...
void __EntryFunction__()//Position - 0x0
{
	...
	else
	{
		if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11))
		{
			...
			while (iVar0 < iLocal_49)
			{
				...
				{
					if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0))
					{
						if (!PED::IS_PED_IN_VEHICLE(iLocal_49[iVar0], iLocal_50, 0))
						{
							BRAIN::TASK_ENTER_VEHICLE(iLocal_49[iVar0], iLocal_50, 4294967295, func_243(iLocal_50), 2f, 1, 0);
						}
					}
					else
					{
						BRAIN::TASK_STAND_STILL(iLocal_49[iVar0], 10000);
					}
				}
				iVar0++;
			}
	...
	while (true)
	{
		...
		if (!func_178())
		{
			...
			switch (iLocal_298)
			{
				case 0:
					if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() && !func_165())
					{
						if (func_156())
						{
							if ((iLocal_44 == 3 && !(CAM::IS_SPHERE_VISIBLE(vLocal_63, 3f) && func_155(AUDIO::_0x0626A247D2405330(), vLocal_63, 1) < 150f)) || iLocal_44 != 3)
							{
								if (iLocal_44 == 3)
								{
								...
								func_154();
								if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && iLocal_44 == 3)
								{
				...
				case 1:
					if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0))
					{
						if (((SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_50, true)) < 10000f || !ENTITY::IS_ENTITY_OCCLUDED(iLocal_50)) || (!PED::IS_PED_INJURED(iLocal_49[0]) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_49[0]))) || (!PED::IS_PED_INJURED(iLocal_49[1]) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_49[1])))
						{
							iLocal_298++;
						}
					}
				...
				case 2:
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_50) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
					{
						if (iLocal_44 == 3)
						{
							func_143();
							if (!ENTITY::IS_ENTITY_OCCLUDED(iLocal_50) && (SYSTEM::VDIST(unk_0x8000C77B5F336760(iLocal_50, true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) < 100f || func_153()))
							{
								func_134(1);
							}
						}
						else if (((!ENTITY::IS_ENTITY_OCCLUDED(iLocal_50) && iLocal_46 == 4) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_70, vLocal_71, fLocal_72, 0, true, 0)) || func_153())
						{
							func_134(1);
						}
						if ((iLocal_46 == 4 && ENTITY::IS_ENTITY_OCCLUDED(iLocal_50)) && iLocal_44 != 3)
						{
							if (SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_50, true)) > 100f)
							{
								func_226();
							}
							else
			...
			if (iLocal_298 > 0)
			{
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && ENTITY::IS_ENTITY_OCCLUDED(iLocal_50))
				{
					if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_50, true)) > 62500f)
					{
						func_226();
					}
					if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_50, true)) > 10000f && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
					{
						func_226();
					}
				}
		...
		else
		{
			...
			if (!HUD::DOES_BLIP_EXIST(iLocal_57))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_52))
				{
					if (iLocal_299 != 0)
					{
						if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(iLocal_52, true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) < SYSTEM::POW(50f, 2f))
						{
							iLocal_299 = 0;
				...
				else if (((bLocal_79 && !OBJECT::DOES_PICKUP_EXIST(iLocal_103)) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0)) && !bLocal_89)
				{
					if (iLocal_299 != 1)
					{
						if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(iLocal_50, true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) < SYSTEM::POW(50f, 2f))
						{
							iLocal_299 = 1;
							func_130(&uLocal_111, 0, 0);
						}
				...
				else if (OBJECT::DOES_PICKUP_EXIST(iLocal_103))
				{
					if (iLocal_299 != 2)
					{
						if (SYSTEM::VDIST2(OBJECT::GET_PICKUP_COORDS(iLocal_103), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) < SYSTEM::POW(50f, 2f))
						{
							iLocal_299 = 2;
							func_130(&uLocal_111, 0, 0);
						}
				...
				{
					if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && !PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_50, 1))
					{
				...
				if (((!ENTITY::IS_ENTITY_DEAD(iLocal_50, 0) && bLocal_79) && !bLocal_81) && (!func_133(0) || (WEAPON::HAS_PED_GOT_WEAPON(AUDIO::_0x0626A247D2405330(), joaat("weapon_stickybomb"), 0) && !func_133(1))))
				{
					switch (iLocal_100)
					{
						case 0:
							if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && SYSTEM::VDIST2(unk_0x8000C77B5F336760(iLocal_50, true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) < 225f)
							{
						...
						case 2:
							if ((MISC::GET_GAME_TIMER() - iLocal_101) > 2000 && WEAPON::HAS_PED_GOT_WEAPON(AUDIO::_0x0626A247D2405330(), joaat("weapon_stickybomb"), 0))
							{
			...
			if ((((OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330())) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_50, 4294967295, 0) == AUDIO::_0x0626A247D2405330()) && !bLocal_83) && iLocal_46 != 8)
			{
				if (bLocal_79)
				{
					func_62(8);
			...
			if (bLocal_81)
			{
				if ((OBJECT::DOES_PICKUP_EXIST(iLocal_103) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330())) && SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), OBJECT::GET_PICKUP_COORDS(iLocal_103)) > 250f)
				{
					func_62(9);
				}
			}
			...
			else
			{
				...
				{
					if ((!ENTITY::IS_ENTITY_DEAD(iLocal_49[iVar2], 0) && !PED::IS_PED_INJURED(iLocal_49[iVar2])) && SYSTEM::VDIST2(unk_0x8000C77B5F336760(iLocal_49[0], true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) < 10000f)
					{
						iVar1 = 0;
					}
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_50))
				{
					if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0))
					{
						if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_50, 0))
						{
							iVar3 = 1;
						}
					}
					if ((SYSTEM::VDIST2(unk_0x8000C77B5F336760(iLocal_50, true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) > 10000f && ENTITY::IS_ENTITY_OCCLUDED(iLocal_50)) || SYSTEM::VDIST2(unk_0x8000C77B5F336760(iLocal_50, true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) > 62500f)
					{
						iVar3 = 1;
					}
				}
		...
		if (((MISC::GET_GAME_TIMER() - iLocal_93) > 10000 && PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) && !iLocal_92)
		{
		...
		if (bLocal_78)
		{
			if ((!PED::IS_PED_INJURED(iLocal_49[0]) || !PED::IS_PED_INJURED(iLocal_49[1])) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(func_3(), true)) < SYSTEM::POW(50f, 2f))
				{
					...
					PLAYER::SET_PLAYER_WANTED_CENTRE_POSITION(CAM::_0xDC9DA9E8789F5246(), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true));
				}
			}
		}
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) == 0 && func_2())
		{
			PLAYER::SET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246(), 2, 0);
			HUD::_0x84698AB38D0C6636(CAM::_0xDC9DA9E8789F5246(), 0);
		}
		...
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
		...
		if (!bLocal_79 && !bLocal_288)
		{
			...
			{
				BRAIN::TASK_PLAY_ANIM(iLocal_49[iLocal_96], "random@security_van", "sec_hand_override", 1000f, -4f, 4294967295, 49, 0, 0, 0, 0);
			}
		}
		if (!iLocal_86)
		{
...
int func_2()//Position - 0x11D5
{
	...
	fVar0 = 50f;
	if (((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && (((OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && bLocal_84) && OBJECT::DOES_PICKUP_EXIST(iLocal_103)) || (!OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && OBJECT::DOES_PICKUP_EXIST(iLocal_103)))) && SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_50, true)) < 20f) && SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), OBJECT::GET_PICKUP_COORDS(iLocal_103)) < 20f)
	{
...
var func_3()//Position - 0x1335
{
	...
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if (!PED::IS_PED_INJURED(iLocal_49[0]))
		{
			fVar0 = SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_49[0], true));
			iVar1 = 0;
		}
		if (!PED::IS_PED_INJURED(iLocal_49[1]))
		{
			if (SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_49[1], true)) < fVar0)
			{
				fVar0 = SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_49[1], true));
				iVar1 = 1;
			}
		}
	}
...
float func_21()//Position - 0x1BE2
{
	...
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if (!PED::IS_PED_INJURED(iLocal_49[0]))
		{
			fVar0 = SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_49[0], true));
		}
		if (!PED::IS_PED_INJURED(iLocal_49[1]))
		{
			if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_49[1], true)) < fVar0)
			{
				fVar0 = SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_49[1], true));
			}
		}
	}
...
int func_22()//Position - 0x1C6C
{
	...
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		...
		while (iVar1 < iLocal_49)
		{
			...
			{
				if (((!PED::IS_PED_INJURED(iLocal_49[iVar1]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_49[iVar1], AUDIO::_0x0626A247D2405330(), 1)) || PED::IS_PED_INJURED(iLocal_49[iVar1])) || ENTITY::IS_ENTITY_DEAD(iLocal_49[iVar1], 0))
				{
					iVar0 = 1;
				}
			}
...
void func_24(vector3 vParam0, bool bParam1)//Position - 0x1DFE
{
	if (!bLocal_89 && !bLocal_81)
	{
		if (!bParam1)
		{
			...
			{
				vParam0 = { OBJECT::GET_SAFE_PICKUP_COORDS(unk_0x8000C77B5F336760(iLocal_49[iLocal_96], false), 1,2f, 1,5f) };
			}
		}
	...
	switch (iLocal_47)
	{
		...
		case 2:
			if (!bLocal_81 && !bLocal_89)
			{
				...
				{
					if (((OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_50, 2) > 0.25f) && VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_50, 3) > 0.25f) || !OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0))
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_52))
						{
							if (ENTITY::IS_ENTITY_ATTACHED(iLocal_52))
							{
								...
								vLocal_279 = { unk_0x8000C77B5F336760(iLocal_52, true) - unk_0x8000C77B5F336760(iLocal_50, true) * Vector(1.5f, 1.5f, 1.5f) };
							...
							else if (MISC::_0x7F8F6405F4777AF6(unk_0x8000C77B5F336760(iLocal_52, true), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, vLocal_276), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, vLocal_277), 0) >= 1f)
							{
								iLocal_47 = 3;
								iLocal_91[0] = 0;
								iLocal_91[1] = 0;
		...
		case 3:
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_52) && !OBJECT::DOES_PICKUP_EXIST(iLocal_103))
			{
				...
				{
					func_24(unk_0x8000C77B5F336760(iLocal_52, true), 1);
					OBJECT::DELETE_OBJECT(&iLocal_52);
				}
				else if ((MISC::GET_GAME_TIMER() - iLocal_278) > 5000)
				{
...
int func_30()//Position - 0x221C
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_53) && ENTITY::IS_ENTITY_ATTACHED(iLocal_53))
	{
		if (!iLocal_272)
		{
			if (MISC::_IS_PROJECTILE_TYPE_IN_RADIUS(unk_0x8000C77B5F336760(iLocal_53, true), joaat("weapon_stickybomb"), 0.25f, 0) || OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(unk_0x8000C77B5F336760(iLocal_53, true), 0.3f, WEAPON::GET_WEAPONTYPE_MODEL(joaat("weapon_stickybomb")), 0))
			{
				iLocal_272 = 1;
			}
		}
		iVar0 = 0;
		GRAPHICS::DRAW_DEBUG_SPHERE(unk_0x8000C77B5F336760(iLocal_53, true), 0.1f, 255, 0, 0, 255);
		if (func_31(0f, 0f, 0f, 0f, 0f, 0f, unk_0x8000C77B5F336760(iLocal_53, true), 1f, 1) || (FIRE::IS_EXPLOSION_IN_SPHERE(2, unk_0x8000C77B5F336760(iLocal_53, true), 0.3f) && iLocal_272))
		{
			iLocal_87 = 1;
			iVar0 = 1;
		}
		if (ENTITY::GET_ENTITY_HEALTH(iLocal_53) < iLocal_98 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_53, AUDIO::_0x0626A247D2405330(), 0))
		{
...
void func_33()//Position - 0x27BA
{
	...
	if (!HUD::DOES_BLIP_EXIST(iLocal_57))
	{
		if (!bLocal_80)
		{
			if ((!PED::IS_PED_INJURED(iLocal_49[1]) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0)) && !bLocal_89)
			{
				if (!bLocal_79)
				{
		...
		else
		{
			...
			if ((OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && HUD::DOES_BLIP_EXIST(iLocal_55)) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_50, 0))
				{
			...
			while (iVar0 < iLocal_49)
			{
				if (!PED::IS_PED_INJURED(iLocal_49[iVar0]) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
				{
					if (!OBJECT::DOES_PICKUP_EXIST(iLocal_103) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_49[iVar0], 0))
					{
						if (!PED::IS_PED_FLEEING(iLocal_49[iVar0]) || SYSTEM::VDIST(unk_0x8000C77B5F336760(iLocal_49[iVar0], true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) < 30f)
						{
							iVar2[iVar0] = 1;
						}
					}
	...
	{
		if ((((((!ENTITY::IS_ENTITY_OCCLUDED(iLocal_50) && ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_50, 100f, 100f, 30f, 0, 1, 0)) || (!ENTITY::IS_ENTITY_OCCLUDED(iLocal_49[0]) && ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_49[0], 100f, 100f, 30f, 0, 1, 0))) || (!ENTITY::IS_ENTITY_OCCLUDED(iLocal_49[1]) && ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_49[1], 100f, 100f, 30f, 0, 1, 0))) || ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_50, 50f, 50f, 20f, 0, 1, 0)) || ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_49[0], 50f, 50f, 20f, 0, 1, 0)) || ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_49[1], 50f, 50f, 20f, 0, 1, 0))
		{
	...
	{
		HUD::_0x75A16C3DA34F1245(uLocal_56[0], iLocal_90);
	}
	if (HUD::DOES_BLIP_EXIST(uLocal_56[1]))
	{
		HUD::_0x75A16C3DA34F1245(uLocal_56[1], bLocal_90);
	}
	if (HUD::DOES_BLIP_EXIST(iLocal_55))
	{
		HUD::_0x75A16C3DA34F1245(iLocal_55, bLocal_90);
	}
	if (HUD::DOES_BLIP_EXIST(iLocal_58))
	{
		HUD::_0x75A16C3DA34F1245(iLocal_58, bLocal_90);
	}
	if (!bLocal_90)
	{
...
void func_42()//Position - 0x2F8A
{
	...
	{
		func_46(13, SYSTEM::FLOOR(Global_19E56.f_27B6.f_F0D));
	}
...
int func_48()//Position - 0x3A85
{
	return Global_1407E0;
}

int func_49(int iParam0, int iParam1)//Position - 0x3A91
{
	switch (iParam0)
	{
		case 0:
...
int func_50(int iParam0)//Position - 0x3E05
{
	switch (iParam0)
	{
		case 29:
...
void func_51(int iParam0)//Position - 0x3E34
{
	int iVar0;
	int iVar1;
...
void func_52(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x3E76
{
	func_53(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_53(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x3E98
{
	int iVar0;
...
int func_56(int iParam0)//Position - 0x41D4
{
	int iVar0;
	int iVar1;
...
void func_57(int iParam0, int iParam1)//Position - 0x4217
{
	MISC::SET_BIT(&(Global_19E56.f_6187.f_8[iParam0]), iParam1);
}

int func_58(int iParam0)//Position - 0x4232
{
	int iVar0;
...
int func_60(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x4300
{
...
void func_62(int iParam0)//Position - 0x44F5
{
	iLocal_46 = iParam0;
	iLocal_48 = 0;
}

int func_63()//Position - 0x4504
{
	if (!OBJECT::DOES_PICKUP_EXIST(iLocal_103))
	{
		if (bLocal_79)
	...
	else
	{
		...
		if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && SYSTEM::VDIST(OBJECT::GET_PICKUP_COORDS(iLocal_103), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) > 300f)
		{
			return 1;
		}
	}
...
int func_64(int iParam0)//Position - 0x460E
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if (SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iParam0, true)) < 150f)
		{
			return 1;
		}
		else if (!ENTITY::IS_ENTITY_OCCLUDED(iParam0) && SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iParam0, true)) < 300f)
		{
			return 1;
		}
	}
			...
			case 0:
				...
				while (iVar0 < iLocal_49)
				{
					if (!PED::IS_PED_INJURED(iLocal_49[iVar0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_52))
					{
						...
						{
							NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_49[iVar0]);
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_54);
							...
							CUTSCENE::_0x8D9DF6ECA8768583(iLocal_54);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_49[iVar0], iLocal_54);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
						}
						...
						ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_49[iVar0], 1);
						ENTITY::SET_ENTITY_HEALTH(iLocal_49[iVar0], true);
					}
					iVar0++;
				}
				if ((ENTITY::DOES_ENTITY_EXIST(iLocal_52) && ENTITY::IS_ENTITY_ATTACHED(iLocal_52)) && !PED::IS_PED_INJURED(iLocal_49[iLocal_96]))
				{
					NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_49[iLocal_96]);
				}
				SYSTEM::SETTIMERA(0);
				iLocal_48++;
				break;
			...
			case 1:
				if (func_70(iLocal_96))
				{
					if (!PED::IS_PED_INJURED(iLocal_49[iLocal_96]))
					{
						...
						BRAIN::TASK_COMBAT_PED(0, AUDIO::_0x0626A247D2405330(), 0, 16);
						CUTSCENE::_0x8D9DF6ECA8768583(iLocal_54);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_49[iLocal_96], iLocal_54);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
					}
					iLocal_48++;
				}
			...
			case 2:
				if (!PED::IS_PED_INJURED(iLocal_49[0]) || !PED::IS_PED_INJURED(iLocal_49[1]))
				{
					...
					if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0))
					{
						if (!bLocal_79)
						{
							if (!PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_50, 0) && (MISC::GET_GAME_TIMER() - iLocal_295) > 5000)
							{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_282) > 250)
	{
		if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			...
			while (iVar0 < iLocal_49)
			{
				if (!PED::IS_PED_INJURED(iLocal_49[iVar0]))
				{
					if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_49[iVar0], AUDIO::_0x0626A247D2405330(), 19) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_49[iVar0], AUDIO::_0x0626A247D2405330()))
					{
						iLocal_281[iVar0] = 1;
					}
					else
...
void func_68(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x4BFE
{
...
void func_69(var uParam0, int iParam1)//Position - 0x4C99
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
bool func_70(int iParam0)//Position - 0x4CB6
{
	bool bVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_52))
	{
		if (!PED::IS_PED_INJURED(iLocal_49[iParam0]))
		{
			if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_52, iLocal_49[iParam0]))
			{
				...
				{
					ENTITY::SET_ENTITY_HEALTH(iLocal_49[iParam0], true);
					BRAIN::TASK_PLAY_ANIM(iLocal_49[iParam0], "weapons@holster_1h", "holster", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
				}
			}
		}
	}
	...
	if (bVar0)
	{
		if (!PED::IS_PED_INJURED(iLocal_49[iParam0]))
		{
			ENTITY::SET_ENTITY_HEALTH(iLocal_49[iParam0], false);
		}
	}
	return bVar0;
}

void func_71(int iParam0, bool bParam1)//Position - 0x4D9A
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		vVar0 = { func_29(ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_50, unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true))) };
		...
		vVar3[0 /*3*/] = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(unk_0x8000C77B5F336760(iLocal_50, true), fVar1, 0f, 4.5f, 0f) };
		vVar3[1 /*3*/] = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(unk_0x8000C77B5F336760(iLocal_50, true), fVar2, 0f, 4.5f, 0f) };
		func_72(&fVar1);
		func_72(&fVar2);
		if (SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), vLocal_293) > 2f)
		{
			bVar5 = true;
		}
		iVar4 = 0;
		while (iVar4 < iLocal_49)
		{
			...
			{
				if (SYSTEM::VDIST(unk_0x8000C77B5F336760(iLocal_49[iVar4], true), vVar3[iVar4 /*3*/]) > 2f)
				{
					bVar5 = true;
				}
			}
		...
		if (bVar5)
		{
			...
			while (iVar4 < iLocal_49)
			{
				if ((((((!PED::IS_PED_INJURED(iLocal_49[iVar4]) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330())) && SYSTEM::VDIST(unk_0x8000C77B5F336760(iLocal_49[iVar4], true), vVar3[iVar4 /*3*/]) > 2f) && (MISC::GET_GAME_TIMER() - iLocal_294[iVar4]) > 1000) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_49[iVar4], 0)) && !iLocal_281[iVar4]) && (iParam0 == 4294967295 || iParam0 == iVar4))
				{
					if (bParam1)
					{
						if (func_66())
						{
							vLocal_293 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true) };
						}
						BRAIN::OPEN_SEQUENCE_TASK(&iVar6);
						if (func_66() || func_32(vLocal_293))
						{
							BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vVar3[iVar4 /*3*/], AUDIO::_0x0626A247D2405330(), 2f, false, 1056964608, 1082130432, true, 0, 0, 3337513804, 20000);
							BRAIN::TASK_AIM_GUN_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295, 1);
						}
						else
						{
							BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, vVar3[iVar4 /*3*/], vLocal_293, 2f, false, 0,5f, 4f, true, 0, 0, 3337513804);
							BRAIN::TASK_AIM_GUN_AT_COORD(0, vLocal_293, 4294967295, 1, 0);
						}
						CUTSCENE::_0x8D9DF6ECA8768583(iVar6);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_49[iVar4], iVar6);
...
void func_72(float fParam0)//Position - 0x4FFF
{
	if (*fParam0 > 180f)
	{
...
void func_73(int iParam0)//Position - 0x503A
{
	float fVar0;
		...
		switch (iLocal_48)
		{
			case 0:
				if (!bLocal_79)
				{
					...
					vLocal_285 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION("random@security_van", "sec_case_into_van_panic", vLocal_283, vLocal_284, 0f, 2) };
					if (((!PED::IS_PED_INJURED(iLocal_49[1]) && !ENTITY::IS_ENTITY_DEAD(iLocal_49[1], 0)) && !PED::IS_PED_INJURED(iLocal_49[0])) && !ENTITY::IS_ENTITY_DEAD(iLocal_49[0], 0))
					{
						...
						if (OBJECT::DOES_PICKUP_EXIST(iLocal_103))
						{
							if (bLocal_80)
							{
								BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, OBJECT::GET_PICKUP_COORDS(iLocal_103), 2f, 4294967295, 1048576000, 0, 1193033728);
							}
							else
							{
								BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, OBJECT::GET_PICKUP_COORDS(iLocal_103), 1f, 4294967295, 1048576000, 0, 1193033728);
							}
							iLocal_48++;
						}
						else
			...
			case 1:
				...
				{
					if ((MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(iParam0, true), OBJECT::GET_PICKUP_COORDS(iLocal_103), true) < 2f && !PED::IS_PED_RAGDOLL(iParam0)) && (MISC::GET_GAME_TIMER() - iLocal_102) > 3000)
					{
			...
			case 2:
				if (!PED::IS_PED_INJURED(iParam0) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0))
				{
					if (BRAIN::GET_SCRIPT_TASK_STATUS(iParam0, 713668775) != 1)
					{
						if (bLocal_80)
						{
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, vLocal_285, 2f, 4294967295, 0.1f, 512, vLocal_284.z);
						}
						else
						{
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, vLocal_285, 1f, 4294967295, 0.1f, 512, vLocal_284.z);
						}
						iLocal_48++;
					}
				}
			...
			case 3:
				if (!PED::IS_PED_INJURED(iParam0))
				{
					...
					else
					{
						...
						if (SYSTEM::VDIST(vLocal_285, unk_0x8000C77B5F336760(iParam0, true)) < 0.3f)
						{
							if (MISC::ABSF((fVar0 - vLocal_284.z)) < 15f)
							{
								PED::CLEAR_PED_ALTERNATE_WALK_ANIM(iParam0, 3238002688);
								NETWORK::_0x5E3AA4CA2B6FB0EE(iParam0);
								bLocal_288 = true;
								iLocal_286 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_283, vLocal_284, 2);
								if (bLocal_80)
								{
									BRAIN::TASK_SYNCHRONIZED_SCENE(iParam0, iLocal_286, "random@security_van", "sec_case_into_van_panic", 4f, 4f, 3, 0, 4f, 0);
									ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_50, iLocal_286, "van_case_into_van_panic", "random@security_van", 4f, -1000f, 0, -1000f);
								}
								else
								{
									BRAIN::TASK_SYNCHRONIZED_SCENE(iParam0, iLocal_286, "random@security_van", "sec_case_into_van_calm", 4f, -4f, 3, 0, 4f, 0);
					...
					if (!bLocal_79)
					{
						if ((ENTITY::DOES_ENTITY_EXIST(iLocal_52) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_52, iParam0)) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_286) > fLocal_296)
						{
							if (!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_52, iLocal_50))
							{
								...
								ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_52, iLocal_50, 0, ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_50, unk_0x8000C77B5F336760(iLocal_52, true)), 90f, 0f, 0f, 0, 0, 0, 0, 2, 1);
							}
							bLocal_79 = true;
						}
					}
			...
			case 5:
				if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_286) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_286) > fLocal_297) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_286))
				{
					if (!bLocal_80)
					{
						if (!PED::IS_PED_INJURED(iLocal_49[0]))
						{
							BRAIN::TASK_ENTER_VEHICLE(iLocal_49[0], iLocal_50, 4294967295, 4294967295, 1f, 1, 0);
						}
					}
					iLocal_48++;
				}
	...
	if ((!PED::IS_PED_INJURED(iLocal_49[0]) || !PED::IS_PED_INJURED(iLocal_49[1])) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if (!bLocal_79)
		{
			if ((((((func_21() < 10f && WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6)) && func_66()) || ((func_21() < 20f && WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6)) && PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))) || (func_21() < 5f && bLocal_80)) || (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0) && func_74(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))) || ((!PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0) && ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYERS_LAST_VEHICLE())) && func_74(PLAYER::GET_PLAYERS_LAST_VEHICLE())))
			{
				func_62(8);
			}
		}
	...
	if ((OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && iLocal_46 != 7) && PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_286))
	{
		ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_50, -8f, 1);
	}
}

int func_74(int iParam0)//Position - 0x5720
{
	int iVar0;
	struct<2> Var1;
	struct<2> Var2;
...
int func_75(var uParam0, var uParam1, var uParam2)//Position - 0x596C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_76(vector3 vParam0, struct<2> Param1, var uParam2, struct<2> Param3, var uParam4, struct<2> Param5, var uParam6, var uParam7)//Position - 0x59F0
{
	float fVar0;
	float fVar1;
	float fVar2;
...
float func_77(float fParam0, float fParam1)//Position - 0x5B28
{
	if (fParam0 > fParam1)
	{
		return fParam0;
...
float func_78(float fParam0, float fParam1)//Position - 0x5B42
{
	if (fParam0 < fParam1)
	{
		return fParam0;
...
void func_79(int iParam0)//Position - 0x5B5C
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_52))
...
void func_80()//Position - 0x5BB6
{
	...
	switch (iLocal_48)
	{
		case 0:
			...
			if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0))
			{
				if (ENTITY::DOES_ENTITY_EXIST(func_83()))
				{
					...
					{
						if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_50, 4294967295, 0) != func_83() && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_50, 4294967295, 0))
						{
							BRAIN::TASK_ENTER_VEHICLE(func_83(), iLocal_50, 20000, 4294967295, 2f, 1, 0);
						}
					}
				}
				if (!PED::IS_PED_INJURED(iLocal_49[1]) && func_83() != iLocal_49[1])
				{
					...
					{
						BRAIN::TASK_ENTER_VEHICLE(iLocal_49[1], iLocal_50, 4294967295, 0, 2f, 1, 0);
					}
				}
				iLocal_48++;
			}
		...
		case 1:
			if (func_82())
			{
				if (ENTITY::DOES_ENTITY_EXIST(func_83()) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
				{
					BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(func_83(), iLocal_50, AUDIO::_0x0626A247D2405330(), 8, 50f, 786484, 100f, 5f, 1);
					iLocal_48++;
				}
			}
			break;
		...
		case 2:
			if (func_81())
			{
				if (ENTITY::DOES_ENTITY_EXIST(func_83()))
				{
					BRAIN::TASK_VEHICLE_MISSION(func_83(), iLocal_50, 0, 5, 0f, 786484, 100f, 100f, 1);
					iLocal_48++;
				}
			}
			break;
	...
	if ((ENTITY::DOES_ENTITY_EXIST(iLocal_50) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_50, 4294967295, 0))) && (ENTITY::IS_ENTITY_DEAD(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_50, 4294967295, 0), 0) || PED::IS_PED_INJURED(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_50, 4294967295, 0))))
	{
		iVar1 = 0;
		if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_50, 4294967295, 0) == iLocal_49[0])
		{
			iVar1 = 1;
		}
		if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(iLocal_50, true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) > 100f)
		{
			if (!PED::IS_PED_INJURED(iLocal_49[iVar1]) && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_49[iVar1], 242628503) != 1)
			{
				PED::SET_PED_FLEE_ATTRIBUTES(iLocal_49[iVar1], 2, true);
				BRAIN::OPEN_SEQUENCE_TASK(&iVar2);
				BRAIN::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(0, iLocal_50, 0);
				BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_50, AUDIO::_0x0626A247D2405330(), 8, 50f, 786484, 100f, 5f, 1);
				CUTSCENE::_0x8D9DF6ECA8768583(iVar2);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_49[iVar1], iVar2);
	...
	if (((((((!OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) || OBJECT::DOES_PICKUP_EXIST(iLocal_103)) || iLocal_47 == 3) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_50, 0, 7000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_50, 3, 30000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_50, 2, 30000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_50, 1, 40000)) || (iLocal_48 > 1 && !func_82()))
	{
		if (!func_82())
		{
		}
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, int iParam7)//Position - 0x61A1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_86(int iParam0, int iParam1, bool bParam2, int iParam3)//Position - 0x6254
{
	int iVar0;
...
void func_87()//Position - 0x62EF
{
			...
			case 0:
				if (func_4(&Local_106, cLocal_105, "RESEC_CAR1", 8, 0, 0, 0))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_52) && ENTITY::IS_ENTITY_ATTACHED(iLocal_52))
					{
						...
						{
							NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_49[0]);
						}
						...
						{
							NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_49[1]);
						}
						iLocal_48++;
					}
					else
	...
	if (iLocal_48 > 0)
	{
		func_71(4294967295, 1);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_51))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_51, 0) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0))
		{
			if (SYSTEM::VDIST(unk_0x8000C77B5F336760(iLocal_51, true), unk_0x8000C77B5F336760(iLocal_50, true)) > 10f)
			{
				func_62(7);
			}
		}
		if ((ENTITY::IS_ENTITY_DEAD(iLocal_51, 0) || !OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_51, 0)) || (!ENTITY::IS_ENTITY_UPRIGHT(iLocal_51, 90f) && !PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_51, 1)))
		{
	...
	if (!PED::IS_PED_INJURED(iLocal_49[0]) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_49[0], AUDIO::_0x0626A247D2405330(), 1))
		{
			func_62(8);
		}
	}
	if (!PED::IS_PED_INJURED(iLocal_49[1]) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_49[1], AUDIO::_0x0626A247D2405330(), 1))
		{
			func_62(8);
		}
	}
	...
	if ((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && func_66()) && WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 7))
	{
		func_62(2);
	}
	if (!OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0))
...
void func_88(int iParam0)//Position - 0x65E4
{
	if (!PED::IS_PED_INJURED(iLocal_49[iParam0]) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_49[iParam0]);
		BRAIN::OPEN_SEQUENCE_TASK(&iLocal_54);
		...
		CUTSCENE::_0x8D9DF6ECA8768583(iLocal_54);
		BRAIN::TASK_PERFORM_SEQUENCE(iLocal_49[iParam0], iLocal_54);
		BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
		if (iLocal_97 == 0)
		{
			iLocal_97 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(116, unk_0x8000C77B5F336760(iLocal_49[iParam0], true), -1f);
		}
	}
}

void func_89()//Position - 0x6681
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	switch (iLocal_48)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_49[0]))
			{
				ENTITY::SET_ENTITY_HEALTH(iLocal_49[0], true);
			}
			if (!PED::IS_PED_INJURED(iLocal_49[1]))
			{
				ENTITY::SET_ENTITY_HEALTH(iLocal_49[1], true);
			}
			if (func_96())
			{
			...
			else if ((!PED::IS_PED_INJURED(iLocal_49[0]) && !PED::IS_PED_INJURED(iLocal_49[1])) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				if (func_95() || func_94())
				{
					func_4(&Local_106, cLocal_105, "RESEC_ENT1", 8, 0, 0, 0);
				}
				else if (WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 4))
				{
		...
		case 2:
			if (!func_93())
			{
				...
				while (iVar1 < iLocal_49)
				{
					if (!func_92(iLocal_49[iVar1], 1000) && (func_21() < 2f && WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6)))
					{
						bVar0 = true;
					}
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_49[iVar1], 0))
					{
						if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_49[iVar1]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_49[iVar1]))
						{
							bVar0 = true;
						}
					}
	...
	{
		if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && ENTITY::DOES_ENTITY_EXIST(iLocal_49[iVar2]))
		{
			if ((PED::IS_PED_INJURED(iLocal_49[iVar2]) || ENTITY::IS_ENTITY_DEAD(iLocal_49[iVar2], 0)) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_49[iVar2], AUDIO::_0x0626A247D2405330(), 0))
			{
				func_62(8);
			}
		}
	...
	if ((OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330())) && func_66())
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_50, AUDIO::_0x0626A247D2405330(), 1))
		{
			func_62(8);
	...
	if ((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6)) && PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
	{
		func_62(8);
	}
...
void func_90()//Position - 0x6A79
{
	Global_3960 = 0;
	func_91();
}

void func_91()//Position - 0x6A89
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_92(int iParam0, int iParam1)//Position - 0x6AAA
{
	int iVar0;
	...
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0))
		{
			if ((ENTITY::IS_ENTITY_A_PED(iParam0) && !PED::IS_PED_INJURED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0))) || (ENTITY::IS_ENTITY_A_VEHICLE(iParam0) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(iParam0), 0)))
			{
				if (SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iParam0, true)) > fLocal_290)
				{
					iVar0 = 1;
				}
				if ((MISC::GET_GAME_TIMER() - iLocal_291) > iParam1)
				{
					fLocal_290 = SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iParam0, true));
...
int func_93()//Position - 0x6B4A
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if (!ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_50, 20f, 20f, 5f, 0, 1, 0) && !PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(CAM::_0xDC9DA9E8789F5246(), 0))
		{
			return 1;
		}
	}
...
int func_94()//Position - 0x6B9A
{
	int iVar0;
	
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, 1.7532f, 0.5984f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, 3.3477f, 3.5984f), 2.8f, 0, true, 0))
		{
			return 1;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_49)
		{
			if (!PED::IS_PED_INJURED(iLocal_49[iVar0]))
			{
				if ((!PED::IS_PED_IN_VEHICLE(iLocal_49[iVar0], iLocal_50, 0) && PED::IS_PED_ON_SPECIFIC_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_50)) && SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_49[iVar0], true)) < 400f)
				{
					return 1;
				}
			}
...
int func_95()//Position - 0x6C5C
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if (PED::GET_VEHICLE_PED_IS_USING(AUDIO::_0x0626A247D2405330()) == iLocal_50)
		{
...
int func_96()//Position - 0x6C99
{
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if ((!PED::IS_PED_INJURED(iLocal_49[0]) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_49[0], AUDIO::_0x0626A247D2405330(), 20f, 20f, 5f, 0, 1, 0)) || (!PED::IS_PED_INJURED(iLocal_49[1]) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_49[1], AUDIO::_0x0626A247D2405330(), 20f, 20f, 5f, 0, 1, 0)))
		{
...
int func_97(char* sParam0)//Position - 0x6D28
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_98(var uParam0, vector3 vParam1, int iParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x6D3B
{
...
void func_99(var uParam0, vector3 vParam1, var uParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x6D71
{
	int iVar0;
...
void func_100(var uParam0)//Position - 0x704B
{
	if (func_101(AUDIO::_0x0626A247D2405330()))
	{
...
int func_101(int iParam0)//Position - 0x70B4
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(iParam0))
...
int func_102(var uParam0)//Position - 0x710F
{
	int iVar0;
...
int func_103(bool bParam0)//Position - 0x713A
{
	switch (Global_8D15)
	{
		case 0:
...
int func_104(char* sParam0)//Position - 0x71E4
{
	if (!func_105(1, 1, 0))
	{
...
int func_105(bool bParam0, bool bParam1, bool bParam2)//Position - 0x727D
{
	int iVar0;
	int iVar1;
	...
	if ((func_113() || func_112(Global_440000.f_2559E)) || func_111())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0);
			iVar1 = func_110(AUDIO::_0x0626A247D2405330(), 0);
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("APC") && iVar1 != 4294967295)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("AKULA") && iVar1 != 4294967295)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("RIOT2") && iVar1 == 0) && func_109(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != 4294967295))
			{
				return 0;
			}
		}
	}
	if (func_106(CAM::_0xDC9DA9E8789F5246()))
	{
		return 0;
	}
	return 1;
...
int func_106(int iParam0)//Position - 0x74CB
{
	if (iParam0 != func_108())
	{
		...
		else if ((Global_140859 && iParam0 == CAM::_0xDC9DA9E8789F5246()) && func_107(iParam0, 1, 0))
		{
			return Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295;
		}
	}
...
int func_107(int iParam0, bool bParam1, bool bParam2)//Position - 0x7531
{
	int iVar0;
...
int func_108()//Position - 0x757B
{
	return 4294967295;
}

int func_109(int iParam0, int iParam1)//Position - 0x7584
{
...
int func_110(int iParam0, int iParam1)//Position - 0x75E6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_111()//Position - 0x766B
{
	return Global_255C02.f_10;
}

bool func_112(int iParam0)//Position - 0x7679
{
	return iParam0 == 51;
}

var func_113()//Position - 0x7686
{
	return Global_255C02.f_F;
}

bool func_114()//Position - 0x7694
{
	return MISC::GET_GAME_TIMER() <= Global_43D7.f_16F1 + 100;
}

int func_115(int iParam0)//Position - 0x76A9
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
void func_116(var uParam0, vector3 vParam1, int iParam2)//Position - 0x7703
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_117(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x779F
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_120(bParam1, bParam2, bParam3) || PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 1) || func_118(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
int func_118(bool bParam0, bool bParam1, bool bParam2)//Position - 0x7B0B
{
...
int func_119(bool bParam0, bool bParam1, bool bParam2)//Position - 0x7B5D
{
	if (!func_105(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_120(bool bParam0, bool bParam1, bool bParam2)//Position - 0x7BA6
{
	if (!func_105(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_121(bool bParam0, bool bParam1, bool bParam2)//Position - 0x7C05
{
	if (!func_105(bParam0, bParam1, bParam2))
	{
		return 0;
...
void func_122()//Position - 0x7C5B
{
	MISC::SET_BIT(&Global_950, 4);
}

void func_123(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x7C6B
{
	func_124(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_124(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x7C88
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 1))
	{
		func_130(uParam0, 0, 0);
...
void func_125(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x7CC0
{
	int iVar0;
	int iVar1;
...
void func_126(var uParam0, int iParam1, vector3 vParam2, int iParam3)//Position - 0x802E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_127()//Position - 0x813E
{
	return func_128(CAM::_0xDC9DA9E8789F5246());
}

int func_128(int iParam0)//Position - 0x814E
{
...
bool func_129(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x816D
{
	if (bParam2)
	{
...
void func_130(var uParam0, int iParam1, int iParam2)//Position - 0x81B4
{
	char* sVar0;
...
void func_131(int iParam0)//Position - 0x8291
{
	MISC::SET_BIT(&(Global_19E56.f_6187.f_6), iParam0);
}

void func_132(char* sParam0, int iParam1)//Position - 0x82A8
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

bool func_133(int iParam0)//Position - 0x82BF
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_6187.f_6, iParam0);
}

int func_134(int iParam0)//Position - 0x82D6
{
	if (func_137())
	{
		Global_19E4C = 1;
		Global_19E49 = MISC::GET_GAME_TIMER();
		if (func_50(Global_19E4B))
		{
			func_135(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_50(Global_19E4B))
		{
...
void func_135(int iParam0)//Position - 0x8329
{
	switch (iParam0)
	{
		case 0:
			if (Global_19E56.f_6187.f_2 < 3)
			{
				...
				{
					func_132(func_136(iParam0), 4294967295);
...
char* func_136(int iParam0)//Position - 0x840A
{
	char* sVar0;
...
int func_137()//Position - 0x844E
{
	switch (func_138(&Global_63AE, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_138(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x8484
{
	int iVar0;
...
void func_139(var uParam0, int iParam1)//Position - 0x85BB
{
	int iVar0;
...
bool func_140(int iParam0)//Position - 0x860A
{
	return func_141(iParam0, Global_8D15);
}

int func_141(int iParam0, int iParam1)//Position - 0x861B
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_142(int iParam0)//Position - 0x87FC
{
	if (Global_8D15 == 15)
	{
		return 0;
...
void func_143()//Position - 0x881E
{
				...
				if (!PED::IS_PED_INJURED(iLocal_49[0]) && !PED::IS_PED_INJURED(iLocal_49[1]))
				{
					...
					if (PED::IS_PED_IN_VEHICLE(iLocal_49[0], iLocal_50, 0) && PED::IS_PED_IN_VEHICLE(iLocal_49[1], iLocal_50, 0))
					{
						if (iLocal_45 == 2)
						{
							...
							BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_50, -574.6195f, -847.232f, 25.2925f, 10f, 0, joaat("STOCKADE"), 786603, 2f, 4f);
							BRAIN::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_50, 10f, 786603);
							CUTSCENE::_0x8D9DF6ECA8768583(iVar0);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_49[0], iVar0);
						...
						{
							BRAIN::OPEN_SEQUENCE_TASK(&iVar1);
							BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_50, -551.2968f, -1119.418f, 20.4011f, 10f, 0, joaat("STOCKADE"), 786603, 2f, 4f);
							BRAIN::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_50, 10f, 786603);
							CUTSCENE::_0x8D9DF6ECA8768583(iVar1);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_49[0], iVar1);
							BRAIN::CLEAR_SEQUENCE_TASK(&iVar1);
							iLocal_48++;
						}
						else if (iLocal_45 == 7)
						{
							BRAIN::OPEN_SEQUENCE_TASK(&iVar2);
							BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_50, 2786.752f, 4358.032f, 48.6794f, 10f, 0, joaat("STOCKADE"), 786603, 2f, 4f);
							BRAIN::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_50, 10f, 786603);
							CUTSCENE::_0x8D9DF6ECA8768583(iVar2);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_49[0], iVar2);
							BRAIN::CLEAR_SEQUENCE_TASK(&iVar2);
							iLocal_48++;
						}
						else
						{
							BRAIN::TASK_VEHICLE_DRIVE_WANDER(iLocal_49[0], iLocal_50, 10f, 786603);
							iLocal_48++;
						}
					}
					else
					{
						if (!PED::IS_PED_IN_VEHICLE(iLocal_49[0], iLocal_50, 0) && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_49[0], 2500551826) != 1)
						{
							BRAIN::TASK_ENTER_VEHICLE(iLocal_49[0], iLocal_50, 4294967295, 4294967295, 1f, 8388608, 0);
						}
						if (!PED::IS_PED_IN_VEHICLE(iLocal_49[1], iLocal_50, 0) && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_49[1], 2500551826) != 1)
						{
							BRAIN::TASK_ENTER_VEHICLE(iLocal_49[1], iLocal_50, 4294967295, 0, 1f, 8388608, 0);
						}
					}
				}
			}
		...
		case 1:
			...
			if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				while (iVar3 < iLocal_49)
				{
					...
					{
						if (PED::IS_PED_JACKING(AUDIO::_0x0626A247D2405330()) && PED::IS_PED_BEING_JACKED(iLocal_49[iVar3]))
						{
							func_62(8);
						}
					}
				...
				if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_50, 1))
				{
					func_62(8);
				}
			}
	...
	if (iLocal_46 == 4)
	{
		if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			WEAPON::GET_CURRENT_PED_WEAPON(AUDIO::_0x0626A247D2405330(), &iVar4, 1);
			if ((iVar4 == joaat("weapon_stickybomb") || iVar4 == joaat("weapon_molotov")) || iVar4 == joaat("weapon_grenade"))
			{
				GRAPHICS::DRAW_DEBUG_TEXT("PLAYER HAS PROJECTILE WEAPON", unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 0, 0, 255, 255);
				if ((PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, -3.44f, -3f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, -13.44f, 3f), 2.3f, 0, true, 0)) && SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_50, true)) < 225f)
				{
					func_62(6);
				}
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, -3.44f, -3f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, -13.44f, 3f), 2.3f, 0, true, 0))
				{
					GRAPHICS::DRAW_DEBUG_TEXT_2D("PLAYER IS BEHIND VAN", 0.1f, 0.8f, 0f, 0, 0, 255, 255);
				}
				if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_50, true)) < 225f)
				{
		...
		if (((OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && func_31(0f, 0f, 0f, 0f, 0f, 0f, unk_0x8000C77B5F336760(iLocal_50, true), 25f, 0)) || (!PED::IS_PED_INJURED(iLocal_49[0]) && func_31(0f, 0f, 0f, 0f, 0f, 0f, unk_0x8000C77B5F336760(iLocal_49[0], true), 20f, 0))) || (!PED::IS_PED_INJURED(iLocal_49[1]) && func_31(0f, 0f, 0f, 0f, 0f, 0f, unk_0x8000C77B5F336760(iLocal_49[1], true), 20f, 0)))
		{
			func_62(6);
		}
		if (iLocal_46 != 4)
		{
			if (!PED::IS_PED_INJURED(iLocal_49[0]))
			{
				...
				ENTITY::SET_ENTITY_HEALTH(iLocal_49[0], false);
			}
			if (!PED::IS_PED_INJURED(iLocal_49[1]))
			{
				PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_49[1], 6, false);
				ENTITY::SET_ENTITY_HEALTH(iLocal_49[1], false);
			}
		}
	}
}

int func_144()//Position - 0x8D66
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	
	if ((OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246())) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		vVar0 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true) - unk_0x8000C77B5F336760(iLocal_50, true) };
		vVar1 = { ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_50) };
		vVar2 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_50, unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) };
		if (((vVar2.y > 1f && (((PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_50) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_50)) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_49[0])) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_49[1]))) && MISC::ABSF(MISC::GET_ANGLE_BETWEEN_2D_VECTORS(vVar1.x, vVar1.y, vVar0.x, vVar0.y)) < 60f) && MISC::GET_ANGLE_BETWEEN_2D_VECTORS(vVar1.z, vVar1.y, vVar0.z, vVar0.y) < 30f)
		{
			return 1;
		}
	}
...
int func_145()//Position - 0x8E56
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 2.7f, 7f, -2f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 2.7f, -3.25f, 3f), 3f, 0, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, -2.7f, 7f, -2f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, -2.7f, -3.25f, 3f), 3f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, 7f, -2f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, 0f, 3f), 2.4f, 0, true, 0))
		{
			if (PED::IS_PED_PLANTING_BOMB(AUDIO::_0x0626A247D2405330()))
			{
				return 1;
...
int func_146()//Position - 0x8F17
{
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		...
		{
			return ((OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iVar0, 0) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(iVar0, iLocal_50)) && ENTITY::GET_ENTITY_SPEED(iVar0) > 10f);
		}
	}
	return 0;
}

int func_147()//Position - 0x8FB0
{
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if (iLocal_86)
...
void func_148()//Position - 0x9032
{
	float fVar0;
	
	if ((!PED::IS_PED_INJURED(iLocal_49[0]) && !PED::IS_PED_INJURED(iLocal_49[1])) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0))
	{
		switch (iLocal_48)
		{
			case 0:
				vLocal_283 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_50, 0) };
				vLocal_284 = { ENTITY::GET_ENTITY_ROTATION(iLocal_50, 2) };
				vLocal_285 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION("random@security_van", "sec_case_into_van_calm", vLocal_283, vLocal_284, 0f, 2) };
				bLocal_288 = false;
				iLocal_289 = 0;
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_50, 1084227584);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_54);
				BRAIN::TASK_STAND_STILL(0, 5000);
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_285, 1f, 4294967295, 0.1f, 512, vLocal_284.z);
				BRAIN::TASK_ACHIEVE_HEADING(0, vLocal_284.z, 0);
				CUTSCENE::_0x8D9DF6ECA8768583(iLocal_54);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_49[1], iLocal_54);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
				iLocal_48++;
				break;
			...
			case 1:
				...
				{
					if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), vLocal_63) < 22500f && ENTITY::HAS_COLLISION_LOADED_AROUND_ENTITY(iLocal_50))
					{
						iLocal_287 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_283, vLocal_284, 2);
						BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_49[0], iLocal_287, "random@security_van", "driver_idle", 2f, -8f, 13, 0, 1148846080, 0);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_287, true);
					}
				}
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_49[1], 242628503) != 1)
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_54);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_285, 1f, 4294967295, 0.1f, 512, vLocal_284.z);
					BRAIN::TASK_ACHIEVE_HEADING(0, vLocal_284.z, 0);
				...
				if (MISC::ABSF((fVar0 - vLocal_284.z)) < 15f && SYSTEM::VDIST(vLocal_285, unk_0x8000C77B5F336760(iLocal_49[1], true)) < 0.2f)
				{
					PED::CLEAR_PED_ALTERNATE_WALK_ANIM(iLocal_49[1], 3238002688);
					NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_49[1]);
					bLocal_288 = true;
					iLocal_286 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_283, vLocal_284, 2);
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_49[1], iLocal_286, "random@security_van", "sec_case_into_van_calm", 4f, -4f, 3, 0, 4f, 0);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_50, iLocal_286, "van_case_into_van_calm", "random@security_van", 4f, -1000f, 0, -1000f);
					iLocal_48++;
				}
				break;
			...
			case 2:
				if (!iLocal_76)
				{
					if (((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_286) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_286) > 0.09f) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_286) < 0.11f) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_49[1], 20f, 20f, 5f, 0, 1, 0))
						{
			...
			case 3:
				if (!iLocal_76)
				{
					if (((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_286) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_286) > 0.56f) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330())) && ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_49[1], 20f, 20f, 5f, 0, 1, 0))
					{
				...
				if (!iLocal_289)
				{
					if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_286) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_286) > 0.6f) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_286))
					{
						if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_287))
						{
							NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_49[0]);
							iLocal_287 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_283, vLocal_284, 2);
							BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_49[0], iLocal_287, "random@security_van", "driver_exit_calm", 4f, -4f, 9, 0, 1148846080, 0);
						}
						iLocal_289 = 1;
					}
				}
				...
				{
					NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_49[1]);
					BRAIN::TASK_ENTER_VEHICLE(iLocal_49[1], iLocal_50, 4294967295, 0, 1f, 1, 0);
					SYSTEM::SETTIMERA(0);
				}
		...
		if (((!PED::IS_PED_INJURED(func_3()) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330())) && SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(func_3(), true)) < 30f) && PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) != 0)
		{
			func_62(8);
		}
	}
		...
		if (iLocal_46 != 4)
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_49[0]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_49[0], "random@security_van", "driver_idle", 3))
				{
					if (iLocal_45 != 2)
					{
						BRAIN::TASK_PLAY_ANIM_ADVANCED(iLocal_49[0], "random@security_van", "driver_exit_panic", vLocal_283, vLocal_284, 1000f, -8f, 4294967295, 4096, 0f, 2, 0);
					}
					else
					{
						NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_49[0]);
						BRAIN::TASK_PLAY_ANIM(iLocal_49[0], "random@security_van", "driver_exit_panic", 1000f, -8f, 4294967295, 0, 0, 0, 0, 0);
					}
				}
			}
			if ((OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0) && PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_286)) && !PED::IS_PED_INJURED(iLocal_49[1]))
			{
				ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_50, -1000f, 1);
				NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_49[1]);
			}
...
int func_149()//Position - 0x97CE
{
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		...
		else if (!ENTITY::IS_ENTITY_DEAD(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 0))
		{
			if (func_74(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
			{
			...
			if (fLocal_280 > 3f)
			{
				iLocal_51 = PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0);
				return 1;
			}
		}
	}
...
int func_150()//Position - 0x9884
{
	...
	while (iVar0 < iLocal_49)
	{
		if ((((((!PED::IS_PED_INJURED(iLocal_49[iVar0]) && PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246())) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330())) && (PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_49[iVar0]) || PED::IS_PED_IN_MELEE_COMBAT(AUDIO::_0x0626A247D2405330()))) && SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_49[iVar0], true)) < 9f) && !WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 7)) && func_66())
		{
			return 1;
		}
...
int func_151()//Position - 0x9986
{
	...
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		...
		if (WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 7) || (iVar0 == joaat("weapon_petrolcan") && PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330())))
		{
			if (PED::IS_PED_ON_FOOT(AUDIO::_0x0626A247D2405330()))
			{
				if (!PED::IS_PED_INJURED(iLocal_49[0]))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_49[0], AUDIO::_0x0626A247D2405330(), 12f, 12f, 5f, 0, 1, 0))
					{
						return 1;
					}
				}
				if (!PED::IS_PED_INJURED(iLocal_49[1]))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_49[1], AUDIO::_0x0626A247D2405330(), 12f, 12f, 5f, 0, 1, 0))
					{
						return 1;
					}
				}
...
int func_152()//Position - 0x9A37
{
	...
	while (iVar0 < iLocal_49)
	{
		if ((((((!PED::IS_PED_INJURED(iLocal_49[iVar0]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_49[iVar0], AUDIO::_0x0626A247D2405330(), 1)) || (!PED::IS_PED_INJURED(iLocal_49[iVar0]) && PED::IS_PED_IN_COMBAT(iLocal_49[iVar0], AUDIO::_0x0626A247D2405330()))) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_49[iVar0], AUDIO::_0x0626A247D2405330(), 1)) || (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_50, AUDIO::_0x0626A247D2405330(), 1) && func_66())) || PED::IS_PED_INJURED(iLocal_49[iVar0])) || ENTITY::IS_ENTITY_DEAD(iLocal_49[iVar0], 0))
		{
			return 1;
		}
		iVar0++;
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_50, 0))
	{
		...
		while (iVar0 < iLocal_49)
		{
			if (!PED::IS_PED_INJURED(iLocal_49[iVar0]))
			{
				if (PED::IS_PED_JACKING(AUDIO::_0x0626A247D2405330()) && PED::IS_PED_BEING_JACKED(iLocal_49[iVar0]))
				{
					return 1;
				}
			}
	...
	{
		if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_63, 25f, 25f, 20f, false, true, 0))
		{
			return 1;
		}
	}
...
int func_153()//Position - 0x9C2A
{
	...
	while (iVar0 < iLocal_49)
	{
		...
		{
			if ((!PED::IS_PED_INJURED(iLocal_49[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_49[iVar0], 0)) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				if ((MISC::IS_BULLET_IN_AREA(unk_0x8000C77B5F336760(iLocal_49[iVar0], true), 5f, 1) || func_31(unk_0x8000C77B5F336760(iLocal_49[iVar0], true) + Vector(5f, 10f, 10f), unk_0x8000C77B5F336760(iLocal_49[iVar0], true) - Vector(5f, 5f, 5f), 0f, 0f, 0f, 0, 0)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_49[iVar0], AUDIO::_0x0626A247D2405330(), 1))
				{
					bLocal_80 = true;
					return 1;
				}
...
void func_154()//Position - 0x9CEF
{
	...
	if (iLocal_44 == 3)
	{
		iLocal_49[0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_50, 26, iLocal_73, 4294967295, 1, true);
	...
	else
	{
		...
		BRAIN::TASK_LOOK_AT_ENTITY(iLocal_49[1], iLocal_49[0], 4294967295, 0, 2);
	}
	func_79(iLocal_49[1]);
	...
	while (iVar0 < iLocal_49)
	{
		...
		WEAPON::GIVE_WEAPON_TO_PED(iLocal_49[iVar0], joaat("weapon_pistol"), 4294967295, false, true);
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, 2761840924, iLocal_60);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_60, 2761840924);
	...
	if (func_11() == 0 && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		func_68(&Local_106, 0, AUDIO::_0x0626A247D2405330(), "MICHAEL", 0, 1);
	}
	if (func_11() == 1 && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		func_68(&Local_106, 1, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
	}
	if (func_11() == 2 && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		func_68(&Local_106, 2, AUDIO::_0x0626A247D2405330(), "TREVOR", 0, 1);
	}
...
float func_155(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xA062
{
	vector3 vVar0;
...
int func_157(var uParam0)//Position - 0xA0EE
{
	int iVar0;
...
bool func_158(var uParam0)//Position - 0xA150
{
	return func_159(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

int func_159(int iParam0, char* sParam1, int iParam2)//Position - 0xA167
{
...
int func_160(int iParam0)//Position - 0xA25B
{
	int iVar0;
...
void func_161(var uParam0, int iParam1)//Position - 0xA287
{
	if (iParam1 > 0)
	{
...
void func_162(var uParam0, char* sParam1)//Position - 0xA29E
{
	func_163(uParam0, 1, 4294967295, sParam1, 0);
}

void func_163(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4)//Position - 0xA2B1
{
	int iVar0;
...
void func_164(var uParam0, int iParam1)//Position - 0xA399
{
	func_163(uParam0, 0, iParam1, "NULL", 0);
}

int func_165()//Position - 0xA3AD
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(AUDIO::_0x0626A247D2405330())) > 1369f && !func_176())
		{
			return 0;
		}
	}
...
int func_166(float fParam0, bool bParam1)//Position - 0xA433
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_167(int iParam0, var uParam1)//Position - 0xA4EA
{
	switch (iParam0)
	{
		case 0:
		...
		case 1:
			func_168(uParam1, "Abigail2", func_170(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, 4294967295, 4, 1, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 2:
			func_168(uParam1, "Barry1", func_170(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 3:
			func_168(uParam1, "Barry2", func_170(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_169(iParam0), 1, 1);
			break;
		
		case 4:
			func_168(uParam1, "Barry3", func_170(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", 4294967295, 0, "", 164, 1, 4294967295, 0, 2, 0, 2359, func_169(iParam0), 0, 0);
			break;
		...
		case 7:
			func_168(uParam1, "Barry4", func_170(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, 4294967295, 4, 2, 800, 2000, func_169(iParam0), 0, 0);
			break;
		
		case 8:
			func_168(uParam1, "Dreyfuss1", func_170(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_169(iParam0), 0, 0);
			break;
		...
		case 15:
			func_168(uParam1, "Epsilon7", func_170(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", 4294967295, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 16:
			func_168(uParam1, "Epsilon8", func_170(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, 4294967295, 4, 1, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 17:
			func_168(uParam1, "Extreme1", func_170(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", 4294967295, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		...
		case 20:
			func_168(uParam1, "Extreme4", func_170(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 21:
			func_168(uParam1, "Fanatic1", func_170(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 700, 2000, func_169(iParam0), 1, 0);
			break;
		
		case 22:
			func_168(uParam1, "Fanatic2", func_170(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 700, 2000, func_169(iParam0), 1, 0);
			break;
		
		case 23:
			func_168(uParam1, "Fanatic3", func_170(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 2, 700, 2000, func_169(iParam0), 0, 1);
			break;
		
		case 24:
			func_168(uParam1, "Hao1", func_170(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", 4294967295, 0, "controller_Races", 13, 1, 4294967295, 4, 2, 2000, 500, func_169(iParam0), 0, 1);
			break;
		
		case 25:
			func_168(uParam1, "Hunting1", func_170(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", 4294967295, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 26:
			func_168(uParam1, "Hunting2", func_170(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, 4294967295, 4, 4, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 27:
			func_168(uParam1, "Josh1", func_170(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", 4294967295, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_169(iParam0), 1, 0);
			break;
		...
		case 29:
			func_168(uParam1, "Josh3", func_170(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 4294967295, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_169(iParam0), 1, 1);
			break;
		
		case 30:
			func_168(uParam1, "Josh4", func_170(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", 4294967295, 36, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 31:
			func_168(uParam1, "Maude1", func_170(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", 4294967295, 0, "BailBond_Launcher", 0, 1, 4294967295, 4, 4, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 32:
			func_168(uParam1, "Minute1", func_170(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", 4294967295, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 33:
			func_168(uParam1, "Minute2", func_170(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", 4294967295, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 34:
			func_168(uParam1, "Minute3", func_170(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", 4294967295, 10, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 35:
			func_168(uParam1, "MrsPhilips1", func_170(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", 4294967295, 0, "ambient_MrsPhilips", 0, 1, 4294967295, 4, 4, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 36:
			func_168(uParam1, "MrsPhilips2", func_170(iParam0), 0, 11, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 37:
			func_168(uParam1, "Nigel1", func_170(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", 4294967295, 0, "", 177, 1, 4294967295, 1, 4, 0, 2359, func_169(iParam0), 1, 0);
			break;
		...
		case 42:
			func_168(uParam1, "Nigel2", func_170(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", 4294967295, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_169(iParam0), 1, 1);
			break;
		
		case 43:
			func_168(uParam1, "Nigel3", func_170(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", 4294967295, 16, "postRC_Nigel3", 0, 0, 4294967295, 4, 4, 0, 2359, func_169(iParam0), 1, 1);
			break;
		
		case 44:
			func_168(uParam1, "Omega1", func_170(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", 4294967295, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 45:
			func_168(uParam1, "Omega2", func_170(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 46:
			func_168(uParam1, "Paparazzo1", func_170(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", 4294967295, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 47:
			func_168(uParam1, "Paparazzo2", func_170(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", 4294967295, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 48:
			func_168(uParam1, "Paparazzo3", func_170(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", 4294967295, 8, "", 183, 1, 4294967295, 2, 2, 0, 2359, func_169(iParam0), 0, 0);
			break;
		...
		case 51:
			func_168(uParam1, "Paparazzo4", func_170(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", 4294967295, 8, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 52:
			func_168(uParam1, "Rampage1", func_170(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", 4294967295, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 54:
			func_168(uParam1, "Rampage3", func_170(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", 4294967295, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 55:
			func_168(uParam1, "Rampage4", func_170(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", 4294967295, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 56:
			func_168(uParam1, "Rampage5", func_170(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", 4294967295, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_169(iParam0), 0, 0);
			break;
		
		case 53:
			func_168(uParam1, "Rampage2", func_170(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", 4294967295, 0, "rampage_controller", 0, 0, 4294967295, 4, 4, 0, 2359, func_169(iParam0), 1, 0);
			break;
		
		case 57:
			func_168(uParam1, "TheLastOne", func_170(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 58:
			func_168(uParam1, "Tonya1", func_170(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", 4294967295, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 59:
			func_168(uParam1, "Tonya2", func_170(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 60:
			func_168(uParam1, "Tonya3", func_170(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 61:
			func_168(uParam1, "Tonya4", func_170(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
		
		case 62:
			func_168(uParam1, "Tonya5", func_170(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_169(iParam0), 0, 1);
			break;
...
int func_169(int iParam0)//Position - 0xB7C2
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_170(int iParam0)//Position - 0xBB08
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_171(int iParam0)//Position - 0xBB40
{
	struct<2> Var0;
...
bool func_173()//Position - 0xBFBF
{
	return Global_19D3C > 0;
}

int func_174()//Position - 0xBFCD
{
...
int func_178()//Position - 0xC08A
{
	if ((Global_19E4B == func_59() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_19E4C)
	{
		return 1;
	}
	return 0;
...
void func_179(var uParam0)//Position - 0xC0B5
{
	int iVar0;
...
void func_180(int iParam0)//Position - 0xC13F
{
	func_181(iParam0, &(iParam0->f_2), iParam0->f_1);
}

void func_181(int iParam0, char* sParam1, int iParam2)//Position - 0xC155
{
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 30))
	{
		switch (func_160(*iParam0))
...
void func_183(int iParam0)//Position - 0xC592
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_59();
...
void func_185(int iParam0)//Position - 0xC605
{
	Global_19E4B = iParam0;
}

int func_186(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xC613
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_220(Global_19E56.f_6187.f_2B[iParam1]))
		{
			return 0;
		}
...
bool func_187(int iParam0)//Position - 0xC9AD
{
	int iVar0;
...
int func_188(int iParam0)//Position - 0xC9CE
{
	return func_189(iParam0, 1);
}

int func_189(int iParam0, int iParam1)//Position - 0xC9DD
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_190(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xCA30
{
	func_191(func_202(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_191(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xCA4E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_192(float fParam0, float fParam1, float fParam2)//Position - 0xCC4F
{
	float fVar0;
...
int func_193(int iParam0, int iParam1)//Position - 0xCC91
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_194(int iParam0)//Position - 0xCD33
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_195(int iParam0)//Position - 0xCD46
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_196(int iParam0)//Position - 0xCD59
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_197(int iParam0)//Position - 0xCD6C
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_198(int iParam0)//Position - 0xCD7E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_199(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}

int func_199(bool bParam0, int iParam1, int iParam2)//Position - 0xCDA3
{
	if (bParam0)
	{
		return iParam1;
...
int func_200(int iParam0)//Position - 0xCDBA
{
	return iParam0 & 15;
}

int func_201(int iParam0, int iParam1)//Position - 0xCDC7
{
	int iVar0;
	int iVar1;
...
void func_203(var uParam0, int iParam1)//Position - 0xCF19
{
	if (iParam1 <= 0)
	{
		return;
...
void func_204(var uParam0, int iParam1)//Position - 0xCF9F
{
...
void func_205(var uParam0, int iParam1)//Position - 0xCFD2
{
	int iVar0;
	int iVar1;
...
void func_206(var uParam0, int iParam1)//Position - 0xD023
{
...
void func_207(var uParam0, int iParam1)//Position - 0xD05D
{
...
void func_208(var uParam0, int iParam1)//Position - 0xD098
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_209(int iParam0)//Position - 0xD0D4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_210(int iParam0, int iParam1)//Position - 0xD1B0
{
...
int func_211(int iParam0)//Position - 0xD1D3
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_1()) || Global_19A9D) || Global_6375) || func_218()) || func_18(8, 4294967295)) || func_217()) || func_216()) || func_215()) || func_214()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_1()) || Global_6375) || func_218()) || func_18(8, 4294967295)) || func_215()) || func_217()) || func_216()) || func_214()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_1()) || Global_19A9D) || Global_6375) || func_218()) || func_18(8, 4294967295)) || func_215()) || func_217()) || func_216()) || func_214()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_1()) || Global_19A9D) || Global_6375) || func_218()) || func_18(8, 4294967295)) || func_217()) || func_216()) || func_214()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_1() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_18(8, 4294967295)) || func_214()) || func_213()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_18(8, 4294967295) || func_217()) || func_216()) || func_213()) || func_212())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_1()) || Global_6375) || func_218()) || func_18(8, 4294967295)) || func_216()) || func_215()) || func_214()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_212()//Position - 0xD8F0
{
	return Global_16C57.f_1;
}

int func_213()//Position - 0xD8FE
{
	if (Global_16089 != 4294967295)
	{
...
bool func_216()//Position - 0xD968
{
	return Global_16C64.f_148 > 0;
}

bool func_217()//Position - 0xD979
{
	return Global_16C64.f_147 > 0;
}

var func_218()//Position - 0xD98A
{
	return Global_140859;
}

int func_219()//Position - 0xD996
{
	func_10();
	if (Global_C74[Global_38B1 /*2811*/][0 /*281*/].f_103 == 2)
	{
...
bool func_220(int iParam0)//Position - 0xD9BE
{
	return func_201(func_202(), iParam0);
}

int func_221(int iParam0, int iParam1, int iParam2)//Position - 0xD9D0
{
	int iVar0;
	int iVar1;
...
int func_222(int iParam0)//Position - 0xDAB4
{
	if (!func_13(iParam0))
	{
		return 7;
...
bool func_223(int iParam0)//Position - 0xDAD8
{
	int iVar0;
	bool bVar1;
...
void func_227(var uParam0, bool bParam1)//Position - 0xDCE3
{
	int iVar0;
...
void func_228(var uParam0)//Position - 0xDD1E
{
	*uParam0 = 0;
...
void func_229(var uParam0)//Position - 0xDD37
{
	int iVar0;
...
void func_230(var uParam0)//Position - 0xDD70
{
	func_231(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

void func_231(int iParam0, char* sParam1, int iParam2)//Position - 0xDD87
{
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 30))
	{
		switch (func_160(iParam0))
...
void func_232(int iParam0)//Position - 0xDE47
{
	char cVar0[64];
...
void func_233(var uParam0)//Position - 0xDEFC
{
	if (*uParam0 == 4294967295)
	{
		return;
...
char* func_234(int iParam0, bool bParam1)//Position - 0xDF39
{
	switch (iParam0)
	{
		case 0:
...
void func_235(int iParam0)//Position - 0xE182
{
	Global_8F3C = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_236(int iParam0)//Position - 0xE194
{
	func_237(iParam0, 0, func_242(iParam0));
}

void func_237(int iParam0, int iParam1, int iParam2)//Position - 0xE1A9
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_238(var uParam0)//Position - 0xE1D8
{
	struct<16> Var0;
	int iVar1;
...
void func_239(int iParam0, var uParam1)//Position - 0xE2A9
{
	Global_19E56.f_6187.f_2B[iParam0] = *uParam1;
}

void func_240(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xE2C1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_241(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xE443
{
...
int func_242(int iParam0)//Position - 0xE47B
{
	int iVar0;
...
int func_243(int iParam0)//Position - 0xE61E
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
