...
int func_39(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_82(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_82(iParam1), Global_70671[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, 0);
		}
	}
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_70671[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iVar0), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_82(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iVar0), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, iParam4);
						}
						func_73(iVar0);
						if (Global_70669 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_82(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, iParam4);
		}
		if (Global_70669 == 1)
		{
			iVar2 = 0;
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_93(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
		...
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_93(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_155(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_70671[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_82(iParam1)) && Global_70671[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_82(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_161()
{
	...
	{
		if (func_157(Global_104555.f_2353.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_172()
{
	...
	{
		func_161();
		GRAPHICS::_0xBF59707B3E5ED531(func_173(Global_104555.f_2353.f_539.f_4301));
	}
	else
	{
...
{
	func_227(&Global_98118, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_246(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2547365[iParam0 /*3*/][func_76(iParam1)];
...
int func_262(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_282())
		{
			*uParam0 = func_267(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_297(char* sParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
			...
			if (((Local_260[iVar0 /*54*/][iVar1 /*17*/].f_3 != 1 && Local_260[iVar0 /*54*/][iVar1 /*17*/].f_3 != 0) && Local_260[iVar0 /*54*/].f_52 != 4) && Local_260[iVar0 /*54*/].f_52 != 5)
			{
				if (!func_300(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6))
				{
					if (!Local_260[iVar0 /*54*/][iVar1 /*17*/].f_1)
					{
						...
						vLocal_421[iVar0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6, 1) };
						iLocal_303[iVar0] = 1;
				...
				else if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6, 1), 2f, 0))
				{
					iLocal_277 = 0;
					iLocal_281 = 1;
					iLocal_330 = 0;
					...
					while (iLocal_330 < 3)
					{
						...
						{
							Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_14 = { ENTITY::GET_ENTITY_COORDS(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, 1) };
							Local_260[iVar0 /*54*/].f_52 = 4;
						}
	...
	while (iVar0 < 5)
	{
		...
		switch (Local_259[iVar0 /*29*/].f_13)
		{
			...
			case 8:
				...
				{
					vVar2 = { ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_12, 1) };
					if (!PED::IS_PED_IN_ANY_VEHICLE(Local_259[iVar0 /*29*/].f_12, 0))
					{
			...
			case 13:
				if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_28, 0), ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_12, 1), false) > 100f)
					{
						Local_259[iVar0 /*29*/].f_13 = 15;
					}
				}
		...
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_376, ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_28, 1), true) > 450f)
			{
				Local_259[iVar0 /*29*/].f_13 = 15;
			}
		}
...
int func_360()
{
	...
	if (func_300(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_300(iLocal_348))
		{
			vVar1 = { ENTITY::GET_ENTITY_COORDS(iLocal_348, 1) };
...
void func_404(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_408(PLAYER::PLAYER_ID())) && !func_406(PLAYER::PLAYER_ID(), 0)) && !func_405())
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_408(PLAYER::PLAYER_ID()))
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_70854 = 0;
			...
			case 17:
				...
				if (!iLocal_301[15])
				{
					if (func_360())
					{
						if (!func_217())
						{
							if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), vLocal_358, true) > 10f)
							{
...
bool func_454(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	func_328(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_475(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		case 0:
		...
		case 4:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && func_454(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
void func_483()
{
	if (!PED::IS_PED_INJURED(iLocal_348))
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_346))
		{
			...
			{
				iLocal_346 = OBJECT::CREATE_OBJECT(iLocal_342, ENTITY::GET_ENTITY_COORDS(iLocal_348, 1), false, false, false);
			}
		}
...
{
	if (((!func_498(0) || Global_71125) || Global_71114 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71110)
