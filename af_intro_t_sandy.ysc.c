...
void func_12(int iParam0)//Position - 0x9A7
{
	...
	while (iVar1 < Global_19E56.f_1DEC.f_C6)
	{
		...
		{
			func_13(Global_19E56.f_1DEC.f_89[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
void func_15(int iParam0)//Position - 0xB17
{
	...
	uVar1 = Global_19E56.f_1DEC[iParam0 /*15*/].f_2;
	...
	while (iVar0 < 3)
	{
		if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uVar1, iVar0))
		{
			func_9(iVar0);
		}
		iVar0++;
...
void func_21()//Position - 0xD81
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_24(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_10(iVar0) && (!func_22(14) || Global_19A3D))
			{
