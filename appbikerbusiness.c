...
void __EntryFunction__()
{
	...
	iLocal_768 = -1;
	iLocal_769 = -1;
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_KEY("appBikerBusiness")) > 1)
	{
		func_468(1);
	}
	uLocal_755 = REQUEST_SCALEFORM_MOVIE("BIKER_BUSINESSES");
	while (!HAS_SCALEFORM_MOVIE_LOADED(uLocal_755))
	{
		WAIT(0);
	}
	func_466(1);
	...
	{
		iLocal_584 = func_458(PLAYER_ID());
	}
	else
	{
		func_449(PLAYER_ID(), 0, 0, 0);
	}
	func_431();
	if (DOES_ENTITY_EXIST(PLAYER_PED_ID()) && !IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
	{
		vLocal_567 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
	}
	...
	if (iLocal_584 != 0)
	{
		...
		if (iVar0 != -1)
		{
			if (func_422(PLAYER_ID(), iLocal_584) == func_421(iLocal_584))
			{
				if (!IS_BIT_SET(Global_1365075, iVar0))
				{
					func_420(iVar0, 1, 0);
					SET_BIT(&Global_1365075, iVar0);
				}
			}
			else
			{
				CLEAR_BIT(&Global_1365075, iVar0);
			}
		}
	}
	while (func_419())
	{
		if (IS_BIT_SET(Global_1589819[PLAYER_ID() /*818*/].f_273.f_23, 14) || func_418(PLAYER_PED_ID(), vLocal_567, 1) > 5f)
		{
			func_468(0);
		}
		...
		if (func_417(PLAYER_ID()) || ((!func_428(7638, -1, -1) && func_415(PLAYER_ID())) && func_397()))
		{
			func_396(7638, 1, -1, 1);
		}
		func_383();
		...
		else if (iLocal_581 != 190)
		{
			...
			else if (func_8(&uLocal_586, 200, 0))
			{
				if (!Global_1671156)
				{
					func_3(PLAYER_ID(), iLocal_584, iLocal_585, 1);
					Global_1671156 = 1;
					func_468(0);
				}
		...
		{
			if (IS_BIT_SET(Global_1365042, 0))
			{
				func_1();
			}
...
void func_11()
{
	...
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_755, "GET_CURRENT_SELECTION");
		uLocal_756 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
		BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_755, "GET_SELECTED_BUSINESS_ID");
		uLocal_758 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
		BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_755, "GET_CURRENT_SCREEN_ID");
		uLocal_759 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
		iLocal_572 = 0;
		iLocal_571 = 0;
	}
	if ((IS_CONTROL_JUST_PRESSED(2, 202) || IS_CONTROL_JUST_PRESSED(2, 238)) && iLocal_572)
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_755, "GET_CURRENT_SCREEN_ID");
		uLocal_759 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
		iLocal_572 = 0;
	}
	if (IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_759) && !iLocal_572)
	{
		iLocal_580 = GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_759);
		iLocal_572 = 1;
	}
	if (iLocal_576 && !iLocal_577)
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_755, "GET_CURRENT_ROLLOVER");
		uLocal_757 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
		iLocal_577 = 1;
	}
	if (iLocal_577)
	{
		if (IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_757))
		{
			iLocal_578 = GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_757);
			iLocal_577 = 0;
		}
	}
	if (iLocal_578 == 3014 && func_381())
	{
		...
		END_TEXT_COMMAND_DISPLAY_HELP(0, 0, 1, 8000);
	...
	if (!iLocal_571)
	{
		if (IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_756) && IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_758))
		{
			iVar1 = GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_756);
			iVar2 = GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_758);
			iVar3 = -1;
			if (iLocal_584 != 0)
			{
			...
			switch (iVar1)
			{
				...
				case 102:
					func_215(0, iVar2);
					PLAY_SOUND_FRONTEND(-1, "Click_Cancel", "DLC_Biker_Computer_Sounds", 1);
					break;
				...
				case 3002:
					if (Global_1589819[PLAYER_ID() /*818*/].f_273.f_177[iVar3 /*12*/].f_4 <= 0)
					{
				...
				case 3003:
					...
					{
						if (func_174(PLAYER_ID()) && !func_177(PLAYER_ID()))
						{
				...
				case 3014:
					...
					else if (!NETWORK_CAN_SPEND_MONEY(iVar7, 0, 1, 0, -1, 0))
					{
...
int func_16(int iParam0)
{
	...
	iVar1 = func_422(PLAYER_ID(), iParam0);
...
void func_18(int iParam0, int iParam1)
{
	...
	else if (Global_1589819[PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_4 <= 0)
	{
		func_190(0, "OR_UPGR_NS", "OR_OVRLY_OK", "", -1, 1);
	}
	...
	else if (func_28(PLAYER_ID(), iLocal_584, iParam0))
	{
		func_190(0, "OR_UPGR_OWN", "OR_OVRLY_OK", "", -1, 1);
	}
	else if (NETWORK_CAN_SPEND_MONEY(func_19(iParam0, iLocal_584), 0, 1, 0, -1, 0))
	{
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5)
{
	switch (iParam0)
	{
		case 148:
		...
		case 229:
		case 230:
			return func_100(iParam1, iParam2, iParam3, INT_TO_PLAYERINDEX(uParam5), iParam4);
		
		case 233:
			return func_93(iParam1, iParam2, iParam3, INT_TO_PLAYERINDEX(uParam5), iParam4);
		...
		case 243:
			return func_76(iParam1, iParam2, INT_TO_PLAYERINDEX(uParam5), iParam4);
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5)
{
	switch (iParam0)
	{
		case 148:
		...
		case 229:
		case 230:
			return func_137(iParam1, iParam3, iParam4, INT_TO_PLAYERINDEX(uParam5), 0, 0, 0);
		
		case 233:
			return func_131(iParam1, iParam3, iParam4, INT_TO_PLAYERINDEX(uParam5), 0, 0, 0);
			return 6;
		...
		case 243:
			return func_122(iParam1, iParam3, INT_TO_PLAYERINDEX(uParam5), 0, -1, 0, 0);
...
{
	if (!func_176(PLAYER_ID(), iParam0, 0))
	{
		return 0;
	}
...
int func_178(int iParam0)
{
	...
	else if (!func_187(PLAYER_ID(), iVar0) && !func_186(iVar0))
	{
		return 2;
	}
...
int func_179(int iParam0, int iParam1)
{
	if (iParam0 == 5)
	{
		if (Global_1365067[iParam0] > 0 && (!func_184(iParam1) || !func_180(PLAYER_ID(), iParam1)))
		{
			if (!Global_262145.f_20950 || func_174(PLAYER_ID()))
			{
				return 1;
			}
		}
	...
	if ((Global_1365067[iParam0] > 0 && !func_184(iParam1)) && (!Global_262145.f_18353 || func_64(PLAYER_ID())))
	{
		return 1;
	}
	return 0;
...
{
	return func_185(PLAYER_ID(), iParam0);
}
...
{
	iLocal_579 = iParam0;
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_755, "SHOW_OVERLAY");
	...
	_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING_2(sParam2);
	_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING_2(sParam3);
	END_SCALEFORM_MOVIE_METHOD();
	if (bParam5)
	{
		PLAY_SOUND_FRONTEND(-1, "Click_Fail", "DLC_Biker_Computer_Sounds", 1);
	}
	iLocal_574 = 1;
}
...
void func_191(int iParam0, int iParam1)
{
	...
	if (func_207(PLAYER_ID(), func_27(iVar0)))
	{
		iVar3 = func_206(PLAYER_ID(), func_27(iVar0));
	...
	if (iVar2 > 0 && !NETWORK_CAN_SPEND_MONEY(iVar2, 0, 1, 0, -1, 0))
	{
...
{
	if (func_193(iParam0) || func_7(PLAYER_ID(), iParam0))
	{
		return 0;
	}
	return 1;
...
void func_215(bool bParam0, int iParam1)
{
	...
	CALL_SCALEFORM_MOVIE_METHOD(uLocal_755, "HIDE_OVERLAY");
	iLocal_574 = 0;
	if (bParam0)
	{
		switch (iLocal_579)
		{
			case 2001:
				if (iLocal_573)
				{
					CALL_SCALEFORM_MOVIE_METHOD(uLocal_755, "SHOW_HOMEPAGE");
					iLocal_573 = 0;
				}
				else if (!func_193(iParam1))
				{
					PLAY_SOUND_FRONTEND(-1, "Click_Special", "DLC_Biker_Computer_Sounds", 1);
					if (func_207(PLAYER_ID(), func_27(iParam1)))
					{
						func_374(iParam1);
						func_373(iVar0, 0);
					}
			...
			case 3005:
				PLAY_SOUND_FRONTEND(-1, "Business_Shutdown", "DLC_Biker_Computer_Sounds", 1);
				iVar0 = func_423(iLocal_584);
				func_296();
				func_373(iVar0, 1);
				func_431();
				if (func_295(PLAYER_ID()))
				{
					...
					if (func_293(iVar2))
					{
						...
						func_282(iVar3);
						SET_BIT(&Global_1671152, iVar0);
					}
				}
				break;
			
			case 3006:
				PLAY_SOUND_FRONTEND(-1, "Business_Restart", "DLC_Biker_Computer_Sounds", 1);
				iVar0 = func_423(iLocal_584);
	...
	while (!func_8(&uVar7, 15000, 0))
	{
		...
		while (iVar10 < GET_NUMBER_OF_EVENTS(1))
		{
			if (GET_EVENT_AT_INDEX(1, iVar10) == 223)
			{
				...
				{
					if (vVar0.x == iLocal_769 && vVar0.x != -1)
					{
						if (vVar0.z == 0)
						{
							return 1;
...
void func_220(int iParam0, int iParam1)
{
	...
	uVar4 = GET_HASH_KEY(func_209(iParam0));
...
int func_275(int iParam0)
{
	...
	if (bVar0)
	{
		if (iVar2 > 0)
		{
			vVar8.x = GET_HASH_KEY(func_209(iLocal_584));
			vVar8.y = iVar6;
			vVar8.z = iParam0;
			_0x675D19C6067CAE08(iVar2, &vVar8, 0, 1);
		}
		iLocal_570 = 1;
		if (func_25())
		{
			...
			if (func_260(func_268()))
			{
				if (func_259(func_268()) == 2)
				{
					*uParam5 = 2;
					if (iParam4 != 0)
					{
						unk_0x7D3EC9370CE8AE07(func_262(func_268()));
...
{
	if (!func_28(PLAYER_ID(), iParam1, iParam0) && NETWORK_CAN_SPEND_MONEY(func_19(iParam0, iParam1), 0, 1, 0, -1, 0))
	{
		return 1;
	}
	return 0;
...
void func_282(int iParam0)
{
	...
	iVar0 = func_289(PLAYER_ID(), iParam0);
	if (!func_288(iVar0))
	{
		return;
	}
...
void func_296()
{
	...
	iVar0 = func_423(iLocal_584);
	if (func_25() && func_422(PLAYER_ID(), iLocal_584) > 0)
	{
		iVar1 = func_269(1);
		iLocal_764 = 1;
		while (!func_258(iVar0, iVar1, &iLocal_767))
		...
		{
			iLocal_767 = 0;
			iVar2 = func_422(PLAYER_ID(), iLocal_584);
			...
			if (iLocal_767 == 2)
			{
				func_297(PLAYER_ID(), iLocal_584, 1, 0, 0, 0);
				func_420(iVar0, 0, 0);
			}
		}
	}
		...
		case 1:
			if (func_260(func_268()))
			{
				if (func_259(func_268()) == 2)
				{
					...
					{
						unk_0x7D3EC9370CE8AE07(func_262(func_268()));
						iVar0 = func_188(PLAYER_ID(), iParam0);
						iVar1 = func_27(iVar0);
						_0x8586789730B10CAF(iParam2, GET_HASH_KEY(func_209(iVar0)), iVar1, iParam5);
					}
					*iParam4 = 2;
					func_224(func_268());
				}
...
int func_317(int iParam0)
{
	...
	iVar0 = iParam0;
	iVar1 = func_27(iVar0);
	iVar2 = func_206(PLAYER_ID(), iVar1);
...
void func_318(int iParam0)
{
	...
	while (iVar2 < 6)
	{
		if (Global_1589819[PLAYER_ID() /*818*/].f_273.f_177[iVar2 /*12*/] == 0)
		{
			iVar1 = iVar2;
		}
		else
...
void func_321()
{
	...
	Global_1365064 = GET_CLOUD_TIME_AS_INT();
}
...
void func_322(int iParam0)
{
	...
	if (Global_1589819[PLAYER_ID() /*818*/].f_273.f_177[iParam0 /*12*/] != 0 && Global_1365057[iParam0] != 0)
	{
		iVar0 = (GET_CLOUD_TIME_AS_INT() - Global_1365057[iParam0]);
		if (iVar0 > 1000000)
		{
		}
		else
...
{
	Global_1365057[iParam0] = GET_CLOUD_TIME_AS_INT();
...
void func_326(int iParam0)
{
	...
	bVar1 = func_211(iVar0);
	iVar2 = func_27(iVar0);
	uVar3 = func_178(iVar0);
	bVar4 = false;
	uVar5 = GET_NAME_OF_ZONE(func_350(iVar0, 0));
	...
	iVar15 = func_422(PLAYER_ID(), iVar0);
	uVar16 = func_348(PLAYER_ID(), iVar0, iVar15);
	iVar17 = 0;
	iVar18 = 0;
	iVar19 = 0;
	iVar20 = 0;
	...
	if (func_7(PLAYER_ID(), iVar0))
	{
		...
		bVar4 = Global_1589819[PLAYER_ID() /*818*/].f_273.f_177[iVar11 /*12*/].f_4 > 0;
		if (bVar4 || func_330(iVar0))
		{
			iVar28 = 1;
		}
	}
	fVar29 = ((TO_FLOAT(iVar15) / TO_FLOAT(iVar14)) * 100f);
	uVar30 = ROUND(fVar29);
	if (iVar17 < 0)
	{
		iVar17 = 0;
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_755, "ADD_BUSINESS");
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar2);
	_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING_2(&Var6);
	_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING_2(uVar5);
	_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING_2(&Var6);
	...
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uVar30);
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uVar16);
	...
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(iVar28);
	...
	END_SCALEFORM_MOVIE_METHOD();
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_755, "ADD_BUSINESS_STATS");
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	...
	END_SCALEFORM_MOVIE_METHOD();
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_755, "SET_START_PRODUCTION_STATUS");
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(bVar4);
	END_SCALEFORM_MOVIE_METHOD();
}
...
int func_330(int iParam0)
{
	...
	iVar0 = func_423(iParam0);
	if ((func_7(PLAYER_ID(), iParam0) && Global_1365067[iVar0] < Global_262145.f_17791) && !func_189(iVar0))
	{
		return 1;
	}
	return 0;
...
struct<4> func_349(int iParam0, int iParam1)
{
	...
	{
		StringIntConCat(&Var0, CEIL((TO_FLOAT(iVar4) / 5f)), 16);
	}
...
bool func_351(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
...
void func_352(int iParam0)
{
	...
	if (func_6(iParam0))
	{
		...
		else
		{
			...
			while (iVar1 <= 5)
			{
				if (Global_1589819[PLAYER_ID() /*818*/].f_273.f_177[iVar1 /*12*/] == 0)
				{
					iVar0 = iVar1;
				}
				else
		...
		Global_1589819[PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/] = iParam0;
		if (func_183(iParam0))
		{
			Global_1589819[PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_11 = 0;
			func_377(9359, 0, -1, 1);
...
void func_356(int iParam0)
{
	...
	if (bVar5)
	{
		if (!IS_BIT_SET(iVar4, uVar3))
		{
			SET_BIT(&iVar4, uVar3);
			func_217(6154, iVar4, -1, 1, 0);
		}
	}
	else if (IS_BIT_SET(iVar4, uVar3))
	{
		CLEAR_BIT(&iVar4, uVar3);
		func_217(6154, iVar4, -1, 1, 0);
	}
}
...
int func_362(int iParam0, int iParam1, int iParam2)
{
	...
	iVar7 = CEIL((TO_FLOAT(func_208(iParam0)) * Global_262145.f_77));
	iVar0 = iVar7;
	...
	else
	{
		*iParam1 = func_423(iParam2);
		...
		if (iVar1 > 0)
		{
			...
			{
				func_372(GET_HASH_KEY(&cVar3), iVar1, 0);
				iLocal_766 = 1;
				PLAY_SOUND_FRONTEND(-1, "Popup_Confirm_Fail", "GTAO_Exec_SecuroServ_Computer_Sounds", 1);
				return 0;
			}
	...
	vVar14.x = GET_HASH_KEY(func_209(iParam0));
	vVar14.y = func_27(iParam0);
	vVar14.z = -1;
	if (iVar1 > 0)
	{
		func_364(joaat("mpply_ingamestore_moneyspent"), iVar1);
	}
	iParam2 = func_188(PLAYER_ID(), *iParam1);
	...
	if (iParam2 == 0 || iParam2 == 32)
	{
		...
		_0x6FD97159FE3C971A(iVar7, &vVar14, 0, 1);
	}
	else if (func_328(iParam2) > 0)
	{
		...
		NETWORK_EARN_FROM_PROPERTY(iVar2, GET_HASH_KEY(func_209(iParam2)));
		if (func_25())
		{
			unk_0x7D3EC9370CE8AE07(func_262(func_268()));
		}
		_0xA51B086B0B2C0F7A(iVar7, &vVar14, 0, 1);
	}
	if (func_25())
	{
		func_224(func_268());
...
void func_374(int iParam0)
{
	...
	iVar0 = func_27(iParam0);
	iVar1 = func_206(PLAYER_ID(), iVar0);
...
void func_375(int iParam0, int iParam1)
{
	...
	if (func_376(iParam0, iParam1))
	{
		...
		func_302(iVar0, 0);
		func_217(func_303(iVar0), 0, -1, 1, 0);
		Global_1589819[PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_1 = 0;
		func_217(func_304(iVar0), 0, -1, 1, 0);
		Global_1589819[PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_4 = 0;
		func_377(func_305(iVar0), 0, -1, 1);
		Global_1589819[PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_5 = 0;
		func_217(func_274(iVar0, 2), 0, -1, 1, 0);
		func_217(func_274(iVar0, 0), 0, -1, 1, 0);
		func_217(func_274(iVar0, 1), 0, -1, 1, 0);
		Global_1589819[PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_6 = 0;
		func_396(func_255(iVar0), 0, -1, 1);
		if (iVar0 != 5)
		{
			func_361(iVar0);
		}
		Global_1589819[PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_8 = 0;
		func_396(func_299(iVar0), 0, -1, 1);
		if (func_183(iParam0))
		{
			Global_1589819[PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_11 = 0;
...
void func_382()
{
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_755, "SET_INPUT_EVENT", TO_FLOAT(205), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	ENABLE_CONTROL_ACTION(2, 206, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 206))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_755, "SET_INPUT_EVENT", TO_FLOAT(206), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (_IS_INPUT_JUST_DISABLED(2))
	{
		...
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_755, "SET_INPUT_EVENT", TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		ENABLE_CONTROL_ACTION(2, 187, 1);
		if (IS_CONTROL_JUST_PRESSED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_755, "SET_INPUT_EVENT", TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (IS_CONTROL_JUST_RELEASED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_755, "SET_INPUT_RELEASE_EVENT", TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (IS_CONTROL_JUST_RELEASED(2, 188))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_755, "SET_INPUT_RELEASE_EVENT", TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (IS_CONTROL_JUST_PRESSED(2, 188))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_755, "SET_INPUT_EVENT", TO_FLOAT(188), -1082130432, -1082130432, -1082130432, -1082130432);
			iLocal_576 = 1;
		}
		ENABLE_CONTROL_ACTION(2, 187, 1);
		if (IS_CONTROL_JUST_PRESSED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_755, "SET_INPUT_EVENT", TO_FLOAT(187), -1082130432, -1082130432, -1082130432, -1082130432);
			iLocal_576 = 1;
		}
	}
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_755, "SET_INPUT_EVENT", TO_FLOAT(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	ENABLE_CONTROL_ACTION(2, 190, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 190))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_755, "SET_INPUT_EVENT", TO_FLOAT(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	ENABLE_CONTROL_ACTION(2, 201, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 201))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_755, "SET_INPUT_EVENT", TO_FLOAT(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	ENABLE_CONTROL_ACTION(2, 202, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 202))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_755, "SET_INPUT_EVENT", TO_FLOAT(202), -1082130432, -1082130432, -1082130432, -1082130432);
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_755, "SET_INPUT_EVENT", TO_FLOAT(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	ENABLE_CONTROL_ACTION(2, 204, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 204))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_755, "SET_INPUT_EVENT", TO_FLOAT(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (_IS_INPUT_JUST_DISABLED(2))
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_755, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		{
			BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_755, "SET_ANALOG_STICK_INPUT");
			iLocal_760 = iVar0;
			iLocal_761 = iVar1;
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(1);
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_760);
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_761);
			END_SCALEFORM_MOVIE_METHOD();
			iLocal_576 = 1;
		}
	}
	...
	if (((iVar2 != 127 || iLocal_762 != 127) || iVar3 != 127) || iLocal_763 != 127)
	{
		...
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_762);
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_763);
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(bVar4);
		END_SCALEFORM_MOVIE_METHOD();
		if (!bVar4)
		{
...
void func_383()
{
	...
	SET_SCRIPT_GFX_DRAW_ORDER(1);
	DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_755, 255, 255, 255, 255, 0);
	func_390();
	func_387(0);
	func_384(1);
}
...
void func_406()
{
	...
	{
		if (func_409(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
			iVar0 = func_408(PLAYER_PED_ID());
...
{
	if (func_416(Global_1589819[iParam0 /*818*/].f_273.f_25, -1) && !IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_273.f_23, 1))
	{
		return 1;
	}
	return 0;
...
float func_418(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
void func_431()
{
	...
	if (func_448())
	{
		...
		if (!func_17(iLocal_584))
		{
			uVar3 = func_348(PLAYER_ID(), iLocal_584, func_422(PLAYER_ID(), iLocal_584));
			fVar4 = (TO_FLOAT(uVar3) * Global_262145.f_18468);
			uVar5 = ROUND(fVar4);
			func_438(func_237(iLocal_584), &cVar10, &cVar6);
			func_437(iVar1, 1, &cVar6, &cVar10, uVar5, 1);
			func_438(!func_237(iLocal_584), &cVar10, &cVar6);
			fVar4 = (TO_FLOAT(uVar3) * Global_262145.f_18469);
			uVar5 = ROUND(fVar4);
			func_437(iVar1, 2, &cVar6, &cVar10, uVar5, 1);
		}
		iVar14 = 0;
		while (iVar14 < 12)
		{
			...
			if (func_28(PLAYER_ID(), iLocal_584, iVar15) || Global_1589819[PLAYER_ID() /*818*/].f_273.f_177[iVar0 /*12*/].f_4 <= 0)
			{
				iVar16 = 0;
			}
			iVar21 = func_19(iVar15, iLocal_584);
			iVar22 = -1;
			if (func_435(iLocal_584, iVar15) && iVar16)
			{
				iVar22 = iVar21;
				iVar21 = func_434(iVar15, iLocal_584);
			}
			func_432(iVar1, iVar14 + 1, func_433(iVar15), iVar21, iVar22, iVar16, &Var17);
			iVar14++;
		}
	}
	else
...
void func_432(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, var uParam6)
{
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_755, "ADD_BUSINESS_UPGRADE");
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam1);
	_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING_2(uParam2);
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam3);
	_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING_2(uParam6);
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam4);
	END_SCALEFORM_MOVIE_METHOD();
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_755, "SET_BUSINESS_UPGRADE_STATUS");
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam1);
...
void func_437(int iParam0, int iParam1, char[4] cParam2, char* sParam3, var uParam4, int iParam5)
{
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_755, "ADD_BUSINESS_BUYER");
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	...
	END_SCALEFORM_MOVIE_METHOD();
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_755, "SET_BUSINESS_BUYER_STATUS");
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam1);
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(iParam5);
	END_SCALEFORM_MOVIE_METHOD();
...
void func_439(int iParam0)
{
	...
	uVar0 = func_441(PLAYER_ID());
	if (IS_STRING_NULL_OR_EMPTY(uVar0))
	{
		uVar0 = func_440();
	}
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_755, "SET_PLAYER_DATA");
	_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING_2(uVar0);
...
{
	if (((func_34(iParam0, 28) || func_34(PLAYER_ID(), 28)) || func_447(iParam0)) && !func_445(iParam0))
	{
		return func_440();
	}
	if (iParam0 != PLAYER_ID())
	...
	else
	{
		...
		if (NETWORK_IS_PLAYER_ACTIVE(iParam0) && (IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_246(PLAYER_ID(), 0) && !func_454()))
				{
			...
			if (bParam1)
			{
				if (!func_453(uVar25) && !IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar25))
				{
					if (!bVar21)
					{
...
void func_468(int iParam0)
{
	...
	SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_755);
	func_462(iParam0);
	func_464(0);
	func_472();
	_0xA5F377B175A699C5(1000);
	PLAY_SOUND_FRONTEND(-1, "Exit", "DLC_Biker_Computer_Sounds", 1);
	if (IS_PC_VERSION())
	{
		func_424(0, 1, 1, 1);
	}
