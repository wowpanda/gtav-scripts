		...
		if (iLocal_288 != -1)
		{
			if (!func_218())
			{
				*uParam0 = func_217(iLocal_288);
				...
				SET_BIT(&(Global_106565.f_18568[*uParam0 /*6*/]), 0);
				SET_BIT(&(Global_106565.f_18568[*uParam0 /*6*/]), 2);
				CLEAR_BIT(&(Global_106565.f_18568[*uParam0 /*6*/]), 3);
				Global_105652[*uParam0 /*10*/].f_1 = 0;
				if (!func_215(0))
				{
					Global_105652[*uParam0 /*10*/].f_3 = 0;
				}
				if (!func_207(*uParam0))
				{
				...
				{
					func_4(500, 1);
					CLEAR_AREA(vParam1, uParam0->f_15, 1, 0, 0, 0);
...
{
	while (!Global_105652[*uParam0 /*10*/])
	{
		WAIT(0);
	}
	return 1;
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_91043[iVar0]))
		{
			if (Global_91043[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || GET_ENTITY_MODEL(iParam0) == func_37(iParam1, iParam2))
					{
						return 1;
					}
				}
...
int func_51(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2539502[iParam0 /*3*/][func_52(iParam1)];
...
void func_60(int iParam0, bool bParam1)
{
	...
	iVar0 = func_48(iParam0);
	if (func_39(iVar0) && !IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER_PED_ID())
		{
...
void func_61(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_66(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_63(Var11.f_1)) && iVar72 < 51)
			{
...
int func_72(var uParam0)
{
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (func_95())
		{
			*uParam0 = func_78(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_74(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_76() == 0)
		{
			return IS_BIT_SET(func_51(func_75(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_78(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_94(iVar0))
		{
			...
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_79(iVar0, 0), 1);
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_102(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_108(char* sParam0, var uParam1, int iParam2)
{
	...
	PLAYSTATS_MISSION_STARTED(sParam0, uParam1, iParam2, func_215(0));
}
...
int func_147(var uParam0, bool bParam1)
{
	...
	if (Var0.f_4 != 17)
	{
		if (!IS_BIT_SET(Var0.f_26, func_225()))
		{
...
void func_148(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_127(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_150(uParam1) || !IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_149(iParam2) && !IS_PED_FACING_PED(iParam0, PLAYER_PED_ID(), 25f))
					{
						TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_150(uParam1) && uParam1->f_4 == 0) && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_149(iParam2) || IS_PED_FACING_PED(iParam0, PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_156(PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_160(int iParam0, float fParam1)
{
	...
	{
		if (func_171(iParam0) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), iParam0))
		{
...
{
	return func_162(iParam0, PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
...
int func_166(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_168(GET_ENTITY_COORDS(iParam1, 1) - GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		vVar3 = { func_168(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_172(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_127(PLAYER_PED_ID()) && func_127(uParam0))
	{
...
int func_175(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_168(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_168(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_167(vVar3, vVar0);
...
int func_185()
{
	return func_186(GET_THIS_SCRIPT_NAME(), 0);
}
...
void func_191()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if (func_192(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
bool func_218()
{
	...
	else if ((func_221(0) || IS_PLAYER_SWITCH_IN_PROGRESS()) || func_220())
	{
		if (func_2("RAMP_HELP_TRIG"))
		{
			if (func_221(0))
...
int func_224(float fParam0)
{
	...
	while (iVar0 < 5)
	{
		vVar1 = { Global_26140[(iLocal_286 + iVar0) /*23*/][0 /*3*/] };
...
void func_226(var uParam0, vector3 vParam1)
{
	...
	while (true)
	{
		...
		if (*uParam0 == 52 || *uParam0 == 53)
		{
			...
			{
				if (IS_EXPLOSION_IN_SPHERE(-1, GET_ENTITY_COORDS(uParam0->f_28[0], 1), 5.1f))
				{
					if (*uParam0 == 52)
					{
						iVar7 = 0;
						...
						{
							if (DOES_ENTITY_EXIST(uParam0->f_41[iVar7]))
							{
								if ((func_127(uParam0->f_28[0]) && IS_ENTITY_ATTACHED_TO_ENTITY(uParam0->f_41[iVar7], uParam0->f_28[0])) || (func_127(uParam0->f_28[1]) && IS_ENTITY_ATTACHED_TO_ENTITY(uParam0->f_41[iVar7], uParam0->f_28[1])))
								{
									DELETE_OBJECT(&(uParam0->f_41[iVar7]));
								}
							}
							iVar7++;
						}
					...
					APPLY_DAMAGE_TO_PED(uParam0->f_28[0], 1000, 1, 0);
					if (func_127(uParam0->f_28[1]))
					{
						SET_PED_TO_RAGDOLL(uParam0->f_28[1], 100, 500, 0, 1, 1, 0);
						APPLY_DAMAGE_TO_PED(uParam0->f_28[1], 1000, 1, 0);
					}
			...
			if (func_127(uParam0->f_28[1]))
			{
				if (IS_EXPLOSION_IN_SPHERE(-1, GET_ENTITY_COORDS(uParam0->f_28[1], 1), 5.1f))
				{
					if (*uParam0 == 52)
					{
						iVar7 = 0;
		...
		if (func_265(52))
		{
			if (IS_SCENARIO_GROUP_ENABLED("Rampage1"))
			{
				...
				SET_SCENARIO_GROUP_ENABLED("Rampage1", 0);
			}
		}
		func_264(*uParam0);
		...
		vLocal_296 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
...
void func_227(var uParam0)
{
	...
	switch (iLocal_114)
	{
		...
		case 1:
			if (func_127(uParam0->f_28[0]))
			{
				if (func_238(uParam0->f_28[0], PLAYER_PED_ID(), 1) < 30f && IS_ENTITY_ON_SCREEN(uParam0->f_28[0]))
				{
		...
		case 2:
			uLocal_115[0] = CREATE_SYNCHRONIZED_SCENE(vLocal_106, vLocal_109, 2);
			if (func_127(uParam0->f_28[0]))
			{
				func_228(&uLocal_119, "RAMP2AU", "RAMP2_LEADIN", "RAMP2_LEADIN_1", 7, 0, 0);
				TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_115[0], sVar0, "hipster_post_post_irony", 8f, -8f, 513, 0, 1148846080, 0);
			}
			SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_115[0], 0);
			_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_115[0], 1);
			iLocal_114++;
			break;
		
		case 3:
			if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_115[0]))
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_115[0]) >= 0.95f)
				{
					iLocal_114++;
				}
			}
		...
		case 4:
			uLocal_115[1] = CREATE_SYNCHRONIZED_SCENE(vLocal_106, vLocal_109, 2);
			if (func_127(uParam0->f_28[0]))
			{
				func_228(&uLocal_119, "RAMP2AU", "RAMP2_LEADIN", "RAMP2_LEADIN_2", 7, 0, 0);
				TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_115[1], sVar0, "hipster_self_hating_hipster", 8f, -8f, 513, 0, 1148846080, 0);
			}
			SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_115[1], 0);
			_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_115[1], 1);
			iLocal_114++;
			break;
		
		case 5:
			if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_115[1]))
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_115[1]) >= 0.95f)
				{
					iLocal_114++;
				}
			}
		...
		case 6:
			uLocal_115[2] = CREATE_SYNCHRONIZED_SCENE(vLocal_106, vLocal_109, 2);
			if (func_127(uParam0->f_28[0]))
			{
				TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_115[2], sVar0, "hipster_idle", 8f, -8f, 513, 0, 1148846080, 0);
			}
			SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_115[2], 1);
			_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_115[2], 0);
			iLocal_114++;
			break;
...
int func_239(var uParam0)
{
	...
	if (iLocal_113 < 0)
	{
		if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(uParam0->f_28[1], 1)) < 25f)
		{
			return 1;
		}
		switch (*uParam0)
		{
			case 52:
				SET_GAMEPLAY_ENTITY_HINT(uParam0->f_28[0], 0.1f, 0f, 0.9f, 1, -1, 2500, 2000, 0);
			...
			case 54:
				SET_GAMEPLAY_ENTITY_HINT(uParam0->f_28[0], 0f, -0.1f, 0.9f, 1, -1, 2500, 2000, 0);
				TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), uParam0->f_28[0], -1, 0, 2);
				GET_IS_MULTIPLAYER_BRIEF(1);
			...
			case 55:
				SET_GAMEPLAY_ENTITY_HINT(uParam0->f_28[1], 0f, 0f, 0.9f, 1, -1, 2500, 2000, 0);
			...
			case 56:
				SET_GAMEPLAY_ENTITY_HINT(uParam0->f_28[1], 0f, 0f, 0f, 1, -1, 2500, 2000, 0);
				TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), uParam0->f_28[1], -1, 0, 2);
				GET_IS_MULTIPLAYER_BRIEF(1);
				_0xD1F8363DFAD03848(-5f);
		...
		iLocal_113 = GET_GAME_TIMER() + 2500;
	}
	else if (GET_GAME_TIMER() > iLocal_113)
	{
		iLocal_113 = -1;
		return 1;
	}
		...
		case 1:
			if (func_127(uParam0->f_28[0]))
			{
				if (!func_146())
				{
					...
					{
						uLocal_285 = CREATE_SYNCHRONIZED_SCENE(vLocal_106, vLocal_109, 2);
						TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_285, "misstrvram_2", "hipster_cunts_in_america", 8f, -8f, 513, 0, 1148846080, 0);
	...
	switch (uParam0->f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
					if (func_127(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)))
					{
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_220()) || Global_105612) || Global_25767) || func_254()) || func_235(8, -1)) || func_95()) || func_253()) || func_252()) || func_251()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_220()) || Global_25767) || func_254()) || func_235(8, -1)) || func_252()) || func_95()) || func_253()) || func_251()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_220()) || Global_105612) || Global_25767) || func_254()) || func_235(8, -1)) || func_252()) || func_95()) || func_253()) || func_251()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_220()) || Global_105612) || Global_25767) || func_254()) || func_235(8, -1)) || func_95()) || func_253()) || func_251()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_220() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_235(8, -1)) || func_251()) || func_250()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_220()) || Global_25767) || func_254()) || func_235(8, -1)) || func_253()) || func_252()) || func_251()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_220()) || Global_105612) || Global_25767) || func_254()) || func_235(8, -1)) || func_252()) || func_250()) || func_95()) || func_253()) || func_251())
						{
							return 0;
						}
						break;
		...
		switch (*uParam0)
		{
			case 52:
				if (func_127(uParam0->f_28[0]))
				{
					...
					_0x2A56C06EBEF2B0D9((*uParam1)[0], uParam0->f_28[0], 0);
				}
				if (func_127(uParam0->f_28[1]))
				{
					(*uParam1)[1] = "Nervous_WhiteTrash";
					_0x2A56C06EBEF2B0D9((*uParam1)[1], uParam0->f_28[1], 0);
				}
				break;
...
void func_256(int iParam0, var uParam1, vector3 vParam2)
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (!IS_STRING_NULL_OR_EMPTY(uParam1))
		{
			...
			{
				if (func_260(PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_259(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_260(PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_262(iParam0);
				}
			}
...
void func_269(var uParam0)
{
	...
	SET_VEHICLE_EXTRA(uParam0->f_35[0], 1, 0);
	SET_VEHICLE_EXTRA(uParam0->f_35[0], 1, 1);
	FREEZE_ENTITY_POSITION(uParam0->f_35[0], 1);
	if (!func_270(&(uParam0->f_41[0]), joaat("weapon_grenadelauncher"), -1297.84f, 2505.91f, 19.34f, func_325(-0.5f)))
	{
	}
	else
	{
		SET_ENTITY_COLLISION(uParam0->f_41[0], 0, 0);
		SET_ENTITY_COORDS(uParam0->f_41[0], -1297.84f, 2505.91f, 19.34f, 1, 0, 0, 1);
		SET_ENTITY_HEADING(uParam0->f_41[0], func_325(-0.5f));
...
int func_270(var uParam0, int iParam1, vector3 vParam2, float fParam5)
{
	...
	uVar0 = GET_WEAPONTYPE_MODEL(iParam1);
	REQUEST_MODEL(uVar0);
	iVar8 = GET_GAME_TIMER() + 10000;
	while (GET_GAME_TIMER() < iVar8)
	{
		if (HAS_MODEL_LOADED(uVar0))
		{
			*uParam0 = CREATE_WEAPON_OBJECT(iParam1, -1, vParam2, 1, 1065353216, 0, 0, 1);
			SET_MODEL_AS_NO_LONGER_NEEDED(uVar0);
			if (func_324(&uVar1, iParam1, joaat("gun_root")))
			{
				if (HAS_WEAPON_GOT_WEAPON_COMPONENT(*uParam0, func_271(&uVar1, iParam1, joaat("gun_root"), 0)))
				{
					REMOVE_WEAPON_COMPONENT_FROM_WEAPON_OBJECT(*uParam0, func_271(&uVar1, iParam1, joaat("gun_root"), 0));
				}
				else if (HAS_WEAPON_GOT_WEAPON_COMPONENT(*uParam0, func_271(&uVar1, iParam1, joaat("gun_root"), 1)))
				{
					REMOVE_WEAPON_COMPONENT_FROM_WEAPON_OBJECT(*uParam0, func_271(&uVar1, iParam1, joaat("gun_root"), 1));
				}
			}
			if (DOES_ENTITY_EXIST(*uParam0))
			{
	...
	switch (iParam1)
	{
		...
		default:
			...
			if (iVar12 != -1)
			{
				...
				{
					if (GET_DLC_WEAPON_COMPONENT_DATA(iVar12, iVar13, &Var54))
					{
...
int func_273(int iParam0, int iParam1)
{
		...
		switch (iParam0)
		{
			...
			case joaat("weapon_bullpupshotgun"):
				switch (iParam1)
				{
					case joaat("component_at_ar_afgrip"):
						iVar0 = 4100;
						iVar0 = FLOOR((TO_FLOAT(iVar0) * Global_262145.f_14499));
						break;
	...
	if (NETWORK_IS_GAME_IN_PROGRESS() && func_306())
	{
		StringCopy(&Var144, func_304(iParam1, iParam0), 16);
		func_300(&sVar128, Var144, GET_ENTITY_MODEL(PLAYER_PED_ID()), 3, 1, func_302(iParam0), func_301(iParam0), -1, 0, 0);
		if (unk_0x3B6DCE62F381F366(&sVar128))
		{
			iVar0 = unk_0x9F672A3614564F11(GET_HASH_KEY(&sVar128), 1671640801, 1);
		}
	}
	if (iVar0 > 0)
	{
	...
	if (iLocal_104 == 1)
	{
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			*iParam1 = FLOOR((TO_FLOAT(*iParam1) * Global_262145.f_76));
			fVar1 = (fVar1 + (TO_FLOAT(Global_262145.f_121) / 100f));
		}
	}
	if (iLocal_104 == 0)
	{
...
int func_306()
{
	if (NETWORK_IS_GAME_IN_PROGRESS() && func_307())
	{
		return 1;
	}
	return 0;
...
int func_313(int iParam0, int iParam1, int iParam2)
{
	...
	return IS_BIT_SET(uVar0, func_314(iVar1));
}
...
void func_332(var uParam0)
{
	...
	SET_PED_COMPONENT_VARIATION(uParam0->f_28[1], 11, 0, 0, 0);
	GIVE_WEAPON_TO_PED(uParam0->f_28[1], joaat("weapon_assaultrifle"), 100, 1, 1);
...
void func_336(var uParam0)
{
	...
	func_340(&uLocal_112);
	while ((((!HAS_MODEL_LOADED(iVar0) || !HAS_MODEL_LOADED(iVar1)) || !HAS_MODEL_LOADED(iVar2)) || !HAS_ANIM_DICT_LOADED(sVar3)) || !func_339(&uLocal_112))
	{
		WAIT(0);
	}
	...
	{
		SET_ENTITY_COORDS(uParam0->f_41[2], 1180.05f, -401.83f, 66.88f, 1, 0, 0, 1);
	...
	{
		uParam0->f_59 = CREATE_SYNCHRONIZED_SCENE(vLocal_106, vLocal_109, 2);
		if (func_127(uParam0->f_28[0]))
		{
			TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uParam0->f_59, sVar3, "hipster_idle", 8f, -8f, 513, 0, 1148846080, 0);
		}
...
void func_337(var uParam0, bool bParam1, int iParam2)
{
	...
	if (HAS_SCALEFORM_MOVIE_LOADED(*uParam0))
	{
		if (bParam1)
		{
			GET_MOBILE_PHONE_RENDER_ID(&uVar0);
		}
		else
		{
			...
			uVar0 = GET_NAMED_RENDERTARGET_RENDER_ID("npcphone");
		}
		SET_TEXT_RENDER_ID(uVar0);
		BEGIN_SCALEFORM_MOVIE_METHOD(*uParam0, "DISPLAY_VIEW");
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam2);
		END_SCALEFORM_MOVIE_METHOD();
		DRAW_SCALEFORM_MOVIE(*uParam0, Global_14473, Global_14474, Global_14475, Global_14476, 255, 255, 255, 255, 0);
	}
}
...
{
	*uParam0 = REQUEST_SCALEFORM_MOVIE(func_341());
}
...
void func_343(var uParam0)
{
	...
	iVar12 = 146905321;
	iVar13 = 1172836182;
	REQUEST_MODEL(iVar11);
	REQUEST_MODEL(iVar12);
	REQUEST_MODEL(iVar13);
	REQUEST_ANIM_DICT(sVar3);
	REQUEST_WEAPON_ASSET(joaat("weapon_assaultrifle"), 31, 0);
	while ((((!HAS_MODEL_LOADED(iVar11) || !HAS_MODEL_LOADED(iVar12)) || !HAS_MODEL_LOADED(iVar13)) || !HAS_ANIM_DICT_LOADED(sVar3)) || !HAS_WEAPON_ASSET_LOADED(joaat("weapon_assaultrifle")))
	{
		WAIT(0);
	}
	...
	if (func_127(uParam0->f_28[1]))
	{
		...
		FREEZE_ENTITY_POSITION(uParam0->f_28[1], 1);
		SET_PED_CONFIG_FLAG(uParam0->f_28[1], 208, 1);
	...
	if (!IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		uParam0->f_59 = CREATE_SYNCHRONIZED_SCENE(910.13f, 3643.74f, 31.69f, 0f, 0f, func_325(-0.26f), 2);
		if (func_127(uParam0->f_28[0]))
		{
			TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uParam0->f_59, sVar3, "redneck_idle_a", 8f, -8f, 513, 0, 1148846080, 0);
		}
		if (func_127(uParam0->f_28[1]))
		{
			TASK_SYNCHRONIZED_SCENE(uParam0->f_28[1], uParam0->f_59, sVar3, "redneck_idle_b", 8f, -8f, 513, 0, 1148846080, 0);
		}
		SET_SYNCHRONIZED_SCENE_LOOPED(uParam0->f_59, 1);
	}
...
void func_350(var uParam0, bool bParam1)
{
	...
	if (iLocal_299 != 0)
	{
		...
		{
			REMOVE_SCENARIO_BLOCKING_AREA(iLocal_299, 0);
		}
	}
	if (IS_GAMEPLAY_HINT_ACTIVE())
	{
