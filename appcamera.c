...
void __EntryFunction__()
{
	...
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
	{
		...
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			uLocal_149 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
			if ((((GET_ENTITY_MODEL(uLocal_149) == joaat("rhino") || GET_ENTITY_MODEL(uLocal_149) == joaat("cutter")) || GET_ENTITY_MODEL(uLocal_149) == joaat("submersible")) || GET_ENTITY_MODEL(uLocal_149) == joaat("khanjali")) || (GET_ENTITY_MODEL(uLocal_149) == joaat("barrage") && _0xE33FFA906CE74880(uLocal_149, func_146(PLAYER_PED_ID(), 1))))
			{
				Global_16899 = 1;
			}
			else if (GET_PED_IN_VEHICLE_SEAT(uLocal_149, -1, 0) == PLAYER_PED_ID())
			{
				if (GET_ENTITY_UPRIGHT_VALUE(uLocal_149) > 0f)
				{
					if (!Global_71590)
					{
						if (!func_145())
						{
							TASK_VEHICLE_TEMP_ACTION(PLAYER_PED_ID(), uLocal_149, 6, 4000);
						}
					}
				}
			}
	...
	{
		uLocal_140 = REQUEST_SCALEFORM_MOVIE("camera_gallery");
		uLocal_141 = REQUEST_SCALEFORM_MOVIE("instructional_buttons");
		while (!HAS_SCALEFORM_MOVIE_LOADED(uLocal_140) || !HAS_SCALEFORM_MOVIE_LOADED(uLocal_141))
		{
			WAIT(0);
		...
		func_141(uLocal_140, "DISPLAY_VIEW", TO_FLOAT(iLocal_144), -1082130432, -1082130432, -1082130432, -1082130432);
	...
	while (true)
	{
		...
		if (!IS_PAUSE_MENU_ACTIVE())
		{
			...
			if (iLocal_150 == 0)
			{
				SET_INPUT_EXCLUSIVE(0, Global_14526);
			}
			SET_INPUT_EXCLUSIVE(0, Global_14523);
			if ((IS_SCREEN_FADED_OUT() || IS_SCREEN_FADING_OUT()) && !func_137())
			{
				iLocal_130 = 1;
				Global_14553.f_1 = 3;
				SET_GAME_PAUSED(0);
			...
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				if ((GET_PED_CONFIG_FLAG(PLAYER_PED_ID(), 78, 1) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PLAYER_FREE_AIMING(PLAYER_ID()))
				{
					if (func_122())
					{
					}
							...
							if (Global_14553.f_1 > 3)
							{
								if (iLocal_150)
								{
									...
									if (Global_16904 == 0 && Global_16901 == 6)
									{
										...
										if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
										{
											vLocal_67 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
										}
										func_112();
										iLocal_109++;
										if (func_150())
										{
											func_141(uLocal_140, "SET_REMAINING_PHOTOS", TO_FLOAT(iLocal_109), TO_FLOAT(iLocal_110), -1082130432, -1082130432, -1082130432);
										}
										else
										{
											func_141(uLocal_140, "SET_REMAINING_PHOTOS", TO_FLOAT(iLocal_109), TO_FLOAT(iLocal_110), -1082130432, -1082130432, -1082130432);
									...
									if (Global_16901 == 0)
									{
										...
										else if (!IS_BIT_SET(Global_4269308, 2))
										{
											func_141(uLocal_140, "SHOW_PHOTO_FRAME", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
										}
										func_105();
								...
								else if (Global_14553.f_1 != 9)
								{
									...
									if (iLocal_102 == 0)
									{
										if (IS_BIT_SET(Global_2423, 28))
										{
											func_92();
											iLocal_102 = 1;
										}
									}
									else if (!IS_BIT_SET(Global_2423, 28))
									{
										func_92();
										iLocal_102 = 0;
									}
											...
											if (iLocal_136 == 1 || iLocal_136 == 0)
											{
												if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
												{
													if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
													{
														...
														while (GET_GAME_TIMER() < (iLocal_135 + iLocal_137) && Global_14553.f_1 > 3)
														{
															func_135();
															func_116();
															func_80();
			...
			else
			{
				if (iLocal_155 == 1)
				{
					SET_WARNING_MESSAGE_WITH_HEADER("CELL_CAM_ALERT", "CELL_CAM_FW_1", iLocal_152, "CELL_CAM_FW_2", 0, -1, "", "", 1, 0);
				}
				if (iLocal_155 == 2)
				{
					SET_WARNING_MESSAGE_WITH_HEADER("CELL_CAM_ALERT", "ERROR_NO_SC_CAMERAPHONE", iLocal_152, "", 0, -1, "", "", 1, 0);
				}
				if (iLocal_155 == 6)
				{
					SET_WARNING_MESSAGE_WITH_HEADER("CELL_CAM_ALERT", "SC_ERROR_BANNED", iLocal_152, "", 0, -1, "", "", 1, 0);
				}
				if (iLocal_155 == 3)
				{
					SET_WARNING_MESSAGE_WITH_HEADER("CELL_CAM_ALERT", "ERROR_UPDATE_SC_CAMERAPHONE", iLocal_152, "", 0, -1, "", "", 1, 0);
				}
				if (iLocal_155 == 7)
				{
					if (IS_XBOX360_VERSION() || IS_DURANGO_VERSION())
					{
						SET_WARNING_MESSAGE_WITH_HEADER("CELL_CAM_ALERT", "CELL_CAM_TEMP_3X", iLocal_152, "", 0, -1, "", "", 1, 0);
					}
					if (IS_PS3_VERSION() || IS_ORBIS_VERSION())
					{
						SET_WARNING_MESSAGE_WITH_HEADER("CELL_CAM_ALERT", "CELL_CAM_TEMP_3P", iLocal_152, "", 0, -1, "", "", 1, 0);
					}
					if (IS_PC_VERSION())
					{
						SET_WARNING_MESSAGE_WITH_HEADER("CELL_CAM_ALERT", "CELL_CAM_TEMP_30", iLocal_152, "", 0, -1, "", "", 1, 0);
					}
				}
				if (iLocal_155 == 4)
				{
					SET_WARNING_MESSAGE_WITH_HEADER("CELL_CAM_ALERT", "CELL_CAM_CCW_1", iLocal_152, "CELL_CAM_CCW_2", 0, -1, "", "", 1, 0);
				}
				if (iLocal_155 == 5)
				{
					...
					{
						case -1:
							SET_WARNING_MESSAGE_WITH_HEADER("CELL_CAM_ALERT", "HUD_AGE_I", iLocal_152, "", 0, -1, "", "", 1, 0);
							break;
						
						case 0:
							SET_WARNING_MESSAGE_WITH_HEADER("CELL_CAM_ALERT", "HUD_AGE_P", iLocal_152, "", 0, -1, "", "", 1, 0);
							break;
						
						case 1:
							SET_WARNING_MESSAGE_WITH_HEADER("CELL_CAM_ALERT", "HUD_AGE_C", iLocal_152, "", 0, -1, "", "", 1, 0);
							break;
						
						case 2:
							SET_WARNING_MESSAGE_WITH_HEADER("CELL_CAM_ALERT", "HUD_AGE_T", iLocal_152, "", 0, -1, "", "", 1, 0);
							break;
		...
		if (func_3() || iLocal_130)
		{
			...
			Global_16900 = 0;
			Global_16902 = 0;
			SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_140);
			SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_141);
			SET_GAME_PAUSED(0);
			if (Global_14727 == 1)
			{
				SET_BIT(&Global_2423, 17);
			...
			Global_16903 = 1;
			STOP_SOUND(uLocal_112);
			RELEASE_SOUND_ID(uLocal_112);
			_REMOVE_LOADING_PROMPT();
			func_99();
			_0xA2CCBE62CD4C91A4(0);
			_0x375A706A5C2FD084(0);
			...
			{
				SET_STREAMED_TEXTURE_DICT_AS_NO_LONGER_NEEDED(sLocal_33[Global_4268033]);
			}
			CLEAR_BIT(&Global_2423, 18);
			func_97(0, 1);
...
void func_4()
{
	...
	switch (iLocal_106)
	{
		case 0:
			iLocal_103 = 0;
			iLocal_109 = _GET_NUMBER_OF_PHOTOS();
			iLocal_110 = _GET_MAXIMUM_NUMBER_OF_PHOTOS_2();
			if (iLocal_104 == 1)
			{
				if (iLocal_127 == 0)
				{
					if (HAS_SCALEFORM_MOVIE_LOADED(uLocal_140))
					{
						if (func_150())
						{
							if (Global_4268033 == 0)
				...
				else if (HAS_SCALEFORM_MOVIE_LOADED(uLocal_140))
				{
					func_141(uLocal_140, "SHOW_PHOTO_FRAME", 0f, -1082130432, -1082130432, -1082130432, -1082130432);
					func_141(uLocal_140, "SET_REMAINING_PHOTOS", TO_FLOAT(iLocal_109), TO_FLOAT(iLocal_110), -1082130432, -1082130432, -1082130432);
				}
		...
		case 1:
			...
			{
				_BEGIN_TEXT_COMMAND_BUSY_STRING("CELL_SPINNER2");
...
void func_5()
{
	...
	{
		func_1(0);
		if (func_101() || IS_BIT_SET(Global_2424, 28))
		{
		}
		else
		{
...
void func_10()
{
	...
	if (iLocal_131)
	{
		...
		if (iLocal_133 == 0)
		{
			if (IS_CONTROL_PRESSED(2, iVar0) && !IS_CONTROL_PRESSED(2, iVar1))
			{
				...
				if (IS_BIT_SET(Global_2423, 28))
				{
					func_64(uLocal_141, "SET_DATA_SLOT", 0f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 177, 1), "CELL_281");
					func_64(uLocal_141, "SET_DATA_SLOT", 1f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 179, 1), func_63());
					func_64(uLocal_141, "SET_DATA_SLOT", 2f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 178, 1), "CELL_CAM_SELFIE_2");
				}
				else
				{
					func_64(uLocal_141, "SET_DATA_SLOT", 0f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 176, 1), "CELL_280");
					func_64(uLocal_141, "SET_DATA_SLOT", 1f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 177, 1), "CELL_281");
					func_64(uLocal_141, "SET_DATA_SLOT", 2f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 178, 1), "CELL_CAM_SELFIE_2");
				}
				func_62();
				BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_141, "SET_MAX_WIDTH");
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(fLocal_77);
				END_SCALEFORM_MOVIE_METHOD();
		...
		if (iLocal_134 == 0)
		{
			if (IS_CONTROL_PRESSED(2, iVar1) && !IS_CONTROL_PRESSED(2, iVar0))
			{
				...
				{
					func_64(uLocal_141, "SET_DATA_SLOT", 2f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 176, 1), "CELL_280");
					func_64(uLocal_141, "SET_DATA_SLOT", 3f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 177, 1), "CELL_281");
				}
				func_61();
				BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_141, "SET_MAX_WIDTH");
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(fLocal_77);
	...
	if ((IS_CONTROL_JUST_PRESSED(2, 183) && iLocal_156 == 0) && !func_137())
	{
	...
	if (iLocal_131)
	{
		...
		{
			iLocal_132 = 0;
			BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_140, "SET_FOCUS_LOCK");
		...
		if (!func_59(14))
		{
			if (IS_BIT_SET(Global_4269308, 10))
			{
				if ((Global_71590 == 0 && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("pi_menu")) > 0) && func_58())
				{
					BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_140, "SET_FOCUS_LOCK");
					SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(1);
					BEGIN_TEXT_COMMAND_SCALEFORM_STRING("CELL_ACTTL");
					ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(_GET_LABEL_TEXT(&Global_4270293));
					END_TEXT_COMMAND_SCALEFORM_STRING();
					SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(0);
					END_SCALEFORM_MOVIE_METHOD();
					CLEAR_BIT(&Global_4269308, 10);
				}
			}
		}
		else if (IS_BIT_SET(Global_4269308, 10))
		{
			CLEAR_BIT(&Global_4269308, 10);
		}
		...
		if ((iLocal_66 - iLocal_65) > 1500)
		{
			if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
			{
				vLocal_70 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
	...
	{
		if (!IS_CONTROL_PRESSED(0, 182) && !func_137())
		{
			PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_14542, 1);
			iLocal_132 = 0;
			BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_140, "SET_FOCUS_LOCK");
	...
	else if (IS_CONTROL_PRESSED(0, 182) && !func_137())
	{
		PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_14542, 1);
		iLocal_132 = 1;
		if (!func_59(14))
	...
	if (func_150())
	{
		if ((IS_CONTROL_JUST_PRESSED(2, 186) && iLocal_156 == 0) && !func_137())
		{
			if (iLocal_131)
			{
				iLocal_57++;
							...
							if (iVar4 == 1)
							{
								if ((((iLocal_57 == 2 || iLocal_57 == 3) || iLocal_57 == 4) || iLocal_57 == 8) || iLocal_57 == 9)
								{
									if (iVar2 == -1 && iVar3 > -1)
									{
										if (iLocal_57 == 3)
										{
											SET_FACIAL_IDLE_ANIM_OVERRIDE(PLAYER_PED_ID(), sLocal_48[iLocal_57], 0);
										}
									}
								}
								else
		...
		if ((IS_CONTROL_JUST_PRESSED(2, 185) && iLocal_156 == 0) && !func_137())
		{
			if (iLocal_131)
			{
				if (bLocal_62 == 1)
				{
					...
					if (iLocal_61 == 0)
					{
						iLocal_61 = 1;
						iLocal_60 = 1;
						if (ARE_STRINGS_EQUAL(sLocal_19[Global_4268032], "phone_cam12DUMMY"))
						{
						}
						else
						{
							_0xA2CCBE62CD4C91A4(1);
							_0x375A706A5C2FD084(1);
						}
					}
					else
					{
	...
	if (iLocal_59 == 1 && !func_137())
	{
		if (IS_CONTROL_JUST_PRESSED(0, 172) && iLocal_156 == 0)
		{
			...
			if (Global_4268033 == 13)
			{
				func_104(0);
				_0x1B0B4AEED5B9B41C(1f);
				SET_STREAMED_TEXTURE_DICT_AS_NO_LONGER_NEEDED(sLocal_33[(Global_4268033 - 1)]);
				Global_4268033 = 0;
				func_57();
				if (iLocal_47 == 1)
				{
			...
			if (Global_4268033 > 0 && Global_4268033 < 13)
			{
				iLocal_59 = 0;
				iLocal_58 = 0;
				REQUEST_STREAMED_TEXTURE_DICT(sLocal_33[Global_4268033], 0);
			}
		}
	}
	if (Global_4268033 > 0)
	{
		if (iLocal_59 == 0)
		{
			if (HAS_STREAMED_TEXTURE_DICT_LOADED(sLocal_33[Global_4268033]))
			{
				iLocal_58 = 1;
				iLocal_59 = 1;
				...
				_0x27FEB5254759CDE3(sLocal_33[Global_4268033], 0);
			}
		}
		if (iLocal_58 == 1)
		{
	...
	if ((IS_CONTROL_JUST_PRESSED(0, 173) && iLocal_156 == 0) && !func_137())
	{
		if (func_150())
		{
			func_99();
	...
	if ((IS_DISABLED_CONTROL_JUST_PRESSED(0, 184) && iLocal_156 == 0) && !func_137())
	{
		if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
		{
			if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !GET_PED_PARACHUTE_STATE(PLAYER_PED_ID()) == 2)
			{
				vLocal_67 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
				PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_14542, 1);
				func_141(uLocal_140, "SHOW_PHOTO_FRAME", 0f, -1082130432, -1082130432, -1082130432, -1082130432);
				func_140(uLocal_140, "CLOSE_SHUTTER");
				iLocal_135 = GET_GAME_TIMER();
				while (GET_GAME_TIMER() < (iLocal_135 + iLocal_139) && Global_14553.f_1 > 3)
				{
					func_135();
					func_116();
					func_80();
	...
	if (iLocal_131 == 0)
	{
		if (iLocal_113 == 0)
		{
			if (IS_CONTROL_JUST_PRESSED(0, 40) || IS_CONTROL_JUST_PRESSED(0, 41))
			{
				...
				{
					if (HAS_SOUND_FINISHED(uLocal_112))
					{
						PLAY_SOUND_FRONTEND(uLocal_112, "Camera_Zoom", &Global_14542, 1);
					}
				}
				else
				{
	...
	if (func_94(2, Global_14522, 0))
	{
		uLocal_75 = GET_GAMEPLAY_CAM_RELATIVE_PITCH();
		uLocal_76 = GET_GAMEPLAY_CAM_RELATIVE_HEADING();
		_0x1072F115DAB0717E(0, 0);
		SET_BIT(&Global_2423, 21);
		STOP_SOUND(uLocal_112);
		iLocal_127 = 1;
		func_141(uLocal_140, "SHOW_PHOTO_FRAME", 0f, -1082130432, -1082130432, -1082130432, -1082130432);
		func_141(uLocal_140, "SHOW_REMAINING_PHOTOS", 0f, -1082130432, -1082130432, -1082130432, -1082130432);
		PLAY_SOUND_FRONTEND(-1, "Camera_Shoot", &Global_14542, 1);
		func_140(uLocal_140, "CLOSE_SHUTTER");
		...
		iLocal_135 = GET_GAME_TIMER();
		while (GET_GAME_TIMER() < (iLocal_135 + iLocal_138) && Global_14553.f_1 > 3)
		{
			func_135();
			func_116();
			func_80();
		...
		if (iLocal_131)
		{
			if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
			{
				if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) || GET_PED_PARACHUTE_STATE(PLAYER_PED_ID()) == 2)
				{
					...
					{
						func_64(uLocal_141, "SET_DATA_SLOT", 2f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 184, 1), "CELL_SP_2NP_XB");
					}
					else
					{
						func_64(uLocal_141, "SET_DATA_SLOT", 2f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 184, 1), "CELL_SP_2NP_XB");
				...
				else if ((Global_71590 == 0 && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("pi_menu")) > 0) && func_58())
				{
					func_49();
				}
				else
				{
					...
					func_64(uLocal_141, "SET_DATA_SLOT", 3f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 183, 1), "CELL_GRID");
					func_64(uLocal_141, "SET_DATA_SLOT", 4f, _0x80C2FD58D720C801(0, 1, 1), "CELL_285");
					if (func_150())
					{
						func_48(5f);
						func_47(6f);
						if (func_29(1))
						{
							...
							if (bLocal_62)
							{
								func_64(uLocal_141, "SET_DATA_SLOT", 8f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 185, 1), "CELL_DEPTH");
							}
						}
						else if (bLocal_62)
						{
							func_64(uLocal_141, "SET_DATA_SLOT", 7f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 185, 1), "CELL_DEPTH");
						}
					}
				}
			}
		...
		else if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
		{
			if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) || GET_PED_PARACHUTE_STATE(PLAYER_PED_ID()) == 2)
			{
				if (!GET_PED_PARACHUTE_STATE(PLAYER_PED_ID()) == 2)
				{
					if (!func_137())
					{
						func_64(uLocal_141, "SET_DATA_SLOT", 2f, _0x80C2FD58D720C801(0, 1, 1), "CELL_285");
						func_64(uLocal_141, "SET_DATA_SLOT", 3f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 183, 1), "CELL_GRID");
						func_64(uLocal_141, "SET_DATA_SLOT", 4f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 39, 1), "CELL_284");
					}
					else
					{
						func_64(uLocal_141, "SET_DATA_SLOT", 0f, _0x80C2FD58D720C801(0, 1, 1), "CELL_285");
						if (!_IS_INPUT_DISABLED(0))
						{
							func_64(uLocal_141, "SET_DATA_SLOT", 1f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 210, 1), "CELL_284");
						}
						else
						{
							func_64(uLocal_141, "SET_DATA_SLOT", 1f, _0x80C2FD58D720C801(0, 29, 1), "CELL_284");
						}
					}
					if (!func_137())
					{
						if (func_150())
						{
							...
							if (bLocal_63)
							{
								func_64(uLocal_141, "SET_DATA_SLOT", 3f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 182, 1), "CELL_FOCUS");
							}
							func_64(uLocal_141, "SET_DATA_SLOT", 8f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 185, 1), "CELL_DEPTH");
						}
					}
			...
			else
			{
				if (!func_137())
				{
					if (_IS_INPUT_DISABLED(2) || IS_ORBIS_VERSION())
					{
						func_64(uLocal_141, "SET_DATA_SLOT", 2f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 184, 1), "CELL_SP_1NP_XB");
					}
					else
					{
						func_64(uLocal_141, "SET_DATA_SLOT", 2f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 184, 1), "CELL_SP_1NP_XB");
				...
				if (!GET_PED_PARACHUTE_STATE(PLAYER_PED_ID()) == 2)
				{
					if (!func_137())
					{
						func_64(uLocal_141, "SET_DATA_SLOT", 4f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 183, 1), "CELL_GRID");
						func_64(uLocal_141, "SET_DATA_SLOT", 5f, _0x80C2FD58D720C801(0, 1, 1), "CELL_285");
					}
					else
					{
						func_64(uLocal_141, "SET_DATA_SLOT", 0f, _0x80C2FD58D720C801(0, 1, 1), "CELL_285");
					...
					if (!func_137())
					{
						func_64(uLocal_141, "SET_DATA_SLOT", 6f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 39, 1), "CELL_284");
					}
					if (!func_137())
					{
						if (func_150())
						{
							...
							func_64(uLocal_141, "SET_DATA_SLOT", 9f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 185, 1), "CELL_DEPTH");
						}
					}
				}
				else
				{
					...
					if (func_150())
					{
						func_48(3f);
						func_47(4f);
						func_64(uLocal_141, "SET_DATA_SLOT", 5f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 185, 1), "CELL_DEPTH");
					}
				}
			}
		}
...
{
	func_64(uLocal_141, "SET_DATA_SLOT", fParam0, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 174, 1), "CELL_ACTION");
}
...
{
	return func_31(PLAYER_PED_ID(), iParam0, iParam1, bParam2, bParam3, bParam4);
}
...
int func_31(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	{
		if (GET_ENTITY_MODEL(uParam0) == joaat("mp_f_freemode_01"))
		{
...
var func_33(var uParam0)
{
	...
	uVar0 = GET_PED_DRAWABLE_VARIATION(uParam0, 1);
	return uVar0;
}
...
var func_36(var uParam0)
{
	...
	uVar0 = GET_PED_PROP_INDEX(uParam0, 0);
	return uVar0;
}
...
{
	func_64(uLocal_141, "SET_DATA_SLOT", fParam0, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 172, 1), "CELL_BORDER");
}
...
void func_48(float fParam0)
{
	...
	func_64(uLocal_141, "SET_DATA_SLOT", fParam0, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 173, 1), "CELL_FILTER");
}
...
void func_49()
{
	...
	func_64(uLocal_141, "SET_DATA_SLOT", 3f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 183, 1), "CELL_GRID");
	func_64(uLocal_141, "SET_DATA_SLOT", 4f, _0x80C2FD58D720C801(0, 1, 1), "CELL_285");
	func_48(5f);
	func_47(6f);
	func_50(7f);
...
{
	func_64(uLocal_141, "SET_DATA_SLOT", fParam0, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 175, 1), "CELL_ACCYC");
}
...
void func_51()
{
	func_141(uLocal_141, "SET_CLEAR_SPACE", 200f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_141(uLocal_141, "SET_DATA_SLOT_EMPTY", 3f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_64(uLocal_141, "SET_DATA_SLOT", 3f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 39, 1), "CELL_284");
	func_64(uLocal_141, "SET_DATA_SLOT", 2f, _0x80C2FD58D720C801(0, 1, 1), "CELL_285");
	func_64(uLocal_141, "SET_DATA_SLOT", 1f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 177, 1), "CELL_281");
	func_64(uLocal_141, "SET_DATA_SLOT", 0f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 176, 1), "CELL_280");
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_141, "SET_MAX_WIDTH");
		...
		else if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
		{
			if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) || GET_PED_PARACHUTE_STATE(PLAYER_PED_ID()) == 2)
			{
				if (!GET_PED_PARACHUTE_STATE(PLAYER_PED_ID()) == 2)
				{
					func_64(uLocal_141, "SET_DATA_SLOT", 3f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 183, 1), "CELL_GRID");
					func_64(uLocal_141, "SET_DATA_SLOT", 4f, _0x80C2FD58D720C801(0, 1, 1), "CELL_285");
					func_64(uLocal_141, "SET_DATA_SLOT", 5f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 39, 1), "CELL_284");
					if (func_150())
					{
						func_48(6f);
						func_47(7f);
			...
			else if (!GET_PED_PARACHUTE_STATE(PLAYER_PED_ID()) == 2)
			{
				...
				else
				{
					...
					func_64(uLocal_141, "SET_DATA_SLOT", 3f, _0x80C2FD58D720C801(0, 1, 1), "CELL_285");
					if (func_150())
					{
						if (!func_137())
						{
							func_48(4f);
							func_47(5f);
							func_64(uLocal_141, "SET_DATA_SLOT", 6f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 185, 1), "CELL_DEPTH");
						}
					}
				}
			}
...
void func_54()
{
	if (iLocal_131)
	{
		SET_GAMEPLAY_CAM_RELATIVE_PITCH(fLocal_73, 1065353216);
...
void func_61()
{
	...
	if (_IS_INPUT_DISABLED(2))
	{
		func_64(uLocal_141, "SET_DATA_SLOT", 3f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 30, 1), "CELL_RT_RSTICK");
		func_64(uLocal_141, "SET_DATA_SLOT", 4f, _0x80C2FD58D720C801(2, 1, 1), "CELL_RT_LSTICK");
	}
	else
	{
		func_64(uLocal_141, "SET_DATA_SLOT", 3f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 1, 1), "CELL_RT_RSTICK");
		func_64(uLocal_141, "SET_DATA_SLOT", 4f, _0x80C2FD58D720C801(2, 0, 1), "CELL_RT_LSTICK");
	}
}
...
void func_62()
{
	if (_IS_INPUT_DISABLED(2) || IS_ORBIS_VERSION())
	{
		func_64(uLocal_141, "SET_DATA_SLOT", 3f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 184, 1), "CELL_SP_2NP_XB");
	}
	else
	{
		func_64(uLocal_141, "SET_DATA_SLOT", 3f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 184, 1), "CELL_SP_2NP_XB");
	}
	func_64(uLocal_141, "SET_DATA_SLOT", 4f, _0x80C2FD58D720C801(0, 1, 1), "CELL_LT_RSTICK");
	if (func_59(14))
	{
		func_64(uLocal_141, "SET_DATA_SLOT", 5f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 30, 1), "CELL_LT_LSTICK");
	}
	else
	{
		func_64(uLocal_141, "SET_DATA_SLOT", 5f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 39, 1), "CELL_LT_LSTICKZ");
		func_64(uLocal_141, "SET_DATA_SLOT", 6f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 30, 1), "CELL_LT_LSTICK");
	}
}

char* func_63()
{
	if (Global_1626536[PLAYER_ID() /*603*/].f_11.f_33 == 233 && Global_1626536[PLAYER_ID() /*603*/].f_11.f_181 == 9)
	{
...
void func_67()
{
	...
	if (IS_CONTROL_PRESSED(2, iVar10) && !IS_CONTROL_PRESSED(2, iVar9))
	{
		...
		uVar3 = FLOOR(_0x4F8A26A890FD62FB(0, 2)) * 127;
		if (_IS_INPUT_DISABLED(2))
		{
		...
		else if (ABSI(iVar2) > 28 || ABSI(uVar3) > 28)
		{
...
void func_71()
{
	...
	if (_IS_INPUT_DISABLED(2))
	{
		...
		{
			if (IS_CONTROL_JUST_PRESSED(2, 178) && !func_137())
			{
...
void func_76()
{
	...
	if (iLocal_124 == 0)
	{
		if (!iLocal_150)
		{
			if (Global_4456448.f_155713 == 0 && Global_4456448.f_155714 == 0)
			{
				DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_141, 255, 255, 255, 0, 0);
			}
		}
	}
	if (iLocal_127 == 0)
...
void func_79()
{
	SET_GAMEPLAY_CAM_RELATIVE_PITCH(uLocal_75, 1065353216);
	SET_GAMEPLAY_CAM_RELATIVE_HEADING(uLocal_76);
}
...
void func_82()
{
	...
	if (IS_BIT_SET(Global_2424, 28))
	{
		func_64(uLocal_141, "SET_DATA_SLOT", 0f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 176, 1), "CELL_286");
	}
	else
	{
		func_64(uLocal_141, "SET_DATA_SLOT", 1f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 178, 1), "CELL_277");
		func_64(uLocal_141, "SET_DATA_SLOT", 0f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 176, 1), "CELL_GALSAVE");
	}
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_141, "SET_MAX_WIDTH");
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(fLocal_77);
	END_SCALEFORM_MOVIE_METHOD();
...
void func_83()
{
	...
	{
		func_64(uLocal_141, "SET_DATA_SLOT", 2f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 179, 1), func_63());
		func_64(uLocal_141, "SET_DATA_SLOT", 1f, GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 178, 1), "CELL_277");
		func_64(uLocal_141, "SET_DATA_SLOT", 0f, GET_CONTROL_INSTRUCTIONAL_BUTTON(0, 176, 1), "CELL_GALSAVE");
	}
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_141, "SET_MAX_WIDTH");
			...
			else if (Global_15866 == 4 || Global_15866 == 3)
			{
				...
				else
				{
					...
					if (Global_106565.f_28044[Global_1738 /*29*/].f_24[Global_14553] == 0)
					{
						...
						func_90(Global_14534, "SET_DATA_SLOT", TO_FLOAT(4), TO_FLOAT(0), TO_FLOAT(3), -1f, -1f, &(Global_117[Global_1738 /*10*/].f_4), "CELL_300", &vVar0, "CELL_195", 0);
					}
					else
					{
						func_141(Global_14534, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_90(Global_14534, "SET_DATA_SLOT", TO_FLOAT(4), TO_FLOAT(0), TO_FLOAT(3), -1f, -1f, &(Global_106565.f_28044[Global_1738 /*29*/].f_3), &(Global_106565.f_28044[Global_1738 /*29*/].f_7), &vVar0, &(Global_106565.f_28044[Global_1738 /*29*/].f_3), 0);
					}
				}
				func_141(Global_14534, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
						...
						if (Global_2992[iVar0] == 0)
						{
							...
							else if (iVar1 == 7)
							{
								...
								else
								{
									...
									func_90(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(uVar6), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
...
void func_105()
{
	if (Global_4268032 > 0 && Global_4268032 < 99)
	{
		if (Global_1667046 == 0)
		{
			SET_TIMECYCLE_MODIFIER(sLocal_19[Global_4268032]);
		}
	}
}
...
void func_116()
{
	if (Global_14553.f_1 > 3)
	{
		if (!IS_PAUSE_MENU_ACTIVE())
		{
			DRAW_SCALEFORM_MOVIE(uLocal_140, 0.5f, 0.5f, 1f, 1f, 255, 255, 255, 255, 0);
		}
	}
}
...
int func_122()
{
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			else if (!GET_PED_IN_VEHICLE_SEAT(uVar0, -1, 0) == PLAYER_PED_ID())
			{
				return 1;
			}
		}
...
void func_144(int iParam0)
{
	if (iParam0 == 1)
	{
		SET_BIT(&Global_2423, 15);
	}
	else
	{
		CLEAR_BIT(&Global_2423, 15);
	}
}
