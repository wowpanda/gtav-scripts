...
void func_1()//Position - 0x1D4
{
	...
	func_5();
	if (func_3(Global_19A8D) && PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), Global_19A8D, 1))
	{
		if (!func_2(AUDIO::_0x0626A247D2405330(), 3466132403) && !func_2(AUDIO::_0x0626A247D2405330(), 451360105))
		{
	...
	else
	{
		...
		{
			if (!PED::IS_PED_INJURED(Global_19A8E) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Global_19A8D, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(Global_19A8E, Global_19A8D, 0))
				{
					if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
					{
						BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(Global_19A8E, Global_19A8D, AUDIO::_0x0626A247D2405330(), 8, 25f, 790564, 300f, 15f, 1);
					}
				}
				else if (!PED::IS_PED_FLEEING(Global_19A8E))
				{
					if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
					{
						BRAIN::TASK_SMART_FLEE_PED(Global_19A8E, AUDIO::_0x0626A247D2405330(), 300f, 4294967295, 0, 0);
					}
				}
				PED::SET_PED_KEEP_TASK(Global_19A8E, true);
				ENTITY::SET_ENTITY_HEALTH(Global_19A8E, false);
			}
		}
		else if (!PED::IS_PED_INJURED(Global_19A8E) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Global_19A8D, 0))
		{
			if (PED::IS_PED_IN_VEHICLE(Global_19A8E, Global_19A8D, 0))
			{
				if (!func_2(Global_19A8E, 4036695475))
				{
					BRAIN::TASK_VEHICLE_DRIVE_WANDER(Global_19A8E, Global_19A8D, 12f, 790699);
				}
			}
			PED::SET_PED_KEEP_TASK(Global_19A8E, true);
			ENTITY::SET_ENTITY_HEALTH(Global_19A8E, false);
	...
	if (PED::DOES_GROUP_EXIST(func_6()))
	{
		...
		if (iVar0 > 0)
		{
			...
			if (!PED::IS_PED_INJURED(iVar2))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(Global_19A8D, 0))
				{
					if (PED::IS_PED_IN_VEHICLE(iVar2, Global_19A8D, 0))
					{
						BRAIN::TASK_LEAVE_VEHICLE(iVar2, Global_19A8D, 64);
					}
				}
			}
			if (iVar0 > 1)
...
void func_7()//Position - 0x4F4
{
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Global_19A8D, 0))
	{
		if (!PED::IS_PED_INJURED(Global_19A8E))
		{
			if (PED::IS_PED_SITTING_IN_VEHICLE(Global_19A8E, Global_19A8D))
			{
				if (!func_58())
				{
					bVar0 = true;
					if (func_52(func_53()) >= iLocal_101)
					{
						if (bLocal_65)
						{
							if (iLocal_101 > 0)
							{
								...
								func_42(Global_19A8E, &iLocal_805);
						...
						else if (ENTITY::GET_ENTITY_SPEED(Global_19A8D) > 5f)
						{
							if (!func_8())
							{
								iLocal_805 = 12;
...
int func_9(int iParam0, int iParam1, int iParam2)//Position - 0x682
{
	...
	return func_10(Global_19E56.f_6D76[iParam0 /*29*/].f_11, 0, iParam1, iParam2, 0);
}
...
void func_13(int iParam0)//Position - 0xFA6
{
	...
	else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_5038.f_1D7, iParam0) || INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_15() /*12745*/].f_1FF2.f_A, iParam0))
	{
		bVar0 = true;
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_19E56.f_5038.f_1D7), iParam0);
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_200000[func_15() /*12745*/].f_1FF2.f_A), iParam0);
	}
	if (bVar0)
	{
...
char* func_14(int iParam0)//Position - 0x10B6
{
	switch (iParam0)
	{
		case 0:
...
int func_16(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1165
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_17()//Position - 0x16C8
{
	return Global_1407E0;
}

void func_18(int iParam0)//Position - 0x16D4
{
	func_40(93, iParam0);
	func_40(29, iParam0);
	func_40(30, iParam0);
...
bool func_19(int iParam0)//Position - 0x16F4
{
	if (iParam0 == 8)
	{
	...
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_15() /*12745*/].f_1FF2.f_A, iParam0);
}

int func_20(int iParam0, int iParam1, int iParam2)//Position - 0x1778
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_21(int iParam0)//Position - 0x17B5
{
	int iVar0;
...
int func_22(int iParam0, int iParam1)//Position - 0x1ACD
{
	int iVar0;
...
int func_23(bool bParam0)//Position - 0x1DC0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_24(int iParam0, int iParam1)//Position - 0x1E77
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_25(int iParam0, int iParam1)//Position - 0x1E92
{
	...
	if (func_35(&Global_412216))
	{
		if (func_33(&Global_412216, iParam0))
		{
			return 0;
		}
		if (func_26(&Global_412216, iParam0))
		{
			return 1;
		}
	}
...
int func_26(var uParam0, int iParam1)//Position - 0x1F2F
{
	int iVar0;
	var uVar1[78];
...
int func_27(var uParam0, int iParam1)//Position - 0x1FE0
{
	int iVar0;
...
bool func_28(var uParam0, int iParam1)//Position - 0x205B
{
	return (*uParam0)[iParam1] == 78;
}

void func_29(var uParam0)//Position - 0x206C
{
	int iVar0;
	...
	func_31(uParam0, (Global_412215 - 0.5f));
}

void func_30(var uParam0, int iParam1)//Position - 0x20A0
{
	(*uParam0)[iParam1] = 78;
}

void func_31(var uParam0, float fParam1)//Position - 0x20B0
{
	if (fParam1 == 0f)
	{
		uParam0->f_50 = 0f;
...
float func_32(var uParam0)//Position - 0x20CD
{
	return uParam0->f_50;
}

bool func_33(var uParam0, int iParam1)//Position - 0x20D9
{
	return func_34(uParam0, iParam1) != 4294967295;
}

int func_34(var uParam0, int iParam1)//Position - 0x20EB
{
	int iVar0;
...
bool func_35(var uParam0)//Position - 0x2118
{
	return uParam0->f_4F == 1;
}

int func_36(int iParam0)//Position - 0x2126
{
	switch (iParam0)
	{
		case 60:
...
bool func_37(int iParam0)//Position - 0x2176
{
	return Global_8D15 == iParam0;
}

int func_38(int iParam0, int iParam1)//Position - 0x2184
{
	int iVar0;
...
void func_39(int iParam0, int iParam1)//Position - 0x21D5
{
	int iVar0;
...
void func_40(int iParam0, int iParam1)//Position - 0x21F8
{
	int iVar0;
...
void func_42(int iParam0, int iParam1)//Position - 0x22CA
{
	bool bVar0;
		...
		if (!func_48(iParam0, 0))
		{
			if (!*iParam1 == 0)
			{
				...
				else if (*iParam1 == 9)
				{
					if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
					{
						bVar0 = AUDIO::IS_AMBIENT_SPEECH_DISABLED(AUDIO::_0x0626A247D2405330());
						if (bVar0)
						{
							AUDIO::STOP_PED_SPEAKING(AUDIO::_0x0626A247D2405330(), false);
						}
						func_46(AUDIO::_0x0626A247D2405330(), "TAXI_CHANGE_DEST", 7);
						if (bVar0)
						{
				...
				else if (*iParam1 == 18)
				{
					...
					else if (SYSTEM::TIMERA() > 4000)
					{
						if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
						{
							...
							{
								case 0:
									func_46(AUDIO::_0x0626A247D2405330(), "RADIO_REQ_VIBE", 7);
									break;
								
								case 1:
									func_46(AUDIO::_0x0626A247D2405330(), "RADIO_REQ_LRR", 7);
									break;
								
								case 2:
									func_46(AUDIO::_0x0626A247D2405330(), "RADIO_REQ_JNR", 7);
									break;
								
								case 3:
									func_46(AUDIO::_0x0626A247D2405330(), "RADIO_REQ_MASSIVEB", 7);
									break;
								
								case 4:
									func_46(AUDIO::_0x0626A247D2405330(), "RADIO_REQ_K109", 7);
									break;
								
								case 5:
									func_46(AUDIO::_0x0626A247D2405330(), "RADIO_REQ_WKTT", 7);
									break;
								
								case 6:
									func_46(AUDIO::_0x0626A247D2405330(), "RADIO_REQ_LCHC", 7);
									break;
								
								case 7:
									func_46(AUDIO::_0x0626A247D2405330(), "RADIO_REQ_JOURNEY", 7);
									break;
								
								case 8:
									func_46(AUDIO::_0x0626A247D2405330(), "RADIO_REQ_FUSION", 7);
									break;
								
								case 9:
									func_46(AUDIO::_0x0626A247D2405330(), "RADIO_REQ_BEAT", 7);
									break;
								
								case 10:
									func_46(AUDIO::_0x0626A247D2405330(), "RADIO_REQ_BROKER", 7);
									break;
								
								case 11:
									func_46(AUDIO::_0x0626A247D2405330(), "RADIO_REQ_VLADIVOSTOK", 7);
									break;
								
								case 12:
									func_46(AUDIO::_0x0626A247D2405330(), "RADIO_REQ_PLR", 7);
									break;
								
								case 13:
									func_46(AUDIO::_0x0626A247D2405330(), "RADIO_REQ_SANJUAN", 7);
									break;
								
								case 14:
									func_46(AUDIO::_0x0626A247D2405330(), "RADIO_REQ_FRANCOIS", 7);
									break;
								
								case 15:
									func_46(AUDIO::_0x0626A247D2405330(), "RADIO_REQ_CLASSICS", 7);
									break;
							}
							if (bVar0)
							{
				...
				else if (*iParam1 == 20)
				{
					if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
					{
						...
						func_46(AUDIO::_0x0626A247D2405330(), "TAXI_STEP_ON_IT", 7);
						if (bVar0)
						{
							AUDIO::STOP_PED_SPEAKING(AUDIO::_0x0626A247D2405330(), true);
						}
				...
				else if (*iParam1 == 23)
				{
					if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
					{
						...
						func_46(AUDIO::_0x0626A247D2405330(), "THANKS", 7);
						if (bVar0)
						{
							AUDIO::STOP_PED_SPEAKING(AUDIO::_0x0626A247D2405330(), true);
						}
...
void func_43()//Position - 0x2777
{
	...
	{
		bVar1 = AUDIO::IS_AMBIENT_SPEECH_DISABLED(AUDIO::_0x0626A247D2405330());
		if (bVar1)
		{
			AUDIO::STOP_PED_SPEAKING(AUDIO::_0x0626A247D2405330(), false);
		}
		func_46(AUDIO::_0x0626A247D2405330(), sVar0, 7);
		if (bVar1)
		{
			AUDIO::STOP_PED_SPEAKING(AUDIO::_0x0626A247D2405330(), true);
		}
...
Vector3 func_45(int iParam0)//Position - 0x30EC
{
	vector3 vVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar5 == 1)
	{
		...
		{
			vVar0 = { unk_0x8000C77B5F336760(iVar1, true) };
		}
	}
	else if (iVar5 == 2)
	{
		...
		if (!PED::IS_PED_INJURED(iVar2))
		{
			vVar0 = { unk_0x8000C77B5F336760(iVar2, true) };
		}
	}
	else if (iVar5 == 3)
	{
		...
		{
			vVar0 = { unk_0x8000C77B5F336760(iVar3, true) };
		}
	}
	else if (iVar5 == 4)
	{
...
void func_46(int iParam0, char* sParam1, int iParam2)//Position - 0x31C7
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_47(iParam2), 1);
}

int func_47(int iParam0)//Position - 0x31DE
{
	int iVar0;
...
int func_48(int iParam0, bool bParam1)//Position - 0x33D3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_50(char* sParam0)//Position - 0x34D0
{
	func_51(sParam0);
}

void func_51(char* sParam0)//Position - 0x34DE
{
...
int func_52(int iParam0)//Position - 0x34F1
{
	var uVar0;
...
int func_53()//Position - 0x3549
{
	func_54();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_54()//Position - 0x3562
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_57(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_55(iVar0) && (!func_37(14) || Global_19A3D))
			{
...
bool func_55(int iParam0)//Position - 0x365F
{
	return iParam0 < 3;
}

int func_56(int iParam0)//Position - 0x366B
{
	int iVar0;
	int iVar1;
...
int func_57(int iParam0)//Position - 0x36A8
{
	if (func_55(iParam0))
	{
...
int func_59(int iParam0)//Position - 0x36EB
{
	return Global_19E56.f_612C[iParam0 /*4*/];
}

void func_60()//Position - 0x36FE
{
	if (func_221())
	{
		func_219();
		...
		switch (iLocal_808)
		{
			case 0:
				if (!PED::IS_PED_INJURED(Global_19A8E) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Global_19A8D, 0))
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(Global_19A8E, Global_19A8D))
					{
						if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_19A8E, &cLocal_811, "leanover_enter", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(Global_19A8E, &cLocal_811, "leanover_idle", 3))
						{
							if (!func_2(Global_19A8E, 2176111930))
							{
								BRAIN::TASK_VEHICLE_TEMP_ACTION(Global_19A8E, Global_19A8D, 1, 1000000);
							}
						}
					}
				}
				if (func_171())
				{
					if (func_170() && !PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330()))
					{
						func_181();
						iLocal_805 = 1;
						iLocal_807 = 0;
			...
			case 1:
				...
				func_168(&Global_19A8D, iLocal_826);
				if (func_167())
				{
...
void func_62(int iParam0, var uParam1, var uParam2, int iParam3)//Position - 0x3A6E
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			while (iVar0 < uParam2->f_2A8)
			{
				if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam2->f_2A4, iVar0))
				{
					...
					if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam2->f_2A5, iVar0))
					{
						...
						func_66(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(iVar1, iVar2, true));
						if (iVar3 < 358)
						{
							func_66(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(iVar1, iVar3, true));
						}
					}
					else
					{
						...
						func_66(PAD::_0x80C2FD58D720C801(iVar4, iVar5, true));
					}
...
void func_64(int iParam0, var uParam1)//Position - 0x3E0A
{
	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iParam0, uParam1->f_4, uParam1->f_5, uParam1->f_6, uParam1->f_7, 0);
}

void func_65(char* sParam0)//Position - 0x3E29
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	CAM::_DISABLE_VEHICLE_FIRST_PERSON_CAM_THIS_FRAME();
}

void func_66(char* sParam0)//Position - 0x3E3B
{
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_BUTTON_NAME(sParam0);
}

void func_67(var uParam0)//Position - 0x3E49
{
	uParam0->f_2A7 = 0;
}

int func_68(var uParam0)//Position - 0x3E57
{
	return uParam0->f_2A7;
}

void func_69(int iParam0)//Position - 0x3E64
{
	Global_141370 = iParam0;
}

void func_70(int iParam0)//Position - 0x3E72
{
	Global_14E696.f_437 = iParam0;
}

int func_71()//Position - 0x3E83
{
	if (iLocal_808 != 2)
	{
		return 0;
...
void func_72(int iParam0, int iParam1, char* sParam2, var uParam3, bool bParam4, int iParam5)//Position - 0x3EC5
{
	int iVar0;
...
void func_73(var uParam0)//Position - 0x3F42
{
	func_74(uParam0);
	uParam0->f_2A7 = 1;
}

void func_74(var uParam0)//Position - 0x3F56
{
	int iVar0;
...
struct<9> func_75()//Position - 0x402C
{
	struct<9> Var0;
	...
	switch (iLocal_810)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT() && AUDIO::IS_AUDIO_SCENE_ACTIVE("FADE_OUT_WORLD_250MS_SCENE"))
			{
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Global_19A8D, 0))
				{
					unk_0x4E87F356DA56EB3F(Global_19A8D, false);
				}
				HUD::CLEAR_PRINTS();
		...
		case 2:
			if (func_121(&vLocal_43, &Global_19A94, &Global_19A9A))
			{
				func_152();
				iLocal_810 = 3;
			}
		...
		case 3:
			if (Global_11635 == 4294967295)
			{
				...
				func_113();
				func_112();
				MISC::CLEAR_AREA(Global_19A94, 5f, 1, 0, 0, false);
				func_108(1097859072);
				if (!PED::IS_PED_INJURED(Global_19A8E) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Global_19A8D, 0))
				{
					ENTITY::SET_ENTITY_COORDS(Global_19A8D, Global_19A94, 1, false, 0, 1);
					ENTITY::SET_ENTITY_HEADING(Global_19A8D, Global_19A9A);
					unk_0x346478B12F69D4E3(Global_19A8D, true);
				}
				CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
				CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
				BRAIN::ENABLE_SCRIPT_BRAIN_SET();
				MISC::CLEAR_AREA(Global_19A94, 5000f, 1, 0, 0, false);
				MISC::CLEAR_AREA_OF_OBJECTS(Global_19A94, 5000f, 0);
				MISC::CLEAR_AREA_OF_PROJECTILES(Global_19A94, 30f, 0);
				GRAPHICS::REMOVE_PARTICLE_FX_IN_RANGE(Global_19A94, 5000f);
				GRAPHICS::REMOVE_DECALS_IN_RANGE(Global_19A94, 5000f);
				if (Global_16089 != 4294967295)
				{
					func_107(Global_16089, 1);
					func_106(Global_16089);
				}
				iLocal_802 = func_105(vLocal_43.x);
				if (iLocal_802 != 4294967295)
				{
		...
		case 4:
			if (STREAMING::NEW_LOAD_SCENE_START_SPHERE(Global_19A94, 4500f, 0))
			{
				iLocal_57 = 1;
				iLocal_810 = 5;
			}
		...
		case 6:
			...
			{
				bVar1 = true;
				if (Global_14893[iLocal_802 /*34*/].f_D == 4294967295 && Global_14893[iLocal_802 /*34*/].f_E == 4294967295)
				{
					bVar1 = false;
				}
				if (bVar1)
				{
					if (((func_53() == 0 && !INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_14893[iLocal_802 /*34*/].f_F, 8)) || (func_53() == 1 && !INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_14893[iLocal_802 /*34*/].f_F, 9))) || (func_53() == 2 && !INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_14893[iLocal_802 /*34*/].f_F, 10)))
					{
						bVar1 = false;
					}
				}
				if (bVar1)
				{
					if (func_100(Global_14893[iLocal_802 /*34*/].f_D, Global_14893[iLocal_802 /*34*/].f_E))
					{
						bVar1 = false;
					}
				}
				if (bVar1)
				{
					CLOCK::ADVANCE_CLOCK_TIME_TO(Global_14893[iLocal_802 /*34*/].f_D, 0, 0);
				}
			}
		...
		case 7:
			...
			if (iLocal_802 != 4294967295 && Global_1608E)
			{
				bVar0 = false;
			}
			...
			if (bVar0)
			{
				...
				{
					iLocal_67 = 0;
					MISC::GET_GROUND_Z_FOR_3D_COORD(Global_19A94 + Vector(100f, 0f, 0f), &fVar2, 0, 0);
					if (fVar2 > Global_19A94.f_2)
					{
						Global_19A94.f_2 = (fVar2 + 0.5f);
					}
				}
				func_108(12f);
				func_78();
				if (!PED::IS_PED_INJURED(Global_19A8E) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Global_19A8D, 0))
				{
					unk_0x346478B12F69D4E3(Global_19A8D, false);
					ENTITY::SET_ENTITY_HEADING(Global_19A8D, Global_19A9A);
					ENTITY::SET_ENTITY_COORDS(Global_19A8D, Global_19A94, 1, false, 0, 1);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Global_19A8D, 1084227584);
					BRAIN::TASK_VEHICLE_TEMP_ACTION(Global_19A8E, Global_19A8D, 24, 5000);
				}
				iLocal_89 = MISC::GET_GAME_TIMER();
				iLocal_810 = 8;
			}
		...
		case 8:
			if (func_155(iLocal_89, 500))
			{
				...
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Global_19A8D, 0))
				{
					unk_0x4E87F356DA56EB3F(Global_19A8D, true);
				}
				if (!func_77())
				{
		...
		case 9:
			...
			{
				if (((!Global_1608F && iLocal_802 != 4294967295) && iLocal_802 != 72) && iLocal_802 != 87)
				{
					func_106(iLocal_802);
				}
				func_156(0);
				if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
				{
					if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), Global_19A8D, 1))
					{
						BRAIN::TASK_LEAVE_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0, 0);
					}
				}
...
void func_78()//Position - 0x46F7
{
	...
	switch (iLocal_803)
	{
		case 92:
			vVar0 = { func_80(229, 0) };
			fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Global_19A94, vVar0, true);
			if (fVar1 < 100f)
			{
				vVar0 = { func_79(Global_19A94 - vVar0) };
				vVar0 = { (Global_19A94 + (vVar0.x * IntToFloat((100 - SYSTEM::ROUND(fVar1))))), (Global_19A94.f_1 + (vVar0.y * IntToFloat((100 - SYSTEM::ROUND(fVar1))))), Global_19A94.f_2 };
				PATHFIND::GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(vVar0, &Global_19A94, &Global_19A9A, 1, 1077936128, 0);
				ENTITY::SET_ENTITY_COORDS(Global_19A8D, Global_19A94, 1, false, 0, 1);
				ENTITY::SET_ENTITY_HEADING(Global_19A8D, Global_19A9A);
			}
			break;
...
Vector3 func_79(vector3 vParam0)//Position - 0x47B2
{
	float fVar0;
	float fVar1;
...
Vector3 func_80(int iParam0, int iParam1)//Position - 0x47F1
{
	int iVar0;
...
bool func_81()//Position - 0x482F
{
	return !Global_11188.f_229;
}

int func_82(vector3 vParam0)//Position - 0x483F
{
	int iVar0;
...
void func_83(int iParam0)//Position - 0x488D
{
	iParam0->f_1 = 0f;
	iParam0->f_2 = 0f;
	*iParam0 = 0;
...
float func_84(int iParam0)//Position - 0x48A3
{
	if (func_89(iParam0))
	{
		if (func_86(iParam0))
		...
		{
			return (func_85(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}

float func_85(bool bParam0)//Position - 0x48E2
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_86(var uParam0)//Position - 0x493A
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*uParam0, 2);
}

void func_87(int iParam0, float fParam1)//Position - 0x494A
{
	if (!func_89(iParam0))
	{
...
void func_88(int iParam0, float fParam1)//Position - 0x4964
{
	iParam0->f_1 = (func_85(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 4)) - fParam1);
	MISC::SET_BIT(iParam0, 1);
	GRAPHICS::_0x35FB78DC42B7BD21(iParam0, 2);
	iParam0->f_2 = 0f;
}

bool func_89(var uParam0)//Position - 0x4992
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*uParam0, 1);
}

int func_90(vector3 vParam0)//Position - 0x49A2
{
	int iVar0;
	int iVar1;
	float fVar2;
...
bool func_91(int iParam0, int iParam1)//Position - 0x4A5D
{
	bool bVar0;
...
int func_92(int iParam0)//Position - 0x4AAA
{
	if (iParam0 != 4294967295)
	{
		if (!Global_19AC5[iParam0 /*10*/].f_1)
		{
			return 1;
		}
	}
...
int func_93(int iParam0, bool bParam1)//Position - 0x4ACB
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_94(int iParam0, var uParam1)//Position - 0x4B82
{
	switch (iParam0)
	{
		case 0:
		...
		case 1:
			func_95(uParam1, "Abigail2", func_97(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, 4294967295, 4, 1, 0, 2359, func_96(iParam0), 1, 0);
			break;
		
		case 2:
			func_95(uParam1, "Barry1", func_97(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 0, 2359, func_96(iParam0), 1, 0);
			break;
		
		case 3:
			func_95(uParam1, "Barry2", func_97(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_96(iParam0), 1, 1);
			break;
		
		case 4:
			func_95(uParam1, "Barry3", func_97(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", 4294967295, 0, "", 164, 1, 4294967295, 0, 2, 0, 2359, func_96(iParam0), 0, 0);
			break;
		...
		case 7:
			func_95(uParam1, "Barry4", func_97(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, 4294967295, 4, 2, 800, 2000, func_96(iParam0), 0, 0);
			break;
		
		case 8:
			func_95(uParam1, "Dreyfuss1", func_97(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_96(iParam0), 0, 0);
			break;
		...
		case 15:
			func_95(uParam1, "Epsilon7", func_97(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", 4294967295, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_96(iParam0), 0, 0);
			break;
		
		case 16:
			func_95(uParam1, "Epsilon8", func_97(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, 4294967295, 4, 1, 0, 2359, func_96(iParam0), 1, 0);
			break;
		
		case 17:
			func_95(uParam1, "Extreme1", func_97(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", 4294967295, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_96(iParam0), 0, 1);
			break;
		...
		case 20:
			func_95(uParam1, "Extreme4", func_97(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_96(iParam0), 0, 0);
			break;
		
		case 21:
			func_95(uParam1, "Fanatic1", func_97(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 700, 2000, func_96(iParam0), 1, 0);
			break;
		
		case 22:
			func_95(uParam1, "Fanatic2", func_97(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 700, 2000, func_96(iParam0), 1, 0);
			break;
		
		case 23:
			func_95(uParam1, "Fanatic3", func_97(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 2, 700, 2000, func_96(iParam0), 0, 1);
			break;
		
		case 24:
			func_95(uParam1, "Hao1", func_97(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", 4294967295, 0, "controller_Races", 13, 1, 4294967295, 4, 2, 2000, 500, func_96(iParam0), 0, 1);
			break;
		
		case 25:
			func_95(uParam1, "Hunting1", func_97(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", 4294967295, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_96(iParam0), 0, 1);
			break;
		
		case 26:
			func_95(uParam1, "Hunting2", func_97(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, 4294967295, 4, 4, 0, 2359, func_96(iParam0), 0, 1);
			break;
		
		case 27:
			func_95(uParam1, "Josh1", func_97(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", 4294967295, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_96(iParam0), 1, 0);
			break;
		...
		case 29:
			func_95(uParam1, "Josh3", func_97(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 4294967295, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_96(iParam0), 1, 1);
			break;
		
		case 30:
			func_95(uParam1, "Josh4", func_97(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", 4294967295, 36, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_96(iParam0), 1, 0);
			break;
		
		case 31:
			func_95(uParam1, "Maude1", func_97(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", 4294967295, 0, "BailBond_Launcher", 0, 1, 4294967295, 4, 4, 0, 2359, func_96(iParam0), 0, 1);
			break;
		
		case 32:
			func_95(uParam1, "Minute1", func_97(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", 4294967295, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_96(iParam0), 0, 1);
			break;
		
		case 33:
			func_95(uParam1, "Minute2", func_97(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", 4294967295, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_96(iParam0), 0, 1);
			break;
		
		case 34:
			func_95(uParam1, "Minute3", func_97(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", 4294967295, 10, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_96(iParam0), 0, 1);
			break;
		
		case 35:
			func_95(uParam1, "MrsPhilips1", func_97(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", 4294967295, 0, "ambient_MrsPhilips", 0, 1, 4294967295, 4, 4, 0, 2359, func_96(iParam0), 0, 0);
			break;
		
		case 36:
			func_95(uParam1, "MrsPhilips2", func_97(iParam0), 0, 11, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_96(iParam0), 0, 0);
			break;
		
		case 37:
			func_95(uParam1, "Nigel1", func_97(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", 4294967295, 0, "", 177, 1, 4294967295, 1, 4, 0, 2359, func_96(iParam0), 1, 0);
			break;
		...
		case 42:
			func_95(uParam1, "Nigel2", func_97(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", 4294967295, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_96(iParam0), 1, 1);
			break;
		
		case 43:
			func_95(uParam1, "Nigel3", func_97(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", 4294967295, 16, "postRC_Nigel3", 0, 0, 4294967295, 4, 4, 0, 2359, func_96(iParam0), 1, 1);
			break;
		
		case 44:
			func_95(uParam1, "Omega1", func_97(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", 4294967295, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_96(iParam0), 0, 0);
			break;
		
		case 45:
			func_95(uParam1, "Omega2", func_97(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_96(iParam0), 0, 0);
			break;
		
		case 46:
			func_95(uParam1, "Paparazzo1", func_97(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", 4294967295, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_96(iParam0), 0, 1);
			break;
		
		case 47:
			func_95(uParam1, "Paparazzo2", func_97(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", 4294967295, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_96(iParam0), 0, 1);
			break;
		
		case 48:
			func_95(uParam1, "Paparazzo3", func_97(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", 4294967295, 8, "", 183, 1, 4294967295, 2, 2, 0, 2359, func_96(iParam0), 0, 0);
			break;
		...
		case 51:
			func_95(uParam1, "Paparazzo4", func_97(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", 4294967295, 8, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_96(iParam0), 0, 0);
			break;
		
		case 52:
			func_95(uParam1, "Rampage1", func_97(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", 4294967295, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_96(iParam0), 0, 0);
			break;
		
		case 54:
			func_95(uParam1, "Rampage3", func_97(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", 4294967295, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_96(iParam0), 1, 0);
			break;
		
		case 55:
			func_95(uParam1, "Rampage4", func_97(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", 4294967295, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_96(iParam0), 1, 0);
			break;
		
		case 56:
			func_95(uParam1, "Rampage5", func_97(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", 4294967295, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_96(iParam0), 0, 0);
			break;
		
		case 53:
			func_95(uParam1, "Rampage2", func_97(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", 4294967295, 0, "rampage_controller", 0, 0, 4294967295, 4, 4, 0, 2359, func_96(iParam0), 1, 0);
			break;
		
		case 57:
			func_95(uParam1, "TheLastOne", func_97(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_96(iParam0), 0, 1);
			break;
		
		case 58:
			func_95(uParam1, "Tonya1", func_97(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", 4294967295, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_96(iParam0), 0, 1);
			break;
		
		case 59:
			func_95(uParam1, "Tonya2", func_97(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_96(iParam0), 0, 1);
			break;
		
		case 60:
			func_95(uParam1, "Tonya3", func_97(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_96(iParam0), 0, 1);
			break;
		
		case 61:
			func_95(uParam1, "Tonya4", func_97(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_96(iParam0), 0, 1);
			break;
		
		case 62:
			func_95(uParam1, "Tonya5", func_97(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_96(iParam0), 0, 1);
			break;
...
int func_96(int iParam0)//Position - 0x5DC8
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_97(int iParam0)//Position - 0x610E
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_98(int iParam0)//Position - 0x6145
{
	struct<2> Var0;
...
bool func_100(int iParam0, int iParam1)//Position - 0x65D7
{
	return func_101(CLOCK::GET_CLOCK_HOURS(), iParam0, iParam1);
}

int func_101(int iParam0, int iParam1, int iParam2)//Position - 0x65EB
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_102()//Position - 0x6694
{
	Global_11188.f_229 = 1;
	Global_11188.f_22A = 0;
}

void func_103(int iParam0)//Position - 0x66AC
{
	if (func_104(iParam0))
	{
		Global_1608A = iParam0;
		Global_1608E = 1;
		return;
	}
}

int func_104(int iParam0)//Position - 0x66CB
{
	switch (iParam0)
	{
		case 67:
...
int func_105(int iParam0)//Position - 0x672A
{
	int iVar0;
	...
	while (iVar0 < 8)
	{
		if (Global_16094[iVar0 /*17*/])
		{
			if (Global_16094[iVar0 /*17*/].f_9 != 263)
			{
				if (Global_64EA[Global_16094[iVar0 /*17*/].f_9 /*23*/].f_13 == iParam0)
				{
					return Global_16094[iVar0 /*17*/].f_5;
				}
			}
		}
		iVar0++;
...
void func_106(int iParam0)//Position - 0x6784
{
	if (Global_16089 != 4294967295)
	{
...
void func_107(int iParam0, bool bParam1)//Position - 0x67A8
{
	if (bParam1)
	{
...
void func_108(float fParam0)//Position - 0x67E6
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	while (!bVar1 && iVar2 < 10)
	{
		...
		{
			bVar1 = false;
			if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(Global_19A94, iVar2, &vVar3, 1, 3f, 0f))
			{
				iVar2++;
			}
		}
	}
	if (SYSTEM::VDIST2(vVar3, Global_19A94) > 2f)
	{
		PATHFIND::GET_SAFE_COORD_FOR_PED(vVar3, 0, &Global_19A94, 0);
	}
}

int func_109(int iParam0, vector3 vParam1, float fParam2)//Position - 0x68CE
{
	int iVar0[5];
	int iVar1;
...
int func_110()//Position - 0x6943
{
	return Global_1172B;
}

int func_111(int iParam0)//Position - 0x694F
{
	int iVar0;
...
void func_113()//Position - 0x6A17
{
	...
	fVar0 = func_116(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), Global_19A94);
	if (bLocal_64)
	{
...
void func_114(float fParam0)//Position - 0x6ACA
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 9)
	{
		if (func_89(&(Global_19E56.f_469B.f_AF[iVar0 /*19*/].f_5)))
		{
			func_115(&(Global_19E56.f_469B.f_AF[iVar0 /*19*/].f_5), (fParam0 * 60f));
		}
		iVar0++;
	}
	iVar1 = 0;
	while (iVar1 < 6)
	{
		if (func_89(&(Global_19E56.f_469B.f_16A[iVar1 /*3*/])))
		{
			func_115(&(Global_19E56.f_469B.f_16A[iVar1 /*3*/]), (fParam0 * 60f));
		}
		iVar1++;
	}
...
void func_115(int iParam0, float fParam1)//Position - 0x6B5B
{
	if (func_89(iParam0))
	{
...
float func_116(vector3 vParam0, vector3 vParam1)//Position - 0x6B7E
{
	return (SYSTEM::VMAG(vParam1 - vParam0) * 1.3f);
}

void func_117()//Position - 0x6B99
{
	float fVar0;
	int iVar1;
	
	fVar0 = (((func_116(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), Global_19A94) / 50f) * fLocal_73) * 2.4f);
...
void func_118()//Position - 0x6C01
{
	...
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), vLocal_820, false) > 50f)
	{
		fLocal_82 = (fLocal_82 + fLocal_73);
		iLocal_103 = 0;
		vLocal_820 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false) };
	}
	iLocal_101 = SYSTEM::CEIL(fLocal_82);
	if (iLocal_101 != iLocal_102)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_111, "SET_TAXI_PRICE");
		GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(iLocal_101);
		CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
		fLocal_83 = SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), Global_19A94);
		iLocal_102 = iLocal_101;
	}
}

void func_119()//Position - 0x6C9F
{
	int iVar0;
	float fVar1;
	...
	if (!func_37(14))
	{
		fVar1 = PATHFIND::CALCULATE_TRAVEL_DISTANCE_BETWEEN_POINTS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), Global_19A94);
		STATS::STAT_INCREMENT(iVar0, fVar1);
	}
}

void func_120()//Position - 0x6D12
{
	BRAIN::ENABLE_SCRIPT_BRAIN_SET();
	if (STREAMING::_0x07C313F94746702C(Global_1994C.f_DA))
	{
		STREAMING::_0x1EE7D8DF4425F053(Global_1994C.f_DA);
	}
}

int func_121(int iParam0, var uParam1, float fParam2)//Position - 0x6D35
{
	vector3 vVar0;
	...
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		switch (iLocal_807)
		{
			case 0:
				...
				if (HUD::DOES_BLIP_EXIST(Global_19A92) && *iParam0 == Global_19A92)
				{
					*uParam1 = { Global_19A97 };
					*fParam2 = Global_19A9B;
			...
			case 2:
				if (ENTITY::DOES_ENTITY_EXIST(Global_19A8D))
				{
					if (func_122(&Global_19A8D, unk_0x8000C77B5F336760(Global_19A8D, false), vLocal_816, uParam1, fParam2, &iLocal_88, 1000))
					{
						iLocal_807 = 3;
						return 1;
					}
...
int func_122(var uParam0, vector3 vParam1, vector3 vParam2, var uParam3, float fParam4, int iParam5, int iParam6)//Position - 0x6EF0
{
	float fVar0;
	float fVar1;
	vector3 vVar2;
...
int func_123(vector3 vParam0, vector3 vParam1)//Position - 0x723D
{
	float fVar0;
	float fVar1;
...
int func_124(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3)//Position - 0x729F
{
...
void func_125(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, var uParam4, var uParam5, int iParam6)//Position - 0x72BF
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_126(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x738A
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_127(vector3 vParam0)//Position - 0x7405
{
	char* sVar0;
...
int func_128(vector3 vParam0, var uParam1, float fParam2, int iParam3)//Position - 0x76F9
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar2[6];
...
bool func_129(vector3 vParam0, vector3 vParam1, float fParam2)//Position - 0x981C
{
	return SYSTEM::VDIST2(vParam0, vParam1) <= (fParam2 * fParam2);
}

float func_130(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3)//Position - 0x9836
{
	return SYSTEM::VDIST2(Param0, Param0.f_1, 0f, Param2, Param2.f_1, 0f);
}

int func_131()//Position - 0x9850
{
	int iVar0;
...
int func_132(int iParam0)//Position - 0x98AF
{
...
bool func_133(vector3 vParam0, vector3 vParam1, float fParam2)//Position - 0x98DC
{
	vector3 vVar0;
...
int func_134(vector3 vParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x9906
{
	vector3 vVar0[15];
	vector3 vVar1[15];
	float fVar2[15];
...
bool func_135(int iParam0, vector3 vParam1)//Position - 0xA65A
{
	return SYSTEM::VDIST2(vParam1, func_137(iParam0)) < func_136(iParam0);
}

float func_136(int iParam0)//Position - 0xA677
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_137(int iParam0)//Position - 0xA70F
{
	switch (iParam0)
	{
		case 1:
...
int func_138(vector3 vParam0, vector3 vParam1, vector3 vParam2)//Position - 0xA7F9
{
...
int func_139(vector3 vParam0, var uParam1, float fParam2)//Position - 0xA850
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_140(int iParam0, var uParam1, var uParam2)//Position - 0xA936
{
	switch (iParam0)
	{
		case 76:
...
int func_141(int iParam0, vector3 vParam1)//Position - 0xAC6C
{
	switch (iParam0)
	{
		case 76:
...
int func_142(int iParam0, var uParam1, var uParam2)//Position - 0xB290
{
	int iVar0;
...
int func_143(int iParam0, vector3 vParam1)//Position - 0xB762
{
	switch (iParam0)
	{
		case 9:
...
int func_144(int iParam0, var uParam1, var uParam2)//Position - 0xBE70
{
	int iVar0;
...
int func_145(int iParam0, vector3 vParam1)//Position - 0xC219
{
	switch (iParam0)
	{
		case 3:
...
int func_146(var uParam0, int iParam1, float fParam2)//Position - 0xC671
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_147(int iParam0)//Position - 0xC78A
{
	int iVar0;
...
int func_148(var uParam0)//Position - 0xC7C6
{
...
int func_149(var uParam0, int iParam1, float fParam2)//Position - 0xC8CC
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	{
		*iParam1 = iVar4;
		if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_4872[*iParam1 /*6*/], 0) && !INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_4872[*iParam1 /*6*/], 3))
		{
			func_94(*iParam1, &Var5);
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Var5.f_1A, func_150()))
			{
				vVar3 = { Var5.f_6 };
				if (uParam0->f_2 == 1f)
				{
...
int func_151(var uParam0, int iParam1, float fParam2)//Position - 0xCA22
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar4 < 8)
	{
		if (Global_16094[iVar4 /*17*/])
		{
			if (Global_16094[iVar4 /*17*/].f_9 != 263)
			{
				if (HUD::DOES_BLIP_EXIST(Global_64EA[Global_16094[iVar4 /*17*/].f_9 /*23*/].f_13))
				{
					vVar3 = { HUD::GET_BLIP_COORDS(Global_64EA[Global_16094[iVar4 /*17*/].f_9 /*23*/].f_13) };
					if (uParam0->f_2 == 1f)
					{
						vVar3.z = 1f;
					}
					...
					if (fVar2 < fVar1)
					{
						if (fVar2 < Global_16094[iVar4 /*17*/].f_A.f_2)
						{
							fVar1 = fVar2;
							iVar0 = iVar4;
						}
	...
	{
		*fParam2 = fVar1;
		*iParam1 = Global_16094[iVar0 /*17*/].f_5;
		return 1;
	}
	*iParam1 = 4294967295;
	*fParam2 = 999999f;
...
void func_153(int iParam0)//Position - 0xCB11
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	if (PED::DOES_GROUP_EXIST(func_6()))
	{
		...
		if (iVar0 > 0)
		{
			if (iVar0 > 1)
			{
				...
				if (!PED::IS_PED_INJURED(iVar2))
				{
					if (!PED::IS_PED_SITTING_IN_VEHICLE(iVar2, Global_19A8D))
					{
						iVar3 = 0;
						if (!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_19A8D, iVar3, 0))
						{
							iVar3 = func_154(&Global_19A8D);
							if (VEHICLE::IS_VEHICLE_SEAT_FREE(Global_19A8D, iVar3, 0))
							{
								NETWORK::_0x5E3AA4CA2B6FB0EE(iVar2);
								PED::SET_PED_INTO_VEHICLE(iVar2, Global_19A8D, iVar3);
							}
						}
						else
						{
...
int func_154(var uParam0)//Position - 0xCC39
{
...
bool func_155(int iParam0, int iParam1)//Position - 0xCC8A
{
	return (MISC::GET_GAME_TIMER() - iParam0) > iParam1;
}

void func_156(bool bParam0)//Position - 0xCC9C
{
	if (bParam0)
	{
		func_162();
...
void func_157(int iParam0)//Position - 0xCCFF
{
	if (func_160())
	{
		return;
...
void func_159(bool bParam0, bool bParam1)//Position - 0xCDA0
{
	if (bParam0)
	{
		if (func_161(0))
...
bool func_160()//Position - 0xCE14
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

int func_161(int iParam0)//Position - 0xCE26
{
	if (iParam0 == 1)
	{
...
void func_163()//Position - 0xCEA9
{
	...
	if (!PED::IS_PED_INJURED(Global_19A8E) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Global_19A8D, 0))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(Global_19A8E, Global_19A8D))
		{
			if (VEHICLE::IS_VEHICLE_STOPPED(Global_19A8D))
			{
				if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_19A8E, &cLocal_811, "leanover_enter", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(Global_19A8E, &cLocal_811, "leanover_idle", 3))
				{
					if (!func_2(Global_19A8E, 2176111930))
			...
			else if (!func_2(Global_19A8E, 4022883198))
			{
				vVar0 = { unk_0x8000C77B5F336760(Global_19A8D, true) };
				fVar1 = ENTITY::GET_ENTITY_HEADING(Global_19A8D);
				BRAIN::TASK_VEHICLE_PARK(Global_19A8E, Global_19A8D, vVar0, fVar1, 3, 60f, 0);
			}
		}
	}
}

void func_164()//Position - 0xCF88
{
	int iVar0;
	float fVar1;
		...
		if (bLocal_61)
		{
			...
			if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Global_19A8D, 0))
			{
				if (!PED::IS_PED_INJURED(Global_19A8E))
				{
					if (func_166())
					{
						if (ENTITY::GET_ENTITY_SPEED(Global_19A8D) < 2f)
						{
							if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
							{
								if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), Global_19A8D, 1))
					...
					else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_19A8E, &cLocal_811, "leanover_enter", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(Global_19A8E, &cLocal_811, "leanover_idle", 3))
					{
						if (PED::IS_PED_HEADTRACKING_PED(Global_19A8E, AUDIO::_0x0626A247D2405330()))
						{
							BRAIN::TASK_CLEAR_LOOK_AT(Global_19A8E);
						}
						BRAIN::TASK_PLAY_ANIM(Global_19A8E, &cLocal_811, "leanover_exit", 4f, -4f, 4294967295, 0, 0, 0, 0, 0);
					}
					else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_19A8E, &cLocal_811, "leanover_exit", 3))
					{
						ENTITY::SET_ENTITY_ANIM_SPEED(Global_19A8E, &cLocal_811, "leanover_exit", 1.2f);
						iLocal_90 = MISC::GET_GAME_TIMER();
						func_168(&Global_19A8D, iLocal_826);
					}
					else if (!func_2(Global_19A8E, 242628503))
					{
						...
						else
						{
							...
							NETWORK::_0x5E3AA4CA2B6FB0EE(Global_19A8E);
							BRAIN::TASK_CLEAR_LOOK_AT(Global_19A8E);
							PED::SET_DRIVER_ABILITY(Global_19A8E, 0.5f);
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_800);
							BRAIN::TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(0, Global_19A8D, Global_19A94, fVar1, iVar0, 45f);
							BRAIN::TASK_VEHICLE_PARK(0, Global_19A8D, Global_19A94, Global_19A9A, iLocal_110, 60f, 1);
							CUTSCENE::_0x8D9DF6ECA8768583(iLocal_800);
							BRAIN::TASK_PERFORM_SEQUENCE(Global_19A8E, iLocal_800);
...
int func_165(int iParam0, int iParam1)//Position - 0xD180
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	if (func_155(*iParam0, 2000) || *iParam0 == 4294967295)
	{
		return 0;
	}
	if (!PED::DOES_GROUP_EXIST(func_6()))
	...
	if (!PED::IS_PED_INJURED(iVar3))
	{
		...
		bVar4 = true;
		iVar2 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(Global_19A8D, iVar6, 0);
		if (ENTITY::DOES_ENTITY_EXIST(iVar2))
		{
			if (iVar2 == AUDIO::_0x0626A247D2405330())
			{
				bVar4 = false;
			}
			else if (iVar2 == iVar3)
		...
		if (bVar4)
		{
			BRAIN::TASK_ENTER_VEHICLE(iVar3, Global_19A8D, 20000, iVar6, 2f, 9437185, 0);
			bVar5 = true;
		}
	}
	if (iVar0 > 1)
...
int func_166()//Position - 0xD305
{
	if ((ENTITY::IS_ENTITY_AT_COORD(Global_19A8D, Global_19A94, 45f, 45f, 20f, false, true, 0) || iLocal_56) || iLocal_808 == 4)
	{
		iLocal_56 = 1;
		if (BRAIN::GET_SCRIPT_TASK_STATUS(Global_19A8E, 242628503) == 7)
		{
			return 1;
		}
	}
...
int func_167()//Position - 0xD35C
{
	if (bLocal_60)
	{
		...
		else if (func_121(&vLocal_43, &Global_19A94, &Global_19A9A))
		{
			iLocal_103 = 0;
			vLocal_820 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false) };
			fLocal_83 = SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), Global_19A94);
...
void func_168(var uParam0, int iParam1)//Position - 0xD3B4
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	if (PED::DOES_GROUP_EXIST(func_6()))
	{
		...
		if (iVar0 > 0)
		{
			...
			if (!PED::IS_PED_INJURED(iVar2))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iVar3))
				{
					if (iVar3 == AUDIO::_0x0626A247D2405330())
					{
						bVar4 = false;
					}
					else if (iVar3 == iVar2)
	...
	if (!PED::IS_PED_INJURED(Global_19A8E) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Global_19A8D, 0))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(Global_19A8E, Global_19A8D))
		{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_811))
			{
				...
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_800);
				BRAIN::TASK_PLAY_ANIM(0, &cLocal_811, "leanover_enter", 4f, -8f, 4294967295, 0, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(0, &cLocal_811, "leanover_idle", 4f, -8f, 4294967295, 1, 0, 0, 0, 0);
				CUTSCENE::_0x8D9DF6ECA8768583(iLocal_800);
				BRAIN::TASK_PERFORM_SEQUENCE(Global_19A8E, iLocal_800);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_800);
				return 1;
...
int func_170()//Position - 0xD59A
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_19A8D))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Global_19A8D, 0))
		{
			iLocal_109 = OBJECT::CREATE_OBJECT(iLocal_108, unk_0x8000C77B5F336760(Global_19A8D, true), true, true, false);
			ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_109, Global_19A8D, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(Global_19A8D, "Chassis"), vLocal_824, vLocal_825, 0, 0, 0, 0, 2, 1);
			VEHICLE::SET_TAXI_LIGHTS(Global_19A8D, 0);
			if (!HUD::IS_NAMED_RENDERTARGET_REGISTERED("taxi"))
			{
...
void func_172()//Position - 0xD68D
{
	...
	if (!CAM::DOES_CAM_EXIST(iLocal_68))
	{
		if (!func_180() && !func_179(8, 4294967295))
		{
			iLocal_68 = CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", false);
			CAM::ATTACH_CAM_TO_ENTITY(iLocal_68, Global_19A8D, vLocal_822, 1);
			func_176();
...
void func_173()//Position - 0xD7AA
{
	...
	GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(iLocal_92);
	CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
}

void func_174()//Position - 0xD7F2
{
	vector3 vVar0;
...
void func_175(int iParam0, bool bParam1, int iParam2)//Position - 0xD837
{
	switch (iParam0)
	{
		case 5:
...
void func_176()//Position - 0xD886
{
	if (CAM::DOES_CAM_EXIST(iLocal_68))
	{
		func_177(Global_19A8D, &iLocal_68, vLocal_823);
...
void func_177(int iParam0, int iParam1, vector3 vParam2)//Position - 0xD8C5
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		if (CAM::DOES_CAM_EXIST(*iParam1))
		{
			...
			fVar3 = vVar0.y;
			vVar4 = { func_79(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_19A8D, vParam2) - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_19A8D, vLocal_822)) };
...
void func_178(vector3 vParam0, var uParam1, var uParam2, int iParam3)//Position - 0xD930
{
	float fVar0;
...
bool func_179(int iParam0, int iParam1)//Position - 0xD9D5
{
	switch (iParam0)
	{
		case 5:
...
bool func_180()//Position - 0xDA10
{
	return Global_434A;
}

void func_181()//Position - 0xDA1B
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar0 < iLocal_91)
	{
		...
		else if (func_186(vLocal_806[iVar0 /*3*/]) == 4294967295)
		{
		}
		else if (func_126(HUD::GET_BLIP_COORDS(vLocal_806[iVar0 /*3*/]), 0f, 0f, 0f, 1056964608, 0))
		{
		}
		else
		{
			...
			GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(iVar0);
			GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(HUD::GET_BLIP_SPRITE(vLocal_806[iVar0 /*3*/]));
			...
			{
				GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_182(iVar6));
				CAM::_DISABLE_VEHICLE_FIRST_PERSON_CAM_THIS_FRAME();
			}
			if (HUD::GET_BLIP_INFO_ID_TYPE(vLocal_806[iVar0 /*3*/]) == 2)
			{
				...
				{
					vVar5 = { unk_0x8000C77B5F336760(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(HUD::GET_BLIP_INFO_ID_ENTITY_INDEX(vLocal_806[iVar0 /*3*/])), true) };
				}
			}
			else if (HUD::GET_BLIP_INFO_ID_TYPE(vLocal_806[iVar0 /*3*/]) == 1)
			{
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(HUD::GET_BLIP_INFO_ID_ENTITY_INDEX(vLocal_806[iVar0 /*3*/]), 0))
				{
					vVar5 = { unk_0x8000C77B5F336760(HUD::GET_BLIP_INFO_ID_ENTITY_INDEX(vLocal_806[iVar0 /*3*/]), true) };
				}
			}
			else
			{
...
char* func_182(int iParam0)//Position - 0xDC89
{
	switch (iParam0)
	{
		case 0:
...
char* func_183(int iParam0, int iParam1)//Position - 0xDFFE
{
	switch (iParam0)
	{
		case 4294967295:
...
int func_184(int iParam0)//Position - 0xE3CF
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar0 < 50)
	{
		...
		if (Global_64EA[iVar2 /*23*/].f_13 == iParam0)
		{
			return iVar1;
		}
		iVar0++;
...
int func_185(int iParam0)//Position - 0xE40A
{
	switch (iParam0)
	{
		case 4294967295:
...
int func_186(int iParam0)//Position - 0xE6EA
{
	int iVar0;
...
void func_187()//Position - 0xE705
{
	...
	if (MISC::GET_MISSION_FLAG())
	{
		if (iLocal_94 == 0)
		{
			if (HUD::DOES_BLIP_EXIST(Global_19A91))
			{
				iVar0 = 0;
				while (iVar0 < 40)
				{
					if (HUD::DOES_BLIP_EXIST(vLocal_806[iVar0 /*3*/]))
					{
						if (vLocal_806[iVar0 /*3*/] == Global_19A91)
						{
							iLocal_92 = iVar0;
							iVar0 = 40;
						}
	...
	else if (!Global_19A91 == 0)
	{
		Global_19A91 = 0;
	}
	if (MISC::GET_MISSION_FLAG())
	{
		if (!Global_19A93 == 4294967295)
		{
			iVar0 = 0;
			while (iVar0 < 40)
			{
				if (HUD::DOES_BLIP_EXIST(vLocal_806[iVar0 /*3*/]))
				{
					if (func_186(vLocal_806[iVar0 /*3*/]) == Global_19A93)
					{
						iLocal_92 = iVar0;
						iVar0 = 40;
					}
	...
	else if (!Global_19A93 == 4294967295)
	{
		Global_19A93 = 4294967295;
	}
}

int func_188()//Position - 0xEB7F
{
	int iVar0;
	int iVar1;
...
int func_189(int iParam0)//Position - 0xEC3B
{
...
int func_190(int iParam0)//Position - 0xEC81
{
	int iVar0;
...
void func_191(int iParam0, bool bParam1)//Position - 0xECB1
{
	vector3 vVar0;
	bool bVar1;
	int iVar2;
			...
			if (func_190(iVar2))
			{
				if (func_203(iVar2))
				{
					if (!func_201(&iVar2))
					{
						...
						if (HUD::DOES_BLIP_EXIST(Global_19A90))
						{
							if (func_186(iVar2) == iLocal_44)
							{
								if (!Global_19A90 == iVar2)
								{
									bVar1 = false;
								}
							}
...
void func_192(vector3 vParam0, bool bParam1)//Position - 0xF107
{
	int iVar0;
	int iVar1;
	...
	iVar0 = 0;
	iVar1 = 0;
	if (func_186(vParam0.x) == 4294967295)
	{
		return;
	}
	iVar0 = 0;
...
void func_193(vector3 vParam0, int iParam1)//Position - 0xF226
{
	func_194(iParam1);
	vLocal_806[iParam1 /*3*/] = { vParam0 };
	if (func_186(vLocal_806[iParam1 /*3*/]) == HUD::_GET_BLIP_INFO_ID_ITERATOR())
	{
		iLocal_97 = iParam1;
...
void func_194(int iParam0)//Position - 0xF267
{
	int iVar0;
	vector3 vVar1;
...
void func_195(vector3 vParam0, int iParam1)//Position - 0xF2AC
{
	vLocal_806[iParam1 /*3*/] = { vParam0 };
	if (func_186(vLocal_806[iParam1 /*3*/]) == HUD::_GET_BLIP_INFO_ID_ITERATOR())
	{
...
int func_196(int iParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5)//Position - 0xF2E7
{
...
float func_197(int iParam0)//Position - 0xF304
{
	vector3 vVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
		if (HUD::DOES_BLIP_EXIST(iParam0))
		{
			vVar0 = { func_45(iParam0) - unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true) };
		}
	}
	return SYSTEM::VMAG(vVar0);
}

void func_198(int iParam0, var uParam1)//Position - 0xF347
{
	vector3 vVar0;
	
	*uParam1 = *iParam0;
	if (!*uParam1 == Global_19A92)
	{
	...
	{
		PATHFIND::GET_STREET_NAME_AT_COORD(Global_19A94, &(uParam1->f_1), &(uParam1->f_2));
	}
}

int func_199(int iParam0)//Position - 0xF391
{
	int iVar0;
...
int func_200(int iParam0)//Position - 0xF3FF
{
	int iVar0;
	...
	while (iVar0 < 8)
	{
		if (Global_16094[iVar0 /*17*/])
		{
			if (Global_16094[iVar0 /*17*/].f_9 != 263)
			{
				if (HUD::DOES_BLIP_EXIST(Global_64EA[Global_16094[iVar0 /*17*/].f_9 /*23*/].f_13))
				{
					if (Global_64EA[Global_16094[iVar0 /*17*/].f_9 /*23*/].f_13 == *iParam0)
					{
						return Global_16094[iVar0 /*17*/].f_5;
...
int func_201(int iParam0)//Position - 0xF472
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
		return 1;
	}
	if (Global_19A8F == *iParam0)
	{
		return 1;
	}
	...
	if (func_202(HUD::GET_BLIP_COORDS(*iParam0), 0f, 0f, 0f, 0))
	{
		return 1;
	}
	if (func_186(*iParam0) == 4294967295)
	{
		return 1;
	}
	return 0;
...
bool func_202(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0xF4CD
{
	if (bParam2)
	{
...
int func_203(int iParam0)//Position - 0xF514
{
	float fVar0;
	...
	if (SYSTEM::TIMERB() > 250)
	{
		...
		if (!bVar0)
		{
			if (iLocal_97 != 4294967295)
			{
				...
				{
					if (func_186(vLocal_806[iLocal_97 /*3*/]) == HUD::_GET_BLIP_INFO_ID_ITERATOR())
					{
...
int func_206()//Position - 0xF670
{
	int iVar0;
	
	iVar0 = 0;
	if (func_3(Global_19A8D))
	{
		if (!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_19A8D, 4294967295, 0))
		{
			iVar0++;
		}
		if (!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_19A8D, 0, 0))
		{
			iVar0++;
		}
		if (!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_19A8D, 1, 0))
		{
			iVar0++;
		}
		if (!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_19A8D, 2, 0))
		{
			iVar0++;
		}
	}
...
void func_208()//Position - 0xF717
{
	...
	if (iLocal_808 != 0)
	{
		if (iLocal_91 > 1)
		{
			...
			if (iVar0 > 28 || NETWORK::_0x5C497525F803486B(2, 180))
			{
				if (!iLocal_62)
				{
					if (bLocal_60)
			...
			if (iVar0 < 4294967268 || PAD::IS_CONTROL_JUST_PRESSED(2, 181))
			{
				if (!iLocal_63)
				{
					if (bLocal_60)
			...
			if (iLocal_808 == 2)
			{
				...
				if (!bLocal_64)
				{
					if (PAD::IS_CONTROL_JUST_PRESSED(2, 179))
					{
						...
						if (!PED::IS_PED_INJURED(Global_19A8E))
						{
							if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_19A8E, &cLocal_811, "leanover_enter", 3))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_19A8E, &cLocal_811, "leanover_idle", 3))
								{
									if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_19A8E, &cLocal_811, "leanover_exit", 3))
									{
										NETWORK::_0x5E3AA4CA2B6FB0EE(Global_19A8E);
									}
								}
...
int func_211(vector3 vParam0)//Position - 0xFB0D
{
...
void func_213(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)//Position - 0xFB9C
{
...
bool func_215()//Position - 0xFCEB
{
	return MISC::GET_GAME_TIMER() <= Global_43D7.f_16F1 + 100;
}

bool func_216()//Position - 0xFD00
{
	return Global_10B8E;
}

void func_217()//Position - 0xFD0C
{
	if (!Global_19A92 == 0)
	{
		if (!HUD::DOES_BLIP_EXIST(Global_19A92))
		{
			Global_19A92 = 0;
		}
	}
...
void func_218()//Position - 0xFD2F
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
		PLAYER::SET_ALL_RANDOM_PEDS_FLEE_THIS_FRAME(CAM::_0xDC9DA9E8789F5246());
		PLAYER::_0x36F1B38855F2A8DF(CAM::_0xDC9DA9E8789F5246());
		PLAYER::_SWITCH_CRIME_TYPE(CAM::_0xDC9DA9E8789F5246(), 2);
		PLAYER::_SWITCH_CRIME_TYPE(CAM::_0xDC9DA9E8789F5246(), 3);
		PLAYER::_SWITCH_CRIME_TYPE(CAM::_0xDC9DA9E8789F5246(), 4);
		PLAYER::_SWITCH_CRIME_TYPE(CAM::_0xDC9DA9E8789F5246(), 5);
		PLAYER::_SWITCH_CRIME_TYPE(CAM::_0xDC9DA9E8789F5246(), 15);
	}
}

void func_219()//Position - 0xFD80
{
...
void func_220()//Position - 0xFDED
{
	MISC::SET_BIT(&Global_950, 4);
}

int func_221()//Position - 0xFDFD
{
	int iVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
		if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330()))
		{
			...
			{
				if (func_222(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
				{
					iVar0 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 4294967295, 0);
...
int func_222(int iParam0)//Position - 0xFF0C
{
...
int func_223(int iParam0)//Position - 0xFF27
{
	vector3 vVar0;
	float fVar1;
	vector3 vVar2;
	...
	if (func_56(AUDIO::_0x0626A247D2405330()) != iLocal_71)
	{
		return 1;
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Global_19A8D))
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Global_19A8E))
	{
		return 1;
	}
	if (PED::IS_PED_INJURED(Global_19A8E))
	...
	if (iLocal_808 != 4)
	{
		if (iParam0 == 1)
		{
			...
			if (((VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(Global_19A8D, 2, 30000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(Global_19A8D, 3, 30000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(Global_19A8D, 0, 7000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(Global_19A8D, 1, 7000))
			{
				return 1;
			}
		}
		vVar0 = { unk_0x8000C77B5F336760(Global_19A8D, false) };
...
int func_225()//Position - 0x100C9
{
	...
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		...
		if (func_229(&iVar0, func_231(), func_230()))
		{
			...
			HUD::HIDE_HUD_COMPONENT_THIS_FRAME(2);
			AUDIO::STOP_PED_SPEAKING(AUDIO::_0x0626A247D2405330(), true);
			if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iVar0, 1, 0) == AUDIO::_0x0626A247D2405330())
			{
				iLocal_826 = 1;
			}
			else
			...
			{
				vLocal_819 = { unk_0x8000C77B5F336760(Global_19A8D, true) - unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true) };
				vLocal_819.z = 0f;
				fLocal_72 = SYSTEM::VMAG(vLocal_819);
				iLocal_71 = func_56(AUDIO::_0x0626A247D2405330());
				func_226();
				iLocal_96 = func_206();
				iLocal_58 = 1;
				PAD::DISABLE_CONTROL_ACTION(0, 75, 1);
...
void func_226()//Position - 0x101AD
{
	int iVar0;
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Global_19A8D, 0))
	{
		if (!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_19A8D, 1, 0))
		{
			iVar0 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(Global_19A8D, 1, 0);
			if (AUDIO::_0x0626A247D2405330() != iVar0)
			{
				if (!PED::IS_PED_GROUP_MEMBER(iVar0, PLAYER::GET_PLAYER_GROUP(CAM::_0xDC9DA9E8789F5246())))
				{
					BRAIN::TASK_SMART_FLEE_PED(iVar0, AUDIO::_0x0626A247D2405330(), 200f, 4294967295, 0, 0);
				}
			}
		}
		if (!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_19A8D, 2, 0))
		{
			iVar0 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(Global_19A8D, 2, 0);
			if (AUDIO::_0x0626A247D2405330() != iVar0)
			{
				if (!PED::IS_PED_GROUP_MEMBER(iVar0, PLAYER::GET_PLAYER_GROUP(CAM::_0xDC9DA9E8789F5246())))
				{
...
int func_227(int iParam0, int iParam1, bool bParam2)//Position - 0x1024F
{
	if (!*iParam0 == Global_19A8D && !Global_19A8D == 0)
	{
		func_228();
	}
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(*iParam0, 0))
		{
			if (!PED::IS_PED_INJURED(*iParam1))
			{
				...
				{
					Global_19A8D = *iParam0;
					Global_19A8E = *iParam1;
					Global_19A9C = 1;
					if (bParam2)
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_19A8E, true, 1);
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_19A8D, true, 1);
						StringCopy(&Global_19AAC, SCRIPT::GET_THIS_SCRIPT_NAME(), 24);
					}
					else
					{
						if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_19A8E))
						{
							ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_19A8E, true, 0);
						}
						if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_19A8D))
						{
							ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_19A8D, true, 0);
							StringCopy(&Global_19AAC, SCRIPT::GET_THIS_SCRIPT_NAME(), 24);
						}
					}
					PED::SET_PED_CONFIG_FLAG(Global_19A8E, 251, true);
					PED::SET_PED_COMBAT_ATTRIBUTES(Global_19A8E, 5, false);
					PED::SET_PED_COMBAT_ATTRIBUTES(Global_19A8E, 17, true);
					PED::SET_PED_FLEE_ATTRIBUTES(Global_19A8E, 512, false);
					ENTITY::SET_ENTITY_HEALTH(Global_19A8E, true);
					AUDIO::SET_AMBIENT_VOICE_NAME(Global_19A8E, "A_M_M_EASTSA_02_LATINO_FULL_01");
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(Global_19A8D, 1);
					VEHICLE::SET_VEHICLE_HAS_BEEN_OWNED_BY_PLAYER(Global_19A8D, 1);
					VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(Global_19A8D, false, 0);
					VEHICLE::_0xBE5C1255A1830FF5(Global_19A8D, 1);
					return 1;
				}
			}
		}
...
void func_228()//Position - 0x10393
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_19A8E))
	{
		if (!PED::IS_PED_INJURED(Global_19A8E))
		{
			PED::SET_PED_CONFIG_FLAG(Global_19A8E, 251, false);
			ENTITY::SET_ENTITY_HEALTH(Global_19A8E, false);
			if (!PED::IS_PED_FLEEING(Global_19A8E) && !PED::IS_PED_IN_COMBAT(Global_19A8E, 0))
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(Global_19A8E, 0))
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_19A8D))
					{
						if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Global_19A8D, 0))
						{
							if (PED::IS_PED_SITTING_IN_VEHICLE(Global_19A8E, Global_19A8D))
							{
								if (BRAIN::GET_SCRIPT_TASK_STATUS(Global_19A8E, 4036695475) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(Global_19A8E, 4036695475) != 0)
								{
									BRAIN::OPEN_SEQUENCE_TASK(&iVar0);
									if ((!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_19A8D, 1, 0) || !VEHICLE::IS_VEHICLE_SEAT_FREE(Global_19A8D, 2, 0)) || !VEHICLE::IS_VEHICLE_SEAT_FREE(Global_19A8D, 0, 0))
									{
									...
									BRAIN::TASK_VEHICLE_DRIVE_WANDER(0, Global_19A8D, 12f, 790699);
									CUTSCENE::_0x8D9DF6ECA8768583(iVar0);
									BRAIN::TASK_PERFORM_SEQUENCE(Global_19A8E, iVar0);
									BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
								}
							}
							else
							{
								BRAIN::TASK_SMART_FLEE_PED(Global_19A8E, AUDIO::_0x0626A247D2405330(), 500f, 4294967295, 0, 0);
							}
						}
						else
						{
				...
				else if (BRAIN::GET_SCRIPT_TASK_STATUS(Global_19A8E, 3148068810) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(Global_19A8E, 3148068810) != 0)
				{
					BRAIN::TASK_WANDER_STANDARD(Global_19A8E, 1193033728, 0);
				}
			}
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(Global_19A8E))
	{
		if (ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_19A8E))
		{
			if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_19A8E, 0))
			{
				if (!PED::IS_PED_INJURED(Global_19A8E))
				{
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Global_19A8E, false, 1);
					ENTITY::SET_ENTITY_HEALTH(Global_19A8E, false);
				}
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&Global_19A8E);
			}
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(Global_19A8D))
	{
		if (ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_19A8D))
		{
			if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_19A8D, 0))
			{
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Global_19A8D, 0))
				{
					VEHICLE::SET_VEHICLE_HAS_BEEN_OWNED_BY_PLAYER(Global_19A8D, 0);
					VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(Global_19A8D, true, 0);
					VEHICLE::_0xBE5C1255A1830FF5(Global_19A8D, 0);
				}
				ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&Global_19A8D);
			}
		}
	}
	Global_19A8E = 0;
	Global_19A8D = 0;
	StringCopy(&Global_19AAC, "NULL", 24);
	Global_19AB2 = 4294967295;
}

int func_229(int iParam0, int iParam1, int iParam2)//Position - 0x105D1
{
	int iVar0;
	int iVar1;
...
int func_230()//Position - 0x10665
{
	return joaat("a_m_y_stlat_01");
}

int func_231()//Position - 0x10672
{
	return joaat("TAXI");
}

void func_232(bool bParam0)//Position - 0x1067F
{
	...
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_112);
	if (func_233(Global_19A8E))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_19A8E, &cLocal_811, "leanover_enter", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(Global_19A8E, "leanover_enter", &cLocal_811, -2f);
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_19A8E, &cLocal_811, "leanover_idle", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(Global_19A8E, "leanover_idle", &cLocal_811, -2f);
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_19A8E, &cLocal_811, "leanover_exit", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(Global_19A8E, "leanover_exit", &cLocal_811, -2f);
		}
		if (PED::IS_PED_HEADTRACKING_PED(Global_19A8E, AUDIO::_0x0626A247D2405330()))
		{
			BRAIN::TASK_CLEAR_LOOK_AT(Global_19A8E);
		...
		if (iLocal_810 != 10)
		{
			...
			if (bParam0)
			{
				if (CAM::IS_SCREEN_FADED_OUT() || CAM::IS_SCREEN_FADING_OUT())
				{
					...
					{
						if ((!func_77() && !func_8()) && Global_16C30 != 10)
						{
							CAM::DO_SCREEN_FADE_IN(250);
						}
					}
	...
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if (func_3(Global_19A8D))
		{
			if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), Global_19A8D, 1))
			{
				if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(Global_19A8D, 4294967295, 0) != AUDIO::_0x0626A247D2405330())
				{
					if (!func_2(AUDIO::_0x0626A247D2405330(), 3466132403) && !func_2(AUDIO::_0x0626A247D2405330(), 451360105))
					{
						BRAIN::TASK_LEAVE_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0, 0);
...
int func_233(int iParam0)//Position - 0x108DD
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
