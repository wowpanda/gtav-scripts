...
void __EntryFunction__()//Position - 0x0
{
	...
	if (Global_28006E)
	{
		if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(3345094074) == 0)
		{
			SCRIPT::REQUEST_SCRIPT_WITH_NAME_HASH(3345094074);
			while (!SCRIPT::HAS_SCRIPT_WITH_NAME_HASH_LOADED(3345094074))
			{
				SYSTEM::WAIT(0);
			}
	...
	if (func_69(AUDIO::_0x0626A247D2405330()))
	{
	}
	func_63();
	while (true)
	{
		...
		if (func_62(AUDIO::_0x0626A247D2405330(), vVar2, 0) > (100f + 20f))
		{
			func_70();
		}
		bVar0 = false;
...
int func_1(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)//Position - 0x196
{
	...
	switch (uParam1->f_D)
	{
		...
		case 8:
			...
			if (func_18(iParam0[uParam1->f_C /*24*/]) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) == 0)
			{
				func_40(uParam1, 0);
				return 0;
			}
...
bool func_18(var uParam0)//Position - 0xD9E
{
	...
	if (uParam0->f_B == 0)
	{
		return !func_21(AUDIO::_0x0626A247D2405330(), uParam0->f_1, (uParam0->f_A + 2f));
	}
...
void func_33()//Position - 0x117F
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_36(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_34(iVar0) && (!func_6(14) || Global_19A3D))
			{
...
bool func_41(var uParam0)//Position - 0x137D
{
	...
	return func_21(AUDIO::_0x0626A247D2405330(), uParam0->f_1, uParam0->f_A);
}
...
void func_56(int iParam0)//Position - 0x1929
{
	...
	if (iLocal_61[iParam0] == 0)
	{
		...
		{
			iLocal_61[iParam0] = SHAPETEST::_START_SHAPE_TEST_CAPSULE_2(vLocal_59[iParam0 /*3*/], vLocal_59[iParam0 /*3*/] + Vector(1f, 0f, 0f), 2f, 2, PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 4);
		}
	}
	else
	{
