	...
	while (true)
	{
		...
		if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("docks_setup")) == 0)
		{
			if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
			{
				...
				{
					iLocal_28 = PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0);
				}
				else
				{
					iLocal_28 = 0;
			...
			{
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_28, 0))
				{
					if (VEHICLE::IS_VEHICLE_MODEL(iLocal_28, joaat("HANDLER")))
					{
						...
						if (!VEHICLE::_0x62CA17B74C435651(iLocal_28))
						{
							if (iLocal_32 == 0)
							{
								if (!ENTITY::DOES_ENTITY_EXIST(iLocal_29) || (ENTITY::DOES_ENTITY_EXIST(iLocal_29) && OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(unk_0x8000C77B5F336760(iLocal_28, true), 15f, 874602658, 1, 0, 1) != iLocal_29))
								{
									iLocal_29 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(unk_0x8000C77B5F336760(iLocal_28, true), 15f, 874602658, 1, 0, 1);
								}
