...
void __EntryFunction__()
{
	...
	if (MISC::GET_GAME_TIMER() < Global_25538 + 10000 && !func_101())
	{
		func_109(0);
	}
	...
	Global_25538 = MISC::GET_GAME_TIMER();
	...
	while (iVar0 == 1)
	{
		...
		if (bLocal_330)
		{
			...
			StringIntConCat(&cVar13, Global_105165[iLocal_217], 64);
			...
			StringIntConCat(&cVar13, iLocal_221[Global_105165[iLocal_217]], 64);
		...
		switch (iLocal_216)
		{
			...
			case 8:
				...
				else if (!func_56())
				{
					...
					if (iLocal_223 < iLocal_221[Global_105165[iLocal_217]] && iVar8)
					{
						func_57();
						iLocal_216 = 7;
					}
				...
				else if (iLocal_269 == 1)
				{
					...
					{
						func_46(Global_105165[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_208, &Local_253, &Local_252));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_55();
				bVar37 = func_56();
				func_45(Global_105165[iLocal_217]);
				if (!bVar37 && (!bVar36 || bLocal_266))
				{
					if (bLocal_329)
					{
						Global_105165[iLocal_217] = uLocal_328;
					}
					else
					{
						Global_105165[iLocal_217]++;
					}
					if (!Global_105165[iLocal_217] < iLocal_218)
					{
						Global_105165[iLocal_217] = 0;
					}
					func_95(0, 1);
					iLocal_216 = 0;
				}
...
void func_48()
{
	...
	func_51(Global_105165[iLocal_217] + 1, &sVar0, &Var1);
	...
	PED::_0x2208438012482A1A(iLocal_208, 0, 0);
	func_49(Global_105165[iLocal_217]);
}
...
int func_52()
{
	...
	Var0 = { Local_230 };
	StringIntConCat(&Var0, Global_105165[iLocal_217] + 1, 16);
	func_43(&uLocal_37, 3, iLocal_208, &Local_205, 0, 1);
	if (bLocal_266)
	{
		iVar1 = 1;
...
void func_60(char* sParam0)
{
	...
	StringIntConCat(sParam0, Global_105165[iLocal_217] + 1, 16);
}
...
void func_62(int iParam0, bool bParam1)
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (func_71(iParam0))
		{
			if (!func_69(iParam0))
			{
				MISC::SET_BIT(&(Global_105220.f_26405.f_2), iVar0);
				if (!bParam1)
				{
...
int func_69(int iParam0)
{
	if (func_71(iParam0))
	{
		return MISC::IS_BIT_SET(Global_105220.f_26405.f_2, iParam0);
	}
	return 0;
}
...
int func_70(int iParam0)
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		return MISC::IS_BIT_SET(Global_105220.f_26405.f_2, iVar0);
	}
	return 0;
}
...
int func_100()
{
	if (MISC::IS_BIT_SET(Global_105220.f_18545[58 /*6*/], 0) && !MISC::IS_BIT_SET(Global_105220.f_18545[58 /*6*/], 3))
	{
		return 1;
	}
	return 0;
...
int func_105()
{
	if (MISC::IS_BIT_SET(Global_105220.f_18545[60 /*6*/], 0) && !MISC::IS_BIT_SET(Global_105220.f_18545[60 /*6*/], 3))
	{
		return 0;
	}
	if (MISC::IS_BIT_SET(Global_105220.f_18545[61 /*6*/], 0) && !MISC::IS_BIT_SET(Global_105220.f_18545[61 /*6*/], 3))
	{
		return 0;
	}
	if (MISC::IS_BIT_SET(Global_105220.f_18545[62 /*6*/], 3))
	{
		return 0;
	}
	if ((MISC::IS_BIT_SET(Global_105220.f_18545[58 /*6*/], 2) || MISC::IS_BIT_SET(Global_105220.f_18545[59 /*6*/], 2)) || MISC::IS_BIT_SET(Global_105220.f_18545[62 /*6*/], 2))
	{
		return 1;
	}
	return 0;
