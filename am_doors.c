...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (NETWORK_IS_IN_TUTORIAL_SESSION())
		{
			...
			{
				if (ScriptParam_0.f_16 != (50 + PLAYER_ID()))
				{
					func_35(2);
				}
			}
			else if (ScriptParam_0.f_16 != _0x3B39236746714134(PLAYER_ID()))
			{
				func_35(2);
			}
		}
		...
		switch (func_33(PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (Global_4456448 == 2)
				{
		...
		if (NETWORK_IS_HOST_OF_THIS_SCRIPT())
		{
			switch (func_26())
			{
				...
				case 2:
					if (func_33(PARTICIPANT_ID_TO_INT()) == 1)
					{
						func_1();
					}
					break;
...
void func_1()
{
	...
	while (iLocal_173 < 6)
	{
		if (func_7(INT_TO_PLAYERINDEX(iLocal_172), 0, 1))
		{
			if (IS_BIT_SET(Local_225[iLocal_172 /*4*/].f_2, iLocal_173))
			{
				SET_BIT(&(Local_175.f_2[iLocal_173]), iLocal_172);
			}
			else
			{
				CLEAR_BIT(&(Local_175.f_2[iLocal_173]), iLocal_172);
			}
		}
		else
		{
			CLEAR_BIT(&(Local_175.f_9[iLocal_173]), iLocal_172);
			CLEAR_BIT(&(Local_175.f_9[iLocal_173]), iLocal_172);
		}
...
void func_2(int iParam0, var uParam1, int iParam2)
{
	...
	{
		if (_0x4BC2854478F3A749(uParam1) == -1)
		{
			if (_0x160AA1B32F6139B8(uParam1) != iParam2)
			{
				if (NETWORK_HAS_CONTROL_OF_DOOR(uParam1))
				{
					SET_BIT(&(iLocal_205[iParam0]), iVar0);
					_SET_DOOR_ACCELERATION_LIMIT(uParam1, iParam2, 1, 1);
					func_34(&(Local_212[iParam0 /*2*/]), 1, 0);
				}
				else
				{
					NETWORK_REQUEST_CONTROL_OF_DOOR(uParam1);
				}
			}
		}
		else if (_0x4BC2854478F3A749(uParam1) != iParam2)
		{
			if (NETWORK_HAS_CONTROL_OF_DOOR(uParam1))
			{
				SET_BIT(&(iLocal_205[iParam0]), iVar0);
...
void func_9()
{
	...
	fVar0 = VDIST(vVar1, Local_69[iLocal_174 /*17*/].f_3);
	if ((IS_BIT_SET(Global_2537168, iLocal_174) || IS_BIT_SET(Global_2537168.f_1, iLocal_174)) || IS_BIT_SET(Global_2537168.f_2, iLocal_174))
	{
		if (IS_BIT_SET(Global_2537168, iLocal_174))
		{
			SET_BIT(&(Local_225[PLAYER_ID() /*4*/].f_2), iLocal_174);
		}
		if (IS_BIT_SET(Global_2537168.f_1, iLocal_174))
		{
			CLEAR_BIT(&(Local_225[PLAYER_ID() /*4*/].f_2), iLocal_174);
		}
		if (IS_BIT_SET(Global_2537168.f_2, iLocal_174))
		{
			SET_BIT(&(Local_225[PLAYER_ID() /*4*/].f_3), iLocal_174);
		}
	}
	else if (fVar0 <= 20f)
	{
		if (IS_POINT_IN_ANGLED_AREA(vVar1, Local_69[iLocal_174 /*17*/].f_3, Local_69[iLocal_174 /*17*/].f_6, Local_69[iLocal_174 /*17*/].f_9, 0, 1))
		{
			if (!IS_BIT_SET(Local_225[PLAYER_ID() /*4*/].f_2, iLocal_174))
			{
				SET_BIT(&(Local_225[PLAYER_ID() /*4*/].f_2), iLocal_174);
			}
		}
		if ((iLocal_174 == 0 || iLocal_174 == 1) || iLocal_174 == 5)
		{
			if (Global_2460032)
			{
				if (IS_POINT_IN_ANGLED_AREA(vVar1, Local_69[iLocal_174 /*17*/].f_10, Local_69[iLocal_174 /*17*/].f_13, Local_69[iLocal_174 /*17*/].f_16, 0, 1))
				{
					if (!IS_BIT_SET(Local_225[PLAYER_ID() /*4*/].f_2, iLocal_174))
					{
						SET_BIT(&(Local_225[PLAYER_ID() /*4*/].f_2), iLocal_174);
		...
		if ((iLocal_174 == 2 || iLocal_174 == 3) || iLocal_174 == 4)
		{
			if (func_11() >= 0)
			{
				...
				else if (IS_BIT_SET(Local_225[PLAYER_ID() /*4*/].f_2, iLocal_174) && !IS_POINT_IN_ANGLED_AREA(vVar1, Local_69[iLocal_174 /*17*/].f_3, Local_69[iLocal_174 /*17*/].f_6, Local_69[iLocal_174 /*17*/].f_9, 0, 1))
				{
					CLEAR_BIT(&(Local_225[PLAYER_ID() /*4*/].f_2), iLocal_174);
				}
			}
	...
	else if (IS_BIT_SET(Local_225[PLAYER_ID() /*4*/].f_2, iLocal_174))
	{
		CLEAR_BIT(&(Local_225[PLAYER_ID() /*4*/].f_2), iLocal_174);
	}
	iLocal_174++;
...
void func_14()
{
	...
	{
		func_22(iVar0, &Var3);
		if (GET_DISTANCE_BETWEEN_COORDS(func_13(PLAYER_ID()), Var3.f_1, 1) < 150f)
		{
			bVar2 = false;
			iVar1 = 0;
			while (iVar1 < 32)
			{
				iVar16 = INT_TO_PLAYERINDEX(iVar1);
				if (func_7(iVar16, 1, 1))
				{
					if (func_15(iVar16) && IS_ENTITY_IN_ANGLED_AREA(GET_PLAYER_PED(iVar16), Var3.f_4[0 /*3*/], Var3.f_4[1 /*3*/], Var3.f_11, 0, 1, 0))
					{
						bVar2 = true;
						iVar1 = 32;
					}
			...
			if (bVar2)
			{
				...
				{
					fLocal_354[iVar0] = (fLocal_354[iVar0] + (Var3.f_12 * TIMESTEP()));
					if (fLocal_354[iVar0] > 1f)
					{
						fLocal_354[iVar0] = 1f;
					}
					_0x06C0023BED16DD6B(Var3, 1);
					_SET_DOOR_AJAR_ANGLE(Var3, fLocal_354[iVar0], 0, 0);
					_SET_DOOR_ACCELERATION_LIMIT(Var3, 0, 0, 1);
				}
			}
			else if (fLocal_354[iVar0] != 0f)
			{
				...
				_0x06C0023BED16DD6B(Var3, 1);
				_SET_DOOR_AJAR_ANGLE(Var3, fLocal_354[iVar0], 0, 0);
				_SET_DOOR_ACCELERATION_LIMIT(Var3, 1, 0, 1);
			}
		}
		iVar0++;
	}
...
void func_30(struct<15> Param0, int iParam15)
{
	if (Param0 != 0)
	{
		ADD_DOOR_TO_SYSTEM(Param0, Param0.f_2, Param0.f_3, 0, iParam15, Param0.f_11);
		if (Param0.f_9)
		{
		...
		if (Param0.f_12 != 0f)
		{
			_SET_DOOR_AJAR_ANGLE(Param0, Param0.f_12, 0, iParam15);
		}
		if (!Param0.f_6)
		{
			if (Param0.f_7)
			{
				_SET_DOOR_ACCELERATION_LIMIT(Param0, Param0.f_8, iParam15, 0);
			}
		}
		if (Param0.f_10)
		{
		...
		if (Param0.f_14 != 0f)
		{
			_0x03C27E13B42A0E82(Param0, Param0.f_14, iParam15, 0);
		}
		if (Param0.f_13 != 0f)
		{
			_0x9BA001CB45CBF627(Param0, Param0.f_13, iParam15, 0);
		}
	}
}
...
{
	Local_225[PARTICIPANT_ID_TO_INT() /*4*/] = iParam0;
}
...
int func_36()
{
	...
	if (func_37() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_37()) == 0)
		{
			return 1;
		}
	}
...
int func_52(struct<21> Param0)
{
	...
	func_54(0, -1, 0);
	NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_175, 30);
	NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&Local_225, 129);
	if (!func_53())
	{
		return 0;
	}
