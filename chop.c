	...
	switch (iLocal_51)
	{
		case 11:
			if (iLocal_52 == 0)
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED("creatures@rottweiler@amb@sleep_in_kennel@"))
				{
					...
					{
						BRAIN::TASK_PLAY_ANIM(iLocal_69, "creatures@rottweiler@amb@sleep_in_kennel@", "sleep_in_kennel", 1000f, -8f, -1, 1, 0, 0, 0, 0);
			...
			else if (iLocal_52 == 1)
			{
				if (func_123())
				{
					...
					{
						BRAIN::TASK_PLAY_ANIM(iLocal_69, "creatures@rottweiler@amb@sleep_in_kennel@", "exit_kennel", 8f, -8f, -1, 0, 0, 0, 0, 0);
						func_122("WHINE");
						iLocal_52++;
					}
				}
			...
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_69, -2017877118) == 7)
				{
		...
		case 17:
			...
			if (iLocal_52 == 0)
			{
				...
				{
					BRAIN::TASK_PLAY_ANIM(iLocal_69, sLocal_80[0], "enter", 8f, -8f, -1, 0, 0, 0, 0, 0);
					iLocal_52++;
				}
			}
			else if (iLocal_52 == 1)
			{
				if ((!func_113(iLocal_69, -2017877118) || (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_69, sLocal_80[0], "enter", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_69, sLocal_80[0], "enter") > 0.98f)) || (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_69, sLocal_80[1], sLocal_81, 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_69, sLocal_80[1], sLocal_81) > 0.98f))
				{
					if (iLocal_53 == 0)
					{
						if (iLocal_79 == 1)
						{
							BRAIN::TASK_PLAY_ANIM(iLocal_69, sLocal_80[1], "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
							sLocal_81 = "base";
							iLocal_52++;
						}
						else
					...
					else
					{
						...
						BRAIN::TASK_PLAY_ANIM(iLocal_69, sLocal_80[2], "exit", 8f, -8f, -1, 0, 0, 0, 0, 0);
						iLocal_52 = 3;
					}
				}
			}
		...
		case 18:
			...
			if (iLocal_52 == 0)
			{
				...
				BRAIN::TASK_GO_TO_ENTITY(iLocal_69, PLAYER::PLAYER_PED_ID(), 20000, 3f, 1f, 1073741824, 0);
				iLocal_52++;
			}
			else if (iLocal_52 == 1)
			{
				if (iLocal_53 == 0)
				{
					if (!func_113(iLocal_69, 1227113341))
					{
						if ((STREAMING::HAS_ANIM_DICT_LOADED("creatures@rottweiler@amb@world_dog_barking@enter") && STREAMING::HAS_ANIM_DICT_LOADED("creatures@rottweiler@amb@world_dog_barking@idle_a")) && STREAMING::HAS_ANIM_DICT_LOADED("creatures@rottweiler@amb@world_dog_barking@exit"))
						{
							...
							BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@amb@world_dog_barking@enter", "enter", 8f, -8f, -1, 0, 0, 0, 0, 0);
							BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@amb@world_dog_barking@idle_a", "idle_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
							BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@amb@world_dog_barking@exit", "exit", 8f, -8f, -1, 0, 0, 0, 0, 0);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_95);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_69, iLocal_95);
		...
		case 2:
			...
			if (iLocal_52 == 0)
			{
				...
				vLocal_76 = { ENTITY::GET_ENTITY_COORDS(iLocal_69, 1) };
		...
		case 4:
			...
			{
				BRAIN::TASK_SMART_FLEE_PED(iLocal_69, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
			}
			break;
		...
		case 5:
			...
			else if (iLocal_52 == 1)
			{
				...
				else
				{
					...
					{
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_69, vLocal_323, 3f, -1, 3f, 36, 1193033728);
					}
				}
			}
			else if (iLocal_52 == 2)
		...
		case 7:
			if (iLocal_52 == 0)
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED("creatures@rottweiler@tricks@"))
				{
					...
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@tricks@", "beg_enter", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@tricks@", "beg_loop", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@tricks@", "beg_loop", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@tricks@", "beg_exit", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_95);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_69, iLocal_95);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_95);
					func_122("PLAYFUL");
		...
		case 8:
			if (iLocal_52 == 0)
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED("creatures@rottweiler@tricks@"))
				{
					...
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@tricks@", "sit_enter", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@tricks@", "sit_loop", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@tricks@", "sit_loop", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@tricks@", "sit_exit", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_95);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_69, iLocal_95);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_95);
					func_122("PLAYFUL");
		...
		case 9:
			if (iLocal_52 == 0)
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED("creatures@rottweiler@tricks@"))
				{
					...
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@tricks@", "sit_enter", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@tricks@", "paw_right_enter", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@tricks@", "paw_right_loop", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@tricks@", "paw_right_loop", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@tricks@", "paw_right_exit", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@tricks@", "sit_exit", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_95);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_69, iLocal_95);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_95);
		...
		case 10:
			...
			if (iLocal_52 == 0)
			{
				...
				BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_69, 0);
				iLocal_52++;
			}
			else if (iLocal_52 == 1)
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), -875674219) == 7)
				{
					...
					{
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_69, vVar3, 1f, 5000, 0.25f, 0, 1193033728);
					}
					iLocal_52++;
				}
			}
			else if (iLocal_52 == 2)
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_69, 713668775) == 7 || func_39(iLocal_69, vVar3, 0) < 0.3f)
				{
					...
					{
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_69, PLAYER::PLAYER_PED_ID(), 0);
						iLocal_376 = 0;
					}
					else
					{
			...
			{
				STREAMING::REQUEST_ANIM_DICT("creatures@rottweiler@tricks@");
				if (((iLocal_376 == 1 || BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_69, -875674219) == 7) && (iLocal_377 == 1 || BRAIN::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), -875674219) == 7)) && STREAMING::HAS_ANIM_DICT_LOADED("creatures@rottweiler@tricks@"))
				{
					BRAIN::TASK_PLAY_ANIM(iLocal_69, "creatures@rottweiler@tricks@", "petting_chop", 8f, -8f, -1, 8, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "creatures@rottweiler@tricks@", "petting_franklin", 8f, -8f, -1, 8, 0, 0, 0, 0);
					func_122("PLAYFUL");
					iLocal_52++;
				}
			}
		...
		case 12:
			if (iLocal_52 == 0)
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED("creatures@rottweiler@tricks@"))
				{
					...
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@tricks@", "sit_enter", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@tricks@", "sit_loop", 8f, -8f, -1, 4097, 0, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_95);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_69, iLocal_95);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_95);
					iLocal_52++;
			...
			else if (iLocal_52 == 1)
			{
				if (!func_16())
				{
					...
					{
						BRAIN::CLEAR_PED_TASKS(iLocal_69);
						BRAIN::TASK_PLAY_ANIM(iLocal_69, "creatures@rottweiler@tricks@", "sit_exit", 8f, -8f, -1, 4096, 0, 0, 0, 0);
		...
		case 13:
			if (iLocal_52 == 0)
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED("creatures@rottweiler@move") && STREAMING::HAS_PTFX_ASSET_LOADED())
				{
					BRAIN::CLEAR_PED_TASKS(iLocal_69);
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_95);
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@move", "dump_enter", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@move", "dump_loop", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@move", "dump_exit", 8f, -8f, -1, 4096, 0, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_95);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_69, iLocal_95);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_95);
					func_122("AGITATED");
		...
		case 14:
			...
			else if (iLocal_52 == 1)
			{
				...
				if (!func_113(iLocal_69, 713668775))
				{
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_69, ENTITY::GET_ENTITY_COORDS(iLocal_349, 1), 2f, 20000, 0.25f, 36, 1193033728);
				}
				if (func_39(iLocal_69, ENTITY::GET_ENTITY_COORDS(iLocal_349, 1), 1) < 2f)
				{
					if ((!MISC::IS_BIT_SET(Global_104555.f_10019.f_94, 10) && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
					{
						MISC::SET_BIT(&(Global_104555.f_10019.f_94), 10);
						if (bLocal_327 == 0)
						{
					...
					{
						vLocal_351 = { ENTITY::GET_ENTITY_COORDS(iLocal_69, 1) };
						iLocal_350 = MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
						fLocal_353 = func_14(vLocal_351, ENTITY::GET_ENTITY_COORDS(iLocal_349, 1));
						if (iLocal_350 == 0)
						{
						...
						if (iLocal_350 == 0)
						{
							BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@move", "pee_right_enter", 8f, -8f, -1, 0, 0, 0, 0, 0);
							BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@move", "pee_right_idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
							BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@move", "pee_right_exit", 8f, -8f, -1, 0, 0, 0, 0, 0);
						}
						else
						{
							BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@move", "pee_left_enter", 8f, -8f, -1, 0, 0, 0, 0, 0);
							BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@move", "pee_left_idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
							BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@move", "pee_left_exit", 8f, -8f, -1, 0, 0, 0, 0, 0);
						}
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_95);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_69, iLocal_95);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_95);
							...
							if ((MISC::GET_GAME_TIMER() - iLocal_368) > 500)
							{
								if (func_5())
								{
									...
									if (STREAMING::HAS_ANIM_DICT_LOADED("creatures@rottweiler@move"))
									{
										...
										{
											BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@move", "fetch_pickup", 8f, -8f, -1, 49152, 0, 0, 0, 0);
										}
										BRAIN::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), 20000, 4f, 3f, 1073741824, 0);
										BRAIN::CLOSE_SEQUENCE_TASK(iLocal_95);
										BRAIN::TASK_PERFORM_SEQUENCE(iLocal_69, iLocal_95);
										BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_95);
										if (iLocal_367 == joaat("weapon_ball"))
								...
								else if (!func_113(iLocal_69, 1227113341))
								{
									...
									if (iLocal_340 > 3)
									{
										BRAIN::TASK_GO_TO_ENTITY(iLocal_69, PLAYER::PLAYER_PED_ID(), 20000, 5f, 3f, 1073741824, 0);
										func_40(1);
										iLocal_52++;
									}
								}
						...
						if (iLocal_367 == joaat("weapon_ball"))
						{
							if (iLocal_365 == 1)
							{
								...
								if (STREAMING::HAS_ANIM_DICT_LOADED("creatures@rottweiler@move"))
								{
									BRAIN::OPEN_SEQUENCE_TASK(&iLocal_95);
									BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
									BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@move", "fetch_drop", 8f, -8f, -1, 16384, 0, 0, 0, 0);
									BRAIN::CLOSE_SEQUENCE_TASK(iLocal_95);
									BRAIN::TASK_PERFORM_SEQUENCE(iLocal_69, iLocal_95);
									BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_95);
									func_108("CHOP_RETURN1", 0);
		...
		case 16:
			if (iLocal_52 == 0)
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED("creatures@rottweiler@in_vehicle@std_car"))
				{
					...
					BRAIN::TASK_PLAY_ANIM(iLocal_69, "creatures@rottweiler@in_vehicle@std_car", "sit", 1000f, -1000f, -1, 9, 0, 0, 0, 0);
					iLocal_52++;
				}
			}
			else if (iLocal_52 == 1)
			{
				if (!ENTITY::IS_ENTITY_ATTACHED(PLAYER::PLAYER_PED_ID()))
				{
					...
					while (iVar6 < 4)
					{
						fVar5 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_84[iVar6 /*3*/], true);
						if (fVar5 < fVar4)
						{
							fVar4 = fVar5;
							iVar7 = iVar6;
...
int func_5()
{
	...
	{
		vVar0 = { ENTITY::GET_ENTITY_COORDS(iLocal_361, 1) };
...
void func_18()
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_56) > iLocal_58)
	{
		...
		if (((!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !MISC::IS_BIT_SET(Global_104555.f_10019.f_94, 1)) && !func_19()) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			MISC::SET_BIT(&(Global_104555.f_10019.f_94), 1);
...
void func_20()
{
	if (!func_113(iLocal_69, 242628503))
	{
		...
		if (STREAMING::HAS_ANIM_DICT_LOADED("creatures@rottweiler@indication@"))
		{
			...
			BRAIN::TASK_PLAY_ANIM(0, "creatures@rottweiler@indication@", func_21(), 8f, -4f, -1, 1, 0, 0, 0, 0);
			BRAIN::CLOSE_SEQUENCE_TASK(iLocal_95);
			BRAIN::TASK_PERFORM_SEQUENCE(iLocal_69, iLocal_95);
			BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_95);
		}
...
char* func_21()
{
	...
	if (func_125(iLocal_69))
	{
		vVar1 = { ENTITY::GET_ENTITY_COORDS(iLocal_69, 1) };
...
bool func_25(int iParam0)
{
	...
	if (iParam0 <= 31)
	{
		return MISC::IS_BIT_SET(Global_104555.f_10019.f_125, iParam0);
	}
	return MISC::IS_BIT_SET(Global_104555.f_10019.f_125.f_1, (iParam0 - 32));
}
...
bool func_26(int iParam0)
{
	...
	if (iParam0 <= 31)
	{
		return MISC::IS_BIT_SET(Global_104555.f_10019.f_122, iParam0);
	}
	return MISC::IS_BIT_SET(Global_104555.f_10019.f_122.f_1, (iParam0 - 32));
}
...
void func_32()
{
	...
	vVar0 = { ENTITY::GET_ENTITY_COORDS(iLocal_69, 1) };
	func_33(vVar0);
	func_122("WHINE");
		...
		if (STREAMING::HAS_PTFX_ASSET_LOADED())
		{
			...
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(vVar0, vLocal_76, false) < 1f)
			{
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(vVar0, vLocal_355, false) > 20f)
				{
					...
					{
						vLocal_355 = { ENTITY::GET_ENTITY_COORDS(iLocal_349, 1) };
						func_121(14, 1);
					}
				}
...
void func_44()
{
	if (((!MISC::IS_BIT_SET(Global_104555.f_10019.f_94, 7) && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()) && !func_19()) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		MISC::SET_BIT(&(Global_104555.f_10019.f_94), 7);
	...
	switch (iLocal_86)
	{
		...
		case 1:
			...
			else if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					if (((!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !MISC::IS_BIT_SET(Global_104555.f_10019.f_94, 3)) && !func_19()) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
					{
						MISC::SET_BIT(&(Global_104555.f_10019.f_94), 3);
		...
		case 8:
			...
			if (func_125(iLocal_78))
			{
				...
				else
				{
					...
					func_63();
					func_62();
					if (((!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !MISC::IS_BIT_SET(Global_104555.f_10019.f_94, 2)) && !func_19()) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
					{
						MISC::SET_BIT(&(Global_104555.f_10019.f_94), 2);
		...
		case 14:
			...
			{
				func_65();
				if (((!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !MISC::IS_BIT_SET(Global_104555.f_10019.f_94, 5)) && !func_19()) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
				{
					MISC::SET_BIT(&(Global_104555.f_10019.f_94), 5);
...
void func_62()
{
	if (func_125(iLocal_69) && func_125(iLocal_78))
	{
		if (iLocal_372 > -1)
		{
			...
			{
				BRAIN::TASK_PLAY_ANIM(iLocal_69, sLocal_371, "shunt_from_back", 8f, -8f, -1, 0, 0, 0, 0, 0);
				PED::_0x2208438012482A1A(iLocal_69, 0, 0);
				func_122("GROWL");
				iLocal_372 = -1;
				iLocal_57 = MISC::GET_GAME_TIMER();
		...
		{
			BRAIN::TASK_PLAY_ANIM(iLocal_69, sLocal_371, "sit", 8f, -8f, -1, 1, 0, 0, 0, 0);
			PED::_0x2208438012482A1A(iLocal_69, 0, 0);
			iLocal_372 = MISC::GET_GAME_TIMER();
			iLocal_57 = MISC::GET_GAME_TIMER();
		}
...
void func_64()
{
	if ((MISC::GET_GAME_TIMER() - iLocal_57) > 500)
	{
		...
		{
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_95);
			BRAIN::TASK_PLAY_ANIM(0, sLocal_371, "bark", 4f, -4f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, sLocal_371, "sit", 8f, -8f, -1, 1, 0, 0, 0, 0);
			BRAIN::CLOSE_SEQUENCE_TASK(iLocal_95);
			BRAIN::TASK_PERFORM_SEQUENCE(iLocal_69, iLocal_95);
			BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_95);
			PED::_0x2208438012482A1A(iLocal_69, 0, 0);
...
int func_66()
{
	...
	if (func_125(iLocal_78))
	{
		...
		{
			vVar1 = { ENTITY::GET_ENTITY_COORDS(iLocal_78, 1) };
			if (iLocal_68 == -1)
			{
...
void func_71()
{
	BRAIN::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "misschop_vehicleenter_exit", sLocal_370, 8f, -8f, -1, 40, 0, 0, 0, 0);
...
void func_74()
{
	...
	{
		BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_69, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 1), 2f, 0f, 0f), 2f, 20000, 0.25f, 0, 1193033728);
	}
}
...
void func_83()
{
	...
	while (iVar2 < 102)
	{
		if (func_96(iVar2))
		{
			...
			if (!func_94(vVar0))
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_69, 1), vVar0, true);
...
int func_85(int iParam0)
{
	switch (iParam0)
	{
		...
		case 16:
			if (MISC::IS_BIT_SET(Global_25391, 7))
			{
				return 0;
			}
			break;
...
void func_102()
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_IN_WATER(PLAYER::PLAYER_PED_ID()))
	{
		if (func_106(PLAYER::PLAYER_PED_ID(), iLocal_69) > 10f || func_105("CHOP_H_WHIS"))
		{
			...
			if (((!MISC::IS_BIT_SET(Global_104555.f_10019.f_94, 8) && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()) && !func_19()) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
			{
				MISC::SET_BIT(&(Global_104555.f_10019.f_94), 8);
...
void func_112()
{
	...
	if (iVar0 == 0)
	{
		BRAIN::TASK_PLAY_ANIM(iLocal_69, sLocal_80[1], "idle_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
		sLocal_81 = "idle_a";
	}
	else if (iVar0 == 1)
	{
		BRAIN::TASK_PLAY_ANIM(iLocal_69, sLocal_80[1], "idle_c", 8f, -8f, -1, 0, 0, 0, 0, 0);
		sLocal_81 = "idle_c";
	}
	else
	{
		BRAIN::TASK_PLAY_ANIM(iLocal_69, sLocal_80[1], "idle_b", 8f, -8f, -1, 0, 0, 0, 0, 0);
		sLocal_81 = "idle_b";
	}
}
...
void func_129()
{
	...
	if (((((((((((func_144() && func_143()) && !func_142()) && iLocal_53 == 0) && iLocal_51 != 6) && func_19()) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) && !PED::IS_PED_IN_COMBAT(iLocal_69, 0)) && !func_81()) && !func_16()) && !func_3(0)) && !func_141())
	{
		...
		{
			HUD::CLEAR_HELP(1);
			if (!MISC::IS_BIT_SET(Global_104555.f_10019.f_94, 0))
			{
				MISC::SET_BIT(&(Global_104555.f_10019.f_94), 0);
			}
			if (bLocal_327 == 0)
			{
				bLocal_327 = func_131();
...
void func_145()
{
	if ((((((((!MISC::IS_BIT_SET(Global_104555.f_10019.f_94, 0) && !(func_105("CHOP_H_INTRO") || (MISC::IS_PC_VERSION() && func_105("CHOP_H_INTRO_KM")))) && !func_105("PW_HELP_1")) && !func_105("PW_HELP_2")) && !func_146()) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) && !func_3(0)) && !func_142()) && !func_141())
	{
...
void func_147(int iParam0)
{
	if (iParam0 == 1)
	{
		if (func_125(iLocal_69))
		{
			BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_69, -1, 48, 2);
			iLocal_73 = 1;
		}
	}
		...
		if (((iLocal_51 == 2 || iLocal_51 == 5) || iLocal_51 == 15) || (iLocal_51 == 14 && !func_113(iLocal_69, 242628503)))
		{
			if (PED::_0x336B3D200AB007CB(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 100f) > 0 || PED::_0x336B3D200AB007CB(iLocal_69, ENTITY::GET_ENTITY_COORDS(iLocal_69, 1), 100f) > 0)
			{
				...
				if (func_125(iVar2))
				{
					...
					if (((!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !MISC::IS_BIT_SET(Global_104555.f_10019.f_94, 6)) && !func_19()) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
					{
						MISC::SET_BIT(&(Global_104555.f_10019.f_94), 6);
					...
					if (PLAYER::GET_PLAYER_TARGET_ENTITY(PLAYER::PLAYER_ID(), &iVar4) || PLAYER::GET_ENTITY_PLAYER_IS_FREE_AIMING_AT(PLAYER::PLAYER_ID(), &iVar4))
					{
						if (ENTITY::IS_ENTITY_A_PED(iVar4))
						{
							...
							if (((!PED::IS_PED_INJURED(iVar5) && iVar5 != iLocal_69) && !PED::IS_PED_IN_ANY_VEHICLE(iVar5, 0)) && func_4(PLAYER::PLAYER_PED_ID(), iVar5, 1) < 50f)
							{
								...
								if (((!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !MISC::IS_BIT_SET(Global_104555.f_10019.f_94, 11)) && !func_19()) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
								{
									MISC::SET_BIT(&(Global_104555.f_10019.f_94), 11);
...
void func_150()
{
	if ((iLocal_51 != 16 && Global_25238 == 1) && ENTITY::IS_ENTITY_ATTACHED_TO_ANY_OBJECT(PLAYER::PLAYER_PED_ID()))
	{
		func_121(16, 1);
	}
}
...
int func_157(int iParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	...
	if (STREAMING::HAS_MODEL_LOADED(iVar0))
	{
		...
		*iParam0 = PED::CREATE_PED(26, iVar0, vParam1, fParam2, 0, false);
		...
		if (Global_104555.f_20088.f_263)
		{
			PED::SET_PED_COMPONENT_VARIATION(*iParam0, 3, 0, Global_104555.f_20088.f_254.f_4, 0);
		}
		else
		{
...
int func_158()
{
	...
	if (func_125(Global_92619) && PED::IS_PED_MODEL(Global_92619, func_162()))
	{
...
int func_163()
{
	...
	if (iLocal_50 > 0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_69))
		{
			...
			if (((((((((((Global_70854 == 1 && Global_25238 == 0) && Global_2327 == 0) && Global_25485 == 0) && Global_25486 == 0) && Global_25487 == 0) && Global_53084 == 0) && !func_146()) && !func_16()) && Global_94367 == 0) && func_125(PLAYER::PLAYER_PED_ID())) && !func_165())
			{
				return 1;
			}
			if (Global_89898 == 1)
			...
			if (ENTITY::IS_ENTITY_DEAD(iLocal_69, 0))
			{
				...
				{
					Global_25378 = 1;
					if (!MISC::IS_BIT_SET(Global_104555.f_10019.f_94, 9) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
					{
						MISC::SET_BIT(&(Global_104555.f_10019.f_94), 9);
						func_15("CHOP_H_DEAD", -1);
					}
				}
				else if (!MISC::IS_BIT_SET(Global_104555.f_10019.f_94, 12) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
				{
					MISC::SET_BIT(&(Global_104555.f_10019.f_94), 12);
			...
			else
			{
				...
				else
				{
					...
					{
						if ((!MISC::IS_BIT_SET(Global_104555.f_10019.f_94, 4) && PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
						{
							...
							{
								MISC::SET_BIT(&(Global_104555.f_10019.f_94), 4);
...
void func_171()
{
	...
	{
		if (func_175(Global_104555.f_2353.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
	...
	else
	{
		...
		if (func_178(63))
		{
			if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				...
				else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), -11.15f, -1425.56f, 29.67f, true) > 50f)
				{
					func_61(138, 1, 0);
				}
			}
...
int func_187()
{
	...
	if (func_125(iLocal_69))
	{
		...
		if (func_188(ENTITY::GET_ENTITY_COORDS(iLocal_69, 0), 1f, 1120403456))
		{
			return 0;
		}
	}
