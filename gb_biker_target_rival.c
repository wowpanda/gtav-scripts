...
void func_3(int iParam0)
{
	...
	uVar0 = iParam0;
	CLEAR_BIT(&(Global_2416063.f_385), uVar0);
	CLEAR_BIT(&(Global_2416063.f_386), uVar0);
	CLEAR_BIT(&(Global_2416063.f_387), uVar0);
	CLEAR_BIT(&(Global_2416063.f_389), uVar0);
	CLEAR_BIT(&(Global_2416063.f_393), uVar0);
	CLEAR_BIT(&(Global_2416063.f_388), uVar0);
}
...
int func_12(int iParam0)
{
	if (func_5(iParam0, 0, 1))
	{
		...
		if (func_74(iParam0))
		{
			func_71(iParam0, func_72(func_73(PLAYER_ID())), 1, 0);
		}
		if (func_69(iParam0))
		{
...
int func_23(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((func_52(PLAYER_ID()) || (func_51() && func_50())) && !IS_BIT_SET(Global_2528542.f_4582, 31)) && !bParam4)
	{
		uVar1 = func_49();
				...
				if (NETWORK_GET_PLAYER_INDEX_FROM_PED(uVar1) != -1)
				{
					if (func_5(NETWORK_GET_PLAYER_INDEX_FROM_PED(uVar1), 0, 1))
					{
						if ((iParam1 > -1 && NETWORK_IS_ACTIVITY_SESSION()) && iParam1 < 4)
						{
							...
							{
								return func_35(iParam0, NETWORK_GET_PLAYER_INDEX_FROM_PED(uVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
...
int func_25(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if (bParam1)
	{
		if (iParam2 > -1)
		{
			if (func_29(iVar0, iParam2, 0) && !IS_BIT_SET(Global_4456448.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_22(1);
...
int func_35(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar1)
	{
		if (iVar0 != -1)
		{
			...
			if ((func_57(iParam1, iParam0, iVar0, 0) && !IS_BIT_SET(Global_4456448.f_15, 18)) || ((func_29(GET_PLAYER_TEAM(iParam1), GET_PLAYER_TEAM(iParam0), 0) && IS_BIT_SET(Global_4456448.f_15, 23)) && !IS_BIT_SET(Global_4456448.f_15, 18)))
			{
				return func_22(1);
			}
...
int func_47(int iParam0, int iParam1, bool bParam2)
{
	...
	if (iParam0 > -1 && iParam1 != func_6())
	{
		...
		if (IS_BIT_SET(Global_4456448.f_15, 26) && !func_29(iParam0, GET_PLAYER_TEAM(iParam1), 0))
		{
			iVar0 = func_36(1);
		}
	}
...
int func_63(int iParam0)
{
	...
	if (GET_HASH_KEY(GET_THIS_SCRIPT_NAME()) == func_64())
	{
		return 1;
	}
	return 0;
...
int func_78()
{
	...
	if (func_64() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_64()) == 0)
		{
			return 1;
		}
	}
