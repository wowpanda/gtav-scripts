				...
				else if (func_46(&iLocal_1102) > 2.5f)
				{
					if (!iLocal_995)
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
						{
							...
							{
								BRAIN::CLEAR_PED_TASKS(iLocal_943);
								if (iLocal_937 == 1)
								{
									if (ENTITY::DOES_ENTITY_EXIST(iLocal_1067))
									{
										...
										{
											BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_943, iLocal_1067, iLocal_1067, 2f, 0, 1056964608, 1082130432, 1, 0, -957453492);
										}
									}
								...
								else if (iLocal_937 == 8)
								{
									...
									{
										BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_943, iLocal_1065, iLocal_1065, 2f, 0, 1056964608, 1082130432, 1, 0, -957453492);
									}
								...
								{
									BRAIN::TASK_AIM_GUN_AT_ENTITY(iLocal_943, PLAYER::PLAYER_PED_ID(), -1, 0);
									func_2(iLocal_943);
								}
							}
						}
...
void func_14()
{
	...
	{
		if (func_17(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_34(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_36(Global_105220.f_18504[iVar0], &vVar2, &fVar3))
			{
...
int func_65(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_73() || func_72(Global_4456448.f_148478)) || func_71())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("riot2") && iVar1 == 0) && func_69(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_66(int iParam0)
{
	if (iParam0 != func_68())
	{
		...
		else if ((Global_1312854 && iParam0 == PLAYER::PLAYER_ID()) && func_67(iParam0, 1, 0))
		{
			return Global_2423644[iParam0 /*406*/].f_305.f_1 != -1;
		}
	}
...
void func_105(int iParam0)
{
	...
	switch (iLocal_934[iParam0])
	{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_942[iParam0], 0))
				{
					if (PED::IS_PED_IN_VEHICLE(iLocal_942[iParam0], iLocal_1066, 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
					{
						if (!iLocal_959)
						{
							if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1066, -1, 0) == iLocal_942[iParam0])
							{
								if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_942[iParam0], -1273030092) != 1)
								{
									BRAIN::TASK_VEHICLE_ESCORT(iLocal_942[iParam0], iLocal_1066, iLocal_1065, -1, 45f, 786981, 10f, -1, 10f);
								}
							}
						}
						else if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1066, -1, 0) == iLocal_942[iParam0])
						{
							if (!iLocal_973)
							{
								if (ENTITY::IS_ENTITY_DEAD(iLocal_939, 0))
								{
									if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
									{
										BRAIN::TASK_COMBAT_PED(iVar0, PLAYER::PLAYER_PED_ID(), 0, 16);
									}
									else
									{
								...
								{
									BRAIN::TASK_VEHICLE_ESCORT(iLocal_942[iParam0], iLocal_1066, iLocal_1065, -1, 45f, 786981, 10f, -1, 10f);
									BRAIN::ADD_VEHICLE_SUBTASK_ATTACK_PED(iVar0, PLAYER::PLAYER_PED_ID());
									iLocal_973 = 1;
								}
							}
						}
		...
		case 6:
			if (bLocal_984)
			{
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_1072);
				...
				BRAIN::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), MISC::GET_RANDOM_INT_IN_RANGE(10000, 11000), 30f, 1f, 1073741824, 0);
				BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(0, PLAYER::PLAYER_PED_ID(), func_123(), 1f, 0, 1056964608, 1082130432, 1, 0, -957453492);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_1072);
				if (!PED::IS_PED_INJURED(iLocal_942[iParam0]))
				{
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_942[iParam0], iLocal_1072);
				}
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_1072);
			}
			else
			{
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_1072);
				...
				BRAIN::TASK_AIM_GUN_AT_COORD(0, func_123(), MISC::GET_RANDOM_INT_IN_RANGE(3000, 3500), 0, 0);
				BRAIN::TASK_AIM_GUN_AT_COORD(0, func_123(), MISC::GET_RANDOM_INT_IN_RANGE(3000, 3500), 0, 0);
				BRAIN::TASK_AIM_GUN_AT_COORD(0, func_123(), -1, 0, 0);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_1072);
				if (!PED::IS_PED_INJURED(iLocal_942[iParam0]))
				{
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_942[iParam0], iLocal_1072);
		...
		case 7:
			if (!PED::IS_PED_INJURED(iLocal_942[iParam0]))
			{
				...
				{
					BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_942[iParam0], iLocal_938, iLocal_938, 1f, 0, -1f, 1082130432, 1, 0, -957453492);
				}
			}
			break;
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (func_24(iParam1, iParam0, 0) > fParam2 && func_23(iParam1, 1) < fParam3)
				{
					...
					{
						if (BRAIN::GET_SCRIPT_TASK_STATUS(iParam1, -1794415470) != 1)
						{
							BRAIN::TASK_ENTER_VEHICLE(iParam1, iParam0, 20000, -1, 2f, 1, 0);
						}
					}
					else if (BRAIN::GET_SCRIPT_TASK_STATUS(iParam1, -1273030092) != 1)
					{
						BRAIN::TASK_VEHICLE_MISSION(iParam1, iParam0, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 6, 35f, 786469, -1f, -1f, 1);
						BRAIN::ADD_VEHICLE_SUBTASK_ATTACK_PED(iParam1, PLAYER::PLAYER_PED_ID());
					}
				}
				else if (!PED::IS_PED_IN_VEHICLE(iParam1, iParam0, 0))
				{
					...
					{
						BRAIN::TASK_COMBAT_PED(iParam1, PLAYER::PLAYER_PED_ID(), 0, 16);
					}
				}
			}
			else if (PED::IS_PED_IN_VEHICLE(iParam1, iParam0, 0))
			{
				...
				{
					if (BRAIN::GET_SCRIPT_TASK_STATUS(iParam1, -1273030092) != 1)
					{
						BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(iParam1, iParam0, PLAYER::PLAYER_PED_ID(), 6, 35f, 786469, -1f, -1f, 1);
						BRAIN::ADD_VEHICLE_SUBTASK_ATTACK_PED(iParam1, PLAYER::PLAYER_PED_ID());
					}
				}
...
void func_121(int iParam0)
{
	...
	if (!PED::IS_PED_INJURED(iLocal_938) && !PED::IS_PED_INJURED(iParam0))
	{
		...
		BRAIN::TASK_AIM_GUN_AT_ENTITY(0, iLocal_938, -1, 0);
...
void func_122(int iParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_938, 0))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_938, 0))
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
			{
				BRAIN::TASK_PERFORM_SEQUENCE(iParam0, iLocal_1072);
			}
			BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_1072);
		}
		...
		if (!PED::IS_PED_INJURED(iParam0))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_938, iParam0, vParam1, 0, 1, 0))
			{
				if (PED::IS_PED_FACING_PED(iParam0, iLocal_938, 160f))
				{
					if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, iLocal_938, 17))
					{
						BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iParam0, iLocal_938, iLocal_938, 1f, 0, -1f, 1082130432, 1, 0, -957453492);
						iLocal_937 = 5;
						iLocal_959 = 1;
					}
				}
			...
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iParam0, -1207174364) != 1)
				{
					BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iParam0, iLocal_938, iLocal_938, 1f, 0, -1f, 1082130432, 1, 0, -957453492);
				}
			}
		...
		if (!PED::IS_PED_IN_ANY_VEHICLE(*iParam0, 0))
		{
			if (!iLocal_961)
			{
				if (*iParam0 == iLocal_943)
				{
					...
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_938, -1);
					BRAIN::CLOSE_SEQUENCE_TASK(iVar0);
					BRAIN::TASK_PERFORM_SEQUENCE(*iParam0, iVar0);
					BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
					iLocal_961 = 1;
				...
				{
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(*iParam0, iLocal_938, -1);
				}
			}
...
void func_128(int iParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_942[iParam0], 0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1066, 0))
		{
			...
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_942[iParam0], -1794415470) != 1)
				{
	...
	switch (iLocal_933[iParam0])
	{
		case 0:
			if (!PED::IS_PED_INJURED(iVar0))
			{
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_1072);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_1072);
				BRAIN::TASK_GO_TO_COORD_ANY_MEANS(0, vLocal_1054[iParam0 /*3*/], 1f, 0, 0, 786603, -1082130432);
				BRAIN::TASK_ACHIEVE_HEADING(0, fLocal_1041[iParam0], 0);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_1072);
				BRAIN::TASK_PERFORM_SEQUENCE(iVar0, iLocal_1072);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_1072);
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0))
				{
					if (!bLocal_994)
					{
						if (BRAIN::GET_SCRIPT_TASK_STATUS(iVar0, -2017877118) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iVar0, 242628503) != 1)
						{
		...
		case 4:
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
			{
				if (!PED::IS_PED_INJURED(iVar0))
				{
					if (iParam0 == 0)
					{
						BRAIN::TASK_LOOK_AT_ENTITY(iLocal_941[0], iLocal_941[1], -1, 0, 2);
						if (!PED::IS_PED_IN_VEHICLE(iVar0, iLocal_1065, 0))
						{
							BRAIN::TASK_ENTER_VEHICLE(iVar0, iLocal_1065, 30000, -1, 1f, 1, 0);
						}
					}
					else if (iParam0 == 1)
					{
						BRAIN::TASK_LOOK_AT_ENTITY(iLocal_941[1], iLocal_941[0], -1, 0, 2);
						if (!PED::IS_PED_IN_VEHICLE(iVar0, iLocal_1065, 0))
						{
		...
		case 5:
			...
			if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0))
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iVar0, 150319005) != 1)
				{
					if (iParam0 == 0)
					{
						BRAIN::TASK_LOOK_AT_ENTITY(iLocal_941[iParam0], iLocal_941[1], -1, 2048, 4);
					}
					else if (iParam0 == 1)
					{
						BRAIN::TASK_LOOK_AT_ENTITY(iLocal_941[iParam0], iLocal_941[0], -1, 2048, 4);
					}
				}
			}
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1065, 0))
				{
					if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1065, -1, 0) == iVar0)
					{
						if (!PED::IS_PED_INJURED(iVar0))
						{
							...
							if (func_133())
							{
								BRAIN::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iVar0, iLocal_1065, "OJASva_101a", 181, 0, 16, -1, 10f, 0, 1073741824);
							}
							else
							{
								BRAIN::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iVar0, iLocal_1065, "OJASva_101", 181, 0, 0, -1, -1f, 0, 1073741824);
							}
						}
					}
					...
					if (!PED::IS_PED_INJURED(iVar0))
					{
						if (bLocal_974 || (iLocal_988 && !BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1065)))
						{
							...
							if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
								{
									if (BRAIN::GET_SCRIPT_TASK_STATUS(iVar0, -1273030092) != 1)
									{
										BRAIN::TASK_VEHICLE_MISSION(iVar0, iLocal_1065, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 8, 35f, 786469, -1f, -1f, 1);
									}
								}
								else if (BRAIN::GET_SCRIPT_TASK_STATUS(iVar0, -1273030092) != 1)
								{
									BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(iVar0, iLocal_1065, PLAYER::PLAYER_PED_ID(), 8, 35f, 786469, -1f, -1f, 1);
								}
							}
						}
					}
		...
		case 8:
			if (bLocal_984)
			{
				...
				BRAIN::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
				BRAIN::TASK_LOOK_AT_COORD(0, func_123(), MISC::GET_RANDOM_INT_IN_RANGE(1000, 1500), 2048, 4);
				BRAIN::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), MISC::GET_RANDOM_INT_IN_RANGE(15000, 16000), 30f, 1f, 1073741824, 0);
				BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(0, PLAYER::PLAYER_PED_ID(), func_123(), 1f, 0, 1056964608, 1082130432, 1, 0, -957453492);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_1072);
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_941[iParam0], 0))
				{
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_941[iParam0], iLocal_1072);
				}
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_1072);
			}
			else
		...
		case 9:
			if (!PED::IS_PED_INJURED(iLocal_941[iParam0]))
			{
				...
				{
					BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_941[iParam0], iLocal_938, iLocal_938, 1f, 0, -1f, 1082130432, 1, 0, -957453492);
				}
			}
			break;
	...
	switch (iLocal_1028)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
			{
				...
				{
					BRAIN::TASK_AIM_GUN_AT_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), -1, 0);
				}
				func_28(iParam0, 3, "OJAvaGUARD");
...
void func_138(int iParam0)
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		{
			if (BRAIN::GET_SCRIPT_TASK_STATUS(iParam0, -1207174364) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iParam0, 1630799643) != 1)
			{
				BRAIN::TASK_AIM_GUN_AT_ENTITY(iParam0, iLocal_938, -1, 0);
			}
		}
		else if (BRAIN::GET_SCRIPT_TASK_STATUS(iParam0, -1207174364) != 1)
		{
			if (iParam0 == iLocal_943)
			{
				BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iParam0, iLocal_938, iLocal_938, 1f, 0, -1f, 1082130432, 1, 0, -957453492);
...
void func_140(int iParam0, var uParam1)
{
	...
	if (iVar0 == 0)
	{
		BRAIN::TASK_PLAY_ANIM(iParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_earpiece_a", 8f, -8f, -1, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 1, 0, 0);
	}
	else if (iVar0 == 1)
	{
		BRAIN::TASK_PLAY_ANIM(iParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_earpiece_b", 8f, -8f, -1, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 1, 0, 0);
	}
	else if (iVar0 == 2)
	{
		BRAIN::TASK_PLAY_ANIM(iParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_fold_arms", 8f, -8f, -1, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 1, 0, 0);
	}
	else if (iVar0 == 3)
	{
		BRAIN::TASK_PLAY_ANIM(iParam0, "ODDJOBS@ASSASSINATE@GUARD", "unarmed_look", 8f, -8f, -1, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 1, 0, 0);
	}
	*uParam1 = iVar0;
}
	...
	switch (iLocal_936[iParam0])
	{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_939, 0))
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_939, 0))
				{
					if (!PED::IS_PED_INJURED(iLocal_940[iParam0]))
					{
						if (iParam0 == 0)
						{
							BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(iLocal_940[iParam0], iLocal_939, 1.5f, 0f, 0f, 1f, -1, 1036831949, 1);
						}
						else if (iParam0 == 1)
						{
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1066, 0))
							{
								...
								BRAIN::TASK_GO_TO_COORD_ANY_MEANS(0, -1222.992f, -191.0932f, 38.17538f, 1f, 0, 0, 786603, -1082130432);
								...
								BRAIN::TASK_PERFORM_SEQUENCE(iLocal_940[iParam0], iVar2);
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_940[iParam0], 0))
					{
						if (!PED::IS_PED_IN_VEHICLE(iLocal_940[iParam0], iVar0, 0))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_939, 0))
							{
								if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_940[iParam0], -1794415470) != 1)
								{
						...
						if (iLocal_959)
						{
							if (!bLocal_989)
							{
								if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_940[iParam0], 780511057) != 1)
								{
									...
									BRAIN::TASK_COMBAT_PED(iLocal_940[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
								}
							}
		...
		case 3:
			...
			if (bLocal_984)
			{
				...
				BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(0, PLAYER::PLAYER_PED_ID(), func_123(), 1f, 0, 1056964608, 1082130432, 1, 0, -957453492);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_1072);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_940[iParam0], iLocal_1072);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_1072);
			}
			else if (!PED::IS_PED_INJURED(iLocal_940[iParam0]))
			{
				...
				if (!iLocal_956 && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_940[iParam0], 0))
				{
					...
					else
					{
						...
						BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, iLocal_939, 1.5f, 0f, 0f, 2f, -1, 1036831949, 1);
					}
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_1072);
					iLocal_956 = 1;
				}
				else
				{
					...
					{
						BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, vVar4, func_123(), 2f, false, 0.5f, 4f, true, 0, 0, -957453492);
						BRAIN::TASK_PUT_PED_DIRECTLY_INTO_COVER(0, vVar4, -1, false, 0.25f, false, 0, 0, 1);
					}
					else
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_939, 0))
						{
							BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, iLocal_939, 0f, -1.5f, 0f, 2f, -1, 1036831949, 1);
						}
					}
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_1072);
				}
		...
		case 5:
			...
			if (!PED::IS_PED_INJURED(iLocal_939))
			{
				if (!PED::IS_PED_INJURED(iLocal_940[iParam0]))
				{
					...
					{
						BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_940[iParam0], iLocal_939, PLAYER::PLAYER_PED_ID(), 3f, 1, 0.005f, 1082130432, 1, 0, -957453492);
					}
				}
	...
	switch (iLocal_935)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_939, 0))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1065, 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_941[0], 0))
				{
					if (!PED::IS_PED_IN_VEHICLE(iLocal_939, iLocal_1065, 0))
					{
						if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_939, -1794415470) != 1)
						{
		...
		case 4:
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_939, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(iLocal_939, iLocal_1065, 0))
				{
					if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_939, -828834893) != 1)
					{
				...
				else if (!bLocal_989)
				{
					...
					BRAIN::TASK_SMART_FLEE_PED(0, iLocal_938, 200f, -1, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iVar0);
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_939, 0))
					{
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_939, iVar0);
					}
					BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
					bLocal_989 = true;
				}
				...
				{
					BRAIN::TASK_SMART_FLEE_PED(iLocal_939, iLocal_938, 200f, -1, 0, 0);
				}
				if (!iLocal_1004)
				{
	...
	switch (iLocal_931)
	{
		...
		case 6:
			...
			if (bLocal_967)
			{
				...
				{
					func_51(&iLocal_1084, Global_105220.f_19934.f_5);
				}
				iLocal_1029 = func_508();
				if (Global_87277)
				{
	...
	switch (iLocal_1035)
	{
		case 0:
			if (!iLocal_331)
			{
				...
				Global_105220.f_19934.f_5 = func_46(&iLocal_1084);
				fLocal_326 = Global_105220.f_19934.f_5;
				func_233();
				iLocal_331 = 1;
				iLocal_1035 = 1;
			}
		...
		case 1:
			...
			if (func_229(&uLocal_342, 1, 0) && AUDIO::_0x6F259F82D873B8B8())
			{
				func_228(&uLocal_1289, 0, 0, 0, 1);
				func_227(&uLocal_1289, "ASS_VA_CONT", 2, 215, 1, 1, 0);
				func_227(&uLocal_1289, "ES_XPAND", 2, 216, 1, 1, 0);
				SYSTEM::SETTIMERA(0);
				iLocal_1035 = 2;
			}
			break;
...
void func_156(struct<25> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14)
{
	...
	func_157(func_13(), 96, SYSTEM::ROUND(fVar0), 0, 0);
}
...
void func_161(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_105220.f_20535.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_163() /*12171*/].f_7688.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_105220.f_20535.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_163() /*12171*/].f_7688.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_167(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_163() /*12171*/].f_7688.f_10, iParam0);
}
...
void func_233()
{
	...
	if (!iLocal_331)
	{
		func_239(&uLocal_342, &Local_919, &Global_55982, 0);
		fLocal_326 = (fLocal_326 * 1000f);
		if (Global_87277)
		{
			func_238(&uLocal_342, 6, &(Local_919.f_12), "MTPHPERSKI", SYSTEM::FLOOR(fLocal_326), 0, 3, 0);
			func_238(&uLocal_342, 6, &(Local_919.f_24), "MTPHPERSKI", 0, 0, 3, 0);
			func_238(&uLocal_342, 6, &(Local_919.f_30), "MTPHPERSKI", SYSTEM::ROUND((fLocal_328 + fLocal_327)), 0, 3, 0);
			func_237();
		}
		else
		{
			if (bLocal_330)
			{
				func_238(&uLocal_342, 6, &(Local_919.f_12), "MTPHPERRET", SYSTEM::FLOOR(fLocal_326), 0, 3, 0);
			}
			else
			{
				func_238(&uLocal_342, 9, &(Local_919.f_12), "", SYSTEM::FLOOR(fLocal_326), 0, 0, 0);
			}
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_919.f_18)))
			{
				if (bLocal_329)
				{
					func_238(&uLocal_342, 6, &(Local_919.f_24), "", 0, 0, 2, 0);
					func_238(&uLocal_342, 3, &(Local_919.f_30), "", SYSTEM::ROUND((fLocal_328 + fLocal_327)), 0, 2, 0);
				}
				else
				{
					func_238(&uLocal_342, 6, &(Local_919.f_24), "", 0, 0, 1, 0);
					func_238(&uLocal_342, 3, &(Local_919.f_30), "", SYSTEM::ROUND(fLocal_327), 0, 0, 0);
				}
			}
			else
			{
		...
		if (iVar0 == 1)
		{
			iLocal_337 = 50;
			iLocal_338 = 1;
			func_236(&uLocal_342, 1, &(Local_919.f_48), iLocal_337, 0, 0, 1, 0);
		}
		else if (bLocal_329)
		{
			if (bLocal_330)
			{
				iLocal_337 = 75;
				iLocal_338 = 2;
				func_236(&uLocal_342, 1, &(Local_919.f_42), iLocal_337, 0, 0, 2, 0);
			}
			else
			{
				iLocal_337 = 100;
				iLocal_338 = 3;
				func_236(&uLocal_342, 1, &(Local_919.f_36), iLocal_337, 0, 0, 3, 0);
			}
		}
...
void func_234()
{
	...
	{
		func_235(38, SYSTEM::FLOOR(fLocal_326), 1);
		if (bLocal_329)
		{
			func_235(39, 1, 1);
		}
		...
		if (bLocal_329)
		{
			func_235(40, SYSTEM::ROUND((fLocal_328 + fLocal_327)), 1);
		}
		else
		{
			func_235(40, SYSTEM::ROUND(fLocal_327), 1);
		}
		func_235(41, iLocal_337, 1);
		func_235(42, iLocal_338, 1);
	}
	else if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("assassin_multi")) == 1)
	{
		func_235(52, SYSTEM::FLOOR(fLocal_326), 1);
		if (bLocal_329)
		{
			func_235(53, 1, 1);
		}
		...
		if (bLocal_329)
		{
			func_235(56, SYSTEM::ROUND((fLocal_328 + fLocal_327)), 1);
		}
		else
		{
			func_235(56, SYSTEM::ROUND(fLocal_327), 1);
		}
		func_235(54, iLocal_337, 1);
		func_235(55, iLocal_338, 1);
	}
	else if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("assassin_hooker")) == 1)
	{
		func_235(66, SYSTEM::FLOOR(fLocal_326), 1);
		if (bLocal_329)
		{
			func_235(67, 1, 1);
		}
		...
		if (bLocal_329)
		{
			func_235(68, SYSTEM::ROUND((fLocal_328 + fLocal_327)), 1);
		}
		else
		{
			func_235(68, SYSTEM::ROUND(fLocal_327), 1);
		}
		func_235(69, iLocal_337, 1);
		func_235(70, iLocal_338, 1);
	}
	else if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("assassin_bus")) == 1)
	{
		func_235(81, SYSTEM::FLOOR(fLocal_326), 1);
		if (bLocal_329)
		{
			func_235(82, 1, 1);
		}
		...
		if (bLocal_329)
		{
			func_235(83, SYSTEM::ROUND((fLocal_328 + fLocal_327)), 1);
		}
		else
		{
			func_235(83, SYSTEM::ROUND(fLocal_327), 1);
		}
		func_235(84, iLocal_337, 1);
		func_235(85, iLocal_338, 1);
	}
	else if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("assassin_construction")) == 1)
	{
		func_235(97, SYSTEM::FLOOR(fLocal_326), 1);
		if (bLocal_329)
		{
			func_235(98, 1, 1);
		}
		...
		if (bLocal_329)
		{
			func_235(99, SYSTEM::ROUND((fLocal_328 + fLocal_327)), 1);
		}
		else
		{
			func_235(99, SYSTEM::ROUND(fLocal_327), 1);
		}
		func_235(100, iLocal_337, 1);
		func_235(101, iLocal_338, 1);
	}
}
...
void func_242()
{
	...
	func_246(&iLocal_1009, &uLocal_1112, "OJASAUD", "OJAS_HOCOM", 9, 1, 0, 0);
	switch (iLocal_1018)
	{
		case 0:
			iLocal_1018++;
...
void func_244()
{
	...
	while (iVar0 < 2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_940[iVar0]))
		{
			if (!PED::IS_PED_INJURED(iLocal_940[iVar0]))
			{
				func_245(&(Local_948[iVar0 /*8*/]));
				BRAIN::CLEAR_PED_TASKS(iLocal_940[iVar0]);
	...
	while (iVar0 < 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_941[iVar0]))
		{
			if (!PED::IS_PED_INJURED(iLocal_941[iVar0]))
			{
				func_245(&(Local_946[iVar0 /*8*/]));
				BRAIN::CLEAR_PED_TASKS(iLocal_941[iVar0]);
	...
	while (iVar0 < 2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_942[iVar0]))
		{
			if (!PED::IS_PED_INJURED(iLocal_942[iVar0]))
			{
				func_245(&(Local_947[iVar0 /*8*/]));
				BRAIN::CLEAR_PED_TASKS(iLocal_942[iVar0]);
...
float func_256(int iParam0, vector3 vParam1, bool bParam2)
{
	vector3 vVar0;
...
void func_261()
{
	func_263(&(Local_1427.f_4));
	func_262(&(Local_1427[0]));
	func_262(&(Local_1427[1]));
	func_262(&(Local_1427.f_8[0]));
	func_262(&(Local_1427.f_8[1]));
	func_262(&(Local_1427.f_5[0]));
	func_262(&(Local_1427.f_5[1]));
	func_262(&(Local_1427.f_3));
}
...
void func_266()
{
	...
	func_265(iLocal_939, 1);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_1073);
	if (!HUD::DOES_BLIP_EXIST(iLocal_950))
	{
		iLocal_950 = func_267(iLocal_939, 0, 0);
	}
...
void func_268()
{
	...
	while (iVar0 < 3)
	{
		if (!CAM::IS_SPHERE_VISIBLE(vLocal_1052[iVar0 /*3*/], 5f) && !func_272(iVar0, 6f))
		{
	...
	if (iLocal_1020 == 0)
	{
		...
		else
		{
			...
			while (iVar0 < 3)
			{
				if (func_270(vLocal_1052[iVar0 /*3*/], 1) > 30f && !func_272(iVar0, 6f))
				{
					vLocal_1053[iLocal_1020 /*3*/] = { vLocal_1052[iVar0 /*3*/] };
					uLocal_1046[iLocal_1020] = fLocal_1045[iVar0];
					iLocal_1020++;
...
void func_273()
{
	switch (iLocal_1018)
	{
		...
		case 1:
			if (((bLocal_966 && !bLocal_964) && func_275()) && func_274())
			{
				func_252();
				iLocal_931 = 11;
			}
...
void func_277()
{
	switch (iLocal_1018)
	{
		...
		case 1:
			if (iLocal_993)
			{
				if (((!func_280(&iLocal_1067) && !func_279(&(iLocal_1071[0]), &bLocal_1014)) && !func_279(&(iLocal_1071[1]), &bLocal_1014)) && !func_279(&(iLocal_1071[2]), &bLocal_1014))
				{
					SYSTEM::SETTIMERA(0);
					func_252();
					iLocal_931 = 10;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90431[iVar0]))
		{
			if (Global_90431[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || ENTITY::GET_ENTITY_MODEL(iParam0) == func_292(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_299(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_366(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_359(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
				Global_105220.f_18545[iVar4 /*6*/].f_4 = 0;
				MemCopy(&uVar5, {func_358(iVar4)}, 4);
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar5, 0, Global_92992, iParam0);
			}
			else
			{
				iVar6 = func_357(&(Global_92955.f_3));
				if (iVar6 > -1)
				{
...
{
	func_301(&Global_98783, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_301(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_13();
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		func_321(PLAYER::PLAYER_PED_ID());
		func_314(PLAYER::PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_313())
		{
			func_307(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
...
int func_310(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2557346[iParam0 /*3*/][func_309(iParam1)];
...
void func_315(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_320(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_317(Var7.f_1)) && iVar9 < 50)
			{
...
int func_323(vector3 vParam0, char* sParam1, vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
int func_325(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_345())
		{
			*uParam0 = func_331(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_327(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_329() == 0)
		{
			return MISC::IS_BIT_SET(func_308(func_328(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_331(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 48)
	{
		if (iParam1 == 6 || iParam1 == func_344(iVar0))
		{
			if (!bParam3 || func_343(iVar0))
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_332(iVar0, 0), true);
...
Vector3 func_334(int iParam0, int iParam1)
{
	...
	if (Global_1589135 != func_68())
	{
		if (iParam1 == 3)
		{
			if (func_335(iParam0, 1, &vVar0, 0, 0))
			{
				vVar1 = { vVar0 };
			}
		}
		else if (iParam1 == 2)
		{
			...
			{
				if (func_335(iParam0, 2, &vVar0, 0, 0))
				{
					vVar1 = { vVar0 };
				}
			}
...
int func_335(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	vVar3 = { Var2 - Var0 };
	vVar3 = { func_336(vVar3, -Var0.f_3.f_2) };
	vVar3 = { func_336(vVar3, vVar1.f_3.f_2) };
	*uParam2 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vVar1, 0f, vVar3) };
	uParam2->f_3 = { Var2.f_3 };
	return 1;
}

Vector3 func_336(vector3 vParam0, float fParam1)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
var func_346()
{
	...
	func_349(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_348(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_347(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_352(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_361(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
void func_369()
{
	...
	{
		case 0:
			if (func_400(1084227584, 1) || (bLocal_976 && STREAMING::_0x7D41E9D2D17C5B2D(iLocal_955)))
			{
				func_399(-1248.398f, -183.366f, 37.72881f, -1216.437f, -196.8727f, 44.07541f, 59.25f, vLocal_1413, fLocal_1414, 1, 1, 1, 0, 0);
						...
						while (iLocal_1017 < 3)
						{
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_941[iLocal_1017], 0))
							{
								...
								if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_941[iLocal_1017], 242628503) != 1)
								{
									...
									BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_1052[iLocal_1017 /*3*/], 1f, 20000, 0.25f, 0, 1193033728);
									BRAIN::CLOSE_SEQUENCE_TASK(iLocal_1072);
									BRAIN::TASK_PERFORM_SEQUENCE(iLocal_941[iLocal_1017], iLocal_1072);
									BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_1072);
								}
							}
							iLocal_1017++;
...
{
	if (func_374() && MISC::GET_GAME_TIMER() >= iParam0 + 1000)
	{
...
void func_377(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_381(PLAYER::PLAYER_ID())) && !func_379(PLAYER::PLAYER_ID(), 0)) && !func_378()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_381(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_70976 = 0;
...
int func_383(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
int func_389(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	...
	{
		vParam1.z = vParam2.z;
		vVar0 = { func_391(vParam1 - vParam2) };
		vVar1 = { vVar0 };
		vVar0.x = -vVar1.y;
		vVar0.y = vVar1.x;
		vVar0.z = 0f;
...
{
	func_387(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

int func_400(float fParam0, int iParam1)
{
	int iVar0;
	
	if (((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_401(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam0, 1, 1056964608, 0, 1, 0)) && !ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
int func_401(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
		...
		case 1:
			...
			if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
			{
				if (!func_413())
				{
					...
					{
						iLocal_949 = func_412(vLocal_1061, 1);
						HUD::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_949, "ASS_VA_DESTBLIP");
						func_411(&iLocal_949, -1234.307f, -250.6783f, 38.2238f, 28.914f);
						if (!iLocal_958)
						{
				...
				else if (STREAMING::_0x7D41E9D2D17C5B2D(iLocal_955) && func_409())
				{
					func_408();
					func_252();
					iLocal_931 = 8;
			...
			{
				func_407(iLocal_949, "ASS_VA_LOSECOPS");
			}
			else
			{
				func_31(3);
...
void func_404()
{
	if (!iLocal_957)
	{
		if (func_270(vLocal_1061, 1) <= 100f)
		{
			func_406();
	...
	else if (func_270(vLocal_1061, 1) > 120f)
	{
...
bool func_410(char* sParam0, int iParam1, char* sParam2)
{
...
void func_411(int iParam0, vector3 vParam1, float fParam2)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_412(vector3 vParam0, bool bParam1)
{
	int iVar0;
...
void func_415()
{
	...
	switch (iLocal_1025)
	{
		...
		case 1:
			...
			BRAIN::OPEN_SEQUENCE_TASK(&iVar0);
			BRAIN::TASK_LOOK_AT_ENTITY(0, Local_1427[1], -1, 0, 2);
			...
			{
				BRAIN::TASK_PERFORM_SEQUENCE(Local_1427[0], iVar0);
			}
			BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
			BRAIN::OPEN_SEQUENCE_TASK(&iVar0);
			BRAIN::TASK_LOOK_AT_ENTITY(0, Local_1427[0], -1, 0, 2);
			...
			{
				BRAIN::TASK_PERFORM_SEQUENCE(Local_1427[1], iVar0);
			}
			BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
			...
			BRAIN::TASK_LOOK_AT_ENTITY(Local_1427.f_3, Local_1427[0], -1, 0, 2);
			...
			BRAIN::TASK_PLAY_ANIM(Local_1427.f_8[0], "oddjobs@assassinate@hotel@", "idle_a", 8f, -4f, -1, 1, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(Local_1427.f_8[1], "oddjobs@assassinate@hotel@", "argue_b", 8f, -4f, -1, 1, 0, 0, 0, 0);
			...
			BRAIN::TASK_PLAY_ANIM(Local_1427.f_5[0], "oddjobs@assassinate@hotel@", "base", 8f, -4f, -1, 1, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(Local_1427.f_5[1], "oddjobs@assassinate@hotel@", "base", 8f, -4f, -1, 1, 0, 0, 0, 0);
			Local_1427.f_11 = 1;
				...
				case 0:
					if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
					{
						if ((PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()) || (ENTITY::DOES_ENTITY_EXIST(iLocal_944) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_944, PLAYER::PLAYER_PED_ID(), 1))) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_1426, PLAYER::PLAYER_PED_ID(), 1))
						{
							...
							BRAIN::TASK_PLAY_ANIM(iLocal_944, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 1000f, -4f, -1, 790536, 0, 0, 0, 0);
							iLocal_1016 = 1;
						}
					}
					break;
				...
				case 1:
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_944, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 3))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_944, "oddjobs@assassinate@hotel@leadin", "Lester_Getup") >= 0.376f)
						{
							...
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1462.339f, -964.178f, 6.3394f, 1f, -1, 1f, 1, 1193033728);
							BRAIN::TASK_WANDER_STANDARD(0, ENTITY::GET_ENTITY_HEADING(iLocal_944), 0);
							BRAIN::CLOSE_SEQUENCE_TASK(iVar0);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_944, iVar0);
							BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
...
void func_424()
{
	...
	if (!MISC::IS_BIT_SET(Global_92955.f_20, 13))
	{
		func_507();
	}
	func_425(0, -1, 1);
...
void func_436()
{
	...
	MemCopy(&(Local_919.f_6), {Global_55982}, 6);
	...
	switch (iLocal_1018)
	{
		...
		case 1:
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				BRAIN::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "oddjobs@assassinate@hotel@leaning@", "idle_a", 1000f, -4f, -1, 513, 0, 0, 0, 0);
			...
			if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Lester", 0)))
			{
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Lester", 0))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_944) && !PED::IS_PED_INJURED(iLocal_944))
					{
						...
						BRAIN::TASK_PLAY_ANIM(iLocal_944, "oddjobs@assassinate@hotel@leadin", "lester_leadin", 1000f, -8f, -1, 790537, 0f, 0, 1, 0);
...
void func_444()
{
	if (bLocal_965)
	{
		...
		{
			func_446(Local_1427.f_8[0], 1);
			func_446(Local_1427.f_8[1], 1);
			func_446(Local_1427.f_5[0], 1);
			func_446(Local_1427.f_5[1], 1);
		}
		else
		{
			...
			if (!iLocal_963)
			{
				func_445(Local_1427.f_5[0], 0);
				func_445(Local_1427.f_5[1], 0);
			}
			else
			{
...
void func_446(int iParam0, bool bParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		{
			BRAIN::OPEN_SEQUENCE_TASK(&iVar0);
			BRAIN::TASK_GO_TO_COORD_ANY_MEANS(0, -1214.343f, -132.1107f, 40.2416f, 1f, 0, 0, 786603, -1082130432);
	...
	switch (iLocal_1026)
	{
		case 0:
			if (((iLocal_979 || iLocal_963) || func_23(Local_1427[0], 0) < 1f) || func_23(Local_1427[1], 0) < 1f)
			{
				...
				{
					BRAIN::TASK_LOOK_AT_ENTITY(Local_1427[0], Local_1427[1], -1, 0, 2);
					BRAIN::TASK_LOOK_AT_ENTITY(Local_1427[1], Local_1427[0], -1, 0, 2);
				}
				...
				{
					BRAIN::CLEAR_PED_TASKS(Local_1427[1]);
			...
			if (!iLocal_999)
			{
				if (func_52(&iLocal_1096))
				{
					if (func_46(&iLocal_1096) > 3f)
					{
						...
						{
							if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_1427[0], -1794415470) != 1)
							{
								BRAIN::CLEAR_PED_TASKS(Local_1427[0]);
		...
		case 2:
			if (func_52(&iLocal_1096))
			{
				if (func_46(&iLocal_1096) > 3f)
				{
					...
					{
						BRAIN::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_1427.f_3, Local_1427.f_4, "OJAS_HotelTaxi01", 786485, 0, 16, -1, 10f, 0, 1073741824);
						iLocal_1026++;
					}
				}
			}
...
void func_448()
{
	...
	{
		BRAIN::TASK_SMART_FLEE_PED(Local_1427.f_3, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
	}
	...
	{
		BRAIN::TASK_SMART_FLEE_PED(Local_1427[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
	...
	{
		BRAIN::TASK_SMART_FLEE_PED(Local_1427[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
	...
	{
		BRAIN::TASK_SMART_FLEE_PED(Local_1427.f_8[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
	}
	...
	{
		BRAIN::TASK_SMART_FLEE_PED(Local_1427.f_8[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
	}
	...
	{
		BRAIN::TASK_SMART_FLEE_PED(Local_1427.f_5[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
	}
	...
	{
		BRAIN::TASK_SMART_FLEE_PED(Local_1427.f_5[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
	}
}
...
int func_453(vector3 vParam0, float fParam1)
{
	return func_454(&(Global_98783.f_2875), vParam0, fParam1, 0);
}

int func_454(var uParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_305(iParam0, 0, 0)) || func_305(iParam0, 1, 0)) || func_305(iParam0, 2, 0)) || func_290(iParam0) != 145) || func_470(iParam0)) || func_469(iParam0)) || func_468(iParam0)) || func_467(iParam0)) || !func_457(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_469(iParam0))
		{
		}
...
void func_484(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90431[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90431[iVar0]) == func_292(iParam0, iParam1))
				{
...
void func_485(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_295(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_295(iVar1 + 1)))
			{
			}
			else
			{
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_295(iVar2 + 1)))
				{
...
int func_486(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_490(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_489(*iParam0, ((*uParam1)[38] - 1)))
	{
...
void func_501(vector3 vParam0, float fParam1, bool bParam2)
{
	int iVar0;
...
void func_515()
{
	...
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89597.f_28[0], true, 1);
		ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(Global_89597.f_28[0]));
	}
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
	{
		func_517(PLAYER::PLAYER_PED_ID(), 1);
...
void func_516()
{
	...
	while (iVar0 < 3)
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (func_270(vLocal_1052[iVar0 /*3*/], 1) < 5f)
			{
