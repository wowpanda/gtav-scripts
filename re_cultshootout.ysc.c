...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_109(vLocal_46, 4294967295, 0, 0, 0))
	{
		func_106(4294967295);
	}
	else
	...
	{
		SYSTEM::WAIT(0);
		if ((BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_60) || (func_105() && ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_46, 500f, 500f, 500f, false, true, 0)))
		{
			if (!func_105())
			{
				if (func_104())
...
void func_1()//Position - 0x18C
{
	...
	if (SYSTEM::VDIST(func_2(CAM::_0xDC9DA9E8789F5246()), vLocal_46) > 150f)
	{
		func_136();
	}
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_6(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}
...
{
	Global_19E56.f_6187.f_7 = iParam0;
}
	...
	switch (iLocal_45)
	{
		case 0:
			if (OBJECT::DOES_PICKUP_EXIST(iLocal_65))
			{
				...
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_49, vLocal_50, fLocal_51, 0, true, 0))
					{
						func_66();
						if (!bLocal_61)
						{
		...
		case 1:
			...
			else if (!ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_46, 100f, 100f, 100f, false, true, 0))
			{
				func_25();
			}
			break;
...
{
	func_56("DRUG_BLIP_END", 4294967295);
...
void func_32()//Position - 0xC74
{
	...
	{
		func_34(13, SYSTEM::FLOOR(Global_19E56.f_27B6.f_F0D));
	}
...
int func_36()//Position - 0x16EE
{
	return Global_1407E0;
}

int func_37(int iParam0, int iParam1)//Position - 0x16FA
{
	switch (iParam0)
	{
		case 0:
...
int func_38(int iParam0)//Position - 0x1A6E
{
	switch (iParam0)
	{
		case 29:
...
void func_39(int iParam0)//Position - 0x1A9D
{
	int iVar0;
	int iVar1;
...
void func_40(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x1ADF
{
	func_41(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_41(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x1B00
{
	int iVar0;
...
void func_44()//Position - 0x1E39
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_48(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_46(iVar0) && (!func_45(14) || Global_19A3D))
			{
				if (Global_19E56.f_933.f_21B.f_10CD != iVar0 && func_46(Global_19E56.f_933.f_21B.f_10CD))
				{
...
bool func_45(int iParam0)//Position - 0x1F36
{
	return Global_8D15 == iParam0;
}

bool func_46(int iParam0)//Position - 0x1F44
{
	return iParam0 < 3;
}

int func_47(int iParam0)//Position - 0x1F50
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0)//Position - 0x1F8D
{
	if (func_46(iParam0))
	{
...
int func_49(int iParam0)//Position - 0x1FB7
{
	int iVar0;
	int iVar1;
...
void func_50(int iParam0, int iParam1)//Position - 0x1FFA
{
	MISC::SET_BIT(&(Global_19E56.f_6187.f_8[iParam0]), iParam1);
}

int func_51(int iParam0)//Position - 0x2015
{
	int iVar0;
...
int func_53(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x20E3
{
...
int func_54()//Position - 0x22BD
{
	return 1;
}

int func_55()//Position - 0x22C6
{
...
void func_56(char* sParam0, int iParam1)//Position - 0x22E8
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_57(int iParam0)//Position - 0x22FF
{
	if (func_60())
	{
		Global_19E4C = 1;
		Global_19E49 = MISC::GET_GAME_TIMER();
		if (func_38(Global_19E4B))
		{
			func_58(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_38(Global_19E4B))
		{
...
void func_58(int iParam0)//Position - 0x2352
{
	switch (iParam0)
	{
		case 0:
			if (Global_19E56.f_6187.f_2 < 3)
			{
				...
				{
					func_56(func_59(iParam0), 4294967295);
...
char* func_59(int iParam0)//Position - 0x2433
{
	char* sVar0;
...
int func_61(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x24AC
{
	int iVar0;
...
void func_62(var uParam0, int iParam1)//Position - 0x25E3
{
	int iVar0;
...
bool func_63(int iParam0)//Position - 0x2632
{
	return func_64(iParam0, Global_8D15);
}

int func_64(int iParam0, int iParam1)//Position - 0x2643
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_65(int iParam0)//Position - 0x2824
{
	if (Global_8D15 == 15)
	{
		return 0;
...
int func_67(int iParam0)//Position - 0x2878
{
	int iVar0;
...
float func_68(bool bParam0, float fParam1, float fParam2)//Position - 0x28B0
{
	if (bParam0)
	{
		return fParam1;
...
void func_70()//Position - 0x28F5
{
	...
	while (iLocal_71 < 6)
	{
		...
		{
			if ((func_89() && iLocal_73 != 2) || (iLocal_73 == 1 && PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330())))
			{
				func_87();
				SYSTEM::WAIT(0);
				if (func_86())
			...
			switch (iLocal_73)
			{
				case 0:
					...
					{
						if ((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_63[iLocal_71], AUDIO::_0x0626A247D2405330(), 15f, 15f, 40f, 0, 1, 0) && PLAYER::CAN_PED_HEAR_PLAYER(CAM::_0xDC9DA9E8789F5246(), iLocal_63[iLocal_71])) || PED::_CAN_PED_SEE_PED(iLocal_63[iLocal_71], AUDIO::_0x0626A247D2405330()))
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_49, vLocal_50, fLocal_51, 0, true, 0) || ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), 2205.918f, 5633.455f, 55.7472f, 15f, 15f, 40f, false, true, 0))
							{
								if (!func_55())
								{
								...
								while (iVar0 < iLocal_63)
								{
									...
									BRAIN::OPEN_SEQUENCE_TASK(&iLocal_70);
									...
									CUTSCENE::_0x8D9DF6ECA8768583(iLocal_70);
									BRAIN::TASK_PERFORM_SEQUENCE(iLocal_63[iVar0], iLocal_70);
									BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_70);
									PED::SET_PED_USING_ACTION_MODE(iLocal_63[iVar0], true, 4294967295, 0);
									iVar0++;
								}
				...
				case 1:
					...
					while (iVar1 < iLocal_63)
					{
						if (!iLocal_56[iVar1])
						{
							...
							BRAIN::TASK_AIM_GUN_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295, 0);
							CUTSCENE::_0x8D9DF6ECA8768583(iLocal_70);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_63[iVar1], iLocal_70);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_70);
							PED::SET_PED_USING_ACTION_MODE(iLocal_63[iVar1], true, 4294967295, 0);
							iLocal_56[iVar1] = 1;
						}
						iVar1++;
					}
					if (!PED::IS_PED_INJURED(iLocal_63[iLocal_71]))
					{
						if (!PED::IS_PED_FACING_PED(iLocal_63[iLocal_71], AUDIO::_0x0626A247D2405330(), 50f))
						{
							BRAIN::TASK_LOOK_AT_ENTITY(iLocal_63[iLocal_71], AUDIO::_0x0626A247D2405330(), 4294967295, 0, 2);
					...
					if (iLocal_56[iLocal_71])
					{
						...
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_49, vLocal_50, fLocal_51, 0, true, 0) || ENTITY::IS_ENTITY_AT_ENTITY(iLocal_63[iLocal_71], AUDIO::_0x0626A247D2405330(), 15f, 15f, 5f, 0, 1, 0))
							{
								func_87();
								SYSTEM::WAIT(0);
								if (func_86())
							...
							else
							{
								...
								{
									NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_63[iLocal_71]);
									if (!PED::IS_PED_INJURED(iLocal_63[0]))
									{
										BRAIN::OPEN_SEQUENCE_TASK(&iLocal_70);
										BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2205.769f, 5631.985f, 55.553f, 1f, 4294967295, 1048576000, 0, 1193033728);
										BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, 2214.833f, 5635.627f, 55.0029f, 8000);
										BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2222.259f, 5613.22f, 53.5576f, 1f, 4294967295, 1048576000, 0, 1193033728);
										BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, 2221.951f, 5593.625f, 52.9483f, 10000);
										BRAIN::SET_SEQUENCE_TO_REPEAT(iLocal_70, 1);
										CUTSCENE::_0x8D9DF6ECA8768583(iLocal_70);
										BRAIN::TASK_PERFORM_SEQUENCE(iLocal_63[0], iLocal_70);
										BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_70);
										PED::SET_PED_USING_ACTION_MODE(iLocal_63[0], false, 4294967295, 0);
									}
									if (!PED::IS_PED_INJURED(iLocal_63[1]))
									{
										BRAIN::OPEN_SEQUENCE_TASK(&iLocal_70);
										BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2210.584f, 5580.684f, 52.8132f, 1f, 4294967295, 1048576000, 0, 1193033728);
										BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, 2205.466f, 5583.631f, 52.8682f, 8000);
										BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2203.039f, 5567.408f, 52.7996f, 1f, 4294967295, 1048576000, 0, 1193033728);
										BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, 2199.498f, 5560.702f, 52.8606f, 10000);
										BRAIN::SET_SEQUENCE_TO_REPEAT(iLocal_70, 1);
										CUTSCENE::_0x8D9DF6ECA8768583(iLocal_70);
										BRAIN::TASK_PERFORM_SEQUENCE(iLocal_63[1], iLocal_70);
										BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_70);
										PED::SET_PED_USING_ACTION_MODE(iLocal_63[1], false, 4294967295, 0);
									}
									if (!PED::IS_PED_INJURED(iLocal_63[2]))
									{
										BRAIN::OPEN_SEQUENCE_TASK(&iLocal_70);
										BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2199.679f, 5590.673f, 52.7784f, 1f, 4294967295, 1048576000, 0, 1193033728);
										BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, 2210.646f, 5593.576f, 52.8312f, 8000);
										BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2232.761f, 5593.563f, 53.0542f, 1f, 4294967295, 1048576000, 0, 1193033728);
										BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, 2237.916f, 5599.589f, 53.2311f, 12000);
										BRAIN::SET_SEQUENCE_TO_REPEAT(iLocal_70, 1);
										CUTSCENE::_0x8D9DF6ECA8768583(iLocal_70);
										BRAIN::TASK_PERFORM_SEQUENCE(iLocal_63[2], iLocal_70);
										BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_70);
										PED::SET_PED_USING_ACTION_MODE(iLocal_63[2], false, 4294967295, 0);
									}
									if (!PED::IS_PED_INJURED(iLocal_63[3]) && !PED::IS_PED_INJURED(iLocal_63[4]))
									{
										BRAIN::OPEN_SEQUENCE_TASK(&iLocal_70);
										BRAIN::TASK_GO_TO_ENTITY(0, iLocal_63[4], 4294967295, 2f, 1f, 1073741824, 0);
										BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_63[4], 0);
										BRAIN::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
										CUTSCENE::_0x8D9DF6ECA8768583(iLocal_70);
										BRAIN::TASK_PERFORM_SEQUENCE(iLocal_63[3], iLocal_70);
										BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_70);
										PED::SET_PED_USING_ACTION_MODE(iLocal_63[3], false, 4294967295, 0);
									}
									if (!PED::IS_PED_INJURED(iLocal_63[4]))
									{
										BRAIN::OPEN_SEQUENCE_TASK(&iLocal_70);
										BRAIN::TASK_GO_TO_ENTITY(0, iLocal_63[3], 4294967295, 2f, 1f, 1073741824, 0);
										BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_63[3], 0);
										BRAIN::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
										CUTSCENE::_0x8D9DF6ECA8768583(iLocal_70);
										BRAIN::TASK_PERFORM_SEQUENCE(iLocal_63[4], iLocal_70);
										BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_70);
										PED::SET_PED_USING_ACTION_MODE(iLocal_63[4], false, 4294967295, 0);
									}
									if (!PED::IS_PED_INJURED(iLocal_63[5]))
									{
										BRAIN::TASK_GUARD_CURRENT_POSITION(iLocal_63[5], 0f, 3f, 1);
										PED::SET_PED_USING_ACTION_MODE(iLocal_63[5], false, 4294967295, 0);
									}
								}
								iVar1 = 0;
				...
				case 2:
					...
					while (iLocal_71 < 6)
					{
						if (!PED::IS_PED_INJURED(iLocal_63[iLocal_71]))
						{
							...
							{
								PED::_0xF1C03A5352243A30(iLocal_63[iLocal_71]);
								BRAIN::TASK_COMBAT_PED(iLocal_63[iLocal_71], AUDIO::_0x0626A247D2405330(), 0, 16);
								PED::SET_PED_KEEP_TASK(iLocal_63[iLocal_71], true);
								if (!HUD::DOES_BLIP_EXIST(uLocal_68[iLocal_71]))
								{
...
int func_71(int iParam0, bool bParam1, int iParam2)//Position - 0x3160
{
	int iVar0;
...
int func_72(int iParam0, bool bParam1, bool bParam2)//Position - 0x31B2
{
	int iVar0;
...
int func_73(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x3256
{
...
int func_74(char* sParam0, int iParam1, bool bParam2)//Position - 0x32A4
{
	Global_3DCF = 0;
...
int func_80()//Position - 0x3798
{
	func_44();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_81()//Position - 0x37B1
{
	int iVar0;
...
bool func_82(int iParam0, int iParam1)//Position - 0x3808
{
	switch (iParam0)
	{
		case 5:
...
void func_84(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x389A
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
void func_85(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x38F0
{
...
bool func_86()//Position - 0x398B
{
	return Global_19E56.f_6187.f_7;
}

void func_87()//Position - 0x399C
{
	Global_3960 = 0;
	func_88();
}

void func_88()//Position - 0x39AC
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_89()//Position - 0x39CD
{
	...
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_64[iVar0], 0))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_64[iVar0], AUDIO::_0x0626A247D2405330(), 1))
			{
				return 1;
			}
		}
	...
	while (iVar0 < iLocal_63)
	{
		...
		{
			if (PED::_CAN_PED_SEE_PED(iLocal_63[iVar0], AUDIO::_0x0626A247D2405330()))
			{
				if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_63[iVar0]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_63[iVar0]))
				{
					return 1;
				}
			}
			if ((((((MISC::IS_BULLET_IN_AREA(unk_0x8000C77B5F336760(iLocal_63[iVar0], true), 5f, 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_63[iVar0], AUDIO::_0x0626A247D2405330(), 1)) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_63[iVar0])) || MISC::IS_PROJECTILE_TYPE_IN_AREA(unk_0x8000C77B5F336760(iLocal_63[iVar0], true) - Vector(15f, 15f, 15f), unk_0x8000C77B5F336760(iLocal_63[iVar0], true) + Vector(15f, 15f, 15f), joaat("weapon_smokegrenade"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(unk_0x8000C77B5F336760(iLocal_63[iVar0], true) - Vector(15f, 15f, 15f), unk_0x8000C77B5F336760(iLocal_63[iVar0], true) + Vector(15f, 15f, 15f), joaat("weapon_grenade"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(unk_0x8000C77B5F336760(iLocal_63[iVar0], true) - Vector(15f, 15f, 15f), unk_0x8000C77B5F336760(iLocal_63[iVar0], true) + Vector(15f, 15f, 15f), joaat("weapon_grenadelauncher"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(unk_0x8000C77B5F336760(iLocal_63[iVar0], true) - Vector(15f, 15f, 15f), unk_0x8000C77B5F336760(iLocal_63[iVar0], true) + Vector(15f, 15f, 15f), joaat("weapon_stickybomb"), 1))
			{
				return 1;
			}
		}
	...
	if (FIRE::IS_EXPLOSION_IN_ANGLED_AREA(4294967295, vLocal_49, vLocal_50, fLocal_51))
	{
		return 1;
	}
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_49, vLocal_50, fLocal_51, 0, true, 0))
	...
	if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), 2202.498f, 5603.424f, 52.7476f, 20f, 20f, 20f, false, true, 0))
	{
		if (ENTITY::GET_ENTITY_SPEED(AUDIO::_0x0626A247D2405330()) > 15f)
		{
			return 1;
		}
	}
...
void func_90()//Position - 0x3C40
{
	...
	if ((STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_salvagoon_01")) && STREAMING::HAS_MODEL_LOADED(joaat("BOBCATXL"))) && STREAMING::HAS_MODEL_LOADED(joaat("prop_cash_case_01")))
	{
		...
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, iLocal_69, 2761840924);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, 2761840924, iLocal_69);
		...
		while (iLocal_71 < 6)
		{
			...
			ENTITY::SET_ENTITY_HEALTH(iLocal_63[iLocal_71], true);
			...
			if (iLocal_72 == 0)
			{
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_63[iLocal_71], joaat("weapon_sawnoffshotgun"), 4294967295, true, true);
			}
			else if (iLocal_72 == 1)
			{
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_63[iLocal_71], joaat("weapon_microsmg"), 4294967295, true, true);
			}
			else
			{
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_63[iLocal_71], joaat("weapon_assaultrifle"), 4294967295, true, true);
			}
		...
		if (!PED::IS_PED_INJURED(iLocal_63[0]))
		{
			...
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2205.769f, 5631.985f, 55.553f, 1f, 4294967295, 1048576000, 0, 1193033728);
			BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, 2214.833f, 5635.627f, 55.0029f, 8000);
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2215.993f, 5613.299f, 53.6157f, 1f, 4294967295, 1048576000, 0, 1193033728);
			BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, 2221.951f, 5593.625f, 52.9483f, 10000);
			BRAIN::SET_SEQUENCE_TO_REPEAT(iLocal_70, 1);
			CUTSCENE::_0x8D9DF6ECA8768583(iLocal_70);
			BRAIN::TASK_PERFORM_SEQUENCE(iLocal_63[0], iLocal_70);
		...
		{
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_70);
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2201.014f, 5589.357f, 52.9573f, 1f, 4294967295, 1048576000, 0, 1193033728);
			BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, 2210.646f, 5593.576f, 52.8312f, 8000);
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2229.667f, 5598.368f, 53.2195f, 1f, 4294967295, 1048576000, 0, 1193033728);
			BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, 2237.916f, 5599.589f, 53.2311f, 12000);
			BRAIN::SET_SEQUENCE_TO_REPEAT(iLocal_70, 1);
			CUTSCENE::_0x8D9DF6ECA8768583(iLocal_70);
			BRAIN::TASK_PERFORM_SEQUENCE(iLocal_63[2], iLocal_70);
		...
		func_56("DRUG_BLIP_START", 4294967295);
		iLocal_44 = 1;
	}
}

int func_91(vector3 vParam0, bool bParam1)//Position - 0x427D
{
	int iVar0;
...
int func_92()//Position - 0x42A9
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(AUDIO::_0x0626A247D2405330())) > 1369f && !func_103())
		{
			return 0;
		}
	}
...
int func_93(float fParam0, bool bParam1)//Position - 0x432F
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_94(int iParam0, var uParam1)//Position - 0x43E6
{
	switch (iParam0)
	{
		case 0:
...
int func_96(int iParam0)//Position - 0x562C
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_97(int iParam0)//Position - 0x5972
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_98(int iParam0)//Position - 0x59A9
{
	struct<2> Var0;
...
bool func_100()//Position - 0x5E27
{
	return Global_19D3C > 0;
}

int func_101()//Position - 0x5E35
{
...
void func_106(int iParam0)//Position - 0x5F1A
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_52();
...
void func_108(int iParam0)//Position - 0x5F8D
{
	Global_19E4B = iParam0;
}

int func_109(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x5F9B
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_130(Global_19E56.f_6187.f_2B[iParam1]))
		{
			return 0;
		}
...
bool func_110(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x6335
{
	if (bParam2)
	{
...
bool func_111(int iParam0)//Position - 0x637C
{
	int iVar0;
...
int func_112(int iParam0)//Position - 0x639D
{
	return func_113(iParam0, 1);
}

int func_113(int iParam0, int iParam1)//Position - 0x63AC
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_114(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x63FF
{
	func_115(func_22(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_115(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x641D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_116(float fParam0, float fParam1, float fParam2)//Position - 0x661E
{
	float fVar0;
...
int func_117(int iParam0, int iParam1)//Position - 0x6660
{
	int iVar0;
	int iVar1;
...
int func_118(int iParam0)//Position - 0x676C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_119(int iParam0, int iParam1)//Position - 0x6848
{
...
int func_120(int iParam0)//Position - 0x686B
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_128()) || Global_19A9D) || Global_6375) || func_127()) || func_82(8, 4294967295)) || func_126()) || func_125()) || func_124()) || func_123()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_128()) || Global_6375) || func_127()) || func_82(8, 4294967295)) || func_124()) || func_126()) || func_125()) || func_123()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_128()) || Global_19A9D) || Global_6375) || func_127()) || func_82(8, 4294967295)) || func_124()) || func_126()) || func_125()) || func_123()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_128()) || Global_19A9D) || Global_6375) || func_127()) || func_82(8, 4294967295)) || func_126()) || func_125()) || func_123()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_128() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_82(8, 4294967295)) || func_123()) || func_122()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_82(8, 4294967295) || func_126()) || func_125()) || func_122()) || func_121())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_128()) || Global_6375) || func_127()) || func_82(8, 4294967295)) || func_125()) || func_124()) || func_123()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_121()//Position - 0x6F88
{
	return Global_16C57.f_1;
}

int func_122()//Position - 0x6F96
{
	if (Global_16089 != 4294967295)
	{
...
bool func_125()//Position - 0x7000
{
	return Global_16C64.f_148 > 0;
}

bool func_126()//Position - 0x7011
{
	return Global_16C64.f_147 > 0;
}

var func_127()//Position - 0x7022
{
	return Global_140859;
}

int func_128()//Position - 0x702E
{
...
bool func_130(int iParam0)//Position - 0x7072
{
	return func_117(func_22(), iParam0);
}

int func_131(int iParam0, int iParam1, int iParam2)//Position - 0x7084
{
	int iVar0;
	int iVar1;
...
int func_132(int iParam0)//Position - 0x7168
{
	if (!func_46(iParam0))
	{
		return 7;
...
bool func_133(int iParam0)//Position - 0x718C
{
	int iVar0;
	bool bVar1;
...
void func_137(int iParam0)//Position - 0x7385
{
	char cVar0[64];
	...
	if (func_105())
	{
		...
		func_140(30000);
		StringCopy(&cVar0, func_139(Global_19E4B, 1), 64);
	...
	func_138(&Global_63AE);
	Global_19E4C = 0;
	func_108(4294967295);
}

void func_138(var uParam0)//Position - 0x743A
{
	if (*uParam0 == 4294967295)
	{
		return;
...
char* func_139(int iParam0, bool bParam1)//Position - 0x7477
{
	switch (iParam0)
	{
		case 0:
...
void func_140(int iParam0)//Position - 0x76C0
{
	Global_8F3C = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_141(int iParam0)//Position - 0x76D2
{
	func_3(iParam0, 0, func_142(iParam0));
}

int func_142(int iParam0)//Position - 0x76E7
{
	int iVar0;
