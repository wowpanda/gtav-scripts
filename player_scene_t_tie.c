...
int func_2()
{
	...
	fVar0 = VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_82);
	if (fVar0 > (100f * 100f))
	{
		return 1;
	}
...
void func_19()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_77)
		{
			...
			{
				REQUEST_MODEL(iLocal_77[iVar0]);
				if (!HAS_MODEL_LOADED(iLocal_77[iVar0]))
				{
					REQUEST_MODEL(iLocal_77[iVar0]);
					bVar2 = false;
				}
		...
		if (!IS_STRING_NULL_OR_EMPTY(&cLocal_117))
		{
			REQUEST_ANIM_DICT(&cLocal_117);
			if (!HAS_ANIM_DICT_LOADED(&cLocal_117))
			{
				REQUEST_ANIM_DICT(&cLocal_117);
				bVar2 = false;
			}
	...
	while (iVar0 < iLocal_72)
	{
		if (iLocal_77[iVar0] != 0)
		{
			iLocal_72[iVar0] = CREATE_PED(26, iLocal_77[iVar0], vLocal_82 + vLocal_86[iVar0 /*3*/], 0, 1, 1);
			SET_ENTITY_ROTATION(iLocal_72[iVar0], Vector(uLocal_85, 0f, 0f) + vLocal_99[iVar0 /*3*/], 2, 1);
			SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_72[iVar0], 0);
			if (iLocal_70 == 288)
			{
				SET_PED_COMPONENT_VARIATION(iLocal_72[iVar0], 3, 1, 0, 0);
				SET_PED_COMPONENT_VARIATION(iLocal_72[iVar0], 4, 0, 0, 0);
			}
			else
			{
				SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_72[iVar0], 0);
			}
			SET_PED_COMBAT_ATTRIBUTES(iLocal_72[iVar0], 13, 0);
			SET_PED_COMBAT_ATTRIBUTES(iLocal_72[iVar0], 17, 1);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_72[iVar0], 1);
			SET_PED_CAN_BE_TARGETTED(iLocal_72[iVar0], 0);
			TASK_PLAY_ANIM_ADVANCED(iLocal_72[iVar0], &cLocal_117, &(Local_125[iVar0 /*8*/]), vLocal_82 + vLocal_86[iVar0 /*3*/], Vector(uLocal_85, 0f, 0f) + vLocal_99[iVar0 /*3*/], 1000f, -8f, -1, iLocal_158, 0, 2, 0);
			_0x2208438012482A1A(iLocal_72[iVar0], 0, 0);
			SET_PED_KEEP_TASK(iLocal_72[iVar0], 1);
			SET_PED_RESET_FLAG(iLocal_72[iVar0], 55, 1);
			if (iLocal_166[iVar0] > 0)
			{
				APPLY_PED_BLOOD_BY_ZONE(iLocal_72[iVar0], 1, 0.36f, 0.71f, "ShotgunSmall");
				APPLY_PED_BLOOD_DAMAGE_BY_ZONE(iLocal_72[iVar0], 1, 0.81f, 0.733f, 4);
				APPLY_PED_BLOOD_DAMAGE_BY_ZONE(iLocal_72[iVar0], 0, 0.94f, 0.59f, 3);
				APPLY_PED_BLOOD_DAMAGE_BY_ZONE(iLocal_72[iVar0], 3, 0.24f, 0.62f, 4);
				APPLY_PED_BLOOD_DAMAGE_BY_ZONE(iLocal_72[iVar0], 2, 0f, 0.15f, 2);
				APPLY_PED_BLOOD_DAMAGE_BY_ZONE(iLocal_72[iVar0], 5, 0.46f, 0.853f, 3);
				APPLY_PED_BLOOD_DAMAGE_BY_ZONE(iLocal_72[iVar0], 4, 0.308f, 0.786f, 3);
				APPLY_PED_BLOOD_SPECIFIC(iLocal_72[iVar0], 3, 0.375f, 0.398f, 0f, 1f, -1, 0f, "BasicSlash");
				APPLY_PED_BLOOD_SPECIFIC(iLocal_72[iVar0], 3, 0.5f, 0.6f, 0f, 1f, -1, 0f, "BasicSlash");
				APPLY_PED_BLOOD_SPECIFIC(iLocal_72[iVar0], 3, 0.6f, 0.25f, 50f, 0.5f, -1, 0f, "BasicSlash");
				APPLY_PED_BLOOD_SPECIFIC(iLocal_72[iVar0], 3, 0.65f, 0.325f, 50f, 0.5f, -1, 0f, "BasicSlash");
				APPLY_PED_BLOOD_SPECIFIC(iLocal_72[iVar0], 0, 0.58f, 0.704f, 0f, 1f, -1, 0f, "ShotgunLarge");
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < iLocal_159)
	{
		if (iLocal_166[iVar0] > 0)
		{
			...
			fVar14 = 1f;
			fVar15 = -1f;
			iLocal_159[iVar0] = ADD_DECAL(iLocal_166[iVar0], vLocal_82 + vLocal_173[iVar0 /*3*/], vVar3, vVar6, fVar9, fVar10, fVar11, fVar12, fVar13, fVar14, fVar15, 0, 0, 0);
			WAIT(0);
		}
		iVar0++;
	}
...
void func_21()
{
	...
	func_25(iLocal_70, &vLocal_82, &uLocal_85, &cVar0);
	Var8.f_1 = -1;
	Var8.f_17 = 4;
	Var8.f_17.f_8 = 4;
	Var8.f_17.f_13 = 4;
	...
	switch (iLocal_70)
	{
		case 280:
			...
			iLocal_166[4] = 1015;
			iLocal_166[5] = 1015;
			vLocal_173[4 /*3*/] = { vLocal_173[0 /*3*/] + vLocal_173[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f)) };
			vLocal_173[5 /*3*/] = { vLocal_173[1 /*3*/] + vLocal_173[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f)) };
			break;
...
void func_33()
{
	...
	while (iVar0 < iLocal_77)
	{
		if (iLocal_77[iVar0] != 0)
		{
			SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_77[iVar0]);
		}
		iVar0++;
	}
	if (!IS_STRING_NULL_OR_EMPTY(&cLocal_117))
	{
		REMOVE_ANIM_DICT(&cLocal_117);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_159)
	{
		if (IS_DECAL_ALIVE(iLocal_159[iVar0]))
		{
		}
		iVar0++;
	}
