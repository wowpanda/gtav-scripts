...
int func_2()
{
	...
	if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_283) > 100f)
	{
		return 1;
	}
	return 0;
		...
		if (!PED::IS_PED_INJURED((*iParam0)[iVar0]))
		{
			switch ((*iParam1)[iVar0])
			{
				case 100:
					...
					{
						BRAIN::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_90307, &cLocal_338, &(Local_347[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
						(*iParam1)[iVar0] = 101;
					}
				...
				case 101:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90308))
					{
						BRAIN::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_90308, &cLocal_338, &(Local_348[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
				...
				case 102:
					if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_338) && ENTITY::IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_338, &(Local_348[iVar0 /*16*/]), 2))
					{
						...
						{
							if (fVar2 < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90308))
							{
						...
						if (iLocal_109 == 165)
						{
							if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_349[iVar0 /*16*/])))
							{
								...
								if (0.95f < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90308))
								{
				...
				case 0:
					vVar8 = { ENTITY::GET_ENTITY_COORDS((*iParam0)[iVar0], 1) };
				...
				case 1:
					vVar14 = { ENTITY::GET_ENTITY_COORDS((*iParam0)[iVar0], 1) };
				...
				case 11:
					if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_283) > 50f && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS((*iParam0)[iVar0], 1)) > 50f)
					{
	...
	while (iVar0 < 263)
	{
		if (MISC::IS_BIT_SET(Global_25578[iVar0 /*23*/].f_11, 0))
		{
			...
			else
			{
				...
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vVar1) < (fParam1 * fParam1))
				{
					return 1;
				}
				if (MISC::IS_BIT_SET(Global_25578[iVar0 /*23*/].f_11, 19))
				{
					iVar3 = 3;
					iVar2 = 0;
					while (iVar2 < iVar3)
					{
						...
						if (!func_24(vVar4))
						{
							if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), vVar4) < (fParam1 * fParam1))
							{
								return 1;
							}
						}
...
int func_32(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_34(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
