...
void func_17()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_19(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_20(iVar0) && (!func_10(14) || Global_104171))
			{
		...
		if (!PED::IS_PED_INJURED((*iParam0)[iVar0]))
		{
			switch ((*iParam1)[iVar0])
			{
				case 100:
					...
					{
						BRAIN::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_90429, &cLocal_338, &(Local_347[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
						(*iParam1)[iVar0] = 101;
					}
				...
				case 101:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90430))
					{
						BRAIN::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_90430, &cLocal_338, &(Local_348[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
				...
				case 102:
					if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_338) && ENTITY::IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_338, &(Local_348[iVar0 /*16*/]), 2))
					{
						...
						{
							if (fVar2 < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90430))
							{
								if (!PED::IS_PED_RUNNING_RAGDOLL_TASK((*iParam0)[iVar0]))
								{
									BRAIN::CLEAR_PED_TASKS((*iParam0)[iVar0]);
						...
						if (iLocal_109 == 165)
						{
							...
							{
								fVar4 = "AMB@WORLD_HUMAN_CLIPBOARD@MALE@BASE";
								STREAMING::REQUEST_ANIM_DICT(fVar4);
								if (0.95f < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90430))
								{
						...
						if (iLocal_109 == 259)
						{
							if (0.95f < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90430))
							{
								BRAIN::TASK_PUT_PED_DIRECTLY_INTO_MELEE((*iParam0)[iVar0], PLAYER::PLAYER_PED_ID(), 0f, -1f, 0f, 0);
								PED::_0x2208438012482A1A((*iParam0)[iVar0], 0, 0);
								SYSTEM::WAIT(0);
								(*iParam1)[iVar0] = 10;
								break;
						...
						if (iLocal_109 == 246 && iVar0 == 0)
						{
							if (0.95f < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90430))
							{
								...
								if (!PED::IS_PED_INJURED((*iParam0)[iVar0]))
								{
									BRAIN::TASK_PUT_PED_DIRECTLY_INTO_MELEE(PLAYER::PLAYER_PED_ID(), (*iParam0)[iVar0], 0f, -1f, 0f, 0);
									SYSTEM::WAIT(0);
								}
								(*iParam1)[iVar0] = 10;
								break;
				...
				case 200:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90429))
					{
						BRAIN::TASK_PLAY_ANIM((*iParam0)[iVar0], &cLocal_338, &(Local_347[iVar0 /*16*/]), 8f, -1000f, -1, 0, 0, 0, 0, 0);
						(*iParam1)[iVar0] = 201;
					}
					else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90430))
					{
				...
				case 201:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90430))
					{
						BRAIN::TASK_PLAY_ANIM((*iParam0)[iVar0], &cLocal_338, &(Local_348[iVar0 /*16*/]), 8f, -1.5f, -1, 32768, 0, 0, 0, 0);
						BRAIN::TASK_LOOK_AT_ENTITY((*iParam0)[iVar0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						STREAMING::REQUEST_ANIM_DICT(&cLocal_338);
						(*iParam1)[iVar0] = 202;
					}
					break;
					...
					if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_338) && ENTITY::IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_338, &(Local_348[iVar0 /*16*/]), 1))
					{
						...
						if (iLocal_109 == 108 || iLocal_109 == 109)
						{
							if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME((*iParam0)[iVar0], &cLocal_338, &(Local_348[iVar0 /*16*/])) > 0.954f)
							{
								...
								BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vLocal_283 + vLocal_285[iVar0 /*3*/], 1f, -1, 0.25f, 0, 1193033728);
				...
				case 1:
					...
					{
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vVar15, 0.5f, -1, 0.25f, 0, 1193033728);
						break;
					}
					break;
				
				case 10:
					if (BRAIN::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], -71340211) == 7 || BRAIN::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], -71340211) == 1)
					{
						iVar17 = 0;
						...
						BRAIN::TASK_COMBAT_HATED_TARGETS_AROUND_PED_TIMED((*iParam0)[iVar0], 25f, -1, 0);
				...
				case 11:
					if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_283) > 50f && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS((*iParam0)[iVar0], true)) > 50f)
					{
						...
						BRAIN::CLEAR_PED_TASKS((*iParam0)[iVar0]);
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vLocal_283 + vLocal_285[iVar0 /*3*/], 0.5f, -1, 0.25f, 0, 1193033728);
						(*iParam1)[iVar0] = 1;
					}
...
int func_23(int iParam0, float fParam1)
{
	...
	while (iVar0 < 263)
	{
		...
		{
			if (Global_25622[iVar0 /*23*/].f_16 == 9)
			{
			}
			else
			{
				...
				if (MISC::IS_BIT_SET(Global_25622[iVar0 /*23*/].f_11, 19))
				{
					iVar3 = 3;
					iVar2 = 0;
					while (iVar2 < iVar3)
...
int func_40()
{
	...
	if (Global_2436641.f_74)
	{
		return 1;
	}
	if (Global_90578.f_44 == 1)
	{
		if (Global_90578.f_46 == 0)
		{
			return 1;
		}
	}
...
int func_42(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_43(Global_92741) && iParam1 != 0)
		{
			Global_92741 = 0;
		}
	}
...
void func_50()
{
	...
	while (iVar0 < iLocal_276)
	{
		if (iLocal_278[iVar0] != 0)
		{
			...
			BRAIN::TASK_STAND_STILL(iLocal_276[iVar0], -1);
			if (iLocal_109 == 285)
			{
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_105220.f_2354.f_539.f_2290[0];
			StringCopy(sParam2, func_61(Global_105220.f_2354.f_539.f_2294[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_105220.f_2354.f_539.f_2290[1];
			StringCopy(sParam2, func_61(Global_105220.f_2354.f_539.f_2294[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_105220.f_2354.f_539.f_2290[2];
			StringCopy(sParam2, func_61(Global_105220.f_2354.f_539.f_2294[2]), 32);
			return 1;
			break;
