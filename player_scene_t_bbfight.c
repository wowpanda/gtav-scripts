...
void __EntryFunction__()
{
	...
	while (iLocal_279 && func_42(5, 0))
	{
		...
		{
			if (iLocal_113 == 258 && func_39(13) == 2)
			{
				func_62();
			}
		}
...
int func_2()
{
	...
	if (IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
	{
		...
		if (func_20(iVar1))
		{
			if (!IS_STRING_NULL_OR_EMPTY(&Local_497))
			{
				if (!iLocal_502)
				{
					if (fVar0 < fLocal_501)
					...
					{
						if (!IS_STRING_NULL_OR_EMPTY(&Local_489))
						{
							func_15(&uLocal_114, func_16(), PLAYER_PED_ID(), &Local_489, 0, 1);
						}
						if (!IS_STRING_NULL_OR_EMPTY(&Local_493))
						{
							func_15(&uLocal_114, 4, iLocal_280[0], &Local_493, 0, 1);
						}
	...
	if (VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_299) > 100f)
	{
		return 1;
	}
	return 0;
...
void func_15(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
		...
		if (!IS_PED_INJURED((*iParam0)[iVar0]))
		{
			switch ((*iParam1)[iVar0])
			{
				case 100:
					...
					{
						TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_91041, &cLocal_371, &(Local_387[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
						(*iParam1)[iVar0] = 101;
					}
				...
				case 101:
					if (IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
					{
						TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_91042, &cLocal_371, &(Local_420[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
						REQUEST_ANIM_DICT(&cLocal_371);
						(*iParam1)[iVar0] = 102;
					}
					break;
				
				case 102:
					if (HAS_ANIM_DICT_LOADED(&cLocal_371) && IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/]), 2))
					{
						sVar1 = "victim_fall";
						fVar2 = -1f;
						fVar3 = -1f;
						if (FIND_ANIM_EVENT_PHASE(&cLocal_371, &(Local_420[iVar0 /*16*/]), sVar1, &fVar2, &fVar3))
						{
							if (fVar2 < GET_SYNCHRONIZED_SCENE_PHASE(Global_91042))
							{
								if (!IS_PED_RUNNING_RAGDOLL_TASK((*iParam0)[iVar0]))
								{
									...
									SET_PED_CONFIG_FLAG((*iParam0)[iVar0], 137, 1);
								}
							}
						}
						if (iLocal_113 == 165)
						{
							if (!IS_STRING_NULL_OR_EMPTY(&(Local_453[iVar0 /*16*/])))
							{
								sVar4 = "AMB@WORLD_HUMAN_CLIPBOARD@MALE@BASE";
								REQUEST_ANIM_DICT(sVar4);
								if (0.95f < GET_SYNCHRONIZED_SCENE_PHASE(Global_91042))
								{
									if (HAS_ANIM_DICT_LOADED(sVar4))
									{
										TASK_START_SCENARIO_IN_PLACE((*iParam0)[iVar0], &(Local_453[iVar0 /*16*/]), 0, 0);
										_0x2208438012482A1A((*iParam0)[iVar0], 0, 0);
										WAIT(0);
										iLocal_486[iVar0] = -1;
										(*iParam1)[iVar0] = 5;
										break;
						...
						if (iLocal_113 == 259)
						{
							if (0.95f < GET_SYNCHRONIZED_SCENE_PHASE(Global_91042))
							{
								TASK_PUT_PED_DIRECTLY_INTO_MELEE((*iParam0)[iVar0], PLAYER_PED_ID(), 0f, -1f, 0f, 0);
								_0x2208438012482A1A((*iParam0)[iVar0], 0, 0);
								WAIT(0);
								(*iParam1)[iVar0] = 10;
								break;
						...
						if (iLocal_113 == 246 && iVar0 == 0)
						{
							if (0.95f < GET_SYNCHRONIZED_SCENE_PHASE(Global_91042))
							{
								...
								if (!IS_PED_INJURED((*iParam0)[iVar0]))
								{
									TASK_PUT_PED_DIRECTLY_INTO_MELEE(PLAYER_PED_ID(), (*iParam0)[iVar0], 0f, -1f, 0f, 0);
									WAIT(0);
								}
								(*iParam1)[iVar0] = 10;
								break;
				...
				case 200:
					if (IS_SYNCHRONIZED_SCENE_RUNNING(Global_91041))
					{
						TASK_PLAY_ANIM((*iParam0)[iVar0], &cLocal_371, &(Local_387[iVar0 /*16*/]), 8f, -1000f, -1, 0, 0, 0, 0, 0);
						(*iParam1)[iVar0] = 201;
					}
					else if (IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
					{
				...
				case 201:
					if (IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
					{
						TASK_PLAY_ANIM((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/]), 8f, -1.5f, -1, 32768, 0, 0, 0, 0);
				...
				case 202:
					if (HAS_ANIM_DICT_LOADED(&cLocal_371) && IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/]), 1))
					{
						sVar5 = "victim_fall";
						fVar6 = -1f;
						fVar7 = -1f;
						if (FIND_ANIM_EVENT_PHASE(&cLocal_371, &(Local_420[iVar0 /*16*/]), sVar5, &fVar6, &fVar7))
						{
							if (fVar6 < GET_ENTITY_ANIM_CURRENT_TIME((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/])))
							{
								if (!IS_PED_RUNNING_RAGDOLL_TASK((*iParam0)[iVar0]))
								{
									CLEAR_PED_TASKS((*iParam0)[iVar0]);
						...
						{
							if (GET_ENTITY_ANIM_CURRENT_TIME((*iParam0)[iVar0], &cLocal_371, &(Local_420[iVar0 /*16*/])) > 0.954f)
							{
								if (iLocal_113 == 108)
								{
								...
								TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
								FORCE_PED_MOTION_STATE((*iParam0)[iVar0], -668482597, 0, 0, 0);
				...
				case 0:
					vVar8 = { GET_ENTITY_COORDS((*iParam0)[iVar0], 1) };
					vVar11 = { vLocal_299 + vLocal_303[iVar0 /*3*/] + Vector(1f, 0f, 0f) };
					fVar14 = VDIST(vVar8, vVar11);
					...
					fVar15 = GET_ENTITY_HEADING((*iParam0)[iVar0]);
					...
					fVar17 = ABSF((fVar15 - fVar16));
					if (fVar17 > 45f)
					{
						if (!GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], 1920390111) == 1)
						{
							TASK_ACHIEVE_HEADING((*iParam0)[iVar0], fVar16, 0);
						}
						break;
					}
					if (!IS_STRING_NULL_OR_EMPTY(&(Local_453[iVar0 /*16*/])))
				...
				case 1:
					vVar18 = { GET_ENTITY_COORDS((*iParam0)[iVar0], 1) };
					vVar21 = { vLocal_299 + vLocal_303[iVar0 /*3*/] + Vector(1f, 0f, 0f) };
					fVar24 = VDIST(vVar18, vVar21);
					if (fVar24 <= 0.5f)
					{
						(*iParam1)[iVar0] = 0;
						break;
					...
					{
						TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vVar21, 0.5f, -1, 1048576000, 0, 1193033728);
						break;
					}
					break;
				...
				case 10:
					if (GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], -71340211) == 7 || GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], -71340211) == 1)
					{
						...
						SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_289, 1862763509);
						SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_289);
						TASK_COMBAT_HATED_TARGETS_AROUND_PED_TIMED((*iParam0)[iVar0], 25f, -1, 0);
						SET_PED_KEEP_TASK((*iParam0)[iVar0], 1);
				...
				case 11:
					if (VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_299) > 50f && VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS((*iParam0)[iVar0], 1)) > 50f)
					{
						SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_289, 1862763509);
						SET_RELATIONSHIP_BETWEEN_GROUPS(2, 1862763509, uLocal_289);
						CLEAR_PED_TASKS((*iParam0)[iVar0]);
						TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], 0.5f, -1, 1048576000, 0, 1193033728);
						(*iParam1)[iVar0] = 1;
					}
				...
				case 5:
					if (func_26((*iParam0)[iVar0]))
					{
						if (DOES_ENTITY_EXIST(uLocal_290[iVar0]))
						{
							DELETE_OBJECT(&(uLocal_290[iVar0]));
							SET_OBJECT_AS_NO_LONGER_NEEDED(&(uLocal_290[iVar0]));
						}
						CLEAR_PED_TASKS((*iParam0)[iVar0]);
						_0xF1C03A5352243A30((*iParam0)[iVar0]);
						(*iParam1)[iVar0] = 10;
						break;
					}
					if (!PED_HAS_USE_SCENARIO_TASK((*iParam0)[iVar0]))
					{
						if (ARE_STRINGS_EQUAL(&(Local_453[iVar0 /*16*/]), "any"))
						{
							if (DOES_SCENARIO_EXIST_IN_AREA(vLocal_299 + vLocal_303[iVar0 /*3*/], 20f, 1))
							{
								TASK_USE_NEAREST_SCENARIO_TO_COORD((*iParam0)[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], 20f, 0);
								iLocal_486[iVar0] = GET_GAME_TIMER();
							}
						}
						else
						{
							...
							TASK_START_SCENARIO_IN_PLACE((*iParam0)[iVar0], &(Local_453[iVar0 /*16*/]), 0, iVar26);
							iLocal_486[iVar0] = GET_GAME_TIMER();
						}
					}
					else if (DOES_ENTITY_EXIST(uLocal_290[iVar0]))
					{
						if (iLocal_486[iVar0] > 0)
						{
							if (GET_GAME_TIMER() > iLocal_486[iVar0] + 1000)
							{
								DELETE_OBJECT(&(uLocal_290[iVar0]));
								SET_OBJECT_AS_NO_LONGER_NEEDED(&(uLocal_290[iVar0]));
							}
	...
	while (iVar0 < 263)
	{
		if (IS_BIT_SET(Global_26140[iVar0 /*23*/].f_11, 0))
		{
			...
			else
			{
				...
				if (VDIST2(GET_ENTITY_COORDS(uParam0, 1), vVar1) < (fParam1 * fParam1))
				{
					return 1;
				}
				if (IS_BIT_SET(Global_26140[iVar0 /*23*/].f_11, 19))
				{
					iVar5 = 3;
					iVar4 = 0;
					while (iVar4 < iVar5)
					{
						vVar6 = { func_25(iVar0, iVar4) };
						if (!func_24(vVar6))
						{
							if (VDIST2(GET_ENTITY_COORDS(uParam0, 1), vVar6) < (fParam1 * fParam1))
							{
								return 1;
							}
						}
...
int func_26(int iParam0)
{
	...
	while (iVar1 < 1)
	{
		if (!func_28(vLocal_317[iVar1 /*3*/], 0f, 0f, 0f, 0))
		{
			if (func_27(PLAYER_PED_ID(), vLocal_299 + vLocal_313[iVar1 /*3*/], vLocal_317[iVar1 /*3*/], (fLocal_302 + fLocal_321[iVar1]), 0, 1, 0))
			{
				fVar2 = 50f;
...
int func_27(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7, int iParam8, int iParam9, int iParam10)
{
	vector3 vVar0;
	vector3 vVar3;
	...
	if (IS_ENTITY_IN_ANGLED_AREA(uParam0, vVar0, vVar3, (vParam4.y * 2f), iParam8, iParam9, iParam10))
	{
		return 1;
	}
	return 0;
...
int func_29(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_36(PLAYER_PED_ID()) && func_36(uParam0))
	{
...
int func_30(var uParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_31(var uParam0, float fParam1)
{
	...
	{
		if (func_32(uParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_32(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_34(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_34(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_33(vVar3, vVar0);
...
float func_33(vector3 vParam0, vector3 vParam3)
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}
...
int func_35(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (IS_PED_SHOOTING(PLAYER_PED_ID()))
...
int func_40()
{
	...
	if (Global_3)
	{
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
				...
				{
					if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uVar0))
					{
						return 0;
					}
				}
	...
	{
		if (!IS_PLAYER_SWITCH_IN_PROGRESS() && !func_41())
		{
			return 1;
		}
	}
...
void func_50()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_280)
		{
			...
			{
				REQUEST_MODEL(iLocal_286[iVar0]);
				if (!HAS_MODEL_LOADED(iLocal_286[iVar0]))
				{
					bVar2 = false;
					REQUEST_MODEL(iLocal_286[iVar0]);
				}
			...
			{
				REQUEST_MODEL(iLocal_293[iVar0]);
				if (!HAS_MODEL_LOADED(iLocal_293[iVar0]))
				{
					bVar2 = false;
					REQUEST_MODEL(iLocal_293[iVar0]);
				}
	...
	ADD_RELATIONSHIP_GROUP("FIGHTERS", &uLocal_289);
	iVar0 = 0;
	while (iVar0 < iLocal_280)
	{
		if (iLocal_286[iVar0] != 0)
		{
			iLocal_280[iVar0] = CREATE_PED(26, iLocal_286[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], 0, 1, 1);
			SET_ENTITY_HEADING(iLocal_280[iVar0], (fLocal_302 + fLocal_310[iVar0]));
			SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_280[iVar0], 0);
			if (iLocal_286[iVar0] == joaat("s_m_y_baywatch_01"))
			{
				if (GET_PED_DRAWABLE_VARIATION(iLocal_280[iVar0], 3) == 0)
				{
					if (GET_PED_DRAWABLE_VARIATION(iLocal_280[iVar0], 10) != 1)
					{
						SET_PED_COMPONENT_VARIATION(iLocal_280[iVar0], 10, 1, 0, 0);
					}
				}
				else if (GET_PED_DRAWABLE_VARIATION(iLocal_280[iVar0], 10) == 1)
				{
					if (GET_PED_DRAWABLE_VARIATION(iLocal_280[iVar0], 10) != 0)
					{
						SET_PED_COMPONENT_VARIATION(iLocal_280[iVar0], 10, 0, 0, 0);
					}
				}
			}
			SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_280[iVar0], uLocal_289);
			TASK_STAND_STILL(iLocal_280[iVar0], -1);
			if (iLocal_113 == 285)
			{
				SET_ENTITY_MAX_HEALTH(iLocal_280[iVar0], 105);
				SET_ENTITY_HEALTH(iLocal_280[iVar0], 105, 0);
			}
		}
		if (iLocal_293[iVar0] != 0)
		{
			uLocal_290[iVar0] = CREATE_OBJECT(iLocal_293[iVar0], vLocal_299 + vLocal_303[iVar0 /*3*/], 1, 1, 0);
			SET_ENTITY_HEADING(uLocal_290[iVar0], (fLocal_302 + fLocal_310[iVar0]));
			ATTACH_ENTITY_TO_ENTITY(uLocal_290[iVar0], iLocal_280[iVar0], GET_PED_BONE_INDEX(iLocal_280[iVar0], iLocal_296[iVar0]), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
		iVar0++;
	}
	SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_289, 1862763509);
...
void func_51()
{
	...
	iLocal_113 = Global_93085;
	func_55(iLocal_113, &vLocal_299, &fLocal_302, &cVar0);
	func_53(iLocal_113, &sLocal_323, &cLocal_339, &cLocal_355, &uVar8, &uVar9);
	...
	switch (iLocal_113)
	{
		...
		case 166:
			...
			fLocal_310[0] = GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
		...
		case 165:
			...
			Local_497 = { func_52("MICS3_IG_2", 3) };
			fLocal_501 = 0.2f;
			break;
		...
		case 259:
			vLocal_303[0 /*3*/] = { GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_303[1 /*3*/] = { GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			fLocal_310[0] = GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_310[1] = GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
		...
		default:
			...
			fLocal_321[0] = GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			break;
	}
}
...
void func_62()
{
	...
	while (iVar0 < iLocal_286)
	{
		if (iLocal_286[iVar0] != 0)
		{
			SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_286[iVar0]);
		}
		iVar0++;
	}
	REMOVE_RELATIONSHIP_GROUP(uLocal_289);
	SET_GAME_PAUSED(0);
