	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_104307[Var0 /*10*/].f_9 != -1)
			{
				...
				func_254(&(Global_104307[Var0 /*10*/].f_9));
			}
		}
		func_241(&Var0, 1);
	}
...
bool func_232(int iParam0, void fParam1)
{
...
int func_238(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	int iVar0;
...
int func_239(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
...
int func_240(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
