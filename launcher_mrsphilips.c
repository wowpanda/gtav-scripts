...
void __EntryFunction__()
{
	...
	iVar64[0] = 35;
	if (!func_241(&iVar64, &Var0, vVar61, 1f))
	{
		func_240();
	...
	func_229(&Var0);
	uLocal_92 = ADD_SCENARIO_BLOCKING_AREA(vVar61 - Vector(20f, 20f, 20f), vVar61 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
	...
	while (true)
	{
		...
		func_190(Var0);
		func_182(&iLocal_91, &(Var0.f_9), vVar61);
		if (func_167(&Var0, 0))
		{
			if (Var0 == 35)
			{
				if (iLocal_93 == 0)
				{
					if (!_DOES_DOOR_EXIST(1736361794))
					{
						ADD_DOOR_TO_SYSTEM(1736361794, joaat("v_ilev_trevtraildr"), 1972.77f, 3815.37f, 33.66f, 1, 1, 0);
					}
					if (_DOES_DOOR_EXIST(1736361794))
					{
						_SET_DOOR_AJAR_ANGLE(1736361794, 0f, 1, 0);
						_SET_DOOR_ACCELERATION_LIMIT(1736361794, 1, 1, 0);
						iLocal_93 = 1;
					}
				}
			}
...
int func_241(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_242((*iParam0)[0], vParam2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_242((*iParam0)[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_242(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_243(Var1.f_6, vParam1, fParam4, 0))
	{
