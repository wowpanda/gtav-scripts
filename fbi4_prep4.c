	...
	switch (iLocal_81)
	{
		case 0:
			...
			if (!IS_STRING_NULL_OR_EMPTY(sLocal_187))
			{
				...
				{
					while ((GET_GAME_TIMER() - iLocal_205) < 3000)
					{
						WAIT(0);
					}
				}
...
void func_22()
{
	switch (iLocal_81)
	{
		...
		case 1:
			if (func_87(PLAYER_PED_ID(), vLocal_200, 2f) && func_81(21))
			{
			...
			else
			{
				...
				if (bLocal_190)
				{
					iLocal_204 = GET_GAME_TIMER();
					iLocal_81 = 2;
				}
				else if (!func_87(PLAYER_PED_ID(), vLocal_197, 75f))
				{
					if (!iLocal_207)
					{
						func_21(&uLocal_192);
					...
					func_78(&uLocal_192, vLocal_200, 1, 1, "PRD_SHOP");
				}
				else if (func_87(PLAYER_PED_ID(), vLocal_200, 12f))
				{
					if (iLocal_207)
					{
						func_21(&uLocal_192);
					...
					func_78(&uLocal_192, vLocal_200, 1, 1, "PRD_BLIP");
					if (DOES_BLIP_EXIST(uLocal_192))
					{
						SET_BLIP_COLOUR(uLocal_192, 2);
						SET_BLIP_ROUTE_COLOUR(uLocal_192, 2);
					}
				}
			}
			break;
		...
		case 2:
			if ((GET_GAME_TIMER() - iLocal_204) > 2000)
			{
				func_21(&uLocal_192);
...
void func_78(var uParam0, vector3 vParam1, int iParam4, bool bParam5, char* sParam6)
{
	if (!DOES_BLIP_EXIST(*uParam0))
	{
		*uParam0 = func_79(vParam1, 5, iParam4);
		if (bParam5)
		{
...
int func_79(vector3 vParam0, int iParam3, var uParam4)
{
	int iVar0;
...
bool func_87(var uParam0, vector3 vParam1, float fParam4)
{
...
int func_88(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			if (bParam1)
			{
				func_89(PLAYER_PED_ID(), -1339.786f, -1277.51f, 3.8874f, 261.2839f);
				bLocal_28 = false;
				func_23(1, 1, 1);
			}
			else
		...
		case 2:
			if (bParam1)
			{
				func_89(PLAYER_PED_ID(), vLocal_200, 261.2839f);
				bLocal_28 = false;
				func_23(1, 1, 1);
			}
			else
...
void func_89(var uParam0, vector3 vParam1, float fParam4)
{
	if (func_228(uParam0))
	{
		CLEAR_PED_TASKS(uParam0);
	}
	func_90(uParam0, vParam1, fParam4, 0, 1);
}

int func_90(var uParam0, vector3 vParam1, var uParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
int func_91(int iParam0, vector3 vParam1, float fParam4)
{
	switch (iParam0)
	{
		case 0:
			if (func_92(vParam1, vLocal_194, 1056964608, 0) && fParam4 == 0f)
			{
				return 1;
			}
			break;
		...
		case 1:
			...
			REQUEST_ADDITIONAL_TEXT(sLocal_212, 6);
...
void func_94(var uParam0)
{
	...
	func_71(uParam0, iVar0, PLAYER_PED_ID(), sVar1, 0, 1);
}
...
void func_95()
{
	switch (iLocal_81)
	{
		...
		case 1:
			if (!iLocal_203)
			{
				if (func_87(PLAYER_PED_ID(), vLocal_197, 60f))
				{
		...
		case 3:
			func_89(PLAYER_PED_ID(), vLocal_200, 0f);
			func_23(1, 1, 1);
			iLocal_81 = 1;
			break;
	}
	...
	switch (iLocal_81)
	{
		case 0:
			if (func_88(iLocal_80, 0))
			{
				...
				if (func_264())
				{
					func_108(&uVar1, -1327.175f, -1290.811f, 3.8472f, 291.8355f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
					func_105(0, -1, 1);
					iVar0 = GET_GAME_TIMER();
					while (!func_104(21) && (GET_GAME_TIMER() - iVar0) < 2000)
					{
						WAIT(0);
					}
					func_24(500, 1);
...
void func_108(var uParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*uParam0 = func_188(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		...
		{
			func_176(iParam12, 0);
			while (!func_109(uParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				WAIT(0);
			}
		}
...
int func_109(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	var uVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam5, 0, 0, 0);
				...
				func_170(uParam0, &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam5, 0, 0, 0);
				...
				func_170(uParam0, &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				SET_VEHICLE_ENVEFF_SCALE(*uParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (GET_ENTITY_MODEL(*uParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (HAS_MODEL_LOADED(Var5))
			{
				...
				*uParam0 = CREATE_VEHICLE(Var5, vParam2, fParam5, 1, 1, 0);
				...
				func_170(uParam0, &(Var5.f_31), &(Var5.f_81));
				SET_VEHICLE_ENVEFF_SCALE(*uParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_110(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	if ((func_14(iParam0) && DOES_ENTITY_EXIST(*uParam1)) && IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_115(*uParam1, 0, &uVar0))
		{
			func_114(uParam1, &(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_106565.f_20112[iParam0 /*43*/].f_31 = func_113(*uParam1);
...
int func_115(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_143(iVar0, bParam1, uParam2) && !func_142(PLAYER_ID())) && !func_126(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_124(PLAYER_ID()) && (IS_THIS_MODEL_A_HELI(iVar0) || IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_122(iParam0)) && !bVar1) && !(func_121(GET_ENTITY_MODEL(iParam0)) && func_117(PLAYER_ID())))
	{
	...
	if (!NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_116(iParam0) && GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_141(PLAYER_ID()) || func_140(PLAYER_ID()))
	{
		if (func_127(iParam0))
		{
			return 1;
...
int func_130(int iParam0, bool bParam1)
{
	switch (GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_132(GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_143(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_124(PLAYER_ID()) && (IS_THIS_MODEL_A_HELI(iParam0) || IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_147(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_165(iParam0, 0, 0)) || func_165(iParam0, 1, 0)) || func_165(iParam0, 2, 0)) || func_164(iParam0) != 145) || func_163(iParam0)) || func_162(iParam0)) || func_116(iParam0)) || func_161(iParam0)) || !func_151(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_162(iParam0))
		{
		}
...
int func_170(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_139(GET_ENTITY_MODEL(*uParam0), 1) && GET_VEHICLE_MOD(*uParam0, 24) != func_173(*uParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*uParam0, 24, func_173(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_172(uParam0);
	if (func_171(*uParam0))
	{
...
void func_176(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_91043[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || GET_ENTITY_MODEL(Global_91043[iVar0]) == func_177(iParam0, iParam1))
				{
...
bool func_187(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
	...
	if (func_205(uParam0))
	{
		...
		if (func_204(uParam0))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_191(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && ARE_STRINGS_EQUAL(GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_191(var uParam0, vector3 vParam1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_192(uParam0, Global_70409.f_139[38], 0))
			{
				func_179(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_192(uParam0, Global_70409.f_139[43], 1))
			{
				func_179(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_192(uParam0, uVar1[iVar6], 1) && func_92(GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_187(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(uParam0, 1), GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_193(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_147(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_147(iVar1 + 1)))
			{
			}
			else
			{
				SET_BIT(&(uParam1->f_77), func_147(iVar1 + 1));
			}
		}
		...
		if (((IS_BIT_SET(uParam1->f_77, 15) || func_196(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_195())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
		{
			func_170(&uParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
		if (!IS_THIS_MODEL_A_HELI(uParam1->f_66) && !IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (IS_BIT_SET(uParam1->f_77, func_147(iVar2 + 1)))
				{
...
void func_215()
{
	if (!bLocal_28 && iLocal_80 != 3)
	{
		if (iLocal_80 > 0)
		{
			...
			if (!bLocal_190)
			{
				if (!func_87(PLAYER_PED_ID(), vLocal_197, 150f))
				{
					func_221(2);
				}
				else if (!func_87(PLAYER_PED_ID(), vLocal_197, 75f))
...
void func_234(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_236() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_236() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_235(iParam0));
...
int func_240(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_236() /*10778*/].f_6165.f_10, iParam0);
}
...
void func_263(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	if (func_264())
	{
...
int func_267(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_83(func_273(iParam1, uParam0->f_2), Global_71399, 0);
			if (IS_BIT_SET(uVar0, uParam0->f_1))
			{
				SET_BIT(&(uParam0->f_6), 2);
			}
...
int func_275(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_276(iParam0, iParam1, &iVar2, &uVar1, bParam2, bParam3))
	{
...
void func_278(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_271(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_271(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = _GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_279(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_337(var uParam0, var uParam1, float fParam2)
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_338(uParam1, *(uParam1[iVar1 /*3*/]) + vVar9))
		{
			vVar9 = { -vVar9 };
		}
...
void func_345(bool bParam0)
{
	...
	if (DOES_CAM_EXIST(uLocal_193))
	{
		RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
		DESTROY_CAM(uLocal_193, 0);
	}
}
