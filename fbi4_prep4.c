...
void func_22()
{
	switch (iLocal_81)
	{
		case 0:
			...
			{
				BRAIN::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), -1335.905f, -1278.671f, 5.07569f, -1, 0, 2);
				iLocal_81 = 1;
			}
			break;
...
int func_115(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_140(iVar0, bParam1, uParam2) && !func_139(PLAYER::PLAYER_ID())) && !func_124(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_122(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((((((VEHICLE::IS_BIG_VEHICLE(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("halftrack")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("phantom3")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("hauler2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("trailerlarge")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("trailersmall2")) && !bVar1) && !(func_121(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_117(PLAYER::PLAYER_ID())))
	{
		*uParam2 = 2;
		return 0;
	}
...
int func_126(int iParam0)
{
	...
	if (func_127(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_128(int iParam0, bool bParam1)
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_130(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_140(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_122(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_162(iParam0, 0, 0)) || func_162(iParam0, 1, 0)) || func_162(iParam0, 2, 0)) || func_161(iParam0) != 145) || func_160(iParam0)) || func_159(iParam0)) || func_116(iParam0)) || func_158(iParam0)) || !func_148(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_159(iParam0))
		{
		}
...
int func_167(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_136(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_170(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_170(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_169(iParam0);
	if (func_168(*iParam0))
	{
...
void func_173(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90431[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90431[iVar0]) == func_174(iParam0, iParam1))
				{
...
void func_175(vector3 vParam0, float fParam1, bool bParam2)
{
	int iVar0;
...
bool func_184(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
{
	return func_186(&(Global_98783.f_2875), vParam0, fParam1, 0);
}

int func_186(var uParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
...
int func_188(int iParam0, vector3 vParam1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_189(iParam0, uVar1[iVar3], 1) && func_92(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_184(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
...
void func_190(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_193(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_192())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_144(iVar2 + 1)))
				{
...
int func_194(int iParam0)
{
	...
	{
		if (!func_200(PLAYER::PLAYER_ID(), -1))
		{
	...
	if (func_196(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
	...
	if (func_223())
	{
		switch (func_11())
		{
			case 0:
				...
				{
					func_222(sLocal_202[0], sLocal_202[1], sLocal_202[2]);
				}
				else if (Global_105220.f_2354.f_539.f_2375[1] == -99)
				{
					func_222(sLocal_202[1], sLocal_202[0], sLocal_202[2]);
				}
				else if (Global_105220.f_2354.f_539.f_2375[2] == -99)
				{
					func_222(sLocal_202[2], sLocal_202[1], sLocal_202[0]);
				}
				break;
...
void func_222(char* sParam0, char* sParam1, char* sParam2)
{
...
void func_231(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_105220.f_20535.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_233() /*12171*/].f_7688.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_105220.f_20535.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_233() /*12171*/].f_7688.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_232(iParam0));
...
bool func_236(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_233() /*12171*/].f_7688.f_10, iParam0);
}
...
void func_259(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_260())
	{
...
void func_266(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_274(iVar7, iParam0, 155);
			return;
			break;
	}
	func_267(&(Global_70793[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_83(func_270(iParam1, uParam0->f_2), Global_70790, 0);
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_267(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
		...
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_267(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
void func_333(var uParam0, var uParam1, float fParam2)
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_334(uParam1, *(uParam1[iVar1 /*3*/]) + vVar5))
		{
			vVar5 = { -vVar5 };
		}
...
bool func_334(var uParam0, struct<2> Param1, Vector3 vParam2)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_336(var uParam0, vector3 vParam1)
{
	if (uParam0->f_51 == 0)
	{
	}
