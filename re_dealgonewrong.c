...
void __EntryFunction__()
{
	...
	{
		WAIT(0);
		if ((IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -1503.54f, 4934.923f, 114.2284f, 100f, 100f, 100f, 0, 1, 0)) || iLocal_47 == 2)
		{
			if (!func_127())
			{
				if (func_126())
				...
				case 2:
					switch (iLocal_46)
					{
						...
						case 1:
								...
								if (!func_78())
								{
									...
									while (iVar0 < 4)
									{
										if (bLocal_267)
										{
											...
											func_72(uLocal_176[0], GET_VEHICLE_PED_IS_USING(PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &vLocal_113, &uLocal_112, &uLocal_116, 0f, 0f, 0f, 1000, 0f);
											func_72(uLocal_176[1], GET_VEHICLE_PED_IS_USING(PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &vLocal_113, &uLocal_112, &uLocal_116, 0f, 2f, 0f, 1000, 0f);
										...
										else if (bLocal_264)
										{
											...
											func_72(uLocal_166[0], GET_VEHICLE_PED_IS_USING(PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &vLocal_113, &uLocal_112, &uLocal_116, 0f, 0f, 0f, 1000, 0f);
											func_72(uLocal_166[1], GET_VEHICLE_PED_IS_USING(PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &vLocal_113, &uLocal_112, &uLocal_116, 0f, 5f, 0f, 1000, 0f);
										...
										else if (bLocal_265)
										{
											...
											func_72(uLocal_171[0], GET_VEHICLE_PED_IS_USING(PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &vLocal_113, &uLocal_112, &uLocal_116, 0f, 0f, 0f, 1000, 0f);
											func_72(uLocal_171[1], GET_VEHICLE_PED_IS_USING(PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &vLocal_113, &uLocal_112, &uLocal_116, 0f, 5f, 0f, 1000, 0f);
							...
							if (((IS_PED_ON_FOOT(PLAYER_PED_ID()) || IS_PED_IN_FLYING_VEHICLE(PLAYER_PED_ID())) && !IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_234, 100f, 100f, 100f, 0, 1, 0)) && iLocal_48 < 2)
							{
								func_44();
							}
							break;
...
void func_1()
{
	...
	if (iLocal_455 && !iLocal_262)
	{
		...
		if (DOES_BLIP_EXIST(uLocal_182))
		{
			REMOVE_BLIP(&uLocal_182);
		}
		iVar0 = 0;
		while (iVar0 < 4)
		{
			...
			if (iLocal_48 >= 6)
			{
				if (IS_PED_INJURED(PLAYER_PED_ID()))
				{
					...
					{
						if (IS_ENTITY_AT_ENTITY(uLocal_150[iVar0], PLAYER_PED_ID(), 100f, 100f, 100f, 0, 1, 0))
						{
							bLocal_266 = true;
						}
					}
		...
		while (iVar0 < 4)
		{
			...
			if (iLocal_48 >= 6)
			{
				if (IS_PED_INJURED(PLAYER_PED_ID()))
				{
					if (!IS_PED_INJURED(uLocal_155[iVar0]))
					{
						if (IS_ENTITY_AT_ENTITY(uLocal_155[iVar0], PLAYER_PED_ID(), 100f, 100f, 100f, 0, 1, 0))
						{
							bLocal_266 = true;
						}
					}
...
void func_40()
{
	...
	{
		if (func_43(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
...
void func_51()
{
	...
	if (!DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_71590)
		{
			if (func_52() == 2 == 0 && !NETWORK_IS_GAME_IN_PROGRESS())
			{
	...
	if (DOES_ENTITY_EXIST(*uParam2))
	{
		if (IS_VEHICLE_DRIVEABLE(*uParam2, 0))
		{
			...
			if (!DOES_BLIP_EXIST(*uParam3))
			{
				if (iVar0 == 1)
				{
					*uParam3 = func_68(GET_ENTITY_COORDS(*uParam2, 1), 0);
...
var func_68(vector3 vParam0, int iParam3)
{
	var uVar0;
	
	uVar0 = ADD_BLIP_FOR_COORD(vParam0);
	SET_BLIP_SCALE(uVar0, func_69(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
int func_71(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_69(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
void func_72(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, vector3 vParam7, int iParam10, float fParam11)
{
	vector3 vVar0;
	
	if (DOES_ENTITY_EXIST(iParam0) && IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (((((((DOES_ENTITY_EXIST(iParam1) && iParam0 != iParam1) && !IS_THIS_MODEL_A_BOAT(GET_ENTITY_MODEL(iParam1))) && !IS_THIS_MODEL_A_PLANE(GET_ENTITY_MODEL(iParam1))) && !IS_THIS_MODEL_A_HELI(GET_ENTITY_MODEL(iParam1))) && !IS_THIS_MODEL_A_TRAIN(GET_ENTITY_MODEL(iParam1))) && IS_VEHICLE_ON_ALL_WHEELS(iParam1)) && func_76(iParam0))
		{
			...
			{
				if (func_74(iParam0, iParam1, 1) > fParam11 && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(iParam1, 1), *uParam2, 1) > 20f)
				{
					if (!func_73(*uParam2))
					{
						...
						{
							vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(vLocal_113, uLocal_112, vParam7) };
							if (!func_73(vVar0))
							{
								if (!IS_SPHERE_VISIBLE(vVar0, 2f))
								{
									...
									SET_ENTITY_HEADING(iParam0, uLocal_112);
									SET_VEHICLE_ON_GROUND_PROPERLY(iParam0, 1084227584);
									SET_VEHICLE_FORWARD_SPEED(iParam0, 10f);
									SET_VEHICLE_ENGINE_ON(iParam0, 1, 1, 0);
									*uParam6 = GET_GAME_TIMER();
...
int func_78()
{
	...
	while (iVar1 < 4)
	{
		if (DOES_ENTITY_EXIST(uLocal_150[iVar1]))
		{
			if (!IS_PED_INJURED(uLocal_150[iVar1]))
			{
				if (IS_ENTITY_AT_ENTITY(uLocal_150[iVar1], PLAYER_PED_ID(), 200f, 200f, 200f, 0, 1, 0))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < 4)
	{
		if (DOES_ENTITY_EXIST(uLocal_155[iVar1]))
		{
			if (!IS_PED_INJURED(uLocal_155[iVar1]))
			{
				if (IS_ENTITY_AT_ENTITY(uLocal_155[iVar1], PLAYER_PED_ID(), 200f, 200f, 200f, 0, 1, 0))
				{
					iVar0 = 0;
				}
			}
...
void func_79()
{
	...
	if (bLocal_456)
	{
		...
		{
			if (!IS_PED_INJURED(uLocal_150[0]) && !IS_ENTITY_DEAD(uLocal_166[0], 0))
			{
			}
			if (!IS_PED_INJURED(uLocal_150[1]) && !IS_ENTITY_DEAD(uLocal_166[1], 0))
			{
			}
		}
		else
		{
			if (!IS_PED_INJURED(uLocal_155[0]) && !IS_ENTITY_DEAD(uLocal_171[0], 0))
			{
			}
			if (!IS_PED_INJURED(uLocal_155[1]) && !IS_ENTITY_DEAD(uLocal_171[1], 0))
			{
			}
		}
		iVar0 = 0;
		while (iVar0 < 4)
		{
			...
			else if (!IS_PED_IN_ANY_VEHICLE(uLocal_150[iVar0], 0))
			{
				if (!DOES_BLIP_EXIST(uLocal_194[iVar0]))
				{
		...
		while (iVar0 < 4)
		{
			...
			else if (!IS_PED_IN_ANY_VEHICLE(uLocal_155[iVar0], 0))
			{
				if (!DOES_BLIP_EXIST(uLocal_199[iVar0]))
				{
	...
	{
		case 0:
			if (((_0x5FC472C501CCADB3(PLAYER_ID()) || !IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_234 + Vector(0f, 20f, 0f), 170f, 270f, 50f, 0, 1, 0)) || IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -1555.4f, 4730.817f, 49.1791f, 15f, 25f, 15f, 0, 1, 0)) || IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -1709.211f, 4659.571f, 36.688f, 15f, 25f, 15f, 0, 1, 0))
			{
				if (!bLocal_267)
				{
					if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -1555.4f, 4730.817f, 49.1791f, 15f, 25f, 15f, 0, 1, 0) || IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -1709.211f, 4659.571f, 36.688f, 15f, 25f, 15f, 0, 1, 0))
					{
						bLocal_267 = true;
					}
				}
				if (GET_CLOSEST_VEHICLE_NODE(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), &vLocal_240, 1, 1077936128, 0))
				{
					if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_240, 20f, 20f, 20f, 0, 1, 0))
					{
						ENABLE_DISPATCH_SERVICE(5, 1);
						ENABLE_DISPATCH_SERVICE(3, 1);
						SETTIMERA(0);
		...
		case 2:
			if (bLocal_267)
			{
				if (TIMERA() > 3500)
				{
					if (((!IS_ENTITY_DEAD(uLocal_176[0], 0) && !IS_ENTITY_DEAD(uLocal_176[1], 0)) && !IS_PED_INJURED(uLocal_150[0])) && !IS_PED_INJURED(uLocal_150[1]))
					{
						SET_PED_INTO_VEHICLE(uLocal_150[0], uLocal_176[0], -1);
						SET_PED_INTO_VEHICLE(uLocal_150[1], uLocal_176[1], -1);
						SET_PED_COMBAT_ATTRIBUTES(uLocal_150[0], 3, 0);
						SET_PED_COMBAT_ATTRIBUTES(uLocal_150[1], 3, 0);
						SET_PED_HELMET(uLocal_150[0], 0);
						SET_PED_HELMET(uLocal_150[1], 0);
						iLocal_48 = 5;
					}
				}
			}
			if (TIMERA() > 10000)
			{
				...
				{
					if (!IS_PED_IN_MODEL(PLAYER_PED_ID(), joaat("rebel")))
					{
						iLocal_48 = 3;
					}
					else
		...
		case 3:
			vLocal_243 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
			uLocal_132 = GET_RANDOM_INT_IN_RANGE(10, 15);
			if (!IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -1603.153f, 4892.943f, 60.1768f, 225f, 225f, 50f, 0, 1, 0))
			{
				if (GET_NTH_CLOSEST_VEHICLE_NODE(vLocal_243, uLocal_132, &(vLocal_439[0 /*3*/]), 1, 1077936128, 0))
				{
					vLocal_439[1 /*3*/] = { vLocal_439[0 /*3*/] + Vector(0f, 5f, 0f) };
					if (!IS_SPHERE_VISIBLE(vLocal_439[0 /*3*/], 7f) && !IS_SPHERE_VISIBLE(vLocal_439[1 /*3*/], 7f))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_166[0], 0))
						{
							SET_ENTITY_COORDS(uLocal_166[0], vLocal_439[0 /*3*/], 1, 0, 0, 1);
							func_91(uLocal_166[0], uLocal_150[0]);
						}
						if (IS_VEHICLE_DRIVEABLE(uLocal_166[1], 0))
						{
							SET_ENTITY_COORDS(uLocal_166[1], vLocal_439[1 /*3*/], 1, 0, 0, 1);
		...
		case 4:
			vLocal_243 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
			uLocal_132 = GET_RANDOM_INT_IN_RANGE(30, 35);
			if (!IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -1603.153f, 4892.943f, 60.1768f, 225f, 225f, 50f, 0, 1, 0))
			{
				if (GET_NTH_CLOSEST_VEHICLE_NODE(vLocal_243, uLocal_132, &(vLocal_439[0 /*3*/]), 1, 1077936128, 0))
				{
					...
					if (!IS_SPHERE_VISIBLE(vLocal_439[0 /*3*/], 7f) && !IS_SPHERE_VISIBLE(vLocal_439[1 /*3*/], 7f))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_171[0], 0))
						{
							SET_ENTITY_COORDS(uLocal_171[0], vLocal_439[0 /*3*/], 1, 0, 0, 1);
							func_91(uLocal_171[0], uLocal_155[0]);
						}
						if (IS_VEHICLE_DRIVEABLE(uLocal_171[1], 0))
						{
							SET_ENTITY_COORDS(uLocal_171[1], vLocal_439[1 /*3*/], 1, 0, 0, 1);
		...
		case 5:
			vLocal_243 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
			uLocal_132 = GET_RANDOM_INT_IN_RANGE(5, 10);
			if (GET_NTH_CLOSEST_VEHICLE_NODE(vLocal_243, uLocal_132, &(vLocal_439[0 /*3*/]), 1, 1077936128, 0))
			{
				vLocal_439[1 /*3*/] = { vLocal_439[0 /*3*/] + Vector(0f, 5f, 0f) };
				if (!IS_SPHERE_VISIBLE(vLocal_439[0 /*3*/], 7f) && !IS_SPHERE_VISIBLE(vLocal_439[1 /*3*/], 7f))
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_176[0], 0))
					{
						SET_ENTITY_COORDS(uLocal_176[0], vLocal_439[0 /*3*/], 1, 0, 0, 1);
						func_91(uLocal_176[0], uLocal_150[0]);
					}
					if (IS_VEHICLE_DRIVEABLE(uLocal_176[1], 0))
					{
						SET_ENTITY_COORDS(uLocal_176[1], vLocal_439[1 /*3*/], 1, 0, 0, 1);
		...
		case 6:
			if (func_66())
			{
				...
				if (iLocal_134 < 5 && iLocal_135 < GET_GAME_TIMER())
				{
					vLocal_90 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
					SHOOT_SINGLE_BULLET_BETWEEN_COORDS((vLocal_90.x + fLocal_120), (vLocal_90.y + fLocal_121), (vLocal_90.z + fLocal_122), (vLocal_90.x - fLocal_120), (vLocal_90.y - fLocal_121), vLocal_90.z, 10, 0, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
					iLocal_135 = (GET_GAME_TIMER() + GET_RANDOM_INT_IN_RANGE(200, 500));
					iLocal_134++;
				}
			}
			if (iLocal_134 > 4)
...
void func_91(var uParam0, var uParam1)
{
	...
	vLocal_436 = { GET_ENTITY_COORDS(uParam0, 1) };
	vLocal_452 = { vLocal_243 - vLocal_436 };
	SET_ENTITY_HEADING(uParam0, GET_HEADING_FROM_VECTOR_2D(vLocal_452.x, vLocal_452.y));
	if (bLocal_267)
	{
		if (!IS_PED_INJURED(uParam1))
		{
			if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
				TASK_VEHICLE_CHASE(uParam1, PLAYER_PED_ID());
				WAIT(1);
				if (!IS_PED_INJURED(uParam1))
				{
					SET_TASK_VEHICLE_CHASE_BEHAVIOR_FLAG(uParam1, 32, 1);
				}
			}
			else
			{
				TASK_VEHICLE_MISSION_PED_TARGET(uParam1, uParam0, PLAYER_PED_ID(), 6, 20f, 786469, -1f, -1f, 1);
			}
			if (!IS_ENTITY_DEAD(uParam0, 0))
			{
				SET_VEHICLE_FORWARD_SPEED(uParam0, GET_ENTITY_SPEED(PLAYER_PED_ID()));
			}
		}
	}
	else if (!IS_PED_INJURED(uParam1))
	{
		...
		{
			TASK_VEHICLE_MISSION_PED_TARGET(uParam1, uParam0, PLAYER_PED_ID(), 2, 100f, 786469, -1f, -1f, 1);
		}
		SET_VEHICLE_FORWARD_SPEED(uParam0, GET_ENTITY_SPEED(PLAYER_PED_ID()));
	}
}
...
void func_92()
{
	...
	uLocal_166[0] = CREATE_VEHICLE(joaat("rebel"), -1595.964f, 4732.479f, 0f, 305f, 1, 1, 0);
	SET_ENTITY_AS_MISSION_ENTITY(uLocal_166[0], 1, 0);
	SET_VEHICLE_ENGINE_ON(uLocal_166[0], 1, 1, 0);
	SET_VEHICLE_LIGHTS(uLocal_166[0], 2);
	SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_166[0], 1);
	FREEZE_ENTITY_POSITION(uLocal_166[0], 1);
	SET_VEHICLE_NUMBER_PLATE_TEXT(uLocal_166[0], "49GNL112");
	uLocal_166[1] = CREATE_VEHICLE(joaat("rebel"), -1570.34f, 4733.755f, 0f, 305f, 1, 1, 0);
	SET_ENTITY_AS_MISSION_ENTITY(uLocal_166[1], 1, 0);
	SET_VEHICLE_ENGINE_ON(uLocal_166[1], 1, 1, 0);
	SET_VEHICLE_LIGHTS(uLocal_166[1], 2);
	SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_166[1], 1);
	FREEZE_ENTITY_POSITION(uLocal_166[1], 1);
	SET_VEHICLE_NUMBER_PLATE_TEXT(uLocal_166[1], "47TMS703");
	uLocal_176[0] = CREATE_VEHICLE(joaat("sanchez"), Vector(0f, 4732.479f, -1595.964f) + Vector(10f, 10f, 10f), 305f, 1, 1, 0);
	SET_ENTITY_AS_MISSION_ENTITY(uLocal_176[0], 1, 0);
	SET_VEHICLE_ENGINE_ON(uLocal_176[0], 1, 1, 0);
	SET_VEHICLE_LIGHTS(uLocal_176[0], 2);
	SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_176[0], 1);
	FREEZE_ENTITY_POSITION(uLocal_176[0], 1);
	SET_VEHICLE_NUMBER_PLATE_TEXT(uLocal_176[0], "49GNL112");
	uLocal_176[1] = CREATE_VEHICLE(joaat("sanchez"), Vector(0f, 4733.755f, -1570.34f) + Vector(10f, 10f, 10f), 305f, 1, 1, 0);
	SET_ENTITY_AS_MISSION_ENTITY(uLocal_176[1], 1, 0);
	SET_VEHICLE_ENGINE_ON(uLocal_176[1], 1, 1, 0);
	SET_VEHICLE_LIGHTS(uLocal_176[1], 2);
	SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_176[1], 1);
	FREEZE_ENTITY_POSITION(uLocal_176[1], 1);
	SET_VEHICLE_NUMBER_PLATE_TEXT(uLocal_176[1], "47TMS703");
	uLocal_150[0] = CREATE_PED_INSIDE_VEHICLE(uLocal_166[0], 26, joaat("g_m_m_chigoon_02"), -1, 1, 1);
	uLocal_150[1] = CREATE_PED_INSIDE_VEHICLE(uLocal_166[1], 26, joaat("g_m_m_chigoon_02"), -1, 1, 1);
	if (!bLocal_267)
	{
		uLocal_150[2] = CREATE_PED_INSIDE_VEHICLE(uLocal_166[0], 26, joaat("g_m_m_chigoon_02"), 0, 1, 1);
		uLocal_150[3] = CREATE_PED_INSIDE_VEHICLE(uLocal_166[1], 26, joaat("g_m_m_chigoon_02"), 0, 1, 1);
	}
	uLocal_171[0] = CREATE_VEHICLE(joaat("bobcatxl"), -1356.281f, 5000f, 0f, 125.2811f, 1, 1, 0);
	SET_ENTITY_AS_MISSION_ENTITY(uLocal_171[0], 1, 0);
	SET_VEHICLE_ENGINE_ON(uLocal_171[0], 1, 1, 0);
	SET_VEHICLE_LIGHTS(uLocal_171[0], 2);
	SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_171[0], 1);
	FREEZE_ENTITY_POSITION(uLocal_171[0], 1);
	SET_VEHICLE_NUMBER_PLATE_TEXT(uLocal_171[0], "49GNL112");
	uLocal_171[1] = CREATE_VEHICLE(joaat("bobcatxl"), -1373.589f, 5000f, 0f, 125.459f, 1, 1, 0);
	SET_ENTITY_AS_MISSION_ENTITY(uLocal_171[1], 1, 0);
	SET_VEHICLE_ENGINE_ON(uLocal_171[1], 1, 1, 0);
	SET_VEHICLE_LIGHTS(uLocal_171[1], 2);
	SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_171[1], 1);
	FREEZE_ENTITY_POSITION(uLocal_171[1], 1);
	SET_VEHICLE_NUMBER_PLATE_TEXT(uLocal_171[1], "47TMS703");
	uLocal_155[0] = CREATE_PED_INSIDE_VEHICLE(uLocal_171[0], 26, joaat("g_m_y_salvagoon_03"), -1, 1, 1);
	uLocal_155[1] = CREATE_PED_INSIDE_VEHICLE(uLocal_171[1], 26, joaat("g_m_y_salvagoon_03"), -1, 1, 1);
	uLocal_155[2] = CREATE_PED_INSIDE_VEHICLE(uLocal_171[0], 26, joaat("g_m_y_salvagoon_03"), 0, 1, 1);
	uLocal_155[3] = CREATE_PED_INSIDE_VEHICLE(uLocal_171[1], 26, joaat("g_m_y_salvagoon_03"), 0, 1, 1);
	ADD_RELATIONSHIP_GROUP("RE_deal1", &uLocal_268);
	ADD_RELATIONSHIP_GROUP("RE_deal2", &uLocal_269);
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (!IS_PED_INJURED(uLocal_150[iVar0]))
		{
			SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_150[iVar0], uLocal_268);
			SET_ENTITY_AS_MISSION_ENTITY(uLocal_150[iVar0], 1, 0);
			if (bLocal_267)
			{
				GIVE_WEAPON_TO_PED(uLocal_150[0], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
				if (!IS_PED_INJURED(uLocal_150[1]))
				{
					GIVE_WEAPON_TO_PED(uLocal_150[1], joaat("weapon_pistol"), -1, 1, 1);
				}
				SET_PED_ACCURACY(uLocal_150[iVar0], 15);
				SET_PED_COMBAT_ATTRIBUTES(uLocal_150[iVar0], 3, 0);
			}
			else
			{
				GIVE_WEAPON_TO_PED(uLocal_150[iVar0], joaat("weapon_pistol"), -1, 1, 1);
				SET_PED_ACCURACY(uLocal_150[iVar0], 13);
			}
			SET_PED_COMBAT_ATTRIBUTES(uLocal_150[iVar0], 13, 1);
			SET_PED_COMBAT_ATTRIBUTES(uLocal_150[iVar0], 2, 1);
			SET_PED_COMBAT_ATTRIBUTES(uLocal_150[iVar0], 1, 1);
	...
	while (iVar0 < 4)
	{
		if (!IS_PED_INJURED(uLocal_150[iVar0]))
		{
			SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_155[iVar0], uLocal_269);
			SET_ENTITY_AS_MISSION_ENTITY(uLocal_155[iVar0], 1, 0);
			if (bLocal_267)
			{
				GIVE_WEAPON_TO_PED(uLocal_150[0], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
				if (!IS_PED_INJURED(uLocal_150[1]))
			...
			{
				GIVE_WEAPON_TO_PED(uLocal_155[iVar0], joaat("weapon_pistol"), -1, 1, 1);
				SET_PED_ACCURACY(uLocal_155[iVar0], 13);
				func_93(&uLocal_271, 5, uLocal_155[iVar0], "REDGWSalvadoran", 0, 1);
			}
			SET_PED_COMBAT_ATTRIBUTES(uLocal_155[iVar0], 13, 1);
			SET_PED_COMBAT_ATTRIBUTES(uLocal_155[iVar0], 2, 1);
			SET_PED_COMBAT_ATTRIBUTES(uLocal_155[iVar0], 1, 1);
		}
		iVar0++;
	}
	SET_RELATIONSHIP_BETWEEN_GROUPS(3, uLocal_268, uLocal_269);
	SET_RELATIONSHIP_BETWEEN_GROUPS(3, uLocal_269, uLocal_268);
	SET_RELATIONSHIP_BETWEEN_GROUPS(3, uLocal_268, 1862763509);
	SET_RELATIONSHIP_BETWEEN_GROUPS(3, uLocal_269, 1862763509);
...
void func_94()
{
	...
	switch (iLocal_130)
	{
		case 0:
			if (bLocal_264)
			{
				...
				while (iVar0 < 4)
				{
					if (!IS_PED_INJURED(uLocal_150[iVar0]))
					{
						if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_150[iVar0], 100f, 100f, 20f, 0, 1, 0))
						{
							iLocal_130 = 3;
						}
					}
			...
			if (bLocal_265)
			{
				...
				while (iVar1 < 4)
				{
					if (!IS_PED_INJURED(uLocal_155[iVar1]))
					{
						if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_155[iVar1], 100f, 100f, 20f, 0, 1, 0))
						{
							iLocal_130 = 3;
						}
					}
		...
		case 3:
			SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_268, uLocal_269);
			SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_269, uLocal_268);
			SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_268, 1862763509);
			SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_269, 1862763509);
			if (bLocal_264)
			{
				iVar2 = 0;
				while (iVar2 < 4)
				{
					if (!IS_PED_INJURED(uLocal_150[iVar2]))
					{
						if ((!IS_PED_IN_COMBAT(uLocal_150[iVar2], 0) && GET_SCRIPT_TASK_STATUS(uLocal_150[iVar2], 579380604) != 1) && GET_SCRIPT_TASK_STATUS(uLocal_150[iVar2], 579380604) != 0)
						{
							CLEAR_PED_TASKS(uLocal_150[iVar2]);
							TASK_COMBAT_PED(uLocal_150[iVar2], PLAYER_PED_ID(), 0, 16);
							SET_PED_KEEP_TASK(uLocal_150[iVar2], 1);
						}
					}
					iVar2++;
				}
			...
			if (bLocal_265)
			{
				...
				while (iVar3 < 4)
				{
					if (!IS_PED_INJURED(uLocal_155[iVar3]))
					{
						if ((!IS_PED_IN_COMBAT(uLocal_155[iVar3], 0) && GET_SCRIPT_TASK_STATUS(uLocal_155[iVar3], 579380604) != 1) && GET_SCRIPT_TASK_STATUS(uLocal_155[iVar3], 579380604) != 0)
						{
							CLEAR_PED_TASKS(uLocal_155[iVar3]);
							TASK_COMBAT_PED(uLocal_155[iVar3], PLAYER_PED_ID(), 0, 16);
							SET_PED_KEEP_TASK(uLocal_155[iVar3], 1);
						}
					}
					iVar3++;
				}
...
void func_95()
{
	...
	{
		case 0:
			if (!IS_PED_INJURED(uLocal_136))
			{
				if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_237, 7f, 7f, 10f, 0, 1, 0))
				{
					func_97();
					WAIT(0);
					func_80(&uLocal_271, "REDGWAU", "REDGW_NTOUCH", 4, 0, 0, 0);
					TASK_LOOK_AT_ENTITY(uLocal_136, PLAYER_PED_ID(), -1, 2048, 2);
					if (!DOES_BLIP_EXIST(uLocal_182))
					{
	...
	switch (iLocal_129)
	{
		case 1:
			if (!IS_PED_INJURED(uLocal_136))
			{
				if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_136, 10f, 10f, 6f, 0, 1, 0))
				{
					if (!func_66())
					{
		...
		case 2:
			if (!func_66() || TIMERB() > 4000)
			{
				if (!IS_PED_INJURED(uLocal_136))
				{
					SET_ENTITY_HEALTH(uLocal_136, 0, 0);
					REMOVE_BLIP(&uLocal_183);
				}
				if (TIMERB() > 7000)
				{
					if (!IS_PED_INJURED(uLocal_137[6]))
					{
						SET_ENTITY_HEALTH(uLocal_137[6], 0, 0);
						REMOVE_BLIP(&(uLocal_184[6]));
					}
				}
				if (TIMERB() > 9000)
				{
					if (!IS_PED_INJURED(uLocal_137[7]))
					{
						SET_ENTITY_HEALTH(uLocal_137[7], 0, 0);
...
void func_99()
{
	...
	if (HAS_PICKUP_BEEN_COLLECTED(uLocal_214))
	{
		if (DOES_BLIP_EXIST(uLocal_181))
		{
			REMOVE_BLIP(&uLocal_181);
	...
	else
	{
		...
		while (iVar0 < 9)
		{
			if (DOES_ENTITY_EXIST(uLocal_137[iVar0]))
			{
				if (!IS_PED_INJURED(uLocal_137[iVar0]))
				{
					if (iVar0 == 0)
					{
					}
		...
		{
			if (!IS_PED_INJURED(iLocal_147[iVar0]))
			{
			}
			iVar0++;
		}
		if (!func_127())
		{
			if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_52[7 /*3*/], 110f, 95f, 40f, 0, 1, 0))
			{
				if (DOES_BLIP_EXIST(uLocal_181))
				{
					REMOVE_BLIP(&uLocal_181);
				}
				if ((!DOES_BLIP_EXIST(uLocal_183) && !DOES_BLIP_EXIST(uLocal_184[6])) && !DOES_BLIP_EXIST(uLocal_184[7]))
				{
					uLocal_183 = func_70(uLocal_136, 1, 145);
					uLocal_184[6] = func_70(uLocal_137[6], 1, 145);
					uLocal_184[7] = func_70(uLocal_137[7], 1, 145);
				}
				_0x75A16C3DA34F1245(uLocal_183, 0);
				_0x75A16C3DA34F1245(uLocal_184[6], 0);
				_0x75A16C3DA34F1245(uLocal_184[7], 0);
				func_100(1);
			}
		}
		if (!IS_PED_INJURED(uLocal_137[6]))
		{
			if (((((GET_SCRIPT_TASK_STATUS(uLocal_137[6], 1785177548) != 1 && GET_SCRIPT_TASK_STATUS(uLocal_137[6], 1785177548) != 0) || IS_ENTITY_ON_FIRE(uLocal_137[6])) || IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), uLocal_137[6])) || HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uLocal_137[6])) || HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uLocal_137[6]))
			{
				SET_ENTITY_HEALTH(uLocal_137[6], 0, 0);
			}
		}
		if (!IS_PED_INJURED(uLocal_137[7]))
		{
			if (((((GET_SCRIPT_TASK_STATUS(uLocal_137[7], 1785177548) != 1 && GET_SCRIPT_TASK_STATUS(uLocal_137[7], 1785177548) != 0) || IS_ENTITY_ON_FIRE(uLocal_137[7])) || IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), uLocal_137[7])) || HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uLocal_137[7])) || HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uLocal_137[7]))
			{
				SET_ENTITY_HEALTH(uLocal_137[7], 0, 0);
			}
		}
		if (!IS_PED_INJURED(uLocal_136))
		{
			if (((((GET_SCRIPT_TASK_STATUS(uLocal_136, 1785177548) != 1 && GET_SCRIPT_TASK_STATUS(uLocal_136, 1785177548) != 0) || IS_ENTITY_ON_FIRE(uLocal_136)) || IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), uLocal_136)) || HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uLocal_136)) || HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uLocal_136))
			{
				SET_ENTITY_HEALTH(uLocal_136, 0, 0);
			}
		}
	...
	switch (iLocal_131)
	{
		case 0:
			if (!IS_PED_INJURED(uLocal_137[6]))
			{
				if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), GET_ENTITY_COORDS(uLocal_137[6], 1) + Vector(0f, 2.5f, 0f), 9f, 5f, 5f, 0, 1, 0) && HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(PLAYER_PED_ID(), uLocal_137[6]))
				{
					TASK_LOOK_AT_ENTITY(uLocal_137[6], PLAYER_PED_ID(), -1, 2048, 2);
					TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), uLocal_137[6], 4000, 2048, 2);
			...
			if (!IS_PED_INJURED(uLocal_137[7]))
			{
				if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), GET_ENTITY_COORDS(uLocal_137[7], 1) + Vector(0f, 3f, 0f), 9f, 7f, 5f, 0, 1, 0) && HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(PLAYER_PED_ID(), uLocal_137[7]))
				{
					TASK_LOOK_AT_ENTITY(uLocal_137[7], PLAYER_PED_ID(), -1, 2048, 2);
					TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), uLocal_137[7], 4000, 2048, 2);
					func_80(&uLocal_271, "REDGWAU", "REDGW_NDIE1", 4, 0, 0, 0);
					iLocal_127 = GET_GAME_TIMER();
					iLocal_131 = 1;
				}
			}
			if (IS_PED_INJURED(uLocal_137[6]) && IS_PED_INJURED(uLocal_137[7]))
			{
				iLocal_131 = 2;
			}
			break;
		...
		case 1:
			if (DOES_BLIP_EXIST(uLocal_183))
			{
				_0x75A16C3DA34F1245(uLocal_183, 1);
			}
			if (DOES_BLIP_EXIST(uLocal_184[6]))
			{
				_0x75A16C3DA34F1245(uLocal_184[6], 1);
			}
			if (DOES_BLIP_EXIST(uLocal_184[7]))
			{
				_0x75A16C3DA34F1245(uLocal_184[7], 1);
			}
...
int func_104()
{
	switch (func_105(&Global_25824, 0, 5, 0, GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
void func_110()
{
	...
	if (!IS_ENTITY_DEAD(uLocal_160[0], 0))
	{
		if (GET_PED_IN_VEHICLE_SEAT(uLocal_160[0], -1, 0) == uLocal_137[8])
		{
			_0x9D3AF56E94C9AE98(uLocal_160[0], 60000f);
			_SOUND_VEHICLE_HORN_THIS_FRAME(uLocal_160[0]);
		}
	}
	if (!IS_PED_INJURED(uLocal_136))
	{
		if (IS_PED_RAGDOLL(uLocal_136))
		{
			SET_ENTITY_HEALTH(uLocal_136, 0, 0);
		}
	}
	else if (DOES_BLIP_EXIST(uLocal_183))
	{
		REMOVE_BLIP(&uLocal_183);
	}
	iVar0 = 0;
	while (iVar0 < 9)
	{
		if (!IS_SPHERE_VISIBLE(vLocal_234, 30f) && VDIST(func_2(PLAYER_ID()), vLocal_234) > 300f)
		{
			if (DOES_ENTITY_EXIST(uLocal_137[iVar0]))
			{
				SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_137[iVar0]));
			}
		}
		if (IS_PED_INJURED(uLocal_137[iVar0]))
		{
...
void func_111()
{
	...
	REQUEST_MODEL(joaat("g_m_m_chigoon_02"));
	REQUEST_MODEL(joaat("g_m_y_salvagoon_03"));
	...
	if ((((((((HAS_MODEL_LOADED(joaat("g_m_m_chigoon_02")) && HAS_MODEL_LOADED(joaat("g_m_y_salvagoon_03"))) && HAS_MODEL_LOADED(joaat("rebel"))) && HAS_MODEL_LOADED(joaat("bobcatxl"))) && HAS_MODEL_LOADED(joaat("sanchez"))) && HAS_MODEL_LOADED(joaat("a_c_rottweiler"))) && HAS_MODEL_LOADED(joaat("prop_security_case_01"))) && HAS_ANIM_DICT_LOADED("random@dealgonewrong")) && HAS_ANIM_DICT_LOADED("random@dealgonewrongdead_peds"))
	{
		ADD_SCENARIO_BLOCKING_AREA(vLocal_234 - Vector(150f, 150f, 150f), vLocal_234 + Vector(150f, 150f, 150f), 0, 1, 1, 1);
		SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("bobcatxl"), 1);
		SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("rebel"), 1);
		ENABLE_DISPATCH_SERVICE(5, 0);
		ENABLE_DISPATCH_SERVICE(3, 0);
		uLocal_160[0] = CREATE_VEHICLE(joaat("bobcatxl"), -1626.94f, 4729.889f, 51.3463f, 347.1188f, 1, 1, 0);
		SET_ENTITY_AS_MISSION_ENTITY(uLocal_160[0], 1, 0);
		SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_160[0], 1084227584);
		SET_VEHICLE_ENGINE_ON(uLocal_160[0], 1, 1, 0);
		SET_VEHICLE_LIGHTS(uLocal_160[0], 2);
		SET_VEHICLE_ENGINE_HEALTH(uLocal_160[0], 500f);
		SET_VEHICLE_PETROL_TANK_HEALTH(uLocal_160[0], 500f);
		SET_VEHICLE_EXTRA(uLocal_160[0], 1, 1);
		SET_VEHICLE_TYRE_BURST(uLocal_160[0], 0, 0, 1148846080);
		SMASH_VEHICLE_WINDOW(uLocal_160[0], 6);
		SET_VEH_RADIO_STATION(uLocal_160[0], "RADIO_06_COUNTRY");
		SET_VEHICLE_NUMBER_PLATE_TEXT(uLocal_160[0], "76JON418");
		SET_VEHICLE_RADIO_ENABLED(uLocal_160[0], 1);
		uLocal_160[1] = CREATE_VEHICLE(joaat("rebel"), -1619.432f, 4747.792f, 52.7502f, 146.6017f, 1, 1, 0);
		SET_ENTITY_AS_MISSION_ENTITY(uLocal_160[1], 1, 0);
		SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_160[1], 1084227584);
		SET_VEHICLE_ENGINE_ON(uLocal_160[1], 1, 1, 0);
		SET_VEHICLE_LIGHTS(uLocal_160[1], 2);
		SET_VEHICLE_ENGINE_HEALTH(uLocal_160[1], 600f);
		SET_VEHICLE_PETROL_TANK_HEALTH(uLocal_160[1], 400f);
		SET_VEHICLE_EXTRA(uLocal_160[1], 1, 1);
		SET_VEHICLE_EXTRA(uLocal_160[1], 2, 1);
		SET_VEHICLE_EXTRA(uLocal_160[1], 3, 0);
		SET_VEHICLE_EXTRA(uLocal_160[1], 4, 0);
		SMASH_VEHICLE_WINDOW(uLocal_160[1], 6);
		SET_VEH_RADIO_STATION(uLocal_160[1], "RADIO_06_COUNTRY");
		SET_VEHICLE_NUMBER_PLATE_TEXT(uLocal_160[1], "79ERK121");
		SET_VEHICLE_RADIO_ENABLED(uLocal_160[1], 1);
		SET_VEHICLE_RADIO_LOUD(uLocal_160[1], 1);
		uLocal_160[2] = CREATE_VEHICLE(joaat("bobcatxl"), -1636.216f, 4748.061f, 51.5484f, 199.3236f, 1, 1, 0);
		SET_VEHICLE_NUMBER_PLATE_TEXT(uLocal_160[2], "83JOH802");
		SET_ENTITY_AS_MISSION_ENTITY(uLocal_160[2], 1, 0);
		SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_160[2], 1084227584);
		SET_VEHICLE_ENGINE_ON(uLocal_160[2], 1, 1, 0);
		SET_VEHICLE_LIGHTS(uLocal_160[2], 2);
		SET_VEHICLE_ENGINE_HEALTH(uLocal_160[2], 60f);
		SET_VEHICLE_PETROL_TANK_HEALTH(uLocal_160[2], 1000f);
		SET_VEHICLE_EXTRA(uLocal_160[2], 1, 0);
		SET_VEHICLE_TYRE_BURST(uLocal_160[2], 1, 0, 1148846080);
		uLocal_160[3] = CREATE_VEHICLE(joaat("rebel"), -1641.578f, 4736.783f, 52.5984f, 278.1865f, 1, 1, 0);
		SET_VEHICLE_NUMBER_PLATE_TEXT(uLocal_160[3], "85TOR114");
		SET_ENTITY_AS_MISSION_ENTITY(uLocal_160[3], 1, 0);
		SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_160[3], 1084227584);
		SET_VEHICLE_ENGINE_ON(uLocal_160[3], 1, 1, 0);
		SET_VEHICLE_LIGHTS(uLocal_160[3], 2);
		SET_VEHICLE_ENGINE_HEALTH(uLocal_160[3], 500f);
		SET_VEHICLE_PETROL_TANK_HEALTH(uLocal_160[3], 500f);
		SET_VEHICLE_EXTRA(uLocal_160[3], 1, 0);
		SET_VEHICLE_EXTRA(uLocal_160[3], 2, 0);
		SET_VEHICLE_EXTRA(uLocal_160[3], 3, 0);
		SET_VEHICLE_EXTRA(uLocal_160[3], 4, 0);
		SET_VEHICLE_TYRE_BURST(uLocal_160[3], 0, 0, 1148846080);
		SET_VEHICLE_TYRE_BURST(uLocal_160[3], 5, 0, 1148846080);
		if (!DOES_PICKUP_EXIST(uLocal_214))
		{
			iVar0 = 0;
			SET_BIT(&iVar0, 1);
			SET_BIT(&iVar0, 3);
			SET_BIT(&iVar0, 4);
			uLocal_214 = CREATE_PICKUP_ROTATE(joaat("pickup_money_case"), vLocal_237, -72f, 0f, 42.48f, iVar0, 25000, 2, 1, joaat("prop_security_case_01"));
		...
		while (iVar1 < 5)
		{
			if (!DOES_PICKUP_EXIST(uLocal_215[iVar1]))
			{
				iVar2 = 0;
				SET_BIT(&iVar2, 3);
				SET_BIT(&iVar2, 4);
				if (iVar1 < 2)
				{
					uLocal_215[iVar1] = CREATE_PICKUP(joaat("pickup_weapon_sawnoffshotgun"), vLocal_246[iVar1 /*3*/], iVar2, -1, 1, 0);
				}
				else if (iVar1 == 4)
				{
					uLocal_215[iVar1] = CREATE_PICKUP_ROTATE(joaat("pickup_weapon_assaultrifle"), vLocal_246[iVar1 /*3*/], 90f, 50f, 0f, 0, 50, 2, 1, 0);
				}
				else
				{
					uLocal_215[iVar1] = CREATE_PICKUP(joaat("pickup_weapon_pistol"), vLocal_246[iVar1 /*3*/], iVar2, -1, 1, 0);
				}
			}
			iVar1++;
		}
		...
		while (iVar1 < 6)
		{
			if (iVar1 <= 3)
			{
				uLocal_137[iVar1] = CREATE_PED(22, joaat("g_m_y_salvagoon_03"), vLocal_52[iVar1 /*3*/], fLocal_80[iVar1], 1, 1);
				SET_PED_CONFIG_FLAG(uLocal_137[iVar1], 227, 1);
			}
			else
			{
				uLocal_137[iVar1] = CREATE_PED(22, joaat("g_m_m_chigoon_02"), vLocal_52[iVar1 /*3*/], fLocal_80[iVar1], 1, 1);
			}
			iVar1++;
		}
		iLocal_147[0] = CREATE_PED(26, joaat("a_c_rottweiler"), -1635.005f, 4737.181f, 53.4995f, 33.4155f, 1, 1);
		iLocal_147[1] = CREATE_PED(26, joaat("a_c_rottweiler"), -1625.215f, 4741.119f, 52.5762f, 316.2733f, 1, 1);
		iVar1 = 0;
		while (iVar1 < iLocal_147)
		{
			SET_PED_CAN_RAGDOLL(iLocal_147[iVar1], 1);
			SET_ENTITY_COLLISION(iLocal_147[iVar1], 1, 0);
			SET_PED_CONFIG_FLAG(iLocal_147[iVar1], 227, 1);
			vLocal_90 = { GET_ENTITY_COORDS(iLocal_147[iVar1], 1) };
			vLocal_93 = { vLocal_90.x, (vLocal_90.y - 2f), (vLocal_90.z - 0.5f) };
			vLocal_96 = { vLocal_90.x, (vLocal_90.y + 50f), (vLocal_90.z - 0.5f) };
			SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vLocal_93, vLocal_96, 100, 1, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
			iVar1++;
		}
		TASK_PLAY_ANIM_ADVANCED(uLocal_137[0], "random@dealgonewrongdead_peds", "ped_b", -1635.928f, 4707.941f, 46.383f, -29.25f, 12.25f, 171.75f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		TASK_PLAY_ANIM_ADVANCED(uLocal_137[1], "random@dealgonewrongdead_peds", "ped_a", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		TASK_PLAY_ANIM_ADVANCED(uLocal_137[2], "random@dealgonewrongdead_peds", "ped_b", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		TASK_PLAY_ANIM_ADVANCED(uLocal_137[3], "random@dealgonewrongdead_peds", "ped_c", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		TASK_PLAY_ANIM_ADVANCED(uLocal_137[4], "random@dealgonewrongdead_peds", "ped_d", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		TASK_PLAY_ANIM_ADVANCED(uLocal_137[5], "random@dealgonewrongdead_peds", "ped_e", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		TASK_PLAY_ANIM_ADVANCED(iLocal_147[0], "random@dealgonewrongdead_peds", "dog_a", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		TASK_PLAY_ANIM_ADVANCED(iLocal_147[1], "random@dealgonewrongdead_peds", "dog_b", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
		_0x46D1A61A21F566FC(50f);
		func_113();
		_0x46D1A61A21F566FC(1f);
		if (IS_VEHICLE_DRIVEABLE(uLocal_160[0], 0))
		{
			uLocal_137[8] = CREATE_PED_INSIDE_VEHICLE(uLocal_160[0], 26, joaat("g_m_y_salvagoon_03"), -1, 1, 1);
			SET_ENTITY_AS_MISSION_ENTITY(uLocal_137[8], 1, 0);
			SET_PED_PLAYS_HEAD_ON_HORN_ANIM_WHEN_DIES_IN_VEHICLE(uLocal_137[8], 1);
			SET_ENTITY_HEALTH(uLocal_137[8], 0, 0);
		}
		if (!DOES_BLIP_EXIST(uLocal_181))
		{
		}
		ADD_RELATIONSHIP_GROUP("re_DealGoneWrong", &uLocal_270);
		uLocal_137[6] = CREATE_PED(22, joaat("g_m_m_chigoon_02"), vLocal_52[6 /*3*/], fLocal_80[6], 1, 1);
		func_93(&uLocal_271, 4, uLocal_137[6], "REDGWChinese", 0, 1);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_137[6], 1);
		SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_137[6], 1);
		SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_137[6], uLocal_270);
		uVar3 = CREATE_SYNCHRONIZED_SCENE(vLocal_52[6 /*3*/] + Vector(1.05f, 0f, 0f), -7f, 0f, 34.1111f, 0);
		TASK_SYNCHRONIZED_SCENE(uLocal_137[6], uVar3, "random@dealgonewrong", "base", 8f, -8f, 5, 0, 1148846080, 0);
		SET_SYNCHRONIZED_SCENE_LOOPED(uVar3, 1);
		SET_PED_KEEP_TASK(uLocal_137[6], 1);
		SET_PED_CONFIG_FLAG(uLocal_137[6], 227, 1);
		uLocal_137[7] = CREATE_PED(22, joaat("g_m_y_salvagoon_03"), -1640.311f, 4738.4f, 50.2f, fLocal_80[7], 1, 1);
		func_93(&uLocal_271, 5, uLocal_137[7], "REDGWSalvadoran", 0, 1);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_137[7], 1);
		SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_137[7], 1);
		SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_137[7], uLocal_270);
		uVar4 = CREATE_SYNCHRONIZED_SCENE(vLocal_52[7 /*3*/] + Vector(0.92f, 0.65f, -0.65f), 0f, 0f, 34.1111f, 0);
		TASK_SYNCHRONIZED_SCENE(uLocal_137[7], uVar4, "random@dealgonewrong", "idle_a", 8f, -8f, 5, 0, 1148846080, 0);
		SET_SYNCHRONIZED_SCENE_LOOPED(uVar4, 1);
		SET_SYNCHRONIZED_SCENE_PHASE(uVar4, 0.5f);
		SET_PED_KEEP_TASK(uLocal_137[7], 1);
		SET_PED_CONFIG_FLAG(uLocal_137[7], 227, 1);
		uLocal_136 = CREATE_PED(22, joaat("g_m_m_chigoon_02"), vLocal_117, fLocal_123, 1, 1);
		func_93(&uLocal_271, 4, uLocal_136, "REDGWChinese", 0, 1);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_136, 1);
		SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_136, uLocal_270);
		uVar5 = CREATE_SYNCHRONIZED_SCENE(vLocal_117, 7.5f, -12.75f, 51.5f, 0);
		TASK_SYNCHRONIZED_SCENE(uLocal_136, uVar5, "random@dealgonewrong", "idle_b", 8f, -8f, 5, 0, 1148846080, 0);
		SET_SYNCHRONIZED_SCENE_LOOPED(uVar5, 1);
		SET_ENTITY_ROTATION(uLocal_136, 4f, 18f, 326.7277f, 0, 1);
		SET_PED_KEEP_TASK(uLocal_136, 1);
		SET_PED_CONFIG_FLAG(uLocal_136, 227, 1);
		SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_270, 1862763509);
		if (func_39() == 0)
		{
			func_93(&uLocal_271, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
		}
		if (func_39() == 1)
		{
			func_93(&uLocal_271, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		}
		if (func_39() == 2)
		{
			func_93(&uLocal_271, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
		}
		uLocal_221[0] = ADD_DECAL(1110, -1632.953f, 4745.359f, 51.7876f, 0f, 0f, -1f, func_112(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		WAIT(0);
		uLocal_221[1] = ADD_DECAL(1110, -1634.87f, 4744.458f, 51.8233f, 0f, 0f, -1f, func_112(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		WAIT(0);
		uLocal_221[2] = ADD_DECAL(1110, -1636.971f, 4736.595f, 52.2814f, 0f, 0f, -1f, func_112(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		WAIT(0);
		uLocal_221[3] = ADD_DECAL(1110, -1625.561f, 4741.241f, 51.7102f, 0f, 0f, -1f, func_112(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		WAIT(0);
		uLocal_221[4] = ADD_DECAL(1110, -1621.533f, 4744.576f, 51.9093f, 0f, 0f, -1f, func_112(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		WAIT(0);
		uLocal_221[5] = ADD_DECAL(1110, -1621.963f, 4737.039f, 51.4174f, 0f, 0f, -1f, func_112(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		WAIT(0);
		uLocal_221[6] = ADD_DECAL(1110, -1628.517f, 4736.906f, 51.8207f, 0f, 0f, -1f, func_112(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		WAIT(0);
		uLocal_221[7] = ADD_DECAL(1110, -1629.324f, 4732.146f, 51.6947f, 0f, 0f, -1f, func_112(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		WAIT(0);
		uLocal_221[8] = ADD_DECAL(1110, -1640.287f, 4738.437f, 52.1756f, 0f, 0f, -1f, func_112(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		WAIT(0);
		uLocal_221[9] = ADD_DECAL(1110, -1640.055f, 4701.995f, 41.2428f, 0f, 0f, -1f, func_112(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		WAIT(0);
		uLocal_221[10] = ADD_DECAL(1110, -1641.924f, 4692.236f, 38.3762f, 0f, 0f, -1f, func_112(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		iVar1 = 0;
		while (iVar1 < 6)
		{
			if (!IS_ENTITY_DEAD(uLocal_137[iVar1], 0))
			{
				SET_PED_CAN_RAGDOLL(uLocal_137[iVar1], 1);
				APPLY_PED_BLOOD_DAMAGE_BY_ZONE(uLocal_137[iVar1], 0, 0.3f, 0.6f, 3);
				APPLY_PED_BLOOD_DAMAGE_BY_ZONE(uLocal_137[iVar1], 0, 0.65f, 0.6f, 3);
...
void func_113()
{
	...
	{
		WAIT(0);
		if (DOES_ENTITY_EXIST(uLocal_160[iVar0]))
		{
			vLocal_99 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_160[iVar0], 0f, 0f, 0.5f) };
		}
		iLocal_133 = 0;
		while (iLocal_133 < 5)
		{
			...
			SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vLocal_102, vLocal_105, 1, 0, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
			vLocal_102 = { (vLocal_99.x + fLocal_120), (vLocal_99.y + fLocal_121), (vLocal_99.z + fLocal_122) };
			vLocal_105 = { (vLocal_99.x - fLocal_120), (vLocal_99.y - fLocal_121), vLocal_99.z };
			SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vLocal_102, vLocal_105, 1, 0, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
			vLocal_102 = { (vLocal_99.x + fLocal_120), (vLocal_99.y - fLocal_121), (vLocal_99.z + fLocal_122) };
...
int func_114()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		if (VMAG2(GET_ENTITY_VELOCITY(PLAYER_PED_ID())) > 1369f && !func_125())
		{
			return 0;
		}
	}
...
int func_127()
{
	if ((Global_106554 == func_63() && GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
int func_131(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_145(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_148()
{
	...
	func_154(&uVar0, GET_CLOCK_SECONDS());
	func_153(&uVar0, GET_CLOCK_MINUTES());
	func_152(&uVar0, GET_CLOCK_HOURS());
	func_151(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_150(&uVar0, GET_CLOCK_MONTH());
	func_149(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_165()) || Global_105612) || Global_25767) || func_164()) || func_88(8, -1)) || func_163()) || func_162()) || func_161()) || func_160()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_165()) || Global_25767) || func_164()) || func_88(8, -1)) || func_161()) || func_163()) || func_162()) || func_160()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_165()) || Global_105612) || Global_25767) || func_164()) || func_88(8, -1)) || func_163()) || func_162()) || func_160()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_165() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_88(8, -1)) || func_160()) || func_159()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_165()) || Global_25767) || func_164()) || func_88(8, -1)) || func_162()) || func_161()) || func_160()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_165()) || Global_105612) || Global_25767) || func_164()) || func_88(8, -1)) || func_161()) || func_159()) || func_163()) || func_162()) || func_160())
						{
							return 0;
						}
						break;
