...
void __EntryFunction__()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("ambient_sonar")) > 1)
	{
...
void func_1()
{
	...
	if (func_105(PLAYER_PED_ID()))
	{
		if (IS_PLAYER_PLAYING(PLAYER_ID()))
		{
			...
			{
				uLocal_386 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
				func_121(1);
				func_13(0);
				if (func_105(PLAYER_PED_ID()))
				{
			...
			{
				if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(uLocal_386, 1)) > 62500f)
				{
					func_5();
				}
				else if (!DOES_BLIP_EXIST(uLocal_387))
				{
					uLocal_387 = func_2(uLocal_386, 0, 0);
					SET_BLIP_SPRITE(uLocal_387, 308);
				}
			}
			else
			{
...
int func_3(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_4(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		SET_BLIP_SCALE(uVar0, func_4(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
{
	func_7();
	if (DOES_ENTITY_EXIST(uLocal_386))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_386);
	}
}
...
void func_7()
{
	if (DOES_BLIP_EXIST(uLocal_387))
	{
		REMOVE_BLIP(&uLocal_387);
	}
}
...
void func_9(vector3 vParam0, bool bParam3, bool bParam4)
{
	...
	CLEAR_BIT(&Global_2424, 30);
	if (bParam3)
	{
		SET_BIT(&Global_2424, 29);
	}
	else
	{
		CLEAR_BIT(&Global_2424, 29);
	}
	if (bParam4)
	{
		SET_BIT(&Global_2425, 1);
	}
	else
	{
		CLEAR_BIT(&Global_2425, 1);
	}
}
	...
	if (*uParam0)
	{
		switch (*iParam4)
		{
			...
			case 1:
				...
				ADD_TEXT_COMPONENT_INTEGER(func_81(iParam3));
				END_TEXT_COMMAND_SCALEFORM_STRING();
...
int func_81(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (IS_BIT_SET(Global_106565.f_10043.f_108, func_83(func_84(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
void func_86(int iParam0, bool bParam1)
{
	...
	{
		if (!bParam1 && !IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
		{
...
int func_89(var uParam0, var uParam1, vector3 vParam2)
{
	...
	if ((uParam1[iVar0 /*11*/])->f_10)
	{
		...
		{
			if (HAS_PICKUP_BEEN_COLLECTED((uParam1[iVar0 /*11*/])->f_1) || func_101((uParam1[iVar0 /*11*/])->f_1))
			{
...
void func_93()
{
	...
	iVar3 = 0;
	STAT_GET_INT(func_94(0), &iVar0, -1);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_48(18, iVar0);
	}
	STAT_GET_INT(func_94(1), &iVar0, -1);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_48(19, iVar0);
	}
	STAT_GET_INT(func_94(3), &iVar0, -1);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_48(20, iVar0);
