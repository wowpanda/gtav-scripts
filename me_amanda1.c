...
void __EntryFunction__()
{
	...
	fLocal_227 = "stand_loop_car";
	fLocal_228 = "arrest_cop";
	fLocal_229 = "arrest_owner";
	sLocal_230 = "arrest_ama";
	fLocal_231 = "arrest_car";
	fLocal_232 = "pst_arrest_loop_cop";
	fLocal_233 = "pst_arrest_loop_owner";
	...
	iLocal_244 = -1;
	iLocal_245 = -1;
	fLocal_277 = "rcmme_amanda1";
	fLocal_278 = "move_characters@amanda@bag";
...
void func_1()
{
	...
	else if (func_520(iLocal_296) && func_520(PLAYER::PLAYER_PED_ID()))
	{
...
void func_4(bool bParam0, bool bParam1)
{
	...
	{
		if (func_520(iLocal_296) && PED::IS_PED_IN_GROUP(iLocal_296))
		{
		...
		else if (func_520(iLocal_296) && ENTITY::IS_ENTITY_AT_COORD(iLocal_296, vLocal_282, 50f, 50f, 50f, false, true, 0))
		{
			func_11(iLocal_296);
		}
		else
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_302))
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_302))
		{
			...
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_302);
				BRAIN::TASK_WANDER_STANDARD(iLocal_302, 1193033728, 0);
			}
		}
		if (bParam0)
		{
...
void func_21(int iParam0)
{
	...
	if (Global_105220.f_9056 || func_33(0))
	{
		iVar0 = func_32();
		if (!func_22(iVar0))
		{
...
void func_23(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_25(Global_105220.f_18504[iVar0], &vVar2, &fVar3))
			{
...
void func_29()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_13(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_14(iVar0) && (!func_30(14) || Global_104171))
			{
...
void func_35()
{
	...
	if (func_520(PLAYER::PLAYER_PED_ID()) && func_520(iLocal_296))
	{
		...
		switch (iLocal_293)
		{
			case 0:
				...
				{
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_296, 0);
					BRAIN::OPEN_SEQUENCE_TASK(&iVar2);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2f, 20000, 0.25f, 0, 1193033728);
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 3000);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_239, 1f, 20000, 0.25f, 0, 1193033728);
					BRAIN::CLOSE_SEQUENCE_TASK(iVar2);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_296, iVar2);
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_296, 0) && func_8(iVar0))
				{
					if (!func_51(iLocal_296, -828834893))
					{
						if (VEHICLE::IS_VEHICLE_STOPPED(iVar0))
						{
							...
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_296, iVar3);
...
void func_37(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_33(0) && Global_71224.f_1 == 1) && func_38(Global_71224))
		{
		}
		else
		{
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_70793[1 /*14*/] = { func_120(iVar10, iParam1, iParam2) };
		if (!func_119(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_70793[1 /*14*/] = { func_120(iVar10, iVar0, uVar11[iVar0]) };
				if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_70793[1 /*14*/] = { func_120(iVar10, 14, uVar12[iVar1]) };
							func_90(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
							func_112(14);
							if (Global_70791 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_80(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_80(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_80(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
						}
						func_112(iVar0);
						if (Global_70791 == 1)
						{
			...
			{
				Global_70793[1 /*14*/] = { func_120(iVar10, iVar0, func_79(iParam0, iVar0, -1)) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_70793[1 /*14*/] = { func_120(iVar10, 14, uVar15[iVar1]) };
			func_90(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
			func_112(14);
			if (Global_70791 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_80(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_80(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_80(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
		}
		if (Global_70791 == 1)
		{
			iVar2 = 0;
...
int func_71(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_184(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_64, Global_105220.f_2354.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_70793[1 /*14*/] = { func_120(iParam0, iParam1, iParam2) };
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_184(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_61, Global_105220.f_2354.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_80(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_97(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_80(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_105(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[0], Global_105220.f_2354.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_105(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[1], Global_105220.f_2354.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_105(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[2], Global_105220.f_2354.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_92(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_92(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_92(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_92(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_112(int iParam0)
{
	...
	{
		func_118(iParam0, Global_70793[1 /*14*/].f_5, Global_70793[1 /*14*/].f_2, 2, Global_70793[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_114(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_115(iParam2)];
	if (iVar0 != 0)
	{
...
int func_116(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_115(iParam1)];
...
void func_122(int iParam0)
{
	...
	func_123(&(Global_70793[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_123(var uParam0, int iParam1, int iParam2, void fParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_116(func_126(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_116(func_125(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_116(iVar1, Global_70790, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_129(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_123(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_123(&(Global_70793[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_123(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_80(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_123(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_184(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_70793[1 /*14*/] = { func_120(iVar0, iParam1, iParam2) };
	if (!MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_184(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_184(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_70793[2 /*14*/] = { func_120(iVar0, 14, iVar4) };
									if (Global_70793[2 /*14*/].f_12 == iVar3)
									{
										if (func_184(iParam0, 14, iVar4))
										{
											if (!func_76(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_70793[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_70793[2 /*14*/] = { func_120(iVar0, iVar2, iVar1) };
						if (!func_76(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_70793[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_70793[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_80(iParam1)) && Global_70793[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_80(iParam1)))
	{
		return 1;
	}
	return 0;
		...
		switch (iLocal_293)
		{
			case 0:
				...
				else
				{
					...
					BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_296);
					...
					BRAIN::OPEN_SEQUENCE_TASK(&iVar3);
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 3000);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_238, 1f, 20000, 0.25f, 0, 1193033728);
					BRAIN::CLOSE_SEQUENCE_TASK(iVar3);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_296, iVar3);
					BRAIN::CLEAR_SEQUENCE_TASK(&iVar3);
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_296, 0) && func_8(iVar0))
				{
					if (!func_51(iLocal_296, 242628503))
					{
						if (VEHICLE::IS_VEHICLE_STOPPED(iVar0))
						{
							...
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_296, iVar4);
...
{
	func_226();
	func_221(&uLocal_343, &uLocal_55, "MEA1AUD", &sLocal_344, &fLocal_350);
	switch (iLocal_293)
	{
		case 0:
			func_34(&iLocal_295);
...
void func_205()
{
	...
	{
		if ((((func_520(PLAYER::PLAYER_PED_ID()) && func_520(iLocal_296)) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_296, 0)) && !func_208()) && func_212(PLAYER::PLAYER_PED_ID(), iLocal_296) < 10f)
		{
...
void func_206(int iParam0, void fParam1, void fParam2, int iParam3)
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, fParam1, fParam2, func_207(iParam3), 0);
}
...
void func_209()
{
	if (((func_9(iLocal_298) && func_520(iLocal_296)) && PED::IS_PED_IN_VEHICLE(iLocal_296, iLocal_298, 0)) && func_212(PLAYER::PLAYER_PED_ID(), iLocal_296) < 10f)
	{
...
bool func_210(void fParam0, int iParam1, void fParam2)
{
...
void func_218(void fParam0, int iParam1, int iParam2)
{
	iParam2 = iParam2;
...
void func_221(var uParam0, var uParam1, char* sParam2, char* sParam3, void fParam4)
{
	switch (*uParam0)
	{
		case 0:
		...
		case 2:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
			{
				...
				{
					if (func_222(uParam1, sParam2, sParam3, fParam4, 8, 1, 0))
					{
						*uParam0 = 3;
					}
				}
		...
		case 4:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && func_222(uParam1, sParam2, sParam3, fParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
bool func_222(var uParam0, char* sParam1, char* sParam2, void fParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_227()
{
	...
	switch (iLocal_293)
	{
		case 0:
			...
			if (func_251())
			{
				if (STREAMING::HAS_ANIM_DICT_LOADED(fLocal_278))
				{
					PED::SET_PED_MOVEMENT_CLIPSET(iLocal_296, fLocal_278, 1048576000);
				}
...
void func_228()
{
	if (func_520(iLocal_306) && func_212(PLAYER::PLAYER_PED_ID(), iLocal_306) > 100f)
	{
		func_16(&iLocal_306, 0, 0, 1);
	}
	if (func_520(iLocal_302) && func_212(PLAYER::PLAYER_PED_ID(), iLocal_302) > 100f)
	{
...
void func_229()
{
	...
	if (((iLocal_337 && !HUD::IS_MESSAGE_BEING_DISPLAYED()) && func_520(PLAYER::PLAYER_PED_ID())) && func_520(iLocal_296))
	{
...
void func_237()
{
	...
	if (func_520(PLAYER::PLAYER_PED_ID()) && MISC::GET_GAME_TIMER() > iLocal_311)
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
		...
		else if (!func_208())
		{
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_298, 0) && PED::IS_PED_IN_VEHICLE(iLocal_296, iLocal_298, 0))
			{
				if (func_252(&uLocal_55, "MEA1AUD", "MEA1_LOSTCOP", "MEA1_LOSTCOP_1", "MEA1_LOSTCOP", "MEA1_LOSTCOP_2", "MEA1_LOSTCOP", "MEA1_LOSTCOP_3", "MEA1_LOSTCOP", "MEA1_LOSTCOP_4", 7, 1, 0) || func_52(&iLocal_332, 5000))
				{
					...
					BRAIN::TASK_LOOK_AT_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_298, 2f, 2f, 0f), 2000, 2050, 4);
					...
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_296, iVar0);
...
int func_255(int iParam0)
{
	...
	if ((func_520(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_8(iParam0))
	{
		iVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
		if (func_8(iVar0))
		{
...
void func_257()
{
	if (func_520(iLocal_296) && !PED::IS_PED_GROUP_MEMBER(iLocal_296, func_220()))
	{
		if (func_8(iLocal_298))
		{
...
void func_258()
{
	if (((((func_520(PLAYER::PLAYER_PED_ID()) && func_520(iLocal_302)) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_302)) && !BRAIN::IS_PED_GETTING_UP(iLocal_302)) && !PED::IS_PED_PRONE(iLocal_302)) && !PED::IS_PED_RAGDOLL(iLocal_302))
	{
		if (MISC::GET_GAME_TIMER() > iLocal_291)
		{
			...
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_302);
				BRAIN::TASK_ARREST_PED(iLocal_302, PLAYER::PLAYER_PED_ID());
...
void func_262()
{
	if (func_520(iLocal_306) && !func_51(iLocal_306, 1805844857))
	{
		if ((func_264(iLocal_306, 1090519040, 1097859072) || PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID())) || (func_520(iLocal_302) && PED::IS_PED_SHOOTING(iLocal_302)))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_306, fLocal_277, fLocal_229, 2) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_306, fLocal_277, fLocal_233, 2))
			{
				ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_306, -8f, 1);
			}
			BRAIN::TASK_SMART_FLEE_PED(iLocal_306, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			func_263(1);
		}
	}
}
...
{
	if (((((func_520(iLocal_302) && func_520(PLAYER::PLAYER_PED_ID())) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_302)) && !BRAIN::IS_PED_GETTING_UP(iLocal_302)) && !PED::IS_PED_PRONE(iLocal_302)) && !PED::IS_PED_RAGDOLL(iLocal_302))
	{
		if (!func_5(iLocal_302) == joaat("weapon_pistol"))
		{
			PED::SET_PED_CAN_SWITCH_WEAPON(iLocal_302, true);
	...
	if ((func_520(iLocal_306) && !PED::IS_PED_FLEEING(iLocal_306)) && !PED::IS_PED_IN_COMBAT(iLocal_306, 0))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_306, fLocal_277, fLocal_229, 2) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_306, fLocal_277, fLocal_233, 2))
		{
			ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_306, -8f, 1);
...
void func_270()
{
	...
	if (func_520(iLocal_302) && func_520(iLocal_306))
	{
		func_221(&uLocal_343, &uLocal_55, "MEA1AUD", &sLocal_344, &fLocal_350);
	}
	switch (iLocal_293)
	{
		case 0:
			...
			iLocal_293 = 1;
			func_307(Global_88138[0 /*10*/].f_7, 1, 0);
			func_300();
			break;
		...
		case 1:
			...
			func_296();
			func_292();
			if (((func_520(PLAYER::PLAYER_PED_ID()) && func_8(iLocal_298)) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_298, PLAYER::PLAYER_PED_ID(), 1)) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
			{
...
void func_271()
{
	...
	else if (func_208())
	{
		if (!iLocal_323)
		{
			Var0 = { func_225() };
			fVar1 = func_272(&Var0);
			if (MISC::ARE_STRINGS_EQUAL(fVar1, "MEA1_SCENE"))
			{
				func_273(1);
				iLocal_323 = 1;
			}
		...
		if (!PED::IS_PED_IN_VEHICLE(iLocal_296, iLocal_298, 0))
		{
			if (!PED::IS_PED_GROUP_MEMBER(iLocal_296, func_220()))
			{
				...
				if ((func_8(iVar0) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iVar0, 0)) && VEHICLE::IS_VEHICLE_SEAT_FREE(iVar0, 0, 0))
				{
					...
					{
						BRAIN::TASK_ENTER_VEHICLE(iLocal_296, iVar0, 20000, 0, 3f, 1, 0);
					}
				}
				else if (func_212(iLocal_296, PLAYER::PLAYER_PED_ID()) > 10f)
				{
					...
					{
						BRAIN::TASK_GO_TO_ENTITY(iLocal_296, PLAYER::PLAYER_PED_ID(), 20000, 7f, 2f, 1073741824, 0);
					}
				}
				else
				{
					BRAIN::CLEAR_PED_TASKS(iLocal_296);
				}
				func_215();
				func_34(&iLocal_295);
				iLocal_322 = 1;
...
void func_291()
{
	...
	if (func_520(PLAYER::PLAYER_PED_ID()))
	{
		...
		else
		{
			...
			if (func_520(iLocal_296))
			{
				BRAIN::TASK_CLEAR_LOOK_AT(iLocal_296);
			}
			PATHFIND::SET_ROADS_BACK_TO_ORIGINAL_IN_ANGLED_AREA(vLocal_329, vLocal_330, fLocal_331, 1);
			iLocal_325 = 1;
			iLocal_320 = 1;
			iLocal_332 = -1;
			if ((((func_520(iLocal_302) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_302)) && !BRAIN::IS_PED_GETTING_UP(iLocal_302)) && !PED::IS_PED_PRONE(iLocal_302)) && !PED::IS_PED_RAGDOLL(iLocal_302))
			{
				if (!func_51(iLocal_302, 1392476864))
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_302, fLocal_277, fLocal_228, 2) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_302, fLocal_277, fLocal_232, 2))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_302, -8f, 1);
					}
					BRAIN::OPEN_SEQUENCE_TASK(&iVar0);
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1500);
					BRAIN::TASK_ARREST_PED(0, PLAYER::PLAYER_PED_ID());
					BRAIN::CLOSE_SEQUENCE_TASK(iVar0);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_302, iVar0);
					BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
				}
			}
			if (func_520(iLocal_306) && !PED::IS_PED_FLEEING(iLocal_306))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_306, fLocal_277, fLocal_229, 2) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_306, fLocal_277, fLocal_233, 2))
				{
					ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_306, -8f, 1);
...
void func_292()
{
	...
	if (((func_8(iLocal_298) && func_520(PLAYER::PLAYER_PED_ID())) && func_520(iLocal_302)) && func_520(iLocal_306))
	{
		switch (iLocal_250)
		{
			case 0:
			...
			case 1:
				...
				if (bVar4)
				{
					BRAIN::TASK_LOOK_AT_ENTITY(iLocal_302, PLAYER::PLAYER_PED_ID(), 2000, 2048, 4);
					iLocal_250 = 2;
				}
				break;
...
void func_297()
{
	if ((func_520(PLAYER::PLAYER_PED_ID()) && func_8(iLocal_298)) && func_520(iLocal_296))
	{
...
void func_298()
{
	if ((((func_520(iLocal_302) && func_520(iLocal_306)) && func_520(iLocal_296)) && func_8(iLocal_298)) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_277))
	{
		switch (iLocal_221)
		{
			case 0:
				...
				iLocal_328 = 1;
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_302, iLocal_220, fLocal_277, sLocal_224, 1000f, -4f, 1, 16, 1148846080, 0);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_306, iLocal_220, fLocal_277, sLocal_225, 1000f, -4f, 1, 16, 1148846080, 0);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_296, iLocal_220, fLocal_277, sLocal_226, 1000f, -4f, 1, 16, 1148846080, 0);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_298, iLocal_220, fLocal_227, fLocal_277, 1000f, -8f, 1, 1148846080);
				iLocal_333 = -1;
				iLocal_234 = 1;
				iLocal_221 = 2;
				break;
			...
			case 1:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_220, false);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_302, iLocal_220, fLocal_277, fLocal_228, 1000f, -4f, 4, 16, 1148846080, 0);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_306, iLocal_220, fLocal_277, fLocal_229, 1000f, -4f, 1, 16, 1148846080, 0);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_296, iLocal_220, fLocal_277, sLocal_230, 1000f, -4f, 4, 16, 1148846080, 0);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_298, iLocal_220, fLocal_231, fLocal_277, 1000f, -8f, 1, 1148846080);
			...
			case 3:
				...
				if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_220))
				{
					iLocal_220 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_222, vLocal_223, 2);
					PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_220, true);
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_302, iLocal_220, fLocal_277, fLocal_232, 1000f, -4f, 1, 16, 1148846080, 0);
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_306, iLocal_220, fLocal_277, fLocal_233, 1000f, -4f, 1, 16, 1148846080, 0);
					if (VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_298, 2, 0))
					{
						...
						BRAIN::TASK_LOOK_AT_ENTITY(iLocal_296, PLAYER::PLAYER_PED_ID(), -1, 2050, 4);
					}
				...
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_296, fLocal_277, fLocal_230, 2))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_296, -1000f, 0);
						if (VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_298, 2, 0))
						{
				...
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_298, fLocal_277, fLocal_231, 2))
					{
			...
			case 4:
				...
				if (func_520(iLocal_302))
				{
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_302, PLAYER::PLAYER_PED_ID(), -1);
				}
				iLocal_221 = 5;
				break;
			}
...
void func_304()
{
	if (func_520(iLocal_302) && func_8(iLocal_298))
	{
		if (PED::IS_PED_IN_VEHICLE(iLocal_302, iLocal_298, 0))
		{
			...
			{
				BRAIN::TASK_VEHICLE_DRIVE_WANDER(iLocal_302, iLocal_298, 30f, 786469);
...
void func_305()
{
	...
	if (iLocal_319)
	{
		PATHFIND::DISABLE_NAVMESH_IN_AREA(vLocal_279, vLocal_280, 0);
		PATHFIND::SET_PED_PATHS_IN_AREA(vLocal_279, vLocal_280, true, 0);
		if ((func_520(iLocal_302) && func_8(iLocal_298)) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_298, -1, 0))
		{
			func_231();
			func_63(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
			...
			{
				BRAIN::OPEN_SEQUENCE_TASK(&iVar0);
				BRAIN::TASK_ENTER_VEHICLE(0, iLocal_298, 20000, -1, 1f, 1, 0);
				BRAIN::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_298, 50f, 786597);
				BRAIN::CLOSE_SEQUENCE_TASK(iVar0);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_302, iVar0);
				BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_298, false);
...
void func_310(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_338(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_105220.f_32546.f_4801 = func_327();
			}
...
void func_311(int iParam0, int iParam1)
{
	...
	func_349(iParam0, &(Global_105220.f_32546.f_5510));
}
...
int func_338(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_348(Global_105220.f_32546.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_348(Global_105220.f_2354.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_348(Global_105220.f_2354.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_341(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_338(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_346(iParam0);
			func_345(uParam1, &(Global_105220.f_32546.f_69[Global_69800.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_360(int iParam0, void fParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_418(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_411(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
			...
			{
				iVar6 = func_409(&(Global_92955.f_3));
				if (iVar6 > -1)
				{
		...
		func_361(iParam0, fParam1, iParam4, iParam5);
...
{
	func_362(&Global_98783, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_362(var uParam0, void fParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_28();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_375())
		{
			func_371(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
...
void func_371(int iParam0, var uParam1, int iParam2)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && ENTITY::GET_ENTITY_MODEL(iParam0) == ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			if (func_372(161, -1))
			{
				uParam1->f_59 = func_116(2051, Global_70790, 0);
			}
			else
			{
				uParam1->f_59 = func_116(752, Global_70790, 0);
			}
			uParam1->f_60 = func_116(753, Global_70790, 0);
			uParam1->f_61 = func_116(754, Global_70790, 0);
		}
...
int func_372(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2557346[iParam0 /*3*/][func_115(iParam1)];
...
void func_376(int iParam0, bool bParam1)
{
	...
	if (func_14(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_377(iParam0, &(Global_105220.f_2354.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_377(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_379(Var7.f_1)) && iVar9 < 50)
			{
...
int func_385(vector3 vParam0, void fParam1, vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
Vector3 func_394(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_405(Global_95018);
			break;
		
		case 46:
			if (Global_1589135 != func_404())
			{
				if (func_403(Global_1589135))
				{
					return func_396(2, 2);
				}
				else if (func_395(Global_1589135))
				{
...
int func_411(void fParam0, int iParam1)
{
	int iVar0;
	void fVar1;
	int iVar2;
...
void func_413(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_416(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_417(Global_105220.f_9056.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_417(Global_105220.f_9056.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_417(Global_105220.f_9056.f_99.f_205[11]);
			break;
		
		case 90:
			return func_417(Global_105220.f_9056.f_99.f_205[7]);
			break;
		
		case 93:
			return func_417(Global_105220.f_9056.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
int func_418(void fParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
...
void func_421()
{
	...
	switch (iLocal_293)
	{
		...
		case 2:
			func_423();
			if ((((func_520(PLAYER::PLAYER_PED_ID()) && func_520(iLocal_296)) && ENTITY::DOES_ENTITY_EXIST(iLocal_306)) && ENTITY::DOES_ENTITY_EXIST(iLocal_302)) && func_8(iLocal_298))
			{
...
void func_422()
{
	if ((((iLocal_244 < 1 && func_520(PLAYER::PLAYER_PED_ID())) && !func_208()) && !func_210("MEA1_01", 0, 0)) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_281, true) > (30f * 3f))
	{
...
void func_423()
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_298))
	{
		if (STREAMING::HAS_MODEL_LOADED(iLocal_299))
		{
			...
			ENTITY::FREEZE_ENTITY_POSITION(iLocal_298, true);
			VEHICLE::_0x428BACCDF5E26EAD(iLocal_298, false);
...
int func_424(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	int iVar0;
...
void func_426()
{
	...
	STREAMING::REQUEST_ANIM_DICT(fLocal_277);
	STREAMING::REQUEST_ANIM_DICT(fLocal_278);
}
...
void func_428(int iParam0, vector3 vParam1, float fParam2)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_429()
{
	...
	if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
	{
		...
		func_517();
		if (func_33(0) && func_520(PLAYER::PLAYER_PED_ID()))
		{
		...
		if (func_452())
		{
			...
			switch (iVar3)
			{
				...
				case 2:
					func_430(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1112014848, 12, 5000, 0, 0);
...
void func_430(vector3 vParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
void func_444(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	vector3 vVar0;
	float fVar1;
...
int func_445(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_64(Global_98783.f_2875.f_12.f_66))
	{
		return 0;
	}
...
bool func_447()
{
	return func_448(&(Global_98783.f_2875));
}
...
void func_453(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_497(vParam1, fParam2);
	}
	else if (iParam7 == 1)
	{
		if (func_348(vParam1, 0f, 0f, 0f, 0))
...
int func_454(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_105220.f_2354.f_539.f_2387[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_105220.f_2354.f_539.f_2387[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_105220.f_2354.f_539.f_2387[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_487(iParam0, &(Global_105220.f_2354.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_31), &(Global_105220.f_2354.f_539.f_2387[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_105220.f_2354.f_539.f_2387[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_105220.f_2354.f_539.f_2387[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_105220.f_2354.f_539.f_2387[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_487(iParam0, &(Global_105220.f_2354.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_31), &(Global_105220.f_2354.f_539.f_2387[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_455(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_14(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_351(iParam1, &(Global_105220.f_2354.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_105220.f_2354.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_105220.f_20089[iParam0 /*43*/].f_31 = func_458(*iParam1);
				...
				func_456(Global_105220.f_2354.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_105220.f_2354.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_105220.f_20089[iParam0 /*43*/].f_1));
				...
				func_456(Global_105220.f_2354.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_105220.f_20089[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_459(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_482(iVar0, bParam1, uParam2) && !func_481(PLAYER::PLAYER_ID())) && !func_466(iParam0))
	{
		return 0;
	}
	...
	if (((((((VEHICLE::IS_BIG_VEHICLE(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("halftrack")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("phantom3")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("hauler2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("trailerlarge")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("trailersmall2")) && !bVar1) && !(func_463(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_460(PLAYER::PLAYER_ID())))
	{
		*uParam2 = 2;
		return 0;
	}
...
int func_460(int iParam0)
{
	if (iParam0 != func_404())
	{
		if (func_462(iParam0, 1, 1))
		{
			...
			{
				return func_461(Global_2423644[iParam0 /*406*/].f_305.f_1) == 11;
			}
		}
	}
	return 0;
...
int func_464(int iParam0)
{
	if (iParam0 != func_404())
	{
		if (func_462(iParam0, 1, 1))
		{
			if (Global_2423644[iParam0 /*406*/].f_305.f_1 != -1)
			{
				return func_461(Global_2423644[iParam0 /*406*/].f_305.f_1) == 7;
			}
		}
	}
	return 0;
...
int func_468(int iParam0)
{
	...
	if (func_469(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
	...
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_472(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				...
				else if (func_471(iParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_479(int iParam0)
{
	if (iParam0 != func_404())
	{
		if (func_462(iParam0, 1, 1))
		{
			if (Global_2423644[iParam0 /*406*/].f_305.f_1 != -1 && Global_2423644[iParam0 /*406*/].f_305.f_4 != func_404())
			{
				return func_461(Global_2423644[iParam0 /*406*/].f_305.f_1) == 5;
			}
		}
	}
	return 0;
...
int func_480(int iParam0)
{
	if (iParam0 != func_404())
	{
		if (func_462(iParam0, 1, 1))
		{
			if (Global_2423644[iParam0 /*406*/].f_305.f_1 != -1 && Global_2423644[iParam0 /*406*/].f_305.f_4 != func_404())
			{
				return func_461(Global_2423644[iParam0 /*406*/].f_305.f_1) == 8;
			}
		}
	}
	return 0;
...
int func_481(int iParam0)
{
	if (iParam0 != func_404())
	{
		if (func_462(iParam0, 1, 1))
		{
			if (Global_2423644[iParam0 /*406*/].f_305.f_1 != -1)
			{
				return func_461(Global_2423644[iParam0 /*406*/].f_305.f_1) == 9;
			}
		}
	}
	return 0;
...
void func_492(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90431[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90431[iVar0]) == func_339(iParam0, iParam1))
				{
...
void func_493(vector3 vParam0, float fParam1, bool bParam2)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_338(&(Global_69800.f_555[0 /*21*/]), iVar0))
		{
...
void func_494(int iParam0)
{
	...
	if (func_338(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		...
		if (MISC::IS_BIT_SET(Global_69800.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_344(iParam0, 0)) && Global_70709.f_66 == 0) && Global_105220.f_32546.f_1958[Global_69800.f_555[0 /*21*/].f_14] != 0) && Global_105220.f_32546.f_1958[Global_69800.f_555[0 /*21*/].f_14] > 3) && (!func_495(0, Global_69800.f_555[0 /*21*/].f_12) || !func_495(1, Global_69800.f_555[0 /*21*/].f_12)))
			{
				func_345(&(Global_105220.f_32546.f_69[Global_69800.f_555[0 /*21*/].f_14 /*78*/]), &Global_70709);
...
int func_495(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_496(&(Global_105220.f_32546.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_314(Global_105220.f_32546.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_497(vector3 vParam0, float fParam1)
{
	return func_498(&(Global_98783.f_2875), vParam0, fParam1, 0);
}

int func_498(var uParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
	...
	if (func_448(uParam0))
	{
		...
		if (func_513(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_500(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar4 = func_499(iVar0);
					if (iVar4 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_500(int iParam0, vector3 vParam1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("cargobob"):
			if (func_501(iParam0, Global_69800.f_139[38], 0))
			{
				func_494(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_501(iParam0, Global_69800.f_139[43], 1))
			{
				func_494(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_501(iParam0, uVar1[iVar3], 1) && func_449(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
void func_502(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_505(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_504())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
bool func_514()
{
	return func_513(&(Global_98783.f_2875));
}

void func_515()
{
	func_516(&(Global_98783.f_2875));
}
...
void func_517()
{
	...
	fVar0 = func_518(PLAYER::PLAYER_PED_ID(), vLocal_281, 1);
...
float func_518(int iParam0, vector3 vParam1, bool bParam2)
{
	vector3 vVar0;
