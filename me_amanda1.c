...
void func_1()
{
	...
	else if (func_518(iLocal_296) && func_518(PLAYER::PLAYER_PED_ID()))
	{
...
void func_4(bool bParam0, bool bParam1)
{
	...
	{
		if (func_518(iLocal_296) && PED::IS_PED_IN_GROUP(iLocal_296))
		{
		...
		else if (func_518(iLocal_296) && ENTITY::IS_ENTITY_AT_COORD(iLocal_296, vLocal_282, 50f, 50f, 50f, false, true, 0))
		{
			func_11(iLocal_296);
		}
		else
...
void func_35()
{
	...
	if (func_518(PLAYER::PLAYER_PED_ID()) && func_518(iLocal_296))
	{
		...
		switch (iLocal_293)
		{
			case 0:
				...
				else
				{
					...
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 2f, 20000, 0.25f, 0, 1193033728);
...
void func_39(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_518(PLAYER::PLAYER_PED_ID()))
	{
...
void func_40(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_45(PLAYER::PLAYER_ID())) && !func_42(PLAYER::PLAYER_ID(), 0)) && !func_41())
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_45(PLAYER::PLAYER_ID()))
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_70854 = 0;
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_70671[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_80(iVar0), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_80(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_80(iVar0), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, iParam4);
						}
						func_112(iVar0);
						if (Global_70669 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_80(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_80(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_80(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, iParam4);
		}
		if (Global_70669 == 1)
		{
			iVar2 = 0;
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_123(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
		...
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_123(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_184(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_70671[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_80(iParam1)) && Global_70671[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_80(iParam1)))
	{
		return 1;
	}
	return 0;
		...
		switch (iLocal_293)
		{
			case 0:
				...
				else
				{
					...
					func_192(iLocal_296, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) + Vector(0f, 2f, 2f));
...
void func_205()
{
	...
	{
		if ((((func_518(PLAYER::PLAYER_PED_ID()) && func_518(iLocal_296)) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_296, 0)) && !func_208()) && func_212(PLAYER::PLAYER_PED_ID(), iLocal_296) < 10f)
		{
...
void func_209()
{
	if (((func_9(iLocal_298) && func_518(iLocal_296)) && PED::IS_PED_IN_VEHICLE(iLocal_296, iLocal_298, 0)) && func_212(PLAYER::PLAYER_PED_ID(), iLocal_296) < 10f)
	{
...
void func_228()
{
	if (func_518(iLocal_306) && func_212(PLAYER::PLAYER_PED_ID(), iLocal_306) > 100f)
	{
		func_16(&iLocal_306, 0, 0, 1);
	}
	if (func_518(iLocal_302) && func_212(PLAYER::PLAYER_PED_ID(), iLocal_302) > 100f)
	{
...
void func_229()
{
	...
	if (((iLocal_337 && !HUD::IS_MESSAGE_BEING_DISPLAYED()) && func_518(PLAYER::PLAYER_PED_ID())) && func_518(iLocal_296))
	{
...
void func_233()
{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vVar0, 1f, 1f, 2f, true, true, 0) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vVar0, true) < 2.75f)
	{
		bVar1 = false;
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
...
void func_237()
{
	...
	if (func_518(PLAYER::PLAYER_PED_ID()) && MISC::GET_GAME_TIMER() > iLocal_311)
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
...
int func_255(int iParam0)
{
	...
	if ((func_518(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_8(iParam0))
	{
		iVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
		if (func_8(iVar0))
		{
...
void func_257()
{
	if (func_518(iLocal_296) && !PED::IS_PED_GROUP_MEMBER(iLocal_296, func_220()))
	{
		if (func_8(iLocal_298))
		{
...
void func_258()
{
	if (((((func_518(PLAYER::PLAYER_PED_ID()) && func_518(iLocal_302)) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_302)) && !BRAIN::IS_PED_GETTING_UP(iLocal_302)) && !PED::IS_PED_PRONE(iLocal_302)) && !PED::IS_PED_RAGDOLL(iLocal_302))
	{
...
void func_262()
{
	...
	{
		if ((func_264(iLocal_306, 1090519040, 1097859072) || PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID())) || (func_518(iLocal_302) && PED::IS_PED_SHOOTING(iLocal_302)))
		{
...
{
	if (((((func_518(iLocal_302) && func_518(PLAYER::PLAYER_PED_ID())) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_302)) && !BRAIN::IS_PED_GETTING_UP(iLocal_302)) && !PED::IS_PED_PRONE(iLocal_302)) && !PED::IS_PED_RAGDOLL(iLocal_302))
	{
		if (!func_5(iLocal_302) == joaat("weapon_pistol"))
		{
			PED::SET_PED_CAN_SWITCH_WEAPON(iLocal_302, true);
	...
	if ((func_518(iLocal_306) && !PED::IS_PED_FLEEING(iLocal_306)) && !PED::IS_PED_IN_COMBAT(iLocal_306, 0))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_306, sLocal_277, sLocal_229, 2) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_306, sLocal_277, sLocal_233, 2))
		{
			ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_306, -8f, 1);
...
int func_267(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_201(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
void func_270()
{
	...
	switch (iLocal_293)
	{
		...
		case 1:
			...
			func_296();
			func_292();
			if (((func_518(PLAYER::PLAYER_PED_ID()) && func_8(iLocal_298)) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_298, PLAYER::PLAYER_PED_ID(), 1)) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
			{
...
int func_284(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_201(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_291()
{
	...
	if (func_518(PLAYER::PLAYER_PED_ID()))
	{
		...
		else
		{
			...
			iLocal_320 = 1;
			iLocal_332 = -1;
			if ((((func_518(iLocal_302) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_302)) && !BRAIN::IS_PED_GETTING_UP(iLocal_302)) && !PED::IS_PED_PRONE(iLocal_302)) && !PED::IS_PED_RAGDOLL(iLocal_302))
			{
			...
			if (func_518(iLocal_306) && !PED::IS_PED_FLEEING(iLocal_306))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_306, sLocal_277, sLocal_229, 2) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_306, sLocal_277, sLocal_233, 2))
				{
					ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_306, -8f, 1);
...
void func_292()
{
	...
	if (((func_8(iLocal_298) && func_518(PLAYER::PLAYER_PED_ID())) && func_518(iLocal_302)) && func_518(iLocal_306))
	{
		switch (iLocal_250)
		{
			case 0:
...
void func_297()
{
	if ((func_518(PLAYER::PLAYER_PED_ID()) && func_8(iLocal_298)) && func_518(iLocal_296))
	{
...
void func_298()
{
	if ((((func_518(iLocal_302) && func_518(iLocal_306)) && func_518(iLocal_296)) && func_8(iLocal_298)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_277))
	{
		switch (iLocal_221)
		{
			case 0:
				...
				iLocal_328 = 1;
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_302, iLocal_220, sLocal_277, sLocal_224, 1000f, -4f, 1, 16, 1148846080, 0);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_306, iLocal_220, sLocal_277, sLocal_225, 1000f, -4f, 1, 16, 1148846080, 0);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_296, iLocal_220, sLocal_277, sLocal_226, 1000f, -4f, 1, 16, 1148846080, 0);
			...
			case 1:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_220, false);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_302, iLocal_220, sLocal_277, sLocal_228, 1000f, -4f, 4, 16, 1148846080, 0);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_306, iLocal_220, sLocal_277, sLocal_229, 1000f, -4f, 1, 16, 1148846080, 0);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_296, iLocal_220, sLocal_277, sLocal_230, 1000f, -4f, 4, 16, 1148846080, 0);
			...
			case 3:
				...
				if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_220))
				{
					iLocal_220 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_222, vLocal_223, 2);
					PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_220, true);
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_302, iLocal_220, sLocal_277, sLocal_232, 1000f, -4f, 1, 16, 1148846080, 0);
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_306, iLocal_220, sLocal_277, sLocal_233, 1000f, -4f, 1, 16, 1148846080, 0);
...
void func_305()
{
	...
	if (iLocal_319)
	{
		PATHFIND::DISABLE_NAVMESH_IN_AREA(vLocal_279, vLocal_280, 0);
		PATHFIND::SET_PED_PATHS_IN_AREA(vLocal_279, vLocal_280, true, 0);
		if ((func_518(iLocal_302) && func_8(iLocal_298)) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_298, -1, 0))
		{
			func_231();
			func_63(&uLocal_55, 4, iLocal_296, "AMANDA", 1, 1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
		{
			if (func_358(24) != PLAYER::GET_PLAYERS_LAST_VEHICLE())
			{
				if (iParam2 == 1)
				{
					if (func_355(ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
{
	func_362(&Global_98118, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_372(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2547365[iParam0 /*3*/][func_115(iParam1)];
...
int func_387(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_408())
		{
			*uParam0 = func_393(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
void func_421()
{
	...
	switch (iLocal_293)
	{
		...
		case 1:
			if (func_518(PLAYER::PLAYER_PED_ID()))
			{
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_281, true) < 200f)
				{
					iLocal_293 = 2;
				}
			}
		...
		case 2:
			func_423();
			if ((((func_518(PLAYER::PLAYER_PED_ID()) && func_518(iLocal_296)) && ENTITY::DOES_ENTITY_EXIST(iLocal_306)) && ENTITY::DOES_ENTITY_EXIST(iLocal_302)) && func_8(iLocal_298))
			{
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_281, true) < 30f)
				{
					iLocal_332 = -1;
					iLocal_293 = 0;
					iLocal_292 = 2;
...
void func_422()
{
	if ((((iLocal_244 < 1 && func_518(PLAYER::PLAYER_PED_ID())) && !func_208()) && !func_210("MEA1_01", 0, 0)) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_281, true) > (30f * 3f))
	{
...
void func_429()
{
	...
	if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
	{
		...
		func_515();
		if (func_33(0) && func_518(PLAYER::PLAYER_PED_ID()))
		{
		...
		if (func_452())
		{
			...
			switch (iVar3)
			{
				...
				case 2:
					func_430(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
...
int func_459(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_480(iVar0, bParam1, uParam2) && !func_479(PLAYER::PLAYER_ID())) && !func_464(iParam0))
	{
		return 0;
	}
...
int func_466(int iParam0)
{
	...
	if (func_467(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
void func_490(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90309[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90309[iVar0]) == func_339(iParam0, iParam1))
				{
...
int func_498(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_499(iParam0, uVar1[iVar3], 1) && func_449(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_348(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_515()
{
	...
	fVar0 = func_516(PLAYER::PLAYER_PED_ID(), vLocal_281, 1);
...
float func_516(int iParam0, vector3 vParam1, bool bParam2)
{
	vector3 vVar0;
