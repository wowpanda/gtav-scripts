		...
		if (!func_159(14))
		{
			...
			if (Global_25774)
			{
				if (!HAS_ACHIEVEMENT_BEEN_PASSED(12))
				{
					...
					{
						func_132(12, iVar0);
						STAT_SET_INT(joaat("num_gold_medals_obtained"), iVar0, 1);
					}
					if (iVar0 >= 70)
					{
						func_126(12, 1);
			...
			if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
			{
				if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
				{
					...
					{
						func_115(0);
						iLocal_56 = (GET_GAME_TIMER() + iLocal_61);
					}
					if (GET_GAME_TIMER() > iLocal_57)
					{
						if (!HAS_ACHIEVEMENT_BEEN_PASSED(14) || iLocal_64 == 1)
						{
							if (func_114(53))
							{
								func_113();
...
void func_2()
{
	...
	{
		if (IS_BIT_SET(Global_2528542.f_2216.f_18, 1))
		{
			func_126(41, 1);
		}
	}
...
int func_13(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2572886[iParam0 /*3*/][func_5(iParam1)];
	if (STAT_GET_INT(uVar0, &uVar1, -1))
	{
		return uVar1;
	}
...
void func_19(var uParam0)
{
	...
	func_87(uParam0, &Var1);
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < Var1)
	{
		if (func_20(uParam0, Var1[iVar0 /*5*/]))
		{
			func_126(29, 1);
			return;
		}
	...
	{
		if (func_20(uParam0, Var1.f_221[iVar0 /*5*/]))
		{
			func_126(29, 1);
			return;
		}
...
int func_20(var uParam0, int iParam1)
{
	...
	while (func_21(&Var45, iParam1, iVar44, 0))
	{
		...
		if (HAS_PED_GOT_WEAPON_COMPONENT(uParam0, iParam1, Var45))
		{
			if (Var45.f_4 == joaat("WAPClip"))
			{
				iVar43 = Var45.f_6;
	...
	if (GET_WEAPON_TINT_COUNT(iParam1) > 0 && GET_PED_WEAPON_TINT_INDEX(uParam0, iParam1) == 0)
	{
		return 0;
	}
	return 1;
					...
					if (GET_DLC_WEAPON_COMPONENT_DATA(iVar12, iVar13, &Var54))
					{
						if (!func_73(Var54.f_3))
						{
							...
							if (iVar14 == iParam2)
							{
								...
								func_85(uParam0, Var54.f_3, Var54, iVar0, Var54.f_1);
							}
							iVar14++;
						}
					}
...
int func_22(int iParam0, int iParam1)
{
	...
	if (NETWORK_IS_GAME_IN_PROGRESS() && func_66())
	{
		StringCopy(&Var144, func_64(iParam1, iParam0), 16);
		func_60(&sVar128, Var144, GET_ENTITY_MODEL(PLAYER_PED_ID()), 3, 1, func_62(iParam0), func_61(iParam0), -1, 0, 0);
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_36(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_66()
{
	if (NETWORK_IS_GAME_IN_PROGRESS() && func_67())
	{
		return 1;
	}
	return 0;
...
int func_74(int iParam0, int iParam1, int iParam2)
{
	...
	return IS_BIT_SET(uVar0, func_75(iVar1));
}
...
void func_87(var uParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(uParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(uParam0, func_90(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
				...
				{
					Var4.f_1 = GET_AMMO_IN_PED_WEAPON(uParam0, Var4);
					if (Var4 == joaat("gadget_parachute"))
					{
						Var4.f_1 = 1;
					}
					Var4.f_3 = GET_PED_WEAPON_TINT_INDEX(uParam0, Var4);
					Var4.f_4 = _0xA2C9AC24B4061285(uParam0, Var4);
					if (Var4.f_1 == -1)
					{
						if (!GET_MAX_AMMO(uParam0, Var4, &(Var4.f_1)))
						{
							Var4.f_1 = 0;
						}
					}
					...
					while (iVar2 != 0)
					{
						if (HAS_PED_GOT_WEAPON_COMPONENT(uParam0, Var4, iVar2))
						{
		...
		while (iVar9 < iVar10)
		{
			if ((GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_88(Var11.f_1)) && iVar72 < 51)
			{
				if (!_IS_DLC_DATA_EMPTY(Var11))
				{
					...
					Var4.f_4 = 0;
					Var4.f_1 = GET_AMMO_IN_PED_WEAPON(uParam0, Var4);
					if (HAS_PED_GOT_WEAPON(uParam0, Var4, 0))
					{
						Var4.f_3 = GET_PED_WEAPON_TINT_INDEX(uParam0, Var4);
						Var4.f_4 = _0xA2C9AC24B4061285(uParam0, Var4);
					}
					...
					while (iVar1 < GET_NUM_DLC_WEAPON_COMPONENTS(iVar9))
					{
						if (GET_DLC_WEAPON_COMPONENT_DATA(iVar9, iVar1, &Var50))
						{
							...
							{
								if (HAS_PED_GOT_WEAPON_COMPONENT(uParam0, Var4, Var50.f_3))
								{
...
float func_91(var uParam0)
{
	if (func_94(uParam0))
	{
		...
		{
			return (func_92(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
int func_113()
{
	...
	if (NETWORK_IS_GAME_IN_PROGRESS() || Global_71590)
	{
		return 0;
	}
...
int func_118(bool bParam0)
{
	...
	STAT_GET_INT(joaat("num_discipline_gold_earned"), &iVar9, -1);
	if (iVar7 > iVar9 && iVar7 > 0)
	{
		STAT_SET_INT(joaat("num_discipline_gold_earned"), iVar7, 1);
		func_132(17, iVar7);
	}
	if (bParam0)
	{
...
int func_121()
{
	...
	while (iVar0 < 4)
	{
		if (IS_BIT_SET(Global_106565.f_24970.f_1, iVar0))
		{
			return 1;
		}
		iVar0++;
...
int func_122()
{
	...
	while (iVar0 < 5)
	{
		if (IS_BIT_SET(Global_106565.f_24973.f_2, iVar0))
		{
			return 1;
		}
		iVar0++;
...
int func_144(int iParam0, int iParam1)
{
	...
	{
		case 1:
			return !IS_BIT_SET(Global_84500[iParam0 /*34*/].f_15, 5);
			break;
...
void func_148()
{
	...
	if (IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
	{
		uVar0 = GET_PED_SOURCE_OF_DEATH(PLAYER_PED_ID());
		if (IS_ENTITY_A_PED(uVar0))
		{
			uVar1 = GET_PED_INDEX_FROM_ENTITY_INDEX(uVar0);
			if (func_149(uVar1))
			{
				if (GET_ENTITY_MODEL(uVar1) == joaat("a_c_sharktiger"))
				{
					func_126(25, 1);
					return;
				}
...
void func_150()
{
	switch (iLocal_55)
	{
		...
		case 1:
			if (func_154() || IS_PLAYER_SWITCH_IN_PROGRESS())
			{
				return;
			}
...
void func_151(var uParam0)
{
	if (func_94(uParam0))
	{
		if (!func_93(uParam0))
		{
			uParam0->f_2 = (func_92(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
			SET_BIT(uParam0, 2);
		}
	}
}
...
int func_155()
{
	...
	iVar0 = 0;
	iVar1 = func_157(2);
	if (func_156(iVar1, 0) || IS_BIT_SET(Global_89563, 2))
	{
		iVar0++;
	}
	iVar1 = func_157(1);
	if (func_156(iVar1, 0) || IS_BIT_SET(Global_89563, 1))
	{
		iVar0++;
	}
	iVar1 = func_157(0);
	if (func_156(iVar1, 0) || IS_BIT_SET(Global_89563, 0))
	{
		iVar0++;
	}
	return iVar0;
...
{
	uParam0->f_1 = (func_92(IS_BIT_SET(*uParam0, 4)) - fParam1);
	SET_BIT(uParam0, 1);
	CLEAR_BIT(uParam0, 2);
	uParam0->f_2 = 0f;
}
