						...
						else
						{
							...
							if (iLocal_61 == -1)
							{
								...
								if (iLocal_68)
								{
									...
									{
										if (!IS_BIT_SET(Global_4269308, 17))
										{
											SET_BIT(&Global_4269308, 17);
...
void func_4()
{
	if (Global_46896 != -1)
	{
		SET_STREAMED_TEXTURE_DICT_AS_NO_LONGER_NEEDED(func_12(Global_46896));
		Global_46896 = -1;
	}
	Global_37587 = 0;
			...
			else if (Global_15866 == 4 || Global_15866 == 3)
			{
				...
				else
				{
					...
					if (Global_106565.f_28044[Global_1738 /*29*/].f_24[Global_14553] == 0)
					{
						...
						func_9(Global_14534, "SET_DATA_SLOT", TO_FLOAT(4), TO_FLOAT(0), TO_FLOAT(3), -1f, -1f, &(Global_117[Global_1738 /*10*/].f_4), "CELL_300", &vVar0, "CELL_195", 0);
					}
					else
					{
						func_60(Global_14534, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_9(Global_14534, "SET_DATA_SLOT", TO_FLOAT(4), TO_FLOAT(0), TO_FLOAT(3), -1f, -1f, &(Global_106565.f_28044[Global_1738 /*29*/].f_3), &(Global_106565.f_28044[Global_1738 /*29*/].f_7), &vVar0, &(Global_106565.f_28044[Global_1738 /*29*/].f_3), 0);
					}
				}
				func_60(Global_14534, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
						...
						if (Global_2992[iVar0] == 0)
						{
							...
							else if (iVar1 == 7)
							{
								...
								else
								{
									...
									func_9(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(uVar6), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
...
void func_13()
{
	...
	if (!iLocal_64)
	{
		...
		{
			iLocal_64 = 1;
			BEGIN_SCALEFORM_MOVIE_METHOD(Global_14534, "SET_INPUT_EVENT");
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
			END_SCALEFORM_MOVIE_METHOD();
	...
	if (!iLocal_63)
	{
		if (IS_CONTROL_PRESSED(2, 176) && TIMERB() > 100)
		{
			if (iLocal_60 == -1)
			{
				...
				uLocal_53 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
				while (!IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_53))
				{
					WAIT(0);
				}
				iLocal_54 = GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_53);
				iLocal_60 = iLocal_54;
				if (func_35(iLocal_55) == 0)
				{
					iLocal_60 = -1;
	...
	if (!bVar5)
	{
		...
		if (Global_40922[iVar2 /*46*/].f_42 > 1)
		{
			...
			while (iVar41 < iVar39)
			{
				...
				BEGIN_SCALEFORM_MOVIE_METHOD(uParam0, "SET_DATA_SLOT");
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(9);
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar41 + 1);
	...
	else
	{
		...
		else
		{
			...
			if (!bVar79)
			{
				...
				{
					BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&Var63);
					iVar80 = 0;
					iVar80 = 0;
					while (iVar80 < Global_46897[iVar43 /*203*/].f_10[iVar3 /*48*/].f_6)
					{
						ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_46897[iVar43 /*203*/].f_10[iVar3 /*48*/].f_7[iVar80 /*4*/]));
						iVar80++;
					}
					END_TEXT_COMMAND_SCALEFORM_STRING();
				}
...
int func_53(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	while (iVar35 < 16)
	{
		...
		if (bVar37)
		{
			...
			ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(sVar38);
			ADD_TEXT_COMPONENT_INTEGER(Global_106565.f_24898[iVar36 /*4*/].f_3);
			END_TEXT_COMMAND_SCALEFORM_STRING();
			END_SCALEFORM_MOVIE_METHOD();
			iVar2++;
			iVar0 = 1;
...
void func_57(int iParam0, int iParam1)
{
	...
	Global_46896 = iVar5;
	REQUEST_STREAMED_TEXTURE_DICT(func_12(iVar5), 0);
...
void func_59()
{
	...
	while (iVar0 < 3)
	{
		...
		{
			_REMOVE_NOTIFICATION(Global_37592[iVar0]);
...
void func_64()
{
	...
	fVar0 = func_65(vLocal_50, vLocal_47, -90f, 0f, 90f, Global_14513, 350f, 0);
	if (Global_3227 == 0)
	{
...
float func_65(vector3 vParam0, vector3 vParam3, vector3 vParam6, vector3 vParam9, float fParam12, bool bParam13)
{
	...
	fVar3 = func_67((TO_FLOAT((GET_GAME_TIMER() - iLocal_18)) / fParam12), 0f, 1f);
	if (fVar3 < 1f)
	{
		fVar4 = fVar3;
		if (bParam13)
		...
		Global_14481 = { func_66(vParam0, vParam3, fVar4) };
		Global_14484 = { func_66(vParam6, vParam9, fVar4) };
	}
	else
	{
...
void func_69()
{
	...
	fVar0 = func_65(vLocal_47, vLocal_50, Global_14513, -90f, 0f, 90f, 350f, 0);
	if (Global_3227 == 0)
	{
		if (IS_PC_VERSION())
		{
...
void func_71(bool bParam0)
{
	...
	if (bParam0)
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(Global_14534, "SET_SOFT_KEYS");
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(1);
