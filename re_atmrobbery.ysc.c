	...
	while (true)
	{
				...
				switch (iLocal_52)
				{
					...
					case 1:
						...
						if (!PED::IS_PED_INJURED(iLocal_55))
						{
							...
							{
								BRAIN::TASK_SMART_FLEE_COORD(iLocal_55, vLocal_53, 200f, 4294967295, 0, 0);
							...
							if (!PED::IS_PED_INJURED(iLocal_56))
							{
								if (CAM::IS_SPHERE_VISIBLE(vLocal_53, 2.5f))
								{
									if (iLocal_65 == 2)
									{
										if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 120f, 120f, 8f, 0, 1, 0) || func_185())
										{
											func_176();
										}
									}
									else if (iLocal_65 == 1)
									{
										if (SYSTEM::VDIST(vLocal_53, -203.758f, -861.738f, 29.2684f) < 5f)
										{
											if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 100f, 100f, 8f, 0, 1, 0) || func_185())
											{
												func_176();
											}
										}
										else if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 170f, 170f, 8f, 0, 1, 0) || func_185())
										{
											func_176();
										}
									}
									...
									{
										if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 65f, 65f, 5f, 0, 1, 0) || func_185())
										{
											func_176();
										}
									}
									...
									{
										if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 50f, 50f, 5f, 0, 1, 0) || func_185())
										{
											func_176();
										}
									}
									...
									{
										if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 60f, 60f, 5f, 0, 1, 0) || func_185())
										{
											func_176();
										}
									}
									else if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 30f, 30f, 8f, 0, 1, 0) || func_185())
									{
										func_176();
									}
								}
						...
						else
						{
							...
							if (!PED::IS_PED_INJURED(iLocal_56))
							{
								BRAIN::TASK_SMART_FLEE_COORD(iLocal_56, vLocal_53, 200f, 4294967295, 0, 0);
		...
		else
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_55))
			{
				if (!PED::IS_PED_INJURED(iLocal_55))
				{
					if (func_172(iLocal_55, 4043842218))
					{
						if (func_171(iLocal_55, vLocal_53, 1) >= 190f)
						{
							NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_55);
							BRAIN::TASK_SMART_FLEE_PED(iLocal_55, AUDIO::_0x0626A247D2405330(), 300f, 4294967295, 0, 0);
						}
					}
					else if (func_172(iLocal_55, 3312640106))
					{
						NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_55);
						BRAIN::TASK_SMART_FLEE_PED(iLocal_55, AUDIO::_0x0626A247D2405330(), 300f, 4294967295, 0, 0);
					}
			...
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				{
					PLAYER::_0x36F1B38855F2A8DF(CAM::_0xDC9DA9E8789F5246());
					if (!iLocal_85 && !bLocal_90)
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
						{
							if (SYSTEM::VDIST(unk_0x8000C77B5F336760(iLocal_56, false), -2956.26f, 487.97f, 15.46f) < 5f)
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 100f, 100f, 15f, 0, 1, 0))
								{
							...
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 40f, 40f, 15f, 0, 1, 0))
								{
									if (func_116(&Local_107, cLocal_123, sLocal_115, 3, 0, 0, 0))
									{
										iLocal_85 = 1;
							...
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 50f, 50f, 15f, 0, 1, 0))
								{
									if (func_116(&Local_107, cLocal_123, sLocal_115, 3, 0, 0, 0))
									{
										iLocal_85 = 1;
							...
							else if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 50f, 50f, 15f, 0, 1, 0))
							{
								if (func_116(&Local_107, cLocal_123, sLocal_115, 3, 0, 0, 0))
								{
									iLocal_85 = 1;
					...
					if (HUD::DOES_BLIP_EXIST(iLocal_59))
					{
						if (!PED::IS_PED_INJURED(iLocal_55))
						{
							if (iLocal_126)
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_55, AUDIO::_0x0626A247D2405330(), fLocal_132, fLocal_132, fLocal_132, 0, 1, 0))
								{
									if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_55, 0))
									{
										if (SYSTEM::TIMERA() > 1000)
										{
											if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_55))
											{
												fLocal_132 = SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_55, true));
								...
								{
									if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_55, 25f, 25f, 25f, 0, 1, 0))
									{
										if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_55, 0))
										{
							...
							{
								if ((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_55) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_55)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_55, AUDIO::_0x0626A247D2405330(), 0))
								{
								...
								if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_73, 0))
								{
									if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_73, AUDIO::_0x0626A247D2405330(), 1))
									{
										...
										{
											BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_55, iLocal_73, AUDIO::_0x0626A247D2405330(), 8, 35f, 4, 10f, 10f, 1);
										}
										else
										{
											BRAIN::TASK_SMART_FLEE_PED(iLocal_55, AUDIO::_0x0626A247D2405330(), 300f, 4294967295, 0, 0);
							...
							{
								if (PED::IS_PED_IN_COMBAT(iLocal_55, AUDIO::_0x0626A247D2405330()))
								{
									bLocal_130 = true;
								}
							...
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
							{
								if (!iLocal_87)
								{
									if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 15f, 15f, 10f, 0, 1, 0))
									{
										if (func_116(&Local_107, cLocal_123, sLocal_116, 4, 0, 0, 0))
										{
											BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
											BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_149, 8f, -4f, 4294967295, 0, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_150, 8f, -4f, 4294967295, 0, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_151, 8f, -4f, 4294967295, 0, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_149, 8f, -4f, 4294967295, 0, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_150, 8f, -4f, 4294967295, 0, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_151, 8f, -4f, 4294967295, 1, 0, 0, 0, 0);
											CUTSCENE::_0x8D9DF6ECA8768583(iLocal_61);
								...
								else if (!iLocal_88)
								{
									if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 15f, 15f, 10f, 0, 1, 0))
									{
										if (((!PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_55) && !PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_55)) && !PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330())) && func_112(iLocal_56, iLocal_55, 1) > 30f)
										{
							...
							if (func_108())
							{
								...
								if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
								{
									vVar0 = { unk_0x8000C77B5F336760(iLocal_56, true) };
								}
								if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_55, vVar0, 25f, 25f, 25f, false, true, 0) && ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_55, 12f, 12f, 12f, 0, 1, 0))
								{
							...
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, Global_13, 0, 1, 0))
								{
								...
								else if (bLocal_130)
								{
									if (func_116(&Local_107, cLocal_123, sLocal_122, 4, 0, 0, 0))
									{
										...
										PED::FORCE_PED_MOTION_STATE(iLocal_56, 3626484699, false, 0, 0);
										bLocal_127 = true;
										func_268();
									}
								}
						...
						{
							if ((PED::IS_PED_INJURED(iLocal_55) || PED::IS_PED_DEAD_OR_DYING(iLocal_55, 1)) || func_172(iLocal_55, 2395094593))
							{
					...
					else if (!HUD::DOES_BLIP_EXIST(iLocal_58))
					{
						if (bLocal_95)
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
							{
								fLocal_82 = SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_56, false));
					...
					else
					{
						...
						if (!bLocal_100)
						{
							if (!PED::IS_PED_INJURED(iLocal_56))
							{
								if (SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_56, false)) > (fLocal_82 + 100f))
								{
									if (bLocal_95)
									{
										func_286(0);
									...
									{
										BRAIN::TASK_SMART_FLEE_PED(iLocal_56, AUDIO::_0x0626A247D2405330(), 100f, 4294967295, 0, 0);
										func_268();
									}
								}
								else if (SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_56, false)) < fLocal_82)
								{
									fLocal_82 = SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_56, false));
								}
								if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_56, AUDIO::_0x0626A247D2405330(), 1))
								{
									if (bLocal_95)
									{
										func_286(0);
...
void func_1()//Position - 0xDBF
{
	if (!PED::IS_PED_INJURED(iLocal_56))
	{
		...
		PED::SET_PED_KEEP_TASK(iLocal_56, true);
		ENTITY::SET_ENTITY_HEALTH(iLocal_56, false);
	...
	if (bLocal_90)
	{
		if (HUD::DOES_BLIP_EXIST(iLocal_60))
		{
			...
			{
				if (SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), OBJECT::GET_PICKUP_COORDS(iLocal_89)) > 100f)
				{
					func_268();
				}
			}
	...
	if (!PED::IS_PED_INJURED(iLocal_56))
	{
		if (!bLocal_99)
		{
			if (iLocal_129)
			{
				if (!iLocal_131)
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 15f, 15f, 20f, 0, 1, 0))
					{
				...
				if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, fLocal_83, fLocal_83, fLocal_83, 0, 1, 0) && !func_94())
				{
					if (func_91(2))
					{
					...
					if (!func_118())
					{
						if (PLAYER::IS_PLAYER_CONTROL_ON(CAM::_0xDC9DA9E8789F5246()))
						{
							if (func_90(1, 0, 1))
							{
								if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_94F, 11) || func_89())
								{
									if (!PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()))
									{
										...
										{
											iLocal_57 = OBJECT::CREATE_OBJECT(iLocal_102, unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), true, true, false);
										}
										else
										{
											iLocal_57 = OBJECT::CREATE_OBJECT(iLocal_101, unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), true, true, false);
										}
										if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
										{
											ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_57, AUDIO::_0x0626A247D2405330(), PED::GET_PED_BONE_INDEX(AUDIO::_0x0626A247D2405330(), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
										}
										...
										if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
										{
											...
											{
												while ((!func_77(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), fLocal_84, 1, 1056964608, 0, 1, 0) || func_88()) || !ENTITY::DOES_ENTITY_HAVE_DRAWABLE(iLocal_57))
												{
													if (!func_77(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), fLocal_84, 1, 1056964608, 0, 1, 0))
													{
													}
													if (func_88())
													{
				...
				{
					func_68(unk_0x8000C77B5F336760(iLocal_56, true), &fLocal_83, &fLocal_84);
					if (!func_94())
					{
						if (!func_172(iLocal_56, 1227113341) && !PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 1))
						{
							NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_56);
							BRAIN::TASK_GO_TO_ENTITY(iLocal_56, AUDIO::_0x0626A247D2405330(), 20000, 0,5f, 1f, 1073741824, 0);
						}
					}
					else if (func_172(iLocal_56, 1227113341))
					{
						...
						BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_149, 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
						BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_151, 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
						BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_150, 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
						CUTSCENE::_0x8D9DF6ECA8768583(iLocal_61);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_56, iLocal_61);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_61);
						MISC::_0x1327E2FE9746BAEE(iLocal_56, 0, 0);
					}
				}
			}
			else if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 25f, 25f, 20f, 0, 1, 1) || ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 30f, 30f, 20f, 0, 1, 2))
			{
				if (!func_94())
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 1))
					{
						...
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
						BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295, 2048, 2);
						BRAIN::TASK_GO_TO_ENTITY(0, AUDIO::_0x0626A247D2405330(), 20000, 0,5f, 1f, 1073741824, 0);
						CUTSCENE::_0x8D9DF6ECA8768583(iLocal_61);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_56, iLocal_61);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_61);
					}
		...
		if (bLocal_99)
		{
			...
			{
				case 0:
					if (((!PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 1) && !PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) && !PED::IS_PED_PRONE(AUDIO::_0x0626A247D2405330())) && !BRAIN::IS_PED_GETTING_UP(AUDIO::_0x0626A247D2405330()))
					{
						if (bLocal_80)
						{
							if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_53, -712.9f, -819.32f, 22.73f, true) < 5f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -709.9229f, -824.0863f, 22.0751f, -715.2137f, -824.2247f, 25.01217f, 3.25f, 0, true, 0))
							{
							...
							{
								vVar7 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false) };
								...
								{
									if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -202.4218f, -864.449f, 27.88059f, -211.4486f, -861.5274f, 31.75401f, 9.5f, 0, true, 0))
									{
								...
								{
									if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 73.30347f, 4.781172f, 66.79439f, 107.6572f, -8.330787f, 69.16833f, 9.75f, 0, true, 0))
									{
								...
								{
									if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 176.3895f, 6635.983f, 29.87799f, 181.7585f, 6641.302f, 33.556f, 7.75f, 0, true, 0))
									{
								...
								{
									if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -3042.549f, 597.1118f, 6.612578f, -3046.965f, 595.6973f, 9.065809f, 5f, 0, true, 0))
									{
						...
						{
							if (SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), 183.6065f, 6636.653f, 30.6299f) < SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), 172.2291f, 6631.007f, 30.7398f))
							{
						...
						else
						{
							...
							if (!PED::IS_PED_INJURED(iLocal_56))
							{
								vVar2 = { unk_0x8000C77B5F336760(iLocal_56, true) };
							}
							vVar3 = { vVar1 - vVar2 };
							vLocal_78 = { vVar1 };
						...
						if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
						{
							if (!OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iVar0, 0))
							{
								...
								if (ENTITY::IS_ENTITY_AT_COORD(iVar0, vLocal_78, (vLocal_137.y + 1f), (vLocal_137.y + 1f), 3f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(iVar0, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_142, sLocal_144, vLocal_78, vLocal_79, 0f, 2), (vLocal_137.y + 1f), (vLocal_137.y + 1f), 3f, false, true, 0))
								{
									if (func_64(vLocal_53, -526.58f, -1222.79f, 17.46f, 10f, 0) && (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -529.7477f, -1218.399f, 16.78482f, -538.9778f, -1213.756f, 20.53685f, 7.5f, 0, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -529.7477f, -1218.399f, 16.78482f, -520.9798f, -1222.305f, 20.55204f, 7.5f, 0, true, 0)))
									{
										if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -529.7477f, -1218.399f, 16.78482f, -538.9778f, -1213.756f, 20.53685f, 7.5f, 0, true, 0))
										{
											vVar6 = { 2.9f, 12f, 8f };
									...
									else if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_53, -203.72f, -861.8f, 29.27f, true) < 5f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -197.7616f, -865.9772f, 27.31116f, -191.161f, -849.0546f, 32.89275f, 10.25f, 0, true, 0))
									{
										vVar6 = { 2.9f, 12f, 8f };
									...
									else if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_53, -387.12f, 6045.79f, 30.5f, true) < 5f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -390.4536f, 6044.05f, 29.99868f, -380.4771f, 6032.985f, 33.24879f, 6f, 0, true, 0))
									{
										vVar6 = { 2.9f, 12f, 8f };
									...
									else if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_53, -2956.78f, 488.19f, 14.47f, true) < 5f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -2955.234f, 492.4626f, 13.80307f, -2967.116f, 493.0511f, 17.05663f, 9.75f, 0, true, 0))
									{
										vVar6 = { 2.9f, 12f, 8f };
									...
									else
									{
										...
										vLocal_75 = { func_61(vLocal_78, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_142, sLocal_144, vLocal_78, vLocal_79, 0f, 2)) };
										if (func_60(0f, 0f, 0f, vLocal_75, 0))
										{
											vLocal_75 = { unk_0x8000C77B5F336760(iVar0, true) };
										}
						...
						{
							MISC::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iVar0), &vLocal_136, &vLocal_137);
							if (ENTITY::IS_ENTITY_AT_COORD(iVar0, vLocal_78, (vLocal_137.y + 1f), (vLocal_137.y + 1f), 1f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(iVar0, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_142, sLocal_144, vLocal_78, vLocal_79, 0f, 2), (vLocal_137.y + 1f), (vLocal_137.y + 1f), 1f, false, true, 0))
							{
						...
						BRAIN::TASK_SYNCHRONIZED_SCENE(AUDIO::_0x0626A247D2405330(), iLocal_68, cLocal_142, sLocal_143, 1000f, -1000f, 1024, 0, 1148846080, 0);
						...
						STATS::STAT_GET_INT(joaat("rc_wallets_returned"), &uVar13, 4294967295);
						iLocal_98++;
					}
					else
					{
						...
						if (PED::IS_PED_PRONE(AUDIO::_0x0626A247D2405330()))
						{
						}
				...
				case 1:
					if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_68) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_68) == 1f) || func_44())
					{
						...
						PLAYER::SPECIAL_ABILITY_FILL_METER(CAM::_0xDC9DA9E8789F5246(), 0);
						if (!PED::IS_PED_INJURED(iLocal_56))
						{
						...
						if (func_64(vLocal_53, -526.58f, -1222.79f, 17.46f, 10f, 0))
						{
							if (func_43(AUDIO::_0x0626A247D2405330(), 215.68f, 60f))
							{
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
							...
							else if (func_43(AUDIO::_0x0626A247D2405330(), 122.0371f, 60f))
							{
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
								BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_56, 0f, 3.5f, 0f), 1f, 20000, 1048576000, 5, 1193033728);
						...
						{
							if (func_43(AUDIO::_0x0626A247D2405330(), 200.8887f, 60f))
							{
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
								BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_56, 0f, 3.5f, 0f), 1f, 20000, 1048576000, 5, 1193033728);
							...
							else if (func_43(AUDIO::_0x0626A247D2405330(), 347.8599f, 60f))
							{
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
								BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_56, 0f, 3.5f, 0f), 1f, 20000, 1048576000, 5, 1193033728);
						...
						PED::FORCE_PED_MOTION_STATE(iLocal_56, 3626484699, true, 0, 0);
					...
					else
					{
						...
						{
							if (!PED::IS_PED_INJURED(iLocal_56) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
							{
								if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_57, AUDIO::_0x0626A247D2405330()))
								{
...
int func_3(int iParam0, int iParam1, int iParam2)//Position - 0x29EF
{
	...
	return func_4(Global_19E56.f_6D76[iParam0 /*29*/].f_11, 0, iParam1, iParam2, 0);
}
...
void func_7(int iParam0)//Position - 0x3313
{
	...
	else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_5038.f_1D7, iParam0) || INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_9() /*12745*/].f_1FF2.f_A, iParam0))
	{
		bVar0 = true;
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_19E56.f_5038.f_1D7), iParam0);
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_200000[func_9() /*12745*/].f_1FF2.f_A), iParam0);
	}
	if (bVar0)
	{
...
char* func_8(int iParam0)//Position - 0x3423
{
	switch (iParam0)
	{
		case 0:
...
int func_10(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x34DA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_11()//Position - 0x3A42
{
	return Global_1407E0;
}

void func_12(int iParam0)//Position - 0x3A4E
{
	func_33(93, iParam0);
	func_33(29, iParam0);
	func_33(30, iParam0);
...
bool func_13(int iParam0)//Position - 0x3A6E
{
	if (iParam0 == 8)
	{
		return func_14(129, 4294967295, 4294967295);
	}
	if (iParam0 == 9)
	{
		return func_14(135, 4294967295, 4294967295);
	}
	if (iParam0 == 10)
	{
		return func_14(136, 4294967295, 4294967295);
	}
	if (iParam0 == 11)
	{
		return func_14(137, 4294967295, 4294967295);
	}
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_5038.f_1D7, iParam0);
	}
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_9() /*12745*/].f_1FF2.f_A, iParam0);
}

int func_14(int iParam0, int iParam1, int iParam2)//Position - 0x3AF2
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_15(int iParam0)//Position - 0x3B2F
{
	int iVar0;
...
int func_16(int iParam0, int iParam1)//Position - 0x3E47
{
	int iVar0;
...
int func_17(bool bParam0)//Position - 0x4140
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_18(int iParam0, int iParam1)//Position - 0x41F7
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_19(int iParam0, int iParam1)//Position - 0x4212
{
	...
	if (func_29(&Global_412216))
	{
		if (func_27(&Global_412216, iParam0))
		{
			return 0;
		}
		if (func_20(&Global_412216, iParam0))
		{
			return 1;
		}
	}
...
int func_20(var uParam0, int iParam1)//Position - 0x42AF
{
	int iVar0;
	var uVar1[78];
...
int func_21(var uParam0, int iParam1)//Position - 0x4360
{
	int iVar0;
...
bool func_22(var uParam0, int iParam1)//Position - 0x43DB
{
	return (*uParam0)[iParam1] == 78;
}

void func_23(var uParam0)//Position - 0x43EC
{
	int iVar0;
	...
	func_25(uParam0, (Global_412215 - 0.5f));
}

void func_24(var uParam0, int iParam1)//Position - 0x4420
{
	(*uParam0)[iParam1] = 78;
}

void func_25(var uParam0, float fParam1)//Position - 0x4430
{
	if (fParam1 == 0f)
	{
		uParam0->f_50 = 0f;
...
float func_26(var uParam0)//Position - 0x444D
{
	return uParam0->f_50;
}

bool func_27(var uParam0, int iParam1)//Position - 0x4459
{
	return func_28(uParam0, iParam1) != 4294967295;
}

int func_28(var uParam0, int iParam1)//Position - 0x446B
{
	int iVar0;
...
bool func_29(var uParam0)//Position - 0x4498
{
	return uParam0->f_4F == 1;
}

int func_30(int iParam0)//Position - 0x44A6
{
	switch (iParam0)
	{
		case 60:
...
bool func_31(int iParam0)//Position - 0x44F6
{
	return Global_8D15 == iParam0;
}

int func_32(int iParam0, int iParam1)//Position - 0x4504
{
	int iVar0;
...
void func_33(int iParam0, int iParam1)//Position - 0x4555
{
	int iVar0;
...
int func_35()//Position - 0x4627
{
	func_36();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_36()//Position - 0x4640
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_39(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_37(iVar0) && (!func_31(14) || Global_19A3D))
			{
...
bool func_37(int iParam0)//Position - 0x473D
{
	return iParam0 < 3;
}

int func_38(int iParam0)//Position - 0x4749
{
	int iVar0;
	int iVar1;
...
int func_39(int iParam0)//Position - 0x4786
{
	if (func_37(iParam0))
	{
...
void func_40()//Position - 0x47B0
{
	int iVar0;
	
	iVar0 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(AUDIO::_0x0626A247D2405330(), 0.5f, -1f, 0.5f), 0f, 0f, ENTITY::GET_ENTITY_HEADING(AUDIO::_0x0626A247D2405330()), 65f, 1, 2);
	CAM::SET_CAM_ACTIVE(iVar0, true);
}

int func_41()//Position - 0x47EE
{
...
void func_42(int iParam0)//Position - 0x4807
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_43(int iParam0, float fParam1, float fParam2)//Position - 0x483F
{
	float fVar0;
	float fVar1;
...
int func_45(int iParam0)//Position - 0x4911
{
...
void func_47(int iParam0, int iParam1)//Position - 0x498D
{
	int iVar0;
...
int func_48(var uParam0, char* sParam1, char* sParam2, char[4] cParam3, char* sParam4, char[4] cParam5, int iParam6, int iParam7, int iParam8)//Position - 0x49B0
{
	var uVar0;
	var uVar1;
...
int func_49(var uParam0, var uParam1, int iParam2, bool bParam3)//Position - 0x4A09
{
	int iVar0;
...
bool func_56(int iParam0, int iParam1)//Position - 0x4FF2
{
	switch (iParam0)
	{
		case 5:
...
void func_58(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16)//Position - 0x5084
{
	Global_3DCB = iParam0;
	Global_3DD5 = 0;
	Global_3DDC = 0;
...
void func_59(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x510C
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
bool func_60(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x5162
{
	if (bParam2)
	{
...
Vector3 func_61(vector3 vParam0, vector3 vParam1)//Position - 0x51A9
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar2;
...
Vector3 func_62(vector3 vParam0, float fParam1, struct<2> Param2, var uParam3)//Position - 0x57AA
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
int func_63(int iParam0)//Position - 0x57F7
{
	if (func_106(iParam0))
	{
...
int func_64(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x5821
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_65(int iParam0, var uParam1, var uParam2, char* sParam3, char* sParam4)//Position - 0x589C
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar1 = 0;
	iVar2 = 1;
	*uParam1 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false) };
	uParam2->f_2 = func_67(iParam0, AUDIO::_0x0626A247D2405330(), 1);
	fVar3 = func_67(iParam0, AUDIO::_0x0626A247D2405330(), 1);
	fVar4 = func_67(iParam0, AUDIO::_0x0626A247D2405330(), 1);
	vVar10 = { unk_0x8000C77B5F336760(iParam0, false) - unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false) };
	if (STREAMING::HAS_ANIM_DICT_LOADED(sParam3))
	{
		vVar9 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(sParam3, sParam4, *uParam1, *uParam2, 0f, 2) };
	}
	else
	{
	...
	while (iVar0 < 2)
	{
		switch (iVar0)
		{
			case 0:
				if (iVar1 > 20)
				{
					uParam2->f_2 = func_66(unk_0x8000C77B5F336760(iParam0, false), *uParam1, 1);
					*uParam1 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(unk_0x8000C77B5F336760(iParam0, false), uParam2->f_2, vVar10) };
					iVar0 = 2;
				}
				else
				{
				...
				if (SHAPETEST::GET_SHAPE_TEST_RESULT(iVar5, &iVar6, &vVar8, &uVar7, &uVar11) == 2)
				{
					if (iVar6 != 0)
					{
						...
						else
						{
							...
							*uParam1 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), fVar4, vVar10) };
							iVar1++;
							iVar0 = 0;
						}
					}
...
float func_66(struct<2> Param0, float fParam1, struct<2> Param2, var uParam3, int iParam4)//Position - 0x5A54
{
	float fVar0;
	float fVar1;
	float fVar2;
...
float func_67(int iParam0, int iParam1, int iParam2)//Position - 0x5AB9
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_68(vector3 vParam0, float fParam1, float fParam2)//Position - 0x5AE5
{
	bool bVar0;
	vector3 vVar1;
	float fVar2;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
		...
		if (func_69(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), fVar2, 15f))
		{
			bVar0 = true;
		}
...
int func_69(int iParam0, float fParam1, float fParam2)//Position - 0x5BE6
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_70(int iParam0)//Position - 0x5C6D
{
	if (func_74())
	{
		return;
...
void func_71(int iParam0)//Position - 0x5CA0
{
	if (func_74())
	{
		return;
...
void func_72(bool bParam0, bool bParam1)//Position - 0x5D1A
{
	if (bParam0)
	{
		if (func_73(0))
...
int func_73(int iParam0)//Position - 0x5D8E
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
bool func_74()//Position - 0x5DE8
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

void func_75()//Position - 0x5DFA
{
	Global_3960 = 0;
	func_76();
}

void func_76()//Position - 0x5E0A
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_77(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x5E2B
{
...
void func_78(int iParam0)//Position - 0x5FBA
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_79(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x5FE6
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_83(CAM::_0xDC9DA9E8789F5246())) && !func_81(CAM::_0xDC9DA9E8789F5246(), 0)) && !func_80()) && !bParam4)
			{
				ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_83(CAM::_0xDC9DA9E8789F5246())) && !bParam4)
		{
			ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), false);
		}
		Global_11623 = 0;
...
int func_82(int iParam0, bool bParam1)//Position - 0x6177
{
	int iVar0;
	int iVar1;
...
int func_83(int iParam0)//Position - 0x61B8
{
...
bool func_84()//Position - 0x61FA
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_240006, 3);
}

int func_85(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x620B
{
	int iVar0;
...
void func_86(int iParam0)//Position - 0x623E
{
	if (iParam0 == 1)
	{
...
void func_87()//Position - 0x6261
{
	Global_3960 = 0;
	func_57();
}

int func_88()//Position - 0x6271
{
...
int func_90(bool bParam0, bool bParam1, bool bParam2)//Position - 0x62B4
{
	int iVar0;
...
bool func_91(int iParam0)//Position - 0x6399
{
	return func_92(func_93(iParam0));
}

int func_92(char* sParam0)//Position - 0x63AB
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

char* func_93(int iParam0)//Position - 0x63BE
{
	char* sVar0;
...
int func_94()//Position - 0x6401
{
	switch (iLocal_72)
	{
		case 1:
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -190.8152f, -801.3224f, 25.45401f, -214.8212f, -866.6472f, 35.0318f, 40f, 0, true, 0))
			{
				return 1;
			}
			break;
		...
		case 2:
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 270.5801f, -1290.954f, 24.16572f, 270.499f, -1238.311f, 34.52738f, 58.25f, 0, true, 0))
			{
				return 1;
			}
			break;
		...
		case 3:
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -3038.987f, 606.4774f, 2.589385f, -3057.039f, 599.7103f, 12.70948f, 19.25f, 0, true, 0))
			{
				return 1;
			}
			break;
		...
		case 4:
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 170.8581f, 6619.894f, 30.31941f, 183.9522f, 6632.882f, 34.06088f, 22.25f, 0, true, 0))
			{
				return 1;
			}
			break;
		...
		case 6:
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -9.663248f, -938.2167f, 24.29024f, 48.12534f, -959.4428f, 34.60982f, 7.5f, 0, true, 0))
			{
				return 1;
			}
			break;
		...
		case 8:
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 283.0487f, -923.3091f, 24.13956f, 301.367f, -871.6924f, 34.4707f, 6.75f, 0, true, 0))
			{
				return 1;
			}
			break;
		...
		case 11:
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1053.799f, -772.7601f, 53.31232f, 1112.018f, -772.2864f, 60.16156f, 14.75f, 0, true, 0))
			{
				return 1;
			}
			break;
		...
		case 16:
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -2097.21f, -292.7766f, 8.141721f, -2101.908f, -345.41f, 18.23235f, 54.25f, 0, true, 0))
			{
				return 1;
			}
			break;
		...
		case 17:
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -799.6841f, -1117.781f, 5.659806f, -820.5555f, -1080.585f, 16.38764f, 29.5f, 0, true, 0))
			{
				return 1;
			}
			break;
		...
		case 18:
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -731.1746f, -820.053f, 18.06713f, -670.6583f, -821.2724f, 29.66125f, 8f, 0, true, 0))
			{
				return 1;
			}
			break;
		...
		case 19:
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -379.9555f, 6033.261f, 29.74875f, -394.2914f, 6047.678f, 33.9986f, 7f, 0, true, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -393.6422f, 6056.547f, 29.75011f, -402.4834f, 6047.817f, 33.99312f, 17.5f, 0, true, 0))
			{
				return 1;
			}
			break;
		...
		case 22:
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -294.338f, -833.5905f, 26.65178f, -330.661f, -827.2508f, 38.64983f, 16.5f, 0, true, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -294.1309f, -836.8602f, 26.72095f, -284.6938f, -814.233f, 37.38612f, 11f, 0, true, 0))
			{
				return 1;
			}
			break;
		...
		case 23:
			if ((!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -253.9362f, -689.096f, 28.56934f, -278.4698f, -682.0773f, 38.52502f, 9.5f, 0, true, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -253.3138f, -687.6628f, 28.5611f, -247.2367f, -703.1184f, 38.8144f, 9.5f, 0, true, 0)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -255.6709f, -726.2742f, 28.5187f, -247.2367f, -703.1184f, 38.8144f, 9.5f, 0, true, 0))
			{
				return 1;
			}
			break;
		...
		case 25:
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 114.2641f, -9.324284f, 62.78819f, 75.47891f, 4.897117f, 73.96004f, 7f, 0, true, 0))
			{
				return 1;
			}
			break;
		...
		case 30:
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -544.5211f, -1200.006f, 12.87966f, -509.3911f, -1216.772f, 23.72543f, 41f, 0, true, 0))
			{
				return 1;
			}
			break;
		...
		case 31:
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -2945.132f, 491.4792f, 13.2899f, -2971.825f, 492.9101f, 18.0671f, 10f, 0, true, 0))
			{
				return 1;
			}
			break;
...
void func_95()//Position - 0x68DC
{
	...
	if (!bLocal_95)
	{
		...
		else
		{
			if (!PED::IS_PED_INJURED(iLocal_55))
			{
				if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_55) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_55))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_55, 25f, 25f, 25f, 0, 1, 0))
					{
						iLocal_126 = 1;
		...
		if (!bLocal_127)
		{
			if (bLocal_90)
			{
				if (OBJECT::HAS_PICKUP_BEEN_COLLECTED(iLocal_89))
				{
					...
					STATS::STAT_GET_INT(joaat("rc_wallets_recovered"), &uVar0, 4294967295);
				...
				{
					if (SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), OBJECT::GET_PICKUP_COORDS(iLocal_89)) > 150f)
					{
						if (PED::IS_PED_INJURED(iLocal_56))
						{
							func_268();
						}
						else if (SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_56, true)) > 100f)
						{
							func_268();
						}
					}
...
void func_96(int iParam0)//Position - 0x69E5
{
	switch (iParam0)
	{
		case 0:
			if (Global_19E56.f_6187.f_2 < 3)
			{
				...
				{
					func_97(func_93(iParam0), 4294967295);
...
void func_97(char* sParam0, int iParam1)//Position - 0x6AC6
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

void func_98(var uParam0)//Position - 0x6ADD
{
	*uParam0 = 4294967197;
}

int func_99(int iParam0, bool bParam1, int iParam2)//Position - 0x6AEB
{
	iParam2 = iParam2;
	return func_100(iParam0, bParam1, 145);
}

int func_100(int iParam0, bool bParam1, int iParam2)//Position - 0x6B01
{
	int iVar0;
...
int func_101(int iParam0, bool bParam1, bool bParam2)//Position - 0x6B53
{
	int iVar0;
...
float func_102(bool bParam0, float fParam1, float fParam2)//Position - 0x6BF7
{
	if (bParam0)
	{
		return fParam1;
	...
	else
	{
		if (!iLocal_91)
		{
			if (!func_172(iLocal_56, 242628503) && !PED::IS_PED_INJURED(iLocal_56))
			{
				...
				BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), 0);
				BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_149, 8f, -2f, 4294967295, 0, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_151, 8f, -2f, 4294967295, 0, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_150, 8f, -2f, 4294967295, 1, 0, 0, 0, 0);
				CUTSCENE::_0x8D9DF6ECA8768583(iLocal_61);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_56, iLocal_61);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_61);
			}
			...
			if (!bLocal_95)
			{
				if (!PED::IS_PED_INJURED(iLocal_56))
				{
					...
					else if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_56, 242628503) == 7)
					{
						NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_56);
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
						BRAIN::TASK_PLAY_ANIM(0, cLocal_93, "pickup_low", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
						BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 3000, 2048, 2);
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), 3000);
						BRAIN::TASK_WANDER_STANDARD(0, 1193033728, 0);
						CUTSCENE::_0x8D9DF6ECA8768583(iLocal_61);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_56, iLocal_61);
...
int func_104(int iParam0)//Position - 0x6F17
{
	return func_105(iParam0);
}

int func_105(int iParam0)//Position - 0x6F25
{
	int iVar0;
...
int func_106(int iParam0)//Position - 0x6F5D
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_107()//Position - 0x6F7E
{
	...
	switch (iLocal_65)
	{
		...
		case 2:
			...
			if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_73, 0) && PED::IS_PED_IN_VEHICLE(iLocal_55, iLocal_73, 0))
			{
			...
			else if (!OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_73, 0) || !func_172(iLocal_55, 3021937204))
			{
				bVar0 = true;
			}
			if (!PED::IS_PED_FLEEING(iLocal_55))
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_55, 3021937204) == 7)
				{
					bVar0 = true;
				}
			}
			if (bVar0)
			{
				if (!iLocal_86)
				{
					...
					{
						NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_55);
						if (func_106(AUDIO::_0x0626A247D2405330()))
						{
							BRAIN::TASK_COMBAT_PED(iLocal_55, AUDIO::_0x0626A247D2405330(), 0, 16);
						}
						iLocal_86 = 1;
					}
				}
...
int func_108()//Position - 0x710C
{
	if (!PED::IS_PED_INJURED(iLocal_55))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_55, 180f, 180f, 50f, 0, 1, 0) || !ENTITY::IS_ENTITY_OCCLUDED(iLocal_55))
		{
	...
	else if (SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), unk_0x8000C77B5F336760(iLocal_55, false)) < 300f)
	{
		return 1;
	}
	return 0;
...
void func_109(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)//Position - 0x71B9
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_110(int iParam0, char* sParam1, int iParam2)//Position - 0x7312
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_111(iParam2), 1);
}

int func_111(int iParam0)//Position - 0x7329
{
	int iVar0;
...
float func_112(int iParam0, int iParam1, bool bParam2)//Position - 0x751E
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_113(int iParam0, var uParam1)//Position - 0x757C
{
	if (HUD::DOES_BLIP_EXIST(iParam0))
	{
		...
		if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && func_114(0))
		{
			func_96(1);
		}
	}
...
bool func_114(int iParam0)//Position - 0x75DA
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E52, iParam0);
}

void func_115()//Position - 0x75EC
{
	switch (iLocal_65)
	{
		case 1:
		case 2:
			if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_73, 0))
			{
				if (iLocal_126)
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(iLocal_55, iLocal_73) || BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_55, 3021937204) == 1)
					{
				...
				else
				{
					if (!VEHICLE::DOES_VEHICLE_HAVE_STUCK_VEHICLE_CHECK(iLocal_73))
					{
						VEHICLE::ADD_VEHICLE_STUCK_CHECK_WITH_WARP(iLocal_73, 0.1f, 1000, 0, 0, 0, 4294967295);
					}
					BRAIN::TASK_VEHICLE_MISSION_COORS_TARGET(iLocal_55, iLocal_73, unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), 8, 35f, 786469, 10f, 10f, 1);
				}
			}
			else
			{
		...
		default:
			...
			{
				BRAIN::TASK_SMART_FLEE_COORD(iLocal_55, unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), 300f, 4294967295, 0, 0);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_61);
			}
			else if (iLocal_126)
			{
...
bool func_116(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x77E3
{
...
int func_117(char* sParam0, int iParam1, bool bParam2)//Position - 0x7831
{
	Global_3DCF = 0;
	if (Global_3DCE == 0 || Global_3DD0 == 2)
	{
...
bool func_118()//Position - 0x7AFD
{
	...
	if (!PED::IS_PED_INJURED(iLocal_56))
	{
		if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
		{
			if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_56))
			{
				iLocal_67++;
				if (iLocal_67 > 60)
				{
		...
		if (FIRE::IS_EXPLOSION_IN_SPHERE(4294967295, PED::GET_PED_BONE_COORDS(iLocal_56, 31086, 0f, 0f, 0f), 50f))
		{
			bVar0 = true;
		}
	}
...
int func_119(int iParam0)//Position - 0x7C4E
{
	if (func_106(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
bool func_121()//Position - 0x7C96
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
	{
		...
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_56, AUDIO::_0x0626A247D2405330(), 1) && PED::IS_PED_RAGDOLL(iLocal_56))
			{
				bVar0 = true;
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_56);
			}
			if (MISC::IS_BULLET_IN_AREA(unk_0x8000C77B5F336760(iLocal_56, true), 1f, 1))
			{
				bVar0 = true;
			}
...
int func_122(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x7D7B
{
	vector3 vVar0;
	
	if (func_106(AUDIO::_0x0626A247D2405330()) && func_106(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(AUDIO::_0x0626A247D2405330()))
			{
				...
				{
					return func_135(AUDIO::_0x0626A247D2405330(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_123(int iParam0, float fParam1)//Position - 0x7E36
{
	float fVar0;
	
	if (func_106(AUDIO::_0x0626A247D2405330()) && func_106(iParam0))
	{
		if (func_134(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iParam0))
		{
			if (WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6))
			{
				fVar0 = 40f;
...
bool func_124(int iParam0, float fParam1)//Position - 0x7EAC
{
	return func_125(iParam0, AUDIO::_0x0626A247D2405330(), fParam1, 1, 250, 7);
}

bool func_125(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x7EC4
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_126(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x7F85
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_127(int iParam0, int iParam1)//Position - 0x80B3
{
	int iVar0;
...
int func_129(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x81C2
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_131(unk_0x8000C77B5F336760(iParam1, true) - unk_0x8000C77B5F336760(iParam0, true)) };
...
float func_130(vector3 vParam0, vector3 vParam1)//Position - 0x8253
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_131(vector3 vParam0)//Position - 0x8274
{
	float fVar0;
	float fVar1;
...
void func_132(var uParam0)//Position - 0x82B3
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_133(int iParam0, int iParam1)//Position - 0x82CE
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0x830D
{
...
bool func_135(int iParam0, int iParam1, float fParam2)//Position - 0x8335
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_136(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x837C
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_137(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x8477
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_138(int iParam0, float fParam1)//Position - 0x8583
{
	var uVar0;
	vector3 vVar1;
...
int func_139(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0x8618
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_131(vParam1 - unk_0x8000C77B5F336760(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_140(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x86A6
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
...
void func_142(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x8725
{
	func_143(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_143(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x873F
{
	func_144(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_144(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x875C
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 1))
	{
...
void func_145(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x8794
{
	int iVar0;
	int iVar1;
...
void func_146(var uParam0)//Position - 0x8B01
{
	if (func_168(AUDIO::_0x0626A247D2405330()))
	{
		BRAIN::TASK_CLEAR_LOOK_AT(AUDIO::_0x0626A247D2405330());
	}
	if (CAM::IS_GAMEPLAY_HINT_ACTIVE())
...
int func_147(var uParam0)//Position - 0x8B6A
{
	int iVar0;
...
int func_148(bool bParam0)//Position - 0x8B95
{
	switch (Global_8D15)
	{
		case 0:
...
int func_149(char* sParam0)//Position - 0x8C3F
{
	if (!func_150(1, 1, 0))
	{
		if ((!MISC::IS_STRING_NULL_OR_EMPTY(sParam0) && func_92(sParam0)) || func_92("CMN_HINT"))
		{
			GRAPHICS::SET_SCRIPT_GFX_DRAW_BEHIND_PAUSEMENU(1);
		}
		return 0;
...
int func_150(bool bParam0, bool bParam1, bool bParam2)//Position - 0x8CD8
{
	int iVar0;
	int iVar1;
	...
	if ((func_158() || func_157(Global_440000.f_2559E)) || func_156())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0);
			iVar1 = func_155(AUDIO::_0x0626A247D2405330(), 0);
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("APC") && iVar1 != 4294967295)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("AKULA") && iVar1 != 4294967295)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("RIOT2") && iVar1 == 0) && func_154(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != 4294967295))
			{
				return 0;
			}
		}
	}
	if (func_151(CAM::_0xDC9DA9E8789F5246()))
	{
		return 0;
	}
	return 1;
...
int func_151(int iParam0)//Position - 0x8F26
{
	if (iParam0 != func_153())
	{
		...
		else if ((Global_140859 && iParam0 == CAM::_0xDC9DA9E8789F5246()) && func_152(iParam0, 1, 0))
		{
			return Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295;
		}
	}
...
int func_152(int iParam0, bool bParam1, bool bParam2)//Position - 0x8F8C
{
	int iVar0;
...
int func_153()//Position - 0x8FD6
{
	return 4294967295;
}

int func_154(int iParam0, int iParam1)//Position - 0x8FDF
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
...
int func_155(int iParam0, int iParam1)//Position - 0x9041
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_156()//Position - 0x90C6
{
	return Global_255C02.f_10;
}

bool func_157(int iParam0)//Position - 0x90D4
{
	return iParam0 == 51;
}

var func_158()//Position - 0x90E1
{
	return Global_255C02.f_F;
}

bool func_159()//Position - 0x90EF
{
	return MISC::GET_GAME_TIMER() <= Global_43D7.f_16F1 + 100;
}

void func_160(var uParam0, int iParam1, vector3 vParam2, int iParam3)//Position - 0x9104
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_161()//Position - 0x9214
{
	return func_162(CAM::_0xDC9DA9E8789F5246());
}

int func_162(int iParam0)//Position - 0x9224
{
...
int func_163(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x9243
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_166(bParam1, bParam2, bParam3) || PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 1) || func_164(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
int func_164(bool bParam0, bool bParam1, bool bParam2)//Position - 0x95AF
{
...
int func_165(bool bParam0, bool bParam1, bool bParam2)//Position - 0x9601
{
	if (!func_150(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_166(bool bParam0, bool bParam1, bool bParam2)//Position - 0x964A
{
	if (!func_150(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_167(bool bParam0, bool bParam1, bool bParam2)//Position - 0x96A9
{
	if (!func_150(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_168(int iParam0)//Position - 0x96FF
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(iParam0))
...
void func_169()//Position - 0x975A
{
	MISC::SET_BIT(&Global_950, 4);
}

void func_170(var uParam0, int iParam1, int iParam2)//Position - 0x976A
{
	char* sVar0;
...
float func_171(int iParam0, vector3 vParam1, bool bParam2)//Position - 0x9847
{
	vector3 vVar0;
...
int func_172(int iParam0, int iParam1)//Position - 0x9881
{
	if (func_119(iParam0))
	{
...
void func_173(char* sParam0)//Position - 0x98B4
{
	func_174(sParam0);
}

void func_174(char* sParam0)//Position - 0x98C2
{
...
void func_175(var uParam0, int iParam1)//Position - 0x98D5
{
...
void func_176()//Position - 0x98F2
{
	BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
	BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_55, 750);
	BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_149, 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
	BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_150, 8f, -2f, 4294967295, 0, 0, 0, 0, 0);
	BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_151, 8f, -2f, 4294967295, 0, 0, 0, 0, 0);
	BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_149, 8f, -2f, 4294967295, 0, 0, 0, 0, 0);
	BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_150, 8f, -2f, 4294967295, 0, 0, 0, 0, 0);
	BRAIN::TASK_PLAY_ANIM(0, cLocal_148, sLocal_151, 8f, -2f, 4294967295, 1, 0, 0, 0, 0);
	CUTSCENE::_0x8D9DF6ECA8768583(iLocal_61);
	BRAIN::TASK_PERFORM_SEQUENCE(iLocal_56, iLocal_61);
	BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_61);
	...
	func_115();
	if ((SYSTEM::VDIST(unk_0x8000C77B5F336760(iLocal_56, false), -2956.26f, 487.97f, 15.46f) > 5f && MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_53, -203.72f, -861.8f, 29.27f, true) > 5f) && MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_53, 288.46f, -1256.71f, 28.44f, true) > 5f)
	{
		if (func_112(AUDIO::_0x0626A247D2405330(), iLocal_56, 1) < 50f)
		{
	...
	if (func_106(AUDIO::_0x0626A247D2405330()))
	{
		AUDIO::STOP_PED_SPEAKING(AUDIO::_0x0626A247D2405330(), true);
	}
	func_177(1);
}

int func_177(int iParam0)//Position - 0x9AA9
{
	if (func_179())
	{
		Global_19E4C = 1;
		Global_19E49 = MISC::GET_GAME_TIMER();
		if (func_178(Global_19E4B))
		{
			func_96(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_178(Global_19E4B))
		{
...
int func_178(int iParam0)//Position - 0x9AFC
{
	switch (iParam0)
	{
		case 29:
...
int func_179()//Position - 0x9B2B
{
	switch (func_180(&Global_63AE, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_180(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x9B61
{
	int iVar0;
...
void func_181(var uParam0, int iParam1)//Position - 0x9C98
{
	int iVar0;
...
bool func_182(int iParam0)//Position - 0x9CE7
{
	return func_183(iParam0, Global_8D15);
}

int func_183(int iParam0, int iParam1)//Position - 0x9CF8
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_184(int iParam0)//Position - 0x9ED9
{
	if (Global_8D15 == 15)
	{
		return 0;
...
int func_185()//Position - 0x9EFB
{
	...
	if (FIRE::IS_EXPLOSION_IN_SPHERE(4294967295, vLocal_53, 50f))
	{
		return 1;
	}
	...
	if (HUD::DOES_BLIP_EXIST(iLocal_59))
	{
		...
		{
			if (CAM::IS_SPHERE_VISIBLE(unk_0x8000C77B5F336760(iLocal_55, false), 2.5f))
			{
				return 1;
			}
		}
...
void func_186()//Position - 0x9FE9
{
	if (SYSTEM::VDIST(vLocal_53, -3044.06f, 594.93f, 6.74f) < 5f)
	{
		if (!HUD::DOES_BLIP_EXIST(iLocal_59))
		{
			if (func_106(iLocal_56) && func_106(AUDIO::_0x0626A247D2405330()))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 60f, 90f, 12f, 0, 1, 0))
				{
					iLocal_59 = func_99(iLocal_55, 1, 0);
	...
	else if (!HUD::DOES_BLIP_EXIST(iLocal_59))
	{
		if (func_106(iLocal_56) && func_106(AUDIO::_0x0626A247D2405330()))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 90f, 90f, 8f, 0, 1, 0))
			{
				iLocal_59 = func_99(iLocal_55, 1, 0);
				HUD::_0x75A16C3DA34F1245(iLocal_59, false);
			}
...
int func_187()//Position - 0xA0D4
{
	...
	if (func_189())
	{
		...
		ENTITY::SET_ENTITY_HEALTH(iLocal_55, true);
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_55, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_92, "b_atm_mugging", vVar0, vVar1, 0f, 2), 0, 0, 1);
		...
		if (func_106(iLocal_56))
		{
			if (PED::IS_PED_MALE(iLocal_56))
			{
				ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_56, PED::GET_ANIM_INITIAL_OFFSET_POSITION("random@atmrobberygen@male", "idle_a", vVar0, vVar1, 0f, 2), 0, 0, 1);
				vVar3 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION("random@atmrobberygen@male", "idle_a", vVar0, vVar1, 0f, 2) };
			}
			else
			{
				ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_56, PED::GET_ANIM_INITIAL_OFFSET_POSITION("random@atmrobberygen@female", "idle_a", vVar0, vVar1, 0f, 2), 0, 0, 1);
		...
		BRAIN::TASK_PLAY_ANIM(iLocal_55, cLocal_92, "b_atm_mugging", 1000f, -4f, 4294967295, 1, 0, 0, 0, 0);
		if (PED::IS_PED_MALE(iLocal_56))
		{
			BRAIN::TASK_PLAY_ANIM(iLocal_56, "random@atmrobberygen@male", "idle_a", 1000f, -4f, 4294967295, 1, 0, 0, 0, 0);
			STREAMING::REMOVE_ANIM_DICT("random@atmrobberygen@female");
		}
		else
		{
			BRAIN::TASK_PLAY_ANIM(iLocal_56, "random@atmrobberygen@female", "idle_a", 1000f, -4f, 4294967295, 1, 0, 0, 0, 0);
			STREAMING::REMOVE_ANIM_DICT("random@atmrobberygen@male");
		}
		NETWORK::_SET_NETWORK_OBJECT_NON_CONTACT(iLocal_55, 1);
		ENTITY::SET_ENTITY_HEALTH(iLocal_56, true);
		WEAPON::GIVE_WEAPON_TO_PED(iLocal_55, joaat("weapon_pistol"), 4294967295, true, true);
		...
		func_188(&Local_107, 0, AUDIO::_0x0626A247D2405330(), sLocal_112, 0, 1);
...
void func_188(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xA790
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
int func_189()//Position - 0xA82B
{
	...
	if (!iLocal_81)
	{
		...
		Local_164.f_92 = MISC::GET_FRAME_COUNT();
...
int func_190(var uParam0)//Position - 0xA8D0
{
	int iVar0;
...
bool func_191(var uParam0)//Position - 0xA932
{
	return func_192(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

int func_192(int iParam0, char* sParam1, int iParam2)//Position - 0xA949
{
...
int func_193(int iParam0)//Position - 0xAA3D
{
	int iVar0;
...
void func_194(var uParam0, char* sParam1)//Position - 0xAA69
{
	func_195(uParam0, 1, 4294967295, sParam1, 0);
}

void func_195(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4)//Position - 0xAA7C
{
	int iVar0;
...
void func_196(var uParam0, int iParam1)//Position - 0xAB64
{
	func_195(uParam0, 0, iParam1, "NULL", 0);
}

void func_197(var uParam0, int iParam1)//Position - 0xAB78
{
	if (iParam1 > 0)
	{
...
int func_198()//Position - 0xAB8F
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), vLocal_51) < (75f * 75f))
		{
			return 1;
		}
...
int func_199(float fParam0, bool bParam1)//Position - 0xAC15
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_200(int iParam0, var uParam1)//Position - 0xACCC
{
	switch (iParam0)
	{
		case 0:
		...
		case 1:
			func_201(uParam1, "Abigail2", func_203(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, 4294967295, 4, 1, 0, 2359, func_202(iParam0), 1, 0);
			break;
		
		case 2:
			func_201(uParam1, "Barry1", func_203(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 0, 2359, func_202(iParam0), 1, 0);
			break;
		
		case 3:
			func_201(uParam1, "Barry2", func_203(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_202(iParam0), 1, 1);
			break;
		
		case 4:
			func_201(uParam1, "Barry3", func_203(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", 4294967295, 0, "", 164, 1, 4294967295, 0, 2, 0, 2359, func_202(iParam0), 0, 0);
			break;
		...
		case 7:
			func_201(uParam1, "Barry4", func_203(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, 4294967295, 4, 2, 800, 2000, func_202(iParam0), 0, 0);
			break;
		
		case 8:
			func_201(uParam1, "Dreyfuss1", func_203(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_202(iParam0), 0, 0);
			break;
		...
		case 15:
			func_201(uParam1, "Epsilon7", func_203(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", 4294967295, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_202(iParam0), 0, 0);
			break;
		
		case 16:
			func_201(uParam1, "Epsilon8", func_203(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, 4294967295, 4, 1, 0, 2359, func_202(iParam0), 1, 0);
			break;
		
		case 17:
			func_201(uParam1, "Extreme1", func_203(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", 4294967295, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_202(iParam0), 0, 1);
			break;
		...
		case 20:
			func_201(uParam1, "Extreme4", func_203(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_202(iParam0), 0, 0);
			break;
		
		case 21:
			func_201(uParam1, "Fanatic1", func_203(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 700, 2000, func_202(iParam0), 1, 0);
			break;
		
		case 22:
			func_201(uParam1, "Fanatic2", func_203(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 700, 2000, func_202(iParam0), 1, 0);
			break;
		
		case 23:
			func_201(uParam1, "Fanatic3", func_203(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 2, 700, 2000, func_202(iParam0), 0, 1);
			break;
		
		case 24:
			func_201(uParam1, "Hao1", func_203(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", 4294967295, 0, "controller_Races", 13, 1, 4294967295, 4, 2, 2000, 500, func_202(iParam0), 0, 1);
			break;
		
		case 25:
			func_201(uParam1, "Hunting1", func_203(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", 4294967295, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_202(iParam0), 0, 1);
			break;
		
		case 26:
			func_201(uParam1, "Hunting2", func_203(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, 4294967295, 4, 4, 0, 2359, func_202(iParam0), 0, 1);
			break;
		
		case 27:
			func_201(uParam1, "Josh1", func_203(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", 4294967295, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_202(iParam0), 1, 0);
			break;
		...
		case 29:
			func_201(uParam1, "Josh3", func_203(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 4294967295, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_202(iParam0), 1, 1);
			break;
		
		case 30:
			func_201(uParam1, "Josh4", func_203(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", 4294967295, 36, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_202(iParam0), 1, 0);
			break;
		
		case 31:
			func_201(uParam1, "Maude1", func_203(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", 4294967295, 0, "BailBond_Launcher", 0, 1, 4294967295, 4, 4, 0, 2359, func_202(iParam0), 0, 1);
			break;
		
		case 32:
			func_201(uParam1, "Minute1", func_203(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", 4294967295, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_202(iParam0), 0, 1);
			break;
		
		case 33:
			func_201(uParam1, "Minute2", func_203(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", 4294967295, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_202(iParam0), 0, 1);
			break;
		
		case 34:
			func_201(uParam1, "Minute3", func_203(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", 4294967295, 10, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_202(iParam0), 0, 1);
			break;
		
		case 35:
			func_201(uParam1, "MrsPhilips1", func_203(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", 4294967295, 0, "ambient_MrsPhilips", 0, 1, 4294967295, 4, 4, 0, 2359, func_202(iParam0), 0, 0);
			break;
		
		case 36:
			func_201(uParam1, "MrsPhilips2", func_203(iParam0), 0, 11, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_202(iParam0), 0, 0);
			break;
		
		case 37:
			func_201(uParam1, "Nigel1", func_203(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", 4294967295, 0, "", 177, 1, 4294967295, 1, 4, 0, 2359, func_202(iParam0), 1, 0);
			break;
		...
		case 42:
			func_201(uParam1, "Nigel2", func_203(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", 4294967295, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_202(iParam0), 1, 1);
			break;
		
		case 43:
			func_201(uParam1, "Nigel3", func_203(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", 4294967295, 16, "postRC_Nigel3", 0, 0, 4294967295, 4, 4, 0, 2359, func_202(iParam0), 1, 1);
			break;
		
		case 44:
			func_201(uParam1, "Omega1", func_203(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", 4294967295, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_202(iParam0), 0, 0);
			break;
		
		case 45:
			func_201(uParam1, "Omega2", func_203(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_202(iParam0), 0, 0);
			break;
		
		case 46:
			func_201(uParam1, "Paparazzo1", func_203(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", 4294967295, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_202(iParam0), 0, 1);
			break;
		
		case 47:
			func_201(uParam1, "Paparazzo2", func_203(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", 4294967295, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_202(iParam0), 0, 1);
			break;
		
		case 48:
			func_201(uParam1, "Paparazzo3", func_203(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", 4294967295, 8, "", 183, 1, 4294967295, 2, 2, 0, 2359, func_202(iParam0), 0, 0);
			break;
		...
		case 51:
			func_201(uParam1, "Paparazzo4", func_203(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", 4294967295, 8, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_202(iParam0), 0, 0);
			break;
		
		case 52:
			func_201(uParam1, "Rampage1", func_203(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", 4294967295, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_202(iParam0), 0, 0);
			break;
		
		case 54:
			func_201(uParam1, "Rampage3", func_203(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", 4294967295, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_202(iParam0), 1, 0);
			break;
		
		case 55:
			func_201(uParam1, "Rampage4", func_203(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", 4294967295, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_202(iParam0), 1, 0);
			break;
		
		case 56:
			func_201(uParam1, "Rampage5", func_203(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", 4294967295, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_202(iParam0), 0, 0);
			break;
		
		case 53:
			func_201(uParam1, "Rampage2", func_203(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", 4294967295, 0, "rampage_controller", 0, 0, 4294967295, 4, 4, 0, 2359, func_202(iParam0), 1, 0);
			break;
		
		case 57:
			func_201(uParam1, "TheLastOne", func_203(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_202(iParam0), 0, 1);
			break;
		
		case 58:
			func_201(uParam1, "Tonya1", func_203(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", 4294967295, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_202(iParam0), 0, 1);
			break;
		
		case 59:
			func_201(uParam1, "Tonya2", func_203(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_202(iParam0), 0, 1);
			break;
		
		case 60:
			func_201(uParam1, "Tonya3", func_203(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_202(iParam0), 0, 1);
			break;
		
		case 61:
			func_201(uParam1, "Tonya4", func_203(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_202(iParam0), 0, 1);
			break;
		
		case 62:
			func_201(uParam1, "Tonya5", func_203(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_202(iParam0), 0, 1);
			break;
...
void func_201(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0xBE81
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_202(int iParam0)//Position - 0xBF12
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_203(int iParam0)//Position - 0xC33F
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_204(int iParam0)//Position - 0xC376
{
	struct<2> Var0;
...
bool func_207()//Position - 0xC83A
{
	return Global_19D3C > 0;
}

int func_208()//Position - 0xC848
{
...
int func_214()//Position - 0xD47C
{
	if ((Global_19E4B == func_215() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_19E4C)
	{
		return 1;
	}
	return 0;
...
int func_216(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0xD4C4
{
...
void func_217(var uParam0)//Position - 0xD69E
{
	int iVar0;
...
void func_218(int iParam0)//Position - 0xD728
{
	func_219(iParam0, &(iParam0->f_2), iParam0->f_1);
}

void func_219(int iParam0, char* sParam1, int iParam2)//Position - 0xD73E
{
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 30))
	{
		switch (func_193(*iParam0))
...
void func_220(int iParam0, var uParam1)//Position - 0xD818
{
	int iVar0;
	int iVar1;
...
void func_221()//Position - 0xD8B7
{
}

void func_222()//Position - 0xD8BF
{
}

void func_223(int iParam0)//Position - 0xD8C7
{
...
void func_225(int iParam0)//Position - 0xD93A
{
	Global_19E4B = iParam0;
}

int func_226(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xD948
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_261(Global_19E56.f_6187.f_2B[iParam1]))
		{
			return 0;
		}
...
bool func_227(int iParam0)//Position - 0xDCE2
{
	int iVar0;
...
int func_228(int iParam0)//Position - 0xDD03
{
	return func_229(iParam0, 1);
}

int func_229(int iParam0, int iParam1)//Position - 0xDD12
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_230(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xDD65
{
	func_231(func_242(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_231(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xDD83
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_232(float fParam0, float fParam1, float fParam2)//Position - 0xDF84
{
	float fVar0;
...
int func_233(int iParam0, int iParam1)//Position - 0xDFC6
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_234(int iParam0)//Position - 0xE068
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_235(int iParam0)//Position - 0xE07B
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_236(int iParam0)//Position - 0xE08E
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_237(int iParam0)//Position - 0xE0A1
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_238(int iParam0)//Position - 0xE0B3
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_239(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}

int func_239(bool bParam0, int iParam1, int iParam2)//Position - 0xE0D8
{
	if (bParam0)
	{
		return iParam1;
...
int func_240(int iParam0)//Position - 0xE0EF
{
	return iParam0 & 15;
}

int func_241(int iParam0, int iParam1)//Position - 0xE0FC
{
	int iVar0;
	int iVar1;
...
int func_242()//Position - 0xE208
{
	var uVar0;
	
	func_248(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_247(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_246(&uVar0, CLOCK::GET_CLOCK_HOURS());
...
void func_243(var uParam0, int iParam1)//Position - 0xE24E
{
	if (iParam1 <= 0)
	{
		return;
...
void func_244(var uParam0, int iParam1)//Position - 0xE2D4
{
...
void func_245(var uParam0, int iParam1)//Position - 0xE307
{
	int iVar0;
	int iVar1;
...
void func_246(var uParam0, int iParam1)//Position - 0xE358
{
...
void func_247(var uParam0, int iParam1)//Position - 0xE392
{
...
void func_248(var uParam0, int iParam1)//Position - 0xE3CD
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_249(int iParam0)//Position - 0xE409
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_250(int iParam0, int iParam1)//Position - 0xE4E5
{
...
int func_251(int iParam0)//Position - 0xE508
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_259()) || Global_19A9D) || Global_6375) || func_258()) || func_56(8, 4294967295)) || func_257()) || func_256()) || func_255()) || func_254()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_259()) || Global_6375) || func_258()) || func_56(8, 4294967295)) || func_255()) || func_257()) || func_256()) || func_254()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_259()) || Global_19A9D) || Global_6375) || func_258()) || func_56(8, 4294967295)) || func_255()) || func_257()) || func_256()) || func_254()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_259()) || Global_19A9D) || Global_6375) || func_258()) || func_56(8, 4294967295)) || func_257()) || func_256()) || func_254()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_259() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_56(8, 4294967295)) || func_254()) || func_253()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_56(8, 4294967295) || func_257()) || func_256()) || func_253()) || func_252())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_259()) || Global_6375) || func_258()) || func_56(8, 4294967295)) || func_256()) || func_255()) || func_254()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_252()//Position - 0xEC25
{
	return Global_16C57.f_1;
}

int func_253()//Position - 0xEC33
{
	if (Global_16089 != 4294967295)
	{
...
bool func_256()//Position - 0xEC9D
{
	return Global_16C64.f_148 > 0;
}

bool func_257()//Position - 0xECAE
{
	return Global_16C64.f_147 > 0;
}

var func_258()//Position - 0xECBF
{
	return Global_140859;
}

int func_259()//Position - 0xECCB
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_261(int iParam0)//Position - 0xED0F
{
	return func_241(func_242(), iParam0);
}

int func_262(int iParam0, int iParam1, int iParam2)//Position - 0xED21
{
	int iVar0;
	int iVar1;
...
int func_263(int iParam0)//Position - 0xEE05
{
	if (!func_37(iParam0))
	{
		return 7;
...
bool func_264(int iParam0)//Position - 0xEE29
{
	int iVar0;
	bool bVar1;
...
bool func_266(bool bParam0)//Position - 0xEECB
{
...
void func_268()//Position - 0xEFB1
{
	...
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		AUDIO::STOP_PED_SPEAKING(AUDIO::_0x0626A247D2405330(), false);
	}
...
void func_269(int iParam0)//Position - 0xF08D
{
	char cVar0[64];
	...
	if (func_214())
	{
		...
		func_273(30000);
		StringCopy(&cVar0, func_272(Global_19E4B, 1), 64);
		if (func_271(Global_19E4B) > 0)
		{
	...
	func_270(&Global_63AE);
	Global_19E4C = 0;
	func_225(4294967295);
}

void func_270(var uParam0)//Position - 0xF142
{
	if (*uParam0 == 4294967295)
	{
		return;
...
int func_271(int iParam0)//Position - 0xF17F
{
	int iVar0;
...
char* func_272(int iParam0, bool bParam1)//Position - 0xF230
{
	switch (iParam0)
	{
		case 0:
...
void func_273(int iParam0)//Position - 0xF479
{
	Global_8F3C = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_274(int iParam0)//Position - 0xF48B
{
	func_275(iParam0, 0, func_280(iParam0));
}

void func_275(int iParam0, int iParam1, int iParam2)//Position - 0xF4A0
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_276(var uParam0)//Position - 0xF4CF
{
	struct<16> Var0;
	int iVar1;
...
void func_277(int iParam0, var uParam1)//Position - 0xF59F
{
	Global_19E56.f_6187.f_2B[iParam0] = *uParam1;
}

void func_278(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xF5B7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_279(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xF739
{
...
int func_280(int iParam0)//Position - 0xF771
{
	int iVar0;
...
void func_281(var uParam0, bool bParam1)//Position - 0xF914
{
	int iVar0;
...
void func_282(var uParam0)//Position - 0xF94F
{
	*uParam0 = 0;
...
void func_283(var uParam0)//Position - 0xF968
{
	int iVar0;
...
void func_284(var uParam0)//Position - 0xF9A1
{
	func_285(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

void func_285(int iParam0, char* sParam1, int iParam2)//Position - 0xF9B8
{
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 30))
	{
		switch (func_193(iParam0))
...
void func_286(bool bParam0)//Position - 0xFA78
{
	Global_19E4E = { vLocal_53 };
	if (bParam0)
	{
		func_301(3);
	}
...
void func_287()//Position - 0xFAAD
{
	func_288();
}

int func_288()//Position - 0xFABA
{
	if (func_266(0))
	{
		return 0;
...
int func_289()//Position - 0xFB05
{
	return 1;
}

void func_290(int iParam0, int iParam1)//Position - 0xFB0E
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_215();
...
void func_291(int iParam0, var uParam1, var uParam2)//Position - 0xFC12
{
	bool bVar0;
...
void func_292()//Position - 0xFCFA
{
	...
	{
		func_32(13, SYSTEM::FLOOR(Global_19E56.f_27B6.f_F0D));
	}
...
int func_293()//Position - 0x101BD
{
	return Global_6373;
}

int func_294(int iParam0, int iParam1)//Position - 0x101C8
{
	switch (iParam0)
	{
		case 0:
...
void func_295(int iParam0)//Position - 0x1053C
{
	int iVar0;
	int iVar1;
...
void func_296(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x1057E
{
	func_297(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_297(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x1059F
{
	int iVar0;
...
void func_298()//Position - 0x10772
{
	int iVar0;
...
int func_299(int iParam0)//Position - 0x10892
{
	int iVar0;
	int iVar1;
...
void func_300(int iParam0, int iParam1)//Position - 0x108D5
{
	MISC::SET_BIT(&(Global_19E56.f_6187.f_8[iParam0]), iParam1);
}

void func_301(int iParam0)//Position - 0x108F0
{
