...
int func_2()//Position - 0x118
{
	...
	if (func_5(&iLocal_87, 0f))
	{
		...
		{
			iVar1 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_69[iVar0], 4294967295, 0);
	...
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), vLocal_85, true) > 100f)
	{
		return 1;
	}
	return 0;
...
float func_6(var uParam0)//Position - 0x25A
{
	if (func_9(uParam0))
	{
		...
		{
			return (uParam0->f_1 - func_4(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*uParam0, 4)));
		}
	}
	return uParam0->f_1;
}
...
void func_13()//Position - 0x3B2
{
	...
	while (iVar0 < 4)
	{
		...
		{
			iVar2 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_73[iVar0], 4294967295, 0);
	...
	while (iVar0 < 4)
	{
		...
		{
			iVar3 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_77[iVar0], 4294967295, 0);
	...
	while (iVar0 < 4)
	{
		...
		{
			iVar4 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_81[iVar0], 4294967295, 0);
...
void func_14(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x503
{
	...
	BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(0, iParam1, vVar1, fParam2, 0, ENTITY::GET_ENTITY_MODEL(iParam1), iParam3, 2f, 5f);
	BRAIN::TASK_VEHICLE_DRIVE_WANDER(0, iParam1, fParam2, iParam3);
...
int func_20(int iParam0, int iParam1)//Position - 0x6ED
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_21(Global_16B5A) && iParam1 != 0)
		{
			Global_16B5A = 0;
		}
	}
...
void func_24()//Position - 0x830
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_27(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_25(iVar0) && (!func_19(14) || Global_19A3D))
			{
...
void func_32()//Position - 0xA0D
{
	...
	while (iVar0 < 12)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_69[iVar0], 0))
		{
			iVar3 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_69[iVar0], 4, iLocal_68[func_35()], 4294967295, 1, true);
			func_33(iVar3);
			ENTITY::_SET_ENTITY_SOMETHING(iLocal_69[iVar0], true);
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_73[iVar0], 0))
		{
			...
			{
				iVar4 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_73[iVar0], 4, iLocal_68[func_35()], 4294967295, 1, true);
				func_33(iVar4);
				ENTITY::_SET_ENTITY_SOMETHING(iLocal_69[iVar0], true);
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_77[iVar0], 0))
		{
			...
			{
				iVar5 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_77[iVar0], 4, iLocal_68[func_35()], 4294967295, 1, true);
				func_33(iVar5);
				ENTITY::_SET_ENTITY_SOMETHING(iLocal_69[iVar0], true);
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_81[iVar0], 0))
		{
			...
			{
				iVar6 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_81[iVar0], 4, iLocal_68[func_35()], 4294967295, 1, true);
				func_33(iVar6);
				ENTITY::_SET_ENTITY_SOMETHING(iLocal_69[iVar0], true);
...
void func_37(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4, int iParam5, var uParam6, var uParam7, int iParam8, var uParam9, var uParam10, int iParam11, var uParam12, var uParam13)//Position - 0x10D3
{
	...
	switch (iParam0)
	{
		...
		case 106:
			...
			func_46(iParam1, iParam2, iParam5, iParam8, iParam11);
			*(uParam12[0 /*3*/]) = { Vector(0f, 0f, -7.5f) + func_44(3204448256, 1056964608) };
			(*uParam13)[0] = (0f + MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f));
			*(uParam12[1 /*3*/]) = { Vector(12f, -21.6f, 0f) + func_44(3204448256, 1056964608) };
			(*uParam13)[1] = (-8.1f + MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f));
			*(uParam12[2 /*3*/]) = { Vector(0f, -6.3f, 2.4f) + func_44(3204448256, 1056964608) };
			(*uParam13)[2] = (0f + MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f));
			*(uParam12[3 /*3*/]) = { Vector(0f, -5.4f, 9.3f) + func_44(3204448256, 1056964608) };
		...
		case 107:
			...
			*(uParam12[0 /*3*/]) = { Vector(0f, -18.7658f, 17.4294f) + func_44(3204448256, 1056964608) };
			(*uParam13)[0] = (-82.86f + MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f));
			*(uParam12[1 /*3*/]) = { Vector(0f, -0.2185f, -8.4f) + func_44(3204448256, 1056964608) };
			(*uParam13)[1] = (326.88f + MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f));
			*(uParam12[2 /*3*/]) = { Vector(0f, 11.1031f, -1.0773f) + func_44(3204448256, 1056964608) };
			(*uParam13)[2] = (-16.56f + MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f));
			*(uParam12[3 /*3*/]) = { Vector(0f, 6.6924f, 3.6826f) + func_44(3204448256, 1056964608) };
		...
		case 209:
			...
			*(uParam12[0 /*3*/]) = { Vector(0f, -18.4198f, 12.4248f) + func_44(3204448256, 1056964608) };
			(*uParam13)[0] = (-42.9526f + MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f));
			*(uParam12[1 /*3*/]) = { Vector(0f, 6.1436f, -6.4904f) + func_44(3204448256, 1056964608) };
			(*uParam13)[1] = (0f + MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f));
			*(uParam12[2 /*3*/]) = { Vector(0f, -46.6f, 15.2f) + func_44(3204448256, 1056964608) };
			(*uParam13)[2] = (74.0878f + MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f));
			*(uParam12[3 /*3*/]) = { Vector(0f, -43.7f, 9f) + func_44(3204448256, 1056964608) };
		...
		case 210:
			...
			*(uParam12[0 /*3*/]) = { Vector(0f, -8.466f, -3.4877f) + func_44(3204448256, 1056964608) };
			(*uParam13)[0] = (-10.26f + MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f));
			*(uParam12[1 /*3*/]) = { Vector(0f, 5.6192f, -2.7229f) + func_44(3204448256, 1056964608) };
			(*uParam13)[1] = (2.3194f + MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f));
			*(uParam12[2 /*3*/]) = { Vector(0f, 5.1081f, 6.8717f) + func_44(3204448256, 1056964608) };
			(*uParam13)[2] = (350.1767f + MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f));
			*(uParam12[3 /*3*/]) = { Vector(0f, -9.6576f, 0.997f) + func_44(3204448256, 1056964608) };
...
void func_47(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x25A8
{
	...
	*(uParam0[0 /*3*/]) = { Vector(0f, -22.7769f, -9.2247f) + func_44(3204448256, 1056964608) };
	*(uParam0[1 /*3*/]) = { Vector(0f, -21.4697f, -0.889f) + func_44(3204448256, 1056964608) };
	iVar1 = 2;
	while (iVar1 <= (*uParam0 - 1))
	{
		...
		*(uParam0[iVar1 /*3*/]) = { *(uParam0[iVar1 /*3*/]) + func_44(3204448256, 1056964608) };
	...
	*(uParam4[0 /*3*/]) = { Vector(0f, 8.1f, 2.1f) + func_44(3204448256, 1056964608) };
	*(uParam4[1 /*3*/]) = { Vector(0f, 15.3f, 4.4f) + func_44(3204448256, 1056964608) };
	*(uParam4[2 /*3*/]) = { Vector(-11.4f, -15.3f, -23.7f) + func_44(3204448256, 1056964608) };
	*(uParam4[3 /*3*/]) = { Vector(-12.7f, -10.9f, -13.4f) + func_44(3204448256, 1056964608) };
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[0];
			StringCopy(sParam2, func_54(Global_19E56.f_933.f_21B.f_8F6[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[1];
			StringCopy(sParam2, func_54(Global_19E56.f_933.f_21B.f_8F6[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[2];
			StringCopy(sParam2, func_54(Global_19E56.f_933.f_21B.f_8F6[2]), 32);
			return 1;
			break;
