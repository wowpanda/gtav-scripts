...
void __EntryFunction__()
{
	...
	SET_BIT(&Global_71838, 7);
	if (!DOES_CAM_EXIST(uLocal_930))
	{
		uLocal_930 = CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -1652.227f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, 1, 2);
		SET_CAM_PARAMS(uLocal_930, -1652.227f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, 0, 1, 1, 2);
	...
	if (func_54(PLAYER_PED_ID()))
	{
		...
		CLEAR_AREA_OF_PROJECTILES(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 60f, 0);
	...
	{
		func_51();
		func_54(PLAYER_PED_ID());
		WAIT(0);
	}
	PLAY_STREAM_FRONTEND();
	if (DOES_CAM_EXIST(uLocal_930))
	{
		SET_CAM_PARAMS(uLocal_930, -1651.501f, -1118.395f, 23.5181f, 3.435f, 0f, -152.2412f, 50.1098f, 5000, 1, 1, 2);
		iVar12 = GET_GAME_TIMER() + 5000;
	}
	while (!func_48(&uLocal_41) && !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		func_51();
		func_54(PLAYER_PED_ID());
		WAIT(0);
	}
	if (func_54(GET_PLAYERS_LAST_VEHICLE()))
	{
		if (func_47(GET_PLAYERS_LAST_VEHICLE(), joaat("bagger")))
		{
			func_33(-1633.43f, -1111.998f, 11.02252f, -1661.27f, -1142.66f, 25.51722f, 12f, -1630.952f, -1107.58f, 12.0215f, 51.9704f, 1, 1, 1, 0, 0);
		}
		else if (func_47(GET_PLAYERS_LAST_VEHICLE(), joaat("sandking")))
		{
	...
	WAIT(0);
	func_15();
	if (func_54(PLAYER_PED_ID()) && func_54(Local_868.f_9))
	{
		SET_ENTITY_COORDS(PLAYER_PED_ID(), -1648.4f, -1127.6f, 18.3f, 1, 0, 0, 1);
		ATTACH_ENTITY_TO_ENTITY(PLAYER_PED_ID(), Local_868.f_9, 0, 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		SET_ENTITY_VISIBLE(PLAYER_PED_ID(), 0, 0);
	}
	while (GET_GAME_TIMER() < iVar12)
	{
		WAIT(0);
	}
	if (DOES_CAM_EXIST(uLocal_930))
	...
	if (func_54(PLAYER_PED_ID()))
	{
		Local_893.f_20 = 60;
		Local_893.f_21 = 20;
		vVar1 = { GET_PED_BONE_COORDS(PLAYER_PED_ID(), 31086, 0f, -0.25f, 0f) };
		func_14(&Local_893, vVar1, GET_ENTITY_ROTATION(Local_868.f_9, 2), 50f, Local_893.f_20, Local_893.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
		ATTACH_CAM_TO_ENTITY(Local_893, PLAYER_PED_ID(), 0f, 0f, 0.5f, 1);
	}
	WAIT(0);
	if (func_54(PLAYER_PED_ID()) && func_54(Local_880.f_9))
	{
		func_12(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(Local_880.f_9, 1), &fVar10, &fVar11, 1);
		func_9(&Local_893, 1, 1, 0, 0, 1045220557, 0, 1065353216, 0);
		SET_CAM_ROT(Local_893, Vector(fVar11, 0f, fVar10) + Local_893.f_14, 2);
	}
	START_AUDIO_SCENE("FAIRGROUND_RIDES_LEVIATHAN");
	iLocal_936 = GET_GAME_TIMER() + 5000;
	...
	while (true)
	{
		...
		fVar13 = (SIN(((Local_868.f_10 - IntToFloat(FLOOR(Local_868.f_10))) * 360f)) * fLocal_937);
		if (func_54(PLAYER_PED_ID()) && func_54(Local_880.f_9))
		{
			func_12(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(Local_880.f_9, 1), &fVar10, &fVar11, 1);
			func_9(&Local_893, 1, 1, 0, 0, 1045220557, 0, 1065353216, 0);
			SET_CAM_ROT(Local_893, Vector((fVar11 + (fVar13 * (fVar14 * 2f))), 0f, (fVar10 + fVar13)) + Local_893.f_14, 2);
		}
		func_51();
		func_2();
		...
		if (GET_GAME_TIMER() > iLocal_936)
		{
			if (fLocal_939 > 0.01f)
			{
				if (fLocal_939 > 0.5f)
				{
					_PLAY_AMBIENT_SPEECH1(PLAYER_PED_ID(), "ROLLERCOASTER_CHAT_EXCITED", "SPEECH_PARAMS_FORCE_FRONTEND", 1);
				}
				else
				{
					_PLAY_AMBIENT_SPEECH1(PLAYER_PED_ID(), "ROLLERCOASTER_CHAT_NORMAL", "SPEECH_PARAMS_FORCE_FRONTEND", 1);
				}
				iLocal_936 = (GET_GAME_TIMER() + GET_RANDOM_INT_IN_RANGE(8000, 13000));
			}
		}
		if (iLocal_924 == 0)
		{
...
void func_6()
{
	...
	fVar0 = TO_FLOAT(ABSI((vLocal_941[iLocal_940 + 1 /*3*/] - vLocal_941[iLocal_940 /*3*/])));
	fVar1 = (vLocal_941[iVar3 /*3*/].f_1 - vLocal_941[iLocal_940 /*3*/].f_1);
	fVar2 = (1f - ((TO_FLOAT(vLocal_941[iVar3 /*3*/]) - Local_868.f_10) / fVar0));
...
void func_9(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, float fParam7, bool bParam8)
{
	...
	{
		uParam0->f_14 = (uParam0->f_14 + func_7(((((vVar10.x - uParam0->f_14) * 0.05f) * fVar9) * fParam7), -3f, 3f));
		uParam0->f_14.f_1 = (uParam0->f_14.f_1 + func_7(((((vVar10.y - uParam0->f_14.f_1) * 0.05f) * fVar9) * fParam7), -3f, 3f));
		uParam0->f_14.f_2 = (uParam0->f_14.f_2 + func_7(((((vVar10.z - uParam0->f_14.f_2) * 0.05f) * fVar9) * fParam7), -3f, 3f));
	}
	if (uParam0->f_26)
	{
...
void func_12(vector3 vParam0, vector3 vParam3, var uParam6, var uParam7, int iParam8)
{
	vector3 vVar0;
...
void func_13(vector3 vParam0, var uParam3, var uParam4, int iParam5)
{
	float fVar0;
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7, var uParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, float fParam14, bool bParam15)
{
	uParam0->f_1 = { vParam1 };
	uParam0->f_4 = { vParam4 };
	uParam0->f_7 = fParam7;
...
void func_16(var uParam0, var uParam1)
{
	...
	func_12(GET_ENTITY_COORDS(uParam0, 1), GET_ENTITY_COORDS(uParam1, 1), &uVar0, &uVar1, 1);
...
void func_17(var uParam0)
{
	...
	fVar0 = uParam0->f_3;
	uParam0->f_3 = (uParam0->f_3 + (((fLocal_867 * fLocal_939) * fLocal_938) * TIMESTEP()));
	if (uParam0->f_3 >= 1f)
	{
		...
		{
			SET_PAD_SHAKE(0, iLocal_933, iLocal_934);
		}
	}
	...
	*uParam0 = { *uParam0 + vLocal_862 };
	...
	{
		SET_ENTITY_COORDS_NO_OFFSET(uParam0->f_9, *uParam0, 0, 0, 1);
	}
...
void func_19()
{
	...
	{
		case 0:
			fLocal_867 = (fLocal_867 + (GET_FRAME_TIME() / 2f));
			if (fLocal_867 >= 5f)
			{
				fLocal_867 = 5f;
				iLocal_892 = 1;
		...
		case 1:
			if (Local_868.f_4[1] == 224 && iLocal_866 == 0)
			{
				...
				if (func_54(PLAYER_PED_ID()))
				{
					PLAY_SOUND_FROM_ENTITY(-1, "BIG_STOP", PLAYER_PED_ID(), 0, 0, 0);
				}
			}
			break;
		
		case 2:
			fLocal_867 = (fLocal_867 - GET_FRAME_TIME());
			if (fLocal_867 <= 0f)
			{
				fLocal_867 = 0f;
				iLocal_892 = 3;
...
void func_27(var uParam0, int iParam1, int iParam2)
{
	...
	*uParam0 = { func_18(&(vLocal_159[uParam0->f_4[0] /*3*/]), &(vLocal_159[uParam0->f_4[1] /*3*/]), &(vLocal_159[uParam0->f_4[2] /*3*/]), &(vLocal_159[uParam0->f_4[3] /*3*/]), uParam0->f_3) };
	*uParam0 = { *uParam0 + vLocal_862 };
	uParam0->f_9 = CREATE_OBJECT_NO_OFFSET(iLocal_40, *uParam0, 1, 1, 0);
	if (func_54(uParam0->f_9))
	{
		SET_ENTITY_COLLISION(uParam0->f_9, 0, 0);
		SET_ENTITY_VISIBLE(uParam0->f_9, 0, 0);
		FREEZE_ENTITY_POSITION(uParam0->f_9, 1);
	}
}
...
void func_28()
{
	...
	iLocal_925[0] = GET_CLOSEST_OBJECT_OF_TYPE(-1643.524f, -1124.681f, 17.4326f, 2f, joaat("prop_roller_car_01"), 1, 0, 1);
	iLocal_925[1] = GET_CLOSEST_OBJECT_OF_TYPE(-1645.146f, -1126.613f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
	iLocal_925[2] = GET_CLOSEST_OBJECT_OF_TYPE(-1646.768f, -1128.545f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
	iLocal_925[3] = GET_CLOSEST_OBJECT_OF_TYPE(-1648.39f, -1130.478f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
	iVar0 = 0;
	while (iVar0 < iLocal_925)
	{
		if (DOES_ENTITY_EXIST(iLocal_925[iVar0]))
		{
			SET_ENTITY_AS_MISSION_ENTITY(iLocal_925[iVar0], 1, 0);
			SET_ENTITY_VISIBLE(iLocal_925[iVar0], 0, 0);
			SET_ENTITY_COLLISION(iLocal_925[iVar0], 0, 0);
			SET_ENTITY_INVINCIBLE(iLocal_925[iVar0], 1);
		}
		iVar0++;
	}
}
...
void func_33(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	func_34(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_34(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, var uParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	var uVar0;
	bool bVar1;
	bool bVar2;
	...
	if (DOES_ENTITY_EXIST(uVar0))
	{
		...
		if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_44(uVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_44(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((((((((((((((func_45(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_45(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_45(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_45(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_45(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_45(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_45(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_45(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_45(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_45(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_45(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_45(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_45(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_45(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_45(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_45(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return 1;
		}
	}
...
void func_55(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	var uVar0;
...
void func_184(bool bParam0)
{
	...
	func_221();
	func_220(PLAYER_PED_ID(), -1631.348f, -1112.651f, 12.0206f);
...
void func_191(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_193() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_193() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_192(iParam0));
...
int func_196(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_193() /*10778*/].f_6165.f_10, iParam0);
}
...
Vector3 func_220(var uParam0, vector3 vParam1)
{
	var uVar0;
...
void func_221()
{
	...
	{
		iLocal_925[0] = CREATE_OBJECT(joaat("prop_roller_car_01"), -1643.524f, -1124.681f, 17.4326f, 1, 1, 0);
	}
	if (!func_54(iLocal_925[1]))
	{
		iLocal_925[1] = CREATE_OBJECT(joaat("prop_roller_car_02"), -1645.146f, -1126.613f, 17.4326f, 1, 1, 0);
	}
	if (!func_54(iLocal_925[2]))
	{
		iLocal_925[2] = CREATE_OBJECT(joaat("prop_roller_car_02"), -1646.768f, -1128.545f, 17.4326f, 1, 1, 0);
	}
	if (!func_54(iLocal_925[3]))
	{
		iLocal_925[3] = CREATE_OBJECT(joaat("prop_roller_car_02"), -1648.39f, -1130.478f, 17.4326f, 1, 1, 0);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_925)
	{
		if (func_54(iLocal_925[iVar0]))
		{
			...
			SET_ENTITY_VISIBLE(iLocal_925[iVar0], 1, 0);
			SET_ENTITY_COLLISION(iLocal_925[iVar0], 1, 0);
			FREEZE_ENTITY_POSITION(iLocal_925[iVar0], 1);
			SET_ENTITY_INVINCIBLE(iLocal_925[iVar0], 1);
...
void func_226()
{
	...
	if (!DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_71590)
		{
			if (func_229() == 2 == 0 && !NETWORK_IS_GAME_IN_PROGRESS())
			{
