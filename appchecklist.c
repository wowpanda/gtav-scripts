...
void func_4()
{
	...
	if (Global_14549 == 0)
	{
		while (iVar0 < 5)
		{
			func_7(Global_14534, "SET_DATA_SLOT", TO_FLOAT(18), TO_FLOAT(iLocal_115), TO_FLOAT(0), -1f, -1f, &(Local_131[iVar0 /*6*/]), 0, 0, 0, 0);
	...
	if (Global_14549 == 1)
	{
		...
		while (iVar0 < 5)
		{
			if (Local_131[iVar1 /*6*/].f_5 > 0)
			{
				...
				{
					func_7(Global_14534, "SET_DATA_SLOT", TO_FLOAT(18), TO_FLOAT(iLocal_115), TO_FLOAT(0), -1f, -1f, &(Local_131[iVar1 /*6*/]), 0, 0, 0, 0);
	...
	if (iLocal_115 == 0)
	{
		func_7(Global_14534, "SET_DATA_SLOT", TO_FLOAT(18), TO_FLOAT(0), TO_FLOAT(0), -1f, -1f, "CELL_3092", 0, 0, 0, 0);
	}
	else
	{
		bLocal_130 = true;
...
void func_10()
{
	...
	if (Global_14531 == 0)
	{
		if (func_9(2, Global_14522, 0))
		{
			...
			uLocal_129 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
			while (!IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_129))
			{
				WAIT(0);
			}
			iVar0 = GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_129);
...
void func_15()
{
	if (Global_14531 == 0)
	{
		if (func_9(2, Global_14522, 0))
		{
			...
			iLocal_128 = GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_129);
			if (Global_14553.f_1 > 3)
			{
				Global_14553.f_1 = 8;
				if (iLocal_128 == 0)
...
void func_16()
{
	...
	if (func_17(0))
	{
		func_7(Global_14534, "SET_DATA_SLOT", TO_FLOAT(18), TO_FLOAT(iVar0), TO_FLOAT(0), -1f, -1f, "CELL_229", 0, 0, 0, 0);
	}
	else
	{
		while (iVar0 < Global_88713)
		{
			func_7(Global_14534, "SET_DATA_SLOT", TO_FLOAT(18), TO_FLOAT(iVar0), TO_FLOAT(0), -1f, -1f, &(Global_88504[iVar0 /*4*/]), 0, 0, 0, 0);
			iLocal_115++;
...
void func_20()
{
	...
	while (iVar0 < 63)
	{
		if ((IS_BIT_SET(Global_106565.f_18568[iVar0 /*6*/], 0) && IS_BIT_SET(Global_106565.f_18568[iVar0 /*6*/], 1)) && !IS_BIT_SET(Global_106565.f_18568[iVar0 /*6*/], 3))
		{
			if (Global_88713 < 52)
			{
	...
	while (iVar0 < 20)
	{
		if (IS_BIT_SET(Global_106565.f_9079.f_99.f_219[0], iVar0))
		{
			if (Global_88713 < 52)
			{
...
void func_26()
{
	func_33(Global_14534, "SET_INPUT_EVENT", TO_FLOAT(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_28()
{
	func_33(Global_14534, "SET_INPUT_EVENT", TO_FLOAT(1), -1082130432, -1082130432, -1082130432, -1082130432);
	PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_14542, 1);
	func_29();
}
...
{
	func_33(Global_14534, "SET_DATA_SLOT_EMPTY", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_7(Global_14534, "SET_DATA_SLOT", TO_FLOAT(18), TO_FLOAT(0), TO_FLOAT(0), -1f, -1f, "CELL_3301", 0, 0, 0, 0);
	func_7(Global_14534, "SET_DATA_SLOT", TO_FLOAT(18), TO_FLOAT(1), TO_FLOAT(0), -1f, -1f, "CELL_3302", 0, 0, 0, 0);
	iLocal_115 = 2;
	func_33(Global_14534, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_5(Global_14534, "SET_HEADER", "CELL_23", 0, 0, 0, 0);
	if (Global_14541)
