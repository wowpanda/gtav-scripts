...
void func_2(bool bParam0, int iParam1)//Position - 0x8E
{
	...
	if (bParam0)
	{
		if ((func_5(0) && Global_1171B.f_1 == 1) && func_4(Global_1171B))
		{
		}
		else
		{
	...
	if (Global_19E56.f_2361 || func_5(0))
	{
		iVar0 = func_3();
...
void func_6()//Position - 0x202
{
	...
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, joaat("player_one"), 0);
	}
		...
		if (Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_69(iParam0, &(Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/].f_1F), &(Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/].f_51));
		...
		else if (Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_69(iParam0, &(Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/].f_1F), &(Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/].f_51));
				GRAPHICS::_ADD_CLAN_DECAL_TO_VEHICLE(*iParam0, Var2.f_60);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("BODHI2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2, vParam2, fParam3, 1, 1, 0);
				...
				func_69(iParam0, &(Var2.f_1F), &(Var2.f_51));
				GRAPHICS::_ADD_CLAN_DECAL_TO_VEHICLE(*iParam0, Var2.f_60);
				if (iParam1 == 1)
				{
...
void func_9(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x1306
{
	...
	if ((func_75(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(*iParam1, 0))
	{
		...
		{
			func_13(iParam1, &(Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_1F), &(Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_51));
			if (bParam3)
			{
				...
				Global_19E56.f_4E7A[iParam0 /*43*/].f_1F = func_12(*iParam1);
				...
				func_10(Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_19E56.f_4E7A[iParam0 /*43*/].f_1));
				...
				func_10(Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_6, 4294967295, iVar3, 0, &(Global_19E56.f_4E7A[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_14(int iParam0, bool bParam1, var uParam2)//Position - 0x36F3
{
	...
	*uParam2 = 0;
	...
	if ((!func_42(iVar0, bParam1, uParam2) && !func_41(CAM::_0xDC9DA9E8789F5246())) && !func_25(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_23(CAM::_0xDC9DA9E8789F5246()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_21(iParam0)) && !bVar1) && !(func_20(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_16(CAM::_0xDC9DA9E8789F5246())))
	{
...
int func_18(int iParam0, bool bParam1, bool bParam2)//Position - 0x3C3D
{
	int iVar0;
...
int func_19()//Position - 0x3C87
{
	return 4294967295;
}

int func_20(int iParam0)//Position - 0x3C90
{
...
int func_21(int iParam0)//Position - 0x3CD2
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("MONSTER4"):
		case joaat("MONSTER5"):
			if (func_22(CAM::_0xDC9DA9E8789F5246()))
			{
				return 1;
			}
			break;
...
int func_22(int iParam0)//Position - 0x3D65
{
	if (iParam0 != func_19())
	{
		if (func_18(iParam0, 1, 1))
		{
			if (Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295)
			{
				return func_17(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 13;
			}
		}
	}
	return 0;
...
int func_23(int iParam0)//Position - 0x3DAC
{
	if (iParam0 != func_19())
	{
		if (func_18(iParam0, 1, 1))
		{
			if (Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295)
			{
				return func_17(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 7;
			}
		}
	}
	return 0;
...
int func_24(int iParam0)//Position - 0x3DF2
{
	switch (iParam0)
	{
		case joaat("AVENGER"):
...
int func_25(int iParam0)//Position - 0x3E27
{
	if (func_40(CAM::_0xDC9DA9E8789F5246()) || func_39(CAM::_0xDC9DA9E8789F5246()))
	{
		if (func_26(iParam0))
		{
			return 1;
...
int func_26(int iParam0)//Position - 0x3E56
{
...
int func_27(int iParam0)//Position - 0x3F0D
{
...
int func_28(int iParam0)//Position - 0x3F43
{
	switch (iParam0)
	{
		case joaat("APC"):
...
int func_29(int iParam0, bool bParam1)//Position - 0x3F9C
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_30(int iParam0)//Position - 0x3FF7
{
	int iVar0;
...
int func_31(int iParam0, int iParam1)//Position - 0x4033
{
	if (iParam1 == 0)
	{
...
bool func_32()//Position - 0x43A7
{
	return DLC::IS_DLC_PRESENT(1927191088);
}

bool func_33()//Position - 0x43B8
{
	return DLC::IS_DLC_PRESENT(2067165443);
}

bool func_34()//Position - 0x43C9
{
	return DLC::IS_DLC_PRESENT(3337689893);
}

bool func_35()//Position - 0x43DA
{
	return DLC::IS_DLC_PRESENT(210122941);
}

bool func_36()//Position - 0x43EB
{
	return DLC::IS_DLC_PRESENT(2400444888);
}

bool func_37()//Position - 0x43FC
{
	return DLC::IS_DLC_PRESENT(1630677557);
}

int func_38(int iParam0, int iParam1)//Position - 0x440D
{
	switch (iParam0)
	{
		case joaat("FACTION2"):
...
int func_39(int iParam0)//Position - 0x4783
{
	if (iParam0 != func_19())
	{
		if (func_18(iParam0, 1, 1))
		{
			if (Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295 && Global_24FBF9[iParam0 /*413*/].f_135.f_7 != func_19())
			{
...
int func_40(int iParam0)//Position - 0x47E2
{
	if (iParam0 != func_19())
	{
		if (func_18(iParam0, 1, 1))
...
int func_41(int iParam0)//Position - 0x4842
{
	if (iParam0 != func_19())
	{
		if (func_18(iParam0, 1, 1))
...
int func_42(int iParam0, bool bParam1, var uParam2)//Position - 0x4889
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_23(CAM::_0xDC9DA9E8789F5246()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_43(int iParam0)//Position - 0x4CA1
{
	switch (iParam0)
	{
		case joaat("TOWTRUCK"):
...
void func_44(int iParam0, int iParam1)//Position - 0x4CCA
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_45(iParam0, &(Global_19E56.f_7F5D.f_1586));
}

void func_45(int iParam0, var uParam1)//Position - 0x4ECC
{
	int iVar0;
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		if (uParam1->f_41 == 4294967295 && !func_47(uParam1->f_42))
		{
			uParam1->f_41 = 0;
		}
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_4D), func_46(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_46(int iParam0)//Position - 0x5177
{
	switch (iParam0)
	{
		case 1:
...
int func_47(int iParam0)//Position - 0x5227
{
	switch (iParam0)
	{
		case joaat("GRANGER"):
...
void func_48(var uParam0)//Position - 0x5247
{
	int iVar0;
...
int func_49(int iParam0)//Position - 0x52F8
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0)) || func_64(iParam0, 0, 0)) || func_64(iParam0, 1, 0)) || func_64(iParam0, 2, 0)) || func_63(iParam0) != 145) || func_62(iParam0)) || func_61(iParam0)) || func_15(iParam0)) || func_60(iParam0)) || !func_50(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_61(iParam0))
		{
		}
...
int func_50(int iParam0)//Position - 0x53D5
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_51(int iParam0, bool bParam1)//Position - 0x5586
{
	int iVar0;
	struct<2> Var1;
...
int func_52(int iParam0)//Position - 0x5706
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_54(int iParam0)//Position - 0x57E9
{
	int iVar0;
	int iVar1;
...
int func_55()//Position - 0x74E4
{
	return 0;
}

int func_56()//Position - 0x74ED
{
	return 1;
}

int func_57()//Position - 0x74F6
{
	return 1;
}

int func_58()//Position - 0x74FF
{
...
int func_60(int iParam0)//Position - 0x75D3
{
	int iVar0;
	char* sVar1;
...
int func_61(int iParam0)//Position - 0x7619
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x7695
{
	int iVar0;
...
int func_63(int iParam0)//Position - 0x777D
{
	int iVar0;
...
int func_64(int iParam0, int iParam1, bool bParam2)//Position - 0x77E0
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_65(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x7851
{
...
void func_66(int iParam0, int iParam1)//Position - 0x792A
{
	int iVar0;
...
void func_67(var uParam0)//Position - 0x79AC
{
	if (!func_68(*uParam0))
	{
...
bool func_68(int iParam0)//Position - 0x79D7
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_69(var uParam0, var uParam1, var uParam2)//Position - 0x79E6
{
	int iVar0;
	int iVar1;
...
int func_70(int iParam0)//Position - 0x7BA9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_71(var uParam0)//Position - 0x7C85
{
...
int func_72(int iParam0, int iParam1)//Position - 0x7CC5
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_73(var uParam0, int iParam1)//Position - 0x7DAA
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_74(int iParam0, var uParam1, int iParam2)//Position - 0x7DEB
{
	int iVar0;
...
bool func_75(int iParam0)//Position - 0x8049
{
	return iParam0 < 3;
}

int func_76(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0x8055
{
	int iVar0;
	struct<82> Var1;
	int iVar2;
...
void func_77(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x811A
{
	func_78(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_78(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x8143
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_79(vector3 vParam0)//Position - 0x8537
{
...
int func_80()//Position - 0x8561
{
	func_81();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_81()//Position - 0x857A
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_84(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			iVar0 = func_83(AUDIO::_0x0626A247D2405330());
			if (func_75(iVar0) && (!func_82(14) || Global_19A3D))
			{
				if (Global_19E56.f_933.f_21B.f_10CD != iVar0 && func_75(Global_19E56.f_933.f_21B.f_10CD))
				{
...
bool func_82(int iParam0)//Position - 0x8677
{
	return Global_8D15 == iParam0;
}

int func_83(int iParam0)//Position - 0x8685
{
	int iVar0;
	int iVar1;
...
int func_84(int iParam0)//Position - 0x86C2
{
	if (func_75(iParam0))
	{
...
int func_85(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)//Position - 0x86EC
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_86(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x89E2
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_87(vector3 vParam0)//Position - 0x8A96
{
	float fVar0;
	float fVar1;
...
void func_88(int iParam0)//Position - 0x8AD5
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
void func_89(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x8B3A
{
	func_78(vParam0, vParam1, fParam2, vParam3, fParam4, vParam5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

bool func_90(vector3 vParam0, int iParam1)//Position - 0x8B64
{
	return func_91(Global_17998.f_B3B.f_C.f_42, vParam0, iParam1);
}

int func_91(int iParam0, vector3 vParam1, int iParam2)//Position - 0x8B81
{
	vector3 vVar0;
	vector3 vVar1;
...
Vector3 func_92()//Position - 0x8BEB
{
	return 2.55f, 5.665f, 2.55f;
}

void func_93(vector3 vParam0, float fParam1, bool bParam2)//Position - 0x8C02
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_101(&(Global_11188.f_22B[0 /*21*/]), iVar0))
		{
...
void func_94(int iParam0)//Position - 0x8C52
{
	bool bVar0;
	...
	if (func_101(&(Global_11188.f_22B[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_100(iParam0, 0)) && Global_11515.f_42 == 0) && Global_19E56.f_7F5D.f_7A6[Global_11188.f_22B[0 /*21*/].f_E] != 0) && Global_19E56.f_7F5D.f_7A6[Global_11188.f_22B[0 /*21*/].f_E] > 3) && (!func_98(0, Global_11188.f_22B[0 /*21*/].f_C) || !func_98(1, Global_11188.f_22B[0 /*21*/].f_C)))
			{
				func_97(&(Global_19E56.f_7F5D.f_45[Global_11188.f_22B[0 /*21*/].f_E /*78*/]), &Global_11515);
...
void func_95(int iParam0, bool bParam1)//Position - 0x8DC4
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_96(int iParam0, int iParam1, bool bParam2)//Position - 0x8E21
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_97(var uParam0, var uParam1)//Position - 0x8E5C
{
...
int func_98(int iParam0, int iParam1)//Position - 0x8F28
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_99(&(Global_19E56.f_7F5D.f_13AE[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_51(Global_19E56.f_7F5D.f_13AE[iVar0 /*157*/][iParam0 /*78*/].f_42, 0);
}

int func_99(var uParam0)//Position - 0x8F9A
{
	return *uParam0;
}

bool func_100(int iParam0, int iParam1)//Position - 0x8FA5
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
int func_101(var uParam0, int iParam1)//Position - 0x8FC8
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam0->f_9, 10))
	{
		...
		if (!func_102(Global_19E56.f_7F5D.f_748[uParam0->f_E /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_102(Global_19E56.f_933.f_21B.f_DF0[1 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_102(Global_19E56.f_933.f_21B.f_DF0[0 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
...
bool func_102(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0xA6C0
{
	if (bParam2)
	{
...
int func_103(int iParam0, int iParam1)//Position - 0xA707
{
	struct<82> Var0;
...
int func_104(int iParam0, int iParam1, int iParam2)//Position - 0xA749
{
	int iVar0;
...
void func_105()//Position - 0xA7D7
{
	...
	while (!CUTSCENE::HAS_CUTSCENE_LOADED())
	{
		...
		{
			func_106("FRANKLIN", AUDIO::_0x0626A247D2405330(), 0, 2);
		}
		SYSTEM::WAIT(0);
	}
}

void func_106(char* sParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA817
{
	struct<50> Var0;
	int iVar1;
...
void func_107(int iParam0, var uParam1, int iParam2)//Position - 0xA8D2
{
	int iVar0;
	var uVar1;
	struct<50> Var2;
	...
	while (iVar0 < 12)
	{
		...
		{
			if (func_187(iVar4, func_189(iVar0), func_188(iParam0, Var2.f_D[iVar0], Var2[iVar0], func_189(iVar0)), &uVar1))
			{
				Var3 = { func_118(iVar4, 2, uParam1->f_3B, 4294967295) };
				uParam1->f_D[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
				iVar5 = 1;
			}
			if (func_116(iVar4, func_189(iVar0), func_188(iParam0, Var2.f_D[iVar0], Var2[iVar0], func_189(iVar0)), &uVar1))
			{
				Var3 = { func_118(iVar4, 1, uParam1->f_3E, 4294967295) };
	...
	while (iVar0 < 9)
	{
		...
		{
			if (func_187(iVar4, 14, func_109(iParam0, Var2.f_27[iVar0], Var2.f_31[iVar0], iVar0), &uVar1))
			{
				Var3 = { func_118(iVar4, 2, uParam1->f_3B, 4294967295) };
				uParam1->f_D[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
			...
			if (func_116(iVar4, 14, func_109(iParam0, Var2.f_27[iVar0], Var2.f_31[iVar0], iVar0), &uVar1))
			{
				Var3 = { func_118(iVar4, 1, uParam1->f_3E, 4294967295) };
				uParam1->f_D[1] = Var3.f_3;
				(*uParam1)[1] = Var3.f_4;
	...
	if (iVar6 || iVar5)
	{
		iVar7 = func_188(iParam0, uParam1->f_D[1], (*uParam1)[1], 1);
		iVar8 = func_188(iParam0, uParam1->f_D[2], (*uParam1)[2], 2);
		iVar9 = func_108(iVar4, iVar8, iVar7);
		if (iVar9 != 4294967197)
		{
			Var3 = { func_118(iVar4, 0, iVar9, 4294967295) };
...
int func_108(int iParam0, int iParam1, int iParam2)//Position - 0xAB47
{
	switch (iParam0)
	{
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAC9E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_110(int iParam0, int iParam1)//Position - 0xAD9A
{
	int iVar0;
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAED8
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILE::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, 4294967295, 0, 4294967295, func_113(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
int func_112(int iParam0, int iParam1)//Position - 0xAFB8
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_113(int iParam0)//Position - 0xB35F
{
	switch (iParam0)
	{
		case 0:
...
int func_114(int iParam0)//Position - 0xB40F
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_115(int iParam0)//Position - 0xB470
{
	switch (iParam0)
	{
		case 0:
...
int func_116(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0xB4F6
{
	int iVar0;
...
int func_117(int iParam0)//Position - 0xB780
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
struct<14> func_118(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB7BB
{
	func_186();
...
void func_119(int iParam0, int iParam1)//Position - 0xB80D
{
	switch (iParam0)
	{
		case 0:
...
void func_120(int iParam0)//Position - 0xB8FD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 155, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_121(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xCB75
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_124(func_127(iParam1, uParam0->f_2), Global_11566, 0);
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_124(func_123(iParam1, uParam0->f_2), Global_11566, 0);
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_124(iVar1, Global_11566, 0);
				if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_122(int iParam0, int iParam1, var uParam2)//Position - 0xCF06
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_123(int iParam0, int iParam1)//Position - 0xD30B
{
	switch (iParam1)
	{
		case 0:
...
int func_124(int iParam0, int iParam1, int iParam2)//Position - 0xD706
{
	int iVar0;
	var uVar1;
...
int func_125(var uParam0)//Position - 0xD738
{
	int iVar0;
	int iVar1;
...
var func_126()//Position - 0xD76C
{
	return Global_1407E0;
}

int func_127(int iParam0, int iParam1)//Position - 0xD778
{
	switch (iParam1)
	{
		case 0:
...
int func_128(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xDB73
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_129(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xEA91
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_130(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xEAD3
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0x1058E
{
	switch (iParam0)
	{
		case 4294967295:
...
void func_132(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10662
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILE::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var2;
					func_121(&(Global_11569[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, 4294967295, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_121(&(Global_11569[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, 4294967295, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILE::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var6;
					func_121(&(Global_11569[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILE::_0x341DE7ED1D2A1BFD(Var6.f_1, 2244334710, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != 4294967295 && Global_11612)
		{
			...
			Global_280005 = Var11;
			func_121(&(Global_11569[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILE::_0x341DE7ED1D2A1BFD(Var11.f_1, 2244334710, 0), 4294967295, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = FILE::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, 4294967295, 0, 4294967295, func_113(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_133(int iParam0)//Position - 0x1093B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 9, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_134(int iParam0)//Position - 0x10A92
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 48, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_135(int iParam0)//Position - 0x10FA0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 1, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_136(int iParam0)//Position - 0x11015
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x11089
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 6, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_138(int iParam0)//Position - 0x11170
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 33, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_139(int iParam0)//Position - 0x114D3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 17, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_140(int iParam0)//Position - 0x116E4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 18, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_141(int iParam0)//Position - 0x11914
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 7, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_142(int iParam0)//Position - 0x11A24
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 84, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_143(int iParam0)//Position - 0x123C3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 104, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_144(int iParam0)//Position - 0x12F36
{
	if (iParam0 < 136)
	{
		func_146(iParam0);
	...
	{
		func_132(3, iParam0, 242, 4294967295);
	}
}

void func_145(int iParam0)//Position - 0x12F6B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x13B6F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x14A7F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x14BAC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0, int iParam1)//Position - 0x14CAA
{
	switch (iParam0)
	{
		case 0:
...
void func_150(int iParam0)//Position - 0x14D9A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 175, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_151(int iParam0)//Position - 0x1628B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x163DC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 47, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_153(int iParam0)//Position - 0x168E7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 63, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_154(int iParam0)//Position - 0x16F55
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x16FC9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 5, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_156(int iParam0)//Position - 0x17099
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 53, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_157(int iParam0)//Position - 0x175C9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 12, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_158(int iParam0)//Position - 0x17760
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 77, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_159(int iParam0)//Position - 0x17F5E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x18070
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 134, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_161(int iParam0)//Position - 0x18F9B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 117, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_162(int iParam0)//Position - 0x19C58
{
	if (iParam0 < 107)
	{
		func_165(iParam0);
	...
	if (Global_11569[0 /*14*/].f_2 == 4294967295)
	{
		func_132(3, iParam0, 318, 4294967295);
	}
}

void func_163(int iParam0)//Position - 0x19C9E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1A743
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1B532
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1C17D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 21, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_167(int iParam0)//Position - 0x1C3F6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 10, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_168(int iParam0, int iParam1)//Position - 0x1C53C
{
	switch (iParam0)
	{
		case 0:
...
void func_169(int iParam0)//Position - 0x1C62C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 113, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_170(int iParam0)//Position - 0x1D3B6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x1D530
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x1DAA7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 45, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_173(int iParam0)//Position - 0x1DFD1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x1E045
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x1E115
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x1E5ED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 20, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_177(int iParam0)//Position - 0x1E856
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 24, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_178(int iParam0)//Position - 0x1EB2C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 14, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_179(int iParam0)//Position - 0x1ECF5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_132(iVar7, iParam0, 99, 4294967295);
			return;
			break;
	}
	func_121(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_180(int iParam0)//Position - 0x1F849
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x20495
{
	if (iParam0 < 60)
	{
		func_183(iParam0);
	...
	if (Global_11569[0 /*14*/].f_2 == 4294967295)
	{
		func_132(3, iParam0, 181, 4294967295);
	}
}

void func_182(int iParam0)//Position - 0x204CA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x2126A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x218F6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185(int iParam0)//Position - 0x219DD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_186()//Position - 0x21ADB
{
...
int func_187(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x21B54
{
	int iVar0;
...
int func_188(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x21E5B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_189(int iParam0)//Position - 0x21EDF
{
	switch (iParam0)
	{
		case 0:
...
void func_190(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x21F8F
{
	int iVar0;
	int iVar1;
...
int func_191(int iParam0, var uParam1)//Position - 0x2212F
{
	var uVar0;
	var uVar1;
	
	uVar0 = Global_2727B6[iParam0 /*3*/][func_125(uParam1)];
...
void func_192(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2215B
{
	int iVar0;
...
void func_193(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x226A3
{
	int iVar0;
...
void func_194(bool bParam0)//Position - 0x228E4
{
...
void func_195()//Position - 0x2293E
{
...
void func_196()//Position - 0x22958
{
	int iVar0;
...
void func_197()//Position - 0x229C9
{
	Global_16C53 = 1;
...
int func_198(int iParam0)//Position - 0x22AB8
{
	int iVar0;
	int iVar1;
	...
	func_199(&(Global_19E56.f_933.f_21B), iVar1);
...
void func_199(var uParam0, int iParam1)//Position - 0x22BCF
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_201(Global_19E56.f_4849[iVar0], &vVar2, &fVar3))
			{
				Global_19E56.f_4849[iVar0] = 318;
				func_200(&(uParam0->f_8E4[iVar0]));
...
void func_200(var uParam0)//Position - 0x22D98
{
	*uParam0 = 4294967281;
}

int func_201(int iParam0, var uParam1, float fParam2)//Position - 0x22DA6
{
	switch (iParam0)
	{
		case 11:
...
void func_202(int iParam0, bool bParam1)//Position - 0x23715
{
	if (bParam1)
	{
