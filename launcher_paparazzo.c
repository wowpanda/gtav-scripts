	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_104307[Var0 /*10*/].f_9 != -1)
			{
				...
				func_277(&(Global_104307[Var0 /*10*/].f_9));
			}
		}
		func_265(&Var0, 1);
	}
...
int func_137(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
int func_161()
{
	return func_162(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_162(void fParam0, int iParam1)
{
	int iVar0;
	void fVar1;
	int iVar2;
...
int func_165(vector3 vParam0, bool bParam1)
{
	...
	HUD::SET_BLIP_SCALE(iVar0, func_166(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
void func_183(int iParam0, void fParam1, vector3 vParam2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
int func_192(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	var uVar0;
	
	if ((((func_124(PLAYER::PLAYER_PED_ID()) && func_124(iParam0->f_28[0])) && !func_143()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_187(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_196(var uParam0, bool bParam1)
{
	...
	if ((func_233(*uParam0) || func_231(*uParam0)) || Global_71223 == 1)
	{
		return 1;
	}
	if (!TASK::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_205(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_206(var uParam0, bool bParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
{
	return func_210(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_210(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_211(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
int func_220(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_221(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_223(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
int func_224(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
{
	if ((func_232() && Global_92955.f_11 == 6) && iParam0 == func_162(&(Global_92955.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_236(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_245(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(fVar1))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				...
				if (func_124(uParam0->f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				...
				if (func_124(uParam0->f_28[1]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
				{
...
void func_240(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)
{
	func_241(iParam0);
...
int func_242(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
...
int func_243(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_248(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_245(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(fVar4))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (func_123(uParam0->f_28[0]))
			{
				...
				{
					func_237(&(uParam0->f_41[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
		...
		case 3:
			if (func_124(uParam0->f_41[0]))
			{
				...
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[0], iLocal_54, "idle_closed_pap_3_rcm_dumpster", fVar4, 8f, -8f, 0, 1148846080);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_54, true);
				if (func_124(uParam0->f_28[0]))
				{
					BRAIN::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_54, fVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_124(uParam0->f_41[1]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[1], iLocal_54, "idle_closed_pap_3_rcm_lid_l", fVar4, 8f, -8f, 0, 1148846080);
				}
				if (func_124(uParam0->f_41[2]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[2], iLocal_54, "idle_closed_pap_3_rcm_lid_r", fVar4, 8f, -8f, 0, 1148846080);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
int func_249(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_245(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo_2"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (func_123(uParam0->f_28[0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
					func_237(&(uParam0->f_41[0]), iVar0[2], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_124(uParam0->f_41[0]))
					{
		...
		case 3:
			if (func_124(uParam0->f_28[0]) && func_124(PLAYER::PLAYER_PED_ID()))
			{
				...
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_54, true);
				BRAIN::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_54, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
			...
			BRAIN::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_PAPARAZZI", false);
		...
		case 3:
			if (func_124(uParam0->f_28[0]))
			{
				if (STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo1beckon"))
				{
					...
					BRAIN::TASK_PLAY_ANIM(0, fVar4, "pap_idle_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, fVar4, "pap_idle_action_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, fVar4, "pap_idle_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, fVar4, "pap_idle_action_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
...
bool func_256(int iParam0, void fParam1)
{
...
void func_265(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		switch (*iParam0)
		{
			...
			case 47:
				BRAIN::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_PAPARAZZI", true);
