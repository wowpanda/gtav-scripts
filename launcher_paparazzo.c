...
void __EntryFunction__()
{
	...
	if (!func_265(&iVar64, &Var0, vVar61, 5f))
	{
		func_264();
	...
	while (true)
	{
		...
		if (Var0 == 47)
		{
			func_195(&Var0, vVar61, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		else if (Var0 == 51)
		{
			func_195(&Var0, vVar61, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		func_194(Var0);
		func_186(&iLocal_95, &(Var0.f_9), vVar61);
		if (func_171(&Var0, 0))
		{
			if (func_170(Var0))
			{
				func_167(Var0, &uLocal_97);
			}
			if (!func_2(&Var0))
			{
				func_268(&Var0, 1);
...
void func_147()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if (func_148(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_148(var uParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
var func_168(vector3 vParam0, int iParam3)
{
	var uVar0;
	
	uVar0 = ADD_BLIP_FOR_COORD(vParam0);
	SET_BLIP_SCALE(uVar0, func_169(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
void func_186(int iParam0, var uParam1, vector3 vParam2)
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (!IS_STRING_NULL_OR_EMPTY(uParam1))
		{
			...
			{
				if (func_190(PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_189(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_190(PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_192(iParam0);
				}
			}
...
float func_190(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
int func_195(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_126(PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && !func_145()) && (GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_190(PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_198(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
...
int func_214(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
int func_217(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_219(GET_ENTITY_COORDS(iParam1, 1) - GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		vVar3 = { func_219(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_223(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_224(var uParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_225(var uParam0, float fParam1)
{
	...
	{
		if (func_226(uParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_226(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_219(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_219(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_218(vVar3, vVar0);
...
int func_227(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (IS_PED_SHOOTING(PLAYER_PED_ID()))
...
var func_237()
{
	return ADD_SCENARIO_BLOCKING_AREA(-74.8392f, 300.5241f, 104f, -62.467f, 318.6961f, 109f, 0, 1, 1, 1);
}
...
int func_239(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_248(&iVar0) || !HAS_ANIM_DICT_LOADED(sVar8))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				...
				if (func_126(uParam0->f_28[0]) && DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				...
				if (func_126(uParam0->f_28[1]) && DOES_ENTITY_EXIST(uParam0->f_41[1]))
				{
...
void func_240(var uParam0, var uParam1, vector3 vParam2, float fParam5)
{
	func_205(uParam0);
...
void func_241(var uParam0, var uParam1, vector3 vParam2, float fParam5)
{
	func_242(uParam0);
...
void func_243(var uParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	func_244(uParam0);
...
int func_245(var uParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_246(uParam0, iParam1, vParam2, fParam5, 1))
	{
		if (DOES_ENTITY_EXIST(*uParam0))
		{
			if (!IS_ENTITY_DEAD(*uParam0, 0))
...
int func_246(var uParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	int iVar0;
...
int func_251(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_248(&iVar0) || !HAS_ANIM_DICT_LOADED(sVar30))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (func_125(uParam0->f_28[0]))
			{
				...
				{
					func_240(&(uParam0->f_41[3]), iVar0[1], GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
		...
		case 3:
			if (func_126(uParam0->f_41[0]))
			{
				uLocal_94 = CREATE_SYNCHRONIZED_SCENE(GET_ENTITY_COORDS(uParam0->f_41[0], 1), GET_ENTITY_ROTATION(uParam0->f_41[0], 2), 2);
				PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[0], uLocal_94, "idle_closed_pap_3_rcm_dumpster", sVar30, 8f, -8f, 0, 1148846080);
				SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_94, 1);
				if (func_126(uParam0->f_28[0]))
				{
					TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_94, sVar30, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_126(uParam0->f_41[1]))
				{
					PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[1], uLocal_94, "idle_closed_pap_3_rcm_lid_l", sVar30, 8f, -8f, 0, 1148846080);
				}
				if (func_126(uParam0->f_41[2]))
				{
					PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[2], uLocal_94, "idle_closed_pap_3_rcm_lid_r", sVar30, 8f, -8f, 0, 1148846080);
				}
			}
			iVar31 = 0;
			while (iVar31 <= (iVar0 - 1))
...
int func_252(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_248(&iVar0) || !HAS_ANIM_DICT_LOADED("rcmpaparazzo_2"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (func_125(uParam0->f_28[0]))
			{
				if (!DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
					func_240(&(uParam0->f_41[0]), iVar0[2], GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_126(uParam0->f_41[0]))
					{
		...
		case 3:
			if (func_126(uParam0->f_28[0]) && func_126(PLAYER_PED_ID()))
			{
				TASK_LOOK_AT_ENTITY(uParam0->f_28[0], PLAYER_PED_ID(), -1, 0, 2);
				uLocal_94 = CREATE_SYNCHRONIZED_SCENE(-71.283f, 301.557f, 106.711f, 0f, 0f, 4.659f, 2);
				SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_94, 1);
				TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_94, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
			...
			SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_PAPARAZZI", 0);
...
int func_253(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_248(&iVar0) || !HAS_ANIM_DICT_LOADED(sVar7))
			{
				return 0;
			}
			func_254(46, 1);
		...
		case 3:
			if (func_126(uParam0->f_28[0]))
			{
				if (HAS_ANIM_DICT_LOADED("rcmpaparazzo1beckon"))
				{
					...
					TASK_PLAY_ANIM(0, sVar7, "pap_idle_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, sVar7, "pap_idle_action_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, sVar7, "pap_idle_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, sVar7, "pap_idle_action_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					SET_SEQUENCE_TO_REPEAT(uVar6, 1);
					CLOSE_SEQUENCE_TASK(uVar6);
					TASK_PERFORM_SEQUENCE(uParam0->f_28[0], uVar6);
...
void func_254(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 46:
			if (bParam1)
			{
				SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, 0, 1);
				REMOVE_VEHICLES_FROM_GENERATORS_IN_AREA(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, 0);
			}
			else
			{
				SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, 1, 1);
			}
			break;
	}
}
...
int func_266(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
...
void func_268(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		{
			case 46:
				SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_93);
				func_270(iParam0, 0, 0, 0);
				break;
			
			case 47:
				SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_PAPARAZZI", 1);
				REMOVE_SCENARIO_BLOCKING_AREA(uLocal_96, 0);
				func_270(iParam0, 0, 0, 0);
				break;
			
			case 48:
				REMOVE_MODEL_HIDE(-260.62f, 292.13f, 90.6f, 10f, joaat("prop_cs_dumpster_01a"), 1);
				REMOVE_MODEL_HIDE(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidr"), 1);
				REMOVE_MODEL_HIDE(-261.54f, 292.54f, 92.1f, 10f, joaat("prop_cs_dumpster_lidl"), 1);
	...
	func_254(*iParam0, 0);
	if (DOES_BLIP_EXIST(uLocal_97))
	{
		REMOVE_BLIP(&uLocal_97);
	}
	if (iLocal_95 != -1)
	{
	...
	if (!bParam1)
	{
		if (*iParam0 == 48)
		{
			...
			while (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("paparazzo3")) > 0)
			{
				WAIT(0);
			}
		}
