...
void __EntryFunction__()
{
	...
	{
		if (func_542(PLAYER_ID(), 1))
		{
			TERMINATE_THIS_THREAD();
		}
		if (func_541(PLAYER_ID(), 1))
		{
			TERMINATE_THIS_THREAD();
		}
	}
	...
	if (!func_539() && !NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_3()
{
	...
	switch (iLocal_295)
	{
		...
		case 7:
			...
			{
				TASK_VEHICLE_DRIVE_TO_COORD(iLocal_97, iLocal_98, vLocal_90, (_GET_VEHICLE_MAX_SPEED(iLocal_98) * 0.65f), 0, 0, 786859, 4f, -1f);
				iLocal_295 = 8;
			}
			break;
		...
		case 8:
			...
			{
				iLocal_297 = GET_RANDOM_INT_IN_RANGE(1, 3);
				iLocal_295 = 11;
			}
			...
			if (DOES_ENTITY_EXIST(iLocal_96) && DOES_ENTITY_EXIST(iLocal_98))
			{
				if (IS_PED_IN_VEHICLE(iLocal_96, iLocal_98, 0))
				{
					if (!IS_ENTITY_DEAD(iLocal_97, 0))
					{
						...
						{
							TASK_LEAVE_ANY_VEHICLE(iLocal_96, 0, 16842752);
						}
					}
				}
				else
...
void func_19()
{
	...
	{
		if (func_22(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
...
{
	if (IS_STRING_NULL_OR_EMPTY(uLocal_63))
	{
		uLocal_63 = func_44(iParam0, 0, 0);
		return 0;
	}
	if (!HAS_ANIM_DICT_LOADED(uLocal_63))
	{
		return 0;
	}
	else
	{
		func_37(iLocal_96, func_43(), 1, FLOOR((15000f * (1f + (TO_FLOAT(iLocal_72) / 2f)))), 1);
		if (iParam0 == PLAYER_PED_ID())
		{
			func_37(iParam0, func_43(), 0, FLOOR((15000f * (1f + (TO_FLOAT(iLocal_72) / 2f)))), 1);
		}
...
void func_37(int iParam0, bool bParam1, bool bParam2, var uParam3, bool bParam4)
{
	...
	uVar0 = GET_VEHICLE_PED_IS_IN(iParam0, 1);
	...
	else
	{
		...
		TASK_PLAY_ANIM(0, uVar2, func_38(0, bParam2, bParam1, bVar1), 8f, -8f, -1, 0, 0, 0, 0, 0);
		TASK_PLAY_ANIM(0, uVar2, func_38(1, bParam2, bParam1, bVar1), 8f, -4f, -1, 0, 0, 0, 0, 0);
		TASK_PLAY_ANIM(0, uVar2, func_38(2, bParam2, bParam1, bVar1), 8f, -4f, uParam3, 1, 0, 0, 0, 0);
		TASK_PLAY_ANIM(0, uVar2, func_38(3, bParam2, bParam1, bVar1), 8f, -4f, -1, 0, 0, 0, 0, 0);
		TASK_PLAY_ANIM(0, uVar2, func_38(4, bParam2, bParam1, bVar1), 4f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_49(int iParam0)
{
	...
	if (!IS_ENTITY_DEAD(iParam0, 0))
	{
		if (IS_PED_BEING_JACKED(iParam0) || !func_51(iParam0, iLocal_98, -1))
		{
			...
			SET_PED_FLEE_ATTRIBUTES(iParam0, 196624, 1);
			if (func_50())
			{
				...
				if (GET_SCRIPT_TASK_STATUS(iLocal_96, 242628503) == 1)
				{
					if (GET_SEQUENCE_PROGRESS(iLocal_96) > 0)
					{
						if (IS_PED_IN_VEHICLE(iLocal_96, iLocal_98, 0))
						{
							...
							OPEN_SEQUENCE_TASK(&uLocal_101);
							TASK_VEHICLE_DRIVE_WANDER(0, iLocal_98, 10f, 786603);
							CLOSE_SEQUENCE_TASK(uLocal_101);
							TASK_PERFORM_SEQUENCE(iLocal_97, uLocal_101);
							CLEAR_SEQUENCE_TASK(&uLocal_101);
			...
			if (IS_PED_IN_VEHICLE(iLocal_97, iLocal_98, 0))
			{
				...
				if (IS_ENTITY_AT_ENTITY(iLocal_97, iLocal_96, 15f, 15f, 5f, 0, 1, 0) && fVar0 <= 1f)
				{
					...
					if (iLocal_66 >= iLocal_68)
					{
						...
						iLocal_68 = GET_RANDOM_INT_IN_RANGE(0, 10000);
						if (iLocal_68 > 2500)
						{
							CLEAR_PED_TASKS(iLocal_96);
							CLEAR_SEQUENCE_TASK(&uLocal_101);
							OPEN_SEQUENCE_TASK(&uLocal_101);
							TASK_ENTER_VEHICLE(0, iLocal_98, -1, 0, 1f, 8388609, 0);
							TASK_STAND_STILL(0, -1);
							CLOSE_SEQUENCE_TASK(uLocal_101);
							TASK_PERFORM_SEQUENCE(iLocal_96, uLocal_101);
							CLEAR_SEQUENCE_TASK(&uLocal_101);
...
int func_57()
{
	...
	if (!func_539())
	{
		...
		else if (func_479(iLocal_49, 4194304))
		{
			...
			{
				TASK_PLAY_ANIM(0, func_61(iLocal_293), func_60(7), 8f, -1.5f, -1, 0, 0, 0, 0, 0);
			}
			func_58(1);
			CLOSE_SEQUENCE_TASK(uVar0);
			TASK_PERFORM_SEQUENCE(iLocal_96, uVar0);
...
void func_58(bool bParam0)
{
	...
	{
		TASK_USE_NEAREST_SCENARIO_TO_COORD(0, vVar0, 20f, 0);
	}
}
...
void func_63(int iParam0)
{
	if (!IS_PED_INJURED(iParam0))
	{
		if (func_64(iParam0))
		{
			SET_PED_RESET_FLAG(iParam0, 109, 1);
		}
	}
}
...
int func_64(var uParam0)
{
	...
	{
		if ((IS_ENTITY_PLAYING_ANIM(uParam0, func_61(iLocal_293), func_60(1), 3) || IS_ENTITY_PLAYING_ANIM(uParam0, func_61(iLocal_293), func_60(2), 3)) || IS_ENTITY_PLAYING_ANIM(uParam0, func_61(iLocal_293), func_60(3), 3))
		{
			return 1;
		}
	}
...
int func_66(bool bParam0)
{
	...
	if (!func_539())
	{
		if (bParam0)
		{
			_DYNAMIC_MIXER_RELATED_FN(iLocal_96, "PROSTITUTE_GROUP", 0);
		...
		if (func_479(iLocal_49, 4194304))
		{
			...
			TASK_PLAY_ANIM(0, func_61(iLocal_293), func_60(0), 2f, -2f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, func_61(iLocal_293), func_60(iVar0), 2f, -2f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, func_61(iLocal_293), func_60(4), 2f, -2f, -1, 1, 0, 0, 0, 0);
			CLOSE_SEQUENCE_TASK(uVar1);
			TASK_PERFORM_SEQUENCE(iLocal_96, uVar1);
...
{
	if (IS_PED_MODEL(uParam0, Global_106565.f_10043.f_1[iParam1 /*11*/].f_10))
	{
		return 1;
	}
	return 0;
...
bool func_74(var uParam0, int iParam1, int iParam2)
{
	...
	return GET_PED_TEXTURE_VARIATION(uParam0, uVar0) == func_75(iParam1, iParam2);
}
...
bool func_78(var uParam0, int iParam1, int iParam2)
{
	...
	return GET_PED_DRAWABLE_VARIATION(uParam0, uVar0) == func_79(iParam1, iParam2);
}
		...
		if (IS_VEHICLE_DRIVEABLE(iLocal_98, 0))
		{
			if (IS_PED_IN_VEHICLE(iLocal_97, iLocal_98, 0))
			{
				...
				if (GET_SCRIPT_TASK_STATUS(iLocal_97, -272084098) == 7 || fVar0 <= 1f)
				{
					...
					OPEN_SEQUENCE_TASK(&uLocal_101);
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar10.x, vVar10.y, vVar10.z, 1f, -1, 0.5f, 8192, 1193033728);
					TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_97, 0);
					TASK_STAND_STILL(0, -1);
					CLOSE_SEQUENCE_TASK(uLocal_101);
					TASK_PERFORM_SEQUENCE(iLocal_96, uLocal_101);
					CLEAR_SEQUENCE_TASK(&uLocal_101);
		...
		if (IS_VEHICLE_DRIVEABLE(iLocal_98, 0))
		{
			if (IS_PED_IN_VEHICLE(iLocal_97, iLocal_98, 0))
			{
				if (func_85(&iLocal_98))
				{
					...
					vVar0 = { GET_ENTITY_COORDS(iLocal_96, 1) };
					if (GET_CLOSEST_VEHICLE_NODE(vVar0, &vVar0, 8, 1077936128, 0))
					{
	...
	if (IS_VEHICLE_DRIVEABLE(*iParam0, 0))
	{
		...
		if (func_88(iVar0, 0) && func_87(*iParam0))
		{
			if (GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(*iParam0) > 0)
			{
				...
				if (((iVar1 == 0 && IS_VEHICLE_SEAT_FREE(*iParam0, 0, 0)) && (!IS_VEHICLE_DOOR_DAMAGED(*iParam0, 1) && !IS_VEHICLE_DOOR_DAMAGED(*iParam0, 0))) || GET_PED_IN_VEHICLE_SEAT(*iParam0, 0, 0) == iLocal_96)
				{
					if (func_41(*iParam0))
					{
	...
	switch (iLocal_295)
	{
		case 0:
			...
			else if (iLocal_296 != 0 && !func_459("PROS_NO_MONEY"))
			{
				...
				{
					case 0:
						func_458(&uLocal_122, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
						break;
					
					case 1:
						func_458(&uLocal_122, 0, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
						break;
					
					case 2:
						func_458(&uLocal_122, 0, PLAYER_PED_ID(), "TREVOR", 0, 1);
						break;
				}
				iLocal_295 = 1;
			}
		...
		case 11:
			...
			if (func_539())
			{
				SET_PED_RESET_FLAG(PLAYER_PED_ID(), 433, 1);
				func_218(uParam0);
			}
			break;
...
void func_95()
{
	if (!IS_ANY_SPEECH_PLAYING(PLAYER_PED_ID()))
	{
		if (iLocal_72 == 0)
		{
			...
			{
				SET_PED_FLEE_ATTRIBUTES(iLocal_96, 32768, 0);
				SET_PED_FLEE_ATTRIBUTES(iLocal_96, 196624, 1);
			}
...
void func_96()
{
	...
	{
		case 0:
			if (!IS_ANY_SPEECH_PLAYING(iLocal_96) || func_114(&uLocal_107) > 4f)
			{
				func_109(iLocal_96);
...
void func_100(var uParam0, bool bParam1)
{
	...
	if (!IS_PED_INJURED(uParam0))
	{
		if (func_539())
		{
			...
			{
				RESET_PED_IN_VEHICLE_CONTEXT(uParam0);
			}
		}
		else
		{
		...
		if (func_479(iLocal_49, 134217728))
		{
			SET_PED_FLEE_ATTRIBUTES(uParam0, 32768, 1);
			TASK_SMART_FLEE_PED(uParam0, PLAYER_PED_ID(), 300f, -1, 1, 0);
		}
		else
		{
			SET_PED_FLEE_ATTRIBUTES(uParam0, 196624, 1);
			CLEAR_SEQUENCE_TASK(&uVar0);
			OPEN_SEQUENCE_TASK(&uVar0);
			TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
			if (IS_PED_IN_ANY_VEHICLE(uParam0, 0))
			{
				if (!IS_VEHICLE_STOPPED(GET_VEHICLE_PED_IS_IN(uParam0, 0)))
				{
					func_102(uParam0, 1);
				}
				else
				{
					if (IS_ENTITY_PLAYING_ANIM(uParam0, func_44(uParam0, 0, 0), func_103(0), 3))
					{
						if (iLocal_72 > 0)
						{
							TASK_PLAY_ANIM(0, func_44(uParam0, 0, 0), func_94(0), 4f, -4f, -1, 0, 0, 0, 0, 0);
						}
						else
						{
							TASK_PLAY_ANIM(0, func_44(uParam0, 0, 0), func_101(0), 4f, -4f, -1, 0, 0, 0, 0, 0);
						}
					}
					func_102(uParam0, 1);
				}
		...
		if (func_539())
		{
			...
			{
				if (_NETWORK_CAN_NETWORK_ID_BE_SEEN(NETWORK_GET_NETWORK_ID_FROM_ENTITY(iLocal_96)))
				{
...
{
	if (!_0x639431E895B9AA57(uParam0, GET_VEHICLE_PED_IS_IN(uParam0, 0), 0, 0, 0))
	{
...
void func_115(var uParam0)
{
	...
	if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			{
				if (GET_PED_IN_VEHICLE_SEAT(uVar1, -1, 0) != PLAYER_PED_ID())
				{
					bVar0 = true;
				}
				if (GET_PED_IN_VEHICLE_SEAT(uVar1, 0, 0) != iLocal_96)
				{
					bVar0 = true;
				}
				if (GET_VEHICLE_NUMBER_OF_PASSENGERS(uVar1) > 2)
				{
					bVar0 = true;
				}
				if (bVar0)
...
void func_116(bool bParam0)
{
	...
	if (bParam0)
	{
		...
		SET_GAMEPLAY_CAM_RELATIVE_PITCH((-5.5f - vVar0.x), 1065353216);
	}
...
void func_119()
{
	...
	if (!IS_ANY_SPEECH_PLAYING(PLAYER_PED_ID()))
	{
		...
		{
			func_34(&uLocal_107);
			SET_PLAYER_CONTROL(PLAYER_ID(), 0, 768);
			func_471(&iLocal_49, 2048);
			iLocal_295 = 13;
		}
	}
...
void func_127()
{
	...
	switch (iLocal_305)
	{
		...
		case 5:
			...
			{
				func_175(iLocal_96, 0);
				TASK_PLAY_ANIM(iLocal_96, func_44(PLAYER_PED_ID(), 0, 0), func_38(iLocal_305, 1, bVar1, bVar2), 4f, -4f, -1, 1, 0, 0, 0, 0);
				func_175(PLAYER_PED_ID(), -1);
				TASK_PLAY_ANIM(PLAYER_PED_ID(), func_44(PLAYER_PED_ID(), 0, 0), func_38(iLocal_305, 0, bVar1, bVar2), 4f, -4f, -1, 1, 0, 0, 0, 0);
				func_116(1);
				iLocal_50 = 0;
				iLocal_73 = 0;
				iLocal_61 = 0;
...
void func_135(int iParam0)
{
	...
	Global_106565.f_10043.f_1[iVar0 /*11*/].f_10 = GET_ENTITY_MODEL(iParam0);
	iVar2 = 0;
	while (iVar2 < 2)
	{
		iVar1 = iVar2;
...
{
	return GET_PED_TEXTURE_VARIATION(uParam0, func_76(iParam1));
}
...
{
	return GET_PED_DRAWABLE_VARIATION(uParam0, func_80(iParam1));
}
...
void func_150(bool bParam0, bool bParam1)
{
	...
	func_151(iLocal_96, iLocal_81, func_44(PLAYER_PED_ID(), 0, 0), func_38(4, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_151(PLAYER_PED_ID(), iLocal_82, func_44(PLAYER_PED_ID(), 0, 0), func_38(4, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
void func_151(int iParam0, int iParam1, var uParam2, var uParam3, float fParam4, float fParam5, int iParam6, int iParam7, float fParam8, int iParam9)
{
	...
	{
		TASK_SYNCHRONIZED_SCENE(iParam0, iParam1, uParam2, uParam3, fParam4, fParam5, iParam6, iParam7, fParam8, iParam9);
	}
}
...
void func_152(bool bParam0, bool bParam1)
{
	...
	func_153(iLocal_96, iLocal_81, func_44(PLAYER_PED_ID(), 0, 0), func_38(4, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
	func_154(&iLocal_82, 0, 0, 0);
	func_153(PLAYER_PED_ID(), iLocal_82, func_44(PLAYER_PED_ID(), 0, 0), func_38(4, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}
...
void func_153(int iParam0, int iParam1, var uParam2, var uParam3, float fParam4, float fParam5, int iParam6, int iParam7, int iParam8)
{
	if (func_539())
	{
		NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(iParam0, iParam1, uParam2, uParam3, fParam4, fParam5, iParam6, iParam7, iParam8, 0);
	}
}
...
void func_155(var uParam0, vector3 vParam1, vector3 vParam4, int iParam7)
{
	if (!func_539())
	{
		SET_SYNCHRONIZED_SCENE_ORIGIN(uParam0, vParam1, vParam4, iParam7);
	}
}
...
void func_156(var uParam0, int iParam1, var uParam2)
{
	...
	if (func_539())
	{
		NETWORK_ATTACH_SYNCHRONISED_SCENE_TO_ENTITY(uParam0, iParam1, uParam2);
	}
	else
	{
		ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uParam0, iParam1, uParam2);
	}
}
...
var func_157(vector3 vParam0, vector3 vParam3, bool bParam6, int iParam7, int iParam8)
{
	...
	if (func_539())
	{
		...
		uVar0 = NETWORK_CREATE_SYNCHRONISED_SCENE(vParam0, vParam3, iParam8, bParam6, iParam7, 1065353216, 0, 1065353216);
	}
	else
	{
		uVar0 = CREATE_SYNCHRONIZED_SCENE(vParam0, vParam3, iParam8);
		_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uVar0, bParam6);
		SET_SYNCHRONIZED_SCENE_LOOPED(uVar0, iParam7);
	}
	return uVar0;
}
...
void func_158(bool bParam0, bool bParam1)
{
	...
	func_151(iLocal_96, iLocal_80, func_44(PLAYER_PED_ID(), 0, 0), func_38(3, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_151(PLAYER_PED_ID(), iLocal_80, func_44(PLAYER_PED_ID(), 0, 0), func_38(3, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
void func_159(bool bParam0, bool bParam1)
{
	...
	func_153(iLocal_96, iLocal_80, func_44(PLAYER_PED_ID(), 0, 0), func_38(3, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
	func_153(PLAYER_PED_ID(), iLocal_80, func_44(PLAYER_PED_ID(), 0, 0), func_38(3, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}
...
void func_167(bool bParam0, bool bParam1)
{
	...
	func_151(iLocal_96, iLocal_79, func_44(PLAYER_PED_ID(), 0, 0), func_38(2, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_151(PLAYER_PED_ID(), iLocal_79, func_44(PLAYER_PED_ID(), 0, 0), func_38(2, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
void func_168(bool bParam0, bool bParam1)
{
	...
	func_153(iLocal_96, iLocal_79, func_44(PLAYER_PED_ID(), 0, 0), func_38(2, 1, bParam0, bParam1), 1000f, -1000f, iVar0, 0, 1148846080);
	func_153(PLAYER_PED_ID(), iLocal_79, func_44(PLAYER_PED_ID(), 0, 0), func_38(2, 0, bParam0, bParam1), 1000f, -1000f, iVar0, 0, 1148846080);
}
...
void func_169(bool bParam0, bool bParam1)
{
	...
	func_151(iLocal_96, iLocal_78, func_44(PLAYER_PED_ID(), 0, 0), func_38(1, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_151(PLAYER_PED_ID(), iLocal_78, func_44(PLAYER_PED_ID(), 0, 0), func_38(1, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
void func_170(bool bParam0, bool bParam1)
{
	...
	func_153(iLocal_96, iLocal_78, func_44(PLAYER_PED_ID(), 0, 0), func_38(1, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
	func_153(PLAYER_PED_ID(), iLocal_78, func_44(PLAYER_PED_ID(), 0, 0), func_38(1, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}
...
float func_171(int iParam0)
{
	...
	if (func_539())
	{
		uVar0 = GET_SYNCHRONIZED_SCENE_PHASE(_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iParam0));
	}
	else
	{
		uVar0 = GET_SYNCHRONIZED_SCENE_PHASE(iParam0);
	}
	return uVar0;
}
...
void func_173(bool bParam0, bool bParam1)
{
	...
	func_151(iLocal_96, iLocal_76, func_44(PLAYER_PED_ID(), 0, 0), func_38(0, 1, bParam0, bParam1), 8f, -0.7f, iVar0, 0, 1000f, 0);
	func_151(PLAYER_PED_ID(), iLocal_77, func_44(PLAYER_PED_ID(), 0, 0), func_38(0, 0, bParam0, bParam1), 8f, -0.7f, iVar0, 0, 1000f, 0);
}
...
void func_174(bool bParam0, bool bParam1)
{
	...
	func_153(iLocal_96, iLocal_76, func_44(PLAYER_PED_ID(), 0, 0), func_38(0, 1, bParam0, bParam1), 4f, -1000f, iVar0, 0, 1148846080);
	func_154(&iLocal_77, 0, 0, 1);
	func_153(PLAYER_PED_ID(), iLocal_77, func_44(PLAYER_PED_ID(), 0, 0), func_38(0, 0, bParam0, bParam1), 4f, -1000f, iVar0, 0, 1148846080);
}
...
void func_176(int iParam0)
{
	...
	SET_CAM_ACTIVE(Local_313[*iParam0 /*7*/], 1);
}
...
void func_177(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	...
	*uParam0 = CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 0);
	...
	SET_CAM_PARAMS(*uParam0, vParam1, uParam0->f_1, fParam7, 0, 1, 1, 2);
	RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
}
		...
		switch (iLocal_298)
		{
			...
			case 2:
				if (func_479(iLocal_49, 32768))
				{
					if (func_539())
					{
						iVar0 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_79);
					}
					else
					{
						iVar0 = iLocal_79;
...
char* func_194(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!IS_ENTITY_DEAD(iParam0, 0))
	{
		uVar1 = GET_VEHICLE_PED_IS_IN(iParam0, 1);
...
void func_196()
{
	...
	if (!IS_ANY_SPEECH_PLAYING(iLocal_96) && !IS_ANY_SPEECH_PLAYING(PLAYER_PED_ID()))
	{
		...
		else if (func_7(&uLocal_107) > GET_RANDOM_FLOAT_IN_RANGE(2f, 5f))
		{
...
bool func_211(int iParam0)
{
	...
	if (func_539())
	{
		uVar0 = IS_SYNCHRONIZED_SCENE_RUNNING(_NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iParam0));
	}
	else
	{
		uVar0 = IS_SYNCHRONIZED_SCENE_RUNNING(iParam0);
	}
	return uVar0;
}
...
void func_212()
{
	if (IS_SCREEN_FADED_OUT())
	{
		...
		SET_ENTITY_COORDS(PLAYER_PED_ID(), func_214(), 1, 0, 0, 1);
		SET_ENTITY_HEADING(PLAYER_PED_ID(), func_213());
		func_530();
		RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
		DELETE_PED(&iLocal_96);
	}
...
void func_215()
{
	...
	if (func_217(&uLocal_104, 3f) && !IS_CAM_ACTIVE(uLocal_103))
	{
		uVar0 = FLOOR(((func_216() - 2f) * 1000f));
		SET_CAM_ACTIVE(uLocal_102, 0);
		SET_CAM_ACTIVE_WITH_INTERP(uLocal_103, uLocal_102, uVar0, 1, 1);
	}
...
void func_219(int iParam0, var uParam1)
{
	...
	if (GET_EVENT_DATA(1, iParam0, &uVar0, 11))
	{
...
void func_224()
{
	...
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		...
		if (func_539())
		{
			...
			{
				SET_VEHICLE_HANDBRAKE(iLocal_99, 1);
				SET_VEHICLE_LIGHTS(iLocal_99, 4);
				SET_VEHICLE_INTERIORLIGHT(iLocal_99, 1);
				SET_VEHICLE_AUTOMATICALLY_ATTACHES(iLocal_99, 0, 0);
			}
		}
		else
		{
		...
		if (!func_369() || !IS_PED_IN_VEHICLE(iLocal_96, iLocal_99, 0))
		{
			func_462(0);
			return;
		}
	...
	func_206(0);
	if ((!IS_VEHICLE_STOPPED(iLocal_99) && IS_PLAYER_CONTROL_ON(PLAYER_ID())) && !func_479(iLocal_49, 1024))
	{
		iLocal_295 = 7;
		func_367(1, -1);
		REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\HUD_321_GO", 1, -1);
		iLocal_301 = 0;
		...
		case 1:
			if (func_539())
			{
				if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
					...
					{
						if (NETWORK_GET_ENTITY_IS_NETWORKED(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)))
						{
							if (GET_PED_IN_VEHICLE_SEAT(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), -1, 0) == PLAYER_PED_ID())
							{
								if (NETWORK_HAS_CONTROL_OF_ENTITY(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)))
								{
									...
									{
										SET_ENTITY_AS_MISSION_ENTITY(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0, 0);
									}
								}
								else
								{
						...
						{
							NETWORK_REGISTER_ENTITY_AS_NETWORKED(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0));
							return;
						}
					}
				}
...
void func_244(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_246() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_246() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_245(iParam0));
...
int func_248(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_246() /*10778*/].f_6165.f_10, iParam0);
}
...
void func_277()
{
	...
	else
	{
		...
		if (iLocal_298 == 0)
		{
			...
			REQUEST_SCRIPT_AUDIO_BANK("PROSTITUTE_BLOWJOB", 0, -1);
			iLocal_297 = 0;
		}
		...
		if (iVar5 == 1 && Global_17411.f_5728)
		{
			...
			if (GET_HASH_KEY(&(Global_17411.f_4690)) != 0 && Global_17411.f_4766 != -1)
			{
				...
				if (Global_17411.f_4768 != 0)
				{
					...
					DRAW_SPRITE(func_312(Global_17411.f_4768), func_309(Global_17411.f_4768, 1), ((Global_17408 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
				}
			...
			if (GET_HASH_KEY(&(Global_4267964.f_21)) != 0 && Global_4267964.f_65 != -1)
			{
				...
				if (Global_4267964.f_67 != 0)
				{
					...
					DRAW_SPRITE(func_312(Global_4267964.f_67), func_309(Global_4267964.f_67, 1), ((Global_17408 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
				}
				fVar51 = (fVar51 + (((_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
								...
								if (bVar33)
								{
									...
									if (bVar54)
									{
										if (func_318(26, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_318(26, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													DRAW_SPRITE(func_312(26), func_309(26, 1), ((fVar34 + fVar42) + fVar45), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
												}
											}
										}
										if (func_318(27, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_318(27, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													DRAW_SPRITE(func_312(27), func_309(27, 1), (((fVar34 + fVar42) + fVar45) + (fVar43 + fVar44)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
												}
											}
										}
									}
												...
												if (func_318(Global_17411.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (func_318(Global_17411.f_4433[(iVar22 + iVar28)], bVar32, 1, &fVar36, &fVar37, bParam7))
													{
														...
														if (iVar5 == 1)
														{
															if (Global_17411.f_5083[iVar8] == 2)
															{
																DRAW_SPRITE(func_312(Global_17411.f_4433[(iVar22 + iVar28)]), func_309(Global_17411.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar42) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
															else
															{
																DRAW_SPRITE(func_312(Global_17411.f_4433[(iVar22 + iVar28)]), func_309(Global_17411.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar42) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
														}
									...
									if (GET_HASH_KEY(&(Global_17411.f_73[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										else
										{
											...
											if (func_293() && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (iVar8 == 0)
												{
												...
												if (func_318(Global_17411.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														if (func_318(Global_17411.f_4433[(iVar22 + iVar14)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															...
															{
																DRAW_SPRITE(func_312(Global_17411.f_4433[(iVar22 + iVar14)]), func_309(Global_17411.f_4433[(iVar22 + iVar14)], bVar32), (Global_17408 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
															else if (Global_17411.f_5083[iVar8] == 2)
															{
																DRAW_SPRITE(func_312(Global_17411.f_4433[(iVar22 + iVar14)]), func_309(Global_17411.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar42) + fVar43) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
															else
															{
																DRAW_SPRITE(func_312(Global_17411.f_4433[(iVar22 + iVar14)]), func_309(Global_17411.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar42) + fVar43) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
														}
													}
									...
									if (func_318(Global_17411.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											if (func_318(Global_17411.f_4433[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												...
												DRAW_SPRITE(func_312(Global_17411.f_4433[iVar22]), func_309(Global_17411.f_4433[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), (fVar36 * func_290(Global_17411.f_4433[iVar22])), (fVar37 * func_290(Global_17411.f_4433[iVar22])), 0f, uVar47, uVar48, uVar49, uVar50, 0);
											}
										}
									}
								}
...
int func_320(bool bParam0, bool bParam1)
{
	...
	if ((((((((!IS_SCREEN_FADED_IN() || (func_24(8, -1) && func_321() != 64)) || (GET_PAUSE_MENU_STATE() != 0 && !bParam1)) || (IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0)) || SET_STORE_ENABLED()) || Global_71850) || Global_17411.f_8352) || IS_WARNING_MESSAGE_ACTIVE()) || Global_93734.f_1409)
	{
		return 0;
	}
	return 1;
...
void func_323()
{
	...
	{
		iLocal_304 = func_341();
		func_332(&iLocal_304, 0, 0, GET_RANDOM_INT_IN_RANGE(1, 2), 0, 0, 0);
	}
...
int func_341()
{
	...
	func_339(&uVar0, GET_CLOCK_SECONDS());
	func_338(&uVar0, GET_CLOCK_MINUTES());
	func_337(&uVar0, GET_CLOCK_HOURS());
	func_335(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_336(&uVar0, GET_CLOCK_MONTH());
	func_334(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
int func_355(char* sParam0, int iParam1)
{
	...
	if (NETWORK_IS_GAME_IN_PROGRESS() && func_356(PLAYER_ID()))
	{
...
int func_357(int iParam0, bool bParam1)
{
	...
	else if (!IS_ENTITY_PLAYING_ANIM(iParam0, func_44(PLAYER_PED_ID(), 0, 0), func_103(bParam1), 3) && GET_SCRIPT_TASK_STATUS(iParam0, -2017877118) != 1)
	{
		if (func_539())
		{
			if (iParam0 == PLAYER_PED_ID())
			{
				...
				TASK_PLAY_ANIM(iParam0, func_44(PLAYER_PED_ID(), 0, 0), func_358(bParam1), 2f, -8f, -1, 0, 0, 0, 0, 0);
			}
			else
			{
				TASK_PLAY_ANIM(iParam0, func_44(PLAYER_PED_ID(), 0, 0), func_358(bParam1), 2f, -8f, -1, 0, 0, 0, 0, 0);
	...
	{
		if (IS_ENTITY_PLAYING_ANIM(iParam0, func_44(PLAYER_PED_ID(), 0, 0), func_358(bParam1), 3))
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(iParam0, func_44(PLAYER_PED_ID(), 0, 0), func_358(bParam1)) >= 0.95f)
			{
				TASK_PLAY_ANIM(iParam0, func_44(PLAYER_PED_ID(), 0, 0), func_103(bParam1), 8f, -2f, -1, 1, 0, 0, 0, 0);
			}
		}
		if (IS_ENTITY_PLAYING_ANIM(iParam0, func_44(PLAYER_PED_ID(), 0, 0), func_103(bParam1), 3))
		{
			return 1;
		}
	}
...
int func_362()
{
	if (func_363(0, -1, 0) && REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\HUD_321_GO", 1, -1))
	{
		return 1;
	}
	return 0;
...
void func_366()
{
	...
	if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			if (DOES_ENTITY_EXIST(uVar0))
			{
				vLocal_56 = { GET_ENTITY_COORDS(uVar0, 1) };
			}
		}
	}
}
...
int func_371(int iParam0)
{
	...
	{
		if (GET_ENTITY_MODEL(iLocal_99) == joaat("tyrant"))
		{
			iLocal_308[iParam0] = _START_SHAPE_TEST_CAPSULE_2(vVar0, vVar3, 0.1f, 511, iLocal_99, 3);
		}
		else if ((GET_ENTITY_MODEL(iLocal_99) == joaat("casco") || GET_ENTITY_MODEL(iLocal_99) == joaat("feltzer3")) || GET_ENTITY_MODEL(iLocal_99) == joaat("fagaloa"))
		{
			iLocal_308[iParam0] = _START_SHAPE_TEST_CAPSULE_2(vVar0, vVar3, 0.15f, 511, iLocal_99, 3);
		}
		else
		{
			iLocal_308[iParam0] = _START_SHAPE_TEST_CAPSULE_2(vVar0, vVar3, 0.25f, 511, iLocal_99, 3);
		}
	}
	else
	{
		switch (GET_SHAPE_TEST_RESULT(iLocal_308[iParam0], &iVar6, &uVar7, &uVar10, &uVar13))
		{
			case 2:
...
void func_373()
{
	if (func_378() && !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
	{
		iLocal_295 = 9;
		func_376(iLocal_96);
		func_376(PLAYER_PED_ID());
		func_374();
		func_34(&uLocal_104);
	}
}
...
void func_374()
{
	...
	if (!DOES_CAM_EXIST(uLocal_102))
	{
		uLocal_102 = CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
	}
	if (!DOES_CAM_EXIST(uLocal_103))
	{
		uLocal_103 = CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
	}
	func_375(&Var0, &Var7);
	SET_CAM_COORD(uLocal_102, Var0);
	SET_CAM_ROT(uLocal_102, Var0.f_3, 2);
	SET_CAM_FOV(uLocal_102, Var0.f_6);
	SET_CAM_COORD(uLocal_103, Var7);
	SET_CAM_ROT(uLocal_103, Var7.f_3, 2);
	SET_CAM_FOV(uLocal_103, Var7.f_6);
	SET_CAM_ACTIVE(uLocal_102, 1);
	SET_CAM_ACTIVE(uLocal_103, 0);
	RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
}
...
void func_376(int iParam0)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_377(), 1f, -1, 0.5f, 8192, 1193033728);
		CLOSE_SEQUENCE_TASK(uVar0);
...
bool func_378()
{
	return VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), func_380()) < (func_379() * func_379());
}
	...
	if (func_369() && IS_PED_IN_VEHICLE(iLocal_96, iLocal_99, 0))
	{
		if (IS_VEHICLE_STOPPED(iLocal_99) && IS_VEHICLE_ON_ALL_WHEELS(iLocal_99))
		{
			if ((func_388() && !func_378()) && !func_387())
			{
				...
				{
					uLocal_85 = ADD_NAVMESH_BLOCKING_OBJECT(GET_ENTITY_COORDS(iLocal_99, 0), 40f, 40f, 40f, GET_ENTITY_HEADING(iLocal_99), 0, 7);
					SET_PLAYER_CONTROL(PLAYER_ID(), 0, 896);
					func_471(&iLocal_49, 2048);
					iLocal_100 = 0;
					ADD_RELATIONSHIP_GROUP("ProstituteInPlay", &uLocal_307);
					SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_307, 1862763509);
					SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_96, uLocal_307);
			...
			{
				if ((!IS_ANY_SPEECH_PLAYING(PLAYER_PED_ID()) && func_7(&uLocal_107) > 15f) && func_384())
				{
...
void func_385()
{
	if (func_539())
	{
		SET_PED_CONFIG_FLAG(iLocal_96, 229, 1);
		SET_PED_CONFIG_FLAG(iLocal_96, 26, 1);
		SET_PED_CONFIG_FLAG(iLocal_96, 115, 1);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_96, 1);
	}
}
	...
	if (!func_479(iLocal_49, 2097152))
	{
		if (GET_GAME_TIMER() > iLocal_84)
		{
			if (iLocal_100 == 0)
			{
				...
				GET_GROUND_Z_FOR_3D_COORD(vVar0, &fVar6, 0, 0);
				vVar0.z = (fVar6 + 0.15f);
				vVar3 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_99, 0f, 0f, -2f) };
				iLocal_100 = START_SHAPE_TEST_CAPSULE(vVar0, vVar3, 2f, 511, iLocal_99, 7);
			}
			else if (_GET_SHAPE_TEST_RESULT_EX(iLocal_100, &iVar8, &uVar9, &uVar12, &iVar7, &uVar15) == 2)
			{
				if (iVar8 != 0)
				{
...
int func_387()
{
	...
	if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
	{
		if (!IS_VEHICLE_SEAT_FREE(uVar0, 0, 0))
		{
...
int func_388()
{
	...
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
	{
		...
		if (!_0x639431E895B9AA57(iLocal_96, iLocal_99, 0, 0, 0))
		{
			return 0;
		}
		SET_SCENARIO_PEDS_TO_BE_RETURNED_BY_NEXT_COMMAND(1);
		if (GET_CLOSEST_PED(vVar1, 20f, 1, 1, &uVar0, 0, 1, -1))
		{
			if (DOES_ENTITY_EXIST(uVar0))
			{
				if (!IS_ENTITY_DEAD(uVar0, 0))
				{
					if (HAS_ENTITY_CLEAR_LOS_TO_ENTITY(uVar0, iLocal_99, 17))
					{
						return 0;
					}
				}
...
int func_392(vector3 vParam0)
{
	...
	uVar0 = GET_NTH_CLOSEST_VEHICLE_NODE_ID(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 1, 1, 1077936128, 0);
	GET_VEHICLE_NODE_POSITION(uVar0, &vParam0);
	if (_GET_SUPPORTS_GPS_ROUTE_FLAG(uVar0))
	{
		if (!_GET_IS_SLOW_ROAD_FLAG(uVar0))
		{
	...
	else if (!_GET_IS_SLOW_ROAD_FLAG(uVar0))
	{
		if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), vParam0) > 400f)
		{
			return 1;
	...
	{
		uVar0 = GET_NTH_CLOSEST_VEHICLE_NODE_ID(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 1, 8, 1077936128, 0);
		GET_VEHICLE_NODE_POSITION(uVar0, &vParam0);
		if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), vParam0) > 400f)
		{
			return 1;
...
int func_395()
{
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("carwash1")) > 0 || _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("carwash2")) > 0)
	{
		return 1;
	}
	return 0;
...
int func_401(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_146() == 0)
		{
			return IS_BIT_SET(func_134(func_399(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_403()
{
	if (!IS_ENTITY_DEAD(iLocal_96, 0))
	{
		if (IS_ENTITY_AT_ENTITY(iLocal_96, PLAYER_PED_ID(), 5f, 5f, 5f, 0, 1, 0) || func_479(iLocal_49, 8192))
		{
					...
					if (IS_PED_SITTING_IN_VEHICLE(iLocal_96, iLocal_99) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_99, 0))
					{
						...
						if (func_479(iLocal_49, 8))
						{
							if (HAS_CLIP_SET_LOADED(func_86()))
							{
								...
								{
									SET_PED_IN_VEHICLE_CONTEXT(iLocal_96, GET_HASH_KEY("MINI_PROSTITUTE_LOW_INFERNUS2_PASSENGER"));
								}
								else if (func_412(iLocal_99))
								{
									SET_PED_IN_VEHICLE_CONTEXT(iLocal_96, GET_HASH_KEY("MINI_PROSTITUTE_LOW_SC1_PASSENGER"));
								}
								else if (func_411(iLocal_99))
								{
									SET_PED_IN_VEHICLE_CONTEXT(iLocal_96, GET_HASH_KEY("MINI_PROSTITUTE_LOW_TEZERACT_PASSENGER"));
								}
								else if (func_410(iLocal_99))
								{
									SET_PED_IN_VEHICLE_CONTEXT(iLocal_96, GET_HASH_KEY("MINI_PROSTITUTE_LOW_DOMINATOR3_PASSENGER"));
								}
								else if (func_409(iLocal_99))
								{
									SET_PED_IN_VEHICLE_CONTEXT(iLocal_96, GET_HASH_KEY("MINI_PROSTITUTE_LOW_ITALIGTO_PASSENGER"));
								}
								else if (func_408(iLocal_99))
								{
									SET_PED_IN_VEHICLE_CONTEXT(iLocal_96, GET_HASH_KEY("MINI_PROSTITUTE_LOW_RESTRICTED_SCHLAGEN_PASSENGER"));
								}
								else if (func_407(iLocal_99))
								{
									SET_PED_IN_VEHICLE_CONTEXT(iLocal_96, GET_HASH_KEY("MINI_PROSTITUTE_LOW_NEO_PASSENGER"));
								}
								else if (func_406(iLocal_99))
								{
									SET_PED_IN_VEHICLE_CONTEXT(iLocal_96, GET_HASH_KEY("MINI_PROSTITUTE_LOW_PEYOTE2_PASSENGER"));
								}
								else
								{
						...
						if (func_539())
						{
							SET_ENTITY_AS_MISSION_ENTITY(iLocal_96, 0, 0);
						}
						else
						{
							SET_ENTITY_AS_MISSION_ENTITY(iLocal_96, 1, 1);
						}
						func_175(iLocal_96, 0);
						func_383();
						iLocal_64 = GET_GAME_TIMER();
			...
			{
				if ((func_405(iLocal_96, PLAYER_PED_ID(), 1) > 11f || func_404(20f)) || !IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_99, 0))
				{
					func_108(&uLocal_113);
				...
				if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
					...
					else if (!_0x639431E895B9AA57(iLocal_96, iLocal_99, 0, 0, 0))
					{
						if (!func_105())
						{
...
void func_418(var uParam0)
{
	...
	if (func_114(&uLocal_113) >= 20f || !IS_ENTITY_AT_ENTITY(iLocal_96, PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0))
	{
		if (func_479(iLocal_75, 524288))
		{
			func_108(&uLocal_113);
	...
	func_63(iLocal_96);
	if (((IS_ENTITY_AT_ENTITY(iLocal_96, PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0) || func_479(iLocal_75, 1)) && !func_209(0)) && !func_394())
	{
		if (!_0x639431E895B9AA57(iLocal_96, iLocal_99, 0, 0, 0))
		{
			if (!func_105())
...
void func_419()
{
	...
	{
		func_422();
		if (func_420(iLocal_74, 1) || IS_PLAYER_PRESSING_HORN(PLAYER_ID()))
		{
		...
		if (func_479(iLocal_49, 8192))
		{
			func_457();
			Global_25915 = 1;
			Global_2424047[PLAYER_ID() /*416*/].f_406 = 1;
			func_124("PROSTITUTES_SOLICIT_SCENE");
			...
			if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
				...
				{
					TASK_ENTER_VEHICLE(iLocal_96, iLocal_99, -1, 0, 1f, 8388609, 0);
				}
			}
			uLocal_63 = func_44(PLAYER_PED_ID(), 1, 0);
			REQUEST_ANIM_DICT(uLocal_63);
			uLocal_63 = func_44(PLAYER_PED_ID(), 0, 1);
			REQUEST_ANIM_DICT(uLocal_63);
			func_34(&uLocal_107);
			iLocal_295 = 5;
		}
...
int func_426()
{
	...
	if (!func_539())
	{
		...
		else if (func_479(iLocal_49, 4194304))
		{
			...
			OPEN_SEQUENCE_TASK(&uVar1);
			TASK_PLAY_ANIM(0, func_61(iLocal_293), func_60(5), 2f, -2f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, func_61(iLocal_293), func_60(iVar0), 8f, -8f, -1, 1, 0, 0, 0, 0);
			CLOSE_SEQUENCE_TASK(uVar1);
			TASK_PERFORM_SEQUENCE(iLocal_96, uVar1);
			CLEAR_SEQUENCE_TASK(&uVar1);
		}
...
int func_427(bool bParam0)
{
	...
	if (func_405(iLocal_96, PLAYER_PED_ID(), 1) > 11f)
	{
		return 0;
	}
	if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	...
	{
		if (!func_479(iLocal_50, 8192) && !IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER_PED_ID()))
		{
	...
	if (!func_369())
	{
		if (!func_539())
		{
			if ((!iLocal_88 && !Global_105612) && func_429(PLAYER_PED_ID(), 0) == -1)
			{
				func_342("PROS_CAR", -1);
				iLocal_88 = 1;
			}
...
void func_430()
{
	...
	{
		func_419();
		if (GET_SCRIPT_TASK_STATUS(iLocal_96, 242628503) == 7 && !func_479(iLocal_49, 8192))
		{
			if (func_66(1))
			{
				func_108(&uLocal_113);
...
void func_432(var uParam0)
{
	...
	if ((GET_SCRIPT_TASK_STATUS(iLocal_96, -1794415470) != 1 || !func_479(iLocal_49, 8192)) && VDIST2(vLocal_93, vVar9) > 0f)
	{
		if (func_539())
		{
			if (!IS_ENTITY_A_MISSION_ENTITY(iLocal_96))
			{
				SET_ENTITY_AS_MISSION_ENTITY(iLocal_96, 0, 1);
			}
			func_442(&uLocal_287, func_61(iLocal_293));
			func_436(uParam0, 1);
			func_433(&uLocal_287, uParam0);
		}
		OPEN_SEQUENCE_TASK(&uVar18);
		TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar9.x, vVar9.y, vVar9.z, 1f, -1, 1f, 8192, 1193033728);
		TASK_TURN_PED_TO_FACE_COORD(0, GET_PED_BONE_COORDS(PLAYER_PED_ID(), 31086, 0f, 0f, 0f), 0);
		CLOSE_SEQUENCE_TASK(uVar18);
		TASK_PERFORM_SEQUENCE(iLocal_96, uVar18);
		CLEAR_SEQUENCE_TASK(&uVar18);
		vLocal_93 = { vVar9 };
	}
}
...
void func_444(var uParam0)
{
	...
	if (func_427(1))
	{
		...
		if (func_460(&uLocal_113, 2f) || func_479(iLocal_49, 8192))
		{
			...
			{
				if (ARE_STRINGS_EQUAL(func_456(&sVar0), "PIM_HHIDCR"))
				{
				...
				func_5(&iLocal_49, 4);
				Global_25915 = 0;
				Global_2424047[PLAYER_ID() /*416*/].f_406 = 0;
			}
		}
	}
	else
...
void func_446(int iParam0, int iParam1, int iParam2)
{
	...
	if (NETWORK_IS_GAME_IN_PROGRESS() && func_450(PLAYER_ID(), 1))
	{
		return;
	}
...
int func_474()
{
	...
	iLocal_98 = GET_RANDOM_VEHICLE_IN_SPHERE(GET_ENTITY_COORDS(iLocal_96, 1), 15f, 0, 6);
	if (DOES_ENTITY_EXIST(iLocal_98) && !IS_ENTITY_DEAD(iLocal_98, 0))
	{
		if (IS_VEHICLE_DRIVEABLE(iLocal_98, 0))
		{
			if (func_85(&iLocal_98))
			{
				iLocal_97 = GET_PED_IN_VEHICLE_SEAT(iLocal_98, -1, 0);
				if (!iLocal_97 == 0)
				{
					if (func_475(&iLocal_97))
					{
						...
						if (!iVar0 == joaat("taxi") && !iVar0 == joaat("taxi"))
						{
							...
							{
								SET_ENTITY_AS_MISSION_ENTITY(iLocal_97, 1, 0);
							}
							if (!IS_ENTITY_A_MISSION_ENTITY(iLocal_98))
							{
								SET_ENTITY_AS_MISSION_ENTITY(iLocal_98, 1, 0);
							}
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_97, 1);
							SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_97, 0, 1);
							SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_98, 0, 1);
							return 1;
						}
					}
				}
...
int func_477()
{
	if ((!func_476() || !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0)) || func_479(iLocal_49, 4096))
	{
		return 0;
	}
	if (func_479(iLocal_49, 32))
...
void func_478()
{
	if (!IS_ENTITY_DEAD(iLocal_96, 0))
	{
		if (!IS_PED_FLEEING(iLocal_96))
		{
			...
			{
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_96, 0);
				SET_PED_FLEE_ATTRIBUTES(iLocal_96, 196628, 1);
				_0xF1C03A5352243A30(iLocal_96);
				TASK_SMART_FLEE_PED(iLocal_96, PLAYER_PED_ID(), 300f, -1, 1, 0);
				SET_PED_KEEP_TASK(iLocal_96, 1);
				func_89(15);
			}
		}
	}
...
void func_492()
{
	...
	{
		if (Global_25919 != GET_ID_OF_THIS_THREAD() && func_479(iLocal_49, 32))
		{
			func_5(&iLocal_49, 32);
		}
		return;
	}
	if ((VDIST2(GET_ENTITY_COORDS(iLocal_96, 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) < Global_25918 || Global_25918 == 0f) && iLocal_296 != 4)
	{
		Global_25918 = VDIST2(GET_ENTITY_COORDS(iLocal_96, 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1));
		Global_25919 = GET_ID_OF_THIS_THREAD();
		func_471(&iLocal_49, 32);
	}
	else if (Global_25919 == GET_ID_OF_THIS_THREAD())
	{
		Global_25918 = VDIST2(GET_ENTITY_COORDS(iLocal_96, 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1));
	}
	else
...
void func_493()
{
	if (func_539())
	{
		if (NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_96))
		{
			SET_PED_RESET_FLAG(iLocal_96, 323, 1);
		}
	}
	else
	{
		...
		if (!IS_ENTITY_DEAD(iLocal_96, 0) && !IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
		{
			if (func_498())
			{
				if (func_539())
				{
					...
					if (!IS_ENTITY_A_MISSION_ENTITY(iLocal_96))
					{
						SET_ENTITY_AS_MISSION_ENTITY(iLocal_96, 1, 0);
					}
...
int func_496()
{
	...
	{
		return IS_VEHICLE_SIREN_ON(uVar0);
	}
	return 0;
}
...
int func_498()
{
	...
	if (!func_479(iLocal_49, 4096))
	{
		if (func_405(iLocal_96, PLAYER_PED_ID(), 1) < 30f)
		{
			vVar0 = { GET_ENTITY_COORDS(iLocal_96, 1) };
			if ((((((IS_SHOCKING_EVENT_IN_SPHERE(86, vVar0, 30f) || IS_SHOCKING_EVENT_IN_SPHERE(89, vVar0, 30f)) || IS_SHOCKING_EVENT_IN_SPHERE(88, vVar0, 30f)) || IS_SHOCKING_EVENT_IN_SPHERE(102, vVar0, 30f)) || IS_SHOCKING_EVENT_IN_SPHERE(114, vVar0, 30f)) || (IS_SHOCKING_EVENT_IN_SPHERE(112, vVar0, 30f) && !func_539())) || IS_PED_SHOOTING(PLAYER_PED_ID()))
			{
				if (!func_539())
				{
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_96, 0);
	...
	if ((DOES_ENTITY_EXIST(iLocal_96) && !IS_ENTITY_DEAD(iLocal_96, 0)) && !IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
	{
		...
		if (!IS_PED_INJURED(iLocal_96))
		{
			if (!IS_PED_IN_ANY_VEHICLE(iLocal_96, 0))
			{
				...
				else if (!(func_500() || IS_PLAYER_SWITCH_IN_PROGRESS()))
				{
			...
			else if (!(func_500() || (IS_PLAYER_SWITCH_IN_PROGRESS() && !func_395())))
			{
				func_480("prostitute SCRIPT SHOULD EXIT - PLAYER ON MISSION");
				func_99(0);
				func_89(15);
...
void func_505()
{
	...
	if (GET_NUM_RESERVED_MISSION_PEDS(0, 0) != 1)
	{
		if (func_506(1, 0, 1))
		{
...
void func_524(var uParam0)
{
	...
	if (!IS_PED_INJURED(iLocal_96))
	{
		if (IS_ENTITY_A_MISSION_ENTITY(iLocal_96))
		{
			if ((func_539() && GET_SCRIPT_TASK_STATUS(iLocal_96, 1805844857) != 1) && GET_SCRIPT_TASK_STATUS(iLocal_96, -251125078) != 1)
			{
				TASK_WANDER_STANDARD(iLocal_96, 1193033728, 0);
				if (NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_96))
				{
	...
	if (func_539())
	{
		if (DOES_NAVMESH_BLOCKING_OBJECT_EXIST(uLocal_85))
		{
			REMOVE_NAVMESH_BLOCKING_OBJECT(uLocal_85);
		}
	}
	iLocal_98 = 0;
	func_528();
	...
	if (Global_25919 == GET_ID_OF_THIS_THREAD())
	{
		Global_25915 = 0;
		Global_2424047[PLAYER_ID() /*416*/].f_406 = 0;
	}
...
void func_529(bool bParam0)
{
	if (!IS_PED_INJURED(iLocal_96))
	{
		if (IS_PED_IN_ANY_VEHICLE(iLocal_96, 0))
		{
			...
			{
				TASK_LEAVE_ANY_VEHICLE(iLocal_96, 0, 65536);
			}
		}
		if (bParam0)
		{
...
void func_530()
{
	...
	if (!IS_ENTITY_DEAD(iLocal_96, 0))
	{
		...
		_0x18EB48CFC41F2EA0(iLocal_96, 0);
	}
	if (IS_VEHICLE_DRIVEABLE(iLocal_99, 0) && !IS_ENTITY_DEAD(iLocal_99, 0))
	{
		if (func_539())
		{
			if (NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_99))
			{
				if (Global_1589819[PLAYER_ID() /*818*/].f_273.f_25 <= 0 && !IS_BIT_SET(Global_1589819[PLAYER_ID() /*818*/].f_273.f_23, 11))
				{
					SET_VEHICLE_HANDBRAKE(iLocal_99, 0);
					SET_VEHICLE_LIGHTS(iLocal_99, 3);
					SET_VEHICLE_INTERIORLIGHT(iLocal_99, 0);
				}
				SET_VEHICLE_AUTOMATICALLY_ATTACHES(iLocal_99, 1, 0);
			}
		}
		else
		{
	...
	if (func_539())
	{
		if (func_512(2))
		{
			...
			else if (NETWORK_GET_ENTITY_IS_NETWORKED(iLocal_99))
			{
				if (NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_99))
				{
...
void func_531()
{
	...
	{
		_0x0BCA1D2C47B0D269(131, func_534(), 0f);
		_0x0BCA1D2C47B0D269(117, func_533(), 0f);
		_0x0BCA1D2C47B0D269(118, func_532(), 0f);
	}
}
...
int func_541(var uParam0, int iParam1)
{
	...
	{
		iVar0 = GET_PLAYER_PED(uParam0);
		if (IS_PED_IN_ANY_VEHICLE(iVar0, iParam1))
		{
			uVar3 = GET_VEHICLE_PED_IS_IN(iVar0, 0);
			iVar1 = 0;
			while (iVar1 < 32)
			{
				uVar2 = INT_TO_PLAYERINDEX(iVar1);
				if (func_201(uVar2, 1, 1))
				{
					if (GET_PLAYER_PED(uVar2) != iVar0)
					{
						if (IS_PED_IN_VEHICLE(GET_PLAYER_PED(uVar2), uVar3, iParam1))
						{
							return 1;
						}
					}
