...
void __EntryFunction__()//Position - 0x0
{
	...
	func_321(&iLocal_83, &(Local_82.f_1C[0]));
	while (true)
	{
		SYSTEM::WAIT(0);
	...
	switch (iLocal_87)
	{
		case 0:
			...
			if (func_297(iLocal_83))
			{
				...
				{
					BRAIN::TASK_PLAY_ANIM(iLocal_83, "rcmabigail", "loop_2_cs", 8f, -8f, 4294967295, 2, 0, 0, 0, 0);
		...
		case 4:
			if (CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				...
				if (func_297(AUDIO::_0x0626A247D2405330()) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
				{
					HUD::_0xC65AB383CD91DF98();
					NETWORK::_0x5E3AA4CA2B6FB0EE(AUDIO::_0x0626A247D2405330());
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(AUDIO::_0x0626A247D2405330(), -1606.534f, 5253.981f, 2.9994f, 1f, 20000, 1048576000, 0, 1193033728);
					BRAIN::TASK_LOOK_AT_COORD(AUDIO::_0x0626A247D2405330(), -1602.62f, 5260.37f, 1.41f, 4294967295, 0, 2);
				}
				if (func_297(iLocal_83) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Abigail", 0))
				{
					NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_83);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_83, -1581.559f, 5198.014f, 3.0091f, 1f, 20000, 1048576000, 0, 1193033728);
				}
			}
			else
			{
		...
		case 5:
			...
			if (func_218(1000) || MISC::GET_GAME_TIMER() > iLocal_86)
			{
				...
				func_204(&iLocal_83);
				if (func_297(AUDIO::_0x0626A247D2405330()))
				{
					NETWORK::_0x5E3AA4CA2B6FB0EE(AUDIO::_0x0626A247D2405330());
					BRAIN::TASK_LOOK_AT_COORD(AUDIO::_0x0626A247D2405330(), -1602.62f, 5260.37f, 1.41f, 5000, 0, 2);
				}
				func_3();
			}
...
void func_2(char* sParam0)//Position - 0x50F
{
	...
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 1, 1, 4294967295);
}
...
int func_12()//Position - 0x126E
{
	return Global_1407E0;
}

void func_13()//Position - 0x127A
{
	func_30();
	func_22();
	func_18();
...
void func_14(int iParam0)//Position - 0x12D3
{
	if (iParam0 == 1)
	{
...
void func_16()//Position - 0x131A
{
	StringCopy(&Global_1170D, "", 16);
	StringCopy(&Global_11711, "", 16);
}

void func_17()//Position - 0x1336
{
	int iVar0;
...
void func_21(int iParam0)//Position - 0x1408
{
	if (iParam0 == 1)
	{
		Global_8F3A = 1;
...
void func_22()//Position - 0x1421
{
	func_23(&Global_18531);
}

void func_23(var uParam0)//Position - 0x1431
{
	int iVar0;
	int iVar1;
...
void func_24(var uParam0)//Position - 0x19C1
{
	*uParam0 = 4294967295;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_25(var uParam0)//Position - 0x19DC
{
	func_26(&(uParam0->f_C));
	*uParam0 = { 0f, 0f, 0f };
...
void func_26(var uParam0)//Position - 0x1A0B
{
	int iVar0;
...
void func_27(var uParam0)//Position - 0x1ABC
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_28(var uParam0)//Position - 0x1ADA
{
	int iVar0;
...
void func_29(var uParam0)//Position - 0x1BBB
{
	*uParam0 = 4294967281;
}

void func_30()//Position - 0x1BC9
{
	StringCopy(&Global_17990, "", 32);
	func_23(&Global_17998);
}

void func_31()//Position - 0x1BE3
{
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x1D21
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_34(int iParam0, int iParam1, int iParam2)//Position - 0x1EE0
{
	int iVar0;
...
int func_35(int iParam0)//Position - 0x1F6C
{
	switch (iParam0)
	{
...
int func_36(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1FA7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_37(int iParam0, int iParam1, int iParam2)//Position - 0x27BD
{
	int iVar0;
	int iVar1;
...
int func_38(int iParam0, int iParam1, int iParam2)//Position - 0x2847
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_39(int iParam0, int iParam1, int iParam2)//Position - 0x2925
{
...
int func_40(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x2950
{
	var uVar0;
	int iVar1;
...
int func_41(int iParam0, int iParam1, int iParam2)//Position - 0x2F54
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_42(int iParam0, int iParam1, int iParam2)//Position - 0x2FED
{
	int iVar0;
	int iVar1;
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x308E
{
	int iVar0;
...
int func_44(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x3395
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_45(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x3F48
{
	int iVar0;
...
int func_46(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x422D
{
	int iVar0;
...
int func_47(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x44F4
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x452B
{
	int iVar0;
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x4554
{
	*iParam2 = 4294967197;
	switch (iParam0)
	{
...
int func_50(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x481E
{
	int iVar0;
...
int func_51(int iParam0, int iParam1, int iParam2)//Position - 0x4AA8
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_52(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4BFF
{
	int iVar0;
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4C97
{
	switch (iParam0)
	{
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4D65
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_55(int iParam0, int iParam1)//Position - 0x4EC1
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_56(int iParam0)//Position - 0x5268
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x52C9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_58(int iParam0, int iParam1)//Position - 0x53C5
{
	int iVar0;
...
int func_59(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5503
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0)//Position - 0x55E3
{
	switch (iParam0)
	{
		case 0:
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5669
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x58E6
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_63(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5D0B
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_64(int iParam0, int iParam1)//Position - 0x5FFE
{
	int iVar0;
	int iVar1;
...
int func_65(int iParam0, int iParam1)//Position - 0x6044
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_66(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x60A4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_67(int iParam0)//Position - 0x6128
{
...
void func_68(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x61E0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_69(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x622A
{
	int iVar0;
...
int func_70(var uParam0)//Position - 0x625A
{
	int iVar0;
	int iVar1;
...
int func_71(int iParam0, int iParam1, int iParam2)//Position - 0x628E
{
	int iVar0;
	var uVar1;
...
bool func_72(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x62C0
{
	int iVar0;
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x7D79
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_74(int iParam0)//Position - 0x8C98
{
	if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11569[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8CE9
{
	int iVar0;
...
int func_76(int iParam0)//Position - 0x8D7F
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_77(int iParam0, int iParam1)//Position - 0x8E2F
{
	int iVar0;
	struct<10> Var1;
...
void func_78(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x975E
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar2;
...
void func_79(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x9888
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_80(int iParam0, int iParam1)//Position - 0x98D0
{
	int iVar0;
	struct<17> Var1;
...
void func_81(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB718
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar2;
...
int func_82(int iParam0)//Position - 0xB902
{
	switch (iParam0)
	{
		case 0:
...
void func_83(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xB9B2
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBA23
{
	func_148();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_85(int iParam0, int iParam1)//Position - 0xBA75
{
	switch (iParam0)
	{
		case 0:
...
void func_86(int iParam0)//Position - 0xBB65
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_87(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xCDDE
{
	int iVar0;
	int iVar1;
...
bool func_88(int iParam0, int iParam1, var uParam2)//Position - 0xD16F
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_89(int iParam0, int iParam1)//Position - 0xD574
{
	switch (iParam1)
	{
		case 0:
...
int func_90(int iParam0, int iParam1)//Position - 0xD96F
{
	switch (iParam1)
	{
		case 0:
...
int func_91(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xDD6A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_92(int iParam0)//Position - 0xDDAC
{
	return Global_8D15 == iParam0;
}

int func_93(int iParam0)//Position - 0xDDBA
{
	switch (iParam0)
	{
		case 4294967295:
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDE8E
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_95(int iParam0)//Position - 0xE167
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_96(int iParam0)//Position - 0xE2BE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_97(int iParam0)//Position - 0xE7CC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_98(int iParam0)//Position - 0xE841
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_99(int iParam0)//Position - 0xE8B5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_100(int iParam0)//Position - 0xE99C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_101(int iParam0)//Position - 0xECFF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_102(int iParam0)//Position - 0xEF10
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_103(int iParam0)//Position - 0xF140
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_104(int iParam0)//Position - 0xF250
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_105(int iParam0)//Position - 0xFBEF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_106(int iParam0)//Position - 0x10764
{
	if (iParam0 < 136)
	{
		func_108(iParam0);
...
void func_107(int iParam0)//Position - 0x10799
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0x1139D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0)//Position - 0x122AB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0)//Position - 0x123D8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0, int iParam1)//Position - 0x124D6
{
	switch (iParam0)
	{
		case 0:
...
void func_112(int iParam0)//Position - 0x125C6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0x13AB7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x13C08
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0x14114
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x14782
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0x147F6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x148C6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0x14DF6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0x14F8D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0x1578B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0x1589B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0x167C6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0x17483
{
	if (iParam0 < 107)
	{
		func_127(iParam0);
...
void func_125(int iParam0)//Position - 0x174C9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x17F6E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0, int iParam1, int iParam2)//Position - 0x1FDBE
{
	...
	if (iParam0 != 4294967295)
	{
		...
		func_161(&uVar1, Var0.f_3, Global_16C55, iParam1, iParam2);
	}
}

void func_161(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x1FDFD
{
...
void func_179(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x21E6F
{
	if (iParam0 != 198)
	{
		if (Global_11625)
...
void func_180(int iParam0, int iParam1)//Position - 0x21ECA
{
	switch (iParam0)
	{
		case 12:
...
void func_181(int iParam0, bool bParam1)//Position - 0x21FB3
{
	if (bParam1)
	{
...
bool func_182(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x21FDC
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_183()//Position - 0x22944
{
	if ((func_9() == 4294967295 || func_9() == 999) && !func_184() == 0)
	{
		return 1;
	}
	return 0;
...
int func_184()//Position - 0x22974
{
	return Global_6374;
}

int func_185(var uParam0, int iParam1)//Position - 0x2297F
{
	int iVar0;
...
int func_186(int iParam0)//Position - 0x261BF
{
	switch (iParam0)
	{
		case 46:
...
void func_187(int iParam0, bool bParam1)//Position - 0x262B1
{
	switch (iParam0)
	{
		case 46:
...
void func_188(int iParam0, bool bParam1)//Position - 0x26302
{
	int iVar0;
...
void func_189(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x26368
{
	func_190(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_190(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2638A
{
	int iVar0;
...
void func_191()//Position - 0x2655E
{
	int iVar0;
...
int func_192(int iParam0)//Position - 0x2667E
{
	int iVar0;
	int iVar1;
...
int func_195(int iParam0)//Position - 0x268B9
{
...
void func_196(int iParam0, int iParam1)//Position - 0x268E6
{
...
int func_197(char* sParam0)//Position - 0x26923
{
	int iVar0;
...
int func_198()//Position - 0x26983
{
	return func_199(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_199(char* sParam0, int iParam1)//Position - 0x26994
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_200(int iParam0, int iParam1, bool bParam2)//Position - 0x269DD
{
	Global_BFD = iParam0;
...
void func_201()//Position - 0x26B87
{
	char cVar0[64];
	char cVar1[64];
	char* sVar2;
...
void func_202()//Position - 0x26C08
{
	if (func_92(14))
	{
...
int func_203()//Position - 0x26CAA
{
	func_155();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_204(int iParam0)//Position - 0x26CC3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_205(var uParam0, int iParam1, bool bParam2)//Position - 0x26D04
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_297(uParam0->f_1C[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_297(uParam0->f_23[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_297(uParam0->f_29[iVar0]))
		{
...
void func_206(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x26DF9
{
	int iVar0;
...
int func_207(int iParam0)//Position - 0x26EA1
{
	if (func_297(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_208(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x26EC1
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_212(CAM::_0xDC9DA9E8789F5246())) && !func_210(CAM::_0xDC9DA9E8789F5246(), 0)) && !func_209()) && !bParam4)
			{
				ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), 0);
			}
		}
		else if ((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_212(CAM::_0xDC9DA9E8789F5246())) && !bParam4)
		{
			ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), 0);
		}
		Global_11623 = 0;
...
int func_211(int iParam0, bool bParam1)//Position - 0x27052
{
	int iVar0;
	int iVar1;
...
int func_212(int iParam0)//Position - 0x27093
{
...
bool func_213()//Position - 0x270D5
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_240006, 3);
}

int func_214(int iParam0, var uParam1, var uParam2, int iParam3)//Position - 0x270E6
{
	int iVar0;
...
void func_216(int iParam0)//Position - 0x27140
{
	if (iParam0 == 1)
	{
...
bool func_217(char* sParam0)//Position - 0x27163
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

int func_218(int iParam0)//Position - 0x27176
{
...
void func_220(int iParam0)//Position - 0x271F2
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_221(int iParam0, bool bParam1)//Position - 0x27217
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_222(int iParam0, int iParam1, bool bParam2)//Position - 0x27274
{
	if (iParam0 == 4294967295)
	{
		return;
...
bool func_223(int iParam0, int iParam1)//Position - 0x272AF
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
void func_224(int iParam0, bool bParam1)//Position - 0x272D2
{
...
void func_225(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x2730E
{
	int iVar0;
...
Vector3 func_226(int iParam0)//Position - 0x274CC
{
	return unk_0x8000C77B5F336760(PLAYER::GET_PLAYER_PED(uParam0), 0);
}

void func_227(vector3 vParam0, float fParam1, int iParam2, int iParam3)//Position - 0x274DF
{
	vector3 vVar0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_17998.f_4))
	{
		...
		{
			if (func_275(24) != Global_17998.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_272(unk_0x8000C77B5F336760(Global_17998.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_228(Global_17998.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}

void func_228(int iParam0, vector3 vParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x2755A
{
	struct<60> Var0;
...
void func_229(int iParam0, int iParam1, int iParam2)//Position - 0x27683
{
	int iVar0;
	...
	if (!func_259(&(Global_11188.f_22B[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_19E56.f_7F5D.f_12C1 = func_248();
			}
...
void func_230(int iParam0, int iParam1)//Position - 0x277A0
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_267(iParam0, &(Global_19E56.f_7F5D.f_1586));
}

int func_231(int iParam0)//Position - 0x279A2
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0)) || func_246(iParam0, 0, 0)) || func_246(iParam0, 1, 0)) || func_246(iParam0, 2, 0)) || func_265(iParam0) != 145) || func_245(iParam0)) || func_244(iParam0)) || func_243(iParam0)) || func_242(iParam0)) || !func_232(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_244(iParam0))
		{
		}
...
int func_232(int iParam0)//Position - 0x27A7F
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_233(int iParam0, bool bParam1)//Position - 0x27C30
{
	int iVar0;
	struct<2> Var1;
...
int func_234(int iParam0)//Position - 0x27DB0
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_236(int iParam0)//Position - 0x27E93
{
	int iVar0;
	int iVar1;
...
int func_237()//Position - 0x29B8F
{
	return 0;
}

int func_238()//Position - 0x29B98
{
	return 1;
}

int func_239()//Position - 0x29BA1
{
	return 1;
}

int func_240()//Position - 0x29BAA
{
...
int func_242(int iParam0)//Position - 0x29C7E
{
	int iVar0;
	char* sVar1;
...
int func_243(int iParam0)//Position - 0x29CC4
{
	int iVar0;
...
int func_244(int iParam0)//Position - 0x29CFF
{
	int iVar0;
...
int func_245(int iParam0)//Position - 0x29D7B
{
	int iVar0;
...
int func_246(int iParam0, int iParam1, bool bParam2)//Position - 0x29E63
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_247(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x29ED4
{
...
void func_249(var uParam0, int iParam1)//Position - 0x29FF3
{
	if (iParam1 <= 0)
	{
		return;
...
void func_250(var uParam0, int iParam1)//Position - 0x2A079
{
...
void func_251(var uParam0, int iParam1)//Position - 0x2A0AC
{
	int iVar0;
	int iVar1;
...
int func_252(int iParam0, int iParam1)//Position - 0x2A0FD
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_253(int iParam0)//Position - 0x2A19F
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_254(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}

int func_254(bool bParam0, int iParam1, int iParam2)//Position - 0x2A1C4
{
	if (bParam0)
	{
		return iParam1;
...
int func_255(var uParam0)//Position - 0x2A1DB
{
	return uParam0 & 15;
}

void func_256(var uParam0, int iParam1)//Position - 0x2A1E8
{
...
void func_257(var uParam0, int iParam1)//Position - 0x2A222
{
...
void func_258(var uParam0, int iParam1)//Position - 0x2A25D
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_259(var uParam0, int iParam1)//Position - 0x2A299
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam0->f_9, 10))
	{
		...
		if (!func_266(Global_19E56.f_7F5D.f_748[uParam0->f_E /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_266(Global_19E56.f_933.f_21B.f_DF0[1 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_266(Global_19E56.f_933.f_21B.f_DF0[0 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_260(int iParam0, int iParam1)//Position - 0x2B991
{
	struct<82> Var0;
...
void func_261(int iParam0, var uParam1, int iParam2)//Position - 0x2B9D3
{
	int iVar0;
...
void func_262(int iParam0, var uParam1, vector3 vParam2, var uParam3, int iParam4)//Position - 0x2BC2F
{
	if (func_259(&(Global_11188.f_22B[0 /*21*/]), iParam0))
	{
		...
		{
			func_264(iParam0);
			func_263(uParam1, &(Global_19E56.f_7F5D.f_45[Global_11188.f_22B[0 /*21*/].f_E /*78*/]));
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11188.f_22B[0 /*21*/].f_9, 11))
			{
				...
				Global_19E56.f_7F5D.f_78E[Global_11188.f_22B[0 /*21*/].f_E] = uParam3;
			}
			else
			{
...
void func_263(var uParam0, var uParam1)//Position - 0x2BD2E
{
...
void func_264(int iParam0)//Position - 0x2BDFA
{
	if (iParam0 == 4294967295)
	{
		return;
	...
	if (func_259(&(Global_11188.f_22B[0 /*21*/]), iParam0))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_11188.f_8B[iParam0], 1, 1);
...
int func_265(int iParam0)//Position - 0x2BE74
{
	int iVar0;
...
bool func_266(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x2BED7
{
	if (bParam2)
	{
...
void func_267(int iParam0, var uParam1)//Position - 0x2BF1E
{
	int iVar0;
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_4D), func_268(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_268(int iParam0)//Position - 0x2C1CB
{
	switch (iParam0)
	{
		case 1:
...
int func_269(int iParam0, var uParam1, var uParam2)//Position - 0x2C27B
{
	int iVar0;
	int iVar1;
...
int func_270(int iParam0)//Position - 0x2C46E
{
	switch (iParam0)
	{
		case joaat("GRANGER"):
...
void func_271(int iParam0)//Position - 0x2C48E
{
...
int func_272(vector3 vParam0, int iParam1, var uParam2, var uParam3)//Position - 0x2C4B5
{
	int iVar0;
...
int func_273(vector3 vParam0, int iParam1, int iParam2)//Position - 0x2C5CB
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= (10 - 1))
	{
		if (Global_1592D[iVar0 /*10*/].f_7 != 263)
		{
			if (Global_1592D[iVar0 /*10*/].f_9 == iParam1 || iParam1 == 145)
			{
				...
				{
					fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_1592D[iVar0 /*10*/].f_3, 1);
					if (fVar1 < fVar2)
					{
						fVar2 = fVar1;
						iVar3 = iVar0;
...
bool func_274(int iParam0)//Position - 0x2C65A
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_1C21[iParam0], 0);
}

int func_275(int iParam0)//Position - 0x2C672
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
void func_276(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x2C68E
{
	func_277(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_277(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x2C6B7
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_278(vector3 vParam0)//Position - 0x2CAAB
{
...
int func_279(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)//Position - 0x2CAD5
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_280(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x2CDCB
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_281(vector3 vParam0)//Position - 0x2CE7F
{
	float fVar0;
	float fVar1;
...
void func_282(int iParam0)//Position - 0x2CEBE
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
void func_283()//Position - 0x2CF23
{
	int iVar0;
...
int func_284(int iParam0, float fParam1, int iParam2)//Position - 0x2CF43
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
		...
		{
			if (!func_291(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_290(AUDIO::_0x0626A247D2405330(), 3466132403))
				{
...
bool func_285()//Position - 0x2D017
{
	bool bVar0;
...
void func_286()//Position - 0x2D03A
{
	Global_3960 = 0;
	func_287();
}

void func_287()//Position - 0x2D04A
{
...
void func_289()//Position - 0x2D0C3
{
...
int func_290(int iParam0, int iParam1)//Position - 0x2D114
{
	if (func_207(iParam0))
	{
...
int func_291(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x2D147
{
...
void func_292(int iParam0)//Position - 0x2D2D6
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_293()//Position - 0x2D302
{
	if (func_297(AUDIO::_0x0626A247D2405330()))
	{
		func_298();
		...
		if (iLocal_88 == 0)
		{
			if (func_297(iLocal_83))
			{
				if (func_294(AUDIO::_0x0626A247D2405330(), iLocal_83, 1) < 4f || (ENTITY::GET_ENTITY_SPEED(AUDIO::_0x0626A247D2405330()) > 2f && func_294(AUDIO::_0x0626A247D2405330(), iLocal_83, 1) < 6f))
				{
...
float func_294(int iParam0, int iParam1, int iParam2)//Position - 0x2D378
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_295(char* sParam0, bool bParam1)//Position - 0x2D3D6
{
	func_296(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_296(bool bParam0)//Position - 0x2D3EC
{
	int iVar0;
...
int func_297(int iParam0)//Position - 0x2D429
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_298()//Position - 0x2D44A
{
	func_300(0);
	func_289();
	func_299();
...
void func_299()//Position - 0x2D45F
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
		{
			if (func_291(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_300(int iParam0)//Position - 0x2D4B7
{
	if (func_304())
	{
		return;
...
void func_301(int iParam0)//Position - 0x2D4EA
{
	if (func_304())
	{
		return;
...
void func_302(bool bParam0, bool bParam1)//Position - 0x2D564
{
	if (bParam0)
	{
		if (func_303(0))
...
int func_303(int iParam0)//Position - 0x2D5D8
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
bool func_304()//Position - 0x2D632
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

void func_305(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2D644
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_11723 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_307(Global_11724, Global_11726, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
float func_306(var uParam0)//Position - 0x2D929
{
	HUD::_BEGIN_TEXT_COMMAND_WIDTH(uParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_307(int iParam0, int iParam1, int iParam2)//Position - 0x2D93C
{
	struct<2> Var0;
	int iVar1;
...
char* func_308(int iParam0)//Position - 0x2DA13
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_309(int iParam0)//Position - 0x2DB66
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_310(int iParam0)//Position - 0x2DB9A
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_311(int iParam0)//Position - 0x2DBCE
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_312(int iParam0)//Position - 0x2DC02
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_313(int iParam0)//Position - 0x2DC36
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_314(int iParam0)//Position - 0x2DC74
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_315(int iParam0)//Position - 0x2DCA8
{
	struct<2> Var0;
...
int func_316(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2DD11
{
	if (((!func_318(0) || Global_11732) || Global_11727 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_11723)
...
bool func_317(bool bParam0)//Position - 0x2DE29
{
	if (bParam0)
	{
...
int func_318(int iParam0)//Position - 0x2DE52
{
	if (Global_8D15 == 15)
	{
		return 0;
...
bool func_319(int iParam0)//Position - 0x2DE74
{
	return func_320(iParam0, Global_8D15);
}

int func_320(int iParam0, int iParam1)//Position - 0x2DE85
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_321(var uParam0, var uParam1)//Position - 0x2E066
{
	*uParam0 = *uParam1;
	*uParam1 = 0;
}

void func_322()//Position - 0x2E078
{
	if (STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
	{
...
void func_323(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x2E09C
{
...
void func_324(var uParam0, bool bParam1)//Position - 0x2E0BC
{
	func_325(&(uParam0->f_29), bParam1);
}

void func_325(var uParam0, bool bParam1)//Position - 0x2E0CE
{
	int iVar0;
...
void func_326(var uParam0, bool bParam1)//Position - 0x2E10C
{
...
void func_327(var uParam0)//Position - 0x2E147
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_328(var uParam0, bool bParam1)//Position - 0x2E172
{
	func_329(&(uParam0->f_23), bParam1);
}

void func_329(var uParam0, bool bParam1)//Position - 0x2E184
{
	int iVar0;
...
void func_330(int iParam0)//Position - 0x2E1C1
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_331(int iParam0)//Position - 0x2E1F9
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
int func_332(int iParam0)//Position - 0x2E295
{
	if (func_297(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
void func_333(var uParam0, int iParam1)//Position - 0x2E2BF
{
	func_334(&(uParam0->f_1C), iParam1);
}

void func_334(var uParam0, int iParam1)//Position - 0x2E2D1
{
	int iVar0;
...
void func_335(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2E312
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_336(bool bParam0)//Position - 0x2E362
{
	int iVar0;
...
void func_337(char* sParam0, int iParam1)//Position - 0x2E432
{
	if (Global_16C30 != 12)
	{
...
int func_338(char* sParam0, int iParam1, int iParam2)//Position - 0x2E45A
{
	var uVar0;
	struct<32> Var1;
	int iVar2;
...
int func_339(char* sParam0)//Position - 0x2E5EC
{
...
int func_340()//Position - 0x2E642
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_341(&(Global_16C30.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_341(char* sParam0, bool bParam1)//Position - 0x2E666
{
	int iVar0;
	int iVar1;
...
int func_342(int iParam0, bool bParam1)//Position - 0x2E690
{
	int iVar0;
...
int func_344()//Position - 0x2E716
{
	...
	{
		if (func_339(&(Global_16C30.f_3)) > 4294967295)
		{
			return 1;
		}
	}
...
void func_345(int iParam0)//Position - 0x2E782
{
	unk_0x59B038076F830627(iParam0);
	HUD::DISPLAY_RADAR(iParam0);
}

void func_346(int iParam0)//Position - 0x2E796
{
	if (iParam0 == 1)
	{
		HUD::_0xFDB423997FA30340();
...
void func_347(int iParam0)//Position - 0x2E7D3
{
	if (iParam0 == 1)
	{
...
void func_348()//Position - 0x2E810
{
	Global_434C.f_5 = 1;
}

void func_349()//Position - 0x2E81E
{
	Global_434C.f_5 = 0;
}

void func_350(bool bParam0)//Position - 0x2E82C
{
	if (bParam0)
	{
		func_351();
...
void func_351()//Position - 0x2E88F
{
...
void func_352()//Position - 0x2E8B8
{
	Global_155CF = 0;
	Global_155D0 = 0;
}

int func_353()//Position - 0x2E8CA
{
...
void func_354()//Position - 0x2E908
{
	Global_16C53 = 1;
...
void func_355(char* sParam0)//Position - 0x2E9F7
{
...
void func_356(var uParam0)//Position - 0x2EA09
{
	func_357(&(uParam0->f_1C));
	func_357(&(uParam0->f_23));
	func_357(&(uParam0->f_29));
}

void func_357(var uParam0)//Position - 0x2EA29
{
	int iVar0;
...
int func_358(int iParam0)//Position - 0x2EA63
{
	if (!func_152(iParam0))
	{
		return Global_19E56.f_6D76[iParam0 /*29*/];
