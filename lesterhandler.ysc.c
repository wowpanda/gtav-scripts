...
void __EntryFunction__()//Position - 0x0
{
	...
	while (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_216, 1))
	{
		if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_216, 0))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
			{
				if (!PED::IS_PED_INJURED(iLocal_46))
				{
					...
					ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_46, 1);
					ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_46, 0, 0);
					ENTITY::SET_ENTITY_HEALTH(iLocal_46, true);
					...
					BRAIN::TASK_PLAY_ANIM_ADVANCED(0, "MISSHEIST_JEWEL@HACKING", "HACK_INTRO", vVar0, vVar1, 8f, -8f, 4294967295, 262152, 0, 2, 0);
					BRAIN::TASK_PLAY_ANIM_ADVANCED(0, "MISSHEIST_JEWEL@HACKING", "HACK_LOOP", vVar0, vVar1, 8f, -8f, 4294967295, 262153, 0, 2, 0);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_49);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_46, iLocal_49);
					MISC::_0x1327E2FE9746BAEE(iLocal_46, 0, 0);
					unk_0x346478B12F69D4E3(iLocal_46, true);
					...
					unk_0x346478B12F69D4E3(iLocal_47, true);
		...
		else if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
		{
			...
			{
				fVar2 = SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_46, true));
				if (func_17() == 0)
				{
					if (fVar2 < 4f)
					{
				...
				if (Global_1172D == 86)
				{
					if (!Global_19E51 == 1 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 718.0749f, -976.0472f, 22.91482f, 718.0593f, -979.455f, 27.1191f, 5.75f, 0, true, 0))
					{
						func_3(7, 1);
						Global_19E4D = 0;
						Global_19E51 = 1;
...
void func_1()//Position - 0x452
{
	if (func_2())
	{
		...
		{
			unk_0xF14A31FD690DC3B0(iLocal_218);
...
{
	iLocal_219 = unk_0x9934FEFB3B8C6DB8("JHPB_02_Laptop");
...
bool func_11(int iParam0)//Position - 0xA5F
{
	return Global_8D15 == iParam0;
}

void func_12()//Position - 0xA6D
{
	int iVar0;
...
bool func_13(int iParam0, int iParam1)//Position - 0xAC4
{
	switch (iParam0)
	{
		case 5:
...
void func_15(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0xB56
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
void func_18()//Position - 0xBE7
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_21(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_19(iVar0) && (!func_11(14) || Global_19A3D))
			{
...
bool func_19(int iParam0)//Position - 0xCE4
{
	return iParam0 < 3;
}

int func_20(int iParam0)//Position - 0xCF0
{
	int iVar0;
	int iVar1;
...
int func_21(int iParam0)//Position - 0xD2D
{
	if (func_19(iParam0))
	{
...
void func_22(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD57
{
...
bool func_23(bool bParam0)//Position - 0xDF2
{
