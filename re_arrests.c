...
void __EntryFunction__()
{
	...
	fLocal_250 = "RANDOM@ARRESTS";
	fLocal_251 = "RANDOM@ARRESTS@BUSTED";
	iLocal_255 = 1;
	...
	while (true)
	{
		...
		{
			case 0:
				if ((TASK::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() && !func_120()) && !func_107())
				{
					if (func_104())
					{
						iLocal_46 = 1;
	...
	if (!PED::IS_PED_INJURED(iLocal_52) && (iLocal_47 != 2 && iLocal_47 != 1))
	{
		if (!PED::IS_PED_INJURED(iLocal_53))
		{
			switch (iLocal_50)
			{
				case 0:
					...
					if (SYSTEM::TIMERA() > 10)
					{
						if (!bLocal_68)
						{
							...
							{
								BRAIN::TASK_GO_TO_ENTITY(iLocal_52, iLocal_53, -1, 1f, 3f, 1073741824, 0);
							}
						}
					}
					if (SYSTEM::TIMERA() > 4000)
					{
						if (!bLocal_68)
						{
							...
							{
								if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_53, -2017877118) == 1)
								{
									BRAIN::STOP_ANIM_PLAYBACK(iLocal_53, 2, 1);
								}
								BRAIN::TASK_SMART_FLEE_PED(iLocal_53, iLocal_52, 150f, -1, 0, 0);
							}
						}
					}
					...
					if (SYSTEM::TIMERA() > 8000 || fVar2 < 1.5f)
					{
						...
						if (iVar3 == 1)
						{
							BRAIN::TASK_GO_TO_ENTITY(iLocal_52, iLocal_53, -1, 1f, 0.01f, 1073741824, 0);
						}
					}
					...
					if (SYSTEM::TIMERA() > 2000)
					{
						if (iVar3 || iLocal_270 == 1)
						{
							if (!func_81())
							{
								...
								BRAIN::CLEAR_PED_TASKS(iLocal_52);
								...
								BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_53, -1, 2048, 2);
								BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, iLocal_53, iLocal_53, 1f, 0, 3f, 1082130432, 1, 0, -957453492);
								BRAIN::TASK_AIM_GUN_AT_ENTITY(0, iLocal_53, 5000, 0);
								BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
				...
				case 1:
					if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_52, -982327190) == 7)
					{
						BRAIN::TASK_GO_TO_ENTITY(iLocal_52, iLocal_53, -1, 1f, 3f, 1073741824, 0);
						iLocal_50 = 0;
					}
				...
				case 2:
					if ((MISC::GET_GAME_TIMER() - iLocal_240) > 1000)
					{
						...
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_53, vVar1, 2f, -1, 1f, 1024, 1193033728);
						iLocal_50 = 3;
					}
					break;
				...
				case 4:
					bLocal_68 = true;
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
					BRAIN::TASK_PLAY_ANIM(0, fLocal_250, "idle_2_hands_up", 2f, -8f, -1, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, fLocal_250, "kneeling_arrest_idle", 8f, -8f, -1, 1, 0, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
				...
				case 5:
					if (iLocal_48 == 3)
					{
						if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_52, 242628503) == 7)
						{
							...
							WEAPON::SET_CURRENT_PED_WEAPON(iLocal_52, joaat("weapon_pistol"), true);
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
							BRAIN::TASK_AIM_GUN_AT_ENTITY(0, iLocal_53, -1, 0);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_52, iLocal_67);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_67);
							PED::SET_PED_KEEP_TASK(iLocal_52, true);
				...
				case 6:
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_55, 0) && !PED::IS_PED_INJURED(iLocal_54))
					{
						...
						if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_52, -2017877118) == 7)
						{
							if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_54, -1273030092) == 7)
							{
								if (VEHICLE::_0x639431E895B9AA57(iLocal_53, iLocal_55, 2, 0, false))
								{
									if (!PED::IS_PED_INJURED(iLocal_53))
									{
										if (!PED::IS_PED_SITTING_IN_VEHICLE(iLocal_53, iLocal_55))
										{
											...
											{
												if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_53, -1794415470) == 7)
												{
													BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
													BRAIN::TASK_PLAY_ANIM(0, fLocal_250, "kneeling_arrest_get_up", 8f, -2f, -1, 0, 0, 0, 0, 0);
													BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
													BRAIN::TASK_PERFORM_SEQUENCE(iLocal_53, iLocal_67);
													BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_67);
											...
											if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_55, 0))
											{
												if (!func_81())
												{
													if (func_71(&uLocal_72, "REARRAU", "REARR_INCAR", 4, iLocal_246, 0, 0))
													{
														...
														BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
														BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_55, vLocal_283), iLocal_53, 0.75f, false, 0.5f, 4f, true, 0, 0, -957453492, 60000);
														BRAIN::TASK_AIM_GUN_AT_ENTITY(0, iLocal_53, -1, 0);
														BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
														BRAIN::TASK_PERFORM_SEQUENCE(iLocal_52, iLocal_67);
														BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_67);
					...
					if (!PED::IS_PED_INJURED(iLocal_52))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_52, 35f, 35f, 35f, 0, 1, 0))
						{
							if ((MISC::GET_GAME_TIMER() - iLocal_269) > 8000)
							{
								if (!func_81())
								{
									BRAIN::TASK_LOOK_AT_ENTITY(iLocal_52, PLAYER::PLAYER_PED_ID(), 6000, 2048, 2);
						...
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_55, 0))
						{
							if (iLocal_62)
							{
								if (func_69(iLocal_52, iLocal_55) == 2)
								{
									BRAIN::TASK_ENTER_VEHICLE(iLocal_53, iLocal_55, -1, 2, 1f, 1, 0);
								}
								else
								{
									BRAIN::TASK_ENTER_VEHICLE(iLocal_53, iLocal_55, -1, 1, 1f, 1, 0);
								}
								iLocal_50 = 8;
							}
							else if (iLocal_61)
							...
							else if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_53, fLocal_250, "kneeling_arrest_get_up", 3))
							{
								if (func_69(iLocal_52, iLocal_55) == 2)
								{
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_55, 0))
					{
						if (!PED::IS_PED_INJURED(iLocal_54))
						{
							if (PED::IS_PED_SITTING_IN_VEHICLE(iLocal_53, iLocal_55))
							{
								...
								else if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_52, -1794415470) == 7)
								{
									BRAIN::CLEAR_PED_TASKS(iLocal_52);
	...
	if (PED::IS_PED_INJURED(iLocal_52))
	{
		if (!PED::IS_PED_INJURED(iLocal_53))
		{
			...
			else
			{
				...
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_53, fLocal_250, "kneeling_arrest_idle", 3))
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
					BRAIN::TASK_PLAY_ANIM(0, fLocal_250, "kneeling_arrest_get_up", 2f, -2f, -1, 0, 0, 0, 0, 0);
...
void func_3(bool bParam0)
{
	...
	{
		fVar0 = "generic_radio_enter";
		fVar1 = "generic_radio_chatter";
		fVar2 = "generic_radio_exit";
	}
	if (!PED::IS_PED_INJURED(iLocal_52))
	{
		switch (iLocal_48)
		{
			case 0:
				if ((iLocal_237 == 3 || iLocal_50 == 5) || iLocal_50 == 6)
				{
					if (!func_81())
					{
						BRAIN::CLEAR_PED_TASKS(iLocal_52);
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
						BRAIN::TASK_LOOK_AT_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_53, false), 10000, 0, 2);
						BRAIN::TASK_PLAY_ANIM(0, fLocal_250, fVar0, 8f, -4f, -1, 0, 0, 0, 0, 0);
						BRAIN::TASK_PLAY_ANIM(0, fLocal_250, fVar1, 16f, -8f, -1, 1, 0, 0, 0, 0);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_52, iLocal_67);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_67);
						iLocal_48 = 1;
			...
			case 1:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_52, fLocal_250, fVar1, 3))
				{
					if (!PED::IS_PED_INJURED(iLocal_53))
					{
						if (!func_81())
			...
			case 2:
				if (!func_81())
				{
					if (func_10())
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_55, 0))
						{
							VEHICLE::_SET_VEHICLE_SIREN_SOUND(iLocal_55, 0);
							VEHICLE::SET_VEHICLE_SIREN(iLocal_55, true);
						}
						BRAIN::CLEAR_PED_TASKS(iLocal_52);
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
						BRAIN::TASK_PLAY_ANIM(0, fLocal_250, fVar2, 8f, -1.5f, -1, 0, 0, 0, 0, 0);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_52, iLocal_67);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_67);
					...
					if (SYSTEM::TIMERB() > iLocal_238 || iLocal_254)
					{
						if (iLocal_47 == 3 || iLocal_47 == 0)
						{
							if (!PED::IS_PED_INJURED(iLocal_53))
							{
								...
								{
									BRAIN::TASK_LOOK_AT_ENTITY(iLocal_52, PLAYER::PLAYER_PED_ID(), 500, 2048, 2);
									func_71(&uLocal_72, "REARRAU", "REARR_PLEAVE", 4, iLocal_246, 0, 0);
									iLocal_238 = 8000;
								}
							}
...
void func_4()
{
	if (!iLocal_254)
	{
		...
		BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
		BRAIN::TASK_PLAY_ANIM(0, fLocal_251, "enter", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, fLocal_251, fLocal_252, 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, fLocal_251, "exit", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, fLocal_250, "kneeling_arrest_idle", 8f, -8f, -1, 9, 0, 0, 0, 0);
		BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
		BRAIN::TASK_PERFORM_SEQUENCE(iLocal_53, iLocal_67);
		BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_67);
		iLocal_254 = 1;
	}
	else if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_53, fLocal_251, "enter", 3))
	{
		if (func_5())
		{
	...
	else if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_53, fLocal_251, "exit", 3))
	{
	}
	else if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_53, fLocal_251, fLocal_252, 3))
	{
...
void func_6()
{
	...
	{
		BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
		BRAIN::TASK_PLAY_ANIM(0, fLocal_250, "radio_enter", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, fLocal_250, "radio_chatter", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, fLocal_250, "radio_exit", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_AIM_GUN_AT_ENTITY(0, iLocal_53, -1, 0);
		BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
		BRAIN::TASK_PERFORM_SEQUENCE(iLocal_52, iLocal_67);
		BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_67);
	...
	else if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_52, fLocal_250, "radio_chatter", 3))
	{
		if (func_5())
		{
	...
	else if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_52, fLocal_250, "radio_exit", 3))
	{
		iLocal_255 = 0;
		func_8();
	}
	...
	switch (iLocal_49)
	{
		case 0:
			if (!bLocal_68)
			{
				...
				{
					BRAIN::TASK_GOTO_ENTITY_OFFSET_XY(iLocal_52, iLocal_53, -1, 3f, 0f, 0f, 1f, 0);
				}
				SYSTEM::SETTIMERB(0);
			}
			break;
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_55, 0))
			{
				if ((MISC::GET_GAME_TIMER() - iLocal_279) > 20000)
				{
					if (!PED::IS_PED_INJURED(iLocal_54))
					{
						if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_54, -1273030092) == 7)
						{
							BRAIN::TASK_ENTER_VEHICLE(iLocal_52, iLocal_55, -1, 0, 1f, 1, 0);
							iLocal_49 = 3;
						}
					}
				}
...
int func_11()
{
	...
	switch (iLocal_237)
	{
			...
			if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_52, 242628503) == 7 || MISC::GET_GAME_TIMER() > iLocal_240 + 15000)
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_52, 25f, 25f, 25f, 0, 1, 0))
				{
					if (!PED::IS_PED_INJURED(iLocal_52))
					{
						...
						{
							BRAIN::TASK_GO_TO_ENTITY(0, iLocal_53, -1, 3.5f, 2f, 1073741824, 0);
						}
		...
		case 2:
			...
			BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_52, PLAYER::PLAYER_PED_ID(), 100);
			break;
				...
				if (iLocal_47 == 2 || bLocal_68 == 1)
				{
					switch (iLocal_241)
					{
						case 8:
							...
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_53, 0) && ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_53, fLocal_250, "kneeling_arrest_idle", 3))
							{
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
								BRAIN::TASK_PLAY_ANIM(0, fLocal_250, "kneeling_arrest_get_up", 8f, -8f, -1, 0, 0, 0, 0, 0);
								BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
								BRAIN::TASK_PERFORM_SEQUENCE(iLocal_53, iLocal_67);
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_67);
								iLocal_241 = 9;
						...
						case 1:
							...
							else
							{
								BRAIN::CLEAR_PED_TASKS(iLocal_53);
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
								BRAIN::TASK_LOOK_AT_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_52, false), 1000, 0, 2);
								BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_52, false), 2f, -1, 3f, 0, 1193033728);
								BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
								BRAIN::TASK_PERFORM_SEQUENCE(iLocal_53, iLocal_67);
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_67);
								iLocal_241 = 2;
						...
						case 7:
							...
							{
								BRAIN::TASK_LOOK_AT_ENTITY(iLocal_53, PLAYER::PLAYER_PED_ID(), -1, 2064, 2);
							}
							if (!PED::IS_PED_FACING_PED(iLocal_53, PLAYER::PLAYER_PED_ID(), 30f))
							{
								BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_53, PLAYER::PLAYER_PED_ID(), -1);
							}
						...
						case 5:
							...
							if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_53, fLocal_250, "Thanks_Male_05", 3) || BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_53, 242628503) == 7)
							{
								if (!func_81())
								{
									if (iLocal_239 < 2)
									{
										...
										BRAIN::TASK_PLAY_ANIM(iLocal_53, fLocal_250, "Thanks_Male_05", 16f, -16f, -1, 16, 0, 0, 0, 0);
									}
									else
									{
...
void func_19(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_105220.f_20535.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_21() /*12171*/].f_7688.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_105220.f_20535.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_21() /*12171*/].f_7688.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_25(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_21() /*12171*/].f_7688.f_10, iParam0);
}
...
void func_49()
{
	...
	{
		if (func_52(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (iParam0 == 1)
			{
				if (!PED::IS_PED_INJURED(iLocal_53))
				{
					if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_53, 1805844857) == 7)
					{
						...
						{
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
							BRAIN::TASK_PLAY_ANIM(0, fLocal_250, "kneeling_arrest_escape", 8f, -8f, -1, 4096, 0, 0, 0, 0);
							BRAIN::TASK_SMART_FLEE_PED(0, iLocal_52, 150f, -1, 0, 0);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_53, iLocal_67);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_67);
...
int func_83(float fParam0)
{
	...
	if (MISC::_GET_GROUND_COORDS_WHILE_IN_AIR(ENTITY::GET_ENTITY_COORDS(iLocal_53, true), &uVar0, &vVar1))
	{
...
void func_91(void fParam0, int iParam1)
{
...
int func_94()
{
	switch (func_95(&Global_25336, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_104()
{
	...
	STREAMING::REQUEST_ANIM_DICT(fLocal_250);
	...
	if ((((((STREAMING::HAS_MODEL_LOADED(iVar0) && STREAMING::HAS_MODEL_LOADED(iVar1)) && STREAMING::HAS_MODEL_LOADED(joaat("prop_ld_binbag_01"))) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_250)) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_251)) && STREAMING::HAS_CLIP_SET_LOADED("MOVE_M@BAIL_BOND_NOT_TAZERED")) && STREAMING::HAS_CLIP_SET_LOADED("MOVE_M@BAIL_BOND_TAZERED"))
	{
		...
		if (SYSTEM::VDIST(2411.32f, 4958.76f, 45.19f, vLocal_63) < 10f)
		{
			iLocal_51 = 1;
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD_ADVANCED(0, 2473.254f, 4901.651f, 43.1488f, 3f, -1, 2f, 1, vLocal_244, 40000f);
			BRAIN::TASK_SMART_FLEE_PED(0, iLocal_52, 150f, -1, 0, 0);
			BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
			BRAIN::TASK_PERFORM_SEQUENCE(iLocal_53, iLocal_67);
			PED::SET_PED_KEEP_TASK(iLocal_53, true);
		...
		else
		{
			iLocal_51 = 2;
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD_ADVANCED(0, 2531.445f, 2521.749f, 38.2072f, 3f, -1, 2f, 1, vLocal_244, 40000f);
			BRAIN::TASK_SMART_FLEE_PED(0, iLocal_52, 150f, -1, 0, 0);
			BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
			BRAIN::TASK_PERFORM_SEQUENCE(iLocal_53, iLocal_67);
			PED::SET_PED_KEEP_TASK(iLocal_53, true);
...
int func_126(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_162(Global_105220.f_24966.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_160()) || Global_104267) || Global_25279) || func_159()) || func_79(8, -1)) || func_158()) || func_157()) || func_156()) || func_155()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_160()) || Global_25279) || func_159()) || func_79(8, -1)) || func_156()) || func_158()) || func_157()) || func_155()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_160()) || Global_104267) || Global_25279) || func_159()) || func_79(8, -1)) || func_158()) || func_157()) || func_155()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_160() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_79(8, -1)) || func_155()) || func_154()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_160()) || Global_25279) || func_159()) || func_79(8, -1)) || func_157()) || func_156()) || func_155()) || Global_105220.f_7659.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_160()) || func_157()) || Global_104267) || Global_25279) || func_159()) || Global_37057) || func_79(8, -1)) || func_156()) || func_154()) || func_155()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_160()) || Global_104267) || Global_25279) || func_159()) || func_79(8, -1)) || func_156()) || func_154()) || func_158()) || func_157()) || func_155())
						{
							return 0;
						}
						break;
	...
	if (MISC::GET_RANDOM_EVENT_FLAG())
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_53))
		{
			if (!PED::IS_PED_INJURED(iLocal_53) && !ENTITY::IS_ENTITY_DEAD(iLocal_53, 0))
			{
				...
				{
					BRAIN::TASK_SMART_FLEE_COORD(iLocal_53, ENTITY::GET_ENTITY_COORDS(iLocal_52, true), 9000f, -1, 0, 0);
				}
				else
				{
					BRAIN::TASK_SMART_FLEE_COORD(iLocal_53, ENTITY::GET_ENTITY_COORDS(iLocal_53, true), 9000f, -1, 0, 0);
				}
...
int func_182()
{
	if ((Global_105209 == func_124() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_105210)
	{
		return 1;
	}
	return 0;
...
void func_188()
{
	...
	{
		func_44(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
...
void func_199()
{
	if (!bLocal_68 && iLocal_49 == 0)
	{
		if (!PED::IS_PED_INJURED(iLocal_52) && !PED::IS_PED_INJURED(iLocal_53))
		{
			BRAIN::TASK_GO_STRAIGHT_TO_COORD(iLocal_52, ENTITY::GET_ENTITY_COORDS(iLocal_53, true), 3f, 20000, 1193033728, 1056964608);
			PED::SET_PED_KEEP_TASK(iLocal_52, true);
			SYSTEM::WAIT(0);
		}
	}
