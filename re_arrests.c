		...
		if (!PED::IS_PED_INJURED(iLocal_53))
		{
			switch (iLocal_50)
			{
				case 0:
					...
					fVar2 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_52, 1), ENTITY::GET_ENTITY_COORDS(iLocal_53, 1), true);
					...
					if (SYSTEM::TIMERA() > 2000)
					{
						if (iVar3 || iLocal_270 == 1)
						{
							if (!func_81())
							{
								...
								vLocal_64 = { ENTITY::GET_ENTITY_COORDS(iLocal_53, 1) };
				...
				case 4:
					bLocal_68 = true;
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
					BRAIN::TASK_PLAY_ANIM(0, sLocal_250, "idle_2_hands_up", 2f, -8f, -1, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, sLocal_250, "kneeling_arrest_idle", 8f, -8f, -1, 1, 0, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
									...
									if (!PED::IS_PED_INJURED(iLocal_53))
									{
										if (!PED::IS_PED_SITTING_IN_VEHICLE(iLocal_53, iLocal_55))
										{
											if (!PED::IS_PED_IN_COMBAT(iLocal_53, 0))
											{
												...
												{
													BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
													BRAIN::TASK_PLAY_ANIM(0, sLocal_250, "kneeling_arrest_get_up", 8f, -2f, -1, 0, 0, 0, 0, 0);
													BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
													BRAIN::TASK_PERFORM_SEQUENCE(iLocal_53, iLocal_67);
													BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_67);
				...
				case 7:
					if (!PED::IS_PED_INJURED(iLocal_52))
					{
						...
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_55, 0))
						{
							...
							{
								fVar4 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_53, 1), ENTITY::GET_ENTITY_COORDS(iLocal_55, 1), true);
		...
		if (!PED::IS_PED_INJURED(iLocal_53))
		{
			...
			else
			{
				if (iLocal_47 == 1 || iLocal_47 == 3)
				{
					if (!func_81())
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_53, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), true) < 20f)
						{
				...
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
					BRAIN::TASK_PLAY_ANIM(0, sLocal_250, "kneeling_arrest_get_up", 2f, -2f, -1, 0, 0, 0, 0, 0);
			...
			case 0:
				if ((iLocal_237 == 3 || iLocal_50 == 5) || iLocal_50 == 6)
				{
					if (!func_81())
					{
						BRAIN::CLEAR_PED_TASKS(iLocal_52);
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
						BRAIN::TASK_LOOK_AT_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_53, 0), 10000, 0, 2);
						BRAIN::TASK_PLAY_ANIM(0, sLocal_250, sVar0, 8f, -4f, -1, 0, 0, 0, 0, 0);
						BRAIN::TASK_PLAY_ANIM(0, sLocal_250, sVar1, 16f, -8f, -1, 1, 0, 0, 0, 0);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_52, iLocal_67);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_67);
						iLocal_48 = 1;
			...
			case 2:
				if (!func_81())
				{
					if (func_10())
					{
						...
						BRAIN::CLEAR_PED_TASKS(iLocal_52);
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
						BRAIN::TASK_PLAY_ANIM(0, sLocal_250, sVar2, 8f, -1.5f, -1, 0, 0, 0, 0, 0);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_52, iLocal_67);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_67);
...
void func_4()
{
	if (!iLocal_254)
	{
		...
		BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
		BRAIN::TASK_PLAY_ANIM(0, sLocal_251, "enter", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, sLocal_251, sLocal_252, 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, sLocal_251, "exit", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, sLocal_250, "kneeling_arrest_idle", 8f, -8f, -1, 9, 0, 0, 0, 0);
		BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
		BRAIN::TASK_PERFORM_SEQUENCE(iLocal_53, iLocal_67);
		BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_67);
		iLocal_254 = 1;
...
void func_6()
{
	...
	{
		BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
		BRAIN::TASK_PLAY_ANIM(0, sLocal_250, "radio_enter", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, sLocal_250, "radio_chatter", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, sLocal_250, "radio_exit", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_AIM_GUN_AT_ENTITY(0, iLocal_53, -1, 0);
		BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
		BRAIN::TASK_PERFORM_SEQUENCE(iLocal_52, iLocal_67);
		BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_67);
...
int func_10()
{
	...
	{
		if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(ENTITY::GET_ENTITY_COORDS(iLocal_52, 0), 1, &vVar0, 1, 3f, 0f))
		{
			if (VEHICLE::_0xA4822F1CF23F4810(&vVar0, &vVar2, &uVar3, 0f, 180f, 50f, true, 1, 1))
			{
				...
				vVar0 = { ENTITY::GET_ENTITY_COORDS(iLocal_55, 1) };
				vVar1 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - vVar0 };
				ENTITY::SET_ENTITY_HEADING(iLocal_55, MISC::GET_HEADING_FROM_VECTOR_2D(vVar1.x, vVar1.y));
				PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(ENTITY::GET_ENTITY_COORDS(iLocal_52, 0), 1, &vVar0, 1, 3f, 0f);
				...
				if (iLocal_47 == 2 || bLocal_68 == 1)
				{
					switch (iLocal_241)
					{
						case 8:
							...
							{
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
								BRAIN::TASK_PLAY_ANIM(0, sLocal_250, "kneeling_arrest_get_up", 8f, -8f, -1, 0, 0, 0, 0, 0);
								BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
								BRAIN::TASK_PERFORM_SEQUENCE(iLocal_53, iLocal_67);
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_67);
								iLocal_241 = 9;
						...
						case 1:
							...
							if (ENTITY::IS_ENTITY_AT_COORD(iLocal_53, ENTITY::GET_ENTITY_COORDS(iLocal_52, 0), 4f, 4f, 3f, false, true, 0))
							{
								iLocal_241 = 2;
							}
							else
							{
								BRAIN::CLEAR_PED_TASKS(iLocal_53);
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
								BRAIN::TASK_LOOK_AT_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_52, 0), 1000, 0, 2);
								BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_52, 0), 2f, -1, 3f, 0, 1193033728);
								BRAIN::CLOSE_SEQUENCE_TASK(iLocal_67);
								BRAIN::TASK_PERFORM_SEQUENCE(iLocal_53, iLocal_67);
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_67);
								iLocal_241 = 2;
							...
							if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_53, sLocal_250, "Thanks_Male_05", 3) || BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_53, 242628503) == 7)
							{
								if (!func_81())
								{
									if (iLocal_239 < 2)
									{
										...
										BRAIN::TASK_PLAY_ANIM(iLocal_53, sLocal_250, "Thanks_Male_05", 16f, -16f, -1, 16, 0, 0, 0, 0);
									}
									else
									{
...
void func_19(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_104555.f_20534.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_21() /*12130*/].f_7676.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_104555.f_20534.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_21() /*12130*/].f_7676.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_25(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_21() /*12130*/].f_7676.f_10, iParam0);
}
			...
			if (iParam0 == 1)
			{
				if (!PED::IS_PED_INJURED(iLocal_53))
				{
					if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_53, 1805844857) == 7)
					{
						...
						{
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_67);
							BRAIN::TASK_PLAY_ANIM(0, sLocal_250, "kneeling_arrest_escape", 8f, -8f, -1, 4096, 0, 0, 0, 0);
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iLocal_53))
		{
			if (bLocal_68)
			{
				if (iLocal_50 != 7)
				{
					if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iLocal_53, 1), vLocal_64) > 2.5f)
					{
						return 1;
					}
				}
...
int func_83(float fParam0)
{
	...
	if (MISC::_GET_GROUND_COORDS_WHILE_IN_AIR(ENTITY::GET_ENTITY_COORDS(iLocal_53, 1), &uVar0, &vVar1))
	{
...
int func_94()
{
	switch (func_95(&Global_25292, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_160()) || Global_103602) || Global_25235) || func_159()) || func_79(8, -1)) || func_158()) || func_157()) || func_156()) || func_155()) || Global_104555.f_7658.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_160()) || Global_25235) || func_159()) || func_79(8, -1)) || func_156()) || func_158()) || func_157()) || func_155()) || Global_104555.f_7658.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_160()) || Global_103602) || Global_25235) || func_159()) || func_79(8, -1)) || func_156()) || func_158()) || func_157()) || func_155()) || Global_104555.f_7658.f_919[iVar0] == 5) || Global_36408 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_160()) || Global_103602) || Global_25235) || func_159()) || func_79(8, -1)) || func_158()) || func_157()) || func_155()) || Global_104555.f_7658.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_160() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_79(8, -1)) || func_155()) || func_154()) || Global_104555.f_7658.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_160()) || Global_25235) || func_159()) || func_79(8, -1)) || func_157()) || func_156()) || func_155()) || Global_104555.f_7658.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_160()) || func_157()) || Global_103602) || Global_25235) || func_159()) || Global_36993) || func_79(8, -1)) || func_156()) || func_154()) || func_155()) || Global_104555.f_7658.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_160()) || Global_103602) || Global_25235) || func_159()) || func_79(8, -1)) || func_156()) || func_154()) || func_158()) || func_157()) || func_155())
						{
							return 0;
						}
						break;
	...
	if (MISC::GET_RANDOM_EVENT_FLAG())
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_53))
		{
			if (!PED::IS_PED_INJURED(iLocal_53) && !ENTITY::IS_ENTITY_DEAD(iLocal_53, 0))
			{
				...
				{
					BRAIN::TASK_SMART_FLEE_COORD(iLocal_53, ENTITY::GET_ENTITY_COORDS(iLocal_52, 1), 9000f, -1, 0, 0);
				}
				else
				{
					BRAIN::TASK_SMART_FLEE_COORD(iLocal_53, ENTITY::GET_ENTITY_COORDS(iLocal_53, 1), 9000f, -1, 0, 0);
				}
...
int func_182()
{
	if ((Global_104544 == func_124() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_104545)
	{
		return 1;
	}
	return 0;
...
void func_199()
{
	if (!bLocal_68 && iLocal_49 == 0)
	{
		if (!PED::IS_PED_INJURED(iLocal_52) && !PED::IS_PED_INJURED(iLocal_53))
		{
			BRAIN::TASK_GO_STRAIGHT_TO_COORD(iLocal_52, ENTITY::GET_ENTITY_COORDS(iLocal_53, 1), 3f, 20000, 1193033728, 1056964608);
			PED::SET_PED_KEEP_TASK(iLocal_52, true);
			SYSTEM::WAIT(0);
		}
	}
