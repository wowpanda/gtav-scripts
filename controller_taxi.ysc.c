...
void __EntryFunction__()//Position - 0x0
{
	...
	bVar0 = false;
	iVar1 = 0;
	func_84(&(Global_19E56.f_4A7D), 4);
	func_84(&(Global_19E56.f_4A7D), 256);
	...
	while (true)
	{
		...
		switch (iVar1)
		{
			case 0:
				...
				{
					iVar3 = func_78(AUDIO::_0x0626A247D2405330());
					if ((iVar3 == 0 || iVar3 == 2) || iVar3 == 1)
					{
						func_77();
						if (!func_76(Global_19E56.f_4A7D, 64))
						{
							func_74(&(Global_19E56.f_4A7D), 64);
						}
						func_73(&uLocal_120);
						iVar1 = 1;
						func_71(&iLocal_114);
						...
						if ((!MISC::IS_MINIGAME_IN_PROGRESS() && !bVar0) && !func_68(5))
						{
							...
							if (func_64())
							{
								if (!iLocal_109)
								{
									if (func_62() == 2)
									{
										if (!func_76(Global_19E56.f_4A7D, 1))
										{
								...
								{
									if (!func_76(Global_19E56.f_4A7D, 16384))
									{
										switch (func_61("TC_ANOTHERJOB"))
										{
											...
											case 1:
												func_74(&(Global_19E56.f_4A7D), 16384);
												break;
											}
									}
								}
								else if (!func_76(Global_19E56.f_4A7D, 16))
								{
									if (!iLocal_112)
									{
										switch (func_61("TC_HOWTOSTART"))
										{
											...
											case 1:
												...
												{
													Global_19E56.f_4A7D.f_16[15]++;
												}
												if (Global_19E56.f_4A7D.f_16[15] >= 5)
												{
													func_74(&(Global_19E56.f_4A7D), 16);
												}
												break;
											}
										}
								...
								switch (iLocal_102)
								{
									...
									case 2:
										...
										{
											if (!func_76(Global_19E56.f_4A7D, 32))
											{
												func_49("TC_MISSEDJOB", 4294967295);
												func_74(&(Global_19E56.f_4A7D), 32);
											}
								...
								if (((PAD::IS_CONTROL_PRESSED(0, 86) && !ENTITY::IS_ENTITY_UPSIDEDOWN(AUDIO::_0x0626A247D2405330())) && !Global_640A) && (MISC::GET_GAME_TIMER() - iLocal_105) > 3000)
								{
									iVar4 = func_62();
									if (iVar4 == 0)
									{
										...
										else
										{
											HUD::CLEAR_PRINTS();
											GRAPHICS::SET_SCRIPT_GFX_DRAW_BEHIND_PAUSEMENU(1);
											if (!func_76(Global_19E56.f_4A7D, 128))
											{
												func_74(&(Global_19E56.f_4A7D), 128);
											}
											iVar1 = 4;
										}
									...
									else if (iVar4 == 2)
									{
										...
										{
											func_49("TXC_HEALTH_GONE", 4294967295);
										}
									}
									else if (iVar4 == 3)
									{
										if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
										{
											...
											{
												if (!func_76(Global_19E56.f_4A7D, 32768))
												{
													func_49("TXC_WANTED_WARN", 4294967295);
													func_74(&(Global_19E56.f_4A7D), 32768);
												}
											}
										}
									}
			...
			case 4:
				...
				{
					AUDIO::SET_HORN_ENABLED(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 1);
				}
			...
			case 8:
				if (func_64())
				{
					if (!func_21())
					{
						...
						if (!func_76(Global_19E56.f_4A7D, 4))
						{
							func_74(&(Global_19E56.f_4A7D), 4);
							VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(func_20(), 1);
						}
						func_74(&(Global_19E56.f_4A7D), 256);
			...
			case 10:
				...
				{
					func_84(&(Global_19E56.f_4A7D), 2048);
					if (func_76(Global_19E56.f_4A7D, 4))
					{
						func_84(&(Global_19E56.f_4A7D), 4);
				...
				else if (func_76(Global_19E56.f_4A7D, 1024))
				{
					func_84(&(Global_19E56.f_4A7D), 1024);
			...
			case 11:
				if (func_76(Global_19E56.f_4A7D, 256))
				{
					func_84(&(Global_19E56.f_4A7D), 256);
					func_4(&iLocal_104);
				}
...
void func_9(int iParam0, bool bParam1)//Position - 0xB12
{
	...
	if (bParam1)
	{
		Global_19E56.f_4A7D.f_1[iParam0 /*2*/] = 1;
		Global_19E56.f_4A7D.f_1[iParam0 /*2*/].f_1 = 0;
	}
	else
	{
		Global_19E56.f_4A7D.f_1[iParam0 /*2*/] = 0;
		Global_19E56.f_4A7D.f_1[iParam0 /*2*/].f_1 = 1;
	}
}
...
void func_10()//Position - 0xB62
{
	...
	while (iVar0 < 10)
	{
		Global_19E56.f_4A7D.f_1[iVar0 /*2*/].f_1 = 0;
		iVar0++;
	}
}
...
void func_12()//Position - 0xC75
{
	...
	{
		func_14(13, SYSTEM::FLOOR(Global_19E56.f_27B6.f_F0D));
	}
...
int func_16()//Position - 0x16F8
{
	return Global_1407E0;
}

int func_17(int iParam0)//Position - 0x1704
{
	int iVar0;
...
void func_18()//Position - 0x179A
{
	Global_3960 = 0;
	func_19();
}

void func_19()//Position - 0x17AA
{
...
int func_20()//Position - 0x1801
{
	return joaat("TAXI");
}

int func_21()//Position - 0x180E
{
...
void func_22(char* sParam0, bool bParam1)//Position - 0x1830
{
	int iVar0;
...
void func_23(char* sParam0, int iParam1, int iParam2)//Position - 0x18A2
{
...
int func_24(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x18C1
{
	int iVar0;
...
void func_25(var uParam0, int iParam1)//Position - 0x19F8
{
	int iVar0;
...
{
	return func_27(iParam0, Global_8D15);
}

int func_27(int iParam0, int iParam1)//Position - 0x1A58
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_28(char* sParam0, int iParam1)//Position - 0x1C39
{
	int iVar0;
	int iVar1;
...
void func_30(int iParam0)//Position - 0x1E06
{
...
void func_31(int iParam0, int iParam1)//Position - 0x1EA0
{
...
int func_32(char* sParam0)//Position - 0x1FB0
{
	int iVar0;
...
void func_33(int iParam0, char* sParam1, var uParam2, bool bParam3)//Position - 0x1FEB
{
	struct<6> Var0;
	vector3 vVar1[24];
...
int func_34(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x20D5
{
...
int func_35(char* sParam0, int iParam1, bool bParam2)//Position - 0x2129
{
	Global_3DCF = 0;
...
var func_41()//Position - 0x261D
{
	func_42();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_42()//Position - 0x2636
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_44(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			iVar0 = func_78(AUDIO::_0x0626A247D2405330());
			if (func_43(iVar0) && (!func_68(14) || Global_19A3D))
			{
...
bool func_43(int iParam0)//Position - 0x2733
{
	return iParam0 < 3;
}

int func_44(int iParam0)//Position - 0x273F
{
	if (func_43(iParam0))
	{
...
bool func_46(int iParam0, int iParam1)//Position - 0x27C0
{
	switch (iParam0)
	{
		case 5:
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27FB
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
char* func_48(int iParam0)//Position - 0x2851
{
	if (iParam0 == 0)
	{
		return "OJTX_EXC_OFF";
...
void func_49(char* sParam0, int iParam1)//Position - 0x28FA
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_50(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2911
{
...
void func_51(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x295F
{
...
float func_53(int iParam0)//Position - 0x2A39
{
	if (func_57(iParam0))
	{
		if (func_55(iParam0))
		...
		{
			return (func_54(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}

float func_54(bool bParam0)//Position - 0x2A78
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_55(int iParam0)//Position - 0x2AD0
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 2);
}

void func_56(int iParam0)//Position - 0x2AE0
{
	if (!func_57(iParam0))
	{
		func_71(iParam0);
...
bool func_57(int iParam0)//Position - 0x2AF8
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 1);
}

int func_58(char* sParam0)//Position - 0x2B08
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_59(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2B1B
{
	func_60(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_60(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2B3C
{
	int iVar0;
...
int func_61(char* sParam0)//Position - 0x2D0F
{
...
int func_63(int iParam0)//Position - 0x2DA2
{
	int iVar0;
	int iVar1;
...
void func_65()//Position - 0x2EB5
{
	if (!func_76(Global_19E56.f_4A7D, 8192))
	{
		if (func_64())
		{
			func_74(&(Global_19E56.f_4A7D), 8192);
			func_67();
		}
	}
	else if (!func_64())
	{
		func_84(&(Global_19E56.f_4A7D), 8192);
		func_66();
	}
}

void func_66()//Position - 0x2F05
{
	int iVar0;
...
bool func_68(int iParam0)//Position - 0x2F57
{
	return Global_8D15 == iParam0;
}

int func_69()//Position - 0x2F65
{
	if (Global_8D15 == 15)
	{
		return 0;
...
int func_70(bool bParam0)//Position - 0x2F7A
{
	if (Global_434C.f_82)
	{
		return 0;
	...
	if (MISC::IS_PC_VERSION())
	{
		...
		if (!bParam0)
		{
			...
			{
				if ((!unk_0xE11F00B4AC919F45(0, 167) && !unk_0xE11F00B4AC919F45(0, 168)) && !unk_0xE11F00B4AC919F45(0, 169))
				{
					return 1;
				}
			}
			...
			{
				if ((!unk_0xE11F00B4AC919F45(0, 166) && !unk_0xE11F00B4AC919F45(0, 168)) && !unk_0xE11F00B4AC919F45(0, 169))
				{
					return 1;
				}
			}
			...
			{
				if ((!unk_0xE11F00B4AC919F45(0, 166) && !unk_0xE11F00B4AC919F45(0, 167)) && !unk_0xE11F00B4AC919F45(0, 169))
				{
					return 1;
				}
			}
			...
			{
				if ((!unk_0xE11F00B4AC919F45(0, 166) && !unk_0xE11F00B4AC919F45(0, 167)) && !unk_0xE11F00B4AC919F45(0, 168))
				{
					return 1;
				}
			}
...
void func_71(int iParam0)//Position - 0x316C
{
	func_72(iParam0, 0f);
}

void func_72(int iParam0, float fParam1)//Position - 0x317B
{
	iParam0->f_1 = (func_54(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 4)) - fParam1);
	MISC::SET_BIT(iParam0, 1);
	GRAPHICS::_0x35FB78DC42B7BD21(iParam0, 2);
	iParam0->f_2 = 0f;
}

void func_73(var uParam0)//Position - 0x31A9
{
	int iVar0;
	char cVar1[64];
	...
	if (iVar0 == 0)
	{
		func_51(uParam0, 0, AUDIO::_0x0626A247D2405330(), "MICHAEL", 0, 1);
	}
	else if (iVar0 == 2)
	{
		func_51(uParam0, 0, AUDIO::_0x0626A247D2405330(), "TREVOR", 0, 1);
	}
	else if (iVar0 == 1)
	{
		func_51(uParam0, 0, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
	}
	else
	{
		func_51(uParam0, 0, AUDIO::_0x0626A247D2405330(), "MICHAEL", 0, 1);
...
void func_74(var uParam0, int iParam1)//Position - 0x3236
{
	func_75(uParam0, iParam1);
}

void func_75(var uParam0, var uParam1)//Position - 0x3246
{
	*uParam0 = (*uParam0 || uParam1);
}

bool func_76(var uParam0, int iParam1)//Position - 0x3257
{
	return (uParam0 && iParam1) != 0;
}

void func_77()//Position - 0x3266
{
	int iVar0;
	
	if (func_76(Global_19E56.f_4A7D, 2048))
	{
		iVar0 = 0;
		while (iVar0 <= (10 - 1))
		{
			Global_19E56.f_4A7D.f_1[0 /*2*/] = 0;
			Global_19E56.f_4A7D.f_1[0 /*2*/].f_1 = 0;
			iVar0++;
		}
	}
}

int func_78(int iParam0)//Position - 0x32B0
{
	int iVar0;
	int iVar1;
...
void func_79(int iParam0)//Position - 0x32ED
{
	iParam0->f_1 = 0f;
	iParam0->f_2 = 0f;
	*iParam0 = 0;
...
int func_80(int iParam0)//Position - 0x3303
{
	if (Global_8D15 == 15)
	{
		return 0;
...
bool func_81(int iParam0, int iParam1)//Position - 0x3325
{
	bool bVar0;
...
int func_82(int iParam0)//Position - 0x3372
{
	int iVar0;
	int iVar1;
...
void func_84(var uParam0, int iParam1)//Position - 0x3458
{
	func_85(uParam0, iParam1);
}

void func_85(var uParam0, var uParam1)//Position - 0x3468
{
