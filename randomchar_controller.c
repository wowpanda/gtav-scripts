...
void func_1()
{
	...
	while (iVar2 < 63)
	{
		...
		{
			func_3(iLocal_74[Global_105652[iVar0 /*10*/].f_8], 0, 0);
				...
				if (!func_42(74))
				{
					...
					else if (func_22(iLocal_96))
					{
						...
						while (iVar1 <= 262)
						{
							...
							{
								if (DOES_BLIP_EXIST(Global_26140[iVar34 /*23*/].f_19))
								{
									SET_BLIP_FLASHES(Global_26140[iVar34 /*23*/].f_19, 1);
									SET_BLIP_FLASH_TIMER(Global_26140[iVar34 /*23*/].f_19, 10000);
									switch (func_9())
									{
										case 1:
...
void func_18(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_30(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_45()
{
	if (!func_44(39))
	{
		if (IS_BIT_SET(Global_106565.f_18568[27 /*6*/], 3))
		{
...
void func_48()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (!func_44(55))
		{
			if ((func_52(5) && func_50(PLAYER_PED_ID(), func_51(5), 1) < func_49(5)) || (func_52(6) && func_50(PLAYER_PED_ID(), func_51(6), 1) < func_49(6)))
			{
...
float func_50(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
void func_53()
{
	if (func_69())
	{
		if (!func_42(114))
		{
			if (IS_BIT_SET(Global_106565.f_18568[46 /*6*/], 3))
			{
		...
		{
			if (IS_BIT_SET(Global_106565.f_18568[51 /*6*/], 3))
			{
...
void func_60(int iParam0)
{
	...
	while (iVar15 < Global_106565.f_7682.f_198)
	{
		...
		{
			func_61(Global_106565.f_7682.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
void func_70()
{
	...
	{
		if (!IS_BIT_SET(Global_106565.f_18568.f_390[iLocal_52], iLocal_51))
		{
			func_17(iVar0, &Var1);
			if (iVar0 == 58)
			{
				SET_BIT(&(Global_106565.f_18568.f_390[iLocal_52]), iLocal_51);
			}
			else if (_IS_MINIMAP_AREA_REVEALED(Var1.f_6))
			{
				SET_BIT(&(Global_106565.f_18568.f_390[iLocal_52]), iLocal_51);
			}
			else if (Global_105652[iVar0 /*10*/].f_8 != -1)
			{
				...
				{
					if (IS_BIT_SET(Global_26140[iLocal_74[Global_105652[iVar0 /*10*/].f_8] /*23*/].f_11, 6))
					{
						func_75(iLocal_74[Global_105652[iVar0 /*10*/].f_8]);
					}
				}
			}
		}
		else if (Global_105652[iVar0 /*10*/].f_8 != -1)
		{
			if (iLocal_53[Global_105652[iVar0 /*10*/].f_8])
			{
				if (!IS_BIT_SET(Global_26140[iLocal_74[Global_105652[iVar0 /*10*/].f_8] /*23*/].f_11, 6))
				{
					func_71(iLocal_74[Global_105652[iVar0 /*10*/].f_8]);
				}
			}
		}
	}
...
void func_77(int iParam0)
{
	...
	if (!IS_BIT_SET(Global_106565.f_18568[iParam0 /*6*/], 1))
	{
		if (!Var0.f_23)
		{
			SET_BIT(&(Global_106565.f_18568[iParam0 /*6*/]), 1);
		}
	}
	if (IS_BIT_SET(Global_106565.f_18568[iParam0 /*6*/], 0) && !IS_BIT_SET(Global_106565.f_18568[iParam0 /*6*/], 3))
	{
		if (!Global_106565.f_18568[iParam0 /*6*/].f_1)
		{
			...
			Global_106565.f_18568[iParam0 /*6*/].f_2 = uVar32;
		...
		if (IS_BIT_SET(Global_106565.f_18568[iParam0 /*6*/], 1))
		{
			if (!IS_BIT_SET(Global_106565.f_18568[iParam0 /*6*/], 2))
			{
				...
				if (Var0.f_15 > 0 && bVar34)
				{
					...
					{
						func_116(Global_106565.f_18568[iParam0 /*6*/].f_2, &uVar35, &uVar36, &uVar37, &iVar38, &iVar39, &iVar40);
				...
				if (bVar34)
				{
					SET_BIT(&(Global_106565.f_18568[iParam0 /*6*/]), 2);
	...
	if (IS_BIT_SET(Global_106565.f_18568[iParam0 /*6*/], 2) && !IS_BIT_SET(Global_106565.f_18568[iParam0 /*6*/], 3))
	{
		bVar59 = true;
		if (func_122(iParam0))
		{
		...
		if (!bVar59)
		{
			CLEAR_BIT(&(Global_106565.f_18568[iParam0 /*6*/]), 2);
		}
	}
	iVar60 = 1;
	...
	else if (Global_105652[iParam0 /*10*/].f_3)
	{
		...
		if (!func_114() && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), Var0.f_6, 0) > fVar61)
		{
			Global_105652[iParam0 /*10*/].f_3 = 0;
		}
		else
	...
	iVar62 = 0;
	if ((((iVar60 && !IS_BIT_SET(Global_106565.f_18568[iParam0 /*6*/], 3)) && IS_BIT_SET(Global_106565.f_18568[iParam0 /*6*/], 0)) && IS_BIT_SET(Global_106565.f_18568[iParam0 /*6*/], 1)) && IS_BIT_SET(Global_106565.f_18568[iParam0 /*6*/], 2))
	{
	...
	if (Global_105652[iParam0 /*10*/].f_7 != iVar62)
	{
		if (func_99(&(Global_105652[iParam0 /*10*/].f_8)))
		{
			...
			{
				iVar63 = iLocal_74[Global_105652[iParam0 /*10*/].f_8];
				if (iVar62 == 0)
				{
					func_3(iVar63, 0, 0);
					func_98(iVar63, 0);
			...
			Global_105652[iParam0 /*10*/].f_7 = iVar62;
		}
	}
	if (!IS_BIT_SET(Global_106565.f_18568[iParam0 /*6*/], 4))
	{
		if (GET_HASH_KEY(&(Var0.f_10)) == GET_HASH_KEY(""))
		{
			SET_BIT(&(Global_106565.f_18568[iParam0 /*6*/]), 4);
		}
		else if (iVar62 == 2)
		{
			if (func_88(Var0.f_26, func_9()))
			{
				if (!func_83() && !IS_PLAYER_SWITCH_IN_PROGRESS())
				{
	...
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (!func_44(35))
		{
			if (IS_BIT_SET(Global_106565.f_18568[iParam0 /*6*/], 2) && !IS_BIT_SET(Global_106565.f_18568[iParam0 /*6*/], 3))
			{
				...
				{
					if (VDIST2(Var0.f_6, GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) < 81f)
					{
						sVar64 = "";
						if (IS_BIT_SET(Var0.f_26, 1))
						{
							sVar64 = "TRIG_RC_F";
						}
						else if (IS_BIT_SET(Var0.f_26, 0))
						{
							sVar64 = "TRIG_RC_M";
						}
						else
						...
						if (!IS_STRING_NULL_OR_EMPTY(sVar64))
						{
...
int func_79(int iParam0)
{
	if (iParam0 == 2)
	{
		if (IS_BIT_SET(Global_106565.f_18568[3 /*6*/], 3) && Global_105652[3 /*10*/].f_3 == 1)
		{
			return 1;
		}
	}
	...
	{
		if (IS_BIT_SET(Global_106565.f_18568[2 /*6*/], 3) && Global_105652[2 /*10*/].f_3 == 1)
		{
			return 1;
		}
	}
...
int func_80(int iParam0)
{
	...
	{
		if (IS_BIT_SET(Global_106565.f_18568[2 /*6*/], 0) && IS_BIT_SET(Global_106565.f_18568[3 /*6*/], 0))
		{
...
int func_82(int iParam0)
{
	...
	uVar1 = IS_BIT_SET(Global_26140[iVar0 /*23*/].f_11, 0);
	uVar2 = IS_BIT_SET(Global_26140[iVar0 /*23*/].f_11, 15);
	if (uVar1 && uVar2)
	{
		return 1;
	}
...
void func_90(int iParam0, int iParam1)
{
	...
	{
		if ((IS_BIT_SET(Global_106565.f_18568[2 /*6*/], 3) || IS_BIT_SET(Global_106565.f_18568[3 /*6*/], 3)) || IS_BIT_SET(Global_106565.f_18568[4 /*6*/], 3))
		{
...
void func_92(int iParam0, int iParam1)
{
	...
	SET_BITS_IN_RANGE(&(Global_26140[iVar0 /*23*/].f_11), 21, 26, iParam1);
	if (Global_26137 == 1)
	{
		Global_26138 = 1;
	}
...
void func_96(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		SET_BIT(&(Global_26140[iVar0 /*23*/].f_11), 28);
	}
	else
	{
		CLEAR_BIT(&(Global_26140[iVar0 /*23*/].f_11), 28);
	}
	if (Global_26137 == 1)
	{
		Global_26138 = 1;
...
int func_106(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = GET_ENTITY_MODEL(func_107(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 1)));
				switch (iVar0)
				{
...
void func_108(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_109(iParam0) && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_84500[26 /*34*/].f_6) == 0)
			{
				Global_106565.f_7255[iParam0] = 1;
				_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_106565.f_7255[iParam0], 1, 1);
			}
...
void func_117(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = ROUND(func_118(TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
