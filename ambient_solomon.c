...
void __EntryFunction__()
{
	...
	if (func_69(PLAYER_PED_ID()))
	{
		while (bVar0 == 0)
		{
			bVar0 = ((GET_MISSION_FLAG() == 0 && func_65() == 0) && func_64(PLAYER_PED_ID(), vLocal_64, fLocal_67));
			func_62();
		}
	}
	func_61(65, 0);
	...
	while (true)
	{
		...
		vLocal_250 = { GET_ENTITY_FORWARD_VECTOR(PLAYER_PED_ID()) };
		if (GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) == 0)
		{
			func_58(&uLocal_239);
			func_3(&uLocal_240);
			if (func_2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 7, 0, 0))
			{
				func_61(65, 1);
				func_1(30);
				func_71();
...
void func_3(var uParam0)
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			if (func_52(PLAYER_PED_ID(), -1210.236f, -579.875f, 26.33215f, -1204.725f, -586.3573f, 29.56773f, 6f))
			{
				fLocal_241 = 0.25f;
				*uParam0++;
				return;
			...
			if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
				...
				uVar1 = ACOS(func_51(vLocal_250, 0.73f, 0.683f, -0.013f));
				if (ABSF(uVar1) < 25f)
				{
		...
		case 2:
			...
			{
				func_46(&uLocal_74, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
				if (func_45())
				{
...
{
	uParam0->f_1 = CREATE_VEHICLE(joaat("akuma"), vParam1, fParam4, 1, 1, 0);
	if (func_69(uParam0->f_1))
	{
		FREEZE_ENTITY_POSITION(uParam0->f_1, 1);
		SET_ENTITY_COLLISION(uParam0->f_1, 0, 0);
		SET_ENTITY_VISIBLE(uParam0->f_1, 0, 0);
		SET_VEHICLE_ENGINE_ON(uParam0->f_1, 0, 1, 0);
		*uParam0 = CREATE_PED_INSIDE_VEHICLE(uParam0->f_1, 26, GET_ENTITY_MODEL(PLAYER_PED_ID()), -1, 1, 1);
		if (func_69(*uParam0))
		{
...
int func_47(vector3 vParam0)
{
	...
	while (iVar1 < iVar0)
	{
		...
		{
			if (IS_PED_MODEL(uVar2[iVar1], iLocal_253))
			{
...
float func_48(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
int func_52(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	struct<2> Var3;
	struct<2> Var6;
	
	if (IS_ENTITY_IN_ANGLED_AREA(uParam0, vParam1, vParam4, fParam7, 0, 1, 0))
	{
		return 1;
	}
	...
	GET_MODEL_DIMENSIONS(GET_ENTITY_MODEL(uParam0), &Var3, &Var6);
	vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, Var3, Var6.f_1, 0f) };
	if (IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam4, fParam7, 0, 1))
	{
		return 1;
	}
	vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, 0f, Var6.f_1, 0f) };
	if (IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam4, fParam7, 0, 1))
	{
		return 1;
	}
	vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, Var6, Var6.f_1, 0f) };
	if (IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam4, fParam7, 0, 1))
	{
		return 1;
	}
	vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, Var3, Var3.f_1, 0f) };
	if (IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam4, fParam7, 0, 1))
	{
		return 1;
	}
	vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, 0f, Var3.f_1, 0f) };
	if (IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam4, fParam7, 0, 1))
	{
		return 1;
	}
	vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, Var6, Var3.f_1, 0f) };
	if (IS_POINT_IN_ANGLED_AREA(vVar0, vParam1, vParam4, fParam7, 0, 1))
	{
		return 1;
	}
...
void func_58(var uParam0)
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			if (func_52(PLAYER_PED_ID(), -1055.046f, -469.3347f, 35.43333f, -1057.44f, -474.9772f, 39.8187f, 12.5f))
			{
				fLocal_241 = 0.25f;
				*uParam0++;
				return;
			...
			{
				uVar2 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
				uVar1 = ACOS(func_51(vLocal_250, -0.37f, -0.927f, -0.053f));
				if (ABSF(uVar1) < 45f)
				{
		...
		case 7:
			if (!func_52(PLAYER_PED_ID(), -1055.514f, -474.6371f, 35.6278f, -1051.23f, -464.4126f, 39.91479f, 9.5f))
			{
				func_54(&uLocal_243);
				*uParam0++;
			}
...
{
	func_69(PLAYER_PED_ID());
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("solomon1")) > 0)
	{
		func_1(30);
		func_61(65, 1);
		func_71();
	...
	if (!func_64(PLAYER_PED_ID(), vLocal_64, (fLocal_67 + 30f)))
	{
		func_71();
	}
	WAIT(0);
...
bool func_64(var uParam0, vector3 vParam1, float fParam4)
{
