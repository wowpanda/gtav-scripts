...
void __EntryFunction__()
{
	...
	iLocal_219 = -1;
	sLocal_221 = "";
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_KEY("appCovertOps")) > 1)
	{
		func_230(0, 0);
	}
	func_182();
...
void func_1()
{
	if (((!IS_BIT_SET(uLocal_216, 7) && !IS_BIT_SET(uLocal_216, 6)) && iLocal_354 == 1) && !func_10())
	{
		if (!func_9())
		{
...
void func_31()
{
	...
	if ((!IS_BIT_SET(uLocal_216, 4) && !func_10()) && iLocal_354 == 1)
	{
		if (!IS_BIT_SET(uLocal_216, 5))
		{
			if (!func_5(15378, -1, -1))
			{
				bVar0 = true;
	...
	if (bVar0)
	{
		SET_BIT(&uLocal_216, 4);
	}
	else if (IS_BIT_SET(uLocal_216, 4))
	{
		...
		{
			CLEAR_BIT(&uLocal_216, 4);
			iLocal_218 = 0;
			func_33(&uLocal_358);
			if (func_32())
			{
				SET_BIT(&uLocal_216, 3);
			}
		}
	}
}
...
int func_32()
{
	if ((func_5(15378, -1, -1) || IS_BIT_SET(uLocal_216, 5)) && func_5(15379, -1, -1))
	{
		return 1;
	}
	return 0;
...
void func_37()
{
	...
	func_159();
	if (IS_BIT_SET(uLocal_216, 0))
	{
		if (IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_526) && IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_527))
		{
			iVar0 = GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_526);
			iVar1 = GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_527);
			switch (iVar0)
			{
				case 102:
...
{
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_525, "SHOW_OVERLAY");
	func_44(sParam0);
...
int func_47(int iParam0)
{
	...
	return IS_BIT_SET(func_48(5463, -1, 0), iParam0);
}
		...
		if (iVar1 != -1)
		{
			...
			switch (iParam2)
			{
				...
				case 2:
					...
					Global_2449538.f_6351 = { func_145(PLAYER_ID()) };
					break;
			}
...
void func_58(var uParam0, int iParam1, int iParam2, vector3 vParam3, var uParam6, vector3 vParam7, bool bParam10, bool bParam11, var uParam12, var uParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	...
	if (func_109(iParam1))
	{
		*uParam6 = { func_108(iParam1, iParam2) };
		vVar3 = { func_107(iParam1, iParam2) };
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (func_105(vVar0))
		{
			if (func_121(PLAYER_ID(), 0))
			{
				if (DOES_ENTITY_EXIST(func_102()) && !IS_ENTITY_DEAD(func_102(), 0))
				{
					vVar0 = { GET_ENTITY_COORDS(func_102(), 1) };
					vVar3 = { 0f, 0f, GET_ENTITY_HEADING(func_102()) };
					if (func_101(Global_1589819[PLAYER_ID() /*818*/].f_682, 1, 0))
					{
			...
			if ((func_100(PLAYER_ID()) || func_98(PLAYER_ID())) && func_97())
			{
	...
	{
		func_90();
		func_89(&vVar7, 144, Global_1589819[PLAYER_ID() /*818*/].f_273.f_25);
		if (!func_105(vVar7))
		{
			vVar0 = { vVar7 };
		}
		func_83(&vVar7, 144, Global_1589819[PLAYER_ID() /*818*/].f_273.f_25);
		vVar3 = { vVar7 };
	}
...
void func_59(bool bParam0, bool bParam1)
{
	...
	if (!bParam0)
	{
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			if (func_60())
			{
				func_73(PLAYER_ID(), 0, 32772, 0);
			}
			else if (!bParam1)
			{
				func_73(PLAYER_ID(), 0, 319492, 0);
			}
		}
		else
		{
			func_73(PLAYER_ID(), 0, 57348, 0);
		}
	}
}
...
int func_65()
{
	if (func_121(PLAYER_ID(), 0))
	{
		if (Global_1589819[PLAYER_ID() /*818*/].f_682 != func_67())
		{
			if (func_66(Global_1589819[PLAYER_ID() /*818*/].f_682, 0, 1))
			{
				if (func_101(Global_1589819[PLAYER_ID() /*818*/].f_682, 1, 0))
				{
					return 0;
	...
	else
	{
		...
		if (NETWORK_IS_PLAYER_ACTIVE(iParam0) && (IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_121(PLAYER_ID(), 0) && !func_78()))
				{
			...
			if (bParam1)
			{
				if (!func_77(uVar25) && !IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar25))
				{
					if (!bVar21)
					{
...
void func_84(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	*uParam2 = { func_86(iParam1, iParam3) };
	...
	vVar13 = { func_85(vVar13, -Var0[0 /*6*/].f_3.f_2) };
	vVar13 = { func_85(vVar13, Var0[1 /*6*/].f_3.f_2) };
...
{
	if (!_GET_SCREEN_EFFECT_IS_ACTIVE(func_111(0)))
	{
		_START_SCREEN_EFFECT(func_111(iParam0), 0, 1);
	}
}
...
char* func_111(int iParam0)
{
	...
	if (func_112(Global_4456448.f_161209) && IS_BIT_SET(Global_4456448.f_162445.f_2808, 2))
	{
...
void func_126(int iParam0)
{
	...
	if (func_128() == 0 || IS_PAUSE_MENU_ACTIVE())
	{
		func_127(1);
...
void func_130(int iParam0)
{
	...
	if ((func_128() == 1 || IS_PAUSE_MENU_ACTIVE()) || iParam0)
	{
		func_127(0);
...
void func_158()
{
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_525, "HIDE_OVERLAY");
	END_SCALEFORM_MOVIE_METHOD();
	func_43(0);
	CLEAR_BIT(&uLocal_216, 1);
}
...
void func_159()
{
	if (func_160())
	{
		if (!IS_BIT_SET(uLocal_216, 0))
		{
			BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_525, "GET_CURRENT_SELECTION");
			uLocal_526 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
			BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_525, "GET_CURRENT_SCREEN_ID");
			uLocal_527 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
			SET_BIT(&uLocal_216, 0);
		}
	}
}
...
void func_161()
{
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_525, "SET_INPUT_EVENT", TO_FLOAT(205), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	ENABLE_CONTROL_ACTION(2, 206, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 206))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_525, "SET_INPUT_EVENT", TO_FLOAT(206), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (_IS_INPUT_JUST_DISABLED(2))
	{
		...
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_525, "SET_INPUT_EVENT", TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		ENABLE_CONTROL_ACTION(2, 187, 1);
		if (IS_CONTROL_JUST_PRESSED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_525, "SET_INPUT_EVENT", TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (IS_CONTROL_JUST_RELEASED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_525, "SET_INPUT_RELEASE_EVENT", TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (IS_CONTROL_JUST_RELEASED(2, 188))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_525, "SET_INPUT_RELEASE_EVENT", TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (IS_CONTROL_JUST_PRESSED(2, 188))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_525, "SET_INPUT_EVENT", TO_FLOAT(188), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		ENABLE_CONTROL_ACTION(2, 187, 1);
		if (IS_CONTROL_JUST_PRESSED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_525, "SET_INPUT_EVENT", TO_FLOAT(187), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	ENABLE_CONTROL_ACTION(2, 189, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 189))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_525, "SET_INPUT_EVENT", TO_FLOAT(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	ENABLE_CONTROL_ACTION(2, 190, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 190))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_525, "SET_INPUT_EVENT", TO_FLOAT(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	ENABLE_CONTROL_ACTION(2, 201, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 201))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_525, "SET_INPUT_EVENT", TO_FLOAT(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	ENABLE_CONTROL_ACTION(2, 202, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 202))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_525, "SET_INPUT_EVENT", TO_FLOAT(202), -1082130432, -1082130432, -1082130432, -1082130432);
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_525, "SET_INPUT_EVENT", TO_FLOAT(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	ENABLE_CONTROL_ACTION(2, 204, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 204))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_525, "SET_INPUT_EVENT", TO_FLOAT(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (_IS_INPUT_JUST_DISABLED(2))
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_525, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		{
			BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_525, "SET_ANALOG_STICK_INPUT");
			iLocal_528 = iVar0;
			iLocal_529 = iVar1;
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(1);
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_528);
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_529);
			END_SCALEFORM_MOVIE_METHOD();
		}
	}
	...
	if (((iVar2 != 127 || iLocal_530 != 127) || iVar3 != 127) || iLocal_531 != 127)
	{
		...
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_530);
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_531);
...
bool func_162()
{
	return IS_BIT_SET(uLocal_216, 1);
}
...
void func_163()
{
	...
	SET_SCRIPT_GFX_DRAW_ORDER(1);
	DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_525, 255, 255, 255, 255, 0);
	func_171();
	func_166(0);
	func_164(1);
}
...
int func_179(int iParam0)
{
	if (iParam0 != func_67())
	{
		...
		else if ((Global_1312867 && iParam0 == PLAYER_ID()) && func_66(iParam0, 1, 0))
		{
			return Global_2424047[iParam0 /*416*/].f_309.f_5 != -1;
		}
	}
...
{
	func_177();
	uLocal_525 = REQUEST_SCALEFORM_MOVIE("COVERT_OPS");
	while (!HAS_SCALEFORM_MOVIE_LOADED(uLocal_525))
	{
		WAIT(0);
	}
	SET_BIT(&uLocal_216, 7);
	func_167(1);
	func_228(1);
	func_227();
	_0xFDB423997FA30340();
	func_226(1);
	func_73(PLAYER_ID(), 0, 0, 0);
...
void func_187()
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_525, "SET_PLAYER_DATA");
...
void func_188(int iParam0)
{
	...
	if (iVar1 != -1)
	{
		if (!func_220())
		{
			...
			if (iVar1 != -1)
			{
				func_189(&fVar5, &fVar6, 0, 9, 0, 0, GET_HASH_KEY(&(Global_794709.f_4[iVar1 /*88*/])));
			}
			if (fVar5 == 1f)
			{
				fVar5 = 0f;
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_525, "ADD_MISSION");
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	if (iVar1 != -1)
	{
		_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING_2(&(Global_794709.f_4[iVar1 /*88*/].f_22));
		BEGIN_TEXT_COMMAND_SCALEFORM_STRING("FMMC_OFFLN_HD");
		iVar0 = 0;
		while (iVar0 < 8)
		{
			ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Local_222[iVar0 /*16*/]));
			iVar0++;
		}
		END_TEXT_COMMAND_SCALEFORM_STRING();
	}
	...
	_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING_2(uVar4);
...
bool func_216(int iParam0)
{
	...
	if (bVar0)
	{
		...
		while (!bVar9)
		{
			...
			{
				StringCopy(&(Local_222[iVar7 /*16*/]), _GET_TEXT_SUBSTRING_SAFE(uVar4, iVar5, iVar6, 63), 64);
				iVar5 = (iVar5 + GET_LENGTH_OF_LITERAL_STRING(&(Local_222[iVar7 /*16*/])));
				iVar7++;
			}
		}
	}
...
{
	SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_525);
	func_226(iParam1);
	func_228(0);
	func_231();
