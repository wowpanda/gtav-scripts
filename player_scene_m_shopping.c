	...
	if (!IS_PED_INJURED(*uParam0))
	{
		...
		if (iLocal_294 >= 0)
		{
			if (IS_ENTITY_ON_FIRE(*uParam0))
			{
				...
				{
					STOP_ANIM_PLAYBACK(*uParam0, 0, 0);
				}
		...
		switch (iLocal_294)
		{
			...
			case 1:
				...
				else if (IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
				{
					...
					if (!IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_312, &cLocal_344, 2))
					{
						CLEAR_PED_TASKS(*uParam0);
						STOP_SYNCHRONIZED_ENTITY_ANIM(*uParam0, -16f, 1);
						SET_PED_MOVE_ANIMS_BLEND_OUT(*uParam0);
						TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, vLocal_304 + vLocal_308, 1f, -1, (fLocal_311 * 0.1f), 0, 1193033728);
						FORCE_PED_MOTION_STATE(*uParam0, -668482597, 0, 0, 0);
					...
					else
					{
						...
						if (!FIND_ANIM_EVENT_PHASE(&cLocal_312, &cLocal_344, "WalkInterruptible", &fVar1, &uVar2))
						{
						}
						else
						{
							if (fLocal_380 >= 0f)
							{
								if (fVar0 >= fLocal_380)
								{
									func_123(*uParam0, "DISMISS_MICHAEL", "AMANDA_NORMAL", 24);
									fLocal_380 = -1f;
								}
							}
							if (fVar0 >= fVar1)
				...
				{
					CLEAR_PED_TASKS(*uParam0);
					if (IS_STRING_NULL_OR_EMPTY(&cLocal_360))
					{
						TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, vLocal_304 + vLocal_308, 1f, -1, (fLocal_311 * 0.1f), 0, 1193033728);
						FORCE_PED_MOTION_STATE(*uParam0, -668482597, 0, 0, 0);
						_RESET_PED_RAGDOLL_BLOCKING_FLAGS(*uParam0, 2);
					...
					{
						TASK_START_SCENARIO_AT_POSITION(*uParam0, &cLocal_360, vLocal_304 + vLocal_376, (fLocal_307 + fLocal_379), 0, 0, 1);
			...
			case 2:
				...
				else
				{
					...
					CLEAR_PED_TASKS(*uParam0);
					if (func_122(vLocal_308, 0f, 0f, 0f, 0))
					{
			...
			case 3:
				...
				{
					if (VDIST2(GET_ENTITY_COORDS(*uParam0, 1), vLocal_304 + vLocal_308) < (fLocal_311 * fLocal_311))
					{
						if (fLocal_311 == 0f)
						{
							fLocal_311 = (VMAG(vLocal_308) * 0.75f);
						}
						TASK_WANDER_IN_AREA(*uParam0, vLocal_304 + vLocal_308, fLocal_311, 1077936128, 1086324736);
						func_124(4, 0);
						return 1;
					}
				}
			...
			case 4:
				...
				if (VDIST2(GET_ENTITY_COORDS(*uParam0, 1), vLocal_304 + vLocal_308) < (fLocal_311 * fLocal_311))
				{
					if (DOES_SCENARIO_EXIST_IN_AREA(vLocal_304 + vLocal_308, fLocal_311, 1))
					{
						TASK_USE_NEAREST_SCENARIO_TO_COORD(*uParam0, vLocal_304 + vLocal_308, fLocal_311, 0);
						REMOVE_SCENARIO_BLOCKING_AREA(uLocal_381, 0);
						func_124(5, 0);
						return 1;
					}
				}
			...
			case 5:
				...
				else
				{
					...
					{
						if (VDIST2(GET_ENTITY_COORDS(*uParam0, 1), vVar9) > 100f)
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, vVar9, 1f, -1, 1048576000, 0, 1193033728);
							vVar12 = { GET_ENTITY_COORDS(*uParam0, 1) - Vector(2f, 2f, 2f) };
							vVar15 = { GET_ENTITY_COORDS(*uParam0, 1) + Vector(2f, 2f, 2f) };
							uLocal_381 = ADD_SCENARIO_BLOCKING_AREA(vVar12, vVar15, 0, 0, 1, 1);
			...
			case 7:
				...
				func_7(*uParam0);
				if (IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_312, &cLocal_328, 2))
				{
				}
				else if (IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_312, &cLocal_344, 2))
				{
				}
				break;
			...
			case 8:
				...
				if (GET_SCRIPT_TASK_STATUS(*uParam0, 1805844857) != 1)
				{
					TASK_SMART_FLEE_PED(*uParam0, PLAYER_PED_ID(), 50f, 20000, 1, 0);
					return 1;
				}
				if (VDIST2(GET_ENTITY_COORDS(*uParam0, 1), GET_ENTITY_COORDS(*uParam0, 1)) > (50f * 1.25f))
				{
					TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, vLocal_304 + vLocal_308, 1f, -1, (fLocal_311 * 0.1f), 0, 1193033728);
...
void func_7(var uParam0)
{
	...
	if (IS_PED_INJURED(uParam0))
	{
		if (!iLocal_384 && HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0, PLAYER_PED_ID(), 1))
		{
			...
			if (iVar2 != -1)
			{
				...
				if (iVar3 != 0)
				{
					...
					{
						func_105(75, GET_ENTITY_COORDS(uParam0, 0), 250f, -1);
	...
	func_10(uParam0, 138, &uLocal_104, "FMMAUD", &uLocal_269, &uLocal_290, 3);
	...
	else
	{
		...
		if (iLocal_382 > 0)
		{
			if (iLocal_383 == 0)
			{
				if (iLocal_382 + 15000 < GET_GAME_TIMER())
				{
			...
			else if (iLocal_382 + 10000 < GET_GAME_TIMER())
			{
...
{
	_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_9(iParam2), 1);
}
...
void func_46(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_48() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_48() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_47(iParam0));
...
int func_54(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_48() /*10778*/].f_6165.f_10, iParam0);
}
...
int func_83(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_14726)
	{
		if (Global_14553.f_1 == 6)
		{
			...
			func_84(1);
			func_87(Global_14534, "DISPLAY_VIEW", 1f, TO_FLOAT(Global_14533), -1082130432, -1082130432, -1082130432);
		}
	}
	return 1;
}
					...
					if (iVar0 == Global_2430[iVar1 /*15*/].f_4)
					{
						if (Global_2992[iVar0] == 0)
						{
							...
							if (Global_2458608)
							{
								if (iVar1 == 14)
								{
									func_85(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(Global_16929), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_2992[iVar0] = 1;
						}
					...
					if (iVar0 == Global_2430[iVar1 /*15*/].f_4)
					{
						if (Global_2992[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_85(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(Global_16934), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_71590)
								{
									...
									func_85(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(iVar4), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_14553)
									...
									func_85(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(uVar6), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_2430[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_85(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(iVar9), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_85(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(0), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_2992[iVar0] = 1;
						}
					}
...
void func_85(var uParam0, char* sParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
...
void func_87(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)
{
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0, sParam1);
...
int func_92(struct<6> Param0, struct<6> Param6)
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
int func_94(int iParam0, int iParam1, int iParam2, var uParam3)
{
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			iVar13 = func_96(iParam0);
			if (func_95(&(Var4[0 /*4*/]), iVar13))
			{
				iParam2 = 1;
			}
			else if (func_95(&(Var4[1 /*4*/]), iVar13))
			{
				iParam2 = 0;
			}
			else
...
int func_102(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4)
{
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			...
			{
				iVar9 = func_96(iParam0);
				if (func_95(&(Var0[0 /*4*/]), iVar9))
				{
					iParam2 = 1;
				}
				else if (func_95(&(Var0[1 /*4*/]), iVar9))
				{
					iParam2 = 0;
				}
				else
...
void func_105(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	if (iParam0 == iParam5)
	{
		return;
...
int func_107(int iParam0, int iParam1)
{
	...
	bVar10 = false;
	if (IS_BIT_SET(Var0.f_2, func_108()))
	{
		bVar10 = true;
	}
	if (Var0.f_4 > iParam1)
...
int func_116(vector3 vParam0, bool bParam3)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_121(var uParam0, bool bParam1)
{
	...
	if (IS_PED_IN_COMBAT(uParam0, PLAYER_PED_ID()))
	{
		return 1;
	}
	if (bParam1)
	{
		...
		if (HAS_PED_RECEIVED_EVENT(uParam0, 122))
		{
			return 1;
		}
	}
...
{
	_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_9(iParam3), 0);
}
...
int func_125()
{
	if (!func_127())
	{
		func_30(&uLocal_104, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
		switch (func_33(Global_93403))
		{
			case 0:
				func_30(&uLocal_104, 1, Global_93403, func_126(0), 0, 1);
				break;
			
			case 1:
				func_30(&uLocal_104, 2, Global_93403, func_126(1), 0, 1);
				break;
			
			case 2:
				func_30(&uLocal_104, 3, Global_93403, func_126(2), 0, 1);
				break;
	...
	if (iLocal_297 != 0)
	{
		if (!DOES_ENTITY_EXIST(uLocal_296))
		{
			uLocal_296 = GET_CLOSEST_OBJECT_OF_TYPE(vLocal_304 + vLocal_298, 1f, iLocal_297, 1, 0, 1);
			if (DOES_ENTITY_EXIST(uLocal_296))
			{
				SET_ENTITY_COORDS(uLocal_296, vLocal_304 + vLocal_298, 1, 0, 0, 1);
				SET_ENTITY_ROTATION(uLocal_296, Vector(fLocal_307, 0f, 0f) + vLocal_301, 2, 1);
				FREEZE_ENTITY_POSITION(uLocal_296, 1);
			}
		}
	}
	return 0;
...
void func_136()
{
	...
	if (iLocal_295 != 0)
	{
		REQUEST_VEHICLE_ASSET(iLocal_295, 3);
	}
	iVar0 = 0;
	bVar1 = false;
	while (!bVar1 && iVar0 < 400)
	{
		...
		if (iLocal_295 != 0)
		{
			if (!HAS_VEHICLE_ASSET_LOADED(iLocal_295))
			{
				bVar1 = false;
			}
		}
...
void func_138()
{
	...
	func_154(iLocal_103, &vLocal_304, &fLocal_307, &cVar0);
	switch (iLocal_103)
	{
		case 98:
		...
		default:
			vLocal_308 = { GET_RANDOM_FLOAT_IN_RANGE(-50f, 50f), GET_RANDOM_FLOAT_IN_RANGE(-50f, 50f), 0f };
			fLocal_311 = (VMAG(vLocal_308) * 0.75f);
			break;
	}
	if ((iLocal_103 != 94 && iLocal_103 != 152) && iLocal_103 != 151)
	{
		...
		Var8.f_31 = 49;
		Var8.f_81 = 2;
		if (func_141(0, iLocal_103, &Var8, &uVar106, &uVar109, &uVar110, &uVar113))
		{
			iLocal_295 = Var8;
		}
	}
	...
	if (iLocal_294 == 0)
	{
		func_139(iLocal_103, &cLocal_312, &cLocal_328, &cLocal_344, &uVar114, &uVar115);
		iLocal_294 = 0;
	}
	else
	{
...
void func_161()
{
	if (iLocal_295 != 0)
	{
		REMOVE_VEHICLE_ASSET(iLocal_295);
	}
	SET_GAME_PAUSED(0);
