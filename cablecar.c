...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!func_297(PLAYER::PLAYER_PED_ID()) || Global_25280 == 1)
		{
			func_302(1, 1, 1, 1);
			Global_25282 = 0;
...
void func_17(var uParam0)
{
	...
	uParam0->f_33 = func_275(PLAYER::PLAYER_PED_ID(), uParam0, 0f, 0);
	if (uParam0->f_33)
	{
		if (uParam0->f_28 != -1)
		{
	...
	switch (*uParam0)
	{
		...
		case 9:
			if (func_233(PLAYER::PLAYER_PED_ID(), uParam0, 0, 0))
			{
			...
			else if (!func_233(PLAYER::PLAYER_PED_ID(), uParam0, 1.1f, 0))
			{
				*uParam0 = 10;
				AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "DOOR_CLOSE", uParam0->f_2, "CABLE_CAR_SOUNDS", 0, 0);
				uParam0->f_11 = 0;
		...
		case 7:
			if (!func_233(PLAYER::PLAYER_PED_ID(), uParam0, 1.125f, 0))
			{
				*uParam0 = 1;
...
void func_20(var uParam0)
{
	...
	ENTITY::PLAY_ENTITY_ANIM(uParam0->f_2, &cVar0, "p_cablecar_s", 8f, false, 1, 0, 0, 0);
}
...
void func_40(var uParam0, bool bParam1)
{
	...
	if (bParam1 && (uParam0->f_11 == 1 || uParam0->f_34 == 1))
	{
		...
		func_27();
		SYSTEM::WAIT(0);
		func_97(ENTITY::GET_ENTITY_COORDS(uParam0->f_2, true), 50f, 13, 5000, 1, 1);
		func_37(PLAYER::PLAYER_PED_ID(), uParam0);
	...
	if (uParam0->f_11 == 1 || uParam0->f_34 == 1)
	{
		...
		MISC::CLEAR_BIT(&Global_71226, 4);
		MISC::CLEAR_BIT(&Global_71226, 5);
		if (uParam0->f_24 == 0)
		{
	...
	*uParam0 = 7;
	...
	if (uParam0->f_11 == 1 || uParam0->f_34 == 1)
	{
		...
		if (func_297(func_88()))
		{
			BRAIN::TASK_GO_STRAIGHT_TO_COORD_RELATIVE_TO_ENTITY(func_88(), PLAYER::PLAYER_PED_ID(), -1f, 2f, 0f, 1f, 20000);
			bVar0 = true;
		}
		if (func_297(func_52()))
		{
			BRAIN::TASK_GO_STRAIGHT_TO_COORD_RELATIVE_TO_ENTITY(func_52(), PLAYER::PLAYER_PED_ID(), 1f, 2f, 0f, 1f, 20000);
			bVar0 = true;
		}
		if (func_43(6))
		{
...
void func_45()
{
	...
	{
		func_49(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
...
int func_54(int iParam0, int iParam1, int iParam2)
{
	...
	return func_55(Global_105220.f_28021[iParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
...
void func_58(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_105220.f_20535.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_60() /*12171*/].f_7688.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_105220.f_20535.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_60() /*12171*/].f_7688.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_62(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_60() /*12171*/].f_7688.f_10, iParam0);
}
...
void func_91()
{
	...
	{
		if (func_87(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_86(PLAYER::PLAYER_PED_ID());
			if (func_85(iVar0) && (!func_43(14) || Global_104171))
			{
				if (Global_105220.f_2354.f_539.f_4301 != iVar0 && func_85(Global_105220.f_2354.f_539.f_4301))
				{
...
void func_97(vector3 vParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
void func_101(int iParam0)
{
	...
	if (iParam0 == 1)
	{
		func_102(&Local_69, vVar0, ENTITY::GET_ENTITY_ROTATION(PLAYER::PLAYER_PED_ID(), 2) + Vector(0f, 0f, fLocal_68), 50f, Local_69.f_20, Local_69.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
	}
	else
	{
		func_102(&Local_69, vVar0, ENTITY::GET_ENTITY_ROTATION(PLAYER::PLAYER_PED_ID(), 2), 50f, Local_69.f_20, Local_69.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
	}
...
void func_102(var uParam0, vector3 vParam1, vector3 vParam2, float fParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, float fParam10, bool bParam11)
{
	uParam0->f_1 = { vParam1 };
	uParam0->f_4 = { vParam2 };
	uParam0->f_7 = fParam3;
...
void func_103(var uParam0)
{
	...
	if (!func_297(PLAYER::PLAYER_PED_ID()) || !func_297(uParam0->f_2))
	{
		return;
	}
	vVar0 = { vLocal_56 };
...
void func_104(var uParam0)
{
	...
	vVar0 = { vLocal_56 };
	vVar0.x = 1f;
	ENTITY::SET_ENTITY_COORDS(func_52(), ENTITY::GET_ENTITY_COORDS(uParam0->f_2, true), 1, false, 0, 1);
	if (ENTITY::IS_ENTITY_ATTACHED(func_52()))
	{
		ENTITY::DETACH_ENTITY(func_52(), 1, true);
	}
	vVar0.y = (vVar0.y * uParam0->f_17);
	if (uParam0->f_17 == -1f)
	{
		ENTITY::ATTACH_ENTITY_TO_ENTITY(func_52(), uParam0->f_2, 0, vVar0, 0f, 0f, 180f, 0, 0, 0, 0, 2, 1);
	}
	else
	{
		ENTITY::ATTACH_ENTITY_TO_ENTITY(func_52(), uParam0->f_2, 0, vVar0, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	}
}
...
void func_105(var uParam0)
{
	...
	vVar0 = { vLocal_56 };
	vVar0.x = -1f;
	ENTITY::SET_ENTITY_COORDS(func_88(), ENTITY::GET_ENTITY_COORDS(uParam0->f_2, true), 1, false, 0, 1);
	if (ENTITY::IS_ENTITY_ATTACHED(func_88()))
	{
		ENTITY::DETACH_ENTITY(func_88(), 1, true);
	}
	vVar0.y = (vVar0.y * uParam0->f_17);
	if (uParam0->f_17 == -1f)
	{
		ENTITY::ATTACH_ENTITY_TO_ENTITY(func_88(), uParam0->f_2, 0, vVar0, 0f, 0f, 180f, 0, 0, 0, 0, 2, 1);
	}
	else
	{
		ENTITY::ATTACH_ENTITY_TO_ENTITY(func_88(), uParam0->f_2, 0, vVar0, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	}
}

void func_106(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_70793[1 /*14*/] = { func_159(iVar10, iParam1, iParam2) };
		if (!func_158(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_70793[1 /*14*/] = { func_159(iVar10, iVar0, uVar11[iVar0]) };
				if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_70793[1 /*14*/] = { func_159(iVar10, 14, uVar12[iVar1]) };
							func_129(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
							func_151(14);
							if (Global_70791 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_119(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_119(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_119(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
						}
						func_151(iVar0);
						if (Global_70791 == 1)
						{
			...
			{
				Global_70793[1 /*14*/] = { func_159(iVar10, iVar0, func_118(iParam0, iVar0, -1)) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_70793[1 /*14*/] = { func_159(iVar10, 14, uVar15[iVar1]) };
			func_129(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
			func_151(14);
			if (Global_70791 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_119(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_119(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_119(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
		}
		if (Global_70791 == 1)
		{
			iVar2 = 0;
...
int func_110(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_223(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_64, Global_105220.f_2354.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_70793[1 /*14*/] = { func_159(iParam0, iParam1, iParam2) };
...
int func_117(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_223(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_61, Global_105220.f_2354.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_131(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_119(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_136(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_119(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_144(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[0], Global_105220.f_2354.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_144(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[1], Global_105220.f_2354.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_144(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[2], Global_105220.f_2354.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_131(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_131(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_131(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_131(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_151(int iParam0)
{
	...
	{
		func_157(iParam0, Global_70793[1 /*14*/].f_5, Global_70793[1 /*14*/].f_2, 2, Global_70793[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_153(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_154(iParam2)];
	if (iVar0 != 0)
	{
...
int func_155(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_154(iParam1)];
...
void func_161(int iParam0)
{
	...
	func_162(&(Global_70793[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_155(func_165(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_155(func_164(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_155(iVar1, Global_70790, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_168(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_162(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_162(&(Global_70793[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_162(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_119(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_162(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_223(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_70793[1 /*14*/] = { func_159(iVar0, iParam1, iParam2) };
	if (!MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_223(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_223(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_70793[2 /*14*/] = { func_159(iVar0, 14, iVar4) };
									if (Global_70793[2 /*14*/].f_12 == iVar3)
									{
										if (func_223(iParam0, 14, iVar4))
										{
											if (!func_115(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_70793[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_70793[2 /*14*/] = { func_159(iVar0, iVar2, iVar1) };
						if (!func_115(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_70793[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_70793[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_119(iParam1)) && Global_70793[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_119(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_225(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_229(PLAYER::PLAYER_ID())) && !func_227(PLAYER::PLAYER_ID(), 0)) && !func_226()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_229(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_70976 = 0;
...
int func_231(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
bool func_233(int iParam0, var uParam1, float fParam2, bool bParam3)
{
	struct<8> Var0;
	struct<8> Var1;
	...
	func_239(&Var0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam1->f_2, 0f, 2.75f, vLocal_56.z) + Vector(1f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam1->f_2, 0f, -2.75f, vLocal_56.z) - Vector(1f, 0f, 0f), 3f);
	if (bParam3)
	{
...
struct<8> func_234(struct<8> Param0, float fParam1)
{
	struct<8> Var0;
	vector3 vVar1;
...
void func_236(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	func_237(*(uParam0[0 /*3*/]), *(uParam0[1 /*3*/]), uParam0->f_7, iParam1, iParam2, iParam3, iParam4);
}

void func_237(vector3 vParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
Vector3 func_238(vector3 vParam0, vector3 vParam1)
{
	return ((vParam0.y * vParam1.z) - (vParam0.z * vParam1.y)), ((vParam0.z * vParam1.x) - (vParam0.x * vParam1.z)), ((vParam0.x * vParam1.y) - (vParam0.y * vParam1.x));
}

void func_239(var uParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	*(uParam0[0 /*3*/]) = { vParam1 };
	*(uParam0[1 /*3*/]) = { vParam2 };
	uParam0->f_7 = fParam3;
...
void func_242(var uParam0)
{
	...
	if (func_297(func_52()) && func_297(uParam0->f_2))
	{
		...
		ENTITY::ATTACH_ENTITY_TO_ENTITY(func_52(), uParam0->f_2, 0, vVar0, 0f, 0f, -90f, 0, 0, 0, 0, 2, 1);
	}
}
...
void func_243(var uParam0)
{
	...
	if (func_297(func_88()) && func_297(uParam0->f_2))
	{
		...
		vVar0.y = (vVar0.y + 0.5f);
		ENTITY::ATTACH_ENTITY_TO_ENTITY(func_88(), uParam0->f_2, 0, vVar0, 0f, 0f, -90f, 0, 0, 0, 0, 2, 1);
	}
}
...
void func_245(var uParam0, var uParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	vector3 vVar0;
	float fVar1;
...
void func_253(vector3 vParam0, vector3 vParam1, float fParam2)
{
	...
	if (iLocal_53)
	{
		...
		iLocal_52 = STREAMING::_0x1F3F018BC3AFA77C(vParam0, func_252(vParam1), fParam2, 12, 127);
		iLocal_53 = 0;
	}
	else if (STREAMING::_0x07C313F94746702C(iLocal_52))
	{
...
void func_254(var uParam0, float fParam1, float fParam2)
{
...
void func_255(var uParam0, vector3 vParam1, vector3 vParam2, int iParam3)
{
...
void func_256(var uParam0, vector3 vParam1, vector3 vParam2, int iParam3, int iParam4)
{
	func_257(uParam0);
...
void func_259(var uParam0)
{
	...
	Var1.f_28 = -1;
	Var1.f_29 = -1;
	if (func_233(PLAYER::PLAYER_PED_ID(), uParam0, 1.05f, 0))
	{
...
struct<35> func_260(var uParam0)
{
...
{
	if (PED::IS_PED_INJURED(func_88()))
	{
		return;
	}
	if (bParam1)
	{
		if (!PED::IS_PED_GROUP_MEMBER(func_88(), func_266()))
		{
			return;
		}
		if (!PED::IS_PED_INJURED(func_52()))
		{
			if (!PED::IS_PED_GROUP_MEMBER(func_52(), func_266()))
			{
				return;
			}
		}
...
int func_267(var uParam0)
{
	...
	bVar0 = func_233(PLAYER::PLAYER_PED_ID(), uParam0, 0, 0);
	if (bVar0)
	{
		uParam0->f_25 = (MISC::GET_GAME_TIMER() + iLocal_63);
		PAD::SET_INPUT_EXCLUSIVE(2, 51);
	...
	switch (uParam0->f_1)
	{
		...
		case 3:
			...
			if (func_268(0) || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
			{
				func_272();
				uParam0->f_1 = 0;
				return 0;
		...
		case 4:
			...
			if (func_246(uParam0) == 0)
			{
				MISC::SET_BIT(&Global_71226, 4);
			}
			else
			{
				MISC::SET_BIT(&Global_71226, 5);
			}
			HUD::CLEAR_HELP(1);
			return 1;
	}
...
bool func_275(int iParam0, var uParam1, float fParam2, bool bParam3)
{
	struct<8> Var0;
	struct<8> Var1;
	...
	func_239(&Var0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam1->f_2, 0f, 2.75f, (vLocal_56.z + 2.63f)) + Vector(1f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam1->f_2, 0f, -2.75f, (vLocal_56.z + 2.63f)) - Vector(1f, 0f, 0f), 3f);
	if (bParam3)
	{
		func_236(&Var0, 0, 0, 255, 255);
	}
...
float func_284(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_288(var uParam0, float fParam1, float fParam2, float fParam3)
{
...
int func_294(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4)
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
void func_298(bool bParam0)
{
	...
	if (PLAYER::GET_CAUSE_OF_MOST_RECENT_FORCE_CLEANUP() == 2)
	{
		if (func_4())
		{
			...
			func_37(PLAYER::PLAYER_PED_ID(), &Local_201);
			if (func_301(PLAYER::PLAYER_PED_ID(), vLocal_54, 1) < 200f)
			{
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vLocal_54, 1, false, 0, 1);
			}
			else if (func_301(PLAYER::PLAYER_PED_ID(), vLocal_55, 1) < 200f)
			{
