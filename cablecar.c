...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!func_297(PLAYER::PLAYER_PED_ID()) || Global_25236 == 1)
		{
			func_302(1, 1, 1, 1);
			Global_25238 = 0;
...
void func_40(var uParam0, bool bParam1)
{
	...
	if (bParam1 && (uParam0->f_11 == 1 || uParam0->f_34 == 1))
	{
		...
		func_27();
		SYSTEM::WAIT(0);
		func_97(ENTITY::GET_ENTITY_COORDS(uParam0->f_2, 1), 50f, 13, 5000, 1, 1);
		func_37(PLAYER::PLAYER_PED_ID(), uParam0);
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(uParam0->f_2, 1) + Vector(0f, 0f, 6f), 1, false, 0, 1);
		if (func_297(uParam0->f_2))
		{
			AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "Arrive_Station", uParam0->f_2, "CABLE_CAR_SOUNDS", 0, 0);
			AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "DOOR_OPEN", uParam0->f_2, "CABLE_CAR_SOUNDS", 0, 0);
	...
	if (uParam0->f_11 == 1 || uParam0->f_34 == 1)
	{
		...
		MISC::CLEAR_BIT(&Global_71104, 4);
		MISC::CLEAR_BIT(&Global_71104, 5);
		if (uParam0->f_24 == 0)
		{
...
void func_58(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_104555.f_20534.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_60() /*12130*/].f_7676.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_104555.f_20534.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_60() /*12130*/].f_7676.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_62(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_60() /*12130*/].f_7676.f_10, iParam0);
}
...
void func_91()
{
	...
	{
		if (func_87(Global_104555.f_2353.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_103(var uParam0)
{
	...
	vVar0 = { vLocal_56 };
	ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(uParam0->f_2, 1), 1, false, 0, 1);
...
void func_104(var uParam0)
{
	...
	vVar0 = { vLocal_56 };
	vVar0.x = 1f;
	ENTITY::SET_ENTITY_COORDS(func_52(), ENTITY::GET_ENTITY_COORDS(uParam0->f_2, 1), 1, false, 0, 1);
...
void func_105(var uParam0)
{
	...
	vVar0 = { vLocal_56 };
	vVar0.x = -1f;
	ENTITY::SET_ENTITY_COORDS(func_88(), ENTITY::GET_ENTITY_COORDS(uParam0->f_2, 1), 1, false, 0, 1);
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_70671[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_119(iVar0), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_119(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_119(iVar0), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, iParam4);
						}
						func_151(iVar0);
						if (Global_70669 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_119(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_119(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_119(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, iParam4);
		}
		if (Global_70669 == 1)
		{
			iVar2 = 0;
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_162(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
		...
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_162(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_223(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_70671[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_119(iParam1)) && Global_70671[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_119(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_225(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_229(PLAYER::PLAYER_ID())) && !func_227(PLAYER::PLAYER_ID(), 0)) && !func_226())
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_229(PLAYER::PLAYER_ID()))
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_70854 = 0;
...
int func_267(var uParam0)
{
	...
	switch (uParam0->f_1)
	{
		...
		case 4:
			...
			if (func_246(uParam0) == 0)
			{
				MISC::SET_BIT(&Global_71104, 4);
			}
			else
			{
				MISC::SET_BIT(&Global_71104, 5);
			}
			HUD::CLEAR_HELP(1);
			return 1;
	}
