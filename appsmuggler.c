...
void __EntryFunction__()
{
	...
	sLocal_216 = "";
	iLocal_220 = 8;
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_KEY("appSmuggler")) > 1)
	{
		func_358(0, 1);
	}
	func_348();
	...
	{
		func_346();
		if (!IS_BIT_SET(uLocal_188, 5) && func_345())
		{
			func_343();
			func_324();
		}
		if (!IS_BIT_SET(uLocal_188, 8) && IS_BIT_SET(uLocal_188, 5))
		{
			func_318();
		}
		func_311();
		...
		{
			if (!Global_1671295.f_2481 && IS_SCREEN_FADED_OUT())
			{
				func_1();
				Global_1671156 = 1;
				func_358(0, 1);
...
void func_6()
{
	...
	{
		if (IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_936))
		{
			iVar0 = GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_936);
			switch (iVar0)
			{
				case 0:
					func_237();
				...
				case 35:
					if (iLocal_218 != 0)
					{
						PLAY_SOUND_FRONTEND(-1, "Show_Overview_Menu", "GTAO_SMG_Hangar_Computer_Sounds", 1);
					}
					iLocal_218 = 0;
					break;
				...
				case 36:
					if (iLocal_218 != 1)
					{
						PLAY_SOUND_FRONTEND(-1, "Show_Source_Menu", "GTAO_SMG_Hangar_Computer_Sounds", 1);
					}
					iLocal_218 = 1;
					break;
				...
				case 37:
					if (iLocal_218 != 2)
					{
						PLAY_SOUND_FRONTEND(-1, "Show_Sell_Menu", "GTAO_SMG_Hangar_Computer_Sounds", 1);
					}
					iLocal_218 = 2;
					break;
				...
				case 29:
					...
					{
						iLocal_218 = 2;
						_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_935, "SHOW_SCREEN", 2f, -1082130432, -1082130432, -1082130432, -1082130432);
					}
					break;
...
int func_12(int iParam0)
{
	...
	if (!func_164(PLAYER_ID(), iParam0, 0))
	{
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5)
{
	switch (iParam0)
	{
		...
		case 229:
		case 230:
			return func_87(iParam1, iParam2, iParam3, INT_TO_PLAYERINDEX(uParam5), iParam4);
		
		case 233:
			return func_80(iParam1, iParam2, iParam3, INT_TO_PLAYERINDEX(uParam5), iParam4);
		...
		case 243:
			return func_63(iParam1, iParam2, INT_TO_PLAYERINDEX(uParam5), iParam4);
...
int func_108(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5)
{
	switch (iParam0)
	{
		case 148:
		...
		case 229:
		case 230:
			return func_127(iParam1, iParam3, iParam4, INT_TO_PLAYERINDEX(uParam5), 0, 0, 0);
		
		case 233:
			return func_118(iParam1, iParam3, iParam4, INT_TO_PLAYERINDEX(uParam5), 0, 0, 0);
			return 6;
		...
		case 243:
			return func_109(iParam1, iParam3, INT_TO_PLAYERINDEX(uParam5), 0, -1, 0, 0);
...
{
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_935, "SHOW_OVERLAY");
	func_169(sParam0);
	...
	if (bParam5)
	{
		PLAY_SOUND_FRONTEND(-1, "Click_Link", "GTAO_SMG_Hangar_Computer_Sounds", 1);
	}
	else if (bParam4)
	{
		PLAY_SOUND_FRONTEND(-1, "Click_Fail", "GTAO_SMG_Hangar_Computer_Sounds", 1);
	}
...
int func_175(int iParam0, int iParam1)
{
	...
	fVar1 = (TO_FLOAT(func_177(iParam0, iParam1)) * fVar0);
	return ROUND(fVar1);
}
...
float func_176(int iParam0, int iParam1)
{
	...
	uVar2 = FLOOR((TO_FLOAT(iParam1) / fVar1));
...
bool func_181()
{
	return IS_BIT_SET(uLocal_188, 10);
}
...
void func_189()
{
	switch (func_235())
	{
		case 2:
			...
			{
				func_213();
				PLAY_SOUND_FRONTEND(-1, "Click_Special", "GTAO_SMG_Hangar_Computer_Sounds", 1);
				func_194(229, 0);
			}
			else
			{
...
int func_223()
{
	...
	if (!bVar0)
	{
		if (!unk_0xE46667979780116E(func_126()) || unk_0x64BE694244417BDA())
		{
...
void func_236()
{
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_935, "HIDE_OVERLAY");
	END_SCALEFORM_MOVIE_METHOD();
	func_168(0);
...
void func_238()
{
	if (func_239())
	{
		if (!IS_BIT_SET(uLocal_188, 0))
		{
			BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_935, "GET_CURRENT_SELECTION");
			uLocal_936 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
...
void func_242()
{
	if (func_182())
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_935, "UPDATE_SELL_COOLDOWN");
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(func_244(Global_2507108.f_26, Global_2507108.f_28));
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(func_243(Global_2507108.f_28));
		END_SCALEFORM_MOVIE_METHOD();
	}
	else
	{
...
int func_244(var uParam0, var uParam1, int iParam2)
{
	...
	iVar0 = (iParam2 - ABSI(GET_TIME_DIFFERENCE(GET_NETWORK_TIME(), uParam0)));
	iVar0 = (iVar0 / 1000);
	return iVar0;
}
...
void func_245()
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_935, "UPDATE_STEAL_COOLDOWN");
	iVar0 = 1;
	while (iVar0 <= 8)
	{
		...
		if (func_165(iVar1))
		{
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(func_244(Global_2507108[iVar2 /*2*/], Global_2507108.f_17[iVar2]));
		}
		else
		{
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(0);
...
void func_246(int iParam0)
{
	...
	iVar3 = ROUND((func_176(func_180(iParam0), iVar0) * 100f));
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_935, "ADD_CARGO");
...
void func_247()
{
	...
	fVar9 = func_251(uVar2, func_252());
	fVar10 = func_251(uVar3, func_250());
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_935, "SET_STATS");
	...
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_192);
...
{
	return ((TO_FLOAT(uParam0) / TO_FLOAT(uParam1)) * 100f);
}
...
char* func_258(int iParam0)
{
	...
	if (((func_14(iParam0, 28) || func_14(PLAYER_ID(), 28)) || func_261(iParam0)) && !func_259(iParam0))
	{
...
void func_281()
{
	...
	if (((NETWORK_IS_PLAYER_ACTIVE(iVar0) && func_187(iVar0)) && !func_289(iVar0, 0)) && !func_288())
	{
		if (!func_287())
		{
	...
	if (IS_BIT_SET(uLocal_193, iLocal_189))
	{
...
void func_282()
{
	...
	if (iVar1 != -1 && iVar1 < 31)
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_935, "REMOVE_ACTIVE_ORGANISATION");
		_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING_2(&(Local_438[iVar1 /*16*/]));
		END_SCALEFORM_MOVIE_METHOD();
		StringCopy(&(Local_438[iVar1 /*16*/]), "", 64);
		CLEAR_BIT(&uLocal_193, iLocal_189);
		func_283(INT_TO_PLAYERINDEX(iLocal_189));
	}
}
...
void func_284(int iParam0, int iParam1)
{
	...
	if (func_15(iParam0))
	{
		...
		while (iVar2 < iVar3)
		{
			...
			if (iVar117 != func_16())
			{
				StringCopy(&(Var4[iVar2 /*16*/]), GET_PLAYER_NAME(iVar117), 64);
			}
			else
			{
		...
		while (iVar2 < iVar3)
		{
			if (IS_STRING_NULL_OR_EMPTY(&(Var4[iVar2 /*16*/])))
			{
				if (iVar2 != iVar3)
				{
					...
					{
						if (!IS_STRING_NULL_OR_EMPTY(&(Var4[iVar118 /*16*/])))
						{
		...
		BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_935, "ADD_ACTIVE_ORGANISATION");
		_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING_2(func_286(iParam0));
		_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING_2(sVar1);
		iVar2 = 0;
		while (iVar2 < iVar3)
		{
			_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING_2(&(Var4[iVar2 /*16*/]));
			iVar2++;
		}
		END_SCALEFORM_MOVIE_METHOD();
		sVar1 = func_286(iParam0);
		func_285(iParam0, func_31(iParam0));
		SET_BIT(&uLocal_193, iParam1);
	}
	else
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_935, "ADD_ACTIVE_ORGANISATION");
...
int func_288()
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (!func_15(INT_TO_PLAYERINDEX(iLocal_189)))
			{
				return 1;
			}
			else
			{
				return iLocal_194[iVar0] != func_31(INT_TO_PLAYERINDEX(iLocal_189));
			}
		}
		iVar0++;
	}
...
void func_290()
{
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_935, "SET_INPUT_EVENT", TO_FLOAT(205), -1082130432, -1082130432, -1082130432, -1082130432);
		if (iLocal_218 == 1)
		{
			iLocal_218 = 0;
			PLAY_SOUND_FRONTEND(-1, "Show_Overview_Menu", "GTAO_SMG_Hangar_Computer_Sounds", 1);
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_935, "SET_INPUT_EVENT", TO_FLOAT(206), -1082130432, -1082130432, -1082130432, -1082130432);
		if (iLocal_218 == 0)
		{
			iLocal_218 = 1;
			PLAY_SOUND_FRONTEND(-1, "Show_Source_Menu", "GTAO_SMG_Hangar_Computer_Sounds", 1);
	...
	if (_IS_INPUT_JUST_DISABLED(2))
	{
		...
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_935, "SET_INPUT_EVENT", TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_293(2, 187, 1);
		if (IS_CONTROL_JUST_PRESSED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_935, "SET_INPUT_EVENT", TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (IS_CONTROL_JUST_RELEASED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_935, "SET_INPUT_RELEASE_EVENT", TO_FLOAT(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (IS_CONTROL_JUST_RELEASED(2, 188))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_935, "SET_INPUT_RELEASE_EVENT", TO_FLOAT(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (IS_CONTROL_JUST_PRESSED(2, 188))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_935, "SET_INPUT_EVENT", TO_FLOAT(188), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_293(2, 187, 1);
		if (IS_CONTROL_JUST_PRESSED(2, 187))
		{
			_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_935, "SET_INPUT_EVENT", TO_FLOAT(187), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	func_293(2, 189, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 189))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_935, "SET_INPUT_EVENT", TO_FLOAT(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_293(2, 190, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 190))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_935, "SET_INPUT_EVENT", TO_FLOAT(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_293(2, 201, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 201))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_935, "SET_INPUT_EVENT", TO_FLOAT(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_293(2, 202, 1);
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_935, "SET_INPUT_EVENT", TO_FLOAT(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_293(2, 204, 1);
	if (IS_CONTROL_JUST_PRESSED(2, 204))
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_935, "SET_INPUT_EVENT", TO_FLOAT(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (_IS_INPUT_JUST_DISABLED(2))
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_935, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		{
			BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_935, "SET_ANALOG_STICK_INPUT");
			iLocal_937 = iVar0;
			iLocal_938 = iVar1;
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(1);
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_937);
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_938);
			END_SCALEFORM_MOVIE_METHOD();
		}
	}
	func_293(2, 197, 1);
	...
	if (((iVar2 != 127 || iLocal_939 != 127) || iVar3 != 127) || iLocal_940 != 127)
	{
		...
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_939);
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_940);
...
void func_291()
{
	...
	{
		iLocal_218 = 0;
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_935, "SHOW_SCREEN", 0f, -1082130432, -1082130432, -1082130432, -1082130432);
		PLAY_SOUND_FRONTEND(-1, "Show_Overview_Menu", "GTAO_SMG_Hangar_Computer_Sounds", 1);
		return;
	}
	if (func_292())
	...
	{
		_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(uLocal_935, "SET_INPUT_EVENT", TO_FLOAT(202), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	PLAY_SOUND_FRONTEND(-1, "Click_Back", "GTAO_SMG_Hangar_Computer_Sounds", 1);
}
...
void func_295()
{
	...
	SET_SCRIPT_GFX_DRAW_ORDER(1);
	DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_935, 255, 255, 255, 255, 0);
	func_305();
	func_299(0);
	func_296(1);
}
	...
	if (!IS_BIT_SET(uLocal_188, 9))
	{
		if (!func_292())
		{
			if (!func_345())
			{
				...
				if ((!func_316(2) && !IS_BIT_SET(Global_1671151, 2)) && IS_BIT_SET(uLocal_188, 13))
				{
					func_315("HAPP_HELP_3", 14000);
					SET_BIT(&Global_1671151, 2);
					func_312(2);
				}
			}
			else
...
void func_318()
{
	...
	iVar5 = 8 + 1;
	if (!IS_BIT_SET(uLocal_188, 7) && !func_323())
	{
		iVar4 = 0;
		while (iVar4 < iVar5)
		{
	...
	if (!IS_BIT_SET(uLocal_188, 7) && !IS_STRING_NULL_OR_EMPTY(&Var0))
	{
		func_315(&Var0, iLocal_191);
		SET_BIT(&uLocal_188, 7);
	}
	else if (IS_BIT_SET(uLocal_188, 7))
	{
...
int func_322(int iParam0)
{
	...
	uVar0 = iParam0;
	if (!IS_BIT_SET(uLocal_188, 9) && iParam0 != 2)
	{
		return 0;
	}
	switch (iParam0)
	{
		case 0:
			if ((!func_316(iParam0) && !IS_BIT_SET(Global_1671151, uVar0)) && IS_BIT_SET(uLocal_188, 11))
			{
				return 1;
			}
			break;
		...
		case 1:
			if ((!func_316(iParam0) && !IS_BIT_SET(Global_1671151, uVar0)) && IS_BIT_SET(uLocal_188, 12))
			{
				return 1;
			}
			break;
		...
		case 2:
			if ((!func_316(iParam0) && !IS_BIT_SET(Global_1671151, uVar0)) && IS_BIT_SET(uLocal_188, 13))
			{
				return 1;
			}
			break;
		...
		case 3:
			if (((!func_316(iParam0) && !IS_BIT_SET(Global_1671151, uVar0)) && IS_BIT_SET(uLocal_188, 9)) && iLocal_218 == 0)
			{
				return 1;
			}
			break;
		...
		case 4:
			if ((!func_316(iParam0) && !IS_BIT_SET(Global_1671151, uVar0)) && iLocal_218 == 1)
			{
				return 1;
			}
			break;
		...
		case 5:
			if (((!func_316(iParam0) && !IS_BIT_SET(Global_1671151, uVar0)) && iLocal_218 == 1) && (IS_BIT_SET(Global_1671151, 4) || func_316(4)))
			{
				return 1;
			}
			break;
		...
		case 6:
			if ((!func_316(iParam0) && !IS_BIT_SET(Global_1671151, uVar0)) && iLocal_218 == 2)
			{
				return 1;
			}
			break;
		...
		case 7:
			if (((!func_316(iParam0) && !IS_BIT_SET(Global_1671151, uVar0)) && iLocal_218 == 2) && (IS_BIT_SET(Global_1671151, 6) || func_316(6)))
			{
				return 1;
			}
			break;
		...
		case 8:
			if (((((!func_316(iParam0) && !IS_BIT_SET(Global_1671151, uVar0)) && IS_BIT_SET(uLocal_188, 14)) && iLocal_218 == 2) && (IS_BIT_SET(Global_1671151, 6) || func_316(6))) && (IS_BIT_SET(Global_1671151, 7) || func_316(7)))
			{
				return 1;
			}
			break;
...
void func_333()
{
	...
	{
		if (func_336(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
			iVar0 = func_335(PLAYER_PED_ID());
...
void func_343()
{
	...
	if (!IS_BIT_SET(uLocal_188, 4) && !func_323())
	{
		if (iLocal_218 == 0)
		{
	...
	else if (IS_BIT_SET(uLocal_188, 4))
	{
...
{
	func_346();
	uLocal_935 = REQUEST_SCALEFORM_MOVIE("HANGAR_CARGO");
	while (!HAS_SCALEFORM_MOVIE_LOADED(uLocal_935))
	{
		WAIT(0);
	}
	func_300(1);
...
{
	SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_935);
	func_354(iParam0);
	func_356(0);
	func_359();
	...
	if (bParam1)
	{
		PLAY_SOUND_FRONTEND(-1, "Exit", "GTAO_SMG_Hangar_Computer_Sounds", 1);
	}
	if (IS_PC_VERSION())
	{
		func_349(0, 1, 1, 1);
