...
void __EntryFunction__()//Position - 0x0
{
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_265, 2761840924);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, 2761840924, iLocal_265);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_264, 2761840924);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, 2761840924, iLocal_264);
	while (true)
	{
		RECORDING::_0x208784099002BC30("M_FINPRB", 0);
		if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			PED::SET_PED_CONFIG_FLAG(AUDIO::_0x0626A247D2405330(), 230, false);
		}
		func_200();
		if (iLocal_272 == 0)
		{
...
void func_6(int iParam0)//Position - 0x361
{
	...
	if (Global_19E56.f_2361 || func_202(0))
	{
		iVar0 = func_13();
		if (!func_7(iVar0))
		{
...
int func_7(int iParam0)//Position - 0x3A6
{
	...
	func_8(&(Global_19E56.f_933.f_21B), iVar1);
...
void func_8(var uParam0, int iParam1)//Position - 0x4BD
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_10(Global_19E56.f_4849[iVar0], &vVar2, &fVar3))
			{
...
void func_20()//Position - 0x12F4
{
	...
	if (iLocal_53 == 0)
	{
		...
		if (CAM::IS_SCREEN_FADED_OUT())
		{
			...
			func_27(iLocal_33, 4294967295, 1);
		}
	...
	if (iLocal_53 == 1)
	{
		...
		{
			if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_33, 0))
			{
				if (func_14() == 0)
				{
					if (func_33(iLocal_39, 0))
					{
						...
						{
							NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_39);
							PED::REMOVE_PED_FROM_GROUP(iLocal_39);
							ENTITY::SET_ENTITY_HEALTH(iLocal_39, true);
					...
					if (func_33(iLocal_38, 0))
					{
						...
						{
							NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_38);
							PED::REMOVE_PED_FROM_GROUP(iLocal_38);
							ENTITY::SET_ENTITY_HEALTH(iLocal_38, true);
				...
				if (func_14() == 2)
				{
					if (func_33(iLocal_37, 0))
					{
						...
						{
							NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_37);
							PED::REMOVE_PED_FROM_GROUP(iLocal_37);
							ENTITY::SET_ENTITY_HEALTH(iLocal_37, true);
				...
				if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_33, 0))
				{
					BRAIN::TASK_LEAVE_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_33, 0);
				}
			}
		}
		SYSTEM::SETTIMERB(0);
	...
	if (iLocal_53 == 2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_33))
		{
			if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_33, 0))
			{
				...
				else if (!PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_33, 1))
				{
	...
	if (iLocal_53 == 3)
	{
		...
		{
			if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_32, 0))
			{
...
void func_22(bool bParam0, int iParam1)//Position - 0x1793
{
	...
	if (bParam0)
	{
		if ((func_202(0) && Global_1171B.f_1 == 1) && func_23(Global_1171B))
		{
		}
		else
		{
...
int func_25(int iParam0)//Position - 0x18FF
{
	...
	return Global_162B5[func_26(iParam0)];
}
...
void func_35()//Position - 0x1C11
{
	...
	{
		case 2:
			ENTITY::SET_ENTITY_COORDS(AUDIO::_0x0626A247D2405330(), 856.9501f, -1573.177f, 29.4751f, 1, false, 0, 1);
			ENTITY::SET_ENTITY_HEADING(AUDIO::_0x0626A247D2405330(), 288.3586f);
			break;
		...
		case 4:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_33))
			{
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_33, 0))
				{
					if (!PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_33, 0))
					{
						PED::SET_PED_INTO_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_33, 4294967295);
					}
				}
			}
			break;
...
void func_36()//Position - 0x1CEE
{
	switch (iLocal_28)
	{
		case 3:
			...
			GRAPHICS::_0x54E22EA2C1956A8D(0.01f);
			break;
...
{
	return func_38(&(Global_17998.f_B3B), vParam0, fParam1, 0);
}
...
int func_51()//Position - 0x4B6D
{
	return 0;
}

int func_52()//Position - 0x4B76
{
	return 1;
}

int func_53()//Position - 0x4B7F
{
	return 1;
}

int func_54()//Position - 0x4B88
{
...
int func_56(int iParam0)//Position - 0x4C5C
{
	int iVar0;
	char* sVar1;
...
int func_57(int iParam0)//Position - 0x4CA2
{
	int iVar0;
...
int func_58(int iParam0)//Position - 0x4CDD
{
	int iVar0;
...
int func_59(int iParam0)//Position - 0x4D59
{
	int iVar0;
...
int func_60(int iParam0)//Position - 0x4E41
{
	int iVar0;
...
int func_61(int iParam0, int iParam1, bool bParam2)//Position - 0x4EA4
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_62(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x4F15
{
...
void func_63(int iParam0, bool bParam1)//Position - 0x4FED
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_64(int iParam0, int iParam1, bool bParam2)//Position - 0x504A
{
	if (iParam0 == 4294967295)
	{
		return;
...
bool func_65(int iParam0, int iParam1)//Position - 0x5085
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
void func_66(int iParam0)//Position - 0x50A8
{
	bool bVar0;
...
void func_67(var uParam0, var uParam1)//Position - 0x521A
{
...
int func_68(int iParam0, int iParam1)//Position - 0x52E6
{
	int iVar0;
...
int func_69(var uParam0)//Position - 0x5358
{
	return *uParam0;
}

int func_70(var uParam0, int iParam1)//Position - 0x5363
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam0->f_9, 10))
	{
		...
		if (!func_98(Global_19E56.f_7F5D.f_748[uParam0->f_E /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_98(Global_19E56.f_933.f_21B.f_DF0[1 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_98(Global_19E56.f_933.f_21B.f_DF0[0 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_71(int iParam0, int iParam1)//Position - 0x6A5A
{
	struct<82> Var0;
...
void func_72(int iParam0, var uParam1, int iParam2)//Position - 0x6A9C
{
	int iVar0;
...
int func_73(int iParam0)//Position - 0x6CF8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_74(int iParam0, vector3 vParam1, bool bParam2)//Position - 0x6DBB
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("CUBAN800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				...
				{
					if ((!bParam2 || func_98(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(iParam0, true), unk_0x8000C77B5F336760(uVar1[iVar3], true), true) < 10f)
					{
...
int func_75(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x6FC3
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_76(int iParam0, int iParam1, bool bParam2)//Position - 0x703E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_77(int iParam0, int iParam1)//Position - 0x709F
{
	int iVar0;
...
void func_78(int iParam0, int iParam1)//Position - 0x7121
{
	int iVar0;
...
void func_79(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x71BF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_80(int iParam0, var uParam1, var uParam2)//Position - 0x770D
{
	int iVar0;
	int iVar1;
...
int func_81(int iParam0)//Position - 0x78D0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_82(var uParam0)//Position - 0x79AC
{
...
int func_83(int iParam0, int iParam1)//Position - 0x79EC
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_84(int iParam0, int iParam1)//Position - 0x7AD1
{
	switch (iParam0)
	{
		case joaat("FACTION2"):
...
void func_85(int iParam0, int iParam1)//Position - 0x7E47
{
	int iVar0;
	int iVar1;
...
bool func_86()//Position - 0x7EAC
{
	return DLC::IS_DLC_PRESENT(2603778600);
}

int func_87(int iParam0)//Position - 0x7EBD
{
	int iVar0;
...
int func_88(int iParam0)//Position - 0x7F08
{
...
int func_90(int iParam0)//Position - 0x7FBE
{
...
int func_91(int iParam0)//Position - 0x7FDB
{
...
int func_92(int iParam0, int iParam1)//Position - 0x7FFE
{
...
int func_93(int iParam0)//Position - 0x803B
{
	if (func_92(iParam0, 0))
	{
...
int func_94(int iParam0, int iParam1)//Position - 0x805E
{
	int iVar0;
...
int func_95(int iParam0, bool bParam1, bool bParam2)//Position - 0x80AB
{
	int iVar0;
...
void func_96(vector3 vParam0, float fParam1, bool bParam2)//Position - 0x80F5
{
	int iVar0;
...
int func_97(var uParam0)//Position - 0x8145
{
	if (func_99(uParam0))
	{
...
bool func_98(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x817A
{
	if (bParam2)
	{
...
int func_99(var uParam0)//Position - 0x81C1
{
...
bool func_100()//Position - 0x8220
{
	return func_97(&(Global_17998.f_B3B));
}

void func_101()//Position - 0x8233
{
	func_102(&(Global_17998.f_B3B));
}

void func_102(var uParam0)//Position - 0x8246
{
	if (func_99(uParam0))
	{
...
int func_103(vector3 vParam0, int iParam1)//Position - 0x8264
{
	return func_104(Global_17998.f_B3B.f_C.f_42, vParam0, iParam1);
}

int func_104(int iParam0, vector3 vParam1, int iParam2)//Position - 0x8281
{
	vector3 vVar0;
	vector3 vVar1;
...
Vector3 func_105()//Position - 0x82EB
{
	return 2.55f, 5.665f, 2.55f;
}

int func_106()//Position - 0x8302
{
	return func_99(&(Global_17998.f_B3B));
}

void func_107()//Position - 0x8315
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_15EE0.f_9[0]))
		{
			...
			iLocal_35[0] = Global_15EE0.f_9[0];
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_35[0], iLocal_264);
			func_108(iLocal_35[0], 30f, 1084227584, 1123024896, 3266576384, 1119092736);
			ENTITY::SET_ENTITY_HEALTH(iLocal_35[0], true);
		}
		else
		{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_35[1]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_15EE0.f_9[1]))
		{
			...
			iLocal_35[1] = Global_15EE0.f_9[1];
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_35[1], iLocal_264);
			func_108(iLocal_35[1], 30f, 1084227584, 1123024896, 3266576384, 1119092736);
			ENTITY::SET_ENTITY_HEALTH(iLocal_35[1], true);
		}
		else
		{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_35[2]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_15EE0.f_9[2]))
		{
			...
			iLocal_35[2] = Global_15EE0.f_9[2];
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_35[2], iLocal_264);
			func_108(iLocal_35[2], 30f, 1084227584, 1123024896, 3266576384, 1119092736);
			ENTITY::SET_ENTITY_HEALTH(iLocal_35[2], true);
		}
		else
		{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_35[3]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_15EE0.f_9[3]))
		{
			...
			iLocal_35[3] = Global_15EE0.f_9[3];
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_35[3], iLocal_264);
			func_108(iLocal_35[3], 30f, 1084227584, 1123024896, 3266576384, 1119092736);
			ENTITY::SET_ENTITY_HEALTH(iLocal_35[3], true);
		}
		else
		{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_35[4]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_15EE0.f_9[4]))
		{
			...
			iLocal_35[4] = Global_15EE0.f_9[4];
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_35[4], iLocal_264);
			func_108(iLocal_35[4], 30f, 1084227584, 1123024896, 3266576384, 1119092736);
			ENTITY::SET_ENTITY_HEALTH(iLocal_35[4], true);
		}
		else
		{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_35[5]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_15EE0.f_9[5]))
		{
			...
			iLocal_35[5] = Global_15EE0.f_9[5];
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_35[5], iLocal_264);
			func_108(iLocal_35[5], 30f, 1084227584, 1123024896, 3266576384, 1119092736);
			ENTITY::SET_ENTITY_HEALTH(iLocal_35[5], true);
		}
		else
		{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_15EE0.f_9[6]))
		{
			...
			iLocal_36[0] = Global_15EE0.f_9[6];
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_36[0], iLocal_265);
			func_108(iLocal_36[0], 40f, 1084227584, 1123024896, 3266576384, 1119092736);
			ENTITY::SET_ENTITY_HEALTH(iLocal_36[0], true);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_36[1]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_15EE0.f_9[7]))
		{
			...
			iLocal_36[1] = Global_15EE0.f_9[7];
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_36[1], iLocal_265);
			func_108(iLocal_36[1], 40f, 1084227584, 1123024896, 3266576384, 1119092736);
			ENTITY::SET_ENTITY_HEALTH(iLocal_36[1], true);
...
void func_108(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5)//Position - 0x8E03
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
void func_109(int iParam0, int iParam1)//Position - 0x8E3F
{
	Global_DB80 = iParam0;
	Global_DB81 = iParam1;
}

void func_110(int iParam0, int iParam1)//Position - 0x8E51
{
	int iVar0;
...
void func_111()//Position - 0x8EBC
{
	...
	if (!func_30())
	{
		ENTITY::SET_ENTITY_COORDS(AUDIO::_0x0626A247D2405330(), 519.1906f, -2980.994f, 5.0443f, 1, false, 0, 1);
		ENTITY::SET_ENTITY_HEADING(AUDIO::_0x0626A247D2405330(), 270.1911f);
	}
	...
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_15EE0[3], true, 0);
		VEHICLE::DELETE_VEHICLE(&(Global_15EE0[3]));
	}
...
void func_113()//Position - 0x90D8
{
	Global_3960 = 0;
	func_114();
}

void func_114()//Position - 0x90E8
{
...
void func_115()//Position - 0x913F
{
	...
	if (iLocal_53 == 1)
	{
		...
		if (func_14() == 0)
		{
			func_132(&uLocal_99, 0, AUDIO::_0x0626A247D2405330(), "MICHAEL", 0, 1);
		}
		if (func_14() == 1)
		{
			func_132(&uLocal_99, 1, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
		}
		if (func_14() == 2)
		{
			func_132(&uLocal_99, 2, AUDIO::_0x0626A247D2405330(), "TREVOR", 0, 1);
		}
		iLocal_53 = 2;
	}
	if (iLocal_53 == 2)
		...
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) == 0)
		{
			if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_33, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_33, 0))
				{
					...
					{
						if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_92, 4f, 4f, 2f, true, true, 2))
						{
							if (func_117(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 4f, 3, 0.5f, 0, 1, 0))
							{
								AUDIO::TRIGGER_MUSIC_EVENT("FHPRB_STOP");
								if (HUD::DOES_BLIP_EXIST(iLocal_50))
								{
...
void func_116(bool bParam0, int iParam1)//Position - 0x937D
{
	int iVar0;
...
int func_117(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x9417
{
...
void func_118(int iParam0)//Position - 0x95A6
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
int func_119(vector3 vParam0, bool bParam1)//Position - 0x95D2
{
	int iVar0;
...
float func_120(bool bParam0, float fParam1, float fParam2)//Position - 0x95FE
{
	if (bParam0)
	{
		return fParam1;
...
bool func_122(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x962C
{
...
int func_123(char* sParam0, int iParam1, bool bParam2)//Position - 0x968B
{
	Global_3DCF = 0;
...
bool func_130(int iParam0, int iParam1)//Position - 0x9BD6
{
	switch (iParam0)
	{
		case 5:
...
void func_131(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x9C11
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
void func_132(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x9C67
{
...
void func_133()//Position - 0x9D02
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_33, 0))
	{
			...
			if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TRAILER(iLocal_33))
			{
				...
				if (iLocal_28 == 4)
				{
					...
					else
					{
						...
						{
							HUD::CLEAR_PRINTS();
							func_137("GOD_4", 7500, 4294967295);
			...
			else
			{
				...
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_32, 0))
				{
					if (!HUD::DOES_BLIP_EXIST(iLocal_52))
					{
						...
						if (iLocal_294 == 0)
						{
							func_137("GOD_6", 7500, 4294967295);
		...
		else
		{
			...
			{
				HUD::CLEAR_PRINTS();
				func_137("GOD_5", 7500, 4294967295);
				iLocal_270 = 1;
			}
		}
	}
...
void func_134(char* sParam0)//Position - 0x9F17
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 1, true, 4294967295);
}

int func_135(int iParam0, bool bParam1, bool bParam2)//Position - 0x9F2D
{
	return func_136(iParam0, !bParam1, bParam2);
}

int func_136(int iParam0, bool bParam1, bool bParam2)//Position - 0x9F40
{
	int iVar0;
...
void func_137(char* sParam0, int iParam1, int iParam2)//Position - 0x9FE4
{
	iParam2 = iParam2;
...
int func_138(char* sParam0)//Position - 0x9FFD
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_139()//Position - 0xA010
{
	if (iLocal_53 > 1)
	{
		func_133();
	...
	if (iLocal_53 == 0)
	{
		...
		if (CAM::IS_SCREEN_FADED_OUT())
		{
			...
			{
				func_27(iLocal_34, 4294967295, 1);
				ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_34);
			}
			else
			{
				func_27(0, 4294967295, 1);
			}
		}
		if (!CAM::IS_SCREEN_FADED_IN())
		{
				...
				if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TRAILER(iLocal_33))
				{
					...
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_93, vLocal_96, true) < 100f)
					{
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) == 0)
						{
							...
							{
								RECORDING::_0x293220DA1B46CEBC(5f, 8f, 4);
								func_137("GOD_7", 7500, 4294967295);
								iLocal_312 = 1;
							}
						}
...
void func_140(int iParam0, bool bParam1)//Position - 0xA4AC
{
	int iVar0;
...
void func_141()//Position - 0xA4F6
{
	if (iLocal_53 == 0)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Global_15EE0[3]))
		{
			...
			{
				if (VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(Global_15EE0[3])))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_15EE0[3], true, 1);
					func_143(1.0095f, -631.9655f, 34.7259f, 349.0681f, 0, 145);
				}
				if (((VEHICLE::IS_THIS_MODEL_A_CAR(ENTITY::GET_ENTITY_MODEL(Global_15EE0[3])) || VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(Global_15EE0[3]))) || VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(Global_15EE0[3]))) || VEHICLE::IS_THIS_MODEL_A_QUADBIKE(ENTITY::GET_ENTITY_MODEL(Global_15EE0[3])))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_15EE0[3], true, 1);
...
void func_142(int iParam0)//Position - 0xA623
{
...
void func_143(vector3 vParam0, float fParam1, int iParam2, int iParam3)//Position - 0xA647
{
	vector3 vVar0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_17998.f_4))
	{
		...
		{
			if (func_163(24) != Global_17998.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_160(unk_0x8000C77B5F336760(Global_17998.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_144(Global_17998.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}

void func_144(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)//Position - 0xA6C2
{
	struct<60> Var0;
...
void func_145(int iParam0, int iParam1, int iParam2)//Position - 0xA7EB
{
	int iVar0;
...
void func_147(var uParam0, int iParam1)//Position - 0xA94E
{
	if (iParam1 <= 0)
	{
		return;
...
void func_148(var uParam0, int iParam1)//Position - 0xA9D4
{
...
void func_149(var uParam0, int iParam1)//Position - 0xAA07
{
	int iVar0;
	int iVar1;
...
int func_150(int iParam0, int iParam1)//Position - 0xAA58
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_153(var uParam0)//Position - 0xAB36
{
	return uParam0 & 15;
}

void func_154(var uParam0, int iParam1)//Position - 0xAB43
{
...
void func_155(var uParam0, int iParam1)//Position - 0xAB7D
{
...
void func_156(var uParam0, int iParam1)//Position - 0xABB8
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
void func_157(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0xABF4
{
	if (func_70(&(Global_11188.f_22B[0 /*21*/]), iParam0))
	{
...
void func_158(int iParam0)//Position - 0xACF3
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_159(int iParam0)//Position - 0xAD6D
{
...
int func_160(vector3 vParam0, int iParam1, var uParam2, var uParam3)//Position - 0xAD94
{
	int iVar0;
...
int func_161(vector3 vParam0, int iParam1, int iParam2)//Position - 0xAEAA
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_162(int iParam0)//Position - 0xAF39
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_1C21[iParam0], 0);
}

int func_163(int iParam0)//Position - 0xAF51
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
void func_164()//Position - 0xAF6D
{
	Global_155D1 = 1;
}

void func_165()//Position - 0xAF7A
{
...
void func_167(vector3 vParam0, float fParam1, int iParam2, int iParam3)//Position - 0xB16B
{
	if (func_29())
	{
...
void func_169()//Position - 0xB219
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_40))
	{
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 45f, -616.2f, 30.8f, true) < 150f)
		{
			STREAMING::REQUEST_MODEL(joaat("s_m_m_security_01"));
		...
		if (!PED::IS_PED_INJURED(iLocal_40))
		{
			if (BRAIN::DOES_SCENARIO_EXIST_IN_AREA(65.2f, -617.2f, 30.8f, 5f, 0))
			{
				if (iLocal_337 == 0)
				{
					...
					{
						NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_40);
					}
					else
					{
			...
			if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_40, 1) < 20f)
			{
				if (iLocal_316 == 0)
				{
					BRAIN::TASK_LOOK_AT_ENTITY(iLocal_40, AUDIO::_0x0626A247D2405330(), 4294967295, 1072, 3);
					iLocal_316 = 1;
				}
			}
			else if (iLocal_316 == 1)
			{
				BRAIN::TASK_LOOK_AT_ENTITY(iLocal_40, AUDIO::_0x0626A247D2405330(), 1, 0, 2);
				iLocal_316 = 0;
			}
		}
	}
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 45f, -616.2f, 30.8f, true) < 50f)
	{
		if (iLocal_338 == 0)
		{
			iLocal_90 = 498972213;
			iLocal_91 = 3782042665;
			OBJECT::ADD_DOOR_TO_SYSTEM(iLocal_90, 3110450777, 61f, -633f, 32f, 1, 1, 0);
			OBJECT::ADD_DOOR_TO_SYSTEM(iLocal_91, 3110450777, 66f, -618f, 32f, 1, 1, 0);
			iLocal_338 = 1;
		}
		if (iLocal_338 == 1)
		{
		...
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 62.90151f, -638.6329f, 29.9188f, 70.78919f, -617.1338f, 36.91788f, 10.75f, 0, true, 0))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_40))
			{
				if (!PED::IS_PED_INJURED(iLocal_40))
...
bool func_170(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xB5ED
{
...
float func_171(int iParam0, int iParam1, bool bParam2)//Position - 0xB63B
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_172()//Position - 0xB699
{
	...
	if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
	{
		if (!func_176() || !HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
		{
			if (iLocal_28 == 3)
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0) && iLocal_31 == 0)
				{
					if (func_14() == 0)
					{
						if (iLocal_29 == 1)
...
int func_174()//Position - 0xBA37
{
	...
	while (iLocal_57 <= 6)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[iLocal_57]))
		{
			...
			{
				iVar0 = func_175(AUDIO::_0x0626A247D2405330(), iLocal_264, 0, 0, 4294967295);
				if (ENTITY::DOES_ENTITY_EXIST(iVar0))
				{
				...
				if (iVar0 == iLocal_35[iLocal_57] && func_171(AUDIO::_0x0626A247D2405330(), iVar0, 1) < 15f)
				{
...
int func_175(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xBAC9
{
	int iVar0[16];
	int iVar1;
...
void func_177()//Position - 0xBBF2
{
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if (WEAPON::IS_PED_CURRENT_WEAPON_SILENCED(AUDIO::_0x0626A247D2405330()) && PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
		{
	...
	if (iLocal_303[0])
	{
		if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[0], 1) < 20f && PED::_CAN_PED_SEE_PED(iLocal_36[0], AUDIO::_0x0626A247D2405330()))
		{
			if (iLocal_328[0] == 0)
			{
				BRAIN::TASK_LOOK_AT_ENTITY(iLocal_36[0], AUDIO::_0x0626A247D2405330(), 4294967295, 1072, 3);
				iLocal_328[0] = 1;
			}
			if (iLocal_328[0] == 1)
			{
		...
		{
			BRAIN::TASK_LOOK_AT_ENTITY(iLocal_36[0], AUDIO::_0x0626A247D2405330(), 1, 0, 2);
			iLocal_328[0] = 0;
		}
	}
	if (iLocal_303[1])
	{
		if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[1], 1) < 20f && PED::_CAN_PED_SEE_PED(iLocal_36[1], AUDIO::_0x0626A247D2405330()))
		{
			if (iLocal_328[1] == 0)
			{
				BRAIN::TASK_LOOK_AT_ENTITY(iLocal_36[1], AUDIO::_0x0626A247D2405330(), 4294967295, 1072, 3);
				iLocal_328[1] = 1;
			}
			if (iLocal_328[1] == 1)
			{
		...
		{
			BRAIN::TASK_LOOK_AT_ENTITY(iLocal_36[1], AUDIO::_0x0626A247D2405330(), 1, 0, 2);
			iLocal_328[1] = 0;
		}
	}
	if (iLocal_303[0] && iLocal_303[1])
	{
		if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[0], 1) < func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[1], 1))
		{
			iLocal_298 = 1;
			iLocal_299 = 0;
		}
	...
	switch (iLocal_31)
	{
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_36[0]))
						{
							if (!PED::IS_PED_BEING_STEALTH_KILLED(iLocal_36[0]))
							{
								...
								{
									if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(iLocal_36[0], true), 863.1551f, -1564.572f, 29.3231f, true) > 3f)
									{
										if (iLocal_340[0] == 0)
										{
											BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_36[0], 863.1551f, -1564.572f, 29.3231f, 1f, 4294967295, 1048576000, 0, 1193033728);
											iLocal_341[0] = 0;
											iLocal_340[0] = 1;
										}
									}
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[1]))
					{
						if (!PED::IS_PED_INJURED(iLocal_36[1]))
						{
							if (!PED::IS_PED_BEING_STEALTH_KILLED(iLocal_36[1]))
							{
								...
								{
									if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(iLocal_36[1], true), 940.2881f, -1573.877f, 29.3866f, true) > 3f)
									{
										if (iLocal_340[1] == 0)
										{
											BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_36[1], 940.2881f, -1573.877f, 29.3866f, 1f, 4294967295, 1048576000, 0, 1193033728);
											iLocal_341[1] = 0;
											iLocal_340[1] = 1;
										}
									}
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
			{
				if (!PED::IS_PED_INJURED(iLocal_36[0]))
				{
					if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[0], 1) < 20f)
					{
						if ((func_183(AUDIO::_0x0626A247D2405330()) == joaat("weapon_unarmed") || PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0)) || func_182(0))
						{
							if (PED::IS_PED_FACING_PED(AUDIO::_0x0626A247D2405330(), iLocal_36[0], 100f) || PED::_CAN_PED_SEE_PED(iLocal_36[0], AUDIO::_0x0626A247D2405330()))
							{
								if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 860.4606f, -1563.58f, 28.81788f, 865.0807f, -1575.088f, 30.93324f, 5.75f, 0, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 855.4593f, -1548.228f, 28.27722f, 863.1765f, -1563.288f, 33.31375f, 4.75f, 0, true, 0))
								{
									if (iLocal_334[0] == 0)
									{
										if (!PED::IS_PED_FACING_PED(iLocal_36[0], AUDIO::_0x0626A247D2405330(), 45f))
										{
											...
											{
												NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_36[0]);
											}
											BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_36[0], AUDIO::_0x0626A247D2405330(), 5000);
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[1]))
			{
				if (!PED::IS_PED_INJURED(iLocal_36[1]))
				{
					if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[1], 1) < 15f)
					{
						if ((func_183(AUDIO::_0x0626A247D2405330()) == joaat("weapon_unarmed") || PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0)) || func_182(0))
						{
							if (PED::IS_PED_FACING_PED(AUDIO::_0x0626A247D2405330(), iLocal_36[1], 100f))
							{
								if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 939.8862f, -1575.635f, 28.59783f, 952.9254f, -1575.484f, 33.19459f, 13.75f, 0, true, 0))
								{
									if (iLocal_334[1] == 0)
									{
										if (!PED::IS_PED_FACING_PED(iLocal_36[1], AUDIO::_0x0626A247D2405330(), 45f))
										{
											...
											{
												NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_36[1]);
											}
											BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_36[1], AUDIO::_0x0626A247D2405330(), 5000);
		...
		case 2:
			...
			if (func_178() || iLocal_297 == 1)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
				{
					if (!PED::IS_PED_INJURED(iLocal_36[0]))
					{
						if (PED::_CAN_PED_SEE_PED(iLocal_36[0], AUDIO::_0x0626A247D2405330()))
						{
							...
							if (iLocal_331[0] == 0)
							{
								...
								BRAIN::TASK_COMBAT_PED(iLocal_36[0], AUDIO::_0x0626A247D2405330(), 0, 16);
								func_181(iLocal_36[0]);
								iLocal_331[0] = 1;
							}
						}
						else if (iLocal_333[0] == 0)
						{
							if (iLocal_332[0] == 0)
							{
								...
								BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_36[0], unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 3f, 4294967295, 1048576000, 0, 1193033728);
								func_181(iLocal_36[0]);
								iLocal_333[0] = 1;
							}
							if (iLocal_332[0] == 1)
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[1]))
				{
					if (!PED::IS_PED_INJURED(iLocal_36[1]))
					{
						if (PED::_CAN_PED_SEE_PED(iLocal_36[1], AUDIO::_0x0626A247D2405330()))
						{
							...
							if (iLocal_331[1] == 0)
							{
								...
								BRAIN::TASK_COMBAT_PED(iLocal_36[1], AUDIO::_0x0626A247D2405330(), 0, 16);
								func_181(iLocal_36[1]);
								iLocal_331[1] = 1;
							}
						}
						else if (iLocal_333[1] == 0)
						{
							if (iLocal_332[1] == 0)
							{
								...
								BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_36[1], unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 3f, 4294967295, 1048576000, 0, 1193033728);
								func_181(iLocal_36[1]);
								iLocal_333[1] = 1;
							}
							if (iLocal_332[1] == 1)
				...
				if (func_178())
				{
					...
					if (iLocal_299 == 1)
					{
						if (iLocal_300 == 0)
						{
							if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[1], 1) < 20f)
							{
				...
				else
				{
					if (iLocal_339 == 0)
					{
						iLocal_41 = func_175(AUDIO::_0x0626A247D2405330(), 2761840924, 0, 0, 28);
						if (iLocal_41 != 0)
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_41))
							{
								...
								{
									if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_41, 1) < 35f)
									{
										iLocal_339 = 1;
									}
								}
					...
					if (PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0 && iLocal_339 == 0)
					{
						if (iLocal_298 == 1)
						{
							if (iLocal_301 == 0)
			...
			if (!func_178())
			{
				if (iLocal_309 == 0)
				{
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 893.2f, -1556.5f, 30f, true) < 18f)
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
						{
							if (!PED::IS_PED_INJURED(iLocal_36[0]))
				...
				if (iLocal_297 == 0)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_36[0]))
						{
							if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[0], 1) > 4f)
							{
								if (PED::_CAN_PED_SEE_PED(iLocal_36[0], AUDIO::_0x0626A247D2405330()))
								{
									if (iLocal_329[0] == 0)
									{
										...
										BRAIN::TASK_GO_TO_ENTITY(iLocal_36[0], AUDIO::_0x0626A247D2405330(), 4294967295, 0,5f, 2f, 1073741824, 0);
										func_181(iLocal_36[0]);
										iLocal_329[0] = 1;
									}
								...
								else if (MISC::GET_GAME_TIMER() > iLocal_80[0] + 500)
								{
									if (iLocal_330[0] == 0)
									{
										...
										BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_36[0], unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 2f, 4294967295, 1048576000, 0, 1193033728);
										func_181(iLocal_36[0]);
										iLocal_330[0] = 1;
									}
								}
							...
							else if (iLocal_361[0] == 0)
							{
								...
								BRAIN::SET_SEQUENCE_TO_REPEAT(uLocal_48, 1);
								CUTSCENE::_0x8D9DF6ECA8768583(uLocal_48);
								BRAIN::TASK_PERFORM_SEQUENCE(iLocal_36[0], uLocal_48);
								BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_48);
								func_181(iLocal_36[0]);
								iLocal_361[0] = 1;
							}
							if (iLocal_335 == 0)
							{
								if (iLocal_326 == 0 || iLocal_302 == 1)
								{
									if (iLocal_296 == 0)
									{
										if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[0], 1) < 10f)
										{
											if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_36[0]))
											{
							...
							{
								if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[0], 1) < 15f)
								{
									if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_36[0]))
									{
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[1]))
					{
						if (!PED::IS_PED_INJURED(iLocal_36[1]))
						{
							if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[1], 1) > 4f)
							{
								if (PED::_CAN_PED_SEE_PED(iLocal_36[1], AUDIO::_0x0626A247D2405330()))
								{
									if (iLocal_329[1] == 0)
									{
										...
										BRAIN::TASK_GO_TO_ENTITY(iLocal_36[1], AUDIO::_0x0626A247D2405330(), 4294967295, 0,5f, 2f, 1073741824, 0);
										func_181(iLocal_36[1]);
										iLocal_329[1] = 1;
									}
								...
								else if (MISC::GET_GAME_TIMER() > iLocal_80[1] + 500)
								{
									if (iLocal_330[1] == 0)
									{
										...
										BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_36[1], unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 2f, 4294967295, 1048576000, 0, 1193033728);
										func_181(iLocal_36[1]);
										iLocal_330[1] = 1;
									}
								}
							...
							else if (iLocal_361[1] == 0)
							{
								...
								BRAIN::SET_SEQUENCE_TO_REPEAT(uLocal_48, 1);
								CUTSCENE::_0x8D9DF6ECA8768583(uLocal_48);
								BRAIN::TASK_PERFORM_SEQUENCE(iLocal_36[1], uLocal_48);
								BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_48);
								func_181(iLocal_36[1]);
								iLocal_361[1] = 1;
							}
							if (iLocal_335 == 0)
							{
								if (iLocal_326 == 0 || iLocal_302 == 1)
								{
									if (iLocal_296 == 0)
									{
										if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[1], 1) < 10f)
										{
											if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_36[1]))
											{
												func_179(iLocal_36[1], "PROVOKE_TRESPASS", "S_M_M_GENERICSECURITY_01_LATINO_MINI_02", 9);
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_33))
					{
						if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_33, 0))
						{
							if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_33, 1))
							{
								if (PED::_CAN_PED_SEE_PED(iLocal_36[0], AUDIO::_0x0626A247D2405330()) || PED::_CAN_PED_SEE_PED(iLocal_36[1], AUDIO::_0x0626A247D2405330()))
								{
									iLocal_297 = 1;
								}
							}
							if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_33, 1) < 5f && PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330()))
							{
								if (PED::_CAN_PED_SEE_PED(iLocal_36[0], AUDIO::_0x0626A247D2405330()) || PED::_CAN_PED_SEE_PED(iLocal_36[1], AUDIO::_0x0626A247D2405330()))
								{
									iLocal_297 = 1;
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
					{
						if (!PED::IS_PED_INJURED(iLocal_36[0]))
						{
							if (PED::IS_PED_IN_MELEE_COMBAT(AUDIO::_0x0626A247D2405330()))
							{
								if (PED::_0xDCCA191DF9980FD7(AUDIO::_0x0626A247D2405330()))
								{
									if (PED::_CAN_PED_SEE_PED(iLocal_36[0], AUDIO::_0x0626A247D2405330()))
									{
										iLocal_297 = 1;
	...
	if (!PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
		...
		while (iLocal_64 <= 6)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[iLocal_64]))
			{
				...
				{
					if (func_183(AUDIO::_0x0626A247D2405330()) != joaat("weapon_unarmed") && !func_182(0))
					{
						if (PED::_CAN_PED_SEE_PED(iLocal_35[iLocal_64], AUDIO::_0x0626A247D2405330()))
						{
							return 1;
						}
					}
...
void func_179(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xD3C2
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_180(iParam3), 0);
}

int func_180(int iParam0)//Position - 0xD3DB
{
	int iVar0;
...
void func_181(int iParam0)//Position - 0xD5D0
{
...
int func_182(int iParam0)//Position - 0xD66A
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
int func_183(int iParam0)//Position - 0xD6C4
{
	var uVar0;
...
void func_184()//Position - 0xD6D8
{
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			vLocal_93 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true) };
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
	{
		if (!PED::IS_PED_INJURED(iLocal_36[0]))
		{
			vLocal_95[0 /*3*/] = { unk_0x8000C77B5F336760(iLocal_36[0], true) };
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[1]))
	{
		if (!PED::IS_PED_INJURED(iLocal_36[1]))
		{
			vLocal_95[1 /*3*/] = { unk_0x8000C77B5F336760(iLocal_36[1], true) };
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_36[0]))
	{
	...
	if (iLocal_31 != 0)
	{
			...
			if (iLocal_303[0] == 1)
			{
				if (iLocal_303[1] == 1)
				{
					if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[0], 1) < func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[1], 1))
					{
						if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[0], 1) < 20f)
						{
							if (((vLocal_93.x < vLocal_95[0 /*3*/] && !PED::IS_PED_FACING_PED(AUDIO::_0x0626A247D2405330(), iLocal_36[0], 90f)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 868.5617f, -1579.476f, 33.30448f, 866.5635f, -1560.984f, 28.90482f, 8.25f, 0, true, 0)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 855.4593f, -1548.228f, 28.27722f, 863.1765f, -1563.288f, 33.31375f, 4.75f, 0, true, 0))
							{
								iLocal_31 = 0;
								iLocal_340[0] = 0;
								iLocal_341[0] = 0;
					...
					else if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[1], 1) < 15f)
					{
						if ((vLocal_93.x > vLocal_95[1 /*3*/] && !PED::IS_PED_FACING_PED(AUDIO::_0x0626A247D2405330(), iLocal_36[1], 90f)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 936.7849f, -1569.337f, 31.49661f, 936.3553f, -1581.973f, 27.77812f, 8.25f, 0, true, 0))
						{
							iLocal_31 = 0;
							iLocal_340[0] = 0;
							iLocal_341[0] = 0;
				...
				else if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[0], 1) < func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[1], 1))
				{
					if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[0], 1) < 15f)
					{
						if ((vLocal_93.x < vLocal_95[0 /*3*/] && !PED::IS_PED_FACING_PED(AUDIO::_0x0626A247D2405330(), iLocal_36[0], 90f)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 868.5617f, -1579.476f, 33.30448f, 866.5635f, -1560.984f, 28.90482f, 8.25f, 0, true, 0))
						{
							iLocal_31 = 0;
							iLocal_340[0] = 0;
							iLocal_341[0] = 0;
		...
		if (iLocal_31 == 2)
		{
			if (iLocal_297 == 0)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 936.7849f, -1569.337f, 31.49661f, 936.3553f, -1581.973f, 27.77812f, 8.25f, 0, true, 0) || vLocal_93.x > 942f)
				{
					if (!PED::IS_PED_INJURED(iLocal_36[1]))
					{
						if (vLocal_93.x > vLocal_95[1 /*3*/])
						{
							if (!PED::IS_PED_FACING_PED(AUDIO::_0x0626A247D2405330(), iLocal_36[1], 90f))
							{
								iLocal_31 = 0;
								iLocal_340[0] = 0;
								iLocal_341[0] = 0;
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 868.5617f, -1579.476f, 33.30448f, 866.5635f, -1560.984f, 28.90482f, 8.25f, 0, true, 0) || vLocal_93.x < 860f)
				{
					if (!PED::IS_PED_INJURED(iLocal_36[0]))
					{
						if (vLocal_93.x < vLocal_95[0 /*3*/])
						{
							if (!PED::IS_PED_FACING_PED(AUDIO::_0x0626A247D2405330(), iLocal_36[0], 90f))
							{
								iLocal_31 = 0;
								iLocal_340[0] = 0;
								iLocal_341[0] = 0;
		...
		if (iLocal_31 != 2)
		{
			if (iLocal_303[0] == 1)
			{
				if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[0], 1) < 20f)
				{
					if ((func_183(AUDIO::_0x0626A247D2405330()) == joaat("weapon_unarmed") || PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0)) || func_182(0))
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 860.4606f, -1563.58f, 28.81788f, 865.0807f, -1575.088f, 30.93324f, 5.75f, 0, true, 0))
						{
							if (vLocal_93.x > vLocal_95[0 /*3*/] || PED::IS_PED_FACING_PED(AUDIO::_0x0626A247D2405330(), iLocal_36[0], 90f))
							{
								iLocal_31 = 1;
							}
						}
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 855.4593f, -1548.228f, 28.27722f, 863.1765f, -1563.288f, 33.31375f, 4.75f, 0, true, 0))
						{
							iLocal_31 = 1;
						}
					}
			...
			if (iLocal_303[1] == 1)
			{
				if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[1], 1) < 15f)
				{
					if ((func_183(AUDIO::_0x0626A247D2405330()) == joaat("weapon_unarmed") || PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0)) || func_182(0))
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 939.8862f, -1575.635f, 28.59783f, 952.9254f, -1575.484f, 33.19459f, 13.75f, 0, true, 0))
						{
							if (vLocal_93.x < vLocal_95[1 /*3*/] || PED::IS_PED_FACING_PED(AUDIO::_0x0626A247D2405330(), iLocal_36[1], 90f))
							{
								iLocal_31 = 1;
							}
						}
	...
	if (iLocal_31 != 2)
	{
		if (FIRE::IS_EXPLOSION_IN_SPHERE(4294967295, 892.9f, -1552.4f, 30f, 40f))
		{
			iLocal_31 = 2;
			iLocal_297 = 1;
		}
		...
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_93, vLocal_96, true) < 36f)
		{
			if (iLocal_303[0] == 1)
			{
				...
				if (func_171(iLocal_36[0], AUDIO::_0x0626A247D2405330(), 1) < 20f)
				{
					if (PLAYER::CAN_PED_HEAR_PLAYER(CAM::_0xDC9DA9E8789F5246(), iLocal_36[0]))
					{
						iLocal_31 = 2;
					}
				}
			...
			if (iLocal_303[1] == 1)
			{
				if (vLocal_93.z < 36f || PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
				{
					if (PED::_CAN_PED_SEE_PED(iLocal_36[1], AUDIO::_0x0626A247D2405330()))
					{
						iLocal_31 = 2;
					}
					if (func_171(iLocal_36[1], AUDIO::_0x0626A247D2405330(), 1) < 20f)
					{
						if (PLAYER::CAN_PED_HEAR_PLAYER(CAM::_0xDC9DA9E8789F5246(), iLocal_36[1]))
						{
							iLocal_31 = 2;
						}
					}
		...
		if (iLocal_303[0] == 1)
		{
			if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[0], 1) < 20f)
			{
				if (vLocal_93.x > vLocal_95[0 /*3*/] && ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 868.5617f, -1579.476f, 33.30448f, 866.5635f, -1560.984f, 28.90482f, 8.25f, 0, true, 0))
				{
					if (PED::_CAN_PED_SEE_PED(iLocal_36[0], AUDIO::_0x0626A247D2405330()) || PLAYER::CAN_PED_HEAR_PLAYER(CAM::_0xDC9DA9E8789F5246(), iLocal_36[0]))
					{
						iLocal_31 = 2;
					}
				}
		...
		if (iLocal_303[1] == 1)
		{
			if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_36[1], 1) < 20f)
			{
				if (vLocal_93.x < vLocal_95[1 /*3*/] && ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 936.7849f, -1569.337f, 31.49661f, 936.3553f, -1581.973f, 27.77812f, 8.25f, 0, true, 0))
				{
					if (PED::_CAN_PED_SEE_PED(iLocal_36[1], AUDIO::_0x0626A247D2405330()) || PLAYER::CAN_PED_HEAR_PLAYER(CAM::_0xDC9DA9E8789F5246(), iLocal_36[1]))
					{
						iLocal_31 = 2;
					}
				}
	...
	while (iLocal_55 <= 6)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[iLocal_55]))
		{
			if (!PED::IS_PED_INJURED(iLocal_35[iLocal_55]))
			{
				...
				{
					if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_35[iLocal_55], 1) > 20f)
					{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[iLocal_54]))
		{
			if (!PED::IS_PED_INJURED(iLocal_35[iLocal_54]))
			{
				...
				if (iLocal_28 == 3 || iLocal_28 == 4)
				{
					...
					if ((func_183(AUDIO::_0x0626A247D2405330()) == joaat("weapon_unarmed") || PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 1)) || func_182(0))
					{
						if (iLocal_297 == 0)
						{
							if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_35[iLocal_54], 1) > 20f)
							{
							...
							if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_35[iLocal_54], 1) < 20f && PED::_CAN_PED_SEE_PED(iLocal_35[iLocal_54], AUDIO::_0x0626A247D2405330()))
							{
						...
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_33))
						{
							if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_33, 0))
							{
								if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_33, 1))
								{
									if (PED::_CAN_PED_SEE_PED(iLocal_35[iLocal_54], AUDIO::_0x0626A247D2405330()))
									{
										if (iLocal_29 != 3 && iLocal_29 != 4)
										{
											iLocal_289 = 1;
								...
								if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_33, 1) < 5f && PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330()))
								{
									...
									if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 917.3436f, -1554.42f, 29.26611f, 916.8774f, -1556.441f, 33.00661f, 2.25f, 0, true, 0))
									{
										if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
										{
						...
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[6]))
						{
							...
							{
								if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_35[6], 1) < 20f)
								{
									if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 928.7163f, -1546.671f, 27.34603f, 921.8971f, -1549.752f, 34.04724f, 6.25f, 0, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 931.868f, -1545.185f, 27.3653f, 925.8857f, -1547.303f, 34.07205f, 3.5f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 929.4908f, -1524.829f, 32.84098f, 929.3696f, -1545.288f, 37.34258f, 5f, 0, true, 0))
									{
										if (PED::_CAN_PED_SEE_PED(iLocal_35[6], AUDIO::_0x0626A247D2405330()))
										{
											if (vLocal_93.z > 31f)
											{
												if (iLocal_29 != 3 && iLocal_29 != 4)
					...
					else
					{
						...
						if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_35[iLocal_54], 1) < 40f)
						{
							if (PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
							{
								if (PED::_CAN_PED_SEE_PED(iLocal_35[iLocal_54], AUDIO::_0x0626A247D2405330()) || PLAYER::CAN_PED_HEAR_PLAYER(CAM::_0xDC9DA9E8789F5246(), iLocal_35[iLocal_54]))
								{
									if (iLocal_29 != 4)
									{
										func_189(4);
...
int func_186(int iParam0, int iParam1)//Position - 0xEB2E
{
...
void func_187()//Position - 0xEB76
{
	Global_3960 = 0;
	func_188();
}

void func_188()//Position - 0xEB86
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_189(int iParam0)//Position - 0xEBA7
{
	iLocal_29 = iParam0;
	iLocal_58 = 0;
}

void func_190(int iParam0)//Position - 0xEBB6
{
	iLocal_56 = 0;
	while (iLocal_56 <= 6)
	{
		...
		{
			if (func_171(AUDIO::_0x0626A247D2405330(), iParam0, 1) < 20f && PED::_CAN_PED_SEE_PED(iParam0, AUDIO::_0x0626A247D2405330()))
			{
				if (iLocal_280[iLocal_56] == 0)
				{
					BRAIN::TASK_LOOK_AT_ENTITY(iParam0, AUDIO::_0x0626A247D2405330(), 4294967295, 1072, 3);
					iLocal_280[iLocal_56] = 1;
				}
			}
			else if (iLocal_280[iLocal_56] == 1)
			{
				BRAIN::TASK_LOOK_AT_ENTITY(iParam0, AUDIO::_0x0626A247D2405330(), 1, 1072, 3);
		...
		case 0:
			if (iLocal_58 == 0)
			{
				...
				if (iParam0 == iLocal_35[0])
				{
					...
					{
						if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_35[0], 1647992574) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_35[0], 2614205159) != 1)
						{
				...
				if (iParam0 == iLocal_35[1])
				{
					...
					{
						if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_35[1], 1647992574) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_35[1], 2614205159) != 1)
						{
				...
				if (iParam0 == iLocal_35[2])
				{
					...
					{
						if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_35[2], 1647992574) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_35[2], 2614205159) != 1)
						{
				...
				if (iParam0 == iLocal_35[3])
				{
					...
					{
						if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_35[3], 1647992574) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_35[3], 2614205159) != 1)
						{
				...
				if (iParam0 == iLocal_35[4])
				{
					...
					{
						if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_35[4], 1647992574) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_35[4], 2614205159) != 1)
						{
				...
				if (iParam0 == iLocal_35[5])
				{
					...
					{
						if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_35[5], 1647992574) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_35[5], 2614205159) != 1)
						{
				...
				if (iParam0 == iLocal_35[6])
				{
					...
					{
						if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_35[6], 1647992574) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_35[6], 2614205159) != 1)
						{
			...
			if (iLocal_58 == 1)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[4]))
				{
					if (!PED::IS_PED_INJURED(iLocal_35[4]))
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[5]))
						{
							...
							{
								if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_35[4], 1) < 25f)
								{
									if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 926.455f, -1582.384f, 29.32759f, 909.6322f, -1581.374f, 31.58907f, 9.5f, 0, true, 0) || vLocal_93.y > -1573f)
									{
										if (iLocal_311 == 0)
										{
											func_132(&uLocal_99, 3, iLocal_35[4], "CONSTRUCTION2", 0, 1);
											func_132(&uLocal_99, 5, iLocal_35[5], "CONSTRUCTION3", 0, 1);
											BRAIN::TASK_LOOK_AT_ENTITY(iLocal_35[4], iLocal_35[5], 4294967295, 0, 2);
											BRAIN::TASK_LOOK_AT_ENTITY(iLocal_35[5], iLocal_35[4], 4294967295, 0, 2);
											if (!func_176())
											{
								...
								if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), 921.9f, -1556.5f, 30f, 5f, 5f, 5f, false, true, 1))
								{
									if (iLocal_318 == 0)
									{
				...
				if (iParam0 == iLocal_35[6])
				{
					...
					if (iLocal_319 == 1)
					{
						...
						{
							if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_35[6], 1) < 15f && vLocal_93.z < 40f)
							{
								if (iLocal_321 == 0)
								{
			...
			if (iLocal_58 == 0)
			{
				...
				while (iLocal_56 <= 6)
				{
					if (iLocal_31 == 0)
					{
						if (iParam0 == iLocal_35[iLocal_56])
						{
							if (func_171(AUDIO::_0x0626A247D2405330(), iParam0, 1) < 20f)
							{
								if (iLocal_281[iLocal_56] == 0)
								{
									if (PED::_CAN_PED_SEE_PED(iParam0, AUDIO::_0x0626A247D2405330()) || PLAYER::CAN_PED_HEAR_PLAYER(CAM::_0xDC9DA9E8789F5246(), iParam0))
									{
										...
										BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), 0);
										CUTSCENE::_0x8D9DF6ECA8768583(uLocal_48);
										BRAIN::TASK_PERFORM_SEQUENCE(iParam0, uLocal_48);
										BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_48);
										ENTITY::SET_ENTITY_HEALTH(iParam0, true);
										iLocal_280[iLocal_56] = 0;
						...
						if (func_171(AUDIO::_0x0626A247D2405330(), iParam0, 1) < 20f)
						{
							if (iLocal_281[iLocal_56] == 0)
							{
								if (PED::_CAN_PED_SEE_PED(iParam0, AUDIO::_0x0626A247D2405330()) || PLAYER::CAN_PED_HEAR_PLAYER(CAM::_0xDC9DA9E8789F5246(), iParam0))
								{
									...
									BRAIN::OPEN_SEQUENCE_TASK(&uLocal_48);
									BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), 0);
									BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295, 1072, 3);
									CUTSCENE::_0x8D9DF6ECA8768583(uLocal_48);
									BRAIN::TASK_PERFORM_SEQUENCE(iParam0, uLocal_48);
									BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_48);
									ENTITY::SET_ENTITY_HEALTH(iParam0, true);
		...
		case 2:
			...
			if (iLocal_58 == 1)
			{
				...
				while (iLocal_56 <= 6)
				{
					if (iParam0 == iLocal_35[iLocal_56])
					{
						if (func_171(iParam0, AUDIO::_0x0626A247D2405330(), 1) < 15f)
						{
							if (func_171(iParam0, AUDIO::_0x0626A247D2405330(), 1) > 3f)
							{
								if (BRAIN::GET_SCRIPT_TASK_STATUS(iParam0, 242628503) != 0 || BRAIN::GET_SCRIPT_TASK_STATUS(iParam0, 242628503) != 1)
								{
									...
									BRAIN::OPEN_SEQUENCE_TASK(&uLocal_48);
									BRAIN::TASK_GO_TO_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295, 1f, 1f, 1073741824, 0);
									BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), 0);
									CUTSCENE::_0x8D9DF6ECA8768583(uLocal_48);
									BRAIN::TASK_PERFORM_SEQUENCE(iParam0, uLocal_48);
									BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_48);
			...
			if (iLocal_58 == 1)
			{
				if (iLocal_28 == 3)
				{
					...
					while (iLocal_56 <= 6)
					{
						if (iParam0 == iLocal_35[iLocal_56])
						{
							if (func_171(iParam0, AUDIO::_0x0626A247D2405330(), 1) < 100f)
							{
						...
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[0]))
						{
							if (!PED::IS_PED_INJURED(iLocal_35[0]))
							{
								if (ENTITY::DOES_ENTITY_EXIST(iLocal_33))
								{
									if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_33, 0))
									{
										if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_33, 1) && ENTITY::IS_ENTITY_AT_COORD(iLocal_33, 919.2f, -1554.4f, 30f, 4f, 4f, 4f, false, true, 0))
										{
											...
											if (ENTITY::IS_ENTITY_ON_SCREEN(iLocal_35[0]))
											{
												NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_35[0]);
											}
											BRAIN::OPEN_SEQUENCE_TASK(&uLocal_48);
											BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 917.8f, -1561f, 29f, 3f, 4294967295, 1048576000, 0, 1193033728);
											BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), 0);
											BRAIN::TASK_PLAY_ANIM(0, "misscarsteal4@director_grip", "mcs_2_loop_grip1", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
											CUTSCENE::_0x8D9DF6ECA8768583(uLocal_48);
											BRAIN::TASK_PERFORM_SEQUENCE(iLocal_35[0], uLocal_48);
											BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_48);
											iLocal_345 = 1;
										}
									}
					...
					if (iLocal_344 == 0)
					{
						if (MISC::GET_GAME_TIMER() > iLocal_63 + 3000)
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[5]))
							{
								if (!PED::IS_PED_INJURED(iLocal_35[5]))
								{
									BRAIN::TASK_PLAY_ANIM(iLocal_35[5], "cellphone@str", "cellphone_call_listen_c", 4f, -8f, 4294967295, 49, 0, 0, 0, 0);
					...
					else if (iLocal_343 == 0)
					{
						if (MISC::GET_GAME_TIMER() > iLocal_87 + 5000)
						{
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[5]))
							{
								if (!PED::IS_PED_INJURED(iLocal_35[5]))
								{
									NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_35[5]);
									BRAIN::TASK_COMBAT_PED(iLocal_35[5], AUDIO::_0x0626A247D2405330(), 0, 16);
									iLocal_343 = 1;
								}
							}
						}
						...
						if (iParam0 == iLocal_35[iLocal_56])
						{
							if (ENTITY::DOES_ENTITY_EXIST(iParam0))
							{
								if (!PED::IS_PED_INJURED(iParam0))
								{
									...
									{
										if (func_171(iParam0, AUDIO::_0x0626A247D2405330(), 1) > 200f)
										{
											if (!ENTITY::IS_ENTITY_ON_SCREEN(iParam0))
											{
												BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(iParam0);
											...
											BRAIN::TASK_SMART_FLEE_PED(iParam0, AUDIO::_0x0626A247D2405330(), 1000f, 4294967295, 0, 0);
											iLocal_268[iLocal_56] = 1;
										}
									}
									else if (func_171(iParam0, AUDIO::_0x0626A247D2405330(), 1) > 100f)
									{
										if (!ENTITY::IS_ENTITY_ON_SCREEN(iParam0))
										{
											BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(iParam0);
			...
			if (iLocal_58 == 1)
			{
				...
				while (iLocal_56 <= 6)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_35[iLocal_56]))
					{
						...
						{
							if (func_171(AUDIO::_0x0626A247D2405330(), iLocal_35[iLocal_56], 1) < 15f)
							{
								if (func_191(iLocal_35[iLocal_56], 6))
								{
									if (PED::_CAN_PED_SEE_PED(iLocal_35[iLocal_56], AUDIO::_0x0626A247D2405330()))
									{
										if (iLocal_285[iLocal_56] == 0)
										{
											...
											if (ENTITY::IS_ENTITY_ON_SCREEN(iLocal_35[iLocal_56]))
											{
												NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_35[iLocal_56]);
											}
											BRAIN::TASK_HANDS_UP(iLocal_35[iLocal_56], 4294967295, AUDIO::_0x0626A247D2405330(), 4294967295, 0);
								...
								else if (iLocal_284[iLocal_56] == 0)
								{
									...
									BRAIN::TASK_SMART_FLEE_PED(iLocal_35[iLocal_56], AUDIO::_0x0626A247D2405330(), 250f, 4294967295, 0, 0);
...
int func_191(int iParam0, int iParam1)//Position - 0x105A8
{
...
void func_192()//Position - 0x105F4
{
	iLocal_37 = func_25(0);
	iLocal_38 = func_25(1);
	iLocal_39 = func_25(2);
		...
		if (!PED::IS_PED_INJURED(iLocal_37))
		{
			...
			else
			{
				if (iLocal_350 == 0)
				{
					...
					{
						if (!PED::IS_PED_IN_VEHICLE(iLocal_37, PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 0))
						{
							iLocal_350 = 1;
						}
					}
				...
				if (iLocal_347 == 1)
				{
					...
					{
						vLocal_94 = { unk_0x8000C77B5F336760(iLocal_37, true) };
		...
		if (!PED::IS_PED_INJURED(iLocal_39))
		{
			...
			else
			{
				if (iLocal_352 == 0)
				{
					...
					{
						if (!PED::IS_PED_IN_VEHICLE(iLocal_39, PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 0))
						{
							iLocal_352 = 1;
						}
					}
				...
				if (iLocal_348 == 1)
				{
					...
					{
						vLocal_94 = { unk_0x8000C77B5F336760(iLocal_39, true) };
						PATHFIND::_0x07FB139B592FA687(vLocal_94.x, vLocal_94.y, vLocal_92.x, vLocal_92.y);
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) == 0)
						{
							if (iLocal_354 == 0)
		...
		if (!PED::IS_PED_INJURED(iLocal_38))
		{
			...
			else
			{
				if (iLocal_351 == 0)
				{
					...
					{
						if (!PED::IS_PED_IN_VEHICLE(iLocal_38, PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 0))
						{
							iLocal_351 = 1;
						}
					}
				...
				if (iLocal_349 == 1)
				{
					...
					{
						vLocal_94 = { unk_0x8000C77B5F336760(iLocal_38, true) };
						PATHFIND::_0x07FB139B592FA687(vLocal_94.x, vLocal_94.y, vLocal_92.x, vLocal_92.y);
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) == 0)
						{
							if (iLocal_355 == 0)
...
int func_193(int iParam0)//Position - 0x10C1D
{
		...
		if (!PED::IS_PED_INJURED(iParam0))
		{
			if (PED::IS_PED_IN_VEHICLE(iParam0, PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 4294967295, 0) == iParam0)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_33))
				{
					if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_33, 0))
					{
						if ((PED::IS_PED_IN_VEHICLE(iParam0, iLocal_33, 0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_33, 4294967295, 0) == iParam0) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_33, vLocal_92, 3f, 3f, 3f, false, true, 0))
						{
...
bool func_194()//Position - 0x10CFF
{
	return Global_434A;
}

void func_195()//Position - 0x10D0A
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_33))
	{
		if (!OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_33, 0))
	...
	if (iLocal_28 == 3 || iLocal_28 == 4)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_32))
		{
			if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_32, 0))
			{
				if (func_171(iLocal_32, AUDIO::_0x0626A247D2405330(), 1) > 600f)
				{
					func_198(5);
					return;
				}
...
int func_196(int iParam0)//Position - 0x10DF5
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
int func_197(int iParam0)//Position - 0x10E38
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(*iParam0, 0))
	{
...
void func_198(int iParam0)//Position - 0x10E92
{
	iLocal_30 = iParam0;
	if (iLocal_28 != 6)
	{
...
void func_199(int iParam0, int iParam1)//Position - 0x10EAA
{
...
void func_200()//Position - 0x10EEF
{
	if (iLocal_28 == 5)
	{
		if (iLocal_360 == 0)
...
void func_201(int iParam0)//Position - 0x10F0B
{
	bool bVar0;
	int iVar1;
...
bool func_202(bool bParam0)//Position - 0x10F7C
{
...
void func_203()//Position - 0x10FA7
{
...
void func_204()//Position - 0x11067
{
	int iVar0;
