...
void __EntryFunction__()
{
	...
	if (MISC::GET_GAME_TIMER() < Global_25494 + 10000 && !func_100())
	{
		func_107(0);
	}
	...
	Global_25494 = MISC::GET_GAME_TIMER();
	...
	while (iVar0 == 1)
	{
		...
		if (bLocal_334)
		{
			...
			StringIntConCat(&cVar13, Global_104500[iLocal_217], 64);
			...
			StringIntConCat(&cVar13, iLocal_221[Global_104500[iLocal_217]], 64);
			GRAPHICS::DRAW_DEBUG_TEXT_2D(&cVar13, 0.02f, 0.83f, 0f, 0, 0, 255, 255);
		}
		vVar15 = { ENTITY::GET_ENTITY_COORDS(iLocal_208, 1) };
		if (((ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iLocal_208) && !iLocal_216 == 25) && !iLocal_216 == 5) && !iLocal_216 == 6)
		{
			...
			{
				func_85();
				BRAIN::TASK_PLAY_ANIM(iLocal_208, &cLocal_234, &Local_203, 2f, -2f, -1, 0, 0, 0, 0, 0);
				iLocal_216 = 25;
			}
			else
			{
		...
		if (!bLocal_268)
		{
			...
			{
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_208, 1)) < 16f)
				{
		...
		switch (iLocal_216)
		{
			...
			case 5:
				...
				{
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_208, vLocal_210, 1f, -1, 1f, 1024, ScriptParam_336.f_17[0]);
					iLocal_216 = 6;
				}
				break;
			...
			case 6:
				...
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_208, 713668775) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_208, 713668775) != 0)
				{
					GRAPHICS::DRAW_DEBUG_TEXT_2D("WAIT_MOVE_BACK_TO_INITIAL_POSITION TASK_PLAY_ANIM", 0.02f, 0.26f, 0f, 0, 0, 255, 255);
					BRAIN::TASK_PLAY_ANIM(iLocal_208, &cLocal_243, "idle_intro", 4f, -4f, -1, 0, 0, 0, 0, 0);
			...
			case 8:
				...
				else if (!func_56())
				{
					...
					if (iLocal_223 < iLocal_221[Global_104500[iLocal_217]] && iVar8)
					{
						func_57();
						iLocal_216 = 7;
					}
				...
				else if (iLocal_269 == 1)
				{
					...
					{
						func_46(Global_104500[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_208, &Local_253, &Local_252));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_55();
				bVar37 = func_56();
				func_45(Global_104500[iLocal_217]);
				if (!bVar37 && (!bVar36 || bLocal_266))
				{
					if (bLocal_333)
					{
						Global_104500[iLocal_217] = uLocal_332;
					}
					else
					{
						Global_104500[iLocal_217]++;
					}
					if (!Global_104500[iLocal_217] < iLocal_218)
					{
						Global_104500[iLocal_217] = 0;
					}
					func_95(0, 1);
					iLocal_216 = 0;
				}
			...
			case 11:
				...
				{
					func_22(&sVar4);
					BRAIN::TASK_PLAY_ANIM(iLocal_208, &Local_255, &sVar4, 2f, -2f, -1, 0, 0, 0, 0, 0);
					iLocal_216 = 12;
				}
				else
				{
			...
			case 15:
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(&Local_255))
				{
					...
					if (!func_56())
					{
						...
						func_22(&sVar4);
						BRAIN::TASK_PLAY_ANIM(iLocal_208, &Local_255, &sVar4, 1000f, -1000f, -1, 0, 0, 0, 0, 0);
						PED::_0x2208438012482A1A(iLocal_208, 0, 0);
						iLocal_216 = 12;
					}
				}
		...
		bVar18 = SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("context_controller")) > 0;
		if (!bVar18)
		{
		}
	...
	while (true)
	{
		...
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_208, PLAYER::PLAYER_PED_ID(), 1) && !bVar20)
		{
			...
			BRAIN::CLEAR_PED_TASKS(iLocal_208);
			BRAIN::TASK_SMART_FLEE_PED(iLocal_208, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
			PED::SET_PED_KEEP_TASK(iLocal_208, true);
			bVar20 = true;
		}
		if ((ENTITY::IS_ENTITY_OCCLUDED(iLocal_208) && func_78(iLocal_208, PLAYER::PLAYER_PED_ID(), 1) > 50f) && !TASK::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			func_107(1);
		}
		SYSTEM::WAIT(0);
...
void func_1()
{
	...
	if ((ENTITY::DOES_ENTITY_EXIST(iLocal_277) && !ENTITY::IS_ENTITY_DEAD(iLocal_277, 0)) && !ENTITY::IS_ENTITY_DEAD(iLocal_208, 0))
	{
		if (!iLocal_278)
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_208, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), true) < 15f)
			{
				BRAIN::TASK_FLUSH_ROUTE();
				BRAIN::TASK_EXTEND_ROUTE(379.8408f, 152.3401f, 102.0718f);
				BRAIN::TASK_EXTEND_ROUTE(380.4872f, 158.653f, 102.1292f);
				BRAIN::TASK_EXTEND_ROUTE(388.7568f, 179.6577f, 102.1317f);
				BRAIN::TASK_FOLLOW_POINT_ROUTE(iLocal_277, 1f, 0);
				iLocal_278 = 1;
			}
		}
		else
		{
			...
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_277, 1), 377.4565f, 154.6708f, 102.0838f, true) > 25f)
			{
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_277);
				iLocal_279 = 1;
			}
			else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_277, 1), ENTITY::GET_ENTITY_COORDS(iLocal_208, 1), true) < 3f && iLocal_280 == 0)
			{
				iLocal_280 = 1;
			}
		}
...
void func_8()
{
	...
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_208, false);
		BRAIN::TASK_WANDER_STANDARD(iLocal_208, 1193033728, 0);
		PED::SET_PED_KEEP_TASK(iLocal_208, true);
	}
}
...
void func_48()
{
	...
	func_51(Global_104500[iLocal_217] + 1, &sVar0, &Var1);
	StringConCat(&Var1, "_", 64);
	StringIntConCat(&Var1, iLocal_223, 64);
	Local_252 = { Var1 };
	Local_253 = { Local_254 };
	func_50(&Local_252);
	BRAIN::TASK_PLAY_ANIM(iLocal_208, &Local_254, &Var1, 1000f, -8f, -1, 0, 0, 0, 0, 0);
	PED::_0x2208438012482A1A(iLocal_208, 0, 0);
	func_49(Global_104500[iLocal_217]);
}
...
int func_52()
{
	...
	Var0 = { Local_230 };
	StringIntConCat(&Var0, Global_104500[iLocal_217] + 1, 16);
	func_43(&uLocal_37, 3, iLocal_208, &Local_205, 0, 1);
	if (bLocal_266)
	{
		iVar1 = 1;
...
int func_56()
{
	if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_208, -2017877118) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_208, -2017877118) != 0)
	{
		return 0;
	}
	return 1;
...
void func_60(char* sParam0)
{
	...
	StringIntConCat(sParam0, Global_104500[iLocal_217] + 1, 16);
}
...
void func_62(int iParam0, bool bParam1)
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (func_71(iParam0))
		{
			if (!func_69(iParam0))
			{
				MISC::SET_BIT(&(Global_104555.f_26404.f_2), iVar0);
				if (!bParam1)
				{
...
int func_69(int iParam0)
{
	if (func_71(iParam0))
	{
		return MISC::IS_BIT_SET(Global_104555.f_26404.f_2, iParam0);
	}
	return 0;
}
...
int func_70(int iParam0)
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		return MISC::IS_BIT_SET(Global_104555.f_26404.f_2, iVar0);
	}
	return 0;
}
...
void func_95(int iParam0, bool bParam1)
{
	...
	{
		BRAIN::TASK_PLAY_ANIM(iLocal_208, &cLocal_234, &Local_203, 1000f, 1000f, -1, 0, 0, 0, 0, 0);
	}
	Local_252 = { Local_203 };
	if (bParam1)
	{
