...
void __EntryFunction__()
{
	...
	iVar1712 = 0;
	fVar1713 = 0f;
	uVar1714 = func_328(25);
	uVar1715 = func_328(17);
	func_327(&Var0, uVar1714, uVar1715);
	iVar1716 = 0;
	iVar1717 = (1 - iVar1716);
	...
	while (true)
	{
		...
		func_2(&(Var0.f_281));
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tennis")) > 0)
		{
			func_301(2, 140);
			func_307(&Var0);
		}
...
void func_3(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	if (func_283(uParam0, iVar18, *iParam2, func_306(uParam1)))
	{
		...
		SET_ENTITY_COORDS(uParam0->f_247, func_282(&(uParam0->f_247)), 1, 0, 0, 0);
	...
	switch (func_306(uParam1))
	{
		case 0:
			...
			{
				CLEAR_PRINTS();
				SET_ENTITY_COORDS((uParam0[iParam3 /*94*/])->f_32, func_269(&(uParam0->f_189), func_271(uParam1), uParam0->f_1661, uParam0->f_1658, iParam3 == func_270(uParam1), iParam3), 1, 1, 0, 1);
		...
		case 4:
			if (func_267(uParam0))
			{
				if (uParam0->f_1657 == 1)
				{
					...
					func_265(uParam0[iParam3 /*94*/], CREATE_PED(1, uParam0->f_1669, vVar23, GET_HEADING_FROM_VECTOR_2D(uParam0->f_1658, uParam0->f_1658.f_1), 0, 0));
					...
					func_265(uParam0[iParam4 /*94*/], CREATE_PED(1, uParam0->f_1668, vVar3, GET_HEADING_FROM_VECTOR_2D(-uParam0->f_1658, -uParam0->f_1658.f_1), 0, 0));
					...
					{
						func_258(uParam0);
						SET_PED_COMPONENT_VARIATION(func_264(uParam0[iParam4 /*94*/]), 0, 0, 0, 0);
						SET_PED_COMPONENT_VARIATION(func_264(uParam0[iParam4 /*94*/]), 2, 0, 0, 0);
						SET_PED_COMPONENT_VARIATION(func_264(uParam0[iParam4 /*94*/]), 3, 0, 0, 0);
						SET_PED_COMPONENT_VARIATION(func_264(uParam0[iParam4 /*94*/]), 4, 0, 0, 0);
						SET_PED_COMPONENT_VARIATION(func_264(uParam0[iParam4 /*94*/]), 5, 0, 0, 0);
						SET_PED_COMPONENT_VARIATION(func_264(uParam0[iParam4 /*94*/]), 7, 0, 0, 0);
					}
				}
			}
			break;
		...
		case 8:
			...
			bVar26 = (GET_GAME_TIMER() > func_253(uParam0[iParam3 /*94*/]) && GET_GAME_TIMER() > func_253(uParam0[iParam4 /*94*/]));
		...
		case 9:
			...
			else
			{
				...
				if (IS_ENTITY_PLAYING_ANIM(func_264(uParam0[func_270(uParam1) /*94*/]), sVar31, "serve", 3))
				{
					if (uParam0->f_1657 == 1 && DOES_ENTITY_EXIST(uParam0->f_247))
					{
						fVar32 = GET_ENTITY_ANIM_CURRENT_TIME(func_264(uParam0[func_270(uParam1) /*94*/]), sVar31, "serve");
		...
		case 10:
			...
			if (GET_FRAME_COUNT() > func_105(&(uParam0->f_247)) && func_104(uParam0[(1 - func_270(uParam1)) /*94*/], 256))
			{
			...
			vVar14 = { func_282(&(uParam0->f_247)) };
			if (vVar14.z < (uParam0->f_189.f_3[0 /*3*/].f_2 - 1f) && VDIST2(uParam0->f_189.f_29, func_282(&(uParam0->f_247))) < (26.75f * 26.75f))
			{
				func_103(uParam1, (1 - func_270(uParam1)));
				func_268(uParam1, 14);
			}
		...
		case 12:
			...
			else if (vVar14.z < (uParam0->f_189.f_3[0 /*3*/].f_2 - 1f) && VDIST2(uParam0->f_189.f_29, func_282(&(uParam0->f_247))) < (26.75f * 26.75f))
			{
				func_103(uParam1, (1 - func_177(uParam1)));
				func_268(uParam1, 14);
				if (func_63(uParam1) != iParam3 && uParam0->f_1657 != 1)
			...
			else if (GET_FRAME_COUNT() > func_105(&(uParam0->f_247)) && func_104(uParam0[(1 - func_177(uParam1)) /*94*/], 256))
			{
				func_103(uParam1, func_177(uParam1));
				func_268(uParam1, 14);
				func_102(iParam2);
			...
			{
				TASK_STAND_STILL(func_264(uParam0[iParam4 /*94*/]), -1);
			}
			break;
		...
		case 20:
			...
			else if (((GET_GAME_TIMER() > func_22(uParam0) && func_228(uParam0, 4)) && DOES_ENTITY_EXIST(uParam0->f_247)) && !IS_ENTITY_ATTACHED(uParam0->f_247))
			{
				func_266(uParam0, 1);
				func_194(uParam0[func_270(uParam1) /*94*/], &(uParam0->f_247));
...
void func_5(var uParam0, var uParam1, var uParam2)
{
	...
	if (!IS_PED_INJURED(iVar0))
	{
		...
		if (iVar6 == 75)
		{
			...
			{
				if (!IS_TENNIS_MODE(func_264(uParam0)))
				{
	...
	if (!func_104(uParam0, 1024))
	{
		...
		if (func_75(uParam0) == 72 || func_75(uParam0) == 73)
		{
			if (func_11(uParam0) != 0)
			{
				...
				_0x8FA9C42FC5D7C64B(iParam1, iVar15, func_10(uParam0), func_9(uParam0), 1065353216, 0);
				func_8(uParam0, GET_GAME_TIMER() + 2871);
			}
		}
		else
		{
			_0xE266ED23311F24D4(iParam1, sVar1, &Var2, fVar12, func_7(uParam0), 0);
		}
...
void func_21(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	{
		if (DOES_ENTITY_EXIST(func_264(uParam1)))
		{
			if (IS_TENNIS_MODE(func_264(uParam1)))
			{
				SET_PED_RESET_FLAG(func_264(uParam1), 69, 1);
			}
			SET_PED_RESET_FLAG(func_264(uParam1), 102, 1);
		}
	}
}
...
{
	if (!((!IS_PED_INJURED(func_264(uParam0)) && _0x921CE12C489C4C41(func_264(uParam0))) && ARE_STRINGS_EQUAL(_0x717E4D1F2048376D(func_264(uParam0)), "running")))
	{
		_TASK_MOVE_NETWORK(func_264(uParam0), sParam1, fParam2, 0, "mini@tennis", 4);
	}
}
...
int func_40(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2539502[iParam0 /*3*/][func_38(iParam1)];
...
void func_53(var uParam0, var uParam1)
{
	...
	if (!func_104(uParam0, 2048) && func_55(uParam0->f_37, uParam1))
	{
		if (GET_SCRIPT_TASK_STATUS(func_264(uParam0), 713668775) != 1 && GET_SCRIPT_TASK_STATUS(func_264(uParam0), 242628503) != 1)
		{
			...
			TASK_FOLLOW_NAV_MESH_TO_COORD(func_264(uParam0), uParam1->f_29 + vVar0, 2f, 20000, 1048576000, 0, 1193033728);
...
void func_57(var uParam0, var uParam1, vector3 vParam2)
{
	...
	{
		iVar0 = func_50(GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.5f, 0, 3);
...
bool func_76(vector3 vParam0, vector3 vParam3, vector3 vParam6, float fParam9)
{
...
Vector3 func_82(var uParam0, var uParam1, vector3 vParam2, var uParam5, float fParam6)
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
Vector3 func_87(vector3 vParam0, var uParam3, vector3 vParam4, vector3 vParam7, var uParam10, var uParam11, var uParam12, var uParam13, int iParam14, var uParam15, float fParam16)
{
	vector3 vVar0;
	int iVar3;
	int iVar4;
...
Vector3 func_89(var uParam0, vector3 vParam1, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, var uParam12)
{
	int iVar0;
	int iVar1;
...
int func_97(var uParam0, int iParam1, var uParam2)
{
	...
	if (HAS_ENTITY_COLLIDED_WITH_ANYTHING(*uParam0) || func_287(uParam0, 16))
	{
		...
		if (VDIST2(*uParam2, func_282(uParam0)) > (26.75f * 26.75f))
		{
			return 1;
		}
	}
...
int func_106(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	if (uParam0->f_31 != 4 && GET_GAME_TIMER() > func_164(uParam0))
	{
	...
	else if (GET_GAME_TIMER() > func_164(uParam0))
	{
		if (VDIST2(func_282(&(uParam1->f_247)), uParam0->f_37) > (0f * 0f))
		{
	...
	{
		if (func_104(uParam0, 4096) && GET_GAME_TIMER() > func_164(uParam0))
		{
		...
		if (func_153(uParam0, vVar11, bVar6))
		{
			...
			if ((iVar4 != 75 && iVar4 != 76) && (uParam0->f_31 == 4 || (uParam0->f_31 != 4 && func_104(uParam0, 512))))
			{
				if (!func_227(&(uParam0->f_4), 8) && !func_227(&(uParam0->f_4), 1))
				{
					...
					func_148(uParam0, GET_FRAME_COUNT() + 2);
					if (uParam0->f_31 == 4)
					{
			...
			else if (iVar4 == 75 && func_145(uParam0, uParam1[iParam3 /*94*/], &(uParam1->f_247), uParam1->f_189.f_29, &fVar5))
			{
				...
				if (fVar5 < 5f)
				{
					...
					fVar36 = TO_FLOAT(func_15(uParam1->f_535[iVar4 /*12*/].f_3));
...
void func_108(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_45(func_264(uParam0)) == 17 && GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.5f)
	{
	...
	if (bParam2 || bParam3)
	{
		...
		{
			PLAY_SOUND_FROM_ENTITY(-1, func_195(uParam0->f_31 != 4, "TENNIS_PLYR_SMASH_MASTER", "TENNIS_NPC_SMASH_MASTER"), func_264(uParam0), 0, 0, 0);
		}
		else if (func_91(uParam1) == 2)
		{
			PLAY_SOUND_FROM_ENTITY(-1, func_195(uParam0->f_31 != 4, "TENNIS_PLYR_SMASH_BACKSLICE_MASTER", "TENNIS_NPC_SMASH_BACKSLICE_MASTER"), func_264(uParam0), 0, 0, 0);
		}
	...
	{
		PLAY_SOUND_FROM_ENTITY(-1, func_195(uParam0->f_31 != 4, "TENNIS_PLYR_LOB_MASTER", "TENNIS_NPC_LOB_MASTER"), func_264(uParam0), 0, 0, 0);
		iVar0 = 60;
	}
	else
	{
		if (func_91(uParam1) == 0)
		{
			PLAY_SOUND_FROM_ENTITY(-1, func_195(uParam0->f_31 != 4, "TENNIS_PLYR_FOREARM_MASTER", "TENNIS_NPC_FOREARM_MASTER"), func_264(uParam0), 0, 0, 0);
		}
		else if (func_91(uParam1) == 2)
		{
			PLAY_SOUND_FROM_ENTITY(-1, func_195(uParam0->f_31 != 4, "TENNIS_PLYR_BACKSLICE_MASTER", "TENNIS_NPC_BACKSLICE_MASTER"), func_264(uParam0), 0, 0, 0);
		}
		else if (func_91(uParam1) == 1)
		{
			PLAY_SOUND_FROM_ENTITY(-1, func_195(uParam0->f_31 != 4, "TENNIS_PLYR_TOPSPIN_MASTER", "TENNIS_NPC_TOPSPIN_MASTER"), func_264(uParam0), 0, 0, 0);
		}
		iVar0 = 80;
	}
	if (uParam0->f_31 != 4)
...
void func_109(var uParam0, char* sParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, int iParam10)
{
	if (!IS_PED_INJURED(func_264(uParam0)))
	{
...
{
	_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, uParam1, uParam2, func_111(iParam3), 0);
}
...
void func_115(var uParam0, bool bParam1)
{
	...
	if (DOES_ENTITY_EXIST(*uParam0))
	{
		vVar0 = { func_116(bParam1, func_282(uParam0), GET_ENTITY_COORDS(*uParam0, 1)) };
	}
	uParam0->f_27 = { vVar0 };
	uParam0->f_30 = { vVar0 };
	uParam0->f_25 = 0f;
...
Vector3 func_120(var uParam0, var uParam1, int iParam2, int iParam3, vector3 vParam4, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
Vector3 func_123(var uParam0, var uParam1, vector3 vParam2, int iParam5)
{
	...
	{
		fVar14 = func_124(0.4f, 1f, GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216));
...
int func_133(var uParam0, var uParam1, vector3 vParam2, bool bParam5)
{
	...
	if (!IS_PED_INJURED(func_264(uParam0)) && _0xE95B0C7D5BA3B96B(func_264(uParam0)))
	{
		return 0;
	}
	...
	fVar4 = VDIST2(vVar0, func_135(uParam0));
	...
	vVar14 = { GET_PED_BONE_COORDS(func_264(uParam0), 60309, 0f, 0f, 0f) };
	vVar17 = { vVar0 - vVar14 };
...
int func_134(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	vector3 vVar0;
	var uVar3;
	var uVar6;
...
void func_137(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, vector3 vParam6, bool bParam9)
{
	...
	if (!func_104(uParam1, 1024))
	{
		...
		if ((1 && !func_227(&((uParam0[iParam3 /*94*/])->f_4), 256)) && GET_GAME_TIMER() > func_253(uParam0[iParam3 /*94*/]))
		{
			iParam5 = (1 - iParam5);
			if (bParam9)
			{
...
int func_143(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, float fParam7, float fParam8, var uParam9)
{
	...
	*fParam8 = _0x7F8F6405F4777AF6(vVar9, func_116(bParam6, *uParam5, *uParam4), func_116(bParam6, *uParam4, *uParam5), 0);
...
int func_145(var uParam0, var uParam1, var uParam2, vector3 vParam3, var uParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (uParam0->f_31 != 4)
	{
		...
		if (VDIST2(uParam0->f_37, func_282(uParam2)) > (20f * 20f))
		{
			return 0;
		}
...
int func_153(var uParam0, vector3 vParam1, bool bParam4)
{
	if (!bParam4)
	{
		return 0;
...
void func_161(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	*uParam3 = 0;
	...
	{
		case 2:
			if (DOES_ENTITY_EXIST(uParam1->f_247) && func_285(&(uParam1->f_247)) > 0)
			{
				fVar0 = GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216);
...
int func_166(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, vector3 vParam6, bool bParam9)
{
	...
	while (uParam1->f_247.f_33 <= 0f)
	{
		...
		*uParam2 = { uParam1->f_1583[iVar0 /*3*/] };
		...
		if (iVar1 == 1)
		{
			...
			{
				func_165(uParam0);
				func_173(uParam0, (TO_FLOAT(iVar0) * GET_FRAME_TIME()));
			}
		}
		if (!func_172(*uParam2))
		{
...
void func_171(var uParam0, vector3 vParam1, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
void func_178(var uParam0, var uParam1, bool bParam2)
{
	if (DOES_ENTITY_EXIST(*uParam1))
	{
		if (bParam2)
		{
			if (!IS_PED_INJURED(func_264(uParam0)))
			{
				TASK_LOOK_AT_ENTITY(func_264(uParam0), *uParam1, -1, 6, 2);
			}
		}
		else if (!IS_PED_INJURED(func_264(uParam0)))
		{
			TASK_CLEAR_LOOK_AT(func_264(uParam0));
		}
	}
}
...
int func_182(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (!bParam3)
	{
		if (((func_252(uParam0) > func_191(uParam1) && func_75(uParam2) == 75) && uParam0->f_1657 != 1) || (((func_252(uParam0) > func_191(uParam1) && func_75(uParam2) == 75) && uParam0->f_1657 == 1) && IS_SCREEN_FADED_IN()))
		{
			func_233(uParam2, 74);
			func_214(uParam0, 0);
		}
	...
	if (func_104(uParam2, 4))
	{
		...
		else if (uParam2->f_4.f_20 == 0)
		{
			...
			iVar0 = func_50(GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.2f, 6, uVar12);
		}
		else if (uParam2->f_4.f_20 == 1)
		{
			uVar12 = GET_RANDOM_INT_IN_RANGE(1, 4);
			iVar0 = func_50(GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.1f, 6, uVar12);
		}
		else if (uParam2->f_4.f_20 == 2)
		{
			iVar0 = GET_RANDOM_INT_IN_RANGE(0, 2);
		}
		vVar6 = { func_122(vVar9, vVar6, GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216)) };
		...
		*uParam2 = fVar5;
		...
		if (iVar0 == 1 || iVar0 == 0)
		{
			PLAY_SOUND_FROM_ENTITY(-1, func_195(uParam0->f_1657 == 1, "TENNIS_AMB_SMASH_MASTER", "TENNIS_NPC_SMASH_MASTER"), func_264(uParam2), 0, 0, 0);
		}
		else
		{
			PLAY_SOUND_FROM_ENTITY(-1, func_195(uParam0->f_1657 == 1, "TENNIS_AMB_SERVE_MASTER", "TENNIS_NPC_SERVE_MASTER"), func_264(uParam2), 0, 0, 0);
		}
...
void func_183(var uParam0, var uParam1, var uParam2)
{
	...
	uVar0 = *uParam1;
	vVar1 = { func_184(TO_FLOAT(*uParam2), TO_FLOAT(uParam2->f_1), uVar0, &(uParam1->f_40), &(uParam1->f_43)) };
	if (DOES_ENTITY_EXIST(uParam0->f_247))
	{
		if (uParam0->f_1657 != 1 && !func_274(&(uParam0->f_247)))
		{
...
Vector3 func_184(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	vector3 vVar0;
	vector3 vVar3;
	
	vVar0 = { func_189(*uParam3) };
	func_185(&vVar0, uParam2, 0f, 0f, 1f);
	vVar3 = { func_189(*uParam4) };
	func_185(&vVar0, uParam1, vVar3);
	vVar0 = { vVar0 * Vector(fParam0, fParam0, fParam0) };
	return vVar0;
}

void func_185(var uParam0, var uParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
...
var func_190(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5)
{
...
int func_198(var uParam0, var uParam1, int iParam2, var uParam3, bool bParam4)
{
	...
	{
		func_158(uParam0);
		if ((IS_CONTROL_JUST_PRESSED(0, 223) && !bParam4) || (func_160(uParam0) > 30f && uParam1->f_1657 == 4))
		{
			...
			if (func_104(uParam0, 64))
			{
				if (func_204(uParam0) > 0.965f)
				{
					*uParam3 = { uParam1->f_282[0 /*2*/] };
					PLAY_SOUND_FROM_ENTITY(-1, "TENNIS_PLYR_SMASH_MASTER", func_264(uParam0), 0, 0, 0);
				...
				else if (func_204(uParam0) > 0.7f)
				{
					*uParam3 = { uParam1->f_282[2 /*2*/] };
					...
					PLAY_SOUND_FROM_ENTITY(-1, "TENNIS_PLYR_SERVE_MASTER", func_264(uParam0), 0, 0, 0);
				}
		...
		if (func_160(uParam0) > 30f || (IS_CONTROL_JUST_PRESSED(0, 223) && !bParam4))
		{
			func_159(uParam0);
		}
	}
...
void func_200(var uParam0)
{
	if (func_211(uParam0))
	{
		if (!func_210(uParam0))
		{
			uParam0->f_2 = (func_201(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
			SET_BIT(uParam0, 2);
		}
	}
}
...
int func_202(var uParam0, var uParam1, int iParam2, var uParam3)
{
	float fVar0;
	vector3 vVar1;
	vector3 vVar4;
...
void func_205(var uParam0)
{
	if (func_211(uParam0))
	{
		if (func_210(uParam0))
		{
			uParam0->f_1 = (func_201(IS_BIT_SET(*uParam0, 4)) - uParam0->f_2);
			uParam0->f_2 = 0f;
			CLEAR_BIT(uParam0, 2);
		}
	}
...
{
	uParam0->f_1 = (func_201(IS_BIT_SET(*uParam0, 4)) - fParam1);
	SET_BIT(uParam0, 1);
	CLEAR_BIT(uParam0, 2);
	uParam0->f_2 = 0f;
}
...
float func_209(var uParam0)
{
	if (func_211(uParam0))
	{
		...
		{
			return (func_201(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	if (!IS_PED_INJURED(func_264(uParam0[iParam1 /*94*/])) && GET_SCRIPT_TASK_STATUS(func_264(uParam0[iParam1 /*94*/]), 242628503) != 7)
	{
		return 0;
	}
	else if ((!IS_PED_INJURED(func_264(uParam0[iParam1 /*94*/])) && ((bParam4 || iParam3 == 4) || iParam3 == 1)) && !func_104(uParam0[iParam1 /*94*/], 8192))
	{
		if (iParam1 == iParam2)
		{
			func_28(uParam0[iParam1 /*94*/], "TennisServeSet", 0f);
		...
		_0x2208438012482A1A(func_264(uParam0[iParam1 /*94*/]), 0, 0);
		func_58(uParam0[iParam1 /*94*/], 8192);
	}
	else if (func_104(uParam0[iParam1 /*94*/], 8192) && iParam1 == iParam2)
	{
		if (!IS_PED_INJURED(func_264(uParam0[iParam1 /*94*/])) && _0x921CE12C489C4C41(func_264(uParam0[iParam1 /*94*/])))
		{
			if (ARE_STRINGS_EQUAL(_0x717E4D1F2048376D(func_264(uParam0[iParam1 /*94*/])), "Intro") && _0x30ED88D5E0C56A37(func_264(uParam0[iParam1 /*94*/])))
			{
				_0xD01015C7316AE176(func_264(uParam0[iParam1 /*94*/]), "running");
			}
		}
	}
	return 1;
...
void func_217(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if ((uParam0->f_31 != 4 && !IS_PED_INJURED(func_264(uParam0))) && !bParam5)
	{
	...
	if (!IS_PED_INJURED(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		if ((uParam1->f_1657 != 1 && !bParam5) && !func_223(PLAYER_ID(), 0))
		{
		...
		else
		{
			...
			fVar4 = (GET_HEADING_FROM_VECTOR_2D(uParam0->f_40, uParam0->f_40.f_1) + func_144(bParam6, 180f, 0f));
			...
			if (!bParam6 && bParam7)
			{
				...
				TASK_PLAY_ANIM(0, func_195(func_196(uParam0), "mini@tennis", "mini@tennis@female"), "idle", 1.5f, -8f, iVar10, 0, 0, 0, 0, 0);
			}
			if (!bParam8)
			{
			...
			SET_PED_WEAPON_MOVEMENT_CLIPSET(func_264(uParam0), "weapons@tennis@male");
			func_80(&(uParam0->f_4), 4);
		}
	}
	if (bParam4 && DOES_ENTITY_EXIST(func_264(uParam0)))
	{
		_0x2208438012482A1A(func_264(uParam0), 0, 0);
	}
}

int func_218(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, float fParam6)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_226(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	if ((uParam0->f_31 != 4 && !IS_PED_INJURED(func_264(uParam0))) && !bParam7)
	{
		func_231(uParam1->f_1657, 1);
	}
	func_233(uParam0, 75);
	...
	if (!IS_PED_INJURED(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		if ((uParam1->f_1657 != 1 && !bParam7) && !func_223(PLAYER_ID(), 0))
		{
			if (!((!IS_PED_INJURED(func_264(uParam0)) && _0x921CE12C489C4C41(func_264(uParam0))) && ARE_STRINGS_EQUAL(_0x717E4D1F2048376D(func_264(uParam0)), "running")))
			{
				func_222(uParam1, iParam3, 1);
		...
		else
		{
			SET_ENTITY_HEADING(uParam0->f_32, GET_ENTITY_HEADING(uParam0->f_32));
			func_58(uParam0, 16384);
			fVar4 = (GET_HEADING_FROM_VECTOR_2D(uParam0->f_40, uParam0->f_40.f_1) + func_144(bParam8, 180f, 0f));
			vVar5 = { uParam1->f_189.f_29 - GET_ENTITY_COORDS((uParam1[iParam3 /*94*/])->f_32, 1) };
			bVar8 = func_69(vVar5, uParam0->f_40) < 0f;
			bVar9 = func_69(vVar5, uParam0->f_43) < 0f;
			func_221(uParam0, 0);
...
void func_235(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	if (((uParam0->f_31 != 3 && !bParam4) && !IS_PED_INJURED(func_264(uParam0))) && !IS_PED_RAGDOLL(func_264(uParam0)))
	{
		if ((IS_TENNIS_MODE(func_264(uParam0)) && !func_196(uParam0)) && !func_104(uParam0, 16384))
		{
			SET_PED_WEAPON_MOVEMENT_CLIPSET(func_264(uParam0), "TENNIS_LOCOMOTION_FEMALE");
		}
		func_128(&iVar0, &iVar1, &uVar2, &uVar2, 1, 1);
		fVar3 = ABSF(TO_FLOAT(iVar0));
		if ((fVar3 > 0f || ABSF(TO_FLOAT(iVar1)) > 0f) && uParam0->f_31 != 4)
		{
			SET_PED_MIN_MOVE_BLEND_RATIO(func_264(uParam0), 2f);
		}
		if ((func_75(uParam0) != 74 && uParam0->f_31 != 4) && fVar3 > 15f)
		{
			func_249(uParam0, (func_250(uParam0) + GET_FRAME_TIME()));
		}
		else
		{
			func_249(uParam0, 0f);
		...
		if (IS_TENNIS_MODE(func_264(uParam0)) && fVar5 < 0f)
		{
			fVar6 = func_69(uParam0->f_43, func_282(&(uParam1->f_247)) - uParam0->f_37);
			_0x54F157E0336A3822(func_264(uParam0), "ForcedStopDirection", fVar6);
		}
	}
	else if (uParam0->f_31 != 3)
	{
		...
		if (!IS_PED_INJURED(func_264(uParam0)) && _0x921CE12C489C4C41(func_264(uParam0)))
		{
			if (ARE_STRINGS_EQUAL(_0x717E4D1F2048376D(func_264(uParam0)), "Intro") && _0x30ED88D5E0C56A37(func_264(uParam0)))
			{
				_0xD01015C7316AE176(func_264(uParam0), "running");
			}
			...
			if (_0xB4F47213DF45A64C(func_264(uParam0), "IdleStarted"))
			{
			...
			_SET_TASK_PROPERTY_BOOL(func_264(uParam0), &(uParam1->f_1670), 1);
			_SET_TASK_PROPERTY_FLOAT(func_264(uParam0), "Speed", uParam0->f_62);
		}
	}
	if (((func_75(uParam0) == 75 && DOES_ENTITY_EXIST(uParam1->f_247)) && HAS_ENTITY_COLLIDED_WITH_ANYTHING(uParam1->f_247)) && VDIST2(uParam0->f_37, func_282(&(uParam1->f_247))) < (0.88f * 0.88f))
	{
		func_58(uParam0, 256);
	...
	if ((GET_RAIN_LEVEL() <= 0f && GET_SNOW_LEVEL() <= 0f) && func_75(uParam0) == 75)
	{
		if (ABSF(TO_FLOAT(iParam1)) >= ABSF(TO_FLOAT(iParam2)))
		{
			if (iParam1 > 15)
			{
				...
				{
					PLAY_SOUND_FROM_ENTITY(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_264(uParam0), 0, 0, 0);
				}
...
void func_238(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	switch (func_147(&(uParam0->f_4)))
	{
		...
		case 5:
			if (func_75(uParam0) == 75)
			{
				...
				{
					TASK_GO_STRAIGHT_TO_COORD(func_264(uParam0), vVar3, 2f, -1, 1193033728, 1056964608);
				...
				else if ((IS_ENTITY_AT_COORD(uParam0->f_32, func_70(&(uParam0->f_4)), vVar6, 0, 1, 0) || GET_SCRIPT_TASK_STATUS(func_264(uParam0), 2106541073) == 7) && !func_227(&(uParam0->f_4), 256))
				{
					func_234(&(uParam0->f_4), 0);
					func_216(&(uParam0->f_4), 4);
				}
		...
		case 1:
			if (func_75(uParam0) == 75)
			{
				_0xF56DFB7B61BE7276(func_282(uParam4), func_282(uParam4) + uParam4->f_10, uParam0->f_37, uParam0->f_40, &fVar9);
				...
				if (((!IS_PED_INJURED(func_264(uParam0)) && !VDIST2(uParam0->f_37, vVar3) <= (0f * 0f)) && !func_227(&(uParam0->f_4), 4)) && !func_104(uParam0, 1024))
				{
					TASK_GO_STRAIGHT_TO_COORD(uParam0->f_32, func_70(&(uParam0->f_4)), 2f, -1, 1193033728, 1056964608);
					vVar3 = { func_70(&(uParam0->f_4)) };
					func_241(&(uParam0->f_4), vVar3);
					func_80(&(uParam0->f_4), 4);
...
void func_244(var uParam0, var uParam1)
{
	...
	if (GET_GAME_TIMER() > func_246(&(uParam0->f_4)))
	{
		...
		func_245(&(uParam0->f_4), GET_GAME_TIMER() + 500);
	}
}
...
{
	if (!IS_PED_INJURED(func_264(uParam0[iParam1 /*94*/])) && !IS_PED_INJURED(func_264(uParam0[iParam2 /*94*/])))
	{
		if (!bParam3)
		{
			if (!bParam4)
			{
				ATTACH_ENTITY_TO_ENTITY((uParam0[iParam1 /*94*/])->f_33, func_264(uParam0[iParam1 /*94*/]), GET_PED_BONE_INDEX(func_264(uParam0[iParam1 /*94*/]), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			}
			ATTACH_ENTITY_TO_ENTITY((uParam0[iParam2 /*94*/])->f_33, func_264(uParam0[iParam2 /*94*/]), GET_PED_BONE_INDEX(func_264(uParam0[iParam2 /*94*/]), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
		else
		{
			if (!bParam4)
			{
				ATTACH_ENTITY_TO_ENTITY((uParam0[iParam1 /*94*/])->f_33, func_264(uParam0[iParam1 /*94*/]), GET_PED_BONE_INDEX(func_264(uParam0[iParam1 /*94*/]), 28422), vLocal_309, vLocal_312, 0, 0, 0, 0, 2, 1);
			}
			ATTACH_ENTITY_TO_ENTITY((uParam0[iParam2 /*94*/])->f_33, func_264(uParam0[iParam2 /*94*/]), GET_PED_BONE_INDEX(func_264(uParam0[iParam2 /*94*/]), 28422), vLocal_309, vLocal_312, 0, 0, 0, 0, 2, 1);
		}
	}
}
...
Vector3 func_269(var uParam0, int iParam1, vector3 vParam2, vector3 vParam5, bool bParam8, int iParam9)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
...
void func_272(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	iVar1 = (1 - iVar0);
	if (!IS_PED_INJURED(func_264(uParam0[iVar0 /*94*/])) && GET_SCRIPT_TASK_STATUS(func_264(uParam0[iVar0 /*94*/]), 242628503) == 1)
	{
		*uParam2 = GET_SEQUENCE_PROGRESS(func_264(uParam0[iVar0 /*94*/]));
	}
	if (!IS_PED_INJURED(func_264(uParam0[iVar1 /*94*/])) && GET_SCRIPT_TASK_STATUS(func_264(uParam0[iVar1 /*94*/]), 242628503) == 1)
	{
	...
	if (func_104(uParam0[iVar0 /*94*/], 16384) && *uParam2 > 0)
	{
		...
		SET_PED_WEAPON_MOVEMENT_CLIPSET(func_264(uParam0[iVar0 /*94*/]), "weapons@tennis@male");
	}
	if (func_104(uParam0[iVar1 /*94*/], 16384) && *uParam3 > 0)
	{
		func_276(uParam0[iVar1 /*94*/], 16384);
		func_260(func_264(uParam0[iVar1 /*94*/]), 0);
		SET_PED_WEAPON_MOVEMENT_CLIPSET(func_264(uParam0[iVar1 /*94*/]), "weapons@tennis@male");
	}
}
...
int func_278(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, bool bParam8, float fParam9, bool bParam10, float fParam11, bool bParam12)
{
	...
	vVar0 = { 0f, 0f, 1f };
	fVar3 = func_144(fParam9 == -1f, GET_FRAME_TIME(), fParam9);
	iVar4 = 0;
...
Vector3 func_279(vector3 vParam0, float fParam3)
{
	vector3 vVar0;
	float fVar3;
	vector3 vVar4;
...
int func_304(var uParam0, int iParam1, int iParam2)
{
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()) && IS_PED_SHOOTING(PLAYER_PED_ID()))
	{
		...
		if (!IS_PED_INJURED(func_264(uParam0[(1 - iParam1) /*94*/])))
		{
			TASK_SEEK_COVER_FROM_PED(func_264(uParam0[(1 - iParam1) /*94*/]), PLAYER_PED_ID(), -1, 0);
		}
		return 1;
	}
	if (IS_PED_INJURED(uVar0))
...
void func_311(float fParam0, var uParam1, var uParam2)
{
	...
	*fParam0 = (*fParam0 + GET_FRAME_TIME());
	if ((((*fParam0 > (5f + GET_RANDOM_FLOAT_IN_RANGE(0f, 5f)) && func_75(uParam2) == 75) && !IS_PED_INJURED(func_264(uParam2))) && !IS_PED_INJURED(PLAYER_PED_ID())) && func_76(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), uParam1->f_3[0 /*3*/] + FtoV((fVar2 * 0.5f)) * uParam1->f_52, uParam1->f_3[3 /*3*/] + FtoV((fVar2 * 0.5f)) * uParam1->f_52, (fVar2 * 1.5f)))
	{
...
void func_327(var uParam0, var uParam1, var uParam2)
{
	...
	uParam0->f_1668 = uParam1;
	uParam0->f_1669 = uParam2;
}
