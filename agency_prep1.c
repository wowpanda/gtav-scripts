...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!iLocal_1125)
		{
			if (!IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_1120, 200f, 200f, 200f, 0, 1, 0) && !IS_SPHERE_VISIBLE(vLocal_1120, 50f))
			{
				CLEAR_AREA(vLocal_1120, 50f, 1, 0, 0, 0);
				iLocal_1125 = 1;
			}
		}
		else if (!IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_1120, 200f, 200f, 200f, 0, 1, 0))
		{
			iLocal_1125 = 0;
		}
		if (!iLocal_1130)
		{
			if (Global_90209.f_358 == GET_HASH_KEY("AHP1_TRUCKCALLED") || Global_90139)
			{
				func_90(543);
		...
		while (iVar0 <= 7)
		{
			if ((DOES_ENTITY_EXIST(iLocal_943[iVar0]) && !IS_PED_INJURED(iLocal_943[iVar0])) && DOES_ENTITY_EXIST(iLocal_941))
			{
				if (VDIST2(GET_ENTITY_COORDS(iLocal_943[iVar0], 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) > 2500f)
				{
					SET_PED_KEEP_TASK(iLocal_943[iVar0], 1);
					TASK_SMART_FLEE_PED(iLocal_943[iVar0], PLAYER_PED_ID(), 300f, 20000, 1, 0);
					SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_943[iVar0]));
				}
			}
			iVar0++;
		}
		...
		switch (iLocal_1118)
		{
			case -1:
				...
				{
					if (DOES_ENTITY_EXIST(iLocal_943[iVar1]))
					{
						if (DOES_ENTITY_EXIST(SET_EXCLUSIVE_PHONE_RELATIONSHIPS(PLAYER_PED_ID())))
						{
							uVar2 = SET_EXCLUSIVE_PHONE_RELATIONSHIPS(PLAYER_PED_ID());
							if ((IS_VEHICLE_DRIVEABLE(uVar2, 0) && VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(uVar2, 1)) < 30f) && IS_VEHICLE_MODEL(uVar2, joaat("firetruk")))
							{
								SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_952);
								SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_952, 1862763509);
			...
			case 0:
				if (!DOES_ENTITY_EXIST(iLocal_941))
				{
					func_86();
					if ((DOES_ENTITY_EXIST(GET_PLAYERS_LAST_VEHICLE()) && IS_VEHICLE_DRIVEABLE(GET_PLAYERS_LAST_VEHICLE(), 0)) && GET_ENTITY_MODEL(GET_PLAYERS_LAST_VEHICLE()) == joaat("firetruk"))
					{
						iLocal_941 = GET_PLAYERS_LAST_VEHICLE();
						SET_ENTITY_AS_MISSION_ENTITY(iLocal_941, 1, 1);
					}
				}
				else
				{
					func_44();
					if (!iLocal_1126 && IS_VEHICLE_DRIVEABLE(iLocal_941, 0))
					{
					...
					if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_1120) < POW(100f, 2f))
					{
					...
					if (bLocal_1131)
					{
						if (IS_VEHICLE_DRIVEABLE(iLocal_941, 0) && IS_VEHICLE_DRIVEABLE(iLocal_942, 0))
						{
							func_35(iLocal_942);
							if (IS_PED_SITTING_IN_VEHICLE(PLAYER_PED_ID(), iLocal_942) && IS_ENTITY_AT_COORD(iLocal_941, vLocal_1120, Global_19, 1, 1, 0))
							{
					...
					else if (IS_VEHICLE_DRIVEABLE(iLocal_941, 0))
					{
						func_35(iLocal_941);
						if (IS_PED_SITTING_IN_VEHICLE(PLAYER_PED_ID(), iLocal_941) && IS_ENTITY_AT_COORD(iLocal_941, vLocal_1120, Global_19, 1, 1, 0))
						{
							if (DOES_BLIP_EXIST(uLocal_939))
							{
								REMOVE_BLIP(&uLocal_939);
				...
				{
					if ((VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(iLocal_941, 1)) > 22500f && IS_ENTITY_OCCLUDED(iLocal_941)) || VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(iLocal_941, 1)) > 90000f)
					{
						func_14("AHP_LOSTTRUCK");
					}
				}
			...
			case 1:
				if (IS_VEHICLE_DRIVEABLE(iLocal_941, 0))
				{
			...
			case 2:
				if (IS_VEHICLE_DRIVEABLE(iLocal_941, 0))
				{
					if (!IS_ENTITY_AT_COORD(iLocal_941, vLocal_1120, Global_19 + Vector(2f, 2f, 2f), 1, 1, 0))
					{
						iLocal_1118 = 0;
					}
					else if (bLocal_1131)
					{
						if (DOES_ENTITY_EXIST(iLocal_942))
						{
							if (!IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_942, iLocal_941))
							{
								SET_VEHICLE_AUTOMATICALLY_ATTACHES(iLocal_941, 0, 0);
								if (IS_VEHICLE_SIREN_ON(iLocal_941))
								{
									SET_VEHICLE_SIREN(iLocal_941, 0);
								}
								SET_VEHICLE_DOORS_LOCKED(iLocal_941, 2);
								CLEAR_PRINTS();
								SETTIMERA(0);
								iLocal_1118++;
							}
							...
							{
								DETACH_VEHICLE_FROM_TOW_TRUCK(iLocal_942, iLocal_941);
							}
						}
					}
					else if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_941, 0))
					{
						if (IS_VEHICLE_SIREN_ON(iLocal_941))
						{
							SET_VEHICLE_SIREN(iLocal_941, 0);
			...
			case 101:
				...
				if (!iLocal_1132)
				{
					if ((IS_VEHICLE_DRIVEABLE(iLocal_941, 0) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_941, 0)) || (IS_VEHICLE_DRIVEABLE(iLocal_942, 0) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_942, 0)))
					{
				...
				else if (IS_VEHICLE_DRIVEABLE(iLocal_941, 0))
				{
					...
					else if (IS_PED_SITTING_IN_VEHICLE(PLAYER_PED_ID(), iLocal_941))
					{
						if (!iLocal_1128)
						{
							func_11("AHP_LOSECOPS", 7500, 1);
							iLocal_1128 = 1;
							iLocal_1119 = GET_GAME_TIMER();
						}
					}
					else if ((iLocal_1128 && (GET_GAME_TIMER() - iLocal_1119) < 7500) && IS_MESSAGE_BEING_DISPLAYED())
					{
						CLEAR_PRINTS();
					}
					if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(iLocal_941, 1)) > 22500f)
					{
						func_14("AHP_LOSTTRUCK");
					}
				}
...
void func_14(char* sParam0)
{
	...
	if (DOES_ENTITY_EXIST(iLocal_941))
	{
		if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_941, 0))
		{
			DELETE_VEHICLE(&iLocal_941);
		}
	}
	iVar0 = 0;
	while (iVar0 < iLocal_943)
	{
		if (DOES_ENTITY_EXIST(iLocal_943[iVar0]))
		{
			DELETE_PED(&(iLocal_943[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < Global_90209.f_9)
	{
		...
		{
			DELETE_PED(&(Global_90209.f_9[iVar0]));
		}
		iVar0++;
	}
...
int func_17()
{
	if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
	{
		...
		{
			if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 226.6765f, -1668.942f, 25.46082f, 185.6446f, -1635.836f, 39.29184f, 57.75f, 0, 1, 0))
			{
				return 1;
			}
		}
		...
		if (GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0)
		{
			if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
			{
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iParam0, 0))
				{
					...
					{
						REMOVE_BLIP(&uLocal_940);
					}
				}
				else if (!DOES_BLIP_EXIST(uLocal_940))
				{
					uLocal_940 = func_39(iParam0, 0, 0);
				}
			}
		}
		else if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iParam0, 0))
		{
			if (DOES_BLIP_EXIST(uLocal_940))
			{
				REMOVE_BLIP(&uLocal_940);
			...
			if (!DOES_BLIP_EXIST(uLocal_939))
			{
				...
				uLocal_939 = func_36(vLocal_1120, 1);
...
var func_36(vector3 vParam0, int iParam3)
{
	var uVar0;
	
	uVar0 = ADD_BLIP_FOR_COORD(vParam0);
	SET_BLIP_SCALE(uVar0, func_37(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
{
	return func_40(uParam0, !bParam1, bParam2);
}
...
int func_40(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_37(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
void func_44()
{
	...
	if (!IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		{
			case 0:
				if ((IS_VEHICLE_DRIVEABLE(iVar0, 0) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iVar0, 0)) && GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) == 0)
				{
					iVar1 = 0;
					while (iVar1 < 3)
					{
						iVar2 = func_84(iVar1);
						if ((!IS_PED_INJURED(iVar2) && IS_PED_IN_VEHICLE(iVar2, iVar0, 0)) && GET_PED_IN_VEHICLE_SEAT(iVar0, -1, 0) == iVar2)
						{
			...
			case 1:
				...
				{
					if ((((IS_PED_INJURED(func_84(iLocal_1134)) || GET_PED_IN_VEHICLE_SEAT(iVar0, -1, 0) != func_84(iLocal_1134)) || !IS_PED_IN_VEHICLE(func_84(iLocal_1134), iVar0, 0)) || !func_83(func_84(iLocal_1134))) || !IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iVar0, 0))
					{
					...
					else
					{
						switch (iLocal_1165)
						{
							...
							case 1:
								if (_0xF7B79A50B905A30D(Local_1141, Local_1141.f_1, Local_1144, Local_1144.f_1))
								{
									iLocal_1165++;
								}
								break;
							...
							case 2:
								TASK_VEHICLE_DRIVE_TO_COORD(func_84(iLocal_1134), iVar0, vLocal_1120, 15f, 0, joaat("firetruk"), 786484, 5f, 5f);
								if (VDIST(GET_ENTITY_COORDS(iVar0, 1), vLocal_1120) > 250f)
								{
									_0x182F266C2D9E2BEB(iVar0, VDIST(GET_ENTITY_COORDS(iLocal_941, 1), vLocal_1120));
								}
								iLocal_1165++;
								break;
							
							case 3:
								if (IS_ENTITY_IN_ANGLED_AREA(iVar0, 697.6884f, -1013.364f, 27.4968f, 688.3482f, -1013.179f, 22.32968f, 29.25f, 0, 1, 0))
								{
									if (VDIST(GET_ENTITY_COORDS(iVar0, 1), vLocal_1135) < VDIST(GET_ENTITY_COORDS(iVar0, 1), vLocal_1138))
									{
										if (bLocal_1131)
										{
											TASK_VEHICLE_DRIVE_TO_COORD(func_84(iLocal_1134), iVar0, vLocal_1138, 5f, 0, GET_ENTITY_MODEL(iVar0), 262144, 2f, 2f);
										}
										else
										{
											TASK_VEHICLE_PARK(func_84(iLocal_1134), iVar0, vLocal_1120, 180f, 1, 15f, 0);
										}
									}
									else if (bLocal_1131)
									{
										TASK_VEHICLE_DRIVE_TO_COORD(func_84(iLocal_1134), iVar0, vLocal_1135, 5f, 0, GET_ENTITY_MODEL(iVar0), 262144, 2f, 2f);
									}
									else
									{
										TASK_VEHICLE_PARK(func_84(iLocal_1134), iVar0, vLocal_1120, 0f, 1, 15f, 0);
									}
									iLocal_1165++;
								}
								break;
...
void func_45()
{
	...
	bVar0 = false;
	if (!IS_PED_INJURED(func_84(iLocal_1134)) && GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) == 0)
	{
		if ((((DOES_ENTITY_EXIST(iLocal_941) && IS_VEHICLE_DRIVEABLE(iLocal_941, 0)) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_941, 0)) && IS_PED_IN_VEHICLE(func_84(iLocal_1134), iLocal_941, 0)) || (((DOES_ENTITY_EXIST(iLocal_942) && IS_VEHICLE_DRIVEABLE(iLocal_942, 0)) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_942, 0)) && IS_PED_IN_VEHICLE(func_84(iLocal_1134), iLocal_942, 0)))
		{
			bVar0 = true;
		}
	}
	switch (iLocal_1147)
	{
		case 0:
			uVar1 = func_77();
			if (func_65(0, 1, 145, 0, uVar1, &cLocal_1148, &cLocal_1152, 1))
			{
				...
				if (func_28() == 1)
				{
					...
					func_63(&uLocal_953, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
				}
				else
				{
					func_63(&uLocal_953, 1, func_84(1), "FRANKLIN", 0, 1);
					func_63(&uLocal_953, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
				}
				if (!iLocal_1157)
				{
					iLocal_1164 = GET_GAME_TIMER();
				}
				iLocal_1147 = 1;
			}
			break;
		...
		case 1:
			if (bVar0)
			{
				if ((GET_GAME_TIMER() - iLocal_1164) > 5000 || iLocal_1157)
				{
		...
		case 2:
			...
			if (IS_PLAYER_SWITCH_IN_PROGRESS() || (!bLocal_1156 && !func_48()))
			{
				func_46();
				iLocal_1147 = 3;
				iLocal_1164 = GET_GAME_TIMER();
		...
		case 3:
			if ((GET_GAME_TIMER() - iLocal_1164) > 10000)
			{
				iLocal_1147 = 0;
			}
			break;
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, char* sParam5, char* sParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar2 == 7)
	{
		...
		{
			if (func_74(&(Global_106565.f_18097.f_388), iParam3, &iVar3, &iVar4, uParam4))
			{
				if (bParam7)
				{
		...
		else if (func_74(&(Global_106565.f_18097.f_175[iVar5 /*19*/].f_9), iParam3, &iVar3, &iVar4, uParam4))
		{
			if (bParam7)
			{
	...
	else
	{
		...
		if (func_74(&(Global_106565.f_18097.f_347[iVar6 /*7*/]), iParam3, &iVar3, &iVar4, uParam4))
		{
			if (bParam7)
			{
...
{
	*iParam1 = SHIFT_RIGHT(uParam0, 16) & 15;
	*iParam2 = SHIFT_RIGHT(uParam0, 12) & 15;
	*iParam3 = SHIFT_RIGHT(uParam0, 8) & 15;
}

void func_73(var uParam0, int iParam1, int iParam2, int iParam3)
{
	*iParam1 = SHIFT_RIGHT(uParam0, 28) & 15;
	*iParam2 = SHIFT_RIGHT(uParam0, 24) & 15;
	*iParam3 = SHIFT_RIGHT(uParam0, 20) & 15;
}

int func_74(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_77()
{
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (func_78(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)))
		{
			SET_BIT(&iVar0, 20);
		}
	}
...
int func_78(struct<2> Param0, var uParam2)
{
	if (Param0.f_1 < 400f)
	{
		if (Param0 < 1400f)
...
int func_86()
{
	if (((IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && IS_VEHICLE_DRIVEABLE(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0)) && GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0) != iLocal_941) && GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0) != iLocal_942)
	{
		if (IS_VEHICLE_MODEL(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), joaat("firetruk")))
		{
			iLocal_941 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
			SET_ENTITY_AS_MISSION_ENTITY(iLocal_941, 1, 1);
			iLocal_1126 = 0;
			return 1;
		}
		...
		{
			if (DOES_ENTITY_EXIST(GET_ENTITY_ATTACHED_TO_TOW_TRUCK(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0))))
			{
				if (IS_VEHICLE_DRIVEABLE(GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(GET_ENTITY_ATTACHED_TO_TOW_TRUCK(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0))), 0))
				{
					iLocal_942 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
					SET_ENTITY_AS_MISSION_ENTITY(iLocal_942, 1, 1);
					if (GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(GET_ENTITY_ATTACHED_TO_TOW_TRUCK(iLocal_942)) != iLocal_941)
					{
						iLocal_941 = GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(GET_ENTITY_ATTACHED_TO_TOW_TRUCK(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)));
						iLocal_1126 = 0;
						SET_ENTITY_AS_MISSION_ENTITY(iLocal_941, 1, 1);
					}
					return 1;
...
void func_87()
{
	...
	if (iLocal_1166 < 8)
	{
		if (iLocal_1166 < 4)
		{
			if (DOES_ENTITY_EXIST(Global_90209.f_9[iLocal_1166]))
			{
				if (!IS_PED_INJURED(Global_90209.f_9[iLocal_1166]))
				{
					if (VDIST2(GET_ENTITY_COORDS(Global_90209.f_9[iLocal_1166], 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) < 900f)
					{
						SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_9[iLocal_1166], 1, 1);
						iLocal_943[iLocal_1166] = Global_90209.f_9[iLocal_1166];
						bVar0 = true;
						Global_90209.f_9[iLocal_1166] = 0;
					}
					else if (VDIST2(GET_ENTITY_COORDS(Global_90209.f_9[iLocal_1166], 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) > 2500f && IS_ENTITY_OCCLUDED(Global_90209.f_9[iLocal_1166]))
					{
						SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_9[iLocal_1166], 1, 1);
						DELETE_PED(&(Global_90209.f_9[iLocal_1166]));
					}
				}
			}
		}
		if (!bVar0)
		{
			if (GET_CLOSEST_PED(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 30f, 1, 1, &iVar1, 0, 1, 21))
			{
				if ((DOES_ENTITY_EXIST(iVar1) && !IS_PED_INJURED(iVar1)) && !func_88(iVar1, &iLocal_943))
				{
		...
		if (bVar0)
		{
			if (!IS_PED_INJURED(iLocal_943[iLocal_1166]))
			{
				SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_943[iLocal_1166], uLocal_952);
				SET_PLAYER_WANTED_LEVEL_NO_DROP(PLAYER_ID(), 1, 0);
				SET_PED_COMBAT_ATTRIBUTES(iLocal_943[iLocal_1166], 17, 0);
				SET_WANTED_LEVEL_DIFFICULTY(PLAYER_ID(), 0f);
			}
			iLocal_1166++;
		}
...
void func_89()
{
	if (bLocal_1131)
	{
		if (((!IS_VEHICLE_DRIVEABLE(iLocal_942, 0) || (IS_VEHICLE_DRIVEABLE(iLocal_942, 0) && !IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_941, iLocal_942))) || (IS_VEHICLE_DRIVEABLE(iLocal_941, 0) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_941, 0))) || (DOES_ENTITY_EXIST(iLocal_942) && VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(iLocal_942, 1)) > 250f))
		{
			bLocal_1131 = false;
		}
	}
	else if ((IS_VEHICLE_DRIVEABLE(iLocal_942, 0) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_942, 0)) && IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_941, iLocal_942))
	{
		bLocal_1131 = true;
	}
}
...
void func_91()
{
	...
	if ((DOES_ENTITY_EXIST(Global_90209[0]) && IS_VEHICLE_DRIVEABLE(Global_90209[0], 0)) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Global_90209[0], 0))
	{
		SET_ENTITY_AS_MISSION_ENTITY(Global_90209[0], 1, 1);
		iLocal_941 = Global_90209[0];
		Global_90209[0] = 0;
	}
	if ((DOES_ENTITY_EXIST(Global_90209[1]) && IS_VEHICLE_DRIVEABLE(Global_90209[1], 0)) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Global_90209[1], 0))
	{
		if (DOES_ENTITY_EXIST(GET_ENTITY_ATTACHED_TO_TOW_TRUCK(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0))) && IS_VEHICLE_DRIVEABLE(GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(GET_ENTITY_ATTACHED_TO_TOW_TRUCK(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0))), 0))
		{
	...
	ADD_RELATIONSHIP_GROUP("FireMen", &uLocal_952);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_952);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_952, 1862763509);
	if (func_10(0))
	{
		...
		uLocal_1167 = ADD_SCENARIO_BLOCKING_AREA(vVar0 - Vector(10f, 30f, 30f), vVar0 + Vector(10f, 30f, 30f), 0, 1, 1, 1);
		CLEAR_AREA(vVar0, 20f, 1, 0, 0, 0);
		iLocal_943[0] = CREATE_PED(21, joaat("s_m_y_fireman_01"), 215.7186f, -1644.622f, 28.7719f, 357.5736f, 1, 1);
		iLocal_943[1] = CREATE_PED(21, joaat("s_m_y_fireman_01"), 214.4446f, -1643.72f, 28.7776f, 279.1055f, 1, 1);
		iLocal_943[2] = CREATE_PED(21, joaat("s_m_y_fireman_01"), 217.0826f, -1644.117f, 28.7155f, 72.8262f, 1, 1);
		iVar3 = 0;
		while (iVar3 <= (iLocal_943 - 1))
		{
			if (!IS_PED_INJURED(iLocal_943[iVar3]))
			{
				TASK_START_SCENARIO_IN_PLACE(iLocal_943[iVar3], "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
				SET_PED_COMBAT_ATTRIBUTES(iLocal_943[iVar3], 17, 0);
				SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_943[iVar3], uLocal_952);
			}
			iVar3++;
		}
		SET_RELATIONSHIP_BETWEEN_GROUPS(255, 1862763509, uLocal_952);
		SET_RELATIONSHIP_BETWEEN_GROUPS(255, uLocal_952, 1862763509);
		iLocal_1118 = -1;
		if (func_98())
		{
...
void func_99()
{
	...
	if (DOES_ENTITY_EXIST(iLocal_941))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_941);
	}
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_1167, 0);
