		...
		switch (iLocal_18)
		{
			case 0:
				if (iLocal_19[0])
				{
					...
					{
						Global_422D[3 /*42*/].f_1B[0] = func_48(2);
						func_47(2, 32, Global_422D[3 /*42*/].f_1B[0]);
					}
					StringCopy(&(Global_422D[3 /*42*/]), "PA_TREV1", 16);
					StringCopy(&(Global_422D[3 /*42*/].f_4), "PA_TREV1", 16);
					Global_422D[3 /*42*/].f_8 = 0;
					Global_422D[3 /*42*/].f_9 = 1;
					StringCopy(&(Global_422D[3 /*42*/].f_A[1 /*4*/]), "PA_TREV1A", 16);
					Global_422D[3 /*42*/].f_25[1] = 0;
					if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
					{
						Global_422D[3 /*42*/].f_1B[1] = func_48(2);
					}
					func_40(2, 3, 1, 1);
					func_37("PA_TREV1A", Global_422D[3 /*42*/].f_1B[1]);
					iLocal_18 = 1;
				}
				break;
			...
			case 1:
				if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
				{
					...
					if (func_36(2, 999999))
					{
						...
						Global_422D[3 /*42*/].f_25[1] = 1;
						Global_422D[3 /*42*/].f_8 = 1;
...
void func_1(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x1D5
{
	...
	func_2(Global_19E56.f_6D76[iParam0 /*29*/].f_11, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
void func_5(int iParam0)//Position - 0xB97
{
	...
	if (iParam0 == 8)
	{
		func_8(129, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 9)
	{
		func_8(135, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 10)
	{
		func_8(136, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 11)
	{
		func_8(137, 0, 4294967295, 1);
		return;
	}
	bVar0 = false;
	...
	else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_5038.f_1D7, iParam0) || INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_7() /*12745*/].f_1FF2.f_A, iParam0))
	{
		bVar0 = true;
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_19E56.f_5038.f_1D7), iParam0);
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_200000[func_7() /*12745*/].f_1FF2.f_A), iParam0);
	}
	if (bVar0)
	{
...
char* func_6(int iParam0)//Position - 0xCA7
{
	switch (iParam0)
	{
		case 0:
...
int func_8(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xD56
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_9()//Position - 0x12BB
{
	return Global_1407E0;
}

void func_10(int iParam0)//Position - 0x12C7
{
	func_32(93, iParam0);
	func_32(29, iParam0);
	func_32(30, iParam0);
...
bool func_11(int iParam0)//Position - 0x12E7
{
	if (iParam0 == 8)
	{
		return func_12(129, 4294967295, 4294967295);
	}
	if (iParam0 == 9)
	{
		return func_12(135, 4294967295, 4294967295);
	}
	if (iParam0 == 10)
	{
		return func_12(136, 4294967295, 4294967295);
	}
	if (iParam0 == 11)
	{
		return func_12(137, 4294967295, 4294967295);
	}
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_5038.f_1D7, iParam0);
	}
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_7() /*12745*/].f_1FF2.f_A, iParam0);
}

int func_12(int iParam0, int iParam1, int iParam2)//Position - 0x136B
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_13(int iParam0)//Position - 0x13A8
{
	int iVar0;
...
int func_14(int iParam0, int iParam1)//Position - 0x16C0
{
	int iVar0;
...
int func_15(bool bParam0)//Position - 0x19B5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_16(int iParam0, int iParam1)//Position - 0x1A6C
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_17(int iParam0, int iParam1)//Position - 0x1A87
{
	...
	if (func_27(&Global_412216))
	{
		if (func_25(&Global_412216, iParam0))
		{
			return 0;
		}
		if (func_18(&Global_412216, iParam0))
		{
			return 1;
		}
	}
...
int func_18(var uParam0, int iParam1)//Position - 0x1B24
{
	int iVar0;
	var uVar1[78];
...
int func_19(var uParam0, int iParam1)//Position - 0x1BD5
{
	int iVar0;
...
bool func_20(var uParam0, int iParam1)//Position - 0x1C50
{
	return (*uParam0)[iParam1] == 78;
}

void func_21(var uParam0)//Position - 0x1C61
{
	int iVar0;
	...
	func_23(uParam0, (Global_412215 - 0.5f));
}

void func_22(var uParam0, int iParam1)//Position - 0x1C95
{
	(*uParam0)[iParam1] = 78;
}

void func_23(var uParam0, float fParam1)//Position - 0x1CA5
{
	if (fParam1 == 0f)
	{
		uParam0->f_50 = 0f;
...
float func_24(var uParam0)//Position - 0x1CC2
{
	return uParam0->f_50;
}

bool func_25(var uParam0, int iParam1)//Position - 0x1CCE
{
	return func_26(uParam0, iParam1) != 4294967295;
}

int func_26(var uParam0, int iParam1)//Position - 0x1CE0
{
	int iVar0;
...
bool func_27(var uParam0)//Position - 0x1D0D
{
	return uParam0->f_4F == 1;
}

int func_28(int iParam0)//Position - 0x1D1B
{
	switch (iParam0)
	{
		case 60:
...
bool func_29(int iParam0)//Position - 0x1D6B
{
	return Global_8D15 == iParam0;
}

int func_30(int iParam0, int iParam1)//Position - 0x1D79
{
	int iVar0;
...
void func_31(int iParam0, int iParam1)//Position - 0x1DCA
{
	int iVar0;
...
void func_32(int iParam0, int iParam1)//Position - 0x1DED
{
	int iVar0;
...
void func_34(char* sParam0, int iParam1, int iParam2)//Position - 0x1EBF
{
	iParam2 = iParam2;
...
void func_35(char* sParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1ED8
{
	iParam3 = iParam3;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
int func_36(int iParam0, int iParam1)//Position - 0x1EF7
{
...
void func_37(char* sParam0, int iParam1)//Position - 0x1F12
{
...
void func_38(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0x1F55
{
...
void func_39(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1F73
{
...
int func_40(int iParam0, int iParam1, bool bParam2, int iParam3)//Position - 0x1FB2
{
	if (func_46())
	{
		return 0;
...
int func_41(var uParam0, var uParam1, bool bParam2, int iParam3)//Position - 0x1FDD
{
...
void func_42(int iParam0)//Position - 0x2041
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_43()//Position - 0x20BB
{
}

int func_44()//Position - 0x20C3
{
	int iVar0;
	...
	while (iVar0 < 2)
	{
		...
		{
			if (!func_45(Global_42D6[iVar0 /*9*/].f_2, Global_42D6[Global_422C /*9*/].f_2))
			{
				Global_422C = iVar0;
			}
		}
...
int func_45(struct<6> Param0, struct<6> Param1)//Position - 0x219D
{
	struct<4> Var0;
	struct<4> Var1;
	int iVar2;
...
int func_47(int iParam0, int iParam1, int iParam2)//Position - 0x22AF
{
	if (Global_19E56.f_6D76[iParam0 /*29*/].f_11 == 3)
	{
		return 0;
	...
	return func_2(Global_19E56.f_6D76[iParam0 /*29*/].f_11, 0, iParam1, iParam2, 0);
}

int func_48(int iParam0)//Position - 0x22F8
{
	var uVar0;
