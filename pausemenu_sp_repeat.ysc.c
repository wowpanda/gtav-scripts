...
void __EntryFunction__()//Position - 0x0
{
	...
	if (Global_28006E)
	{
		if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(4251087373) == 0)
		{
			SCRIPT::REQUEST_SCRIPT_WITH_NAME_HASH(4251087373);
			while (!SCRIPT::HAS_SCRIPT_WITH_NAME_HASH_LOADED(4251087373))
			{
				SYSTEM::WAIT(0);
			}
	...
	switch (ScriptParam_30)
	{
		...
		case 2:
			switch (ScriptParam_30.f_1)
			{
				...
				case 76:
					if (Global_1172F != 4294967295)
					{
						func_1(Global_1172F, Global_1171E);
						func_27(4294967295);
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
						{
							...
							{
								Global_11720 = { ENTITY::GET_ENTITY_VELOCITY(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)) };
							}
						}
...
{
	Global_1171B = iParam0;
	Global_1171B.f_1 = iParam1;
	if (iParam1 == 7)
	{
...
{
	if (Global_19E56.f_4872.f_17C > 0)
	{
		return 1;
	}
	return 0;
...
int func_7()//Position - 0x3EA
{
	...
	else if (Global_19E56.f_2704.f_15 > 0)
	{
		return 1;
	}
	return 0;
...
int func_12(int iParam0, int iParam1, bool bParam2)//Position - 0x5FF
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_17() == 0)
		{
			return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(func_13(func_16(iParam0), 4294967295, 0), iParam1);
		}
	}
	else
	{
...
bool func_23(var uParam0, int iParam1)//Position - 0xBA4
{
	return (uParam0 && iParam1) != 0;
}

bool func_24(bool bParam0)//Position - 0xBB3
{
...
bool func_25(int iParam0)//Position - 0xBDE
{
	return Global_8D15 == iParam0;
}

int func_26()//Position - 0xBEC
{
	if (Global_8D15 == 15)
	{
		return 0;
...
void func_27(int iParam0)//Position - 0xC01
{
	Global_1172F = iParam0;
}

void func_28(int iParam0, bool bParam1)//Position - 0xC0F
{
	if (bParam1 == 1)
	{
		func_29(0, 1);
	}
	GRAPHICS::_BEGIN_SCALEFORM_MOVIE_METHOD_N("SHOW_COLUMN");
	GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(iParam0);
	GRAPHICS::SET_SEETHROUGH(bParam1);
	CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
}

void func_29(bool bParam0, int iParam1)//Position - 0xC3E
{
	char* sVar0;
	char* sVar1;
	int iVar2;
	...
	GRAPHICS::_BEGIN_SCALEFORM_MOVIE_METHOD_N("SHOW_WARNING_MESSAGE");
	GRAPHICS::SET_SEETHROUGH(bParam0);
	iVar3 = func_8();
	if (iVar3 != 4294967295)
	{
		iVar2 = 1;
	...
	GRAPHICS::REMOVE_DECALS_FROM_VEHICLE((3 - iVar2));
	func_30(sVar0);
	func_30(sVar1);
...
void func_30(char* sParam0)//Position - 0xDBF
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	CAM::_DISABLE_VEHICLE_FIRST_PERSON_CAM_THIS_FRAME();
}

void func_31(int iParam0)//Position - 0xDD1
{
	if (iParam0 == 1)
	{
...
void func_32(int iParam0, int iParam1)//Position - 0xDF9
{
	if (func_8() == 4294967295)
	{
		if (func_5(Global_1171E))
		{
			func_27(iParam0);
			func_46(iParam0);
			if (Global_1171F > 16)
			{
				...
				func_33(func_34(iParam0), Global_1171F);
			}
		}
	}
}

void func_33(int iParam0, int iParam1)//Position - 0xE47
{
...
int func_34(int iParam0)//Position - 0xE72
{
	int iVar0;
...
void func_35()//Position - 0xEA0
{
	switch (Global_1171E)
	{
		case 1:
			Global_1171F = func_36(&Local_29, 1, 0, 1);
			break;
		
		case 7:
			Global_1171F = func_36(&Local_29, 0, 1, 1);
			break;
...
int func_36(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEE0
{
	int iVar0;
...
void func_37(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xF38
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_38(int iParam0, int iParam1, int iParam2)//Position - 0x1026
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_39(int iParam0, int iParam1)//Position - 0x10A2
{
	switch (iParam1)
	{
		case 1:
...
int func_40(int iParam0)//Position - 0x10E3
{
	switch (iParam0)
	{
		case 0:
...
int func_41(int iParam0, int iParam1)//Position - 0x1429
{
	switch (iParam1)
	{
		case 1:
			return Global_19E56.f_2361.f_14A[iParam0 /*6*/].f_3;
			break;
		
		case 7:
			return Global_19E56.f_4872[iParam0 /*6*/].f_3;
			break;
...
int func_42(int iParam0, int iParam1)//Position - 0x1471
{
	switch (iParam1)
	{
		case 1:
...
{
	if (((Global_19E56.f_2361.f_14A[24 /*6*/] == 1 || Global_19E56.f_2361.f_14A[25 /*6*/] == 1) || Global_19E56.f_2361.f_14A[26 /*6*/] == 1) || Global_19E56.f_2361.f_14A[27 /*6*/] == 1)
	{
		return 1;
	}
	return 0;
...
int func_44(var uParam0)//Position - 0x152F
{
	int iVar0;
...
int func_45(int iParam0)//Position - 0x1569
{
	switch (iParam0)
	{
		case 1:
...
void func_46(int iParam0)//Position - 0x1598
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Local_28 = { func_77(iParam0, Global_1171E) };
	if (!func_4(2))
	{
		return;
	}
	...
	iVar4 = 0;
	iVar0 = 0;
	while (iVar0 < func_74(iParam0, Global_1171E))
	{
		iVar5 = func_72(iParam0, Global_1171E, iVar0);
		iVar6 = 1;
		switch (iVar5)
		{
			case 42:
		...
		if (!Global_DC56[iVar5 /*13*/].f_7 && iVar6)
		{
...
void func_47(int iParam0)//Position - 0x16DC
{
...
float func_48(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)//Position - 0x16F9
{
	float fVar0;
	int iVar1;
	...
	else
	{
		GRAPHICS::_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_DESCRIPTION");
		GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(2);
		GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(func_49(iVar1));
		GRAPHICS::_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(fVar0);
...
int func_49(int iParam0)//Position - 0x17CB
{
	int iVar0;
...
int func_50(float fParam0)//Position - 0x1807
{
	if (fParam0 == 0f)
	{
		return 0;
...
float func_51(int iParam0, int iParam1, bool bParam2)//Position - 0x183C
{
	float fVar0;
	float fVar1;
...
void func_52(int iParam0, int iParam1)//Position - 0x189B
{
	int iVar0;
	...
	if (Global_1171E == 7)
	{
		...
		{
			case 52:
				*iParam1 = Global_19E56.f_928[0 /*2*/];
				if (*iParam1 == 0)
				{
					*iParam1 = 1;
				}
			...
			case 53:
				*iParam1 = Global_19E56.f_928[1 /*2*/];
				if (*iParam1 == 0)
				{
					*iParam1 = 1;
				}
			...
			case 54:
				*iParam1 = Global_19E56.f_928[2 /*2*/];
				if (*iParam1 == 0)
				{
					*iParam1 = 1;
				}
			...
			case 55:
				*iParam1 = Global_19E56.f_928[3 /*2*/];
				if (*iParam1 == 0)
				{
					*iParam1 = 1;
				}
			...
			case 56:
				*iParam1 = Global_19E56.f_928[4 /*2*/];
				if (*iParam1 == 0)
				{
					*iParam1 = 1;
				}
...
int func_53(int iParam0, int iParam1, int iParam2)//Position - 0x195B
{
	struct<13> Var0;
	int iVar1;
	int iVar2;
	...
	if (Global_DC56[iParam0 /*13*/].f_7)
	{
		return 1;
	}
	Var0 = { Global_DC56[iParam0 /*13*/] };
...
void func_54(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1BC1
{
	if (iParam5 != 0)
	{
...
char* func_55(int iParam0)//Position - 0x1C31
{
	switch (iParam0)
	{
		case 0:
...
void func_56(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2E0C
{
	if (iParam5 != 0)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam5, "SET_DATA_SLOT");
...
void func_57(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x2E7C
{
	int iVar0;
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x2F01
{
	float fVar0;
	...
	GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(SYSTEM::CEIL(fVar0));
	if (iParam6 == 0)
	{
		GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("PM_RP_STATD");
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(sParam4);
...
void func_59(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4)//Position - 0x2F8A
{
	if (iParam4 != 0)
	{
...
void func_60(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2FEF
{
	int iVar0;
	int iVar1;
...
void func_61(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x308E
{
	if (iParam5 != 0)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam5, "SET_DATA_SLOT");
...
char* func_62(int iParam0)//Position - 0x30FE
{
	switch (iParam0)
	{
		case 0:
...
{
	if (func_64(iParam0, func_70(Global_DC56[iParam0 /*13*/].f_4)))
	{
		return 1;
	}
	return 0;
...
int func_64(int iParam0, int iParam1)//Position - 0x4370
{
	...
	if (((iParam0 == 881 || iParam0 == 889) || iParam0 == 897) && Global_19E56.f_612C[4 /*4*/] == func_65())
	{
...
void func_66()//Position - 0x4453
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_69(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			iVar0 = func_68(AUDIO::_0x0626A247D2405330());
			if (func_67(iVar0) && (!func_25(14) || Global_19A3D))
			{
				if (Global_19E56.f_933.f_21B.f_10CD != iVar0 && func_67(Global_19E56.f_933.f_21B.f_10CD))
				{
...
int func_70(int iParam0)//Position - 0x45C3
{
	int iVar0;
...
int func_71(int iParam0)//Position - 0x45EC
{
	int iVar0;
	
	iVar0 = func_70(Global_DC56[iParam0 /*13*/].f_4);
	if (iVar0 > 4294967294)
	{
		return iVar0;
	}
...
int func_72(int iParam0, int iParam1, int iParam2)//Position - 0x4611
{
	switch (iParam1)
	{
		case 1:
...
int func_73(int iParam0, int iParam1)//Position - 0x4654
{
	switch (iParam0)
	{
		case 2:
...
int func_74(int iParam0, int iParam1)//Position - 0x4D38
{
	switch (iParam1)
	{
		case 1:
...
int func_75(int iParam0)//Position - 0x4D73
{
	switch (iParam0)
	{
		case 2:
...
void func_76(int iParam0)//Position - 0x4F24
{
	GRAPHICS::_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_DATA_SLOT_EMPTY");
	GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(iParam0);
	CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
	if (iParam0 == 1)
	{
...
struct<2> func_77(int iParam0, int iParam1)//Position - 0x4F49
{
	struct<2> Var0;
...
struct<2> func_78(int iParam0)//Position - 0x4FDF
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_79(int iParam0)//Position - 0x5017
{
	struct<2> Var0;
...
void func_81(int iParam0, int iParam1, int iParam2)//Position - 0x549A
{
	int iVar0;
	
	iVar0 = 0;
	if (Global_1171E != iParam0 || iParam2 == 1)
	{
		iVar0 = 1;
	}
	Global_1171E = iParam0;
	func_4(2);
...
void func_82()//Position - 0x5534
{
	...
	iVar3 = 0;
	iVar0 = 0;
	while (iVar0 < Global_1171F)
	{
		iVar2 = 0;
		iVar3 = 0;
		iVar8 = 4294967295;
		iVar1 = Local_29[iVar0 /*2*/];
		Local_28 = { func_77(iVar1, Global_1171E) };
		iVar7 = 0;
		while (iVar7 < func_74(iVar1, Global_1171E))
		{
			iVar4 = func_72(iVar1, Global_1171E, iVar7);
			if (!Global_DC56[iVar4 /*13*/].f_7)
			{
				if (func_63(iVar4) == 1)
				{
					iVar3++;
...
void func_83(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, char* sParam5, int iParam6)//Position - 0x5652
{
	if (GRAPHICS::_BEGIN_SCALEFORM_MOVIE_METHOD_N("SET_DATA_SLOT"))
	{
		...
		func_30(sParam5);
		GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(iParam6);
		CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
	}
}

void func_84()//Position - 0x56A9
{
