...
void __EntryFunction__()//Position - 0x0
{
	...
	if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_152(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
			...
			switch (iLocal_59)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_130(3) && !Global_16C52)
						{
							if (func_152(uLocal_58, 2097152))
							{
								if ((!func_152(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_129())) && !Global_16C52)
								{
									func_145(10);
									break;
								}
						...
						if ((!func_120(6) || Global_19A9D) || func_119())
						{
							bVar2 = false;
						}
						if (!bLocal_78)
						...
						if (func_113() || func_112(8, 4294967295))
						{
							bVar2 = false;
						}
						...
						if (bVar2)
						{
							...
							{
								iVar3 = PED::GET_VEHICLE_PED_IS_USING(AUDIO::_0x0626A247D2405330());
								if (bVar2)
								{
									if (iLocal_54 == iVar3)
									{
				...
				case 5:
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&Local_52))
					{
						...
						if (iVar4 == 1)
						{
							...
							if (Global_9197)
							{
								func_37(AUDIO::_0x0626A247D2405330());
							}
							iLocal_50 = func_27();
				...
				case 6:
					if (func_152(Global_19911, 262144))
					{
						func_159(&Global_19911, 262144);
						func_14();
					}
					if (func_152(uLocal_58, 2097152))
					{
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						if (iLocal_63 != 4294967295)
						{
							if (func_152(Global_19911, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_20(iLocal_63), 0, Global_16C55, 0);
								func_6(func_20(iLocal_63), 0, Global_16C55, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_20(iLocal_63), 0, Global_16C55, 0);
								func_6(func_20(iLocal_63), 0, Global_16C55, 0, 0);
							}
						}
						func_5();
						func_159(&Global_19911, 0);
...
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_247) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
	}
...
void func_36()//Position - 0x52E0
{
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_247, 0))
	{
...
void func_51()//Position - 0x57DB
{
	...
	if (func_100(Local_247.f_3, Local_247, 1, 1, 1, 1, 0) || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		{
			if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_247, 0) && PED::IS_PED_IN_VEHICLE(Local_247.f_3, Local_247, 0))
			{
				BRAIN::TASK_VEHICLE_MISSION_COORS_TARGET(Local_247.f_3, Local_247, unk_0x8000C77B5F336760(Local_247, true) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_247) + Vector(500f, 0f, 0f), 4, VEHICLE::_GET_VEHICLE_MAX_SPEED(Local_247), 262144, 50f, 50f, 1);
			}
			else
			{
				BRAIN::TASK_SMART_FLEE_PED(Local_247.f_3, AUDIO::_0x0626A247D2405330(), 1000f, 4294967295, 0, 0);
			}
	...
	fVar6 = SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), func_99(iLocal_81));
	if (fVar6 < 11664f)
	{
		if (!iLocal_251)
		{
	...
	if (fVar6 < 10000f)
	{
		...
		{
			if ((STREAMING::HAS_MODEL_LOADED(func_98(iLocal_81)) && ENTITY::DOES_ENTITY_EXIST(Local_247)) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_247, 0))
			{
				Local_247.f_3 = PED::CREATE_PED_INSIDE_VEHICLE(Local_247, 4, func_98(iLocal_81), 4294967295, 1, true);
				if (!PED::IS_PED_INJURED(Local_247.f_3))
				{
					...
					BRAIN::TASK_STAND_STILL(Local_247.f_3, 4294967295);
		...
		else
		{
			...
			if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_247.f_A9, 0))
			{
				if (CAM::IS_SCREEN_FADED_IN())
				{
					if (!PED::IS_PED_INJURED(Local_247.f_3) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
					{
						if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(Local_247.f_3, true)) < 400f)
						{
							func_77(&uLocal_82, "OJBJAUD", func_91(iLocal_81), 8, 0, 0, 0);
							BRAIN::TASK_LOOK_AT_ENTITY(Local_247.f_3, AUDIO::_0x0626A247D2405330(), 6000, 0, 2);
							MISC::SET_BIT(&(Local_247.f_A9), 0);
						}
					}
				}
			}
	...
	func_16(&iLocal_252, Local_247);
	if ((PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), Local_247, 1) && !PED::IS_PED_JACKING(AUDIO::_0x0626A247D2405330())) && func_75(Local_247.f_3, Local_247))
	{
		vVar5 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_247, PED::GET_PED_BONE_COORDS(AUDIO::_0x0626A247D2405330(), 0, 0f, 0f, 0f)) };
		if (vVar5.x < 0f || vVar5.y < 1f)
		{
			...
			if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_247, 0))
			{
				iVar0 = BRAIN::GET_SCRIPT_TASK_STATUS(Local_247.f_3, 3021937204);
				if (iVar0 != 0 && iVar0 != 1)
				{
					...
					{
						SYSTEM::WAIT(0);
						if (PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_JACKING(AUDIO::_0x0626A247D2405330()))
						{
							func_54(iLocal_69);
							if (ENTITY::DOES_ENTITY_EXIST(Local_247.f_3) && !PED::IS_PED_INJURED(Local_247.f_3))
							{
					...
					func_22(&iLocal_253);
					while (!PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), Local_247, 0) && func_53(&iLocal_253) < 2f)
					{
						SYSTEM::WAIT(0);
					}
					func_9(&iLocal_253);
					if (!PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), Local_247, 0))
					{
						bVar8 = false;
						CAM::RENDER_SCRIPT_CAMS(false, false, 3000, 1, 0, 0);
						if (CAM::DOES_CAM_EXIST(iLocal_252))
					...
					if (!ENTITY::IS_ENTITY_DEAD(Local_247.f_3, 0) && !ENTITY::IS_ENTITY_DEAD(Local_247, 0))
					{
						...
						BRAIN::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_247, unk_0x8000C77B5F336760(Local_247, true) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_247) + Vector(500f, 0f, 0f), 4, VEHICLE::_GET_VEHICLE_MAX_SPEED(Local_247), 262144, 50f, 50f, 1);
						CUTSCENE::_0x8D9DF6ECA8768583(iVar4);
						BRAIN::TASK_PERFORM_SEQUENCE(Local_247.f_3, iVar4);
	...
	if (!bVar8)
	{
		if ((OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_247, 0) && SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(Local_247, true)) < 225f) && !PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 1))
		{
		...
		if ((!PED::IS_PED_INJURED(Local_247.f_3) && BRAIN::GET_SCRIPT_TASK_STATUS(Local_247.f_3, 3312640106) != 0) && BRAIN::GET_SCRIPT_TASK_STATUS(Local_247.f_3, 3312640106) != 1)
		{
			BRAIN::TASK_STAND_STILL(Local_247.f_3, 4294967295);
		}
	}
...
void func_61(bool bParam0, bool bParam1)//Position - 0x63C8
{
	if (bParam0)
	{
		if (func_111(0))
...
void func_64(int iParam0, int iParam1, int iParam2)//Position - 0x6477
{
...
void func_65(int iParam0, bool bParam1)//Position - 0x64CE
{
	if (bParam1)
	{
...
void func_66(bool bParam0, bool bParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x64F0
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_71(CAM::_0xDC9DA9E8789F5246())) && !func_68(CAM::_0xDC9DA9E8789F5246(), 0)) && !func_67()) && !bParam4)
			{
...
int func_69(int iParam0, bool bParam1)//Position - 0x6681
{
	int iVar0;
	int iVar1;
...
int func_70()//Position - 0x66C2
{
	return Global_1407E0;
}

int func_71(int iParam0)//Position - 0x66CE
{
...
bool func_72()//Position - 0x6710
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_240006, 3);
}

int func_73(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x6721
{
	int iVar0;
...
void func_74(int iParam0)//Position - 0x6754
{
	if (iParam0 == 1)
	{
...
int func_75(int iParam0, int iParam1)//Position - 0x6777
{
	...
	if (PED::IS_PED_IN_VEHICLE(iParam0, iParam1, 0) && func_76(iParam0, iParam1) == 4294967295)
	{
		return 1;
	}
	return 0;
...
int func_76(int iParam0, int iParam1)//Position - 0x67D4
{
...
int func_77(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x6846
{
...
int func_78(char* sParam0, int iParam1, bool bParam2)//Position - 0x6894
{
	Global_3DCF = 0;
...
var func_83()//Position - 0x6D61
{
	func_84();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_84()//Position - 0x6D7A
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_87(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_85(iVar0) && (!func_132(14) || Global_19A3D))
			{
...
bool func_85(int iParam0)//Position - 0x6E77
{
	return iParam0 < 3;
}

int func_86(int iParam0)//Position - 0x6E83
{
	int iVar0;
	int iVar1;
...
int func_87(int iParam0)//Position - 0x6EC0
{
	if (func_85(iParam0))
	{
...
void func_90(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x6F98
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
char* func_91(int iParam0)//Position - 0x6FEE
{
	bool bVar0;
	
	bVar0 = func_86(AUDIO::_0x0626A247D2405330()) == true;
	switch (iParam0)
	{
		case 0:
...
char* func_92(bool bParam0, char* sParam1, char* sParam2)//Position - 0x70B0
{
	if (bParam0)
	{
		return sParam1;
...
void func_93(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x70C7
{
...
char* func_94(int iParam0)//Position - 0x7162
{
	return "EXT1HELIPILOT";
}

char* func_95(int iParam0)//Position - 0x716E
{
	switch (iParam0)
	{
		case 0:
...
void func_96()//Position - 0x71E9
{
	iLocal_46++;
}

void func_97(int iParam0, int iParam1)//Position - 0x71F7
{
...
int func_98(int iParam0)//Position - 0x729E
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_99(int iParam0)//Position - 0x731E
{
	switch (iParam0)
	{
		case 0:
...
int func_100(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x7468
{
	int iVar0;
	vector3 vVar1;
	
	iVar0 = AUDIO::_0x0626A247D2405330();
	if (((!ENTITY::DOES_ENTITY_EXIST(iParam1) || ENTITY::IS_ENTITY_DEAD(iParam1, 0)) || !OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam1, 0)) || FIRE::IS_ENTITY_ON_FIRE(iParam1))
	{
		return 1;
	}
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (WEAPON::IS_PED_ARMED(iVar0, 4))
			{
				...
				{
					if (ENTITY::IS_ENTITY_AT_COORD(iParam0, unk_0x8000C77B5F336760(iVar0, true), 45f, 45f, 45f, false, true, 0))
					{
						return 1;
					}
				}
			...
			if ((FIRE::IS_EXPLOSION_IN_SPHERE(4294967295, vVar1, 25f) && !FIRE::IS_EXPLOSION_IN_SPHERE(11, vVar1, 25f)) && !FIRE::IS_EXPLOSION_IN_SPHERE(13, vVar1, 25f))
			{
				return 1;
			}
		}
...
float func_101(int iParam0, bool bParam1)//Position - 0x7657
{
	return func_102(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), iParam0, bParam1);
}

float func_102(int iParam0, int iParam1, bool bParam2)//Position - 0x766F
{
	vector3 vVar0;
	vector3 vVar1;
...
float func_103(bool bParam0, float fParam1, float fParam2)//Position - 0x76CD
{
	if (bParam0)
	{
		return fParam1;
...
int func_105(int iParam0, bool bParam1)//Position - 0x773A
{
	int iVar0;
...
int func_106(int iParam0)//Position - 0x77F2
{
	int iVar0;
...
void func_107(int iParam0)//Position - 0x782D
{
	int iVar0;
...
void func_108(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x7884
{
	int iVar0;
...
int func_109(int iParam0)//Position - 0x79AF
{
	return 0;
	return 1;
}

var func_110()//Position - 0x79BC
{
	return Global_10B8E;
}

int func_111(int iParam0)//Position - 0x79C8
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
bool func_112(int iParam0, int iParam1)//Position - 0x7A22
{
	switch (iParam0)
	{
		case 5:
...
bool func_113()//Position - 0x7A5D
{
	return MISC::GET_GAME_TIMER() <= Global_43D7.f_16F1 + 100;
}

int func_114()//Position - 0x7A72
{
...
bool func_115(bool bParam0)//Position - 0x7A8C
{
	if (bParam0)
	{
...
int func_116()//Position - 0x7AB5
{
	return 1;
}

void func_117(var uParam0, int iParam1)//Position - 0x7ABE
{
	func_118(uParam0, iParam1);
}

void func_118(var uParam0, var uParam1)//Position - 0x7ACE
{
	*uParam0 = (*uParam0 || uParam1);
}

bool func_119()//Position - 0x7ADF
{
	int iVar0;
	bool bVar1;
...
int func_120(int iParam0)//Position - 0x7BE9
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_127()) || Global_19A9D) || Global_6375) || func_126()) || func_112(8, 4294967295)) || func_125()) || func_124()) || func_123()) || func_114()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_127()) || Global_6375) || func_126()) || func_112(8, 4294967295)) || func_123()) || func_125()) || func_124()) || func_114()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_127()) || Global_19A9D) || Global_6375) || func_126()) || func_112(8, 4294967295)) || func_123()) || func_125()) || func_124()) || func_114()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_127()) || Global_19A9D) || Global_6375) || func_126()) || func_112(8, 4294967295)) || func_125()) || func_124()) || func_114()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_127() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_112(8, 4294967295)) || func_114()) || func_122()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_112(8, 4294967295) || func_125()) || func_124()) || func_122()) || func_121())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_127()) || Global_6375) || func_126()) || func_112(8, 4294967295)) || func_124()) || func_123()) || func_114()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_121()//Position - 0x8307
{
	return Global_16C57.f_1;
}

int func_122()//Position - 0x8315
{
...
bool func_124()//Position - 0x8365
{
	return Global_16C64.f_148 > 0;
}

bool func_125()//Position - 0x8376
{
	return Global_16C64.f_147 > 0;
}

var func_126()//Position - 0x8387
{
	return Global_140859;
}

int func_127()//Position - 0x8393
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_129()//Position - 0x83C9
{
	return Global_15C47;
}

int func_130(int iParam0)//Position - 0x83D5
{
	switch (iParam0)
	{
		case 0:
...
bool func_131(int iParam0)//Position - 0x8447
{
	int iVar0;
...
bool func_132(int iParam0)//Position - 0x8483
{
	return Global_8D15 == iParam0;
}

void func_133(var uParam0, int iParam1)//Position - 0x8491
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_134()//Position - 0x84A2
{
	if (bLocal_248)
	{
		switch (iLocal_81)
...
void func_135(vector3 vParam0, float fParam1)//Position - 0x85C2
{
	var uVar0;
	bool bVar1;
	
	fLocal_57 = SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), vParam0);
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && (fLocal_57 > 25f || CAM::IS_SCREEN_FADED_OUT()))
	{
		if (fLocal_57 < 25600f)
		{
...
bool func_136()//Position - 0x86F2
{
	return func_137(&uLocal_79);
}

int func_137(var uParam0)//Position - 0x8700
{
	int iVar0;
...
void func_139(var uParam0)//Position - 0x879C
{
	int iVar0;
...
int func_141(var uParam0, int iParam1)//Position - 0x87F5
{
	int iVar0;
	int iVar1;
...
int func_142(var uParam0)//Position - 0x8852
{
	int iVar0;
...
void func_143(int iParam0)//Position - 0x887E
{
	if (iParam0 == 2)
	{
	}
...
void func_145(int iParam0)//Position - 0x8912
{
	iLocal_59 = iParam0;
}

void func_146(int iParam0, bool bParam1, bool bParam2)//Position - 0x891E
{
	int iVar0;
	bool bVar1;
...
bool func_149(int iParam0, int iParam1)//Position - 0x8A6A
{
	bool bVar0;
...
bool func_150(int iParam0)//Position - 0x8AB7
{
	return func_151(iParam0, Global_8D15);
}

int func_151(int iParam0, int iParam1)//Position - 0x8AC8
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_152(var uParam0, int iParam1)//Position - 0x8CA9
{
	return (uParam0 && iParam1) != 0;
}

void func_153()//Position - 0x8CB8
{
	iLocal_63 = 0;
	if (ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
	{
...
int func_154(int iParam0)//Position - 0x8E4A
{
	switch (iParam0)
	{
		case 91:
...
int func_155(int iParam0)//Position - 0x8F62
{
...
bool func_156(int iParam0)//Position - 0x8F8E
{
	return Global_19AC5[iParam0 /*10*/].f_1;
}

int func_157(vector3 vParam0, int iParam1)//Position - 0x8FA0
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_158(int iParam0)//Position - 0x8FEF
{
	switch (iParam0)
	{
		case 0:
...
void func_159(var uParam0, int iParam1)//Position - 0x9036
{
	func_160(uParam0, iParam1);
}

void func_160(var uParam0, var uParam1)//Position - 0x9046
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_161(bool bParam0)//Position - 0x905B
{
	if (bParam0)
	{
		if (iLocal_69 != 263)
