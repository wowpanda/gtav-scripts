...
void func_1()//Position - 0xCE
{
	...
	if ((func_46(AUDIO::_0x0626A247D2405330()) && !func_45(14)) && !CAM::IS_SCREEN_FADED_OUT())
	{
		if (iLocal_41 < 10)
		{
			if (iLocal_41 == 0)
...
int func_4(int iParam0)//Position - 0x44D
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_2725.f_6C, func_10(func_11(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
int func_7(int iParam0, int iParam1)//Position - 0x86A
{
	int iVar0;
...
int func_8()//Position - 0xB58
{
	return Global_1407E0;
}

int func_9(int iParam0)//Position - 0xB64
{
	if (iParam0 == 3)
	{
		return 815;
...
int func_10(int iParam0, int iParam1)//Position - 0xBAB
{
	if (iParam1 < 32)
	{
		return iParam1;
...
int func_11(int iParam0)//Position - 0xBC7
{
	if (iParam0 == 3)
	{
		return 30;
...
void func_12(int iParam0)//Position - 0xC17
{
...
int func_14(int iParam0)//Position - 0xC53
{
	int iVar0;
	int iVar1;
...
int func_15(int iParam0, int iParam1, bool bParam2)//Position - 0xCAD
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar1 < Global_B5F8[iVar0 /*203*/].f_3)
	{
		...
		if (iVar3 < 3)
		{
			func_16(Global_B5F8[iVar0 /*203*/].f_4[iVar1], Global_B5F8[iVar0 /*203*/].f_1, 1, bParam2, 0);
		}
		iVar1++;
	}
	return 1;
...
void func_16(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEA9
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!bParam2)
	{
		...
		iVar2 = iVar5;
		Var3 = { func_26(Global_91A4[iVar5 /*12*/].f_1) };
	...
	else
	{
		...
		{
			Var3 = { func_26(Global_91A4[iVar11 /*12*/].f_1) };
		}
	}
	if (!bParam4)
	{
...
void func_17(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)//Position - 0x127E
{
	int iVar0;
	bool bVar1;
	char cVar2[64];
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_18(HUD::_SET_NOTIFICATION_MESSAGE(&cVar2, &cVar2, 0, 2, HUD::_GET_LABEL_TEXT(func_19(iParam1)), 0));
		}
		else
		{
			func_18(HUD::_SET_NOTIFICATION_MESSAGE("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, HUD::_GET_LABEL_TEXT(func_19(iParam1)), 0));
		}
		switch (Global_38B1)
		{
			case 0:
...
void func_18(var uParam0)//Position - 0x1466
{
...
char* func_19(int iParam0)//Position - 0x1494
{
	switch (iParam0)
	{
		case 0:
...
char* func_20(int iParam0, int iParam1)//Position - 0x17FF
{
	*iParam1 = 1;
	switch (iParam0)
	{
...
var func_21()//Position - 0x1C52
{
	func_22();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_22()//Position - 0x1C6B
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_25(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_23(iVar0) && (!func_45(14) || Global_19A3D))
			{
...
bool func_23(int iParam0)//Position - 0x1D68
{
	return iParam0 < 3;
}

int func_24(int iParam0)//Position - 0x1D74
{
	int iVar0;
	int iVar1;
...
int func_25(int iParam0)//Position - 0x1DB1
{
	if (func_23(iParam0))
	{
...
struct<16> func_26(int iParam0)//Position - 0x1DDB
{
	struct<16> Var0;
	struct<16> Var1;
...
int func_27(int iParam0, bool bParam1)//Position - 0x1E0C
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
int func_28(int iParam0)//Position - 0x2024
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_29(int iParam0, int iParam1)//Position - 0x2088
{
...
void func_30(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)//Position - 0x20CD
{
	int iVar0;
...
void func_31(vector3 vParam0)//Position - 0x21E6
{
	int iVar0;
...
int func_32(int iParam0, int iParam1)//Position - 0x2224
{
	int iVar0;
	int iVar1;
...
void func_33(var uParam0, var uParam1)//Position - 0x227E
{
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), OBJECT::GET_PICKUP_COORDS(*uParam0), true) >= 60f)
		{
			func_40(uParam0);
			*uParam0 = 0;
			*uParam1 = 0;
...
void func_34(vector3 vParam0)//Position - 0x22BE
{
	if (func_35(AUDIO::_0x0626A247D2405330(), vParam0, 7f))
	{
		BRAIN::TASK_LOOK_AT_COORD(AUDIO::_0x0626A247D2405330(), vParam0, 100, 2048, 1);
	}
}

bool func_35(int iParam0, vector3 vParam1, float fParam2)//Position - 0x22E8
{
	return SYSTEM::VDIST2(unk_0x8000C77B5F336760(iParam0, true), vParam1) <= (fParam2 * fParam2);
}

int func_36()//Position - 0x2305
{
	if (func_37(0))
	{
		return 0;
...
bool func_37(bool bParam0)//Position - 0x2350
{
...
void func_38(int iParam0, int iParam1)//Position - 0x237B
{
	Global_16C57.f_7 = iParam0;
	Global_16C57.f_8 = iParam1;
}

int func_39(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2393
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_40(var uParam0)//Position - 0x28F1
{
...
int func_41(int iParam0)//Position - 0x290A
{
	int iVar0;
	int iVar1;
	...
	if (func_46(AUDIO::_0x0626A247D2405330()))
	{
...
void func_42(int iParam0)//Position - 0x2996
{
	int iVar0;
	int iVar1;
...
int func_43(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x29D8
{
	int iVar0;
	...
	StringCopy(&(Global_19E56.f_3721[iVar0 /*104*/]), sParam2, 64);
	Global_19E56.f_3721[iVar0 /*104*/].f_11 = iParam1;
	if (iParam3 == 0)
	{
		return 0;
	}
	...
	{
		Global_19E56.f_3721[iVar0 /*104*/].f_18 = iParam3;
	}
	Global_19E56.f_3721[iVar0 /*104*/].f_19 = iParam4;
	Global_19E56.f_3721[iVar0 /*104*/].f_1A = iParam5;
	Global_19E56.f_3721[iVar0 /*104*/].f_1D = iParam6;
	Global_19E56.f_3721[iVar0 /*104*/].f_1E = iParam8;
	Global_19E56.f_3721[iVar0 /*104*/].f_1F = iParam7;
	Global_19E56.f_3721[iVar0 /*104*/].f_1C = 0;
	return 1;
}

int func_44(int iParam0)//Position - 0x2AA9
{
	int iVar0;
	int iVar1;
...
bool func_45(int iParam0)//Position - 0x2AEC
{
	return Global_8D15 == iParam0;
}

int func_46(int iParam0)//Position - 0x2AFA
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_47()//Position - 0x2B1B
{
	int iVar0;
	int iVar1;
	
	iVar0 = 0;
	if (Global_19E56.f_4872.f_184)
	{
...
int func_48(int iParam0)//Position - 0x2CCD
{
	int iVar0;
	int iVar1;
