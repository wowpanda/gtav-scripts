...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_85.f_4)
	{
		...
		case 2:
			if (func_49(PLAYER_PED_ID(), uParam0[uParam0->f_85.f_2 /*14*/]))
			{
		...
		case 5:
			...
			{
				uParam0->f_85.f_1 = NETWORK_CREATE_SYNCHRONISED_SCENE(func_38(uParam0), func_37(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uParam0->f_85.f_1, &sVar0, &sVar16, 2f, -1000f, 13, 16, 1.5f, 0);
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			uVar42 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_85.f_1);
			if (IS_SYNCHRONIZED_SCENE_RUNNING(uVar42))
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(uVar42) >= 1f)
				{
					...
					func_39(uParam0, &sVar16);
					uParam0->f_85.f_1 = NETWORK_CREATE_SYNCHRONISED_SCENE(func_38(uParam0), func_37(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
					NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uParam0->f_85.f_1, &sVar0, &sVar16, 4f, -1.5f, 13, 16, 1000f, 0);
					NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_85.f_1);
					func_25(&(uParam0->f_85), 8);
		...
		case 8:
			uVar43 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_85.f_1);
...
int func_46(var uParam0)
{
	...
	while (iVar0 < _NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK_IS_PARTICIPANT_ACTIVE(INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if ((iVar1 != PLAYER_ID() && func_47(iVar1, 1, 1)) && func_49(GET_PLAYER_PED(iVar1), uParam0[uParam0->f_85.f_2 /*14*/]))
			{
				return 1;
			}
		}
...
void func_55(var uParam0)
{
	...
	func_56(&(uParam0->f_85), 1, IS_ENTITY_DEAD(PLAYER_PED_ID(), 0));
	func_56(&(uParam0->f_85), 3, IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1));
	func_56(&(uParam0->f_85), 0, func_35(0));
	func_56(&(uParam0->f_85), 2, IS_PED_RUNNING(PLAYER_PED_ID()));
}
...
{
	return IS_ENTITY_IN_ANGLED_AREA(uParam0, 416.2457f, 4826.312f, -59.9997f, 376.9388f, 4827.659f, -56.95424f, 15f, 0, 1, 0);
}
...
int func_72()
{
	if (Global_1589667 != func_59())
	{
		if (NETWORK_IS_SCRIPT_ACTIVE("base_reception_seats", Global_1589667, 1, 0))
		{
			return 0;
		}
...
void func_76(int iParam0, var uParam1, int iParam2)
{
	...
	while (iVar4 < 2)
	{
		...
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_8 = { func_79(func_80(iVar4), fVar3) + vVar0 };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_8.f_3 = { 0f, 0f, (fVar3 + 174f) };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_1 = { func_79(func_78(iVar4), fVar3) + vVar0 };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_1.f_3 = { func_79(func_77(iVar4), fVar3) + vVar0 };
