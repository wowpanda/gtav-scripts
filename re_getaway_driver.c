					...
					if (iLocal_228 != -1 && MISC::GET_GAME_TIMER() > iLocal_228 + 1000)
					{
						...
						if (iLocal_228 != -1 && MISC::GET_GAME_TIMER() > iLocal_228 + 10000)
						{
							...
							if (!PED::IS_PED_INJURED(iLocal_258[0]))
							{
								...
								BRAIN::CLOSE_SEQUENCE_TASK(iLocal_265);
		...
		if ((iVar2 > 1 && iVar2 < 7) && !iLocal_253)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_257))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_257, PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_258[0]))
					{
						BRAIN::TASK_SMART_FLEE_PED(iLocal_258[0], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					}
					if (!PED::IS_PED_INJURED(iLocal_258[1]))
					{
						BRAIN::TASK_SMART_FLEE_PED(iLocal_258[1], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					}
					iVar8 = 0;
					iVar0 = 7;
					func_239(Var1, &iLocal_258, bVar4);
				...
				if (!PED::IS_PED_INJURED(iLocal_260[0]))
				{
					if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_260[0], PLAYER::PLAYER_PED_ID(), 4f, 4f, 4f, 0, 1, 0))
						{
							if (!func_178())
							{
								BRAIN::TASK_LOOK_AT_ENTITY(iLocal_260[0], PLAYER::PLAYER_PED_ID(), 1000, 2052, 4);
					...
					{
						BRAIN::CLEAR_PED_TASKS(iLocal_260[0]);
						func_167();
						SYSTEM::WAIT(0);
						iVar8 = 0;
						iVar0 = 7;
			...
			if (bLocal_249)
			{
				if (!PED::IS_PED_INJURED(iLocal_257))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_257, PLAYER::PLAYER_PED_ID(), 4f, 4f, 4f, 0, 1, 0))
					{
						if (!func_178())
						{
							BRAIN::TASK_LOOK_AT_ENTITY(iLocal_257, PLAYER::PLAYER_PED_ID(), 3000, 2048, 2);
						...
						if (!iLocal_252)
						{
							if (PED::IS_PED_SHOOTING_IN_AREA(PLAYER::PLAYER_PED_ID(), Vector(28.4601f, -1565.293f, 61.5891f) - Vector(30f, 30f, 30f), Vector(28.4601f, -1565.293f, 61.5891f) + Vector(30f, 30f, 30f), 0, 1))
							{
								...
								while (iVar9 < iLocal_259)
								{
									...
									{
										BRAIN::TASK_SMART_FLEE_PED(iLocal_259[iVar9], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
								...
								if (!PED::IS_PED_INJURED(iLocal_257))
								{
									BRAIN::TASK_SMART_FLEE_PED(iLocal_257, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
									PED::SET_PED_KEEP_TASK(iLocal_257, true);
								}
								iLocal_252 = 1;
							}
	...
	switch (*iParam0)
	{
		...
		case 1:
			*iParam7 = 0;
			...
			BRAIN::TASK_COWER(iLocal_259[0], -1);
		...
		case 2:
			if (((((!ENTITY::IS_ENTITY_DEAD(iLocal_257, 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_259[0], 0)) && !ENTITY::IS_ENTITY_DEAD(iLocal_259[2], 0)) && !ENTITY::IS_ENTITY_DEAD(iLocal_259[3], 0)) && !ENTITY::IS_ENTITY_DEAD((*uParam6)[0], 0)) && !ENTITY::IS_ENTITY_DEAD((*uParam6)[1], 0))
			{
				if (((((PED::_0x7350823473013C02(iLocal_257) && PED::_0x7350823473013C02(iLocal_259[0])) && PED::_0x7350823473013C02(iLocal_259[2])) && PED::_0x7350823473013C02(iLocal_259[3])) && PED::_0x7350823473013C02((*uParam6)[0])) && PED::_0x7350823473013C02((*uParam6)[1]))
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_257))
					{
						BRAIN::TASK_HANDS_UP(iLocal_257, -1, 0, -1, 0);
						if (!PED::IS_PED_INJURED((*uParam6)[0]))
						{
							BRAIN::TASK_PLAY_ANIM((*uParam6)[0], "random@getawaydriver@thugs", "base_a", 4f, -2f, -1, 1, 0, 0, 0, 0);
							BRAIN::TASK_LOOK_AT_ENTITY((*uParam6)[0], PLAYER::PLAYER_PED_ID(), -1, 2052, 4);
						}
						if (!PED::IS_PED_INJURED((*uParam6)[1]))
						{
							BRAIN::TASK_PLAY_ANIM((*uParam6)[1], "random@getawaydriver@thugs", "base_b", 4f, -2f, -1, 1, 0, 0, 0, 0);
							BRAIN::TASK_LOOK_AT_ENTITY((*uParam6)[1], PLAYER::PLAYER_PED_ID(), -1, 2052, 4);
						}
					}
					SYSTEM::SETTIMERA(0);
					*iParam0 = 3;
		...
		case 3:
			...
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 81.71976f, -1530.834f, 28.17651f, 26.78526f, -1595.693f, 58.29443f, 32.875f, 0, true, 0))
			{
				if (!iLocal_252)
				{
					if (!PED::IS_PED_INJURED(iLocal_259[0]))
					{
						BRAIN::TASK_SMART_FLEE_COORD(iLocal_259[0], vLocal_232, 200f, -1, 0, 0);
					}
					if (!PED::IS_PED_INJURED(iLocal_259[2]))
					{
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_265);
						BRAIN::TASK_PAUSE(0, 250);
						BRAIN::TASK_SMART_FLEE_COORD(0, vLocal_232, 200f, -1, 0, 0);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_265);
			...
			if (PED::IS_COP_PED_IN_AREA_3D(vLocal_232 - Vector(40f, 40f, 40f), vLocal_232 + Vector(40f, 40f, 40f)) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(vLocal_232 - Vector(40f, 40f, 40f), vLocal_232 + Vector(40f, 40f, 40f)))
			{
				...
				{
					BRAIN::TASK_SMART_FLEE_PED((*uParam6)[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
					BRAIN::TASK_SMART_FLEE_PED((*uParam6)[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
					func_167();
					SYSTEM::WAIT(0);
			...
			if (!func_178())
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_257))
				{
					if (!PED::IS_PED_INJURED(iLocal_257))
					{
						...
						BRAIN::TASK_LOOK_AT_ENTITY((*uParam6)[0], PLAYER::PLAYER_PED_ID(), 10000, 2052, 4);
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_265);
		...
		case 5:
			if (PED::IS_PED_INJURED(iLocal_257))
			{
				if (!PED::IS_PED_INJURED((*uParam6)[0]) && !PED::IS_PED_INJURED((*uParam6)[1]))
				{
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY((*uParam6)[0], PLAYER::PLAYER_PED_ID(), -1);
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY((*uParam6)[1], PLAYER::PLAYER_PED_ID(), -1);
				}
			}
						...
						if (ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) < 0.1f)
						{
							if (func_126() && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
							{
								...
								if (!PED::IS_PED_INJURED(iLocal_257))
								{
									...
									BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vVar11, iLocal_257, 3f, false, 0.5f, 4f, true, 0, 0, -957453492, 20000);
									BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000, 2096, 4);
									BRAIN::CLOSE_SEQUENCE_TASK(iLocal_265);
									BRAIN::TASK_PERFORM_SEQUENCE(iLocal_258[0], iLocal_265);
									BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_265);
									...
									BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vVar12, iLocal_257, 3f, false, 0.5f, 4f, true, 0, 0, -957453492, 20000);
									BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000, 2096, 4);
									BRAIN::CLOSE_SEQUENCE_TASK(iLocal_265);
									BRAIN::TASK_PERFORM_SEQUENCE(iLocal_258[1], iLocal_265);
									BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_265);
							...
							else if (!iLocal_250)
							{
								if (!func_178())
								{
									...
									BRAIN::TASK_LOOK_AT_ENTITY(iLocal_258[1], PLAYER::PLAYER_PED_ID(), -1, 2096, 4);
									iLocal_250 = 1;
								}
							}
						}
			...
			if (((PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_COP_PED_IN_AREA_3D(vLocal_232 - Vector(40f, 40f, 40f), vLocal_232 + Vector(40f, 40f, 40f))) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(vLocal_232 - Vector(40f, 40f, 40f), vLocal_232 + Vector(40f, 40f, 40f)))
			{
				if (!PED::IS_PED_INJURED((*uParam6)[0]) && !PED::IS_PED_INJURED((*uParam6)[1]))
				{
					BRAIN::TASK_SMART_FLEE_PED((*uParam6)[0], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					BRAIN::TASK_SMART_FLEE_PED((*uParam6)[1], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					func_167();
					SYSTEM::WAIT(0);
					func_169(&uLocal_53, "REGETAU", "REAWA_POLICE", 4, 0, 0, 0);
					*iParam0 = 20;
			...
			*iParam7 = 0;
							...
							if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_ON_ANY_BIKE(PLAYER::PLAYER_PED_ID()))
							{
								if (func_126() && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
								{
									...
									if (!PED::IS_PED_INJURED(iLocal_258[0]) && !PED::IS_PED_INJURED(iLocal_258[1]))
									{
										...
										{
											BRAIN::CLEAR_PED_TASKS(iLocal_258[0]);
											BRAIN::CLEAR_PED_TASKS(iLocal_258[1]);
											BRAIN::TASK_LOOK_AT_ENTITY(iLocal_258[1], PLAYER::PLAYER_PED_ID(), 10000, 2052, 4);
											PED::SET_PED_AS_GROUP_MEMBER(iLocal_258[0], func_70());
											PED::SET_PED_AS_GROUP_MEMBER(iLocal_258[1], func_70());
											PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_258[0], 1);
											PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_258[1], 0);
			...
			if (!PED::IS_PED_INJURED(iLocal_258[0]))
			{
				...
				else
				{
					...
					if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_258[0], -875674219) == 1 || BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_258[0], -875674219) == 0)
					{
					}
				}
			}
			if (!PED::IS_PED_INJURED(iLocal_258[1]))
			{
				...
				else
				{
					...
					if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_258[1], -875674219) == 1 || BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_258[1], -875674219) == 0)
					{
					}
				}
			}
		...
		case 14:
			...
			while (iVar8 < *uParam6)
			{
				if (!PED::IS_PED_INJURED((*uParam6)[0]))
				{
					BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), (*uParam6)[iVar8], 4000, 2048, 2);
					BRAIN::OPEN_SEQUENCE_TASK(&iVar0);
					BRAIN::TASK_LEAVE_ANY_VEHICLE(0, 0, 4194816);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar7[iLocal_221 /*3*/], 2f, -1, 0.25f, 0, 1193033728);
					BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
					...
					BRAIN::TASK_LOOK_AT_ENTITY((*uParam6)[iVar8], PLAYER::PLAYER_PED_ID(), 4000, 2052, 2);
					func_167();
					SYSTEM::WAIT(0);
					if (iLocal_226 > 0)
					{
		...
		case 18:
			...
			while (iVar16 < iLocal_258)
			{
				if (!PED::IS_PED_INJURED(iLocal_258[iVar16]))
				{
					if (HUD::DOES_BLIP_EXIST(uLocal_255[iVar16]))
					{
						...
						BRAIN::TASK_COMBAT_PED(iLocal_258[iVar16], PLAYER::PLAYER_PED_ID(), 0, 16);
			...
			if (!bLocal_249)
			{
				if (!PED::IS_PED_INJURED(iLocal_257))
				{
					...
					BRAIN::TASK_PLAY_ANIM(iLocal_257, "random@getawaydriver", "base", 4f, -4f, -1, 1, 0, 0, 0, 0);
				}
			}
			iVar16 = 0;
			while (iVar16 < iLocal_259)
			{
				...
				{
					BRAIN::TASK_SMART_FLEE_PED(iLocal_259[iVar16], PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
...
void func_5(void fParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
...
void func_8()
{
	...
	{
		if (func_12(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_11(PLAYER::PLAYER_PED_ID());
			if (func_10(iVar0) && (!func_9(14) || Global_104171))
			{
...
void func_17(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	func_18(Global_105220.f_28021[iParam0 /*29*/].f_17, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
void func_21(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_105220.f_20535.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_23() /*12171*/].f_7688.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_105220.f_20535.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_23() /*12171*/].f_7688.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_27(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_23() /*12171*/].f_7688.f_10, iParam0);
}
...
int func_33(int iParam0, int iParam1)
{
	...
	if (func_43(&Global_4267702))
	{
		if (func_41(&Global_4267702, iParam0))
		{
			return 0;
		}
		if (func_34(&Global_4267702, iParam0))
		{
			return 1;
		}
	}
...
void func_37(var uParam0)
{
	...
	func_39(uParam0, (Global_4267701 - 0.5f));
}
...
void func_55(void fParam0, int iParam1)
{
		...
		if (!PED::IS_PED_INJURED(iLocal_258[iVar0]))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
			{
				if (!func_126())
				{
					...
					{
						BRAIN::TASK_GO_TO_ENTITY(iLocal_258[iVar0], PLAYER::PLAYER_PED_ID(), -1, 6f, 2f, 1073741824, 0);
					}
				...
				else
				{
					...
					if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_258[iVar0], 1227113341) == 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_258[iVar0], 1227113341) == 0)
					{
						BRAIN::CLEAR_PED_TASKS(iLocal_258[iVar0]);
					}
					if (!PED::IS_PED_INJURED(iLocal_258[0]) && !PED::IS_PED_INJURED(iLocal_258[1]))
					{
						PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_258[0], 1);
						...
						if (!ENTITY::IS_ENTITY_DEAD(iParam1, 0))
						{
							if (!func_178())
							{
								...
								if (!PED::IS_PED_INJURED((*uParam0)[1]) && !PED::IS_PED_INJURED(iLocal_257))
								{
									...
									BRAIN::TASK_AIM_GUN_AT_ENTITY(0, iLocal_257, -1, 0);
...
void func_76(int iParam0, int iParam1)
{
	...
	func_77(iParam0, &(Global_105220.f_32546.f_5510));
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_78(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_101(int iParam0)
{
	if (func_105())
	{
		...
		if (func_104(Global_105209))
		{
			func_102(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_104(Global_105209))
		{
...
int func_105()
{
	switch (func_106(&Global_25336, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_109(iParam0, Global_35905);
}
...
void func_111(int iParam0, void fParam1, int iParam2)
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, fParam1, func_112(iParam2), 1);
}
...
void func_117(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_118(iParam2)];
	if (iVar0 != 0)
	{
...
int func_119(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_118(iParam1)];
...
int func_123(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_121() == 0)
		{
			return MISC::IS_BIT_SET(func_119(func_120(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_139()) || Global_104267) || Global_25279) || func_138()) || func_137(8, -1)) || func_136()) || func_135()) || func_134()) || func_133()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_139()) || Global_25279) || func_138()) || func_137(8, -1)) || func_134()) || func_136()) || func_135()) || func_133()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_139()) || Global_104267) || Global_25279) || func_138()) || func_137(8, -1)) || func_134()) || func_136()) || func_135()) || func_133()) || Global_105220.f_7659.f_919[iVar0] == 5) || Global_36452 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_139()) || Global_104267) || Global_25279) || func_138()) || func_137(8, -1)) || func_136()) || func_135()) || func_133()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_139() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_137(8, -1)) || func_133()) || func_132()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_139()) || Global_25279) || func_138()) || func_137(8, -1)) || func_135()) || func_134()) || func_133()) || Global_105220.f_7659.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_139()) || func_135()) || Global_104267) || Global_25279) || func_138()) || Global_37057) || func_137(8, -1)) || func_134()) || func_132()) || func_133()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_139()) || Global_104267) || Global_25279) || func_138()) || func_137(8, -1)) || func_134()) || func_132()) || func_136()) || func_135()) || func_133())
						{
							return 0;
						}
						break;
...
void func_145(int iParam0, void fParam1, int iParam2)
{
...
int func_149(int iParam0, void fParam1, int iParam2)
{
	if (MISC::IS_BIT_SET(iParam0, 30))
	{
...
void func_151(var uParam0, int iParam1, int iParam2, void fParam3, int iParam4)
{
	int iVar0;
		...
		else
		{
			...
			if (bLocal_247)
			{
				...
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_260[1]))
				{
					...
					{
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_260[1], true);
						BRAIN::TASK_GO_TO_COORD_ANY_MEANS(iLocal_260[1], 68.7217f, -1569.83f, 28.6027f, 3f, 0, 0, 786603, -1082130432);
						PED::SET_PED_KEEP_TASK(iLocal_260[1], true);
					}
				}
...
int func_200()
{
	if ((Global_105209 == func_190() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_105210)
	{
		return 1;
	}
	return 0;
...
void func_203(int iParam0, void fParam1, int iParam2)
{
	if (MISC::IS_BIT_SET(*iParam0, 30))
	{
		switch (func_146(*iParam0))
...
int func_207(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_233(Global_105220.f_24966.f_43[iParam1]))
		{
			return 0;
		}
	...
	if (iLocal_269)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_257))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_257, "random@getawaydriver", "idle_a", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_257, "random@getawaydriver", "idle_2_hands_up", 3))
			{
				...
				{
					BRAIN::TASK_SMART_FLEE_PED(0, (*iParam1)[0], 150f, -1, 0, 0);
				}
				else if (!PED::IS_PED_INJURED((*iParam1)[1]))
				{
					BRAIN::TASK_SMART_FLEE_PED(0, (*iParam1)[1], 150f, -1, 0, 0);
				}
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_265);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_257, iLocal_265);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_265);
		...
		if (!bParam2)
		{
			if (!PED::IS_PED_INJURED((*iParam1)[0]))
			{
				BRAIN::TASK_SMART_FLEE_COORD((*iParam1)[0], func_179(PLAYER::PLAYER_ID()), 200f, -1, 0, 0);
			}
			if (!PED::IS_PED_INJURED((*iParam1)[1]))
			{
				BRAIN::TASK_SMART_FLEE_COORD((*iParam1)[1], func_179(PLAYER::PLAYER_ID()), 200f, -1, 0, 0);
			}
		}
		if (!iLocal_218)
		{
...
void func_240(int iParam0)
{
	...
	if (func_200())
	{
		...
		func_243(30000);
		StringCopy(&cVar0, func_242(Global_105209, 1), 64);
		if (func_189(Global_105209) > 0)
		{
