...
void func_1()
{
	switch (iLocal_85)
	{
		...
		case 4:
			...
			{
				SET_PED_CAPSULE(uLocal_78, 0.75f);
			}
			if (!func_69(4))
			{
		...
		case 6:
			if (!func_28(3))
			{
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -580.8914f, 2033.12f, 130.5113f, -578.4783f, 2035.029f, 127.5615f, 0.75f, 0, 1, 0))
				{
					func_27(3, 1);
				}
			}
			if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -580.2305f, 2032.054f, 130.2928f, -577.6669f, 2033.917f, 127.5157f, 0.75f, 0, 1, 0))
			{
				if (func_28(3))
				{
			...
			if (!func_28(2))
			{
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -580.2305f, 2032.054f, 130.2928f, -577.6669f, 2033.917f, 127.5157f, 0.75f, 0, 1, 0) || IS_SCREEN_FADED_OUT())
				{
			...
			if (func_28(1))
			{
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -594.9976f, 2089.005f, 130.3449f, -597.1125f, 2088.365f, 133.3035f, 1f, 0, 1, 0))
				{
...
bool func_16(int iParam0)
{
	...
	iVar1 = GET_BITS_IN_RANGE(Global_106565.f_10043.f_133, 0, (iVar0 - 1));
...
void func_18(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	func_19(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_19(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, var uParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	var uVar0;
	bool bVar1;
	bool bVar2;
	...
	if (DOES_ENTITY_EXIST(uVar0))
	{
		...
		if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_23(uVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_23(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
void func_27(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		SET_BIT(&uLocal_92, iParam0);
	}
	else
	{
		CLEAR_BIT(&uLocal_92, iParam0);
	}
}

bool func_28(int iParam0)
{
	return IS_BIT_SET(uLocal_92, iParam0);
}
...
void func_29()
{
	...
	switch (iLocal_72)
	{
		case 0:
			if (!GET_MISSION_FLAG())
			{
				if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_51, vLocal_65, 1, 1, 0))
				{
					if (func_55())
					{
						iLocal_72 = 2;
		...
		case 1:
			...
			{
				if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_54, vLocal_65, 1, 1, 0))
				{
					func_48(0);
					iLocal_72 = 3;
					func_54(0, 800);
		...
		case 2:
			...
			if (IS_SCREEN_FADED_OUT())
			{
				...
				NEW_LOAD_SCENE_START_SPHERE(vLocal_61, 20f, 0);
				func_33(24, &iLocal_71);
				_LOAD_INTERIOR(iLocal_71);
				iLocal_86 = (GET_GAME_TIMER() + 40000);
				while ((!IS_NEW_LOAD_SCENE_LOADED() || !IS_INTERIOR_READY(iLocal_71)) && iLocal_86 > GET_GAME_TIMER())
				{
					WAIT(0);
				}
				NEW_LOAD_SCENE_STOP();
				if (iLocal_86 <= GET_GAME_TIMER())
				{
					UNPIN_INTERIOR(iLocal_71);
					func_38(PLAYER_PED_ID(), vLocal_57, fLocal_60);
					func_54(1, 800);
					iLocal_72 = 0;
				}
				else
...
void func_30(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	var uVar0;
	int iVar1;
...
void func_38(var uParam0, vector3 vParam1, float fParam4)
{
...
void func_43()
{
	...
	{
		case 0:
			if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vVar0, vVar3, fVar6, 0, 1, 0) && !func_5(0))
			{
				func_47(sLocal_90);
				iLocal_73++;
			}
		...
		case 1:
			if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vVar0, vVar3, fVar6, 0, 1, 0) && !func_5(0))
			{
				if (!func_46(PLAYER_PED_ID(), -880529684))
				{
				...
				{
					func_45(0);
					TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER_PED_ID(), -1007.351f, -477.5197f, 49.0282f, 1f, -1, 0.5f, 0, 30.4025f);
					func_47(sLocal_91);
					DISPLAY_RADAR(0);
					SET_CAM_ACTIVE(uLocal_74, 1);
...
void func_61(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam1)
	{
		SET_BIT(&(Global_106565.f_10043.f_133), iParam0);
		if (!bParam2)
		{
			PLAY_SOUND_FRONTEND(uLocal_81, sLocal_79, sLocal_80, 0);
		}
		func_62();
	}
	else
	{
		CLEAR_BIT(&(Global_106565.f_10043.f_133), iParam0);
	}
}
...
int func_65()
{
	if (func_60(PLAYER_PED_ID()))
	{
		return IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0);
	}
	return 0;
}
...
bool func_66()
{
	return VDIST2(func_68(iLocal_85), vLocal_82) < func_67(iLocal_85);
}
...
{
	return IS_BIT_SET(Global_106565.f_10043.f_133, iParam0);
}
...
int func_70()
{
	switch (iLocal_85)
	{
		...
		case 6:
			return (func_72() || (func_28(2) && func_71(vLocal_68)));
...
var func_71(vector3 vParam0)
{
	var uVar0;
	var uVar1;
	
	return GET_SCREEN_COORD_FROM_WORLD_COORD(vParam0, &uVar0, &uVar1);
}

bool func_72()
{
	return VDIST2(func_74(iLocal_85), vLocal_82) < func_73(iLocal_85);
}
...
void func_75()
{
	if (func_60(PLAYER_PED_ID()))
	{
		vLocal_82 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 0) };
	}
}
...
void func_76(vector3 vParam0)
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("murdermystery")) > 1)
	{
		TERMINATE_THIS_THREAD();
	}
	iVar0 = 0;
...
void func_77()
{
	switch (iLocal_85)
	{
		...
		case 4:
			func_79(-671910391);
			func_78(sLocal_88);
			uLocal_78 = CREATE_PED(26, -671910391, func_68(4), 184.5548f, 1, 1);
			SET_MODEL_AS_NO_LONGER_NEEDED(-671910391);
			TASK_PLAY_ANIM(uLocal_78, sLocal_88, sLocal_89, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_78, 1);
			SET_PED_KEEP_TASK(uLocal_78, 1);
			FREEZE_ENTITY_POSITION(uLocal_78, 1);
			STOP_PED_SPEAKING(uLocal_78, 1);
			DISABLE_PED_PAIN_AUDIO(uLocal_78, 1);
			SET_PED_CONFIG_FLAG(uLocal_78, 118, 0);
			SET_PED_CONFIG_FLAG(uLocal_78, 208, 1);
			SET_ENTITY_INVINCIBLE(uLocal_78, 1);
			SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_78, 1862763509);
			break;
		...
		case 5:
			...
			uLocal_74 = CREATE_CAMERA_WITH_PARAMS(26379945, -1008.056f, -476.7573f, 50.2493f, -89.5003f, 0f, 38.7952f, 50f, 0, 2);
			break;
		
		case 6:
			func_79(732742363);
			uLocal_76 = CREATE_PED(26, 732742363, func_68(6), 22.9631f, 1, 1);
			SET_PED_PROP_INDEX(uLocal_76, 0, 0, 0, 0);
			SET_MODEL_AS_NO_LONGER_NEEDED(732742363);
			STOP_PED_SPEAKING(uLocal_76, 1);
			DISABLE_PED_PAIN_AUDIO(uLocal_76, 1);
			EXPLODE_PED_HEAD(uLocal_76, joaat("weapon_sniperrifle"));
			SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_76, 1862763509);
			uLocal_77 = CREATE_OBJECT_NO_OFFSET(130556722, -543.71f, 1986.2f, 126.05f, 1, 1, 0);
			break;
	}
}
...
bool func_81(vector3 vParam0, vector3 vParam3, float fParam6)
{
...
void func_84()
{
	switch (iLocal_85)
	{
		...
		case 4:
			if (DOES_ENTITY_EXIST(uLocal_78))
			{
				SET_PED_AS_NO_LONGER_NEEDED(&uLocal_78);
			}
		...
		case 5:
			...
			if (DOES_CAM_EXIST(uLocal_74))
			{
				DESTROY_CAM(uLocal_74, 0);
			}
			if (func_28(4))
			{
				DO_SCREEN_FADE_IN(0);
		...
		case 6:
			...
			if (DOES_ENTITY_EXIST(uLocal_77))
			{
				SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_77);
			}
			if (func_28(2))
			{
				REMOVE_MODEL_HIDE(vLocal_68, 200f, -1241212535, 0);
			}
			break;
	}
}
