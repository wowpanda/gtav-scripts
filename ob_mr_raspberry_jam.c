...
void __EntryFunction__()
{
	...
	vLocal_286 = { 0f, 0f, 0f };
	vLocal_289 = { 0f, 0f, 0f };
	iLocal_296 = GET_RANDOM_INT_IN_RANGE(0, 4);
	func_70();
	...
	func_62(&uLocal_108, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
	while (true)
	{
		WAIT(0);
		if (DOES_ENTITY_EXIST(uLocal_41))
		{
			if (((((IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE(uLocal_41) && !IS_ENTITY_DEAD(uLocal_41, 0)) && !IS_PED_INJURED(PLAYER_PED_ID())) && func_57()) && func_56(0)) && !IS_PLAYER_SWITCH_IN_PROGRESS())
			{
				switch (iLocal_292)
				{
					case 0:
...
void func_1()
{
	...
	{
		case 0:
			if (func_46(vVar0, vVar3) && _0xFCF37A457CB96DC0(PLAYER_PED_ID(), GET_ENTITY_COORDS(uLocal_41, 1), 90f))
			{
				func_70();
		...
		case 2:
			...
			uLocal_294 = CREATE_SYNCHRONIZED_SCENE(func_31(), func_30(), 2);
			TASK_SYNCHRONIZED_SCENE(PLAYER_PED_ID(), uLocal_294, func_29(), func_28(iLocal_296), 8f, -2f, 0, 0, 1148846080, 0);
			PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_41, uLocal_294, func_27(iLocal_296), func_29(), 8f, -2f, 0, 1148846080);
			if (_0x7F2F4F13AC5257EF(uLocal_294))
			{
				_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_294, 0);
			}
			if (GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
			{
				uLocal_295 = CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
				PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_295, uLocal_294, func_24(iLocal_296), func_29());
			...
			iLocal_299 = 0;
			iLocal_300 = (GET_GAME_TIMER() + func_23());
			iLocal_293 = 3;
			break;
		...
		case 3:
			...
			HIDE_HUD_AND_RADAR_THIS_FRAME();
			DISABLE_CONTROL_ACTION(1, 0, 1);
			if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_294))
			{
				func_21();
				if (iLocal_297)
				{
					fVar6 = GET_SYNCHRONIZED_SCENE_PHASE(uLocal_294);
					if (FIND_ANIM_EVENT_PHASE(func_29(), func_28(iLocal_296), "WalkInterruptible", &fVar7, &fVar8))
					{
				...
				if (!iLocal_299 && GET_GAME_TIMER() > iLocal_300)
				{
		...
		case 5:
			...
			if (STAT_GET_INT(joaat("num_sh_mr_jam_used"), &iLocal_301, -1))
			{
				STAT_SET_INT(joaat("num_sh_mr_jam_used"), iLocal_301 + 1, 1);
			}
...
void func_34(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_39(PLAYER_ID())) && !func_36(PLAYER_ID(), 0)) && !func_35()) && !bParam4) && !bParam5)
			{
...
int func_52()
{
	if (REQUEST_AMBIENT_AUDIO_BANK(func_53(), 0, -1))
	{
		return 1;
	}
	return 0;
...
int func_56(int iParam0)
{
	...
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		...
		{
			if (func_47(GET_ENTITY_COORDS(uLocal_41, 0), func_51(), 5f, 0))
			{
				return 1;
			}
		}
...
void func_62(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_69()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if ((!IS_PLAYER_CONTROL_ON(PLAYER_ID()) && func_43(1, 0, 1)) && iLocal_36)
		{
			func_34(0, 1, 1, 0, 0, 0);
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
