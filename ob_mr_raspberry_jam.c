	...
	switch (iLocal_40)
	{
		...
		case joaat("prop_mr_raspberry_01"):
			if (Global_105220.f_7232.f_227[145] == 1)
			{
				if (func_10() == 2)
				{
					if (((((Global_88106[13] != 127 && Global_88106[13] != 135) && Global_88122 != 127) && Global_88122 != 135) && !func_59()) && !func_61())
					{
						return 1;
					}
				}
...
{
	return func_67(iParam0, Global_35905);
}
