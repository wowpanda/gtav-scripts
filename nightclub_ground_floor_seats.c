...
int func_71()
{
	if (IS_SCREEN_FADED_OUT() && !func_84())
	{
		return 1;
	}
	if (!func_83())
...
int func_83()
{
	if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1607.052f, -3011.89f, -80.00597f, -1574.768f, -3011.67f, -77.99634f, 9.5f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
int func_85()
{
	if (Global_2424047[PLAYER_ID() /*416*/].f_309.f_8 != func_19())
	{
		if (NETWORK_IS_SCRIPT_ACTIVE("nightclub_ground_floor_seats", Global_2424047[PLAYER_ID() /*416*/].f_309.f_8, 1, 0))
		{
			return 0;
		}
...
Vector3 func_89(vector3 vParam0, var uParam3)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
