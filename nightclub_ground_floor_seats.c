...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_141.f_4)
	{
		...
		case 5:
			...
			{
				uParam0->f_141.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_46(uParam0), func_45(uParam0), 2, true, false, 1065353216, 0, 1.12f);
...
int func_54(var uParam0)
{
	...
	while (iVar0 < NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			{
				if (func_62(PLAYER::GET_PLAYER_PED(iVar1), uParam0[uParam0->f_141.f_2 /*14*/]) || func_56(iVar1) == uParam0->f_141.f_2)
				{
					return 1;
				}
			}
...
void func_68(var uParam0)
{
	...
	func_69(&(uParam0->f_141), 2, BRAIN::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
...
int func_84()
{
	if (Global_2423644[PLAYER::PLAYER_ID() /*406*/].f_305.f_4 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("nightclub_ground_floor_seats", Global_2423644[PLAYER::PLAYER_ID() /*406*/].f_305.f_4, 1, 0))
		{
			return 0;
		}
...
void func_85()
{
	func_86(0, &uLocal_144, 0, 2);
	func_86(1, &uLocal_144, 1, 1);
	func_86(2, &uLocal_144, 2, 2);
	func_86(3, &uLocal_144, 3, 1);
	func_86(5, &uLocal_144, 5, 1);
	func_86(6, &uLocal_144, 6, 2);
	func_86(7, &uLocal_144, 7, 1);
	func_86(8, &uLocal_144, 8, 2);
	func_86(9, &uLocal_144, 9, 1);
}
