...
void func_1(var uParam0)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			if (func_55(PLAYER_PED_ID(), &(uParam0->f_16[uParam0->f_9 /*14*/])) && func_54(PLAYER_PED_ID(), uParam0->f_16[uParam0->f_9 /*14*/].f_3, uParam0->f_16[uParam0->f_9 /*14*/].f_13))
			{
				if ((((((((((((func_53(uParam0) || func_49(uParam0)) || func_48(uParam0)) || !func_47(uParam0)) || func_45(PLAYER_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || IS_PED_IN_MELEE_COMBAT(PLAYER_PED_ID())) || _0xDCCA191DF9980FD7(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_INJURED(PLAYER_PED_ID())) || IS_BIT_SET(Global_1671295.f_4, 2)) || func_44(uParam0->f_16[uParam0->f_9 /*14*/].f_13))
				{
					if (func_49(uParam0))
					{
				...
				else if (IS_CONTROL_JUST_PRESSED(0, 51))
				{
					...
					{
						SET_BIT(&(Global_2424047[PLAYER_ID() /*416*/].f_309.f_4), 15);
						func_35(157);
					}
				}
			}
		...
		case 4:
			...
			vVar20 = { GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar16, func_30(uParam0), func_29(uParam0), 0, 2) };
			vVar23 = { GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_30(uParam0), func_29(uParam0), 0, 2) };
			uVar26 = vVar23.z;
			fVar27 = 0.05f;
		...
		case 5:
			...
			vVar29 = { GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_30(uParam0), func_29(uParam0), 0, 2) };
			fVar32 = vVar29.z;
			if ((iVar28 != 1 && iVar28 != 0) || func_16(GET_ENTITY_HEADING(PLAYER_PED_ID()), fVar32, 5f))
			{
				if (uParam0->f_1.f_1 == 3)
				{
					if (_0xEE778F8C7E1142E2(0) == 4)
				...
				DISABLE_CONTROL_ACTION(0, 0, 1);
				uParam0->f_8 = NETWORK_CREATE_SYNCHRONISED_SCENE(func_30(uParam0), func_29(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uParam0->f_8, &sVar0, &sVar16, 2f, -1000f, 9, 0, 1148846080, 0);
		...
		case 6:
			...
			func_17(uParam0);
			func_8(uParam0);
			uVar33 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_8);
			if (func_32(&(uParam0->f_7), 13))
			{
				DISABLE_CONTROL_ACTION(0, 0, 1);
			}
			if (IS_SYNCHRONIZED_SCENE_RUNNING(uVar33))
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(uVar33) >= 1f)
				{
					...
					func_33(uParam0, &sVar16);
					uParam0->f_8 = NETWORK_CREATE_SYNCHRONISED_SCENE(func_30(uParam0), func_29(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
					NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uParam0->f_8, &sVar0, &sVar16, 4f, -1.5f, 9, 0, 1148846080, 0);
					NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_8);
					func_31(&(uParam0->f_7), 8);
		...
		case 8:
			uVar34 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_8);
			iVar35 = GET_SCRIPT_TASK_STATUS(PLAYER_PED_ID(), 1785177548);
			if (iVar35 == 0 || iVar35 == 1)
			{
				if (IS_SYNCHRONIZED_SCENE_RUNNING(uVar34))
				{
					if ((GET_SYNCHRONIZED_SCENE_PHASE(uVar34) >= 0.7f || HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), GET_HASH_KEY("BREAKOUT_FINISH"))) || HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), GET_HASH_KEY("BREAK_OUT")))
					{
						NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_8);
						func_28(-1);
						func_40(uParam0);
...
void func_8(var uParam0)
{
	...
	if (uParam0->f_13 == 6)
	{
		...
		fVar3 = VMAG(vVar0);
		if ((uParam0->f_13 == 6 && !HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), GET_HASH_KEY("BLOCK_INTERRUPT"))) && !func_32(&(uParam0->f_7), 12))
		{
		...
		else
		{
			...
			if (((((!IS_PAUSE_MENU_ACTIVE() && !func_32(&(uParam0->f_7), 0)) && !func_32(&(uParam0->f_7), 4)) && !func_11()) && !func_9(1)) && uParam0->f_1.f_3 != 3)
			{
				if (uParam0->f_6 == -1)
				{
...
void func_14(var uParam0)
{
	...
	uParam0->f_8 = NETWORK_CREATE_SYNCHRONISED_SCENE(func_30(uParam0), func_29(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
	func_34(uParam0, &sVar0);
	NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uParam0->f_8, &sVar0, "exit", 4f, -4f, 9, 0, 1148846080, 0);
	NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_8);
	func_41(&(uParam0->f_6));
	func_57(uParam0, 8);
}
...
int func_48(var uParam0)
{
	...
	while (iVar11 < 10)
	{
		if (((DOES_ENTITY_EXIST(uVar0[iVar11]) && !IS_PED_INJURED(uVar0[iVar11])) && IS_ENTITY_VISIBLE(uVar0[iVar11])) && func_55(uVar0[iVar11], &(uParam0->f_16[uParam0->f_9 /*14*/])))
		{
			return 1;
		}
		iVar11++;
...
int func_49(var uParam0)
{
	...
	while (iVar0 < _NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK_IS_PARTICIPANT_ACTIVE(INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if (iVar1 != PLAYER_ID() && func_52(iVar1, 1, 1))
			{
				if (func_55(GET_PLAYER_PED(iVar1), &(uParam0->f_16[uParam0->f_9 /*14*/])) || func_50(iVar1) == uParam0->f_9)
				{
					return 1;
				}
			}
...
int func_54(var uParam0, vector3 vParam1, int iParam4)
{
	if (DOES_ENTITY_EXIST(uParam0))
	{
		if (iParam4 == 3 || iParam4 == 4)
		{
			if (func_16(GET_ENTITY_HEADING(uParam0), (vParam1.z - 180f), 45f))
			{
				return 1;
			}
		}
		else if (func_16(GET_ENTITY_HEADING(uParam0), vParam1.z, 45f))
		{
			return 1;
		}
	}
...
{
	return IS_ENTITY_IN_ANGLED_AREA(uParam0, uParam1->f_6.f_1, uParam1->f_6.f_4, uParam1->f_6, 0, 1, 0);
}
...
void func_61(var uParam0)
{
	...
	func_62(&(uParam0->f_7), 1, IS_ENTITY_DEAD(PLAYER_PED_ID(), 0));
	func_62(&(uParam0->f_7), 3, IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1));
...
int func_64()
{
	...
	if (func_78(PLAYER_ID()) && IS_SCREEN_FADED_OUT())
	{
		return 1;
	}
	if (func_76() != 0)
...
void func_85(var uParam0)
{
	...
	{
		func_28(-1);
		uVar0 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_8);
		if (IS_SYNCHRONIZED_SCENE_RUNNING(uVar0))
		{
			NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_8);
		}
	}
	CLEAR_BIT(&(Global_2424047[PLAYER_ID() /*416*/].f_309.f_4), 15);
}

void func_86()
{
	NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, 0, func_97());
	func_95(0, -1, 0);
	func_94();
	func_87();
	if (NETWORK_IS_GAME_IN_PROGRESS())
...
void func_88(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	uParam1->f_16[iParam2 /*14*/].f_6.f_1 = { func_90(func_92(), func_91(iParam3, fVar3)) + vVar0 };
	uParam1->f_16[iParam2 /*14*/].f_6.f_4 = { func_90(func_89(), func_91(iParam3, fVar3)) + vVar0 };
...
Vector3 func_90(vector3 vParam0, var uParam3)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
