...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_15();
		if ((!iLocal_195 && !IS_NEW_LOAD_SCENE_ACTIVE()) && func_14())
		{
			if (!Global_1573972)
			{
		...
		if (!IS_NEW_LOAD_SCENE_ACTIVE() && func_14())
		{
			if (!NETWORK_IS_ACTIVITY_SESSION() || func_11())
			{
				if (!Global_1573973)
				{
					...
					if (!IS_BIT_SET(Global_4456448.f_154959, 14))
					{
			...
			if (!Global_1573976)
			{
				if (IS_BIT_SET(Global_1671295.f_5, 18))
				{
				...
				if (IS_BIT_SET(Global_1671295.f_5, 19))
				{
				...
				{
					REQUEST_IPL("hei_dlc_casino_aircon");
				}
			}
		}
		if (!func_14())
		...
		else if (!IS_NEW_LOAD_SCENE_ACTIVE() && !func_14())
		{
			func_4();
			iLocal_197 = 0;
		}
...
void func_1()
{
	if (!IS_BIT_SET(Global_35547, 0))
	{
		if (!DOES_ENTITY_EXIST(uLocal_199[0]))
		{
			REQUEST_MODEL(476379176);
			if (HAS_MODEL_LOADED(476379176))
			{
				uLocal_199[0] = CREATE_OBJECT_NO_OFFSET(476379176, 2222.883f, 5612.299f, 55.291f, 0, 0, 1);
				SET_ENTITY_ROTATION(uLocal_199[0], 0.5f, 0f, 15.325f, 2, 1);
				FREEZE_ENTITY_POSITION(uLocal_199[0], 1);
				SET_MODEL_AS_NO_LONGER_NEEDED(476379176);
			}
		}
	}
	else if (DOES_ENTITY_EXIST(uLocal_199[0]))
	{
		DELETE_OBJECT(&(uLocal_199[0]));
	}
	if ((!IS_BIT_SET(Global_35547, 1) && func_3() == 0) && !(NETWORK_IS_ACTIVITY_SESSION() && (func_2(Global_4456448.f_138474) == 14 || func_2(Global_4456448.f_138474) == 15)))
	{
		if (!DOES_ENTITY_EXIST(uLocal_199[1]))
		{
			REQUEST_MODEL(630616933);
			if (HAS_MODEL_LOADED(630616933))
			{
				uLocal_199[1] = CREATE_OBJECT_NO_OFFSET(630616933, -362.402f, 4829.89f, 142.477f, 0, 0, 1);
				SET_ENTITY_ROTATION(uLocal_199[1], 0f, 0f, 320f, 2, 1);
				FREEZE_ENTITY_POSITION(uLocal_199[1], 1);
				SET_MODEL_AS_NO_LONGER_NEEDED(630616933);
			}
		}
	}
	else if (DOES_ENTITY_EXIST(uLocal_199[1]))
	{
		DELETE_OBJECT(&(uLocal_199[1]));
	}
}
...
void func_5(int iParam0, bool bParam1)
{
	...
	if (func_10(iParam0))
	{
		...
		while (iVar0 < 2)
		{
			REMOVE_IPL(func_8(iParam0, iVar0));
			iVar0++;
		}
		if (!bParam1)
		{
		...
		if (Global_2537295.f_118 <= 0 || bParam1)
		{
			...
			SET_MODEL_AS_NO_LONGER_NEEDED(func_6());
			if (!bParam1)
			{
...
void func_15()
{
	...
	while (iVar6 < 7)
	{
		if (Global_32194[iVar6] != 0 || Global_32202[iVar6] != 0)
		{
			bVar7 = false;
		}
		iVar6++;
	...
	if (func_23(iVar0))
	{
		if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), vVar1, 1) > 250f)
		{
			func_22(iVar0, 0);
			func_21(iVar0, 1);
			if (iVar0 == 17)
	...
	if (func_20(iVar0) && !ARE_STRINGS_EQUAL(&Global_33147, vVar1.f_3))
	{
		bVar8 = false;
		...
		if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), vVar1, 1) > 250f && !bVar8)
		{
			func_18(iVar0, 1);
			func_16(iVar0, 0);
			if (iVar0 == 17)
...
void func_26()
{
	...
	{
		fLocal_83 = GET_DISTANCE_BETWEEN_COORDS(Global_35548[iLocal_81 /*31*/].f_2, GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 1);
	}
	else
	{
		fVar0 = GET_DISTANCE_BETWEEN_COORDS(Global_35548[iLocal_81 /*31*/].f_2, GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 1);
		if (fVar0 < fLocal_83)
		{
			fLocal_83 = fVar0;
			iLocal_82 = iLocal_81;
...
void func_27(int iParam0)
{
	...
	SET_BIT(&iLocal_95, iParam0);
	if (IS_BIT_SET(Global_35548[iParam0 /*31*/].f_1, 4))
	{
		if (IS_PLAYER_PLAYING(PLAYER_ID()))
		{
			if (GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0)
			{
				if (!IS_BIT_SET(Global_35548[iParam0 /*31*/].f_1, 6))
				{
					func_34(iParam0, 1);
				}
			}
			else if (IS_BIT_SET(Global_35548[iParam0 /*31*/].f_1, 6))
			{
				func_34(iParam0, 0);
			}
		}
	...
	if ((IS_BIT_SET(Global_35548[iParam0 /*31*/].f_1, 6) || IS_BIT_SET(Global_35548[iParam0 /*31*/].f_1, 5)) || func_31(iParam0))
	{
		func_30(iParam0);
		iLocal_84 = iParam0;
		...
		{
			_0x06C0023BED16DD6B(Global_35548[iParam0 /*31*/], 1);
		}
		if (IS_BIT_SET(Global_35548[iParam0 /*31*/].f_1, 7))
		{
			func_29(iParam0, 1);
		}
		if (!IS_BIT_SET(Global_35548[iParam0 /*31*/].f_1, 2))
		{
			if (IS_BIT_SET(Global_35548[iParam0 /*31*/].f_1, 1))
			{
				if (Global_35548[iParam0 /*31*/].f_22 > -1f)
				{
					Global_35548[iParam0 /*31*/].f_22 = (Global_35548[iParam0 /*31*/].f_22 - (Global_35548[iParam0 /*31*/].f_23 * TIMESTEP()));
					if (Global_35548[iParam0 /*31*/].f_22 < -1f)
					{
						Global_35548[iParam0 /*31*/].f_22 = -1f;
					}
					CLEAR_BIT(&(Global_35548[iParam0 /*31*/].f_1), 3);
				}
				else
				{
					SET_BIT(&(Global_35548[iParam0 /*31*/].f_1), 2);
				}
			}
		...
		else if (IS_BIT_SET(Global_35548[iParam0 /*31*/].f_1, 1))
		{
			if (Global_35548[iParam0 /*31*/].f_22 > -1f)
			{
				CLEAR_BIT(&(Global_35548[iParam0 /*31*/].f_1), 2);
			}
		}
		else if (Global_35548[iParam0 /*31*/].f_22 < 1f)
		{
	...
	else
	{
		...
		if (!IS_BIT_SET(Global_35548[iParam0 /*31*/].f_1, 3))
		{
			bVar2 = false;
			uVar3 = GET_CLOSEST_VEHICLE(Global_35548[iParam0 /*31*/].f_2, 15f, 0, 2175);
			if (DOES_ENTITY_EXIST(uVar3))
			{
				if (IS_VEHICLE_DRIVEABLE(uVar3, 0))
				{
					fVar4 = VDIST2(GET_ENTITY_COORDS(uVar3, 1), Global_35548[iParam0 /*31*/].f_2);
			...
			if (IS_BIT_SET(Global_35548[iParam0 /*31*/].f_1, 1))
			{
				...
				{
					Global_35548[iParam0 /*31*/].f_22 = 0f;
					SET_BIT(&(Global_35548[iParam0 /*31*/].f_1), 3);
				}
			}
		...
		else
		{
			if ((((((((Global_35548[iParam0 /*31*/] == -1735618852 || Global_35548[iParam0 /*31*/] == 213039352) || Global_35548[iParam0 /*31*/] == -1247364148) || Global_35548[iParam0 /*31*/] == 935592315) || Global_35548[iParam0 /*31*/] == 179480401) || Global_35548[iParam0 /*31*/] == -804938986) || Global_35548[iParam0 /*31*/] == -599111730) || Global_35548[iParam0 /*31*/] == 1423193534) || Global_35548[iParam0 /*31*/] == -1958174046)
			{
				_0x06C0023BED16DD6B(Global_35548[iParam0 /*31*/], 0);
			}
			func_28(iParam0);
		}
	}
...
void func_29(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!IS_BIT_SET(Global_35548[iVar0 /*31*/].f_1, 2))
		{
			if (IS_BIT_SET(Global_35548[iVar0 /*31*/].f_1, 1))
			{
				if (Global_35548[iVar0 /*31*/].f_22 > -1f)
				{
					Global_35548[iVar0 /*31*/].f_22 = (Global_35548[iVar0 /*31*/].f_22 - (Global_35548[iVar0 /*31*/].f_23 * TIMESTEP()));
					if (Global_35548[iVar0 /*31*/].f_22 < -1f)
					{
						Global_35548[iVar0 /*31*/].f_22 = -1f;
					}
					CLEAR_BIT(&(Global_35548[iVar0 /*31*/].f_1), 3);
				}
				else
				{
					SET_BIT(&(Global_35548[iVar0 /*31*/].f_1), 2);
				}
			}
			...
			_SET_DOOR_AJAR_ANGLE(Global_35548[iVar0 /*31*/], Global_35548[iVar0 /*31*/].f_22, 0, 0);
			_SET_DOOR_ACCELERATION_LIMIT(Global_35548[iVar0 /*31*/], 1, 0, 1);
		}
		else if (IS_BIT_SET(Global_35548[iVar0 /*31*/].f_1, 1))
		{
			if (Global_35548[iVar0 /*31*/].f_22 > -1f)
			{
				CLEAR_BIT(&(Global_35548[iVar0 /*31*/].f_1), 2);
			}
		}
		else if (Global_35548[iVar0 /*31*/].f_22 < 1f)
		{
	...
	else if (!IS_BIT_SET(Global_35548[iVar0 /*31*/].f_1, 3))
	{
		bVar1 = false;
		uVar2 = GET_CLOSEST_VEHICLE(Global_35548[iVar0 /*31*/].f_2, 15f, 0, 2175);
		if (DOES_ENTITY_EXIST(uVar2))
		{
			if (IS_VEHICLE_DRIVEABLE(uVar2, 0))
			{
				fVar3 = VDIST2(GET_ENTITY_COORDS(uVar2, 1), Global_35548[iVar0 /*31*/].f_2);
		...
		if (IS_BIT_SET(Global_35548[iVar0 /*31*/].f_1, 1))
		{
			...
			{
				Global_35548[iVar0 /*31*/].f_22 = 0f;
				SET_BIT(&(Global_35548[iVar0 /*31*/].f_1), 3);
			}
		}
	...
	if (Global_35548[iParam0 /*31*/].f_24 > 0)
	{
		...
		while (iVar0 < Global_35548[iParam0 /*31*/].f_24)
		{
			...
			if (DOES_ENTITY_EXIST(uVar1))
			{
				...
				{
					if (VDIST2(Global_35548[iParam0 /*31*/].f_2, GET_ENTITY_COORDS(uVar1, 1)) < Global_35548[iParam0 /*31*/].f_6)
					{
						if (IS_ENTITY_IN_ANGLED_AREA(uVar1, Global_35548[iParam0 /*31*/].f_9, Global_35548[iParam0 /*31*/].f_12, Global_35548[iParam0 /*31*/].f_8, 0, 1, 0))
						{
							iLocal_86 = iVar0;
							return 1;
						}
						if (IS_BIT_SET(Global_35548[iParam0 /*31*/].f_1, 0))
						{
							if (IS_ENTITY_IN_ANGLED_AREA(uVar1, Global_35548[iParam0 /*31*/].f_16, Global_35548[iParam0 /*31*/].f_19, Global_35548[iParam0 /*31*/].f_15, 0, 1, 0))
							{
								iLocal_86 = iVar0;
								return 1;
							}
						...
						if (IS_PED_IN_ANY_VEHICLE(uVar1, 0))
						{
							...
							vVar9 = { func_32() };
							vVar12 = { func_32() };
							GET_MODEL_DIMENSIONS(GET_ENTITY_MODEL(uVar2), &vVar3, &vVar6);
							vVar6.x = 0f;
							vVar3.x = 0f;
							vVar9 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uVar2, vVar6) };
							vVar12 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uVar2, vVar3) };
							if (IS_POINT_IN_ANGLED_AREA(vVar9, Global_35548[iParam0 /*31*/].f_9, Global_35548[iParam0 /*31*/].f_12, Global_35548[iParam0 /*31*/].f_8, 0, 1))
							{
								iLocal_86 = iVar0;
								return 1;
							}
							if (IS_POINT_IN_ANGLED_AREA(vVar12, Global_35548[iParam0 /*31*/].f_9, Global_35548[iParam0 /*31*/].f_12, Global_35548[iParam0 /*31*/].f_8, 0, 1))
							{
								iLocal_86 = iVar0;
								return 1;
							}
							if (IS_BIT_SET(Global_35548[iParam0 /*31*/].f_1, 0))
							{
								if (IS_POINT_IN_ANGLED_AREA(vVar9, Global_35548[iParam0 /*31*/].f_16, Global_35548[iParam0 /*31*/].f_19, Global_35548[iParam0 /*31*/].f_15, 0, 1))
								{
									iLocal_86 = iVar0;
									return 1;
								}
								if (IS_POINT_IN_ANGLED_AREA(vVar12, Global_35548[iParam0 /*31*/].f_16, Global_35548[iParam0 /*31*/].f_19, Global_35548[iParam0 /*31*/].f_15, 0, 1))
								{
									iLocal_86 = iVar0;
									return 1;
								}
							}
							if (IS_VEHICLE_ATTACHED_TO_TRAILER(uVar2))
							{
								iVar15 = 0;
								if (GET_VEHICLE_TRAILER_VEHICLE(uVar2, &iVar15))
								{
									if (IS_ENTITY_IN_ANGLED_AREA(iVar15, Global_35548[iParam0 /*31*/].f_9, Global_35548[iParam0 /*31*/].f_12, Global_35548[iParam0 /*31*/].f_8, 0, 1, 0))
									{
										iLocal_86 = iVar0;
										return 1;
									}
									if (IS_BIT_SET(Global_35548[iParam0 /*31*/].f_1, 0))
									{
										if (IS_ENTITY_IN_ANGLED_AREA(iVar15, Global_35548[iParam0 /*31*/].f_16, Global_35548[iParam0 /*31*/].f_19, Global_35548[iParam0 /*31*/].f_15, 0, 1, 0))
										{
											iLocal_86 = iVar0;
											return 1;
										}
...
void func_34(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		SET_BIT(&(Global_35548[iParam0 /*31*/].f_1), 6);
	}
	else
	{
		CLEAR_BIT(&(Global_35548[iParam0 /*31*/].f_1), 6);
	}
}
		...
		if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
		{
			switch (iParam0)
			{
				case 13:
					...
					{
						if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_84500[78 /*34*/].f_6) == 0)
						{
							if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), Global_35548[13 /*31*/].f_2, 1) <= 100f)
							{
								if (!func_45(13, PLAYER_PED_ID()))
								{
									func_44(13, PLAYER_PED_ID());
								}
							}
							else if (func_45(13, PLAYER_PED_ID()))
							{
								func_33(13, PLAYER_PED_ID(), 0);
							}
						}
					}
					else if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_84500[78 /*34*/].f_6) == 0)
					{
						if (func_45(13, PLAYER_PED_ID()))
						{
							func_33(13, PLAYER_PED_ID(), 0);
				...
				case 17:
				case 16:
					if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_84500[9 /*34*/].f_6) == 0 && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("extreme2")) == 0)
					{
						if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), Global_35548[17 /*31*/].f_2, 1) <= 100f)
						{
							switch (func_39())
							{
								case 0:
									if (func_38(12, 5))
									{
										if (!func_45(17, PLAYER_PED_ID()))
										{
											func_44(17, PLAYER_PED_ID());
										}
										if (!func_45(16, PLAYER_PED_ID()))
										{
											func_44(16, PLAYER_PED_ID());
										}
									}
									else
									{
										if (func_45(17, PLAYER_PED_ID()))
										{
											func_33(17, PLAYER_PED_ID(), 0);
										}
										if (func_45(16, PLAYER_PED_ID()))
										{
											func_33(16, PLAYER_PED_ID(), 0);
										}
									}
									break;
				...
				case 22:
					if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), Global_35548[22 /*31*/].f_2, 1) <= 100f)
					{
						switch (func_39())
						{
							case 0:
								if (func_38(12, 5))
								{
									if (!func_45(22, PLAYER_PED_ID()))
									{
										func_44(22, PLAYER_PED_ID());
									}
									if (!func_45(23, PLAYER_PED_ID()))
									{
										func_44(23, PLAYER_PED_ID());
									}
								}
								else
								{
									if (func_45(22, PLAYER_PED_ID()))
									{
										func_33(22, PLAYER_PED_ID(), 0);
									}
									if (func_45(23, PLAYER_PED_ID()))
									{
										func_33(23, PLAYER_PED_ID(), 0);
									}
								}
								break;
				...
				case 14:
				case 15:
					if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_84500[27 /*34*/].f_6) == 0)
					{
						if (func_45(14, PLAYER_PED_ID()))
						{
							func_33(14, PLAYER_PED_ID(), 0);
						}
						if (func_45(15, PLAYER_PED_ID()))
						{
							func_33(15, PLAYER_PED_ID(), 0);
						}
					}
					break;
				
				case 24:
					if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 480.4354f, -1317.91f, 29.5957f) < 400f)
					{
						...
						{
							if (func_45(24, PLAYER_PED_ID()))
							{
								if (GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()) != GET_INTERIOR_AT_COORDS(480.4354f, -1317.91f, 29.5957f) && !IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 486.86f, -1316.604f, 27.71937f, 484.8906f, -1312.647f, 31.72312f, 4.25f, 0, 1, 0))
								{
									func_33(24, PLAYER_PED_ID(), 0);
								}
							}
							else if (GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()) == GET_INTERIOR_AT_COORDS_WITH_TYPE(480.4354f, -1317.91f, 29.5957f, "v_chopshop"))
							{
								func_44(24, PLAYER_PED_ID());
							}
						}
						else if (!func_45(24, PLAYER_PED_ID()))
						{
							func_44(24, PLAYER_PED_ID());
						}
					}
				...
				case 25:
				case 26:
					if (!func_45(25, PLAYER_PED_ID()))
					{
						func_44(25, PLAYER_PED_ID());
					}
					if (!func_45(26, PLAYER_PED_ID()))
					{
						func_44(26, PLAYER_PED_ID());
					}
					break;
				
				case 4:
					if (!func_45(4, PLAYER_PED_ID()))
					{
						switch (func_39())
						{
							case 0:
								if (VDIST2(Global_35548[4 /*31*/].f_2, GET_ENTITY_COORDS(PLAYER_PED_ID(), 0)) < 10000f)
								{
									func_44(4, PLAYER_PED_ID());
								}
								break;
							...
							case 1:
								if (func_37(2))
								{
									...
									else if (VDIST2(Global_35548[4 /*31*/].f_2, GET_ENTITY_COORDS(PLAYER_PED_ID(), 0)) < 10000f)
									{
										func_44(4, PLAYER_PED_ID());
									}
								}
...
{
	if ((IS_BIT_SET(Global_32221[(iParam0 / 32)], (iParam0 % 32)) && Global_32684[iParam0] != 2) && !IS_BIT_SET(Global_32457[(iParam0 / 32)], (iParam0 % 32)))
	{
...
int func_52(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = GET_ENTITY_MODEL(func_53(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 1)));
				switch (iVar0)
				{
...
void func_54(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_55(iParam0) && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_84500[26 /*34*/].f_6) == 0)
			{
				Global_106565.f_7255[iParam0] = 1;
				_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_106565.f_7255[iParam0], 1, 1);
			}
...
var func_57()
{
	...
	func_60(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_59(&uVar0, GET_CLOCK_MONTH());
	func_58(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SHIFT_RIGHT(uParam0, 26) & 31 * func_63(IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_73()
{
	...
	if (!IS_NEW_LOAD_SCENE_ACTIVE())
	{
		...
		while (iVar0 < 10)
		{
			if (!IS_STRING_NULL_OR_EMPTY(&(Global_35466[iVar0 /*8*/])))
			{
				if (!IS_IPL_ACTIVE(&(Global_35466[iVar0 /*8*/])))
				{
					REQUEST_IPL(&(Global_35466[iVar0 /*8*/]));
				}
	...
	if (Global_34587)
	{
		...
		while (iVar1 < 198)
		{
			func_77(&vLocal_99, iVar1);
			func_76(&vLocal_99, iVar1, Global_33790[iVar1]);
			func_74(&vLocal_99, iVar1, Global_33790[iVar1]);
	...
	if (IS_SCREEN_FADED_OUT())
	{
		...
		while (iVar3 < 10)
		{
			if (!IS_STRING_NULL_OR_EMPTY(&(Global_35385[iVar3 /*8*/])))
			{
				if (IS_IPL_ACTIVE(&(Global_35385[iVar3 /*8*/])))
				{
					REMOVE_IPL(&(Global_35385[iVar3 /*8*/]));
				}
...
void func_74(var uParam0, int iParam1, int iParam2)
{
	if (!func_75(uParam0->f_79, 0f, 0f, 0f, 0))
	{
		if (iParam2 == 0)
		{
			...
			{
				REMOVE_SCENARIO_BLOCKING_AREA(Global_35185[iParam1], 0);
		...
		else if (iParam2 == 1 || iParam2 == 2)
		{
			if (!Global_34588[iParam1])
			{
				Global_35185[iParam1] = ADD_SCENARIO_BLOCKING_AREA(uParam0->f_79, uParam0->f_82, 0, 1, 1, 1);
...
void func_76(var uParam0, int iParam1, int iParam2)
{
	if (!func_75(uParam0->f_58, 0f, 0f, 0f, 0) && !func_75(uParam0->f_61, 0f, 0f, 0f, 0))
	{
		...
		{
			SET_ROADS_IN_AREA(uParam0->f_58, uParam0->f_61, 1, 1);
		}
		else
		{
			SET_ROADS_IN_AREA(uParam0->f_58, uParam0->f_61, 0, 1);
		}
	}
	if (!func_75(uParam0->f_68, 0f, 0f, 0f, 0))
	{
		if (uParam0->f_75[iParam2])
		{
			...
			{
				Global_33989[iParam1] = ADD_NAVMESH_BLOCKING_OBJECT(uParam0->f_68, uParam0->f_71, uParam0->f_74, 0, 7);
				Global_34188[iParam1] = 1;
			}
		}
		else if (Global_34188[iParam1])
		{
			REMOVE_NAVMESH_BLOCKING_OBJECT(Global_33989[iParam1]);
	...
	if (!func_75(uParam0->f_85, 0f, 0f, 0f, 0) && !func_75(uParam0->f_88, 0f, 0f, 0f, 0))
	{
		...
		{
			SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(uParam0->f_85, uParam0->f_88, 0, 1);
		}
		else
		{
			SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(uParam0->f_85, uParam0->f_88, 1, 1);
		}
	}
}
...
int func_78(int iParam0)
{
	...
	{
		func_77(&vLocal_99, iParam0);
		bVar0 = true;
		if (vLocal_99.f_33)
		{
			if (GET_HASH_KEY(&(vLocal_99.f_8[2 /*8*/])) != GET_HASH_KEY(""))
			{
				if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), vLocal_99, 1) > 250f)
				{
	...
	if (Global_34986[iParam0])
	{
		...
		func_76(&vLocal_99, iParam0, Global_33790[iParam0]);
	...
	if (Global_34787[iParam0])
	{
		...
		func_74(&vLocal_99, iParam0, Global_33790[iParam0]);
...
void func_83()
{
	...
	if (Global_32211)
	{
		...
		while (iVar0 < 27)
		{
			if (_DOES_DOOR_EXIST(Global_35548[iVar0 /*31*/]))
			{
				REMOVE_DOOR_FROM_SYSTEM(Global_35548[iVar0 /*31*/]);
			}
			iVar0++;
		}
	}
...
void func_84()
{
	if (!iLocal_98 && IS_BIT_SET(Global_106565.f_9079.f_2[27 /*3*/], 2))
	{
		iLocal_98 = 1;
		bLocal_97 = true;
	}
	if (bLocal_97 && (!IS_NEW_LOAD_SCENE_ACTIVE() || (IS_PLAYER_SWITCH_IN_PROGRESS() && GET_PLAYER_SWITCH_STATE() == 5)))
	{
...
void func_85(int iParam0)
{
	...
	_SET_NORTH_YANKTON_MAP(iParam0);
...
void func_86(char* sParam0)
{
	...
	else
	{
		...
		while (iVar0 < 10)
		{
			iVar2 = GET_HASH_KEY(&(Global_35385[iVar0 /*8*/]));
			if (iVar2 == 0)
			{
				iVar4 = iVar0;
			}
...
void func_87()
{
	...
	while (iVar0 < 226)
	{
		SET_BIT(&(Global_32212[(iVar0 / 32)]), (iVar0 % 32));
		Global_32230[iVar0] = 0;
		CLEAR_BIT(&(Global_32221[(iVar0 / 32)]), (iVar0 % 32));
		Global_32684[iVar0] = 0;
		Global_32911[iVar0] = 1;
		SET_BIT(&(Global_32457[(iVar0 / 32)]), (iVar0 % 32));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 198)
	{
		...
		{
			REMOVE_NAVMESH_BLOCKING_OBJECT(Global_33989[iVar0]);
			Global_34188[iVar0] = 0;
		}
		if (Global_34588[iVar0])
		{
			REMOVE_SCENARIO_BLOCKING_AREA(Global_35185[iVar0], 0);
...
void func_91()
{
	...
	func_21(192, 1);
	func_21(193, 1);
	if (!NETWORK_IS_GAME_IN_PROGRESS() && !func_92())
	{
		func_16(25, 1);
		func_16(26, 1);
		func_16(27, 1);
...
void func_95()
{
	...
	while (iVar0 < 27)
	{
		ADD_DOOR_TO_SYSTEM(Global_35548[iVar0 /*31*/], Global_35548[iVar0 /*31*/].f_5, Global_35548[iVar0 /*31*/].f_2, 1, 1, 0);
		_SET_DOOR_ACCELERATION_LIMIT(Global_35548[iVar0 /*31*/], 1, 1, 0);
		Global_35548[iVar0 /*31*/].f_22 = _0x65499865FCA6E5EC(Global_35548[iVar0 /*31*/]);
		CLEAR_BIT(&(Global_35548[iVar0 /*31*/].f_1), 2);
		CLEAR_BIT(&(Global_35548[iVar0 /*31*/].f_1), 3);
		CLEAR_BIT(&(Global_35548[iVar0 /*31*/].f_1), 5);
		CLEAR_BIT(&(Global_35548[iVar0 /*31*/].f_1), 6);
		iVar0++;
	}
	bLocal_87 = true;
}
...
void func_96()
{
	...
	SET_BIT(&(Global_35548[iVar0 /*31*/].f_1), 0);
	SET_BIT(&(Global_35548[iVar0 /*31*/].f_1), 1);
	SET_BIT(&(Global_35548[iVar0 /*31*/].f_1), 3);
	SET_BIT(&(Global_35548[iVar0 /*31*/].f_1), 4);
	CLEAR_BIT(&(Global_35548[iVar0 /*31*/].f_1), 7);
	iVar0 = 0;
	...
	CLEAR_BIT(&(Global_35548[iVar0 /*31*/].f_1), 0);
	CLEAR_BIT(&(Global_35548[iVar0 /*31*/].f_1), 1);
	SET_BIT(&(Global_35548[iVar0 /*31*/].f_1), 3);
	CLEAR_BIT(&(Global_35548[iVar0 /*31*/].f_1), 7);
	iVar0 = 1;
	...
	CLEAR_BIT(&(Global_35548[iVar0 /*31*/].f_1), 1);
	SET_BIT(&(Global_35548[iVar0 /*31*/].f_1), 3);
	SET_BIT(&(Global_35548[iVar0 /*31*/].f_1), 7);
	iVar0 = 23;
...
void func_100(char* sParam0, int iParam1, vector3 vParam2, bool bParam5)
{
	var uVar0;
	
	uVar0 = GET_HASH_KEY(sParam0);
	if (bParam5)
	{
		if (!_DOES_DOOR_EXIST(uVar0))
		{
			ADD_DOOR_TO_SYSTEM(uVar0, iParam1, vParam2, 0, 0, 0);
		}
		_SET_DOOR_ACCELERATION_LIMIT(uVar0, 1, 0, 1);
	}
	else if (_DOES_DOOR_EXIST(uVar0))
	{
		_SET_DOOR_ACCELERATION_LIMIT(uVar0, 0, 0, 1);
		REMOVE_DOOR_FROM_SYSTEM(uVar0);
	}
}
...
void func_102()
{
	if (func_71())
	{
		if (((!Global_106565.f_7255.f_426 || IS_BIT_SET(iLocal_78, 0)) || NETWORK_IS_GAME_IN_PROGRESS()) || Global_32210)
		{
			if (!Global_2460020)
			{
				if (IS_BIT_SET(iLocal_78, 0) || Global_32210)
				{
					iLocal_194 = 1;
				}
				iLocal_96 = 0;
	...
	else if ((IS_BIT_SET(iLocal_78, 1) || ((!NETWORK_IS_GAME_IN_PROGRESS() && !func_92()) && !func_103())) || Global_32210)
	{
		if (func_3() == 2)
		{
