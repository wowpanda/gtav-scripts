...
void __EntryFunction__()//Position - 0x0
{
	...
	func_479(&Local_41);
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_41.f_3B))
	{
		PED::_DISPOSE_SYNCHRONIZED_SCENE(Local_41.f_3B);
...
void func_1()//Position - 0x11F
{
	...
	switch (iLocal_43)
	{
		case 0:
			...
			{
				unk_0x346478B12F69D4E3(iLocal_55, false);
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
			{
				unk_0x346478B12F69D4E3(iLocal_56, false);
			}
			if (iLocal_44 == 1)
			{
				...
				if (func_17(iLocal_58))
				{
					...
					{
						if (func_14(iLocal_58, unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), 35f))
						{
						...
						if (!func_2(iLocal_58, 1805844857))
						{
							if (!PED::IS_PED_FLEEING(iLocal_58))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_58, "special_ped@maude@exit_flee", "female_Flee_Table_Left_Maude", 3))
								{
									...
									BRAIN::TASK_SMART_FLEE_PED(iLocal_58, AUDIO::_0x0626A247D2405330(), 50f, 4294967295, 0, 0);
...
int func_10()//Position - 0x475
{
	...
	if (func_17(iLocal_58))
	{
		...
		{
			if (!PED::IS_PED_RAGDOLL(iLocal_58) || BRAIN::IS_PED_GETTING_UP(iLocal_58))
			{
				STREAMING::REQUEST_ANIM_DICT("special_ped@maude@exit_flee");
				if (STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@exit_flee"))
				{
					...
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_58, iLocal_50, "special_ped@maude@exit_flee", "female_Flee_Table_Left_Maude", 1000f, -4f, 4626, 0, 1148846080, 0);
					MISC::_0x1327E2FE9746BAEE(iLocal_58, 0, 0);
...
void func_27()//Position - 0x9E6
{
	...
	switch (iLocal_43)
	{
		case 0:
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_56))
			{
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(2727.4f, 4145.56f, 43.68f, 10f, 3914268813, 0))
				{
					iLocal_56 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2727.4f, 4145.56f, 43.68f, 10f, 3914268813, 1, 0, 1);
					if (func_11(iLocal_56))
					{
						...
						unk_0x346478B12F69D4E3(iLocal_56, true);
					}
				}
			}
			if (func_17(iLocal_58))
			{
				if (!PED::IS_PED_HEADTRACKING_PED(iLocal_58, AUDIO::_0x0626A247D2405330()))
				{
					BRAIN::TASK_LOOK_AT_ENTITY(iLocal_58, AUDIO::_0x0626A247D2405330(), 4294967295, 0, 2);
				}
				PED::SET_PED_KEEP_TASK(iLocal_58, true);
			}
		...
		case 1:
			...
			if (func_17(iLocal_58))
			{
				vVar0 = { unk_0x8000C77B5F336760(iLocal_58, false) };
				if (!func_237(0))
				{
					if (SYSTEM::VDIST2(vVar0, unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false)) > 14400f)
					{
...
{
	func_229("BBONDS_UNLOCK", 1, 0, 4294967295, 10000, 4, 0, 0, 1);
	func_225(62, 2, 1);
	func_29(107, 1);
	func_445();
}
...
void func_29(int iParam0, bool bParam1)//Position - 0xBD3
{
	...
	{
		func_196(&(Global_19AC5[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_33()//Position - 0xE68
{
	...
	{
		func_35(13, SYSTEM::FLOOR(Global_19E56.f_27B6.f_F0D));
	}
...
int func_37()//Position - 0x18ED
{
	return Global_1407E0;
}

void func_38()//Position - 0x18F9
{
	func_55();
	func_47();
	func_43();
...
void func_39(int iParam0)//Position - 0x1952
{
	if (iParam0 == 1)
	{
...
void func_41()//Position - 0x1999
{
	StringCopy(&Global_1170D, "", 16);
	StringCopy(&Global_11711, "", 16);
}

void func_42()//Position - 0x19B3
{
	int iVar0;
...
void func_46(int iParam0)//Position - 0x1A85
{
	if (iParam0 == 1)
	{
		Global_8F3A = 1;
...
void func_47()//Position - 0x1A9E
{
	func_48(&Global_18531);
}

void func_48(var uParam0)//Position - 0x1AAE
{
	int iVar0;
	int iVar1;
...
void func_49(var uParam0)//Position - 0x203E
{
	*uParam0 = 4294967295;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_50(var uParam0)//Position - 0x2059
{
	func_51(&(uParam0->f_C));
	*uParam0 = { 0f, 0f, 0f };
...
void func_51(var uParam0)//Position - 0x2088
{
	int iVar0;
...
void func_52(var uParam0)//Position - 0x2138
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_53(var uParam0)//Position - 0x2156
{
	int iVar0;
...
void func_54(var uParam0)//Position - 0x2236
{
	*uParam0 = 4294967281;
}

void func_55()//Position - 0x2244
{
	StringCopy(&Global_17990, "", 32);
	func_48(&Global_17998);
}

void func_56()//Position - 0x225D
{
...
int func_58(int iParam0, int iParam1, int iParam2)//Position - 0x239B
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	Global_11569[1 /*14*/] = { func_109(iVar0, iParam1, iParam2, 4294967295) };
	...
	else
	{
		...
		Global_11569[1 /*14*/] = { func_109(iVar0, iParam1, uVar6[iParam1], 4294967295) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_101(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_101(iParam1), Global_11569[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_101(iParam1), Global_11569[1 /*14*/].f_3, Global_11569[1 /*14*/].f_4, 0);
		}
	}
...
int func_59(int iParam0, int iParam1, int iParam2)//Position - 0x255A
{
	int iVar0;
	...
	{
		if (!func_174(iParam0, Global_19E56.f_933.f_21B[iVar0 /*65*/].f_40, Global_19E56.f_933.f_21B[iVar0 /*65*/].f_3F))
		{
...
int func_60(int iParam0)//Position - 0x25E6
{
	switch (iParam0)
	{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2621
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_11569[1 /*14*/] = { func_109(iVar10, iParam1, iParam2, 4294967295) };
		if (!func_99(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			...
			{
				Global_11569[1 /*14*/] = { func_109(iVar10, iVar0, uVar11[iVar0], 4294967295) };
				if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11569[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_11569[1 /*14*/] = { func_109(iVar10, 14, uVar12[iVar1], 4294967295) };
							func_77(iParam0, Global_11569[1 /*14*/].f_C, Global_11569[1 /*14*/].f_3, Global_11569[1 /*14*/].f_4);
							func_92(14);
							if (Global_11567 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_101(iVar0), Global_11569[1 /*14*/].f_3, Global_11569[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_101(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_101(iVar0), Global_11569[1 /*14*/].f_3, Global_11569[1 /*14*/].f_4, iParam4);
						}
						func_92(iVar0);
						if (Global_11567 == 1)
						{
			...
			{
				Global_11569[1 /*14*/] = { func_109(iVar10, iVar0, func_67(iParam0, iVar0, 4294967295), 4294967295) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_11569[1 /*14*/] = { func_109(iVar10, 14, uVar15[iVar1], 4294967295) };
			func_77(iParam0, Global_11569[1 /*14*/].f_C, Global_11569[1 /*14*/].f_3, Global_11569[1 /*14*/].f_4);
			func_92(14);
			if (Global_11567 == 1)
			{
	...
	else
	{
		if (iParam4 == 4294967295)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_101(iParam1), Global_11569[1 /*14*/].f_3, Global_11569[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_101(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_101(iParam1), Global_11569[1 /*14*/].f_3, Global_11569[1 /*14*/].f_4, iParam4);
		}
		if (Global_11567 == 1)
		{
			iVar2 = 0;
...
void func_62(int iParam0, int iParam1, int iParam2)//Position - 0x2E37
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0, int iParam1, int iParam2)//Position - 0x2EC1
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_64(int iParam0, int iParam1, int iParam2)//Position - 0x2F9F
{
	Global_11569[1 /*14*/] = { func_109(iParam0, iParam1, iParam2, 4294967295) };
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11569[1 /*14*/].f_6, 2);
}

int func_65(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x2FCA
{
	var uVar0;
	int iVar1;
...
int func_66(int iParam0, int iParam1, int iParam2)//Position - 0x35CE
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_67(int iParam0, int iParam1, int iParam2)//Position - 0x3667
{
	int iVar0;
	int iVar1;
...
int func_68(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3708
{
	int iVar0;
...
int func_69(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x3A0F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x45C3
{
	int iVar0;
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x48A7
{
	int iVar0;
...
int func_72(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4B6E
{
	int iVar0;
	int iVar1;
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4BA5
{
	int iVar0;
...
int func_74(int iParam0, int iParam1, int iParam2)//Position - 0x4BCE
{
	*iParam2 = 4294967197;
	switch (iParam0)
	{
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4E98
{
	int iVar0;
...
int func_76(int iParam0, int iParam1, int iParam2)//Position - 0x5122
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_77(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5279
{
	int iVar0;
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_78(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, FILE::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5311
{
	switch (iParam0)
	{
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x53DF
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		iVar9 = FILE::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, 4294967295, 0, 4294967295, func_101(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_80(int iParam0, int iParam1)//Position - 0x553B
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_81(int iParam0)//Position - 0x58E2
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5943
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_83(int iParam0, int iParam1)//Position - 0x5A3F
{
	int iVar0;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5B7D
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILE::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, 4294967295, 0, 4294967295, func_101(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
int func_85(int iParam0)//Position - 0x5C5D
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5CE3
{
	switch (iParam0)
	{
		case joaat("player_zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILE::_0x341DE7ED1D2A1BFD(iParam3, 2537416713, 1) || FILE::_0x341DE7ED1D2A1BFD(func_79(iParam0, iParam2, 14, 3), 2452280943, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILE::_0x341DE7ED1D2A1BFD(iParam3, 2537416713, 0) || FILE::_0x341DE7ED1D2A1BFD(func_79(iParam0, iParam2, 1, 3), 2452280943, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILE::_0x341DE7ED1D2A1BFD(iParam3, 2537416713, 1) || FILE::_0x341DE7ED1D2A1BFD(func_79(iParam0, iParam2, 14, 4), 2452280943, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILE::_0x341DE7ED1D2A1BFD(iParam3, 2537416713, 0) || FILE::_0x341DE7ED1D2A1BFD(func_79(iParam0, iParam2, 1, 4), 2452280943, 0));
					}
					break;
			}
			break;
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5F60
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6385
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_89(int iParam0, int iParam1)//Position - 0x6678
{
	int iVar0;
	int iVar1;
...
int func_90(int iParam0, int iParam1)//Position - 0x66BE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_91(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x671E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_92(int iParam0)//Position - 0x67A2
{
	...
	{
		func_98(iParam0, Global_11569[1 /*14*/].f_5, Global_11569[1 /*14*/].f_2, 2, Global_11569[1 /*14*/].f_1, 1, 0);
	}
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11569[1 /*14*/].f_6, 1) && INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11569[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_93(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x685A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x68A4
{
	int iVar0;
	...
	iVar0 = Global_26B05F[iParam0 /*3*/][func_95(iParam2)];
	if (iVar0 != 0)
	{
...
int func_95(var uParam0)//Position - 0x68D4
{
	int iVar0;
	int iVar1;
...
int func_96(int iParam0, int iParam1, int iParam2)//Position - 0x6908
{
	int iVar0;
	var uVar1;
...
bool func_97(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x693A
{
	int iVar0;
...
int func_98(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x83F6
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_99(int iParam0)//Position - 0x9314
{
	if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11569[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_100(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9365
{
	int iVar0;
	...
	{
		if (!func_174(iParam0, Global_19E56.f_933.f_21B[iVar0 /*65*/].f_3D, Global_19E56.f_933.f_21B[iVar0 /*65*/].f_3C) || iParam3 == 1)
		{
...
int func_101(int iParam0)//Position - 0x93FB
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_102(int iParam0, int iParam1)//Position - 0x94AB
{
	int iVar0;
	struct<10> Var1;
...
void func_103(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9DDA
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar2;
...
void func_104(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x9F04
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_105(int iParam0, int iParam1)//Position - 0x9F4C
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_108(&Var1, 4294967197, 4294967197, Global_19E56.f_933.f_21B.f_C4[0], Global_19E56.f_933.f_21B.f_C8[0], 6, 3, 0, 0, 0, 4294967197, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_108(&Var1, 4294967197, 4294967197, Global_19E56.f_933.f_21B.f_C4[1], Global_19E56.f_933.f_21B.f_C8[1], 17, 2, 26, 0, 0, 4294967197, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_108(&Var1, 4294967197, 4294967197, Global_19E56.f_933.f_21B.f_C4[2], Global_19E56.f_933.f_21B.f_C8[2], 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
...
void func_106(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBD94
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar2;
...
int func_107(int iParam0)//Position - 0xBF7E
{
	switch (iParam0)
	{
		case 0:
...
void func_108(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xC030
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_109(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC0A1
{
	func_173();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_110(int iParam0, int iParam1)//Position - 0xC0F3
{
	switch (iParam0)
	{
		case 0:
...
void func_111(int iParam0)//Position - 0xC1E3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_112(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_112(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD45A
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_96(func_115(iParam1, uParam0->f_2), Global_11566, 0);
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_96(func_114(iParam1, uParam0->f_2), Global_11566, 0);
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_96(iVar1, Global_11566, 0);
				if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_113(int iParam0, int iParam1, var uParam2)//Position - 0xD7EB
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_114(int iParam0, int iParam1)//Position - 0xDBF0
{
	switch (iParam1)
	{
		case 0:
...
int func_115(int iParam0, int iParam1)//Position - 0xDFEB
{
	switch (iParam1)
	{
		case 0:
...
int func_116(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE3E6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_117(int iParam0)//Position - 0xE428
{
	return Global_8D15 == iParam0;
}

int func_118(int iParam0)//Position - 0xE436
{
	switch (iParam0)
	{
		case 4294967295:
...
void func_119(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE50A
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILE::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var2;
					func_112(&(Global_11569[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, 4294967295, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_112(&(Global_11569[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, 4294967295, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILE::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var6;
					func_112(&(Global_11569[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILE::_0x341DE7ED1D2A1BFD(Var6.f_1, 2244334710, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != 4294967295 && Global_11612)
		{
			...
			Global_280005 = Var11;
			func_112(&(Global_11569[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILE::_0x341DE7ED1D2A1BFD(Var11.f_1, 2244334710, 0), 4294967295, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = FILE::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, 4294967295, 0, 4294967295, func_101(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_120(int iParam0)//Position - 0xE7E3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0xE93A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0xEE48
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0xEEBD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0xEF31
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0xF018
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0xF37B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0xF58C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0xF7BC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0xF8CC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x1026D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x10DE0
{
	if (iParam0 < 136)
	{
		func_133(iParam0);
...
void func_132(int iParam0)//Position - 0x10E15
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x11A19
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x12927
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x12A54
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0, int iParam1)//Position - 0x12B52
{
	switch (iParam0)
	{
		case 0:
...
void func_137(int iParam0)//Position - 0x12C42
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x14134
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x14285
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x14790
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x14DFE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x14E72
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x14F42
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x15472
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x15609
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x15E07
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x15F17
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x16E42
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x17AFF
{
	if (iParam0 < 107)
	{
		func_152(iParam0);
...
void func_150(int iParam0)//Position - 0x17B45
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x185EB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x193DA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x1A023
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1A29C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0, int iParam1)//Position - 0x1A3E2
{
	switch (iParam0)
	{
		case 0:
...
void func_156(int iParam0)//Position - 0x1A4D2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x1B25C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x1B3D6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1B94D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1BE77
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1BEEB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x1BFBB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x1C4B0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1C719
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1C9EF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1CBB8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x1D70C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x1E356
{
	if (iParam0 < 60)
	{
		func_170(iParam0);
...
void func_169(int iParam0)//Position - 0x1E38B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x1F12B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x1F7B7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x1F89E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173()//Position - 0x1F99C
{
...
int func_174(int iParam0, int iParam1, int iParam2)//Position - 0x1FA15
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if ((uVar5[iVar2] != 4294967197 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_174(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_174(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_11569[2 /*14*/] = { func_109(iVar0, 14, iVar4, 4294967295) };
									if (Global_11569[2 /*14*/].f_C == iVar3)
									{
										if (func_174(iParam0, 14, iVar4))
										{
											if (!func_65(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_11569[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_11569[2 /*14*/] = { func_109(iVar0, iVar2, iVar1, 4294967295) };
						if (!func_65(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_11569[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_11569[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_101(iParam1)) && Global_11569[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_101(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_175(int iParam0)//Position - 0x1FC70
{
	int iVar0;
	int iVar1;
...
int func_176(int iParam0)//Position - 0x1FCAD
{
	if (func_177(iParam0))
	{
...
bool func_177(int iParam0)//Position - 0x1FCD7
{
	return iParam0 < 3;
}

void func_178(char* sParam0, int iParam1)//Position - 0x1FCE3
{
...
void func_180()//Position - 0x1FD83
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_176(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			iVar0 = func_175(AUDIO::_0x0626A247D2405330());
			if (func_177(iVar0) && (!func_117(14) || Global_19A3D))
			{
				if (Global_19E56.f_933.f_21B.f_10CD != iVar0 && func_177(Global_19E56.f_933.f_21B.f_10CD))
				{
...
struct<2> func_181(int iParam0)//Position - 0x1FE80
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_182(int iParam0)//Position - 0x1FEB7
{
	struct<2> Var0;
...
void func_183(int iParam0, int iParam1)//Position - 0x2043E
{
...
void func_184(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x20488
{
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
...
void func_185(int iParam0, int iParam1, int iParam2)//Position - 0x20525
{
	struct<4> Var0;
	char* sVar1;
	...
	if (iParam0 != 4294967295)
	{
		...
		func_186(&sVar1, Var0.f_3, Global_16C55, iParam1, iParam2);
	}
}

void func_186(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x20564
{
...
void func_187(int iParam0, var uParam1)//Position - 0x205A8
{
	switch (iParam0)
	{
		case 0:
		...
		case 1:
			func_188(uParam1, "Abigail2", func_181(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, 4294967295, 4, 1, 0, 2359, func_189(iParam0), 1, 0);
			break;
		
		case 2:
			func_188(uParam1, "Barry1", func_181(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 0, 2359, func_189(iParam0), 1, 0);
			break;
		
		case 3:
			func_188(uParam1, "Barry2", func_181(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_189(iParam0), 1, 1);
			break;
		
		case 4:
			func_188(uParam1, "Barry3", func_181(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", 4294967295, 0, "", 164, 1, 4294967295, 0, 2, 0, 2359, func_189(iParam0), 0, 0);
			break;
		...
		case 7:
			func_188(uParam1, "Barry4", func_181(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, 4294967295, 4, 2, 800, 2000, func_189(iParam0), 0, 0);
			break;
		
		case 8:
			func_188(uParam1, "Dreyfuss1", func_181(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_189(iParam0), 0, 0);
			break;
		...
		case 15:
			func_188(uParam1, "Epsilon7", func_181(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", 4294967295, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_189(iParam0), 0, 0);
			break;
		
		case 16:
			func_188(uParam1, "Epsilon8", func_181(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, 4294967295, 4, 1, 0, 2359, func_189(iParam0), 1, 0);
			break;
		
		case 17:
			func_188(uParam1, "Extreme1", func_181(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", 4294967295, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_189(iParam0), 0, 1);
			break;
		...
		case 20:
			func_188(uParam1, "Extreme4", func_181(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_189(iParam0), 0, 0);
			break;
		
		case 21:
			func_188(uParam1, "Fanatic1", func_181(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 700, 2000, func_189(iParam0), 1, 0);
			break;
		
		case 22:
			func_188(uParam1, "Fanatic2", func_181(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 700, 2000, func_189(iParam0), 1, 0);
			break;
		
		case 23:
			func_188(uParam1, "Fanatic3", func_181(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 2, 700, 2000, func_189(iParam0), 0, 1);
			break;
		
		case 24:
			func_188(uParam1, "Hao1", func_181(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", 4294967295, 0, "controller_Races", 13, 1, 4294967295, 4, 2, 2000, 500, func_189(iParam0), 0, 1);
			break;
		
		case 25:
			func_188(uParam1, "Hunting1", func_181(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", 4294967295, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_189(iParam0), 0, 1);
			break;
		
		case 26:
			func_188(uParam1, "Hunting2", func_181(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, 4294967295, 4, 4, 0, 2359, func_189(iParam0), 0, 1);
			break;
		
		case 27:
			func_188(uParam1, "Josh1", func_181(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", 4294967295, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_189(iParam0), 1, 0);
			break;
		...
		case 29:
			func_188(uParam1, "Josh3", func_181(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 4294967295, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_189(iParam0), 1, 1);
			break;
		
		case 30:
			func_188(uParam1, "Josh4", func_181(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", 4294967295, 36, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_189(iParam0), 1, 0);
			break;
		
		case 31:
			func_188(uParam1, "Maude1", func_181(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", 4294967295, 0, "BailBond_Launcher", 0, 1, 4294967295, 4, 4, 0, 2359, func_189(iParam0), 0, 1);
			break;
		
		case 32:
			func_188(uParam1, "Minute1", func_181(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", 4294967295, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_189(iParam0), 0, 1);
			break;
		
		case 33:
			func_188(uParam1, "Minute2", func_181(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", 4294967295, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_189(iParam0), 0, 1);
			break;
		
		case 34:
			func_188(uParam1, "Minute3", func_181(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", 4294967295, 10, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_189(iParam0), 0, 1);
			break;
		
		case 35:
			func_188(uParam1, "MrsPhilips1", func_181(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", 4294967295, 0, "ambient_MrsPhilips", 0, 1, 4294967295, 4, 4, 0, 2359, func_189(iParam0), 0, 0);
			break;
		
		case 36:
			func_188(uParam1, "MrsPhilips2", func_181(iParam0), 0, 11, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_189(iParam0), 0, 0);
			break;
		
		case 37:
			func_188(uParam1, "Nigel1", func_181(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", 4294967295, 0, "", 177, 1, 4294967295, 1, 4, 0, 2359, func_189(iParam0), 1, 0);
			break;
		...
		case 42:
			func_188(uParam1, "Nigel2", func_181(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", 4294967295, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_189(iParam0), 1, 1);
			break;
		
		case 43:
			func_188(uParam1, "Nigel3", func_181(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", 4294967295, 16, "postRC_Nigel3", 0, 0, 4294967295, 4, 4, 0, 2359, func_189(iParam0), 1, 1);
			break;
		
		case 44:
			func_188(uParam1, "Omega1", func_181(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", 4294967295, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_189(iParam0), 0, 0);
			break;
		
		case 45:
			func_188(uParam1, "Omega2", func_181(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_189(iParam0), 0, 0);
			break;
		
		case 46:
			func_188(uParam1, "Paparazzo1", func_181(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", 4294967295, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_189(iParam0), 0, 1);
			break;
		
		case 47:
			func_188(uParam1, "Paparazzo2", func_181(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", 4294967295, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_189(iParam0), 0, 1);
			break;
		
		case 48:
			func_188(uParam1, "Paparazzo3", func_181(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", 4294967295, 8, "", 183, 1, 4294967295, 2, 2, 0, 2359, func_189(iParam0), 0, 0);
			break;
		...
		case 51:
			func_188(uParam1, "Paparazzo4", func_181(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", 4294967295, 8, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_189(iParam0), 0, 0);
			break;
		
		case 52:
			func_188(uParam1, "Rampage1", func_181(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", 4294967295, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_189(iParam0), 0, 0);
			break;
		
		case 54:
			func_188(uParam1, "Rampage3", func_181(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", 4294967295, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_189(iParam0), 1, 0);
			break;
		
		case 55:
			func_188(uParam1, "Rampage4", func_181(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", 4294967295, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_189(iParam0), 1, 0);
			break;
		
		case 56:
			func_188(uParam1, "Rampage5", func_181(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", 4294967295, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_189(iParam0), 0, 0);
			break;
		
		case 53:
			func_188(uParam1, "Rampage2", func_181(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", 4294967295, 0, "rampage_controller", 0, 0, 4294967295, 4, 4, 0, 2359, func_189(iParam0), 1, 0);
			break;
		
		case 57:
			func_188(uParam1, "TheLastOne", func_181(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_189(iParam0), 0, 1);
			break;
		
		case 58:
			func_188(uParam1, "Tonya1", func_181(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", 4294967295, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_189(iParam0), 0, 1);
			break;
		
		case 59:
			func_188(uParam1, "Tonya2", func_181(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_189(iParam0), 0, 1);
			break;
		
		case 60:
			func_188(uParam1, "Tonya3", func_181(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_189(iParam0), 0, 1);
			break;
		
		case 61:
			func_188(uParam1, "Tonya4", func_181(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_189(iParam0), 0, 1);
			break;
		
		case 62:
			func_188(uParam1, "Tonya5", func_181(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_189(iParam0), 0, 1);
			break;
...
int func_189(int iParam0)//Position - 0x217EE
{
	switch (iParam0)
	{
		case 0:
...
void func_190(int iParam0)//Position - 0x21B34
{
	Global_8F3C = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_191()//Position - 0x21B46
{
	if (Global_1620F)
	{
		func_180();
		GRAPHICS::_0xBF59707B3E5ED531(func_192(Global_19E56.f_933.f_21B.f_10CD));
	}
	else
	{
...
char* func_192(var uParam0)//Position - 0x21B78
{
	uParam0 = uParam0;
	return "";
}

void func_193()//Position - 0x21B87
{
	vector3 vVar0[24];
...
void func_194(int iParam0, int iParam1)//Position - 0x21BCA
{
	Global_1620A = iParam0;
	Global_1620B = iParam1;
}

void func_195()//Position - 0x21BDE
{
	if (Global_11723 != 6)
	{
	}
...
void func_196(var uParam0)//Position - 0x21C16
{
...
void func_197(int iParam0, bool bParam1)//Position - 0x21C53
{
	struct<26> Var0;
	int iVar1;
	bool bVar2;
	...
	if (Var0.f_16 != 0)
	{
		func_221(Var0.f_16, 0);
	}
	func_215(iParam0, Global_11732);
	if (!bParam1)
	{
...
int func_198(int iParam0)//Position - 0x21DD9
{
	switch (iParam0)
	{
		case 0:
...
void func_199(int iParam0)//Position - 0x22160
{
	func_201(iParam0, 1);
	Global_19E56.f_4872[iParam0 /*6*/].f_3 = func_200();
	Global_19E56.f_4872.f_17C++;
}

int func_200()//Position - 0x22196
{
	return (Global_19E56.f_2704.f_15 + Global_19E56.f_4872.f_17C);
}

void func_201(var uParam0, bool bParam1)//Position - 0x221B2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_202(int iParam0)//Position - 0x224D6
{
...
void func_203(int iParam0)//Position - 0x22509
{
	switch (iParam0)
	{
		case 30:
...
void func_204(int iParam0, bool bParam1)//Position - 0x2253E
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_205(int iParam0, int iParam1, bool bParam2)//Position - 0x2259B
{
	if (iParam0 == 4294967295)
	{
		return;
...
bool func_206(int iParam0, int iParam1)//Position - 0x225D6
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
void func_207(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x225F9
{
	if (iParam0 != 198)
	{
		if (Global_11625)
...
void func_208(int iParam0, int iParam1)//Position - 0x22654
{
	switch (iParam0)
	{
		case 12:
...
void func_209(int iParam0, bool bParam1)//Position - 0x2273D
{
	if (bParam1)
	{
...
bool func_210(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x22766
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_211()//Position - 0x230B8
{
	if ((func_34() == 4294967295 || func_34() == 999) && !func_212() == 0)
	{
		return 1;
	}
	return 0;
...
int func_212()//Position - 0x230E8
{
	return Global_6374;
}

int func_213(var uParam0, int iParam1)//Position - 0x230F3
{
	int iVar0;
...
int func_214(int iParam0)//Position - 0x2688F
{
	switch (iParam0)
	{
		case 46:
...
void func_215(int iParam0, bool bParam1)//Position - 0x26981
{
	switch (iParam0)
	{
		case 46:
...
void func_216(int iParam0, bool bParam1)//Position - 0x269D2
{
	int iVar0;
...
int func_217(int iParam0)//Position - 0x26A38
{
	int iVar0;
	int iVar1;
...
int func_220(int iParam0)//Position - 0x26C72
{
...
void func_221(int iParam0, int iParam1)//Position - 0x26C9F
{
...
int func_222(char* sParam0)//Position - 0x26CDC
{
	int iVar0;
...
int func_223()//Position - 0x26D3C
{
	return func_224(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_224(char* sParam0, int iParam1)//Position - 0x26D4D
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_225(int iParam0, int iParam1, bool bParam2)//Position - 0x26D96
{
	Global_BFD = iParam0;
...
void func_226()//Position - 0x26F40
{
	char cVar0[64];
	char cVar1[64];
	char* sVar2;
...
void func_227()//Position - 0x26FBF
{
	if (func_117(14))
	{
...
int func_228()//Position - 0x27061
{
	func_180();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_229(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2707A
{
	func_230(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_230(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2709B
{
	int iVar0;
...
void func_231()//Position - 0x2726E
{
	int iVar0;
...
bool func_232(char* sParam0, int iParam1, int iParam2)//Position - 0x2738E
{
...
int func_233(vector3 vParam0, vector3 vParam1, int iParam2, float fParam3)//Position - 0x273AC
{
...
void func_234(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27426
{
...
void func_235(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27461
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
void func_236(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x274B7
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
int func_237(bool bParam0)//Position - 0x27552
{
	if (func_17(iLocal_58))
	{
		...
		if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330()))
		{
			...
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_54))
				{
					return 1;
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_56))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56))
				{
					return 1;
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_55))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_55))
				{
					return 1;
				}
			}
		...
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_58, AUDIO::_0x0626A247D2405330(), 3f, 3f, 3f, 0, 1, 0))
			{
				return 1;
			}
		}
		...
		if (FIRE::IS_EXPLOSION_IN_SPHERE(4294967295, unk_0x8000C77B5F336760(iLocal_58, true), 15f))
		{
			return 1;
		}
...
int func_238(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x27697
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_11(AUDIO::_0x0626A247D2405330()) && func_11(iParam0))
	{
...
int func_239(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x27792
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_240(int iParam0, float fParam1)//Position - 0x2789E
{
	var uVar0;
	vector3 vVar1;
...
int func_241(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0x27933
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_243(vParam1 - unk_0x8000C77B5F336760(iParam0, true)) };
...
float func_242(vector3 vParam0, vector3 vParam1)//Position - 0x279C1
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_243(vector3 vParam0)//Position - 0x279E2
{
	float fVar0;
	float fVar1;
...
int func_244(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x27A21
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
...
int func_245(int iParam0, float fParam1)//Position - 0x27A69
{
	float fVar0;
	
	if (func_11(AUDIO::_0x0626A247D2405330()) && func_11(iParam0))
	{
		if (func_254(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iParam0))
		{
...
bool func_246(int iParam0, float fParam1)//Position - 0x27ADF
{
	return func_247(iParam0, AUDIO::_0x0626A247D2405330(), fParam1, 1, 250, 7);
}

bool func_247(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27AF7
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_248(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x27BB8
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_249(int iParam0, int iParam1)//Position - 0x27CE4
{
	int iVar0;
...
int func_251(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x27DF3
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_243(unk_0x8000C77B5F336760(iParam1, true) - unk_0x8000C77B5F336760(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_252(var uParam0)//Position - 0x27E84
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_253(int iParam0, int iParam1)//Position - 0x27E9F
{
	int iVar0;
...
int func_254(int iParam0)//Position - 0x27EDE
{
...
void func_255(char* sParam0, int iParam1, int iParam2)//Position - 0x27F06
{
	iParam2 = iParam2;
...
void func_256()//Position - 0x27F1F
{
	int iVar0;
			...
			if (!PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
			{
				if (func_343())
				{
					if (func_338(1, 1093140480, 0))
					{
						...
						func_336(&iLocal_58, &(Local_41.f_1C[0]));
						func_335(&iLocal_54, &(Local_41.f_29[0]));
						func_335(&iLocal_55, &(Local_41.f_29[1]));
						func_334();
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(AUDIO::_0x0626A247D2405330(), sLocal_59, 0, 0, 0);
						if (func_11(iLocal_58))
						{
				...
				if (func_17(iLocal_58))
				{
					if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_60, 0) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_61, 0))
					{
						if (STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@base"))
						{
							...
							BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_58, iLocal_47, "special_ped@maude@base", "base", 1000f, -8f, 4688, 0, 1148846080, 0);
							iVar0 = 0;
							iVar0 = 16;
							iVar0 = 64;
							iVar0 = 512;
...
void func_257()//Position - 0x281DE
{
	int iVar0;
...
void func_258(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x28220
{
	int iVar0;
	...
	if (iParam1 == 1)
	{
		...
		{
			if (func_11(AUDIO::_0x0626A247D2405330()))
			{
...
void func_259(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x282C8
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_263(CAM::_0xDC9DA9E8789F5246())) && !func_261(CAM::_0xDC9DA9E8789F5246(), 0)) && !func_260()) && !bParam4)
			{
				ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_263(CAM::_0xDC9DA9E8789F5246())) && !bParam4)
		{
			ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), false);
		}
		Global_11623 = 0;
...
int func_262(int iParam0, bool bParam1)//Position - 0x28459
{
	int iVar0;
	int iVar1;
...
int func_263(int iParam0)//Position - 0x2849A
{
...
bool func_264()//Position - 0x284DC
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_240006, 3);
}

int func_265(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x284ED
{
	int iVar0;
...
void func_267(int iParam0)//Position - 0x28547
{
	if (iParam0 == 1)
	{
...
void func_269(int iParam0, bool bParam1, bool bParam2)//Position - 0x2859B
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_270()//Position - 0x2869B
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
void func_271(vector3 vParam0, float fParam1, int iParam2, int iParam3)//Position - 0x28796
{
	vector3 vVar0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_17998.f_4))
	{
		...
		{
			if (func_319(24) != Global_17998.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_316(unk_0x8000C77B5F336760(Global_17998.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_272(Global_17998.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}

void func_272(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)//Position - 0x28811
{
	struct<60> Var0;
...
void func_273(int iParam0, int iParam1, int iParam2)//Position - 0x2893A
{
	int iVar0;
	...
	if (!func_303(&(Global_11188.f_22B[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_19E56.f_7F5D.f_12C1 = func_292();
			}
...
void func_274(int iParam0, int iParam1)//Position - 0x28A57
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_311(iParam0, &(Global_19E56.f_7F5D.f_1586));
}

int func_275(int iParam0)//Position - 0x28C59
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0)) || func_290(iParam0, 0, 0)) || func_290(iParam0, 1, 0)) || func_290(iParam0, 2, 0)) || func_309(iParam0) != 145) || func_289(iParam0)) || func_288(iParam0)) || func_287(iParam0)) || func_286(iParam0)) || !func_276(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_288(iParam0))
		{
		}
...
int func_276(int iParam0)//Position - 0x28D36
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_277(int iParam0, bool bParam1)//Position - 0x28EE7
{
	int iVar0;
	struct<2> Var1;
...
int func_278(int iParam0)//Position - 0x29067
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_280(int iParam0)//Position - 0x2914A
{
	int iVar0;
	int iVar1;
...
int func_281()//Position - 0x2AE45
{
	return 0;
}

int func_282()//Position - 0x2AE4E
{
	return 1;
}

int func_283()//Position - 0x2AE57
{
	return 1;
}

int func_284()//Position - 0x2AE60
{
...
int func_286(int iParam0)//Position - 0x2AF34
{
	int iVar0;
	char* sVar1;
...
int func_287(int iParam0)//Position - 0x2AF7A
{
	int iVar0;
...
int func_288(int iParam0)//Position - 0x2AFB5
{
	int iVar0;
...
int func_289(int iParam0)//Position - 0x2B031
{
	int iVar0;
...
int func_290(int iParam0, int iParam1, bool bParam2)//Position - 0x2B119
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_291(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2B18A
{
...
void func_293(var uParam0, int iParam1)//Position - 0x2B2A8
{
	if (iParam1 <= 0)
	{
		return;
...
void func_294(var uParam0, int iParam1)//Position - 0x2B32E
{
...
void func_295(var uParam0, int iParam1)//Position - 0x2B361
{
	int iVar0;
	int iVar1;
...
int func_296(int iParam0, int iParam1)//Position - 0x2B3B2
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_297(int iParam0)//Position - 0x2B454
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_298(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}

int func_298(bool bParam0, int iParam1, int iParam2)//Position - 0x2B479
{
	if (bParam0)
	{
		return iParam1;
...
int func_299(var uParam0)//Position - 0x2B490
{
	return uParam0 & 15;
}

void func_300(var uParam0, int iParam1)//Position - 0x2B49D
{
...
void func_301(var uParam0, int iParam1)//Position - 0x2B4D7
{
...
void func_302(var uParam0, int iParam1)//Position - 0x2B512
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_303(var uParam0, int iParam1)//Position - 0x2B54E
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam0->f_9, 10))
	{
		...
		if (!func_310(Global_19E56.f_7F5D.f_748[uParam0->f_E /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_310(Global_19E56.f_933.f_21B.f_DF0[1 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_310(Global_19E56.f_933.f_21B.f_DF0[0 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_304(int iParam0, int iParam1)//Position - 0x2CC4A
{
	struct<82> Var0;
...
void func_305(int iParam0, var uParam1, int iParam2)//Position - 0x2CC8C
{
	int iVar0;
...
void func_306(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0x2CEE8
{
	if (func_303(&(Global_11188.f_22B[0 /*21*/]), iParam0))
	{
		...
		{
			func_308(iParam0);
			func_307(uParam1, &(Global_19E56.f_7F5D.f_45[Global_11188.f_22B[0 /*21*/].f_E /*78*/]));
...
void func_307(var uParam0, var uParam1)//Position - 0x2CFE7
{
...
void func_308(int iParam0)//Position - 0x2D0B3
{
	if (iParam0 == 4294967295)
	{
		return;
...
int func_309(int iParam0)//Position - 0x2D12D
{
	int iVar0;
...
bool func_310(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x2D190
{
	if (bParam2)
	{
...
void func_311(int iParam0, var uParam1)//Position - 0x2D1D7
{
	int iVar0;
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_4D), func_312(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_312(int iParam0)//Position - 0x2D482
{
	switch (iParam0)
	{
		case 1:
...
int func_313(int iParam0, var uParam1, var uParam2)//Position - 0x2D532
{
	int iVar0;
	int iVar1;
...
int func_314(int iParam0)//Position - 0x2D725
{
	switch (iParam0)
	{
		case joaat("GRANGER"):
...
void func_315(int iParam0)//Position - 0x2D745
{
...
int func_316(vector3 vParam0, int iParam1, var uParam2, var uParam3)//Position - 0x2D76C
{
	int iVar0;
...
int func_317(vector3 vParam0, int iParam1, int iParam2)//Position - 0x2D882
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_318(int iParam0)//Position - 0x2D911
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_1C21[iParam0], 0);
}

int func_319(int iParam0)//Position - 0x2D929
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
void func_320(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x2D945
{
	func_321(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_321(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x2D96E
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_322(vector3 vParam0)//Position - 0x2DD62
{
...
int func_323(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)//Position - 0x2DD8C
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_324(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x2E082
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_325(int iParam0)//Position - 0x2E136
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
bool func_326(vector3 vParam0, int iParam1)//Position - 0x2E19B
{
	return func_327(Global_17998.f_B3B.f_C.f_42, vParam0, iParam1);
}

int func_327(int iParam0, vector3 vParam1, int iParam2)//Position - 0x2E1B8
{
	vector3 vVar0;
	vector3 vVar1;
...
Vector3 func_328()//Position - 0x2E222
{
	return 2.55f, 5.665f, 2.55f;
}

void func_329(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x2E239
{
	int iVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (bParam6)
		{
			...
			{
				case 0:
					if (func_174(AUDIO::_0x0626A247D2405330(), 8, 15))
					{
						func_61(AUDIO::_0x0626A247D2405330(), 8, 0, 1, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
					if (func_174(AUDIO::_0x0626A247D2405330(), 9, 6))
					{
						func_61(AUDIO::_0x0626A247D2405330(), 9, 0, 1, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
					break;
				
				case 1:
					if (func_174(AUDIO::_0x0626A247D2405330(), 8, 1) || func_174(AUDIO::_0x0626A247D2405330(), 8, 10))
					{
						func_61(AUDIO::_0x0626A247D2405330(), 8, 26, 1, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
					break;
				
				case 2:
					if (func_174(AUDIO::_0x0626A247D2405330(), 8, 4))
					{
						func_61(AUDIO::_0x0626A247D2405330(), 8, 15, 1, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
					break;
				}
		}
...
void func_330(int iParam0, bool bParam1)//Position - 0x2E3F7
{
...
Vector3 func_331(int iParam0)//Position - 0x2E433
{
	return unk_0x8000C77B5F336760(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_332(bool bParam0)//Position - 0x2E446
{
	int iVar0;
...
void func_333()//Position - 0x2E483
{
	int iVar0;
...
void func_334()//Position - 0x2E4A3
{
	vector3 vVar0;
	int iVar1;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_57))
	{
		...
		iVar1 = 2057223314;
		if (func_14(AUDIO::_0x0626A247D2405330(), vVar0, 150f))
		{
...
void func_335(int iParam0, var uParam1)//Position - 0x2E50A
{
	*iParam0 = *uParam1;
	*uParam1 = 0;
}

void func_336(int iParam0, var uParam1)//Position - 0x2E51C
{
	*iParam0 = *uParam1;
	*uParam1 = 0;
}

void func_337(var uParam0, bool bParam1, bool bParam2)//Position - 0x2E52E
{
	int iVar0;
...
int func_338(int iParam0, float fParam1, int iParam2)//Position - 0x2E623
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
		...
		{
			if (!func_341(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_2(AUDIO::_0x0626A247D2405330(), 3466132403))
				{
...
bool func_339()//Position - 0x2E6F7
{
	bool bVar0;
...
void func_340()//Position - 0x2E71A
{
...
int func_341(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x2E76B
{
...
void func_342(int iParam0)//Position - 0x2E8FA
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
int func_343()//Position - 0x2E926
{
	...
	if (iLocal_48 == 0)
	{
		...
		{
			if (!func_344(AUDIO::_0x0626A247D2405330(), Local_41.f_1C[0], 7f, 1))
			{
				CAM::SET_GAMEPLAY_ENTITY_HINT(Local_41.f_1C[0], 0f, 0f, 0f, 1, 4294967295, 2000, 2000, 0);
				...
				if (!PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
				{
					BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(AUDIO::_0x0626A247D2405330(), Local_41.f_1C[0], 0f, 1.2f, 0f, 1f, 4294967295, 1036831949, 1);
				}
			...
			else
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
				{
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(AUDIO::_0x0626A247D2405330(), Local_41.f_1C[0], 0);
				}
				iLocal_49 = 4294967295;
			}
			BRAIN::TASK_LOOK_AT_ENTITY(AUDIO::_0x0626A247D2405330(), Local_41.f_1C[0], 4000, 0, 2);
		}
		iLocal_48++;
	}
	else if (iLocal_48 == 1)
	{
		if ((iLocal_49 == 4294967295 || (MISC::GET_GAME_TIMER() - iLocal_49) > 3000) || (func_11(Local_41.f_1C[0]) && func_344(AUDIO::_0x0626A247D2405330(), Local_41.f_1C[0], 4.5f, 1)))
		{
			return 1;
		}
	}
...
void func_347()//Position - 0x2EAC6
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
		{
			if (func_341(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_348(int iParam0)//Position - 0x2EB1E
{
	if (func_352())
	{
		return;
...
void func_349(int iParam0)//Position - 0x2EB51
{
	if (func_352())
	{
		return;
...
void func_350(bool bParam0, bool bParam1)//Position - 0x2EBCB
{
	if (bParam0)
	{
		if (func_351(0))
...
int func_351(int iParam0)//Position - 0x2EC3F
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
bool func_352()//Position - 0x2EC99
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

void func_353(char* sParam0, bool bParam1)//Position - 0x2ECAB
{
	func_332(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_354()//Position - 0x2ECC1
{
	if (Global_155D0)
	{
...
var func_355()//Position - 0x2EE39
{
	return Global_17998.f_4;
}

int func_356(var uParam0)//Position - 0x2EE47
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_39)
	{
		...
		case 2:
			...
			{
				func_360(&(uParam0->f_29[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[1]))
			{
				func_360(&(uParam0->f_29[1]), iVar0[2], 2727.686f, 4145.715f, 44.08f, 71f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (!func_357(&(uParam0->f_1C[0]), 62, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 1))
				{
					bVar2 = false;
				}
			}
		...
		case 3:
			if (func_17(uParam0->f_1C[0]) && func_11(uParam0->f_29[0]))
			{
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uParam0->f_3B, false);
				BRAIN::TASK_SYNCHRONIZED_SCENE(uParam0->f_1C[0], uParam0->f_3B, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1148846080, 0);
...
int func_357(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0x2F0D9
{
...
int func_358(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0x2F135
{
	int iVar0;
...
int func_359(var uParam0, int iParam1)//Position - 0x2F1C3
{
	int iVar0;
...
void func_360(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0x2F209
{
	func_4(iParam0);
...
int func_361(int iParam0)//Position - 0x2F230
{
	int iVar0;
...
int func_362(int iParam0)//Position - 0x2F261
{
	if (!func_177(iParam0))
	{
		return Global_19E56.f_6D76[iParam0 /*29*/];
...
void func_363(int iParam0, int iParam1, int iParam2)//Position - 0x2F28C
{
...
void func_364(int iParam0, int iParam1, int iParam2)//Position - 0x2F2C0
{
...
void func_365(bool bParam0, bool bParam1)//Position - 0x2F384
{
	if (bParam0)
	{
		func_366(0, 1, 1);
...
void func_366(bool bParam0, int iParam1, int iParam2)//Position - 0x2F3B7
{
	bool bVar0;
...
void func_367(vector3 vParam0, float fParam1, int iParam2, int iParam3)//Position - 0x2F416
{
	if (func_442())
	{
...
void func_368(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x2F4AB
{
	int iVar0;
...
int func_369(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)//Position - 0x2F63F
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_406(iParam0, &(Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/].f_1F), &(Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/].f_51));
		...
		else if (Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_406(iParam0, &(Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/].f_1F), &(Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/].f_51));
				GRAPHICS::_ADD_CLAN_DECAL_TO_VEHICLE(*iParam0, Var2.f_60);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("BODHI2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2, vParam2, fParam3, true, true, false);
				...
				func_406(iParam0, &(Var2.f_1F), &(Var2.f_51));
				GRAPHICS::_ADD_CLAN_DECAL_TO_VEHICLE(*iParam0, Var2.f_60);
				if (iParam1 == 1)
				{
...
void func_370(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x30485
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_177(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(*iParam1, 0))
	{
		...
		{
			func_313(iParam1, &(Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_1F), &(Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_51));
			if (bParam3)
			{
				...
				Global_19E56.f_4E7A[iParam0 /*43*/].f_1F = func_373(*iParam1);
				...
				func_371(Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_19E56.f_4E7A[iParam0 /*43*/].f_1));
				...
				func_371(Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_6, 4294967295, iVar3, 0, &(Global_19E56.f_4E7A[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_371(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x31099
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_372(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x3110C
{
	*uParam2 = 4294967295;
	*uParam3 = 4294967295;
	*uParam4 = 4294967295;
...
float func_373(int iParam0)//Position - 0x32694
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_374(int iParam0, bool bParam1, var uParam2)//Position - 0x32744
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_401(iVar0, bParam1, uParam2) && !func_400(CAM::_0xDC9DA9E8789F5246())) && !func_384(iParam0))
	{
		return 0;
	}
	if (func_400(CAM::_0xDC9DA9E8789F5246()))
	{
		if (func_383(iVar0))
		{
			return 1;
	...
	bVar1 = false;
	if (func_382(CAM::_0xDC9DA9E8789F5246()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_380(iParam0)) && !bVar1) && !(func_379(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_375(CAM::_0xDC9DA9E8789F5246())))
	{
...
int func_375(int iParam0)//Position - 0x328B2
{
	if (iParam0 != func_378())
	{
		if (func_377(iParam0, 1, 1))
		{
			...
			{
				return func_376(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 11;
			}
		}
	}
	return 0;
...
int func_376(int iParam0)//Position - 0x328F9
{
	switch (iParam0)
	{
		case 0:
...
int func_377(int iParam0, bool bParam1, bool bParam2)//Position - 0x32C53
{
	int iVar0;
...
int func_378()//Position - 0x32C9D
{
	return 4294967295;
}

int func_379(int iParam0)//Position - 0x32CA6
{
...
int func_380(int iParam0)//Position - 0x32CE8
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_381(int iParam0)//Position - 0x32D7B
{
	if (iParam0 != func_378())
	{
		if (func_377(iParam0, 1, 1))
		{
			if (Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295)
			{
				return func_376(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 13;
			}
		}
	}
	return 0;
...
int func_382(int iParam0)//Position - 0x32DC2
{
	if (iParam0 != func_378())
	{
		if (func_377(iParam0, 1, 1))
		{
			if (Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295)
			{
				return func_376(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 7;
			}
		}
	}
	return 0;
...
int func_383(int iParam0)//Position - 0x32E08
{
	switch (iParam0)
	{
		case joaat("AVENGER"):
...
int func_384(int iParam0)//Position - 0x32E3D
{
	if (func_399(CAM::_0xDC9DA9E8789F5246()) || func_398(CAM::_0xDC9DA9E8789F5246()))
	{
		if (func_385(iParam0))
		{
			return 1;
...
int func_385(int iParam0)//Position - 0x32E6C
{
...
int func_386(int iParam0)//Position - 0x32F25
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		return 0;
...
int func_387(int iParam0)//Position - 0x32F5B
{
	switch (iParam0)
	{
		case joaat("APC"):
...
int func_388(int iParam0, bool bParam1)//Position - 0x32FB4
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("INSURGENT"):
			if (func_390(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				...
				else if (func_389(iParam0) != 4294967295 && !bParam1)
				{
					return 1;
				}
			}
...
int func_389(int iParam0)//Position - 0x3300F
{
	int iVar0;
...
int func_390(int iParam0, int iParam1)//Position - 0x33049
{
	if (iParam1 == 0)
	{
...
bool func_391()//Position - 0x333BD
{
	return DLC::IS_DLC_PRESENT(1927191088);
}

bool func_392()//Position - 0x333CE
{
	return DLC::IS_DLC_PRESENT(2067165443);
}

bool func_393()//Position - 0x333DF
{
	return DLC::IS_DLC_PRESENT(3337689893);
}

bool func_394()//Position - 0x333F0
{
	return DLC::IS_DLC_PRESENT(210122941);
}

bool func_395()//Position - 0x33401
{
	return DLC::IS_DLC_PRESENT(2400444888);
}

bool func_396()//Position - 0x33412
{
	return DLC::IS_DLC_PRESENT(1630677557);
}

int func_397(int iParam0, int iParam1)//Position - 0x33423
{
	switch (iParam0)
	{
		case joaat("FACTION2"):
...
int func_398(int iParam0)//Position - 0x33799
{
	if (iParam0 != func_378())
	{
		if (func_377(iParam0, 1, 1))
		{
			if (Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295 && Global_24FBF9[iParam0 /*413*/].f_135.f_7 != func_378())
			{
				return func_376(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 5;
			}
		}
	}
	return 0;
...
int func_399(int iParam0)//Position - 0x337F8
{
	if (iParam0 != func_378())
	{
		if (func_377(iParam0, 1, 1))
		{
			if (Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295 && Global_24FBF9[iParam0 /*413*/].f_135.f_7 != func_378())
			{
				return func_376(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 8;
			}
		}
	}
	return 0;
...
int func_400(int iParam0)//Position - 0x33858
{
	if (iParam0 != func_378())
	{
		if (func_377(iParam0, 1, 1))
		{
			if (Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295)
			{
				return func_376(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 9;
			}
		}
	}
	return 0;
...
int func_401(int iParam0, bool bParam1, var uParam2)//Position - 0x3389F
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_382(CAM::_0xDC9DA9E8789F5246()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_402(int iParam0)//Position - 0x33CB7
{
	switch (iParam0)
	{
		case joaat("TOWTRUCK"):
...
void func_403(int iParam0, int iParam1)//Position - 0x33CE0
{
	int iVar0;
...
void func_404(int iParam0)//Position - 0x33D62
{
	if (!func_405(*iParam0))
	{
...
bool func_405(int iParam0)//Position - 0x33D8D
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_406(int iParam0, var uParam1, var uParam2)//Position - 0x33D9C
{
	int iVar0;
	int iVar1;
...
int func_407(int iParam0)//Position - 0x33F5F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_408(var uParam0)//Position - 0x3403E
{
...
int func_409(int iParam0, int iParam1)//Position - 0x3407E
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_410(var uParam0, int iParam1)//Position - 0x34163
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_411(int iParam0, int iParam1)//Position - 0x341A4
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_16222[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_16222[iVar0]) == func_304(iParam0, iParam1))
				{
...
void func_412(vector3 vParam0, float fParam1, bool bParam2)//Position - 0x34242
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_303(&(Global_11188.f_22B[0 /*21*/]), iVar0))
		{
...
void func_413(int iParam0)//Position - 0x34292
{
	bool bVar0;
	...
	if (func_303(&(Global_11188.f_22B[0 /*21*/]), iParam0))
	{
		...
		if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11188.f_22B[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_206(iParam0, 0)) && Global_11515.f_42 == 0) && Global_19E56.f_7F5D.f_7A6[Global_11188.f_22B[0 /*21*/].f_E] != 0) && Global_19E56.f_7F5D.f_7A6[Global_11188.f_22B[0 /*21*/].f_E] > 3) && (!func_414(0, Global_11188.f_22B[0 /*21*/].f_C) || !func_414(1, Global_11188.f_22B[0 /*21*/].f_C)))
			{
...
int func_414(int iParam0, int iParam1)//Position - 0x34404
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_415(&(Global_19E56.f_7F5D.f_13AE[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_277(Global_19E56.f_7F5D.f_13AE[iVar0 /*157*/][iParam0 /*78*/].f_42, 0);
}

int func_415(var uParam0)//Position - 0x34476
{
	return *uParam0;
}

int func_416(vector3 vParam0, float fParam1)//Position - 0x34481
{
	return func_417(&(Global_18531.f_B3B), vParam0, fParam1, 0);
}

int func_417(var uParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x3449B
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
	...
	if (func_434(uParam0))
	{
		...
		if (func_433(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_422(iVar0, &(uParam0->f_C), 0, 1);
				bVar2 = true;
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam3)
					{
						...
						{
							func_411(uParam0->f_B, 1);
						}
						else if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar0)))
						{
							func_411(uParam0->f_B, 2);
						}
					}
					VEHICLE::_0xAB04325045427AAE(iVar0, 0);
					VEHICLE::_0x428BACCDF5E26EAD(iVar0, 0);
					VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(iVar0, true);
					func_403(iVar0, uParam0->f_B);
				}
				else if ((!func_419(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_A) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_418(int iParam0)//Position - 0x3474E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_419(int iParam0, vector3 vParam1, bool bParam2)//Position - 0x34811
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("CARGOBOB"):
			if (func_421(iParam0, Global_11188.f_8B[38], 0))
			{
				func_413(38);
				return 1;
			}
		...
		case joaat("FIRETRUK"):
			if (func_421(iParam0, Global_11188.f_8B[43], 1))
			{
				func_413(43);
				return 1;
			}
		...
		case joaat("CUBAN800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_421(iParam0, uVar1[iVar3], 1) && func_420(unk_0x8000C77B5F336760(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_310(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(iParam0, true), unk_0x8000C77B5F336760(uVar1[iVar3], true), true) < 10f)
					{
...
int func_420(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x34A19
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_421(int iParam0, int iParam1, bool bParam2)//Position - 0x34A94
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_422(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x34AF5
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam1->f_4D, func_312(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam1->f_4D, func_312(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_4D), func_312(iVar1 + 1));
			}
		}
		...
		if (((INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam1->f_4D, 15) || func_425(iParam0)) || (((uParam1->f_3E == 0 && uParam1->f_3F == 0) && uParam1->f_40 == 0) && uParam1->f_9[20] > 0)) && func_424())
		{
			uParam1->f_3E = 0;
			uParam1->f_3F = 0;
			uParam1->f_40 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_42) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_42))
		{
			...
			while (iVar2 <= 11)
			{
				if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam1->f_4D, func_312(iVar2 + 1)))
				{
...
void func_423(int iParam0, int iParam1)//Position - 0x35045
{
	int iVar0;
	int iVar1;
...
bool func_424()//Position - 0x350AA
{
	return DLC::IS_DLC_PRESENT(2603778600);
}

int func_425(int iParam0)//Position - 0x350BB
{
	int iVar0;
...
int func_426(int iParam0)//Position - 0x35109
{
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
		if (!func_432(CAM::_0xDC9DA9E8789F5246(), 4294967295))
		{
	...
	if (func_428(CAM::_0xDC9DA9E8789F5246()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
		{
			if (func_427(iParam0) != 4294967295)
			{
				return 1;
			}
		}
...
int func_427(int iParam0)//Position - 0x35190
{
...
int func_428(int iParam0)//Position - 0x351C2
{
...
int func_429(int iParam0)//Position - 0x351DF
{
...
int func_430(int iParam0, int iParam1)//Position - 0x35202
{
...
int func_431(int iParam0)//Position - 0x3523D
{
	if (func_430(iParam0, 0))
	{
...
int func_432(int iParam0, int iParam1)//Position - 0x35260
{
	int iVar0;
...
int func_433(var uParam0)//Position - 0x352AD
{
	if (func_434(uParam0))
	{
...
int func_434(var uParam0)//Position - 0x352E2
{
	if (uParam0->f_C.f_42 == 0)
	{
		return 0;
	}
	if (!func_277(uParam0->f_C.f_42, 0))
	{
		return 0;
	}
	if (uParam0->f_C.f_42 == joaat("STUNT") && func_420(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
bool func_435()//Position - 0x35341
{
	return func_433(&(Global_18531.f_B3B));
}

void func_436()//Position - 0x35354
{
	func_437(&(Global_18531.f_B3B));
}

void func_437(var uParam0)//Position - 0x35367
{
	if (func_434(uParam0))
	{
...
int func_438(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x35385
{
	...
	if (iParam2 == 0 && func_440(Global_18531.f_B3B.f_C.f_42))
	{
		return 0;
	}
...
int func_440(int iParam0)//Position - 0x35488
{
	switch (iParam0)
	{
		case joaat("POLICE"):
...
bool func_441()//Position - 0x354E1
{
	return func_434(&(Global_18531.f_B3B));
}

int func_442()//Position - 0x354F4
{
...
void func_443()//Position - 0x35518
{
	iLocal_42 = 0;
	iLocal_43 = 0;
	iLocal_47 = 4294967295;
...
void func_444()//Position - 0x35545
{
	Global_155D1 = 1;
}

void func_445()//Position - 0x35552
{
	func_333();
	if (func_458())
	{
...
void func_446(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x35576
{
...
void func_447(var uParam0, bool bParam1)//Position - 0x35596
{
	func_448(&(uParam0->f_29), bParam1);
}

void func_448(var uParam0, bool bParam1)//Position - 0x355A8
{
	int iVar0;
...
void func_449(var uParam0, bool bParam1)//Position - 0x355E6
{
	func_450(&(uParam0->f_23), bParam1);
}

void func_450(var uParam0, bool bParam1)//Position - 0x355F8
{
	int iVar0;
...
void func_451(int iParam0)//Position - 0x35635
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_452(int iParam0)//Position - 0x3566D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_453(int iParam0)//Position - 0x35709
{
	if (func_11(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
void func_454(var uParam0, int iParam1)//Position - 0x35733
{
	func_455(&(uParam0->f_1C), iParam1);
}

void func_455(var uParam0, int iParam1)//Position - 0x35745
{
	int iVar0;
...
void func_456(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x35786
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_457()//Position - 0x357D6
{
	if (CAM::IS_GAMEPLAY_HINT_ACTIVE())
	{
		CAM::STOP_GAMEPLAY_HINT(0);
...
void func_459(bool bParam0)//Position - 0x3589F
{
	int iVar0;
...
void func_460(char* sParam0, int iParam1)//Position - 0x3596F
{
	if (Global_16C30 != 12)
	{
...
int func_461(char* sParam0, int iParam1, int iParam2)//Position - 0x35997
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
...
int func_462(char* sParam0)//Position - 0x35B29
{
...
int func_463()//Position - 0x35B83
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_464(&(Global_16C30.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_464(char* sParam0, bool bParam1)//Position - 0x35BA7
{
	int iVar0;
	int iVar1;
...
int func_465(int iParam0, bool bParam1)//Position - 0x35BD1
{
	int iVar0;
...
int func_467()//Position - 0x35C57
{
	...
	{
		if (func_462(&(Global_16C30.f_3)) > 4294967295)
		{
			return 1;
		}
	}
...
void func_468(bool bParam0)//Position - 0x35CC3
{
	unk_0x59B038076F830627(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_469(int iParam0)//Position - 0x35CD7
{
	if (iParam0 == 1)
	{
		HUD::_0xFDB423997FA30340();
...
void func_470(int iParam0)//Position - 0x35D14
{
	if (iParam0 == 1)
	{
...
void func_471()//Position - 0x35D51
{
	Global_434C.f_5 = 1;
}

void func_472()//Position - 0x35D5F
{
	Global_434C.f_5 = 0;
}

void func_473(bool bParam0)//Position - 0x35D6D
{
	if (bParam0)
	{
		func_474();
...
void func_474()//Position - 0x35DD0
{
...
void func_475()//Position - 0x35DF9
{
	Global_155CF = 0;
	Global_155D0 = 0;
}

int func_476()//Position - 0x35E0B
{
	if (((Global_16C30 == 13 || Global_16C30 == 10) || Global_16C30 == 11) || Global_16C30 == 12)
	{
		return 0;
...
void func_477()//Position - 0x35E49
{
	Global_16C53 = 1;
...
void func_478(char* sParam0)//Position - 0x35F3C
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_479(var uParam0)//Position - 0x35F4E
{
...
void func_480(var uParam0)//Position - 0x35F6E
{
	int iVar0;
