...
int func_83()
{
	if (Global_2423644[PLAYER::PLAYER_ID() /*406*/].f_305.f_4 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("business_hub_garage_seats", Global_2423644[PLAYER::PLAYER_ID() /*406*/].f_305.f_4, 1, 0))
		{
			return 0;
		}
...
void func_85(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	(uParam1[iParam2 /*14*/])->f_1 = { func_87(func_88(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_87(func_86(), fVar1) + vVar0 };
