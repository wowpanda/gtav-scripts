...
void func_3(var uParam0)
{
	...
	{
		func_4(-1);
		uVar0 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_141.f_1);
...
void func_9(var uParam0)
{
	...
	switch (uParam0->f_141.f_4)
	{
		...
		case 2:
			if (func_62(PLAYER_PED_ID(), uParam0[uParam0->f_141.f_2 /*14*/]) && func_61(PLAYER_PED_ID(), (uParam0[uParam0->f_141.f_2 /*14*/])->f_8.f_3, (*uParam0)[uParam0->f_141.f_2 /*14*/]))
			{
		...
		case 4:
			...
			vVar20 = { GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar16, func_47(uParam0), func_46(uParam0), 0, 2) };
			vVar23 = { GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_47(uParam0), func_46(uParam0), 0, 2) };
			uVar26 = vVar23.z;
			fVar27 = 0.05f;
			...
			TASK_GO_STRAIGHT_TO_COORD(PLAYER_PED_ID(), vVar20, 1f, 500, uVar26, fVar27);
		...
		case 5:
			...
			func_49(uParam0, &sVar0);
			func_48(uParam0, &sVar16);
			iVar28 = GET_SCRIPT_TASK_STATUS(PLAYER_PED_ID(), 2106541073);
			vVar29 = { GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_47(uParam0), func_46(uParam0), 0, 2) };
			fVar32 = vVar29.z;
			if ((iVar28 != 1 && iVar28 != 0) || func_34(GET_ENTITY_HEADING(PLAYER_PED_ID()), fVar32, 5f))
			{
				uParam0->f_141.f_1 = NETWORK_CREATE_SYNCHRONISED_SCENE(func_47(uParam0), func_46(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uParam0->f_141.f_1, &sVar0, &sVar16, 2f, -1000f, 13, 16, 1148846080, 0);
		...
		case 6:
			...
			func_35(uParam0);
			func_16(uParam0);
			uVar33 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_141.f_1);
			if (IS_SYNCHRONIZED_SCENE_RUNNING(uVar33))
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(uVar33) >= 1f)
				{
					func_10(uParam0, 0);
					func_49(uParam0, &sVar0);
					func_48(uParam0, &sVar16);
					uParam0->f_141.f_1 = NETWORK_CREATE_SYNCHRONISED_SCENE(func_47(uParam0), func_46(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
					NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uParam0->f_141.f_1, &sVar0, &sVar16, 4f, -1.5f, 13, 16, 1148846080, 0);
					NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
					func_33(&(uParam0->f_141), 8);
		...
		case 8:
			uVar34 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_141.f_1);
			iVar35 = GET_SCRIPT_TASK_STATUS(PLAYER_PED_ID(), 1785177548);
			if (iVar35 == 0 || iVar35 == 1)
			{
				if (IS_SYNCHRONIZED_SCENE_RUNNING(uVar34))
				{
					if ((GET_SYNCHRONIZED_SCENE_PHASE(uVar34) >= 0.7f || HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), 364629851)) || HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), 2116425869))
					{
						NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
						func_4(-1);
						func_5(uParam0, 1);
...
void func_16(var uParam0)
{
	...
	if (uParam0->f_141.f_4 == 6)
	{
		...
		else
		{
			...
			bVar4 = false;
			if (((func_26(func_27()) && func_25()) && func_24(Global_2424047[PLAYER_ID() /*416*/].f_309.f_8, 4)) && func_23(Global_2424047[PLAYER_ID() /*416*/].f_309.f_8))
			{
				bVar4 = true;
			}
			if (((((!IS_PAUSE_MENU_ACTIVE() && !func_32(&(uParam0->f_141), 0)) && !func_32(&(uParam0->f_141), 4)) && !func_22()) && !func_20(1)) && uParam0->f_141.f_8.f_2 != 3)
			{
				...
				if (uParam0->f_141.f_4 == 6)
				{
					...
					if (((IS_DISABLED_CONTROL_JUST_PRESSED(2, iVar5) && !IS_CONTROL_JUST_PRESSED(2, 203)) && !Global_2507141) && !Global_2507139)
					{
						func_30(uParam0);
					}
					if (((((IS_DISABLED_CONTROL_JUST_PRESSED(2, 203) && !IS_DISABLED_CONTROL_JUST_PRESSED(2, iVar5)) && func_26(func_27())) && func_25()) && func_24(Global_2424047[PLAYER_ID() /*416*/].f_309.f_8, 4)) && func_23(Global_2424047[PLAYER_ID() /*416*/].f_309.f_8))
					{
						Global_2507141 = 1;
						Global_2507139 = 1;
					}
...
int func_18(int iParam0, int iParam1)
{
	...
	uVar0 = iParam1 + 20;
	return IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_273.f_316.f_1, uVar0);
}
...
int func_23(int iParam0)
{
	...
	return IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_273.f_316.f_1, 1);
}
...
int func_24(int iParam0, int iParam1)
{
	...
	{
		case 0:
			return IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_273.f_275.f_7, 0);
			break;
		
		case 1:
			return IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_273.f_275.f_7, 1);
			break;
		
		case 4:
			return IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_273.f_275.f_7, 2);
			break;
		
		case 2:
			return IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_273.f_275.f_7, 3);
			break;
		
		case 3:
			return IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_273.f_275.f_7, 4);
			break;
		
		case 5:
			return IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_273.f_275.f_7, 5);
			break;
	}
	return 0;
}
...
int func_25()
{
	if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1612.283f, -3021.792f, -76.18069f, -1612.22f, -3005.203f, -74.20517f, 12.75f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
void func_30(var uParam0)
{
	...
	uParam0->f_141.f_1 = NETWORK_CREATE_SYNCHRONISED_SCENE(func_47(uParam0), func_46(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
	func_49(uParam0, &sVar0);
	NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uParam0->f_141.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1148846080, 0);
	NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_141.f_1);
	func_7(&(uParam0->f_141.f_5));
	func_64(uParam0, 8);
}
...
int func_55(var uParam0)
{
	...
	while (iVar0 < _NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK_IS_PARTICIPANT_ACTIVE(INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if (iVar1 != PLAYER_ID() && func_58(iVar1, 1, 1))
			{
				if (func_62(GET_PLAYER_PED(iVar1), uParam0[uParam0->f_141.f_2 /*14*/]) || func_57(iVar1) == uParam0->f_141.f_2)
				{
					return 1;
				}
			}
...
int func_56(var uParam0)
{
	...
	while (iVar11 < 10)
	{
		if (((DOES_ENTITY_EXIST(uVar0[iVar11]) && !IS_PED_INJURED(uVar0[iVar11])) && IS_ENTITY_VISIBLE(uVar0[iVar11])) && (func_62(uVar0[iVar11], uParam0[uParam0->f_141.f_2 /*14*/]) || VDIST2(GET_ENTITY_COORDS(uVar0[iVar11], 0), (uParam0[uParam0->f_141.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_141.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f))
		{
			return 1;
		}
		iVar11++;
...
int func_61(var uParam0, vector3 vParam1, int iParam4)
{
	if (DOES_ENTITY_EXIST(uParam0))
	{
		if (iParam4 == 3)
		{
			if (func_34(GET_ENTITY_HEADING(uParam0), (vParam1.z - 180f), 45f))
			{
				return 1;
			}
		}
		else if (func_34(GET_ENTITY_HEADING(uParam0), vParam1.z, 45f))
		{
			return 1;
		}
	}
...
void func_66(var uParam0)
{
	...
	else if (uParam0->f_141.f_4 > 4)
	{
		...
		SET_PED_CAPSULE(PLAYER_PED_ID(), func_67());
...
void func_68(var uParam0)
{
	...
	func_69(&(uParam0->f_141), 1, IS_ENTITY_DEAD(PLAYER_PED_ID(), 0));
	func_69(&(uParam0->f_141), 3, IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1));
	func_69(&(uParam0->f_141), 0, func_44(0));
	func_69(&(uParam0->f_141), 2, IS_PED_RUNNING(PLAYER_PED_ID()));
}
...
int func_71()
{
	...
	if (Global_2424047[PLAYER_ID() /*416*/].f_309.f_8 == func_19())
	{
		return 1;
	}
	return 0;
...
int func_72()
{
	...
	if (func_73() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_73()) == 0)
		{
			return 1;
		}
	}
...
int func_83()
{
	if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1502.824f, -3006.31f, -80.557f, -1513.824f, -3006.31f, -84.557f, 9.5f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
int func_84()
{
	if (Global_2424047[PLAYER_ID() /*416*/].f_309.f_8 != func_19())
	{
		if (NETWORK_IS_SCRIPT_ACTIVE("business_hub_garage_seats", Global_2424047[PLAYER_ID() /*416*/].f_309.f_8, 1, 0))
		{
			return 0;
		}
		NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, 0, Global_2424047[PLAYER_ID() /*416*/].f_309.f_8);
		func_92(0, -1, 0);
...
void func_86(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	func_90(iParam0, &vVar0, &uVar3);
	(*uParam1)[iParam2 /*14*/] = iParam3;
	(uParam1[iParam2 /*14*/])->f_8 = { vVar0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, uVar3 };
	(uParam1[iParam2 /*14*/])->f_1 = { func_88(func_89(), uVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_88(func_87(), uVar3) + vVar0 };
...
Vector3 func_88(vector3 vParam0, var uParam3)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
