...
void __EntryFunction__()
{
	...
	{
		if (!IS_PED_INJURED(uLocal_140))
		{
			if (IS_PED_GROUP_MEMBER(uLocal_140, GET_PLAYER_GROUP(PLAYER_ID())))
			{
				REMOVE_PED_FROM_GROUP(uLocal_140);
				TASK_WANDER_STANDARD(uLocal_140, 1193033728, 0);
				SET_PED_COMBAT_ATTRIBUTES(uLocal_140, 17, 1);
				SET_PED_FLEE_ATTRIBUTES(uLocal_140, 2, 0);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_140, 0);
				SET_PED_KEEP_TASK(uLocal_140, 1);
			}
			else if (!IS_ENTITY_PLAYING_ANIM(uLocal_140, sLocal_386, "IG_1_ALT1_GIRL_IN_VAN_LOOP", 3))
			{
				SET_PED_SUFFERS_CRITICAL_HITS(uLocal_140, 1);
				TASK_SMART_FLEE_COORD(uLocal_140, GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 150f, -1, 0, 0);
				SET_PED_KEEP_TASK(uLocal_140, 1);
			}
		}
		func_250();
	...
	SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_PARK_PERPENDICULAR_NOSE_IN", 0);
	...
	while (true)
	{
			...
			if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			{
				switch (iLocal_48)
				{
					...
					case 1:
						...
						if ((!IS_PED_INJURED(PLAYER_PED_ID()) && !IS_PED_INJURED(uLocal_141)) && !IS_PED_INJURED(uLocal_140))
						{
							if (!DOES_BLIP_EXIST(uLocal_123))
							{
								if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), GET_ENTITY_COORDS(uLocal_140, 0) - Vector(7f, 0f, 0f), 142f, 83.75f, 35.25f, 0, 1, 0))
								{
							...
							if (iLocal_439 == 0)
							{
								if ((!IS_ENTITY_OCCLUDED(uLocal_155) || !IS_ENTITY_OCCLUDED(uLocal_141)) || IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_140, 40f, 40f, 20f, 0, 1, 0))
								{
									SETTIMERB(0);
									iLocal_439 = 1;
								}
							...
							if (iLocal_439 == 3)
							{
								...
								SET_VEHICLE_TYRES_CAN_BURST(uLocal_155, 1);
								func_161(0);
							}
							else if (!iLocal_101)
							{
								if (func_160() == 2)
								{
									if ((VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), vLocal_52) < 40f && DOES_ENTITY_EXIST(uLocal_155)) && !IS_ENTITY_OCCLUDED(uLocal_155))
									{
		...
		else if (!IS_PED_INJURED(uLocal_140))
		{
			if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_140, 150f, 150f, 50f, 0, 1, 0) || (IS_VEHICLE_DRIVEABLE(uLocal_155, 0) && !IS_ENTITY_OCCLUDED(uLocal_155)))
			{
				switch (iLocal_50)
				{
					case 0:
						_0xAF66DCEE6609B148();
						if (IS_VEHICLE_DRIVEABLE(uLocal_155, 0) && !IS_PED_INJURED(uLocal_142))
						{
							if (IS_PED_IN_VEHICLE(uLocal_142, uLocal_155, 0))
							{
								if (IS_ENTITY_ATTACHED(uLocal_140) && GET_SCRIPT_TASK_STATUS(uLocal_142, 242628503) == 7)
								{
									TASK_LOOK_AT_ENTITY(uLocal_140, PLAYER_PED_ID(), -1, 0, 2);
									OPEN_SEQUENCE_TASK(&uLocal_159);
									TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_155, vLocal_62, 50f, 0, 0, 786469, 7f, 15f);
									TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_155, -859.6284f, 382.7891f, 86.4466f, 50f, 0, 0, 786469, 7f, 15f);
									TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_155, -703.2946f, 287.229f, 82.6848f, 50f, 0, 0, 786469, 7f, 15f);
									TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_155, -496.6651f, 246.5268f, 82.0747f, 50f, 0, 0, 786469, 7f, 15f);
									TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_155, -166.6776f, 250.8786f, 92.4768f, 50f, 0, 0, 786469, 7f, 15f);
									TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_155, 74.5106f, 236.4861f, 108.1344f, 50f, 0, 0, 786469, 7f, 15f);
									TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_155, 278.7988f, 161.9029f, 103.446f, 50f, 0, 0, 786469, 7f, 15f);
									TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_155, 425.6758f, 108.9366f, 99.4329f, 50f, 0, 0, 786469, 7f, 15f);
									TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_155, 729.2792f, -19.616f, 81.9823f, 50f, 0, 0, 786469, 7f, 15f);
									TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_155, vLocal_59, 50f, 0, 0, 786469, 7f, 15f);
									CLOSE_SEQUENCE_TASK(uLocal_159);
									TASK_PERFORM_SEQUENCE(uLocal_142, uLocal_159);
									CLEAR_SEQUENCE_TASK(&uLocal_159);
									iLocal_50 = 1;
								}
							}
						}
					...
					case 1:
						...
						if (((((func_116() || func_115()) || func_113()) || func_112()) || func_111()) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_140, PLAYER_PED_ID(), 1))
						{
							CLEAR_ENTITY_LAST_DAMAGE_ENTITY(uLocal_140);
							if (DOES_BLIP_EXIST(uLocal_123))
							{
								if (GET_BLIP_COLOUR(uLocal_123) != 1)
								{
									SET_BLIP_AS_FRIENDLY(uLocal_123, 0);
									SET_BLIP_COLOUR(uLocal_123, 1);
								}
							}
							func_149();
						...
						else if (IS_VEHICLE_DRIVEABLE(uLocal_155, 0))
						{
							if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_155, 25f, 25f, 5f, 0, 1, 0) && GET_ENTITY_SPEED(uLocal_155) > 10f)
							{
					...
					case 2:
						...
						if (DOES_ENTITY_EXIST(uLocal_155) && DOES_ENTITY_EXIST(uLocal_140))
						{
							if (IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_140, uLocal_155))
							{
								if (IS_ENTITY_DEAD(uLocal_155, 0))
								{
									SET_ENTITY_INVINCIBLE(uLocal_140, 0);
									DETACH_ENTITY(uLocal_140, 1, 0);
								}
							}
						}
						if (bLocal_74)
					...
					case 3:
						...
						switch (iLocal_385)
						{
							case 0:
								...
								{
									if (!DOES_ENTITY_EXIST(uLocal_163))
									{
										uLocal_163 = GET_PLAYERS_LAST_VEHICLE();
										SET_ENTITY_AS_MISSION_ENTITY(uLocal_163, 1, 1);
									}
								}
								if (func_103(1, 0, 1) && IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_140, 2.5f, 2.5f, 2.5f, 0, 1, 1))
								{
									CLEAR_AREA_OF_PROJECTILES(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 50f, 0);
									SET_PED_CONFIG_FLAG(uLocal_140, 118, 0);
									func_102();
									func_94(1, 1, 1, 0, 0, 0);
									...
									if (!IS_ENTITY_DEAD(uLocal_155, 0))
									{
										STOP_SYNCHRONIZED_ENTITY_ANIM(uLocal_155, -8f, 1);
										FREEZE_ENTITY_POSITION(uLocal_155, 0);
										SET_VEHICLE_DOORS_LOCKED(uLocal_155, 1);
										Local_392.f_3 = { -22.8598f, 0f, (GET_ENTITY_HEADING(uLocal_155) - 60f) };
									}
									...
									SET_ENTITY_COORDS(uLocal_140, GET_ENTITY_COORDS(uLocal_155, 0), 1, 0, 0, 1);
									vLocal_110 = { 0f, 0f, 0f };
									vLocal_113 = { 0f, 0f, 0f };
									uLocal_108 = CREATE_SYNCHRONIZED_SCENE(vLocal_110, vLocal_113, 2);
									if (IS_ENTITY_ATTACHED(uLocal_140))
									{
										DETACH_ENTITY(uLocal_140, 1, 0);
									}
									ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_108, uLocal_155, GET_ENTITY_BONE_INDEX_BY_NAME(uLocal_155, sLocal_175));
									SET_SYNCHRONIZED_SCENE_ORIGIN(uLocal_108, vLocal_110, vLocal_113, 2);
									TASK_LOOK_AT_ENTITY(uLocal_140, PLAYER_PED_ID(), -1, 0, 2);
									TASK_SYNCHRONIZED_SCENE(uLocal_140, uLocal_108, sLocal_386, "IG_1_ALT1_EXIT_VAN", 1000f, -4f, 5, 0, 1148846080, 0);
									_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_108, 0);
									SET_PED_KEEP_TASK(uLocal_140, 1);
									uLocal_412 = CREATE_CAMERA(964613260, 1);
									PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_412, uLocal_108, "IG_1_ALT1_EXIT_VAN_CAM", sLocal_386);
									FREEZE_ENTITY_POSITION(uLocal_155, 1);
									SET_VEHICLE_DOOR_OPEN(uLocal_155, 2, 0, 0);
									SET_VEHICLE_DOOR_OPEN(uLocal_155, 3, 0, 0);
									vLocal_110 = { GET_ENTITY_COORDS(uLocal_155, 0) };
									vLocal_113.z = GET_ENTITY_HEADING(uLocal_155);
									vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_155, 0f, -4.7f, 0f) };
									GET_GROUND_Z_FOR_3D_COORD(vVar0, &(vVar0.f_2), 0, 0);
									SET_ENTITY_HEADING(PLAYER_PED_ID(), GET_ENTITY_HEADING(uLocal_155));
									SET_ENTITY_COORDS(PLAYER_PED_ID(), vVar0, 1, 0, 0, 1);
									if (func_86(uLocal_163))
									{
										func_85();
									}
									if (DOES_ENTITY_EXIST(uLocal_141))
									{
										if (IS_ENTITY_DEAD(uLocal_141, 0) && VDIST(GET_ENTITY_COORDS(uLocal_141, 0), GET_ENTITY_COORDS(uLocal_140, 0)) < 3f)
										{
											DELETE_PED(&uLocal_141);
										}
										if (IS_ENTITY_DEAD(uLocal_143, 0) && VDIST(GET_ENTITY_COORDS(uLocal_143, 0), GET_ENTITY_COORDS(uLocal_143, 0)) < 3f)
										{
											DELETE_PED(&uLocal_143);
										}
									}
							...
							case 1:
								if (DOES_ENTITY_EXIST(uLocal_155))
								{
									iLocal_385++;
								}
								break;
							...
							case 4:
								if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_108))
								{
									if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_108) > 0.3746479f && !iLocal_116)
									{
									...
									if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_108) > 0.4f)
									{
										iLocal_385++;
									}
								}
							...
							case 5:
								CLEAR_PED_TASKS(uLocal_140);
								SET_ENTITY_INVINCIBLE(uLocal_140, 0);
								SET_PED_CONFIG_FLAG(uLocal_140, 118, 1);
								vLocal_171 = { GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_386, "IG_1_ALT1_EXIT_VAN", vLocal_110, vLocal_113, 1f, 2) };
								GET_GROUND_Z_FOR_3D_COORD(vLocal_171, &(vLocal_171.f_2), 0, 0);
								SET_ENTITY_COORDS(uLocal_140, vLocal_171, 1, 0, 0, 1);
								vLocal_171 = { GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_386, "IG_1_ALT1_EXIT_VAN", vLocal_110, vLocal_113, 1f, 2) };
								SET_ENTITY_HEADING(uLocal_140, vLocal_171.z);
								if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_108))
								{
									SET_SYNCHRONIZED_SCENE_PHASE(uLocal_108, 1f);
								}
								_0x2208438012482A1A(uLocal_140, 0, 0);
								HIDE_PED_WEAPON_FOR_SCRIPTED_CUTSCENE(PLAYER_PED_ID(), 0);
								if (IS_VEHICLE_DRIVEABLE(uLocal_155, 0))
								{
									FREEZE_ENTITY_POSITION(uLocal_155, 0);
									if (IS_ENTITY_PLAYING_ANIM(uLocal_155, sLocal_386, "IG_1_ALT1_EXIT_VAN", 3))
									{
										STOP_ENTITY_ANIM(uLocal_155, "IG_1_ALT1_EXIT_VAN", sLocal_386, -8f);
									}
								}
								RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
								if (DOES_CAM_EXIST(uLocal_412))
								{
									DESTROY_CAM(uLocal_412, 0);
								}
								SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
								SET_PLAYER_CONTROL(PLAYER_ID(), 1, 0);
								func_94(0, 1, 1, 0, 0, 0);
								SET_PED_CAN_RAGDOLL(uLocal_140, 1);
								func_82(vLocal_56);
								if (IS_VEHICLE_DRIVEABLE(uLocal_155, 0))
								{
									SET_VEHICLE_DOORS_LOCKED(uLocal_155, 1);
						...
						{
							HIDE_HUD_AND_RADAR_THIS_FRAME();
							if ((func_80(1000) || !IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_108)) || (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_108) && GET_SYNCHRONIZED_SCENE_PHASE(uLocal_108) > 0.4f))
							{
								iLocal_385 = 5;
							}
						}
					...
					case 4:
						...
						if (DOES_ENTITY_EXIST(uLocal_142))
						{
							if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(uLocal_142, 0)) > 10000f && IS_ENTITY_OCCLUDED(uLocal_142))
							{
								SET_PED_AS_NO_LONGER_NEEDED(&uLocal_142);
							}
						}
						if (DOES_ENTITY_EXIST(uLocal_143))
						{
							if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(uLocal_143, 0)) > 10000f && IS_ENTITY_OCCLUDED(uLocal_143))
							{
								SET_PED_AS_NO_LONGER_NEEDED(&uLocal_143);
							}
						}
						if (DOES_ENTITY_EXIST(uLocal_141))
						{
							if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(uLocal_141, 0)) > 10000f && IS_ENTITY_OCCLUDED(uLocal_141))
							{
								SET_PED_AS_NO_LONGER_NEEDED(&uLocal_141);
							}
						}
						if (DOES_ENTITY_EXIST(uLocal_155))
						{
							if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(uLocal_155, 0)) > 10000f && IS_ENTITY_OCCLUDED(uLocal_155))
							{
								SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_155);
							}
						}
						func_62();
						if (DOES_BLIP_EXIST(uLocal_122))
						{
							if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_140, 10f, 10f, 10f, 0, 1, 0))
							{
								if (IS_PLAYER_CONTROL_ON(PLAYER_ID()))
								{
									if (GET_SCRIPT_TASK_STATUS(uLocal_140, 474215631) != 7)
									{
										CLEAR_PED_TASKS(uLocal_140);
									}
									TASK_CLEAR_LOOK_AT(uLocal_140);
									SET_PED_AS_GROUP_MEMBER(uLocal_140, GET_PLAYER_GROUP(PLAYER_ID()));
									SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uLocal_140, 0);
						...
						else if (DOES_BLIP_EXIST(uLocal_120))
						{
							if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_56, Global_19, 1, 1, 0))
							{
								if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && IS_PED_IN_ANY_VEHICLE(uLocal_140, 0))
								{
									if ((IS_VEHICLE_DRIVEABLE(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0) && IS_VEHICLE_ON_ALL_WHEELS(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0))) && IS_ENTITY_UPRIGHT(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 1119092736))
									{
										iLocal_50 = 6;
										func_55();
										REMOVE_BLIP(&uLocal_120);
							...
							else
							{
								...
								{
									if ((GET_GAME_TIMER() - iLocal_69) > 5000)
									{
										iLocal_69 = (GET_GAME_TIMER() - 5000);
									}
									func_47();
									iVar4 = 0;
									while (iVar4 < iLocal_156)
									{
										if (((func_46(iLocal_144[iVar4]) || func_46(iLocal_147[iVar4])) || VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), vLocal_56) < 400f) || VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), vLocal_65) < 400f)
										{
											if (DOES_BLIP_EXIST(uLocal_120))
											{
												REMOVE_BLIP(&uLocal_120);
											...
											func_44();
											iLocal_75 = 0;
											if (!IS_PED_INJURED(iLocal_144[iVar4]))
											{
												SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(iLocal_144[iVar4], 3);
											}
											if (!IS_PED_INJURED(iLocal_147[iVar4]))
											{
					...
					case 5:
						...
						else if ((GET_GAME_TIMER() - iLocal_119) > 2000 && !func_84())
						{
							if (!iLocal_99)
							{
								if (func_11() && func_10() < 30f)
								{
									if (!IS_PED_INJURED(uLocal_140) && !IS_PED_INJURED(iLocal_144[0]))
									{
										if (IS_PED_IN_ANY_VEHICLE(uLocal_140, 0))
										{
											TASK_DRIVE_BY(uLocal_140, iLocal_144[0], 0, 0f, 0f, 0f, 50f, 90, 0, 1566631136);
										}
										iLocal_99 = 1;
									}
								}
							...
							else if (!iLocal_100)
							{
								if (IS_PED_IN_ANY_VEHICLE(uLocal_140, 0))
								{
									if (IS_PED_DOING_DRIVEBY(uLocal_140))
									{
						...
						{
							iVar6 = 0;
							if ((DOES_ENTITY_EXIST(iLocal_144[iVar5]) && !IS_PED_INJURED(iLocal_144[iVar5])) && !IS_ENTITY_DEAD(iLocal_144[iVar5], 0))
							{
							...
							if ((DOES_ENTITY_EXIST(iLocal_147[iVar5]) && !IS_PED_INJURED(iLocal_147[iVar5])) && !IS_ENTITY_DEAD(iLocal_147[iVar5], 0))
							{
							...
							func_7(iVar5, (iVar6 && IS_VEHICLE_DRIVEABLE(iLocal_156[iVar5], 0)));
							iVar5++;
						}
						if (func_6())
						{
							...
							while (iLocal_85 < 2)
							{
								...
								if (!IS_PED_INJURED(iLocal_144[iLocal_85]))
								{
									SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_144[iLocal_85]));
								}
								if (!IS_PED_INJURED(iLocal_147[iLocal_85]))
								{
				...
				if (DOES_BLIP_EXIST(uLocal_120))
				{
					_0x75A16C3DA34F1245(uLocal_120, iLocal_83);
				}
				if (DOES_BLIP_EXIST(uLocal_121))
				{
					_0x75A16C3DA34F1245(uLocal_121, iLocal_83);
				}
				if (DOES_BLIP_EXIST(uLocal_122))
				{
					_0x75A16C3DA34F1245(uLocal_122, iLocal_83);
				}
				if (DOES_BLIP_EXIST(uLocal_123))
				{
					_0x75A16C3DA34F1245(uLocal_123, iLocal_83);
				}
				if (DOES_BLIP_EXIST(uLocal_124))
				{
					_0x75A16C3DA34F1245(uLocal_124, iLocal_83);
				}
			}
			else
			{
	...
	if (!IS_PED_INJURED(uLocal_140))
	{
		switch (iLocal_437)
		{
			case 0:
				...
				{
					while (!func_3(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 1093140480, 1, 1056964608, 0, 1, 0))
					{
						WAIT(0);
					}
				}
				...
				if (!IS_PED_IN_ANY_VEHICLE(uLocal_140, 0))
				{
					TASK_TURN_PED_TO_FACE_ENTITY(uLocal_140, PLAYER_PED_ID(), 0);
				}
				TASK_LOOK_AT_ENTITY(uLocal_140, PLAYER_PED_ID(), 30000, 2052, 2);
				TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), uLocal_140, 30000, 2052, 2);
				iLocal_437++;
				break;
			...
			case 1:
				if (!func_84())
				{
					...
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, -3069.737f, 455.0024f, 8.6478f, 1f, 30000, 0.25f, 0, 1193033728);
					TASK_ACHIEVE_HEADING(0, 73.0132f, 0);
					TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_SMOKING", 0, 1);
					CLOSE_SEQUENCE_TASK(uVar0);
					TASK_PERFORM_SEQUENCE(uLocal_140, uVar0);
...
int func_3(var uParam0, int iParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	{
		_SET_VEHICLE_HALT(uParam0, iParam1, iParam2, iParam4);
	}
...
void func_7(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		{
			uLocal_131[iParam0] = func_8(GET_ENTITY_COORDS(iLocal_156[iParam0], 0), 0);
		...
		else
		{
			...
			vVar3 = { GET_ENTITY_COORDS(iLocal_156[iParam0], 0) };
...
var func_8(vector3 vParam0, int iParam3)
{
	...
	SET_BLIP_SCALE(uVar0, func_9(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
float func_10()
{
	...
	{
		if ((DOES_ENTITY_EXIST(iLocal_144[iVar0]) && !IS_PED_INJURED(iLocal_144[iVar0])) && !IS_ENTITY_DEAD(iLocal_144[iVar0], 0))
		{
			if (fVar1 == -1f)
			{
				fVar1 = VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(iLocal_144[iVar0], 0));
			}
			else if (VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(iLocal_144[iVar0], 0)) < fVar1)
			{
				fVar1 = VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(iLocal_144[iVar0], 0));
			}
		}
	...
	{
		if ((DOES_ENTITY_EXIST(iLocal_147[iVar0]) && !IS_PED_INJURED(iLocal_147[iVar0])) && !IS_ENTITY_DEAD(iLocal_147[iVar0], 0))
		{
			if (fVar1 == -1f)
			{
				fVar1 = VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(iLocal_147[iVar0], 0));
			}
			else if (VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(iLocal_147[iVar0], 0)) < fVar1)
			{
				fVar1 = VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(iLocal_147[iVar0], 0));
			}
		}
...
int func_11()
{
	if (!IS_PED_INJURED(uLocal_140))
	{
		if ((IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && IS_VEHICLE_DRIVEABLE(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0)) && IS_PED_IN_VEHICLE(uLocal_140, GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0))
		{
			return 1;
		}
		if ((!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !IS_PED_IN_ANY_VEHICLE(uLocal_140, 0)) && !IS_PED_RAGDOLL(uLocal_140))
		{
			if (VDIST2(GET_ENTITY_COORDS(uLocal_140, 0), GET_ENTITY_COORDS(PLAYER_PED_ID(), 0)) < 400f)
			{
				return 1;
			}
		}
...
void func_12()
{
	...
	if (!iLocal_367)
	{
		vVar0 = { GET_ENTITY_COORDS(uLocal_140, 0) + vVar0 };
		vVar3 = { GET_ENTITY_COORDS(uLocal_140, 0) + vVar3 };
		if (func_159(&uLocal_176, cLocal_387, "RESNA_MOR", 4, func_200(), 0, 0))
		{
			if (!IS_PED_INJURED(uLocal_140) && !IS_PED_INJURED(iLocal_147[0]))
			{
				TASK_LOOK_AT_ENTITY(uLocal_140, iLocal_144[0], 20000, 16, 3);
			}
			iLocal_367 = 1;
		}
	}
...
void func_13()
{
	if (!IS_PED_INJURED(uLocal_140))
	{
		SET_PED_CONFIG_FLAG(uLocal_140, 317, 1);
	}
	func_18(-1, 0);
	func_17();
	func_14();
...
void func_33()
{
	...
	{
		if (func_37(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
...
int func_46(var uParam0)
{
	...
	if ((DOES_ENTITY_EXIST(uParam0) && !IS_PED_INJURED(uParam0)) && !IS_ENTITY_DEAD(uParam0, 0))
	{
		if (!IS_ENTITY_OCCLUDED(uParam0) && VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(uParam0, 0)) < 10000f)
		{
			iVar0 = 1;
		}
		if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(uParam0, 0)) < 2500f)
		{
			iVar0 = 1;
		}
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(PLAYER_PED_ID(), uParam0, 1))
		{
			iVar0 = 1;
		}
		if (!IS_PED_INJURED(uLocal_140) && IS_PED_IN_ANY_VEHICLE(uLocal_140, 0))
		{
			if (IS_VEHICLE_DRIVEABLE(GET_VEHICLE_PED_IS_IN(uLocal_140, 0), 0))
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(GET_VEHICLE_PED_IS_IN(uLocal_140, 0), uParam0, 1))
				{
					iVar0 = 1;
				}
			}
			if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0) != GET_VEHICLE_PED_IS_IN(uLocal_140, 0))
			{
				if (IS_VEHICLE_DRIVEABLE(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0))
				{
					if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), uParam0, 1))
					{
						iVar0 = 1;
					}
				}
...
void func_47()
{
	...
	if (!DOES_ENTITY_EXIST(uLocal_415))
	{
		REQUEST_MODEL(joaat("prop_ld_test_01"));
		if (HAS_MODEL_LOADED(joaat("prop_ld_test_01")))
		{
			uLocal_415 = CREATE_OBJECT(joaat("prop_ld_test_01"), GET_ENTITY_COORDS(PLAYER_PED_ID(), 0) + Vector(2f, 0f, 0f), 1, 1, 0);
			SET_ENTITY_COLLISION(uLocal_415, 0, 0);
			SET_ENTITY_VISIBLE(uLocal_415, 0, 0);
			FREEZE_ENTITY_POSITION(uLocal_415, 1);
		}
	}
	DRAW_DEBUG_TEXT_2D("Checking for warp", 0.89f, 0.02f, 0f, 0, 0, 255, 255);
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && IS_VEHICLE_DRIVEABLE(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0))
	{
		uVar0 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
		iVar1 = 0;
		while (iVar1 <= 1)
		{
			if ((IS_VEHICLE_DRIVEABLE(iLocal_156[iVar1], 0) && !IS_PED_INJURED(iLocal_144[iVar1])) && IS_PED_SITTING_IN_VEHICLE(iLocal_144[iVar1], iLocal_156[iVar1]))
			{
				vVar2 = { GET_ENTITY_COORDS(iLocal_156[iVar1], 0) };
				vVar5 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 0) };
				if (VDIST2(vVar5, Local_416[0 /*7*/]) > 400f && VDIST2(vVar5, Local_416[1 /*7*/]) > 400f)
				{
					if (VDIST2(vVar5, Local_416[iVar1 /*7*/]) > 900f)
					{
						if (func_49(iLocal_156[iVar1], uVar0, uLocal_415, vVar5, GET_ENTITY_ROTATION(uVar0, 2)))
						{
							Local_416[iVar1 /*7*/] = { vVar5 };
							Local_416[iVar1 /*7*/].f_3 = { GET_ENTITY_ROTATION(uVar0, 2) };
							Local_416[iVar1 /*7*/].f_6 = VMAG(GET_ENTITY_VELOCITY(iLocal_156[iVar1]));
						}
					}
				}
				if (!func_48(Local_416[iVar1 /*7*/]))
				{
					if (!IS_ENTITY_OCCLUDED(iLocal_156[iVar1]))
					{
						uLocal_434[iVar1] = GET_GAME_TIMER();
					}
					else if (((GET_GAME_TIMER() - uLocal_434[iVar1]) > 1000 && (GET_GAME_TIMER() - uLocal_431[0]) > 2000) && (GET_GAME_TIMER() - uLocal_431[1]) > 2000)
					{
						if (!IS_SPHERE_VISIBLE(Local_416[iVar1 /*7*/], 3f) && !IS_SPHERE_VISIBLE(vVar2, 3f))
						{
							fVar8 = 99f;
							iVar9 = 0;
							if (iVar1 == 0)
							...
							{
								fVar8 = VDIST(GET_ENTITY_COORDS(iLocal_156[iVar9], 0), Local_416[iVar1 /*7*/]);
							}
							if ((((VDIST2(vVar2, vVar5) > 625f && VDIST2(vVar2, Local_416[iVar1 /*7*/]) < VDIST2(vVar2, vVar5)) && VDIST2(vVar5, Local_416[iVar1 /*7*/]) > 400f) && fVar8 > 5f) && func_49(iLocal_156[iVar1], uVar0, uLocal_415, Local_416[iVar1 /*7*/], Local_416[iVar1 /*7*/].f_3))
							{
								CLEAR_AREA_OF_PEDS(Local_416[iVar1 /*7*/], 3f, 0);
								CLEAR_AREA_OF_VEHICLES(Local_416[iVar1 /*7*/], 3f, 0, 0, 0, 0, 0, 0);
								SET_ENTITY_COORDS(iLocal_156[iVar1], Local_416[iVar1 /*7*/], 1, 0, 0, 1);
								SET_ENTITY_ROTATION(iLocal_156[iVar1], Local_416[iVar1 /*7*/].f_3, 2, 1);
								SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_156[iVar1], 1084227584);
								SET_VEHICLE_FORWARD_SPEED(iLocal_156[iVar1], (Local_416[iVar1 /*7*/].f_6 + 5f));
								TASK_VEHICLE_CHASE(iLocal_144[iVar1], PLAYER_PED_ID());
								SET_VEHICLE_ENGINE_ON(iLocal_156[iVar1], 1, 1, 0);
								uLocal_431[iVar1] = GET_GAME_TIMER();
								iLocal_68 = GET_GAME_TIMER() + 1000;
							}
						}
					}
				}
...
int func_49(var uParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6)
{
	...
	{
		GET_MODEL_DIMENSIONS(GET_ENTITY_MODEL(uParam0), &vVar7, &vVar10);
		GET_MODEL_DIMENSIONS(GET_ENTITY_MODEL(uParam1), &vVar13, &uVar16);
...
void func_50()
{
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if (VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), vLocal_56) < 1500f || VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), vLocal_65) < 1500f)
			{
				if (func_51())
				{
					iLocal_73 = 1;
...
int func_51()
{
	...
	{
		if (!IS_PED_INJURED(iLocal_144[0]))
		{
			if (GET_SCRIPT_TASK_STATUS(iLocal_144[0], -1273030092) == 1)
			{
				if (!IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(iLocal_144[0]))
				{
					TASK_DRIVE_BY(iLocal_144[0], PLAYER_PED_ID(), 0, 0f, 0f, 0f, 100f, 100, 1, -753768974);
				}
			}
		}
		if (!IS_PED_INJURED(iLocal_144[1]))
		{
			if (GET_SCRIPT_TASK_STATUS(iLocal_144[1], -1273030092) == 1)
			{
				if (!IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(iLocal_144[1]))
				{
					TASK_DRIVE_BY(iLocal_144[1], PLAYER_PED_ID(), 0, 0f, 0f, 0f, 100f, 100, 1, -753768974);
				}
			}
		}
		return 1;
	...
	else
	{
		...
		if ((HAS_MODEL_LOADED(iLocal_370) && HAS_MODEL_LOADED(iLocal_372)) && HAS_MODEL_LOADED(iLocal_371))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				vVar5 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 0) };
				if (_0xA4822F1CF23F4810(&vVar5, &vVar2, &vVar8, 0, 1127481344, 30f, 0, 1, 1))
				{
					if ((func_52(vVar2) && !IS_SPHERE_VISIBLE(vVar2, 5f)) && VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), vVar2) > 100f)
					{
						iVar11 = 0;
						while (iVar11 < 2)
						{
							CLEAR_AREA(vVar2, 3f, 0, 0, 0, 0);
							vVar2.x = (vVar2.x + TO_FLOAT(iVar11));
							iLocal_156[iVar11] = CREATE_VEHICLE(iLocal_370, vVar2, vVar8.z, 1, 1, 0);
							iLocal_144[iVar11] = CREATE_PED_INSIDE_VEHICLE(iLocal_156[iVar11], 22, iLocal_372, -1, 1, 1);
							iLocal_147[iVar11] = CREATE_PED_INSIDE_VEHICLE(iLocal_156[iVar11], 22, iLocal_371, 0, 1, 1);
							SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_147[iVar11], uLocal_374);
							SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_144[iVar11], uLocal_374);
							if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
							{
								if (IS_VEHICLE_DRIVEABLE(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0))
								{
									TASK_VEHICLE_CHASE(iLocal_144[iVar11], PLAYER_PED_ID());
								}
							}
							else
							{
								TASK_VEHICLE_MISSION_PED_TARGET(iLocal_144[iVar11], iLocal_156[iVar11], PLAYER_PED_ID(), iVar1, 50f, iVar0, 5f, 10f, 1);
							}
							SET_PED_SUFFERS_CRITICAL_HITS(iLocal_144[iVar11], 0);
							SET_PED_SUFFERS_CRITICAL_HITS(iLocal_147[iVar11], 0);
							SET_PED_KEEP_TASK(iLocal_144[iVar11], 1);
							GIVE_WEAPON_TO_PED(iLocal_144[iVar11], joaat("weapon_sawnoffshotgun"), 999999, 1, 1);
							SET_VEHICLE_FORWARD_SPEED(iLocal_156[iVar11], (GET_ENTITY_SPEED(PLAYER_PED_ID()) + 5f));
							iVar1 = 11;
							GIVE_WEAPON_TO_PED(iLocal_147[iVar11], joaat("weapon_sawnoffshotgun"), 999999, 1, 1);
							TASK_DRIVE_BY(iLocal_147[iVar11], PLAYER_PED_ID(), 0, 0f, 0f, 0f, 200f, 70, 0, -753768974);
							SET_PED_KEEP_TASK(iLocal_147[iVar11], 1);
							SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(iLocal_144[iVar11], 1);
							SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(iLocal_147[iVar11], 1);
							SET_PED_CONFIG_FLAG(iLocal_144[iVar11], 42, 1);
							SET_PED_CONFIG_FLAG(iLocal_147[iVar11], 42, 1);
...
int func_52(vector3 vParam0)
{
	...
	vVar0 = { vParam0 - GET_ENTITY_COORDS(PLAYER_PED_ID(), 0) };
	vVar3 = { GET_ENTITY_FORWARD_VECTOR(PLAYER_PED_ID()) };
...
int func_54(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_9(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
void func_55()
{
	if (DOES_BLIP_EXIST(uLocal_139))
	{
		REMOVE_BLIP(&uLocal_139);
	}
}
...
void func_57()
{
	if (func_160() == 2)
	{
		if (!DOES_BLIP_EXIST(uLocal_139))
		{
			...
			SET_BLIP_SPRITE(uLocal_139, 269);
			func_58();
		}
	}
}
...
void func_62()
{
	...
	if (!iLocal_87[0])
	{
		if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(uLocal_140, 0)) < 400f)
		{
	...
	if (!iLocal_90[0])
	{
		if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(uLocal_140, 0)) < 400f && (GET_GAME_TIMER() - iLocal_104) > 30000)
		{
			if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !IS_PED_IN_ANY_VEHICLE(uLocal_140, 0))
			{
				if (IS_VEHICLE_DRIVEABLE(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0))
				{
					if (!func_79(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)))
					{
						iLocal_90[0] = 1;
					}
				}
	...
	if (!iLocal_93[0])
	{
		if (func_11())
		{
			...
			{
				fLocal_102 = (fLocal_102 + GET_FRAME_TIME());
				if (fLocal_102 > 30f)
				{
					iLocal_93[0] = 1;
				}
			...
			{
				fLocal_102 = (fLocal_102 - (GET_FRAME_TIME() * 10f));
			}
		}
	}
	else if (iLocal_93[1])
	...
	if (!iLocal_96[0])
	{
		if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !IS_PED_IN_ANY_VEHICLE(uLocal_140, 0))
		{
			if (!DOES_ENTITY_EXIST(SET_EXCLUSIVE_PHONE_RELATIONSHIPS(PLAYER_PED_ID())))
			{
				fLocal_103 = (fLocal_103 + GET_FRAME_TIME());
				if (fLocal_103 > 15f)
				{
					iLocal_96[0] = 1;
				}
		...
		{
			fLocal_103 = (fLocal_103 - (GET_FRAME_TIME() * 10f));
		}
	}
	if ((((!iLocal_93[0] || (iLocal_93[0] && iLocal_93[1])) && (!iLocal_87[0] || (iLocal_87[0] && iLocal_87[1]))) && (!iLocal_90[0] || (iLocal_90[0] && iLocal_90[1]))) && (!iLocal_96[0] || (iLocal_96[0] && iLocal_96[1])))
	{
		switch (iLocal_390)
		{
			...
			case 1:
				if ((GET_GAME_TIMER() - iLocal_389) > 15000)
				{
					switch (iLocal_388)
					{
						case 0:
			...
			case 5:
				...
				{
					if (!IS_PED_RUNNING_MOBILE_PHONE_TASK(uLocal_140))
					{
						TASK_USE_MOBILE_PHONE(uLocal_140, 1, 1);
					}
				}
				else if (IS_PED_RUNNING_MOBILE_PHONE_TASK(uLocal_140))
				{
					TASK_USE_MOBILE_PHONE(uLocal_140, 0, 1);
				}
				switch (iLocal_388)
				{
					case 0:
						if ((GET_GAME_TIMER() - iLocal_389) > 10000)
						{
							if (func_11())
							{
								if (func_159(&uLocal_176, cLocal_387, "RESNA_CELL1", 8, 0, 0, 0))
								{
									SET_PED_CAN_PLAY_GESTURE_ANIMS(uLocal_140, 0);
									SET_PED_CAN_PLAY_AMBIENT_ANIMS(uLocal_140, 0);
									SET_PED_CAN_PLAY_VISEME_ANIMS(uLocal_140, 0, 0);
									iLocal_388++;
								}
							}
						}
					...
					case 3:
						if ((GET_GAME_TIMER() - iLocal_389) > 2000)
						{
							if (func_11() && !_0xA3F3564A5B3646C0(uLocal_140))
							{
								if (func_78("RESNA_CELLR", 0))
								{
									SET_PED_CAN_PLAY_GESTURE_ANIMS(uLocal_140, 1);
									SET_PED_CAN_PLAY_AMBIENT_ANIMS(uLocal_140, 1);
									SET_PED_CAN_PLAY_VISEME_ANIMS(uLocal_140, 1, 0);
									iLocal_388++;
								}
							}
						}
			...
			case 6:
				if (func_160() == 2 && (GET_GAME_TIMER() - iLocal_389) > 15000)
				{
					switch (iLocal_388)
					{
						case 0:
						...
						case 4:
							if (func_82(vLocal_56) && VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), vLocal_65) < 250f)
							{
								iLocal_388++;
							}
							break;
	...
	else
	{
		...
		{
			if ((IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !IS_PED_IN_ANY_VEHICLE(uLocal_140, 0)) && IS_VEHICLE_DRIVEABLE(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0))
			{
				uVar7 = GET_ENTITY_MODEL(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0));
				if ((IS_THIS_MODEL_A_BIKE(uVar7) || IS_THIS_MODEL_A_BICYCLE(uVar7)) || IS_THIS_MODEL_A_QUADBIKE(uVar7))
				{
					sVar6 = "RESNA_VEH1";
				}
				else
...
int func_65(char* sParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		if ((iLocal_376 && !iLocal_377) && bParam1)
		{
			...
			else if ((GET_GAME_TIMER() - iLocal_384) > 500)
			{
				iLocal_384 = -1;
				iLocal_376 = 0;
				iLocal_377 = 0;
...
void func_85()
{
	...
	vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_155, 0f, -6f, 0f) };
	if (IS_VEHICLE_DRIVEABLE(GET_PLAYERS_LAST_VEHICLE(), 0))
	{
		if (IS_ENTITY_AT_COORD(GET_PLAYERS_LAST_VEHICLE(), vVar0, 5f, 5f, 5f, 0, 1, 0))
		{
			GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), iLocal_3, &vVar3, &uVar6, &uVar7, 1, 1077936128, 0);
			SET_ENTITY_HEADING(GET_PLAYERS_LAST_VEHICLE(), uVar6);
			SET_ENTITY_COORDS(GET_PLAYERS_LAST_VEHICLE(), vVar3, 1, 0, 0, 1);
		}
	}
}
...
int func_86(var uParam0)
{
	...
	iVar0 = 0;
	if (DOES_ENTITY_EXIST(uParam0) && DOES_ENTITY_EXIST(uLocal_155))
	{
		uVar1 = uParam0;
		GET_MODEL_DIMENSIONS(GET_ENTITY_MODEL(uVar1), &vVar2, &vVar5);
		vVar8 = { vVar5 - vVar2 };
		vVar11[0 /*3*/] = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uVar1, (-vVar8.x / 2f), (vVar8.y / 2f), 0f) };
		vVar11[1 /*3*/] = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uVar1, (vVar8.x / 2f), (vVar8.y / 2f), 0f) };
		vVar11[2 /*3*/] = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uVar1, (vVar8.x / 2f), (-vVar8.y / 2f), 0f) };
		vVar11[3 /*3*/] = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uVar1, (-vVar8.x / 2f), (-vVar8.y / 2f), 0f) };
		vVar24[0 /*3*/] = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_155, -1f, -2.5f, 0f) };
		vVar24[1 /*3*/] = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_155, 1f, -2.5f, 0f) };
		vVar24[2 /*3*/] = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_155, 0.75f, -5f, 0f) };
		vVar24[3 /*3*/] = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_155, -0.75f, -5f, 0f) };
		iVar50 = 0;
...
void func_90(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		uParam0->f_14 = CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 0);
		SET_CAM_COORD(uParam0->f_14, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam1, *uParam0));
		if (uParam0->f_18 == 1)
		{
			ATTACH_CAM_TO_ENTITY(uParam0->f_14, uParam1, *uParam0, 1);
		}
		if (bParam2)
		{
		...
		{
			vVar0 = { func_93(GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam1, uParam0->f_3), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam1, *uParam0)) };
			vVar3 = { func_91(vVar0) };
			SET_CAM_ROT(uParam0->f_14, vVar3, 2);
		}
		SET_CAM_FOV(uParam0->f_14, uParam0->f_12);
		SET_CAM_ACTIVE(uParam0->f_14, 1);
	}
}
...
void func_94(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_98(PLAYER_ID())) && !func_96(PLAYER_ID(), 0)) && !func_95()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_98(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
...
void func_104()
{
	...
	if (IS_PED_INJURED(uLocal_143))
	{
		if (DOES_BLIP_EXIST(uLocal_124))
		{
			REMOVE_BLIP(&uLocal_124);
		}
		iVar0++;
	}
	if (!IS_PED_INJURED(uLocal_140))
	{
		if (GET_GAME_TIMER() > iLocal_86 + 8000)
		{
...
{
	_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_106(iParam2), 1);
}
...
void func_107()
{
	...
	if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_59, 10f, 10f, 10f, 0, 1, 0))
	{
		iVar0 = 0;
		while (iVar0 < 4)
		{
			uLocal_150[iVar0] = CREATE_PED(22, iLocal_371, vVar1[iVar0 /*3*/], 0, 1, 1);
			GIVE_WEAPON_TO_PED(uLocal_150[iVar0], joaat("weapon_sawnoffshotgun"), 999999, 1, 1);
			SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_150[iVar0], uLocal_374);
			TASK_COMBAT_PED(uLocal_150[iVar0], PLAYER_PED_ID(), 0, 16);
			SET_PED_CONFIG_FLAG(uLocal_150[iVar0], 42, 1);
...
void func_108()
{
	...
	while (iVar0 < 4)
	{
		if (IS_PED_INJURED(uLocal_150[iVar0]))
		{
...
int func_111()
{
	...
	else if (IS_PED_ON_FOOT(uLocal_142))
	{
		return 1;
	}
	if (IS_PED_INJURED(uLocal_141))
...
int func_112()
{
	if (IS_VEHICLE_DRIVEABLE(uLocal_155, 0))
	{
		if (IS_ENTITY_AT_COORD(uLocal_155, vLocal_59, 10f, 10f, 10f, 0, 1, 0))
		{
			bLocal_74 = true;
			return 1;
		}
...
int func_113()
{
	if (IS_VEHICLE_DRIVEABLE(uLocal_155, 0))
	{
		...
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_155, 20f, 20f, 10f, 0, 1, 0))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_155, PLAYER_PED_ID(), 1))
			{
				if (iLocal_438 == -1)
				{
					iLocal_438 = GET_GAME_TIMER();
				}
				iLocal_84++;
				CLEAR_ENTITY_LAST_DAMAGE_ENTITY(uLocal_155);
				if (TIMERA() > 10000)
				{
					...
					else if (!IS_PED_INJURED(uLocal_142))
					{
		...
		if (IS_VEHICLE_STUCK_ON_ROOF(uLocal_155))
		{
			return 1;
		}
	}
...
void func_114()
{
	if (!IS_PED_INJURED(uLocal_142))
	{
		if (IS_PED_IN_ANY_VEHICLE(uLocal_142, 0))
		{
			if (!IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(uLocal_142))
			{
				if (!HAS_PED_GOT_WEAPON(uLocal_142, joaat("weapon_microsmg"), 0) || (HAS_PED_GOT_WEAPON(uLocal_142, joaat("weapon_microsmg"), 0) && GET_PED_AMMO_BY_TYPE(uLocal_142, joaat("ammo_shotgun")) == 0))
				{
					GIVE_WEAPON_TO_PED(uLocal_142, joaat("weapon_microsmg"), 68, 1, 1);
				}
				else
				{
					SET_CURRENT_PED_WEAPON(uLocal_142, joaat("weapon_microsmg"), 1);
				}
				TASK_DRIVE_BY(uLocal_142, PLAYER_PED_ID(), 0, 0f, 0f, 0f, 100f, 100, 1, -753768974);
			}
		}
	}
	if ((GET_GAME_TIMER() - iLocal_438) > 250)
	{
		if (!IS_PED_INJURED(uLocal_141))
		{
			if ((IS_PED_IN_ANY_VEHICLE(uLocal_141, 0) && GET_SCRIPT_TASK_STATUS(uLocal_141, 2104565373) != 1) && GET_SCRIPT_TASK_STATUS(uLocal_141, 2104565373) != 0)
			{
				CLEAR_PED_TASKS(uLocal_141);
				GIVE_WEAPON_TO_PED(uLocal_141, joaat("weapon_microsmg"), 68, 1, 1);
				TASK_DRIVE_BY(uLocal_141, PLAYER_PED_ID(), 0, 0f, 0f, 0f, 100f, 100, 0, -753768974);
			}
		}
	}
	if (!IS_PED_INJURED(uLocal_143))
	{
		if ((IS_PED_IN_ANY_VEHICLE(uLocal_143, 0) && GET_SCRIPT_TASK_STATUS(uLocal_143, 2104565373) != 1) && GET_SCRIPT_TASK_STATUS(uLocal_143, 2104565373) != 0)
		{
			CLEAR_PED_TASKS(uLocal_143);
			GIVE_WEAPON_TO_PED(uLocal_143, joaat("weapon_pistol"), 68, 1, 1);
			TASK_DRIVE_BY(uLocal_143, PLAYER_PED_ID(), 0, 0f, 0f, 0f, 100f, 100, 0, -753768974);
			SET_PED_KEEP_TASK(uLocal_143, 1);
		}
	}
	if (!iLocal_366)
	{
...
int func_115()
{
	if (IS_VEHICLE_DRIVEABLE(uLocal_155, 0))
	{
		if (GET_VEHICLE_ENGINE_HEALTH(uLocal_155) < 700f || GET_VEHICLE_PETROL_TANK_HEALTH(uLocal_155) < 700f)
		{
			return 1;
		}
	}
...
int func_116()
{
	if (IS_VEHICLE_DRIVEABLE(uLocal_155, 0))
	{
		if (((IS_VEHICLE_TYRE_BURST(uLocal_155, 0, 0) || IS_VEHICLE_TYRE_BURST(uLocal_155, 1, 0)) || IS_VEHICLE_TYRE_BURST(uLocal_155, 4, 0)) || IS_VEHICLE_TYRE_BURST(uLocal_155, 5, 0))
		{
			return 1;
		}
	}
...
void func_121(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_146(uParam1) && IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
...
int func_125(char* sParam0)
{
	if (!func_126(1, 1, 0))
	{
		if ((!IS_STRING_NULL_OR_EMPTY(sParam0) && func_110(sParam0)) || func_110("CMN_HINT"))
		{
			CLEAR_HELP(1);
		}
		return 0;
...
int func_126(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_134() || func_133(Global_4456448.f_161209)) || func_132())
	{
		...
		{
			uVar0 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
			iVar1 = func_131(PLAYER_PED_ID(), 0);
			if (((_0xE33FFA906CE74880(uVar0, iVar1) || (GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_130(uVar0, 10)) && GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_127(int iParam0)
{
	if (iParam0 != func_129())
	{
		...
		else if ((Global_1312867 && iParam0 == PLAYER_ID()) && func_128(iParam0, 1, 0))
		{
			return Global_2424047[iParam0 /*416*/].f_309.f_5 != -1;
		}
	}
...
int func_141(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_144(bParam1, bParam2, bParam3) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1) || func_142(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_148()
{
	if (!IS_PED_INJURED(uLocal_143) && IS_VEHICLE_DRIVEABLE(uLocal_155, 0))
	{
		if (!IS_PED_IN_VEHICLE(uLocal_143, uLocal_155, 0))
		{
			if (!IS_ENTITY_PLAYING_ANIM(uLocal_155, sLocal_386, "IG_1_ALT1_EXIT_VAN_BURR", 3))
			{
				SET_PED_INTO_VEHICLE(uLocal_143, uLocal_155, 1);
			}
		}
	}
}
...
void func_149()
{
	if (!IS_PED_INJURED(uLocal_142))
	{
		TASK_COMBAT_PED(uLocal_142, PLAYER_PED_ID(), 0, 16);
		SET_PED_KEEP_TASK(uLocal_142, 1);
		func_159(&uLocal_176, cLocal_387, "RESNA_ATT", 4, 0, 0, 0);
	}
	if (!IS_PED_INJURED(uLocal_141))
	{
		GIVE_WEAPON_TO_PED(uLocal_141, joaat("weapon_smg"), 68, 1, 1);
		SET_CURRENT_PED_WEAPON(uLocal_141, joaat("weapon_smg"), 1);
		SET_PED_CAN_BE_TARGETTED(uLocal_141, 1);
		TASK_COMBAT_PED(uLocal_141, PLAYER_PED_ID(), 0, 16);
		SET_PED_KEEP_TASK(uLocal_141, 1);
	}
	if (!IS_PED_INJURED(uLocal_143))
	{
		GIVE_WEAPON_TO_PED(uLocal_143, joaat("weapon_pistol"), 68, 1, 1);
		SET_CURRENT_PED_WEAPON(uLocal_143, joaat("weapon_pistol"), 1);
		TASK_COMBAT_PED(uLocal_143, PLAYER_PED_ID(), 0, 16);
		SET_PED_KEEP_TASK(uLocal_143, 1);
	}
	func_150();
	CLEAR_SEQUENCE_TASK(&uLocal_159);
...
void func_150()
{
	...
	if (!IS_PED_INJURED(uLocal_141))
	{
		if (IS_ENTITY_AT_ENTITY(uLocal_141, PLAYER_PED_ID(), 100f, 100f, 20f, 0, 1, 0))
		{
			if (!DOES_BLIP_EXIST(uLocal_121))
			{
	...
	if (!IS_PED_INJURED(uLocal_143))
	{
		if (IS_ENTITY_AT_ENTITY(uLocal_143, PLAYER_PED_ID(), 100f, 100f, 20f, 0, 1, 0))
		{
			if (!DOES_BLIP_EXIST(uLocal_124))
			{
...
void func_151()
{
	...
	else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_141, PLAYER_PED_ID(), 1))
	{
		bVar0 = true;
	}
	if (IS_PED_INJURED(uLocal_142))
	...
	else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_142, PLAYER_PED_ID(), 1))
	{
		bVar0 = true;
	}
	if (IS_PED_INJURED(uLocal_143))
	...
	else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_143, PLAYER_PED_ID(), 1))
	{
		bVar0 = true;
	}
	if (IS_PED_INJURED(uLocal_140))
	...
	else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_140, PLAYER_PED_ID(), 1))
	{
		bVar0 = true;
	}
	if (bVar0)
	{
		...
		if (iLocal_365)
		{
			if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_107))
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_107) > 0.735f)
				{
					func_156();
				}
				else if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_107) > 0.4f)
				{
					func_155();
				}
			}
		...
		else
		{
			if (!IS_PED_INJURED(uLocal_142))
			{
				if (IS_VEHICLE_DRIVEABLE(uLocal_155, 0))
				{
					TASK_VEHICLE_MISSION_PED_TARGET(uLocal_142, uLocal_155, PLAYER_PED_ID(), 8, 40f, 786469, -1f, -1f, 1);
				}
				else
				{
					TASK_SMART_FLEE_PED(uLocal_142, PLAYER_PED_ID(), 150f, -1, 0, 0);
					SET_PED_KEEP_TASK(uLocal_142, 1);
				}
			}
			func_152();
...
void func_152()
{
	if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_106))
	{
		DETACH_SYNCHRONIZED_SCENE(uLocal_106);
	}
	if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_107))
	{
		DETACH_SYNCHRONIZED_SCENE(uLocal_107);
	}
	if (!IS_PED_INJURED(uLocal_140))
	{
		SET_PED_SUFFERS_CRITICAL_HITS(uLocal_140, 1);
		if (!IS_ENTITY_PLAYING_ANIM(uLocal_140, sLocal_386, "IG_1_ALT1_GIRL_IN_VAN_LOOP", 3))
		{
			TASK_SMART_FLEE_PED(uLocal_140, PLAYER_PED_ID(), 150f, -1, 0, 0);
			SET_PED_KEEP_TASK(uLocal_140, 1);
		}
	}
	func_149();
...
void func_155()
{
	if (IS_VEHICLE_DRIVEABLE(uLocal_155, 0) && !IS_PED_INJURED(uLocal_140))
	{
		ATTACH_ENTITY_TO_ENTITY(uLocal_140, uLocal_155, GET_ENTITY_BONE_INDEX_BY_NAME(uLocal_155, sLocal_175), 0.421191f, -1.99042f, 0.20134f, -5.08056E-06f, -6.5249E-06f, 174.612f, 1, 0, 0, 0, 2, 1);
		SET_ENTITY_COORDS(uLocal_140, GET_ENTITY_COORDS(uLocal_155, 0), 1, 0, 0, 1);
		CLEAR_PED_TASKS_IMMEDIATELY(uLocal_140);
		TASK_PLAY_ANIM(uLocal_140, sLocal_386, "IG_1_ALT1_GIRL_IN_VAN_LOOP", 1000f, -1000f, -1, 9, 0, 0, 0, 0);
		SET_PED_KEEP_TASK(uLocal_140, 1);
		if (!DOES_BLIP_EXIST(uLocal_123))
		{
			uLocal_123 = func_170(uLocal_142, 1, 0);
		...
		if (IS_VEHICLE_DRIVEABLE(uLocal_155, 0))
		{
			SET_VEHICLE_DOORS_SHUT(uLocal_155, 1);
		}
		iLocal_365 = 0;
	}
}
...
void func_156()
{
	if (((IS_VEHICLE_DRIVEABLE(uLocal_155, 0) && !IS_PED_INJURED(uLocal_140)) && !IS_PED_INJURED(uLocal_141)) && !IS_PED_INJURED(uLocal_143))
	{
		SET_PED_INTO_VEHICLE(uLocal_143, uLocal_155, 2);
		SET_PED_INTO_VEHICLE(uLocal_141, uLocal_155, 1);
		ATTACH_ENTITY_TO_ENTITY(uLocal_140, uLocal_155, GET_ENTITY_BONE_INDEX_BY_NAME(uLocal_155, sLocal_175), 0.421191f, -1.99042f, 0.20134f, -5.08056E-06f, -6.5249E-06f, 174.612f, 1, 0, 0, 0, 2, 1);
		SET_ENTITY_COORDS(uLocal_140, GET_ENTITY_COORDS(uLocal_155, 0), 1, 0, 0, 1);
		CLEAR_PED_TASKS_IMMEDIATELY(uLocal_140);
		TASK_PLAY_ANIM(uLocal_140, sLocal_386, "IG_1_ALT1_GIRL_IN_VAN_LOOP", 1000f, -1000f, -1, 9, 0, 0, 0, 0);
		...
		if (IS_VEHICLE_DRIVEABLE(uLocal_155, 0))
		{
			SET_VEHICLE_DOORS_SHUT(uLocal_155, 0);
		}
		_0xAF66DCEE6609B148();
		iLocal_365 = 0;
	}
...
void func_157()
{
	if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_118))
	{
		if (!IS_PED_INJURED(uLocal_141))
		{
			CLEAR_PED_TASKS(uLocal_141);
		...
		STOP_SYNCHRONIZED_ENTITY_ANIM(uLocal_155, -4f, 1);
	}
}
...
void func_158()
{
	if (!IS_PED_INJURED(uLocal_140))
	{
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_140, PLAYER_PED_ID(), 1) || IS_ENTITY_ON_FIRE(uLocal_140))
		{
			if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_118))
			{
				func_157();
...
int func_164()
{
	switch (func_165(&Global_25824, 0, 5, 0, GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_172()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		if (VMAG2(GET_ENTITY_VELOCITY(PLAYER_PED_ID())) > 1369f && !func_183())
		{
			return 0;
		}
	}
...
int func_184()
{
	...
	func_190(44, 1);
	fLocal_55 = 321f;
	SET_PED_MODEL_IS_SUPPRESSED(iLocal_372, 1);
	SET_PED_MODEL_IS_SUPPRESSED(iLocal_373, 1);
	SET_PED_MODEL_IS_SUPPRESSED(iLocal_371, 1);
	SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_369, 1);
	REQUEST_MODEL(iLocal_373);
	REQUEST_MODEL(iLocal_371);
	REQUEST_MODEL(iLocal_372);
	REQUEST_MODEL(iLocal_369);
	REQUEST_ANIM_DICT(sLocal_386);
	REQUEST_MODEL(joaat("prop_ld_test_01"));
	if (((((HAS_MODEL_LOADED(iLocal_373) && HAS_MODEL_LOADED(iLocal_371)) && HAS_MODEL_LOADED(iLocal_372)) && HAS_MODEL_LOADED(iLocal_369)) && HAS_MODEL_LOADED(joaat("prop_ld_test_01"))) && HAS_ANIM_DICT_LOADED(sLocal_386))
	{
		func_189();
		func_188();
		func_187();
		func_186();
		ADD_SHOCKING_EVENT_AT_POSITION(109, vLocal_52, -1082130432);
		uLocal_162 = ADD_SCENARIO_BLOCKING_AREA(vLocal_59 - Vector(50f, 50f, 50f), vLocal_59 + Vector(50f, 50f, 50f), 0, 1, 1, 1);
		switch (func_160())
		{
			case 0:
				sLocal_174 = "MICHAEL";
		...
		func_185(&uLocal_176, 0, PLAYER_PED_ID(), sLocal_174, 0, 1);
		vLocal_165 = { -3057.362f, 441.8271f, 6.151212f };
		vLocal_168 = { -0.34992f, -0.199749f, -98.79861f };
		fLocal_359 = 116f;
		vLocal_56 = { -3053.721f, 440.9221f, 5.3566f };
		uLocal_164 = CREATE_OBJECT(joaat("prop_ld_test_01"), GET_ENTITY_COORDS(uLocal_155, 0), 1, 1, 0);
		SET_ENTITY_ROTATION(uLocal_164, GET_ENTITY_ROTATION(uLocal_155, 2), 2, 1);
		FREEZE_ENTITY_POSITION(uLocal_164, 1);
		SET_ENTITY_COLLISION(uLocal_164, 0, 0);
		return 1;
	}
	return 0;
}
...
void func_186()
{
	SET_PED_CAN_BE_TARGETTED(uLocal_141, 0);
	SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_155, 1);
	SET_VEHICLE_DOORS_LOCKED(uLocal_155, 3);
	SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_142, uLocal_374);
	SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_143, uLocal_374);
	SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_141, uLocal_374);
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_143, 1);
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_142, 1);
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_141, 1);
	SET_PED_CONFIG_FLAG(uLocal_142, 42, 1);
	SET_PED_CONFIG_FLAG(uLocal_141, 42, 1);
	SET_PED_CONFIG_FLAG(uLocal_143, 42, 1);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_143, 17, 0);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_143, 1, 0);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_143, 13, 1);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_143, 50, 1);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_141, 2, 1);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_142, 17, 0);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_142, 1, 0);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_142, 13, 1);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_142, 50, 1);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_142, 6, 0);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_141, 2, 1);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_141, 17, 0);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_141, 1, 0);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_141, 13, 1);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_141, 50, 1);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_141, 2, 1);
	SET_PED_COMBAT_MOVEMENT(uLocal_143, 2);
	SET_PED_COMBAT_MOVEMENT(uLocal_142, 2);
	SET_PED_COMBAT_MOVEMENT(uLocal_141, 2);
	SET_PED_SUFFERS_CRITICAL_HITS(uLocal_143, 0);
	SET_PED_SUFFERS_CRITICAL_HITS(uLocal_142, 0);
	SET_PED_SUFFERS_CRITICAL_HITS(uLocal_141, 0);
	GIVE_WEAPON_TO_PED(uLocal_143, joaat("weapon_pistol"), 68, 0, 1);
	GIVE_WEAPON_TO_PED(uLocal_142, joaat("weapon_sawnoffshotgun"), 68, 0, 1);
	GIVE_WEAPON_TO_PED(uLocal_141, joaat("weapon_microsmg"), 68, 0, 1);
	SET_PED_DIES_IN_VEHICLE(uLocal_143, 0);
	SET_PED_DIES_IN_VEHICLE(uLocal_142, 0);
	SET_PED_DIES_IN_VEHICLE(uLocal_141, 0);
	SET_PED_CONFIG_FLAG(uLocal_142, 115, 1);
	SET_PED_CONFIG_FLAG(uLocal_141, 115, 1);
	SET_PED_CONFIG_FLAG(uLocal_143, 115, 1);
...
void func_187()
{
	...
	if (IS_VEHICLE_DRIVEABLE(uLocal_155, 0))
	{
		uLocal_140 = CREATE_PED(5, iLocal_373, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_155, vLocal_353), fLocal_55, 1, 1);
	}
	else
	{
		uLocal_140 = CREATE_PED(5, iLocal_373, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PLAYER_PED_ID(), vLocal_353), fLocal_55, 1, 1);
	}
	SET_AMBIENT_VOICE_NAME(uLocal_140, "LostKidnapGirl");
	SET_PED_CAN_BE_TARGETTED(uLocal_140, 0);
	SET_PED_SUFFERS_CRITICAL_HITS(uLocal_140, 0);
	SET_ENTITY_HEALTH(uLocal_140, iVar0, 0);
	SET_PED_MAX_HEALTH(uLocal_140, iVar0);
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_140, 1);
	SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_140, uLocal_375);
...
void func_188()
{
	...
	{
		uLocal_155 = CREATE_VEHICLE(iLocal_369, -1116.946f, 560.8027f, 101.3588f, 116.0592f, 1, 1, 0);
		vLocal_62 = { -1247.233f, 515.3996f, 94.1352f };
	}
	else
	{
		uLocal_155 = CREATE_VEHICLE(iLocal_369, vLocal_52, 305f, 1, 1, 0);
		vLocal_62 = { -852.9832f, 441.7806f, 86.0437f };
	}
	ADD_VEHICLE_UPSIDEDOWN_CHECK(uLocal_155);
	SET_VEHICLE_ENGINE_ON(uLocal_155, 1, 1, 0);
	uLocal_142 = CREATE_PED_INSIDE_VEHICLE(uLocal_155, 22, iLocal_372, -1, 1, 1);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_142, 2, 1);
	GIVE_WEAPON_TO_PED(uLocal_142, joaat("weapon_sawnoffshotgun"), 68, 1, 1);
	SET_CURRENT_PED_WEAPON(uLocal_142, joaat("weapon_sawnoffshotgun"), 1);
	uLocal_143 = CREATE_PED(22, iLocal_372, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_155, vLocal_356), fLocal_55, 1, 1);
	uLocal_141 = CREATE_PED(22, iLocal_371, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_155, vLocal_356), fLocal_55, 1, 1);
	FREEZE_ENTITY_POSITION(uLocal_155, 1);
	iLocal_82 = 1;
	SET_PED_SHOOT_RATE(uLocal_141, 25);
	SET_PED_FIRING_PATTERN(uLocal_141, -753768974);
	SET_PED_SHOOT_RATE(uLocal_143, 35);
	SET_PED_FIRING_PATTERN(uLocal_141, 1566631136);
	SET_PED_ACCURACY(uLocal_142, 12);
	SET_PED_ACCURACY(uLocal_143, 10);
	SET_PED_ACCURACY(uLocal_141, 15);
	SET_VEHICLE_TYRES_CAN_BURST(uLocal_155, 0);
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_372);
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_371);
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_369);
	SET_VEHICLE_AUTOMATICALLY_ATTACHES(uLocal_155, 0, 0);
	SET_VEHICLE_LOD_MULTIPLIER(uLocal_155, 2f);
}

void func_189()
{
	ADD_RELATIONSHIP_GROUP("re_snatched badGuys", &uLocal_374);
	ADD_RELATIONSHIP_GROUP("re_snatched pedVictim", &uLocal_375);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_374, 1862763509);
	SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_374, uLocal_375);
	SET_RELATIONSHIP_BETWEEN_GROUPS(0, uLocal_375, 1862763509);
}
...
int func_197(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_22() == 0)
		{
			return IS_BIT_SET(func_194(func_195(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_198()
{
	...
	if (((DOES_ENTITY_EXIST(uLocal_141) && DOES_ENTITY_EXIST(uLocal_143)) && DOES_ENTITY_EXIST(uLocal_140)) && DOES_ENTITY_EXIST(uLocal_155))
	{
		...
		if (HAS_ANIM_DICT_LOADED("random@kidnap_girl"))
		{
			...
			switch (iLocal_439)
			{
				case 0:
					if (((IS_VEHICLE_DRIVEABLE(uLocal_155, 0) && !IS_PED_INJURED(uLocal_140)) && !IS_PED_INJURED(uLocal_141)) && !IS_PED_INJURED(uLocal_143))
					{
						if (!IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_117))
						{
							vLocal_110 = { 0f, 0f, 0f };
							vLocal_113 = { 0f, 0f, 0f };
							uLocal_117 = CREATE_SYNCHRONIZED_SCENE(vLocal_110, vLocal_113, 2);
							ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_117, uLocal_155, GET_ENTITY_BONE_INDEX_BY_NAME(uLocal_155, sLocal_175));
							SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_117, 1);
							SET_SYNCHRONIZED_SCENE_ORIGIN(uLocal_117, vLocal_110, vLocal_113, 2);
							TASK_SYNCHRONIZED_SCENE(uLocal_140, uLocal_117, sLocal_386, "IG_1_GIRL_ON_PHONE_LOOP", 1000f, -1000f, 4, 0, 1148846080, 0);
							TASK_SYNCHRONIZED_SCENE(uLocal_141, uLocal_117, sLocal_386, "IG_1_GUY1_IN_VAN_LOOP", 1000f, -1000f, 4, 0, 1148846080, 0);
							TASK_SYNCHRONIZED_SCENE(uLocal_143, uLocal_117, sLocal_386, "IG_1_GUY2_IN_VAN_LOOP", 1000f, -1000f, 4, 0, 1148846080, 0);
							SET_PED_CAN_RAGDOLL(uLocal_140, 1);
						}
						else
						{
				...
				case 1:
					if ((!IS_PED_INJURED(uLocal_140) && !IS_PED_INJURED(uLocal_141)) && !IS_PED_INJURED(uLocal_143))
					{
						if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_117))
						{
							CLEAR_PED_TASKS(uLocal_141);
						...
						if (!IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_118))
						{
							...
							{
								vLocal_110 = { 0f, 0f, 0f };
								vLocal_113 = { GET_ENTITY_ROTATION(uLocal_155, 2) };
								uLocal_118 = CREATE_SYNCHRONIZED_SCENE(GET_ENTITY_COORDS(uLocal_155, 0), vLocal_113.x, vLocal_113.y, GET_ENTITY_HEADING(uLocal_155), 2);
								if (iLocal_82)
								{
									FREEZE_ENTITY_POSITION(uLocal_155, 0);
									iLocal_82 = 0;
								}
								SET_SYNCHRONIZED_SCENE_RATE(uLocal_118, fVar0);
								TASK_SYNCHRONIZED_SCENE(uLocal_140, uLocal_118, sLocal_386, "IG_1_GIRL_DRAG_INTO_VAN", 1000f, -4f, 5, 0, 1148846080, 0);
								TASK_SYNCHRONIZED_SCENE(uLocal_141, uLocal_118, sLocal_386, "IG_1_GUY1_DRAG_INTO_VAN", 1000f, -4f, 5, 0, 1148846080, 0);
								TASK_SYNCHRONIZED_SCENE(uLocal_143, uLocal_118, sLocal_386, "IG_1_GUY2_DRAG_INTO_VAN", 1000f, -4f, 5, 0, 1148846080, 0);
								PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_155, uLocal_118, "DRAG_INTO_VAN_BURR", sLocal_386, 1000f, -4f, 1, 1148846080);
							}
						}
						else
						{
							if (!iLocal_80)
							{
								if ((((IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_118) && VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(uLocal_155, 0)) < 30f) && !func_84()) && GET_SYNCHRONIZED_SCENE_PHASE(uLocal_118) > 0.1f) && GET_SYNCHRONIZED_SCENE_PHASE(uLocal_118) < 0.4f)
								{
							...
							if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_118) > 0.502f)
							{
								SET_ENTITY_INVINCIBLE(uLocal_140, 1);
								SET_ENTITY_INVINCIBLE(uLocal_141, 1);
								SET_ENTITY_INVINCIBLE(uLocal_143, 1);
								if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_118) < 0.732f)
								{
									if (!IS_ENTITY_ATTACHED(uLocal_155))
									{
										SET_PED_CAN_RAGDOLL(uLocal_141, 0);
										SET_PED_CAN_RAGDOLL(uLocal_143, 0);
										if (!IS_PED_INJURED(uLocal_142) && IS_VEHICLE_DRIVEABLE(uLocal_155, 0))
										{
											TASK_VEHICLE_TEMP_ACTION(uLocal_142, uLocal_155, 30, 6000);
										}
										SET_ENTITY_INVINCIBLE(uLocal_140, 1);
										SET_PED_CONFIG_FLAG(uLocal_140, 106, 1);
										SET_PED_CONFIG_FLAG(uLocal_141, 106, 1);
										SET_PED_CONFIG_FLAG(uLocal_143, 106, 1);
									}
									if (IS_ENTITY_DEAD(uLocal_155, 0))
									{
										func_157();
										if (DOES_ENTITY_EXIST(uLocal_140))
										{
											SET_ENTITY_HEALTH(uLocal_140, 0, 0);
										}
										if (DOES_ENTITY_EXIST(uLocal_143))
										{
											SET_ENTITY_HEALTH(uLocal_143, 0, 0);
										}
										if (DOES_ENTITY_EXIST(uLocal_141))
										{
											SET_ENTITY_HEALTH(uLocal_141, 0, 0);
										}
										if (DOES_ENTITY_EXIST(uLocal_142))
										{
											SET_ENTITY_HEALTH(uLocal_142, 0, 0);
										}
										DETACH_ENTITY(uLocal_155, 1, 0);
									}
								}
								else
								{
									SET_PED_CAN_RAGDOLL(uLocal_141, 1);
									SET_PED_CAN_RAGDOLL(uLocal_143, 1);
									SET_PED_CONFIG_FLAG(uLocal_140, 106, 0);
									SET_PED_CONFIG_FLAG(uLocal_141, 106, 0);
									SET_PED_CONFIG_FLAG(uLocal_143, 106, 0);
									SET_ENTITY_INVINCIBLE(uLocal_141, 0);
									SET_ENTITY_INVINCIBLE(uLocal_143, 0);
									func_157();
									func_156();
									iLocal_439 = 3;
									SETTIMERB(0);
...
int func_199()
{
	...
	vVar0 = { 10f, 10f, 3f };
	vVar3 = { -10f, -10f, -3f };
	if (IS_BULLET_IN_AREA(GET_PED_BONE_COORDS(uLocal_140, 31086, 0f, 0f, 0f), 15f, 1))
	{
		return 1;
	}
	vVar0 = { vVar0 + GET_PED_BONE_COORDS(uLocal_140, 31086, 0f, 0f, 0f) };
	vVar3 = { vVar3 + GET_PED_BONE_COORDS(uLocal_140, 31086, 0f, 0f, 0f) };
	...
	if (IS_ENTITY_ON_FIRE(uLocal_140))
	{
		return 1;
	}
	return 0;
...
int func_200()
{
	...
	if (!IS_PED_INJURED(uLocal_140))
	{
		if (IS_ENTITY_AT_ENTITY(uLocal_140, PLAYER_PED_ID(), vVar1, 0, 1, 0))
		{
			iVar0 = 0;
		}
		else
...
int func_203()
{
	if ((Global_106554 == func_41() && GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
{
	CLEAR_AREA(vLocal_171, 15f, 1, 0, 0, 0);
	CLEAR_AREA(-1133.993f, 558.3267f, 107.351f, 5f, 1, 0, 0, 0);
	if (bParam0)
	{
		uLocal_414 = ADD_SCENARIO_BLOCKING_AREA(Vector(104.0503f, 560.4913f, -1126.376f) - Vector(5.75f, 19.25f, 39.75f), Vector(104.0503f, 560.4913f, -1126.376f) + Vector(5.75f, 19.25f, 39.75f), 0, 1, 1, 1);
		uLocal_413 = ADD_SCENARIO_BLOCKING_AREA(Vector(9.361914f, 442.6952f, -3055.088f) + Vector(5f, 10f, 10f), Vector(9.361914f, 442.6952f, -3055.088f) - Vector(5f, 10f, 10f), 0, 1, 1, 1);
	}
	else
	{
		REMOVE_SCENARIO_BLOCKING_AREA(uLocal_414, 0);
		REMOVE_SCENARIO_BLOCKING_AREA(uLocal_413, 0);
	}
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Vector(107.351f, 558.3267f, -1133.993f) + Vector(7.25f, 25.25f, 25f), Vector(107.351f, 558.3267f, -1133.993f) - Vector(7.25f, 25.25f, 25f), !bParam0, 1);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Vector(9.361914f, 442.6952f, -3055.088f) + Vector(5f, 10f, 10f), Vector(9.361914f, 442.6952f, -3055.088f) - Vector(5f, 10f, 10f), !bParam0, 1);
}
...
void func_214(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = ROUND(func_215(TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_222(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_225()
{
	...
	func_231(&uVar0, GET_CLOCK_SECONDS());
	func_230(&uVar0, GET_CLOCK_MINUTES());
	func_229(&uVar0, GET_CLOCK_HOURS());
	func_228(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_227(&uVar0, GET_CLOCK_MONTH());
	func_226(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_242()) || Global_105612) || Global_25767) || func_241()) || func_74(8, -1)) || func_240()) || func_239()) || func_238()) || func_237()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_242()) || Global_25767) || func_241()) || func_74(8, -1)) || func_238()) || func_240()) || func_239()) || func_237()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_242()) || Global_105612) || Global_25767) || func_241()) || func_74(8, -1)) || func_240()) || func_239()) || func_237()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_242() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_74(8, -1)) || func_237()) || func_236()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_242()) || Global_25767) || func_241()) || func_74(8, -1)) || func_239()) || func_238()) || func_237()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_242()) || func_239()) || Global_105612) || Global_25767) || func_241()) || Global_37584) || func_74(8, -1)) || func_238()) || func_236()) || func_237()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_242()) || Global_105612) || Global_25767) || func_241()) || func_74(8, -1)) || func_238()) || func_236()) || func_240()) || func_239()) || func_237())
						{
							return 0;
						}
						break;
...
void func_250()
{
	...
	if (func_203())
	{
		...
		REMOVE_SCENARIO_BLOCKING_AREA(uLocal_162, 0);
	}
	else
	{
	...
	SET_MAX_WANTED_LEVEL(5);
	SET_WANTED_LEVEL_MULTIPLIER(1f);
	if ((DOES_ENTITY_EXIST(uLocal_140) && !IS_PED_INJURED(uLocal_140)) && IS_PED_GROUP_MEMBER(uLocal_140, GET_PLAYER_GROUP(PLAYER_ID())))
	{
		REMOVE_PED_FROM_GROUP(uLocal_140);
	}
	if (IS_VEHICLE_DRIVEABLE(uLocal_155, 0))
	...
	func_204(0);
	func_251(-1);
	SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_PARK_PERPENDICULAR_NOSE_IN", 1);
