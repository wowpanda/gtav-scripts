...
int func_28(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_30(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
void func_67(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_72(PLAYER::PLAYER_ID())) && !func_69(PLAYER::PLAYER_ID(), 0)) && !func_68())
			{
...
int func_218()
{
	...
	{
		vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_304, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) };
		if (vVar0.y < -1f)
		{
			return 1;
		}
...
int func_267(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2547365[iParam0 /*3*/][func_130(iParam1)];
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_340(iParam3), 0);
}
...
int func_342(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, float fParam6)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		vVar1 = { func_30(ENTITY::GET_ENTITY_COORDS(iVar0, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
void func_348(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
...
int func_352(char* sParam0)
{
	if (!func_353(1, 1, 0))
	{
		if ((!MISC::IS_STRING_NULL_OR_EMPTY(sParam0) && func_337(sParam0)) || func_337("CMN_HINT"))
		{
			HUD::CLEAR_HELP(1);
		}
		return 0;
...
int func_353(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_359() || func_358(Global_4456448.f_143970)) || func_357())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if ((VEHICLE::_0xE33FFA906CE74880(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), func_356(PLAYER::PLAYER_PED_ID(), 0)) || (ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) == joaat("apc") && func_356(PLAYER::PLAYER_PED_ID(), 0) != -1)) || (ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) == joaat("akula") && func_356(PLAYER::PLAYER_PED_ID(), 0) != -1))
			{
				return 0;
			}
		}
...
void func_373()
{
	if (iLocal_256 > 0 && MISC::GET_GAME_TIMER() > iLocal_256)
	{
		if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_299))
		{
			if ((func_219(PLAYER::PLAYER_PED_ID(), iLocal_299) < 50f && !func_21()) && !func_374("MEJ1_02", 0, 0))
			{
				if (iLocal_259)
				{
...
bool func_374(char* sParam0, int iParam1, char* sParam2)
{
...
void func_375()
{
	...
	if ((func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_301[0])) && func_43(iLocal_304))
	{
		...
		else if (((iLocal_254 < 8 && func_219(PLAYER::PLAYER_PED_ID(), iLocal_301[0]) < 50f) && !func_21()) && !func_374("MEJ1_02", 0, 0))
		{
...
void func_377()
{
	...
	if (STREAMING::HAS_ANIM_DICT_LOADED("missfam3"))
	{
		if (MISC::GET_GAME_TIMER() > iLocal_265)
		{
			...
			if (func_380(PLAYER::PLAYER_PED_ID(), vVar0, 20f))
			{
		...
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(iParam0))
			{
				...
				if (func_43(iVar5))
				{
					...
					BRAIN::CLEAR_SEQUENCE_TASK(&iVar3);
					BRAIN::OPEN_SEQUENCE_TASK(&iVar3);
					BRAIN::TASK_PLAY_ANIM(0, "missfam3", sVar0, 4f, -8f, -1, 16 | iParam2, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "missfam3", sVar1, 8f, -8f, iParam1, 16 | iParam2 | 1, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "missfam3", sVar2, 8f, -4f, -1, 16 | iParam2, 0, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iVar3);
...
bool func_380(int iParam0, vector3 vParam1, float fParam2)
{
...
void func_384()
{
	...
	switch (iLocal_296)
	{
		...
		case 1:
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_290, true) < 1400f)
			{
				iLocal_296 = 2;
			}
			break;
		...
		case 2:
			...
			{
				if (func_380(PLAYER::PLAYER_PED_ID(), vLocal_290, 150f) || func_376(&uLocal_67, 14, "MEJ1AUD", "MEJ1_CLOSE", 7, 0, 0, 1))
				{
					iLocal_296 = 3;
				}
			}
...
int func_387(int iParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
...
void func_391(int iParam0, vector3 vParam1, float fParam2)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
	...
	if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
	{
		...
		if (func_388())
		{
			...
			switch (iVar3)
			{
				...
				case 3:
					func_393(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
...
void func_393(vector3 vParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
void func_426(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
...
int func_427(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
...
void func_428(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_13(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_432(*iParam1, 0, &uVar0))
		{
...
int func_432(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_453(iVar0, bParam1, uParam2) && !func_452(PLAYER::PLAYER_ID())) && !func_437(iParam0))
	{
		return 0;
	}
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_433(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_439(int iParam0)
{
	...
	if (func_440(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_441(int iParam0, bool bParam1)
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_443(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_209(iParam0, 0, 0)) || func_209(iParam0, 1, 0)) || func_209(iParam0, 2, 0)) || func_256(iParam0) != 145) || func_460(iParam0)) || func_459(iParam0)) || func_433(iParam0)) || func_458(iParam0)) || !func_457(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_459(iParam0))
		{
		}
...
int func_464(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_449(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_467(*iParam0, ((*uParam1)[38] - 1)))
	{
...
void func_469(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90309[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90309[iVar0]) == func_258(iParam0, iParam1))
				{
...
int func_482(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_483(iParam0, uVar1[iVar3], 1) && func_414(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_282(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_488(int iParam0)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!func_494(PLAYER::PLAYER_ID(), -1))
		{
