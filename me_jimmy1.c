...
void __EntryFunction__()
{
	...
	fLocal_232 = "missmej1ig_1";
	fLocal_235 = "seat_pside_r";
	iLocal_236 = 115;
	iLocal_239 = -1;
	iLocal_240 = -1;
...
void func_3()
{
	...
	else if (func_36(iLocal_299) && func_36(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (func_35(iLocal_304) && (((((PED::IS_PED_IN_VEHICLE(iLocal_299, iLocal_304, 0) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_299, fLocal_232, "back", 2)) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_299, fLocal_232, "base", 2)) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_299, fLocal_232, "enter_back", 2)) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_299, fLocal_232, "enter_backseat", 2)) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_299, fLocal_232, "exit_back", 2)))
			{
			...
			if (((PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()) && func_34(PLAYER::PLAYER_PED_ID(), iLocal_299, 50f, 1)) && func_33(iLocal_299, 1126825984)) && func_24(PLAYER::PLAYER_PED_ID(), iLocal_299, 90f, 1, 250, 7))
			{
				...
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_299, -1519143300) != 1)
				{
					BRAIN::TASK_HANDS_UP(iLocal_299, -1, 0, -1, 0);
				}
			}
			else if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_299, -1519143300) == 1)
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_299);
			}
		}
	}
}
...
void func_54(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_56(Global_105220.f_18504[iVar0], &vVar2, &fVar3))
			{
	...
	if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_299))
	{
		...
		switch (iLocal_296)
		{
			case 0:
				...
				BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_299, -1, 2050, 4);
				if (func_43(iVar0))
				{
				...
				{
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_299, 0);
					...
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_250, 1f, 20000, 0.25f, 0, 1193033728);
		...
		switch (iLocal_296)
		{
			case 0:
				...
				else
				{
					...
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2f, 20000, 0.25f, 0, 1193033728);
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_249, 1f, 20000, 0.25f, 0, 1193033728);
					BRAIN::CLOSE_SEQUENCE_TASK(iVar1);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_299, iVar1);
					BRAIN::CLEAR_SEQUENCE_TASK(&iVar1);
				}
...
{
	func_235();
	func_230(&uLocal_336, &uLocal_67, "MEJ1AUD", &sLocal_337, &fLocal_343);
	switch (iLocal_296)
	{
		case 0:
			func_61(&iLocal_298);
	...
	if (func_36(iLocal_299) && func_43(iLocal_304))
	{
		switch (iLocal_234)
		{
			...
			case 2:
				...
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, fLocal_235));
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, fLocal_232, "enter_back", 8f, -8f, 4, iLocal_236, 1148846080, 0);
				iLocal_266 = 0;
				iLocal_267 = -1;
				iLocal_234 = 12;
				break;
			...
			case 4:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, fLocal_235));
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, fLocal_232, "enter_left", 8f, -8f, 4, iLocal_236, 1148846080, 0);
				iLocal_234 = 5;
				break;
			...
			case 5:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_233))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_233) >= 0.9f)
					{
						...
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, fLocal_235));
						BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, fLocal_232, "left", 8f, -8f, 4, iLocal_236, 1148846080, 0);
						iLocal_234 = 6;
					}
				}
				break;
			...
			case 7:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, fLocal_235));
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, fLocal_232, "exit_left", 8f, -8f, 4, iLocal_236, 1148846080, 0);
			...
			case 8:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, fLocal_235));
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, fLocal_232, "enter_right", 8f, -8f, 4, iLocal_236, 1148846080, 0);
				iLocal_234 = 9;
				break;
			...
			case 9:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_233))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_233) >= 0.9f)
					{
						...
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, false);
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, fLocal_235));
						BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, fLocal_232, "right", 8f, -8f, 4, iLocal_236, 1148846080, 0);
						iLocal_234 = 10;
					}
				}
				break;
			...
			case 11:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, fLocal_235));
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, fLocal_232, "exit_right", 8f, -8f, 4, iLocal_236, 1148846080, 0);
				if (iLocal_237 || !VEHICLE::IS_VEHICLE_WINDOW_INTACT(iLocal_304, 7))
				{
					iLocal_234 = 13;
				}
			...
			case 12:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_233))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_233) >= 0.9f)
					{
						...
						PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, false);
						PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, fLocal_235));
						BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, fLocal_232, "back", 8f, -8f, 4, iLocal_236, 1148846080, 0);
						iLocal_234 = 3;
					}
				}
				break;
			...
			case 14:
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, true);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, fLocal_235));
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, fLocal_232, "exit_back", 4f, -8f, 4, iLocal_236, 1148846080, 0);
				iLocal_234 = 15;
				break;
			...
			case 15:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_233))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_233) >= 0.95f)
					{
						...
						BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, fLocal_232, "enter_backseat", 8f, -8f, 4, iLocal_236, 1148846080, 0);
						iLocal_234 = 16;
					}
				}
				else
...
void func_229(void fParam0, int iParam1, int iParam2)
{
	iParam2 = iParam2;
...
void func_230(var uParam0, var uParam1, char* sParam2, char* sParam3, void fParam4)
{
	switch (*uParam0)
	{
		case 0:
		...
		case 2:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
			{
				...
				{
					if (func_231(uParam1, sParam2, sParam3, fParam4, 8, 1, 0))
					{
						*uParam0 = 3;
					}
				}
		...
		case 4:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && func_231(uParam1, sParam2, sParam3, fParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
bool func_231(var uParam0, char* sParam1, char* sParam2, void fParam3, int iParam4, int iParam5, int iParam6)
{
	func_20(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_245()
{
	...
	else if (iLocal_238 == 1)
	{
		...
		{
			if (func_231(&uLocal_67, "MEJ1AUD", "MEJ1_DRIVE1", &fLocal_241, 7, 0, 0))
			{
				iLocal_238 = 2;
			}
		}
...
void func_247(int iParam0, void fParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_318(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
...
int func_267(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2557346[iParam0 /*3*/][func_130(iParam1)];
...
void func_272(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_274(Var7.f_1)) && iVar9 < 50)
			{
...
int func_280(vector3 vParam0, void fParam1, vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
int func_318(void fParam0, int iParam1)
{
	int iVar0;
	void fVar1;
	int iVar2;
...
void func_320(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_325(void fParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
...
int func_328(vector3 vParam0, int iParam1, bool bParam2)
{
	int iVar0;
	...
	switch (iLocal_296)
	{
		case 0:
			...
			if ((((func_43(iLocal_304) && func_36(iLocal_301[0])) && func_36(iLocal_301[1])) && func_36(iLocal_301[2])) && func_36(iLocal_299))
			{
				...
				iLocal_298 = func_384(iLocal_304, 0, 5);
			...
			iLocal_237 = 0;
			iLocal_261 = 1;
			func_382(&uLocal_331, &uLocal_333, &uLocal_330, &fLocal_332);
			fLocal_293 = 800f;
			fLocal_294 = 100f;
			PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.1f);
		...
		case 1:
			...
			func_376();
			func_374();
			func_373(iLocal_298, iLocal_299, fLocal_293, 1061158912, 0);
		...
		case 2:
			...
			if (func_43(iLocal_304))
			{
				if (VEHICLE::IS_VEHICLE_STOPPED(iLocal_304))
				{
					...
					{
						iLocal_298 = func_384(iLocal_304, 1, 5);
...
void func_336(var uParam0, void fParam1, int iParam2)
{
	void fVar0;
...
void func_338(int iParam0, bool bParam1)
{
	...
	if (func_36(iParam0))
	{
		...
		{
			fVar0 = "SUPER_HIGH_FALL";
		}
		if (PED::IS_PED_MALE(iParam0))
		{
			func_339(iParam0, fVar0, "WAVELOAD_PAIN_MALE", 24);
		}
		else
		{
			func_339(iParam0, fVar0, "WAVELOAD_PAIN_FEMALE", 24);
		}
	}
}

void func_339(int iParam0, void fParam1, void fParam2, int iParam3)
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, fParam1, fParam2, func_340(iParam3), 0);
}
...
void func_346(var uParam0, int iParam1, void fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	func_347(uParam0, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_347(var uParam0, int iParam1, void fParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)
{
	uParam0->f_6 = 0;
	func_348(uParam0, iParam1, 0f, 0f, 0f, fParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_348(var uParam0, int iParam1, vector3 vParam2, void fParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	void fVar0;
	int iVar1;
	...
	if (func_371(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		iVar1 = 0;
		...
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			if (func_366(uParam0, bParam5, bParam7, 0))
			{
				func_363(uParam0, iParam1, vParam2, iParam4);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
	...
	{
		func_336(uParam0, fVar0, 0);
	}
}

void func_349(var uParam0)
{
	if (func_371(PLAYER::PLAYER_PED_ID()))
	{
		BRAIN::TASK_CLEAR_LOOK_AT(PLAYER::PLAYER_PED_ID());
	}
	if (CAM::IS_GAMEPLAY_HINT_ACTIVE())
...
int func_352(void fParam0)
{
	if (!func_353(1, 1, 0))
	{
		if ((!MISC::IS_STRING_NULL_OR_EMPTY(fParam0) && func_337(fParam0)) || func_337("CMN_HINT"))
		{
			HUD::CLEAR_HELP(1);
		}
		return 0;
...
int func_353(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_360() || func_359(Global_4456448.f_148478)) || func_358())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("riot2") && iVar1 == 0) && func_356(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_354(int iParam0)
{
	if (iParam0 != func_300())
	{
		...
		else if ((Global_1312854 && iParam0 == PLAYER::PLAYER_ID()) && func_355(iParam0, 1, 0))
		{
			return Global_2423644[iParam0 /*406*/].f_305.f_1 != -1;
		}
	}
...
void func_363(var uParam0, int iParam1, vector3 vParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_366(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_369(bParam1, bParam2, bParam3) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || func_367(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_374()
{
	if (iLocal_256 > 0 && MISC::GET_GAME_TIMER() > iLocal_256)
	{
		if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_299))
		{
			if ((func_219(PLAYER::PLAYER_PED_ID(), iLocal_299) < 50f && !func_21()) && !func_375("MEJ1_02", 0, 0))
			{
				if (iLocal_259)
				{
...
bool func_375(void fParam0, int iParam1, void fParam2)
{
...
void func_376()
{
	...
	if ((func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_301[0])) && func_43(iLocal_304))
	{
		if (iLocal_254 == -1 && iLocal_255 == -1)
		{
			...
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_304, PLAYER::PLAYER_PED_ID(), 1) || bLocal_257)
			{
				...
				if (func_4(&uLocal_67, "MEJ1AUD", "MEJ1_RAM", "MEJ1_RAM_3", 7, 0, 0))
				{
					...
					BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_301[0], iLocal_304, PLAYER::PLAYER_PED_ID(), 8, 25f, 786468, 100f, 1f, 1);
					RECORDING::_0x293220DA1B46CEBC(3f, 0f, 3);
					iLocal_234 = 2;
					fLocal_293 = 200f;
					fLocal_294 = 500f;
		...
		else if (iLocal_260)
		{
			if (!func_21())
			{
				if (func_377(&uLocal_67, 14, "MEJ1AUD", "MEJ1_DAD", 7, 0, 0, 1))
				{
					iLocal_260 = 0;
				}
			}
		}
		else if (((iLocal_254 < 8 && func_219(PLAYER::PLAYER_PED_ID(), iLocal_301[0]) < 50f) && !func_21()) && !func_375("MEJ1_02", 0, 0))
		{
			...
			if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(iParam0))
			{
				...
				if (func_43(iVar5))
				{
					...
					switch (iVar4)
					{
						case -1:
						case 1:
							fVar0 = "incar_lookbehind_enter_driver";
							fVar1 = "incar_lookbehind_idle_driver";
							fVar2 = "incar_lookbehind_exit_driver";
							break;
						
						case 0:
						case 2:
							fVar0 = "incar_lookbehind_enter_passenger";
							fVar1 = "incar_lookbehind_idle_passenger";
							fVar2 = "incar_lookbehind_exit_passenger";
							break;
					}
					BRAIN::CLEAR_SEQUENCE_TASK(&iVar3);
					BRAIN::OPEN_SEQUENCE_TASK(&iVar3);
					BRAIN::TASK_PLAY_ANIM(0, "missfam3", fVar0, 4f, -8f, -1, 16 | iParam2, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "missfam3", fVar1, 8f, -8f, iParam1, 16 | iParam2 | 1, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "missfam3", fVar2, 8f, -4f, -1, 16 | iParam2, 0, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iVar3);
...
void func_383(void fParam0, int iParam1)
{
...
void func_385()
{
	...
	switch (iLocal_296)
	{
		case 0:
			...
			func_392(&iLocal_298, -2086.913f, 951.6347f, 183.7526f, 75.8f);
		...
		case 2:
			...
			{
				if (func_381(PLAYER::PLAYER_PED_ID(), vLocal_290, 150f) || func_377(&uLocal_67, 14, "MEJ1AUD", "MEJ1_CLOSE", 7, 0, 0, 1))
				{
					iLocal_296 = 3;
				}
			}
...
void func_387()
{
	...
	if (func_43(iLocal_304))
	{
		...
		if (!func_36(iLocal_299))
		{
			if (STREAMING::HAS_MODEL_LOADED(func_46(14)) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_232))
			{
				func_388(&iLocal_299, vLocal_306, fLocal_307, 1);
				...
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_233, false);
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, fLocal_235));
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_299, iLocal_233, fLocal_232, "base", 8f, -8f, 4, iLocal_236, 1148846080, 0);
				iLocal_234 = 0;
			}
		}
	}
...
void func_392(int iParam0, vector3 vParam1, float fParam2)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_393()
{
	...
	if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
	{
		if (func_36(PLAYER::PLAYER_PED_ID()))
		{
			func_341(&uLocal_67, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 1, 1);
		}
		...
		STREAMING::REQUEST_ANIM_DICT(fLocal_232);
		...
		if (func_60(0) && func_36(PLAYER::PLAYER_PED_ID()))
		{
			...
			func_427(&iVar0, vVar1, fVar2, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
		}
		if (func_389())
		{
			iVar3 = func_426();
			...
			{
				case 0:
					func_410(&iVar4, 1, 1, 1, 1, iLocal_335, 0, 145);
					if (func_381(iVar4, -811.3438f, 187.4367f, 71.47861f, 6f))
					{
				...
				case 3:
					func_394(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1112014848, 12, 5000, 0, 0);
...
void func_394(vector3 vParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
void func_400(bool bParam0)
{
	...
	if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(iLocal_299))
	{
		...
		{
			vVar2 = { func_402() };
			func_401(&vVar2, &fVar3);
			func_427(&iVar1, vVar2, fVar3, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
...
void func_408()
{
	...
	if (func_36(PLAYER::PLAYER_PED_ID()))
	{
		func_40(1, 0);
		func_390();
		func_427(&iVar0, -2086.913f, 951.6347f, 183.7526f, 75.8f, 1, 1, 0, 1, 1, iLocal_335, 0, 145, 1);
		if (func_43(iVar0))
		{
...
void func_410(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	if (func_425() && func_411(iParam1, iParam2, iParam3, 1))
	{
		vVar0 = { 0f, 0f, 0f };
		fVar1 = 0f;
		func_427(iParam0, vVar0, fVar1, 1, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1);
	}
...
void func_427(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_482(vParam1, fParam2);
	}
	else if (iParam7 == 1)
	{
...
int func_433(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_456(iVar0, bParam1, uParam2) && !func_455(PLAYER::PLAYER_ID())) && !func_440(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_438(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((((((VEHICLE::IS_BIG_VEHICLE(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("halftrack")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("phantom3")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("hauler2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("trailerlarge")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("trailersmall2")) && !bVar1) && !(func_437(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_435(PLAYER::PLAYER_ID())))
	{
		*uParam2 = 2;
		return 0;
	}
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_434(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_442(int iParam0)
{
	...
	if (func_443(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_444(int iParam0, bool bParam1)
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_446(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_456(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_438(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_209(iParam0, 0, 0)) || func_209(iParam0, 1, 0)) || func_209(iParam0, 2, 0)) || func_256(iParam0) != 145) || func_463(iParam0)) || func_462(iParam0)) || func_434(iParam0)) || func_461(iParam0)) || !func_460(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_462(iParam0))
		{
		}
...
int func_467(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_452(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_470(*iParam0, ((*uParam1)[38] - 1)))
	{
...
void func_472(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90431[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90431[iVar0]) == func_258(iParam0, iParam1))
				{
...
int func_482(vector3 vParam0, float fParam1)
{
	return func_483(&(Global_98783.f_2875), vParam0, fParam1, 0);
}

int func_483(var uParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
	...
	if (func_414(uParam0))
	{
		...
		if (func_498(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_485(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar4 = func_484(iVar0);
					if (iVar4 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_485(int iParam0, vector3 vParam1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_486(iParam0, uVar1[iVar3], 1) && func_415(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
void func_503(bool bParam0)
{
	...
	HUD::CLEAR_PRINTS();
	func_203();
	STREAMING::REMOVE_ANIM_DICT(fLocal_232);
	CAM::SET_WIDESCREEN_BORDERS(false, 0);
