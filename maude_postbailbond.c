...
void __EntryFunction__()
{
	...
	while (true)
	{
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			...
			vVar3 = { GET_ENTITY_COORDS(uLocal_82, 1) };
			...
			switch (iLocal_87)
			{
				...
				case 2:
					if (!func_4(uLocal_82, 1805844857) && !IS_PED_FLEEING(uLocal_82))
					{
						if (!IS_ENTITY_PLAYING_ANIM(uLocal_82, func_11(), func_3(), 3))
						{
							func_1();
						}
					}
...
void func_1()
{
	...
	{
		func_2(&uLocal_82);
		TASK_SMART_FLEE_PED(uLocal_82, PLAYER_PED_ID(), 10000f, -1, 0, 0);
		SET_PED_KEEP_TASK(uLocal_82, 1);
	}
}
...
void func_2(var uParam0)
{
	if (func_51(*uParam0))
	{
		...
		SET_PED_FLEE_ATTRIBUTES(*uParam0, 64, 0);
		SET_PED_FLEE_ATTRIBUTES(*uParam0, 128, 0);
		SET_PED_FLEE_ATTRIBUTES(*uParam0, 8, 0);
		SET_PED_FLEE_ATTRIBUTES(*uParam0, 1, 0);
		SET_PED_FLEE_ATTRIBUTES(*uParam0, 32, 0);
...
int func_5(var uParam0, var uParam1, int iParam2)
{
	...
	if (func_51(*uParam0))
	{
		if (IS_ENTITY_PLAYING_ANIM(*uParam0, func_10(), func_9(), 3))
		{
			if (!IS_PED_RAGDOLL(*uParam0) || IS_PED_GETTING_UP(*uParam0))
			{
				...
				if (HAS_ANIM_DICT_LOADED(func_11()))
				{
					*iParam2 = CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
					...
					{
						STOP_SYNCHRONIZED_ENTITY_ANIM(*uParam0, -1000f, 1);
					}
					TASK_SYNCHRONIZED_SCENE(*uParam0, *iParam2, func_11(), func_3(), 1000f, -4f, 4626, 0, 1148846080, 0);
					_0x2208438012482A1A(*uParam0, 0, 0);
					if (func_8(*uParam1))
					{
						if (IS_ENTITY_PLAYING_ANIM(*uParam1, func_10(), func_7(), 3))
						{
							STOP_SYNCHRONIZED_ENTITY_ANIM(*uParam1, -16f, 0);
						}
						iVar0 = 0;
						iVar0 += 16;
						iVar0 += 64;
						iVar0 += 512;
						iVar0 += 4096;
						PLAY_SYNCHRONIZED_ENTITY_ANIM(*uParam1, *iParam2, func_6(), func_11(), 16f, -4f, iVar0, 1148846080);
					}
					return 1;
				}
			}
...
void func_12(vector3 vParam0, vector3 vParam3)
{
	if (func_51(uLocal_82))
	{
		if (!IS_AMBIENT_SPEECH_PLAYING(uLocal_82))
		{
...
void func_13(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	...
	if (func_51(*uParam0))
	{
		bVar0 = IS_AMBIENT_SPEECH_DISABLED(*uParam0);
		if (bVar0)
		{
...
{
	_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, uParam1, uParam2, func_15(iParam3), 0);
}
...
void func_16(bool bParam0)
{
	...
	if (func_23())
	{
		Var0 = { func_22() };
		uVar6 = func_21();
		if (ARE_STRINGS_EQUAL(&Var0, uVar6))
		{
			if (bParam0)
			{
				func_19();
...
char* func_21()
{
	if (IS_BIT_SET(Global_106565.f_24980, 3))
	{
		return "BB4_loiter";
	}
	else if (IS_BIT_SET(Global_106565.f_24980, 2))
	{
		return "BB3_loiter";
	}
	else if (IS_BIT_SET(Global_106565.f_24980, 1))
	{
		return "BB2_loiter";
	}
	else if (IS_BIT_SET(Global_106565.f_24980, 0))
	{
		return "BB1_loiter";
	}
	return "MAUDE_loiter";
...
void func_24()
{
	...
	{
		FREEZE_ENTITY_POSITION(uLocal_81, 0);
	}
	if (DOES_ENTITY_EXIST(uLocal_80))
	{
		FREEZE_ENTITY_POSITION(uLocal_80, 0);
	}
}
...
int func_25(var uParam0, bool bParam1)
{
	if (func_51(*uParam0))
	{
		if ((HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(*uParam0) || HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(*uParam0)) || HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(*uParam0))
		{
			return 1;
		}
		if (IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()))
		{
			...
			{
				if (IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), uLocal_79))
				{
					return 1;
				}
			}
			if (DOES_ENTITY_EXIST(uLocal_80))
			{
				if (IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), uLocal_80))
				{
					return 1;
				}
			}
			if (DOES_ENTITY_EXIST(uLocal_81))
			{
				if (IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), uLocal_81))
				{
					return 1;
				}
			}
		}
		if (HAS_PED_RECEIVED_EVENT(*uParam0, 60))
		{
			return 1;
		}
		if (IS_PED_RAGDOLL(*uParam0))
		{
			if (IS_ENTITY_AT_ENTITY(*uParam0, PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0))
			{
				return 1;
			}
		}
		if (HAS_PED_RECEIVED_EVENT(*uParam0, 50))
		{
			return 1;
		}
		...
		if (IS_EXPLOSION_IN_SPHERE(-1, GET_ENTITY_COORDS(*uParam0, 1), 15f))
		{
			return 1;
		}
		if (HAS_PED_RECEIVED_EVENT(*uParam0, 72))
		{
			return 1;
		}
		if (bParam1)
...
int func_28(var uParam0, float fParam1)
{
	...
	{
		if (func_29(uParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_29(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_31(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_31(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_43(vector3 vParam0, vector3 vParam3, int iParam6, float fParam7)
{
	...
	if (iLocal_84 < iLocal_85)
	{
		if (!func_23())
		{
			...
			{
				if (GET_GAME_TIMER() - iLocal_83) > (iParam6 + GET_RANDOM_INT_IN_RANGE(0, 2000))
				{
					uVar0 = 16;
					func_47(&uVar0, 3, uLocal_82, "MAUDE", 0, 1);
					cVar165 = func_46();
					sVar166 = func_21();
...
void func_50()
{
	...
	if (func_51(uLocal_82))
	{
		if (!IS_ENTITY_A_MISSION_ENTITY(uLocal_82))
		{
			SET_ENTITY_AS_MISSION_ENTITY(uLocal_82, 1, 0);
		}
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_82, 1);
		SET_PED_MONEY(uLocal_82, 0);
		SET_PED_CAN_BE_TARGETTED(uLocal_82, 0);
		SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_82, 1862763509);
		SET_PED_PATH_CAN_USE_CLIMBOVERS(uLocal_82, 0);
		SET_PED_PATH_CAN_DROP_FROM_HEIGHT(uLocal_82, 0);
		SET_PED_CONFIG_FLAG(uLocal_82, 118, 0);
		vVar0 = { 2728.33f, 4145.6f, 43.89f };
		if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vVar0, 10f, -380698483, 0))
		{
			uLocal_80 = GET_CLOSEST_OBJECT_OF_TYPE(vVar0, 10f, -380698483, 1, 0, 1);
			if (func_8(uLocal_80))
			{
				SET_ENTITY_COORDS(uLocal_80, 2727.4f, 4145.56f, 43.68f, 1, 0, 0, 1);
				SET_ENTITY_HEADING(uLocal_80, -92.17f);
				FREEZE_ENTITY_POSITION(uLocal_80, 1);
			}
		}
		if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vVar0, 10f, 1385417869, 0))
		{
			uLocal_81 = GET_CLOSEST_OBJECT_OF_TYPE(vVar0, 10f, 1385417869, 0, 0, 1);
			if (func_8(uLocal_81))
			{
				if (!IS_ENTITY_A_MISSION_ENTITY(uLocal_81))
				{
					SET_ENTITY_AS_MISSION_ENTITY(uLocal_81, 1, 0);
				}
				SET_ENTITY_COORDS(uLocal_81, 2727.686f, 4145.715f, 44.08f, 1, 0, 0, 1);
				SET_ENTITY_HEADING(uLocal_81, 71f);
				FREEZE_ENTITY_POSITION(uLocal_81, 1);
			}
		}
		if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vVar0, 10f, -741944541, 0))
		{
			uLocal_79 = GET_CLOSEST_OBJECT_OF_TYPE(vVar0, 10f, -741944541, 0, 0, 1);
			if (func_8(uLocal_79))
			{
				if (!IS_ENTITY_A_MISSION_ENTITY(uLocal_79))
				{
					SET_ENTITY_AS_MISSION_ENTITY(uLocal_79, 1, 0);
				}
				SET_ENTITY_COORDS(uLocal_79, 2728.35f, 4145.59f, 43.3f, 1, 0, 0, 1);
				SET_ENTITY_HEADING(uLocal_79, -91.28f);
			}
		}
	}
}
...
void func_55()
{
	...
	if (func_8(uLocal_79))
	{
		FREEZE_ENTITY_POSITION(uLocal_79, 0);
		if (IS_ENTITY_PLAYING_ANIM(uLocal_79, "special_ped@maude@base", "base_chair", 3))
		{
			STOP_ENTITY_ANIM(uLocal_79, "base_chair", "special_ped@maude@base", -1000f);
			STOP_SYNCHRONIZED_ENTITY_ANIM(uLocal_79, -1000f, 1);
		}
		else if (IS_ENTITY_PLAYING_ANIM(uLocal_79, func_11(), "Female_Flee_Table_Left_Maude_Chair", 3))
		{
			STOP_ENTITY_ANIM(uLocal_79, "Female_Flee_Table_Left_Maude_Chair", func_11(), -1000f);
			STOP_SYNCHRONIZED_ENTITY_ANIM(uLocal_79, -1000f, 1);
		}
	}
	func_57(&uLocal_79, 0);
	...
	{
		SET_PED_KEEP_TASK(uLocal_82, 1);
		SET_PED_CONFIG_FLAG(uLocal_82, 118, 1);
	}
	func_56(&uLocal_82, 1, 0, 1);
