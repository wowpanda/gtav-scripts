...
int func_1()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("drunk")) > 0)
	{
		return 1;
	}
	if (Global_37343 > 0)
...
void func_2()
{
	...
	if (Global_37552 > iVar1 || Global_37552 == -1)
	{
		...
		if (Global_37555 != Global_37556)
		{
			...
			if (ABSF((Global_37555 - Global_37556)) < 0.01f)
			{
		...
		{
			SHAKE_GAMEPLAY_CAM("DRUNK_SHAKE", ((Global_37555 * fVar3) * fVar5));
		}
		if ((GET_GAME_TIMER() % 100) == 0)
		{
			...
			else
			{
				...
				SET_GAMEPLAY_CAM_SHAKE_AMPLITUDE(((Global_37555 * fVar3) * fVar5));
				CUSTOM_MENU_COORDINATES(((Global_37554 * fVar3) * fVar5));
				fLocal_26 = fVar3;
			}
		}
		if (((Global_37554 * fVar3) * fVar5) < 1f)
		{
			_0x0225778816FDC28C(((Global_37554 * fVar3) * fVar5));
		}
		else
		{
		...
		{
			SHAKE_CINEMATIC_CAM("DRUNK_SHAKE", (((Global_37555 * Global_37549) * fVar3) * fVar5));
		}
		SET_CINEMATIC_CAM_SHAKE_AMPLITUDE((((Global_37555 * Global_37549) * fVar3) * fVar5));
		if (DOES_CAM_EXIST(Global_37551))
		{
			if (IS_CAM_SHAKING(Global_37551))
			{
				SET_CAM_SHAKE_AMPLITUDE(Global_37551, ((Global_37555 * fVar3) * fVar5));
			}
		}
		if (!IS_STRING_NULL_OR_EMPTY(&Global_37578) && !IS_STRING_NULL_OR_EMPTY(&Global_37562))
		{
			START_AUDIO_SCENE(&Global_37562);
		...
		if (Global_37557 > 0f)
		{
			if (fLocal_16 != Global_37557)
			{
				...
				{
					SET_TRANSITION_TIMECYCLE_MODIFIER(&Global_37558, 15f);
			...
			else
			{
				...
				if (iVar7 <= (Global_37553 / 2) && Global_37552 != -1)
				{
					...
					else
					{
						...
						{
							_0x1CBA05AE7BD7EE05((TO_FLOAT((Global_37553 / 2)) / 1000f));
						}
						fLocal_16 = -99f;
						Global_37557 = 0f;
...
float func_8()
{
	...
	fVar0 = 0.1f;
	iVar1 = func_12(PLAYER_PED_ID());
	iVar2 = func_9(PLAYER_PED_ID());
	if (iVar2 == 0)
	{
		if (iVar1 == 0)
		{
...
void func_15(int iParam0)
{
	...
	if (IS_ENTITY_DEAD(Global_37345[iParam0 /*5*/].f_1, 0))
	{
		func_18(iParam0);
		return;
	}
