...
void __EntryFunction__()
{
	...
	{
		SYSTEM::WAIT(0);
		if ((TASK::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_76) || iLocal_103)
		{
			if (!func_161())
			{
				if (func_160())
					...
					if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
					{
							...
							case 1:
								if (!func_135())
								{
									if ((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_59, 75f, 75f, 75f, false, true, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_58)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_58, 15f, 15f, 15f, 0, 1, 0))
									{
										if (!func_161())
										{
											BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_58, -1, 0, 2);
							...
							case 4:
								if (!bLocal_64)
								{
									if (!PED::IS_PED_INJURED(iLocal_58))
									{
										...
										{
											BRAIN::TASK_PLAY_ANIM(iLocal_58, "random@homelandsecurity", "knees_to_stand_girl", 4f, -4f, -1, 0, 0.3f, 0, 0, 0);
										}
										else
										{
										...
										if (PED::IS_PED_IN_GROUP(iLocal_58))
										{
											...
											else
											{
												...
												if (!PED::IS_PED_INJURED(iLocal_58))
												{
													...
													BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_68, 1f, -1, 0.25f, 0, 38.9844f);
						...
						if (iLocal_47 == 4 || iLocal_47 == 5)
						{
							if (!PED::IS_PED_INJURED(iLocal_58))
							{
								...
								{
									BRAIN::TASK_SMART_FLEE_PED(iLocal_58, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
									func_96();
									func_109();
								}
							}
...
void func_34(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	func_35(Global_105220.f_28021[iParam0 /*29*/].f_17, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
void func_38(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_105220.f_20535.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_40() /*12171*/].f_7688.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_105220.f_20535.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_40() /*12171*/].f_7688.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_42(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_40() /*12171*/].f_7688.f_10, iParam0);
}
...
int func_48(int iParam0, int iParam1)
{
	...
	if (func_58(&Global_4267702))
	{
		if (func_56(&Global_4267702, iParam0))
		{
			return 0;
		}
...
void func_52(var uParam0)
{
	...
	func_54(uParam0, (Global_4267701 - 0.5f));
}
...
void func_92(void fParam0, int iParam1)
{
...
void func_110()
{
	if (!iLocal_77)
	{
		if (!PED::IS_PED_INJURED(iLocal_50[0]))
		{
			...
			BRAIN::CLEAR_PED_TASKS(iLocal_50[0]);
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_102);
	...
	if (!iLocal_78)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_50[1]))
		{
			...
			{
				BRAIN::TASK_COMBAT_PED(iLocal_50[1], PLAYER::PLAYER_PED_ID(), 0, 16);
				PED::SET_PED_KEEP_TASK(iLocal_50[1], true);
				iLocal_78 = 1;
			}
		}
	...
	if (!bLocal_104)
	{
		switch (iLocal_49)
		{
			...
			case 5:
				...
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_102);
					BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_58, -1, 2054, 2);
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_58, -1);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_102);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_50[0], iLocal_102);
					PED::SET_PED_KEEP_TASK(iLocal_50[0], true);
					iLocal_83 = 1;
								...
								if (!func_108())
								{
									if (PED::IS_PED_FACING_PED(iLocal_50[0], iLocal_58, 10f))
									{
										if (func_106(&uLocal_120, "REHOMAU", "REHOM_ARR", 4, 0, 0, 0))
										{
											...
											ENTITY::PLAY_ENTITY_ANIM(iLocal_53, "exit_car", "random@homelandsecurity", 4f, false, 0, 0, 0, 0);
											iLocal_116 = 1;
											iLocal_93 = MISC::GET_GAME_TIMER();
											iLocal_49 = 6;
										}
						...
						if (!func_108())
						{
							if (PED::IS_PED_FACING_PED(iLocal_50[0], iLocal_58, 10f))
							{
								if (func_106(&uLocal_120, "REHOMAU", "REHOM_ARR", 4, 0, 0, 0))
								{
									...
									BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_50[0], iLocal_115, "random@homelandsecurity", "exit_cop_gun", 2f, -4f, 1, 0, 1148846080, 0);
									BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_50[1], iLocal_115, "random@homelandsecurity", "exit_cop_ground", 2f, -4f, 1, 0, 1148846080, 0);
									ENTITY::PLAY_ENTITY_ANIM(iLocal_53, "exit_car", "random@homelandsecurity", 2f, false, 0, 0, 0, 0);
									iLocal_116 = 1;
									iLocal_93 = MISC::GET_GAME_TIMER();
									iLocal_49 = 6;
								}
				...
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_115))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_115) > 0.9f)
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_53, 0))
						{
							if (!PED::IS_PED_INJURED(iLocal_50[0]))
							{
								BRAIN::TASK_ENTER_VEHICLE(iLocal_50[0], iLocal_53, -1, -1, 1f, 9, 0);
								iLocal_49 = 7;
							}
						}
					}
				...
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_115))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_115) > 0.95f)
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_53, 0))
						{
							if (!PED::IS_PED_INJURED(iLocal_50[1]))
							{
								BRAIN::TASK_ENTER_VEHICLE(iLocal_50[1], iLocal_53, -1, 0, 1f, 9, 0);
								PED::SET_PED_KEEP_TASK(iLocal_50[1], true);
								iLocal_49 = 8;
							}
						}
			...
			case 13:
				...
				if (iLocal_107)
				{
					if (!PED::IS_PED_INJURED(iLocal_50[1]))
					{
						if (!PED::IS_PED_INJURED(iLocal_58))
						{
							if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_50[1], 1785177548) != 1)
							{
								...
								BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, iLocal_58, -1f, 0f, 0f, 1f, -1, 1036831949, 1);
								BRAIN::CLOSE_SEQUENCE_TASK(iLocal_102);
								BRAIN::TASK_PERFORM_SEQUENCE(iLocal_50[1], iLocal_102);
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_102);
							}
					...
					if (!PED::IS_PED_INJURED(iLocal_58))
					{
						...
						{
							BRAIN::TASK_SEEK_COVER_FROM_PED(iLocal_58, PLAYER::PLAYER_PED_ID(), -1, 0);
							PED::SET_PED_KEEP_TASK(iLocal_58, true);
						}
					}
				}
...
int func_128()
{
	switch (func_129(&Global_25336, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_132(iParam0, Global_35905);
}
...
int func_145(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_11() == 0)
		{
			return MISC::IS_BIT_SET(func_142(func_143(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_165(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_201(Global_105220.f_24966.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_199()) || Global_104267) || Global_25279) || func_198()) || func_76(8, -1)) || func_197()) || func_196()) || func_195()) || func_194()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_199()) || Global_25279) || func_198()) || func_76(8, -1)) || func_195()) || func_197()) || func_196()) || func_194()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_199()) || Global_104267) || Global_25279) || func_198()) || func_76(8, -1)) || func_195()) || func_197()) || func_196()) || func_194()) || Global_105220.f_7659.f_919[iVar0] == 5) || Global_36452 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_199()) || Global_104267) || Global_25279) || func_198()) || func_76(8, -1)) || func_197()) || func_196()) || func_194()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_199() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_76(8, -1)) || func_194()) || func_193()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_199()) || Global_25279) || func_198()) || func_76(8, -1)) || func_196()) || func_195()) || func_194()) || Global_105220.f_7659.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_199()) || func_196()) || Global_104267) || Global_25279) || func_198()) || Global_37057) || func_76(8, -1)) || func_195()) || func_193()) || func_194()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_199()) || Global_104267) || Global_25279) || func_198()) || func_76(8, -1)) || func_195()) || func_193()) || func_197()) || func_196()) || func_194())
						{
							return 0;
						}
						break;
		...
		while (iVar0 < iLocal_50)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_50[iVar0]))
			{
				if (!PED::IS_PED_INJURED(iLocal_50[iVar0]))
				{
					if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						BRAIN::TASK_AIM_GUN_AT_COORD(iLocal_50[iVar0], func_219(PLAYER::PLAYER_ID()), -1, 0, 0);
...
void func_208(int iParam0)
{
	...
	if (func_161())
	{
		...
		func_211(30000);
		StringCopy(&cVar0, func_210(Global_105209, 1), 64);
