					...
					if (IS_PLAYER_PLAYING(PLAYER_ID()))
					{
						switch (iLocal_49)
						{
							...
							case 1:
								if (!func_138())
								{
									if ((IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_73, 75f, 75f, 75f, 0, 1, 0) && !IS_ENTITY_OCCLUDED(iLocal_72)) || IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_72, 15f, 15f, 15f, 0, 1, 0))
									{
										if (!func_161())
										{
											TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), iLocal_72, -1, 0, 2);
									...
									if (!IS_PED_INJURED(iLocal_52[0]) && !IS_PED_INJURED(iLocal_52[1]))
									{
										if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_52[0], PLAYER_PED_ID(), 1) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_52[1], PLAYER_PED_ID(), 1))
										{
											func_137();
											bLocal_111 = true;
										}
									...
									if (!IS_PED_INJURED(iLocal_72) && IS_VEHICLE_DRIVEABLE(uLocal_65, 0))
									{
										if (IS_PED_IN_VEHICLE(iLocal_72, uLocal_65, 0))
										{
											iLocal_137 = 1;
										}
									}
									if (bLocal_138)
									{
										if (IS_VEHICLE_DRIVEABLE(uLocal_65, 0))
										{
											if (!IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_65, 150f, 150f, 150f, 0, 1, 0))
											{
												iLocal_49 = 9;
											}
										}
							...
							case 3:
								...
								if (!IS_PED_INJURED(iLocal_72))
								{
									PLAY_PAIN(iLocal_72, 3, 0, 0);
									if (!IS_PED_IN_ANY_VEHICLE(iLocal_72, 0))
									{
										if (!iLocal_117)
										{
											if (IS_ENTITY_PLAYING_ANIM(iLocal_72, "random@homelandsecurity", "idle_girl", 3) && !IS_PED_RAGDOLL(iLocal_72))
											{
												_SET_PED_RAGDOLL_BLOCKING_FLAGS(iLocal_72, 16);
												OPEN_SEQUENCE_TASK(&uLocal_136);
												TASK_PLAY_ANIM(0, "random@homelandsecurity", "idle_to_knees_girl", 1000f, -8f, -1, 8192, 0, 0, 0, 0);
												TASK_PLAY_ANIM(0, "random@homelandsecurity", "knees_loop_girl", 8f, -8f, -1, 8321, 0, 0, 0, 0);
												CLOSE_SEQUENCE_TASK(uLocal_136);
												TASK_PERFORM_SEQUENCE(iLocal_72, uLocal_136);
												CLEAR_SEQUENCE_TASK(&uLocal_136);
												iLocal_117 = 1;
											}
											else
											{
										...
										else if ((((!IS_ENTITY_PLAYING_ANIM(iLocal_72, "random@homelandsecurity", "idle_girl", 3) && !IS_ENTITY_PLAYING_ANIM(iLocal_72, "random@homelandsecurity", "idle_to_knees_girl", 1)) && !IS_ENTITY_PLAYING_ANIM(iLocal_72, "random@homelandsecurity", "knees_loop_girl", 1)) && GET_SCRIPT_TASK_STATUS(iLocal_72, 474215631) != 0) && GET_SCRIPT_TASK_STATUS(iLocal_72, 474215631) != 1)
										{
											iLocal_117 = 0;
										}
									}
									else if (IS_VEHICLE_DRIVEABLE(uLocal_65, 0))
									{
										if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_65, 0))
										{
								...
								if (!func_111())
								{
									if (iLocal_129 < GET_GAME_TIMER())
									{
										...
										else if (!IS_PED_INJURED(iLocal_52[1]))
										{
											func_109(&uLocal_154, "REHOMAU", "REHOM_YELL2", 4, 0, 0, 0);
										}
										iLocal_129 = (GET_GAME_TIMER() + GET_RANDOM_INT_IN_RANGE(4500, 5000));
									}
								}
								if (IS_PED_INJURED(iLocal_52[0]))
								{
								...
								else if (_CAN_PED_SEE_PED(iLocal_52[0], PLAYER_PED_ID()) || IS_ENTITY_AT_ENTITY(iLocal_52[0], PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0))
								{
								}
								...
								else if (_CAN_PED_SEE_PED(iLocal_52[1], PLAYER_PED_ID()) || IS_ENTITY_AT_ENTITY(iLocal_52[1], PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0))
								{
								}
								...
								if (DOES_ENTITY_EXIST(iLocal_52[0]) && DOES_ENTITY_EXIST(iLocal_52[1]))
								{
									if (((HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_52[0], joaat("weapon_stungun"), 0) && HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_52[1], joaat("weapon_stungun"), 0)) || (IS_PED_DEAD_OR_DYING(iLocal_52[0], 1) && IS_PED_DEAD_OR_DYING(iLocal_52[1], 1))) || func_107())
									{
										if (DOES_BLIP_EXIST(uLocal_121[0]))
										{
											REMOVE_BLIP(&(uLocal_121[0]));
										...
										if (!IS_PED_INJURED(iLocal_72))
										{
											if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_72, 15f, 15f, 15f, 0, 1, 0))
											{
												if (!func_111())
												{
													...
													bLocal_90 = false;
													iLocal_108 = 1;
													_RESET_PED_RAGDOLL_BLOCKING_FLAGS(iLocal_72, 16);
							...
							case 4:
								if (!bLocal_90)
								{
									if (!IS_PED_INJURED(iLocal_72))
									{
										if ((IS_ENTITY_PLAYING_ANIM(iLocal_72, "random@homelandsecurity", "idle_to_knees_girl", 1) || IS_ENTITY_PLAYING_ANIM(iLocal_72, "random@homelandsecurity", "knees_loop_girl", 1)) && !IS_PED_RAGDOLL(iLocal_72))
										{
											TASK_PLAY_ANIM(iLocal_72, "random@homelandsecurity", "knees_to_stand_girl", 4f, -4f, -1, 0, 0.3f, 0, 0, 0);
										}
										else
										{
											CLEAR_PED_TASKS(iLocal_72);
										}
										SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_72, 0);
										SET_PED_AS_GROUP_MEMBER(iLocal_72, func_106());
								...
								if (bLocal_90)
								{
									if (!IS_PED_INJURED(iLocal_72))
									{
										if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_72, 8f, 8f, 8f, 0, 1, 0) || IS_PED_IN_ANY_TAXI(PLAYER_PED_ID()))
										{
											if (DOES_BLIP_EXIST(uLocal_120))
											{
												REMOVE_BLIP(&uLocal_120);
										...
										{
											uLocal_120 = func_102(iLocal_72, 0, 145);
										}
									}
								}
								if (!IS_PED_INJURED(iLocal_52[0]))
								{
									if (_CAN_PED_SEE_PED(iLocal_52[0], PLAYER_PED_ID()))
									{
								...
								if (!IS_PED_INJURED(iLocal_52[1]))
								{
									if (_CAN_PED_SEE_PED(iLocal_52[1], PLAYER_PED_ID()))
									{
										if (GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) < 2)
										{
										}
							...
							case 5:
								...
								if (!IS_PED_INJURED(iLocal_72))
								{
									if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_93, Global_22, 1, 1, 0) && IS_ENTITY_AT_ENTITY(iLocal_72, PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0))
									{
										if (IS_PED_IN_GROUP(iLocal_72))
										{
											if (DOES_BLIP_EXIST(uLocal_120))
											...
											else
											{
												...
												if (!IS_PED_INJURED(iLocal_72))
												{
													...
													TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_96, 1f, -1, 0.25f, 0, 38.9844f);
													TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_SMOKING", 0, 1);
													CLOSE_SEQUENCE_TASK(uLocal_136);
													TASK_PERFORM_SEQUENCE(iLocal_72, uLocal_136);
													CLEAR_SEQUENCE_TASK(&uLocal_136);
													SET_PED_KEEP_TASK(iLocal_72, 1);
												}
						...
						if (iLocal_150 && !iLocal_151)
						{
							if (iLocal_49 != 6)
							{
								if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_149))
								{
									if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_149) > 0.85f)
									{
										if (IS_VEHICLE_DRIVEABLE(uLocal_65, 0))
										{
											if (!IS_PED_INJURED(iLocal_72))
											{
												if (!IS_PED_IN_VEHICLE(iLocal_72, uLocal_65, 0))
												{
													if (!IS_PED_RAGDOLL(iLocal_72))
													{
														CLEAR_PED_TASKS(iLocal_72);
														SET_PED_INTO_VEHICLE(iLocal_72, uLocal_65, 2);
														SET_PED_KEEP_TASK(iLocal_72, 1);
														iLocal_151 = 1;
													}
													else
						...
						if (iLocal_49 == 4 || iLocal_49 == 5)
						{
							if (!IS_PED_INJURED(iLocal_72))
							{
								if (!IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_72, 150f, 150f, 150f, 0, 1, 0) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_72, PLAYER_PED_ID(), 1))
								{
									TASK_SMART_FLEE_PED(iLocal_72, PLAYER_PED_ID(), 150f, -1, 0, 0);
									func_99();
									func_112();
								}
							}
...
int func_1()
{
	...
	iVar0[1] = 0;
	iVar0[2] = 0;
	if (DOES_ENTITY_EXIST(iLocal_52[0]))
	{
		if (IS_PED_INJURED(iLocal_52[0]))
		{
			iVar0[0] = 1;
	...
	if (DOES_ENTITY_EXIST(iLocal_52[1]))
	{
		if (IS_PED_INJURED(iLocal_52[1]))
		{
			iVar0[1] = 1;
...
void func_22()
{
	...
	{
		if (func_26(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
...
void func_38(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_40() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_40() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_39(iParam0));
...
int func_44(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_40() /*10778*/].f_6165.f_10, iParam0);
}
...
int func_45(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2539502[iParam0 /*3*/][func_42(iParam1)];
...
void func_83()
{
	if (!IS_PED_INJURED(iLocal_72))
	{
		if (!iLocal_105)
		{
			...
			{
				if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), GET_PLAYERS_LAST_VEHICLE(), 1) && IS_PED_IN_VEHICLE(iLocal_72, GET_PLAYERS_LAST_VEHICLE(), 0))
				{
					func_68(0);
					func_99();
					WAIT(0);
		...
		{
			if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), GET_PLAYERS_LAST_VEHICLE(), 0) && IS_PED_IN_VEHICLE(iLocal_72, GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				iLocal_105 = 0;
			}
		}
	...
	if (!IS_PED_INJURED(iLocal_72))
	{
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_72, 8f, 8f, 8f, 0, 1, 0) || IS_PED_IN_ANY_TAXI(PLAYER_PED_ID()))
		{
			...
			if (!IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0))
			{
				if (!DOES_BLIP_EXIST(uLocal_124))
				{
					uLocal_124 = func_97(vLocal_93, 1);
				}
				...
				if (func_104() == 2 && !func_96())
				{
					if (!DOES_BLIP_EXIST(uLocal_125))
					{
						uLocal_125 = func_97(vLocal_99, 0);
						SET_BLIP_SPRITE(uLocal_125, 269);
						func_94();
					}
				}
			}
...
var func_97(vector3 vParam0, int iParam3)
{
	var uVar0;
	
	uVar0 = ADD_BLIP_FOR_COORD(vParam0);
	SET_BLIP_SCALE(uVar0, func_98(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
int func_101()
{
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		uLocal_118 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
		if (IS_VEHICLE_DRIVEABLE(uLocal_118, 0))
		{
			if (!IS_PED_INJURED(iLocal_72))
			{
				if (IS_PED_SITTING_IN_VEHICLE(iLocal_72, uLocal_118))
				{
					return 1;
				}
			}
...
var func_102(int iParam0, bool bParam1, int iParam2)
{
	...
	uVar0 = func_103(iParam0, !bParam1, 0);
...
int func_103(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_98(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
int func_107()
{
	if (DOES_ENTITY_EXIST(uLocal_65))
	{
		if (((IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_65, 0) && IS_PED_IN_VEHICLE(iLocal_72, uLocal_65, 0)) && !IS_PED_IN_VEHICLE(iLocal_52[0], uLocal_65, 0)) && !IS_PED_IN_VEHICLE(iLocal_52[1], uLocal_65, 0))
		{
			return 1;
		}
	}
...
void func_113()
{
	if (!iLocal_109)
	{
		if (!IS_PED_INJURED(iLocal_52[0]))
		{
			...
			CLEAR_PED_TASKS(iLocal_52[0]);
			OPEN_SEQUENCE_TASK(&uLocal_136);
			TASK_CLEAR_LOOK_AT(0);
			TASK_COMBAT_PED(0, PLAYER_PED_ID(), 0, 16);
			CLOSE_SEQUENCE_TASK(uLocal_136);
			TASK_PERFORM_SEQUENCE(iLocal_52[0], uLocal_136);
			CLEAR_SEQUENCE_TASK(&uLocal_136);
			SET_PED_KEEP_TASK(iLocal_52[0], 1);
			if (DOES_BLIP_EXIST(uLocal_121[0]))
			{
				SET_BLIP_AS_FRIENDLY(uLocal_121[0], 0);
			}
			SETTIMERB(0);
			iLocal_109 = 1;
		}
	...
	if (!iLocal_110)
	{
		if (DOES_BLIP_EXIST(uLocal_121[1]))
		{
			SET_BLIP_AS_FRIENDLY(uLocal_121[1], 0);
		}
		func_99();
		WAIT(0);
		if (!IS_PED_INJURED(iLocal_52[1]))
		{
			...
			if ((IS_ENTITY_PLAYING_ANIM(iLocal_52[1], "random@homelandsecurity", "idle_cop_ground", 3) || IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_149)) && !IS_PED_RAGDOLL(iLocal_52[1]))
			{
				_SET_PED_RAGDOLL_BLOCKING_FLAGS(iLocal_52[1], 16);
				OPEN_SEQUENCE_TASK(&uLocal_136);
				TASK_PLAY_ANIM(0, "random@homelandsecurity", "idle_to_stand_cop_ground", 4f, -2f, 1400, 8192, 0, 0, 0, 0);
				TASK_COMBAT_PED(0, PLAYER_PED_ID(), 0, 16);
				CLOSE_SEQUENCE_TASK(uLocal_136);
				TASK_PERFORM_SEQUENCE(iLocal_52[1], uLocal_136);
				CLEAR_SEQUENCE_TASK(&uLocal_136);
				SET_PED_KEEP_TASK(iLocal_52[1], 1);
				iLocal_110 = 1;
			}
			else
			{
				TASK_COMBAT_PED(iLocal_52[1], PLAYER_PED_ID(), 0, 16);
				SET_PED_KEEP_TASK(iLocal_52[1], 1);
				iLocal_110 = 1;
			}
		}
	...
	{
		if (((!IS_ENTITY_PLAYING_ANIM(iLocal_52[1], "random@homelandsecurity", "idle_cop_ground", 3) && !IS_ENTITY_PLAYING_ANIM(iLocal_52[1], "random@homelandsecurity", "idle_to_stand_cop_ground", 1)) && GET_SCRIPT_TASK_STATUS(iLocal_52[1], 780511057) != 0) && GET_SCRIPT_TASK_STATUS(iLocal_52[1], 780511057) != 1)
		{
			iLocal_110 = 1;
		}
	}
...
int func_121()
{
	...
	while (iLocal_126 <= 1)
	{
		if (IS_ENTITY_DEAD(iLocal_52[iLocal_126], 0))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_52[iLocal_126], PLAYER_PED_ID(), 1))
			{
				return 1;
			}
		}
	...
	if (!bLocal_138)
	{
		switch (iLocal_51)
		{
			...
			case 5:
				...
				{
					OPEN_SEQUENCE_TASK(&uLocal_136);
					TASK_LOOK_AT_ENTITY(0, iLocal_72, -1, 2054, 2);
					TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_72, -1);
					CLOSE_SEQUENCE_TASK(uLocal_136);
					TASK_PERFORM_SEQUENCE(iLocal_52[0], uLocal_136);
					SET_PED_KEEP_TASK(iLocal_52[0], 1);
					iLocal_115 = 1;
				...
				{
					if (((IS_VEHICLE_DRIVEABLE(uLocal_65, 0) && !IS_PED_INJURED(iLocal_52[0])) && !IS_PED_INJURED(iLocal_52[1])) && !IS_PED_INJURED(iLocal_72))
					{
						if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_149))
						{
							if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_149) > 0.98f)
							{
								if (!func_111())
								{
									if (IS_PED_FACING_PED(iLocal_52[0], iLocal_72, 10f))
									{
										if (func_109(&uLocal_154, "REHOMAU", "REHOM_ARR", 4, 0, 0, 0))
										{
											...
											uLocal_149 = CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
											ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_149, uLocal_65, 0);
											TASK_SYNCHRONIZED_SCENE(iLocal_72, uLocal_149, "random@homelandsecurity", "exit_girl", 2f, -4f, 1, 0, 1148846080, 0);
											TASK_SYNCHRONIZED_SCENE(iLocal_52[0], uLocal_149, "random@homelandsecurity", "exit_cop_gun", 2f, -4f, 1, 0, 1148846080, 0);
											TASK_SYNCHRONIZED_SCENE(iLocal_52[1], uLocal_149, "random@homelandsecurity", "exit_cop_ground", 2f, -4f, 1, 0, 1148846080, 0);
											PLAY_ENTITY_ANIM(uLocal_65, "exit_car", "random@homelandsecurity", 4f, 0, 0, 0, 0, 0);
											iLocal_150 = 1;
											iLocal_127 = GET_GAME_TIMER();
											iLocal_51 = 6;
										}
						...
						if (!func_111())
						{
							if (IS_PED_FACING_PED(iLocal_52[0], iLocal_72, 10f))
							{
								if (func_109(&uLocal_154, "REHOMAU", "REHOM_ARR", 4, 0, 0, 0))
								{
									...
									TASK_SYNCHRONIZED_SCENE(iLocal_52[0], uLocal_149, "random@homelandsecurity", "exit_cop_gun", 2f, -4f, 1, 0, 1148846080, 0);
									TASK_SYNCHRONIZED_SCENE(iLocal_52[1], uLocal_149, "random@homelandsecurity", "exit_cop_ground", 2f, -4f, 1, 0, 1148846080, 0);
									PLAY_ENTITY_ANIM(uLocal_65, "exit_car", "random@homelandsecurity", 2f, 0, 0, 0, 0, 0);
									iLocal_150 = 1;
									iLocal_127 = GET_GAME_TIMER();
									iLocal_51 = 6;
								}
			...
			case 6:
				...
				if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_149))
				{
					if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_149) > 0.45f)
					{
						if ((IS_VEHICLE_DRIVEABLE(uLocal_65, 0) && !IS_PED_INJURED(iLocal_72)) && !IS_PED_INJURED(iLocal_52[0]))
						{
						}
					}
				}
				if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_149))
				{
					if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_149) > 0.9f)
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_65, 0))
						{
							if (!IS_PED_INJURED(iLocal_52[0]))
							{
								TASK_ENTER_VEHICLE(iLocal_52[0], uLocal_65, -1, -1, 1f, 9, 0);
								iLocal_51 = 7;
							}
						}
					}
			...
			case 7:
				...
				if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_149))
				{
					if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_149) > 0.95f)
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_65, 0))
						{
							if (!IS_PED_INJURED(iLocal_52[1]))
							{
								TASK_ENTER_VEHICLE(iLocal_52[1], uLocal_65, -1, 0, 1f, 9, 0);
								SET_PED_KEEP_TASK(iLocal_52[1], 1);
								iLocal_51 = 8;
							}
						}
			...
			case 8:
				func_123();
				if ((IS_VEHICLE_DRIVEABLE(uLocal_65, 0) && !IS_PED_INJURED(iLocal_52[0])) && !IS_PED_INJURED(iLocal_52[1]))
				{
					if ((IS_PED_SITTING_IN_VEHICLE(iLocal_72, uLocal_65) && IS_PED_SITTING_IN_VEHICLE(iLocal_52[0], uLocal_65)) && IS_PED_SITTING_IN_VEHICLE(iLocal_52[1], uLocal_65))
					{
						TASK_VEHICLE_DRIVE_WANDER(iLocal_52[0], uLocal_65, 15f, 786468);
						SET_VEHICLE_SIREN(uLocal_65, 1);
						bLocal_138 = true;
					}
				}
				break;
			...
			case 10:
				if (IS_PED_ARMED(PLAYER_PED_ID(), 6) && IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_52[0], 15f, 15f, 15f, 0, 1, 0))
				{
				...
				if (((iLocal_135 - iLocal_134) > 6000 && IS_PED_ARMED(PLAYER_PED_ID(), 6)) && !iLocal_113)
				{
			...
			case 11:
				...
				if (((iLocal_135 - iLocal_134) > 9000 && IS_PED_ARMED(PLAYER_PED_ID(), 6)) || iLocal_140)
				{
			...
			case 13:
				...
				if (iLocal_141)
				{
					if (!IS_PED_INJURED(iLocal_52[1]))
					{
						if (!IS_PED_INJURED(iLocal_72))
						{
							if (GET_SCRIPT_TASK_STATUS(iLocal_52[1], 1785177548) != 1)
							{
								OPEN_SEQUENCE_TASK(&uLocal_136);
								TASK_CLEAR_LOOK_AT(0);
								TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_72, 0);
								TASK_LOOK_AT_ENTITY(0, iLocal_72, 20000, 0, 2);
								TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, iLocal_72, -1f, 0f, 0f, 1f, -1, 1036831949, 1);
								CLOSE_SEQUENCE_TASK(uLocal_136);
								TASK_PERFORM_SEQUENCE(iLocal_52[1], uLocal_136);
								CLEAR_SEQUENCE_TASK(&uLocal_136);
							}
						}
						else if (GET_SCRIPT_TASK_STATUS(iLocal_52[1], 1785177548) != 1)
						{
							OPEN_SEQUENCE_TASK(&uLocal_136);
							TASK_CLEAR_LOOK_AT(0);
					...
					if (!IS_PED_INJURED(iLocal_72))
					{
						if (GET_SCRIPT_TASK_STATUS(iLocal_72, 1785177548) != 1)
						{
							TASK_SEEK_COVER_FROM_PED(iLocal_72, PLAYER_PED_ID(), -1, 0);
							SET_PED_KEEP_TASK(iLocal_72, 1);
						}
					}
				}
			...
			case 14:
				...
				if (!IS_PED_INJURED(iLocal_52[0]))
				{
					...
					iLocal_115 = 0;
					SETTIMERA(0);
					iLocal_127 = (GET_GAME_TIMER() - 4500);
					iLocal_51 = 5;
				}
			}
	}
				...
				if (IS_PED_IN_VEHICLE(iLocal_72, uLocal_65, 0))
				{
					if (func_124(iLocal_72, 0) == 2)
					{
						if (iLocal_129 < GET_GAME_TIMER())
						{
							...
							iLocal_129 = (GET_GAME_TIMER() + GET_RANDOM_INT_IN_RANGE(3500, 4000));
						}
					}
				}
			}
...
int func_125()
{
	if ((!IS_PED_INJURED(iLocal_52[0]) && !IS_PED_INJURED(iLocal_52[1])) && !IS_PED_INJURED(iLocal_72))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if ((IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_52[0], 1.5f, 1.5f, 5f, 0, 1, 2) || IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_52[1], 2.5f, 2.5f, 5f, 0, 1, 2)) || IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_72, 1.5f, 1.5f, 5f, 0, 1, 2))
			{
				return 1;
			}
		}
		else if ((IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_52[0], 0.5f, 0.5f, 5f, 0, 1, 1) || IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_52[1], 0.5f, 0.5f, 5f, 0, 1, 1)) || IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_72, 0.5f, 0.5f, 5f, 0, 1, 1))
		{
			return 1;
		}
	}
...
int func_126()
{
	if (!IS_PED_INJURED(iLocal_52[1]))
	{
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_52[1], 6f, 6f, 6f, 0, 1, 0))
		{
			if (IS_PED_FACING_PED(iLocal_52[1], PLAYER_PED_ID(), 120f))
			{
				if (!IS_PED_ARMED(PLAYER_PED_ID(), 6))
				{
					return 1;
	...
	if (!IS_PED_INJURED(iLocal_52[0]))
	{
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_52[0], 6f, 6f, 6f, 0, 1, 0))
		{
			if (!IS_PED_ARMED(PLAYER_PED_ID(), 6))
			{
				return 1;
...
int func_127()
{
	if (!IS_PED_INJURED(iLocal_52[1]))
	{
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_52[1], 6f, 6f, 6f, 0, 1, 1))
		{
			if (IS_PED_FACING_PED(iLocal_52[1], PLAYER_PED_ID(), 120f))
			{
				if (IS_PED_ARMED(PLAYER_PED_ID(), 6))
	...
	if (!IS_PED_INJURED(iLocal_52[0]))
	{
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_52[0], 6f, 6f, 6f, 0, 1, 1))
		{
			if (IS_PED_FACING_PED(iLocal_52[0], PLAYER_PED_ID(), 120f))
			{
				if (IS_PED_ARMED(PLAYER_PED_ID(), 6))
				{
					return 1;
...
int func_131()
{
	switch (func_132(&Global_25824, 0, 5, 0, GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
void func_137()
{
	if (DOES_BLIP_EXIST(uLocal_119))
	{
		REMOVE_BLIP(&uLocal_119);
	}
	if (!DOES_BLIP_EXIST(uLocal_120))
	{
		...
		{
			uLocal_120 = func_102(iLocal_72, 0, 145);
			_0x75A16C3DA34F1245(uLocal_120, 0);
		}
	}
	else
	{
		_0x75A16C3DA34F1245(uLocal_120, 1);
	}
	iLocal_126 = 0;
	while (iLocal_126 <= 1)
	{
		if (!DOES_BLIP_EXIST(uLocal_121[iLocal_126]))
		{
			if (!IS_ENTITY_DEAD(iLocal_52[iLocal_126], 0))
			{
				uLocal_121[iLocal_126] = func_102(iLocal_52[iLocal_126], 0, 145);
				_0x75A16C3DA34F1245(uLocal_121[iLocal_126], 0);
			}
		}
		else
		{
			_0x75A16C3DA34F1245(uLocal_121[iLocal_126], 1);
		}
		iLocal_126++;
	}
}
...
int func_138()
{
	...
	if (!bLocal_133)
	{
		...
		if (!IS_PED_INJURED(iLocal_52[0]) && !IS_PED_INJURED(iLocal_52[1]))
		{
			if (IS_ENTITY_AT_ENTITY(iLocal_52[0], PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0))
			{
				if (IS_PED_ARMED(PLAYER_PED_ID(), 7) || (IS_PED_IN_MELEE_COMBAT(PLAYER_PED_ID()) && IS_ENTITY_AT_ENTITY(iLocal_52[0], PLAYER_PED_ID(), 6f, 6f, 6f, 0, 1, 0)))
				{
					...
					{
						if (_CAN_PED_SEE_PED(iLocal_52[0], PLAYER_PED_ID()) || _CAN_PED_SEE_PED(iLocal_52[1], PLAYER_PED_ID()))
						{
							iLocal_50 = 2;
							return 1;
						}
		...
		if (DOES_ENTITY_EXIST(uLocal_65))
		{
			if (!IS_ENTITY_DEAD(uLocal_65, 0))
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_65, PLAYER_PED_ID(), 1))
				{
					iLocal_50 = 2;
					return 1;
				}
				if (IS_PED_ON_SPECIFIC_VEHICLE(PLAYER_PED_ID(), uLocal_65) && GET_ENTITY_SPEED(PLAYER_PED_ID()) > 0.1f)
				{
					iLocal_50 = 2;
					return 1;
				}
				...
				{
					if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_65, uVar0, 1))
					{
						iLocal_50 = 2;
						return 1;
					}
			...
			else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_65, PLAYER_PED_ID(), 1))
			{
				iLocal_50 = 2;
				return 1;
			}
		...
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if (IS_PED_IN_MODEL(PLAYER_PED_ID(), joaat("towtruck")) || IS_PED_IN_MODEL(PLAYER_PED_ID(), joaat("towtruck2")))
			{
				...
				if (!IS_ENTITY_DEAD(uLocal_65, 0))
				{
					if (IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uVar1, uLocal_65))
					{
						iLocal_50 = 2;
						return 1;
					}
		...
		if (!IS_PED_INJURED(iLocal_52[0]) || IS_ENTITY_DEAD(iLocal_52[0], 0))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_52[0], PLAYER_PED_ID(), 1))
			{
				iLocal_50 = 5;
				return 1;
			}
			if (IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), iLocal_52[0]) && GET_ENTITY_SPEED(PLAYER_PED_ID()) > 0.1f)
			{
				iLocal_50 = 5;
				return 1;
			}
			if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_52[0], uVar0, 1))
				{
					iLocal_50 = 5;
					return 1;
				}
		...
		if (!IS_PED_INJURED(iLocal_52[1]) || IS_ENTITY_DEAD(iLocal_52[1], 0))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_52[1], PLAYER_PED_ID(), 1))
			{
				iLocal_50 = 5;
				return 1;
			}
			if (IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), iLocal_52[1]) && GET_ENTITY_SPEED(PLAYER_PED_ID()) > 0.1f)
			{
				iLocal_50 = 5;
				return 1;
			}
			if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_52[1], uVar0, 1))
				{
					iLocal_50 = 5;
					return 1;
				}
		...
		if (!IS_ENTITY_DEAD(iLocal_72, 0))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_72, PLAYER_PED_ID(), 1))
			{
				iLocal_50 = 4;
				return 1;
			}
			if (IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), iLocal_72))
			{
				iLocal_50 = 4;
				return 1;
			}
			if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_72, uVar0, 1))
				{
					iLocal_50 = 4;
					return 1;
				}
		...
		else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_72, PLAYER_PED_ID(), 1))
		{
			iLocal_50 = 4;
			return 1;
		}
...
void func_139()
{
	...
	SET_PED_PATHS_IN_AREA(419f, -1387f, 28f, 427f, -1370f, 29f, 0, 0);
	SET_BIT(&uLocal_131, 5);
	iLocal_72 = CREATE_PED(26, iLocal_76, vLocal_73, 0, 1, 1);
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_72, 1);
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_76);
	SET_PED_CAN_BE_TARGETTED(iLocal_72, 0);
	SET_PED_CONFIG_FLAG(iLocal_72, 185, 1);
	SET_PED_CONFIG_FLAG(iLocal_72, 206, 1);
	SET_PED_FLEE_ATTRIBUTES(iLocal_72, 2, 0);
	STOP_PED_SPEAKING(iLocal_72, 1);
	SET_AMBIENT_VOICE_NAME(iLocal_72, "REHOMGirl");
	SET_PED_COMPONENT_VARIATION(iLocal_72, 0, 2, 1, 0);
	SET_PED_COMPONENT_VARIATION(iLocal_72, 2, 0, 0, 0);
	SET_PED_COMPONENT_VARIATION(iLocal_72, 3, 1, 4, 0);
	SET_PED_COMPONENT_VARIATION(iLocal_72, 4, 0, 5, 0);
	SET_PED_COMPONENT_VARIATION(iLocal_72, 6, 1, 0, 0);
	ADD_RELATIONSHIP_GROUP("OFFICERS", &uLocal_153);
	iLocal_126 = 0;
	while (iLocal_126 <= 1)
	{
		iLocal_52[iLocal_126] = CREATE_PED(6, iLocal_70, vLocal_55[iLocal_126 /*3*/], fLocal_62[iLocal_126], 1, 1);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_52[iLocal_126], 1);
		SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_70);
		SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_52[iLocal_126], uLocal_153);
		SET_PED_CONFIG_FLAG(iLocal_52[iLocal_126], 42, 1);
		iLocal_126++;
	}
	GIVE_WEAPON_TO_PED(iLocal_52[0], joaat("weapon_pistol"), -1, 1, 1);
	GIVE_WEAPON_TO_PED(iLocal_52[1], joaat("weapon_pistol"), -1, 0, 1);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_153, 1862763509);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_153, -1533126372);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, uLocal_153);
	uLocal_65 = CREATE_VEHICLE(iLocal_71, vLocal_66, fLocal_69, 1, 1, 0);
	SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_71, 1);
	SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_65, 1084227584);
	SET_VEHICLE_SIREN(uLocal_65, 1);
	...
	if (func_104() == 0)
	{
		func_140(&uLocal_154, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
	}
	else if (func_104() == 1)
	{
		func_140(&uLocal_154, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	uLocal_149 = CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
	ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_149, uLocal_65, 0);
	TASK_SYNCHRONIZED_SCENE(iLocal_72, uLocal_149, "random@homelandsecurity", "idle_girl", 4f, -2f, 1, 0, 1148846080, 0);
	TASK_SYNCHRONIZED_SCENE(iLocal_52[0], uLocal_149, "random@homelandsecurity", "idle_cop_gun", 4f, -2f, 1, 0, 1148846080, 0);
	TASK_SYNCHRONIZED_SCENE(iLocal_52[1], uLocal_149, "random@homelandsecurity", "idle_cop_ground", 4f, -2f, 1, 0, 1148846080, 0);
	SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_149, 1);
}

void func_140(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_142(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_11() == 0)
		{
			uVar0 = func_45(func_143(iParam0), -1, 0);
			CLEAR_BIT(&uVar0, iParam1);
			func_41(func_143(iParam0), uVar0, -1, 1, 0);
		}
	}
	else
	{
...
int func_145(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_11() == 0)
		{
			return IS_BIT_SET(func_45(func_143(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_146()
{
	...
	REQUEST_MODEL(iLocal_71);
	REQUEST_ANIM_DICT("random@homelandsecurity");
	if (((HAS_MODEL_LOADED(iLocal_76) && HAS_MODEL_LOADED(iLocal_70)) && HAS_MODEL_LOADED(iLocal_71)) && HAS_ANIM_DICT_LOADED("random@homelandsecurity"))
	{
		bLocal_104 = true;
	}
	else
...
int func_148()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		if (VMAG2(GET_ENTITY_VELOCITY(PLAYER_PED_ID())) > 1369f && !func_159())
		{
			return 0;
		}
	}
...
int func_161()
{
	if ((Global_106554 == func_30() && GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
int func_165(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_179(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_182()
{
	...
	func_188(&uVar0, GET_CLOCK_SECONDS());
	func_187(&uVar0, GET_CLOCK_MINUTES());
	func_186(&uVar0, GET_CLOCK_HOURS());
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_199()) || Global_105612) || Global_25767) || func_198()) || func_79(8, -1)) || func_197()) || func_196()) || func_195()) || func_194()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_199()) || Global_25767) || func_198()) || func_79(8, -1)) || func_195()) || func_197()) || func_196()) || func_194()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_199()) || Global_105612) || Global_25767) || func_198()) || func_79(8, -1)) || func_195()) || func_197()) || func_196()) || func_194()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_199()) || Global_105612) || Global_25767) || func_198()) || func_79(8, -1)) || func_197()) || func_196()) || func_194()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_199() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_79(8, -1)) || func_194()) || func_193()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_199()) || Global_25767) || func_198()) || func_79(8, -1)) || func_196()) || func_195()) || func_194()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_199()) || func_196()) || Global_105612) || Global_25767) || func_198()) || Global_37584) || func_79(8, -1)) || func_195()) || func_193()) || func_194()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_199()) || Global_105612) || Global_25767) || func_198()) || func_79(8, -1)) || func_195()) || func_193()) || func_197()) || func_196()) || func_194())
						{
							return 0;
						}
						break;
...
void func_207()
{
	...
	if (iLocal_102)
	{
		...
		if (iLocal_103)
		{
			...
			SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_71, 0);
		}
		iVar0 = 0;
		while (iVar0 < iLocal_52)
		{
			if (DOES_ENTITY_EXIST(iLocal_52[iVar0]))
			{
				if (!IS_PED_INJURED(iLocal_52[iVar0]))
				{
					if (IS_PED_INJURED(PLAYER_PED_ID()))
					{
						TASK_AIM_GUN_AT_COORD(iLocal_52[iVar0], func_219(PLAYER_ID()), -1, 0, 0);
						SET_PED_KEEP_TASK(iLocal_52[iVar0], 1);
						if (!IS_PED_INJURED(iLocal_72))
						{
							TASK_COWER(iLocal_72, -1);
							SET_PED_KEEP_TASK(iLocal_72, 1);
					...
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_52[iVar0], 0);
				}
				SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_52[iVar0]));
			}
			iVar0++;
		...
		if (DOES_ENTITY_EXIST(iLocal_72))
		{
			if (!IS_PED_INJURED(iLocal_72))
			{
				SET_PED_CONFIG_FLAG(iLocal_72, 317, 1);
				if (IS_PED_IN_GROUP(iLocal_72))
				{
					REMOVE_PED_FROM_GROUP(iLocal_72);
				}
				...
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_72, 0);
			}
			SET_PED_AS_NO_LONGER_NEEDED(&iLocal_72);
		}
		if (DOES_ENTITY_EXIST(uLocal_65))
		{
			SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_65);
		}
