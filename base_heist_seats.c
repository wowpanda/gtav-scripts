...
void func_1()
{
	MISC::CLEAR_BIT(&Global_1573960, 1);
	func_3(&Local_47);
	func_2();
}
...
{
	func_19(&Local_47);
	if (Global_1589140 == PLAYER::PLAYER_ID() && !MISC::IS_BIT_SET(Global_1681994[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*39*/].f_27, 5))
	{
		...
		{
			MISC::SET_BIT(&Global_1573960, 1);
			if ((((((iLocal_64 == 0 && !MISC::IS_BIT_SET(Global_1681994[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*39*/].f_27, 3)) && !func_16()) && !HUD::IS_PAUSE_MENU_ACTIVE()) && !func_15(0)) && !func_14()) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 225))
			{
				func_12(&Local_47);
			}
		}
	...
	iLocal_64 = 0;
	if (MISC::IS_BIT_SET(Global_1681994[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*39*/].f_27, 3))
	{
...
void func_19(int iParam0)
{
	...
	switch (iParam0->f_421.f_4)
	{
		...
		case 2:
			if (func_54(PLAYER::PLAYER_PED_ID(), iParam0[iParam0->f_421.f_2 /*14*/]))
			{
		...
		case 4:
			...
			if (Var2 != 3)
			{
				vVar3 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_43(iParam0), func_42(iParam0), 0, 2) };
				vVar4 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_43(iParam0), func_42(iParam0), 0, 2) };
				iVar5 = vVar4.z;
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				iParam0->f_421.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_43(iParam0), func_42(iParam0), 2, true, false, 1065353216, 0, 1065353216);
...
void func_31(var uParam0)
{
	...
	if (((func_21(uParam0) != uParam0->f_421.f_8.f_1 && uParam0->f_421.f_8.f_2 < 6) && uParam0->f_421.f_8.f_2 != 3) && uParam0->f_421.f_8.f_2 != 4)
	{
		...
		uParam0->f_421.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_43(uParam0), func_42(uParam0), 2, true, false, 1065353216, 0, 1065353216);
...
int func_51(var uParam0)
{
	...
	while (iVar0 < NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if ((iVar1 != PLAYER::PLAYER_ID() && func_52(iVar1, 1, 1)) && func_54(PLAYER::GET_PLAYER_PED(iVar1), uParam0[uParam0->f_421.f_2 /*14*/]))
			{
				return 1;
			}
		}
...
bool func_54(int iParam0, var uParam1)
{
...
int func_55(var uParam0)
{
	...
	while (iVar0 < 5)
	{
		if (func_54(PLAYER::PLAYER_PED_ID(), uParam0[uParam0->f_421.f_2 /*14*/]))
		{
			return 1;
		}
		else
...
void func_58(var uParam0)
{
	...
	else if (uParam0->f_421.f_4 > 4)
	{
		...
		PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_59(uParam0));
...
void func_60(var uParam0)
{
	...
	func_61(&(uParam0->f_421), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0));
	func_61(&(uParam0->f_421), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1));
	func_61(&(uParam0->f_421), 0, func_15(0));
	func_61(&(uParam0->f_421), 2, BRAIN::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
...
int func_64()
{
	...
	if (func_65() != 0)
	{
		if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_65()) == 0)
		{
			return 1;
		}
	}
...
int func_75()
{
	if (Global_1589140 != func_63())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_heist_seats", Global_1589140, 1, 0))
		{
			return 0;
		}
...
int func_81(int iParam0)
{
	if (iParam0 != func_63())
	{
		...
		{
			if (MISC::IS_BIT_SET(Global_1681994[iParam0 /*39*/].f_27, 3))
			{
				return 1;
			}
		}
...
void func_82(int iParam0, vector3 vParam1, float fParam2, vector3 vParam3, vector3 vParam4)
{
