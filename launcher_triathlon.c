...
void __EntryFunction__()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_117(uLocal_94, 4194304))
	{
		if (iLocal_105 != 263)
		{
		...
		if (DOES_ENTITY_EXIST(uLocal_85) && !IS_ENTITY_DEAD(uLocal_85, 0))
		{
			...
			switch (iLocal_95)
			{
				...
				case 3:
					...
					{
						Local_69 = { Local_53 };
						bVar3 = !func_117(uLocal_94, 64);
						func_121(&uLocal_94, 128);
						if (!func_99(3) && !Global_93716)
						{
							if (func_117(uLocal_94, 2097152))
							{
								if ((!func_117(uLocal_94, 1) || !DOES_ENTITY_EXIST(func_98())) && !Global_93716)
								{
									func_110(10);
									break;
								}
						...
						if (bVar3)
						{
							...
							if (fLocal_93 < ((fLocal_117 * fLocal_117) + 4f))
							{
								if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
								{
									func_85(&uLocal_94, 128);
									bVar3 = false;
									if (!func_117(uLocal_94, 1024))
									{
										func_78("MG_GET_ON_FOOT", -1);
										func_85(&uLocal_94, 1024);
									}
								}
								else if (func_117(uLocal_94, 1024))
								{
									func_121(&uLocal_94, 1024);
							...
							if (bVar3)
							{
								...
								if (func_77(uLocal_86))
								{
									...
									else if (!func_117(uLocal_94, 2048) || !IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_75(&iLocal_96);
				...
				case 6:
					...
					if (func_117(uLocal_94, 2097152))
					{
						if (!func_99(3) && !IS_THREAD_ACTIVE(uLocal_52))
						{
							func_110(10);
						}
					}
					...
					{
						PLAYSTATS_ODDJOB_DONE(ROUND((func_32(&uLocal_107) * 1000f)), iLocal_99, 0);
						func_31(&uLocal_107);
						func_121(&uLocal_94, 256);
						func_30();
						if (bVar0)
						{
							func_121(&uLocal_94, 2);
						}
						...
						if (iLocal_99 != -1)
						{
							if (func_117(Global_105216, 0))
							{
								PLAYSTATS_MISSION_CHECKPOINT(func_39(iLocal_99), 0, Global_93719, 0);
								func_28(func_39(iLocal_99), 0, Global_93719, 1, 0);
							}
							else
							{
								PLAYSTATS_MISSION_CHECKPOINT(func_39(iLocal_99), 0, Global_93719, 0);
								func_28(func_39(iLocal_99), 0, Global_93719, 0, 0);
							}
						}
						func_4();
						func_121(&Global_105216, 0);
...
void func_4()
{
	...
	{
		SET_ENTITY_AS_MISSION_ENTITY(uLocal_129, 1, 1);
	}
	if (DOES_ENTITY_EXIST(uLocal_127))
	{
		SET_ENTITY_AS_MISSION_ENTITY(uLocal_127, 1, 1);
	}
	if (DOES_ENTITY_EXIST(uLocal_128))
	{
		SET_ENTITY_AS_MISSION_ENTITY(uLocal_128, 1, 1);
	}
	uLocal_130 = ADD_SCENARIO_BLOCKING_AREA((vLocal_121.x - 3f), (vLocal_121.y - 3f), (vLocal_121.z - 3f), (vLocal_121.x + 3f), (vLocal_121.y + 3f), (vLocal_121.z + 3f), 0, 1, 1, 1);
	func_7();
	func_5();
}
...
void func_7()
{
	if (func_117(Global_106565.f_20005.f_9, 1))
	{
		...
		if (iLocal_135 == Global_106565.f_20005.f_8)
		{
			if (Global_106565.f_20005.f_8 != 2)
			{
				...
				if (iLocal_132 && Global_106565.f_20005.f_8 == 2)
				{
					func_19(62);
				}
				else
...
void func_8(int iParam0, bool bParam1)
{
	...
	if (bParam1 != IS_BIT_SET(Global_26140[iVar0 /*23*/].f_11, 13))
	{
		SET_BIT(&(Global_26140[iVar0 /*23*/].f_11), 18);
	}
	if (bParam1)
	{
		SET_BIT(&(Global_26140[iVar0 /*23*/].f_11), 13);
	}
	else
	{
		CLEAR_BIT(&(Global_26140[iVar0 /*23*/].f_11), 13);
	}
}
...
void func_19(int iParam0)
{
	...
	if (iVar1 < 3)
	{
		CLEAR_BIT(&(Global_106565.f_20404.f_150[iVar1]), iVar0);
		CLEAR_BIT(&(Global_106565.f_20404.f_150[iVar1]), iVar0);
	}
}
...
void func_28(char* sParam0, int iParam1, var uParam2, int iParam3, int iParam4)
{
...
void func_45()
{
	...
	if (bLocal_131)
	{
		...
		{
			if (DOES_NAVMESH_BLOCKING_OBJECT_EXIST(iLocal_136[iVar0]))
			{
				REMOVE_NAVMESH_BLOCKING_OBJECT(iLocal_136[iVar0]);
			}
			iVar0++;
		}
...
var func_46()
{
	...
	Var0.f_6 = uLocal_127;
	Var0.f_7 = uLocal_128;
	uVar8 = START_NEW_SCRIPT_WITH_ARGS(&Local_53, &Var0, 8, iLocal_97);
...
void func_60()
{
	...
	else if ((IS_PED_INJURED(uLocal_129) || IS_SHOCKING_EVENT_IN_SPHERE(89, GET_ENTITY_COORDS(uLocal_129, 1), 40f)) || IS_SHOCKING_EVENT_IN_SPHERE(116, GET_ENTITY_COORDS(uLocal_129, 1), 40f))
	{
		func_78("TRI_DEATH", -1);
		iVar0 = iLocal_105;
		func_72(iLocal_105);
	...
	if (DOES_ENTITY_EXIST(uLocal_129))
	{
		if (!IS_ENTITY_DEAD(uLocal_129, 0) && !IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
		{
			if (VDIST2(GET_ENTITY_COORDS(uLocal_129, 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) <= 144f)
			{
				if (GET_SCRIPT_TASK_STATUS(uLocal_129, 150319005) != 1)
				{
					TASK_LOOK_AT_ENTITY(uLocal_129, PLAYER_PED_ID(), -1, 0, 2);
				}
			}
			else if (GET_SCRIPT_TASK_STATUS(uLocal_129, 150319005) == 1)
			{
				TASK_CLEAR_LOOK_AT(uLocal_129);
			}
		}
	}
	if (bLocal_131)
...
void func_61()
{
	...
	if (GET_GAME_TIMER() > iLocal_134 && fLocal_93 < (30f * 30f))
	{
		iLocal_134 = GET_GAME_TIMER() + 10000;
		if (GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) <= 0.5f)
		{
			...
			iVar13 = GET_PED_NEARBY_PEDS(PLAYER_PED_ID(), &uVar2, iVar0);
			iVar15 = 0;
			while (iVar15 < iVar13)
			{
				if (!IS_PED_INJURED(uVar2[iVar15]) && !DOES_ENTITY_EXIST(uVar14))
				{
					if (GET_ENTITY_MODEL(uVar2[iVar15]) == joaat("a_m_y_roadcyc_01"))
					{
						uVar14 = uVar2[iVar15];
					}
				}
			...
			if (DOES_ENTITY_EXIST(uVar14) && !IS_PED_INJURED(uVar14))
			{
				...
				StringIntConCat(&cVar16, GET_RANDOM_INT_IN_RANGE(1, 5), 32);
				func_62(uVar14, "TRIATHLON_WARMUP", &cVar16, 6);
			}
		}
	}
}
...
{
	_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, cParam2, func_63(iParam3), 0);
}
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_96()) || Global_105612) || Global_25767) || func_95()) || func_81(8, -1)) || func_94()) || func_93()) || func_92()) || func_83()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_96()) || Global_25767) || func_95()) || func_81(8, -1)) || func_92()) || func_94()) || func_93()) || func_83()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_96()) || Global_105612) || Global_25767) || func_95()) || func_81(8, -1)) || func_92()) || func_94()) || func_93()) || func_83()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_96()) || Global_105612) || Global_25767) || func_95()) || func_81(8, -1)) || func_94()) || func_93()) || func_83()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_96() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_81(8, -1)) || func_83()) || func_91()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_96()) || Global_25767) || func_95()) || func_81(8, -1)) || func_93()) || func_92()) || func_83()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_96()) || func_93()) || Global_105612) || Global_25767) || func_95()) || Global_37584) || func_81(8, -1)) || func_92()) || func_91()) || func_83()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_96()) || Global_105612) || Global_25767) || func_95()) || func_81(8, -1)) || func_92()) || func_91()) || func_94()) || func_93()) || func_83())
						{
							return 0;
						}
						break;
...
void func_102()
{
	...
	if (bLocal_131)
	{
		CLEAR_AREA_OF_OBJECTS(vLocal_118, 25f, 0);
		if (DOES_SCENARIO_GROUP_EXIST("Triathlon_1_Start") && iLocal_135 == 1)
		{
			SET_SCENARIO_GROUP_ENABLED("Triathlon_1_Start", 1);
		}
		if (DOES_SCENARIO_GROUP_EXIST("Triathlon_2_Start") && iLocal_135 == 0)
		{
			SET_SCENARIO_GROUP_ENABLED("Triathlon_2_Start", 1);
		}
		if (DOES_SCENARIO_GROUP_EXIST("Triathlon_3_Start") && iLocal_135 == 2)
		{
			SET_SCENARIO_GROUP_ENABLED("Triathlon_3_Start", 1);
		}
		if (!DOES_ENTITY_EXIST(uLocal_125))
		{
			vVar1 = { func_106(iLocal_135 == 1, 2434.162f, 4282.774f, 35.5112f, func_106(iLocal_135 == 0, -1231.203f, -2051.531f, 12.9317f, func_106(iLocal_135 == 2, 1591.099f, 3814.026f, 33.2697f, 0f, 0f, 0f))) };
			fVar0 = func_105(iLocal_135 == 1, 264.0724f, func_105(iLocal_135 == 0, 256.2876f, func_105(iLocal_135 == 2, 222.6197f, 0f)));
			uLocal_125 = CREATE_OBJECT(joaat("prop_tri_table_01"), vVar1, 1, 1, 0);
			SET_ENTITY_HEADING(uLocal_125, fVar0);
			FREEZE_ENTITY_POSITION(uLocal_125, 1);
			SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_tri_table_01"));
		}
		if (!DOES_ENTITY_EXIST(uLocal_126))
		{
			vLocal_121 = { func_106(iLocal_135 == 1, 2434.955f, 4282.711f, 35.5333f, func_106(iLocal_135 == 0, -1230.361f, -2051.761f, 12.918f, func_106(iLocal_135 == 2, 1591.686f, 3813.401f, 33.3371f, 0f, 0f, 0f))) };
			fVar0 = func_105(iLocal_135 == 1, 264.3256f, func_105(iLocal_135 == 0, 253.044f, func_105(iLocal_135 == 2, 220.7912f, 0f)));
			uLocal_126 = CREATE_OBJECT(joaat("prop_chair_08"), vLocal_121, 1, 1, 0);
			SET_ENTITY_HEADING(uLocal_126, fVar0);
			FREEZE_ENTITY_POSITION(uLocal_126, 1);
			SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_chair_08"));
		}
		if (!DOES_ENTITY_EXIST(uLocal_127))
		{
			vVar1.z = (vVar1.z + 0.54f);
			uLocal_127 = CREATE_OBJECT(joaat("p_cs_clipboard"), vVar1, 1, 1, 0);
			SET_ENTITY_ROTATION(uLocal_127, -90f, 0f, 90f, 2, 0);
			ACTIVATE_PHYSICS(uLocal_127);
		...
		if (!DOES_ENTITY_EXIST(uLocal_129))
		{
			...
			uLocal_129 = CREATE_PED(4, joaat("a_m_y_roadcyc_01"), vLocal_121, fVar0, 1, 1);
			SET_PED_COMPONENT_VARIATION(uLocal_129, 0, 1, 0, 0);
			SET_PED_COMPONENT_VARIATION(uLocal_129, 4, 0, 3, 0);
			SET_PED_COMPONENT_VARIATION(uLocal_129, 3, 0, 2, 0);
		...
		if (!DOES_ENTITY_EXIST(uLocal_128))
		{
			...
			uLocal_128 = CREATE_OBJECT(joaat("prop_pencil_01"), vVar4, 1, 1, 0);
			SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_pencil_01"));
		}
		if (!IS_PED_INJURED(uLocal_129))
		{
			if (DOES_SCENARIO_EXIST_IN_AREA(vLocal_121, 3f, 1))
			{
				TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(uLocal_129, vLocal_121, 2f, 0);
			}
			else
			{
				switch (iLocal_135)
				...
				TASK_START_SCENARIO_AT_POSITION(uLocal_129, "PROP_HUMAN_SEAT_CHAIR", vVar7, fVar10, -1, 0, 1);
			}
		}
		iVar18 = 0;
		while (iVar18 < iLocal_136)
		{
			func_104(iLocal_135, iVar18, &vVar11, &vVar14, &uVar17);
			if (!func_103(vVar11))
			{
				iLocal_136[iVar18] = ADD_NAVMESH_BLOCKING_OBJECT(vVar11, vVar14, uVar17, 0, 7);
			}
			iVar18++;
		}
	}
...
void func_118()
{
	...
	if (Global_106565.f_20005.f_8 < iLocal_135)
	{
		func_85(&uLocal_94, 8388608);
	}
}
...
int func_119(vector3 vParam0, var uParam3)
{
	...
	fVar11 = VDIST2(vVar1[0 /*3*/], vParam0);
	fVar13 = 0f;
	iVar12 = 1;
	while (iVar12 <= (3 - 1))
	{
		fVar13 = VDIST2(vParam0, vVar1[iVar12 /*3*/]);
		if (fVar13 < fVar11)
		{
			iVar0 = iVar12;
			fVar11 = fVar13;
...
void func_125()
{
	...
	if (fLocal_110 > (fLocal_102 * fLocal_102))
	{
		if (DOES_ENTITY_EXIST(uLocal_124))
		{
			DELETE_OBJECT(&uLocal_124);
		}
	}
	func_126(1, -1);
	iVar0 = 0;
	...
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_130, 0);
	if (!iLocal_133)
	{
