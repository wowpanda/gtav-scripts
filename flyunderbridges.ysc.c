			...
			if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
			{
				...
				switch (iLocal_27)
				{
					case 0:
						...
						{
							if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), vLocal_39[iLocal_31 /*3*/]) < fLocal_40)
							{
								if (PED::IS_PED_IN_ANY_HELI(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_IN_ANY_PLANE(AUDIO::_0x0626A247D2405330()))
								{
									...
									if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 0))
									{
										if (func_14())
										{
											if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_41, vLocal_42, fLocal_45, 0, true, 0))
											{
												bLocal_33 = true;
												iLocal_27 = 1;
											}
											if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_43, vLocal_44, fLocal_45, 0, true, 0))
											{
												bLocal_34 = true;
												iLocal_27 = 1;
											}
					...
					case 1:
						if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
						{
							...
							else if (!ENTITY::IS_ENTITY_IN_AIR(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
							{
								func_13();
							}
							if (bLocal_33)
							{
								if (iLocal_37)
								{
									if (iLocal_36)
									{
										if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_41, vLocal_42, fLocal_45, 0, true, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_43, vLocal_44, fLocal_45, 0, true, 0))
										{
											func_13();
											func_1();
									...
									else if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_41, vLocal_42, fLocal_45, 0, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_43, vLocal_44, fLocal_45, 0, true, 0))
									{
										iLocal_36 = 1;
									}
									else if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_41, vLocal_42, fLocal_45, 0, true, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_43, vLocal_44, fLocal_45, 0, true, 0))
...
void func_1()//Position - 0x53A
{
	...
	if (iLocal_31 < 32)
	{
		bVar0 = INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_2725.f_60, iLocal_31);
	}
	else if (iLocal_31 < 64)
	{
		bVar0 = INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_2725.f_61, (iLocal_31 - 32));
	}
	else
	{
		bVar0 = INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_2725.f_62, (iLocal_31 - 64));
	}
	if (bVar0)
	{
	}
	else
	{
		...
		if (iLocal_31 < 32)
		{
			MISC::SET_BIT(&(Global_19E56.f_2725.f_60), iLocal_31);
		}
		else if (iLocal_31 < 64)
		{
			MISC::SET_BIT(&(Global_19E56.f_2725.f_61), (iLocal_31 - 32));
		}
		else
		{
			MISC::SET_BIT(&(Global_19E56.f_2725.f_62), (iLocal_31 - 64));
		}
		Global_15EAC = 1;
		func_29();
		iLocal_29 = 1;
...
void func_9()//Position - 0x813
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_12(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_10(iVar0) && (!func_52(14) || Global_19A3D))
			{
...
int func_14()//Position - 0x99D
{
	if (bLocal_38)
	{
		...
		{
			if (ENTITY::GET_ENTITY_UPRIGHT_VALUE(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)) > -0.6f && ENTITY::GET_ENTITY_UPRIGHT_VALUE(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)) < 0.6f)
			{
				return 1;
			}
		}
...
void func_15()//Position - 0x9EF
{
	if ((MISC::GET_GAME_TIMER() - iLocal_48) > 500)
	{
		if (iLocal_31 == 29)
		{
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_2725.f_60, iLocal_31))
			{
				bLocal_47 = true;
			}
		}
...
void func_16()//Position - 0xA29
{
	switch (iLocal_28)
	{
		case 0:
			if (iLocal_29 && !bLocal_47)
			{
				if (!func_22())
				{
					...
					{
						func_21("FU_KNIFE");
						GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(15);
					}
					else
					{
						func_21("FU_TITLE");
					...
					GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(func_29());
					CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
					iLocal_32 = func_29();
					Global_645B = iLocal_32;
					SYSTEM::SETTIMERB(0);
					unk_0x1190AB7024CBD8CB(4294967295, "UNDER_THE_BRIDGE", "HUD_AWARDS", 1);
				}
				iLocal_28 = 1;
			}
			break;
		...
		case 1:
			if ((((((SYSTEM::TIMERB() > 3750 || CAM::IS_SCREEN_FADED_OUT()) || !PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246())) || func_22()) || !PLAYER::IS_PLAYER_CONTROL_ON(CAM::_0xDC9DA9E8789F5246())) || func_20()) || func_19())
			{
		...
		case 2:
			if ((((((SYSTEM::TIMERB() > 500 || CAM::IS_SCREEN_FADED_OUT()) || !PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246())) || func_22()) || !PLAYER::IS_PLAYER_CONTROL_ON(CAM::_0xDC9DA9E8789F5246())) || func_20()) || func_19())
			{
				iLocal_28 = 3;
			}
			else
...
void func_25()//Position - 0xCFF
{
	...
	{
		if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_2725.f_61, (iLocal_31 - 32)))
		{
			bLocal_47 = true;
		}
	}
	else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_2725.f_62, (iLocal_31 - 64)))
	{
		bLocal_47 = true;
	}
	if (bLocal_47)
...
void func_44()//Position - 0x323D
{
	...
	{
		func_47(13, SYSTEM::FLOOR(Global_19E56.f_27B6.f_F0D));
	}
...
int func_47(int iParam0, int iParam1)//Position - 0x3C68
{
	int iVar0;
...
int func_48()//Position - 0x3CB9
{
	...
	while (iVar1 < 32)
	{
		if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_2725.f_60, iVar1))
		{
			if (func_49(iVar1))
			{
				iVar0++;
		...
		if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_2725.f_61, iVar1))
		{
			if (func_49(iVar1 + 32))
			{
				iVar0++;
		...
		if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_2725.f_62, iVar1))
		{
			if (func_49(iVar1 + 64))
			{
				iVar0++;
...
int func_49(int iParam0)//Position - 0x3D3D
{
	switch (iParam0)
	{
		case 33:
...
bool func_51(bool bParam0)//Position - 0x3E35
{
...
bool func_52(int iParam0)//Position - 0x3E60
{
