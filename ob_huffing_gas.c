...
void func_4()
{
	...
	switch (iLocal_277)
	{
		...
		case 2:
			...
			BRAIN::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_281, func_69(), func_39(0), 1000f, -8f, 0, 0, 1148846080, 0);
		...
		case 5:
			...
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_281))
			{
				...
				if (func_25())
				{
					fLocal_284 = "ig_8_wake_up_front_player";
					sLocal_285 = "ig_8_wake_up_front_cam";
				}
				else
				{
					fLocal_284 = "ig_8_wake_up_right_player";
				...
				BRAIN::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_281, func_69(), fLocal_284, 1000f, -4f, 0, 0, 1148846080, 0);
				if (PED::_0x7F2F4F13AC5257EF(iLocal_281))
				{
...
void func_20()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_23(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_21(iVar0) && (!func_13(14) || Global_104171))
			{
...
void func_27(float fParam0)
{
	...
	while (iVar0 < 9)
	{
		if (func_33(&(Global_105220.f_18074.f_175[iVar0 /*19*/].f_5)))
		{
			func_28(&(Global_105220.f_18074.f_175[iVar0 /*19*/].f_5), (fParam0 * 60f));
		}
		iVar0++;
	}
	iVar1 = 0;
	while (iVar1 < 6)
	{
		if (func_33(&(Global_105220.f_18074.f_362[iVar1 /*3*/])))
		{
			func_28(&(Global_105220.f_18074.f_362[iVar1 /*3*/]), (fParam0 * 60f));
		}
		iVar1++;
	}
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if ((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID())) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				...
				{
					if ((Global_90028 && Global_90029) || func_60())
					{
						return 0;
					}
...
int func_66()
{
	...
	while (!STREAMING::HAS_ANIM_DICT_LOADED(fVar0))
	{
		SYSTEM::WAIT(0);
	}
	return 1;
...
int func_67()
{
	...
	if (!iLocal_278)
	{
		...
		if (!TASK::IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE(iLocal_41))
		{
			return 0;
		}
	}
	...
	switch (iLocal_40)
	{
		...
		case joaat("prop_bong_01"):
			...
			if (func_19() == 0)
			{
				...
				if (((((Global_88106[0] == 5 || Global_88106[0] == 21) || Global_88106[0] == 20) || Global_88106[0] == 16) || Global_88106[0] == 18) || Global_88106[0] == 9)
				{
					return 0;
				}
				if (((((Global_88106[0] == 6 || Global_88106[0] == 7) || Global_88106[0] == 11) || Global_88106[0] == 17) || Global_88106[0] == 140) || Global_88106[0] == 141)
				{
					return 1;
				}
				return 1;
		...
		case joaat("prop_mr_raspberry_01"):
			if (Global_105220.f_7232.f_227[145] == 1)
			{
				if (func_19() == 2)
				{
					if (((((Global_88106[13] != 127 && Global_88106[13] != 135) && Global_88122 != 127) && Global_88122 != 135) && !func_87()) && !func_89())
					{
						return 1;
					}
				}
		...
		case joaat("prop_radio_01"):
			iLocal_31 = 1;
			if ((Global_33270[78] != 1 && Global_88106[9] != 117) && Global_88106[11] != 117)
			{
				if (func_19() == 2)
				{
					bLocal_35 = true;
		...
		case joaat("p_w_grass_gls_s"):
			...
			if (func_19() == 0)
			{
				if (Global_88106[0] != 17 && Global_88106[2] != 73)
				{
					return 1;
				}
			}
...
{
	return func_94(iParam0, Global_35905);
}
