...
void __EntryFunction__()
{
	...
	if (DOES_ENTITY_EXIST(uScriptParam_0))
	{
		...
		iLocal_40 = GET_ENTITY_MODEL(uLocal_41);
	}
	if (!func_70())
	{
		func_95();
	}
	REQUEST_ANIM_DICT(func_69());
	while (true)
	{
		WAIT(0);
		if (!func_67())
...
void func_1()
{
	...
	if (iLocal_306)
	{
		if (!iLocal_308)
		{
			iLocal_309 = GET_GAME_TIMER() + 50;
			iLocal_308 = 1;
		}
		else if (GET_GAME_TIMER() > iLocal_309)
		{
			if (fLocal_310 < fVar1)
			{
			...
			if (fLocal_311 > fVar0)
			{
				...
				{
					SET_CAM_MOTION_BLUR_STRENGTH(uLocal_296, fLocal_311);
				}
			}
			if (fLocal_312 > fVar2)
			{
				...
				SET_TIMECYCLE_MODIFIER_STRENGTH(fLocal_312);
			}
			iLocal_308 = 0;
...
void func_4()
{
	...
	{
		case 0:
			if ((func_58(vVar0, vVar3) && GET_ENTITY_HEADING(PLAYER_PED_ID()) >= (func_57() - 90f)) && GET_ENTITY_HEADING(PLAYER_PED_ID()) <= (func_57() + 90f))
			{
				func_56();
		...
		case 1:
			...
			if (func_53(1, 0, 1))
			{
				if ((((func_58(vVar0, vVar3) && GET_ENTITY_HEADING(PLAYER_PED_ID()) >= (func_57() - 90f)) && GET_ENTITY_HEADING(PLAYER_PED_ID()) <= (func_57() + 90f)) && vVar6.z > 33f) && !IS_PED_JUMPING(PLAYER_PED_ID()))
				{
					if ((!IS_PLAYER_FREE_AIMING(PLAYER_ID()) && !IS_PLAYER_TARGETTING_ANYTHING(PLAYER_ID())) && IS_CONTROL_PRESSED(2, 51))
					{
						...
						iLocal_36 = 1;
						if (DOES_ENTITY_EXIST(uLocal_41))
						{
		...
		case 2:
			...
			uLocal_297 = CREATE_SYNCHRONIZED_SCENE(func_41(), func_40(), 2);
			TASK_SYNCHRONIZED_SCENE(PLAYER_PED_ID(), uLocal_297, func_69(), func_39(0), 1000f, -8f, 0, 0, 1148846080, 0);
			PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_41, uLocal_297, func_38(0), func_69(), 1000f, -8f, 0, 1148846080);
			if (!_0x7F2F4F13AC5257EF(uLocal_297))
			{
				_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_297, 1);
			}
			if (GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
			{
				uLocal_296 = CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
				PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_296, uLocal_297, func_35(0), func_69());
		...
		case 3:
			...
			HIDE_HUD_AND_RADAR_THIS_FRAME();
			DISABLE_CONTROL_ACTION(0, 0, 1);
			if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_297) > 0.95f)
			{
				iLocal_293 = 4;
			}
			else if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_297) > 0.35f)
			{
				if (!iLocal_295)
				{
					SET_ENTITY_MOTION_BLUR(PLAYER_PED_ID(), 1);
					SET_TIMECYCLE_MODIFIER("DRUG_gas_huffin");
					SET_TIMECYCLE_MODIFIER_STRENGTH(0f);
					bLocal_307 = true;
					iLocal_295 = 1;
				}
			}
		...
		case 4:
			...
			if (IS_SCREEN_FADED_OUT())
			{
				...
				if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_297))
				{
					SET_SYNCHRONIZED_SCENE_PHASE(uLocal_297, 1f);
				}
				if (DOES_CAM_EXIST(uLocal_296))
				{
					DESTROY_CAM(uLocal_296, 0);
					RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
				}
				iLocal_298 = GET_RANDOM_INT_IN_RANGE(0, 6);
				switch (iLocal_298)
				{
					case 0:
				...
				SET_ENTITY_COORDS(PLAYER_PED_ID(), vLocal_302, 1, 0, 0, 1);
				SET_ENTITY_HEADING(PLAYER_PED_ID(), fLocal_305);
				ADD_TO_CLOCK_TIME(6, 0, 0);
				func_27(TO_FLOAT(6));
				func_26(vLocal_302, 10f, 13);
				iLocal_293 = 5;
			}
			break;
		...
		case 5:
			...
			if (!IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_297))
			{
				...
				uLocal_297 = CREATE_SYNCHRONIZED_SCENE(vVar9.x, vVar9.y, vVar9.z, 0f, 0f, fLocal_305, 2);
				TASK_SYNCHRONIZED_SCENE(PLAYER_PED_ID(), uLocal_297, func_69(), sLocal_300, 1000f, -4f, 0, 0, 1148846080, 0);
				if (_0x7F2F4F13AC5257EF(uLocal_297))
				{
					_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_297, 0);
				}
				if (GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
				{
					uLocal_296 = CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
					PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_296, uLocal_297, sLocal_301, func_69());
					RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
				}
				else
				{
		...
		case 8:
			if ((iLocal_313 && iLocal_314) && iLocal_315)
			{
				...
				if (STAT_GET_INT(joaat("num_sh_gas_huffed"), &iLocal_299, -1))
				{
					STAT_SET_INT(joaat("num_sh_gas_huffed"), iLocal_299 + 1, 1);
				}
				iLocal_295 = 0;
				func_43(0, 1, 1, 0, 0, 0);
				iLocal_294 = 0;
...
void func_5()
{
	...
	if (func_19() == 0)
	{
		...
		func_18(&uLocal_108, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
	...
	else if (func_19() == 1)
	{
		...
		func_18(&uLocal_108, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		switch (iVar0)
		{
			case 0:
	...
	else
	{
		...
		func_18(&uLocal_108, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
		switch (iVar0)
		{
			case 0:
...
void func_18(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
...
{
	uParam0->f_1 = (func_30(IS_BIT_SET(*uParam0, 4)) - fParam1);
	SET_BIT(uParam0, 1);
	CLEAR_BIT(uParam0, 2);
	uParam0->f_2 = 0f;
}
...
float func_31(var uParam0)
{
	if (func_33(uParam0))
	{
		...
		{
			return (func_30(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
int func_58(vector3 vParam0, float fParam3, var uParam4, var uParam5)
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if ((!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !IS_ENTITY_ON_FIRE(PLAYER_PED_ID())) && IS_PLAYER_CONTROL_ON(PLAYER_ID()))
		{
			...
			{
				if ((((IS_GAMEPLAY_CAM_RENDERING() && !IS_CUTSCENE_PLAYING()) && !IS_CINEMATIC_CAM_RENDERING()) && !func_62(0)) && !func_61())
				{
					if ((Global_90640 && Global_90641) || func_60())
					{
						return 0;
					}
					if (func_59(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vParam0, fParam3, 0))
					{
						return 1;
					}
				}
...
int func_64()
{
	if (REQUEST_AMBIENT_AUDIO_BANK(func_65(), 0, -1))
	{
		return 1;
	}
	return 0;
...
int func_66()
{
	...
	while (!HAS_ANIM_DICT_LOADED(uVar0))
	{
		WAIT(0);
	}
	return 1;
...
int func_67()
{
	...
	if (!iLocal_294)
	{
		...
		if (!IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE(uLocal_41))
		{
			return 0;
		}
	}
...
int func_68()
{
	...
	if (DOES_ENTITY_EXIST(uLocal_41))
	{
		vVar0 = { GET_ENTITY_COORDS(uLocal_41, 1) };
		if (!IS_ENTITY_DEAD(uLocal_41, 0) && vVar0.z > 33f)
		{
			return 1;
		}
	}
...
int func_79(var uParam0, int iParam1)
{
	...
	return func_80(uParam0, iVar0, iVar1, iParam1);
}
...
int func_80(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_82(GET_ENTITY_MODEL(uParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_82(GET_ENTITY_MODEL(uParam0), iVar1, 14, 4);
		}
	}
	...
	while (iVar4 <= (iVar2 - 1))
	{
		...
		else
		{
			...
			while (iVar5 <= (iVar6 - 1))
			{
				...
				{
					iVar3 = (iVar3 + func_81(uParam0, iParam3));
					return iVar3;
				}
				else
				{
...
int func_84(int iParam0)
{
	...
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		...
		{
			if (func_59(GET_ENTITY_COORDS(uLocal_41, 0), func_63(), 5f, 0))
			{
				return 1;
			}
		}
...
void func_95()
{
	...
	REMOVE_ANIM_DICT(func_69());
	if (DOES_CAM_EXIST(uLocal_296))
	{
		SET_CAM_MOTION_BLUR_STRENGTH(uLocal_296, 0f);
		DESTROY_CAM(uLocal_296, 0);
	}
	func_96();
...
void func_96()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if ((!IS_PLAYER_CONTROL_ON(PLAYER_ID()) && func_53(1, 0, 1)) && iLocal_36)
		{
			func_43(0, 1, 1, 0, 0, 0);
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
