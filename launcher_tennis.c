...
void __EntryFunction__()
{
	...
	uLocal_86 = GET_PLAYER_PED(PLAYER_ID());
	iLocal_96 = 0;
	func_185(&Global_105216, 0);
	func_180();
	if (func_179(uLocal_95, 1))
	{
		iLocal_101 = 10;
	}
	else
	...
	{
		if (!func_177(iLocal_101))
		{
			if (func_176(0, iLocal_100))
			{
				func_187(0);
			}
			else
	...
	if (func_179(uLocal_95, 8388608))
	{
		func_187(1);
	}
	if (func_179(uLocal_95, 524288) && (func_175() && !func_174()))
	{
		func_187(1);
	}
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_179(uLocal_95, 4194304))
	{
		if (iLocal_106 != 263)
		{
			func_173(iLocal_106, 1, 0);
			iLocal_106 = 263;
		}
		func_172(10);
	}
	while (true)
	{
		...
		uLocal_86 = GET_PLAYER_PED(PLAYER_ID());
		if (func_179(uLocal_95, 1048576))
		{
			if (IS_ENTITY_DEAD(uLocal_86, 0))
			{
				func_187(1);
			}
		}
		if (DOES_ENTITY_EXIST(uLocal_86) && !IS_ENTITY_DEAD(uLocal_86, 0))
		{
			vLocal_88 = { GET_ENTITY_COORDS(uLocal_86, 1) };
			uLocal_94 = VDIST2(vLocal_88, ScriptParam_0.f_1[0 /*3*/]);
			uLocal_94 = uLocal_94;
			vLocal_112 = { vLocal_88 };
			vLocal_115 = { ScriptParam_0.f_1[0 /*3*/] };
			vLocal_112.z = 0f;
			vLocal_115.z = 0f;
			fLocal_111 = VDIST2(vLocal_112, vLocal_115);
			switch (iLocal_96)
			{
				case 0:
					if (func_177(iLocal_101) || (func_179(uLocal_95, 16) && !func_179(uLocal_95, 524288)))
					{
						iLocal_99 = -1;
						func_171();
						func_172(1);
				...
				case 3:
					...
					if (!func_177(iLocal_101))
					{
						...
						{
							bVar1 = true;
							if (ARE_STRINGS_EQUAL(&(Global_93682.f_3), &cLocal_70))
							{
								cLocal_70 = { Local_54 };
								bVar1 = false;
							}
					...
					if (!func_179(uLocal_95, 4))
					{
						func_168();
						func_167(&uLocal_95, 4);
					}
					if (fLocal_111 > (fLocal_103 * fLocal_103) && !Global_93716)
					{
						if (iLocal_106 != 263)
						{
							if (func_166(6) && !func_165(iLocal_106))
							{
							}
							else
							{
					...
					{
						cLocal_70 = { Local_54 };
						bVar2 = !func_179(uLocal_95, 64);
						func_185(&uLocal_95, 128);
						if (!func_164(3) && !Global_93716)
						{
							if (func_179(uLocal_95, 2097152))
							{
								if ((!func_179(uLocal_95, 1) || !DOES_ENTITY_EXIST(func_163())) && !Global_93716)
								{
									func_172(10);
									break;
								}
						...
						if (bVar2)
						{
							if (!IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_118, vLocal_121, fLocal_124, 1, 0, iLocal_104) || (fLocal_126 > 0f && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), func_138(vLocal_118, vLocal_121, 0.5f), 0) > fLocal_126))
							{
								bVar2 = false;
							}
							else if (fLocal_125 > 0f)
							{
								if (ABSF((vLocal_88.z - vLocal_118.z)) > fLocal_125)
								{
									bVar2 = false;
								}
							}
							...
							if (bVar2)
							{
								...
								if (func_137(uLocal_87))
								{
									if (iLocal_97 == -1)
									{
										func_136(&iLocal_97, 4, sLocal_102, 0, 0, 0, 0);
										func_149(&uLocal_95, 2048);
									}
									else if (!func_179(uLocal_95, 2048) || !IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_135(&iLocal_97);
										func_185(&uLocal_95, 2048);
									}
									if (func_133(iLocal_97, 1))
									{
				...
				case 5:
					...
					if (HAS_SCRIPT_LOADED(&cLocal_70))
					{
						...
						if (iVar3 == 1)
						{
							...
							uLocal_53 = START_NEW_SCRIPT(&cLocal_70, iLocal_98);
							SET_SCRIPT_AS_NO_LONGER_NEEDED(&cLocal_70);
							Local_54 = { cLocal_70 };
							StringCopy(&cLocal_70, "", 64);
							func_149(&uLocal_95, 2);
							func_172(6);
							func_21(&uLocal_108);
							if (iLocal_100 != -1)
							{
				...
				case 6:
					...
					if (func_179(uLocal_95, 2097152))
					{
						if (!func_164(3) && !IS_THREAD_ACTIVE(uLocal_53))
						{
							func_172(10);
						}
					}
					if (!IS_THREAD_ACTIVE(uLocal_53))
					{
						PLAYSTATS_ODDJOB_DONE(ROUND((func_11(&uLocal_108) * 1000f)), iLocal_100, 0);
						func_10(&uLocal_108);
						func_185(&uLocal_95, 256);
						func_9();
						if (bVar0)
						{
							func_185(&uLocal_95, 2);
						}
						else if (func_179(uLocal_95, 2))
						{
						...
						if (iLocal_100 != -1)
						{
							if (func_179(Global_105216, 0))
							{
								PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_100), 0, Global_93719, 0);
								func_7(func_19(iLocal_100), 0, Global_93719, 1, 0);
							}
							else
							{
								PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_100), 0, Global_93719, 0);
								func_7(func_19(iLocal_100), 0, Global_93719, 0, 0);
							}
						}
						func_6();
						func_185(&Global_105216, 0);
						if (func_179(uLocal_95, 16777216))
						{
							func_187(1);
						}
						if (iLocal_100 != -1)
				...
				case 7:
					...
					if (iLocal_106 != 263)
					{
						func_173(iLocal_106, 0, 0);
					}
					if (iLocal_97 != -1)
					{
						func_135(&iLocal_97);
					}
					if (!IS_STRING_NULL_OR_EMPTY(sLocal_102))
					{
					...
					if ((iLocal_105 % 150) == 0)
					{
						if (!IS_PED_INJURED(PLAYER_PED_ID()))
						{
							if (iLocal_107 == 2)
							{
								if (iLocal_107 == 2)
								{
									if (func_177(iLocal_101) && func_176(0, iLocal_100))
									{
										func_180();
										if (iLocal_106 != 263)
										{
...
{
	_0x5AAB586FFEC0FD96(uParam0);
	_0xF79F9DEF0AADE61A(uParam0);
}
...
void func_38()
{
	...
	if (iLocal_128 == 2)
	{
		...
		else if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tennis_family")) == 0)
		{
			iLocal_130 = 0;
			iLocal_131 = 0;
		}
	...
	if (!_0x66680A92700F43DF(PLAYER_PED_ID()))
	{
	}
}
...
void func_44(var uParam0, int iParam1, var uParam2)
{
	...
	while (iVar0 <= 11)
	{
		...
		{
			_0x39D55A620FCB6A3A(uParam0, iVar0, Var1.f_3, Var1.f_4);
		}
		iVar0++;
	}
	...
	while (iVar15 <= 8)
	{
		...
		if (uVar19[iVar15] != iVar18)
		{
			...
			{
				_IS_PED_PROP_VALID(uParam0, iVar17, Var1.f_3, Var1.f_4);
			}
		}
		iVar15++;
	}
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_51(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_56(int iParam0)
{
	...
	func_57(&(Global_71402[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_60(func_63(iParam1, uParam0->f_2), Global_71399, 0);
			if (IS_BIT_SET(uVar0, uParam0->f_1))
			{
				SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_60(func_59(iParam1, uParam0->f_2), Global_71399, 0);
			if (IS_BIT_SET(uVar0, uParam0->f_1))
			{
				SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_60(iVar1, Global_71399, 0);
				if (!IS_BIT_SET(uVar0, uParam0->f_1))
				{
					SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_64(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_65(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_66(iParam0, iParam1, &iVar2, &uVar1, bParam2, bParam3))
	{
...
void func_67(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_57(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_57(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = _GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_51(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_145()
{
	if (func_166(6) || func_166(7))
	{
		...
		{
			switch (func_146(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)))
			{
				case 1:
					return func_165(96);
					break;
...
int func_146(vector3 vParam0)
{
	...
	while (iVar3 < 10)
	{
		fVar1 = VDIST2(vParam0, func_147(iVar3));
		if (fVar0 > fVar1)
		{
			fVar0 = fVar1;
			iVar2 = iVar3;
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_159()) || Global_105612) || Global_25767) || func_158()) || func_141(8, -1)) || func_157()) || func_156()) || func_155()) || func_143()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_159()) || Global_25767) || func_158()) || func_141(8, -1)) || func_155()) || func_157()) || func_156()) || func_143()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_159()) || Global_105612) || Global_25767) || func_158()) || func_141(8, -1)) || func_157()) || func_156()) || func_143()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_159() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_141(8, -1)) || func_143()) || func_154()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_159()) || Global_25767) || func_158()) || func_141(8, -1)) || func_156()) || func_155()) || func_143()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_159()) || func_156()) || Global_105612) || Global_25767) || func_158()) || Global_37584) || func_141(8, -1)) || func_155()) || func_154()) || func_143()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_159()) || Global_105612) || Global_25767) || func_158()) || func_141(8, -1)) || func_155()) || func_154()) || func_157()) || func_156()) || func_143())
						{
							return 0;
						}
						break;
...
void func_161()
{
	...
	if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
	{
		if (func_131(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
			iVar0 = func_130(PLAYER_PED_ID());
...
void func_168()
{
	...
	if (bLocal_129 && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tennis_ambient")) == 0)
	{
		if (iLocal_128 == 1)
		{
			iVar4 = GET_RANDOM_INT_IN_RANGE(1, 4);
			uVar5[0] = GET_RANDOM_INT_IN_RANGE(2, 8);
			iVar9 = 1;
...
void func_180()
{
	...
	iLocal_98 = 28000;
	func_167(&uLocal_95, 1);
	sLocal_102 = "PLAY_TENNIS";
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
	{
		iLocal_128 = func_146(vLocal_91);
	}
	iLocal_106 = func_183(vLocal_91);
	bLocal_129 = true;
	iVar0 = func_130(PLAYER_PED_ID());
	if (iVar0 == 1)
	{
...
void func_188()
{
	func_185(&uLocal_95, 4);
	func_189();
	if (IS_THREAD_ACTIVE(uLocal_53))
	{
		FORCE_CLEANUP_FOR_THREAD_WITH_THIS_ID(uLocal_53, 3);
	}
	if (!IS_STRING_NULL(&cLocal_70))
	{
		if (GET_LENGTH_OF_LITERAL_STRING(&cLocal_70) != 0)
		{
			SET_SCRIPT_AS_NO_LONGER_NEEDED(&cLocal_70);
		}
	}
