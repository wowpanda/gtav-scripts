...
void __EntryFunction__()
{
	...
	if (func_431())
	{
		...
		func_325(&uVar0, -257.08f, 285.27f, 90.43f, 12.52f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
	...
	if (!func_220(Local_85.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
	{
		switch (iLocal_84)
		{
			case 0:
				...
				{
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_85.f_28[0], 1);
				}
				iLocal_84 = 1;
				break;
			...
			case 1:
				...
				{
					if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_332))
					{
						if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_332) >= 1f)
						{
							iLocal_84 = 2;
						}
					}
...
int func_220(int iParam0, bool bParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	vector3 vVar0;
	
	if (func_219(PLAYER_PED_ID()) && func_219(iParam0))
	{
		...
		if (!IS_PED_ARMED(PLAYER_PED_ID(), 6))
		{
			if (IS_PED_IN_MELEE_COMBAT(PLAYER_PED_ID()))
			{
				...
				{
					return func_233(PLAYER_PED_ID(), iParam0, iParam2);
				}
			}
		}
		if (bParam4)
...
bool func_223(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_224(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_224(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_225(iParam4, iParam7) };
...
int func_227(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_229(GET_ENTITY_COORDS(iParam1, 1) - GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		vVar3 = { func_229(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_228(vVar3, vVar0);
...
bool func_233(var uParam0, var uParam1, var uParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_234(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_219(PLAYER_PED_ID()) && func_219(uParam0))
	{
...
int func_237(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_229(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_229(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_228(vVar3, vVar0);
...
void func_239()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()) && func_219(Local_85.f_28[0]))
	{
		SET_IK_TARGET(Local_85.f_28[0], 1, PLAYER_PED_ID(), 31086, 0f, 0f, 0f, 0, -1, -1);
		SET_IK_TARGET(PLAYER_PED_ID(), 1, Local_85.f_28[0], 31086, 0f, 0f, 0f, 0, -1, -1);
	}
}
	...
	switch (iLocal_84)
	{
		case 0:
			...
			if (func_219(PLAYER_PED_ID()))
			{
				...
				{
					func_275(sLocal_160, PLAYER_PED_ID(), 0, 2);
				}
			}
			if (func_268(1, 1093140480, 0))
			{
				...
				{
					REGISTER_ENTITY_FOR_CUTSCENE(Local_85.f_28[0], sLocal_162, 0, 0, 0);
				}
				if (func_219(PLAYER_PED_ID()))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(PLAYER_PED_ID(), sLocal_160, 0, 0, 0);
				}
				if (DOES_ENTITY_EXIST(uLocal_149[0]))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(uLocal_149[0], sLocal_156, 0, iLocal_152, 0);
				}
				else
				{
					REGISTER_ENTITY_FOR_CUTSCENE(uLocal_149[0], sLocal_156, 2, iLocal_152, 0);
				}
				if (DOES_ENTITY_EXIST(uLocal_149[1]))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(uLocal_149[1], sLocal_157, 0, iLocal_153, 0);
				}
				else
				{
					REGISTER_ENTITY_FOR_CUTSCENE(uLocal_149[1], sLocal_157, 2, iLocal_153, 0);
				}
				if (DOES_ENTITY_EXIST(uLocal_147))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(uLocal_147, sLocal_159, 0, iLocal_155, 0);
				}
				else
				{
					REGISTER_ENTITY_FOR_CUTSCENE(uLocal_147, sLocal_159, 2, iLocal_155, 0);
				}
				if (DOES_ENTITY_EXIST(uLocal_148))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(uLocal_148, sLocal_158, 0, iLocal_154, 0);
				}
				else
				{
					REGISTER_ENTITY_FOR_CUTSCENE(uLocal_148, sLocal_158, 2, iLocal_154, 0);
				}
		...
		case 1:
			...
			if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_162, 0))
			{
				uLocal_332 = CREATE_SYNCHRONIZED_SCENE(vLocal_333, vLocal_336, 2);
				TASK_SYNCHRONIZED_SCENE(Local_85.f_28[0], uLocal_332, sLocal_161, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
				_0x2208438012482A1A(Local_85.f_28[0], 0, 0);
			}
			if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_160, 0))
			{
				SET_ENTITY_COORDS(PLAYER_PED_ID(), -258.8661f, 292.7882f, 90.5764f, 1, 0, 0, 1);
				SET_ENTITY_HEADING(PLAYER_PED_ID(), 153.0417f);
				_0x2208438012482A1A(PLAYER_PED_ID(), 0, 0);
			}
			if (!DOES_ENTITY_EXIST(uLocal_148))
			{
				if (DOES_ENTITY_EXIST(GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_158, iLocal_154)))
				{
					uLocal_148 = GET_OBJECT_INDEX_FROM_ENTITY_INDEX(GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_158, iLocal_154));
				}
			}
			else if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_332) && CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_158, 0))
			{
				SET_ENTITY_COORDS(uLocal_148, vLocal_333, 0, 0, 0, 1);
				SET_ENTITY_ROTATION(uLocal_148, vLocal_336, 2, 0);
				PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_148, uLocal_332, "leadout_pap_3_rcm_dumpster", sLocal_161, 1000f, -8f, 0, 1148846080);
				FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(uLocal_148);
			}
			if (!DOES_ENTITY_EXIST(uLocal_149[0]))
			{
				if (DOES_ENTITY_EXIST(GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_156, 0)))
				{
					uLocal_149[0] = GET_OBJECT_INDEX_FROM_ENTITY_INDEX(GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_156, iLocal_152));
				}
			}
			else if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_332) && CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_156, 0))
			{
				PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_149[0], uLocal_332, "leadout_pap_3_rcm_lid_l", sLocal_161, 1000f, -8f, 1, 1148846080);
				FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(uLocal_149[0]);
			}
			if (!DOES_ENTITY_EXIST(uLocal_149[1]))
			{
				if (DOES_ENTITY_EXIST(GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_157, 0)))
				{
					uLocal_149[1] = GET_OBJECT_INDEX_FROM_ENTITY_INDEX(GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_157, iLocal_153));
				}
			}
			else if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_332) && CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_157, 0))
			{
				PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_149[1], uLocal_332, "leadout_pap_3_rcm_lid_r", sLocal_161, 1000f, -8f, 1, 1148846080);
				FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(uLocal_149[1]);
			}
			if (!DOES_ENTITY_EXIST(uLocal_147))
			{
				if (DOES_ENTITY_EXIST(GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_159, 0)))
				{
					uLocal_147 = GET_OBJECT_INDEX_FROM_ENTITY_INDEX(GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_159, iLocal_155));
				}
			}
			else if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_332) && CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_159, 0))
			{
				SET_ENTITY_COORDS(uLocal_147, -261.1132f, 294.1956f, 90.68612f, 0, 0, 0, 1);
				SET_ENTITY_ROTATION(uLocal_147, -0.604164f, -2.332095f, 89.8831f, 2, 0);
				FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(uLocal_147);
			}
...
void func_253(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	var uVar0;
	...
	if (IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_255(GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_257(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	func_258(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_258(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, var uParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_262(iVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_262(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = { func_229(vParam1 - vParam4) };
		vVar3 = { vVar0 };
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_263(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_263(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_263(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_263(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_263(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_263(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_263(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_263(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_263(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_263(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_263(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_263(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_263(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_263(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_263(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_263(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return 1;
		}
	}
...
int func_268(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_273(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_272(PLAYER_PED_ID(), -828834893))
				{
...
int func_273(var uParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_281()
{
	if (func_251())
	{
		SET_GAMEPLAY_ENTITY_HINT(Local_85.f_28[0], 0f, 0f, 0f, 1, -1, 1500, 2000, 0);
	}
}
...
void func_282()
{
	...
	switch (iLocal_84)
	{
		case 0:
			...
			if (func_218(Local_85.f_28[0]) && DOES_ENTITY_EXIST(uLocal_148))
			{
				uLocal_330 = CREATE_SYNCHRONIZED_SCENE(GET_ENTITY_COORDS(uLocal_148, 1), GET_ENTITY_ROTATION(uLocal_148, 2), 2);
				TASK_SYNCHRONIZED_SCENE(Local_85.f_28[0], uLocal_330, sLocal_161, "leadin_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				if (DOES_ENTITY_EXIST(uLocal_148))
				{
					PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_148, uLocal_330, "leadin_pap_3_rcm_dumpster", sLocal_161, 1000f, -8f, 0, 1148846080);
				}
				if (DOES_ENTITY_EXIST(uLocal_149[0]))
				{
					PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_149[0], uLocal_330, "leadin_pap_3_rcm_lid_l", sLocal_161, 1000f, -8f, 0, 1148846080);
				}
				if (DOES_ENTITY_EXIST(uLocal_149[1]))
				{
					PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_149[1], uLocal_330, "leadin_pap_3_rcm_lid_r", sLocal_161, 1000f, -8f, 0, 1148846080);
				}
				func_242(1, 1, 1, 1);
				iLocal_84 = 1;
			}
		...
		case 1:
			if (func_218(Local_85.f_28[0]) && DOES_ENTITY_EXIST(uLocal_148))
			{
				if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_330))
				{
					if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_330) > 0.99f)
					{
						if (!IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_331))
						{
							uLocal_331 = CREATE_SYNCHRONIZED_SCENE(GET_ENTITY_COORDS(uLocal_148, 1), GET_ENTITY_ROTATION(uLocal_148, 2), 2);
							TASK_SYNCHRONIZED_SCENE(Local_85.f_28[0], uLocal_331, sLocal_161, "idle_01_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
							_0x2208438012482A1A(Local_85.f_28[0], 0, 0);
							if (DOES_ENTITY_EXIST(uLocal_148))
							{
								PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_148, uLocal_331, "idle_01_pap_3_rcm_dumpster", sLocal_161, 1000f, -8f, 0, 1148846080);
								FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(uLocal_148);
							}
							if (DOES_ENTITY_EXIST(uLocal_149[0]))
							{
								PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_149[0], uLocal_331, "idle_01_pap_3_rcm_lid_l", sLocal_161, 1000f, -8f, 0, 1148846080);
								FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(uLocal_149[0]);
							}
							if (DOES_ENTITY_EXIST(uLocal_149[1]))
							{
								PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_149[1], uLocal_331, "idle_01_pap_3_rcm_lid_r", sLocal_161, 1000f, -8f, 0, 1148846080);
								FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(uLocal_149[1]);
							}
						}
					}
					if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_330) > 0.3f)
					{
						if (!bLocal_328)
						{
					...
					if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_330) > 0.05f)
					{
						func_281();
					}
				}
...
void func_283()
{
	if (DOES_ENTITY_EXIST(Local_85.f_41[3]) && !iLocal_345)
	{
		START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_rcpap1_camera", GET_PED_BONE_COORDS(Local_85.f_28[0], 28422, vLocal_340), GET_ENTITY_ROTATION(Local_85.f_41[3], 2), 1065353216, 0, 0, 0);
		if (!HAS_SOUND_FINISHED(uLocal_339))
		{
			STOP_SOUND(uLocal_339);
		}
		if (REQUEST_SCRIPT_AUDIO_BANK(sLocal_343, 0, -1))
		{
			PLAY_SOUND_FROM_COORD(uLocal_339, "CAMERA", GET_PED_BONE_COORDS(Local_85.f_28[0], 28422, vLocal_340), sLocal_344, 0, 0, 0);
			iLocal_345 = 1;
		}
	}
}
...
void func_286()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if (func_273(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_292()
{
	...
	if (func_218(PLAYER_PED_ID()))
	{
		uLocal_146 = GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER_PED_ID());
	}
	if (func_218(Local_85.f_28[0]))
	{
		SET_PED_RELATIONSHIP_GROUP_HASH(Local_85.f_28[0], uLocal_146);
		SET_PED_CONFIG_FLAG(Local_85.f_28[0], 132, 1);
		SET_PED_KEEP_TASK(Local_85.f_28[0], 1);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_85.f_28[0], 1);
	}
	if (!DOES_ENTITY_EXIST(uLocal_147))
	{
		uLocal_147 = GET_CLOSEST_OBJECT_OF_TYPE(-261.19f, 292.22f, 90.79f, 10f, iLocal_155, 1, 0, 1);
		_0xA80AE305E0A3044F(uLocal_147, 0);
	}
	if (!DOES_ENTITY_EXIST(uLocal_148))
	{
		func_301(&uLocal_148, &(Local_85.f_41[0]));
	}
	if (!DOES_ENTITY_EXIST(uLocal_149[0]))
	{
		func_301(&(uLocal_149[0]), &(Local_85.f_41[1]));
	}
	if (!DOES_ENTITY_EXIST(uLocal_149[1]))
	{
		func_301(&(uLocal_149[1]), &(Local_85.f_41[2]));
	}
	func_300(&uLocal_163, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_300(&uLocal_163, 3, Local_85.f_28[0], "BEVERLY", 0, 1);
	REQUEST_ADDITIONAL_TEXT("PAP3", 0);
	REQUEST_ANIM_DICT(sLocal_161);
	REQUEST_PTFX_ASSET();
	while (!HAS_ANIM_DICT_LOADED(sLocal_161) || !HAS_PTFX_ASSET_LOADED())
	{
		func_285();
		WAIT(0);
	}
	uLocal_339 = GET_SOUND_ID();
	if (func_431())
	{
		switch (func_299())
		{
...
void func_293()
{
	...
	func_296();
	func_241(1);
	func_295(PLAYER_PED_ID(), -258.8661f, 292.7882f, 90.5764f, 153.0393f, 0, 1);
	func_294(1, 1, 1);
}
...
int func_295(var uParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
void func_296()
{
	if (func_219(Local_85.f_28[0]) && DOES_ENTITY_EXIST(uLocal_148))
	{
		uLocal_332 = CREATE_SYNCHRONIZED_SCENE(vLocal_333, vLocal_336, 2);
		TASK_SYNCHRONIZED_SCENE(Local_85.f_28[0], uLocal_332, sLocal_161, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
		if (DOES_ENTITY_EXIST(uLocal_148))
		...
		SET_SYNCHRONIZED_SCENE_PHASE(uLocal_332, 0.02f);
	}
	bLocal_329 = false;
}
...
void func_300(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
...
int func_302()
{
	...
	else if (DOES_ENTITY_EXIST(Local_85.f_28[0]))
	{
		if (IS_ENTITY_DEAD(Local_85.f_28[0], 0))
		{
			func_303("P3BEVDEAD");
			return 1;
		}
		else if (GET_PED_MAX_HEALTH(Local_85.f_28[0]) > GET_ENTITY_HEALTH(Local_85.f_28[0]))
		{
			func_303("P3BEVHURT");
			return 1;
		}
...
void func_304()
{
	...
	{
		case 0:
			if (ARE_STRINGS_EQUAL(sLocal_346, "DEFAULT"))
			{
				func_447(1);
			}
			else
...
{
	if (((!func_321(0) || Global_71859) || Global_71848 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_290(0)) || func_320(1))
			{
			}
			else
			{
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_260(iParam0, 0, 0)) || func_260(iParam0, 1, 0)) || func_260(iParam0, 2, 0)) || func_380(iParam0) != 145) || func_379(iParam0)) || func_378(iParam0)) || func_333(iParam0)) || func_377(iParam0)) || !func_367(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_378(iParam0))
		{
		}
...
int func_425(var uParam0)
{
	...
	switch (iLocal_79)
	{
		case 0:
			...
			{
				REQUEST_MODEL(iVar0[iVar31]);
				iVar31++;
			}
			REQUEST_ANIM_DICT(sVar30);
			iLocal_79 = 1;
			break;
		
		case 1:
			if (!func_430(&iVar0) || !HAS_ANIM_DICT_LOADED(sVar30))
			{
				return 0;
			}
			iLocal_79 = 2;
		...
		case 2:
			...
			if (func_218(uParam0->f_28[0]))
			{
				...
				{
					func_426(&(uParam0->f_41[3]), iVar0[1], GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_219(uParam0->f_41[3]))
					{
						ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[3], uParam0->f_28[0], GET_PED_BONE_INDEX(uParam0->f_28[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			...
			if (bVar32)
			{
				uVar6[0] = GET_CLOSEST_OBJECT_OF_TYPE(-260.62f, 292.1391f, 90.604f, 10f, joaat("prop_cs_dumpster_01a"), 1, 0, 1);
				vVar10[0 /*3*/] = { -260.614f, 292.106f, 91.127f };
				vVar20[0 /*3*/] = { 7.2E-05f, -2.500116f, 89.63998f };
				uVar6[1] = GET_CLOSEST_OBJECT_OF_TYPE(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidl"), 1, 0, 1);
				vVar10[1 /*3*/] = { -261.108f, 292.5062f, 92.03645f };
				vVar20[1 /*3*/] = { -0.656039f, -2.50018f, 89.6114f };
				uVar6[2] = GET_CLOSEST_OBJECT_OF_TYPE(-261.5835f, 291.6671f, 92.066f, 10f, joaat("prop_cs_dumpster_lidr"), 1, 0, 1);
				vVar10[2 /*3*/] = { -261.1135f, 291.6249f, 91.99765f };
				vVar20[2 /*3*/] = { -0.281056f, -2.500049f, 89.62769f };
				iVar31 = 0;
				while (iVar31 <= 2)
				{
					SET_OBJECT_AS_NO_LONGER_NEEDED(&(uVar6[iVar31]));
					iVar31++;
				}
				CREATE_MODEL_HIDE(-260.62f, 292.13f, 90.6f, 10f, joaat("prop_cs_dumpster_01a"), 1);
				CREATE_MODEL_HIDE(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidr"), 1);
				CREATE_MODEL_HIDE(-261.54f, 292.54f, 92.1f, 10f, joaat("prop_cs_dumpster_lidl"), 1);
				uParam0->f_41[0] = CREATE_OBJECT_NO_OFFSET(joaat("prop_cs_dumpster_01a"), vVar10[0 /*3*/], 1, 1, 0);
				SET_ENTITY_ROTATION(uParam0->f_41[0], vVar20[0 /*3*/], 2, 1);
				_0xA80AE305E0A3044F(uParam0->f_41[0], 0);
				uParam0->f_41[1] = CREATE_OBJECT_NO_OFFSET(joaat("prop_cs_dumpster_lidl"), vVar10[1 /*3*/], 1, 1, 0);
				SET_ENTITY_ROTATION(uParam0->f_41[1], vVar20[1 /*3*/], 2, 1);
				_0xA80AE305E0A3044F(uParam0->f_41[1], 0);
				uParam0->f_41[2] = CREATE_OBJECT_NO_OFFSET(joaat("prop_cs_dumpster_lidr"), vVar10[2 /*3*/], 1, 1, 0);
				SET_ENTITY_ROTATION(uParam0->f_41[2], vVar20[2 /*3*/], 2, 1);
				_0xA80AE305E0A3044F(uParam0->f_41[2], 0);
				iLocal_79 = 3;
			}
			break;
		...
		case 3:
			...
			{
				uLocal_82 = CREATE_SYNCHRONIZED_SCENE(GET_ENTITY_COORDS(uParam0->f_41[0], 1), GET_ENTITY_ROTATION(uParam0->f_41[0], 2), 2);
				PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[0], uLocal_82, "idle_closed_pap_3_rcm_dumpster", sVar30, 8f, -8f, 0, 1148846080);
				SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_82, 1);
				if (func_219(uParam0->f_28[0]))
				{
					TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_82, sVar30, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_219(uParam0->f_41[1]))
				{
					PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[1], uLocal_82, "idle_closed_pap_3_rcm_lid_l", sVar30, 8f, -8f, 0, 1148846080);
				}
				if (func_219(uParam0->f_41[2]))
				{
					PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[2], uLocal_82, "idle_closed_pap_3_rcm_lid_r", sVar30, 8f, -8f, 0, 1148846080);
				}
			}
			iVar31 = 0;
			while (iVar31 <= (iVar0 - 1))
			{
				SET_MODEL_AS_NO_LONGER_NEEDED(iVar0[iVar31]);
				iVar31++;
			}
			REMOVE_ANIM_DICT(sVar30);
			return 1;
			break;
	}
	return 0;
...
void func_426(var uParam0, var uParam1, vector3 vParam2, float fParam5)
{
	func_252(uParam0);
...
int func_427(var uParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_428(uParam0, iParam1, vParam2, fParam5, 1))
	{
		if (DOES_ENTITY_EXIST(*uParam0))
		{
			if (!IS_ENTITY_DEAD(*uParam0, 0))
...
int func_428(var uParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	int iVar0;
...
void func_432()
{
	...
	RELEASE_SOUND_ID(uLocal_339);
	if (DOES_ENTITY_EXIST(uLocal_149[0]))
	{
		FREEZE_ENTITY_POSITION(uLocal_149[0], 1);
	}
	if (DOES_ENTITY_EXIST(uLocal_149[1]))
	{
		FREEZE_ENTITY_POSITION(uLocal_149[1], 1);
	}
	func_445(&(uLocal_149[0]), 0);
	func_445(&(uLocal_149[1]), 0);
	func_445(&uLocal_147, 0);
	func_445(&uLocal_148, 0);
	REMOVE_ANIM_DICT(sLocal_161);
	REMOVE_PTFX_ASSET();
...
void func_447(bool bParam0)
{
	...
	if (!func_464())
	{
		...
		{
			func_159(iVar0, 1, 0);
			func_448(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_105652[iVar0 /*10*/].f_9 == -1)
...
int func_449(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_455())
	{
		...
		{
			iVar33 = func_450(GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
