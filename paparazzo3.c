	...
	switch (iLocal_42)
	{
		...
		case 1:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_58, 0))
			{
				...
				BRAIN::TASK_SYNCHRONIZED_SCENE(Local_43.f_28[0], iLocal_228, fLocal_57, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
			...
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_228) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_54, 0))
			{
				...
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_46, iLocal_228, "leadout_pap_3_rcm_dumpster", fLocal_57, 1000f, -8f, 0, 1148846080);
			...
			{
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_47[0], iLocal_228, "leadout_pap_3_rcm_lid_l", fLocal_57, 1000f, -8f, 1, 1148846080);
			...
			{
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_47[1], iLocal_228, "leadout_pap_3_rcm_lid_r", fLocal_57, 1000f, -8f, 1, 1148846080);
	...
	switch (iLocal_42)
	{
		case 0:
			...
			if (func_218(Local_43.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_46))
			{
				...
				BRAIN::TASK_SYNCHRONIZED_SCENE(Local_43.f_28[0], iLocal_226, fLocal_57, "leadin_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_46, iLocal_226, "leadin_pap_3_rcm_dumpster", fLocal_57, 1000f, -8f, 0, 1148846080);
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_47[0]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_47[0], iLocal_226, "leadin_pap_3_rcm_lid_l", fLocal_57, 1000f, -8f, 0, 1148846080);
				}
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_47[1]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_47[1], iLocal_226, "leadin_pap_3_rcm_lid_r", fLocal_57, 1000f, -8f, 0, 1148846080);
				}
				func_242(1, 1, 1, 1);
				iLocal_42 = 1;
			}
				...
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_226))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_226) > 0.99f)
					{
						if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_227))
						{
							...
							BRAIN::TASK_SYNCHRONIZED_SCENE(Local_43.f_28[0], iLocal_227, fLocal_57, "idle_01_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
							PED::_0x2208438012482A1A(Local_43.f_28[0], 0, 0);
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_46, iLocal_227, "idle_01_pap_3_rcm_dumpster", fLocal_57, 1000f, -8f, 0, 1148846080);
								ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_46);
							}
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_47[0]))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_47[0], iLocal_227, "idle_01_pap_3_rcm_lid_l", fLocal_57, 1000f, -8f, 0, 1148846080);
								ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_47[0]);
							}
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_47[1]))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_47[1], iLocal_227, "idle_01_pap_3_rcm_lid_r", fLocal_57, 1000f, -8f, 0, 1148846080);
								ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_47[1]);
							}
						}
					}
...
void func_283()
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_43.f_41[3]) && !iLocal_235)
	{
		...
		if (AUDIO::REQUEST_SCRIPT_AUDIO_BANK(fLocal_233, false, -1))
		{
...
void func_284(void fParam0, bool bParam1)
{
	func_256(bParam1);
...
void func_291()
{
	...
	func_299(&uLocal_59, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_299(&uLocal_59, 3, Local_43.f_28[0], "BEVERLY", 0, 1);
	HUD::REQUEST_ADDITIONAL_TEXT("PAP3", 0);
	STREAMING::REQUEST_ANIM_DICT(fLocal_57);
	STREAMING::REQUEST_PTFX_ASSET();
	while (!STREAMING::HAS_ANIM_DICT_LOADED(fLocal_57) || !STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		func_285();
		SYSTEM::WAIT(0);
	}
...
void func_292()
{
	...
	func_295();
	func_241(1);
	func_294(PLAYER::PLAYER_PED_ID(), -258.8661f, 292.7882f, 90.5764f, 153.0393f, 0, 1);
	func_293(1, 1, 1);
}
...
int func_294(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_305(void fParam0, bool bParam1)
{
	func_306(fParam0);
	func_443(bParam1);
}

void func_306(void fParam0)
{
	...
	if (Global_71232 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_309(Global_71233, Global_71235, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_320(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_290(0)) || func_319(1))
			{
			}
			else
			{
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_260(iParam0, 0, 0)) || func_260(iParam0, 1, 0)) || func_260(iParam0, 2, 0)) || func_376(iParam0) != 145) || func_375(iParam0)) || func_374(iParam0)) || func_332(iParam0)) || func_373(iParam0)) || !func_363(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_374(iParam0))
		{
		}
...
int func_421(var uParam0)
{
	...
	fVar4 = "rcmpaparazzo_3leadinoutpap_3_rcm";
	iVar0[0] = uLocal_38;
	...
	switch (iLocal_37)
	{
		...
		case 1:
			if (!func_426(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(fVar4))
			{
				return 0;
			}
			iLocal_37 = 2;
		...
		case 2:
			...
			if (func_218(uParam0->f_28[0]))
			{
				...
				{
					func_422(&(uParam0->f_41[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
		...
		case 3:
			if (func_219(uParam0->f_41[0]))
			{
				...
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[0], iLocal_40, "idle_closed_pap_3_rcm_dumpster", fVar4, 8f, -8f, 0, 1148846080);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_40, true);
				if (func_219(uParam0->f_28[0]))
				{
					BRAIN::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_40, fVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_219(uParam0->f_41[1]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[1], iLocal_40, "idle_closed_pap_3_rcm_lid_l", fVar4, 8f, -8f, 0, 1148846080);
				}
				if (func_219(uParam0->f_41[2]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[2], iLocal_40, "idle_closed_pap_3_rcm_lid_r", fVar4, 8f, -8f, 0, 1148846080);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
void func_422(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_252(iParam0);
...
int func_423(int iParam0, int iParam1, vector3 vParam2, float fParam3, void fParam4, int iParam5)
{
	if (func_424(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_424(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_428()
{
	...
	func_441(&(iLocal_47[0]), 0);
	func_441(&(iLocal_47[1]), 0);
	func_441(&iLocal_45, 0);
	func_441(&iLocal_46, 0);
	STREAMING::REMOVE_ANIM_DICT(fLocal_57);
	STREAMING::REMOVE_PTFX_ASSET();
	func_440(&uLocal_59, 1);
	func_440(&uLocal_59, 3);
	HUD::CLEAR_ADDITIONAL_TEXT(0, true);
	HUD::CLEAR_PRINTS();
	func_439(&(Local_43.f_28[0]), 1, 0, 1);
	func_429(&Local_43, 1, 0, 0);
...
void func_443(bool bParam0)
{
	...
	if (!func_460())
	{
		...
		{
			func_159(iVar0, 1, 0);
			func_444(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_104307[iVar0 /*10*/].f_9 == -1)
...
void func_444(void fParam0, int iParam1)
{
	if (Global_92955 != 12)
	{
		if (func_445(fParam0, 6, iParam1))
		{
...
int func_445(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_451())
	{
		...
		{
			iVar2 = func_446(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_448(void fParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
