...
int func_227(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_229(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_237(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_229(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
	...
	switch (iLocal_42)
	{
		...
		case 1:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_58, 0))
			{
				...
				BRAIN::TASK_SYNCHRONIZED_SCENE(Local_43.f_28[0], iLocal_228, sLocal_57, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
...
void func_243(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_247(PLAYER::PLAYER_ID())) && !func_245(PLAYER::PLAYER_ID(), 0)) && !func_244())
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_247(PLAYER::PLAYER_ID()))
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_70854 = 0;
...
void func_282()
{
	...
	switch (iLocal_42)
	{
		case 0:
			...
			{
				iLocal_226 = PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(iLocal_46, 1), ENTITY::GET_ENTITY_ROTATION(iLocal_46, 2), 2);
				BRAIN::TASK_SYNCHRONIZED_SCENE(Local_43.f_28[0], iLocal_226, sLocal_57, "leadin_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
				{
			...
			if (func_218(Local_43.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_46))
			{
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_226))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_226) > 0.99f)
					{
						...
						{
							iLocal_227 = PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(iLocal_46, 1), ENTITY::GET_ENTITY_ROTATION(iLocal_46, 2), 2);
							BRAIN::TASK_SYNCHRONIZED_SCENE(Local_43.f_28[0], iLocal_227, sLocal_57, "idle_01_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
							PED::_0x2208438012482A1A(Local_43.f_28[0], 0, 0);
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
							{
...
{
	if (((!func_320(0) || Global_71125) || Global_71114 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71110)
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_260(iParam0, 0, 0)) || func_260(iParam0, 1, 0)) || func_260(iParam0, 2, 0)) || func_374(iParam0) != 145) || func_373(iParam0)) || func_372(iParam0)) || func_332(iParam0)) || func_371(iParam0)) || !func_361(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_372(iParam0))
		{
		}
...
int func_419(var uParam0)
{
	...
	switch (iLocal_37)
	{
		...
		case 1:
			if (!func_424(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar4))
			{
				return 0;
			}
			iLocal_37 = 2;
		...
		case 2:
			...
			if (func_218(uParam0->f_28[0]))
			{
				...
				{
					func_420(&(uParam0->f_41[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
		...
		case 3:
			...
			{
				iLocal_40 = PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(uParam0->f_41[0], 1), ENTITY::GET_ENTITY_ROTATION(uParam0->f_41[0], 2), 2);
				...
				{
					BRAIN::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_40, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
...
void func_420(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_252(iParam0);
...
int func_421(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
...
int func_422(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
