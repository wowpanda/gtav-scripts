...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		switch (func_182(PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (func_181() == 2)
				{
					vLocal_140[PARTICIPANT_ID_TO_INT() /*3*/] = 2;
				}
				else if (func_181() == 6)
				{
					vLocal_140[PARTICIPANT_ID_TO_INT() /*3*/] = 5;
				}
				break;
			...
			case 2:
				if (func_181() == 2)
				{
					...
					else if (!IS_BIT_SET(vLocal_140[PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
					{
						func_8();
					}
				}
			...
			case 5:
				...
				{
					vLocal_140[PARTICIPANT_ID_TO_INT() /*3*/] = 6;
				}
				break;
...
void func_3()
{
	...
	if (NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		if (iLocal_139 == 0)
		{
			CLEAR_BIT(&uLocal_238, 0);
			SET_BIT(&uLocal_238, 1);
		}
		iVar0 = iLocal_139;
		if (NETWORK_IS_PARTICIPANT_ACTIVE(iVar0))
		{
			iVar1 = NETWORK_GET_PLAYER_INDEX(iVar0);
			if (!IS_BIT_SET(vLocal_140[iLocal_139 /*3*/].f_2, 0))
			{
				CLEAR_BIT(&uLocal_238, 1);
			}
			if (func_4(iVar1, 0, 1))
			{
				if (!IS_BIT_SET(Global_1589819[iLocal_139 /*818*/].f_146, 4))
				{
				}
			}
		}
		...
		if (iLocal_139 == 32)
		{
			if (IS_BIT_SET(uLocal_238, 1))
			{
				SET_BIT(&(vLocal_61.f_1), 0);
			}
			SET_BIT(&uLocal_238, 0);
			iLocal_139 = 0;
		}
	}
}
...
void func_8()
{
	...
	SET_BIT(&(vLocal_140[PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
	SET_BIT(&(vLocal_140[PARTICIPANT_ID_TO_INT() /*3*/].f_2), 1);
	func_70(10, 0);
	func_69(0);
	func_30(1);
	func_23();
...
int func_22(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_17() == 0)
		{
			return IS_BIT_SET(func_15(func_16(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_30(bool bParam0)
{
	...
	iVar1 = func_65(PLAYER_ID(), bParam0);
...
void func_69(bool bParam0)
{
	if (bParam0)
	{
		SET_BIT(&(Global_1589819[PLAYER_ID() /*818*/].f_146), 18);
	}
	else
	{
		CLEAR_BIT(&(Global_1589819[PLAYER_ID() /*818*/].f_146), 18);
	}
}
...
void func_71(int iParam0, bool bParam1)
{
	...
	if (DOES_BLIP_EXIST(Global_93734.f_231[iParam0]))
	{
	}
}
...
void func_74()
{
	...
	switch (vLocal_140[PARTICIPANT_ID_TO_INT() /*3*/].f_1)
	{
		case 0:
			if (!IS_BIT_SET(vLocal_140[PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
			{
				if (!IS_PED_INJURED(PLAYER_PED_ID()))
				{
					if (!IS_BIT_SET(uLocal_238, 5))
					{
						if (GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) == 0)
						{
							if (IS_BIT_SET(uLocal_238, 3))
							{
								CLEAR_BIT(&uLocal_238, 10);
							}
							if (!IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()))
							{
								if (IS_BIT_SET(uLocal_238, 3))
								{
									CLEAR_BIT(&uLocal_238, 3);
								}
								if (IS_BIT_SET(uLocal_238, 7))
								{
									CLEAR_BIT(&uLocal_238, 7);
								}
								if (IS_BIT_SET(uLocal_238, 8))
								{
									CLEAR_BIT(&uLocal_238, 8);
								}
								if (IS_BIT_SET(uLocal_238, 11))
								{
									CLEAR_BIT(&uLocal_238, 11);
								}
								if (!IS_BIT_SET(uLocal_238, 2))
								{
									if (iLocal_237 != -1)
									{
										func_72(iLocal_237, 0);
							...
							else
							{
								if (IS_BIT_SET(uLocal_238, 2))
								{
									CLEAR_BIT(&uLocal_238, 2);
								}
								iVar0 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
								if ((!func_149(iVar0, 0, &uVar1) || !func_148(iVar0)) || func_147(GET_ENTITY_MODEL(iVar0)))
								{
									if (func_146())
									{
										func_145(0);
									...
									if (!IS_BIT_SET(uLocal_238, 8))
									{
										if (func_140())
										{
											if (IS_VEHICLE_DRIVEABLE(iVar0, 0))
											{
												if (iLocal_246 > 0)
												{
													if (func_147(GET_ENTITY_MODEL(iVar0)))
													{
														func_139("FM_CTUT_PRM", -1);
														SET_BIT(&uLocal_238, 8);
														SET_BIT(&uLocal_238, 11);
									...
									else if (IS_BIT_SET(uLocal_238, 11))
									{
								...
								else
								{
									...
									if (!func_135() || (func_135() && IS_PLAYER_CONTROL_ON(PLAYER_ID())))
									{
										if (!IS_BIT_SET(uLocal_238, 3))
										{
											func_176("FM_CTUT_MOD", 0);
											SET_BIT(&uLocal_238, 3);
											func_137(&uLocal_239);
											...
											if (iLocal_237 == -1)
											{
												iLocal_237 = func_118(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 4, -1);
												if (iLocal_237 != -1)
												{
									...
									else if (func_135() && !IS_PLAYER_CONTROL_ON(PLAYER_ID()))
									{
										if (!IS_BIT_SET(uLocal_238, 3))
										{
											SET_BIT(&uLocal_238, 3);
						...
						{
							if (!IS_BIT_SET(uLocal_238, 10))
							{
								if (!IS_BIT_SET(uLocal_238, 9))
								{
							...
							if (func_146())
							{
								if (!IS_PED_INJURED(PLAYER_PED_ID()))
								{
									...
									{
										iVar0 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
										if ((!func_149(iVar0, 0, &uVar2) || !func_148(iVar0)) || func_147(GET_ENTITY_MODEL(iVar0)))
										{
											func_145(0);
										}
									}
					...
					if (IS_BIT_SET(uLocal_238, 3) || (func_135() && IS_BIT_SET(uLocal_238, 10)))
					{
						if (func_135())
						{
							...
							if (!IS_BIT_SET(uLocal_238, 9))
							{
								if (func_112())
								{
									SET_BIT(&uLocal_238, 9);
									SET_BIT(&(Global_2528542.f_1720), 25);
							...
							if (func_111())
							{
								if (!IS_BIT_SET(Global_2528542.f_1720, 25))
								{
									SET_BIT(&(Global_2528542.f_1720), 25);
								}
							...
							else if (IS_BIT_SET(uLocal_238, 9))
							{
								if (func_107(PLAYER_ID()) || (!func_105() && func_104()))
								{
									iVar3 = func_101(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0));
									if (iVar3 > 0)
									{
						...
						else if (IS_BIT_SET(uLocal_238, 9))
						{
							...
							else if (!IS_BIT_SET(vLocal_140[PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
							{
								SET_BIT(&(vLocal_140[PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
							}
						}
					...
					if (!IS_BIT_SET(uLocal_238, 5))
					{
						if (((func_82(PLAYER_ID(), 1) || func_81()) || func_80() > 0) || (!func_78() && !func_135()))
						{
							SET_BIT(&uLocal_238, 5);
							func_23();
						}
					}
					else if (IS_PLAYER_CONTROL_ON(PLAYER_ID()) || func_135())
					{
						if (IS_SCREEN_FADED_IN())
						{
							if ((((!func_82(PLAYER_ID(), 1) && !func_81()) && func_80() == 0) && func_78()) || func_135())
	...
	if (!IS_BIT_SET(vLocal_140[PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
	{
		if (func_76())
		{
			func_8();
...
int func_94()
{
	...
	if (func_95() >= 0)
	{
		if (IS_BIT_SET(Global_1323594[func_95() /*141*/].f_102, 2))
		{
			return 1;
		}
	}
...
int func_97()
{
	...
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		...
		if (func_98(uVar0, 1) || Global_93734.f_1414)
		{
			return 1;
		}
	}
...
{
	return DECOR_EXIST_ON(uParam0, "Sprayed_Vehicle_Decorator");
}
...
int func_101(var uParam0)
{
	...
	if (func_103(GET_ENTITY_MODEL(uParam0), 0))
	{
...
int func_107(int iParam0)
{
	...
	return IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_146, 19);
}
...
void func_108(bool bParam0)
{
	if (bParam0)
	{
		SET_BIT(&(Global_1589819[PLAYER_ID() /*818*/].f_146), 20);
	}
	else
	{
		CLEAR_BIT(&(Global_1589819[PLAYER_ID() /*818*/].f_146), 20);
	}
}
...
int func_109(int iParam0)
{
	...
	return IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_146, 20);
}
...
int func_110(int iParam0)
{
	...
	return IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_146, 21);
}
...
int func_118(vector3 vParam0, int iParam3, int iParam4)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_21(iVar0))
		{
			...
			if (func_133(iVar4))
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_119(iVar0, 0), 1);
...
int func_122(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	vVar18 = { Var12 - Var0 };
	vVar18 = { func_123(vVar18, -Var0.f_3.f_2) };
	vVar18 = { func_123(vVar18, vVar6.f_3.f_2) };
	*uParam2 = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar6, 0f, vVar18) };
	uParam2->f_3 = { Var12.f_3 };
	return 1;
}

Vector3 func_123(vector3 vParam0, float fParam3)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int func_134(int iParam0)
{
	...
	return IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_146, 18);
}
...
int func_140()
{
	if (((((((((((((!func_4(PLAYER_ID(), 1, 1) || IS_PED_INJURED(PLAYER_PED_ID())) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || func_144(8, -1)) || func_144(15, -1)) || func_143()) || func_144(3, -1)) || IS_HELP_MESSAGE_BEING_DISPLAYED()) || func_82(PLAYER_ID(), 1)) || func_81()) || func_104()) || func_142()) || func_141()) || IS_PAUSE_MENU_ACTIVE())
	{
		return 0;
	}
	return 1;
...
void func_145(bool bParam0)
{
	if (bParam0)
	{
		SET_BIT(&(Global_2528542.f_1723), 4);
	}
	else
	{
		CLEAR_BIT(&(Global_2528542.f_1723), 4);
	}
}

bool func_146()
{
	return IS_BIT_SET(Global_2528542.f_1723, 4);
}
...
int func_149(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_174(iVar0, bParam1, uParam2) && !func_173(PLAYER_ID())) && !func_158(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_156(PLAYER_ID()) && (IS_THIS_MODEL_A_HELI(iVar0) || IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_154(iParam0)) && !bVar1) && !(func_153(GET_ENTITY_MODEL(iParam0)) && func_151(PLAYER_ID())))
	{
...
int func_160(int iParam0)
{
	...
	if (func_161(GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_162(int iParam0, bool bParam1)
{
	switch (GET_ENTITY_MODEL(iParam0))
	{
		case joaat("technical"):
		case joaat("insurgent"):
			if (func_164(GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_174(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_156(PLAYER_ID()) && (IS_THIS_MODEL_A_HELI(iParam0) || IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
void func_183()
{
	...
	if (!func_180(0))
	{
		if (func_109(PLAYER_ID()) || iLocal_245)
		{
			func_31(122, 1, -1, 1);
		}
	}
...
int func_193()
{
	...
	if (func_194() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_194()) == 0)
		{
			return 1;
		}
	}
...
void func_204(struct<21> Param0)
{
	...
	func_208(0, -1, 0);
	NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&vLocal_61, 78);
	NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&vLocal_140, 97);
