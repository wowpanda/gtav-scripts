...
void func_18(bool bParam0)//Position - 0x528
{
	...
	{
		ENTITY::SET_ENTITY_COORDS(AUDIO::_0x0626A247D2405330(), 689.1f, 586.5f, 130.5f, 1, 0, 0, 1);
...
void func_37(bool bParam0, bool bParam1)//Position - 0x28A5
{
	if (bParam0)
	{
		if (func_39(0))
...
bool func_38()//Position - 0x2919
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

int func_39(int iParam0)//Position - 0x292B
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
void func_43(int iParam0)//Position - 0x2ABB
{
...
void func_44(char* sParam0)//Position - 0x2B1E
{
	STREAMING::REMOVE_ANIM_DICT(sParam0);
}

void func_45(int iParam0)//Position - 0x2B2C
{
	if (iParam0 != 0)
	{
...
void func_46(var uParam0)//Position - 0x2B40
{
	int iVar0;
	char* sVar1;
	char* sVar2;
...
char* func_47(int iParam0)//Position - 0x2BB5
{
	char* sVar0;
...
char* func_48(int iParam0)//Position - 0x2BCB
{
	char* sVar0;
...
void func_49(var uParam0)//Position - 0x2BE0
{
	int iVar0;
...
void func_50(int iParam0)//Position - 0x2C2C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_51(var uParam0)//Position - 0x2C6D
{
	int iVar0;
...
void func_52(int iParam0)//Position - 0x2C96
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
