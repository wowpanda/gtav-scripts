...
void func_3(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)//Position - 0x10B
{
	...
	iLocal_29[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_4(iParam0), vParam2, iVar0, 4294967295, 2, 1, 0);
...
void func_7(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)//Position - 0x1E7
{
	...
	iLocal_27[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_8(iParam0), vParam2, iVar0, 4294967295, 2, 1, 0);
...
void func_11(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)//Position - 0x3FC
{
	...
	iLocal_24[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_12(iParam0), vParam2, iVar0, 4294967295, 2, 1, 0);
...
void func_14()//Position - 0x5B9
{
	switch (Global_6464)
	{
		...
		case 1:
			...
			{
				case 0:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_20[Global_6466]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_20[Global_6466]))
					{
						Global_6467 = 0;
					}
					else
				...
				case 1:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_22[Global_6466]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_22[Global_6466]))
					{
						Global_6467 = 0;
					}
					else
				...
				case 2:
					if (OBJECT::DOES_PICKUP_EXIST(iLocal_23[Global_6466]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(iLocal_23[Global_6466]))
					{
						Global_6467 = 0;
					}
					else
...
void func_26(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4, bool bParam5)//Position - 0xFF8
{
	...
	iLocal_23[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_28(iParam0, 0), vParam2, iVar0, 4294967295, 2, 1, 0);
...
void func_30(int iParam0, vector3 vParam1, bool bParam2, bool bParam3)//Position - 0x243A
{
	...
	iLocal_22[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_health_standard"), func_32(iParam0, 0), vParam1, iVar0, 4294967295, 2, 1, 0);
...
void func_34(int iParam0, vector3 vParam1, bool bParam2)//Position - 0x3435
{
	...
	iLocal_21[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_weapon_petrolcan"), func_35(iParam0), vParam1, iVar0, 4294967295, 2, 1, 0);
...
void func_37(int iParam0, vector3 vParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x3935
{
	...
	iLocal_20[iParam0] = OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_armour_standard"), func_39(iParam0, 0), vParam1, iVar0, 4294967295, 2, 1, 0);
