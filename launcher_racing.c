...
void func_9()
{
	...
	if (func_63(PLAYER_PED_ID()))
	{
		...
		{
			SET_PED_HELMET(PLAYER_PED_ID(), 0);
		}
	}
	while (!func_57())
	{
	...
	if (Local_83.f_1 != 3)
	{
		...
		if (func_14(uVar1))
		{
			while (!func_12(uVar1, 3f, 2, 1056964608, 0, 1, 0) || GET_GAME_TIMER() < iVar0)
			{
				WAIT(0);
			}
		}
		uVar2 = GET_PLAYER_INDEX();
		if (IS_PLAYER_PLAYING(uVar2))
		{
			SET_PLAYER_CONTROL(uVar2, 0, 0);
		}
	}
	func_10();
}
...
void func_10()
{
	if (!func_11(0))
	{
		...
		START_NEW_SCRIPT_WITH_ARGS("mission_Race", &Local_83, 6, 28000);
	}
...
void func_20(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_22() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_22() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
...
int func_28(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_22() /*10778*/].f_6165.f_10, iParam0);
}
...
int func_29(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2539502[iParam0 /*3*/][func_24(iParam1)];
...
void func_53()
{
	...
	{
		if (func_56(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
			iVar0 = func_55(PLAYER_PED_ID());
...
void func_68(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_72(PLAYER_ID())) && !func_70(PLAYER_ID(), 0)) && !func_69()) && !bParam4) && !bParam5)
			{
								...
								if (bVar33)
								{
									...
									if (GET_HASH_KEY(&(Global_17411.f_73[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										else
										{
											...
											if (func_88() && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (iVar8 == 0)
												{
									...
									if (func_112(Global_17411.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											if (func_112(Global_17411.f_4433[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												...
												DRAW_SPRITE(func_106(Global_17411.f_4433[iVar22]), func_103(Global_17411.f_4433[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), (fVar36 * func_85(Global_17411.f_4433[iVar22])), (fVar37 * func_85(Global_17411.f_4433[iVar22])), 0f, uVar47, uVar48, uVar49, uVar50, 0);
											}
										}
									}
								}
...
void func_87(float fParam0, float fParam1, char* sParam2, var uParam3, int iParam4)
{
	BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
int func_112(int iParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)
{
	...
	if (GET_HASH_KEY(&cVar16) != 0)
	{
		...
		vVar37.x = (vVar37.x * (func_113(iParam0) / fVar34));
		vVar37.y = (vVar37.y * (func_113(iParam0) / fVar34));
		if (!bParam2)
		{
...
int func_114(bool bParam0, bool bParam1)
{
	...
	if ((((((((!IS_SCREEN_FADED_IN() || (func_116(8, -1) && func_115() != 64)) || (GET_PAUSE_MENU_STATE() != 0 && !bParam1)) || (IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0)) || SET_STORE_ENABLED()) || Global_71850) || Global_17411.f_8352) || IS_WARNING_MESSAGE_ACTIVE()) || Global_93734.f_1409)
	{
		return 0;
	}
	return 1;
	...
	if (func_159())
	{
		if (func_142())
		{
			...
			if (func_63(uLocal_103[iVar0]))
			{
				if (bLocal_102)
				{
					if (IS_ENTITY_PLAYING_ANIM(uLocal_103[iVar0], cLocal_184, sLocal_185[iVar0], 3))
					{
						STOP_ANIM_TASK(uLocal_103[iVar0], cLocal_184, sLocal_185[iVar0], -1056964608);
					}
					func_131(iVar0);
				}
			}
...
void func_130()
{
	if (iLocal_92 && GET_GAME_TIMER() > iLocal_95)
	{
		CLEAR_HELP(1);
		iLocal_92 = 0;
	}
...
void func_131(int iParam0)
{
	...
	if (!IS_ENTITY_DEAD(uLocal_103[iParam0], 0) && !IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
	{
		switch (iLocal_195)
		{
			case 0:
				if (VDIST2(GET_ENTITY_COORDS(uLocal_103[iParam0], 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) < 64f)
				{
					iLocal_196 = 0;
					iLocal_197 = 0;
					iLocal_195 = 1;
			...
			case 1:
				...
				TASK_PERFORM_SEQUENCE(uLocal_103[iParam0], uVar0);
				CLEAR_SEQUENCE_TASK(&uVar0);
				iLocal_195 = 2;
				break;
			
			case 2:
				if (GET_SCRIPT_TASK_STATUS(uLocal_103[iParam0], 242628503) != 1 || IS_PED_FACING_PED(uLocal_103[iParam0], PLAYER_PED_ID(), 20f))
				{
					TASK_TURN_PED_TO_FACE_ENTITY(uLocal_103[iParam0], PLAYER_PED_ID(), -1);
					if (!iLocal_197)
					{
			...
			case 3:
				if (!IS_AMBIENT_SPEECH_PLAYING(uLocal_103[iParam0]))
				{
					func_136(&uLocal_198);
					TASK_PLAY_ANIM(uLocal_103[iParam0], "random@street_race", "_streetracer_wait_loop", 4f, -4f, -1, 9, 0, 0, 0, 0);
					iLocal_195 = 4;
				}
				break;
			
			case 4:
				if (VDIST2(GET_ENTITY_COORDS(uLocal_103[iParam0], 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) > 225f)
				{
					iLocal_195 = 0;
				}
...
{
	uParam0->f_1 = (func_133(IS_BIT_SET(*uParam0, 4)) - fParam1);
	SET_BIT(uParam0, 1);
	CLEAR_BIT(uParam0, 2);
	uParam0->f_2 = 0f;
}
...
{
	_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_139(iParam3), 0);
}
...
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()) && !func_141())
	{
		if (func_63(uLocal_103[iParam0]))
		{
			if (iLocal_93 && GET_ENTITY_SPEED(PLAYER_PED_ID()) < 20f)
			{
				SET_GAMEPLAY_ENTITY_HINT(uLocal_103[iParam0], 0f, 0f, 0f, 1, 2000, 2000, 2000, 0);
				iLocal_93 = 0;
			}
		}
	}
...
int func_142()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		...
		{
			func_153(&uLocal_0);
			uLocal_0 = GET_VEHICLE_PED_IS_USING(PLAYER_PED_ID());
			if (!func_148())
			{
				iLocal_92 = 1;
				iLocal_95 = GET_GAME_TIMER() + 1000;
			...
			else if ((GET_ENTITY_HEALTH(uLocal_0) <= 200 || IS_ENTITY_ON_FIRE(uLocal_0)) || func_147())
			{
			...
			else if (GET_PED_IN_VEHICLE_SEAT(uLocal_0, -1, 0) != PLAYER_PED_ID())
			{
				func_143();
				return 0;
			}
			...
			{
				if (func_83(0) || _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appinternet")) > 0)
				{
					func_130();
					return 0;
				}
...
int func_147()
{
	...
	uVar0 = GET_ENTITY_MODEL(uLocal_0);
	if (IS_THIS_MODEL_A_BIKE(uVar0))
	{
		if (IS_VEHICLE_TYRE_BURST(uLocal_0, 6, 0) || IS_VEHICLE_TYRE_BURST(uLocal_0, 7, 0))
		{
			return 1;
		}
	}
	else if (IS_THIS_MODEL_A_CAR(uVar0))
	{
		if (((IS_VEHICLE_TYRE_BURST(uLocal_0, 0, 0) || IS_VEHICLE_TYRE_BURST(uLocal_0, 1, 0)) || IS_VEHICLE_TYRE_BURST(uLocal_0, 4, 0)) || IS_VEHICLE_TYRE_BURST(uLocal_0, 5, 0))
		{
			return 1;
		}
	}
...
int func_149()
{
	...
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		...
		{
			iVar0 = GET_ENTITY_MODEL(uLocal_0);
...
int func_159()
{
	...
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		...
		if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_89, 1) < IntToFloat(iVar0) && GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()) == 0)
		{
			return 1;
		}
	}
	...
	if (func_165(&uLocal_216))
	{
		if (Local_83.f_1 == 2)
		{
			if (func_162())
			{
				...
				{
					if (HAS_MODEL_LOADED(iLocal_182) && HAS_MODEL_LOADED(iLocal_182))
					{
						uLocal_111 = CREATE_VEHICLE(iLocal_182, vLocal_113, fLocal_116, 1, 1, 0);
						if (CAN_CREATE_RANDOM_PED(1) && CAN_CREATE_RANDOM_DRIVER())
						{
							iLocal_112 = CREATE_RANDOM_PED_AS_DRIVER(uLocal_111, 1);
							TASK_VEHICLE_TEMP_ACTION(iLocal_112, uLocal_111, 1, 99999999);
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_112, 1);
							SET_PED_KEEP_TASK(iLocal_112, 1);
						}
						SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_111, 1084227584);
						SET_VEHICLE_ENGINE_ON(uLocal_111, 1, 1, 0);
						SET_VEHICLE_RADIO_ENABLED(uLocal_111, 1);
						SET_VEHICLE_RADIO_LOUD(uLocal_111, 1);
						_0x774BD811F656A122(GET_RADIO_STATION_NAME(10), 1);
						SET_VEH_RADIO_STATION(uLocal_111, GET_RADIO_STATION_NAME(10));
						_0xAB04325045427AAE(uLocal_111, 0);
						SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_182);
						WAIT(0);
					}
				}
				if (!DOES_ENTITY_EXIST(uLocal_117))
				{
					if (HAS_MODEL_LOADED(iLocal_183))
					{
						uLocal_117 = CREATE_VEHICLE(iLocal_183, vLocal_118, fLocal_121, 1, 1, 0);
						SET_VEHICLE_ENGINE_ON(uLocal_117, 0, 1, 0);
						SET_VEHICLE_RADIO_ENABLED(uLocal_117, 1);
						SET_VEHICLE_RADIO_LOUD(uLocal_117, 1);
						SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_117, 1084227584);
						_0x774BD811F656A122(GET_RADIO_STATION_NAME(10), 1);
						SET_VEH_RADIO_STATION(uLocal_117, GET_RADIO_STATION_NAME(10));
						_0xAB04325045427AAE(uLocal_117, 0);
						SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_183);
						WAIT(0);
					}
				}
				if (HAS_ANIM_DICT_LOADED(cLocal_184))
				{
					if (iLocal_193)
					{
						iVar0 = 0;
						...
						{
							if (DOES_ENTITY_EXIST(uLocal_103[iVar0]))
							{
								if (!IS_ENTITY_DEAD(uLocal_103[iVar0], 0) && !func_161(uLocal_103[iVar0], -2017877118))
								{
									TASK_PLAY_ANIM(uLocal_103[iVar0], cLocal_184, sLocal_185[iVar0], 1000f, -1000f, -1, 1, 0, 0, 0, 0);
									SET_PED_KEEP_TASK(uLocal_103[iVar0], 1);
								}
							}
							else if (HAS_MODEL_LOADED(iLocal_174[iVar0]))
							{
								uLocal_103[iVar0] = CREATE_PED(25, iLocal_174[iVar0], vLocal_136[iVar0 /*3*/], fLocal_158[iVar0], 1, 1);
								SET_ENTITY_COORDS_NO_OFFSET(uLocal_103[iVar0], vLocal_136[iVar0 /*3*/], 0, 0, 1);
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_103[iVar0], 1);
								TASK_PLAY_ANIM(uLocal_103[iVar0], cLocal_184, sLocal_185[iVar0], 1000f, -1000f, -1, 1, 0, 0, 0, 0);
								SET_PED_KEEP_TASK(uLocal_103[iVar0], 1);
							}
							iVar0++;
						}
						if ((((((((func_63(uLocal_103[0]) && func_63(uLocal_103[1])) && func_63(uLocal_103[2])) && func_63(uLocal_103[3])) && func_63(uLocal_103[4])) && func_63(uLocal_103[5])) && func_63(uLocal_103[6])) && func_14(uLocal_111)) && func_14(uLocal_117))
						{
							bLocal_102 = true;
							iVar0 = 0;
							while (iVar0 <= (iLocal_174 - 1))
		...
		else if (Local_83.f_1 == 1)
		{
			if (func_162())
			{
				if (!DOES_ENTITY_EXIST(uLocal_111))
				{
					if (HAS_MODEL_LOADED(iLocal_182))
					{
						uLocal_111 = CREATE_VEHICLE(iLocal_182, vLocal_113, fLocal_116, 1, 1, 0);
				...
				if (HAS_ANIM_DICT_LOADED(cLocal_184))
				{
					if (iLocal_193)
					{
						...
						{
							if (DOES_ENTITY_EXIST(uLocal_103[iVar1]))
							{
								if (!IS_ENTITY_DEAD(uLocal_103[iVar1], 0) && !func_161(uLocal_103[iVar1], -2017877118))
								{
									SET_ENTITY_COORDS_NO_OFFSET(uLocal_103[iVar1], vLocal_136[iVar1 /*3*/], 0, 0, 1);
									if (iVar1 != 2 && iVar1 != 3)
									{
										TASK_PLAY_ANIM(uLocal_103[iVar1], cLocal_184, sLocal_185[iVar1], 1000f, -1000f, -1, 1, 0, 0, 0, 0);
									}
									else
									{
										TASK_PLAY_ANIM(uLocal_103[iVar1], cLocal_184, sLocal_185[iVar1], 1000f, -1000f, -1, 1, 0.5f, 0, 0, 0);
									}
									SET_PED_KEEP_TASK(uLocal_103[iVar1], 1);
								}
							}
							else if (HAS_MODEL_LOADED(iLocal_174[iVar1]))
							{
								uLocal_103[iVar1] = CREATE_PED(25, iLocal_174[iVar1], vLocal_136[iVar1 /*3*/], fLocal_158[iVar1], 1, 1);
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_103[iVar1], 1);
							}
							iVar1++;
						}
						if ((((func_63(uLocal_103[0]) && func_63(uLocal_103[1])) && func_63(uLocal_103[2])) && func_63(uLocal_103[3])) && func_63(uLocal_103[4]))
						{
							TASK_LOOK_AT_ENTITY(uLocal_103[4], PLAYER_PED_ID(), -1, 2048, 4);
							iVar1 = 0;
			...
			if (func_162())
			{
				if (!DOES_ENTITY_EXIST(uLocal_111))
				{
					if (HAS_MODEL_LOADED(iLocal_182))
					{
						uLocal_111 = CREATE_VEHICLE(iLocal_182, vLocal_113, fLocal_116, 1, 1, 0);
						SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_111, 1084227584);
						_0xE842A9398079BD82(uLocal_111, 0f);
						_0xE3EBAAE484798530(uLocal_111, 0);
						_0xB28B1FE5BFADD7F5(uLocal_111, 0);
						if (_0x2467A2D807D37CA3(uLocal_111))
						{
							SET_BOAT_ANCHOR(uLocal_111, 1);
						}
						SET_VEHICLE_ENGINE_ON(uLocal_111, 0, 1, 0);
					}
				}
				iVar2 = 0;
				iVar2 = 0;
				while (iVar2 < 3)
				{
					if (DOES_ENTITY_EXIST(uLocal_166[iVar2]))
					{
						if (DOES_ENTITY_EXIST(iLocal_170[iVar2]))
						{
							if (!IS_PED_INJURED(iLocal_170[iVar2]) && func_14(uLocal_166[iVar2]))
							{
								if (IS_VEHICLE_SEAT_FREE(uLocal_166[iVar2], -1, 0))
								{
									SET_PED_INTO_VEHICLE(iLocal_170[iVar2], uLocal_166[iVar2], -1);
								}
							}
						}
						else if (func_14(uLocal_166[iVar2]) && HAS_MODEL_LOADED(joaat("a_m_y_jetski_01")))
						{
							iLocal_170[iVar2] = CREATE_PED_INSIDE_VEHICLE(uLocal_166[iVar2], 25, joaat("a_m_y_jetski_01"), -1, 1, 1);
							SET_PED_DIES_IN_WATER(iLocal_170[iVar2], 0);
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_170[iVar2], 1);
						}
					}
					else if (HAS_MODEL_LOADED(iLocal_182))
					{
						uLocal_166[iVar2] = CREATE_VEHICLE(iLocal_182, vLocal_122[iVar2 /*3*/], fLocal_132[iVar2], 1, 1, 0);
						SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_166[iVar2], 1084227584);
						_0xE842A9398079BD82(uLocal_166[iVar2], 0f);
						_0xE3EBAAE484798530(uLocal_166[iVar2], 1);
						_0xB28B1FE5BFADD7F5(uLocal_166[iVar2], 1);
						if (_0x2467A2D807D37CA3(uLocal_166[iVar2]))
						{
							SET_BOAT_ANCHOR(uLocal_166[iVar2], 1);
						}
						SET_VEHICLE_ENGINE_ON(uLocal_166[iVar2], 0, 1, 0);
					}
					iVar2++;
				}
				if (((DOES_ENTITY_EXIST(uLocal_111) && DOES_ENTITY_EXIST(uLocal_166[0])) && DOES_ENTITY_EXIST(uLocal_166[1])) && DOES_ENTITY_EXIST(uLocal_166[2]))
				{
					SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_182);
				}
				if ((DOES_ENTITY_EXIST(iLocal_170[0]) && DOES_ENTITY_EXIST(iLocal_170[1])) && DOES_ENTITY_EXIST(iLocal_170[2]))
				{
...
int func_162()
{
	...
	if (func_63(PLAYER_PED_ID()))
	{
		if (!func_163(PLAYER_PED_ID(), vLocal_113, 100f) || IS_SCREEN_FADED_OUT())
		{
			return 1;
		}
	}
...
bool func_163(var uParam0, vector3 vParam1, float fParam4)
{
...
void func_172()
{
	...
	if (Local_83.f_1 == 1 || Local_83.f_1 == 2)
	{
		...
		func_177(Local_83, &vLocal_207, &vLocal_210, &fLocal_213);
		...
		SET_PED_PATHS_IN_AREA(vLocal_201, vLocal_204, 0, 0);
		SET_ROADS_IN_ANGLED_AREA(vLocal_207, vLocal_210, fLocal_213, 0, 0, 1);
		iLocal_94 = 1;
	}
	else if (Local_83.f_1 == 3)
	{
...
int func_178()
{
	...
	if (func_63(PLAYER_PED_ID()) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		uVar0 = GET_PLAYERS_LAST_VEHICLE();
		if (((func_14(uVar0) && IS_PED_SITTING_IN_VEHICLE(PLAYER_PED_ID(), uVar0)) && !func_200(PLAYER_PED_ID(), uVar0, -1)) && GET_ENTITY_MODEL(uVar0) != joaat("taxi"))
		{
			return 0;
		}
	}
	...
	if (!func_164())
	{
		...
		while (iVar1 <= (iLocal_174 - 1))
		{
			if (func_63(uLocal_103[iVar1]))
			{
				...
				TASK_PERFORM_SEQUENCE(uLocal_103[iVar1], uVar2);
			}
			iVar1++;
		}
		iVar1 = 0;
		while (iVar1 <= (iLocal_170 - 1))
		{
			if (func_63(iLocal_170[iVar1]))
			{
				...
				if (func_14(uLocal_166[iVar1]) && IS_PED_IN_VEHICLE(iLocal_170[iVar1], uLocal_166[iVar1], 0))
				{
					TASK_VEHICLE_DRIVE_WANDER(0, uLocal_166[iVar1], 30f, 786597);
				}
				else
				{
					TASK_WANDER_STANDARD(0, 1193033728, 0);
				...
				CLOSE_SEQUENCE_TASK(uVar2);
				TASK_PERFORM_SEQUENCE(iLocal_170[iVar1], uVar2);
			}
			iVar1++;
		}
		if (func_63(iLocal_112))
		{
			if (func_14(uLocal_111) && IS_PED_IN_VEHICLE(iLocal_112, uLocal_111, 0))
			{
				TASK_VEHICLE_DRIVE_WANDER(iLocal_112, uLocal_111, 30f, 786597);
			}
			else
			{
	...
	if (func_180())
	{
		...
		while (iVar4 <= (iLocal_174 - 1))
		{
			if (func_63(uLocal_103[iVar4]))
			{
				...
				TASK_PERFORM_SEQUENCE(uLocal_103[iVar4], uVar3);
			}
			iVar4++;
		}
		iVar4 = 0;
		while (iVar4 <= (iLocal_170 - 1))
		{
			...
			{
				SET_BOAT_ANCHOR(uLocal_166[iVar4], 0);
			}
			if (func_63(iLocal_170[iVar4]))
			{
				OPEN_SEQUENCE_TASK(&uVar3);
				TASK_PAUSE(0, iVar4 * 60);
				if (func_14(uLocal_166[iVar4]) && IS_PED_IN_VEHICLE(iLocal_170[iVar4], uLocal_166[iVar4], 0))
				{
					TASK_VEHICLE_DRIVE_WANDER(0, uLocal_166[iVar4], 50f, 786468);
				}
				else
				{
					TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 500f, -1, 0, 0);
				...
				CLOSE_SEQUENCE_TASK(uVar3);
				TASK_PERFORM_SEQUENCE(iLocal_170[iVar4], uVar3);
				if ((iVar4 % 2) == 0)
				{
		...
		{
			SET_BOAT_ANCHOR(uLocal_111, 0);
		}
		if (func_63(iLocal_112))
		{
			if (func_14(uLocal_111) && IS_PED_IN_VEHICLE(iLocal_112, uLocal_111, 0))
			{
				TASK_VEHICLE_DRIVE_WANDER(iLocal_112, uLocal_111, 50f, 786468);
			}
			else
			{
				TASK_SMART_FLEE_PED(iLocal_112, PLAYER_PED_ID(), 500f, -1, 0, 0);
			}
		}
		switch (Local_83)
		{
			case 0:
				Global_106539[0] = 1;
				Global_106545[0] = GET_GAME_TIMER();
				break;
			
			case 1:
				Global_106539[1] = 1;
				Global_106545[1] = GET_GAME_TIMER();
				break;
			
			case 2:
				Global_106539[2] = 1;
				Global_106545[2] = GET_GAME_TIMER();
				break;
			
			case 3:
				Global_106539[3] = 1;
				Global_106545[3] = GET_GAME_TIMER();
				break;
			
			case 4:
				Global_106539[4] = 1;
				Global_106545[4] = GET_GAME_TIMER();
				break;
			
			case 5:
				Global_106529[0] = 1;
				Global_106534[0] = GET_GAME_TIMER();
				break;
			
			case 6:
				Global_106529[1] = 1;
				Global_106534[1] = GET_GAME_TIMER();
				break;
			
			case 7:
				Global_106529[2] = 1;
				Global_106534[2] = GET_GAME_TIMER();
				break;
			
			case 8:
				Global_106529[3] = 1;
				Global_106534[3] = GET_GAME_TIMER();
				break;
		}
		return 0;
	}
...
int func_180()
{
	...
	if (Local_83.f_1 == 3)
	{
		...
		while (iVar0 <= (iLocal_170 - 1))
		{
			...
			{
				if (IS_PED_INJURED(iLocal_170[iVar0]))
				{
					return 1;
				}
				else if (func_181(iLocal_170[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0) || IS_PED_BEING_JACKED(iLocal_170[iVar0]))
				{
					return 1;
				}
			}
			if (DOES_ENTITY_EXIST(uLocal_166[iVar0]))
			{
				if (IS_ENTITY_DEAD(uLocal_166[iVar0], 0))
				{
					return 1;
				}
				else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_166[iVar0], PLAYER_PED_ID(), 1) && GET_ENTITY_HEALTH(uLocal_166[iVar0]) < 900)
				{
					return 1;
				}
			}
		...
		if (DOES_ENTITY_EXIST(uLocal_111))
		{
			if (IS_ENTITY_DEAD(uLocal_111, 0))
			{
				return 1;
			}
			else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_111, PLAYER_PED_ID(), 1) && GET_ENTITY_HEALTH(uLocal_111) < 900)
			{
				return 1;
			}
		}
	...
	if (func_163(PLAYER_PED_ID(), vLocal_89, 50f) && IS_PED_SHOOTING(PLAYER_PED_ID()))
	{
		return 1;
	}
	if (DOES_ENTITY_EXIST(iLocal_112))
	{
		if (IS_PED_INJURED(iLocal_112))
		{
			return 1;
		}
		...
		{
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_112, 0);
			return 1;
		}
	}
	if (DOES_ENTITY_EXIST(uLocal_111))
	{
		...
		else if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_111, 1) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_111, PLAYER_PED_ID(), 1))
		{
			return 1;
		}
	}
	if (DOES_ENTITY_EXIST(uLocal_117))
	{
		if (IS_ENTITY_DEAD(uLocal_117, 0))
		{
			return 1;
		}
		else if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_117, 1) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_117, PLAYER_PED_ID(), 1))
		{
			return 1;
		}
	}
	...
	while (iVar0 <= (iLocal_174 - 1))
	{
		if (DOES_ENTITY_EXIST(uLocal_103[iVar0]))
		{
			if (IS_PED_INJURED(uLocal_103[iVar0]))
			{
				return 1;
			}
...
int func_181(int iParam0, bool bParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	vector3 vVar0;
	...
	if (func_15(PLAYER_PED_ID()) && func_15(iParam0))
	{
		...
		if (!IS_PED_ARMED(PLAYER_PED_ID(), 6))
		{
			if (IS_PED_IN_MELEE_COMBAT(PLAYER_PED_ID()))
			{
				...
				{
					return func_194(PLAYER_PED_ID(), iParam0, iParam2);
				}
			}
		}
		if (bParam4)
...
int func_182(int iParam0, float fParam1)
{
	...
	if (func_15(PLAYER_PED_ID()) && func_15(iParam0))
	{
		if (func_193(iParam0) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), iParam0))
		{
			if (IS_PED_ARMED(PLAYER_PED_ID(), 6))
			{
				fVar0 = 40f;
...
{
	return func_184(iParam0, PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
...
bool func_184(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_185(&(Local_40[iVar4 /*4*/]), vVar1, iParam1, &(Local_40[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (GET_GAME_TIMER() - Local_40[iVar4 /*4*/].f_3) < iParam4);
}

int func_185(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_186(iParam4, iParam7) };
...
int func_188(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_190(GET_ENTITY_COORDS(iParam1, 1) - GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		vVar3 = { func_190(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_189(vVar3, vVar0);
...
float func_189(vector3 vParam0, vector3 vParam3)
{
...
bool func_194(var uParam0, var uParam1, var uParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_195(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_15(PLAYER_PED_ID()) && func_15(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_199(uParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_196(uParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_196(var uParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_197(var uParam0, float fParam1)
{
	...
	{
		if (func_198(uParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_198(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_190(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_190(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_189(vVar3, vVar0);
...
int func_199(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (IS_PED_SHOOTING(PLAYER_PED_ID()))
...
int func_201()
{
	...
	{
		case 5:
			return IS_BIT_SET(Global_106565.f_24970.f_2, 0);
			break;
		
		case 6:
			return IS_BIT_SET(Global_106565.f_24970.f_2, 1);
			break;
		
		case 7:
			return IS_BIT_SET(Global_106565.f_24970.f_2, 2);
			break;
		
		case 8:
			return IS_BIT_SET(Global_106565.f_24970.f_2, 3);
			break;
		
		case 0:
			return IS_BIT_SET(Global_106565.f_24973.f_3, 0);
			break;
		
		case 1:
			return IS_BIT_SET(Global_106565.f_24973.f_3, 1);
			break;
		
		case 2:
			return IS_BIT_SET(Global_106565.f_24973.f_3, 2);
			break;
		
		case 3:
			return IS_BIT_SET(Global_106565.f_24973.f_3, 3);
			break;
		
		case 4:
			return IS_BIT_SET(Global_106565.f_24973.f_3, 4);
			break;
	}
	return 0;
}
...
void func_202()
{
	...
	SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_PARK_PARALLEL", 0);
	if (Local_83 == 1)
	{
		uLocal_215 = func_203(374.0083f, 279.5919f, 102.3306f, 40f);
		CLEAR_AREA_OF_VEHICLES(374.0083f, 279.5919f, 102.3306f, 25f, 0, 0, 0, 0, 0, 0);
	}
	if (Local_83.f_1 == 1 || Local_83.f_1 == 2)
	{
		uLocal_214 = func_203(vLocal_89, 60f);
	}
}

var func_203(vector3 vParam0, float fParam3)
{
	vector3 vVar0;
...
int func_208(int iParam0)
{
	...
	{
		case 0:
			return IS_BIT_SET(Global_106565.f_24973.f_1, 0);
			break;
		
		case 1:
			return IS_BIT_SET(Global_106565.f_24973.f_1, 1);
			break;
		
		case 2:
			return IS_BIT_SET(Global_106565.f_24973.f_1, 2);
			break;
		
		case 3:
			return IS_BIT_SET(Global_106565.f_24973.f_1, 3);
			break;
		
		case 4:
			return IS_BIT_SET(Global_106565.f_24973.f_1, 4);
			break;
	}
	return 0;
}
...
void func_210()
{
	if (func_211(func_212(86, 0), vLocal_89, 1f, 0))
	{
		Local_83 = 0;
		Local_83.f_1 = 2;
		Local_83.f_3 = 100;
	...
	else if (func_211(func_212(87, 0), vLocal_89, 1f, 0))
	{
		Local_83 = 1;
		Local_83.f_1 = 2;
		Local_83.f_3 = 500;
	...
	else if (func_211(func_212(88, 0), vLocal_89, 1f, 0))
	{
		Local_83 = 2;
		Local_83.f_1 = 2;
		Local_83.f_3 = 1000;
	...
	else if (func_211(func_212(89, 0), vLocal_89, 1f, 0))
	{
		Local_83 = 3;
		Local_83.f_1 = 2;
		Local_83.f_3 = 1250;
	...
	else if (func_211(func_212(90, 0), vLocal_89, 1f, 0))
	{
		Local_83 = 4;
		Local_83.f_1 = 1;
		Local_83.f_3 = 1500;
	...
	else if (func_211(func_212(82, 0), vLocal_89, 1f, 0))
	{
		Local_83 = 5;
		Local_83.f_1 = 3;
		Local_83.f_3 = 0;
	...
	else if (func_211(func_212(83, 0), vLocal_89, 1f, 0))
	{
		Local_83 = 6;
		Local_83.f_1 = 3;
		Local_83.f_3 = 0;
	...
	else if (func_211(func_212(84, 0), vLocal_89, 1f, 0))
	{
		Local_83 = 7;
		Local_83.f_1 = 3;
		Local_83.f_3 = 0;
	...
	else if (func_211(func_212(85, 0), vLocal_89, 1f, 0))
	{
		Local_83 = 8;
		Local_83.f_1 = 3;
		Local_83.f_4 = 24;
...
void func_213(bool bParam0)
{
	...
	while (iVar0 < 7)
	{
		...
		{
			CLEAR_PED_TASKS(uLocal_103[iVar0]);
			TASK_WANDER_STANDARD(uLocal_103[iVar0], 1193033728, 0);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_103[iVar0], 0);
			SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_103[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	...
	while (iVar0 < 3)
	{
		if (func_15(iLocal_170[iVar0]))
		{
			...
			{
				CLEAR_PED_TASKS(iLocal_170[iVar0]);
				if (IS_THIS_MODEL_A_BOAT(GET_ENTITY_MODEL(uLocal_166[iVar0])))
				{
					SET_BOAT_ANCHOR(uLocal_166[iVar0], 0);
				}
				TASK_VEHICLE_DRIVE_WANDER(iLocal_170[iVar0], uLocal_166[iVar0], 20f, 786599);
				SET_PED_KEEP_TASK(iLocal_170[iVar0], 1);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_170[iVar0], 0);
				SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_170[iVar0]));
				SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uLocal_166[iVar0]));
			}
		}
		iVar0++;
	}
	if (func_15(iLocal_112))
	{
		if (func_15(uLocal_111))
		{
			...
			SET_PED_COMBAT_ATTRIBUTES(iLocal_112, 1, 1);
			TASK_VEHICLE_DRIVE_WANDER(iLocal_112, uLocal_111, 15f, 786599);
			SET_PED_KEEP_TASK(iLocal_112, 1);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_112, 0);
			SET_PED_AS_NO_LONGER_NEEDED(&iLocal_112);
			SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_111);
		}
	}
	...
	{
		uVar1 = GET_PLAYER_INDEX();
		if (IS_PLAYER_PLAYING(uVar1))
		{
			if (!IS_PLAYER_CONTROL_ON(uVar1))
			{
				SET_PLAYER_CONTROL(uVar1, 1, 0);
			}
		}
	}
	if (!bParam0)
	...
	SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_PARK_PARALLEL", 1);
	if (Local_83 == 1)
	{
		REMOVE_SCENARIO_BLOCKING_AREA(uLocal_215, 0);
	}
	if (Local_83.f_1 == 1 || Local_83.f_1 == 2)
	{
		REMOVE_SCENARIO_BLOCKING_AREA(uLocal_214, 0);
	}
	else
	{
