...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (DOES_SCENARIO_GROUP_EXIST("DEALERSHIP"))
		{
			...
			{
				SET_SCENARIO_GROUP_ENABLED("DEALERSHIP", 0);
			}
		}
		fVar0 = (_0x8BFCEB5EA1B161B6() + 20f);
		if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), vLocal_99) < (fVar0 * fVar0))
		{
			_0xAF66DCEE6609B148();
		}
		if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), vLocal_103) < (fVar0 * fVar0))
		{
			_0xAF66DCEE6609B148();
		}
		...
		else if (bLocal_120)
		{
			...
			if (func_2(uLocal_90))
			{
				if (func_1(uLocal_90, PLAYER_PED_ID(), 1) > 120f)
				{
					func_94();
				}
			}
	...
	switch (iLocal_89)
	{
		...
		case 1:
			...
			if (func_2(uLocal_90))
			{
				if (func_52())
				{
					if (!iLocal_112)
					{
						iLocal_113 = 1;
						iLocal_108 = 1;
						CLEAR_PED_TASKS(uLocal_90);
						if (DOES_ENTITY_EXIST(uLocal_94))
						{
							DELETE_OBJECT(&uLocal_94);
						}
						if (!bLocal_110)
						{
							if (!bLocal_111)
							{
								OPEN_SEQUENCE_TASK(&uLocal_147);
								...
								CLOSE_SEQUENCE_TASK(uLocal_147);
							}
							else
							{
								OPEN_SEQUENCE_TASK(&uLocal_147);
							...
							TASK_PERFORM_SEQUENCE(uLocal_90, uLocal_147);
							CLEAR_SEQUENCE_TASK(&uLocal_147);
							iLocal_112 = 1;
						}
						else
						{
							if (!bLocal_111)
							{
								OPEN_SEQUENCE_TASK(&uLocal_147);
								TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), -1, 0, 2);
								if (func_1(uLocal_90, PLAYER_PED_ID(), 1) <= 4f)
								{
									TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), 1500);
								}
								TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 150f, -1, 1, 0);
								CLOSE_SEQUENCE_TASK(uLocal_147);
							}
							else
							{
					...
					{
						func_35();
						SET_PED_MAX_MOVE_BLEND_RATIO(uLocal_90, 2f);
						if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(uLocal_90, 0), 1) >= 100f && !IS_SPHERE_VISIBLE(GET_ENTITY_COORDS(uLocal_90, 0), 3f))
						{
							DELETE_PED(&uLocal_90);
						}
				...
				else
				{
					...
					if (Local_47[0 /*20*/].f_18 >= 5 && Local_47[1 /*20*/].f_18 >= 5)
					{
						if (!IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -69.62395f, -1087.37f, 24.59833f, -11.27861f, -1108.28f, 34.17205f, 47.5f, 0, 1, 0))
						{
							func_4();
						}
					}
					if (func_2(uLocal_90))
					{
						SET_PED_RESET_FLAG(uLocal_90, 60, 1);
					}
				}
			}
			else
			{
				...
				if (DOES_ENTITY_EXIST(uLocal_90))
				{
					if (IS_ENTITY_DEAD(uLocal_90, 0))
					{
						if (!iLocal_121)
						{
							iLocal_121 = 1;
...
{
	_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_37(iParam2), 1);
}
...
int func_52()
{
	if (func_2(uLocal_90))
	{
		if (!bLocal_110)
		{
			if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(uLocal_90, 0), 1) <= 7f || GET_SCRIPT_TASK_STATUS(uLocal_90, 242628503) == 7)
			{
				if (!iLocal_112)
				{
					if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(uLocal_90, 0), 1) <= 7f)
					{
					}
					if (GET_SCRIPT_TASK_STATUS(uLocal_90, 242628503) == 7)
					{
					}
				}
				return 1;
		...
		else if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(uLocal_90, 0), 1) <= 4.5f || GET_SCRIPT_TASK_STATUS(uLocal_90, 242628503) == 7)
		{
			if (!iLocal_112)
			{
				if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(uLocal_90, 0), 1) <= 4.5f)
				{
				}
				if (GET_SCRIPT_TASK_STATUS(uLocal_90, 242628503) == 7)
				{
...
void func_53()
{
	if (func_2(uLocal_90))
	{
		if (IS_ENTITY_PLAYING_ANIM(uLocal_90, "cellphone@", "cellphone_call_out", 3))
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_90, "cellphone@", "cellphone_call_out") >= 0.24f)
			{
				if (DOES_ENTITY_EXIST(uLocal_94))
				{
					DELETE_OBJECT(&uLocal_94);
					...
					if (func_59())
					{
						if (iLocal_119 == 0)
						{
							if (bLocal_109)
							{
								...
								TASK_PLAY_ANIM(0, "cellphone@", "cellphone_call_out", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
								CLOSE_SEQUENCE_TASK(uLocal_147);
								TASK_PERFORM_SEQUENCE(uLocal_90, uLocal_147);
								CLEAR_SEQUENCE_TASK(&uLocal_147);
							}
						...
						{
							if ((GET_GAME_TIMER() - iLocal_97) >= iLocal_98)
							{
								func_56();
...
void func_56()
{
	if (func_49() == 1)
	{
		func_50(&uLocal_152, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	else
	{
		func_50(&uLocal_152, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
	}
...
int func_57()
{
	if ((((((((func_58(PLAYER_PED_ID()) != joaat("weapon_unarmed") && func_58(PLAYER_PED_ID()) != joaat("object")) && func_58(PLAYER_PED_ID()) != joaat("weapon_knife")) && func_58(PLAYER_PED_ID()) != joaat("weapon_nightstick")) && func_58(PLAYER_PED_ID()) != joaat("weapon_hammer")) && func_58(PLAYER_PED_ID()) != joaat("weapon_bat")) && func_58(PLAYER_PED_ID()) != joaat("weapon_crowbar")) && func_58(PLAYER_PED_ID()) != joaat("weapon_golfclub")) && func_58(PLAYER_PED_ID()) != joaat("weapon_bottle"))
	{
...
int func_59()
{
	if (!IS_COP_PED_IN_AREA_3D(vLocal_126, vLocal_129) && !(IS_POSITION_OCCUPIED(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) && IS_POSITION_OCCUPIED(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0)))
	{
		if (GET_ROOM_KEY_FROM_ENTITY(PLAYER_PED_ID()) == GET_HASH_KEY("rm_showroom"))
		{
			if (!func_123())
			{
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -41.19015f, -1104.137f, 24.42232f, -33.7943f, -1107.183f, 28.67232f, 8.5f, 0, 1, 0))
				{
					bLocal_110 = true;
					func_71(0);
				}
	...
	else if (IS_COP_PED_IN_AREA_3D(vLocal_126, vLocal_129) || (IS_POSITION_OCCUPIED(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) && IS_POSITION_OCCUPIED(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0)))
	{
		if (GET_ROOM_KEY_FROM_ENTITY(PLAYER_PED_ID()) == GET_HASH_KEY("rm_showroom"))
		{
...
int func_65()
{
	switch (func_66(&Global_25824, 0, 5, 0, GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
void func_71(bool bParam0)
{
	if (bParam0)
	{
		if (func_2(uLocal_92))
		{
			SET_ENTITY_VISIBLE(uLocal_92, 1, 0);
			FREEZE_ENTITY_POSITION(uLocal_92, 0);
			SET_ENTITY_CAN_BE_DAMAGED(uLocal_92, 1);
			uLocal_90 = uLocal_92;
			uLocal_94 = uLocal_96;
			func_60(&uLocal_91);
			func_72(&uLocal_95);
	...
	{
		SET_ENTITY_VISIBLE(uLocal_91, 1, 0);
		FREEZE_ENTITY_POSITION(uLocal_91, 0);
		SET_ENTITY_CAN_BE_DAMAGED(uLocal_91, 1);
		uLocal_90 = uLocal_91;
		uLocal_94 = uLocal_95;
		func_60(&uLocal_92);
		func_72(&uLocal_96);
...
void func_73()
{
	switch (iLocal_89)
	{
		case 0:
			...
			SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-51.89f, -1097.35f, 23.42f, -45.71f, -1092.1f, 27.42f, 0, 1);
			CLEAR_ANGLED_AREA_OF_VEHICLES(-53.57574f, -1095.356f, 24.17232f, -46.52551f, -1094.587f, 27.42232f, 3.75f, 0, 0, 0, 0, 0, 0);
			break;
		
		case 1:
			if (!func_2(uLocal_91) || !func_2(uLocal_92))
			{
				func_75(&uLocal_91, 18, vLocal_99, fLocal_102, 1);
				if (func_2(uLocal_91))
				{
					SET_ENTITY_VISIBLE(uLocal_91, 0, 0);
					SET_ENTITY_CAN_BE_DAMAGED(uLocal_91, 0);
					SET_PED_CAN_BE_TARGETTED(uLocal_91, 0);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_91, 1);
					SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_91, uLocal_150);
					SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_91, 1);
					GIVE_WEAPON_TO_PED(uLocal_91, joaat("weapon_pistol"), 999, 0, 0);
					SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(uLocal_91, 0, uLocal_148);
					SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_148, 1862763509);
					SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_91, 1, 1);
					SET_PED_CONFIG_FLAG(uLocal_91, 104, 1);
					uLocal_95 = CREATE_OBJECT(iLocal_122, GET_ENTITY_COORDS(uLocal_91, 1), 1, 1, 0);
					ATTACH_ENTITY_TO_ENTITY(uLocal_95, uLocal_91, GET_PED_BONE_INDEX(uLocal_91, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
					OPEN_SEQUENCE_TASK(&uLocal_147);
					TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_b", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_f", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_no_a", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_d", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
					SET_SEQUENCE_TO_REPEAT(uLocal_147, 1);
					CLOSE_SEQUENCE_TASK(uLocal_147);
					TASK_PERFORM_SEQUENCE(uLocal_91, uLocal_147);
					CLEAR_SEQUENCE_TASK(&uLocal_147);
					FREEZE_ENTITY_POSITION(uLocal_91, 1);
				}
				func_75(&uLocal_92, 18, vLocal_103, fLocal_106, 1);
				if (func_2(uLocal_92))
				{
					SET_ENTITY_VISIBLE(uLocal_92, 0, 0);
					SET_ENTITY_CAN_BE_DAMAGED(uLocal_92, 0);
					SET_PED_CAN_BE_TARGETTED(uLocal_92, 0);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_92, 1);
					SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_92, uLocal_150);
					SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_92, 1);
					GIVE_WEAPON_TO_PED(uLocal_92, joaat("weapon_pistol"), 999, 0, 0);
					SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(uLocal_92, 0, uLocal_148);
					SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_148, 1862763509);
					SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_92, 1, 1);
					SET_PED_CONFIG_FLAG(uLocal_92, 104, 1);
					uLocal_96 = CREATE_OBJECT(iLocal_122, GET_ENTITY_COORDS(uLocal_92, 1), 1, 1, 0);
					ATTACH_ENTITY_TO_ENTITY(uLocal_96, uLocal_92, GET_PED_BONE_INDEX(uLocal_92, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
					OPEN_SEQUENCE_TASK(&uLocal_147);
					TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_b", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_f", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_no_a", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
					...
					SET_SEQUENCE_TO_REPEAT(uLocal_147, 1);
					CLOSE_SEQUENCE_TASK(uLocal_147);
					TASK_PERFORM_SEQUENCE(uLocal_92, uLocal_147);
					CLEAR_SEQUENCE_TASK(&uLocal_147);
					FREEZE_ENTITY_POSITION(uLocal_91, 1);
				}
			}
			...
			{
				func_74();
				uLocal_123 = CREATE_VEHICLE(joaat("baller2"), -46.2722f, -1097.466f, 25.42f, 112.5363f, 1, 1, 0);
				SET_VEHICLE_COLOUR_COMBINATION(uLocal_123, 7);
				SET_VEHICLE_WINDOW_TINT(uLocal_123, 3);
				SET_VEHICLE_DOORS_LOCKED(uLocal_123, 2);
				SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_123, 0);
				uLocal_124 = CREATE_VEHICLE(joaat("tailgater"), -41.07354f, -1099.567f, 25.42f, 138.4292f, 1, 1, 0);
				SET_VEHICLE_COLOUR_COMBINATION(uLocal_124, 12);
				SET_VEHICLE_DOORS_LOCKED(uLocal_124, 2);
				SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_124, 0);
				uLocal_125 = CREATE_VEHICLE(joaat("bjxl"), -36.74456f, -1101.583f, 25.42f, 155.1573f, 1, 1, 0);
				SET_VEHICLE_COLOUR_COMBINATION(uLocal_125, 4);
				SET_VEHICLE_WINDOW_TINT(uLocal_125, 3);
				SET_VEHICLE_DOORS_LOCKED(uLocal_125, 2);
				SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_125, 0);
				iLocal_89 = 2;
			}
			break;
...
int func_75(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_78()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		if (VMAG2(GET_ENTITY_VELOCITY(PLAYER_PED_ID())) > 1369f && !func_89())
		{
			return 0;
		}
	}
...
void func_81(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_90()
{
	if (((((((((((HAS_MODEL_LOADED(Local_47[0 /*20*/]) && HAS_MODEL_LOADED(Local_47[1 /*20*/])) && HAS_WEAPON_ASSET_LOADED(Local_47[0 /*20*/].f_17)) && HAS_WEAPON_ASSET_LOADED(Local_47[1 /*20*/].f_17)) && func_54()) && HAS_ANIM_DICT_LOADED("cellphone@")) && HAS_ANIM_DICT_LOADED("cellphone@str")) && GET_IS_WAYPOINT_RECORDING_LOADED("reyetarian_simeonoffice")) && HAS_MODEL_LOADED(iLocal_122)) && HAS_MODEL_LOADED(joaat("bjxl"))) && HAS_MODEL_LOADED(joaat("tailgater"))) && HAS_MODEL_LOADED(joaat("baller2")))
	{
		return 1;
	}
	return 0;
	...
	switch (Local_47[iParam0 /*20*/].f_18)
	{
		...
		case 1:
			if (!Local_47[iParam0 /*20*/].f_19)
			{
				...
				{
					Local_47[iParam0 /*20*/].f_1 = CREATE_PED(22, Local_47[iParam0 /*20*/], Local_47[iParam0 /*20*/].f_10, Local_47[iParam0 /*20*/].f_13, 1, 1);
					if (func_2(Local_47[iParam0 /*20*/].f_1))
					{
						if (iParam0 == 0)
						{
							...
							SET_PED_COMBAT_ATTRIBUTES(Local_47[iParam0 /*20*/].f_1, 37, 1);
						}
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_47[iParam0 /*20*/].f_1, 1);
						SET_PED_RELATIONSHIP_GROUP_HASH(Local_47[iParam0 /*20*/].f_1, uLocal_148);
						SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(Local_47[iParam0 /*20*/].f_1, 0, uLocal_148);
						SET_PED_COMBAT_ATTRIBUTES(Local_47[iParam0 /*20*/].f_1, 23, 0);
						SET_PED_COMBAT_ATTRIBUTES(Local_47[iParam0 /*20*/].f_1, 1, 0);
						SET_PED_COMBAT_ATTRIBUTES(Local_47[iParam0 /*20*/].f_1, 28, 1);
						SET_PED_CHANCE_OF_FIRING_BLANKS(Local_47[iParam0 /*20*/].f_1, 0.7f, 0.3f);
						iLocal_116[iParam0] = 0;
						if (func_49() == 0)
						{
							GIVE_WEAPON_TO_PED(Local_47[iParam0 /*20*/].f_1, Local_47[iParam0 /*20*/].f_17, -1, 1, 1);
						}
		...
		case 2:
			if (func_2(Local_47[iParam0 /*20*/].f_1))
			{
				if (iLocal_113)
				{
					func_93(Local_47[iParam0 /*20*/].f_1, &(Local_47[iParam0 /*20*/].f_2), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
					CLEAR_PED_TASKS(Local_47[iParam0 /*20*/].f_1);
					SET_PED_USING_ACTION_MODE(Local_47[iParam0 /*20*/].f_1, 1, -1, "DEFAULT_ACTION");
					OPEN_SEQUENCE_TASK(&uLocal_147);
					TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), -1, 12, 2);
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_47[iParam0 /*20*/].f_14, 1f, -1, 3f, 0, 1193033728);
					TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), 0);
					CLOSE_SEQUENCE_TASK(uLocal_147);
					TASK_PERFORM_SEQUENCE(Local_47[iParam0 /*20*/].f_1, uLocal_147);
					CLEAR_SEQUENCE_TASK(&uLocal_147);
					Local_47[iParam0 /*20*/].f_18 = 3;
				}
				if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(Local_47[iParam0 /*20*/].f_1, 0), 1) >= 250f)
				{
		...
		case 3:
			...
			{
				func_93(Local_47[iParam0 /*20*/].f_1, &(Local_47[iParam0 /*20*/].f_2), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
				if (GET_SCRIPT_TASK_STATUS(Local_47[iParam0 /*20*/].f_1, 242628503) == 7 || GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(Local_47[iParam0 /*20*/].f_1, 0), 1) <= 5f)
				{
					TASK_LOOK_AT_ENTITY(Local_47[iParam0 /*20*/].f_1, PLAYER_PED_ID(), -1, 0, 2);
					TASK_COMBAT_PED(Local_47[iParam0 /*20*/].f_1, PLAYER_PED_ID(), 0, 16);
					SET_PED_ALERTNESS(Local_47[iParam0 /*20*/].f_1, 3);
					SET_PED_KEEP_TASK(Local_47[iParam0 /*20*/].f_1, 1);
		...
		case 4:
			...
			else
			{
				if (iLocal_116[iParam0] == 0)
				{
					...
					{
						GIVE_WEAPON_TO_PED(Local_47[iParam0 /*20*/].f_1, Local_47[iParam0 /*20*/].f_17, -1, 0, 1);
						iLocal_116[iParam0] = 1;
					}
				}
				if (GET_SCRIPT_TASK_STATUS(Local_47[iParam0 /*20*/].f_1, 780511057) == 7)
				{
					TASK_COMBAT_PED(Local_47[iParam0 /*20*/].f_1, PLAYER_PED_ID(), 0, 16);
				}
				if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(Local_47[iParam0 /*20*/].f_1, 0), 1) >= 75f)
				{
					Local_47[iParam0 /*20*/].f_18 = 5;
				}
			}
		...
		case 5:
			...
			if (DOES_ENTITY_EXIST(Local_47[iParam0 /*20*/].f_1))
			{
...
int func_93(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
void func_94()
{
	...
	func_95(-1);
	REMOVE_RELATIONSHIP_GROUP(uLocal_148);
	REMOVE_RELATIONSHIP_GROUP(uLocal_149);
	REMOVE_RELATIONSHIP_GROUP(uLocal_150);
	if (iLocal_107 == 0)
	{
	...
	if (DOES_ENTITY_EXIST(uLocal_90))
	{
		SET_PED_AS_NO_LONGER_NEEDED(&uLocal_90);
		if (DOES_BLIP_EXIST(uLocal_93))
		{
			REMOVE_BLIP(&uLocal_93);
		}
	...
	if (DOES_SCENARIO_GROUP_EXIST("DEALERSHIP"))
	{
		if (!IS_SCENARIO_GROUP_ENABLED("DEALERSHIP"))
		{
			SET_SCENARIO_GROUP_ENABLED("DEALERSHIP", 1);
		}
	}
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-51.0518f, -1104.685f, 25.2975f, -29.9812f, -1094.079f, 27.5686f, 1, 1);
	TERMINATE_THIS_THREAD();
}
...
int func_119()
{
	...
	func_115(&uVar0, GET_CLOCK_HOURS());
...
int func_123()
{
	if ((Global_106554 == func_31() && GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
void func_124()
{
	...
	ADD_RELATIONSHIP_GROUP("GoonGroup", &uLocal_148);
	ADD_RELATIONSHIP_GROUP("PlayerGroup", &uLocal_149);
	ADD_RELATIONSHIP_GROUP("YetarianGroup", &uLocal_150);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_150, 1862763509);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, 1862763509, uLocal_150);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_148, 1862763509);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_148);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-51.0518f, -1104.685f, 25.2975f, -29.9812f, -1094.079f, 27.5686f, 0, 1);
	uLocal_142 = ADD_SCENARIO_BLOCKING_AREA(-79.95f, -1126.33f, 20.65f, -3.5f, -1081.6f, 30.67f, 0, 1, 1, 1);
	...
	func_125(194, 0);
	func_125(195, 0);
	REQUEST_MODEL(Local_47[0 /*20*/]);
	REQUEST_MODEL(Local_47[1 /*20*/]);
...
int func_130(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = GET_ENTITY_MODEL(func_131(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 1)));
				switch (iVar0)
				{
...
void func_132(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_133(iParam0) && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_84500[26 /*34*/].f_6) == 0)
			{
				Global_106565.f_7255[iParam0] = 1;
				_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_106565.f_7255[iParam0], 1, 1);
			}
...
int func_139(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!bVar0)
	{
		...
		if (!func_160(Global_106565.f_24989.f_43[iParam3]))
		{
			return 0;
		}
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_158()) || Global_25767) || func_157()) || func_46(8, -1)) || func_154()) || func_156()) || func_155()) || func_153()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_158()) || Global_105612) || Global_25767) || func_157()) || func_46(8, -1)) || func_156()) || func_155()) || func_153()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_158() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_46(8, -1)) || func_153()) || func_152()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_158()) || Global_25767) || func_157()) || func_46(8, -1)) || func_155()) || func_154()) || func_153()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_158()) || Global_105612) || Global_25767) || func_157()) || func_46(8, -1)) || func_154()) || func_152()) || func_156()) || func_155()) || func_153())
						{
							return 0;
						}
						break;
