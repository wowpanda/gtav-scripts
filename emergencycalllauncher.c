...
void func_3()
{
	...
	{
		Local_210 = { func_5() };
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_KEY(&Local_210)) == 0)
		{
			func_4();
		}
		else
...
void func_7()
{
	...
	{
		case 0:
			if ((((((func_29(130) && func_27(PLAYER_ID()) != 192) && func_27(PLAYER_ID()) != 190) && func_27(PLAYER_ID()) != 191) && func_27(PLAYER_ID()) != 225) && func_27(PLAYER_ID()) != 226) && func_27(PLAYER_ID()) != 227)
			{
				if (Global_25996)
				{
					iLocal_217 = 11;
		...
		case 1:
			if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("emergencycall")) == 0)
			{
				if (!func_29(130))
				{
					iLocal_43 = 1;
...
{
	Global_25989 = 1;
	StringCopy(&Global_25990, GET_THIS_SCRIPT_NAME(), 24);
}
