...
void __EntryFunction__()
{
	...
	if (((func_334(10) && SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tennis")) == 0) || Global_90028) && !vScriptParam_737.y)
	{
	...
	while (true)
	{
		...
		if (NETWORK::NETWORK_IS_IN_SESSION() && !vScriptParam_737.y)
		{
			func_302(&Var0);
		}
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Var0.f_189.f_55) < 5625f || vScriptParam_737.y)
			{
		...
		if ((func_334(10) && SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tennis")) == 0) && !vScriptParam_737.y)
		{
			func_302(&Var0);
		}
		SYSTEM::WAIT(0);
...
void func_2(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	switch (func_301(uParam1))
	{
		...
		case 9:
			...
			{
				fVar18 = func_193(func_194(uParam0[func_269(uParam1) /*94*/]), "mini@tennis", "mini@tennis@female");
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(func_263(uParam0[func_269(uParam1) /*94*/]), fVar18, "serve", 3))
				{
					if (uParam0->f_1657 == 1 && ENTITY::DOES_ENTITY_EXIST(uParam0->f_247))
					{
						fVar19 = ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(func_263(uParam0[func_269(uParam1) /*94*/]), fVar18, "serve");
		...
		case 12:
			...
			{
				BRAIN::TASK_STAND_STILL(func_263(uParam0[iParam4 /*94*/]), -1);
			}
			break;
...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	{
		fVar7 = func_193(func_194(uParam0), "mini@tennis", "mini@tennis@female");
		if (iVar6 == 75)
		{
			if (func_103(uParam0, 32))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iVar0, fVar7, "idle", 3))
				{
					BRAIN::STOP_ANIM_TASK(iVar0, fVar7, "idle", -1056964608);
				}
				func_275(uParam0, 32);
			}
		...
		else if (iVar6 == 74)
		{
			...
			fVar3 = 0.855f;
			fVar5 = "serve";
			if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iVar0, fVar7, fVar5, 3))
			{
				BRAIN::TASK_PLAY_ANIM(iVar0, fVar7, fVar5, 8f, -8f, -1, 0, fVar1, 0, 0, 0);
				func_228(uParam0, 7);
			}
			else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iVar0, fVar7, fVar5) > fVar3)
			{
				BRAIN::STOP_ANIM_TASK(iVar0, fVar7, fVar5, -1056964608);
				func_232(uParam0, 75);
			...
			else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iVar0, fVar7, fVar5) >= fVar2)
			{
				if (!func_103(uParam0, 4))
				{
					func_57(uParam0, 4);
			...
			else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iVar0, fVar7, fVar5) > fVar4)
			{
				if (func_103(uParam0, 4))
				{
					func_275(uParam0, 4);
...
int func_39(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_37(iParam1)];
...
void func_52(var uParam0, var uParam1)
{
	...
	if (!func_103(uParam0, 2048) && func_54(uParam0->f_37, uParam1))
	{
		if (BRAIN::GET_SCRIPT_TASK_STATUS(func_263(uParam0), 713668775) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(func_263(uParam0), 242628503) != 1)
		{
			...
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(func_263(uParam0), uParam1->f_29 + vVar0, 2f, 20000, 0.25f, 0, 1193033728);
...
void func_53(void fParam0, int iParam1)
{
	...
	if (iParam3 != iParam4 && ((func_103(uParam0, 512) && uParam0->f_31 != 4) || uParam0->f_31 == 4))
	{
		if (func_151(uParam0, vVar11, bVar6))
		{
			...
			else if (iVar4 == 75 && func_143(uParam0, uParam1[iParam3 /*94*/], &(uParam1->f_247), uParam1->f_189.f_29, &fVar5))
			{
				...
				{
					BRAIN::CLEAR_PED_TASKS(func_263(uParam0));
...
void func_108(var uParam0, void fParam1, void fParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10)
{
	if (!PED::IS_PED_INJURED(func_263(uParam0)))
	{
		func_109(func_263(uParam0), fParam1, &fParam2, iParam10);
	}
}

void func_109(int iParam0, void fParam1, void fParam2, int iParam3)
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, fParam1, fParam2, func_110(iParam3), 0);
}
...
void func_176(var uParam0, var uParam1, bool bParam2)
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam1))
	{
		if (bParam2)
		{
			if (!PED::IS_PED_INJURED(func_263(uParam0)))
			{
				BRAIN::TASK_LOOK_AT_ENTITY(func_263(uParam0), *uParam1, -1, 6, 2);
			}
		}
...
void func_216(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if (!PED::IS_PED_INJURED(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		else
		{
			...
			fVar2 = (MISC::GET_HEADING_FROM_VECTOR_2D(uParam0->f_40, uParam0->f_40.f_1) + func_323(bParam6, 180f, 0f));
			...
			if ((bParam6 && !bVar4) || (!bParam6 && bVar4))
			{
				...
				{
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar7, 1f, 20000, 0.25f, 1, 1193033728);
				}
				func_220(uParam0, func_26(uParam0) + 1);
			}
			...
			{
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar1, 1f, 20000, 0.25f, 0, fVar2);
				func_220(uParam0, func_26(uParam0) + 1);
			}
			fVar8 = func_193(func_194(uParam0), "mini@tennis", "mini@tennis@female");
			BRAIN::TASK_PLAY_ANIM(0, fVar8, "idle_2_ready", 8f, -8f, -1, 0, 0, 0, 0, 0);
			func_220(uParam0, func_26(uParam0) + 1);
			BRAIN::CLOSE_SEQUENCE_TASK(uParam0->f_54);
			BRAIN::TASK_PERFORM_SEQUENCE(func_263(uParam0), uParam0->f_54);
...
void func_225(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	if (!PED::IS_PED_INJURED(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		else
		{
			ENTITY::SET_ENTITY_HEADING(uParam0->f_32, ENTITY::GET_ENTITY_HEADING(uParam0->f_32));
			func_57(uParam0, 16384);
			fVar2 = (MISC::GET_HEADING_FROM_VECTOR_2D(uParam0->f_40, uParam0->f_40.f_1) + func_323(bParam8, 180f, 0f));
			vVar3 = { uParam1->f_189.f_29 - ENTITY::GET_ENTITY_COORDS((uParam1[iParam3 /*94*/])->f_32, true) };
			bVar4 = func_68(vVar3, uParam0->f_40) < 0f;
			bVar5 = func_68(vVar3, uParam0->f_43) < 0f;
			func_220(uParam0, 0);
			...
			if ((bParam8 && !bVar4) || (!bParam8 && bVar4))
			{
				...
				{
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar6, 1f, 20000, 0.25f, 1, 1193033728);
				}
				func_220(uParam0, func_26(uParam0) + 1);
			}
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar1, 1f, 20000, 0.25f, 0, fVar2);
...
void func_234(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	else if (uParam0->f_31 != 3)
	{
		...
		if (!PED::IS_PED_INJURED(func_263(uParam0)) && BRAIN::_0x921CE12C489C4C41(func_263(uParam0)))
		{
			...
			BRAIN::_0xB0A6CFD2C69C1088(func_263(uParam0), &(uParam1->f_1670), 1);
			BRAIN::_0xD5BB4025AE449A4E(func_263(uParam0), "Speed", uParam0->f_62);
		}
	}
	...
	switch (func_145(&(uParam0->f_4)))
	{
		...
		case 5:
			if (func_74(uParam0) == 75)
			{
				...
				{
					BRAIN::TASK_GO_STRAIGHT_TO_COORD(func_263(uParam0), vVar1, 2f, -1, 1193033728, 1056964608);
				...
				else if ((ENTITY::IS_ENTITY_AT_COORD(uParam0->f_32, func_69(&(uParam0->f_4)), vVar2, false, true, 0) || BRAIN::GET_SCRIPT_TASK_STATUS(func_263(uParam0), 2106541073) == 7) && !func_226(&(uParam0->f_4), 256))
				{
					func_233(&(uParam0->f_4), 0);
					func_215(&(uParam0->f_4), 4);
				}
		...
		case 1:
			if (func_74(uParam0) == 75)
			{
				...
				{
					BRAIN::TASK_GO_STRAIGHT_TO_COORD(uParam0->f_32, func_69(&(uParam0->f_4)), 2f, -1, 1193033728, 1056964608);
					vVar1 = { func_69(&(uParam0->f_4)) };
					func_240(&(uParam0->f_4), vVar1);
					func_79(&(uParam0->f_4), 4);
				...
				else if (SYSTEM::VDIST2(uParam0->f_37, vVar1) <= (0f * 0f) || BRAIN::GET_SCRIPT_TASK_STATUS(func_263(uParam0), 2106541073) == 7)
				{
...
void func_260(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (!PED::IS_PED_INJURED(func_263(uParam0[iParam1 /*94*/])) && !PED::IS_PED_INJURED(func_263(uParam0[iParam2 /*94*/])))
	{
		...
		else
		{
			if (!bParam4)
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam1 /*94*/])->f_33, func_263(uParam0[iParam1 /*94*/]), PED::GET_PED_BONE_INDEX(func_263(uParam0[iParam1 /*94*/]), 28422), vLocal_283, vLocal_284, 0, 0, 0, 0, 2, 1);
			}
			ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam2 /*94*/])->f_33, func_263(uParam0[iParam2 /*94*/]), PED::GET_PED_BONE_INDEX(func_263(uParam0[iParam2 /*94*/]), 28422), vLocal_283, vLocal_284, 0, 0, 0, 0, 2, 1);
		}
	}
}
...
int func_299(var uParam0, int iParam1, int iParam2)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			BRAIN::TASK_SEEK_COVER_FROM_PED(func_263(uParam0[(1 - iParam1) /*94*/]), PLAYER::PLAYER_PED_ID(), -1, 0);
		}
		return 1;
	}
	if (PED::IS_PED_INJURED(iVar0))
...
void func_300(void fParam0, int iParam1, int iParam2)
{
	iParam2 = iParam2;
...
{
	return MISC::IS_BIT_SET(Global_1589291[iParam0 /*770*/].f_39.f_18, 14);
}
...
void func_309(var uParam0, vector3 vParam1, vector3 vParam2, vector3 vParam3, vector3 vParam4)
{
...
void func_314(var uParam0, int iParam1, int iParam2, vector3 vParam3, vector3 vParam4)
{
	uParam0->f_36 = 75;
	uParam0->f_1 = iParam1;
...
void func_327(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_329(Global_105220.f_18504[iVar0], &vVar2, &fVar3))
			{
