...
void __EntryFunction__()
{
	...
	if (((func_335(10) && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tennis")) == 0) || Global_90640) && !vScriptParam_0.y)
	{
	...
	while (true)
	{
		...
		if (NETWORK_IS_IN_SESSION() && !vScriptParam_0.y)
		{
			func_303(&Var0);
		}
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), Var0.f_189.f_55) < 5625f || vScriptParam_0.y)
			{
		...
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), Var0.f_189.f_55) > (fVar1712 * fVar1712))
			{
				func_303(&Var0);
			}
		}
		if ((func_335(10) && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tennis")) == 0) && !vScriptParam_0.y)
		{
			func_303(&Var0);
		}
		WAIT(0);
...
void func_2(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	if (func_282(uParam0, iVar18, *iParam2, func_302(uParam1)))
	{
		...
		SET_ENTITY_COORDS(uParam0->f_247, func_281(&(uParam0->f_247)), 1, 0, 0, 0);
	...
	switch (func_302(uParam1))
	{
		case 0:
			...
			{
				CLEAR_PRINTS();
				SET_ENTITY_COORDS((uParam0[iParam3 /*94*/])->f_32, func_268(&(uParam0->f_189), func_270(uParam1), uParam0->f_1661, uParam0->f_1658, iParam3 == func_269(uParam1), iParam3), 1, 1, 0, 1);
		...
		case 4:
			if (func_266(uParam0))
			{
				if (uParam0->f_1657 == 1)
				{
					...
					func_264(uParam0[iParam3 /*94*/], CREATE_PED(1, uParam0->f_1669, vVar23, GET_HEADING_FROM_VECTOR_2D(uParam0->f_1658, uParam0->f_1658.f_1), 0, 0));
					TASK_STAND_STILL((uParam0[iParam3 /*94*/])->f_32, -1);
					SET_ENTITY_HEADING(func_263(uParam0[iParam3 /*94*/]), (GET_HEADING_FROM_VECTOR_2D(uParam0->f_1658, uParam0->f_1658.f_1) + 180f));
					vVar3 = { func_268(&(uParam0->f_189), func_270(uParam1), uParam0->f_1661, uParam0->f_1658, iParam4 == func_269(uParam1), iParam4) };
					func_264(uParam0[iParam4 /*94*/], CREATE_PED(1, uParam0->f_1668, vVar3, GET_HEADING_FROM_VECTOR_2D(-uParam0->f_1658, -uParam0->f_1658.f_1), 0, 0));
					TASK_STAND_STILL((uParam0[iParam4 /*94*/])->f_32, -1);
					SET_ENTITY_HEADING(func_263(uParam0[iParam4 /*94*/]), GET_HEADING_FROM_VECTOR_2D(-uParam0->f_1658, -uParam0->f_1658.f_1));
					vVar3 = { 0f, 0f, 0f };
					func_267(uParam1, 8);
					func_262(uParam1, 0);
					func_261(uParam1, iParam3);
					(uParam0[iParam3 /*94*/])->f_33 = CREATE_OBJECT(joaat("prop_tennis_rack_01b"), uParam0->f_189.f_3[3 /*3*/], 0, 0, 0);
					SET_ENTITY_VISIBLE((uParam0[iParam3 /*94*/])->f_33, 0, 0);
					(uParam0[iParam4 /*94*/])->f_33 = CREATE_OBJECT(joaat("prop_tennis_rack_01b"), uParam0->f_189.f_3[2 /*3*/], 0, 0, 0);
					func_260(uParam0, iParam3, iParam4, 0, 0);
					SET_ENTITY_VISIBLE((uParam0[iParam4 /*94*/])->f_33, 0, 0);
					SET_ENTITY_VISIBLE((uParam0[iParam3 /*94*/])->f_33, 1, 0);
					_0xB2D0BDE54F0E8E5A((uParam0[iParam3 /*94*/])->f_33, 1);
					SET_ENTITY_VISIBLE((uParam0[iParam4 /*94*/])->f_33, 1, 0);
					_0xB2D0BDE54F0E8E5A((uParam0[iParam4 /*94*/])->f_33, 1);
					func_259(func_263(uParam0[iParam3 /*94*/]), 1);
					func_259(func_263(uParam0[iParam4 /*94*/]), 1);
					if (uParam0->f_189 == 0)
					{
						func_257(uParam0);
						SET_PED_COMPONENT_VARIATION(func_263(uParam0[iParam4 /*94*/]), 0, 0, 0, 0);
						SET_PED_COMPONENT_VARIATION(func_263(uParam0[iParam4 /*94*/]), 2, 0, 0, 0);
						SET_PED_COMPONENT_VARIATION(func_263(uParam0[iParam4 /*94*/]), 3, 0, 0, 0);
						SET_PED_COMPONENT_VARIATION(func_263(uParam0[iParam4 /*94*/]), 4, 0, 0, 0);
						SET_PED_COMPONENT_VARIATION(func_263(uParam0[iParam4 /*94*/]), 5, 0, 0, 0);
						SET_PED_COMPONENT_VARIATION(func_263(uParam0[iParam4 /*94*/]), 7, 0, 0, 0);
					}
				}
			}
			break;
		...
		case 8:
			...
			bVar26 = (GET_GAME_TIMER() > func_252(uParam0[iParam3 /*94*/]) && GET_GAME_TIMER() > func_252(uParam0[iParam4 /*94*/]));
		...
		case 9:
			...
			else
			{
				...
				if (IS_ENTITY_PLAYING_ANIM(func_263(uParam0[func_269(uParam1) /*94*/]), sVar31, "serve", 3))
				{
					if (uParam0->f_1657 == 1 && DOES_ENTITY_EXIST(uParam0->f_247))
					{
						fVar32 = GET_ENTITY_ANIM_CURRENT_TIME(func_263(uParam0[func_269(uParam1) /*94*/]), sVar31, "serve");
		...
		case 10:
			...
			if (GET_FRAME_COUNT() > func_104(&(uParam0->f_247)) && func_103(uParam0[(1 - func_269(uParam1)) /*94*/], 256))
			{
			...
			vVar14 = { func_281(&(uParam0->f_247)) };
			if (vVar14.z < (uParam0->f_189.f_3[0 /*3*/].f_2 - 1f) && VDIST2(uParam0->f_189.f_29, func_281(&(uParam0->f_247))) < (26.75f * 26.75f))
			{
				func_102(uParam1, (1 - func_269(uParam1)));
				func_267(uParam1, 14);
			}
		...
		case 12:
			...
			else if (vVar14.z < (uParam0->f_189.f_3[0 /*3*/].f_2 - 1f) && VDIST2(uParam0->f_189.f_29, func_281(&(uParam0->f_247))) < (26.75f * 26.75f))
			{
				func_102(uParam1, (1 - func_175(uParam1)));
				func_267(uParam1, 14);
				if (func_62(uParam1) != iParam3 && uParam0->f_1657 != 1)
			...
			else if (GET_FRAME_COUNT() > func_104(&(uParam0->f_247)) && func_103(uParam0[(1 - func_175(uParam1)) /*94*/], 256))
			{
				func_102(uParam1, func_175(uParam1));
				func_267(uParam1, 14);
				func_101(iParam2);
			...
			{
				TASK_STAND_STILL(func_263(uParam0[iParam4 /*94*/]), -1);
			}
			break;
		...
		case 20:
			...
			else if (((GET_GAME_TIMER() > func_21(uParam0) && func_227(uParam0, 4)) && DOES_ENTITY_EXIST(uParam0->f_247)) && !IS_ENTITY_ATTACHED(uParam0->f_247))
			{
				func_265(uParam0, 1);
				func_192(uParam0[func_269(uParam1) /*94*/], &(uParam0->f_247));
				func_285(&(uParam0->f_247), 4);
			}
			if (func_269(uParam1) != iParam3 && GET_SCRIPT_TASK_STATUS(func_263(uParam0[iParam3 /*94*/]), 242628503) == 7)
			{
				func_230(uParam0->f_1657, 1);
				func_234(uParam0[iParam3 /*94*/], uParam0, func_270(uParam1), iParam3, 0, 0);
	...
	if (!IS_PED_INJURED(iVar0))
	{
		...
		if (iVar6 == 75)
		{
			if (func_103(uParam0, 32))
			{
				...
				{
					STOP_ANIM_TASK(iVar0, sVar7, "idle", -1056964608);
				}
				func_275(uParam0, 32);
			}
			if (!func_103(uParam0, 128) && !func_226(&(uParam0->f_4), 4))
			{
				if (!IS_TENNIS_MODE(func_263(uParam0)))
				{
		...
		else if (iVar6 == 74)
		{
			...
			{
				STOP_ANIM_TASK(iVar0, sVar7, sVar5, -1056964608);
				func_232(uParam0, 75);
...
void func_5(var uParam0, int iParam1, var uParam2, int iParam3, var uParam4)
{
	...
	fVar11 = (TO_FLOAT(iParam3) / TO_FLOAT(uVar10));
	fVar12 = *uParam2;
	...
	if (!func_103(uParam0, 1024))
	{
		...
		if (func_74(uParam0) == 72 || func_74(uParam0) == 73)
		{
			if (func_10(uParam0) != 0)
			{
				...
				_0x8FA9C42FC5D7C64B(iParam1, iVar15, func_9(uParam0), func_8(uParam0), 1065353216, 0);
				func_7(uParam0, GET_GAME_TIMER() + 2871);
			}
		}
		else
		{
			_0xE266ED23311F24D4(iParam1, sVar1, &Var2, fVar12, func_6(uParam0), 0);
		}
...
var func_14(var uParam0)
{
	...
	fVar0 = (TO_FLOAT(uParam0) * 0.03333334f);
...
void func_20(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	{
		if (DOES_ENTITY_EXIST(func_263(uParam1)))
		{
			if (IS_TENNIS_MODE(func_263(uParam1)))
			{
				SET_PED_RESET_FLAG(func_263(uParam1), 69, 1);
			}
			SET_PED_RESET_FLAG(func_263(uParam1), 102, 1);
		}
	}
}
...
int func_25(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6)
{
	...
	else if ((!IS_PED_INJURED(iVar1) && (bParam5 || iParam4 == 1)) && !func_103(uParam0[iParam1 /*94*/], 8192))
	{
		if (iParam1 == iParam3)
		{
		...
		func_259(iVar1, 1);
		_0x2208438012482A1A(iVar1, 0, 0);
		func_57(uParam0[iParam1 /*94*/], 8192);
	}
	else if (func_103(uParam0[iParam1 /*94*/], 8192) && iParam1 == iParam3)
	{
		if (!IS_PED_INJURED(iVar1) && _0x921CE12C489C4C41(iVar1))
		{
			if (ARE_STRINGS_EQUAL(_0x717E4D1F2048376D(iVar1), "Intro") && _0x30ED88D5E0C56A37(iVar1))
			{
				_0xD01015C7316AE176(iVar1, "running");
			}
		}
	}
	...
	else if (((!IS_PED_INJURED(iVar2) && ((bParam5 || iParam4 == 4) || iParam4 == 1)) && !func_103(uParam0[iParam2 /*94*/], 8192)) && GET_SCRIPT_TASK_STATUS(iVar2, 242628503) == 7)
	{
		if (iParam2 == iParam3)
		{
		...
		func_259(iVar2, 1);
		_0x2208438012482A1A(iVar2, 0, 0);
		func_57(uParam0[iParam2 /*94*/], 8192);
	}
	else if (func_103(uParam0[iParam2 /*94*/], 8192) && iParam2 == iParam3)
	{
		if (!IS_PED_INJURED(iVar2) && _0x921CE12C489C4C41(iVar2))
		{
			if (ARE_STRINGS_EQUAL(_0x717E4D1F2048376D(iVar2), "Intro") && _0x30ED88D5E0C56A37(iVar2))
			{
				_0xD01015C7316AE176(iVar2, "running");
			}
		}
	}
	return iVar0;
...
{
	if (!((!IS_PED_INJURED(func_263(uParam0)) && _0x921CE12C489C4C41(func_263(uParam0))) && ARE_STRINGS_EQUAL(_0x717E4D1F2048376D(func_263(uParam0)), "running")))
	{
		_TASK_MOVE_NETWORK(func_263(uParam0), sParam1, fParam2, 0, "mini@tennis", 4);
	}
}
...
void func_52(var uParam0, var uParam1)
{
	...
	{
		if (GET_SCRIPT_TASK_STATUS(func_263(uParam0), 713668775) != 1 && GET_SCRIPT_TASK_STATUS(func_263(uParam0), 242628503) != 1)
		{
			vVar0 = { uParam0->f_37 - uParam1->f_29 * Vector(0.93f, 0.93f, 0.93f) };
			TASK_FOLLOW_NAV_MESH_TO_COORD(func_263(uParam0), uParam1->f_29 + vVar0, 2f, 20000, 1048576000, 0, 1193033728);
			func_57(uParam0, 2048);
			func_53("FAR_FROM_COURT", -1);
		}
	}
	else if (func_103(uParam0, 2048) && GET_SCRIPT_TASK_STATUS(func_263(uParam0), 713668775) != 1)
	{
...
void func_56(var uParam0, var uParam1, vector3 vParam2)
{
	...
	{
		iVar0 = func_49(GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.5f, 0, 3);
...
bool func_75(vector3 vParam0, vector3 vParam3, vector3 vParam6, float fParam9)
{
	...
	return IS_POINT_IN_ANGLED_AREA(vParam0, vParam3, vParam6, fParam9, 0, 1);
}
...
Vector3 func_81(var uParam0, var uParam1, vector3 vParam2, var uParam5, float fParam6)
{
	...
	while (iVar0 < 75)
	{
		...
		if (bVar16 == bVar17)
		{
			...
			fVar11 = ABSF(((vVar1.z + vVar12.z) - vParam2.z));
			if (fVar11 < 0.15f)
			{
				fVar11 = 0f;
			}
...
float func_82(var uParam0, vector3 vParam1, float fParam4, float fParam5)
{
	...
	*fParam5 = VMAG(vVar0);
	...
	vVar3 = { GET_ENTITY_VELOCITY(uParam0->f_32) };
	fVar6 = ((VDIST(vVar0, vVar3) * 2f) / 5f);
...
Vector3 func_86(vector3 vParam0, var uParam3, vector3 vParam4, vector3 vParam7, var uParam10, var uParam11, var uParam12, var uParam13, int iParam14, var uParam15, float fParam16)
{
	...
	while (iVar4 < 180 && iVar3 < 2)
	{
		...
		if (VDIST(vParam0, vVar0) < VDIST(vParam0, vParam4))
		{
			*fParam16 = (IntToFloat(iVar4) * GET_FRAME_TIME());
			return vParam4;
		}
...
int func_95(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	vVar0 = { func_281(&(uParam1->f_247)) };
	if (ABSF((vVar0.z - uParam0->f_3[0 /*3*/].f_2)) <= 0.6f)
	{
...
int func_96(var uParam0, int iParam1, var uParam2)
{
	...
	if (HAS_ENTITY_COLLIDED_WITH_ANYTHING(*uParam0) || func_286(uParam0, 16))
	{
		...
		if (VDIST2(*uParam2, func_281(uParam0)) > (26.75f * 26.75f))
		{
			return 1;
		}
	}
...
int func_105(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	if (uParam0->f_31 != 4 && GET_GAME_TIMER() > func_162(uParam0))
	{
	...
	else if (GET_GAME_TIMER() > func_162(uParam0))
	{
		if (VDIST2(func_281(&(uParam1->f_247)), uParam0->f_37) > (0f * 0f))
		{
	...
	{
		if (func_103(uParam0, 4096) && GET_GAME_TIMER() > func_162(uParam0))
		{
		...
		if (func_151(uParam0, vVar11, bVar6))
		{
			...
			if ((iVar4 != 75 && iVar4 != 76) && (uParam0->f_31 == 4 || (uParam0->f_31 != 4 && func_103(uParam0, 512))))
			{
				if (!func_226(&(uParam0->f_4), 8) && !func_226(&(uParam0->f_4), 1))
				{
					...
					func_146(uParam0, GET_FRAME_COUNT() + 2);
					if (uParam0->f_31 == 4)
					{
			...
			else if (iVar4 == 75 && func_143(uParam0, uParam1[iParam3 /*94*/], &(uParam1->f_247), uParam1->f_189.f_29, &fVar5))
			{
				...
				func_137(uParam0, GET_GAME_TIMER() + 1000);
				if (iVar4 == 75 || fVar5 <= 0f)
				{
					CLEAR_PED_TASKS(func_263(uParam0));
				...
				if (fVar5 < 5f)
				{
					...
					fVar36 = TO_FLOAT(func_14(uParam1->f_535[iVar4 /*12*/].f_3));
					iVar37 = (FLOOR((uParam1->f_535[iVar4 /*12*/].f_1 * fVar36)) - iVar34);
...
void func_106(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	{
		DETACH_ENTITY(uParam1->f_247, 1, 1);
	}
...
void func_107(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_44(func_263(uParam0)) == 17 && GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.5f)
	{
	...
	if (bParam2 || bParam3)
	{
		...
		{
			PLAY_SOUND_FROM_ENTITY(-1, func_193(uParam0->f_31 != 4, "TENNIS_PLYR_SMASH_MASTER", "TENNIS_NPC_SMASH_MASTER"), func_263(uParam0), 0, 0, 0);
		}
		else if (func_90(uParam1) == 2)
		{
			PLAY_SOUND_FROM_ENTITY(-1, func_193(uParam0->f_31 != 4, "TENNIS_PLYR_SMASH_BACKSLICE_MASTER", "TENNIS_NPC_SMASH_BACKSLICE_MASTER"), func_263(uParam0), 0, 0, 0);
		}
	...
	{
		PLAY_SOUND_FROM_ENTITY(-1, func_193(uParam0->f_31 != 4, "TENNIS_PLYR_LOB_MASTER", "TENNIS_NPC_LOB_MASTER"), func_263(uParam0), 0, 0, 0);
		iVar0 = 60;
	}
	else
	{
		if (func_90(uParam1) == 0)
		{
			PLAY_SOUND_FROM_ENTITY(-1, func_193(uParam0->f_31 != 4, "TENNIS_PLYR_FOREARM_MASTER", "TENNIS_NPC_FOREARM_MASTER"), func_263(uParam0), 0, 0, 0);
		}
		else if (func_90(uParam1) == 2)
		{
			PLAY_SOUND_FROM_ENTITY(-1, func_193(uParam0->f_31 != 4, "TENNIS_PLYR_BACKSLICE_MASTER", "TENNIS_NPC_BACKSLICE_MASTER"), func_263(uParam0), 0, 0, 0);
		}
		else if (func_90(uParam1) == 1)
		{
			PLAY_SOUND_FROM_ENTITY(-1, func_193(uParam0->f_31 != 4, "TENNIS_PLYR_TOPSPIN_MASTER", "TENNIS_NPC_TOPSPIN_MASTER"), func_263(uParam0), 0, 0, 0);
		}
		iVar0 = 80;
	}
	if (uParam0->f_31 != 4)
...
{
	if (!IS_PED_INJURED(func_263(uParam0)))
	{
...
{
	_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, uParam1, uParam2, func_110(iParam3), 0);
}
...
void func_112(var uParam0, vector3 vParam1)
{
	...
	if (DOES_ENTITY_EXIST(uParam0->f_247))
	{
		...
		func_117(&(uParam0->f_247), GET_FRAME_COUNT() + 5);
...
void func_113(var uParam0, bool bParam1)
{
	...
	{
		if ((IS_ENTITY_VISIBLE(uParam0) && !bParam1) || (!IS_ENTITY_VISIBLE(uParam0) && bParam1))
		{
			SET_ENTITY_VISIBLE(uParam0, bParam1, 0);
			_0xB2D0BDE54F0E8E5A(uParam0, bParam1);
		}
	}
}
...
void func_114(var uParam0, bool bParam1)
{
	...
	if (DOES_ENTITY_EXIST(*uParam0))
	{
		vVar0 = { func_115(bParam1, func_281(uParam0), GET_ENTITY_COORDS(*uParam0, 1)) };
	}
	uParam0->f_27 = { vVar0 };
	uParam0->f_30 = { vVar0 };
	uParam0->f_25 = 0f;
...
Vector3 func_119(var uParam0, var uParam1, int iParam2, int iParam3, vector3 vParam4, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	fVar9 = fVar8;
	vVar10 = { vParam4 };
	vVar13 = { _0x21C235BC64831E5A(vVar10, uParam1->f_189.f_32[0 /*3*/], uParam1->f_189.f_32[1 /*3*/], 0) };
	fVar16 = VDIST(vVar10, vVar13);
	fVar17 = (VMAG(uParam1->f_189.f_3[3 /*3*/] - uParam1->f_189.f_3[0 /*3*/]) / 2f);
...
Vector3 func_120(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4)
{
	...
	{
		vVar6 = { FtoV(GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f)) * uParam0->f_43 };
	...
	{
		fVar9 = GET_RANDOM_FLOAT_IN_RANGE(-0.15f, 1.15f);
	...
	{
		bVar28 = false;
		fVar29 = VDIST2(uParam1->f_189.f_3[0 /*3*/], *uParam3);
		fVar30 = VDIST2(uParam1->f_189.f_3[1 /*3*/], *uParam3);
		fVar31 = ABSF((fVar29 - fVar30));
		fVar32 = func_123(0.75f, 0.05f, (fVar31 / 90f));
		fVar33 = GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216);
		...
		if (fVar29 > fVar30 && !bVar28)
		{
			if (uParam0->f_1 == 0)
			{
				fVar29 = VDIST2(uParam1->f_189.f_3[0 /*3*/], uParam0->f_37);
				fVar30 = VDIST2(uParam1->f_189.f_3[1 /*3*/], uParam0->f_37);
			...
			{
				fVar29 = VDIST2(uParam1->f_189.f_3[3 /*3*/], uParam0->f_37);
				fVar30 = VDIST2(uParam1->f_189.f_3[2 /*3*/], uParam0->f_37);
				if (func_64(iVar2, uParam1, 0, 0))
				{
		...
		else if (!bVar28)
		{
			if (uParam0->f_1 == 0)
			{
				fVar29 = VDIST2(uParam1->f_189.f_3[1 /*3*/], uParam0->f_37);
				fVar30 = VDIST2(uParam1->f_189.f_3[0 /*3*/], uParam0->f_37);
				if (func_64(iVar2, uParam1, 0, 0))
				{
			...
			{
				fVar29 = VDIST2(uParam1->f_189.f_3[2 /*3*/], uParam0->f_37);
				fVar30 = VDIST2(uParam1->f_189.f_3[3 /*3*/], uParam0->f_37);
				if (func_64(iVar2, uParam1, 0, 0))
				{
...
Vector3 func_122(var uParam0, var uParam1, vector3 vParam2, int iParam5)
{
	...
	{
		fVar14 = func_123(0.4f, 1f, GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216));
	...
	vVar15 = { _0x21C235BC64831E5A(uParam0->f_37, uParam1->f_3[iVar9 /*3*/], uParam1->f_3[iVar10 /*3*/], 1) };
	if (ABSI(iParam5) > 15)
	{
		if (iParam5 > 0)
		{
			fVar18 = (TO_FLOAT(iParam5) / TO_FLOAT(128));
...
int func_125(int iParam0)
{
	switch (iParam0)
	{
		...
		case 1:
			if (GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.3f)
			{
				if (GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.5f)
				{
					return 1;
				}
				else
		...
		case 2:
			if (GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.2f)
			{
				if (GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.6f)
				{
					return 1;
				}
				else
...
int func_132(var uParam0, var uParam1, vector3 vParam2, bool bParam5)
{
	...
	if (!IS_PED_INJURED(func_263(uParam0)) && _0xE95B0C7D5BA3B96B(func_263(uParam0)))
	{
		return 0;
	}
	if (func_135(uParam0) > GET_FRAME_COUNT())
	{
		return 0;
	}
	if (!func_103(uParam0, 1024))
	...
	fVar4 = VDIST2(vVar0, func_134(uParam0));
	...
	vVar14 = { GET_PED_BONE_COORDS(func_263(uParam0), 60309, 0f, 0f, 0f) };
	vVar17 = { vVar0 - vVar14 };
	fVar20 = func_68(uParam0->f_43, vVar17);
	fVar21 = (ABSF(fVar11) - ABSF(fVar20));
	fVar21 = (fVar21 * 0.3f);
	if (!func_133(uParam0->f_33, &vVar14, &(uParam0->f_40), &vVar0, &(uParam1->f_10)))
	{
		return 0;
	}
	if (ABSF(fVar11) > (0.65f + fVar21))
	{
		return 0;
	}
	if (fVar12 < -0.9f)
	...
	SET_ENTITY_COORDS(*uParam1, vVar0, 1, 0, 0, 1);
	return 1;
}
...
int func_133(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	if (DOES_ENTITY_EXIST(uParam0))
	{
		GET_ENTITY_MATRIX(uParam0, &uVar6, &uVar3, &vVar9, &vVar0);
		vVar0 = { vVar0 + vVar9 * Vector(0.4f, 0.4f, 0.4f) };
		fVar12 = GET_FRAME_TIME();
...
Vector3 func_134(var uParam0)
{
	...
	if (DOES_ENTITY_EXIST(uParam0->f_33))
	{
		...
		GET_ENTITY_MATRIX(uParam0->f_33, &uVar6, &uVar3, &vVar9, &vVar0);
		vVar0 = { vVar0 + vVar9 * Vector(0.4f, 0.4f, 0.4f) };
	}
	return vVar0;
}
...
void func_136(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, vector3 vParam6, bool bParam9)
{
	...
	if (!func_103(uParam1, 1024))
	{
		...
		_0xE266ED23311F24D4(iVar1, sVar2, sVar3, 0f, 1f, 1);
		func_57(uParam1, 1024);
		func_79(&(uParam1->f_4), 16);
		func_7(uParam1, GET_GAME_TIMER() + 2442);
		if ((1 && !func_226(&((uParam0[iParam3 /*94*/])->f_4), 256)) && GET_GAME_TIMER() > func_252(uParam0[iParam3 /*94*/]))
		{
			iParam5 = (1 - iParam5);
			if (bParam9)
			{
...
int func_138(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	if (iVar0 == 72)
	{
		iVar19 = func_142(uParam0, &vVar20, &vVar23, &vLocal_327, &vLocal_333, &vLocal_336, 0, &fVar29, &fVar30, &uVar26);
		if (iVar19 == 0)
		{
	...
	{
		iVar19 = func_142(uParam0, &vVar20, &vVar23, &vLocal_315, &vLocal_321, &vLocal_324, 1, &fVar29, &fVar30, &uVar26);
		if (iVar19 == 0)
		{
			func_141(uParam0, 0.5f);
			func_140(uParam0, 1f);
...
int func_142(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6, float fParam7, float fParam8, var uParam9)
{
	...
	*fParam7 = _0x7F8F6405F4777AF6(vVar9, *uParam5, *uParam3, 0);
	*fParam8 = _0x7F8F6405F4777AF6(vVar9, func_115(bParam6, *uParam5, *uParam4), func_115(bParam6, *uParam4, *uParam5), 0);
...
int func_143(var uParam0, var uParam1, var uParam2, vector3 vParam3, var uParam6)
{
	...
	if (uParam0->f_31 != 4)
	{
		...
		if (VDIST2(uParam0->f_37, func_281(uParam2)) > (20f * 20f))
		{
			return 0;
		}
...
void func_144(var uParam0, var uParam1, var uParam2)
{
	...
	else
	{
		...
		fVar0 = VDIST(vVar8, uParam2->f_37);
		fVar1 = VDIST(vVar11, uParam2->f_37);
		fVar2 = ABSF((fVar0 - fVar1));
		fVar3 = func_123(0.15f, 0.5f, (fVar2 / 570f));
		fVar4 = GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216);
		if (fVar4 < fVar3)
		{
			func_228(uParam0, 2);
		}
...
int func_149(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	fVar1 = 0.75f;
	fVar2 = 100f;
	_0xF56DFB7B61BE7276(*(uParam4[0 /*3*/]), *(uParam4[1 /*3*/]), uParam0->f_37, uParam0->f_40, &fVar10);
				...
				if ((uParam3[iVar32 /*12*/])->f_1 >= 0f)
				{
					...
					if (iVar3 < (*uParam4 - 2) && iVar3 >= 0)
					{
						if (iVar24 == 0 && (iVar32 == 72 || iVar32 == 73))
						{
							...
							if (iVar32 == 72)
							{
								iVar37 = func_142(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &vLocal_327, &vLocal_333, &vLocal_336, 0, &fVar38, &fVar39, &vVar28);
							}
							else
							{
								iVar37 = func_142(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &vLocal_315, &vLocal_321, &vLocal_324, 1, &fVar38, &fVar39, &vVar28);
							}
							if (iVar37 != 0)
							{
						...
						else if (iVar32 != 72 && iVar32 != 73)
						{
							...
							{
								iVar55++;
								vVar44 = { _0x21C235BC64831E5A(vVar41, *(uParam4[(iVar3 - iVar55) /*3*/]), *(uParam4[((iVar3 - iVar55) - 1) /*3*/]), 1) };
								vVar50 = { vVar41 - vVar44 };
								fVar53 = func_68(vVar50, uParam0->f_40);
							}
							if (ABSF(fVar53) > 0.3f)
							{
								fVar53 = (fVar53 * (0.3f / ABSF(fVar53)));
							}
...
void func_159(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	*uParam3 = 0;
	...
	{
		case 2:
			if (DOES_ENTITY_EXIST(uParam1->f_247) && func_284(&(uParam1->f_247)) > 0)
			{
				fVar0 = GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216);
	...
	while (uParam1->f_247.f_33 <= 0f)
	{
		...
		*uParam2 = { uParam1->f_1583[iVar0 /*3*/] };
		...
		if (iVar1 == 1)
		{
			...
			{
				func_163(uParam0);
				func_171(uParam0, (TO_FLOAT(iVar0) * GET_FRAME_TIME()));
			}
		}
		if (!func_170(*uParam2))
		{
...
void func_176(var uParam0, var uParam1, bool bParam2)
{
	if (DOES_ENTITY_EXIST(*uParam1))
	{
		if (bParam2)
		{
			if (!IS_PED_INJURED(func_263(uParam0)))
			{
				TASK_LOOK_AT_ENTITY(func_263(uParam0), *uParam1, -1, 6, 2);
			}
		}
		else if (!IS_PED_INJURED(func_263(uParam0)))
		{
			TASK_CLEAR_LOOK_AT(func_263(uParam0));
		}
	}
}
...
int func_180(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	...
	if (!bParam3)
	{
		if (((func_251(uParam0) > func_189(uParam1) && func_74(uParam2) == 75) && uParam0->f_1657 != 1) || (((func_251(uParam0) > func_189(uParam1) && func_74(uParam2) == 75) && uParam0->f_1657 == 1) && IS_SCREEN_FADED_IN()))
		{
			func_232(uParam2, 74);
			func_213(uParam0, 0);
		}
	...
	if (func_103(uParam2, 4))
	{
		...
		{
			uVar12 = GET_RANDOM_INT_IN_RANGE(2, 6);
			iVar0 = func_49(GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.2f, 6, uVar12);
		}
		else if (uParam2->f_4.f_20 == 1)
		{
			uVar12 = GET_RANDOM_INT_IN_RANGE(1, 4);
			iVar0 = func_49(GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.1f, 6, uVar12);
		}
		else if (uParam2->f_4.f_20 == 2)
		{
			iVar0 = GET_RANDOM_INT_IN_RANGE(0, 2);
		}
		vVar6 = { func_121(vVar9, vVar6, GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216)) };
		...
		*uParam2 = fVar5;
		...
		if (iVar0 == 1 || iVar0 == 0)
		{
			PLAY_SOUND_FROM_ENTITY(-1, func_193(uParam0->f_1657 == 1, "TENNIS_AMB_SMASH_MASTER", "TENNIS_NPC_SMASH_MASTER"), func_263(uParam2), 0, 0, 0);
		}
		else
		{
			PLAY_SOUND_FROM_ENTITY(-1, func_193(uParam0->f_1657 == 1, "TENNIS_AMB_SERVE_MASTER", "TENNIS_NPC_SERVE_MASTER"), func_263(uParam2), 0, 0, 0);
		}
		DETACH_ENTITY(uParam0->f_247, 0, 1);
...
void func_181(var uParam0, var uParam1, var uParam2)
{
	...
	uVar0 = *uParam1;
	vVar1 = { func_182(TO_FLOAT(*uParam2), TO_FLOAT(uParam2->f_1), uVar0, &(uParam1->f_40), &(uParam1->f_43)) };
	if (DOES_ENTITY_EXIST(uParam0->f_247))
	{
		if (uParam0->f_1657 != 1 && !func_273(&(uParam0->f_247)))
		{
		...
		func_274(&(uParam0->f_247), GET_ENTITY_COORDS(uParam0->f_247, 1));
		uParam0->f_247.f_16 = { func_281(&(uParam0->f_247)) };
		func_117(&(uParam0->f_247), GET_FRAME_COUNT() + 5);
		func_116(&(uParam0->f_247));
		func_114(&(uParam0->f_247), 1);
...
void func_192(var uParam0, var uParam1)
{
	...
	{
		ATTACH_ENTITY_TO_ENTITY(*uParam1, iVar0, GET_PED_BONE_INDEX(iVar0, 60309), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
		func_113(*uParam1, 1);
	}
}
...
int func_197(var uParam0, var uParam1, int iParam2, var uParam3, bool bParam4)
{
	...
	{
		func_156(uParam0);
		if ((IS_CONTROL_JUST_PRESSED(0, 223) && !bParam4) || (func_158(uParam0) > 30f && uParam1->f_1657 == 4))
		{
		...
		if (func_103(uParam0, 4))
		{
			if (func_103(uParam0, 64))
			{
				if (func_203(uParam0) > 0.965f)
				{
					*uParam3 = { uParam1->f_282[0 /*2*/] };
					PLAY_SOUND_FROM_ENTITY(-1, "TENNIS_PLYR_SMASH_MASTER", func_263(uParam0), 0, 0, 0);
				...
				else if (func_203(uParam0) > 0.7f)
				{
					*uParam3 = { uParam1->f_282[2 /*2*/] };
					...
					PLAY_SOUND_FROM_ENTITY(-1, "TENNIS_PLYR_SERVE_MASTER", func_263(uParam0), 0, 0, 0);
				}
			...
			DETACH_ENTITY(uParam1->f_247, 0, 1);
		...
		if (func_158(uParam0) > 30f || (IS_CONTROL_JUST_PRESSED(0, 223) && !bParam4))
		{
			func_157(uParam0);
		}
	}
...
void func_199(var uParam0)
{
	if (func_210(uParam0))
	{
		if (!func_209(uParam0))
		{
			uParam0->f_2 = (func_200(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
			SET_BIT(uParam0, 2);
		}
	}
}
...
int func_201(var uParam0, var uParam1, int iParam2, var uParam3)
{
	...
	fVar19 = ((TO_FLOAT(uParam3) + 128f) / 256f);
	if (uParam0->f_1 == 0)
	{
		if (iParam2 == 1)
		{
	...
	fVar0 = GET_ANGLE_BETWEEN_2D_VECTORS(uParam0->f_40, uParam0->f_40.f_1, vVar4.x, vVar4.y);
	fVar0 = (fVar0 * fVar20);
	*uParam0 = fVar0;
	if (iParam2 == 0)
	{
...
void func_204(var uParam0)
{
	if (func_210(uParam0))
	{
		if (func_209(uParam0))
		{
			uParam0->f_1 = (func_200(IS_BIT_SET(*uParam0, 4)) - uParam0->f_2);
			uParam0->f_2 = 0f;
			CLEAR_BIT(uParam0, 2);
		}
	}
...
{
	uParam0->f_1 = (func_200(IS_BIT_SET(*uParam0, 4)) - fParam1);
	SET_BIT(uParam0, 1);
	CLEAR_BIT(uParam0, 2);
	uParam0->f_2 = 0f;
}
...
{
	if (!IS_PED_INJURED(func_263(uParam0[iParam1 /*94*/])) && GET_SCRIPT_TASK_STATUS(func_263(uParam0[iParam1 /*94*/]), 242628503) != 7)
	{
		return 0;
	}
	else if ((!IS_PED_INJURED(func_263(uParam0[iParam1 /*94*/])) && ((bParam4 || iParam3 == 4) || iParam3 == 1)) && !func_103(uParam0[iParam1 /*94*/], 8192))
	{
		if (iParam1 == iParam2)
		{
			func_27(uParam0[iParam1 /*94*/], "TennisServeSet", 0f);
		...
		_0x2208438012482A1A(func_263(uParam0[iParam1 /*94*/]), 0, 0);
		func_57(uParam0[iParam1 /*94*/], 8192);
	}
	else if (func_103(uParam0[iParam1 /*94*/], 8192) && iParam1 == iParam2)
	{
		if (!IS_PED_INJURED(func_263(uParam0[iParam1 /*94*/])) && _0x921CE12C489C4C41(func_263(uParam0[iParam1 /*94*/])))
		{
			if (ARE_STRINGS_EQUAL(_0x717E4D1F2048376D(func_263(uParam0[iParam1 /*94*/])), "Intro") && _0x30ED88D5E0C56A37(func_263(uParam0[iParam1 /*94*/])))
			{
				_0xD01015C7316AE176(func_263(uParam0[iParam1 /*94*/]), "running");
			}
		}
	}
	return 1;
...
void func_216(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	if ((uParam0->f_31 != 4 && !IS_PED_INJURED(func_263(uParam0))) && !bParam5)
	{
	...
	if (!IS_PED_INJURED(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		if ((uParam1->f_1657 != 1 && !bParam5) && !func_222(PLAYER_ID(), 0))
		{
			func_221(uParam1, iParam3, 1);
			SET_ENTITY_COORDS(uParam0->f_32, vVar1, 1, 0, 0, 1);
		...
		else
		{
			...
			fVar4 = (GET_HEADING_FROM_VECTOR_2D(uParam0->f_40, uParam0->f_40.f_1) + func_324(bParam6, 180f, 0f));
			...
			if (!bParam6 && bParam7)
			{
				...
				TASK_PLAY_ANIM(0, func_193(func_194(uParam0), "mini@tennis", "mini@tennis@female"), "idle", 1.5f, -8f, iVar10, 0, 0, 0, 0, 0);
			}
			if (!bParam8)
			{
				TASK_PLAY_ANIM(0, "mini@tennis", "ready_2_idle", 1.5f, -1056964608, -1, 0, 0, 0, 0, 0);
				func_220(uParam0, func_26(uParam0) + 1);
			}
			if ((bParam6 && !bVar8) || (!bParam6 && bVar8))
			{
				...
				{
					TASK_GO_STRAIGHT_TO_COORD(0, vVar11, 1f, 20000, 1193033728, 1056964608);
				}
				else
				{
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar11, 1f, 20000, 1048576000, 1, 1193033728);
				}
				func_220(uParam0, func_26(uParam0) + 1);
			}
			if (func_217(GET_ENTITY_COORDS(uParam0->f_32, 1), vVar1, 0.1f))
			{
				TASK_ACHIEVE_HEADING(0, fVar4, 2500);
				func_220(uParam0, func_26(uParam0) + 1);
			}
			else
			{
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar1, 1f, 20000, 1048576000, 0, fVar4);
				func_220(uParam0, func_26(uParam0) + 1);
			}
			sVar14 = func_193(func_194(uParam0), "mini@tennis", "mini@tennis@female");
			TASK_PLAY_ANIM(0, sVar14, "idle_2_ready", 1090519040, -8f, -1, 0, 0, 0, 0, 0);
			func_220(uParam0, func_26(uParam0) + 1);
			CLOSE_SEQUENCE_TASK(uParam0->f_54);
			TASK_PERFORM_SEQUENCE(func_263(uParam0), uParam0->f_54);
			SET_PED_WEAPON_MOVEMENT_CLIPSET(func_263(uParam0), "weapons@tennis@male");
			func_79(&(uParam0->f_4), 4);
		}
	}
	if (bParam4 && DOES_ENTITY_EXIST(func_263(uParam0)))
	{
		_0x2208438012482A1A(func_263(uParam0), 0, 0);
	}
}
...
void func_225(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	if ((uParam0->f_31 != 4 && !IS_PED_INJURED(func_263(uParam0))) && !bParam7)
	{
		func_230(uParam1->f_1657, 1);
	}
	func_232(uParam0, 75);
	...
	if (!IS_PED_INJURED(uParam0->f_32) && uParam0->f_36 == 75)
	{
		...
		if ((uParam1->f_1657 != 1 && !bParam7) && !func_222(PLAYER_ID(), 0))
		{
			if (!((!IS_PED_INJURED(func_263(uParam0)) && _0x921CE12C489C4C41(func_263(uParam0))) && ARE_STRINGS_EQUAL(_0x717E4D1F2048376D(func_263(uParam0)), "running")))
			{
				func_221(uParam1, iParam3, 1);
			}
			SET_ENTITY_COORDS(uParam0->f_32, vVar1, 1, 1, 0, 1);
			fVar0 = GET_HEADING_FROM_VECTOR_2D(-uParam1->f_1658, -uParam1->f_1658.f_1);
			if (uParam0->f_1 == 0)
			{
				fVar0 = (fVar0 + 180f);
		...
		else
		{
			SET_ENTITY_HEADING(uParam0->f_32, GET_ENTITY_HEADING(uParam0->f_32));
			func_57(uParam0, 16384);
			fVar4 = (GET_HEADING_FROM_VECTOR_2D(uParam0->f_40, uParam0->f_40.f_1) + func_324(bParam8, 180f, 0f));
			vVar5 = { uParam1->f_189.f_29 - GET_ENTITY_COORDS((uParam1[iParam3 /*94*/])->f_32, 1) };
			bVar8 = func_68(vVar5, uParam0->f_40) < 0f;
			bVar9 = func_68(vVar5, uParam0->f_43) < 0f;
			func_220(uParam0, 0);
			...
			if ((bParam8 && !bVar8) || (!bParam8 && bVar8))
			{
				...
				if (func_218(uParam1, uParam0))
				{
					TASK_GO_STRAIGHT_TO_COORD(0, vVar10, 1f, 20000, 1193033728, 1056964608);
				}
				else
				{
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar10, 1f, 20000, 1048576000, 1, 1193033728);
				}
				func_220(uParam0, func_26(uParam0) + 1);
			}
			TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar1, 1f, 20000, 1048576000, 0, fVar4);
			func_220(uParam0, func_26(uParam0) + 1);
			TASK_PLAY_ANIM(0, "mini@tennis", "idle_2_serve", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
			func_220(uParam0, func_26(uParam0) + 1);
			CLOSE_SEQUENCE_TASK(uParam0->f_54);
...
void func_234(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	if (((uParam0->f_31 != 3 && !bParam4) && !IS_PED_INJURED(func_263(uParam0))) && !IS_PED_RAGDOLL(func_263(uParam0)))
	{
		if ((IS_TENNIS_MODE(func_263(uParam0)) && !func_194(uParam0)) && !func_103(uParam0, 16384))
		{
			SET_PED_WEAPON_MOVEMENT_CLIPSET(func_263(uParam0), "TENNIS_LOCOMOTION_FEMALE");
		}
		func_127(&iVar0, &iVar1, &uVar2, &uVar2, 1, 1);
		fVar3 = ABSF(TO_FLOAT(iVar0));
		if ((fVar3 > 0f || ABSF(TO_FLOAT(iVar1)) > 0f) && uParam0->f_31 != 4)
		{
			SET_PED_MIN_MOVE_BLEND_RATIO(func_263(uParam0), 2f);
		}
		if ((func_74(uParam0) != 74 && uParam0->f_31 != 4) && fVar3 > 15f)
		{
			func_248(uParam0, (func_249(uParam0) + GET_FRAME_TIME()));
		}
		else
		{
			func_248(uParam0, 0f);
		...
		if (IS_TENNIS_MODE(func_263(uParam0)) && fVar5 < 0f)
		{
			fVar6 = func_68(uParam0->f_43, func_281(&(uParam1->f_247)) - uParam0->f_37);
			_0x54F157E0336A3822(func_263(uParam0), "ForcedStopDirection", fVar6);
		}
	}
	else if (uParam0->f_31 != 3)
	{
		...
		if (!IS_PED_INJURED(func_263(uParam0)) && _0x921CE12C489C4C41(func_263(uParam0)))
		{
			if (ARE_STRINGS_EQUAL(_0x717E4D1F2048376D(func_263(uParam0)), "Intro") && _0x30ED88D5E0C56A37(func_263(uParam0)))
			{
				_0xD01015C7316AE176(func_263(uParam0), "running");
			}
			...
			if ((fVar8 > 0.75f && VDIST2(uParam0->f_37, vVar11) > (fVar15 * fVar15)) || (fVar8 < 0.25f && VDIST2(uParam0->f_37, vVar11) < (fVar14 * fVar14)))
			{
				uParam0->f_62 = fVar8;
			}
			else if ((((fVar8 >= 0.25f && fVar8 <= 0.75f) || (fVar8 > 0.75f && VDIST2(uParam0->f_37, vVar11) < (fVar15 * fVar15))) || (fVar8 < 0.25f && VDIST2(uParam0->f_37, vVar11) > (fVar14 * fVar14))) || iParam5)
			{
				uParam0->f_62 = 0.5f;
			}
			if (_0xB4F47213DF45A64C(func_263(uParam0), "IdleStarted"))
			{
				fVar16 = GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216);
				StringCopy(&(uParam1->f_1670), func_193(fVar16 < 0.33f, "Idle3", func_193(fVar16 < 0.66f, "Idle4", "Idle1")), 8);
			}
			_SET_TASK_PROPERTY_BOOL(func_263(uParam0), &(uParam1->f_1670), 1);
			_SET_TASK_PROPERTY_FLOAT(func_263(uParam0), "Speed", uParam0->f_62);
		}
	}
	if (((func_74(uParam0) == 75 && DOES_ENTITY_EXIST(uParam1->f_247)) && HAS_ENTITY_COLLIDED_WITH_ANYTHING(uParam1->f_247)) && VDIST2(uParam0->f_37, func_281(&(uParam1->f_247))) < (0.88f * 0.88f))
	{
		func_57(uParam0, 256);
...
{
	if ((GET_RAIN_LEVEL() <= 0f && GET_SNOW_LEVEL() <= 0f) && func_74(uParam0) == 75)
	{
		if (ABSF(TO_FLOAT(iParam1)) >= ABSF(TO_FLOAT(iParam2)))
		{
			if (iParam1 > 15)
			{
				if (uParam0->f_35 != 3 && GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.08f)
				{
					PLAY_SOUND_FROM_ENTITY(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_263(uParam0), 0, 0, 0);
				}
				else if (GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.1f)
				{
					PLAY_SOUND_FROM_ENTITY(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_263(uParam0), 0, 0, 0);
				}
				uParam0->f_35 = 3;
			...
			{
				if (uParam0->f_35 != 2 && GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.08f)
				{
					PLAY_SOUND_FROM_ENTITY(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_263(uParam0), 0, 0, 0);
				}
				else if (GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.1f)
			...
			{
				if (uParam0->f_35 != 4 && GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.08f)
				{
					PLAY_SOUND_FROM_ENTITY(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_263(uParam0), 0, 0, 0);
				}
				uParam0->f_35 = 4;
		...
		else if (ABSF(TO_FLOAT(iParam1)) < ABSF(TO_FLOAT(iParam2)))
		{
			if (iParam2 > 15)
			{
				if (uParam0->f_35 != 1 && GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.08f)
				{
					PLAY_SOUND_FROM_ENTITY(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_263(uParam0), 0, 0, 0);
				}
				else if (GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.1f)
			...
			{
				if (uParam0->f_35 != 0 && GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.08f)
				{
					PLAY_SOUND_FROM_ENTITY(-1, "TENNIS_FOOT_SQUEAKS_MASTER", func_263(uParam0), 0, 0, 0);
				}
				else if (GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.1f)
	...
	switch (func_145(&(uParam0->f_4)))
	{
		...
		case 5:
			if (func_74(uParam0) == 75)
			{
				...
				{
					TASK_GO_STRAIGHT_TO_COORD(func_263(uParam0), vVar3, 2f, -1, 1193033728, 1056964608);
					func_240(&(uParam0->f_4), vVar3);
					func_79(&(uParam0->f_4), 4);
					vVar0 = { vVar3 - uParam0->f_37 };
					vVar0 = { vVar0 / FtoV(VMAG(vVar0)) };
					*uParam1 = ROUND((vVar0.x * 128f));
					*uParam2 = ROUND((vVar0.y * 128f));
				}
				else if ((IS_ENTITY_AT_COORD(uParam0->f_32, func_69(&(uParam0->f_4)), vVar6, 0, 1, 0) || GET_SCRIPT_TASK_STATUS(func_263(uParam0), 2106541073) == 7) && !func_226(&(uParam0->f_4), 256))
				{
					func_233(&(uParam0->f_4), 0);
					func_215(&(uParam0->f_4), 4);
				}
		...
		case 1:
			if (func_74(uParam0) == 75)
			{
				_0xF56DFB7B61BE7276(func_281(uParam4), func_281(uParam4) + uParam4->f_10, uParam0->f_37, uParam0->f_40, &fVar9);
				...
				if (func_51(uParam3) != 2)
				{
					...
					bVar31 = fVar29 > 0f;
					bVar32 = fVar30 > 0f;
					if ((VDIST2(uParam0->f_37, vVar3) < 50f && bVar31 != bVar32) && fVar22 < 0f)
					{
						CLEAR_PED_TASKS(func_263(uParam0));
						func_79(&(uParam0->f_4), 4);
					}
				}
				if (((!IS_PED_INJURED(func_263(uParam0)) && !VDIST2(uParam0->f_37, vVar3) <= (0f * 0f)) && !func_226(&(uParam0->f_4), 4)) && !func_103(uParam0, 1024))
				{
					TASK_GO_STRAIGHT_TO_COORD(uParam0->f_32, func_69(&(uParam0->f_4)), 2f, -1, 1193033728, 1056964608);
					vVar3 = { func_69(&(uParam0->f_4)) };
					func_240(&(uParam0->f_4), vVar3);
					func_79(&(uParam0->f_4), 4);
				...
				else if (VDIST2(uParam0->f_37, vVar3) <= (0f * 0f) || GET_SCRIPT_TASK_STATUS(func_263(uParam0), 2106541073) == 7)
				{
...
int func_241(var uParam0, var uParam1, var uParam2)
{
	...
	if (IS_ENTITY_AT_COORD(uParam0->f_32, *uParam1, *uParam2, 0, 1, 0))
	{
		return 0;
	}
...
void func_243(var uParam0, var uParam1)
{
	...
	if (GET_GAME_TIMER() > func_245(&(uParam0->f_4)))
	{
		...
		func_244(&(uParam0->f_4), GET_GAME_TIMER() + 500);
	}
}
...
int func_246(var uParam0, var uParam1)
{
	...
	if (VDIST2(func_69(&(uParam0->f_4)) + Vector(1f, 0f, 0f), uParam0->f_37) > (4f * 4f))
	{
		return 0;
	}
...
void func_258(var uParam0, int iParam1)
{
	...
	SET_PED_CONFIG_FLAG(*uParam0, 20, 1);
	_SET_PED_RAGDOLL_BLOCKING_FLAGS(*uParam0, 16);
	if (iParam1 != -86095805)
	{
...
void func_259(int iParam0, int iParam1)
{
	...
	if (DOES_ENTITY_EXIST(iParam0) && !IS_PED_INJURED(iParam0))
	{
		...
		ENABLE_TENNIS_MODE(iParam0, iParam1, iVar1);
	}
}

void func_260(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (!IS_PED_INJURED(func_263(uParam0[iParam1 /*94*/])) && !IS_PED_INJURED(func_263(uParam0[iParam2 /*94*/])))
	{
		if (!bParam3)
		{
			if (!bParam4)
			{
				ATTACH_ENTITY_TO_ENTITY((uParam0[iParam1 /*94*/])->f_33, func_263(uParam0[iParam1 /*94*/]), GET_PED_BONE_INDEX(func_263(uParam0[iParam1 /*94*/]), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			}
			ATTACH_ENTITY_TO_ENTITY((uParam0[iParam2 /*94*/])->f_33, func_263(uParam0[iParam2 /*94*/]), GET_PED_BONE_INDEX(func_263(uParam0[iParam2 /*94*/]), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
		else
		{
			if (!bParam4)
			{
				ATTACH_ENTITY_TO_ENTITY((uParam0[iParam1 /*94*/])->f_33, func_263(uParam0[iParam1 /*94*/]), GET_PED_BONE_INDEX(func_263(uParam0[iParam1 /*94*/]), 28422), vLocal_309, vLocal_312, 0, 0, 0, 0, 2, 1);
			}
			ATTACH_ENTITY_TO_ENTITY((uParam0[iParam2 /*94*/])->f_33, func_263(uParam0[iParam2 /*94*/]), GET_PED_BONE_INDEX(func_263(uParam0[iParam2 /*94*/]), 28422), vLocal_309, vLocal_312, 0, 0, 0, 0, 2, 1);
		}
	}
}
...
void func_265(var uParam0, int iParam1)
{
	...
	uParam0->f_247 = CREATE_OBJECT(joaat("prop_tennis_ball"), vVar0, 0, 0, 0);
	_0xB2D0BDE54F0E8E5A(uParam0->f_247, 1);
	SET_ENTITY_RECORDS_COLLISIONS(uParam0->f_247, 1);
	func_113(uParam0->f_247, 0);
	FREEZE_ENTITY_POSITION(uParam0->f_247, 0);
...
{
	if (!REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\Tennis", 0, -1))
	{
		if (uParam0->f_1657 != 1)
		{
		}
	...
	if (!REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\TENNIS_VER2_A", 0, -1))
	{
		if (uParam0->f_1657 != 1)
		{
		}
...
void func_271(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	iVar1 = (1 - iVar0);
	if (!IS_PED_INJURED(func_263(uParam0[iVar0 /*94*/])) && GET_SCRIPT_TASK_STATUS(func_263(uParam0[iVar0 /*94*/]), 242628503) == 1)
	{
		*uParam2 = GET_SEQUENCE_PROGRESS(func_263(uParam0[iVar0 /*94*/]));
	}
	if (!IS_PED_INJURED(func_263(uParam0[iVar1 /*94*/])) && GET_SCRIPT_TASK_STATUS(func_263(uParam0[iVar1 /*94*/]), 242628503) == 1)
	{
		*uParam3 = GET_SEQUENCE_PROGRESS(func_263(uParam0[iVar1 /*94*/]));
	}
	if (func_103(uParam0[iVar0 /*94*/], 16384) && *uParam2 > 0)
	{
		func_275(uParam0[iVar0 /*94*/], 16384);
		func_259(func_263(uParam0[iVar0 /*94*/]), 0);
		SET_PED_WEAPON_MOVEMENT_CLIPSET(func_263(uParam0[iVar0 /*94*/]), "weapons@tennis@male");
	}
	if (func_103(uParam0[iVar1 /*94*/], 16384) && *uParam3 > 0)
	{
		func_275(uParam0[iVar1 /*94*/], 16384);
		func_259(func_263(uParam0[iVar1 /*94*/]), 0);
		SET_PED_WEAPON_MOVEMENT_CLIPSET(func_263(uParam0[iVar1 /*94*/]), "weapons@tennis@male");
	}
}
...
void func_272(var uParam0)
{
	if (func_273(uParam0))
	{
		STOP_PARTICLE_FX_LOOPED(uParam0->f_23, 1);
		func_285(uParam0, 1);
	}
}
...
int func_277(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7, bool bParam8, float fParam9, bool bParam10, float fParam11, bool bParam12)
{
	...
	vVar0 = { 0f, 0f, 1f };
	fVar3 = func_324(fParam9 == -1f, GET_FRAME_TIME(), fParam9);
	iVar4 = 0;
	...
	*uParam4 = (*uParam4 + fVar3);
	...
	DRAW_DEBUG_LINE(uParam0->f_29 + Vector(1f, 0f, 0f), uParam0->f_29 + Vector(1f, 0f, 0f) + vVar6, 0, 0, 255, 255);
	...
	if (iVar4 == 2)
	{
		...
		vVar21 = { *uParam3 / FtoV(VMAG(*uParam3)) };
	...
	*uParam1 = { *uParam1 + *uParam2 * Vector(fVar3, fVar3, fVar3) };
	...
	{
		_0xF56DFB7B61BE7276(vVar31, *uParam1, uParam0->f_29, 0f, 0f, 1f, &fVar34);
...
int func_280(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6)
{
	...
	{
		vVar1 = { *uParam1 + *uParam2 - *uParam1 * Vector(fVar0, fVar0, fVar0) };
		fVar7 = _0x7F8F6405F4777AF6(vVar1, uParam0->f_39[0 /*3*/], uParam0->f_39[1 /*3*/], 0);
		fVar8 = _0x7F8F6405F4777AF6(vVar1, uParam0->f_39[1 /*3*/], uParam0->f_39[2 /*3*/], 0);
		...
		{
			vVar10 = { *uParam3 / FtoV(VMAG(*uParam3)) };
			if (func_68(*uParam2 - *uParam1, vVar10) > 0f)
			{
				vVar10 = { vVar10 * Vector(-1f, -1f, -1f) };
			}
			fVar13 = SQRT(((0.025f * 0.025f) - (fVar9 * fVar9)));
...
void func_289(var uParam0, vector3 vParam1)
{
	...
	if (func_286(uParam0, 1))
	{
		if (!func_273(uParam0))
		{
			uParam0->f_23 = START_PARTICLE_FX_LOOPED_AT_COORD("scr_tennis_ball_trail", vParam1, 0f, 0f, 0f, 1065353216, 0, 0, 0, 1);
			GET_HUD_COLOUR(12, &uVar0, &uVar1, &uVar2, &uVar3);
			SET_PARTICLE_FX_LOOPED_COLOUR(uParam0->f_23, (TO_FLOAT(uVar0) / 255f), (TO_FLOAT(uVar1) / 255f), (TO_FLOAT(uVar2) / 255f), 0);
			uVar3 = uVar3;
		}
		SET_PARTICLE_FX_LOOPED_OFFSETS(uParam0->f_23, vParam1, 0f, 0f, 0f);
	}
}
...
int func_300(var uParam0, int iParam1, int iParam2)
{
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()) && IS_PED_SHOOTING(PLAYER_PED_ID()))
	{
		...
		{
			TASK_SEEK_COVER_FROM_PED(uVar0, PLAYER_PED_ID(), -1, 0);
		}
		if (!IS_PED_INJURED(func_263(uParam0[(1 - iParam1) /*94*/])))
		{
			TASK_SEEK_COVER_FROM_PED(func_263(uParam0[(1 - iParam1) /*94*/]), PLAYER_PED_ID(), -1, 0);
		}
		return 1;
	}
	if (IS_PED_INJURED(uVar0))
	...
	if (HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uVar0))
	{
		return 1;
	}
	if (IS_PED_IN_MELEE_COMBAT(uVar0))
	{
		return 1;
	}
	if ((!IS_ENTITY_DEAD(uVar0, 0) && !IS_ENTITY_DEAD(PLAYER_PED_ID(), 0)) && HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uVar0, PLAYER_PED_ID(), 1))
	{
		return 1;
	}
	...
	if (HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uVar1))
	{
		return 1;
	}
	if (IS_PED_IN_MELEE_COMBAT(uVar1))
	{
		return 1;
	}
	if ((!IS_ENTITY_DEAD(uVar1, 0) && !IS_ENTITY_DEAD(PLAYER_PED_ID(), 0)) && HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uVar1, PLAYER_PED_ID(), 1))
	{
		return 1;
	}
	...
	if (IS_PED_RAGDOLL(uVar1))
	{
		return 1;
	}
	if (uParam0->f_1657 == 1 && (IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), uVar0) || IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), uVar1)))
	{
		return 1;
	}
	return 0;
...
void func_303(var uParam0)
{
	if (DOES_ENTITY_EXIST((uParam0[0 /*94*/])->f_33))
	{
		DETACH_ENTITY((uParam0[0 /*94*/])->f_33, 1, 1);
		SET_OBJECT_AS_NO_LONGER_NEEDED(&((uParam0[0 /*94*/])->f_33));
	}
	if (DOES_ENTITY_EXIST(uParam0->f_247))
	{
		DETACH_ENTITY(uParam0->f_247, 1, 1);
		SET_OBJECT_AS_NO_LONGER_NEEDED(&(uParam0->f_247));
	}
	if (DOES_ENTITY_EXIST((uParam0[1 /*94*/])->f_33))
	{
		DETACH_ENTITY((uParam0[1 /*94*/])->f_33, 1, 1);
...
void func_308(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, var uParam5, int iParam6, int iParam7)
{
	...
	func_309(uParam1, func_49(uParam5->f_1, uParam5->f_3, GET_RANDOM_INT_IN_RANGE(500, 3000)));
	func_267(uParam1, 4);
...
void func_315(var uParam0, int iParam1, int iParam2, vector3 vParam3, vector3 vParam6)
{
	...
	uParam0->f_43 = { vParam6 / FtoV(VMAG(vParam6)) };
	uParam0->f_63 = (3f + 1f);
	switch (iParam2)
	{
		case 0:
...
void func_318(var uParam0, var uParam1, int iParam2)
{
	...
	if (uParam1->f_1656 == 16 && uParam1->f_1657 != 1)
	{
		...
		func_322(uParam0, VMAG(uParam1->f_1661));
...
var func_323(var uParam0)
{
	...
	fVar0 = 1E+08f;
	bVar5 = IS_ENTITY_DEAD(PLAYER_PED_ID(), 0);
	if (func_222(PLAYER_ID(), 0))
	{
		bVar5 = IS_ENTITY_DEAD(GET_PLAYER_PED(NETWORK_GET_PLAYER_INDEX(NETWORK_GET_HOST_OF_THIS_SCRIPT())), 0);
	}
	if (!bVar5)
	{
		if (func_222(PLAYER_ID(), 0))
...
void func_328(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_330(Global_106565.f_18527[iVar0], &vVar2, &fVar5))
			{
