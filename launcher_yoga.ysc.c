			...
			switch (iLocal_67)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_69(3) && !Global_16C52)
						{
							if (func_83(uLocal_66, 2097152))
							{
								if ((!func_83(uLocal_66, 1) || !ENTITY::DOES_ENTITY_EXIST(func_68())) && !Global_16C52)
								{
									func_76(10);
									break;
								}
						...
						if ((!func_58(6) || Global_19A9D) || func_57())
						{
							bVar3 = false;
						}
						if (func_83(uLocal_66, 1))
						...
						if (func_51() || func_50(8, 4294967295))
						{
							bVar3 = false;
						}
				...
				case 6:
					...
					if (func_83(Global_19911, 262144))
					{
						func_86(&Global_19911, 262144);
						func_13();
					}
					if (func_83(uLocal_66, 2097152))
					{
...
void func_28(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x1013
{
	int iVar0;
...
int func_30(int iParam0, int iParam1, int iParam2)//Position - 0x10C6
{
...
int func_31(int iParam0, int iParam1, int iParam2)//Position - 0x10E1
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x112D
{
	int iVar0;
...
int func_34(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x11F3
{
	int iVar0;
...
void func_35(var uParam0, int iParam1)//Position - 0x132A
{
	int iVar0;
...
int func_36(int iParam0)//Position - 0x1379
{
	if (Global_8D15 == 15)
	{
		return 0;
...
int func_38(int iParam0, bool bParam1)//Position - 0x13C5
{
	int iVar0;
...
int func_39(int iParam0)//Position - 0x147D
{
	int iVar0;
...
void func_40(int iParam0)//Position - 0x14B8
{
	int iVar0;
...
void func_41(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x150F
{
	int iVar0;
...
int func_42(var uParam0)//Position - 0x163A
{
	return 1;
}

bool func_43(int iParam0)//Position - 0x1643
{
	func_44();
	return iParam0 == Global_19E56.f_933.f_21B.f_10CD;
}

void func_44()//Position - 0x165F
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_47(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_45(iVar0) && (!func_71(14) || Global_19A3D))
			{
...
bool func_45(int iParam0)//Position - 0x175C
{
	return iParam0 < 3;
}

int func_46(int iParam0)//Position - 0x1768
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0)//Position - 0x17A5
{
	if (func_45(iParam0))
	{
...
var func_48()//Position - 0x17CF
{
	return Global_10B8E;
}

int func_49(int iParam0)//Position - 0x17DB
{
	if (iParam0 == 1)
	{
...
bool func_50(int iParam0, int iParam1)//Position - 0x1835
{
	switch (iParam0)
	{
		case 5:
...
bool func_51()//Position - 0x1870
{
	return MISC::GET_GAME_TIMER() <= Global_43D7.f_16F1 + 100;
}

int func_52()//Position - 0x1885
{
...
bool func_53(bool bParam0)//Position - 0x189F
{
	if (bParam0)
	{
...
void func_54(var uParam0, int iParam1)//Position - 0x18C8
{
	func_55(uParam0, iParam1);
}

void func_55(var uParam0, var uParam1)//Position - 0x18D8
{
	*uParam0 = (*uParam0 || uParam1);
}

int func_56()//Position - 0x18E9
{
	return 1;
}

bool func_57()//Position - 0x18F2
{
	int iVar0;
	bool bVar1;
...
int func_58(int iParam0)//Position - 0x19FC
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_65()) || Global_19A9D) || Global_6375) || func_64()) || func_50(8, 4294967295)) || func_63()) || func_62()) || func_61()) || func_52()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_65()) || Global_6375) || func_64()) || func_50(8, 4294967295)) || func_61()) || func_63()) || func_62()) || func_52()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_65()) || Global_19A9D) || Global_6375) || func_64()) || func_50(8, 4294967295)) || func_61()) || func_63()) || func_62()) || func_52()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_65()) || Global_19A9D) || Global_6375) || func_64()) || func_50(8, 4294967295)) || func_63()) || func_62()) || func_52()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_65() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_50(8, 4294967295)) || func_52()) || func_60()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_50(8, 4294967295) || func_63()) || func_62()) || func_60()) || func_59())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_65()) || Global_6375) || func_64()) || func_50(8, 4294967295)) || func_62()) || func_61()) || func_52()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_59()//Position - 0x2119
{
	return Global_16C57.f_1;
}

int func_60()//Position - 0x2127
{
...
bool func_62()//Position - 0x2177
{
	return Global_16C64.f_148 > 0;
}

bool func_63()//Position - 0x2188
{
	return Global_16C64.f_147 > 0;
}

var func_64()//Position - 0x2199
{
	return Global_140859;
}

int func_65()//Position - 0x21A5
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_66()//Position - 0x21C1
{
	func_44();
	return Global_19E56.f_933.f_21B.f_10CD;
}

int func_67()//Position - 0x21DA
{
...
var func_68()//Position - 0x21F4
{
	return Global_15C47;
}

int func_69(int iParam0)//Position - 0x2200
{
	switch (iParam0)
	{
		case 0:
...
bool func_70(int iParam0)//Position - 0x2272
{
	int iVar0;
...
bool func_71(int iParam0)//Position - 0x22AE
{
	return Global_8D15 == iParam0;
}

void func_72()//Position - 0x22BC
{
	if (!ENTITY::DOES_ENTITY_EXIST(Local_88))
	{
		...
		unk_0x346478B12F69D4E3(Local_88, true);
	}
}

bool func_73()//Position - 0x2305
{
	if (!NETWORK::_SET_NETWORK_ID_SYNC_TO_PLAYER(Local_88.f_1))
	{
		return 0;
	}
...
void func_75(var uParam0, int iParam1)//Position - 0x2344
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_76(int iParam0)//Position - 0x2355
{
	iLocal_67 = iParam0;
}

void func_77(int iParam0, bool bParam1, bool bParam2)//Position - 0x2361
{
	int iVar0;
	bool bVar1;
...
bool func_80(int iParam0, int iParam1)//Position - 0x24AD
{
	bool bVar0;
...
bool func_81(int iParam0)//Position - 0x24FA
{
	return func_82(iParam0, Global_8D15);
}

int func_82(int iParam0, int iParam1)//Position - 0x250B
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_83(var uParam0, int iParam1)//Position - 0x26EC
{
	return (uParam0 && iParam1) != 0;
}

void func_84()//Position - 0x26FB
{
...
int func_85()//Position - 0x27A3
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
		vVar0 = { unk_0x8000C77B5F336760(PLAYER::GET_PLAYER_PED(CAM::_0xDC9DA9E8789F5246()), true) };
...
void func_86(var uParam0, int iParam1)//Position - 0x283F
{
	func_87(uParam0, iParam1);
}

void func_87(var uParam0, var uParam1)//Position - 0x284F
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_88(bool bParam0)//Position - 0x2864
{
	if (bParam0)
	{
		if (iLocal_77 != 263)
