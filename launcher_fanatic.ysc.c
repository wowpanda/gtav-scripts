	...
	while (true)
	{
		...
		if (iLocal_55 == 0)
		{
			if (Var0 == 22)
			{
				...
				{
					if (func_196(Var0.f_1C[1]))
					{
						func_288("Trying to set Mary Ann boyfriend component variation");
						CUTSCENE::_0x2A56C06EBEF2B0D9("MaryAnnes_Friend", Var0.f_1C[1], 0);
...
void func_47(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3798
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x3938
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x396A
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x399E
{
	return Global_1407E0;
}

int func_51(int iParam0, int iParam1)//Position - 0x39AA
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x39D6
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F1E
{
	int iVar0;
...
int func_54()//Position - 0x4160
{
	func_55();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_55()//Position - 0x4179
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x4276
{
	return Global_8D15 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x4284
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x4377
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x4601
{
	switch (iParam0)
	{
		case 3036451504:
...
int func_60(int iParam0)//Position - 0x469C
{
...
int func_61(int iParam0, int iParam1)//Position - 0x4822
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x5393
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x53CE
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x5642
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x567E
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_66(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x5BD9
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5C1D
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x62FC
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x6343
{
...
bool func_70(int iParam0)//Position - 0x639E
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x63AE
{
...
int func_72(int iParam0)//Position - 0x6418
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x671B
{
	return Global_6373;
}

int func_74(int iParam0)//Position - 0x6726
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6736
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x67D8
{
	switch (iParam0)
	{
		case 4294967295:
...
int func_77(int iParam0)//Position - 0x6DAD
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6E0B
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6EB9
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6F4E
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6F92
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x7116
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x7124
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7BEB
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7C6D
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7CCB
{
	return 4294967295;
}

Vector3 func_87(int iParam0)//Position - 0x7CD4
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x7EDF
{
	return func_89(CAM::_0xDC9DA9E8789F5246());
}

int func_89(int iParam0)//Position - 0x7EEF
{
	return MISC::GET_BITS_IN_RANGE(Global_24FBF9[iParam0 /*413*/].f_135.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x7F0C
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x7F1C
{
	switch (iParam0)
	{
		case 4294967295:
...
void func_129(var uParam0, bool bParam1, bool bParam2)//Position - 0xA64C
{
	...
	while (iVar0 < 6)
	{
		if (func_196(uParam0->f_1C[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_196(uParam0->f_23[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_196(uParam0->f_29[iVar0]))
		{
	...
	switch (iParam0->f_10)
	{
		case 0:
			if (*iParam0 == 12)
			{
				...
				else if (func_196(iParam0->f_1C[0]))
				{
					if (func_172(iParam0))
					{
						if (func_176(2))
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
				{
					if (func_196(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
					{
...
void func_185(int iParam0)//Position - 0xCB3D
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_57) >= 900)
	{
		if (func_196(iParam0->f_1C[0]))
		{
			if (!func_144())
			{
				func_186(iParam0->f_1C[0], "PUSHUP_BREATH", "MARYANN", 6);
				iLocal_57 = MISC::GET_GAME_TIMER();
			}
		}
	}
...
void func_186(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xCB8D
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_187(iParam3), 0);
}

int func_187(int iParam0)//Position - 0xCBA6
{
	int iVar0;
...
int func_188(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xCD9B
{
	var uVar0;
	
	if ((((func_196(AUDIO::_0x0626A247D2405330()) && func_196(iParam0->f_1C[0])) && !func_144()) && (MISC::GET_GAME_TIMER() - iParam0->f_3C) > iParam6) && func_192(AUDIO::_0x0626A247D2405330(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_191(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
...
void func_189(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCE23
{
...
void func_190(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCE5E
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
void func_191(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCEB4
{
...
float func_192(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xCF4F
{
	vector3 vVar0;
...
int func_193(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)//Position - 0xCF89
{
	var uVar0;
	...
	if (func_176(2))
	{
		if (!func_144())
		{
			if (((func_196(AUDIO::_0x0626A247D2405330()) && func_196(iParam0->f_1C[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_3C) > iParam6) && func_192(AUDIO::_0x0626A247D2405330(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_191(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
				func_189(&uVar0, cParam2, sParam3, 7, 0, 0);
		...
		{
			if (func_196(AUDIO::_0x0626A247D2405330()))
			{
				if (func_192(AUDIO::_0x0626A247D2405330(), vParam1, 1) >= 20f)
				{
					func_142();
				}
			}
...
int func_194(char* sParam0)//Position - 0xD04B
{
	struct<6> Var0;
...
struct<6> func_195()//Position - 0xD06B
{
	struct<6> Var0;
...
int func_196(int iParam0)//Position - 0xD08F
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_197(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xD0B0
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_192(AUDIO::_0x0626A247D2405330(), vParam2, 1) <= 100f)
				{
					func_200(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_192(AUDIO::_0x0626A247D2405330(), vParam2, 1) > 120f)
				{
					func_202(iParam0);
				}
			}
...
void func_198(int iParam0, bool bParam1)//Position - 0xD1A1
{
	if (iParam0 == 4294967295)
	{
		return;
...
int func_199(int iParam0)//Position - 0xD1DD
{
	if (Global_11621 == iParam0)
	{
...
void func_200(int iParam0, int iParam1)//Position - 0xD216
{
	bool bVar0;
	int iVar1;
...
bool func_201()//Position - 0xD2B4
{
	return Global_1620C;
}

void func_202(int iParam0)//Position - 0xD2C0
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_203(iParam0);
...
void func_203(int iParam0)//Position - 0xD2D7
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_204(int iParam0)//Position - 0xD3BF
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_163();
...
int func_205(var uParam0, bool bParam1)//Position - 0xD3E7
{
	struct<27> Var0;
...
void func_206(int iParam0, var uParam1, int iParam2)//Position - 0xD65A
{
	int iVar0;
	int iVar1;
	...
	if (func_196(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				...
				{
					if (func_207(iParam2) && !PED::IS_PED_FACING_PED(iParam0, AUDIO::_0x0626A247D2405330(), 25f))
					{
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, AUDIO::_0x0626A247D2405330(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_208(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_207(iParam2) || PED::IS_PED_FACING_PED(iParam0, AUDIO::_0x0626A247D2405330(), 10f))
				{
					if (func_68(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						BRAIN::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, 4294967295, 262153, 0, 0, 0, 0);
...
int func_207(int iParam0)//Position - 0xD9B2
{
...
int func_208(var uParam0)//Position - 0xD9D2
{
...
int func_209(var uParam0)//Position - 0xD9EA
{
...
void func_210(var uParam0)//Position - 0xDA0F
{
	int iVar0;
	int iVar1;
...
void func_211(int iParam0)//Position - 0xDD13
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_212(var uParam0)//Position - 0xDD3E
{
	int iVar0;
...
int func_213(var uParam0, bool bParam1, bool bParam2)//Position - 0xDDBE
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_214(AUDIO::_0x0626A247D2405330(), uParam0->f_23[iVar0]))
							{
...
int func_214(int iParam0, int iParam1)//Position - 0xDF7C
{
	int iVar0;
...
int func_215(var uParam0, bool bParam1, int iParam2)//Position - 0xDFAC
{
	int iVar0;
	int iVar1;
...
int func_216(int iParam0)//Position - 0xE268
{
...
int func_217(int iParam0, float fParam1)//Position - 0xE29C
{
	float fVar0;
	
	if (func_196(AUDIO::_0x0626A247D2405330()) && func_196(iParam0))
	{
...
bool func_218(int iParam0, float fParam1)//Position - 0xE312
{
	return func_219(iParam0, AUDIO::_0x0626A247D2405330(), fParam1, 1, 250, 7);
}

bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE32A
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_220(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE3EB
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_221(int iParam0, int iParam1)//Position - 0xE517
{
	int iVar0;
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE626
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_225(unk_0x8000C77B5F336760(iParam1, true) - unk_0x8000C77B5F336760(iParam0, true)) };
...
float func_224(vector3 vParam0, vector3 vParam1)//Position - 0xE6B7
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_225(vector3 vParam0)//Position - 0xE6D8
{
	float fVar0;
	float fVar1;
...
void func_226(var uParam0)//Position - 0xE717
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_227(int iParam0, int iParam1)//Position - 0xE732
{
	int iVar0;
...
int func_228(int iParam0)//Position - 0xE771
{
...
int func_229(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE799
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_230(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE894
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_231(int iParam0, float fParam1)//Position - 0xE9A0
{
	var uVar0;
	vector3 vVar1;
...
int func_232(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xEA35
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_225(vParam1 - unk_0x8000C77B5F336760(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_233(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEAC3
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
...
int func_234(int iParam0)//Position - 0xEB0B
{
...
void func_235(int iParam0)//Position - 0xEB55
{
	int iVar0;
...
int func_236(int iParam0)//Position - 0xEBF2
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_163();
...
int func_237(int iParam0)//Position - 0xEC8A
{
...
int func_240(int iParam0)//Position - 0xED0C
{
	if ((func_241() && Global_16C30.f_B == 6) && iParam0 == func_164(&(Global_16C30.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_242(int iParam0)//Position - 0xED7E
{
	if (func_107(0))
	{
...
int func_243(int iParam0)//Position - 0xEDA6
{
	switch (*iParam0)
	{
		case 21:
...
int func_245(var uParam0)//Position - 0xEE59
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_251(&(uParam0->f_30), "rcmfanatic3", "ef_3_rcm_loop_maryann", 0);
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_250(&iVar0) || !func_249(&(uParam0->f_30)))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				if (func_246(&(uParam0->f_1C[0]), 61, -915.6f, 6139.192f, 5.525f, 111.24f, "FANATIC LAUNCHER RC", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[0]))
			{
				...
				uParam0->f_29[0] = OBJECT::CREATE_OBJECT(iVar0[1], vVar3, true, true, false);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[1]))
			{
				...
				uParam0->f_29[1] = OBJECT::CREATE_OBJECT(iVar0[2], vVar3, true, true, false);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[2]))
			{
				...
				uParam0->f_29[2] = OBJECT::CREATE_OBJECT(iVar0[3], vVar3, true, true, false);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[3]))
			{
				...
				uParam0->f_29[3] = OBJECT::CREATE_OBJECT(iVar0[4], vVar3, true, true, false);
...
int func_246(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xF219
{
...
int func_247(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xF275
{
	int iVar0;
...
int func_248(var uParam0, int iParam1)//Position - 0xF303
{
	int iVar0;
...
int func_249(var uParam0)//Position - 0xF349
{
	if (func_209(uParam0))
	{
...
int func_250(int iParam0)//Position - 0xF373
{
	int iVar0;
...
void func_251(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xF3A4
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_252(var uParam0)//Position - 0xF3E0
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_251(&(uParam0->f_30), "rcm_fanatic2", "ef_2_rcm__maryann_biking_maryann", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (!func_246(&(uParam0->f_1C[0]), 61, 809.66f, 1279.76f, 360.49f, 122.53f, "FANATIC LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_256(&(uParam0->f_1C[1]), iVar0[1], 808.43f, 1279.16f, 360.47f, -79.11f, 26);
				if (func_196(uParam0->f_1C[1]))
				{
			...
			{
				func_254(&(uParam0->f_23[0]), iVar0[2], 808.35f, 1277.2f, 360.15f, 216.5f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[1]))
			{
				func_254(&(uParam0->f_23[1]), iVar0[2], 807.89f, 1275.73f, 360.18f, 208.2f);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
		...
		case 3:
			...
			while (iVar1 <= 1)
			{
				if (func_196(uParam0->f_23[iVar1]))
				{
...
void func_254(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF724
{
	func_255(iParam0);
...
void func_255(int iParam0)//Position - 0xF766
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_256(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0xF802
{
	func_257(iParam0);
	*iParam0 = PED::CREATE_PED(iParam4, iParam1, vParam2, fParam3, 0, false);
}

void func_257(int iParam0)//Position - 0xF823
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_258(var uParam0)//Position - 0xF864
{
	int iVar0[1];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_251(&(uParam0->f_30), "rcmfanatic1", "ef_1_rcm_mary_ann_streching_base", 0);
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (func_246(&(uParam0->f_1C[0]), 61, -1878.27f, -440.55f, 46.23f, 165.94f, "FANATIC LAUNCHER RC", 1))
				{
...
int func_259(int iParam0)//Position - 0xF9BF
{
	struct<27> Var0;
	int iVar1;
...
int func_260(int iParam0)//Position - 0xFA13
{
	char* sVar0;
...
int func_261(int iParam0)//Position - 0xFACC
{
	var uVar0;
...
int func_262(int iParam0)//Position - 0xFB8D
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_263(int iParam0, char* sParam1)//Position - 0xFC12
{
...
bool func_264(int iParam0)//Position - 0xFCF4
{
...
bool func_265(int iParam0)//Position - 0xFD22
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
int func_267(int iParam0)//Position - 0xFD7E
{
	if (func_237(iParam0))
	{
		return 0;
...
void func_268()//Position - 0xFDB3
{
	func_288("Running end routines.");
	Global_19D3C = (Global_19D3C - 1);
}

int func_269(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xFDCD
{
	int iVar0;
...
int func_270(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xFE32
{
	int iVar0;
	struct<7> Var1;
...
int func_271(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xFEB0
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_272(int iParam0, bool bParam1)//Position - 0xFF2B
{
	char* sVar0;
...
void func_273(char* sParam0)//Position - 0xFFCF
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_194(sParam0))
...
void func_274()//Position - 0xFFEE
{
	Global_3960 = 0;
	func_275();
}

void func_275()//Position - 0xFFFE
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_276(var uParam0)//Position - 0x10021
{
	if (func_209(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_277(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10057
{
...
void func_278(var uParam0, bool bParam1)//Position - 0x10077
{
	func_279(&(uParam0->f_29), bParam1);
}

void func_279(var uParam0, bool bParam1)//Position - 0x10089
{
	int iVar0;
...
void func_280(int iParam0, bool bParam1)//Position - 0x100C7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_281(var uParam0, bool bParam1)//Position - 0x10102
{
	func_282(&(uParam0->f_23), bParam1);
}

void func_282(var uParam0, bool bParam1)//Position - 0x10114
{
	int iVar0;
...
void func_283(int iParam0)//Position - 0x10151
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_284(var uParam0, int iParam1)//Position - 0x10189
{
	func_285(&(uParam0->f_1C), iParam1);
}

void func_285(var uParam0, int iParam1)//Position - 0x1019B
{
	int iVar0;
...
void func_286(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x101DC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_287(var uParam0)//Position - 0x1022C
{
	if (*uParam0 == 4294967295)
	{
		return;
...
void func_288(char* sParam0)//Position - 0x10269
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_289(var uParam0)//Position - 0x1027B
{
	*uParam0 = 4294967295;
...
void func_290()//Position - 0x102AE
{
	func_288("Running start routines.");
	Global_19D3C++;
}

int func_291(int iParam0)//Position - 0x102C8
{
	if (!func_36(iParam0))
	{
		return Global_19E56.f_6D76[iParam0 /*29*/];
