...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (NETWORK_IS_IN_TUTORIAL_SESSION() != iLocal_1079)
		{
			func_143();
		}
		switch (func_130(PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (func_129() == 1)
				{
					func_128();
					func_127();
					vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/] = 1;
				}
				else if (func_129() == 4)
				{
					vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/] = 3;
				}
				break;
			...
			case 1:
				...
				{
					if (!IS_ENTITY_AT_COORD(PLAYER_PED_ID(), GET_ENTITY_COORDS(NET_TO_VEH(Local_95.f_2), 1), 200f, 200f, 200f, 0, 1, 0))
					{
						vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/] = 4;
					}
				}
				break;
		...
		if (NETWORK_IS_HOST_OF_THIS_SCRIPT())
		{
			switch (func_129())
			{
				case 0:
					...
					{
						if (!IS_BIT_SET(Local_95, 12))
						{
							Local_95.f_4 = PLAYER_ID();
							Local_95.f_5 = func_67();
							Local_95.f_10 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 0) + Vector(0f, 5f, 0f) };
...
int func_2()
{
	...
	if (Local_95.f_21 >= 0 || Local_95.f_21 <= 3)
	{
		if (NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_2))
		{
			if (!func_72(Local_95.f_2))
			{
				if (NETWORK_GET_DESTROYER_OF_NETWORK_ID(Local_95.f_2, &uVar0) == PLAYER_ID())
				{
					func_5(1, 600000);
				}
				return 1;
		...
		if (NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_3))
		{
			if (func_4(Local_95.f_3))
			{
				if (NETWORK_GET_DESTROYER_OF_NETWORK_ID(Local_95.f_3, &uVar1) == PLAYER_ID())
				{
					func_5(1, 600000);
				}
				return 1;
...
bool func_25()
{
	return IS_BIT_SET(func_26(6424, -1, 0), 19);
}
...
void func_30()
{
	...
	if (Local_95.f_20 != 7)
	{
		...
		else if (!IS_PED_IN_VEHICLE(NET_TO_PED(Local_95.f_3), NET_TO_VEH(Local_95.f_2), 0))
		{
			Local_95.f_20 = 7;
		}
	}
	if (!func_4(Local_95.f_3) && func_72(Local_95.f_2))
	{
		if (Local_95.f_20 != 1)
		{
			if (GET_ENTITY_HEALTH(NET_TO_VEH(Local_95.f_2)) <= 600 || GET_ENTITY_HEALTH(NET_TO_PED(Local_95.f_3)) <= 150)
			{
				Local_95.f_20 = 1;
			}
		}
		switch (Local_95.f_20)
		{
			case 2:
				...
				else if (!IS_BIT_SET(Local_95, 7) && IS_ENTITY_AT_ENTITY(NET_TO_PED(Local_95.f_3), PLAYER_PED_ID(), 10f, 10f, 10f, 0, 1, 0))
				{
					Local_95.f_20 = 3;
				}
				break;
			...
			case 4:
				SET_BIT(&uLocal_214, 8);
				if (GET_VEHICLE_NUMBER_OF_PASSENGERS(NET_TO_VEH(Local_95.f_2)) <= 0)
				{
					Local_95.f_20 = 3;
					CLEAR_BIT(&uLocal_214, 8);
				}
				else if (!IS_BIT_SET(Local_95, 7) && IS_ENTITY_AT_COORD(NET_TO_PED(Local_95.f_3), Local_95.f_7, 10f, 10f, 10f, 0, 1, 0))
				{
					Local_95.f_20 = 5;
				}
				break;
			...
			case 5:
				if ((GET_VEHICLE_NUMBER_OF_PASSENGERS(NET_TO_VEH(Local_95.f_2)) <= 0 && !IS_PED_ON_SPECIFIC_VEHICLE(PLAYER_PED_ID(), NET_TO_VEH(Local_95.f_2))) && func_31(PLAYER_PED_ID(), NET_TO_VEH(Local_95.f_2), 1) >= 10f)
				{
					Local_95.f_20 = 6;
				}
				break;
			...
			case 3:
				if (GET_VEHICLE_NUMBER_OF_PASSENGERS(NET_TO_VEH(Local_95.f_2)) >= 1)
				{
					Local_95.f_20 = 4;
				}
				break;
			...
			case 6:
				if ((GET_VEHICLE_NUMBER_OF_PASSENGERS(NET_TO_VEH(Local_95.f_2)) <= 0 && !IS_PED_ON_SPECIFIC_VEHICLE(PLAYER_PED_ID(), NET_TO_VEH(Local_95.f_2))) && func_31(PLAYER_PED_ID(), NET_TO_VEH(Local_95.f_2), 1) >= 10f)
				{
					if (GET_SCRIPT_TASK_STATUS(NET_TO_PED(Local_95.f_3), 242628503) == 1)
					{
						Local_95.f_20 = 7;
					}
				}
			...
			case 1:
				if (GET_SCRIPT_TASK_STATUS(NET_TO_PED(Local_95.f_3), 242628503) == 1 && func_31(PLAYER_PED_ID(), NET_TO_PED(Local_95.f_3), 1) >= 10f)
				{
					Local_95.f_20 = 7;
				}
				break;
...
void func_32()
{
	...
	{
		case 0:
			if (IS_BIT_SET(Local_95, 8) || GET_VEHICLE_NUMBER_OF_PASSENGERS(NET_TO_VEH(Local_95.f_2)) > 0)
			{
				Local_95.f_21 = 1;
			}
			break;
		...
		case 2:
			...
			else if (IS_BIT_SET(Local_95, 10))
			{
				Local_95.f_21 = 4;
			}
			break;
	...
	while (iVar0 < _NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK_IS_PARTICIPANT_ACTIVE(INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if (func_3(iVar1, 1, 1))
			{
				if (func_72(Local_95.f_2))
				{
					if (!IS_BIT_SET(Local_95, 8))
					{
						if (IS_ENTITY_AT_COORD(NET_TO_VEH(Local_95.f_2), Local_95.f_10, (10f * 1.5f), (10f * 1.5f), (10f * 1.5f), 0, 1, 0))
						{
							SET_BIT(&Local_95, 8);
						}
					}
					if (!IS_BIT_SET(Local_95, 7) || IS_BIT_SET(Local_95, 11))
					{
						if (!IS_BIT_SET(Local_95, 10))
						{
							if (IS_ENTITY_AT_COORD(NET_TO_VEH(Local_95.f_2), Local_95.f_7, (10f * 1.5f), (10f * 1.5f), (10f * 1.5f), 0, 1, 0))
							{
								SET_BIT(&Local_95, 10);
							}
						}
					}
					if (!IS_BIT_SET(Local_95, 9))
					{
						if (IS_BIT_SET(vLocal_117[iVar0 /*3*/].f_1, 6))
						{
							SET_BIT(&Local_95, 9);
							CLEAR_BIT(&(vLocal_117[iVar0 /*3*/].f_1), 6);
						}
					}
					if (Local_95.f_20 != 3)
					{
						if (IS_BIT_SET(vLocal_117[iVar0 /*3*/].f_1, 5))
						{
							Local_95.f_20 = 3;
							CLEAR_BIT(&(vLocal_117[iVar0 /*3*/].f_1), 5);
						}
					}
				}
			}
...
void func_34()
{
	...
	if ((Local_95.f_21 <= 2 || Local_95.f_20 == 2) || Local_95.f_20 == 3)
	{
		...
		if ((!GET_WATER_HEIGHT_NO_WAVES(vVar0, &uVar3) || func_36()) || func_35())
		{
			Local_95.f_1 = 4;
		}
	}
...
int func_35()
{
	if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2631.833f, 4526.624f, -10f, -380.1435f, 3906.702f, 78.484f, 1200f, 0, 1, 0))
	{
		return 1;
	}
	if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1731.902f, -123.8468f, 137.2596f, 2079.203f, 798.3421f, 249.3267f, 600f, 0, 1, 0))
	{
		return 1;
	}
	if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 252.5025f, 855.094f, 148.1213f, -393.3539f, 695.785f, 272.1867f, 500f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
int func_36()
{
	...
	while (iVar0 < 21)
	{
		if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), func_37(iVar0), 50f, 50f, 50f, 0, 1, 0))
		{
			return 1;
		}
		iVar0++;
...
int func_39()
{
	if ((!NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_3) && func_64(joaat("s_m_y_blackops_01"))) && NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_2))
	{
		if (func_72(Local_95.f_2))
		{
			if (func_40(&(Local_95.f_3), Local_95.f_2, 22, joaat("s_m_y_blackops_01"), -1, 1, 1, 1))
			{
				SET_PED_COMPONENT_VARIATION(NET_TO_PED(Local_95.f_3), 0, 0, 1, 0);
				SET_PED_COMPONENT_VARIATION(NET_TO_PED(Local_95.f_3), 2, 1, 0, 0);
				SET_PED_COMPONENT_VARIATION(NET_TO_PED(Local_95.f_3), 3, 0, 1, 0);
				SET_PED_COMPONENT_VARIATION(NET_TO_PED(Local_95.f_3), 4, 0, 2, 0);
				SET_PED_COMPONENT_VARIATION(NET_TO_PED(Local_95.f_3), 8, 1, 0, 0);
				SET_PED_COMPONENT_VARIATION(NET_TO_PED(Local_95.f_3), 9, 0, 0, 0);
				if (Global_1589819[PLAYER_ID() /*818*/] != 0)
				{
					SET_PED_RELATIONSHIP_GROUP_HASH(NET_TO_PED(Local_95.f_3), Global_1574987);
				}
				else
				{
					SET_PED_RELATIONSHIP_GROUP_HASH(NET_TO_PED(Local_95.f_3), Global_1574670[2 /*94*/][2 /*31*/][2 /*10*/][2 /*3*/][0]);
				}
				SET_PED_KEEP_TASK(NET_TO_PED(Local_95.f_3), 1);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(NET_TO_PED(Local_95.f_3), 1);
				SET_ENTITY_HEALTH(NET_TO_PED(Local_95.f_3), ROUND((200f * Global_262145.f_153)), 0);
				SET_PED_CAN_BE_DRAGGED_OUT(NET_TO_PED(Local_95.f_3), 0);
				SET_PED_CONFIG_FLAG(NET_TO_PED(Local_95.f_3), 255, 1);
			}
		}
	}
	if (!NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_3))
...
int func_41()
{
	...
	if (!NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_2))
	{
		...
		{
			if (!IS_BIT_SET(uLocal_214, 10))
			{
				func_61(&vLocal_910, &uLocal_913);
				if (TEST_PROBE_AGAINST_WATER(vLocal_910 + Vector(2f, 0f, 0f), vLocal_910 - Vector(10f, 0f, 0f), &vLocal_910))
				{
					if (func_45(vLocal_910, 6f, 1f, 1f, 5f, 1, 1, 1, 1123024896, 0, -1, 1, 0, 0, 0, 0, 0))
					{
						vVar4 = { vLocal_910 + Vector(12f, 0f, 0f) };
						iLocal_908 = START_SHAPE_TEST_BOX(vVar4, 10f, 10f, 25f, 0f, 0f, -1f, 2, 1, 0, 4);
						if (iLocal_908 == 0)
						{
							return 0;
						}
						...
						{
							SET_BIT(&uLocal_214, 10);
						}
					}
				}
			}
			else if (GET_SHAPE_TEST_RESULT(iLocal_908, &iLocal_909, &uVar0, &uVar0, &uVar3) == 2)
			{
				iLocal_908 = 0;
				if (iLocal_909 == 0)
				{
					...
					{
						_0x9737A37136F07E75(NET_TO_VEH(Local_95.f_2), 1);
						SET_VEHICLE_ENGINE_ON(NET_TO_VEH(Local_95.f_2), 1, 1, 0);
						SET_VEHICLE_FORWARD_SPEED(NET_TO_VEH(Local_95.f_2), 12f);
						_0x25367DE49D64CF16(NET_TO_VEH(Local_95.f_2), 1);
						_SET_ENTITY_SOMETHING(NET_TO_VEH(Local_95.f_2), 0);
					}
				}
				else
				{
					iLocal_909 = 0;
					CLEAR_BIT(&uLocal_214, 10);
				}
			}
			else if (GET_SHAPE_TEST_RESULT(iLocal_908, &iLocal_909, &uVar0, &uVar0, &uVar3) == 0)
			{
				iLocal_908 = 0;
				CLEAR_BIT(&uLocal_214, 10);
			}
	...
	if (DOES_ENTITY_EXIST(iVar1))
	{
		*uParam0 = VEH_TO_NET(iVar1);
		...
		if (NETWORK_DOES_NETWORK_ID_EXIST(*uParam0))
		{
			...
			func_43(vParam2, uParam5, iParam1, iVar1);
			return 1;
		}
	}
	return 0;
...
void func_43(vector3 vParam0, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	
	if (func_44(PLAYER_ID(), vParam0, iParam4) > -1)
	{
...
int func_44(var uParam0, vector3 vParam1, int iParam4)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
	...
	if (iParam4 && !bParam7)
	{
		if (func_3(PLAYER_ID(), 1, 1))
		{
			if (!IS_SCREEN_FADED_OUT())
			{
				...
				if (GET_DISTANCE_BETWEEN_COORDS(func_50(PLAYER_ID()), vParam0, 1) <= (fVar2 + fParam3))
				{
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != PLAYER_ID()))
				{
					if ((func_47(iVar1) || !bParam10) && !Global_2424047[iVar1 /*416*/].f_259)
					{
						...
						if (!bParam7)
						{
							...
							{
								if (GET_DISTANCE_BETWEEN_COORDS(func_50(iVar1), vParam0, 1) <= (fVar2 + fParam3))
								{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && PLAYER_ID() != iVar1) || iParam8 == 0)
		{
			if (func_3(iVar1, bParam4, bParam5))
			{
				...
				{
					if (!bParam7 || (!IS_PED_INJURED(GET_PLAYER_PED(iVar1)) && func_47(iVar1)))
					{
						if ((!bParam6 || (bParam6 == 1 && GET_PLAYER_TEAM(PLAYER_ID()) != GET_PLAYER_TEAM(iVar1))) || GET_PLAYER_TEAM(PLAYER_ID()) == -1)
						{
							...
							{
								if (GET_DISTANCE_BETWEEN_COORDS(func_51(iVar1), vParam0, 1) < fParam3)
								{
									return 1;
								}
							}
...
int func_60(var uParam0, var uParam1)
{
	...
	{
		Global_2505680 = { func_59(uParam0) };
		Global_2505693 = { func_59(uParam1) };
...
void func_61(var uParam0, var uParam1)
{
	...
	*uParam1 = GET_HEADING_FROM_VECTOR_2D((Local_95.f_10 - *uParam0), (Local_95.f_10.f_1 - uParam0->f_1));
}
...
Vector3 func_62(vector3 vParam0, float fParam3, float fParam4, float fParam5)
{
	...
	fVar3 = (fParam5 / 2f);
	vVar0 = { func_63(vVar0, GET_RANDOM_FLOAT_IN_RANGE(fParam3, fParam4)) };
...
Vector3 func_65(int iParam0)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			while (iVar0 <= 4)
			{
				fVar5 = GET_DISTANCE_BETWEEN_COORDS(Local_95.f_10, func_37(iVar0), 1);
				if (fVar5 < fVar6)
				{
					iVar1 = iVar0;
					fVar6 = fVar5;
...
int func_72(var uParam0)
{
	if (NETWORK_DOES_NETWORK_ID_EXIST(uParam0))
	{
		return !func_73(NET_TO_VEH(uParam0));
	}
	return 0;
}
...
void func_74()
{
	if (func_3(PLAYER_ID(), 1, 1))
	{
		if (Local_95.f_21 == 5)
		{
			vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 5;
		}
		switch (vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/].f_2)
		{
			case 0:
				func_97();
				if (Local_95.f_21 > 0)
				{
					vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 1;
				}
				break;
			...
			case 1:
				...
				{
					func_127();
					if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), NET_TO_VEH(Local_95.f_2), 0))
					{
						func_96();
						vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 3;
						CLEAR_PED_TASKS(PLAYER_PED_ID());
						CLEAR_BIT(&(vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/].f_1), 0);
					}
				}
				break;
			...
			case 2:
				if (func_72(Local_95.f_2))
				{
					...
					{
						vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 3;
						CLEAR_BIT(&(vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/].f_1), 5);
						SET_BIT(&(vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/].f_1), 6);
						if (Local_95.f_21 >= 4)
						{
							vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 4;
						}
					}
					else
					{
			...
			case 4:
				if (func_72(Local_95.f_2))
				{
					if (!IS_BIT_SET(uLocal_214, 3))
					{
						if (GET_ENTITY_SPEED(NET_TO_VEH(Local_95.f_2)) < 3f)
						{
							TASK_LEAVE_ANY_VEHICLE(PLAYER_PED_ID(), 0, 0);
							SET_BIT(&uLocal_214, 3);
						}
					}
					if ((!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), NET_TO_VEH(Local_95.f_2), 0) && !IS_PED_ON_SPECIFIC_VEHICLE(PLAYER_PED_ID(), NET_TO_VEH(Local_95.f_2))) && func_31(PLAYER_PED_ID(), NET_TO_VEH(Local_95.f_2), 1) >= 10f)
					{
						vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 5;
					}
				}
...
void func_75()
{
	...
	if (HAS_SCALEFORM_MOVIE_LOADED(uLocal_220))
	{
		if (func_90(1, 1))
		{
			if (((vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 1 || vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 2) || vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 3) || vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 4)
			{
				iVar0 = 1;
				Var1 = { func_89() };
				func_87(&uLocal_221);
				if (vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 1)
				{
					if (func_72(Local_95.f_2))
					{
						if ((IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), NET_TO_VEH(Local_95.f_2), 10f, 10f, 3f, 0, 1, 0) && !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0)) && !func_86(NET_TO_VEH(Local_95.f_2), 0))
						{
							func_85(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 23, 1), "BTX_ENTER", &uLocal_221, 0);
						}
					}
				}
				else
	...
	{
		uLocal_220 = REQUEST_SCALEFORM_MOVIE("instructional_buttons");
	}
}
			...
			while (iVar0 < uParam2->f_680)
			{
				if (IS_BIT_SET(uParam2->f_676, iVar0))
				{
					...
					if (!IS_BIT_SET(uParam2->f_677, iVar0))
					{
						...
						func_80(GET_CONTROL_INSTRUCTIONAL_BUTTON(uVar1, uVar2, 1));
						if (iVar3 < 359)
						{
							func_80(GET_CONTROL_INSTRUCTIONAL_BUTTON(uVar1, iVar3, 1));
						}
					}
					else
					{
						...
						func_80(_0x80C2FD58D720C801(uVar4, uVar5, 1));
					}
...
void func_96()
{
	if (DOES_BLIP_EXIST(uLocal_216))
	{
		REMOVE_BLIP(&uLocal_216);
	}
}
...
void func_100()
{
	if (!func_4(Local_95.f_3) && func_72(Local_95.f_2))
	{
		if (NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_95.f_3) || (!_NETWORK_CAN_NETWORK_ID_BE_SEEN(Local_95.f_3) && NETWORK_IS_HOST_OF_THIS_SCRIPT()))
		{
			func_125();
			func_104();
			if (func_103(Local_95.f_3))
			{
				SET_PED_RESET_FLAG(NET_TO_PED(Local_95.f_3), 323, 1);
			}
			switch (Local_95.f_20)
			{
				case 0:
				...
				case 2:
					if (GET_SCRIPT_TASK_STATUS(NET_TO_PED(Local_95.f_3), -1273030092) != 1 && GET_SCRIPT_TASK_STATUS(NET_TO_PED(Local_95.f_3), -1273030092) != 0)
					{
						TASK_BOAT_MISSION(NET_TO_PED(Local_95.f_3), NET_TO_VEH(Local_95.f_2), 0, PLAYER_PED_ID(), 0f, 0f, 0f, 4, 12f, 786469, 10f, 1071);
					}
					break;
				
				case 4:
					func_102(GET_ENTITY_COORDS(NET_TO_VEH(Local_95.f_2), 0), Local_95.f_7);
					_0x07FB139B592FA687(fLocal_1085, fLocal_1087, fLocal_1086, fLocal_1088);
					if (_0xF7B79A50B905A30D(fLocal_1085, fLocal_1087, fLocal_1086, fLocal_1088))
					{
						if (GET_SCRIPT_TASK_STATUS(NET_TO_PED(Local_95.f_3), 242628503) != 1 && GET_SCRIPT_TASK_STATUS(NET_TO_PED(Local_95.f_3), 242628503) != 0)
						{
							TASK_PERFORM_SEQUENCE(NET_TO_PED(Local_95.f_3), uLocal_219);
						}
					}
					break;
				...
				case 5:
					if (GET_SCRIPT_TASK_STATUS(NET_TO_PED(Local_95.f_3), -1273030092) != 1 && GET_SCRIPT_TASK_STATUS(NET_TO_PED(Local_95.f_3), -1273030092) != 0)
					{
						TASK_VEHICLE_MISSION_COORS_TARGET(NET_TO_PED(Local_95.f_3), NET_TO_VEH(Local_95.f_2), GET_ENTITY_COORDS(NET_TO_VEH(Local_95.f_2), 1), 5, 5f, 1076625579, 2f, 1f, 1);
					}
					break;
				...
				case 1:
					if (!IS_BIT_SET(vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/].f_1, 7))
					{
						if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), NET_TO_VEH(Local_95.f_2), 0) || IS_PED_ON_SPECIFIC_VEHICLE(PLAYER_PED_ID(), NET_TO_VEH(Local_95.f_2)))
						{
							SET_PED_DIES_IN_WATER(NET_TO_PED(Local_95.f_3), 0);
							SET_PED_DIES_INSTANTLY_IN_WATER(NET_TO_PED(Local_95.f_3), 0);
							SET_PED_FLEE_ATTRIBUTES(NET_TO_PED(Local_95.f_3), 2, 0);
							TASK_PERFORM_SEQUENCE(NET_TO_PED(Local_95.f_3), uLocal_217);
						}
						else
						{
							SET_PED_DIES_IN_WATER(NET_TO_PED(Local_95.f_3), 0);
							SET_PED_DIES_INSTANTLY_IN_WATER(NET_TO_PED(Local_95.f_3), 0);
							SET_PED_FLEE_ATTRIBUTES(NET_TO_PED(Local_95.f_3), 2, 1);
							TASK_PERFORM_SEQUENCE(NET_TO_PED(Local_95.f_3), uLocal_218);
						}
						SET_BIT(&(vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/].f_1), 7);
					}
					break;
...
void func_102(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)
{
	if (Param0 < Param3)
	{
...
void func_104()
{
	...
	if (!IS_BIT_SET(uLocal_214, 4))
	{
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), NET_TO_PED(Local_95.f_3), 15f, 15f, 15f, 0, 1, 0))
		{
			func_124(&uLocal_914, 8, NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
			if (func_108(&uLocal_914, "FMAMBAU", "FMA_BPDA", 12, 0, 0, 1))
			{
				TASK_LOOK_AT_ENTITY(NET_TO_PED(Local_95.f_3), PLAYER_PED_ID(), 5000, 0, 2);
				SET_BIT(&uLocal_214, 4);
			}
		}
	}
	if (!IS_BIT_SET(uLocal_214, 6))
	{
		if (Local_95.f_20 == 4)
		{
			func_124(&uLocal_914, 8, NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
			...
			{
				TASK_LOOK_AT_ENTITY(NET_TO_PED(Local_95.f_3), PLAYER_PED_ID(), 5000, 0, 2);
				SET_BIT(&uLocal_214, 6);
			}
		}
	}
	if (!IS_BIT_SET(uLocal_214, 5))
	{
		if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), Local_95.f_7, (10f * 2f), (10f * 2f), (10f * 2f), 0, 1, 0))
		{
			func_124(&uLocal_914, 8, NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
			if (func_108(&uLocal_914, "FMAMBAU", "FMA_BPDA6", 12, 0, 0, 1))
			{
				TASK_LOOK_AT_ENTITY(NET_TO_PED(Local_95.f_3), PLAYER_PED_ID(), 5000, 0, 2);
				SET_BIT(&uLocal_214, 5);
			}
		}
	}
	if (!IS_BIT_SET(uLocal_214, 7))
	{
		if (Local_95.f_20 == 5)
		{
			func_124(&uLocal_914, 8, NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
			...
			{
				TASK_LOOK_AT_ENTITY(NET_TO_PED(Local_95.f_3), PLAYER_PED_ID(), 5000, 0, 2);
				SET_BIT(&uLocal_214, 7);
			}
		}
	}
	if (!IS_BIT_SET(uLocal_214, 8))
	{
		func_124(&uLocal_914, 8, NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
	...
	if (Local_95.f_20 == 4)
	{
		if (GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) <= 0)
		{
			if (func_68(&uLocal_1083, iLocal_1082, 0))
			{
				...
				StringCopy(&Var1, "", 16);
				if (!IS_BIT_SET(uLocal_215, iVar0))
				{
					switch (iVar0)
					{
						case 0:
					...
					if (!IS_STRING_NULL_OR_EMPTY(&Var1))
					{
						...
						if (func_108(&uLocal_914, "FMAMBAU", &Var1, 12, 0, 0, 1))
						{
							...
							SET_BIT(&uLocal_215, iVar0);
							TASK_LOOK_AT_ENTITY(NET_TO_PED(Local_95.f_3), PLAYER_PED_ID(), 5000, 0, 2);
							iLocal_1082 = (GET_RANDOM_INT_IN_RANGE(20000, 30001) + iVar0 * 500);
						}
					}
				}
			}
	...
	if (!func_4(Local_95.f_3))
	{
		if (func_72(Local_95.f_2))
		{
			if (!IS_AMBIENT_SPEECH_PLAYING(NET_TO_PED(Local_95.f_3)) && !IS_SCRIPTED_SPEECH_PLAYING(NET_TO_PED(Local_95.f_3)))
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(NET_TO_VEH(Local_95.f_2), PLAYER_PED_ID(), 1) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(NET_TO_PED(Local_95.f_3), PLAYER_PED_ID(), 1))
				{
					switch (GET_RANDOM_INT_IN_RANGE(0, 6))
					{
						case 0:
							func_105(NET_TO_PED(Local_95.f_3), "GENERIC_SHOCKED_MED", 3);
							break;
						
						case 1:
							func_105(NET_TO_PED(Local_95.f_3), "GENERIC_SHOCKED_HIGH", 3);
							break;
						
						case 2:
							func_105(NET_TO_PED(Local_95.f_3), "GENERIC_FRIGHTENED_MED", 3);
							break;
						
						case 3:
							func_105(NET_TO_PED(Local_95.f_3), "GENERIC_FRIGHTENED_HIGH", 3);
							break;
						
						case 4:
							func_105(NET_TO_PED(Local_95.f_3), "GENERIC_CURSE_MED", 3);
							break;
						
						case 5:
							func_105(NET_TO_PED(Local_95.f_3), "GENERIC_CURSE_HIGH", 3);
							break;
					}
					CLEAR_ENTITY_LAST_DAMAGE_ENTITY(NET_TO_VEH(Local_95.f_2));
					CLEAR_ENTITY_LAST_DAMAGE_ENTITY(NET_TO_PED(Local_95.f_3));
				}
			}
			else
			{
...
void func_116()
{
	...
	{
		if (func_119(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
			iVar0 = func_118(PLAYER_PED_ID());
...
void func_124(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_125()
{
	...
	if (func_3(PLAYER_ID(), 1, 1))
	{
		if (IS_PED_SITTING_IN_VEHICLE(PLAYER_PED_ID(), NET_TO_VEH(Local_95.f_2)) && !func_126(PLAYER_PED_ID(), NET_TO_VEH(Local_95.f_2), -1))
		{
...
void func_127()
{
	if (!DOES_BLIP_EXIST(uLocal_216))
	{
		if (func_72(Local_95.f_2))
		{
			uLocal_216 = ADD_BLIP_FOR_ENTITY(NET_TO_VEH(Local_95.f_2));
			SET_BLIP_SPRITE(uLocal_216, 356);
			SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_216, "BTX_BLIP");
			SET_BLIP_FLASHES(uLocal_216, 1);
			SET_BLIP_CATEGORY(uLocal_216, 6);
		}
	}
}
...
void func_128()
{
	if (func_72(Local_95.f_2))
	{
		OPEN_SEQUENCE_TASK(&uLocal_219);
		TASK_BOAT_MISSION(0, NET_TO_VEH(Local_95.f_2), 0, 0, Local_95.f_7, 4, 12f, 786469, 10f, 1071);
		CLOSE_SEQUENCE_TASK(uLocal_219);
		OPEN_SEQUENCE_TASK(&uLocal_218);
		TASK_VEHICLE_MISSION_COORS_TARGET(0, NET_TO_VEH(Local_95.f_2), Local_95.f_13, 4, 12f, 786469, 0f, 0f, 1);
		TASK_VEHICLE_DRIVE_WANDER(0, NET_TO_VEH(Local_95.f_2), 12f, 786469);
		CLOSE_SEQUENCE_TASK(uLocal_218);
		OPEN_SEQUENCE_TASK(&uLocal_217);
		...
		CLOSE_SEQUENCE_TASK(uLocal_217);
	}
}
...
void func_143()
{
	...
	if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (Local_95.f_20 == 7)
		{
			...
			if (NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_2))
			{
				if (NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_95.f_2))
				{
					func_101(&(Local_95.f_2));
				}
			}
			if (NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_3))
			{
				if (NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_95.f_3))
				{
					func_101(&(Local_95.f_3));
				}
			}
	...
	func_145();
	SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_220);
	func_144();
}
...
void func_145()
{
	CLEAR_SEQUENCE_TASK(&uLocal_217);
	CLEAR_SEQUENCE_TASK(&uLocal_218);
	CLEAR_SEQUENCE_TASK(&uLocal_219);
}
...
int func_148(struct<21> Param0)
{
	...
	func_150(0, -1, 0);
	NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_95, 22);
	...
	SET_BIT(&uLocal_214, 8);
	iLocal_1079 = NETWORK_IS_IN_TUTORIAL_SESSION();
	vLocal_117[PARTICIPANT_ID_TO_INT() /*3*/] = 0;
	return 1;
}
