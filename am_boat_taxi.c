	...
	while (true)
	{
		...
		switch (func_125(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			...
			case 1:
				...
				{
					if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(NETWORK::NET_TO_VEH(Local_95.f_2), 1), 200f, 200f, 200f, false, true, 0))
					{
...
void func_10(int iParam0)
{
	...
	if (iParam0 != -1)
	{
		...
		func_11(&(Global_4262188[iParam0 /*80*/]));
	}
}
...
int func_15(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9)
{
	int iVar0;
...
bool func_22()
{
	return MISC::IS_BIT_SET(func_23(6420, -1, 0), 19);
}
...
int func_23(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_24(iParam1)];
...
void func_27()
{
	...
	if (!func_4(Local_95.f_3) && func_67(Local_95.f_2))
	{
		...
		switch (Local_95.f_20)
		{
			...
			case 5:
				if ((VEHICLE::GET_VEHICLE_NUMBER_OF_PASSENGERS(NETWORK::NET_TO_VEH(Local_95.f_2)) <= 0 && !PED::IS_PED_ON_SPECIFIC_VEHICLE(PLAYER::PLAYER_PED_ID(), NETWORK::NET_TO_VEH(Local_95.f_2))) && func_28(PLAYER::PLAYER_PED_ID(), NETWORK::NET_TO_VEH(Local_95.f_2), 1) >= 10f)
				{
					Local_95.f_20 = 6;
				}
				break;
			...
			case 1:
				if (BRAIN::GET_SCRIPT_TASK_STATUS(NETWORK::NET_TO_PED(Local_95.f_3), 242628503) == 1 && func_28(PLAYER::PLAYER_PED_ID(), NETWORK::NET_TO_PED(Local_95.f_3), 1) >= 10f)
				{
					Local_95.f_20 = 7;
				}
				break;
...
float func_28(int iParam0, int iParam1, bool bParam2)
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_31()
{
	...
	if ((Local_95.f_21 <= 2 || Local_95.f_20 == 2) || Local_95.f_20 == 3)
	{
		...
		if ((!WATER::GET_WATER_HEIGHT_NO_WAVES(vVar0, &uVar1) || func_33()) || func_32())
		{
			Local_95.f_1 = 4;
		}
	}
...
int func_33()
{
	...
	while (iVar0 < 21)
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_34(iVar0), 50f, 50f, 50f, false, true, 0))
		{
			return 1;
		}
		iVar0++;
...
int func_36()
{
	if ((!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_3) && func_59(joaat("s_m_y_blackops_01"))) && NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_2))
	{
		if (func_67(Local_95.f_2))
		{
			if (func_37(&(Local_95.f_3), Local_95.f_2, 22, joaat("s_m_y_blackops_01"), -1, 1, 1, 1))
			{
				...
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(NETWORK::NET_TO_PED(Local_95.f_3), Global_1574801);
				}
				else
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(NETWORK::NET_TO_PED(Local_95.f_3), Global_1574484[2 /*94*/][2 /*31*/][2 /*10*/][2 /*3*/][0]);
				}
...
int func_37(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
...
int func_39(var uParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	float fVar0;
	int iVar1;
...
int func_40(vector3 vParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, bool bParam6, int iParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, float fParam12, bool bParam13, float fParam14, bool bParam15, int iParam16)
{
...
int func_41(vector3 vParam0, float fParam1, int iParam2, int iParam3, float fParam4, bool bParam5, int iParam6, float fParam7, bool bParam8)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar0 < 32)
	{
		...
		if (func_3(iVar1, 1, 1))
		{
			if (!func_43(iVar1, 0) && NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER::PLAYER_ID(), iVar1))
			{
				if (iParam2 == 1 || (iParam2 == 0 && iVar1 != PLAYER::PLAYER_ID()))
				{
					if ((func_42(iVar1) || !bParam8) && !Global_2423644[iVar1 /*406*/].f_255)
					{
						fVar2 = fParam4;
						if (fParam7 > 0f)
						{
...
Vector3 func_45(int iParam0)
{
	...
	iVar0 = iParam0;
	if ((func_48() && Global_1589291[iVar0 /*770*/].f_746) && !func_47(Global_1589291[iVar0 /*770*/].f_747))
	{
...
int func_49(vector3 vParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, var uParam7)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam6 == 1 && PLAYER::PLAYER_ID() != iVar1) || iParam6 == 0)
		{
			if (func_3(iVar1, bParam2, bParam3))
			{
				...
				{
					if (!bParam5 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_42(iVar1)))
					{
						if ((!bParam4 || (bParam4 == 1 && PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) != PLAYER::GET_PLAYER_TEAM(iVar1))) || PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID()) == -1)
						{
							...
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_46(iVar1), vParam0, true) < fParam1)
								{
									return 1;
								}
							}
...
int func_50(int iParam0)
{
	...
	Global_2498829 = { func_54(iParam0) };
...
int func_55(int iParam0, int iParam1)
{
	...
	{
		Global_2498829 = { func_54(iParam0) };
		Global_2498842 = { func_54(iParam1) };
...
Vector3 func_57(vector3 vParam0, float fParam1, float fParam2, float fParam3)
{
	vector3 vVar0;
	float fVar1;
	...
	fVar1 = (fParam3 / 2f);
	vVar0 = { func_58(vVar0, MISC::GET_RANDOM_FLOAT_IN_RANGE(fParam1, fParam2)) };
	vVar0.z = MISC::GET_RANDOM_FLOAT_IN_RANGE(-fVar1, fVar1);
	return vParam0 + vVar0;
}

Vector3 func_58(vector3 vParam0, float fParam1)
{
	float fVar0;
...
Vector3 func_60(int iParam0)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			while (iVar0 <= 4)
			{
				fVar3 = MISC::GET_DISTANCE_BETWEEN_COORDS(Local_95.f_10, func_34(iVar0), true);
				if (fVar3 < fVar4)
				{
					iVar1 = iVar0;
					fVar4 = fVar3;
...
int func_62()
{
	...
	vVar0 = { func_46(PLAYER::PLAYER_ID()) };
...
int func_67(int iParam0)
{
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iParam0))
	{
		return !func_68(NETWORK::NET_TO_VEH(iParam0));
	}
	return 0;
}
		...
		switch (vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2)
		{
			...
			case 4:
				if (func_67(Local_95.f_2))
				{
					...
					if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), NETWORK::NET_TO_VEH(Local_95.f_2), 0) && !PED::IS_PED_ON_SPECIFIC_VEHICLE(PLAYER::PLAYER_PED_ID(), NETWORK::NET_TO_VEH(Local_95.f_2))) && func_28(PLAYER::PLAYER_PED_ID(), NETWORK::NET_TO_VEH(Local_95.f_2), 1) >= 10f)
					{
						vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 5;
					}
				}
...
void func_70()
{
		...
		if (func_85(1, 1))
		{
			if (((vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 1 || vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 2) || vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 3) || vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 4)
			{
				...
				if (vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 1)
				{
					if (func_67(Local_95.f_2))
					{
						if ((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), NETWORK::NET_TO_VEH(Local_95.f_2), 10f, 10f, 3f, 0, 1, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !func_81(NETWORK::NET_TO_VEH(Local_95.f_2), 0))
						{
							func_80(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 23, true), "BTX_ENTER", &uLocal_104, 0);
						}
					}
				}
				else
	...
	{
		iLocal_103 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("instructional_buttons");
	}
}
			...
			while (iVar0 < uParam2->f_680)
			{
				if (MISC::IS_BIT_SET(uParam2->f_676, iVar0))
				{
					...
					if (!MISC::IS_BIT_SET(uParam2->f_677, iVar0))
					{
						...
						func_75(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(iVar1, iVar2, true));
						if (iVar3 < 358)
						{
							func_75(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(iVar1, iVar3, true));
						}
					}
					else
					{
						...
						func_75(PAD::_0x80C2FD58D720C801(iVar4, iVar5, true));
					}
...
void func_80(char* sParam0, char* sParam1, var uParam2, char* sParam3)
{
	int iVar0;
...
void func_93(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_24(iParam2)];
	if (iVar0 != 0)
	{
	...
	if (!func_4(Local_95.f_3) && func_67(Local_95.f_2))
	{
		if (NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_95.f_3) || (!NETWORK::_0xA1607996431332DF(Local_95.f_3) && NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT()))
		{
			...
			switch (Local_95.f_20)
			{
				...
				case 4:
					func_97(ENTITY::GET_ENTITY_COORDS(NETWORK::NET_TO_VEH(Local_95.f_2), 0), Local_95.f_7);
					...
					if (PATHFIND::_0xF7B79A50B905A30D(fLocal_966, fLocal_968, fLocal_967, fLocal_969))
					{
						...
						{
							BRAIN::TASK_PERFORM_SEQUENCE(NETWORK::NET_TO_PED(Local_95.f_3), iLocal_102);
						}
					}
					break;
				...
				case 1:
					if (!MISC::IS_BIT_SET(vLocal_96[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1, 7))
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), NETWORK::NET_TO_VEH(Local_95.f_2), 0) || PED::IS_PED_ON_SPECIFIC_VEHICLE(PLAYER::PLAYER_PED_ID(), NETWORK::NET_TO_VEH(Local_95.f_2)))
						{
							...
							BRAIN::TASK_PERFORM_SEQUENCE(NETWORK::NET_TO_PED(Local_95.f_3), iLocal_100);
						}
						else
						{
							PED::SET_PED_DIES_IN_WATER(NETWORK::NET_TO_PED(Local_95.f_3), 0);
							...
							BRAIN::TASK_PERFORM_SEQUENCE(NETWORK::NET_TO_PED(Local_95.f_3), iLocal_101);
						}
...
void func_97(struct<2> Param0, float fParam1, struct<2> Param2, var uParam3)
{
	if (Param0 < Param2)
	{
...
void func_99()
{
	...
	if (!MISC::IS_BIT_SET(iLocal_97, 4))
	{
		...
		{
			func_119(&uLocal_795, 8, NETWORK::NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
		...
		if (func_67(Local_95.f_2))
		{
			if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(NETWORK::NET_TO_PED(Local_95.f_3)) && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(NETWORK::NET_TO_PED(Local_95.f_3)))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(NETWORK::NET_TO_VEH(Local_95.f_2), PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(NETWORK::NET_TO_PED(Local_95.f_3), PLAYER::PLAYER_PED_ID(), 1))
				{
					...
					{
						case 0:
							func_100(NETWORK::NET_TO_PED(Local_95.f_3), "GENERIC_SHOCKED_MED", 3);
							break;
						
						case 1:
							func_100(NETWORK::NET_TO_PED(Local_95.f_3), "GENERIC_SHOCKED_HIGH", 3);
							break;
						
						case 2:
							func_100(NETWORK::NET_TO_PED(Local_95.f_3), "GENERIC_FRIGHTENED_MED", 3);
							break;
						
						case 3:
							func_100(NETWORK::NET_TO_PED(Local_95.f_3), "GENERIC_FRIGHTENED_HIGH", 3);
							break;
						
						case 4:
							func_100(NETWORK::NET_TO_PED(Local_95.f_3), "GENERIC_CURSE_MED", 3);
							break;
						
						case 5:
							func_100(NETWORK::NET_TO_PED(Local_95.f_3), "GENERIC_CURSE_HIGH", 3);
							break;
					}
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_101(iParam2), 1);
}
...
void func_111()
{
	...
	{
		if (func_114(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_113(PLAYER::PLAYER_PED_ID());
			if (func_112(iVar0) && (!func_115(14) || Global_104171))
			{
				if (Global_105220.f_2354.f_539.f_4301 != iVar0 && func_112(Global_105220.f_2354.f_539.f_4301))
				{
...
void func_118(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)
{
...
void func_120()
{
	...
	if (func_3(PLAYER::PLAYER_ID(), 1, 1))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), NETWORK::NET_TO_VEH(Local_95.f_2)) && !func_121(PLAYER::PLAYER_PED_ID(), NETWORK::NET_TO_VEH(Local_95.f_2), -1))
		{
...
void func_123()
{
	if (func_67(Local_95.f_2))
	{
		...
		BRAIN::OPEN_SEQUENCE_TASK(&iLocal_101);
		...
		BRAIN::CLOSE_SEQUENCE_TASK(iLocal_101);
		BRAIN::OPEN_SEQUENCE_TASK(&iLocal_100);
		...
		BRAIN::CLOSE_SEQUENCE_TASK(iLocal_100);
	}
}
...
void func_139()
{
	BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_100);
	BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_101);
...
void func_146(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_138();
