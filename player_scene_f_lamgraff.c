...
int func_2()
{
	...
	if (!PED::IS_PED_INJURED(Global_92619))
	{
		...
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_92619, &sLocal_271, &cLocal_303, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_92619))
				{
					BRAIN::STOP_ANIM_PLAYBACK(Global_92619, 0, 0);
					BRAIN::CLEAR_PED_TASKS(Global_92619);
					return 0;
				}
...
int func_20()
{
	...
	if (!PED::IS_PED_INJURED(Global_92619))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_267))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_92619, &sLocal_271, &cLocal_287, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_92619))
				{
					BRAIN::STOP_ANIM_PLAYBACK(Global_92619, 0, 0);
				...
				else
				{
					...
					BRAIN::TASK_SYNCHRONIZED_SCENE(Global_92619, iLocal_312, &sLocal_271, &cLocal_303, 8f, -8f, 257, 0, 8f, 0);
					return 1;
				}
			}
			else
			{
				...
				{
					BRAIN::CLEAR_PED_TASKS(Global_92619);
					PED::_RESET_PED_RAGDOLL_BLOCKING_FLAGS(Global_92619, 16);
					if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_312))
					{
						iLocal_312 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_269, 0f, 0f, fLocal_270, 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_312, true);
...
void func_31()
{
	...
	while (!ENTITY::DOES_ENTITY_EXIST(Global_92619) || !STREAMING::HAS_MODEL_LOADED(iLocal_268))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_92619))
	{
		if (!PED::IS_PED_INJURED(Global_92619))
		{
			BRAIN::TASK_STAND_STILL(Global_92619, -1);
		}
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_92619, 1862763509);
	}
	ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_92619, true, 1);
	PED::SET_PED_CONFIG_FLAG(Global_92619, 132, true);
	PED::_SET_PED_RAGDOLL_BLOCKING_FLAGS(Global_92619, 16);
	func_33(&Global_92619, Global_87982);
	func_32(&uLocal_100, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	iLocal_267 = OBJECT::CREATE_OBJECT(iLocal_268, ENTITY::GET_ENTITY_COORDS(Global_92619, 1), true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_267, Global_92619, PED::GET_PED_BONE_INDEX(Global_92619, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
}
