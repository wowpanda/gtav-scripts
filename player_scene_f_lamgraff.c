...
int func_2()
{
	...
	{
		if (DOES_ENTITY_EXIST(uLocal_271))
		{
			if (IS_ENTITY_PLAYING_ANIM(Global_93403, &sLocal_277, &cLocal_309, 3))
			{
				if (IS_ENTITY_ON_FIRE(Global_93403))
				{
					STOP_ANIM_PLAYBACK(Global_93403, 0, 0);
					CLEAR_PED_TASKS(Global_93403);
					return 0;
				}
				fVar0 = GET_SYNCHRONIZED_SCENE_PHASE(iLocal_325);
				if (!iLocal_270)
				{
				...
				if (fVar0 < 0.2812f)
				{
					if (iLocal_326 != 0)
					{
						STOP_PARTICLE_FX_LOOPED(iLocal_326, 0);
						iLocal_326 = 0;
					}
				}
				else if (fVar0 < 0.4778f)
				{
					if (iLocal_326 == 0)
					{
						iLocal_326 = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_lamgraff_paint_spray", uLocal_271, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
						SET_PARTICLE_FX_LOOPED_COLOUR(iLocal_326, fLocal_327, fLocal_328, fLocal_329, 0);
					}
				}
...
int func_20()
{
	...
	if (!IS_PED_INJURED(Global_93403))
	{
		if (DOES_ENTITY_EXIST(uLocal_271))
		{
			if (IS_ENTITY_PLAYING_ANIM(Global_93403, &sLocal_277, &cLocal_293, 3))
			{
				if (IS_ENTITY_ON_FIRE(Global_93403))
				{
					STOP_ANIM_PLAYBACK(Global_93403, 0, 0);
				...
				else
				{
					...
					{
						iLocal_325 = CREATE_SYNCHRONIZED_SCENE(vLocal_273, 0f, 0f, uLocal_276, 2);
						SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_325, 1);
					}
					TASK_SYNCHRONIZED_SCENE(Global_93403, iLocal_325, &sLocal_277, &cLocal_309, 8f, -8f, 257, 0, 8f, 0);
					return 1;
				}
			}
			else
			{
				...
				{
					CLEAR_PED_TASKS(Global_93403);
					_RESET_PED_RAGDOLL_BLOCKING_FLAGS(Global_93403, 16);
					if (!IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_325))
					{
						iLocal_325 = CREATE_SYNCHRONIZED_SCENE(vLocal_273, 0f, 0f, uLocal_276, 2);
						SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_325, 1);
...
void func_31()
{
	REQUEST_MODEL(iLocal_272);
	REQUEST_PTFX_ASSET();
	while (!DOES_ENTITY_EXIST(Global_93403) || !HAS_MODEL_LOADED(iLocal_272))
	{
		WAIT(0);
	}
	...
	if (DOES_ENTITY_EXIST(Global_93403))
	{
		if (!IS_PED_INJURED(Global_93403))
		{
			TASK_STAND_STILL(Global_93403, -1);
		}
		SET_PED_RELATIONSHIP_GROUP_HASH(Global_93403, 1862763509);
	}
	SET_ENTITY_AS_MISSION_ENTITY(Global_93403, 1, 1);
	SET_PED_CONFIG_FLAG(Global_93403, 132, 1);
	_SET_PED_RAGDOLL_BLOCKING_FLAGS(Global_93403, 16);
	func_33(&Global_93403, Global_88716);
	func_32(&uLocal_104, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	uLocal_271 = CREATE_OBJECT(iLocal_272, GET_ENTITY_COORDS(Global_93403, 1), 1, 1, 0);
	ATTACH_ENTITY_TO_ENTITY(uLocal_271, Global_93403, GET_PED_BONE_INDEX(Global_93403, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
}

void func_32(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_34()
{
	...
	func_40(iLocal_103, &vLocal_273, &uLocal_276, &cVar0);
	...
	func_37(Var8, &Var117);
	func_35(iLocal_103, &sLocal_277, &cVar237, &cLocal_293, &uVar253, &uVar254);
...
int func_37(struct<109> Param0, var uParam109)
{
	uParam109->f_119 = 0;
	switch (Param0.f_2)
	{
...
void func_38(var uParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, float fParam7)
{
