	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != 4294967295)
		{
			if (Global_19AC5[Var0 /*10*/].f_9 != 4294967295)
			{
				...
				func_257(&(Global_19AC5[Var0 /*10*/].f_9));
			}
		}
		func_244(&Var0, 1);
	}
...
void func_47(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3711
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x38B1
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x38E3
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x3917
{
	return Global_1407E0;
}

int func_51(int iParam0, int iParam1)//Position - 0x3923
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x394F
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3E97
{
	int iVar0;
...
bool func_107(bool bParam0)//Position - 0x84EE
{
...
struct<2> func_108(int iParam0)//Position - 0x8519
{
	struct<2> Var0;
...
void func_109(int iParam0, var uParam1)//Position - 0x8965
{
	switch (iParam0)
	{
		case 0:
...
int func_111(int iParam0)//Position - 0x9BAB
{
	switch (iParam0)
	{
		case 0:
...
int func_112(int iParam0)//Position - 0x9EF1
{
	int iVar0;
...
void func_113(int iParam0)//Position - 0x9F95
{
	struct<2> Var0;
...
void func_114(int iParam0)//Position - 0xA030
{
	if (iParam0 < 63)
	{
		func_115();
...
void func_116(int iParam0)//Position - 0xA08E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_117(int iParam0)//Position - 0xA0E7
{
...
int func_118(int iParam0)//Position - 0xA16A
{
	int iVar0;
...
void func_119(int iParam0, int iParam1, int iParam2)//Position - 0xA19B
{
	func_120(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_120(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA1B0
{
	int iVar0;
...
int func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA263
{
...
int func_123(int iParam0, int iParam1, int iParam2)//Position - 0xA27E
{
	int iVar0;
...
int func_124(int iParam0)//Position - 0xA2CA
{
	int iVar0;
...
int func_125(int iParam0)//Position - 0xA313
{
	if (func_126(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_126(int iParam0)//Position - 0xA333
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_127(int iParam0)//Position - 0xA354
{
	switch (iParam0)
	{
		case 5:
...
int func_129(int iParam0)//Position - 0xA424
{
	switch (iParam0)
	{
		case 5:
...
void func_130(var uParam0, bool bParam1, bool bParam2)//Position - 0xA477
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0xA56C
{
	switch (iParam0)
	{
		case 5:
...
void func_132(bool bParam0)//Position - 0xA5D7
{
	int iVar0;
...
void func_133(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA614
{
	if (bParam0)
	{
...
int func_136(int iParam0, bool bParam1)//Position - 0xA7A5
{
	int iVar0;
	int iVar1;
...
int func_137(int iParam0)//Position - 0xA7E6
{
...
bool func_138()//Position - 0xA828
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_240006, 3);
}

int func_139(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA839
{
	int iVar0;
...
void func_141(int iParam0)//Position - 0xA893
{
	if (iParam0 == 1)
	{
...
int func_142(char* sParam0)//Position - 0xA8B6
{
...
void func_143()//Position - 0xA8F3
{
	Global_3960 = 0;
	func_144();
}

void func_144()//Position - 0xA903
{
...
int func_148(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA9E9
{
...
void func_149(int iParam0)//Position - 0xAB78
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_151(int iParam0)//Position - 0xABF5
{
	if (func_155())
	{
		return;
...
void func_152(int iParam0)//Position - 0xAC28
{
	if (func_155())
	{
		return;
...
void func_153(bool bParam0, bool bParam1)//Position - 0xACA2
{
	if (bParam0)
	{
		if (func_154(0))
...
int func_154(int iParam0)//Position - 0xAD16
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
bool func_155()//Position - 0xAD70
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

int func_156(int iParam0)//Position - 0xAD82
{
...
int func_157(int iParam0)//Position - 0xADC3
{
	int iVar0;
...
void func_158(int iParam0)//Position - 0xAE08
{
...
int func_159(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAE3A
{
	int iVar0;
...
void func_160(var uParam0, int iParam1)//Position - 0xAF71
{
	int iVar0;
...
bool func_161(int iParam0)//Position - 0xAFC0
{
	return func_162(iParam0, Global_8D15);
}

int func_162(int iParam0, int iParam1)//Position - 0xAFD1
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_163(int iParam0)//Position - 0xB1B2
{
	if (Global_8D15 == 15)
	{
		return 0;
...
int func_164()//Position - 0xB1D4
{
	return func_165(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_165(char* sParam0, int iParam1)//Position - 0xB1E5
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_167(var uParam0, int iParam1)//Position - 0xB252
{
	switch (uParam0->f_10)
	{
		case 0:
...
void func_168()//Position - 0xBA35
{
	func_27(&(Global_17998.f_B3B), &Global_17998, 0, 1, 1, 0);
}

int func_169(var uParam0)//Position - 0xBA50
{
	float fVar0;
...
void func_170(int iParam0, int iParam1)//Position - 0xBADE
{
	if (iParam0 == 1)
	{
		if (!func_129(iParam1))
...
int func_171(bool bParam0)//Position - 0xBB42
{
	int iVar0;
...
int func_172(int iParam0)//Position - 0xBBD9
{
	if (func_126(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
int func_173(int iParam0)//Position - 0xBC03
{
	int iVar0;
...
var func_174()//Position - 0xC322
{
	return Global_16C57.f_1;
}

int func_175()//Position - 0xC330
{
...
bool func_178()//Position - 0xC39A
{
	return Global_16C64.f_148 > 0;
}

bool func_179(int iParam0, int iParam1)//Position - 0xC3AB
{
	switch (iParam0)
	{
		case 5:
...
var func_180()//Position - 0xC3E6
{
	return Global_140859;
}

int func_181()//Position - 0xC3F2
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_182(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xC40E
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
...
void func_183(int iParam0, bool bParam1)//Position - 0xC4FF
{
	if (iParam0 == 4294967295)
	{
		return;
...
int func_184(int iParam0)//Position - 0xC53B
{
	if (Global_11621 == iParam0)
	{
...
void func_185(int iParam0, int iParam1)//Position - 0xC574
{
	bool bVar0;
	int iVar1;
...
float func_186(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xC612
{
	vector3 vVar0;
...
bool func_187()//Position - 0xC64C
{
	return Global_1620C;
}

void func_188(int iParam0)//Position - 0xC658
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_189(iParam0);
...
void func_189(int iParam0)//Position - 0xC66F
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_190(int iParam0)//Position - 0xC757
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_164();
...
int func_191(var uParam0, bool bParam1)//Position - 0xC77F
{
	struct<27> Var0;
...
void func_192(int iParam0, var uParam1, int iParam2)//Position - 0xC9F2
{
	int iVar0;
	int iVar1;
...
int func_193(int iParam0)//Position - 0xCD4A
{
...
int func_194(var uParam0)//Position - 0xCD6A
{
...
int func_195(var uParam0)//Position - 0xCD82
{
...
void func_196(var uParam0)//Position - 0xCDA7
{
	int iVar0;
	int iVar1;
...
void func_197(int iParam0)//Position - 0xD0AB
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_198(var uParam0)//Position - 0xD0D6
{
	int iVar0;
...
int func_199(var uParam0, bool bParam1, bool bParam2)//Position - 0xD156
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_200(int iParam0, int iParam1)//Position - 0xD314
{
	int iVar0;
...
int func_201(var uParam0, bool bParam1, int iParam2)//Position - 0xD344
{
	int iVar0;
	int iVar1;
...
int func_202(int iParam0)//Position - 0xD600
{
...
int func_203(int iParam0, float fParam1)//Position - 0xD634
{
	float fVar0;
...
bool func_204(int iParam0, float fParam1)//Position - 0xD6AA
{
	return func_205(iParam0, AUDIO::_0x0626A247D2405330(), fParam1, 1, 250, 7);
}

bool func_205(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD6C2
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_206(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xD783
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_207(int iParam0, int iParam1)//Position - 0xD8AF
{
	int iVar0;
...
int func_209(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xD9BE
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
float func_210(vector3 vParam0, vector3 vParam1)//Position - 0xDA4F
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_211(vector3 vParam0)//Position - 0xDA70
{
	float fVar0;
	float fVar1;
...
void func_212(var uParam0)//Position - 0xDAAF
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_213(int iParam0, int iParam1)//Position - 0xDACA
{
	int iVar0;
...
int func_214(int iParam0)//Position - 0xDB09
{
...
int func_215(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xDB31
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_216(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xDC2C
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_217(int iParam0, float fParam1)//Position - 0xDD38
{
	var uVar0;
	vector3 vVar1;
...
int func_218(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xDDCD
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
int func_219(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xDE5B
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
...
int func_220(int iParam0)//Position - 0xDEA3
{
...
void func_221(int iParam0)//Position - 0xDEED
{
	int iVar0;
...
int func_222(int iParam0)//Position - 0xDF8A
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_164();
...
int func_223(int iParam0)//Position - 0xE022
{
...
int func_226(int iParam0)//Position - 0xE0A4
{
...
int func_228(int iParam0)//Position - 0xE116
{
	if (func_107(0))
	{
...
void func_229(int iParam0)//Position - 0xE13E
{
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
...
void func_230(int iParam0)//Position - 0xE16B
{
	iParam0->f_10 = 5;
...
int func_231(int iParam0)//Position - 0xE1C0
{
	struct<27> Var0;
	int iVar1;
...
int func_232(int iParam0)//Position - 0xE214
{
	char* sVar0;
...
int func_233(int iParam0)//Position - 0xE2CD
{
	var uVar0;
...
int func_234(int iParam0)//Position - 0xE38E
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_235(int iParam0, char* sParam1)//Position - 0xE413
{
...
bool func_236(int iParam0)//Position - 0xE4F3
{
...
bool func_237(int iParam0)//Position - 0xE521
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
bool func_238(int iParam0)//Position - 0xE54F
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
int func_239(int iParam0)//Position - 0xE57D
{
	if (func_223(iParam0))
	{
		return 0;
...
void func_240()//Position - 0xE5B2
{
	func_258("Running end routines.");
	Global_19D3C = (Global_19D3C - 1);
}

int func_241(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE5CC
{
	int iVar0;
...
int func_242(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xE631
{
	int iVar0;
	struct<7> Var1;
...
int func_243(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xE6AF
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_244(int iParam0, bool bParam1)//Position - 0xE72A
{
	if (bParam1)
	{
...
void func_245(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xE77E
{
...
void func_246(var uParam0, bool bParam1)//Position - 0xE79E
{
	func_247(&(uParam0->f_29), bParam1);
}

void func_247(var uParam0, bool bParam1)//Position - 0xE7B0
{
	int iVar0;
...
void func_248(int iParam0, bool bParam1)//Position - 0xE7EE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_249(var uParam0, bool bParam1)//Position - 0xE829
{
	func_250(&(uParam0->f_23), bParam1);
}

void func_250(var uParam0, bool bParam1)//Position - 0xE83B
{
	int iVar0;
...
void func_251(int iParam0)//Position - 0xE878
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_252(int iParam0)//Position - 0xE8B0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_253(var uParam0, int iParam1)//Position - 0xE94C
{
	func_254(&(uParam0->f_1C), iParam1);
}

void func_254(var uParam0, int iParam1)//Position - 0xE95E
{
	int iVar0;
...
void func_255(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xE99F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_256(int iParam0)//Position - 0xE9EF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_257(var uParam0)//Position - 0xEA30
{
	if (*uParam0 == 4294967295)
	{
		return;
...
void func_258(char* sParam0)//Position - 0xEA6D
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_259(var uParam0)//Position - 0xEA7F
{
	*uParam0 = 4294967295;
