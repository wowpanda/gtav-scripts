...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		func_7(AUDIO::_0x0626A247D2405330());
		if (func_2())
		{
			func_41();
		}
...
void func_1(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0xDD
{
...
void func_3(char* sParam0)//Position - 0x1D4
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	CAM::_DISABLE_VEHICLE_FIRST_PERSON_CAM_THIS_FRAME();
}

void func_4()//Position - 0x1E6
{
	int iVar0;
	int iVar1;
	...
	while (iVar1 <= (16 - 1))
	{
		...
		{
			if ((!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_39, iVar1) && iVar0 >= Local_22[iVar1]) && iVar0 < Local_22.f_11[iVar1])
			{
				func_5();
...
void func_5()//Position - 0x249
{
}

void func_6()//Position - 0x251
{
}

bool func_7(int iParam0)//Position - 0x259
{
...
void func_8(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x277
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_13(CAM::_0xDC9DA9E8789F5246())) && !func_10(CAM::_0xDC9DA9E8789F5246(), 0)) && !func_9()) && !bParam4)
			{
				ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_13(CAM::_0xDC9DA9E8789F5246())) && !bParam4)
		{
			ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), false);
		}
		Global_11623 = 0;
...
int func_11(int iParam0, bool bParam1)//Position - 0x408
{
	int iVar0;
	int iVar1;
...
int func_12()//Position - 0x449
{
	return Global_1407E0;
}

int func_13(int iParam0)//Position - 0x455
{
...
bool func_14()//Position - 0x497
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_240006, 3);
}

int func_15(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x4A8
{
	int iVar0;
...
void func_17(int iParam0)//Position - 0x502
{
	if (iParam0 == 1)
	{
...
void func_18(bool bParam0)//Position - 0x525
{
	int iVar0;
	
	if (func_7(AUDIO::_0x0626A247D2405330()))
	{
		ENTITY::SET_ENTITY_COORDS(AUDIO::_0x0626A247D2405330(), 689.1f, 586.5f, 130.5f, 1, false, 0, 1);
	...
	while (ENTITY::IS_ENTITY_WAITING_FOR_WORLD_COLLISION(AUDIO::_0x0626A247D2405330()))
	{
		SYSTEM::WAIT(0);
	}
...
void func_19(int iParam0)//Position - 0x859
{
	switch (iParam0)
	{
		case 0:
...
void func_20(int iParam0, int iParam1, int iParam2)//Position - 0x9C9
{
	Local_22[iParam0] = iParam1;
	Local_22.f_11[iParam0] = iParam2;
}

void func_21(var uParam0, int iParam1)//Position - 0x9E3
{
	uParam0->f_16 = 0;
	GRAPHICS::_0x35FB78DC42B7BD21(&uLocal_47, iParam1);
	if (iParam1 == 0 && uParam0->f_16 == 0)
	{
	}
}

void func_22(var uParam0, int iParam1)//Position - 0xA0B
{
	uParam0->f_16 = 0;
	GRAPHICS::_0x35FB78DC42B7BD21(&uLocal_45, iParam1);
	if (iParam1 == 0 && uParam0->f_16 == 0)
	{
	}
}

void func_23(var uParam0, int iParam1)//Position - 0xA33
{
	vector3 vVar0;
	
	func_28(uParam0);
	GRAPHICS::_0x35FB78DC42B7BD21(&uLocal_43, iParam1);
	switch (iParam1)
	{
		case 0:
...
void func_24(var uParam0, vector3 vParam1, vector3 vParam2, int iParam3, float fParam4, float fParam5)//Position - 0x23D8
{
	uParam0->f_1 = { vParam1 };
	uParam0->f_4 = { vParam2 };
	uParam0->f_7 = iParam3;
...
void func_25(var uParam0, int iParam1, vector3 vParam2, vector3 vParam3, int iParam4, int iParam5, int iParam6)//Position - 0x240A
{
...
void func_26(var uParam0, var uParam1, vector3 vParam2, vector3 vParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2445
{
	*uParam0 = { vParam2 };
	uParam0->f_3 = { vParam3 };
	uParam0->f_6 = uParam4;
...
float func_27(float fParam0)//Position - 0x2477
{
	return (fParam0 * 57.29578f);
}

void func_28(var uParam0)//Position - 0x2487
{
	uParam0->f_9A = 0;
	uParam0->f_9B[0 /*11*/] = 0;
	uParam0->f_9B[1 /*11*/] = 0;
...
int func_29(char* sParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x24A4
{
	int iVar0;
...
int func_30(char* sParam0, var uParam1, int iParam2)//Position - 0x2509
{
	int iVar0;
...
int func_31(char* sParam0, int iParam1)//Position - 0x2571
{
	int iVar0;
...
char* func_32(int iParam0)//Position - 0x25CC
{
	char* sVar0;
...
void func_33(int iParam0, int iParam1)//Position - 0x269C
{
	...
	*iParam0 = PED::ADD_SCENARIO_BLOCKING_AREA(-7000f, -7000f, -100f, 7000f, 7000f, 315f, 0, 1, 1, 1);
	...
	if (func_7(AUDIO::_0x0626A247D2405330()) && iParam1 == 1)
	{
		MISC::CLEAR_AREA_OF_PEDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 500f, 0);
	}
}

void func_34(bool bParam0)//Position - 0x276B
{
...
void func_35(bool bParam0)//Position - 0x27C5
{
	if (bParam0)
	{
		func_40();
...
void func_36(int iParam0)//Position - 0x2828
{
	if (func_38())
	{
		return;
...
void func_37(bool bParam0, bool bParam1)//Position - 0x28A2
{
	if (bParam0)
	{
		if (func_39(0))
...
bool func_38()//Position - 0x2916
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

int func_39(int iParam0)//Position - 0x2928
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
void func_43(int iParam0)//Position - 0x2AB8
{
...
void func_44(char* sParam0)//Position - 0x2B1B
{
	STREAMING::REMOVE_ANIM_DICT(sParam0);
}

void func_45(int iParam0)//Position - 0x2B29
{
	if (iParam0 != 0)
	{
...
void func_46(var uParam0)//Position - 0x2B3D
{
	int iVar0;
	char* sVar1;
	char* sVar2;
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_11[iVar0]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_11[iVar0], 0))
		{
			ENTITY::STOP_ENTITY_ANIM(uParam0->f_11[iVar0], sVar2, sVar1, -1000f);
		}
...
char* func_47(int iParam0)//Position - 0x2BB2
{
	char* sVar0;
...
char* func_48(int iParam0)//Position - 0x2BC8
{
	char* sVar0;
...
void func_49(var uParam0)//Position - 0x2BDD
{
	int iVar0;
...
void func_50(int iParam0)//Position - 0x2C29
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_51(var uParam0)//Position - 0x2C6A
{
	int iVar0;
