...
void func_1()//Position - 0x116
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_40))
	{
		if ((ENTITY::IS_ENTITY_DEAD(iLocal_40, 0) || ENTITY::GET_ENTITY_HEALTH(iLocal_40) <= 0) || VEHICLE::GET_VEHICLE_ENGINE_HEALTH(iLocal_40) <= 0f)
		{
			...
			if (iLocal_47 == 1)
			{
				vVar0 = { unk_0x8000C77B5F336760(iLocal_40, 0) };
				func_8(vVar0);
			}
			if (iLocal_47 == 1)
			{
...
void func_11()//Position - 0x494
{
	...
	if (func_6(iLocal_40))
	{
		...
		if (func_5(AUDIO::_0x0626A247D2405330()))
		{
			PED::SET_PED_INTO_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_45, 4294967295);
			CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
			CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
			MISC::CLEAR_AREA(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 1), 500f, 1, 0, 0, false);
		}
	}
...
void func_12(int iParam0, int iParam1)//Position - 0x52F
{
	...
	fVar0 = func_13(unk_0x8000C77B5F336760(iParam0, 1), unk_0x8000C77B5F336760(iParam1, 1), 1);
...
void func_16()//Position - 0x60F
{
	...
	if (func_6(iLocal_40))
	{
		iLocal_43 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_40, 26, iLocal_44, 4294967295, 1, true);
		if (func_5(iLocal_43))
		{
			ENTITY::SET_ENTITY_HEALTH(iLocal_43, 1);
