...
void func_34()
{
	...
	switch (iLocal_48)
	{
		...
		case 1:
			...
			{
				case 0:
					if (HAS_MODEL_LOADED(iLocal_154))
					{
				...
				case 1:
					if (HAS_MODEL_LOADED(iLocal_153))
					{
				...
				case 2:
					if (HAS_MODEL_LOADED(iLocal_155))
					{
						REQUEST_MODEL(iLocal_156);
						iLocal_148++;
					}
					break;
				
				case 3:
					if (HAS_MODEL_LOADED(iLocal_156))
					{
						REQUEST_MODEL(iLocal_157);
						iLocal_148++;
					}
					break;
				
				case 4:
					if (HAS_MODEL_LOADED(iLocal_157))
					{
				...
				case 6:
					if ((((((HAS_MODEL_LOADED(iLocal_154) && HAS_MODEL_LOADED(iLocal_153)) && HAS_MODEL_LOADED(iLocal_155)) && HAS_MODEL_LOADED(iLocal_157)) && HAS_MODEL_LOADED(iLocal_156)) && GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_137)) && GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_138))
					{
				...
				case 7:
					...
					if (func_41())
					{
						...
						{
							SET_RELATIONSHIP_BETWEEN_GROUPS(3, 1862763509, iLocal_171);
							SET_RELATIONSHIP_BETWEEN_GROUPS(3, iLocal_171, 1862763509);
						}
					}
					break;
				...
				case 9:
					if (func_198(Local_116[0 /*4*/]))
					{
						if (func_37(PLAYER_PED_ID(), vLocal_145, 1) >= 200f && func_37(Local_116[0 /*4*/], vLocal_145, 1) >= 200f)
						{
							iLocal_48 = 2;
						}
					}
...
float func_37(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
int func_38(int iParam0, bool bParam1)
{
	...
	{
		if (func_40(Local_49[iParam0 /*6*/], PLAYER_PED_ID(), 1) >= 400f)
		{
			func_39(iParam0, 0);
			return 1;
		}
...
{
	if (DOES_ENTITY_EXIST(Local_49[iParam0 /*6*/]))
	{
		...
		{
			DETACH_ENTITY(Local_49[iParam0 /*6*/], 1, 1);
		}
		if (bParam1)
		{
...
bool func_41()
{
	return IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 3150.508f, 2179.343f, -3.388727f, 3064.608f, 2223.616f, 12.38177f, 103f, 0, 1, 0);
}
...
int func_43()
{
	if (func_198(Local_116[0 /*4*/]) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_116[0 /*4*/], 0))
	{
		return 1;
	}
	return 0;
...
int func_48()
{
	switch (func_49(&Global_25824, 0, 5, 0, GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_54(int iParam0, bool bParam1, vector3 vParam2, float fParam5)
{
	vector3 vVar0;
	float fVar3;
	int iVar4;
	...
	if (!DOES_ENTITY_EXIST(Local_49[iParam0 /*6*/]))
	{
		...
		if (func_198(iVar6))
		{
			Local_49[iParam0 /*6*/] = CREATE_PED_INSIDE_VEHICLE(iVar6, 26, iVar4, iVar7, 1, 1);
		}
		else
		{
			Local_49[iParam0 /*6*/] = CREATE_PED(26, iVar4, vVar0, fVar3, 1, 1);
			SET_ENTITY_COLLISION(Local_49[iParam0 /*6*/], iVar42, 0);
			_SET_ENTITY_COLLISION_2(Local_49[iParam0 /*6*/], !bVar66, 0);
		}
		if (bVar41)
		{
		...
		SET_PED_CONFIG_FLAG(Local_49[iParam0 /*6*/], 213, iVar29);
		SET_PED_CONFIG_FLAG(Local_49[iParam0 /*6*/], 212, iVar30);
		...
		SET_PED_CONFIG_FLAG(Local_49[iParam0 /*6*/], 188, iVar56);
		SET_PED_CONFIG_FLAG(Local_49[iParam0 /*6*/], 42, !bVar34);
		SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 9, iVar36);
		SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 3, iVar38);
		SET_PED_CONFIG_FLAG(Local_49[iParam0 /*6*/], 342, iVar58);
		SET_ENTITY_LOAD_COLLISION_FLAG(Local_49[iParam0 /*6*/], iVar37, 1);
		SET_PED_ARMOUR(Local_49[iParam0 /*6*/], iVar18);
		SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 8, iVar40);
		...
		SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 2, iVar44);
		SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 1, iVar45);
		SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 52, iVar46);
		SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 13, iVar69);
		SET_PED_SUFFERS_CRITICAL_HITS(Local_49[iParam0 /*6*/], iVar47);
		SET_PED_CAN_BE_TARGETTED(Local_49[iParam0 /*6*/], iVar48);
		SET_PED_CONFIG_FLAG(Local_49[iParam0 /*6*/], 118, iVar49);
		SET_PED_CONFIG_FLAG(Local_49[iParam0 /*6*/], 115, iVar50);
		SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 12, iVar51);
		SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 36, iVar52);
		SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 35, iVar53);
		SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 29, iVar54);
		SET_PED_CONFIG_FLAG(Local_49[iParam0 /*6*/], 185, iVar55);
		SET_PED_TO_LOAD_COVER(Local_49[iParam0 /*6*/], iVar57);
		SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 17, iVar63);
		SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 5, iVar72);
		SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 46, iVar73);
		...
		SET_PED_CONFIG_FLAG(Local_49[iParam0 /*6*/], 203, bVar68);
		_0xA9B61A329BFDCBEA(Local_49[iParam0 /*6*/], !bVar68);
		if (!bVar61)
		{
			func_57(iParam0, 2);
		}
		...
		if (iVar17 > 0)
		{
			...
			SET_ENTITY_HEALTH(Local_49[iParam0 /*6*/], iVar17, 0);
		}
		if (iVar19 > 0)
		{
		...
		SET_PED_RELATIONSHIP_GROUP_HASH(Local_49[iParam0 /*6*/], iVar28);
		if (DOES_ENTITY_EXIST(uVar8))
		{
			ATTACH_ENTITY_TO_ENTITY(Local_49[iParam0 /*6*/], uVar8, -1, vVar9, vVar12, 1, 1, 1, 0, 2, 1);
		...
		if (iVar15 != 0)
		{
			...
			SET_CURRENT_PED_WEAPON(Local_49[iParam0 /*6*/], iVar5, 1);
		}
		SET_PED_COMBAT_ABILITY(Local_49[iParam0 /*6*/], iVar16);
		if (bVar65)
		{
...
void func_56(int iParam0)
{
	if (func_198(Local_49[iParam0 /*6*/]))
	{
		...
		{
			case 0:
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 0, 0, 0, 0);
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 3, 0, 0, 0);
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 4, 0, 0, 0);
				break;
			
			case 1:
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 0, 1, 1, 0);
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 3, 1, 2, 0);
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 4, 0, 1, 0);
				break;
			...
			case 3:
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 0, 1, 0, 0);
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 3, 1, 0, 0);
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 4, 0, 1, 0);
				break;
			
			case 4:
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 0, 1, 2, 0);
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 3, 0, 1, 0);
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 4, 1, 0, 0);
				break;
			
			case 7:
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 0, 0, 2, 0);
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 3, 1, 2, 0);
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 4, 1, 2, 0);
				break;
			
			case 8:
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 0, 1, 1, 0);
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 3, 0, 2, 0);
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 4, 0, 2, 0);
				break;
			...
			case 10:
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 0, 0, 1, 0);
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 3, 1, 1, 0);
				SET_PED_COMPONENT_VARIATION(Local_49[iParam0 /*6*/], 4, 1, 0, 0);
				break;
			}
	}
...
{
	SET_BIT(&(Local_49[iParam0 /*6*/].f_2), iParam1);
}
...
int func_63(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	vector3 vVar0;
	float fVar3;
	int iVar4;
	...
	if (!DOES_ENTITY_EXIST(Local_116[iParam0 /*4*/]))
	{
		iVar5 = 0;
		iVar6 = 1;
		iVar7 = 1;
		...
		Local_116[iParam0 /*4*/] = CREATE_VEHICLE(iVar4, vVar0, fVar3, 1, 1, 0);
		func_66(iParam0);
		func_65(iParam0);
		SET_ENTITY_VISIBLE(Local_116[iParam0 /*4*/], iVar7, 0);
		if (DOES_ENTITY_EXIST(uVar26))
		{
			ATTACH_ENTITY_TO_ENTITY(Local_116[iParam0 /*4*/], uVar26, -1, vVar27, vVar30, 0, 0, 0, 0, 2, 1);
		}
		else
		{
		...
		if (bVar11)
		{
			SET_VEHICLE_ENGINE_ON(Local_116[iParam0 /*4*/], bVar11, 1, 0);
		}
		SET_ENTITY_INVINCIBLE(Local_116[iParam0 /*4*/], iVar14);
		SET_ENTITY_LOAD_COLLISION_FLAG(Local_116[iParam0 /*4*/], iVar15, 1);
		...
		if (!IS_STRING_NULL_OR_EMPTY(uVar33))
		{
			SET_VEHICLE_NUMBER_PLATE_TEXT(Local_116[iParam0 /*4*/], uVar33);
		}
		if (fVar23 > 0f)
		{
		...
		if (fVar24 >= 0f)
		{
			SET_PLANE_TURBULENCE_MULTIPLIER(Local_116[iParam0 /*4*/], fVar24);
		}
		if (fVar25 >= 0f)
		{
		...
		if (bVar21)
		{
			SET_BOAT_ANCHOR(Local_116[iParam0 /*4*/], 1);
		}
		if (iVar5 != 0)
		{
		...
		if (iParam0 == 0)
		{
			CONTROL_LANDING_GEAR(Local_116[iParam0 /*4*/], 3);
		}
	}
	return 1;
}
...
void func_65(int iParam0)
{
	if (func_198(Local_116[iParam0 /*4*/]))
	{
		switch (iParam0)
		{
			case 2:
			case 3:
				SET_VEHICLE_EXTRA(Local_116[iParam0 /*4*/], 1, 1);
				SET_VEHICLE_EXTRA(Local_116[iParam0 /*4*/], 2, 1);
				SET_VEHICLE_EXTRA(Local_116[iParam0 /*4*/], 3, 1);
				SET_VEHICLE_EXTRA(Local_116[iParam0 /*4*/], 4, 1);
				SET_VEHICLE_EXTRA(Local_116[iParam0 /*4*/], 5, 0);
				break;
			...
			case 4:
				...
				SET_VEHICLE_EXTRA(Local_116[iParam0 /*4*/], 2, 1);
				SET_VEHICLE_EXTRA(Local_116[iParam0 /*4*/], 3, 1);
				SET_VEHICLE_EXTRA(Local_116[iParam0 /*4*/], 4, 0);
				SET_VEHICLE_EXTRA(Local_116[iParam0 /*4*/], 5, 1);
				break;
			}
	}
}
	...
	if (func_198(Local_116[iParam0 /*4*/]))
	{
		switch (iParam0)
		{
			...
			case 2:
				...
				SET_VEHICLE_EXTRA_COLOURS(Local_116[iParam0 /*4*/], 0, 156);
				break;
...
void func_68()
{
	...
	func_79(0);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(3073.41f, 2161.604f, -20f, 3123.816f, 2216.9f, 9.0777f, 0, 1);
	...
	{
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(3077.523f, 2069.831f, -3.3524f, 3092.296f, 2092.042f, 2.769f, 0, 1);
	...
	{
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(3054.367f, 2071.361f, -2.4173f, 3075.652f, 2091.954f, 2.7296f, 0, 1);
	...
	{
		CLEAR_AREA_OF_VEHICLES(3070.882f, 2103.967f, -2.0883f, 5f, 0, 0, 0, 0, 0, 0);
	}
	...
	func_78(&uLocal_174, 1, PLAYER_PED_ID(), "TREVOR", 0, 1);
...
int func_77(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_10() == 0)
		{
			return IS_BIT_SET(func_74(func_75(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_84()
{
	...
	while (iVar0 < 11)
	{
		if (DOES_ENTITY_EXIST(Local_49[iVar0 /*6*/]) && DOES_BLIP_EXIST(Local_49[iVar0 /*6*/].f_1))
		{
			...
			if (IS_PED_INJURED(Local_49[iVar0 /*6*/]))
			{
	...
	while (iVar0 < 5)
	{
		if (DOES_ENTITY_EXIST(Local_116[iVar0 /*4*/]) && DOES_BLIP_EXIST(Local_116[iVar0 /*4*/].f_1))
		{
...
{
	CLEAR_BIT(&(Local_49[iParam0 /*6*/].f_2), iParam1);
}
...
{
	return IS_BIT_SET(Local_49[iParam0 /*6*/].f_2, iParam1);
}
...
void func_89()
{
	...
	while (iVar0 < 5)
	{
		if (DOES_ENTITY_EXIST(Local_116[iVar0 /*4*/]))
		{
			func_90(iVar0);
		}
		iVar0++;
	...
	if (func_198(Local_116[iParam0 /*4*/]) || iParam0 == 0)
	{
		switch (iParam0)
		{
			...
			case 4:
				...
				{
					case 0:
						if (((!func_198(GET_PED_IN_VEHICLE_SEAT(Local_116[iParam0 /*4*/], -1, 0)) && !func_198(GET_PED_IN_VEHICLE_SEAT(Local_116[iParam0 /*4*/], 0, 0))) && !func_198(GET_PED_IN_VEHICLE_SEAT(Local_116[iParam0 /*4*/], 1, 0))) && !func_198(GET_PED_IN_VEHICLE_SEAT(Local_116[iParam0 /*4*/], 2, 0)))
						{
							SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_116[iParam0 /*4*/], 1);
							SET_BOAT_ANCHOR(Local_116[iParam0 /*4*/], 0);
...
void func_93()
{
	...
	while (iVar0 < 11)
	{
		if (DOES_ENTITY_EXIST(Local_49[iVar0 /*6*/]))
		{
			func_94(iVar0);
		}
		iVar0++;
...
void func_94(int iParam0)
{
	...
	if (func_198(Local_49[iParam0 /*6*/]))
	{
		switch (iParam0)
		{
			...
			case 2:
				if (Local_49[iParam0 /*6*/].f_3 >= 2 && Local_49[iParam0 /*6*/].f_3 < 5)
				{
					if ((IS_PED_IN_ANY_VEHICLE(Local_49[iParam0 /*6*/], 0) && func_198(GET_VEHICLE_PED_IS_IN(Local_49[iParam0 /*6*/], 0))) && IS_ENTITY_ON_FIRE(GET_VEHICLE_PED_IS_IN(Local_49[iParam0 /*6*/], 0)))
					{
						...
						TASK_LEAVE_ANY_VEHICLE(0, GET_RANDOM_INT_IN_RANGE(500, 1501), 4096);
						TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 0);
						TASK_COMBAT_PED(0, PLAYER_PED_ID(), 0, 16);
						func_102(Local_49[iParam0 /*6*/]);
						SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 1, 0);
				...
				switch (Local_49[iParam0 /*6*/].f_3)
				{
					case 0:
						...
						if (((func_120(1) || IS_PED_IN_COMBAT(Local_49[iParam0 /*6*/], PLAYER_PED_ID())) || func_101()) || func_100())
						{
							func_99(iParam0);
							TASK_COMBAT_PED(Local_49[iParam0 /*6*/], PLAYER_PED_ID(), 0, 16);
					...
					case 2:
						...
						WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sVar4, GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), &iVar1);
						...
						if (iVar1 > 0 && IS_PED_ON_FOOT(PLAYER_PED_ID()))
						{
							iVar1 = (iVar1 - 1);
						}
						if (iParam0 == 2 && !IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 3108.675f, 2194.121f, 10.95087f, 3143.525f, 2232.265f, -4.598444f, 82.75f, 0, 1, 0))
						{
							iVar1 = func_98(iVar1, 22, iVar3);
						}
						if (func_37(PLAYER_PED_ID(), vLocal_145, 1) >= 225f)
						{
							iVar1 = (iVar3 - 1);
						}
						if (((((iParam0 == 0 && iLocal_151 != iVar1) && iVar1 > iVar2) || ((iParam0 == 2 && iLocal_152 != iVar1) && iVar1 > iVar2)) && func_198(GET_VEHICLE_PED_IS_USING(Local_49[iParam0 /*6*/]))) && !IS_PED_BEING_STUNNED(Local_49[iParam0 /*6*/], 0))
						{
							...
							{
								SET_BOAT_ANCHOR(GET_VEHICLE_PED_IS_USING(Local_49[iParam0 /*6*/]), 0);
								func_85(iParam0, 5);
							}
						...
						{
							TASK_VEHICLE_SHOOT_AT_PED(Local_49[iParam0 /*6*/], PLAYER_PED_ID(), 1101004800);
							if (func_198(GET_VEHICLE_PED_IS_USING(Local_49[iParam0 /*6*/])) && _0x2467A2D807D37CA3(GET_VEHICLE_PED_IS_USING(Local_49[iParam0 /*6*/])))
							{
								SET_BOAT_ANCHOR(GET_VEHICLE_PED_IS_USING(Local_49[iParam0 /*6*/]), 1);
								func_57(iParam0, 5);
							}
						}
						if (!func_88(iParam0, 4))
						{
							if (IS_PED_BEING_STUNNED(Local_49[iParam0 /*6*/], 0))
							{
								...
								if (!func_88(iParam0, 5) && _0x2467A2D807D37CA3(GET_VEHICLE_PED_IS_USING(Local_49[iParam0 /*6*/])))
								{
									SET_BOAT_ANCHOR(GET_VEHICLE_PED_IS_USING(Local_49[iParam0 /*6*/]), 1);
								}
							}
						...
						{
							TASK_DRIVE_BY(Local_49[iParam0 /*6*/], PLAYER_PED_ID(), 0, vLocal_139, 500f, 100, 1, -687903391);
						}
						WAYPOINT_RECORDING_GET_COORD(sVar4, (iVar3 - 1), &vVar6);
						if (IS_ENTITY_AT_COORD(Local_49[iParam0 /*6*/], vVar6, 8f, 8f, 8f, 0, 1, 0))
						{
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_49[iParam0 /*6*/], 1);
							TASK_BOAT_MISSION(Local_49[iParam0 /*6*/], GET_VEHICLE_PED_IS_USING(Local_49[iParam0 /*6*/]), 0, PLAYER_PED_ID(), vLocal_139, 7, 20f, 786469, 5f, 7);
							func_67(5);
					...
					case 4:
						if (!func_97(Local_49[iParam0 /*6*/], -1708676711, 1))
						{
							...
							{
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_49[iParam0 /*6*/], 0);
								TASK_COMBAT_PED(Local_49[iParam0 /*6*/], PLAYER_PED_ID(), 0, 16);
							}
							else
							{
			...
			case 4:
				switch (Local_49[iParam0 /*6*/].f_3)
				{
					case 0:
						...
						{
							func_99(iParam0);
							Local_49[iParam0 /*6*/].f_4 = (GET_GAME_TIMER() + GET_RANDOM_INT_IN_RANGE(1250, 1501));
							Local_49[iParam0 /*6*/].f_3++;
						}
						break;
					
					case 1:
						if (GET_GAME_TIMER() >= Local_49[iParam0 /*6*/].f_4)
						{
							if ((iParam0 == 1 && func_198(Local_116[1 /*4*/])) && func_198(GET_PED_IN_VEHICLE_SEAT(Local_116[1 /*4*/], -1, 0)))
							{
								CLEAR_PED_TASKS(Local_49[iParam0 /*6*/]);
								TASK_ENTER_VEHICLE(Local_49[iParam0 /*6*/], Local_116[1 /*4*/], 20000, 0, 3f, 1, 0);
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_49[iParam0 /*6*/], 1);
							}
							if ((iParam0 == 3 && func_198(Local_116[2 /*4*/])) && func_198(GET_PED_IN_VEHICLE_SEAT(Local_116[2 /*4*/], -1, 0)))
							{
								CLEAR_PED_TASKS(Local_49[iParam0 /*6*/]);
								TASK_ENTER_VEHICLE(Local_49[iParam0 /*6*/], Local_116[2 /*4*/], 20000, 0, 3f, 1, 0);
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_49[iParam0 /*6*/], 1);
							}
							if ((iParam0 == 4 && func_198(Local_116[2 /*4*/])) && func_198(GET_PED_IN_VEHICLE_SEAT(Local_116[2 /*4*/], -1, 0)))
							{
								CLEAR_PED_TASKS(Local_49[iParam0 /*6*/]);
								TASK_ENTER_VEHICLE(Local_49[iParam0 /*6*/], Local_116[2 /*4*/], 20000, 1, 3f, 1, 0);
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_49[iParam0 /*6*/], 1);
							}
							Local_49[iParam0 /*6*/].f_3++;
						}
					...
					case 2:
						...
						if (IS_PED_IN_ANY_VEHICLE(Local_49[iParam0 /*6*/], 1) || !func_198(GET_PED_IN_VEHICLE_SEAT(Local_116[iVar9 /*4*/], -1, 0)))
						{
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_49[iParam0 /*6*/], 0);
							TASK_COMBAT_PED(Local_49[iParam0 /*6*/], PLAYER_PED_ID(), 0, 16);
							Local_49[iParam0 /*6*/].f_3++;
						...
						else if (!func_97(Local_49[iParam0 /*6*/], -1794415470, 1))
						{
							...
							{
								TASK_ENTER_VEHICLE(Local_49[iParam0 /*6*/], Local_116[iVar9 /*4*/], 20000, 0, 3f, 1, 0);
							}
							if (iParam0 == 4 && func_198(Local_116[iVar9 /*4*/]))
							{
								TASK_ENTER_VEHICLE(Local_49[iParam0 /*6*/], Local_116[iVar9 /*4*/], 20000, 1, 3f, 1, 0);
							}
						}
						break;
					...
					case 3:
						if (IS_PED_IN_ANY_VEHICLE(Local_49[iParam0 /*6*/], 0) && func_198(GET_VEHICLE_PED_IS_IN(Local_49[iParam0 /*6*/], 0)))
						{
							...
							if (Local_49[iParam0 /*6*/].f_3 == 3)
							{
								...
								else if (!func_198(GET_PED_IN_VEHICLE_SEAT(GET_VEHICLE_PED_IS_IN(Local_49[iParam0 /*6*/], 0), -1, 0)))
								{
									SET_PED_COMBAT_ATTRIBUTES(Local_49[iParam0 /*6*/], 3, 1);
									TASK_COMBAT_PED(Local_49[iParam0 /*6*/], PLAYER_PED_ID(), 0, 16);
									Local_49[iParam0 /*6*/].f_3++;
								}
							}
			...
			case 7:
				...
				{
					case 0:
						if ((((func_43() && func_40(PLAYER_PED_ID(), Local_49[iParam0 /*6*/], 1) <= 125f) || ((IS_PED_ON_FOOT(PLAYER_PED_ID()) && !IS_ENTITY_IN_WATER(PLAYER_PED_ID())) && func_40(PLAYER_PED_ID(), Local_49[iParam0 /*6*/], 1) <= 150f)) || (IS_PED_ON_FOOT(PLAYER_PED_ID()) && !IS_ENTITY_OCCLUDED(Local_49[iParam0 /*6*/]))) || func_120(6))
						{
							if (func_198(Local_116[3 /*4*/]))
							{
								SET_BOAT_ANCHOR(GET_VEHICLE_PED_IS_USING(Local_49[iParam0 /*6*/]), 0);
								fVar10 = GET_ENTITY_SPEED(PLAYER_PED_ID());
								fVar10 = func_95(fVar10, 10f, 40f);
								SET_VEHICLE_FORWARD_SPEED(Local_116[3 /*4*/], fVar10);
							}
							SET_CURRENT_PED_WEAPON(Local_49[iParam0 /*6*/], joaat("weapon_pistol"), 0);
							TASK_BOAT_MISSION(Local_49[iParam0 /*6*/], GET_VEHICLE_PED_IS_USING(Local_49[iParam0 /*6*/]), 0, PLAYER_PED_ID(), vLocal_139, 7, 20f, 786469, 5f, 7);
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_49[iParam0 /*6*/], 1);
							Local_49[iParam0 /*6*/].f_1 = func_59(Local_49[iParam0 /*6*/], 1, 145);
							func_67(6);
				...
				switch (Local_49[iParam0 /*6*/].f_3)
				{
					case 0:
						if ((((func_43() && func_40(PLAYER_PED_ID(), Local_49[iParam0 /*6*/], 1) <= 125f) || ((IS_PED_ON_FOOT(PLAYER_PED_ID()) && !IS_ENTITY_IN_WATER(PLAYER_PED_ID())) && func_40(PLAYER_PED_ID(), Local_49[iParam0 /*6*/], 1) <= 150f)) || (IS_PED_ON_FOOT(PLAYER_PED_ID()) && !IS_ENTITY_OCCLUDED(Local_49[iParam0 /*6*/]))) || func_120(6))
						{
							...
							{
								SET_BOAT_ANCHOR(GET_VEHICLE_PED_IS_USING(Local_49[iParam0 /*6*/]), 0);
								fVar11 = GET_ENTITY_SPEED(PLAYER_PED_ID());
			...
			case 10:
				...
				{
					case 0:
						if (((func_43() && func_40(PLAYER_PED_ID(), Local_49[iParam0 /*6*/], 1) <= 125f) || ((IS_PED_ON_FOOT(PLAYER_PED_ID()) && !IS_ENTITY_IN_WATER(PLAYER_PED_ID())) && func_40(PLAYER_PED_ID(), Local_49[iParam0 /*6*/], 1) <= 150f)) || (IS_PED_ON_FOOT(PLAYER_PED_ID()) && !IS_ENTITY_OCCLUDED(Local_49[iParam0 /*6*/])))
						{
							Local_49[iParam0 /*6*/].f_1 = func_59(Local_49[iParam0 /*6*/], 1, 145);
	...
	else
	{
		if (func_88(iParam0, 1))
		{
			...
			DETACH_ENTITY(Local_49[iParam0 /*6*/], 1, 0);
			func_85(iParam0, 1);
		}
...
int func_96(int iParam0, int iParam1)
{
	...
	if (func_198(Local_116[iVar0 /*4*/]))
	{
		...
		{
			Local_116[iVar0 /*4*/].f_3 = (Local_116[iVar0 /*4*/].f_3 + GET_FRAME_TIME());
		}
		else
		{
...
int func_101()
{
	...
	if (func_198(uVar0) && IS_ENTITY_IN_ANGLED_AREA(uVar0, 3083.23f, 2195.516f, -3.22382f, 3096.519f, 2195.455f, 4.949678f, 15f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
void func_105()
{
	...
	{
		if (func_198(Local_116[0 /*4*/]) && func_40(PLAYER_PED_ID(), Local_116[0 /*4*/], 1) >= 250f)
		{
			bVar0 = true;
			iVar1 = 0;
			while (iVar1 <= 10)
	...
	if (DOES_ENTITY_EXIST(Local_116[0 /*4*/]) && !func_198(Local_116[0 /*4*/]))
	{
		bVar0 = true;
		iVar1 = 0;
		while (iVar1 <= 10)
...
int func_106()
{
	...
	{
		if (VMAG2(GET_ENTITY_VELOCITY(PLAYER_PED_ID())) > 1369f && !func_114())
		{
			return 0;
		}
	}
...
void func_109(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_124(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_137(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_158()) || Global_105612) || Global_25767) || func_157()) || func_156(8, -1)) || func_155()) || func_154()) || func_153()) || func_152()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_158()) || Global_25767) || func_157()) || func_156(8, -1)) || func_153()) || func_155()) || func_154()) || func_152()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_158()) || Global_105612) || Global_25767) || func_157()) || func_156(8, -1)) || func_155()) || func_154()) || func_152()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_158() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_156(8, -1)) || func_152()) || func_151()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_158()) || Global_25767) || func_157()) || func_156(8, -1)) || func_154()) || func_153()) || func_152()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_158()) || Global_105612) || Global_25767) || func_157()) || func_156(8, -1)) || func_153()) || func_151()) || func_155()) || func_154()) || func_152())
						{
							return 0;
						}
						break;
...
int func_167()
{
	...
	if (func_198(PLAYER_PED_ID()))
	{
		vVar0 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
		GET_GROUND_Z_FOR_3D_COORD(vVar0, &fVar3, 0, 0);
		if ((vVar0.y < 2149.042f && (IS_PED_IN_FLYING_VEHICLE(PLAYER_PED_ID()) || (IS_ENTITY_IN_AIR(PLAYER_PED_ID()) && (vVar0.z - fVar3) >= 7.5f))) && (vVar0.z - fVar3) >= 3f)
		{
			return 0;
		}
		if (vVar0.z >= 100f && IS_PED_IN_FLYING_VEHICLE(PLAYER_PED_ID()))
		{
			return 0;
		}
	}
...
void func_168(bool bParam0, bool bParam1)
{
	...
	func_192(0);
	func_190();
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(3054.991f, 1995.887f, -20f, 3140.817f, 2225.639f, 10.453f, 1, 1);
