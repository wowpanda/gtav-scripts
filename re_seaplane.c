...
void __EntryFunction__()
{
	...
	iLocal_41 = 49;
	iLocal_42 = 64;
	fLocal_49 = "RE_SeaPlane1";
	fLocal_50 = "RE_SeaPlane2";
	vLocal_51 = { 0f, 0f, 0f };
		...
		case 1:
			switch (iLocal_54)
			{
				...
				case 4:
					...
					{
						BRAIN::REQUEST_WAYPOINT_RECORDING(fLocal_49);
						iLocal_54++;
					}
					break;
				
				case 5:
					if (BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(fLocal_49))
					{
						BRAIN::REQUEST_WAYPOINT_RECORDING(fLocal_50);
						iLocal_54++;
					}
					break;
				
				case 6:
					if ((((((STREAMING::HAS_MODEL_LOADED(iLocal_60) && STREAMING::HAS_MODEL_LOADED(iLocal_59)) && STREAMING::HAS_MODEL_LOADED(iLocal_61)) && STREAMING::HAS_MODEL_LOADED(iLocal_63)) && STREAMING::HAS_MODEL_LOADED(iLocal_62)) && BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(fLocal_49)) && BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(fLocal_50))
					{
...
void func_46(void fParam0, int iParam1)
{
...
int func_48()
{
	switch (func_49(&Global_25336, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_47[iParam0 /*6*/]))
	{
		...
		switch (iParam0)
		{
			...
			case 1:
				...
				fVar68 = "WORLD_HUMAN_HANG_OUT_STREET";
		...
		func_58(Local_47[iParam0 /*6*/], fVar16, iVar17, fVar18, iVar19, iVar20);
		...
		if (!MISC::IS_STRING_NULL_OR_EMPTY(fVar68))
		{
			BRAIN::TASK_START_SCENARIO_IN_PLACE(Local_47[iParam0 /*6*/], fVar68, -1, 0);
		}
		if (iVar11 > 0)
		{
...
void func_58(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5)
{
			...
			case 2:
				...
				switch (Local_47[iParam0 /*6*/].f_3)
				{
					...
					case 2:
						...
						BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(fVar4, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), &iVar1);
						BRAIN::WAYPOINT_RECORDING_GET_NUM_POINTS(fVar4, &iVar3);
						BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(fVar4, ENTITY::GET_ENTITY_COORDS(Local_47[iParam0 /*6*/], true), &iVar2);
						...
						if (((((iParam0 == 0 && iLocal_57 != iVar1) && iVar1 > iVar2) || ((iParam0 == 2 && iLocal_58 != iVar1) && iVar1 > iVar2)) && func_198(PED::GET_VEHICLE_PED_IS_USING(Local_47[iParam0 /*6*/]))) && !PED::IS_PED_BEING_STUNNED(Local_47[iParam0 /*6*/], 0))
						{
							...
							BRAIN::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_47[iParam0 /*6*/], PED::GET_VEHICLE_PED_IS_USING(Local_47[iParam0 /*6*/]), fVar4, 786469, 0, iVar5, iVar1, -1f, 0, 6f);
						}
						if ((!func_97(Local_47[iParam0 /*6*/], -235832601, 1) && BRAIN::GET_SCRIPT_TASK_STATUS(Local_47[iParam0 /*6*/], -235832601) == 7) && !func_97(Local_47[iParam0 /*6*/], 538064912, 1))
						{
							...
							if (func_198(PED::GET_VEHICLE_PED_IS_USING(Local_47[iParam0 /*6*/])) && VEHICLE::_0x2467A2D807D37CA3(PED::GET_VEHICLE_PED_IS_USING(Local_47[iParam0 /*6*/])))
							{
						...
						if (!func_88(iParam0, 4))
						{
							if (PED::IS_PED_BEING_STUNNED(Local_47[iParam0 /*6*/], 0))
							{
								...
								if (!func_88(iParam0, 5) && VEHICLE::_0x2467A2D807D37CA3(PED::GET_VEHICLE_PED_IS_USING(Local_47[iParam0 /*6*/])))
								{
									VEHICLE::SET_BOAT_ANCHOR(PED::GET_VEHICLE_PED_IS_USING(Local_47[iParam0 /*6*/]), true);
								}
							}
						...
						BRAIN::WAYPOINT_RECORDING_GET_COORD(fVar4, (iVar3 - 1), &vVar6);
						if (ENTITY::IS_ENTITY_AT_COORD(Local_47[iParam0 /*6*/], vVar6, 8f, 8f, 8f, false, true, 0))
						{
							...
							func_67(5);
							BRAIN::REMOVE_WAYPOINT_RECORDING(fVar4);
							Local_47[iParam0 /*6*/].f_3++;
						}
						break;
...
int func_124(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_161(Global_105220.f_24966.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_158()) || Global_25279) || func_157()) || func_156(8, -1)) || func_153()) || func_155()) || func_154()) || func_152()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_158()) || Global_104267) || Global_25279) || func_157()) || func_156(8, -1)) || func_155()) || func_154()) || func_152()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_158() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_156(8, -1)) || func_152()) || func_151()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_158()) || Global_25279) || func_157()) || func_156(8, -1)) || func_154()) || func_153()) || func_152()) || Global_105220.f_7659.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_158()) || func_154()) || Global_104267) || Global_25279) || func_157()) || Global_37057) || func_156(8, -1)) || func_153()) || func_151()) || func_152()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_158()) || Global_104267) || Global_25279) || func_157()) || func_156(8, -1)) || func_153()) || func_151()) || func_155()) || func_154()) || func_152())
						{
							return 0;
						}
						break;
...
void func_188()
{
	BRAIN::REMOVE_WAYPOINT_RECORDING(fLocal_49);
	BRAIN::REMOVE_WAYPOINT_RECORDING(fLocal_50);
}
