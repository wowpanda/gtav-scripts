...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		if (SYSTEM::VDIST2(func_60(), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) < 40000f)
		{
			if (CAM::IS_SCREEN_FADED_IN())
			{
				if (PLAYER::IS_PLAYER_CONTROL_ON(CAM::_0xDC9DA9E8789F5246()))
				{
					Global_19E56.f_61D5.f_8 = 1;
				}
			}
		}
	}
...
void func_6(int iParam0)//Position - 0x32D
{
	...
	{
		case 0:
			Global_19E56.f_61D5 = 1;
			Global_19E56.f_61D5.f_3 = 1;
			break;
		
		case 1:
			Global_19E56.f_61D5 = 2;
			Global_19E56.f_61D5.f_4 = 1;
			break;
		
		case 2:
			Global_19E56.f_61D5 = 3;
			Global_19E56.f_61D5.f_5 = 1;
			break;
		
		case 3:
			Global_19E56.f_61D5 = 4;
			Global_19E56.f_61D5.f_6 = 1;
			break;
		
		case 4:
			Global_19E56.f_61D5 = 0;
			Global_19E56.f_61D5.f_7 = 1;
			break;
	}
}
...
void func_7(int iParam0)//Position - 0x3C9
{
	...
	iVar0 = 0;
	STATS::STAT_GET_INT(joaat("num_stock_races_completed"), &iVar0, 4294967295);
	if (iVar0 < iParam0 + 1)
	{
...
void func_8()//Position - 0x3F9
{
	...
	StringIntConCat(&Var0, Global_19E56.f_61D5 + 1, 16);
	func_9(&Var0, 4294967295);
}

void func_9(char* sParam0, int iParam1)//Position - 0x420
{
...
void func_11()//Position - 0x443
{
	...
	{
		func_12(&Global_19E54);
		Global_19E54 = 4294967295;
		iLocal_149 = 2;
		iLocal_148 = 3;
	}
}
...
void func_13()//Position - 0x4A8
{
	...
	if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("country_race")) == 0)
	{
		if (SCRIPT::HAS_SCRIPT_LOADED("Country_Race"))
		{
			if (iLocal_149 == 2)
			{
				iLocal_149 = func_17(&Global_19E54, 2, 9, 0, 0);
			}
...
void func_23()//Position - 0xA16
{
	if (func_43())
	{
		if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), func_60(), 5f, 5f, 5f, 1, true, 0))
		{
			PAD::DISABLE_CONTROL_ACTION(0, 74, 1);
			PED::SET_IK_TARGET(iLocal_151, 1, AUDIO::_0x0626A247D2405330(), 0, 0f, 0f, 0f, 0, 150, 400);
			if (func_41())
			{
				if (func_38())
				{
					...
					func_33();
					func_32();
					if (((!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !func_31(1)) && !func_30(0)) && SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appinternet")) == 0)
					{
						if (PAD::IS_CONTROL_JUST_PRESSED(2, 51))
						{
							...
							ENTITY::FREEZE_ENTITY_POSITION(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), true);
							HUD::HIDE_HELP_TEXT_THIS_FRAME();
							iLocal_148 = 1;
						}
					}
...
void func_28()//Position - 0xB94
{
	...
	{
		if (!func_25("CRACECAR") && SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appinternet")) == 0)
		{
			GRAPHICS::SET_SCRIPT_GFX_DRAW_BEHIND_PAUSEMENU(1);
...
void func_29(char* sParam0, int iParam1, bool bParam2, int iParam3)//Position - 0xBD1
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
...
{
	if (((((CAM::GET_FOLLOW_VEHICLE_CAM_VIEW_MODE() != 3 && CAM::GET_FOLLOW_VEHICLE_CAM_VIEW_MODE() != 4) && !CAM::IS_GAMEPLAY_CAM_LOOKING_BEHIND()) && PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246())) && func_34(iLocal_151)) && ENTITY::GET_ENTITY_SPEED(AUDIO::_0x0626A247D2405330()) < 20f)
	{
		if (iLocal_153)
		{
			if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
...
{
	if ((!Global_19E56.f_61D5.f_9 && !Global_19E56.f_61D5.f_8) && SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), func_60()) < 84100f)
	{
		Global_19E56.f_61D5.f_9 = func_54();
		func_51();
		if (!Global_19E56.f_61D5.f_9)
		{
			if (func_61(iLocal_151) && func_61(iLocal_150))
			{
				if (!HUD::HAS_THIS_ADDITIONAL_TEXT_LOADED("C_RACE", 3) && SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("mission_stat_watcher")) <= 0)
				{
	...
	{
		if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), func_60()) > 90000f)
		{
			func_15(&iLocal_151, 1);
			func_14(&iLocal_150, 1);
			if (Global_19E56.f_61D5.f_9)
			{
				Global_19E56.f_61D5.f_9 = 0;
			}
			if (Global_19E56.f_61D5.f_8)
			{
				Global_19E56.f_61D5.f_8 = 0;
			}
		}
		if (Global_19E56.f_61D5.f_9)
		{
			...
			if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), func_60(), 5f, 5f, 5f, 1, true, 0))
			{
				if (HUD::HAS_THIS_ADDITIONAL_TEXT_LOADED("C_RACE", 3))
				{
					if (!func_25("CRACEDISRUPT") && SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appinternet")) == 0)
					{
						GRAPHICS::SET_SCRIPT_GFX_DRAW_BEHIND_PAUSEMENU(1);
...
void func_44(bool bParam0)//Position - 0x1721
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_150) && !ENTITY::DOES_ENTITY_EXIST(iLocal_151))
	{
		...
		if (STREAMING::HAS_MODEL_LOADED(func_50()) && STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_motox_02")))
		{
			...
			BRAIN::TASK_START_SCENARIO_IN_PLACE(iLocal_151, "WORLD_HUMAN_STAND_IMPATIENT", 4294967295, 1);
...
void func_51()//Position - 0x1A2D
{
	if (func_61(iLocal_151))
	{
		if ((!PED::IS_PED_FLEEING(iLocal_151) && !PED::IS_PED_IN_COMBAT(iLocal_151, 0)) && !PED::IS_PED_RAGDOLL(iLocal_151))
		{
			...
			if (func_52(iLocal_150) || Global_19E56.f_61D5.f_9)
			{
				PED::_0xF1C03A5352243A30(iLocal_151);
				BRAIN::TASK_COMBAT_PED(iLocal_151, AUDIO::_0x0626A247D2405330(), 0, 16);
			}
			fLocal_154 = ENTITY::GET_ENTITY_SPEED(AUDIO::_0x0626A247D2405330());
		}
...
int func_54()//Position - 0x1B9A
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_150))
	{
		...
		else
		{
			...
			if (WEAPON::HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(AUDIO::_0x0626A247D2405330(), iLocal_150, 0, 4294967295))
			{
				return 1;
			}
		}
...
float func_55(int iParam0, vector3 vParam1, bool bParam2)//Position - 0x1C3E
{
	vector3 vVar0;
...
void func_56()//Position - 0x1C78
{
	...
	if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("country_race")) == 0)
	{
		if (SYSTEM::VDIST2(func_60(), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) > 160000f)
		{
			func_62(0);
		}
	}
...
void func_62(bool bParam0)//Position - 0x1EBE
{
	...
	if (func_61(iLocal_151))
	{
		...
		{
			BRAIN::TASK_WANDER_STANDARD(iLocal_151, 1193033728, 0);
		}
	}
