...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_282(AUDIO::_0x0626A247D2405330()))
	{
		iLocal_262 = PED::GET_PED_RELATIONSHIP_GROUP_HASH(AUDIO::_0x0626A247D2405330());
	}
	if (func_281(Local_81.f_1C[0]))
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_81.f_1C[0], iLocal_262);
...
void func_1()//Position - 0x17C
{
	switch (iLocal_83)
	{
		...
		case 1:
			...
			if (!iLocal_94)
			{
				if (func_282(Local_81.f_1C[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
				{
					iLocal_87 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_88, vLocal_89, 2);
					BRAIN::TASK_SYNCHRONIZED_SCENE(Local_81.f_1C[0], iLocal_87, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
			...
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_87))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_87) > 0.29f)
				{
					if (!iLocal_95)
					{
						func_220(&uLocal_97, 2, AUDIO::_0x0626A247D2405330(), "Trevor", 0, 1);
						func_220(&uLocal_97, 5, Local_81.f_1C[0], "Josh", 0, 1);
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -1107.107f, 290.4275f, 62.9487f, -1102.038f, 291.3421f, 66.27895f, 2f, 0, true, 0))
				{
					func_232("Too close, stopping scene");
					if (func_281(Local_81.f_1C[0]))
					{
						NETWORK::_0x5E3AA4CA2B6FB0EE(Local_81.f_1C[0]);
				...
				if (func_209(Local_81.f_1C[0], AUDIO::_0x0626A247D2405330(), 1) > 17.5f)
				{
					if (func_281(Local_81.f_1C[0]))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Local_81.f_1C[0], -8f, 1);
						NETWORK::_0x5E3AA4CA2B6FB0EE(Local_81.f_1C[0]);
					}
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_85))
					{
				...
				if ((PED::IS_PED_INJURED(Local_81.f_1C[0]) || FIRE::IS_ENTITY_ON_FIRE(Local_81.f_1C[0])) || FIRE::IS_EXPLOSION_IN_SPHERE(4294967295, unk_0x8000C77B5F336760(Local_81.f_1C[0], true), 5f))
				{
					if (func_281(Local_81.f_1C[0]))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Local_81.f_1C[0], -8f, 1);
		...
		case 2:
			...
			if (func_281(Local_81.f_1C[0]))
			{
				if (iLocal_96 == 1)
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_84);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1115.44f, 317.46f, 65.98f, 1f, 30000, 1048576000, 0, 1193033728);
					BRAIN::TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "enter", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "idle_b", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_84);
				}
				else
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_84);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1115.44f, 317.46f, 65.98f, 1f, 30000, 0.25f, 1, 1193033728);
					BRAIN::TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "enter", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "idle_b", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_84);
				}
				BRAIN::TASK_PERFORM_SEQUENCE(Local_81.f_1C[0], iLocal_84);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_84);
				ENTITY::SET_ENTITY_HEALTH(Local_81.f_1C[0], false);
				if (iLocal_96 == 0)
				{
					PED::FORCE_PED_MOTION_STATE(Local_81.f_1C[0], 3626484699, false, 0, 1);
				}
			}
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0))
			{
...
{
	func_205(58, 2, 1);
	while (!func_202(2478434089, 0, 4, 58, 6000, 6000, 65, 0, 4294967295, 17, 1))
	{
		SYSTEM::WAIT(0);
	}
	func_3(322, 1);
...
void func_13(int iParam0)//Position - 0x13FD
{
	if (iParam0 == 1)
	{
...
void func_15()//Position - 0x1444
{
	StringCopy(&Global_1170D, "", 16);
	StringCopy(&Global_11711, "", 16);
}

void func_16()//Position - 0x1460
{
	int iVar0;
...
void func_20(int iParam0)//Position - 0x1532
{
	if (iParam0 == 1)
	{
		Global_8F3A = 1;
...
void func_21()//Position - 0x154B
{
	func_22(&Global_18531);
}

void func_22(var uParam0)//Position - 0x155B
{
	int iVar0;
	int iVar1;
...
void func_23(var uParam0)//Position - 0x1AEB
{
	*uParam0 = 4294967295;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_24(var uParam0)//Position - 0x1B06
{
	func_25(&(uParam0->f_C));
	*uParam0 = { 0f, 0f, 0f };
...
void func_25(var uParam0)//Position - 0x1B35
{
	int iVar0;
...
void func_26(var uParam0)//Position - 0x1BE6
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_27(var uParam0)//Position - 0x1C04
{
	int iVar0;
...
void func_28(var uParam0)//Position - 0x1CE5
{
	*uParam0 = 4294967281;
}

void func_29()//Position - 0x1CF3
{
	StringCopy(&Global_17990, "", 32);
	func_22(&Global_17998);
}

void func_30()//Position - 0x1D0D
{
...
int func_32(int iParam0, int iParam1, int iParam2)//Position - 0x1E4B
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x200A
{
	int iVar0;
...
int func_34(int iParam0)//Position - 0x2096
{
	switch (iParam0)
	{
...
int func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x20D1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_36(int iParam0, int iParam1, int iParam2)//Position - 0x28E7
{
	int iVar0;
	int iVar1;
...
int func_37(int iParam0, int iParam1, int iParam2)//Position - 0x2971
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_38(int iParam0, int iParam1, int iParam2)//Position - 0x2A4F
{
...
int func_39(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x2A7A
{
	var uVar0;
	int iVar1;
...
int func_40(int iParam0, int iParam1, int iParam2)//Position - 0x307E
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_41(int iParam0, int iParam1, int iParam2)//Position - 0x3117
{
	int iVar0;
	int iVar1;
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x31B8
{
	int iVar0;
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x34BF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_44(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x4074
{
	int iVar0;
...
int func_45(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4358
{
	int iVar0;
...
int func_46(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x461F
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4656
{
	int iVar0;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x467F
{
	*iParam2 = 4294967197;
	switch (iParam0)
	{
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4949
{
	int iVar0;
...
int func_50(int iParam0, int iParam1, int iParam2)//Position - 0x4BD3
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_51(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4D2A
{
	int iVar0;
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4DC2
{
	switch (iParam0)
	{
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4E90
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_54(int iParam0, int iParam1)//Position - 0x4FEC
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_55(int iParam0)//Position - 0x5393
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_56(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x53F4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_57(int iParam0, int iParam1)//Position - 0x54F0
{
	int iVar0;
...
int func_58(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x562E
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x570E
{
	switch (iParam0)
	{
		case 0:
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5794
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5A11
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5E36
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_63(int iParam0, int iParam1)//Position - 0x6129
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0, int iParam1)//Position - 0x616F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x61CF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_66(int iParam0)//Position - 0x6253
{
...
void func_67(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x630B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_68(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x6355
{
	int iVar0;
...
int func_69(var uParam0)//Position - 0x6385
{
	int iVar0;
	int iVar1;
...
int func_70(int iParam0, int iParam1, int iParam2)//Position - 0x63B9
{
	int iVar0;
	var uVar1;
...
bool func_71(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x63EB
{
	int iVar0;
...
int func_72(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x7EA4
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_73(int iParam0)//Position - 0x8DC6
{
	if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11569[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8E17
{
	int iVar0;
...
int func_75(int iParam0)//Position - 0x8EAD
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_76(int iParam0, int iParam1)//Position - 0x8F5D
{
	int iVar0;
	struct<10> Var1;
...
void func_77(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x988C
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar2;
...
void func_78(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x99B6
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_79(int iParam0, int iParam1)//Position - 0x99FE
{
	int iVar0;
	struct<17> Var1;
...
void func_80(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB846
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar2;
...
int func_81(int iParam0)//Position - 0xBA30
{
	switch (iParam0)
	{
		case 0:
...
void func_82(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xBAE0
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBB51
{
	func_147();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_84(int iParam0, int iParam1)//Position - 0xBBA3
{
	switch (iParam0)
	{
		case 0:
...
void func_85(int iParam0)//Position - 0xBC93
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
bool func_151(int iParam0)//Position - 0x1FAAF
{
	return iParam0 < 3;
}

void func_152(char* sParam0, int iParam1)//Position - 0x1FABB
{
...
void func_154()//Position - 0x1FB5B
{
	int iVar0;
...
struct<2> func_155(int iParam0)//Position - 0x1FC58
{
	struct<2> Var0;
	char[] cVar1[8];
...
void func_157(int iParam0, int iParam1)//Position - 0x200DE
{
...
void func_158(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x20128
{
...
void func_159(int iParam0, int iParam1, int iParam2)//Position - 0x201C5
{
	struct<4> Var0;
	char* sVar1;
...
void func_160(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x20204
{
...
void func_161(int iParam0, var uParam1)//Position - 0x20249
{
	switch (iParam0)
	{
		case 0:
...
int func_163(int iParam0)//Position - 0x21521
{
	switch (iParam0)
	{
		case 0:
...
void func_164(int iParam0)//Position - 0x21867
{
	Global_8F3C = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_165()//Position - 0x21879
{
	if (Global_1620F)
	{
		func_154();
...
char* func_166(var uParam0)//Position - 0x218AC
{
	uParam0 = uParam0;
	return "";
}

void func_167()//Position - 0x218BC
{
	vector3 vVar0[24];
...
void func_168(int iParam0, int iParam1)//Position - 0x218FF
{
	Global_1620A = iParam0;
	Global_1620B = iParam1;
}

void func_169()//Position - 0x21913
{
	if (Global_11723 != 6)
	{
	}
...
void func_170(var uParam0)//Position - 0x2194B
{
...
void func_171(int iParam0, bool bParam1)//Position - 0x21988
{
	struct<26> Var0;
	int iVar1;
	bool bVar2;
...
int func_172(int iParam0)//Position - 0x21B0F
{
	switch (iParam0)
	{
		case 0:
...
void func_173(int iParam0)//Position - 0x21E96
{
	func_175(iParam0, 1);
...
int func_174()//Position - 0x21ECC
{
	return (Global_19E56.f_2704.f_15 + Global_19E56.f_4872.f_17C);
}

void func_175(var uParam0, bool bParam1)//Position - 0x21EE8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_176(int iParam0)//Position - 0x2220C
{
...
void func_177(int iParam0)//Position - 0x2223F
{
	switch (iParam0)
	{
		case 30:
...
void func_178(int iParam0, bool bParam1)//Position - 0x22274
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_179(int iParam0, int iParam1, bool bParam2)//Position - 0x222D1
{
	if (iParam0 == 4294967295)
	{
		return;
...
bool func_180(int iParam0, int iParam1)//Position - 0x2230C
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
void func_181(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x2232F
{
	if (iParam0 != 198)
	{
		if (Global_11625)
...
void func_182(int iParam0, int iParam1)//Position - 0x2238A
{
	switch (iParam0)
	{
		case 12:
...
void func_183(int iParam0, bool bParam1)//Position - 0x22473
{
	if (bParam1)
	{
...
bool func_184(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x2249C
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_186()//Position - 0x22E34
{
	return Global_6374;
}

int func_187(var uParam0, int iParam1)//Position - 0x22E3F
{
	int iVar0;
...
int func_188(int iParam0)//Position - 0x2667F
{
	switch (iParam0)
	{
		case 46:
...
void func_189(int iParam0, bool bParam1)//Position - 0x26771
{
	switch (iParam0)
	{
		case 46:
...
void func_190(int iParam0, bool bParam1)//Position - 0x267C2
{
	int iVar0;
...
void func_191(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x26828
{
	func_192(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_192(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2684A
{
	int iVar0;
...
void func_193()//Position - 0x26A1E
{
	int iVar0;
...
int func_194(int iParam0)//Position - 0x26B3E
{
	int iVar0;
	int iVar1;
...
int func_197(int iParam0)//Position - 0x26D79
{
...
void func_198(int iParam0, int iParam1)//Position - 0x26DA6
{
...
int func_199(char* sParam0)//Position - 0x26DE3
{
	int iVar0;
...
int func_200()//Position - 0x26E43
{
	return func_201(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_201(char* sParam0, int iParam1)//Position - 0x26E54
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_202(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x26E9D
{
	struct<14> Var0;
...
void func_203(int iParam0)//Position - 0x26FB8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_204(int iParam0)//Position - 0x2707C
{
	switch (iParam0)
	{
		case 0:
...
void func_205(int iParam0, int iParam1, bool bParam2)//Position - 0x270E6
{
	Global_BFD = iParam0;
...
void func_206()//Position - 0x27290
{
	char cVar0[64];
	char cVar1[64];
	char* sVar2;
...
void func_207()//Position - 0x27311
{
	if (func_91(14))
	{
...
int func_208()//Position - 0x273B3
{
	func_154();
	return Global_19E56.f_933.f_21B.f_10CD;
}

float func_209(int iParam0, int iParam1, bool bParam2)//Position - 0x273CC
{
	vector3 vVar0;
	vector3 vVar1;
...
bool func_210(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2742A
{
...
int func_211(char* sParam0, int iParam1, bool bParam2)//Position - 0x27478
{
	Global_3DCF = 0;
...
void func_212()//Position - 0x27744
{
	int iVar0;
...
void func_213()//Position - 0x27776
{
...
void func_216()//Position - 0x278CB
{
	int iVar0;
...
bool func_217(int iParam0, int iParam1)//Position - 0x27923
{
	switch (iParam0)
	{
		case 5:
...
void func_218()//Position - 0x2795E
{
...
void func_219(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x279B5
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
void func_220(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x27A0B
{
...
void func_221(int iParam0, int iParam1, int iParam2)//Position - 0x27AA6
{
...
void func_222(int iParam0, bool bParam1)//Position - 0x27ADA
{
...
void func_223(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x27B16
{
	int iVar0;
	...
	if (iParam1 == 1)
	{
		...
		{
			if (func_281(AUDIO::_0x0626A247D2405330()))
			{
...
void func_224(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x27BBE
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_228(CAM::_0xDC9DA9E8789F5246())) && !func_226(CAM::_0xDC9DA9E8789F5246(), 0)) && !func_225()) && !bParam4)
			{
				ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_228(CAM::_0xDC9DA9E8789F5246())) && !bParam4)
		{
			ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), false);
		}
		Global_11623 = 0;
...
int func_227(int iParam0, bool bParam1)//Position - 0x27D4F
{
	int iVar0;
	int iVar1;
...
int func_228(int iParam0)//Position - 0x27D90
{
...
bool func_229()//Position - 0x27DD2
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_240006, 3);
}

int func_230(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x27DE3
{
	int iVar0;
...
void func_231(int iParam0)//Position - 0x27E16
{
	if (iParam0 == 1)
	{
...
void func_232(char* sParam0)//Position - 0x27E39
{
	sParam0 = sParam0;
}

void func_233()//Position - 0x27E45
{
	int iVar0;
	vector3 vVar1;
	float fVar2;
	...
	if (CUTSCENE::_0xB56BBBCC2955D9CB())
	{
		...
		if (func_281(Local_81.f_1C[0]))
		{
			CUTSCENE::_0x2A56C06EBEF2B0D9("Josh", Local_81.f_1C[0], 0);
		}
	}
	switch (iLocal_83)
	{
		case 0:
			if (func_249(1, 1093140480, 0))
			{
				...
				if (func_281(Local_81.f_1C[0]))
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_81.f_1C[0], "Josh", 0, 0, 0);
				}
				if (func_281(AUDIO::_0x0626A247D2405330()))
				{
		...
		case 1:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
			{
				...
				if (!iLocal_94)
				{
					...
					func_234(AUDIO::_0x0626A247D2405330(), -1104.65f, 289.02f, 63.25f, 16.6717f, 0, 1);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					if (func_282(Local_81.f_1C[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
					{
						iLocal_87 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_88, vLocal_89, 2);
						BRAIN::TASK_SYNCHRONIZED_SCENE(Local_81.f_1C[0], iLocal_87, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, iLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
						func_232("Done Josh leadout anim on Josh exit state");
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_85);
						PED::FORCE_PED_MOTION_STATE(Local_81.f_1C[0], 2423432979, false, 1, 1);
						iLocal_94 = 1;
					}
				}
			}
			...
			if (!CUTSCENE::IS_CUTSCENE_ACTIVE())
			{
				...
				if (!iLocal_94)
				{
					...
					{
						iLocal_87 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_88, vLocal_89, 2);
						BRAIN::TASK_SYNCHRONIZED_SCENE(Local_81.f_1C[0], iLocal_87, "rcmjosh1leadinout", "leadout_josh", 8f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, iLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
						func_232("Done Josh leadout anim on non active cutscene");
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_85);
						MISC::_0x1327E2FE9746BAEE(Local_81.f_1C[0], 0, 0);
						iLocal_94 = 1;
					}
				}
				iLocal_83 = 2;
...
int func_234(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)//Position - 0x284C7
{
	bool bVar0;
	float fVar1;
...
void func_235(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x28523
{
	int iVar0;
...
Vector3 func_236(int iParam0)//Position - 0x286E1
{
	return unk_0x8000C77B5F336760(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_237(bool bParam0)//Position - 0x286F4
{
	int iVar0;
...
void func_238(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x28731
{
	func_239(vParam0, vParam1, fParam2, vParam3, fParam4, vParam5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

void func_239(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x2875B
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_240(vector3 vParam0)//Position - 0x28B4F
{
...
int func_241(int iParam0, int iParam1, bool bParam2)//Position - 0x28B79
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_242(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x28BEA
{
...
int func_243(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)//Position - 0x28CC3
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_244(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x28FB9
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_245(vector3 vParam0)//Position - 0x2906D
{
	float fVar0;
	float fVar1;
...
void func_246(int iParam0)//Position - 0x290AC
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
void func_247()//Position - 0x29111
{
	int iVar0;
...
int func_248(int iParam0)//Position - 0x29131
{
	if (func_281(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
int func_249(int iParam0, float fParam1, int iParam2)//Position - 0x2915B
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
		...
		{
			if (!func_255(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_254(AUDIO::_0x0626A247D2405330(), 3466132403))
				{
...
bool func_250()//Position - 0x2922F
{
	bool bVar0;
...
void func_251()//Position - 0x29252
{
	Global_3960 = 0;
	func_218();
}

int func_252()//Position - 0x29262
{
...
void func_253()//Position - 0x29284
{
...
int func_254(int iParam0, int iParam1)//Position - 0x292D5
{
	if (func_282(iParam0))
	{
...
int func_255(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x29308
{
...
void func_256(int iParam0)//Position - 0x29497
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_257()//Position - 0x294C3
{
	func_258();
	if (CUTSCENE::_0xB56BBBCC2955D9CB())
	{
	...
	{
		case 0:
			if (!func_5(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, true, 0))
			{
		...
		case 1:
			if (!func_5(0))
			{
				if (!bLocal_90)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, true, 0))
					{
						if (func_282(Local_81.f_1C[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
						{
							iLocal_86 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_88, vLocal_89, 2);
							BRAIN::TASK_SYNCHRONIZED_SCENE(Local_81.f_1C[0], iLocal_86, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1148846080, 0);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, iLocal_86, "leadin_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
							BRAIN::TASK_LOOK_AT_ENTITY(AUDIO::_0x0626A247D2405330(), Local_81.f_1C[0], 4294967295, 0, 2);
							BRAIN::TASK_LOOK_AT_ENTITY(Local_81.f_1C[0], AUDIO::_0x0626A247D2405330(), 4000, 2060, 2);
				...
				else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_86))
				{
					...
					if (func_209(AUDIO::_0x0626A247D2405330(), Local_81.f_1C[0], 1) <= 2.5f)
					{
...
void func_258()//Position - 0x29853
{
	func_260(0);
	func_253();
	func_259();
...
void func_259()//Position - 0x29868
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
		{
			if (func_255(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_260(int iParam0)//Position - 0x298C0
{
	if (func_264())
	{
		return;
...
void func_261(int iParam0)//Position - 0x298F3
{
	if (func_264())
	{
		return;
...
void func_262(bool bParam0, bool bParam1)//Position - 0x2996D
{
	if (bParam0)
	{
		if (func_263(0))
...
int func_263(int iParam0)//Position - 0x299E1
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
bool func_264()//Position - 0x29A3B
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

void func_265(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x29A4D
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_11723 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_267(Global_11724, Global_11726, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
float func_266(char* sParam0)//Position - 0x29D32
{
	HUD::_BEGIN_TEXT_COMMAND_WIDTH(sParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_267(int iParam0, int iParam1, int iParam2)//Position - 0x29D45
{
	struct<2> Var0;
	int iVar1;
...
char* func_268(int iParam0)//Position - 0x29E1C
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_269(int iParam0)//Position - 0x29F6F
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_270(int iParam0)//Position - 0x29FA3
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_271(int iParam0)//Position - 0x29FD7
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_272(int iParam0)//Position - 0x2A00B
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_273(int iParam0)//Position - 0x2A03F
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_274(int iParam0)//Position - 0x2A07D
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_275(int iParam0)//Position - 0x2A0B1
{
	struct<2> Var0;
...
int func_276(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2A11A
{
	if (((!func_278(0) || Global_11732) || Global_11727 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_11723)
...
bool func_277(bool bParam0)//Position - 0x2A232
{
	if (bParam0)
	{
...
int func_278(int iParam0)//Position - 0x2A25B
{
	if (Global_8D15 == 15)
	{
		return 0;
...
bool func_279(int iParam0)//Position - 0x2A27D
{
	return func_280(iParam0, Global_8D15);
}

int func_280(int iParam0, int iParam1)//Position - 0x2A28E
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_281(int iParam0)//Position - 0x2A46F
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
int func_282(int iParam0)//Position - 0x2A490
{
	if (func_281(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_283(var uParam0, bool bParam1, bool bParam2)//Position - 0x2A4B0
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_281(uParam0->f_1C[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_281(uParam0->f_23[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_281(uParam0->f_29[iVar0]))
		{
...
int func_284(var uParam0)//Position - 0x2A5A5
{
	int iVar0[2];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_77)
	{
		case 0:
			...
			func_295(&(uParam0->f_30), "rcmjosh1", "idle", 0);
			iLocal_77 = 1;
			break;
		
		case 1:
			if (!func_294(&iVar0) || !func_292(&(uParam0->f_30)))
			{
				return 0;
			}
			iLocal_77 = 2;
		...
		case 2:
			...
			{
				if (!func_289(&(uParam0->f_1C[0]), 58, -1104.72f, 291.02f, 64.39f, 138.35f, "JOSH LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
...
int func_285(bool bParam0, bool bParam1)//Position - 0x2A712
{
	int iVar0;
	...
	if (bParam1)
	{
		OBJECT::_SET_DOOR_AJAR_ANGLE(3499548916, 0f, 0, 0);
		OBJECT::_SET_DOOR_ACCELERATION_LIMIT(904342475, 4, 0, 1);
		iVar0++;
	}
	else
...
void func_286(int iParam0, bool bParam1)//Position - 0x2A780
{
	vector3 vVar0;
	float fVar1;
...
void func_287(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0x2A7F4
{
	func_288(iParam0);
...
void func_288(int iParam0)//Position - 0x2A836
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_289(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0x2A8D2
{
...
int func_290(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0x2A92E
{
	int iVar0;
...
int func_291(var uParam0, int iParam1)//Position - 0x2A9BC
{
	int iVar0;
...
int func_292(var uParam0)//Position - 0x2AA02
{
	if (func_293(uParam0))
	{
...
int func_293(var uParam0)//Position - 0x2AA2C
{
...
int func_294(int iParam0)//Position - 0x2AA51
{
	int iVar0;
...
void func_295(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2AA82
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
void func_297()//Position - 0x2AAE2
{
	func_247();
	if (func_310())
	{
	...
	func_309(&(Local_81.f_1C[0]), 1, 1, 1);
...
void func_298(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x2AB6C
{
...
void func_299(var uParam0, bool bParam1)//Position - 0x2AB8C
{
	func_300(&(uParam0->f_29), bParam1);
}

void func_300(var uParam0, bool bParam1)//Position - 0x2AB9E
{
	int iVar0;
...
void func_301(int iParam0, bool bParam1)//Position - 0x2ABDC
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_302(int iParam0)//Position - 0x2AC17
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_303(var uParam0, bool bParam1)//Position - 0x2AC42
{
	func_304(&(uParam0->f_23), bParam1);
}

void func_304(var uParam0, bool bParam1)//Position - 0x2AC54
{
	int iVar0;
...
void func_305(int iParam0)//Position - 0x2AC91
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_306(var uParam0, int iParam1)//Position - 0x2ACC9
{
	func_307(&(uParam0->f_1C), iParam1);
}

void func_307(var uParam0, int iParam1)//Position - 0x2ACDB
{
	int iVar0;
...
void func_308(int iParam0)//Position - 0x2AD1C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_309(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2AD5D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_311(bool bParam0)//Position - 0x2AE4E
{
	int iVar0;
...
void func_312(char* sParam0, int iParam1)//Position - 0x2AF1E
{
	if (Global_16C30 != 12)
	{
...
int func_313(char* sParam0, int iParam1, int iParam2)//Position - 0x2AF46
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
...
int func_314(char* sParam0)//Position - 0x2B0D8
{
...
int func_315()//Position - 0x2B12E
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_316(&(Global_16C30.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_316(char* sParam0, bool bParam1)//Position - 0x2B152
{
	int iVar0;
	int iVar1;
...
int func_317(int iParam0, bool bParam1)//Position - 0x2B17C
{
	int iVar0;
...
int func_319()//Position - 0x2B202
{
	...
	{
		if (func_314(&(Global_16C30.f_3)) > 4294967295)
		{
			return 1;
		}
	}
...
void func_320(bool bParam0)//Position - 0x2B26E
{
	unk_0x59B038076F830627(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_321(int iParam0)//Position - 0x2B282
{
	if (iParam0 == 1)
	{
		HUD::_0xFDB423997FA30340();
...
void func_322(int iParam0)//Position - 0x2B2BF
{
	if (iParam0 == 1)
	{
...
void func_323()//Position - 0x2B2FC
{
	Global_434C.f_5 = 1;
}

void func_324()//Position - 0x2B30A
{
	Global_434C.f_5 = 0;
}

void func_325(bool bParam0)//Position - 0x2B318
{
	if (bParam0)
	{
		func_326();
...
void func_326()//Position - 0x2B37B
{
...
void func_327()//Position - 0x2B3A4
{
	Global_155CF = 0;
	Global_155D0 = 0;
}

int func_328()//Position - 0x2B3B6
{
...
void func_329()//Position - 0x2B3F4
{
	Global_16C53 = 1;
...
void func_330(char* sParam0)//Position - 0x2B4E3
{
...
void func_331(var uParam0)//Position - 0x2B4F5
{
...
void func_332(var uParam0)//Position - 0x2B515
{
	int iVar0;
...
int func_333(int iParam0)//Position - 0x2B54F
{
	if (!func_151(iParam0))
	{
		return Global_19E56.f_6D76[iParam0 /*29*/];
