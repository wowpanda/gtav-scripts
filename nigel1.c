					...
					if (!CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						if (func_298(Local_94.f_35[0]))
						{
							...
							if (func_298(Local_94.f_28[0]))
							{
								...
								BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(Local_94.f_28[0]);
							...
							if (func_298(Local_94.f_28[1]))
							{
								...
								BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(Local_94.f_28[1]);
							...
							BRAIN::TASK_VEHICLE_DRIVE_WANDER(Local_94.f_28[0], Local_94.f_35[0], 20f, 786603);
						}
...
void func_240(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_95814.f_4))
	{
		...
		{
			if (func_288(24) != Global_95814.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_285(ENTITY::GET_ENTITY_COORDS(Global_95814.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_241(Global_95814.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_242(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_272(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_105220.f_32546.f_4801 = func_261();
			}
...
void func_243(int iParam0, int iParam1)
{
	...
	func_280(iParam0, &(Global_105220.f_32546.f_5510));
}
...
int func_272(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_279(Global_105220.f_32546.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_279(Global_105220.f_2354.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_279(Global_105220.f_2354.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_275(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_272(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_277(iParam0);
			func_276(uParam1, &(Global_105220.f_32546.f_69[Global_69800.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_306(void fParam0, bool bParam1)
{
	func_239(bParam1);
...
{
	if (((!func_321(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
...
{
	return func_323(iParam0, Global_35905);
}
	...
	switch (iLocal_77)
	{
		...
		case 3:
			if (func_298(uParam0->f_28[0]) && func_298(uParam0->f_28[1]))
			{
				...
				BRAIN::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iVar2, "rcmnigel1", "base_nigel", 8f, -8f, 0, 0, 1148846080, 0);
				BRAIN::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[1], iVar2, "rcmnigel1", "base_mrs_thornhill", 8f, -8f, 0, 0, 1148846080, 0);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
int func_330(int iParam0, int iParam1, vector3 vParam2, float fParam3, void fParam4, int iParam5)
{
...
void func_352(void fParam0, int iParam1)
{
	if (Global_92955 != 12)
	{
		if (func_353(fParam0, 6, iParam1))
		{
...
int func_356(void fParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
...
int func_359()
{
	...
	{
		if (func_354(&(Global_92955.f_3)) > -1)
		{
			return 1;
		}
	}
