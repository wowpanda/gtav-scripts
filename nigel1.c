...
void __EntryFunction__()
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	uLocal_80 = func_376(64);
	uLocal_81 = func_376(63);
	...
	if (func_337())
	{
		Global_71835 = 1;
		iLocal_79 = 0;
		while (!func_327(&Local_96))
		{
			WAIT(0);
		}
		func_326(&Local_96, 0, 1);
		Global_71835 = 0;
	}
	uLocal_325 = func_325();
	func_324();
	while (true)
	{
		...
		func_307(Local_96.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_322)
		{
			case 0:
				func_218();
...
void func_1()
{
	switch (iLocal_323)
	{
		case 0:
			bLocal_324 = false;
			func_217(&uLocal_157, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
			iLocal_323 = 1;
			break;
		...
		case 1:
			if (!bLocal_324)
			{
				bLocal_324 = func_207(&uLocal_157, "NIG1AAU", "NIG1A_COMM", 7, 0, 0, 0);
			}
			else if (!func_206())
			{
				iLocal_323 = 2;
...
void func_217(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
		...
		case 1:
			switch (iLocal_326)
			{
				case 0:
					...
					{
						if (func_298(Local_96.f_28[0]))
						{
							REGISTER_ENTITY_FOR_CUTSCENE(Local_96.f_28[0], "Nigel", 0, 0, 0);
						}
						if (func_298(Local_96.f_28[1]))
						{
							REGISTER_ENTITY_FOR_CUTSCENE(Local_96.f_28[1], "MRS_Thornhill", 0, 0, 0);
						}
						func_297();
				...
				case 1:
					if (IS_CUTSCENE_PLAYING())
					{
						...
						{
							CLEAR_AREA(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 100f, 1, 1, 0, 0);
						}
				...
				case 2:
					if (!IS_CUTSCENE_PLAYING())
					{
						func_226(1, 1, 1, 1);
						func_326(&Local_96, 0, 1);
						if (!func_298(Local_96.f_35[0]))
						{
							func_222(&(Local_96.f_35[0]), -1084.456f, 787.2556f, 163.986f, 100.8542f, 0, 1);
						}
						if (func_298(Local_96.f_35[0]))
						{
							func_221(Local_96.f_35[0], -1094.484f, 785.5936f, 163.2927f, 102.2748f, 0, 1);
							SET_VEHICLE_ON_GROUND_PROPERLY(Local_96.f_35[0], 1084227584);
							_0x25367DE49D64CF16(Local_96.f_35[0], 1);
							if (func_298(Local_96.f_28[0]))
							{
								SET_PED_RELATIONSHIP_GROUP_HASH(Local_96.f_28[0], 1862763509);
								CLEAR_PED_TASKS_IMMEDIATELY(Local_96.f_28[0]);
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_96.f_28[0], 1);
								SET_PED_INTO_VEHICLE(Local_96.f_28[0], Local_96.f_35[0], -1);
								SET_PED_KEEP_TASK(Local_96.f_28[0], 1);
							}
							if (func_298(Local_96.f_28[1]))
							{
								SET_PED_RELATIONSHIP_GROUP_HASH(Local_96.f_28[1], 1862763509);
								CLEAR_PED_TASKS_IMMEDIATELY(Local_96.f_28[1]);
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_96.f_28[1], 1);
								SET_PED_INTO_VEHICLE(Local_96.f_28[1], Local_96.f_35[0], 0);
								SET_PED_KEEP_TASK(Local_96.f_28[1], 1);
							}
							SET_VEHICLE_ENGINE_ON(Local_96.f_35[0], 1, 1, 0);
							TASK_VEHICLE_DRIVE_WANDER(Local_96.f_28[0], Local_96.f_35[0], 20f, 786603);
						}
						_0x81CBAE94390F9F89();
						func_220(&(Local_96.f_28[0]), 1, 0, 1);
						func_220(&(Local_96.f_28[1]), 1, 0, 1);
						func_219(&(Local_96.f_35[0]));
						iLocal_322 = 1;
						iLocal_323 = 0;
					}
					break;
...
int func_221(var uParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
int func_222(var uParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	func_223(uParam0, iLocal_83, vParam1, fParam4);
	if (func_298(*uParam0))
	{
...
void func_223(var uParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_224(uParam0);
...
void func_228(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_232(PLAYER_ID())) && !func_230(PLAYER_ID(), 0)) && !func_229()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_232(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
...
int func_234(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_237(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	var uVar0;
	...
	if (IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_238(GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
	...
	if (DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_288(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_285(GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
...
void func_241(int iParam0, vector3 vParam1, var uParam4, int iParam5, bool bParam6)
{
	...
	if (DOES_ENTITY_EXIST(iParam0) && IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_275(iParam5, &Var0, vParam1, uParam4, func_278(iParam0));
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_259(iParam0, 0, 0)) || func_259(iParam0, 1, 0)) || func_259(iParam0, 2, 0)) || func_278(iParam0) != 145) || func_258(iParam0)) || func_257(iParam0)) || func_256(iParam0)) || func_255(iParam0)) || !func_245(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_257(iParam0))
		{
		}
...
var func_261()
{
	...
	func_271(&uVar0, GET_CLOCK_SECONDS());
	func_270(&uVar0, GET_CLOCK_MINUTES());
	func_269(&uVar0, GET_CLOCK_HOURS());
	func_264(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_263(&uVar0, GET_CLOCK_MONTH());
	func_262(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SHIFT_RIGHT(uParam0, 26) & 31 * func_267(IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_275(int iParam0, var uParam1, vector3 vParam2, var uParam5, int iParam6)
{
	if (func_272(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
...
bool func_279(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
...
int func_285(vector3 vParam0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;
	
	iVar0 = func_286(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_286(vector3 vParam0, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_289(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	func_290(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_290(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, var uParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	var uVar0;
	bool bVar1;
	bool bVar2;
	...
	if (DOES_ENTITY_EXIST(uVar0))
	{
		...
		if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_292(uVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_292(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = { func_294(vParam1 - vParam4) };
		vVar3 = { vVar0 };
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_293(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_293(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_293(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_293(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_293(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_293(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_293(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_293(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_293(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_293(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_293(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_293(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_293(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_293(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_293(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_293(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return 1;
		}
	}
...
int func_293(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_299(int iParam0, int iParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_304(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_303(PLAYER_PED_ID(), -828834893))
				{
...
int func_304(var uParam0, var uParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (Global_71844 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_309(Global_71845, Global_71847, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
int func_318(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	...
	switch (Global_71844)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_320(0)) || func_319(1))
			{
			}
			else
			{
...
int func_327(var uParam0)
{
	...
	switch (iLocal_79)
	{
		case 0:
			...
			func_336(&uLocal_84, "rcmnigel1", "base_mrs_thornhill", "base_mrs_thornhill");
			iLocal_79 = 1;
			break;
		...
		case 2:
			...
			{
				func_223(&(uParam0->f_35[0]), iLocal_83, -1077.959f, 793.9361f, 164.6374f, 172.8563f);
...
void func_328(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 38:
			if (bParam1)
			{
				uLocal_95 = ADD_SCENARIO_BLOCKING_AREA(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, 0, 1, 1, 1);
				SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_GUARD_STAND", 0);
				SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_CLIPBOARD", 0);
				SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", 0);
		...
		case 39:
			if (bParam1)
			{
				uLocal_95 = ADD_SCENARIO_BLOCKING_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0, 1, 1, 1);
		...
		case 41:
			if (bParam1)
			{
				uLocal_95 = ADD_SCENARIO_BLOCKING_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
		...
		case 42:
			if (bParam1)
			{
				uLocal_95 = ADD_SCENARIO_BLOCKING_AREA(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, 0, 1, 1, 1);
...
int func_330(var uParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_331(uParam0, iParam1, vParam2, fParam5, 1))
	{
		if (DOES_ENTITY_EXIST(*uParam0))
		{
			if (!IS_ENTITY_DEAD(*uParam0, 0))
...
int func_331(var uParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	int iVar0;
...
void func_338()
{
	...
	func_329(1);
	func_349(&uLocal_157, 2);
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_325, 0);
	CLEAR_PED_NON_CREATION_AREA();
	func_339(&Local_96, 1, 0, 0);
...
void func_351(bool bParam0)
{
	...
	if (!func_371())
	{
		...
		{
			func_159(iVar0, 1, 0);
			func_352(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_105652[iVar0 /*10*/].f_9 == -1)
