...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_128(vLocal_47, 4294967295, 0, 0, 0))
	{
		func_125(4294967295);
	}
	else
	...
	{
		SYSTEM::WAIT(0);
		if ((BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), -1503.54f, 4934.923f, 114.2284f, 100f, 100f, 100f, false, true, 0)) || iLocal_45 == 2)
		{
			if (!func_124())
			{
				if (func_123())
				...
				case 2:
					switch (iLocal_44)
					{
						...
						case 1:
								...
								if (!func_75())
								{
									...
									while (iVar0 < 4)
									{
										if (bLocal_110)
										{
											...
											func_69(iLocal_88[0], PED::GET_VEHICLE_PED_IS_USING(AUDIO::_0x0626A247D2405330()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_69(iLocal_88[1], PED::GET_VEHICLE_PED_IS_USING(AUDIO::_0x0626A247D2405330()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 2f, 0f, 1000, 0f);
										...
										else if (bLocal_107)
										{
											...
											func_69(iLocal_86[0], PED::GET_VEHICLE_PED_IS_USING(AUDIO::_0x0626A247D2405330()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_69(iLocal_86[1], PED::GET_VEHICLE_PED_IS_USING(AUDIO::_0x0626A247D2405330()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 5f, 0f, 1000, 0f);
										...
										else if (bLocal_108)
										{
											...
											func_69(iLocal_87[0], PED::GET_VEHICLE_PED_IS_USING(AUDIO::_0x0626A247D2405330()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 0f, 0f, 1000, 0f);
											func_69(iLocal_87[1], PED::GET_VEHICLE_PED_IS_USING(AUDIO::_0x0626A247D2405330()), &uLocal_56, &uLocal_59, &vLocal_61, &fLocal_60, &uLocal_62, 0f, 5f, 0f, 1000, 0f);
							...
							if (((PED::IS_PED_ON_FOOT(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_IN_FLYING_VEHICLE(AUDIO::_0x0626A247D2405330())) && !ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_100, 100f, 100f, 100f, false, true, 0)) && iLocal_46 < 2)
							{
								func_41();
							}
							break;
...
void func_1()//Position - 0x3B1
{
		...
		while (iVar0 < 4)
		{
			...
			if (iLocal_46 >= 6)
			{
				if (PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
				{
					...
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_83[iVar0], AUDIO::_0x0626A247D2405330(), 100f, 100f, 100f, 0, 1, 0))
						{
							bLocal_109 = true;
						}
					}
		...
		while (iVar0 < 4)
		{
			...
			if (iLocal_46 >= 6)
			{
				if (PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
				{
					...
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_84[iVar0], AUDIO::_0x0626A247D2405330(), 100f, 100f, 100f, 0, 1, 0))
						{
							bLocal_109 = true;
						}
					}
	...
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_100, 30f) && SYSTEM::VDIST(func_2(CAM::_0xDC9DA9E8789F5246()), vLocal_100) > 300f)
	{
		func_170();
	}
}
...
char* func_8(int iParam0)//Position - 0xF9B
{
	switch (iParam0)
	{
		case 0:
...
int func_10(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x104A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_11()//Position - 0x15AD
{
	return Global_1407E0;
}

void func_12(int iParam0)//Position - 0x15B9
{
	func_34(93, iParam0);
	func_34(29, iParam0);
	func_34(30, iParam0);
...
bool func_13(int iParam0)//Position - 0x15D9
{
	if (iParam0 == 8)
	{
...
int func_14(int iParam0, int iParam1, int iParam2)//Position - 0x165D
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_15(int iParam0)//Position - 0x169A
{
	int iVar0;
...
int func_16(int iParam0, int iParam1)//Position - 0x19B2
{
	int iVar0;
...
int func_17(bool bParam0)//Position - 0x1CA5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_18(int iParam0, int iParam1)//Position - 0x1D5C
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_19(int iParam0, int iParam1)//Position - 0x1D77
{
...
int func_20(var uParam0, int iParam1)//Position - 0x1E14
{
	int iVar0;
	var uVar1[78];
...
int func_21(var uParam0, int iParam1)//Position - 0x1EC5
{
	int iVar0;
...
bool func_22(var uParam0, int iParam1)//Position - 0x1F40
{
	return (*uParam0)[iParam1] == 78;
}

void func_23(var uParam0)//Position - 0x1F51
{
	int iVar0;
...
void func_24(var uParam0, int iParam1)//Position - 0x1F85
{
	(*uParam0)[iParam1] = 78;
}

void func_25(var uParam0, float fParam1)//Position - 0x1F95
{
	if (fParam1 == 0f)
	{
		uParam0->f_50 = 0f;
...
float func_26(var uParam0)//Position - 0x1FB2
{
	return uParam0->f_50;
}

bool func_27(var uParam0, int iParam1)//Position - 0x1FBE
{
	return func_28(uParam0, iParam1) != 4294967295;
}

int func_28(var uParam0, int iParam1)//Position - 0x1FD0
{
	int iVar0;
...
bool func_29(var uParam0)//Position - 0x1FFD
{
	return uParam0->f_4F == 1;
}

int func_30(int iParam0)//Position - 0x200B
{
	switch (iParam0)
	{
		case 60:
...
bool func_31(int iParam0)//Position - 0x205B
{
	return Global_8D15 == iParam0;
}

int func_32(int iParam0, int iParam1)//Position - 0x2069
{
	int iVar0;
...
void func_33(int iParam0, int iParam1)//Position - 0x20BA
{
	int iVar0;
...
void func_34(int iParam0, int iParam1)//Position - 0x20DD
{
	int iVar0;
...
int func_36()//Position - 0x21AF
{
	func_37();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_37()//Position - 0x21C8
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_40(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_38(iVar0) && (!func_31(14) || Global_19A3D))
			{
...
bool func_38(int iParam0)//Position - 0x22C5
{
	return iParam0 < 3;
}

int func_39(int iParam0)//Position - 0x22D1
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x230E
{
	if (func_38(iParam0))
	{
...
void func_41()//Position - 0x2338
{
	...
	func_45(4294967295, 0);
	func_42();
	iLocal_45 = 3;
}

void func_42()//Position - 0x236C
{
	func_43();
}

int func_43()//Position - 0x2379
{
	if (func_44(0))
	{
		return 0;
...
bool func_44(bool bParam0)//Position - 0x23C4
{
...
void func_45(int iParam0, int iParam1)//Position - 0x23EF
{
...
void func_46(int iParam0)//Position - 0x24F3
{
	Global_19E48 = iParam0;
}

void func_47(int iParam0, var uParam1, var uParam2)//Position - 0x2501
{
	bool bVar0;
...
int func_49()//Position - 0x2AAA
{
	return Global_6373;
}

int func_50(int iParam0, int iParam1)//Position - 0x2AB5
{
	switch (iParam0)
	{
		case 0:
...
int func_51(int iParam0)//Position - 0x2E29
{
	switch (iParam0)
	{
		case 29:
...
void func_52(int iParam0)//Position - 0x2E58
{
	int iVar0;
	int iVar1;
...
void func_53(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2E9A
{
	func_54(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_54(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2EBB
{
	int iVar0;
...
int func_57(int iParam0)//Position - 0x31F4
{
	int iVar0;
	int iVar1;
...
void func_58(int iParam0, int iParam1)//Position - 0x3237
{
	MISC::SET_BIT(&(Global_19E56.f_6187.f_8[iParam0]), iParam1);
}

int func_59(int iParam0)//Position - 0x3252
{
	int iVar0;
...
int func_61(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x3320
{
...
int func_62()//Position - 0x34FA
{
	return 1;
}

int func_63()//Position - 0x3503
{
...
void func_64(var uParam0, int iParam1, var uParam2, int iParam3)//Position - 0x3525
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(*uParam2, 0))
		{
			...
			if (!HUD::DOES_BLIP_EXIST(*iParam3))
			{
				if (iVar0 == 1)
				{
					*iParam3 = func_65(unk_0x8000C77B5F336760(*uParam2, true), 0);
			...
			else
			{
				...
				vVar2 = { unk_0x8000C77B5F336760(*uParam2, true) };
...
int func_65(vector3 vParam0, bool bParam1)//Position - 0x3670
{
	int iVar0;
...
float func_66(bool bParam0, float fParam1, float fParam2)//Position - 0x369C
{
	if (bParam0)
	{
		return fParam1;
...
int func_67(int iParam0, bool bParam1, int iParam2)//Position - 0x36B3
{
	int iVar0;
...
int func_68(int iParam0, bool bParam1, bool bParam2)//Position - 0x3705
{
	int iVar0;
...
void func_69(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, var uParam6, vector3 vParam7, int iParam8, float fParam9)//Position - 0x37A9
{
	vector3 vVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		if (((((((ENTITY::DOES_ENTITY_EXIST(iParam1) && iParam0 != iParam1) && !VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iParam1))) && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(iParam1)) && func_73(iParam0))
		{
			...
			{
				if (func_71(iParam0, iParam1, 1) > fParam9 && MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(iParam1, true), *uParam2, true) > 20f)
				{
					if (!func_70(*uParam2))
					{
...
int func_70(vector3 vParam0)//Position - 0x39C7
{
...
float func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x39F1
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_72(int iParam0, var uParam1, var uParam2)//Position - 0x3A4F
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
int func_73(int iParam0)//Position - 0x3A7F
{
	int iVar0;
...
void func_74(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3ACA
{
	int iVar0;
	int iVar1;
...
int func_75()//Position - 0x3BBB
{
	...
	while (iVar1 < 4)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_83[iVar1]))
		{
			...
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_83[iVar1], AUDIO::_0x0626A247D2405330(), 200f, 200f, 200f, 0, 1, 0))
				{
					iVar0 = 0;
				}
			}
	...
	while (iVar1 < 4)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_84[iVar1]))
		{
			...
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_84[iVar1], AUDIO::_0x0626A247D2405330(), 200f, 200f, 200f, 0, 1, 0))
				{
					iVar0 = 0;
				}
			}
...
void func_76()//Position - 0x3C78
{
	...
	{
		case 0:
			if (((PLAYER::_0x5FC472C501CCADB3(CAM::_0xDC9DA9E8789F5246()) || !ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_100 + Vector(0f, 20f, 0f), 170f, 270f, 50f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), -1555.4f, 4730.817f, 49.1791f, 15f, 25f, 15f, false, true, 0)) || ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), -1709.211f, 4659.571f, 36.688f, 15f, 25f, 15f, false, true, 0))
			{
				if (!bLocal_110)
				{
					if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), -1555.4f, 4730.817f, 49.1791f, 15f, 25f, 15f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), -1709.211f, 4659.571f, 36.688f, 15f, 25f, 15f, false, true, 0))
					{
						bLocal_110 = true;
					}
				}
				if (PATHFIND::GET_CLOSEST_VEHICLE_NODE(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), &vLocal_102, 1, 1077936128, 0))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_102, 20f, 20f, 20f, false, true, 0))
					{
						MISC::ENABLE_DISPATCH_SERVICE(5, true);
						MISC::ENABLE_DISPATCH_SERVICE(3, true);
						SYSTEM::SETTIMERA(0);
		...
		case 2:
			if (bLocal_110)
			{
				if (SYSTEM::TIMERA() > 3500)
				{
					...
					{
						PED::SET_PED_INTO_VEHICLE(iLocal_83[0], iLocal_88[0], 4294967295);
						PED::SET_PED_INTO_VEHICLE(iLocal_83[1], iLocal_88[1], 4294967295);
			...
			if (SYSTEM::TIMERA() > 10000)
			{
				...
				{
					if (!PED::IS_PED_IN_MODEL(AUDIO::_0x0626A247D2405330(), joaat("REBEL")))
					{
						iLocal_46 = 3;
					}
					else
		...
		case 3:
			vLocal_103 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true) };
			iLocal_76 = MISC::GET_RANDOM_INT_IN_RANGE(10, 15);
			if (!ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), -1603.153f, 4892.943f, 60.1768f, 225f, 225f, 50f, false, true, 0))
			{
				if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(vLocal_103, iLocal_76, &(vLocal_280[0 /*3*/]), 1, 3f, 0f))
				{
					...
					{
						if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_86[0], 0))
						{
							ENTITY::SET_ENTITY_COORDS(iLocal_86[0], vLocal_280[0 /*3*/], 1, false, 0, 1);
							func_88(iLocal_86[0], iLocal_83[0]);
						}
						if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_86[1], 0))
						{
		...
		case 4:
			...
			if (!ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), -1603.153f, 4892.943f, 60.1768f, 225f, 225f, 50f, false, true, 0))
			{
				if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(vLocal_103, iLocal_76, &(vLocal_280[0 /*3*/]), 1, 3f, 0f))
				{
					...
					if (!CAM::IS_SPHERE_VISIBLE(vLocal_280[0 /*3*/], 7f) && !CAM::IS_SPHERE_VISIBLE(vLocal_280[1 /*3*/], 7f))
					{
						if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_87[0], 0))
						{
							ENTITY::SET_ENTITY_COORDS(iLocal_87[0], vLocal_280[0 /*3*/], 1, false, 0, 1);
							func_88(iLocal_87[0], iLocal_84[0]);
						}
						if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_87[1], 0))
						{
		...
		case 5:
			...
			if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(vLocal_103, iLocal_76, &(vLocal_280[0 /*3*/]), 1, 3f, 0f))
			{
				...
				if (!CAM::IS_SPHERE_VISIBLE(vLocal_280[0 /*3*/], 7f) && !CAM::IS_SPHERE_VISIBLE(vLocal_280[1 /*3*/], 7f))
				{
					if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_88[0], 0))
					{
						ENTITY::SET_ENTITY_COORDS(iLocal_88[0], vLocal_280[0 /*3*/], 1, false, 0, 1);
						func_88(iLocal_88[0], iLocal_83[0]);
					}
					if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_88[1], 0))
					{
		...
		case 6:
			if (func_63())
			{
				...
				{
					vLocal_50 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true) };
					MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS((vLocal_50.x + fLocal_64), (vLocal_50.y + fLocal_65), (vLocal_50.z + fLocal_66), (vLocal_50.x - fLocal_64), (vLocal_50.y - fLocal_65), vLocal_50.z, 10, 0, joaat("weapon_assaultrifle"), 0, 1, 1, 3212836864);
...
bool func_77(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x451D
{
...
int func_78(char* sParam0, int iParam1, bool bParam2)//Position - 0x456B
{
	Global_3DCF = 0;
...
bool func_85(int iParam0, int iParam1)//Position - 0x4AB6
{
	switch (iParam0)
	{
		case 5:
...
void func_87(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x4B48
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
void func_88(int iParam0, int iParam1)//Position - 0x4B9E
{
	unk_0x346478B12F69D4E3(iParam0, false);
	VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iParam0, 1084227584);
	vLocal_279 = { unk_0x8000C77B5F336760(iParam0, true) };
	...
	if (bLocal_110)
	{
		if (!PED::IS_PED_INJURED(iParam1))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
			{
				BRAIN::TASK_VEHICLE_CHASE(iParam1, AUDIO::_0x0626A247D2405330());
				SYSTEM::WAIT(1);
				if (!PED::IS_PED_INJURED(iParam1))
				{
			...
			{
				BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(iParam1, iParam0, AUDIO::_0x0626A247D2405330(), 6, 20f, 786469, -1f, -1f, 1);
			}
			if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
			{
				VEHICLE::SET_VEHICLE_FORWARD_SPEED(iParam0, ENTITY::GET_ENTITY_SPEED(AUDIO::_0x0626A247D2405330()));
			}
		}
	}
	else if (!PED::IS_PED_INJURED(iParam1))
	{
		...
		{
			BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(iParam1, iParam0, AUDIO::_0x0626A247D2405330(), 2, 100f, 786469, -1f, -1f, 1);
		}
		VEHICLE::SET_VEHICLE_FORWARD_SPEED(iParam0, ENTITY::GET_ENTITY_SPEED(AUDIO::_0x0626A247D2405330()));
	}
}

void func_89()//Position - 0x4CA6
{
	int iVar0;
	...
	iLocal_83[0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_86[0], 26, joaat("g_m_m_chigoon_02"), 4294967295, 1, true);
	iLocal_83[1] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_86[1], 26, joaat("g_m_m_chigoon_02"), 4294967295, 1, true);
	if (!bLocal_110)
	{
	...
	iLocal_84[0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_87[0], 26, joaat("g_m_y_salvagoon_03"), 4294967295, 1, true);
	iLocal_84[1] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_87[1], 26, joaat("g_m_y_salvagoon_03"), 4294967295, 1, true);
	...
	while (iVar0 < 4)
	{
		if (!PED::IS_PED_INJURED(iLocal_83[iVar0]))
		{
			...
			if (bLocal_110)
			{
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_83[0], joaat("weapon_sawnoffshotgun"), 4294967295, true, true);
				if (!PED::IS_PED_INJURED(iLocal_83[1]))
				{
					WEAPON::GIVE_WEAPON_TO_PED(iLocal_83[1], joaat("weapon_pistol"), 4294967295, true, true);
				}
			...
			{
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_83[iVar0], joaat("weapon_pistol"), 4294967295, true, true);
	...
	while (iVar0 < 4)
	{
		if (!PED::IS_PED_INJURED(iLocal_83[iVar0]))
		{
			...
			{
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_84[iVar0], joaat("weapon_pistol"), 4294967295, true, true);
...
void func_90(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x5240
{
		...
		case 0:
			if (bLocal_107)
			{
				...
				while (iVar0 < 4)
				{
					if (!PED::IS_PED_INJURED(iLocal_83[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_83[iVar0], 100f, 100f, 20f, 0, 1, 0))
						{
							iLocal_74 = 3;
						}
					}
			...
			if (bLocal_108)
			{
				...
				while (iVar1 < 4)
				{
					if (!PED::IS_PED_INJURED(iLocal_84[iVar1]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_84[iVar1], 100f, 100f, 20f, 0, 1, 0))
						{
							iLocal_74 = 3;
						}
					}
		...
		case 3:
			...
			if (bLocal_107)
			{
				...
				while (iVar2 < 4)
				{
					...
					{
						if ((!PED::IS_PED_IN_COMBAT(iLocal_83[iVar2], 0) && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_83[iVar2], 579380604) != 1) && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_83[iVar2], 579380604) != 0)
						{
							NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_83[iVar2]);
							BRAIN::TASK_COMBAT_PED(iLocal_83[iVar2], AUDIO::_0x0626A247D2405330(), 0, 16);
			...
			if (bLocal_108)
			{
				...
				while (iVar3 < 4)
				{
					...
					{
						if ((!PED::IS_PED_IN_COMBAT(iLocal_84[iVar3], 0) && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_84[iVar3], 579380604) != 1) && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_84[iVar3], 579380604) != 0)
						{
							NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_84[iVar3]);
							BRAIN::TASK_COMBAT_PED(iLocal_84[iVar3], AUDIO::_0x0626A247D2405330(), 0, 16);
...
void func_92()//Position - 0x5510
{
	switch (iLocal_72)
	{
		case 0:
			...
			{
				if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_101, 7f, 7f, 10f, false, true, 0))
				{
					func_94();
					SYSTEM::WAIT(0);
					func_77(&uLocal_114, "REDGWAU", "REDGW_NTOUCH", 4, 0, 0, 0);
					BRAIN::TASK_LOOK_AT_ENTITY(iLocal_80, AUDIO::_0x0626A247D2405330(), 4294967295, 2048, 2);
					if (!HUD::DOES_BLIP_EXIST(iLocal_90))
					{
	...
	switch (iLocal_73)
	{
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_80))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_80, 10f, 10f, 6f, 0, 1, 0))
				{
					if (!func_63())
					{
...
int func_93(int iParam0)//Position - 0x56FF
{
	int iVar0;
...
void func_94()//Position - 0x5737
{
	Global_3960 = 0;
	func_95();
}

void func_95()//Position - 0x5747
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_96()//Position - 0x5768
{
	...
	else
	{
		...
		if (!func_124())
		{
			if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_48[7 /*3*/], 110f, 95f, 40f, false, true, 0))
			{
				if (HUD::DOES_BLIP_EXIST(iLocal_89))
				{
					HUD::REMOVE_BLIP(&iLocal_89);
				...
				HUD::_0x75A16C3DA34F1245(iLocal_91, false);
				HUD::_0x75A16C3DA34F1245(iLocal_92[6], false);
				HUD::_0x75A16C3DA34F1245(iLocal_92[7], false);
				func_97(1);
			}
		}
		if (!PED::IS_PED_INJURED(iLocal_81[6]))
		{
			if (((((BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_81[6], 1785177548) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_81[6], 1785177548) != 0) || FIRE::IS_ENTITY_ON_FIRE(iLocal_81[6])) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_81[6])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_81[6])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(iLocal_81[6]))
			{
				unk_0x65E471E4A2D56226(iLocal_81[6], 0, 0);
			}
		}
		if (!PED::IS_PED_INJURED(iLocal_81[7]))
		{
			if (((((BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_81[7], 1785177548) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_81[7], 1785177548) != 0) || FIRE::IS_ENTITY_ON_FIRE(iLocal_81[7])) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_81[7])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_81[7])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(iLocal_81[7]))
			{
				unk_0x65E471E4A2D56226(iLocal_81[7], 0, 0);
			}
		}
		if (!PED::IS_PED_INJURED(iLocal_80))
		{
			if (((((BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_80, 1785177548) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_80, 1785177548) != 0) || FIRE::IS_ENTITY_ON_FIRE(iLocal_80)) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_80)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_80)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(iLocal_80))
			{
				unk_0x65E471E4A2D56226(iLocal_80, 0, 0);
			}
		}
	...
	switch (iLocal_75)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_81[6]))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), unk_0x8000C77B5F336760(iLocal_81[6], true) + Vector(0f, 2.5f, 0f), 9f, 5f, 5f, false, true, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(AUDIO::_0x0626A247D2405330(), iLocal_81[6]))
				{
					BRAIN::TASK_LOOK_AT_ENTITY(iLocal_81[6], AUDIO::_0x0626A247D2405330(), 4294967295, 2048, 2);
					BRAIN::TASK_LOOK_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_81[6], 4000, 2048, 2);
			...
			if (!PED::IS_PED_INJURED(iLocal_81[7]))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), unk_0x8000C77B5F336760(iLocal_81[7], true) + Vector(0f, 3f, 0f), 9f, 7f, 5f, false, true, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(AUDIO::_0x0626A247D2405330(), iLocal_81[7]))
				{
					BRAIN::TASK_LOOK_AT_ENTITY(iLocal_81[7], AUDIO::_0x0626A247D2405330(), 4294967295, 2048, 2);
					BRAIN::TASK_LOOK_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_81[7], 4000, 2048, 2);
		...
		case 1:
			...
			{
				HUD::_0x75A16C3DA34F1245(iLocal_91, true);
			}
			if (HUD::DOES_BLIP_EXIST(iLocal_92[6]))
			{
				HUD::_0x75A16C3DA34F1245(iLocal_92[6], true);
			}
			if (HUD::DOES_BLIP_EXIST(iLocal_92[7]))
			{
				HUD::_0x75A16C3DA34F1245(iLocal_92[7], true);
			}
...
int func_97(int iParam0)//Position - 0x5C19
{
	if (func_101())
	{
		Global_19E4C = 1;
		Global_19E49 = MISC::GET_GAME_TIMER();
		if (func_51(Global_19E4B))
		{
			func_98(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_51(Global_19E4B))
		{
...
void func_98(int iParam0)//Position - 0x5C6C
{
	switch (iParam0)
	{
		case 0:
...
void func_99(char* sParam0, int iParam1)//Position - 0x5D4D
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_100(int iParam0)//Position - 0x5D64
{
	char* sVar0;
...
int func_101()//Position - 0x5DA7
{
	switch (func_102(&Global_63AE, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_102(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x5DDD
{
	int iVar0;
...
void func_103(var uParam0, int iParam1)//Position - 0x5F14
{
	int iVar0;
...
bool func_104(int iParam0)//Position - 0x5F63
{
	return func_105(iParam0, Global_8D15);
}

int func_105(int iParam0, int iParam1)//Position - 0x5F74
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_106(int iParam0)//Position - 0x6155
{
	if (Global_8D15 == 15)
	{
		return 0;
...
void func_107()//Position - 0x6177
{
	int iVar0;
	
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_85[0], 0))
	{
		if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_85[0], 4294967295, 0) == iLocal_81[8])
		{
...
void func_108()//Position - 0x625F
{
	...
	if ((((((((STREAMING::HAS_MODEL_LOADED(joaat("g_m_m_chigoon_02")) && STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_salvagoon_03"))) && STREAMING::HAS_MODEL_LOADED(joaat("REBEL"))) && STREAMING::HAS_MODEL_LOADED(joaat("BOBCATXL"))) && STREAMING::HAS_MODEL_LOADED(joaat("SANCHEZ"))) && STREAMING::HAS_MODEL_LOADED(joaat("a_c_rottweiler"))) && STREAMING::HAS_MODEL_LOADED(joaat("prop_security_case_01"))) && STREAMING::HAS_ANIM_DICT_LOADED("random@dealgonewrong")) && STREAMING::HAS_ANIM_DICT_LOADED("random@dealgonewrongdead_peds"))
	{
		...
		ENTITY::_0xDC6F8601FAF2E893(iLocal_85[0], 6);
		...
		ENTITY::_0xDC6F8601FAF2E893(iLocal_85[1], 6);
		...
		while (iVar1 < 5)
		{
			if (!OBJECT::DOES_PICKUP_EXIST(iLocal_98[iVar1]))
			{
				...
				if (iVar1 < 2)
				{
					iLocal_98[iVar1] = OBJECT::CREATE_PICKUP(joaat("pickup_weapon_sawnoffshotgun"), vLocal_104[iVar1 /*3*/], iVar2, 4294967295, 1, 0);
				}
				else if (iVar1 == 4)
				{
				...
				{
					iLocal_98[iVar1] = OBJECT::CREATE_PICKUP(joaat("pickup_weapon_pistol"), vLocal_104[iVar1 /*3*/], iVar2, 4294967295, 1, 0);
				}
			}
			iVar1++;
		}
		...
		while (iVar1 < iLocal_82)
		{
			...
			vLocal_50 = { unk_0x8000C77B5F336760(iLocal_82[iVar1], true) };
			vLocal_51 = { vLocal_50.x, (vLocal_50.y - 2f), (vLocal_50.z - 0.5f) };
			vLocal_52 = { vLocal_50.x, (vLocal_50.y + 50f), (vLocal_50.z - 0.5f) };
			MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vLocal_51, vLocal_52, 100, 1, joaat("weapon_assaultrifle"), 0, 1, 1, 3212836864);
			iVar1++;
		}
		BRAIN::TASK_PLAY_ANIM_ADVANCED(iLocal_81[0], "random@dealgonewrongdead_peds", "ped_b", -1635.928f, 4707.941f, 46.383f, -29.25f, 12.25f, 171.75f, 1000f, -1000f, 4294967295, 2102272, 0, 2, 0);
		BRAIN::TASK_PLAY_ANIM_ADVANCED(iLocal_81[1], "random@dealgonewrongdead_peds", "ped_a", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, 4294967295, 2102272, 0, 2, 0);
		BRAIN::TASK_PLAY_ANIM_ADVANCED(iLocal_81[2], "random@dealgonewrongdead_peds", "ped_b", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, 4294967295, 2102272, 0, 2, 0);
		BRAIN::TASK_PLAY_ANIM_ADVANCED(iLocal_81[3], "random@dealgonewrongdead_peds", "ped_c", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, 4294967295, 2102272, 0, 2, 0);
		BRAIN::TASK_PLAY_ANIM_ADVANCED(iLocal_81[4], "random@dealgonewrongdead_peds", "ped_d", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, 4294967295, 2102272, 0, 2, 0);
		BRAIN::TASK_PLAY_ANIM_ADVANCED(iLocal_81[5], "random@dealgonewrongdead_peds", "ped_e", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, 4294967295, 2102272, 0, 2, 0);
		BRAIN::TASK_PLAY_ANIM_ADVANCED(iLocal_82[0], "random@dealgonewrongdead_peds", "dog_a", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, 4294967295, 2102272, 0, 2, 0);
		BRAIN::TASK_PLAY_ANIM_ADVANCED(iLocal_82[1], "random@dealgonewrongdead_peds", "dog_b", -1626.923f, 4729.901f, 52.214f, -1.341f, 1.085f, -12.902f, 1000f, -1000f, 4294967295, 2102272, 0, 2, 0);
		GRAPHICS::_0x46D1A61A21F566FC(50f);
		func_110();
		GRAPHICS::_0x46D1A61A21F566FC(1f);
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_85[0], 0))
		{
			iLocal_81[8] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_85[0], 26, joaat("g_m_y_salvagoon_03"), 4294967295, 1, true);
		...
		ENTITY::SET_ENTITY_HEALTH(iLocal_81[6], true);
		...
		BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_81[6], iVar3, "random@dealgonewrong", "base", 8f, -8f, 5, 0, 1148846080, 0);
		...
		ENTITY::SET_ENTITY_HEALTH(iLocal_81[7], true);
		...
		BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_81[7], iVar4, "random@dealgonewrong", "idle_a", 8f, -8f, 5, 0, 1148846080, 0);
		...
		ENTITY::SET_ENTITY_HEALTH(iLocal_80, true);
		...
		BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_80, iVar5, "random@dealgonewrong", "idle_b", 8f, -8f, 5, 0, 1148846080, 0);
		...
		if (func_36() == 0)
		{
			func_90(&uLocal_114, 0, AUDIO::_0x0626A247D2405330(), "MICHAEL", 0, 1);
		}
		if (func_36() == 1)
		{
			func_90(&uLocal_114, 1, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
		}
		if (func_36() == 2)
		{
			func_90(&uLocal_114, 2, AUDIO::_0x0626A247D2405330(), "TREVOR", 0, 1);
		}
...
Vector3 func_109(vector3 vParam0)//Position - 0x7232
{
	float fVar0;
	float fVar1;
...
void func_110()//Position - 0x7271
{
	...
	while (iVar0 < 5)
	{
		...
		while (iLocal_77 < 5)
		{
			...
			MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vLocal_54, vLocal_55, 1, 0, joaat("weapon_assaultrifle"), 0, 1, 1, 3212836864);
			vLocal_54 = { (vLocal_53.x + fLocal_64), (vLocal_53.y + fLocal_65), (vLocal_53.z + fLocal_66) };
			vLocal_55 = { (vLocal_53.x - fLocal_64), (vLocal_53.y - fLocal_65), vLocal_53.z };
			MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vLocal_54, vLocal_55, 1, 0, joaat("weapon_assaultrifle"), 0, 1, 1, 3212836864);
			vLocal_54 = { (vLocal_53.x + fLocal_64), (vLocal_53.y - fLocal_65), (vLocal_53.z + fLocal_66) };
...
int func_112(float fParam0, bool bParam1)//Position - 0x74CB
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_113(int iParam0, var uParam1)//Position - 0x7582
{
	switch (iParam0)
	{
		case 0:
...
int func_115(int iParam0)//Position - 0x87C9
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_116(int iParam0)//Position - 0x8B0F
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_117(int iParam0)//Position - 0x8B46
{
	struct<2> Var0;
...
bool func_119()//Position - 0x8FC4
{
	return Global_19D3C > 0;
}

int func_120()//Position - 0x8FD2
{
...
int func_124()//Position - 0x908C
{
	if ((Global_19E4B == func_60() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_19E4C)
	{
		return 1;
	}
	return 0;
...
void func_125(int iParam0)//Position - 0x90B7
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_60();
...
void func_127(int iParam0)//Position - 0x912A
{
	Global_19E4B = iParam0;
}

int func_128(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x9138
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
...
bool func_129(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x94D2
{
	if (bParam2)
	{
...
bool func_130(int iParam0)//Position - 0x9519
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0x953A
{
	return func_132(iParam0, 1);
}

int func_132(int iParam0, int iParam1)//Position - 0x9549
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_133(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x959C
{
	func_134(func_145(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_134(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x95BA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_135(float fParam0, float fParam1, float fParam2)//Position - 0x97BB
{
	float fVar0;
...
int func_136(int iParam0, int iParam1)//Position - 0x97FD
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_137(int iParam0)//Position - 0x989F
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_138(int iParam0)//Position - 0x98B2
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_139(int iParam0)//Position - 0x98C5
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_140(int iParam0)//Position - 0x98D8
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_141(int iParam0)//Position - 0x98EA
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_142(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}

int func_142(bool bParam0, int iParam1, int iParam2)//Position - 0x990F
{
	if (bParam0)
	{
		return iParam1;
...
int func_143(int iParam0)//Position - 0x9926
{
	return iParam0 & 15;
}

int func_144(int iParam0, int iParam1)//Position - 0x9933
{
	int iVar0;
	int iVar1;
...
void func_146(var uParam0, int iParam1)//Position - 0x9A85
{
	if (iParam1 <= 0)
	{
		return;
...
void func_147(var uParam0, int iParam1)//Position - 0x9B0B
{
...
void func_148(var uParam0, int iParam1)//Position - 0x9B3E
{
	int iVar0;
	int iVar1;
...
void func_149(var uParam0, int iParam1)//Position - 0x9B8F
{
...
void func_150(var uParam0, int iParam1)//Position - 0x9BC9
{
...
void func_151(var uParam0, int iParam1)//Position - 0x9C04
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_152(int iParam0)//Position - 0x9C40
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_153(int iParam0, int iParam1)//Position - 0x9D1C
{
...
int func_154(int iParam0)//Position - 0x9D3F
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_162()) || Global_6375) || func_161()) || func_85(8, 4294967295)) || func_158()) || func_160()) || func_159()) || func_157()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_162()) || Global_19A9D) || Global_6375) || func_161()) || func_85(8, 4294967295)) || func_158()) || func_160()) || func_159()) || func_157()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_162() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_85(8, 4294967295)) || func_157()) || func_156()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_85(8, 4294967295) || func_160()) || func_159()) || func_156()) || func_155())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_162()) || Global_6375) || func_161()) || func_85(8, 4294967295)) || func_159()) || func_158()) || func_157()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_155()//Position - 0xA45C
{
	return Global_16C57.f_1;
}

int func_156()//Position - 0xA46A
{
	if (Global_16089 != 4294967295)
	{
...
bool func_159()//Position - 0xA4D4
{
	return Global_16C64.f_148 > 0;
}

bool func_160()//Position - 0xA4E5
{
	return Global_16C64.f_147 > 0;
}

var func_161()//Position - 0xA4F6
{
	return Global_140859;
}

int func_162()//Position - 0xA502
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_164(int iParam0)//Position - 0xA546
{
	return func_144(func_145(), iParam0);
}

int func_165(int iParam0, int iParam1, int iParam2)//Position - 0xA558
{
	int iVar0;
	int iVar1;
...
int func_166(int iParam0)//Position - 0xA63C
{
	if (!func_38(iParam0))
	{
		return 7;
...
bool func_167(int iParam0)//Position - 0xA660
{
	int iVar0;
	bool bVar1;
...
void func_171(int iParam0)//Position - 0xA935
{
	char cVar0[64];
...
void func_172(var uParam0)//Position - 0xA9EA
{
	if (*uParam0 == 4294967295)
	{
		return;
...
char* func_173(int iParam0, bool bParam1)//Position - 0xAA27
{
	switch (iParam0)
	{
		case 0:
...
void func_174(int iParam0)//Position - 0xAC70
{
	Global_8F3C = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_175(int iParam0)//Position - 0xAC82
{
	func_176(iParam0, 0, func_181(iParam0));
}

void func_176(int iParam0, int iParam1, int iParam2)//Position - 0xAC97
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_177(var uParam0)//Position - 0xACC6
{
	struct<16> Var0;
	int iVar1;
...
void func_178(int iParam0, var uParam1)//Position - 0xAD96
{
	Global_19E56.f_6187.f_2B[iParam0] = *uParam1;
}

void func_179(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xADAE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_180(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xAF30
{
...
int func_181(int iParam0)//Position - 0xAF68
{
	int iVar0;
