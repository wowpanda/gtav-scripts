...
void __EntryFunction__()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("epsilontract")) > 1)
	{
...
void func_1()
{
	...
	if ((func_46(PLAYER_PED_ID()) && !func_45(14)) && !IS_SCREEN_FADED_OUT())
	{
		if (iLocal_41 < 10)
		{
			if (iLocal_41 == 0)
			{
				if (!func_44(36) && (GET_GAME_TIMER() - iLocal_42) > iLocal_43)
				{
...
int func_4(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (IS_BIT_SET(Global_106565.f_10043.f_108, func_10(func_11(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
void func_16(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (!bParam2)
	{
		...
		iVar2 = iVar20;
		Var3 = { func_26(Global_37597[iVar20 /*12*/].f_1) };
	...
	else
	{
		...
		{
			Var3 = { func_26(Global_37597[iVar26 /*12*/].f_1) };
		}
	}
	if (!bParam4)
	{
			...
			if (!func_45(13) && !func_45(14))
			{
				if (!DOES_PICKUP_EXIST(uParam0->f_1))
				{
					if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), uParam0->f_3) <= (50f * 50f))
					{
						...
						{
							SET_BIT(&uVar0, 1);
							uParam0->f_1 = CREATE_PICKUP_ROTATE(joaat("pickup_custom_script"), uParam0->f_3, uParam0->f_6, uVar0, -1, iParam5, 1, iParam1);
						}
						else
						{
							SET_BIT(&uVar0, 3);
							...
							SET_BIT(&uVar0, 8);
							SET_BIT(&uVar0, 1);
							uParam0->f_1 = CREATE_PICKUP(iParam2, uParam0->f_3, uVar0, -1, 1, iParam1);
						}
...
void func_33(var uParam0, var uParam1)
{
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_PICKUP_COORDS(*uParam0), 1) >= 60f)
		{
			func_40(uParam0);
			*uParam0 = 0;
			*uParam1 = 0;
...
void func_34(vector3 vParam0)
{
	...
	{
		TASK_LOOK_AT_COORD(PLAYER_PED_ID(), vParam0, 100, 2048, 1);
	}
}

bool func_35(var uParam0, vector3 vParam1, float fParam4)
{
