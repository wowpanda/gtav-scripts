...
void __EntryFunction__()
{
	...
	if (func_445())
	{
		...
		{
			case 0:
				func_443(Local_145, Local_145.f_3, 1, 0);
				func_441(1);
				break;
			
			case 1:
				func_443(vLocal_161, 298.7f, 1, 0);
				func_440(1);
				break;
	...
	{
		func_418(&(Local_186[0 /*29*/]), &(Local_81.f_35[1]));
	}
	if (DOES_ENTITY_EXIST(Local_81.f_28[0]))
	{
		func_417(&(Local_186[0 /*29*/].f_1), &(Local_81.f_28[0]));
	}
	if (DOES_ENTITY_EXIST(Local_81.f_28[1]))
	{
		func_417(&(Local_186[0 /*29*/].f_2), &(Local_81.f_28[1]));
	}
	func_415();
	while (true)
	{
		_0x208784099002BC30("SF_GRTP", 0);
		func_399(Local_81.f_9, 0, 0, 1, 0, 0);
		func_394();
		if (iLocal_142 == 9)
		{
			func_387();
...
void func_1()
{
	switch (iLocal_143)
	{
		case 0:
			func_213(&uLocal_144);
			if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_145.f_4, 0))
			{
				if (GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) < 1)
				{
					iLocal_437 = 1;
					iLocal_438 = 0;
					uLocal_144 = func_212(vLocal_161, 5, 1);
				}
				else
				{
					iLocal_437 = 1;
					iLocal_438 = 1;
					if (GET_PROFILE_SETTING(203) == 0 || !func_211())
					{
						func_209(2);
						iLocal_436 = 0;
					}
			...
			else
			{
				...
				uLocal_144 = func_207(Local_145.f_4, 1, 5);
			}
			iLocal_143 = 1;
			break;
		
		case 1:
			if (!func_206(Local_145.f_4, vLocal_161, 125f))
			{
			...
			else if (!iLocal_437)
			{
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_145.f_4, 0))
				{
					...
					{
						iLocal_438 = 0;
						if (IS_ENTITY_AT_COORD(Local_145.f_4, vLocal_161, 6f, 6f, 2f, 1, 1, 0))
						{
							func_213(&uLocal_144);
							iLocal_143 = 0;
							iLocal_142 = 6;
				...
				else if (iLocal_436 && !func_211())
				{
					func_209(3);
					iLocal_436 = 0;
				}
			}
			else if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_145.f_4, 0))
			{
				CLEAR_PRINTS();
				iLocal_437 = 0;
				iLocal_436 = 1;
			...
			else if (IS_ENTITY_AT_COORD(Local_145.f_4, vLocal_161, 6f, 6f, 2f, 1, 1, 0))
			{
				func_213(&uLocal_144);
				iLocal_143 = 0;
				iLocal_142 = 6;
...
int func_55(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_57(GET_ENTITY_MODEL(uParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_57(GET_ENTITY_MODEL(uParam0), iVar1, 14, 4);
		}
	}
...
bool func_206(var uParam0, vector3 vParam1, float fParam4)
{
...
void func_209(int iParam0)
{
	if (func_208(iParam0))
	{
		func_210(vLocal_167[iParam0 /*3*/].f_2, 7500, 1);
...
int func_212(vector3 vParam0, int iParam3, int iParam4)
{
	int iVar0;
...
void func_214()
{
	...
	{
		case 0:
			if (IS_ENTITY_AT_COORD(Local_145.f_4, vLocal_161, 10f, 10f, 2f, 0, 1, 0))
			{
				func_213(&uLocal_144);
				_SET_UNK_MAP_FLAG(0);
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_145.f_4, 0))
		...
		case 1:
			if (IS_ENTITY_AT_COORD(Local_145.f_4, vLocal_161, 10f, 10f, 2f, 0, 1, 0))
			{
				...
				{
					func_216();
					if (!func_215(PLAYER_PED_ID(), Local_145.f_4, 55f, 1) && !IS_ENTITY_ON_SCREEN(Local_145.f_4))
					{
						iLocal_143 = 2;
					}
					else if ((iLocal_433 && func_208(5)) && (GET_PROFILE_SETTING(203) == 0 || !func_211()))
					{
						func_209(5);
					}
				}
...
bool func_215(var uParam0, var uParam1, float fParam2, int iParam3)
{
...
void func_216()
{
	if (!iLocal_434)
	{
		iLocal_435 = GET_GAME_TIMER() + 3500;
		iLocal_434 = 1;
	}
	else if (!iLocal_433)
	{
		if (GET_GAME_TIMER() > iLocal_435)
		{
			if (iLocal_429 == 1)
			{
				if (func_217(&uLocal_251, 49, "BAR3AAU", "BAR3A_P1", 9, 1, 0, 0, 0))
				{
					iLocal_143 = 1;
					iLocal_433 = 1;
				}
			}
			else if (func_217(&uLocal_251, 49, "BAR3AAU", "BAR3A_P1b", 9, 1, 0, 0, 0))
			{
				iLocal_143 = 1;
				iLocal_433 = 1;
			}
...
int func_229()
{
	...
	while (iLocal_250 <= 5)
	{
		if (func_230(vLocal_167[iLocal_250 /*3*/].f_2, 0, 0))
		{
			iVar0 = 1;
		}
		iLocal_250++;
...
void func_231()
{
	...
	{
		case 0:
			if (GET_VEHICLE_PETROL_TANK_HEALTH(Local_145.f_4) < 1f)
			{
				SET_VEHICLE_PETROL_TANK_HEALTH(Local_145.f_4, 10f);
			}
			if (GET_VEHICLE_ENGINE_HEALTH(Local_145.f_4) < 1f)
			{
				SET_VEHICLE_ENGINE_HEALTH(Local_145.f_4, 10f);
			}
			if (func_234(Local_145.f_4, 1093140480, 1, 1056964608, 0, 1, 0))
			{
				func_233(0, -1);
				iLocal_442 = 0;
				iLocal_439 = 0;
		...
		case 2:
			func_232(&uLocal_251, 3, 0, "BARRY", 0, 1);
			iLocal_143 = 0;
			iLocal_142 = 7;
			break;
	}
...
int func_234(var uParam0, int iParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_236()
{
	switch (iLocal_143)
	{
		case 0:
			func_213(&uLocal_144);
			if (!func_211() || GET_PROFILE_SETTING(203) == 0)
			{
				func_209(2);
				func_247(&uLocal_450);
				iLocal_431 = 0;
			...
			iLocal_429 = 1;
			iLocal_249 = GET_GAME_TIMER() + 2500;
			iLocal_143 = 1;
			break;
		
		case 1:
			func_242(&uLocal_450, &uLocal_251, "BAR3AAU", &sLocal_451, &cLocal_457);
			if (!iLocal_248 && GET_GAME_TIMER() > iLocal_249)
			{
...
void func_239()
{
	...
	{
		if (!func_211() && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_145.f_4, 0))
		{
			if (!iLocal_425)
			{
				iLocal_425 = 1;
			...
			if ((GET_GAME_TIMER() - iLocal_427) > Local_416[iLocal_426 /*2*/].f_1 && (func_241() || iLocal_426 == 0))
			{
				if (iLocal_426 != 2 || GET_ENTITY_SPEED(Local_145.f_4) > 10f)
				{
					if (func_229() || GET_PROFILE_SETTING(203) == 0)
					{
						if (func_240(&uLocal_251, "BAR3AAU", Local_416[iLocal_426 /*2*/], 7, 1, 0, 0))
						{
							iLocal_425 = 0;
							iLocal_426++;
						}
					}
					else if (func_240(&uLocal_251, "BAR3AAU", Local_416[iLocal_426 /*2*/], 7, 0, 0, 0))
					{
						iLocal_425 = 0;
						iLocal_426++;
					}
...
int func_241()
{
	if (IS_COP_PED_IN_AREA_3D(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) - Vector(70f, 70f, 70f), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) + Vector(70f, 70f, 70f)))
	{
		return 1;
	}
	return 0;
...
void func_242(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		...
		case 4:
			if (!IS_SCRIPTED_CONVERSATION_ONGOING() && func_243(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
void func_248()
{
	switch (iLocal_143)
	{
		case 0:
			func_213(&uLocal_144);
			uLocal_144 = func_207(Local_145.f_4, 1, 5);
			SET_BLIP_ROUTE(uLocal_144, 1);
			if (func_208(3) && (GET_PROFILE_SETTING(203) == 0 || !func_211()))
			{
				func_209(3);
				func_247(&uLocal_450);
			}
	...
	switch (iLocal_143)
	{
		case 0:
			...
			if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_145.f_4, 0))
			{
				func_213(&uLocal_144);
				uLocal_144 = func_212(vLocal_161, 5, 1);
				if (func_208(0) && (GET_PROFILE_SETTING(203) == 0 || !func_211()))
				{
					func_209(0);
					func_247(&uLocal_450);
				}
		...
		case 1:
			if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_145.f_4, 0))
			{
				...
				else
				{
					...
					if (IS_PED_SITTING_IN_VEHICLE(PLAYER_PED_ID(), Local_145.f_4) && IS_ENTITY_AT_COORD(Local_145.f_4, vLocal_161, 6f, 6f, 2f, 1, 1, 0))
					{
						iLocal_439 = 0;
						iLocal_143 = 2;
					}
					if (!iLocal_432)
					{
						if (((GET_GAME_TIMER() - iLocal_427) > 8000 && iLocal_426 >= 4) && !func_211())
						{
							if (func_240(&uLocal_251, "BAR3AAU", "BAR3A_LW", 7, 0, 0, 0))
							{
								iLocal_432 = 1;
							}
						}
...
void func_252(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_200(GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
			...
			{
				iVar10 = func_323(&(Global_93682.f_3));
				if (iVar10 > -1)
				{
...
{
	func_254(&Global_100114, GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_254(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_224();
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		func_284(PLAYER_PED_ID());
		func_277(PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_276())
		{
			func_272(PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_91043[iVar0]))
		{
			if (Global_91043[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || GET_ENTITY_MODEL(iParam0) == func_263(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_266(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_277(int iParam0, bool bParam1)
{
	...
	iVar0 = func_148(iParam0);
	if (func_150(iVar0) && !IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER_PED_ID())
		{
...
void func_278(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_283(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_280(Var11.f_1)) && iVar72 < 51)
			{
...
void func_284(var uParam0)
{
	...
	if (func_150(iVar0) && !IS_PED_INJURED(uParam0))
	{
...
int func_289(var uParam0)
{
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (func_311())
		{
			*uParam0 = func_294(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_291(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_7() == 0)
		{
			return IS_BIT_SET(func_69(func_292(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_294(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_310(iVar0))
		{
			...
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_295(iVar0, 0), 1);
...
int func_298(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	vVar18 = { Var12 - Var0 };
	vVar18 = { func_299(vVar18, -Var0.f_3.f_2) };
	vVar18 = { func_299(vVar18, vVar6.f_3.f_2) };
	*uParam2 = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar6, 0f, vVar18) };
	uParam2->f_3 = { Var12.f_3 };
	return 1;
}

Vector3 func_299(vector3 vParam0, float fParam3)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
{
	return (SHIFT_RIGHT(uParam0, 26) & 31 * func_318(IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_330(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	vector3 vVar0;
	var uVar3;
	...
	if (DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_357(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_354(GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_331(Global_97130.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_331(int iParam0, vector3 vParam1, var uParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (DOES_ENTITY_EXIST(iParam0) && IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_350(iParam5, &Var0, vParam1, uParam4, func_261(iParam0));
		func_332(iParam5, iParam0, 0);
	}
}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_270(iParam0, 0, 0)) || func_270(iParam0, 1, 0)) || func_270(iParam0, 2, 0)) || func_261(iParam0) != 145) || func_348(iParam0)) || func_347(iParam0)) || func_346(iParam0)) || func_345(iParam0)) || !func_335(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_347(iParam0))
		{
		}
...
void func_350(int iParam0, var uParam1, vector3 vParam2, var uParam5, int iParam6)
{
	if (func_349(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
...
int func_354(vector3 vParam0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;
	
	iVar0 = func_355(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_355(vector3 vParam0, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_359()
{
	switch (iLocal_143)
	{
		case 0:
			func_232(&uLocal_251, 3, 0, "BARRY", 0, 1);
			if (func_217(&uLocal_251, 49, "BAR3AAU", "BAR3A_PICK2", 7, 1, 0, 0, 0))
			{
				iLocal_143 = 1;
			}
			break;
...
void func_360()
{
	...
	{
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-1142.829f, -1254.585f, 0f, -1136.686f, -1246.472f, 8f, 0, 1);
		uLocal_144 = func_207(Local_145.f_4, 1, 5);
		iLocal_142 = 1;
		iLocal_143 = 0;
	}
...
void func_361()
{
	...
	{
		SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_247);
...
void func_362(int iParam0)
{
	...
	{
		case 0:
			if (!DOES_ENTITY_EXIST(Local_186[iParam0 /*29*/].f_1))
			{
				if (func_203(Local_186[iParam0 /*29*/]))
				{
					if (HAS_MODEL_LOADED(iLocal_247))
					{
						Local_186[iParam0 /*29*/].f_1 = CREATE_PED_INSIDE_VEHICLE(Local_186[iParam0 /*29*/], 6, iLocal_247, -1, 1, 1);
						Local_186[iParam0 /*29*/].f_2 = CREATE_PED_INSIDE_VEHICLE(Local_186[iParam0 /*29*/], 6, iLocal_247, 0, 1, 1);
					}
				}
				else if (HAS_MODEL_LOADED(iLocal_246))
				{
					Local_186[iParam0 /*29*/] = CREATE_VEHICLE(iLocal_246, Local_186[iParam0 /*29*/].f_3, Local_186[iParam0 /*29*/].f_6, 1, 1, 0);
				}
			}
			else if (!IS_ENTITY_DEAD(Local_186[iParam0 /*29*/].f_1, 0))
			{
				SET_PED_AS_COP(Local_186[iParam0 /*29*/].f_1, 1);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_186[iParam0 /*29*/].f_1, 1);
				GIVE_DELAYED_WEAPON_TO_PED(Local_186[iParam0 /*29*/].f_1, joaat("weapon_pistol"), 100, 1);
				SET_PED_ACCURACY(Local_186[iParam0 /*29*/].f_1, 10);
				if (func_203(Local_186[iParam0 /*29*/].f_2))
				{
					SET_PED_AS_COP(Local_186[iParam0 /*29*/].f_2, 1);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_186[iParam0 /*29*/].f_2, 1);
					GIVE_DELAYED_WEAPON_TO_PED(Local_186[iParam0 /*29*/].f_2, joaat("weapon_pistol"), 100, 1);
					SET_PED_ACCURACY(Local_186[iParam0 /*29*/].f_2, 10);
				}
		...
		case 1:
			if (func_206(PLAYER_PED_ID(), Local_186[iParam0 /*29*/].f_3, 275f))
			{
				if (func_381(iParam0))
				{
					Local_186[iParam0 /*29*/].f_25 = GET_GAME_TIMER() + 1750;
					Local_186[iParam0 /*29*/].f_24 = 2;
				}
				else if ((func_380(Local_186[iParam0 /*29*/]) || func_367(Local_186[iParam0 /*29*/].f_1)) || func_367(Local_186[iParam0 /*29*/].f_2))
				{
					func_365(iParam0, 0);
				}
				else if (GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0)
			...
			{
				if (!Local_186[iParam0 /*29*/].f_26 && DOES_ENTITY_EXIST(Local_186[iParam0 /*29*/].f_1))
				{
					func_364(&(Local_186[iParam0 /*29*/].f_1));
					Local_186[iParam0 /*29*/].f_26 = 1;
				}
				if (!Local_186[iParam0 /*29*/].f_27 && DOES_ENTITY_EXIST(Local_186[iParam0 /*29*/].f_2))
				{
					func_364(&(Local_186[iParam0 /*29*/].f_2));
					Local_186[iParam0 /*29*/].f_27 = 1;
				}
				if (!Local_186[iParam0 /*29*/].f_28 && DOES_ENTITY_EXIST(Local_186[iParam0 /*29*/]))
				{
					func_202(&(Local_186[iParam0 /*29*/]));
			...
			{
				if ((func_367(Local_186[iParam0 /*29*/].f_1) || func_367(Local_186[iParam0 /*29*/].f_2)) || func_380(Local_186[iParam0 /*29*/]))
				{
					func_365(iParam0, 0);
				}
			}
		...
		case 2:
			if (GET_GAME_TIMER() > Local_186[iParam0 /*29*/].f_25)
			{
				func_365(iParam0, 1);
			}
			else if ((func_367(Local_186[iParam0 /*29*/].f_1) || func_367(Local_186[iParam0 /*29*/].f_2)) || func_380(Local_186[iParam0 /*29*/]))
			{
				func_365(iParam0, 0);
			}
			break;
		...
		case 3:
			if (!func_206(PLAYER_PED_ID(), Local_186[iParam0 /*29*/].f_3, 275f))
			{
				if (!Local_186[iParam0 /*29*/].f_26 && DOES_ENTITY_EXIST(Local_186[iParam0 /*29*/].f_1))
				{
					func_363(&(Local_186[iParam0 /*29*/].f_1), 1, 0, 1);
					Local_186[iParam0 /*29*/].f_26 = 1;
				}
				if (!Local_186[iParam0 /*29*/].f_27 && DOES_ENTITY_EXIST(Local_186[iParam0 /*29*/].f_2))
				{
...
void func_365(int iParam0, int iParam1)
{
	...
	if (func_203(Local_186[iParam0 /*29*/].f_1))
	{
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_186[iParam0 /*29*/].f_1, 0);
		_0x52D59AB61DDC05DD(Local_186[iParam0 /*29*/].f_1, 1);
		func_363(&(Local_186[iParam0 /*29*/].f_1), 1, 0, 1);
	}
	if (func_203(Local_186[iParam0 /*29*/].f_2))
	{
		SET_PED_AS_COP(Local_186[iParam0 /*29*/].f_2, 1);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_186[iParam0 /*29*/].f_2, 0);
		_0x52D59AB61DDC05DD(Local_186[iParam0 /*29*/].f_2, 1);
		func_363(&(Local_186[iParam0 /*29*/].f_2), 1, 0, 1);
	}
	if (iParam1 && func_203(Local_186[iParam0 /*29*/]))
	{
		SET_VEHICLE_ENGINE_ON(Local_186[iParam0 /*29*/], 1, 1, 0);
		func_366(&(Local_186[iParam0 /*29*/]));
	}
...
int func_367(int iParam0)
{
	...
	if (func_203(iParam0))
	{
		...
		if (IS_PED_BEING_JACKED(iParam0) && func_215(iParam0, PLAYER_PED_ID(), 2f, 1))
		{
			return 1;
		}
		...
		else if (IS_PROJECTILE_IN_AREA(vVar0 - Vector(3f, 3f, 3f), vVar0 + Vector(3f, 3f, 3f), 1))
		{
			return 1;
		}
...
int func_368(int iParam0, float fParam1)
{
	...
	if (func_203(PLAYER_PED_ID()) && func_203(iParam0))
	{
		if (func_379(iParam0) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), iParam0))
		{
...
bool func_370(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	iVar4 = func_378(iParam0, iParam1);
	if (!func_203(iParam0) || !func_203(iParam1))
	{
		if (iVar4 != -1)
		{
			func_377(&(Local_37[iVar4 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_371(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
...
int func_374(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_376(GET_ENTITY_COORDS(iParam1, 1) - GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		vVar3 = { func_376(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_380(var uParam0)
{
	...
	if (DOES_ENTITY_EXIST(uParam0))
	{
		...
		else if (IS_PROJECTILE_IN_AREA(vVar0 - Vector(5f, 5f, 5f), vVar0 + Vector(5f, 5f, 5f), 1))
		{
			return 1;
		}
	}
...
{
	if (IS_ENTITY_IN_ANGLED_AREA(Local_145.f_4, Local_186[iParam0 /*29*/].f_7[0 /*8*/][0 /*3*/], Local_186[iParam0 /*29*/].f_7[0 /*8*/][1 /*3*/], Local_186[iParam0 /*29*/].f_7[0 /*8*/].f_7, 0, 1, 0))
	{
		return 1;
	}
	else if (Local_186[iParam0 /*29*/].f_7[1 /*8*/].f_7 != 0f && IS_ENTITY_IN_ANGLED_AREA(Local_145.f_4, Local_186[iParam0 /*29*/].f_7[1 /*8*/][0 /*3*/], Local_186[iParam0 /*29*/].f_7[1 /*8*/][1 /*3*/], Local_186[iParam0 /*29*/].f_7[1 /*8*/].f_7, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
int func_384()
{
	if (IS_VEHICLE_STUCK_ON_ROOF(Local_145.f_4))
	{
		if (iLocal_153)
		{
			if ((GET_GAME_TIMER() - iLocal_154) > 7000)
			{
				return 1;
			}
		}
...
int func_385()
{
	switch (iLocal_439)
	{
		...
		case 1:
			iLocal_440 = GET_MILLISECONDS_PER_GAME_MINUTE() * 120;
			iLocal_440 = (iLocal_440 + GET_GAME_TIMER());
			iLocal_441 = (iLocal_440 - GET_MILLISECONDS_PER_GAME_MINUTE() * 30);
		...
		case 2:
			if (GET_GAME_TIMER() >= iLocal_440)
			{
				return 1;
			}
			else
			{
				if ((!iLocal_443 && GET_GAME_TIMER() >= iLocal_441) && !func_211())
				{
					if (func_240(&uLocal_251, "BAR3AAU", "BAR3A_HURRY", 7, 0, 0, 0))
					{
						iLocal_443 = 1;
					}
				}
...
void func_386()
{
	...
	if (iVar0 >= iLocal_446)
	{
		if ((iVar0 - iLocal_447) > 500)
		{
			...
			iLocal_447 = GET_GAME_TIMER() + 1000;
		}
	}
	...
	switch (iLocal_143)
	{
		case 0:
			if (!func_393())
			{
				...
				CLEAR_PRINTS();
				CLEAR_HELP(1);
				if (IS_STRING_NULL_OR_EMPTY(sLocal_449))
				{
					sLocal_449 = "DEFAULT";
				}
				if (ARE_STRINGS_EQUAL(sLocal_449, "DEFAULT"))
				{
					func_462(1);
				}
				else
				{
					func_391(sLocal_449, 1);
				}
				iLocal_143 = 1;
			}
			break;
...
void func_388(bool bParam0)
{
	if (bParam0)
	{
		...
		while (iLocal_250 <= 1)
		{
			func_364(&(Local_186[iLocal_250 /*29*/].f_1));
			func_364(&(Local_186[iLocal_250 /*29*/].f_2));
			iLocal_250++;
		}
		iLocal_250 = 0;
		while (iLocal_250 <= 1)
		{
			func_202(&(Local_186[iLocal_250 /*29*/]));
			iLocal_250++;
		}
	}
	else
	{
		func_389(&uLocal_155, 0);
		func_366(&(Local_145.f_4));
		iLocal_250 = 0;
		while (iLocal_250 <= 1)
		{
			func_363(&(Local_186[iLocal_250 /*29*/].f_1), 1, 0, 1);
			func_363(&(Local_186[iLocal_250 /*29*/].f_2), 1, 0, 1);
			func_366(&(Local_186[iLocal_250 /*29*/]));
			iLocal_250++;
		}
	}
	if (iLocal_245)
	...
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-1142.829f, -1254.585f, 0f, -1136.686f, -1246.472f, 8f, 1, 1);
}
...
void func_394()
{
	...
	if (iLocal_442)
	{
		if ((!IS_CUTSCENE_PLAYING() && !func_398(0)) && !func_393())
		{
			iVar0 = (iLocal_440 - GET_GAME_TIMER());
			if (iVar0 < 0)
			{
				iVar0 = 0;
			}
...
void func_399(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71844 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_401(Global_71845, Global_71847, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_402(iVar2), 8);
					break;
			}
			break;
...
{
	if (((!func_412(0) || Global_71859) || Global_71848 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_398(0)) || func_411(1))
			{
			}
			else
			{
...
void func_415()
{
	if (func_203(Local_145.f_4))
	{
		SET_VEHICLE_STRONG(Local_145.f_4, 1);
		SET_VEHICLE_HAS_STRONG_AXLES(Local_145.f_4, 1);
		_0x51BB2D88D31A914B(Local_145.f_4, 0);
		_0x192547247864DFDD(Local_145.f_4, 0);
		if (!bLocal_152)
		{
			ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_145.f_4);
		}
		func_416(Local_145.f_4, 0);
	}
}
...
void func_424(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_428(PLAYER_ID())) && !func_426(PLAYER_ID(), 0)) && !func_425()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_428(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
...
int func_430(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_432(bool bParam0)
{
	...
	{
		SET_ENTITY_COORDS(PLAYER_PED_ID(), -1243.316f, -1041.637f, 7.5121f, 1, 0, 0, 1);
...
{
	REQUEST_MODEL(Local_145.f_5);
	REQUEST_MODEL(iLocal_159);
	while (!HAS_MODEL_LOADED(Local_145.f_5) || !HAS_MODEL_LOADED(iLocal_159))
	{
		WAIT(0);
	}
	if (func_203(Local_145.f_4))
	{
		if (bLocal_152)
		{
			REMOVE_VEHICLE_UPSIDEDOWN_CHECK(Local_145.f_4);
			bLocal_152 = false;
		}
	}
	if (bParam4)
	...
	func_205(&uLocal_155);
	func_202(&(Local_145.f_4));
	Local_145.f_4 = CREATE_VEHICLE(Local_145.f_5, vParam0, fParam3, 1, 1, 0);
	SET_VEHICLE_COLOUR_COMBINATION(Local_145.f_4, 1);
	if (bParam4)
	{
		func_438(PLAYER_PED_ID(), Local_145.f_4, -1);
	}
	_0x51BB2D88D31A914B(Local_145.f_4, 0);
	_0x192547247864DFDD(Local_145.f_4, 0);
	SET_VEHICLE_STRONG(Local_145.f_4, 1);
	SET_VEHICLE_HAS_STRONG_AXLES(Local_145.f_4, 1);
	ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_145.f_4);
	SET_VEHICLE_EXTRA(Local_145.f_4, 1, 1);
	SET_VEHICLE_EXTRA(Local_145.f_4, 2, 1);
	SET_VEHICLE_EXTRA(Local_145.f_4, 3, 1);
	uLocal_155 = CREATE_OBJECT(iLocal_159, vParam0, 1, 1, 0);
	ATTACH_ENTITY_TO_ENTITY(uLocal_155, Local_145.f_4, 0, vLocal_156, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
	SET_ENTITY_COLLISION(uLocal_155, 1, 0);
	bLocal_152 = true;
	func_416(Local_145.f_4, 0);
	SET_MODEL_AS_NO_LONGER_NEEDED(Local_145.f_5);
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_159);
}
...
void func_441(bool bParam0)
{
	...
	if (bParam0)
	{
		if (!DOES_ENTITY_EXIST(Local_145.f_4))
		{
			func_437(Local_145, Local_145.f_3, 0);
		}
		while (!HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			WAIT(0);
	...
	{
		func_437(Local_145, Local_145.f_3, 1);
	}
	iLocal_439 = 1;
	iLocal_442 = 1;
}
...
void func_446()
{
	...
	if (func_203(PLAYER_PED_ID()))
	{
		func_232(&uLocal_251, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	iLocal_432 = 0;
	iLocal_443 = 0;
	iLocal_426 = 0;
	...
	sLocal_449 = "DEFAULT";
	func_447(49, 1, 0);
	uLocal_164[0] = ADD_SCENARIO_BLOCKING_AREA(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, 0, 1, 1, 1);
	uLocal_164[1] = ADD_SCENARIO_BLOCKING_AREA(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, 0, 1, 1, 1);
...
void func_450()
{
	vLocal_167[0 /*3*/] = { func_451("B3ADELV", 1) };
	vLocal_167[1 /*3*/] = { func_451("B3AGETIN", 1) };
	vLocal_167[2 /*3*/] = { func_451("B3AWAN1", -1) };
	vLocal_167[3 /*3*/] = { func_451("B3ARTV", 1) };
	vLocal_167[4 /*3*/] = { func_451("B3AEXIT", 1) };
	vLocal_167[5 /*3*/] = { func_451("B3ALEAVE", 1) };
}
...
void func_453()
{
	...
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_164[0], 0);
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_164[1], 0);
	_SET_UNK_MAP_FLAG(0);
...
void func_462(bool bParam0)
{
	...
	if (!func_479())
	{
		...
		{
			func_158(iVar0, 1, 0);
			func_463(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_105652[iVar0 /*10*/].f_9 == -1)
...
int func_464(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_467())
	{
		...
		{
			iVar33 = func_323(GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
