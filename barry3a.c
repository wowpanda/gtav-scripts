...
void func_252(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_321(&(Global_92955.f_3));
				if (iVar6 > -1)
				{
...
{
	func_254(&Global_98783, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_254(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_224();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_276())
		{
			func_272(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
...
void func_277(int iParam0, bool bParam1)
{
	...
	if (func_150(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_278(iParam0, &(Global_105220.f_2354.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_278(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_280(Var7.f_1)) && iVar9 < 50)
			{
...
Vector3 func_295(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_306(Global_95018);
			break;
		
		case 46:
			if (Global_1589135 != func_305())
			{
				if (func_304(Global_1589135))
				{
					return func_297(2, 2);
				}
				else if (func_296(Global_1589135))
				{
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_316(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_322(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_323(Global_105220.f_9056.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_323(Global_105220.f_9056.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_323(Global_105220.f_9056.f_99.f_205[11]);
			break;
		
		case 90:
			return func_323(Global_105220.f_9056.f_99.f_205[7]);
			break;
		
		case 93:
			return func_323(Global_105220.f_9056.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
void func_328(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	vector3 vVar0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_95814.f_4))
	{
		...
		{
			if (func_355(24) != Global_95814.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_352(ENTITY::GET_ENTITY_COORDS(Global_95814.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_329(Global_95814.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}

void func_329(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
...
void func_330(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_347(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_105220.f_32546.f_4801 = func_310();
			}
...
void func_331(int iParam0, int iParam1)
{
	...
	func_265(iParam0, &(Global_105220.f_32546.f_5510));
}

int func_332(int iParam0)
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_270(iParam0, 0, 0)) || func_270(iParam0, 1, 0)) || func_270(iParam0, 2, 0)) || func_261(iParam0) != 145) || func_346(iParam0)) || func_345(iParam0)) || func_344(iParam0)) || func_343(iParam0)) || !func_333(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_345(iParam0))
		{
		}
...
int func_347(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_288(Global_105220.f_32546.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_288(Global_105220.f_2354.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_288(Global_105220.f_2354.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_348(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_347(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_350(iParam0);
			func_349(uParam1, &(Global_105220.f_32546.f_69[Global_69800.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_352(vector3 vParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
...
int func_353(vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_372(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_374(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		vVar1 = { func_374(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
Vector3 func_374(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
void func_392()
{
	...
	if (iLocal_246)
	{
		if ((!CUTSCENE::IS_CUTSCENE_PLAYING() && !func_396(0)) && !func_391())
		{
...
void func_393(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16)
{
	int iVar0;
	int iVar1;
	...
	if (Global_71232 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_399(Global_71233, Global_71235, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_410(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_396(0)) || func_409(1))
			{
			}
			else
			{
...
{
	return func_412(iParam0, Global_35905);
}
...
void func_422(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_426(PLAYER::PLAYER_ID())) && !func_424(PLAYER::PLAYER_ID(), 0)) && !func_423()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_426(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_70976 = 0;
...
int func_428(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_435(vector3 vParam0, float fParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		func_436(PLAYER::PLAYER_PED_ID(), Local_43.f_4, -1);
	}
	VEHICLE::_0x51BB2D88D31A914B(Local_43.f_4, false);
	VEHICLE::_0x192547247864DFDD(Local_43.f_4, false);
	VEHICLE::SET_VEHICLE_STRONG(Local_43.f_4, true);
...
Vector3 func_449(char* sParam0, int iParam1)
{
	vector3 vVar0;
...
int func_462(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_465())
	{
		...
		{
			iVar2 = func_321(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_463()
{
	...
	iVar0 = func_324(&(Global_92955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_465()
{
	...
	{
		if (func_321(&(Global_92955.f_3)) > -1)
		{
			return 1;
		}
	}
