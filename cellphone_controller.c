...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Global_71590 == 1)
		{
			if (Global_14553.f_1 == 3)
			{
				if (IS_BIT_SET(Global_4269308, 15))
				{
				...
				if (IS_BIT_SET(Global_4269308, 16))
				{
					SET_BIT(&Global_4269308, 14);
					WAIT(0);
				...
				if (IS_BIT_SET(Global_4269308, 27))
				{
					SET_BIT(&Global_4269308, 14);
					WAIT(0);
		...
		if (Global_71590 == 0)
		{
			if (IS_BIT_SET(Global_4269308, 11))
			{
				if ((Global_14553.f_1 != 10 && Global_14553.f_1 != 9) || func_69() == 0)
				{
					CLEAR_BIT(&Global_4269308, 11);
			...
			else if (Global_14553.f_1 == 10 || Global_14553.f_1 == 9)
			{
				if (func_69())
				{
					SET_BIT(&Global_4269308, 11);
					SET_BIT(&Global_2424, 11);
				}
			}
			if (IS_BIT_SET(Global_4269308, 12))
			{
				CLEAR_BIT(&Global_4269308, 12);
				SET_BIT(&Global_2424, 11);
			}
		}
		else if (IS_BIT_SET(Global_4269308, 12))
		{
		...
		if (IS_PC_VERSION())
		{
			...
			{
				if (!IS_BIT_SET(Global_4269308, 19))
				{
					SET_BIT(&Global_4269308, 19);
					SET_BIT(&Global_2424, 11);
				}
			}
			else if (IS_BIT_SET(Global_4269308, 19))
			{
				CLEAR_BIT(&Global_4269308, 19);
				SET_BIT(&Global_2424, 11);
			}
		}
		if (iLocal_93 == 0)
		{
			if (IS_BIT_SET(Global_2423, 25))
			{
				STAT_GET_INT(joaat("sp_cellphone_sleep_time"), &iLocal_92, -1);
				iLocal_90 = GET_GAME_TIMER();
				iLocal_93 = 1;
			}
		}
		else if (!IS_BIT_SET(Global_2423, 25))
		{
			STAT_GET_INT(joaat("sp_cellphone_sleep_time"), &iLocal_92, -1);
			iLocal_91 = GET_GAME_TIMER();
			iLocal_93 = 0;
			STAT_SET_INT(joaat("sp_cellphone_sleep_time"), (iLocal_92 + (iLocal_91 - iLocal_90)), 1);
		}
		func_68();
		func_67();
		func_66();
		...
		if (IS_BIT_SET(Global_2423, 7))
		{
			func_47();
			CLEAR_BIT(&Global_2423, 7);
		}
		if (IS_BIT_SET(Global_2423, 0))
		{
			func_46();
		}
		if (IS_BIT_SET(Global_4269308, 0))
		{
			func_45();
		}
		if (IS_BIT_SET(Global_2424, 11))
		{
			Global_3127 = 0;
			if (IS_BIT_SET(Global_2423, 25))
			{
			...
			if (IS_BIT_SET(Global_4269308, 28))
			{
				if (Global_71590 == 1)
				{
					Global_3127++;
...
void func_1()
{
	iLocal_70 = _RETURN_TWO(Global_16905);
	switch (iLocal_70)
	{
		case 0:
			Global_16901 = 4;
...
void func_2()
{
	if (_0xEC72C258667BE5EA(Global_16905))
	{
		Global_16901 = 13;
	}
	else
...
void func_3()
{
	if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		iLocal_68 = GET_TIME_DIFFERENCE(GET_NETWORK_TIME(), uLocal_66);
	}
	else
	{
...
void func_4()
{
	iLocal_70 = _0x0C0C4E81E1AC60A0();
	switch (iLocal_70)
	{
		case 0:
			if (NETWORK_IS_GAME_IN_PROGRESS())
			{
				uLocal_66 = GET_NETWORK_TIME();
			}
			else
			{
...
void func_5()
{
	...
	if (_0x3DEC726C25A11BAC(Global_16906))
	{
		Global_16901 = 10;
		_BEGIN_TEXT_COMMAND_BUSY_STRING("CELL_278");
...
void func_7()
{
	iLocal_70 = _0xF5BED327CEA362B1(1);
	switch (iLocal_70)
	{
		case 0:
			Global_16901 = 9;
...
void func_8()
{
	iLocal_70 = _0xCB82A0BF0E3E3265(iLocal_71);
	switch (iLocal_70)
	{
		case 0:
...
void func_9()
{
	if (_0x759650634F07B6B4(iLocal_71))
	{
		Global_16901 = 5;
	}
	else
...
int func_15()
{
	...
	if ((func_21(2, Global_14520, 0) && !IS_HUD_COMPONENT_ACTIVE(19)) && !IS_STUNT_JUMP_IN_PROGRESS())
	{
		if (IS_PC_VERSION())
		{
			if (DECOR_EXIST_ON(PLAYER_PED_ID(), "Synched"))
			{
				uVar0 = _GET_LABEL_TEXT("CELL_ANTIH_A");
				_SET_NOTIFICATION_TEXT_ENTRY("CELL_ANTIH");
				_SET_NOTIFICATION_MESSAGE("CHAR_SOCIAL_CLUB", "CHAR_SOCIAL_CLUB", 0, 0, uVar0, 0);
			}
		}
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			if (func_20(PLAYER_PED_ID()) || IS_PED_AIMING_FROM_COVER(PLAYER_PED_ID()))
			{
		...
		Global_16925 = 0;
		Global_16926 = 0;
		if (_GET_CURRENT_NOTIFICATION() == Global_16923 && _GET_CURRENT_NOTIFICATION() != -1)
		{
			Global_16925 = Global_16924;
			iLocal_74 = GET_GAME_TIMER();
			iLocal_76 = 0;
			iLocal_77 = 0;
			while (((func_19(2, Global_14520) && iLocal_76 < 250) && Global_14733 == 0) && !IS_HUD_COMPONENT_ACTIVE(19))
			{
				if (Global_3127 > 0)
				{
					func_16();
			...
			if ((func_19(2, Global_14520) && Global_14733 == 0) && !IS_HUD_COMPONENT_ACTIVE(19))
			{
				iLocal_77 = 1;
			}
			if (Global_14733 == 0)
...
void func_16()
{
	...
	if (Global_16931)
	{
		...
		if (!func_18())
		{
			...
			DRAW_SCALEFORM_MOVIE(uLocal_37, fLocal_84, fLocal_85, 0.27f, 0.45f, 255, 255, 255, iVar0, 0);
	...
	else
	{
		if (IS_PC_VERSION())
		{
			...
			else if (IS_BIT_SET(Global_2423, 13))
			{
				if (IS_BIT_SET(Global_4269308, 19))
				{
					bLocal_38 = false;
		...
		else if (Global_2416063.f_1486 || IS_BIT_SET(Global_2423, 13))
		{
			bLocal_38 = true;
		}
		else
				...
				if (!bLocal_38)
				{
					if (!func_17())
					{
						if (IS_PLAYER_PLAYING(PLAYER_ID()))
						{
							...
							{
								SET_SCRIPT_GFX_DRAW_ORDER(4);
								if (IS_PC_VERSION() && Global_2416063.f_1486)
								{
									fLocal_87 = 0.165f;
									fLocal_88 = 0.755f;
								}
								...
								if (!func_18())
								{
									...
									if (Global_2416063.f_1486)
									{
										...
										{
											DRAW_SCALEFORM_MOVIE(uLocal_37, (fLocal_84 + fLocal_39), (fLocal_85 + fLocal_40), 0.27f, 0.45f, 255, 255, 255, iVar0, 0);
										}
									}
									else
									{
...
{
	if (IS_CONTROL_PRESSED(iParam0, uParam1))
	{
		if (IS_PC_VERSION())
		{
...
void func_23()
{
	...
	switch (Global_14553.f_1)
	{
		case 6:
			...
			if (Global_3028 == 1)
			{
				func_30(Global_14534, "DISPLAY_VIEW", 1f, TO_FLOAT(Global_14557), -1082130432, -1082130432, -1082130432);
				Global_14533 = Global_14557;
			}
			else
			{
				func_30(Global_14534, "DISPLAY_VIEW", 1f, TO_FLOAT(Global_14558), -1082130432, -1082130432, -1082130432);
		...
		case 9:
			...
			{
				func_26();
				func_30(Global_14534, "SET_THEME", TO_FLOAT(Global_106565.f_14045[Global_14553 /*20*/].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
				if (Global_15879)
				{
				...
				{
					func_27(Global_14534, "SET_DATA_SLOT", TO_FLOAT(4), TO_FLOAT(0), TO_FLOAT(2), -1f, -1f, &(Global_117[Global_1738 /*10*/].f_4), "CELL_300", "CELL_217", "CELL_195", 0);
				}
				else
				{
					func_27(Global_14534, "SET_DATA_SLOT", TO_FLOAT(4), TO_FLOAT(0), TO_FLOAT(2), -1f, -1f, &(Global_106565.f_28044[Global_1738 /*29*/].f_3), &(Global_106565.f_28044[Global_1738 /*29*/].f_7), "CELL_217", &(Global_106565.f_28044[Global_1738 /*29*/].f_3), 0);
				}
				func_30(Global_14534, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			else if (Global_15866 == 4 || Global_15866 == 3)
			{
				...
				else
				{
					...
					if (Global_106565.f_28044[Global_1738 /*29*/].f_24[Global_14553] == 0)
					{
						...
						func_27(Global_14534, "SET_DATA_SLOT", TO_FLOAT(4), TO_FLOAT(0), TO_FLOAT(3), -1f, -1f, &(Global_117[Global_1738 /*10*/].f_4), "CELL_300", &vVar0, "CELL_195", 0);
					}
					else
					{
						func_30(Global_14534, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_27(Global_14534, "SET_DATA_SLOT", TO_FLOAT(4), TO_FLOAT(0), TO_FLOAT(3), -1f, -1f, &(Global_106565.f_28044[Global_1738 /*29*/].f_3), &(Global_106565.f_28044[Global_1738 /*29*/].f_7), &vVar0, &(Global_106565.f_28044[Global_1738 /*29*/].f_3), 0);
					}
				}
				func_30(Global_14534, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
					...
					if (iVar0 == Global_2430[iVar1 /*15*/].f_4)
					{
						if (Global_2992[iVar0] == 0)
						{
							...
							if (Global_2458608)
							{
								if (iVar1 == 14)
								{
									func_27(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(Global_16929), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_2992[iVar0] = 1;
						}
					...
					if (iVar0 == Global_2430[iVar1 /*15*/].f_4)
					{
						if (Global_2992[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_27(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(Global_16934), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_71590)
								{
									...
									func_27(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(iVar4), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_14553)
									...
									func_27(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(uVar6), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_2430[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_27(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(iVar9), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_27(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(0), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_2992[iVar0] = 1;
						}
					}
...
void func_32()
{
	if (func_15() || IS_BIT_SET(Global_2423, 8))
	{
		CLEAR_BIT(&Global_2423, 8);
		func_38();
		if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
		{
...
void func_45()
{
	...
	CLEAR_BIT(&Global_4269308, 0);
	if (Global_16927 != 0)
	{
		if (IS_PEDHEADSHOT_VALID(Global_16927))
		{
			if (IS_PEDHEADSHOT_READY(Global_16927))
			{
				StringCopy(&cVar0, GET_PEDHEADSHOT_TXD_STRING(Global_16927), 64);
	...
	{
		StringCopy(&cVar0, _GET_LABEL_TEXT(&(Global_106565.f_28044[Global_4268043[Global_4269292 /*104*/].f_17 /*29*/].f_7)), 64);
		Global_16935[Global_4269292] = 0;
	}
	...
	if (((((((Global_4268043[Global_4269292 /*104*/].f_32 == 4 || Global_4268043[Global_4269292 /*104*/].f_32 == 5) || Global_4268043[Global_4269292 /*104*/].f_32 == 6) || Global_4268043[Global_4269292 /*104*/].f_32 == 7) || Global_4268043[Global_4269292 /*104*/].f_32 == 8) || Global_4268043[Global_4269292 /*104*/].f_32 == 9) || Global_4268043[Global_4269292 /*104*/].f_32 == 10) || Global_4268043[Global_4269292 /*104*/].f_32 == 11)
	{
		...
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_4268043[Global_4269292 /*104*/]));
		while (iVar16 < Global_4268043[Global_4269292 /*104*/].f_49)
		{
			switch (Global_4268043[Global_4269292 /*104*/].f_32)
			{
				case 4:
					ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_2528542.f_1653[iVar16 /*4*/]));
					break;
				
				case 5:
					ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1657086[iVar16 /*4*/]));
					break;
				
				case 6:
					ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1657127[iVar16 /*4*/]));
					break;
				
				case 7:
					ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1657148[iVar16 /*4*/]));
					break;
				
				case 8:
					ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1657165[iVar16 /*4*/]));
					break;
				
				case 9:
					ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1657178[iVar16 /*4*/]));
					break;
				
				case 10:
					ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1657191[iVar16 /*4*/]));
					break;
				
				case 11:
					ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1657204[iVar16 /*4*/]));
					break;
			}
			iVar16++;
		}
		StringCopy(&cVar17, _GET_LABEL_TEXT(&(Global_106565.f_28044[Global_4268043[Global_4269292 /*104*/].f_17 /*29*/].f_3)), 64);
		uLocal_64 = _SET_NOTIFICATION_MESSAGE(&cVar0, &cVar0, 0, 2, &cVar17, 0);
		SET_BIT(&Global_4269308, 1);
		Global_16924 = 1;
	...
	{
		_SET_NOTIFICATION_TEXT_ENTRY(&(Global_4268043[Global_4269292 /*104*/]));
		switch (Global_4268043[Global_4269292 /*104*/].f_32)
		{
			case 0:
				break;
			...
			case 1:
				ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4268043[Global_4269292 /*104*/].f_33));
				if (Global_4268043[Global_4269292 /*104*/].f_66 == 1 && !ARE_STRINGS_EQUAL(&(Global_4268043[Global_4269292 /*104*/].f_67), "NULL"))
				{
					ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4268043[Global_4269292 /*104*/].f_67));
				}
				if ((Global_4268043[Global_4269292 /*104*/].f_66 == 2 && !ARE_STRINGS_EQUAL(&(Global_4268043[Global_4269292 /*104*/].f_67), "NULL")) && !ARE_STRINGS_EQUAL(&(Global_4268043[Global_4269292 /*104*/].f_83), "NULL"))
				{
					if (DOES_TEXT_LABEL_EXIST(&(Global_4268043[Global_4269292 /*104*/].f_67)))
					{
						ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_4268043[Global_4269292 /*104*/].f_67));
					}
					else
					{
						ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4268043[Global_4269292 /*104*/].f_67));
					}
					if (DOES_TEXT_LABEL_EXIST(&(Global_4268043[Global_4269292 /*104*/].f_83)))
					{
						ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_4268043[Global_4269292 /*104*/].f_83));
					}
					else
					{
						ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4268043[Global_4269292 /*104*/].f_83));
					}
				}
				break;
			
			case 2:
				ADD_TEXT_COMPONENT_INTEGER(Global_4268043[Global_4269292 /*104*/].f_49);
				break;
		...
		if (Global_4268043[Global_4269292 /*104*/].f_17 == 145)
		{
			...
			uLocal_64 = _SET_NOTIFICATION_MESSAGE(&cVar0, &cVar0, 0, 2, &cVar33, 0);
			SET_BIT(&Global_4269308, 1);
			Global_16924 = 1;
			Global_16923 = uLocal_64;
		}
		...
		{
			StringCopy(&cVar49, _GET_LABEL_TEXT(&(Global_106565.f_28044[Global_4268043[Global_4269292 /*104*/].f_17 /*29*/].f_3)), 64);
			if (Global_4268043[Global_4269292 /*104*/].f_17 == 98)
			{
				StringCopy(&cVar65, "~HUD_COLOUR_SOCIAL_CLUB~", 64);
				StringConCat(&cVar65, &cVar49, 64);
				uLocal_64 = _SET_NOTIFICATION_MESSAGE(&cVar0, &cVar0, 0, 2, &cVar65, 0);
			}
			else
			{
				uLocal_64 = _SET_NOTIFICATION_MESSAGE(&cVar0, &cVar0, 0, 2, &cVar49, 0);
			}
			SET_BIT(&Global_4269308, 1);
			Global_16924 = 1;
			Global_16923 = uLocal_64;
...
void func_47()
{
	if (IS_BIT_SET(Global_2423, 1))
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			uLocal_53[Global_14553] = GET_NETWORK_TIME();
			iLocal_43[Global_14553] = 1;
		}
		else if (!IS_BIT_SET(Global_2423, 10))
		{
			uLocal_48[Global_14553] = GET_GAME_TIMER();
			iLocal_43[Global_14553] = 1;
		}
		else
		{
			uLocal_48[0] = GET_GAME_TIMER();
			uLocal_48[2] = GET_GAME_TIMER();
			uLocal_48[1] = GET_GAME_TIMER();
			iLocal_43[0] = 1;
			iLocal_43[2] = 1;
			iLocal_43[1] = 1;
		}
		CLEAR_BIT(&Global_2423, 1);
	}
}
...
void func_50()
{
	...
	{
		StringCopy(&cVar0, _GET_LABEL_TEXT(&(Global_106565.f_28044[Global_106565.f_14135[Global_16933 /*104*/].f_17 /*29*/].f_7)), 64);
	...
	if (((((((Global_106565.f_14135[Global_16933 /*104*/].f_32 == 4 || Global_106565.f_14135[Global_16933 /*104*/].f_32 == 5) || Global_106565.f_14135[Global_16933 /*104*/].f_32 == 6) || Global_106565.f_14135[Global_16933 /*104*/].f_32 == 7) || Global_106565.f_14135[Global_16933 /*104*/].f_32 == 8) || Global_106565.f_14135[Global_16933 /*104*/].f_32 == 9) || Global_106565.f_14135[Global_16933 /*104*/].f_32 == 10) || Global_106565.f_14135[Global_16933 /*104*/].f_32 == 11)
	{
		...
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_106565.f_14135[Global_16933 /*104*/]));
		...
		StringCopy(&cVar17, _GET_LABEL_TEXT(&(Global_106565.f_28044[Global_106565.f_14135[Global_16933 /*104*/].f_17 /*29*/].f_3)), 64);
		uLocal_64 = _SET_NOTIFICATION_MESSAGE(&cVar0, &cVar0, 0, 1, &cVar17, 0);
		Global_16924 = 3;
		Global_16923 = uLocal_64;
		Global_16927 = 0;
	}
	...
	{
		_SET_NOTIFICATION_TEXT_ENTRY(&(Global_106565.f_14135[Global_16933 /*104*/]));
		switch (Global_106565.f_14135[Global_16933 /*104*/].f_32)
		{
			case 0:
				break;
			...
			case 1:
				ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106565.f_14135[Global_16933 /*104*/].f_33));
				if (Global_106565.f_14135[Global_16933 /*104*/].f_66 == 1 && !ARE_STRINGS_EQUAL(&(Global_106565.f_14135[Global_16933 /*104*/].f_67), "NULL"))
				{
					ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106565.f_14135[Global_16933 /*104*/].f_67));
				}
				if ((Global_106565.f_14135[Global_16933 /*104*/].f_66 == 2 && !ARE_STRINGS_EQUAL(&(Global_106565.f_14135[Global_16933 /*104*/].f_67), "NULL")) && !ARE_STRINGS_EQUAL(&(Global_106565.f_14135[Global_16933 /*104*/].f_83), "NULL"))
				{
					if (DOES_TEXT_LABEL_EXIST(&(Global_106565.f_14135[Global_16933 /*104*/].f_67)))
					{
						ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_106565.f_14135[Global_16933 /*104*/].f_67));
					}
					else
					{
						ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106565.f_14135[Global_16933 /*104*/].f_67));
					}
					if (DOES_TEXT_LABEL_EXIST(&(Global_106565.f_14135[Global_16933 /*104*/].f_83)))
					{
						ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_106565.f_14135[Global_16933 /*104*/].f_83));
					}
					else
					{
						ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106565.f_14135[Global_16933 /*104*/].f_83));
					}
				}
				break;
			
			case 2:
				ADD_TEXT_COMPONENT_INTEGER(Global_106565.f_14135[Global_16933 /*104*/].f_49);
				break;
		...
		if (Global_106565.f_14135[Global_16933 /*104*/].f_17 == 145)
		{
			...
			StringConCat(&cVar33, &Global_3111, 64);
			StringConCat(&cVar33, "</C>", 64);
			uLocal_64 = _SET_NOTIFICATION_MESSAGE(&cVar0, &cVar0, 0, 1, &cVar33, 0);
			Global_16924 = 3;
			Global_16923 = uLocal_64;
		}
		else
		{
			StringCopy(&cVar49, _GET_LABEL_TEXT(&(Global_106565.f_28044[Global_106565.f_14135[Global_16933 /*104*/].f_17 /*29*/].f_3)), 64);
			if (Global_106565.f_14135[Global_16933 /*104*/].f_17 == 98)
			{
				StringCopy(&cVar65, "~HUD_COLOUR_SOCIAL_CLUB~", 64);
				StringConCat(&cVar65, &cVar49, 64);
				uLocal_64 = _SET_NOTIFICATION_MESSAGE(&cVar0, &cVar0, 0, 1, &cVar65, 0);
			}
			else
			{
				uLocal_64 = _SET_NOTIFICATION_MESSAGE(&cVar0, &cVar0, 0, 1, &cVar49, 0);
			}
			Global_16924 = 3;
			Global_16923 = uLocal_64;
			Global_16927 = 0;
...
void func_51()
{
	if (IS_BIT_SET(Global_2423, 19))
	{
		CLEAR_BIT(&Global_2423, 19);
		func_38();
...
void func_52()
{
	if (iLocal_43[Global_14553] == 1)
	{
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			iLocal_63 = GET_TIME_DIFFERENCE(GET_NETWORK_TIME(), uLocal_53[Global_14553]);
		}
		else
		{
			uLocal_58[Global_14553] = GET_GAME_TIMER();
			iLocal_63 = (uLocal_58[Global_14553] - uLocal_48[Global_14553]);
		}
		if (iLocal_63 > 300000)
		{
	...
	if (Global_71590 == 0)
	{
		if (!func_44())
		{
			...
			else
			{
				if (NETWORK_IS_GAME_IN_PROGRESS())
				{
					iLocal_79 = GET_TIME_DIFFERENCE(GET_NETWORK_TIME(), uLocal_78);
				}
				else
				{
...
int func_57(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_14726)
	{
		if (Global_14553.f_1 == 6)
		{
			func_30(Global_14534, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_28(1);
			func_30(Global_14534, "DISPLAY_VIEW", 1f, TO_FLOAT(Global_14533), -1082130432, -1082130432, -1082130432);
		}
	}
	return 1;
}
...
void func_64()
{
	if (IS_BIT_SET(Global_2423, 6))
	{
		if (Global_3127 > 0)
		{
			if (IS_BIT_SET(Global_2424, 11))
			{
				if (iLocal_41)
				{
					...
					if (IS_BIT_SET(Global_2423, 25))
					{
						BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_37, "CREATE_ALERT");
					...
					if (IS_BIT_SET(Global_4269308, 19))
					{
						...
						SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(222f);
						if ((IS_BIT_SET(Global_4269308, 12) || IS_BIT_SET(Global_4269308, 11)) || IS_BIT_SET(Global_2423, 25))
						{
		...
		if (Global_3127 < 1)
		{
			SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_37);
			CLEAR_BIT(&Global_2423, 6);
		}
		else
		{
			func_16();
	...
	{
		uLocal_37 = REQUEST_SCALEFORM_MOVIE("cellphone_alert_popup");
		while (!HAS_SCALEFORM_MOVIE_LOADED(uLocal_37))
		{
			WAIT(0);
		}
		SET_SCRIPT_GFX_DRAW_ORDER(4);
		SET_BIT(&Global_2423, 6);
	}
}
...
void func_66()
{
	if (IS_BIT_SET(Global_2424, 7))
	{
		SET_BIT(&Global_2424, 6);
		CLEAR_BIT(&Global_2424, 7);
		return;
	}
	if (!IS_BIT_SET(Global_2424, 7))
	{
		CLEAR_BIT(&Global_2424, 6);
		return;
	}
}
...
void func_67()
{
	if (IS_BIT_SET(Global_2424, 4))
	{
		SET_BIT(&Global_2424, 3);
		CLEAR_BIT(&Global_2424, 4);
		return;
	}
	if (!IS_BIT_SET(Global_2424, 4))
	{
		CLEAR_BIT(&Global_2424, 3);
		return;
	}
}
...
void func_68()
{
	if (IS_BIT_SET(Global_2424, 2))
	{
		if (!Global_14553.f_1 == 1)
		{
			Global_14553.f_1 = 0;
		}
		CLEAR_BIT(&Global_2424, 2);
		return;
	}
	if (!IS_BIT_SET(Global_2424, 2))
	{
...
int func_78(int iParam0, bool bParam1, int iParam2)
{
	...
	if (IS_PLAYER_SWITCH_IN_PROGRESS() || func_92())
	{
		return 4;
	}
	if (func_58())
...
int func_79(bool bParam0)
{
	...
	if ((((((func_58() || Global_17272.f_4) || func_80()) || IS_MEMORY_CARD_IN_USE()) || IS_AUTO_SAVE_IN_PROGRESS()) || func_92()) || func_108())
	{
		return 0;
	}
	if (!bParam0)
...
void func_83(var uParam0)
{
	...
	while (iVar0 <= (19 - 1))
	{
		Global_105538[iVar0] = GET_INTERIOR_AT_COORDS(func_84(iVar0));
		iVar0++;
	}
	iLocal_27 = 1;
}
...
int func_99(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_101() == 0)
		{
			return IS_BIT_SET(func_111(func_100(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
