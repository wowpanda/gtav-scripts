...
int func_1()//Position - 0x119
{
	...
	else if (iLocal_46 == 1)
	{
		...
		{
			func_43(AUDIO::_0x0626A247D2405330(), -347.4067f, -93.5801f, 44.6639f, 306.0178f);
		}
...
int func_12()//Position - 0xEA7
{
	return Global_1407E0;
}

int func_13(int iParam0, int iParam1)//Position - 0xEB3
{
	switch (iParam0)
	{
		case 0:
...
int func_14(int iParam0)//Position - 0x1227
{
	switch (iParam0)
	{
		case 29:
...
void func_15(int iParam0)//Position - 0x1256
{
	int iVar0;
	int iVar1;
...
void func_16(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x1298
{
	func_17(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_17(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x12BA
{
	int iVar0;
...
bool func_21(int iParam0)//Position - 0x16F1
{
	return Global_8D15 == iParam0;
}

bool func_22(int iParam0)//Position - 0x16FF
{
	return iParam0 < 3;
}

int func_23(int iParam0)//Position - 0x170B
{
	int iVar0;
	int iVar1;
...
int func_24(int iParam0)//Position - 0x1748
{
	if (func_22(iParam0))
	{
...
int func_25(int iParam0)//Position - 0x1772
{
	int iVar0;
	int iVar1;
...
void func_26(int iParam0, int iParam1)//Position - 0x17B5
{
	MISC::SET_BIT(&(Global_19E56.f_6187.f_8[iParam0]), iParam1);
}

int func_27(int iParam0)//Position - 0x17D0
{
	int iVar0;
...
int func_29(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x189E
{
...
void func_30()//Position - 0x1A78
{
	func_31(1751306471, 6, func_34(), 133, 30000, 10000, 4294967295, 0, 4294967295, 0, 0);
}

int func_31(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x1A9C
{
	struct<14> Var0;
...
void func_32(int iParam0)//Position - 0x1BB7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_33(int iParam0)//Position - 0x1C7B
{
	switch (iParam0)
	{
		case 0:
...
int func_34()//Position - 0x1CE5
{
	int iVar0;
	
	iVar0 = ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330());
	switch (iVar0)
	{
...
int func_35(int iParam0)//Position - 0x1D1D
{
	int iVar0;
	int iVar1;
...
void func_36(int iParam0)//Position - 0x1E44
{
	int iVar0;
	struct<10> Var1;
...
void func_37(int iParam0)//Position - 0x1EFD
{
	int iVar0;
	struct<14> Var1;
...
void func_38(int iParam0)//Position - 0x1FC5
{
	struct<15> Var0;
	int iVar1;
	int iVar2;
...
void func_39(int iParam0)//Position - 0x2072
{
	struct<15> Var0;
	int iVar1;
	int iVar2;
	...
	while (iVar1 < Global_19E56.f_1DEC.f_C6)
	{
		...
		{
			func_40(Global_19E56.f_1DEC.f_89[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
int func_40(int iParam0)//Position - 0x212E
{
	int iVar0;
...
void func_41(int iParam0, int iParam1)//Position - 0x219F
{
	if (Global_75[iParam0 /*10*/].f_8 != 145)
	{
		if (iParam1 > 3)
...
void func_42(int iParam0)//Position - 0x21E2
{
	int iVar0;
	int iVar1;
	struct<15> Var2;
...
void func_43(int iParam0, vector3 vParam1, float fParam2)//Position - 0x22BD
{
	ENTITY::SET_ENTITY_COORDS(iParam0, vParam1, 1, false, 0, 1);
	ENTITY::SET_ENTITY_HEADING(iParam0, fParam2);
}

int func_44(int iParam0)//Position - 0x22DB
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_49()//Position - 0x24BB
{
	...
	else if (iLocal_46 == 1)
	{
		if (func_44(AUDIO::_0x0626A247D2405330()))
		{
			func_43(AUDIO::_0x0626A247D2405330(), -366.6139f, -79.7531f, 44.6616f, 230.7299f);
		}
		CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
		CAM::DO_SCREEN_FADE_IN(250);
...
int func_52(int iParam0)//Position - 0x26BB
{
	if (func_56())
	{
		Global_19E4C = 1;
...
void func_53(int iParam0)//Position - 0x270E
{
	switch (iParam0)
	{
		case 0:
			if (Global_19E56.f_6187.f_2 < 3)
			{
				...
				{
					func_54(func_55(iParam0), 4294967295);
...
void func_54(char* sParam0, int iParam1)//Position - 0x27EF
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_55(int iParam0)//Position - 0x2806
{
	char* sVar0;
...
int func_56()//Position - 0x284A
{
	switch (func_57(&Global_63AE, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_57(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x2880
{
	int iVar0;
...
void func_58(var uParam0, int iParam1)//Position - 0x29B7
{
	int iVar0;
...
bool func_59(int iParam0)//Position - 0x2A06
{
	return func_60(iParam0, Global_8D15);
}

int func_60(int iParam0, int iParam1)//Position - 0x2A17
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_61(int iParam0)//Position - 0x2BF8
{
	if (Global_8D15 == 15)
	{
		return 0;
...
int func_62(int iParam0, bool bParam1, int iParam2)//Position - 0x2C1A
{
	int iVar0;
...
int func_63(int iParam0, bool bParam1, bool bParam2)//Position - 0x2C6C
{
	int iVar0;
...
float func_64(bool bParam0, float fParam1, float fParam2)//Position - 0x2D10
{
	if (bParam0)
	{
		return fParam1;
...
void func_66()//Position - 0x2D48
{
	...
	if (func_44(iLocal_48))
	{
		...
		bVar1 = func_44(AUDIO::_0x0626A247D2405330());
		vVar2 = { unk_0x8000C77B5F336760(iLocal_48, false) };
		fVar4 = 7.5f;
		vVar5 = { fVar4, fVar4, fVar4 };
		if (bVar1)
		{
			vVar3 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false) };
			bVar6 = PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0);
			bVar7 = PED::IS_PED_IN_ANY_HELI(AUDIO::_0x0626A247D2405330());
		}
		if (iLocal_51 < 3)
		{
		...
		switch (iLocal_51)
		{
			case 0:
				...
				{
					ENTITY::SET_ENTITY_HEALTH(iLocal_48, true);
					BRAIN::TASK_PLAY_ANIM(iLocal_48, sLocal_62, sLocal_63, 1000f, -8f, 4294967295, 8193, 0, 0, 0, 0);
					iLocal_51++;
				}
				break;
			
			case 1:
				if (func_77(2277090178))
				{
					iLocal_51 = 5;
				}
				if (func_76(AUDIO::_0x0626A247D2405330(), iLocal_48, 35f))
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_68);
					BRAIN::TASK_PLAY_ANIM(0, sLocal_62, sLocal_64, 8f, -8f, 4294967295, 8192, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, sLocal_62, sLocal_65, 8f, -2f, 4294967295, 8193, 0, 0, 0, 0);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_68);
			...
			case 2:
				...
				if ((bVar0 && bVar1) && func_76(AUDIO::_0x0626A247D2405330(), iLocal_48, fVar8))
				{
					iLocal_51 = 3;
				}
				if (iLocal_52)
			...
			case 4:
				...
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_68);
				BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), 800);
				BRAIN::TASK_SMART_FLEE_PED(0, AUDIO::_0x0626A247D2405330(), 9999f, 4294967295, 1, 0);
				CUTSCENE::_0x8D9DF6ECA8768583(iLocal_68);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_48, iLocal_68);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_68);
				iLocal_51++;
			...
			case 5:
				...
				if (!ENTITY::IS_ENTITY_ON_SCREEN(iLocal_48) && SYSTEM::VDIST2(vVar2, unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false)) > 2500f)
				{
	...
	{
		unk_0x346478B12F69D4E3(iLocal_48, false);
	}
}

int func_67()//Position - 0x306F
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	...
	switch (iLocal_56)
	{
		case 0:
			...
			else if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48, sLocal_62, sLocal_64, 3))
			{
				...
				if (fLocal_54 != 0.2f)
				{
					...
					vLocal_57 = { unk_0x8000C77B5F336760(iLocal_48, false) - Vector(1f, 0f, 0f) };
					iLocal_56 = 1;
				}
				else
				{
		...
		case 1:
			...
			BRAIN::TASK_PLAY_ANIM(iLocal_48, sLocal_62, sLocal_64, 4f, -8f, 4294967295, 0, fLocal_54, 1, 0, 0);
...
Vector3 func_68(vector3 vParam0, vector3 vParam1, float fParam2)//Position - 0x327D
{
	return FtoV((1f - fParam2)) * vParam0 + Vector(fParam2, fParam2, fParam2) * vParam1;
}

void func_69()//Position - 0x3298
{
	if (iLocal_60 != 0)
	{
...
void func_70(int iParam0)//Position - 0x32B0
{
...
float func_71(float fParam0, float fParam1, float fParam2)//Position - 0x32D0
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
bool func_74(vector3 vParam0, vector3 vParam1)//Position - 0x33F8
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	fVar0 = PLAYER::GET_PLAYER_CURRENT_STEALTH_NOISE(CAM::_0xDC9DA9E8789F5246());
...
bool func_75()//Position - 0x3451
{
	return (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -334.4651f, -93.42171f, 48.57328f, -332.2641f, -82.78552f, 45.8103f, 3f, 0, true, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -329.1134f, -83.87273f, 45.79989f, -331.0937f, -88.05348f, 48.71878f, 3f, 0, true, 0));
}

int func_76(int iParam0, int iParam1, float fParam2)//Position - 0x34B3
{
	float fVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		...
		return SYSTEM::VDIST2(unk_0x8000C77B5F336760(iParam0, false), unk_0x8000C77B5F336760(iParam1, false)) <= fVar0;
	}
	return 0;
}

int func_77(int iParam0)//Position - 0x34EF
{
	if (!func_78(iLocal_48, iParam0) && !func_78(iLocal_48, 1805844857))
	{
		func_70(&iLocal_53);
		BRAIN::TASK_SMART_FLEE_PED(iLocal_48, AUDIO::_0x0626A247D2405330(), 9999f, 4294967295, 1, 0);
		return 1;
	}
	return 0;
}

bool func_78(int iParam0, int iParam1)//Position - 0x3531
{
	int iVar0;
...
void func_79(vector3 vParam0)//Position - 0x3551
{
	if (func_83(vParam0))
	{
		func_80(33);
...
void func_80(int iParam0)//Position - 0x3575
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_28();
...
void func_82(int iParam0)//Position - 0x35E8
{
	Global_19E4B = iParam0;
}

int func_83(vector3 vParam0)//Position - 0x35F6
{
...
bool func_85()//Position - 0x36E5
{
	return func_86(func_87(), 5);
}

bool func_86(int iParam0, int iParam1)//Position - 0x36F6
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
bool func_88(int iParam0)//Position - 0x3754
{
...
int func_89(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x3782
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(AUDIO::_0x0626A247D2405330())) > 1369f && !func_143())
			{
				return 0;
			}
		}
		...
		if (!func_127(Global_19E56.f_6187.f_2B[iParam1]))
		{
			return 0;
		}
...
bool func_90(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x3B1C
{
	if (bParam2)
	{
...
bool func_91(int iParam0)//Position - 0x3B63
{
	int iVar0;
...
int func_92(int iParam0)//Position - 0x3B84
{
	return func_93(iParam0, 1);
}

int func_93(int iParam0, int iParam1)//Position - 0x3B93
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_94(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x3BE6
{
	func_95(func_106(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_95(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x3C04
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_96(float fParam0, float fParam1, float fParam2)//Position - 0x3E05
{
	float fVar0;
...
int func_97(int iParam0, int iParam1)//Position - 0x3E47
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_98(int iParam0)//Position - 0x3EE9
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_99(int iParam0)//Position - 0x3EFC
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_100(int iParam0)//Position - 0x3F0F
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_101(int iParam0)//Position - 0x3F22
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_102(int iParam0)//Position - 0x3F34
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_103(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}

int func_103(bool bParam0, int iParam1, int iParam2)//Position - 0x3F59
{
	if (bParam0)
	{
		return iParam1;
...
int func_104(int iParam0)//Position - 0x3F70
{
	return iParam0 & 15;
}

int func_105(int iParam0, int iParam1)//Position - 0x3F7D
{
	int iVar0;
	int iVar1;
...
void func_107(var uParam0, int iParam1)//Position - 0x40D0
{
	if (iParam1 <= 0)
	{
		return;
...
void func_108(var uParam0, int iParam1)//Position - 0x4156
{
...
void func_109(var uParam0, int iParam1)//Position - 0x4189
{
	int iVar0;
	int iVar1;
...
void func_110(var uParam0, int iParam1)//Position - 0x41DA
{
...
void func_111(var uParam0, int iParam1)//Position - 0x4214
{
...
void func_112(var uParam0, int iParam1)//Position - 0x424F
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_113(int iParam0)//Position - 0x428B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_114(int iParam0, int iParam1)//Position - 0x4367
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_124()) || Global_19A9D) || Global_6375) || func_123()) || func_122(8, 4294967295)) || func_121()) || func_120()) || func_119()) || func_118()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_124()) || Global_6375) || func_123()) || func_122(8, 4294967295)) || func_119()) || func_121()) || func_120()) || func_118()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_124()) || Global_19A9D) || Global_6375) || func_123()) || func_122(8, 4294967295)) || func_119()) || func_121()) || func_120()) || func_118()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_124()) || Global_19A9D) || Global_6375) || func_123()) || func_122(8, 4294967295)) || func_121()) || func_120()) || func_118()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_124() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_122(8, 4294967295)) || func_118()) || func_117()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_122(8, 4294967295) || func_121()) || func_120()) || func_117()) || func_116())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_124()) || Global_6375) || func_123()) || func_122(8, 4294967295)) || func_120()) || func_119()) || func_118()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_116()//Position - 0x4AA7
{
	return Global_16C57.f_1;
}

int func_117()//Position - 0x4AB5
{
...
bool func_120()//Position - 0x4B1F
{
	return Global_16C64.f_148 > 0;
}

bool func_121()//Position - 0x4B30
{
	return Global_16C64.f_147 > 0;
}

bool func_122(int iParam0, int iParam1)//Position - 0x4B41
{
	switch (iParam0)
	{
		case 5:
...
var func_123()//Position - 0x4B7C
{
	return Global_140859;
}

int func_124()//Position - 0x4B88
{
...
bool func_127(int iParam0)//Position - 0x4C6E
{
	return func_105(func_106(), iParam0);
}

int func_128(int iParam0, int iParam1, int iParam2)//Position - 0x4C80
{
	int iVar0;
	int iVar1;
...
int func_129(int iParam0)//Position - 0x4D64
{
	if (!func_22(iParam0))
	{
		return 7;
...
bool func_130(int iParam0)//Position - 0x4D88
{
	int iVar0;
	bool bVar1;
...
int func_131(float fParam0, bool bParam1)//Position - 0x4DE6
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_132(int iParam0, var uParam1)//Position - 0x4E9D
{
	switch (iParam0)
	{
		case 0:
...
int func_134(int iParam0)//Position - 0x6175
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_135(int iParam0)//Position - 0x64BB
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_136(int iParam0)//Position - 0x64F3
{
	struct<2> Var0;
...
int func_137()//Position - 0x6940
{
	func_20();
	return Global_19E56.f_933.f_21B.f_10CD;
}

int func_138()//Position - 0x6959
{
	int iVar0;
...
bool func_140()//Position - 0x69CF
{
	return Global_19D3C > 0;
}

int func_141()//Position - 0x69DD
{
	if (Global_16089 != 4294967295)
	{
		return 1;
...
void func_145(int iParam0)//Position - 0x6A50
{
	char cVar0[64];
	...
	if (func_156())
	{
		...
		func_148(30000);
		StringCopy(&cVar0, func_147(Global_19E4B, 1), 64);
	...
	func_146(&Global_63AE);
	Global_19E4C = 0;
	func_82(4294967295);
}

void func_146(var uParam0)//Position - 0x6B05
{
	if (*uParam0 == 4294967295)
	{
		return;
...
char* func_147(int iParam0, bool bParam1)//Position - 0x6B42
{
	switch (iParam0)
	{
		case 0:
...
void func_148(int iParam0)//Position - 0x6D8B
{
	Global_8F3C = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_149(int iParam0)//Position - 0x6D9D
{
	func_150(iParam0, 0, func_155(iParam0));
}

void func_150(int iParam0, int iParam1, int iParam2)//Position - 0x6DB2
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_151(var uParam0)//Position - 0x6DE1
{
	struct<16> Var0;
	int iVar1;
...
void func_152(int iParam0, var uParam1)//Position - 0x6EB2
{
	Global_19E56.f_6187.f_2B[iParam0] = *uParam1;
}

void func_153(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x6ECA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_154(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x704C
{
...
int func_155(int iParam0)//Position - 0x7084
{
	int iVar0;
