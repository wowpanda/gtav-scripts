...
int func_2()//Position - 0x108
{
	...
	fVar0 = SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), vLocal_70);
	if (fVar0 > (100f * 100f))
	{
		return 1;
	}
...
int func_6(int iParam0, int iParam1)//Position - 0x217
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_7(Global_16B5A) && iParam1 != 0)
		{
			Global_16B5A = 0;
		}
	}
...
void func_19()//Position - 0x545
{
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0)
		{
			...
			BRAIN::TASK_PLAY_ANIM_ADVANCED(iLocal_68[iVar0], &cLocal_75, &(Local_80[iVar0 /*8*/]), vLocal_70 + vLocal_72[iVar0 /*3*/], Vector(uLocal_71, 0f, 0f) + vLocal_73[iVar0 /*3*/], 1000f, -8f, 4294967295, iLocal_81, 0, 2, 0);
			MISC::_0x1327E2FE9746BAEE(iLocal_68[iVar0], 0, 0);
			...
			if (iLocal_83[iVar0] > 0)
			{
				...
				PED::APPLY_PED_BLOOD_SPECIFIC(iLocal_68[iVar0], 3, 0.375f, 0.398f, 0f, 1f, 4294967295, 0f, "BasicSlash");
				PED::APPLY_PED_BLOOD_SPECIFIC(iLocal_68[iVar0], 3, 0.5f, 0.6f, 0f, 1f, 4294967295, 0f, "BasicSlash");
				PED::APPLY_PED_BLOOD_SPECIFIC(iLocal_68[iVar0], 3, 0.6f, 0.25f, 50f, 0.5f, 4294967295, 0f, "BasicSlash");
				PED::APPLY_PED_BLOOD_SPECIFIC(iLocal_68[iVar0], 3, 0.65f, 0.325f, 50f, 0.5f, 4294967295, 0f, "BasicSlash");
				PED::APPLY_PED_BLOOD_SPECIFIC(iLocal_68[iVar0], 0, 0.58f, 0.704f, 0f, 1f, 4294967295, 0f, "ShotgunLarge");
			}
		}
		iVar0++;
	}
