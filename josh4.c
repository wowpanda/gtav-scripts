...
void __EntryFunction__()
{
	...
	if (func_442())
	{
		...
		func_441(vLocal_106, fLocal_109, 1, 0);
	...
	{
		STOP_PED_SPEAKING(Local_443.f_28[1], 1);
	}
	if (func_428(Local_443.f_28[2]))
	{
		STOP_PED_SPEAKING(Local_443.f_28[2], 1);
	}
	uLocal_507 = Local_443.f_35[0];
	uLocal_508 = Local_443.f_35[1];
	...
	if (func_442())
	{
		...
		func_325(&uLocal_86, -1100.04f, 280.6f, 63.53f, 267.48f, 0, 0, 1, 1, 0, joaat("asterope"), 0, 145, 1);
...
void func_1()
{
	...
	switch (iLocal_88)
	{
		case 0:
			func_429(&Local_443, 0, 1);
			if (func_428(uLocal_507))
			{
				SET_ENTITY_PROOFS(uLocal_507, 0, 0, 0, 0, 0, 0, 0, 0);
			}
			if (func_428(uLocal_508))
			{
				SET_ENTITY_PROOFS(uLocal_508, 0, 0, 0, 0, 0, 0, 0, 0);
			}
			func_254("JOSH4_LOSECOPS", 7500, 1);
			SET_PLAYER_WANTED_LEVEL(GET_PLAYER_INDEX(), 2, 0);
			SET_PLAYER_WANTED_LEVEL_NOW(GET_PLAYER_INDEX(), 0);
			SET_PED_NON_CREATION_AREA(-1140.223f, 271.745f, 50f, -1082.403f, 344.8568f, 80f);
			SET_PED_PATHS_IN_AREA(-1140.223f, 271.745f, 50f, -1082.403f, 344.8568f, 80f, 0, 0);
			CLEAR_AREA_OF_PEDS(-1114.788f, 319.3401f, 66.1226f, 20.5f, 0);
			if (func_428(Local_443.f_28[0]))
			{
				TASK_LOOK_AT_ENTITY(Local_443.f_28[0], PLAYER_PED_ID(), -1, 0, 2);
			}
			_SET_UNK_MAP_FLAG(2);
			iLocal_511 = GET_GAME_TIMER();
			iLocal_88 = 1;
			break;
		...
		case 1:
			...
			func_208();
			func_206();
			if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_INDEX()) <= 0 && !func_205())
			{
				iVar0 = 1;
				...
				if (func_203(uLocal_507))
				{
					if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_507, 0))
					{
						func_202(777);
					}
				}
...
int func_32(var uParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(uParam0, func_75(iParam1)) > 0 && GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(uParam0, func_75(iParam1), Global_71402[1 /*14*/].f_3) > 0)
		{
			SET_PED_COMPONENT_VARIATION(uParam0, func_75(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, 0);
		}
	}
...
int func_35(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							SET_PED_COMPONENT_VARIATION(uParam0, func_75(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, GET_PED_PALETTE_VARIATION(uParam0, func_75(iVar0)));
						}
						else
						{
							SET_PED_COMPONENT_VARIATION(uParam0, func_75(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_66(iVar0);
						if (Global_71400 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			SET_PED_COMPONENT_VARIATION(uParam0, func_75(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, GET_PED_PALETTE_VARIATION(uParam0, func_75(iParam1)));
		}
		else
		{
			SET_PED_COMPONENT_VARIATION(uParam0, func_75(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
void func_68(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4)
{
	int iVar0;
...
int func_148(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(uParam0, func_75(iParam1)) && Global_71402[1 /*14*/].f_4 == GET_PED_TEXTURE_VARIATION(uParam0, func_75(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_206()
{
	if (iLocal_533 == 0)
	{
		if (func_207(PLAYER_PED_ID(), -1116.62f, 299.12f, 64.96f, 1) > 50f)
		{
...
float func_207(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
void func_208()
{
	if (iLocal_528 == 0)
	{
		if (!IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1208.581f, 309.8494f, 80.69189f, -1041.645f, 319.5811f, 60.40263f, 178.5f, 0, 1, 0))
		{
			while (func_205())
			{
				func_223();
			...
			func_222(&uLocal_278, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
			func_222(&uLocal_278, 4, Local_443.f_28[0], "JOSH", 0, 1);
			iLocal_531 = GET_GAME_TIMER();
			iLocal_528++;
		}
	}
	else if (iLocal_528 == 1)
	{
		if (iLocal_102 != 0)
		{
			if ((GET_GAME_TIMER() - iLocal_531) > 6000)
			{
				if (iLocal_102 == 3)
				{
				...
				else if (iLocal_102 == 1)
				{
					if (func_428(Local_443.f_28[0]))
					{
						if (func_209(PLAYER_PED_ID(), Local_443.f_28[0], 1) < 75f)
						{
...
float func_209(var uParam0, var uParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_222(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	switch (iLocal_102)
	{
		case 0:
			if (iLocal_101 == 3)
			{
				if (func_428(Local_443.f_28[0]))
				{
					CLEAR_PED_TASKS(Local_443.f_28[0]);
					if (func_203(uLocal_508))
					{
						if (IS_POSITION_OCCUPIED(-1138.421f, 298.0307f, 65.90032f, 4f, 0, 1, 0, 0, 0, uLocal_508, 0))
						{
							func_476("Back gate blocked");
							vLocal_110 = { -1130.35f, 307.92f, 65.19f };
							OPEN_SEQUENCE_TASK(&uLocal_506);
							TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_110, 2f, 20000, 1f, 1, 1193033728);
							TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1126.56f, 319.85f, 65.98f, 2f, 20000, 1f, 1, 1193033728);
							TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 500f, -1, 0, 0);
							CLOSE_SEQUENCE_TASK(uLocal_506);
							SET_PED_KEEP_TASK(Local_443.f_28[0], 1);
							TASK_PERFORM_SEQUENCE(Local_443.f_28[0], uLocal_506);
						}
						else
						{
							...
							if (func_203(uLocal_508))
							{
								TASK_VEHICLE_MISSION_PED_TARGET(0, uLocal_508, PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, 1);
							}
							else
							{
								TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 500f, -1, 0, 0);
					...
					else
					{
						...
						if (func_203(uLocal_508))
						{
							TASK_ENTER_VEHICLE(0, uLocal_508, 20000, -1, 1073741824, 1, 0);
							TASK_VEHICLE_MISSION_PED_TARGET(0, uLocal_508, PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, 1);
						}
						else
						{
					...
					SET_PED_FLEE_ATTRIBUTES(Local_443.f_28[0], 2, 1);
					CLEAR_SEQUENCE_TASK(&uLocal_506);
				}
				iLocal_532 = GET_GAME_TIMER();
				SET_PED_CAN_BE_DRAGGED_OUT(Local_443.f_28[0], 1);
				SET_PED_CONFIG_FLAG(Local_443.f_28[0], 177, 1);
				iLocal_102 = 1;
			}
			break;
		...
		case 1:
			if (func_428(Local_443.f_28[0]))
			{
				if (!iLocal_525)
				{
					...
					{
						if (func_209(Local_443.f_28[0], PLAYER_PED_ID(), 0) < 20f)
						{
							func_222(&uLocal_278, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
							func_222(&uLocal_278, 4, Local_443.f_28[0], "JOSH", 0, 1);
							if (func_205())
				...
				if (func_203(uLocal_508))
				{
					if (IS_PED_IN_VEHICLE(Local_443.f_28[0], uLocal_508, 1))
					{
						if (GET_VEHICLE_ENGINE_HEALTH(uLocal_508) < 20f)
						{
							CLEAR_PED_TASKS(Local_443.f_28[0]);
							TASK_LEAVE_ANY_VEHICLE(Local_443.f_28[0], 0, 4416);
							TASK_SMART_FLEE_PED(Local_443.f_28[0], PLAYER_PED_ID(), 510f, -1, 0, 0);
							func_228(&uLocal_508);
						}
					}
					if (func_428(PLAYER_PED_ID()))
					{
						if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_508, 1))
						{
							CLEAR_PED_TASKS(Local_443.f_28[0]);
							TASK_SMART_FLEE_PED(Local_443.f_28[0], PLAYER_PED_ID(), 510f, -1, 0, 0);
							func_228(&uLocal_508);
					...
					if (IS_PED_BEING_JACKED(Local_443.f_28[0]))
					{
						if (iLocal_526 == 0)
						{
				...
				if (func_209(PLAYER_PED_ID(), Local_443.f_28[0], 1) > 350f)
				{
				...
				if (func_428(PLAYER_PED_ID()) && func_428(Local_443.f_28[0]))
				{
					if (iLocal_529 < 3)
					{
						if (func_209(PLAYER_PED_ID(), Local_443.f_28[0], 1) < 10f)
						{
							if (!func_205() && (GET_GAME_TIMER() - iLocal_532) > 8000)
							{
			...
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_443.f_28[0], PLAYER_PED_ID(), 1))
				{
...
void func_231()
{
	switch (Local_89.f_11)
	{
		case 0:
			...
			while (iLocal_510 <= 4)
			{
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), Local_534[iLocal_510 /*7*/], Local_534[iLocal_510 /*7*/].f_3, Local_534[iLocal_510 /*7*/].f_6, 0, 1, 2))
				{
					...
					REQUEST_VEHICLE_RECORDING(Local_89.f_9, Local_89.f_10);
					while ((!HAS_VEHICLE_RECORDING_BEEN_LOADED(Local_89.f_9, Local_89.f_10) || !HAS_MODEL_LOADED(iLocal_85)) || !HAS_MODEL_LOADED(iLocal_84))
					{
						WAIT(0);
					}
		...
		case 1:
			if (!DOES_ENTITY_EXIST(Local_89.f_7))
			{
				Local_89.f_7 = CREATE_VEHICLE(iLocal_85, Local_89, 0, 1, 1, 0);
				SET_VEHICLE_ON_GROUND_PROPERLY(Local_89.f_7, 1084227584);
				SET_ENTITY_QUATERNION(Local_89.f_7, Local_89.f_3, Local_89.f_4, Local_89.f_5, Local_89.f_6);
				Local_89.f_8 = CREATE_PED_INSIDE_VEHICLE(Local_89.f_7, 6, iLocal_84, -1, 1, 1);
				GIVE_WEAPON_TO_PED(Local_89.f_8, joaat("weapon_pistol"), -1, 0, 1);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_89.f_8, 1);
				CLEAR_PED_TASKS(Local_89.f_8);
		...
		case 2:
			if (func_203(Local_89.f_7))
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(Local_89.f_8, 0))
					{
						START_PLAYBACK_RECORDED_VEHICLE(Local_89.f_7, Local_89.f_9, Local_89.f_10, 1);
						_0x1F2E4E06DEA8992B(Local_89.f_7, 1);
						func_232("*** m_AI_FleeCar.iRecNum: ", Local_89.f_9);
						switch (Local_89.f_9)
						{
							case 0:
								SET_PLAYBACK_SPEED(Local_89.f_7, 1.5f);
								break;
							
							case 1:
								SET_PLAYBACK_SPEED(Local_89.f_7, 1f);
								break;
							
							case 2:
								SET_PLAYBACK_SPEED(Local_89.f_7, 1.4f);
								break;
		...
		case 3:
			if (func_203(Local_89.f_7))
			{
				if (!IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_89.f_7))
				{
					if (HAS_VEHICLE_RECORDING_BEEN_LOADED(Local_89.f_9, Local_89.f_10))
					{
						REMOVE_VEHICLE_RECORDING(Local_89.f_9, Local_89.f_10);
		...
		case 4:
			if (func_203(Local_89.f_7))
			{
				if (func_428(Local_89.f_8))
				{
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_89.f_8, 0);
...
void func_233()
{
	...
	switch (iLocal_101)
	{
		case 0:
			...
			if ((GET_GAME_TIMER() - iLocal_511) > 4000)
			{
			...
			while (iVar0 <= (Local_443.f_28 - 1))
			{
				if (func_428(Local_443.f_28[iVar0]))
				{
					if (func_209(Local_443.f_28[iVar0], PLAYER_PED_ID(), 0) > 10f)
					{
		...
		case 2:
			if ((GET_GAME_TIMER() - iLocal_511) > 20000)
			{
				func_476("************************************** TIMEOUT - ARREST next frame");
				if (func_428(Local_443.f_28[1]))
				{
					CLEAR_PED_TASKS(Local_443.f_28[1]);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_443.f_28[1], 0);
					TASK_ARREST_PED(Local_443.f_28[1], PLAYER_PED_ID());
				}
				iLocal_101 = 4;
				iLocal_511 = GET_GAME_TIMER();
			}
			...
			while (iVar0 <= (Local_443.f_28 - 1))
			{
				if (func_428(Local_443.f_28[iVar0]))
				{
					if (func_209(Local_443.f_28[iVar0], PLAYER_PED_ID(), 0) > 12f)
					{
		...
		case 3:
			...
			if (!iLocal_518)
			{
				...
				ENABLE_DISPATCH_SERVICE(6, 1);
				iVar0 = 1;
				while (iVar0 <= (Local_443.f_28 - 1))
				{
					if (func_428(Local_443.f_28[iVar0]))
					{
						CLEAR_PED_TASKS(Local_443.f_28[iVar0]);
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_443.f_28[iVar0], 0);
						OPEN_SEQUENCE_TASK(&uLocal_506);
						TASK_SHOOT_AT_ENTITY(0, PLAYER_PED_ID(), -1, -687903391);
						CLOSE_SEQUENCE_TASK(uLocal_506);
						TASK_PERFORM_SEQUENCE(Local_443.f_28[iVar0], uLocal_506);
						CLEAR_SEQUENCE_TASK(&uLocal_506);
					}
					iVar0++;
				}
				func_222(&uLocal_113, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
			...
			else
			{
				...
				while (iVar1 <= (Local_443.f_28 - 1))
				{
					...
					{
						if (func_209(Local_443.f_28[iVar1], PLAYER_PED_ID(), 1) > 20f)
						{
							SET_PED_ACCURACY(Local_443.f_28[iVar1], 75);
						}
						else
						{
							SET_PED_ACCURACY(Local_443.f_28[iVar1], 1);
						}
					}
					iVar1++;
				}
				if ((GET_GAME_TIMER() - iLocal_530) > 15000)
				{
					iVar1 = 1;
					while (iVar1 <= (Local_443.f_28 - 1))
					{
						if (func_428(Local_443.f_28[iVar1]))
						{
							if (func_209(Local_443.f_28[iVar1], PLAYER_PED_ID(), 1) >= 50f)
							{
	...
	if (iLocal_101 != 3)
	{
		...
		while (iVar0 <= (Local_443.f_28 - 1))
		{
			if (func_428(Local_443.f_28[iVar0]))
			{
				if (IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), Local_443.f_28[iVar0]))
				{
				...
				if (iLocal_101 != 4)
				{
					if (func_209(Local_443.f_28[iVar0], PLAYER_PED_ID(), 0) < 2.3f)
					{
...
int func_234(int iParam0, bool bParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	vector3 vVar0;
	...
	if (func_428(PLAYER_PED_ID()) && func_428(iParam0))
	{
		...
		if (!IS_PED_ARMED(PLAYER_PED_ID(), 6))
		{
			if (IS_PED_IN_MELEE_COMBAT(PLAYER_PED_ID()))
			{
				...
				{
					return func_247(PLAYER_PED_ID(), iParam0, iParam2);
				}
			}
		}
		if (bParam4)
...
bool func_237(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_238(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_238(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_239(iParam4, iParam7) };
...
int func_241(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_243(GET_ENTITY_COORDS(iParam1, 1) - GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		vVar3 = { func_243(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_242(vVar3, vVar0);
...
bool func_247(var uParam0, var uParam1, var uParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_248(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_249(var uParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_250(var uParam0, float fParam1)
{
	...
	{
		if (func_251(uParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_251(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_243(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_243(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_242(vVar3, vVar0);
...
int func_252(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (IS_PED_SHOOTING(PLAYER_PED_ID()))
...
void func_253()
{
	...
	else
	{
		...
		{
			case 0:
				if ((GET_GAME_TIMER() - iLocal_105) > 1000)
				{
					iLocal_103 = 1;
				}
				break;
			...
			case 1:
				if (!func_205() && !IS_MESSAGE_BEING_DISPLAYED())
				{
					if (iLocal_104)
					{
						func_222(&uLocal_113, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
...
void func_255()
{
	if (iLocal_87 == 1)
	{
		...
		{
			if (GET_CUTSCENE_TIME() > 14000 && !iLocal_522)
			{
...
void func_256()
{
	...
	if (_0xB56BBBCC2955D9CB())
	{
		if (func_428(Local_443.f_28[1]))
		{
			...
			_0x2A56C06EBEF2B0D9("Cop_standing_idle", Local_443.f_28[1], 0);
		}
		if (func_428(Local_443.f_28[2]))
		{
			func_476("Trying to set Cop 2 component variation (intro loop)");
			_0x2A56C06EBEF2B0D9("Cop_with_notepad", Local_443.f_28[2], 0);
		}
	}
	switch (iLocal_88)
	{
		case 0:
			if (!ARE_STRINGS_EQUAL(sLocal_83, ""))
			{
				if (iLocal_519 == 0)
				{
		...
		case 1:
			switch (iLocal_527)
			{
				case 0:
					if (func_284(1, 1093140480, 0))
					{
						...
						if (func_203(uVar0))
						{
							...
							else if (IS_ENTITY_IN_ANGLED_AREA(uVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, 0, 1, 0))
							{
						...
						if (func_203(uVar0))
						{
							if (IS_THIS_MODEL_A_HELI(GET_ENTITY_MODEL(uVar0)))
							{
								func_274(-1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, vVar1, fVar4, 50f, 50f, 50f, 1, 1, 1, 0, 0);
							}
							else
							{
								func_274(-1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, vVar1, fVar4, func_273(), 1, 1, 1, 0, 0);
							}
						}
						else
						{
						...
						if (func_203(uLocal_507))
						{
							SET_ENTITY_COORDS(uLocal_507, -1107.5f, 280.33f, 64.01f, 1, 0, 0, 1);
							SET_ENTITY_HEADING(uLocal_507, 97.97f);
							SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_507, 1084227584);
						}
						iLocal_527++;
					}
					break;
				...
				case 1:
					...
					REQUEST_MODEL(iLocal_509);
					iLocal_527++;
					break;
				
				case 2:
					if (((HAS_ANIM_DICT_LOADED("rcmjosh4") && HAS_ANIM_DICT_LOADED("combat@gestures@pistol@halt")) && HAS_ANIM_DICT_LOADED("combat@gestures@pistol@glances")) && HAS_MODEL_LOADED(iLocal_509))
					{
						iLocal_527++;
					}
					break;
...
void func_259(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_263(PLAYER_ID())) && !func_261(PLAYER_ID(), 0)) && !func_260()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_263(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
...
void func_267()
{
	if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
	{
		if (func_428(Local_443.f_28[0]))
		{
			...
			TASK_PLAY_ANIM(0, "rcmjosh4", "josh_leadout_loop", 4f, -4f, -1, 262153, 0, 0, 0, 0);
			CLOSE_SEQUENCE_TASK(uLocal_506);
			TASK_PERFORM_SEQUENCE(Local_443.f_28[0], uLocal_506);
			CLEAR_SEQUENCE_TASK(&uLocal_506);
			FORCE_PED_MOTION_STATE(Local_443.f_28[0], 247561816, 0, 1, 0);
		}
	}
	if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Security_guard_pistol", 0))
	{
		if (func_428(uLocal_504) && func_428(Local_443.f_28[1]))
		{
			GIVE_WEAPON_OBJECT_TO_PED(uLocal_504, Local_443.f_28[1]);
			func_476("*** Gave idle cop gun");
		}
	}
	if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("FBI_Agent_1_Gun", 0))
	{
		if (func_428(uLocal_505) && func_428(Local_443.f_28[2]))
		{
			GIVE_WEAPON_OBJECT_TO_PED(uLocal_505, Local_443.f_28[2]);
	...
	if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_standing_idle", 0))
	{
		if (func_428(Local_443.f_28[1]))
		{
			FORCE_PED_MOTION_STATE(Local_443.f_28[1], 1063765679, 0, 1, 0);
			OPEN_SEQUENCE_TASK(&uLocal_506);
			TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), -1, 1026, 2);
			TASK_AIM_GUN_AT_ENTITY(0, PLAYER_PED_ID(), -1, 1);
			TASK_PLAY_ANIM(0, "combat@gestures@pistol@glances", "90", 8f, -1000f, -1, 262184, 0, 0, 0, 0);
			CLOSE_SEQUENCE_TASK(uLocal_506);
			TASK_PERFORM_SEQUENCE(Local_443.f_28[1], uLocal_506);
			CLEAR_SEQUENCE_TASK(&uLocal_506);
	...
	if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_with_notepad", 0))
	{
		if (func_428(Local_443.f_28[2]))
		{
			FORCE_PED_MOTION_STATE(Local_443.f_28[2], 1063765679, 0, 1, 0);
			OPEN_SEQUENCE_TASK(&uLocal_506);
			TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), -1, 1026, 2);
			TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1103.72f, 289.46f, 63.23f, PLAYER_PED_ID(), 1f, 0, 0.1f, 1082130432, 1, 0, 1, -957453492, 20000);
			TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1106.08f, 288.55f, 63.31f, PLAYER_PED_ID(), 1f, 0, 0.1f, 1082130432, 1, 0, 1, -957453492, 20000);
			TASK_AIM_GUN_AT_ENTITY(0, PLAYER_PED_ID(), -1, 1);
			CLOSE_SEQUENCE_TASK(uLocal_506);
			TASK_PERFORM_SEQUENCE(Local_443.f_28[2], uLocal_506);
			CLEAR_SEQUENCE_TASK(&uLocal_506);
...
void func_269(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	var uVar0;
...
void func_274(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	func_275(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_275(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, var uParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_279(iVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_279(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = { func_243(vParam1 - vParam4) };
		vVar3 = { vVar0 };
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_280(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_280(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_280(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_280(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_280(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_280(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_280(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_280(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_280(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_280(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_280(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_280(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_280(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_280(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_280(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_280(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return 1;
		}
	}
...
void func_283()
{
	...
	if (func_428(Local_443.f_28[0]))
	{
		REGISTER_ENTITY_FOR_CUTSCENE(Local_443.f_28[0], "Josh", 0, 0, 0);
		func_476("*** Registered Josh");
	}
	if (func_428(Local_443.f_28[1]))
	{
		uLocal_504 = CREATE_WEAPON_OBJECT(joaat("weapon_pistol"), -1, GET_ENTITY_COORDS(Local_443.f_28[1], 1), 1, 1065353216, 0, 0, 1);
		REGISTER_ENTITY_FOR_CUTSCENE(Local_443.f_28[1], "Cop_standing_idle", 0, 0, 0);
		func_476("*** Registered Cop standing");
	}
	if (func_428(Local_443.f_28[2]))
	{
		uLocal_505 = CREATE_WEAPON_OBJECT(joaat("weapon_pistol"), -1, GET_ENTITY_COORDS(Local_443.f_28[2], 1), 1, 1065353216, 0, 0, 1);
		REGISTER_ENTITY_FOR_CUTSCENE(Local_443.f_28[2], "Cop_with_notepad", 0, 0, 0);
		func_476("*** Registered Cop with notepad");
	}
	if (func_428(uLocal_504))
	{
		REGISTER_ENTITY_FOR_CUTSCENE(uLocal_504, "Security_guard_pistol", 0, 0, 0);
		func_476("*** Registered idle cop gun");
	}
	if (func_428(uLocal_505))
	{
		REGISTER_ENTITY_FOR_CUTSCENE(uLocal_505, "FBI_Agent_1_Gun", 0, 0, 0);
...
int func_284(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_288(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_288(var uParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_291(int iParam0)
{
	...
	REQUEST_ANIM_DICT("combat@gestures@pistol@glances");
	REQUEST_MODEL(iLocal_509);
	while ((!HAS_ANIM_DICT_LOADED("combat@gestures@pistol@halt") || !HAS_ANIM_DICT_LOADED("combat@gestures@pistol@glances")) || !HAS_MODEL_LOADED(iLocal_509))
	{
		WAIT(0);
	}
	if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1138.32f, 299.69f, 65.94f, 5f, joaat("prop_lrggate_01c_l"), 0))
	{
		SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1138.32f, 299.69f, 65.94f, 0, 0f, 0);
	}
	if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1137.52f, 297.02f, 65.81f, 5f, joaat("prop_lrggate_01c_r"), 0))
	{
		SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_r"), -1137.054f, 295.5856f, 67.18046f, 0, 0f, 0);
	}
	if (func_428(Local_443.f_28[0]))
	{
		if (iParam0 == 1)
		{
			SET_ENTITY_COORDS(Local_443.f_28[0], -1103.962f, 291.3401f, 63.367f, 1, 0, 0, 1);
			SET_ENTITY_HEADING(Local_443.f_28[0], 193.1737f);
			TASK_PLAY_ANIM(Local_443.f_28[0], "rcmjosh4", "josh_leadout_loop", 1090519040, -1056964608, -1, 1, 0, 0, 0, 0);
		}
		SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_443.f_28[0], 1);
		SET_PED_CAN_BE_TARGETTED(Local_443.f_28[0], 1);
	}
	if (iParam0 == 1)
	{
		if (func_428(Local_443.f_28[2]))
		{
			GIVE_WEAPON_TO_PED(Local_443.f_28[2], joaat("weapon_pistol"), -1, 1, 1);
			SET_ENTITY_COORDS(Local_443.f_28[2], -1106.08f, 288.55f, 63.31f, 1, 0, 0, 1);
			OPEN_SEQUENCE_TASK(&uLocal_506);
			TASK_AIM_GUN_AT_ENTITY(0, PLAYER_PED_ID(), -1, 1);
			CLOSE_SEQUENCE_TASK(uLocal_506);
			TASK_PERFORM_SEQUENCE(Local_443.f_28[2], uLocal_506);
			CLEAR_SEQUENCE_TASK(&uLocal_506);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_443.f_28[2], 1);
		}
	}
	if (iParam0 == 1)
	{
		if (func_428(Local_443.f_28[1]))
		{
			GIVE_WEAPON_TO_PED(Local_443.f_28[1], joaat("weapon_pistol"), -1, 1, 1);
			SET_ENTITY_COORDS(Local_443.f_28[1], -1102.41f, 289.73f, 63.18f, 1, 0, 0, 1);
			OPEN_SEQUENCE_TASK(&uLocal_506);
			TASK_AIM_GUN_AT_ENTITY(0, PLAYER_PED_ID(), -1, 1);
			CLOSE_SEQUENCE_TASK(uLocal_506);
			TASK_PERFORM_SEQUENCE(Local_443.f_28[1], uLocal_506);
			CLEAR_SEQUENCE_TASK(&uLocal_506);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_443.f_28[1], 1);
		}
	}
	if (func_428(Local_443.f_28[1]))
	{
		SET_PED_COMBAT_ATTRIBUTES(Local_443.f_28[1], 23, 1);
	}
	if (func_428(Local_443.f_28[2]))
	{
		SET_PED_COMBAT_ATTRIBUTES(Local_443.f_28[2], 23, 1);
	}
	if (func_203(Local_443.f_35[1]))
	{
		SET_VEHICLE_DOORS_LOCKED(Local_443.f_35[1], 1);
	}
	func_222(&uLocal_278, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
	iLocal_512 = 0;
	iLocal_513 = 0;
...
void func_293()
{
	...
	{
		case 0:
			if (!func_5(0) && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, 1, 0))
			{
		...
		case 1:
			if (!func_5(0) && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, 1, 0))
			{
				if (func_428(PLAYER_PED_ID()) && func_258(Local_443.f_28[0]))
				{
					if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1105.571f, 290.008f, 62.87176f, -1100.577f, 290.4298f, 66.45212f, 4.5f, 0, 1, 0))
					{
						if (!func_294())
						{
							if (!func_287(PLAYER_PED_ID(), -875674219))
							{
								TASK_TURN_PED_TO_FACE_ENTITY(PLAYER_PED_ID(), Local_443.f_28[0], 0);
							}
						}
						else
						{
				...
				if (!iLocal_519)
				{
					...
					{
						if (IS_ENTITY_PLAYING_ANIM(Local_443.f_28[0], "rcmjosh4", "beckon_a_josh", 3) && !func_205())
						{
							TASK_PLAY_ANIM(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 2f, -8f, -1, 2, 0, 0, 0, 0);
							func_476("Done Josh leadin anim");
							if (func_258(Local_443.f_28[2]))
							{
								TASK_PLAY_ANIM(Local_443.f_28[2], "rcmjosh4", "josh_4_leadin_cop_a", 8f, -8f, -1, 2, 0, 0, 0, 0);
								func_476("Done Notepad cop leadin anim");
							}
							if (func_258(Local_443.f_28[1]))
							{
								TASK_PLAY_ANIM(Local_443.f_28[1], "rcmjosh4", "josh_4_leadin_cop_b", 8f, -8f, -1, 2, 0, 0, 0, 0);
								func_476("Done Speaker cop leadin anim");
							}
							REMOVE_CUTSCENE();
							_REQUEST_CUTSCENE_EX("JOSH_4_INT_CONCAT", 2, 8);
							iLocal_519 = 1;
						}
					}
				}
				...
				{
					if ((func_428(PLAYER_PED_ID()) && func_258(Local_443.f_28[0])) && !func_294())
					{
						if (!func_287(PLAYER_PED_ID(), -875674219))
						{
							TASK_TURN_PED_TO_FACE_ENTITY(PLAYER_PED_ID(), Local_443.f_28[0], 0);
					...
					if (func_258(Local_443.f_28[0]))
					{
						if (IS_ENTITY_PLAYING_ANIM(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 3))
						{
							if (GET_ENTITY_ANIM_CURRENT_TIME(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh") > 0.276f)
							{
								if (iLocal_520 == 0)
								{
							...
							if (GET_ENTITY_ANIM_CURRENT_TIME(Local_443.f_28[0], "rcmjosh4", "josh_4_leadin_josh") > 0.98f)
							{
								func_290(1);
							}
							if (func_209(PLAYER_PED_ID(), Local_443.f_28[0], 1) <= 2f)
							{
								if (func_205())
								{
									func_223();
...
void func_296()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if (func_288(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_315(0) || Global_71859) || Global_71848 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_300(0)) || func_314(1))
			{
			}
			else
			{
...
void func_318()
{
	if (func_428(Local_443.f_28[1]))
	{
		SET_ENTITY_COORDS_NO_OFFSET(Local_443.f_28[1], -1102.48f, 290.2f, 64.22f, 0, 0, 1);
		SET_ENTITY_HEADING(Local_443.f_28[1], 177.74f);
	}
	else
	{
		Local_443.f_28[1] = CREATE_PED(6, iLocal_84, -1102.92f, 290.12f, -200f, 40.46f, 0, 0);
	}
	if (func_428(Local_443.f_28[2]))
	{
		SET_ENTITY_COORDS_NO_OFFSET(Local_443.f_28[2], -1103.94f, 290.21f, 64.28f, 0, 0, 1);
		SET_ENTITY_HEADING(Local_443.f_28[2], -167.67f);
	}
	else
	{
		Local_443.f_28[2] = CREATE_PED(6, iLocal_84, -1102.73f, 290.91f, -200f, 92.06f, 0, 0);
	}
	if (!func_324())
	{
		func_323(PLAYER_PED_ID(), vLocal_106, fLocal_109, 1, 1);
		SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
		SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
	}
	func_291(1);
	REQUEST_MODEL(iLocal_509);
	while (!HAS_MODEL_LOADED(iLocal_509))
	{
		WAIT(0);
	}
	func_290(2);
...
int func_321(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		_SET_DOOR_AJAR_ANGLE(-1502457334, 0f, 0, 0);
		_SET_DOOR_ACCELERATION_LIMIT(-1502457334, 3, 0, 1);
		iVar0++;
	}
	else
	{
	...
	if (bParam1)
	{
		_SET_DOOR_AJAR_ANGLE(-1994188940, 0f, 0, 0);
		_SET_DOOR_ACCELERATION_LIMIT(-1994188940, 3, 0, 1);
		iVar0++;
	}
	else
	{
...
int func_322(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		CREATE_FORCED_OBJECT(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0);
		_SET_DOOR_AJAR_ANGLE(904342475, 1f, 0, 0);
		_SET_DOOR_ACCELERATION_LIMIT(904342475, 4, 0, 1);
		iVar0++;
	}
	else
	{
	...
	if (bParam1)
	{
		CREATE_FORCED_OBJECT(-1101.62f, 290.36f, 64.76f, 5f, joaat("prop_lrggate_01c_r"), 0);
		_SET_DOOR_AJAR_ANGLE(-795418380, -0.9f, 0, 0);
		_SET_DOOR_ACCELERATION_LIMIT(-795418380, 4, 0, 1);
		iVar0++;
	}
	else
	{
...
int func_323(var uParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
void func_325(var uParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*uParam0 = func_399(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		...
		{
			func_390(iParam12, 0);
			while (!func_326(uParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				WAIT(0);
			}
		}
...
int func_326(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	var uVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam5, 0, 0, 0);
				...
				func_384(uParam0, &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam5, 0, 0, 0);
				...
				func_384(uParam0, &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				SET_VEHICLE_ENVEFF_SCALE(*uParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (GET_ENTITY_MODEL(*uParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (HAS_MODEL_LOADED(Var5))
			{
				...
				*uParam0 = CREATE_VEHICLE(Var5, vParam2, fParam5, 1, 1, 0);
				...
				func_384(uParam0, &(Var5.f_31), &(Var5.f_81));
				SET_VEHICLE_ENVEFF_SCALE(*uParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_327(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	if ((func_151(iParam0) && DOES_ENTITY_EXIST(*uParam1)) && IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_332(*uParam1, 0, &uVar0))
		{
			func_331(uParam1, &(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_106565.f_20112[iParam0 /*43*/].f_31 = func_330(*uParam1);
...
int func_332(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_360(iVar0, bParam1, uParam2) && !func_359(PLAYER_ID())) && !func_343(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_341(PLAYER_ID()) && (IS_THIS_MODEL_A_HELI(iVar0) || IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_339(iParam0)) && !bVar1) && !(func_338(GET_ENTITY_MODEL(iParam0)) && func_334(PLAYER_ID())))
	{
...
{
	if (func_358(PLAYER_ID()) || func_357(PLAYER_ID()))
	{
		if (func_344(iParam0))
		{
			return 1;
...
int func_345(int iParam0)
{
	...
	if (func_346(GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_347(int iParam0, bool bParam1)
{
	switch (GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_349(GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_360(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_341(PLAYER_ID()) && (IS_THIS_MODEL_A_HELI(iParam0) || IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_364(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_277(iParam0, 0, 0)) || func_277(iParam0, 1, 0)) || func_277(iParam0, 2, 0)) || func_380(iParam0) != 145) || func_379(iParam0)) || func_378(iParam0)) || func_333(iParam0)) || func_377(iParam0)) || !func_367(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_378(iParam0))
		{
		}
...
int func_384(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_356(GET_ENTITY_MODEL(*uParam0), 1) && GET_VEHICLE_MOD(*uParam0, 24) != func_387(*uParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*uParam0, 24, func_387(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_386(uParam0);
	if (func_385(*uParam0))
	{
...
void func_390(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_91043[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || GET_ENTITY_MODEL(Global_91043[iVar0]) == func_391(iParam0, iParam1))
				{
...
void func_392(vector3 vParam0, float fParam3, int iParam4)
{
	int iVar0;
...
bool func_398(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
...
int func_399(vector3 vParam0, float fParam3)
{
	return func_400(&(Global_100114.f_2890), vParam0, fParam3, 0);
}

int func_400(var uParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
	...
	if (func_417(uParam0))
	{
		...
		if (func_416(uParam0))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_402(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && ARE_STRINGS_EQUAL(GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_402(var uParam0, vector3 vParam1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_404(uParam0, Global_70409.f_139[38], 0))
			{
				func_393(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_404(uParam0, Global_70409.f_139[43], 1))
			{
				func_393(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_404(uParam0, uVar1[iVar6], 1) && func_403(GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_398(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(uParam0, 1), GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						DELETE_VEHICLE(&uParam0);
						return 1;
					}
...
int func_403(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_405(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_364(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_364(iVar1 + 1)))
			{
			}
			else
			{
				SET_BIT(&(uParam1->f_77), func_364(iVar1 + 1));
			}
		}
		...
		if (((IS_BIT_SET(uParam1->f_77, 15) || func_408(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_407())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
		{
			func_384(&uParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
		if (!IS_THIS_MODEL_A_HELI(uParam1->f_66) && !IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (IS_BIT_SET(uParam1->f_77, func_364(iVar2 + 1)))
				{
...
int func_430(var uParam0)
{
	...
	switch (iLocal_79)
	{
		...
		case 2:
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_28[1]))
			{
				...
				if (func_428(uParam0->f_28[1]))
				{
					...
					GIVE_WEAPON_TO_PED(uParam0->f_28[1], joaat("weapon_pistol"), -1, 0, 1);
					if (HAS_ANIM_DICT_LOADED("rcmjosh4"))
					{
						CLEAR_PED_TASKS(uParam0->f_28[1]);
						TASK_PLAY_ANIM(uParam0->f_28[1], "rcmjosh4", "BECKON_A_COP_B", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
				}
				else
				{
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_28[2]))
			{
				...
				if (func_428(uParam0->f_28[2]))
				{
					...
					GIVE_WEAPON_TO_PED(uParam0->f_28[2], joaat("weapon_pistol"), -1, 0, 1);
					if (HAS_ANIM_DICT_LOADED("rcmjosh4"))
					{
						CLEAR_PED_TASKS(uParam0->f_28[2]);
						TASK_PLAY_ANIM(uParam0->f_28[2], "rcmjosh4", "BECKON_A_COP_A", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
				}
				else
				{
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				...
				if (func_203(uParam0->f_35[1]))
				{
					...
					fVar6 = GET_VEHICLE_ENGINE_HEALTH(uParam0->f_35[1]);
					fVar6 = (fVar6 / 2f);
					SET_VEHICLE_ENGINE_HEALTH(uParam0->f_35[1], fVar6);
					SET_VEHICLE_ON_GROUND_PROPERLY(uParam0->f_35[1], 1084227584);
				}
				else
				{
					bVar7 = false;
		...
		case 3:
			if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1138.32f, 299.69f, 65.94f, 5f, joaat("prop_lrggate_01c_l"), 0))
			{
				SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1138.32f, 299.69f, 65.94f, 1, 0f, 0);
			}
			if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1137.52f, 297.02f, 65.81f, 5f, joaat("prop_lrggate_01c_r"), 0))
			{
				SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_r"), -1137.054f, 295.5856f, 67.18046f, 1, 0f, 0);
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
			{
...
void func_431(var uParam0, bool bParam1)
{
	...
	func_432(uParam0, iLocal_81, vVar0, fVar3);
	SET_VEHICLE_COLOUR_COMBINATION(*uParam0, 4);
	SET_VEHICLE_DOORS_LOCKED(*uParam0, 3);
	SET_VEHICLE_AUTOMATICALLY_ATTACHES(*uParam0, 0, 0);
	_0x2B6747FAA9DB9D6B(*uParam0, 1);
}

void func_432(var uParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_226(uParam0);
...
void func_433(var uParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	func_227(uParam0);
	*uParam0 = CREATE_PED(iParam6, uParam1, vParam2, fParam5, 0, 0);
}

int func_434(var uParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_435(uParam0, iParam1, vParam2, fParam5, 1))
	{
		if (DOES_ENTITY_EXIST(*uParam0))
		{
			if (!IS_ENTITY_DEAD(*uParam0, 0))
...
int func_435(var uParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	int iVar0;
