...
void __EntryFunction__()
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_38 = func_473(58);
	iLocal_39 = joaat("felon2");
	fLocal_41 = "josh_4_int_concat";
	...
	if (func_438())
	{
		...
		func_437(vLocal_53, fLocal_54, 1, 0);
		func_472("*** Replay setup started");
		Global_71223 = 1;
		iLocal_37 = 0;
		while (!func_426(&Local_386))
		{
			SYSTEM::WAIT(0);
		}
		func_472("*** Josh 4 scene set up");
		func_425(&Local_386, 0, 1);
		Global_71223 = 0;
	}
	if (func_424(Local_386.f_28[1]))
	{
		AUDIO::STOP_PED_SPEAKING(Local_386.f_28[1], 1);
	}
	if (func_424(Local_386.f_28[2]))
	{
...
void func_1()
{
	...
	switch (iLocal_46)
	{
		case 0:
			...
			if (func_424(Local_386.f_28[0]))
			{
				BRAIN::TASK_LOOK_AT_ENTITY(Local_386.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			}
		...
		case 1:
			...
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) <= 0 && !func_205())
			{
				...
				{
					if (func_424(Local_386.f_28[iVar0]))
					{
	...
	switch (iLocal_49)
	{
		case 0:
			if (iLocal_48 == 3)
			{
				if (func_424(Local_386.f_28[0]))
				{
					BRAIN::CLEAR_PED_TASKS(Local_386.f_28[0]);
					if (func_203(iLocal_391))
					{
						if (MISC::IS_POSITION_OCCUPIED(-1138.421f, 298.0307f, 65.90032f, 4f, 0, 1, 0, 0, 0, iLocal_391, 0))
						{
							...
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_389);
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_55, 2f, 20000, 1f, 1, 1193033728);
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1126.56f, 319.85f, 65.98f, 2f, 20000, 1f, 1, 1193033728);
							BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_389);
							PED::SET_PED_KEEP_TASK(Local_386.f_28[0], true);
							BRAIN::TASK_PERFORM_SEQUENCE(Local_386.f_28[0], iLocal_389);
						}
						else
						{
							...
							if (func_203(iLocal_391))
							{
								BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_391, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, 1);
							}
							else
							{
								BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
					...
					else
					{
						...
						if (func_203(iLocal_391))
						{
							BRAIN::TASK_ENTER_VEHICLE(0, iLocal_391, 20000, -1, 2f, 1, 0);
							BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_391, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, 1);
						}
						else
						{
					...
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_389);
				}
			...
			if (func_424(Local_386.f_28[0]))
			{
				...
				if (func_203(iLocal_391))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_386.f_28[0], iLocal_391, 1))
					{
						...
						{
							BRAIN::CLEAR_PED_TASKS(Local_386.f_28[0]);
							BRAIN::TASK_LEAVE_ANY_VEHICLE(Local_386.f_28[0], 0, 4416);
							BRAIN::TASK_SMART_FLEE_PED(Local_386.f_28[0], PLAYER::PLAYER_PED_ID(), 510f, -1, 0, 0);
							func_228(&iLocal_391);
						}
					}
					if (func_424(PLAYER::PLAYER_PED_ID()))
				...
				if (func_424(PLAYER::PLAYER_PED_ID()) && func_424(Local_386.f_28[0]))
				{
					if (iLocal_410 < 3)
					{
	...
	switch (Local_47.f_11)
	{
		...
		case 1:
			if (!ENTITY::DOES_ENTITY_EXIST(Local_47.f_7))
			{
				...
				BRAIN::CLEAR_PED_TASKS(Local_47.f_8);
	...
	switch (iLocal_48)
	{
		...
		case 2:
			if ((MISC::GET_GAME_TIMER() - iLocal_394) > 20000)
			{
				...
				if (func_424(Local_386.f_28[1]))
				{
					BRAIN::CLEAR_PED_TASKS(Local_386.f_28[1]);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_386.f_28[1], false);
					BRAIN::TASK_ARREST_PED(Local_386.f_28[1], PLAYER::PLAYER_PED_ID());
				}
				iLocal_48 = 4;
				iLocal_394 = MISC::GET_GAME_TIMER();
			}
		...
		case 3:
			...
			if (!iLocal_399)
			{
				...
				while (iVar0 <= (Local_386.f_28 - 1))
				{
					if (func_424(Local_386.f_28[iVar0]))
					{
						BRAIN::CLEAR_PED_TASKS(Local_386.f_28[iVar0]);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_386.f_28[iVar0], false);
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_389);
						BRAIN::TASK_SHOOT_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, -687903391);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_389);
						BRAIN::TASK_PERFORM_SEQUENCE(Local_386.f_28[iVar0], iLocal_389);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_389);
					}
					iVar0++;
				}
			...
			else
			{
				...
				{
					if (func_424(Local_386.f_28[iVar1]))
					{
...
int func_234(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_424(PLAYER::PLAYER_PED_ID()) && func_424(iParam0))
	{
...
void func_254(void fParam0, int iParam1, int iParam2)
{
	iParam2 = iParam2;
...
void func_256()
{
	...
	{
		case 0:
			if (!MISC::ARE_STRINGS_EQUAL(fLocal_41, ""))
			{
				if (iLocal_400 == 0)
				{
					func_292(fLocal_41, 0);
				}
				iLocal_408 = 0;
				iLocal_46 = 1;
			}
...
void func_267()
{
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
	{
		if (func_424(Local_386.f_28[0]))
		{
			...
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_389);
			BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2, 2);
			BRAIN::TASK_PLAY_ANIM(0, "rcmjosh4", "josh_leadout_loop", 4f, -4f, -1, 262153, 0, 0, 0, 0);
			BRAIN::CLOSE_SEQUENCE_TASK(iLocal_389);
			BRAIN::TASK_PERFORM_SEQUENCE(Local_386.f_28[0], iLocal_389);
			BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_389);
	...
	{
		if (func_424(iLocal_387) && func_424(Local_386.f_28[1]))
		{
	...
	{
		if (func_424(iLocal_388) && func_424(Local_386.f_28[2]))
		{
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_standing_idle", 0))
	{
		if (func_424(Local_386.f_28[1]))
		{
			...
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_389);
			BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1026, 2);
			BRAIN::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1);
			BRAIN::TASK_PLAY_ANIM(0, "combat@gestures@pistol@glances", "90", 8f, -1000f, -1, 262184, 0, 0, 0, 0);
			BRAIN::CLOSE_SEQUENCE_TASK(iLocal_389);
			BRAIN::TASK_PERFORM_SEQUENCE(Local_386.f_28[1], iLocal_389);
			BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_389);
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_with_notepad", 0))
	{
		if (func_424(Local_386.f_28[2]))
		{
			...
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_389);
			BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1026, 2);
			BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1103.72f, 289.46f, 63.23f, PLAYER::PLAYER_PED_ID(), 1f, false, 0.1f, 4f, true, 0, 1, -957453492, 20000);
			BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -1106.08f, 288.55f, 63.31f, PLAYER::PLAYER_PED_ID(), 1f, false, 0.1f, 4f, true, 0, 1, -957453492, 20000);
			BRAIN::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1);
			BRAIN::CLOSE_SEQUENCE_TASK(iLocal_389);
			BRAIN::TASK_PERFORM_SEQUENCE(Local_386.f_28[2], iLocal_389);
			BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_389);
...
void func_291(int iParam0)
{
	...
	if (func_424(Local_386.f_28[0]))
	{
		if (iParam0 == 1)
		{
			...
			BRAIN::TASK_PLAY_ANIM(Local_386.f_28[0], "rcmjosh4", "josh_leadout_loop", 8f, -8f, -1, 1, 0, 0, 0, 0);
		}
...
void func_292(void fParam0, bool bParam1)
{
	func_272(bParam1);
...
void func_293()
{
	...
	switch (iLocal_46)
	{
		...
		case 1:
			if (!func_5(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, true, 0))
			{
				if (func_424(PLAYER::PLAYER_PED_ID()) && func_258(Local_386.f_28[0]))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1105.571f, 290.008f, 62.87176f, -1100.577f, 290.4298f, 66.45212f, 4.5f, 0, true, 0))
					{
						if (!func_294())
						{
							...
							{
								BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_386.f_28[0], 0);
							}
						}
						else
						{
				...
				if (!iLocal_400)
				{
					if (func_258(Local_386.f_28[0]))
					{
						...
						{
							BRAIN::TASK_PLAY_ANIM(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 2f, -8f, -1, 2, 0, 0, 0, 0);
							func_472("Done Josh leadin anim");
							if (func_258(Local_386.f_28[2]))
							{
								BRAIN::TASK_PLAY_ANIM(Local_386.f_28[2], "rcmjosh4", "josh_4_leadin_cop_a", 8f, -8f, -1, 2, 0, 0, 0, 0);
								func_472("Done Notepad cop leadin anim");
							}
							if (func_258(Local_386.f_28[1]))
							{
								BRAIN::TASK_PLAY_ANIM(Local_386.f_28[1], "rcmjosh4", "josh_4_leadin_cop_b", 8f, -8f, -1, 2, 0, 0, 0, 0);
				...
				{
					if ((func_424(PLAYER::PLAYER_PED_ID()) && func_258(Local_386.f_28[0])) && !func_294())
					{
						if (!func_287(PLAYER::PLAYER_PED_ID(), -875674219))
						{
							BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_386.f_28[0], 0);
...
void func_301(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71232 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_303(Global_71233, Global_71235, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_314(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_300(0)) || func_313(1))
			{
			}
			else
			{
...
void func_317()
{
	...
	if (!func_323())
	{
		func_322(PLAYER::PLAYER_PED_ID(), vLocal_53, fLocal_54, 1, 1);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
	}
	func_291(1);
...
int func_322(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_324(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
...
void func_326(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_151(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_331(*iParam1, 0, &uVar0))
		{
...
int func_331(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if (((((((VEHICLE::IS_BIG_VEHICLE(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("halftrack")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("phantom3")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("hauler2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("trailerlarge")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("trailersmall2")) && !bVar1) && !(func_337(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_333(PLAYER::PLAYER_ID())))
	{
		*uParam2 = 2;
		return 0;
	}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_277(iParam0, 0, 0)) || func_277(iParam0, 1, 0)) || func_277(iParam0, 2, 0)) || func_376(iParam0) != 145) || func_375(iParam0)) || func_374(iParam0)) || func_332(iParam0)) || func_373(iParam0)) || !func_363(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_374(iParam0))
		{
		}
...
void func_386(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90431[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90431[iVar0]) == func_387(iParam0, iParam1))
				{
...
{
	return func_396(&(Global_98783.f_2875), vParam0, fParam1, 0);
}
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
			{
				...
				if (func_424(uParam0->f_28[1]))
				{
					...
					if (STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh4"))
					{
						...
						BRAIN::TASK_PLAY_ANIM(uParam0->f_28[1], "rcmjosh4", "BECKON_A_COP_B", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
				}
				else
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[2]))
			{
				...
				if (func_424(uParam0->f_28[2]))
				{
					...
					if (STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh4"))
					{
						BRAIN::CLEAR_PED_TASKS(uParam0->f_28[2]);
						BRAIN::TASK_PLAY_ANIM(uParam0->f_28[2], "rcmjosh4", "BECKON_A_COP_A", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
				}
				else
				{
...
void func_427(int iParam0, bool bParam1)
{
	...
	func_428(iParam0, iLocal_39, vVar0, fVar1);
...
void func_428(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_226(iParam0);
...
void func_429(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)
{
	func_227(iParam0);
	*iParam0 = PED::CREATE_PED(iParam4, iParam1, vParam2, fParam3, 0, false);
}

int func_430(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_431(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_431(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_437(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_438())
	{
...
void func_450(bool bParam0)
{
	...
	if (!func_467())
	{
		...
		{
			func_159(iVar0, 1, 0);
			func_451(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_104307[iVar0 /*10*/].f_9 == -1)
...
void func_451(void fParam0, int iParam1)
{
	if (Global_92955 != 12)
	{
		if (func_452(fParam0, 6, iParam1))
		{
...
int func_455(void fParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
