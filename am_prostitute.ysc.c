...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		func_42();
		if (((func_32() || NETWORK::NETWORK_IS_IN_TUTORIAL_SESSION()) || (func_31(CAM::_0xDC9DA9E8789F5246()) || func_30(CAM::_0xDC9DA9E8789F5246()))) || func_27(CAM::_0xDC9DA9E8789F5246()))
		{
			func_43();
		}
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		...
		if ((iLocal_54 % iVar0) == 0)
		{
			if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iVar2, 0))
				{
					...
					{
						if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 0), unk_0x8000C77B5F336760(iVar2, 1)) <= 22500f)
						{
							if (!iLocal_56)
							{
							...
							if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_55, iVar0))
							{
								MISC::SET_BIT(&iLocal_55, iVar0);
							}
						}
						else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_55, iVar0))
						{
							GRAPHICS::_0x35FB78DC42B7BD21(&iLocal_55, iVar0);
						}
					}
					else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_55, iVar0))
					{
...
void func_2()//Position - 0x230
{
	...
	{
		case 0:
			if (((func_23(CAM::_0xDC9DA9E8789F5246(), 1) || func_22()) || !bVar3) || func_17())
			{
				iLocal_52 = 4;
			}
			else
		...
		case 5:
			if (((!func_23(CAM::_0xDC9DA9E8789F5246(), 1) && !func_22()) && bVar3) && !func_3())
			{
				iLocal_53 = MISC::GET_GAME_TIMER() + 250;
				iLocal_52 = 0;
			}
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
			{
				...
				if (func_26(&iVar2))
				{
					...
					vVar4 = { unk_0x8000C77B5F336760(func_12(iVar1), 0) };
					vVar5 = { unk_0x8000C77B5F336760(iVar0, 0) };
					vVar6 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 0) };
...
int func_17()//Position - 0x88E
{
	...
	if (func_18(CAM::_0xDC9DA9E8789F5246()) != 4294967295)
	{
		return 1;
	}
	return 0;
...
int func_26(int iParam0)//Position - 0x9D0
{
	...
	{
		if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(PED::GET_VEHICLE_PED_IS_USING(*iParam0), 4294967295, 0) == *iParam0)
		{
			return 1;
		}
	}
...
int func_27(int iParam0)//Position - 0x9FB
{
	if (iParam0 != func_29())
	{
		if (func_10(iParam0, 1, 1))
		{
			...
			{
				return func_28(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 11;
			}
		}
	}
	return 0;
...
int func_29()//Position - 0xD9C
{
	return 4294967295;
}

bool func_30(int iParam0)//Position - 0xDA5
{
	return Global_24FBF9[iParam0 /*413*/].f_73 == 7;
}

bool func_31(int iParam0)//Position - 0xDBA
{
	return Global_24FBF9[iParam0 /*413*/].f_73 == 2;
}

int func_32()//Position - 0xDCF
{
	var uVar0;
...
int func_34()//Position - 0xE8D
{
	return Global_6373;
}

bool func_35()//Position - 0xE98
{
	return Global_255C02.f_24B;
}

int func_36(int iParam0)//Position - 0xEA7
{
...
bool func_37()//Position - 0xEBE
{
	return Global_25824F;
}

bool func_38()//Position - 0xECA
{
	return Global_255C02.f_246;
}

void func_39(var uParam0)//Position - 0xED9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_40(int iParam0)//Position - 0xF4C
{
	vector3 vVar0;
	int iVar1;
	int iVar2;
...
int func_41(int iParam0, var uParam1)//Position - 0xFCD
{
...
void func_42()//Position - 0x102C
{
	SYSTEM::WAIT(0);
}

void func_43()//Position - 0x1039
{
	if (iLocal_56)
	{
		STREAMING::REMOVE_ANIM_DICT("mini@prostitutes@sexlow_veh");
...
void func_44()//Position - 0x108B
{
	HUD::DISPLAY_SNIPER_SCOPE_THIS_FRAME();
}

void func_45()//Position - 0x1097
{
	Global_252F9E.f_47F.f_A = 0;
}

void func_46(struct<21> Param0)//Position - 0x10A9
{
...
int func_47(int iParam0, int iParam1, bool bParam2)//Position - 0x10EB
{
	int iVar0;
...
bool func_48()//Position - 0x1200
{
	return Global_140842;
}

void func_49(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x120C
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_44();
...
int func_50(int iParam0)//Position - 0x122B
{
	switch (iParam0)
	{
		case 3:
