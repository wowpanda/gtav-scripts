			...
			if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
			{
				if (!IS_PED_INJURED(PLAYER_PED_ID()))
				{
					if ((!IS_PED_FALLING(PLAYER_PED_ID()) && !IS_ENTITY_IN_WATER(PLAYER_PED_ID())) && !IS_ENTITY_ON_FIRE(PLAYER_PED_ID()))
					{
						if (!bVar0)
						{
							if (!((func_26() || IS_PLAYER_SWITCH_IN_PROGRESS()) || func_25()))
							{
								if (func_13())
								{
									bVar0 = true;
						...
						else
						{
							if (iLocal_28)
							{
								SET_PLAYER_CONTROL(PLAYER_ID(), 0, 384);
							...
							switch (func_12())
							{
								...
								case -1989308064:
									func_7(12, 0);
									func_6(134, 1);
									STAT_SET_INT(joaat("sp_final_decision"), 2, 1);
									break;
								...
								case -1060930305:
									func_7(12, 1);
									func_6(134, 1);
									STAT_SET_INT(joaat("sp_final_decision"), 1, 1);
									break;
								
								case -1817481777:
									func_7(12, 2);
									func_6(134, 1);
									STAT_SET_INT(joaat("sp_final_decision"), 3, 1);
									break;
...
void func_36(int iParam0)
{
	...
	Global_36977[iParam0] = GET_GAME_TIMER();
}

void func_37()
{
	Global_36976 = GET_GAME_TIMER();
}
