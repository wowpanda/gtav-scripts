...
void __EntryFunction__()
{
	...
	if (HAS_FORCE_CLEANUP_OCCURRED(11))
	{
		...
		{
			if (IS_PED_IN_GROUP(uLocal_55))
			{
				REMOVE_PED_FROM_GROUP(uLocal_55);
			}
		}
		if (!IS_PED_INJURED(uLocal_57))
		{
			if (IS_PED_IN_GROUP(uLocal_57))
			{
				REMOVE_PED_FROM_GROUP(uLocal_57);
			}
		}
		func_177();
	}
	...
	{
		WAIT(0);
		if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || bLocal_116)
		{
			if (!func_143())
			{
				if (func_142())
			...
			switch (iLocal_48)
			{
				...
				case 1:
					...
					if (!iLocal_114)
					{
						...
						func_116();
						func_105();
						if (!IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_318))
						{
							func_104();
						}
					}
					else
					{
						...
						if (iLocal_49 == 3)
						{
							if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_87, 1) < 100f)
							{
								...
								if (IS_CUTSCENE_ACTIVE())
								{
									...
									{
										if ((((!IS_PED_INJURED(uLocal_55) && !IS_PED_INJURED(uLocal_57)) && !IS_PED_INJURED(uLocal_56)) && !IS_PED_INJURED(uLocal_58)) && !IS_ENTITY_DEAD(uLocal_132, 0))
										{
											_0x2A56C06EBEF2B0D9("Groom", uLocal_55, 0);
											_0x2A56C06EBEF2B0D9("Groomsman", uLocal_57, 0);
											_0x2A56C06EBEF2B0D9("Bride", uLocal_56, 0);
											_0x2A56C06EBEF2B0D9("Father_of_the_bride", uLocal_58, 0);
										}
									}
								}
							}
							...
							else if (!IS_PED_INJURED(uLocal_57))
							{
								if (IS_PED_IN_ANY_VEHICLE(uLocal_57, 0))
								{
									if (DOES_BLIP_EXIST(uLocal_322))
									{
										REMOVE_BLIP(&uLocal_322);
										if (DOES_BLIP_EXIST(uLocal_320))
										{
											REMOVE_BLIP(&uLocal_320);
										}
										if (!DOES_BLIP_EXIST(uLocal_320))
										{
						...
						if (func_3())
						{
							if (!IS_PED_INJURED(uLocal_55))
							{
								TASK_SMART_FLEE_PED(uLocal_55, PLAYER_PED_ID(), 1000f, -1, 0, 0);
							}
							if (!IS_PED_INJURED(uLocal_57))
							{
								TASK_SMART_FLEE_PED(uLocal_57, PLAYER_PED_ID(), 1000f, -1, 0, 0);
							}
							if (!IS_PED_INJURED(uLocal_56))
							{
								TASK_SMART_FLEE_PED(uLocal_56, PLAYER_PED_ID(), 1000f, -1, 0, 0);
							}
							if (!IS_PED_INJURED(uLocal_58))
							{
								TASK_SMART_FLEE_PED(uLocal_58, PLAYER_PED_ID(), 1000f, -1, 0, 0);
							}
							func_2();
						}
					}
...
int func_3()
{
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_55, PLAYER_PED_ID(), 1) || IS_ENTITY_IN_WATER(uLocal_55))
			{
				return 1;
			}
			if (bLocal_116)
	...
	{
		if ((!IS_VEHICLE_DRIVEABLE(iLocal_59, 0) || IS_VEHICLE_STUCK_ON_ROOF(iLocal_59)) || IS_ENTITY_IN_WATER(iLocal_59))
		{
			func_21();
		...
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			{
				if (IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), iLocal_59))
				{
					func_21();
					if (func_4(&uLocal_136, "stagdau", "stagdwrcar", 4, 0, 0, 0))
					{
	...
	if (!IS_PED_INJURED(uLocal_55))
	{
		if (!IS_ENTITY_AT_ENTITY(uLocal_55, PLAYER_PED_ID(), 150f, 150f, 150f, 0, 1, 0))
		{
			if (!IS_ENTITY_DEAD(iLocal_59, 0))
			{
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_59, 0))
				{
	...
	if (iLocal_49 >= 1)
	{
		if (bLocal_123)
		{
			...
			else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_57, PLAYER_PED_ID(), 1))
			{
				func_21();
				return 1;
			}
		...
		if (!IS_ENTITY_DEAD(iLocal_59, 0))
		{
			if (!IS_ENTITY_AT_ENTITY(iLocal_59, PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0))
			{
				if (!iLocal_126)
				{
					func_21();
			...
			if (!IS_ENTITY_AT_ENTITY(iLocal_59, PLAYER_PED_ID(), 150f, 150f, 150f, 0, 1, 0))
			{
				return 1;
			}
		}
	...
	if (iLocal_49 == 3)
	{
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			if (IS_PED_INJURED(uLocal_56) || IS_PED_INJURED(uLocal_58))
			{
				return 1;
			}
			else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_56, PLAYER_PED_ID(), 1) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_58, PLAYER_PED_ID(), 1))
			{
				return 1;
			}
		}
		if (!IS_PED_INJURED(uLocal_57))
		{
			if (!IS_ENTITY_AT_ENTITY(uLocal_57, PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0) && iLocal_310)
			{
				if (!iLocal_127)
				{
					func_21();
			...
			if (!IS_ENTITY_AT_ENTITY(uLocal_57, PLAYER_PED_ID(), 150f, 150f, 150f, 0, 1, 0))
			{
				return 1;
			}
		}
...
var func_23(vector3 vParam0, int iParam3)
{
	...
	SET_BLIP_SCALE(uVar0, func_24(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
	...
	switch (iLocal_131)
	{
		...
		case 2:
			if ((((!IS_PED_INJURED(uLocal_55) && !IS_PED_INJURED(uLocal_57)) && !IS_PED_INJURED(uLocal_56)) && !IS_PED_INJURED(uLocal_58)) && !IS_ENTITY_DEAD(uLocal_132, 0))
			{
				if (func_51())
				{
					REGISTER_ENTITY_FOR_CUTSCENE(uLocal_132, "SDRM_Car", 0, 0, 0);
					REGISTER_ENTITY_FOR_CUTSCENE(uLocal_55, "Groom", 0, 0, 0);
					REGISTER_ENTITY_FOR_CUTSCENE(uLocal_57, "Groomsman", 0, 0, 0);
					REGISTER_ENTITY_FOR_CUTSCENE(uLocal_56, "Bride", 0, 0, 0);
					REGISTER_ENTITY_FOR_CUTSCENE(uLocal_58, "Father_of_the_bride", 0, 0, 0);
					START_CUTSCENE(4);
					iLocal_131++;
				}
			}
		...
		case 3:
			...
			{
				if (!IS_ENTITY_DEAD(uLocal_132, 0))
				{
					SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_132, 1084227584);
					SET_VEHICLE_DOORS_SHUT(uLocal_132, 1);
					DISPLAY_HUD(1);
					DISPLAY_RADAR(1);
		...
		case 4:
			DELETE_PED(&uLocal_55);
			DELETE_PED(&uLocal_57);
			DELETE_PED(&uLocal_56);
			DELETE_PED(&uLocal_58);
			func_52(0, 1, 1, 0, 0, 0);
...
void func_52(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_56(PLAYER_ID())) && !func_54(PLAYER_ID(), 0)) && !func_53()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_56(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
...
void func_61()
{
	if (!IS_ENTITY_DEAD(iLocal_59, 0) && !IS_ENTITY_DEAD(uLocal_55, 0))
	{
		if (!iLocal_117)
		{
			if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_59, 0) && IS_PED_IN_VEHICLE(uLocal_55, iLocal_59, 0))
			{
				iLocal_117 = 1;
				if (DOES_BLIP_EXIST(uLocal_319))
				{
					REMOVE_BLIP(&uLocal_319);
				}
		...
		if (!iLocal_117 && !iLocal_119)
		{
			if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_59, 0))
			{
				if (!IS_PED_IN_VEHICLE(uLocal_55, iLocal_59, 0))
				{
					if (!func_65())
					{
					}
					...
					if (!DOES_BLIP_EXIST(uLocal_319))
					{
						...
						SET_BLIP_AS_FRIENDLY(uLocal_319, 1);
					}
					iLocal_117 = 0;
					iLocal_119 = 1;
				}
...
int func_63(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_24(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
void func_66()
{
	if (DOES_ENTITY_EXIST(uLocal_55))
	{
		if (!IS_PED_INJURED(uLocal_55))
		{
			if (IS_ENTITY_AT_ENTITY(uLocal_55, PLAYER_PED_ID(), 4f, 4f, 4f, 0, 1, 0))
			{
				if ((!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !IS_PED_IN_ANY_VEHICLE(uLocal_55, 0)) || IS_PED_IN_ANY_TAXI(PLAYER_PED_ID()))
				{
					if (DOES_BLIP_EXIST(uLocal_321))
					{
						REMOVE_BLIP(&uLocal_321);
						if (!DOES_BLIP_EXIST(uLocal_320))
						{
							uLocal_320 = func_23(vLocal_67, 1);
						}
				...
				else if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && IS_PED_IN_ANY_VEHICLE(uLocal_55, 0))
				{
					if (DOES_BLIP_EXIST(uLocal_321))
					{
						REMOVE_BLIP(&uLocal_321);
				...
				else if (DOES_BLIP_EXIST(uLocal_320))
				{
					REMOVE_BLIP(&uLocal_320);
					if (!DOES_BLIP_EXIST(uLocal_321))
					{
			...
			if (!IS_PED_IN_GROUP(uLocal_55))
			{
				if (!IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_55, 10f, 10f, 10f, 0, 1, 0))
				{
					CLEAR_PED_TASKS(uLocal_55);
					SET_PED_AS_GROUP_MEMBER(uLocal_55, func_67());
					SET_PED_NEVER_LEAVES_GROUP(uLocal_55, 1);
					SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uLocal_55, 0);
				}
	...
	if (!IS_PED_INJURED(uLocal_55))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
		{
			if (!func_71())
			{
				...
				if (GET_SCRIPT_TASK_STATUS(uLocal_55, 1227113341) != 1 && GET_SCRIPT_TASK_STATUS(uLocal_55, 1227113341) != 0)
				{
					TASK_GO_TO_ENTITY(uLocal_55, PLAYER_PED_ID(), -1, 6f, 1073741824, 1073741824, 0);
				}
				if (IS_PED_IN_ANY_VEHICLE(uLocal_55, 0))
				{
					TASK_LEAVE_ANY_VEHICLE(uLocal_55, 0, 0);
				}
				if (!iLocal_125)
				{
					if (!func_65())
			...
			{
				iLocal_125 = 0;
				if (((GET_SCRIPT_TASK_STATUS(uLocal_55, 1227113341) == 1 || GET_SCRIPT_TASK_STATUS(uLocal_55, 1227113341) == 0) || GET_SCRIPT_TASK_STATUS(uLocal_55, 242628503) == 1) || GET_SCRIPT_TASK_STATUS(uLocal_55, 242628503) == 0)
				{
					CLEAR_PED_TASKS(uLocal_55);
					if (!IS_PED_IN_GROUP(uLocal_55))
					{
		...
		else if (((!IS_PED_IN_GROUP(uLocal_55) && !IS_PED_IN_ANY_VEHICLE(uLocal_55, 0)) && GET_SCRIPT_TASK_STATUS(uLocal_55, 242628503) != 1) && GET_SCRIPT_TASK_STATUS(uLocal_55, 242628503) != 0)
		{
			SET_PED_AS_GROUP_MEMBER(uLocal_55, func_67());
			SET_PED_NEVER_LEAVES_GROUP(uLocal_55, 1);
			SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uLocal_55, 0);
...
void func_72(var uParam0, bool bParam1)
{
	...
	if (!IS_PED_INJURED(uParam0))
	{
		...
		if (bParam1)
		{
			if (IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()) && IS_PED_SITTING_IN_ANY_VEHICLE(uParam0))
			{
		...
		if (!IS_PED_HEADTRACKING_ENTITY(uParam0, PLAYER_PED_ID()))
		{
			if (!bVar0)
			{
				TASK_LOOK_AT_ENTITY(uParam0, PLAYER_PED_ID(), -1, 2049, 2);
			}
		}
		else if (bVar0)
		{
			if (!IS_PED_IN_CURRENT_CONVERSATION(uParam0))
			{
...
void func_73()
{
	if (DOES_ENTITY_EXIST(uLocal_55))
	{
		if (!IS_ENTITY_DEAD(uLocal_55, 0) && !IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
		{
			...
			if (func_87("stagd_chape_3"))
			{
				...
				if (!IS_PED_INJURED(uLocal_55))
				{
					if (IS_PED_IN_ANY_VEHICLE(uLocal_55, 0))
					{
						OPEN_SEQUENCE_TASK(&uLocal_113);
						TASK_CLEAR_LOOK_AT(0);
						TASK_USE_MOBILE_PHONE_TIMED(0, 30600);
						CLOSE_SEQUENCE_TASK(uLocal_113);
						TASK_PERFORM_SEQUENCE(uLocal_55, uLocal_113);
						CLEAR_SEQUENCE_TASK(&uLocal_113);
					}
				}
			}
			if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_55, 13.5f, 13.5f, 13.5f, 0, 1, 0) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
				if (IS_PED_IN_VEHICLE(uLocal_55, GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0))
				{
					if (iLocal_49 == 0)
					{
						if (TIMERB() > 5000)
					...
					if (!bLocal_124)
					{
						...
						if (!IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_87, 150f, 150f, 150f, 0, 1, 0))
						{
							if (iLocal_303 == 0)
							{
...
int func_75()
{
	...
	func_78(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_77(&uVar0, GET_CLOCK_MONTH());
	func_76(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_81(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
		...
		if (!IS_ENTITY_DEAD(uLocal_55, 0))
		{
			if (!IS_PED_INJURED(uLocal_55))
			{
				if (!iLocal_129 && bLocal_118)
				{
					...
					if (IS_ENTITY_IN_ANGLED_AREA(uLocal_55, -2002.008f, 455.58f, 101.0381f, -2009.761f, 453.2027f, 105.9135f, 12.4375f, 0, 1, 0) || TIMERA() > 5000)
					{
						iLocal_129 = 1;
						SETTIMERA(0);
						func_52(1, 1, 1, 0, 0, 0);
						...
						uLocal_134 = CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -2014.228f, 456.4961f, 103.5524f, -6.509435f, -0.037031f, -95.98762f, 29.00143f, 0, 2);
						uLocal_135 = CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -2014.334f, 456.418f, 103.3152f, -6.198685f, -0.037031f, -100.5736f, 29.00143f, 0, 2);
						SHAKE_CAM(uLocal_134, "HAND_SHAKE", 0.25f);
						SHAKE_CAM(uLocal_135, "HAND_SHAKE", 0.25f);
						SET_CAM_ACTIVE(uLocal_134, 1);
						RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
						WAIT(1000);
						SET_CAM_ACTIVE_WITH_INTERP(uLocal_135, uLocal_134, 4000, 1, 1);
						RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
						CLEAR_AREA_OF_VEHICLES(vLocal_99, 10f, 0, 0, 0, 0, 0, 0);
						if (!IS_ENTITY_DEAD(GET_PLAYERS_LAST_VEHICLE(), 0))
						{
							REQUEST_VEHICLE_HIGH_DETAIL_MODEL(GET_PLAYERS_LAST_VEHICLE());
							if (IS_ENTITY_AT_COORD(GET_PLAYERS_LAST_VEHICLE(), vLocal_99, 8f, 8f, 8f, 0, 1, 0))
							{
								uLocal_133 = GET_PLAYERS_LAST_VEHICLE();
								SET_ENTITY_AS_MISSION_ENTITY(uLocal_133, 1, 0);
								DELETE_VEHICLE(&uLocal_133);
							}
						}
						if (!IS_ENTITY_DEAD(iLocal_59, 0))
						{
							SET_VEHICLE_DOORS_LOCKED(iLocal_59, 1);
							if (!DOES_BLIP_EXIST(uLocal_319))
							{
								uLocal_319 = func_62(iLocal_59, 0, 0);
								SET_BLIP_AS_FRIENDLY(uLocal_319, 1);
				...
				if (iLocal_129 && DOES_CAM_EXIST(uLocal_134))
				{
					if (TIMERA() > 5700 && !iLocal_317)
					{
					...
					if (TIMERA() > 6000)
					{
						...
						DISPLAY_RADAR(1);
						func_52(0, 1, 1, 0, 0, 0);
						SET_CAM_ACTIVE(uLocal_134, 0);
						RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
						DESTROY_CAM(uLocal_134, 0);
						STOP_GAMEPLAY_HINT(0);
					}
				}
				if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -2201.417f, 4296.06f, 47.5076f, 100f, 100f, 100f, 0, 1, 0))
				{
					CLEAR_AREA_OF_VEHICLES(vLocal_87, 5f, 0, 0, 0, 0, 0, 0);
				}
			}
			if (!bLocal_123)
			{
				if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_103, 100f, 100f, 100f, 0, 1, 0))
				{
					REQUEST_MODEL(joaat("ig_bestmen"));
					if (HAS_MODEL_LOADED(joaat("ig_bestmen")))
					{
						uLocal_57 = CREATE_PED(4, joaat("ig_bestmen"), -2202.747f, 4299.008f, 47.4293f, 73.0028f, 1, 1);
						func_90(&uLocal_136, 4, uLocal_57, "BESTMAN", 0, 1);
						SET_PED_COMPONENT_VARIATION(uLocal_57, 0, 0, 0, 0);
						SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_57, 1862763509);
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_57, 1);
						SET_PED_CONFIG_FLAG(uLocal_57, 185, 1);
						OPEN_SEQUENCE_TASK(&uLocal_113);
						TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), -1);
						TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), -1, 2048, 2);
						CLOSE_SEQUENCE_TASK(uLocal_113);
						TASK_PERFORM_SEQUENCE(uLocal_57, uLocal_113);
						CLEAR_SEQUENCE_TASK(&uLocal_113);
						bLocal_123 = true;
					}
				}
			...
			if (!bLocal_124)
			{
				if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_77, 20f, 20f, 20f, 0, 1, 0))
				{
					func_21();
					if (!func_65())
					{
			...
			if (((IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_70, vLocal_73, fLocal_76, 0, 1, 0) && IS_ENTITY_IN_ANGLED_AREA(uLocal_55, vLocal_70, vLocal_73, fLocal_76, 0, 1, 0)) || (IS_ENTITY_AT_COORD(uLocal_55, vLocal_67, 0f, 0f, 2f, 1, 1, 0) && func_60(1, 0, 1))) || bLocal_118)
			{
				switch (iLocal_49)
				{
					case 0:
						...
						if (!bLocal_118)
						{
							...
							if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
							{
								if (!IS_ENTITY_DEAD(GET_PLAYERS_LAST_VEHICLE(), 0))
								{
									_SET_VEHICLE_HALT(GET_PLAYERS_LAST_VEHICLE(), 10.5f, 4, 0);
								}
							}
							if (!IS_ENTITY_DEAD(iLocal_59, 0))
							{
								iVar2 = _0x19CAFA3C87F7C2FF();
								if (iVar2 != 0)
								{
									iVar3 = _0xEE778F8C7E1142E2(iVar2);
									if (iVar3 == 4)
									{
										TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), uLocal_55, 5000, 0, 2);
									}
									else
									{
										TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), iLocal_59, 5000, 2052, 4);
										SET_GAMEPLAY_VEHICLE_HINT(iLocal_59, 0f, 0f, 0f, 1, -1, 3000, 2000);
									}
								}
							}
							func_21();
							if (!func_65())
							{
								...
								if (!IS_PED_INJURED(uLocal_55))
								{
									CLEAR_PED_TASKS(uLocal_55);
									OPEN_SEQUENCE_TASK(&uLocal_113);
									TASK_FOLLOW_NAV_MESH_TO_COORD(0, -2013.094f, 460.3515f, 101.8024f, 2f, 20000, 1048576000, 0, 1193033728);
									TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_99, 3f, 20000, 1048576000, 0, 1193033728);
									TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), -1);
									TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), -1, 2048, 2);
									CLOSE_SEQUENCE_TASK(uLocal_113);
									TASK_PERFORM_SEQUENCE(uLocal_55, uLocal_113);
						...
						if (!IS_PED_INJURED(uLocal_55) && !IS_ENTITY_DEAD(iLocal_59, 0))
						{
							if ((bLocal_118 && IS_ENTITY_AT_COORD(uLocal_55, vLocal_99, 1f, 1f, 1f, 0, 1, 0)) && !IS_PED_IN_ANY_VEHICLE(uLocal_55, 0))
							{
								if (IS_PED_IN_GROUP(uLocal_55))
								{
									if (!func_65())
								...
								if (IS_ENTITY_OCCLUDED(uLocal_55))
								{
									if (!IS_PED_INJURED(uLocal_55))
									{
										SET_ENTITY_VISIBLE(uLocal_55, 0, 0);
										SET_ENTITY_COLLISION(uLocal_55, 0, 0);
										SET_ENTITY_INVINCIBLE(uLocal_55, 1);
										FREEZE_ENTITY_POSITION(uLocal_55, 1);
									}
									if (TIMERA() > 15000)
									{
										if (!IS_PED_INJURED(uLocal_55))
										{
											SET_PED_COMPONENT_VARIATION(uLocal_55, 2, 1, 0, 0);
											SET_PED_COMPONENT_VARIATION(uLocal_55, 0, 0, 1, 0);
											SET_PED_COMPONENT_VARIATION(uLocal_55, 3, 1, 0, 0);
											SET_PED_COMPONENT_VARIATION(uLocal_55, 4, 1, 0, 0);
											SET_PED_COMPONENT_VARIATION(uLocal_55, 11, 0, 0, 0);
											SET_ENTITY_VISIBLE(uLocal_55, 1, 0);
											SET_ENTITY_COLLISION(uLocal_55, 1, 0);
											SET_ENTITY_INVINCIBLE(uLocal_55, 0);
											FREEZE_ENTITY_POSITION(uLocal_55, 0);
											SET_ENTITY_COORDS(uLocal_55, vLocal_99, 1, 0, 0, 1);
											SET_ENTITY_HEADING(uLocal_55, 106.5078f);
											SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uLocal_55, 0);
											SET_PED_COMBAT_ATTRIBUTES(uLocal_55, 17, 1);
											SET_PED_STAY_IN_VEHICLE_WHEN_JACKED(uLocal_55, 1);
											TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), uLocal_55, -1, 2048, 4);
											if (!IS_ENTITY_DEAD(iLocal_59, 0))
											{
												OPEN_SEQUENCE_TASK(&uLocal_113);
												TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), -1, 2052, 4);
												TASK_ENTER_VEHICLE(0, iLocal_59, -1, 0, 2f, 1, 0);
												CLOSE_SEQUENCE_TASK(uLocal_113);
												TASK_PERFORM_SEQUENCE(uLocal_55, uLocal_113);
												CLEAR_SEQUENCE_TASK(&uLocal_113);
											}
					...
					case 1:
						if (!IS_PED_INJURED(uLocal_55) && !IS_ENTITY_DEAD(iLocal_59, 0))
						{
							if (IS_ENTITY_AT_ENTITY(uLocal_55, iLocal_59, 5f, 5f, 5f, 0, 1, 0) && !iLocal_128)
							{
							...
							if (IS_PED_IN_ANY_VEHICLE(uLocal_55, 0))
							{
								...
								else
								{
									...
									if (iLocal_308 != 0 && GET_GAME_TIMER() > iLocal_308 + 6000)
									{
					...
					case 2:
						if (!bLocal_118)
						{
							...
							if (func_4(&uLocal_136, "stagdau", "stagd_hairc", 4, 0, 0, 0))
							{
								if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
								{
									if (!IS_ENTITY_DEAD(GET_PLAYERS_LAST_VEHICLE(), 0))
									{
										uLocal_132 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
										_SET_VEHICLE_HALT(GET_PLAYERS_LAST_VEHICLE(), 10.5f, 2, 0);
									}
								}
								if (!IS_PED_INJURED(uLocal_57) && !IS_PED_INJURED(uLocal_55))
								{
									if (IS_PED_IN_ANY_VEHICLE(uLocal_55, 0))
									{
										uLocal_132 = GET_VEHICLE_PED_IS_IN(uLocal_55, 0);
										OPEN_SEQUENCE_TASK(&uLocal_113);
										TASK_ENTER_VEHICLE(0, uLocal_132, -1, 2, 1f, 1, 0);
										TASK_CLEAR_LOOK_AT(0);
										CLOSE_SEQUENCE_TASK(uLocal_113);
										TASK_PERFORM_SEQUENCE(uLocal_57, uLocal_113);
										SET_PED_CONFIG_FLAG(uLocal_57, 185, 0);
									}
									else
									{
										TASK_GO_TO_ENTITY(uLocal_57, uLocal_55, -1, 8f, 1073741824, 1073741824, 0);
									}
									if (!DOES_BLIP_EXIST(uLocal_322))
									{
						...
						if (bLocal_118 && !IS_PED_INJURED(uLocal_55))
						{
							if (GET_SCRIPT_TASK_STATUS(uLocal_55, 242628503) == 7 || TIMERA() > 12000)
							{
								vLocal_67 = { vLocal_77 };
								vLocal_70 = { vLocal_80 };
								vLocal_73 = { vLocal_83 };
								...
								{
									uLocal_56 = CREATE_PED(5, joaat("ig_bride"), -330.36f, 6154.03f, 30.8f, 90f, 1, 1);
									SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_56, 1);
									OPEN_SEQUENCE_TASK(&uLocal_113);
									TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), -1);
									CLOSE_SEQUENCE_TASK(uLocal_113);
									TASK_PERFORM_SEQUENCE(uLocal_56, uLocal_113);
									CLEAR_SEQUENCE_TASK(&uLocal_113);
									uLocal_58 = CREATE_PED(4, joaat("ig_bestmen"), -333.3692f, 6157.644f, 30.489f, 83.2763f, 1, 1);
									SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_58, 1);
									TASK_TURN_PED_TO_FACE_ENTITY(uLocal_58, PLAYER_PED_ID(), -1);
									SET_PED_COMPONENT_VARIATION(uLocal_58, 0, 1, 0, 0);
									uLocal_60[0] = CREATE_VEHICLE(joaat("washington"), -342.1295f, 6141.404f, 30.4839f, 133.4604f, 1, 1, 0);
									uLocal_60[1] = CREATE_VEHICLE(joaat("baller2"), -338.3777f, 6137.41f, 30.476f, 135.6866f, 1, 1, 0);
									uLocal_60[2] = CREATE_VEHICLE(joaat("primo"), -329.4687f, 6143.247f, 30.4893f, 313.82f, 1, 1, 0);
									uLocal_60[3] = CREATE_VEHICLE(joaat("washington"), -322.3235f, 6135.427f, 30.4924f, 316.5898f, 1, 1, 0);
									SET_VEHICLE_COLOURS(uLocal_60[0], GET_RANDOM_INT_IN_RANGE(0, 127), 0);
									SET_VEHICLE_COLOURS(uLocal_60[1], GET_RANDOM_INT_IN_RANGE(0, 127), 0);
									SET_VEHICLE_COLOURS(uLocal_60[2], GET_RANDOM_INT_IN_RANGE(0, 127), 0);
									SET_VEHICLE_COLOURS(uLocal_60[3], GET_RANDOM_INT_IN_RANGE(0, 127), 0);
									iLocal_49 = 3;
									bLocal_118 = false;
									iLocal_130 = 0;
								}
...
void func_91()
{
	if ((iLocal_310 && iLocal_307 != func_74(func_75())) && !DOES_CAM_EXIST(uLocal_134))
	{
	...
	if (iLocal_307 == func_74(func_75()))
	{
		...
		if (!func_65())
		{
			...
			if (!IS_PED_INJURED(uLocal_55))
			{
				TASK_USE_MOBILE_PHONE(uLocal_55, 1, 1);
			}
			if (!IS_PED_INJURED(uLocal_56))
			{
				TASK_SMART_FLEE_PED(uLocal_56, PLAYER_PED_ID(), 300f, -1, 0, 0);
			}
			if (!IS_PED_INJURED(uLocal_58))
			{
				TASK_SMART_FLEE_PED(uLocal_58, PLAYER_PED_ID(), 300f, -1, 0, 0);
			}
			WAIT(8500);
			if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
				if (!IS_ENTITY_DEAD(GET_PLAYERS_LAST_VEHICLE(), 0))
				{
					_SET_VEHICLE_HALT(GET_PLAYERS_LAST_VEHICLE(), 10.5f, 3, 0);
				}
			}
			WAIT(2000);
			if (!IS_ENTITY_DEAD(uLocal_55, 0))
			{
				CLEAR_PED_TASKS(uLocal_55);
				TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), uLocal_55, 5000, 2048, 2);
				TASK_LOOK_AT_ENTITY(uLocal_55, PLAYER_PED_ID(), 5000, 2048, 2);
				TASK_LEAVE_ANY_VEHICLE(uLocal_55, 0, 0);
				REMOVE_PED_FROM_GROUP(uLocal_55);
			}
			if (!IS_ENTITY_DEAD(uLocal_57, 0))
			{
				TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), uLocal_55, 5000, 0, 2);
				TASK_LEAVE_ANY_VEHICLE(uLocal_57, 500, 0);
			}
			WAIT(1000);
			if (!IS_ENTITY_DEAD(iLocal_59, 0))
			{
			...
			if (!IS_ENTITY_DEAD(uLocal_55, 0) && !IS_ENTITY_DEAD(GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				OPEN_SEQUENCE_TASK(&uLocal_113);
				if (GET_PLAYERS_LAST_VEHICLE() == iLocal_59)
				{
					TASK_ENTER_VEHICLE(0, iLocal_59, -1, -1, 1f, 8, 0);
					TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_59, PLAYER_PED_ID(), 8, 15f, 786469, 10f, 10f, 1);
				}
				else
				{
				...
				if (!IS_ENTITY_DEAD(uLocal_57, 0))
				{
					...
					if (GET_PLAYERS_LAST_VEHICLE() == iLocal_59)
					{
						TASK_ENTER_VEHICLE(0, iLocal_59, -1, 0, 1073741824, 1, 0);
						TASK_PAUSE(0, 100000);
					}
					else
					{
...
void func_99()
{
	if (!IS_PED_INJURED(uLocal_55))
	{
		if (!IS_ENTITY_DEAD(iLocal_59, 0) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if (IS_PED_IN_VEHICLE(uLocal_55, iLocal_59, 0) && HAS_ENTITY_COLLIDED_WITH_ANYTHING(iLocal_59))
			{
				if (!func_65())
				{
					if (func_100())
			...
			else if (IS_PED_IN_VEHICLE(uLocal_55, GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0) && HAS_ENTITY_COLLIDED_WITH_ANYTHING(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)))
			{
				if (!func_65())
				{
					func_4(&uLocal_136, "stagdau", "stagd_bump1", 4, 0, 0, 0);
...
void func_101()
{
	if (!IS_PED_INJURED(uLocal_55))
	{
		SET_PED_CAN_PLAY_AMBIENT_BASE_ANIMS(uLocal_55, 0);
	}
	if (!IS_PED_INJURED(uLocal_57))
	{
		SET_PED_CAN_PLAY_AMBIENT_BASE_ANIMS(uLocal_57, 0);
	}
	if (((((IS_ENTITY_AT_ENTITY(uLocal_55, PLAYER_PED_ID(), 4f, 4f, 4f, 0, 1, 0) || iLocal_49 == 1) || iLocal_126) || iLocal_127) || iLocal_125) || bLocal_118)
	{
		if ((((((iLocal_49 >= 2 && iLocal_120) && iLocal_49 != 1) && !iLocal_126) && !iLocal_127) && !iLocal_125) && !bLocal_118)
		{
			if (IS_ENTITY_AT_ENTITY(uLocal_57, PLAYER_PED_ID(), 4f, 4f, 4f, 0, 1, 0))
			{
				if (func_103())
				{
					func_102(0);
...
void func_104()
{
	...
	else
	{
		if (!IS_PED_INJURED(uLocal_55))
		{
			...
			if (DOES_ENTITY_EXIST(uLocal_66))
			{
				DETACH_ENTITY(uLocal_66, 1, 1);
			}
		}
		while (func_65())
		{
...
void func_105()
{
	if (!IS_PED_INJURED(PLAYER_PED_ID()) && !IS_PED_INJURED(uLocal_55))
	{
		if (!iLocal_115)
		{
			if ((IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_55, 130f, 60f, 50f, 0, 1, 0) && !IS_ENTITY_OCCLUDED(uLocal_55)) || IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_55, 10f, 10f, 10f, 0, 1, 0))
			{
				if (!DOES_BLIP_EXIST(uLocal_321))
				{
					uLocal_321 = func_64(uLocal_55, 0, 145);
					_0x75A16C3DA34F1245(uLocal_321, 0);
					TASK_LOOK_AT_ENTITY(uLocal_55, PLAYER_PED_ID(), -1, 2052, 4);
				}
				if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_55, 10f, 10f, 10f, 0, 1, 0))
				{
					if (DOES_BLIP_EXIST(uLocal_321))
					{
						_0x75A16C3DA34F1245(uLocal_321, 1);
					}
					SETTIMERB(0);
					func_92();
					while (func_65())
			...
			if (!IS_PED_INJURED(PLAYER_PED_ID()) && !IS_PED_INJURED(uLocal_55))
			{
				if ((!func_143() && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1131.777f, 2636.418f, 15.589f, -1040.995f, 2717.077f, 31.715f, 60.75f, 0, 1, 0)) && DOES_BLIP_EXIST(uLocal_321))
				{
					if (!func_65())
					{
					...
					if (!IS_ENTITY_DEAD(GET_PLAYERS_LAST_VEHICLE(), 0))
					{
						iLocal_65 = GET_PLAYERS_LAST_VEHICLE();
					}
					func_106(1);
				}
			}
		...
		else if (!iLocal_301)
		{
			if (!IS_PED_INJURED(uLocal_55))
			{
				if (!IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_55, 25f, 25f, 25f, 0, 1, 0))
				{
					func_21();
					WAIT(0);
...
int func_110()
{
	switch (func_111(&Global_25824, 0, 5, 0, GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
void func_116()
{
	if (DOES_ENTITY_EXIST(uLocal_55))
	{
		if (!IS_PED_INJURED(uLocal_55))
		{
			if (IS_EXPLOSION_IN_SPHERE(-1, GET_ENTITY_COORDS(uLocal_55, 1), 3f))
			{
				CLEAR_PED_TASKS_IMMEDIATELY(uLocal_55);
				SET_ENTITY_HEALTH(uLocal_55, 99, 0);
			}
			if (!IS_ENTITY_DEAD(GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				...
				{
					FREEZE_ENTITY_POSITION(uLocal_55, 0);
					if (IS_ENTITY_TOUCHING_ENTITY(GET_PLAYERS_LAST_VEHICLE(), uLocal_55))
					{
						CLEAR_PED_TASKS_IMMEDIATELY(uLocal_55);
						SET_ENTITY_HEALTH(uLocal_55, 99, 0);
					}
			...
			if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_55, 2f, 2f, 2f, 0, 1, 0))
			{
				if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
					if (func_60(1, 0, 1))
					{
						if (!iLocal_311)
						{
							...
							if (!IS_PED_INJURED(uLocal_55))
							{
								CLEAR_AREA(GET_ENTITY_COORDS(uLocal_55, 1), 5f, 1, 0, 0, 0);
								REMOVE_PARTICLE_FX_IN_RANGE(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 5f);
							}
							if (!IS_ENTITY_DEAD(GET_PLAYERS_LAST_VEHICLE(), 0))
							{
								if (IS_ENTITY_AT_ENTITY(GET_PLAYERS_LAST_VEHICLE(), uLocal_55, 5f, 5f, 5f, 0, 1, 0))
								{
									SET_ENTITY_COORDS(GET_PLAYERS_LAST_VEHICLE(), GET_ENTITY_COORDS(uLocal_55, 1) - Vector(1.5f, 4f, 3f), 1, 0, 0, 1);
									SET_VEHICLE_ON_GROUND_PROPERLY(GET_PLAYERS_LAST_VEHICLE(), 1084227584);
								}
							}
							if (!IS_PED_INJURED(uLocal_55))
							{
								uLocal_318 = CREATE_SYNCHRONIZED_SCENE(-935.57f, 2767.616f, 24.448f, 2.433f, 0.152f, 53.743f, 2);
								uLocal_134 = CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
								SET_SYNCHRONIZED_SCENE_PHASE(uLocal_318, 0.158f);
								PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_134, uLocal_318, "untie_cam", "re@stag_do@");
								CLEAR_PED_TASKS_IMMEDIATELY(PLAYER_PED_ID());
								CLEAR_PED_TASKS_IMMEDIATELY(uLocal_55);
								TASK_SYNCHRONIZED_SCENE(uLocal_55, uLocal_318, "re@stag_do@", "untie_ped", 1000f, -1000f, 4, 0, 1148846080, 0);
								_0x2208438012482A1A(uLocal_55, 0, 0);
								TASK_SYNCHRONIZED_SCENE(PLAYER_PED_ID(), uLocal_318, "re@stag_do@", "untie_player", 1000f, -1000f, 0, 0, 1148846080, 0);
	...
	if (iLocal_311 && !iLocal_312)
	{
		if (!iLocal_316)
		{
			if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_318) > 0.2f && GET_SYNCHRONIZED_SCENE_PHASE(uLocal_318) < 0.3f)
			{
				PLAY_SOUND_FROM_ENTITY(-1, "ROPE_CUT", PLAYER_PED_ID(), "ROPE_CUT_SOUNDSET", 0, 0);
				iLocal_316 = 1;
			}
		}
		if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_318) > 0.4647059f && !iLocal_317)
		{
		...
		if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_318) > 0.5f)
		{
			iLocal_312 = 1;
		}
		if (func_117(1000))
	...
	if (iLocal_312 && !iLocal_314)
	{
		...
		CLEAR_PED_TASKS_IMMEDIATELY(PLAYER_PED_ID());
		SET_ENTITY_COORDS(PLAYER_PED_ID(), -936.6537f, 2767.497f, 24.4289f, 1, 0, 0, 1);
		...
		if (!IS_PED_INJURED(uLocal_55))
		{
			FREEZE_ENTITY_POSITION(uLocal_55, 0);
			CLEAR_PED_TASKS_IMMEDIATELY(uLocal_55);
			SET_PED_CAN_RAGDOLL(uLocal_55, 1);
			SET_ENTITY_COORDS(uLocal_55, -935.6716f, 2767.772f, 24.4289f, 1, 0, 0, 1);
			SET_ENTITY_HEADING(uLocal_55, 136.9073f);
			_0x2208438012482A1A(uLocal_55, 0, 0);
		}
		if (iLocal_315)
		{
	...
	if (iLocal_314 && !IS_PED_INJURED(uLocal_55))
	{
		if (IS_VEHICLE_DRIVEABLE(GET_PLAYERS_LAST_VEHICLE(), 0))
		{
			if ((((((IS_ENTITY_AT_ENTITY(uLocal_55, GET_PLAYERS_LAST_VEHICLE(), 20f, 20f, 20f, 0, 1, 0) && GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(GET_PLAYERS_LAST_VEHICLE()) >= 1) && !IS_THIS_MODEL_A_BOAT(GET_ENTITY_MODEL(GET_PLAYERS_LAST_VEHICLE()))) && !IS_THIS_MODEL_A_HELI(GET_ENTITY_MODEL(GET_PLAYERS_LAST_VEHICLE()))) && !IS_THIS_MODEL_A_PLANE(GET_ENTITY_MODEL(GET_PLAYERS_LAST_VEHICLE()))) && !IS_THIS_MODEL_A_TRAIN(GET_ENTITY_MODEL(GET_PLAYERS_LAST_VEHICLE()))) && GET_ENTITY_MODEL(GET_PLAYERS_LAST_VEHICLE()) != joaat("rhino"))
			{
				OPEN_SEQUENCE_TASK(&uLocal_113);
			...
			else if (!IS_PED_IN_GROUP(uLocal_55))
			{
				SET_PED_AS_GROUP_MEMBER(uLocal_55, func_67());
				SET_PED_NEVER_LEAVES_GROUP(uLocal_55, 1);
				SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uLocal_55, 0);
...
void func_119()
{
	if (!IS_PED_INJURED(uLocal_55))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			{
				SET_ENTITY_AS_MISSION_ENTITY(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 1, 0);
			}
		}
		uLocal_133 = GET_RANDOM_VEHICLE_IN_SPHERE(GET_ENTITY_COORDS(uLocal_55, 0), 30f, 0, 4);
		if (!IS_ENTITY_DEAD(uLocal_133, 0))
		{
			if (!IS_VEHICLE_SEAT_FREE(uLocal_133, -1, 0))
			{
				if (IS_ENTITY_AT_ENTITY(uLocal_133, uLocal_55, 30f, 30f, 30f, 0, 1, 0))
				{
					SET_ENTITY_AS_MISSION_ENTITY(uLocal_133, 1, 0);
					if (IS_VEHICLE_DRIVEABLE(uLocal_133, 0))
					{
						START_VEHICLE_HORN(uLocal_133, 3000, 0, 0);
						if (!IS_PED_INJURED(uLocal_55))
						{
				...
				{
					SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_133);
				}
			}
		}
	}
...
void func_121()
{
	...
	while ((!HAS_ANIM_DICT_LOADED("re@stag_do@") || !HAS_ANIM_DICT_LOADED("re@stag_do@idle_a")) || !REQUEST_SCRIPT_AUDIO_BANK("ROPE_CUT", 0, -1))
	{
		WAIT(0);
	}
	uLocal_55 = CREATE_PED(26, joaat("u_m_y_staggrm_01"), -935.57f, 2767.616f, 24.448f, 140.5f, 1, 1);
	SET_AMBIENT_VOICE_NAME(uLocal_55, "GROOM");
	SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_55, 1862763509);
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_55, 1);
	SET_PED_MONEY(uLocal_55, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_55, 2, 0, 0, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_55, 0, 0, 0, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_55, 3, 0, 0, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_55, 4, 0, 0, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_55, 11, 1, 0, 0);
	TASK_SET_DECISION_MAKER(uLocal_55, -1143637011);
	SET_PED_COMBAT_MOVEMENT(uLocal_55, 3);
	SET_PED_CONFIG_FLAG(uLocal_55, 206, 1);
	SET_PED_CONFIG_FLAG(uLocal_55, 134, 1);
	uLocal_66 = CREATE_OBJECT(joaat("prop_stag_do_rope"), GET_ENTITY_COORDS(uLocal_55, 1), 1, 1, 0);
	ATTACH_ENTITY_TO_ENTITY(uLocal_66, uLocal_55, GET_PED_BONE_INDEX(uLocal_55, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	iLocal_59 = CREATE_VEHICLE(joaat("superd"), -2009.015f, 455.3556f, 101.6528f, 274.8103f, 0, 0, 0);
	SET_VEHICLE_HAS_STRONG_AXLES(iLocal_59, 1);
	SET_VEHICLE_DIRT_LEVEL(iLocal_59, 0f);
	SET_VEHICLE_DOORS_LOCKED(iLocal_59, 3);
	SET_VEHICLE_MOD_KIT(iLocal_59, 0);
	SET_VEHICLE_MOD_COLOR_1(iLocal_59, 0, 73, 0);
	SET_VEHICLE_MOD_COLOR_2(iLocal_59, 2, 48);
	SET_VEHICLE_MOD(iLocal_59, 11, 1, 0);
	SET_VEHICLE_MOD(iLocal_59, 12, 1, 0);
	REQUEST_VEHICLE_ASSET(joaat("superd"), 3);
	SET_ENTITY_LOD_DIST(iLocal_59, 10000);
	SET_VEHICLE_LOD_MULTIPLIER(iLocal_59, 5f);
	ADD_VEHICLE_UPSIDEDOWN_CHECK(iLocal_59);
	...
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("superd"), 1);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_87 - Vector(10f, 10f, 10f), vLocal_87 + Vector(10f, 10f, 10f), 0, 1);
	ADD_SCENARIO_BLOCKING_AREA(vLocal_87 - Vector(20f, 20f, 20f), vLocal_87 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
	ADD_SCENARIO_BLOCKING_AREA(GET_ENTITY_COORDS(uLocal_55, 0) - Vector(10f, 10f, 10f), GET_ENTITY_COORDS(uLocal_55, 0) + Vector(10f, 10f, 10f), 0, 1, 1, 1);
	ADD_SCENARIO_BLOCKING_AREA(Vector(101.6406f, 455.1994f, -2007.751f) - Vector(15f, 15f, 15f), Vector(101.6406f, 455.1994f, -2007.751f) + Vector(15f, 15f, 15f), 0, 1, 1, 1);
	ADD_SCENARIO_BLOCKING_AREA(Vector(47.4293f, 4299.008f, -2202.747f) - Vector(15f, 25f, 25f), Vector(47.4293f, 4299.008f, -2202.747f) + Vector(15f, 25f, 25f), 0, 1, 1, 1);
	CLEAR_AREA_OF_PEDS(GET_ENTITY_COORDS(uLocal_55, 1), 10f, 0);
	if (!IS_ENTITY_DEAD(uLocal_55, 0))
	{
		OPEN_SEQUENCE_TASK(&uLocal_113);
		TASK_PLAY_ANIM(0, "re@stag_do@idle_a", "idle_a_ped", 8f, -8f, -1, 9, 0, 0, 0, 0);
		CLOSE_SEQUENCE_TASK(uLocal_113);
		TASK_PERFORM_SEQUENCE(uLocal_55, uLocal_113);
		CLEAR_SEQUENCE_TASK(&uLocal_113);
		SET_PED_KEEP_TASK(uLocal_55, 1);
	...
	if (func_11() == 0)
	{
		func_90(&uLocal_136, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
	}
	if (func_11() == 1)
	{
		func_90(&uLocal_136, 0, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	if (func_11() == 2)
	{
		func_90(&uLocal_136, 0, PLAYER_PED_ID(), "TREVOR", 0, 1);
	}
...
int func_129(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_34() == 0)
		{
			return IS_BIT_SET(func_126(func_127(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_130()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		if (VMAG2(GET_ENTITY_VELOCITY(PLAYER_PED_ID())) > 1369f && !func_141())
		{
			return 0;
		}
	}
...
int func_143()
{
	if ((Global_106554 == func_48() && GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_168()) || Global_105612) || Global_25767) || func_167()) || func_18(8, -1)) || func_166()) || func_165()) || func_164()) || func_163()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_168()) || Global_25767) || func_167()) || func_18(8, -1)) || func_164()) || func_166()) || func_165()) || func_163()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_168()) || Global_105612) || Global_25767) || func_167()) || func_18(8, -1)) || func_164()) || func_166()) || func_165()) || func_163()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_168()) || Global_105612) || Global_25767) || func_167()) || func_18(8, -1)) || func_166()) || func_165()) || func_163()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_168() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_18(8, -1)) || func_163()) || func_162()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_168()) || Global_25767) || func_167()) || func_18(8, -1)) || func_165()) || func_164()) || func_163()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_168()) || Global_105612) || Global_25767) || func_167()) || func_18(8, -1)) || func_164()) || func_162()) || func_166()) || func_165()) || func_163())
						{
							return 0;
						}
						break;
...
void func_177()
{
	...
	{
		func_213(0);
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_87 - Vector(10f, 10f, 10f), vLocal_87 + Vector(10f, 10f, 10f), 1, 1);
		REMOVE_SCENARIO_BLOCKING_AREAS();
		func_21();
		RESET_WANTED_LEVEL_DIFFICULTY(PLAYER_ID());
		if (!IS_ENTITY_DEAD(iLocal_65, 0))
		{
			if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_65, 0) && !IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_65, 50f, 50f, 50f, 0, 1, 0))
			{
				func_189(iLocal_65, 0, 145);
			}
		}
		if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_87, 100f, 100f, 100f, 0, 1, 0))
		{
			if (!IS_PED_INJURED(uLocal_55) && !IS_PED_INJURED(uLocal_57))
			{
				OPEN_SEQUENCE_TASK(&uLocal_113);
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, -330.36f, 6154.03f, 31.8f, 1f, -1, 1048576000, 0, 1193033728);
				TASK_CHAT_TO_PED(0, uLocal_57, 16, 0f, 0f, 0f, 0f, 0f);
				CLOSE_SEQUENCE_TASK(uLocal_113);
				TASK_PERFORM_SEQUENCE(uLocal_55, uLocal_113);
				CLEAR_SEQUENCE_TASK(&uLocal_113);
				OPEN_SEQUENCE_TASK(&uLocal_113);
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, -330.36f, 6155.03f, 31.8f, 1f, -1, 1048576000, 0, 1193033728);
				TASK_CHAT_TO_PED(0, uLocal_55, 16, 0f, 0f, 0f, 0f, 0f);
				CLOSE_SEQUENCE_TASK(uLocal_113);
				TASK_PERFORM_SEQUENCE(uLocal_57, uLocal_113);
				CLEAR_SEQUENCE_TASK(&uLocal_113);
			}
		...
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_133);
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_59);
		...
		if (!IS_PED_INJURED(uLocal_55))
		{
			SET_PED_CONFIG_FLAG(uLocal_55, 317, 1);
			if (!IS_ENTITY_ATTACHED(uLocal_55))
			{
				FREEZE_ENTITY_POSITION(uLocal_55, 0);
			}
			REMOVE_PED_FROM_GROUP(uLocal_55);
		...
		else if (DOES_ENTITY_EXIST(uLocal_66))
		{
			DETACH_ENTITY(uLocal_66, 1, 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&uLocal_55);
		if (!IS_PED_INJURED(uLocal_57))
		{
			SET_PED_CONFIG_FLAG(uLocal_57, 317, 1);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_57, 0);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&uLocal_57);
		if (!IS_PED_INJURED(uLocal_56))
		{
		...
		if (!IS_PED_INJURED(uLocal_58))
		{
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_58, 0);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&uLocal_56);
	}
	func_178(-1);
	TERMINATE_THIS_THREAD();
}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_192(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_211(iParam0, 0, 0)) || func_211(iParam0, 1, 0)) || func_211(iParam0, 2, 0)) || func_210(iParam0) != 145) || func_209(iParam0)) || func_208(iParam0)) || func_207(iParam0)) || func_206(iParam0)) || !func_197(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_208(iParam0))
		{
		}
