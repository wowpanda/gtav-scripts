...
void __EntryFunction__()
{
	...
	{
		SYSTEM::WAIT(0);
		if (TASK::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || bLocal_80)
		{
			if (!func_143())
			{
				if (func_142())
				...
				case 1:
					...
					else
					{
						...
						if (func_3())
						{
							if (!PED::IS_PED_INJURED(iLocal_51))
							{
								BRAIN::TASK_SMART_FLEE_PED(iLocal_51, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
							}
							if (!PED::IS_PED_INJURED(iLocal_53))
							{
								BRAIN::TASK_SMART_FLEE_PED(iLocal_53, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
							}
							if (!PED::IS_PED_INJURED(iLocal_52))
							{
								BRAIN::TASK_SMART_FLEE_PED(iLocal_52, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
							}
							if (!PED::IS_PED_INJURED(iLocal_54))
							{
								BRAIN::TASK_SMART_FLEE_PED(iLocal_54, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
							}
							func_2();
						}
					}
...
void func_42(void fParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
						...
						if (!bLocal_82)
						{
							...
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_55, 0))
							{
								...
								if (iVar2 != 0)
								{
									...
									if (iVar3 == 4)
									{
										BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_51, 5000, 0, 2);
									}
									else
									{
										BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 5000, 2052, 4);
							...
							if (!func_65())
							{
								...
								if (!PED::IS_PED_INJURED(iLocal_51))
								{
									BRAIN::CLEAR_PED_TASKS(iLocal_51);
									BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
									BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -2013.094f, 460.3515f, 101.8024f, 2f, 20000, 0.25f, 0, 1193033728);
									BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_71, 3f, 20000, 0.25f, 0, 1193033728);
									BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
									BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
									BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
									BRAIN::TASK_PERFORM_SEQUENCE(iLocal_51, iLocal_77);
								...
								if (ENTITY::IS_ENTITY_OCCLUDED(iLocal_51))
								{
									...
									if (SYSTEM::TIMERA() > 15000)
									{
										if (!PED::IS_PED_INJURED(iLocal_51))
										{
											...
											BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_51, -1, 2048, 4);
											if (!ENTITY::IS_ENTITY_DEAD(iLocal_55, 0))
											{
												BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
												BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2052, 4);
												BRAIN::TASK_ENTER_VEHICLE(0, iLocal_55, -1, 0, 2f, 1, 0);
												BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
												BRAIN::TASK_PERFORM_SEQUENCE(iLocal_51, iLocal_77);
												BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
											}
							...
							if (func_4(&uLocal_100, "stagdau", "stagd_hairc", 4, 0, 0, 0))
							{
								...
								if (!PED::IS_PED_INJURED(iLocal_53) && !PED::IS_PED_INJURED(iLocal_51))
								{
									if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_51, 0))
									{
										...
										BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
										BRAIN::TASK_ENTER_VEHICLE(0, iLocal_96, -1, 2, 1f, 1, 0);
										BRAIN::TASK_CLEAR_LOOK_AT(0);
										BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
										BRAIN::TASK_PERFORM_SEQUENCE(iLocal_53, iLocal_77);
									...
									{
										BRAIN::TASK_GO_TO_ENTITY(iLocal_53, iLocal_51, -1, 8f, 2f, 1073741824, 0);
									}
									if (!HUD::DOES_BLIP_EXIST(iLocal_286))
									{
						...
						if (bLocal_82 && !PED::IS_PED_INJURED(iLocal_51))
						{
							if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_51, 242628503) == 7 || SYSTEM::TIMERA() > 12000)
							{
								...
								if (((STREAMING::HAS_MODEL_LOADED(joaat("ig_bride")) && STREAMING::HAS_MODEL_LOADED(joaat("washington"))) && STREAMING::HAS_MODEL_LOADED(joaat("baller2"))) && STREAMING::HAS_MODEL_LOADED(joaat("primo")))
								{
									...
									BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_54, PLAYER::PLAYER_PED_ID(), -1);
...
void func_91()
{
	...
	if (iLocal_271 == func_74(func_75()))
	{
		...
		if (!func_65())
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_52))
			{
				BRAIN::TASK_SMART_FLEE_PED(iLocal_52, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
			}
			if (!PED::IS_PED_INJURED(iLocal_54))
			{
				BRAIN::TASK_SMART_FLEE_PED(iLocal_54, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
			}
			SYSTEM::WAIT(8500);
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
			...
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_51);
				BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_51, 5000, 2048, 2);
				BRAIN::TASK_LOOK_AT_ENTITY(iLocal_51, PLAYER::PLAYER_PED_ID(), 5000, 2048, 2);
				BRAIN::TASK_LEAVE_ANY_VEHICLE(iLocal_51, 0, 0);
				PED::REMOVE_PED_FROM_GROUP(iLocal_51);
			}
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_51, 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				...
				{
					BRAIN::TASK_ENTER_VEHICLE(0, iLocal_55, -1, -1, 1f, 8, 0);
					BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_55, PLAYER::PLAYER_PED_ID(), 8, 15f, 786469, 10f, 10f, 1);
				}
				else
				{
		...
		if (!iLocal_79)
		{
			if ((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_51, 130f, 60f, 50f, 0, 1, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_51)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_51, 10f, 10f, 10f, 0, 1, 0))
			{
				if (!HUD::DOES_BLIP_EXIST(iLocal_285))
				{
					...
					BRAIN::TASK_LOOK_AT_ENTITY(iLocal_51, PLAYER::PLAYER_PED_ID(), -1, 2052, 4);
				}
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_51, 10f, 10f, 10f, 0, 1, 0))
				{
					if (HUD::DOES_BLIP_EXIST(iLocal_285))
...
void func_108(void fParam0, int iParam1)
{
...
int func_110()
{
	switch (func_111(&Global_25336, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
					...
					if (func_60(1, 0, 1))
					{
						if (!iLocal_275)
						{
							...
							if (!PED::IS_PED_INJURED(iLocal_51))
							{
								...
								BRAIN::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_282, "re@stag_do@", "untie_player", 1000f, -1000f, 0, 0, 1148846080, 0);
...
void func_121()
{
	...
	BRAIN::TASK_SET_DECISION_MAKER(iLocal_51, -1143637011);
...
int func_143()
{
	if ((Global_105209 == func_48() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_105210)
	{
		return 1;
	}
	return 0;
...
int func_147(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_170(Global_105220.f_24966.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_168()) || Global_104267) || Global_25279) || func_167()) || func_18(8, -1)) || func_166()) || func_165()) || func_164()) || func_163()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_168()) || Global_25279) || func_167()) || func_18(8, -1)) || func_164()) || func_166()) || func_165()) || func_163()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_168()) || Global_104267) || Global_25279) || func_167()) || func_18(8, -1)) || func_164()) || func_166()) || func_165()) || func_163()) || Global_105220.f_7659.f_919[iVar0] == 5) || Global_36452 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_168()) || Global_104267) || Global_25279) || func_167()) || func_18(8, -1)) || func_166()) || func_165()) || func_163()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_168() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_18(8, -1)) || func_163()) || func_162()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_168()) || Global_25279) || func_167()) || func_18(8, -1)) || func_165()) || func_164()) || func_163()) || Global_105220.f_7659.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_168()) || func_165()) || Global_104267) || Global_25279) || func_167()) || Global_37057) || func_18(8, -1)) || func_164()) || func_162()) || func_163()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_168()) || Global_104267) || Global_25279) || func_167()) || func_18(8, -1)) || func_164()) || func_162()) || func_166()) || func_165()) || func_163())
						{
							return 0;
						}
						break;
...
void func_177()
{
	if (iLocal_49)
	{
		...
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_67, 100f, 100f, 100f, false, true, 0))
		{
			...
			{
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -330.36f, 6154.03f, 31.8f, 1f, -1, 0.25f, 0, 1193033728);
				BRAIN::TASK_CHAT_TO_PED(0, iLocal_53, 16, 0f, 0f, 0f, 0f, 0f);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_51, iLocal_77);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -330.36f, 6155.03f, 31.8f, 1f, -1, 0.25f, 0, 1193033728);
