...
void func_1()//Position - 0x4F
{
	...
	if (!PED::IS_PED_INJURED(iLocal_20))
	{
		if (!Global_15EDE)
		{
			...
			{
				NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_20);
			}
			vVar0 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 0) };
			ENTITY::SET_ENTITY_HEALTH(iLocal_20, 1);
...
void func_2(int iParam0)//Position - 0x13C
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (iLocal_19 == 1)
		{
			switch (func_5(AUDIO::_0x0626A247D2405330()))
			{
				case 2:
...
int func_8(var uParam0)//Position - 0x4AF
{
	...
	while (iLocal_18 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_16248[iLocal_18]) && !PED::IS_PED_INJURED(Global_16248[iLocal_18]))
		{
			if (Global_16248[iLocal_18] != AUDIO::_0x0626A247D2405330())
			{
				if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_16248[iLocal_18]))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(Global_16248[iLocal_18], 0) || !ENTITY::IS_ENTITY_ATTACHED(Global_16248[iLocal_18]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(Global_16248[iLocal_18], 1), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 0), true) < 10f)
						{
							iLocal_19 = func_5(Global_16248[iLocal_18]);
							if ((iLocal_19 == 0 || iLocal_19 == 2) || iLocal_19 == 1)
							{
								if (iLocal_19 != func_9())
								{
									if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(Global_16248[iLocal_18], AUDIO::_0x0626A247D2405330(), 17))
									{
										if (PED::IS_PED_IN_ANY_VEHICLE(Global_16248[iLocal_18], 0))
										{
											iVar0 = PED::GET_VEHICLE_PED_IS_IN(Global_16248[iLocal_18], 0);
										}
										if ((ENTITY::DOES_ENTITY_EXIST(iVar0) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iVar0, 0)) || !ENTITY::DOES_ENTITY_EXIST(iVar0))
										{
											*uParam0 = Global_16248[iLocal_18];
											return 1;
										}
									}
								}
...
void func_10()//Position - 0x60D
{
	...
	{
		if (func_6(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			iVar0 = func_5(AUDIO::_0x0626A247D2405330());
			if (func_7(iVar0) && (!func_11(14) || Global_19A3D))
			{
