...
int func_1(int iParam0, var uParam1, vector3 vParam2, vector3 vParam3, var uParam4)//Position - 0xF3
{
	...
	while (iVar0 < 3)
	{
		...
		if (!func_27(iVar1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_162B5[iVar0]))
			{
	...
	if (Global_19E56.f_6D76[iVar3 /*29*/].f_C[iVar4] == 1)
	{
		return 0;
	}
	...
	if (Global_1591E != 8)
	{
		if (Global_1591F == 4294967295)
		{
			...
			if (func_7())
			{
				...
				if (func_6(iVar7, iVar10, iVar11, 6, func_30(), iVar3, iVar8, 10000, 4294967295, 0, 4294967295, 0, 1))
				{
					Global_1591F = MISC::GET_GAME_TIMER();
					return 1;
				}
			}
			else
			{
				...
				if (func_2(iVar7, 6, func_30(), iVar3, iVar3, iVar8, 10000, 4294967295, 4294967295, 0, 4294967295, 0))
				{
					Global_1591F = MISC::GET_GAME_TIMER();
					return 1;
				}
...
{
	if ((PED::IS_PED_DUCKING(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_IN_COVER(AUDIO::_0x0626A247D2405330(), 0)) || PED::GET_PED_STEALTH_MOVEMENT(AUDIO::_0x0626A247D2405330()))
	{
		if (ENTITY::IS_ENTITY_IN_AREA(AUDIO::_0x0626A247D2405330(), vParam0, vParam1, 0, 1, 0))
		{
			if (*uParam2 < 0)
			{
...
void func_20()//Position - 0xF5B
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_23(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_25(iVar0) && (!func_21(14) || Global_19A3D))
			{
...
int func_24(int iParam0)//Position - 0x10CD
{
	if (func_25(iParam0))
	{
		if ((Global_19E56.f_2361 || Global_3) || func_5(0))
		{
...
void func_32(var uParam0, int iParam1, var uParam2, var uParam3, vector3 vParam4, char* sParam5)//Position - 0x122A
{
	...
	{
		*uParam2 = INTERIOR::GET_INTERIOR_FROM_ENTITY(AUDIO::_0x0626A247D2405330());
	...
	if (INTERIOR::IS_VALID_INTERIOR(*uParam2) && INTERIOR::IS_INTERIOR_READY(*uParam2))
	{
		if (*uParam2 == *uParam3)
		{
			...
			if (unk_0xE11F00B4AC919F45(0, 37))
			{
				if (!Global_19E56.f_4836.f_11)
				{
					func_33("FAM_WEAPDIS", 4294967295);
					Global_19E56.f_4836.f_11 = 1;
				}
				*uParam2 = INTERIOR::GET_INTERIOR_FROM_ENTITY(AUDIO::_0x0626A247D2405330());
				if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam5))
				{
			...
			if (WEAPON::GET_CURRENT_PED_VEHICLE_WEAPON(AUDIO::_0x0626A247D2405330(), &iVar0))
			{
				if (iVar0 != joaat("weapon_unarmed") && iVar0 != joaat("object"))
				{
					WEAPON::SET_CURRENT_PED_VEHICLE_WEAPON(AUDIO::_0x0626A247D2405330(), joaat("weapon_unarmed"));
				}
			}
		}
...
{
	iParam0->f_1 = (func_36(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 4)) - fParam1);
...
float func_38(var uParam0)//Position - 0x1555
{
	if (func_40(uParam0))
	{
		...
		{
			return (func_36(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
int func_41(int iParam0, vector3 vParam1, float fParam2)//Position - 0x15B4
{
	...
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), vParam1, true) >= (100f * fParam2))
	{
		return 0;
	}
	if (Global_16C62)
...
int func_42(int iParam0)//Position - 0x15F8
{
	...
	if (MISC::GET_RANDOM_EVENT_FLAG() && Global_19E4C)
	{
		return 0;
	}
	if (!func_27(iParam0))
	...
	if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_2361.f_2[27 /*3*/], 1))
	{
		return 0;
	}
	return 1;
...
{
	return func_46(iParam0, Global_8D15);
}
...
void func_47()//Position - 0x18E2
{
	...
	func_48(&uLocal_153, 0, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
}
...
void func_50()//Position - 0x19C4
{
	...
	while (iVar0 < 1)
	{
		...
		if (iVar1 < 15)
		{
			if (Global_1590D[iVar1] != 141)
			{
				func_54(iVar1);
				Global_1590D[iVar1] = 141;
			}
			func_51(iVar1);
		}
		iVar0++;
...
void func_56(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9)//Position - 0x1C1F
{
	...
	while (iVar0 < *uParam2)
	{
		...
		if (*uParam2)[iVar0] != AUDIO::_0x0626A247D2405330()
		{
...
void func_61(int iParam0)//Position - 0x2230
{
	...
	while (iVar1 < Global_19E56.f_1DEC.f_C6)
	{
		...
		{
			func_62(Global_19E56.f_1DEC.f_89[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
{
	Global_63AF[iParam0 /*11*/].f_A = iParam1;
}
...
{
	AUDIO::STOP_STREAM();
	if ((*uParam0 == 0 && *uParam1 == 4294967295) && MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
	{
		return 0;
	}
	if (*uParam0 != 0)
...
void func_74(int iParam0)//Position - 0x3282
{
	...
	{
		if (BRAIN::GET_SCRIPT_TASK_STATUS(*iParam0, 2277090178) != 0)
		{
...
int func_77(int iParam0, char* sParam1, int iParam2)//Position - 0x33C6
{
	...
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(iParam0) && PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
		{
			if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(iParam0), 0))
			{
				return 0;
			}
		}
