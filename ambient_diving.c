...
int func_28(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (MISC::IS_BIT_SET(Global_105220.f_10020.f_108, func_33(func_34(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
			...
			if (Local_42.f_1.f_4 < Local_42.f_1.f_3)
			{
				...
				else
				{
					...
					if (!HUD::DOES_BLIP_EXIST(iLocal_55))
					{
						...
						HUD::_0x75A16C3DA34F1245(iLocal_55, false);
					}
					else
					{
					...
					if (func_63())
					{
						...
						while (iVar3 <= 3)
						{
							if (!HUD::DOES_BLIP_EXIST(iLocal_56[iVar3]))
							{
								...
								HUD::_0x75A16C3DA34F1245(iLocal_56[iVar3], false);
							}
							else
							{
