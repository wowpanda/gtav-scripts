...
void __EntryFunction__()
{
	...
	{
		SYSTEM::WAIT(0);
		if (TASK::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_58)
		{
			if (!func_189())
			{
				if (func_188())
							...
							if (func_68() || ENTITY::IS_ENTITY_DEAD(iLocal_74, 0))
							{
								if (ENTITY::DOES_ENTITY_EXIST(iLocal_73[0]))
								{
									if (!ENTITY::IS_ENTITY_DEAD(iLocal_73[0], 0))
									{
										...
										BRAIN::CLEAR_PED_TASKS(iLocal_73[0]);
										BRAIN::TASK_SMART_FLEE_PED(iLocal_73[0], PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
								...
								if (func_68() || ENTITY::IS_ENTITY_DEAD(iLocal_74, 0))
								{
									...
									if (ENTITY::DOES_ENTITY_EXIST(iLocal_73[1]))
									{
										if (!PED::IS_PED_INJURED(iLocal_73[1]))
										{
											...
											BRAIN::CLEAR_PED_TASKS(iLocal_73[1]);
											BRAIN::TASK_SMART_FLEE_PED(iLocal_73[1], PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
			...
			if (!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_74, 0) || VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(iLocal_74))
			{
				...
				if (!func_4())
				{
					if (func_61(&uLocal_140, "REDR2AU", "REDR2_LC", 4, 0, 0, 0))
					{
						...
						if (!PED::IS_PED_INJURED(iLocal_73[1]))
						{
							BRAIN::TASK_GO_TO_ENTITY(iLocal_73[1], iLocal_73[0], -1, 0f, 1f, 1073741824, 0);
							PED::SET_PED_KEEP_TASK(iLocal_73[1], true);
						}
						return 1;
					}
...
void func_37()
{
	...
	{
		func_39(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
...
void func_46(void fParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
			...
			if (iLocal_52 == 1)
			{
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1017.461f, -1259.868f, 3.9183f, -1061.891f, -1424.029f, 24.4253f, 171.75f, 0, true, 0) && CAM::IS_SPHERE_VISIBLE(vLocal_125, 1f)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_125, 15f, 15f, 15f, false, true, 0))
				{
					...
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1011.144f, -1378.79f, 4.1997f, -1039.685f, -1337.61f, 9.7035f, 37.875f, 0, true, 0))
					{
						...
						{
							func_147();
							BRAIN::TASK_PLAY_ANIM(iLocal_73[0], "random@drunk_driver_1", "drunk_argument_dd1", 2f, -2f, -1, 0, 0, 0, 0, 0);
							BRAIN::TASK_PLAY_ANIM(iLocal_73[1], "random@drunk_driver_1", "drunk_argument_dd2", 2f, -2f, -1, 0, 0, 0, 0, 0);
		...
		case 1:
			if (iLocal_103 < MISC::GET_GAME_TIMER())
			{
				if (!PED::IS_PED_INJURED(iLocal_73[0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_74, 0))
				{
					...
					BRAIN::TASK_ENTER_VEHICLE(0, iLocal_74, -1, -1, 1f, 1, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_79);
			...
			if (iLocal_52 == 2)
			{
					...
					if (!PED::IS_PED_INJURED(iLocal_73[0]))
					{
						if (PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), iLocal_73[0], 80f))
						{
							if (PED::_CAN_PED_SEE_PED(iLocal_73[0], PLAYER::PLAYER_PED_ID()))
							{
								...
								if (!PED::IS_PED_INJURED(iLocal_73[1]))
								{
									BRAIN::TASK_LOOK_AT_ENTITY(iLocal_73[1], PLAYER::PLAYER_PED_ID(), -1, 2060, 4);
								}
								SYSTEM::SETTIMERA(0);
								iLocal_53 = 4;
							}
				...
				if (iLocal_103 < MISC::GET_GAME_TIMER())
				{
					...
					if (func_61(&uLocal_140, "REDR2AU", "REDR2_DRV", 4, 0, 0, 0))
					{
						...
						{
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_79);
							BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_73[1], -1, 2060, 4);
							BRAIN::TASK_ENTER_VEHICLE(0, iLocal_74, -1, -1, 1f, 1, 0);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_79);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_73[0], iLocal_79);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_79);
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_79);
							BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_73[0], -1, 2060, 4);
							BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_73[0], 0);
							BRAIN::TASK_ENTER_VEHICLE(0, iLocal_74, -1, 0, 1f, 1, 0);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_79);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_73[1], iLocal_79);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_79);
							iLocal_59 = 0;
				...
				switch (iLocal_137)
				{
					case 0:
						if (!PED::IS_PED_INJURED(iLocal_73[0]) && !PED::IS_PED_INJURED(iLocal_73[1]))
						{
							...
							{
								AUDIO::_0xB542DE8C3D1CB210(0);
								BRAIN::TASK_LOOK_AT_ENTITY(iLocal_73[0], PLAYER::PLAYER_PED_ID(), -1, 2060, 4);
								BRAIN::TASK_LOOK_AT_ENTITY(iLocal_73[1], PLAYER::PLAYER_PED_ID(), -1, 2060, 4);
								BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_73[0], -1, 2060, 4);
						...
						if (!func_4())
						{
							...
							else
							{
								if (!PED::IS_PED_INJURED(iLocal_73[0]))
								{
									if (PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), iLocal_73[0], 80f))
									{
										BRAIN::TASK_LOOK_AT_ENTITY(iLocal_73[0], PLAYER::PLAYER_PED_ID(), 10000, 2060, 4);
										BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_73[0], 10000, 2060, 4);
										func_6();
										SYSTEM::WAIT(0);
										iLocal_137++;
									}
							...
							if (!func_4())
							{
								if (func_61(&uLocal_140, "REDR1AU", "REDR1_PLS", 4, 0, 0, 0))
								{
									...
									if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_74, 0))
									{
										...
										if (!PED::IS_PED_INJURED(iLocal_73[0]))
										{
											BRAIN::TASK_ENTER_VEHICLE(iLocal_73[0], iLocal_74, -1, 0, 1f, 1, 0);
										}
									}
									iLocal_137++;
								}
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_74, 0))
				{
					if (!PED::IS_PED_INJURED(iLocal_73[0]) && !PED::IS_PED_INJURED(iLocal_73[1]))
					{
						if (PED::IS_PED_SITTING_IN_VEHICLE(iLocal_73[0], iLocal_74) && PED::IS_PED_SITTING_IN_VEHICLE(iLocal_73[1], iLocal_74))
						{
							VEHICLE::_0x25367DE49D64CF16(iLocal_74, 1);
							BRAIN::CLEAR_PED_TASKS(iLocal_73[1]);
							BRAIN::TASK_STAND_STILL(iLocal_73[1], -1);
							PED::SET_PED_KEEP_TASK(iLocal_73[1], true);
							iLocal_53 = 5;
						}
						if (!iLocal_81)
						{
							...
							{
								BRAIN::CLEAR_PED_TASKS(iLocal_73[0]);
								BRAIN::TASK_STAND_STILL(iLocal_73[0], -1);
							}
							if (!PED::IS_PED_SITTING_IN_VEHICLE(iLocal_73[0], iLocal_74) && PED::IS_PED_SITTING_IN_VEHICLE(iLocal_73[1], iLocal_74))
							{
								BRAIN::CLEAR_PED_TASKS(iLocal_73[1]);
...
void func_71()
{
	switch (iLocal_106)
	{
		case 0:
			...
			{
				PED::REMOVE_PED_FROM_GROUP(iLocal_73[0]);
				BRAIN::TASK_LOOK_AT_ENTITY(iLocal_73[1], PLAYER::PLAYER_PED_ID(), 10000, 2060, 4);
			}
		...
		case 2:
			if (iLocal_105 < MISC::GET_GAME_TIMER())
			{
				if (!PED::IS_PED_INJURED(iLocal_73[0]))
				{
					BRAIN::TASK_GO_STRAIGHT_TO_COORD(iLocal_73[0], vLocal_70, 1f, -1, 1193033728, 1056964608);
		...
		case 3:
			if (iLocal_105 < MISC::GET_GAME_TIMER())
			{
				if (!PED::IS_PED_INJURED(iLocal_73[1]))
				{
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_73[1], vLocal_70, 1f, -1, 0.25f, 0, 1193033728);
					iLocal_106++;
				}
			}
			break;
...
void func_76(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_105220.f_20535.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_78() /*12171*/].f_7688.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_105220.f_20535.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_78() /*12171*/].f_7688.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_80(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_78() /*12171*/].f_7688.f_10, iParam0);
}
	...
	switch (iLocal_106)
	{
		...
		case 2:
			if (!PED::IS_PED_INJURED(iLocal_73[1]))
			{
				...
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_70, 1f, -1, 0.25f, 0, 1193033728);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_79);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_73[1], iLocal_79);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_79);
		...
		case 3:
			if (iLocal_105 < MISC::GET_GAME_TIMER())
			{
				if (!PED::IS_PED_INJURED(iLocal_73[0]))
				{
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_73[0], vLocal_70, 1f, -1, 0.25f, 0, 1193033728);
					iLocal_106++;
				}
			}
			break;
				...
				if (VEHICLE::IS_VEHICLE_STOPPED(iLocal_74))
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_74, 0))
					{
						if (!PED::IS_PED_INJURED(iLocal_73[0]))
						{
							BRAIN::CLEAR_PED_TASKS(iLocal_73[0]);
							PED::REMOVE_PED_FROM_GROUP(iLocal_73[0]);
							BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_73[0], 4000, 2060, 4);
						}
						if (!PED::IS_PED_INJURED(iLocal_73[1]))
						{
							BRAIN::CLEAR_PED_TASKS(iLocal_73[1]);
		...
		case 2:
			...
			if (iLocal_105 - 1000) < MISC::GET_GAME_TIMER()
			{
				if (!PED::IS_PED_INJURED(iLocal_73[0]))
				{
					...
					{
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_79);
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_70 - Vector(0f, 0f, 1f), 1f, -1, 0.25f, 0, 1193033728);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_79);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_73[0], iLocal_79);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_79);
						PED::SET_PED_KEEP_TASK(iLocal_73[0], true);
...
void func_117()
{
	...
	switch (iLocal_309)
	{
		case 0:
			if (func_121())
			{
				BRAIN::TASK_LOOK_AT_ENTITY(iLocal_73[0], iLocal_73[1], -1, 2060, 4);
				BRAIN::TASK_LOOK_AT_ENTITY(iLocal_73[1], iLocal_73[0], -1, 2060, 4);
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - iLocal_310) > 15000)
			{
				if (func_121())
				{
					BRAIN::TASK_PLAY_ANIM(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_intro_m", 2f, -2f, -1, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_intro_f", 2f, -2f, -1, 0, 0, 0, 0, 0);
					iLocal_309++;
				}
			}
			break;
		...
		case 4:
			if (func_121())
			{
				...
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_intro_m", 3))
				{
					...
					{
						BRAIN::TASK_PLAY_ANIM(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_loop_m", 2f, -2f, -1, 1, 0, 0, 0, 0);
						BRAIN::TASK_PLAY_ANIM(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_loop_f", 2f, -2f, -1, 1, 0, 0, 0, 0);
						iLocal_310 = MISC::GET_GAME_TIMER();
						iLocal_309++;
					}
				}
				...
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), PED::GET_VEHICLE_PED_IS_IN(iLocal_73[1], 0), 0))
				{
					if ((MISC::GET_GAME_TIMER() - iLocal_310) > 15000)
					{
						...
						if (!bVar3)
						{
							...
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_79);
							BRAIN::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iLocal_79);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_79);
						}
						if (func_17() == 0)
						{
				...
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), PED::GET_VEHICLE_PED_IS_IN(iLocal_73[1], 0), 0))
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_loop_m", 3))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_loop_m") > 0.9f)
						{
							...
							BRAIN::TASK_PLAY_ANIM(iLocal_73[0], "random@drunk_driver_2", "cardrunksex_outro_m", 2f, -2f, -1, 0, 0, 0, 0, 0);
							BRAIN::TASK_PLAY_ANIM(iLocal_73[1], "random@drunk_driver_2", "cardrunksex_outro_f", 2f, -2f, -1, 0, 0, 0, 0, 0);
							iLocal_309++;
						}
					}
				}
		...
		switch (iLocal_91)
		{
			...
			case 1:
				if (SYSTEM::TIMERB() > 3000 || !func_4())
				{
					...
					{
						BRAIN::CLEAR_PED_TASKS(iLocal_73[0]);
						BRAIN::TASK_PLAY_ANIM(iLocal_73[0], "random@drunk_driver_1", fLocal_94, 8f, -8f, -1, 0, 0, 0, 0, 0);
						iLocal_91++;
					}
				}
				break;
			...
			case 2:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_73[0], "random@drunk_driver_1", fLocal_94, 3))
				{
					fVar0 = ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_73[0], "random@drunk_driver_1", fLocal_94);
					...
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_73[0], "random@drunk_driver_1", fLocal_94) > 0.8f)
					{
						iLocal_91++;
					}
				}
			...
			case 3:
				...
				{
					BRAIN::TASK_PLAY_ANIM(iLocal_73[0], "random@drunk_driver_1", fLocal_93, 2f, -4f, -1, 1, 0, 0, 0, 0);
					iLocal_85 = 0;
					iLocal_91++;
				}
				break;
...
void func_130()
{
	...
	if ((iLocal_134 - iLocal_133) > 60000 && iLocal_136)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_73[0]) && !PED::IS_PED_INJURED(iLocal_73[1]))
		{
			...
			BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(iLocal_73[1], iLocal_73[0], 0f, 1f, 0f, 1f, -1, 1036831949, 1);
			func_64(iLocal_73[1], 120000, 0);
			PED::SET_PED_KEEP_TASK(iLocal_73[1], true);
			if (PED::IS_PED_IN_GROUP(iLocal_73[1]))
			{
	...
	if (iLocal_52 == 1)
	{
		if (!PED::IS_PED_INJURED(iLocal_73[0]))
		{
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (PED::IS_PED_IN_VEHICLE(iLocal_73[0], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0))
				{
					if ((!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_73[0], "random@drunk_driver_1", fLocal_93, 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_73[0], "random@drunk_driver_1", fLocal_94, 3)) && !PED::IS_PED_GETTING_INTO_A_VEHICLE(iLocal_73[0]))
					{
						BRAIN::TASK_PLAY_ANIM(iLocal_73[0], "random@drunk_driver_1", fLocal_93, 2f, -4f, -1, 1, 0, 0, 0, 0);
					}
					if (func_144())
				...
				else if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_73[0], "random@drunk_driver_1", fLocal_93, 3))
				{
			...
			else
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_73[0], 0))
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_73[0], "random@drunk_driver_1", fLocal_93, 3))
					{
						BRAIN::STOP_ANIM_PLAYBACK(iLocal_73[0], 0, 0);
					}
				}
...
void func_133(void fParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(iLocal_73[0]))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
		{
			if (!func_141())
			{
				...
				{
					BRAIN::TASK_GO_TO_ENTITY(iLocal_73[0], PLAYER::PLAYER_PED_ID(), -1, 6f, 2f, 1073741824, 0);
				}
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_73[0], 0))
				{
...
int func_152()
{
	switch (func_153(&Global_25336, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
void func_160()
{
	if (func_162())
	{
		fLocal_93 = "drunk_idle_van";
		fLocal_94 = "vomit_van";
	}
	else if (func_161())
	{
		fLocal_93 = "drunk_idle_low";
		fLocal_94 = "vomit_low";
	}
	else
	{
		fLocal_93 = "drunk_idle";
		fLocal_94 = "vomit_outside";
	}
}
...
void func_164()
{
	if (!iLocal_57)
	{
		...
		if (iLocal_52 == 1)
		{
			BRAIN::TASK_PLAY_ANIM(iLocal_73[0], "random@drunk_driver_1", "drunk_driver_stand_loop_dd1", 8f, -2f, -1, 1, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(iLocal_73[1], "random@drunk_driver_1", "drunk_driver_stand_loop_dd2", 8f, -2f, -1, 1, 0, 0, 0, 0);
...
int func_173(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_38() == 0)
		{
			return MISC::IS_BIT_SET(func_170(func_171(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_189()
{
	if ((Global_105209 == func_52() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_105210)
	{
		return 1;
	}
	return 0;
...
int func_193(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_229(Global_105220.f_24966.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_227()) || Global_104267) || Global_25279) || func_226()) || func_24(8, -1)) || func_225()) || func_224()) || func_223()) || func_222()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_227()) || Global_25279) || func_226()) || func_24(8, -1)) || func_223()) || func_225()) || func_224()) || func_222()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_227()) || Global_104267) || Global_25279) || func_226()) || func_24(8, -1)) || func_223()) || func_225()) || func_224()) || func_222()) || Global_105220.f_7659.f_919[iVar0] == 5) || Global_36452 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_227()) || Global_104267) || Global_25279) || func_226()) || func_24(8, -1)) || func_225()) || func_224()) || func_222()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_227() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_24(8, -1)) || func_222()) || func_221()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_227()) || Global_25279) || func_226()) || func_24(8, -1)) || func_224()) || func_223()) || func_222()) || Global_105220.f_7659.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_227()) || func_224()) || Global_104267) || Global_25279) || func_226()) || Global_37057) || func_24(8, -1)) || func_223()) || func_221()) || func_222()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_227()) || Global_104267) || Global_25279) || func_226()) || func_24(8, -1)) || func_223()) || func_221()) || func_225()) || func_224()) || func_222())
						{
							return 0;
						}
						break;
