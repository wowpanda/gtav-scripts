...
void __EntryFunction__()
{
	...
	iLocal_43 = 64;
	fLocal_47 = -1f;
	uLocal_51 = _0x4A9923385BDB9DAD();
	uLocal_52 = _GET_BLIP_INFO_ID_ITERATOR();
			...
			switch (iLocal_53)
			{
				...
				case 1:
					...
					if (IS_PLAYER_PLAYING(PLAYER_ID()))
					{
						func_166();
						func_163();
						if (iLocal_54 == 1 && !DOES_ENTITY_EXIST(uLocal_91[1]))
						{
							func_70();
							if (func_68() || IS_ENTITY_DEAD(iLocal_94, 0))
							{
								if (DOES_ENTITY_EXIST(uLocal_91[0]))
								{
									if (!IS_ENTITY_DEAD(uLocal_91[0], 0))
									{
										if (IS_PED_IN_GROUP(uLocal_91[0]))
										{
											REMOVE_PED_FROM_GROUP(uLocal_91[0]);
										}
										CLEAR_PED_TASKS(uLocal_91[0]);
										TASK_SMART_FLEE_PED(uLocal_91[0], PLAYER_PED_ID(), 250f, -1, 0, 0);
										func_64(uLocal_91[0], 120000, 0);
										SET_PED_KEEP_TASK(uLocal_91[0], 1);
										func_62();
										WAIT(0);
						...
						if (iLocal_54 == 2 || (iLocal_54 == 1 && DOES_ENTITY_EXIST(uLocal_91[1])))
						{
							func_70();
							if (iLocal_55 != 9)
							{
								if (func_68() || IS_ENTITY_DEAD(iLocal_94, 0))
								{
									...
									if (DOES_ENTITY_EXIST(uLocal_91[1]))
									{
										if (!IS_PED_INJURED(uLocal_91[1]))
										{
											if (IS_PED_IN_GROUP(uLocal_91[1]))
											{
												REMOVE_PED_FROM_GROUP(uLocal_91[1]);
											}
											CLEAR_PED_TASKS(uLocal_91[1]);
											TASK_SMART_FLEE_PED(uLocal_91[1], PLAYER_PED_ID(), 250f, -1, 0, 0);
											func_64(uLocal_91[1], 120000, 0);
											SET_PED_KEEP_TASK(uLocal_91[1], 1);
										}
									}
									if (iLocal_54 == 1)
									{
						...
						if (DOES_ENTITY_EXIST(uLocal_91[0]))
						{
							if (!IS_PED_INJURED(uLocal_91[0]))
							{
								SET_PED_MAX_MOVE_BLEND_RATIO(uLocal_91[0], 1f);
							}
						}
						if (DOES_ENTITY_EXIST(uLocal_91[1]))
						{
							if (!IS_PED_INJURED(uLocal_91[1]))
							{
								SET_PED_MAX_MOVE_BLEND_RATIO(uLocal_91[1], 1f);
							}
						}
					}
					if ((func_59() && !func_58()) && iLocal_55 != 9)
					{
						if (!IS_PED_INJURED(uLocal_91[0]))
						{
							if (IS_ENTITY_AT_COORD(uLocal_91[0], vLocal_87, 5f, 5f, 5f, 0, 1, 0))
							{
								if (iLocal_54 == 2)
								{
									if (!IS_PED_INJURED(uLocal_91[1]))
									{
										if (!IS_PED_IN_GROUP(uLocal_91[0]) && !IS_PED_IN_GROUP(uLocal_91[1]))
										{
											SET_PED_AS_GROUP_MEMBER(uLocal_91[0], func_57());
											SET_PED_AS_GROUP_MEMBER(uLocal_91[1], func_57());
										}
									}
								}
								func_56(0);
					...
					if (func_55())
					{
						if (DOES_ENTITY_EXIST(uLocal_91[0]))
						{
							DELETE_PED(&(uLocal_91[0]));
						}
						if (DOES_ENTITY_EXIST(uLocal_91[1]))
						{
							DELETE_PED(&(uLocal_91[1]));
						}
						func_30();
					}
		...
		if (IS_VEHICLE_DRIVEABLE(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0))
		{
			if (iLocal_54 == 1)
			{
				if (DOES_ENTITY_EXIST(uLocal_91[0]))
				{
					if (!IS_PED_INJURED(uLocal_91[0]))
					{
						if (IS_PED_IN_VEHICLE(uLocal_91[0], GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0))
						{
							return 1;
						}
					}
			...
			if (iLocal_54 == 2)
			{
				if (DOES_ENTITY_EXIST(uLocal_91[0]) && DOES_ENTITY_EXIST(uLocal_91[1]))
				{
					if (!IS_PED_INJURED(uLocal_91[0]) && !IS_PED_INJURED(uLocal_91[1]))
					{
						if (IS_PED_IN_VEHICLE(uLocal_91[0], GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0) && IS_PED_IN_VEHICLE(uLocal_91[1], GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0))
						{
							return 1;
						}
					}
...
int func_3()
{
	if (iLocal_54 == 2)
	{
		if (!IS_ENTITY_DEAD(iLocal_94, 0))
		{
			...
			if (!IS_VEHICLE_DRIVEABLE(iLocal_94, 0) || IS_VEHICLE_STUCK_ON_ROOF(iLocal_94))
			{
				...
				if (!func_4())
				{
					if (func_61(&uLocal_173, "REDR2AU", "REDR2_LC", 4, 0, 0, 0))
					{
						if (!IS_PED_INJURED(uLocal_91[0]))
						{
							TASK_WANDER_STANDARD(uLocal_91[0], 1193033728, 0);
							SET_PED_KEEP_TASK(uLocal_91[0], 1);
						}
						if (!IS_PED_INJURED(uLocal_91[1]))
						{
							TASK_GO_TO_ENTITY(uLocal_91[1], uLocal_91[0], -1, 0f, 1f, 1073741824, 0);
							SET_PED_KEEP_TASK(uLocal_91[1], 1);
						}
						return 1;
					}
			...
			if (HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_94, 0, 2) && HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_94, PLAYER_PED_ID(), 0))
			{
				if (!IS_PED_INJURED(uLocal_91[0]))
				{
					CLEAR_PED_TASKS(uLocal_91[0]);
...
int func_68()
{
	...
	if (!IS_PED_INJURED(uLocal_91[0]))
	{
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_91[0], PLAYER_PED_ID(), 1) || IS_ENTITY_IN_WATER(uLocal_91[0]))
		{
			return 1;
		}
		if (!IS_ENTITY_DEAD(GET_PLAYERS_LAST_VEHICLE(), 0))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_91[0], GET_PLAYERS_LAST_VEHICLE(), 1))
			{
				return 1;
			}
		}
		...
		{
			if (IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uLocal_91[0]) || IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uLocal_91[0]))
			{
				if (_CAN_PED_SEE_PED(uLocal_91[0], PLAYER_PED_ID()))
				{
					return 1;
				}
			}
	...
	if (DOES_ENTITY_EXIST(uLocal_91[1]))
	{
		if (!IS_PED_INJURED(uLocal_91[1]))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_91[1], PLAYER_PED_ID(), 1))
			{
				return 1;
			}
			if (!IS_ENTITY_DEAD(GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_91[1], GET_PLAYERS_LAST_VEHICLE(), 1))
				{
					return 1;
				}
			}
			if (IS_PED_ARMED(PLAYER_PED_ID(), 6))
			{
				if (IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uLocal_91[1]) || IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uLocal_91[1]))
				{
					if (_CAN_PED_SEE_PED(uLocal_91[1], PLAYER_PED_ID()))
					{
						return 1;
					}
				}
...
void func_70()
{
	...
	switch (iLocal_55)
	{
		case 0:
			if (iLocal_54 == 1)
			{
				if ((IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1017.461f, -1259.868f, 3.9183f, -1061.891f, -1424.029f, 24.4253f, 171.75f, 0, 1, 0) && IS_SPHERE_VISIBLE(vLocal_152, 1f)) || IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_152, 15f, 15f, 15f, 0, 1, 0))
				{
					if (DOES_BLIP_EXIST(uLocal_151))
					{
						REMOVE_BLIP(&uLocal_151);
					}
					if (!IS_PED_INJURED(uLocal_91[0]))
					{
						if (!DOES_BLIP_EXIST(uLocal_155[0]))
						{
							uLocal_155[0] = func_162(uLocal_91[0], 0, 145);
							_0x75A16C3DA34F1245(uLocal_155[0], 0);
						}
					}
					if (!func_189())
					{
					...
					if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1011.144f, -1378.79f, 4.1997f, -1039.685f, -1337.61f, 9.7035f, 37.875f, 0, 1, 0))
					{
						if (!IS_PED_INJURED(uLocal_91[0]) && !IS_PED_INJURED(uLocal_91[1]))
						{
							func_150();
							TASK_PLAY_ANIM(uLocal_91[0], "random@drunk_driver_1", "drunk_argument_dd1", 2f, -2f, -1, 0, 0, 0, 0, 0);
							TASK_PLAY_ANIM(uLocal_91[1], "random@drunk_driver_1", "drunk_argument_dd2", 2f, -2f, -1, 0, 0, 0, 0, 0);
							iLocal_123 = (GET_GAME_TIMER() + 60000);
							if (DOES_BLIP_EXIST(uLocal_155[0]))
							{
								_0x75A16C3DA34F1245(uLocal_155[0], 1);
							}
							iLocal_55 = 1;
						}
					}
			...
			if (iLocal_54 == 2)
			{
				if ((IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1820.238f, 3671.948f, 30.8437f, 1957.818f, 3751.887f, 55.4436f, 159.9375f, 0, 1, 0) && IS_SPHERE_VISIBLE(vLocal_152, 1f)) || IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_152, 15f, 15f, 15f, 0, 1, 0))
				{
					func_149();
					if (!func_189())
					{
					...
					if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1877.761f, 3727.7f, 31.882f, 1896.962f, 3693.83f, 34.9925f, 19.1875f, 0, 1, 0))
					{
						...
						{
							_0x75A16C3DA34F1245(uLocal_155[1], 1);
						}
		...
		case 1:
			...
			{
				if (!IS_PED_INJURED(uLocal_91[0]) && !IS_ENTITY_DEAD(iLocal_94, 0))
				{
					OPEN_SEQUENCE_TASK(&uLocal_99);
					TASK_LOOK_AT_ENTITY(0, uLocal_91[1], 7000, 2060, 4);
					TASK_PAUSE(0, 2500);
					TASK_ENTER_VEHICLE(0, iLocal_94, -1, -1, 1f, 1, 0);
					CLOSE_SEQUENCE_TASK(uLocal_99);
					TASK_PERFORM_SEQUENCE(uLocal_91[0], uLocal_99);
					CLEAR_SEQUENCE_TASK(&uLocal_99);
				}
				if (!IS_PED_INJURED(uLocal_91[1]))
				{
					OPEN_SEQUENCE_TASK(&uLocal_99);
					TASK_LOOK_AT_ENTITY(0, uLocal_91[0], 7000, 2060, 4);
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1052.215f, -1354.937f, 4.3754f, 1f, -1, 1f, 0, 1193033728);
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1061.464f, -1384.922f, 4.2462f, 1f, -1, 1f, 1, 1193033728);
					TASK_WANDER_STANDARD(0, 1193033728, 0);
					CLOSE_SEQUENCE_TASK(uLocal_99);
					TASK_PERFORM_SEQUENCE(uLocal_91[1], uLocal_99);
					CLEAR_SEQUENCE_TASK(&uLocal_99);
				}
				SETTIMERA(0);
				iLocal_55 = 3;
			...
			if (!IS_PED_INJURED(uLocal_91[0]))
			{
				if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_91[0], 8f, 8f, 4f, 0, 1, 0))
				{
					if (IS_PED_FACING_PED(PLAYER_PED_ID(), uLocal_91[0], 80f))
					{
						bLocal_121 = true;
						SETTIMERA(0);
						iLocal_55 = 4;
				...
				else if (!IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_91[0], 30f, 30f, 30f, 0, 1, 0))
				{
		...
		case 3:
			...
			if (iLocal_54 == 2)
			{
				if (!IS_PED_INJURED(uLocal_91[0]))
				{
					if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_91[0], 30f, 30f, 30f, 0, 1, 0))
					{
						func_148();
						if (func_147())
						{
				...
				if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_68, 15f, 15f, 15f, 0, 1, 0) && !IS_PED_TRYING_TO_ENTER_A_LOCKED_VEHICLE(PLAYER_PED_ID()))
				{
					if (!IS_PED_INJURED(uLocal_91[0]))
					{
						if (IS_PED_FACING_PED(PLAYER_PED_ID(), uLocal_91[0], 80f))
						{
							if (_CAN_PED_SEE_PED(uLocal_91[0], PLAYER_PED_ID()))
							{
								if (!IS_PED_INJURED(uLocal_91[0]))
								{
									...
									TASK_PLAY_ANIM(0, "random@drunk_driver_2", "exit_1", 8f, -8f, -1, 0, 0, 0, 0, 0);
								...
								if (!IS_PED_INJURED(uLocal_91[1]))
								{
									TASK_LOOK_AT_ENTITY(uLocal_91[1], PLAYER_PED_ID(), -1, 2060, 4);
								}
								SETTIMERA(0);
								iLocal_55 = 4;
							}
				...
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1889.121f, 3715.057f, 31.844f, 1895.608f, 3703.586f, 34.8272f, 12.4375f, 0, 1, 0))
				{
					if (!IS_PED_INJURED(uLocal_91[0]))
					{
						OPEN_SEQUENCE_TASK(&uLocal_99);
				...
				if (IS_VEHICLE_DRIVEABLE(iLocal_94, 0))
				{
					if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_94, 1.5f, 1.5f, 5f, 0, 1, 0) && IS_PED_TRYING_TO_ENTER_A_LOCKED_VEHICLE(PLAYER_PED_ID()))
					{
						...
						if (func_61(&uLocal_173, "REDR2AU", "REDR2_TRY", 4, 0, 0, 0))
						{
							...
							if (!DOES_BLIP_EXIST(uLocal_158))
							{
								uLocal_158 = func_145(iLocal_94, 0, 0);
							}
							if (!IS_PED_INJURED(uLocal_91[0]))
							{
								CLEAR_PED_TASKS_IMMEDIATELY(uLocal_91[0]);
							}
							iLocal_55 = 4;
						}
					}
				...
				if (iLocal_123 < GET_GAME_TIMER())
				{
					...
					{
						if ((!IS_PED_INJURED(uLocal_91[0]) && !IS_PED_INJURED(uLocal_91[1])) && DOES_ENTITY_EXIST(iLocal_94))
						{
							OPEN_SEQUENCE_TASK(&uLocal_99);
							TASK_LOOK_AT_ENTITY(0, uLocal_91[1], -1, 2060, 4);
							TASK_ENTER_VEHICLE(0, iLocal_94, -1, -1, 1f, 1, 0);
							CLOSE_SEQUENCE_TASK(uLocal_99);
							TASK_PERFORM_SEQUENCE(uLocal_91[0], uLocal_99);
							CLEAR_SEQUENCE_TASK(&uLocal_99);
							OPEN_SEQUENCE_TASK(&uLocal_99);
							TASK_LOOK_AT_ENTITY(0, uLocal_91[0], -1, 2060, 4);
							TASK_TURN_PED_TO_FACE_ENTITY(0, uLocal_91[0], 0);
							TASK_ENTER_VEHICLE(0, iLocal_94, -1, 0, 1f, 1, 0);
							CLOSE_SEQUENCE_TASK(uLocal_99);
							TASK_PERFORM_SEQUENCE(uLocal_91[1], uLocal_99);
							CLEAR_SEQUENCE_TASK(&uLocal_99);
							iLocal_63 = 0;
		...
		case 4:
			if (iLocal_54 == 1)
			{
				switch (iLocal_170)
				{
					case 0:
						if (!IS_PED_INJURED(uLocal_91[0]) && !IS_PED_INJURED(uLocal_91[1]))
						{
							if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_91[0], 8f, 8f, 4f, 0, 1, 0) || bLocal_121)
							{
								_0xB542DE8C3D1CB210(0);
								TASK_LOOK_AT_ENTITY(uLocal_91[0], PLAYER_PED_ID(), -1, 2060, 4);
								TASK_LOOK_AT_ENTITY(uLocal_91[1], PLAYER_PED_ID(), -1, 2060, 4);
								TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), uLocal_91[0], -1, 2060, 4);
					...
					case 1:
						if (!func_4())
						{
							if (func_144())
							{
								...
								{
									OPEN_SEQUENCE_TASK(&uLocal_99);
									TASK_PLAY_ANIM(0, "random@drunk_driver_1", "drunk_breakout_dd1", 2f, -2f, -1, 0, 0, 0, 0, 0);
									...
									{
										OPEN_SEQUENCE_TASK(&uLocal_99);
										TASK_PLAY_ANIM(0, "random@drunk_driver_1", "drunk_breakout_dd2", 2f, -2f, -1, 0, 0, 0, 0, 0);
										TASK_TURN_PED_TO_FACE_ENTITY(0, uLocal_91[0], 0);
										TASK_PAUSE(0, 3000);
										TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1052.215f, -1354.937f, 4.3754f, 1f, -1, 1f, 0, 1193033728);
										TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1061.464f, -1384.922f, 4.2462f, 1f, -1, 1f, 1, 1193033728);
							...
							else
							{
								if (!IS_PED_INJURED(uLocal_91[0]))
								{
									if (IS_PED_FACING_PED(PLAYER_PED_ID(), uLocal_91[0], 80f))
									{
										TASK_LOOK_AT_ENTITY(uLocal_91[0], PLAYER_PED_ID(), 10000, 2060, 4);
										TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), uLocal_91[0], 10000, 2060, 4);
										func_6();
										WAIT(0);
										iLocal_170++;
									}
									...
									{
										func_142(uLocal_91[0], &(uLocal_65[0]));
									}
								}
								if (!func_4())
								{
							...
							if (!func_4())
							{
								if (func_61(&uLocal_173, "REDR1AU", "REDR1_PLS", 4, 0, 0, 0))
								{
									...
									if (IS_VEHICLE_DRIVEABLE(iLocal_94, 0))
									{
										...
										if (!IS_PED_INJURED(uLocal_91[0]))
										{
											TASK_ENTER_VEHICLE(uLocal_91[0], iLocal_94, -1, 0, 1f, 1, 0);
										}
									}
									iLocal_170++;
								}
						...
						if (func_144())
						{
							if (!IS_PED_INJURED(uLocal_91[0]))
							{
								if (!IS_PED_IN_GROUP(uLocal_91[0]))
								{
									CLEAR_PED_TASKS(uLocal_91[0]);
									SET_PED_AS_GROUP_MEMBER(uLocal_91[0], func_57());
									SET_PED_NEVER_LEAVES_GROUP(uLocal_91[0], 1);
									SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uLocal_91[0], 0);
								}
								SET_RELATIONSHIP_BETWEEN_GROUPS(255, uLocal_100, 1862763509);
								func_141();
							}
							if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
							{
			...
			if (iLocal_54 == 2)
			{
				switch (iLocal_170)
				{
					case 0:
						if (!IS_PED_INJURED(uLocal_91[0]) && !IS_PED_INJURED(uLocal_91[1]))
						{
							if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_91[0], 10f, 10f, 10f, 0, 1, 0))
							{
								if (IS_PED_FACING_PED(uLocal_91[0], PLAYER_PED_ID(), 50f))
								{
									TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), uLocal_91[0], -1, 2060, 4);
									TASK_LOOK_AT_ENTITY(uLocal_91[0], PLAYER_PED_ID(), -1, 2060, 4);
									TASK_LOOK_AT_ENTITY(uLocal_91[1], PLAYER_PED_ID(), -1, 2060, 4);
					...
					case 2:
						...
						if (!func_4())
						{
							if (!IS_PED_INJURED(uLocal_91[0]))
							{
								if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_91[0], 20f, 20f, 20f, 0, 1, 0) && TIMERA() > 9500)
								{
			...
			if (iLocal_54 == 1)
			{
				if (!IS_PED_INJURED(uLocal_91[0]) && !IS_ENTITY_DEAD(iLocal_94, 0))
				{
					if (TIMERA() > 50000 || GET_PED_IN_VEHICLE_SEAT(iLocal_94, -1, 0) == uLocal_91[0])
					{
						if (func_61(&uLocal_173, "REDR1AU", "REDR1_FU", 4, 0, 0, 0))
						{
							if (IS_VEHICLE_DRIVEABLE(iLocal_94, 0) && !IS_VEHICLE_STUCK_ON_ROOF(iLocal_94))
							{
								if (!IS_PED_INJURED(uLocal_91[0]))
								{
									if (IS_VEHICLE_SEAT_FREE(iLocal_94, -1, 0) && IS_PED_IN_VEHICLE(uLocal_91[0], iLocal_94, 0))
									{
										TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(uLocal_91[0], iLocal_94, 0);
										iLocal_55 = 2;
									}
									else if (GET_PED_IN_VEHICLE_SEAT(iLocal_94, -1, 0) == uLocal_91[0])
									{
										iLocal_55 = 2;
									}
									else if (GET_PED_IN_VEHICLE_SEAT(iLocal_94, -1, 0) == PLAYER_PED_ID())
									{
										iLocal_55 = 7;
									}
									else
							...
							else if (!IS_PED_INJURED(uLocal_91[0]))
							{
								func_64(uLocal_91[0], 120000, 0);
								TASK_WANDER_STANDARD(uLocal_91[0], 1193033728, 0);
								SET_PED_KEEP_TASK(uLocal_91[0], 1);
			...
			if (iLocal_54 == 2)
			{
				if (TIMERA() > 60000)
				{
					if (func_61(&uLocal_173, "REDR2AU", "REDR2_FU", 4, 0, 0, 0))
					{
						if (IS_VEHICLE_DRIVEABLE(iLocal_94, 0))
						{
							if (IS_VEHICLE_SEAT_FREE(iLocal_94, -1, 0))
							{
								if (!IS_PED_INJURED(uLocal_91[0]))
								{
									OPEN_SEQUENCE_TASK(&uLocal_99);
		...
		case 2:
			if (iLocal_54 == 1)
			{
				if (!IS_PED_INJURED(uLocal_91[0]))
				{
					if (!IS_ENTITY_DEAD(iLocal_94, 0))
					{
						if (IS_PED_IN_VEHICLE(uLocal_91[0], iLocal_94, 0))
						{
							if (GET_SCRIPT_TASK_STATUS(uLocal_91[0], 355471868) != 1 && GET_SCRIPT_TASK_STATUS(uLocal_91[0], 355471868) != 0)
							{
								SET_VEHICLE_ENGINE_HEALTH(iLocal_94, 5f);
								_0x25367DE49D64CF16(iLocal_94, 1);
								OPEN_SEQUENCE_TASK(&uLocal_99);
								TASK_VEHICLE_MISSION_COORS_TARGET(0, iLocal_94, -1016.152f, -1352.855f, 4.4854f, 4, 50f, 262144, -1f, 100f, 1);
								TASK_VEHICLE_MISSION_COORS_TARGET(0, iLocal_94, -1005.757f, -1353.806f, 4.4756f, 4, 50f, 262144, -1f, 100f, 1);
								TASK_VEHICLE_MISSION_COORS_TARGET(0, iLocal_94, -989.2302f, -1354.278f, -7.3581f, 4, 50f, 262144, -1f, 100f, 1);
								CLOSE_SEQUENCE_TASK(uLocal_99);
								TASK_PERFORM_SEQUENCE(uLocal_91[0], uLocal_99);
								CLEAR_SEQUENCE_TASK(&uLocal_99);
								SET_PED_KEEP_TASK(uLocal_91[0], 1);
			...
			if (iLocal_54 == 2)
			{
				if (IS_VEHICLE_DRIVEABLE(iLocal_94, 0))
				{
					if (!IS_PED_INJURED(uLocal_91[0]) && !IS_PED_INJURED(uLocal_91[1]))
					{
						if (IS_PED_SITTING_IN_VEHICLE(uLocal_91[0], iLocal_94) && IS_PED_SITTING_IN_VEHICLE(uLocal_91[1], iLocal_94))
						{
							_0x25367DE49D64CF16(iLocal_94, 1);
							CLEAR_PED_TASKS(uLocal_91[1]);
							TASK_STAND_STILL(uLocal_91[1], -1);
							SET_PED_KEEP_TASK(uLocal_91[1], 1);
							iLocal_55 = 5;
						}
						if (!iLocal_101)
						{
							...
							{
								CLEAR_PED_TASKS(uLocal_91[0]);
								TASK_STAND_STILL(uLocal_91[0], -1);
							}
							if (!IS_PED_SITTING_IN_VEHICLE(uLocal_91[0], iLocal_94) && IS_PED_SITTING_IN_VEHICLE(uLocal_91[1], iLocal_94))
							{
								CLEAR_PED_TASKS(uLocal_91[1]);
		...
		case 5:
			if (IS_VEHICLE_DRIVEABLE(iLocal_94, 0))
			{
				if (!IS_PED_INJURED(uLocal_91[0]))
				{
					CLEAR_PED_TASKS(uLocal_91[0]);
					OPEN_SEQUENCE_TASK(&uLocal_99);
					TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_94, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_94, 0f, 2f, 0f), 10f, 0, iLocal_98, 262144, 5f, -1f);
					TASK_VEHICLE_TEMP_ACTION(0, iLocal_94, 24, 500);
					TASK_VEHICLE_TEMP_ACTION(0, iLocal_94, 9, 1500);
					TASK_VEHICLE_TEMP_ACTION(0, iLocal_94, 24, 500);
					TASK_VEHICLE_TEMP_ACTION(0, iLocal_94, 11, 1500);
					TASK_VEHICLE_MISSION_COORS_TARGET(0, iLocal_94, 2185.817f, 3915.471f, 27.9257f, 4, 30f, 262144, 0f, 0f, 1);
					CLOSE_SEQUENCE_TASK(uLocal_99);
					TASK_PERFORM_SEQUENCE(uLocal_91[0], uLocal_99);
					CLEAR_SEQUENCE_TASK(&uLocal_99);
					SET_PED_KEEP_TASK(uLocal_91[0], 1);
		...
		case 6:
			if (!IS_PED_INJURED(uLocal_91[0]))
			{
				if (GET_SCRIPT_TASK_STATUS(uLocal_91[0], 242628503) == 1)
				{
					if (GET_SEQUENCE_PROGRESS(uLocal_91[0]) == 5)
					{
						func_60();
					}
				}
		...
		case 7:
			if (iLocal_54 == 1)
			{
				if (!IS_PED_INJURED(uLocal_91[1]))
				{
					if (!IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_91[1], 50f, 50f, 50f, 0, 1, 0))
					{
						SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_91[1]));
					}
				}
				switch (iLocal_64)
				{
						...
						if (TIMERA() > 1000)
						{
							if (!IS_PED_INJURED(uLocal_91[0]))
							{
								if (func_144())
								{
									...
									{
										fLocal_164 = func_140(PLAYER_PED_ID(), uLocal_91[0], 1);
										iLocal_64++;
									}
								}
								else if (!iLocal_119)
					...
					case 2:
						...
						if (!IS_PED_INJURED(uLocal_91[0]))
						{
							if (func_144())
							{
								if (!iLocal_118)
								{
									if (func_140(PLAYER_PED_ID(), uLocal_91[0], 1) > (fLocal_164 + 5f))
									{
						...
						if (func_2())
						{
							...
							if (func_17() == 2 && !func_58())
							{
								...
								{
									uLocal_103 = func_137(vLocal_87, 0);
									SET_BLIP_SPRITE(uLocal_103, 269);
									func_135();
								}
							}
							iLocal_62 = 1;
						...
						if (!IS_PED_INJURED(uLocal_91[0]))
						{
							if (func_140(PLAYER_PED_ID(), uLocal_91[0], 1) > 50f)
							{
								func_60();
							}
						}
					...
					case 5:
						...
						if (!IS_PED_INJURED(uLocal_91[0]))
						{
							if (IS_ENTITY_AT_COORD(uLocal_91[0], vLocal_81, Global_22, 1, 1, 0))
							{
			...
			if (iLocal_54 == 2)
			{
				switch (iLocal_64)
				{
					case 0:
						if (!IS_ENTITY_DEAD(iLocal_94, 0))
						{
							if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_94, 1))
							{
								...
								if (!DOES_BLIP_EXIST(uLocal_155[1]))
								{
									uLocal_155[1] = func_162(uLocal_91[1], 0, 145);
								}
								if (!func_4())
								{
									SETTIMERA(0);
					...
					case 1:
						if (!IS_PED_INJURED(uLocal_91[0]) && !IS_ENTITY_DEAD(iLocal_94, 0))
						{
							TASK_CLEAR_LOOK_AT(uLocal_91[0]);
							TASK_ENTER_VEHICLE(uLocal_91[0], iLocal_94, 30000, 2, 1073741824, 1, 0);
						}
						SETTIMERA(0);
						iLocal_64++;
						break;
					...
					case 2:
						if (!IS_PED_INJURED(uLocal_91[1]) && !IS_ENTITY_DEAD(iLocal_94, 0))
						{
							OPEN_SEQUENCE_TASK(&uLocal_99);
							TASK_CLEAR_LOOK_AT(0);
							TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, iLocal_94, 1.5f, -3f, 0f, 1f, 4000, 1036831949, 1);
							TASK_ENTER_VEHICLE(0, iLocal_94, 30000, 1, 1073741824, 1, 0);
							CLOSE_SEQUENCE_TASK(uLocal_99);
							TASK_PERFORM_SEQUENCE(uLocal_91[1], uLocal_99);
							CLEAR_SEQUENCE_TASK(&uLocal_99);
						}
					...
					case 3:
						...
						if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
						{
							if (IS_VEHICLE_DRIVEABLE(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0))
							{
								if (!IS_ENTITY_DEAD(uLocal_91[0], 0) && !IS_ENTITY_DEAD(uLocal_91[1], 0))
								{
									if (IS_PED_IN_VEHICLE(uLocal_91[0], GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0) && IS_PED_IN_VEHICLE(uLocal_91[1], GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0))
									{
										SET_RELATIONSHIP_BETWEEN_GROUPS(255, uLocal_100, 1862763509);
					...
					case 5:
						...
						if (!IS_ENTITY_DEAD(iLocal_94, 0))
						{
							if ((!IS_PED_INJURED(uLocal_91[0]) && !IS_PED_INJURED(uLocal_91[1])) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_94, 0))
							{
								if (IS_ENTITY_AT_COORD(uLocal_91[0], vLocal_81, Global_22, 1, 1, 0) && IS_ENTITY_AT_COORD(uLocal_91[1], vLocal_81, Global_22, 0, 1, 0))
								{
									iLocal_64++;
								}
							}
		...
		case 8:
			...
			while (iLocal_63 <= (iLocal_90 - 1))
			{
				if (!IS_PED_INJURED(uLocal_91[iLocal_63]))
				{
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_91[iLocal_63], 0);
				}
				iLocal_63++;
			}
			if (iLocal_54 == 1)
			{
				if (func_119(1, 0, 1) && iLocal_124 == -1)
				{
					...
					if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
					{
						_SET_VEHICLE_HALT(GET_PLAYERS_LAST_VEHICLE(), (10.5f - 5f), 2, 0);
					}
					if (func_2())
					{
						if (GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0) == iLocal_94)
			...
			if (iLocal_54 == 2)
			{
				if (func_119(1, 0, 1) && iLocal_124 == -1)
				{
					...
					if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
					{
						_SET_VEHICLE_HALT(GET_PLAYERS_LAST_VEHICLE(), (10.5f - 4f), 2, 0);
...
void func_71()
{
	switch (iLocal_126)
	{
		case 0:
			...
			{
				REMOVE_PED_FROM_GROUP(uLocal_91[0]);
				TASK_LOOK_AT_ENTITY(uLocal_91[1], PLAYER_PED_ID(), 10000, 2060, 4);
			}
		...
		case 2:
			if (iLocal_125 < GET_GAME_TIMER())
			{
				if (!IS_PED_INJURED(uLocal_91[0]))
				{
					TASK_GO_STRAIGHT_TO_COORD(uLocal_91[0], vLocal_84, 1f, -1, 1193033728, 1056964608);
		...
		case 3:
			if (iLocal_125 < GET_GAME_TIMER())
			{
				if (!IS_PED_INJURED(uLocal_91[1]))
				{
					TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_91[1], vLocal_84, 1f, -1, 1048576000, 0, 1193033728);
					iLocal_126++;
				}
			}
			break;
...
void func_76(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_78() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_78() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_77(iParam0));
...
int func_82(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_78() /*10778*/].f_6165.f_10, iParam0);
}
...
int func_83(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2539502[iParam0 /*3*/][func_80(iParam1)];
	...
	switch (iLocal_126)
	{
		...
		case 2:
			if (!IS_PED_INJURED(uLocal_91[1]))
			{
				...
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_84, 1f, -1, 1048576000, 0, 1193033728);
				CLOSE_SEQUENCE_TASK(uLocal_99);
				TASK_PERFORM_SEQUENCE(uLocal_91[1], uLocal_99);
				CLEAR_SEQUENCE_TASK(&uLocal_99);
		...
		case 3:
			if (iLocal_125 < GET_GAME_TIMER())
			{
				if (!IS_PED_INJURED(uLocal_91[0]))
				{
					TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_91[0], vLocal_84, 1f, -1, 1048576000, 0, 1193033728);
					iLocal_126++;
				}
			}
			break;
...
void func_105()
{
	...
	switch (iLocal_126)
	{
				...
				if (IS_VEHICLE_STOPPED(iLocal_94))
				{
					if (IS_VEHICLE_DRIVEABLE(iLocal_94, 0))
					{
						if (!IS_PED_INJURED(uLocal_91[0]))
						{
							CLEAR_PED_TASKS(uLocal_91[0]);
							REMOVE_PED_FROM_GROUP(uLocal_91[0]);
							TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), uLocal_91[0], 4000, 2060, 4);
						}
						if (!IS_PED_INJURED(uLocal_91[1]))
						{
							CLEAR_PED_TASKS(uLocal_91[1]);
		...
		case 1:
			if (IS_VEHICLE_DRIVEABLE(iLocal_94, 0))
			{
				uLocal_128 = CREATE_CAMERA_WITH_PARAMS(26379945, 1121.335f, 2643.908f, 37.862f, 1.5062f, 0f, 20.274f, 33.0256f, 0, 2);
				uLocal_129 = CREATE_CAMERA_WITH_PARAMS(26379945, 1121.302f, 2643.998f, 37.8919f, 1.5062f, 0f, 18.7019f, 33.0256f, 0, 2);
				SHAKE_CAM(uLocal_128, "HAND_SHAKE", 0.3f);
				SHAKE_CAM(uLocal_129, "HAND_SHAKE", 0.3f);
				SET_CAM_ACTIVE_WITH_INTERP(uLocal_129, uLocal_128, 2500, 0, 0);
				RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
				CLEAR_AREA(vLocal_81, 8f, 1, 0, 0, 0);
				SET_ENTITY_COORDS(iLocal_94, 1120.551f, 2647.307f, 36.9963f, 1, 0, 0, 1);
				SET_ENTITY_HEADING(iLocal_94, 179.7675f);
				SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_94, 1084227584);
		...
		case 2:
			if (iLocal_125 - 500) < GET_GAME_TIMER()
			{
				if (!IS_PED_INJURED(uLocal_91[1]))
				{
					if (IS_PED_IN_ANY_VEHICLE(uLocal_91[1], 0))
					{
						OPEN_SEQUENCE_TASK(&uLocal_99);
						TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_84, 1f, -1, 1048576000, 0, 1193033728);
						CLOSE_SEQUENCE_TASK(uLocal_99);
			...
			if (iLocal_125 - 1000) < GET_GAME_TIMER()
			{
				if (!IS_PED_INJURED(uLocal_91[0]))
				{
					if (IS_PED_IN_ANY_VEHICLE(uLocal_91[0], 0))
					{
						OPEN_SEQUENCE_TASK(&uLocal_99);
						TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_84 - Vector(0f, 0f, 1f), 1f, -1, 1048576000, 0, 1193033728);
						CLOSE_SEQUENCE_TASK(uLocal_99);
						TASK_PERFORM_SEQUENCE(uLocal_91[0], uLocal_99);
						CLEAR_SEQUENCE_TASK(&uLocal_99);
						SET_PED_KEEP_TASK(uLocal_91[0], 1);
			...
			if (iLocal_125 < GET_GAME_TIMER())
			{
				SET_CAM_PARAMS(uLocal_128, 1105.849f, 2664.653f, 38.047f, 3.6983f, 0.0242f, -140.4768f, 41.7126f, 0, 1, 1, 2);
				SET_CAM_PARAMS(uLocal_129, 1106f, 2664.469f, 38.0625f, 3.6984f, 0.0242f, -140.4769f, 41.7126f, 0, 1, 1, 2);
				SET_CAM_ACTIVE_WITH_INTERP(uLocal_129, uLocal_128, 5000, 0, 0);
				NEW_LOAD_SCENE_STOP();
		...
		case 3:
			if (iLocal_125 < GET_GAME_TIMER())
			{
				SET_CAM_PARAMS(uLocal_128, 1122.37f, 2646.108f, 38.3339f, -5.6746f, -0.1271f, 33.7683f, 50f, 0, 1, 1, 2);
				SET_CAM_PARAMS(uLocal_129, 1122.338f, 2646.157f, 38.3281f, -5.6746f, -0.1271f, 33.7683f, 50f, 0, 1, 1, 2);
				SET_CAM_ACTIVE_WITH_INTERP(uLocal_129, uLocal_128, 1500, 1, 1);
				if (!IS_PED_INJURED(uLocal_91[0]) && !IS_PED_INJURED(uLocal_91[1]))
				{
					SET_ENTITY_COORDS(uLocal_91[0], 1141.156f, 2643.205f, 37.1487f, 1, 0, 0, 1);
					SET_ENTITY_HEADING(uLocal_91[0], 262.7369f);
					SET_ENTITY_COORDS(uLocal_91[1], 1140.152f, 2644.149f, 37.1487f, 1, 0, 0, 1);
					SET_ENTITY_HEADING(uLocal_91[1], 262.1522f);
				}
				if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
...
void func_108(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_112(PLAYER_ID())) && !func_110(PLAYER_ID(), 0)) && !func_109()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_112(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
	...
	switch (iLocal_126)
	{
		...
		case 3:
			if (!IS_PED_INJURED(uLocal_91[0]))
			{
				...
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_84, 1f, -1, 1048576000, 0, 1193033728);
				TASK_PLAY_ANIM(0, "random@drunk_driver_1", "drunk_fall_over", 2f, -2f, -1, 2359304, 0, 0, 0, 0);
				CLOSE_SEQUENCE_TASK(uLocal_99);
				TASK_PERFORM_SEQUENCE(uLocal_91[0], uLocal_99);
				CLEAR_SEQUENCE_TASK(&uLocal_99);
				SET_PED_KEEP_TASK(uLocal_91[0], 1);
...
void func_117()
{
	...
	switch (iLocal_126)
	{
		case 0:
			...
			if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
			{
				if (IS_VEHICLE_STOPPED(uVar0) && !func_4())
				{
					if (!IS_PED_INJURED(uLocal_91[0]))
					{
						CLEAR_PED_TASKS(uLocal_91[0]);
...
void func_120()
{
	...
	if ((IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), "random@drunk_driver_2", "driver_enter_m", 3) || IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), "random@drunk_driver_2", "driver_idle_m", 3)) || IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), "random@drunk_driver_2", "driver_exit_m", 3))
	{
		...
		if ((((((((func_125(64) || IS_CONTROL_PRESSED(0, 86)) || IS_CONTROL_PRESSED(0, 71)) || IS_CONTROL_PRESSED(0, 72)) || IS_CONTROL_PRESSED(0, 76)) || IS_CONTROL_PRESSED(0, 73)) || IS_CONTROL_PRESSED(0, 68)) || IS_CONTROL_PRESSED(0, 75)) || iVar0)
		{
	...
	switch (iLocal_346)
	{
		case 0:
			if (func_124())
			{
				TASK_LOOK_AT_ENTITY(uLocal_91[0], uLocal_91[1], -1, 2060, 4);
				TASK_LOOK_AT_ENTITY(uLocal_91[1], uLocal_91[0], -1, 2060, 4);
				if (func_61(&uLocal_173, "REDR2AU", "REDR2_HC", 4, 0, 0, 0))
				{
					OPEN_SEQUENCE_TASK(&uLocal_99);
					TASK_PLAY_ANIM(0, "random@drunk_driver_2", "cardrunkflirt_intro_m", 2f, -2f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "random@drunk_driver_2", "cardrunkflirt_loop_m", 2f, -2f, -1, 1, 0, 0, 0, 0);
					CLOSE_SEQUENCE_TASK(uLocal_99);
					TASK_PERFORM_SEQUENCE(uLocal_91[0], uLocal_99);
					CLEAR_SEQUENCE_TASK(&uLocal_99);
					OPEN_SEQUENCE_TASK(&uLocal_99);
					TASK_PLAY_ANIM(0, "random@drunk_driver_2", "cardrunkflirt_intro_f", 2f, -2f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "random@drunk_driver_2", "cardrunkflirt_loop_f", 2f, -2f, -1, 1, 0, 0, 0, 0);
					CLOSE_SEQUENCE_TASK(uLocal_99);
					TASK_PERFORM_SEQUENCE(uLocal_91[1], uLocal_99);
					CLEAR_SEQUENCE_TASK(&uLocal_99);
		...
		case 3:
			if ((GET_GAME_TIMER() - iLocal_347) > 15000)
			{
				if (func_124())
				{
					TASK_PLAY_ANIM(uLocal_91[0], "random@drunk_driver_2", "cardrunksex_intro_m", 2f, -2f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(uLocal_91[1], "random@drunk_driver_2", "cardrunksex_intro_f", 2f, -2f, -1, 0, 0, 0, 0, 0);
					iLocal_346++;
				}
			}
			break;
		...
		case 4:
			...
			{
				func_122();
				if (IS_ENTITY_PLAYING_ANIM(uLocal_91[0], "random@drunk_driver_2", "cardrunksex_intro_m", 3))
				{
					if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_91[0], "random@drunk_driver_2", "cardrunksex_intro_m") > 0.9f)
					{
						TASK_PLAY_ANIM(uLocal_91[0], "random@drunk_driver_2", "cardrunksex_loop_m", 2f, -2f, -1, 1, 0, 0, 0, 0);
						TASK_PLAY_ANIM(uLocal_91[1], "random@drunk_driver_2", "cardrunksex_loop_f", 2f, -2f, -1, 1, 0, 0, 0, 0);
						iLocal_347 = GET_GAME_TIMER();
						iLocal_346++;
					}
				}
			}
			else if (!IS_PED_INJURED(uLocal_91[0]) && !IS_PED_INJURED(uLocal_91[1]))
			{
				CLEAR_PED_TASKS(uLocal_91[0]);
				CLEAR_PED_TASKS(uLocal_91[1]);
				iLocal_346 = 3;
		...
		case 5:
			if (func_124())
			{
				func_122();
				func_121();
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), GET_VEHICLE_PED_IS_IN(uLocal_91[1], 0), 0))
				{
					if ((GET_GAME_TIMER() - iLocal_347) > 15000)
					{
						bVar3 = false;
						...
						{
							OPEN_SEQUENCE_TASK(&uLocal_99);
							TASK_PLAY_ANIM(0, "random@drunk_driver_2", "driver_enter_m", 2f, -2f, -1, 0, 0, 0, 0, 0);
							TASK_PLAY_ANIM(0, "random@drunk_driver_2", "driver_idle_m", 2f, -2f, -1, 1, 0, 0, 0, 0);
							CLOSE_SEQUENCE_TASK(uLocal_99);
							TASK_PERFORM_SEQUENCE(PLAYER_PED_ID(), uLocal_99);
							CLEAR_SEQUENCE_TASK(&uLocal_99);
						}
						if (func_17() == 0)
						{
		...
		case 6:
			func_122();
			func_121();
			if ((GET_GAME_TIMER() - iLocal_347) > 5000 && func_124())
			{
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), GET_VEHICLE_PED_IS_IN(uLocal_91[1], 0), 0))
				{
					if (IS_ENTITY_PLAYING_ANIM(uLocal_91[0], "random@drunk_driver_2", "cardrunksex_loop_m", 3))
					{
						if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_91[0], "random@drunk_driver_2", "cardrunksex_loop_m") > 0.9f)
						{
							...
							TASK_PLAY_ANIM(uLocal_91[0], "random@drunk_driver_2", "cardrunksex_outro_m", 2f, -2f, -1, 0, 0, 0, 0, 0);
							TASK_PLAY_ANIM(uLocal_91[1], "random@drunk_driver_2", "cardrunksex_outro_f", 2f, -2f, -1, 0, 0, 0, 0, 0);
							iLocal_346++;
						}
					}
				}
		...
		case 7:
			...
			if (func_124())
			{
				if (IS_ENTITY_PLAYING_ANIM(uLocal_91[0], "random@drunk_driver_2", "cardrunksex_outro_m", 3))
				{
					if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_91[0], "random@drunk_driver_2", "cardrunksex_outro_m") < 0.25f && GET_ENTITY_ANIM_CURRENT_TIME(uLocal_91[0], "random@drunk_driver_2", "cardrunksex_outro_m") > 0.2f)
					{
						APPLY_FORCE_TO_ENTITY(GET_VEHICLE_PED_IS_IN(uLocal_91[0], 0), 0, 0f, 0f, 20f, -0.4f, 0f, 0f, 0, 1, 1, 1, 0, 1);
						iLocal_347 = GET_GAME_TIMER();
						iLocal_346++;
					}
				}
		...
		case 8:
			...
			if (func_124())
			{
				if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), GET_VEHICLE_PED_IS_IN(uLocal_91[1], 0), 0))
				{
					if (IS_ENTITY_PLAYING_ANIM(uLocal_91[0], "random@drunk_driver_2", "cardrunksex_outro_m", 3))
					{
						if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_91[0], "random@drunk_driver_2", "cardrunksex_outro_m") < 0.525f)
						{
							TASK_PLAY_ANIM(uLocal_91[0], "random@drunk_driver_2", "cardrunksex_loop_m", 2f, -2f, -1, 1, 0, 0, 0, 0);
							TASK_PLAY_ANIM(uLocal_91[1], "random@drunk_driver_2", "cardrunksex_loop_f", 2f, -2f, -1, 1, 0, 0, 0, 0);
							iLocal_346 = 6;
...
void func_121()
{
	if (!IS_PED_INJURED(uLocal_91[1]))
	{
		if (IS_VEHICLE_DRIVEABLE(GET_VEHICLE_PED_IS_IN(uLocal_91[0], 0), 0))
		{
			if (IS_ENTITY_PLAYING_ANIM(uLocal_91[1], "random@drunk_driver_2", "cardrunksex_loop_f", 3))
			{
				if ((((GET_ENTITY_ANIM_CURRENT_TIME(uLocal_91[1], "random@drunk_driver_2", "cardrunksex_loop_f") < 0.15f && GET_ENTITY_ANIM_CURRENT_TIME(uLocal_91[1], "random@drunk_driver_2", "cardrunksex_loop_f") > 0.1f) || (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_91[1], "random@drunk_driver_2", "cardrunksex_loop_f") < 0.35f && GET_ENTITY_ANIM_CURRENT_TIME(uLocal_91[1], "random@drunk_driver_2", "cardrunksex_loop_f") > 0.3f)) || (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_91[1], "random@drunk_driver_2", "cardrunksex_loop_f") < 0.65f && GET_ENTITY_ANIM_CURRENT_TIME(uLocal_91[1], "random@drunk_driver_2", "cardrunksex_loop_f") > 0.6f)) || (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_91[1], "random@drunk_driver_2", "cardrunksex_loop_f") < 0.9f && GET_ENTITY_ANIM_CURRENT_TIME(uLocal_91[1], "random@drunk_driver_2", "cardrunksex_loop_f") > 0.85f))
				{
					APPLY_FORCE_TO_ENTITY(GET_VEHICLE_PED_IS_IN(uLocal_91[0], 0), 0, 0f, 0f, 15f, -0.4f, 0f, 0f, 0, 1, 1, 1, 0, 1);
					PLAY_SOUND_FROM_ENTITY(-1, "SUSPENSION_SCRIPT_FORCE", GET_VEHICLE_PED_IS_IN(uLocal_91[0], 0), 0, 0, 0);
				}
			}
		}
	}
...
int func_124()
{
	...
	if (!IS_PED_INJURED(uLocal_91[1]))
	{
		if (IS_PED_IN_ANY_VEHICLE(uLocal_91[1], 0))
		{
			uVar0 = GET_VEHICLE_PED_IS_IN(uLocal_91[1], 0);
			if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
			{
				if (!IS_PED_INJURED(uLocal_91[0]))
				{
					if (IS_PED_IN_VEHICLE(uLocal_91[0], uVar0, 0))
					{
						if (GET_PED_IN_VEHICLE_SEAT(uVar0, 2, 0) == uLocal_91[0] && GET_PED_IN_VEHICLE_SEAT(uVar0, 1, 0) == uLocal_91[1])
						{
							return 1;
						}
					}
...
void func_128()
{
	...
	else if ((bLocal_108 && !iLocal_132) && iLocal_149 < GET_GAME_TIMER())
	{
		if (!func_4())
		{
...
void func_129()
{
	if (func_2() && iLocal_111 < 2)
	{
		...
		func_130(vLocal_160, (GET_GAME_TIMER() - iLocal_159));
	}
	if (iLocal_163 > 17)
	{
		iLocal_109 = 1;
...
Vector3 func_131(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
		...
		switch (iLocal_111)
		{
			case 0:
				if (func_61(&uLocal_173, "REDR1AU", "REDR1_SIK", 4, 0, 0, 0))
				{
					if (!IS_ENTITY_DEAD(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0))
					{
						REMOVE_VEHICLE_WINDOW(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 1);
					}
					SETTIMERB(0);
					iLocal_111++;
				}
			...
			case 1:
				if (TIMERB() > 3000 || !func_4())
				{
					...
					{
						CLEAR_PED_TASKS(uLocal_91[0]);
						TASK_PLAY_ANIM(uLocal_91[0], "random@drunk_driver_1", sLocal_114, 8f, -8f, -1, 0, 0, 0, 0, 0);
						iLocal_111++;
					}
				}
				break;
			...
			case 2:
				if (IS_ENTITY_PLAYING_ANIM(uLocal_91[0], "random@drunk_driver_1", sLocal_114, 3))
				{
					fVar0 = GET_ENTITY_ANIM_CURRENT_TIME(uLocal_91[0], "random@drunk_driver_1", sLocal_114);
					if (fVar0 > 0.243f && fVar0 < 0.28f)
					{
						if (!iLocal_105)
						{
							START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE("scr_puke_in_car", uLocal_91[0], 0f, 0f, 0f, 0f, 0f, 0f, 31086, 1065353216, 0, 0, 0);
							iLocal_105 = 1;
						}
					}
					...
					if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_91[0], "random@drunk_driver_1", sLocal_114) > 0.8f)
					{
						iLocal_111++;
					}
				}
			...
			case 3:
				...
				{
					TASK_PLAY_ANIM(uLocal_91[0], "random@drunk_driver_1", sLocal_113, 2f, -4f, -1, 1, 0, 0, 0, 0);
					iLocal_105 = 0;
					iLocal_111++;
				}
				break;
...
void func_133()
{
	...
	if ((iLocal_167 - iLocal_166) > 60000 && iLocal_169)
	{
		...
		if (!IS_PED_INJURED(uLocal_91[0]) && !IS_PED_INJURED(uLocal_91[1]))
		{
			...
			TASK_FOLLOW_TO_OFFSET_OF_ENTITY(uLocal_91[1], uLocal_91[0], 0f, 1f, 0f, 1f, -1, 1036831949, 1);
			func_64(uLocal_91[1], 120000, 0);
			SET_PED_KEEP_TASK(uLocal_91[1], 1);
			if (IS_PED_IN_GROUP(uLocal_91[1]))
			{
...
void func_134()
{
	if (iLocal_54 == 1)
	{
		if (!IS_PED_INJURED(uLocal_91[0]))
		{
			if (!IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_91[0], 150f, 150f, 150f, 0, 1, 0))
			{
				func_60();
			}
			if (func_144() || IS_PED_ON_FOOT(PLAYER_PED_ID()))
			{
				if (!IS_PED_IN_GROUP(uLocal_91[0]))
				{
					SET_PED_AS_GROUP_MEMBER(uLocal_91[0], func_57());
			...
			else if (IS_PED_IN_GROUP(uLocal_91[0]))
			{
				REMOVE_PED_FROM_GROUP(uLocal_91[0]);
			}
			if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
				if (IS_PED_IN_VEHICLE(uLocal_91[0], GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0))
				{
					if ((!IS_ENTITY_PLAYING_ANIM(uLocal_91[0], "random@drunk_driver_1", sLocal_113, 3) && !IS_ENTITY_PLAYING_ANIM(uLocal_91[0], "random@drunk_driver_1", sLocal_114, 3)) && !IS_PED_GETTING_INTO_A_VEHICLE(uLocal_91[0]))
					{
						TASK_PLAY_ANIM(uLocal_91[0], "random@drunk_driver_1", sLocal_113, 2f, -4f, -1, 1, 0, 0, 0, 0);
					}
					if (func_147())
				...
				else if (IS_ENTITY_PLAYING_ANIM(uLocal_91[0], "random@drunk_driver_1", sLocal_113, 3))
				{
					STOP_ANIM_PLAYBACK(uLocal_91[0], 0, 0);
				}
			}
			else
			{
				if (IS_PED_IN_ANY_VEHICLE(uLocal_91[0], 0))
				{
					if (IS_ENTITY_PLAYING_ANIM(uLocal_91[0], "random@drunk_driver_1", sLocal_113, 3))
					{
						STOP_ANIM_PLAYBACK(uLocal_91[0], 0, 0);
					}
				}
			...
			if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_91[0], 8f, 8f, 8f, 0, 1, 0) || IS_PED_IN_ANY_TAXI(PLAYER_PED_ID()))
			{
				if (DOES_BLIP_EXIST(uLocal_155[0]))
				{
					REMOVE_BLIP(&(uLocal_155[0]));
				...
				if (!DOES_BLIP_EXIST(uLocal_102))
				{
					uLocal_102 = func_137(vLocal_81, 1);
				}
			}
			else
			{
	...
	if (iLocal_54 == 2)
	{
		if ((!IS_ENTITY_DEAD(iLocal_94, 0) && !IS_PED_INJURED(uLocal_91[0])) && !IS_PED_INJURED(uLocal_91[1]))
		{
			if (!IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_91[0], 150f, 150f, 150f, 0, 1, 0) || !IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_91[1], 150f, 150f, 150f, 0, 1, 0))
			{
				if (DOES_ENTITY_EXIST(uLocal_91[0]))
				{
					if (!IS_PED_INJURED(uLocal_91[0]))
			...
			{
				if (IS_PED_IN_VEHICLE(uLocal_91[0], iLocal_94, 0) && IS_PED_IN_VEHICLE(uLocal_91[1], iLocal_94, 0))
				{
					if (func_147())
					{
						func_56(0);
...
var func_137(vector3 vParam0, int iParam3)
{
	var uVar0;
	
	uVar0 = ADD_BLIP_FOR_COORD(vParam0);
	SET_BLIP_SCALE(uVar0, func_138(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
	...
	if (!IS_PED_INJURED(uLocal_91[0]))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
		{
			if (!func_144())
			{
				...
				if (GET_SCRIPT_TASK_STATUS(uLocal_91[0], 1227113341) != 1 && GET_SCRIPT_TASK_STATUS(uLocal_91[0], 1227113341) != 0)
				{
					TASK_GO_TO_ENTITY(uLocal_91[0], PLAYER_PED_ID(), -1, 6f, 1073741824, 1073741824, 0);
				}
				if (IS_PED_IN_ANY_VEHICLE(uLocal_91[0], 0))
				{
					TASK_LEAVE_ANY_VEHICLE(uLocal_91[0], 0, 0);
				}
				if (!iLocal_122)
				{
					if (!func_4())
...
float func_140(var uParam0, var uParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
	...
	switch (*uParam1)
	{
		case 0:
			if (!IS_PED_INJURED(uParam0))
			{
				...
				TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), -1);
				CLOSE_SEQUENCE_TASK(uLocal_99);
				TASK_PERFORM_SEQUENCE(uParam0, uLocal_99);
				CLEAR_SEQUENCE_TASK(&uLocal_99);
				*uParam1++;
			}
			break;
		...
		case 1:
			if (!IS_PED_INJURED(uParam0))
			{
				if (IS_PED_FACING_PED(uParam0, PLAYER_PED_ID(), 45f))
				{
					*uParam1++;
				}
			}
...
int func_146(var uParam0, bool bParam1, bool bParam2)
{
	var uVar0;
	...
	{
		SET_BLIP_SCALE(uVar0, func_138(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
void func_149()
{
	...
	while (iLocal_63 <= (iLocal_90 - 1))
	{
		if (!DOES_BLIP_EXIST(uLocal_155[iLocal_63]))
		{
			uLocal_155[iLocal_63] = func_162(uLocal_91[iLocal_63], 0, 145);
			_0x75A16C3DA34F1245(uLocal_155[iLocal_63], 0);
		}
		iLocal_63++;
	}
}
...
int func_155()
{
	switch (func_156(&Global_25824, 0, 5, 0, GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
var func_162(var uParam0, bool bParam1, int iParam2)
{
	...
	uVar0 = func_146(uParam0, !bParam1, 0);
...
int func_164()
{
	...
	if (IS_PED_IN_ANY_VEHICLE(uLocal_91[0], 0))
	{
		if (!IS_ENTITY_DEAD(GET_VEHICLE_PED_IS_IN(uLocal_91[0], 0), 0))
		{
			iVar0 = GET_VEHICLE_LAYOUT_HASH(GET_VEHICLE_PED_IS_IN(uLocal_91[0], 0));
...
void func_167()
{
	if (!iLocal_61)
	{
		...
		func_169(43, 1);
		func_169(44, 1);
		CLEAR_AREA(vLocal_68, 8f, 1, 0, 0, 0);
		ADD_SCENARIO_BLOCKING_AREA(vLocal_68 - Vector(8f, 8f, 8f), vLocal_68 + Vector(8f, 8f, 8f), 0, 1, 1, 1);
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_76 - Vector(10f, 15f, 15f), vLocal_76 + Vector(10f, 15f, 15f), 0, 1);
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_81 - Vector(10f, 15f, 15f), vLocal_81 + Vector(10f, 15f, 15f), 0, 1);
		SET_BIT(&uLocal_150, 5);
		if (func_17() == 0)
		{
			func_168(&uLocal_173, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
		}
		else if (func_17() == 1)
		{
			func_168(&uLocal_173, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		}
		else if (func_17() == 2)
		{
			func_168(&uLocal_173, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
		}
		ADD_RELATIONSHIP_GROUP("rghDrunkPeds", &uLocal_100);
		iLocal_94 = CREATE_VEHICLE(iLocal_98, vLocal_76, fLocal_79, 1, 1, 0);
		ADD_VEHICLE_UPSIDEDOWN_CHECK(iLocal_94);
		SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_94, 1084227584);
		SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_98, 1);
		SET_VEHICLE_DOORS_LOCKED(iLocal_94, 3);
		_0x2B6747FAA9DB9D6B(iLocal_94, 1);
		iLocal_80 = GET_ENTITY_HEALTH(iLocal_94);
		uLocal_91[0] = CREATE_PED(26, iLocal_96, vLocal_68, fLocal_71, 1, 1);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_91[0], 1);
		SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_91[0], uLocal_100);
		SET_PED_CONFIG_FLAG(uLocal_91[0], 185, 1);
		SET_PED_FLEE_ATTRIBUTES(uLocal_91[0], 65536, 1);
		SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_96);
		STOP_PED_SPEAKING(uLocal_91[0], 1);
		uLocal_91[1] = CREATE_PED(26, iLocal_97, vLocal_72, fLocal_75, 1, 1);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_91[1], 1);
		SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_91[1], uLocal_100);
		SET_PED_CONFIG_FLAG(uLocal_91[1], 185, 1);
		SET_PED_FLEE_ATTRIBUTES(uLocal_91[1], 65536, 1);
		STOP_PED_SPEAKING(uLocal_91[1], 1);
		SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_100, 1862763509);
		SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_97);
		if (iLocal_54 == 1)
		{
			TASK_PLAY_ANIM(uLocal_91[0], "random@drunk_driver_1", "drunk_driver_stand_loop_dd1", 8f, -2f, -1, 1, 0, 0, 0, 0);
			TASK_PLAY_ANIM(uLocal_91[1], "random@drunk_driver_1", "drunk_driver_stand_loop_dd2", 8f, -2f, -1, 1, 0, 0, 0, 0);
			SET_PED_MOVEMENT_CLIPSET(uLocal_91[0], "MOVE_M@DRUNK@VERYDRUNK", 1048576000);
			SET_PED_MOVEMENT_CLIPSET(uLocal_91[1], "MOVE_M@DRUNK@MODERATEDRUNK", 1048576000);
			SET_PED_COMPONENT_VARIATION(uLocal_91[0], 0, 1, 2, 0);
			SET_PED_COMPONENT_VARIATION(uLocal_91[0], 3, 0, 1, 0);
			SET_PED_COMPONENT_VARIATION(uLocal_91[0], 4, 0, 1, 0);
			SET_PED_COMPONENT_VARIATION(uLocal_91[1], 0, 1, 1, 0);
			SET_PED_COMPONENT_VARIATION(uLocal_91[1], 3, 0, 0, 0);
			SET_PED_COMPONENT_VARIATION(uLocal_91[1], 4, 0, 1, 0);
			REMOVE_VEHICLE_WINDOW(iLocal_94, 1);
			SET_PED_CONFIG_FLAG(uLocal_91[0], 206, 1);
			SET_PED_CONFIG_FLAG(uLocal_91[0], 299, 1);
			SET_PED_CAN_BE_TARGETTED(uLocal_91[0], 0);
			SET_AMBIENT_VOICE_NAME(uLocal_91[0], "REDR1Drunk1_AI_Drunk");
			SET_AMBIENT_VOICE_NAME(uLocal_91[1], "A_M_Y_VINEWOOD_01_BLACK_MINI_01");
			func_168(&uLocal_173, 3, uLocal_91[0], "REDR1Drunk1", 0, 1);
			func_168(&uLocal_173, 4, uLocal_91[1], "REDR1Drunk2", 0, 1);
		}
		if (iLocal_54 == 2)
		{
			ADD_SCENARIO_BLOCKING_AREA(vLocal_81 - Vector(10f, 50f, 30f), vLocal_81 + Vector(10f, 50f, 30f), 0, 1, 1, 1);
			SET_VEHICLE_HAS_STRONG_AXLES(iLocal_94, 1);
			SET_PED_COMPONENT_VARIATION(uLocal_91[1], 0, 0, 0, 0);
			SET_PED_COMPONENT_VARIATION(uLocal_91[1], 2, 0, 2, 0);
			SET_PED_COMPONENT_VARIATION(uLocal_91[1], 3, 1, 1, 0);
			SET_PED_COMPONENT_VARIATION(uLocal_91[1], 4, 1, 2, 0);
			SET_PED_COMPONENT_VARIATION(uLocal_91[1], 8, 0, 0, 0);
			SET_PED_CONFIG_FLAG(uLocal_91[0], 134, 1);
			SET_PED_CONFIG_FLAG(uLocal_91[1], 134, 1);
			SET_PED_CONFIG_FLAG(uLocal_91[0], 26, 1);
			SET_PED_CONFIG_FLAG(uLocal_91[1], 26, 1);
			SET_PED_CONFIG_FLAG(uLocal_91[0], 206, 1);
			SET_PED_CONFIG_FLAG(uLocal_91[1], 206, 1);
			SET_PED_CAN_BE_TARGETTED(uLocal_91[0], 0);
			SET_PED_CAN_BE_TARGETTED(uLocal_91[1], 0);
			TASK_START_SCENARIO_IN_PLACE(uLocal_91[0], "WORLD_HUMAN_BUM_STANDING", 0, 0);
			TASK_LOOK_AT_ENTITY(uLocal_91[0], uLocal_91[1], -1, 2060, 4);
			TASK_START_SCENARIO_IN_PLACE(uLocal_91[1], "WORLD_HUMAN_BUM_STANDING", 0, 0);
			SET_PED_CAN_PLAY_AMBIENT_ANIMS(uLocal_91[1], 0);
			TASK_LOOK_AT_ENTITY(uLocal_91[1], uLocal_91[0], -1, 2060, 4);
			SET_PED_MOVEMENT_CLIPSET(uLocal_91[0], "MOVE_M@DRUNK@MODERATEDRUNK_HEAD_UP", 1048576000);
			SET_PED_MOVEMENT_CLIPSET(uLocal_91[1], "MOVE_M@DRUNK@SLIGHTLYDRUNK", 1048576000);
			SET_AMBIENT_VOICE_NAME(uLocal_91[0], "A_M_Y_BeachVesp_01_White_Mini_01");
			SET_AMBIENT_VOICE_NAME(uLocal_91[1], "A_F_Y_EastSA_03_Latino_FULL_01");
			func_168(&uLocal_173, 3, uLocal_91[0], "REDR2DrunkM", 0, 1);
			func_168(&uLocal_173, 4, uLocal_91[1], "REDR2DrunkF", 0, 1);
		}
		iLocal_61 = 1;
	}
}

void func_168(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_170(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_38() == 0)
		{
			uVar0 = func_83(func_171(iParam0), -1, 0);
			CLEAR_BIT(&uVar0, iParam1);
			func_79(func_171(iParam0), uVar0, -1, 1, 0);
		}
	}
	else
	{
...
int func_173(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_38() == 0)
		{
			return IS_BIT_SET(func_83(func_171(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_174()
{
	...
	if (iLocal_54 == 1)
	{
		...
		REQUEST_SCRIPT_AUDIO_BANK("Taxi_Vomit", 0, -1);
	}
	else if (iLocal_54 == 2)
	{
	...
	if (((HAS_MODEL_LOADED(iLocal_96) && HAS_MODEL_LOADED(iLocal_98)) && HAS_ANIM_SET_LOADED("MOVE_M@DRUNK@MODERATEDRUNK")) && HAS_MODEL_LOADED(iLocal_97))
	{
		if (iLocal_54 == 1)
		{
			if (((HAS_PTFX_ASSET_LOADED() && HAS_ANIM_DICT_LOADED("random@drunk_driver_1")) && HAS_ANIM_SET_LOADED("MOVE_M@DRUNK@VERYDRUNK")) && REQUEST_SCRIPT_AUDIO_BANK("CONSTRUCTION_ACCIDENT_1", 0, -1))
			{
				iLocal_56 = 1;
			}
		}
...
int func_176()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		if (VMAG2(GET_ENTITY_VELOCITY(PLAYER_PED_ID())) > 1369f && !func_187())
		{
			return 0;
		}
	}
...
int func_189()
{
	if ((Global_106554 == func_52() && GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_207(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_227()) || Global_105612) || Global_25767) || func_226()) || func_24(8, -1)) || func_225()) || func_224()) || func_223()) || func_222()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_227()) || Global_25767) || func_226()) || func_24(8, -1)) || func_223()) || func_225()) || func_224()) || func_222()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_227()) || Global_105612) || Global_25767) || func_226()) || func_24(8, -1)) || func_223()) || func_225()) || func_224()) || func_222()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_227()) || Global_105612) || Global_25767) || func_226()) || func_24(8, -1)) || func_225()) || func_224()) || func_222()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_227() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_24(8, -1)) || func_222()) || func_221()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_227()) || Global_25767) || func_226()) || func_24(8, -1)) || func_224()) || func_223()) || func_222()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_227()) || func_224()) || Global_105612) || Global_25767) || func_226()) || Global_37584) || func_24(8, -1)) || func_223()) || func_221()) || func_222()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_227()) || Global_105612) || Global_25767) || func_226()) || func_24(8, -1)) || func_223()) || func_221()) || func_225()) || func_224()) || func_222())
						{
							return 0;
						}
						break;
...
void func_235()
{
	...
	if (iLocal_172)
	{
		...
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_76 - Vector(10f, 15f, 15f), vLocal_76 + Vector(10f, 15f, 15f), 1, 1);
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_81 - Vector(10f, 15f, 15f), vLocal_81 + Vector(10f, 15f, 15f), 1, 1);
		func_151(0);
		if (!IS_ENTITY_DEAD(GET_PLAYERS_LAST_VEHICLE(), 0))
		{
		...
		{
			if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_95, 0) && func_140(PLAYER_PED_ID(), iLocal_95, 1) > 50f)
			{
		...
		if (DOES_ENTITY_EXIST(uLocal_91[0]))
		{
			if (!IS_PED_INJURED(uLocal_91[0]))
			{
				SET_PED_CONFIG_FLAG(uLocal_91[0], 317, 1);
				if (!IS_PED_IN_ANY_VEHICLE(uLocal_91[0], 0))
				{
					RESET_PED_LAST_VEHICLE(uLocal_91[0]);
				}
				if (IS_PED_IN_GROUP(uLocal_91[0]))
				{
					REMOVE_PED_FROM_GROUP(uLocal_91[0]);
		...
		while (iLocal_63 <= (iLocal_90 - 1))
		{
			if (DOES_ENTITY_EXIST(uLocal_91[iLocal_63]))
			{
				if (!IS_PED_INJURED(uLocal_91[iLocal_63]))
				{
					SET_PED_CONFIG_FLAG(uLocal_91[iLocal_63], 317, 1);
					if (!IS_PED_IN_ANY_VEHICLE(uLocal_91[iLocal_63], 0))
					{
						RESET_PED_LAST_VEHICLE(uLocal_91[iLocal_63]);
					}
					SET_PED_CAN_BE_TARGETTED(uLocal_91[iLocal_63], 1);
					SET_RELATIONSHIP_BETWEEN_GROUPS(255, uLocal_100, 1862763509);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_91[iLocal_63], 0);
				}
				SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_91[iLocal_63]));
			}
			iLocal_63++;
		}
		iLocal_63 = 0;
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_250(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_269(iParam0, 0, 0)) || func_269(iParam0, 1, 0)) || func_269(iParam0, 2, 0)) || func_268(iParam0) != 145) || func_267(iParam0)) || func_266(iParam0)) || func_265(iParam0)) || func_264(iParam0)) || !func_255(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_266(iParam0))
		{
		}
