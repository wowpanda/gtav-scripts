...
void func_1()
{
	switch (iLocal_85)
	{
		case 0:
			...
			CLEAR_HELP(1);
			func_20();
			if (!IS_STRING_NULL_OR_EMPTY(sLocal_192))
			{
				if (ARE_STRINGS_EQUAL(sLocal_192, "PRE_FKICKOFF"))
				{
					while ((GET_GAME_TIMER() - iLocal_380) < 2000)
					{
						WAIT(0);
					}
				}
...
void func_6(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_8(Global_106565.f_18527[iVar0], &vVar2, &fVar5))
			{
...
void func_22()
{
	...
	{
		case 0:
			if (func_89(iLocal_84, bLocal_28))
			{
				func_87("PRE_LEAVE", &iLocal_194);
				iLocal_85 = 1;
			}
			break;
		...
		case 2:
			...
			if ((GET_GAME_TIMER() - iLocal_379) > 2000)
			{
				func_21(&uLocal_200);
				if (func_44(&uLocal_86, &cLocal_375, &uLocal_210))
				{
					func_39();
				}
			}
		...
		case 3:
			func_37(PLAYER_PED_ID(), 16.0317f, -1118.455f, 27.8667f, 170.4274f);
			func_23(1, 1, 1);
			iLocal_85 = 2;
			break;
	}
...
void func_37(var uParam0, vector3 vParam1, float fParam4)
{
	if (func_231(uParam0))
	{
		CLEAR_PED_TASKS(uParam0);
	}
	func_38(uParam0, vParam1, fParam4, 0, 1);
}

int func_38(var uParam0, vector3 vParam1, var uParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
int func_82(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_86() == 0)
		{
			return IS_BIT_SET(func_83(func_85(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_89(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_90(1, vLocal_202, 0))
			{
				return 1;
			}
			break;
		...
		case 1:
			if (bParam1)
			{
				func_37(PLAYER_PED_ID(), vLocal_205, 354.7487f);
				bLocal_28 = false;
				func_23(1, 1, 1);
			}
			else
...
int func_90(int iParam0, vector3 vParam1, float fParam4)
{
	switch (iParam0)
	{
		case 0:
			if (func_91(vParam1, vLocal_202, 1056964608, 0) && fParam4 == 0f)
			{
				return 1;
			}
			break;
		...
		case 1:
			REQUEST_ADDITIONAL_TEXT(sLocal_193, 0);
			REQUEST_ADDITIONAL_TEXT(sLocal_209, 6);
...
void func_93(var uParam0)
{
	...
	func_72(uParam0, iVar0, PLAYER_PED_ID(), sVar1, 0, 1);
}
...
void func_94()
{
	...
	switch (iLocal_85)
	{
		case 0:
			if (func_89(iLocal_84, bLocal_28))
			{
				func_102(&uLocal_200, vLocal_205, 1, 1, "PRE_BLIP");
				if (DOES_BLIP_EXIST(uLocal_200))
				{
					SET_BLIP_COLOUR(uLocal_200, 2);
					SET_BLIP_ROUTE_COLOUR(uLocal_200, 2);
				}
				func_87("PRE_GCLOTH", &iLocal_194);
				iLocal_85 = 1;
			}
			break;
		...
		case 1:
			func_100();
			if (func_99(PLAYER_PED_ID(), vLocal_205, 2f) && func_98(28))
			{
				if (!iLocal_199)
				{
					CLEAR_PLAYER_WANTED_LEVEL(PLAYER_ID());
			...
			else
			{
				...
				else
				{
					...
					if (!func_99(PLAYER_PED_ID(), vLocal_205, 75f))
					{
						if (!iLocal_198)
						{
							func_21(&uLocal_200);
						...
						func_102(&uLocal_200, vLocal_205, 1, 1, "PRE_SHOP");
					}
					else if (func_99(PLAYER_PED_ID(), vLocal_205, 12f))
					{
						if (iLocal_198)
						{
							func_21(&uLocal_200);
...
bool func_99(var uParam0, vector3 vParam1, float fParam4)
{
...
void func_102(var uParam0, vector3 vParam1, int iParam4, bool bParam5, char* sParam6)
{
	if (!DOES_BLIP_EXIST(*uParam0))
	{
		*uParam0 = func_103(vParam1, 5, iParam4);
		if (bParam5)
		{
			SET_BLIP_NAME_FROM_TEXT_FILE(*uParam0, sParam6);
		}
	}
}

int func_103(vector3 vParam0, int iParam3, var uParam4)
{
	int iVar0;
		...
		case 0:
			if (func_89(iLocal_84, 0))
			{
				if (func_274())
				{
					...
					func_110(&uVar5, vVar1, fVar4, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
					func_107(0, -1, 1);
					iVar0 = GET_GAME_TIMER();
					while (!func_106(28) && (GET_GAME_TIMER() - iVar0) < 2000)
					{
						WAIT(0);
					}
					func_24(500, 1);
				...
				else
				{
					if (func_267(0))
					{
						func_37(PLAYER_PED_ID(), 16.5342f, -1122.583f, 27.8635f, 354.7487f);
...
void func_110(var uParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		...
		*uParam0 = func_190(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		...
		{
			func_178(iParam12, 0);
			while (!func_111(uParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				WAIT(0);
			}
		}
...
int func_111(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	var uVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam5, 0, 0, 0);
				...
				func_172(uParam0, &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam5, 0, 0, 0);
				...
				func_172(uParam0, &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				SET_VEHICLE_ENVEFF_SCALE(*uParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (GET_ENTITY_MODEL(*uParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (HAS_MODEL_LOADED(Var5))
			{
				...
				*uParam0 = CREATE_VEHICLE(Var5, vParam2, fParam5, 1, 1, 0);
				...
				func_172(uParam0, &(Var5.f_31), &(Var5.f_81));
				SET_VEHICLE_ENVEFF_SCALE(*uParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_112(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	if ((func_14(iParam0) && DOES_ENTITY_EXIST(*uParam1)) && IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_117(*uParam1, 0, &uVar0))
		{
			func_116(uParam1, &(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_106565.f_20112[iParam0 /*43*/].f_31 = func_115(*uParam1);
...
int func_117(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_145(iVar0, bParam1, uParam2) && !func_144(PLAYER_ID())) && !func_128(iParam0))
	{
		return 0;
	}
	if (func_144(PLAYER_ID()))
	{
		if (func_127(iVar0))
		{
			return 1;
	...
	bVar1 = false;
	if (func_126(PLAYER_ID()) && (IS_THIS_MODEL_A_HELI(iVar0) || IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_124(iParam0)) && !bVar1) && !(func_123(GET_ENTITY_MODEL(iParam0)) && func_119(PLAYER_ID())))
	{
	...
	if (!NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_118(iParam0) && GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_143(PLAYER_ID()) || func_142(PLAYER_ID()))
	{
		if (func_129(iParam0))
		{
			return 1;
...
int func_130(int iParam0)
{
	...
	if (func_131(GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_132(int iParam0, bool bParam1)
{
	switch (GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_134(GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_145(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_126(PLAYER_ID()) && (IS_THIS_MODEL_A_HELI(iParam0) || IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_149(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_167(iParam0, 0, 0)) || func_167(iParam0, 1, 0)) || func_167(iParam0, 2, 0)) || func_166(iParam0) != 145) || func_165(iParam0)) || func_164(iParam0)) || func_118(iParam0)) || func_163(iParam0)) || !func_153(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_164(iParam0))
		{
		}
...
int func_167(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_168(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_172(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_141(GET_ENTITY_MODEL(*uParam0), 1) && GET_VEHICLE_MOD(*uParam0, 24) != func_175(*uParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*uParam0, 24, func_175(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_174(uParam0);
	if (func_173(*uParam0))
	{
...
void func_178(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_91043[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || GET_ENTITY_MODEL(Global_91043[iVar0]) == func_179(iParam0, iParam1))
				{
...
void func_180(vector3 vParam0, float fParam3, int iParam4)
{
	int iVar0;
...
bool func_189(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
...
int func_190(vector3 vParam0, float fParam3)
{
	return func_191(&(Global_100114.f_2890), vParam0, fParam3, 0);
}

int func_191(var uParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
	...
	if (func_207(uParam0))
	{
		...
		if (func_206(uParam0))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_193(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && ARE_STRINGS_EQUAL(GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_193(var uParam0, vector3 vParam1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_194(uParam0, Global_70409.f_139[38], 0))
			{
				func_181(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_194(uParam0, Global_70409.f_139[43], 1))
			{
				func_181(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_194(uParam0, uVar1[iVar6], 1) && func_91(GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_189(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(uParam0, 1), GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_195(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_149(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_149(iVar1 + 1)))
			{
			}
			else
			{
				SET_BIT(&(uParam1->f_77), func_149(iVar1 + 1));
			}
		}
		...
		if (((IS_BIT_SET(uParam1->f_77, 15) || func_198(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_197())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
		{
			func_172(&uParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
		if (!IS_THIS_MODEL_A_HELI(uParam1->f_66) && !IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (IS_BIT_SET(uParam1->f_77, func_149(iVar2 + 1)))
				{
...
{
	return func_216(Global_100114.f_2890.f_12.f_66, vParam0, iParam3);
}

int func_216(int iParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_218()
{
	if (!bLocal_28 && iLocal_84 != 3)
	{
		if (iLocal_84 > 0)
		{
			...
			if (!bLocal_196)
			{
				if (!func_99(PLAYER_PED_ID(), vLocal_205, 150f))
				{
					func_225(2);
				}
				else if (!func_99(PLAYER_PED_ID(), vLocal_205, 75f))
				{
					if (!bLocal_208)
					{
						CLEAR_PRINTS();
						func_219("PRE_RETSHOP", &bLocal_208);
					}
				}
			}
		}
...
int func_220()
{
	...
	if (!func_221(bLocal_196, iVar0) && !bLocal_196)
	{
		return 0;
	}
	return 1;
...
void func_266(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_86() == 0)
		{
			uVar0 = func_83(func_85(iParam0), -1, 0);
			SET_BIT(&uVar0, iParam1);
			func_240(func_85(iParam0), uVar0, -1, 1, 0);
		}
	}
	else
	{
...
void func_273(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	if (func_274())
	{
...
int func_277(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_280(int iParam0)
{
	...
	func_281(&(Global_71402[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_83(func_284(iParam1, uParam0->f_2), Global_71399, 0);
			if (IS_BIT_SET(uVar0, uParam0->f_1))
			{
				SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_83(func_283(iParam1, uParam0->f_2), Global_71399, 0);
			if (IS_BIT_SET(uVar0, uParam0->f_1))
			{
				SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_83(iVar1, Global_71399, 0);
				if (!IS_BIT_SET(uVar0, uParam0->f_1))
				{
					SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_285(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_286(iParam0, iParam1, &iVar2, &uVar1, bParam2, bParam3))
	{
...
void func_288(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_281(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_281(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = _GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_289(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_346(var uParam0, int iParam1)
{
	...
	{
		func_350(&uLocal_87, *(uParam0[iVar0 /*3*/]));
		iVar0++;
	}
	func_349(&uLocal_87);
	func_347(&uLocal_139, &uLocal_87, 50f);
}
...
void func_347(var uParam0, var uParam1, float fParam2)
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_348(uParam1, *(uParam1[iVar1 /*3*/]) + vVar9))
		{
			vVar9 = { -vVar9 };
		}
...
void func_355(bool bParam0)
{
	...
	if (DOES_CAM_EXIST(uLocal_201))
	{
		RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
		DESTROY_CAM(uLocal_201, 0);
	}
}
