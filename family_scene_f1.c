...
void __EntryFunction__()
{
	...
	while (iLocal_85)
	{
		...
		{
			func_32(&uLocal_145, &uLocal_146, &uLocal_149, &uLocal_150, vLocal_114, "v_franklinshouse");
			if (func_31(126))
			{
...
int func_1(int iParam0, var uParam1, vector3 vParam2, vector3 vParam5, var uParam8)
{
	...
	while (iVar0 < 3)
	{
		...
		if (!func_27(iVar1))
		{
			if (DOES_ENTITY_EXIST(Global_91190[iVar0]))
			{
	...
	if (Global_88735 != 8)
	{
		if (Global_88736 == -1)
		{
			...
			if (func_7())
			{
				...
				iVar16 = GET_RANDOM_INT_IN_RANGE(0, iVar13);
				switch (iVar16)
				{
					case 0:
						iVar15 = 19;
...
void func_32(var uParam0, var uParam1, var uParam2, var uParam3, vector3 vParam4, char* sParam7)
{
	int iVar0;
	vector3 vVar1;
...
int func_41(int iParam0, vector3 vParam1, float fParam4)
{
	...
	if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vParam1, 1) >= (100f * fParam4))
	{
		return 0;
	}
	if (Global_93732)
...
int func_42(int iParam0)
{
	...
	if (GET_RANDOM_EVENT_FLAG() && Global_106555)
	{
		return 0;
	}
	if (!func_27(iParam0))
	...
	if (!IS_BIT_SET(Global_106565.f_9079.f_2[27 /*3*/], 1))
	{
		return 0;
	}
	return 1;
...
void func_47()
{
	...
	func_48(&uLocal_156, 0, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}
...
void func_56(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9)
{
	...
	while (iVar0 < *uParam1)
	{
		...
		if (DOES_ENTITY_EXIST((*uParam1)[iVar0]) && DOES_ENTITY_BELONG_TO_THIS_SCRIPT((*uParam1)[iVar0], 1))
		{
	...
	while (iVar0 < *uParam2)
	{
		...
		if (DOES_ENTITY_EXIST((*uParam3)[iVar0]))
		{
			...
			{
				DETACH_ENTITY((*uParam3)[iVar0], 1, 1);
			}
		}
		...
		if (DOES_ENTITY_EXIST((*uParam3)[iVar0]) && DOES_ENTITY_BELONG_TO_THIS_SCRIPT((*uParam3)[iVar0], 1))
		{
		...
		if (DOES_ENTITY_EXIST((*uParam5)[iVar0]) && DOES_ENTITY_BELONG_TO_THIS_SCRIPT((*uParam5)[iVar0], 1))
		{
...
int func_69()
{
	...
	while (iVar23 < 11)
	{
		...
		if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vVar1, 10f, iVar0, 0))
		{
			uVar24 = GET_CLOSEST_OBJECT_OF_TYPE(vVar1, 10f, iVar0, 0, 0, 1);
			if (DOES_ENTITY_EXIST(uVar24))
			{
				if (iVar5 == 825812850)
				{
					SET_ENTITY_ROTATION(uVar24, 0f, 0f, 21f, 2, 1);
				}
				SET_OBJECT_AS_NO_LONGER_NEEDED(&uVar24);
			}
		}
		if (iVar4 != 226)
		{
		}
		else if (!_DOES_DOOR_EXIST(iVar5))
		{
		}
		else
		{
			_SET_DOOR_ACCELERATION_LIMIT(iVar5, 3, 1, 1);
			_SET_DOOR_AJAR_ANGLE(iVar5, 0f, 1, 1);
			if (((iVar23 != 6 && iVar23 != 7) && iVar23 != 8) && iVar23 != 9)
			{
				REMOVE_DOOR_FROM_SYSTEM(iVar5);
			}
		}
		iVar23++;
	}
...
void func_74(var uParam0)
{
	...
	{
		if (GET_SCRIPT_TASK_STATUS(*uParam0, -2017877118) != 0)
		{
	...
	if (DOES_ENTITY_EXIST(*uParam0))
	{
		if (DOES_ENTITY_BELONG_TO_THIS_SCRIPT(*uParam0, 1))
		{
...
int func_77(var uParam0, char* sParam1, int iParam2)
{
	if (!DOES_ENTITY_EXIST(uParam0))
	{
		return 0;
	}
	if (GET_CAUSE_OF_MOST_RECENT_FORCE_CLEANUP() == 64 && GET_ENTITY_MODEL(uParam0) != joaat("prop_bong_01"))
	{
		if (!IS_ENTITY_DEAD(uParam0, 0) && !DOES_ENTITY_BELONG_TO_THIS_SCRIPT(uParam0, 1))
		{
	...
	{
		if (IS_ENTITY_A_VEHICLE(uParam0) && IS_PLAYER_PLAYING(PLAYER_ID()))
		{
			if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(uParam0), 0))
			{
				return 0;
			}
		}
	...
	if (!IS_ENTITY_DEAD(uParam0, 0))
	{
		...
		if (GET_ENTITY_MODEL(uParam0) == joaat("prop_bong_01"))
		{
			return 0;
		}
	}
