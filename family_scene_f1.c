...
int func_1(int iParam0, var uParam1, vector3 vParam2, vector3 vParam3, var uParam4)
{
	...
	while (iVar0 < 3)
	{
		...
		if (!func_27(iVar1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_90578[iVar0]))
			{
	...
	if (Global_88123 != 8)
	{
		if (Global_88124 == -1)
		{
			...
			if (func_7())
			{
				...
				{
					Global_88124 = MISC::GET_GAME_TIMER();
					return 1;
				}
			}
			else
...
int func_42(int iParam0)
{
	...
	if (MISC::GET_RANDOM_EVENT_FLAG() && Global_105210)
	{
		return 0;
	}
	if (!func_27(iParam0))
	...
	if (!MISC::IS_BIT_SET(Global_105220.f_9056.f_2[27 /*3*/], 1))
	{
		return 0;
	}
	return 1;
...
void func_61(int iParam0)
{
	...
	while (iVar1 < Global_105220.f_7659.f_198)
	{
		...
		{
			func_62(Global_105220.f_7659.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
void func_74(int iParam0)
{
	...
	{
		if (BRAIN::GET_SCRIPT_TASK_STATUS(*iParam0, -2017877118) != 0)
		{
