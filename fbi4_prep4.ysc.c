...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_261(0))
	{
		Global_19E56.f_933.f_21B.f_947[0] = 4294967197;
		Global_19E56.f_933.f_21B.f_947[1] = 4294967197;
		Global_19E56.f_933.f_21B.f_947[2] = 4294967197;
		func_229();
	}
	while (true)
	{
		RECORDING::_0x208784099002BC30("M_MS", 0);
		if (func_228(AUDIO::_0x0626A247D2405330()))
		{
			if (iLocal_80 == 2)
			{
				iLocal_191 = func_227();
...
void func_4(int iParam0)//Position - 0x28C
{
	...
	if (Global_19E56.f_2361 || func_261(0))
	{
		iVar0 = func_17();
		if (!func_5(iVar0))
		{
...
void func_22()//Position - 0x129F
{
	switch (iLocal_81)
	{
		case 0:
			...
			{
				BRAIN::TASK_LOOK_AT_COORD(AUDIO::_0x0626A247D2405330(), -1335.905f, -1278.671f, 5.07569f, 4294967295, 0, 2);
				iLocal_81 = 1;
			}
			break;
		
		case 1:
			if (func_87(AUDIO::_0x0626A247D2405330(), vLocal_196, 2f) && func_81(21))
			{
			...
			else
			{
				...
				else if (!func_87(AUDIO::_0x0626A247D2405330(), vLocal_195, 75f))
				{
					if (!iLocal_201)
					{
						func_21(&iLocal_192);
				...
				else if (func_87(AUDIO::_0x0626A247D2405330(), vLocal_196, 12f))
				{
					if (iLocal_201)
					{
						func_21(&iLocal_192);
		...
		case 2:
			if ((MISC::GET_GAME_TIMER() - iLocal_198) > 2000)
			{
				...
				{
					func_41(0, 4294967295);
					if ((Global_19E56.f_933.f_21B.f_947[0] == 38 && Global_19E56.f_933.f_21B.f_947[1] == 33) && Global_19E56.f_933.f_21B.f_947[2] == 54)
					{
						func_40(821);
					}
					func_37();
		...
		case 3:
			Global_19E56.f_933.f_21B.f_947[0] = 38;
			Global_19E56.f_933.f_21B.f_947[1] = 33;
			Global_19E56.f_933.f_21B.f_947[2] = 54;
			func_23(1, 1, 1);
			iLocal_81 = 2;
			break;
	}
...
int func_26(int iParam0)//Position - 0x15B4
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_27(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x15D5
{
	if (bParam0)
	{
...
int func_30(int iParam0, bool bParam1)//Position - 0x1766
{
	int iVar0;
	int iVar1;
...
int func_31()//Position - 0x17A7
{
	return Global_1407E0;
}

int func_32(int iParam0)//Position - 0x17B3
{
...
bool func_33()//Position - 0x17F5
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_240006, 3);
}

int func_34(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x1806
{
	int iVar0;
...
void func_36(int iParam0)//Position - 0x1860
{
	if (iParam0 == 1)
	{
...
void func_38(bool bParam0, int iParam1)//Position - 0x1899
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	if (bParam0)
	{
		if ((func_261(0) && Global_1171B.f_1 == 1) && func_39(Global_1171B))
		{
		}
		else
		{
...
int func_39(int iParam0)//Position - 0x196F
{
	switch (iParam0)
	{
		case 71:
...
void func_40(int iParam0)//Position - 0x19AD
{
	bool bVar0;
	int iVar1;
...
void func_41(bool bParam0, int iParam1)//Position - 0x1A1E
{
	int iVar0;
...
int func_42(var uParam0, char* sParam1, var uParam2)//Position - 0x1AB8
{
	switch (*uParam0)
	{
		case 0:
...
void func_43(int iParam0, int iParam1)//Position - 0x1C2D
{
...
int func_44(int iParam0)//Position - 0x1C6A
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
void func_46(bool bParam0)//Position - 0x1CE7
{
...
void func_47(char* sParam0, char* sParam1)//Position - 0x1CFB
{
	if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
	{
		Global_3E07 = 1;
...
void func_49()//Position - 0x1D41
{
	...
	func_50(func_53(), 0, func_11(), func_70(), 9, 6000, 6000, 4294967295, 0, 4294967295, 0);
}

int func_50(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x1D98
{
	struct<15> Var0;
	int iVar1;
...
void func_51(int iParam0)//Position - 0x1EE9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_52(int iParam0)//Position - 0x1FAD
{
	switch (iParam0)
	{
		case 0:
...
int func_54()//Position - 0x213D
{
	return Global_1172B;
}

int func_55(int iParam0, int iParam1)//Position - 0x2149
{
	int iVar0;
...
int func_56(int iParam0)//Position - 0x21A5
{
	if (iParam0 > 3)
	{
		return 0;
	...
	return Global_162B5[func_57(iParam0)];
}

int func_57(int iParam0)//Position - 0x21D6
{
	if (iParam0 == 0)
	{
		return 0;
...
struct<4> func_58(bool bParam0)//Position - 0x2211
{
	struct<4> Var0;
...
bool func_59(var uParam0, var uParam1, int iParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)//Position - 0x2277
{
...
int func_60(char* sParam0, int iParam1, bool bParam2)//Position - 0x22DF
{
	Global_3DCF = 0;
...
bool func_66(int iParam0, int iParam1)//Position - 0x2803
{
	switch (iParam0)
	{
		case 5:
...
void func_68(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2895
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = uParam1;
...
void func_71(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2A2C
{
...
void func_72(int iParam0, int iParam1)//Position - 0x2AC7
{
...
void func_73(bool bParam0)//Position - 0x2B0C
{
	if (bParam0)
	{
		func_50(1527885205, 0, func_11(), 23, 3, 6000, 6000, 4294967295, 0, 4294967295, 0);
	}
	else if (!func_75(3))
	{
		func_50(4070275669, 0, func_11(), 23, 3, 6000, 6000, 4294967295, 50, 4294967295, 0);
	}
	else
	{
		func_50(4070275669, 0, func_11(), 23, 3, 6000, 6000, 4294967295, 0, 4294967295, 0);
	}
}

int func_74()//Position - 0x2B7D
{
...
int func_75(int iParam0)//Position - 0x2BA8
{
...
int func_77(int iParam0)//Position - 0x2C1C
{
	if (iParam0 == 146 || iParam0 == 4294967295)
	{
		return 0;
...
void func_78(int iParam0, vector3 vParam1, bool bParam2, bool bParam3, char* sParam4)//Position - 0x2C49
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_79(vector3 vParam0, int iParam1, bool bParam2)//Position - 0x2C78
{
	int iVar0;
...
bool func_80(char* sParam0, int iParam1, int iParam2)//Position - 0x2CA6
{
...
int func_81(int iParam0)//Position - 0x2CC4
{
	return func_82(iParam0, 6, 1);
}

int func_82(int iParam0, int iParam1, bool bParam2)//Position - 0x2CD4
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
int func_83(int iParam0, int iParam1, int iParam2)//Position - 0x2D3E
{
	int iVar0;
	var uVar1;
...
int func_84(var uParam0)//Position - 0x2D70
{
	int iVar0;
	int iVar1;
...
int func_85(int iParam0)//Position - 0x2DA4
{
	switch (iParam0)
	{
		case 0:
...
int func_86()//Position - 0x30A7
{
	return Global_6373;
}

bool func_87(int iParam0, vector3 vParam1, float fParam2)//Position - 0x30B2
{
	return SYSTEM::VDIST2(unk_0x8000C77B5F336760(iParam0, true), vParam1) <= (fParam2 * fParam2);
}

int func_88(int iParam0, bool bParam1)//Position - 0x30CF
{
	func_93();
	switch (iParam0)
	{
		...
		case 1:
			if (bParam1)
			{
				func_89(AUDIO::_0x0626A247D2405330(), -1339.786f, -1277.51f, 3.8874f, 261.2839f);
				bLocal_28 = false;
				func_23(1, 1, 1);
			}
			else
		...
		case 2:
			if (bParam1)
			{
				func_89(AUDIO::_0x0626A247D2405330(), vLocal_196, 261.2839f);
				bLocal_28 = false;
				func_23(1, 1, 1);
			}
			else
...
void func_89(int iParam0, vector3 vParam1, float fParam2)//Position - 0x317A
{
	if (func_228(iParam0))
	{
...
int func_90(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)//Position - 0x31A0
{
	bool bVar0;
	float fVar1;
...
int func_91(int iParam0, vector3 vParam1, float fParam2)//Position - 0x31FC
{
	switch (iParam0)
	{
		case 0:
...
int func_92(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x3264
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_93()//Position - 0x32DF
{
	func_94(&uLocal_204);
}

void func_94(var uParam0)//Position - 0x32ED
{
	int iVar0;
	char* sVar1;
	...
	func_71(uParam0, iVar0, AUDIO::_0x0626A247D2405330(), sVar1, 0, 1);
}

void func_95()//Position - 0x3343
{
	switch (iLocal_81)
	{
		case 0:
		...
		case 1:
			if (!iLocal_197)
			{
				if (func_87(AUDIO::_0x0626A247D2405330(), vLocal_195, 60f))
				{
		...
		case 3:
			func_89(AUDIO::_0x0626A247D2405330(), vLocal_196, 0f);
			func_23(1, 1, 1);
			iLocal_81 = 1;
			break;
	}
...
void func_96(bool bParam0)//Position - 0x348B
{
	func_97(iLocal_80);
...
void func_97(int iParam0)//Position - 0x34BE
{
	switch (iParam0)
	{
		case 0:
...
void func_98(int iParam0, bool bParam1)//Position - 0x34D6
{
	int iVar0;
...
bool func_99(int iParam0)//Position - 0x3520
{
	return func_82(iParam0, 5, 1);
}

void func_100(char* sParam0, int iParam1)//Position - 0x3530
{
	if (!*iParam1)
	{
...
void func_101(char* sParam0, int iParam1, int iParam2)//Position - 0x354D
{
	iParam2 = iParam2;
...
void func_103(int iParam0)//Position - 0x368B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
bool func_104(int iParam0)//Position - 0x36C3
{
	return func_82(iParam0, 0, 1);
}

void func_105(int iParam0, int iParam1, int iParam2)//Position - 0x36D3
{
...
void func_106(int iParam0)//Position - 0x3797
{
	if (iParam0 == 1)
	{
...
bool func_107()//Position - 0x37C0
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_16C30.f_14, 13);
}

void func_108(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x37D4
{
	int iVar0;
...
int func_109(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)//Position - 0x3968
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_170(iParam0, &(Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/].f_1F), &(Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/].f_51));
		...
		else if (Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_170(iParam0, &(Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/].f_1F), &(Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/].f_51));
				GRAPHICS::_ADD_CLAN_DECAL_TO_VEHICLE(*iParam0, Var2.f_60);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("BODHI2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2, vParam2, fParam3, 1, 1, 0);
				...
				func_170(iParam0, &(Var2.f_1F), &(Var2.f_51));
				GRAPHICS::_ADD_CLAN_DECAL_TO_VEHICLE(*iParam0, Var2.f_60);
				if (iParam1 == 1)
				{
...
void func_110(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x47AD
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_14(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(*iParam1, 0))
	{
		...
		{
			func_114(iParam1, &(Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_1F), &(Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_51));
			if (bParam3)
			{
				...
				Global_19E56.f_4E7A[iParam0 /*43*/].f_1F = func_113(*iParam1);
				...
				func_111(Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_19E56.f_4E7A[iParam0 /*43*/].f_1));
				...
				func_111(Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_6, 4294967295, iVar3, 0, &(Global_19E56.f_4E7A[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_111(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x53C1
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_112(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x5434
{
	*uParam2 = 4294967295;
	*uParam3 = 4294967295;
	*uParam4 = 4294967295;
...
float func_113(int iParam0)//Position - 0x6926
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_114(int iParam0, var uParam1, var uParam2)//Position - 0x69D6
{
	int iVar0;
	int iVar1;
...
int func_115(int iParam0, bool bParam1, var uParam2)//Position - 0x6BC9
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	if ((!func_143(iVar0, bParam1, uParam2) && !func_142(CAM::_0xDC9DA9E8789F5246())) && !func_126(iParam0))
	{
		return 0;
	}
	if (func_142(CAM::_0xDC9DA9E8789F5246()))
	{
		if (func_125(iVar0))
		{
			return 1;
	...
	bVar1 = false;
	if (func_124(CAM::_0xDC9DA9E8789F5246()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_122(iParam0)) && !bVar1) && !(func_121(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_117(CAM::_0xDC9DA9E8789F5246())))
	{
...
int func_116(int iParam0)//Position - 0x6D37
{
	int iVar0;
...
int func_117(int iParam0)//Position - 0x6D72
{
	if (iParam0 != func_120())
	{
		if (func_119(iParam0, 1, 1))
		{
			...
			{
				return func_118(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 11;
			}
		}
	}
	return 0;
...
int func_118(int iParam0)//Position - 0x6DB9
{
	switch (iParam0)
	{
		case 0:
...
int func_119(int iParam0, bool bParam1, bool bParam2)//Position - 0x7113
{
	int iVar0;
...
int func_120()//Position - 0x715D
{
	return 4294967295;
}

int func_121(int iParam0)//Position - 0x7166
{
...
int func_122(int iParam0)//Position - 0x71A8
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
...
int func_123(int iParam0)//Position - 0x723B
{
	if (iParam0 != func_120())
	{
		if (func_119(iParam0, 1, 1))
		{
			if (Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295)
			{
				return func_118(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 13;
			}
		}
	}
	return 0;
...
int func_124(int iParam0)//Position - 0x7282
{
	if (iParam0 != func_120())
	{
		if (func_119(iParam0, 1, 1))
		{
			if (Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295)
			{
				return func_118(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 7;
			}
		}
	}
	return 0;
...
int func_125(int iParam0)//Position - 0x72C8
{
	switch (iParam0)
	{
		case joaat("AVENGER"):
...
int func_126(int iParam0)//Position - 0x72FD
{
	if (func_141(CAM::_0xDC9DA9E8789F5246()) || func_140(CAM::_0xDC9DA9E8789F5246()))
	{
		if (func_127(iParam0))
		{
			return 1;
...
int func_127(int iParam0)//Position - 0x732C
{
...
int func_128(int iParam0)//Position - 0x73E3
{
...
int func_129(int iParam0)//Position - 0x7419
{
	switch (iParam0)
	{
		case joaat("APC"):
...
int func_130(int iParam0, bool bParam1)//Position - 0x7472
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("INSURGENT"):
			if (func_132(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				...
				else if (func_131(iParam0) != 4294967295 && !bParam1)
				{
					return 1;
				}
			}
...
int func_131(int iParam0)//Position - 0x74CD
{
	int iVar0;
...
int func_132(int iParam0, int iParam1)//Position - 0x7507
{
	if (iParam1 == 0)
	{
...
bool func_133()//Position - 0x787B
{
	return DLC::IS_DLC_PRESENT(1927191088);
}

bool func_134()//Position - 0x788C
{
	return DLC::IS_DLC_PRESENT(2067165443);
}

bool func_135()//Position - 0x789D
{
	return DLC::IS_DLC_PRESENT(3337689893);
}

bool func_136()//Position - 0x78AE
{
	return DLC::IS_DLC_PRESENT(210122941);
}

bool func_137()//Position - 0x78BF
{
	return DLC::IS_DLC_PRESENT(2400444888);
}

bool func_138()//Position - 0x78D0
{
	return DLC::IS_DLC_PRESENT(1630677557);
}

int func_139(int iParam0, int iParam1)//Position - 0x78E1
{
	switch (iParam0)
	{
		case joaat("FACTION2"):
...
int func_140(int iParam0)//Position - 0x7C57
{
	if (iParam0 != func_120())
	{
		if (func_119(iParam0, 1, 1))
		{
			if (Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295 && Global_24FBF9[iParam0 /*413*/].f_135.f_7 != func_120())
			{
				return func_118(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 5;
			}
		}
	}
	return 0;
...
int func_141(int iParam0)//Position - 0x7CB6
{
	if (iParam0 != func_120())
	{
		if (func_119(iParam0, 1, 1))
		{
			if (Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295 && Global_24FBF9[iParam0 /*413*/].f_135.f_7 != func_120())
			{
				return func_118(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 8;
			}
		}
	}
	return 0;
...
int func_142(int iParam0)//Position - 0x7D16
{
	if (iParam0 != func_120())
	{
		if (func_119(iParam0, 1, 1))
		{
			if (Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295)
			{
				return func_118(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 9;
			}
		}
	}
	return 0;
...
int func_143(int iParam0, bool bParam1, var uParam2)//Position - 0x7D5D
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_124(CAM::_0xDC9DA9E8789F5246()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_144(int iParam0)//Position - 0x8176
{
	switch (iParam0)
	{
		case joaat("TOWTRUCK"):
...
void func_145(int iParam0, int iParam1)//Position - 0x819F
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_146(iParam0, &(Global_19E56.f_7F5D.f_1586));
}

void func_146(int iParam0, var uParam1)//Position - 0x83A1
{
	int iVar0;
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		if (uParam1->f_41 == 4294967295 && !func_148(uParam1->f_42))
		{
			uParam1->f_41 = 0;
		}
		...
		func_114(&iParam0, &(uParam1->f_9), &(uParam1->f_3B));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
			{
				MISC::SET_BIT(&(uParam1->f_4D), func_147(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_147(int iParam0)//Position - 0x864C
{
	switch (iParam0)
	{
		case 1:
...
int func_148(int iParam0)//Position - 0x86FC
{
	switch (iParam0)
	{
		case joaat("GRANGER"):
...
void func_149(var uParam0)//Position - 0x871C
{
	int iVar0;
...
int func_150(int iParam0)//Position - 0x87CC
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0)) || func_165(iParam0, 0, 0)) || func_165(iParam0, 1, 0)) || func_165(iParam0, 2, 0)) || func_164(iParam0) != 145) || func_163(iParam0)) || func_162(iParam0)) || func_116(iParam0)) || func_161(iParam0)) || !func_151(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_162(iParam0))
		{
		}
...
int func_151(int iParam0)//Position - 0x88A9
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_152(int iParam0, bool bParam1)//Position - 0x8A5A
{
	int iVar0;
	struct<2> Var1;
...
int func_153(int iParam0)//Position - 0x8BDA
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_155(int iParam0)//Position - 0x8CBD
{
	int iVar0;
	int iVar1;
...
int func_156()//Position - 0xA9B8
{
	return 0;
}

int func_157()//Position - 0xA9C1
{
	return 1;
}

int func_158()//Position - 0xA9CA
{
	return 1;
}

int func_159()//Position - 0xA9D3
{
...
int func_161(int iParam0)//Position - 0xAAA7
{
	int iVar0;
	char* sVar1;
...
int func_162(int iParam0)//Position - 0xAAED
{
	int iVar0;
...
int func_163(int iParam0)//Position - 0xAB69
{
	int iVar0;
...
int func_164(int iParam0)//Position - 0xAC51
{
	int iVar0;
...
int func_165(int iParam0, int iParam1, bool bParam2)//Position - 0xACB4
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_166(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0xAD25
{
...
void func_167(int iParam0, int iParam1)//Position - 0xADFD
{
	int iVar0;
...
void func_168(int iParam0)//Position - 0xAE7F
{
	if (!func_169(*iParam0))
	{
...
bool func_169(int iParam0)//Position - 0xAEAA
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_170(int iParam0, var uParam1, var uParam2)//Position - 0xAEB9
{
	int iVar0;
	int iVar1;
...
int func_171(int iParam0)//Position - 0xB07C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_172(var uParam0)//Position - 0xB158
{
...
int func_173(int iParam0, int iParam1)//Position - 0xB198
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_174(var uParam0, int iParam1)//Position - 0xB27D
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_175(int iParam0, var uParam1, int iParam2)//Position - 0xB2BE
{
	int iVar0;
...
void func_176(int iParam0, int iParam1)//Position - 0xB51A
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_16222[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_16222[iVar0]) == func_177(iParam0, iParam1))
				{
...
int func_177(int iParam0, int iParam1)//Position - 0xB5B8
{
	struct<82> Var0;
...
void func_178(vector3 vParam0, float fParam1, bool bParam2)//Position - 0xB5FA
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_186(&(Global_11188.f_22B[0 /*21*/]), iVar0))
		{
...
void func_179(int iParam0)//Position - 0xB64A
{
	bool bVar0;
	...
	if (func_186(&(Global_11188.f_22B[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_185(iParam0, 0)) && Global_11515.f_42 == 0) && Global_19E56.f_7F5D.f_7A6[Global_11188.f_22B[0 /*21*/].f_E] != 0) && Global_19E56.f_7F5D.f_7A6[Global_11188.f_22B[0 /*21*/].f_E] > 3) && (!func_183(0, Global_11188.f_22B[0 /*21*/].f_C) || !func_183(1, Global_11188.f_22B[0 /*21*/].f_C)))
			{
				func_182(&(Global_19E56.f_7F5D.f_45[Global_11188.f_22B[0 /*21*/].f_E /*78*/]), &Global_11515);
...
void func_180(int iParam0, bool bParam1)//Position - 0xB7BC
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_181(int iParam0, int iParam1, bool bParam2)//Position - 0xB819
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_182(var uParam0, var uParam1)//Position - 0xB854
{
...
int func_183(int iParam0, int iParam1)//Position - 0xB920
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_184(&(Global_19E56.f_7F5D.f_13AE[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_152(Global_19E56.f_7F5D.f_13AE[iVar0 /*157*/][iParam0 /*78*/].f_42, 0);
}

int func_184(var uParam0)//Position - 0xB992
{
	return *uParam0;
}

bool func_185(int iParam0, int iParam1)//Position - 0xB99D
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
int func_186(var uParam0, int iParam1)//Position - 0xB9C0
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam0->f_9, 10))
	{
		...
		if (!func_187(Global_19E56.f_7F5D.f_748[uParam0->f_E /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_187(Global_19E56.f_933.f_21B.f_DF0[1 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_187(Global_19E56.f_933.f_21B.f_DF0[0 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
...
bool func_187(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0xD0B9
{
	if (bParam2)
	{
...
int func_188(vector3 vParam0, float fParam1)//Position - 0xD100
{
	return func_189(&(Global_18531.f_B3B), vParam0, fParam1, 0);
}

int func_189(var uParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xD11A
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam3)
					{
						...
						{
							func_176(uParam0->f_B, 1);
						}
						else if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar0)))
						{
							func_176(uParam0->f_B, 2);
						}
					}
					VEHICLE::_0xAB04325045427AAE(iVar0, 0);
					VEHICLE::_0x428BACCDF5E26EAD(iVar0, 0);
					VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(iVar0, true);
					func_167(iVar0, uParam0->f_B);
				}
				else if ((!func_191(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_A) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_190(int iParam0)//Position - 0xD3CC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_191(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xD48F
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("CARGOBOB"):
			if (func_192(iParam0, Global_11188.f_8B[38], 0))
			{
				func_179(38);
				return 1;
			}
		...
		case joaat("FIRETRUK"):
			if (func_192(iParam0, Global_11188.f_8B[43], 1))
			{
				func_179(43);
				return 1;
			}
		...
		case joaat("CUBAN800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_192(iParam0, uVar1[iVar3], 1) && func_92(unk_0x8000C77B5F336760(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_187(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(iParam0, true), unk_0x8000C77B5F336760(uVar1[iVar3], true), true) < 10f)
					{
...
int func_192(int iParam0, int iParam1, bool bParam2)//Position - 0xD697
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_193(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0xD6F8
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam1->f_4D, func_147(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam1->f_4D, func_147(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_4D), func_147(iVar1 + 1));
			}
		}
		...
		if (((INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam1->f_4D, 15) || func_196(iParam0)) || (((uParam1->f_3E == 0 && uParam1->f_3F == 0) && uParam1->f_40 == 0) && uParam1->f_9[20] > 0)) && func_195())
		{
			uParam1->f_3E = 0;
			uParam1->f_3F = 0;
			uParam1->f_40 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_42) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_42))
		{
			...
			while (iVar2 <= 11)
			{
				if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam1->f_4D, func_147(iVar2 + 1)))
				{
...
void func_194(int iParam0, int iParam1)//Position - 0xDC48
{
	int iVar0;
	int iVar1;
...
bool func_195()//Position - 0xDCAD
{
	return DLC::IS_DLC_PRESENT(2603778600);
}

int func_196(int iParam0)//Position - 0xDCBE
{
	int iVar0;
...
int func_197(int iParam0)//Position - 0xDD09
{
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
		if (!func_203(CAM::_0xDC9DA9E8789F5246(), 4294967295))
		{
	...
	if (func_199(CAM::_0xDC9DA9E8789F5246()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
		{
			if (func_198(iParam0) != 4294967295)
			{
				return 1;
			}
		}
...
int func_198(int iParam0)//Position - 0xDD90
{
...
int func_199(int iParam0)//Position - 0xDDBF
{
...
int func_200(int iParam0)//Position - 0xDDDC
{
...
int func_201(int iParam0, int iParam1)//Position - 0xDDFF
{
...
int func_202(int iParam0)//Position - 0xDE3A
{
	if (func_201(iParam0, 0))
	{
...
int func_203(int iParam0, int iParam1)//Position - 0xDE5D
{
	int iVar0;
...
int func_204(var uParam0)//Position - 0xDEAA
{
	if (func_205(uParam0))
	{
...
int func_205(var uParam0)//Position - 0xDEDF
{
	if (uParam0->f_C.f_42 == 0)
	{
		return 0;
	}
	if (!func_152(uParam0->f_C.f_42, 0))
	{
		return 0;
	}
	if (uParam0->f_C.f_42 == joaat("STUNT") && func_92(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
bool func_206()//Position - 0xDF3E
{
	return func_204(&(Global_18531.f_B3B));
}

void func_207()//Position - 0xDF51
{
	func_208(&(Global_18531.f_B3B));
}

void func_208(var uParam0)//Position - 0xDF64
{
	if (func_205(uParam0))
	{
...
int func_209(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDF82
{
	...
	if (iParam2 == 0 && func_211(Global_18531.f_B3B.f_C.f_42))
	{
		return 0;
	}
...
int func_211(int iParam0)//Position - 0xE085
{
	switch (iParam0)
	{
		case joaat("POLICE"):
...
bool func_212()//Position - 0xE0DE
{
	return func_205(&(Global_18531.f_B3B));
}

void func_213(int iParam0)//Position - 0xE0F1
{
	Global_15C5E = 0;
	switch (iParam0)
	{
...
void func_214(int iParam0)//Position - 0xE17F
{
	MISC::SET_BIT(&Global_15C5E, iParam0);
}

void func_215()//Position - 0xE191
{
	if (!bLocal_28 && iLocal_80 != 3)
	{
		if (iLocal_80 > 0)
		{
			...
			if (!bLocal_190)
			{
				if (!func_87(AUDIO::_0x0626A247D2405330(), vLocal_195, 150f))
				{
					func_221(2);
				}
				else if (!func_87(AUDIO::_0x0626A247D2405330(), vLocal_195, 75f))
...
int func_217(bool bParam0, int iParam1)//Position - 0xE288
{
	int iVar0;
...
int func_218(int iParam0, int iParam1)//Position - 0xE2D4
{
	int iVar0;
...
int func_219(int iParam0)//Position - 0xE2E9
{
	return Global_D06B[iParam0];
}

bool func_220(int iParam0)//Position - 0xE2F8
{
	return func_82(iParam0, 1, 1);
}

void func_221(int iParam0)//Position - 0xE308
{
	HUD::CLEAR_PRINTS();
	func_222();
	switch (iParam0)
...
void func_222()//Position - 0xE36A
{
	Global_3960 = 0;
	func_67();
}

int func_223()//Position - 0xE37A
{
	func_224();
	if (iLocal_191 >= 3)
	{
...
void func_224()//Position - 0xE3BF
{
	if (func_226())
	{
		...
		{
			case 0:
				if (Global_19E56.f_933.f_21B.f_947[0] == 4294967197)
				{
					func_225(sLocal_202[0], sLocal_202[1], sLocal_202[2]);
				}
				else if (Global_19E56.f_933.f_21B.f_947[1] == 4294967197)
				{
					func_225(sLocal_202[1], sLocal_202[0], sLocal_202[2]);
				}
				else if (Global_19E56.f_933.f_21B.f_947[2] == 4294967197)
				{
			...
			case 1:
				if (Global_19E56.f_933.f_21B.f_947[1] == 4294967197)
				{
					func_225(sLocal_202[1], sLocal_202[0], sLocal_202[2]);
				}
				else if (Global_19E56.f_933.f_21B.f_947[0] == 4294967197)
				{
					func_225(sLocal_202[0], sLocal_202[1], sLocal_202[2]);
				}
				else if (Global_19E56.f_933.f_21B.f_947[2] == 4294967197)
			...
			case 2:
				if (Global_19E56.f_933.f_21B.f_947[2] == 4294967197)
				{
					func_225(sLocal_202[2], sLocal_202[1], sLocal_202[0]);
				}
				else if (Global_19E56.f_933.f_21B.f_947[0] == 4294967197)
...
void func_225(char* sParam0, char* sParam1, char* sParam2)//Position - 0xE575
{
...
bool func_226()//Position - 0xE5B1
{
	return MISC::GET_GAME_TIMER() <= Global_43D7.f_16F1 + 100;
}

int func_227()//Position - 0xE5C6
{
	int iVar0;
	int iVar1;
	...
	while (iVar1 <= 2)
	{
		if (Global_19E56.f_933.f_21B.f_947[iVar1] != 4294967197)
		{
			iVar0++;
		}
		iVar1++;
...
int func_228(int iParam0)//Position - 0xE602
{
	if (func_26(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_230(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xE672
{
	int iVar0;
	int iVar1;
	...
	func_231(Global_19E56.f_6D76[iParam0 /*29*/].f_11, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
int func_231(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xE759
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_232(bool bParam0)//Position - 0xED58
{
	int iVar0;
	int iVar1;
...
void func_233(int iParam0)//Position - 0xEFDA
{
	int iVar0;
...
void func_234(int iParam0)//Position - 0xF034
{
	bool bVar0;
	char cVar1[64];
	...
	if (iParam0 == 8)
	{
		func_237(129, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 9)
	{
		func_237(135, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 10)
	{
		func_237(136, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 11)
	{
		func_237(137, 0, 4294967295, 1);
		return;
	}
	bVar0 = false;
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_5038.f_1D7, iParam0) || INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_236() /*12745*/].f_1FF2.f_A, iParam0))
	{
		bVar0 = true;
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_19E56.f_5038.f_1D7), iParam0);
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_200000[func_236() /*12745*/].f_1FF2.f_A), iParam0);
	}
	if (bVar0)
	{
...
char* func_235(int iParam0)//Position - 0xF146
{
	switch (iParam0)
	{
		case 0:
...
int func_237(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF201
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_238(int iParam0)//Position - 0xF769
{
	func_259(93, iParam0);
	func_259(29, iParam0);
	func_259(30, iParam0);
...
bool func_239(int iParam0)//Position - 0xF789
{
	if (iParam0 == 8)
	{
		return func_240(129, 4294967295, 4294967295);
	}
	if (iParam0 == 9)
	{
		return func_240(135, 4294967295, 4294967295);
	}
	if (iParam0 == 10)
	{
		return func_240(136, 4294967295, 4294967295);
	}
	if (iParam0 == 11)
	{
		return func_240(137, 4294967295, 4294967295);
	}
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_5038.f_1D7, iParam0);
	}
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_236() /*12745*/].f_1FF2.f_A, iParam0);
}

int func_240(int iParam0, int iParam1, int iParam2)//Position - 0xF80D
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_241(int iParam0)//Position - 0xF84A
{
	int iVar0;
...
int func_242(int iParam0, int iParam1)//Position - 0xFB62
{
	int iVar0;
...
int func_243(bool bParam0)//Position - 0xFE5A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_244(int iParam0, int iParam1)//Position - 0xFF11
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_245(int iParam0, int iParam1)//Position - 0xFF2C
{
	...
	if (func_255(&Global_412216))
	{
		if (func_253(&Global_412216, iParam0))
		{
			return 0;
		}
		if (func_246(&Global_412216, iParam0))
		{
			return 1;
		}
	}
...
int func_246(var uParam0, int iParam1)//Position - 0xFFC9
{
	int iVar0;
	var uVar1[78];
...
int func_247(var uParam0, int iParam1)//Position - 0x1007C
{
	int iVar0;
...
bool func_248(var uParam0, int iParam1)//Position - 0x100F7
{
	return (*uParam0)[iParam1] == 78;
}

void func_249(var uParam0)//Position - 0x10108
{
	int iVar0;
	...
	func_251(uParam0, (Global_412215 - 0.5f));
}

void func_250(var uParam0, int iParam1)//Position - 0x1013C
{
	(*uParam0)[iParam1] = 78;
}

void func_251(var uParam0, float fParam1)//Position - 0x1014C
{
	if (fParam1 == 0f)
	{
		uParam0->f_50 = 0f;
...
float func_252(var uParam0)//Position - 0x10169
{
	return uParam0->f_50;
}

bool func_253(var uParam0, int iParam1)//Position - 0x10175
{
	return func_254(uParam0, iParam1) != 4294967295;
}

int func_254(var uParam0, int iParam1)//Position - 0x10187
{
	int iVar0;
...
bool func_255(var uParam0)//Position - 0x101B4
{
	return uParam0->f_4F == 1;
}

int func_256(int iParam0)//Position - 0x101C2
{
	switch (iParam0)
	{
		case 60:
...
int func_257(int iParam0, int iParam1)//Position - 0x10212
{
	int iVar0;
...
void func_258(int iParam0, int iParam1)//Position - 0x10263
{
	int iVar0;
...
void func_259(int iParam0, int iParam1)//Position - 0x10286
{
	int iVar0;
...
void func_260()//Position - 0x102E3
{
	int iVar0;
...
bool func_261(bool bParam0)//Position - 0x10358
{
...
void func_262(vector3 vParam0, float fParam1, int iParam2, int iParam3)//Position - 0x10383
{
	if (func_263())
	{
...
void func_264()//Position - 0x1043C
{
...
int func_265(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x1078C
{
	Global_11569[1 /*14*/] = { func_267(iParam0, iParam1, iParam2, 4294967295) };
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11569[1 /*14*/].f_6, 0) && !INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11569[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_266(iParam1, Global_11569[1 /*14*/].f_5, Global_11569[1 /*14*/].f_2, 0, Global_11569[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_266(iParam1, Global_11569[1 /*14*/].f_5, Global_11569[1 /*14*/].f_2, 0, Global_11569[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
int func_266(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x10828
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_267(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11746
{
	func_332();
...
void func_268(int iParam0, int iParam1)//Position - 0x11798
{
	switch (iParam0)
	{
		case 0:
...
void func_269(int iParam0)//Position - 0x11888
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 155, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_270(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x12AFF
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_274(Global_280004, 1, 1, 1, 4294967295))
			{
				GRAPHICS::_0x35FB78DC42B7BD21(&(uParam0->f_6), 2);
			}
			if (!func_274(Global_280004, 2, 1, 1, 4294967295))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_83(func_273(iParam1, uParam0->f_2), Global_11566, 0);
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_83(func_272(iParam1, uParam0->f_2), Global_11566, 0);
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
...
bool func_271(int iParam0, int iParam1, var uParam2)//Position - 0x12E90
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_272(int iParam0, int iParam1)//Position - 0x13295
{
	switch (iParam1)
	{
		case 0:
...
int func_273(int iParam0, int iParam1)//Position - 0x13690
{
	switch (iParam1)
	{
		case 0:
...
int func_274(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x13A8B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_275(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x13ACD
{
	int iVar0;
...
int func_276(int iParam0)//Position - 0x15587
{
	switch (iParam0)
	{
		case 4294967295:
...
void func_277(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1565B
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILE::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var2;
					func_270(&(Global_11569[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, 4294967295, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_270(&(Global_11569[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, 4294967295, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILE::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var6;
					func_270(&(Global_11569[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILE::_0x341DE7ED1D2A1BFD(Var6.f_1, 2244334710, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != 4294967295 && Global_11612)
		{
			...
			Global_280005 = Var11;
			func_270(&(Global_11569[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILE::_0x341DE7ED1D2A1BFD(Var11.f_1, 2244334710, 0), 4294967295, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = FILE::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, 4294967295, 0, 4294967295, func_278(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_278(int iParam0)//Position - 0x15934
{
	switch (iParam0)
	{
		case 0:
...
void func_279(int iParam0)//Position - 0x159E4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 9, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_280(int iParam0)//Position - 0x15B3B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 48, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_281(int iParam0)//Position - 0x16049
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 1, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_282(int iParam0)//Position - 0x160BE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_283(int iParam0)//Position - 0x16132
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 6, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_284(int iParam0)//Position - 0x16219
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 33, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_285(int iParam0)//Position - 0x1657C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 17, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_286(int iParam0)//Position - 0x1678D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 18, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_287(int iParam0)//Position - 0x169BD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 7, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_288(int iParam0)//Position - 0x16ACD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 84, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_289(int iParam0)//Position - 0x1746C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 104, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_290(int iParam0)//Position - 0x17FDF
{
	if (iParam0 < 136)
	{
		func_292(iParam0);
	...
	{
		func_277(3, iParam0, 242, 4294967295);
	}
}

void func_291(int iParam0)//Position - 0x18015
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_292(int iParam0)//Position - 0x18C19
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_293(int iParam0)//Position - 0x19B27
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_294(int iParam0)//Position - 0x19C54
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_295(int iParam0, int iParam1)//Position - 0x19D52
{
	switch (iParam0)
	{
		case 0:
...
void func_296(int iParam0)//Position - 0x19E42
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 175, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_297(int iParam0)//Position - 0x1B333
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_298(int iParam0)//Position - 0x1B484
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 47, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_299(int iParam0)//Position - 0x1B98F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 63, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_300(int iParam0)//Position - 0x1BFFD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_301(int iParam0)//Position - 0x1C074
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 5, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_302(int iParam0)//Position - 0x1C144
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 53, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_303(int iParam0)//Position - 0x1C674
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 12, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_304(int iParam0)//Position - 0x1C80B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 77, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_305(int iParam0)//Position - 0x1D009
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_306(int iParam0)//Position - 0x1D119
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 134, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_307(int iParam0)//Position - 0x1E044
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 117, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_308(int iParam0)//Position - 0x1ED01
{
	if (iParam0 < 107)
	{
		func_311(iParam0);
	...
	if (Global_11569[0 /*14*/].f_2 == 4294967295)
	{
		func_277(3, iParam0, 318, 4294967295);
	}
}

void func_309(int iParam0)//Position - 0x1ED47
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_310(int iParam0)//Position - 0x1F7EC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_311(int iParam0)//Position - 0x205DD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_312(int iParam0)//Position - 0x21226
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 21, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_313(int iParam0)//Position - 0x2149F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 10, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_314(int iParam0, int iParam1)//Position - 0x215E5
{
	switch (iParam0)
	{
		case 0:
...
void func_315(int iParam0)//Position - 0x216D5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 113, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_316(int iParam0)//Position - 0x2245F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_317(int iParam0)//Position - 0x225D9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_318(int iParam0)//Position - 0x22B50
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 45, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_319(int iParam0)//Position - 0x2307A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_321(int iParam0)//Position - 0x231BE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_322(int iParam0)//Position - 0x23696
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 20, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_323(int iParam0)//Position - 0x238FF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 24, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_324(int iParam0)//Position - 0x23BD5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 14, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_325(int iParam0)//Position - 0x23D9E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_277(iVar7, iParam0, 99, 4294967295);
			return;
			break;
	}
	func_270(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_326(int iParam0)//Position - 0x24B2D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_327(int iParam0)//Position - 0x25777
{
	if (iParam0 < 60)
	{
		func_329(iParam0);
	...
	if (Global_11569[0 /*14*/].f_2 == 4294967295)
	{
		func_277(3, iParam0, 181, 4294967295);
	}
}

void func_328(int iParam0)//Position - 0x257AC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_329(int iParam0)//Position - 0x2654C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_330(int iParam0)//Position - 0x26BD8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_331(int iParam0)//Position - 0x26CBF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_332()//Position - 0x26DBD
{
...
void func_333()//Position - 0x26E36
{
	func_342();
	func_341();
	func_334();
...
void func_334()//Position - 0x26E4A
{
	vector3 vVar0[8];
...
void func_335(var uParam0, int iParam1)//Position - 0x26EB7
{
	int iVar0;
...
void func_336(var uParam0, var uParam1, float fParam2)//Position - 0x26EFB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_337(var uParam0, struct<2> Param1, Vector3 vParam2)//Position - 0x27008
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_338(var uParam0)//Position - 0x270C4
{
	int iVar0;
	float fVar1;
...
void func_339(var uParam0, vector3 vParam1)//Position - 0x27164
{
	if (uParam0->f_33 == 0)
	{
	}
...
void func_340(var uParam0)//Position - 0x27195
{
	if (uParam0->f_33)
	{
	}
...
void func_341()//Position - 0x271BC
{
...
void func_342()//Position - 0x271DC
{
}

void func_343()//Position - 0x271E4
{
	func_354(1);
	func_353();
	func_344(0);
...
void func_344(bool bParam0)//Position - 0x271FE
{
	if (bParam0)
	{
	}
...
void func_345()//Position - 0x27269
{
}

void func_346()//Position - 0x27271
{
	Global_3960 = 0;
	func_347();
}

void func_347()//Position - 0x27281
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_348()//Position - 0x272A2
{
}

void func_349()//Position - 0x272AA
{
}

void func_350()//Position - 0x272B2
{
}

void func_351()//Position - 0x272BA
{
}

void func_352(bool bParam0, int iParam1, int iParam2)//Position - 0x272C2
{
	bool bVar0;
...
void func_353()//Position - 0x27321
{
	Global_15C5E = 0;
}

void func_354(bool bParam0)//Position - 0x2732E
{
...
void func_355()//Position - 0x27375
{
	int iVar0;
...
void func_357()//Position - 0x27424
{
	Global_19E56.f_933.f_21B.f_947[0] = 4294967197;
	Global_19E56.f_933.f_21B.f_947[1] = 4294967197;
	Global_19E56.f_933.f_21B.f_947[2] = 4294967197;
