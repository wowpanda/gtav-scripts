...
void __EntryFunction__()
{
	...
	fLocal_88 = 90f;
	bLocal_90 = true;
	fLocal_99 = "RANDOM@RESCUE_HOSTAGE";
...
void func_1(int iParam0, void fParam1, void fParam2, int iParam3)
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, fParam1, fParam2, func_2(iParam3), 0);
}
...
void func_29()
{
	...
	{
		func_31(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
...
void func_38(void fParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
	...
	if (!iLocal_73)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_49))
		{
			if (iLocal_64 == -1)
			{
				...
				BRAIN::TASK_PLAY_ANIM(iLocal_49, fLocal_99, "girl_villian_shot", 8f, -2f, -1, 10, 0, 0, 0, 0);
				...
				if (!PED::IS_PED_INJURED(iLocal_50))
				{
					...
					{
						BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_50, iLocal_64, fLocal_99, "bystander_villian_shot", 1000f, -2f, 5, 0, 1148846080, 0);
					}
					else
					{
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_50, false);
				...
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_49, iLocal_64, fLocal_99, "girl_villian_shot", 1000f, -2f, 5, 0, 1148846080, 0);
			}
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_64))
			{
				...
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_64) == 1f)
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_50))
					{
						if (bLocal_79)
						{
							BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_50, iLocal_64, fLocal_99, "bystander_helping_girl_loop", 1000f, -2f, 5, 0, 1148846080, 0);
						}
						else
						{
					...
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_49, iLocal_64, fLocal_99, "girl_helping_girl_loop", 1000f, -2f, 5, 0, 1148846080, 0);
					PED::SET_PED_KEEP_TASK(iLocal_49, true);
			...
			if (!WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(iLocal_48, joaat("weapon_stungun"), 0))
			{
				if (!PED::IS_PED_INJURED(iLocal_49))
				{
					if (!PED::IS_PED_RAGDOLL(iLocal_48))
					{
						...
						BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_49, iLocal_63, fLocal_99, "girl_girl_shot", 4f, -4f, 5, 0, 1148846080, 0);
						BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_48, iLocal_63, fLocal_99, "villian_girl_shot", 4f, -4f, 5, 0, 1148846080, 0);
						PED::SET_PED_KEEP_TASK(iLocal_49, true);
						PED::SET_PED_CAN_RAGDOLL(iLocal_49, 0);
					}
				}
		...
		else if (MISC::ARE_STRINGS_EQUAL(sLocal_84, "NULL"))
		{
			switch (MISC::GET_RANDOM_INT_IN_RANGE(0, 10))
			{
				...
				case 1:
					if (iLocal_89)
					{
						fLocal_84 = "RERHO_HELP";
						iLocal_89 = 0;
					}
					else
					{
						fLocal_84 = "RERHO_RANT";
						iLocal_89 = 1;
					}
					break;
				
				case 2:
					fLocal_84 = "RERHO_SCREAM";
					break;
			}
		}
		else if (func_5(&Local_93, "RERHOAU", fLocal_84, 4, iLocal_98, 0, 0))
		{
			SYSTEM::SETTIMERA(0);
		}
	}
...
void func_62(void fParam0, int iParam1)
{
	func_64(fParam0);
	func_63(iParam1);
}
...
void func_71(void fParam0, int iParam1)
{
...
int func_73()
{
	switch (func_74(&Global_25336, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_95()
{
	if ((Global_105209 == func_44() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_105210)
	{
		return 1;
	}
	return 0;
...
void func_100(int iParam0, void fParam1, int iParam2)
{
	...
	if (bLocal_90 == 0)
	{
		if (!PED::IS_PED_INJURED(iLocal_50) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (iLocal_72)
			{
				...
				BRAIN::TASK_PLAY_ANIM(0, fLocal_99, "bystander_bystander_angry", 8f, -8f, 1500, 0, 0, 0, 0, 0);
...
int func_106()
{
	...
	fVar3 = "A_F_M_BEVHILLS_02_WHITE_FULL_02";
	STREAMING::REQUEST_MODEL(iVar0);
	STREAMING::REQUEST_MODEL(iVar2);
	STREAMING::REQUEST_MODEL(iVar1);
	STREAMING::REQUEST_ANIM_DICT(fLocal_99);
	if (((STREAMING::HAS_MODEL_LOADED(iVar0) && STREAMING::HAS_MODEL_LOADED(iVar2)) && STREAMING::HAS_MODEL_LOADED(iVar1)) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_99))
	{
		MISC::CLEAR_AREA(vLocal_46, 5f, 1, 1, 0, false);
		iLocal_49 = PED::CREATE_PED(5, iVar2, vLocal_46, fLocal_47, 1, true);
		PED::SET_PED_SUFFERS_CRITICAL_HITS(iLocal_49, 1);
		AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_49, fVar3);
		...
		BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_48, iLocal_63, fLocal_99, "villian_struggle_loop", 1000f, -4f, 5, 0, 1148846080, 0);
		BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_49, iLocal_63, fLocal_99, "girl_struggle_loop", 1000f, -4f, 5, 0, 1148846080, 0);
		iLocal_65 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_66, vLocal_67, 2);
		PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_65, true);
		BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_50, iLocal_65, fLocal_99, "bystander_taking_cover", 1000f, -1.5f, 5, 0, 1148846080, 0);
...
int func_115(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_151(Global_105220.f_24966.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_149()) || Global_104267) || Global_25279) || func_148()) || func_19(8, -1)) || func_147()) || func_146()) || func_145()) || func_144()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_149()) || Global_25279) || func_148()) || func_19(8, -1)) || func_145()) || func_147()) || func_146()) || func_144()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_149()) || Global_104267) || Global_25279) || func_148()) || func_19(8, -1)) || func_147()) || func_146()) || func_144()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_149() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_19(8, -1)) || func_144()) || func_143()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_149()) || Global_25279) || func_148()) || func_19(8, -1)) || func_146()) || func_145()) || func_144()) || Global_105220.f_7659.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_149()) || func_146()) || Global_104267) || Global_25279) || func_148()) || Global_37057) || func_19(8, -1)) || func_145()) || func_143()) || func_144()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_149()) || Global_104267) || Global_25279) || func_148()) || func_19(8, -1)) || func_145()) || func_143()) || func_147()) || func_146()) || func_144())
						{
							return 0;
						}
						break;
