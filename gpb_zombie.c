...
void __EntryFunction__()
{
	...
	while (iVar0 == 1)
	{
		...
		{
			if (!func_84() && SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("director_mode")) == 0)
			{
				if (func_103())
				{
				}
		...
		switch (iLocal_216)
		{
			...
			case 5:
				...
				{
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_208, vLocal_210, 1f, -1, 1f, 1024, ScriptParam_334.f_17[0]);
					iLocal_216 = 6;
				}
				break;
			...
			case 8:
				...
				else if (iLocal_269 == 1)
				{
					...
					{
						func_47(Global_104500[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_208, &Local_253, &Local_252));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_56();
				bVar37 = func_57();
				func_46(Global_104500[iLocal_217]);
				if (!bVar37 && (!bVar36 || bLocal_266))
				{
					if (bLocal_331)
					{
						Global_104500[iLocal_217] = uLocal_330;
					}
					else
					{
	...
	while (true)
	{
		...
		if ((ENTITY::IS_ENTITY_OCCLUDED(iLocal_208) && func_79(iLocal_208, PLAYER::PLAYER_PED_ID(), 1) > 50f) && !TASK::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			func_108(1);
		}
		SYSTEM::WAIT(0);
...
int func_8()
{
	if (Global_104500[iLocal_217] == 3 && (iLocal_223 >= 4 && iLocal_223 <= 12))
	{
		return 1;
	}
	return 0;
...
void func_18()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_22(Global_104555.f_2353.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_20(iVar0) && (!func_19(14) || Global_103506))
			{
...
void func_47(int iParam0, int iParam1, float fParam2)
{
	if (iParam0 == 3)
	{
		...
		{
			iLocal_277 = OBJECT::CREATE_OBJECT(joaat("prop_npc_phone"), ENTITY::GET_ENTITY_COORDS(iLocal_208, 1), true, true, false);
...
void func_49()
{
	...
	func_52(Global_104500[iLocal_217] + 1, &sVar0, &Var1);
	...
	PED::_0x2208438012482A1A(iLocal_208, 0, 0);
	func_50(Global_104500[iLocal_217]);
}
...
int func_80(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_82(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
void func_92(int iParam0)
{
	...
	func_95(&(Global_104555.f_20087), iParam0);
...
{
	return func_106(Global_104555.f_20087, uParam0);
}
