		...
		switch (iLocal_216)
		{
			...
			case 8:
				...
				else if (iLocal_269 == 1)
				{
					...
					{
						func_47(Global_105165[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_208, &Local_253, &Local_252));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_56();
				bVar37 = func_57();
				func_46(Global_105165[iLocal_217]);
				if (!bVar37 && (!bVar36 || bLocal_266))
				{
					if (bLocal_331)
					{
						Global_105165[iLocal_217] = uLocal_330;
					}
					else
					{
...
int func_8()
{
	if (Global_105165[iLocal_217] == 3 && (iLocal_223 >= 4 && iLocal_223 <= 12))
	{
		return 1;
	}
	return 0;
...
void func_18()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_22(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_20(iVar0) && (!func_19(14) || Global_104171))
			{
...
void func_49()
{
	...
	func_52(Global_105165[iLocal_217] + 1, &sVar0, &Var1);
	...
	PED::_0x2208438012482A1A(iLocal_208, 0, 0);
	func_50(Global_105165[iLocal_217]);
}
...
void func_92(int iParam0)
{
	...
	func_95(&(Global_105220.f_20088), iParam0);
...
{
	return func_106(Global_105220.f_20088, uParam0);
}
