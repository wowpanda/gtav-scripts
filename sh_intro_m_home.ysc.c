...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		switch (iLocal_37)
		{
			...
			case 1:
				if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -871.9259f, 162.0005f, 52.99224f, -741.5948f, 155.0873f, 113.0255f, 90f, 0, true, 0))
					{
...
int func_4(int iParam0)//Position - 0xE58
{
...
void func_6(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0xED4
{
	int iVar0;
...
int func_7(int iParam0)//Position - 0xF7C
{
	if (func_8(iParam0))
	{
...
int func_8(int iParam0)//Position - 0xF9C
{
...
void func_9(char* sParam0, int iParam1)//Position - 0xFBD
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

void func_10()//Position - 0xFD4
{
	int iVar0;
	...
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		...
		ENTITY::SET_ENTITY_COORDS(AUDIO::_0x0626A247D2405330(), -840.6724f, 159.0602f, 66.2181f, 1, false, 0, 1);
		ENTITY::SET_ENTITY_HEADING(AUDIO::_0x0626A247D2405330(), 305.1602f);
	}
...
void func_11(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)//Position - 0x10FB
{
	struct<60> Var0;
...
void func_12(int iParam0, int iParam1, int iParam2)//Position - 0x1224
{
	int iVar0;
	...
	if (!func_43(&(Global_11188.f_22B[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_19E56.f_7F5D.f_12C1 = func_32();
			}
...
void func_13(int iParam0, int iParam1)//Position - 0x1341
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_55(iParam0, &(Global_19E56.f_7F5D.f_1586));
}

int func_14(int iParam0)//Position - 0x1543
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0)) || func_29(iParam0, 0, 0)) || func_29(iParam0, 1, 0)) || func_29(iParam0, 2, 0)) || func_53(iParam0) != 145) || func_28(iParam0)) || func_27(iParam0)) || func_26(iParam0)) || func_25(iParam0)) || !func_15(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_27(iParam0))
		{
		}
...
int func_15(int iParam0)//Position - 0x1620
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_16(int iParam0, bool bParam1)//Position - 0x17D1
{
	int iVar0;
	struct<2> Var1;
...
int func_19(int iParam0)//Position - 0x1A31
{
	int iVar0;
	int iVar1;
...
int func_20()//Position - 0x372C
{
	return 0;
}

int func_21()//Position - 0x3735
{
	return 1;
}

int func_22()//Position - 0x373E
{
	return 1;
}

int func_23()//Position - 0x3747
{
...
int func_25(int iParam0)//Position - 0x381B
{
	int iVar0;
	char* sVar1;
...
int func_26(int iParam0)//Position - 0x3861
{
	int iVar0;
...
int func_27(int iParam0)//Position - 0x389C
{
	int iVar0;
...
int func_28(int iParam0)//Position - 0x3918
{
	int iVar0;
...
int func_29(int iParam0, int iParam1, bool bParam2)//Position - 0x3A00
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_30(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3A71
{
...
int func_31(int iParam0)//Position - 0x3B4A
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
void func_33(var uParam0, int iParam1)//Position - 0x3BAC
{
	if (iParam1 <= 0)
	{
		return;
...
void func_34(var uParam0, int iParam1)//Position - 0x3C32
{
...
void func_35(var uParam0, int iParam1)//Position - 0x3C65
{
	int iVar0;
	int iVar1;
...
int func_36(int iParam0, int iParam1)//Position - 0x3CB6
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_37(int iParam0)//Position - 0x3D58
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_38(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}

int func_38(bool bParam0, int iParam1, int iParam2)//Position - 0x3D7D
{
	if (bParam0)
	{
		return iParam1;
...
int func_39(var uParam0)//Position - 0x3D94
{
	return uParam0 & 15;
}

void func_40(var uParam0, int iParam1)//Position - 0x3DA1
{
...
void func_41(var uParam0, int iParam1)//Position - 0x3DDB
{
...
void func_42(var uParam0, int iParam1)//Position - 0x3E16
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_43(var uParam0, int iParam1)//Position - 0x3E52
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam0->f_9, 10))
	{
		...
		if (!func_54(Global_19E56.f_7F5D.f_748[uParam0->f_E /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_54(Global_19E56.f_933.f_21B.f_DF0[1 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_54(Global_19E56.f_933.f_21B.f_DF0[0 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_44(int iParam0, int iParam1)//Position - 0x56A5
{
	struct<82> Var0;
...
void func_45(int iParam0, var uParam1, int iParam2)//Position - 0x56E7
{
	int iVar0;
...
bool func_46(int iParam0)//Position - 0x5943
{
	return iParam0 < 3;
}

void func_47(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0x594F
{
	if (func_43(&(Global_11188.f_22B[0 /*21*/]), iParam0))
	{
		...
		{
			func_52(iParam0);
			func_51(uParam1, &(Global_19E56.f_7F5D.f_45[Global_11188.f_22B[0 /*21*/].f_E /*78*/]));
...
void func_48(int iParam0, bool bParam1)//Position - 0x5A4E
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_49(int iParam0, int iParam1, bool bParam2)//Position - 0x5AAB
{
	if (iParam0 == 4294967295)
	{
		return;
...
bool func_50(int iParam0, int iParam1)//Position - 0x5AE6
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
void func_51(var uParam0, var uParam1)//Position - 0x5B09
{
...
void func_52(int iParam0)//Position - 0x5BD5
{
	if (iParam0 == 4294967295)
	{
		return;
...
int func_53(int iParam0)//Position - 0x5C4F
{
	int iVar0;
...
bool func_54(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x5CB2
{
	if (bParam2)
	{
...
void func_55(int iParam0, var uParam1)//Position - 0x5CF9
{
	int iVar0;
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_4D), func_56(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_56(int iParam0)//Position - 0x5FA4
{
	switch (iParam0)
	{
		case 1:
...
int func_57(int iParam0, var uParam1, var uParam2)//Position - 0x6054
{
	int iVar0;
	int iVar1;
...
void func_59(var uParam0)//Position - 0x6267
{
	int iVar0;
...
void func_60(int iParam0)//Position - 0x6318
{
...
Vector3 func_61(vector3 vParam0)//Position - 0x633F
{
	return (-SYSTEM::SIN(vParam0.z) * SYSTEM::COS(vParam0.x)), (SYSTEM::COS(vParam0.z) * SYSTEM::COS(vParam0.x)), SYSTEM::SIN(vParam0.x);
}

void func_62(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x636C
{
	int iVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (bParam6)
		{
			...
			{
				case 0:
					if (func_181(AUDIO::_0x0626A247D2405330(), 8, 15))
					{
						func_65(AUDIO::_0x0626A247D2405330(), 8, 0, 1, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
					if (func_181(AUDIO::_0x0626A247D2405330(), 9, 6))
					{
						func_65(AUDIO::_0x0626A247D2405330(), 9, 0, 1, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
					break;
				
				case 1:
					if (func_181(AUDIO::_0x0626A247D2405330(), 8, 1) || func_181(AUDIO::_0x0626A247D2405330(), 8, 10))
					{
						func_65(AUDIO::_0x0626A247D2405330(), 8, 26, 1, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
					break;
				
				case 2:
					if (func_181(AUDIO::_0x0626A247D2405330(), 8, 4))
					{
						func_65(AUDIO::_0x0626A247D2405330(), 8, 15, 1, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
					break;
				}
		}
...
void func_63(int iParam0, bool bParam1)//Position - 0x652A
{
	if (CAM::IS_SCREEN_FADED_OUT() || CAM::IS_SCREEN_FADING_OUT())
	{
...
Vector3 func_64(int iParam0)//Position - 0x6566
{
	return unk_0x8000C77B5F336760(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_65(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x6579
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_11569[1 /*14*/] = { func_116(iVar10, iParam1, iParam2, 4294967295) };
		if (!func_115(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			...
			{
				Global_11569[1 /*14*/] = { func_116(iVar10, iVar0, uVar11[iVar0], 4294967295) };
				if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11569[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_11569[1 /*14*/] = { func_116(iVar10, 14, uVar12[iVar1], 4294967295) };
							func_85(iParam0, Global_11569[1 /*14*/].f_C, Global_11569[1 /*14*/].f_3, Global_11569[1 /*14*/].f_4);
							func_107(14);
							if (Global_11567 == 1)
							{
								iVar2 = 0;
			...
			{
				Global_11569[1 /*14*/] = { func_116(iVar10, iVar0, func_74(iParam0, iVar0, 4294967295), 4294967295) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_11569[1 /*14*/] = { func_116(iVar10, 14, uVar15[iVar1], 4294967295) };
			func_85(iParam0, Global_11569[1 /*14*/].f_C, Global_11569[1 /*14*/].f_3, Global_11569[1 /*14*/].f_4);
			func_107(14);
			if (Global_11567 == 1)
			{
...
int func_66(int iParam0, int iParam1, int iParam2)//Position - 0x6D8F
{
	int iVar0;
	...
	{
		if (!func_181(iParam0, Global_19E56.f_933.f_21B[iVar0 /*65*/].f_40, Global_19E56.f_933.f_21B[iVar0 /*65*/].f_3F))
		{
...
int func_67(int iParam0)//Position - 0x6E1B
{
	switch (iParam0)
	{
...
void func_68(int iParam0, int iParam1, int iParam2)//Position - 0x6E56
{
	int iVar0;
	int iVar1;
...
int func_69(int iParam0, int iParam1, int iParam2)//Position - 0x6EE0
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_70(int iParam0, int iParam1, int iParam2)//Position - 0x6FBE
{
	Global_11569[1 /*14*/] = { func_116(iParam0, iParam1, iParam2, 4294967295) };
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11569[1 /*14*/].f_6, 2);
}

int func_71(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x6FE9
{
	var uVar0;
	int iVar1;
...
int func_72(int iParam0, int iParam1, int iParam2)//Position - 0x75ED
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7686
{
	int iVar0;
	...
	{
		if (!func_181(iParam0, Global_19E56.f_933.f_21B[iVar0 /*65*/].f_3D, Global_19E56.f_933.f_21B[iVar0 /*65*/].f_3C) || iParam3 == 1)
		{
...
int func_74(int iParam0, int iParam1, int iParam2)//Position - 0x771C
{
	int iVar0;
	int iVar1;
...
int func_75(int iParam0)//Position - 0x77BD
{
	switch (iParam0)
	{
		case 0:
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x786D
{
	int iVar0;
...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x7B74
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x8762
{
	int iVar0;
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8A46
{
	int iVar0;
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8D0D
{
	int iVar0;
	int iVar1;
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8D44
{
	int iVar0;
...
int func_82(int iParam0, int iParam1, int iParam2)//Position - 0x8D6D
{
	*iParam2 = 4294967197;
	switch (iParam0)
	{
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9037
{
	int iVar0;
...
int func_84(int iParam0, int iParam1, int iParam2)//Position - 0x92C1
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9418
{
	int iVar0;
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_86(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, FILE::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x94B0
{
	switch (iParam0)
	{
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x957E
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_88(int iParam0, int iParam1)//Position - 0x96DA
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_89(int iParam0)//Position - 0x9A81
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9AE2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_91(int iParam0, int iParam1)//Position - 0x9BDE
{
	int iVar0;
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9D1C
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_93(int iParam0)//Position - 0x9DFC
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_94(int iParam0, int iParam1)//Position - 0x9E82
{
	int iVar0;
	struct<10> Var1;
...
void func_95(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA7B1
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar2;
...
void func_96(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xA8DB
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_97(int iParam0, int iParam1)//Position - 0xA923
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_100(&Var1, 4294967197, 4294967197, Global_19E56.f_933.f_21B.f_C4[0], Global_19E56.f_933.f_21B.f_C8[0], 6, 3, 0, 0, 0, 4294967197, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_100(&Var1, 4294967197, 4294967197, Global_19E56.f_933.f_21B.f_C4[1], Global_19E56.f_933.f_21B.f_C8[1], 17, 2, 26, 0, 0, 4294967197, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_100(&Var1, 4294967197, 4294967197, Global_19E56.f_933.f_21B.f_C4[2], Global_19E56.f_933.f_21B.f_C8[2], 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
...
void func_98(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC804
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar2;
...
int func_99(int iParam0)//Position - 0xC9EE
{
	switch (iParam0)
	{
		case 0:
...
void func_100(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xCA9E
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCB0F
{
	switch (iParam0)
	{
		case joaat("player_zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILE::_0x341DE7ED1D2A1BFD(iParam3, 2537416713, 1) || FILE::_0x341DE7ED1D2A1BFD(func_87(iParam0, iParam2, 14, 3), 2452280943, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILE::_0x341DE7ED1D2A1BFD(iParam3, 2537416713, 0) || FILE::_0x341DE7ED1D2A1BFD(func_87(iParam0, iParam2, 1, 3), 2452280943, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILE::_0x341DE7ED1D2A1BFD(iParam3, 2537416713, 1) || FILE::_0x341DE7ED1D2A1BFD(func_87(iParam0, iParam2, 14, 4), 2452280943, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILE::_0x341DE7ED1D2A1BFD(iParam3, 2537416713, 0) || FILE::_0x341DE7ED1D2A1BFD(func_87(iParam0, iParam2, 1, 4), 2452280943, 0));
					}
					break;
			}
			break;
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCD8C
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_103(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD1B1
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_104(int iParam0, int iParam1)//Position - 0xD4A4
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1)//Position - 0xD4EA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD54A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_107(int iParam0)//Position - 0xD5CE
{
	...
	{
		func_114(iParam0, Global_11569[1 /*14*/].f_5, Global_11569[1 /*14*/].f_2, 2, Global_11569[1 /*14*/].f_1, 1, 0);
	}
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11569[1 /*14*/].f_6, 1) && INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11569[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_108(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xD686
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_109(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xD6D0
{
	int iVar0;
	...
	iVar0 = Global_26B05F[iParam0 /*3*/][func_110(iParam2)];
	if (iVar0 != 0)
	{
...
int func_110(var uParam0)//Position - 0xD700
{
	int iVar0;
	int iVar1;
...
int func_111()//Position - 0xD734
{
	return Global_1407E0;
}

int func_112(int iParam0, int iParam1, int iParam2)//Position - 0xD740
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Global_26B05F[iParam0 /*3*/][func_110(iParam1)];
...
bool func_113(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xD772
{
	int iVar0;
...
int func_114(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xF22B
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_115(int iParam0)//Position - 0x1014A
{
	if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11569[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_116(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1019B
{
	func_180();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_117(int iParam0, int iParam1)//Position - 0x101ED
{
	switch (iParam0)
	{
		case 0:
...
void func_118(int iParam0)//Position - 0x102DD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_119(&(Global_11569[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_119(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x11554
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_112(func_122(iParam1, uParam0->f_2), Global_11566, 0);
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_112(func_121(iParam1, uParam0->f_2), Global_11566, 0);
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_112(iVar1, Global_11566, 0);
				if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_120(int iParam0, int iParam1, var uParam2)//Position - 0x118E5
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_121(int iParam0, int iParam1)//Position - 0x11CEA
{
	switch (iParam1)
	{
		case 0:
...
int func_122(int iParam0, int iParam1)//Position - 0x120E5
{
	switch (iParam1)
	{
		case 0:
...
int func_123(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x124E0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_124(int iParam0)//Position - 0x12522
{
	return Global_8D15 == iParam0;
}

int func_125(int iParam0)//Position - 0x12530
{
	switch (iParam0)
	{
		case 4294967295:
...
void func_126(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x12604
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILE::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var2;
					func_119(&(Global_11569[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, 4294967295, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_119(&(Global_11569[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, 4294967295, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILE::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var6;
					func_119(&(Global_11569[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILE::_0x341DE7ED1D2A1BFD(Var6.f_1, 2244334710, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != 4294967295 && Global_11612)
		{
			...
			Global_280005 = Var11;
			func_119(&(Global_11569[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILE::_0x341DE7ED1D2A1BFD(Var11.f_1, 2244334710, 0), 4294967295, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
...
void func_127(int iParam0)//Position - 0x128DD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x12A34
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0x12F42
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x12FB7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x1302B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x13112
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x13475
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x13686
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x138B6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x139C6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x14366
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x14ED9
{
	if (iParam0 < 136)
	{
		func_140(iParam0);
...
void func_139(int iParam0)//Position - 0x14F0E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x15B12
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x16A20
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x16B4D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0, int iParam1)//Position - 0x16C4B
{
	switch (iParam0)
	{
		case 0:
...
void func_144(int iParam0)//Position - 0x16D3B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x1822D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x1837E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x18889
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x18EF7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x18F6B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x1903B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1956B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x19702
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x19F00
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x1A010
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1AF3B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1BBF8
{
	if (iParam0 < 107)
	{
		func_159(iParam0);
...
void func_157(int iParam0)//Position - 0x1BC3E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x1C6E5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1D4D4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1E11D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1E396
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0, int iParam1)//Position - 0x1E4DC
{
	switch (iParam0)
	{
		case 0:
...
void func_163(int iParam0)//Position - 0x1E5CC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1F356
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1F4D0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1FA47
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x1FF71
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x1FFE5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x200B7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x2058F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x207F8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x20ACE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x20C97
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x217EB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x22435
{
	if (iParam0 < 60)
	{
		func_177(iParam0);
...
void func_176(int iParam0)//Position - 0x2246A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x2320A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x23896
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x2397D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180()//Position - 0x23A7B
{
...
int func_181(int iParam0, int iParam1, int iParam2)//Position - 0x23AF4
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_11569[1 /*14*/] = { func_116(iVar0, iParam1, iParam2, 4294967295) };
	if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11569[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != 4294967197 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_181(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_181(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_11569[2 /*14*/] = { func_116(iVar0, 14, iVar4, 4294967295) };
					...
					else
					{
						...
						Global_11569[2 /*14*/] = { func_116(iVar0, iVar2, iVar1, 4294967295) };
...
int func_182()//Position - 0x23D4F
{
	func_183();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_183()//Position - 0x23D68
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_185(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			iVar0 = func_184(AUDIO::_0x0626A247D2405330());
			if (func_46(iVar0) && (!func_124(14) || Global_19A3D))
			{
...
int func_184(int iParam0)//Position - 0x23E65
{
	int iVar0;
	int iVar1;
...
int func_185(int iParam0)//Position - 0x23EA2
{
	if (func_46(iParam0))
	{
...
void func_186(bool bParam0)//Position - 0x23ECC
{
	int iVar0;
...
void func_187(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x23F09
{
	if (bParam0)
	{
...
int func_190(int iParam0, bool bParam1)//Position - 0x2409B
{
	int iVar0;
	int iVar1;
...
int func_191(int iParam0)//Position - 0x240DC
{
...
bool func_192()//Position - 0x2411E
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_240006, 3);
}

int func_193(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x2412F
{
	int iVar0;
...
void func_195(int iParam0)//Position - 0x24189
{
	if (iParam0 == 1)
	{
...
void func_196()//Position - 0x241AC
{
	Global_3960 = 0;
	func_197();
}

void func_197()//Position - 0x241BC
{
...
int func_198(int iParam0, float fParam1, int iParam2)//Position - 0x241DD
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
		...
		{
			if (!func_205(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_204(AUDIO::_0x0626A247D2405330(), 3466132403))
				{
...
bool func_199()//Position - 0x242B1
{
	bool bVar0;
...
void func_200()//Position - 0x242D4
{
	Global_3960 = 0;
	func_201();
}

void func_201()//Position - 0x242E4
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
...
void func_203()//Position - 0x2435D
{
...
int func_204(int iParam0, int iParam1)//Position - 0x243AE
{
	if (func_7(iParam0))
	{
...
int func_205(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x243E1
{
...
void func_206(int iParam0)//Position - 0x24570
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_207()//Position - 0x2459C
{
	if (iLocal_41)
	{
		if (INTERIOR::IS_VALID_INTERIOR(iLocal_51))
...
void func_208(bool bParam0)//Position - 0x245D2
{
	if (bParam0)
	{
		if (!iLocal_40)
...
int func_210(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x2464C
{
	int iVar0;
...
void func_211(var uParam0, int iParam1)//Position - 0x24783
{
	int iVar0;
...
bool func_212(int iParam0)//Position - 0x247D2
{
	return func_213(iParam0, Global_8D15);
}

int func_213(int iParam0, int iParam1)//Position - 0x247E3
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_214(int iParam0)//Position - 0x249C4
{
	if (Global_8D15 == 15)
	{
		return 0;
...
int func_215()//Position - 0x249E6
{
	...
	{
		if (Global_19E56.f_1DEC[Global_8F38 /*15*/].f_3 >= 2)
		{
			return 0;
		}
	}
...
bool func_218(vector3 vParam0, vector3 vParam1, float fParam2)//Position - 0x24AA2
{
	vector3 vVar0;
...
bool func_219(var uParam0, struct<2> Param1, var uParam2)//Position - 0x24ACC
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_220(var uParam0)//Position - 0x24B88
{
	int iVar0;
	float fVar1;
...
void func_221(var uParam0, vector3 vParam1)//Position - 0x24C28
{
	if (uParam0->f_33 == 0)
	{
	}
...
void func_222(var uParam0)//Position - 0x24C59
{
	if (uParam0->f_33)
	{
	}
...
void func_223()//Position - 0x24C80
{
...
void func_224(int iParam0)//Position - 0x24CFB
{
	if (*iParam0 == 4294967295)
	{
		return;
...
int func_225(int iParam0)//Position - 0x24D38
{
	int iVar0;
	int iVar1;
