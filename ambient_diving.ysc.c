...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		{
			iLocal_67 = 0;
			func_72(AUDIO::_0x0626A247D2405330());
			switch (iLocal_49)
			{
				case 0:
					func_67();
...
int func_14()//Position - 0x101F
{
	return Global_1407E0;
}

void func_15(bool bParam0)//Position - 0x102B
{
	if (bParam0)
	{
...
int func_17(int iParam0)//Position - 0x106C
{
...
int func_18(var uParam0, int iParam1)//Position - 0x1099
{
	int iVar0;
	bool bVar1;
	vector3 vVar2;
	...
	if (uParam0->f_B)
	{
		if (!Global_11729)
		{
			func_26(&(uParam0->f_B), &(uParam0->f_C), &(uParam0->f_9), 5, &iLocal_52, &uLocal_50, "DIVING_TITLE", "DIVING_COLLECT");
		}
		if (!func_25(44))
		{
...
void func_19(int iParam0)//Position - 0x1247
{
	int iVar0;
	int iVar1;
...
void func_20(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x1289
{
	func_21(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_21(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x12AA
{
	int iVar0;
...
Vector3 func_23(int iParam0)//Position - 0x159D
{
	switch (iParam0)
	{
		case 0:
...
bool func_24(var uParam0, int iParam1, vector3 vParam2, int iParam3)//Position - 0x18D9
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_25(int iParam0)//Position - 0x1940
{
	int iVar0;
	int iVar1;
...
void func_26(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, var uParam5, char* sParam6, char* sParam7)//Position - 0x1983
{
	int iVar0;
...
int func_28(int iParam0)//Position - 0x1B35
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam0 == 2)
	{
		...
		{
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_2725.f_6C, func_33(func_34(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
int func_29(int iParam0, int iParam1, int iParam2)//Position - 0x1BFD
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_30(int iParam0)//Position - 0x1C3A
{
	int iVar0;
...
int func_31(int iParam0, int iParam1)//Position - 0x1F52
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x223C
{
	if (iParam0 == 3)
	{
		return 815;
...
int func_33(int iParam0, int iParam1)//Position - 0x2283
{
	if (iParam1 < 32)
	{
		return iParam1;
...
int func_34(int iParam0)//Position - 0x229F
{
	if (iParam0 == 3)
	{
		return 30;
...
void func_35(int iParam0)//Position - 0x22EF
{
...
int func_36(var uParam0, var uParam1, vector3 vParam2)//Position - 0x2309
{
	int iVar0;
...
void func_37(var uParam0)//Position - 0x23C6
{
...
bool func_38(int iParam0)//Position - 0x23DF
{
	return Global_8D15 == iParam0;
}

void func_39(var uParam0, var uParam1, int iParam2)//Position - 0x23ED
{
	int iVar0;
...
void func_40(int iParam0, int iParam1)//Position - 0x2498
{
	Global_16C57.f_7 = iParam0;
	Global_16C57.f_8 = iParam1;
}

void func_41()//Position - 0x24B0
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar3 = 0;
	STATS::STAT_GET_INT(func_42(0), &iVar0, 4294967295);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_12(18, iVar0);
	}
	STATS::STAT_GET_INT(func_42(1), &iVar0, 4294967295);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_12(19, iVar0);
	}
	STATS::STAT_GET_INT(func_42(3), &iVar0, 4294967295);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_12(20, iVar0);
...
int func_42(int iParam0)//Position - 0x2553
{
	if (iParam0 == 3)
	{
...
void func_43(var uParam0)//Position - 0x25A4
{
	int iVar0;
	int iVar1;
...
void func_44(int iParam0, int iParam1)//Position - 0x2627
{
...
void func_45(var uParam0, int iParam1)//Position - 0x2664
{
	if (uParam0->f_3 <= 0)
	{
	}
...
void func_46(int iParam0, int iParam1, bool bParam2)//Position - 0x26D8
{
...
void func_47(var uParam0, int iParam1, bool bParam2)//Position - 0x27C4
{
	if (iParam1 < 0 || iParam1 >= 64)
	{
		return;
...
void func_48(int iParam0)//Position - 0x2825
{
...
int func_49(var uParam0)//Position - 0x2845
{
	int iVar0;
	int iVar1;
	...
	if (func_50(AUDIO::_0x0626A247D2405330()))
	{
...
int func_50(int iParam0)//Position - 0x28D1
{
...
void func_51(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)//Position - 0x28F2
{
	int iVar0;
...
void func_52(vector3 vParam0)//Position - 0x2A0B
{
	int iVar0;
...
bool func_53(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x2A49
{
	if (bParam2)
	{
...
bool func_54(var uParam0, int iParam1)//Position - 0x2A90
{
	if (iParam1 < 0 || iParam1 >= 64)
	{
		return 0;
...
void func_55()//Position - 0x2ACE
{
	...
	switch (iLocal_66)
	{
		case 0:
			...
			else if (func_50(iLocal_64) && func_50(AUDIO::_0x0626A247D2405330()))
			{
				...
				if (func_60(AUDIO::_0x0626A247D2405330(), iLocal_64, 0) > fVar0)
				{
					func_59();
					if (iLocal_49 == 2)
					{
...
int func_56(int iParam0, bool bParam1, bool bParam2)//Position - 0x2BEF
{
	return func_57(iParam0, !bParam1, bParam2);
}

int func_57(int iParam0, bool bParam1, bool bParam2)//Position - 0x2C02
{
	int iVar0;
...
float func_58(bool bParam0, float fParam1, float fParam2)//Position - 0x2CA6
{
	if (bParam0)
	{
		return fParam1;
...
float func_60(int iParam0, int iParam1, int iParam2)//Position - 0x2D02
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_62()//Position - 0x2D79
{
	if (func_50(AUDIO::_0x0626A247D2405330()))
	{
		if (func_50(iLocal_64))
		{
			if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_64, 0))
			{
				return 1;
			}
		}
		...
		{
			iLocal_64 = PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0);
	...
	if (func_24(&Local_42, &Local_48, vVar0, &iLocal_51))
	{
		...
		else
		{
			...
			if (func_25(42))
			{
				if (!func_25(43))
				{
					if (ENTITY::IS_ENTITY_IN_WATER(AUDIO::_0x0626A247D2405330()) && !PED::IS_PED_SWIMMING_UNDER_WATER(AUDIO::_0x0626A247D2405330()))
					{
...
float func_65(float fParam0, float fParam1, float fParam2)//Position - 0x31AE
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_68(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3287
{
	uParam0->f_6 = iParam1;
	func_69(&(uParam0->f_1), iParam2, iParam3);
}

void func_69(var uParam0, var uParam1, var uParam2)//Position - 0x32A1
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = 0;
	...
	while (iVar0 < uParam0->f_3)
	{
		if (func_29((uParam0->f_2 + iVar0), 4294967295, 4294967295))
		{
			iVar1++;
...
void func_70(var uParam0, int iParam1, int iParam2, char* sParam3)//Position - 0x330A
{
	*uParam0 = iParam1;
	uParam0->f_7 = iParam2;
	uParam0->f_8 = sParam3;
...
bool func_72(int iParam0)//Position - 0x3626
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x3644
{
	if (Global_8D15 == 15)
	{
		return 0;
...
bool func_74(int iParam0)//Position - 0x3666
{
	return func_75(iParam0, Global_8D15);
}

int func_75(int iParam0, int iParam1)//Position - 0x3677
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_76(int iParam0)//Position - 0x3858
{
	int iVar0;
	int iVar1;
...
void func_77(bool bParam0)//Position - 0x38B2
{
	int iVar0;
...
int func_78(int iParam0)//Position - 0x3951
{
	int iVar0;
	int iVar1;
...
bool func_79(var uParam0)//Position - 0x39AB
{
	if (uParam0->f_3 <= 0)
	{
	}
