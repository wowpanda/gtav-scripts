...
void __EntryFunction__()
{
	...
	else if (func_429(0))
	{
		...
		{
			func_427(PLAYER_PED_ID(), vLocal_625, fLocal_392, 0, 0);
	...
	while (true)
	{
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			...
			vLocal_619 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
			func_416();
			func_415();
			switch (iLocal_98)
			{
		...
		switch (iLocal_98)
		{
			case 0:
				if (iLocal_100 == 1)
				{
					if (!func_70())
					{
						func_19(PLAYER_PED_ID(), vLocal_628, fLocal_393, 0, 1);
			...
			case 1:
				...
				if (iLocal_100 == 1)
				{
					if (!func_70())
					{
						func_19(PLAYER_PED_ID(), vLocal_631, fLocal_394, 0, 1);
						SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_379 == 0)
						{
				...
				if (iLocal_100 == 1)
				{
					...
					if (iLocal_407 > 0)
					{
						...
						while (iVar0 <= (iLocal_407 - 1))
						{
							...
							{
								EXPLODE_PED_HEAD(Local_132[iVar0 /*19*/], joaat("weapon_sniperrifle"));
								SET_ENTITY_HEALTH(Local_132[iVar0 /*19*/], 0, 0);
							}
							iVar0++;
						}
					}
			...
			case 3:
				...
				if (iLocal_100 == 1)
				{
					...
					if (!func_70())
					{
						func_427(PLAYER_PED_ID(), vLocal_616, 254.9762f, 0, 0);
						SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_379 == 0)
						{
...
int func_36()
{
	if (func_58(vLocal_619, Local_322.f_1, 210f))
	{
		...
		if (!DOES_ENTITY_EXIST(Local_342))
		{
			if (func_58(vLocal_619, Local_342.f_1, 150f))
			{
				if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_342.f_1, 10f, func_47(), 0))
				{
					Local_342 = GET_CLOSEST_OBJECT_OF_TYPE(Local_342.f_1, 10f, func_47(), 1, 0, 1);
					if (func_428(Local_342))
					{
						SET_ENTITY_COORDS(Local_342, func_46(), 1, 0, 0, 1);
						SET_ENTITY_HEADING(Local_342, func_45());
						FREEZE_ENTITY_POSITION(Local_342, 1);
					}
				}
			}
		}
		if (!DOES_ENTITY_EXIST(Local_348))
		{
			if (func_58(vLocal_619, Local_348.f_1, 150f))
			{
				if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_348.f_1, 10f, func_44(), 0))
				{
					Local_348 = GET_CLOSEST_OBJECT_OF_TYPE(Local_348.f_1, 10f, func_44(), 1, 0, 1);
				}
			}
		}
	}
	else if (!IS_SPHERE_VISIBLE(Local_322.f_1, 2.5f))
	{
		func_41(&Local_322, 1);
	...
	if (func_22(Local_322))
	{
		if (func_428(Local_330))
		{
			if (func_57(2))
			{
				...
				TASK_SYNCHRONIZED_SCENE(Local_322, uVar0, func_40(), func_50(), 1000f, -8f, 4688, 0, 1148846080, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_330, uVar0, func_49(), func_40(), 1000f, -8f, iVar1, 1148846080);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_322, 1);
				SET_PED_MONEY(Local_322, 0);
				SET_PED_CAN_BE_TARGETTED(Local_322, 0);
				SET_PED_RELATIONSHIP_GROUP_HASH(Local_322, 1862763509);
				SET_PED_PATH_CAN_USE_CLIMBOVERS(Local_322, 0);
				SET_PED_PATH_CAN_DROP_FROM_HEIGHT(Local_322, 0);
				SET_PED_KEEP_TASK(Local_322, 1);
				SET_PED_CONFIG_FLAG(Local_322, 118, 0);
			}
		}
	}
}
...
void func_66()
{
	if (func_428(Local_112.f_9))
	{
		...
		{
			_0x2A56C06EBEF2B0D9(sLocal_429, Local_112.f_9, 0);
		}
	}
	if (func_428(Local_322))
	{
		if (_0xB56BBBCC2955D9CB())
		{
			_0x2A56C06EBEF2B0D9(sLocal_428, Local_322, 0);
		}
	}
}
		...
		case 0:
			...
			if (iLocal_102 == 4)
			{
				if (func_22(Local_322))
				{
					...
					if (!IS_AMBIENT_SPEECH_PLAYING(Local_322))
					{
						if (func_105(Local_322, GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 35f))
						{
							STOP_PED_SPEAKING(Local_322, 0);
				...
				{
					FREEZE_ENTITY_POSITION(Local_336, 0);
				}
				if (DOES_ENTITY_EXIST(Local_342))
				{
					FREEZE_ENTITY_POSITION(Local_342, 0);
				}
			...
			else if (!iLocal_375)
			{
				...
				if (iLocal_102 == 4)
				{
					...
					else if (func_22(Local_322))
					{
						...
						{
							if (!IS_PED_FLEEING(Local_322))
							{
								if (!IS_ENTITY_PLAYING_ANIM(Local_322, func_102(), func_73(), 3))
								{
									func_72(&Local_322);
									TASK_SMART_FLEE_PED(Local_322, PLAYER_PED_ID(), 50f, -1, 0, 0);
									SET_PED_KEEP_TASK(Local_322, 1);
								}
							}
						}
...
void func_91(bool bParam0)
{
	...
	if (func_22(Local_322))
	{
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_322, 0);
		SET_PED_KEEP_TASK(Local_322, 1);
	}
	...
	if (iLocal_407 > 0)
	{
		...
		while (iVar0 <= (iLocal_407 - 1))
		{
			if (iLocal_111 == 4)
			{
				if (func_22(Local_132[iVar0 /*19*/]))
				{
					SET_PED_RELATIONSHIP_GROUP_HASH(Local_132[iVar0 /*19*/], -2065892691);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_132[iVar0 /*19*/], 0);
					if (Global_105274 == 0)
					{
						SET_PED_KEEP_TASK(Local_132[iVar0 /*19*/], 0);
					}
					else
					{
						SET_PED_KEEP_TASK(Local_132[iVar0 /*19*/], 1);
					}
				}
			}
...
void func_99(var uParam0, bool bParam1)
{
	if (func_22(uParam0))
	{
		...
		if (!func_63(uParam0, 1805844857))
		{
			...
			TASK_SMART_FLEE_PED(uParam0, PLAYER_PED_ID(), 150f, -1, 0, 0);
		}
		if (bParam1)
		{
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0, 1);
...
void func_114(int iParam0)
{
	...
	{
		if (GET_PED_RELATIONSHIP_GROUP_HASH(Local_132[iParam0 /*19*/]) == iLocal_597)
		{
			SET_PED_HEARING_RANGE(Local_132[iParam0 /*19*/], 30f);
			SET_PED_SEEING_RANGE(Local_132[iParam0 /*19*/], 30f);
			SET_PED_ID_RANGE(Local_132[iParam0 /*19*/], 30f);
			SET_PED_COMBAT_RANGE(Local_132[iParam0 /*19*/], 0);
			SET_PED_COMBAT_ATTRIBUTES(Local_132[iParam0 /*19*/], 1, 0);
			SET_PED_COMBAT_ATTRIBUTES(Local_132[iParam0 /*19*/], 3, 1);
			SET_PED_COMBAT_ATTRIBUTES(Local_132[iParam0 /*19*/], 0, 1);
			TASK_LOOK_AT_ENTITY(Local_132[iParam0 /*19*/], PLAYER_PED_ID(), -1, 0, 2);
			if (!IS_PED_FLEEING(Local_132[iParam0 /*19*/]))
			{
				if (IS_PED_USING_ANY_SCENARIO(Local_132[iParam0 /*19*/]))
				{
					_0xF1C03A5352243A30(Local_132[iParam0 /*19*/]);
				}
				TASK_CLEAR_LOOK_AT(Local_132[iParam0 /*19*/]);
				CLEAR_PED_SECONDARY_TASK(Local_132[iParam0 /*19*/]);
				CLEAR_PED_TASKS(Local_132[iParam0 /*19*/]);
				TASK_HANDS_UP(Local_132[iParam0 /*19*/], -1, PLAYER_PED_ID(), -1, 0);
			}
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_132[iParam0 /*19*/], 1);
			Local_132[iParam0 /*19*/].f_14 = 2;
		}
		else
		{
			SET_PED_COMBAT_ATTRIBUTES(Local_132[iParam0 /*19*/], 13, 0);
			SET_PED_COMBAT_ATTRIBUTES(Local_132[iParam0 /*19*/], 5, 0);
			SET_PED_COMBAT_ATTRIBUTES(Local_132[iParam0 /*19*/], 17, 1);
			SET_PED_COMBAT_ATTRIBUTES(Local_132[iParam0 /*19*/], 0, 1);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_132[iParam0 /*19*/], 0);
	...
	switch (iLocal_100)
	{
		case 0:
			...
			if (func_36())
			{
				...
				{
					REGISTER_ENTITY_FOR_CUTSCENE(PLAYER_PED_ID(), sLocal_427, 0, 0, 0);
					if (func_428(Local_322))
					{
						REGISTER_ENTITY_FOR_CUTSCENE(Local_322, sLocal_428, 0, 0, 0);
					}
					if (func_428(Local_112.f_9))
					{
						REGISTER_ENTITY_FOR_CUTSCENE(Local_112.f_9, sLocal_429, 0, 0, 0);
					}
					if (func_428(Local_330))
					{
						REGISTER_ENTITY_FOR_CUTSCENE(Local_330, sLocal_430, 0, 0, 0);
					}
					if (func_428(Local_336))
					{
						REGISTER_ENTITY_FOR_CUTSCENE(Local_336, sLocal_431, 0, 0, 0);
					}
					START_CUTSCENE(0);
					WAIT(0);
					func_23(800, 0);
		...
		case 1:
			if (func_428(Local_330))
			{
				if (func_22(Local_322))
				{
					if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_428, 0) && CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_430, 0))
					{
						func_48();
					}
				}
			}
			if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_427, 0))
			{
		...
		case 2:
			...
			else
			{
				...
				if (func_22(Local_322))
				{
					TASK_LOOK_AT_ENTITY(Local_322, PLAYER_PED_ID(), -1, 0, 2);
					SET_PED_KEEP_TASK(Local_322, 1);
				}
...
void func_308()
{
	...
	if (func_22(Local_112.f_9))
	{
		...
		{
			case 0:
				SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_597);
				SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_597, 1862763509);
				iLocal_412 = GET_ENTITY_HEALTH(Local_112.f_9);
				vLocal_634 = { GET_ENTITY_COORDS(Local_112.f_9, 0) };
				...
				if (!iLocal_382)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						else
						{
							...
							{
								if (func_113(iLocal_397, GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_105(Local_112.f_9, vLocal_619, 30f))
									{
			...
			case 2:
				...
				iLocal_355 = 1;
				func_319();
				CLEAR_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_597);
				CLEAR_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_597, 1862763509);
				func_110(&(Local_112.f_8));
				iLocal_355 = 1;
				Local_112.f_17 = GET_GAME_TIMER();
				func_317(&uLocal_44, 0, 0);
			...
			switch (Local_112.f_10)
			{
				...
				case 30:
					if (!func_63(Local_112.f_9, 242628503))
					{
						...
						OPEN_SEQUENCE_TASK(&uLocal_418);
						TASK_GOTO_ENTITY_AIMING(0, PLAYER_PED_ID(), uVar3, 30f);
						TASK_AIM_GUN_AT_ENTITY(0, PLAYER_PED_ID(), 2000, 0);
						CLOSE_SEQUENCE_TASK(uLocal_418);
						TASK_PERFORM_SEQUENCE(Local_112.f_9, uLocal_418);
						CLEAR_SEQUENCE_TASK(&uLocal_418);
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
					}
					break;
				...
				case 31:
					if (func_113(Local_112.f_18, GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						SET_PED_ACCURACY(Local_112.f_9, 50);
						GET_CURRENT_PED_WEAPON(Local_112.f_9, &iVar0, 1);
						if (iVar0 == joaat("weapon_unarmed"))
						{
							GIVE_WEAPON_TO_PED(Local_112.f_9, joaat("weapon_pistol"), -1, 0, 1);
						...
						OPEN_SEQUENCE_TASK(&uLocal_418);
						TASK_AIM_GUN_AT_ENTITY(0, PLAYER_PED_ID(), 1500, 0);
						TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_622, PLAYER_PED_ID(), 1f, 1, 1056964608, 1082130432, 1, 0, 0, -957453492, 20000);
						TASK_SEEK_COVER_FROM_PED(0, PLAYER_PED_ID(), GET_RANDOM_INT_IN_RANGE(1500, 2500), 1);
						TASK_COMBAT_PED(0, PLAYER_PED_ID(), 0, 16);
						TASK_SET_SPHERE_DEFENSIVE_AREA(0, vLocal_622, 50f);
						CLOSE_SEQUENCE_TASK(uLocal_418);
						TASK_PERFORM_SEQUENCE(Local_112.f_9, uLocal_418);
						CLEAR_SEQUENCE_TASK(&uLocal_418);
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
				...
				case 33:
					if (func_113(Local_112.f_18, GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						SET_PED_ACCURACY(Local_112.f_9, 10);
						GET_CURRENT_PED_WEAPON(Local_112.f_9, &iVar0, 1);
						if (iVar0 == joaat("weapon_unarmed"))
						{
							GIVE_WEAPON_TO_PED(Local_112.f_9, joaat("weapon_pistol"), -1, 0, 1);
						...
						OPEN_SEQUENCE_TASK(&uLocal_418);
						TASK_AIM_GUN_AT_ENTITY(0, PLAYER_PED_ID(), 750, 0);
						TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_622, PLAYER_PED_ID(), 2f, 1, 0.5f, 4f, 1, 0, 0, -687903391, 20000);
						TASK_SEEK_COVER_FROM_PED(0, PLAYER_PED_ID(), GET_RANDOM_INT_IN_RANGE(1000, 2000), 0);
						TASK_SET_SPHERE_DEFENSIVE_AREA(0, vLocal_622, 50f);
						CLOSE_SEQUENCE_TASK(uLocal_418);
						TASK_PERFORM_SEQUENCE(Local_112.f_9, uLocal_418);
						CLEAR_SEQUENCE_TASK(&uLocal_418);
				...
				case 35:
					if (func_113(Local_112.f_18, GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						OPEN_SEQUENCE_TASK(&uLocal_418);
						TASK_AIM_GUN_AT_ENTITY(0, PLAYER_PED_ID(), 750, 0);
						TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_622, PLAYER_PED_ID(), 2f, 1, 0.75f, 4f, 1, 0, 0, -687903391, 20000);
						CLOSE_SEQUENCE_TASK(uLocal_418);
						TASK_PERFORM_SEQUENCE(Local_112.f_9, uLocal_418);
						CLEAR_SEQUENCE_TASK(&uLocal_418);
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
				...
				case 37:
					if (func_113(Local_112.f_18, GET_RANDOM_INT_IN_RANGE(250, 750)))
					{
						...
						SET_PED_COMBAT_RANGE(Local_112.f_9, 1);
				...
				case 13:
					if (func_113(Local_112.f_18, GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (IS_PED_USING_ANY_SCENARIO(Local_112.f_9))
						{
							_0xFE07FF6495D52E2A(Local_112.f_9, vLocal_619);
						}
						GET_CURRENT_PED_WEAPON(Local_112.f_9, &iVar0, 1);
						if (iVar0 != joaat("weapon_unarmed"))
						{
						...
						SET_PED_COMBAT_ATTRIBUTES(Local_112.f_9, 5, 0);
						SET_PED_COMBAT_ATTRIBUTES(Local_112.f_9, 17, 1);
						TASK_SMART_FLEE_PED(Local_112.f_9, PLAYER_PED_ID(), 200f, -1, 0, 0);
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
						SET_PED_KEEP_TASK(Local_112.f_9, 1);
						Local_112.f_10 = 14;
					}
				...
				case 15:
					...
					{
						if ((!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_191[0 /*6*/], 0) && func_105(Local_191[0 /*6*/], Local_191[0 /*6*/].f_1, 3f)) && func_363(GET_ENTITY_HEADING(Local_191[0 /*6*/]), Local_191[0 /*6*/].f_4, 20f))
						{
							if (IS_PED_IN_VEHICLE(Local_112.f_9, Local_191[0 /*6*/], 0) && !IS_PED_BEING_JACKED(Local_112.f_9))
							{
								Local_112.f_10 = 16;
							}
							else if (func_113(Local_112.f_18, GET_RANDOM_INT_IN_RANGE(250, 350)))
							{
								...
								TASK_ENTER_VEHICLE(Local_112.f_9, Local_191[0 /*6*/], 25000, -1, 2f, 8388608, 0);
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, 1);
								Local_112.f_10 = 16;
							}
						}
				...
				case 16:
					...
					else if (((IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_191[0 /*6*/], 0) || IS_PED_BEING_JACKED(Local_112.f_9)) || !func_105(Local_191[0 /*6*/], Local_191[0 /*6*/].f_1, 3f)) || !func_363(GET_ENTITY_HEADING(Local_191[0 /*6*/]), Local_191[0 /*6*/].f_4, 20f))
					{
						Local_112.f_10 = 13;
					}
					else if (IS_PED_SITTING_IN_VEHICLE(Local_112.f_9, Local_191[0 /*6*/]))
					{
						Local_112.f_10 = 39;
					}
				...
				case 17:
					if (func_95(Local_191[0 /*6*/]) && IS_PED_SITTING_IN_VEHICLE(Local_112.f_9, Local_191[0 /*6*/]))
					{
						TASK_VEHICLE_MISSION_PED_TARGET(Local_112.f_9, Local_191[0 /*6*/], PLAYER_PED_ID(), 8, 30f, 786468, 350f, 30f, 1);
...
void func_377()
{
	if (func_58(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_616, 100f))
	{
		if (!func_378())
		{
			REQUEST_CUTSCENE(&cLocal_604, 8);
			func_66();
			iLocal_386 = 1;
		}
	}
	...
	{
		if (!func_58(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_616, 120f))
		{
			if (HAS_CUTSCENE_LOADED())
			{
				REMOVE_CUTSCENE();
		...
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			if (IS_PED_IN_ANY_VEHICLE(Local_112.f_9, 0) && GET_VEHICLE_PED_IS_IN(Local_112.f_9, 0) == iVar0)
			{
				if (!IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0))
				{
					...
					{
						if ((GET_GAME_TIMER() - iLocal_396) > 7500)
						{
							func_385(0);
						}
					}
					...
					{
						if ((GET_GAME_TIMER() - iLocal_396) > 10000)
						{
							func_385(1);
						}
					}
			...
			else
			{
				...
				else if (Local_112.f_10 == 24 && func_63(Local_112.f_9, -1519143300))
				{
					if (func_105(Local_112.f_9, vLocal_619, 25f))
					{
						...
						{
							if (func_113(iLocal_398, GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_61())
								{
									func_5();
				...
				else
				{
					...
					if (!func_61())
					{
						if (func_113(iLocal_397, GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_105(Local_112.f_9, vLocal_619, 20f))
							{
			...
			case 1:
				if (!iLocal_383)
				{
					...
					else
					{
						...
						if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_616, 4f, 4f, 2f, 1, 1, 0))
						{
						}
						...
						if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
						{
							if (func_105(PLAYER_PED_ID(), vLocal_616, 6.5f))
							{
								iLocal_100 = 2;
							}
						}
						else if (func_105(PLAYER_PED_ID(), vLocal_616, 2.5f))
						{
							iLocal_100 = 2;
						}
					}
		...
		if (func_22(Local_132[iVar0 /*19*/]))
		{
			...
			switch (Local_132[iVar0 /*19*/].f_14)
			{
				...
				case 2:
					...
					{
						if (!func_22(Local_112.f_9) || (IS_PED_FLEEING(Local_112.f_9) && GET_PED_DESIRED_MOVE_BLEND_RATIO(Local_112.f_9) > 1f))
						{
							if (GET_SCRIPT_TASK_STATUS(Local_132[iVar0 /*19*/], -1519143300) == 1)
							{
								if (iVar0 == 0)
								{
									iVar2 = 750;
								...
								UPDATE_TASK_HANDS_UP_DURATION(Local_132[iVar0 /*19*/], iVar2);
							}
							else
							{
								CLEAR_PED_TASKS(Local_132[iVar0 /*19*/]);
								CLEAR_PED_SECONDARY_TASK(Local_132[iVar0 /*19*/]);
							}
							Local_132[iVar0 /*19*/].f_14 = 4;
							func_109(&(Local_132[iVar0 /*19*/].f_6));
						}
					...
					else if (!func_63(Local_132[iVar0 /*19*/], 780511057))
					{
						...
						if (func_105(Local_132[iVar0 /*19*/], vLocal_619, 5f))
						{
							...
							{
								SET_PED_SPHERE_DEFENSIVE_AREA(Local_132[iVar0 /*19*/], GET_ENTITY_COORDS(Local_132[iVar0 /*19*/], 1), 5f, 0, 0);
								TASK_COMBAT_PED(Local_132[iVar0 /*19*/], PLAYER_PED_ID(), 0, 16);
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_132[iVar0 /*19*/], 1);
							}
						}
					}
					else
					{
						...
						{
							CLEAR_PED_TASKS(Local_132[iVar0 /*19*/]);
							TASK_LOOK_AT_ENTITY(Local_132[iVar0 /*19*/], PLAYER_PED_ID(), -1, 0, 2);
							TASK_TURN_PED_TO_FACE_ENTITY(Local_132[iVar0 /*19*/], PLAYER_PED_ID(), -1);
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_132[iVar0 /*19*/], 0);
						}
				...
				case 4:
					...
					{
						if (!IS_PED_FLEEING(Local_132[iVar0 /*19*/]))
						{
...
int func_395(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, float fParam6)
{
	...
	if (func_22(uParam0))
	{
		...
		{
			vVar0 = { GET_ENTITY_COORDS(uParam0, 1) };
			if (IS_BULLET_IN_AREA(vVar0, fParam5, 1))
			{
				return 1;
			}
			if (func_105(uParam0, vLocal_619, fParam2))
			{
				...
				if (IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), uParam0) || HAS_PED_RECEIVED_EVENT(uParam0, 56))
				{
					return 1;
				}
			}
			...
			if (IS_EXPLOSION_IN_SPHERE(-1, vVar0, fParam6))
			{
				return 1;
			}
			vVar3 = { vVar0 };
...
void func_396(int iParam0)
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_22(Local_132[iVar0 /*19*/]))
		{
			Local_132[iVar0 /*19*/].f_15 = GET_GAME_TIMER();
	...
	if (func_22(Local_112.f_9))
	{
		...
		switch (iLocal_100)
		{
			...
			case 2:
				...
				func_398(0);
				func_352(&(Local_112.f_8), "", "", &iLocal_400, iLocal_401, 0);
				iLocal_400 = GET_GAME_TIMER();
				iLocal_401 = GET_GAME_TIMER();
				func_124(2);
				break;
			}
	}
	...
	if (!iLocal_367)
	{
		if (!func_61())
		{
			if (func_105(Local_112.f_9, vLocal_619, (25f + 5f)))
			{
				...
				if (IS_STRING_NULL_OR_EMPTY(&Local_610))
				{
...
void func_417()
{
	if (DOES_ENTITY_EXIST(Local_322))
	{
		if (IS_ENTITY_DEAD(Local_322, 0) || IS_PED_INJURED(Local_322))
		{
			iLocal_102 = 3;
			return;
		}
	...
	if (iLocal_98 == 0)
	{
		if (!VDIST2(vLocal_619, Local_103) <= ((Local_103.f_3 + 25f) * (Local_103.f_3 + 25f)))
		{
...
int func_418(bool bParam0)
{
	if (func_22(Local_322))
	{
		if ((HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(Local_322) || HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(Local_322)) || HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(Local_322))
		{
			return 1;
		}
		if (IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()))
		{
			if (IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), Local_322))
			{
				return 1;
			}
			if (DOES_ENTITY_EXIST(Local_330))
			{
				if (IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), Local_330))
				{
					return 1;
				}
			}
			if (DOES_ENTITY_EXIST(Local_342))
			{
				if (IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), Local_342))
				{
					return 1;
				}
			}
		...
		if (HAS_PED_RECEIVED_EVENT(Local_322, 60))
		{
			return 1;
		}
		if (IS_PED_RAGDOLL(Local_322))
		{
			if (IS_ENTITY_AT_ENTITY(Local_322, PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0))
			{
				return 1;
			}
		}
		if (HAS_PED_RECEIVED_EVENT(Local_322, 50))
		{
			return 1;
		}
		...
		if (IS_EXPLOSION_IN_SPHERE(-1, GET_ENTITY_COORDS(Local_322, 1), 15f))
		{
			return 1;
		}
		if (HAS_PED_RECEIVED_EVENT(Local_322, 72))
		{
			return 1;
		}
		if (bParam0)
...
int func_424(int iParam0, float fParam1)
{
	...
	if (func_428(PLAYER_PED_ID()) && func_428(iParam0))
	{
		if (func_426(iParam0) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), iParam0))
		{
...
void func_431()
{
	...
	func_20();
	REMOVE_RELATIONSHIP_GROUP(iLocal_597);
	func_516();
	func_124(0);
}
...
void func_432(bool bParam0, bool bParam1)
{
	...
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_416, 0);
	CLEAR_PED_NON_CREATION_AREA();
		...
		if (Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam5, 0, 0, 0);
				...
				func_478(uParam0, &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam5, 0, 0, 0);
				...
				func_478(uParam0, &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				SET_VEHICLE_ENVEFF_SCALE(*uParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (GET_ENTITY_MODEL(*uParam0) == joaat("bodhi2"))
...
void func_444(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if ((func_83(iParam0) && DOES_ENTITY_EXIST(*uParam1)) && IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_448(*uParam1, 0, &uVar0))
		{
			...
			if (bParam3)
			{
				...
				Global_106565.f_20112[iParam0 /*43*/].f_31 = func_447(*uParam1);
...
int func_448(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = GET_ENTITY_MODEL(iParam0);
	if ((!func_473(iVar0, bParam1, uParam2) && !func_472(PLAYER_ID())) && !func_456(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_454(PLAYER_ID()) && (IS_THIS_MODEL_A_HELI(iVar0) || IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_452(iParam0)) && !bVar1) && !(func_451(GET_ENTITY_MODEL(iParam0)) && func_449(PLAYER_ID())))
	{
...
int func_458(int iParam0)
{
	...
	if (func_459(GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_460(int iParam0, bool bParam1)
{
	switch (GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_462(GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_473(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_454(PLAYER_ID()) && (IS_THIS_MODEL_A_HELI(iParam0) || IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_478(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_469(GET_ENTITY_MODEL(*uParam0), 1) && GET_VEHICLE_MOD(*uParam0, 24) != func_481(*uParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*uParam0, 24, func_481(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_480(uParam0);
	if (func_479(*uParam0))
	{
...
void func_516()
{
	...
	ADD_RELATIONSHIP_GROUP("ENEMIES", &iLocal_597);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_597);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_597, 1862763509);
	vVar0 = { func_523(Local_103) };
	vVar3 = { func_522(Local_103) };
	SET_PED_NON_CREATION_AREA(vVar0, vVar3);
	uLocal_416 = ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar3, 0, 1, 1, 1);
	...
	if (func_22(PLAYER_PED_ID()))
	{
		func_90(&uLocal_432, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
...
void func_517()
{
	...
	if (func_22(Local_112.f_9))
	{
		...
		if (Local_112.f_12 != 0)
		{
			GIVE_WEAPON_TO_PED(Local_112.f_9, Local_112.f_12, -1, 0, 1);
		}
		func_354(Local_112.f_9);
		func_518(Local_112.f_9, "TARGET_", 0);
		Local_112.f_10 = 0;
		SET_PED_COMPONENT_VARIATION(Local_112.f_9, 0, 1, 1, 0);
		SET_PED_COMPONENT_VARIATION(Local_112.f_9, 2, 1, 1, 0);
		SET_PED_COMPONENT_VARIATION(Local_112.f_9, 3, 0, 1, 0);
		SET_PED_COMPONENT_VARIATION(Local_112.f_9, 4, 0, 0, 0);
		OPEN_SEQUENCE_TASK(&uLocal_418);
		TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "base", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "base", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "idle_a", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "idle_c", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "idle_a", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "base", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "idle_a", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		SET_SEQUENCE_TO_REPEAT(uLocal_418, 1);
		CLOSE_SEQUENCE_TASK(uLocal_418);
		TASK_PERFORM_SEQUENCE(Local_112.f_9, uLocal_418);
		CLEAR_SEQUENCE_TASK(&uLocal_418);
	}
	...
	while (iVar0 <= 2)
	{
		if (func_22(Local_132[iVar0 /*19*/]))
		{
			...
			if (iVar0 == 0 || iVar0 == 2)
			{
				SET_PED_RELATIONSHIP_GROUP_HASH(Local_132[iVar0 /*19*/], iLocal_597);
			}
			...
			switch (iVar0)
			{
				case 0:
					OPEN_SEQUENCE_TASK(&uLocal_418);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "idle_b", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "idle_b", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					SET_SEQUENCE_TO_REPEAT(uLocal_418, 1);
					CLOSE_SEQUENCE_TASK(uLocal_418);
					TASK_PERFORM_SEQUENCE(Local_132[iVar0 /*19*/], uLocal_418);
					CLEAR_SEQUENCE_TASK(&uLocal_418);
					break;
				
				case 1:
					OPEN_SEQUENCE_TASK(&uLocal_418);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "idle_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "idle_b", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "idle_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
					SET_SEQUENCE_TO_REPEAT(uLocal_418, 1);
					CLOSE_SEQUENCE_TASK(uLocal_418);
				...
				case 2:
					OPEN_SEQUENCE_TASK(&uLocal_418);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "idle_c", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "idle_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "idle_a", 8f, -8f, -1, 0, 0, 0, 0, 0);
					SET_SEQUENCE_TO_REPEAT(uLocal_418, 1);
					CLOSE_SEQUENCE_TASK(uLocal_418);
...
int func_519()
{
	...
	if (iVar1 == iLocal_407)
	{
		...
		while (iVar2 <= (iLocal_407 - 1))
		{
			SET_MODEL_AS_NO_LONGER_NEEDED(Local_132[iVar2 /*19*/].f_18);
			iVar2++;
		}
	}
	if (iLocal_404 > 0)
	...
	if (iLocal_403 > 0)
	{
		...
		while (iVar2 <= (iLocal_403 - 1))
		{
			...
			{
				FREEZE_ENTITY_POSITION(Local_277[iVar2 /*9*/], 1);
				iVar0++;
			}
			iVar2++;
		}
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_539()) || Global_105612) || Global_25767) || func_545()) || func_88(8, -1)) || func_544()) || func_543()) || func_537()) || func_538()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_539()) || Global_25767) || func_545()) || func_88(8, -1)) || func_537()) || func_544()) || func_543()) || func_538()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_539()) || Global_105612) || Global_25767) || func_545()) || func_88(8, -1)) || func_544()) || func_543()) || func_538()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_539() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_88(8, -1)) || func_538()) || func_542()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_539()) || Global_25767) || func_545()) || func_88(8, -1)) || func_543()) || func_537()) || func_538()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
...
int func_550(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_561())
	{
		...
		{
			iVar33 = func_551(GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
