...
void __EntryFunction__()
{
	...
	else if (func_427(0))
	{
		...
		{
			func_425(PLAYER::PLAYER_PED_ID(), vLocal_333, fLocal_117, 0, 0);
		...
		switch (iLocal_58)
		{
			...
			case 3:
				...
				if (iLocal_60 == 1)
				{
					...
					if (!func_69())
					{
						func_425(PLAYER::PLAYER_PED_ID(), vLocal_330, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_104 == 0)
						{
...
void func_25(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_30(PLAYER::PLAYER_ID())) && !func_27(PLAYER::PLAYER_ID(), 0)) && !func_26())
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_30(PLAYER::PLAYER_ID()))
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_70854 = 0;
...
void func_81()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_84(Global_104555.f_2353.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_95149.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_95149.f_4, 0))
		{
			if (func_176(24) != Global_95149.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_173(ENTITY::GET_ENTITY_COORDS(Global_95149.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
int func_191(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_70671[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_201(iVar0), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_201(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_201(iVar0), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, iParam4);
						}
						func_233(iVar0);
						if (Global_70669 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_201(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_201(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_201(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, iParam4);
		}
		if (Global_70669 == 1)
		{
			iVar2 = 0;
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_244(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
		...
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_244(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_305(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_70671[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_201(iParam1)) && Global_70671[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_201(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_331(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_338() || func_337(Global_4456448.f_143970)) || func_336())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if ((VEHICLE::_0xE33FFA906CE74880(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), func_335(PLAYER::PLAYER_PED_ID(), 0)) || (ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) == joaat("apc") && func_335(PLAYER::PLAYER_PED_ID(), 0) != -1)) || (ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) == joaat("akula") && func_335(PLAYER::PLAYER_PED_ID(), 0) != -1))
			{
				return 0;
			}
		}
...
void func_340(var uParam0, int iParam1, vector3 vParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_350(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
...
int func_351(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
		...
		if (iLocal_70 == 0)
		{
			...
			if (func_364())
			{
				if (iLocal_107 || iLocal_58 == 7)
				{
					...
					{
						PED::SET_PED_MOVEMENT_CLIPSET(Local_68.f_9, func_362(), 1048576000);
						iLocal_70 = 1;
					}
				}
			}
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_68.f_10)
			{
				...
				case 15:
					...
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_71[0 /*6*/], 0) && func_104(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f)) && func_361(ENTITY::GET_ENTITY_HEADING(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f))
						{
				...
				case 16:
					...
					else if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_71[0 /*6*/], 0) || PED::IS_PED_BEING_JACKED(Local_68.f_9)) || !func_104(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f)) || !func_361(ENTITY::GET_ENTITY_HEADING(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f))
					{
						Local_68.f_10 = 13;
					}
				...
				case 21:
					...
					else if (PED::DOES_GROUP_EXIST(func_357()))
					{
						...
						if (!PED::IS_PED_GROUP_MEMBER(Local_68.f_9, func_357()))
						{
							PED::SET_PED_AS_GROUP_MEMBER(Local_68.f_9, func_357());
						}
						PED::SET_GROUP_FORMATION(func_357(), 0);
						PED::SET_GROUP_FORMATION_SPACING(func_357(), 1.5f, 3.5f, -1082130432);
					...
					if (func_359(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_358())
					{
						...
						if (((!PED::IS_PED_RAGDOLL(Local_68.f_9) && !PED::IS_PED_BEING_STUNNED(Local_68.f_9, 0)) && !PED::IS_PED_BEING_JACKED(Local_68.f_9)) && !func_62(Local_68.f_9, -828834893))
						{
							...
							if ((!func_355(Local_68.f_19, 10) && func_104(Local_68.f_9, vLocal_331, 50f)) || !func_112(iLocal_140, 2000))
							{
								...
								else if (((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && !PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_68.f_9)) && !func_358()) || ENTITY::IS_ENTITY_IN_WATER(Local_68.f_9))
								{
									BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(Local_68.f_9, PLAYER::PLAYER_PED_ID(), -1);
								}
				...
				case 24:
					if (func_359(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_358())
					{
						if (!func_62(Local_68.f_9, -1519143300))
						{
							...
							{
								if ((WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_68.f_9)) || func_358())
								{
									Local_68.f_10 = 23;
								}
							}
...
int func_359(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_364()
{
	STREAMING::REQUEST_ANIM_SET(func_362());
	STREAMING::REQUEST_ANIM_SET(func_363());
	if (STREAMING::HAS_CLIP_SET_LOADED(func_362()) && STREAMING::HAS_CLIP_SET_LOADED(func_363()))
	{
		return 1;
	}
	return 0;
...
void func_366(int iParam0, var uParam1, float fParam2, int iParam3)
{
	if (func_426(iParam0))
	{
		if (func_367(iParam0, PLAYER::PLAYER_PED_ID(), fParam2, 1, 250, iParam3))
		{
...
void func_374(int iParam0, int iParam1, float fParam2, int iParam3)
{
	if (func_426(iParam0))
	{
		if (func_367(PLAYER::PLAYER_PED_ID(), iParam0, fParam2, 1, 250, iParam3))
		{
...
int func_378(int iParam0, vector3 vParam1, int iParam2, int iParam3, float fParam4)
{
	vector3 vVar0;
	var uVar1;
	char[] cVar2[8];
...
int func_387(vector3 vParam0, int iParam1, bool bParam2)
{
	int iVar0;
...
int func_392(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
int func_393(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, float fParam6)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
void func_432()
{
	STREAMING::REMOVE_ANIM_SET(func_362());
...
int func_446(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_466(iVar0, bParam1, uParam2) && !func_465(PLAYER::PLAYER_ID())) && !func_450(iParam0))
	{
		return 0;
	}
...
int func_452(int iParam0)
{
	...
	if (func_453(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
void func_476(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90309[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90309[iVar0]) == func_157(iParam0, iParam1))
				{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_532()) || Global_103602) || Global_25235) || func_538()) || func_87(8, -1)) || func_537()) || func_536()) || func_530()) || func_531()) || Global_104555.f_7658.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_532()) || Global_25235) || func_538()) || func_87(8, -1)) || func_530()) || func_537()) || func_536()) || func_531()) || Global_104555.f_7658.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_532()) || Global_103602) || Global_25235) || func_538()) || func_87(8, -1)) || func_530()) || func_537()) || func_536()) || func_531()) || Global_104555.f_7658.f_919[iVar0] == 5) || Global_36408 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_532()) || Global_103602) || Global_25235) || func_538()) || func_87(8, -1)) || func_537()) || func_536()) || func_531()) || Global_104555.f_7658.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_532() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_87(8, -1)) || func_531()) || func_535()) || Global_104555.f_7658.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_532()) || Global_25235) || func_538()) || func_87(8, -1)) || func_536()) || func_530()) || func_531()) || Global_104555.f_7658.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_532()) || func_536()) || Global_103602) || Global_25235) || func_538()) || Global_36993) || func_87(8, -1)) || func_530()) || func_535()) || func_531()) || Global_104555.f_7658.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_532()) || Global_103602) || Global_25235) || func_538()) || func_87(8, -1)) || func_530()) || func_535()) || func_537()) || func_536()) || func_531())
						{
							return 0;
						}
						break;
