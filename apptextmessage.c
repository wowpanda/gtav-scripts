...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Global_14553.f_1 != 9)
		{
			...
			{
				if (ARE_STRINGS_EQUAL(&(Global_106565.f_14135[iLocal_58 /*104*/]), "CELL_FINV"))
				{
				}
				else
				{
...
void func_6()
{
	if (Global_106565.f_14135[iLocal_58 /*104*/].f_24 == 1)
	{
		if (Global_14531 == 0)
		{
			if (IS_CONTROL_JUST_PRESSED(2, Global_14524))
			{
				func_2();
				Global_14531 = 1;
				func_22();
				...
				_REMOVE_NOTIFICATION(Global_106565.f_14135[iLocal_58 /*104*/].f_16);
				func_40(Global_14534, "SET_DATA_SLOT_EMPTY", 6f, -1082130432, -1082130432, -1082130432, -1082130432);
				func_38();
				if (iLocal_56 > 0)
				{
			...
			else if (Global_15866 == 4 || Global_15866 == 3)
			{
				...
				else
				{
					...
					if (Global_106565.f_28044[Global_1738 /*29*/].f_24[Global_14553] == 0)
					{
						...
						func_13(Global_14534, "SET_DATA_SLOT", TO_FLOAT(4), TO_FLOAT(0), TO_FLOAT(3), -1f, -1f, &(Global_117[Global_1738 /*10*/].f_4), "CELL_300", &vVar0, "CELL_195", 0);
					}
					else
					{
						func_40(Global_14534, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_13(Global_14534, "SET_DATA_SLOT", TO_FLOAT(4), TO_FLOAT(0), TO_FLOAT(3), -1f, -1f, &(Global_106565.f_28044[Global_1738 /*29*/].f_3), &(Global_106565.f_28044[Global_1738 /*29*/].f_7), &vVar0, &(Global_106565.f_28044[Global_1738 /*29*/].f_3), 0);
					}
				}
				func_40(Global_14534, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
						...
						if (Global_2992[iVar0] == 0)
						{
							...
							else if (iVar1 == 7)
							{
								...
								else
								{
									...
									func_13(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(uVar6), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
...
void func_15()
{
	...
	{
		if (func_16() && IS_PED_IN_COVER(PLAYER_PED_ID(), 0))
		{
			iVar1 = 1;
		}
	}
		...
		if ((func_3(2, Global_14522, 0) || Global_106565.f_14045[Global_14553 /*20*/].f_17 == 1) || Global_16926 == 1)
		{
			...
			if (Global_106565.f_14135[iLocal_58 /*104*/].f_24 != 0)
			{
				...
				else
				{
					...
					uLocal_67 = _END_SCALEFORM_MOVIE_METHOD_RETURN();
					while (!IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_67) && iLocal_62 == 0)
					{
						WAIT(0);
						if (TIMERB() > 2000)
						{
					...
					{
						iLocal_63 = GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_67);
					}
					if (iLocal_63 < 0)
					{
						iLocal_63 = 0;
				...
				if (Global_106565.f_14135[iLocal_58 /*104*/].f_17 == 145)
				{
					...
					ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106565.f_14135[iLocal_58 /*104*/].f_50));
					END_TEXT_COMMAND_SCALEFORM_STRING();
				}
				else
				{
				...
				switch (Global_106565.f_14135[iLocal_58 /*104*/].f_32)
				{
					...
					case 1:
						BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&(Global_106565.f_14135[iLocal_58 /*104*/]));
						ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106565.f_14135[iLocal_58 /*104*/].f_33));
						if (Global_106565.f_14135[iLocal_58 /*104*/].f_66 == 1 && !ARE_STRINGS_EQUAL(&(Global_106565.f_14135[iLocal_58 /*104*/].f_67), "NULL"))
						{
							ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106565.f_14135[iLocal_58 /*104*/].f_67));
						}
						if ((Global_106565.f_14135[iLocal_58 /*104*/].f_66 == 2 && !ARE_STRINGS_EQUAL(&(Global_106565.f_14135[iLocal_58 /*104*/].f_67), "NULL")) && !ARE_STRINGS_EQUAL(&(Global_106565.f_14135[iLocal_58 /*104*/].f_83), "NULL"))
						{
							if (DOES_TEXT_LABEL_EXIST(&(Global_106565.f_14135[iLocal_58 /*104*/].f_67)))
							{
								ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_106565.f_14135[iLocal_58 /*104*/].f_67));
							}
							else
							{
								ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106565.f_14135[iLocal_58 /*104*/].f_67));
							}
							if (DOES_TEXT_LABEL_EXIST(&(Global_106565.f_14135[iLocal_58 /*104*/].f_83)))
							{
								ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_106565.f_14135[iLocal_58 /*104*/].f_83));
							}
							else
							{
								ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106565.f_14135[iLocal_58 /*104*/].f_83));
							}
						}
						END_TEXT_COMMAND_SCALEFORM_STRING();
						break;
					...
					case 2:
						BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&(Global_106565.f_14135[iLocal_58 /*104*/]));
						ADD_TEXT_COMPONENT_INTEGER(Global_106565.f_14135[iLocal_58 /*104*/].f_49);
						END_TEXT_COMMAND_SCALEFORM_STRING();
						break;
				...
				{
					if (IS_PEDHEADSHOT_VALID(Global_16935[iLocal_58]))
					{
						if (IS_PEDHEADSHOT_READY(Global_16935[iLocal_58]))
						{
							sVar16 = GET_PEDHEADSHOT_TXD_STRING(Global_16935[iLocal_58]);
						}
						else
						{
							sVar16 = "CHAR_DEFAULT";
...
void func_31()
{
	...
	if (iLocal_2219)
	{
		SET_STREAMED_TEXTURE_DICT_AS_NO_LONGER_NEEDED(&uLocal_68);
	}
	iLocal_2219 = 0;
	if (Global_106565.f_14135[iLocal_58 /*104*/].f_24 != 0)
	{
		...
		while (iVar0 < 165)
		{
			if (ARE_STRINGS_EQUAL(&(Global_106565.f_14135[iLocal_58 /*104*/]), &(Local_84[iVar0 /*6*/])))
			{
				if (iVar0 < 19)
				{
				...
				iLocal_2219 = 1;
				REQUEST_STREAMED_TEXTURE_DICT(&uLocal_68, 0);
				while (!HAS_STREAMED_TEXTURE_DICT_LOADED(&uLocal_68))
				{
					WAIT(100);
				}
			}
...
void func_32()
{
	...
	if (iLocal_61 == 0)
	{
		if (func_3(2, Global_14529, 0) || IS_CONTROL_JUST_PRESSED(2, 181))
		{
			if (iLocal_56 > 0)
			{
				iLocal_56 = (iLocal_56 - 1);
		...
		if (func_3(2, Global_14530, 0) || IS_CONTROL_JUST_PRESSED(2, 180))
		{
			iLocal_56++;
...
void func_37()
{
	if (Global_106565.f_14045[Global_14553 /*20*/].f_17 == 0)
	{
		...
		func_40(Global_14534, "DISPLAY_VIEW", 6f, TO_FLOAT(iLocal_57), -1082130432, -1082130432, -1082130432);
		func_29(Global_14534, "SET_HEADER", "CELL_1", 0, 0, 0, 0);
		if (Global_14541)
		{
			if (iLocal_55 > 0)
	...
	while (iVar36 < 34)
	{
		...
		if (Global_106565.f_14135[iVar38 /*104*/].f_24 != 0)
		{
			if (Global_106565.f_14135[iVar38 /*104*/].f_99[Global_14553] == 1)
			{
				...
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_106565.f_14135[iVar38 /*104*/].f_18.f_2);
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_106565.f_14135[iVar38 /*104*/].f_18.f_1);
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_59);
				if (Global_106565.f_14135[iVar38 /*104*/].f_17 == 145)
				{
					BEGIN_TEXT_COMMAND_SCALEFORM_STRING("CELL_CONDFNH");
					ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106565.f_14135[iVar38 /*104*/].f_50));
					END_TEXT_COMMAND_SCALEFORM_STRING();
				}
				else
				{
				...
				switch (Global_106565.f_14135[iVar38 /*104*/].f_32)
				{
					...
					case 1:
						BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&(Global_106565.f_14135[iVar38 /*104*/]));
						ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106565.f_14135[iVar38 /*104*/].f_33));
						if (Global_106565.f_14135[iVar38 /*104*/].f_66 == 1 && !ARE_STRINGS_EQUAL(&(Global_106565.f_14135[iVar38 /*104*/].f_67), "NULL"))
						{
							ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106565.f_14135[iVar38 /*104*/].f_67));
						}
						if ((Global_106565.f_14135[iVar38 /*104*/].f_66 == 2 && !ARE_STRINGS_EQUAL(&(Global_106565.f_14135[iVar38 /*104*/].f_67), "NULL")) && !ARE_STRINGS_EQUAL(&(Global_106565.f_14135[iVar38 /*104*/].f_83), "NULL"))
						{
							if (DOES_TEXT_LABEL_EXIST(&(Global_106565.f_14135[iVar38 /*104*/].f_67)))
							{
								ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_106565.f_14135[iVar38 /*104*/].f_67));
							}
							else
							{
								ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106565.f_14135[iVar38 /*104*/].f_67));
							}
							if (DOES_TEXT_LABEL_EXIST(&(Global_106565.f_14135[iVar38 /*104*/].f_83)))
							{
								ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_106565.f_14135[iVar38 /*104*/].f_83));
							}
							else
							{
								ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_106565.f_14135[iVar38 /*104*/].f_83));
							}
						}
						END_TEXT_COMMAND_SCALEFORM_STRING();
						break;
					...
					case 2:
						BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&(Global_106565.f_14135[iVar38 /*104*/]));
						ADD_TEXT_COMPONENT_INTEGER(Global_106565.f_14135[iVar38 /*104*/].f_49);
						END_TEXT_COMMAND_SCALEFORM_STRING();
						break;
