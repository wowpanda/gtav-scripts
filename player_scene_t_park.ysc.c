...
int func_2()//Position - 0x10E
{
	...
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &sLocal_110, &cLocal_126, 2))
		{
			fVar1 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_16221);
			switch (iLocal_170)
			{
				case 0:
					if (fLocal_108 < 0f)
					...
					if (fVar1 > fLocal_108)
					{
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_68) || iLocal_79 != 4294967295)
						{
							if (GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE(&cLocal_89, AUDIO::_0x0626A247D2405330(), 0f, 0f, 0f, 0f, 0f, 0f, iLocal_79, 1f, 0, 0, 0))
							{
								if (MISC::ARE_STRINGS_EQUAL(&cLocal_89, "scr_meth_pipe_smoke"))
								{
									func_16(AUDIO::_0x0626A247D2405330(), 0, 1);
								}
								iLocal_169 = AUDIO::GET_SOUND_ID();
								AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_169, &cLocal_160, AUDIO::_0x0626A247D2405330(), &cLocal_151, 0, 0);
								iLocal_170++;
							}
						}
...
int func_3(int iParam0, int iParam1)//Position - 0x3DF
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			if (((ENTITY::GET_ENTITY_MODEL(*iParam0) != 2701200099 && ENTITY::GET_ENTITY_MODEL(*iParam0) != joaat("v_res_tt_flusher")) && ENTITY::GET_ENTITY_MODEL(*iParam0) != joaat("v_ilev_fh_lampa_on")) && ENTITY::GET_ENTITY_MODEL(*iParam0) != joaat("prop_cs_remote_01"))
			{
				ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(*iParam0, -8f, 1);
			}
		...
		case 4:
			vVar3 = { unk_0x8000C77B5F336760(*iParam0, true) };
		...
		case 5:
			FIRE::ADD_EXPLOSION(unk_0x8000C77B5F336760(*iParam0, true), 0, 0,5f, 1, 0, 1065353216, 0);
			OBJECT::DELETE_OBJECT(iParam0);
			return 1;
			break;
		...
		case 7:
			if (ENTITY::GET_ENTITY_MODEL(*iParam0) == WEAPON::GET_WEAPONTYPE_MODEL(joaat("weapon_pistol")))
			{
				if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
				{
					...
					{
						WEAPON::GIVE_WEAPON_TO_PED(AUDIO::_0x0626A247D2405330(), joaat("weapon_pistol"), 30, false, true);
					}
					WEAPON::SET_CURRENT_PED_WEAPON(AUDIO::_0x0626A247D2405330(), joaat("weapon_pistol"), true);
				}
				OBJECT::DELETE_OBJECT(iParam0);
				return 1;
			}
		...
		case 8:
			vVar8 = { unk_0x8000C77B5F336760(*iParam0, true) };
		...
		case 9:
			vVar11 = { unk_0x8000C77B5F336760(*iParam0, true) };
			...
			*iParam0 = OBJECT::CREATE_OBJECT(iVar14, vVar11, true, true, false);
			...
			if (func_6(iVar0, &sVar15, &cVar16, &iVar17))
			{
				if (func_4(iVar0, &sVar18, &cVar19, &cVar20, &uVar21, &uVar22))
				{
					...
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(*iParam0, Global_16221, &sVar15, &sVar18, 1000f, -8f, iVar17, 1148846080);
					}
				}
			}
...
void func_10(bool bParam0, bool bParam1)//Position - 0x2507
{
	if (bParam0)
	{
		if (func_12(0))
...
bool func_11()//Position - 0x257B
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

int func_12(int iParam0)//Position - 0x258D
{
	if (iParam0 == 1)
	{
...
void func_16(int iParam0, int iParam1, int iParam2)//Position - 0x2651
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_17(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x27AA
{
	func_18(iParam0, iParam1, iParam2, iParam3, 0, iParam4);
}

void func_18(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27C1
{
	int iVar0;
...
int func_20(int iParam0, int iParam1, int iParam2)//Position - 0x2874
{
	if (func_21(iParam0, iParam1, iParam2) == 4294967295)
	{
		return 0;
	}
	return 1;
...
int func_21(int iParam0, int iParam1, int iParam2)//Position - 0x288F
{
	int iVar0;
...
void func_22(int iParam0, int iParam1)//Position - 0x28DB
{
	int iVar0;
	int iVar1;
...
void func_23(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x295A
{
	func_18(iParam0, iParam1, iParam2, 0, iParam3, 1);
}

int func_24(int iParam0)//Position - 0x2970
{
	int iVar0;
...
int func_25(int iParam0)//Position - 0x29A1
{
	int iVar0;
...
int func_26(int iParam0)//Position - 0x29D1
{
	int iVar0;
...
void func_27(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, bool bParam5)//Position - 0x2A12
{
	int iVar0;
...
float func_28()//Position - 0x2ACD
{
	...
	fVar0 = 0.1f;
	iVar1 = func_29(AUDIO::_0x0626A247D2405330());
	iVar2 = func_34(AUDIO::_0x0626A247D2405330());
	if (iVar2 == 0)
	{
		if (iVar1 == 0)
		{
...
int func_29(int iParam0)//Position - 0x2B4C
{
	int iVar0;
	int iVar1;
...
int func_30(int iParam0, int iParam1, bool bParam2)//Position - 0x2B8F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_32(int iParam0)//Position - 0x2C7A
{
	if (iParam0 == 0)
	{
		return 0;
	}
	if (func_33(iParam0) == 4294967295)
	{
		return 0;
	}
	return 1;
...
int func_34(int iParam0)//Position - 0x2CE4
{
	int iVar0;
	int iVar1;
...
int func_35()//Position - 0x2D27
{
	if (!iLocal_69 == 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_68))
		{
			...
			else if (iLocal_72 != 4294967295)
			{
				...
				ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_68, AUDIO::_0x0626A247D2405330(), PED::GET_PED_BONE_INDEX(AUDIO::_0x0626A247D2405330(), iLocal_72), vLocal_70, vLocal_71, 0, 0, 0, 0, 2, 1);
			}
			else
			{
				...
				unk_0x346478B12F69D4E3(iLocal_68, true);
			}
		}
	}
	if (!func_36())
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_68))
		{
			...
			{
				if (!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_68, AUDIO::_0x0626A247D2405330()))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_68, AUDIO::_0x0626A247D2405330(), PED::GET_PED_BONE_INDEX(AUDIO::_0x0626A247D2405330(), iLocal_72), vLocal_70, vLocal_71, 0, 0, 0, 0, 2, 1);
				}
			}
...
int func_37(int iParam0, int iParam1)//Position - 0x2E74
{
	vector3 vVar0;
	float fVar1;
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_38(Global_16B5A) && iParam1 != 0)
		{
			Global_16B5A = 0;
		}
	}
...
int func_38(var uParam0)//Position - 0x2F58
{
	return uParam0;
}

bool func_39(var uParam0, var uParam1)//Position - 0x2F62
{
	return (uParam0 && uParam1) != 0;
}

int func_40()//Position - 0x2F71
{
	func_41();
...
void func_41()//Position - 0x2FB7
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		...
		{
			iVar0 = func_43(AUDIO::_0x0626A247D2405330());
			if (func_42(iVar0) && (!func_45(14) || Global_19A3D))
			{
				if (Global_19E56.f_933.f_21B.f_10CD != iVar0 && func_42(Global_19E56.f_933.f_21B.f_10CD))
				{
...
bool func_42(int iParam0)//Position - 0x30B4
{
	return iParam0 < 3;
}

int func_43(int iParam0)//Position - 0x30C0
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0)//Position - 0x30FD
{
	if (func_42(iParam0))
	{
...
bool func_45(int iParam0)//Position - 0x3127
{
	return Global_8D15 == iParam0;
}

void func_46()//Position - 0x3135
{
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
...
void func_47()//Position - 0x3175
{
	func_48((Global_16B5C - 1));
}

void func_48(int iParam0)//Position - 0x3187
{
	Global_16B5C = iParam0;
}

void func_49()//Position - 0x3195
{
	func_48(0);
}

void func_50()//Position - 0x31A2
{
	int iVar0;
	bool bVar1;
	...
	while (!bVar1 && iVar0 < 400)
	{
		...
		{
			if (!AUDIO::REQUEST_AMBIENT_AUDIO_BANK(&cLocal_142, 0, 4294967295))
			{
				bVar1 = false;
			}
		}
...
int func_52(struct<109> Param0, var uParam1)//Position - 0x3689
{
	uParam1->f_77 = 0;
	switch (Param0.f_2)
	{
		...
		case 12:
			*uParam1 = { Param0 };
			...
			func_53(uParam1, 144, 3312640106, 3312640106, 0f, 0f, 0f, 0f);
			uParam1->f_76 = 2;
			return 1;
			break;
		...
		case 75:
			*uParam1 = { Param0 };
			...
			func_53(uParam1, 30, 3312640106, 3312640106, 0f, 0f, 0f, 0f);
			uParam1->f_76 = 2;
			return 1;
			break;
		...
		case 80:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_53(uParam1, 17, 2277090178, 2277090178, Vector(2.6407f, 8.164f, -14.1564f) + Vector(-1f, 0.03f, -2.16f), (-66f + -56f));
			if (Param0.f_2 == 80)
			{
				func_54(uParam1);
			}
		...
		case 99:
			*uParam1 = { Param0 };
			uParam1->f_6D = 3312640106;
			uParam1->f_6E = 3312640106;
			func_53(uParam1, 15, 3312640106, 451360105, 0f, 0f, 0f, 0f);
			uParam1->f_76 = 2;
			return 1;
			break;
		...
		case 101:
			*uParam1 = { Param0 };
			uParam1->f_6D = 3312640106;
			uParam1->f_6E = 3312640106;
			func_53(uParam1, 14, 3312640106, 451360105, 0f, 0f, 0f, 0f);
			uParam1->f_76 = 2;
			return 1;
			break;
		...
		case 167:
			*uParam1 = { Param0 };
			uParam1->f_6D = 3312640106;
			uParam1->f_6E = 1785177548;
			func_53(uParam1, 14, 3312640106, 1785177548, -0.8472f, 0.155f, 0f, 152.556f);
			uParam1->f_76 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 193:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_53(uParam1, 144, 3312640106, 1785177548, 4.2943f, -6.7858f, 0f, -133.5332f);
			uParam1->f_76 = 1;
			if (Global_3)
			{
				uParam1->f_76 = 1;
		...
		case 270:
			*uParam1 = { Param0 };
			...
			if (Param0.f_2 == 267)
			{
				func_53(uParam1, 144, 3312640106, 2106541073, -2.4166f, -0.15f, 0f, -148.7555f);
			}
			if (Param0.f_2 == 266)
			{
		...
		case 289:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_53(uParam1, 144, 2277090178, 2277090178, -3.264f, -14.7895f, 14.1815f, -0.6311f);
			uParam1->f_76 = 1;
			return 1;
			break;
		...
		case 312:
			*uParam1 = { Param0 };
			...
			func_53(uParam1, 144, 474215631, 2775823996, -9.5443f, -3.191f, -0.3f, 180f);
			uParam1->f_76 = 1;
			return 1;
			break;
...
void func_53(var uParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, float fParam5)//Position - 0x6A04
{
...
void func_54(var uParam0)//Position - 0x6A2E
{
	func_53(uParam0, 145, 1435919172, 1435919172, 0f, 0f, 0f, 0f);
}

int func_55(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0x6A4C
{
	int iVar0;
...
bool func_56(var uParam0)//Position - 0x6C3F
{
	int iVar0;
	vector3 vVar1;
	float fVar2;
...
bool func_57(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x6CFA
{
	if (bParam2)
	{
...
int func_58(int iParam0, var uParam1, char* sParam2)//Position - 0x6D41
{
	vector3 vVar0;
	int iVar1;
	var uVar2;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[0];
			StringCopy(sParam2, func_62(Global_19E56.f_933.f_21B.f_8F6[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[1];
			StringCopy(sParam2, func_62(Global_19E56.f_933.f_21B.f_8F6[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[2];
			StringCopy(sParam2, func_62(Global_19E56.f_933.f_21B.f_8F6[2]), 32);
			return 1;
			break;
...
int func_59(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x9249
{
	switch (iParam1)
	{
		case 0:
...
int func_61(int iParam0, var uParam1, var uParam2)//Position - 0xB1B7
{
	switch (iParam0)
	{
		case 11:
...
char* func_62(int iParam0)//Position - 0xBB26
{
	switch (iParam0)
	{
		case 2014101067:
