...
void func_233()
{
	...
	if (Local_43.f_3 == 1)
	{
		...
		{
			func_340(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
		}
		Local_43.f_3 = 0;
	}
	if (Local_43.f_1 == 0)
	...
	if (Local_43.f_1 == 1)
	{
		...
		if (func_460(Local_48.f_2))
		{
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Orleans", 0))
			{
				...
				BRAIN::TASK_PLAY_ANIM(0, sLocal_380, "leadout_sas_3_rcm_sas", 1000f, -8f, -1, 17039368, 0, 0, 1, 0);
				BRAIN::TASK_PLAY_ANIM(0, sLocal_380, "sas_idle_sit", 1000f, -1000f, -1, 17039369, 0, 0, 1, 0);
...
void func_237(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_241(PLAYER::PLAYER_ID())) && !func_239(PLAYER::PLAYER_ID(), 0)) && !func_238())
			{
...
{
	func_249(&Global_98118, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_284(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_304())
		{
			*uParam0 = func_289(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
void func_368()
{
	...
	if (Local_43.f_1 == 1)
	{
		...
		else if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_48.f_2, 1), 4f))
		{
		...
		else
		{
			...
			if (iLocal_168 == 0)
			{
				if (!func_370(&uLocal_63, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
				{
...
void func_369()
{
	HUD::CLEAR_PRINTS();
	func_11(&(Local_48.f_3));
	if (func_370(&uLocal_115, ENTITY::GET_ENTITY_COORDS(Local_48.f_2, 0)))
	{
		bLocal_180 = false;
	}
	else
...
void func_377()
{
	...
	else if (MISC::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_48.f_2, 1), 5f, 1, 1))
	{
		if (Local_47.f_352 < (Local_47.f_353 - 1))
		{
			if (!func_18())
...
int func_384(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
			...
			if (func_460(Local_48.f_2))
			{
				...
				else if (MISC::GET_GAME_TIMER() > Local_48.f_4)
				{
					if ((AUDIO::HAS_SOUND_FINISHED(Local_48.f_6) && AUDIO::HAS_SOUND_FINISHED(Local_48.f_6)) && AUDIO::HAS_SOUND_FINISHED(Local_48.f_7))
					{
						...
						HUD::_0x72DD432F3CDFC0EE(ENTITY::GET_ENTITY_COORDS(Local_48.f_2, 1), 30f, 6);
					}
		...
		case 3:
			if (func_460(Local_48.f_2))
			{
				...
				else if (Local_48.f_1 == 1)
				{
					...
					{
						BRAIN::TASK_PLAY_ANIM(Local_48.f_2, sLocal_379, "tlo_leap_out", 8f, -8f, -1, 512, 0, 0, 0, 0);
						Local_48.f_1 = 2;
					}
...
int func_390(var uParam0)
{
	...
	vVar0 = { func_334(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - uParam0->f_1) };
...
void func_402()
{
	...
	if (Local_43.f_1 == 1)
	{
		...
		{
			bVar0 = func_370(&uLocal_63, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
...
int func_418(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_334(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_428(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_334(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
		...
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_45, sLocal_379, "hunter_leadout", 3))
		{
			if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_45, sLocal_379, "hunter_leadout") > 0.9f)
			{
				if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_379))
				{
					...
					BRAIN::TASK_PLAY_ANIM(0, sLocal_379, "hunter_idle", 8f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, sLocal_379, "hunter_idle_action", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, sLocal_379, "hunter_idle_look", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, sLocal_379, "hunter_idle_action", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, sLocal_379, "hunter_idle", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, sLocal_379, "hunter_idle", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, sLocal_379, "hunter_idle_look", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
...
int func_432(var uParam0)
{
	...
	vVar7 = { ENTITY::GET_ENTITY_COORDS(uParam0->f_1, 1) };
	vVar8 = { ENTITY::GET_ENTITY_COORDS(uParam0->f_2, 1) };
	if (uParam0->f_3 > 0f)
	{
		...
		if (func_460(Local_44.f_28[0]))
		{
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Hunter", 0))
			{
				...
				if (func_438(Local_45, 1862763509, iLocal_368))
				{
					if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_379))
					{
						BRAIN::TASK_PLAY_ANIM(Local_45, sLocal_379, "hunter_leadout", 1000f, -8f, -1, iLocal_382, 0, 0, 0, 0);
					}
				}
			}
		}
...
{
	if (((!func_475(0) || Global_71125) || Global_71114 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71110)
