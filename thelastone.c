...
void __EntryFunction__()
{
	...
	fLocal_379 = "rcmlastone1";
	fLocal_380 = "rcmlastone2leadinout";
	fLocal_381 = "EMPTY";
	iLocal_382 = 786440;
...
void func_1()
{
	...
	switch (Local_43.f_1)
	{
		case 0:
			...
			if (MISC::ARE_STRINGS_EQUAL(fVar0, fLocal_381))
			{
				func_500(1);
			}
			else
...
void func_14(void fParam0, bool bParam1)
{
	func_15(fParam0);
	func_500(bParam1);
}

void func_15(void fParam0)
{
...
void func_17()
{
	switch (Local_43.f_1)
	{
		...
		case 1:
			if ((MISC::GET_GAME_TIMER() > iLocal_189 && !func_18()) || !func_460(Local_48.f_2))
			{
				func_19();
			}
			break;
...
void func_20(int iParam0, bool bParam1)
{
	...
	{
		func_187(&(Global_104307[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_24()
{
	...
	{
		func_26(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
...
int func_49(int iParam0, int iParam1, int iParam2)
{
	...
	Global_70793[1 /*14*/] = { func_100(iVar0, iParam1, iParam2) };
	...
	else
	{
		...
		Global_70793[1 /*14*/] = { func_100(iVar0, iParam1, uVar6[iParam1]) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_92(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_92(iParam1), Global_70793[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_92(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, 0);
		}
	}
...
int func_50(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_165(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_64, Global_105220.f_2354.f_539[iVar0 /*65*/].f_63))
		{
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_70793[1 /*14*/] = { func_100(iVar10, iParam1, iParam2) };
		if (!func_90(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_70793[1 /*14*/] = { func_100(iVar10, iVar0, uVar11[iVar0]) };
				if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_70793[1 /*14*/] = { func_100(iVar10, 14, uVar12[iVar1]) };
							func_68(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
							func_83(14);
							if (Global_70791 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_92(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_92(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_92(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
						}
						func_83(iVar0);
						if (Global_70791 == 1)
						{
			...
			{
				Global_70793[1 /*14*/] = { func_100(iVar10, iVar0, func_58(iParam0, iVar0, -1)) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_70793[1 /*14*/] = { func_100(iVar10, 14, uVar15[iVar1]) };
			func_68(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
			func_83(14);
			if (Global_70791 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_92(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_92(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_92(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
		}
		if (Global_70791 == 1)
		{
			iVar2 = 0;
...
{
	Global_70793[1 /*14*/] = { func_100(iParam0, iParam1, iParam2) };
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_92(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_92(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_70(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_70(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_70(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_70(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_83(int iParam0)
{
	...
	{
		func_89(iParam0, Global_70793[1 /*14*/].f_5, Global_70793[1 /*14*/].f_2, 2, Global_70793[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_86(iParam2)];
	if (iVar0 != 0)
	{
...
int func_87(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_86(iParam1)];
...
int func_91(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_165(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_61, Global_105220.f_2354.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_99(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[0], Global_105220.f_2354.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_99(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[1], Global_105220.f_2354.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_99(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[2], Global_105220.f_2354.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_102(int iParam0)
{
	...
	func_103(&(Global_70793[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_103(var uParam0, int iParam1, int iParam2, void fParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_87(func_106(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_87(func_105(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_87(iVar1, Global_70790, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_110(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_103(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_103(&(Global_70793[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_103(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_92(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_103(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_165(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_165(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_165(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_70793[2 /*14*/] = { func_100(iVar0, 14, iVar4) };
									if (Global_70793[2 /*14*/].f_12 == iVar3)
									{
										if (func_165(iParam0, 14, iVar4))
										{
											if (!func_56(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_70793[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_70793[2 /*14*/] = { func_100(iVar0, iVar2, iVar1) };
						if (!func_56(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_70793[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_70793[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_92(iParam1)) && Global_70793[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_92(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_171()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_167(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_168(iVar0) && (!func_108(14) || Global_104171))
			{
				if (Global_105220.f_2354.f_539.f_4301 != iVar0 && func_168(Global_105220.f_2354.f_539.f_4301))
				{
...
void func_176(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&fVar1, {func_173(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&fVar1, 0, Global_92992, 0);
		func_177(&fVar1, Var0.f_3, Global_92992, iParam1, iParam2);
	}
}

void func_177(void fParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(&Global_90170))
	{
		return;
	}
	if (MISC::COMPARE_STRINGS(fParam0, &Global_90170, 0, -1) != 0)
	{
		return;
	}
	STATS::PLAYSTATS_MISSION_OVER(fParam0, iParam1, iParam2, iParam3, iParam4, Global_87277);
...
void func_182()
{
	...
	{
		func_171();
		GRAPHICS::_0xBF59707B3E5ED531(func_183(Global_105220.f_2354.f_539.f_4301));
	}
	else
	{
...
{
	func_192(iParam0, 1);
	Global_105220.f_18545[iParam0 /*6*/].f_3 = func_191();
...
void func_209(void fParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
...
int func_218(void fParam0, int iParam1)
{
	int iVar0;
	void fVar1;
	int iVar2;
...
void func_233()
{
	...
	if (Local_43.f_3 == 1)
	{
		...
		{
			func_340(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1112014848, 12, 5000, 0, 0);
		}
		Local_43.f_3 = 0;
	}
	if (Local_43.f_1 == 0)
	...
	if (Local_43.f_1 == 1)
	{
		if (!func_328(iLocal_385))
		{
			...
			if (!func_328(iLocal_385) && STREAMING::HAS_MODEL_LOADED(iLocal_377))
			{
		...
		if (func_460(Local_48.f_2))
		{
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Orleans", 0))
			{
				...
				BRAIN::TASK_PLAY_ANIM(0, fLocal_380, "leadout_sas_3_rcm_sas", 1000f, -8f, -1, 17039368, 0, 0, 1, 0);
				BRAIN::TASK_PLAY_ANIM(0, fLocal_380, "sas_idle_sit", 1000f, -1000f, -1, 17039369, 0, 0, 1, 0);
				BRAIN::CLOSE_SEQUENCE_TASK(iVar1);
				BRAIN::TASK_PERFORM_SEQUENCE(Local_48.f_2, iVar1);
				...
				if (func_460(PLAYER::PLAYER_PED_ID()) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("FRANKLIN", 0))
				{
					BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_48.f_2, -1, 2050, 4);
					BRAIN::TASK_LOOK_AT_ENTITY(Local_48.f_2, PLAYER::PLAYER_PED_ID(), -1, 2050, 4);
				}
			}
			if (iLocal_412)
			{
...
void func_246()
{
	...
	if (!func_349())
	{
		func_323(PLAYER::PLAYER_PED_ID(), -1518.762f, 4540.353f, 44.5008f, 95.2894f, 0, 1);
	}
...
void func_247(int iParam0, void fParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_319(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		else
		{
			...
			{
				iVar6 = func_316(&(Global_92955.f_3));
				if (iVar6 > -1)
				{
		...
		func_248(iParam0, fParam1, iParam4, iParam5);
...
{
	func_249(&Global_98783, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_249(var uParam0, void fParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_227();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_271())
		{
			func_267(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
...
int func_268(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2557346[iParam0 /*3*/][func_86(iParam1)];
...
void func_272(int iParam0, bool bParam1)
{
	...
	if (func_168(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_273(iParam0, &(Global_105220.f_2354.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
int func_281(vector3 vParam0, void fParam1, vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
int func_317(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_318(Global_105220.f_9056.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_318(Global_105220.f_9056.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_318(Global_105220.f_9056.f_99.f_205[11]);
			break;
		
		case 90:
			return func_318(Global_105220.f_9056.f_99.f_205[7]);
			break;
		
		case 93:
			return func_318(Global_105220.f_9056.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
int func_319(void fParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
...
Vector3 func_325(int iParam0, vector3 vParam1)
{
	var uVar0;
...
void func_329(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	func_330(vParam0, vParam1, fParam2, vParam3, fParam4, vParam5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

void func_330(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
Vector3 func_334(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
void func_337(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_340(vector3 vParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
int func_350(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_355(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_354(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
void func_357(void fParam0, bool bParam1)
{
	func_339(bParam1);
...
int func_361()
{
	...
	if (func_460(Local_48.f_2))
	{
		iLocal_188 = func_362(PLAYER::PLAYER_PED_ID(), Local_48.f_2, 0f);
...
int func_364()
{
	if ((STREAMING::HAS_MODEL_LOADED(iLocal_370) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_379)) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_380))
	{
		return 1;
	}
	return 0;
...
{
	STREAMING::REQUEST_MODEL(iLocal_370);
	STREAMING::REQUEST_ANIM_DICT(fLocal_379);
	STREAMING::REQUEST_ANIM_DICT(fLocal_380);
}
...
void func_367(bool bParam0, int iParam1, int iParam2)
{
	bool bVar0;
...
void func_368()
{
	if (Local_43.f_3 == 1)
	{
		...
		func_8(1);
		func_2(1);
		if (func_460(PLAYER::PLAYER_PED_ID()) && !func_349())
		{
	...
	if (Local_43.f_1 == 1)
	{
		...
		else
		{
			...
			if (func_376(PLAYER::PLAYER_PED_ID(), Local_47.f_1[10 /*14*/].f_5, 100f))
			{
				CUTSCENE::REQUEST_CUTSCENE("sas_2_rcm_t7", 8);
			}
			if (iLocal_170 == 0)
			...
			if (iLocal_168 == 0)
			{
				if (!func_370(&uLocal_63, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
				{
...
void func_369()
{
	HUD::CLEAR_PRINTS();
	func_11(&(Local_48.f_3));
	if (func_370(&uLocal_115, ENTITY::GET_ENTITY_COORDS(Local_48.f_2, false)))
	{
		bLocal_180 = false;
	}
	else
...
bool func_370(var uParam0, struct<2> Param1, float fParam2)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_371()
{
	...
	while (iVar0 < iLocal_60)
	{
		...
		{
			BRAIN::TASK_SMART_FLEE_PED(Local_59[iVar0 /*16*/], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			func_4(&(Local_59[iVar0 /*16*/]), 1, 0, 1);
		}
		iVar0++;
	}
...
void func_374(void fParam0, int iParam1)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(fParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

void func_375(void fParam0, int iParam1, int iParam2)
{
	iParam2 = iParam2;
...
bool func_376(int iParam0, vector3 vParam1, float fParam2)
{
...
void func_382(int iParam0)
{
	...
	switch (iParam0->f_1)
	{
		case 1:
			...
			else if (func_383(*iParam0, PLAYER::PLAYER_PED_ID(), iParam0->f_15, 1))
			{
...
int func_384(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5, float fParam6, void fParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
	...
	switch (Local_48)
	{
		case 1:
			if (func_460(Local_48.f_2))
			{
				...
				else if (Local_48.f_1 == 1)
				{
					...
					else if (func_376(PLAYER::PLAYER_PED_ID(), uParam0->f_1, fVar0))
					{
						Local_48 = 2;
						Local_48.f_1 = 0;
					}
		...
		case 2:
			if (func_460(Local_48.f_2))
			{
				...
				else if (fVar0 == -1f || func_383(Local_48.f_2, PLAYER::PLAYER_PED_ID(), fVar0, 1))
				{
		...
		case 3:
			if (func_460(Local_48.f_2))
			{
				...
				{
					func_360(Local_48.f_2, 1);
					BRAIN::TASK_GO_STRAIGHT_TO_COORD(Local_48.f_2, uParam0->f_5, 3f, -1, 1193033728, 1056964608);
					if ((AUDIO::HAS_SOUND_FINISHED(Local_48.f_6) && AUDIO::HAS_SOUND_FINISHED(Local_48.f_6)) && AUDIO::HAS_SOUND_FINISHED(Local_48.f_7))
					{
				...
				else if (Local_48.f_1 == 1)
				{
					...
					{
						BRAIN::TASK_PLAY_ANIM(Local_48.f_2, fLocal_379, "tlo_leap_out", 8f, -8f, -1, 512, 0, 0, 0, 0);
						Local_48.f_1 = 2;
					}
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						if (func_328(iVar3) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(iVar3, Local_48.f_2))
						{
							Local_48 = 6;
							Local_48.f_1 = 0;
						}
				...
				{
					BRAIN::CLEAR_PED_TASKS(Local_48.f_2);
					if (Local_47.f_352 < (Local_47.f_353 - 1))
					{
						if ((AUDIO::HAS_SOUND_FINISHED(Local_48.f_6) && AUDIO::HAS_SOUND_FINISHED(Local_48.f_6)) && AUDIO::HAS_SOUND_FINISHED(Local_48.f_7))
						{
		...
		case 5:
			if (func_460(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					...
					BRAIN::TASK_PERFORM_SEQUENCE(Local_48.f_2, iVar6);
					func_371();
					Local_48.f_1 = 1;
					Local_48.f_9 = 0;
				}
				else if (Local_48.f_1 == 1)
				{
					if (Local_48.f_9 == 0)
					{
						if (func_383(PLAYER::PLAYER_PED_ID(), Local_48.f_2, 20f, 1))
						{
							ENTITY::SET_ENTITY_HEALTH(Local_48.f_2, 110, 0);
		...
		case 6:
			if (func_460(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					...
					iLocal_171 = 1;
					BRAIN::TASK_COMBAT_PED(Local_48.f_2, PLAYER::PLAYER_PED_ID(), 0, 16);
					func_371();
					Local_48.f_1 = 1;
				}
				else if (Local_48.f_1 == 1)
...
int func_390(var uParam0)
{
	...
	vVar0 = { func_334(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - uParam0->f_1) };
...
void func_391(int iParam0, struct<2> Param1, var uParam2)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
void func_399()
{
	...
	while (iVar0 < iLocal_60)
	{
		...
		if (func_460(Local_59[iVar0 /*16*/]))
		{
			...
			BRAIN::TASK_WANDER_IN_AREA(Local_59[iVar0 /*16*/], Local_59[iVar0 /*16*/].f_11, 15f, 1077936128, 1086324736);
...
void func_402()
{
	...
	if (Local_43.f_1 == 0)
	{
		...
		if (func_439())
		{
			...
			HUD::_0x75A16C3DA34F1245(iLocal_61, false);
	...
	if (Local_43.f_1 == 1)
	{
		...
		else if ((func_423(Local_45, 0, 70f, 170f, 1, 0, 0, 0) || !func_376(Local_45, vLocal_397, 1.5f)) || PED::IS_PED_RAGDOLL(Local_45))
		{
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_45, -2065892691);
			BRAIN::TASK_COMBAT_PED(Local_45, PLAYER::PLAYER_PED_ID(), 0, 16);
			func_394();
			func_245(6);
			Local_43.f_9 = 3;
			Local_43.f_1 = 3;
		...
		{
			bVar0 = func_370(&uLocal_63, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
			if (iLocal_182 && func_376(PLAYER::PLAYER_PED_ID(), vLocal_388, 250f))
			{
				func_365();
				func_401();
				iLocal_182 = 0;
			...
			else if (iLocal_167 == 0)
			{
				...
				if (func_18())
				{
					if (func_404(PLAYER::PLAYER_PED_ID(), Local_45) > 25f)
					{
						func_394();
					}
				}
			...
			else
			{
				if (iLocal_169 == 0)
				{
					if (func_376(PLAYER::PLAYER_PED_ID(), vLocal_388, 5f))
					{
						func_232(&uLocal_199, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
				...
				if (iLocal_176 == 0)
				{
					if (func_376(PLAYER::PLAYER_PED_ID(), Local_47.f_1[0 /*14*/].f_1, 40f))
					{
						if (func_361())
						{
							func_11(&iLocal_61);
							...
							HUD::_0x72DD432F3CDFC0EE(ENTITY::GET_ENTITY_COORDS(Local_48.f_2, true), 30f, 6);
							BRAIN::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_47.f_1[0 /*14*/].f_1, 6000, 1024, 2);
							iLocal_176 = 1;
							iLocal_190 = -1;
							func_403();
						}
...
void func_406()
{
	if (iLocal_173)
	{
		if (!func_328(Local_44.f_35[0]) && func_404(PLAYER::PLAYER_PED_ID(), Local_45) < 25f)
		{
			func_394();
...
bool func_407(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, int iParam8, int iParam9, int iParam10)
{
	var uVar0;
	var uVar1;
...
int func_408(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
void func_409(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16)
{
...
void func_410()
{
	if (func_460(Local_45) && func_460(PLAYER::PLAYER_PED_ID()))
	{
		if (func_383(PLAYER::PLAYER_PED_ID(), Local_45, 50f, 1))
		{
...
void func_411(int iParam0, int iParam1, char* sParam2)
{
...
int func_412(int iParam0, float fParam1)
{
	float fVar0;
	
	if (func_236(PLAYER::PLAYER_PED_ID()) && func_236(iParam0))
	{
		if (func_422(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_413(int iParam0, float fParam1)
{
	return func_414(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_414(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_415(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
int func_418(int iParam0, int iParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_334(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_334(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_419(vector3 vParam0, vector3 vParam1)
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}
...
int func_423(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	vector3 vVar0;
	...
	if (func_236(PLAYER::PLAYER_PED_ID()) && func_236(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_424(PLAYER::PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_428(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_334(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_430()
{
	...
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_45, fLocal_379, "hunter_leadout", 3))
		{
			if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_45, fLocal_379, "hunter_leadout") > 0.9f)
			{
				if (STREAMING::HAS_ANIM_DICT_LOADED(fLocal_379))
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iVar0);
					BRAIN::TASK_PLAY_ANIM(0, fLocal_379, "hunter_idle", 8f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, fLocal_379, "hunter_idle_action", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, fLocal_379, "hunter_idle_look", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, fLocal_379, "hunter_idle_action", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, fLocal_379, "hunter_idle", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, fLocal_379, "hunter_idle", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, fLocal_379, "hunter_idle_look", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					BRAIN::SET_SEQUENCE_TO_REPEAT(iVar0, 1);
					BRAIN::CLOSE_SEQUENCE_TASK(iVar0);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_45, iVar0);
...
int func_432(var uParam0)
{
	...
	if (uParam0->f_3 > 0f)
	{
		...
		fVar10 = func_419(ENTITY::GET_ENTITY_FORWARD_VECTOR(uParam0->f_1), vVar9);
	...
	else
	{
		...
		else if (BRAIN::IS_PED_RUNNING(uParam0->f_2))
		{
	...
	if (Local_45.f_4 == 0)
	{
		if (bParam0)
		{
			...
			if (func_438(Local_45, 1862763509, iLocal_368))
			{
				if (func_460(PLAYER::PLAYER_PED_ID()))
				{
					BRAIN::TASK_LOOK_AT_ENTITY(Local_45, PLAYER::PLAYER_PED_ID(), -1, 1024, 2);
				}
			}
		}
		func_437();
...
int func_439()
{
	if (((((((STREAMING::HAS_MODEL_LOADED(iLocal_371) && STREAMING::HAS_MODEL_LOADED(iLocal_372)) && STREAMING::HAS_MODEL_LOADED(iLocal_373)) && STREAMING::HAS_MODEL_LOADED(iLocal_374)) && STREAMING::HAS_MODEL_LOADED(iLocal_375)) && VEHICLE::HAS_VEHICLE_ASSET_LOADED(iLocal_372)) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_379)) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_380))
	{
		return 1;
	}
	return 0;
...
void func_449()
{
	...
	{
		func_339(0);
		fVar0 = func_456(PLAYER::PLAYER_PED_ID(), -1295.844f, 4641.988f, 105.3325f, 1);
		fVar1 = func_456(PLAYER::PLAYER_PED_ID(), -1301.435f, 4641.214f, 105.6249f, 1);
		fVar2 = (fVar0 - fVar1);
		if (fVar2 < 0f)
		{
			fVar2 = (fVar2 * -1f);
		...
		if (func_350(1, 1093140480, 0))
		{
			...
			BRAIN::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_HIKER", false);
		...
		if (func_460(Local_44.f_28[0]))
		{
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Hunter", 0))
			{
				...
				if (func_438(Local_45, 1862763509, iLocal_368))
				{
					if (STREAMING::HAS_ANIM_DICT_LOADED(fLocal_379))
					{
						BRAIN::TASK_PLAY_ANIM(Local_45, fLocal_379, "hunter_leadout", 1000f, -8f, -1, iLocal_382, 0, 0, 0, 0);
					}
				}
			}
		}
...
int func_451(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_452(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_456(int iParam0, vector3 vParam1, bool bParam2)
{
	vector3 vVar0;
...
void func_457()
{
	...
	if ((((AUDIO::REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\SAS_BANK_01", false, -1) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\SAS_BANK_02", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("SAS_BANK_03", false, -1)) && func_359()) && func_358())
	{
		if (AUDIO::IS_AMBIENT_ZONE_ENABLED("AZ_DISTANT_SASQUATCH"))
		{
	...
	if (Global_71232 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_464(Global_71233, Global_71235, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_475(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_345(0)) || func_474(1))
			{
			}
			else
			{
...
{
	return func_477(iParam0, Global_35905);
}
...
void func_481(var uParam0, vector3 vParam1)
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_483(vector3 vParam0, vector3 vParam1, float fParam2)
{
	vLocal_391 = { vParam0 };
	vLocal_392 = { vParam1 };
	fParam2 = fParam2;
...
void func_484(vector3 vParam0, float fParam1, float fParam2)
{
	int iVar0;
...
void func_485(vector3 vParam0, vector3 vParam1, float fParam2, float fParam3, int iParam4, int iParam5)
{
	func_486(1, vParam0, 0f, vParam1, fParam2, fParam3, iParam4, iParam5);
}

void func_486(int iParam0, vector3 vParam1, float fParam2, vector3 vParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	int iVar0;
...
void func_488(vector3 vParam0, vector3 vParam1)
{
	vLocal_388 = { vParam0 };
	vLocal_389 = { vParam1 };
}

void func_489(vector3 vParam0, float fParam1)
{
	vLocal_395 = { vParam0 };
	fLocal_396 = fParam1;
}
...
int func_492(var uParam0)
{
	...
	switch (iLocal_37)
	{
		...
		case 1:
			if (((!func_494(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmlastone1")) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("weapon_pumpshotgun"))) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_37 = 2;
		...
		case 2:
			...
			if (func_460(uParam0->f_28[0]))
			{
				...
				BRAIN::TASK_PLAY_ANIM(uParam0->f_28[0], "rcmlastone1", "idle_action_01", 8f, -8f, -1, 1, 0, 0, 0, 0);
...
void func_493(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_324(iParam0);
...
void func_497()
{
	...
	BRAIN::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_HIKER", true);
...
void func_500(bool bParam0)
{
	...
	if (!func_514())
	{
		...
		{
			func_176(iVar0, 1, 0);
			func_501(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_104307[iVar0 /*10*/].f_9 == -1)
...
void func_501(void fParam0, int iParam1)
{
	if (Global_92955 != 12)
	{
		if (func_502(fParam0, 6, iParam1))
		{
...
int func_502(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_505())
	{
		...
		{
			iVar2 = func_316(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_503()
{
	...
	iVar0 = func_319(&(Global_92955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_505()
{
	...
	{
		if (func_316(&(Global_92955.f_3)) > -1)
		{
			return 1;
		}
	}
