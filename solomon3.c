...
void __EntryFunction__()
{
	...
	iLocal_68 = 49;
	iLocal_69 = 64;
	uLocal_73 = _0x4A9923385BDB9DAD();
	uLocal_74 = _GET_BLIP_INFO_ID_ITERATOR();
	bLocal_78 = true;
	bLocal_85 = true;
	bLocal_107 = true;
	fLocal_1273 = 120f;
...
void func_1()
{
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if (iLocal_3444 == 0)
			{
				iLocal_3275 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
				if (DOES_ENTITY_EXIST(iLocal_3275))
				{
	...
	if (iLocal_3445[0] == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3229[0]))
		{
			if (IS_PED_INJURED(uLocal_3229[0]))
			{
				iLocal_3191++;
				iLocal_3445[0] = 1;
			}
	...
	if (iLocal_3445[1] == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3229[1]))
		{
			if (IS_PED_INJURED(uLocal_3229[1]))
			{
				iLocal_3191++;
				iLocal_3445[1] = 1;
			}
	...
	if (iLocal_3445[2] == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3229[2]))
		{
			if (IS_PED_INJURED(uLocal_3229[2]))
			{
				iLocal_3191++;
				iLocal_3445[2] = 1;
			}
	...
	if (iLocal_3445[3] == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3233[0]))
		{
			if (IS_PED_INJURED(uLocal_3233[0]))
			{
				iLocal_3191++;
				iLocal_3445[3] = 1;
			}
	...
	if (iLocal_3445[4] == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3233[1]))
		{
			if (IS_PED_INJURED(uLocal_3233[1]))
			{
				iLocal_3191++;
				iLocal_3445[4] = 1;
			}
	...
	if (iLocal_3445[5] == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3233[2]))
		{
			if (IS_PED_INJURED(uLocal_3233[2]))
			{
				iLocal_3191++;
				iLocal_3445[5] = 1;
			}
	...
	if (iLocal_3445[6] == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3233[3]))
		{
			if (IS_PED_INJURED(uLocal_3233[3]))
			{
				iLocal_3191++;
				iLocal_3445[6] = 1;
			}
	...
	if (iLocal_3445[7] == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3233[4]))
		{
			if (IS_PED_INJURED(uLocal_3233[4]))
			{
				iLocal_3191++;
				iLocal_3445[7] = 1;
			}
	...
	if (iLocal_3445[8] == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3233[5]))
		{
			if (IS_PED_INJURED(uLocal_3233[5]))
			{
				iLocal_3191++;
				iLocal_3445[8] = 1;
			}
	...
	if (iLocal_3445[9] == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3233[6]))
		{
			if (IS_PED_INJURED(uLocal_3233[6]))
			{
				iLocal_3191++;
				iLocal_3445[9] = 1;
			}
	...
	if (iLocal_3445[10] == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3233[7]))
		{
			if (IS_PED_INJURED(uLocal_3233[7]))
			{
				iLocal_3191++;
				iLocal_3445[10] = 1;
			}
	...
	if (iLocal_3445[11] == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3233[8]))
		{
			if (IS_PED_INJURED(uLocal_3233[8]))
			{
				iLocal_3191++;
				iLocal_3445[11] = 1;
			}
	...
	if (iLocal_3445[12] == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3233[9]))
		{
			if (IS_PED_INJURED(uLocal_3233[9]))
			{
				iLocal_3191++;
				iLocal_3445[12] = 1;
			}
	...
	if (iLocal_3445[13] == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3233[10]))
		{
			if (IS_PED_INJURED(uLocal_3233[10]))
			{
				iLocal_3191++;
				iLocal_3445[13] = 1;
			}
	...
	if (iLocal_3445[14] == 0)
	{
		if (DOES_ENTITY_EXIST(iLocal_3248))
		{
			if (IS_PED_INJURED(iLocal_3248))
			{
				iLocal_3191++;
				iLocal_3445[14] = 1;
			}
	...
	if (iLocal_3445[15] == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3249))
		{
			if (IS_PED_INJURED(uLocal_3249))
			{
				iLocal_3191++;
				iLocal_3445[15] = 1;
			}
	...
	if (iLocal_3445[16] == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3250))
		{
			if (IS_PED_INJURED(uLocal_3250))
			{
				iLocal_3191++;
				iLocal_3445[16] = 1;
			}
	...
	if (iLocal_3445[17] == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3251[0]))
		{
			if (IS_PED_INJURED(uLocal_3251[0]))
			{
				iLocal_3191++;
				iLocal_3445[17] = 1;
			}
...
void func_5()
{
	...
	{
		if (DOES_ENTITY_EXIST(iLocal_3267))
		{
			SET_VEHICLE_DOOR_OPEN(iLocal_3267, 0, 0, 1);
		}
	}
	if (iLocal_3181 > 0)
	{
	...
	if (iLocal_3181 == 0)
	{
		...
		if (DOES_BLIP_EXIST(uLocal_3285))
		{
			REMOVE_BLIP(&uLocal_3285);
		}
		...
		if (DOES_ENTITY_EXIST(iLocal_3259))
		{
		...
		if (DOES_ENTITY_EXIST(iLocal_3228))
		{
			if (!IS_PED_INJURED(iLocal_3228))
			{
				SET_PED_CAN_BE_TARGETTED(iLocal_3228, 1);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_3228, 0);
			}
		}
		...
		uLocal_3221 = ADD_NAVMESH_BLOCKING_OBJECT(-948.4f, -2992.6f, 13.3f, 6f, 5f, 4f, 60f, 0, 7);
		if (DOES_ENTITY_EXIST(uLocal_3266))
		{
			if (IS_VEHICLE_DRIVEABLE(uLocal_3266, 0))
			{
				_0x21115BCD6E44656A(uLocal_3266, 0);
			}
		}
		if (DOES_ENTITY_EXIST(iLocal_3267))
		{
		...
		func_17(&uLocal_3578, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
	...
	if (iLocal_3181 == 1)
	{
		if (iLocal_3469 == 0)
		{
			if (!DOES_ENTITY_EXIST(uLocal_3279[0]))
			{
				if (HAS_MODEL_LOADED(joaat("oracle2")))
				{
					uLocal_3279[0] = CREATE_VEHICLE(joaat("oracle2"), -1025.596f, -2869.237f, 12.9585f, 241.0686f, 1, 1, 0);
					SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_3279[0], 1, 1);
					SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_3279[0], 1084227584);
		...
		if (iLocal_3470 == 0)
		{
			if (!DOES_ENTITY_EXIST(uLocal_3279[1]))
			{
				if (HAS_MODEL_LOADED(joaat("baller2")))
				{
					uLocal_3279[1] = CREATE_VEHICLE(joaat("baller2"), -971.4223f, -2903.354f, 12.9652f, 61.0213f, 1, 1, 0);
					SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_3279[1], 1, 1);
					SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_3279[1], 1084227584);
		...
		if (DOES_ENTITY_EXIST(uLocal_3279[0]))
		{
			if (IS_VEHICLE_DRIVEABLE(uLocal_3279[0], 0))
			{
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_3279[0], 0))
				{
			...
			if (func_16(PLAYER_PED_ID(), uLocal_3279[0], 1) > 200f || IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_3279[0], 0))
			{
				SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uLocal_3279[0]));
			}
		}
		if (DOES_ENTITY_EXIST(uLocal_3279[1]))
		{
			if (IS_VEHICLE_DRIVEABLE(uLocal_3279[1], 0))
			{
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_3279[1], 0))
				{
					if (!IS_AUDIO_SCENE_ACTIVE("SOL_3_LOSE_COPS_VEHICLE"))
					{
						START_AUDIO_SCENE("SOL_3_LOSE_COPS_VEHICLE");
			...
			if (func_16(PLAYER_PED_ID(), uLocal_3279[1], 1) > 200f || IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_3279[1], 0))
			{
				SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uLocal_3279[1]));
			}
		}
		if (iLocal_3430 == 0)
		{
		...
		if (iLocal_3374 == 0)
		{
			if (TIMERA() > 8000)
			{
				if (IS_VEHICLE_DRIVEABLE(uLocal_3268[0], 0))
				{
					START_PLAYBACK_RECORDED_VEHICLE(uLocal_3268[0], 68, "BB_Chase", 1);
					_0x796A877E459B99EA(uLocal_3268[0], 0f, 0f, 0.15f);
				}
				if (IS_VEHICLE_DRIVEABLE(uLocal_3268[1], 0))
				{
					START_PLAYBACK_RECORDED_VEHICLE(uLocal_3268[1], 69, "BB_Chase", 1);
					_0x796A877E459B99EA(uLocal_3268[1], 0f, 0f, 0.15f);
				}
				iLocal_3374 = 1;
			}
		}
		else
		{
			if (IS_VEHICLE_DRIVEABLE(uLocal_3268[0], 0))
			{
				if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3268[0]))
				{
					if (GET_TIME_POSITION_IN_RECORDING(uLocal_3268[0]) > 5000f)
					{
						if (IS_VEHICLE_STOPPED(uLocal_3268[0]))
						{
							STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_3268[0]);
						}
					}
				}
				else if (iLocal_3375 == 0)
				{
					if (!IS_PED_INJURED(uLocal_3233[6]))
					{
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3233[6], 0);
					}
					if (!IS_PED_INJURED(uLocal_3233[7]))
					{
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3233[7], 0);
					}
					iLocal_3375 = 1;
				}
			}
			if (IS_VEHICLE_DRIVEABLE(uLocal_3268[1], 0))
			{
				if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3268[1]))
				{
					if (GET_TIME_POSITION_IN_RECORDING(uLocal_3268[1]) > 5000f)
					{
						if (IS_VEHICLE_STOPPED(uLocal_3268[1]))
						{
							STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_3268[1]);
						}
					}
				}
				else if (iLocal_3376 == 0)
				{
					if (!IS_PED_INJURED(uLocal_3233[8]))
					{
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3233[8], 0);
					}
					if (!IS_PED_INJURED(uLocal_3233[9]))
					{
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3233[9], 0);
					}
					iLocal_3376 = 1;
				}
			}
		...
		if (iLocal_3474 == 0)
		{
			if (DOES_ENTITY_EXIST(iLocal_3267))
			{
				if (IS_VEHICLE_DRIVEABLE(iLocal_3267, 0))
				{
					if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_3267, 0))
					{
					...
					else if (func_16(PLAYER_PED_ID(), iLocal_3267, 1) > 200f)
					{
						SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_3267);
					}
				}
		...
		if (iLocal_3477 == 1)
		{
			if (GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) == 0)
			{
				if (GET_GAME_TIMER() > iLocal_3193 + 3500)
				{
					if (IS_AUDIO_SCENE_ACTIVE("SOL_3_LOSE_COPS_PLANE"))
					{
						STOP_AUDIO_SCENE("SOL_3_LOSE_COPS_PLANE");
...
void func_12()
{
	...
	while (iLocal_3189 <= 9)
	{
		if (DOES_ENTITY_EXIST(uLocal_3233[iLocal_3189]))
		{
			if (!IS_PED_INJURED(uLocal_3233[iLocal_3189]))
			{
				if (!IS_PED_IN_ANY_VEHICLE(uLocal_3233[iLocal_3189], 0))
				{
					if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
					{
						if (func_13(PLAYER_PED_ID(), uLocal_3233[iLocal_3189]) > 200f)
						{
							CLEAR_PED_TASKS(uLocal_3233[iLocal_3189]);
							SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3233[iLocal_3189]));
						}
						else if (func_13(PLAYER_PED_ID(), uLocal_3233[iLocal_3189]) > 20f)
						{
							if (GET_SCRIPT_TASK_STATUS(uLocal_3233[iLocal_3189], -1207174364) != 1 && GET_SCRIPT_TASK_STATUS(uLocal_3233[iLocal_3189], -1207174364) != 0)
							{
								TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(uLocal_3233[iLocal_3189], PLAYER_PED_ID(), PLAYER_PED_ID(), 2f, 1, 15f, 20f, 0, 0, -687903391);
							}
						}
						else if (GET_SCRIPT_TASK_STATUS(uLocal_3233[iLocal_3189], 780511057) != 1 && GET_SCRIPT_TASK_STATUS(uLocal_3233[iLocal_3189], 780511057) != 0)
						{
							TASK_COMBAT_PED(uLocal_3233[iLocal_3189], PLAYER_PED_ID(), 0, 16);
							SET_PED_COMBAT_ATTRIBUTES(uLocal_3233[iLocal_3189], 50, 1);
						}
					}
					else if (func_13(PLAYER_PED_ID(), uLocal_3233[iLocal_3189]) > 200f)
					{
						SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3233[iLocal_3189]));
					}
					else if (func_13(PLAYER_PED_ID(), uLocal_3233[iLocal_3189]) > 5f)
					{
						if (GET_SCRIPT_TASK_STATUS(uLocal_3233[iLocal_3189], -1207174364) != 1 && GET_SCRIPT_TASK_STATUS(uLocal_3233[iLocal_3189], -1207174364) != 0)
						{
							TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(uLocal_3233[iLocal_3189], PLAYER_PED_ID(), PLAYER_PED_ID(), 2f, 1, 15f, 20f, 0, 0, -687903391);
	...
	if (iLocal_3374 == 1)
	{
		if (iLocal_3346 == 0)
		{
			if (DOES_ENTITY_EXIST(uLocal_3268[0]))
			{
				if (IS_VEHICLE_DRIVEABLE(uLocal_3268[0], 0))
				{
					if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3268[0]))
					...
					else
					{
						if (DOES_ENTITY_EXIST(uLocal_3233[6]))
						{
							...
							{
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3233[6], 0);
								CLEAR_PED_TASKS(uLocal_3233[6]);
								OPEN_SEQUENCE_TASK(&uLocal_3292);
								TASK_LEAVE_VEHICLE(0, uLocal_3268[0], 256);
								TASK_COMBAT_PED(0, PLAYER_PED_ID(), 0, 16);
								CLOSE_SEQUENCE_TASK(uLocal_3292);
								TASK_PERFORM_SEQUENCE(uLocal_3233[6], uLocal_3292);
								CLEAR_SEQUENCE_TASK(&uLocal_3292);
							}
						}
						if (DOES_ENTITY_EXIST(uLocal_3233[7]))
						{
							...
							{
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3233[7], 0);
								CLEAR_PED_TASKS(uLocal_3233[7]);
								OPEN_SEQUENCE_TASK(&uLocal_3292);
								TASK_LEAVE_VEHICLE(0, uLocal_3268[0], 256);
								TASK_COMBAT_PED(0, PLAYER_PED_ID(), 0, 16);
								CLOSE_SEQUENCE_TASK(uLocal_3292);
								TASK_PERFORM_SEQUENCE(uLocal_3233[7], uLocal_3292);
								CLEAR_SEQUENCE_TASK(&uLocal_3292);
							}
						}
						iLocal_3346 = 1;
			...
			if (DOES_ENTITY_EXIST(uLocal_3268[0]))
			{
				if (IS_VEHICLE_DRIVEABLE(uLocal_3268[0], 0))
				{
					if (DOES_ENTITY_EXIST(uLocal_3233[6]))
					{
						if (!IS_PED_INJURED(uLocal_3233[6]))
						{
							if (!IS_PED_IN_VEHICLE(uLocal_3233[6], uLocal_3268[0], 0))
							{
								if (func_13(PLAYER_PED_ID(), uLocal_3233[6]) < 20f)
								{
		...
		if (iLocal_3347 == 0)
		{
			if (DOES_ENTITY_EXIST(uLocal_3268[1]))
			{
				if (IS_VEHICLE_DRIVEABLE(uLocal_3268[1], 0))
				{
					if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3268[1]))
					...
					else
					{
						if (DOES_ENTITY_EXIST(uLocal_3233[8]))
						{
							...
							{
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3233[8], 0);
								CLEAR_PED_TASKS(uLocal_3233[8]);
								OPEN_SEQUENCE_TASK(&uLocal_3292);
								TASK_LEAVE_VEHICLE(0, uLocal_3268[1], 256);
								TASK_COMBAT_PED(0, PLAYER_PED_ID(), 0, 16);
								CLOSE_SEQUENCE_TASK(uLocal_3292);
								TASK_PERFORM_SEQUENCE(uLocal_3233[8], uLocal_3292);
								CLEAR_SEQUENCE_TASK(&uLocal_3292);
							}
						}
						if (DOES_ENTITY_EXIST(uLocal_3233[9]))
						{
							...
							{
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3233[9], 0);
								CLEAR_PED_TASKS(uLocal_3233[9]);
								OPEN_SEQUENCE_TASK(&uLocal_3292);
								TASK_LEAVE_VEHICLE(0, uLocal_3268[1], 256);
								TASK_COMBAT_PED(0, PLAYER_PED_ID(), 0, 16);
								CLOSE_SEQUENCE_TASK(uLocal_3292);
								TASK_PERFORM_SEQUENCE(uLocal_3233[9], uLocal_3292);
								CLEAR_SEQUENCE_TASK(&uLocal_3292);
							}
						}
						iLocal_3347 = 1;
	...
	if (iLocal_3348 == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3233[10]))
		{
			if (!IS_PED_INJURED(uLocal_3233[10]))
			{
				if (func_13(PLAYER_PED_ID(), uLocal_3233[10]) > 200f)
				{
					SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3233[iLocal_3189]));
				...
				{
					if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -923.2303f, -2948.004f, 12.9451f, 2f, 2f, 2f, 0, 1, 0))
					{
						if (!IS_PED_INJURED(uLocal_3233[10]))
						{
							CLEAR_PED_TASKS(uLocal_3233[10]);
							OPEN_SEQUENCE_TASK(&uLocal_3292);
							TASK_PLAY_ANIM(0, "misssolomon_3", "plyr_roll_left", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
							TASK_COMBAT_PED(0, PLAYER_PED_ID(), 0, 16);
							CLOSE_SEQUENCE_TASK(uLocal_3292);
							TASK_PERFORM_SEQUENCE(uLocal_3233[10], uLocal_3292);
							CLEAR_SEQUENCE_TASK(&uLocal_3292);
							iLocal_3348 = 1;
						}
					}
...
{
	_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_15(iParam2), 1);
}
...
void func_25(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_116(GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_109(GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
...
{
	func_27(&Global_100114, GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_57()
{
	...
	if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
	{
		if (func_48(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
...
void func_60(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_65(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_62(Var11.f_1)) && iVar72 < 51)
			{
...
void func_66(var uParam0)
{
	...
	if (func_38(iVar0) && !IS_PED_INJURED(uParam0))
	{
...
int func_71(var uParam0)
{
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (func_94())
		{
			*uParam0 = func_77(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_77(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_93(iVar0))
		{
			...
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_78(iVar0, 0), 1);
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_101(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_120()
{
	switch (iLocal_3180)
	{
		case 2:
			...
			SET_ENTITY_COORDS(PLAYER_PED_ID(), -1019.579f, -484.872f, 36.0795f, 1, 0, 0, 1);
		...
		case 3:
			...
			{
				if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_3259, 0))
				{
					SET_PED_INTO_VEHICLE(PLAYER_PED_ID(), iLocal_3259, -1);
				}
				SET_ENTITY_HEALTH(iLocal_3259, 3000, 0);
				SET_ENTITY_PROOFS(iLocal_3259, 0, 1, 0, 0, 0, 0, 0, 0);
			}
			break;
		
		case 5:
			CLEAR_PED_TASKS_IMMEDIATELY(PLAYER_PED_ID());
			SET_ENTITY_COORDS(PLAYER_PED_ID(), -935.4413f, -2928.061f, 12.9451f, 1, 0, 0, 1);
			SET_ENTITY_HEADING(PLAYER_PED_ID(), 178.466f);
			SET_ENTITY_LOAD_COLLISION_FLAG(PLAYER_PED_ID(), 1, 1);
			break;
		
		case 8:
			CLEAR_PED_TASKS_IMMEDIATELY(PLAYER_PED_ID());
			SET_ENTITY_COORDS(PLAYER_PED_ID(), -937.5466f, -2968.713f, 12.9451f, 1, 0, 0, 1);
...
void func_121()
{
	switch (iLocal_3180)
	{
		case 2:
			...
			SET_PLAYER_WANTED_LEVEL_NOW(PLAYER_ID(), 0);
			CLEAR_AREA(-1026.8f, -492.1f, 36f, 18f, 1, 0, 0, 0);
			SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-1042.5f, -500f, 41f, -1019.5f, -475f, 34f, 0, 1);
			...
			if (!DOES_ENTITY_EXIST(iLocal_3259))
			{
				CLEAR_AREA(vLocal_3294, 5f, 1, 0, 0, 0);
				iLocal_3259 = CREATE_VEHICLE(joaat("rapidgt"), vLocal_3294, fLocal_3321, 1, 1, 0);
				SET_VEHICLE_COLOURS(iLocal_3259, 112, 112);
				SET_ENTITY_HEALTH(iLocal_3259, 3000, 0);
				SET_VEHICLE_STRONG(iLocal_3259, 1);
				SET_MODEL_AS_NO_LONGER_NEEDED(joaat("rapidgt"));
				SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("rapidgt"), 1);
				_SET_ENTITY_SOMETHING(iLocal_3259, 1);
				SET_VEHICLE_HAS_STRONG_AXLES(iLocal_3259, 1);
			}
			if (!DOES_ENTITY_EXIST(uLocal_3276))
			{
				if (HAS_MODEL_LOADED(joaat("surano")))
				{
					CLEAR_AREA(-1037.398f, -491.6539f, 35.5545f, 5f, 1, 0, 0, 0);
					uLocal_3276 = CREATE_VEHICLE(joaat("surano"), -1037.398f, -491.6539f, 35.5545f, 208.889f, 1, 1, 0);
					SET_VEHICLE_COLOURS(uLocal_3276, 0, 0);
					SET_ENTITY_HEALTH(uLocal_3276, 3000, 0);
					SET_VEHICLE_STRONG(uLocal_3276, 1);
					SET_MODEL_AS_NO_LONGER_NEEDED(joaat("surano"));
					SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("surano"), 1);
					SET_VEHICLE_HAS_STRONG_AXLES(uLocal_3276, 1);
				}
			}
			if (!DOES_ENTITY_EXIST(uLocal_3277))
			{
				if (HAS_MODEL_LOADED(joaat("carbonizzare")))
				{
					CLEAR_AREA(vLocal_3294, 5f, 1, 0, 0, 0);
					uLocal_3277 = CREATE_VEHICLE(joaat("carbonizzare"), -1033.938f, -489.7475f, 35.8323f, 207.1758f, 1, 1, 0);
					SET_VEHICLE_COLOURS(uLocal_3277, 89, 89);
					SET_ENTITY_HEALTH(uLocal_3277, 3000, 0);
					SET_VEHICLE_STRONG(uLocal_3277, 1);
					SET_MODEL_AS_NO_LONGER_NEEDED(joaat("carbonizzare"));
					SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("carbonizzare"), 1);
					SET_VEHICLE_HAS_STRONG_AXLES(uLocal_3277, 1);
				}
			}
			break;
		...
		case 3:
			...
			SET_PLAYER_WANTED_LEVEL_NOW(PLAYER_ID(), 0);
			func_184();
			CLEAR_AREA(vLocal_3297, 200f, 1, 0, 0, 0);
			if (!DOES_ENTITY_EXIST(uLocal_3258))
			{
				uLocal_3258 = CREATE_VEHICLE(joaat("cogcabrio"), vLocal_3297, fLocal_3322, 1, 1, 0);
				SET_ENTITY_PROOFS(uLocal_3258, 1, 1, 1, 1, 1, 0, 0, 0);
				SET_VEHICLE_COLOURS(uLocal_3258, 27, 27);
				SET_MODEL_AS_NO_LONGER_NEEDED(joaat("cogcabrio"));
				_DYNAMIC_MIXER_RELATED_FN(uLocal_3258, "SOL_3_MOLLY_CAR_Group", 0);
			}
			if (!DOES_ENTITY_EXIST(iLocal_3222))
			{
				iLocal_3222 = CREATE_PED_INSIDE_VEHICLE(uLocal_3258, 26, joaat("ig_molly"), -1, 1, 1);
				SET_ENTITY_PROOFS(iLocal_3222, 1, 1, 1, 1, 1, 0, 0, 0);
				SET_ENTITY_INVINCIBLE(iLocal_3222, 1);
				SET_PED_CAN_BE_TARGETTED(iLocal_3222, 0);
				SET_MODEL_AS_NO_LONGER_NEEDED(joaat("ig_molly"));
				SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_3222, 1862763509);
			}
			if (func_23())
			{
				if (!DOES_ENTITY_EXIST(iLocal_3259))
				{
					if (func_183())
					{
						if (!IS_THIS_MODEL_A_HELI(func_182()) && !IS_THIS_MODEL_A_PLANE(func_182()))
						{
							iLocal_3259 = func_142(vLocal_3312, fLocal_3325);
							SET_MODEL_AS_NO_LONGER_NEEDED(func_182());
							SET_VEHICLE_HAS_STRONG_AXLES(iLocal_3259, 1);
						}
						else
						{
							iLocal_3259 = CREATE_VEHICLE(joaat("rapidgt"), vLocal_3312, fLocal_3325, 1, 1, 0);
							SET_VEHICLE_COLOURS(iLocal_3259, 112, 112);
						}
					}
					else
			...
			else if (!DOES_ENTITY_EXIST(iLocal_3259))
			{
				iLocal_3259 = CREATE_VEHICLE(joaat("rapidgt"), vLocal_3312, fLocal_3325, 1, 1, 0);
				SET_VEHICLE_COLOURS(iLocal_3259, 112, 112);
				SET_MODEL_AS_NO_LONGER_NEEDED(joaat("rapidgt"));
		...
		case 5:
			iLocal_3352 = 0;
			CLEAR_AREA(-973.3f, -2967.7f, 13.5f, 100f, 1, 0, 0, 0);
			SETTIMERA(0);
			...
			if (!DOES_ENTITY_EXIST(iLocal_3222))
			{
				iLocal_3222 = CREATE_PED(26, joaat("ig_molly"), -920.5093f, -2943.93f, 12.9451f, 157.6203f, 1, 1);
				SET_ENTITY_INVINCIBLE(iLocal_3222, 1);
				SET_PED_CAN_BE_TARGETTED(iLocal_3222, 0);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_3222, 1);
				SET_MODEL_AS_NO_LONGER_NEEDED(joaat("ig_molly"));
				SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_3222, 1, 1);
				SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_3222, 1862763509);
			}
			iLocal_3283 = CREATE_OBJECT(joaat("prop_cs_film_reel_01"), -929f, -2917f, 13f, 1, 1, 0);
			ATTACH_ENTITY_TO_ENTITY(iLocal_3283, iLocal_3222, GET_PED_BONE_INDEX(iLocal_3222, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
			if (!DOES_ENTITY_EXIST(uLocal_3266))
			{
				uLocal_3266 = CREATE_VEHICLE(joaat("jet"), -952.1345f, -2990.269f, 12.9451f, 240.7726f, 1, 1, 0);
				SET_VEHICLE_LIVERY(uLocal_3266, 2);
				SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_3266, 0);
				FREEZE_ENTITY_POSITION(uLocal_3266, 1);
				SET_ENTITY_PROOFS(uLocal_3266, 1, 1, 1, 1, 1, 0, 0, 0);
				SET_MODEL_AS_NO_LONGER_NEEDED(joaat("jet"));
				SET_ENTITY_LOD_DIST(uLocal_3266, 500);
			}
			if (func_23())
			{
				if (func_183())
				...
				if (!DOES_ENTITY_EXIST(iLocal_3259))
				{
					...
					{
						iLocal_3259 = CREATE_VEHICLE(joaat("rapidgt"), -918.6263f, -2926.631f, 12.9666f, 43.1705f, 1, 1, 0);
						SET_VEHICLE_COLOURS(iLocal_3259, 112, 112);
						_SET_ENTITY_SOMETHING(iLocal_3259, 1);
						SET_MODEL_AS_NO_LONGER_NEEDED(joaat("rapidgt"));
						SET_VEHICLE_HAS_STRONG_AXLES(iLocal_3259, 1);
			...
			if (!DOES_ENTITY_EXIST(uLocal_3258))
			{
				uLocal_3258 = CREATE_VEHICLE(joaat("cogcabrio"), -928.3279f, -2916.16f, 12.945f, 61.7688f, 1, 1, 0);
				SET_VEHICLE_COLOURS(uLocal_3258, 27, 27);
				SET_MODEL_AS_NO_LONGER_NEEDED(joaat("cogcabrio"));
			}
			if (!DOES_ENTITY_EXIST(uLocal_3263))
			{
				uLocal_3263 = CREATE_VEHICLE(joaat("police3"), -924.2796f, -2914.371f, 12.945f, 86.6188f, 1, 1, 0);
			}
			if (!DOES_ENTITY_EXIST(iLocal_3248))
			{
				iLocal_3248 = CREATE_PED(6, joaat("s_m_y_cop_01"), -922.942f, -2912.509f, 12.945f, 156.2652f, 1, 1);
				GIVE_WEAPON_TO_PED(iLocal_3248, joaat("weapon_pistol"), 1000, 1, 1);
		...
		case 8:
			...
			if (!DOES_ENTITY_EXIST(uLocal_3282))
			{
				uLocal_3282 = CREATE_OBJECT(joaat("prop_jet_bloodsplat_01"), -946.4231f, -2979.826f, 12.9264f, 1, 1, 0);
				SET_ENTITY_ROTATION(uLocal_3282, 0f, 0f, -121.5948f, 2, 1);
				SET_ENTITY_QUATERNION(uLocal_3282, 0f, 0f, 0.8729f, -0.4879f);
			...
			if (!DOES_ENTITY_EXIST(uLocal_3266))
			{
				...
				SET_ENTITY_PROOFS(uLocal_3266, 1, 1, 1, 1, 1, 0, 0, 0);
				SET_MODEL_AS_NO_LONGER_NEEDED(joaat("jet"));
				uLocal_3763 = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_damage", uLocal_3266, -11.956f, 10.528f, -7.657f, 0f, 2f, 0f, 1065353216, 0, 0, 0);
				SET_ENTITY_LOD_DIST(uLocal_3266, 500);
			}
			if (!DOES_ENTITY_EXIST(iLocal_3228))
			{
				iLocal_3228 = CREATE_PED(26, joaat("s_m_y_airworker"), -933.8942f, -2965.785f, 12.9451f, 331.7339f, 1, 1);
				func_17(&uLocal_3578, 4, iLocal_3228, "HangerWorker", 0, 1);
				SET_MODEL_AS_NO_LONGER_NEEDED(joaat("s_m_y_airworker"));
				SET_PED_CAN_BE_TARGETTED(iLocal_3228, 1);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_3228, 1);
				TASK_SMART_FLEE_PED(iLocal_3228, PLAYER_PED_ID(), 150f, -1, 0, 0);
				SET_PED_KEEP_TASK(iLocal_3228, 1);
				SET_ENTITY_PROOFS(iLocal_3228, 0, 0, 0, 0, 0, 0, 0, 0);
...
void func_122(int iParam0)
{
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		iVar0 = GET_BEST_PED_WEAPON(PLAYER_PED_ID(), 0);
		if (iVar0 != joaat("weapon_unarmed"))
		{
			SET_CURRENT_PED_WEAPON(PLAYER_PED_ID(), iVar0, iParam0);
		}
	}
}
...
void func_124()
{
	if (iLocal_3339 == 0)
	{
		if (!DOES_ENTITY_EXIST(uLocal_3268[0]))
		{
			uLocal_3268[0] = CREATE_VEHICLE(joaat("police3"), -994.5278f, -2903.285f, 12.9447f, 158.7951f, 1, 1, 0);
			_0x428BACCDF5E26EAD(uLocal_3268[0], 0);
		}
		if (!DOES_ENTITY_EXIST(uLocal_3233[0]))
		{
			uLocal_3233[0] = CREATE_PED(6, joaat("s_m_y_cop_01"), -969.06f, -2955.186f, 12.945f, 241.1703f, 1, 1);
			GIVE_WEAPON_TO_PED(uLocal_3233[0], joaat("weapon_pistol"), 1000, 1, 1);
			SET_PED_ACCURACY(uLocal_3233[0], 20);
			SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_3233[0], 1, 1);
			TASK_AIM_GUN_AT_ENTITY(uLocal_3233[0], PLAYER_PED_ID(), -1, 1);
			func_126(uLocal_3233[0], 0);
		}
		if (!DOES_ENTITY_EXIST(iLocal_3267))
		{
			iLocal_3267 = CREATE_VEHICLE(joaat("shamal"), -968.3718f, -2952.298f, 12.9451f, 114.9439f, 1, 1, 0);
			SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_3267, 1084227584);
			SET_MODEL_AS_NO_LONGER_NEEDED(joaat("shamal"));
			SET_ENTITY_HEALTH(iLocal_3267, 2000, 0);
			SET_VEHICLE_DOOR_OPEN(iLocal_3267, 0, 0, 1);
		}
		if (!DOES_ENTITY_EXIST(uLocal_3233[6]))
		{
			uLocal_3233[6] = CREATE_PED_INSIDE_VEHICLE(uLocal_3268[0], 6, joaat("s_m_y_cop_01"), 0, 1, 1);
			GIVE_WEAPON_TO_PED(uLocal_3233[6], joaat("weapon_pistol"), 1000, 1, 1);
			SET_PED_ACCURACY(uLocal_3233[6], 20);
			SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_3233[6], 1, 1);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3233[6], 1);
			func_126(uLocal_3233[6], 0);
		}
		if (!DOES_ENTITY_EXIST(uLocal_3233[7]))
		{
			uLocal_3233[7] = CREATE_PED_INSIDE_VEHICLE(uLocal_3268[0], 6, joaat("s_m_y_cop_01"), -1, 1, 1);
			GIVE_WEAPON_TO_PED(uLocal_3233[7], joaat("weapon_pistol"), 1000, 1, 1);
			SET_PED_ACCURACY(uLocal_3233[7], 20);
			SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_3233[7], 1, 1);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3233[7], 1);
			func_126(uLocal_3233[7], 0);
		}
		if (!DOES_ENTITY_EXIST(uLocal_3268[1]))
		{
			uLocal_3268[1] = CREATE_VEHICLE(joaat("police3"), -962.2432f, -2864.16f, 12.9447f, 149.5586f, 1, 1, 0);
			_0x428BACCDF5E26EAD(uLocal_3268[1], 0);
		}
		if (!DOES_ENTITY_EXIST(uLocal_3233[8]))
		{
			uLocal_3233[8] = CREATE_PED_INSIDE_VEHICLE(uLocal_3268[1], 6, joaat("s_m_y_cop_01"), 0, 1, 1);
			GIVE_WEAPON_TO_PED(uLocal_3233[8], joaat("weapon_pistol"), 1000, 1, 1);
			SET_PED_ACCURACY(uLocal_3233[8], 20);
			SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_3233[8], 1, 1);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3233[8], 1);
			func_126(uLocal_3233[8], 0);
		}
		if (!DOES_ENTITY_EXIST(uLocal_3233[9]))
		{
			uLocal_3233[9] = CREATE_PED_INSIDE_VEHICLE(uLocal_3268[1], 6, joaat("s_m_y_cop_01"), -1, 1, 1);
			GIVE_WEAPON_TO_PED(uLocal_3233[9], joaat("weapon_pistol"), 1000, 1, 1);
			SET_PED_ACCURACY(uLocal_3233[9], 20);
			SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_3233[9], 1, 1);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3233[9], 1);
			func_126(uLocal_3233[9], 0);
		}
		if (!DOES_ENTITY_EXIST(uLocal_3233[10]))
		{
			uLocal_3233[10] = CREATE_PED(6, joaat("s_m_y_cop_01"), -922.1185f, -2939.595f, 12.9451f, 156.1408f, 1, 1);
			GIVE_WEAPON_TO_PED(uLocal_3233[10], joaat("weapon_pistol"), 1000, 1, 1);
			SET_PED_ACCURACY(uLocal_3233[10], 20);
			SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_3233[10], 1, 1);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3233[10], 1);
			func_126(uLocal_3233[10], 0);
			SET_PED_DUCKING(uLocal_3233[10], 1);
		}
		iLocal_3339 = 1;
	}
}
...
{
	return func_143(&(Global_100114.f_2890), vParam0, fParam3, 0);
}
	...
	if (func_129(uParam0))
	{
		...
		if (func_128(uParam0))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_160(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && ARE_STRINGS_EQUAL(GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_45(iParam0, 0, 0)) || func_45(iParam0, 1, 0)) || func_45(iParam0, 2, 0)) || func_34(iParam0) != 145) || func_150(iParam0)) || func_149(iParam0)) || func_148(iParam0)) || func_147(iParam0)) || !func_146(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_149(iParam0))
		{
		}
...
int func_160(var uParam0, vector3 vParam1, bool bParam4)
{
	...
	{
		case joaat("cargobob"):
			if (func_161(uParam0, Global_70409.f_139[38], 0))
			{
				func_154(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_161(uParam0, Global_70409.f_139[43], 1))
			{
				func_154(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_161(uParam0, uVar1[iVar6], 1) && func_130(GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_70(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(uParam0, 1), GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_163(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_91043[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || GET_ENTITY_MODEL(Global_91043[iVar0]) == func_36(iParam0, iParam1))
				{
...
void func_164(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_40(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_40(iVar1 + 1)))
			{
			}
			else
			{
		...
		if (((IS_BIT_SET(uParam1->f_77, 15) || func_172(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_171())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!IS_THIS_MODEL_A_HELI(uParam1->f_66) && !IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (IS_BIT_SET(uParam1->f_77, func_40(iVar2 + 1)))
				{
...
int func_165(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_169(GET_ENTITY_MODEL(*uParam0), 1) && GET_VEHICLE_MOD(*uParam0, 24) != func_168(*uParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*uParam0, 24, func_168(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_167(uParam0);
	if (func_166(*uParam0))
	{
...
void func_184()
{
	uLocal_3293 = REQUEST_SCALEFORM_MOVIE("BREAKING_NEWS");
	REQUEST_MODEL(joaat("jet"));
	REQUEST_MODEL(joaat("police3"));
	...
	while (!HAS_SCALEFORM_MOVIE_LOADED(uLocal_3293) || !func_185(1, "BB_Chase"))
	{
		WAIT(0);
	}
...
void func_187()
{
	...
	if (DOES_NAVMESH_BLOCKING_OBJECT_EXIST(uLocal_3221))
	{
		REMOVE_NAVMESH_BLOCKING_OBJECT(uLocal_3221);
	}
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		SET_ENTITY_COORDS(PLAYER_PED_ID(), -1019.579f, -484.872f, 36.0795f, 1, 0, 0, 1);
	...
	if (DOES_ENTITY_EXIST(uLocal_3258))
	{
		if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
		{
			_0x18EB48CFC41F2EA0(uLocal_3258, 0);
			if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
			{
				STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_3258);
			}
		}
	}
	if (DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_3759))
	{
		STOP_PARTICLE_FX_LOOPED(uLocal_3759, 0);
	}
	if (DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_3760))
	{
		STOP_PARTICLE_FX_LOOPED(uLocal_3760, 0);
	}
	if (DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_3761))
	{
		STOP_PARTICLE_FX_LOOPED(uLocal_3761, 0);
	}
	if (DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_3762))
	{
		STOP_PARTICLE_FX_LOOPED(uLocal_3762, 0);
	}
	if (DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_3763))
	{
		STOP_PARTICLE_FX_LOOPED(uLocal_3763, 0);
	}
	if (DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_3755[0]))
	{
		STOP_PARTICLE_FX_LOOPED(uLocal_3755[0], 0);
	}
	if (DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_3755[1]))
	{
		STOP_PARTICLE_FX_LOOPED(uLocal_3755[1], 0);
	}
	if (DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_3755[2]))
	{
		STOP_PARTICLE_FX_LOOPED(uLocal_3755[2], 0);
	}
	REMOVE_PTFX_ASSET();
	if (DOES_ENTITY_EXIST(iLocal_3222))
	{
		DELETE_PED(&iLocal_3222);
	}
	if (DOES_ENTITY_EXIST(iLocal_3228))
	{
		DELETE_PED(&iLocal_3228);
	}
	if (DOES_ENTITY_EXIST(uLocal_3245))
	{
		DELETE_PED(&uLocal_3245);
	}
	if (DOES_ENTITY_EXIST(uLocal_3246))
	{
		DELETE_PED(&uLocal_3246);
	}
	if (DOES_ENTITY_EXIST(uLocal_3247))
	{
		DELETE_PED(&uLocal_3247);
	}
	if (DOES_ENTITY_EXIST(iLocal_3248))
	{
		DELETE_PED(&iLocal_3248);
	}
	if (DOES_ENTITY_EXIST(uLocal_3249))
	{
		DELETE_PED(&uLocal_3249);
	}
	if (DOES_ENTITY_EXIST(uLocal_3250))
	{
		DELETE_PED(&uLocal_3250);
	}
	if (DOES_ENTITY_EXIST(uLocal_3223[0]))
	{
		DELETE_PED(&(uLocal_3223[0]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3223[1]))
	{
		DELETE_PED(&(uLocal_3223[1]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3223[2]))
	{
		DELETE_PED(&(uLocal_3223[2]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3223[3]))
	{
		DELETE_PED(&(uLocal_3223[3]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3229[0]))
	{
		DELETE_PED(&(uLocal_3229[0]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3229[1]))
	{
		DELETE_PED(&(uLocal_3229[1]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3229[2]))
	{
		DELETE_PED(&(uLocal_3229[2]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[0]))
	{
		DELETE_PED(&(uLocal_3233[0]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[1]))
	{
		DELETE_PED(&(uLocal_3233[1]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[2]))
	{
		DELETE_PED(&(uLocal_3233[2]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[3]))
	{
		DELETE_PED(&(uLocal_3233[3]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[4]))
	{
		DELETE_PED(&(uLocal_3233[4]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[5]))
	{
		DELETE_PED(&(uLocal_3233[5]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[6]))
	{
		DELETE_PED(&(uLocal_3233[6]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[7]))
	{
		DELETE_PED(&(uLocal_3233[7]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[8]))
	{
		DELETE_PED(&(uLocal_3233[8]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[9]))
	{
		DELETE_PED(&(uLocal_3233[9]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[10]))
	{
		DELETE_PED(&(uLocal_3233[10]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3251[0]))
	{
		DELETE_PED(&(uLocal_3251[0]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3254[0]))
	{
		DELETE_PED(&(uLocal_3254[0]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3254[1]))
	{
		DELETE_PED(&(uLocal_3254[1]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3258))
	{
		DELETE_VEHICLE(&uLocal_3258);
	}
	if (DOES_ENTITY_EXIST(iLocal_3259))
	{
		if (!IS_ENTITY_A_MISSION_ENTITY(iLocal_3259))
		{
			SET_ENTITY_AS_MISSION_ENTITY(iLocal_3259, 1, 0);
		}
		DELETE_VEHICLE(&iLocal_3259);
	}
	if (DOES_ENTITY_EXIST(uLocal_3264))
	{
		DELETE_VEHICLE(&uLocal_3264);
	}
	if (DOES_ENTITY_EXIST(uLocal_3265))
	{
		DELETE_VEHICLE(&uLocal_3265);
	}
	if (DOES_ENTITY_EXIST(uLocal_3266))
	{
		DELETE_VEHICLE(&uLocal_3266);
	}
	if (DOES_ENTITY_EXIST(iLocal_3267))
	{
		DELETE_VEHICLE(&iLocal_3267);
	}
	if (DOES_ENTITY_EXIST(uLocal_3271))
	{
		DELETE_VEHICLE(&uLocal_3271);
	}
	if (DOES_ENTITY_EXIST(iLocal_3275))
	{
	...
	if (DOES_ENTITY_EXIST(uLocal_3279[0]))
	{
		DELETE_VEHICLE(&(uLocal_3279[0]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3279[1]))
	{
		DELETE_VEHICLE(&(uLocal_3279[1]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3260[0]))
	{
		DELETE_VEHICLE(&(uLocal_3260[0]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3260[1]))
	{
		DELETE_VEHICLE(&(uLocal_3260[1]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3279[0]))
	{
		DELETE_VEHICLE(&(uLocal_3279[0]));
	...
	if (DOES_ENTITY_EXIST(uLocal_3268[0]))
	{
		DELETE_VEHICLE(&(uLocal_3268[0]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3268[1]))
	{
		DELETE_VEHICLE(&(uLocal_3268[1]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3272[0]))
	{
		DELETE_VEHICLE(&(uLocal_3272[0]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3263))
	{
		DELETE_VEHICLE(&uLocal_3263);
	}
	if (DOES_ENTITY_EXIST(uLocal_3282))
	{
		DELETE_OBJECT(&uLocal_3282);
	}
	if (DOES_ENTITY_EXIST(iLocal_3283))
	{
		DELETE_OBJECT(&iLocal_3283);
	}
	if (DOES_ENTITY_EXIST(uLocal_3284))
	{
		DELETE_OBJECT(&uLocal_3284);
	}
	...
	STOP_SOUND(uLocal_3211);
	STOP_SOUND(iLocal_3213);
	STOP_SOUND(iLocal_3214);
	STOP_SOUND(iLocal_3215);
	STOP_SOUND(iLocal_3216);
	STOP_SOUND(uLocal_3217);
	STOP_SOUND(iLocal_3218);
	STOP_SOUND(uLocal_3219);
	STOP_SOUND(uLocal_3212);
	func_209(&uLocal_28, 0, 0);
	if (DOES_CAM_EXIST(uLocal_3289))
	{
		DESTROY_CAM(uLocal_3289, 0);
	}
	if (DOES_CAM_EXIST(uLocal_3290))
	{
		DESTROY_CAM(uLocal_3290, 0);
	}
	if (DOES_CAM_EXIST(uLocal_3291))
	{
		DESTROY_CAM(uLocal_3291, 0);
	}
	func_188(1, 1);
	REMOVE_ANIM_DICT("misssolomon_3");
	...
	SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_3293);
...
void func_188(bool bParam0, bool bParam1)
{
	if (!IS_STRING_NULL_OR_EMPTY(&cLocal_2668))
	{
		iLocal_91 = 0;
		func_208();
		REMOVE_RELATIONSHIP_GROUP(uLocal_2684);
		...
		if (bLocal_107)
		{
			SET_MODEL_AS_NO_LONGER_NEEDED(func_207());
		}
		SET_MODEL_AS_NO_LONGER_NEEDED(func_206());
		SET_MODEL_AS_NO_LONGER_NEEDED(func_205());
		SET_MODEL_AS_NO_LONGER_NEEDED(func_204());
...
void func_196()
{
	...
	while (iVar0 < 35)
	{
		if (DOES_ENTITY_EXIST(iLocal_3121[iVar0]))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_3121[iVar0], 0))
			{
				...
				iVar1 = GET_PED_IN_VEHICLE_SEAT(iLocal_3121[iVar0], -1, 0);
...
void func_197()
{
	...
	while (iVar0 < 15)
	{
		if (DOES_ENTITY_EXIST(iLocal_3105[iVar0]))
		{
...
void func_198()
{
	...
	while (iVar0 < 175)
	{
		if (DOES_ENTITY_EXIST(iLocal_2916[iVar0]))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_2916[iVar0], 0))
			{
				...
				iVar1 = GET_PED_IN_VEHICLE_SEAT(iLocal_2916[iVar0], -1, 0);
				if (DOES_ENTITY_EXIST(iVar1) && iVar1 != PLAYER_PED_ID())
				{
					if (IS_ENTITY_A_MISSION_ENTITY(iVar1))
					{
...
void func_202()
{
	...
	while (iVar0 < 15)
	{
		if (DOES_ENTITY_EXIST(iLocal_3105[iVar0]))
		{
			if (!IS_ENTITY_DEAD(iLocal_3105[iVar0], 0))
			{
				SET_ENTITY_COLLISION(iLocal_3105[iVar0], 1, 0);
			}
...
void func_203()
{
	...
	while (iVar0 < 175)
	{
		if (DOES_ENTITY_EXIST(iLocal_2916[iVar0]))
		{
			if (!IS_ENTITY_DEAD(iLocal_2916[iVar0], 0))
			{
				SET_ENTITY_COLLISION(iLocal_2916[iVar0], 1, 0);
			}
			if (IS_VEHICLE_DRIVEABLE(iLocal_2916[iVar0], 0))
			{
				if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_2916[iVar0]))
...
void func_215()
{
	...
	if (DOES_BLIP_EXIST(uLocal_3286))
	{
		REMOVE_BLIP(&uLocal_3286);
	}
	if (DOES_BLIP_EXIST(uLocal_3287))
	{
		REMOVE_BLIP(&uLocal_3287);
	}
	if (DOES_BLIP_EXIST(uLocal_3288))
	{
		REMOVE_BLIP(&uLocal_3288);
	}
}
...
void func_216()
{
	if (iLocal_3570 == 0)
	{
		if (DOES_ENTITY_EXIST(iLocal_3228))
		{
			if (!IS_PED_INJURED(iLocal_3228))
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_3228, PLAYER_PED_ID(), 0))
				{
					iLocal_3570 = 1;
				}
			}
	...
	if (iLocal_3570 == 0)
	{
						...
						if (!IS_PED_INJURED(iLocal_3222))
						{
							if (IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_3222))
							{
								if (GET_PED_WAYPOINT_PROGRESS(iLocal_3222) > 18)
								{
									if (DOES_ENTITY_EXIST(uLocal_3284))
									{
										if (IS_ENTITY_ATTACHED(uLocal_3284))
										{
											DETACH_ENTITY(uLocal_3284, 1, 1);
										}
									}
									uLocal_3210 = CREATE_SYNCHRONIZED_SCENE(-932.847f, -2978.498f, 13.946f, 0f, 0f, 16.56f, 2);
									TASK_SYNCHRONIZED_SCENE(iLocal_3228, uLocal_3210, "misssolomon_3", "_action", 1000f, -1000f, 4, 0, 1148846080, 0);
									TASK_LOOK_AT_ENTITY(iLocal_3228, PLAYER_PED_ID(), 9000, 1024, 3);
									iLocal_3534 = 1;
									iLocal_3535 = 0;
								}
							}
		...
		if (iLocal_3534 == 1 && iLocal_3536 == 0)
		{
			if (DOES_ENTITY_EXIST(iLocal_3228))
			{
				if (!IS_PED_INJURED(iLocal_3228))
				{
					if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_3210))
					{
						if (!iLocal_3535)
						{
							if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_3210) > 0.25f)
							{
								func_17(&uLocal_3578, 4, iLocal_3228, "HangerWorker", 0, 1);
						...
						if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_3210) > 0.99f)
						{
							uLocal_3210 = CREATE_SYNCHRONIZED_SCENE(-932.847f, -2978.498f, 13.946f, 0f, 0f, 16.56f, 2);
							TASK_SYNCHRONIZED_SCENE(iLocal_3228, uLocal_3210, "misssolomon_3", "_react_to_death", 1000f, -1.5f, 3, 16, 1148846080, 0);
							iLocal_3536 = 1;
						}
					}
				}
		...
		if (iLocal_3536 == 1 && iLocal_3539 == 0)
		{
			if (DOES_ENTITY_EXIST(iLocal_3228))
			{
				if (!IS_PED_INJURED(iLocal_3228))
				{
					if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_3210))
					{
						if (HAS_ANIM_EVENT_FIRED(iLocal_3228, GET_HASH_KEY("ENDS_IN_RUN")))
						{
							OPEN_SEQUENCE_TASK(&uLocal_3292);
							...
							CLOSE_SEQUENCE_TASK(uLocal_3292);
							TASK_PERFORM_SEQUENCE(iLocal_3228, uLocal_3292);
							CLEAR_SEQUENCE_TASK(&uLocal_3292);
							FORCE_PED_MOTION_STATE(iLocal_3228, -1115154469, 0, 0, 0);
							iLocal_3539 = 1;
						}
					}
				}
	...
	if (iLocal_3181 == 1)
	{
		switch (iLocal_3183)
		{
			case 0:
				...
				if (IS_VEHICLE_DRIVEABLE(uLocal_3266, 0))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(uLocal_3266, "JET_TRV4", 0, joaat("jet"), 0);
				}
			...
			case 1:
				...
				if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("JET_TRV4", joaat("jet")))
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_3266, 0))
					{
						if (!IS_ENTITY_DEAD(uLocal_3266, 0))
						{
							FREEZE_ENTITY_POSITION(uLocal_3266, 1);
						}
					}
				...
				if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Airworker_Tackle_trevor", joaat("s_m_y_airworker")))
				{
					if (!IS_PED_INJURED(iLocal_3228))
					{
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_3228, 1);
						TASK_SMART_FLEE_PED(iLocal_3228, PLAYER_PED_ID(), 150f, -1, 0, 0);
						SET_ENTITY_INVINCIBLE(iLocal_3228, 0);
						SET_PED_CAN_BE_TARGETTED(iLocal_3228, 1);
						SET_ENTITY_PROOFS(iLocal_3228, 0, 0, 0, 0, 0, 0, 0, 0);
					}
				}
				...
				if (!IS_CUTSCENE_ACTIVE())
				{
					...
					{
						GIVE_WEAPON_TO_PED(PLAYER_PED_ID(), joaat("weapon_smg"), 150, 1, 1);
					}
					iLocal_3181 = 2;
				}
				break;
...
void func_219(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_223(PLAYER_ID())) && !func_221(PLAYER_ID(), 0)) && !func_220()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_223(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
...
void func_228()
{
	if (iLocal_3511 == 0)
	{
		if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -926.0258f, -2958.615f, 12.46467f, -930.6525f, -2956.061f, 16.45945f, 2.75f, 0, 1, 0))
		{
			iLocal_3511 = 1;
		}
	}
	else if (iLocal_3515 == 0)
	{
		...
		if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -938.5178f, -2972.022f, 12.46715f, -934.1034f, -2974.613f, 15.96715f, 5.25f, 0, 1, 0))
		{
		...
		else
		{
			...
			SET_PED_MAX_MOVE_BLEND_RATIO(PLAYER_PED_ID(), fLocal_3326);
		}
	}
	if (iLocal_3181 > 0)
	{
	...
	if (iLocal_3181 == 1)
	{
		if (iLocal_3479 == 0)
		{
			if (REQUEST_SCRIPT_AUDIO_BANK("Trv_4_747", 0, -1))
			{
				iLocal_3479 = 1;
			}
		}
						...
						if (GET_PED_WAYPOINT_PROGRESS(iLocal_3222) > 20)
						{
							if (DOES_ENTITY_EXIST(uLocal_3266))
							{
								if (IS_VEHICLE_DRIVEABLE(uLocal_3266, 0))
								{
									...
									PLAY_SOUND_FROM_COORD(uLocal_3211, "Trevor_4_747_Jet_Engine", -937.77f, -2981.36f, 15.44f, 0, 0, 0, 0);
									SET_VEHICLE_ENGINE_ON(uLocal_3266, 1, 0, 0);
									iLocal_3471 = 1;
								}
							}
						}
						...
						if (GET_PED_WAYPOINT_PROGRESS(iLocal_3222) > 23)
						{
							...
							if (DOES_ENTITY_EXIST(uLocal_3266))
							{
								if (IS_VEHICLE_DRIVEABLE(uLocal_3266, 0))
								{
									...
									uLocal_3209 = CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
									ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_3209, uLocal_3266, GET_ENTITY_BONE_INDEX_BY_NAME(uLocal_3266, "chassis_Control"));
									TASK_SYNCHRONIZED_SCENE(iLocal_3222, uLocal_3209, "MISSSOLOMON_3", "molly_death", 1.5f, -8f, 4, 0, 1148846080, 0);
									_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_3209, 1);
									iLocal_3512 = 1;
								}
							}
						}
		...
		if (iLocal_3513 == 0)
		{
			if (DOES_ENTITY_EXIST(iLocal_3222))
			{
				if (!IS_PED_INJURED(iLocal_3222))
				{
					if (iLocal_3512 == 1)
					{
						vLocal_3318 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
						if (vLocal_3318.y < -2965f)
						{
							SET_GAMEPLAY_ENTITY_HINT(iLocal_3222, 0f, 0f, 0f, 1, 6000, 1000, 2000, 0);
							SET_PLAYER_CONTROL(PLAYER_ID(), 0, 0);
							TASK_TURN_PED_TO_FACE_ENTITY(PLAYER_PED_ID(), iLocal_3222, 0);
							TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), iLocal_3222, 4000, 48, 4);
							iLocal_3513 = 1;
						}
					}
				}
		...
		else if (iLocal_3514 == 0)
		{
			if (!DOES_ENTITY_EXIST(iLocal_3222))
			{
				...
				if (DOES_ENTITY_EXIST(uLocal_3233[0]))
				{
					if (!IS_PED_INJURED(uLocal_3233[0]))
					{
						CLEAR_PED_TASKS(uLocal_3233[0]);
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3233[0], 0);
					}
				}
				iLocal_3514 = 1;
			}
				...
				if (!IS_PED_INJURED(iLocal_3222))
				{
					if (DOES_ENTITY_EXIST(iLocal_3283))
					{
						if (IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_3283, iLocal_3222))
						{
							...
							{
								if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_3209) > 0.59f)
								{
									DETACH_ENTITY(iLocal_3283, 1, 1);
									if (DOES_BLIP_EXIST(uLocal_3285))
									{
										REMOVE_BLIP(&uLocal_3285);
									}
		...
		if (iLocal_3571[3] == 0)
		{
			if (iLocal_3515 == 1 && iLocal_3514 == 1)
			{
				if (TIMERB() > 2500)
				{
					_0x293220DA1B46CEBC(10f, 1073741824, 3);
					iLocal_3571[3] = 1;
				}
			}
		}
		if (iLocal_3472 == 0)
		{
			if (!IS_PED_INJURED(iLocal_3222))
			{
				if (IS_ENTITY_PLAYING_ANIM(iLocal_3222, "MISSSOLOMON_3", "molly_death", 3))
				{
					if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_3209) > 0.89f)
					{
						if (DOES_ENTITY_EXIST(uLocal_3266))
						{
							if (IS_VEHICLE_DRIVEABLE(uLocal_3266, 0))
							{
								DELETE_PED(&iLocal_3222);
								START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_trev4_747_blood_impact", uLocal_3266, -12.5793f, 12.2f, -7.09421f, 0f, 0f, 0f, 1f, 0, 0, 0);
								uLocal_3764 = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_exhaust_plane_misfire", uLocal_3266, -12.6323f, 8.1153f, -7.0876f, 0f, 0f, 0f, 1f, 0, 0, 0);
								PLAY_SOUND_FROM_COORD(uLocal_3212, "Trevor_4_747_Man_Sucked_In", -938.6f, -2984.13f, 15.47f, 0, 0, 0, 0);
								iLocal_3192 = GET_GAME_TIMER();
								iLocal_3472 = 1;
							}
						}
					}
		...
		{
			if (GET_GAME_TIMER() > iLocal_3192 + 574)
			{
				if (!DOES_ENTITY_EXIST(uLocal_3282))
				{
					if (HAS_MODEL_LOADED(joaat("prop_jet_bloodsplat_01")))
				...
				if (iLocal_3568 == 0)
				{
					if (DOES_ENTITY_EXIST(uLocal_3266))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_3266, 0))
						{
							START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_trev4_747_engine_debris", uLocal_3266, -12.6286f, 6.85353f, -7.13622f, 180f, 0f, 0f, 1f, 0, 0, 0);
							SET_VEHICLE_ENGINE_ON(uLocal_3266, 0, 0, 0);
							func_229();
							STOP_SOUND(uLocal_3211);
							iLocal_3568 = 1;
						}
			...
			if (iLocal_3516[0] == 0)
			{
				if (GET_GAME_TIMER() > iLocal_3192 + 300)
				{
					if (DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_3764))
					{
						STOP_PARTICLE_FX_LOOPED(uLocal_3764, 0);
					}
					iLocal_3516[0] = 1;
				}
			}
			...
			{
				if (GET_GAME_TIMER() > iLocal_3192 + 700)
				{
					if (DOES_ENTITY_EXIST(uLocal_3266))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_3266, 0))
			...
			{
				if (GET_GAME_TIMER() > iLocal_3192 + 1000)
				{
					if (DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_3764))
					{
						STOP_PARTICLE_FX_LOOPED(uLocal_3764, 0);
			...
			{
				if (GET_GAME_TIMER() > iLocal_3192 + 1400)
				{
					if (DOES_ENTITY_EXIST(uLocal_3266))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_3266, 0))
			...
			{
				if (GET_GAME_TIMER() > iLocal_3192 + 3500)
				{
					if (DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_3764))
					{
						STOP_PARTICLE_FX_LOOPED(uLocal_3764, 0);
					...
					if (DOES_ENTITY_EXIST(uLocal_3266))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_3266, 0))
						{
							SET_ENTITY_PROOFS(uLocal_3266, 0, 0, 0, 0, 0, 0, 0, 0);
						}
					}
					iLocal_3516[2] = 1;
				}
		...
		if (iLocal_3537 == 0)
		{
			if (iLocal_3473 == 1)
			{
				if (iLocal_3538 == 0)
				{
					...
					{
						iLocal_3202 = GET_GAME_TIMER();
						iLocal_3538 = 1;
					}
				}
				else if (GET_GAME_TIMER() > iLocal_3202 + 2000)
				{
					FREEZE_ENTITY_POSITION(iLocal_3283, 1);
					iLocal_3537 = 1;
				}
			}
		}
		if (iLocal_3542 == 0)
		{
			if (!DOES_ENTITY_EXIST(iLocal_3222))
			{
				if (DOES_ENTITY_EXIST(uLocal_3266))
				{
					FREEZE_ENTITY_POSITION(uLocal_3266, 0);
					iLocal_3542 = 1;
				}
			}
		}
		if (DOES_ENTITY_EXIST(iLocal_3283))
		{
			if (DOES_BLIP_EXIST(uLocal_3288))
			{
				if (func_16(PLAYER_PED_ID(), iLocal_3283, 1) < 1.5f && !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
...
int func_231(var uParam0, int iParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_232(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
			SET_BLIP_AS_FRIENDLY(uVar0, iParam1);
		}
		else
		{
	...
	{
		SET_BLIP_SCALE(uVar0, func_232(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, iParam1);
	}
...
void func_233(var uParam0)
{
	...
	if (!IS_ENTITY_DEAD(*uParam0, 0))
	{
		...
		vVar12 = { 180f, 0f, 0f };
		uLocal_3759 = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_heathaze", *uParam0, vVar0, vVar12, 1065353216, 0, 0, 0);
		uLocal_3760 = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_heathaze", *uParam0, vVar3, vVar12, 1065353216, 0, 0, 0);
		uLocal_3761 = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_heathaze", *uParam0, vVar6, vVar12, 1065353216, 0, 0, 0);
		uLocal_3762 = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_trev4_747_engine_heathaze", *uParam0, vVar9, vVar12, 1065353216, 0, 0, 0);
	}
}
...
void func_234()
{
	if (DOES_ENTITY_EXIST(iLocal_3222))
	{
		if (!IS_PED_INJURED(iLocal_3222))
		{
			if (IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_3222))
			{
				if (func_16(PLAYER_PED_ID(), iLocal_3222, 1) < 17f)
				{
					WAYPOINT_PLAYBACK_OVERRIDE_SPEED(iLocal_3222, 3f, 1);
				}
				if (func_16(PLAYER_PED_ID(), iLocal_3222, 1) < 22f && func_16(PLAYER_PED_ID(), iLocal_3222, 1) > 17f)
				{
					WAYPOINT_PLAYBACK_OVERRIDE_SPEED(iLocal_3222, 2f, 1);
				}
				if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), -921.7f, -2946.4f, 13.4f, 1) > 8f && !IS_ENTITY_ON_SCREEN(iLocal_3222))
				{
					if (func_16(PLAYER_PED_ID(), iLocal_3222, 1) > 22f)
					{
						WAYPOINT_PLAYBACK_OVERRIDE_SPEED(iLocal_3222, 1f, 1);
					}
				}
				else if (func_16(PLAYER_PED_ID(), iLocal_3222, 1) > 22f)
				{
					WAYPOINT_PLAYBACK_OVERRIDE_SPEED(iLocal_3222, 2f, 1);
				}
			}
	...
	if (iLocal_3181 > 0)
	{
		...
		if (!DOES_ENTITY_EXIST(iLocal_3228))
		{
			...
			{
				iLocal_3228 = CREATE_PED(26, joaat("s_m_y_airworker"), -932.1812f, -2967.947f, 12.9451f, 170.7182f, 1, 1);
				SET_ENTITY_PROOFS(iLocal_3228, 0, 0, 0, 0, 0, 0, 0, 0);
				SET_PED_CAN_BE_TARGETTED(iLocal_3228, 0);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_3228, 1);
				func_17(&uLocal_3578, 4, iLocal_3228, "HangerWorker", 0, 1);
				uLocal_3284 = CREATE_OBJECT(joaat("p_amb_clipboard_01"), -932.1812f, -2967.947f, 12.9451f, 1, 1, 0);
				ATTACH_ENTITY_TO_ENTITY(uLocal_3284, iLocal_3228, GET_PED_BONE_INDEX(iLocal_3222, 60309), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
				uLocal_3210 = CREATE_SYNCHRONIZED_SCENE(-932.847f, -2978.498f, 13.946f, 0f, 0f, 16.56f, 2);
				TASK_SYNCHRONIZED_SCENE(iLocal_3228, uLocal_3210, "misssolomon_3", "_start_loop", 1000f, -8f, 68, 0, 1148846080, 0);
				SET_MODEL_AS_NO_LONGER_NEEDED(joaat("s_m_y_airworker"));
		...
		if (!DOES_ENTITY_EXIST(uLocal_3233[0]))
		{
			...
			if (HAS_MODEL_LOADED(joaat("s_m_y_cop_01")))
			{
				...
				SET_PED_ACCURACY(uLocal_3233[0], 20);
				SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_3233[0], 1, 1);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3233[0], 1);
				TASK_AIM_GUN_AT_ENTITY(uLocal_3233[0], PLAYER_PED_ID(), -1, 1);
				func_126(uLocal_3233[0], 0);
			}
		}
		...
		if (DOES_ENTITY_EXIST(iLocal_3267))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_3267, 0))
			{
				if (func_16(PLAYER_PED_ID(), iLocal_3267, 1) > 5f)
				{
					SET_VEHICLE_DOOR_OPEN(iLocal_3267, 0, 0, 0);
				}
			}
		}
	}
	if (iLocal_3181 == 0)
	{
		...
		{
			_0x18EB48CFC41F2EA0(uLocal_3258, 0);
			SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_3258);
		}
		if (DOES_ENTITY_EXIST(uLocal_3271))
		{
			DELETE_VEHICLE(&uLocal_3271);
		...
		if (!IS_PED_INJURED(iLocal_3222))
		{
			if (!DOES_BLIP_EXIST(uLocal_3285))
			{
				uLocal_3285 = ADD_BLIP_FOR_ENTITY(iLocal_3222);
				SET_BLIP_AS_FRIENDLY(uLocal_3285, 1);
			}
		}
		SET_AUDIO_FLAG("PoliceScannerDisabled", 1);
		if (iLocal_3365[2] == 1)
		{
			if (!HAS_SOUND_FINISHED(uLocal_3219))
			{
				STOP_SOUND(uLocal_3219);
			}
			RELEASE_SOUND_ID(uLocal_3219);
			iLocal_3397 = 0;
			iLocal_3365[2] = 0;
		}
		SET_MAX_WANTED_LEVEL(5);
	...
	if (iLocal_3181 == 2)
	{
		if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -880.365f, -2942.26f, 14f, 9.55f, 15.69f, 5f, 0, 1, 0))
		{
			func_235("TRV4_FAIL1");
		}
		if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -945.725f, -2893.15f, 14f, 4.5f, 9.56f, 5f, 0, 1, 0))
		{
			func_235("TRV4_FAIL1");
		}
		if (TIMERA() > 15000)
		...
		if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -932.1196f, -2934.317f, 12.9448f, 2f, 2f, 2f, 0, 1, 0))
		{
			if (!IS_PED_INJURED(iLocal_3222))
			{
				if (!IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_3222))
				{
					...
					TASK_PLAY_ANIM(iLocal_3222, "move_f@film_reel_arms", "run", 8f, -8f, -1, 49, 0, 0, 0, 0);
				}
			}
			SETTIMERA(0);
			iLocal_3181 = 3;
	...
	if (iLocal_3181 == 3)
	{
		...
		if (TIMERA() > 50000)
		{
			if (!IS_PED_INJURED(iLocal_3222))
			{
				CLEAR_PED_TASKS_IMMEDIATELY(iLocal_3222);
				SET_ENTITY_COORDS(iLocal_3222, -932.5f, -2964.1f, 13.4f, 1, 0, 0, 1);
...
void func_239(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_241(Global_106565.f_18527[iVar0], &vVar2, &fVar5))
			{
...
void func_246()
{
	if (!DOES_ENTITY_EXIST(uLocal_3266))
	{
		if (DOES_ENTITY_EXIST(uLocal_3258))
		{
			if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
			{
				if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
				{
					if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 30000f)
					{
						REQUEST_MODEL(joaat("jet"));
						if (HAS_MODEL_LOADED(joaat("jet")))
						{
	...
	if (iLocal_3181 == 0)
	{
		if (iLocal_3182 < 2)
		{
			SET_PED_CAN_HEAD_IK(PLAYER_PED_ID(), 0);
		}
		func_339();
		func_307();
		if (iLocal_3402 == 0)
		{
			if (DOES_ENTITY_EXIST(iLocal_3121[20]))
			{
				if (IS_VEHICLE_DRIVEABLE(iLocal_3121[20], 0))
				{
					SET_VEHICLE_ENGINE_ON(iLocal_3121[20], 1, 1, 0);
		...
		else if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
		{
			if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
			{
				func_303(uLocal_3289, uLocal_3271, fLocal_3323);
				SET_CAM_FOV(uLocal_3289, 45f);
			}
		}
		if (iLocal_3337 == 0)
		{
			if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
			{
				if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
				{
					if ((GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 15000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 125464f) && func_295(1, 0, 0))
					{
						iLocal_3352 = 1;
						if (iLocal_3437 == 0)
						{
		...
		else if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
		{
			if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
			{
				if (HAS_SCALEFORM_MOVIE_LOADED(uLocal_3293) && func_185(1, "BB_Chase"))
				{
					if (((GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 15000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 125464f) && iLocal_3437 == 0) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
					{
						func_266();
					}
					if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 125464f || !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
					{
						if (iLocal_3336)
						{
							CLEAR_HELP(1);
		...
		switch (iLocal_3182)
		{
			case 0:
				if (iLocal_3571[0] == 0)
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
						{
							if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 44255f && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), -1187.3f, -2847.8f, 13.6f, 1) < 100f)
							{
								_0x293220DA1B46CEBC(10f, 1073741824, 3);
								iLocal_3571[0] = 1;
							}
				...
				if (iLocal_3571[1] == 0)
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
						{
							if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 52875f && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), -1349f, -2720f, 14f, 1) < 50f)
							{
								_0x293220DA1B46CEBC(6f, 1073741824, 3);
								iLocal_3571[1] = 1;
							}
						}
					}
				...
				if (iLocal_3571[2] == 0)
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
						{
							if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 87085f && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), -1507f, -2520f, 14f, 1) < 70f)
							{
								_0x293220DA1B46CEBC(10f, 1073741824, 3);
								iLocal_3571[2] = 1;
							}
				...
				if (!IS_AUDIO_SCENE_ACTIVE("SOL_3_PLANE_ON_FIRE"))
				{
					if (DOES_ENTITY_EXIST(uLocal_3258))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
						{
							if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
							{
								if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 64280f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 72000f)
								{
									if (GET_DISTANCE_BETWEEN_COORDS(-1149.6f, -2323.7f, 22.5f, GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 1) < 130f)
									{
				...
				else if (DOES_ENTITY_EXIST(uLocal_3258))
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
						{
							if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 72500f)
							{
								STOP_AUDIO_SCENE("SOL_3_PLANE_ON_FIRE");
							}
						}
				...
				if (!IS_AUDIO_SCENE_ACTIVE("SOL_3_EVENT_JET_LANDING"))
				{
					if (DOES_ENTITY_EXIST(uLocal_3258))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
						{
							if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
							{
								if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 78000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 85000f)
								{
				...
				else if (DOES_ENTITY_EXIST(uLocal_3258))
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
						{
							if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 85500f)
							{
								STOP_AUDIO_SCENE("SOL_3_EVENT_JET_LANDING");
							}
						}
				...
				if (!IS_AUDIO_SCENE_ACTIVE("SOL_3_EVENT_PLANE_TAXIING_EXPLOSION"))
				{
					if (DOES_ENTITY_EXIST(uLocal_3258))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
						{
							if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
							{
								if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 100000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 107000f)
								{
				...
				else if (DOES_ENTITY_EXIST(uLocal_3258))
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
						{
							if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 107500f)
							{
								STOP_AUDIO_SCENE("SOL_3_EVENT_PLANE_TAXIING_EXPLOSION");
							}
						}
				...
				if (DOES_ENTITY_EXIST(uLocal_3258))
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
						{
							if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 10000f)
							{
								func_263();
							}
						}
				...
				if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
				{
					if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
					{
						if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 30000f)
						{
							func_262(uLocal_3258, GET_TIME_POSITION_IN_RECORDING(uLocal_3258));
						}
					}
				}
				if (iLocal_3440 == 0)
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
						{
							if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 22000f)
							{
				...
				{
					if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -940.8253f, -2858.602f, 11.94482f, -1001.272f, -2823.764f, 21.00674f, 5.75f, 0, 1, 0))
					{
				...
				if (iLocal_3343 == 0)
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
					{
						if (func_16(uLocal_3258, PLAYER_PED_ID(), 1) < 170f && IS_ENTITY_ON_SCREEN(uLocal_3258))
						{
							if (DOES_BLIP_EXIST(uLocal_3287))
							{
								REMOVE_BLIP(&uLocal_3287);
					...
					if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -536.0366f, -2102.793f, 5.672412f, -464.5755f, -2165.133f, 14.75182f, 65.25f, 0, 1, 0))
					{
						if (DOES_BLIP_EXIST(uLocal_3287))
						{
							REMOVE_BLIP(&uLocal_3287);
				...
				else if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
				{
					if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
					{
						if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 15000f)
						{
						}
					}
				}
				if (iLocal_3328 == 0)
				{
					...
					if (HAS_MODEL_LOADED(joaat("jet")))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
						{
							if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
							{
								if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 18490f)
								{
									uLocal_3260[1] = CREATE_VEHICLE(joaat("jet"), -441.3117f, -3435.736f, 409.9454f, 148.3975f, 1, 1, 0);
									START_PLAYBACK_RECORDED_VEHICLE(uLocal_3260[1], 2, "BB_Chase", 1);
									SET_MODEL_AS_NO_LONGER_NEEDED(joaat("jet"));
									iLocal_3328 = 1;
								}
							}
				...
				else if (DOES_ENTITY_EXIST(uLocal_3260[1]))
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_3260[1], 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3260[1]))
						{
							SET_PLAYBACK_SPEED(uLocal_3260[1], fLocal_3323);
							if (GET_TIME_POSITION_IN_RECORDING(uLocal_3260[1]) > 20000f)
							{
								if (func_16(PLAYER_PED_ID(), uLocal_3260[1], 1) > 200f && !IS_ENTITY_ON_SCREEN(uLocal_3260[1]))
								{
									STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_3260[1]);
									if (DOES_ENTITY_EXIST(uLocal_3254[1]))
									{
										DELETE_PED(&(uLocal_3254[1]));
									}
									DELETE_VEHICLE(&(uLocal_3260[1]));
									iLocal_3207 = GET_GAME_TIMER() + 1000;
								}
							}
							if (DOES_ENTITY_EXIST(uLocal_3260[1]))
							{
								if (GET_TIME_POSITION_IN_RECORDING(uLocal_3260[1]) > 31543f)
								{
									STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_3260[1]);
									FREEZE_ENTITY_POSITION(uLocal_3260[1], 1);
								}
							}
						}
						else if (func_16(PLAYER_PED_ID(), uLocal_3260[1], 1) > 200f && !IS_ENTITY_ON_SCREEN(uLocal_3260[1]))
						{
							if (DOES_ENTITY_EXIST(uLocal_3254[1]))
							{
								DELETE_PED(&(uLocal_3254[1]));
				...
				if (iLocal_3487 == 0)
				{
					if (!DOES_ENTITY_EXIST(uLocal_3265))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
						{
							if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
							{
								if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 23000f)
								{
									REQUEST_MODEL(joaat("tanker"));
									if (HAS_MODEL_LOADED(joaat("tanker")))
									{
										uLocal_3265 = CREATE_VEHICLE(joaat("tanker"), -1325f, -2779f, 14f, 233.9563f, 1, 1, 0);
										SET_MODEL_AS_NO_LONGER_NEEDED(joaat("tanker"));
										SET_VEHICLE_COLOURS(uLocal_3265, 57, 57);
										iLocal_3487 = 1;
									}
								}
							}
				...
				if (DOES_ENTITY_EXIST(iLocal_3121[1]))
				{
					if (IS_VEHICLE_DRIVEABLE(iLocal_3121[1], 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3121[1]))
						{
							if (GET_TIME_POSITION_IN_RECORDING(iLocal_3121[1]) > 13000f)
							{
								...
								{
									fLocal_1173[1] = 0.5f;
									uLocal_3245 = GET_PED_IN_VEHICLE_SEAT(iLocal_3121[1], -1, 0);
									iLocal_3377 = 1;
								}
							}
						}
				...
				if (iLocal_3334 == 0)
				{
					...
					if (DOES_ENTITY_EXIST(iLocal_3121[1]))
					{
						...
						if (DOES_ENTITY_EXIST(uLocal_3265))
						{
							if (!IS_ENTITY_DEAD(iLocal_3121[1], 0))
							{
								if (!IS_ENTITY_DEAD(uLocal_3265, 0))
								{
									if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3121[1]))
									{
										ATTACH_VEHICLE_TO_TRAILER(iLocal_3121[1], uLocal_3265, 1065353216);
									}
								}
							}
						}
					...
					if (DOES_ENTITY_EXIST(uLocal_3265))
					{
						if (DOES_ENTITY_EXIST(uLocal_3258))
						{
							if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
							{
								if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
								{
									if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 41430f)
									{
										DETACH_ENTITY(uLocal_3265, 1, 1);
										iLocal_3334 = 1;
									}
								}
							}
				...
				else if (iLocal_3380 == 0)
				{
					if (IS_VEHICLE_DRIVEABLE(iLocal_3121[1], 0))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
						{
							if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
							{
								if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 42700f)
								{
									if (DOES_ENTITY_EXIST(uLocal_3245))
									{
										if (!IS_PED_INJURED(uLocal_3245))
										{
											SET_ENTITY_HEALTH(uLocal_3245, 0, 0);
										}
									}
									if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3121[1]))
									{
				...
				if (DOES_ENTITY_EXIST(uLocal_3258))
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
						{
							if (iLocal_3551 == 0)
							{
								if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 38000f)
								{
									if (DOES_ENTITY_EXIST(iLocal_3121[1]) && IS_VEHICLE_DRIVEABLE(iLocal_3121[1], 0))
									{
							...
							if (iLocal_3365[1] == 0)
							{
								if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 39000f)
								{
									if (!IS_AUDIO_SCENE_ACTIVE("SOL_3_EVENT_TANKER_CRASH"))
									{
									...
									if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
									{
										SET_ENTITY_PROOFS(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0, 1, 1, 0, 0, 0, 0, 0);
									}
									iLocal_3365[1] = 1;
								}
							}
							if (iLocal_3435 == 0)
							{
								if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 41611f)
								{
									if (DOES_ENTITY_EXIST(uLocal_3265))
									{
										if (!IS_ENTITY_DEAD(uLocal_3265, 0))
										{
											if (DOES_ENTITY_EXIST(iLocal_3121[7]))
											{
												if (!IS_ENTITY_DEAD(iLocal_3121[7], 0))
												{
													PLAY_SOUND_FROM_ENTITY(-1, "Trevor_4_747_Tanker_Explosion", uLocal_3265, 0, 0, 0);
													STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_3121[7]);
													EXPLODE_VEHICLE(iLocal_3121[7], 1, 0);
													EXPLODE_VEHICLE(uLocal_3265, 1, 0);
													ADD_EXPLOSION(-1221f, -2852f, 17f, 14, 1f, 1, 0, 1065353216, 0);
													ADD_EXPLOSION(-1212f, -2855f, 14.34f, 14, 1f, 1, 0, 1065353216, 0);
													SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_3265);
							...
							if (iLocal_3369[1] == 0)
							{
								if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 43204f)
								{
									if (IS_AUDIO_SCENE_ACTIVE("SOL_3_EVENT_TANKER_CRASH"))
									{
										STOP_AUDIO_SCENE("SOL_3_EVENT_TANKER_CRASH");
									...
									if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
									{
										SET_ENTITY_PROOFS(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0, 0, 0, 0, 0, 0, 0, 0);
									}
									iLocal_3369[1] = 1;
								}
							}
				...
				if (!IS_AUDIO_SCENE_ACTIVE("SOL_3_HELI_TAKEOFF"))
				{
					if (DOES_ENTITY_EXIST(iLocal_3121[0]))
					{
						if (IS_VEHICLE_DRIVEABLE(iLocal_3121[0], 0))
						{
							if (DOES_ENTITY_EXIST(uLocal_3258))
							{
								if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
								{
									if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
									{
										if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 36000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 40000f)
										{
				...
				else if (DOES_ENTITY_EXIST(iLocal_3121[0]))
				{
					if (IS_VEHICLE_DRIVEABLE(iLocal_3121[0], 0))
					{
						if (DOES_ENTITY_EXIST(uLocal_3258))
				...
				if (iLocal_3327 == 0)
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
						{
							if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 60500f)
							{
								REQUEST_MODEL(joaat("jet"));
							}
							if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 66500f)
							{
								if (HAS_MODEL_LOADED(joaat("jet")))
								{
									uLocal_3260[0] = CREATE_VEHICLE(joaat("jet"), -1119.072f, -1864.548f, -8.2205f, 148.3975f, 1, 1, 0);
									SET_ENTITY_INVINCIBLE(uLocal_3260[0], 1);
									SET_VEHICLE_LIVERY(uLocal_3260[0], 2);
									START_PLAYBACK_RECORDED_VEHICLE(uLocal_3260[0], 35, "BB_Chase", 1);
									SKIP_TIME_IN_PLAYBACK_RECORDED_VEHICLE(uLocal_3260[0], 3491f);
									SET_MODEL_AS_NO_LONGER_NEEDED(joaat("jet"));
									iLocal_3327 = 1;
								}
							}
				...
				else if (DOES_ENTITY_EXIST(uLocal_3260[0]))
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_3260[0], 0))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
						{
							if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
							{
								if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3260[0]))
								{
									SET_PLAYBACK_SPEED(uLocal_3260[0], fLocal_3323);
									if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 80000f)
									{
										if (func_16(uLocal_3260[0], PLAYER_PED_ID(), 1) > 200f)
										{
											STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_3260[0]);
										}
									}
								}
								else if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 80000f)
								{
									if (func_16(uLocal_3260[0], PLAYER_PED_ID(), 1) > 200f && !IS_ENTITY_ON_SCREEN(uLocal_3260[0]))
									{
										if (DOES_ENTITY_EXIST(uLocal_3254[0]))
										{
											DELETE_PED(&(uLocal_3254[0]));
				...
				if (iLocal_3399 == 0)
				{
					if (iLocal_3398 == 0)
					{
						if (DOES_ENTITY_EXIST(uLocal_3258))
						{
							if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
							{
								if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
								{
									if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 50000f)
									{
										REQUEST_MODEL(joaat("s_m_y_airworker"));
										REQUEST_ANIM_DICT("misstrevor4");
										if (HAS_MODEL_LOADED(joaat("s_m_y_airworker")))
										{
											uLocal_3246 = CREATE_PED(26, joaat("s_m_y_airworker"), -1170.541f, -2507.111f, 12.9455f, 218.3035f, 1, 1);
											uLocal_3247 = CREATE_PED(26, joaat("s_m_y_airworker"), -1168.264f, -2508.715f, 12.9455f, 70.7735f, 1, 1);
											SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3246, 1);
											SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3247, 1);
											SET_MODEL_AS_NO_LONGER_NEEDED(joaat("s_m_y_airworker"));
											iLocal_3398 = 1;
										}
									}
					...
					else if (DOES_ENTITY_EXIST(uLocal_3258))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
						{
							if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
							{
								if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 58000f)
								{
									if (!IS_PED_INJURED(uLocal_3246))
									{
										if (HAS_ANIM_DICT_LOADED("misstrevor4"))
										{
											if (!IS_ENTITY_PLAYING_ANIM(uLocal_3246, "misstrevor4", "dive_clear_goon1", 3))
											{
												TASK_PLAY_ANIM(uLocal_3246, "misstrevor4", "dive_clear_goon1", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
											}
										}
									}
									if (!IS_PED_INJURED(uLocal_3247))
									{
										if (HAS_ANIM_DICT_LOADED("misstrevor4"))
										{
											if (!IS_ENTITY_PLAYING_ANIM(uLocal_3247, "misstrevor4", "dive_clear_goon2", 3))
											{
												TASK_PLAY_ANIM(uLocal_3247, "misstrevor4", "dive_clear_goon2", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
											}
										}
									}
									iLocal_3399 = 1;
				...
				else if (DOES_ENTITY_EXIST(uLocal_3246))
				{
					if (!IS_PED_INJURED(uLocal_3246))
					{
						if (!IS_ENTITY_PLAYING_ANIM(uLocal_3246, "misstrevor4", "dive_clear_goon1", 3))
							...
							if (DOES_ENTITY_EXIST(uLocal_3247))
							{
								if (!IS_PED_INJURED(uLocal_3247))
								{
									if (!IS_ENTITY_PLAYING_ANIM(uLocal_3247, "misstrevor4", "dive_clear_goon2", 3))
									{
										...
										SET_PED_AS_NO_LONGER_NEEDED(&uLocal_3246);
										SET_PED_AS_NO_LONGER_NEEDED(&uLocal_3247);
									}
								}
							}
						}
				...
				if (DOES_ENTITY_EXIST(iLocal_3121[8]))
				{
						...
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3121[8]))
						{
							if (DOES_ENTITY_EXIST(uLocal_3258))
							{
								if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
								{
									if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
									{
										if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 50200f)
										{
											if (iLocal_3330 == 0)
											{
												SET_PLAYBACK_SPEED(iLocal_3121[8], 1f);
												if (func_16(PLAYER_PED_ID(), iLocal_3121[8], 1) < 100f)
												{
													SET_TIME_SCALE(0.3f);
													iLocal_3373 = 0;
													if (!IS_AUDIO_SCENE_ACTIVE("SOL_3_CAR_JET_ENGINE"))
												...
												SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_3121[8], 1, 1);
												SET_VEHICLE_DOOR_BROKEN(iLocal_3121[8], 1, 0);
				...
				if (DOES_ENTITY_EXIST(iLocal_3121[11]))
				{
						...
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3121[11]))
						{
							if (DOES_ENTITY_EXIST(uLocal_3258))
							{
								if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
								{
									if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
									{
										if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 82683f)
										{
											if (iLocal_3331 == 0)
											{
				...
				if (DOES_ENTITY_EXIST(iLocal_3121[12]))
				{
						...
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3121[12]))
						{
							if (DOES_ENTITY_EXIST(uLocal_3258))
							{
								if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
								{
									if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
									{
										if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 82463f)
										{
											if (iLocal_3332 == 0)
											{
				...
				if (iLocal_3540 == 0 && iLocal_3541 == 1)
				{
					if (DOES_ENTITY_EXIST(iLocal_3121[12]))
					{
						if (IS_VEHICLE_DRIVEABLE(iLocal_3121[12], 0))
						{
							vLocal_3315 = { GET_ENTITY_COORDS(iLocal_3121[12], 1) };
						}
					}
					vLocal_3318 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
					if (GET_GAME_TIMER() > iLocal_3203 + 1579 || vLocal_3318.y < vLocal_3315.y)
					{
						SET_TIME_SCALE(1f);
						STOP_GAMEPLAY_HINT(0);
						iLocal_3540 = 1;
				...
				if (DOES_ENTITY_EXIST(uLocal_3258))
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
						{
							if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 105000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 113000f)
							{
				...
				if (DOES_ENTITY_EXIST(iLocal_3121[13]))
				{
					if (IS_VEHICLE_DRIVEABLE(iLocal_3121[13], 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3121[13]))
						{
							if (DOES_ENTITY_EXIST(uLocal_3258))
							{
								if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
								{
									if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
									{
										if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 108830f)
										{
											SET_VEHICLE_CAN_BREAK(iLocal_3121[13], 0);
											SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_3121[13], 1, 1);
											_SET_ENTITY_SOMETHING(iLocal_3121[13], 0);
											SETTIMERA(0);
											iLocal_3486 = 1;
										}
									}
						...
						{
							SET_ENTITY_HEALTH(iLocal_3121[13], 0, 0);
							SET_VEHICLE_UNDRIVEABLE(iLocal_3121[13], 1);
							SET_ENTITY_HEALTH(GET_PED_IN_VEHICLE_SEAT(iLocal_3121[13], -1, 0), 0, 0);
						}
					}
				}
				if (iLocal_3478 == 0)
				{
					if (DOES_ENTITY_EXIST(iLocal_3121[5]))
					{
						if (IS_VEHICLE_DRIVEABLE(iLocal_3121[5], 0))
						{
							SET_VEHICLE_LIVERY(iLocal_3121[5], 0);
							SET_ENTITY_INVINCIBLE(iLocal_3121[5], 1);
							iLocal_3478 = 1;
						}
					}
				}
				if (DOES_ENTITY_EXIST(iLocal_3121[15]))
				{
						...
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3121[15]))
						{
							if (DOES_ENTITY_EXIST(uLocal_3258))
							{
								if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
								{
									if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
									{
										if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 104989f)
										{
				...
				if (DOES_ENTITY_EXIST(uLocal_3258))
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
						{
							if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 112000f)
							{
								REQUEST_WAYPOINT_RECORDING("BB_MOLLY_2");
								REQUEST_ANIM_DICT("misssolomon_3");
								REQUEST_ANIM_DICT("move_f@film_reel_arms");
			...
			case 1:
				if (iLocal_3508 == 0)
				{
					if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -887.1561f, -2957.106f, 12.46766f, -848.108f, -2997.588f, 18.23435f, 5f, 0, 1, 0))
					{
						iLocal_3508 = 1;
					}
				}
				if (DOES_ENTITY_EXIST(uLocal_3272[0]))
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_3272[0], 0))
					{
						_0x18EB48CFC41F2EA0(uLocal_3272[0], 0);
						SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uLocal_3272[0]));
					}
				}
				if (DOES_ENTITY_EXIST(uLocal_3251[0]))
				{
					if (!IS_PED_INJURED(uLocal_3251[0]))
					{
						CLEAR_PED_TASKS(uLocal_3251[0]);
						SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3251[0]));
					}
				}
				if (iLocal_3401 == 0)
				{
					if (DOES_ENTITY_EXIST(uLocal_3258))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
						{
							if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
							{
								if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 115000f)
								{
									REQUEST_WAYPOINT_RECORDING("Trev4_5");
									REQUEST_MODEL(joaat("prop_cs_film_reel_01"));
				...
				if (iLocal_3437 == 0)
				{
					if (DOES_ENTITY_EXIST(uLocal_3258))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
						{
							if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
							{
								if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 120000f)
								{
									if (!IS_AUDIO_SCENE_ACTIVE("SOL_3_ARRIVE_AT_HANGAR"))
									{
										START_AUDIO_SCENE("SOL_3_ARRIVE_AT_HANGAR");
									}
									REQUEST_VEHICLE_HIGH_DETAIL_MODEL(uLocal_3258);
								}
								if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 125513f)
								{
									STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_3258);
									FREEZE_ENTITY_POSITION(uLocal_3258, 1);
									func_259();
									CLEAR_PED_NON_CREATION_AREA();
									SET_PED_PATHS_IN_AREA(-833.86f, -2564.17f, 13.43f, -814.37f, -2521.04f, 12.94f, 1, 0);
									STOP_AUDIO_SCENE("TREVOR_4_MAIN_CHASE");
									if (!DOES_CAM_EXIST(uLocal_3291))
									{
										uLocal_3291 = CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 0);
									}
									if (!DOES_CAM_EXIST(uLocal_3290))
									{
										uLocal_3290 = CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 0);
									}
									iLocal_3194 = GET_GAME_TIMER();
									SET_CINEMATIC_BUTTON_ACTIVE(1);
									_SET_UNK_MAP_FLAG(0);
									iLocal_3182 = 2;
								}
			...
			case 2:
				...
				if (iLocal_3437 == 0)
				{
					if (GET_DISTANCE_BETWEEN_COORDS(vLocal_3318, -930.7f, -2916.9f, 13.4f, 1) < 45f)
					{
						iLocal_3182 = 3;
					}
					if (DOES_ENTITY_EXIST(uLocal_3258))
					{
						if (IS_ENTITY_ON_SCREEN(uLocal_3258))
						{
							if (iLocal_3508 == 1)
							{
								iLocal_3182 = 3;
					...
					if (GET_GAME_TIMER() > iLocal_3194 + 5000 && iLocal_3508 == 1)
					{
						iLocal_3182 = 3;
					}
				}
			...
			case 3:
							...
							if (!IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
							{
								if (HAS_ANIM_DICT_LOADED("misssolomon_3"))
								{
									if (!IS_PED_INJURED(iLocal_3222))
									{
										...
										if (!IS_ENTITY_PLAYING_ANIM(iLocal_3222, "misssolomon_3", "molly_escapes_car_mol", 3))
										{
											FREEZE_ENTITY_POSITION(uLocal_3258, 0);
											uLocal_3208 = CREATE_SYNCHRONIZED_SCENE(-929.492f, -2913.472f, 14.16f, 0f, 0f, -28.96f, 2);
											PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_3258, uLocal_3208, "molly_escapes_car_car", "misssolomon_3", 8f, -8f, 0, 1000f);
											TASK_SYNCHRONIZED_SCENE(iLocal_3222, uLocal_3208, "misssolomon_3", "molly_escapes_car_mol", 1000f, -1000f, 5, 0, 1148846080, 0);
											_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_3208, 0);
				...
				if (iLocal_3468 == 0)
				{
					if (iLocal_3466 == 1)
					{
						if (!IS_PED_INJURED(iLocal_3222))
						{
							if (IS_ENTITY_IN_ANGLED_AREA(iLocal_3222, -937.6656f, -2927.864f, 12.77007f, -934.8479f, -2929.484f, 14.46523f, 1.5f, 0, 1, 0))
							{
								if (IS_ENTITY_PLAYING_ANIM(iLocal_3222, "misssolomon_3", "molly_escapes_car_mol", 3))
								{
								...
								CLEAR_PED_TASKS_IMMEDIATELY(iLocal_3222);
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_3222, 1);
								SET_ENTITY_COORDS(iLocal_3222, -934.8388f, -2932.831f, 12.9649f, 1, 0, 0, 1);
					...
					if (iLocal_3476 == 0)
					{
						if (iLocal_3475 == 0)
						{
							if (!IS_PED_INJURED(iLocal_3222))
							{
								if (IS_ENTITY_PLAYING_ANIM(iLocal_3222, "misssolomon_3", "molly_escapes_car_mol", 3))
								{
									if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_3208) > 0.18f || GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), -930.7f, -2916.9f, 13.4f, 1) < 10f)
									{
										iLocal_3183 = 0;
										iLocal_3475 = 1;
									}
						...
						while (iLocal_3475 == 1)
						{
							...
							{
								case 0:
									SET_CAM_PARAMS(uLocal_3291, -927.0851f, -2921.173f, 13.66304f, 1.738541f, 1.294743f, 28.05799f, 34.66404f, 0, 1, 1, 2);
									SET_CAM_PARAMS(uLocal_3290, -927.0851f, -2921.173f, 13.66304f, 1.738541f, 1.294742f, 32.59915f, 34.66404f, 0, 1, 1, 2);
									SET_CAM_ACTIVE_WITH_INTERP(uLocal_3290, uLocal_3291, 4000, 1, 1);
									DISPLAY_RADAR(0);
									DISPLAY_HUD(0);
									...
									if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
									{
										SET_ENTITY_COORDS(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), -918.6157f, -2926.646f, 12.9667f, 1, 0, 0, 1);
										SET_ENTITY_HEADING(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 47.9465f);
									}
									else
									{
										SET_ENTITY_COORDS(PLAYER_PED_ID(), -918.6157f, -2926.646f, 12.9667f, 1, 0, 0, 1);
								...
								case 1:
									if (!IS_PED_INJURED(iLocal_3222))
									{
										if (IS_ENTITY_PLAYING_ANIM(iLocal_3222, "misssolomon_3", "molly_escapes_car_mol", 3))
										{
											if (iLocal_3529 == 0)
											{
												if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_3208) > 0.3f)
												{
											...
											if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_3208) > 0.5f)
											{
												SET_CAM_PARAMS(uLocal_3291, -926.0932f, -2916.891f, 14.47074f, -3.471637f, 1.294743f, 125.8315f, 34.66404f, 0, 1, 1, 2);
												SET_CAM_PARAMS(uLocal_3290, -926.0932f, -2916.891f, 14.47074f, -3.471636f, 1.294743f, 135.4584f, 34.66404f, 0, 1, 1, 2);
												SET_CAM_ACTIVE_WITH_INTERP(uLocal_3290, uLocal_3291, 4000, 1, 1);
												iLocal_3206 = GET_GAME_TIMER();
												iLocal_3183++;
											}
										}
									}
								...
								case 2:
									if (!IS_PED_INJURED(iLocal_3222))
									{
										if (IS_ENTITY_PLAYING_ANIM(iLocal_3222, "misssolomon_3", "molly_escapes_car_mol", 3))
										{
											if ((iLocal_3206 != -1 && _0xEE778F8C7E1142E2(0) == 4) && (GET_GAME_TIMER() - iLocal_3206) >= 2230)
											{
												_START_SCREEN_EFFECT("CamPushInNeutral", 0, 0);
												PLAY_SOUND_FRONTEND(-1, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", 1);
												iLocal_3206 = -1;
											}
											if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_3208) > 0.85f)
											{
												DISPLAY_HUD(1);
												DISPLAY_RADAR(1);
												RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
												...
												if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
												{
													TASK_LEAVE_VEHICLE(PLAYER_PED_ID(), GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0);
				...
				if (iLocal_3476 == 1)
				{
					...
					if (iLocal_3552 == 0)
					{
						if (DOES_ENTITY_EXIST(iLocal_3222))
						{
							if (!IS_PED_INJURED(iLocal_3222))
							{
								if (IS_ENTITY_AT_COORD(iLocal_3222, -935.3f, -2927.3f, 13f, 1.5f, 1.5f, 2f, 0, 1, 0))
								{
									PLAY_SOUND_FROM_COORD(-1, "Trevor_4_747_Molly_Open_Doors", -935.1f, -2927.6f, 13.2f, 0, 0, 0, 0);
									iLocal_3552 = 1;
								}
							}
						}
				...
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -929.7908f, -2928.213f, 12.19499f, -935.7283f, -2924.685f, 15.44832f, 4.75f, 0, 1, 1))
				{
					if (iLocal_3468 == 0)
					{
						if (!IS_PED_INJURED(iLocal_3222))
...
void func_247()
{
	if (iLocal_3433 == 0)
	{
		if (DOES_ENTITY_EXIST(iLocal_3121[14]))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_3121[14], 0))
			{
				iLocal_3248 = GET_PED_IN_VEHICLE_SEAT(iLocal_3121[14], -1, 0);
				GIVE_WEAPON_TO_PED(iLocal_3248, joaat("weapon_pistol"), 1000, 1, 1);
				SET_ENTITY_AS_MISSION_ENTITY(iLocal_3248, 1, 0);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_3248, 1);
				SET_PED_ACCURACY(iLocal_3248, 5);
				SET_ENTITY_HEALTH(iLocal_3248, 150, 0);
	...
	else if (iLocal_3432 == 0)
	{
		if (DOES_ENTITY_EXIST(iLocal_3248))
		{
			if (!IS_PED_INJURED(iLocal_3248))
			{
				CLEAR_PED_TASKS(iLocal_3248);
				SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_3248, GET_ENTITY_COORDS(iLocal_3248, 1), 5f, 0, 0);
				OPEN_SEQUENCE_TASK(&uLocal_3292);
				TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
				TASK_SEEK_COVER_FROM_PED(0, PLAYER_PED_ID(), 5000, 1);
				TASK_COMBAT_PED(0, PLAYER_PED_ID(), 0, 16);
				CLOSE_SEQUENCE_TASK(uLocal_3292);
				TASK_PERFORM_SEQUENCE(iLocal_3248, uLocal_3292);
				CLEAR_SEQUENCE_TASK(&uLocal_3292);
				iLocal_3432 = 1;
			}
		}
	...
	else if (iLocal_3489 == 0)
	{
		if (DOES_ENTITY_EXIST(iLocal_3248))
		{
			if (!IS_PED_INJURED(iLocal_3248))
			{
				if (!IS_PED_IN_ANY_VEHICLE(iLocal_3248, 0) && func_13(PLAYER_PED_ID(), iLocal_3248) < 20f)
				{
					if (!func_257())
					{
...
void func_260(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7, bool bParam8)
{
	...
	if (!IS_ENTITY_DEAD(uParam0, 0))
	{
		...
		if (bParam8)
		{
			vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, vParam1) };
		}
		else
		{
			vVar0 = { vParam1 };
		...
		APPLY_FORCE_TO_ENTITY(uParam0, 3, vVar6, vParam4, 0, 0, 1, 1, 0, 1);
	}
}
...
void func_262(var uParam0, float fParam1)
{
	...
	if (iLocal_1956 < 15)
	{
		...
		if (IS_VEHICLE_DRIVEABLE(uParam0, 0))
		{
			if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uParam0))
			{
				...
				vVar1 = { _0x92523B76657A517D(uVar0, (fParam1 + (TO_FLOAT((iLocal_1956 - 1)) * 2000f))) };
	...
	else if (!bLocal_106)
	{
		...
		SET_ROADS_IN_AREA(vLocal_2650, vLocal_2653, 0, 0);
		iLocal_1956 = 0;
	}
}
...
void func_264()
{
	if (iLocal_3333 == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_3258))
		{
			if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
			{
				if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 55000f)
				{
					...
					if ((HAS_MODEL_LOADED(joaat("firetruk")) && HAS_MODEL_LOADED(joaat("s_m_y_fireman_01"))) && HAS_ANIM_DICT_LOADED("missheist_agency3aig_lift_waitped_a"))
					{
						if (!DOES_ENTITY_EXIST(uLocal_3264))
						{
							CLEAR_AREA(-1129.566f, -2319.888f, 12.9445f, 10f, 0, 0, 0, 0);
							uLocal_3264 = CREATE_VEHICLE(joaat("firetruk"), -1129.566f, -2319.888f, 12.9445f, 16.5423f, 1, 1, 0);
						}
						uLocal_3755[0] = START_PARTICLE_FX_LOOPED_AT_COORD("scr_trev4_trailer_fire", -1151f, -2311f, 15f, 0f, 0f, 0f, 1065353216, 0, 0, 0, 0);
						if (iLocal_3388 == 0)
						{
							PLAY_SOUND_FROM_COORD(uLocal_3217, "Trevor_4_747_Loud_Fire", -1151f, -2311f, 15f, 0, 0, 0, 0);
							iLocal_3388 = 1;
						}
						uLocal_3755[1] = START_PARTICLE_FX_LOOPED_AT_COORD("scr_trev4_trailer_fire", -1140f, -2328f, 18f, 0f, 0f, 0f, 1065353216, 0, 0, 0, 0);
						uLocal_3755[2] = START_PARTICLE_FX_LOOPED_AT_COORD("scr_trev4_trailer_fire", -1150f, -2327f, 19f, 0f, 0f, 0f, 1065353216, 0, 0, 0, 0);
						if (!DOES_ENTITY_EXIST(uLocal_3223[0]))
						{
							uLocal_3223[0] = CREATE_PED_INSIDE_VEHICLE(uLocal_3264, 21, joaat("s_m_y_fireman_01"), -1, 1, 1);
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3223[0], 1);
							SET_PED_KEEP_TASK(uLocal_3223[0], 1);
							TASK_VEHICLE_SHOOT_AT_COORD(uLocal_3223[0], -1147.07f, -2320.65f, 18.93f, 1101004800);
						}
						if (!DOES_ENTITY_EXIST(uLocal_3223[1]))
						{
							uLocal_3223[1] = CREATE_PED(21, joaat("s_m_y_fireman_01"), -1138.313f, -2313.277f, 12.9445f, 155.4271f, 1, 1);
							TASK_PLAY_ANIM(uLocal_3223[1], "missheist_agency3aig_lift_waitped_a", "idle_b", 8f, -8f, -1, 9, 0, 0, 0, 0);
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3223[1], 1);
							SET_PED_KEEP_TASK(uLocal_3223[1], 1);
						}
						if (!DOES_ENTITY_EXIST(uLocal_3223[2]))
						{
							uLocal_3223[2] = CREATE_PED(21, joaat("s_m_y_fireman_01"), -1145.362f, -2309.387f, 12.9445f, 96.0786f, 1, 1);
							TASK_PLAY_ANIM(uLocal_3223[2], "missheist_agency3aig_lift_waitped_a", "idle_a", 8f, -8f, -1, 9, 0, 0, 0, 0);
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3223[2], 1);
							SET_PED_KEEP_TASK(uLocal_3223[2], 1);
						}
						if (!DOES_ENTITY_EXIST(uLocal_3223[3]))
						{
							uLocal_3223[3] = CREATE_PED(21, joaat("s_m_y_fireman_01"), -1147.461f, -2314.511f, 13.1518f, 57.8707f, 1, 1);
							TASK_PLAY_ANIM(uLocal_3223[3], "missheist_agency3aig_lift_waitped_a", "idle_c", 8f, -8f, -1, 9, 0, 0, 0, 0);
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3223[3], 1);
							SET_PED_KEEP_TASK(uLocal_3223[3], 1);
						}
	...
	if (iLocal_3333 == 1)
	{
		if (iLocal_3543[0] == 0)
		{
			if (DOES_ENTITY_EXIST(uLocal_3223[1]))
			{
				if (!IS_PED_INJURED(uLocal_3223[1]))
				{
					if (iLocal_3547[0] == 0)
					{
						if (IS_ENTITY_PLAYING_ANIM(uLocal_3223[1], "missheist_agency3aig_lift_waitped_a", "idle_b", 3))
						{
							iLocal_3547[0] = 1;
						}
					}
					if (iLocal_3547[0] == 1)
					{
						if (!IS_ENTITY_PLAYING_ANIM(uLocal_3223[1], "missheist_agency3aig_lift_waitped_a", "idle_b", 3))
						{
							TASK_COWER(uLocal_3223[1], -1);
							SET_PED_KEEP_TASK(uLocal_3223[1], 1);
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3223[1], 0);
							iLocal_3543[0] = 1;
						}
					}
				}
		...
		if (iLocal_3543[1] == 0)
		{
			if (DOES_ENTITY_EXIST(uLocal_3223[2]))
			{
				if (!IS_PED_INJURED(uLocal_3223[2]))
				{
					if (iLocal_3547[1] == 0)
					{
						if (IS_ENTITY_PLAYING_ANIM(uLocal_3223[2], "missheist_agency3aig_lift_waitped_a", "idle_a", 3))
						{
							iLocal_3547[1] = 1;
						}
					}
					if (iLocal_3547[1] == 1)
					{
						if (!IS_ENTITY_PLAYING_ANIM(uLocal_3223[2], "missheist_agency3aig_lift_waitped_a", "idle_a", 3))
						{
							TASK_COWER(uLocal_3223[2], -1);
							SET_PED_KEEP_TASK(uLocal_3223[2], 1);
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3223[2], 0);
							iLocal_3543[1] = 1;
						}
					}
				}
		...
		if (iLocal_3543[2] == 0)
		{
			if (DOES_ENTITY_EXIST(uLocal_3223[3]))
			{
				if (!IS_PED_INJURED(uLocal_3223[3]))
				{
					if (iLocal_3547[2] == 0)
					{
						if (IS_ENTITY_PLAYING_ANIM(uLocal_3223[3], "missheist_agency3aig_lift_waitped_a", "idle_c", 3))
						{
							iLocal_3547[2] = 1;
						}
					}
					if (iLocal_3547[2] == 1)
					{
						if (!IS_ENTITY_PLAYING_ANIM(uLocal_3223[3], "missheist_agency3aig_lift_waitped_a", "idle_c", 3))
						{
							TASK_COWER(uLocal_3223[3], -1);
							SET_PED_KEEP_TASK(uLocal_3223[3], 1);
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3223[3], 0);
							iLocal_3543[2] = 1;
						}
					}
				}
	...
	if (iLocal_3434 == 0)
	{
		...
		if (HAS_MODEL_LOADED(joaat("police3")) && HAS_MODEL_LOADED(joaat("s_m_y_cop_01")))
		{
			if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
			{
				if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
				{
					if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 15500f)
					{
						SET_PLAYER_WANTED_LEVEL(PLAYER_ID(), 2, 0);
						SET_PLAYER_WANTED_LEVEL_NOW(PLAYER_ID(), 0);
						uLocal_3272[0] = CREATE_VEHICLE(joaat("police3"), -847.2593f, -2379.987f, 15.9304f, 196.4921f, 1, 1, 0);
						uLocal_3251[0] = CREATE_PED_INSIDE_VEHICLE(uLocal_3272[0], 6, joaat("s_m_y_cop_01"), -1, 1, 1);
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3251[0], 1);
						_DYNAMIC_MIXER_RELATED_FN(uLocal_3272[0], "SOL_3_POLICE_CARS_Group", 0);
						func_126(uLocal_3251[0], 0);
						SET_VEHICLE_ENGINE_ON(uLocal_3272[0], 1, 1, 0);
						START_PLAYBACK_RECORDED_VEHICLE(uLocal_3272[0], 1, "BB_AIChase", 1);
						GIVE_WEAPON_TO_PED(uLocal_3251[0], joaat("weapon_pistol"), 1000, 1, 1);
						SET_VEHICLE_SIREN(uLocal_3272[0], 1);
	...
	if (iLocal_3434 == 1)
	{
		if (iLocal_3480[0] == 0)
		{
			if (DOES_ENTITY_EXIST(uLocal_3272[0]))
			{
				if (IS_VEHICLE_DRIVEABLE(uLocal_3272[0], 0))
				{
					if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3272[0]))
					{
						SET_PLAYBACK_SPEED(uLocal_3272[0], fLocal_3323);
						if (GET_TIME_POSITION_IN_RECORDING(uLocal_3272[0]) > 13000f)
						{
							STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_3272[0]);
						}
					}
					else if (DOES_ENTITY_EXIST(uLocal_3251[0]))
					{
						if (!IS_PED_INJURED(uLocal_3251[0]))
						{
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_3251[0], 1);
							if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
							{
								TASK_VEHICLE_CHASE(uLocal_3251[0], PLAYER_PED_ID());
								SET_PED_KEEP_TASK(uLocal_3251[0], 1);
							}
							else
							{
								TASK_COMBAT_PED(uLocal_3251[0], PLAYER_PED_ID(), 0, 16);
								SET_PED_KEEP_TASK(uLocal_3251[0], 1);
							}
							REMOVE_VEHICLE_RECORDING(1, "BB_AIChase");
							iLocal_3196 = GET_GAME_TIMER();
							iLocal_3480[0] = 1;
						}
					}
				}
		...
		if (iLocal_3483[0] == 0)
		{
			if (iLocal_3480[0] == 1)
			{
				if (GET_GAME_TIMER() > iLocal_3196 + 500)
				{
					if (DOES_ENTITY_EXIST(uLocal_3251[0]))
					{
						if (!IS_PED_INJURED(uLocal_3251[0]))
						{
							if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
							{
								SET_TASK_VEHICLE_CHASE_BEHAVIOR_FLAG(uLocal_3251[0], 16, 1);
								SET_TASK_VEHICLE_CHASE_BEHAVIOR_FLAG(uLocal_3251[0], 1, 1);
								iLocal_3483[0] = 1;
							}
							else
							{
...
void func_266()
{
	if (!iLocal_3335)
	{
		if (IS_VEHICLE_DRIVEABLE(iLocal_3121[20], 0))
		{
			uLocal_3289 = CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 0);
			SET_CAM_ACTIVE(uLocal_3289, 1);
			iLocal_3336 = 0;
			iLocal_3335 = 1;
		}
	}
	else if (func_281(&uLocal_28, 1, 0, 0) && iLocal_3437 == 0)
	{
		...
		if (iLocal_3365[2] == 0)
		{
			...
			PLAY_SOUND_FRONTEND(uLocal_3219, "Trevor_4_747_TV", 0, 1);
			iLocal_3365[2] = 1;
		}
		func_272(1, 1, 30, 5, 0);
		if (iLocal_3354 == 0)
		{
			BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_3293, "SET_TEXT");
			func_271("TRV4_NEWS1");
			func_271("");
		...
		if (iLocal_3355 == 0)
		{
			BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_3293, "SET_SCROLL_TEXT");
			...
			END_SCALEFORM_MOVIE_METHOD();
			BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_3293, "DISPLAY_SCROLL_TEXT");
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(1f);
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(0f);
			END_SCALEFORM_MOVIE_METHOD();
			iLocal_3201 = (GET_GAME_TIMER() - 5000);
			iLocal_3355 = 1;
		}
		if (GET_GAME_TIMER() > iLocal_3201 + 5000)
		{
			func_270();
			iLocal_3201 = GET_GAME_TIMER();
		}
		if (iLocal_3356 == 0)
		{
			if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
			{
				if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
				{
					if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 25000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 50000f)
					{
						BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_3293, "SET_SCROLL_TEXT");
						SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(1f);
						SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(1f);
		...
		if (iLocal_3357 == 0)
		{
			if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
			{
				if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
				{
					if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 77600f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 115000f)
					{
						BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_3293, "SET_SCROLL_TEXT");
						SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(1f);
						SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(2f);
		...
		SET_TEXT_RENDER_ID(uLocal_3184);
		DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_3293, 255, 255, 255, 0, 0);
		if (iLocal_3336 == 0)
		{
			func_225(1, 1, 1, 0);
			SHAKE_CAM(uLocal_3289, "ROAD_VIBRATION_SHAKE", 1f);
			SET_CAM_ACTIVE(uLocal_3289, 1);
			RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
			DISPLAY_RADAR(0);
			SPECIAL_ABILITY_DEACTIVATE(PLAYER_ID());
...
void func_270()
{
	...
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_3186);
	END_SCALEFORM_MOVIE_METHOD();
	iLocal_3186++;
}
...
void func_274(int iParam0)
{
	if (iParam0 < 32)
	{
		SET_BIT(&uLocal_54, iParam0);
	}
}

int func_275(int iParam0)
{
	if (IS_BIT_SET(uLocal_54, iParam0))
	{
		return 1;
	}
	return 0;
...
void func_276(bool bParam0, int iParam1)
{
	...
	else if (bParam0)
	{
		...
		uLocal_45 = GET_RANDOM_INT_IN_RANGE(0, 4);
		...
		if (iLocal_46 == 0)
		{
			...
			{
				DRAW_SPRITE("digitalOverlay", "Static1", 0.5f, 0.5f, (1f * func_277(bLocal_40)), (1f * func_277(bLocal_41)), 0f, 255, 255, 255, iParam1, 0);
			}
		}
		if (iLocal_46 == 1)
		{
			...
			{
				DRAW_SPRITE("digitalOverlay", "Static2", 0.5f, 0.5f, (1f * func_277(bLocal_40)), (1f * func_277(bLocal_41)), 0f, 255, 255, 255, iParam1, 0);
			}
		}
		if (iLocal_46 == 2)
		{
			...
			{
				DRAW_SPRITE("digitalOverlay", "Static3", 0.5f, 0.5f, (1f * func_277(bLocal_40)), (1f * func_277(bLocal_41)), 0f, 255, 255, 255, iParam1, 0);
			}
		}
		if (iLocal_46 == 3)
		{
			...
			{
				DRAW_SPRITE("digitalOverlay", "Static4", 0.5f, 0.5f, (1f * func_277(bLocal_40)), (1f * func_277(bLocal_41)), 0f, 255, 255, 255, iParam1, 0);
			}
		}
		if (iLocal_46 == 4)
		{
			...
			{
				DRAW_SPRITE("digitalOverlay", "Static5", 0.5f, 0.5f, (1f * func_277(bLocal_40)), (1f * func_277(bLocal_41)), 0f, 255, 255, 255, iParam1, 0);
			}
		}
	}
}
...
int func_280()
{
	REQUEST_STREAMED_TEXTURE_DICT("digitalOverlay", 0);
...
int func_281(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_286(bParam1, bParam2, bParam3) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1) || func_283(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
int func_295(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_301() || func_300(Global_4456448.f_161209)) || func_299())
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			iVar1 = func_298(PLAYER_PED_ID(), 0);
			if (((_0xE33FFA906CE74880(uVar0, iVar1) || (GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_297(uVar0, 10)) && GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_296(int iParam0)
{
	if (iParam0 != func_88())
	{
		...
		else if ((Global_1312867 && iParam0 == PLAYER_ID()) && func_180(iParam0, 1, 0))
		{
			return Global_2424047[iParam0 /*416*/].f_309.f_5 != -1;
		}
	}
...
void func_303(var uParam0, var uParam1, float fParam2)
{
	...
	{
		if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uParam1))
		{
			SET_PLAYBACK_SPEED(uParam1, fParam2);
			vVar0 = { GET_ENTITY_COORDS(uParam1, 1) };
			vVar3 = { GET_ENTITY_ROTATION(uParam1, 2) };
			SET_CAM_COORD(uParam0, vVar0);
			SET_CAM_ROT(uParam0, vVar3, 2);
		}
	}
}
...
void func_304(var uParam0, var uParam1, char* sParam2, int iParam3)
{
	...
	if (!IS_ENTITY_DEAD(uParam1, 0))
	{
		...
		SET_ENTITY_COLLISION(uParam1, 0, 0);
		SET_ENTITY_INVINCIBLE(uParam1, 1);
		SET_ENTITY_PROOFS(uParam1, 1, 1, 1, 1, 1, 0, 0, 0);
		START_PLAYBACK_RECORDED_VEHICLE(uParam1, iParam3, sParam2, 1);
		vVar0 = { GET_ENTITY_COORDS(uParam1, 1) };
		SET_CAM_COORD(uParam0, vVar0);
		SET_CAM_ROT(uParam0, GET_ENTITY_ROTATION(uParam1, 2), 2);
	}
}
...
void func_306()
{
	if (DOES_ENTITY_EXIST(iLocal_3121[19]))
	{
		if (!IS_ENTITY_DEAD(iLocal_3121[19], 0))
		{
			if (!IS_VEHICLE_SIREN_ON(iLocal_3121[19]))
			{
				SET_VEHICLE_SIREN(iLocal_3121[19], 1);
			}
		}
	}
	if (DOES_ENTITY_EXIST(iLocal_3121[7]))
	{
		if (!IS_ENTITY_DEAD(iLocal_3121[7], 0))
		{
			...
			{
				SET_VEHICLE_SIREN(iLocal_3121[7], 1);
			}
		}
	}
	if (DOES_ENTITY_EXIST(iLocal_3121[8]))
	{
		if (!IS_ENTITY_DEAD(iLocal_3121[8], 0))
		{
			if (!IS_VEHICLE_SIREN_ON(iLocal_3121[8]))
			{
				SET_VEHICLE_SIREN(iLocal_3121[8], 1);
			}
		}
	}
	if (DOES_ENTITY_EXIST(iLocal_3121[9]))
	{
		if (!IS_ENTITY_DEAD(iLocal_3121[9], 0))
		{
			if (!IS_VEHICLE_SIREN_ON(iLocal_3121[9]))
			{
				SET_VEHICLE_SIREN(iLocal_3121[9], 1);
			}
		}
	}
	if (DOES_ENTITY_EXIST(iLocal_3121[10]))
	{
		if (!IS_ENTITY_DEAD(iLocal_3121[10], 0))
		{
			if (!IS_VEHICLE_SIREN_ON(iLocal_3121[10]))
			{
				SET_VEHICLE_SIREN(iLocal_3121[10], 1);
			}
		}
	}
	if (DOES_ENTITY_EXIST(iLocal_3121[11]))
	{
		if (!IS_ENTITY_DEAD(iLocal_3121[11], 0))
		{
			if (!IS_VEHICLE_SIREN_ON(iLocal_3121[11]))
			{
				SET_VEHICLE_SIREN(iLocal_3121[11], 1);
			}
		}
	}
	if (DOES_ENTITY_EXIST(iLocal_3121[13]))
	{
		if (!IS_ENTITY_DEAD(iLocal_3121[13], 0))
		{
			if (!IS_VEHICLE_SIREN_ON(iLocal_3121[13]))
			{
				SET_VEHICLE_SIREN(iLocal_3121[13], 1);
			}
		}
	}
	if (DOES_ENTITY_EXIST(iLocal_3121[14]))
	{
		if (!IS_ENTITY_DEAD(iLocal_3121[14], 0))
		{
			if (!IS_VEHICLE_SIREN_ON(iLocal_3121[14]))
			{
				SET_VEHICLE_SIREN(iLocal_3121[14], 1);
			}
		}
	}
	if (DOES_ENTITY_EXIST(iLocal_3121[15]))
	{
		if (!IS_ENTITY_DEAD(iLocal_3121[15], 0))
		{
			if (!IS_VEHICLE_SIREN_ON(iLocal_3121[15]))
			{
				SET_VEHICLE_SIREN(iLocal_3121[15], 1);
			}
		}
	}
	if (DOES_ENTITY_EXIST(iLocal_3121[16]))
	{
		if (!IS_ENTITY_DEAD(iLocal_3121[16], 0))
		{
			if (!IS_VEHICLE_SIREN_ON(iLocal_3121[16]))
			{
				SET_VEHICLE_SIREN(iLocal_3121[16], 1);
			}
		}
	}
	if (DOES_ENTITY_EXIST(iLocal_3121[17]))
	{
		if (!IS_ENTITY_DEAD(iLocal_3121[17], 0))
		{
			if (!IS_VEHICLE_SIREN_ON(iLocal_3121[17]))
			{
				SET_VEHICLE_SIREN(iLocal_3121[17], 1);
			}
		}
	}
}
...
void func_307()
{
	...
	{
		if (_GET_VEHICLE_MAX_SPEED(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)) > 40f)
		{
			fLocal_3324 = 0.85f;
		}
		else
	...
	if (!IS_ENTITY_DEAD(uLocal_3258, 0))
	{
		if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
		{
			if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
			{
				if (iLocal_3359 == 0)
				{
					if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 10000f)
					{
						if (func_16(PLAYER_PED_ID(), uLocal_3258, 1) < 100f || IS_ENTITY_ON_SCREEN(uLocal_3258))
						{
							func_334(uLocal_3258, PLAYER_PED_ID(), &fLocal_3323, 1f, 40f, 55f, 100f, 1.7f, 1f, fLocal_3324, 0);
							SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
							func_308(uLocal_3258, fLocal_3323);
						}
						else
						{
							func_334(uLocal_3258, PLAYER_PED_ID(), &fLocal_3323, 0.6f, 40f, 50f, 60f, 1.7f, 1f, fLocal_3324, 0);
							SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
							func_308(uLocal_3258, fLocal_3323);
						}
					}
				}
				else if (func_16(PLAYER_PED_ID(), uLocal_3258, 1) > 175f)
				{
					fLocal_3323 = 0.6f;
					SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
					func_308(uLocal_3258, fLocal_3323);
				}
				else if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 10000f)
				{
					func_334(uLocal_3258, PLAYER_PED_ID(), &fLocal_3323, 1f, 25f, 40f, 180f, 1.7f, 1f, fLocal_3324, 0);
					SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
					func_308(uLocal_3258, fLocal_3323);
				}
				if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 10000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 23000f)
				{
					if (IS_VEHICLE_DRIVEABLE(iLocal_3121[8], 0))
					{
						func_334(iLocal_3121[8], PLAYER_PED_ID(), &fLocal_3323, 1f, 25f, 30f, 50f, 1.7f, 0.5f, fLocal_3324, 1);
						SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
						func_308(uLocal_3258, fLocal_3323);
					}
					else
					{
						func_334(uLocal_3258, PLAYER_PED_ID(), &fLocal_3323, 1f, 25f, 35f, 180f, 1.7f, 0.5f, fLocal_3324, 1);
						SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
						func_308(uLocal_3258, fLocal_3323);
					}
				}
				if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 23000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 32000f)
				{
					if (DOES_ENTITY_EXIST(iLocal_3121[7]))
					{
						if (IS_VEHICLE_DRIVEABLE(iLocal_3121[7], 0))
						{
							func_334(iLocal_3121[7], PLAYER_PED_ID(), &fLocal_3323, 1f, 20f, 30f, 100f, 1.8f, 1f, fLocal_3324, 0);
							SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
							func_308(uLocal_3258, fLocal_3323);
						}
						else if (DOES_ENTITY_EXIST(iLocal_3121[8]))
						{
							if (IS_VEHICLE_DRIVEABLE(iLocal_3121[8], 0))
							{
								func_334(iLocal_3121[8], PLAYER_PED_ID(), &fLocal_3323, 1f, 10f, 20f, 40f, 1.8f, 1f, fLocal_3324, 0);
								SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
								func_308(uLocal_3258, fLocal_3323);
							}
							else
							{
								func_334(uLocal_3258, PLAYER_PED_ID(), &fLocal_3323, 1f, 25f, 40f, 100f, 1.8f, 1f, fLocal_3324, 0);
								SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
								func_308(uLocal_3258, fLocal_3323);
							}
						}
				...
				if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 32000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 39000f)
				{
					if (DOES_ENTITY_EXIST(iLocal_3121[7]))
					{
						if (IS_VEHICLE_DRIVEABLE(iLocal_3121[7], 0))
						{
							func_334(iLocal_3121[7], PLAYER_PED_ID(), &fLocal_3323, 1f, 22f, 25f, 100f, 1.8f, 0.5f, fLocal_3324, 1);
							SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
							func_308(uLocal_3258, fLocal_3323);
						}
						else
						{
							func_334(uLocal_3258, PLAYER_PED_ID(), &fLocal_3323, 1f, 25f, 35f, 150f, 1.8f, 0.5f, fLocal_3324, 1);
							SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
							func_308(uLocal_3258, fLocal_3323);
						}
					}
				...
				if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 39000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 56000f)
				{
					if (IS_VEHICLE_DRIVEABLE(iLocal_3121[8], 0))
					{
						func_334(iLocal_3121[8], PLAYER_PED_ID(), &fLocal_3323, 1f, 25f, 40f, 100f, 1.8f, 1f, fLocal_3324, 0);
						SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
						func_308(uLocal_3258, fLocal_3323);
					}
					else
					{
						func_334(uLocal_3258, PLAYER_PED_ID(), &fLocal_3323, 1f, 25f, 35f, 150f, 1.8f, 1f, fLocal_3324, 0);
						SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
						func_308(uLocal_3258, fLocal_3323);
					}
				}
				if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 56000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 65000f)
				{
					if (IS_VEHICLE_DRIVEABLE(iLocal_3121[11], 0))
					{
						func_334(iLocal_3121[11], PLAYER_PED_ID(), &fLocal_3323, 1f, 25f, 30f, 100f, 1.8f, 1f, fLocal_3324, 0);
						SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
						func_308(uLocal_3258, fLocal_3323);
					}
					else
					{
						func_334(uLocal_3258, PLAYER_PED_ID(), &fLocal_3323, 1f, 25f, 35f, 100f, 1.8f, 1f, fLocal_3324, 0);
						SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
						func_308(uLocal_3258, fLocal_3323);
					}
				}
				if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 65000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 90000f)
				{
					if (DOES_ENTITY_EXIST(iLocal_3121[13]))
					{
						if (IS_VEHICLE_DRIVEABLE(iLocal_3121[13], 0))
						{
							func_334(iLocal_3121[13], PLAYER_PED_ID(), &fLocal_3323, 1f, 30f, 35f, 50f, 1.8f, 1f, fLocal_3324, 0);
							SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
							func_308(uLocal_3258, fLocal_3323);
						}
						else
						{
							func_334(uLocal_3258, PLAYER_PED_ID(), &fLocal_3323, 1f, 45f, 55f, 150f, 1.8f, 1f, fLocal_3324, 0);
							SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
							func_308(uLocal_3258, fLocal_3323);
						}
					}
				...
				if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 90000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 110000f)
				{
					func_334(uLocal_3258, PLAYER_PED_ID(), &fLocal_3323, 1f, 60f, 70f, 150f, 1.5f, 0.5f, fLocal_3324, 1);
					SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
					func_308(uLocal_3258, fLocal_3323);
				}
				if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 110000f)
				{
					func_334(uLocal_3258, PLAYER_PED_ID(), &fLocal_3323, 1f, 100f, 120f, 150f, 1.6f, 1f, fLocal_3324, 0);
					SET_PLAYBACK_SPEED(uLocal_3258, fLocal_3323);
					func_308(uLocal_3258, fLocal_3323);
				}
			}
	...
	if (!bLocal_81)
	{
		...
		if (IS_VEHICLE_DRIVEABLE(uParam0, 0))
		{
			if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uParam0))
			{
				if (IS_PLAYER_PLAYING(PLAYER_ID()))
				{
					if (func_332(PLAYER_PED_ID(), uParam0))
					{
						iLocal_86 = 1;
					}
					else
				...
				fLocal_1275 = GET_TIME_POSITION_IN_RECORDING(uParam0);
				SET_PLAYBACK_SPEED(uParam0, ((fParam1 * fLocal_1276) * fLocal_1278));
				if (bLocal_85)
				{
					...
					{
						iLocal_1962 = 0;
						fLocal_1280 = (fLocal_1280 + (GET_FRAME_TIME() * 1000f));
					}
				}
			}
		}
		...
		if (iLocal_83)
		{
			if (IS_PLAYER_PLAYING(PLAYER_ID()))
			{
				if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
					uLocal_3164 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
					vLocal_2641 = { GET_ENTITY_COORDS(uLocal_3164, 1) };
					GET_ENTITY_QUATERNION(uLocal_3164, &uLocal_989, &uLocal_990, &uLocal_991, &uLocal_992);
				}
			}
			iLocal_83 = 0;
		}
		if (iLocal_82)
		{
			if (DOES_ENTITY_EXIST(uLocal_3164))
			{
				func_200(uLocal_3165);
				uLocal_3165 = uLocal_3164;
			}
			if (IS_VEHICLE_DRIVEABLE(uLocal_3165, 0))
			{
				SET_ENTITY_COORDS(uLocal_3165, vLocal_2641, 1, 0, 0, 1);
				SET_ENTITY_QUATERNION(uLocal_3165, uLocal_989, uLocal_990, uLocal_991, uLocal_992);
			}
...
int func_309(var uParam0, float fParam1)
{
	...
	else
	{
		if (IS_VEHICLE_DRIVEABLE(*uParam0, 0))
		{
			if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(*uParam0))
			{
				SET_PLAYBACK_SPEED(*uParam0, ((1f * fLocal_1276) * fLocal_1278));
		...
		if (HAS_VEHICLE_RECORDING_BEEN_LOADED(iParam1, &cLocal_2668))
		{
			if (IS_VEHICLE_DRIVEABLE(*uParam0, 0))
			{
				if (!IS_PLAYBACK_GOING_ON_FOR_VEHICLE(*uParam0))
				{
					...
					if (bParam4)
					{
						START_PLAYBACK_RECORDED_VEHICLE_USING_AI(*uParam0, iParam1, &cLocal_2668, 1092616192, 786603);
					}
					else
					{
		...
		while (iVar0 < 35)
		{
			if (iLocal_1858[iVar0] != 99)
			{
					...
					if (iLocal_1822[iVar0] > 0)
					{
						if (!iLocal_75)
						{
							if (fLocal_1275 > (fLocal_1137[iVar0] - (7000f * fParam1)))
							{
								...
								{
									SET_BIT(&(iLocal_1894[iVar0]), 0);
								}
								else if (IS_THIS_MODEL_A_BIKE(iLocal_2877[iVar0]))
								{
									SET_BIT(&(iLocal_1894[iVar0]), 2);
								}
								CLEAR_BIT(&(iLocal_1894[iVar0]), 1);
								iLocal_1858[iVar0]++;
								iLocal_1954++;
							}
						}
				...
				else if (iLocal_1858[iVar0] == 1)
				{
					...
					if (IS_BIT_SET(iLocal_1894[iVar0], 0))
					{
						REQUEST_MODEL(func_204());
						bVar14 = HAS_MODEL_LOADED(func_204());
					}
					else if (!bLocal_102 && ((!IS_BIT_SET(iLocal_1894[iVar0], 2) && uVar16) || (IS_BIT_SET(iLocal_1894[iVar0], 2) && uVar17)))
					{
						bVar14 = true;
					}
					else
					{
						REQUEST_MODEL(func_207());
						bVar14 = HAS_MODEL_LOADED(func_207());
					}
					if (bVar14)
					{
						if (!DOES_ENTITY_EXIST(iLocal_3121[iVar0]))
						{
							REQUEST_MODEL(iLocal_2877[iVar0]);
							if (HAS_MODEL_LOADED(iLocal_2877[iVar0]) && HAS_VEHICLE_RECORDING_BEEN_LOADED(iLocal_1822[iVar0], &cLocal_2668))
							{
								if (fLocal_1275 >= (fLocal_1137[iVar0] - (fLocal_1288 * fParam1)))
								{
									if ((iLocal_89 || bParam2) || (!bLocal_106 && !func_321(vLocal_2535[iVar0 /*3*/], vVar9, 5f, fLocal_1286)))
									{
										...
										iLocal_3121[iVar0] = CREATE_VEHICLE(iLocal_2877[iVar0], vLocal_2535[iVar0 /*3*/], 0, 0, 0, 0);
										if (iLocal_2877[iVar0] == joaat("polmav"))
										{
											SET_VEHICLE_LIVERY(iLocal_3121[iVar0], 0);
										}
										if (uLocal_98 && !IS_BIT_SET(iLocal_1894[iVar0], 0))
										{
											func_319(iLocal_3121[iVar0]);
										}
										if (IS_BIT_SET(iLocal_1894[iVar0], 3))
										{
											_SET_ENTITY_SOMETHING(iLocal_3121[iVar0], 1);
										}
										...
										{
											SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_3121[iVar0], 1084227584);
										}
										if (!IS_BIT_SET(iLocal_1894[iVar0], 0))
										{
											SET_VEHICLE_ENGINE_ON(iLocal_3121[iVar0], 1, 1, 0);
											if (GET_CLOCK_HOURS() > 19 || GET_CLOCK_HOURS() < 7)
											{
												SET_VEHICLE_LIGHTS(iLocal_3121[iVar0], 3);
											}
										}
										FREEZE_ENTITY_POSITION(iLocal_3121[iVar0], 1);
										SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_2877[iVar0]);
						...
						else if (!IS_ENTITY_DEAD(iLocal_3121[iVar0], 0) && IS_VEHICLE_DRIVEABLE(iLocal_3121[iVar0], 0))
						{
							SET_ENTITY_COORDS_NO_OFFSET(iLocal_3121[iVar0], vLocal_2535[iVar0 /*3*/], 0, 0, 1);
							SET_ENTITY_QUATERNION(iLocal_3121[iVar0], fLocal_993[iVar0], fLocal_1029[iVar0], fLocal_1065[iVar0], fLocal_1101[iVar0]);
							if (IS_THIS_MODEL_A_CAR(iLocal_2877[iVar0]) || IS_THIS_MODEL_A_BIKE(iLocal_2877[iVar0]))
				...
				{
					REQUEST_VEHICLE_RECORDING(iLocal_1822[iVar0], &cLocal_2668);
					if (!IS_BIT_SET(iLocal_1894[iVar0], 1))
					{
						bVar14 = false;
						if (IS_BIT_SET(iLocal_1894[iVar0], 0))
						{
						...
						if (!IS_ENTITY_DEAD(iLocal_3121[iVar0], 0))
						{
							if (!bLocal_106 && IS_VEHICLE_SEAT_FREE(iLocal_3121[iVar0], -1, 0))
							{
								if (bVar14)
								{
									if ((VDIST2(GET_ENTITY_COORDS(iLocal_3121[iVar0], 1), vVar9) < 10000f || bParam2) || iLocal_89)
									{
										func_317(&(iLocal_3121[iVar0]), iVar19, 1);
										SET_BIT(&(iLocal_1894[iVar0]), 1);
									}
								}
							}
						}
						...
						if (fLocal_1275 >= fLocal_1137[iVar0])
						{
							if (14 > iLocal_1947)
							{
								...
								if (HAS_VEHICLE_RECORDING_BEEN_LOADED(iLocal_1822[iVar0], &cLocal_2668))
								{
									...
									{
										vVar3 = { GET_ENTITY_COORDS(iLocal_3121[iVar0], 1) };
										...
										else if (((!bLocal_106 || IS_BIT_SET(iLocal_1894[iVar0], 1)) || iLocal_89) || bParam2)
										{
											if (func_310(&(iLocal_3121[iVar0]), iLocal_1822[iVar0], fVar12, 1, 0, 0, bLocal_104, bLocal_103))
											{
												...
												if (IS_VEHICLE_DRIVEABLE(iLocal_3121[iVar0], 0))
												{
													...
													{
														SET_VEHICLE_ENGINE_ON(iLocal_3121[iVar0], 1, 1, 0);
														SET_VEHICLE_SIREN(iLocal_3121[iVar0], 1);
				...
				else if (iLocal_1858[iVar0] == 3)
				{
					if (IS_VEHICLE_DRIVEABLE(iLocal_3121[iVar0], 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3121[iVar0]))
						{
							uVar1 = GET_PED_IN_VEHICLE_SEAT(iLocal_3121[iVar0], -1, 0);
							if (!IS_PED_INJURED(uVar1))
							{
								if (bVar15)
								{
									if (((!bLocal_79 && !iLocal_76) && !bLocal_95) && (((!bLocal_104 && !bLocal_103) && IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), iLocal_3121[iVar0])) || func_316(iLocal_3121[iVar0])))
									{
				...
				else if (iLocal_1858[iVar0] == 5)
				{
					if (!iLocal_3121[iVar0] == iLocal_3166)
					{
						...
						else if (DOES_ENTITY_EXIST(iLocal_3121[iVar0]))
						{
							DELETE_VEHICLE(&(iLocal_3121[iVar0]));
						}
					}
...
int func_317(var uParam0, int iParam1, bool bParam2)
{
	...
	if (!IS_ENTITY_DEAD(*uParam0, 0))
	{
		if (IS_VEHICLE_SEAT_FREE(*uParam0, -1, 0))
		{
			if (iParam1 == 2)
			{
				iVar0 = CREATE_PED_INSIDE_VEHICLE(*uParam0, 6, func_204(), -1, 0, 0);
				SET_PED_RELATIONSHIP_GROUP_HASH(iVar0, uLocal_2684);
				SET_MODEL_AS_NO_LONGER_NEEDED(func_204());
			}
			else if (iParam1 == 1)
			{
			...
			{
				iVar0 = CREATE_PED_INSIDE_VEHICLE(*uParam0, 4, func_207(), -1, 0, 0);
				if (bLocal_107)
				{
					SET_MODEL_AS_NO_LONGER_NEEDED(func_207());
				}
...
float func_322(var uParam0)
{
	...
	REQUEST_VEHICLE_RECORDING(uParam0, &cLocal_2668);
	while (!HAS_VEHICLE_RECORDING_BEEN_LOADED(uParam0, &cLocal_2668))
	{
		WAIT(0);
	}
	uVar0 = GET_TOTAL_DURATION_OF_VEHICLE_RECORDING(uParam0, &cLocal_2668);
	REMOVE_VEHICLE_RECORDING(uParam0, &cLocal_2668);
	return uVar0;
}
		...
		while (iVar0 < 15)
		{
			switch (iLocal_1930[iVar0])
			{
				case 0:
					if (!iLocal_2861[iVar0] == 0)
					{
						if (IS_ENTITY_AT_COORD(uParam0, vLocal_2489[iVar0 /*3*/], fLocal_1273, fLocal_1273, fLocal_1273, 0, 1, 0))
						{
							iLocal_1953++;
							iLocal_1930[iVar0]++;
						}
				...
				case 1:
					if (6 > iLocal_1948)
					{
						if (!DOES_ENTITY_EXIST(iLocal_3105[iVar0]))
						{
							REQUEST_MODEL(iLocal_2861[iVar0]);
							if (HAS_MODEL_LOADED(iLocal_2861[iVar0]))
							{
								if ((iLocal_75 || iLocal_89) || (!bLocal_106 && !func_321(vLocal_2489[iVar0 /*3*/], vVar1, 5f, fLocal_1286)))
								{
									...
									iLocal_3105[iVar0] = CREATE_VEHICLE(iLocal_2861[iVar0], vLocal_2489[iVar0 /*3*/], 0, 0, 0, 0);
									if (iLocal_2861[iVar0] == joaat("polmav"))
									{
										SET_VEHICLE_LIVERY(iLocal_3105[iVar0], 0);
									}
									SET_ENTITY_QUATERNION(iLocal_3105[iVar0], fLocal_1209[iVar0], fLocal_1225[iVar0], fLocal_1241[iVar0], fLocal_1257[iVar0]);
									SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_2861[iVar0]);
									if (IS_VEHICLE_MODEL(iLocal_3105[iVar0], func_205()))
									{
										SET_VEHICLE_SIREN(iLocal_3105[iVar0], 1);
										if (!IS_THIS_MODEL_A_BIKE(iLocal_2861[iVar0]))
										{
											SET_SIREN_WITH_NO_DRIVER(iLocal_3105[iVar0], 1);
										}
									}
									if (IS_VEHICLE_MODEL(iLocal_3105[iVar0], func_206()))
									{
										SET_VEHICLE_COLOURS(iLocal_3105[iVar0], 0, 0);
									}
									_SET_ENTITY_SOMETHING(iLocal_3105[iVar0], 1);
				...
				case 2:
					if (!bVar7)
					{
						...
						{
							vVar4 = { GET_ENTITY_COORDS(iLocal_3105[iVar0], 1) };
						}
		...
		while (iVar0 < 175 && !bVar23)
		{
			if (iLocal_1470[iVar0] != 99)
			{
						...
						if (!iLocal_75)
						{
							if (fLocal_1275 < (fLocal_813[iVar0] + 20000f))
							{
								if (fLocal_1275 >= (fLocal_813[iVar0] - (7000f * fParam1)))
								{
									...
									{
										SET_BIT(&(iLocal_1646[iVar0]), 0);
									}
									else if (IS_THIS_MODEL_A_BIKE(iLocal_2685[iVar0]))
									{
										SET_BIT(&(iLocal_1646[iVar0]), 2);
									}
									CLEAR_BIT(&(iLocal_1646[iVar0]), 1);
									iLocal_1955++;
									iLocal_1470[iVar0]++;
								}
								else if (iVar1 > 2)
				...
				else if (iLocal_1470[iVar0] == 1)
				{
					...
					bVar17 = false;
					if (IS_BIT_SET(iLocal_1646[iVar0], 0))
					{
						REQUEST_MODEL(func_204());
						if (HAS_MODEL_LOADED(func_204()))
						{
							bVar17 = true;
						}
					}
					else if (!bLocal_102 && ((!IS_BIT_SET(iLocal_1646[iVar0], 2) && uVar19) || (IS_BIT_SET(iLocal_1646[iVar0], 2) && uVar20)))
					{
						bVar17 = true;
					}
					else
					{
						REQUEST_MODEL(func_207());
						bVar17 = HAS_MODEL_LOADED(func_207());
					}
					if (!DOES_ENTITY_EXIST(iLocal_2916[iVar0]))
					{
						REQUEST_MODEL(iLocal_2685[iVar0]);
						if ((HAS_MODEL_LOADED(iLocal_2685[iVar0]) && HAS_VEHICLE_RECORDING_BEEN_LOADED(iLocal_1294[iVar0], &cLocal_2668)) && bVar17)
						{
							if (fLocal_1275 >= (fLocal_813[iVar0] - (fLocal_1288 * fParam1)))
							{
								if ((iLocal_89 || iParam2) || (!bLocal_106 && !func_321(vLocal_1963[iVar0 /*3*/], vVar12, 5f, fLocal_1286)))
								{
									...
									iLocal_2916[iVar0] = CREATE_VEHICLE(iLocal_2685[iVar0], vLocal_1963[iVar0 /*3*/], 0, 0, 0, 0);
									if (iLocal_2685[iVar0] == joaat("polmav"))
									{
										SET_VEHICLE_LIVERY(iLocal_2916[iVar0], 0);
									}
									if (uLocal_98 && !IS_BIT_SET(iLocal_1646[iVar0], 0))
									{
									...
									{
										SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_2916[iVar0], 1084227584);
									}
									if (IS_BIT_SET(iLocal_1646[iVar0], 3))
									{
										_SET_ENTITY_SOMETHING(iLocal_2916[iVar0], 1);
									}
									if (!IS_BIT_SET(iLocal_1646[iVar0], 0))
									{
										SET_VEHICLE_ENGINE_ON(iLocal_2916[iVar0], 1, 1, 0);
										if (GET_CLOCK_HOURS() > 19 || GET_CLOCK_HOURS() < 7)
										{
											SET_VEHICLE_LIGHTS(iLocal_2916[iVar0], 3);
										}
									}
									FREEZE_ENTITY_POSITION(iLocal_2916[iVar0], 1);
									SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_2916[iVar0], 1);
									SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_2685[iVar0]);
				...
				else if (iLocal_1470[iVar0] == 2)
				{
					...
					{
						if (!IS_BIT_SET(iLocal_1646[iVar0], 1))
						{
							if (IS_BIT_SET(iLocal_1646[iVar0], 0))
							{
								REQUEST_MODEL(func_204());
								bVar17 = HAS_MODEL_LOADED(func_204());
								iVar21 = 2;
							}
							else if (!bLocal_102 && ((!IS_BIT_SET(iLocal_1646[iVar0], 2) && uVar19) || (IS_BIT_SET(iLocal_1646[iVar0], 2) && uVar20)))
							{
							...
							if (!IS_ENTITY_DEAD(iLocal_2916[iVar0], 0))
							{
								if (!bLocal_106 && IS_VEHICLE_SEAT_FREE(iLocal_2916[iVar0], -1, 0))
								{
									if (bVar17)
									{
										if ((VDIST2(GET_ENTITY_COORDS(iLocal_2916[iVar0], 1), vVar12) < 10000f || iParam2) || iLocal_89)
										{
											func_317(&(iLocal_2916[iVar0]), iVar21, 0);
											SET_BIT(&(iLocal_1646[iVar0]), 1);
										}
									}
								}
							}
							...
							if (fLocal_1275 >= fLocal_813[iVar0])
							{
								if (12 > iLocal_1946)
								{
									...
									if (HAS_VEHICLE_RECORDING_BEEN_LOADED(iLocal_1294[iVar0], &cLocal_2668))
									{
										...
										{
											vVar6 = { GET_ENTITY_COORDS(iLocal_2916[iVar0], 1) };
											...
											else if (((!bLocal_106 || IS_BIT_SET(iLocal_1646[iVar0], 1)) || iLocal_89) || iParam2)
											{
				...
				else if (iLocal_1470[iVar0] == 3)
				{
					if (IS_VEHICLE_DRIVEABLE(iLocal_2916[iVar0], 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_2916[iVar0]))
						{
							uVar4 = GET_PED_IN_VEHICLE_SEAT(iLocal_2916[iVar0], -1, 0);
							if (!IS_PED_INJURED(uVar4))
							{
								if (bVar18)
								{
									...
									if (!bLocal_84)
									{
										...
										else if (((!bLocal_99 && !IS_BIT_SET(iLocal_1646[iVar0], 4)) && iVar2 < 3) && (iVar0 > iLocal_1960 || iLocal_1960 == 0))
										{
											vVar25 = { GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(uParam0, GET_ENTITY_COORDS(iLocal_2916[iVar0], 1)) };
											if (vVar25.y < 0f)
											{
...
void func_327(int iParam0, float fParam1)
{
	...
	if (!IS_ENTITY_DEAD(iLocal_2916[iParam0], 0))
	{
		SET_ENTITY_COLLISION(iLocal_2916[iParam0], 1, 0);
		FREEZE_ENTITY_POSITION(iLocal_2916[iParam0], 0);
		iVar0 = GET_PED_IN_VEHICLE_SEAT(iLocal_2916[iParam0], -1, 0);
		if (!IS_PED_INJURED(iVar0) && iVar0 != PLAYER_PED_ID())
		{
			...
			TASK_VEHICLE_MISSION(iVar0, iLocal_2916[iParam0], 0, 1, fParam1, 786603, 5f, 5f, 1);
			SET_PED_FLEE_ATTRIBUTES(iVar0, 8192, 1);
			if (bLocal_108)
			{
				SET_PED_FLEE_ATTRIBUTES(iVar0, 65536, 1);
	...
	else
	{
		...
		if (DOES_ENTITY_EXIST(iLocal_2916[iParam0]))
		{
	...
	if (!IS_ENTITY_DEAD(uParam0, 0) && IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uParam0))
	{
		...
		if (fVar1 < (fParam1 + 25000f))
		{
			...
			if (fVar1 <= GET_TOTAL_DURATION_OF_VEHICLE_RECORDING_ID(uVar0))
			{
				if (iLocal_1956 == 0)
				{
					vLocal_2656 = { _0x92523B76657A517D(uVar0, fLocal_1289) };
					iLocal_1956++;
				}
				else if (iLocal_1956 == 1)
				{
					vLocal_2659 = { _0x92523B76657A517D(uVar0, fVar1) };
					iLocal_1956++;
				}
				else if (!bLocal_106)
				{
					...
					vLocal_2659 = { vLocal_2659 + Vector(fLocal_1293, fLocal_1293, fLocal_1293) };
					SET_ROADS_IN_AREA(vLocal_2656, vLocal_2659, 0, 0);
					fLocal_1289 = fVar1;
					iLocal_1956 = 0;
				}
			}
		...
		if (fVar2 < (fParam1 - 8000f))
		{
			...
			if (iLocal_1959 == 0)
			{
				vLocal_2662 = { _0x92523B76657A517D(uVar0, fLocal_1290) };
				iLocal_1959++;
			}
			else if (iLocal_1959 == 1)
			{
				vLocal_2665 = { _0x92523B76657A517D(uVar0, fVar2) };
				iLocal_1959++;
			}
...
int func_338()
{
	...
	{
		if (DOES_ENTITY_EXIST(iLocal_3121[iLocal_3190]))
		{
...
void func_339()
{
	...
	if (DOES_ENTITY_EXIST(iLocal_3121[4]))
	{
		if (IS_VEHICLE_DRIVEABLE(iLocal_3121[4], 0))
		{
			if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_3121[4]))
			{
				vLocal_3303 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
				vVar3 = { GET_ENTITY_COORDS(iLocal_3121[4], 1) };
	...
	if (DOES_ENTITY_EXIST(iLocal_3121[3]))
	{
		if (IS_VEHICLE_DRIVEABLE(iLocal_3121[3], 0))
		{
			...
			{
				vLocal_3303 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
				vVar0 = { GET_ENTITY_COORDS(iLocal_3121[3], 1) };
	...
	if (DOES_ENTITY_EXIST(iLocal_3121[21]))
	{
		if (IS_VEHICLE_DRIVEABLE(iLocal_3121[21], 0))
		{
			...
			{
				vLocal_3303 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
				vVar6 = { GET_ENTITY_COORDS(iLocal_3121[21], 1) };
		...
		if (IS_VEHICLE_DRIVEABLE(iLocal_3121[0], 0))
		{
			if (DOES_ENTITY_EXIST(uLocal_3258))
			{
				if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
				{
					if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
					{
						if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 50000f && !IS_ENTITY_ON_SCREEN(iLocal_3121[0]))
						{
	...
	if (DOES_ENTITY_EXIST(uLocal_3264))
	{
		if (IS_VEHICLE_DRIVEABLE(uLocal_3264, 0))
		{
			if (DOES_ENTITY_EXIST(uLocal_3258))
			{
				if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
				{
					if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
					{
						if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 90000f && !IS_ENTITY_ON_SCREEN(uLocal_3264))
						{
							STOP_PARTICLE_FX_LOOPED(uLocal_3755[0], 0);
							STOP_PARTICLE_FX_LOOPED(uLocal_3755[1], 0);
							STOP_PARTICLE_FX_LOOPED(uLocal_3755[2], 0);
							if (DOES_ENTITY_EXIST(uLocal_3223[0]))
							{
								SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3223[0]));
							}
							if (DOES_ENTITY_EXIST(uLocal_3223[1]))
							{
								SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3223[1]));
							}
							if (DOES_ENTITY_EXIST(uLocal_3223[2]))
							{
								SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3223[2]));
							}
							if (DOES_ENTITY_EXIST(uLocal_3223[3]))
							{
								SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3223[3]));
							}
							SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_3264);
							REMOVE_ANIM_DICT("missheist_agency3aig_lift_waitped_a");
						}
					}
				}
...
void func_341()
{
	if (DOES_ENTITY_EXIST(iLocal_3121[2]))
	{
		if (IS_VEHICLE_DRIVEABLE(iLocal_3121[2], 0))
		{
			if (DOES_ENTITY_EXIST(uLocal_3258))
			{
				if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
				{
					if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
					{
						if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 50530f)
						{
							if (!GET_IS_VEHICLE_ENGINE_RUNNING(iLocal_3121[2]))
							{
								SET_VEHICLE_ENGINE_ON(iLocal_3121[2], 1, 1, 0);
							}
						}
						else if (GET_IS_VEHICLE_ENGINE_RUNNING(iLocal_3121[2]))
						{
							SET_VEHICLE_ENGINE_ON(iLocal_3121[2], 0, 0, 0);
						}
					}
				}
			}
	...
	if (DOES_ENTITY_EXIST(iLocal_3121[5]))
	{
		if (IS_VEHICLE_DRIVEABLE(iLocal_3121[5], 0))
		{
			if (!GET_IS_VEHICLE_ENGINE_RUNNING(iLocal_3121[5]))
			{
				SET_VEHICLE_ENGINE_ON(iLocal_3121[5], 1, 1, 0);
			}
		}
	}
	if (DOES_ENTITY_EXIST(uLocal_3260[0]))
	{
		if (IS_VEHICLE_DRIVEABLE(uLocal_3260[0], 0))
		{
			if (!GET_IS_VEHICLE_ENGINE_RUNNING(uLocal_3260[0]))
			{
				SET_VEHICLE_ENGINE_ON(uLocal_3260[0], 1, 1, 0);
			}
			if (IS_VEHICLE_SEAT_FREE(uLocal_3260[0], -1, 0))
			{
				if (!DOES_ENTITY_EXIST(uLocal_3254[0]))
				{
					...
					{
						uLocal_3254[0] = CREATE_PED_INSIDE_VEHICLE(uLocal_3260[0], 26, joaat("s_m_m_gentransport"), -1, 1, 1);
	...
	if (DOES_ENTITY_EXIST(uLocal_3260[1]))
	{
		if (IS_VEHICLE_DRIVEABLE(uLocal_3260[1], 0))
		{
			if (!GET_IS_VEHICLE_ENGINE_RUNNING(uLocal_3260[1]))
			{
				SET_VEHICLE_ENGINE_ON(uLocal_3260[1], 1, 1, 0);
			}
			if (IS_VEHICLE_SEAT_FREE(uLocal_3260[1], -1, 0))
			{
				if (!DOES_ENTITY_EXIST(uLocal_3254[1]))
				{
					REQUEST_MODEL(joaat("s_m_m_gentransport"));
					if (HAS_MODEL_LOADED(joaat("s_m_m_gentransport")))
					{
						uLocal_3254[1] = CREATE_PED_INSIDE_VEHICLE(uLocal_3260[1], 26, joaat("s_m_m_gentransport"), -1, 1, 1);
						SET_MODEL_AS_NO_LONGER_NEEDED(joaat("s_m_m_gentransport"));
					}
				}
			}
...
void func_342()
{
	if (iLocal_3181 == 0)
	{
		REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\Trv_4_747_Cop_Cars", 0, -1);
		REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\Trv_4_747_Plane_Explosion", 0, -1);
		REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\Trv_4_747_Tanker_Explosion", 0, -1);
		REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\TV_Monitors", 0, -1);
		if (iLocal_3392 == 0)
		{
			iLocal_3213 = GET_SOUND_ID();
			iLocal_3392 = 1;
		}
		if (iLocal_3393 == 0)
		{
			iLocal_3214 = GET_SOUND_ID();
			iLocal_3393 = 1;
		}
		if (iLocal_3394 == 0)
		{
			iLocal_3215 = GET_SOUND_ID();
			iLocal_3394 = 1;
		}
		if (iLocal_3395 == 0)
		{
			iLocal_3216 = GET_SOUND_ID();
			iLocal_3395 = 1;
		}
		if (iLocal_3396 == 0)
		{
			uLocal_3217 = GET_SOUND_ID();
			iLocal_3396 = 1;
		}
		if (iLocal_3391 == 0)
		{
			iLocal_3218 = GET_SOUND_ID();
			iLocal_3391 = 1;
		}
		if (iLocal_3397 == 0)
		{
			uLocal_3219 = GET_SOUND_ID();
			iLocal_3397 = 1;
		}
		if (iLocal_3345 == 1)
		{
		...
		if (!DOES_CAM_EXIST(uLocal_3289))
		{
			uLocal_3289 = CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
			SET_CAM_FOV(uLocal_3289, 40f);
		}
		iLocal_3343 = 0;
		iLocal_3337 = 0;
		iLocal_3349 = 0;
		...
		bLocal_95 = true;
		func_280();
		uLocal_3184 = GET_DEFAULT_SCRIPT_RENDERTARGET_RENDER_ID();
		CLEAR_AREA(-823.71f, -2548.2f, 13.75f, 20f, 1, 0, 0, 0);
		SET_PED_NON_CREATION_AREA(-833.86f, -2564.17f, 13.43f, -814.37f, -2521.04f, 12.94f);
		SET_PED_PATHS_IN_AREA(-833.86f, -2564.17f, 13.43f, -814.37f, -2521.04f, 12.94f, 0, 0);
		SET_ROADS_IN_AREA(-482f, -2118f, 6f, -1072f, -2724f, 17f, 0, 1);
		func_125(2, 1);
	...
	if (iLocal_3181 == 2)
	{
		if (!DOES_ENTITY_EXIST(uLocal_3271))
		{
			uLocal_3271 = CREATE_VEHICLE(joaat("blista"), 0f, 0f, 1f, 0f, 1, 1, 0);
		}
		...
		if (IS_SCREEN_FADED_OUT())
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_3259, 0))
			{
				SET_VEHICLE_ENGINE_ON(iLocal_3259, 1, 1, 0);
		...
		if (DOES_ENTITY_EXIST(uLocal_3258))
		{
			if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
			{
				START_PLAYBACK_RECORDED_VEHICLE(uLocal_3258, 45, "BB_Chase", 1);
				SETTIMERB(0);
				func_263();
				_SET_UNK_MAP_FLAG(2);
				if (DOES_ENTITY_EXIST(iLocal_3259))
...
void func_344(char* sParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		...
		SET_ROADS_IN_AREA(vLocal_2644, vLocal_2647, 0, 0);
		if (bParam2)
		{
			CLEAR_AREA_OF_VEHICLES(vVar0, 500f, 0, 0, 0, 0, 0, 0);
		}
	}
	ADD_RELATIONSHIP_GROUP("rgh_traffic", &uLocal_2684);
	func_333();
	if (bParam3)
	{
		func_189(1);
...
void func_345()
{
	if (iLocal_3181 == 0)
	{
		...
		SET_ROADS_IN_AREA(-617f, -2274f, 0f, -406.01f, -2044f, 15f, 0, 1);
		iLocal_3188 = GET_GAME_TIMER();
		if (IS_SCREEN_FADED_OUT())
		{
			if (!func_24())
			{
			...
			func_21(0, -1, 1);
			SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_3259);
			SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_3276);
			SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_3277);
		}
		if (!IS_SCREEN_FADED_IN())
		{
			DO_SCREEN_FADE_IN(800);
	...
	if (iLocal_3181 == 1)
	{
		...
		{
			if (!func_257() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
			{
		...
		{
			if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_3300, 1) < 800f)
			{
				iLocal_3187 = GET_RANDOM_INT_IN_RANGE(0, 2);
				if (iLocal_3187 == 0)
				{
		...
		if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_3300, 1) < 600f)
		{
			if (!DOES_ENTITY_EXIST(uLocal_3258))
			{
				REQUEST_MODEL(joaat("cogcabrio"));
				...
				{
					uLocal_3258 = CREATE_VEHICLE(joaat("cogcabrio"), -428.0226f, -2153.558f, 9.2992f, 90.9098f, 1, 1, 0);
					SET_ENTITY_PROOFS(uLocal_3258, 0, 1, 1, 1, 0, 0, 0, 0);
					SET_VEHICLE_COLOURS(uLocal_3258, 27, 27);
					SET_MODEL_AS_NO_LONGER_NEEDED(joaat("cogcabrio"));
					_DYNAMIC_MIXER_RELATED_FN(uLocal_3258, "SOL_3_MOLLY_CAR_Group", 0);
				}
		...
		if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_3300, 1) < 500f)
		{
			if (iLocal_3362 == 0)
			{
				uLocal_3293 = REQUEST_SCALEFORM_MOVIE("BREAKING_NEWS");
		...
		if (iLocal_3379 == 0)
		{
			if (GET_GAME_TIMER() > (iLocal_3188 + 135000))
			{
				CLEAR_PRINTS();
		...
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			if (!DOES_ENTITY_EXIST(iLocal_3259))
			{
				iLocal_3259 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
				SET_ENTITY_PROOFS(iLocal_3259, 0, 1, 0, 0, 0, 0, 0, 0);
		...
		else if (DOES_ENTITY_EXIST(iLocal_3259))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_3259, 0))
			{
				if (iLocal_3361 == 0)
				{
					SET_ENTITY_PROOFS(iLocal_3259, 0, 0, 0, 0, 0, 0, 0, 0);
					iLocal_3361 = 1;
				}
				if (iLocal_3353 == 1)
				{
		...
		if ((iLocal_3362 == 1 && DOES_ENTITY_EXIST(uLocal_3258)) && DOES_ENTITY_EXIST(iLocal_3222))
		{
			if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(uLocal_3258, func_347(PLAYER_PED_ID()), 0))
				{
					func_346();
					iLocal_3181 = 0;
					iLocal_3183 = 0;
			...
			if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
			{
				if (IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uLocal_3258))
				{
					func_346();
					iLocal_3181 = 0;
					iLocal_3183 = 0;
			...
			if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
			{
				if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), GET_ENTITY_COORDS(uLocal_3258, 1), 200f, 132f, 100f, 0, 1, 0))
				{
					iLocal_3359 = 0;
					func_346();
					iLocal_3181 = 0;
			...
			if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
			{
				if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -577f, -2051.5f, 7f, 84f, 87.5f, 15f, 0, 1, 0))
				{
					iLocal_3359 = 1;
					func_346();
					iLocal_3181 = 0;
			...
			if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
			{
				if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -703.5f, -1969.5f, 10f, 53.5f, 62.5f, 10f, 0, 1, 0))
				{
					CLEAR_GPS_MULTI_ROUTE();
					SET_IGNORE_NO_GPS_FLAG(0);
					iLocal_3359 = 1;
			...
			switch (iLocal_3183)
			{
				case 0:
					...
					if (func_395())
					{
						...
						if (DOES_ENTITY_EXIST(Global_90209[0]))
						{
							if (IS_VEHICLE_DRIVEABLE(Global_90209[0], 0))
							{
								SET_ENTITY_AS_MISSION_ENTITY(Global_90209[0], 1, 1);
								iLocal_3259 = Global_90209[0];
							}
						}
						if (DOES_ENTITY_EXIST(Global_90209[1]))
						{
							if (IS_VEHICLE_DRIVEABLE(Global_90209[1], 0))
							{
								SET_ENTITY_AS_MISSION_ENTITY(Global_90209[1], 1, 1);
								uLocal_3276 = Global_90209[1];
							}
						}
						if (DOES_ENTITY_EXIST(Global_90209[2]))
						{
							if (IS_VEHICLE_DRIVEABLE(Global_90209[2], 0))
							{
								SET_ENTITY_AS_MISSION_ENTITY(Global_90209[2], 1, 1);
								uLocal_3277 = Global_90209[2];
							}
						}
				...
				case 1:
					if (iLocal_3467 == 0)
					{
						if (IS_CUTSCENE_ACTIVE())
						{
							if (iLocal_3506 == 0)
							{
								if (DOES_ENTITY_EXIST(uLocal_3278))
								{
									if (IS_VEHICLE_DRIVEABLE(uLocal_3278, 0))
									{
										if (IS_THIS_MODEL_A_HELI(GET_ENTITY_MODEL(uLocal_3278)))
										{
											CONTROL_LANDING_GEAR(uLocal_3278, 2);
											SET_ENTITY_COORDS(uLocal_3278, -1048.722f, -506.8387f, 35.0386f, 1, 0, 0, 1);
											SET_ENTITY_HEADING(uLocal_3278, 357.1288f);
											SET_VEHICLE_DOORS_SHUT(uLocal_3278, 1);
											SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_3278, 1084227584);
											func_356(-1048.722f, -506.8387f, 35.0386f, 357.1288f, 0, 145);
											iLocal_3506 = 1;
										}
										if (((IS_THIS_MODEL_A_CAR(GET_ENTITY_MODEL(uLocal_3278)) || IS_THIS_MODEL_A_BIKE(GET_ENTITY_MODEL(uLocal_3278))) || IS_THIS_MODEL_A_BICYCLE(GET_ENTITY_MODEL(uLocal_3278))) || IS_THIS_MODEL_A_QUADBIKE(GET_ENTITY_MODEL(uLocal_3278)))
										{
											if ((((((((GET_ENTITY_MODEL(uLocal_3278) != joaat("bus") && GET_ENTITY_MODEL(uLocal_3278) != joaat("pounder")) && GET_ENTITY_MODEL(uLocal_3278) != joaat("packer")) && GET_ENTITY_MODEL(uLocal_3278) != joaat("airbus")) && GET_ENTITY_MODEL(uLocal_3278) != joaat("ambulance")) && GET_ENTITY_MODEL(uLocal_3278) != joaat("barracks")) && GET_ENTITY_MODEL(uLocal_3278) != joaat("barracks2")) && GET_ENTITY_MODEL(uLocal_3278) != joaat("benson")) && GET_ENTITY_MODEL(uLocal_3278) != joaat("biff"))
											{
												SET_ENTITY_COORDS(uLocal_3278, -1027.657f, -486.6945f, 35.9571f, 1, 0, 0, 1);
												SET_ENTITY_HEADING(uLocal_3278, 207.7515f);
												SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_3278, 1084227584);
												func_356(-1027.657f, -486.6945f, 35.9571f, 207.7515f, 0, 145);
												iLocal_3506 = 1;
											}
										}
										if ((((!IS_THIS_MODEL_A_HELI(GET_ENTITY_MODEL(uLocal_3278)) && !IS_THIS_MODEL_A_CAR(GET_ENTITY_MODEL(uLocal_3278))) && !IS_THIS_MODEL_A_BIKE(GET_ENTITY_MODEL(uLocal_3278))) && !IS_THIS_MODEL_A_BICYCLE(GET_ENTITY_MODEL(uLocal_3278))) && !IS_THIS_MODEL_A_QUADBIKE(GET_ENTITY_MODEL(uLocal_3278)))
										{
											DELETE_VEHICLE(&uLocal_3278);
											iLocal_3506 = 1;
										}
									}
								}
					...
					if (iLocal_3438 == 0)
					{
						ADD_RELATIONSHIP_GROUP("SecGuards", &uLocal_3576);
						SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_3576);
						SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_3576, 1862763509);
					...
					if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
					{
						SET_ENTITY_COORDS(PLAYER_PED_ID(), -1012.268f, -480.0742f, 38.9757f, 1, 0, 0, 1);
						...
						FORCE_PED_MOTION_STATE(PLAYER_PED_ID(), -530524, 0, 0, 0);
					}
				...
				case 2:
					...
					if (DOES_ENTITY_EXIST(uLocal_3276))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_3276, 0))
						{
							if (DOES_ENTITY_BELONG_TO_THIS_SCRIPT(uLocal_3276, 1))
							{
								SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_3276);
							}
						}
					...
					if (DOES_ENTITY_EXIST(uLocal_3277))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_3277, 0))
						{
							if (DOES_ENTITY_BELONG_TO_THIS_SCRIPT(uLocal_3277, 1))
							{
								SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_3277);
							}
						}
	...
	if (DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_365(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_362(GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_357(Global_97130.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
...
int func_368(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (uParam0->f_2 == 0)
	{
		if (uParam0->f_7 != -1 && uParam0->f_8 != -1)
		{
			...
			{
				if (REQUEST_AMBIENT_AUDIO_BANK("TIME_LAPSE", 0, -1))
				{
					uParam0->f_6 = 0;
					uParam0->f_2 = 1;
				}
	...
	if (uParam0->f_2 == 1)
	{
		if (bParam2)
		{
			...
			uParam0->f_4 = CREATE_CAM("DEFAULT_SPLINE_CAMERA", 0);
			...
			uVar1 = GET_CAM_FAR_CLIP(uParam0->f_4);
			_0x23B59D8912F94246();
			CLEAR_AREA_OF_COPS(uParam1->f_2, uVar1, 0);
			REMOVE_PARTICLE_FX_IN_RANGE(uParam1->f_2, uVar1);
			REMOVE_DECALS_IN_RANGE(uParam1->f_2, uVar1);
			if (bParam3)
			{
				CLEAR_AREA(uParam1->f_2, 5000f, 1, 1, 0, 0);
			}
			func_390(&(uParam0->f_1), 0, 0, 0, GET_CLOCK_DAY_OF_MONTH(), GET_CLOCK_MONTH(), GET_CLOCK_YEAR());
		...
		else if (!func_391(uParam0->f_7, uParam0->f_8))
		{
			if (uParam0->f_5)
			{
				...
				if (!bParam6)
				{
					...
					uVar2 = GET_PLAYERS_LAST_VEHICLE();
					if (DOES_ENTITY_EXIST(uVar2))
					{
						...
						SET_ENTITY_VISIBLE(uVar2, 0, 0);
					}
				}
				uVar3 = GET_CAM_FAR_CLIP(uParam0->f_4);
				_0x23B59D8912F94246();
				CLEAR_AREA_OF_COPS(uParam1->f_2, uVar3, 0);
				REMOVE_PARTICLE_FX_IN_RANGE(uParam1->f_2, uVar3);
				REMOVE_DECALS_IN_RANGE(uParam1->f_2, uVar3);
				if (bParam3)
				{
					CLEAR_AREA(uParam1->f_2, 5000f, 1, 1, 0, 0);
				}
				func_390(&(uParam0->f_1), 0, 0, 8, GET_CLOCK_DAY_OF_MONTH(), GET_CLOCK_MONTH(), GET_CLOCK_YEAR());
				func_354(uParam0, 1, 0, 2000, 1, 1, 0, 1);
				uParam0->f_2 = 2;
			}
			else
		...
		else if (!uParam0->f_5)
		{
			...
			if (!bParam6)
			{
				...
				uVar4 = GET_PLAYERS_LAST_VEHICLE();
				if (DOES_ENTITY_EXIST(uVar4))
				{
					if (!IS_ENTITY_A_MISSION_ENTITY(uVar4))
					{
						SET_ENTITY_AS_MISSION_ENTITY(uVar4, 1, 0);
					}
					SET_ENTITY_VISIBLE(uVar4, 0, 0);
				}
			}
			uVar5 = GET_CAM_FAR_CLIP(uParam0->f_4);
			_0x23B59D8912F94246();
			CLEAR_AREA_OF_COPS(uParam1->f_2, uVar5, 0);
			REMOVE_PARTICLE_FX_IN_RANGE(uParam1->f_2, uVar5);
			REMOVE_DECALS_IN_RANGE(uParam1->f_2, uVar5);
			if (bParam3)
			{
				CLEAR_AREA(uParam1->f_2, 5000f, 0, 1, 0, 0);
			}
			func_390(&(uParam0->f_1), 0, 0, 0, GET_CLOCK_DAY_OF_MONTH(), GET_CLOCK_MONTH(), GET_CLOCK_YEAR());
			func_354(uParam0, 1, 0, 2000, 1, 1, 0, 1);
			uParam0->f_2 = 2;
	...
	switch (uParam4->f_3)
	{
		...
		case 2:
			if ((DOES_CAM_EXIST(uParam4->f_4) && IS_CAM_INTERPOLATING(uParam4->f_4)) || !(fParam5 >= 0.99f || fParam5 == -1f))
			{
				...
				if (fVar0 >= 0.5f)
				{
					if (uParam4->f_3 == 1)
					{
						...
						{
							_SET_WEATHER_TYPE_OVER_TIME(uParam2, iParam8);
						}
						if (GET_HASH_KEY(uParam3) != 0)
						{
							_CLEAR_CLOUD_HAT();
							_SET_CLOUD_HAT_TRANSITION(uParam3, 0);
						}
						uParam4->f_3 = 2;
					}
				}
			...
			if (fVar0 >= 0.99f || fVar0 == -1f)
			{
				...
				SET_CLOCK_TIME(func_376(iVar5), func_375(iVar5), func_374(iVar5));
				if (bParam7)
				{
					_0x03FC694AE06C5A20();
				}
			...
			SET_CLOCK_TIME(func_376(iVar5), func_375(iVar5), func_374(iVar5));
			if (func_372(iVar5) != GET_CLOCK_DAY_OF_MONTH())
			{
				SET_CLOCK_DATE(func_372(iVar5), func_102(iVar5), func_100(iVar5));
			}
			func_267();
...
{
	uParam0->f_1 = (func_381(IS_BIT_SET(*uParam0, 4)) - fParam1);
	SET_BIT(uParam0, 1);
	CLEAR_BIT(uParam0, 2);
	uParam0->f_2 = 0f;
}
...
float func_382(var uParam0)
{
	if (func_384(uParam0))
	{
		...
		{
			return (func_381(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	return func_392(GET_CLOCK_HOURS(), iParam0, iParam1);
}
...
void func_397()
{
	if (iLocal_3181 == 0)
	{
		CLEAR_AREA(-920.0547f, -2744.662f, 12.8434f, 20f, 1, 0, 0, 0);
		SET_PLAYER_WANTED_LEVEL(PLAYER_ID(), 0, 0);
		SET_PLAYER_WANTED_LEVEL_NOW(PLAYER_ID(), 0);
		iLocal_3181++;
	}
...
void func_400()
{
	if (iLocal_3490[0] == 0)
	{
		if (DOES_ENTITY_EXIST(iLocal_3121[7]))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_3121[7], 0))
			{
				_DYNAMIC_MIXER_RELATED_FN(iLocal_3121[7], "SOL_3_POLICE_CARS_Group", 0);
				iLocal_3490[0] = 1;
			}
		}
	}
	if (iLocal_3498[0] == 0)
	{
		if (iLocal_3490[0] == 1)
		{
			if (DOES_ENTITY_EXIST(iLocal_3121[7]))
			{
				if (!IS_VEHICLE_DRIVEABLE(iLocal_3121[7], 0))
				{
					_0x18EB48CFC41F2EA0(iLocal_3121[7], 0);
					iLocal_3498[0] = 1;
				}
	...
	if (iLocal_3490[1] == 0)
	{
		if (DOES_ENTITY_EXIST(iLocal_3121[8]))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_3121[8], 0))
			{
				_DYNAMIC_MIXER_RELATED_FN(iLocal_3121[8], "SOL_3_POLICE_CARS_Group", 0);
				iLocal_3490[1] = 1;
			}
		}
	}
	if (iLocal_3498[1] == 0)
	{
		if (iLocal_3490[1] == 1)
		{
			if (DOES_ENTITY_EXIST(iLocal_3121[8]))
			{
				if (!IS_VEHICLE_DRIVEABLE(iLocal_3121[8], 0))
				{
					_0x18EB48CFC41F2EA0(iLocal_3121[8], 0);
					iLocal_3498[1] = 1;
				}
				else if (iLocal_3180 == 5)
				{
	...
	if (iLocal_3490[2] == 0)
	{
		if (DOES_ENTITY_EXIST(iLocal_3121[11]))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_3121[11], 0))
			{
				_DYNAMIC_MIXER_RELATED_FN(iLocal_3121[11], "SOL_3_POLICE_CARS_Group", 0);
				iLocal_3490[2] = 1;
			}
		}
	}
	if (iLocal_3498[2] == 0)
	{
		if (iLocal_3490[2] == 1)
		{
			if (DOES_ENTITY_EXIST(iLocal_3121[11]))
			{
				if (!IS_VEHICLE_DRIVEABLE(iLocal_3121[11], 0))
				{
					_0x18EB48CFC41F2EA0(iLocal_3121[11], 0);
					iLocal_3498[2] = 1;
				}
				else if (iLocal_3180 == 5)
				{
	...
	if (iLocal_3490[3] == 0)
	{
		if (DOES_ENTITY_EXIST(iLocal_3121[12]))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_3121[12], 0))
			{
				_DYNAMIC_MIXER_RELATED_FN(iLocal_3121[12], "SOL_3_POLICE_CARS_Group", 0);
				iLocal_3490[3] = 1;
			}
		}
	}
	if (iLocal_3498[3] == 0)
	{
		if (iLocal_3490[3] == 1)
		{
			if (DOES_ENTITY_EXIST(iLocal_3121[12]))
			{
				if (!IS_VEHICLE_DRIVEABLE(iLocal_3121[12], 0))
				{
					_0x18EB48CFC41F2EA0(iLocal_3121[12], 0);
					iLocal_3498[3] = 1;
				}
				else if (iLocal_3180 == 5)
				{
	...
	if (iLocal_3490[4] == 0)
	{
		if (DOES_ENTITY_EXIST(iLocal_3121[13]))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_3121[13], 0))
			{
				_DYNAMIC_MIXER_RELATED_FN(iLocal_3121[13], "SOL_3_POLICE_CARS_Group", 0);
				iLocal_3490[4] = 1;
			}
		}
	}
	if (iLocal_3498[4] == 0)
	{
		if (iLocal_3490[4] == 1)
		{
			if (DOES_ENTITY_EXIST(iLocal_3121[13]))
			{
				if (!IS_VEHICLE_DRIVEABLE(iLocal_3121[13], 0))
				{
					_0x18EB48CFC41F2EA0(iLocal_3121[13], 0);
					iLocal_3498[4] = 1;
				}
				else if (iLocal_3180 == 5)
				{
	...
	if (iLocal_3490[5] == 0)
	{
		if (DOES_ENTITY_EXIST(iLocal_3121[14]))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_3121[14], 0))
			{
				_DYNAMIC_MIXER_RELATED_FN(iLocal_3121[14], "SOL_3_POLICE_CARS_Group", 0);
				iLocal_3490[5] = 1;
			}
		}
	}
	if (iLocal_3498[5] == 0)
	{
		if (iLocal_3490[5] == 1)
		{
			if (DOES_ENTITY_EXIST(iLocal_3121[14]))
			{
				if (!IS_VEHICLE_DRIVEABLE(iLocal_3121[14], 0))
				{
					_0x18EB48CFC41F2EA0(iLocal_3121[14], 0);
					iLocal_3498[5] = 1;
				}
				else if (iLocal_3180 == 5)
				{
	...
	if (iLocal_3490[6] == 0)
	{
		if (DOES_ENTITY_EXIST(iLocal_3121[15]))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_3121[15], 0))
			{
				_DYNAMIC_MIXER_RELATED_FN(iLocal_3121[15], "SOL_3_POLICE_CARS_Group", 0);
				iLocal_3490[6] = 1;
			}
		}
	}
	if (iLocal_3498[6] == 0)
	{
		if (iLocal_3490[6] == 1)
		{
			if (DOES_ENTITY_EXIST(iLocal_3121[15]))
			{
				if (!IS_VEHICLE_DRIVEABLE(iLocal_3121[15], 0))
				{
					_0x18EB48CFC41F2EA0(iLocal_3121[15], 0);
					iLocal_3498[6] = 1;
				}
				else if (iLocal_3180 == 5)
				{
		...
		case 2:
			if (iLocal_3181 > 0)
			{
				...
				if (iLocal_3185 == 1)
				{
					if (iLocal_3364 == 0)
					{
						if (GET_DISTANCE_BETWEEN_COORDS(vLocal_3318, GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 1) > 2f)
						{
							if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
							{
					...
					if (iLocal_3523 == 0)
					{
						if (GET_DISTANCE_BETWEEN_COORDS(vLocal_3318, GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 1) > 100f)
						{
							if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
							{
					...
					if (iLocal_3557 == 0)
					{
						if (DOES_ENTITY_EXIST(uLocal_3258))
						{
							if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
							{
								if (func_16(PLAYER_PED_ID(), uLocal_3258, 1) < 200f && IS_ENTITY_ON_SCREEN(uLocal_3258))
								{
									if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
									{
										if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
						...
						if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
						{
							if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
							{
								if (iLocal_3524[0] == 0)
								{
									...
									{
										if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 7000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 28000f)
										{
											if (!func_257())
											{
												if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								if (iLocal_3524[1] == 0)
								{
									if (IS_VEHICLE_DRIVEABLE(iLocal_3121[7], 0) || IS_VEHICLE_DRIVEABLE(iLocal_3121[8], 0))
									{
										if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 28000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 34500f)
										{
											if (!func_257())
											{
												if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								if (iLocal_3524[2] == 0)
								{
									if (IS_VEHICLE_DRIVEABLE(iLocal_3121[7], 0) || IS_VEHICLE_DRIVEABLE(iLocal_3121[8], 0))
									{
										if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 36000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 41000f)
										{
											if (!func_257())
											{
												if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								if (iLocal_3554 == 0)
								{
									if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 41000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 43500f)
									{
										if (DOES_ENTITY_EXIST(uLocal_3265) && IS_ENTITY_ON_SCREEN(uLocal_3265))
										{
											if (!func_257())
											{
												if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								if (iLocal_3555 == 0)
								{
									if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 50509f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 50872f)
									{
										if (DOES_ENTITY_EXIST(uLocal_3265) && IS_ENTITY_ON_SCREEN(uLocal_3265))
										{
											if (!func_257())
								...
								if (iLocal_3524[3] == 0)
								{
									if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 58000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 68000f)
									{
										if (!func_257())
										{
											if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								{
									if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 76000f)
									{
										if (!func_257())
										{
											if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								if (iLocal_3553 == 0)
								{
									if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 80000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 82000f)
									{
										if (DOES_ENTITY_EXIST(uLocal_3260[0]))
										{
											if (IS_VEHICLE_DRIVEABLE(uLocal_3260[0], 0))
											{
												if (IS_ENTITY_ON_SCREEN(uLocal_3260[0]))
												{
													if (!func_257())
													{
														if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								if (iLocal_3559 == 0)
								{
									if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 82100f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 83500f)
									{
										if (DOES_ENTITY_EXIST(iLocal_3121[11]))
										{
										...
										else if (DOES_ENTITY_EXIST(iLocal_3121[12]))
										{
								...
								if (iLocal_3562 == 0)
								{
									if ((GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 101891f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 105000f) && IS_ENTITY_ON_SCREEN(uLocal_3258))
									{
										if (!func_257())
										{
											if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								if (((GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 105500f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 119000f) && GET_GAME_TIMER() > iLocal_3199 + 7000) && iLocal_3561 == 0)
								{
									if (!func_257())
									{
										if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
								...
								if (((GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 105500f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 119000f) && GET_GAME_TIMER() > iLocal_3199 + 7000) && iLocal_3560 == 1)
								{
									if (!func_257())
									{
										if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
		...
		case 5:
			if (iLocal_3181 > 0)
			{
				...
				if (iLocal_3185 == 1)
				{
					if (iLocal_3569 == 0)
					{
						_PLAY_AMBIENT_SPEECH_AT_COORDS("T1M4_BBAA", "AIRPORTANNO", -939.5f, -2932.2f, 16f, "SPEECH_PARAMS_FORCE_FRONTEND");
						iLocal_3569 = 1;
					}
					if (iLocal_3564 == 1)
					{
						...
						if (GET_GAME_TIMER() > iLocal_3200 + 5000)
						{
							if (!func_257())
							{
								if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
					...
					if (iLocal_3563 == 1 && GET_GAME_TIMER() > iLocal_3204 + 4000)
					{
						if (!func_257())
						{
							if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
				...
				if (iLocal_3185 == 1)
				{
					...
					if (iLocal_3532 == 0)
					{
						if (DOES_ENTITY_EXIST(iLocal_3222))
						{
							if (!IS_PED_INJURED(iLocal_3222))
							{
								if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_3209))
								{
									if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_3209) > 0.65f && GET_SYNCHRONIZED_SCENE_PHASE(uLocal_3209) < 0.835f)
									{
										if (!func_257())
										{
											if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
			...
			if (iLocal_3181 > 0)
			{
				...
				if (iLocal_3185 == 1)
				{
					if (iLocal_3567 == 0)
					{
						if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
						{
							uLocal_3257 = func_402(PLAYER_PED_ID(), -1533126372, 0, 0, 28);
							if (DOES_ENTITY_EXIST(uLocal_3257))
							{
								if (func_16(PLAYER_PED_ID(), uLocal_3257, 1) < 40f)
								{
									if (!func_257())
									{
										if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
					...
					if (iLocal_3567 == 1 && GET_GAME_TIMER() > iLocal_3205 + 5000)
					{
						if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
						{
							uLocal_3257 = func_402(PLAYER_PED_ID(), -1533126372, 0, 0, 28);
...
void func_405()
{
	if (((iLocal_3180 == 4 || iLocal_3180 == 5) || iLocal_3180 == 8) || iLocal_3180 == 6)
	{
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			if (func_406(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 2, 200, 0))
			{
...
void func_408()
{
	if (iLocal_3351 == 1)
	{
		if (iLocal_3180 == 4)
		{
			...
			{
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -828.6987f, -2938.073f, 12.21745f, -807.6911f, -2905.148f, 16.35626f, 28f, 0, 1, 0))
				{
					func_235("TRV4_FAIL1");
				}
			}
		...
		if (iLocal_3180 == 6)
		{
			if (DOES_ENTITY_EXIST(iLocal_3283))
			{
				if (DOES_BLIP_EXIST(uLocal_3288))
				{
					if (func_16(PLAYER_PED_ID(), iLocal_3283, 1) > 100f)
					{
						func_235("TRV4_FAIL6");
					}
				}
		...
		if (iLocal_3180 == 4)
		{
			if (iLocal_3182 == 2)
			{
				if (GET_GAME_TIMER() > iLocal_3194 + 7000 && iLocal_3508 == 0)
				{
					func_235("TRV4_FAIL1");
				}
			}
		...
		if (iLocal_3180 == 4)
		{
			if (DOES_ENTITY_EXIST(uLocal_3258))
			{
				if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
				{
					if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
					{
						if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 62000f && GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 77000f)
						{
							if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), -1219f, -2570f, 13f, 1) < 210f)
							{
								if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
								{
									if (GET_ENTITY_HEADING(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)) < 200f && GET_ENTITY_HEADING(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)) > 125f)
									{
										if (iLocal_3507 == 0)
										{
											iLocal_3197 = GET_GAME_TIMER();
											iLocal_3507 = 1;
										}
										if (iLocal_3507 == 1 && GET_GAME_TIMER() > iLocal_3197 + 4000)
										{
											func_235("TRV4_FAIL1");
										}
									}
		...
		{
			if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), -928.9f, -2935f, 13f, 1) < 5f && !IS_PLAYER_CONTROL_ON(PLAYER_ID()))
			{
				func_235("TRV4_FAIL1");
			}
		}
		...
		if (DOES_ENTITY_EXIST(uLocal_3258))
		{
			if (!IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
			{
				if (DOES_ENTITY_EXIST(iLocal_3222))
				{
					if (!IS_PED_INJURED(iLocal_3222))
					{
						SET_ENTITY_INVINCIBLE(iLocal_3222, 0);
						SET_ENTITY_HEALTH(iLocal_3222, 0, 0);
					}
				}
			}
		}
		...
		if (iLocal_3180 == 4)
		{
			if (iLocal_3352 == 1)
			{
				if (!IS_PED_INJURED(iLocal_3222))
				{
					if (func_13(PLAYER_PED_ID(), iLocal_3222) > 300f)
					{
						if (iLocal_3436 == 1)
						{
							CLEAR_PRINTS();
					...
					if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
					{
						if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
						{
							if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) < 40000f)
							{
								if (func_13(PLAYER_PED_ID(), iLocal_3222) > 400f)
								{
									func_235("TRV4_FAIL1");
								}
							}
							else if (func_13(PLAYER_PED_ID(), iLocal_3222) > 350f)
							{
								func_235("TRV4_FAIL1");
							}
						}
			...
			if (iLocal_3182 == 3)
			{
				if (iLocal_3476 == 1)
				{
					if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), -934.4f, -2927.2f, 13.2f, 1) > 25f || GET_GAME_TIMER() > iLocal_3195 + 12000)
					{
						func_235("TRV4_FAIL1");
					}
				}
		...
		if (iLocal_3180 == 4)
		{
			if (IS_VEHICLE_DRIVEABLE(uLocal_3258, 0))
			{
				if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_3258))
				{
					if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 111509f)
					{
						if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1070.838f, -2942.241f, 12.19534f, -1009.038f, -2977.609f, 17.44443f, 89.5f, 0, 1, 0))
						{
							func_235("TRV4_FAIL1");
						}
					}
					if (GET_TIME_POSITION_IN_RECORDING(uLocal_3258) > 122000f)
					{
						if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
						{
							if (IS_ENTITY_UPSIDEDOWN(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)))
							{
								if (iLocal_3509 == 0)
								{
									iLocal_3198 = GET_GAME_TIMER();
									iLocal_3509 = 1;
								}
								if (iLocal_3509 == 1)
								{
									if (GET_GAME_TIMER() > iLocal_3198 + 4000)
									{
										func_235("TRV4_FAIL1");
									}
								}
		...
		if (iLocal_3180 == 2)
		{
			if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -803.4108f, -2173.417f, -1.911488f, -605.6846f, -2358.229f, 27.32842f, 250f, 0, 1, 0))
			{
				func_235("TRV4_FAIL1");
			}
		}
...
void func_413()
{
	func_419(24, 1);
	SET_AUDIO_FLAG("PoliceScannerDisabled", 0);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-1042.5f, -500f, 41f, -1019.5f, -475f, 34f, 1, 1);
	func_414();
	func_209(&uLocal_28, 0, 0);
	_SET_UNK_MAP_FLAG(0);
	SET_IGNORE_NO_GPS_FLAG(0);
	...
	if (DOES_ENTITY_EXIST(iLocal_3222))
	{
		if (!IS_PED_INJURED(iLocal_3222))
		{
			SET_PED_KEEP_TASK(iLocal_3222, 1);
		}
	...
	if (DOES_ENTITY_EXIST(uLocal_3245))
	{
		if (!IS_PED_INJURED(uLocal_3245))
		{
			SET_PED_KEEP_TASK(uLocal_3245, 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&uLocal_3245);
	}
	if (DOES_ENTITY_EXIST(uLocal_3246))
	{
		if (!IS_PED_INJURED(uLocal_3246))
		{
			SET_PED_KEEP_TASK(uLocal_3246, 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&uLocal_3246);
	}
	if (DOES_ENTITY_EXIST(uLocal_3247))
	{
		if (!IS_PED_INJURED(uLocal_3247))
		{
			SET_PED_KEEP_TASK(uLocal_3247, 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&uLocal_3247);
	}
	if (DOES_ENTITY_EXIST(iLocal_3248))
	{
		if (!IS_PED_INJURED(iLocal_3248))
		{
			SET_PED_KEEP_TASK(iLocal_3248, 1);
		}
	...
	if (DOES_ENTITY_EXIST(uLocal_3249))
	{
		if (!IS_PED_INJURED(uLocal_3249))
		{
			SET_PED_KEEP_TASK(uLocal_3249, 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&uLocal_3249);
	}
	if (DOES_ENTITY_EXIST(uLocal_3250))
	{
		if (!IS_PED_INJURED(uLocal_3250))
		{
			SET_PED_KEEP_TASK(uLocal_3250, 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&uLocal_3250);
	}
	if (DOES_ENTITY_EXIST(uLocal_3223[0]))
	{
		if (!IS_PED_INJURED(uLocal_3223[0]))
		{
			SET_PED_KEEP_TASK(uLocal_3223[0], 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3223[0]));
	...
	if (DOES_ENTITY_EXIST(uLocal_3229[0]))
	{
		if (!IS_PED_INJURED(uLocal_3229[0]))
		{
			SET_PED_KEEP_TASK(uLocal_3229[0], 1);
		}
	...
	if (DOES_ENTITY_EXIST(uLocal_3229[1]))
	{
		if (!IS_PED_INJURED(uLocal_3229[1]))
		{
			SET_PED_KEEP_TASK(uLocal_3229[1], 1);
		}
	...
	if (DOES_ENTITY_EXIST(uLocal_3229[2]))
	{
		if (!IS_PED_INJURED(uLocal_3229[2]))
		{
			SET_PED_KEEP_TASK(uLocal_3229[2], 1);
		}
	...
	if (DOES_ENTITY_EXIST(uLocal_3233[0]))
	{
		if (!IS_PED_INJURED(uLocal_3233[0]))
		{
			SET_PED_KEEP_TASK(uLocal_3233[0], 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3233[0]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[1]))
	{
		if (!IS_PED_INJURED(uLocal_3233[1]))
		{
			SET_PED_KEEP_TASK(uLocal_3233[1], 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3233[1]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[2]))
	{
		if (!IS_PED_INJURED(uLocal_3233[2]))
		{
			SET_PED_KEEP_TASK(uLocal_3233[2], 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3233[2]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[3]))
	{
		if (!IS_PED_INJURED(uLocal_3233[3]))
		{
			SET_PED_KEEP_TASK(uLocal_3233[3], 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3233[3]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[4]))
	{
		if (!IS_PED_INJURED(uLocal_3233[4]))
		{
			SET_PED_KEEP_TASK(uLocal_3233[4], 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3233[4]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[5]))
	{
		if (!IS_PED_INJURED(uLocal_3233[5]))
		{
			SET_PED_KEEP_TASK(uLocal_3233[5], 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3233[5]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[6]))
	{
		if (!IS_PED_INJURED(uLocal_3233[6]))
		{
			SET_PED_KEEP_TASK(uLocal_3233[6], 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3233[6]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[7]))
	{
		if (!IS_PED_INJURED(uLocal_3233[7]))
		{
			SET_PED_KEEP_TASK(uLocal_3233[7], 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3233[7]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[8]))
	{
		if (!IS_PED_INJURED(uLocal_3233[8]))
		{
			SET_PED_KEEP_TASK(uLocal_3233[8], 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3233[8]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[9]))
	{
		if (!IS_PED_INJURED(uLocal_3233[9]))
		{
			SET_PED_KEEP_TASK(uLocal_3233[9], 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3233[9]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3233[10]))
	{
		if (!IS_PED_INJURED(uLocal_3233[10]))
		{
			SET_PED_KEEP_TASK(uLocal_3233[10], 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3233[10]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3251[0]))
	{
		if (!IS_PED_INJURED(uLocal_3251[0]))
	...
	if (DOES_ENTITY_EXIST(uLocal_3254[0]))
	{
		if (!IS_PED_INJURED(uLocal_3254[0]))
		{
			SET_PED_KEEP_TASK(uLocal_3254[0], 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3254[0]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3254[1]))
	{
		if (!IS_PED_INJURED(uLocal_3254[1]))
		{
			SET_PED_KEEP_TASK(uLocal_3254[1], 1);
		}
		SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_3254[1]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3258))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_3258);
	...
	if (DOES_ENTITY_EXIST(uLocal_3266))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_3266);
	}
	if (DOES_ENTITY_EXIST(iLocal_3267))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_3267);
	...
	if (DOES_ENTITY_EXIST(uLocal_3271))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_3271);
	}
	if (DOES_ENTITY_EXIST(iLocal_3275))
	{
	...
	if (DOES_ENTITY_EXIST(uLocal_3260[0]))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uLocal_3260[0]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3260[1]))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uLocal_3260[1]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3279[0]))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uLocal_3279[0]));
	...
	if (DOES_ENTITY_EXIST(uLocal_3268[0]))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uLocal_3268[0]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3268[1]))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uLocal_3268[1]));
	}
	if (DOES_ENTITY_EXIST(uLocal_3272[0]))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uLocal_3272[0]));
	...
	if (DOES_ENTITY_EXIST(uLocal_3263))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_3263);
	}
	...
	if (DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_3763))
	{
		REMOVE_PARTICLE_FX(uLocal_3763, 0);
	}
	CLEAR_GPS_MULTI_ROUTE();
	SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_3293);
	SET_STREAMED_TEXTURE_DICT_AS_NO_LONGER_NEEDED("digitalOverlay");
	SET_ROADS_IN_AREA(-617f, -2274f, 0f, -406.01f, -2044f, 15f, 1, 1);
	SET_ROADS_IN_AREA(-482f, -2118f, 6f, -1072f, -2724f, 17f, 1, 1);
	if (GET_IS_WAYPOINT_RECORDING_LOADED("Trev4_5"))
	{
		USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE("Trev4_5", 0, 0.5f, 1f);
	}
...
void func_417(var uParam0, int iParam1)
{
	...
	if (DOES_ENTITY_EXIST(uParam0))
	{
		if (GET_CURRENT_PED_WEAPON(uParam0, &iVar0, 0))
		{
...
int func_420(int iParam0)
{
	...
	if (Var0.f_1 != -1 && IS_BIT_SET(Global_32202[Var0.f_1], Var0))
	{
		return 1;
	}
	return 0;
...
void func_422(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		SET_BIT(&(Global_32202[Var0.f_1]), Var0);
	}
	else
	{
		CLEAR_BIT(&(Global_32202[Var0.f_1]), Var0);
	}
}
