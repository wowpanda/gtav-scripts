...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (!iLocal_38)
		{
			...
			{
				ENTITY::SET_ENTITY_COORDS(AUDIO::_0x0626A247D2405330(), vLocal_45, 1, false, 0, 1);
				ENTITY::SET_ENTITY_HEADING(AUDIO::_0x0626A247D2405330(), fLocal_43);
...
{
	iLocal_44 = INTERIOR::GET_INTERIOR_FROM_ENTITY(AUDIO::_0x0626A247D2405330());
...
void func_19()//Position - 0x4C8
{
	...
	{
		PED::IS_PED_VAULTING("imp_dt1_02_cargarage_a");
	}
}
