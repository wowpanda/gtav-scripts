	...
	switch (iLocal_84)
	{
		...
		case 1:
			...
			if (func_230(Local_81.f_28[0]))
			{
				...
				if (func_232(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 1) >= 100f && !CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(Local_81.f_28[0], 1), 3f))
				{
					iLocal_84 = 3;
				}
				if ((((((GRAPHICS::_0x2F09F7976C512404(ENTITY::GET_ENTITY_COORDS(Local_81.f_28[0], 0), 5f) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_81.f_28[0], 0), 5f, 0)) || MISC::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(Local_81.f_28[0], 0), joaat("weapon_grenadelauncher"), 5f, 0)) || MISC::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(Local_81.f_28[0], 0), joaat("weapon_rpg"), 5f, 0)) || MISC::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(Local_81.f_28[0], 0), joaat("weapon_grenade"), 5f, 0)) || MISC::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(Local_81.f_28[0], 0), joaat("weapon_molotov"), 5f, 0)) || MISC::_0x34318593248C8FB2(ENTITY::GET_ENTITY_COORDS(Local_81.f_28[0], 0), joaat("weapon_flare"), 5f, 0))
				{
...
void func_23()
{
	...
	{
		Global_104555.f_10019.f_104 = CLOCK::GET_CLOCK_DAY_OF_MONTH();
	}
...
void func_180()
{
	...
	{
		func_10();
		GRAPHICS::_0xBF59707B3E5ED531(func_181(Global_104555.f_2353.f_539.f_4301));
	}
	else
	{
...
void func_241(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_245(PLAYER::PLAYER_ID())) && !func_243(PLAYER::PLAYER_ID(), 0)) && !func_242())
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_245(PLAYER::PLAYER_ID()))
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_70854 = 0;
...
{
	if (((!func_295(0) || Global_71125) || Global_71114 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71110)
