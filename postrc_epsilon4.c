...
void func_1()
{
	if (func_23(uLocal_205))
	{
		if (((((!func_22() && !IS_PED_FLEEING(uLocal_205)) && !IS_PED_RAGDOLL(uLocal_205)) && !IS_PED_PRONE(uLocal_205)) && !IS_PED_INJURED(uLocal_205)) && !IS_PED_IN_ANY_VEHICLE(uLocal_205, 0))
		{
			if (func_21(uLocal_205, PLAYER_PED_ID(), 1) <= 2.3f)
			{
				if ((GET_GAME_TIMER() - iLocal_203) > 8000)
				{
					if (func_4(&uLocal_38, "EPS4AUD", "EPS4_FOLLJ", 7, 0, 0, 0))
					{
						iLocal_203 = GET_GAME_TIMER();
					}
				}
			}
		}
		if (func_21(uLocal_205, PLAYER_PED_ID(), 1) > 150f)
		{
			func_3(&uLocal_205);
		}
	}
	...
	{
		if (((((!func_22() && !IS_PED_FLEEING(uLocal_204)) && !IS_PED_RAGDOLL(uLocal_204)) && !IS_PED_PRONE(uLocal_204)) && !IS_PED_INJURED(uLocal_204)) && !IS_PED_IN_ANY_VEHICLE(uLocal_204, 0))
		{
			if (func_21(uLocal_204, PLAYER_PED_ID(), 1) <= 2.7f)
			{
				if ((GET_GAME_TIMER() - iLocal_203) > 8000)
				{
		...
		if (func_21(uLocal_204, PLAYER_PED_ID(), 1) > 150f)
		{
			func_3(&uLocal_204);
		}
	}
	...
	if (!func_23(uLocal_204) && !func_23(uLocal_205))
	{
		iLocal_37 = 2;
	}
}
...
float func_21(var uParam0, var uParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_24()
{
	...
	while (iVar1 < iVar0)
	{
		...
		{
			if (GET_ENTITY_MODEL(uVar2[iVar1]) == func_26(55))
			{
				uLocal_205 = uVar2[iVar1];
				if (!IS_ENTITY_A_MISSION_ENTITY(uLocal_205))
				{
					SET_ENTITY_AS_MISSION_ENTITY(uLocal_205, 1, 0);
				}
				SET_PED_MONEY(uLocal_205, 0);
				SET_PED_CAN_BE_TARGETTED(uLocal_205, 0);
				SET_PED_NAME_DEBUG(uLocal_205, "POSTJIMMY");
				SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_205, 1862763509);
				func_25(&uLocal_38, 5, uLocal_205, "JIMMYBOSTON", 1, 1);
			}
			if (GET_ENTITY_MODEL(uVar2[iVar1]) == func_26(60))
			{
				uLocal_204 = uVar2[iVar1];
				if (!IS_ENTITY_A_MISSION_ENTITY(uLocal_204))
				{
					SET_ENTITY_AS_MISSION_ENTITY(uLocal_204, 1, 0);
				}
				SET_PED_MONEY(uLocal_204, 0);
				SET_PED_CAN_BE_TARGETTED(uLocal_204, 0);
				SET_PED_NAME_DEBUG(uLocal_204, "POSTMARNIE");
				SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_204, 1862763509);
				func_25(&uLocal_38, 4, uLocal_204, "MARNIE", 1, 1);
			}
		}
		iVar1++;
	}
