...
void __EntryFunction__()
{
	...
	if (!func_280(&iVar64, &Var0, vVar61, 1f))
	{
		func_279();
	...
	if (Var0 == 27)
	{
		func_249(&uLocal_97, 5, Var0.f_28[0], "JOSH", 0, 1);
	}
	else if (Var0 == 30)
	{
		func_249(&uLocal_97, 4, Var0.f_28[0], "JOSH", 0, 1);
		func_249(&uLocal_97, 3, Var0.f_28[1], "JOSHCOP", 0, 1);
	...
	while (true)
	{
		...
		if (!func_212(&Var0, 1))
		{
			if (Var0 == 30)
			{
				if (func_211(PLAYER_PED_ID(), -1102.724f, 290.1463f, 63.23002f, 1) < 200f)
				{
		...
		func_209(Var0);
		func_202(&iLocal_95, &(Var0.f_9), vVar61);
		if (Var0 == 27)
		{
			func_200(&Var0, vVar61, "JOSH1AU", "JOSH1_AMB1", 5, "JOSH", 5000, 14f);
		}
		else if (Var0 == 28)
		{
			func_200(&Var0, vVar61, "JOSH2AU", "JOSH2_AMB", 5, "JOSH", 5000, 1101004800);
		}
		else if (Var0 == 29)
		{
			func_200(&Var0, vVar61, "JOSH3AU", "JOSH3_AMB", 3, "JOSH", 5000, 1101004800);
		}
		else if (Var0 == 30)
		{
			if (iLocal_265 == 0)
			{
				if (_0xB56BBBCC2955D9CB())
				{
					if (func_199(Var0.f_28[1]))
					{
						...
						_0x2A56C06EBEF2B0D9("Cop_standing_idle", Var0.f_28[1], 0);
					}
					if (func_199(Var0.f_28[2]))
					{
						func_301("Josh 4: Trying to set Cop 2 component variation");
						_0x2A56C06EBEF2B0D9("Cop_with_notepad", Var0.f_28[2], 0);
					}
					iLocal_265 = 1;
				}
			}
	...
	if (*uParam0 == 30)
	{
		if (func_199(uParam0->f_28[0]))
		{
			if (bLocal_263)
			{
				if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
					if (func_171(PLAYER_PED_ID(), uParam0->f_28[0], 1) <= 15f)
					{
						func_301("Special launching Josh 4 (not in vehicle)");
						return 1;
					}
				}
				else if (func_171(PLAYER_PED_ID(), uParam0->f_28[0], 1) <= 10f)
				{
...
int func_172(var uParam0)
{
	if (*uParam0 == 29)
	{
		if (func_211(PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, 1) < 6f)
		{
			if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
			...
			else if ((!func_173(PLAYER_PED_ID(), -828834893) && func_199(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0))) && func_147(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 1f, 1, 1056964608, 0, 1, 0))
			{
				TASK_LEAVE_ANY_VEHICLE(PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_174(var uParam0)
{
	if (*uParam0 == 28)
	{
		if (func_211(PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, 1) < 9f)
		{
			if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
			...
			else if ((!func_173(PLAYER_PED_ID(), -828834893) && func_199(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0))) && func_147(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 4f, 1, 1056964608, 0, 1, 0))
			{
				TASK_LEAVE_ANY_VEHICLE(PLAYER_PED_ID(), 0, 0);
			}
		}
	...
	switch (uParam0->f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
					if (func_199(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)))
					{
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_189()) || Global_105612) || Global_25767) || func_188()) || func_187(8, -1)) || func_92()) || func_186()) || func_185()) || func_184()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_189()) || Global_25767) || func_188()) || func_187(8, -1)) || func_185()) || func_92()) || func_186()) || func_184()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_189()) || Global_105612) || Global_25767) || func_188()) || func_187(8, -1)) || func_185()) || func_92()) || func_186()) || func_184()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_189()) || Global_105612) || Global_25767) || func_188()) || func_187(8, -1)) || func_92()) || func_186()) || func_184()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_189() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_187(8, -1)) || func_184()) || func_183()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_189()) || Global_25767) || func_188()) || func_187(8, -1)) || func_186()) || func_185()) || func_184()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_189()) || Global_105612) || Global_25767) || func_188()) || func_187(8, -1)) || func_185()) || func_183()) || func_92()) || func_186()) || func_184())
						{
							return 0;
						}
						break;
...
void func_190()
{
	...
	{
		case 0:
			if ((GET_GAME_TIMER() - iLocal_262) > 100 && bLocal_263 == 0)
			{
				iLocal_96 = 1;
			}
			break;
		...
		case 1:
			if (func_211(PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, 1) <= 20f)
			{
				if (func_191(&uLocal_97, "JOSH4AU", "JOSH4_AMB", 8, 0, 0, 0))
				{
					iLocal_96 = 2;
				}
			}
		...
		case 2:
			...
			else if (func_211(PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, 1) >= 25f)
			{
				func_142();
				bLocal_263 = true;
				iLocal_96 = 0;
...
int func_200(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_199(PLAYER_PED_ID()) && func_199(iParam0->f_28[0])) && !func_144()) && (GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_211(PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
		func_249(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
...
void func_202(int iParam0, var uParam1, vector3 vParam2)
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (!IS_STRING_NULL_OR_EMPTY(uParam1))
		{
			...
			{
				if (func_211(PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_205(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_211(PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_207(iParam0);
				}
			}
...
float func_211(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_215(uParam1) || !IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_215(uParam1) && uParam1->f_4 == 0) && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			if (DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_220(PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_223(int iParam0, float fParam1)
{
	...
	if (func_199(PLAYER_PED_ID()) && func_199(iParam0))
	{
...
{
	return func_225(iParam0, PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
...
int func_226(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
int func_229(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_231(GET_ENTITY_COORDS(iParam1, 1) - GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		vVar3 = { func_231(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_235(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_199(PLAYER_PED_ID()) && func_199(uParam0))
	{
...
int func_236(var uParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_237(var uParam0, float fParam1)
{
	...
	{
		if (func_238(uParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_238(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_231(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_231(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_230(vVar3, vVar0);
...
int func_239(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (IS_PED_SHOOTING(PLAYER_PED_ID()))
...
void func_249(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_252(var uParam0, bool bParam1)
{
	...
	func_253(uParam0, iLocal_93, vVar0, fVar3);
...
void func_253(var uParam0, int iParam1, vector3 vParam2, float fParam5)
{
	func_254(uParam0);
...
void func_255(var uParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	func_256(uParam0);
...
int func_257(var uParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_258(uParam0, iParam1, vParam2, fParam5, 1))
	{
		if (DOES_ENTITY_EXIST(*uParam0))
		{
			if (!IS_ENTITY_DEAD(*uParam0, 0))
...
int func_258(var uParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	int iVar0;
...
int func_265(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_263(&iVar0) || !HAS_ANIM_DICT_LOADED("rcmjosh3"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 3:
			if (func_199(uParam0->f_28[0]))
			{
				SET_PED_CONFIG_FLAG(uParam0->f_28[0], 118, 0);
				SET_PED_CONFIG_FLAG(uParam0->f_28[0], 208, 1);
				uParam0->f_59 = CREATE_SYNCHRONIZED_SCENE(563.76f, -1773.86f, 28.36f, 0f, 0.05f, -110.7f, 2);
				TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uParam0->f_59, "rcmjosh3", "sit_stairs_idle", 8f, -8f, 17, 0, 1148846080, 0);
...
{
	func_253(uParam0, iLocal_93, 558.09f, -1765.39f, 28.86f, 335.3252f);
	SET_VEHICLE_COLOUR_COMBINATION(*uParam0, 4);
...
int func_267(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_263(&iVar0) || !HAS_ANIM_DICT_LOADED("rcmjosh2"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 3:
			if (func_199(uParam0->f_28[0]))
			{
				...
				uLocal_94 = CREATE_SYNCHRONIZED_SCENE(563.76f, -1773.86f, 28.36f, 0.02f, 0.02f, -110.7f, 2);
				SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_94, 1);
				TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_94, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
...
int func_268(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 3:
			SET_PED_PATHS_IN_AREA(-1112.67f, 287.38f, 62.85f, -1096.41f, 297.5f, 65.59f, 0, 0);
			iVar3 = 0;
			while (iVar3 <= (iVar0 - 1))
			{
				SET_MODEL_AS_NO_LONGER_NEEDED(iVar0[iVar3]);
...
int func_269(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		_SET_DOOR_AJAR_ANGLE(904342475, 0f, 0, 0);
		_SET_DOOR_ACCELERATION_LIMIT(904342475, 4, 0, 1);
		iVar0++;
	}
	else
	...
	if (bParam1)
	{
		_SET_DOOR_AJAR_ANGLE(-795418380, 0f, 0, 0);
		_SET_DOOR_ACCELERATION_LIMIT(904342475, 4, 0, 1);
		iVar0++;
	}
	else
...
int func_280(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_281((*iParam0)[0], vParam2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_281((*iParam0)[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_281(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_282(Var1.f_6, vParam1, fParam4, 0))
	{
