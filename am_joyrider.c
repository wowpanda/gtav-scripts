...
void __EntryFunction__()
{
	...
	iLocal_43 = 64;
	iLocal_207 = 20;
	if (NETWORK_IS_GAME_IN_PROGRESS() && func_71(PLAYER_ID(), 0, 1))
	{
	...
	while (true)
	{
		...
		switch (func_43(PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				...
				{
					func_41();
					vLocal_105[PARTICIPANT_ID_TO_INT() /*3*/] = 1;
				}
				else if (func_42() == 4)
				{
					vLocal_105[PARTICIPANT_ID_TO_INT() /*3*/] = 3;
				}
				break;
			...
			case 3:
				...
				{
					vLocal_105[PARTICIPANT_ID_TO_INT() /*3*/] = 4;
				}
				break;
...
int func_2()
{
	if (Local_93.f_9 == 0)
	{
		...
		else
		{
			if (iLocal_210 == 1)
			{
				if (IS_BIT_SET(Local_93.f_1, 0))
				{
					return 1;
				}
			}
			if (!IS_PED_IN_VEHICLE(NET_TO_PED(Local_93.f_3), NET_TO_VEH(Local_93.f_2), 0))
			{
				return 1;
			}
		}
...
void func_7()
{
	...
	{
		iLocal_210 = 0;
		SET_BIT(&(Local_93.f_1), 0);
	}
	if (func_4(Local_93.f_2))
	{
		iVar0 = 1;
	}
	if (NETWORK_IS_PARTICIPANT_ACTIVE(INT_TO_PARTICIPANTINDEX(iLocal_209)))
	{
		iVar1 = NETWORK_GET_PLAYER_INDEX(INT_TO_PARTICIPANTINDEX(iLocal_209));
		...
		if (func_71(iVar1, 1, 1))
		{
			if (IS_BIT_SET(Local_93.f_1, 0))
			{
				if (iVar0 == 1)
				{
					if (IS_ENTITY_AT_ENTITY(uVar2, NET_TO_VEH(Local_93.f_2), 250f, 250f, 250f, 0, 1, 0))
					{
						CLEAR_BIT(&(Local_93.f_1), 0);
					}
				}
				else
				{
	...
	iLocal_209++;
	if (iLocal_209 == _NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		iLocal_209 = 0;
		iLocal_210 = 1;
	}
...
int func_9()
{
	...
	if ((!NETWORK_DOES_NETWORK_ID_EXIST(Local_93.f_3) && func_34(Local_93.f_5)) && NETWORK_DOES_NETWORK_ID_EXIST(Local_93.f_2))
	{
		if (func_4(Local_93.f_2))
		{
			if (func_11(&(Local_93.f_3), Local_93.f_2, 22, Local_93.f_5, -1, 1, 1, 1))
			{
				SET_PED_RANDOM_COMPONENT_VARIATION(NET_TO_PED(Local_93.f_3), 0);
				if (func_10())
				{
					SET_PED_RELATIONSHIP_GROUP_HASH(NET_TO_PED(Local_93.f_3), Global_1574989);
				}
				else
				{
					SET_PED_RELATIONSHIP_GROUP_HASH(NET_TO_PED(Local_93.f_3), Global_1574992);
				}
				SET_PED_KEEP_TASK(NET_TO_PED(Local_93.f_3), 1);
				if (func_10())
				{
					iVar0 = GET_RANDOM_INT_IN_RANGE(0, 10);
					if (iVar0 < 5)
					{
						GIVE_DELAYED_WEAPON_TO_PED(NET_TO_PED(Local_93.f_3), joaat("weapon_pistol"), 25000, func_10());
					}
					else if (iVar0 > 6)
					{
						GIVE_DELAYED_WEAPON_TO_PED(NET_TO_PED(Local_93.f_3), joaat("weapon_microsmg"), 25000, func_10());
					}
					else
					{
						GIVE_DELAYED_WEAPON_TO_PED(NET_TO_PED(Local_93.f_3), joaat("weapon_pumpshotgun"), 25000, func_10());
					}
				}
				iVar0 = GET_RANDOM_INT_IN_RANGE(0, 10);
				if (iVar0 == 0 || iVar0 == 1)
				{
					SET_PED_COMBAT_ABILITY(NET_TO_PED(Local_93.f_3), 0);
				}
				else if ((iVar0 == 2 || iVar0 == 3) || iVar0 == 4)
				{
					SET_PED_COMBAT_ABILITY(NET_TO_PED(Local_93.f_3), 2);
				}
				else
				{
					SET_PED_COMBAT_ABILITY(NET_TO_PED(Local_93.f_3), 1);
				}
				iVar0 = GET_RANDOM_INT_IN_RANGE(0, 4);
				if (iVar0 == 0)
				{
					SET_PED_COMBAT_ATTRIBUTES(NET_TO_PED(Local_93.f_3), 5, 1);
				}
				else if (iVar0 == 1)
				{
					SET_PED_COMBAT_ATTRIBUTES(NET_TO_PED(Local_93.f_3), 17, 1);
				}
				else if (iVar0 == 2)
				{
					SET_PED_COMBAT_ATTRIBUTES(NET_TO_PED(Local_93.f_3), 13, 1);
				}
				if (func_10())
				{
					SET_PED_COMBAT_ATTRIBUTES(NET_TO_PED(Local_93.f_3), 20, 1);
				}
				if (func_10())
				{
					SET_PED_COMBAT_ATTRIBUTES(NET_TO_PED(Local_93.f_3), 2, 1);
				}
				iVar0 = GET_RANDOM_INT_IN_RANGE(0, 4);
				if (iVar0 == 0)
				{
					SET_PED_COMBAT_MOVEMENT(NET_TO_PED(Local_93.f_3), 2);
				}
				else if (iVar0 == 1)
				{
					SET_PED_COMBAT_MOVEMENT(NET_TO_PED(Local_93.f_3), 1);
				}
				else if (iVar0 == 2)
				{
					SET_PED_COMBAT_MOVEMENT(NET_TO_PED(Local_93.f_3), 3);
				}
				_0x49E50BDB8BA4DAB2(NET_TO_PED(Local_93.f_3), 1);
				SET_PED_GET_OUT_UPSIDE_DOWN_VEHICLE(NET_TO_PED(Local_93.f_3), 1);
				SET_PED_CONFIG_FLAG(NET_TO_PED(Local_93.f_3), 29, 1);
				SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(NET_TO_PED(Local_93.f_3), 3);
				SET_ENTITY_HEALTH(NET_TO_PED(Local_93.f_3), ROUND((200f * Global_262145.f_153)), 0);
				SET_VEHICLE_RADIO_LOUD(NET_TO_VEH(Local_93.f_2), 1);
				_0x25367DE49D64CF16(NET_TO_VEH(Local_93.f_2), 1);
				func_41();
				TASK_PERFORM_SEQUENCE(NET_TO_PED(Local_93.f_3), uLocal_203);
				SET_MODEL_AS_NO_LONGER_NEEDED(Local_93.f_5);
			}
		}
	}
	if (!NETWORK_DOES_NETWORK_ID_EXIST(Local_93.f_3))
	{
		return 0;
	}
	return 1;
...
int func_12()
{
	...
	if (!NETWORK_DOES_NETWORK_ID_EXIST(Local_93.f_2))
	{
		if (func_34(Local_93.f_4))
		{
			if (func_16(&vVar0, &uVar3))
			{
				if (func_13(&(Local_93.f_2), Local_93.f_4, vVar0, uVar3, 1, 1, 1, 0, 1, 1, 0, 0, 0, 0))
				{
					SET_VEHICLE_ENGINE_ON(NET_TO_VEH(Local_93.f_2), 1, 1, 0);
					SET_VEHICLE_IS_WANTED(NET_TO_VEH(Local_93.f_2), 1);
					SET_VEHICLE_IS_STOLEN(NET_TO_VEH(Local_93.f_2), 1);
					_DYNAMIC_MIXER_RELATED_FN(NET_TO_VEH(Local_93.f_2), "JOYRIDER_GROUP", 0f);
					SET_MODEL_AS_NO_LONGER_NEEDED(Local_93.f_4);
				}
			}
		}
	}
...
int func_13(var uParam0, int iParam1, vector3 vParam2, var uParam5, int iParam6, int iParam7, bool bParam8, int iParam9, int iParam10, bool bParam11, bool bParam12, bool bParam13, int iParam14, bool bParam15)
{
	float fVar0;
	int iVar1;
	...
	if (DOES_ENTITY_EXIST(iVar1))
	{
		*uParam0 = VEH_TO_NET(iVar1);
		...
		if (NETWORK_DOES_NETWORK_ID_EXIST(*uParam0))
		{
			...
			func_14(vParam2, uParam5, iParam1, iVar1);
			return 1;
		}
	}
	return 0;
...
void func_14(vector3 vParam0, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	
	if (func_15(PLAYER_ID(), vParam0, iParam4) > -1)
	{
...
int func_15(var uParam0, vector3 vParam1, int iParam4)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
bool func_16(var uParam0, var uParam1)
{
	...
	if (!bVar0)
	{
		if (_0xA4822F1CF23F4810(&(Local_93.f_6), uParam0, &uVar2, 0f, 180f, 40f, 0, 1, 1))
		{
			...
			{
				if (GET_DISTANCE_BETWEEN_COORDS(-1367.557f, -3220.598f, 12.9448f, Local_93.f_6, 1) >= 600f && GET_DISTANCE_BETWEEN_COORDS(750f, -3200f, 6f, Local_93.f_6, 1) >= 700f)
				{
					if (GET_DISTANCE_BETWEEN_COORDS(func_33(PLAYER_ID()), *uParam0, 1) <= (250f - 50f))
					{
						if (iLocal_208 <= 5)
						{
	...
	if (iParam4 && !bParam7)
	{
		if (func_71(PLAYER_ID(), 1, 1))
		{
			if (!IS_SCREEN_FADED_OUT())
			{
				...
				if (GET_DISTANCE_BETWEEN_COORDS(func_23(PLAYER_ID()), vParam0, 1) <= (fVar2 + fParam3))
				{
	...
	while (iVar0 < 32)
	{
		...
		if (func_71(iVar1, 1, 1))
		{
			if (!func_20(iVar1, 0) && _NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER_ID(), iVar1))
			{
				...
				{
					if ((func_19(iVar1) || !bParam10) && !Global_2424047[iVar1 /*416*/].f_259)
					{
						fVar2 = fParam6;
						if (fParam9 > 0f)
						{
						...
						if (!bParam7)
						{
							...
							{
								if (GET_DISTANCE_BETWEEN_COORDS(func_23(iVar1), vParam0, 1) <= (fVar2 + fParam3))
								{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && PLAYER_ID() != iVar1) || iParam8 == 0)
		{
			if (func_71(iVar1, bParam4, bParam5))
			{
				...
				{
					if (!bParam7 || (!IS_PED_INJURED(GET_PLAYER_PED(iVar1)) && func_19(iVar1)))
					{
						if ((!bParam6 || (bParam6 == 1 && GET_PLAYER_TEAM(PLAYER_ID()) != GET_PLAYER_TEAM(iVar1))) || GET_PLAYER_TEAM(PLAYER_ID()) == -1)
						{
							if (((GET_PLAYER_TEAM(PLAYER_ID()) == -1 && uParam9) && bParam6) && func_27(iVar1))
							{
							}
							else if (DOES_ENTITY_EXIST(GET_PLAYER_PED(iVar1)))
							{
								if (GET_DISTANCE_BETWEEN_COORDS(func_33(iVar1), vParam0, 1) < fParam3)
								{
									return 1;
								}
							}
...
int func_32(var uParam0, var uParam1)
{
	...
	{
		Global_2505680 = { func_31(uParam0) };
		Global_2505693 = { func_31(uParam1) };
...
bool func_35()
{
	if (!IS_BIT_SET(uLocal_202, 1))
	{
		if (GET_NTH_CLOSEST_VEHICLE_NODE(func_33(PLAYER_ID()), iLocal_206, &(Local_93.f_6), 4, 1077936128, 0))
		{
			SET_BIT(&uLocal_202, 1);
		}
		else
		{
			iLocal_206++;
	...
	return IS_BIT_SET(uLocal_202, 1);
}
...
void func_39()
{
	switch (vLocal_105[PARTICIPANT_ID_TO_INT() /*3*/].f_2)
	{
		case 0:
			func_41();
			func_40();
			if (Local_93.f_9 > 0)
			{
				vLocal_105[PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 1;
			}
			break;
...
void func_40()
{
	...
	if (!IS_BIT_SET(vLocal_105[PARTICIPANT_ID_TO_INT() /*3*/].f_1, 0))
	{
		if (func_4(Local_93.f_2) && !func_3(Local_93.f_3))
		{
			iVar0 = GET_ENTITY_HEALTH(NET_TO_VEH(Local_93.f_2));
			fVar1 = GET_ENTITY_SPEED(NET_TO_VEH(Local_93.f_2));
			if (iVar0 < 200)
			{
				func_41();
				TASK_PERFORM_SEQUENCE(NET_TO_PED(Local_93.f_3), uLocal_205);
				SET_BIT(&(vLocal_105[PARTICIPANT_ID_TO_INT() /*3*/].f_1), 0);
			}
			else if (fVar1 < 3f)
			{
				if ((((IS_ENTITY_UPSIDEDOWN(NET_TO_VEH(Local_93.f_2)) || IS_VEHICLE_STUCK_TIMER_UP(NET_TO_VEH(Local_93.f_2), 3, 10000)) || IS_VEHICLE_STUCK_TIMER_UP(NET_TO_VEH(Local_93.f_2), 1, 10000)) || IS_VEHICLE_STUCK_TIMER_UP(NET_TO_VEH(Local_93.f_2), 0, 10000)) || IS_VEHICLE_STUCK_TIMER_UP(NET_TO_VEH(Local_93.f_2), 2, 10000))
				{
					func_41();
					TASK_PERFORM_SEQUENCE(NET_TO_PED(Local_93.f_3), uLocal_204);
					SET_BIT(&(vLocal_105[PARTICIPANT_ID_TO_INT() /*3*/].f_1), 0);
				}
			}
		}
...
void func_41()
{
	if (!IS_BIT_SET(uLocal_202, 0))
	{
		if (func_4(Local_93.f_2))
		{
			OPEN_SEQUENCE_TASK(&uLocal_203);
			TASK_VEHICLE_MISSION_COORS_TARGET(0, NET_TO_VEH(Local_93.f_2), Local_93.f_6, 14, 30f, 786468, 15f, 1f, 0);
			TASK_VEHICLE_DRIVE_WANDER(0, NET_TO_VEH(Local_93.f_2), 30f, 786468);
			CLOSE_SEQUENCE_TASK(uLocal_203);
			OPEN_SEQUENCE_TASK(&uLocal_204);
			TASK_LEAVE_ANY_VEHICLE(0, 0, 1);
			CLOSE_SEQUENCE_TASK(uLocal_204);
			OPEN_SEQUENCE_TASK(&uLocal_205);
			TASK_VEHICLE_MISSION_COORS_TARGET(0, NET_TO_VEH(Local_93.f_2), Local_93.f_6, 5, 30f, 786468, 99999f, 1f, 0);
			TASK_LEAVE_ANY_VEHICLE(0, 0, 1);
			CLOSE_SEQUENCE_TASK(uLocal_205);
			SET_BIT(&uLocal_202, 0);
		}
	}
}
...
int func_46(int iParam0)
{
	...
	while (iVar0 < 32)
	{
		if (func_71(INT_TO_PLAYERINDEX(iVar0), 0, 1))
		{
...
int func_48()
{
	...
	if (func_49() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_49()) == 0)
		{
			return 1;
		}
	}
...
void func_60()
{
	...
	{
		SET_VEHICLE_MODEL_IS_SUPPRESSED(Local_93.f_4, 0);
	}
	if (func_4(Local_93.f_2))
	{
		_0x18EB48CFC41F2EA0(NET_TO_VEH(Local_93.f_2), 0f);
	}
...
void func_63()
{
	CLEAR_SEQUENCE_TASK(&uLocal_203);
}
...
void func_64(struct<21> Param0)
{
	...
	func_67(0, -1, 0);
	NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_93, 12);
	NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&vLocal_105, 97);
	if (!func_66())
	{
		func_60();
	}
	if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		if (NETWORK_IS_HOST_OF_THIS_SCRIPT())
		{
			...
			SET_VEHICLE_MODEL_IS_SUPPRESSED(Local_93.f_4, 1);
			Local_93.f_5 = func_65(1);
		}
		func_62(9, 1);
		START_AUDIO_SCENE("JOYRIDER_RADIO_SCENE");
		vLocal_105[PARTICIPANT_ID_TO_INT() /*3*/] = 0;
	}
	else
	{
		func_60();
