...
void func_8(bool bParam0)
{
	...
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("boxville3"), 0);
	SET_PED_MODEL_IS_SUPPRESSED(joaat("s_m_m_armoured_01"), 0);
	if (func_20())
	{
		func_13(0);
	}
	...
	if (DOES_ENTITY_EXIST(iLocal_1316))
	{
		if (bParam0)
		{
			DELETE_VEHICLE(&iLocal_1316);
		}
		else
		{
			SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_1316);
		}
	}
	if (DOES_ENTITY_EXIST(vLocal_1306.x))
	{
		if (bParam0)
		{
			DELETE_PED(&vLocal_1306);
		}
		else
		{
			SET_PED_AS_NO_LONGER_NEEDED(&vLocal_1306);
		}
	}
	if (DOES_ENTITY_EXIST(Local_1318))
	{
		if (bParam0 && !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			DELETE_VEHICLE(&Local_1318);
		}
		else
		{
			SET_VEHICLE_AS_NO_LONGER_NEEDED(&Local_1318);
		}
	}
	iVar0 = 0;
	while (iVar0 < Local_1322)
	{
		if (DOES_ENTITY_EXIST(Local_1322[iVar0 /*2*/]))
		{
			if (bParam0)
			{
				DELETE_OBJECT(&(Local_1322[iVar0 /*2*/]));
			}
			else
			{
				if (IS_ENTITY_ATTACHED(Local_1322[iVar0 /*2*/]))
				{
					DETACH_ENTITY(Local_1322[iVar0 /*2*/], 1, 1);
				}
				SET_OBJECT_AS_NO_LONGER_NEEDED(&(Local_1322[iVar0 /*2*/]));
			}
		}
		iVar0++;
	}
	if (DOES_ENTITY_EXIST(uLocal_1329))
	{
		if (bParam0)
		{
			DELETE_OBJECT(&uLocal_1329);
		}
		else
		{
			if (IS_ENTITY_ATTACHED(uLocal_1329))
			{
				DETACH_ENTITY(uLocal_1329, 1, 1);
			}
			SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_1329);
		}
	}
	if (iLocal_1330 != 0)
	{
		REMOVE_SCENARIO_BLOCKING_AREA(iLocal_1330, 0);
	}
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (HAS_PED_GOT_WEAPON(PLAYER_PED_ID(), joaat("weapon_briefcase"), 0))
		{
...
int func_22()
{
	...
	if (!iLocal_95)
	{
		if (func_193(Local_1318))
		{
			if (GET_BLIP_FROM_ENTITY(Local_1318) != 0)
			{
				Local_1318.f_1 = GET_BLIP_FROM_ENTITY(Local_1318);
			}
			else
			{
				Local_1318.f_1 = func_192(Local_1318, 0, 0);
			}
			func_191("JHP2A_STEAL", 7500, 1);
			func_190("JHP2A_HLP2", 15000);
		}
		else if (GET_BLIP_FROM_ENTITY(Local_1318) != 0)
		{
			SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(1);
			uVar7 = GET_BLIP_FROM_ENTITY(Local_1318);
			REMOVE_BLIP(&uVar7);
	...
	if (iLocal_95)
	{
		...
		{
			case 1:
				if ((((((iLocal_1303 == 0 && DOES_ENTITY_EXIST(Local_1318)) && IS_VEHICLE_DRIVEABLE(Local_1318, 0)) && DOES_ENTITY_EXIST(vLocal_1306.x)) && !IS_PED_INJURED(vLocal_1306.x)) && IS_PED_IN_VEHICLE(vLocal_1306.x, Local_1318, 0)) && func_129(&(Local_1084[0 /*8*/])))
				{
					func_100(&uLocal_1291, Local_1318, 0, 0, 1, 1, 1);
				}
				else
				{
					func_11(&uLocal_1291, 0, 0);
				...
				else if ((DOES_ENTITY_EXIST(iLocal_1320) && IS_VEHICLE_DRIVEABLE(iLocal_1320, 0)) && IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_1320, Local_1318))
				{
					if (DOES_BLIP_EXIST(Local_1318.f_1))
					{
						_0x293220DA1B46CEBC(5f, 5f, 4);
						SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(1);
						REMOVE_BLIP(&(Local_1318.f_1));
						SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(0);
						func_96(705, 0);
					}
					func_95(&uLocal_1101, vVar0, 0.1f, 0.1f, 0.1f, 1, iLocal_1320, "JHP2A_RTNVAN", "", "", 1, 0, 1, -1);
					if (IS_ENTITY_IN_ANGLED_AREA(Local_1318, 692.9143f, -1003.556f, 21.50839f, 692.6511f, -1021.604f, 26.20675f, 9.75f, 0, 1, 0))
					{
						_SET_VEHICLE_HALT(iLocal_1320, 5f, -1, 0);
						iLocal_94 = 101;
					}
				}
				...
				{
					func_97(&uLocal_1101, 1, 0);
					if (!DOES_BLIP_EXIST(Local_1322[0 /*2*/].f_1))
					{
						_0x293220DA1B46CEBC(5f, 5f, 4);
						Local_1322[0 /*2*/].f_1 = func_94(Local_1322[0 /*2*/]);
						func_191("JHP2A_TAKEBZ", 7500, 1);
						iLocal_1345 = 1;
						SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_1318, 0);
					}
				}
				else if (iLocal_1303 == 0)
				{
					...
					if (func_92(&uLocal_1101, vVar0, 692.9143f, -1003.556f, 21.50839f, 692.6511f, -1021.604f, 26.20675f, 9.75f, 1, Local_1318, "JHP2A_RTNVAN", "", "", IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_1318, 0), 0, 1, -1))
					{
						iLocal_94 = 101;
					}
					if (DOES_BLIP_EXIST(uLocal_1101) && _0xDD2238F57B977751(uLocal_1101))
					{
						SET_BLIP_ROUTE(uLocal_1101, 0);
					}
				}
				break;
			
			case 101:
				if (DOES_ENTITY_EXIST(Local_1318) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_1318, 0))
				{
					iVar8 = Local_1318;
				}
				else if (DOES_ENTITY_EXIST(iLocal_1320) && IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_1320, Local_1318))
				{
					iVar8 = iLocal_1320;
				}
				if (func_90(iVar8, 1093140480, 1, 1056964608, 0, 1, 0))
				{
					if (func_7(87))
					{
						_0x293220DA1B46CEBC(5f, 5f, 4);
			...
			case 102:
				if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
				{
					CLEAR_PRINTS();
					SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_1318, 0);
					_0x2B6747FAA9DB9D6B(Local_1318, 1);
					if (DOES_ENTITY_EXIST(iLocal_1320))
					{
						_SET_VEHICLE_HALT(iLocal_1320, 5f, 1, 0);
					}
					func_89(0, -1);
					if (DOES_ENTITY_EXIST(Local_1322[0 /*2*/]))
					{
						DELETE_OBJECT(&(Local_1322[0 /*2*/]));
					}
					if (DOES_ENTITY_EXIST(Local_1322[1 /*2*/]))
					{
						DELETE_OBJECT(&(Local_1322[1 /*2*/]));
					}
					if (DOES_ENTITY_EXIST(Local_1322[2 /*2*/]))
					{
						DELETE_OBJECT(&(Local_1322[2 /*2*/]));
					}
					return 1;
				}
				break;
			...
			case 2:
				if (!HAS_PED_GOT_WEAPON(PLAYER_PED_ID(), joaat("weapon_briefcase"), 0))
				{
					...
					{
						if (DOES_ENTITY_EXIST(Local_1322[iVar6 /*2*/]) && !IS_ENTITY_ATTACHED(Local_1322[iVar6 /*2*/]))
						{
							if (DOES_BLIP_EXIST(Local_1318.f_1))
							{
								SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(1);
							...
							if (!DOES_BLIP_EXIST(Local_1322[iVar6 /*2*/].f_1))
							{
								Local_1322[iVar6 /*2*/].f_1 = func_94(Local_1322[iVar6 /*2*/]);
							}
						}
						iVar6++;
					}
					...
					while (iVar6 < Local_1322)
					{
						if (DOES_ENTITY_EXIST(Local_1322[iVar6 /*2*/]) && !IS_ENTITY_ATTACHED(Local_1322[iVar6 /*2*/]))
						{
							if (!HAS_PED_GOT_WEAPON(PLAYER_PED_ID(), joaat("weapon_briefcase"), 0))
							{
								bVar9 = func_88(Local_1322[iVar6 /*2*/]);
								if ((bVar9 && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, 0f, -3f, -0.5f), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, 0f, -4.5f, 1f), 1.68f, 0, 1, 1)) || (!bVar9 && IS_ENTITY_AT_COORD(PLAYER_PED_ID(), GET_ENTITY_COORDS(Local_1322[iVar6 /*2*/], 1), 0.75f, 0.75f, 4f, 0, 0, 1)))
								{
									GIVE_WEAPON_TO_PED(PLAYER_PED_ID(), joaat("weapon_briefcase"), 1, 0, 0);
									DELETE_OBJECT(&(Local_1322[iVar6 /*2*/]));
									CLEAR_PRINTS();
									PLAY_SOUND_FRONTEND(-1, "PICKUP_WEAPON_SMOKEGRENADE", "HUD_FRONTEND_WEAPONS_PICKUPS_SOUNDSET", 1);
								}
							}
						}
						iVar6++;
				...
				else
				{
					...
					while (iVar6 < Local_1322)
					{
						if (DOES_BLIP_EXIST(Local_1322[iVar6 /*2*/].f_1))
						{
							REMOVE_BLIP(&(Local_1322[iVar6 /*2*/].f_1));
						}
						iVar6++;
					}
					func_42(&uLocal_1101, vVar3, 0.1f, 0.1f, 0.1f, 0, "JHP2A_RTNBZ", 1, 1, -1, 1);
					GET_CURRENT_PED_WEAPON(PLAYER_PED_ID(), &iVar10, 1);
					if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), 722.9849f, -965.7473f, 32.29691f, 50f, 40f, 11.4375f, 0, 1, 0))
					{
						iVar12 = 1;
					}
					if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 709.7432f, -960.3367f, 29.39533f, 703.6478f, -960.3293f, 33.65119f, 4.125f, 0, 1, 0))
					{
						bVar11 = true;
					}
					if (bVar11 || ((iVar12 && !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) && iLocal_1352))
					{
						...
						{
							if (!IS_PED_IN_COVER(PLAYER_PED_ID(), 0) && !func_18(0))
							{
								if (iVar10 != joaat("weapon_briefcase"))
								{
									SET_CURRENT_PED_WEAPON(PLAYER_PED_ID(), joaat("weapon_briefcase"), 1);
								}
							}
						}
					}
					if (bVar11)
					{
						...
						if (IS_CONTROL_JUST_PRESSED(0, 51) && iVar10 == joaat("weapon_briefcase"))
						{
							if (func_12("JHP2A_HLP1"))
							{
								CLEAR_HELP(1);
							}
							uVar13 = GET_WEAPON_OBJECT_FROM_PED(PLAYER_PED_ID(), 1);
							ACTIVATE_PHYSICS(uVar13);
							_0x293220DA1B46CEBC(3f, 5f, 4);
							PLAY_SOUND_FROM_ENTITY(-1, "Drop_Case", uVar13, "JWL_PREP_2A_SOUNDS", 0, 0);
							SET_OBJECT_AS_NO_LONGER_NEEDED(&uVar13);
					...
					iLocal_1352 = IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1);
				}
				break;
			...
			case 1000:
				...
				if (func_36())
				{
					if (func_25(&uLocal_1126, 12, "JHFAUD", "JHF_BZD2", 8, 1, 0, 0, 0))
					{
						_0x293220DA1B46CEBC(5f, 5f, 4);
						iLocal_94++;
					}
...
void func_38(bool bParam0, bool bParam1)
{
	...
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
	{
		...
		SET_PED_RESET_FLAG(PLAYER_PED_ID(), 102, 1);
	}
...
void func_39(bool bParam0)
{
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
	{
		...
		SET_PED_CONFIG_FLAG(PLAYER_PED_ID(), 157, 0);
		SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 1);
...
int func_42(var uParam0, vector3 vParam1, vector3 vParam4, int iParam7, char* sParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	return func_43(uParam0, vParam1, vParam4, func_87(), func_87(), iParam7, 3, 0, 0, 0, 0, sParam8, func_86(), func_86(), func_86(), func_86(), func_86(), 0, bParam9, func_86(), 0, 0, bParam10, iParam11, func_86(), func_86(), func_86(), bParam12, 1065353216);
}
...
int func_43(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, char* sParam19, char* sParam20, char* sParam21, char* sParam22, char* sParam23, char* sParam24, bool bParam25, bool bParam26, char* sParam27, bool bParam28, int iParam29, bool bParam30, int iParam31, int iParam32, int iParam33, int iParam34, bool bParam35, int iParam36)
{
	...
	func_84(uParam0);
	func_83();
	if (func_66(uParam0, uParam0->f_17[0], uParam0->f_17[1], uParam0->f_17[2], sParam20, sParam21, sParam22, sParam23, uParam0->f_8, bParam25, iParam18, 0, 0, iParam32, iParam33, iParam34, iParam14, bParam26))
	{
		func_65(sParam20);
		func_65(sParam21);
		func_65(sParam22);
		...
		if (IS_SCREEN_FADED_IN())
		{
			...
			if (bVar1)
			{
				...
				if (bParam26 && IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0))
				{
					...
					if ((!func_60(uParam0, 1) && !func_59(uParam0)) && !IS_BIT_SET(uParam0->f_13, 0))
					{
						if (bParam30)
						{
							func_58(uParam0, "LOSE_WANTED", 0);
							if (!IS_PED_INJURED(uParam0->f_17[0]))
							{
								func_56(uParam0->f_17[0], "VEHICLE_POLICE_PURSUIT", 3);
							}
						}
				...
				else
				{
					...
					if (IS_BIT_SET(uParam0->f_13, 1))
					{
						if (!func_60(uParam0, 1))
						{
							if (!IS_PED_INJURED(uParam0->f_17[0]))
							{
								func_56(uParam0->f_17[0], "LOSE_WANTED_LEVEL", 3);
							}
							CLEAR_BIT(&(uParam0->f_13), 1);
						}
					}
					if (!DOES_BLIP_EXIST(uParam0->f_5))
					{
						...
						if (bParam35)
						{
							func_54(uParam0->f_5, uParam0);
						}
					}
					else if (!func_53(vVar3, GET_BLIP_COORDS(uParam0->f_5), 0.1f, 0))
					{
					...
					if (bVar1)
					{
						...
						while (iVar2 < 3)
						{
							if (!IS_PED_INJURED(uParam0->f_17[iVar2]))
							{
								...
								else if (!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar2], func_52()) || !func_50(uParam0->f_17[iVar2], 1))
								{
									bVar1 = false;
								}
							}
						...
						if (!func_60(uParam0, 2))
						{
							...
							else if (IS_BIT_SET(uParam0->f_13, 9))
							{
								...
								if (!IS_BIT_SET(uParam0->f_13, 23))
								{
									if (!IS_PED_INJURED(uParam0->f_17[0]))
									{
										func_56(uParam0->f_17[0], "GET_IN_CAR", 3);
									}
						...
						if (!func_60(uParam0, 2))
						{
							if (IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()))
							{
								if (!IS_BIT_SET(uParam0->f_13, 13))
								{
									...
									{
										func_56(uParam0->f_17[iVar9], "NEED_A_BIGGER_VEHICLE", 3);
									}
...
int func_45(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_46(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		SET_BLIP_SCALE(uVar0, func_46(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
int func_47(var uParam0)
{
	if (IS_BIT_SET(uParam0->f_13, 12))
	{
		...
		{
			if (func_48(1, 0, 1) || IS_BIT_SET(uParam0->f_13, 7))
			{
				return 1;
			}
		}
	}
	else if (func_48(1, 0, 1) || IS_BIT_SET(uParam0->f_13, 7))
	{
		return 1;
	}
	return 0;
...
int func_50(var uParam0, int iParam1)
{
	if (!IS_PED_INJURED(uParam0))
	{
		...
		{
			if (func_51(PLAYER_PED_ID(), uParam0))
			{
				SET_GROUP_SEPARATION_RANGE(func_52(), 50f);
				return 1;
			}
		}
		else if (IS_PED_GROUP_MEMBER(uParam0, func_52()))
		{
			SET_GROUP_SEPARATION_RANGE(func_52(), 50f);
			return 1;
		}
...
var func_55(vector3 vParam0, int iParam3)
{
	var uVar0;
...
{
	_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_57(iParam2), 1);
}
...
void func_58(var uParam0, char* sParam1, bool bParam2)
{
	if (!bParam2)
	{
...
int func_63(var uParam0, int iParam1)
{
	...
	{
		uVar0 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
		if (func_64(uVar0, uParam0, iParam1))
		{
			return 1;
		}
	}
...
int func_66(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, var uParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17)
{
	int iVar0;
	int iVar1;
	int iVar2;
						...
						if (func_64(uParam0->f_21, uParam0, iVar3))
						{
							...
							while (iVar0 < 3)
							{
								if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
								{
									...
									if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_52()))
									{
										REMOVE_PED_FROM_GROUP(uParam0->f_17[iVar0]);
									}
									if (GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], -1794415470) == 7 && !func_82(uParam0->f_17[iVar0], uParam0->f_21))
									{
		...
		if (bVar23)
		{
			...
			while (iVar0 < 3)
			{
				if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
				{
					...
					if (!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_52()))
					{
						if (func_80(uParam0, uParam0->f_17[iVar0], uParam8, 1))
						{
							SET_PED_AS_GROUP_MEMBER(uParam0->f_17[iVar0], func_52());
						}
					}
				}
				iVar0++;
	...
	if (!IS_BIT_SET(uParam0->f_13, 26))
	{
		if ((!func_79(uParam0) && IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID())) && !DOES_ENTITY_EXIST(iParam10))
		{
			...
			if (IS_VEHICLE_DRIVEABLE(iVar13, 0))
			{
				if (!IS_BIT_SET(uParam0->f_13, 13))
				{
					...
					if (!func_60(uParam0, 2))
					{
						...
						{
							func_56(uParam0->f_17[iVar27], "NEED_A_BIGGER_VEHICLE", 3);
						}
						func_58(uParam0, "MORE_SEATS", 0);
						SET_BIT(&(uParam0->f_13), 13);
					}
		...
		if (!DOES_ENTITY_EXIST(iParam10))
		{
			if ((!IS_PED_INJURED(uParam0->f_17[0]) || !IS_PED_INJURED(uParam0->f_17[1])) || !IS_PED_INJURED(uParam0->f_17[2]))
			{
				...
				{
					if (IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()) && !func_60(uParam0, 2))
					{
						iVar13 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
						if (func_78(iVar13, uParam0))
						{
				...
				if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
				{
					...
					if (IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()))
					{
						...
						if (IS_VEHICLE_DRIVEABLE(iVar13, 0))
						{
							if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_52()))
							{
								if (!func_79(uParam0) && IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()))
								{
					...
					if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_52()))
					{
						...
						{
							if (func_64(uVar32, uParam0, 0))
							{
								if (func_76(iVar0, uParam0) || !IS_BIT_SET(uParam0->f_13, 27))
								{
									SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uParam0->f_17[iVar0], iVar0);
					...
					if ((!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_52()) && !func_73(uParam0->f_17[iVar0], iParam10)) && !func_72(uParam0->f_17[iVar0], iParam10))
					{
						if (func_80(uParam0, uParam0->f_17[iVar0], uParam8, bParam11))
						{
							if (!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_52()))
							{
					...
					{
						if (((func_50(uParam0->f_17[iVar0], 1) || func_73(uParam0->f_17[iVar0], iParam10)) || iParam12) || (IS_VEHICLE_DRIVEABLE(iParam10, 0) && !IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iParam10, 0)))
						{
							if (DOES_BLIP_EXIST(uParam0->f_1[iVar0]))
							{
								REMOVE_BLIP(&(uParam0->f_1[iVar0]));
								func_65(uVar15[iVar0]);
							}
						}
						else
						{
					...
					else if (IS_VEHICLE_DRIVEABLE(iParam10, 0))
					{
						if (!IS_PED_SITTING_IN_VEHICLE(uParam0->f_17[iVar0], iParam10))
						{
							if ((IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], iParam10, 20f, 20f, 5f, 0, 1, 0) && !IS_BIT_SET(uParam0->f_13, 11)) && !((bParam17 && IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) && !IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iParam10, 0)))
							{
								...
								else
								{
									...
									iVar14 = GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], -1794415470);
									if (iVar14 == 7 && !func_82(uParam0->f_17[iVar0], iParam10))
									{
										if (((((!IS_PED_JUMPING_OUT_OF_VEHICLE(uParam0->f_17[iVar0]) && !IS_PED_JUMPING_OUT_OF_VEHICLE(PLAYER_PED_ID())) && !func_71(uParam0->f_17[iVar0], 2f)) && !IS_PED_RAGDOLL(uParam0->f_17[iVar0])) && !IS_PED_GETTING_UP(uParam0->f_17[iVar0])) && !IS_ENTITY_ON_FIRE(iParam10))
										{
											SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_17[iVar0], 1);
							...
							else if (!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_52()))
							{
								if (func_80(uParam0, uParam0->f_17[iVar0], uParam8, bParam11))
								{
									if (!IS_PED_RAGDOLL(uParam0->f_17[iVar0]) && !IS_PED_GETTING_UP(uParam0->f_17[iVar0]))
						...
						else if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_52()) && !IS_ENTITY_ON_FIRE(iParam10))
						{
							REMOVE_PED_FROM_GROUP(uParam0->f_17[iVar0]);
						}
					}
			...
			if (iVar1 > 0)
			{
				...
				while (iVar0 < 3)
				{
					if (iVar7[iVar0])
					{
						if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
						{
							if (func_77(uParam0->f_17[iVar0]) || IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], PLAYER_PED_ID(), uParam0->f_8, uParam0->f_8, uParam0->f_8, 0, 1, 0))
							{
								iVar1 = (iVar1 - 1);
								iVar7[iVar0] = 0;
							}
					...
					{
						if (!IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], PLAYER_PED_ID(), (uParam0->f_8 * 0.85f), (uParam0->f_8 * 0.85f), uParam0->f_8, 0, 1, 0) && !func_77(uParam0->f_17[iVar0]))
						{
						}
					}
					iVar0++;
								...
								if (iVar7[iVar0])
								{
									if (!func_70(iVar0, uParam0))
									{
										if (!IS_STRING_NULL(uVar19[iVar0]))
										{
											...
											{
												func_68(uParam0, uVar15[iVar0], uVar19[iVar0], 0);
										...
										if (!func_70(iVar0, uParam0))
										{
											func_58(uParam0, uVar15[iVar0], 0);
											func_67(iVar0, uParam0);
											uParam0->f_12 = iVar1;
										}
									}
...
void func_68(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	if (!bParam3)
	{
		if (!IS_STRING_NULL(uParam1))
		{
			...
			{
				func_69(uParam1, uParam2, 7500, 1);
			}
		}
	}
	uParam0->f_10 = GET_GAME_TIMER();
...
int func_72(var uParam0, int iParam1)
{
	...
	if (!IS_PED_INJURED(uParam0))
	{
		if (!IS_PED_GROUP_MEMBER(uParam0, func_52()))
		{
...
int func_88(var uParam0)
{
	...
	if (IS_ENTITY_DEAD(Local_1318, 0))
	{
		return 0;
	}
	vVar0 = { _0x21C235BC64831E5A(GET_ENTITY_COORDS(uParam0, 1), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, vLocal_87), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, vLocal_90), 0) };
	if (VDIST2(vVar0, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, vLocal_87)) <= VDIST2(GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, vLocal_90), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, vLocal_87)))
	{
		return 1;
	}
	return 0;
...
int func_90(int iParam0, int iParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
bool func_92(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, int iParam10, int iParam11, int iParam12, char* sParam13, char* sParam14, char* sParam15, bool bParam16, int iParam17, bool bParam18, int iParam19)
{
	return func_43(uParam0, vParam1, func_93(), vParam4, vParam7, iParam11, 5, 0, 0, 0, iParam12, sParam13, func_86(), func_86(), func_86(), func_86(), sParam14, 0, bParam16, sParam15, 1, iParam17, bParam18, iParam19, func_86(), func_86(), func_86(), 1, iParam10);
}
...
{
	return func_45(uParam0, 1, 0);
}

int func_95(var uParam0, vector3 vParam1, vector3 vParam4, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11, bool bParam12, int iParam13, bool bParam14, int iParam15)
{
	return func_43(uParam0, vParam1, vParam4, func_87(), func_87(), iParam7, 5, 0, 0, 0, iParam8, sParam9, func_86(), func_86(), func_86(), func_86(), sParam10, 0, bParam12, sParam11, 0, iParam13, bParam14, iParam15, 0, 0, 0, 1, 1065353216);
}
...
void func_97(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 3)
	{
		if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
		{
			...
			if (bParam1)
			{
				if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_52()) && uParam0->f_17[iVar0] != PLAYER_PED_ID())
				{
					REMOVE_PED_FROM_GROUP(uParam0->f_17[iVar0]);
				}
			}
...
void func_100(var uParam0, var uParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	func_101(uParam0, uParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_101(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	func_102(uParam0, uParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_102(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
	{
		func_11(uParam0, 0, 0);
	...
	uParam0->f_6 = 2;
	func_103(uParam0, uParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_103(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
	...
	if (func_127(uParam1) && IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
		...
		if (!IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				func_118(uParam0, uParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
int func_108(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_116() || func_115(Global_4456448.f_161209)) || func_114())
	{
		...
		{
			uVar0 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
			iVar1 = func_113(PLAYER_PED_ID(), 0);
			if (((_0xE33FFA906CE74880(uVar0, iVar1) || (GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_112(uVar0, 10)) && GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_109(int iParam0)
{
	if (iParam0 != func_111())
	{
		...
		else if ((Global_1312867 && iParam0 == PLAYER_ID()) && func_110(iParam0, 1, 0))
		{
			return Global_2424047[iParam0 /*416*/].f_309.f_5 != -1;
		}
	}
...
void func_118(var uParam0, var uParam1, vector3 vParam2, int iParam5)
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_122(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_125(bParam1, bParam2, bParam3) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1) || func_123(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_132()
{
	...
	{
		if (((IS_ENTITY_DEAD(Local_1318, 0) || (DOES_ENTITY_EXIST(Local_1322[0 /*2*/]) && !IS_ENTITY_ATTACHED(Local_1322[0 /*2*/]))) || (DOES_ENTITY_EXIST(Local_1322[1 /*2*/]) && !IS_ENTITY_ATTACHED(Local_1322[1 /*2*/]))) || (DOES_ENTITY_EXIST(Local_1322[2 /*2*/]) && !IS_ENTITY_ATTACHED(Local_1322[2 /*2*/])))
		{
			iLocal_1303 = 2;
		}
	}
	if (iLocal_1303 == 2)
	{
		if ((((!DOES_ENTITY_EXIST(Local_1318) || !IS_VEHICLE_DRIVEABLE(Local_1318, 0)) || (DOES_ENTITY_EXIST(Local_1322[0 /*2*/]) && !func_88(Local_1322[0 /*2*/]))) || (DOES_ENTITY_EXIST(Local_1322[1 /*2*/]) && !func_88(Local_1322[1 /*2*/]))) || (DOES_ENTITY_EXIST(Local_1322[2 /*2*/]) && !func_88(Local_1322[2 /*2*/])))
		{
			iLocal_1303 = 3;
		}
	}
	if (iLocal_1303 == 0)
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			if (GET_ENTITY_MODEL(uVar0) == joaat("towtruck") || GET_ENTITY_MODEL(uVar0) == joaat("towtruck2"))
			{
				if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
				{
					if (IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uVar0, Local_1318))
					{
						iLocal_1320 = uVar0;
					}
				}
	...
	if (iLocal_1303 == 0)
	{
		if (!IS_VEHICLE_DRIVEABLE(Local_1318, 0))
		{
			iLocal_1303 = 1;
		}
	}
	if (iLocal_1303 == 1 && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_1318, 1))
	{
		func_9(6, 1);
	}
	else
	...
	if (DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_185(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_182(GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_134(Global_97130.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_134(int iParam0, vector3 vParam1, var uParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (DOES_ENTITY_EXIST(iParam0) && IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_169(iParam5, &Var0, vParam1, uParam4, func_175(iParam0));
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_152(iParam0, 0, 0)) || func_152(iParam0, 1, 0)) || func_152(iParam0, 2, 0)) || func_175(iParam0) != 145) || func_151(iParam0)) || func_150(iParam0)) || func_149(iParam0)) || func_148(iParam0)) || !func_138(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_150(iParam0))
		{
		}
...
var func_154()
{
	...
	func_164(&uVar0, GET_CLOCK_SECONDS());
	func_163(&uVar0, GET_CLOCK_MINUTES());
	func_162(&uVar0, GET_CLOCK_HOURS());
...
{
	return (SHIFT_RIGHT(uParam0, 26) & 31 * func_160(IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_169(int iParam0, var uParam1, vector3 vParam2, var uParam5, int iParam6)
{
	if (func_165(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_177(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_187()
{
	...
	{
		if (func_189(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
			iVar0 = func_188(PLAYER_PED_ID());
...
{
	return func_45(uParam0, !bParam1, bParam2);
}
...
int func_193(var uParam0)
{
	if (DOES_ENTITY_EXIST(uParam0))
	{
		switch (GET_ENTITY_TYPE(uParam0))
		{
			case 1:
				if (!IS_PED_INJURED(GET_PED_INDEX_FROM_ENTITY_INDEX(uParam0)))
				{
...
void func_195()
{
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		if (!iLocal_1351)
		{
			func_198(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), -1);
			func_197(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), -1);
			iLocal_1351 = 1;
		}
	}
	else if (iLocal_1351)
	...
	if (!iLocal_1349)
	{
		if (IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0))
		{
			if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_1318, 1))
			{
				PLAY_POLICE_REPORT("SCRIPTED_SCANNER_REPORT_JSH_PREP_2A_01", 0f);
				iLocal_1349 = 1;
			}
			else if (HAS_PED_GOT_WEAPON(PLAYER_PED_ID(), joaat("weapon_briefcase"), 0))
			{
	...
	if (iLocal_93 == 0)
	{
		...
		{
			case 0:
				if ((DOES_ENTITY_EXIST(vLocal_1306.x) && !IS_PED_INJURED(vLocal_1306.x)) && func_129(&(Local_1084[0 /*8*/])))
				{
					if (Local_1084[0 /*8*/].f_1 == 1)
					{
						if (func_196(PLAYER_PED_ID(), Local_1318, 1) > 500f)
						{
							func_301(1);
						}
					}
					...
					{
						if (func_196(PLAYER_PED_ID(), Local_1318, 1) > 250f)
						{
							func_301(1);
						}
					}
					else if (func_196(PLAYER_PED_ID(), Local_1318, 1) > 250f)
					{
						func_301(2);
					}
				}
			...
			case 2:
				if (!HAS_PED_GOT_WEAPON(PLAYER_PED_ID(), joaat("weapon_briefcase"), 0))
				{
					if (((((DOES_ENTITY_EXIST(Local_1322[0 /*2*/]) && func_196(PLAYER_PED_ID(), Local_1322[0 /*2*/], 1) > 250f) && DOES_ENTITY_EXIST(Local_1322[1 /*2*/])) && func_196(PLAYER_PED_ID(), Local_1322[1 /*2*/], 1) > 250f) && DOES_ENTITY_EXIST(Local_1322[2 /*2*/])) && func_196(PLAYER_PED_ID(), Local_1322[2 /*2*/], 1) > 250f)
					{
						func_301(3);
					}
				}
	...
	if (DOES_ENTITY_EXIST(Local_1318))
	{
		if ((IS_ENTITY_IN_WATER(Local_1318) && !IS_VEHICLE_DRIVEABLE(Local_1318, 0)) && !HAS_PED_GOT_WEAPON(PLAYER_PED_ID(), joaat("weapon_briefcase"), 0))
		{
			func_301(4);
		}
	}
...
float func_196(var uParam0, var uParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_199()
{
	if (DOES_ENTITY_EXIST(vLocal_1306.x))
	{
		if (!IS_PED_IN_ANY_VEHICLE(vLocal_1306.x, 0))
		{
			func_200(vLocal_1306.x, &(vLocal_1306.f_2), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
		}
	}
	if (DOES_ENTITY_EXIST(Local_1318))
	{
		if (((!func_193(Local_1318) && IS_ENTITY_DEAD(Local_1318, 0)) && iLocal_1346) && func_196(Local_1318, PLAYER_PED_ID(), 1) > 200f)
		{
			SET_VEHICLE_AS_NO_LONGER_NEEDED(&Local_1318);
		}
	}
...
int func_200(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
void func_201()
{
	...
	if (bLocal_96 == 1)
	{
		...
		else
		{
			...
			if (!func_275())
			{
				func_274(iLocal_93, &vVar0, &uVar3);
				...
				func_272(&uLocal_99, vVar0, 50f, 0);
			}
			func_271(&uLocal_99);
			switch (iLocal_93)
			{
				case 0:
					func_270(&uLocal_99, iLocal_83);
					func_270(&uLocal_99, iLocal_84);
					func_270(&uLocal_99, iLocal_85);
					func_269(&uLocal_99, &Global_90574);
					break;
				
				case 1:
					func_270(&uLocal_99, joaat("burrito2"));
					break;
			}
			while (!func_268(&uLocal_99))
			{
				WAIT(0);
				func_199();
			}
			switch (iLocal_93)
			{
				case 0:
					...
					if (ARE_STRINGS_EQUAL(&Global_90574, "jhp2a_main"))
					{
						while (!func_205(&iLocal_1316, 1395.851f, -1069.306f, 52.4779f, 118.1591f, 1))
						{
							WAIT(0);
							CLEAR_AREA_OF_VEHICLES(1395.851f, -1069.306f, 52.4779f, 20f, 0, 0, 0, 0, 0, 0);
						}
					}
					else
					{
						while (!func_205(&iLocal_1316, 1256.913f, 556.8416f, 79.7013f, 134.0793f, 1))
						{
							WAIT(0);
							CLEAR_AREA_OF_VEHICLES(1256.913f, 556.8416f, 79.7013f, 20f, 0, 0, 0, 0, 0, 0);
						}
					}
					SET_VEHICLE_COLOUR_COMBINATION(iLocal_1316, 0);
					SET_VEHICLE_EXTRA(iLocal_1316, 1, 0);
					SET_VEHICLE_EXTRA(iLocal_1316, 2, 1);
					SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_1316, 1084227584);
					SET_VEHICLE_ENGINE_ON(iLocal_1316, 1, 1, 0);
					if (func_275())
					{
						func_202(iLocal_1316, -1, 1);
					}
					else
					{
						FREEZE_ENTITY_POSITION(PLAYER_PED_ID(), 0);
						SET_PED_INTO_VEHICLE(PLAYER_PED_ID(), iLocal_1316, -1);
					}
				...
				case 1:
					if (!func_7(87))
					{
						Local_1318 = CREATE_VEHICLE(joaat("boxville3"), 693.725f, -1006.302f, 21.8355f, 359.884f, 1, 1, 0);
						SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_1318, 0);
						SET_VEHICLE_ON_GROUND_PROPERLY(Local_1318, 1084227584);
					}
					if (func_275())
					{
						func_202(0, -1, 1);
					...
					SET_ENTITY_COORDS(PLAYER_PED_ID(), 692.067f, -1004.812f, 21.9059f, 1, 0, 0, 1);
...
int func_205(var uParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	struct<67> Var0;
	...
	if (Var0.f_66 != 0)
	{
		if (!func_257(0, &Var0))
		{
			if (IS_THIS_MODEL_A_CAR(Var0.f_66) || IS_THIS_MODEL_A_BIKE(Var0.f_66))
			{
				...
				{
					*uParam0 = CREATE_VEHICLE(Var0.f_66, vParam1, fParam4, 1, 1, 0);
					func_246(*uParam0, &Var0, 0, 1);
	...
	if (bParam5)
	{
		if (!DOES_ENTITY_EXIST(*uParam0))
		{
			if (func_206(uParam0, 0, vParam1, fParam4, 1, 0))
			{
				SET_VEHICLE_MODEL_IS_SUPPRESSED(func_166(0, 0), 1);
				return 1;
			}
		}
		return 0;
...
int func_206(var uParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6, int iParam7)
{
	var uVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, uParam5, 0, 0, 0);
				...
				func_241(uParam0, &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, uParam5, 0, 0, 0);
				...
				func_241(uParam0, &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				SET_VEHICLE_ENVEFF_SCALE(*uParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (GET_ENTITY_MODEL(*uParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (HAS_MODEL_LOADED(Var5))
			{
				...
				*uParam0 = CREATE_VEHICLE(Var5, vParam2, uParam5, 1, 1, 0);
				...
				func_241(uParam0, &(Var5.f_31), &(Var5.f_81));
				SET_VEHICLE_ENVEFF_SCALE(*uParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_207(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	if ((func_168(iParam0) && DOES_ENTITY_EXIST(*uParam1)) && IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_211(*uParam1, 0, &uVar0))
		{
			func_178(uParam1, &(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_106565.f_20112[iParam0 /*43*/].f_31 = func_210(*uParam1);
...
int func_208(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	...
	iVar0 = 0;
	while (func_209(iVar0, &sVar2, &iVar1, &iVar6, &iVar7))
	{
...
int func_211(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = GET_ENTITY_MODEL(iParam0);
	if ((!func_236(iVar0, bParam1, uParam2) && !func_235(PLAYER_ID())) && !func_219(iParam0))
	{
		return 0;
	}
	if (func_235(PLAYER_ID()))
	{
		if (func_218(iVar0))
		{
			return 1;
	...
	bVar1 = false;
	if (func_217(PLAYER_ID()) && (IS_THIS_MODEL_A_HELI(iVar0) || IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_215(iParam0)) && !bVar1) && !(func_214(GET_ENTITY_MODEL(iParam0)) && func_212(PLAYER_ID())))
	{
	...
	if (!NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_149(iParam0) && GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_234(PLAYER_ID()) || func_233(PLAYER_ID()))
	{
		if (func_220(iParam0))
		{
			return 1;
...
int func_221(int iParam0)
{
	...
	if (func_222(GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_223(int iParam0, bool bParam1)
{
	switch (GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_225(GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_236(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_217(PLAYER_ID()) && (IS_THIS_MODEL_A_HELI(iParam0) || IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_241(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_232(GET_ENTITY_MODEL(*uParam0), 1) && GET_VEHICLE_MOD(*uParam0, 24) != func_244(*uParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*uParam0, 24, func_244(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_243(uParam0);
	if (func_242(*uParam0))
	{
...
void func_246(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_177(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_177(iVar1 + 1)))
			{
			}
			else
			{
				SET_BIT(&(uParam1->f_77), func_177(iVar1 + 1));
			}
		}
		...
		if (((IS_BIT_SET(uParam1->f_77, 15) || func_249(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_248())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
		{
			func_241(&uParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
		if (!IS_THIS_MODEL_A_HELI(uParam1->f_66) && !IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (IS_BIT_SET(uParam1->f_77, func_177(iVar2 + 1)))
				{
...
int func_257(int iParam0, var uParam1)
{
	...
	{
		if (Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam0 /*98*/] == uParam1->f_66 && GET_HASH_KEY(&(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam0 /*98*/].f_27)) == GET_HASH_KEY(&(uParam1->f_1)))
		{
			return 1;
		}
	}
	...
	{
		if (Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam0 /*98*/] == uParam1->f_66 && GET_HASH_KEY(&(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam0 /*98*/].f_27)) == GET_HASH_KEY(&(uParam1->f_1)))
		{
			return 1;
		}
	}
...
int func_261(bool bParam0)
{
	...
	bVar0 = false;
	func_269(&uLocal_99, &Global_90574);
	func_270(&uLocal_99, joaat("s_m_m_armoured_01"));
	func_270(&uLocal_99, iLocal_85);
	func_270(&uLocal_99, iLocal_86);
	if ((HAS_MODEL_LOADED(joaat("s_m_m_armoured_01")) && HAS_MODEL_LOADED(iLocal_85)) && HAS_MODEL_LOADED(iLocal_86))
	{
		if (bParam0)
		{
			if (!DOES_ENTITY_EXIST(Local_1318))
			...
			if (!DOES_ENTITY_EXIST(vLocal_1306.x))
			{
				if (DOES_ENTITY_EXIST(Global_90209.f_9[0]))
				{
					...
					vLocal_1306.x = Global_90209.f_9[0];
				}
				else
				{
					bVar0 = false;
		...
		{
			func_270(&uLocal_99, iLocal_84);
			if (HAS_MODEL_LOADED(iLocal_84) && GET_IS_WAYPOINT_RECORDING_LOADED(&Global_90574))
			{
				if (ARE_STRINGS_EQUAL(&Global_90574, "jhp2a_main"))
				{
					WAYPOINT_RECORDING_GET_COORD(&Global_90574, 23, &vVar1);
					CLEAR_AREA_OF_VEHICLES(vVar1, 20f, 0, 0, 0, 0, 0, 0);
					Local_1318 = CREATE_VEHICLE(iLocal_84, vVar1, 119.4988f, 1, 1, 0);
					vLocal_1306.x = CREATE_PED_INSIDE_VEHICLE(Local_1318, 26, iLocal_83, -1, 1, 1);
					SET_VEHICLE_ON_GROUND_PROPERLY(Local_1318, 1084227584);
					TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1306.x, Local_1318, &Global_90574, 786475, 23, 16, -1, 12f, 0, 1073741824);
				}
				else
				{
					WAYPOINT_RECORDING_GET_COORD(&Global_90574, 29, &vVar1);
					CLEAR_AREA_OF_VEHICLES(vVar1, 20f, 0, 0, 0, 0, 0, 0);
					Local_1318 = CREATE_VEHICLE(iLocal_84, vVar1, 134.0011f, 1, 1, 0);
					vLocal_1306.x = CREATE_PED_INSIDE_VEHICLE(Local_1318, 26, iLocal_83, -1, 1, 1);
					SET_VEHICLE_ON_GROUND_PROPERLY(Local_1318, 1084227584);
					TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1306.x, Local_1318, &Global_90574, 786475, 29, 16, -1, 12f, 0, 1073741824);
				}
			}
		}
		if (DOES_ENTITY_EXIST(Local_1318))
		{
			func_267(Local_1318, 0);
			if (IS_VEHICLE_DRIVEABLE(Local_1318, 0))
			{
				SET_VEHICLE_HAS_STRONG_AXLES(Local_1318, 1);
				SET_ENTITY_LOAD_COLLISION_FLAG(Local_1318, 1, 1);
				_0x192547247864DFDD(Local_1318, 1);
				_0x2B6747FAA9DB9D6B(Local_1318, 1);
			}
		}
		if (DOES_ENTITY_EXIST(vLocal_1306.x))
		{
			if (!IS_PED_INJURED(vLocal_1306.x))
			{
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(vLocal_1306.x, 1);
				SET_PED_RELATIONSHIP_GROUP_HASH(vLocal_1306.x, uLocal_1305);
				SET_PED_ACCURACY(vLocal_1306.x, 5);
				SET_PED_CAN_BE_TARGETTED(vLocal_1306.x, 0);
				SET_PED_COMBAT_ATTRIBUTES(vLocal_1306.x, 1, 0);
				GIVE_WEAPON_TO_PED(vLocal_1306.x, joaat("weapon_pistol"), 15, 0, 1);
				func_266(&uLocal_1126, 3, vLocal_1306.x, "JHP2A_Driver", 0, 1);
				func_265(&(Local_1084[0 /*8*/]), 0, 0, 1);
			}
		}
		if (DOES_ENTITY_EXIST(Local_1318) && DOES_ENTITY_EXIST(vLocal_1306.x))
		{
			func_264();
			func_265(&(Local_1084[1 /*8*/]), 0, 0, 1);
			func_262(&uLocal_99, joaat("boxville3"));
...
void func_264()
{
	...
	if (DOES_ENTITY_EXIST(Local_1318))
	{
		if (!IS_ENTITY_DEAD(Local_1318, 0) && !DOES_ENTITY_EXIST(uLocal_1329))
		{
			uLocal_1329 = CREATE_OBJECT(iLocal_86, GET_ENTITY_COORDS(Local_1318, 1), 1, 1, 0);
			SET_OBJECT_PHYSICS_PARAMS(uLocal_1329, 0.1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f);
			ATTACH_ENTITY_TO_ENTITY_PHYSICALLY(uLocal_1329, Local_1318, -1, -1, GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_1318, GET_WORLD_POSITION_OF_ENTITY_BONE(Local_1318, 5)) + Vector(0f, 0f, 0.02f), 0f, 0f, 0f, 0f, 0f, 0f, -1f, 1, 1, 0, 1, 2);
			SET_ENTITY_VISIBLE(uLocal_1329, 0, 0);
		}
		if (!DOES_ENTITY_EXIST(Local_1322[0 /*2*/]))
		{
			if (IS_ENTITY_DEAD(Local_1318, 0))
			{
				vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, GET_RANDOM_FLOAT_IN_RANGE(-2.5f, 2.5f), -5f, 0f) };
				GET_GROUND_Z_FOR_3D_COORD(vVar0, &(vVar0.f_2), 0, 0);
				Local_1322[0 /*2*/] = CREATE_OBJECT(iLocal_85, vVar0, 1, 1, 0);
			}
			else
			{
				Local_1322[0 /*2*/] = CREATE_OBJECT(iLocal_85, GET_ENTITY_COORDS(Local_1318, 1), 1, 1, 0);
				SET_OBJECT_PHYSICS_PARAMS(Local_1322[0 /*2*/], 3.5f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f);
				ATTACH_ENTITY_TO_ENTITY(Local_1322[0 /*2*/], Local_1318, -1, -0.2f, -2.675f, 0.05f, -90f, 0f, -90f, 0, 0, 0, 0, 2, 1);
				_SET_ENTITY_SOMETHING(Local_1322[0 /*2*/], 1);
			}
		}
		if (!DOES_ENTITY_EXIST(Local_1322[1 /*2*/]))
		{
			if (IS_ENTITY_DEAD(Local_1318, 0))
			{
				vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, GET_RANDOM_FLOAT_IN_RANGE(-2.5f, 2.5f), -5f, 0f) };
				GET_GROUND_Z_FOR_3D_COORD(vVar0, &(vVar0.f_2), 0, 0);
				Local_1322[1 /*2*/] = CREATE_OBJECT(iLocal_85, vVar0, 1, 1, 0);
			}
			else
			{
				Local_1322[1 /*2*/] = CREATE_OBJECT(iLocal_85, GET_ENTITY_COORDS(Local_1318, 1), 1, 1, 0);
				SET_OBJECT_PHYSICS_PARAMS(Local_1322[1 /*2*/], 3.5f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f);
				ATTACH_ENTITY_TO_ENTITY(Local_1322[1 /*2*/], Local_1318, -1, 0f, -2.675f, 0.05f, -90f, 0f, -90f, 0, 0, 0, 0, 2, 1);
				_SET_ENTITY_SOMETHING(Local_1322[1 /*2*/], 1);
			}
		}
		if (!DOES_ENTITY_EXIST(Local_1322[2 /*2*/]))
		{
			if (IS_ENTITY_DEAD(Local_1318, 0))
			{
				vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, GET_RANDOM_FLOAT_IN_RANGE(-2.5f, 2.5f), -5f, 0f) };
				GET_GROUND_Z_FOR_3D_COORD(vVar0, &(vVar0.f_2), 0, 0);
				Local_1322[2 /*2*/] = CREATE_OBJECT(iLocal_85, vVar0, 1, 1, 0);
			}
			else
			{
				Local_1322[2 /*2*/] = CREATE_OBJECT(iLocal_85, GET_ENTITY_COORDS(Local_1318, 1), 1, 1, 0);
				SET_OBJECT_PHYSICS_PARAMS(Local_1322[2 /*2*/], 3.5f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1f);
				ATTACH_ENTITY_TO_ENTITY(Local_1322[2 /*2*/], Local_1318, -1, 0.2f, -2.675f, 0.05f, -90f, 0f, -90f, 0, 0, 0, 0, 2, 1);
				_SET_ENTITY_SOMETHING(Local_1322[2 /*2*/], 1);
			}
		}
	}
}
...
int func_272(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	if (func_273(vParam1) || fParam4 <= 0f)
	{
		return 0;
	}
	if (uParam0->f_868)
	{
		if (func_121(uParam0->f_868.f_4, vParam1, 0) && uParam0->f_868.f_10 == fParam4)
		{
			uParam0->f_868.f_2 = 0;
...
void func_278()
{
	if (bLocal_98 && (func_279() || IS_SCREEN_FADED_OUT()))
	{
		func_8(1);
		TERMINATE_THIS_THREAD();
	}
...
void func_280()
{
	...
	func_287();
	ADD_RELATIONSHIP_GROUP("SECDRIVER", &uLocal_1305);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_1305, -1533126372);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_1305, -183807561);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, uLocal_1305);
	if (func_6(0) || func_204())
	{
		...
		if (func_204())
		{
			func_274(iLocal_97, &vVar0, &uVar3);
			func_286(vVar0, uVar3, 1, 0);
		}
		bLocal_96 = true;
	}
	else
	...
	func_284(&uLocal_99, "JHP2A", 0);
	SET_WANTED_LEVEL_MULTIPLIER(0.1f);
	SET_ALL_RANDOM_PEDS_FLEE(PLAYER_ID(), 1);
	func_282(88);
	func_266(&uLocal_1126, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
	func_266(&uLocal_1126, 3, 0, "Lester", 0, 1);
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("boxville3"), 1);
	SET_PED_MODEL_IS_SUPPRESSED(joaat("s_m_m_armoured_01"), 1);
	if (HAS_PED_GOT_WEAPON(PLAYER_PED_ID(), joaat("weapon_briefcase"), 0))
	{
		REMOVE_WEAPON_FROM_PED(PLAYER_PED_ID(), joaat("weapon_briefcase"));
	}
	func_281();
	if (IS_STRING_NULL_OR_EMPTY(&Global_90574))
	{
	}
	iLocal_1330 = ADD_SCENARIO_BLOCKING_AREA(713.7754f, -996.4443f, 22.3085f, 715.7624f, -991.7067f, 25.6214f, 0, 1, 1, 1);
...
void func_286(vector3 vParam0, var uParam3, int iParam4, int iParam5)
{
	if (func_204())
	{
...
void func_287()
{
	func_295(&(Local_1084[0 /*8*/]), 79088, "Van Driver Manager");
	func_295(&(Local_1084[1 /*8*/]), 77735, "Cargo Manager");
}
...
void func_288(var uParam0)
{
	if (!func_130(uParam0))
	{
		if (IS_ENTITY_DEAD(Local_1318, 0))
		{
			func_293(Local_1322[0 /*2*/], 1);
			func_293(Local_1322[1 /*2*/], 1);
			func_293(Local_1322[2 /*2*/], 1);
			iLocal_1346 = 1;
			func_292(uParam0);
		}
		else
		{
			...
			{
				case 1:
					func_291(&uLocal_99, "JWL_HEIST_PREP_2A_SHOOTING_LOCK");
					if (REQUEST_SCRIPT_AUDIO_BANK("JWL_HEIST_PREP_2A_SHOOTING_LOCK", 0, -1))
					{
						if ((GET_GAME_TIMER() - iLocal_1336) > 150)
						{
							if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_1329, PLAYER_PED_ID(), 0))
							{
								if ((((HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(uLocal_1329, joaat("weapon_molotov"), 0) || HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(uLocal_1329, joaat("weapon_bzgas"), 0)) || HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(uLocal_1329, joaat("weapon_knife"), 0)) || HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(uLocal_1329, joaat("weapon_unarmed"), 0)) || HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(uLocal_1329, joaat("weapon_hit_by_water_cannon"), 0))
								{
									CLEAR_ENTITY_LAST_WEAPON_DAMAGE(uLocal_1329);
								}
								else
								{
									CLEAR_ENTITY_LAST_DAMAGE_ENTITY(uLocal_1329);
									iLocal_1336 = GET_GAME_TIMER();
									iLocal_1335++;
									if (iLocal_1335 >= 3)
									{
										PLAY_SOUND_FROM_ENTITY(-1, "Lock_Destroyed", uLocal_1329, "JWL_PREP_2A_SOUNDS", 0, 0);
									}
									else
									{
										PLAY_SOUND_FROM_ENTITY(-1, "Lock_Damage", uLocal_1329, "JWL_PREP_2A_SOUNDS", 0, 0);
									}
								}
							}
						}
					...
					if (((((iLocal_1335 >= 3 || IS_ENTITY_DEAD(uLocal_1329, 0)) || IS_VEHICLE_DOOR_DAMAGED(Local_1318, 2)) || IS_VEHICLE_DOOR_DAMAGED(Local_1318, 3)) || GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1318, 2) > 0f) || GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1318, 3) > 0f)
					{
						if (DOES_ENTITY_EXIST(uLocal_1329))
						{
							DELETE_OBJECT(&uLocal_1329);
						}
						if (!IS_VEHICLE_DOOR_DAMAGED(Local_1318, 2))
						{
							SET_VEHICLE_DOOR_OPEN(Local_1318, 2, 0, 0);
						}
						if (!IS_VEHICLE_DOOR_DAMAGED(Local_1318, 3))
						{
							SET_VEHICLE_DOOR_OPEN(Local_1318, 3, 0, 0);
						}
						iLocal_1347 = 0;
						iLocal_1348 = 0;
						func_293(Local_1322[0 /*2*/], 0);
						func_293(Local_1322[1 /*2*/], 0);
						func_293(Local_1322[2 /*2*/], 0);
						func_290(uParam0, 2, 0);
					}
					break;
				
				case 2:
					if (func_289(Local_1318))
					{
						if (ABSF(GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1318, 2)) > 0.5f && ABSF(GET_VEHICLE_DOOR_ANGLE_RATIO(Local_1318, 3)) > 0.5f)
						{
				...
				case 3:
					if (func_289(Local_1318))
					{
						if (!IS_VEHICLE_DOOR_DAMAGED(Local_1318, 2))
						{
							if (IS_VEHICLE_DOOR_FULLY_OPEN(Local_1318, 2))
							{
								SET_VEHICLE_DOOR_OPEN(Local_1318, 2, 1, 0);
								SET_VEHICLE_DOOR_LATCHED(Local_1318, 2, 0, 0, 1);
								iLocal_1347 = 1;
							}
						}
						else
						...
						if (!IS_VEHICLE_DOOR_DAMAGED(Local_1318, 3))
						{
							if (IS_VEHICLE_DOOR_FULLY_OPEN(Local_1318, 3))
							{
								SET_VEHICLE_DOOR_OPEN(Local_1318, 3, 1, 0);
								SET_VEHICLE_DOOR_LATCHED(Local_1318, 3, 0, 0, 1);
								iLocal_1348 = 1;
							}
						}
						else
...
void func_293(var uParam0, bool bParam1)
{
	...
	if (DOES_ENTITY_EXIST(uParam0))
	{
		...
		{
			DETACH_ENTITY(uParam0, 1, bParam1);
			SET_ENTITY_COLLISION(uParam0, 1, 0);
			ACTIVATE_PHYSICS(uParam0);
		}
		if (bParam1)
		{
			vVar0 = { func_294(GET_ENTITY_COORDS(uParam0, 1) - GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, GET_RANDOM_FLOAT_IN_RANGE(-0.15f, 0.15f), IntToFloat(-GET_RANDOM_INT_IN_RANGE(3, 6)), GET_RANDOM_FLOAT_IN_RANGE(-0.1f, 0.1f))) };
			APPLY_FORCE_TO_ENTITY_CENTER_OF_MASS(uParam0, 1, vVar0 * FtoV(GET_RANDOM_FLOAT_IN_RANGE(0.25f, 0.5f)), 0, 1, 1, 0);
			APPLY_FORCE_TO_ENTITY_CENTER_OF_MASS(uParam0, 5, IntToFloat(GET_RANDOM_INT_IN_RANGE(0, 10)), IntToFloat(GET_RANDOM_INT_IN_RANGE(0, 10)), IntToFloat(GET_RANDOM_INT_IN_RANGE(0, 10)), 0, 1, 1, 0);
			SET_ENTITY_NO_COLLISION_ENTITY(uParam0, Local_1318, 1);
		}
	}
}
...
void func_296(var uParam0)
{
	...
	if (!func_130(uParam0))
	{
		if (((!DOES_ENTITY_EXIST(vLocal_1306.x) || IS_PED_INJURED(vLocal_1306.x)) || (DOES_ENTITY_EXIST(Local_1318) && func_196(Local_1318, vLocal_1306.x, 1) > 200f)) || (!IS_PED_IN_ANY_VEHICLE(vLocal_1306.x, 0) && func_196(Local_1318, vLocal_1306.x, 1) > 200f))
		{
			if (DOES_ENTITY_EXIST(Local_1318) && IS_VEHICLE_DRIVEABLE(Local_1318, 0))
			{
				_0x2B6747FAA9DB9D6B(Local_1318, 0);
			}
			SET_PED_AS_NO_LONGER_NEEDED(&vLocal_1306);
			func_292(uParam0);
		}
		...
		{
			if ((uParam0->f_1 != 5 && uParam0->f_1 != 3) && ((!DOES_ENTITY_EXIST(Local_1318) || !IS_VEHICLE_DRIVEABLE(Local_1318, 0)) || !IS_PED_IN_VEHICLE(vLocal_1306.x, Local_1318, 0)))
			{
				iLocal_1337 = 0;
				iLocal_1338 = 0;
			...
			else if ((uParam0->f_1 == 1 || uParam0->f_1 == 2) || uParam0->f_1 == 4)
			{
				...
				{
					uVar0 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
					if (IS_ENTITY_TOUCHING_ENTITY(uVar0, Local_1318))
					{
						if ((!iLocal_1332 && (GET_GAME_TIMER() - iLocal_1334) > 500) && fLocal_1333 >= 4f)
						{
							iLocal_1332 = 1;
							iLocal_1331++;
						}
					...
					{
						iLocal_1334 = GET_GAME_TIMER();
						iLocal_1332 = 0;
					}
					vVar1 = { func_294(GET_ENTITY_COORDS(uVar0, 1) - GET_ENTITY_COORDS(Local_1318, 1)) };
					vVar4 = { GET_ENTITY_VELOCITY(Local_1318) - GET_ENTITY_VELOCITY(uVar0) };
					fLocal_1333 = func_300(vVar4, vVar1);
				}
			}
			switch (uParam0->f_1)
			{
				case 1:
					if ((((((((((((((((((HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_1318, PLAYER_PED_ID(), 1) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(vLocal_1306.x, PLAYER_PED_ID(), 1)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 122)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 123)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 124)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 29)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 116)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 121)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 22)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 24)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 46)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 61)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 61)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 136)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 86)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 87)) || IS_PED_BEING_JACKED(vLocal_1306.x)) || IS_ENTITY_ON_FIRE(Local_1318)) || iLocal_1331 > 0)
					{
						iLocal_1337 = 0;
						iLocal_1338 = 0;
						StringCopy(&cLocal_1339, "", 24);
					...
					else
					{
						if (DOES_ENTITY_EXIST(Local_1318) && IS_VEHICLE_DRIVEABLE(Local_1318, 0))
						{
							if ((IS_ENTITY_STATIC(PLAYER_PED_ID()) || fLocal_1333 > 0.5f) && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, 0f, 2f, -0.5f), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_1318, 0f, 10f, 2f), 4.5f, 0, 1, 0))
							{
								if (!IS_HORN_ACTIVE(Local_1318))
								{
									if (iLocal_1350 == -1)
									{
										iLocal_1350 = GET_GAME_TIMER();
									}
									else if ((GET_GAME_TIMER() - iLocal_1350) > 5000)
									{
										START_VEHICLE_HORN(Local_1318, 2000, 1330140418, 0);
									}
								}
								else
								{
						...
						if (func_299(Local_1318, -993.7236f, -2418.757f, 12.9447f, 1) < 20f)
						{
							func_269(&uLocal_99, "jhp2a_airport");
						}
						if (!func_298(vLocal_1306.x, -235832601, 1))
						{
							if (IS_ENTITY_IN_ANGLED_AREA(Local_1318, -990.6312f, -2413.214f, 12.69471f, -996.0194f, -2422.608f, 16.05846f, 8.75f, 0, 1, 0))
							{
							...
							{
								TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1306.x, Local_1318, &Global_90574, 786475, -1, 24, -1, 12f, 0, 1073741824);
							}
						}
					}
					break;
				...
				case 2:
					...
					else if (!func_298(vLocal_1306.x, -235832601, 1))
					{
						if (IS_ENTITY_IN_ANGLED_AREA(Local_1318, -1096.139f, -2467.117f, 12.69561f, -1101.641f, -2476.775f, 15.6304f, 7.8125f, 0, 1, 0))
						{
							iLocal_1337 = 0;
							iLocal_1338 = 0;
							StringCopy(&cLocal_1339, "", 24);
						...
						{
							TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(vLocal_1306.x, Local_1318, "jhp2a_airport", 786475, -1, 24, -1, 12f, 0, 1073741824);
						}
					}
					break;
				
				case 3:
					if (((((((((((((((((((HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_1318, PLAYER_PED_ID(), 1) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(vLocal_1306.x, PLAYER_PED_ID(), 1)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 122)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 123)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 124)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 29)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 116)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 121)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 22)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 24)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 46)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 61)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 61)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 136)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 86)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 87)) || IS_PED_BEING_JACKED(vLocal_1306.x)) || IS_ENTITY_ON_FIRE(Local_1318)) || IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_1318, 1)) || iLocal_1331 > 0)
					{
						iLocal_1337 = 0;
						iLocal_1338 = 0;
						StringCopy(&cLocal_1339, "", 24);
					...
					else if (IS_PED_IN_VEHICLE(vLocal_1306.x, Local_1318, 1))
					{
						if (!func_298(vLocal_1306.x, 451360105, 1))
						{
							TASK_LEAVE_VEHICLE(vLocal_1306.x, Local_1318, 0);
						}
					}
					else
					{
						SET_VEHICLE_DOORS_LOCKED(Local_1318, 2);
						if (!func_298(vLocal_1306.x, 242628503, 1))
						{
							OPEN_SEQUENCE_TASK(&uLocal_1304);
							...
							CLOSE_SEQUENCE_TASK(uLocal_1304);
							TASK_PERFORM_SEQUENCE(vLocal_1306.x, uLocal_1304);
							CLEAR_SEQUENCE_TASK(&uLocal_1304);
						}
					}
					break;
				
				case 4:
					if (IS_VEHICLE_TYRE_BURST(Local_1318, 0, 1))
					{
						iVar7++;
					}
					if (IS_VEHICLE_TYRE_BURST(Local_1318, 1, 1))
					{
						iVar7++;
					}
					if (IS_VEHICLE_TYRE_BURST(Local_1318, 4, 1))
					{
						iVar7++;
					}
					if (IS_VEHICLE_TYRE_BURST(Local_1318, 5, 1))
					{
						iVar7++;
					}
					if (((((IntToFloat(GET_ENTITY_HEALTH(Local_1318)) <= 0f || GET_VEHICLE_ENGINE_HEALTH(Local_1318) <= 250f) || GET_VEHICLE_PETROL_TANK_HEALTH(Local_1318) <= 400f) || IS_PED_INJURED(vLocal_1306.x)) || iVar7 >= 2) || iLocal_1331 > 6)
					{
						if (DOES_ENTITY_EXIST(Local_1318) && IS_VEHICLE_DRIVEABLE(Local_1318, 0))
						{
							_0x2B6747FAA9DB9D6B(Local_1318, 0);
					...
					else if (!func_298(vLocal_1306.x, -1273030092, 1))
					{
						TASK_VEHICLE_MISSION_PED_TARGET(vLocal_1306.x, Local_1318, PLAYER_PED_ID(), 8, 90f, 786468, 400f, 10f, 0);
					}
					break;
				
				case 5:
					if (DOES_ENTITY_EXIST(Local_1318) && !IS_ENTITY_DEAD(Local_1318, 0))
					{
						if (IS_PED_IN_VEHICLE(vLocal_1306.x, Local_1318, 0))
						{
							if (!func_81(Local_1318))
							{
								if (!func_298(vLocal_1306.x, -2118855366, 1))
								{
									CLEAR_PED_TASKS(vLocal_1306.x);
									TASK_VEHICLE_TEMP_ACTION(vLocal_1306.x, Local_1318, 5, -1);
								}
							}
							else if (!func_298(vLocal_1306.x, 451360105, 1))
							{
								TASK_LEAVE_VEHICLE(vLocal_1306.x, Local_1318, 256);
							}
						}
						else if (!func_298(vLocal_1306.x, 780511057, 1))
						{
							SET_PED_CAN_BE_TARGETTED(vLocal_1306.x, 1);
							TASK_COMBAT_PED(vLocal_1306.x, PLAYER_PED_ID(), 0, 16);
						}
					}
					if (DOES_ENTITY_EXIST(Local_1318) && !IS_ENTITY_DEAD(Local_1318, 0))
					{
						_SET_VEHICLE_DOOR_CAN_BREAK(Local_1318, 2, 1);
						_SET_VEHICLE_DOOR_CAN_BREAK(Local_1318, 3, 1);
					}
					break;
				}
		}
		if ((DOES_ENTITY_EXIST(vLocal_1306.x) && !IS_PED_INJURED(vLocal_1306.x)) && !IS_CONVERSATION_PED_DEAD(vLocal_1306.x))
		{
			switch (uParam0->f_1)
			{
				case 4:
					...
					{
						case 0:
							if (func_36() && !IS_AMBIENT_SPEECH_PLAYING(vLocal_1306.x))
							{
								if (IS_PED_BEING_JACKED(vLocal_1306.x))
								{
									func_56(vLocal_1306.x, "JACKED_GENERIC", 10);
								}
								else
								{
									func_56(vLocal_1306.x, "GENERIC_SHOCKED_HIGH", 10);
								}
								iLocal_1337++;
							}
							break;
						...
						case 1:
							if (!IS_PED_IN_VEHICLE(vLocal_1306.x, Local_1318, 0) || iLocal_1303 == 3)
							{
								if (!IS_PED_IN_VEHICLE(vLocal_1306.x, Local_1318, 0))
								{
									iLocal_1337 = 4;
							...
							else if (func_36() && !IS_AMBIENT_SPEECH_PLAYING(vLocal_1306.x))
							{
								if (func_297(&uLocal_1126, &cLocal_79, "JS_INIT_M", 8, 0, 0, 0))
								{
									iLocal_1337++;
								}
							}
						...
						case 2:
							if (func_36() && !IS_AMBIENT_SPEECH_PLAYING(vLocal_1306.x))
							{
								if (IS_STRING_NULL_OR_EMPTY(&cLocal_1339))
								{
									fVar8 = VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(vLocal_1306.x, 1));
									if ((((((iLocal_1332 || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 122)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 123)) || HAS_PED_RECEIVED_EVENT(vLocal_1306.x, 124)) || fVar8 < 49f) && (GET_GAME_TIMER() - iLocal_1338) > 5000) && fVar8 < 225f)
									{
								...
								if (!IS_STRING_NULL_OR_EMPTY(&cLocal_1339))
								{
									if (ARE_STRINGS_EQUAL(&cLocal_1339, "GENERIC_CURSE_HIGH"))
									{
										func_56(vLocal_1306.x, "GENERIC_CURSE_HIGH", 10);
										iLocal_1337++;
									}
									else
									{
										if (func_297(&uLocal_1126, &cLocal_79, &cLocal_1339, 8, 0, 0, 0))
										{
											iLocal_1337++;
										}
										iLocal_1337++;
						...
						case 3:
							if (!func_37() && !IS_AMBIENT_SPEECH_PLAYING(vLocal_1306.x))
							{
								iLocal_1338 = GET_GAME_TIMER();
								StringCopy(&cLocal_1339, "", 24);
					...
					switch (iLocal_1337)
					{
						case 0:
							if (func_36() && !IS_AMBIENT_SPEECH_PLAYING(vLocal_1306.x))
							{
								if (IS_STRING_NULL_OR_EMPTY(&cLocal_1339))
								{
									if ((GET_GAME_TIMER() - iLocal_1338) > 5000 && VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(vLocal_1306.x, 1)) < 400f)
									{
										if (GET_RANDOM_INT_IN_RANGE(0, 2) == 0)
										{
								...
								if (!IS_STRING_NULL_OR_EMPTY(&cLocal_1339))
								{
									if (ARE_STRINGS_EQUAL(&cLocal_1339, "GENERIC_INSULT_HIGH"))
									{
										func_56(vLocal_1306.x, "GENERIC_INSULT_HIGH", 10);
										iLocal_1337++;
									}
									else if (func_297(&uLocal_1126, &cLocal_79, &cLocal_1339, 8, 0, 0, 0))
									{
										iLocal_1337++;
									}
								}
...
float func_299(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
void func_305(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_307(Global_106565.f_18527[iVar0], &vVar2, &fVar5))
			{
