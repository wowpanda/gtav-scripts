...
void __EntryFunction__()
{
	...
	if (func_345())
	{
		Global_71835 = 1;
		iLocal_79 = 0;
		while (!func_344(&Local_83))
		{
			WAIT(0);
		}
		func_242(&uVar0, 236.1378f, -369.3902f, 43.2497f, 251.2f, 0, 0, 0, 1, 0, joaat("asterope"), 0, 145, 1);
		Global_71835 = 0;
	}
	while (true)
	{
		...
		func_225(Local_83.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_81)
		{
			case 0:
				func_1();
...
void func_1()
{
	switch (iLocal_82)
	{
		...
		case 1:
			...
			func_215(&uLocal_145, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			func_215(&uLocal_145, 3, 0, "BARRY", 0, 1);
			iLocal_144 = 0;
			iLocal_82 = 2;
			break;
		...
		case 2:
			if (!iLocal_144)
			{
				if (func_203(&uLocal_145, 49, "BARR4AU", "BAR4_RCM_LI", 11, 1, 0, 0, 0))
				{
			...
			{
				DISABLE_CONTROL_ACTION(0, 177, 1);
			}
			break;
...
void func_225(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71844 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_227(Global_71845, Global_71847, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_228(iVar2), 8);
					break;
			}
			break;
...
{
	if (((!func_239(0) || Global_71859) || Global_71848 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_238(0)) || func_237(1))
			{
			}
			else
			{
...
void func_242(var uParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_340(iParam6, iParam7, iParam8, iParam13))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*uParam0 = func_318(vParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		...
		{
			func_309(iParam12, 0);
			while (!func_243(uParam0, iParam12, vParam1, fParam4, 1, 0))
			{
				WAIT(0);
			}
		}
...
int func_243(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	var uVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam5, 0, 0, 0);
				...
				func_303(uParam0, &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam5, 0, 0, 0);
				...
				func_303(uParam0, &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				SET_VEHICLE_ENVEFF_SCALE(*uParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (GET_ENTITY_MODEL(*uParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (HAS_MODEL_LOADED(Var5))
			{
				...
				*uParam0 = CREATE_VEHICLE(Var5, vParam2, fParam5, 1, 1, 0);
				...
				func_303(uParam0, &(Var5.f_31), &(Var5.f_81));
				SET_VEHICLE_ENVEFF_SCALE(*uParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_244(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	if ((func_151(iParam0) && DOES_ENTITY_EXIST(*uParam1)) && IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_249(*uParam1, 0, &uVar0))
		{
			func_248(uParam1, &(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_106565.f_20112[iParam0 /*43*/].f_31 = func_247(*uParam1);
...
int func_245(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	...
	iVar0 = 0;
	while (func_246(iVar0, &sVar2, &iVar1, &iVar6, &iVar7))
	{
...
int func_249(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_277(iVar0, bParam1, uParam2) && !func_276(PLAYER_ID())) && !func_260(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_258(PLAYER_ID()) && (IS_THIS_MODEL_A_HELI(iVar0) || IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_256(iParam0)) && !bVar1) && !(func_255(GET_ENTITY_MODEL(iParam0)) && func_251(PLAYER_ID())))
	{
	...
	{
		if ((func_250(iParam0) && GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_275(PLAYER_ID()) || func_274(PLAYER_ID()))
	{
		if (func_261(iParam0))
		{
			return 1;
...
int func_262(int iParam0)
{
	...
	if (func_263(GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_264(int iParam0, bool bParam1)
{
	switch (GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_266(GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_277(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_258(PLAYER_ID()) && (IS_THIS_MODEL_A_HELI(iParam0) || IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_298(iParam0, 0, 0)) || func_298(iParam0, 1, 0)) || func_298(iParam0, 2, 0)) || func_297(iParam0) != 145) || func_296(iParam0)) || func_295(iParam0)) || func_250(iParam0)) || func_294(iParam0)) || !func_284(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_295(iParam0))
		{
		}
...
int func_303(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_273(GET_ENTITY_MODEL(*uParam0), 1) && GET_VEHICLE_MOD(*uParam0, 24) != func_306(*uParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*uParam0, 24, func_306(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_305(uParam0);
	if (func_304(*uParam0))
	{
...
void func_309(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_91043[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || GET_ENTITY_MODEL(Global_91043[iVar0]) == func_310(iParam0, iParam1))
				{
...
void func_311(vector3 vParam0, float fParam3, int iParam4)
{
	int iVar0;
...
bool func_317(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
...
{
	return func_319(&(Global_100114.f_2890), vParam0, fParam3, 0);
}

int func_319(var uParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
	...
	if (func_336(uParam0))
	{
		...
		if (func_335(uParam0))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_321(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && ARE_STRINGS_EQUAL(GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_321(var uParam0, vector3 vParam1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_323(uParam0, Global_70409.f_139[38], 0))
			{
				func_312(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_323(uParam0, Global_70409.f_139[43], 1))
			{
				func_312(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_323(uParam0, uVar1[iVar6], 1) && func_322(GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_317(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(uParam0, 1), GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
int func_323(var uParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_324(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((IS_BIT_SET(uParam1->f_77, 15) || func_327(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_326())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
		{
			func_303(&uParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
...
void func_363(bool bParam0)
{
	...
	if (!func_383())
	{
		...
		{
			func_159(iVar0, 1, 0);
			func_364(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_105652[iVar0 /*10*/].f_9 == -1)
...
int func_365(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_371())
	{
		...
		{
			iVar33 = func_366(GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
