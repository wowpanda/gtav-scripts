...
void __EntryFunction__()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("spaceshipparts")) > 1)
	{
...
void func_5()
{
	...
	{
		if (func_9(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
...
int func_18(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (IS_BIT_SET(Global_106565.f_10043.f_108, func_24(func_25(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
void func_32()
{
	...
	iVar3 = 0;
	STAT_GET_INT(func_34(0), &iVar0, -1);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_33(18, iVar0);
	}
	STAT_GET_INT(func_34(1), &iVar0, -1);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_33(19, iVar0);
	}
	STAT_GET_INT(func_34(3), &iVar0, -1);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_33(20, iVar0);
