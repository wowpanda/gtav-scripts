...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_63, 0))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_63, 0))
				{
					ENTITY::SET_ENTITY_COORDS(AUDIO::_0x0626A247D2405330(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_63, 2.5f, 1.5f, 0f), 1, false, 0, 1);
					ENTITY::SET_ENTITY_HEADING(AUDIO::_0x0626A247D2405330(), ENTITY::GET_ENTITY_HEADING(iLocal_63));
...
void func_2()//Position - 0x252
{
	...
	if (!PED::IS_PED_INJURED(iLocal_58) && !PED::IS_PED_INJURED(iLocal_57))
	{
		...
		else if (!func_81())
		{
			...
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				if (!PED::IS_PED_SITTING_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_63) && iLocal_52 + 1 < 13)
				{
					func_220();
				}
			}
...
void func_22(vector3 vParam0, int iParam1)//Position - 0xCF7
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_63, 0))
	{
		...
		{
			if (!ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), Local_51.f_4, 12f, 12f, 12f, false, true, 0))
			{
		...
		{
			BRAIN::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_57, 3f);
		}
		iLocal_74 = 1;
	}
}
...
void func_23(vector3 vParam0)//Position - 0xD7B
{
	...
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		...
		BRAIN::TASK_LOOK_AT_COORD(AUDIO::_0x0626A247D2405330(), vParam0, iVar1, 0, 2);
	}
	iVar0 = 0;
	while (iVar0 < 5)
	{
...
void func_24()//Position - 0xDF6
{
	...
	if (CAM::DOES_CAM_EXIST(iLocal_81))
	{
		...
		func_26();
		iVar8 = SYSTEM::FLOOR((PAD::_0x5B84D09CEC5209C5(2, 218) * 127f));
		iVar9 = SYSTEM::FLOOR((PAD::_0x5B84D09CEC5209C5(2, 219) * 127f));
		iVar10 = SYSTEM::FLOOR((PAD::_0x5B84D09CEC5209C5(2, 220) * 127f));
		iVar11 = SYSTEM::FLOOR((PAD::_0x5B84D09CEC5209C5(2, 221) * 127f));
		if (!PAD::IS_LOOK_INVERTED())
		{
			iVar9 = (iVar9 * 4294967295);
			iVar11 = (iVar11 * 4294967295);
		}
		if ((iVar11 > 28 || iVar11 < 4294967268) || PAD::_IS_INPUT_DISABLED(2))
		{
		...
		if ((iVar10 > 28 || iVar10 < 4294967268) || PAD::_IS_INPUT_DISABLED(2))
		{
		...
		if ((iVar9 > 28 || iVar9 < 4294967268) || PAD::_IS_INPUT_DISABLED(2))
		{
		...
		if ((iVar8 > 28 || iVar8 < 4294967268) || PAD::_IS_INPUT_DISABLED(2))
		{
		...
		func_25(AUDIO::_0x0626A247D2405330(), &iLocal_81, fLocal_95, 0f, fLocal_94);
		CAM::SET_CAM_FOV(iLocal_81, fVar1);
		CAM::ATTACH_CAM_TO_ENTITY(iLocal_81, AUDIO::_0x0626A247D2405330(), vVar7.x, (vVar7.y - 1f), (vVar7.z + 1f), 1);
	}
	else
	{
...
void func_26()//Position - 0x1191
{
	...
	{
		if (BRAIN::GET_SCRIPT_TASK_STATUS(uLocal_59[2], 3414437612) == 7)
		{
			if (MISC::GET_GAME_TIMER() > iLocal_89 + 8000)
			{
				...
				BRAIN::TASK_LOOK_AT_COORD(uLocal_59[2], vVar0, iVar1, 2049, 2);
...
void func_28()//Position - 0x12DC
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_63, 0))
	{
		if (!PED::IS_PED_INJURED(iLocal_57))
		{
			NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_57);
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_79);
			BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_63, 120.8878f, 239.3244f, 106.5131f, 3f, 0, joaat("TOURBUS"), iLocal_264, 5f, 15f);
			BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_63, Local_51.f_1, 3f, 0, joaat("TOURBUS"), iLocal_264, 3f, 15f);
			CUTSCENE::_0x8D9DF6ECA8768583(iLocal_79);
			BRAIN::TASK_PERFORM_SEQUENCE(iLocal_57, iLocal_79);
...
void func_30(vector3 vParam0, float fParam1)//Position - 0x1376
{
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_63, 0))
	{
		...
		BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_57, iLocal_63, unk_0x8000C77B5F336760(iLocal_63, true), 0f, 0, joaat("TOURBUS"), iLocal_264, 5f, 15f);
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_63, 0))
	{
		...
		if (iVar0 < 13)
		{
			if (!PED::IS_PED_INJURED(iLocal_57))
			{
				BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_57, iLocal_63, Local_50[iVar0 /*15*/].f_1, Local_50[iVar0 /*15*/].f_8, 0, joaat("TOURBUS"), iLocal_264, 5f, 15f);
			}
		}
		else if (!PED::IS_PED_INJURED(iLocal_57))
		{
			BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_57, iLocal_63, Local_51.f_1, Local_50[iVar0 /*15*/].f_8, 0, joaat("TOURBUS"), iLocal_264, 5f, 15f);
		}
...
void func_36(int iParam0)//Position - 0x1637
{
	if (func_39())
	{
		return;
...
void func_37(bool bParam0, bool bParam1)//Position - 0x16B1
{
	if (bParam0)
	{
		if (func_38(0))
...
int func_38(int iParam0)//Position - 0x1725
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
		...
		switch (iLocal_48)
		{
			case 0:
				...
				while (iVar0 < 14)
				{
					if (!Local_50[iVar0 /*15*/].f_9)
					{
						if (iVar0 == 13)
						{
							if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), Local_50[iVar0 /*15*/].f_1, 30f, 30f, 15f, false, true, 0))
							{
						...
						else if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), Local_50[iVar0 /*15*/].f_1, 40f, 40f, 12f, false, true, 0))
						{
							if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_63, 0))
							{
			...
			case 1:
				...
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_63, 0))
				{
					if (iVar1 <= 13)
					{
						func_78(unk_0x8000C77B5F336760(iLocal_63, true), Local_50[iVar1 /*15*/].f_1, &vLocal_77, &vLocal_78, 500);
					}
							...
							if (func_77(&uLocal_96, "BUSTOAU", Local_50[iLocal_52 /*15*/], 4, 0, 0, 0))
							{
								if (iVar1 <= 13)
								{
									if (iVar1 == 11)
									{
										...
										BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_63, -100.461f, -206.1412f, 44.4215f, Local_50[iVar1 /*15*/].f_8, 0, joaat("TOURBUS"), iLocal_264, 4f, 15f);
										BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_63, Local_50[iVar1 /*15*/].f_1, Local_50[iVar1 /*15*/].f_8, 0, joaat("TOURBUS"), iLocal_264, 4f, 15f);
										CUTSCENE::_0x8D9DF6ECA8768583(iVar2);
										BRAIN::TASK_PERFORM_SEQUENCE(iLocal_57, iVar2);
										BRAIN::CLEAR_SEQUENCE_TASK(&iVar2);
									}
									else
									{
										BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_57, iLocal_63, Local_50[iVar1 /*15*/].f_1, Local_50[iVar1 /*15*/].f_8, 0, joaat("TOURBUS"), iLocal_264, 4f, 15f);
									}
								}
								iLocal_71 = MISC::GET_GAME_TIMER();
				...
				if ((iLocal_70 - iLocal_71) > 5000)
				{
					if (!func_83())
					{
						...
						else
						{
							if (!PED::IS_PED_INJURED(iLocal_57))
							{
								BRAIN::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_57, 15f);
							}
							iLocal_48 = 0;
						}
					}
...
void func_41(vector3 vParam0)//Position - 0x1AB2
{
	int iVar0;
	...
	while (iVar0 < 5)
	{
		if ((MISC::GET_GAME_TIMER() - iLocal_61) > iLocal_60[iVar0] && iLocal_62[iVar0] == 0)
		{
			...
			{
				BRAIN::TASK_LOOK_AT_COORD(uLocal_59[iVar0], vParam0, 20000, 2050, 4);
			}
			iLocal_62[iVar0] = 1;
		}
		iVar0++;
...
int func_42()//Position - 0x1B1B
{
	...
	switch (iLocal_86)
	{
		case 0:
			...
			ENTITY::SET_ENTITY_HEADING(iLocal_63, Local_51.f_D);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_63, 1084227584);
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_63, 3);
			if (!PED::IS_PED_INJURED(iLocal_57))
			{
				NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_57);
				BRAIN::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_57, 0f);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_79);
				BRAIN::TASK_VEHICLE_TEMP_ACTION(0, iLocal_63, 24, 10000);
				CUTSCENE::_0x8D9DF6ECA8768583(iLocal_79);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_57, iLocal_79);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_79);
			}
			BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(AUDIO::_0x0626A247D2405330());
			ENTITY::SET_ENTITY_COORDS(AUDIO::_0x0626A247D2405330(), 101.4382f, 250.0447f, 107.2579f, 1, false, 0, 1);
			ENTITY::SET_ENTITY_HEADING(AUDIO::_0x0626A247D2405330(), 268.4057f);
			...
			if ((iLocal_70 - iLocal_71) > 3000)
			{
				...
				while (iLocal_88 < 5)
				{
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_59[iLocal_88]))
					{
						...
						{
							BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_59[iLocal_88]);
							...
							BRAIN::TASK_WANDER_STANDARD(uLocal_59[iLocal_88], 1193033728, 0);
						}
					}
					iLocal_88++;
				}
...
void func_43()//Position - 0x1EF3
{
	func_47(4294967295, 0);
	func_44();
	func_220();
}

void func_44()//Position - 0x1F09
{
	func_45();
}

int func_45()//Position - 0x1F16
{
	if (func_46(0))
	{
		return 0;
...
bool func_46(bool bParam0)//Position - 0x1F61
{
...
void func_47(int iParam0, int iParam1)//Position - 0x1F8C
{
...
void func_48(int iParam0)//Position - 0x208F
{
	Global_19E48 = iParam0;
}

void func_49(int iParam0, var uParam1, var uParam2)//Position - 0x209D
{
	bool bVar0;
...
int func_51()//Position - 0x2646
{
	return Global_6373;
}

int func_52(int iParam0, int iParam1)//Position - 0x2651
{
	int iVar0;
...
int func_53(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x26A2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_54()//Position - 0x2C05
{
	return Global_1407E0;
}

int func_55(int iParam0, int iParam1)//Position - 0x2C11
{
	switch (iParam0)
	{
		case 0:
...
void func_57(int iParam0)//Position - 0x2FB4
{
	int iVar0;
	int iVar1;
...
void func_58(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2FF6
{
	func_59(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_59(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x3017
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x3350
{
	int iVar0;
	int iVar1;
...
void func_63(int iParam0, int iParam1)//Position - 0x3393
{
	MISC::SET_BIT(&(Global_19E56.f_6187.f_8[iParam0]), iParam1);
}

int func_64(int iParam0)//Position - 0x33AE
{
	int iVar0;
...
int func_66(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x347C
{
...
void func_67(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x3656
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_71(CAM::_0xDC9DA9E8789F5246())) && !func_69(CAM::_0xDC9DA9E8789F5246(), 0)) && !func_68()) && !bParam4)
			{
				ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_71(CAM::_0xDC9DA9E8789F5246())) && !bParam4)
		{
			ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), false);
		}
		Global_11623 = 0;
...
int func_70(int iParam0, bool bParam1)//Position - 0x37E7
{
	int iVar0;
	int iVar1;
...
int func_71(int iParam0)//Position - 0x3828
{
...
bool func_72()//Position - 0x386A
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_240006, 3);
}

int func_73(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x387B
{
	int iVar0;
...
void func_74(int iParam0)//Position - 0x38AE
{
	if (iParam0 == 1)
	{
...
int func_75(int iParam0)//Position - 0x38D1
{
	if (CAM::IS_SCREEN_FADED_IN())
	{
...
bool func_77(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x394D
{
...
void func_78(struct<2> Param0, float fParam1, struct<2> Param2, var uParam3, float fParam4, float fParam5, int iParam6)//Position - 0x399B
{
	if (!iLocal_75)
	{
		if (Param2 <= Param0)
...
int func_80(int iParam0)//Position - 0x3D29
{
			...
			if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_63, 0))
			{
				if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
				{
					if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_63, 0))
					{
						if (!PED::IS_PED_INJURED(iLocal_57))
						{
							BRAIN::TASK_VEHICLE_TEMP_ACTION(iLocal_57, iLocal_63, 24, 5000);
							...
							BRAIN::TASK_LEAVE_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_63, 0);
						}
					}
				}
			}
...
bool func_82(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x3E3D
{
	func_19(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
	...
	if (!PED::IS_PED_INJURED(iLocal_58) && !PED::IS_PED_INJURED(iLocal_57))
	{
		switch (iLocal_49)
		{
			case 0:
				...
				AUDIO::_DYNAMIC_MIXER_RELATED_FN(iLocal_63, "RE_BUS_TOUR_BUS_VEHICLE", 0f);
				...
				PED::SET_PED_INTO_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_63, 2);
				MISC::SET_MINIGAME_IN_PROGRESS(1);
				HUD::DISPLAY_RADAR(false);
				...
				PAD::_0x3D42B92563939375("BusTours");
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_63, 0))
				{
					func_78(unk_0x8000C77B5F336760(iLocal_63, true), Local_50[0 /*15*/].f_1, &vLocal_77, &vLocal_78, 500);
			...
			case 1:
				...
				if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
				{
					if ((PED::IS_PED_SITTING_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_63) && PED::IS_PED_SITTING_IN_VEHICLE(iLocal_58, iLocal_63)) && PED::IS_PED_SITTING_IN_VEHICLE(iLocal_57, iLocal_63))
					{
						iLocal_49 = 2;
					}
			...
			case 2:
				BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_57, iLocal_63, Local_50[0 /*15*/].f_1, Local_50[0 /*15*/].f_8, 0, joaat("TOURBUS"), iLocal_264, 5f, 15f);
				CAM::SET_CAM_ACTIVE(iLocal_82, false);
...
int func_86(int iParam0, int iParam1, int iParam2)//Position - 0x427F
{
	...
	return func_87(Global_19E56.f_6D76[iParam0 /*29*/].f_11, 0, iParam1, iParam2, 0);
}

int func_87(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x42C8
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_88(bool bParam0)//Position - 0x48C7
{
	int iVar0;
	int iVar1;
...
void func_89(int iParam0)//Position - 0x4B49
{
	int iVar0;
...
void func_90(int iParam0)//Position - 0x4BA3
{
	bool bVar0;
	char cVar1[64];
	...
	else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_5038.f_1D7, iParam0) || INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_92() /*12745*/].f_1FF2.f_A, iParam0))
	{
		bVar0 = true;
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_19E56.f_5038.f_1D7), iParam0);
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_200000[func_92() /*12745*/].f_1FF2.f_A), iParam0);
	}
	if (bVar0)
	{
...
char* func_91(int iParam0)//Position - 0x4CB5
{
	switch (iParam0)
	{
		case 0:
...
void func_93(int iParam0)//Position - 0x4D70
{
	func_113(93, iParam0);
	func_113(29, iParam0);
	func_113(30, iParam0);
...
bool func_94(int iParam0)//Position - 0x4D90
{
	if (iParam0 == 8)
	{
	...
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_92() /*12745*/].f_1FF2.f_A, iParam0);
}

int func_95(int iParam0, int iParam1, int iParam2)//Position - 0x4E14
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_96(int iParam0)//Position - 0x4E51
{
	int iVar0;
...
int func_97(int iParam0, int iParam1)//Position - 0x5169
{
	int iVar0;
...
int func_98(bool bParam0)//Position - 0x545C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_99(int iParam0, int iParam1)//Position - 0x5513
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_100(int iParam0, int iParam1)//Position - 0x552E
{
	...
	if (func_110(&Global_412216))
	{
		if (func_108(&Global_412216, iParam0))
		{
			return 0;
		}
		if (func_101(&Global_412216, iParam0))
		{
			return 1;
		}
	}
...
int func_101(var uParam0, int iParam1)//Position - 0x55CB
{
	int iVar0;
	var uVar1[78];
...
int func_102(var uParam0, int iParam1)//Position - 0x567C
{
	int iVar0;
...
bool func_103(var uParam0, int iParam1)//Position - 0x56F7
{
	return (*uParam0)[iParam1] == 78;
}

void func_104(var uParam0)//Position - 0x5708
{
	int iVar0;
	...
	func_106(uParam0, (Global_412215 - 0.5f));
}

void func_105(var uParam0, int iParam1)//Position - 0x573C
{
	(*uParam0)[iParam1] = 78;
}

void func_106(var uParam0, float fParam1)//Position - 0x574C
{
	if (fParam1 == 0f)
	{
		uParam0->f_50 = 0f;
...
float func_107(var uParam0)//Position - 0x5769
{
	return uParam0->f_50;
}

bool func_108(var uParam0, int iParam1)//Position - 0x5775
{
	return func_109(uParam0, iParam1) != 4294967295;
}

int func_109(var uParam0, int iParam1)//Position - 0x5787
{
	int iVar0;
...
bool func_110(var uParam0)//Position - 0x57B4
{
	return uParam0->f_4F == 1;
}

int func_111(int iParam0)//Position - 0x57C2
{
	switch (iParam0)
	{
		case 60:
...
void func_112(int iParam0, int iParam1)//Position - 0x5812
{
	int iVar0;
...
void func_113(int iParam0, int iParam1)//Position - 0x5835
{
	int iVar0;
...
int func_115(char* sParam0)//Position - 0x5907
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_116()//Position - 0x591A
{
	if (!PED::IS_PED_INJURED(iLocal_58))
	{
		NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_58);
		BRAIN::TASK_ENTER_VEHICLE(iLocal_58, iLocal_63, 10000, 0, 2f, 262144, 0);
		PED::SET_PED_KEEP_TASK(iLocal_58, true);
		iLocal_93 = 1;
	}
}

void func_117()//Position - 0x5954
{
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if (func_157())
		...
		{
			if ((ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_63, 5f, 5f, 5f, 0, 1, 0) && !PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0)) && !func_115("TX_H02"))
			{
				if (func_146())
				{
					if (!iLocal_266)
					...
					{
						BRAIN::TASK_ENTER_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_63, 4294967295, 2, 1f, 8, 0);
					}
					if (!HUD::DOES_BLIP_EXIST(iLocal_67))
					{
						...
						HUD::SET_BLIP_SCALE(iLocal_67, Global_63A1);
						if (!PED::IS_PED_INJURED(iLocal_58))
						{
...
int func_118(var uParam0)//Position - 0x5AB6
{
	char* sVar0;
...
char* func_119(bool bParam0)//Position - 0x5C0F
{
	int iVar0;
...
int func_120(int iParam0)//Position - 0x5F4C
{
	int iVar0;
...
void func_121(int iParam0)//Position - 0x5FC5
{
	iLocal_49 = 0;
	iLocal_47 = iParam0;
}

int func_122()//Position - 0x5FD4
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_63, 0))
	{
		if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			...
			{
				if (PED::SET_EXCLUSIVE_PHONE_RELATIONSHIPS(AUDIO::_0x0626A247D2405330()) == iLocal_63)
				{
					return 1;
				}
			}
...
int func_123(int iParam0)//Position - 0x6011
{
	if (func_127())
	{
		Global_19E4C = 1;
		Global_19E49 = MISC::GET_GAME_TIMER();
		if (func_56(Global_19E4B))
		{
			func_124(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_56(Global_19E4B))
		{
...
void func_124(int iParam0)//Position - 0x6064
{
	switch (iParam0)
	{
		case 0:
			if (Global_19E56.f_6187.f_2 < 3)
			{
				...
				{
					func_125(func_126(iParam0), 4294967295);
...
void func_125(char* sParam0, int iParam1)//Position - 0x6145
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_126(int iParam0)//Position - 0x615C
{
	char* sVar0;
...
int func_127()//Position - 0x619F
{
	switch (func_128(&Global_63AE, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_128(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x61D5
{
	int iVar0;
...
void func_129(var uParam0, int iParam1)//Position - 0x630C
{
	int iVar0;
...
bool func_130(int iParam0)//Position - 0x635B
{
	return func_131(iParam0, Global_8D15);
}

int func_131(int iParam0, int iParam1)//Position - 0x636C
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_132(int iParam0)//Position - 0x654D
{
	if (Global_8D15 == 15)
	{
		return 0;
...
int func_134(float fParam0, bool bParam1)//Position - 0x65D1
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_135(int iParam0, var uParam1)//Position - 0x6688
{
	switch (iParam0)
	{
		case 0:
		...
		case 1:
			func_136(uParam1, "Abigail2", func_138(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, 4294967295, 4, 1, 0, 2359, func_137(iParam0), 1, 0);
			break;
		
		case 2:
			func_136(uParam1, "Barry1", func_138(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 0, 2359, func_137(iParam0), 1, 0);
			break;
		
		case 3:
			func_136(uParam1, "Barry2", func_138(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_137(iParam0), 1, 1);
			break;
		
		case 4:
			func_136(uParam1, "Barry3", func_138(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", 4294967295, 0, "", 164, 1, 4294967295, 0, 2, 0, 2359, func_137(iParam0), 0, 0);
			break;
		...
		case 7:
			func_136(uParam1, "Barry4", func_138(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, 4294967295, 4, 2, 800, 2000, func_137(iParam0), 0, 0);
			break;
		
		case 8:
			func_136(uParam1, "Dreyfuss1", func_138(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_137(iParam0), 0, 0);
			break;
		...
		case 15:
			func_136(uParam1, "Epsilon7", func_138(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", 4294967295, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_137(iParam0), 0, 0);
			break;
		
		case 16:
			func_136(uParam1, "Epsilon8", func_138(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, 4294967295, 4, 1, 0, 2359, func_137(iParam0), 1, 0);
			break;
		
		case 17:
			func_136(uParam1, "Extreme1", func_138(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", 4294967295, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_137(iParam0), 0, 1);
			break;
		...
		case 20:
			func_136(uParam1, "Extreme4", func_138(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_137(iParam0), 0, 0);
			break;
		
		case 21:
			func_136(uParam1, "Fanatic1", func_138(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 700, 2000, func_137(iParam0), 1, 0);
			break;
		
		case 22:
			func_136(uParam1, "Fanatic2", func_138(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 700, 2000, func_137(iParam0), 1, 0);
			break;
		
		case 23:
			func_136(uParam1, "Fanatic3", func_138(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 2, 700, 2000, func_137(iParam0), 0, 1);
			break;
		
		case 24:
			func_136(uParam1, "Hao1", func_138(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", 4294967295, 0, "controller_Races", 13, 1, 4294967295, 4, 2, 2000, 500, func_137(iParam0), 0, 1);
			break;
		
		case 25:
			func_136(uParam1, "Hunting1", func_138(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", 4294967295, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_137(iParam0), 0, 1);
			break;
		
		case 26:
			func_136(uParam1, "Hunting2", func_138(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, 4294967295, 4, 4, 0, 2359, func_137(iParam0), 0, 1);
			break;
		
		case 27:
			func_136(uParam1, "Josh1", func_138(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", 4294967295, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_137(iParam0), 1, 0);
			break;
		...
		case 29:
			func_136(uParam1, "Josh3", func_138(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 4294967295, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_137(iParam0), 1, 1);
			break;
		
		case 30:
			func_136(uParam1, "Josh4", func_138(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", 4294967295, 36, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_137(iParam0), 1, 0);
			break;
		
		case 31:
			func_136(uParam1, "Maude1", func_138(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", 4294967295, 0, "BailBond_Launcher", 0, 1, 4294967295, 4, 4, 0, 2359, func_137(iParam0), 0, 1);
			break;
		
		case 32:
			func_136(uParam1, "Minute1", func_138(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", 4294967295, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_137(iParam0), 0, 1);
			break;
		
		case 33:
			func_136(uParam1, "Minute2", func_138(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", 4294967295, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_137(iParam0), 0, 1);
			break;
		
		case 34:
			func_136(uParam1, "Minute3", func_138(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", 4294967295, 10, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_137(iParam0), 0, 1);
			break;
		
		case 35:
			func_136(uParam1, "MrsPhilips1", func_138(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", 4294967295, 0, "ambient_MrsPhilips", 0, 1, 4294967295, 4, 4, 0, 2359, func_137(iParam0), 0, 0);
			break;
		
		case 36:
			func_136(uParam1, "MrsPhilips2", func_138(iParam0), 0, 11, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_137(iParam0), 0, 0);
			break;
		
		case 37:
			func_136(uParam1, "Nigel1", func_138(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", 4294967295, 0, "", 177, 1, 4294967295, 1, 4, 0, 2359, func_137(iParam0), 1, 0);
			break;
		...
		case 42:
			func_136(uParam1, "Nigel2", func_138(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", 4294967295, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_137(iParam0), 1, 1);
			break;
		
		case 43:
			func_136(uParam1, "Nigel3", func_138(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", 4294967295, 16, "postRC_Nigel3", 0, 0, 4294967295, 4, 4, 0, 2359, func_137(iParam0), 1, 1);
			break;
		
		case 44:
			func_136(uParam1, "Omega1", func_138(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", 4294967295, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_137(iParam0), 0, 0);
			break;
		
		case 45:
			func_136(uParam1, "Omega2", func_138(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_137(iParam0), 0, 0);
			break;
		
		case 46:
			func_136(uParam1, "Paparazzo1", func_138(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", 4294967295, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_137(iParam0), 0, 1);
			break;
		
		case 47:
			func_136(uParam1, "Paparazzo2", func_138(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", 4294967295, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_137(iParam0), 0, 1);
			break;
		
		case 48:
			func_136(uParam1, "Paparazzo3", func_138(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", 4294967295, 8, "", 183, 1, 4294967295, 2, 2, 0, 2359, func_137(iParam0), 0, 0);
			break;
		...
		case 51:
			func_136(uParam1, "Paparazzo4", func_138(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", 4294967295, 8, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_137(iParam0), 0, 0);
			break;
		
		case 52:
			func_136(uParam1, "Rampage1", func_138(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", 4294967295, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_137(iParam0), 0, 0);
			break;
		
		case 54:
			func_136(uParam1, "Rampage3", func_138(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", 4294967295, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_137(iParam0), 1, 0);
			break;
		
		case 55:
			func_136(uParam1, "Rampage4", func_138(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", 4294967295, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_137(iParam0), 1, 0);
			break;
		
		case 56:
			func_136(uParam1, "Rampage5", func_138(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", 4294967295, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_137(iParam0), 0, 0);
			break;
		
		case 53:
			func_136(uParam1, "Rampage2", func_138(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", 4294967295, 0, "rampage_controller", 0, 0, 4294967295, 4, 4, 0, 2359, func_137(iParam0), 1, 0);
			break;
		
		case 57:
			func_136(uParam1, "TheLastOne", func_138(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_137(iParam0), 0, 1);
			break;
		
		case 58:
			func_136(uParam1, "Tonya1", func_138(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", 4294967295, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_137(iParam0), 0, 1);
			break;
		
		case 59:
			func_136(uParam1, "Tonya2", func_138(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_137(iParam0), 0, 1);
			break;
		
		case 60:
			func_136(uParam1, "Tonya3", func_138(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_137(iParam0), 0, 1);
			break;
		
		case 61:
			func_136(uParam1, "Tonya4", func_138(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_137(iParam0), 0, 1);
			break;
		
		case 62:
			func_136(uParam1, "Tonya5", func_138(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_137(iParam0), 0, 1);
			break;
...
int func_137(int iParam0)//Position - 0x78CE
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_138(int iParam0)//Position - 0x7C14
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_139(int iParam0)//Position - 0x7C4B
{
	struct<2> Var0;
...
bool func_142()//Position - 0x80E8
{
	return Global_19D3C > 0;
}

int func_143()//Position - 0x80F6
{
...
int func_145()//Position - 0x8131
{
	if ((Global_19E4B == func_65() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_19E4C)
	{
		return 1;
	}
	return 0;
...
int func_147(int iParam0)//Position - 0x8177
{
	var uVar0;
...
int func_148(int iParam0)//Position - 0x81CF
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_156()) || Global_19A9D) || Global_6375) || func_155()) || func_17(8, 4294967295)) || func_154()) || func_153()) || func_152()) || func_151()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_156()) || Global_6375) || func_155()) || func_17(8, 4294967295)) || func_152()) || func_154()) || func_153()) || func_151()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_156()) || Global_19A9D) || Global_6375) || func_155()) || func_17(8, 4294967295)) || func_152()) || func_154()) || func_153()) || func_151()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_156()) || Global_19A9D) || Global_6375) || func_155()) || func_17(8, 4294967295)) || func_154()) || func_153()) || func_151()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_156() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_17(8, 4294967295)) || func_151()) || func_150()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_17(8, 4294967295) || func_154()) || func_153()) || func_150()) || func_149())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_156()) || Global_6375) || func_155()) || func_17(8, 4294967295)) || func_153()) || func_152()) || func_151()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_149()//Position - 0x88EC
{
	return Global_16C57.f_1;
}

int func_150()//Position - 0x88FA
{
	if (Global_16089 != 4294967295)
	{
...
bool func_153()//Position - 0x8964
{
	return Global_16C64.f_148 > 0;
}

bool func_154()//Position - 0x8975
{
	return Global_16C64.f_147 > 0;
}

var func_155()//Position - 0x8986
{
	return Global_140859;
}

int func_156()//Position - 0x8992
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_157()//Position - 0x89AE
{
	...
	if (!PED::IS_PED_INJURED(iLocal_57))
	{
		if (((func_162(iLocal_57) || !PED::IS_PED_IN_ANY_VEHICLE(iLocal_57, 0)) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_57)) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_57))
		{
			func_158(iLocal_58);
			return 1;
		}
	...
	if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_63, AUDIO::_0x0626A247D2405330(), 1))
	{
		if (func_170(iLocal_58))
		{
			if (!PED::IS_PED_INJURED(iLocal_58))
	...
	if (!ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_63, 220f, 220f, 30f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
void func_158(int iParam0)//Position - 0x8AF3
{
	if (func_170(iLocal_58))
	{
		if (!PED::IS_PED_INJURED(iLocal_58))
...
void func_159()//Position - 0x8B3A
{
	if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_58, 40f, 40f, 5f, 0, 1, 0))
	{
		iLocal_70 = MISC::GET_GAME_TIMER();
		if ((iLocal_70 - iLocal_71) > 10000)
		{
...
void func_160(int iParam0, char* sParam1, int iParam2)//Position - 0x8B94
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_161(iParam2), 1);
}

int func_161(int iParam0)//Position - 0x8BAB
{
	int iVar0;
...
int func_162(int iParam0)//Position - 0x8DA0
{
...
int func_163(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5, int iParam6)//Position - 0x8DDA
{
	float fVar0;
	float fVar1;
	bool bVar2;
					...
					if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iParam0) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iParam0))
					{
						if (fVar5 < fVar0)
						{
							if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, AUDIO::_0x0626A247D2405330(), 17))
							{
								...
								func_168("\n");
								func_164("		time since not LockedOn = ", (MISC::GET_GAME_TIMER() - iLocal_43));
								func_168("\n");
								bVar2 = true;
...
void func_164(char* sParam0, int iParam1)//Position - 0x9038
{
	func_166(sParam0);
	func_165(iParam1);
}

void func_165(int iParam0)//Position - 0x904C
{
	if (iParam0 > 0)
	{
	}
...
void func_166(char* sParam0)//Position - 0x905A
{
...
void func_167(int iParam0)//Position - 0x906D
{
	AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(iParam0);
}

void func_168(char* sParam0)//Position - 0x907B
{
	func_166(sParam0);
}

int func_169(int iParam0, int iParam1)//Position - 0x9089
{
...
int func_170(int iParam0)//Position - 0x90D6
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_174()//Position - 0x9197
{
	if (MISC::IS_NEXT_WEATHER_TYPE("RAIN") || MISC::IS_NEXT_WEATHER_TYPE("THUNDER"))
	{
		MISC::_SET_WEATHER_TYPE_OVER_TIME("OVERCAST", 10000f);
	}
}

void func_175()//Position - 0x91C5
{
	int iVar0;
	int iVar1;
	...
	else
	{
		...
		if ((((STREAMING::HAS_MODEL_LOADED(iVar0) && STREAMING::HAS_MODEL_LOADED(iVar1)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_262)) && STREAMING::HAS_MODEL_LOADED(joaat("TOURBUS"))) && HUD::HAS_ADDITIONAL_TEXT_LOADED(2))
		{
			...
			iLocal_63 = VEHICLE::CREATE_VEHICLE(joaat("TOURBUS"), Local_51.f_1, Local_51.f_D, true, true, false);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_63, 1084227584);
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_63, 3);
			...
			iLocal_57 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_63, 26, iVar1, 4294967295, 1, true);
			ENTITY::SET_ENTITY_HEALTH(iLocal_57, true);
			...
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_80);
			BRAIN::TASK_PLAY_ANIM(0, sLocal_262, "IDLE_A", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, sLocal_262, "IDLE_B", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, sLocal_262, "IDLE_C", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			BRAIN::SET_SEQUENCE_TO_REPEAT(iLocal_80, 1);
			CUTSCENE::_0x8D9DF6ECA8768583(iLocal_80);
			BRAIN::TASK_PERFORM_SEQUENCE(iLocal_58, iLocal_80);
			BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_80);
...
void func_177(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x9486
{
...
void func_179()//Position - 0x95A7
{
}

void func_180()//Position - 0x95AF
{
}

void func_181()//Position - 0x95B7
{
	struct<15> Var0;
	struct<15> Var1;
	struct<15> Var2;
...
void func_182(char[60] cParam0)//Position - 0x9B83
{
	Local_50[iLocal_52 /*15*/] = { cParam0 };
	iLocal_52++;
}

void func_183(int iParam0)//Position - 0x9BA2
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_65();
...
void func_185(int iParam0)//Position - 0x9C15
{
	Global_19E4B = iParam0;
}

int func_186(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x9C23
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_213(Global_19E56.f_6187.f_2B[iParam1]))
		{
			return 0;
		}
...
bool func_187(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x9FBD
{
	if (bParam2)
	{
...
bool func_188(int iParam0)//Position - 0xA004
{
	int iVar0;
...
int func_189(int iParam0)//Position - 0xA025
{
	return func_190(iParam0, 1);
}

int func_190(int iParam0, int iParam1)//Position - 0xA034
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_191(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xA087
{
	func_192(func_203(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_192(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xA0A5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_193(float fParam0, float fParam1, float fParam2)//Position - 0xA2A6
{
	float fVar0;
...
int func_194(int iParam0, int iParam1)//Position - 0xA2E8
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_195(int iParam0)//Position - 0xA38A
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_196(int iParam0)//Position - 0xA39D
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_197(int iParam0)//Position - 0xA3B0
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_198(int iParam0)//Position - 0xA3C3
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_199(int iParam0)//Position - 0xA3D5
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_200(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}

int func_200(bool bParam0, int iParam1, int iParam2)//Position - 0xA3FA
{
	if (bParam0)
	{
		return iParam1;
...
int func_201(int iParam0)//Position - 0xA411
{
	return iParam0 & 15;
}

int func_202(int iParam0, int iParam1)//Position - 0xA41E
{
	int iVar0;
	int iVar1;
...
void func_204(var uParam0, int iParam1)//Position - 0xA570
{
	if (iParam1 <= 0)
	{
		return;
...
void func_205(var uParam0, int iParam1)//Position - 0xA5F6
{
...
void func_206(var uParam0, int iParam1)//Position - 0xA629
{
	int iVar0;
	int iVar1;
...
void func_207(var uParam0, int iParam1)//Position - 0xA67A
{
...
void func_208(var uParam0, int iParam1)//Position - 0xA6B4
{
...
void func_209(var uParam0, int iParam1)//Position - 0xA6EF
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_210(int iParam0)//Position - 0xA72B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_211(int iParam0, int iParam1)//Position - 0xA807
{
...
bool func_213(int iParam0)//Position - 0xA852
{
	return func_202(func_203(), iParam0);
}

int func_214(int iParam0, int iParam1, int iParam2)//Position - 0xA864
{
	int iVar0;
	int iVar1;
...
int func_215(int iParam0)//Position - 0xA948
{
	if (!func_12(iParam0))
	{
		return 7;
...
bool func_216(int iParam0)//Position - 0xA96C
{
	int iVar0;
	bool bVar1;
...
void func_220()//Position - 0xAAEC
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_57))
	{
		if (!PED::IS_PED_INJURED(iLocal_57))
		{
			...
			ENTITY::SET_ENTITY_HEALTH(iLocal_57, false);
		}
	...
	while (iVar0 < 5)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_59[iVar0]))
		{
			...
			{
				ENTITY::SET_ENTITY_HEALTH(uLocal_59[iVar0], false);
			}
...
void func_221(int iParam0)//Position - 0xAC7D
{
	char cVar0[64];
	...
	if (func_145())
	{
		...
		func_223(30000);
		StringCopy(&cVar0, func_222(Global_19E4B, 1), 64);
		if (func_64(Global_19E4B) > 0)
		{
...
char* func_222(int iParam0, bool bParam1)//Position - 0xAD32
{
	switch (iParam0)
	{
		case 0:
...
void func_223(int iParam0)//Position - 0xAF7B
{
	Global_8F3C = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_224(int iParam0)//Position - 0xAF8D
{
	func_225(iParam0, 0, func_230(iParam0));
}

void func_225(int iParam0, int iParam1, int iParam2)//Position - 0xAFA2
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_226(var uParam0)//Position - 0xAFD1
{
	struct<16> Var0;
	int iVar1;
...
void func_227(int iParam0, var uParam1)//Position - 0xB0A1
{
	Global_19E56.f_6187.f_2B[iParam0] = *uParam1;
}

void func_228(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xB0B9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_229(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xB23B
{
...
int func_230(int iParam0)//Position - 0xB273
{
	int iVar0;
...
void func_231(var uParam0)//Position - 0xB416
{
	if (*uParam0 == 4294967295)
	{
		return;
...
void func_232()//Position - 0xB453
{
	func_223(30000);
	func_231(&Global_63AE);
	Global_63A2 = MISC::GET_GAME_TIMER();
}
