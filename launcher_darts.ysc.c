...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		vLocal_56 = { unk_0x8000C77B5F336760(iScriptParam_104, true) };
	...
	if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_114(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
			...
			switch (iLocal_59)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_98(3) && !Global_16C52)
						{
							if (func_114(uLocal_58, 2097152))
							{
								if ((!func_114(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_97())) && !Global_16C52)
								{
									func_107(10);
									break;
								}
						...
						if ((!func_88(6) || Global_19A9D) || func_87())
						{
							bVar4 = false;
						}
						if (func_114(uLocal_58, 1))
						...
						if (func_81() || func_80(8, 4294967295))
						{
							bVar4 = false;
						}
						...
						if (bVar4)
						{
							...
							if (INTERIOR::GET_INTERIOR_FROM_ENTITY(AUDIO::_0x0626A247D2405330()) != iLocal_84)
							{
								bVar4 = false;
							}
				...
				case 6:
					if (func_114(Global_19911, 262144))
					{
						func_116(&Global_19911, 262144);
						func_13();
					}
					if (func_114(uLocal_58, 2097152))
					{
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						if (iLocal_63 != 4294967295)
						{
							if (func_114(Global_19911, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_17(iLocal_63), 0, Global_16C55, 0);
								func_5(func_17(iLocal_63), 0, Global_16C55, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_17(iLocal_63), 0, Global_16C55, 0);
								func_5(func_17(iLocal_63), 0, Global_16C55, 0, 0);
							}
						}
						func_4();
						func_116(&Global_19911, 0);
...
int func_23()//Position - 0xF41
{
	...
	Local_93 = { unk_0x8000C77B5F336760(iLocal_94, true) };
...
void func_37()//Position - 0x1455
{
		...
		if (iLocal_91 == 0)
		{
			if (fVar5 < (10f * 10f))
			{
				...
				if (!func_100(6) && !func_100(7))
				{
					...
					{
						unk_0x346478B12F69D4E3(iLocal_87, false);
						BRAIN::TASK_LOOK_AT_ENTITY(iLocal_87, iLocal_88, 4294967295, 2049, 3);
						BRAIN::TASK_START_SCENARIO_IN_PLACE(iLocal_87, "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
					}
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_88, 0))
					{
						unk_0x346478B12F69D4E3(iLocal_88, false);
						BRAIN::TASK_LOOK_AT_ENTITY(iLocal_88, iLocal_87, 4294967295, 2049, 3);
						BRAIN::TASK_START_SCENARIO_IN_PLACE(iLocal_88, "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
					}
				}
				else
				{
					...
					{
						unk_0x346478B12F69D4E3(iLocal_87, false);
						if (BRAIN::DOES_SCENARIO_EXIST_IN_AREA(1991.677f, 3044.957f, 46.21505f, 0.5f, 1))
						{
							BRAIN::TASK_USE_NEAREST_SCENARIO_TO_COORD(iLocal_87, 1991.677f, 3044.957f, 46.21505f, 0.5f, 0);
						}
						else
						{
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_87, 1991.677f, 3044.957f, 46.21505f, 1f, 20000, 1048576000, 0, 1193033728);
						}
					...
					{
						unk_0x346478B12F69D4E3(iLocal_88, false);
						if (BRAIN::DOES_SCENARIO_EXIST_IN_AREA(1990.37f, 3045.121f, 46.21502f, 0.5f, 1))
						{
							BRAIN::TASK_USE_NEAREST_SCENARIO_TO_COORD(iLocal_88, 1990.37f, 3045.121f, 46.21502f, 0.5f, 0);
						}
						else
						{
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_88, 1990.37f, 3045.121f, 46.21502f, 1f, 20000, 1048576000, 0, 1193033728);
						}
		...
		else if (iLocal_91 == 1)
		{
			if (fVar5 >= (10f * 10f))
			{
				...
				if (!func_100(6) && !func_100(7))
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_87, 0))
					{
						BRAIN::TASK_STAND_STILL(iLocal_87, 4294967295);
						if (!ENTITY::IS_ENTITY_ATTACHED(iLocal_87))
						{
							unk_0x346478B12F69D4E3(iLocal_87, true);
						}
					}
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_88, 0))
					{
						BRAIN::TASK_STAND_STILL(iLocal_88, 4294967295);
						if (!ENTITY::IS_ENTITY_ATTACHED(iLocal_88))
						{
							unk_0x346478B12F69D4E3(iLocal_88, true);
						}
					}
				}
				else
	...
	if (!iLocal_97)
	{
		if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			if (((PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::GET_PLAYER_INDEX(), 0)) || PED::IS_ANY_PED_SHOOTING_IN_AREA(937.0616f, -117.8927f, 72.9163f, 1021.849f, -120.5357f, 72.9163f, 1, 1)) || MISC::IS_PROJECTILE_IN_AREA(1991.473f, 3045.98f, 49.532f, 1996.906f, 3052.17f, 46.3392f, 0))
			{
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_87, 0))
				{
					BRAIN::TASK_SMART_FLEE_PED(iLocal_87, AUDIO::_0x0626A247D2405330(), 1000f, 4294967295, 0, 0);
				}
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_88, 0))
				{
					BRAIN::TASK_SMART_FLEE_PED(iLocal_88, AUDIO::_0x0626A247D2405330(), 1000f, 4294967295, 0, 0);
				}
				bVar3 = true;
			}
			else
			{
				...
				while (iVar2 < iVar1)
				{
					...
					{
						if (PED::IS_PED_IN_MELEE_COMBAT(uVar0[iVar2]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), uVar0[iVar2]))
						{
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_87, 0))
							{
								BRAIN::TASK_SMART_FLEE_PED(iLocal_87, AUDIO::_0x0626A247D2405330(), 1000f, 4294967295, 0, 0);
	...
	if (iLocal_92 == 1)
	{
		...
		else if (iLocal_95 == INTERIOR::GET_INTERIOR_FROM_ENTITY(AUDIO::_0x0626A247D2405330()))
		{
			func_38(140, 3);
			func_38(139, 3);
			if (!PED::IS_PED_INJURED(iLocal_87) && !PED::IS_PED_INJURED(iLocal_88))
			{
				if (iLocal_98)
				{
					ENTITY::SET_ENTITY_HEALTH(iLocal_87, false);
					ENTITY::SET_ENTITY_HEALTH(iLocal_88, false);
					iLocal_98 = 0;
				}
			}
		}
		else if (!PED::IS_PED_INJURED(iLocal_87) && !PED::IS_PED_INJURED(iLocal_88))
		{
			if (!iLocal_98)
			{
				ENTITY::SET_ENTITY_HEALTH(iLocal_87, true);
				ENTITY::SET_ENTITY_HEALTH(iLocal_88, true);
				iLocal_98 = 1;
			}
		}
	}
	else if (iLocal_92 == 2)
	{
		...
		else if (iLocal_96 == INTERIOR::GET_INTERIOR_FROM_ENTITY(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(iLocal_87) && !PED::IS_PED_INJURED(iLocal_88))
			{
				if (iLocal_98)
...
void func_43()//Position - 0x2108
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_46(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_44(iVar0) && (!func_100(14) || Global_19A3D))
			{
...
int func_47(int iParam0)//Position - 0x2278
{
	int iVar0;
...
int func_48(int iParam0)//Position - 0x24CD
{
	int iVar0;
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			...
			{
				iVar0 = ENTITY::GET_ENTITY_MODEL(func_49(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 1)));
				switch (iVar0)
				{
...
int func_49(int iParam0)//Position - 0x2539
{
	return iParam0;
}

void func_50(int iParam0, var uParam1)//Position - 0x2543
{
	int iVar0;
	int iVar1;
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_51(iParam0) && SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_14893[26 /*34*/].f_6) == 0)
			{
				Global_19E56.f_1C41[iParam0] = 1;
				OBJECT::_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_19E56.f_1C41[iParam0], 1, 1);
			}
...
bool func_51(int iParam0)//Position - 0x2EDE
{
	struct<7> Var0;
	int iVar1;
...
int func_52(int iParam0)//Position - 0x2F12
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

var func_53()//Position - 0x2F25
{
	var uVar0;
...
void func_54(var uParam0, int iParam1)//Position - 0x2F6B
{
	if (iParam1 <= 0)
	{
		return;
...
void func_55(var uParam0, int iParam1)//Position - 0x2FF1
{
...
void func_56(var uParam0, int iParam1)//Position - 0x3024
{
	int iVar0;
	int iVar1;
...
int func_57(int iParam0, int iParam1)//Position - 0x3075
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_58(int iParam0)//Position - 0x3117
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_59(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}

int func_59(bool bParam0, int iParam1, int iParam2)//Position - 0x313C
{
	if (bParam0)
	{
		return iParam1;
...
int func_60(var uParam0)//Position - 0x3153
{
	return uParam0 & 15;
}

void func_61(var uParam0, int iParam1)//Position - 0x3160
{
...
void func_62(var uParam0, int iParam1)//Position - 0x319A
{
...
void func_63(var uParam0, int iParam1)//Position - 0x31D5
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
struct<7> func_64(int iParam0)//Position - 0x3211
{
	struct<7> Var0;
...
int func_65()//Position - 0x5E1C
{
	if ((func_67() == 4294967295 || func_67() == 999) && !func_66() == 0)
	{
		return 1;
	}
	return 0;
...
void func_68(int iParam0)//Position - 0x5E62
{
	if (iParam0 == 2)
	{
	}
...
Vector3 func_70(int iParam0)//Position - 0x5EE4
{
	switch (iParam0)
	{
		case 1:
...
int func_71()//Position - 0x5F26
{
	return 1;
}

int func_72(int iParam0, bool bParam1)//Position - 0x5F2F
{
	int iVar0;
...
int func_73(int iParam0)//Position - 0x5FE7
{
	int iVar0;
...
void func_74(int iParam0)//Position - 0x6022
{
	int iVar0;
...
void func_75(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x6079
{
	int iVar0;
...
int func_76(var uParam0)//Position - 0x61A4
{
	return 1;
}

int func_77(var uParam0, vector3 vParam1, vector3 vParam2, int iParam3)//Position - 0x61AD
{
	int iVar0;
	var uVar1;
	var uVar2;
...
var func_78()//Position - 0x6251
{
	return Global_10B8E;
}

int func_79(int iParam0)//Position - 0x625D
{
	if (iParam0 == 1)
	{
...
bool func_80(int iParam0, int iParam1)//Position - 0x62B7
{
	switch (iParam0)
	{
		case 5:
...
bool func_81()//Position - 0x62F2
{
	return MISC::GET_GAME_TIMER() <= Global_43D7.f_16F1 + 100;
}

int func_82()//Position - 0x6307
{
...
bool func_83(bool bParam0)//Position - 0x6321
{
	if (bParam0)
	{
...
void func_84(var uParam0, int iParam1)//Position - 0x634A
{
	func_85(uParam0, iParam1);
}

void func_85(var uParam0, var uParam1)//Position - 0x635A
{
	*uParam0 = (*uParam0 || uParam1);
}

int func_86()//Position - 0x636B
{
	if (func_100(6) || func_100(7))
	{
		if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
...
int func_88(int iParam0)//Position - 0x64A7
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_95()) || Global_19A9D) || Global_6375) || func_94()) || func_80(8, 4294967295)) || func_93()) || func_92()) || func_91()) || func_82()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_95()) || Global_6375) || func_94()) || func_80(8, 4294967295)) || func_91()) || func_93()) || func_92()) || func_82()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_95()) || Global_19A9D) || Global_6375) || func_94()) || func_80(8, 4294967295)) || func_91()) || func_93()) || func_92()) || func_82()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_95()) || Global_19A9D) || Global_6375) || func_94()) || func_80(8, 4294967295)) || func_93()) || func_92()) || func_82()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_95() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_80(8, 4294967295)) || func_82()) || func_90()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_80(8, 4294967295) || func_93()) || func_92()) || func_90()) || func_89())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_95()) || Global_6375) || func_94()) || func_80(8, 4294967295)) || func_92()) || func_91()) || func_82()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_89()//Position - 0x6BC4
{
	return Global_16C57.f_1;
}

int func_90()//Position - 0x6BD2
{
...
bool func_92()//Position - 0x6C22
{
	return Global_16C64.f_148 > 0;
}

bool func_93()//Position - 0x6C33
{
	return Global_16C64.f_147 > 0;
}

var func_94()//Position - 0x6C44
{
	return Global_140859;
}

int func_95()//Position - 0x6C50
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_97()//Position - 0x6C86
{
	return Global_15C47;
}

int func_98(int iParam0)//Position - 0x6C92
{
	switch (iParam0)
	{
		case 0:
...
bool func_99(int iParam0)//Position - 0x6D04
{
	int iVar0;
...
bool func_100(int iParam0)//Position - 0x6D40
{
	return Global_8D15 == iParam0;
}

void func_101()//Position - 0x6D4E
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	...
	if (bLocal_90)
	{
		...
		if ((fVar2 > 45f || Global_19E30) && !ENTITY::DOES_ENTITY_EXIST(iLocal_87))
		{
			if (Global_19E30)
			{
				Global_19E30 = 0;
...
float func_102(bool bParam0, float fParam1, float fParam2)//Position - 0x6F38
{
	if (bParam0)
	{
		return fParam1;
...
Vector3 func_103(bool bParam0, vector3 vParam1, vector3 vParam2)//Position - 0x6F4F
{
	if (bParam0)
	{
		return vParam1;
...
void func_106(var uParam0, int iParam1)//Position - 0x70A2
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_107(int iParam0)//Position - 0x70B3
{
	iLocal_59 = iParam0;
}

void func_108(int iParam0, bool bParam1, bool bParam2)//Position - 0x70BF
{
	int iVar0;
	bool bVar1;
...
bool func_111(int iParam0, int iParam1)//Position - 0x720B
{
	bool bVar0;
...
bool func_112(int iParam0)//Position - 0x7258
{
	return func_113(iParam0, Global_8D15);
}

int func_113(int iParam0, int iParam1)//Position - 0x7269
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_114(var uParam0, int iParam1)//Position - 0x744A
{
	return (uParam0 && iParam1) != 0;
}

void func_115()//Position - 0x7459
{
	bool bVar0;
	...
	iLocal_69 = 67;
	bVar0 = false;
	if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), func_70(2), 100f, 100f, 100f, false, false, 0))
	{
		bVar0 = true;
	}
	if (!bVar0)
...
void func_116(var uParam0, int iParam1)//Position - 0x74EF
{
	func_117(uParam0, iParam1);
}

void func_117(var uParam0, var uParam1)//Position - 0x74FF
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_118(bool bParam0)//Position - 0x7514
{
	if (bParam0)
	{
		if (iLocal_69 != 263)
...
void func_121(int iParam0)//Position - 0x75AF
{
	if (iParam0 != 263)
	{
