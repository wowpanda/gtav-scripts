...
void __EntryFunction__()//Position - 0x0
{
	...
	SYSTEM::SETTIMERB(0);
	vLocal_47 = { Global_3882[Global_387A /*3*/] };
	vLocal_48 = { vLocal_47 };
	...
	while (true)
	{
		...
		if (Global_38B1.f_1 != 9)
		{
			...
			else if (Global_389F)
			{
				...
				{
					iLocal_53 = 1;
					func_62(Global_389E, iLocal_51);
					func_61(Global_389E, "SET_HEADER", "EM_INBOX", 0, 0, 0, 0);
					func_60(Global_389E, "DISPLAY_VIEW", 8f, 3212836864, 3212836864, 3212836864, 3212836864);
				}
				else
				{
					if (Global_919B)
					...
					if (iLocal_54)
					{
						...
						if (iLocal_56 == 4294967295)
						{
							...
							func_60(Global_389E, "SET_DATA_SLOT_EMPTY", 8f, 3212836864, 3212836864, 3212836864, 3212836864);
							iVar0 = func_62(Global_389E, iLocal_51);
							func_61(Global_389E, "SET_HEADER", "EM_INBOX", 0, 0, 0, 0);
							iLocal_55 = 0;
							if (iVar0 > 0)
							{
							...
							func_72(1);
							func_71(0);
							func_60(Global_389E, "DISPLAY_VIEW", 8f, fLocal_66, 3212836864, 3212836864, 3212836864);
						}
						else
						{
							func_60(Global_389E, "SET_DATA_SLOT_EMPTY", 21f, 3212836864, 3212836864, 3212836864, 3212836864);
							SYSTEM::WAIT(0);
							func_60(Global_389E, "DISPLAY_VIEW", 21f, 3212836864, 3212836864, 3212836864, 3212836864);
							SYSTEM::WAIT(0);
							func_72(1);
							func_59();
							if (iLocal_57 == 4294967295)
							{
								...
								func_52(Global_389E, iLocal_51, iLocal_56);
								Global_41F2 = 0;
								...
								if (iLocal_64)
								{
									...
									{
										if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_41212A, 17))
										{
											MISC::SET_BIT(&Global_41212A, 17);
											func_39("AM_H_FLINK", 4294967295);
										}
									}
									func_71(1);
								}
								...
								func_60(Global_389E, "DISPLAY_VIEW", 9f, 3212836864, 3212836864, 3212836864, 3212836864);
							}
							else
							{
								func_60(Global_389E, "SET_DATA_SLOT_EMPTY", 21f, 3212836864, 3212836864, 3212836864, 3212836864);
								...
								func_60(Global_389E, "DISPLAY_VIEW", 21f, 3212836864, 3212836864, 3212836864, 3212836864);
								SYSTEM::WAIT(0);
								func_60(Global_389E, "SET_DATA_SLOT_EMPTY", 9f, 3212836864, 3212836864, 3212836864, 3212836864);
								func_36(Global_389E, iLocal_51, iLocal_56);
								func_60(Global_389E, "DISPLAY_VIEW", 9f, 3212836864, 3212836864, 3212836864, 3212836864);
							}
						}
						iLocal_54 = 0;
...
{
	if (Global_B5F7 != 4294967295)
	{
		GRAPHICS::SET_STREAMED_TEXTURE_DICT_AS_NO_LONGER_NEEDED(func_12(Global_B5F7));
...
void func_5()//Position - 0x580
{
	...
	{
		case 6:
			func_60(Global_389E, "SET_DATA_SLOT_EMPTY", 1f, 3212836864, 3212836864, 3212836864, 3212836864);
			func_10(Global_BAC);
			if (Global_BAC == 1)
			{
				func_60(Global_389E, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_38B5), 3212836864, 3212836864, 3212836864);
				Global_389D = Global_38B5;
			}
			else
			{
				func_60(Global_389E, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_38B6), 3212836864, 3212836864, 3212836864);
				Global_389D = Global_38B6;
			}
			if (Global_38A5)
			{
				func_9(Global_389E, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205", 0, 0, 0, 0);
				func_9(Global_389E, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206", 0, 0, 0, 0);
			}
			else
			{
				func_9(Global_389E, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, 0, 0, 0, 0, 0);
				func_9(Global_389E, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, 0, 0, 0, 0, 0);
			}
			if (Global_395B == 0)
			{
				func_9(Global_389E, "SET_SOFT_KEYS", 1f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
			...
			else
			{
				if (Global_395A == 1)
				{
					if (Global_38A5)
					{
						func_9(Global_389E, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, "CELL_225", 0, 0, 0, 0);
					}
					else
					{
						func_9(Global_389E, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, 0, 0, 0, 0, 0);
					}
				}
				else if (Global_38A5)
				{
					func_9(Global_389E, "SET_SOFT_KEYS", 1f, 1f, 3f, -1f, -1f, "CELL_225", 0, 0, 0, 0);
				}
				else
				{
					func_9(Global_389E, "SET_SOFT_KEYS", 1f, 1f, 3f, -1f, -1f, 0, 0, 0, 0, 0);
				}
		...
		case 10:
			func_60(Global_389E, "DISPLAY_VIEW", 4f, 3212836864, 3212836864, 3212836864, 3212836864);
			func_9(Global_389E, "SET_SOFT_KEYS", 2f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
			func_9(Global_389E, "SET_SOFT_KEYS", 1f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
			GRAPHICS::_0x35FB78DC42B7BD21(&Global_94F, 17);
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_94F, 20))
			{
				func_9(Global_389E, "SET_SOFT_KEYS", 3f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
			}
			else if (Global_38A5)
			{
				func_9(Global_389E, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_202", 0, 0, 0, 0);
				if (Global_3878)
				{
					func_9(Global_389E, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, 0, 0, 0, 0, 0);
				}
			}
			else
			{
		...
		case 9:
			...
			{
				func_8();
				func_60(Global_389E, "SET_THEME", SYSTEM::TO_FLOAT(Global_19E56.f_36C7[Global_38B1 /*20*/].f_6), 3212836864, 3212836864, 3212836864, 3212836864);
				if (Global_3DDB)
				{
				...
				{
					func_9(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_75[Global_6A2 /*10*/].f_4), "CELL_300", "CELL_217", "CELL_195", 0);
				}
				else
				{
					func_9(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_19E56.f_6D76[Global_6A2 /*29*/].f_3), &(Global_19E56.f_6D76[Global_6A2 /*29*/].f_7), "CELL_217", &(Global_19E56.f_6D76[Global_6A2 /*29*/].f_3), 0);
				}
				func_60(Global_389E, "DISPLAY_VIEW", 4f, 3212836864, 3212836864, 3212836864, 3212836864);
			}
			else if (Global_3DCE == 4 || Global_3DCE == 3)
			{
				...
				else
				{
					...
					{
						func_60(Global_389E, "SET_DATA_SLOT_EMPTY", 4f, 3212836864, 3212836864, 3212836864, 3212836864);
						func_9(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_75[Global_6A2 /*10*/].f_4), "CELL_300", &cVar0, "CELL_195", 0);
					}
					else
					{
						func_60(Global_389E, "SET_DATA_SLOT_EMPTY", 4f, 3212836864, 3212836864, 3212836864, 3212836864);
						func_9(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_19E56.f_6D76[Global_6A2 /*29*/].f_3), &(Global_19E56.f_6D76[Global_6A2 /*29*/].f_7), &cVar0, &(Global_19E56.f_6D76[Global_6A2 /*29*/].f_3), 0);
					}
				}
				func_60(Global_389E, "DISPLAY_VIEW", 4f, 3212836864, 3212836864, 3212836864, 3212836864);
			}
...
void func_6()//Position - 0xB26
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_389E))
	{
		if (Global_38B0 == 1)
		{
			if (Global_38A5)
			{
				func_9(Global_389E, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, "CELL_203", 0, 0, 0, 0);
			}
			else
			{
				func_9(Global_389E, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, 0, 0, 0, 0, 0);
			}
			if (Global_3DFD)
			{
				func_9(Global_389E, "SET_SOFT_KEYS", 3f, 0f, 6f, -1f, -1f, 0, 0, 0, 0, 0);
			}
			...
			{
				func_9(Global_389E, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_204", 0, 0, 0, 0);
			}
			else
			{
				func_9(Global_389E, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, 0, 0, 0, 0, 0);
					...
					if (iVar0 == Global_956[iVar1 /*15*/].f_4)
					{
						if (Global_B88[iVar0] == 0)
						{
							...
							if (Global_25824A)
							{
								if (iVar1 == 14)
								{
									func_9(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(Global_41F5), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_B88[iVar0] = 1;
						}
					...
					if (iVar0 == Global_956[iVar1 /*15*/].f_4)
					{
						if (Global_B88[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_9(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(Global_41FA), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_11625)
								{
									...
									func_9(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_38B1)
									...
									func_9(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_956[iVar1 /*15*/].f_A == 57 && iVar1 == 23)
							{
								...
								func_9(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_9(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(0), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_B88[iVar0] = 1;
						}
					}
...
void func_13()//Position - 0x16E4
{
	...
	if (!iLocal_60)
	{
		...
		{
			iLocal_60 = 1;
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_389E, "SET_INPUT_EVENT");
			GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(1);
			CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
	...
	if (!iLocal_59)
	{
		if (PAD::IS_CONTROL_PRESSED(2, 176) && SYSTEM::TIMERB() > 100)
		{
			if (iLocal_56 == 4294967295)
			{
				...
				uLocal_49 = GRAPHICS::_END_SCALEFORM_MOVIE_METHOD_RETURN();
				while (!GRAPHICS::_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_BOOL(uLocal_49))
				{
					SYSTEM::WAIT(0);
				}
				iLocal_50 = GRAPHICS::_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_INT(uLocal_49);
				iLocal_56 = iLocal_50;
				if (func_35(iLocal_51) == 0)
				{
					iLocal_56 = 4294967295;
	...
	if (PAD::IS_CONTROL_PRESSED(2, 179))
	{
		if (iLocal_64)
		{
			...
			StringCopy(&Global_10B7E, sLocal_65, 64);
			func_14(7, 0, 0);
			iLocal_64 = 0;
			func_33();
		}
...
int func_14(int iParam0, bool bParam1, int iParam2)//Position - 0x1ACA
{
	...
	if (Global_11625 && func_16())
	{
		return 0;
	}
	if (!Global_11625 && func_15())
	{
		return 0;
	}
	if (bVar0)
...
void func_18(int iParam0, int iParam1, int iParam2)//Position - 0x1D1F
{
	...
	iVar1 = ((Global_B48E[iVar0 /*120*/] - 1) - iParam1);
	while (iVar1 >= 16)
	{
		iVar1 = (iVar1 - 16);
	}
	iVar2 = iVar1;
	iVar3 = Global_B48E[iVar0 /*120*/].f_12[iVar2];
	iVar4 = Global_B48E[iVar0 /*120*/].f_1[iVar2];
	if (((iVar4 < 0 || iVar3 < 0) || !iVar4 < 9) || !iVar3 < 122)
	{
		return;
	}
	iVar5 = Global_9EA1[iVar3 /*46*/].f_20[iVar4];
	if (Global_91A4[iVar5 /*12*/].f_4 == 0)
	{
		return;
	}
	Global_B48E[iVar0 /*120*/].f_23[iVar2] = 1;
	Global_B48E[iVar0 /*120*/].f_34[iVar2] = iParam2;
...
void func_19(int iParam0, int iParam1)//Position - 0x1E19
{
	...
	iVar1 = Global_9EA1[iParam0 /*46*/].f_20[iVar0];
	if (!iParam1 < Global_91A4[iVar1 /*12*/].f_4)
	{
		return;
	}
	iVar2 = Global_91A4[iVar1 /*12*/].f_5[iParam1 /*4*/].f_1;
	bVar3 = false;
	if (Global_9EA1[iParam0 /*46*/].f_1F < (Global_9EA1[iParam0 /*46*/].f_1E - 1))
	{
		iVar4 = Global_9EA1[iParam0 /*46*/].f_8[Global_9EA1[iParam0 /*46*/].f_1F];
		if (iVar2 == iVar4)
		{
			bVar3 = true;
		}
	...
	if (!bVar3)
	{
		if (iVar2 > 4294967295)
		{
			...
			iVar5 = Global_9EA1[iParam0 /*46*/].f_2;
			iVar6 = 0;
			iVar7 = Global_91A4[iVar2 /*12*/].f_2;
			iVar6 = 0;
			while (iVar6 < iVar5)
			{
				if (!iVar6 == iVar7)
				{
					func_23(Global_9EA1[iParam0 /*46*/].f_3[iVar6], iParam0, 0, 0, 0);
				}
				iVar6++;
			}
		}
	}
	if (Global_91A4[iVar1 /*12*/].f_5[iParam1 /*4*/].f_3 > 4294967295)
	{
		func_20(Global_91A4[iVar1 /*12*/].f_5[iParam1 /*4*/].f_3, 0);
	}
	if (Global_91A4[iVar1 /*12*/].f_5[iParam1 /*4*/].f_2)
	{
		Global_9EA1[iParam0 /*46*/].f_1 = 1;
	}
	else if (iVar2 > 4294967295)
	{
		Global_9EA1[iParam0 /*46*/].f_2D = Global_91A4[iVar2 /*12*/].f_A;
		Global_9EA1[iParam0 /*46*/].f_2B = Global_91A4[iVar2 /*12*/].f_B;
	}
	else
	{
		Global_9EA1[iParam0 /*46*/].f_2D = 0;
	}
	if (Global_9EA1[iParam0 /*46*/].f_2B < 30000)
	{
		Global_9EA1[iParam0 /*46*/].f_2B = 30000;
	}
}
...
void func_23(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x21E1
{
	...
	if (!bParam2)
	{
		...
		iVar2 = iVar5;
		Var3 = { func_28(Global_91A4[iVar5 /*12*/].f_1) };
	...
	else
	{
		...
		{
			Var3 = { func_28(Global_91A4[iVar11 /*12*/].f_1) };
		}
	}
	if (!bParam4)
	{
...
void func_24(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11, char* sParam12, char* sParam13)//Position - 0x25B6
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_25(HUD::_SET_NOTIFICATION_MESSAGE(&cVar2, &cVar2, 0, 2, HUD::_GET_LABEL_TEXT(func_26(iParam1)), 0));
		}
		else
		{
			func_25(HUD::_SET_NOTIFICATION_MESSAGE("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, HUD::_GET_LABEL_TEXT(func_26(iParam1)), 0));
		}
		switch (Global_38B1)
		{
			case 0:
...
int func_29(int iParam0, int iParam1)//Position - 0x2FBB
{
	...
	Global_9EA1[iParam0 /*46*/].f_20[Global_9EA1[iParam0 /*46*/].f_2A] = iParam1;
...
int func_30(int iParam0, int iParam1)//Position - 0x3000
{
	...
	iVar2 = iVar1;
	if (!Global_B48E[iVar0 /*120*/].f_56[iVar2])
	{
		iVar3 = Global_B48E[iVar0 /*120*/].f_12[iVar2];
		iVar4 = Global_B48E[iVar0 /*120*/].f_1[iVar2];
		iVar5 = Global_9EA1[iVar3 /*46*/].f_20[iVar4];
		...
		if (Global_B48E[iVar0 /*120*/].f_23[iVar2] == 1)
		{
			return 0;
		}
...
int func_31(int iParam0, int iParam1)//Position - 0x30DF
{
	...
	iVar0 = Global_B48E[iParam0 /*120*/].f_1[iParam1];
	iVar1 = Global_B48E[iParam0 /*120*/].f_12[iParam1];
	if (!(Global_9EA1[iVar1 /*46*/] && !Global_9EA1[iVar1 /*46*/].f_1))
	{
		return 0;
	}
	if (!iVar0 == (Global_9EA1[iVar1 /*46*/].f_2A - 1))
	{
		return 0;
	}
	iVar2 = Global_9EA1[iVar1 /*46*/].f_20[(Global_9EA1[iVar1 /*46*/].f_2A - 1)];
	if (Global_91A4[iVar2 /*12*/].f_4 > 0)
	{
		return 1;
	}
	return 0;
...
void func_36(var uParam0, int iParam1, int iParam2)//Position - 0x31F2
{
	...
	iVar1 = ((Global_B48E[iVar0 /*120*/] - 1) - iParam2);
	while (iVar1 >= 16)
	{
		iVar1 = (iVar1 - 16);
	}
	...
	if (!Global_B48E[iVar0 /*120*/].f_56[iVar2])
	{
		...
		iVar6 = 0;
		iVar7 = Global_91A4[iVar5 /*12*/].f_4;
		if (iVar7 > 1)
		{
			iVar7 = 1;
		}
		...
		while (iVar6 < iVar7)
		{
			iVar8 = Global_91A4[iVar5 /*12*/].f_5[iVar6 /*4*/].f_1;
			Var9 = { func_28(Global_91A4[iVar8 /*12*/].f_1) };
			Var10 = { func_28(Global_91A4[iVar8 /*12*/].f_1) };
			...
			func_7(&Var10);
			func_7(func_38(Global_91A4[iVar8 /*12*/].f_2));
			func_37(iVar8, Global_91A4[iVar8 /*12*/].f_2);
			CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
			iVar6++;
		}
	}
...
char* func_47(int iParam0, int iParam1)//Position - 0x3BF4
{
	...
	uVar1 = uVar1;
	iVar5 = 4294967295;
	bVar6 = Global_B48E[iVar0 /*120*/].f_56[iVar4];
	if (!bVar6)
	{
		iVar5 = Global_9EA1[iVar2 /*46*/].f_20[iVar3];
	}
	else
	{
		iVar7 = 4294967295;
		...
		while (iVar8 < 7)
		{
			if (Global_B5F8[iVar8 /*203*/].f_1 == iVar2)
			{
				iVar7 = iVar8;
			}
			iVar8++;
		}
		iVar5 = Global_B5F8[iVar7 /*203*/].f_A[iVar3 /*48*/];
	}
...
int func_49(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4)//Position - 0x3FC4
{
	...
	iVar0 = ((Global_B48E[iParam0 /*120*/] - 1) - iParam1);
	while (iVar0 >= 16)
	{
		iVar0 = (iVar0 - 16);
	}
	iVar1 = iVar0;
	*uParam2 = Global_B48E[iParam0 /*120*/].f_12[iVar1];
	*uParam3 = Global_B48E[iParam0 /*120*/].f_1[iVar1];
	*uParam4 = Global_B48E[iParam0 /*120*/].f_23[iVar1];
	return iVar1;
}
...
int func_50(int iParam0, int iParam1)//Position - 0x4023
{
	...
	if (!bVar6)
	{
		iVar5 = Global_9EA1[iVar1 /*46*/].f_20[iVar2];
	}
	else
	{
		iVar7 = 4294967295;
		...
		while (iVar8 < 7)
		{
			if (Global_B5F8[iVar8 /*203*/].f_1 == iVar1)
			{
				iVar7 = iVar8;
			}
			iVar8++;
		}
		iVar5 = Global_B5F8[iVar7 /*203*/].f_A[iVar2 /*48*/];
	}
...
void func_52(var uParam0, int iParam1, int iParam2)//Position - 0x4256
{
	...
	bVar5 = Global_B48E[iVar0 /*120*/].f_56[iVar4];
	if (!Global_B48E[iVar0 /*120*/].f_45[iVar4])
	{
		func_56(4294967295);
	}
	Global_B48E[iVar0 /*120*/].f_45[iVar4] = 1;
	if (!bVar5)
	{
		iVar6 = Global_9EA1[iVar2 /*46*/].f_20[iVar3];
		Var7 = { func_28(Global_91A4[iVar6 /*12*/]) };
		Var8 = { func_28(Global_91A4[iVar6 /*12*/].f_1) };
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0, "SET_DATA_SLOT");
		GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(9);
		GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(0);
		func_7(func_55(Global_91A4[iVar6 /*12*/].f_3));
		func_7(func_55(Global_91A4[iVar6 /*12*/].f_2));
		func_7(&Var7);
		func_7(&Var8);
		func_7(func_38(Global_91A4[iVar6 /*12*/].f_2));
		func_37(iVar6, Global_91A4[iVar6 /*12*/].f_2);
		CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
		if (Global_91A4[iVar6 /*12*/].f_4 == 0)
		{
			func_73(0);
		}
		...
		if (Global_9EA1[iVar2 /*46*/].f_2A > 1)
		{
			iVar9 = iVar3;
			iVar10 = (iVar3 - 1);
			iVar11 = 0;
			...
			while (iVar11 < iVar9)
			{
				iVar6 = Global_9EA1[iVar2 /*46*/].f_20[iVar10];
				Var7 = { func_28(Global_91A4[iVar6 /*12*/]) };
				Var8 = { func_28(Global_91A4[iVar6 /*12*/].f_1) };
				iVar12 = func_54(iParam1, Global_91A4[iVar6 /*12*/].f_3);
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0, "SET_DATA_SLOT");
				GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(9);
				GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(iVar11 + 1);
	...
	else
	{
		...
		while (iVar14 < 7)
		{
			if (Global_B5F8[iVar14 /*203*/].f_1 == iVar2)
			{
				iVar13 = iVar14;
			}
			iVar14++;
		...
		{
			iVar15 = Global_B5F8[iVar13 /*203*/].f_A[iVar3 /*48*/];
			iVar16 = Global_B5F8[iVar13 /*203*/].f_A[iVar3 /*48*/];
			Var17 = { func_28(Global_91A4[iVar15 /*12*/]) };
			Var18 = { func_28(Global_91A4[iVar15 /*12*/].f_1) };
			if (Global_B5F8[iVar13 /*203*/].f_A[iVar3 /*48*/].f_1)
			{
				MemCopy(&Var18, {Global_B5F8[iVar13 /*203*/].f_A[iVar3 /*48*/].f_2}, 16);
			}
			if (Global_91A4[iVar15 /*12*/].f_4 == 0)
			{
				func_73(0);
			}
			else if (bVar1)
			...
			bVar19 = false;
			bVar19 = func_53(uParam0, Global_B5F8[iVar13 /*203*/].f_1, iVar3, iVar16);
			if (!bVar19)
			{
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0, "SET_DATA_SLOT");
				GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(9);
				GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(0);
				func_7(func_55(Global_91A4[iVar15 /*12*/].f_3));
				func_7(func_55(Global_91A4[iVar15 /*12*/].f_2));
				func_7(&Var17);
				if (Global_B5F8[iVar13 /*203*/].f_A[iVar3 /*48*/].f_6 > 0)
				{
					GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&Var18);
					iVar20 = 0;
					iVar20 = 0;
					while (iVar20 < Global_B5F8[iVar13 /*203*/].f_A[iVar3 /*48*/].f_6)
					{
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_B5F8[iVar13 /*203*/].f_A[iVar3 /*48*/].f_7[iVar20 /*4*/]));
						iVar20++;
					}
					CAM::_DISABLE_VEHICLE_FIRST_PERSON_CAM_THIS_FRAME();
				}
				...
				func_7(func_38(Global_91A4[iVar15 /*12*/].f_2));
				func_37(iVar15, Global_91A4[iVar15 /*12*/].f_2);
				CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
			}
		}
	}
...
int func_53(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x4643
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0, "SET_DATA_SLOT_EMPTY");
	CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
	Var3 = { func_28(Global_91A4[iParam3 /*12*/]) };
	switch (iParam3)
	{
		case 72:
	...
	GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(9);
	GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(iVar2);
	func_7(func_55(Global_91A4[iParam3 /*12*/].f_3));
	func_7(func_55(Global_91A4[iParam3 /*12*/].f_2));
	func_7(&Var3);
	func_7(&Var4);
	func_7(func_38(Global_91A4[iParam3 /*12*/].f_2));
	func_7("");
	GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(0);
	GRAPHICS::SET_SEETHROUGH(true);
	CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
	...
	while (iVar5 < 16)
	{
		...
		{
			case 72:
				if (Global_19E56.f_612C[iVar6 /*4*/] == 0)
				{
					bVar7 = true;
				}
				break;
			...
			case 73:
				if (Global_19E56.f_612C[iVar6 /*4*/] == 1)
				{
					bVar7 = true;
				}
				break;
			...
			case 74:
				if (Global_19E56.f_612C[iVar6 /*4*/] == 2)
				{
					bVar7 = true;
				}
				break;
		...
		if (bVar7)
		{
			...
			HUD::ADD_TEXT_COMPONENT_INTEGER(Global_19E56.f_612C[iVar6 /*4*/].f_3);
			CAM::_DISABLE_VEHICLE_FIRST_PERSON_CAM_THIS_FRAME();
			CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
			iVar2++;
			iVar0 = 1;
...
void func_56(int iParam0)//Position - 0x4C6E
{
	...
	{
		case 0:
			Global_919C = (Global_919C + iParam0);
			if (Global_919C < 0)
			{
				Global_919C = 0;
			}
		...
		case 2:
			Global_919E = (Global_919E + iParam0);
			if (Global_919E < 0)
			{
				Global_919E = 0;
			}
		...
		case 1:
			Global_919D = (Global_919D + iParam0);
			if (Global_919D < 0)
			{
				Global_919D = 0;
			}
...
void func_57(int iParam0, int iParam1)//Position - 0x4CD9
{
	...
	iVar4 = Global_B48E[iVar0 /*120*/].f_1[iVar2];
	iVar5 = 4294967295;
	bVar6 = Global_B48E[iVar0 /*120*/].f_56[iVar2];
	if (!bVar6)
	{
		iVar5 = Global_9EA1[iVar3 /*46*/].f_20[iVar4];
	}
	else
	{
		...
		while (iVar8 < 7)
		{
			if (Global_B5F8[iVar8 /*203*/].f_1 == iVar3)
			{
				iVar7 = iVar8;
			}
			iVar8++;
		...
		iVar5 = Global_B5F8[iVar7 /*203*/].f_A[iVar4 /*48*/];
	}
	if (!func_58(iVar5))
	{
		return;
	...
	Global_B5F7 = iVar5;
	unk_0xE2BBD32891C18569(func_12(iVar5), 0);
...
void func_59()//Position - 0x4EBB
{
	...
	while (iVar0 < 3)
	{
		if (Global_919F[iVar0] != 4294967295)
		{
			HUD::_REMOVE_NOTIFICATION(Global_919F[iVar0]);
			Global_919F[iVar0] = 4294967295;
		}
		iVar0++;
	}
	Global_91A3 = 0;
...
int func_62(var uParam0, int iParam1)//Position - 0x4FB8
{
	...
	CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
	if (Global_B48E[iVar0 /*120*/] < 1)
	{
		return 0;
	}
	iVar1 = (Global_B48E[iVar0 /*120*/] - 1);
	while (iVar1 >= 16)
	{
		iVar1 = (iVar1 - 16);
	}
	iVar2 = Global_B48E[iVar0 /*120*/];
	if (iVar2 > 16)
	{
		iVar2 = 16;
	}
	...
	while (iVar3 < iVar2)
	{
		if (!Global_B48E[iVar0 /*120*/].f_56[iVar1])
		{
			iVar4 = Global_B48E[iVar0 /*120*/].f_12[iVar1];
			iVar5 = Global_B48E[iVar0 /*120*/].f_1[iVar1];
			iVar6 = Global_9EA1[iVar4 /*46*/].f_20[iVar5];
			iVar7 = 0;
			if (Global_B48E[iVar0 /*120*/].f_45[iVar1])
			{
				iVar7 = 1;
			}
			if (iVar7 == 1)
			{
				if (Global_91A4[iVar6 /*12*/].f_4 > 0)
				{
					if (Global_B48E[iVar0 /*120*/].f_23[iVar1] == 0)
					{
						iVar7 = 2;
					}
				}
			}
			MemCopy(&sVar8, {func_28(Global_91A4[iVar6 /*12*/])}, 4);
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0, "SET_DATA_SLOT");
			GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(8);
		...
		{
			iVar9 = Global_B48E[iVar0 /*120*/].f_12[iVar1];
			iVar10 = 4294967295;
			iVar11 = 0;
			iVar11 = 0;
			while (iVar11 < 7)
			{
				if (Global_B5F8[iVar11 /*203*/].f_1 == iVar9)
				{
					iVar10 = iVar11;
				}
				iVar11++;
			...
			{
				iVar12 = Global_B48E[iVar0 /*120*/].f_1[iVar1];
				iVar13 = 0;
				if (Global_B48E[iVar0 /*120*/].f_45[iVar1])
				{
					iVar13 = 1;
				}
				iVar14 = Global_B5F8[iVar10 /*203*/].f_A[iVar12 /*48*/];
				if (iVar13 == 1)
				{
					if (Global_91A4[iVar14 /*12*/].f_4 > 0)
					{
						if (Global_B48E[iVar0 /*120*/].f_23[iVar1] == 0)
						{
							iVar13 = 2;
				...
				Var15 = { func_28(Global_91A4[iVar14 /*12*/]) };
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0, "SET_DATA_SLOT");
				GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(8);
				GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(iVar3);
				GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(iVar13);
				GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(0);
				func_7(func_55(Global_91A4[iVar14 /*12*/].f_2));
				func_7(&Var15);
				CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
			}
		}
...
void func_63(int iParam0)//Position - 0x5247
{
	...
	{
		bVar6 = true;
		if (Global_B48E[iVar0 /*120*/].f_67[iVar3])
		{
			bVar6 = false;
		}
		if (Global_B48E[iVar0 /*120*/].f_56[iVar3])
		{
			iVar7 = Global_B48E[iVar0 /*120*/].f_12[iVar3];
			iVar8 = 4294967295;
			iVar9 = 0;
			iVar9 = 0;
			while (iVar9 < 7)
			{
				if (Global_B5F8[iVar9 /*203*/].f_1 == iVar7)
				{
					iVar8 = iVar9;
				}
				iVar9++;
		...
		{
			iVar10 = Var4;
			Var4.f_1[iVar10] = Global_B48E[iVar0 /*120*/].f_1[iVar3];
			Var4.f_12[iVar10] = Global_B48E[iVar0 /*120*/].f_12[iVar3];
			Var4.f_23[iVar10] = Global_B48E[iVar0 /*120*/].f_23[iVar3];
			Var4.f_34[iVar10] = Global_B48E[iVar0 /*120*/].f_34[iVar3];
			Var4.f_45[iVar10] = Global_B48E[iVar0 /*120*/].f_45[iVar3];
			Var4.f_56[iVar10] = Global_B48E[iVar0 /*120*/].f_56[iVar3];
			Var4++;
		}
		iVar3++;
		if (iVar3 == 16)
	...
	Global_B48E[iVar0 /*120*/] = Var4;
	iVar5 = 0;
	while (iVar5 < 16)
	{
		Global_B48E[iVar0 /*120*/].f_67[iVar5] = 0;
		Global_B48E[iVar0 /*120*/].f_1[iVar5] = Var4.f_1[iVar5];
		Global_B48E[iVar0 /*120*/].f_12[iVar5] = Var4.f_12[iVar5];
		Global_B48E[iVar0 /*120*/].f_23[iVar5] = Var4.f_23[iVar5];
		Global_B48E[iVar0 /*120*/].f_34[iVar5] = Var4.f_34[iVar5];
		Global_B48E[iVar0 /*120*/].f_45[iVar5] = Var4.f_45[iVar5];
		Global_B48E[iVar0 /*120*/].f_56[iVar5] = Var4.f_56[iVar5];
		iVar5++;
	}
}
...
void func_64()//Position - 0x54E3
{
	...
	fVar0 = func_65(vLocal_48, vLocal_47, -90f, 0f, 90f, Global_3889, 350f, 0);
	if (Global_C73 == 0)
	{
...
float func_65(vector3 vParam0, vector3 vParam1, vector3 vParam2, vector3 vParam3, float fParam4, bool bParam5)//Position - 0x5541
{
	...
	if (fVar1 < 1f)
	{
		...
		Global_3869 = { func_66(vParam0, vParam1, fVar2) };
		Global_386C = { func_66(vParam2, vParam3, fVar2) };
	}
	else
	{
		Global_3869 = { vParam1 };
...
void func_69()//Position - 0x58BB
{
	...
	fVar0 = func_65(vLocal_47, vLocal_48, Global_3889, -90f, 0f, 90f, 350f, 0);
	if (Global_C73 == 0)
	{
...
void func_71(bool bParam0)//Position - 0x595B
{
	...
	if (bParam0)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_389E, "SET_SOFT_KEYS");
		GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(1);
		GRAPHICS::SET_SEETHROUGH(true);
...
void func_75()//Position - 0x5AE8
{
	...
	{
		if (func_78(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			iVar0 = func_77(AUDIO::_0x0626A247D2405330());
			if (func_76(iVar0) && (!func_11(14) || Global_19A3D))
			{
				if (Global_19E56.f_933.f_21B.f_10CD != iVar0 && func_76(Global_19E56.f_933.f_21B.f_10CD))
				{
