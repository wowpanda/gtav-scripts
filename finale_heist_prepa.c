	...
	switch (iLocal_41)
	{
		...
		case 1:
			if (func_14())
			{
				...
				else if (func_12(&uLocal_150, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
				{
...
void func_71()
{
	...
	iLocal_467 = 1;
	func_372(27, 0);
	OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Global_34984[13 /*31*/], 4, 1, 0);
	iLocal_468 = 0;
}
...
int func_81(int iParam0, vector3 vParam1, float fParam2)
{
	...
	switch (iParam0)
	{
		...
		case 3:
			...
			while (iVar0 <= 2)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_89475.f_9[iVar0]))
				{
					if (!PED::IS_PED_DEAD_OR_DYING(Global_89475.f_9[iVar0], 1))
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89475.f_9[iVar0], true, 1);
		...
		case 4:
			...
			while (iVar3 <= 3)
			{
				...
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89475[iVar3], true, 1);
...
void func_146(int iParam0)
{
	...
	if (!func_167(iParam0))
	{
		if (func_148(Local_289[iParam0 /*22*/], 1, 50f, 140f, 0, 1, 1, 1) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_289[iParam0 /*22*/], 1), 100f))
		{
...
int func_155(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_157(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_165(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_157(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_197(int iParam0)
{
	if (!func_167(iParam0))
	{
		...
		else if (func_148(Local_289[iParam0 /*22*/], 1, 70f, 150f, 0, 1, 0, 1) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_289[iParam0 /*22*/], 1), 100f))
		{
			func_124();
		}
...
void func_199()
{
	...
	{
		if ((((func_369(Local_289[0 /*22*/]) && func_369(Local_289[1 /*22*/])) && func_12(&uLocal_46, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))) && func_62(Local_289[0 /*22*/], Local_289[0 /*22*/].f_1, 3f)) && func_62(Local_289[1 /*22*/], Local_289[1 /*22*/].f_1, 3f))
		{
		...
		else if ((func_369(Local_289[2 /*22*/]) && func_12(&uLocal_98, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))) && func_62(Local_289[2 /*22*/], Local_289[2 /*22*/].f_1, 3f))
		{
	...
	switch (iLocal_41)
	{
		case 0:
			if (func_70(iLocal_40, bLocal_28))
			{
				...
				if (OBJECT::_DOES_DOOR_EXIST(Global_34984[13 /*31*/]))
				{
					AUDIO::_0x06C0023BED16DD6B(Global_34984[13 /*31*/], 1);
				}
				iLocal_479 = 0;
...
void func_216()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			func_217(iVar0, ENTITY::GET_ENTITY_COORDS(iVar0, 1), ENTITY::GET_ENTITY_HEADING(iVar0), 24, 0);
		}
	}
}
...
int func_265(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_70671[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_266(iParam1)) && Global_70671[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_266(iParam1)))
	{
		return 1;
	}
	return 0;
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_288(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
		...
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_288(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
void func_377()
{
	...
	OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Global_34984[13 /*31*/], 1, 1, 0);
...
void func_388()
{
	...
	if (OBJECT::_DOES_DOOR_EXIST(Global_34984[13 /*31*/]))
	{
		AUDIO::_0x06C0023BED16DD6B(Global_34984[13 /*31*/], 0);
	}
	OBJECT::_SET_DOOR_AJAR_ANGLE(Global_34984[13 /*31*/], 0f, 1, 1);
	OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Global_34984[13 /*31*/], 4, 1, 1);
