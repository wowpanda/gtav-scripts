...
void func_17(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_19(Global_105220.f_18504[iVar0], &vVar2, &fVar3))
			{
...
void func_71()
{
	...
	iLocal_467 = 1;
	func_372(27, 0);
	OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Global_35028[13 /*31*/], 4, 1, 0);
	iLocal_468 = 0;
}
	...
	while (iVar0 <= 2)
	{
		...
		if (!func_77(Local_289[iVar0 /*22*/], -1098463898))
		{
			switch (iVar0)
			{
				case 0:
				case 1:
					BRAIN::TASK_START_SCENARIO_AT_POSITION(Local_289[iVar0 /*22*/], "WORLD_HUMAN_HANG_OUT_STREET", Local_289[iVar0 /*22*/].f_1, Local_289[iVar0 /*22*/].f_4, 0, 0, 1);
					break;
				
				case 2:
					BRAIN::TASK_USE_MOBILE_PHONE(Local_289[iVar0 /*22*/], 1, 1);
					break;
				}
		}
...
int func_81(int iParam0, vector3 vParam1, float fParam2)
{
	...
	switch (iParam0)
	{
		...
		case 3:
			...
			while (iVar0 <= 2)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_89597.f_9[iVar0]))
				{
					if (!PED::IS_PED_DEAD_OR_DYING(Global_89597.f_9[iVar0], 1))
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89597.f_9[iVar0], true, 1);
						Local_289[iVar0 /*22*/] = Global_89597.f_9[iVar0];
		...
		case 4:
			...
			while (iVar3 <= 3)
			{
				if (func_7(Global_89597[iVar3]))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89597[iVar3], true, 1);
					Local_291[iVar4 /*6*/] = Global_89597[iVar3];
...
int func_95(int iParam0)
{
	...
	if ((func_369(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_7(iParam0))
	{
...
int func_106(int iParam0, int iParam1)
{
	...
	{
		case 0:
			BRAIN::TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, PED::GET_VEHICLE_PED_IS_IN(iParam1, 0), vLocal_266, 4, 20f, 786469, 3.5f, 5f, 1);
			iLocal_43[iParam0] = 3;
			break;
	...
	switch (iLocal_43[iParam0])
	{
		case 0:
			if (!MISC::IS_POSITION_OCCUPIED(Local_254[iLocal_470 /*4*/], 1.5f, 0, 0, 1, 0, 0, iParam1, 0))
			{
				...
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam1, Local_254[iLocal_470 /*4*/], fVar0, 20000, 0.25f, 0, Local_254[iLocal_470 /*4*/].f_3);
				iLocal_43[iParam0] = 1;
			}
			break;
...
void func_119(int iParam0)
{
	...
	switch (Local_289[iParam0 /*22*/].f_20)
	{
			...
			if (func_143(iParam0) && func_62(Local_289[iParam0 /*22*/], Local_289[iParam0 /*22*/].f_1, 3f))
			{
				if (MISC::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > MISC::GET_RANDOM_INT_IN_RANGE(1000, 1500)
				{
					if (!func_77(Local_289[iParam0 /*22*/], -875674219))
					{
						...
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(Local_289[iParam0 /*22*/], PLAYER::PLAYER_PED_ID(), 0);
					}
		...
		case 6:
			...
			{
				if (!PED::IS_PED_BEING_STUNNED(Local_289[iParam0 /*22*/], 0) && !BRAIN::IS_PED_IN_WRITHE(Local_289[iParam0 /*22*/]))
				{
					Local_289[iParam0 /*22*/].f_14 = MISC::GET_GAME_TIMER();
					func_126(iParam0);
				}
			...
			if ((MISC::GET_GAME_TIMER() - Local_289[iParam0 /*22*/].f_14) > 350)
			{
				...
				else
				{
					...
					if ((func_77(Local_289[iParam0 /*22*/], -2128726980) || func_77(Local_289[iParam0 /*22*/], -982327190)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 2)
					{
						...
						{
							BRAIN::TASK_ARREST_PED(Local_289[iParam0 /*22*/], PLAYER::PLAYER_PED_ID());
						}
					}
				}
			}
...
void func_126(int iParam0)
{
	if (Local_289[iParam0 /*22*/].f_20 != 7)
	{
		if (func_369(Local_289[iParam0 /*22*/]))
		{
			...
			{
				BRAIN::CLEAR_PED_TASKS(Local_289[iParam0 /*22*/]);
			}
...
int func_130(int iParam0, float fParam1)
{
	...
	if (func_369(PLAYER::PLAYER_PED_ID()) && func_369(iParam0))
	{
...
void func_133(int iParam0)
{
	...
	if (Local_289[iParam0 /*22*/].f_18 != 1 && !func_77(Local_289[iParam0 /*22*/], 242628503))
	{
		...
		if (iParam0 == 2)
		{
			...
			{
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_289[iParam0 /*22*/].f_1, 1f, 120000, 0.25f, 0, Local_289[iParam0 /*22*/].f_4);
			}
			else
			{
				BRAIN::TASK_ACHIEVE_HEADING(0, Local_289[iParam0 /*22*/].f_4, 0);
			}
			...
			{
				BRAIN::TASK_USE_MOBILE_PHONE(0, 1, 1);
			}
			BRAIN::CLOSE_SEQUENCE_TASK(iVar0);
			BRAIN::TASK_PERFORM_SEQUENCE(Local_289[iParam0 /*22*/], iVar0);
	...
	switch (Local_289[iParam0 /*22*/].f_21)
	{
		case 0:
			...
			else if (iParam0 == 2)
			{
				...
				{
					BRAIN::CLEAR_PED_TASKS(Local_289[iParam0 /*22*/]);
					BRAIN::TASK_START_SCENARIO_IN_PLACE(Local_289[iParam0 /*22*/], "WORLD_HUMAN_STAND_MOBILE", 0, 1);
				}
			}
			break;
...
void func_199()
{
	...
	{
		if ((((func_369(Local_289[0 /*22*/]) && func_369(Local_289[1 /*22*/])) && func_12(&uLocal_46, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true))) && func_62(Local_289[0 /*22*/], Local_289[0 /*22*/].f_1, 3f)) && func_62(Local_289[1 /*22*/], Local_289[1 /*22*/].f_1, 3f))
		{
		...
		else if ((func_369(Local_289[2 /*22*/]) && func_12(&uLocal_98, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true))) && func_62(Local_289[2 /*22*/], Local_289[2 /*22*/].f_1, 3f))
		{
	...
	switch (iLocal_41)
	{
		case 0:
			if (func_70(iLocal_40, bLocal_28))
			{
				...
				if (OBJECT::_DOES_DOOR_EXIST(Global_35028[13 /*31*/]))
				{
					AUDIO::_0x06C0023BED16DD6B(Global_35028[13 /*31*/], 1);
				}
				iLocal_479 = 0;
	...
	switch (iLocal_41)
	{
		case 0:
			if (func_70(iLocal_40, 0))
			{
				...
				MISC::CLEAR_AREA_OF_PEDS(369.0115f, -1609.116f, 28.2928f, 5f, 0);
				MISC::CLEAR_AREA_OF_PEDS(Local_289[0 /*22*/].f_1, 5f, 0);
				if (func_265(PLAYER::PLAYER_PED_ID(), 12, 4) || func_265(PLAYER::PLAYER_PED_ID(), 12, 3))
				{
					bLocal_272 = true;
				}
				func_216();
...
void func_216()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			func_217(iVar0, ENTITY::GET_ENTITY_COORDS(iVar0, true), ENTITY::GET_ENTITY_HEADING(iVar0), 24, 0);
		}
	}
}

void func_217(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_235(iParam0, 0, 0)) || func_235(iParam0, 1, 0)) || func_235(iParam0, 2, 0)) || func_258(iParam0) != 145) || func_234(iParam0)) || func_233(iParam0)) || func_232(iParam0)) || func_231(iParam0)) || !func_221(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_233(iParam0))
		{
		}
...
var func_238()
{
	...
	func_241(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_240(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_239(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_244(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_252(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_249(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
...
int func_265(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_70793[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_266(iParam1)) && Global_70793[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_266(iParam1)))
	{
		return 1;
	}
	return 0;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_271(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_271(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_271(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_271(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_271(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_266(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_279(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_266(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_287(int iParam0)
{
	...
	func_288(&(Global_70793[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_291(func_293(iParam1, uParam0->f_2), Global_70790, 0);
...
int func_291(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_292(iParam1)];
...
void func_298(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_288(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_266(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_288(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
void func_356()
{
	if (bLocal_274)
	{
		if (PED::IS_COP_PED_IN_AREA_3D(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, true, 0))
		{
			if (func_12(&uLocal_150, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
			{
				func_358(Global_35028[13 /*31*/], &fLocal_270);
				return;
			}
		}
		else
		{
			func_357(Global_35028[13 /*31*/], &fLocal_270);
		}
	}
...
struct<7> func_375(vector3 vParam0, vector3 vParam1, float fParam2)
{
	struct<7> Var0;
...
void func_377()
{
	...
	OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Global_35028[13 /*31*/], 1, 1, 0);
...
void func_380(var uParam0, vector3 vParam1)
{
	if (uParam0->f_51 == 0)
	{
	}
...
struct<22> func_384(vector3 vParam0, float fParam1, int iParam2)
{
	struct<22> Var0;
...
struct<6> func_386(vector3 vParam0, float fParam1, int iParam2)
{
	struct<6> Var0;
...
void func_388()
{
	...
	if (OBJECT::_DOES_DOOR_EXIST(Global_35028[13 /*31*/]))
	{
		AUDIO::_0x06C0023BED16DD6B(Global_35028[13 /*31*/], 0);
	}
	OBJECT::_SET_DOOR_AJAR_ANGLE(Global_35028[13 /*31*/], 0f, 1, 1);
	OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Global_35028[13 /*31*/], 4, 1, 1);
