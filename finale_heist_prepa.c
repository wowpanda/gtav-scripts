...
void __EntryFunction__()
{
	...
	func_388();
	func_374();
	uLocal_360 = ADD_SCENARIO_BLOCKING_AREA(402.9022f, -1633.604f, 25.0472f, 315.6288f, -1558.814f, 38.7931f, 0, 1, 1, 1);
	func_373(27, 0);
	if (func_372())
	{
...
void func_1()
{
	switch (iLocal_81)
	{
		case 0:
			...
			CLEAR_HELP(1);
			func_32();
			if (!IS_STRING_NULL_OR_EMPTY(sLocal_353))
			{
				func_30(sLocal_353);
			}
			else
		...
		case 1:
			if (func_14())
			{
				...
				else if (func_12(&uLocal_196, GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)))
				{
					func_10(408.3364f, -1567.429f, 28.2723f, 128.2512f);
					func_8(471.5946f, -1412.737f, 28.1562f, 68.5531f);
				}
				CLEAR_AREA(372.9868f, -1623.531f, 28.2928f, 100f, 1, 0, 0, 0);
				func_2();
				func_389();
			}
			break;
...
void func_2()
{
	...
	REMOVE_VEHICLE_UPSIDEDOWN_CHECK(Local_456);
	func_5(&Local_456);
	func_4(&uLocal_358);
	iVar0 = 0;
	while (iVar0 <= 2)
...
bool func_12(var uParam0, struct<2> Param1, var uParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_17(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_19(Global_106565.f_18527[iVar0], &vVar2, &fVar5))
			{
...
void func_34()
{
	...
	func_90(&Local_456, &uVar0, &iLocal_82, &uLocal_357, &uLocal_356, vLocal_364, 0, 0, 1090519040);
	switch (iLocal_81)
	{
		case 0:
		...
		case 1:
			func_69(&uLocal_356, vLocal_364, &iLocal_91, iLocal_82, &iLocal_355, &iLocal_384);
			if (iLocal_91 == 2)
			{
				if (func_12(&uLocal_196, GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)))
				{
					_0x4669B3ED80F24B4E(PLAYER_ID());
				}
			}
			if (func_57(Local_456, vLocal_364, &uLocal_356, iLocal_82, iLocal_91, &iLocal_663, &iLocal_385, &iLocal_379, &iLocal_380, &iLocal_355, 1090519040))
			{
		...
		case 3:
			if (func_7(Local_456))
			{
				if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_456, 0))
				{
					SET_PED_INTO_VEHICLE(PLAYER_PED_ID(), Local_456, -1);
				}
				else
				{
					func_48(Local_456, vLocal_364, 126.0705f, 0, 1);
					func_35(1, 1, 1);
					iLocal_81 = 1;
				}
			}
	...
	if (iParam1 == 1)
	{
		if ((iLocal_37 != 0 && iLocal_37 != joaat("object")) && iLocal_37 != joaat("gadget_parachute"))
		{
			if (func_6(PLAYER_PED_ID()))
			{
				...
				{
					SET_CURRENT_PED_WEAPON(PLAYER_PED_ID(), iLocal_37, 0);
				}
			}
		}
	}
...
int func_48(int iParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
int func_57(int iParam0, vector3 vParam1, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	float fVar0;
	...
	if ((iParam5 == 1 || iParam5 == 2) || iParam5 == 3)
	{
		if (iParam6 == 0)
		{
			...
			if (!IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vParam1, fParam12, fParam12, 2f, 0, 1, 2))
			{
				IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vParam1, fParam12, fParam12, 2f, 1, 1, 2);
				if (func_65(func_67(func_68()), 0, 0))
				{
					CLEAR_THIS_PRINT(func_67(func_68()));
				}
				*iParam7 = 1;
				func_63(uParam4, vParam1, 1);
			}
			else
			{
				if (*iParam7)
				{
					fVar0 = (fParam12 / 2f);
					if (func_62(PLAYER_PED_ID(), vParam1, fVar0))
					{
						*iParam7 = 0;
	...
	else if (IS_ENTITY_AT_COORD(iParam0, vParam1, fParam12, fParam12, 2f, 0, 1, 2))
	{
		if (*iParam9 == -1)
		{
	...
	else
	{
		...
		if (!*iParam8)
		{
			...
			{
				CLEAR_THIS_PRINT(func_60(func_68(), 0));
			}
...
bool func_62(var uParam0, vector3 vParam1, float fParam4)
{
	return VDIST2(GET_ENTITY_COORDS(uParam0, 1), vParam1) <= (fParam4 * fParam4);
}

void func_63(var uParam0, vector3 vParam1, int iParam4)
{
	if (!DOES_BLIP_EXIST(*uParam0))
	{
		*uParam0 = func_64(vParam1, 5, iParam4);
	}
}

int func_64(vector3 vParam0, int iParam3, var uParam4)
{
	int iVar0;
...
void func_69(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
	switch (*iParam4)
	{
		case 0:
...
int func_70(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_81(1, vLocal_361, 0))
			{
				if (((func_81(2, Local_456.f_1, Local_456.f_4) && func_81(4, vLocal_361, 0)) && func_81(3, vLocal_361, 0)) && func_81(5, vLocal_361, 0))
				{
					uLocal_371 = ADD_NAVMESH_BLOCKING_OBJECT(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_80(229.3746f), 0, 7);
					if (GET_BLIP_FROM_ENTITY(Local_456) != 0)
					{
						uVar0 = GET_BLIP_FROM_ENTITY(Local_456);
						SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(1);
						func_33(&uVar0);
						SET_THIS_SCRIPT_CAN_REMOVE_BLIPS_CREATED_BY_ANY_SCRIPT(0);
					}
					func_78(&uLocal_356, Local_456, 1);
					func_76();
					func_74();
					return 1;
				}
		...
		case 1:
			if (bParam1)
			{
				if (((func_81(2, Local_456.f_1, Local_456.f_4) && func_81(4, vLocal_361, 0)) && func_81(3, vLocal_361, 0)) && func_81(5, vLocal_361, 0))
				{
					func_73(PLAYER_PED_ID(), 408.3364f, -1567.429f, 28.2723f, 128.2512f);
					func_71();
					CLEAR_AREA_OF_PEDS(369.0115f, -1609.116f, 28.2928f, 5f, 0);
					CLEAR_AREA_OF_PEDS(Local_389[0 /*22*/].f_1, 5f, 0);
					func_76();
					func_74();
					bLocal_28 = false;
					func_35(1, 1, 1);
		...
		case 2:
			if (bParam1)
			{
				if ((func_81(2, Local_456.f_1, Local_456.f_4) && func_81(4, vLocal_361, 0)) && func_81(3, vLocal_361, 0))
				{
					func_71();
					CLEAR_AREA_OF_PEDS(369.0115f, -1609.116f, 28.2928f, 5f, 0);
					CLEAR_AREA_OF_PEDS(Local_389[0 /*22*/].f_1, 5f, 0);
		...
		case 3:
			if (bParam1)
			{
				if (func_81(2, vLocal_364, Local_456.f_4))
				{
					func_71();
					SET_PED_INTO_VEHICLE(PLAYER_PED_ID(), Local_456, -1);
					func_74();
...
void func_71()
{
	...
	iLocal_662 = 1;
	func_373(27, 0);
	_SET_DOOR_ACCELERATION_LIMIT(Global_35548[13 /*31*/], 4, 1, 0);
	iLocal_663 = 0;
}
...
void func_72()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (iVar0 <= (15 - 1))
		{
			CLEAR_BIT(&(Local_389[iVar1 /*22*/].f_15), iVar0);
			iVar0++;
		}
...
void func_73(var uParam0, vector3 vParam1, float fParam4)
{
	if (func_370(uParam0))
	{
		CLEAR_PED_TASKS(uParam0);
	}
	func_48(uParam0, vParam1, fParam4, 0, 1);
}
...
void func_74()
{
	...
	func_75(&uLocal_483, iVar0, PLAYER_PED_ID(), sVar1, 0, 1);
...
void func_75(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_76()
{
	...
	while (iVar0 <= 2)
	{
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_389[iVar0 /*22*/], 0);
		if (!func_77(Local_389[iVar0 /*22*/], -1098463898))
		{
			switch (iVar0)
			{
				case 0:
				case 1:
					TASK_START_SCENARIO_AT_POSITION(Local_389[iVar0 /*22*/], "WORLD_HUMAN_HANG_OUT_STREET", Local_389[iVar0 /*22*/].f_1, Local_389[iVar0 /*22*/].f_4, 0, 0, 1);
					break;
				
				case 2:
					TASK_USE_MOBILE_PHONE(Local_389[iVar0 /*22*/], 1, 1);
					break;
				}
		}
		GIVE_WEAPON_TO_PED(Local_389[iVar0 /*22*/], joaat("weapon_pistol"), -1, 0, 0);
		SET_PED_RELATIONSHIP_GROUP_HASH(Local_389[iVar0 /*22*/], uLocal_481);
...
void func_78(var uParam0, var uParam1, int iParam2)
{
	if (!DOES_BLIP_EXIST(*uParam0))
	{
		*uParam0 = func_79(uParam1, iParam2, 5);
	}
}
...
int func_79(var uParam0, var uParam1, int iParam2)
{
	...
	if (func_6(uParam0))
	{
		...
		SET_BLIP_AS_FRIENDLY(iVar0, uParam1);
...
int func_81(int iParam0, vector3 vParam1, float fParam4)
{
	int iVar0;
	int iVar1;
	char cVar2[16];
	...
	{
		case 0:
			if (func_89(vParam1, vLocal_361, 1056964608, 0) && fParam4 == 0f)
			{
				return 1;
			}
			break;
		...
		case 1:
			REQUEST_ADDITIONAL_TEXT(sLocal_354, 0);
			REQUEST_ADDITIONAL_TEXT(cLocal_482, 6);
		...
		case 2:
			if (func_7(Global_90209[0]))
			{
				...
				Local_456 = Global_90209[0];
				if (func_7(Local_456))
				{
					if (!DOES_VEHICLE_HAVE_STUCK_VEHICLE_CHECK(Local_456))
					{
						ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_456);
					}
					_SET_VEHICLE_DOOR_CAN_BREAK(Local_456, 2, 0);
					_SET_VEHICLE_DOOR_CAN_BREAK(Local_456, 3, 0);
					func_88(Local_456, 0);
					SET_VEHICLE_HAS_STRONG_AXLES(Local_456, 1);
					SET_VEHICLE_DOORS_LOCKED(Local_456, 1);
					return 1;
				}
			}
		...
		case 3:
			...
			while (iVar0 <= 2)
			{
				if (DOES_ENTITY_EXIST(Global_90209.f_9[iVar0]))
				{
					if (!IS_PED_DEAD_OR_DYING(Global_90209.f_9[iVar0], 1))
					{
						SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_9[iVar0], 1, 1);
						Local_389[iVar0 /*22*/] = Global_90209.f_9[iVar0];
						if (func_370(Local_389[iVar0 /*22*/]))
						{
							SET_PED_TARGET_LOSS_RESPONSE(Local_389[iVar0 /*22*/], 2);
							STOP_PED_SPEAKING(Local_389[iVar0 /*22*/], 1);
							func_86(iVar0);
							iVar1++;
						}
					}
				...
				else if (func_85(&(Local_389[iVar0 /*22*/]), Local_389[iVar0 /*22*/].f_5, Local_389[iVar0 /*22*/].f_1, Local_389[iVar0 /*22*/].f_4, 0, 0, 0, 1))
				{
					...
					SET_PED_NAME_DEBUG(Local_389[iVar0 /*22*/], &cVar2);
					iVar1++;
				}
				iVar0++;
			}
		...
		case 4:
			...
			while (iVar6 <= 3)
			{
				...
				{
					SET_ENTITY_AS_MISSION_ENTITY(Global_90209[iVar6], 1, 1);
		...
		case 5:
			if (func_82(&uLocal_358, joaat("prop_box_guncase_03a"), 354.6938f, -1634.783f, 22.7849f, 299.1508f, 1))
			{
				if (func_7(Local_456))
				{
					ATTACH_ENTITY_TO_ENTITY(uLocal_358, Local_456, 0, 0f, -1.85f, 0.05f, GET_ENTITY_ROTATION(Local_456, 2), 0, 0, 0, 0, 2, 1);
					if (IS_ENTITY_ATTACHED_TO_ENTITY(Local_456, uLocal_358))
					{
						return 1;
					}
				}
...
int func_82(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	if (!DOES_ENTITY_EXIST(*uParam0))
	{
...
int func_85(var uParam0, var uParam1, vector3 vParam2, var uParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	if (!DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_84(uParam1, "Loading", 0))
		{
			*uParam0 = CREATE_PED(26, uParam1, vParam2, uParam5, 1, 1);
			if (func_370(*uParam0))
			{
				if (bParam7)
				{
				...
				if (bParam8)
				{
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(*uParam0, bParam8);
				}
				if (!bParam9)
				{
					SET_PED_CAN_BE_TARGETTED(*uParam0, bParam9);
				}
				if (bParam6)
				{
					func_83(uParam1, 1);
...
void func_86(int iParam0)
{
	if (func_370(Local_389[iParam0 /*22*/]))
	{
		if (iParam0 == 0)
		{
			SET_PED_COMPONENT_VARIATION(Local_389[iParam0 /*22*/], 0, 0, 1, 0);
			SET_PED_COMPONENT_VARIATION(Local_389[iParam0 /*22*/], 3, 0, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_389[iParam0 /*22*/], 4, 0, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_389[iParam0 /*22*/], 8, 0, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_389[iParam0 /*22*/], 9, 1, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_389[iParam0 /*22*/], 10, 0, 0, 0);
		}
		else
		{
			SET_PED_COMPONENT_VARIATION(Local_389[iParam0 /*22*/], 0, 1, 1, 0);
			SET_PED_COMPONENT_VARIATION(Local_389[iParam0 /*22*/], 3, 0, 1, 0);
			SET_PED_COMPONENT_VARIATION(Local_389[iParam0 /*22*/], 4, 0, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_389[iParam0 /*22*/], 8, 1, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_389[iParam0 /*22*/], 9, 2, 0, 0);
			SET_PED_COMPONENT_VARIATION(Local_389[iParam0 /*22*/], 10, 0, 1, 0);
		}
	}
}

int func_87(int iParam0, var uParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (!DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_84(uParam1, "Loading", 0))
		{
			*iParam0 = CREATE_VEHICLE(uParam1, vParam2, uParam5, 1, 1, 0);
			if (DOES_ENTITY_EXIST(*iParam0))
			{
	...
	else
	{
		if (func_7(*iParam0))
		{
			SET_ENTITY_COORDS(*iParam0, vParam2, 1, 0, 0, 1);
			SET_ENTITY_HEADING(*iParam0, uParam5);
		}
		if (!IS_ENTITY_A_MISSION_ENTITY(*iParam0))
		{
			SET_ENTITY_AS_MISSION_ENTITY(*iParam0, 1, 0);
...
int func_89(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_90(int iParam0, var uParam1, int iParam2, var uParam3, var uParam4, vector3 vParam5, int iParam8, bool bParam9, int iParam10)
{
	if (func_7(*iParam0))
	{
		switch (*iParam2)
		{
			case 0:
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), *iParam0, 0))
				{
					...
					if (func_65(func_59(func_68()), 0, 0))
					{
						CLEAR_THIS_PRINT(func_59(func_68()));
					}
					if (*iParam0 == iParam8)
					{
						*iParam2 = 1;
				...
				else
				{
					...
					{
						CLEAR_THIS_PRINT(func_60(func_68(), bParam9));
					}
					if (func_68() != 33)
					{
						func_93(iParam0);
			...
			case 2:
			case 1:
				if ((!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), *iParam0, 0) && !func_96(*iParam0)) && !func_95(*iParam0))
				{
					func_33(uParam4);
					if (!IS_ENTITY_AT_COORD(*iParam0, vParam5, iParam10, iParam10, 2f, 0, 1, 2))
					{
						func_78(uParam3, *iParam0, 1);
					}
					*iParam2 = 0;
				}
				break;
				...
				if (func_7(iVar0))
				{
					...
					if (iVar1 == joaat("trash"))
					{
						...
						*uParam0 = iVar0;
						...
						if (!IS_ENTITY_A_MISSION_ENTITY(*uParam0))
						{
							SET_ENTITY_AS_MISSION_ENTITY(*uParam0, 1, 1);
						}
					}
					else if (iVar1 == joaat("towtruck"))
					{
						uVar2 = GET_ENTITY_ATTACHED_TO_TOW_TRUCK(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0));
						if (func_6(uVar2))
						{
							iVar0 = GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(uVar2);
...
void func_93(var uParam0)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		...
		if (iVar0 != *uParam0)
		{
			if (func_7(iVar0))
			{
				if (GET_ENTITY_MODEL(iVar0) == func_94(func_68()))
				{
					func_92(uParam0);
					*uParam0 = iVar0;
					func_88(*uParam0, 1);
...
int func_95(int iParam0)
{
	...
	if ((func_370(PLAYER_PED_ID()) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0)) && func_7(iParam0))
	{
...
void func_97()
{
	...
	switch (iLocal_81)
	{
				...
				if (PREPARE_MUSIC_EVENT("FHPRA_VAN"))
				{
					if (GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) == 0)
					{
						if (iLocal_82 == 1 || iLocal_82 == 2)
						{
							...
							func_63(&uLocal_356, vLocal_364, 1);
						}
					}
					iLocal_664 = 0;
					iLocal_81 = 1;
		...
		case 1:
			...
			if (func_100(Local_456, vLocal_364, &uLocal_356, iLocal_91, iLocal_82, &iLocal_355, &iLocal_385, 0, 0, 1086324736))
			{
				_0x293220DA1B46CEBC(5f, 6f, 4);
				iLocal_81 = 2;
			}
...
int func_100(int iParam0, vector3 vParam1, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, int iParam11)
{
	if ((iParam6 == 1 || iParam6 == 2) || iParam6 == 3)
	{
		if (iParam5 == 0)
		{
			...
			if (!bParam10)
			{
				if (func_7(iParam0))
				{
					if (IS_ENTITY_AT_COORD(iParam0, vParam1, iParam11, iParam11, 2f, 1, 1, 0))
					{
						return 1;
					}
				}
			}
			else if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vParam1, iParam11, iParam11, 2f, 1, 1, 2))
			{
				return 1;
			}
			if (func_65(func_59(func_68()), 0, 0))
	...
	while (iVar0 < 3)
	{
		...
		if (!IS_PED_INJURED(iVar1))
		{
			switch (iLocal_87[iVar0])
			{
					...
					if (!func_114(iVar1))
					{
						if (func_113(iVar1, 0))
						{
							if (func_112(iVar0, iVar1) || func_110(iVar0, iVar1))
							{
								if (func_109(iVar1, 0))
								{
									SET_ENTITY_AS_MISSION_ENTITY(iVar1, 1, 1);
									SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iVar1, 1);
				...
				case 1:
					if (func_108(iVar0, iVar1) && DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, 1))
					{
						iLocal_87[iVar0] = 0;
						func_107(iVar1);
					}
				...
				case 2:
					if (func_106(iVar0, iVar1) && DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, 1))
					{
						iLocal_87[iVar0] = 0;
						func_107(iVar1);
					}
...
int func_106(int iParam0, int iParam1)
{
	...
	{
		case 0:
			TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, GET_VEHICLE_PED_IS_IN(iParam1, 0), vLocal_364, 4, 20f, 786469, 3.5f, 5f, 1);
			iLocal_83[iParam0] = 3;
			break;
		
		case 3:
			if (!func_110(iParam0, iParam1) || func_62(PLAYER_PED_ID(), vLocal_364, 2f))
			{
				iLocal_83[iParam0] = 4;
			}
			break;
...
int func_108(int iParam0, int iParam1)
{
	...
	{
		case 0:
			if (!IS_POSITION_OCCUPIED(Local_300[iLocal_665 /*4*/], 1.5f, 0, 0, 1, 0, 0, iParam1, 0))
			{
				...
				TASK_FOLLOW_NAV_MESH_TO_COORD(iParam1, Local_300[iLocal_665 /*4*/], fVar0, 20000, 0.25f, 0, Local_300[iLocal_665 /*4*/].f_3);
				iLocal_83[iParam0] = 1;
			}
			break;
...
int func_110(int iParam0, int iParam1)
{
	if (!func_111())
	{
		if ((DOES_ENTITY_EXIST(Local_456) && IS_VEHICLE_DRIVEABLE(Local_456, 0)) && !IS_ENTITY_AT_COORD(Local_456, vLocal_364, 2f, 2f, 2f, 0, 1, 0))
		{
			if ((!IS_PED_INJURED(PLAYER_PED_ID()) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_456, 0)) && GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) == 0)
			{
				if (IS_PED_IN_VEHICLE(iParam1, Local_456, 0) && GET_PED_IN_VEHICLE_SEAT(Local_456, -1, 0) == iParam1)
				{
					iLocal_87[iParam0] = 2;
					return 1;
				}
...
int func_112(int iParam0, int iParam1)
{
	if (!func_111())
	{
		if (IS_ENTITY_IN_ANGLED_AREA(iParam1, 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.63f, 0, 1, 0) && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.38f, 0, 1, 0))
		{
			iLocal_665 = 0;
			iLocal_87[iParam0] = 1;
			return 1;
		}
		else if (IS_ENTITY_IN_ANGLED_AREA(iParam1, 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.63f, 0, 1, 0) && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.38f, 0, 1, 0))
		{
			iLocal_665 = 1;
			iLocal_87[iParam0] = 1;
			return 1;
...
void func_117()
{
	...
	if (!bLocal_28)
	{
		...
		{
			_SWITCH_CRIME_TYPE(PLAYER_ID(), 38);
			_SWITCH_CRIME_TYPE(PLAYER_ID(), 30);
			bLocal_374 = false;
		}
		if (iLocal_80 == 2)
		{
			if (!iLocal_386)
			{
				if (!func_62(PLAYER_PED_ID(), Local_456.f_1, 180f))
				{
					iVar0 = 0;
					while (iVar0 <= 2)
					{
...
void func_118()
{
	...
	{
		if (DOES_ENTITY_EXIST(Local_389[iVar0 /*22*/]) && !IS_PED_INJURED(Local_389[iVar0 /*22*/]))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_389[iVar0 /*22*/], PLAYER_PED_ID(), 1))
			{
				CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_389[iVar0 /*22*/]);
				if (((IS_PED_CURRENT_WEAPON_SILENCED(PLAYER_PED_ID()) || IS_PED_BEING_STEALTH_KILLED(Local_389[iVar0 /*22*/])) || WAS_PED_KILLED_BY_STEALTH(Local_389[iVar0 /*22*/])) || WAS_PED_KILLED_BY_TAKEDOWN(Local_389[iVar0 /*22*/]))
				{
					if (!bLocal_374)
					{
						_SWITCH_CRIME_TYPE(PLAYER_ID(), 41);
						_SWITCH_CRIME_TYPE(PLAYER_ID(), 33);
...
void func_119(int iParam0)
{
	...
	switch (Local_389[iParam0 /*22*/].f_20)
	{
		case 1:
			...
			{
				if (GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > GET_RANDOM_INT_IN_RANGE(1000, 1500)
				{
					if (!func_77(Local_389[iParam0 /*22*/], -875674219))
					{
						_0xF1C03A5352243A30(Local_389[iParam0 /*22*/]);
						TASK_TURN_PED_TO_FACE_ENTITY(Local_389[iParam0 /*22*/], PLAYER_PED_ID(), 0);
					}
					Local_389[iParam0 /*22*/].f_14 = GET_GAME_TIMER();
				}
			}
			else
			{
		...
		case 2:
			if (GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > GET_RANDOM_INT_IN_RANGE(5000, 6000)
			{
				if (IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 2))
				{
					func_126(iParam0);
					func_124();
					return;
		...
		case 3:
			if (GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				if (IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 8))
				{
					Local_389[iParam0 /*22*/].f_17 = 1;
				}
				else
		...
		case 4:
			if (GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				if (IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 8))
				{
					...
					else if (IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 9) && !bLocal_372)
					{
						func_126(iParam0);
						func_124();
						return;
		...
		case 6:
			...
			if ((GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > iVar0)
			{
				if (!IS_PED_BEING_STUNNED(Local_389[iParam0 /*22*/], 0) && !IS_PED_IN_WRITHE(Local_389[iParam0 /*22*/]))
				{
					Local_389[iParam0 /*22*/].f_14 = GET_GAME_TIMER();
					func_126(iParam0);
				}
		...
		case 5:
			if (GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > GET_RANDOM_INT_IN_RANGE(1000, 3000)
			{
				func_124();
				return;
			}
		...
		case 7:
			if ((GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > 350)
			{
				if (!bLocal_374 && func_123(iParam0, 15))
				{
					func_72();
					func_133(iParam0);
					_0xC594B315EDF2D4AF(Local_389[iParam0 /*22*/]);
					return;
				}
				else
				{
					if (iLocal_660 != -1)
					{
						if ((GET_GAME_TIMER() - iLocal_660) > 12000)
						{
							func_122(-1);
						}
						...
						else if (GET_ENTITY_PLAYER_IS_FREE_AIMING_AT(PLAYER_ID(), &uVar1))
						{
							if (IS_ENTITY_A_PED(uVar1))
							{
								iVar2 = GET_PED_INDEX_FROM_ENTITY_INDEX(uVar1);
					...
					if ((func_77(Local_389[iParam0 /*22*/], -2128726980) || func_77(Local_389[iParam0 /*22*/], -982327190)) && GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) < 2)
					{
						if (!func_77(Local_389[iParam0 /*22*/], 1392476864))
						{
							TASK_ARREST_PED(Local_389[iParam0 /*22*/], PLAYER_PED_ID());
						}
					}
				}
			}
			if (!iLocal_658)
			{
				if (IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 1) && IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 14))
				{
					if (iParam0 == 0)
					{
						sVar3 = "PRA_COPSHT1";
...
void func_122(int iParam0)
{
	...
	{
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_389[0 /*22*/], 0);
	}
	if (func_370(Local_389[1 /*22*/]))
	{
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_389[1 /*22*/], 0);
	}
	if (func_370(Local_389[2 /*22*/]))
	{
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_389[2 /*22*/], 0);
	}
	if (iParam0 != -1)
	{
		SET_PLAYER_WANTED_LEVEL(PLAYER_ID(), iParam0, 0);
		SET_PLAYER_WANTED_LEVEL_NOW(PLAYER_ID(), 0);
	}
}
...
int func_123(int iParam0, int iParam1)
{
	...
	while (iVar0 <= 14)
	{
		if (iVar0 != iParam1)
		{
			if (IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, iVar0))
			{
				return 0;
			}
		}
...
void func_124()
{
	...
	while (iVar0 <= 2)
	{
		...
		{
			func_189(&(Local_389[iVar0 /*22*/].f_6));
			Local_389[iVar0 /*22*/].f_14 = GET_GAME_TIMER();
...
void func_126(int iParam0)
{
	if (Local_389[iParam0 /*22*/].f_20 != 7)
	{
		if (func_370(Local_389[iParam0 /*22*/]))
		{
			if (func_77(Local_389[iParam0 /*22*/], 242628503) || IS_PED_RUNNING_MOBILE_PHONE_TASK(Local_389[iParam0 /*22*/]))
			{
			...
			SET_PED_AS_COP(Local_389[iParam0 /*22*/], 1);
			TASK_ARREST_PED(Local_389[iParam0 /*22*/], PLAYER_PED_ID());
			GIVE_WEAPON_TO_PED(Local_389[iParam0 /*22*/], joaat("weapon_pistol"), -1, 0, 1);
			CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_389[iParam0 /*22*/]);
			_0xBC9490CA15AEA8FB(PLAYER_ID());
			func_127(iParam0);
...
void func_127(int iParam0)
{
	...
	if ((iLocal_80 != 2 && !iLocal_659) && !IS_ENTITY_DEAD(Local_389[iParam0 /*22*/], 0))
	{
		if (func_132(iParam0) && func_130(Local_389[iParam0 /*22*/], 30f))
		{
			...
			if (IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 3))
			{
				iLocal_659 = 1;
			}
			else if (!func_123(iParam0, 15) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, 1, 0))
			{
				func_128();
				iLocal_656 = 0;
				if (iParam0 == 2)
				...
				{
					_PLAY_AMBIENT_SPEECH_WITH_VOICE(Local_389[iParam0 /*22*/], "ARREST_PLAYER", sVar0, "SPEECH_PARAMS_FORCE", 0);
				}
				iLocal_659 = 1;
			}
		}
...
int func_130(int iParam0, float fParam1)
{
	...
	if (func_370(PLAYER_PED_ID()) && func_370(iParam0))
	{
		if (func_131(PLAYER_PED_ID(), iParam0, 0) <= fParam1)
		{
			return 1;
		}
	}
...
float func_131(var uParam0, int iParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_133(int iParam0)
{
	...
	{
		CLEAR_PED_TASKS(Local_389[iParam0 /*22*/]);
		SET_PED_RELATIONSHIP_GROUP_HASH(Local_389[iParam0 /*22*/], uLocal_481);
		if (iParam0 == 2)
		{
			OPEN_SEQUENCE_TASK(&uVar0);
			if (!func_62(Local_389[iParam0 /*22*/], Local_389[iParam0 /*22*/].f_1, 3f))
			{
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_389[iParam0 /*22*/].f_1, 1f, 120000, 0.25f, 0, Local_389[iParam0 /*22*/].f_4);
			}
			else
			{
				TASK_ACHIEVE_HEADING(0, Local_389[iParam0 /*22*/].f_4, 0);
			}
			if (iLocal_648[2] && IS_STRING_NULL_OR_EMPTY("sResumeRoot"))
			{
			...
			TASK_PERFORM_SEQUENCE(Local_389[iParam0 /*22*/], uVar0);
		...
		func_134();
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_389[iParam0 /*22*/], 0);
...
void func_134()
{
	if (func_12(&uLocal_92, GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)))
	{
		if (!func_102())
		{
...
void func_145(int iParam0)
{
	switch (Local_389[iParam0 /*22*/].f_21)
	{
		case 0:
			if (func_102())
			{
				if (IS_PED_BEING_STEALTH_KILLED(Local_389[iParam0 /*22*/]))
				{
					func_128();
				}
			}
			...
			{
				if (iLocal_648[2] && !IS_PED_IN_CURRENT_CONVERSATION(Local_389[iParam0 /*22*/]))
				{
					CLEAR_PED_TASKS(Local_389[iParam0 /*22*/]);
					TASK_START_SCENARIO_IN_PLACE(Local_389[iParam0 /*22*/], "WORLD_HUMAN_STAND_MOBILE", 0, 1);
				}
			}
			break;
...
void func_146(int iParam0)
{
	...
	if (!func_167(iParam0))
	{
		if (func_148(Local_389[iParam0 /*22*/], 1, 50f, 140f, 0, 1, 1, 1) || IS_EXPLOSION_IN_SPHERE(-1, GET_ENTITY_COORDS(Local_389[iParam0 /*22*/], 1), 100f))
		{
			if ((!IS_PED_BEING_STEALTH_KILLED(Local_389[iParam0 /*22*/]) && !WAS_PED_KILLED_BY_STEALTH(Local_389[iParam0 /*22*/])) && !WAS_PED_KILLED_BY_TAKEDOWN(Local_389[iParam0 /*22*/]))
			{
				func_124();
			}
			else if (!bLocal_374)
			{
				_SWITCH_CRIME_TYPE(PLAYER_ID(), 41);
				_SWITCH_CRIME_TYPE(PLAYER_ID(), 33);
				_SWITCH_CRIME_TYPE(PLAYER_ID(), 12);
				SET_PLAYER_WANTED_LEVEL(PLAYER_ID(), 0, 0);
				SET_PLAYER_WANTED_LEVEL_NOW(PLAYER_ID(), 0);
			}
		}
	}
	else if (func_147(Local_389[iParam0 /*22*/], PLAYER_PED_ID(), 5f, 1))
	{
		if (!bLocal_374)
		{
			_SWITCH_CRIME_TYPE(PLAYER_ID(), 41);
	...
	if (func_6(PLAYER_PED_ID()) && func_6(iParam0))
	{
		...
		if (!IS_PED_ARMED(PLAYER_PED_ID(), 6))
		{
			if (IS_PED_IN_MELEE_COMBAT(PLAYER_PED_ID()))
			{
				...
				{
					return func_161(PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_149(int iParam0, float fParam1)
{
	...
	if (func_6(PLAYER_PED_ID()) && func_6(iParam0))
	{
		if (func_160(iParam0) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), iParam0))
		{
			if (IS_PED_ARMED(PLAYER_PED_ID(), 6))
			{
				fVar0 = 40f;
...
{
	return func_151(iParam0, PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
...
bool func_151(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_152(&(Local_38[iVar4 /*4*/]), vVar1, iParam1, &(Local_38[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (GET_GAME_TIMER() - Local_38[iVar4 /*4*/].f_3) < iParam4);
}

int func_152(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_153(iParam4, iParam7) };
...
int func_155(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_157(GET_ENTITY_COORDS(iParam1, 1) - GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		vVar3 = { func_157(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_156(vVar3, vVar0);
...
int func_164(var uParam0, float fParam1)
{
	...
	{
		if (func_165(uParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_165(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_157(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_157(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_156(vVar3, vVar0);
...
{
	if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_389[iParam0 /*22*/], 0f, -2f, 0f), 2f, 3f, 2f, 0, 1, 0) && !IS_PED_ARMED(PLAYER_PED_ID(), 6))
	{
		return 1;
	}
	return 0;
...
void func_168(int iParam0)
{
	...
	{
		if (((!bLocal_372 && !IS_PED_BEING_STEALTH_KILLED(Local_389[iParam0 /*22*/])) && !WAS_PED_KILLED_BY_STEALTH(Local_389[iParam0 /*22*/])) && !WAS_PED_KILLED_BY_TAKEDOWN(Local_389[iParam0 /*22*/]))
		{
			func_169(iParam0);
		}
	}
...
void func_171(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_143(iParam0) || iParam2)
	{
		...
		{
			if (Local_389[func_144(iParam0) /*22*/].f_20 != 3 || (GET_GAME_TIMER() - iLocal_376) > 7500)
			{
				if (!IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 9))
				{
					if (iParam0 == 0)
					{
						sVar0 = "PRA_CWCAR1";
		...
		{
			if (Local_389[func_144(iParam0) /*22*/].f_20 != 4 || (GET_GAME_TIMER() - iLocal_376) > 7500)
			{
				if (!bLocal_373)
				{
					if (iParam0 == 0)
		...
		else if (iParam1 == 5)
		{
			if (Local_389[func_144(iParam0) /*22*/].f_20 != 5)
			{
				if (iParam0 == 0)
				{
					...
					_PLAY_AMBIENT_SPEECH_WITH_VOICE(Local_389[iParam0 /*22*/], "CHALLENGE_THREATEN", sVar1, "SPEECH_PARAMS_FORCE", 0);
				}
				else if (iParam0 == 1)
				{
		...
		Local_389[iParam0 /*22*/].f_14 = GET_GAME_TIMER();
		Local_389[func_144(iParam0) /*22*/].f_14 = GET_GAME_TIMER();
...
void func_172(int iParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		if (IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 12))
		{
			return;
		}
	}
...
void func_176(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_143(iParam0) || iParam2)
	{
		if (iParam1 == 1)
		{
			if (Local_389[iParam0 /*22*/].f_19 != 1 || (GET_GAME_TIMER() - iLocal_376) > 7500)
			{
				if (!bLocal_372)
				{
					if (iParam0 == 0)
		...
		{
			if (Local_389[iParam0 /*22*/].f_19 != 2 || (GET_GAME_TIMER() - iLocal_376) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPPLY1";
		...
		{
			if (Local_389[iParam0 /*22*/].f_19 != 4 || (GET_GAME_TIMER() - iLocal_376) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPST1";
		...
		else if (iParam1 == 5)
		{
			if (Local_389[iParam0 /*22*/].f_19 != 5)
			{
				...
				_PLAY_AMBIENT_SPEECH_WITH_VOICE(Local_389[iParam0 /*22*/], "BUMP", sVar1, "SPEECH_PARAMS_FORCE", 0);
				func_177(iParam0, iParam1, 0);
			}
		}
		else if (iParam1 == 7)
		...
		if (bLocal_372)
		{
			if (!IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 12))
			{
				SET_BIT(&(Local_389[iParam0 /*22*/].f_15), 12);
			}
		}
	}
}
...
void func_178(int iParam0)
{
	...
	if ((!func_143(iParam0) && Local_389[iParam0 /*22*/].f_20 != 6) && Local_389[iParam0 /*22*/].f_20 != 7)
	{
		...
		if (iParam0 == 0 || iParam0 == 1)
		{
			if (!iLocal_382)
			{
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 340.0758f, -1598.255f, 28.29322f, 346.4939f, -1603.684f, 38.29278f, 6.22f, 0, 1, 0))
				{
					...
					else if (!IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 11))
					{
						if ((((fVar0 > 16f && !Local_389[iParam0 /*22*/].f_16) && !IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 10)) && !IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0)) && IS_ENTITY_IN_ANGLED_AREA(Local_389[iParam0 /*22*/], Local_309[1 /*7*/], Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0))
						{
							func_180(iParam0, 11);
							return;
						}
				...
				if (((IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), Local_309[1 /*7*/], Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0) && IS_ENTITY_IN_ANGLED_AREA(Local_389[iParam0 /*22*/], Local_309[1 /*7*/], Local_309[1 /*7*/].f_3, Local_309[1 /*7*/].f_6, 0, 1, 0)) && !IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 10)) && !IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 11))
				{
					if ((fVar0 > 12f && !Local_389[iParam0 /*22*/].f_16) && !IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0))
					{
						func_180(iParam0, 11);
					}
				}
			}
			else if ((GET_GAME_TIMER() - iLocal_381) > 4000)
			{
				iLocal_382 = 0;
			}
		}
		else if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), Local_309[5 /*7*/], Local_309[5 /*7*/].f_3, Local_309[5 /*7*/].f_6, 0, 1, 0) && IS_ENTITY_IN_ANGLED_AREA(Local_389[iParam0 /*22*/], Local_309[5 /*7*/], Local_309[5 /*7*/].f_3, Local_309[5 /*7*/].f_6, 0, 1, 0))
		{
...
{
	if (IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, iParam1))
	{
		CLEAR_BIT(&(Local_389[iParam0 /*22*/].f_15), iParam1);
		Local_389[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_180(int iParam0, int iParam1)
{
	if (!IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, iParam1))
	{
		SET_BIT(&(Local_389[iParam0 /*22*/].f_15), iParam1);
		Local_389[iParam0 /*22*/].f_17 = 1;
	}
}
...
void func_181(int iParam0)
{
	...
	{
		bVar0 = false;
		if (((func_147(Local_389[iParam0 /*22*/], PLAYER_PED_ID(), 5f, 1) && !IS_PED_BEING_STEALTH_KILLED(Local_389[iParam0 /*22*/])) && !WAS_PED_KILLED_BY_STEALTH(Local_389[iParam0 /*22*/])) && !WAS_PED_KILLED_BY_TAKEDOWN(Local_389[iParam0 /*22*/]))
		{
	...
	else if (!func_147(Local_389[iParam0 /*22*/], PLAYER_PED_ID(), 5.5f, 1))
	{
		func_179(iParam0, 5);
		func_179(iParam0, 3);
	}
...
int func_182(int iParam0)
{
	...
	if (Local_389[iParam0 /*22*/].f_20 != 7)
	{
		if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_389[iParam0 /*22*/], 1f, -1f, 0f), 1f, 1f, 2f, 0, 1, 0))
		{
			return 1;
		}
	}
...
{
	if (IS_ENTITY_TOUCHING_ENTITY(Local_389[iParam0 /*22*/], PLAYER_PED_ID()))
	{
		if (IS_PED_RAGDOLL(Local_389[iParam0 /*22*/]))
		{
			*iParam1 = 1;
		}
		else
...
void func_184(int iParam0)
{
	...
	if (Local_389[iParam0 /*22*/].f_20 != 6 && Local_389[iParam0 /*22*/].f_20 != 7)
	{
		...
		while (iVar0 <= 5)
		{
			if (Local_389[iParam0 /*22*/].f_16)
			{
				if (!IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 12))
				{
					if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), Local_309[iVar0 /*7*/], Local_309[iVar0 /*7*/].f_3, Local_309[iVar0 /*7*/].f_6, 0, 1, 0))
					{
						iLocal_382 = 1;
						iLocal_381 = GET_GAME_TIMER();
						if (iVar0 == 4)
			...
			else if (!IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), Local_309[iVar0 /*7*/], Local_309[iVar0 /*7*/].f_3, Local_309[iVar0 /*7*/].f_6, 0, 1, 0) || IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 12))
			{
				func_185(iParam0, iVar0);
			}
			iVar0++;
	...
	else if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), Local_309[3 /*7*/], Local_309[3 /*7*/].f_3, Local_309[3 /*7*/].f_6, 0, 1, 0))
	{
		func_187(iParam0, 3);
	}
	else
	...
	switch (iParam1)
	{
		...
		case 4:
			if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
				...
				if (func_7(iVar0))
				{
					if (func_186(GET_ENTITY_MODEL(iVar0)))
					{
						bLocal_373 = true;
					}
					else
					...
					if (!IS_ENTITY_IN_ANGLED_AREA(iVar0, Local_309[4 /*7*/], Local_309[4 /*7*/].f_3, Local_309[4 /*7*/].f_6, 0, 1, 0))
					{
						func_179(iParam0, 8);
						func_179(iParam0, 7);
					}
					else if (!IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 7))
					{
						func_180(iParam0, 7);
					}
				}
...
void func_187(int iParam0, int iParam1)
{
	...
	{
		case 1:
			if ((!IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 6) && !IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 1)) && !IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 9))
			{
				if (!IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 10))
				{
					func_180(iParam0, 10);
				}
			}
		...
		case 2:
			if (!IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 1))
			{
				if (!IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 6))
				{
					func_180(iParam0, 6);
				}
			}
		...
		case 3:
			if (!IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 14))
			{
				func_180(iParam0, 14);
			}
			break;
		...
		case 4:
			if (!IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 8))
			{
				...
				{
					SET_BIT(&(Local_389[iParam0 /*22*/].f_15), 9);
					func_180(iParam0, 8);
				}
				else
				{
					CLEAR_BIT(&(Local_389[iParam0 /*22*/].f_15), 9);
					func_180(iParam0, 8);
				}
			}
			break;
		...
		case 5:
			if (!IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 4))
			{
				if ((!IS_PED_BEING_STEALTH_KILLED(Local_389[iParam0 /*22*/]) && !WAS_PED_KILLED_BY_STEALTH(Local_389[iParam0 /*22*/])) && !WAS_PED_KILLED_BY_TAKEDOWN(Local_389[iParam0 /*22*/]))
				{
					func_180(iParam0, 4);
...
{
	if (func_147(PLAYER_PED_ID(), Local_389[iParam0 /*22*/], 30f, 1))
	{
		if (func_151(Local_389[iParam0 /*22*/], PLAYER_PED_ID(), 140f, 1, 250, 7))
		{
...
int func_190(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
void func_191()
{
	...
	while (iVar0 <= 1)
	{
		...
		{
			if (DOES_ENTITY_EXIST(Local_389[iVar0 /*22*/]))
			{
				if (func_7(GET_PLAYERS_LAST_VEHICLE()))
				{
					if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_389[iVar0 /*22*/], GET_PLAYERS_LAST_VEHICLE(), 1))
					{
						CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_389[iVar0 /*22*/]);
						func_124();
					}
...
void func_192(int iParam0)
{
	...
	switch (Local_389[iParam0 /*22*/].f_19)
	{
		case 1:
			if (GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, 1, 0))
				{
					func_126(iParam0);
					func_124();
					return;
				...
				{
					if ((IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 13) && (GET_GAME_TIMER() - iLocal_376) > 2500) && !iLocal_661)
					{
						if (iParam0 == 0)
						{
							sVar0 = "PRA_COPST1";
						...
						func_120(&uLocal_483, cLocal_482, sVar0, 7, 0, 0);
						CLEAR_BIT(&(Local_389[iParam0 /*22*/].f_15), 13);
						CLEAR_BIT(&(Local_389[func_144(iParam0) /*22*/].f_15), 13);
						iLocal_661 = 1;
					}
					Local_389[iParam0 /*22*/].f_17 = 1;
				}
		...
		case 2:
			if (GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > GET_RANDOM_INT_IN_RANGE(1500, 2000)
			{
				if (func_123(iParam0, 12))
				{
					func_133(iParam0);
		...
		case 5:
			if (GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				if (!func_147(Local_389[iParam0 /*22*/], PLAYER_PED_ID(), 1.5f, 1))
				{
					CLEAR_BIT(&(Local_389[iParam0 /*22*/].f_15), 5);
				}
				if (func_123(iParam0, 12))
				{
					func_133(iParam0);
		...
		case 7:
			if (GET_GAME_TIMER() - Local_389[iParam0 /*22*/].f_14) > GET_RANDOM_INT_IN_RANGE(2500, 3000)
			{
				...
				if (((fVar1 < 12f && !Local_389[iParam0 /*22*/].f_16) && !IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 10)) && !func_77(Local_389[iParam0 /*22*/], -875674219))
				{
					CLEAR_BIT(&(Local_389[iParam0 /*22*/].f_15), 11);
				}
				if (func_123(iParam0, 12))
				{
					func_133(iParam0);
...
void func_195(int iParam0)
{
	...
	if (!iLocal_661)
	{
		...
		if (!IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 13))
		{
			if (IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 10))
			{
				if (Local_389[iParam0 /*22*/].f_16)
		...
		else if (func_132(iParam0))
		{
			if (bVar0)
			{
				if (!func_147(PLAYER_PED_ID(), Local_389[iParam0 /*22*/], 10f, 1))
				{
					if (!IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 10) && !IS_BIT_SET(Local_389[iParam0 /*22*/].f_15, 6))
					{
						CLEAR_BIT(&(Local_389[iParam0 /*22*/].f_15), 13);
					}
				}
...
void func_196(int iParam0)
{
	...
	if (Local_389[iParam0 /*22*/].f_20 != 6 && Local_389[iParam0 /*22*/].f_20 != 7)
	{
		if (func_147(PLAYER_PED_ID(), Local_389[iParam0 /*22*/], 12f, 1))
		{
			if (bVar0)
			{
				if (Local_389[iParam0 /*22*/].f_16)
...
void func_197(int iParam0)
{
	if (!func_167(iParam0))
	{
		...
		else if (func_148(Local_389[iParam0 /*22*/], 1, 70f, 150f, 0, 1, 0, 1) || IS_EXPLOSION_IN_SPHERE(-1, GET_ENTITY_COORDS(Local_389[iParam0 /*22*/], 1), 100f))
		{
			func_124();
		}
...
int func_198(int iParam0)
{
	...
	if (func_370(Local_389[iParam0 /*22*/]))
	{
		...
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), Local_389[iParam0 /*22*/], fVar0, fVar0, fVar0, 0, 1, 0))
		{
			if (IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), Local_389[iParam0 /*22*/]) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), Local_389[iParam0 /*22*/]))
			{
				if (Local_389[iParam0 /*22*/].f_16)
				{
					return 1;
...
void func_199()
{
	...
	{
		if ((((func_370(Local_389[0 /*22*/]) && func_370(Local_389[1 /*22*/])) && func_12(&uLocal_92, GET_ENTITY_COORDS(PLAYER_PED_ID(), 1))) && func_62(Local_389[0 /*22*/], Local_389[0 /*22*/].f_1, 3f)) && func_62(Local_389[1 /*22*/], Local_389[1 /*22*/].f_1, 3f))
		{
		...
		else if ((func_370(Local_389[2 /*22*/]) && func_12(&uLocal_144, GET_ENTITY_COORDS(PLAYER_PED_ID(), 1))) && func_62(Local_389[2 /*22*/], Local_389[2 /*22*/].f_1, 3f))
		{
			if (!IS_BIT_SET(Local_389[2 /*22*/].f_15, 2) && !IS_BIT_SET(Local_389[2 /*22*/].f_15, 4))
			{
...
bool func_200(int iParam0, var uParam1, char* sParam2, float fParam3, int iParam4)
{
	if (!*uParam1)
	{
		if (!func_102() && IS_SCREEN_FADED_IN())
		{
	...
	switch (iLocal_81)
	{
		case 0:
			if (func_70(iLocal_80, bLocal_28))
			{
				...
				if (_DOES_DOOR_EXIST(Global_35548[13 /*31*/]))
				{
					_0x06C0023BED16DD6B(Global_35548[13 /*31*/], 1);
				}
				iLocal_678 = 0;
		...
		case 1:
			if (GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) < 3)
			{
				if (func_370(Local_389[2 /*22*/]))
				{
					...
					{
						if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 371.9393f, -1604.252f, 45.603f, 399.8371f, -1627.065f, 31.75287f, 32.73f, 0, 1, 2) || IS_PED_SHOOTING(PLAYER_PED_ID()))
						{
			...
			if ((IS_PED_CLIMBING(PLAYER_PED_ID()) && iLocal_678 == 0) && func_131(Local_456, PLAYER_PED_ID(), 1) < 100f)
			{
	...
	switch (iLocal_81)
	{
		case 0:
			if (func_70(iLocal_80, 0))
			{
				...
				CLEAR_AREA_OF_PEDS(369.0115f, -1609.116f, 28.2928f, 5f, 0);
				CLEAR_AREA_OF_PEDS(Local_389[0 /*22*/].f_1, 5f, 0);
				if (func_266(PLAYER_PED_ID(), 12, 4) || func_266(PLAYER_PED_ID(), 12, 3))
				{
					bLocal_372 = true;
				}
				func_217();
...
void func_205(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	var uVar0;
	int iVar1;
...
void func_217()
{
	...
	if (DOES_ENTITY_EXIST(iVar0))
	{
		...
		{
			func_218(iVar0, GET_ENTITY_COORDS(iVar0, 1), GET_ENTITY_HEADING(iVar0), 24, 0);
		}
	}
}

void func_218(int iParam0, vector3 vParam1, var uParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (DOES_ENTITY_EXIST(iParam0) && IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_253(iParam5, &Var0, vParam1, uParam4, func_259(iParam0));
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_236(iParam0, 0, 0)) || func_236(iParam0, 1, 0)) || func_236(iParam0, 2, 0)) || func_259(iParam0) != 145) || func_235(iParam0)) || func_234(iParam0)) || func_233(iParam0)) || func_232(iParam0)) || !func_222(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_234(iParam0))
		{
		}
...
var func_239()
{
	...
	func_242(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_241(&uVar0, GET_CLOCK_MONTH());
	func_240(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SHIFT_RIGHT(uParam0, 26) & 31 * func_245(IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_253(int iParam0, var uParam1, vector3 vParam2, var uParam5, int iParam6)
{
	if (func_250(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
...
int func_266(var uParam0, int iParam1, int iParam2)
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar2 <= 14)
		{
			...
			{
				if (!func_266(uParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_266(uParam0, 14, uVar22[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar32 <= 8)
		{
			if (!func_266(uParam0, 14, uVar33[iVar32]))
			{
				return 0;
			}
			iVar32++;
	...
	else if (Global_71402[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(uParam0, func_267(iParam1)) && Global_71402[1 /*14*/].f_4 == GET_PED_TEXTURE_VARIATION(uParam0, func_267(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_268(var uParam0, int iParam1)
{
	...
	return func_269(uParam0, iVar1, iVar2, iParam1);
}
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || _0x341DE7ED1D2A1BFD(func_272(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || _0x341DE7ED1D2A1BFD(func_272(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || _0x341DE7ED1D2A1BFD(func_272(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || _0x341DE7ED1D2A1BFD(func_272(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_272(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_267(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
		...
		if (!_IS_DLC_DATA_EMPTY(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &vVar16) && vVar16.z != -1)
				{
					...
					{
						(*iParam0)[vVar16.z] = func_280(iParam1, vVar16.x, 14, iVar0);
					}
					else if (vVar16.y != -1)
					{
...
int func_280(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_267(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		while (iVar36 < Var1.f_4)
		{
			if (_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar36, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_284(vVar16.z)] = vVar16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_284(vVar16.z)] = func_280(iParam1, vVar16.x, func_284(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					(*uParam0)[func_284(vVar16.z)] = vVar16.y;
				}
			}
			iVar36++;
		}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_292(func_291(iParam1, uParam0->f_2), Global_71399, 0);
			if (IS_BIT_SET(uVar0, uParam0->f_1))
			{
				SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_292(iVar1, Global_71399, 0);
				if (!IS_BIT_SET(uVar0, uParam0->f_1))
				{
					SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_295(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_299(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_289(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_289(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = _GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_267(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_356()
{
	...
	{
		_SET_DOOR_ACCELERATION_LIMIT(iLocal_369, 0, 1, 1);
	}
	else
	{
		_SET_DOOR_ACCELERATION_LIMIT(iLocal_369, 1, 1, 1);
	}
}
...
void func_357()
{
	if (bLocal_374)
	{
		if (IS_COP_PED_IN_AREA_3D(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, 1, 0))
		{
			if (func_12(&uLocal_196, GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)))
			{
	...
	else if (IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER_PED_ID()) || iLocal_82 == 1)
	{
		if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, 1, 0) || IS_COP_PED_IN_AREA_3D(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f))
		{
			func_359(Global_35548[13 /*31*/], &fLocal_370);
		}
		else
...
{
	if (_DOES_DOOR_EXIST(uParam0))
	{
		if (*fParam1 != 0f)
		{
			if (!DOES_NAVMESH_BLOCKING_OBJECT_EXIST(uLocal_371))
			{
				uLocal_371 = ADD_NAVMESH_BLOCKING_OBJECT(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_80(229.3746f), 0, 7);
			}
			_SET_DOOR_AJAR_ANGLE(uParam0, *fParam1, 1, 1);
			*fParam1 = (*fParam1 - (0.2f * TIMESTEP()));
			if (*fParam1 <= 0f)
			{
				_SET_DOOR_ACCELERATION_LIMIT(uParam0, 1, 1, 0);
				REMOVE_NAVMESH_BLOCKING_OBJECT(uLocal_371);
				*fParam1 = 0f;
			}
		}
	}
...
void func_364()
{
	...
	{
		if (!func_62(PLAYER_PED_ID(), 372.0053f, -1604.076f, 36.7536f, 100f) && !bLocal_387)
		{
			func_366("PR_AREAWARN", &bLocal_387);
		}
		else if (!func_62(PLAYER_PED_ID(), 372.0053f, -1604.076f, 36.7536f, 170f) && bLocal_387)
		{
			func_365(3);
		}
	}
...
void func_367()
{
	...
	else
	{
		...
		if (iLocal_80 == 2 || iLocal_80 == 3)
		{
			if (!func_147(PLAYER_PED_ID(), Local_456, 50f, 1) && !bLocal_388)
			{
				func_366("PR_VANWARN", &bLocal_388);
			}
			else if (!func_147(PLAYER_PED_ID(), Local_456, 100f, 1) && bLocal_388)
			{
				func_365(4);
			}
		}
...
void func_368()
{
	if (IS_VEHICLE_STUCK_ON_ROOF(Local_456))
	{
		if (iLocal_368)
		{
...
struct<7> func_376(vector3 vParam0, vector3 vParam3, float fParam6)
{
	struct<7> Var0;
...
void func_378()
{
	...
	if (!_DOES_DOOR_EXIST(iLocal_369))
	{
		ADD_DOOR_TO_SYSTEM(iLocal_369, joaat("prop_fnclink_03gate5"), 391.8602f, -1636.07f, 29.9744f, 1, 1, 0);
	}
	_SET_DOOR_ACCELERATION_LIMIT(Global_35548[13 /*31*/], 1, 1, 0);
	_SET_DOOR_ACCELERATION_LIMIT(iLocal_369, 1, 1, 0);
}
...
void func_384()
{
	...
	while (iVar1 <= 2)
	{
		...
		while (iVar2 <= (15 - 1))
		{
			CLEAR_BIT(&(Local_389[iVar1 /*22*/].f_15), iVar2);
			iVar2++;
		}
		iVar1++;
	}
...
struct<22> func_385(vector3 vParam0, float fParam3, int iParam4)
{
	struct<22> Var0;
...
struct<6> func_387(vector3 vParam0, float fParam3, int iParam4)
{
	struct<6> Var0;
...
void func_388()
{
	ADD_RELATIONSHIP_GROUP("COPS", &uLocal_481);
}

void func_389()
{
	REMOVE_RELATIONSHIP_GROUP(uLocal_481);
	func_400(1);
	if (_DOES_DOOR_EXIST(Global_35548[13 /*31*/]))
	{
		_0x06C0023BED16DD6B(Global_35548[13 /*31*/], 0);
	}
	_SET_DOOR_AJAR_ANGLE(Global_35548[13 /*31*/], 0f, 1, 1);
	_SET_DOOR_ACCELERATION_LIMIT(Global_35548[13 /*31*/], 4, 1, 1);
	_SET_DOOR_ACCELERATION_LIMIT(iLocal_369, 0, 1, 0);
	REMOVE_DOOR_FROM_SYSTEM(iLocal_369);
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_360, 0);
	func_54();
	SET_MAX_WANTED_LEVEL(5);
	SET_WANTED_LEVEL_MULTIPLIER(1f);
	func_399();
...
void func_390(bool bParam0)
{
	...
	if (bParam0)
	{
		if (DOES_ENTITY_EXIST(Local_456))
		{
			if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
			{
				if (!IS_PED_INJURED(PLAYER_PED_ID()))
	...
	if (DOES_CAM_EXIST(uLocal_359))
	{
		RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
		DESTROY_CAM(uLocal_359, 0);
	}
}
...
void func_396()
{
	...
	SET_MODEL_AS_NO_LONGER_NEEDED(Local_456.f_5);
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		SET_MODEL_AS_NO_LONGER_NEEDED(Local_462[iVar0 /*6*/].f_5);
		iVar0++;
	}
}
