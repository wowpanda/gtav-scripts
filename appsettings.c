...
void __EntryFunction__()
{
	...
	while (iVar0 < 9)
	{
		...
		else if (MISC::ARE_STRINGS_EQUAL(&(Global_104555.f_14021[Global_14453 /*20*/].f_11), &(Global_3128[Global_14453 /*2811*/][1 /*281*/].f_144[iVar0 /*6*/])))
		{
...
void func_12()
{
	...
	if (iLocal_23 == 1)
	{
		...
		if ((((func_10(2, Global_14429, 0) || func_10(2, Global_14430, 0)) || iLocal_31) || iLocal_45 == 1) || iLocal_46 == 1)
		{
			...
			iLocal_27 = iLocal_18[GRAPHICS::_0x2DE7EFA66B906036(uLocal_21)];
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
			{
				AUDIO::STOP_PED_RINGTONE(PLAYER::PLAYER_PED_ID());
				SYSTEM::WAIT(100);
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					{
						if (MISC::ARE_STRINGS_EQUAL(&(Global_3128[Global_14453 /*2811*/][1 /*281*/].f_144[iLocal_27 /*6*/]), "Silent Ringtone Dummy"))
						{
						}
						else
						{
							AUDIO::PLAY_PED_RINGTONE(&(Global_3128[Global_14453 /*2811*/][1 /*281*/].f_144[iLocal_27 /*6*/]), PLAYER::PLAYER_PED_ID(), 1);
						}
					}
				}
			}
	...
	if (Global_14431 == 0)
	{
		if (func_10(2, Global_14422, 0))
		{
			...
			iLocal_26 = GRAPHICS::_0x2DE7EFA66B906036(uLocal_21);
			if (iLocal_26 < 0)
			{
				iLocal_26 = 0;
			}
			...
			if (iLocal_23 == 4)
			{
				...
				if (Global_70856)
				{
					...
					if (Global_4267356 == 0)
					{
						...
						if ((NETWORK::NETWORK_CLAN_PLAYER_IS_ACTIVE(&Var2) && NETWORK::_0x72D918C99BCACC54(0)) && Global_4267359 == 0)
						{
							SYSTEM::SETTIMERA(0);
...
void func_26()
{
	if (Global_14431 == 0)
	{
		if (func_10(2, Global_14422, 0))
		{
			...
			iLocal_24 = GRAPHICS::_0x2DE7EFA66B906036(uLocal_21);
...
void func_27()
{
	...
	while (iVar1 < 19)
	{
		...
		iVar0[iVar4] = 1;
		if (MISC::ARE_STRINGS_EQUAL(&(Global_3128[Global_14453 /*2811*/][iLocal_23 /*281*/].f_7[Global_3128[Global_14453 /*2811*/][iLocal_23 /*281*/].f_259 /*4*/]), &(Global_3128[Global_14453 /*2811*/][iLocal_23 /*281*/].f_7[iVar4 /*4*/])))
		{
			iLocal_28 = iVar1;
			if (iLocal_28 < 0)
			{
