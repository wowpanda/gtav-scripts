	...
	while (iLocal_289 && func_124(2, 0))
	{
		...
		switch (iLocal_98)
		{
			...
			case 2:
				if (func_120())
				{
					func_119(&uLocal_100, 0, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
					func_119(&uLocal_100, 2, Global_16B5A, "LAMAR", 0, 1);
					iLocal_98 = 3;
				}
				break;
...
int func_2()//Position - 0x171
{
	...
	func_112(&Global_16B5A, iLocal_290);
	func_3(Global_16B5A);
	return 0;
}
...
void func_3(int iParam0)//Position - 0x1B0
{
	...
	{
		if (!iLocal_369 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, AUDIO::_0x0626A247D2405330(), 1))
		{
			...
			if (iVar2 != 4294967295)
			{
				...
				if (iVar3 != 0)
				{
					...
					{
						func_97(75, unk_0x8000C77B5F336760(iParam0, false), 250f, 4294967295);
						if (func_35(Global_15BE5, iVar0, 2, 0, iVar3, iVar2, 75))
						{
							iLocal_369 = 1;
						}
					}
	...
	fVar4 = SYSTEM::VDIST2(unk_0x8000C77B5F336760(iParam0, true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true));
	if (fVar4 > (8f * 8f))
	{
		iLocal_367 = 4294967295;
	}
...
int func_6(int iParam0, int iParam1, var uParam2, char* sParam3, var uParam4, int iParam5, int iParam6)//Position - 0x518
{
	...
	switch (iVar3)
	{
		...
		case 2:
			if (Global_1590D[2] == 65 || Global_1590D[2] == 66)
			{
				return 0;
			}
	...
	if (!PAD::IS_CONTROL_JUST_PRESSED(0, 46) && !NETWORK::_0x5C497525F803486B(0, 46))
	{
		return 0;
	}
	if (!bVar5)
	...
	if (iVar8 || func_26(sParam3, &Var4, uParam4))
	{
		if (iVar3 == 5)
		{
			if (iVar2 == 0)
			{
				func_119(uParam2, 0, AUDIO::_0x0626A247D2405330(), "MICHAEL", 0, 1);
			}
			else if (iVar2 == 1)
			{
				func_119(uParam2, 0, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
			}
			else if (iVar2 == 2)
			{
				func_119(uParam2, 0, AUDIO::_0x0626A247D2405330(), "TREVOR", 0, 1);
			}
		}
...
int func_10(char* sParam0, char* sParam1, var uParam2, int iParam3, var uParam4, char* sParam5)//Position - 0x952
{
	...
	if (func_24(sParam0, 7))
	{
		...
		{
			func_119(uParam2, 0, AUDIO::_0x0626A247D2405330(), sVar0, 0, 1);
...
void func_33()//Position - 0x19CF
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_29(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_30(iVar0) && (!func_19(14) || Global_19A3D))
			{
...
int func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1B09
{
	...
	if (iParam3 == 0)
	{
		if (func_94(iVar1, iParam2, 4294967295, &iVar4, &iVar5))
		{
	...
	else if (func_86(iVar1, iParam2, 4294967295, &sVar8))
	{
...
int func_37(int iParam0, int iParam1, int iParam2)//Position - 0x1CF5
{
	...
	return func_38(Global_19E56.f_6D76[iParam0 /*29*/].f_11, 0, iParam1, iParam2, 0);
}
...
void func_41(int iParam0)//Position - 0x2619
{
	...
	if (iParam0 == 8)
	{
		func_44(129, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 9)
	{
		func_44(135, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 10)
	{
		func_44(136, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 11)
	{
		func_44(137, 0, 4294967295, 1);
		return;
	}
	bVar0 = false;
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_5038.f_1D7, iParam0) || INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_43() /*12745*/].f_1FF2.f_A, iParam0))
	{
		bVar0 = true;
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_19E56.f_5038.f_1D7), iParam0);
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_200000[func_43() /*12745*/].f_1FF2.f_A), iParam0);
	}
	if (bVar0)
	{
...
char* func_42(int iParam0)//Position - 0x272A
{
	switch (iParam0)
	{
		case 0:
...
int func_44(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x27E4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_45()//Position - 0x2D4C
{
	return Global_1407E0;
}

void func_46(int iParam0)//Position - 0x2D58
{
	func_67(93, iParam0);
	func_67(29, iParam0);
	func_67(30, iParam0);
...
bool func_47(int iParam0)//Position - 0x2D78
{
	if (iParam0 == 8)
	{
		return func_48(129, 4294967295, 4294967295);
	}
	if (iParam0 == 9)
	{
		return func_48(135, 4294967295, 4294967295);
	}
	if (iParam0 == 10)
	{
		return func_48(136, 4294967295, 4294967295);
	}
	if (iParam0 == 11)
	{
		return func_48(137, 4294967295, 4294967295);
	}
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_5038.f_1D7, iParam0);
	}
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_43() /*12745*/].f_1FF2.f_A, iParam0);
}

int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x2DFC
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_49(int iParam0)//Position - 0x2E39
{
	int iVar0;
...
int func_50(int iParam0, int iParam1)//Position - 0x3151
{
	int iVar0;
...
int func_51(bool bParam0)//Position - 0x3449
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_52(int iParam0, int iParam1)//Position - 0x3500
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_53(int iParam0, int iParam1)//Position - 0x351B
{
...
int func_54(var uParam0, int iParam1)//Position - 0x35B8
{
	int iVar0;
	var uVar1[78];
...
int func_55(var uParam0, int iParam1)//Position - 0x3669
{
	int iVar0;
...
bool func_56(var uParam0, int iParam1)//Position - 0x36E4
{
	return (*uParam0)[iParam1] == 78;
}

void func_57(var uParam0)//Position - 0x36F5
{
	int iVar0;
...
void func_58(var uParam0, int iParam1)//Position - 0x3729
{
	(*uParam0)[iParam1] = 78;
}

void func_59(var uParam0, float fParam1)//Position - 0x3739
{
	if (fParam1 == 0f)
	{
		uParam0->f_50 = 0f;
...
float func_60(var uParam0)//Position - 0x3756
{
	return uParam0->f_50;
}

bool func_61(var uParam0, int iParam1)//Position - 0x3762
{
	return func_62(uParam0, iParam1) != 4294967295;
}

int func_62(var uParam0, int iParam1)//Position - 0x3774
{
	int iVar0;
...
bool func_63(var uParam0)//Position - 0x37A1
{
	return uParam0->f_4F == 1;
}

int func_64(int iParam0)//Position - 0x37AF
{
	switch (iParam0)
	{
		case 60:
...
int func_65(int iParam0, int iParam1)//Position - 0x37FF
{
	int iVar0;
...
void func_66(int iParam0, int iParam1)//Position - 0x3850
{
	int iVar0;
...
void func_67(int iParam0, int iParam1)//Position - 0x3873
{
	int iVar0;
...
int func_69(int iParam0)//Position - 0x3945
{
	var uVar0;
...
int func_74(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)//Position - 0x3AA5
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_75(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)//Position - 0x3B3D
{
	int iVar0;
	...
	if (!Global_395A)
	{
		...
		{
			func_79(Global_389E, "SET_DATA_SLOT_EMPTY", 1f, 3212836864, 3212836864, 3212836864, 3212836864);
			func_76(1);
			func_79(Global_389E, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_389D), 3212836864, 3212836864, 3212836864);
		}
	}
	return 1;
}

void func_76(int iParam0)//Position - 0x3FF4
{
	int iVar0;
	int iVar1;
	int iVar2;
					...
					if (iVar0 == Global_956[iVar1 /*15*/].f_4)
					{
						if (Global_B88[iVar0] == 0)
						{
							...
							if (Global_25824A)
							{
								if (iVar1 == 14)
								{
									func_77(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(Global_41F5), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_B88[iVar0] = 1;
						}
					...
					if (iVar0 == Global_956[iVar1 /*15*/].f_4)
					{
						if (Global_B88[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_77(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(Global_41FA), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_11625)
								{
									...
									func_77(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_38B1)
									...
									func_77(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_956[iVar1 /*15*/].f_A == 57 && iVar1 == 23)
							{
								...
								func_77(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_77(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(0), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_B88[iVar0] = 1;
						}
					}
...
void func_77(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)//Position - 0x459B
{
...
void func_78(char* sParam0)//Position - 0x464E
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	CAM::_DISABLE_VEHICLE_FIRST_PERSON_CAM_THIS_FRAME();
}

void func_79(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)//Position - 0x4660
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
...
bool func_80()//Position - 0x46C3
{
	return Global_140859;
}

void func_81(int iParam0)//Position - 0x46CF
{
	var uVar0;
	var uVar1;
...
void func_82(int iParam0)//Position - 0x46EE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_83()//Position - 0x4780
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_84(Global_19E56.f_3721[iVar2 /*104*/].f_12, Global_19E56.f_3721[Global_41F9 /*104*/].f_12))
		{
			Global_41F9 = iVar2;
		}
		iVar2++;
...
int func_84(struct<6> Param0, struct<6> Param1)//Position - 0x484B
{
	struct<4> Var0;
	struct<4> Var1;
	int iVar2;
...
int func_86(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x4A9E
{
	struct<4> Var0;
	struct<4> Var1[2];
	int iVar2;
...
int func_87(char* sParam0, int iParam1)//Position - 0x4BD6
{
	int iVar0;
	int iVar1;
...
int func_88(int iParam0)//Position - 0x4C4A
{
	switch (iParam0)
	{
		case 0:
...
char* func_89(int iParam0)//Position - 0x4CAC
{
	switch (iParam0)
	{
		case 0:
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x4D1F
{
	struct<14> Var0;
...
void func_91(int iParam0)//Position - 0x4E5D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_92(int iParam0)//Position - 0x4F21
{
	switch (iParam0)
	{
		case 0:
...
bool func_93(bool bParam0)//Position - 0x4F8B
{
...
int func_94(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4)//Position - 0x4FB6
{
	struct<4> Var0[2];
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x50B8
{
...
int func_96(int iParam0)//Position - 0x5166
{
	switch (iParam0)
	{
		case 0:
...
void func_97(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0x519D
{
	if (iParam0 == iParam3)
	{
		return;
...
int func_98(int iParam0)//Position - 0x51E6
{
	int iVar0;
	int iVar1;
...
int func_99(int iParam0, int iParam1)//Position - 0x529C
{
	struct<10> Var0;
	bool bVar1;
	...
	bVar1 = false;
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Var0.f_2, func_100()))
	{
		bVar1 = true;
	}
	if (Var0.f_4 > iParam1)
	...
	if (bVar1)
	{
		if (Var0.f_3 < Global_19E56.f_1DEC.f_397[func_100()])
		{
			return 5;
		}
	}
...
int func_100()//Position - 0x5334
{
	func_33();
	return Global_19E56.f_933.f_21B.f_10CD;
}

struct<10> func_101(int iParam0)//Position - 0x534D
{
	int iVar0;
	struct<10> Var1;
...
int func_102(int iParam0, int iParam1)//Position - 0x539C
{
	struct<14> Var0;
	bool bVar1;
...
struct<14> func_103(int iParam0)//Position - 0x542B
{
	int iVar0;
	struct<14> Var1;
...
int func_104(int iParam0, int iParam1)//Position - 0x547A
{
	struct<15> Var0;
	bool bVar1;
...
struct<15> func_105(int iParam0)//Position - 0x5525
{
	int iVar0;
	struct<15> Var1;
...
int func_106(int iParam0)//Position - 0x556D
{
	int iVar0;
...
int func_107(int iParam0)//Position - 0x5669
{
	vector3 vVar0;
...
int func_108(vector3 vParam0, bool bParam1)//Position - 0x56FC
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_109(int iParam0)//Position - 0x5779
{
	if (iParam0 == 0)
	{
		return 2091854273;
...
int func_110(int iParam0)//Position - 0x57E5
{
	if (iParam0 == 145)
	{
		return 7;
...
int func_111(int iParam0)//Position - 0x5840
{
	int iVar0;
	int iVar1;
...
int func_112(int iParam0, int iParam1)//Position - 0x5880
{
	int iVar0;
	float fVar1;
	float fVar2;
		...
		switch (iLocal_292[iParam1])
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_349, &(Local_359[iParam1 /*16*/]), 2))
				{
					...
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_16221) > fVar1)
					{
						...
						if (PED::IS_PED_INJURED(*iParam0))
						{
							...
							BRAIN::TASK_GO_STRAIGHT_TO_COORD(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/] * Vector(0.1f, 0.1f, 0.1f), 1f, 4294967295, 1193033728, 1056964608);
							PED::FORCE_PED_MOTION_STATE(*iParam0, 3626484699, false, 1, 0);
				...
				if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_16220) && !PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_16221))
				{
					SYSTEM::WAIT(0);
					if (PED::IS_PED_INJURED(*iParam0))
					{
			...
			case 1:
				...
				{
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vLocal_295 + vLocal_298[iParam1 /*3*/], 1f, 4294967295, 0.25f, iVar0, 1193033728);
					iLocal_292[iParam1] = 2;
					return 1;
				}
				fVar5 = SYSTEM::VMAG(vLocal_298[iParam1 /*3*/] * Vector(0.05f, 0.05f, 0.05f));
				if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(*iParam0, true), vLocal_295) >= fVar5)
				{
				...
				if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), *iParam0) || PED::IS_PED_IN_COMBAT(*iParam0, 0))
				{
			...
			case 3:
				...
				if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(*iParam0, true), vLocal_295 + vLocal_298[iParam1 /*3*/]) < (fLocal_300[iParam1] * fLocal_300[iParam1]))
				{
			...
			case 4:
				...
				else
				{
					...
					{
						if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(*iParam0, true), vVar7) > 100f)
						{
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vVar7, 1f, 4294967295, 0.25f, iVar0, 1193033728);
							iLocal_292[iParam1] = 1;
							return 1;
						}
					}
			...
			case 10:
				...
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_293, Global_1590B);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, Global_1590B, iLocal_293);
...
Vector3 func_113(vector3 vParam0, float fParam1, float fParam2)//Position - 0x5E7A
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_114(vector3 vParam0, float fParam1, float fParam2)//Position - 0x5EF3
{
	vector3 vVar0;
	float fVar1;
	...
	fVar1 = (fParam2 / 2f);
	vVar0 = { func_115(vVar0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1)) };
	vVar0.z = MISC::GET_RANDOM_FLOAT_IN_RANGE(-fVar1, fVar1);
	return vParam0 + vVar0;
}

Vector3 func_115(vector3 vParam0, float fParam1)//Position - 0x5F3B
{
	float fVar0;
...
float func_116(float fParam0, float fParam1, float fParam2)//Position - 0x5F72
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
bool func_118(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x5FB3
{
	if (bParam2)
	{
...
void func_119(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x5FFA
{
	...
	if (!func_121())
	{
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_16221))
		{
			...
			while (iVar0 < iLocal_290)
			{
				...
				{
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_290[iVar0], Global_16221, &cLocal_349, &(Local_359[iVar0 /*16*/]), 8f, -4f, 3, 0, 1148846080, 0);
					iLocal_292[iVar0] = 0;
				}
				else
				{
					iLocal_292[iVar0] = 4294967295;
				}
				iVar0++;
			}
...
int func_123()//Position - 0x61F9
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_16220))
	{
		...
		while (iVar0 < iLocal_290)
		{
			if (!PED::IS_PED_INJURED(iLocal_290[iVar0]))
			{
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_290[iVar0], Global_16220, &cLocal_349, &(Local_358[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			func_119(&uLocal_100, 1, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
		}
		if (!PED::IS_PED_INJURED(Global_16B5A))
		{
			func_119(&uLocal_100, 4, Global_16B5A, "LAMAR", 0, 1);
		}
...
int func_124(int iParam0, int iParam1)//Position - 0x62D9
{
	vector3 vVar0;
	float fVar1;
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_125(Global_16B5A) && iParam1 != 0)
		{
			Global_16B5A = 0;
		}
	}
...
int func_125(var uParam0)//Position - 0x63BD
{
	return uParam0;
}

bool func_126(var uParam0, var uParam1)//Position - 0x63C7
{
	return (uParam0 && uParam1) != 0;
}

int func_127()//Position - 0x63D6
{
	func_33();
...
void func_129()//Position - 0x645C
{
	func_130((Global_16B5C - 1));
}

void func_130(int iParam0)//Position - 0x646E
{
	Global_16B5C = iParam0;
}

void func_131()//Position - 0x647C
{
	func_130(0);
}

void func_132()//Position - 0x6489
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_16B5A))
	{
		if (func_31(19) == ENTITY::GET_ENTITY_MODEL(Global_16B5A))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_16B5A, true, 1);
		}
		func_133(&Global_16B5A, Global_1590B);
		PED::SET_PED_CONFIG_FLAG(Global_16B5A, 132, true);
		PED::SET_PED_CONFIG_FLAG(Global_16B5A, 317, true);
		func_133(&Global_16B5A, Global_1590B);
	}
	...
	while (iVar0 < iLocal_290)
	{
		if (iLocal_291[iVar0] != 0)
		{
			...
			BRAIN::TASK_PLAY_ANIM(iLocal_290[iVar0], &cLocal_349, &(Local_358[iVar0 /*16*/]), 8f, -8f, 4294967295, 9, 0, 0, 0, 0);
...
void func_133(var uParam0, int iParam1)//Position - 0x6667
{
...
void func_134()//Position - 0x669D
{
	char[] cVar0[8];
	var uVar1;
	var uVar2;
	
	iLocal_99 = Global_16A1C;
...
struct<4> func_135(char* sParam0, int iParam1)//Position - 0x6C58
{
	struct<4> Var0;
...
int func_136(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)//Position - 0x6CB4
{
	*uParam4 = 9;
	*uParam5 = 0;
	switch (iParam0)
...
void func_137(int iParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0x83F3
{
...
int func_138(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0x8413
{
	int iVar0;
...
bool func_139(var uParam0)//Position - 0x85FE
{
	int iVar0;
	vector3 vVar1;
	float fVar2;
...
int func_140(int iParam0, var uParam1, char* sParam2)//Position - 0x86B9
{
	vector3 vVar0;
	int iVar1;
	var uVar2;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[0];
			StringCopy(sParam2, func_144(Global_19E56.f_933.f_21B.f_8F6[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[1];
			StringCopy(sParam2, func_144(Global_19E56.f_933.f_21B.f_8F6[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[2];
			StringCopy(sParam2, func_144(Global_19E56.f_933.f_21B.f_8F6[2]), 32);
			return 1;
			break;
...
int func_141(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0xAAC5
{
	switch (iParam1)
	{
		case 0:
...
int func_143(int iParam0, var uParam1, var uParam2)//Position - 0xCA34
{
	switch (iParam0)
	{
		case 11:
...
char* func_144(int iParam0)//Position - 0xD3A3
{
	switch (iParam0)
	{
		case 2014101067:
