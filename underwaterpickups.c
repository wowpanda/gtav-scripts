...
void func_1()
{
	...
	while (iVar0 < 20)
	{
		if (func_3(iVar0, &iVar1, &vVar2, &vVar5, &uVar9))
		{
			if (func_2(vVar5, 0f, 0f, 0f, 0))
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_24)
					{
						uLocal_3[iVar0] = CREATE_PICKUP(iVar1, vVar2, iVar8, uVar9, 1, 0);
					}
				}
				else if (VDIST2(vVar2, vLocal_25) > 400f)
				{
					...
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_24)
						{
							uLocal_3[iVar0] = CREATE_PICKUP(iVar1, vVar2, iVar8, -1, 1, 0);
						}
					}
					else
					{
			...
			else
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_24)
					{
						uLocal_3[iVar0] = CREATE_PICKUP_ROTATE(iVar1, vVar2, vVar5, iVar8, 10000, 2, 1, 0);
					}
				}
				else if (VDIST2(vVar2, vLocal_25) > 400f)
				{
					if (iVar1 == joaat("pickup_armour_standard"))
					{
						uLocal_3[iVar0] = CREATE_PICKUP_ROTATE(iVar1, vVar2, vVar5, iVar8, -1, 2, 1, 0);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_24)
...
void func_27()
{
	...
	while (iVar0 < 20)
	{
		if (DOES_PICKUP_EXIST(uLocal_3[iVar0]))
		{
			REMOVE_PICKUP(uLocal_3[iVar0]);
		}
		iVar0++;
	}
}
