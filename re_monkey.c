...
void __EntryFunction__()
{
	...
	fLocal_62 = "switch@franklin@lamar_tagging_wall";
	fLocal_63 = "lamar_tagging_wall_loop_lamar";
	fLocal_64 = "lamar_tagging_wall_exit_lamar";
	fLocal_65 = "lamar_tagging_exit_loop_lamar";
	vLocal_66 = { 0f, 0f, 0f };
...
void func_39(int iParam0)
{
	...
	while (iVar1 < Global_105220.f_7659.f_198)
	{
		...
		{
			func_40(Global_105220.f_7659.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
void func_54(void fParam0, int iParam1)
{
...
int func_56()
{
	switch (func_57(&Global_25336, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_60(iParam0, Global_35905);
}
...
void func_66()
{
	...
	if (func_44(iLocal_48))
	{
		...
		{
			case 0:
				STREAMING::REQUEST_ANIM_DICT(fLocal_62);
				if (STREAMING::HAS_ANIM_DICT_LOADED(fLocal_62))
				{
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_48, true);
					BRAIN::TASK_PLAY_ANIM(iLocal_48, fLocal_62, fLocal_63, 1000f, -8f, -1, 8193, 0, 0, 0, 0);
					iLocal_51++;
				}
				break;
			...
			case 1:
				...
				if (func_76(PLAYER::PLAYER_PED_ID(), iLocal_48, 35f))
				{
					...
					BRAIN::TASK_PLAY_ANIM(0, fLocal_62, fLocal_64, 8f, -8f, -1, 8192, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, fLocal_62, fLocal_65, 8f, -2f, -1, 8193, 0, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_68);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_48, iLocal_68);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_68);
					STREAMING::REMOVE_ANIM_DICT(fLocal_62);
					iLocal_51++;
				}
				break;
...
int func_67()
{
	...
	{
		case 0:
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48, fLocal_62, fLocal_65, 3))
			{
				fLocal_54 = 0.349f;
				iLocal_55 = 900;
				vLocal_57 = { vVar0 };
			...
			else if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48, fLocal_62, fLocal_64, 3))
			{
				fLocal_54 = ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_48, fLocal_62, fLocal_64);
		...
		case 1:
			...
			BRAIN::TASK_PLAY_ANIM(iLocal_48, fLocal_62, fLocal_64, 4f, -8f, -1, 0, fLocal_54, 1, 0, 0);
		...
		case 2:
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48, fLocal_62, fLocal_64, 3))
			{
				...
				ENTITY::SET_ENTITY_ANIM_CURRENT_TIME(iLocal_48, fLocal_62, fLocal_64, fVar5);
				fVar6 = (fVar4 - 0.12f);
...
void func_72()
{
	...
	if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48, fLocal_62, fLocal_64, 3))
	{
		fVar0 = ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_48, fLocal_62, fLocal_64);
		if (fVar0 < 0.383793f)
		{
			func_69();
		}
	...
	else if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48, fLocal_62, fLocal_65, 3))
	{
		fVar0 = ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_48, fLocal_62, fLocal_65);
		if (fVar0 < 0.1124f)
		{
			func_69();
		}
...
int func_89(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_127(Global_105220.f_24966.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_124()) || Global_104267) || Global_25279) || func_123()) || func_122(8, -1)) || func_121()) || func_120()) || func_119()) || func_118()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_124()) || Global_25279) || func_123()) || func_122(8, -1)) || func_119()) || func_121()) || func_120()) || func_118()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_124()) || Global_104267) || Global_25279) || func_123()) || func_122(8, -1)) || func_119()) || func_121()) || func_120()) || func_118()) || Global_105220.f_7659.f_919[iVar0] == 5) || Global_36452 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_124()) || Global_104267) || Global_25279) || func_123()) || func_122(8, -1)) || func_121()) || func_120()) || func_118()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_124() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_122(8, -1)) || func_118()) || func_117()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_124()) || Global_25279) || func_123()) || func_122(8, -1)) || func_120()) || func_119()) || func_118()) || Global_105220.f_7659.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_124()) || func_120()) || Global_104267) || Global_25279) || func_123()) || Global_37057) || func_122(8, -1)) || func_119()) || func_117()) || func_118()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_124()) || Global_104267) || Global_25279) || func_123()) || func_122(8, -1)) || func_119()) || func_117()) || func_121()) || func_120()) || func_118())
						{
							return 0;
						}
						break;
...
void func_145(int iParam0)
{
	...
	if (func_156())
	{
		...
		func_148(30000);
		StringCopy(&cVar0, func_147(Global_105209, 1), 64);
