...
int func_1()
{
	...
	else if (iLocal_48 == 1)
	{
		...
		{
			func_43(PLAYER_PED_ID(), -347.4067f, -93.5801f, 44.6639f, 306.0178f);
		}
...
void func_39(int iParam0)
{
	...
	while (iVar15 < Global_106565.f_7682.f_198)
	{
		...
		{
			func_40(Global_106565.f_7682.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
void func_45()
{
	...
	while (iVar0 < 4)
	{
		...
		switch (iVar1)
		{
			...
			case 1:
				uLocal_64[iVar1] = CREATE_OBJECT(joaat("prop_paints_can02"), -335.66f, -95.24f, 46.16f, 1, 1, 0);
				SET_ENTITY_COORDS_NO_OFFSET(uLocal_64[iVar1], -335.66f, -95.24f, 46.16f, 0, 0, 1);
				SET_ENTITY_ROTATION(uLocal_64[iVar1], -2.32f, 0.66f, -0.8f, 2, 1);
				break;
			
			case 2:
				uLocal_64[iVar1] = CREATE_OBJECT(joaat("prop_paint_brush05"), -336.04f, -94.9f, 46.02f, 1, 1, 0);
				SET_ENTITY_COORDS_NO_OFFSET(uLocal_64[iVar1], -336.04f, -94.9f, 46.02f, 0, 0, 1);
				SET_ENTITY_ROTATION(uLocal_64[iVar1], 0.01f, 3.85f, 2.72f, 2, 1);
				break;
			
			case 3:
				uLocal_64[iVar1] = CREATE_OBJECT(joaat("prop_paint_spray01b"), -336.34f, -95.66f, 46.02f, 1, 1, 0);
				SET_ENTITY_COORDS_NO_OFFSET(uLocal_64[iVar1], -336.34f, -95.66f, 46.02f, 0, 0, 1);
				SET_ENTITY_ROTATION(uLocal_64[iVar1], -2.86f, 0.76f, 28.89f, 2, 1);
				break;
		}
		iVar0++;
	}
...
int func_49()
{
	...
	else if (iLocal_48 == 1)
	{
		if (func_44(PLAYER_PED_ID()))
		{
			func_43(PLAYER_PED_ID(), -366.6139f, -79.7531f, 44.6616f, 230.7299f);
		}
		SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
		SET_GAMEPLAY_CAM_RELATIVE_PITCH(0, 1065353216);
		DO_SCREEN_FADE_IN(250);
		...
		switch (iLocal_49)
		{
			...
			case 1:
				if (func_50())
				{
					...
					{
						if (_0x89215EC747DF244A(1106247680, 31086, 1061997773, 1060320051, 1048576000, 1090519040, 1051361018, 31086, 24818) == iLocal_50)
						{
							iLocal_83 = GET_GAME_TIMER() + 2000;
							iLocal_49++;
						}
					}
				}
...
int func_51()
{
	...
	else
	{
		...
		{
			iLocal_50 = CREATE_PED(26, 1813637474, vLocal_51, fLocal_54, 1, 1);
			SET_MODEL_AS_NO_LONGER_NEEDED(1813637474);
			uLocal_64[0] = CREATE_OBJECT(joaat("prop_cs_spray_can"), vLocal_69, 1, 1, 0);
			ATTACH_ENTITY_TO_ENTITY(uLocal_64[0], iLocal_50, GET_PED_BONE_INDEX(iLocal_50, 28422), 0f, -0.01f, -0.02f, vLocal_78, 1, 1, 0, 0, 2, 1);
			SET_PED_KEEP_TASK(iLocal_50, 1);
			SET_PED_CONFIG_FLAG(iLocal_50, 42, 1);
...
int func_56()
{
	switch (func_57(&Global_25824, 0, 5, 0, GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_63(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_64(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		SET_BLIP_SCALE(uVar0, func_64(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
void func_66()
{
	...
	if (func_44(iLocal_50))
	{
		...
		if (bVar1)
		{
			...
			bVar12 = IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0);
			bVar13 = IS_PED_IN_ANY_HELI(PLAYER_PED_ID());
		}
		if (iLocal_55 < 3)
		{
		...
		switch (iLocal_55)
		{
			case 0:
				...
				{
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_50, 1);
			...
			case 1:
				...
				if (func_76(PLAYER_PED_ID(), iLocal_50, 35f))
				{
					OPEN_SEQUENCE_TASK(&uLocal_82);
					TASK_PLAY_ANIM(0, sLocal_74, sLocal_76, 8f, -8f, -1, 8192, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, sLocal_74, sLocal_77, 8f, -2f, -1, 8193, 0, 0, 0, 0);
					CLOSE_SEQUENCE_TASK(uLocal_82);
					TASK_PERFORM_SEQUENCE(iLocal_50, uLocal_82);
					CLEAR_SEQUENCE_TASK(&uLocal_82);
			...
			case 2:
				...
				if ((bVar0 && bVar1) && func_76(PLAYER_PED_ID(), iLocal_50, fVar14))
				{
					iLocal_55 = 3;
				}
				if (iLocal_56)
			...
			case 4:
				SET_PED_FLEE_ATTRIBUTES(iLocal_50, 8, 1);
				SET_PED_FLEE_ATTRIBUTES(iLocal_50, 32, 1);
				OPEN_SEQUENCE_TASK(&uLocal_82);
				TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), 800);
				TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 9999f, -1, 1, 0);
				CLOSE_SEQUENCE_TASK(uLocal_82);
				TASK_PERFORM_SEQUENCE(iLocal_50, uLocal_82);
				CLEAR_SEQUENCE_TASK(&uLocal_82);
				iLocal_55++;
			...
			case 5:
				...
				if (!IS_ENTITY_ON_SCREEN(iLocal_50) && VDIST2(vVar2, GET_ENTITY_COORDS(PLAYER_PED_ID(), 0)) > 2500f)
				{
					uLocal_81 = START_SHAPE_TEST_LOS_PROBE(vVar5, vVar2, 1, 0, 7);
					iLocal_55++;
				}
				break;
			...
			case 6:
				...
				iVar23 = GET_SHAPE_TEST_RESULT(uLocal_81, &iVar15, &uVar16, &uVar19, &uVar22);
				if (iVar23 == 2)
				{
					if (iVar15 == 1)
					{
	...
	{
		FREEZE_ENTITY_POSITION(iLocal_50, 0);
	}
}
...
int func_67()
{
	...
	switch (iLocal_60)
	{
		...
		case 1:
			FREEZE_ENTITY_POSITION(iLocal_50, 1);
			TASK_PLAY_ANIM(iLocal_50, sLocal_74, sLocal_76, 4f, -8f, -1, 0, fLocal_58, 1, 0, 0);
			iLocal_83 = GET_GAME_TIMER();
			func_70(&uLocal_57);
			func_69();
			if (DOES_ENTITY_EXIST(uLocal_64[0]))
			{
				DETACH_ENTITY(uLocal_64[0], 1, 1);
			}
			iLocal_60++;
			break;
		...
		case 2:
			...
			{
				iVar7 = (GET_GAME_TIMER() - iLocal_83);
				...
				SET_ENTITY_COORDS(iLocal_50, vVar11, 0, 1, 0, 1);
				if (fVar9 == 0.161f)
				{
					FREEZE_ENTITY_POSITION(iLocal_50, 0);
					return 1;
...
void func_73()
{
	if (iLocal_72 == 0)
	{
		iLocal_72 = START_PARTICLE_FX_LOOPED_ON_ENTITY(sLocal_73, uLocal_64[0], vLocal_78, vLocal_78, 1065353216, 0, 0, 0);
...
bool func_75()
{
	return (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -334.4651f, -93.42171f, 48.57328f, -332.2641f, -82.78552f, 45.8103f, 3f, 0, 1, 0) && !IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -329.1134f, -83.87273f, 45.79989f, -331.0937f, -88.05348f, 48.71878f, 3f, 0, 1, 0));
}

int func_76(var uParam0, var uParam1, float fParam2)
{
	float fVar0;
	...
	if (DOES_ENTITY_EXIST(uParam0) && DOES_ENTITY_EXIST(uParam1))
	{
		...
		return VDIST2(GET_ENTITY_COORDS(uParam0, 0), GET_ENTITY_COORDS(uParam1, 0)) <= fVar0;
	}
	return 0;
}
...
int func_77(int iParam0)
{
	...
	{
		func_70(&uLocal_57);
		TASK_SMART_FLEE_PED(iLocal_50, PLAYER_PED_ID(), 9999f, -1, 1, 0);
		return 1;
	}
	return 0;
}
...
int func_89(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!bVar0)
	{
		...
		if (!func_127(Global_106565.f_24989.f_43[iParam3]))
		{
			return 0;
		}
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_124()) || Global_105612) || Global_25767) || func_123()) || func_122(8, -1)) || func_121()) || func_120()) || func_119()) || func_118()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_124()) || Global_25767) || func_123()) || func_122(8, -1)) || func_119()) || func_121()) || func_120()) || func_118()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_124()) || Global_105612) || Global_25767) || func_123()) || func_122(8, -1)) || func_119()) || func_121()) || func_120()) || func_118()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_124()) || Global_105612) || Global_25767) || func_123()) || func_122(8, -1)) || func_121()) || func_120()) || func_118()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_124() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_122(8, -1)) || func_118()) || func_117()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_124()) || Global_25767) || func_123()) || func_122(8, -1)) || func_120()) || func_119()) || func_118()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_124()) || func_120()) || Global_105612) || Global_25767) || func_123()) || Global_37584) || func_122(8, -1)) || func_119()) || func_117()) || func_118()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_124()) || Global_105612) || Global_25767) || func_123()) || func_122(8, -1)) || func_119()) || func_117()) || func_121()) || func_120()) || func_118())
						{
							return 0;
						}
						break;
