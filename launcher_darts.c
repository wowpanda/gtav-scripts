...
void __EntryFunction__()
{
	...
	{
		vLocal_90 = { GET_ENTITY_COORDS(uScriptParam_0, 1) };
		uLocal_156 = uScriptParam_0;
		Var0.f_1[0 /*3*/] = { vLocal_90 };
		uLocal_118 = GET_ENTITY_MODEL(uLocal_156);
	}
	else
	{
		uLocal_156 = uScriptParam_0;
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_114(uLocal_94, 4194304))
	{
		if (iLocal_105 != 263)
		{
	...
	while (true)
	{
		...
		{
			fVar24 = 0f;
			if (GET_GROUND_Z_FOR_3D_COORD(Var0.f_1[0 /*3*/], &fVar24, 0, 0))
			{
				if (fVar24 != 0f)
				{
		...
		if (DOES_ENTITY_EXIST(uLocal_85) && !IS_ENTITY_DEAD(uLocal_85, 0))
		{
			...
			uLocal_93 = VDIST2(vLocal_87, Var0.f_1[0 /*3*/]);
			uLocal_93 = uLocal_93;
			...
			switch (iLocal_95)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_98(3) && !Global_93716)
						{
							...
							{
								if ((!func_114(uLocal_94, 1) || !DOES_ENTITY_EXIST(func_97())) && !Global_93716)
								{
									func_107(10);
									break;
								}
						...
						if (bVar26)
						{
							if (!IS_ENTITY_AT_COORD(uLocal_85, Var0.f_1[0 /*3*/], fLocal_117, fLocal_117, 2f, 0, 1, iLocal_103))
							{
								bVar26 = false;
							}
							if (IS_ENTITY_DEAD(uLocal_156, 0))
							{
								uLocal_156 = GET_CLOSEST_OBJECT_OF_TYPE(vLocal_90, 2f, uLocal_118, 1, 0, 1);
								func_84(&uLocal_94, 128);
								bVar26 = false;
							}
							else
							{
								vLocal_137 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_156, vLocal_134) };
								if (func_77(&Local_119, vLocal_87, vLocal_137, uLocal_156))
								{
									bLocal_132 = false;
								}
							...
							if (GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()) != iLocal_140)
							{
								bVar26 = false;
							}
				...
				case 6:
					...
					if (func_114(uLocal_94, 2097152))
					{
						if (!func_98(3) && !IS_THREAD_ACTIVE(uLocal_52))
						{
							func_107(10);
						}
					}
...
var func_23()
{
	...
	vVar0 = { GET_ENTITY_ROTATION(uLocal_156, 2) };
	Local_149 = { GET_ENTITY_COORDS(uLocal_156, 1) };
	Local_149.f_3 = vVar0.z;
	Local_149.f_4 = uLocal_156;
	...
	uVar3 = START_NEW_SCRIPT_WITH_ARGS(&Local_53, &Local_149, 7, iLocal_97);
...
void func_37()
{
	...
	if (bLocal_146)
	{
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			vVar29 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
		}
		...
		if (iLocal_147 == 0)
		{
			if (fVar32 < (10f * 10f))
			{
				...
				if (!func_100(6) && !func_100(7))
				{
					if (!IS_ENTITY_DEAD(uLocal_143, 0))
					{
						FREEZE_ENTITY_POSITION(uLocal_143, 0);
						TASK_LOOK_AT_ENTITY(uLocal_143, uLocal_144, -1, 2049, 3);
						TASK_START_SCENARIO_IN_PLACE(uLocal_143, "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
					}
					if (!IS_ENTITY_DEAD(uLocal_144, 0))
					{
						FREEZE_ENTITY_POSITION(uLocal_144, 0);
						TASK_LOOK_AT_ENTITY(uLocal_144, uLocal_143, -1, 2049, 3);
						TASK_START_SCENARIO_IN_PLACE(uLocal_144, "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
					}
				}
				else
				{
					if (!IS_ENTITY_DEAD(uLocal_143, 0))
					{
						...
						{
							TASK_USE_NEAREST_SCENARIO_TO_COORD(uLocal_143, 1991.677f, 3044.957f, 46.21505f, 0.5f, 0);
						}
						else
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_143, 1991.677f, 3044.957f, 46.21505f, 1f, 20000, 1048576000, 0, 1193033728);
						}
					...
					if (!IS_ENTITY_DEAD(uLocal_144, 0))
					{
						...
						{
							TASK_USE_NEAREST_SCENARIO_TO_COORD(uLocal_144, 1990.37f, 3045.121f, 46.21502f, 0.5f, 0);
						}
						else
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_144, 1990.37f, 3045.121f, 46.21502f, 1f, 20000, 1048576000, 0, 1193033728);
						}
						SET_PED_AS_NO_LONGER_NEEDED(&uLocal_144);
					}
				}
			}
		}
		else if (iLocal_147 == 1)
		{
			if (fVar32 >= (10f * 10f))
			{
				...
				if (!func_100(6) && !func_100(7))
				{
					if (!IS_ENTITY_DEAD(uLocal_143, 0))
					{
						TASK_STAND_STILL(uLocal_143, -1);
						if (!IS_ENTITY_ATTACHED(uLocal_143))
						{
							FREEZE_ENTITY_POSITION(uLocal_143, 1);
						}
					}
					if (!IS_ENTITY_DEAD(uLocal_144, 0))
					{
						TASK_STAND_STILL(uLocal_144, -1);
						if (!IS_ENTITY_ATTACHED(uLocal_144))
						{
							FREEZE_ENTITY_POSITION(uLocal_144, 1);
						}
					}
				}
				else
				{
					if (!IS_ENTITY_DEAD(uLocal_143, 0))
					{
						SET_ENTITY_COORDS(uLocal_143, 1991.677f, 3044.957f, 46.21505f, 1, 0, 0, 1);
						TASK_STAND_STILL(uLocal_143, -1);
						if (!IS_ENTITY_ATTACHED(uLocal_143))
						{
							FREEZE_ENTITY_POSITION(uLocal_143, 1);
					...
					if (!IS_ENTITY_DEAD(uLocal_144, 0))
					{
						SET_ENTITY_COORDS(uLocal_144, 1990.37f, 3045.121f, 46.21502f, 1, 0, 0, 1);
						TASK_STAND_STILL(uLocal_144, -1);
						if (!IS_ENTITY_ATTACHED(uLocal_144))
						{
							FREEZE_ENTITY_POSITION(uLocal_144, 1);
	...
	if (!iLocal_159)
	{
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			if (((IS_PED_SHOOTING(PLAYER_PED_ID()) || IS_PLAYER_WANTED_LEVEL_GREATER(GET_PLAYER_INDEX(), 0)) || IS_ANY_PED_SHOOTING_IN_AREA(937.0616f, -117.8927f, 72.9163f, 1021.849f, -120.5357f, 72.9163f, 1, 1)) || IS_PROJECTILE_IN_AREA(1991.473f, 3045.98f, 49.532f, 1996.906f, 3052.17f, 46.3392f, 0))
			{
				if (!IS_ENTITY_DEAD(uLocal_143, 0))
				{
					TASK_SMART_FLEE_PED(uLocal_143, PLAYER_PED_ID(), 1000f, -1, 0, 0);
				}
				if (!IS_ENTITY_DEAD(uLocal_144, 0))
				{
					TASK_SMART_FLEE_PED(uLocal_144, PLAYER_PED_ID(), 1000f, -1, 0, 0);
				}
				bVar28 = true;
			}
			else
			{
				iVar26 = GET_PED_NEARBY_PEDS(PLAYER_PED_ID(), &uVar0, -1);
				iVar27 = 0;
				while (iVar27 < iVar26)
				{
					if (!IS_PED_INJURED(uVar0[iVar27]))
					{
		...
		if (!func_100(6) && !func_100(7))
		{
			if (!IS_PED_INJURED(uLocal_143) && !IS_PED_INJURED(uLocal_144))
			{
				if (IS_PED_FLEEING(uLocal_143) || IS_PED_FLEEING(uLocal_144))
				{
					bVar28 = true;
				}
			}
	...
	if (iLocal_148 == 1)
	{
		...
		else if (iLocal_157 == GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()))
		{
			func_38(140, 3);
			func_38(139, 3);
			if (!IS_PED_INJURED(uLocal_143) && !IS_PED_INJURED(uLocal_144))
			{
				if (iLocal_160)
				{
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_143, 0);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_144, 0);
					iLocal_160 = 0;
				}
			}
		}
		else if (!IS_PED_INJURED(uLocal_143) && !IS_PED_INJURED(uLocal_144))
		{
			if (!iLocal_160)
			{
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_143, 1);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_144, 1);
				iLocal_160 = 1;
			}
		}
	}
	else if (iLocal_148 == 2)
	{
		...
		else if (iLocal_158 == GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(uLocal_143) && !IS_PED_INJURED(uLocal_144))
			{
				if (iLocal_160)
...
int func_48(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = GET_ENTITY_MODEL(func_49(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 1)));
				switch (iVar0)
				{
...
void func_50(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_51(iParam0) && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_84500[26 /*34*/].f_6) == 0)
			{
				Global_106565.f_7255[iParam0] = 1;
				_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_106565.f_7255[iParam0], 1, 1);
			}
...
{
	return (SHIFT_RIGHT(uParam0, 26) & 31 * func_59(IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
int func_77(var uParam0, vector3 vParam1, vector3 vParam4, var uParam7)
{
	int iVar0;
	var uVar1;
	var uVar4;
	...
	{
		case 0:
			uParam0->f_2 = START_SHAPE_TEST_LOS_PROBE(vParam1, vParam4, 19, uParam7, 7);
			*uParam0 = 1;
			break;
		
		case 1:
			if (GET_SHAPE_TEST_RESULT(uParam0->f_2, &(uParam0->f_9), &uVar1, &uVar4, &iVar0) == 2)
			{
				if (uParam0->f_9 == 0)
				{
					*uParam0 = 3;
			...
			else if (GET_SHAPE_TEST_RESULT(uParam0->f_2, &(uParam0->f_9), &uVar1, &uVar4, &iVar0) == 0)
			{
				*uParam0 = 3;
			}
			break;
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_95()) || Global_105612) || Global_25767) || func_94()) || func_80(8, -1)) || func_93()) || func_92()) || func_91()) || func_82()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_95()) || Global_25767) || func_94()) || func_80(8, -1)) || func_91()) || func_93()) || func_92()) || func_82()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_95()) || Global_105612) || Global_25767) || func_94()) || func_80(8, -1)) || func_91()) || func_93()) || func_92()) || func_82()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_95()) || Global_105612) || Global_25767) || func_94()) || func_80(8, -1)) || func_93()) || func_92()) || func_82()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_95() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_80(8, -1)) || func_82()) || func_90()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_95()) || Global_25767) || func_94()) || func_80(8, -1)) || func_92()) || func_91()) || func_82()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_95()) || func_92()) || Global_105612) || Global_25767) || func_94()) || Global_37584) || func_80(8, -1)) || func_91()) || func_90()) || func_82()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_95()) || Global_105612) || Global_25767) || func_94()) || func_80(8, -1)) || func_91()) || func_90()) || func_93()) || func_92()) || func_82())
						{
							return 0;
						}
						break;
...
void func_101()
{
	...
	if (bLocal_146)
	{
		...
		if ((fVar6 > 45f || Global_106527) && !DOES_ENTITY_EXIST(uLocal_143))
		{
			if (Global_106527)
			{
				Global_106527 = 0;
			...
			fVar21 = 142.6717f;
			fVar22 = 44.8785f;
			uVar23 = GET_INTERIOR_AT_COORDS(func_70(iLocal_148));
			if (IS_VALID_INTERIOR(uVar23))
			{
				_LOAD_INTERIOR(uVar23);
				while (!IS_INTERIOR_READY(uVar23))
				{
					WAIT(0);
				}
				UNPIN_INTERIOR(uVar23);
			}
			uLocal_143 = CREATE_PED(26, iLocal_141, func_103(iLocal_148 == 1, vVar7, vVar13), func_102(iLocal_148 == 1, fVar19, fVar21), 1, 1);
			uLocal_144 = CREATE_PED(26, iLocal_142, func_103(iLocal_148 == 1, vVar10, vVar16), func_102(iLocal_148 == 1, fVar20, fVar22), 1, 1);
			SET_ENTITY_AS_MISSION_ENTITY(uLocal_143, 1, 0);
			SET_ENTITY_AS_MISSION_ENTITY(uLocal_144, 1, 0);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_143, 1);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_144, 1);
			iLocal_160 = 1;
		...
		else
		{
			...
			else if (DOES_ENTITY_EXIST(uLocal_143))
			{
			}
			iLocal_145 = 0;
		}
...
int func_104()
{
	if (bLocal_146)
	{
		return ((HAS_MODEL_LOADED(iLocal_141) && HAS_MODEL_LOADED(iLocal_142)) && HAS_MODEL_LOADED(joaat("prop_dart_1")));
	}
	return 1;
}
...
void func_115()
{
	...
	iLocal_105 = 67;
	bVar0 = false;
	if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), func_70(2), 100f, 100f, 100f, 0, 0, 0))
	{
		bVar0 = true;
	}
	if (!bVar0)
