...
void __EntryFunction__()
{
	...
	iLocal_107 = -1;
	iLocal_108 = -1;
	uLocal_109 = GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 195, 1);
...
void func_1()
{
	...
	func_5();
	if (func_3(Global_105596) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Global_105596, 1))
	{
	...
	else
	{
		...
		{
			if (!IS_PED_INJURED(Global_105597) && IS_VEHICLE_DRIVEABLE(Global_105596, 0))
			{
				if (IS_PED_IN_VEHICLE(Global_105597, Global_105596, 0))
				{
					if (!IS_PED_INJURED(PLAYER_PED_ID()))
					{
						TASK_VEHICLE_MISSION_PED_TARGET(Global_105597, Global_105596, PLAYER_PED_ID(), 8, 25f, 790564, 300f, 15f, 1);
					}
				}
				else if (!IS_PED_FLEEING(Global_105597))
				{
					if (!IS_PED_INJURED(PLAYER_PED_ID()))
					{
						TASK_SMART_FLEE_PED(Global_105597, PLAYER_PED_ID(), 300f, -1, 0, 0);
					}
				}
				SET_PED_KEEP_TASK(Global_105597, 1);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_105597, 0);
			}
		}
		else if (!IS_PED_INJURED(Global_105597) && IS_VEHICLE_DRIVEABLE(Global_105596, 0))
		{
			if (IS_PED_IN_VEHICLE(Global_105597, Global_105596, 0))
			{
				if (!func_2(Global_105597, -258271821))
				{
					TASK_VEHICLE_DRIVE_WANDER(Global_105597, Global_105596, 12f, 790699);
				}
			}
			SET_PED_KEEP_TASK(Global_105597, 1);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_105597, 0);
...
void func_5()
{
	...
	if (DOES_GROUP_EXIST(func_6()))
	{
		...
		if (iVar0 > 0)
		{
			uVar2 = GET_PED_AS_GROUP_MEMBER(func_6(), 0);
			if (!IS_PED_INJURED(uVar2))
			{
				CLEAR_PED_TASKS(uVar2);
				if (!IS_ENTITY_DEAD(Global_105596, 0))
				{
					if (IS_PED_IN_VEHICLE(uVar2, Global_105596, 0))
					{
						TASK_LEAVE_VEHICLE(uVar2, Global_105596, 64);
					}
				}
			}
			if (iVar0 > 1)
			{
				uVar2 = GET_PED_AS_GROUP_MEMBER(func_6(), 1);
				if (!IS_PED_INJURED(uVar2))
				{
					CLEAR_PED_TASKS(uVar2);
					if (!IS_ENTITY_DEAD(Global_105596, 0))
...
void func_7()
{
	...
	if (IS_VEHICLE_DRIVEABLE(Global_105596, 0))
	{
		if (!IS_PED_INJURED(Global_105597))
		{
			if (IS_PED_SITTING_IN_VEHICLE(Global_105597, Global_105596))
			{
				if (!func_61())
				{
					bVar0 = true;
					if (func_55(func_56()) >= iLocal_103)
					{
						...
						else if (GET_ENTITY_SPEED(Global_105596) > 5f)
						{
							if (!func_8())
							{
								iLocal_815 = 12;
...
void func_13(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_15() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_15() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
...
int func_21(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_15() /*10778*/].f_6165.f_10, iParam0);
}
...
int func_22(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2539502[iParam0 /*3*/][func_17(iParam1)];
	...
	if (!IS_PED_INJURED(uParam0))
	{
		if (!func_51(uParam0, 0))
		{
			if (!*iParam1 == 0)
			{
				if (*iParam1 == 1)
				{
					func_49(uParam0, "TAXID_WHERE_TO", 7);
					*iParam1 = 22;
				}
				else if (*iParam1 == 2)
				{
				...
				{
					func_49(uParam0, "TAXID_BEGIN_JOURNEY", 7);
					*iParam1 = 22;
				}
				else if (*iParam1 == 4)
				{
					func_49(uParam0, "TAXID_BANTER", 24);
					*iParam1 = 22;
				}
				else if (*iParam1 == 5)
				{
					func_49(uParam0, "TAXID_ARRIVE_AT_DEST", 7);
					*iParam1 = 23;
				}
				else if (*iParam1 == 6)
				{
					func_49(uParam0, "TAXID_CLOSE_AS_POSS", 7);
					*iParam1 = 22;
				}
				else if (*iParam1 == 7)
				{
					func_49(uParam0, "TAXID_NO_MONEY", 7);
					*iParam1 = 22;
				}
				else if (*iParam1 == 9)
				{
					if (IS_PLAYER_PLAYING(PLAYER_ID()))
					{
						...
						func_49(PLAYER_PED_ID(), "TAXI_CHANGE_DEST", 7);
						if (bVar0)
						{
				...
				{
					func_49(uParam0, "TAXID_CHANGE_DEST", 7);
					*iParam1 = 22;
				}
				else if (*iParam1 == 12)
				{
					func_49(uParam0, "TAXID_RUN_AWAY", 7);
					*iParam1 = 22;
				}
				else if (*iParam1 == 13)
				{
					func_49(uParam0, "TAXID_GET_OUT_EARLY", 7);
					*iParam1 = 22;
				}
				else if (*iParam1 == 14)
				{
					func_49(uParam0, "TAXID_TRASHED", 7);
					*iParam1 = 22;
				}
				else if (*iParam1 == 15)
				{
					if (!Global_105617)
					{
						func_49(uParam0, "TAXID_AFFORD_PART_JOURNEY", 7);
						Global_105617 = 1;
					}
					*iParam1 = 22;
				}
				...
				{
					func_49(uParam0, "TAXID_TAKE_FIRST_CAB", 7);
					*iParam1 = 22;
				}
				else if (*iParam1 == 17)
				{
				...
				else if (*iParam1 == 18)
				{
					...
					else if (TIMERA() > 4000)
					{
						if (IS_PLAYER_PLAYING(PLAYER_ID()))
						{
							...
							{
								case 0:
									func_49(PLAYER_PED_ID(), "RADIO_REQ_VIBE", 7);
									break;
								
								case 1:
									func_49(PLAYER_PED_ID(), "RADIO_REQ_LRR", 7);
									break;
								
								case 2:
									func_49(PLAYER_PED_ID(), "RADIO_REQ_JNR", 7);
									break;
								
								case 3:
									func_49(PLAYER_PED_ID(), "RADIO_REQ_MASSIVEB", 7);
									break;
								
								case 4:
									func_49(PLAYER_PED_ID(), "RADIO_REQ_K109", 7);
									break;
								
								case 5:
									func_49(PLAYER_PED_ID(), "RADIO_REQ_WKTT", 7);
									break;
								
								case 6:
									func_49(PLAYER_PED_ID(), "RADIO_REQ_LCHC", 7);
									break;
								
								case 7:
									func_49(PLAYER_PED_ID(), "RADIO_REQ_JOURNEY", 7);
									break;
								
								case 8:
									func_49(PLAYER_PED_ID(), "RADIO_REQ_FUSION", 7);
									break;
								
								case 9:
									func_49(PLAYER_PED_ID(), "RADIO_REQ_BEAT", 7);
									break;
								
								case 10:
									func_49(PLAYER_PED_ID(), "RADIO_REQ_BROKER", 7);
									break;
								
								case 11:
									func_49(PLAYER_PED_ID(), "RADIO_REQ_VLADIVOSTOK", 7);
									break;
								
								case 12:
									func_49(PLAYER_PED_ID(), "RADIO_REQ_PLR", 7);
									break;
								
								case 13:
									func_49(PLAYER_PED_ID(), "RADIO_REQ_SANJUAN", 7);
									break;
								
								case 14:
									func_49(PLAYER_PED_ID(), "RADIO_REQ_FRANCOIS", 7);
									break;
								
								case 15:
									func_49(PLAYER_PED_ID(), "RADIO_REQ_CLASSICS", 7);
									break;
							}
							if (bVar0)
							{
				...
				else if (*iParam1 == 20)
				{
					if (IS_PLAYER_PLAYING(PLAYER_ID()))
					{
						...
						func_49(PLAYER_PED_ID(), "TAXI_STEP_ON_IT", 7);
						if (bVar0)
						{
							STOP_PED_SPEAKING(PLAYER_PED_ID(), 1);
						}
				...
				{
					func_49(uParam0, "TAXID_SPEED_UP", 7);
					*iParam1 = 22;
				}
				else if (*iParam1 == 23)
				{
					if (IS_PLAYER_PLAYING(PLAYER_ID()))
					{
						...
						func_49(PLAYER_PED_ID(), "THANKS", 7);
						if (bVar0)
						{
							STOP_PED_SPEAKING(PLAYER_PED_ID(), 1);
						}
...
char* func_47()
{
	...
	StringCopy(&cVar0, GET_NAME_OF_ZONE(func_48(vLocal_43.x)), 32);
...
void func_49(var uParam0, char* sParam1, int iParam2)
{
	_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_50(iParam2), 1);
}
	...
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (DOES_GROUP_EXIST(func_6()))
		{
			...
			if (iVar1 > 0)
			{
				...
				while (iVar2 < iVar1)
				{
					uVar0 = GET_PED_AS_GROUP_MEMBER(func_6(), iVar2);
					if (!IS_PED_INJURED(uVar0))
					{
						if (IS_AMBIENT_SPEECH_PLAYING(uVar0))
						{
...
void func_57()
{
	...
	{
		if (func_60(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
	...
	if (func_224())
	{
		...
		if (iLocal_938 != 4)
		{
			...
			if (iLocal_938 != 0)
			{
				if (func_208())
				{
					if (HAS_SCALEFORM_MOVIE_LOADED(uLocal_113))
					{
						func_184();
						iLocal_60 = 1;
					}
		...
		switch (iLocal_938)
		{
			case 0:
				if (!IS_PED_INJURED(Global_105597) && IS_VEHICLE_DRIVEABLE(Global_105596, 0))
				{
					if (IS_PED_SITTING_IN_VEHICLE(Global_105597, Global_105596))
					{
						if (!IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_941, "leanover_enter", 3) && !IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_941, "leanover_idle", 3))
						{
							if (!func_2(Global_105597, -2118855366))
							{
								TASK_VEHICLE_TEMP_ACTION(Global_105597, Global_105596, 1, 1000000);
							}
						}
					}
				}
				if (func_174())
				{
					if (func_173() && !IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID()))
					{
						func_184();
						iLocal_815 = 1;
						iLocal_937 = 0;
...
void func_64()
{
	...
	if (!func_217())
	{
		if (HAS_SCALEFORM_MOVIE_LOADED(uLocal_114))
		{
			if (iLocal_938 != 0)
			{
				uVar0 = GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 218, 1);
				if (!ARE_STRINGS_EQUAL(uLocal_109, uVar0))
				{
					uLocal_109 = uVar0;
					iLocal_60 = 1;
				}
		...
		{
			uLocal_114 = REQUEST_SCALEFORM_MOVIE("instructional_buttons");
		}
	}
	else
	{
		SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_114);
		iLocal_60 = 1;
	}
}
			...
			while (iVar0 < uParam2->f_680)
			{
				if (IS_BIT_SET(uParam2->f_676, iVar0))
				{
					...
					if (!IS_BIT_SET(uParam2->f_677, iVar0))
					{
						...
						func_69(GET_CONTROL_INSTRUCTIONAL_BUTTON(uVar1, uVar2, 1));
						if (iVar3 < 359)
						{
							func_69(GET_CONTROL_INSTRUCTIONAL_BUTTON(uVar1, iVar3, 1));
						}
					}
					else
					{
						...
						func_69(_0x80C2FD58D720C801(uVar4, uVar5, 1));
					}
...
int func_74()
{
	...
	if (DOES_CAM_EXIST(uLocal_70))
	{
		if (IS_CAM_ACTIVE(uLocal_70))
		{
			return 0;
		}
	}
	...
	switch (iLocal_940)
	{
		...
		case 1:
			if (IS_SCREEN_FADED_OUT() && IS_AUDIO_SCENE_ACTIVE("FADE_OUT_WORLD_250MS_SCENE"))
			{
				if (IS_VEHICLE_DRIVEABLE(Global_105596, 0))
				{
					SET_VEHICLE_RADIO_ENABLED(Global_105596, 0);
				}
				CLEAR_PRINTS();
				...
				if (DOES_ENTITY_EXIST(uLocal_111))
				{
					DELETE_OBJECT(&uLocal_111);
					SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_110);
				}
				if (IS_CAM_ACTIVE(uLocal_70))
				{
					SET_PARTICLE_FX_CAM_INSIDE_VEHICLE(0);
					Global_105613 = 0;
					SET_CAM_ACTIVE(uLocal_70, 0);
					RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
		...
		case 3:
			if (Global_71606 == -1)
			{
				...
				func_116();
				func_115();
				CLEAR_AREA(Global_105603, 5f, 1, 0, 0, 0);
				func_111(1097859072);
				if (!IS_PED_INJURED(Global_105597) && IS_VEHICLE_DRIVEABLE(Global_105596, 0))
				{
					SET_ENTITY_COORDS(Global_105596, Global_105603, 1, 0, 0, 1);
					SET_ENTITY_HEADING(Global_105596, Global_105609);
					FREEZE_ENTITY_POSITION(Global_105596, 1);
				}
				SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
				SET_GAMEPLAY_CAM_RELATIVE_PITCH(0, 1065353216);
				NEW_LOAD_SCENE_STOP();
				CLEAR_AREA(Global_105603, 5000f, 1, 0, 0, 0);
				CLEAR_AREA_OF_OBJECTS(Global_105603, 5000f, 0);
				CLEAR_AREA_OF_PROJECTILES(Global_105603, 30f, 0);
				REMOVE_PARTICLE_FX_IN_RANGE(Global_105603, 5000f);
				REMOVE_DECALS_IN_RANGE(Global_105603, 5000f);
				if (Global_90634 != -1)
				{
		...
		case 4:
			if (NEW_LOAD_SCENE_START_SPHERE(Global_105603, 4500f, 0))
			{
				iLocal_59 = 1;
				iLocal_940 = 5;
			}
		...
		case 6:
			...
			if (iLocal_812 != -1)
			{
				...
				if (bVar1)
				{
					if (((func_56() == 0 && !IS_BIT_SET(Global_84500[iLocal_812 /*34*/].f_15, 8)) || (func_56() == 1 && !IS_BIT_SET(Global_84500[iLocal_812 /*34*/].f_15, 9))) || (func_56() == 2 && !IS_BIT_SET(Global_84500[iLocal_812 /*34*/].f_15, 10)))
					{
						bVar1 = false;
					}
				}
				...
				if (bVar1)
				{
					ADVANCE_CLOCK_TIME_TO(Global_84500[iLocal_812 /*34*/].f_13, 0, 0);
				}
			}
		...
		case 7:
			...
			if (bVar0)
			{
				...
				{
					iLocal_69 = 0;
					GET_GROUND_Z_FOR_3D_COORD(Global_105603 + Vector(100f, 0f, 0f), &fVar2, 0, 0);
				...
				if (!IS_PED_INJURED(Global_105597) && IS_VEHICLE_DRIVEABLE(Global_105596, 0))
				{
					FREEZE_ENTITY_POSITION(Global_105596, 0);
					SET_ENTITY_HEADING(Global_105596, Global_105609);
					SET_ENTITY_COORDS(Global_105596, Global_105603, 1, 0, 0, 1);
					SET_VEHICLE_ON_GROUND_PROPERLY(Global_105596, 1084227584);
					TASK_VEHICLE_TEMP_ACTION(Global_105597, Global_105596, 24, 5000);
				}
				iLocal_91 = GET_GAME_TIMER();
				iLocal_940 = 8;
			}
		...
		case 8:
			if (func_158(iLocal_91, 500))
			{
				...
				if (IS_VEHICLE_DRIVEABLE(Global_105596, 0))
				{
					SET_VEHICLE_RADIO_ENABLED(Global_105596, 1);
				}
				if (!func_80())
				{
		...
		case 9:
			if (IS_SCREEN_FADED_IN() || func_80())
			{
				...
				if (!IS_PED_INJURED(PLAYER_PED_ID()))
				{
					if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Global_105596, 1))
					{
						TASK_LEAVE_ANY_VEHICLE(PLAYER_PED_ID(), 0, 0);
					}
				}
...
void func_81()
{
	...
	switch (iLocal_813)
	{
		case 92:
			vVar0 = { func_83(229, 0) };
			fVar3 = GET_DISTANCE_BETWEEN_COORDS(Global_105603, vVar0, 1);
			if (fVar3 < 100f)
			{
				vVar0 = { func_82(Global_105603 - vVar0) };
				vVar0 = { (Global_105603 + (vVar0.x * IntToFloat((100 - ROUND(fVar3))))), (Global_105603.f_1 + (vVar0.y * IntToFloat((100 - ROUND(fVar3))))), Global_105603.f_2 };
				GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(vVar0, &Global_105603, &Global_105609, 1, 1077936128, 0);
				SET_ENTITY_COORDS(Global_105596, Global_105603, 1, 0, 0, 1);
				SET_ENTITY_HEADING(Global_105596, Global_105609);
			}
			break;
...
int func_93(vector3 vParam0)
{
	...
	if (func_94(0, 4))
	{
		...
		while (iVar1 <= 72)
		{
			fVar2 = VDIST2(func_83(iVar1, 0), vParam0);
			if (fVar2 <= 1225f)
			{
				iVar0++;
			}
...
void func_111(int iParam0)
{
	...
	{
		bVar1 = true;
		if (func_112(&iVar0, vVar3, iParam0))
		{
			bVar1 = false;
			if (GET_NTH_CLOSEST_VEHICLE_NODE(Global_105603, iVar2, &vVar3, 1, 1077936128, 0))
			{
				iVar2++;
			}
		}
	}
	if (VDIST2(vVar3, Global_105603) > 2f)
	{
		GET_SAFE_COORD_FOR_PED(vVar3, 0, &Global_105603, 0);
	}
}

int func_112(int iParam0, vector3 vParam1, var uParam4)
{
	int iVar0[5];
	int iVar6;
	...
	while (iVar6 < iVar0)
	{
		*iParam0 = GET_CLOSEST_VEHICLE(vParam1, uParam4, iVar0[iVar6], 67590);
		if (*iParam0 != 0)
		{
			return 1;
		}
...
void func_116()
{
	...
	fVar0 = func_119(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), Global_105603);
	if (bLocal_66)
	{
...
void func_120()
{
	...
	fVar0 = (((func_119(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), Global_105603) / 50f) * fLocal_75) * 2.4f);
...
void func_121()
{
	iLocal_105 = (iLocal_105 + ROUND((GET_FRAME_TIME() * 1000f)));
	if (iLocal_105 > 5000)
	{
		fLocal_84 = (fLocal_84 + fLocal_75);
		iLocal_105 = 0;
	}
	if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), vLocal_961, 0) > 50f)
	{
		fLocal_84 = (fLocal_84 + fLocal_75);
		iLocal_105 = 0;
		vLocal_961 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 0) };
	}
	iLocal_103 = CEIL(fLocal_84);
	if (iLocal_103 != iLocal_104)
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_113, "SET_TAXI_PRICE");
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_103);
		END_SCALEFORM_MOVIE_METHOD();
		fLocal_85 = VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), Global_105603);
...
void func_122()
{
	...
	if (!func_40(14))
	{
		uVar1 = CALCULATE_TRAVEL_DISTANCE_BETWEEN_POINTS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), Global_105603);
		STAT_INCREMENT(iVar0, uVar1);
	}
}
...
{
	NEW_LOAD_SCENE_STOP();
	if (_0x07C313F94746702C(Global_105275.f_218))
	{
		_0x1EE7D8DF4425F053(Global_105275.f_218);
	}
}
	...
	if (DOES_BLIP_EXIST(*iParam0))
	{
		switch (iLocal_937)
		{
			case 0:
				...
				if (DOES_BLIP_EXIST(Global_105601) && *iParam0 == Global_105601)
				{
				...
				{
					if (func_142(vLocal_949, uParam1, uParam2))
					{
						vVar0 = { vLocal_949 - *uParam1 };
						vVar0.z = 0f;
						fLocal_74 = VMAG(vVar0);
			...
			case 1:
				if (func_131(vLocal_949, uParam1, uParam2, 1))
				{
					vVar0 = { vLocal_949 - *uParam1 };
					vVar0.z = 0f;
					fLocal_74 = VMAG(vVar0);
			...
			case 2:
				if (DOES_ENTITY_EXIST(Global_105596))
				{
					if (func_125(&Global_105596, GET_ENTITY_COORDS(Global_105596, 0), vLocal_949, uParam1, uParam2, &iLocal_90, 1000))
					{
						iLocal_937 = 3;
						return 1;
					}
...
int func_125(var uParam0, vector3 vParam1, vector3 vParam4, var uParam7, var uParam8, int iParam9, int iParam10)
{
	float fVar0;
	float fVar1;
	vector3 vVar2;
	...
	if (func_127(vLocal_952, vLocal_955))
	{
		while (!bVar19 && *iParam9 < iVar24)
		{
			...
			if (GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(vParam4, *iParam9, uParam7, uParam8, &iVar12, iVar20, fVar0, fVar1))
			{
				uVar18 = GET_NTH_CLOSEST_VEHICLE_NODE_ID(*uParam7, 1, iVar20, 1077936128, 0);
				if (IS_VEHICLE_NODE_ID_VALID(uVar18))
				{
					if (GET_CLOSEST_ROAD(*uParam7, 1f, 1, &uVar8, &uVar5, &iVar14, &iVar13, &fVar16, iVar21))
					{
						...
						else
						{
							...
							if (GET_VEHICLE_NODE_PROPERTIES(*uParam7, &uVar27, &uVar26))
							{
								if (!uVar26 & 64 == 0)
								{
						...
						{
							*uParam7 = { _GET_OBJECT_OFFSET_FROM_COORDS(*uParam7, *uParam8, fVar15, 0f, 0f) };
							if (IS_VEHICLE_DRIVEABLE(*uParam0, 0))
							{
								iVar11 = *uParam0;
							}
							if (!IS_POINT_OBSCURED_BY_A_MISSION_ENTITY(*uParam7, 3f, 3f, 3f, iVar11))
							{
			...
			*iParam9++;
			if (*iParam9 >= iVar25)
			{
				*uParam7 = { vParam4 };
				...
				{
					fVar17 = 1f;
					fVar17 = _0x3599D741C9AC6310((*uParam7 - 2f), (uParam7->f_1 - 2f), (*uParam7 + 2f), (uParam7->f_1 + 2f));
					if (fVar17 > 1f)
					{
						iLocal_69 = 1;
						uParam7->f_2 = fVar17;
...
int func_126(vector3 vParam0, vector3 vParam3)
{
	float fVar0;
	float fVar1;
...
int func_131(vector3 vParam0, var uParam3, var uParam4, int iParam5)
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4[6];
...
bool func_132(vector3 vParam0, vector3 vParam3, float fParam6)
{
	return VDIST2(vParam0, vParam3) <= (fParam6 * fParam6);
}

var func_133(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)
{
...
int func_137(vector3 vParam0, int iParam3, int iParam4, bool bParam5)
{
	vector3 vVar0[15];
	vector3 vVar46[15];
	float fVar92[15];
...
{
	return VDIST2(vParam1, func_140(iParam0)) < func_139(iParam0);
}
...
int func_141(vector3 vParam0, vector3 vParam3, vector3 vParam6)
{
...
int func_142(vector3 vParam0, var uParam3, var uParam4)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_144(int iParam0, vector3 vParam1)
{
	switch (iParam0)
	{
		case 76:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -1157.595f, -2726.636f, 12.94464f, -1110.794f, -2679.33f, 22.94466f, 26f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 70:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -1908.065f, 4432.693f, 51.3842f, -1962.212f, 4473.8f, 22.93989f, 70f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 71:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -541.8311f, 2050.599f, 186.3904f, -499.787f, 1968.325f, 228.0183f, 70f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 73:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -179.8588f, 4216.167f, 30.26505f, -246.32f, 4226.653f, 53.77886f, 70f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 74:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 1634.122f, 3858.049f, 28.33912f, 1573.259f, 3800.442f, 48.35476f, 70f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 75:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 2057.873f, 2059.198f, 63.88074f, 1999.045f, 2190.544f, 122.2642f, 110f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 72:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 3028.084f, 2768.167f, 57.72984f, 2944.284f, 2772.836f, 30.23068f, 85f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 106:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 2097.951f, 4820.308f, 55.48169f, 2151.254f, 4726.398f, 31.0732f, 120f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 125:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -763.5086f, -1297.98f, 2.000373f, -864.1372f, -1278.007f, 24.15038f, 85f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 126:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 1137.022f, 89.06853f, 74.89022f, 1267.821f, 292.0106f, 102.9904f, 195f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 127:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 2512.305f, 1519.462f, 28.55504f, 2380.374f, 1521.587f, 58.80984f, 90f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 128:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -193.5583f, 6533.439f, -1.902109f, -299.2512f, 6645.049f, 20.45973f, 120f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 131:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -1171.147f, 4647.89f, 203.7937f, -1280.149f, 4457.597f, 5.653551f, 120f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 132:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -687.974f, 4499.52f, 114.781f, -826.0081f, 4496.864f, 49.88359f, 140f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 134:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -1364.701f, 4490.626f, 49.52477f, -1367.169f, 4340.34f, -1.682158f, 100f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 135:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 2566.189f, 5007.007f, 97.36896f, 2491.714f, 4923.261f, 30.43494f, 80f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 136:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 1009.917f, -163.4684f, 102.1028f, 1113.474f, -221.3295f, 49.8745f, 90f, 0, 1))
			{
				return 1;
			}
			break;
...
int func_146(int iParam0, vector3 vParam1)
{
	switch (iParam0)
	{
		...
		case 11:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 1882.79f, 4725.034f, 34.74373f, 1701.497f, 4677.47f, 47.89289f, 159.5f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 21:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -1903.322f, -401.2384f, 19.23456f, -1844.879f, -445.7261f, 73.56197f, 115f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 22:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 794.2453f, 1277.443f, -100f, 833.8215f, 1277.108f, 400f, 19f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 23:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -1015.526f, 6287.513f, -10.94449f, -761.3104f, 5895.014f, 45.33727f, 167.75f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 24:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -72.13491f, -1267.587f, 27.68361f, -72.18015f, -1256.712f, 31f, 30f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 33:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -21.12362f, 4518.907f, 119.7836f, 43.13283f, 4538.929f, 72.58955f, 48f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 39:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -1088.425f, 372.0723f, 62.75896f, -967.03f, 363.5976f, 101.3483f, 75f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 43:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -91.45676f, -1296.975f, 26.15437f, 40.67288f, -1297.459f, 58.29368f, 110f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 47:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -78.38029f, 285.5254f, 102.6286f, -51.1546f, 357.5217f, 122.0617f, 40f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 49:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 420.5196f, 116.2892f, 77.57532f, 212.2937f, 193.6794f, 131.8767f, 250f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 50:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 1140.158f, -540.9644f, 49.99944f, 972.3716f, -535.1002f, 85.64397f, 168.25f, 0, 1))
			{
				return 1;
			}
			break;
...
int func_148(int iParam0, vector3 vParam1)
{
	switch (iParam0)
	{
		case 3:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -1535.754f, -922.101f, 4.122119f, -1487.87f, -961.3929f, 26.71922f, 50f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 8:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 53.12898f, -463.9999f, 36.9208f, 99.3761f, -329.3476f, 118.0454f, 125f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 38:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 1420.347f, -2036.558f, 47.36072f, 1341.11f, -2103.844f, 72.32651f, 55f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 48:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -2306.98f, 435.3038f, 171.4666f, -2303.291f, 366.3199f, 179.6018f, 65.5f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 45:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 1324.172f, 1110.748f, 99.65493f, 1523.097f, 1110.473f, 132.8859f, 170f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 60:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, -995.978f, -517.4324f, 11.37763f, -1060.725f, -547.5588f, 65.33043f, 35.75f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 86:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 682.6544f, -968.7439f, 19.97575f, 762.8684f, -964.4064f, 43.03712f, 53f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 87:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 148.8361f, -3029.146f, 4.277727f, 148.1396f, -3342.344f, 22.90379f, 97.75f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 78:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 446.8174f, -1691.708f, 23.28233f, 288.5565f, -1552.352f, 108.3117f, 155f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 79:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 910.9382f, -1749.91f, 14.50614f, 921.7415f, -1455.248f, 99.67125f, 210f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 83:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 2657.302f, 2974.529f, 34.53447f, 2591.657f, 2880.223f, 68.08156f, 78.75f, 0, 1))
			{
				return 1;
			}
			break;
		...
		case 84:
			...
			if (IS_POINT_IN_ANGLED_AREA(vParam1, 83.32325f, -1312.172f, 23.33694f, 148.383f, -1273.553f, 49.46651f, 65f, 0, 1))
			{
				return 1;
			}
			break;
...
int func_152(var uParam0, int iParam1, float fParam2)
{
	...
	{
		*iParam1 = iVar6;
		if (IS_BIT_SET(Global_106565.f_18568[*iParam1 /*6*/], 0) && !IS_BIT_SET(Global_106565.f_18568[*iParam1 /*6*/], 3))
		{
			func_97(*iParam1, &Var7);
			if (IS_BIT_SET(Var7.f_26, func_153()))
			{
				vVar3 = { Var7.f_6 };
				if (uParam0->f_2 == 1f)
				{
...
int func_154(var uParam0, int iParam1, float fParam2)
{
	...
	while (iVar6 < 8)
	{
		if (Global_90645[iVar6 /*17*/])
		{
			...
			{
				if (DOES_BLIP_EXIST(Global_26140[Global_90645[iVar6 /*17*/].f_9 /*23*/].f_19))
				{
					vVar3 = { GET_BLIP_COORDS(Global_26140[Global_90645[iVar6 /*17*/].f_9 /*23*/].f_19) };
					if (uParam0->f_2 == 1f)
					{
						vVar3.z = 1f;
					}
	...
	if (DOES_GROUP_EXIST(func_6()))
	{
		...
		if (iVar0 > 0)
		{
			if (iVar0 > 1)
			{
				...
				if (!IS_PED_INJURED(uVar2))
				{
					if (!IS_PED_SITTING_IN_VEHICLE(uVar2, Global_105596))
					{
						iVar3 = 0;
						if (!IS_VEHICLE_SEAT_FREE(Global_105596, iVar3, 0))
						{
							iVar3 = func_157(&Global_105596);
							if (IS_VEHICLE_SEAT_FREE(Global_105596, iVar3, 0))
							{
								CLEAR_PED_TASKS(uVar2);
								SET_PED_INTO_VEHICLE(uVar2, Global_105596, iVar3);
							}
						}
						else
						{
...
void func_166()
{
	...
	if (!IS_PED_INJURED(Global_105597) && IS_VEHICLE_DRIVEABLE(Global_105596, 0))
	{
		if (IS_PED_SITTING_IN_VEHICLE(Global_105597, Global_105596))
		{
			if (IS_VEHICLE_STOPPED(Global_105596))
			{
				if (!IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_941, "leanover_enter", 3) && !IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_941, "leanover_idle", 3))
				{
					if (!func_2(Global_105597, -2118855366))
			...
			{
				vVar0 = { GET_ENTITY_COORDS(Global_105596, 1) };
				uVar3 = GET_ENTITY_HEADING(Global_105596);
				TASK_VEHICLE_PARK(Global_105597, Global_105596, vVar0, uVar3, 3, 60f, 0);
			}
		}
	}
}
		...
		if (bLocal_63)
		{
			...
			if (IS_VEHICLE_DRIVEABLE(Global_105596, 0))
			{
				if (!IS_PED_INJURED(Global_105597))
				{
					if (func_169())
					{
						if (GET_ENTITY_SPEED(Global_105596) < 2f)
						{
							if (!IS_PED_INJURED(PLAYER_PED_ID()))
							{
								if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Global_105596, 1))
					...
					else if (IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_941, "leanover_enter", 3) || IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_941, "leanover_idle", 3))
					{
						if (IS_PED_HEADTRACKING_PED(Global_105597, PLAYER_PED_ID()))
						{
							TASK_CLEAR_LOOK_AT(Global_105597);
						}
						TASK_PLAY_ANIM(Global_105597, &cLocal_941, "leanover_exit", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else if (IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_941, "leanover_exit", 3))
					{
						SET_ENTITY_ANIM_SPEED(Global_105597, &cLocal_941, "leanover_exit", 1.2f);
					...
					else if (!func_2(Global_105597, 242628503))
					{
						...
						else
						{
							...
							CLEAR_PED_TASKS(Global_105597);
							TASK_CLEAR_LOOK_AT(Global_105597);
							SET_DRIVER_ABILITY(Global_105597, 0.5f);
							OPEN_SEQUENCE_TASK(&uLocal_802);
							TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(0, Global_105596, Global_105603, fVar1, iVar0, 45f);
							TASK_VEHICLE_PARK(0, Global_105596, Global_105603, Global_105609, iLocal_112, 60f, 1);
							CLOSE_SEQUENCE_TASK(uLocal_802);
							TASK_PERFORM_SEQUENCE(Global_105597, uLocal_802);
							CLEAR_SEQUENCE_TASK(&uLocal_802);
						}
					}
				}
			}
...
int func_168(int iParam0, int iParam1)
{
	...
	if (!IS_PED_INJURED(iVar3))
	{
		...
		bVar4 = true;
		iVar2 = GET_PED_IN_VEHICLE_SEAT(Global_105596, iVar6, 0);
		...
		if (GET_PED_CONFIG_FLAG(iVar3, 167, 0))
		{
			bVar4 = false;
		}
		...
		if (bVar4)
		{
			TASK_ENTER_VEHICLE(iVar3, Global_105596, 20000, iVar6, 2f, 9437185, 0);
			bVar5 = true;
		}
	}
	if (iVar0 > 1)
...
int func_169()
{
	if ((IS_ENTITY_AT_COORD(Global_105596, Global_105603, 45f, 45f, 20f, 0, 1, 0) || iLocal_58) || iLocal_938 == 4)
	{
		iLocal_58 = 1;
		if (GET_SCRIPT_TASK_STATUS(Global_105597, 242628503) == 7)
		{
			return 1;
		}
	}
	...
	if (DOES_GROUP_EXIST(func_6()))
	{
		...
		if (iVar0 > 0)
		{
			...
			if (!IS_PED_INJURED(iVar2))
			{
				...
				bVar4 = true;
				iVar3 = GET_PED_IN_VEHICLE_SEAT(*uParam0, iVar5, 0);
				...
				if (GET_PED_CONFIG_FLAG(iVar2, 167, 0))
				{
					bVar4 = false;
				}
...
int func_172()
{
	if (!IS_PED_INJURED(Global_105597) && IS_VEHICLE_DRIVEABLE(Global_105596, 0))
	{
		if (IS_PED_SITTING_IN_VEHICLE(Global_105597, Global_105596))
		{
			REQUEST_ANIM_DICT(&cLocal_941);
			if (HAS_ANIM_DICT_LOADED(&cLocal_941))
			{
				if (IS_PED_HEADTRACKING_PED(Global_105597, PLAYER_PED_ID()))
				{
					TASK_CLEAR_LOOK_AT(Global_105597);
				...
				OPEN_SEQUENCE_TASK(&uLocal_802);
				TASK_PLAY_ANIM(0, &cLocal_941, "leanover_enter", 4f, -8f, -1, 0, 0, 0, 0, 0);
				TASK_PLAY_ANIM(0, &cLocal_941, "leanover_idle", 4f, -8f, -1, 1, 0, 0, 0, 0);
				CLOSE_SEQUENCE_TASK(uLocal_802);
				TASK_PERFORM_SEQUENCE(Global_105597, uLocal_802);
				CLEAR_SEQUENCE_TASK(&uLocal_802);
				return 1;
...
int func_173()
{
	...
	if (DOES_ENTITY_EXIST(Global_105596))
	{
		if (IS_VEHICLE_DRIVEABLE(Global_105596, 0))
		{
			uLocal_111 = CREATE_OBJECT(iLocal_110, GET_ENTITY_COORDS(Global_105596, 1), 1, 1, 0);
			ATTACH_ENTITY_TO_ENTITY(uLocal_111, Global_105596, GET_ENTITY_BONE_INDEX_BY_NAME(Global_105596, "Chassis"), vLocal_973, vLocal_976, 0, 0, 0, 0, 2, 1);
			SET_TAXI_LIGHTS(Global_105596, 0);
			if (!IS_NAMED_RENDERTARGET_REGISTERED("taxi"))
			{
				REGISTER_NAMED_RENDERTARGET("taxi", 0);
				LINK_NAMED_RENDERTARGET(GET_ENTITY_MODEL(uLocal_111));
			}
			uLocal_95 = GET_NAMED_RENDERTARGET_RENDER_ID("taxi");
		}
	}
	return 0;
}
...
int func_174()
{
	REQUEST_MODEL(iLocal_110);
	uLocal_113 = REQUEST_SCALEFORM_MOVIE("taxi_display");
	uLocal_114 = REQUEST_SCALEFORM_MOVIE("instructional_buttons");
	REQUEST_ANIM_DICT(&cLocal_941);
	if (((HAS_MODEL_LOADED(iLocal_110) && HAS_SCALEFORM_MOVIE_LOADED(uLocal_113)) && HAS_SCALEFORM_MOVIE_LOADED(uLocal_114)) && HAS_ANIM_DICT_LOADED(&cLocal_941))
	{
		return 1;
	}
	return 0;
...
void func_175()
{
	...
	if (!DOES_CAM_EXIST(uLocal_70))
	{
		...
		{
			uLocal_70 = CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 0);
			ATTACH_CAM_TO_ENTITY(uLocal_70, Global_105596, vLocal_967, 1);
			func_179();
			_0x661B5C8654ADD825(uLocal_70, 1);
		}
	}
	...
	else if (IS_CAM_ACTIVE(uLocal_70))
	{
		SET_CAM_ACTIVE(uLocal_70, 0);
...
void func_176()
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_113, "HIGHLIGHT_DESTINATION");
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_94);
	END_SCALEFORM_MOVIE_METHOD();
}
...
void func_177()
{
	...
	if (DOES_BLIP_EXIST(vLocal_43.x))
	{
		vVar0 = { GET_BLIP_COORDS(vLocal_43.x) };
		if (DOES_CAM_EXIST(uLocal_70) && IS_CAM_ACTIVE(uLocal_70))
		{
...
void func_179()
{
	if (DOES_CAM_EXIST(uLocal_70))
	{
		func_180(Global_105596, &uLocal_70, vLocal_970);
		SET_CAM_FOV(uLocal_70, fLocal_76);
		SET_CAM_NEAR_CLIP(uLocal_70, 0.01f);
		_0xA2767257A320FC82(uLocal_70, 1);
		unk_0xA7B62842BD58B5D2(1);
	}
}

void func_180(var uParam0, var uParam1, vector3 vParam2)
{
	vector3 vVar0;
	var uVar3;
	var uVar4;
	...
	if (!IS_ENTITY_DEAD(uParam0, 0))
	{
		if (DOES_CAM_EXIST(*uParam1))
		{
			...
			uVar5 = vVar0.y;
			vVar6 = { func_82(GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_105596, vParam2) - GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_105596, vLocal_967)) };
			func_181(vVar6, &uVar3, &uVar4, 1);
...
void func_184()
{
	...
	iVar0 = 0;
	func_190();
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_113, "CLEAR_TAXI_DISPLAY");
	END_SCALEFORM_MOVIE_METHOD();
	iVar0 = 0;
	while (iVar0 < iLocal_93)
	{
		if (!DOES_BLIP_EXIST(vLocal_816[iVar0 /*3*/]))
		{
		}
		else if (func_189(vLocal_816[iVar0 /*3*/]) == -1)
		{
		}
		else if (func_129(GET_BLIP_COORDS(vLocal_816[iVar0 /*3*/]), 0f, 0f, 0f, 1056964608, 0))
		{
		}
		else
		{
			BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_113, "ADD_TAXI_DESTINATION");
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar0);
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(GET_BLIP_SPRITE(vLocal_816[iVar0 /*3*/]));
			GET_HUD_COLOUR(GET_BLIP_HUD_COLOUR(vLocal_816[iVar0 /*3*/]), &uVar1, &uVar2, &uVar3, &uVar4);
			...
			if (iVar8 == -1)
			{
				...
				ADD_TEXT_COMPONENT_SUBSTRING_BLIP_NAME(vLocal_816[iVar0 /*3*/]);
				END_TEXT_COMMAND_SCALEFORM_STRING();
			}
			else
			{
				BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
				ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_185(iVar8));
				END_TEXT_COMMAND_SCALEFORM_STRING();
			}
			if (GET_BLIP_INFO_ID_TYPE(vLocal_816[iVar0 /*3*/]) == 2)
			{
				if (!IS_PED_INJURED(GET_PED_INDEX_FROM_ENTITY_INDEX(GET_BLIP_INFO_ID_ENTITY_INDEX(vLocal_816[iVar0 /*3*/]))))
				{
					vVar5 = { GET_ENTITY_COORDS(GET_PED_INDEX_FROM_ENTITY_INDEX(GET_BLIP_INFO_ID_ENTITY_INDEX(vLocal_816[iVar0 /*3*/])), 1) };
				}
			}
			else if (GET_BLIP_INFO_ID_TYPE(vLocal_816[iVar0 /*3*/]) == 1)
			{
				if (IS_VEHICLE_DRIVEABLE(GET_BLIP_INFO_ID_ENTITY_INDEX(vLocal_816[iVar0 /*3*/]), 0))
				{
					vVar5 = { GET_ENTITY_COORDS(GET_BLIP_INFO_ID_ENTITY_INDEX(vLocal_816[iVar0 /*3*/]), 1) };
				}
			}
			else
			{
				vVar5 = { GET_BLIP_COORDS(vLocal_816[iVar0 /*3*/]) };
			}
			func_68(GET_NAME_OF_ZONE(vVar5));
			if (vLocal_816[iVar0 /*3*/].f_2 == 0)
			{
				if (vLocal_816[iVar0 /*3*/].f_1 != 0)
				{
					BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRTNM1");
					ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL_HASH_KEY(vLocal_816[iVar0 /*3*/].f_1);
					END_TEXT_COMMAND_SCALEFORM_STRING();
				}
			}
			else
			{
				...
				ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL_HASH_KEY(vLocal_816[iVar0 /*3*/].f_1);
				ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL_HASH_KEY(vLocal_816[iVar0 /*3*/].f_2);
				END_TEXT_COMMAND_SCALEFORM_STRING();
			}
			END_SCALEFORM_MOVIE_METHOD();
			if (bLocal_62)
	...
	if (bLocal_62)
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_113, "SHOW_TAXI_DESTINATION");
		END_SCALEFORM_MOVIE_METHOD();
		BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_113, "HIGHLIGHT_DESTINATION");
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_94);
		END_SCALEFORM_MOVIE_METHOD();
...
void func_190()
{
	...
	if (GET_MISSION_FLAG())
	{
		if (iLocal_96 == 0)
		{
			if (DOES_BLIP_EXIST(Global_105600))
			{
				iVar0 = 0;
				while (iVar0 < 40)
				{
...
int func_191()
{
	...
	iVar0 = 0;
	iVar1 = GET_FIRST_BLIP_INFO_ID(iLocal_46);
	while (DOES_BLIP_EXIST(iVar1))
	{
		...
		iVar1 = GET_NEXT_BLIP_INFO_ID(iLocal_46);
	}
	iVar1 = GET_FIRST_BLIP_INFO_ID(iLocal_47);
	while (DOES_BLIP_EXIST(iVar1))
	{
		if (func_193(iVar1))
		{
		...
		iVar1 = GET_NEXT_BLIP_INFO_ID(iLocal_47);
	}
	return iVar0;
}
...
void func_194(int iParam0, bool bParam1)
{
	...
	iVar4 = GET_FIRST_BLIP_INFO_ID(iParam0);
	iVar5 = 20;
	while (DOES_BLIP_EXIST(iVar4))
	{
		if (iLocal_100 >= iVar5)
		{
			WAIT(0);
			...
			if (func_193(iVar4))
			{
				if (func_206(iVar4))
				{
					if (!func_204(&iVar4))
					{
						...
						if (DOES_BLIP_EXIST(Global_105599))
						{
						...
						if (bVar3)
						{
							...
							if (func_193(iVar4))
							{
								iVar6 = GET_BLIP_INFO_ID_TYPE(iVar4);
		...
		iLocal_100++;
		iVar4 = GET_NEXT_BLIP_INFO_ID(iParam0);
	}
}

void func_195(vector3 vParam0, bool bParam3)
{
	int iVar0;
	int iVar1;
...
void func_196(vector3 vParam0, int iParam3)
{
	...
	if (func_189(vLocal_816[iParam3 /*3*/]) == _GET_BLIP_INFO_ID_ITERATOR())
	{
		iLocal_99 = iParam3;
		vLocal_964 = { GET_BLIP_COORDS(vLocal_816[iParam3 /*3*/]) };
	}
}
...
void func_198(vector3 vParam0, int iParam3)
{
	vLocal_816[iParam3 /*3*/] = { vParam0 };
	if (func_189(vLocal_816[iParam3 /*3*/]) == _GET_BLIP_INFO_ID_ITERATOR())
	{
...
float func_200(var uParam0)
{
	...
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (DOES_BLIP_EXIST(uParam0))
		{
			vVar0 = { func_48(uParam0) - GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
		}
	}
	return VMAG(vVar0);
}
...
void func_201(int iParam0, var uParam1)
{
	...
	*uParam1 = *iParam0;
	if (!*uParam1 == Global_105601)
	{
		...
		GET_STREET_NAME_AT_COORD(vVar0, &(uParam1->f_1), &(uParam1->f_2));
	}
	else
	{
		GET_STREET_NAME_AT_COORD(Global_105603, &(uParam1->f_1), &(uParam1->f_2));
	}
}
...
int func_202(var uParam0)
{
	...
	if (DOES_BLIP_EXIST(*uParam0))
	{
		iVar0 = GET_BLIP_HUD_COLOUR(*uParam0);
...
int func_203(var uParam0)
{
	...
	while (iVar0 < 8)
	{
		if (Global_90645[iVar0 /*17*/])
		{
			if (Global_90645[iVar0 /*17*/].f_9 != 263)
			{
				if (DOES_BLIP_EXIST(Global_26140[Global_90645[iVar0 /*17*/].f_9 /*23*/].f_19))
				{
...
int func_204(var uParam0)
{
	...
	if (func_205(GET_BLIP_COORDS(*uParam0), 0f, 0f, 0f, 0))
	{
		return 1;
	}
...
bool func_208()
{
	...
	bVar0 = false;
	if (!DOES_BLIP_EXIST(vLocal_816[iLocal_94 /*3*/]))
	{
	...
	if (TIMERB() > 250)
	{
		if (!bVar0)
		{
			if (iLocal_97 != GET_NUMBER_OF_ACTIVE_BLIPS())
			{
				bVar0 = true;
			}
			iLocal_97 = GET_NUMBER_OF_ACTIVE_BLIPS();
		...
		if (!bVar0)
		{
			if (iLocal_99 != -1)
			{
				if (DOES_BLIP_EXIST(vLocal_816[iLocal_99 /*3*/]))
				{
					if (func_189(vLocal_816[iLocal_99 /*3*/]) == _GET_BLIP_INFO_ID_ITERATOR())
					{
						vVar1 = { GET_BLIP_COORDS(vLocal_816[iLocal_99 /*3*/]) };
				...
				{
					uVar4 = GET_FIRST_BLIP_INFO_ID(_GET_BLIP_INFO_ID_ITERATOR());
					if (DOES_BLIP_EXIST(uVar4))
					{
						vVar1 = { GET_BLIP_COORDS(uVar4) };
						if (!func_129(vVar1, vLocal_964, 1056964608, 0))
						{
							bVar0 = true;
						}
...
int func_209()
{
	...
	{
		if (!IS_VEHICLE_SEAT_FREE(Global_105596, -1, 0))
		{
			iVar0++;
		}
		if (!IS_VEHICLE_SEAT_FREE(Global_105596, 0, 0))
		{
			iVar0++;
		}
		if (!IS_VEHICLE_SEAT_FREE(Global_105596, 1, 0))
		...
		if (!IS_VEHICLE_SEAT_FREE(Global_105596, 2, 0))
		{
			iVar0++;
		}
	}
...
void func_210()
{
	if (iLocal_938 != 0)
	{
		SET_TEXT_RENDER_ID(uLocal_95);
		SET_SCRIPT_GFX_DRAW_ORDER(4);
		SET_SCRIPT_GFX_DRAW_BEHIND_PAUSEMENU(1);
		if (IS_VEHICLE_DRIVEABLE(Global_105596, 0))
		{
			DRAW_SCALEFORM_MOVIE(uLocal_113, fLocal_88, fLocal_89, fLocal_86, fLocal_87, 0, 0, 0, 255, 0);
		}
	}
}
			...
			if (iLocal_938 == 2)
			{
				...
				if (!bLocal_66)
				{
					if (IS_CONTROL_JUST_PRESSED(2, 179))
					{
						...
						if (!IS_PED_INJURED(Global_105597))
						{
							if (!IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_941, "leanover_enter", 3))
							{
								if (!IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_941, "leanover_idle", 3))
								{
									if (!IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_941, "leanover_exit", 3))
									{
										CLEAR_PED_TASKS(Global_105597);
									}
								}
...
void func_213()
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_113, "SET_INPUT_EVENT");
	...
	if (DOES_BLIP_EXIST(vLocal_816[iLocal_94 /*3*/]))
	{
		vVar0 = { GET_BLIP_COORDS(vLocal_816[iLocal_94 /*3*/]) };
		if (!func_214(vVar0))
		{
			LOCK_MINIMAP_POSITION(vVar0.x, vVar0.y);
		}
...
void func_220()
{
	if (!Global_105601 == 0)
	{
		if (!DOES_BLIP_EXIST(Global_105601))
		{
			Global_105601 = 0;
		}
	}
...
int func_224()
{
	...
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()))
		{
			...
			{
				if (func_225(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)))
				{
					iVar0 = GET_PED_IN_VEHICLE_SEAT(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), -1, 0);
...
{
	if (IS_VEHICLE_MODEL(uParam0, joaat("taxi")))
	{
		return 1;
	}
	return 0;
...
int func_226(int iParam0)
{
	...
	if (func_59(PLAYER_PED_ID()) != iLocal_73)
	{
		return 1;
	}
	if (!DOES_ENTITY_EXIST(Global_105596))
	...
	if (!DOES_ENTITY_EXIST(Global_105597))
	{
		return 1;
	}
	if (IS_PED_INJURED(Global_105597))
	...
	if (iLocal_938 != 4)
	{
		if (iParam0 == 1)
		{
			...
			if (((IS_VEHICLE_STUCK_TIMER_UP(Global_105596, 2, 30000) || IS_VEHICLE_STUCK_TIMER_UP(Global_105596, 3, 30000)) || IS_VEHICLE_STUCK_TIMER_UP(Global_105596, 0, 7000)) || IS_VEHICLE_STUCK_TIMER_UP(Global_105596, 1, 7000))
			{
				return 1;
			}
		}
		vVar0 = { GET_ENTITY_COORDS(Global_105596, 0) };
		if (IS_BULLET_IN_AREA(vVar0, 7f, 0))
		{
			return 1;
		}
		fVar3 = 15f;
		...
		if (IS_PROJECTILE_IN_AREA(vVar4, vVar7, 1))
		{
			return 1;
		}
	}
...
int func_228()
{
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		if (func_232(&uVar0, func_234(), func_233()))
		{
			...
			if (func_230(&uVar0, &uVar1, 1))
			{
				vLocal_958 = { GET_ENTITY_COORDS(Global_105596, 1) - GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
				vLocal_958.z = 0f;
				fLocal_74 = VMAG(vLocal_958);
				iLocal_73 = func_59(PLAYER_PED_ID());
				func_229();
				iLocal_98 = func_209();
				iLocal_60 = 1;
				DISABLE_CONTROL_ACTION(0, 75, 1);
...
void func_229()
{
	...
	if (IS_VEHICLE_DRIVEABLE(Global_105596, 0))
	{
		if (!IS_VEHICLE_SEAT_FREE(Global_105596, 1, 0))
		{
			iVar0 = GET_PED_IN_VEHICLE_SEAT(Global_105596, 1, 0);
			if (PLAYER_PED_ID() != iVar0)
			{
				if (!IS_PED_GROUP_MEMBER(iVar0, GET_PLAYER_GROUP(PLAYER_ID())))
				{
					TASK_SMART_FLEE_PED(iVar0, PLAYER_PED_ID(), 200f, -1, 0, 0);
				}
			}
		}
		if (!IS_VEHICLE_SEAT_FREE(Global_105596, 2, 0))
		{
			iVar0 = GET_PED_IN_VEHICLE_SEAT(Global_105596, 2, 0);
			if (PLAYER_PED_ID() != iVar0)
			{
				if (!IS_PED_GROUP_MEMBER(iVar0, GET_PLAYER_GROUP(PLAYER_ID())))
				{
		...
		if (IS_VEHICLE_DRIVEABLE(*uParam0, 0))
		{
			if (!IS_PED_INJURED(*uParam1))
			{
				if (IS_PED_SITTING_IN_VEHICLE(*uParam1, *uParam0))
				{
					...
					Global_105597 = *uParam1;
					Global_105611 = 1;
					if (bParam2)
					{
						SET_ENTITY_AS_MISSION_ENTITY(Global_105597, 1, 1);
						SET_ENTITY_AS_MISSION_ENTITY(Global_105596, 1, 1);
						StringCopy(&Global_105627, GET_THIS_SCRIPT_NAME(), 24);
					}
					else
					{
						if (!IS_ENTITY_A_MISSION_ENTITY(Global_105597))
						{
							SET_ENTITY_AS_MISSION_ENTITY(Global_105597, 1, 0);
						}
						if (!IS_ENTITY_A_MISSION_ENTITY(Global_105596))
						{
							SET_ENTITY_AS_MISSION_ENTITY(Global_105596, 1, 0);
							StringCopy(&Global_105627, GET_THIS_SCRIPT_NAME(), 24);
						}
					}
					SET_PED_CONFIG_FLAG(Global_105597, 251, 1);
					SET_PED_COMBAT_ATTRIBUTES(Global_105597, 5, 0);
					SET_PED_COMBAT_ATTRIBUTES(Global_105597, 17, 1);
					SET_PED_FLEE_ATTRIBUTES(Global_105597, 512, 0);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_105597, 1);
					SET_AMBIENT_VOICE_NAME(Global_105597, "A_M_M_EASTSA_02_LATINO_FULL_01");
					SET_VEHICLE_DOORS_LOCKED(Global_105596, 1);
					SET_VEHICLE_HAS_BEEN_OWNED_BY_PLAYER(Global_105596, 1);
					SET_VEHICLE_AUTOMATICALLY_ATTACHES(Global_105596, 0, 0);
					_0xBE5C1255A1830FF5(Global_105596, 1);
					return 1;
				}
			}
		}
...
void func_231()
{
	...
	if (DOES_ENTITY_EXIST(Global_105597))
	{
		if (!IS_PED_INJURED(Global_105597))
		{
			SET_PED_CONFIG_FLAG(Global_105597, 251, 0);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_105597, 0);
			if (!IS_PED_FLEEING(Global_105597) && !IS_PED_IN_COMBAT(Global_105597, 0))
			{
				if (IS_PED_IN_ANY_VEHICLE(Global_105597, 0))
				{
					if (DOES_ENTITY_EXIST(Global_105596))
					{
						if (IS_VEHICLE_DRIVEABLE(Global_105596, 0))
						{
							if (IS_PED_SITTING_IN_VEHICLE(Global_105597, Global_105596))
							{
								if (GET_SCRIPT_TASK_STATUS(Global_105597, -258271821) != 1 && GET_SCRIPT_TASK_STATUS(Global_105597, -258271821) != 0)
								{
									OPEN_SEQUENCE_TASK(&uVar0);
									if ((!IS_VEHICLE_SEAT_FREE(Global_105596, 1, 0) || !IS_VEHICLE_SEAT_FREE(Global_105596, 2, 0)) || !IS_VEHICLE_SEAT_FREE(Global_105596, 0, 0))
									{
										TASK_PAUSE(0, 2000);
									}
									else
									...
									TASK_VEHICLE_DRIVE_WANDER(0, Global_105596, 12f, 790699);
									CLOSE_SEQUENCE_TASK(uVar0);
									TASK_PERFORM_SEQUENCE(Global_105597, uVar0);
									CLEAR_SEQUENCE_TASK(&uVar0);
								}
							}
							else
							{
								TASK_SMART_FLEE_PED(Global_105597, PLAYER_PED_ID(), 500f, -1, 0, 0);
							}
						}
						else
						{
				...
				else if (GET_SCRIPT_TASK_STATUS(Global_105597, -1146898486) != 1 && GET_SCRIPT_TASK_STATUS(Global_105597, -1146898486) != 0)
				{
					TASK_WANDER_STANDARD(Global_105597, 1193033728, 0);
				}
			}
		}
	}
	if (DOES_ENTITY_EXIST(Global_105597))
	{
		if (IS_ENTITY_A_MISSION_ENTITY(Global_105597))
		{
			if (DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_105597, 0))
			{
				if (!IS_PED_INJURED(Global_105597))
				{
					SET_ENTITY_LOAD_COLLISION_FLAG(Global_105597, 0, 1);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_105597, 0);
				}
				SET_PED_AS_NO_LONGER_NEEDED(&Global_105597);
			}
		}
	}
	if (DOES_ENTITY_EXIST(Global_105596))
	{
		if (IS_ENTITY_A_MISSION_ENTITY(Global_105596))
		{
			if (DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_105596, 0))
			{
				if (IS_VEHICLE_DRIVEABLE(Global_105596, 0))
				{
					SET_VEHICLE_HAS_BEEN_OWNED_BY_PLAYER(Global_105596, 0);
					SET_VEHICLE_AUTOMATICALLY_ATTACHES(Global_105596, 1, 0);
					_0xBE5C1255A1830FF5(Global_105596, 0);
				}
				SET_VEHICLE_AS_NO_LONGER_NEEDED(&Global_105596);
			}
		}
	}
	Global_105597 = 0;
				...
				if (DOES_ENTITY_EXIST(uVar0))
				{
					if (!IS_PED_INJURED(uVar0))
					{
						if (!IS_PED_FLEEING(uVar0))
						{
							...
							{
								if (IS_PED_MODEL(uVar0, uParam2))
								{
									if (IS_ENTITY_UPRIGHT(*uParam0, 1119092736))
									{
										iVar1 = GET_VEHICLE_DOOR_LOCK_STATUS(*uParam0);
										if (iVar1 != 3 && iVar1 != 2)
										{
											return 1;
										}
...
void func_235(bool bParam0)
{
	...
	SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_113);
	SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_114);
	if (func_236(Global_105597))
	{
		if (IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_941, "leanover_enter", 3))
		{
			STOP_ENTITY_ANIM(Global_105597, "leanover_enter", &cLocal_941, -2f);
		}
		else if (IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_941, "leanover_idle", 3))
		{
			STOP_ENTITY_ANIM(Global_105597, "leanover_idle", &cLocal_941, -2f);
		}
		else if (IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_941, "leanover_exit", 3))
		{
			STOP_ENTITY_ANIM(Global_105597, "leanover_exit", &cLocal_941, -2f);
		}
		if (IS_PED_HEADTRACKING_PED(Global_105597, PLAYER_PED_ID()))
		{
			TASK_CLEAR_LOOK_AT(Global_105597);
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (func_3(Global_105596))
		{
			if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Global_105596, 1))
			{
				if (GET_PED_IN_VEHICLE_SEAT(Global_105596, -1, 0) != PLAYER_PED_ID())
				{
					if (!func_2(PLAYER_PED_ID(), -828834893) && !func_2(PLAYER_PED_ID(), 451360105))
					{
						TASK_LEAVE_ANY_VEHICLE(PLAYER_PED_ID(), 0, 0);
