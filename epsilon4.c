...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (func_338(PLAYER::PLAYER_PED_ID()) == iLocal_89)
			{
...
void func_11()
{
	...
	while (func_338(PLAYER::PLAYER_PED_ID()) == iLocal_89)
	{
		SYSTEM::WAIT(0);
		HUD::HIDE_HUD_COMPONENT_THIS_FRAME(2);
		if (STREAMING::HAS_ANIM_DICT_LOADED("weapons@holster_1h"))
		{
			...
			{
				BRAIN::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "weapons@holster_1h", "holster", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
...
int func_13(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar2 = 0;
		func_19(&iVar2);
		iVar3 = func_18(Var1, Global_105220.f_7659.f_765[iVar2 /*10*/]);
		if (iVar3 == 2)
		{
			func_16(Global_105220.f_7659.f_765[iVar2 /*10*/]);
		...
		else if (iVar3 == 1)
		{
			...
			{
				if (!func_14(Global_105220.f_7659.f_765[iVar2 /*10*/]))
				{
					Global_105220.f_7659.f_765[iVar2 /*10*/] = { Var1 };
					func_15(&Var1);
					return 1;
...
void func_19(int iParam0)
{
	...
	*iParam0 = 0;
	...
	{
		if (func_18(Global_105220.f_7659.f_765[iVar0 /*10*/], Global_105220.f_7659.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
void func_25()
{
	...
	{
		func_12(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
...
void func_176(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_177(&sVar1, Var0.f_3, Global_92992, iParam1, iParam2);
	}
}
...
void func_226()
{
	switch (Local_434.f_1)
	{
		...
		case 1:
			...
			{
				if (func_227(PLAYER::PLAYER_PED_ID(), Local_298[0 /*8*/], 1) >= 50f)
				{
...
void func_237()
{
	...
	if (Local_434.f_3 == 1)
	{
		...
		if (CUTSCENE::_0xB56BBBCC2955D9CB())
		{
			...
			{
				func_291("Michael", PLAYER::PLAYER_PED_ID(), 0, 2);
			}
	...
	if (Local_434.f_1 == 0)
	{
		...
		if (func_339(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (iLocal_283 == 0)
			{
				...
				{
					iLocal_303 = func_268(PLAYER::PLAYER_PED_ID(), joaat("weapon_digiscanner"), 1, 0, 0, 0, 0, 0, 0);
			...
			if (iLocal_283 >= 2)
			{
				if (CUTSCENE::IS_CUTSCENE_PLAYING())
				{
					if (CUTSCENE::GET_CUTSCENE_TIME() > 17000)
					{
						if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
						{
							STREAMING::NEW_LOAD_SCENE_START(1847.472f, 4756.157f, 36.6968f, func_252(271.4718f), 145f, 0);
						}
					}
				}
			}
...
void func_239(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_243(PLAYER::PLAYER_ID())) && !func_241(PLAYER::PLAYER_ID(), 0)) && !func_240()) && !bParam4)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_243(PLAYER::PLAYER_ID())) && !bParam4)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_70976 = 0;
	...
	if (func_228(Local_298[1 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Jimmy_Boston", 0))
		{
			if (iLocal_283 >= 2)
			{
				...
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_435);
					BRAIN::TASK_WARP_PED_INTO_VEHICLE(0, iLocal_292, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_435);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_81.f_28[1], iLocal_435);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_435);
					func_389("Did Jimmy pass exit");
				}
			}
			else
			{
				BRAIN::TASK_GO_STRAIGHT_TO_COORD(Local_81.f_28[1], 1764.089f, 4665.879f, 42.3031f, 1f, 20000, 1193033728, 1056964608);
	...
	if (func_228(Local_298[0 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Marnie", 0))
		{
			if (iLocal_283 >= 2)
			{
				...
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_435);
					BRAIN::TASK_WARP_PED_INTO_VEHICLE(0, iLocal_292, -1);
					...
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_435);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_81.f_28[0], iLocal_435);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_435);
			...
			{
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_81.f_28[0], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_81.f_28[0], 0f, 7f, 0f), 1f, 20000, 0.25f, 5, 1193033728);
...
Vector3 func_252(float fParam0)
{
...
void func_254(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
int func_264(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_265(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_268(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (func_272(iVar2, iVar6) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_272(iVar2, iVar6)))
			{
				if (func_271(func_272(iVar2, iVar6)))
				{
					iVar7 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_272(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_272(iVar2, iVar6) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_272(iVar2, iVar6)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iVar1, func_272(iVar2, iVar6));
...
int func_275(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (iParam0 == 1)
	{
		if (func_288())
		{
			if ((MISC::ARE_STRINGS_EQUAL(Local_301.f_14, "NO_RECENT_ANIM") || !ENTITY::IS_ENTITY_PLAYING_ANIM(Local_301, "rcm_epsilonism4", Local_301.f_14, 3)) || ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_301, "rcm_epsilonism4", Local_301.f_14) >= 0.98f)
			{
				...
				ENTITY::PLAY_ENTITY_ANIM(Local_301, Local_301.f_14, "rcm_epsilonism4", 16f, false, 0, 0, 0, 0);
			}
		}
	}
	else if (func_288())
...
void func_295(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_296(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_300()
{
	...
	if (Local_434.f_1 == 0)
	{
		...
		func_322(&uLocal_98, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	...
	if (Local_434.f_1 == 1)
	{
		...
		else if (!func_320(&uLocal_356, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
		{
			func_236(6);
			Local_434.f_9 = 8;
			Local_434.f_1 = 3;
		...
		else
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Local_293[iLocal_283 /*43*/].f_1))
			{
				if (iLocal_283 == 0)
				{
					if (func_227(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_1, 1) < 100f)
					{
						if (!CUTSCENE::HAS_CUTSCENE_LOADED())
						{
					...
					else if (func_227(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_1, 1) > 120f)
					{
						if (CUTSCENE::HAS_CUTSCENE_LOADED())
						{
				...
				else if (func_227(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_1, 1) < 100f)
				{
					if (!CUTSCENE::HAS_CUTSCENE_LOADED())
					{
			...
			{
				func_314(&iLocal_94);
				if (!func_320(&uLocal_304, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
				{
					iLocal_269 = 0;
					AUDIO::STOP_SCRIPTED_CONVERSATION(false);
					HUD::CLEAR_PRINTS();
				...
				{
					if (MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_36, sLocal_91) || func_305(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_36, 7, 0, 0, 0))
					{
						if (!MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_36, sLocal_91))
						{
							if (func_228(iLocal_291))
							{
								BRAIN::TASK_LOOK_AT_ENTITY(iLocal_291, PLAYER::PLAYER_PED_ID(), 10000, 0, 2);
							}
						}
						iLocal_421 = MISC::GET_GAME_TIMER();
						iLocal_270 = 1;
				...
				{
					if (!func_279() && (MISC::GET_GAME_TIMER() - iLocal_288) >= 7500)
					{
						if ((MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_37, sLocal_91) || !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_291, 30f, 30f, 30f, 0, 1, 0)) || func_305(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_37, 7, 0, 0, 0))
						{
							if (!MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_37, sLocal_91))
							{
								if (func_228(iLocal_291))
								{
									BRAIN::TASK_LOOK_AT_ENTITY(iLocal_291, PLAYER::PLAYER_PED_ID(), 5000, 0, 2);
								}
							}
							iLocal_271 = 1;
							iLocal_421 = MISC::GET_GAME_TIMER();
				...
				else if (iLocal_268 == 0 && !func_303(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_2, 9f))
				{
					if (func_303(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_2, 20f))
					{
						if (!iLocal_273)
						{
							if (!func_279())
					...
					{
						if (func_302(PLAYER::PLAYER_PED_ID(), iLocal_291, 30f, 1) || iLocal_283 == 2)
						{
							if (!func_279() && (MISC::GET_GAME_TIMER() - iLocal_286) > 15000)
							{
								if (bLocal_266)
								{
									if (iLocal_282 == 0)
									{
										...
										{
											if (MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_40, sLocal_91) || func_305(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_40, 7, 0, 0, 0))
											{
												if (func_339(iLocal_291))
												{
													BRAIN::TASK_LOOK_AT_ENTITY(iLocal_291, PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
												}
												iLocal_286 = MISC::GET_GAME_TIMER();
												iLocal_412++;
												if (iLocal_283 == 2)
									...
									{
										if (MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_40, sLocal_91) || func_305(&uLocal_98, "EPS4AUD", "EPS4_HASSIG", 7, 0, 0, 0))
										{
											iLocal_286 = MISC::GET_GAME_TIMER();
											iLocal_414++;
										}
								...
								{
									if (MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_41, sLocal_91) || func_305(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_41, 7, 0, 0, 0))
									{
										if (func_339(iLocal_291))
										{
											BRAIN::TASK_LOOK_AT_ENTITY(iLocal_291, PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
				...
				if (iLocal_283 == 0)
				{
					if (iLocal_415 < 5)
					{
						if (((MISC::GET_GAME_TIMER() - iLocal_417) > 7500 && !func_279()) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						{
							if (func_228(Local_298[0 /*8*/]))
							{
								if (func_227(Local_298[0 /*8*/], PLAYER::PLAYER_PED_ID(), 1) < 4f)
								{
				...
				else if (iLocal_283 == 1)
				{
					if (iLocal_415 < 4)
					{
						if (((MISC::GET_GAME_TIMER() - iLocal_417) > 7500 && !func_279()) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						{
							if (func_228(Local_298[1 /*8*/]))
							{
								if (func_227(Local_298[1 /*8*/], PLAYER::PLAYER_PED_ID(), 1) < 4f)
								{
				...
				else if (!func_303(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_2, (9f + 2f)))
				{
					iLocal_267 = 0;
				}
			}
			else
			{
				...
				else if (iLocal_274 == 0)
				{
					if (iLocal_283 < 2)
					{
						...
						{
							if (!func_279() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
							{
								if (MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_38, sLocal_91) || func_305(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_38, 7, 0, 0, 0))
								{
									iLocal_274 = 1;
								}
							}
					...
					else if (!func_279() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
					{
						if (MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_38, sLocal_91) || func_305(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_38, 7, 0, 0, 0))
						{
							iLocal_274 = 1;
				...
				else if (iLocal_275 == 0)
				{
					if (iLocal_283 < 2)
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_291, 30f, 30f, 30f, 0, 1, 0))
						{
							if ((!func_279() && (MISC::GET_GAME_TIMER() - iLocal_288) >= 7500) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
							{
								if (MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_39, sLocal_91) || func_305(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_39, 7, 0, 0, 0))
								{
									iLocal_275 = 1;
								}
							}
					...
					else if ((!func_279() && (MISC::GET_GAME_TIMER() - iLocal_288) >= 7500) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
					{
						if (MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_39, sLocal_91) || func_305(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_39, 7, 0, 0, 0))
						{
							iLocal_275 = 1;
...
int func_301(vector3 vParam0, int iParam1, bool bParam2)
{
	int iVar0;
...
bool func_303(int iParam0, vector3 vParam1, float fParam2)
{
...
bool func_305(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_306(char* sParam0, int iParam1, bool bParam2)
{
	Global_15801 = 0;
...
void func_313(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)
{
...
void func_317(var uParam0)
{
	...
	if (func_339(*uParam0) && PED::IS_PED_IN_GROUP(*uParam0))
	{
	...
	switch (uParam0->f_1)
	{
		...
		case 1:
			...
			else if (uParam0->f_2 == 0)
			{
				...
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_296[uParam0->f_3 /*6*/], 1f, -1, 0.25f, 5, 1193033728);
				uParam0->f_2 = 1;
			}
		...
		case 2:
			...
			else if (uParam0->f_2 == 0)
			{
				...
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_97);
				if (Local_296[uParam0->f_3 /*6*/].f_4 == 0)
				{
					if (*uParam0 == Local_298[1 /*8*/])
					{
						BRAIN::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_entry_jb", 4f, -4f, -1, 0, 0, 0, 0, 0);
						BRAIN::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_idle_a_jb", 8f, -4f, -1, 0, 0, 0, 0, 0);
						BRAIN::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_exit_jb", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else
					{
						BRAIN::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_entry_marnie", 4f, -4f, -1, 0, 0, 0, 0, 0);
						BRAIN::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_idle_a_marnie", 8f, -4f, -1, 0, 0, 0, 0, 0);
						BRAIN::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_exit_marnie", 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
				}
				else if (Local_296[uParam0->f_3 /*6*/].f_4 == 2)
				{
					BRAIN::TASK_ACHIEVE_HEADING(0, Local_296[uParam0->f_3 /*6*/].f_3, 0);
					BRAIN::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "peeing", 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
				else if (Local_296[uParam0->f_3 /*6*/].f_4 == 3)
				{
					BRAIN::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "hippy_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				...
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_97);
				BRAIN::TASK_PERFORM_SEQUENCE(*uParam0, iLocal_97);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_97);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
		...
		case 4:
			...
			else if (uParam0->f_2 == 0)
			{
				if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uParam0->f_4, 1f, 1f, 1f, false, true, 0) || iLocal_283 > 0)
				{
					...
					{
						BRAIN::CLEAR_PED_TASKS(*uParam0);
						PED::SET_PED_AS_GROUP_MEMBER(*uParam0, func_318());
						PED::SET_PED_CONFIG_FLAG(*uParam0, 167, true);
					}
					iLocal_418 = MISC::GET_GAME_TIMER();
					if (iLocal_283 == 0)
					{
						PED::SET_GROUP_FORMATION(func_318(), 0);
					}
					else
					{
						PED::SET_GROUP_FORMATION(func_318(), 0);
					}
					PED::SET_GROUP_FORMATION_SPACING(func_318(), 4f, -1082130432, -1082130432);
					uParam0->f_2 = 1;
				}
			}
			else if (uParam0->f_2 == 1)
			{
				...
				if (BRAIN::IS_PED_SPRINTING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_JUMPING(PLAYER::PLAYER_PED_ID()))
				{
					if ((((MISC::GET_GAME_TIMER() - iLocal_419) > 7500 && !func_279()) && !HUD::IS_MESSAGE_BEING_DISPLAYED()) && !iLocal_267)
					{
						if (*uParam0 == Local_298[1 /*8*/])
						{
				...
				{
					if ((((iLocal_420 < 4 && !func_279()) && !HUD::IS_MESSAGE_BEING_DISPLAYED()) && !iLocal_267) && !func_340())
					{
						if (*uParam0 == Local_298[1 /*8*/])
						{
		...
		case 5:
			...
			{
				BRAIN::TASK_GO_TO_ENTITY(*uParam0, PLAYER::PLAYER_PED_ID(), 20000, 4.5f, 2f, 1073741824, 0);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
...
{
	if (func_339(iParam0) && func_228(PLAYER::PLAYER_PED_ID()))
	{
		if (iLocal_299 == 0)
		{
...
{
	if (func_339(*uParam0) && func_339(PLAYER::PLAYER_PED_ID()))
	{
		uParam0->f_1 = 4;
		uParam0->f_2 = 0;
		BRAIN::TASK_LOOK_AT_ENTITY(*uParam0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
		if (bParam1)
		{
			BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(*uParam0, PLAYER::PLAYER_PED_ID(), 0);
		}
...
void func_332()
{
	...
	if (Local_434.f_1 == 0)
	{
		...
		if (func_275(1, 1093140480, 0))
		{
			...
			{
				ENTITY::FREEZE_ENTITY_POSITION(Local_81.f_28[1], false);
				if (func_228(WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(Local_81.f_28[1])))
				{
	...
	if (Local_434.f_1 == 1)
	{
		...
		if (func_228(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				func_389("*** Forcing Michael's move state");
				func_335(PLAYER::PLAYER_PED_ID(), 1827.161f, 4698.645f, 38.094f, 184.1384f, 0, 1);
				WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), iLocal_89, -1, true, true);
			}
		}
...
void func_334()
{
	if (func_228(Local_298[0 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Marnie", 0))
		{
			...
			BRAIN::TASK_GO_STRAIGHT_TO_COORD(Local_298[0 /*8*/], Local_296[Local_298[0 /*8*/].f_3 /*6*/], 1f, -1, 1193033728, 1056964608);
...
void func_337()
{
	...
	if (Local_434.f_1 == 0)
	{
		...
		if (!func_400(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, true, 0))
		{
	...
	if (Local_434.f_1 == 1)
	{
		...
		if (!func_400(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, true, 0))
		{
			if (func_227(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 1) >= 3f)
			{
				if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
				{
					if (!iLocal_263)
					{
						if (func_228(Local_81.f_28[0]))
						{
							...
							{
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_97);
								BRAIN::TASK_LOOK_AT_ENTITY(0, Local_81.f_28[0], 15000, 0, 2);
								BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1827.34f, 4697.22f, 38.02f, 1f, 20000, 0.25f, 1, 1193033728);
								BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_81.f_28[0], 0);
								BRAIN::CLOSE_SEQUENCE_TASK(iLocal_97);
								BRAIN::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iLocal_97);
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_97);
			...
			if (!iLocal_264)
			{
				...
				{
					BRAIN::TASK_LOOK_AT_ENTITY(Local_81.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 48, 2);
					BRAIN::TASK_PLAY_ANIM(Local_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 8f, -8f, -1, 2, 0, 0, 0, 0);
					CUTSCENE::REMOVE_CUTSCENE();
			...
			else if (func_339(Local_81.f_28[0]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 3))
				{
					...
					if (func_227(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 1) <= 1.5f)
					{
						PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
						BRAIN::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
					}
...
void func_341(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71232 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_343(Global_71233, Global_71235, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
struct<2> func_343(int iParam0, int iParam1, int iParam2)
{
	struct<2> Var0;
	int iVar1;
...
int func_352(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (((!func_354(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_222(0)) || func_353(1))
			{
			}
			else
			{
...
{
	return func_356(iParam0, Global_35905);
}
...
int func_364(var uParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4)
{
	if (iParam3 != 0)
	{
		*uParam0 = iParam3;
...
void func_365(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1))
	{
		...
		func_366("Rock rot vector: ", ENTITY::GET_ENTITY_ROTATION(uParam0->f_1, 0));
		func_366("Rock actual position: ", ENTITY::GET_ENTITY_COORDS(uParam0->f_1, false));
		ENTITY::SET_ENTITY_CAN_BE_DAMAGED(uParam0->f_1, false);
		ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_1, true);
	}
}

void func_366(char* sParam0, vector3 vParam1)
{
	sParam0 = sParam0;
	vParam1 = { vParam1 };
}
...
void func_372(var uParam0, vector3 vParam1)
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_375(float fParam0, float fParam1, float fParam2)
{
	int iVar0;
...
void func_378(char* sParam0, char* sParam1)
{
	int iVar0;
...
void func_382(vector3 vParam0, float fParam1)
{
	int iVar0;
...
void func_384(vector3 vParam0, vector3 vParam1, float fParam2)
{
	int iVar0;
...
void func_385(int iParam0, vector3 vParam1, vector3 vParam2)
{
	int iVar0;
...
int func_390(vector3 vParam0, float fParam1)
{
	vector3 vVar0;
...
int func_393(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
...
int func_394(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_403(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_405(bool bParam0)
{
	...
	if (!func_420())
	{
		...
		{
			func_176(iVar0, 1, 0);
			func_406(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_104307[iVar0 /*10*/].f_9 == -1)
...
int func_407(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_413())
	{
		...
		{
			iVar2 = func_408(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_413()
{
	...
	{
		if (func_408(&(Global_92955.f_3)) > -1)
		{
			return 1;
		}
	}
