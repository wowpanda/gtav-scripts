...
void __EntryFunction__()
{
	...
	func_511();
	if (!func_510(PLAYER::PLAYER_PED_ID()))
	{
	}
	func_509(2, 1);
	func_509(3, 1);
...
void func_11()
{
	switch (iLocal_115)
	{
		...
		case 2:
			...
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_106);
				...
				if (bLocal_146)
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_161);
					BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic3leadinoutef_3_mcs_1", "leadout_ef_3_mcs_maryann", 8f, -4f, -1, 0, 0.164f, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_161);
				}
				else
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_161);
					BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic3leadinoutef_3_mcs_1", "leadout_ef_3_mcs_maryann", 8f, -4f, -1, 0, 0, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_161);
				}
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_106, iLocal_161);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_161);
				if (func_510(PLAYER::PLAYER_PED_ID()))
				{
			...
			BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_106, -1, 0, 2);
			SYSTEM::WAIT(1000);
						...
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_106, "rcmfanatic3leadinoutef_3_mcs_1", "leadout_ef_3_mcs_maryann") >= 0.98f)
						{
							if (iLocal_147 == 0)
							{
								if (func_5(iLocal_67))
								{
									...
									BRAIN::TASK_ENTER_VEHICLE(0, iLocal_67, 20000, -1, 2f, 1, 0);
...
void func_17()
{
	...
	{
		if (func_20(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_19(PLAYER::PLAYER_PED_ID());
			if (func_18(iVar0) && (!func_21(14) || Global_104171))
			{
				if (Global_105220.f_2354.f_539.f_4301 != iVar0 && func_18(Global_105220.f_2354.f_539.f_4301))
				{
...
void func_26()
{
	...
	{
		func_28(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
...
int func_51(int iParam0, int iParam1, int iParam2)
{
	...
	Global_70793[1 /*14*/] = { func_102(iVar0, iParam1, iParam2) };
	...
	else
	{
		...
		Global_70793[1 /*14*/] = { func_102(iVar0, iParam1, uVar6[iParam1]) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_94(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_94(iParam1), Global_70793[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_94(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, 0);
		}
	}
...
int func_52(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_166(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_64, Global_105220.f_2354.f_539[iVar0 /*65*/].f_63))
		{
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_70793[1 /*14*/] = { func_102(iVar10, iParam1, iParam2) };
		if (!func_92(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_70793[1 /*14*/] = { func_102(iVar10, iVar0, uVar11[iVar0]) };
				if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_70793[1 /*14*/] = { func_102(iVar10, 14, uVar12[iVar1]) };
							func_70(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
							func_85(14);
							if (Global_70791 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_94(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_94(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_94(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
						}
						func_85(iVar0);
						if (Global_70791 == 1)
						{
			...
			{
				Global_70793[1 /*14*/] = { func_102(iVar10, iVar0, func_60(iParam0, iVar0, -1)) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_70793[1 /*14*/] = { func_102(iVar10, 14, uVar15[iVar1]) };
			func_70(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
			func_85(14);
			if (Global_70791 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_94(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_94(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_94(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
		}
		if (Global_70791 == 1)
		{
			iVar2 = 0;
...
{
	Global_70793[1 /*14*/] = { func_102(iParam0, iParam1, iParam2) };
...
int func_72(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_94(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_94(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_72(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_72(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_72(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_72(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_85(int iParam0)
{
	...
	{
		func_91(iParam0, Global_70793[1 /*14*/].f_5, Global_70793[1 /*14*/].f_2, 2, Global_70793[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_87(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_88(iParam2)];
	if (iVar0 != 0)
	{
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_166(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_61, Global_105220.f_2354.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_101(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[0], Global_105220.f_2354.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_101(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[1], Global_105220.f_2354.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_101(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[2], Global_105220.f_2354.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_104(int iParam0)
{
	...
	func_105(&(Global_70793[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_89(func_108(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_89(func_107(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_89(iVar1, Global_70790, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_111(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_105(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_105(&(Global_70793[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_105(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_94(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_105(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_166(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_166(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_166(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_70793[2 /*14*/] = { func_102(iVar0, 14, iVar4) };
									if (Global_70793[2 /*14*/].f_12 == iVar3)
									{
										if (func_166(iParam0, 14, iVar4))
										{
											if (!func_58(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_70793[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_70793[2 /*14*/] = { func_102(iVar0, iVar2, iVar1) };
						if (!func_58(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_70793[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_70793[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_94(iParam1)) && Global_70793[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_94(iParam1)))
	{
		return 1;
	}
	return 0;
	...
	switch (iLocal_57)
	{
		...
		case 1:
			...
			if (func_269(&vLocal_80))
			{
				...
				BRAIN::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "rcmfanatic3leadinoutef_3_mcs_1", "Fra_outofbreath_intro", 2f, -8f, -1, 0, 0, 0, 0, 0);
...
int func_269(var uParam0)
{
	...
	if (fVar1 < 5.5f)
	{
		...
		else
		{
			...
			HUD::_0x75A16C3DA34F1245(iLocal_93, false);
			if (iLocal_100 == (iLocal_99 - 1))
			{
			...
			if (iLocal_100 < (iLocal_99 - 1))
			{
				...
				if (iLocal_100 == (iLocal_99 - 2))
				{
					...
					HUD::_0x75A16C3DA34F1245(iLocal_94, false);
				}
				else
				{
...
void func_274()
{
	...
	switch (iLocal_114)
	{
		...
		case 1:
			if (func_510(iLocal_76))
			{
				...
				{
					BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(iLocal_76, "fan3_ownerroute", 0, 0, -1);
				...
				if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_76))
				{
					if (func_295(PLAYER::PLAYER_PED_ID(), iLocal_76) < 16f)
					{
						if (!func_265())
						{
							...
							{
								BRAIN::TASK_LOOK_AT_ENTITY(iLocal_76, PLAYER::PLAYER_PED_ID(), 6000, 0, 2);
								BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_76, 6000, 0, 2);
								iLocal_114++;
							}
						}
					}
	...
	if (func_510(iLocal_76))
	{
		...
		{
			BRAIN::CLEAR_PED_TASKS(iLocal_76);
			BRAIN::TASK_SMART_FLEE_PED(iLocal_76, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
			if (func_265())
			{
				Var0 = { func_276() };
...
int func_277(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_510(PLAYER::PLAYER_PED_ID()) && func_510(iParam0))
	{
	...
	if (func_510(PLAYER::PLAYER_PED_ID()))
	{
		if (func_297(PLAYER::PLAYER_PED_ID(), vLocal_80[1 /*3*/], 5f))
		{
			if (func_510(iLocal_75))
			{
				...
				{
					BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(iLocal_75, "fan3_dogroute", 0, 0, -1);
				}
			}
		}
	}
		...
		switch (iLocal_111)
		{
			case 0:
				if (func_277(iLocal_72, 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					...
					{
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_161);
						BRAIN::TASK_ENTER_VEHICLE(0, iLocal_66, 20000, -1, 3f, 8, 0);
						BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_66, PLAYER::PLAYER_PED_ID(), 8, 30f, 786468, 300f, 10f, 1);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_161);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_72, iLocal_161);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_161);
	...
	if (func_510(iLocal_74))
	{
		switch (iLocal_112)
		{
			case 0:
				...
				{
					BRAIN::CLEAR_PED_TASKS(iLocal_74);
					BRAIN::TASK_SMART_FLEE_PED(iLocal_74, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
					iLocal_112++;
				}
				break;
	...
	if (func_510(iLocal_73))
	{
		switch (iLocal_113)
		{
			case 0:
				...
				{
					BRAIN::CLEAR_PED_TASKS(iLocal_73);
					BRAIN::TASK_SMART_FLEE_PED(iLocal_73, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
					iLocal_113++;
				}
				break;
...
void func_307()
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (iLocal_55 != 7)
		{
			if (!func_308(ENTITY::GET_ENTITY_MODEL(iVar0)))
			{
				if (func_510(iLocal_106) && func_510(PLAYER::PLAYER_PED_ID()))
				{
	...
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 59.70891f, 6931.386f, 10.60823f, 69.71092f, 6899.878f, 15.37432f, 11f, 0, true, 0))
	{
		if (!iLocal_142)
		{
			if (func_510(iLocal_106))
			{
				...
				{
					if (Global_105220.f_18545.f_386 == 1)
					{
						if (func_265())
						{
							func_233();
	...
	switch (iParam0)
	{
		...
		case 2:
			if (func_510(iLocal_60) && func_510(iLocal_61))
			{
				...
				if (func_510(iLocal_106))
				{
					BRAIN::TASK_ENTER_VEHICLE(iLocal_106, iLocal_63, 20000, -1, 3f, 1, 0);
				}
				if (!func_265())
				{
					if (iLocal_103 == 1)
		...
		case 3:
			if (func_510(iLocal_106) && func_5(iLocal_63))
			{
				if (!BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_63) && iLocal_128 == 0)
				{
					...
					BRAIN::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_106, iLocal_63, sLocal_107, 786485, 0, 24, -1, -1f, 0, 1073741824);
					func_10(&iLocal_95);
				}
			}
			break;
		...
		case 5:
			if (func_510(iLocal_106))
			{
				if (!BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_106))
				{
					...
					BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(iLocal_106, "fan3_pedJog", 0, 0, -1);
				}
			}
			break;
	...
	if (iLocal_56 == 3 && iLocal_55 == 3)
	{
		if (iLocal_103 == 1)
		{
			if (func_510(iLocal_106) && func_510(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_107, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), &iVar0);
					if ((MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_106, true), true) > 65f && iVar0 > 26) && BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_63))
					{
						if (func_510(iLocal_63))
						{
							if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_63))
							{
								BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_107, ENTITY::GET_ENTITY_COORDS(iLocal_63, true), &uVar1);
								BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_107, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), &iVar0);
							}
							iVar0 = (iVar0 - 5);
...
void func_329()
{
		...
		else if (iLocal_56 == 3)
		{
			...
			if (func_510(iLocal_63))
			{
				if (BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED("Fan3_pedBike") && BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED("Fan3_pedBikePrep"))
				{
					if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_63))
					{
						BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_107, ENTITY::GET_ENTITY_COORDS(iLocal_63, true), &iVar3);
						if (MISC::ARE_STRINGS_EQUAL(sLocal_107, "Fan3_pedBike"))
						{
							...
							if (iVar3 > 93 && iVar3 < 98)
							{
								...
								BRAIN::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_106, iLocal_63, sLocal_107, 262144, 0, 24, -1, -1f, 0, 1073741824);
							}
						}
						else
						{
	...
	else if (iLocal_56 == 3)
	{
		if (func_510(iLocal_63))
		{
			if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_63))
			{
				BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_107, ENTITY::GET_ENTITY_COORDS(iLocal_63, true), &iVar5);
				if (MISC::ARE_STRINGS_EQUAL(sLocal_107, "Fan3_pedBike"))
				{
					...
					if (iVar5 > 93 && iVar5 < 98)
					{
						func_9("**** SWITCHING TO JUMP PREP");
						sLocal_107 = "Fan3_pedBikePrep";
						BRAIN::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_106, iLocal_63, sLocal_107, 262160, 0, 24, -1, -1f, 0, 1073741824);
					}
				}
				else
				{
...
void func_330(int iParam0)
{
	...
	if (func_510(iLocal_63))
	{
		...
		{
			BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_107, ENTITY::GET_ENTITY_COORDS(iLocal_63, true), &iParam0);
...
void func_337()
{
	...
	{
		BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_106, PED::GET_VEHICLE_PED_IS_IN(iLocal_106, 0), PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 100f, 0.1f, 1);
		PED::SET_PED_FLEE_ATTRIBUTES(iLocal_106, 2, true);
		func_9("Setting Mary Ann Use Vehicle flee attribute");
	}
	else
	{
		BRAIN::TASK_SMART_FLEE_PED(iLocal_106, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
	}
	if (func_510(iLocal_72))
	{
...
int func_356()
{
	...
	if (func_510(iLocal_72))
	{
		...
		BRAIN::TASK_PLAY_ANIM(iLocal_72, "rcmfanatic3", "binoculars", 8f, -8f, -1, 1, 0, 0, 0, 0);
	...
	if (func_510(iLocal_73))
	{
		...
		BRAIN::TASK_PLAY_ANIM(iLocal_73, "rcmfanatic3", "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
	}
	func_3(&iLocal_74);
	...
	if (func_510(iLocal_74))
	{
		...
		BRAIN::TASK_PLAY_ANIM(iLocal_74, "rcmfanatic1maryann_stretchidle_b", "idle_e", 8f, -8f, -1, 1, 0, 0, 0, 0);
	}
	func_3(&iLocal_75);
		...
		if (func_5(iLocal_65) && func_510(iLocal_70))
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -402.2801f, 6407.981f, 9.086394f, -382.6009f, 6364.857f, 16.76248f, 5f, 0, true, 0))
			{
				if (!iLocal_127)
				{
					...
					func_246(&uLocal_329, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					BRAIN::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iLocal_70, iLocal_65, "Fan3_baddriver", 786469, 0, 0, -1, -1f, 0, 1073741824);
					iLocal_127 = 1;
				}
			}
			else if (iLocal_127)
...
void func_367()
{
	...
	switch (iLocal_57)
	{
		...
		case 2:
			...
			Global_92955.f_12[0] = iLocal_159;
			iLocal_55 = 4;
			iLocal_57 = 0;
			break;
	}
...
void func_368(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_438(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		else
		{
			...
			{
				iVar6 = func_435(&(Global_92955.f_3));
				if (iVar6 > -1)
				{
...
{
	func_370(&Global_98783, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_370(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_16();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_390())
		{
			func_386(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
...
void func_386(int iParam0, var uParam1, int iParam2)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && ENTITY::GET_ENTITY_MODEL(iParam0) == ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			if (func_387(161, -1))
			{
				uParam1->f_59 = func_89(2051, Global_70790, 0);
			}
			else
			{
				uParam1->f_59 = func_89(752, Global_70790, 0);
			}
			uParam1->f_60 = func_89(753, Global_70790, 0);
			uParam1->f_61 = func_89(754, Global_70790, 0);
		}
...
void func_391(int iParam0, bool bParam1)
{
	...
	if (func_18(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_392(iParam0, &(Global_105220.f_2354.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_392(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_394(Var7.f_1)) && iVar9 < 50)
			{
...
Vector3 func_409(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_420(Global_95018);
			break;
		
		case 46:
			if (Global_1589135 != func_419())
			{
				if (func_418(Global_1589135))
				{
					return func_411(2, 2);
				}
				else if (func_410(Global_1589135))
				{
...
var func_424()
{
	...
	func_434(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_433(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_432(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_427(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_426(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_425(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_430(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_436(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_437(Global_105220.f_9056.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_437(Global_105220.f_9056.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_437(Global_105220.f_9056.f_99.f_205[11]);
			break;
		
		case 90:
			return func_437(Global_105220.f_9056.f_99.f_205[7]);
			break;
		
		case 93:
			return func_437(Global_105220.f_9056.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
int func_438(char* sParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
...
void func_443()
{
	if (func_510(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (func_510(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)))
		{
			if (!iLocal_162)
			{
...
int func_445()
{
	...
	{
		BRAIN::TASK_PLAY_ANIM(iLocal_71, "rcmfanatic3", "KNEEL_IDLE_A", 8f, -8f, -1, 1, 0, 0, 0, 0);
	}
...
int func_461(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if ((!PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_BOAT(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = 0;
				if (!func_464(PLAYER::PLAYER_PED_ID(), -828834893))
				{
					BRAIN::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
				}
			}
...
void func_470()
{
	...
	if (!func_455())
	{
		...
		func_474(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1112014848, 12, 5000, 0, 0);
	}
	if (func_510(iLocal_106))
	{
		BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_106);
...
void func_474(vector3 vParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
void func_483()
{
	...
	if (func_522())
	{
		iLocal_160 = Global_92955.f_12[0];
	}
...
void func_484(vector3 vParam0, vector3 vParam1, var uParam2, int iParam3)
{
	int iVar0;
	vector3 vVar1;
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmfanatic3"))
			{
				if (func_510(iLocal_106))
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_106, "rcmfanatic3", "ef_3_rcm_loop_maryann", 3))
					{
						...
						{
							BRAIN::TASK_PLAY_ANIM(iLocal_106, "rcmfanatic3", "ef_3_rcm_action_maryann", 8f, -8f, -1, 2, 0, 0, 0, 0);
							ENTITY::FREEZE_ENTITY_POSITION(iLocal_106, false);
							CUTSCENE::REMOVE_CUTSCENE();
		...
		case 1:
			if (func_222(iLocal_106))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_106, "rcmfanatic3", "ef_3_rcm_action_maryann", 3))
				{
					...
					{
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_106, 0);
						PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
						func_9("Player too close to Mary Ann, starting cutscene early");
					}
				}
...
void func_489(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_522())
	{
...
void func_491(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71232 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_493(Global_71233, Global_71235, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_504(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_479(0)) || func_503(1))
			{
			}
			else
			{
...
{
	return func_506(iParam0, Global_35905);
}
...
void func_520(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
void func_523()
{
	...
	if (func_510(iLocal_106))
	{
		if (func_5(iLocal_67))
		{
			...
			{
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_161);
				BRAIN::TASK_ENTER_VEHICLE(0, iLocal_67, 20000, -1, 1f, 1, 0);
				BRAIN::TASK_GO_TO_COORD_ANY_MEANS(0, 253.0988f, 6751.997f, 14.2161f, 1f, 0, 0, 786603, -1082130432);
				BRAIN::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_67, 15f, 786599);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_161);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_106, iLocal_161);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_161);
	...
	if (func_510(iLocal_72))
	{
		PED::SET_PED_FLEE_ATTRIBUTES(iLocal_72, 2, true);
		PED::SET_PED_KEEP_TASK(iLocal_72, true);
		if (func_510(iLocal_66) && func_510(PLAYER::PLAYER_PED_ID()))
		{
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_161);
			BRAIN::TASK_ENTER_VEHICLE(0, iLocal_66, 20000, -1, 3f, 8, 0);
			BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
...
int func_529(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_532())
	{
		...
		{
			iVar2 = func_435(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_530()
{
	...
	iVar0 = func_438(&(Global_92955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_532()
{
	...
	{
		if (func_435(&(Global_92955.f_3)) > -1)
		{
			return 1;
		}
	}
