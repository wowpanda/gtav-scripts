	...
	switch (iLocal_115)
	{
		...
		case 2:
			if (func_510(iLocal_106))
			{
				...
				CAM::PLAY_CAM_ANIM(iLocal_599, "leadout_ef_3_mcs_maryann_cam", "rcmfanatic3leadinoutef_3_mcs_1", ENTITY::GET_ENTITY_COORDS(iLocal_106, 1), ENTITY::GET_ENTITY_ROTATION(iLocal_106, 2), 0, 2);
...
void func_17()
{
	...
	{
		if (func_20(Global_104555.f_2353.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
int func_51(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_94(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_94(iParam1), Global_70671[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_94(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, 0);
		}
	}
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_70671[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_94(iVar0), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_94(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_94(iVar0), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, iParam4);
						}
						func_85(iVar0);
						if (Global_70669 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_94(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_94(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_94(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, iParam4);
		}
		if (Global_70669 == 1)
		{
			iVar2 = 0;
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_105(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
		...
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_105(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_166(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_70671[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_94(iParam1)) && Global_70671[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_94(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_223(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_227(PLAYER::PLAYER_ID())) && !func_225(PLAYER::PLAYER_ID(), 0)) && !func_224())
			{
...
void func_268()
{
	...
	switch (iLocal_57)
	{
		...
		case 1:
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_80[iLocal_100 /*3*/], true) > 75f)
			{
				if (!iLocal_144)
				{
...
int func_269(var uParam0)
{
	...
	if (fVar1 < 5.5f)
	{
		...
		else
		{
			...
			if (iLocal_100 == (iLocal_99 - 1))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
				{
					fVar14 = MISC::GET_DISTANCE_BETWEEN_COORDS(*(uParam0[iLocal_100 /*3*/]), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), true);
					if (iLocal_90 != 0)
					{
						if (fVar14 > 100f)
						{
			...
			else
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
				{
					fVar20 = MISC::GET_DISTANCE_BETWEEN_COORDS(*(uParam0[iLocal_100 /*3*/]), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), true);
					if (iLocal_90 != 0)
					{
						if (fVar20 > 100f)
						{
	...
	else
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			fVar25 = MISC::GET_DISTANCE_BETWEEN_COORDS(*(uParam0[iLocal_100 /*3*/]), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), true);
			if (iLocal_90 != 0)
			{
				if (fVar25 > 100f)
				{
...
void func_304()
{
	if (!func_306(&uLocal_494, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
	{
		if (iLocal_136)
		{
...
int func_321(var uParam0)
{
	...
	if (func_510(iLocal_106))
	{
		...
		{
			vVar0 = { ENTITY::GET_ENTITY_COORDS(iLocal_106, 1) };
	...
	if (iLocal_56 == 3 && iLocal_55 == 3)
	{
		if (iLocal_103 == 1)
		{
			if (func_510(iLocal_106) && func_510(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_107, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), &iVar0);
					if ((MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_106, 1), true) > 65f && iVar0 > 26) && BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_63))
					{
						if (func_510(iLocal_63))
						{
							if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_63))
							{
								BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_107, ENTITY::GET_ENTITY_COORDS(iLocal_63, 1), &uVar1);
								BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_107, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), &iVar0);
							}
							iVar0 = (iVar0 - 5);
							BRAIN::WAYPOINT_RECORDING_GET_COORD(sLocal_107, iVar0, &vVar2);
							BRAIN::WAYPOINT_RECORDING_GET_COORD(sLocal_107, iVar0 + 1, &vVar3);
							if (!CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(iLocal_106, 1), 3f) && !CAM::IS_SPHERE_VISIBLE(vVar2, 3f))
							{
...
void func_329()
{
	...
	fVar2 = 2f;
	fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_106, 1), true);
	if (fVar0 > 45f)
	{
		fVar0 = 45f;
	}
		...
		else if (iLocal_56 == 3)
		{
			...
			if (func_510(iLocal_63))
			{
				if (BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED("Fan3_pedBike") && BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED("Fan3_pedBikePrep"))
				{
					if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_63))
					{
						BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_107, ENTITY::GET_ENTITY_COORDS(iLocal_63, 1), &iVar3);
						if (MISC::ARE_STRINGS_EQUAL(sLocal_107, "Fan3_pedBike"))
						{
	...
	else if (iLocal_56 == 3)
	{
		if (func_510(iLocal_63))
		{
			if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_63))
			{
				BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_107, ENTITY::GET_ENTITY_COORDS(iLocal_63, 1), &iVar5);
				if (MISC::ARE_STRINGS_EQUAL(sLocal_107, "Fan3_pedBike"))
				{
...
void func_330(int iParam0)
{
	...
	if (func_510(iLocal_63))
	{
		...
		{
			BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_107, ENTITY::GET_ENTITY_COORDS(iLocal_63, 1), &iParam0);
...
void func_339()
{
	if (func_510(iLocal_106))
	{
		if ((func_290(iLocal_106, 1, 0, 0, 0) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_106, 1), 40f, 0)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_106, PLAYER::PLAYER_PED_ID(), 1))
		{
			func_337();
		}
		...
		{
			if (!func_306(&uLocal_546, ENTITY::GET_ENTITY_COORDS(iLocal_106, 1)))
			{
		...
		if (iLocal_103 == 2)
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_106, 1), true) >= 300f)
			{
				func_267(3);
			}
		}
...
void func_340()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_106))
	{
		...
		{
			vLocal_89 = { ENTITY::GET_ENTITY_COORDS(iLocal_106, 1) };
		}
	}
...
void func_355(var uParam0)
{
	...
	if (iLocal_100 == (iLocal_99 - 1))
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			fVar4 = MISC::GET_DISTANCE_BETWEEN_COORDS(*(uParam0[iLocal_100 /*3*/]), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), true);
			if (iLocal_90 != 0)
			{
				if (fVar4 > 100f)
				{
	...
	else
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0))
		{
			fVar9 = MISC::GET_DISTANCE_BETWEEN_COORDS(*(uParam0[iLocal_100 /*3*/]), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), true);
			if (iLocal_90 != 0)
			{
				if (fVar9 > 100f)
				{
...
{
	func_370(&Global_98118, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_387(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2547365[iParam0 /*3*/][func_88(iParam1)];
...
void func_470()
{
	...
	if (!func_455())
	{
		...
		func_474(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
	}
	if (func_510(iLocal_106))
	{
		BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_106);
...
{
	if (((!func_504(0) || Global_71125) || Global_71114 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71110)
