...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			if (!func_26() || func_24(CAM::_0xDC9DA9E8789F5246(), 0))
			{
				if ((((((((!Global_18044C && !func_23(3)) && !func_20(CAM::_0xDC9DA9E8789F5246(), 0)) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) && PLAYER::IS_PLAYER_CONTROL_ON(CAM::_0xDC9DA9E8789F5246())) && !func_18(CAM::_0xDC9DA9E8789F5246())) && !func_16(func_17(CAM::_0xDC9DA9E8789F5246()))) && !func_14(CAM::_0xDC9DA9E8789F5246(), 146)) && !func_10(CAM::_0xDC9DA9E8789F5246()))
				{
					if (func_9(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 0), 4, 100, 0))
					{
...
float func_2(var uParam0)//Position - 0x259
{
	if (func_8(uParam0))
	{
		...
		{
			return (func_3(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
int func_28()//Position - 0x13AD
{
	...
	{
		case 0:
			if (Global_18044C || func_23(3))
			{
				Local_115.f_4 = PED::ADD_SCENARIO_BLOCKING_AREA(1413.703f, 2341.517f, -232.3945f, 2016.209f, 2998.893f, 161.0299f, 0, 1, 1, 1);
			}
			func_29(&(uLocal_114[NETSHOP::_NETWORK_SHOP_BASKET_START()]), 1);
			Local_115 = 1;
			break;
		
		case 1:
			if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 0), 1693.164f, 2559.616f, 44.5649f) >= 1030225f)
			{
				Local_115 = 2;
			}
			break;
