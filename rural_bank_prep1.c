	...
	switch (iLocal_1295)
	{
		...
		case 2:
			...
			while (iVar0 <= (9 - 1))
			{
				...
				{
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_68[iVar0 /*14*/], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), true) < 400f)
					{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_95149.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_95149.f_4, 0))
		{
			if (func_140(24) != Global_95149.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_137(ENTITY::GET_ENTITY_COORDS(Global_95149.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
void func_145()
{
	...
	if (func_31(Local_65[0 /*2*/]) && func_31(PLAYER::PLAYER_PED_ID()))
	{
		if (iLocal_1294 > 0)
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_65[0 /*2*/], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), true) > 650f)
			{
				func_187(5);
			}
			else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_65[0 /*2*/], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), true) > 600f)
			{
				if (!iLocal_277)
				{
	...
	if (!iLocal_267)
	{
		...
		if (fLocal_264 < 3f)
		{
			...
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_89475[iVar2]))
				{
					if (ENTITY::IS_ENTITY_DEAD(Global_89475[iVar2], 0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Global_89475[iVar2], 0))
					{
						iVar4 = VEHICLE::GET_VEHICLE_CAUSE_OF_DESTRUCTION(Global_89475[iVar2]);
	...
	if (!iLocal_266)
	{
		if (func_148(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 3, 0, 0))
		{
			iLocal_266 = 1;
	...
	else if (!func_148(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 3, 0, 0))
	{
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
		{
	...
	else if (iLocal_1294 >= 1)
	{
		if (AUDIO::IS_AUDIO_SCENE_ACTIVE("PS_PREP_INTERCEPT_CONVOY"))
		{
			...
			while (iVar2 <= 3)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_89475[iVar2]))
				{
					AUDIO::_0x18EB48CFC41F2EA0(Global_89475[iVar2], 0);
				}
				iVar2++;
			}
		}
...
void func_150()
{
	...
	if (iLocal_260 == 3 || iLocal_260 == 1)
	{
		...
		OBJECT::_SET_DOOR_AJAR_ANGLE(Global_34984[20 /*31*/], fLocal_262, 0, 1);
		OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Global_34984[20 /*31*/], 4, 0, 1);
	}
}
		...
		if (!PED::IS_PED_INJURED(iVar1))
		{
			...
			else if (func_159(iVar1) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, 1))
			{
				...
				else if (!BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_65[0 /*2*/]))
				{
					...
					{
						BRAIN::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iVar1, Local_65[0 /*2*/], sLocal_305, 786469, 0, 8, -1, 10f, 0, 2f);
					}
				}
			}
	...
	switch (iLocal_257)
	{
		case 0:
			...
			else
			{
				if (func_31(Local_65[0 /*2*/]))
				{
					vLocal_283 = { ENTITY::GET_ENTITY_COORDS(Local_65[0 /*2*/], 0) };
				}
				iLocal_259 = 0;
				iLocal_258 = 0;
				iLocal_257 = 1;
		...
		case 2:
			...
			else
			{
				if (func_31(Local_65[0 /*2*/]))
				{
					vLocal_283 = { ENTITY::GET_ENTITY_COORDS(Local_65[0 /*2*/], 1) };
				}
				iLocal_259 = 0;
				iLocal_258 = 0;
				iLocal_257 = 1;
			...
			switch (iLocal_258)
			{
				...
				case 2:
					...
					while (iVar0 <= (9 - 1))
					{
						if (func_31(Local_68[iVar0 /*14*/]) && func_31(PLAYER::PLAYER_PED_ID()))
						{
							...
							if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_68[iVar0 /*14*/], 0), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), true) < 75f)
							{
				...
				case 3:
					...
					while (iVar0 <= (9 - 1))
					{
						if (func_31(Local_68[iVar0 /*14*/]) && func_31(PLAYER::PLAYER_PED_ID()))
						{
							if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_68[iVar0 /*14*/], 0), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), true) > 120f)
							{
								PED::SET_PED_COMBAT_MOVEMENT(Local_68[iVar0 /*14*/], 1);
								PED::SET_PED_COMBAT_ATTRIBUTES(Local_68[iVar0 /*14*/], 51, false);
								Local_68[iVar0 /*14*/].f_12 = 0;
				...
				case 4:
					...
					while (iVar0 <= (9 - 1))
					{
						if ((func_31(PLAYER::PLAYER_PED_ID()) && func_31(Local_68[iVar0 /*14*/])) && func_31(Local_65[0 /*2*/]))
						{
							...
							else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_65[0 /*2*/], 0) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_65[0 /*2*/], 0), ENTITY::GET_ENTITY_COORDS(Local_68[iVar0 /*14*/], 0), true) > (120f / 2f))
							{
								PED::SET_PED_COMBAT_ATTRIBUTES(Local_68[iVar0 /*14*/], 1, true);
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_68[iVar0 /*14*/], 0), true) > (120f * 2f))
								{
...
void func_174()
{
	...
	if (func_31(Local_65[1 /*2*/]))
	{
		...
		if (func_178(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(Local_65[1 /*2*/], 0), 30f, 0))
		{
			bLocal_279 = true;
		}
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			vVar1 = { func_177(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0) - ENTITY::GET_ENTITY_COORDS(Local_65[1 /*2*/], 0)) };
	...
	if (func_31(Local_65[2 /*2*/]))
	{
		...
		if (func_178(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(Local_65[2 /*2*/], 0), 30f, 0))
		{
			bLocal_279 = true;
		}
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			vVar3 = { func_177(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0) - ENTITY::GET_ENTITY_COORDS(Local_65[2 /*2*/], 0)) };
	...
	if (func_31(Local_65[0 /*2*/]))
	{
		...
		if (func_178(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(Local_65[0 /*2*/], 0), 30f, 0))
		{
			bLocal_279 = true;
		}
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			vVar5 = { func_177(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0) - ENTITY::GET_ENTITY_COORDS(Local_65[0 /*2*/], 0)) };
		...
		if (func_175())
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar7, 0))
			{
				...
				vVar8 = { func_177(ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0) - ENTITY::GET_ENTITY_COORDS(Local_65[0 /*2*/], 0)) };
		...
		switch (iLocal_256)
		{
			case 0:
				...
				if (fLocal_1300[1] > 1.5f)
				{
					...
					BRAIN::TASK_AIM_GUN_AT_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1000, 0, 1);
...
void func_237(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	if (func_260(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		iVar1 = 0;
...
int func_242(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_249() || func_248(Global_4456448.f_143970)) || func_247())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if ((VEHICLE::_0xE33FFA906CE74880(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), func_246(PLAYER::PLAYER_PED_ID(), 0)) || (ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) == joaat("apc") && func_246(PLAYER::PLAYER_PED_ID(), 0) != -1)) || (ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) == joaat("akula") && func_246(PLAYER::PLAYER_PED_ID(), 0) != -1))
			{
				return 0;
			}
		}
...
void func_252(var uParam0, int iParam1, vector3 vParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_253()
{
	return func_254(PLAYER::PLAYER_ID());
}
...
int func_255(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_258(bParam1, bParam2, bParam3) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || func_256(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
{
	func_268(&Global_98118, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_268(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_19();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_284())
		{
			func_277(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
...
int func_281(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2547365[iParam0 /*3*/][func_279(iParam1)];
...
int func_294(vector3 vParam0, char* sParam1, vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
int func_296(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_316())
		{
			*uParam0 = func_302(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_298(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_300() == 0)
		{
			return MISC::IS_BIT_SET(func_278(func_299(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_302(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 47)
	{
		if (iParam1 == 6 || iParam1 == func_315(iVar0))
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_303(iVar0, 0), true);
...
Vector3 func_307(vector3 vParam0, float fParam1)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
int func_329()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_65[0 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89475[0]))
		{
			...
			AUDIO::_0x18EB48CFC41F2EA0(Global_89475[0], 0);
			AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_65[0 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
			func_205(Local_65[0 /*2*/], 0);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_65[1 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89475[1]))
		{
			...
			AUDIO::_0x18EB48CFC41F2EA0(Global_89475[1], 0);
			AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_65[1 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_65[2 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89475[2]))
		{
			...
			AUDIO::_0x18EB48CFC41F2EA0(Global_89475[2], 0);
			AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_65[2 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89475.f_9[9]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89475.f_9[9], true, 1);
...
void func_331(vector3 vParam0, var uParam1, int iParam2, int iParam3)
{
	if (func_203())
	{
