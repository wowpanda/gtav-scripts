...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_263(&uLocal_494);
		if (((((iLocal_1480 == 0 && DOES_ENTITY_EXIST(Local_94[0 /*2*/])) && IS_VEHICLE_DRIVEABLE(Local_94[0 /*2*/], 0)) && !IS_PED_INJURED(PLAYER_PED_ID())) && !IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_94[0 /*2*/], 0)) && VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(Local_94[0 /*2*/], 1)) < 5625f)
		{
			bVar0 = false;
...
void func_8()
{
	...
	switch (iLocal_1481)
	{
		...
		case 1:
			if (func_40(&Local_403, vLocal_49, 0.1f, 0.1f, 2f, 1, Local_94[0 /*2*/], "RHP_RTN", "", "RHP_BK", 1, 0, 1, -1) || (DOES_BLIP_EXIST(Local_403.f_5) && IS_ENTITY_IN_ANGLED_AREA(Local_94[0 /*2*/], 1359.476f, 3614.326f, 36.87141f, 1356.748f, 3621.605f, 33.72731f, 5f, 0, 1, 0)))
			{
		...
		case 2:
			...
			while (iVar0 <= (9 - 1))
			{
				if (func_31(Local_111[iVar0 /*14*/]))
				{
					...
					{
						if (!IS_PED_IN_COMBAT(Local_111[iVar0 /*14*/], 0))
						{
...
void func_33(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 3)
	{
		if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
		{
			...
			if (bParam1)
			{
				if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_34()) && uParam0->f_17[iVar0] != PLAYER_PED_ID())
				{
...
int func_38(var uParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
int func_40(var uParam0, vector3 vParam1, vector3 vParam4, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11, bool bParam12, int iParam13, bool bParam14, int iParam15)
{
	return func_41(uParam0, vParam1, vParam4, func_82(), func_82(), iParam7, 5, 0, 0, 0, iParam8, sParam9, func_81(), func_81(), func_81(), func_81(), sParam10, 0, bParam12, sParam11, 0, iParam13, bParam14, iParam15, 0, 0, 0, 1, 1065353216);
}

int func_41(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, char* sParam19, char* sParam20, char* sParam21, char* sParam22, char* sParam23, char* sParam24, bool bParam25, bool bParam26, char* sParam27, bool bParam28, int iParam29, bool bParam30, int iParam31, int iParam32, int iParam33, int iParam34, bool bParam35, int iParam36)
{
	var uVar0;
	bool bVar1;
	int iVar2;
					...
					if (bVar1)
					{
						...
						while (iVar2 < 3)
						{
							if (!IS_PED_INJURED(uParam0->f_17[iVar2]))
							{
								...
								else if (!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar2], func_34()) || !func_48(uParam0->f_17[iVar2], 1))
								{
									bVar1 = false;
								}
							}
...
int func_43(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_44(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		SET_BLIP_SCALE(uVar0, func_44(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
int func_48(var uParam0, int iParam1)
{
	if (!IS_PED_INJURED(uParam0))
	{
		...
		else if (IS_PED_GROUP_MEMBER(uParam0, func_34()))
		{
			SET_GROUP_SEPARATION_RANGE(func_34(), 50f);
			return 1;
		}
		...
		while (iVar0 < 3)
		{
			if (DOES_ENTITY_EXIST(uParam0->f_17[iVar0]))
			{
				if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
				{
					...
					if ((!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_34()) && !func_69(uParam0->f_17[iVar0], iParam10)) && !func_68(uParam0->f_17[iVar0], iParam10))
					{
...
int func_68(var uParam0, int iParam1)
{
	...
	if (!IS_PED_INJURED(uParam0))
	{
		if (!IS_PED_GROUP_MEMBER(uParam0, func_34()))
		{
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_87(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_107(iParam0, 0, 0)) || func_107(iParam0, 1, 0)) || func_107(iParam0, 2, 0)) || func_106(iParam0) != 145) || func_105(iParam0)) || func_104(iParam0)) || func_103(iParam0)) || func_102(iParam0)) || !func_92(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_104(iParam0))
		{
		}
			...
			while (iVar0 <= 8)
			{
				if (func_31(Local_111[iVar0 /*14*/]))
				{
					if (!iLocal_450)
					{
						...
						func_141();
						_PLAY_AMBIENT_SPEECH1(Local_111[iVar0 /*14*/], "GENERIC_WAR_CRY", func_54(3), 1);
						iLocal_450 = 1;
					}
				}
				iVar0++;
			}
			SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_493);
			_0x293220DA1B46CEBC(3f, 5f, 4);
			iLocal_1481++;
			break;
...
{
	return func_43(uParam0, !bParam1, bParam2);
}
...
void func_112(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	vector3 vVar0;
	var uVar3;
	...
	if (DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_140(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_137(GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_113(Global_97130.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_113(int iParam0, vector3 vParam1, var uParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (DOES_ENTITY_EXIST(iParam0) && IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_129(iParam5, &Var0, vParam1, uParam4, func_106(iParam0));
...
var func_115()
{
	...
	func_125(&uVar0, GET_CLOCK_SECONDS());
	func_124(&uVar0, GET_CLOCK_MINUTES());
	func_123(&uVar0, GET_CLOCK_HOURS());
...
{
	return (SHIFT_RIGHT(uParam0, 26) & 31 * func_121(IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_129(int iParam0, var uParam1, vector3 vParam2, var uParam5, int iParam6)
{
	if (func_126(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
...
int func_137(vector3 vParam0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;
	
	iVar0 = func_138(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
void func_145()
{
	...
	while (iLocal_447 <= (9 - 1))
	{
		...
		if ((((func_31(Local_111[iLocal_447 /*14*/]) && (GET_GAME_TIMER() - iLocal_455) > 8000) && bLocal_456) && !IS_AMBIENT_SPEECH_PLAYING(Local_111[iLocal_447 /*14*/])) && !IS_PED_IN_ANY_VEHICLE(Local_111[iLocal_447 /*14*/], 0))
		{
			if (GET_ENTITY_HEALTH(Local_111[iLocal_447 /*14*/]) < 110)
			{
				_PLAY_AMBIENT_SPEECH1(Local_111[iLocal_447 /*14*/], "DYING_MOAN", func_54(3), 1);
				iLocal_455 = GET_GAME_TIMER();
			}
			else if (GET_ENTITY_HEALTH(Local_111[iLocal_447 /*14*/]) < 140)
			{
				_PLAY_AMBIENT_SPEECH1(Local_111[iLocal_447 /*14*/], "DYING_HELP", func_54(3), 1);
				iLocal_455 = GET_GAME_TIMER();
			}
			else if (IS_PED_GOING_INTO_COVER(Local_111[iLocal_447 /*14*/]))
			{
				_PLAY_AMBIENT_SPEECH1(Local_111[iLocal_447 /*14*/], "TAKE_COVER", func_54(3), 1);
				iLocal_455 = GET_GAME_TIMER();
			}
			else if (IS_PED_RUNNING(Local_111[iLocal_447 /*14*/]))
			{
				_PLAY_AMBIENT_SPEECH1(Local_111[iLocal_447 /*14*/], "COVER_ME", func_54(3), 1);
				iLocal_455 = GET_GAME_TIMER();
			}
			else if (IS_PED_SHOOTING(Local_111[iLocal_447 /*14*/]))
			{
				_PLAY_AMBIENT_SPEECH1(Local_111[iLocal_447 /*14*/], "COVER_YOU", func_54(3), 1);
				iLocal_455 = GET_GAME_TIMER();
			}
			else if (!IS_PED_WEAPON_READY_TO_SHOOT(Local_111[iLocal_447 /*14*/]))
			{
				_PLAY_AMBIENT_SPEECH1(Local_111[iLocal_447 /*14*/], "RELOADING", func_54(3), 1);
				iLocal_455 = GET_GAME_TIMER();
			}
			else if (func_182(Local_111[iLocal_447 /*14*/], -828834893, 1) || func_182(Local_111[iLocal_447 /*14*/], 451360105, 1))
			{
				_PLAY_AMBIENT_SPEECH1(Local_111[iLocal_447 /*14*/], "GENERIC_WAR_CRY", func_54(3), 1);
				iLocal_455 = GET_GAME_TIMER();
			}
		}
		iLocal_447++;
	...
	{
		if (IS_ENTITY_IN_ANGLED_AREA(Local_94[0 /*2*/], -1521.829f, 2725.003f, 16.64367f, -1600.763f, 2794.875f, 21.45629f, 30f, 0, 1, 0) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_94[0 /*2*/], 0))
		{
	...
	if (func_31(Local_94[0 /*2*/]))
	{
		...
		if (bVar0)
		{
			if ((!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_94[0 /*2*/], 0) && !IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) && !IS_PED_SHOOTING(PLAYER_PED_ID()))
			{
	...
	if (!iLocal_444)
	{
		...
		else if (iLocal_1480 == 1)
		{
			if (fLocal_441 < 5f)
			{
				fLocal_441 = (fLocal_441 + GET_FRAME_TIME());
			}
		}
		if (fLocal_441 < 3f)
		{
			...
			{
				if (DOES_ENTITY_EXIST(Global_90209[iVar2]))
				{
					if (IS_ENTITY_DEAD(Global_90209[iVar2], 0) || !IS_VEHICLE_DRIVEABLE(Global_90209[iVar2], 0))
					{
						iVar4 = GET_VEHICLE_CAUSE_OF_DESTRUCTION(Global_90209[iVar2]);
	...
	if (!iLocal_443)
	{
		if (func_148(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 3, 0, 0))
		{
			iLocal_443 = 1;
			_0xD9F692D349249528();
	...
	else if (!func_148(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 3, 0, 0))
	{
		if (GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) == 0)
		{
			...
			ENABLE_DISPATCH_SERVICE(10, 0);
			ENABLE_DISPATCH_SERVICE(9, 0);
	...
	if (DOES_ENTITY_EXIST(PLAYER_PED_ID()) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if (!iLocal_1491)
			{
				func_147(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 725);
				func_146(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 718);
				iLocal_1491 = 1;
			}
		}
		else if (iLocal_1491)
	...
	if (!iLocal_442)
	{
		...
		{
			SET_ENTITY_AS_MISSION_ENTITY(iVar5, 1, 1);
			iLocal_428 = iVar5;
		}
	}
}
...
int func_148(vector3 vParam0, int iParam3, int iParam4, bool bParam5)
{
	vector3 vVar0[15];
	vector3 vVar46[15];
	float fVar92[15];
	...
	else if (iLocal_1480 >= 1)
	{
		if (IS_AUDIO_SCENE_ACTIVE("PS_PREP_INTERCEPT_CONVOY"))
		{
			...
			while (iVar1 < 3)
			{
				...
				{
					_0x18EB48CFC41F2EA0(Local_94[1 /*2*/], 0);
				}
				iVar1++;
			}
			iVar2 = 0;
			while (iVar2 <= 3)
			{
				if (DOES_ENTITY_EXIST(Global_90209[iVar2]))
				{
					_0x18EB48CFC41F2EA0(Global_90209[iVar2], 0);
				}
				iVar2++;
			}
		}
...
void func_150()
{
	...
	if (iLocal_437 == 3 || iLocal_437 == 1)
	{
		...
		_SET_DOOR_AJAR_ANGLE(Global_35548[20 /*31*/], fLocal_439, 0, 1);
		_SET_DOOR_ACCELERATION_LIMIT(Global_35548[20 /*31*/], 4, 0, 1);
	}
}
...
int func_153()
{
	...
	while (iVar0 < 3)
	{
		if ((DOES_ENTITY_EXIST(Local_94[iVar0 /*2*/]) && IS_VEHICLE_DRIVEABLE(Local_94[iVar0 /*2*/], 0)) && IS_ENTITY_IN_ANGLED_AREA(Local_94[iVar0 /*2*/], -1591.019f, 2803.731f, 15.41812f, -1569.92f, 2777.878f, 22.14856f, 8.25f, 0, 1, 0))
		{
			return 1;
		}
		iVar0++;
...
void func_154()
{
	...
	while (iVar0 < 3)
	{
		...
		if (!IS_PED_INJURED(iVar1))
		{
			...
			else if (func_159(iVar1) && DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, 1))
			{
				REQUEST_WAYPOINT_RECORDING(sLocal_491);
				bLocal_1490 = IS_ENTITY_IN_ANGLED_AREA(iVar1, 1365.772f, 3625.582f, 33.69244f, 1374.662f, 3598.951f, 36.8947f, 34f, 0, 1, 0);
				if (!bLocal_1490)
				{
			...
			else if (func_157(iVar1) && DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, 1))
			{
...
int func_159(int iParam0)
{
	if (!func_158())
	{
		if (func_31(Local_94[0 /*2*/]) && !IS_ENTITY_IN_ANGLED_AREA(Local_94[0 /*2*/], 1364.248f, 3620.511f, 33.89069f, 1350.9f, 3616.225f, 37.12358f, 6.5f, 0, 1, 0))
		{
			if (func_31(PLAYER_PED_ID()) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_94[0 /*2*/], 0))
			{
				if (IS_PED_IN_VEHICLE(iParam0, Local_94[0 /*2*/], 0) && GET_PED_IN_VEHICLE_SEAT(Local_94[0 /*2*/], -1, 0) == iParam0)
				{
					return 1;
				}
			}
	...
	switch (iLocal_434)
	{
		case 0:
			if (!bLocal_456)
			{
				...
				{
					if (IS_ENTITY_IN_ANGLED_AREA(Local_94[0 /*2*/], -1521.829f, 2725.003f, 16.64367f, -1600.763f, 2794.875f, 21.45629f, 30f, 0, 1, 0) && IS_PED_IN_VEHICLE(Local_111[4 /*14*/], Local_94[0 /*2*/], 0))
					{
						iLocal_434 = 2;
						iLocal_471 = 0;
					}
					...
					{
						SET_DRIVE_TASK_CRUISE_SPEED(Local_111[0 /*14*/], uVar2);
					}
				}
			}
			else
						...
						case 0:
							if (!func_182(Local_111[0 /*14*/], 242628503, 1))
							{
								if (iLocal_437 == 2 || (iLocal_437 == 3 && fLocal_439 > 0.8f))
								{
									...
									TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_94[1 /*2*/], -1785.46f, 3169.625f, 31.93f, 4, 10f, 786603, 3f, 3f, 1);
									TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_94[1 /*2*/], -1885.875f, 3006.152f, 31.81027f, 4, 10f, 786603, -1f, -1f, 1);
									CLOSE_SEQUENCE_TASK(uVar4);
									TASK_PERFORM_SEQUENCE(Local_111[0 /*14*/], uVar4);
							...
							if (IS_ENTITY_AT_COORD(Local_111[0 /*14*/], -1885.875f, 3006.152f, 31.81027f, 5f, 5f, 5f, 0, 1, 0))
							{
								iVar0 = 0;
								while (iVar0 <= (9 - 1))
								{
									if (func_31(Local_111[iVar0 /*14*/]))
									{
										...
										SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 3, 1);
										SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 1, 1);
										...
										{
											TASK_LEAVE_ANY_VEHICLE(Local_111[iVar0 /*14*/], 0, 65536);
										}
										else
										{
		...
		case 1:
			GET_CLOSEST_PED(vLocal_460, 50f, 1, 0, &uVar5, 0, 0, -1);
			if (func_31(uVar5))
			{
				SET_PED_FLEE_ATTRIBUTES(uVar5, 2, 0);
				SET_PED_FLEE_ATTRIBUTES(uVar5, 2048, 0);
			}
			switch (iLocal_435)
			{
				case 0:
					switch (iLocal_436)
					{
						...
						case 1:
							if (func_31(Local_111[0 /*14*/]) && func_31(Local_94[1 /*2*/]))
							{
								...
								{
									OPEN_SEQUENCE_TASK(&uLocal_446);
									if (GET_ENTITY_SPEED(Local_111[0 /*14*/]) > 5f)
									{
										TASK_VEHICLE_TEMP_ACTION(0, Local_94[1 /*2*/], 5, 1000);
									}
									else
									{
										TASK_VEHICLE_TEMP_ACTION(0, Local_94[1 /*2*/], 14, 1500);
									}
									TASK_LEAVE_ANY_VEHICLE(0, 720, 65536);
									CLOSE_SEQUENCE_TASK(uLocal_446);
									TASK_PERFORM_SEQUENCE(Local_111[0 /*14*/], uLocal_446);
									CLEAR_SEQUENCE_TASK(&uLocal_446);
								}
							}
							if (func_31(Local_111[4 /*14*/]) && func_31(Local_94[0 /*2*/]))
							{
								if (IS_PED_IN_VEHICLE(Local_111[4 /*14*/], Local_94[0 /*2*/], 0))
								{
									...
									{
										TASK_VEHICLE_TEMP_ACTION(0, Local_94[0 /*2*/], 4, 2500);
									}
									else
									{
										TASK_VEHICLE_TEMP_ACTION(0, Local_94[0 /*2*/], 13, 1500);
									}
									TASK_LEAVE_ANY_VEHICLE(0, 500, 65536);
									CLOSE_SEQUENCE_TASK(uLocal_446);
									TASK_PERFORM_SEQUENCE(Local_111[4 /*14*/], uLocal_446);
									CLEAR_SEQUENCE_TASK(&uLocal_446);
								}
							}
							if ((func_31(Local_111[5 /*14*/]) && func_31(Local_94[2 /*2*/])) && func_31(Local_94[1 /*2*/]))
							{
								if (IS_PED_IN_VEHICLE(Local_111[5 /*14*/], Local_94[2 /*2*/], 0))
								{
									...
									{
										TASK_VEHICLE_DRIVE_TO_COORD(0, Local_94[2 /*2*/], GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_94[1 /*2*/], -3f, 0f, 0f), 10f, 0, joaat("crusader"), 786469, 4f, -1f);
									}
									TASK_VEHICLE_TEMP_ACTION(0, Local_94[2 /*2*/], 5, 1000);
									TASK_LEAVE_ANY_VEHICLE(0, 0, 65536);
									CLOSE_SEQUENCE_TASK(uLocal_446);
									TASK_PERFORM_SEQUENCE(Local_111[5 /*14*/], uLocal_446);
									CLEAR_SEQUENCE_TASK(&uLocal_446);
								}
							}
							iLocal_435 = 1;
						...
						case 2:
							if (func_31(Local_111[0 /*14*/]) && func_31(Local_94[1 /*2*/]))
							{
								...
								{
									OPEN_SEQUENCE_TASK(&uLocal_446);
									TASK_VEHICLE_TEMP_ACTION(0, Local_94[1 /*2*/], 5, 1500);
							...
							if (func_31(Local_111[4 /*14*/]) && func_31(Local_94[0 /*2*/]))
							{
								...
								{
									OPEN_SEQUENCE_TASK(&uLocal_446);
									TASK_VEHICLE_TEMP_ACTION(0, Local_94[0 /*2*/], 5, 1000);
							...
							if ((func_31(Local_111[5 /*14*/]) && func_31(Local_94[2 /*2*/])) && func_31(Local_94[0 /*2*/]))
							{
								if (IS_PED_IN_VEHICLE(Local_111[5 /*14*/], Local_94[2 /*2*/], 0))
								{
									...
									{
										TASK_VEHICLE_DRIVE_TO_COORD(0, Local_94[2 /*2*/], GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_94[0 /*2*/], -2f, 1f, 0f), 10f, 0, joaat("crusader"), 786469, 4f, -1f);
									}
						...
						case 3:
							if ((func_31(Local_111[0 /*14*/]) && func_31(Local_94[1 /*2*/])) && func_31(Local_94[2 /*2*/]))
							{
								...
								{
									OPEN_SEQUENCE_TASK(&uLocal_446);
									TASK_VEHICLE_TEMP_ACTION(0, Local_94[1 /*2*/], 6, 500);
									if (VDIST2(GET_ENTITY_COORDS(Local_94[1 /*2*/], 0), GET_ENTITY_COORDS(Local_94[2 /*2*/], 0)) < 1000f)
									{
										TASK_VEHICLE_DRIVE_TO_COORD(0, Local_94[1 /*2*/], GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_94[2 /*2*/], 2f, 0f, 0f), 10f, 0, joaat("crusader"), 786469, 4f, -1f);
									}
									TASK_VEHICLE_TEMP_ACTION(0, Local_94[1 /*2*/], 5, 1000);
							...
							if (func_31(Local_111[4 /*14*/]) && func_31(Local_94[0 /*2*/]))
							{
								if (IS_PED_IN_VEHICLE(Local_111[4 /*14*/], Local_94[0 /*2*/], 0))
								{
									...
									{
										OPEN_SEQUENCE_TASK(&uLocal_446);
										TASK_VEHICLE_TEMP_ACTION(0, Local_94[0 /*2*/], 5, 1500);
							...
							if (func_31(Local_111[5 /*14*/]) && func_31(Local_94[2 /*2*/]))
							{
								if (IS_PED_IN_VEHICLE(Local_111[5 /*14*/], Local_94[2 /*2*/], 0))
								{
									...
									{
										OPEN_SEQUENCE_TASK(&uLocal_446);
										TASK_VEHICLE_TEMP_ACTION(0, Local_94[2 /*2*/], 4, 1500);
						...
						case 4:
							if (func_31(Local_111[0 /*14*/]) && func_31(Local_94[1 /*2*/]))
							{
								...
								{
									OPEN_SEQUENCE_TASK(&uLocal_446);
									TASK_VEHICLE_TEMP_ACTION(0, Local_94[1 /*2*/], 4, 1500);
							...
							if (func_31(Local_111[4 /*14*/]) && func_31(Local_94[0 /*2*/]))
							{
								...
								{
									OPEN_SEQUENCE_TASK(&uLocal_446);
									TASK_VEHICLE_TEMP_ACTION(0, Local_94[0 /*2*/], 4, 1500);
				...
				case 1:
					...
					while (iVar0 <= (9 - 1))
					{
						if (func_31(Local_111[iVar0 /*14*/]) && func_31(PLAYER_PED_ID()))
						{
							...
							SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 0, 1);
							SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 50, 1);
							SET_PED_CONFIG_FLAG(Local_111[iVar0 /*14*/], 184, 0);
							...
							if ((iVar0 != 0 && iVar0 != 4) && iVar0 != 5)
							{
								...
								CLOSE_SEQUENCE_TASK(uLocal_446);
								TASK_PERFORM_SEQUENCE(Local_111[iVar0 /*14*/], uLocal_446);
								CLEAR_SEQUENCE_TASK(&uLocal_446);
								SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 3, 1);
							}
						}
					...
					while (iVar0 <= (9 - 1))
					{
						if (func_31(Local_111[iVar0 /*14*/]) && func_31(PLAYER_PED_ID()))
						{
							...
							if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(Local_111[iVar0 /*14*/], 0), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 1) < 75f)
							{
								...
								{
									SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 51, 1);
							...
							{
								SET_PED_COMBAT_MOVEMENT(Local_111[iVar0 /*14*/], 1);
								SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 51, 0);
				...
				case 4:
					if (func_169(PLAYER_PED_ID(), vLocal_49, 1) < 30f)
					{
						iVar7 = 1;
					}
					iVar0 = 0;
					while (iVar0 <= (9 - 1))
					{
						...
						{
							if (iVar7 && func_169(Local_111[iVar0 /*14*/], vLocal_49, 1) < 30f)
							{
								SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 1, 0);
								SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 3, 1);
							...
							else if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_94[0 /*2*/], 0) || GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(Local_94[0 /*2*/], 0), GET_ENTITY_COORDS(Local_111[iVar0 /*14*/], 0), 1) > (120f / 2f))
							{
								...
								if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(Local_111[iVar0 /*14*/], 0), 1) > (120f * 2f))
								{
									if (!IS_PED_IN_ANY_VEHICLE(Local_111[iVar0 /*14*/], 0) && !IS_ENTITY_ON_SCREEN(Local_111[iVar0 /*14*/]))
									{
										...
										{
											iVar8 = -1;
											if (IS_VEHICLE_SEAT_FREE(iVar9, -1, 0))
											{
												iVar8 = -1;
											}
											else if (IS_VEHICLE_SEAT_FREE(iVar9, 0, 0))
											{
												iVar8 = 0;
											}
											else if (IS_VEHICLE_SEAT_FREE(iVar9, 1, 0))
											{
												iVar8 = 1;
											}
											else if (IS_VEHICLE_SEAT_FREE(iVar9, 2, 0))
											{
												iVar8 = 2;
											}
											if (func_167(iVar9))
											{
												...
												SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 3, 0);
											}
											else
											{
												SET_PED_AS_NO_LONGER_NEEDED(&(Local_111[iVar0 /*14*/]));
									...
									else if (!IS_PED_IN_COMBAT(Local_111[iVar0 /*14*/], 0))
									{
										TASK_COMBAT_PED(Local_111[iVar0 /*14*/], PLAYER_PED_ID(), 0, 16);
									}
								}
								...
								{
									if (func_166(PLAYER_PED_ID(), Local_111[iVar0 /*14*/], 1) < 35f)
									{
										if (func_165(Local_111[iVar0 /*14*/], GET_VEHICLE_PED_IS_IN(Local_111[iVar0 /*14*/], 0)) == -1)
										{
										...
										if (GET_ENTITY_SPEED(PLAYER_PED_ID()) < 2f && func_166(PLAYER_PED_ID(), Local_111[iVar0 /*14*/], 1) < 20f)
										{
											SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*14*/], 3, 1);
										}
										else
...
float func_166(var uParam0, var uParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
var func_168(var uParam0)
{
	...
	{
		if (func_166(uParam0, Local_94[1 /*2*/], 1) < fVar1)
		{
			fVar1 = func_166(uParam0, Local_94[1 /*2*/], 1);
	...
	{
		if (func_166(uParam0, Local_94[2 /*2*/], 1) < fVar1)
		{
			fVar1 = func_166(uParam0, Local_94[2 /*2*/], 1);
...
float func_169(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
int func_170()
{
	...
	{
		if (func_169(Local_94[0 /*2*/], vLocal_460, 1) > 120f)
		{
			return 4;
		}
		else if (func_169(PLAYER_PED_ID(), vLocal_460, 1) <= 120f)
		{
			return 2;
		}
		else if (func_169(PLAYER_PED_ID(), vLocal_460, 1) > 120f && !IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_94[0 /*2*/], 0))
		{
			return 3;
		}
	}
...
void func_174()
{
	...
	while (iVar0 <= (9 - 1))
	{
		if (func_31(Local_111[iVar0 /*14*/]))
		{
			if (((((IS_PED_IN_COMBAT(Local_111[iVar0 /*14*/], 0) || IS_PED_IN_MELEE_COMBAT(Local_111[iVar0 /*14*/])) || IS_PED_BEING_STUNNED(Local_111[iVar0 /*14*/], 0)) || IS_PED_BEING_STEALTH_KILLED(Local_111[iVar0 /*14*/])) || IS_PED_BEING_JACKED(Local_111[iVar0 /*14*/])) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_111[iVar0 /*14*/], PLAYER_PED_ID(), 1))
			{
				bLocal_456 = true;
			}
	...
	if (func_31(Local_94[1 /*2*/]))
	{
		...
		if (func_178(0f, 0f, 0f, 0f, 0f, 0f, GET_ENTITY_COORDS(Local_94[1 /*2*/], 0), 30f, 0))
		{
			bLocal_456 = true;
		}
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			vVar1 = { func_177(GET_ENTITY_COORDS(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0) - GET_ENTITY_COORDS(Local_94[1 /*2*/], 0)) };
			vVar4 = { GET_ENTITY_VELOCITY(Local_94[1 /*2*/]) - GET_ENTITY_VELOCITY(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)) };
			fLocal_463 = func_176(vVar4, vVar1);
		}
	}
	else
	{
	...
	if (func_31(Local_94[2 /*2*/]))
	{
		...
		if (func_178(0f, 0f, 0f, 0f, 0f, 0f, GET_ENTITY_COORDS(Local_94[2 /*2*/], 0), 30f, 0))
		{
			bLocal_456 = true;
		}
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			vVar7 = { func_177(GET_ENTITY_COORDS(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0) - GET_ENTITY_COORDS(Local_94[2 /*2*/], 0)) };
			vVar10 = { GET_ENTITY_VELOCITY(Local_94[2 /*2*/]) - GET_ENTITY_VELOCITY(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)) };
			fLocal_465 = func_176(vVar10, vVar7);
		}
	}
	else
	{
	...
	if (func_31(Local_94[0 /*2*/]))
	{
		if (func_166(PLAYER_PED_ID(), PLAYER_PED_ID(), 1) < 45f && GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0)
		{
			bLocal_456 = true;
		}
		if (func_178(0f, 0f, 0f, 0f, 0f, 0f, GET_ENTITY_COORDS(Local_94[0 /*2*/], 0), 30f, 0))
		{
			bLocal_456 = true;
		}
		...
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			vVar13 = { func_177(GET_ENTITY_COORDS(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0) - GET_ENTITY_COORDS(Local_94[0 /*2*/], 0)) };
			vVar16 = { GET_ENTITY_VELOCITY(Local_94[0 /*2*/]) - GET_ENTITY_VELOCITY(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)) };
			fLocal_464 = func_176(vVar16, vVar13);
		}
		if (func_175())
		{
			uVar19 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
			if (IS_VEHICLE_DRIVEABLE(uVar19, 0))
			{
				if (IS_ENTITY_TOUCHING_ENTITY(uVar19, Local_94[0 /*2*/]))
				{
					bLocal_456 = true;
				}
				vVar20 = { func_177(GET_ENTITY_COORDS(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0) - GET_ENTITY_COORDS(Local_94[0 /*2*/], 0)) };
				vVar23 = { GET_ENTITY_VELOCITY(Local_94[0 /*2*/]) - GET_ENTITY_VELOCITY(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)) };
				fLocal_464 = func_176(vVar23, vVar20);
			}
		}
	}
	else
...
bool func_175()
{
	return IS_BIT_SET(Global_2528542.f_786, 2);
}
...
int func_178(vector3 vParam0, vector3 vParam3, vector3 vParam6, float fParam9, bool bParam10)
{
	int iVar0;
	
	iVar0 = 0;
	if (!func_179(vParam0 + vParam3))
	{
	...
	else if ((((((((((((((((((((((IS_EXPLOSION_IN_SPHERE(5, vParam6, fParam9) || (IS_EXPLOSION_IN_SPHERE(2, vParam6, fParam9) && !bParam10)) || (IS_EXPLOSION_IN_SPHERE(20, vParam6, fParam9) && !bParam10)) || IS_EXPLOSION_IN_SPHERE(4, vParam6, fParam9)) || (IS_EXPLOSION_IN_SPHERE(28, vParam6, fParam9) && !bParam10)) || IS_EXPLOSION_IN_SPHERE(32, vParam6, fParam9)) || IS_EXPLOSION_IN_SPHERE(25, vParam6, fParam9)) || IS_EXPLOSION_IN_SPHERE(9, vParam6, fParam9)) || (IS_EXPLOSION_IN_SPHERE(3, vParam6, fParam9) && !bParam10)) || (IS_EXPLOSION_IN_SPHERE(6, vParam6, fParam9) && !bParam10)) || IS_EXPLOSION_IN_SPHERE(0, vParam6, fParam9)) || IS_EXPLOSION_IN_SPHERE(1, vParam6, fParam9)) || IS_EXPLOSION_IN_SPHERE(23, vParam6, fParam9)) || IS_EXPLOSION_IN_SPHERE(34, vParam6, fParam9)) || IS_EXPLOSION_IN_SPHERE(14, vParam6, fParam9)) || (IS_EXPLOSION_IN_SPHERE(30, vParam6, fParam9) && !bParam10)) || (IS_EXPLOSION_IN_SPHERE(12, vParam6, fParam9) && !bParam10)) || IS_EXPLOSION_IN_SPHERE(7, vParam6, fParam9)) || (IS_EXPLOSION_IN_SPHERE(21, vParam6, fParam9) && !bParam10)) || (IS_EXPLOSION_IN_SPHERE(18, vParam6, fParam9) && !bParam10)) || IS_EXPLOSION_IN_SPHERE(15, vParam6, fParam9)) || IS_EXPLOSION_IN_SPHERE(10, vParam6, fParam9)) || IS_EXPLOSION_IN_SPHERE(27, vParam6, fParam9))
	{
		iVar0 = 1;
	}
	return iVar0;
...
void func_180()
{
	...
	{
		vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_94[0 /*2*/], 0f, func_173(func_166(Local_94[0 /*2*/], Local_94[1 /*2*/], 1), 3f, 25f), 5.5f) };
		...
		vVar12 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_94[2 /*2*/], 0f, func_173(func_166(Local_94[2 /*2*/], Local_94[0 /*2*/], 1), 3f, 25f), 5f) };
		vVar15 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_94[2 /*2*/], 0f, 0f, -6f) };
		switch (iLocal_433)
		{
			case 0:
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vVar6, vVar9, 9f, 0, 1, 0))
				{
					if (GET_ENTITY_SPEED(Local_94[1 /*2*/]) < 1f && GET_ENTITY_SPEED(PLAYER_PED_ID()) < 1f)
					{
						fLocal_1486[1] = (fLocal_1486[1] + GET_FRAME_TIME());
					}
					else if (fLocal_1486[1] > 0f)
					{
						fLocal_1486[1] = (fLocal_1486[1] - (GET_FRAME_TIME() * 10f));
					}
				}
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vVar0, vVar3, 9f, 0, 1, 0))
				{
					if (GET_ENTITY_SPEED(Local_94[0 /*2*/]) < 1f && GET_ENTITY_SPEED(PLAYER_PED_ID()) < 1f)
					{
						fLocal_1486[0] = (fLocal_1486[0] + GET_FRAME_TIME());
					}
					else if (fLocal_1486[0] > 0f)
					{
						fLocal_1486[0] = (fLocal_1486[0] - (GET_FRAME_TIME() * 10f));
					}
				}
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vVar12, vVar15, 9f, 0, 1, 0))
				{
					if (GET_ENTITY_SPEED(Local_94[2 /*2*/]) < 1f && GET_ENTITY_SPEED(PLAYER_PED_ID()) < 1f)
					{
						fLocal_1486[2] = (fLocal_1486[2] + GET_FRAME_TIME());
					}
					else if (fLocal_1486[2] > 0f)
					{
						fLocal_1486[2] = (fLocal_1486[2] - (GET_FRAME_TIME() * 10f));
					}
				}
				if (fLocal_1486[1] > 1.5f)
				{
					...
					_SET_VEHICLE_HALT(Local_94[0 /*2*/], 4f, 1, 0);
					_SET_VEHICLE_HALT(Local_94[1 /*2*/], 4f, 1, 0);
					_SET_VEHICLE_HALT(Local_94[2 /*2*/], 4f, 1, 0);
					OPEN_SEQUENCE_TASK(&uLocal_446);
					if (IS_PED_IN_ANY_VEHICLE(Local_111[0 /*14*/], 0))
					{
						TASK_LEAVE_ANY_VEHICLE(0, 0, 65536);
					}
					TASK_AIM_GUN_AT_COORD(0, GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 1000, 0, 1);
					TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER_PED_ID(), PLAYER_PED_ID(), 1f, 0, 3f, 1082130432, 1, 0, -957453492);
				...
				else
				{
					if ((IS_PED_IN_ANY_VEHICLE(Local_111[5 /*14*/], 0) && IS_PED_IN_ANY_VEHICLE(Local_111[0 /*14*/], 0)) && IS_PED_IN_ANY_VEHICLE(Local_111[4 /*14*/], 0))
					{
						...
						{
							TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_111[0 /*14*/], Local_94[1 /*2*/], &cLocal_475, 786603, 0, 24, -1, 11f, 0, 1073741824);
						}
			...
			case 1:
						...
						if ((GET_GAME_TIMER() - iLocal_473) > 8000 && !func_9())
						{
							if (!IS_PED_IN_ANY_VEHICLE(iLocal_474, 0))
							{
								...
								else
								{
									...
									TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER_PED_ID(), PLAYER_PED_ID(), 1f, 0, 4f, 1082130432, 1, 0, -957453492);
									TASK_AIM_GUN_AT_ENTITY(0, PLAYER_PED_ID(), -1, 0);
									CLOSE_SEQUENCE_TASK(uLocal_446);
									TASK_PERFORM_SEQUENCE(iLocal_474, uLocal_446);
									CLEAR_SEQUENCE_TASK(&uLocal_446);
									iLocal_473 = GET_GAME_TIMER();
				...
				if ((!IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vVar0, vVar3, 9f, 0, 1, 0) && !IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vVar6, vVar9, 9f, 0, 1, 0)) && !IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vVar12, vVar15, 9f, 0, 1, 0))
				{
...
int func_184(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
void func_187(int iParam0)
{
	...
	{
		if (DOES_ENTITY_EXIST(uLocal_108[iLocal_447]))
		{
			DELETE_OBJECT(&(uLocal_108[iLocal_447]));
		}
		iLocal_447++;
	}
	func_336();
...
void func_192(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_194(Global_106565.f_18527[iVar0], &vVar2, &fVar5))
			{
...
void func_199()
{
	...
	if (bLocal_1484 == 1)
	{
		...
		else if (iLocal_1479 == 3)
		{
			...
			if (!func_222())
			{
				func_221(iLocal_1485, &vVar0, &uVar3);
				...
				func_220(&uLocal_494, vVar0, 50f, 0);
			}
...
void func_204(vector3 vParam0, float fParam3)
{
	Local_94[0 /*2*/] = CREATE_VEHICLE(joaat("barracks"), vParam0, fParam3, 1, 1, 0);
	SET_ENTITY_HEALTH(Local_94[0 /*2*/], GET_ENTITY_HEALTH(Local_94[0 /*2*/]) * 2, 0);
	SET_VEHICLE_STRONG(Local_94[0 /*2*/], 1);
	...
	_0x192547247864DFDD(Local_94[0 /*2*/], 0);
	_0x51BB2D88D31A914B(Local_94[0 /*2*/], 0);
	SET_VEHICLE_PROVIDES_COVER(Local_94[0 /*2*/], 1);
	SET_VEHICLE_AUTOMATICALLY_ATTACHES(Local_94[0 /*2*/], 0, 0);
	func_205(Local_94[0 /*2*/], 0);
	uLocal_108[0] = CREATE_OBJECT(joaat("prop_mil_crate_01"), 1006.765f, 2128.32f, 48.0929f, 1, 1, 0);
	ATTACH_ENTITY_TO_ENTITY(uLocal_108[0], Local_94[0 /*2*/], 0, 0f, -0.5f, 1.5f, 0f, 0f, -90f, 0, 0, 0, 0, 2, 1);
	uLocal_108[1] = CREATE_OBJECT(joaat("prop_mil_crate_01"), 1006.765f, 2128.32f, 48.0929f, 1, 1, 0);
	ATTACH_ENTITY_TO_ENTITY(uLocal_108[1], Local_94[0 /*2*/], 0, 0f, -2.85f, 1.5f, 0f, 0f, -90f, 0, 0, 0, 0, 2, 1);
	_DYNAMIC_MIXER_RELATED_FN(Local_94[0 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
}
...
void func_208(vector3 vParam0, float fParam3)
{
	Local_94[2 /*2*/] = CREATE_VEHICLE(joaat("crusader"), vParam0, fParam3, 1, 1, 0);
	_DYNAMIC_MIXER_RELATED_FN(Local_94[2 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
}
...
void func_210(int iParam0, int iParam1)
{
	...
	Local_111[iParam0 /*14*/] = CREATE_PED_INSIDE_VEHICLE(iParam1, 26, iVar0, iVar1, 1, 1);
	SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[iParam0 /*14*/], uLocal_493);
	SET_PED_AS_ENEMY(Local_111[iParam0 /*14*/], 1);
	GIVE_WEAPON_TO_PED(Local_111[iParam0 /*14*/], iLocal_451, -1, 1, 1);
	GIVE_WEAPON_TO_PED(Local_111[iParam0 /*14*/], joaat("weapon_pistol"), -1, 1, 1);
	SET_PED_MONEY(Local_111[iParam0 /*14*/], 0);
	SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*14*/], 2, 1, 0, 0);
	SET_PED_ALERTNESS(Local_111[iParam0 /*14*/], 1);
	SET_PED_TARGET_LOSS_RESPONSE(Local_111[iParam0 /*14*/], 1);
	SET_PED_COMBAT_ATTRIBUTES(Local_111[iParam0 /*14*/], 0, 1);
	SET_PED_COMBAT_ATTRIBUTES(Local_111[iParam0 /*14*/], 1, 0);
	SET_PED_COMBAT_MOVEMENT(Local_111[iParam0 /*14*/], 1);
	SET_PED_CONFIG_FLAG(Local_111[iParam0 /*14*/], 184, 1);
	SET_PED_CONFIG_FLAG(Local_111[iParam0 /*14*/], 272, 1);
	STOP_PED_SPEAKING(Local_111[iParam0 /*14*/], 1);
	SET_ENTITY_LOAD_COLLISION_FLAG(Local_111[iParam0 /*14*/], 1, 1);
	SET_PED_ACCURACY(Local_111[iParam0 /*14*/], 10);
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_111[iParam0 /*14*/], 1);
	Local_111[iParam0 /*14*/].f_10 = 0;
}

void func_211(vector3 vParam0, float fParam3)
{
	Local_94[1 /*2*/] = CREATE_VEHICLE(joaat("crusader"), vParam0, fParam3, 1, 1, 0);
	_DYNAMIC_MIXER_RELATED_FN(Local_94[1 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
}
...
int func_218(var uParam0, var uParam1)
{
	...
	while (iVar0 < uParam0->f_374)
	{
		...
		{
			if (ARE_STRINGS_EQUAL(uParam0->f_374[iVar0 /*5*/].f_4, uParam1))
			{
	...
	if (iVar1 >= 0)
	{
		...
		uParam0->f_374[iVar1 /*5*/].f_4 = uParam1;
		uParam0->f_982 = 1;
		return 1;
	}
	return 0;
...
int func_220(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	if (func_179(vParam1) || fParam4 <= 0f)
	{
		return 0;
	}
	if (uParam0->f_868)
	{
		if (func_135(uParam0->f_868.f_4, vParam1, 0) && uParam0->f_868.f_10 == fParam4)
		{
			uParam0->f_868.f_2 = 0;
			if (!uParam0->f_868.f_1)
			{
...
void func_232()
{
	switch (iLocal_1479)
	{
		...
		case 0:
			if ((GET_GAME_TIMER() - iLocal_1483) > 2500)
			{
				iLocal_1483 = GET_GAME_TIMER();
			}
			break;
	}
}
...
void func_235(var uParam0, var uParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	func_236(uParam0, uParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_236(var uParam0, var uParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)
{
	uParam0->f_6 = 0;
	func_237(uParam0, uParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}
...
void func_237(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_261(uParam1) && IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
		...
		if (!IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				func_253(uParam0, uParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
int func_241(char* sParam0)
{
	if (!func_242(1, 1, 0))
	{
		if ((!IS_STRING_NULL_OR_EMPTY(sParam0) && func_234(sParam0)) || func_234("CMN_HINT"))
		{
			CLEAR_HELP(1);
		}
		return 0;
...
int func_242(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_250() || func_249(Global_4456448.f_161209)) || func_248())
	{
		...
		{
			uVar0 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
			iVar1 = func_247(PLAYER_PED_ID(), 0);
			if (((_0xE33FFA906CE74880(uVar0, iVar1) || (GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_246(uVar0, 10)) && GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_243(int iParam0)
{
	if (iParam0 != func_245())
	{
		...
		else if ((Global_1312867 && iParam0 == PLAYER_ID()) && func_244(iParam0, 1, 0))
		{
			return Global_2424047[iParam0 /*416*/].f_309.f_5 != -1;
		}
	}
...
void func_253(var uParam0, var uParam1, vector3 vParam2, int iParam5)
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_256(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_259(bParam1, bParam2, bParam3) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1) || func_257(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_264()
{
	...
	REMOVE_RELATIONSHIP_GROUP(uLocal_492);
	REMOVE_RELATIONSHIP_GROUP(uLocal_493);
	ADD_RELATIONSHIP_GROUP("trevor", &uLocal_492);
	ADD_RELATIONSHIP_GROUP("enemies", &uLocal_493);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_493, 1862763509);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_493, uLocal_492);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_492, uLocal_493);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_493, -1533126372);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, uLocal_493);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_493, uLocal_493);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_493, -472287501);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, -472287501, uLocal_493);
	...
	SET_MAX_WANTED_LEVEL(0);
	SET_POLICE_RADAR_BLIPS(0);
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("crusader"), 1);
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("barracks"), 1);
	uLocal_445 = ADD_SCENARIO_BLOCKING_AREA(Vector(35.39456f, 3600.538f, 1375.234f) - Vector(0f, 7f, 14.25f), Vector(35.39456f, 3600.538f, 1375.234f) + Vector(3f, 7f, 14.25f), 0, 1, 1, 1);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Vector(33.8865f, 3596.518f, 1383.51f) - Vector(1f, 5f, 5f), Vector(33.8865f, 3596.518f, 1383.51f) + Vector(2f, 5f, 5f), 0, 1);
...
void func_267(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_322(GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
...
{
	func_269(&Global_100114, GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_269(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_19();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_285())
		{
			func_278(PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_91043[iVar0]))
		{
			if (Global_91043[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || GET_ENTITY_MODEL(iParam0) == func_127(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_287(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_292(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_289(Var11.f_1)) && iVar72 < 51)
			{
...
int func_295(vector3 vParam0, char* sParam3, vector3 vParam4)
{
	int iVar0;
	int iVar1;
...
int func_297(var uParam0)
{
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (func_319())
		{
			*uParam0 = func_303(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_299(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_301() == 0)
		{
			return IS_BIT_SET(func_279(func_300(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_303(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_318(iVar0))
		{
			...
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_304(iVar0, 0), 1);
...
int func_307(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	vVar18 = { Var12 - Var0 };
	vVar18 = { func_308(vVar18, -Var0.f_3.f_2) };
	vVar18 = { func_308(vVar18, vVar6.f_3.f_2) };
	*uParam2 = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar6, 0f, vVar18) };
	uParam2->f_3 = { Var12.f_3 };
	return 1;
}

Vector3 func_308(vector3 vParam0, float fParam3)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
void func_324(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_329(var uParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
...
int func_332()
{
	...
	if (!DOES_ENTITY_EXIST(Local_94[0 /*2*/]))
	{
		if (DOES_ENTITY_EXIST(Global_90209[0]))
		{
			...
			_0x18EB48CFC41F2EA0(Global_90209[0], 0);
			_DYNAMIC_MIXER_RELATED_FN(Local_94[0 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
			func_205(Local_94[0 /*2*/], 0);
	...
	if (!DOES_ENTITY_EXIST(Local_94[1 /*2*/]))
	{
		if (DOES_ENTITY_EXIST(Global_90209[1]))
		{
			...
			_0x18EB48CFC41F2EA0(Global_90209[1], 0);
			_DYNAMIC_MIXER_RELATED_FN(Local_94[1 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
	...
	if (!DOES_ENTITY_EXIST(Local_94[2 /*2*/]))
	{
		if (DOES_ENTITY_EXIST(Global_90209[2]))
		{
			...
			_0x18EB48CFC41F2EA0(Global_90209[2], 0);
			_DYNAMIC_MIXER_RELATED_FN(Local_94[2 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
	...
	{
		if (DOES_ENTITY_EXIST(Global_90209.f_9[9]))
		{
			SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_9[9], 1, 1);
			Local_111[8 /*14*/] = Global_90209.f_9[9];
			func_209(Local_111[8 /*14*/], 0);
		}
	}
	if (!DOES_ENTITY_EXIST(uLocal_108[0]))
	{
	...
	if (!DOES_ENTITY_EXIST(uLocal_108[1]))
	{
	...
	while (iVar0 <= (9 - 1))
	{
		if (func_31(Local_111[iVar0 /*14*/]))
		{
			SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[iVar0 /*14*/], uLocal_493);
	...
	if (((((((((((((DOES_ENTITY_EXIST(Local_94[0 /*2*/]) && DOES_ENTITY_EXIST(Local_94[1 /*2*/])) && DOES_ENTITY_EXIST(Local_94[2 /*2*/])) && DOES_ENTITY_EXIST(Local_111[4 /*14*/])) && DOES_ENTITY_EXIST(Local_111[0 /*14*/])) && DOES_ENTITY_EXIST(Local_111[1 /*14*/])) && DOES_ENTITY_EXIST(Local_111[2 /*14*/])) && DOES_ENTITY_EXIST(Local_111[3 /*14*/])) && DOES_ENTITY_EXIST(Local_111[5 /*14*/])) && DOES_ENTITY_EXIST(Local_111[6 /*14*/])) && DOES_ENTITY_EXIST(Local_111[7 /*14*/])) && DOES_ENTITY_EXIST(Local_111[8 /*14*/])) && DOES_ENTITY_EXIST(uLocal_108[0])) && DOES_ENTITY_EXIST(uLocal_108[1]))
	{
		return 1;
	}
	return 0;
...
void func_334(vector3 vParam0, var uParam3, int iParam4, int iParam5)
{
	if (func_203())
	{
...
void func_336()
{
	...
	while (iLocal_447 <= (3 - 1))
	{
		if (func_31(Local_101[iLocal_447 /*2*/]))
		{
			...
			{
				SET_PED_KEEP_TASK(Local_101[iLocal_447 /*2*/], 1);
				func_198(&(Local_101[iLocal_447 /*2*/]), 1, 0, 1);
			}
	...
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_445, 0);
	SET_WANTED_LEVEL_MULTIPLIER(1f);
	SET_MAX_WANTED_LEVEL(5);
	DISPLAY_RADAR(1);
	DISPLAY_HUD(1);
	...
	ENABLE_DISPATCH_SERVICE(10, 1);
	ENABLE_DISPATCH_SERVICE(9, 1);
	_0xD9F692D349249528();
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Vector(33.8865f, 3596.518f, 1383.51f) - Vector(1f, 5f, 5f), Vector(33.8865f, 3596.518f, 1383.51f) + Vector(2f, 5f, 5f), 1, 1);
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("crusader"), 0);
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("barracks"), 0);
	iLocal_434 = 0;
	bLocal_456 = false;
	SET_POLICE_RADAR_BLIPS(1);
	func_233(&Local_82, 0, 0);
