			...
			while (iVar0 <= (9 - 1))
			{
				if (func_31(Local_68[iVar0 /*14*/]))
				{
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_68[iVar0 /*14*/], true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) < 400f)
					{
						...
						{
							BRAIN::TASK_COMBAT_PED(Local_68[iVar0 /*14*/], PLAYER::PLAYER_PED_ID(), 0, 16);
						}
						bLocal_280 = false;
					}
					else
...
void func_30(void fParam0, int iParam1, int iParam2)
{
	iParam2 = iParam2;
...
int func_40(int iParam0, vector3 vParam1, vector3 vParam2, bool bParam3, int iParam4, void fParam5, void fParam6, void fParam7, bool bParam8, int iParam9, bool bParam10, int iParam11)
{
	return func_41(iParam0, vParam1, vParam2, func_82(), func_82(), bParam3, 5, 0, 0, 0, iParam4, fParam5, func_81(), func_81(), func_81(), func_81(), fParam6, 0, bParam8, fParam7, 0, iParam9, bParam10, iParam11, 0, 0, 0, 1, 1065353216);
}
...
int func_41(int iParam0, vector3 vParam1, vector3 vParam2, vector3 vParam3, vector3 vParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, void fParam11, void fParam12, void fParam13, void fParam14, void fParam15, void fParam16, bool bParam17, bool bParam18, void fParam19, bool bParam20, int iParam21, bool bParam22, int iParam23, int iParam24, int iParam25, int iParam26, bool bParam27, float fParam28)
{
	...
	func_79(iParam0);
	func_78();
	if (func_62(iParam0, iParam0->f_17[0], iParam0->f_17[1], iParam0->f_17[2], fParam12, fParam13, fParam14, fParam15, iParam0->f_8, bParam17, iParam10, 0, 0, iParam24, iParam25, iParam26, iParam6, bParam18))
	{
		func_61(fParam12);
		func_61(fParam13);
		func_61(fParam14);
...
void func_53(int iParam0, void fParam1, int iParam2)
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, fParam1, func_54(iParam2), 1);
}
...
void func_55(int iParam0, void fParam1, bool bParam2)
{
	if (!bParam2)
	{
...
int func_62(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, void fParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_64(var uParam0, void fParam1, void fParam2, bool bParam3)
{
	if (!bParam3)
	{
		if (!MISC::IS_STRING_NULL(fParam1))
		{
			if (!MISC::ARE_STRINGS_EQUAL(fParam1, ""))
			{
				func_65(fParam1, fParam2, 7500, 1);
			}
		}
	}
...
void func_65(void fParam0, void fParam1, int iParam2, int iParam3)
{
	iParam3 = iParam3;
	HUD::BEGIN_TEXT_COMMAND_PRINT(fParam0);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_95814.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_95814.f_4, 0))
		{
			if (func_140(24) != Global_95814.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_137(ENTITY::GET_ENTITY_COORDS(Global_95814.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_113(Global_95814.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_144(void fParam0, int iParam1)
{
...
void func_145()
{
	...
	if (func_31(Local_65[0 /*2*/]))
	{
		...
		if (bVar0)
		{
			if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_65[0 /*2*/], 0) && !PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) && !PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_65[0 /*2*/], -1, 2048, 1);
				}
			}
	...
	if (!iLocal_267)
	{
		...
		if (fLocal_264 < 3f)
		{
			...
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_89597[iVar2]))
				{
					if (ENTITY::IS_ENTITY_DEAD(Global_89597[iVar2], 0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Global_89597[iVar2], 0))
					{
						iVar4 = VEHICLE::GET_VEHICLE_CAUSE_OF_DESTRUCTION(Global_89597[iVar2]);
	...
	else if (iLocal_1294 >= 1)
	{
		if (AUDIO::IS_AUDIO_SCENE_ACTIVE("PS_PREP_INTERCEPT_CONVOY"))
		{
			...
			while (iVar2 <= 3)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_89597[iVar2]))
				{
					AUDIO::_0x18EB48CFC41F2EA0(Global_89597[iVar2], 0);
				}
				iVar2++;
			}
		}
...
void func_150()
{
	...
	if (iLocal_260 == 3 || iLocal_260 == 1)
	{
		...
		OBJECT::_SET_DOOR_AJAR_ANGLE(Global_35028[20 /*31*/], fLocal_262, 0, 1);
		OBJECT::_SET_DOOR_ACCELERATION_LIMIT(Global_35028[20 /*31*/], 4, 0, 1);
	}
}
...
void func_154()
{
	...
	while (iVar0 < 3)
	{
		...
		if (!PED::IS_PED_INJURED(iVar1))
		{
			...
			{
				BRAIN::REQUEST_WAYPOINT_RECORDING(fLocal_305);
				...
				{
					BRAIN::REQUEST_WAYPOINT_RECORDING(fLocal_305);
					if (BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(fLocal_305))
					{
						BRAIN::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iVar1, Local_65[0 /*2*/], fLocal_305, 786469, 0, 8, -1, 10f, 0, 2f);
					}
				}
			}
				...
				if (((((func_31(Local_68[4 /*14*/]) && func_31(Local_68[0 /*14*/])) && func_31(Local_68[5 /*14*/])) && func_31(Local_65[1 /*2*/])) && func_31(Local_65[2 /*2*/])) && func_31(Local_65[0 /*2*/]))
				{
					switch (iLocal_292)
					{
						case 0:
							...
							{
								BRAIN::TASK_VEHICLE_ESCORT(Local_68[4 /*14*/], Local_65[0 /*2*/], Local_65[1 /*2*/], -1, 11f, 786603, -1f, 20, 0f);
							}
							if (!func_182(Local_68[5 /*14*/], -1273030092, 1))
							{
								BRAIN::TASK_VEHICLE_ESCORT(Local_68[5 /*14*/], Local_65[2 /*2*/], Local_65[0 /*2*/], -1, 11f, 786603, -1f, 20, 0f);
							}
								...
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_68[iVar0 /*14*/], false), true) > (120f * 2f))
								{
									if (!PED::IS_PED_IN_ANY_VEHICLE(Local_68[iVar0 /*14*/], 0) && !ENTITY::IS_ENTITY_ON_SCREEN(Local_68[iVar0 /*14*/]))
									{
										...
										if (func_31(iVar9))
										{
											...
											if (func_167(iVar9))
											{
												if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_68[iVar0 /*14*/], -1794415470) != 1)
												{
		...
		switch (iLocal_256)
		{
			case 0:
				...
				if (fLocal_1300[1] > 1.5f)
				{
					...
					BRAIN::CLEAR_PED_TASKS(Local_68[4 /*14*/]);
					BRAIN::CLEAR_PED_TASKS(Local_68[0 /*14*/]);
					BRAIN::CLEAR_PED_TASKS(Local_68[5 /*14*/]);
					...
					BRAIN::TASK_AIM_GUN_AT_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1000, 0, 1);
					BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 1f, 0, 3f, 1082130432, 1, 0, -957453492);
				...
				else
				{
					if ((PED::IS_PED_IN_ANY_VEHICLE(Local_68[5 /*14*/], 0) && PED::IS_PED_IN_ANY_VEHICLE(Local_68[0 /*14*/], 0)) && PED::IS_PED_IN_ANY_VEHICLE(Local_68[4 /*14*/], 0))
					{
						...
						{
							BRAIN::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_68[0 /*14*/], Local_65[1 /*2*/], &cLocal_296, 786603, 0, 24, -1, 11f, 0, 1073741824);
						}
						if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_68[4 /*14*/], -1273030092) != 1)
						{
							BRAIN::TASK_VEHICLE_ESCORT(Local_68[4 /*14*/], Local_65[0 /*2*/], Local_65[1 /*2*/], -1, 11f, 786603, -1f, 20, 0f);
						}
						if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_68[5 /*14*/], -1273030092) != 1)
						{
							BRAIN::TASK_VEHICLE_ESCORT(Local_68[5 /*14*/], Local_65[2 /*2*/], Local_65[0 /*2*/], -1, 11f, 786603, -1f, 20, 0f);
						}
			...
			case 1:
					...
					case 3:
						if ((MISC::GET_GAME_TIMER() - iLocal_294) > 8000 && !func_9())
						{
							if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_295, 0))
							{
								...
								{
									BRAIN::OPEN_SEQUENCE_TASK(&iLocal_269);
									BRAIN::TASK_SHOOT_AT_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PLAYER::PLAYER_PED_ID(), 0.5f, 0f, -1f), 1000, 1566631136);
									BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 1f, 0, 4f, 1082130432, 1, 0, -957453492);
									BRAIN::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0);
									BRAIN::CLOSE_SEQUENCE_TASK(iLocal_269);
				...
				if ((!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar0, vVar1, 9f, 0, true, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar2, vVar3, 9f, 0, true, 0)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vVar4, vVar5, 9f, 0, true, 0))
				{
					...
					{
						BRAIN::TASK_AIM_GUN_AT_ENTITY(iLocal_295, PLAYER::PLAYER_PED_ID(), -1, 0);
					}
					if (SYSTEM::TIMERA() > 3000)
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_295, 0))
						{
							...
							{
								BRAIN::TASK_ENTER_VEHICLE(iLocal_295, Local_65[0 /*2*/], 20000, -1, 2f, 1, 0);
							}
							else if (iLocal_295 == Local_68[0 /*14*/])
							{
								BRAIN::TASK_ENTER_VEHICLE(iLocal_295, Local_65[1 /*2*/], 20000, -1, 2f, 1, 0);
							}
							else if (iLocal_295 == Local_68[5 /*14*/])
							{
								BRAIN::TASK_ENTER_VEHICLE(iLocal_295, Local_65[2 /*2*/], 20000, -1, 2f, 1, 0);
							}
						}
						iLocal_256 = 2;
					}
...
int func_184(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5, float fParam6, void fParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
void func_192(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_194(Global_105220.f_18504[iVar0], &vVar2, &fVar3))
			{
...
int func_218(var uParam0, void fParam1)
{
	int iVar0;
	int iVar1;
...
void func_233(var uParam0, void fParam1, int iParam2)
{
	void fVar0;
...
int func_234(void fParam0)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(fParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_235(var uParam0, int iParam1, void fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	func_236(uParam0, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_236(var uParam0, int iParam1, void fParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)
{
	uParam0->f_6 = 0;
	func_237(uParam0, iParam1, 0f, 0f, 0f, fParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_237(var uParam0, int iParam1, vector3 vParam2, void fParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	void fVar0;
	int iVar1;
...
int func_241(void fParam0)
{
	if (!func_242(1, 1, 0))
	{
		if ((!MISC::IS_STRING_NULL_OR_EMPTY(fParam0) && func_234(fParam0)) || func_234("CMN_HINT"))
		{
			HUD::CLEAR_HELP(1);
		}
		return 0;
...
int func_242(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_250() || func_249(Global_4456448.f_148478)) || func_248())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("riot2") && iVar1 == 0) && func_246(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_243(int iParam0)
{
	if (iParam0 != func_245())
	{
		...
		else if ((Global_1312854 && iParam0 == PLAYER::PLAYER_ID()) && func_244(iParam0, 1, 0))
		{
			return Global_2423644[iParam0 /*406*/].f_305.f_1 != -1;
		}
	}
...
void func_267(int iParam0, void fParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_318(&(Global_92955.f_3));
				if (iVar6 > -1)
				{
		...
		func_268(iParam0, fParam1, iParam4, iParam5);
		if (MISC::ARE_STRINGS_EQUAL(fParam1, ""))
		{
		}
	}
...
{
	func_269(&Global_98783, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_269(var uParam0, void fParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_19();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_285())
		{
			func_278(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
...
int func_279(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_280(iParam1)];
...
int func_282(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2557346[iParam0 /*3*/][func_280(iParam1)];
...
void func_287(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_289(Var7.f_1)) && iVar9 < 50)
			{
...
int func_295(vector3 vParam0, void fParam1, vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
int func_320(void fParam0, int iParam1)
{
	int iVar0;
	void fVar1;
	int iVar2;
...
int func_327(void fParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
...
int func_330()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_65[0 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89597[0]))
		{
			...
			Local_65[0 /*2*/] = Global_89597[0];
			AUDIO::_0x18EB48CFC41F2EA0(Global_89597[0], 0);
			AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_65[0 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
			func_205(Local_65[0 /*2*/], 0);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_65[1 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89597[1]))
		{
			...
			Local_65[1 /*2*/] = Global_89597[1];
			AUDIO::_0x18EB48CFC41F2EA0(Global_89597[1], 0);
			AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_65[1 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_65[2 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89597[2]))
		{
			...
			Local_65[2 /*2*/] = Global_89597[2];
			AUDIO::_0x18EB48CFC41F2EA0(Global_89597[2], 0);
			AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_65[2 /*2*/], "PS_PREP_VEHICLES_GROUP", 0);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_68[4 /*14*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89597.f_9[0]))
		{
			...
			Local_68[4 /*14*/] = Global_89597.f_9[0];
			func_209(Local_68[4 /*14*/], 0);
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_68[0 /*14*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89597.f_9[2]))
		{
			...
			Local_68[0 /*14*/] = Global_89597.f_9[2];
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_68[1 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89597.f_9[3], true, 1);
			Local_68[1 /*14*/] = Global_89597.f_9[3];
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_68[2 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89597.f_9[4], true, 1);
			Local_68[2 /*14*/] = Global_89597.f_9[4];
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_68[3 /*14*/]))
	{
		...
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89597.f_9[5], true, 1);
			Local_68[3 /*14*/] = Global_89597.f_9[5];
			func_209(Local_68[3 /*14*/], 0);
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_68[5 /*14*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89597.f_9[6]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89597.f_9[6], true, 1);
			Local_68[5 /*14*/] = Global_89597.f_9[6];
			func_209(Local_68[5 /*14*/], 0);
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_68[6 /*14*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89597.f_9[7]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89597.f_9[7], true, 1);
			Local_68[6 /*14*/] = Global_89597.f_9[7];
			func_209(Local_68[6 /*14*/], 0);
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_68[7 /*14*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89597.f_9[8]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89597.f_9[8], true, 1);
			Local_68[7 /*14*/] = Global_89597.f_9[8];
			func_209(Local_68[7 /*14*/], 0);
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_68[8 /*14*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89597.f_9[9]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89597.f_9[9], true, 1);
			Local_68[8 /*14*/] = Global_89597.f_9[9];
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_67[0]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89597.f_28[0]))
		{
			...
			iLocal_67[0] = Global_89597.f_28[0];
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_67[1]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89597.f_28[1]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89597.f_28[1], true, 1);
			iLocal_67[1] = Global_89597.f_28[1];
		}
	}
	iVar0 = 0;
	while (iVar0 <= (9 - 1))
...
void func_331(int iParam0, vector3 vParam1)
{
	int iVar0;
...
void func_332(vector3 vParam0, var uParam1, int iParam2, int iParam3)
{
	if (func_203())
	{
...
void func_334()
{
	...
	while (iLocal_270 <= (2 - 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_67[iLocal_270]))
		{
			func_337(&(iLocal_67[iLocal_270]), 0);
		}
		iLocal_270++;
	}
	iLocal_270 = 0;
