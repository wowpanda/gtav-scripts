		...
		while (iVar1 != 2)
		{
			if (func_13(&(Global_26101[iVar0 /*7*/])))
			{
				if (func_12(iVar0, vVar2))
				{
					...
					{
						if (IS_THREAD_ACTIVE(Global_26101[iVar0 /*7*/].f_5))
						{
							FORCE_CLEANUP_FOR_THREAD_WITH_THIS_ID(Global_26101[iVar0 /*7*/].f_5, 1);
						}
...
int func_5(var uParam0, vector3 vParam1)
{
	...
	{
		if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -2080.115f, 3292.193f, -11.667f, -2112.049f, 3224.331f, 11.667f, 115f, 1, 0, 0))
		{
			return 0;
		}
	}
...
{
	vParam1.z = 0f;
	if (!IS_THREAD_ACTIVE(Global_26101[iParam0 /*7*/].f_5))
	{
		return 1;
	}
	...
	if (func_9() && !func_6(6))
	{
		if (!func_10(Global_26101[iParam0 /*7*/], 1))
		{
			...
			{
				if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("golf")) == 0)
				{
					return 1;
				}
			}
