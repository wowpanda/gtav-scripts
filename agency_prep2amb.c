...
void func_163()
{
	if ((MISC::IS_BIT_SET(iLocal_49, 0) && Global_35861 == 15) && !func_194())
	{
		if (iLocal_38 == 0)
		{
...
void func_210()
{
	...
	if (((((((Global_35861 == 15 && iLocal_37 != 3) && MISC::IS_BIT_SET(iLocal_49, 5)) && !func_194()) && Global_70853 == -1) && !func_220()) && !func_82(9)) || func_101(35))
	{
		func_219();
		func_217();
		switch (iLocal_39)
