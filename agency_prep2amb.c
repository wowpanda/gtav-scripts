	...
	else if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_14474) == 1)
	{
		if (func_10())
		{
			if (func_9())
			{
				...
				while ((!GRAPHICS::_0x768FF8961BA904D6(uVar0) && iVar6 == 0) && GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_14474) == 1)
				{
					SYSTEM::WAIT(0);
...
void func_163()
{
	if ((MISC::IS_BIT_SET(iLocal_49, 0) && Global_35905 == 15) && !func_194())
	{
		if (iLocal_38 == 0)
		{
...
int func_173(vector3 vParam0)
{
	...
	fVar0 = SYSTEM::VDIST2(vParam0, Global_88239[func_174(vParam0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_174(vector3 vParam0, bool bParam1)
{
	...
	while (iVar0 <= (7 - 1))
	{
		...
		{
			if (!bParam1 || MISC::IS_BIT_SET(Global_105220.f_7200.f_17[iVar0], 0))
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_88239[iVar0 /*9*/].f_3, true);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
int func_175(vector3 vParam0)
{
	...
	fVar0 = SYSTEM::VDIST2(vParam0, Global_88303[func_176(vParam0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_187()
{
	...
	fVar1 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Global_88138[iVar0 /*10*/].f_3);
	if (fVar1 <= 10000f)
	{
		if (func_12())
		{
...
void func_210()
{
	...
	if (((((((Global_35905 == 15 && iLocal_37 != 3) && MISC::IS_BIT_SET(iLocal_49, 5)) && !func_194()) && Global_70975 == -1) && !func_220()) && !func_82(9)) || func_101(35))
	{
		func_219();
		func_217();
		switch (iLocal_39)
...
void func_211(int iParam0, bool bParam1)
{
	...
	{
		case 1:
			if ((!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !func_214(func_87())) && !func_213())
			{
...
bool func_218(char* sParam0, int iParam1, char* sParam2)
{
...
struct<8> func_248(char* sParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	struct<8> Var0;
