...
void func_163()
{
	if ((IS_BIT_SET(uLocal_105, 0) && Global_36425 == 15) && !func_195())
	{
		if (iLocal_38 == 0)
		{
			if (!IS_BIT_SET(uLocal_105, 1) && IS_BIT_SET(uLocal_105, 0))
			{
				if (!func_74(PLAYER_PED_ID(), vLocal_106, 5f))
				{
					if (IS_BIT_SET(uLocal_105, 20) || func_129())
					{
						if ((func_237(PLAYER_PED_ID()) && !IS_BIT_SET(uLocal_101[0], 17)) && !IS_BIT_SET(uLocal_101[1], 18))
						{
...
int func_171()
{
	...
	while (iVar6 <= 4)
	{
		if (func_237(uVar0[iVar6]) && uVar0[iVar6] != PLAYER_PED_ID())
		{
...
int func_192()
{
	if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 1276.123f, -1723.665f, 53.6551f) <= 52900f)
	{
		if (func_12())
		{
			func_68(30);
	...
	else if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 111.8564f, -751.7169f, 44.757f) <= 160000f)
	{
		if (func_12())
		{
			func_68(31);
...
int func_209(var uParam0)
{
	...
	if (func_237(PLAYER_PED_ID()) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		iVar0 = GET_PLAYERS_LAST_VEHICLE();
		if (func_83(iVar0))
		{
...
void func_211()
{
	...
	if (((((((Global_36425 == 15 && iLocal_37 != 3) && IS_BIT_SET(uLocal_105, 5)) && !func_195()) && Global_71587 == -1) && !func_221()) && !func_82(9)) || func_101(35))
	{
		func_220();
		func_218();
		switch (iLocal_39)
...
void func_212(int iParam0, bool bParam1)
{
	...
	{
		case 1:
			if ((!IS_HELP_MESSAGE_BEING_DISPLAYED() && !func_215(func_87())) && !func_214())
			{
...
int func_233(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_94() == 0)
		{
			return IS_BIT_SET(func_234(func_236(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_234(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2539502[iParam0 /*3*/][func_235(iParam1)];
...
int func_239()
{
	...
	if (!func_82(14) && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("director_mode")) > 0)
	{
		return 1;
	}
	return 0;
