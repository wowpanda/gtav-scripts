...
void __EntryFunction__()
{
	...
	{
		if (MISC::IS_BIT_SET(Global_1369394, 1))
		{
			func_17();
		}
		else
	...
	while (true)
	{
		...
		{
			if (TASK::IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE(iScriptParam_21))
			{
				switch (iLocal_18)
				{
					case 0:
						...
						{
							vLocal_19 = { ENTITY::GET_ENTITY_COORDS(iScriptParam_21, 1) };
							iLocal_18 = 1;
						}
						break;
