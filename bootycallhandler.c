	...
	switch (Global_105559)
	{
		case 0:
			if (!Global_105559.f_27)
			{
				...
				{
					iVar0 = iVar1;
					if (func_65(func_66(iVar0)) && (Global_105559.f_15[iVar1] + 120000) < GET_GAME_TIMER())
					{
						if (func_63(iVar0))
						{
							func_62(iVar0, 0);
						...
						else
						{
							...
							else if (((GET_GAME_TIMER() >= Global_105559.f_4[iVar1] && func_50()) && func_49(iVar0)) && func_48(iVar0) >= func_47(iVar0))
							{
							...
							if (func_46() == 2)
							{
								func_54(&uLocal_36, 0, PLAYER_PED_ID(), "TREVOR", 0, 1);
							}
							else if (func_46() == 0)
							{
								func_54(&uLocal_36, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
							}
							else if (func_46() == 1)
							{
								func_54(&uLocal_36, 0, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
							}
...
void func_67()
{
	...
	switch (Global_105559)
	{
		case 0:
			...
			{
				if (GET_GAME_TIMER() >= Global_105559.f_3)
				{
...
int func_74()
{
	...
	while (iVar0 < 10)
	{
		if (Global_106565.f_243[func_46() /*53*/].f_2[iVar0 /*5*/].f_4 && GET_GAME_TIMER() >= Global_105559.f_4[iVar0])
		{
			iVar2[iVar1] = iVar0;
			iVar1++;
		}
...
void func_77()
{
	...
	{
		if (Global_105559.f_3 < (GET_GAME_TIMER() + 120000))
		{
			func_80(1800000);
		}
