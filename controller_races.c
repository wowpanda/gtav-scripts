...
void __EntryFunction__()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("controller_races")) > 1)
	{
		TERMINATE_THIS_THREAD();
	}
	while (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("initial")) > 0)
	{
		WAIT(0);
	}
	func_29();
...
void func_1()
{
	...
	if (func_11(8))
	{
		...
		{
			iVar1 = func_10(iVar0);
			if (IS_BIT_SET(Global_106565.f_24973.f_1, iVar0))
			{
				if (IS_BIT_SET(Global_106565.f_24973.f_3, iVar0))
				{
					...
					if (fVar2 > 43681f)
					{
						if (!func_7(iVar1))
						{
							if (!Global_106539[iVar0])
							{
								func_3(iVar1);
								func_2(iVar1, 1, 1);
								CLEAR_BIT(&(Global_106565.f_24973.f_3), iVar0);
							}
							else if ((GET_GAME_TIMER() - Global_106545[iVar0]) > 60000)
							{
								Global_106539[iVar0] = 0;
								Global_106545[iVar0] = GET_GAME_TIMER();
								func_3(iVar1);
								func_2(iVar1, 1, 1);
								CLEAR_BIT(&(Global_106565.f_24973.f_3), iVar0);
							}
...
{
	return IS_BIT_SET(Global_106565.f_9079.f_99.f_219[0], iParam0);
}
...
void func_18()
{
	...
	if (func_11(7))
	{
		...
		{
			iVar1 = func_21(iVar0);
			if (IS_BIT_SET(Global_106565.f_24970.f_2, iVar0))
			{
				fVar2 = VDIST2(func_9(PLAYER_ID()), func_8(iVar1, 0));
				if (fVar2 > 43681f)
				{
					if (!func_7(iVar1))
					{
						if (!Global_106529[iVar0])
						{
							func_3(iVar1);
							func_2(iVar1, 1, 1);
							CLEAR_BIT(&(Global_106565.f_24970.f_2), iVar0);
						}
						else if ((GET_GAME_TIMER() - Global_106534[iVar0]) > 60000)
						{
							Global_106529[iVar0] = 0;
							Global_106534[iVar0] = GET_GAME_TIMER();
							func_3(iVar1);
							func_2(iVar1, 1, 1);
							CLEAR_BIT(&(Global_106565.f_24970.f_2), iVar0);
						}
