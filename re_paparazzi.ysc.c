...
void __EntryFunction__()//Position - 0x0
{
	...
	if (!Global_3)
	{
		if (func_231(vLocal_48, 4294967295, 0, 0, 0))
		{
			func_228(4294967295);
		}
		else
	...
	while (true)
	{
		...
		while (iVar0 < Local_108)
		{
			...
			{
				Local_108[iVar0 /*18*/].f_8 = { unk_0x8000C77B5F336760(Local_108[iVar0 /*18*/], true) };
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < Local_109)
		{
			...
			{
				Local_109[iVar0 /*18*/].f_6 = { unk_0x8000C77B5F336760(Local_109[iVar0 /*18*/], true) };
			}
			iVar0++;
		}
		if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			vLocal_52 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true) };
		}
		if (!PED::IS_PED_INJURED(iLocal_67))
		{
			vLocal_53 = { unk_0x8000C77B5F336760(iLocal_67, true) };
		}
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_70) && !ENTITY::IS_ENTITY_DEAD(iLocal_70, 0))
		{
			vLocal_54 = { unk_0x8000C77B5F336760(iLocal_70, true) };
		}
		if (!func_224())
		{
			if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			{
				switch (iLocal_130)
				{
					...
					case 1:
						if ((func_191() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || !OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0))
						{
						...
						else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 281.0074f, 192.4805f, 58.08817f, 228.8291f, 50.88667f, 111.6104f, 82.75f, 0, true, 0))
						{
							func_181(1);
		...
		else
		{
			...
			if (!ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_53, 210f, 210f, 210f, false, true, 0))
			{
				func_190();
				func_274();
			}
		...
		{
			iVar1 = func_24();
			if (iVar1 != 4294967295 && (iLocal_60 || func_19() != 0))
			{
				if ((!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 243.6443f, 123.7193f, 97.59898f, 262.4353f, 116.8746f, 107.4762f, 32.25f, 0, true, 0) && (MISC::GET_GAME_TIMER() - iLocal_145) > 5000) && !PED::IS_PED_INJURED(Local_109[iVar1 /*18*/]))
				{
					if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(Local_109[iVar1 /*18*/], true), vLocal_52) < (30.5f * 30.5f) && SYSTEM::VDIST2(vLocal_53, vLocal_52) > (22.5f * 22.5f))
					{
						if (func_224())
						{
...
void func_2()//Position - 0x8CC
{
	...
	while (iVar0 < Local_109)
	{
		...
		{
			if (ENTITY::GET_ENTITY_HEALTH(Local_109[iVar0 /*18*/]) < Local_109[iVar0 /*18*/].f_11)
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_109[iVar0 /*18*/], AUDIO::_0x0626A247D2405330(), 1))
				{
					iLocal_138[iVar0] = (iLocal_138[iVar0] + (Local_109[iVar0 /*18*/].f_11 - ENTITY::GET_ENTITY_HEALTH(Local_109[iVar0 /*18*/])));
					iLocal_63 = (iLocal_63 + (Local_109[iVar0 /*18*/].f_11 - ENTITY::GET_ENTITY_HEALTH(Local_109[iVar0 /*18*/])));
			...
			Local_109[iVar0 /*18*/].f_11 = ENTITY::GET_ENTITY_HEALTH(Local_109[iVar0 /*18*/]);
		}
		iVar0++;
	}
}
...
void func_20()//Position - 0x12F1
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_23(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_21(iVar0) && (!func_12(14) || Global_19A3D))
			{
...
void func_25()//Position - 0x14E1
{
	...
	switch (iLocal_47)
	{
		case 0:
			...
			if (((((STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_genstreet_02")) && STREAMING::HAS_MODEL_LOADED(joaat("prop_pap_camera_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("CAVALCADE2"))) && STREAMING::HAS_MODEL_LOADED(joaat("VADER"))) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_134)) && STREAMING::HAS_ANIM_DICT_LOADED("random@paparazzi@pap_anims"))
			{
				...
				BRAIN::TASK_PLAY_ANIM(func_56(0, 1), "random@paparazzi@pap_anims", "base_pap", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(func_56(1, 0), "random@paparazzi@pap_anims", "pap_idle_a", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(func_56(1, 1), "random@paparazzi@pap_anims", "pap_idle_b", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(func_56(2, 1), "random@paparazzi@pap_anims", "pap_idle_a", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(func_56(3, 1), "random@paparazzi@pap_anims", "pap_idle_b", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
				iLocal_47 = 1;
			}
			break;
		...
		case 2:
			...
			switch (iLocal_165)
			{
				case 0:
					...
					{
						NETWORK::_0x5E3AA4CA2B6FB0EE(func_56(1, 0));
					}
					if (!PED::IS_PED_INJURED(func_56(1, 1)))
					{
						NETWORK::_0x5E3AA4CA2B6FB0EE(func_56(1, 1));
					}
					if (!ENTITY::DOES_ENTITY_EXIST(Local_108[2 /*18*/]))
					{
						func_57(2, vLocal_161[2 /*3*/], fLocal_162[2], 0);
						if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_108[2 /*18*/], 0))
						{
							func_58(func_61(2), unk_0x8000C77B5F336760(Local_108[2 /*18*/], true), 0f);
							PED::SET_PED_INTO_VEHICLE(func_56(2, 0), Local_108[2 /*18*/], 4294967295);
						}
					}
					...
					{
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(2, 1), vLocal_156, 2f, 4294967295, 1048576000, 0, 1193033728);
					}
					if (!PED::IS_PED_INJURED(func_56(3, 1)))
					{
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(3, 1), vLocal_157, 2f, 4294967295, 1048576000, 0, 1193033728);
					}
					...
					if (Global_3 || bLocal_56)
					{
						if (!PED::IS_PED_INJURED(func_56(1, 0)))
						{
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(1, 0), vLocal_158, 2f, 20000, 1048576000, 0, 1193033728);
						}
						if (!PED::IS_PED_INJURED(func_56(1, 1)))
						{
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(1, 1), vLocal_159, 2f, 20000, 1048576000, 0, 1193033728);
						}
						if (!PED::IS_PED_INJURED(func_56(0, 1)))
						{
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(0, 1), vLocal_160, 2f, 20000, 1048576000, 0, 1193033728);
						}
					}
					SYSTEM::SETTIMERB(0);
					iVar1 = 0;
					while (iVar1 < Local_109)
					{
						...
						{
							AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_109[iVar1 /*18*/], "MAG_2_PAPARAZZI_GROUP", 0f);
						}
						iVar1++;
					}
					iVar1 = 0;
					while (iVar1 < Local_108)
					{
						...
						{
							AUDIO::_DYNAMIC_MIXER_RELATED_FN(Local_108[iVar1 /*18*/], "MAG_2_PAPARAZZI_GROUP", 0f);
						}
						iVar1++;
					}
					iLocal_165++;
				...
				case 1:
					func_49();
					if ((OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_108[0 /*18*/], 0) && !PED::IS_PED_INJURED(func_56(0, 0))) && !PED::IS_PED_INJURED(func_56(0, 1)))
					{
						if (!iLocal_152[1])
						{
							iLocal_152[1] = 1;
							BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(func_56(0, 0), Local_108[0 /*18*/], vLocal_154, 10f, 0, joaat("CAVALCADE2"), 786469, 2f, 10f);
						}
					}
					if ((OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_108[2 /*18*/], 0) && !PED::IS_PED_INJURED(func_56(2, 0))) && !PED::IS_PED_INJURED(func_56(2, 1)))
					{
						if (!iLocal_152[0])
						{
							BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(func_56(2, 0), Local_108[2 /*18*/], vLocal_155, 10f, 0, joaat("CAVALCADE2"), 786469, 2f, 10f);
							iLocal_152[0] = 1;
						}
					}
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_67) && !PED::IS_PED_INJURED(iLocal_67))
					{
						...
						if (Global_3 || bLocal_56)
						{
							if (!PED::IS_PED_INJURED(func_56(1, 0)))
							{
								if (ENTITY::IS_ENTITY_AT_COORD(func_56(1, 0), vLocal_158, Global_16, false, true, 0))
								{
							...
							if (!PED::IS_PED_INJURED(func_56(1, 1)))
							{
								if (ENTITY::IS_ENTITY_AT_COORD(func_56(1, 1), vLocal_159, Global_16, false, true, 0))
								{
							...
							if (!PED::IS_PED_INJURED(func_56(0, 1)))
							{
								if (ENTITY::IS_ENTITY_AT_COORD(func_56(0, 1), vLocal_159, Global_16, false, true, 0))
								{
					...
					if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(iLocal_70, true), vLocal_68) < 9f)
					{
						if (ENTITY::IS_ENTITY_AT_COORD(func_56(2, 1), vLocal_156, Global_16, false, true, 0))
						{
							func_45(iLocal_67, func_59(2));
						}
						if (ENTITY::IS_ENTITY_AT_COORD(func_56(3, 1), vLocal_157, Global_16, false, true, 0))
						{
							func_45(iLocal_67, func_59(3));
						}
						if (ENTITY::IS_ENTITY_AT_COORD(func_56(0, 1), vLocal_157, Global_16, false, true, 0))
						{
							func_45(iLocal_67, func_59(0));
						}
					}
					...
					{
						if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_168, 3))
						{
							NETWORK::_0x5E3AA4CA2B6FB0EE(Local_109[func_59(3) /*18*/]);
							MISC::SET_BIT(&iLocal_168, 3);
						}
						if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_168, 2))
						{
							NETWORK::_0x5E3AA4CA2B6FB0EE(Local_109[func_59(2) /*18*/]);
							MISC::SET_BIT(&iLocal_168, 2);
						}
						if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_168, 0))
						{
							NETWORK::_0x5E3AA4CA2B6FB0EE(Local_109[func_59(0) /*18*/]);
		...
		case 3:
			func_49();
			if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0))
			{
			...
			while (iVar0 < Local_108)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_108[iVar0 /*18*/]) && iLocal_45 != 6)
				{
					...
					{
						case 0:
							if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_108[iVar0 /*18*/], 0))
							{
								if (!PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), Local_108[iVar0 /*18*/], 0))
								{
									if (!PED::IS_PED_INJURED(Local_109[iVar2 /*18*/]))
									{
										if (!PED::IS_PED_IN_VEHICLE(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], 0))
										{
											if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_109[iVar2 /*18*/], 2500551826) != 1 && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_108[iVar0 /*18*/], 4294967295, 0))
											{
												BRAIN::TASK_ENTER_VEHICLE(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], 4294967295, 4294967295, 2f, 1, 0);
											}
										}
									}
									if (iVar3 != 4294967295)
									{
										if (!PED::IS_PED_INJURED(Local_109[iVar3 /*18*/]))
										{
											...
											{
												if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_109[iVar3 /*18*/], 2500551826) != 1 && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_108[iVar0 /*18*/], 0, 0))
												{
													BRAIN::TASK_ENTER_VEHICLE(Local_109[iVar3 /*18*/], Local_108[iVar0 /*18*/], 4294967295, 0, 2f, 1, 0);
												}
											}
										}
										if (!PED::IS_PED_INJURED(Local_109[iVar2 /*18*/]) && (iVar3 != 4294967295 && !PED::IS_PED_INJURED(Local_109[iVar3 /*18*/])))
										{
											if ((PED::IS_PED_IN_VEHICLE(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], 0) && (iVar3 != 4294967295 && PED::IS_PED_IN_VEHICLE(Local_109[iVar3 /*18*/], Local_108[iVar0 /*18*/], 0))) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0))
											{
												if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_109[iVar2 /*18*/], 3021937204) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(Local_109[iVar2 /*18*/], 2477085294) != 1)
												{
													...
													if (iVar0 == 0)
													{
														BRAIN::TASK_VEHICLE_MISSION(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 10, 50f, 786471, 4f, 10f, 1);
													}
													else if (iVar0 == 1)
													{
														BRAIN::TASK_VEHICLE_MISSION(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 11, 50f, 786470, 4f, 10f, 1);
													}
													else if (iVar0 == 2)
													{
														BRAIN::TASK_VEHICLE_MISSION(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 10, 50f, 786471, 4f, 10f, 1);
												...
												BRAIN::SET_DRIVE_TASK_CRUISE_SPEED(Local_109[iVar2 /*18*/], func_39((3f * MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_54, Local_108[iVar0 /*18*/].f_8, true)), 50f, 120f));
											}
										}
									}
							...
							else
							{
								if (!PED::IS_PED_INJURED(Local_109[iVar2 /*18*/]))
								{
									if (!PED::IS_PED_FLEEING(Local_109[iVar2 /*18*/]))
									{
										...
										BRAIN::TASK_SMART_FLEE_PED(Local_109[iVar2 /*18*/], AUDIO::_0x0626A247D2405330(), 300f, 100000, 0, 0);
									}
								}
								if (iVar3 != 4294967295)
								{
									if (!PED::IS_PED_INJURED(Local_109[iVar3 /*18*/]))
									{
										if (!PED::IS_PED_FLEEING(Local_109[iVar3 /*18*/]))
										{
											...
											BRAIN::TASK_SMART_FLEE_PED(Local_109[iVar3 /*18*/], AUDIO::_0x0626A247D2405330(), 300f, 100000, 0, 0);
										}
									}
								}
							}
						...
						case 1:
							...
							{
								BRAIN::TASK_LEAVE_ANY_VEHICLE(Local_109[iVar2 /*18*/], 1, 256);
							}
							else
							{
							...
							if (iVar3 != 4294967295)
							{
								if (!PED::IS_PED_INJURED(Local_109[iVar3 /*18*/]))
								{
									...
									{
										BRAIN::TASK_LEAVE_ANY_VEHICLE(Local_109[iVar3 /*18*/], 0, 256);
									}
									else
									{
					...
					if ((!PED::IS_PED_INJURED(Local_109[iVar2 /*18*/]) && (iVar3 == 4294967295 || !PED::IS_PED_INJURED(Local_109[iVar3 /*18*/]))) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_108[iVar0 /*18*/], 0))
					{
						iVar4 = 1;
						...
						if ((iVar4 && SYSTEM::VDIST(vLocal_52, Local_108[iVar0 /*18*/].f_8) > 25f) && SYSTEM::VDIST(vLocal_52, Local_109[iVar0 /*18*/].f_6) > 25f)
						{
							if (!PED::IS_PED_IN_VEHICLE(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], 0))
							{
								PED::SET_PED_INTO_VEHICLE(Local_109[iVar2 /*18*/], Local_108[iVar0 /*18*/], 4294967295);
							}
							if (iVar3 != 4294967295)
							{
								if (!PED::IS_PED_IN_VEHICLE(Local_109[iVar3 /*18*/], Local_108[iVar0 /*18*/], 0))
				...
				while (iVar0 < Local_108)
				{
					...
					if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_108[iVar0 /*18*/], 0))
					{
						if (!PED::IS_PED_INJURED(Local_109[iVar5 /*18*/]))
						{
							...
							{
								if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_109[iVar5 /*18*/], 2500551826) != 1)
								{
									BRAIN::TASK_ENTER_VEHICLE(Local_109[iVar5 /*18*/], Local_108[iVar0 /*18*/], 4294967295, 4294967295, 2f, 1, 0);
								}
							}
						}
						if (iVar6 != 4294967295)
						{
							if (!PED::IS_PED_INJURED(Local_109[iVar6 /*18*/]))
							{
								...
								{
									if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_109[iVar6 /*18*/], 2500551826) != 1)
									{
										BRAIN::TASK_ENTER_VEHICLE(Local_109[iVar6 /*18*/], Local_108[iVar0 /*18*/], 4294967295, 0, 2f, 1, 0);
									}
								}
							}
							if (!PED::IS_PED_INJURED(Local_109[iVar5 /*18*/]) && (iVar6 != 4294967295 && !PED::IS_PED_INJURED(Local_109[iVar6 /*18*/])))
							{
								if ((PED::IS_PED_IN_VEHICLE(Local_109[iVar5 /*18*/], Local_108[iVar0 /*18*/], 0) && (iVar6 != 4294967295 && PED::IS_PED_IN_VEHICLE(Local_109[iVar6 /*18*/], Local_108[iVar0 /*18*/], 0))) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0))
								{
									fVar7 = func_39((70f - (SYSTEM::TO_FLOAT((MISC::GET_GAME_TIMER() - iLocal_66)) / 50f)), 0f, 70f);
									if (fVar7 <= 1f || (MISC::GET_GAME_TIMER() - iLocal_66) > 4000)
									{
										BRAIN::SET_DRIVE_TASK_MAX_CRUISE_SPEED(Local_109[iVar5 /*18*/], fVar7);
										iVar8 = 0;
										while (iVar8 < Local_108)
										{
											if ((OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_108[iVar8 /*18*/], 0) && !PED::IS_PED_INJURED(func_56(iVar8, 0))) && PED::IS_PED_IN_VEHICLE(func_56(iVar8, 0), Local_108[iVar8 /*18*/], 0))
											{
												NETWORK::_0x5E3AA4CA2B6FB0EE(func_56(iVar8, 0));
												BRAIN::TASK_VEHICLE_MISSION(func_56(iVar8, 0), Local_108[iVar8 /*18*/], 0, 5, 10f, 786468, 10f, 10f, 1);
											}
											iVar8++;
										}
										iLocal_167 = 1;
									}
									else if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_109[iVar5 /*18*/], 3021937204) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(Local_109[iVar5 /*18*/], 2477085294) != 1)
									{
										...
										if (iVar0 == 0)
										{
											BRAIN::TASK_VEHICLE_MISSION(Local_109[iVar5 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 10, fVar7, 786471, 4f, 10f, 1);
										}
										else if (iVar0 == 1)
										{
											BRAIN::TASK_VEHICLE_MISSION(Local_109[iVar5 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 11, fVar7, 786470, 4f, 10f, 1);
										}
										else if (iVar0 == 2)
										{
											BRAIN::TASK_VEHICLE_MISSION(Local_109[iVar5 /*18*/], Local_108[iVar0 /*18*/], iLocal_70, 10, fVar7, 786471, 4f, 10f, 1);
					...
					else
					{
						if (!PED::IS_PED_INJURED(Local_109[iVar5 /*18*/]))
						{
							if (!PED::IS_PED_FLEEING(Local_109[iVar5 /*18*/]))
							{
								...
								BRAIN::TASK_SMART_FLEE_PED(Local_109[iVar5 /*18*/], AUDIO::_0x0626A247D2405330(), 300f, 100000, 0, 0);
							}
						}
						if (iVar6 != 4294967295)
						{
							if (!PED::IS_PED_INJURED(Local_109[iVar6 /*18*/]))
							{
								if (!PED::IS_PED_FLEEING(Local_109[iVar6 /*18*/]))
								{
									...
									BRAIN::TASK_SMART_FLEE_PED(Local_109[iVar6 /*18*/], AUDIO::_0x0626A247D2405330(), 300f, 100000, 0, 0);
								}
							}
						}
					}
	...
	while (iVar0 < Local_109)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_109[iVar0 /*18*/]) && !PED::IS_PED_INJURED(Local_109[iVar0 /*18*/]))
		{
				...
				if (!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_134))
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(Local_109[iVar0 /*18*/].f_2) && ENTITY::IS_ENTITY_ATTACHED(Local_109[iVar0 /*18*/].f_2))
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(Local_109[iVar0 /*18*/], 0))
						{
							...
							{
								if (BRAIN::IS_PED_GETTING_UP(Local_109[iVar0 /*18*/]))
								{
									ENTITY::SET_ENTITY_VISIBLE(Local_109[iVar0 /*18*/].f_2, false, 0);
								}
							}
							else if (!BRAIN::IS_PED_GETTING_UP(Local_109[iVar0 /*18*/]))
							{
							...
							if (!ENTITY::IS_ENTITY_OCCLUDED(Local_109[iVar0 /*18*/]))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_109[iVar0 /*18*/], sLocal_134, func_27(iVar0), 3))
								{
									if (!Local_109[iVar0 /*18*/].f_B)
									{
										...
										{
											BRAIN::TASK_PLAY_ANIM(Local_109[iVar0 /*18*/], sLocal_134, "grip", 1000f, -1000f, 4294967295, 57, 0, 0, 0, 0);
								...
								{
									BRAIN::TASK_PLAY_ANIM(Local_109[iVar0 /*18*/], sLocal_134, "grip", 1000f, -1000f, 4294967295, 48, 0.99f, 0, 0, 0);
						...
						if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(Local_109[iVar0 /*18*/]) && func_26(Local_109[iVar0 /*18*/], PED::GET_VEHICLE_PED_IS_IN(Local_109[iVar0 /*18*/], 0)) == 4294967295)
						{
							if (ENTITY::IS_ENTITY_VISIBLE(Local_109[iVar0 /*18*/].f_2))
							{
								ENTITY::SET_ENTITY_VISIBLE(Local_109[iVar0 /*18*/].f_2, false, 0);
			...
			if (iLocal_45 != 7)
			{
				if (PED::IS_PED_BEING_JACKED(Local_109[iVar0 /*18*/]) && PED::IS_PED_JACKING(AUDIO::_0x0626A247D2405330()))
				{
					func_178(7);
				}
			}
...
void func_28(int iParam0)//Position - 0x2CB3
{
	...
	while (iVar0 < 15)
	{
		if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_109[iParam0 /*18*/].f_F, iVar0))
		{
			iVar1 = 5;
			...
			if (iVar3 < iVar1)
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_109[iParam0 /*18*/], sLocal_134, func_27(iParam0), 3))
				{
					...
					{
						GRAPHICS::_0x35FB78DC42B7BD21(&(Local_109[iParam0 /*18*/].f_F), iVar0);
					}
				}
			}
			else if (iVar3 < iVar2)
...
void func_29()//Position - 0x2DB0
{
	...
	if (!PED::IS_PED_INJURED(iLocal_67))
	{
		...
		if (((ENTITY::DOES_ENTITY_EXIST(Local_108[iLocal_149 /*18*/]) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_108[iLocal_149 /*18*/], 0)) && ENTITY::DOES_ENTITY_EXIST(Local_109[iVar0 /*18*/])) && !PED::IS_PED_INJURED(Local_109[iVar0 /*18*/]))
		{
			if (VEHICLE::IS_VEHICLE_MODEL(Local_108[iLocal_149 /*18*/], joaat("CAVALCADE2")))
			{
				if (SYSTEM::VDIST2(Local_109[iVar0 /*18*/].f_6, vLocal_53) < SYSTEM::POW(30f, 2f) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_108[iLocal_149 /*18*/], 0, 0) == Local_109[iVar0 /*18*/])
				{
					...
					else if (!func_36(iVar0) && (MISC::GET_GAME_TIMER() - Local_109[iVar0 /*18*/].f_D) > 1000)
					{
						if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_109[iVar0 /*18*/], sLocal_135, "base", 3))
						{
							BRAIN::TASK_PLAY_ANIM(Local_109[iVar0 /*18*/], sLocal_135, "base", 8f, 1000f, 4294967295, 16, 0, 0, 0, 0);
						}
					}
				}
			}
			else if (!Local_109[iVar0 /*18*/].f_9)
			{
				if (SYSTEM::VDIST2(Local_109[iVar0 /*18*/].f_6, vLocal_53) < SYSTEM::POW(30f, 2f) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_108[iLocal_149 /*18*/], 0, 0) == Local_109[iVar0 /*18*/])
				{
					BRAIN::TASK_SWEEP_AIM_ENTITY(Local_109[iVar0 /*18*/], "random@paparazzi@pap_anims", "sweep_low", "sweep_med", "sweep_high", 4294967295, iLocal_67, 1,57f, 0,25f);
					Local_109[iVar0 /*18*/].f_9 = 1;
					Local_109[iVar0 /*18*/].f_D = MISC::GET_GAME_TIMER();
				}
			}
			else if (Local_109[iVar0 /*18*/].f_9)
			{
				if ((MISC::GET_GAME_TIMER() - Local_109[iVar0 /*18*/].f_D) > 2000)
				{
...
void func_31(int iParam0, int iParam1)//Position - 0x307E
{
	if (iParam1 < 15)
	{
		if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_109[iParam0 /*18*/].f_F, iParam1))
		{
			if (func_33(iParam1))
			{
				BRAIN::TASK_PLAY_ANIM(Local_109[iParam0 /*18*/], sLocal_135, iLocal_136[func_32(iParam1)], 4f, -4f, 4294967295, 16, 0, 0, 0, 0);
			}
			else if (iParam1 < 5)
			{
				BRAIN::TASK_PLAY_ANIM(Local_109[iParam0 /*18*/], sLocal_134, func_27(iParam0), 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			}
			else
			{
				BRAIN::TASK_PLAY_ANIM(Local_109[iParam0 /*18*/], sLocal_134, "grip", 1000f, -1000f, 4294967295, 57, 0, 0, 0, 0);
			}
			Local_109[iParam0 /*18*/].f_F = 0;
			MISC::SET_BIT(&(Local_109[iParam0 /*18*/].f_F), iParam1);
		}
	}
}
...
bool func_36(int iParam0)//Position - 0x3203
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_135))
	{
		...
		while (iVar1 <= 13)
		{
			if (!bVar0)
			{
				if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_109[iParam0 /*18*/].f_F, iVar1))
				{
					bVar0 = true;
				}
			}
...
int func_38(int iParam0, float fParam1)//Position - 0x3316
{
	...
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_108[iParam0 /*18*/], 0))
		{
...
void func_40(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, vector3 vParam7, int iParam8, float fParam9)//Position - 0x3436
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		if (((((ENTITY::DOES_ENTITY_EXIST(iParam1) && iParam0 != iParam1) && !VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iParam1))) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iParam1)))
		{
			...
			{
				if (func_43(iParam0, iParam1, iLocal_119, unk_0x8000C77B5F336760(iParam1, true), ENTITY::GET_ENTITY_ROTATION(iParam1, 2)))
				{
					*uParam2 = { *uParam4 };
					*uParam3 = *uParam5;
					*uParam2 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(*uParam2, *uParam3, vParam7) };
					*uParam4 = { unk_0x8000C77B5F336760(iParam1, true) };
			...
			{
				if ((func_42(iParam0, iParam1, 1) > fParam9 && MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(iParam1, true), *uParam2, true) > 20f) && SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), *uParam2) > 100f)
				{
					if (!func_41(*uParam2))
					{
...
void func_44()//Position - 0x37C4
{
	...
	{
		if ((MISC::GET_GAME_TIMER() - Local_109[iLocal_147 /*18*/].f_C) > 500)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_109[iLocal_147 /*18*/]) && !PED::IS_PED_INJURED(Local_109[iLocal_147 /*18*/]))
			{
				...
				if (bVar0)
				{
					if (((ENTITY::IS_ENTITY_PLAYING_ANIM(Local_109[iLocal_147 /*18*/], sLocal_134, func_27(iLocal_147), 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_109[iLocal_147 /*18*/], sLocal_134, func_27(iLocal_147)) > 0.5f) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_109[iLocal_147 /*18*/], sLocal_134, func_27(iLocal_147)) < 0.75f) || Local_109[iLocal_147 /*18*/].f_9)
					{
						...
						if ((iLocal_147 % 3) == 0)
						{
							AUDIO::PLAY_SOUND_FROM_COORD(4294967295, "SHUTTER_FLASH", unk_0x8000C77B5F336760(Local_109[iLocal_147 /*18*/].f_2, true), "CAMERA_FLASH_SOUNDSET", 0, 0, 0);
						}
						else if ((iLocal_147 % 3) == 1)
						{
							AUDIO::PLAY_SOUND_FROM_COORD(4294967295, "SHUTTER", unk_0x8000C77B5F336760(Local_109[iLocal_147 /*18*/].f_2, true), "CAMERA_FLASH_SOUNDSET", 0, 0, 0);
						}
						else
						{
							AUDIO::PLAY_SOUND_FROM_COORD(4294967295, "FLASH", unk_0x8000C77B5F336760(Local_109[iLocal_147 /*18*/].f_2, true), "CAMERA_FLASH_SOUNDSET", 0, 0, 0);
						}
						Local_109[iLocal_147 /*18*/].f_C = MISC::GET_GAME_TIMER();
					}
...
void func_45(int iParam0, int iParam1)//Position - 0x3967
{
	if (!PED::IS_PED_INJURED(Local_109[iParam1 /*18*/]) && !PED::IS_PED_INJURED(iParam0))
	{
		...
		{
			if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_109[iParam1 /*18*/], 3419293077) != 1)
			{
				BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(Local_109[iParam1 /*18*/], iParam0, 0);
			}
		}
		else if ((MISC::GET_GAME_TIMER() - Local_109[iParam1 /*18*/].f_D) > 2000)
		{
			if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_109[iParam1 /*18*/], sLocal_134, func_27(iParam1), 3))
			{
				BRAIN::TASK_PLAY_ANIM(Local_109[iParam1 /*18*/], sLocal_134, func_27(iParam1), 4f, -4f, 4294967295, 0, 0, 0, 0, 0);
				Local_109[iParam1 /*18*/].f_D = MISC::GET_GAME_TIMER();
			}
		}
	}
}
...
void func_46(int iParam0, int iParam1)//Position - 0x3A17
{
	...
	if (!PED::IS_PED_INJURED(Local_109[iParam1 /*18*/]) && !PED::IS_PED_INJURED(iParam0))
	{
		...
		switch (Local_109[iParam1 /*18*/].f_10)
		{
			...
			case 1:
				if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_109[iParam1 /*18*/], 713668775) != 1 || SYSTEM::VDIST(vVar0, Local_109[iParam1 /*18*/].f_6) > 5f)
				{
					Local_109[iParam1 /*18*/].f_10++;
				}
				break;
			...
			case 3:
				...
				if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_109[iParam1 /*18*/], 713668775) != 1)
				{
...
void func_47(vector3 vParam0, int iParam1, int iParam2)//Position - 0x3B68
{
	...
	vVar0 = { func_35(unk_0x8000C77B5F336760(iParam2, true) - vParam0) };
	fVar1 = MISC::GET_HEADING_FROM_VECTOR_2D(vVar0.x, vVar0.y);
	Local_109[iParam1 /*18*/].f_3 = { vParam0 };
	NETWORK::_0x5E3AA4CA2B6FB0EE(Local_109[iParam1 /*18*/]);
	if (SYSTEM::VDIST(vParam0, Local_109[iParam1 /*18*/].f_6) < 2f)
	{
		BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_109[iParam1 /*18*/], Local_109[iParam1 /*18*/].f_3, 1f, 4294967295, 0.5f, 512, fVar1);
	}
	else
	{
		BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_109[iParam1 /*18*/], Local_109[iParam1 /*18*/].f_3, 2f, 4294967295, 0.5f, 512, fVar1);
	}
}
...
void func_54(int iParam0, vector3 vParam1, float fParam2, char* sParam3, char* sParam4, char* sParam5)//Position - 0x405E
{
	...
	{
		if (SYSTEM::VDIST(unk_0x8000C77B5F336760(Local_109[iParam0 /*18*/], true), vParam1) > 1.5f)
		{
			if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_109[iParam0 /*18*/], 713668775) != 1)
			{
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_109[iParam0 /*18*/], vParam1, 2f, 4294967295, 0.25f, 0, fParam2);
			}
		}
		else if (MISC::ABSF((func_55(ENTITY::GET_ENTITY_HEADING(Local_109[iParam0 /*18*/])) - func_55(fParam2))) > 10f)
		{
			if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_109[iParam0 /*18*/], 1920390111) != 1)
			{
				BRAIN::TASK_ACHIEVE_HEADING(Local_109[iParam0 /*18*/], fParam2, 0);
			}
		}
		else
		{
			switch (Local_109[iParam0 /*18*/].f_10)
			{
				case 0:
					if (MISC::IS_STRING_NULL_OR_EMPTY(sParam5))
					{
						...
						{
							BRAIN::TASK_PLAY_ANIM(Local_109[iParam0 /*18*/], sParam3, sParam4, 4f, -4f, 4294967295, 1, 0, 0, 0, 0);
						}
					}
					else if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_109[iParam0 /*18*/], sParam3, sParam4, 3))
					{
						BRAIN::TASK_PLAY_ANIM(Local_109[iParam0 /*18*/], sParam3, sParam4, 4f, -4f, 4294967295, 0, 0, 0, 0, 0);
					}
					else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_109[iParam0 /*18*/], sParam3, sParam4) > 0.99f)
					{
						BRAIN::TASK_PLAY_ANIM(Local_109[iParam0 /*18*/], sParam3, sParam5, 4f, -4f, 4294967295, 0, 0, 0, 0, 0);
...
void func_57(int iParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x4294
{
	...
	if (bParam3)
	{
		...
		if (!PED::IS_PED_INJURED(func_56(iParam0, 0)) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_108[iParam0 /*18*/], 0))
		{
			PED::SET_PED_INTO_VEHICLE(func_56(iParam0, 0), Local_108[iParam0 /*18*/], 4294967295);
		}
		if (!PED::IS_PED_INJURED(func_56(iParam0, 1)) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_108[iParam0 /*18*/], 0))
		{
...
void func_58(int iParam0, vector3 vParam1, float fParam2)//Position - 0x43AF
{
	...
	ENTITY::SET_ENTITY_HEALTH(Local_109[iParam0 /*18*/], true);
	...
	PED::SET_PED_FIRING_PATTERN(Local_109[iParam0 /*18*/], 3337513804);
	...
	if (Global_3 || bLocal_56)
	{
		ENTITY::FREEZE_ENTITY_POSITION(Local_109[iParam0 /*18*/], true);
	...
	Local_109[iParam0 /*18*/].f_11 = ENTITY::GET_ENTITY_HEALTH(Local_109[iParam0 /*18*/]);
}
...
int func_63()//Position - 0x45CA
{
	...
	if (!PED::IS_PED_INJURED(iLocal_67))
	{
		...
		if (func_66())
		{
			...
			{
				if (SYSTEM::VDIST(unk_0x8000C77B5F336760(func_65(), true), vLocal_53) < 5f && ENTITY::GET_ENTITY_SPEED(iLocal_70) < 1f)
				{
					bVar0 = true;
				}
			}
		}
		else if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0))
		{
			if (!PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_70, 0) && PED::IS_PED_IN_VEHICLE(iLocal_67, iLocal_70, 0))
			{
		...
		if (!OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0) && (!bLocal_129 || iLocal_45 == 1))
		{
			bVar1 = true;
		}
		...
		if (((OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0) && func_64(iLocal_70)) && (!bLocal_129 || iLocal_45 == 1)) && SYSTEM::VDIST(unk_0x8000C77B5F336760(iLocal_67, true), vLocal_50) > 15f)
		{
			bVar1 = true;
		}
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0) && ENTITY::IS_ENTITY_IN_WATER(iLocal_70))
		{
			bVar1 = true;
		}
		if (bVar1)
...
int func_66()//Position - 0x487A
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0))
	{
		if (!PED::IS_PED_INJURED(iLocal_67))
		{
			if (PED::IS_PED_IN_VEHICLE(iLocal_67, iLocal_70, 0) && PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_70, 0))
			{
				return 1;
			}
		}
...
int func_68(int iParam0, int iParam1, bool bParam2)//Position - 0x4929
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		if (SYSTEM::VDIST2(vVar0, vLocal_52) < 400f)
		{
			if (!bParam2)
			{
				if ((WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6) && !WEAPON::IS_PED_CURRENT_WEAPON_SILENCED(AUDIO::_0x0626A247D2405330())) && PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
				{
					return 1;
				}
			}
			if ((iVar1 == joaat("weapon_petrolcan") && PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330())) && SYSTEM::VDIST2(vLocal_52, vVar0) < 9f)
			{
				return 1;
			}
			if (((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iParam0)) && (func_69(vLocal_52, iParam0) && SYSTEM::VDIST2(vLocal_52, unk_0x8000C77B5F336760(iParam0, true)) < 100f)) && WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6))
			{
				return 1;
			}
			if (iLocal_137 > 150)
...
bool func_74()//Position - 0x4BE6
{
	if (!PED::IS_PED_INJURED(iLocal_67) && SYSTEM::VDIST2(vLocal_52, vLocal_53) < 400f)
	{
		...
		{
			if (WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6) && PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
			{
				if (iLocal_118 > 2)
				{
					if (!Global_3 && !bLocal_56)
...
void func_81(int iParam0, var uParam1, var uParam2)//Position - 0x4F85
{
	...
	{
		func_85((891 + iParam0), 1, 4294967295, 1);
	}
	bVar0 = true;
...
void func_82()//Position - 0x506D
{
	...
	{
		func_84(13, SYSTEM::FLOOR(Global_19E56.f_27B6.f_F0D));
	}
...
int func_86()//Position - 0x5AF2
{
	return Global_1407E0;
}

int func_87(int iParam0, int iParam1)//Position - 0x5AFE
{
	switch (iParam0)
	{
		case 0:
...
int func_88(int iParam0)//Position - 0x5E72
{
	switch (iParam0)
	{
		case 29:
...
void func_89(int iParam0)//Position - 0x5EA1
{
	int iVar0;
	int iVar1;
...
void func_90(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x5EE3
{
	func_91(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_91(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x5F03
{
	int iVar0;
...
int func_94(int iParam0)//Position - 0x623B
{
	int iVar0;
	int iVar1;
...
void func_95(int iParam0, int iParam1)//Position - 0x627E
{
	MISC::SET_BIT(&(Global_19E56.f_6187.f_8[iParam0]), iParam1);
}

int func_96(int iParam0)//Position - 0x6299
{
	int iVar0;
...
int func_98(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x6367
{
...
void func_100()//Position - 0x6559
{
	...
	switch (iLocal_130)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_67))
			{
				BRAIN::TASK_SMART_FLEE_PED(iLocal_67, AUDIO::_0x0626A247D2405330(), 300f, 4294967295, 0, 0);
			}
			iVar0 = 0;
			while (iVar0 < Local_109)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_109[iVar0 /*18*/]))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_109[iVar0 /*18*/]) && SYSTEM::VDIST2(unk_0x8000C77B5F336760(Local_109[iVar0 /*18*/], true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) > 900f)
					{
			...
			while (iVar0 < Local_108)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_108[iVar0 /*18*/]))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_108[iVar0 /*18*/]) && SYSTEM::VDIST2(unk_0x8000C77B5F336760(Local_108[iVar0 /*18*/], true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) > 900f)
					{
		...
		case 1:
			...
			while (iVar0 < Local_109)
			{
				...
				{
					iVar1++;
					func_46(AUDIO::_0x0626A247D2405330(), iVar0);
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_109[iVar0 /*18*/]) && SYSTEM::VDIST2(unk_0x8000C77B5F336760(Local_109[iVar0 /*18*/], true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) > 2500f)
					{
						if (ENTITY::DOES_ENTITY_EXIST(Local_109[iVar0 /*18*/].f_2))
						{
							OBJECT::DELETE_OBJECT(&(Local_109[iVar0 /*18*/].f_2));
			...
			if (!iLocal_203)
			{
				if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(func_65(), true)) < 100f)
				{
...
void func_101(char* sParam0)//Position - 0x6B13
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!iLocal_202)
	{
		...
		while (iVar0 < Local_109)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Local_109[iVar0 /*18*/]) && !PED::IS_PED_INJURED(Local_109[iVar0 /*18*/]))
			{
				NETWORK::_0x5E3AA4CA2B6FB0EE(Local_109[iVar0 /*18*/]);
		...
		if (ENTITY::DOES_ENTITY_EXIST(Local_109[iVar0 /*18*/]))
		{
			if (!PED::IS_PED_INJURED(Local_109[iVar0 /*18*/]))
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_67))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(Local_109[iVar0 /*18*/], 0))
					{
						BRAIN::TASK_LEAVE_ANY_VEHICLE(Local_109[iVar0 /*18*/], 0, 0);
					}
					else
					{
				...
				else if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_109[iVar0 /*18*/], 3148068810) != 1)
				{
					BRAIN::TASK_WANDER_STANDARD(Local_109[iVar0 /*18*/], 1193033728, 0);
				}
			}
			if ((ENTITY::IS_ENTITY_OCCLUDED(Local_109[iVar0 /*18*/]) && SYSTEM::VDIST2(unk_0x8000C77B5F336760(Local_109[iVar0 /*18*/], true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) > 400f) && SYSTEM::VDIST2(unk_0x8000C77B5F336760(Local_109[iVar0 /*18*/], true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) > 400f)
			{
				PED::DELETE_PED(&(Local_109[iVar0 /*18*/]));
				if (ENTITY::DOES_ENTITY_EXIST(Local_109[iVar0 /*18*/].f_2))
				{
	...
	while (iVar0 < Local_108)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_108[iVar0 /*18*/]))
		{
			if ((ENTITY::IS_ENTITY_OCCLUDED(Local_108[iVar0 /*18*/]) && SYSTEM::VDIST2(unk_0x8000C77B5F336760(Local_108[iVar0 /*18*/], true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) > 2500f) && func_52(Local_108[iVar0 /*18*/], 0, 0, 0, 0, 0, 1, 0))
			{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_67))
	{
		if (ENTITY::IS_ENTITY_OCCLUDED(iLocal_67) && SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), vLocal_53) > 2500f)
		{
	...
	switch (iLocal_130)
	{
		...
		case 1:
			if (((OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0) && PED::IS_PED_IN_VEHICLE(iLocal_67, iLocal_70, 0)) && !bLocal_129) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_70, 4294967295, 0))
			{
				if (SYSTEM::VDIST(vLocal_53, vLocal_49) < 100f)
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iVar2);
					BRAIN::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(0, iLocal_70, 0);
					BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_70, vLocal_49, 20f, 0, joaat("SERRANO"), 786599, 10f, 10f);
					BRAIN::TASK_VEHICLE_PARK(0, iLocal_70, vLocal_49, 288.7089f, 1, 50f, 0);
					BRAIN::TASK_VEHICLE_MISSION_COORS_TARGET(0, iLocal_70, unk_0x8000C77B5F336760(iLocal_70, true), 5, 10f, 262144, 2f, 2f, 1);
					BRAIN::TASK_LEAVE_VEHICLE(0, iLocal_70, 0);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_50, 1f, 4294967295, 0.25f, 512, fLocal_51);
					BRAIN::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_SMOKING", 0, 1);
					CUTSCENE::_0x8D9DF6ECA8768583(iVar2);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_67, iVar2);
				...
				else
				{
					...
					BRAIN::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(0, iLocal_70, 0);
					BRAIN::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_70, 15f, 786468);
					CUTSCENE::_0x8D9DF6ECA8768583(iVar3);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_67, iVar3);
		...
		case 2:
			if (iVar1 > 0)
			{
				BRAIN::TASK_SMART_FLEE_PED(iLocal_67, AUDIO::_0x0626A247D2405330(), 3000f, 4294967295, 1, 0);
				iLocal_130 = 1000;
			}
			else
			{
				if (SYSTEM::VDIST(vLocal_53, vLocal_49) < 100f)
				{
					...
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_67, iVar4);
...
void func_102()//Position - 0x707D
{
	Global_3960 = 0;
	func_103();
}

void func_103()//Position - 0x708D
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_104()//Position - 0x70AE
{
	...
	if (!PED::IS_PED_INJURED(iLocal_67) && SYSTEM::VDIST2(vLocal_52, vLocal_53) < 900f)
	{
		...
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_67, 2229074605);
	}
	else
	{
		func_190();
	...
	switch (iLocal_130)
	{
		case 0:
			...
			if (!PED::IS_PED_INJURED(iLocal_67))
			{
				...
				BRAIN::TASK_LEAVE_VEHICLE(0, iLocal_70, 0);
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_50, 1f, 30000, 0.25f, 512, fLocal_51);
				BRAIN::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_SMOKING", 0, 1);
				CUTSCENE::_0x8D9DF6ECA8768583(iVar0);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_67, iVar0);
		...
		case 1:
			...
			{
				if (ENTITY::IS_ENTITY_AT_COORD(iLocal_67, vLocal_50, 3f, 3f, 3f, false, true, 0) && ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_50, 5f, 5f, 5f, false, true, 0))
				{
					iLocal_130++;
				}
			}
...
int func_106()//Position - 0x72B6
{
	return 1;
}

void func_107(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x72BF
{
	int iVar0;
	int iVar1;
	...
	func_108(Global_19E56.f_6D76[iParam0 /*29*/].f_11, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
int func_108(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x73A6
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_109(bool bParam0)//Position - 0x79A5
{
	int iVar0;
	int iVar1;
...
void func_110(int iParam0)//Position - 0x7C27
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x7C81
{
	bool bVar0;
	char cVar1[64];
	...
	if (iParam0 == 8)
	{
		func_85(129, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 9)
	{
		func_85(135, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 10)
	{
		func_85(136, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 11)
	{
		func_85(137, 0, 4294967295, 1);
		return;
	}
	bVar0 = false;
	...
	else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_5038.f_1D7, iParam0) || INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_113() /*12745*/].f_1FF2.f_A, iParam0))
	{
		bVar0 = true;
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_19E56.f_5038.f_1D7), iParam0);
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_200000[func_113() /*12745*/].f_1FF2.f_A), iParam0);
	}
	if (bVar0)
	{
...
char* func_112(int iParam0)//Position - 0x7D92
{
	switch (iParam0)
	{
		case 0:
...
void func_114(int iParam0)//Position - 0x7E4C
{
	func_134(93, iParam0);
	func_134(29, iParam0);
	func_134(30, iParam0);
...
bool func_115(int iParam0)//Position - 0x7E6C
{
	if (iParam0 == 8)
	{
		return func_116(129, 4294967295, 4294967295);
	}
	if (iParam0 == 9)
	{
		return func_116(135, 4294967295, 4294967295);
	}
	if (iParam0 == 10)
	{
		return func_116(136, 4294967295, 4294967295);
	}
	if (iParam0 == 11)
	{
		return func_116(137, 4294967295, 4294967295);
	}
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_5038.f_1D7, iParam0);
	}
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_113() /*12745*/].f_1FF2.f_A, iParam0);
}

int func_116(int iParam0, int iParam1, int iParam2)//Position - 0x7EF0
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_117(int iParam0)//Position - 0x7F2D
{
	int iVar0;
...
int func_118(int iParam0, int iParam1)//Position - 0x8246
{
	int iVar0;
...
int func_119(bool bParam0)//Position - 0x853E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_120(int iParam0, int iParam1)//Position - 0x85F5
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_121(int iParam0, int iParam1)//Position - 0x8610
{
	...
	if (func_131(&Global_412216))
	{
		if (func_129(&Global_412216, iParam0))
		{
			return 0;
		}
...
int func_122(var uParam0, int iParam1)//Position - 0x86AD
{
	int iVar0;
	var uVar1[78];
...
int func_123(var uParam0, int iParam1)//Position - 0x875E
{
	int iVar0;
...
bool func_124(var uParam0, int iParam1)//Position - 0x87D9
{
	return (*uParam0)[iParam1] == 78;
}

void func_125(var uParam0)//Position - 0x87EA
{
	int iVar0;
	...
	func_127(uParam0, (Global_412215 - 0.5f));
}

void func_126(var uParam0, int iParam1)//Position - 0x881E
{
	(*uParam0)[iParam1] = 78;
}

void func_127(var uParam0, float fParam1)//Position - 0x882E
{
	if (fParam1 == 0f)
	{
		uParam0->f_50 = 0f;
...
float func_128(var uParam0)//Position - 0x884B
{
	return uParam0->f_50;
}

bool func_129(var uParam0, int iParam1)//Position - 0x8857
{
	return func_130(uParam0, iParam1) != 4294967295;
}

int func_130(var uParam0, int iParam1)//Position - 0x8869
{
	int iVar0;
...
bool func_131(var uParam0)//Position - 0x8896
{
	return uParam0->f_4F == 1;
}

int func_132(int iParam0)//Position - 0x88A4
{
	switch (iParam0)
	{
		case 60:
...
void func_133(int iParam0, int iParam1)//Position - 0x88F4
{
	int iVar0;
...
void func_134(int iParam0, int iParam1)//Position - 0x8917
{
	int iVar0;
...
void func_136(bool bParam0)//Position - 0x89E9
{
	if (!PED::IS_PED_INJURED(iLocal_67))
	{
		if (iLocal_170 > 1)
		{
			if (!PED::IS_PED_FACING_PED(iLocal_67, AUDIO::_0x0626A247D2405330(), 60f))
			{
				iLocal_170 = 0;
				iLocal_171 = 0;
			}
		...
		switch (iLocal_170)
		{
			case 0:
				NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_67);
				BRAIN::TASK_LOOK_AT_ENTITY(iLocal_67, AUDIO::_0x0626A247D2405330(), 4294967295, 16, 2);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_169);
				...
				CUTSCENE::_0x8D9DF6ECA8768583(iLocal_169);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_67, iLocal_169);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_169);
				iLocal_170++;
				break;
			
			case 1:
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_67, 242628503) != 1)
				{
					iLocal_170++;
				}
				break;
				...
				if (bParam0)
				{
					switch (iLocal_171)
					{
						case 0:
							...
							{
								BRAIN::TASK_PLAY_ANIM(iLocal_67, "random@paparazzi@wait", "wait_a", 4f, -4f, 4294967295, 0, 0, 0, 0, 0);
							}
							else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_67, "random@paparazzi@wait", "wait_a") > 0.95f)
							{
								BRAIN::TASK_PLAY_ANIM(iLocal_67, "random@paparazzi@wait", "wait_b", 4f, -4f, 4294967295, 0, 0, 0, 0, 0);
								iLocal_171++;
							}
							break;
						...
						case 1:
							...
							{
								BRAIN::TASK_PLAY_ANIM(iLocal_67, "random@paparazzi@wait", "wait_c", 4f, -4f, 4294967295, 0, 0, 0, 0, 0);
								iLocal_171++;
							}
							break;
...
void func_138()//Position - 0x8C20
{
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0))
	{
		...
		{
			case 0:
				if (!PED::IS_PED_INJURED(iLocal_67) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0))
				{
					func_137();
					func_142(1, 1, 0, 0, 0);
					if (HUD::DOES_BLIP_EXIST(iLocal_123))
					...
					if (!PED::IS_PED_INJURED(iLocal_67))
					{
						BRAIN::TASK_LOOK_AT_COORD(iLocal_67, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_70, -10f, 5f, 0f), 4294967295, 16, 4);
					}
					BRAIN::TASK_LOOK_AT_COORD(AUDIO::_0x0626A247D2405330(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_70, 10f, 5f, 0f), 15000, 16, 4);
					PLAYER::SET_PLAYER_CONTROL(CAM::_0xDC9DA9E8789F5246(), false, 1280);
			...
			case 3:
				if ((!PED::IS_PED_INJURED(iLocal_67) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0)) && SYSTEM::TIMERA() > 1000)
				{
					BRAIN::TASK_LEAVE_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_70, 0);
					BRAIN::TASK_LOOK_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_70, 10000, 0, 3);
					iLocal_130++;
				}
				break;
			
			case 4:
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0) && !PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_70, 0))
				{
					PLAYER::SET_PLAYER_CONTROL(CAM::_0xDC9DA9E8789F5246(), true, 0);
					func_142(0, 1, 0, 0, 0);
				...
				if (SYSTEM::TIMERA() > 1000)
				{
					if (func_106())
					{
						if (!bLocal_129)
						{
							if (!func_94(19))
							{
								func_90("AM_H_CALLTX", 1, 0, 4294967295, 10000, 7, 0, 0, 0);
								func_89(19);
							}
						}
						func_75();
...
bool func_139(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8F4E
{
...
void func_140()//Position - 0x8FA2
{
	Global_3960 = 0;
	func_141();
}

void func_141()//Position - 0x8FB2
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_142(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x8FD6
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if ((((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_146(CAM::_0xDC9DA9E8789F5246())) && !func_144(CAM::_0xDC9DA9E8789F5246(), 0)) && !func_143()) && !bParam4)
			{
				ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_146(CAM::_0xDC9DA9E8789F5246())) && !bParam4)
		{
			ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), false);
		}
		Global_11623 = 0;
...
int func_145(int iParam0, bool bParam1)//Position - 0x9167
{
	int iVar0;
	int iVar1;
...
int func_146(int iParam0)//Position - 0x91A8
{
...
bool func_147()//Position - 0x91EA
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_240006, 3);
}

int func_148(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x91FB
{
	int iVar0;
...
void func_149(int iParam0)//Position - 0x922E
{
	if (iParam0 == 1)
	{
...
void func_150()//Position - 0x9251
{
	...
	if (bLocal_129 && !PED::IS_PED_INJURED(iLocal_67))
	{
		...
		if (!PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_70, 0))
		{
			if ((PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 0)) && func_170(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
			{
				iLocal_70 = 0;
				iLocal_70 = PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0);
		...
		{
			if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_50, 15f, 15f, 15f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), 231.7982f, 672.7683f, 189.2f, 1f, 1f, 2.5f, true, true, 0))
			{
				func_178(4);
			}
		}
		else if (iLocal_130 != 100)
		{
			...
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_70, 225.5938f, 681.1489f, 188.4262f, 232.02f, 681.3113f, 191.9843f, 8.75f, 0, true, 0) || ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), 226.6788f, 681.0637f, 189f, 1f, 1f, 2.5f, true, true, 0))
				{
					SYSTEM::SETTIMERA(0);
					iLocal_130 = 100;
				}
			...
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_67, 2500551826) != 1)
				{
					BRAIN::TASK_ENTER_VEHICLE(iLocal_67, iLocal_70, 4294967295, func_168(iLocal_70), 2f, 8388608, 0);
				}
			}
		}
	}
...
var func_151()//Position - 0x9A5D
{
	return Global_645E;
}

int func_152(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x9A68
{
...
void func_153(int iParam0)//Position - 0x9BF7
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
int func_154(char* sParam0)//Position - 0x9C23
{
	vector3 vVar0;
...
int func_155(char* sParam0, bool bParam1)//Position - 0x9C77
{
	if (bParam1)
	{
		if (!iLocal_58)
...
struct<6> func_156()//Position - 0x9D27
{
	struct<6> Var0;
	int iVar1;
	int iVar2;
...
bool func_157(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x9DD3
{
	func_16(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
int func_158()//Position - 0x9E27
{
	if (bLocal_129)
	{
		...
		if (!PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_67, 0))
		{
...
int func_161(vector3 vParam0, bool bParam1)//Position - 0x9EE8
{
	return func_50(vParam0, bParam1);
}

void func_162()//Position - 0x9EFA
{
	if (func_19() == 2)
	{
		if (!Global_6460)
		{
			func_163("CULT_BLIP_HELP", 4294967295);
			Global_6460 = 1;
		}
	}
}

void func_163(char* sParam0, int iParam1)//Position - 0x9F1E
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_164()//Position - 0x9F35
{
...
void func_165(bool bParam0)//Position - 0x9F51
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0) && !PED::IS_PED_INJURED(iLocal_67))
	{
		if (func_66())
		{
			if (bParam0)
...
int func_166(int iParam0, bool bParam1, bool bParam2)//Position - 0xA025
{
	return func_167(iParam0, !bParam1, bParam2);
}

int func_167(int iParam0, bool bParam1, bool bParam2)//Position - 0xA038
{
	int iVar0;
...
int func_168(int iParam0)//Position - 0xA0DC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_169(bool bParam0, bool bParam1, bool bParam2)//Position - 0xA126
{
	int iVar0;
...
int func_170(int iParam0)//Position - 0xA20B
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
int func_171(int iParam0)//Position - 0xA25B
{
	if (PED::IS_PED_GROUP_MEMBER(iParam0, PLAYER::GET_PLAYER_GROUP(CAM::_0xDC9DA9E8789F5246())))
	{
		if (!ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iParam0, 25f, 25f, 25f, 0, 1, 0))
		{
...
void func_172()//Position - 0xA2C5
{
	if (!PED::IS_PED_INJURED(iLocal_67) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0))
	{
		...
		if ((ENTITY::DOES_ENTITY_EXIST(func_65()) && SYSTEM::VDIST2(unk_0x8000C77B5F336760(iLocal_67, true), unk_0x8000C77B5F336760(func_65(), true)) < 100f) && (ENTITY::GET_ENTITY_SPEED(iLocal_70) < 5f || !VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iLocal_70))))
		{
			if (bLocal_129)
			{
				if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_67, "VEH@STD@PS@IDLE_PANIC", "sit", 3) && PED::IS_PED_SITTING_IN_VEHICLE(iLocal_67, iLocal_70))
				{
					BRAIN::TASK_PLAY_ANIM(iLocal_67, "VEH@STD@PS@IDLE_PANIC", "sit", 4f, -4f, 4294967295, 48, 0, 0, 0, 0);
				}
			}
			...
			{
				BRAIN::TASK_PLAY_ANIM(iLocal_67, "VEH@LOW@FRONT_PS@IDLE_PANIC", "sit", 4f, -4f, 4294967295, 48, 0, 0, 0, 0);
			}
		}
		...
		switch (iLocal_130)
		{
			...
			case 2:
				...
				if (Global_3 || bLocal_56)
				{
					if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), 244.2175f, 441.0128f, 126.2767f, 33.5f, 40f, 14.75f, false, true, 0) && func_66())
					{
						iLocal_47 = 4;
...
int func_173()//Position - 0xABEF
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_196) > 5000)
	{
		...
		{
			if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_70, 1))
			{
				if (iVar0 != 4294967295 && (MISC::GET_GAME_TIMER() - Local_109[iVar0 /*18*/].f_C) < 3000)
				{
...
void func_174()//Position - 0xAC91
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_145) > iLocal_146)
	{
		...
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(vLocal_53, unk_0x8000C77B5F336760(func_65(), true), true) < 8f)
			{
...
void func_175()//Position - 0xAEF8
{
	...
	if (!PED::IS_PED_INJURED(iLocal_67))
	{
		if (HUD::DOES_BLIP_EXIST(iLocal_121))
		{
			HUD::_0x75A16C3DA34F1245(iLocal_121, iLocal_194);
		}
		switch (iLocal_130)
		{
			case 0:
				...
				if ((STREAMING::HAS_ANIM_DICT_LOADED("random@paparazzi@peek") && STREAMING::HAS_ANIM_DICT_LOADED("random@paparazzi@trans")) && STREAMING::HAS_ANIM_DICT_LOADED("random@paparazzi@wait"))
				{
					...
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_67, iLocal_174, "random@paparazzi@peek", "left_peek_a", 1000f, -8f, 1, 0, 1148846080, 0);
					BRAIN::TASK_LOOK_AT_ENTITY(iLocal_67, AUDIO::_0x0626A247D2405330(), 4294967295, 4, 4);
					sLocal_175[0] = "peek_a";
					sLocal_175[1] = "peek_b";
					sLocal_175[2] = "peek_c";
					GRAPHICS::_0x54E22EA2C1956A8D(0.2f);
			...
			case 1:
				if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_190, 0))
				{
					if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_190, 1))
					{
				...
				iVar2 = 0;
				bVar0 = ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_181, vLocal_182, fLocal_183, 0, true, 0);
				bVar1 = ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_178, vLocal_179, fLocal_180, 0, true, 0);
				...
				if ((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_174) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_174) > 0.9f) || iVar2)
				{
					if (iLocal_190 == 0)
					{
						...
						iLocal_174 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_187, vLocal_188, 2);
						BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_67, iLocal_174, "random@paparazzi@peek", &cVar3, 4f, -4f, 1, 0, 1148846080, 0);
				...
				if (bVar0 || bVar1)
				{
					...
					if ((MISC::GET_GAME_TIMER() - iLocal_173) > 5000 && iLocal_190 == 0)
					{
						if (SYSTEM::VDIST2(vLocal_52, vLocal_53) < (22.2f * 22.2f))
						{
							...
							if (func_19() == 1)
							{
								func_17(&Local_139, 1, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
							}
							else if (func_19() == 0)
							{
								func_17(&Local_139, 1, AUDIO::_0x0626A247D2405330(), "MICHAEL", 0, 1);
							}
							else
							{
								func_17(&Local_139, 1, AUDIO::_0x0626A247D2405330(), "TREVOR", 0, 1);
							}
							if (func_5(&Local_139, cLocal_133, sVar4, 4, 0, 0, 0))
							{
								iLocal_192 = 1;
								if (!ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_67, 7f, 7f, 7f, 0, 1, 0))
								{
									NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_67);
									StringCopy(&cVar5, sLocal_177, 24);
									StringConCat(&cVar5, "come_here", 24);
									iLocal_174 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_187, vLocal_188, 2);
									BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_67, iLocal_174, "random@paparazzi@peek", &cVar5, 4f, -4f, 1, 0, 1148846080, 0);
									MISC::SET_BIT(&iLocal_190, 0);
								}
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_184, vLocal_185, fLocal_186, 0, true, 0) && iLocal_190 == 0)
				{
					...
					if (bVar1)
					{
						BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_67, iLocal_174, "random@paparazzi@trans", "trans_left_to_wait", 8f, -4f, 1, 0, 1148846080, 0);
					}
					else
					{
						BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_67, iLocal_174, "random@paparazzi@trans", "trans_right_to_wait", 8f, -4f, 1, 0, 1148846080, 0);
					}
					MISC::SET_BIT(&iLocal_190, 0);
					iLocal_130++;
				}
			...
			case 2:
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_174) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_174) > 0.9f)
				{
					...
					{
						NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_67);
						BRAIN::TASK_PLAY_ANIM(iLocal_67, "random@paparazzi@wait", "wait_c", 8f, -4f, 4294967295, 0, 0, 0, 0, 0);
						iLocal_170 = 2;
						SYSTEM::SETTIMERA(0);
					}
					iLocal_130++;
			...
			case 4:
				...
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_70, iLocal_67, Global_13 + Vector(2f, 12f, 12f), 0, 1, 0) && !bLocal_129)
					{
						if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_67, 242628503) != 1 && !iLocal_189)
						{
							...
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_67, iVar6);
							MISC::_0x1327E2FE9746BAEE(iLocal_67, 0, 0);
					...
					if ((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_70, iLocal_67, Global_13, 0, 1, 0) && func_170(iLocal_70)) && (SYSTEM::TIMERA() > 6000 || !bLocal_129))
					{
						if (!iLocal_172)
						{
							func_102();
						...
						else
						{
							...
							NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_67);
							BRAIN::TASK_ENTER_VEHICLE(iLocal_67, iLocal_70, 4294967295, func_168(iLocal_70), 1f, 8388608, 0);
						}
					}
				}
				break;
			...
			case 5:
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0))
				{
					...
					else
					{
						if (!Global_3 && !bLocal_56)
						{
							if ((PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_70, 0) && !PED::IS_PED_IN_VEHICLE(iLocal_67, iLocal_70, 1)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_70, 225.1779f, 125.6632f, 113.6647f, 262.3032f, 111.8771f, 97.16339f, 37f, 0, true, 0))
							{
								if (bLocal_129)
								{
			...
			case 101:
				if (SYSTEM::VDIST2(vLocal_52, vLocal_53) < 49f && !PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
				{
					if (ENTITY::GET_ENTITY_SPEED(AUDIO::_0x0626A247D2405330()) < 3f)
					{
				...
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_70, 0))
				{
					if (!PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_70, 0) && func_177())
					{
						bLocal_129 = true;
						iLocal_60 = 1;
						iLocal_70 = PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0);
					...
					if (PED::IS_PED_SITTING_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_70))
					{
						if (HUD::DOES_BLIP_EXIST(iLocal_122))
						{
							HUD::REMOVE_BLIP(&iLocal_122);
			...
			else
			{
				if (!bLocal_129)
				{
					if (!Global_3 && !bLocal_56)
					{
						...
						{
							if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_70, AUDIO::_0x0626A247D2405330(), 1))
							{
...
void func_176(vector3 vParam0, bool bParam1)//Position - 0xBB83
{
	if (SYSTEM::VDIST(vLocal_53, vParam0) > 2.5f)
	{
		if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_67, 713668775) != 1)
		{
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_67, vParam0, 1f, 4294967295, 0.25f, 0, 1193033728);
		}
	}
	else if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_67, 713668775) != 1)
	{
		func_136(bParam1);
		BRAIN::TASK_LOOK_AT_ENTITY(iLocal_67, AUDIO::_0x0626A247D2405330(), 4294967295, 16, 2);
	}
...
bool func_177()//Position - 0xBBEC
{
	return (((((PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 0)) && (VEHICLE::IS_THIS_MODEL_A_CAR(ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0))) || VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0))))) && VEHICLE::GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)) > 0) && func_170(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0))) && !Global_19A9D);
}

void func_178(int iParam0)//Position - 0xBC6D
{
	iLocal_45 = iParam0;
	iLocal_130 = 0;
}

void func_179(char* sParam0)//Position - 0xBC7D
{
	int iVar0;
...
int func_180(int iParam0, bool bParam1, int iParam2)//Position - 0xBD02
{
	int iVar0;
...
int func_181(int iParam0)//Position - 0xBD54
{
	if (func_184())
	{
		Global_19E4C = 1;
		Global_19E49 = MISC::GET_GAME_TIMER();
		if (func_88(Global_19E4B))
		{
			func_182(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_88(Global_19E4B))
		{
...
void func_182(int iParam0)//Position - 0xBDA7
{
	switch (iParam0)
	{
		case 0:
			if (Global_19E56.f_6187.f_2 < 3)
			{
				...
				{
					func_163(func_183(iParam0), 4294967295);
...
char* func_183(int iParam0)//Position - 0xBE88
{
	char* sVar0;
...
int func_184()//Position - 0xBECA
{
	switch (func_185(&Global_63AE, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_185(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xBF00
{
	int iVar0;
...
void func_186(var uParam0, int iParam1)//Position - 0xC038
{
	int iVar0;
...
bool func_187(int iParam0)//Position - 0xC087
{
	return func_188(iParam0, Global_8D15);
}

int func_188(int iParam0, int iParam1)//Position - 0xC098
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_189(int iParam0)//Position - 0xC279
{
	if (Global_8D15 == 15)
	{
		return 0;
...
void func_190()//Position - 0xC29B
{
	...
	while (iVar0 < Local_109)
	{
		if (!PED::IS_PED_INJURED(Local_109[iVar0 /*18*/]))
		{
			BRAIN::TASK_SMART_FLEE_PED(Local_109[iVar0 /*18*/], AUDIO::_0x0626A247D2405330(), 300f, 4294967295, 0, 0);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_109[iVar0 /*18*/], 2229074605);
			ENTITY::SET_ENTITY_HEALTH(Local_109[iVar0 /*18*/], false);
		}
		iVar0++;
	}
}

int func_191()//Position - 0xC318
{
	int iVar0;
	int iVar1;
	...
	while (iVar1 < Local_109)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_109[iVar1 /*18*/]) && !PED::IS_PED_INJURED(Local_109[iVar1 /*18*/]))
		{
			...
			{
				if (((MISC::IS_BULLET_IN_AREA(Local_109[iVar1 /*18*/].f_6, 5f, 1) || FIRE::IS_EXPLOSION_IN_SPHERE(4294967295, Local_109[iVar1 /*18*/].f_6, 10f)) || PED::IS_PED_FLEEING(Local_109[iVar1 /*18*/])) || (iLocal_138[iVar1] > 10 && iLocal_45 == 0))
				{
					iVar0 = 1;
				}
			}
	...
	while (iVar1 < Local_108)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_108[iVar1 /*18*/]))
		{
			if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_108[iVar1 /*18*/], 0) && ENTITY::IS_ENTITY_VISIBLE(Local_108[iVar1 /*18*/]))
			{
...
int func_192()//Position - 0xC412
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(AUDIO::_0x0626A247D2405330())) > 1369f && !func_203())
		{
			return 0;
		}
	}
...
int func_193(float fParam0, bool bParam1)//Position - 0xC498
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_194(int iParam0, var uParam1)//Position - 0xC54F
{
	switch (iParam0)
	{
		case 0:
		...
		case 1:
			func_195(uParam1, "Abigail2", func_197(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, 4294967295, 4, 1, 0, 2359, func_196(iParam0), 1, 0);
			break;
		
		case 2:
			func_195(uParam1, "Barry1", func_197(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 0, 2359, func_196(iParam0), 1, 0);
			break;
		
		case 3:
			func_195(uParam1, "Barry2", func_197(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_196(iParam0), 1, 1);
			break;
		
		case 4:
			func_195(uParam1, "Barry3", func_197(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", 4294967295, 0, "", 164, 1, 4294967295, 0, 2, 0, 2359, func_196(iParam0), 0, 0);
			break;
		...
		case 7:
			func_195(uParam1, "Barry4", func_197(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, 4294967295, 4, 2, 800, 2000, func_196(iParam0), 0, 0);
			break;
		
		case 8:
			func_195(uParam1, "Dreyfuss1", func_197(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_196(iParam0), 0, 0);
			break;
		...
		case 15:
			func_195(uParam1, "Epsilon7", func_197(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", 4294967295, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_196(iParam0), 0, 0);
			break;
		
		case 16:
			func_195(uParam1, "Epsilon8", func_197(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, 4294967295, 4, 1, 0, 2359, func_196(iParam0), 1, 0);
			break;
		
		case 17:
			func_195(uParam1, "Extreme1", func_197(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", 4294967295, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_196(iParam0), 0, 1);
			break;
		...
		case 20:
			func_195(uParam1, "Extreme4", func_197(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_196(iParam0), 0, 0);
			break;
		
		case 21:
			func_195(uParam1, "Fanatic1", func_197(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 700, 2000, func_196(iParam0), 1, 0);
			break;
		
		case 22:
			func_195(uParam1, "Fanatic2", func_197(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 700, 2000, func_196(iParam0), 1, 0);
			break;
		
		case 23:
			func_195(uParam1, "Fanatic3", func_197(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 2, 700, 2000, func_196(iParam0), 0, 1);
			break;
		
		case 24:
			func_195(uParam1, "Hao1", func_197(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", 4294967295, 0, "controller_Races", 13, 1, 4294967295, 4, 2, 2000, 500, func_196(iParam0), 0, 1);
			break;
		
		case 25:
			func_195(uParam1, "Hunting1", func_197(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", 4294967295, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_196(iParam0), 0, 1);
			break;
		
		case 26:
			func_195(uParam1, "Hunting2", func_197(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, 4294967295, 4, 4, 0, 2359, func_196(iParam0), 0, 1);
			break;
		
		case 27:
			func_195(uParam1, "Josh1", func_197(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", 4294967295, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_196(iParam0), 1, 0);
			break;
		...
		case 29:
			func_195(uParam1, "Josh3", func_197(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 4294967295, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_196(iParam0), 1, 1);
			break;
		
		case 30:
			func_195(uParam1, "Josh4", func_197(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", 4294967295, 36, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_196(iParam0), 1, 0);
			break;
		
		case 31:
			func_195(uParam1, "Maude1", func_197(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", 4294967295, 0, "BailBond_Launcher", 0, 1, 4294967295, 4, 4, 0, 2359, func_196(iParam0), 0, 1);
			break;
		
		case 32:
			func_195(uParam1, "Minute1", func_197(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", 4294967295, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_196(iParam0), 0, 1);
			break;
		
		case 33:
			func_195(uParam1, "Minute2", func_197(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", 4294967295, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_196(iParam0), 0, 1);
			break;
		
		case 34:
			func_195(uParam1, "Minute3", func_197(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", 4294967295, 10, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_196(iParam0), 0, 1);
			break;
		
		case 35:
			func_195(uParam1, "MrsPhilips1", func_197(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", 4294967295, 0, "ambient_MrsPhilips", 0, 1, 4294967295, 4, 4, 0, 2359, func_196(iParam0), 0, 0);
			break;
		
		case 36:
			func_195(uParam1, "MrsPhilips2", func_197(iParam0), 0, 11, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_196(iParam0), 0, 0);
			break;
		
		case 37:
			func_195(uParam1, "Nigel1", func_197(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", 4294967295, 0, "", 177, 1, 4294967295, 1, 4, 0, 2359, func_196(iParam0), 1, 0);
			break;
		...
		case 42:
			func_195(uParam1, "Nigel2", func_197(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", 4294967295, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_196(iParam0), 1, 1);
			break;
		
		case 43:
			func_195(uParam1, "Nigel3", func_197(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", 4294967295, 16, "postRC_Nigel3", 0, 0, 4294967295, 4, 4, 0, 2359, func_196(iParam0), 1, 1);
			break;
		
		case 44:
			func_195(uParam1, "Omega1", func_197(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", 4294967295, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_196(iParam0), 0, 0);
			break;
		
		case 45:
			func_195(uParam1, "Omega2", func_197(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_196(iParam0), 0, 0);
			break;
		
		case 46:
			func_195(uParam1, "Paparazzo1", func_197(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", 4294967295, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_196(iParam0), 0, 1);
			break;
		
		case 47:
			func_195(uParam1, "Paparazzo2", func_197(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", 4294967295, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_196(iParam0), 0, 1);
			break;
		
		case 48:
			func_195(uParam1, "Paparazzo3", func_197(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", 4294967295, 8, "", 183, 1, 4294967295, 2, 2, 0, 2359, func_196(iParam0), 0, 0);
			break;
		...
		case 51:
			func_195(uParam1, "Paparazzo4", func_197(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", 4294967295, 8, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_196(iParam0), 0, 0);
			break;
		
		case 52:
			func_195(uParam1, "Rampage1", func_197(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", 4294967295, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_196(iParam0), 0, 0);
			break;
		
		case 54:
			func_195(uParam1, "Rampage3", func_197(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", 4294967295, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_196(iParam0), 1, 0);
			break;
		
		case 55:
			func_195(uParam1, "Rampage4", func_197(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", 4294967295, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_196(iParam0), 1, 0);
			break;
		
		case 56:
			func_195(uParam1, "Rampage5", func_197(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", 4294967295, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_196(iParam0), 0, 0);
			break;
		
		case 53:
			func_195(uParam1, "Rampage2", func_197(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", 4294967295, 0, "rampage_controller", 0, 0, 4294967295, 4, 4, 0, 2359, func_196(iParam0), 1, 0);
			break;
		
		case 57:
			func_195(uParam1, "TheLastOne", func_197(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_196(iParam0), 0, 1);
			break;
		
		case 58:
			func_195(uParam1, "Tonya1", func_197(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", 4294967295, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_196(iParam0), 0, 1);
			break;
		
		case 59:
			func_195(uParam1, "Tonya2", func_197(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_196(iParam0), 0, 1);
			break;
		
		case 60:
			func_195(uParam1, "Tonya3", func_197(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_196(iParam0), 0, 1);
			break;
		
		case 61:
			func_195(uParam1, "Tonya4", func_197(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_196(iParam0), 0, 1);
			break;
		
		case 62:
			func_195(uParam1, "Tonya5", func_197(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_196(iParam0), 0, 1);
			break;
...
int func_196(int iParam0)//Position - 0xD755
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_197(int iParam0)//Position - 0xDA9B
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_198(int iParam0)//Position - 0xDAD1
{
	struct<2> Var0;
...
bool func_200()//Position - 0xDF4E
{
	return Global_19D3C > 0;
}

int func_201()//Position - 0xDF5C
{
...
int func_205(vector3 vParam0)//Position - 0xE21E
{
	int iVar0;
...
void func_206(int iParam0, bool bParam1)//Position - 0xE240
{
	if (bParam1)
	{
...
void func_207(int iParam0, int iParam1, bool bParam2)//Position - 0xE277
{
	int iVar0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_83() == 0)
		{
			iVar0 = func_210(func_211(iParam0), 4294967295, 0);
			GRAPHICS::_0x35FB78DC42B7BD21(&iVar0, iParam1);
			func_208(func_211(iParam0), iVar0, 4294967295, 1, 0);
		}
	}
	else
	{
...
void func_208(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xE2E9
{
	int iVar0;
	...
	iVar0 = Global_26B05F[iParam0 /*3*/][func_209(iParam2)];
	if (iVar0 != 0)
	{
...
int func_209(var uParam0)//Position - 0xE319
{
	int iVar0;
	int iVar1;
...
int func_210(int iParam0, int iParam1, int iParam2)//Position - 0xE34D
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Global_26B05F[iParam0 /*3*/][func_209(iParam1)];
...
int func_211(int iParam0)//Position - 0xE37F
{
	switch (iParam0)
	{
		case 0:
...
void func_212(int iParam0, int iParam1, bool bParam2)//Position - 0xE682
{
	int iVar0;
...
int func_213(int iParam0, int iParam1, bool bParam2)//Position - 0xE6F4
{
	if (iParam0 == 4294967295)
	{
		return 0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_83() == 0)
		{
			return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(func_210(func_211(iParam0), 4294967295, 0), iParam1);
		}
	}
	else
	{
...
int func_215(var uParam0)//Position - 0xE899
{
	int iVar0;
...
bool func_216(var uParam0)//Position - 0xE8FB
{
	return func_217(*uParam0, "NULL", uParam0->f_1);
}

int func_217(int iParam0, char* sParam1, int iParam2)//Position - 0xE910
{
...
int func_218(int iParam0)//Position - 0xEA04
{
	int iVar0;
...
void func_219(var uParam0)//Position - 0xEA30
{
	func_220(uParam0, 9, 4294967295, 0);
}

void func_220(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEA42
{
	int iVar0;
...
int func_221(int iParam0)//Position - 0xEB05
{
	switch (iParam0)
	{
		case 4294967295:
...
void func_222(var uParam0, int iParam1)//Position - 0xEBA4
{
	func_220(uParam0, 0, iParam1, 0);
}

int func_223()//Position - 0xEBB6
{
	if (!func_187(5))
	{
		return 1;
...
int func_224()//Position - 0xEC18
{
	if ((Global_19E4B == func_97() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_19E4C)
	{
		return 1;
	}
	return 0;
...
void func_225(var uParam0)//Position - 0xEC43
{
	int iVar0;
...
void func_226(int iParam0)//Position - 0xECCD
{
	func_227(iParam0, "NULL", iParam0->f_1);
}

void func_227(int iParam0, char* sParam1, int iParam2)//Position - 0xECE1
{
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 30))
	{
		switch (func_218(*iParam0))
...
void func_228(int iParam0)//Position - 0xEDBB
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_97();
...
void func_230(int iParam0)//Position - 0xEE2E
{
	Global_19E4B = iParam0;
}

int func_231(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xEE3C
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_267(Global_19E56.f_6187.f_2B[iParam1]))
		{
			return 0;
		}
...
bool func_232(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0xF1D6
{
	if (bParam2)
	{
...
bool func_233(int iParam0)//Position - 0xF21D
{
	int iVar0;
...
int func_234(int iParam0)//Position - 0xF23E
{
	return func_235(iParam0, 1);
}

int func_235(int iParam0, int iParam1)//Position - 0xF24D
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_236(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xF2A0
{
	func_237(func_248(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_237(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xF2BE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_238(float fParam0, float fParam1, float fParam2)//Position - 0xF4BF
{
	float fVar0;
...
int func_239(int iParam0, int iParam1)//Position - 0xF501
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_240(int iParam0)//Position - 0xF5A3
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_241(int iParam0)//Position - 0xF5B6
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_242(int iParam0)//Position - 0xF5C9
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_243(int iParam0)//Position - 0xF5DC
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_244(int iParam0)//Position - 0xF5EE
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_245(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}

int func_245(bool bParam0, int iParam1, int iParam2)//Position - 0xF613
{
	if (bParam0)
	{
		return iParam1;
...
int func_246(int iParam0)//Position - 0xF62A
{
	return iParam0 & 15;
}

int func_247(int iParam0, int iParam1)//Position - 0xF637
{
	int iVar0;
	int iVar1;
...
void func_249(var uParam0, int iParam1)//Position - 0xF789
{
	if (iParam1 <= 0)
	{
		return;
...
void func_250(var uParam0, int iParam1)//Position - 0xF80F
{
...
void func_251(var uParam0, int iParam1)//Position - 0xF842
{
	int iVar0;
	int iVar1;
...
void func_252(var uParam0, int iParam1)//Position - 0xF893
{
...
void func_253(var uParam0, int iParam1)//Position - 0xF8CD
{
...
void func_254(var uParam0, int iParam1)//Position - 0xF908
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_255(int iParam0)//Position - 0xF944
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_256(int iParam0, int iParam1)//Position - 0xFA20
{
...
int func_257(int iParam0)//Position - 0xFA43
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_265()) || Global_19A9D) || Global_6375) || func_264()) || func_14(8, 4294967295)) || func_263()) || func_262()) || func_261()) || func_260()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_265()) || Global_6375) || func_264()) || func_14(8, 4294967295)) || func_261()) || func_263()) || func_262()) || func_260()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_265()) || Global_19A9D) || Global_6375) || func_264()) || func_14(8, 4294967295)) || func_261()) || func_263()) || func_262()) || func_260()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_265()) || Global_19A9D) || Global_6375) || func_264()) || func_14(8, 4294967295)) || func_263()) || func_262()) || func_260()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_265() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_14(8, 4294967295)) || func_260()) || func_259()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_14(8, 4294967295) || func_263()) || func_262()) || func_259()) || func_258())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_265()) || Global_6375) || func_264()) || func_14(8, 4294967295)) || func_262()) || func_261()) || func_260()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_258()//Position - 0x10161
{
	return Global_16C57.f_1;
}

int func_259()//Position - 0x1016F
{
	if (Global_16089 != 4294967295)
	{
...
bool func_262()//Position - 0x101D9
{
	return Global_16C64.f_148 > 0;
}

bool func_263()//Position - 0x101EA
{
	return Global_16C64.f_147 > 0;
}

var func_264()//Position - 0x101FB
{
	return Global_140859;
}

int func_265()//Position - 0x10207
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_267(int iParam0)//Position - 0x1024B
{
	return func_247(func_248(), iParam0);
}

int func_268(int iParam0, int iParam1, int iParam2)//Position - 0x1025D
{
	int iVar0;
	int iVar1;
...
int func_269(int iParam0)//Position - 0x10341
{
	if (!func_21(iParam0))
	{
		return 7;
...
bool func_270(int iParam0)//Position - 0x10365
{
	int iVar0;
	bool bVar1;
...
void func_273(var uParam0, int iParam1)//Position - 0x104C2
{
	if (iParam1 > 0)
	{
...
void func_274()//Position - 0x104D9
{
	func_292(0);
...
void func_275()//Position - 0x1062D
{
	Global_645E = 0;
	Global_645F = 0;
	Global_6461 = 0;
...
void func_276(int iParam0)//Position - 0x10649
{
	char cVar0[64];
	...
	if (func_224())
	{
		...
		func_279(30000);
		StringCopy(&cVar0, func_278(Global_19E4B, 1), 64);
		if (func_96(Global_19E4B) > 0)
		{
	...
	func_277(&Global_63AE);
	Global_19E4C = 0;
	func_230(4294967295);
}

void func_277(var uParam0)//Position - 0x106FE
{
	if (*uParam0 == 4294967295)
	{
		return;
...
char* func_278(int iParam0, bool bParam1)//Position - 0x1073B
{
	switch (iParam0)
	{
		case 0:
...
void func_279(int iParam0)//Position - 0x10984
{
	Global_8F3C = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_280(int iParam0)//Position - 0x10996
{
	func_281(iParam0, 0, func_286(iParam0));
}

void func_281(int iParam0, int iParam1, int iParam2)//Position - 0x109AB
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_282(var uParam0)//Position - 0x109DA
{
	struct<16> Var0;
	int iVar1;
...
void func_283(int iParam0, var uParam1)//Position - 0x10AA9
{
	Global_19E56.f_6187.f_2B[iParam0] = *uParam1;
}

void func_284(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x10AC1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_285(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x10C43
{
...
int func_286(int iParam0)//Position - 0x10C7B
{
	int iVar0;
...
void func_287(var uParam0, bool bParam1)//Position - 0x10E1E
{
	int iVar0;
...
void func_288(var uParam0)//Position - 0x10E5E
{
	*uParam0 = 0;
	uParam0->f_1 = 4294967295;
}

void func_289(var uParam0)//Position - 0x10E6F
{
	int iVar0;
...
void func_290(var uParam0)//Position - 0x10EA8
{
	func_291(*uParam0, "NULL", uParam0->f_1);
}

void func_291(int iParam0, char* sParam1, int iParam2)//Position - 0x10EBD
{
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 30))
	{
		switch (func_218(iParam0))
...
void func_292(bool bParam0)//Position - 0x10F7D
{
	int iVar0;
