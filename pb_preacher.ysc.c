...
void func_1()//Position - 0xEC
{
	if (SYSTEM::TIMERB() > 7000)
	{
		...
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_48, 10f, 10f, 10f, 0, 1, 0) && iLocal_50 == 0)
			{
				SYSTEM::SETTIMERB(0);
				...
				BRAIN::TASK_PLAY_ANIM(0, "amb@PREACHER", "PREACH", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
				CUTSCENE::_0x8D9DF6ECA8768583(iLocal_51);
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_48, 0))
				{
			...
			if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_48, 3f, 3f, 3f, 0, 1, 0) && iLocal_49 == 0)
			{
				vLocal_46 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true) };
				SYSTEM::SETTIMERB(0);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_51);
