...
void __EntryFunction__()
{
	...
	{
		OBJECT_DECAL_TOGGLE(995898030);
		OBJECT_DECAL_TOGGLE(1433313072);
		OBJECT_DECAL_TOGGLE(1096198329);
		OBJECT_DECAL_TOGGLE(696733436);
		OBJECT_DECAL_TOGGLE(831272562);
		OBJECT_DECAL_TOGGLE(-1871331138);
		OBJECT_DECAL_TOGGLE(874957556);
		OBJECT_DECAL_TOGGLE(817402210);
		OBJECT_DECAL_TOGGLE(337714004);
		OBJECT_DECAL_TOGGLE(1655527845);
		OBJECT_DECAL_TOGGLE(-2086579765);
		OBJECT_DECAL_TOGGLE(-1770673475);
		_0xC78E239AC5B2DDB9(0, -1, 0);
		Global_1312434 = 0;
	...
	switch (iScriptParam_0)
	{
		case 3:
			while (iVar0 == 0)
			{
				...
				REQUEST_STREAMED_TEXTURE_DICT("MPAwards1", 0);
				REQUEST_STREAMED_TEXTURE_DICT("MPAwards2", 0);
				REQUEST_STREAMED_TEXTURE_DICT("MPAwards3", 0);
				REQUEST_STREAMED_TEXTURE_DICT("MPAwards4", 0);
				REQUEST_STREAMED_TEXTURE_DICT("MPAwards5", 0);
				REQUEST_STREAMED_TEXTURE_DICT("MPAwards6", 0);
				REQUEST_STREAMED_TEXTURE_DICT("MPTShirtAwards2", 0);
				REQUEST_STREAMED_TEXTURE_DICT("MPTshirtAwardLTS", 0);
...
void func_2(var uParam0, var uParam1, var uParam2)
{
	...
	if ((IS_CONTROL_PRESSED(2, 187) || func_12(187, &(Global_1371947.f_1060), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
		SET_BIT(&(uParam0->f_464), 0);
	}
	if ((IS_CONTROL_PRESSED(2, 188) || func_12(188, &(Global_1371947.f_1060), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
		SET_BIT(&(uParam0->f_464), 1);
	}
	if (((IS_CONTROL_PRESSED(2, 189) || IS_CONTROL_PRESSED(2, 241)) || func_12(189, &(Global_1371947.f_1060), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
		SET_BIT(&(uParam0->f_464), 2);
	}
	if (((IS_CONTROL_PRESSED(2, 190) || IS_CONTROL_PRESSED(2, 242)) || func_12(190, &(Global_1371947.f_1060), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
	...
	{
		_0x36C1451A88A09630(&uVar3, &iVar4);
		switch (uParam1->f_7)
		{
			case 0:
				if (iVar4 == 0 || iVar4 == 1)
	...
	{
		_0x7E17BE53E1AAABAF(&uVar8, &iVar9, &iVar10);
		iVar11 = iVar9 + 1000;
		if (iVar11 >= 0)
		{
			if (iVar10 == 0)
...
{
	_0xC78E239AC5B2DDB9(iParam0, 6, 0);
}
	...
	if (*uParam0 == 0)
	{
		...
		while (iVar0 <= 15)
		{
			if (uParam0->f_1[iVar0] == 1)
			{
				...
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(0);
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(0);
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_309[iVar0]);
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
				if (uParam0->f_378)
				{
				...
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_292[iVar0]);
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_343[iVar0]);
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_360[iVar0]);
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(-1);
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(-1);
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(-1);
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_326[iVar0]);
				END_SCALEFORM_MOVIE_METHOD();
			}
			*uParam0 = 1;
			iVar0++;
...
void func_17(var uParam0, int iParam1)
{
	...
	if (uParam0->f_381 == 0)
	{
		if (uParam0->f_380 != -1)
		{
			...
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(0);
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_380);
			END_SCALEFORM_MOVIE_METHOD();
			uParam0->f_380 = -1;
			uParam0->f_381 = 1;
		}
			...
			while (iVar0 <= 11)
			{
				...
				if (uParam0->f_1[iVar0] == 1)
				{
					...
					else
					{
						...
						ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&cVar3);
						END_TEXT_COMMAND_SCALEFORM_STRING();
					}
...
int func_39(var uParam0)
{
	...
	while (iVar0 <= 11)
	{
		if (uParam0->f_1[iVar0] == 1)
		{
			...
			{
				REQUEST_STREAMED_TEXTURE_DICT(&(uParam0->f_331[iVar0 /*8*/]), 0);
...
int func_48(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2572886[iParam0 /*3*/][func_45(iParam1)];
	if (STAT_GET_INT(uVar0, &uVar1, -1))
	{
		return uVar1;
	}
...
int func_51(int iParam0, int iParam1)
{
	...
	iVar1 = iParam0;
	return IS_BIT_SET(uVar0, func_52(iVar1));
}
...
void func_91(int iParam0, int iParam1, int iParam2, var uParam3)
{
	...
	else
	{
		switch (iParam0)
		{
			case 17:
				iVar11 = 0;
				uVar13 = func_92(962840492);
				iVar0 = 0;
				while (iVar0 < 28)
				{
					if (IS_BIT_SET(uVar13, iVar0))
					{
						iVar11++;
					}
					iVar0++;
				}
				if (IS_BIT_SET(uVar13, 9))
				{
					iVar11 = (iVar11 - 1);
				}
				if (IS_BIT_SET(uVar13, 26))
				{
					iVar11 = (iVar11 - 1);
				}
				if (iVar11 < 0)
...
int func_95(int iParam0)
{
	...
	uVar1 = func_92(func_96(iParam0));
	iVar2 = 0;
	while (iVar2 < 29)
	{
		if (IS_BIT_SET(uVar1, iVar2))
		{
			iVar0++;
		}
		iVar2++;
...
void func_120(int iParam0, int iParam1, int iParam2, var uParam3)
{
	...
	iVar9 = (iVar5 - iVar8);
	iVar10 = (iVar6 - iVar8);
	uVar11 = FLOOR(((TO_FLOAT(iVar10) / TO_FLOAT(iVar9)) * 100f));
...
void func_128(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	{
		BEGIN_TEXT_COMMAND_SCALEFORM_STRING(iParam3);
