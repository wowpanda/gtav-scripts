...
int func_8(var uParam0)
{
	...
	{
		return !func_9(NET_TO_VEH(uParam0));
	}
	return 0;
}
...
bool func_12(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	return IS_BIT_SET(Local_103.f_2[iVar0], iVar1);
}
...
int func_23()
{
	...
	if (!func_287(0))
	{
		if (func_98(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), &Local_156, &(Local_156.f_3)))
		{
			func_97(0);
		}
	}
	if (func_95(func_96()) && func_287(0))
	{
		...
		if (func_92(&(Local_103.f_6), func_96(), Local_156, Local_156.f_3, 1, 1, 1, 0, 1, 1, 0, 0, 0, 0))
		{
			...
			if (DECOR_IS_REGISTERED_AS_TYPE("MPBitset", 3))
			{
				...
				{
					uVar103 = DECOR_GET_INT(uVar0, "MPBitset");
				}
				SET_BIT(&uVar103, 11);
				DECOR_SET_INT(uVar0, "MPBitset", uVar103);
			}
			if (DECOR_IS_REGISTERED_AS_TYPE("Not_Allow_As_Saved_Veh", 3))
			{
				DECOR_SET_INT(uVar0, "Not_Allow_As_Saved_Veh", 1);
			}
			_0xDBC631F109350B8C(uVar0, 1);
			_0x2311DD7159F00582(uVar0, 1);
			SET_MODEL_AS_NO_LONGER_NEEDED(func_96());
			return 1;
		}
	}
	return 0;
...
void func_24(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		if ((NETWORK_IS_GAME_IN_PROGRESS() && NETWORK_HAS_CONTROL_OF_ENTITY(uParam0)) || !NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			{
				OVERRIDE_VEH_HORN(uParam0, 1, uParam1->f_78);
			}
			if (!uParam1->f_79 == -1)
			{
				unk_0x5216CAB7E4DE009D(uParam0, uParam1->f_79);
			}
			if (func_75(uParam1->f_66, &fVar0) && uParam1->f_80 != fVar0)
			{
				uParam1->f_80 = fVar0;
			}
			SET_VEHICLE_ENVEFF_SCALE(uParam0, uParam1->f_80);
			_SET_VEHICLE_INTERIOR_COLOUR(uParam0, uParam1->f_97);
			if (uParam1->f_99 >= 0)
			{
				_SET_VEHICLE_DASHBOARD_COLOUR(uParam0, uParam1->f_99);
			}
			if (func_74(uParam0))
			{
				func_68(uParam0, func_71(uParam1->f_74, uParam1->f_75, uParam1->f_76));
			}
			if (_GET_VEHICLE_ROOF_LIVERY_COUNT(uParam0) > 1 && uParam1->f_98 >= 0)
			{
				_SET_VEHICLE_ROOF_LIVERY(uParam0, uParam1->f_98);
			}
			if (IS_BIT_SET(uParam1->f_95, 0))
			{
				func_42(uParam0, &(uParam1->f_81));
			}
			if ((!func_33(4) && !bParam4) && !NETWORK_IS_ACTIVITY_SESSION())
			{
				func_27(uParam0);
			}
			if (func_26(GET_ENTITY_MODEL(uParam0)))
			{
				switch (uParam1->f_9[5])
				{
					case 0:
						REMOVE_VEHICLE_MOD(uParam0, 16);
						break;
					
					case 1:
						REMOVE_VEHICLE_MOD(uParam0, 16);
						if ((IS_VEHICLE_MODEL(uParam0, joaat("scarab")) || IS_VEHICLE_MODEL(uParam0, joaat("scarab2"))) || IS_VEHICLE_MODEL(uParam0, -579747861))
						{
							SET_VEHICLE_MOD(uParam0, 16, 0, 0);
						}
						else
						{
							SET_VEHICLE_MOD(uParam0, 16, 2, 0);
						}
						break;
					...
					case 2:
						...
						if ((IS_VEHICLE_MODEL(uParam0, joaat("scarab")) || IS_VEHICLE_MODEL(uParam0, joaat("scarab2"))) || IS_VEHICLE_MODEL(uParam0, -579747861))
						{
							SET_VEHICLE_MOD(uParam0, 16, 1, 0);
						}
						else
						{
							SET_VEHICLE_MOD(uParam0, 16, 3, 0);
						}
						break;
					...
					case 3:
						...
						{
							SET_VEHICLE_MOD(uParam0, 16, 4, 0);
						}
						break;
			...
			switch (uParam1->f_94)
			{
				...
				case 1:
					...
					{
						DECOR_SET_INT(uParam0, "Player_Vehicle", -1);
					}
					break;
				...
				case 2:
					if (IS_BIT_SET(uParam1->f_95, 1) && IS_BIT_SET(uParam1->f_95, 2))
					{
						...
						{
							DECOR_SET_INT(uParam0, "Veh_Modded_By_Player", _NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER_ID()));
						}
					}
					else if (DECOR_IS_REGISTERED_AS_TYPE("Veh_Modded_By_Player", 3))
					{
						...
						{
							DECOR_SET_INT(uParam0, "Veh_Modded_By_Player", _NETWORK_HASH_FROM_PLAYER_HANDLE(NETWORK_GET_PLAYER_FROM_GAMER_HANDLE(&(uParam1->f_81))));
						}
						else
						{
							DECOR_SET_INT(uParam0, "Veh_Modded_By_Player", -1);
						}
					}
					break;
...
void func_28(vector3 vParam0)
{
	...
	_0xA40CC53DF8E50837(1, &vVar0, 5, func_29(1, 1));
}
...
int func_35(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_39() == 0)
		{
			return IS_BIT_SET(func_36(func_38(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_50(var uParam0)
{
	if (DOES_ENTITY_EXIST(uParam0) && IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		if (_DOES_VEHICLE_HAVE_DECAL(uParam0, 0) || func_51(uParam0))
		{
			return 1;
		}
	}
...
int func_52(var uParam0, var uParam1)
{
	...
	if (((((((!(DOES_ENTITY_EXIST(uParam0) && !IS_ENTITY_DEAD(uParam0, 0)) || !NETWORK_HAS_CONTROL_OF_ENTITY(uParam0)) || !_0x595F028698072DD9(0, -1, 1)) || !((NETWORK_IS_HANDLE_VALID(uParam1, 13) && _NETWORK_PLAYER_IS_IN_CLAN()) && NETWORK_CLAN_PLAYER_IS_ACTIVE(uParam1))) || iVar0 == func_89()) || !func_311(iVar0, 0, 0)) || !bVar1) || func_53(uParam0))
	{
		return 0;
	}
	return 1;
...
{
	return func_60(PLAYER_ID(), bParam0);
}
...
int func_63(int iParam0, bool bParam1)
{
	...
	iVar1 = iParam0;
	return IS_BIT_SET(uVar0, func_64(iVar1));
}
...
int func_71(int iParam0, int iParam1, int iParam2)
{
	...
	if ((NETWORK_IS_GAME_IN_PROGRESS() && func_72()) && Global_1314023)
	{
...
void func_76(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_86(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_86(iVar1 + 1)))
			{
			}
			else
			{
				SET_BIT(&(uParam1->f_77), func_86(iVar1 + 1));
			}
		}
		...
		if (((IS_BIT_SET(uParam1->f_77, 15) || func_85(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_84())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!IS_THIS_MODEL_A_HELI(uParam1->f_66) && !IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (IS_BIT_SET(uParam1->f_77, func_86(iVar2 + 1)))
				{
...
int func_77(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_81(GET_ENTITY_MODEL(*uParam0), 1) && GET_VEHICLE_MOD(*uParam0, 24) != func_80(*uParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*uParam0, 24, func_80(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_79(uParam0);
	if (func_78(*uParam0))
	{
...
void func_93(vector3 vParam0, var uParam3, int iParam4, int iParam5)
{
	...
	if (func_94(PLAYER_ID(), vParam0, iParam4) > -1)
	{
...
void func_97(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	SET_BIT(&(uLocal_153[iVar0]), iVar1);
}
...
int func_99(vector3 vParam0, vector3 vParam3, int iParam6, int iParam7, var uParam8, var uParam9, var uParam10)
{
	...
	if (!Global_2405071.f_598 == 0 && GET_TIME_DIFFERENCE(GET_NETWORK_TIME(), Global_2405071.f_603) < func_230(0))
	{
	...
	if (!GET_ID_OF_THIS_THREAD() == Global_2405071.f_667)
	{
		if (!Global_2405071.f_668 == 0)
		{
			if (GET_TIME_DIFFERENCE(GET_NETWORK_TIME(), Global_2405071.f_671) < func_230(0))
			{
				return 0;
			}
			else
	...
	else
	{
		...
		if (!Global_2405071.f_668 == 0)
		{
			if (GET_TIME_DIFFERENCE(GET_NETWORK_TIME(), Global_2405071.f_671) > func_230(1))
			{
				Global_2405071.f_668 = 0;
			}
		}
	...
	switch (Global_2405071.f_668)
	{
		case 2:
			if (_0xF7B79A50B905A30D((vParam0.x - 100f), (vParam0.y - 100f), (vParam0.x + 100f), (vParam0.y + 100f)))
			{
				...
				if (((uParam10->f_2 && func_180(vParam0, fVar2, fVar3, fVar4, 1f, 0, 0, 0, 1123024896, 0, -1, 1, 0, 0, 0, 0, 0)) && !uParam10->f_6) && !func_178(vParam0, *uParam9, iParam6, PLAYER_ID(), 0))
				{
					Global_2405071.f_674 = { vParam0 };
				...
				if (GET_TIME_DIFFERENCE(GET_NETWORK_TIME(), Global_2405071.f_690) < 10000)
				{
					if (_0xE64A3CA08DFA37A9(Global_2405071.f_689))
					{
						if (_0x4DF7CFFF471A7FB1(Global_2405071.f_689))
						{
							...
							{
								if (func_119(Global_2405071.f_674, Global_2405071.f_677, iParam6, PLAYER_ID(), 0) || func_101(Global_2405071.f_674, Global_2405071.f_677, iParam6, 1, 0, 0, 0, 1, 0))
								{
									func_121(Global_2405071.f_674, 0);
									func_120(-1);
								}
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam9 == 1 && PLAYER_ID() != iVar1) || iParam9 == 0)
		{
			if (func_311(iVar1, bParam5, bParam6))
			{
				...
				{
					if (!bParam8 || (!IS_PED_INJURED(GET_PLAYER_PED(iVar1)) && func_118(iVar1)))
					{
						if ((!bParam7 || (bParam7 == 1 && GET_PLAYER_TEAM(PLAYER_ID()) != GET_PLAYER_TEAM(iVar1))) || GET_PLAYER_TEAM(PLAYER_ID()) == -1)
						{
							if (((GET_PLAYER_TEAM(PLAYER_ID()) == -1 && iParam10) && bParam7) && func_113(iVar1))
							{
							}
...
int func_102(vector3 vParam0, vector3 vParam3, float fParam6, int iParam7, float fParam8)
{
	...
	if (VDIST(vParam0, vParam3) < func_110(iParam7, 1008981770))
	{
...
void func_124(vector3 vParam0, var uParam3, int iParam4, var uParam5)
{
	...
	*uParam5 = func_125(&vParam0, &uParam3, &iParam4);
	...
	Var0.f_6 = iParam4;
	Var0.f_7 = *uParam5;
	_0xA40CC53DF8E50837(1, &Var0, 8, func_29(1, 1));
}
														...
														if (func_146(vVar1, uParam2))
														{
															if ((uParam2->f_48 && !func_166(&vVar1, 0)) || uParam2->f_48 == 0)
															{
																...
																if (VMAG(vVar1) > 0f)
																{
																	...
																	{
																		if ((uParam2->f_12 && !func_145(vVar1, fVar4, uParam2->f_34, PLAYER_ID(), 0, uParam2->f_56)) || !uParam2->f_12)
																		{
...
void func_128(var uParam0, var uParam1, var uParam2, vector3 vParam3)
{
	...
	while (iVar2 < *uParam0)
	{
		...
		if (fVar1 < fVar0)
		{
			if (!func_129(*(uParam0[iVar2 /*4*/]), 5f, PLAYER_ID(), 0, 0))
			{
				fVar0 = fVar1;
				iVar3 = iVar2;
			}
		...
		if (!iParam4 == iVar0 || iParam5 == 1)
		{
			...
			if (!bVar2)
			{
				if (func_311(iVar1, 0, 1) && func_311(iParam4, 0, 1))
				{
					...
					else if (VDIST(func_111(iVar1), vParam0) < 1f)
					{
						return 1;
					}
				}
				...
				{
					if (VDIST(func_111(iVar1), vParam0) < 1f)
					{
						return 1;
					}
				}
		...
		if (!func_142(iParam0))
		{
			if (_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER_ID(), iParam0))
			{
				if (!GET_PLAYER_TEAM(iParam0) == GET_PLAYER_TEAM(PLAYER_ID()))
				{
					...
					{
						if (!func_138(GET_PLAYER_TEAM(iParam0), GET_PLAYER_TEAM(PLAYER_ID()), 0))
						{
							return 1;
						}
					}
	...
	if (func_139(PLAYER_ID(), 1))
	{
		...
		if (Global_969025.f_255 > 0)
		{
			...
			while (iVar0 < Global_969025.f_255)
			{
				...
				{
					if (func_102(vParam0, GET_ENTITY_COORDS(Global_969025.f_220[iVar0], 1), GET_ENTITY_HEADING(Global_969025.f_220[iVar0]), GET_ENTITY_MODEL(Global_969025.f_220[iVar0]), 0.5f))
					{
						return 1;
					}
				}
		...
		if (Global_969025.f_253 > 0)
		{
			...
			while (iVar0 < Global_969025.f_253)
			{
				...
				{
					if (func_102(vParam0, GET_ENTITY_COORDS(Global_969025.f_118[iVar0], 1), GET_ENTITY_HEADING(Global_969025.f_118[iVar0]), GET_ENTITY_MODEL(Global_969025.f_118[iVar0]), 0.5f))
					{
						return 1;
					}
				}
...
Vector3 func_151(vector3 vParam0, var uParam3, int iParam4, bool bParam5, vector3 vParam6, int iParam9, bool bParam10, int iParam11, var uParam12, int iParam13, bool bParam14, bool bParam15)
{
	...
	if (uVar4 & 1024 == 0 && !bParam10)
	{
		...
		if (bParam14)
		{
			...
			if (IS_THIS_MODEL_A_HELI(iParam11) && func_153(vParam0))
			{
				return 0f, 0f, 0f;
			}
		}
...
void func_164(var uParam0, vector3 vParam1, float fParam4, float fParam5, bool bParam6, float fParam7)
{
	...
	else
	{
		...
		if (fParam7 == 0f)
		{
			func_109(&vVar0, 0f, 0f, GET_RANDOM_FLOAT_IN_RANGE(0f, 360f));
		}
		else
		{
			...
			if (iVar1 > -1 && iVar1 < 101)
			{
				...
				if (VMAG(vVar2) > 0f)
				{
					if ((uParam2->f_57 && VDIST(vVar2, uParam2->f_35) > uParam2->f_4) || uParam2->f_57 == 0)
					{
						...
						{
							if ((uParam2->f_12 && !func_145(vVar2, fVar5, uParam2->f_34, PLAYER_ID(), 0, uParam2->f_56)) || !uParam2->f_12)
							{
...
int func_181(vector3 vParam0, float fParam3, int iParam4, int iParam5, float fParam6, bool bParam7, int iParam8, float fParam9, bool bParam10)
{
	...
	if (iParam4 && !bParam7)
	{
		if (func_311(PLAYER_ID(), 1, 1))
		{
			if (!IS_SCREEN_FADED_OUT())
			{
				...
				if (GET_DISTANCE_BETWEEN_COORDS(func_182(PLAYER_ID()), vParam0, 1) <= (fVar2 + fParam3))
				{
	...
	while (iVar0 < 32)
	{
		...
		{
			if (!func_30(iVar1, 0) && _NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER_ID(), iVar1))
			{
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != PLAYER_ID()))
				{
					if ((func_118(iVar1) || !bParam10) && !Global_2424047[iVar1 /*416*/].f_259)
					{
						...
						if (!bParam7)
						{
							...
							{
								if (GET_DISTANCE_BETWEEN_COORDS(func_182(iVar1), vParam0, 1) <= (fVar2 + fParam3))
								{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && PLAYER_ID() != iVar1) || iParam8 == 0)
		{
			if (func_311(iVar1, bParam4, bParam5))
			{
				if (_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER_ID(), iVar1))
				{
					if (!bParam7 || (!IS_PED_INJURED(GET_PLAYER_PED(iVar1)) && func_118(iVar1)))
					{
						if ((!bParam6 || (bParam6 == 1 && GET_PLAYER_TEAM(PLAYER_ID()) != GET_PLAYER_TEAM(iVar1))) || GET_PLAYER_TEAM(PLAYER_ID()) == -1)
						{
							if (((GET_PLAYER_TEAM(PLAYER_ID()) == -1 && uParam9) && bParam6) && func_113(iVar1))
							{
							}
							else if (DOES_ENTITY_EXIST(GET_PLAYER_PED(iVar1)))
							{
								if (GET_DISTANCE_BETWEEN_COORDS(func_111(iVar1), vParam0, 1) < fParam3)
								{
									return 1;
								}
							}
...
int func_188(int iParam0)
{
	...
	if (func_198(PLAYER_ID(), 0) || (func_195(PLAYER_ID()) && func_193(func_194(PLAYER_ID())) == 12))
	{
		return 1;
	}
	if (func_192(PLAYER_ID()) || (func_195(PLAYER_ID()) && func_193(func_194(PLAYER_ID())) == 8))
	{
		return 1;
	}
	if (func_191(PLAYER_ID()) || (func_195(PLAYER_ID()) && func_193(func_194(PLAYER_ID())) == 5))
	{
		return 1;
	}
	if (func_190(PLAYER_ID()) || (func_195(PLAYER_ID()) && func_193(func_194(PLAYER_ID())) == 10))
	{
		return 1;
	}
	if (func_189(PLAYER_ID()) || (func_195(PLAYER_ID()) && func_193(func_194(PLAYER_ID())) == 6))
	{
		return 1;
	}
	return 0;
...
void func_201(vector3 vParam0, int iParam3)
{
	...
	if (!func_218())
	{
		...
		if (iVar1 > -1)
		{
			...
			switch (iVar1)
			{
				...
				case 30:
					if (func_213(iParam3))
					{
						func_214(Global_1589819[PLAYER_ID() /*818*/].f_273.f_25);
					}
					break;
		...
		else if (func_210(vParam0, &iVar2, &iVar6) || (func_187(vParam0, &(iVar2[0])) && (IS_THIS_MODEL_A_PLANE(iParam3) || IS_THIS_MODEL_A_HELI(iParam3))))
		{
			func_228();
			iVar0 = 0;
			while (iVar0 < iVar2)
			{
				...
				{
					if (((func_208(PLAYER_PED_ID()) || func_207(PLAYER_PED_ID())) && IS_THIS_MODEL_A_PLANE(iParam3)) || IS_THIS_MODEL_A_HELI(iParam3))
					{
						if (func_206(iParam3))
						{
...
void func_234(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	SET_BIT(&(Local_103.f_2[iVar0]), iVar1);
}
...
void func_236()
{
	...
	if (func_238(PARTICIPANT_ID()) != 3 && func_20() == 3)
	{
		func_237(3);
	}
	switch (func_238(PARTICIPANT_ID()))
	{
		case 0:
			if (func_20() > 0)
			{
...
{
	Local_111[PARTICIPANT_ID_TO_INT() /*4*/].f_1 = iParam0;
}
...
bool func_246(int iParam0, int iParam1)
{
	...
	iVar0 = (iParam1 / 32);
	iVar1 = (iParam1 % 32);
	return IS_BIT_SET(Local_111[iParam0 /*4*/].f_2[iVar0], iVar1);
}

void func_247(int iParam0)
{
	Global_1626536[PLAYER_ID() /*603*/].f_11.f_299 = iParam0;
}

int func_248()
{
	return Global_1626536[PLAYER_ID() /*603*/].f_11.f_299;
}
...
void func_252()
{
	...
	if (func_258(PLAYER_PED_ID(), func_16(), 120f, 1))
	{
		if (!func_246(PARTICIPANT_ID(), 1))
		{
			func_257(1);
	...
	else if (func_246(PARTICIPANT_ID(), 1))
	{
		func_256(1);
	}
	if (!func_246(PARTICIPANT_ID(), 0) && func_253())
	{
		func_257(0);
	}
}
...
int func_253()
{
	if (func_250())
	{
		if (!func_258(PLAYER_PED_ID(), func_16(), 1000f, 1))
		{
			return 1;
		}
		if (func_255(PLAYER_ID(), 1, 1))
		{
			return 1;
		}
		if (func_254(PLAYER_ID()))
		{
			return 1;
		}
...
void func_256(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	CLEAR_BIT(&(Local_111[PARTICIPANT_ID_TO_INT() /*4*/].f_2[iVar0]), iVar1);
}
...
void func_257(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	SET_BIT(&(Local_111[PARTICIPANT_ID_TO_INT() /*4*/].f_2[iVar0]), iVar1);
}
...
void func_260()
{
	...
	if (iVar0 != func_262())
	{
		switch (func_262())
		{
			...
			case 0:
				if ((func_250() && !func_246(PARTICIPANT_ID(), 0)) && iVar0 == 2)
				{
					func_257(0);
				}
				break;
...
{
	return func_266(PLAYER_ID(), bParam0);
}
...
void func_267()
{
	...
	switch (func_19())
	{
		...
		case 2:
			if (((((!func_12(3) && !func_246(PARTICIPANT_ID(), 2)) && func_7()) && !_0x422F32CC7E56ABAD(func_16())) && func_270(func_10())) && func_269(func_16()) == 0)
			{
				SET_VEHICLE_DOORS_LOCKED_FOR_ALL_PLAYERS(func_16(), 1);
				NETWORK_FADE_OUT_ENTITY(func_16(), 0, 1);
				func_257(2);
			}
			break;
		
		case 3:
			if (((!func_12(4) && !func_246(PARTICIPANT_ID(), 3)) && func_7()) && !IS_ENTITY_VISIBLE(func_16()))
			{
				func_257(3);
			}
			break;
		...
		case 4:
			if (((!func_12(5) && !func_246(PARTICIPANT_ID(), 4)) && func_7()) && func_270(func_10()))
			{
				uVar0 = func_10();
				func_268(&uVar0);
				func_257(4);
...
void func_272()
{
	if (func_278())
	{
		if (!DOES_BLIP_EXIST(uLocal_160))
		{
			uLocal_160 = ADD_BLIP_FOR_ENTITY(func_16());
			SET_BLIP_SPRITE(uLocal_160, func_277());
			func_274(&uLocal_160, func_276());
			SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_160, func_273());
		}
	}
	else if (DOES_BLIP_EXIST(uLocal_160))
	{
...
int func_278()
{
	...
	if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), func_16(), 0))
	{
		return 0;
	}
	if (!func_7())
...
{
	Local_111[PARTICIPANT_ID_TO_INT() /*4*/] = iParam0;
}
...
void func_284()
{
	...
	while (iVar0 < _NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK_IS_PARTICIPANT_ACTIVE(iVar0))
		{
			...
			uVar1 = NETWORK_GET_PLAYER_INDEX(iLocal_144[iVar0]);
...
void func_285(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	CLEAR_BIT(&(Local_103.f_2[iVar0]), iVar1);
}
...
bool func_287(int iParam0)
{
	...
	iVar0 = (iParam0 / 32);
	iVar1 = (iParam0 % 32);
	return IS_BIT_SET(uLocal_153[iVar0], iVar1);
}
...
int func_288()
{
	...
	if (func_289() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_289()) == 0)
		{
			return 1;
		}
	}
...
{
	func_241(15);
	Global_1626536[PLAYER_ID() /*603*/].f_11.f_300 = 0;
}
...
int func_306(struct<21> Param0)
{
	...
	func_307(0, -1, 0);
	NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_103, 8);
	NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&Local_111, 33);
