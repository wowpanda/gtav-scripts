					...
					else
					{
						if (iLocal_42)
						{
							...
							while (iLocal_44 < 8)
							{
								...
								{
									if (func_32(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), iLocal_44 + 1, 0, 0))
									{
						...
						if (SYSTEM::TIMERA() > 125)
						{
							...
							if (func_29(iLocal_37, unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false)))
							{
								...
								if (func_28(iLocal_37))
								{
									...
									if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(MISC::GET_HASH_KEY(&Local_48)) == 0)
									{
										if (!Global_6449[iLocal_37])
										{
											func_26(iLocal_37, Global_6449[iLocal_37]);
										}
									}
								}
								else if (!Global_6449[iLocal_37])
								{
									if (PED::IS_PED_IN_FLYING_VEHICLE(AUDIO::_0x0626A247D2405330()))
									{
										...
										if (!bLocal_40)
										{
											if (func_32(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), iLocal_37, 0, 0))
											{
												if ((MISC::GET_GAME_TIMER() - iLocal_49[iLocal_46]) > 8000)
												{
													func_18();
												}
												else if (MISC::IS_PROJECTILE_IN_AREA(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false) + Vector(200f, 200f, 200f), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false) - Vector(200f, 200f, 200f), 1))
												{
													func_18();
												}
												else if (iLocal_37 != 4)
...
void func_18()//Position - 0xC4F
{
	switch (iLocal_46)
	{
		case 0:
			iLocal_47 = 2;
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) < iLocal_47)
			{
			}
			break;
		
		case 1:
			if (PED::IS_PED_IN_FLYING_VEHICLE(AUDIO::_0x0626A247D2405330()) && MISC::IS_PROJECTILE_IN_AREA(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false) + Vector(200f, 200f, 200f), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false) - Vector(200f, 200f, 200f), 1))
			{
				iLocal_47 = 5;
			}
			else
	...
	if (PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) < iLocal_47)
	{
		PLAYER::SET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246(), iLocal_47, 0);
