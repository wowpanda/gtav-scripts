	...
	while (iLocal_293 && func_127(2, 0))
	{
		...
		switch (iLocal_102)
		{
			...
			case 2:
				if (func_123())
				{
					func_122(&uLocal_104, 0, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					func_122(&uLocal_104, 2, Global_93403, "LAMAR", 0, 1);
					iLocal_102 = 3;
				}
				break;
...
int func_2()
{
	...
	{
		func_115(&(iLocal_294[iVar0]), iVar0);
		iVar0++;
	}
	func_115(&Global_93403, iLocal_294);
	func_3(Global_93403);
	return 0;
}
...
void func_3(var uParam0)
{
	...
	{
		if (!iLocal_549 && HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0, PLAYER_PED_ID(), 1))
		{
			...
			if (iVar2 != -1)
			{
				iVar3 = func_110(uParam0);
				if (iVar3 != 0)
				{
					if (!func_109(iVar2) || func_101(iVar2) == 6)
					{
						func_100(75, GET_ENTITY_COORDS(uParam0, 0), 250f, -1);
	...
	func_6(uParam0, 138, &uLocal_104, "FMFAUD", &uLocal_269, &uLocal_290, 3);
	fVar4 = VDIST2(GET_ENTITY_COORDS(uParam0, 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1));
	if (fVar4 > (8f * 8f))
	{
		iLocal_547 = -1;
	}
	else if (IS_ANY_SPEECH_PLAYING(uParam0))
	{
		iLocal_547 = -1;
	}
	else
	{
		...
		if (iLocal_547 > 0)
		{
			if (iLocal_548 == 0)
			{
				if (iLocal_547 + 15000 < GET_GAME_TIMER())
				{
			...
			else if (iLocal_547 + 10000 < GET_GAME_TIMER())
			{
...
int func_6(var uParam0, int iParam1, var uParam2, char* sParam3, var uParam4, var uParam5, int iParam6)
{
	...
	else if (!IS_ENTITY_ON_SCREEN(uParam0) || !IS_ENTITY_VISIBLE(uParam0))
	{
		return 0;
	}
	bVar12 = false;
	...
	if (!bVar12)
	{
		iVar13 = GET_ROOM_KEY_FROM_ENTITY(uParam0);
		if (Global_93734.f_338 != iVar13)
		{
			return 0;
		}
	}
	...
	if (iVar18 || func_26(sParam3, &Var8, uParam4))
	{
		if (iVar7 == 5)
		{
			if (iVar6 == 0)
			{
				func_122(uParam2, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
			}
			else if (iVar6 == 1)
			{
				func_122(uParam2, 0, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			}
			else if (iVar6 == 2)
			{
				func_122(uParam2, 0, PLAYER_PED_ID(), "TREVOR", 0, 1);
			}
		}
...
int func_10(char* sParam0, char* sParam1, var uParam2, int iParam3, var uParam4, int iParam5)
{
	...
	if (func_24(sParam0, 7))
	{
		...
		{
			func_122(uParam2, 0, PLAYER_PED_ID(), sVar0, 0, 1);
...
{
	if (HAS_THIS_ADDITIONAL_TEXT_LOADED(uParam0, iParam1))
	{
		return 1;
	}
	else if (!func_25() && !IS_MOBILE_PHONE_CALL_ONGOING())
	{
		...
		{
			REQUEST_ADDITIONAL_TEXT(uParam0, iParam1);
		}
	}
	return 0;
}
...
int func_26(var uParam0, var uParam1, var uParam2)
{
	char cVar0[16];
	char cVar4[16];
	int iVar8;
	...
	if (func_24(uParam0, 7))
	{
		...
		iVar75 = GET_RANDOM_INT_IN_RANGE(0, iVar71 + 1);
		*uParam1 = { Var9[iVar75 /*4*/] };
		if (IS_STRING_NULL_OR_EMPTY(uParam1))
		{
			return 0;
		}
...
void func_41(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_43() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_43() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_42(iParam0));
...
int func_49(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_43() /*10778*/].f_6165.f_10, iParam0);
}
...
int func_50(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2539502[iParam0 /*3*/][func_45(iParam1)];
...
int func_78(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_14726)
	{
		if (Global_14553.f_1 == 6)
		{
			...
			func_79(1);
			func_82(Global_14534, "DISPLAY_VIEW", 1f, TO_FLOAT(Global_14533), -1082130432, -1082130432, -1082130432);
		}
	}
	return 1;
}
					...
					if (iVar0 == Global_2430[iVar1 /*15*/].f_4)
					{
						if (Global_2992[iVar0] == 0)
						{
							...
							if (Global_2458608)
							{
								if (iVar1 == 14)
								{
									func_80(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(Global_16929), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_2992[iVar0] = 1;
						}
					...
					if (iVar0 == Global_2430[iVar1 /*15*/].f_4)
					{
						if (Global_2992[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_80(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(Global_16934), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_71590)
								{
									...
									func_80(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(iVar4), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_14553)
									...
									func_80(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(uVar6), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_2430[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_80(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(iVar9), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_80(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(0), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_2992[iVar0] = 1;
						}
					}
...
void func_80(var uParam0, char* sParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
...
void func_82(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)
{
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0, sParam1);
...
int func_89(int iParam0, int iParam1, int iParam2, var uParam3)
{
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			iVar13 = func_91(iParam0);
			if (func_90(&(Var4[0 /*4*/]), iVar13))
			{
				iParam2 = 1;
			}
			else if (func_90(&(Var4[1 /*4*/]), iVar13))
			{
				iParam2 = 0;
			}
			else
...
int func_97(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4)
{
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			...
			{
				iVar9 = func_91(iParam0);
				if (func_90(&(Var0[0 /*4*/]), iVar9))
				{
					iParam2 = 1;
				}
				else if (func_90(&(Var0[1 /*4*/]), iVar9))
				{
					iParam2 = 0;
				}
				else
...
void func_100(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	if (iParam0 == iParam5)
	{
		return;
	...
	Global_36426[iParam0 /*5*/].f_3 = fParam4;
	Global_36426[iParam0 /*5*/].f_4 = iParam5;
}
...
int func_102(int iParam0, int iParam1)
{
	...
	bVar10 = false;
	if (IS_BIT_SET(Var0.f_2, func_103()))
	{
		bVar10 = true;
	}
	if (Var0.f_4 > iParam1)
...
int func_115(var uParam0, int iParam1)
{
	...
	if (DOES_ENTITY_EXIST(*uParam0))
	{
		...
		{
			case 0:
				if (IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_393, &(Local_474[iParam1 /*16*/]), 2))
				{
					fVar1 = fLocal_546;
					fVar2 = -1f;
					fVar3 = -1f;
					if (FIND_ANIM_EVENT_PHASE(&cLocal_393, &(Local_474[iParam1 /*16*/]), "WalkInterruptible", &fVar2, &fVar3))
					{
						fVar1 = fVar2;
					}
					else
					...
					if (GET_SYNCHRONIZED_SCENE_PHASE(Global_91042) > fVar1)
					{
						if (func_121(vLocal_323[iParam1 /*3*/], 0f, 0f, 0f, 0))
						{
						...
						if (IS_PED_INJURED(*uParam0))
						{
							...
							TASK_GO_STRAIGHT_TO_COORD(*uParam0, vLocal_309 + vLocal_323[iParam1 /*3*/] * Vector(0.1f, 0.1f, 0.1f), 1f, -1, 1193033728, 1056964608);
							FORCE_PED_MOTION_STATE(*uParam0, -668482597, 0, 1, 0);
							_0x2208438012482A1A(*uParam0, 0, 0);
							_RESET_PED_RAGDOLL_BLOCKING_FLAGS(*uParam0, 2);
						}
						WAIT(0);
						iLocal_302[iParam1] = 1;
						return 1;
				...
				if (!IS_SYNCHRONIZED_SCENE_RUNNING(Global_91041) && !IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
				{
					WAIT(0);
					if (IS_PED_INJURED(*uParam0))
					{
			...
			case 1:
				if (GET_SCRIPT_TASK_STATUS(*uParam0, 2106541073) != 1)
				{
					TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, vLocal_309 + vLocal_323[iParam1 /*3*/], 1f, -1, 0.25f, iVar0, 1193033728);
					iLocal_302[iParam1] = 2;
					return 1;
				}
				fVar7 = VMAG(vLocal_323[iParam1 /*3*/] * Vector(0.05f, 0.05f, 0.05f));
				if (VDIST2(GET_ENTITY_COORDS(*uParam0, 1), vLocal_309) >= fVar7)
				{
					if (!func_120() && !IS_ENTITY_ON_SCREEN(*uParam0))
					{
						TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, vLocal_309 + vLocal_323[iParam1 /*3*/], 1f, -1, 0.25f, iVar0, 1193033728);
						iLocal_302[iParam1] = 2;
						return 1;
				...
				if (IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), *uParam0) || IS_PED_IN_COMBAT(*uParam0, 0))
				{
			...
			case 2:
				if (IS_PED_RAGDOLL(*uParam0) || IS_PED_GETTING_UP(*uParam0))
				{
					return 0;
				}
				if (IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), *uParam0) || IS_PED_IN_COMBAT(*uParam0, 0))
				...
				if (GET_SCRIPT_TASK_STATUS(*uParam0, 713668775) != 1)
				{
					...
					{
						fLocal_340[iParam1] = (VMAG(vLocal_323[iParam1 /*3*/]) * 0.75f);
					}
					TASK_WANDER_IN_AREA(*uParam0, vLocal_309 + vLocal_323[iParam1 /*3*/], fLocal_340[iParam1], 1077936128, 1086324736);
			...
			case 3:
				...
				if (IS_SCENARIO_TYPE_ENABLED(sLocal_545))
				{
					SET_SCENARIO_TYPE_ENABLED(sLocal_545, 0);
				}
				if (VDIST2(GET_ENTITY_COORDS(*uParam0, 1), vLocal_309 + vLocal_323[iParam1 /*3*/]) < (fLocal_340[iParam1] * fLocal_340[iParam1]))
				{
					if (DOES_SCENARIO_EXIST_IN_AREA(vLocal_309 + vLocal_323[iParam1 /*3*/], fLocal_340[iParam1], 1))
					{
						TASK_USE_NEAREST_SCENARIO_TO_COORD(*uParam0, vLocal_309 + vLocal_323[iParam1 /*3*/], fLocal_340[iParam1], 0);
			...
			case 4:
				if (PED_HAS_USE_SCENARIO_TASK(*uParam0))
				{
				}
				else
				{
					...
					vVar8 = { func_116(vLocal_309 + vLocal_323[iParam1 /*3*/], func_119((fLocal_340[iParam1] * 0.9f), 10f, 100f), 0f) };
					if (GET_SCRIPT_TASK_STATUS(*uParam0, 1647992574) == 1)
					{
					}
					else if (GET_SAFE_COORD_FOR_PED(vVar8, 0, &vVar11, 14))
					{
						if (VDIST2(GET_ENTITY_COORDS(*uParam0, 1), vVar11) > 100f)
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, vVar11, 1f, -1, 0.25f, iVar0, 1193033728);
							iLocal_302[iParam1] = 1;
							return 1;
						}
					}
			...
			case 10:
				...
				SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_307, 1862763509);
				SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_307);
				SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_307, Global_88716);
				SET_RELATIONSHIP_BETWEEN_GROUPS(5, Global_88716, uLocal_307);
				TASK_COMBAT_HATED_TARGETS_AROUND_PED(*uParam0, 15f, 0);
...
Vector3 func_116(vector3 vParam0, float fParam3, float fParam4)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
	...
	return func_117(vParam0, fParam3, fParam4);
}

Vector3 func_117(vector3 vParam0, float fParam3, float fParam4)
{
	vector3 vVar0;
	float fVar3;
	...
	fVar3 = (fParam4 / 2f);
	vVar0 = { func_118(vVar0, GET_RANDOM_FLOAT_IN_RANGE(0f, fParam3)) };
...
int func_123()
{
	...
	{
		func_115(&(iLocal_294[iVar1]), iVar1);
		iVar1++;
	}
	func_115(&Global_93403, iLocal_294);
	return 0;
...
int func_125()
{
	...
	if (!func_124())
	{
		if (IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
		{
			...
			while (iVar0 < iLocal_294)
			{
				if (!IS_PED_INJURED(iLocal_294[iVar0]))
				{
					TASK_SYNCHRONIZED_SCENE(iLocal_294[iVar0], Global_91042, &cLocal_393, &(Local_474[iVar0 /*16*/]), 8f, -4f, 3, 0, 1148846080, 0);
					iLocal_302[iVar0] = 0;
				}
				else
				{
...
int func_126()
{
	...
	if (IS_SYNCHRONIZED_SCENE_RUNNING(Global_91041))
	{
		...
		while (iVar0 < iLocal_294)
		{
			if (!IS_PED_INJURED(iLocal_294[iVar0]))
			{
				TASK_SYNCHRONIZED_SCENE(iLocal_294[iVar0], Global_91041, &cLocal_393, &(Local_409[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			func_122(&uLocal_104, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		}
		if (!IS_PED_INJURED(Global_93403))
		{
			func_122(&uLocal_104, 4, Global_93403, "LAMAR", 0, 1);
		}
		if (!IS_PED_INJURED(iLocal_294[0]))
		{
			func_122(&uLocal_104, 5, iLocal_294[0], "GangMember1", 0, 1);
		}
		if (!IS_PED_INJURED(iLocal_294[1]))
		{
			func_122(&uLocal_104, 6, iLocal_294[1], "GangMember2", 0, 1);
		}
		return 1;
	}
	return 0;
...
void func_135()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_294)
		{
			...
			{
				REQUEST_MODEL(iLocal_298[iVar0]);
				if (!HAS_MODEL_LOADED(iLocal_298[iVar0]))
				{
					bVar2 = false;
					REQUEST_MODEL(iLocal_298[iVar0]);
				}
		...
		if (!IS_STRING_NULL_OR_EMPTY(&cLocal_393))
		{
			REQUEST_ANIM_DICT(&cLocal_393);
			if (!HAS_ANIM_DICT_LOADED(&cLocal_393))
			{
				bVar2 = false;
				REQUEST_ANIM_DICT(&cLocal_393);
			}
	...
	if (DOES_ENTITY_EXIST(Global_93403))
	{
		if (func_31(19) == GET_ENTITY_MODEL(Global_93403))
		{
			SET_ENTITY_AS_MISSION_ENTITY(Global_93403, 1, 1);
		}
		func_136(&Global_93403, Global_88716);
		SET_PED_CONFIG_FLAG(Global_93403, 132, 1);
		SET_PED_CONFIG_FLAG(Global_93403, 317, 1);
		func_136(&Global_93403, Global_88716);
	}
	ADD_RELATIONSHIP_GROUP("TAUNTERS", &uLocal_307);
	iVar0 = 0;
	while (iVar0 < iLocal_294)
	{
		if (iLocal_298[iVar0] != 0)
		{
			iLocal_294[iVar0] = CREATE_PED(iLocal_308, iLocal_298[iVar0], vLocal_309 + vLocal_313[iVar0 /*3*/], 0, 1, 1);
			SET_ENTITY_HEADING(iLocal_294[iVar0], (fLocal_312 + fLocal_336[iVar0]));
			SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_294[iVar0], 0);
			SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_294[iVar0], uLocal_307);
			TASK_PLAY_ANIM(iLocal_294[iVar0], &cLocal_393, &(Local_409[iVar0 /*16*/]), 8f, -8f, -1, 9, 0, 0, 0, 0);
			SET_PED_CONFIG_FLAG(iLocal_294[iVar0], 317, 1);
			if (iLocal_308 == 6)
			{
				GIVE_WEAPON_TO_PED(iLocal_294[iVar0], joaat("weapon_stungun"), 1000, 0, 1);
			}
		}
		iVar0++;
	}
...
void func_137()
{
	...
	iLocal_103 = Global_93085;
	func_141(iLocal_103, &vLocal_309, &fLocal_312, &cVar0);
	func_139(iLocal_103, &sLocal_345, &cLocal_361, &cLocal_377, &uVar8, &uVar9);
	switch (iLocal_103)
	{
		case 218:
			vLocal_313[0 /*3*/] = { GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_313[1 /*3*/] = { GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_323[0 /*3*/] = { -77.3f, -4.1f, 1f };
			vLocal_323[1 /*3*/] = { vLocal_323[0 /*3*/] };
			vLocal_323[iLocal_294 /*3*/] = { 66.7f, -7.299f, 1f };
			fLocal_336[0] = GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_336[1] = GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_340[0] = 30f;
		...
		case 225:
			...
			Local_539 = { func_138("FRAS_IG_10", 3) };
			fLocal_543 = 0f;
			break;
...
void func_148()
{
	...
	while (iVar0 < iLocal_298)
	{
		if (iLocal_298[iVar0] != 0)
		{
			SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_294[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_298)
	{
		if (iLocal_298[iVar0] != 0)
		{
			SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_298[iVar0]);
		}
		iVar0++;
	}
	REMOVE_RELATIONSHIP_GROUP(uLocal_307);
	if (!IS_SCENARIO_TYPE_ENABLED(sLocal_545))
	{
		SET_SCENARIO_TYPE_ENABLED(sLocal_545, 1);
	}
	SET_GAME_PAUSED(0);
