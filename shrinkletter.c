	...
	while (true)
	{
		switch (iLocal_84)
		{
			...
			case 1:
				...
				DISPLAY_RADAR(0);
				DISPLAY_HUD(0);
				uLocal_85 = REQUEST_SCALEFORM_MOVIE("PSYCHOLOGY_REPORT");
				while (!HAS_SCALEFORM_MOVIE_LOADED(uLocal_85))
				{
					func_43();
					WAIT(0);
				}
				...
				BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_85, "SET_PLAYER_NAME");
				...
				BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_85, "SET_LETTER_TEXT");
				func_42("HEADER_1");
				func_42("HEADER_2");
				...
				func_12(&uLocal_104);
				func_11(&uLocal_104, 0, 0, 0, 1);
				func_10(&uLocal_104, "CONTINUE", 2, 201, 1, 1, 0);
				func_9(&uLocal_104, 1);
				func_8(&uLocal_104, 1);
				if (IS_SCREEN_FADED_OUT())
				{
					...
					while (!IS_SCREEN_FADED_IN())
					{
						...
						DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_85, 255, 255, 255, 255, 0);
						WAIT(0);
					}
				}
				func_43();
			...
			case 2:
				SET_SCRIPT_GFX_DRAW_ORDER(1);
				DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_85, 255, 255, 255, 255, 0);
				func_1(&uLocal_104, 1128792064, 1, 0, 1, 1065353216);
			...
			case 3:
				...
				SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_85);
				func_50(0, 1, 1, 0, 0, 0);
...
void func_1(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	if (!func_6(uParam0->f_1, 256) || (func_6(uParam0->f_1, 8192) && _0x6CD79468A1E595C6(2)))
	{
		...
		if (IS_PC_VERSION())
		{
			...
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(func_6(uParam0->f_1, 4096));
			END_SCALEFORM_MOVIE_METHOD();
		}
		iVar5 = 0;
		iVar6 = 0;
...
int func_13(var uParam0, var uParam1, var uParam2)
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			_OBJECT_VALUE_ADD_INTEGER(uVar0, "in", *uParam2);
			_OBJECT_VALUE_ADD_STRING(uVar0, "st", &(uParam2->f_1));
			_OBJECT_VALUE_ADD_STRING(uVar0, "mp", &(uParam2->f_2));
			_OBJECT_VALUE_ADD_STRING(uVar0, "ms", &(uParam2->f_3));
			_OBJECT_VALUE_ADD_STRING(uVar0, "sc", &(uParam2->f_5));
			_OBJECT_VALUE_ADD_STRING(uVar0, "pr", &(uParam2->f_6));
			_OBJECT_VALUE_ADD_STRING(uVar0, "fa", &(uParam2->f_7));
			_OBJECT_VALUE_ADD_STRING(uVar0, "sm", &(uParam2->f_8));
			_OBJECT_VALUE_ADD_STRING(uVar0, "kp", &(uParam2->f_9));
			_OBJECT_VALUE_ADD_STRING(uVar0, "sv", &(uParam2->f_10));
			_OBJECT_VALUE_ADD_STRING(uVar0, "yo", &(uParam2->f_11));
			_OBJECT_VALUE_ADD_STRING(uVar0, "fi", &(uParam2->f_12));
			_OBJECT_VALUE_ADD_STRING(uVar0, "rc", &(uParam2->f_13));
			_OBJECT_VALUE_ADD_STRING(uVar0, "co", &(uParam2->f_14));
			_OBJECT_VALUE_ADD_INTEGER(uVar0, "su", uParam2->f_15);
			_0x83BCCE3224735F05("gta5/psych/index.json");
			*uParam0++;
			break;
...
{
	if (!_0x4DFDD9EB705F8140(uParam0))
	{
		if (*uParam0)
		{
			if (DATAFILE_GET_FILE_DICT() != 0 && iParam1)
			{
				DATAFILE_DELETE();
			}
			return 1;
...
struct<4> func_20(var uParam0)
{
	...
	iVar4 = GET_RANDOM_INT_IN_RANGE(1, 24);
	uParam0->f_15 = iVar4;
...
struct<4> func_21(var uParam0)
{
	...
	if (((func_22(110) || func_22(95)) || func_22(106)) || func_22(107))
	{
		...
		iVar4 = GET_RANDOM_INT_IN_RANGE(1, 11);
	}
	else
	{
		StringCopy(&(uParam0->f_14), "N", 4);
		StringConCat(&Var0, "N", 16);
		iVar4 = GET_RANDOM_INT_IN_RANGE(1, 12);
	}
...
struct<4> func_23(var uParam0)
{
	...
	iVar4 = GET_RANDOM_INT_IN_RANGE(1, 13);
...
int func_34(int iParam0)
{
	if (iParam0 < 9)
	{
		return IS_BIT_SET(Global_106565.f_18097.f_175[iParam0 /*19*/].f_18, 0);
	}
	return 0;
}
...
struct<4> func_38(var uParam0)
{
	...
	if (iVar6 >= 1000000)
	{
		...
		iVar4 = GET_RANDOM_INT_IN_RANGE(1, 14);
	}
	else
	{
...
struct<4> func_41(var uParam0)
{
	...
	iVar4 = GET_RANDOM_INT_IN_RANGE(1, 21);
	*uParam0 = iVar4;
	StringIntConCat(&Var0, iVar4, 16);
	return Var0;
}
