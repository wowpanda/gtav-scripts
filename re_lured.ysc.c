...
void func_1()//Position - 0x191
{
	if (bLocal_229)
	{
		...
		{
			if (!ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 100f, 100f, 100f, 0, 1, 0))
			{
				func_2();
			}
		}
		else if (!ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 100f, 100f, 100f, 0, 1, 0))
		{
			func_3();
		}
	}
	else
	{
		if (!PED::IS_PED_INJURED(iLocal_55))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_55, AUDIO::_0x0626A247D2405330(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(iLocal_55))
			{
				func_2();
			}
		}
...
int func_14()//Position - 0x1037
{
	return Global_1407E0;
}

int func_15(int iParam0, int iParam1)//Position - 0x1043
{
	switch (iParam0)
	{
		case 0:
...
int func_16(int iParam0)//Position - 0x13B7
{
	switch (iParam0)
	{
		case 29:
...
void func_17(int iParam0)//Position - 0x13E6
{
	int iVar0;
	int iVar1;
...
void func_18(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x1428
{
	func_19(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_19(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x1449
{
	int iVar0;
...
bool func_23(int iParam0)//Position - 0x187F
{
	return Global_8D15 == iParam0;
}

bool func_24(int iParam0)//Position - 0x188D
{
	return iParam0 < 3;
}

int func_25(int iParam0)//Position - 0x1899
{
	int iVar0;
	int iVar1;
...
int func_26(int iParam0)//Position - 0x18D6
{
	if (func_24(iParam0))
	{
...
int func_27(int iParam0)//Position - 0x1900
{
	int iVar0;
	int iVar1;
...
void func_28(int iParam0, int iParam1)//Position - 0x1943
{
	MISC::SET_BIT(&(Global_19E56.f_6187.f_8[iParam0]), iParam1);
}

int func_29(int iParam0)//Position - 0x195E
{
	int iVar0;
...
int func_31(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x1A2C
{
...
int func_32()//Position - 0x1C06
{
	return 1;
}

int func_33()//Position - 0x1C0F
{
...
void func_34()//Position - 0x1C31
{
}

void func_35()//Position - 0x1C39
{
	if (!bLocal_229)
	{
		if (func_50())
	...
	{
		if ((func_50() || WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6)) || !ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), unk_0x8000C77B5F336760(iLocal_56, false), 12f, 12f, 5f, false, true, 0))
		{
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_54, 1862763509);
			if (!PED::IS_PED_INJURED(iLocal_56))
			{
				NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_56);
				BRAIN::TASK_COMBAT_PED(iLocal_56, AUDIO::_0x0626A247D2405330(), 0, 16);
				if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56, 15f, 15f, 15f, 0, 1, 0))
				{
					func_48();
					SYSTEM::WAIT(0);
...
bool func_36(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1DB6
{
...
int func_37(char* sParam0, int iParam1, bool bParam2)//Position - 0x1E04
{
	Global_3DCF = 0;
...
int func_43()//Position - 0x22F8
{
	func_22();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_44()//Position - 0x2311
{
	int iVar0;
...
bool func_45(int iParam0, int iParam1)//Position - 0x2368
{
	switch (iParam0)
	{
		case 5:
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x23FA
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
void func_48()//Position - 0x2450
{
	Global_3960 = 0;
	func_49();
}

void func_49()//Position - 0x2460
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_50()//Position - 0x2481
{
	...
	if (!PED::IS_PED_INJURED(iLocal_55) && !PED::IS_PED_INJURED(iLocal_56))
	{
		...
		if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_55, 30f, 30f, 30f, 0, 1, 0) && WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6))
		{
			if (((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_55) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_56)) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_55)) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_56))
			{
				if (PED::_CAN_PED_SEE_PED(iLocal_55, AUDIO::_0x0626A247D2405330()) || PED::_CAN_PED_SEE_PED(iLocal_56, AUDIO::_0x0626A247D2405330()))
				{
					func_48();
					SYSTEM::WAIT(0);
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
		{
			...
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_55) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_56))
				{
					return 1;
				}
			}
		...
		if (PED::IS_COP_PED_IN_AREA_3D(unk_0x8000C77B5F336760(iLocal_55, false) - vLocal_49, unk_0x8000C77B5F336760(iLocal_55, false) + vLocal_49) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(unk_0x8000C77B5F336760(iLocal_55, false) - vLocal_49, unk_0x8000C77B5F336760(iLocal_55, false) + vLocal_49))
		{
			return 1;
		}
	}
	if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), 894.1762f, -1048.294f, 41.828f, 15f, 21.5625f, 10f, false, true, 0))
	{
		func_48();
		SYSTEM::WAIT(0);
	...
	if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_47, 15f, 15f, 15f, false, true, 0))
	{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_47, 40f, 40f, 40f, false, true, 0))
	{
...
void func_51()//Position - 0x27F8
{
	if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), -734.9749f, -728.4423f, 29.4985f, 2f, 6f, 2f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), -663.9312f, -725.6195f, 28.2592f, 2f, 6f, 2f, false, true, 0))
	{
		if (!PED::IS_PED_INJURED(iLocal_56))
		{
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
...
void func_52()//Position - 0x28CE
{
	if (!bLocal_230)
	{
		if (!PED::IS_PED_INJURED(iLocal_56))
		{
			if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_56, 242628503) == 7 && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_56, AUDIO::_0x0626A247D2405330(), 2.8f, 2.8f, 2.8f, 0, 1, 0))
			{
				if (!iLocal_231)
				{
					iLocal_236 = 500;
...
int func_53(int iParam0, int iParam1, int iParam2)//Position - 0x2A53
{
	...
	return func_54(Global_19E56.f_6D76[iParam0 /*29*/].f_11, 0, iParam1, iParam2, 0);
}

int func_54(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x2A9C
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_55(bool bParam0)//Position - 0x309B
{
	int iVar0;
	int iVar1;
...
void func_56(int iParam0)//Position - 0x331D
{
	int iVar0;
...
void func_57(int iParam0)//Position - 0x3377
{
	bool bVar0;
	char cVar1[64];
...
char* func_58(int iParam0)//Position - 0x3489
{
	switch (iParam0)
	{
		case 0:
...
void func_60(int iParam0)//Position - 0x3544
{
	func_80(93, iParam0);
	func_80(29, iParam0);
	func_80(30, iParam0);
...
bool func_61(int iParam0)//Position - 0x3564
{
	if (iParam0 == 8)
	{
...
int func_62(int iParam0, int iParam1, int iParam2)//Position - 0x35E8
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_63(int iParam0)//Position - 0x3625
{
	int iVar0;
...
int func_64(int iParam0, int iParam1)//Position - 0x393D
{
	int iVar0;
...
int func_65(bool bParam0)//Position - 0x3C29
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_66(int iParam0, int iParam1)//Position - 0x3CE0
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_67(int iParam0, int iParam1)//Position - 0x3CFB
{
...
int func_68(var uParam0, int iParam1)//Position - 0x3D98
{
	int iVar0;
	var uVar1[78];
...
int func_69(var uParam0, int iParam1)//Position - 0x3E49
{
	int iVar0;
...
bool func_70(var uParam0, int iParam1)//Position - 0x3EC4
{
	return (*uParam0)[iParam1] == 78;
}

void func_71(var uParam0)//Position - 0x3ED5
{
	int iVar0;
	...
	func_73(uParam0, (Global_412215 - 0.5f));
}

void func_72(var uParam0, int iParam1)//Position - 0x3F09
{
	(*uParam0)[iParam1] = 78;
}

void func_73(var uParam0, float fParam1)//Position - 0x3F19
{
	if (fParam1 == 0f)
	{
		uParam0->f_50 = 0f;
...
float func_74(var uParam0)//Position - 0x3F36
{
	return uParam0->f_50;
}

bool func_75(var uParam0, int iParam1)//Position - 0x3F42
{
	return func_76(uParam0, iParam1) != 4294967295;
}

int func_76(var uParam0, int iParam1)//Position - 0x3F54
{
	int iVar0;
...
bool func_77(var uParam0)//Position - 0x3F81
{
	return uParam0->f_4F == 1;
}

int func_78(int iParam0)//Position - 0x3F8F
{
	switch (iParam0)
	{
		case 60:
...
void func_79(int iParam0, int iParam1)//Position - 0x3FDF
{
	int iVar0;
...
void func_80(int iParam0, int iParam1)//Position - 0x4003
{
	int iVar0;
...
int func_82(int iParam0)//Position - 0x40D5
{
	var uVar0;
...
void func_83()//Position - 0x412D
{
	if (!PED::IS_PED_INJURED(iLocal_56))
	{
		if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), 873.9561f, -1050.806f, 33.0066f, 4.75f, 1.9f, 1f, false, true, 0))
		{
			if (!WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6))
			{
				BRAIN::TASK_LOOK_AT_ENTITY(iLocal_56, AUDIO::_0x0626A247D2405330(), 4294967295, 2048, 2);
				...
				else
				{
					...
					BRAIN::TASK_PLAY_ANIM(0, "random@mugging5", "ig_1_guy_enter_stickup", 2f, -2f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), AUDIO::_0x0626A247D2405330(), 2f, 0, 2.3f, 4f, 1, 1, 3337513804);
					BRAIN::TASK_AIM_GUN_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 500, 0);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_61);
				}
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_56, iLocal_61);
				...
				if (!PED::IS_PED_INJURED(iLocal_55))
				{
					BRAIN::TASK_LOOK_AT_ENTITY(iLocal_55, AUDIO::_0x0626A247D2405330(), 4294967295, 2048, 2);
					WEAPON::GIVE_WEAPON_TO_PED(iLocal_55, joaat("weapon_pistol"), 200, true, true);
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
					BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_52, AUDIO::_0x0626A247D2405330(), 2f, false, 0f, 4f, true, 512, 0, 3337513804, 20000);
					BRAIN::TASK_AIM_GUN_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 5000, 0);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_61);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_55, iLocal_61);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_61);
				}
				...
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
					BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_56, 4294967295, 2048, 2);
					BRAIN::TASK_PAUSE(0, 1000);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_61);
					BRAIN::TASK_PERFORM_SEQUENCE(AUDIO::_0x0626A247D2405330(), iLocal_61);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_61);
					func_84(1);
				}
				func_48();
...
void func_84(bool bParam0)//Position - 0x43CC
{
	if (bParam0)
	{
		func_89();
...
void func_85(int iParam0)//Position - 0x442F
{
	if (func_87())
	{
		return;
...
void func_86(bool bParam0, bool bParam1)//Position - 0x44A9
{
	if (bParam0)
	{
		if (func_88(0))
...
bool func_87()//Position - 0x451D
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

int func_88(int iParam0)//Position - 0x452F
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
int func_90(int iParam0, bool bParam1, int iParam2)//Position - 0x45B2
{
	int iVar0;
...
int func_91(int iParam0, bool bParam1, bool bParam2)//Position - 0x4604
{
	int iVar0;
	...
	{
		HUD::SET_BLIP_SCALE(iVar0, func_92(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		HUD::SET_BLIP_SCALE(iVar0, func_92(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
...
float func_92(bool bParam0, float fParam1, float fParam2)//Position - 0x46A8
{
	if (bParam0)
	{
		return fParam1;
...
void func_93()//Position - 0x46BF
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_55, 0))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_55, 15f, 15f, 15f, 0, 1, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
			{
				if (!func_33())
				{
					if (iLocal_235 == 0)
					{
						...
						BRAIN::TASK_LOOK_AT_ENTITY(iLocal_55, AUDIO::_0x0626A247D2405330(), 4294967295, 2052, 2);
						iLocal_235++;
						SYSTEM::SETTIMERB(0);
					}
...
void func_94()//Position - 0x47D7
{
	if (!PED::IS_PED_INJURED(iLocal_55))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
		{
			if (WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6) && PED::_CAN_PED_SEE_PED(iLocal_55, AUDIO::_0x0626A247D2405330()))
			{
				NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_55);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
				BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295, 2052, 2);
				...
				else if (WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 2))
				{
					func_36(&uLocal_62, "lurinau", "lurin_other", 4, 0, 0, 0);
				}
				func_2();
...
void func_95()//Position - 0x48E5
{
	if (!func_124())
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_55, 0))
		{
			if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_47, 65f, 60f, 60f, false, true, 0) || Global_19E51)
			{
	...
	if (!iLocal_227)
	{
		if (!PED::IS_PED_INJURED(iLocal_55))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_55, 25f, 25f, 25f, 0, 1, 0) && func_124())
			{
				if (func_36(&uLocal_62, "lurinau", "lurin_help2", 4, 0, 0, 0))
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
					BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295, 2064, 2);
					BRAIN::TASK_PLAY_ANIM(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 4f, -4f, 4294967295, 49, 0, 0, 0, 0);
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_55, 0))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_55, 15f, 15f, 15f, 0, 1, 0) && PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
		{
			WEAPON::SET_CURRENT_PED_WEAPON(AUDIO::_0x0626A247D2405330(), joaat("weapon_unarmed"), true);
		}
		if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_55, 8f, 8f, 8f, 0, 1, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
			{
				iLocal_228 = 1;
				...
				{
					SYSTEM::SETTIMERB(0);
					BRAIN::CLEAR_PED_SECONDARY_TASK(iLocal_55);
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
					BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295, 2064, 2);
					BRAIN::TASK_STAND_STILL(0, 1000);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_51, 2f, 4294967295, 0.25f, 512, 80.1325f);
					BRAIN::TASK_PLAY_ANIM(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 4f, -4f, 4294967295, 1, 0, 0, 0, 0);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_61);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_55, iLocal_61);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_61);
			...
			else if (!iLocal_234)
			{
				...
				if (!func_33())
				{
					if (!PED::IS_PED_INJURED(iLocal_55))
					{
						...
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
						BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295, 3076, 2);
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295);
						CUTSCENE::_0x8D9DF6ECA8768583(iLocal_61);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_55, iLocal_61);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_61);
...
void func_96()//Position - 0x4B84
{
	Global_3960 = 0;
	func_97();
}

void func_97()//Position - 0x4B94
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
int func_98(int iParam0)//Position - 0x4BB8
{
	if (func_102())
	{
		Global_19E4C = 1;
...
void func_99(int iParam0)//Position - 0x4C0B
{
	switch (iParam0)
	{
		case 0:
...
void func_100(char* sParam0, int iParam1)//Position - 0x4CEC
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_101(int iParam0)//Position - 0x4D03
{
	char* sVar0;
...
int func_102()//Position - 0x4D46
{
	switch (func_103(&Global_63AE, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_103(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x4D7C
{
	int iVar0;
...
void func_104(var uParam0, int iParam1)//Position - 0x4EB3
{
	int iVar0;
...
bool func_105(int iParam0)//Position - 0x4F02
{
	return func_106(iParam0, Global_8D15);
}

int func_106(int iParam0, int iParam1)//Position - 0x4F13
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_107(int iParam0)//Position - 0x50F4
{
	if (Global_8D15 == 15)
	{
		return 0;
...
void func_108()//Position - 0x5116
{
	...
	BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
	BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295, 3076, 2);
	BRAIN::TASK_PLAY_ANIM(0, "random@mugging5", "ig_1_girl_agitated_loop", 2f, -2f, 4294967295, 1, 0, 0, 0, 0);
	BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295);
	CUTSCENE::_0x8D9DF6ECA8768583(iLocal_61);
	BRAIN::TASK_PERFORM_SEQUENCE(iLocal_55, iLocal_61);
	BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_61);
	...
	BRAIN::TASK_LOOK_AT_ENTITY(iLocal_56, AUDIO::_0x0626A247D2405330(), 4294967295, 2052, 2);
	func_109(&uLocal_62, 0, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
	func_109(&uLocal_62, 4, iLocal_55, "HOBOFEMALE", 0, 1);
	func_109(&uLocal_62, 5, iLocal_56, "HOBOMALE", 0, 1);
	iLocal_45 = 1;
}

void func_109(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x5302
{
...
int func_112(float fParam0, bool bParam1)//Position - 0x5491
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_113(int iParam0, var uParam1)//Position - 0x5548
{
	switch (iParam0)
	{
		case 0:
...
int func_115(int iParam0)//Position - 0x678E
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_116(int iParam0)//Position - 0x6AD4
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_117(int iParam0)//Position - 0x6B0B
{
	struct<2> Var0;
...
bool func_119()//Position - 0x6F89
{
	return Global_19D3C > 0;
}

int func_120()//Position - 0x6F97
{
...
void func_125(int iParam0)//Position - 0x707C
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_30();
...
void func_127(int iParam0)//Position - 0x70EF
{
	Global_19E4B = iParam0;
}

int func_128(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x70FD
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
...
bool func_129(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x7497
{
	if (bParam2)
	{
...
bool func_130(int iParam0)//Position - 0x74DE
{
	int iVar0;
...
int func_131(int iParam0)//Position - 0x74FF
{
	return func_132(iParam0, 1);
}

int func_132(int iParam0, int iParam1)//Position - 0x750E
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_133(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x7561
{
	func_134(func_145(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_134(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x757F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_135(float fParam0, float fParam1, float fParam2)//Position - 0x7780
{
	float fVar0;
...
int func_136(int iParam0, int iParam1)//Position - 0x77C2
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_137(int iParam0)//Position - 0x7864
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_138(int iParam0)//Position - 0x7877
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_139(int iParam0)//Position - 0x788A
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_140(int iParam0)//Position - 0x789D
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_141(int iParam0)//Position - 0x78AF
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_142(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}

int func_142(bool bParam0, int iParam1, int iParam2)//Position - 0x78D4
{
	if (bParam0)
	{
		return iParam1;
...
int func_143(int iParam0)//Position - 0x78EB
{
	return iParam0 & 15;
}

int func_144(int iParam0, int iParam1)//Position - 0x78F8
{
	int iVar0;
	int iVar1;
...
void func_146(var uParam0, int iParam1)//Position - 0x7A4A
{
	if (iParam1 <= 0)
	{
		return;
...
void func_147(var uParam0, int iParam1)//Position - 0x7AD0
{
...
void func_148(var uParam0, int iParam1)//Position - 0x7B03
{
	int iVar0;
	int iVar1;
...
void func_149(var uParam0, int iParam1)//Position - 0x7B54
{
...
void func_150(var uParam0, int iParam1)//Position - 0x7B8E
{
...
void func_151(var uParam0, int iParam1)//Position - 0x7BC9
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_152(int iParam0)//Position - 0x7C05
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_153(int iParam0, int iParam1)//Position - 0x7CE1
{
...
int func_154(int iParam0)//Position - 0x7D04
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_162()) || Global_6375) || func_161()) || func_45(8, 4294967295)) || func_158()) || func_160()) || func_159()) || func_157()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_162() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_45(8, 4294967295)) || func_157()) || func_156()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_45(8, 4294967295) || func_160()) || func_159()) || func_156()) || func_155())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_162()) || Global_6375) || func_161()) || func_45(8, 4294967295)) || func_159()) || func_158()) || func_157()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_155()//Position - 0x8422
{
	return Global_16C57.f_1;
}

int func_156()//Position - 0x8430
{
	if (Global_16089 != 4294967295)
	{
...
bool func_159()//Position - 0x849A
{
	return Global_16C64.f_148 > 0;
}

bool func_160()//Position - 0x84AB
{
	return Global_16C64.f_147 > 0;
}

var func_161()//Position - 0x84BC
{
	return Global_140859;
}

int func_162()//Position - 0x84C8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_164(int iParam0)//Position - 0x850C
{
	return func_144(func_145(), iParam0);
}

int func_165(int iParam0, int iParam1, int iParam2)//Position - 0x851E
{
	int iVar0;
	int iVar1;
...
int func_166(int iParam0)//Position - 0x8602
{
	if (!func_24(iParam0))
	{
		return 7;
...
bool func_167(int iParam0)//Position - 0x8626
{
	int iVar0;
	bool bVar1;
...
void func_171(int iParam0)//Position - 0x8843
{
	char cVar0[64];
...
void func_172(var uParam0)//Position - 0x88F8
{
	if (*uParam0 == 4294967295)
	{
		return;
...
char* func_173(int iParam0, bool bParam1)//Position - 0x8935
{
	switch (iParam0)
	{
		case 0:
...
void func_174(int iParam0)//Position - 0x8B7E
{
	Global_8F3C = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_175(int iParam0)//Position - 0x8B90
{
	func_176(iParam0, 0, func_181(iParam0));
}

void func_176(int iParam0, int iParam1, int iParam2)//Position - 0x8BA5
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_177(var uParam0)//Position - 0x8BD4
{
	struct<16> Var0;
	int iVar1;
...
void func_178(int iParam0, var uParam1)//Position - 0x8CA4
{
	Global_19E56.f_6187.f_2B[iParam0] = *uParam1;
}

void func_179(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8CBC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_180(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8E3E
{
...
int func_181(int iParam0)//Position - 0x8E76
{
	int iVar0;
