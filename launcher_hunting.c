...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_104307[Var0 /*10*/].f_9 != -1)
			{
				...
				func_267(&(Global_104307[Var0 /*10*/].f_9));
			}
		}
		func_255(&Var0, 1);
	}
	...
	while (true)
	{
		...
		if (func_164(&Var0, 0) && MISC::ABSF((vVar1.z - vVar3.z)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_255(&Var0, 1);
...
int func_179(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	var uVar0;
	
	if ((((func_124(PLAYER::PLAYER_PED_ID()) && func_124(iParam0->f_28[0])) && !func_143()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_183(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_184(int iParam0, void fParam1, vector3 vParam2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(fParam1))
		{
			...
			{
				if (func_183(PLAYER::PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_187(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_183(PLAYER::PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_189(iParam0);
				}
			}
...
int func_192(int iParam0, bool bParam1)
{
	...
	func_107(*iParam0, &Var0);
	if ((func_229(*iParam0) || func_227(*iParam0)) || Global_71223 == 1)
	{
		return 1;
	}
	if (!TASK::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_193(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_124(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_195(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_194(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_195(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_194(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_68(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						BRAIN::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_207(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
int func_210(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_212(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_212(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_211(vector3 vParam0, vector3 vParam1)
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_212(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
int func_219(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_212(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
{
	if ((func_228() && Global_92955.f_11 == 6) && iParam0 == func_162(&(Global_92955.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_231(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_238(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmhunting2"))
			{
				return 0;
			}
			iLocal_51 = 2;
...
void func_232(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
...
int func_235(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
...
int func_236(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_239(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if ((!func_238(&iVar0) || !func_240(&(uParam0->f_48))) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_51 = 2;
...
bool func_246(int iParam0, void fParam1)
{
