...
void __EntryFunction__()
{
	...
	uLocal_92 = func_274(54);
	iLocal_93 = joaat("dune");
	iLocal_94 = GET_WEAPONTYPE_MODEL(joaat("weapon_sniperrifle"));
	iLocal_95 = GET_WEAPON_COMPONENT_TYPE_MODEL(joaat("component_at_scope_large"));
	iLocal_96 = GET_WEAPON_COMPONENT_TYPE_MODEL(joaat("component_at_ar_supp_02"));
	...
	if (!func_255(&iVar64, &Var0, vVar61, 1f))
	{
		func_254();
	...
	while (true)
	{
		...
		func_194(Var0);
		func_187(&iLocal_101, &(Var0.f_9), vVar61);
		if (Var0 == 25)
		{
			func_182(&Var0, vVar61, "HUNT1AU", "HUNT1_AMB", 3, "CLETUS", 5000, 1101004800);
		}
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()) && !IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
		{
			vVar67 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 0) };
		}
		if (Var0 == 25)
		{
			if (VDIST2(vVar61, vVar67) < (10f * 10f))
			{
		...
		if (func_167(&Var0, 0) && ABSF((vVar61.z - vVar67.z)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_258(&Var0, 1);
...
int func_182(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_126(PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && !func_145()) && (GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_186(PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
		func_185(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
...
float func_186(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
void func_187(int iParam0, var uParam1, vector3 vParam2)
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (!IS_STRING_NULL_OR_EMPTY(uParam1))
		{
			...
			{
				if (func_186(PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_190(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_186(PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_192(iParam0);
				}
			}
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_198(uParam1) || !IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_198(uParam1) && uParam1->f_4 == 0) && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
bool func_209(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_210(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_210(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
int func_213(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_215(GET_ENTITY_COORDS(iParam1, 1) - GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		vVar3 = { func_215(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_219(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_220(var uParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_221(var uParam0, float fParam1)
{
	...
	{
		if (func_222(uParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_222(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_215(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_215(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_214(vVar3, vVar0);
...
int func_223(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (IS_PED_SHOOTING(PLAYER_PED_ID()))
...
int func_234(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_241(&iVar0) || !HAS_ANIM_DICT_LOADED("rcmhunting2"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!DOES_ENTITY_EXIST(uLocal_100))
			{
				uLocal_100 = CREATE_WEAPON_OBJECT(joaat("weapon_sniperrifle"), 0, vLocal_97, 0, 1065353216, 0, 0, 1);
				GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uLocal_100, joaat("component_at_scope_large"));
				GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uLocal_100, joaat("component_at_ar_supp_02"));
			}
			if (bVar7)
			{
				iLocal_91 = 3;
		...
		case 3:
			...
			{
				SET_ENTITY_ROTATION(uLocal_100, 0f, -90f, -162.64f, 2, 1);
			}
			iVar6 = 0;
			while (iVar6 <= (iVar0 - 1))
			{
...
void func_235(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	func_236(uParam0, iLocal_93, vParam1, fParam4);
	if (DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_236(var uParam0, int iParam1, vector3 vParam2, var uParam5)
{
	func_237(uParam0);
...
int func_239(var uParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	int iVar0;
...
int func_242(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if ((!func_241(&iVar0) || !func_243(&(uParam0->f_48))) || !HAS_ANIM_DICT_LOADED("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_91 = 2;
...
int func_255(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_256((*iParam0)[0], vParam2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_256((*iParam0)[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_256(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_257(Var1.f_6, vParam1, fParam4, 0))
	{
...
int func_257(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
