...
void func_1(int iParam0)//Position - 0x13F
{
	...
	if (Global_389C == 0)
	{
		...
		if (!bLocal_23 == bLocal_24)
		{
			...
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(fLocal_25);
		...
		if (!bLocal_29 == bLocal_30)
		{
			...
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(fLocal_31);
			CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
		}
		...
		if (!bLocal_32 == bLocal_33)
		{
			...
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(fLocal_34);
			CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
		}
		...
		if (!bLocal_35 == bLocal_36)
		{
			...
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(fLocal_37);
			CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
		}
		...
		if (!bLocal_41 == bLocal_42)
		{
			...
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(fLocal_43);
			CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
		}
		...
		if (!bLocal_44 == bLocal_45)
		{
			bLocal_45 = bLocal_44;
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_INPUT_EVENT");
			GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(14);
			GRAPHICS::_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(fLocal_46);
			CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
		}
	}
}
