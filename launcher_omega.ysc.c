	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != 4294967295)
		{
			if (Global_19AC5[Var0 /*10*/].f_9 != 4294967295)
			{
				...
				func_281(&(Global_19AC5[Var0 /*10*/].f_9));
			}
		}
		func_265(&Var0, 1);
	}
...
void func_47(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x371D
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x38BD
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x38EF
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x3923
{
	return Global_1407E0;
}

int func_51(int iParam0, int iParam1)//Position - 0x392F
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x395B
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EA3
{
	int iVar0;
...
int func_54()//Position - 0x40E6
{
	func_55();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_55()//Position - 0x40FF
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x41FC
{
	return Global_8D15 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x420A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x42FD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x4587
{
	switch (iParam0)
	{
		case 3036451504:
...
int func_60(int iParam0)//Position - 0x4622
{
...
int func_61(int iParam0, int iParam1)//Position - 0x47A8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x5319
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x5354
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x55C8
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x5604
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_66(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x5B5F
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5BA3
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x6282
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x62C9
{
...
bool func_70(int iParam0)//Position - 0x6324
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6334
{
...
int func_72(int iParam0)//Position - 0x639E
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x66A1
{
	return Global_6373;
}

int func_74(int iParam0)//Position - 0x66AC
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x66BC
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x675E
{
	switch (iParam0)
	{
		case 4294967295:
...
int func_77(int iParam0)//Position - 0x6D33
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6D91
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6E3F
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6ED4
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6F18
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x709C
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x70AA
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7B71
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7BF3
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7C51
{
	return 4294967295;
}

Vector3 func_87(int iParam0)//Position - 0x7C5A
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x7E65
{
	return func_89(CAM::_0xDC9DA9E8789F5246());
}

int func_89(int iParam0)//Position - 0x7E75
{
	return MISC::GET_BITS_IN_RANGE(Global_24FBF9[iParam0 /*413*/].f_135.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x7E92
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x7EA2
{
	switch (iParam0)
	{
		case 4294967295:
...
bool func_92()//Position - 0x8149
{
	return Global_16C64.f_147 > 0;
}

var func_93()//Position - 0x815A
{
	var uVar0;
...
void func_94(var uParam0, int iParam1)//Position - 0x81A0
{
	if (iParam1 <= 0)
	{
		return;
...
void func_95(var uParam0, int iParam1)//Position - 0x8226
{
...
void func_96(var uParam0, int iParam1)//Position - 0x8259
{
	int iVar0;
	int iVar1;
...
int func_97(int iParam0, int iParam1)//Position - 0x82AA
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_100(var uParam0)//Position - 0x8388
{
	return uParam0 & 15;
}

void func_101(var uParam0, int iParam1)//Position - 0x8395
{
...
void func_102(var uParam0, int iParam1)//Position - 0x83CF
{
...
void func_103(var uParam0, int iParam1)//Position - 0x840A
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_104()//Position - 0x8446
{
	func_55();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_105(int iParam0)//Position - 0x845F
{
	var uVar0;
	vector3 vVar1[24];
...
void func_106(char* sParam0, int iParam1, int iParam2)//Position - 0x84B8
{
...
bool func_107(bool bParam0)//Position - 0x84FA
{
...
struct<2> func_108(int iParam0)//Position - 0x8525
{
	struct<2> Var0;
...
void func_109(int iParam0, var uParam1)//Position - 0x8972
{
	switch (iParam0)
	{
		case 0:
...
int func_111(int iParam0)//Position - 0x9C4A
{
	switch (iParam0)
	{
		case 0:
...
int func_112(int iParam0)//Position - 0x9F90
{
	int iVar0;
...
void func_113(int iParam0)//Position - 0xA034
{
	struct<2> Var0;
...
void func_114(int iParam0)//Position - 0xA0CF
{
	if (iParam0 < 63)
	{
		func_115();
...
void func_116(int iParam0)//Position - 0xA12D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_117(int iParam0)//Position - 0xA186
{
...
int func_118(int iParam0)//Position - 0xA209
{
	int iVar0;
...
void func_119(int iParam0, int iParam1, int iParam2)//Position - 0xA23A
{
	func_120(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_120(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA24F
{
	int iVar0;
...
int func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA302
{
...
int func_123(int iParam0, int iParam1, int iParam2)//Position - 0xA31D
{
	int iVar0;
...
int func_124(int iParam0)//Position - 0xA369
{
	int iVar0;
...
int func_125(int iParam0)//Position - 0xA3B2
{
	if (func_126(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_126(int iParam0)//Position - 0xA3D2
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_127(int iParam0)//Position - 0xA3F3
{
	switch (iParam0)
	{
		case 5:
...
int func_129(int iParam0)//Position - 0xA4C3
{
	switch (iParam0)
	{
		case 5:
...
void func_130(var uParam0, bool bParam1, bool bParam2)//Position - 0xA516
{
	int iVar0;
...
void func_132(bool bParam0)//Position - 0xA676
{
	int iVar0;
...
void func_133(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA6B3
{
	if (bParam0)
	{
...
int func_136(int iParam0, bool bParam1)//Position - 0xA844
{
	int iVar0;
	int iVar1;
...
int func_137(int iParam0)//Position - 0xA885
{
...
bool func_138()//Position - 0xA8C7
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_240006, 3);
}

int func_139(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA8D8
{
	int iVar0;
...
void func_141(int iParam0)//Position - 0xA932
{
	if (iParam0 == 1)
	{
...
int func_142(char* sParam0)//Position - 0xA955
{
...
void func_143()//Position - 0xA992
{
	Global_3960 = 0;
	func_144();
}

void func_144()//Position - 0xA9A2
{
...
int func_148(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xAA88
{
...
void func_149(int iParam0)//Position - 0xAC17
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_151(int iParam0)//Position - 0xAC94
{
	if (func_155())
	{
		return;
...
void func_152(int iParam0)//Position - 0xACC7
{
	if (func_155())
	{
		return;
...
void func_153(bool bParam0, bool bParam1)//Position - 0xAD41
{
	if (bParam0)
	{
		if (func_154(0))
...
int func_154(int iParam0)//Position - 0xADB5
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
bool func_155()//Position - 0xAE0F
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

int func_156(int iParam0)//Position - 0xAE21
{
...
int func_157(int iParam0)//Position - 0xAE62
{
	int iVar0;
...
void func_158(int iParam0)//Position - 0xAEA7
{
...
int func_159(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAED9
{
	int iVar0;
...
void func_160(var uParam0, int iParam1)//Position - 0xB010
{
	int iVar0;
...
bool func_161(int iParam0)//Position - 0xB05F
{
	return func_162(iParam0, Global_8D15);
}

int func_162(int iParam0, int iParam1)//Position - 0xB070
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_163(int iParam0)//Position - 0xB251
{
	if (Global_8D15 == 15)
	{
		return 0;
...
int func_164()//Position - 0xB273
{
	return func_165(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_165(char* sParam0, int iParam1)//Position - 0xB284
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_167(int iParam0, int iParam1)//Position - 0xB2F1
{
	switch (iParam0->f_10)
	{
		case 0:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, true, 0))
				{
					if (func_126(iParam0->f_1C[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iParam0->f_1C[0], true), true) < 3f)
						{
							if (func_173(2))
							{
								if (func_171(iParam0->f_1B))
								{
									func_170(iParam0->f_1B, *iParam0);
...
void func_168()//Position - 0xBAD4
{
	func_27(&(Global_17998.f_B3B), &Global_17998, 0, 1, 1, 0);
}

int func_169(var uParam0)//Position - 0xBAEF
{
	float fVar0;
...
void func_170(int iParam0, int iParam1)//Position - 0xBB7D
{
	if (iParam0 == 1)
	{
		if (!func_129(iParam1))
...
int func_171(bool bParam0)//Position - 0xBBE1
{
	int iVar0;
...
int func_172(int iParam0)//Position - 0xBC78
{
	if (func_126(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
int func_173(int iParam0)//Position - 0xBCA2
{
	int iVar0;
...
var func_174()//Position - 0xC3C0
{
	return Global_16C57.f_1;
}

int func_175()//Position - 0xC3CE
{
...
bool func_178()//Position - 0xC438
{
	return Global_16C64.f_148 > 0;
}

bool func_179(int iParam0, int iParam1)//Position - 0xC449
{
	switch (iParam0)
	{
		case 5:
...
var func_180()//Position - 0xC484
{
	return Global_140859;
}

int func_181()//Position - 0xC490
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_182(int iParam0)//Position - 0xC4AC
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	...
	{
		if (func_126(iParam0->f_1C[0]) && !ENTITY::IS_ENTITY_ON_SCREEN(iParam0->f_1C[0]))
		{
			if (func_126(AUDIO::_0x0626A247D2405330()) && !func_183(AUDIO::_0x0626A247D2405330(), iParam0->f_1C[0], 50f, 1))
			{
				vVar0 = { unk_0x8000C77B5F336760(iParam0->f_1C[0], true) };
...
void func_184()//Position - 0xC5B7
{
	...
	CAM::_ENABLE_CROSSHAIR_THIS_FRAME();
	unk_0xF14A31FD690DC3B0(iLocal_57);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
...
int func_185(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6)//Position - 0xC6A9
{
	var uVar0;
	...
	if (!*uParam6 == 3)
	{
		if (func_173(2))
		{
			if (!func_145())
			{
				if ((func_126(AUDIO::_0x0626A247D2405330()) && func_126(iParam0->f_1C[0])) && func_192(AUDIO::_0x0626A247D2405330(), vParam1, 1) < 20f)
				{
			...
			if (func_192(AUDIO::_0x0626A247D2405330(), vParam1, 1) < 20f && *uParam6 == 1)
			{
...
void func_186(int iParam0)//Position - 0xC7CB
{
	Global_41C1 = iParam0;
}

int func_187(char* sParam0)//Position - 0xC7D8
{
	struct<6> Var0;
...
struct<6> func_188()//Position - 0xC7F8
{
	struct<6> Var0;
...
void func_189(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC81C
{
...
void func_190(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC857
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
void func_191(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC8AD
{
...
float func_192(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xC948
{
	vector3 vVar0;
...
void func_193(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xC982
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
...
void func_194(int iParam0, bool bParam1)//Position - 0xCA73
{
	if (iParam0 == 4294967295)
	{
		return;
...
int func_195(int iParam0)//Position - 0xCAAF
{
	if (Global_11621 == iParam0)
	{
...
void func_196(int iParam0, int iParam1)//Position - 0xCAE8
{
	bool bVar0;
	int iVar1;
...
bool func_197()//Position - 0xCB86
{
	return Global_1620C;
}

void func_198(int iParam0)//Position - 0xCB92
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_199(iParam0);
...
void func_199(int iParam0)//Position - 0xCBA9
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_200(int iParam0)//Position - 0xCC91
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_164();
...
int func_201(int iParam0, bool bParam1)//Position - 0xCCB9
{
	struct<27> Var0;
	...
	func_109(*iParam0, &Var0);
	if ((func_238(*iParam0) || func_236(*iParam0)) || Global_1171A == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_205(&(iParam0->f_30)) && bParam1)
	{
		func_202(iParam0->f_1C[0], &(iParam0->f_30), *iParam0);
	}
	return 1;
}

void func_202(int iParam0, var uParam1, int iParam2)//Position - 0xCF2C
{
	int iVar0;
	int iVar1;
	...
	if (func_126(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				...
				{
					if (func_203(iParam2) && !PED::IS_PED_FACING_PED(iParam0, AUDIO::_0x0626A247D2405330(), 25f))
					{
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, AUDIO::_0x0626A247D2405330(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_204(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_203(iParam2) || PED::IS_PED_FACING_PED(iParam0, AUDIO::_0x0626A247D2405330(), 10f))
				{
					if (func_68(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						BRAIN::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, 4294967295, 262153, 0, 0, 0, 0);
...
int func_203(int iParam0)//Position - 0xD284
{
...
int func_204(var uParam0)//Position - 0xD2A4
{
...
int func_205(var uParam0)//Position - 0xD2BC
{
...
void func_206(var uParam0)//Position - 0xD2E1
{
	int iVar0;
	int iVar1;
...
void func_207(int iParam0)//Position - 0xD5E5
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_208(var uParam0)//Position - 0xD610
{
	int iVar0;
...
int func_209(var uParam0, bool bParam1, bool bParam2)//Position - 0xD690
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_210(AUDIO::_0x0626A247D2405330(), uParam0->f_23[iVar0]))
							{
...
int func_210(int iParam0, int iParam1)//Position - 0xD84E
{
	int iVar0;
...
int func_211(var uParam0, bool bParam1, int iParam2)//Position - 0xD87E
{
	int iVar0;
	int iVar1;
...
int func_212(int iParam0)//Position - 0xDB3A
{
...
int func_213(int iParam0, float fParam1)//Position - 0xDB6E
{
	float fVar0;
	
	if (func_126(AUDIO::_0x0626A247D2405330()) && func_126(iParam0))
	{
		if (func_224(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iParam0))
		{
...
bool func_214(int iParam0, float fParam1)//Position - 0xDBE4
{
	return func_215(iParam0, AUDIO::_0x0626A247D2405330(), fParam1, 1, 250, 7);
}

bool func_215(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDBFC
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_216(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xDCBD
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_217(int iParam0, int iParam1)//Position - 0xDDE9
{
	int iVar0;
...
int func_219(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xDEF8
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_221(unk_0x8000C77B5F336760(iParam1, true) - unk_0x8000C77B5F336760(iParam0, true)) };
...
float func_220(vector3 vParam0, vector3 vParam1)//Position - 0xDF89
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_221(vector3 vParam0)//Position - 0xDFAA
{
	float fVar0;
	float fVar1;
...
void func_222(var uParam0)//Position - 0xDFE9
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_223(int iParam0, int iParam1)//Position - 0xE004
{
	int iVar0;
...
int func_224(int iParam0)//Position - 0xE043
{
...
int func_225(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE06B
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_226(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE166
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_227(int iParam0, float fParam1)//Position - 0xE272
{
	var uVar0;
	vector3 vVar1;
...
int func_228(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xE307
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_221(vParam1 - unk_0x8000C77B5F336760(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_229(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE395
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
...
int func_230(int iParam0)//Position - 0xE3DD
{
...
void func_231(int iParam0)//Position - 0xE427
{
	int iVar0;
...
int func_232(int iParam0)//Position - 0xE4C4
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_164();
...
int func_233(int iParam0)//Position - 0xE55C
{
...
int func_236(int iParam0)//Position - 0xE5DE
{
	if ((func_237() && Global_16C30.f_B == 6) && iParam0 == func_165(&(Global_16C30.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_238(int iParam0)//Position - 0xE650
{
	if (func_107(0))
	{
...
void func_239()//Position - 0xE678
{
	iLocal_58 = MISC::GET_GAME_TIMER();
}

void func_240()//Position - 0xE686
{
	iLocal_56 = unk_0x9934FEFB3B8C6DB8("digiscanner");
...
int func_241(int iParam0)//Position - 0xE6EE
{
	switch (*iParam0)
	{
		case 44:
...
int func_242(var uParam0)//Position - 0xE735
{
	int iVar0[2];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_250(&(uParam0->f_30), "rcmrc_omega_2", "omega_idle_looking_around", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			{
				if (!func_245(&(uParam0->f_1C[0]), 69, 2319.443f, 2583.588f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_243(&(uParam0->f_23[0]), iVar0[1], 2331.08f, 2573.53f, 46.13f, 358.61f);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
...
void func_243(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE903
{
	func_244(iParam0);
...
void func_244(int iParam0)//Position - 0xE945
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_245(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xE9E1
{
...
int func_246(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xEA3D
{
	int iVar0;
...
int func_247(var uParam0, int iParam1)//Position - 0xEACB
{
	int iVar0;
...
int func_248(var uParam0)//Position - 0xEB11
{
	if (func_205(uParam0))
	{
...
int func_249(int iParam0)//Position - 0xEB3B
{
	int iVar0;
...
void func_250(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xEB6C
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_251(var uParam0)//Position - 0xEBA8
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_250(&(uParam0->f_30), "rcmrc_omega_1", "omega_idle_geiger_counter", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (!func_245(&(uParam0->f_1C[0]), 69, 2468.51f, 3437.39f, 49.9f, 180f, "OMEGA LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			if ((func_126(uParam0->f_1C[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[0])) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[1]))
			{
...
int func_252(int iParam0)//Position - 0xEE2A
{
	struct<27> Var0;
	int iVar1;
...
int func_253(int iParam0)//Position - 0xEE7E
{
	char* sVar0;
...
int func_254(int iParam0)//Position - 0xEF37
{
	var uVar0;
...
int func_255(int iParam0)//Position - 0xEFF8
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_256(int iParam0, char* sParam1)//Position - 0xF07D
{
...
bool func_257(int iParam0)//Position - 0xF15F
{
...
bool func_258(int iParam0)//Position - 0xF18D
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
bool func_259(int iParam0)//Position - 0xF1BB
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
int func_260(int iParam0)//Position - 0xF1E9
{
	if (func_233(iParam0))
	{
		return 0;
...
void func_261()//Position - 0xF21E
{
	func_282("Running end routines.");
	Global_19D3C = (Global_19D3C - 1);
}

int func_262(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF238
{
	int iVar0;
...
int func_263(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xF29D
{
	int iVar0;
	struct<7> Var1;
...
int func_264(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xF31B
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_265(int iParam0, bool bParam1)//Position - 0xF396
{
	char* sVar0;
...
void func_266(char* sParam0)//Position - 0xF466
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_187(sParam0))
...
void func_267()//Position - 0xF485
{
	Global_3960 = 0;
	func_268();
}

void func_268()//Position - 0xF495
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_269(var uParam0)//Position - 0xF4B6
{
	if (func_205(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_270(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xF4EC
{
...
void func_271(var uParam0, bool bParam1)//Position - 0xF50C
{
	func_272(&(uParam0->f_29), bParam1);
}

void func_272(var uParam0, bool bParam1)//Position - 0xF51E
{
	int iVar0;
...
void func_273(int iParam0, bool bParam1)//Position - 0xF55C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_274(var uParam0, bool bParam1)//Position - 0xF597
{
	func_275(&(uParam0->f_23), bParam1);
}

void func_275(var uParam0, bool bParam1)//Position - 0xF5A9
{
	int iVar0;
...
void func_276(int iParam0)//Position - 0xF5E6
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_277(var uParam0, int iParam1)//Position - 0xF61E
{
	func_278(&(uParam0->f_1C), iParam1);
}

void func_278(var uParam0, int iParam1)//Position - 0xF630
{
	int iVar0;
...
void func_279(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF671
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_280(int iParam0)//Position - 0xF6C1
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_281(var uParam0)//Position - 0xF702
{
	if (*uParam0 == 4294967295)
	{
		return;
...
void func_282(char* sParam0)//Position - 0xF73F
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_283(var uParam0)//Position - 0xF751
{
	*uParam0 = 4294967295;
...
void func_284()//Position - 0xF784
{
	func_282("Running start routines.");
	Global_19D3C++;
}

int func_285(int iParam0)//Position - 0xF79E
{
	if (!func_36(iParam0))
	{
		return Global_19E56.f_6D76[iParam0 /*29*/];
