...
void func_1()
{
	...
	if (iLocal_28 == 2)
	{
		if (DOES_ENTITY_EXIST(iLocal_48))
		{
			...
			{
				if (func_2(iLocal_48, PLAYER_PED_ID(), 1) > 850f)
				{
					func_3(2);
					return;
				}
	...
	if (iLocal_28 == 3 || iLocal_28 == 4)
	{
		if (DOES_ENTITY_EXIST(iLocal_48))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
			{
				if (func_2(iLocal_48, PLAYER_PED_ID(), 1) > 100f)
				{
					func_3(2);
					return;
				}
...
float func_2(int iParam0, var uParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
{
	func_6(&(Global_100114.f_2890), vParam0, fParam3);
}

void func_6(var uParam0, vector3 vParam1, var uParam4)
{
	*uParam0 = { vParam1 };
	uParam0->f_6 = uParam4;
}
...
void func_15(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_17(Global_106565.f_18527[iVar0], &vVar2, &fVar5))
			{
...
void func_28()
{
	...
	if (iLocal_175 == 0)
	{
		...
		if (DOES_ENTITY_EXIST(iLocal_48))
		{
			FREEZE_ENTITY_POSITION(iLocal_48, 0);
		}
		...
		if (DOES_ENTITY_EXIST(iLocal_48))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
			{
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_48, 0))
				{
					TASK_LEAVE_VEHICLE(PLAYER_PED_ID(), iLocal_48, 0);
				}
			}
		}
		iLocal_197 = 1;
	...
	if (iLocal_175 == 1)
	{
		if (DOES_ENTITY_EXIST(iLocal_48))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
			{
				if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_48, 1))
				{
					SET_VEHICLE_DOOR_SHUT(iLocal_48, 0, 0);
					SET_VEHICLE_DOOR_SHUT(iLocal_48, 1, 0);
					SET_VEHICLE_DOORS_LOCKED(iLocal_48, 2);
					SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_48, 0);
					FREEZE_ENTITY_POSITION(iLocal_48, 1);
					func_29();
				}
			}
		}
...
void func_34()
{
	switch (iLocal_28)
	{
		case 2:
			...
			{
				if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_55, 0))
				{
					SET_PED_INTO_VEHICLE(PLAYER_PED_ID(), iLocal_55, -1);
				}
			}
			else
			{
				SET_ENTITY_COORDS(PLAYER_PED_ID(), -1565.084f, 2780.813f, 16.4022f, 1, 0, 0, 1);
			...
			if (func_20() == 2)
			{
				if (DOES_ENTITY_EXIST(iLocal_48))
				{
					if (IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
					{
						if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_48, 0))
						{
							SET_PED_INTO_VEHICLE(PLAYER_PED_ID(), iLocal_48, -1);
						}
						FREEZE_ENTITY_POSITION(iLocal_48, 0);
					}
				}
...
void func_36()
{
	...
	{
		case 2:
			CLEAR_AREA(-1588.1f, 2794.9f, 17.2f, 20f, 1, 0, 0, 0);
			...
			if (func_267())
			{
				if (func_107())
				{
					if (!IS_THIS_MODEL_A_HELI(func_106()) && !IS_THIS_MODEL_A_PLANE(func_106()))
					{
						func_104();
						while (!func_103())
						{
			...
			if (!DOES_ENTITY_EXIST(iLocal_48))
			{
				CLEAR_AREA(vLocal_311, 10f, 1, 0, 0, 0);
				iLocal_48 = CREATE_VEHICLE(joaat("cargobob"), vLocal_311, fLocal_323, 1, 1, 0);
				SET_VEHICLE_CAN_BE_TARGETTED(iLocal_48, 0);
				FREEZE_ENTITY_POSITION(iLocal_48, 1);
				SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_48, 1, 1);
				SET_MODEL_AS_NO_LONGER_NEEDED(joaat("cargobob"));
				SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("cargobob"), 1);
				SET_VEHICLE_STRONG(iLocal_48, 1);
				SET_VEHICLE_ENGINE_CAN_DEGRADE(iLocal_48, 0);
			...
			if (!DOES_ENTITY_EXIST(uLocal_49[0]))
			{
				...
				{
					CLEAR_AREA(-1866.446f, 3071.395f, 31.8104f, 10f, 1, 0, 0, 0);
					uLocal_49[0] = CREATE_VEHICLE(joaat("buzzard"), -1866.446f, 3071.395f, 31.8104f, 150.2863f, 1, 1, 0);
					SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_49[0], 1, 1);
					SET_VEHICLE_CAN_BE_TARGETTED(uLocal_49[0], 1);
					SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_49[0], 1084227584);
					_DYNAMIC_MIXER_RELATED_FN(uLocal_49[0], "DH_P_2B_ENEMY_CHOPPERS", 0);
					SET_MODEL_AS_NO_LONGER_NEEDED(joaat("buzzard"));
					SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_49[0], 0);
				}
			}
			if (func_267())
			{
				if (!DOES_ENTITY_EXIST(iLocal_55))
				{
					if (func_107())
					{
						if (!IS_THIS_MODEL_A_HELI(func_106()) && !IS_THIS_MODEL_A_PLANE(func_106()))
						{
							...
							SET_MODEL_AS_NO_LONGER_NEEDED(func_106());
							SET_VEHICLE_HAS_STRONG_AXLES(iLocal_55, 1);
							SET_VEHICLE_STRONG(iLocal_55, 1);
						}
					}
				}
			}
		...
		case 3:
			...
			{
				uLocal_31[0] = CREATE_PED_INSIDE_VEHICLE(uLocal_49[0], 26, joaat("s_m_m_pilot_02"), -1, 1, 1);
				SET_MODEL_AS_NO_LONGER_NEEDED(joaat("s_m_m_pilot_02"));
			}
			else if (!IS_PED_IN_VEHICLE(uLocal_31[0], uLocal_49[0], 0))
			{
				SET_PED_INTO_VEHICLE(uLocal_31[0], uLocal_49[0], -1);
			}
			GIVE_WEAPON_TO_PED(PLAYER_PED_ID(), joaat("gadget_parachute"), -1, 0, 1);
			START_ALARM("PORT_OF_LS_HEIST_FORT_ZANCUDO_ALARMS", 1);
			SET_AMBIENT_ZONE_STATE("AZ_AFB_ALARM_SPEECH", 1, 1);
			break;
		...
		case 4:
			...
			{
				CLEAR_AREA(vLocal_311, 10f, 1, 0, 0, 0);
				iLocal_48 = CREATE_VEHICLE(joaat("cargobob"), -629.1677f, 2871.31f, 385.0313f, 283.1214f, 1, 1, 0);
				SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_48, 1, 1);
				SET_MODEL_AS_NO_LONGER_NEEDED(joaat("cargobob"));
				SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("cargobob"), 1);
				SET_VEHICLE_ENGINE_CAN_DEGRADE(iLocal_48, 0);
				SET_VEHICLE_STRONG(iLocal_48, 1);
				SET_VEHICLE_ENGINE_ON(iLocal_48, 1, 1, 0);
				SET_HELI_BLADES_FULL_SPEED(iLocal_48);
		...
		case 5:
			...
			if (!DOES_ENTITY_EXIST(iLocal_48))
			{
				CLEAR_AREA(1749.61f, 3272.95f, 40.1533f, 5f, 1, 0, 0, 0);
				iLocal_48 = CREATE_VEHICLE(joaat("cargobob"), 1749.61f, 3272.95f, 40.1533f, 51.128f, 1, 1, 0);
				SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_48, 1, 1);
				SET_MODEL_AS_NO_LONGER_NEEDED(joaat("cargobob"));
				SET_VEHICLE_STRONG(iLocal_48, 1);
				SET_VEHICLE_ENGINE_CAN_DEGRADE(iLocal_48, 0);
			...
			if (!DOES_ENTITY_EXIST(uLocal_51[0]))
			{
				uLocal_51[0] = CREATE_VEHICLE(joaat("sandking"), 1754.951f, 3290.994f, 40.1176f, 182.397f, 1, 1, 0);
				FREEZE_ENTITY_POSITION(uLocal_51[0], 1);
...
{
	return func_38(&(Global_100114.f_2890), vParam0, fParam3, 0);
}
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_8(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(uParam0, 1), GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_99()
{
	if (iLocal_201 == 0)
	{
		...
		{
			if (!DOES_ENTITY_EXIST(uLocal_33[0]))
			{
				uLocal_33[0] = CREATE_PED(26, joaat("s_m_y_marine_01"), -1590.523f, 2796.302f, 15.9184f, 247.0896f, 1, 1);
			}
			if (!DOES_ENTITY_EXIST(uLocal_33[1]))
			{
				uLocal_33[1] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2303.8f, 3387.99f, 30.034f, 58.5763f, 1, 1);
			}
			if (!DOES_ENTITY_EXIST(uLocal_33[2]))
			{
				uLocal_33[2] = CREATE_PED(26, joaat("s_m_y_marine_01"), -1697.329f, 2909.941f, 31.9506f, 245.656f, 1, 1);
			}
			if (!DOES_ENTITY_EXIST(uLocal_33[3]))
			{
				uLocal_33[3] = CREATE_PED(26, joaat("s_m_y_marine_01"), -1696.369f, 2905.772f, 31.9454f, 6.3714f, 1, 1);
			}
			if (!DOES_ENTITY_EXIST(uLocal_33[4]))
			{
				uLocal_33[4] = CREATE_PED(26, joaat("s_m_y_marine_01"), -1843.707f, 2821.611f, 31.8528f, 271.6265f, 1, 1);
			}
			if (!DOES_ENTITY_EXIST(uLocal_33[5]))
			{
				uLocal_33[5] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2006.877f, 2955.101f, 31.8103f, 332.0101f, 1, 1);
			}
			if (!DOES_ENTITY_EXIST(uLocal_33[6]))
			{
				uLocal_33[6] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2010.022f, 2956.805f, 31.8103f, 288.1283f, 1, 1);
			}
			if (iLocal_28 != 3)
			{
				if (!DOES_ENTITY_EXIST(uLocal_33[7]))
				{
					uLocal_33[7] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2140.213f, 3034.609f, 31.81f, 302.4493f, 1, 1);
				}
				if (!DOES_ENTITY_EXIST(uLocal_33[8]))
				{
					uLocal_33[8] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2136.053f, 3031.494f, 31.81f, 38.6856f, 1, 1);
				}
			}
			if (!DOES_ENTITY_EXIST(uLocal_33[9]))
			{
				uLocal_33[9] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2035.429f, 3058.876f, 31.8103f, 169.8222f, 1, 1);
			}
			if (!DOES_ENTITY_EXIST(uLocal_33[10]))
			{
				uLocal_33[10] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2146.467f, 3160.749f, 31.8106f, 356.4766f, 1, 1);
			}
			if (!DOES_ENTITY_EXIST(uLocal_33[11]))
			{
				uLocal_33[11] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2280.087f, 3172.423f, 31.8103f, 353.663f, 1, 1);
			}
			if (!DOES_ENTITY_EXIST(uLocal_33[12]))
			{
				uLocal_33[12] = CREATE_PED(26, joaat("s_m_y_marine_01"), -2277.376f, 3177.8f, 31.8103f, 175.0685f, 1, 1);
			}
			if (!DOES_ENTITY_EXIST(uLocal_31[0]))
			{
				uLocal_31[0] = CREATE_PED(26, joaat("s_m_m_pilot_02"), -1859.831f, 3071.758f, 31.8104f, 139.3607f, 1, 1);
				SET_PED_PROP_INDEX(uLocal_31[0], 0, 2, 0, 0);
				SET_PED_COMPONENT_VARIATION(uLocal_31[0], 8, 0, 0, 0);
				SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_31[0], 1, 1);
				GIVE_WEAPON_TO_PED(uLocal_31[0], joaat("weapon_assaultrifle"), 2000, 1, 1);
				SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_31[0], uLocal_60);
				SET_PED_ACCURACY(uLocal_31[0], 0);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_31[0], 1);
			...
			while (iLocal_176 <= 12)
			{
				...
				{
					if (!IS_PED_INJURED(uLocal_33[iLocal_176]))
					{
						SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_33[iLocal_176], 1, 1);
						GIVE_WEAPON_TO_PED(uLocal_33[iLocal_176], joaat("weapon_assaultrifle"), 2000, 1, 1);
						SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_33[iLocal_176], uLocal_60);
						SET_PED_ACCURACY(uLocal_33[iLocal_176], 10);
						func_101(uLocal_33[iLocal_176], 595);
						func_100(uLocal_33[iLocal_176], 0);
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_33[iLocal_176], 1);
...
void func_108(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	func_109(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_109(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, var uParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	var uVar0;
	bool bVar1;
	bool bVar2;
	...
	if (DOES_ENTITY_EXIST(uVar0))
	{
		...
		if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_111(uVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_111(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = { func_113(vParam1 - vParam4) };
		vVar3 = { vVar0 };
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_112(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_112(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_112(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_112(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_112(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_112(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_112(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_112(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_112(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_112(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_112(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_112(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_112(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_112(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_112(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_112(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return 1;
		}
	}
...
void func_115()
{
	if (!func_35())
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			SET_ENTITY_COORDS(PLAYER_PED_ID(), 1738.131f, 3283.38f, 40.1261f, 1, 0, 0, 1);
			SET_ENTITY_HEADING(PLAYER_PED_ID(), 25.3545f);
		}
	}
	if (DOES_ENTITY_EXIST(uLocal_31[0]))
	{
		DELETE_PED(&(uLocal_31[0]));
	}
	iLocal_176 = 0;
	while (iLocal_176 <= 12)
	{
		if (DOES_ENTITY_EXIST(uLocal_33[iLocal_176]))
		{
			DELETE_PED(&(uLocal_33[iLocal_176]));
		}
		iLocal_176++;
	}
	if (func_20() == 2)
	{
		if (DOES_ENTITY_EXIST(uLocal_325[0]))
		{
			DELETE_PED(&(uLocal_325[0]));
		}
	}
	if (func_20() == 0)
	{
		if (DOES_ENTITY_EXIST(uLocal_325[2]))
		{
			DELETE_PED(&(uLocal_325[2]));
		}
	}
	if (DOES_ENTITY_EXIST(uLocal_49[0]))
	{
		_0x18EB48CFC41F2EA0(uLocal_49[0], 0);
	}
	STOP_ALARM("PORT_OF_LS_HEIST_FORT_ZANCUDO_ALARMS", 1);
	SET_AMBIENT_ZONE_STATE("AZ_AFB_ALARM_SPEECH", 0, 0);
	...
	if (DOES_ENTITY_EXIST(uLocal_47))
	{
		DELETE_VEHICLE(&uLocal_47);
	}
	if (DOES_ENTITY_EXIST(iLocal_55))
	{
	...
	if (DOES_ENTITY_EXIST(uLocal_49[0]))
	{
		DELETE_VEHICLE(&(uLocal_49[0]));
	}
	if (DOES_ENTITY_EXIST(Global_90209[0]))
	{
		if (!DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_90209[0], 1))
		{
			SET_ENTITY_AS_MISSION_ENTITY(Global_90209[0], 1, 1);
		}
		DELETE_VEHICLE(&(Global_90209[0]));
	}
	if (DOES_ENTITY_EXIST(Global_90209[1]))
	{
		if (!DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_90209[1], 1))
		{
			SET_ENTITY_AS_MISSION_ENTITY(Global_90209[1], 1, 1);
		}
		DELETE_VEHICLE(&(Global_90209[1]));
	}
	if (DOES_ENTITY_EXIST(Global_90209[2]))
	{
		if (!DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_90209[2], 1))
		{
			SET_ENTITY_AS_MISSION_ENTITY(Global_90209[2], 1, 1);
		}
		DELETE_VEHICLE(&(Global_90209[2]));
	}
	if (DOES_ENTITY_EXIST(uLocal_51[0]))
	{
		DELETE_VEHICLE(&(uLocal_51[0]));
	}
	if (DOES_ENTITY_EXIST(uLocal_58))
	{
		DELETE_OBJECT(&uLocal_58);
	}
	if (DOES_ENTITY_EXIST(uLocal_59))
	{
		DELETE_OBJECT(&uLocal_59);
	}
	if (DOES_CAM_EXIST(uLocal_56))
	{
		if (IS_CAM_ACTIVE(uLocal_56))
		{
			RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
		}
		DESTROY_CAM(uLocal_56, 0);
	}
}
...
void func_116()
{
	...
	if (DOES_BLIP_EXIST(uLocal_62))
	{
		REMOVE_BLIP(&uLocal_62);
	}
	...
	if (DOES_ENTITY_EXIST(iLocal_48))
	{
		if (IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
		{
			if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_48, 0))
			{
				...
				if (iLocal_300 == 1)
				{
					if (GET_GAME_TIMER() < iLocal_189 + 7500)
					{
						CLEAR_PRINTS();
					}
				}
				if (iLocal_28 == 4)
				{
					if (!DOES_BLIP_EXIST(uLocal_62))
					{
						uLocal_62 = func_125(vLocal_314, 0);
					}
					if (iLocal_199 == 0)
					{
						if (!IS_MESSAGE_BEING_DISPLAYED())
						{
							if (!func_124() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
							{
								func_123("DP_GOD4", 7500, 1);
								iLocal_190 = GET_GAME_TIMER();
								iLocal_199 = 1;
							}
						}
					}
			...
			else if (iLocal_28 != 5)
			{
				...
				if (iLocal_28 == 4)
				{
					if (iLocal_199 == 1)
					{
						if (GET_GAME_TIMER() < iLocal_190 + 7500)
						{
							CLEAR_PRINTS();
						}
					}
...
int func_120(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_121(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		SET_BLIP_SCALE(uVar0, func_121(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
var func_125(vector3 vParam0, int iParam3)
{
	var uVar0;
	...
	if (iLocal_175 == 0)
	{
		...
		while (iLocal_176 <= 12)
		{
			if (DOES_ENTITY_EXIST(uLocal_33[iLocal_176]))
			{
				if (!IS_PED_INJURED(uLocal_33[iLocal_176]))
				{
					SET_PED_KEEP_TASK(uLocal_33[iLocal_176], 1);
					SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_33[iLocal_176]));
				}
			}
			iLocal_176++;
		}
		if (DOES_ENTITY_EXIST(uLocal_49[0]))
		{
			SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uLocal_49[0]));
		}
		if (DOES_ENTITY_EXIST(uLocal_31[0]))
		{
			SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_31[0]));
		}
		if (!IS_AUDIO_SCENE_ACTIVE("DH_P_2B_ENTER_CHOPPER"))
		{
	...
	if (iLocal_175 == 1)
	{
		if (iLocal_308 == 0)
		{
			if (DOES_ENTITY_EXIST(iLocal_48))
			{
				if (IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
				{
					if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_48, 0))
					{
						if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_311, 1) > 800f)
						{
						...
						if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_311, 1) > 800f)
						{
							if (iLocal_304 == 0 && iLocal_199 == 1)
							{
								if (!IS_MESSAGE_BEING_DISPLAYED())
								{
									if (!func_124() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
									{
										func_143(&uLocal_403, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
		...
		if (DOES_ENTITY_EXIST(iLocal_48))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
			{
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_48, 0))
				{
					if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_314, 2f, 2f, 2f, 1, 1, 0))
					{
					}
					if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1721.001f, 3264.248f, 38.40064f, 1765.509f, 3276.518f, 46.05385f, 48.25f, 0, 1, 0))
					{
...
void func_144(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_218(GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_211(GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
			...
			{
				iVar10 = func_209(&(Global_93682.f_3));
				if (iVar10 > -1)
				{
...
{
	func_146(&Global_100114, GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_146(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_20();
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		func_170(PLAYER_PED_ID());
		func_163(PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_162())
		{
			func_155(PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_91043[iVar0]))
		{
			if (Global_91043[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || GET_ENTITY_MODEL(iParam0) == func_71(iParam1, iParam2))
					{
						return 1;
					}
				}
...
int func_156(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2539502[iParam0 /*3*/][func_157(iParam1)];
...
void func_164(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_169(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_166(Var11.f_1)) && iVar72 < 51)
			{
...
void func_170(var uParam0)
{
	...
	if (func_23(iVar0) && !IS_PED_INJURED(uParam0))
	{
...
int func_172(vector3 vParam0, char* sParam3, vector3 vParam4)
{
	int iVar0;
	int iVar1;
...
int func_174(var uParam0)
{
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (func_197())
		{
			*uParam0 = func_180(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_176(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_178() == 0)
		{
			return IS_BIT_SET(func_156(func_177(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_180(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_196(iVar0))
		{
			...
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_181(iVar0, 0), 1);
...
var func_198()
{
	...
	func_201(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_200(&uVar0, GET_CLOCK_MONTH());
	func_199(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SHIFT_RIGHT(uParam0, 26) & 31 * func_204(IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_213(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
void func_223()
{
	if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_314, 1) < 500f)
	{
		if (iLocal_214 == 0)
		{
			if (!DOES_ENTITY_EXIST(uLocal_51[0]))
	...
	{
		if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_314, 1) > 550f)
		{
			if (DOES_ENTITY_EXIST(uLocal_51[0]))
			{
				DELETE_VEHICLE(&(uLocal_51[0]));
...
void func_224()
{
	if (iLocal_175 > 0)
	{
		...
		while (iLocal_176 <= 12)
		{
			if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_48, 0))
			{
				func_227(uLocal_33[iLocal_176], &(Local_70[iLocal_176 /*8*/]), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1);
			}
			else
			{
				func_117(&(Local_70[iLocal_176 /*8*/]));
	...
	if (iLocal_175 == 1)
	{
		if (iLocal_206[0] == 1)
		{
			...
			if (DOES_ENTITY_EXIST(iLocal_48))
			{
				if (IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
				{
					if (IS_ENTITY_IN_ANGLED_AREA(iLocal_48, 1721.001f, 3264.248f, 38.40064f, 1765.509f, 3276.518f, 46.05385f, 48.25f, 0, 1, 0))
					{
						if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_48, 0))
						{
							SET_PLAYER_WANTED_LEVEL(PLAYER_ID(), 0, 0);
		...
		else if (iLocal_209 == 0)
		{
			if (DOES_ENTITY_EXIST(iLocal_48))
			{
				if (IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
				{
					if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_48, 0))
					{
						if (GET_GAME_TIMER() > iLocal_183 + 10000)
						{
							if (!IS_MESSAGE_BEING_DISPLAYED())
							{
...
int func_227(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
void func_228()
{
	uLocal_53 = GET_CLOSEST_VEHICLE(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 300f, joaat("lazer"), 4);
	uLocal_54 = GET_CLOSEST_VEHICLE(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 300f, joaat("lazer"), 16386);
	if (DOES_ENTITY_EXIST(uLocal_53) && IS_ENTITY_IN_AIR(uLocal_53))
	{
		if (!DOES_BLIP_EXIST(uLocal_65))
		{
			uLocal_65 = ADD_BLIP_FOR_ENTITY(uLocal_53);
			SET_BLIP_AS_FRIENDLY(uLocal_65, 0);
		}
	}
	if (DOES_ENTITY_EXIST(uLocal_54) && IS_ENTITY_IN_AIR(uLocal_54))
	{
		if (!DOES_BLIP_EXIST(uLocal_66))
		{
			uLocal_66 = ADD_BLIP_FOR_ENTITY(uLocal_54);
...
void func_229()
{
	if (iLocal_28 == 3)
	{
		if (DOES_ENTITY_EXIST(iLocal_48))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
			{
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_48, 0))
				{
					vLocal_320 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
					if (DOES_ENTITY_EXIST(uLocal_49[0]))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
						{
							if (DOES_ENTITY_EXIST(uLocal_31[0]))
							{
								if (!IS_PED_INJURED(uLocal_31[0]))
								{
									if (func_2(PLAYER_PED_ID(), uLocal_31[0], 1) < 600f)
									{
										if (GET_DISTANCE_BETWEEN_COORDS(vLocal_320, -75.8f, -819.9f, 326f, 1) > 1600f && GET_DISTANCE_BETWEEN_COORDS(vLocal_320, -2159f, 3067f, 33f, 1) < 1000f)
										{
											if (vLocal_320.z > 70f)
											{
												if (iLocal_30 != 2)
										...
										{
											if (GET_DISTANCE_BETWEEN_COORDS(vLocal_320, -75.8f, -819.9f, 326f, 1) < 1600f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_215[0] = 1;
											...
											if (GET_DISTANCE_BETWEEN_COORDS(vLocal_320, -2159f, 3067f, 33f, 1) > 1000f)
											{
												if (iLocal_30 != 3)
												{
													iLocal_215[0] = 1;
				...
				else if (GET_DISTANCE_BETWEEN_COORDS(vLocal_320, -75.8f, -819.9f, 326f, 1) > 1600f)
				{
					if (iLocal_30 != 0)
					{
						iLocal_215[0] = 1;
			...
			if (DOES_ENTITY_EXIST(uLocal_49[0]))
			{
				if (IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
				{
					if (DOES_ENTITY_EXIST(uLocal_31[0]))
					{
						if (!IS_PED_INJURED(uLocal_31[0]))
						{
							if (func_2(PLAYER_PED_ID(), uLocal_31[0], 1) < 200f)
							{
								vLocal_317 = { GET_ENTITY_COORDS(uLocal_49[0], 1) };
								CLEAR_PED_TASKS(uLocal_31[0]);
								SET_PED_SPHERE_DEFENSIVE_AREA(uLocal_31[0], vLocal_317, 10f, 0, 0);
								TASK_COMBAT_HATED_TARGETS_AROUND_PED(uLocal_31[0], 250f, 0);
								iLocal_202[0] = 1;
							}
						}
					}
				...
				if (IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
				{
					if (DOES_ENTITY_EXIST(uLocal_31[0]))
					{
						if (!IS_PED_INJURED(uLocal_31[0]))
						{
							...
							if (!IS_PED_IN_VEHICLE(uLocal_31[0], uLocal_49[0], 0))
							{
								TASK_ENTER_VEHICLE(0, uLocal_49[0], 20000, -1, 1073741824, 1, 0);
							}
							TASK_HELI_MISSION(0, uLocal_49[0], 0, 0, vLocal_317.x, vLocal_317.y, (vLocal_317.z + 20f), 4, 30f, 10f, -1f, 170, 40, -1082130432, 0);
							TASK_HELI_MISSION(0, uLocal_49[0], 0, PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 40, -1082130432, 0);
							CLOSE_SEQUENCE_TASK(uLocal_572);
							TASK_PERFORM_SEQUENCE(uLocal_31[0], uLocal_572);
			...
			if (IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
			{
				if (DOES_ENTITY_EXIST(uLocal_31[0]))
				{
					if (!IS_PED_INJURED(uLocal_31[0]))
					{
						if (IS_PED_IN_VEHICLE(uLocal_31[0], uLocal_49[0], 0))
						{
							if (GET_GAME_TIMER() > (iLocal_188 + 90000))
							{
								if (iLocal_297 == 0)
								{
									SET_PED_ACCURACY(uLocal_31[0], 100);
									iLocal_296 = 0;
									iLocal_297 = 1;
								}
							}
							else if (GET_GAME_TIMER() > iLocal_188 + 10000 && !IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_48, 0))
							{
								if (iLocal_297 == 0)
								{
									SET_PED_ACCURACY(uLocal_31[0], 100);
							...
							if (func_2(uLocal_49[0], PLAYER_PED_ID(), 1) < 300f)
							{
								if (iLocal_299 == 0)
								{
									SET_CURRENT_PED_VEHICLE_WEAPON(uLocal_31[0], joaat("vehicle_weapon_space_rocket"));
									SET_PED_FIRING_PATTERN(uLocal_31[0], -1857128337);
									iLocal_298 = 0;
									iLocal_299 = 1;
								}
							}
							...
							{
								SET_CURRENT_PED_VEHICLE_WEAPON(uLocal_31[0], joaat("vehicle_weapon_player_buzzard"));
								SET_PED_FIRING_PATTERN(uLocal_31[0], 1566631136);
								iLocal_299 = 0;
								iLocal_298 = 1;
							}
						}
					...
					if (DOES_ENTITY_EXIST(uLocal_49[0]))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
						{
							if (DOES_ENTITY_EXIST(uLocal_31[0]))
							{
								if (!IS_PED_INJURED(uLocal_31[0]))
								{
									TASK_HELI_MISSION(uLocal_31[0], uLocal_49[0], 0, PLAYER_PED_ID(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 15, 10, -1082130432, 0);
									iLocal_215[0] = 0;
								}
							}
						}
					...
					if (DOES_ENTITY_EXIST(uLocal_49[0]))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
						{
							if (DOES_ENTITY_EXIST(uLocal_31[0]))
							{
								if (!IS_PED_INJURED(uLocal_31[0]))
								{
									TASK_HELI_MISSION(uLocal_31[0], uLocal_49[0], 0, PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 50, 20, -1082130432, 0);
									iLocal_215[0] = 0;
								}
							}
						}
					...
					if (DOES_ENTITY_EXIST(uLocal_49[0]))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
						{
							if (DOES_ENTITY_EXIST(uLocal_31[0]))
							{
								if (!IS_PED_INJURED(uLocal_31[0]))
								{
									TASK_HELI_MISSION(uLocal_31[0], uLocal_49[0], 0, PLAYER_PED_ID(), 0f, 0f, 0f, 6, 40f, 20f, -1f, 170, 70, -1082130432, 0);
									iLocal_215[0] = 0;
								}
							}
						}
					...
					if (DOES_ENTITY_EXIST(uLocal_49[0]))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
						{
							if (DOES_ENTITY_EXIST(uLocal_31[0]))
							{
								if (!IS_PED_INJURED(uLocal_31[0]))
								{
									TASK_HELI_MISSION(uLocal_31[0], uLocal_49[0], 0, 0, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_49[0], 20f, 0f, 0f), 4, 10f, 10f, GET_ENTITY_HEADING(uLocal_49[0]), ROUND(GET_ENTITY_HEIGHT(uLocal_49[0], GET_ENTITY_COORDS(uLocal_49[0], 1), 1, 1)), 100, -1082130432, 0);
									iLocal_215[0] = 0;
								}
							}
						}
						...
						if (DOES_ENTITY_EXIST(uLocal_49[0]))
						{
							if (IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
							{
								if (DOES_ENTITY_EXIST(uLocal_31[0]))
								{
									if (!IS_PED_INJURED(uLocal_31[0]))
									{
										TASK_HELI_MISSION(uLocal_31[0], uLocal_49[0], 0, PLAYER_PED_ID(), 0f, 0f, 0f, 6, 20f, 20f, -1f, 170, 70, -1082130432, 0);
										iLocal_295 = 1;
									}
								}
							}
					...
					if (DOES_ENTITY_EXIST(uLocal_49[0]))
					{
						if (IS_VEHICLE_DRIVEABLE(uLocal_49[0], 0))
						{
							if (DOES_ENTITY_EXIST(uLocal_31[0]))
							{
								if (!IS_PED_INJURED(uLocal_31[0]))
								{
									TASK_HELI_MISSION(uLocal_31[0], uLocal_49[0], 0, PLAYER_PED_ID(), 0f, 0f, 0f, 8, 40f, 50f, -1f, 200, 170, -1082130432, 0);
									iLocal_215[0] = 0;
								}
							}
						}
	...
	if (DOES_ENTITY_EXIST(uLocal_31[0]))
	{
		if (!IS_PED_INJURED(uLocal_31[0]))
		{
			if (IS_ENTITY_IN_WATER(uLocal_31[0]))
			{
				CLEAR_PED_TASKS(uLocal_31[0]);
				SET_ENTITY_HEALTH(uLocal_31[0], 0, 0);
				if (DOES_BLIP_EXIST(uLocal_63[0]))
				{
					REMOVE_BLIP(&(uLocal_63[0]));
				}
...
void func_230()
{
	if (iLocal_210 == 0)
	{
		if ((((func_231(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 3, 0, 0) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1601.514f, 2794.148f, 14.84222f, -1587.692f, 2806.101f, 20.29557f, 16f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1598.278f, 2803.98f, 17.01772f, -1665.98f, 2895.398f, 34.58953f, 14.5f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1648.554f, 2873.74f, 24.85017f, -1673.864f, 2889.698f, 38.18856f, 14.5f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1647.446f, 2873.969f, 24.82373f, -1667.316f, 2914.302f, 39.39478f, 14.5f, 0, 1, 0))
		{
			iLocal_210 = 1;
		}
	}
	...
	if (iLocal_201 == 1)
	{
				...
				if (DOES_ENTITY_EXIST(uLocal_33[iLocal_176]))
				{
					if (!IS_PED_INJURED(uLocal_33[iLocal_176]))
					{
						if (DOES_ENTITY_EXIST(iLocal_48))
						{
							if (IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
							{
								if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_48, 0) || iLocal_212 == 1)
								{
									if (func_2(PLAYER_PED_ID(), uLocal_33[iLocal_176], 1) < 39f)
									{
										if (iLocal_217[iLocal_176] == 0)
										{
											CLEAR_PED_TASKS(uLocal_33[iLocal_176]);
											SET_PED_SPHERE_DEFENSIVE_AREA(uLocal_33[iLocal_176], GET_ENTITY_COORDS(uLocal_33[iLocal_176], 1), 50f, 0, 0);
											TASK_COMBAT_PED(uLocal_33[iLocal_176], PLAYER_PED_ID(), 0, 16);
											SET_PED_COMBAT_ATTRIBUTES(uLocal_33[iLocal_176], 51, 1);
											SET_PED_COMBAT_ATTRIBUTES(uLocal_33[iLocal_176], 43, 1);
									...
									else if (iLocal_231[iLocal_176] == 0)
									{
										CLEAR_PED_TASKS(uLocal_33[iLocal_176]);
										OPEN_SEQUENCE_TASK(&uLocal_572);
										TASK_FOLLOW_NAV_MESH_TO_COORD(0, GET_ENTITY_COORDS(iLocal_48, 1), 2f, -1, 20f, 0, 1193033728);
										TASK_COMBAT_PED(0, PLAYER_PED_ID(), 0, 16);
										CLOSE_SEQUENCE_TASK(uLocal_572);
										TASK_PERFORM_SEQUENCE(uLocal_33[iLocal_176], uLocal_572);
										CLEAR_SEQUENCE_TASK(&uLocal_572);
										iLocal_245[iLocal_176] = 0;
										iLocal_259[iLocal_176] = 0;
								...
								else
								{
									...
									if (func_2(PLAYER_PED_ID(), uLocal_33[iLocal_176], 1) > 41f && func_2(PLAYER_PED_ID(), uLocal_33[iLocal_176], 1) < 400f)
									{
										if (iLocal_259[iLocal_176] == 0)
										{
											iLocal_195 = GET_RANDOM_INT_IN_RANGE(0, 4);
											CLEAR_PED_TASKS(uLocal_33[iLocal_176]);
											SET_PED_SPHERE_DEFENSIVE_AREA(uLocal_33[iLocal_176], GET_ENTITY_COORDS(uLocal_33[iLocal_176], 1), 50f, 0, 0);
											OPEN_SEQUENCE_TASK(&uLocal_572);
											if (iLocal_195 == 0)
											{
												TASK_GO_TO_ENTITY(0, PLAYER_PED_ID(), -1, 25f, 1073741824, 1073741824, 0);
											}
											...
											{
												TASK_GO_TO_ENTITY(0, PLAYER_PED_ID(), -1, 25f, 3f, 1073741824, 0);
											}
		...
		if (((iLocal_210 == 0 && iLocal_289 == 0) && iLocal_302 == 0) && iLocal_211 == 0)
		{
			...
			while (iLocal_193 <= 1)
			{
				if (DOES_ENTITY_EXIST(uLocal_33[iLocal_193]))
				{
					if (!IS_PED_INJURED(uLocal_33[iLocal_193]))
					{
						if (func_2(uLocal_33[iLocal_193], PLAYER_PED_ID(), 1) < 25f)
						{
							if (iLocal_292[iLocal_193] == 0)
							{
								if (!IS_ENTITY_ON_SCREEN(uLocal_33[iLocal_193]))
								{
									CLEAR_PED_TASKS_IMMEDIATELY(uLocal_33[iLocal_193]);
								}
								else
								{
									CLEAR_PED_TASKS(uLocal_33[iLocal_193]);
								}
								TASK_AIM_GUN_AT_ENTITY(uLocal_33[iLocal_193], PLAYER_PED_ID(), -1, 0);
								iLocal_292[iLocal_193] = 1;
							}
							if (iLocal_303 == 1)
							{
								if (GET_GAME_TIMER() > iLocal_191 + 20000)
								{
									iLocal_302 = 1;
								}
							}
						}
						else if (func_2(uLocal_33[iLocal_193], PLAYER_PED_ID(), 1) > 30f)
						{
...
int func_231(vector3 vParam0, int iParam3, int iParam4, bool bParam5)
{
	vector3 vVar0[15];
	vector3 vVar46[15];
	float fVar92[15];
...
void func_232()
{
	...
	if (iLocal_175 == 0)
	{
		...
		SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("lazer"), 1);
		REQUEST_MODEL(joaat("s_m_y_marine_01"));
		REQUEST_MODEL(joaat("s_m_m_pilot_02"));
		if (!DOES_ENTITY_EXIST(iLocal_48))
		{
		...
		if (!DOES_ENTITY_EXIST(uLocal_49[0]))
		{
			if (DOES_ENTITY_EXIST(Global_90209[1]))
			{
				...
				{
					SET_ENTITY_AS_MISSION_ENTITY(Global_90209[1], 1, 1);
					uLocal_49[0] = Global_90209[1];
					SET_VEHICLE_CAN_BE_TARGETTED(uLocal_49[0], 1);
					SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_49[0], 1, 1);
					FREEZE_ENTITY_POSITION(uLocal_49[0], 0);
					_DYNAMIC_MIXER_RELATED_FN(uLocal_49[0], "DH_P_2B_ENEMY_CHOPPERS", 0);
					SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_49[0], 0);
				}
			}
		...
		if (DOES_ENTITY_EXIST(Global_90209[2]))
		{
			...
			{
				if (IS_THIS_MODEL_A_HELI(GET_ENTITY_MODEL(Global_90209[2])))
				{
					SET_ENTITY_AS_MISSION_ENTITY(Global_90209[2], 1, 1);
					func_240(1734.799f, 3234.833f, 40.7041f, 321.0399f, 0, 145);
				}
				if (((IS_THIS_MODEL_A_CAR(GET_ENTITY_MODEL(Global_90209[2])) || IS_THIS_MODEL_A_BIKE(GET_ENTITY_MODEL(Global_90209[2]))) || IS_THIS_MODEL_A_BICYCLE(GET_ENTITY_MODEL(Global_90209[2]))) || IS_THIS_MODEL_A_QUADBIKE(GET_ENTITY_MODEL(Global_90209[2])))
				{
					SET_ENTITY_AS_MISSION_ENTITY(Global_90209[2], 1, 1);
		...
		if (IS_SCREEN_FADED_OUT())
		{
			...
			func_221(iLocal_55, -1, 1);
		}
		if (!IS_SCREEN_FADED_IN())
		{
			DO_SCREEN_FADE_IN(800);
		}
		func_239(PLAYER_PED_ID(), -1);
		func_238(73);
		iLocal_197 = 1;
		iLocal_175 = 1;
	}
	if (iLocal_175 == 1)
	{
		if (DOES_SCENARIO_GROUP_EXIST("ARMY_GUARD"))
		{
			...
			{
				SET_SCENARIO_GROUP_ENABLED("ARMY_GUARD", 0);
			}
		}
		func_99();
		if (iLocal_211 == 0)
		{
			if (GET_GAME_TIMER() > iLocal_182 + 3000)
			{
				iLocal_184 = 0;
				while (iLocal_184 <= 12)
				{
					if (DOES_ENTITY_EXIST(uLocal_33[iLocal_184]))
					{
						if (!IS_PED_INJURED(uLocal_33[iLocal_184]))
						{
							if (func_2(PLAYER_PED_ID(), uLocal_33[iLocal_184], 1) < 40f)
							{
								if (_CAN_PED_SEE_PED(uLocal_33[iLocal_184], PLAYER_PED_ID()))
								{
									if (IS_PED_JACKING(PLAYER_PED_ID()))
									{
										START_ALARM("PORT_OF_LS_HEIST_FORT_ZANCUDO_ALARMS", 0);
										SET_AMBIENT_ZONE_STATE("AZ_AFB_ALARM_SPEECH", 1, 1);
										iLocal_211 = 1;
									}
									if (iLocal_210 == 1)
									...
									if (iLocal_307 == 0)
									{
										if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !func_237(0))
										{
											if (func_236(PLAYER_PED_ID()) != joaat("weapon_unarmed"))
											{
												iLocal_194 = GET_GAME_TIMER();
												iLocal_307 = 1;
											}
										}
									}
									else if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !func_237(0))
									{
										if (func_236(PLAYER_PED_ID()) != joaat("weapon_unarmed"))
										{
											if (GET_GAME_TIMER() > iLocal_194 + 3000)
											{
												START_ALARM("PORT_OF_LS_HEIST_FORT_ZANCUDO_ALARMS", 0);
												SET_AMBIENT_ZONE_STATE("AZ_AFB_ALARM_SPEECH", 1, 1);
												iLocal_211 = 1;
		...
		if (DOES_ENTITY_EXIST(iLocal_48))
		{
			if (IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
			{
				if (func_2(PLAYER_PED_ID(), iLocal_48, 1) < 30f)
				{
					iLocal_212 = 1;
				}
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_48, 0))
...
{
	CLEAR_BIT(&Global_89567, iParam0);
}
...
void func_240(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	vector3 vVar0;
	var uVar3;
	...
	if (DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_249(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_246(GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_241(Global_97130.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_241(int iParam0, vector3 vParam1, var uParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (DOES_ENTITY_EXIST(iParam0) && IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_243(iParam5, &Var0, vParam1, uParam4, func_60(iParam0));
		func_242(iParam5, iParam0, 0);
	}
}
...
void func_243(int iParam0, var uParam1, vector3 vParam2, var uParam5, int iParam6)
{
	if (func_70(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
...
int func_246(vector3 vParam0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;
	
	iVar0 = func_247(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
void func_250()
{
	if (iLocal_175 == 0)
	{
		...
		func_254(4, 0);
		func_254(12, 0);
		ADD_RELATIONSHIP_GROUP("MarineGroupHash", &uLocal_60);
		SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_60, 1862763509);
		SET_RELATIONSHIP_BETWEEN_GROUPS(5, -472287501, 1862763509);
		SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_60, -472287501);
		SET_RELATIONSHIP_BETWEEN_GROUPS(1, -472287501, uLocal_60);
		SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, uLocal_60);
		SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_60, -1533126372);
		...
		if (func_267())
		{
			if (Global_87889 == 1)
			{
				if (func_253() == 0)
				{
					func_252(vLocal_311, fLocal_323, 1, 0);
					iLocal_196 = 1;
					iLocal_175 = 0;
					iLocal_28 = 3;
				}
...
void func_251()
{
	...
	SET_ENTITY_COORDS(PLAYER_PED_ID(), 1747.04f, 3267.456f, 40.246f, 1, 0, 0, 1);
	...
	if (!DOES_ENTITY_EXIST(iLocal_48))
	{
		...
		iLocal_48 = CREATE_VEHICLE(joaat("cargobob"), 1740.852f, 3263.161f, 40.2743f, 280.3712f, 1, 1, 0);
		SET_VEHICLE_DOOR_SHUT(iLocal_48, 0, 1);
		SET_VEHICLE_DOOR_SHUT(iLocal_48, 1, 1);
		SET_VEHICLE_DOORS_LOCKED(iLocal_48, 2);
		SET_VEHICLE_STRONG(iLocal_48, 1);
		FREEZE_ENTITY_POSITION(iLocal_48, 1);
		SET_VEHICLE_ENGINE_CAN_DEGRADE(iLocal_48, 0);
...
void func_252(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	if (func_267())
	{
...
{
	_0x9B2BD3773123EA2F(iParam0, !bParam1);
	...
	if (DOES_ENTITY_EXIST(iLocal_48))
	{
		if (IS_VEHICLE_DRIVEABLE(iLocal_48, 0))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_48, 0))
				{
					if (IS_PED_SITTING_IN_VEHICLE(PLAYER_PED_ID(), iLocal_48))
					{
						if (func_257(PLAYER_PED_ID(), iLocal_48) == -1)
						{
...
void func_258()
{
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		{
			if (func_231(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 3, 200, 0) || iLocal_211 == 1)
			{
		...
		if (iLocal_28 == 4)
		{
			if (GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) != 0 && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_311, 1) > 1000f)
			{
				SET_PLAYER_WANTED_LEVEL(PLAYER_ID(), 0, 0);
				SET_PLAYER_WANTED_LEVEL_NOW(PLAYER_ID(), 0);
			}
...
void func_260()
{
	if (iLocal_289 == 0)
	{
		...
		while (iLocal_185 <= 12)
		{
			if (DOES_ENTITY_EXIST(uLocal_33[iLocal_185]))
			{
				if (!IS_PED_INJURED(uLocal_33[iLocal_185]))
				{
					if (_CAN_PED_SEE_PED(uLocal_33[iLocal_185], PLAYER_PED_ID()))
					{
						if (func_2(uLocal_33[iLocal_185], PLAYER_PED_ID(), 1) < 40f)
						{
						...
						if (func_2(uLocal_33[iLocal_185], PLAYER_PED_ID(), 1) < 25f)
						{
							if (func_236(PLAYER_PED_ID()) != joaat("weapon_unarmed"))
							{
								if (func_265(uLocal_33[iLocal_185], 6))
								{
									iLocal_289 = 1;
								}
							}
	...
	if (iLocal_210 == 0)
	{
		...
		while (iLocal_192 <= 1)
		{
			if (DOES_ENTITY_EXIST(uLocal_33[iLocal_192]))
			{
				if (!IS_PED_INJURED(uLocal_33[iLocal_192]))
				{
					if (iLocal_290 == 0 && iLocal_291 == 0)
					{
						if (!func_124())
						{
							if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
							{
								if (func_2(PLAYER_PED_ID(), uLocal_33[iLocal_192], 1) < 25f)
								{
									if (_CAN_PED_SEE_PED(uLocal_33[iLocal_192], PLAYER_PED_ID()))
									{
										if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !func_237(0))
										{
											if (func_236(PLAYER_PED_ID()) != joaat("weapon_unarmed"))
											{
												if (DOES_ENTITY_EXIST(uLocal_33[0]))
												{
													if (!IS_PED_INJURED(uLocal_33[0]))
													{
														if (func_2(PLAYER_PED_ID(), uLocal_33[0], 1) < 30f)
														{
												...
												if (DOES_ENTITY_EXIST(uLocal_33[1]))
												{
													if (!IS_PED_INJURED(uLocal_33[1]))
													{
														if (func_2(PLAYER_PED_ID(), uLocal_33[1], 1) < 30f)
														{
							...
							if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
							{
								if (func_2(PLAYER_PED_ID(), uLocal_33[iLocal_192], 1) < 25f)
								{
									if (_CAN_PED_SEE_PED(uLocal_33[iLocal_192], PLAYER_PED_ID()))
									{
										if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
										{
											if (func_236(PLAYER_PED_ID()) == joaat("weapon_unarmed") || func_237(0))
											{
												if (DOES_ENTITY_EXIST(uLocal_33[0]))
												{
													if (!IS_PED_INJURED(uLocal_33[0]))
					...
					if (iLocal_290 == 1 || iLocal_291 == 1)
					{
						if (iLocal_289 == 0 && iLocal_210 == 0)
						{
							if (iLocal_310 == 0)
							{
								if (GET_GAME_TIMER() > iLocal_186 + 8000)
								{
									if (!func_124())
									{
										if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
							...
							if (GET_GAME_TIMER() > iLocal_187 + 8000)
							{
								if (!func_124())
								{
									if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
	...
	if (GET_GAME_TIMER() > iLocal_177 + 12000)
	{
		if (iLocal_210 == 1 || iLocal_289 == 1)
		{
			if (!IS_MESSAGE_BEING_DISPLAYED() || !IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
			{
				if (!func_124())
				{
					if (func_264())
					{
						iLocal_181 = GET_RANDOM_INT_IN_RANGE(0, 6);
						if (iLocal_181 == 0)
						{
...
{
	_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_262(iParam2), 1);
}
...
int func_263()
{
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		GET_CLOSEST_PED(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 30f, 0, 1, &iVar0, 0, 1, -1);
	}
	iLocal_179 = 0;
	while (iLocal_179 <= 9)
	{
		if (DOES_ENTITY_EXIST(uLocal_33[iLocal_179]))
		{
			if (!IS_PED_INJURED(uLocal_33[iLocal_179]))
			{
...
int func_264()
{
	...
	while (iLocal_180 <= 9)
	{
		if (DOES_ENTITY_EXIST(uLocal_33[iLocal_180]))
		{
			if (!IS_PED_INJURED(uLocal_33[iLocal_180]))
			{
				if (func_2(PLAYER_PED_ID(), uLocal_33[iLocal_180], 1) < 25f)
				{
					return 1;
				}
			}
...
void func_266()
{
	if (DOES_SCENARIO_GROUP_EXIST("ARMY_HELI"))
	{
		...
		{
			SET_SCENARIO_GROUP_ENABLED("ARMY_HELI", 0);
		}
	}
}
...
void func_268()
{
	...
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-2024.2f, 2968f, 30.2f, -2004f, 2921.5f, 37.6f, 0, 1);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-2133.3f, 2993.7f, 41.1f, -2152.7f, 3039.4f, 31.6f, 0, 1);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-1884.6f, 2827.7f, 41.8f, -1843.1f, 2772.1f, 29.9f, 0, 1);
	uLocal_67 = ADD_SCENARIO_BLOCKING_AREA(-1884.6f, 2827.7f, 41.8f, -1843.1f, 2772.1f, 29.9f, 0, 1, 1, 1);
	uLocal_69 = ADD_SCENARIO_BLOCKING_AREA(-2168.3f, 3223.6f, 52.8f, -2156.2f, 3205f, 29f, 0, 1, 1, 1);
	CLEAR_AREA(-1876.8f, 2806.1f, 32.3f, 8f, 1, 0, 0, 0);
	CLEAR_AREA(-1857.7f, 2797.9f, 32.4f, 8f, 1, 0, 0, 0);
	SET_AUDIO_FLAG("WantedMusicOnMission", 1);
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("buzzard"), 1);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-2195.3f, 3231.1f, 41.4f, -2164.1f, 3250.5f, 29f, 0, 1);
	REMOVE_VEHICLES_FROM_GENERATORS_IN_AREA(-2195.3f, 3231.1f, 41.4f, -2164.1f, 3250.5f, 29f, 0);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-2050.8f, 3139.5f, 41f, -2018.5f, 3160f, 27f, 0, 1);
...
{
	func_271();
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("cargobob"), 0);
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("buzzard"), 0);
	SET_POLICE_RADAR_BLIPS(1);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-2195.3f, 3231.1f, 41.4f, -2164.1f, 3250.5f, 29f, 1, 1);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-2050.8f, 3139.5f, 41f, -2018.5f, 3160f, 27f, 1, 1);
	_0x0A436B8643716D14();
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_67, 0);
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_68, 0);
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_69, 0);
	func_254(1, 1);
	func_254(2, 1);
	func_254(7, 1);
	func_254(8, 1);
	...
	if (DOES_SCENARIO_GROUP_EXIST("ARMY_GUARD"))
	{
		if (!IS_SCENARIO_GROUP_ENABLED("ARMY_GUARD"))
		{
			SET_SCENARIO_GROUP_ENABLED("ARMY_GUARD", 1);
		}
	}
	STOP_ALARM("PORT_OF_LS_HEIST_FORT_ZANCUDO_ALARMS", 1);
	SET_AMBIENT_ZONE_STATE("AZ_AFB_ALARM_SPEECH", 0, 0);
	...
	if (DOES_SCENARIO_GROUP_EXIST("ARMY_HELI"))
	{
		if (!IS_SCENARIO_GROUP_ENABLED("ARMY_HELI"))
		{
			SET_SCENARIO_GROUP_ENABLED("ARMY_HELI", 1);
		}
	}
	REMOVE_RELATIONSHIP_GROUP(uLocal_60);
