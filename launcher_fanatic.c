	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_104307[Var0 /*10*/].f_9 != -1)
			{
				...
				func_284(&(Global_104307[Var0 /*10*/].f_9));
			}
		}
		func_269(&Var0, 1);
	}
	...
	switch (iParam0->f_16)
	{
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (func_193(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)))
					{
...
void func_183(int iParam0, void fParam1, void fParam2, int iParam3)
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, fParam1, fParam2, func_184(iParam3), 0);
}
...
int func_185(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_193(PLAYER::PLAYER_PED_ID()) && func_193(iParam0->f_28[0])) && !func_142()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_189(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_190(int iParam0, vector3 vParam1, char[4] cParam2, void fParam3, int iParam4, char* sParam5, int iParam6)
{
	var uVar0;
	...
	if (func_173(2))
	{
		if (!func_142())
		{
			if (((func_193(PLAYER::PLAYER_PED_ID()) && func_193(iParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_189(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_188(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
				func_186(&uVar0, cParam2, fParam3, 7, 0, 0);
				iParam0->f_60 = MISC::GET_GAME_TIMER();
				return 1;
			}
		}
		else if (func_191(fParam3))
		{
			if (func_193(PLAYER::PLAYER_PED_ID()))
			{
				if (func_189(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
				{
					func_140();
				}
			}
...
void func_194(int iParam0, void fParam1, vector3 vParam2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
int func_202(var uParam0, bool bParam1)
{
	...
	if ((func_239(*uParam0) || func_237(*uParam0)) || Global_71223 == 1)
	{
		return 1;
	}
	if (!TASK::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
int func_214(int iParam0, float fParam1)
{
	...
	if (func_193(PLAYER::PLAYER_PED_ID()) && func_193(iParam0))
	{
...
int func_217(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
int func_220(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_222(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_222(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_221(vector3 vParam0, vector3 vParam1)
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_222(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
int func_229(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_222(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
{
	if ((func_238() && Global_92955.f_11 == 6) && iParam0 == func_161(&(Global_92955.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_243(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
...
int func_244(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_253(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)
{
	func_254(iParam0);
...
bool func_260(int iParam0, void fParam1)
{
