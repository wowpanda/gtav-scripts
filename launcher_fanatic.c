...
void func_183(int iParam0, char* sParam1, char* sParam2, int iParam3)
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_184(iParam3), 0);
}
...
int func_190(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	var uVar0;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_205(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_205(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_220(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_222(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_229(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_222(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
