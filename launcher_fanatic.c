...
void __EntryFunction__()
{
	...
	while (true)
	{
			...
			if (Var0 == 22)
			{
				if (_0xB56BBBCC2955D9CB())
				{
					if (func_196(Var0.f_28[1]))
					{
						...
						_0x2A56C06EBEF2B0D9("MaryAnnes_Friend", Var0.f_28[1], 0);
		...
		if (Var0 == 21)
		{
			func_193(&Var0, vVar61, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		}
		else if (Var0 == 22)
		{
			func_188(&Var0, vVar61, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		}
		else if (Var0 == 23)
		{
			if (iLocal_96 == 0)
			{
				if (func_193(&Var0, vVar61, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
				{
					iLocal_96 = 1;
				}
			}
	...
	switch (iParam0->f_16)
	{
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
					if (func_196(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)))
					{
...
void func_185(int iParam0)
{
	...
	if ((GET_GAME_TIMER() - iLocal_97) >= 900)
	{
		if (func_196(iParam0->f_28[0]))
		{
			if (!func_144())
...
{
	_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_187(iParam3), 0);
}
...
int func_188(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_196(PLAYER_PED_ID()) && func_196(iParam0->f_28[0])) && !func_144()) && (GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_192(PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
		func_191(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
...
float func_192(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
int func_193(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
	...
	if (func_176(2))
	{
		if (!func_144())
		{
			if (((func_196(PLAYER_PED_ID()) && func_196(iParam0->f_28[0])) && (GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_192(PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_191(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
				func_189(&uVar0, cParam4, sParam5, 7, 0, 0);
		...
		{
			if (func_196(PLAYER_PED_ID()))
			{
				if (func_192(PLAYER_PED_ID(), vParam1, 1) >= 20f)
				{
					func_142();
				}
			}
...
void func_197(int iParam0, var uParam1, vector3 vParam2)
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (!IS_STRING_NULL_OR_EMPTY(uParam1))
		{
			...
			{
				if (func_192(PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_200(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_192(PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_202(iParam0);
				}
			}
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_208(uParam1) || !IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_208(uParam1) && uParam1->f_4 == 0) && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_217(int iParam0, float fParam1)
{
	...
	if (func_196(PLAYER_PED_ID()) && func_196(iParam0))
	{
...
int func_220(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_225(GET_ENTITY_COORDS(iParam1, 1) - GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		vVar3 = { func_225(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_229(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_196(PLAYER_PED_ID()) && func_196(uParam0))
	{
...
int func_230(var uParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_231(var uParam0, float fParam1)
{
	...
	{
		if (func_232(uParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_232(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_225(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_225(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_224(vVar3, vVar0);
...
int func_233(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (IS_PED_SHOOTING(PLAYER_PED_ID()))
...
int func_246(var uParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_247(uParam0, iParam1, vParam2, fParam5, 1))
	{
		if (DOES_ENTITY_EXIST(*uParam0))
		{
			if (!IS_ENTITY_DEAD(*uParam0, 0))
...
int func_247(var uParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	int iVar0;
...
int func_252(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 3:
			...
			while (iVar4 <= 1)
			{
				if (func_196(uParam0->f_35[iVar4]))
				{
...
void func_256(var uParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	func_257(uParam0);
...
int func_270(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
