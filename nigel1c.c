...
void __EntryFunction__()
{
	...
	else if (func_276(0))
	{
		if (func_275(PLAYER::PLAYER_PED_ID()))
		{
			...
			SYSTEM::WAIT(0);
			func_272(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
...
void func_1()
{
	...
	if (func_275(iLocal_422) && func_275(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_422, PLAYER::PLAYER_PED_ID(), 1))
		{
			...
			{
				PED::_0xFE07FF6495D52E2A(iLocal_422, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
			}
...
void func_10()
{
	...
	{
		if (func_13(Global_104555.f_2353.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
int func_25(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_27(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
void func_40()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_423))
	{
		...
		else if (FIRE::GET_NUMBER_OF_FIRES_IN_RANGE(ENTITY::GET_ENTITY_COORDS(iLocal_423, 1), 2f) > 0)
		{
			PED::SET_PED_TO_RAGDOLL(iLocal_423, 500, 1000, 0, 1, 1, 0);
			iLocal_414 = 3;
			iLocal_420 = 0;
	...
	switch (iLocal_420)
	{
		case 0:
			...
			if (func_275(iLocal_423))
			{
				...
				iLocal_430 = PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_ROTATION(PLAYER::PLAYER_PED_ID(), 2), 2);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_430, false);
				PED::_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_430, false);
				BRAIN::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_430, sLocal_655, "take_collar_trevor", 8f, -4f, 1, 16, 1148846080, 0);
...
void func_69(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_74(PLAYER::PLAYER_ID())) && !func_71(PLAYER::PLAYER_ID(), 0)) && !func_70())
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_74(PLAYER::PLAYER_ID()))
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_70854 = 0;
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_70671[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iVar0), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_95(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iVar0), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, iParam4);
						}
						func_127(iVar0);
						if (Global_70669 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_95(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, iParam4);
		}
		if (Global_70669 == 1)
		{
			iVar2 = 0;
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_138(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
		...
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_138(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_199(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_70671[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_95(iParam1)) && Global_70671[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_95(iParam1)))
	{
		return 1;
	}
	return 0;
	...
	switch (iLocal_420)
	{
		case 0:
			if (func_275(iLocal_423))
			{
				...
				BRAIN::TASK_PLAY_ANIM(0, sLocal_653, "chop_growl", 8f, -8f, -1, 9, 0, 0, 0, 0);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_617);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_423, iLocal_617);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_617);
...
int func_216(float fParam0)
{
	...
	if (func_275(PLAYER::PLAYER_PED_ID()) && func_275(iLocal_423))
	{
		...
		{
			vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_423, 1)) };
...
int func_219()
{
	...
	BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_426, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), &uVar0);
	return uVar0;
}
...
int func_224()
{
	...
	BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_426, ENTITY::GET_ENTITY_COORDS(iLocal_423, 1), &uVar0);
	return uVar0;
}
			...
			if (iLocal_624 == 0)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_423, -662.7688f, -208.3171f, 35.49321f, -674.6289f, -214.6519f, 38.80591f, 6.5f, 0, true, 0))
				{
					...
					if (func_275(Local_421[2 /*16*/]))
					{
						...
						{
							PED::_0xFE07FF6495D52E2A(Local_421[2 /*16*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
						}
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_617);
						BRAIN::TASK_PAUSE(0, 500);
						BRAIN::TASK_PLAY_ANIM(0, sLocal_652, "reaction_backward_big_intro_c", 8f, -8f, -1, 8192, 0, 0, 0, 0);
						BRAIN::TASK_PLAY_ANIM(0, sLocal_652, "react_big_variations_a", 8f, -8f, -1, 8192, 0, 0, 0, 0);
						BRAIN::TASK_PLAY_ANIM(0, sLocal_652, "exit_to_generic", 8f, -8f, -1, 8192, 0, 0, 0, 0);
...
void func_236(int iParam0)
{
	...
	if (!Local_421[iParam0 /*16*/].f_14)
	{
		if (func_275(Local_421[iParam0 /*16*/]) && func_275(iLocal_423))
		{
			...
			{
				vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_421[iParam0 /*16*/], ENTITY::GET_ENTITY_COORDS(iLocal_423, 1)) };
				BRAIN::CLEAR_PED_TASKS(Local_421[iParam0 /*16*/]);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_617);
				BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_423, -1, 0, 2);
				if (vVar0.y > 0.7f)
				{
					BRAIN::TASK_PLAY_ANIM(0, sLocal_652, Local_421[iParam0 /*16*/].f_15, 8f, -4f, -1, 0, 0, 0, 0, 0);
				}
				else
				{
					BRAIN::TASK_PLAY_ANIM(0, sLocal_652, "avoid_rb", 8f, -4f, -1, 0, 0, 0, 0, 0);
				}
				BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_423, 0);
				BRAIN::TASK_PAUSE(0, 1000);
	...
	switch (iLocal_420)
	{
		case 0:
			...
			if (func_275(iLocal_423))
			{
				...
				BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(0, sLocal_426, 0, 616, -1);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_617);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_423, iLocal_617);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_617);
			}
			if ((iLocal_674 != 1 && func_275(iLocal_422)) && func_275(iLocal_423))
			{
				...
				BRAIN::TASK_PLAY_ANIM(0, sLocal_652, "IDLE_D", 2f, -8f, -1, 8193, 0, 0, 0, 0);
	...
	switch (iLocal_415)
	{
		...
		case 3:
			if (func_275(iLocal_422) && func_80(&uLocal_452, "NIG1CAU", "NIG1C_MODEL", "NIG1C_MODEL_1", 7, 0, 0))
			{
				...
				BRAIN::TASK_PLAY_ANIM(0, sLocal_654, "gesture_easy_now", 8f, -8f, -1, 8, 0, 0, 0, 0);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_617);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_422, iLocal_617);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_617);
				iLocal_641 = 1;
...
{
	if (((!func_269(0) || Global_71125) || Global_71114 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71110)
...
int func_305(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_95(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_95(iParam1), Global_70671[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, 0);
		}
	}
...
void func_316()
{
	...
	{
		func_10();
		GRAPHICS::_0xBF59707B3E5ED531(func_317(Global_104555.f_2353.f_539.f_4301));
	}
	else
	{
...
int func_364(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_387(iVar0, bParam1, uParam2) && !func_386(PLAYER::PLAYER_ID())) && !func_371(iParam0))
	{
		return 0;
	}
...
{
	if (func_385(PLAYER::PLAYER_ID()) || func_384(PLAYER::PLAYER_ID()))
	{
		if (func_372(iParam0))
		{
			return 1;
...
int func_373(int iParam0)
{
	...
	if (func_374(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_204(iParam0, 0, 0)) || func_204(iParam0, 1, 0)) || func_204(iParam0, 2, 0)) || func_407(iParam0) != 145) || func_406(iParam0)) || func_405(iParam0)) || func_365(iParam0)) || func_404(iParam0)) || !func_394(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_405(iParam0))
		{
		}
...
int func_411(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_383(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_414(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_414(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_413(iParam0);
	if (func_412(*iParam0))
	{
...
void func_417(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90309[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90309[iVar0]) == func_418(iParam0, iParam1))
				{
...
int func_426(vector3 vParam0, float fParam1)
{
	return func_427(&(Global_98118.f_2875), vParam0, fParam1, 0);
}

int func_427(var uParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
...
int func_429(int iParam0, vector3 vParam1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_431(iParam0, uVar1[iVar3], 1) && func_430(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_425(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_432(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_391(iVar2 + 1)))
				{
...
int func_470(var uParam0)
{
	...
	switch (iLocal_40)
	{
		...
		case 1:
			if (!func_471(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar2))
			{
				return 0;
			}
			iLocal_40 = 2;
		...
		case 2:
			...
			BRAIN::TASK_PLAY_ANIM(0, sVar2, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, sVar2, "dexy_stay_there", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, sVar2, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, sVar2, "price_tag", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, sVar2, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, sVar2, "such_a_good", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, sVar2, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, sVar2, "this_looks", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, sVar2, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, sVar2, "who_would", 8f, -8f, -1, 0, 0, 0, 0, 0);
...
void func_487(struct<2> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
...
int func_491(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_497())
	{
		...
		{
			iVar2 = func_492(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
