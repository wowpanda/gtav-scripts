...
void __EntryFunction__()
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_41 = func_513(64);
	uLocal_42 = func_513(63);
	...
	iLocal_639 = 1;
	iLocal_641 = 1;
	fLocal_642 = "NIG1CBrake";
	iLocal_643 = 102;
	fLocal_644 = "NIG1CCrash";
	iLocal_645 = 101;
	iLocal_646 = 103;
	vLocal_648 = { -603.9266f, -293.9479f, 34.77906f };
	vLocal_649 = { -636.4999f, -242.5444f, 39.1609f };
	fLocal_650 = 20f;
	fLocal_652 = "rcmnigel1c";
	fLocal_653 = "misschop_vehicle@back_of_van";
	fLocal_654 = "gestures@f@standing@casual";
	fLocal_655 = "random@nigel@1c";
	...
	else if (func_276(0))
	{
		if (func_275(PLAYER::PLAYER_PED_ID()))
		{
			...
			SYSTEM::WAIT(0);
			func_272(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1112014848, 12, 5000, 0, 0);
...
void func_1()
{
	...
	if (func_275(iLocal_422) && func_275(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_422, PLAYER::PLAYER_PED_ID(), 1))
		{
			...
			BRAIN::CLEAR_PED_TASKS(iLocal_422);
			BRAIN::TASK_SMART_FLEE_PED(iLocal_422, PLAYER::PLAYER_PED_ID(), 80f, -1, 0, 0);
		}
		if (!PED::IS_PED_FLEEING(iLocal_422))
		{
			if ((func_30(iLocal_422, 1126825984) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_422, PLAYER::PLAYER_PED_ID(), 1)) && !func_22(iLocal_422, 1, 0, 0, 0))
			{
				...
				BRAIN::CLEAR_PED_TASKS(iLocal_422);
				BRAIN::TASK_LOOK_AT_ENTITY(iLocal_422, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
				BRAIN::TASK_SMART_FLEE_PED(iLocal_422, PLAYER::PLAYER_PED_ID(), 80f, -1, 0, 0);
				iLocal_638 = 1;
			}
		}
...
void func_40()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_422))
	{
		...
		{
			if (func_275(iLocal_422) && !PED::IS_PED_FLEEING(iLocal_422))
			{
				if (PED::IS_PED_USING_ANY_SCENARIO(iLocal_422))
				{
					PED::_0xFE07FF6495D52E2A(iLocal_422, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
				}
				BRAIN::TASK_SMART_FLEE_PED(iLocal_422, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			}
			if (func_275(iLocal_423) && !PED::IS_PED_FLEEING(iLocal_423))
			{
				BRAIN::TASK_SMART_FLEE_PED(iLocal_423, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			}
			iLocal_414 = 2;
			iLocal_420 = 0;
			iLocal_419 = 10;
	...
	{
		if (func_275(iLocal_423) && func_275(PLAYER::PLAYER_PED_ID()))
		{
...
void func_49(struct<2> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	func_50(&(Param0.f_1));
	func_47(&Param0);
}
...
void func_58()
{
	switch (iLocal_420)
	{
		case 0:
			...
			if (func_275(iLocal_423))
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_423);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_617);
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_423, 0.5f, 1f, 0f), 2.5f, 20000, 0.25f, 0, 1193033728);
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -650.2209f, -120.7035f, 36.832f, 2.5f, 20000, 1f, 0, 1193033728);
				BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 50f, -1, 1, 0);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_617);
			...
			{
				if (func_62(iLocal_422, PLAYER::PLAYER_PED_ID()) < 30f)
				{
					BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(iLocal_422, iLocal_423, 0f, 0f, 0f, 2f, -1, 3f, 1);
				}
			}
			iLocal_673 = -1;
			iLocal_420 = 1;
		...
		case 1:
			if (!func_20())
			{
				...
				else if (MISC::GET_GAME_TIMER() > iLocal_673)
				{
					...
					func_60(&uLocal_452, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	...
	switch (iLocal_420)
	{
		case 0:
			...
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_665, vLocal_666, fLocal_667, 0, true, 0))
			{
				...
				func_81(PLAYER::PLAYER_PED_ID(), vLocal_668);
			...
			STREAMING::REQUEST_ANIM_DICT(fLocal_655);
			while (!STREAMING::HAS_ANIM_DICT_LOADED(fLocal_655))
			{
				SYSTEM::WAIT(0);
			}
			if (func_275(iLocal_423))
			...
			if (func_275(iLocal_423))
			{
				...
				func_81(PLAYER::PLAYER_PED_ID(), vVar0);
				...
				BRAIN::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_430, fLocal_655, "take_collar_trevor", 8f, -4f, 1, 16, 1148846080, 0);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_423, iLocal_430, fLocal_655, "take_collar_dog", 8f, -4f, 1, 16, 1148846080, 0);
				PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
				iLocal_622 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", true);
				CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_622, iLocal_430, "take_collar_cam", fLocal_655);
		...
		case 1:
			if (((iLocal_633 == 0 && PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_430)) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_430) >= 0.75f) && func_275(iLocal_423))
			{
...
void func_69(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_74(PLAYER::PLAYER_ID())) && !func_71(PLAYER::PLAYER_ID(), 0)) && !func_70()) && !bParam4)
			{
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_70793[1 /*14*/] = { func_135(iVar10, 14, uVar12[iVar1]) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_95(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
						}
						func_127(iVar0);
						if (Global_70791 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_70793[1 /*14*/] = { func_135(iVar10, 14, uVar15[iVar1]) };
			func_105(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
			func_127(14);
			if (Global_70791 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_95(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
		}
		if (Global_70791 == 1)
		{
			iVar2 = 0;
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_95(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_112(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_95(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_107(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_107(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_107(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_107(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_137(int iParam0)
{
	...
	func_138(&(Global_70793[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_138(var uParam0, int iParam1, int iParam2, void fParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_131(func_141(iParam1, uParam0->f_2), Global_70790, 0);
...
void func_144(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_138(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_95(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_138(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_199(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_70793[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_95(iParam1)) && Global_70793[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_95(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_206(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
void func_212(struct<8> Param0)
{
	if (func_213(Param0))
	{
		...
		{
			BRAIN::CLEAR_PED_TASKS(Param0.f_1);
			BRAIN::TASK_VEHICLE_DRIVE_WANDER(Param0.f_1, Param0, 10f, 786599);
		}
	}
}

int func_213(struct<2> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	...
	switch (iLocal_420)
	{
		case 0:
			if (func_275(iLocal_423))
			{
				...
				BRAIN::TASK_PLAY_ANIM(0, fLocal_653, "chop_growl", 8f, -8f, -1, 9, 0, 0, 0, 0);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_617);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_423, iLocal_617);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_617);
		...
		case 1:
			...
			if (BRAIN::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) == 1f)
			{
				fVar0 = 1f;
			}
			else
			...
			if (func_216(fVar0) && !PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()))
			{
				iLocal_420 = 0;
				iLocal_419 = 7;
			}
...
int func_216(float fParam0)
{
	...
	if (func_275(PLAYER::PLAYER_PED_ID()) && func_275(iLocal_423))
	{
		if (((((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || BRAIN::IS_PED_GETTING_UP(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_PRONE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_JUMPING(PLAYER::PLAYER_PED_ID()))
		{
			return 0;
		}
		if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_423, vLocal_662, vLocal_663, fLocal_664, 0, true, 0) && func_217(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_423, 0f, 1f, 0f), 1.5f)) && !ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iLocal_423))
		{
...
void func_218()
{
	if (Local_421[0 /*16*/].f_14)
	{
		if (iLocal_630 == 0)
		{
			if ((func_275(Local_421[0 /*16*/]) && func_275(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_FLEEING(Local_421[0 /*16*/]))
			{
				if (func_220() || func_21(Local_421[0 /*16*/], PLAYER::PLAYER_PED_ID(), 5f, 1))
				{
					if (func_21(Local_421[0 /*16*/], PLAYER::PLAYER_PED_ID(), 12f, 1))
					{
						...
						{
							BRAIN::CLEAR_PED_TASKS(Local_421[0 /*16*/]);
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_617);
							BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 4000);
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_421[0 /*16*/].f_9, 1f, 20000, 0.25f, 0, 1193033728);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_617);
							BRAIN::TASK_PERFORM_SEQUENCE(Local_421[0 /*16*/], iLocal_617);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_617);
							iLocal_630 = 1;
							BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_421[0 /*16*/], 5000, 0, 2);
						}
					}
				}
			}
	...
	if (iLocal_632 == 1)
	{
		if ((func_275(Local_421[2 /*16*/]) && func_275(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_FLEEING(Local_421[2 /*16*/]))
		{
	...
	if (Local_421[1 /*16*/].f_14 == 1)
	{
		if (iLocal_636 == 1)
		{
			if ((func_275(Local_421[1 /*16*/]) && func_275(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_FLEEING(Local_421[1 /*16*/]))
			{
				if (func_21(Local_421[1 /*16*/], PLAYER::PLAYER_PED_ID(), 8f, 1))
				{
					if (func_80(&uLocal_452, "NIG1CAU", "NIG1C_DOG", "NIG1C_DOG_4", 7, func_19(), 0))
					{
						BRAIN::CLEAR_PED_TASKS(Local_421[1 /*16*/]);
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_617);
						BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 4000);
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_421[1 /*16*/].f_9, 1f, 20000, 0.25f, 0, 1193033728);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_617);
						BRAIN::TASK_PERFORM_SEQUENCE(Local_421[1 /*16*/], iLocal_617);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_617);
						BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_421[1 /*16*/], 3500, 0, 2);
						iLocal_636 = 0;
					}
				}
			}
	...
	if (iLocal_634 == 1)
	{
		if (func_219() > 40)
		{
			...
			{
				BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_423, -1, 0, 2);
				iLocal_634 = 0;
				iLocal_635 = 1;
			}
		}
...
int func_219()
{
	...
	BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(fLocal_426, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), &uVar0);
	return uVar0;
}

int func_220()
{
	if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_421[0 /*16*/], fLocal_652, "avoid_rf", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(Local_421[0 /*16*/], fLocal_652, "avoid_rb", 3))
	{
		return 1;
	}
	return 0;
...
bool func_222(void fParam0, int iParam1, void fParam2)
{
		...
		if (func_213(Local_445) && func_275(iLocal_423))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_445))
			{
				...
				if (func_224() > 35)
				{
					...
					BRAIN::CLEAR_PED_TASKS(Local_445.f_1);
			...
			else if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_423))
			{
				if (func_224() == 19)
				{
					...
					BRAIN::TASK_LOOK_AT_ENTITY(Local_445.f_1, iLocal_423, -1, 0, 2);
...
int func_224()
{
	...
	BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(fLocal_426, ENTITY::GET_ENTITY_COORDS(iLocal_423, true), &uVar0);
	return uVar0;
}
		...
		if (func_213(Local_443) && func_275(iLocal_423))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_443))
			{
				...
				if (func_224() > 32)
				{
					...
					BRAIN::CLEAR_PED_TASKS(Local_443.f_1);
			...
			else if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_423))
			{
				if (func_224() > 25)
				{
					...
					BRAIN::TASK_LOOK_AT_ENTITY(Local_443.f_1, iLocal_423, -1, 0, 2);
					if (func_275(iLocal_429))
					{
						BRAIN::TASK_LOOK_AT_ENTITY(iLocal_429, iLocal_423, -1, 0, 2);
					}
				}
			}
	...
	if (iLocal_412 != 6)
	{
		if ((func_213(Local_442) && func_213(Local_441)) && func_213(Local_446))
		{
			if (iLocal_624 == 0)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_423, -662.7688f, -208.3171f, 35.49321f, -674.6289f, -214.6519f, 38.80591f, 6.5f, 0, true, 0))
				{
					...
					if (func_275(Local_421[2 /*16*/]))
					{
						...
						BRAIN::TASK_PLAY_ANIM(0, fLocal_652, "reaction_backward_big_intro_c", 8f, -8f, -1, 8192, 0, 0, 0, 0);
						BRAIN::TASK_PLAY_ANIM(0, fLocal_652, "react_big_variations_a", 8f, -8f, -1, 8192, 0, 0, 0, 0);
						BRAIN::TASK_PLAY_ANIM(0, fLocal_652, "exit_to_generic", 8f, -8f, -1, 8192, 0, 0, 0, 0);
			...
			switch (iLocal_412)
			{
				...
				case 1:
					VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_441, iLocal_643, fLocal_642, 1);
					VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_442, iLocal_645, fLocal_644, 1);
					VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_446, iLocal_646, fLocal_644, 1);
				...
				case 3:
					...
					VEHICLE::REMOVE_VEHICLE_RECORDING(iLocal_645, fLocal_644);
					VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(Local_446);
					VEHICLE::REMOVE_VEHICLE_RECORDING(iLocal_646, fLocal_644);
					VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(Local_441);
					VEHICLE::REMOVE_VEHICLE_RECORDING(iLocal_643, fLocal_642);
				...
				case 5:
					if (ENTITY::GET_ENTITY_SPEED(Local_442) < 0.5f && ENTITY::GET_ENTITY_SPEED(Local_446) < 0.5f)
					{
						...
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_442.f_1, -1f, 1f, 0f), 1.3f, 20000, 0.25f, 0, 1193033728);
...
void func_227()
{
	if ((func_275(Local_446.f_1) && func_29(Local_446)) && func_275(PLAYER::PLAYER_PED_ID()))
	{
		switch (iLocal_417)
		{
			case 0:
				...
				{
					BRAIN::CLEAR_PED_TASKS(Local_446.f_1);
					if (func_230() == joaat("weapon_unarmed"))
					{
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_446.f_1, 5, true);
					}
					BRAIN::TASK_COMBAT_PED(Local_446.f_1, PLAYER::PLAYER_PED_ID(), 0, 16);
					iLocal_417 = 1;
				}
			...
			case 1:
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_446, 0))
				{
					...
					{
						BRAIN::CLEAR_PED_TASKS(Local_446.f_1);
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(Local_446.f_1, PLAYER::PLAYER_PED_ID(), -1);
				...
				if (func_228(Local_446.f_1, 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					...
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_446.f_1, 17, true);
					BRAIN::CLEAR_PED_TASKS(Local_446.f_1);
					BRAIN::TASK_SMART_FLEE_PED(Local_446.f_1, PLAYER::PLAYER_PED_ID(), 60f, -1, 0, 0);
					iLocal_417 = 4;
				}
				break;
			
			case 2:
				if (func_63(PLAYER::PLAYER_PED_ID(), Local_446.f_1, 1) < 8f)
				{
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_446.f_1, 5, true);
					BRAIN::TASK_COMBAT_PED(Local_446.f_1, PLAYER::PLAYER_PED_ID(), 0, 16);
					iLocal_417 = 1;
				}
				if (func_63(PLAYER::PLAYER_PED_ID(), Local_446.f_1, 1) > 20f)
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_617);
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1000);
					BRAIN::TASK_ENTER_VEHICLE(0, Local_446, -1, -1, 1f, 1, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_617);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_446.f_1, iLocal_617);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_617);
					iLocal_417 = 3;
	...
	if (func_275(Local_441.f_1))
	{
		switch (iLocal_418)
		{
			case 0:
				if ((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_442, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_441, 0)) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_446, 0))
				{
					BRAIN::CLEAR_PED_TASKS(Local_441.f_1);
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(Local_441.f_1, PLAYER::PLAYER_PED_ID(), 0);
					iLocal_418 = 1;
				}
				break;
...
void func_231()
{
	if (func_213(Local_444) && func_275(iLocal_423))
	{
		switch (iLocal_413)
		{
			...
			case 4:
				if ((BRAIN::GET_SCRIPT_TASK_STATUS(Local_444.f_1, 242628503) != 1 && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_444, -1, 0)) && !PED::IS_PED_FLEEING(Local_444.f_1))
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_617);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_444, -2f, 2f, 0f), 2f, 20000, 0.25f, 0, 1193033728);
					if (func_275(Local_441.f_1))
					{
					...
					BRAIN::TASK_ENTER_VEHICLE(0, Local_444, -1, -1, 1.8f, 9, 0);
				...
				{
					BRAIN::CLEAR_PED_TASKS(Local_444.f_1);
					iLocal_413 = 6;
				}
			...
			case 6:
				...
				BRAIN::TASK_ENTER_VEHICLE(0, Local_444, -1, -1, 2.5f, 9, 0);
				BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(0, Local_444, PLAYER::PLAYER_PED_ID(), 8, 20f, 20, 100f, 5f, 1);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_617);
				BRAIN::TASK_PERFORM_SEQUENCE(Local_444.f_1, iLocal_617);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_617);
				iLocal_413 = 7;
...
void func_232(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
		...
		case 1:
			...
			else if (iLocal_640 == 0)
			{
				if (func_213(Local_448))
				{
					if (func_219() > 25)
					{
						BRAIN::CLEAR_PED_TASKS(Local_448.f_1);
...
void func_234()
{
	if (func_275(iLocal_422))
	{
		BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_422, PLAYER::PLAYER_PED_ID(), -1);
	}
	iLocal_420 = 0;
	iLocal_419 = 7;
}
...
void func_235()
{
	if (func_275(Local_421[4 /*16*/]) && func_275(iLocal_423))
	{
		if (Local_421[4 /*16*/].f_13 == 0)
		{
			...
			{
				BRAIN::CLEAR_PED_TASKS(Local_421[4 /*16*/]);
				...
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_617);
				BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_423, -1, 0, 2);
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -631.84f, -153.48f, 36.83f, 1f, 20000, 0.25f, 0, 1193033728);
	...
	if (!Local_421[iParam0 /*16*/].f_14)
	{
		if (func_275(Local_421[iParam0 /*16*/]) && func_275(iLocal_423))
		{
			if (!Local_421[iParam0 /*16*/].f_13)
			{
				if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_423))
				{
					if (func_224() > Local_421[iParam0 /*16*/].f_12)
					{
						...
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_421[iParam0 /*16*/].f_6, 1f, 20000, 0.25f, 0, 1193033728);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_617);
			...
			else if (func_21(Local_421[iParam0 /*16*/], iLocal_423, 3f, 1))
			{
				...
				BRAIN::CLEAR_PED_TASKS(Local_421[iParam0 /*16*/]);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_617);
				BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_423, -1, 0, 2);
				if (vVar0.y > 0.7f)
				{
					BRAIN::TASK_PLAY_ANIM(0, fLocal_652, Local_421[iParam0 /*16*/].f_15, 8f, -4f, -1, 0, 0, 0, 0, 0);
				}
				else
				{
					BRAIN::TASK_PLAY_ANIM(0, fLocal_652, "avoid_rb", 8f, -4f, -1, 0, 0, 0, 0, 0);
				}
				BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_423, 0);
				BRAIN::TASK_PAUSE(0, 1000);
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_421[iParam0 /*16*/].f_9, 1f, 20000, 0.25f, 0, 1193033728);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_617);
				BRAIN::TASK_PERFORM_SEQUENCE(Local_421[iParam0 /*16*/], iLocal_617);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_617);
...
void func_237()
{
	if ((func_275(iLocal_422) && func_238(iLocal_422, vLocal_425, 1) < 5f) && func_238(PLAYER::PLAYER_PED_ID(), vLocal_425, 1) < 25f)
	{
		if (iLocal_427)
		{
...
void func_241()
{
	VEHICLE::REQUEST_VEHICLE_RECORDING(iLocal_645, fLocal_644);
	VEHICLE::REQUEST_VEHICLE_RECORDING(iLocal_646, fLocal_644);
	...
	VEHICLE::REQUEST_VEHICLE_RECORDING(iLocal_643, fLocal_642);
	VEHICLE::REQUEST_VEHICLE_RECORDING(1, "NIG1C_FIRE");
	BRAIN::REQUEST_WAYPOINT_RECORDING(fLocal_426);
	...
	STREAMING::REQUEST_ANIM_DICT(fLocal_652);
	STREAMING::REQUEST_ANIM_DICT(fLocal_655);
	STREAMING::REQUEST_ANIM_DICT(fLocal_654);
	STREAMING::REQUEST_ANIM_DICT(fLocal_653);
...
void func_242()
{
	...
	switch (iLocal_420)
	{
		case 0:
			...
			func_79(0);
			BRAIN::WAYPOINT_RECORDING_GET_NUM_POINTS(fLocal_426, &iLocal_621);
			BRAIN::WAYPOINT_RECORDING_GET_COORD(fLocal_426, (iLocal_621 - 1), &vLocal_620);
			if (func_275(iLocal_423))
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_423);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_617);
				BRAIN::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
				BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(0, fLocal_426, 0, 616, -1);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_617);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_423, iLocal_617);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_617);
			}
			if ((iLocal_674 != 1 && func_275(iLocal_422)) && func_275(iLocal_423))
			{
				...
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_425, 2.2f, 20000, 0.25f, 0, 1193033728);
				BRAIN::TASK_CLEAR_LOOK_AT(0);
				BRAIN::TASK_PLAY_ANIM(0, fLocal_652, "IDLE_D", 2f, -8f, -1, 8193, 0, 0, 0, 0);
		...
		case 1:
			...
			{
				bVar0 = false;
				if ((func_275(iLocal_422) && func_275(PLAYER::PLAYER_PED_ID())) && func_21(iLocal_422, PLAYER::PLAYER_PED_ID(), 35f, 1))
				{
...
void func_243(void fParam0, int iParam1, int iParam2)
{
	iParam2 = iParam2;
	...
	switch (iLocal_415)
	{
		...
		case 1:
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				Var1.f_20 = 48;
				Var1.f_21 = 1024;
				BRAIN::TASK_SCRIPTED_ANIMATION(PLAYER::PLAYER_PED_ID(), &Var1, &Var0, &Var0, 0.25f, 0.25f);
			}
			RECORDING::_0x293220DA1B46CEBC(3f, 2f, 0);
		...
		case 2:
			if (MISC::GET_GAME_TIMER() > iLocal_672 && func_275(iLocal_422))
			{
				if (PED::IS_PED_USING_ANY_SCENARIO(iLocal_422))
				{
					PED::_0xFE07FF6495D52E2A(iLocal_422, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
		...
		case 3:
			...
			{
				BRAIN::TASK_LOOK_AT_ENTITY(iLocal_422, PLAYER::PLAYER_PED_ID(), -1, 2050, 4);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_617);
				BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
				BRAIN::TASK_PLAY_ANIM(0, fLocal_654, "gesture_easy_now", 8f, -8f, -1, 8, 0, 0, 0, 0);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_617);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_422, iLocal_617);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_617);
				iLocal_641 = 1;
		...
		case 5:
			func_249();
			if (MISC::GET_GAME_TIMER() > iLocal_672 && func_275(iLocal_423))
			{
...
bool func_248(int iParam0, vector3 vParam1, float fParam2)
{
...
void func_250()
{
	...
	{
		case 0:
			BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_422, -1, 0, 2);
			if (!HUD::DOES_BLIP_EXIST(iLocal_451))
			{
				RECORDING::_0x293220DA1B46CEBC(2f, 10f, 1);
				iLocal_451 = func_244(iLocal_423, 1, 1, 5);
...
void func_253(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71232 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_256(Global_71233, Global_71235, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_269(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_45(0)) || func_268(1))
			{
			}
			else
			{
...
void func_281()
{
	...
	{
		func_283(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
	if (!DATAFILE::DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_70978)
		{
			if (func_282() == 2 == 0 && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
...
int func_305(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_70793[1 /*14*/] = { func_135(iVar0, iParam1, uVar6[iParam1]) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_95(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_95(iParam1), Global_70793[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, 0);
		}
	}
...
void func_310(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_311(&sVar1, Var0.f_3, Global_92992, iParam1, iParam2);
	}
}

void func_311(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
void func_313(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
void func_316()
{
	...
	{
		func_10();
		GRAPHICS::_0xBF59707B3E5ED531(func_317(Global_105220.f_2354.f_539.f_4301));
	}
	else
	{
...
void func_342(void fParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
...
int func_350()
{
	return func_351(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_351(void fParam0, int iParam1)
{
	int iVar0;
	void fVar1;
	int iVar2;
...
void func_357(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
...
int func_358(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
...
int func_364(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_389(iVar0, bParam1, uParam2) && !func_388(PLAYER::PLAYER_ID())) && !func_373(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_371(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((((((VEHICLE::IS_BIG_VEHICLE(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("halftrack")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("phantom3")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("hauler2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("trailerlarge")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("trailersmall2")) && !bVar1) && !(func_370(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_366(PLAYER::PLAYER_ID())))
	{
		*uParam2 = 2;
		return 0;
	}
...
int func_375(int iParam0)
{
	...
	if (func_376(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_377(int iParam0, bool bParam1)
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_379(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_389(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_371(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_204(iParam0, 0, 0)) || func_204(iParam0, 1, 0)) || func_204(iParam0, 2, 0)) || func_409(iParam0) != 145) || func_408(iParam0)) || func_407(iParam0)) || func_365(iParam0)) || func_406(iParam0)) || !func_396(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_407(iParam0))
		{
		}
...
int func_413(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_385(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_416(*iParam0, ((*uParam1)[38] - 1)))
	{
...
void func_419(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90431[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90431[iVar0]) == func_420(iParam0, iParam1))
				{
...
void func_421(vector3 vParam0, float fParam1, bool bParam2)
{
	int iVar0;
...
bool func_427(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
{
	return func_429(&(Global_98783.f_2875), vParam0, fParam1, 0);
}
...
int func_431(int iParam0, vector3 vParam1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_433(iParam0, uVar1[iVar3], 1) && func_432(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_427(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_432(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_434(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_437(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_436())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_393(iVar2 + 1)))
				{
...
int func_456()
{
	...
	if (!STREAMING::HAS_ANIM_DICT_LOADED(fLocal_652))
	{
		return 0;
	}
	if (!STREAMING::HAS_ANIM_DICT_LOADED(fLocal_654))
	{
		return 0;
	}
	if (!STREAMING::HAS_ANIM_DICT_LOADED(fLocal_653))
	{
		return 0;
	}
...
void func_470(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_474())
	{
...
int func_472(var uParam0)
{
	...
	switch (iLocal_40)
	{
		case 0:
			...
			STREAMING::REQUEST_ANIM_DICT(fVar2);
			iLocal_40 = 1;
			break;
		
		case 1:
			if (!func_473(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(fVar2))
			{
				return 0;
			}
			iLocal_40 = 2;
		...
		case 2:
			...
			BRAIN::TASK_PLAY_ANIM(0, fVar2, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, fVar2, "dexy_stay_there", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, fVar2, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, fVar2, "price_tag", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, fVar2, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, fVar2, "such_a_good", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, fVar2, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, fVar2, "this_looks", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, fVar2, "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, fVar2, "who_would", 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::SET_SEQUENCE_TO_REPEAT(iVar3, 1);
			BRAIN::CLOSE_SEQUENCE_TASK(iVar3);
			BRAIN::TASK_PERFORM_SEQUENCE(uParam0->f_28[0], iVar3);
...
void func_487()
{
	...
	func_486(&iLocal_422, 1, 0, 1);
	func_486(&iLocal_423, 1, 0, 1);
	func_486(&iLocal_429, 0, 0, 1);
	func_483(&iLocal_450);
	func_489(Local_442);
	func_489(Local_444);
	func_489(Local_441);
	...
	STREAMING::REMOVE_ANIM_DICT(fLocal_652);
	STREAMING::REMOVE_ANIM_DICT(fLocal_655);
	STREAMING::REMOVE_ANIM_DICT(fLocal_653);
	STREAMING::REMOVE_ANIM_DICT(fLocal_654);
	VEHICLE::REMOVE_VEHICLE_RECORDING(iLocal_645, fLocal_644);
	VEHICLE::REMOVE_VEHICLE_RECORDING(iLocal_646, fLocal_644);
	VEHICLE::REMOVE_VEHICLE_RECORDING(iLocal_643, fLocal_642);
	VEHICLE::REMOVE_VEHICLE_RECORDING(1, "NIG1C_COMET");
...
void func_488(int iParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_421[iParam0 /*16*/]))
	{
		func_486(&(Local_421[iParam0 /*16*/]), 0, 0, 1);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_421[iParam0 /*16*/].f_1);
	}
}

void func_489(struct<2> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
...
void func_492(void fParam0, int iParam1)
{
	if (Global_92955 != 12)
	{
		if (func_493(fParam0, 6, iParam1))
		{
...
int func_496(void fParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
