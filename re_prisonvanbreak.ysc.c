...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_89(vLocal_217, 4294967295, 0, 0, 0))
	{
		func_86(4294967295);
	}
	else
	...
	while (true)
	{
		...
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_246)
		{
			...
			{
				case 0:
					if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_217, 100f, 100f, 100f, false, true, 0))
					{
						func_142();
					}
					if (iLocal_45)
...
void func_2()//Position - 0x325
{
	...
	if (!bLocal_256)
	{
		if (!iLocal_248)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_218))
			{
				...
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_218, AUDIO::_0x0626A247D2405330(), 1))
					{
						...
						{
							BRAIN::TASK_COMBAT_PED(iLocal_219, AUDIO::_0x0626A247D2405330(), 0, 16);
							PED::SET_PED_KEEP_TASK(iLocal_219, true);
							PED::REGISTER_TARGET(iLocal_219, AUDIO::_0x0626A247D2405330());
		...
		if (!iLocal_247)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_219))
			{
				...
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_219, AUDIO::_0x0626A247D2405330(), 1))
					{
						...
						{
							BRAIN::TASK_COMBAT_PED(iLocal_218, AUDIO::_0x0626A247D2405330(), 0, 16);
							PED::SET_PED_KEEP_TASK(iLocal_218, true);
							PED::REGISTER_TARGET(iLocal_218, AUDIO::_0x0626A247D2405330());
		...
		if (func_37() || !ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), 310.6203f, 2642.854f, 43.5173f, 150f, 150f, 180f, false, true, 0))
		{
			if (PED::IS_PED_INJURED(iLocal_218) && PED::IS_PED_INJURED(iLocal_219))
			{
				if (func_37() && !ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_217, 50f, 50f, 50f, false, true, 0))
				{
					func_7();
				}
				if (bLocal_48 && !bLocal_47)
				{
					if (!ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), 310.6203f, 2642.854f, 43.5173f, 150f, 150f, 180f, false, true, 0))
					{
						func_6(5);
						func_7();
					}
			...
			else if (!ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), 310.6203f, 2642.854f, 43.5173f, 200f, 200f, 180f, false, true, 0))
			{
				func_5();
			}
		}
	...
	if (bLocal_256)
	{
		if (func_37())
		{
			...
			if (bLocal_256)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_218))
				{
					if (!ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_218, 150f, 150f, 150f, 0, 0, 0))
					{
						if (!bLocal_48)
						{
							func_6(6);
				...
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_219))
				{
					if (!ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_219, 150f, 150f, 150f, 0, 0, 0))
					{
						if (!bLocal_48)
						{
							func_6(6);
	...
	else if (!iLocal_240 && !bLocal_47)
	{
		...
		if (((ENTITY::IS_ENTITY_DEAD(iLocal_218, 0) && ENTITY::IS_ENTITY_DEAD(iLocal_219, 0)) && STREAMING::HAS_MODEL_LOADED(joaat("AMBULANCE"))) && STREAMING::HAS_ANIM_DICT_LOADED("random@countrysiderobbery"))
		{
			...
			if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), 267.94f, 2700.48f, 43.6f, 15f, 15f, 15f, false, true, 0))
			{
			...
			iLocal_220 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_227, 20, joaat("s_m_m_paramedic_01"), 4294967295, 1, true);
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_218))
			{
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_243);
				BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_227, 307.1379f, 2640.042f, 43.4639f, 18f, 0, joaat("AMBULANCE"), 786475, 5f, 5f);
				BRAIN::TASK_GO_TO_ENTITY(0, iLocal_218, 4294967295, 2f, 1f, 10f, 0);
				BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_218, 4294967295, 2052, 2);
				BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_218, 0);
				BRAIN::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "enter", 2f, -2f, 4294967295, 0, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "base", 2f, -2f, 4294967295, 1, 0, 0, 0, 0);
				CUTSCENE::_0x8D9DF6ECA8768583(iLocal_243);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_220, iLocal_243);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_243);
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_219))
			{
				...
				BRAIN::TASK_GO_TO_ENTITY(0, iLocal_219, 4294967295, 2f, 1f, 10f, 0);
				BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_219, 4294967295, 2052, 2);
				BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_219, 0);
				BRAIN::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "enter", 2f, -2f, 4294967295, 0, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "base", 2f, -2f, 4294967295, 1, 0, 0, 0, 0);
				CUTSCENE::_0x8D9DF6ECA8768583(iLocal_243);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_221, iLocal_243);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_243);
			...
			if (!PED::IS_PED_INJURED(iLocal_222[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_226))
			{
				...
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_243);
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, unk_0x8000C77B5F336760(iLocal_226, false) + Vector(0f, 5f, 0f), 1f, 4294967295, 1048576000, 0, 1193033728);
				unk_0x74C219E0C7FC4E4B(0, 0);
				BRAIN::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "idle_a", 2f, -2f, 4294967295, 0, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "idle_d", 2f, -2f, 4294967295, 1, 0, 0, 0, 0);
				CUTSCENE::_0x8D9DF6ECA8768583(iLocal_243);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_222[0], iLocal_243);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_243);
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_222[1], 0) && ENTITY::DOES_ENTITY_EXIST(iLocal_223))
			{
				...
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_243);
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, unk_0x8000C77B5F336760(iLocal_223, false) + Vector(0f, 1f, 0f), 2f, 4294967295, 1048576000, 0, 1193033728);
				BRAIN::TASK_LOOK_AT_COORD(0, unk_0x8000C77B5F336760(iLocal_223, false), 4294967295, 2052, 2);
				BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, unk_0x8000C77B5F336760(iLocal_223, false), 0);
				BRAIN::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "enter", 2f, -2f, 4294967295, 0, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "base", 2f, -2f, 4294967295, 1, 0, 0, 0, 0);
				CUTSCENE::_0x8D9DF6ECA8768583(iLocal_243);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_222[1], iLocal_243);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_243);
			...
			if (!PED::IS_PED_INJURED(iLocal_222[2]) && ENTITY::DOES_ENTITY_EXIST(iLocal_219))
			{
				...
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_243);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, unk_0x8000C77B5F336760(iLocal_219, false) + Vector(0f, 1f, 0f), 1f, 4294967295, 1048576000, 0, 1193033728);
					unk_0x74C219E0C7FC4E4B(0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "idle_d", 2f, -2f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "random@countrysiderobbery", "idle_a", 2f, -2f, 4294967295, 1, 0, 0, 0, 0);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_243);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_222[2], iLocal_243);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_243);
				}
	...
	if (((((ENTITY::IS_ENTITY_DEAD(iLocal_218, 0) && ENTITY::IS_ENTITY_DEAD(iLocal_219, 0)) && ENTITY::IS_ENTITY_DEAD(iLocal_222[0], 0)) && ENTITY::IS_ENTITY_DEAD(iLocal_222[1], 0)) && ENTITY::IS_ENTITY_DEAD(iLocal_222[2], 0)) && (func_37() || !ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), 310.6203f, 2642.854f, 43.5173f, 200f, 200f, 180f, false, true, 0)))
	{
...
void func_13()//Position - 0x1199
{
	...
	{
		func_15(13, SYSTEM::FLOOR(Global_19E56.f_27B6.f_F0D));
	}
...
int func_17()//Position - 0x1C16
{
	return Global_1407E0;
}

int func_18(int iParam0, int iParam1)//Position - 0x1C22
{
	switch (iParam0)
	{
		case 0:
...
int func_19(int iParam0)//Position - 0x1F96
{
	switch (iParam0)
	{
		case 29:
...
void func_20(int iParam0)//Position - 0x1FC5
{
	int iVar0;
	int iVar1;
...
void func_21(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2007
{
	func_22(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_22(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2029
{
	int iVar0;
...
bool func_26(int iParam0)//Position - 0x2460
{
	return Global_8D15 == iParam0;
}

bool func_27(int iParam0)//Position - 0x246E
{
	return iParam0 < 3;
}

int func_28(int iParam0)//Position - 0x247A
{
	int iVar0;
	int iVar1;
...
int func_29(int iParam0)//Position - 0x24B7
{
	if (func_27(iParam0))
	{
...
int func_30(int iParam0)//Position - 0x24E1
{
	int iVar0;
	int iVar1;
...
void func_31(int iParam0, int iParam1)//Position - 0x2524
{
	MISC::SET_BIT(&(Global_19E56.f_6187.f_8[iParam0]), iParam1);
}

int func_32(int iParam0)//Position - 0x253F
{
	int iVar0;
...
int func_34(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x260D
{
...
int func_35()//Position - 0x27E7
{
	return 1;
}

int func_36()//Position - 0x27F0
{
...
int func_38(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x28A3
{
...
int func_39(char* sParam0, int iParam1, bool bParam2)//Position - 0x28F1
{
	Global_3DCF = 0;
...
bool func_47(int iParam0, int iParam1)//Position - 0x2E57
{
	switch (iParam0)
	{
		case 5:
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2EE9
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
void func_50(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2F3F
{
...
int func_51(int iParam0)//Position - 0x2FDA
{
	int iVar0;
...
float func_52(bool bParam0, float fParam1, float fParam2)//Position - 0x3012
{
	if (bParam0)
	{
		return fParam1;
...
void func_53(var uParam0, int iParam1)//Position - 0x3029
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	...
	if (!iLocal_254)
	{
		if (!PED::IS_PED_INJURED(iLocal_218))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_218, 0))
			{
				...
				if (((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_263, AUDIO::_0x0626A247D2405330(), 1) && PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0)) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_263, AUDIO::_0x0626A247D2405330(), 10f, 10f, 10f, 0, 1, 0)) || PED::IS_PED_BEING_JACKED(iLocal_218)) || PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_263, 0)) || WEAPON::HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(AUDIO::_0x0626A247D2405330(), iLocal_263, joaat("weapon_stickybomb"), 4294967295))
				{
					ENTITY::SET_ENTITY_HEALTH(iLocal_218, false);
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_241, 1862763509);
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_218, 0))
					{
						...
						BRAIN::TASK_DRIVE_BY(iLocal_218, AUDIO::_0x0626A247D2405330(), 0, 0f, 0f, 0f, 200f, 50, 0, 3541198322);
					}
					if (!PED::IS_PED_INJURED(iLocal_219))
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_219, 0))
						{
							ENTITY::SET_ENTITY_HEALTH(iLocal_219, false);
							...
							BRAIN::TASK_DRIVE_BY(iLocal_219, AUDIO::_0x0626A247D2405330(), 0, 0f, 0f, 0f, 200f, 50, 0, 3541198322);
						}
					}
					bLocal_48 = true;
					iLocal_254 = 1;
			...
			{
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_241, 1862763509);
				if ((PED::IS_PED_IN_ANY_VEHICLE(iLocal_218, 0) && PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0)) && !ENTITY::IS_ENTITY_DEAD(iLocal_263, 0))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_263, AUDIO::_0x0626A247D2405330(), 10f, 10f, 10f, 0, 1, 0))
					{
						ENTITY::SET_ENTITY_HEALTH(iLocal_218, false);
						WEAPON::GIVE_WEAPON_TO_PED(iLocal_218, joaat("weapon_microsmg"), 200, true, true);
						WEAPON::SET_CURRENT_PED_WEAPON(iLocal_218, joaat("weapon_microsmg"), true);
				...
				if (!PED::IS_PED_INJURED(iLocal_219))
				{
					if ((PED::IS_PED_IN_ANY_VEHICLE(iLocal_219, 0) && PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0)) && !ENTITY::IS_ENTITY_DEAD(iLocal_263, 0))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_263, AUDIO::_0x0626A247D2405330(), 10f, 10f, 10f, 0, 1, 0))
						{
							ENTITY::SET_ENTITY_HEALTH(iLocal_219, false);
		...
		if (!PED::IS_PED_INJURED(iLocal_219))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_219, 0))
			{
				...
				if (((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_263, AUDIO::_0x0626A247D2405330(), 1) || PED::IS_PED_BEING_JACKED(iLocal_219)) || PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_263, 0)) || WEAPON::HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(AUDIO::_0x0626A247D2405330(), iLocal_263, joaat("weapon_stickybomb"), 4294967295))
				{
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_241, 1862763509);
					if (!PED::IS_PED_INJURED(iLocal_218))
					{
...
void func_55()//Position - 0x3584
{
	if (!PED::IS_PED_INJURED(iLocal_218) && !ENTITY::IS_ENTITY_DEAD(iLocal_226, 0))
	{
		if (!VEHICLE::_0x639431E895B9AA57(iLocal_218, iLocal_226, 4294967295, 0, false) && !VEHICLE::_0x639431E895B9AA57(iLocal_218, iLocal_226, 0, 0, false))
		{
			BRAIN::TASK_SMART_FLEE_COORD(iLocal_218, vLocal_217, 1000f, 4294967295, 0, 0);
			PED::SET_PED_KEEP_TASK(iLocal_218, true);
			iLocal_257 = 1;
		}
	}
	...
	{
		if (!VEHICLE::_0x639431E895B9AA57(iLocal_219, iLocal_226, 4294967295, 0, false) && !VEHICLE::_0x639431E895B9AA57(iLocal_219, iLocal_226, 0, 0, false))
		{
			BRAIN::TASK_SMART_FLEE_COORD(iLocal_219, vLocal_217, 1000f, 4294967295, 0, 0);
			PED::SET_PED_KEEP_TASK(iLocal_219, true);
			iLocal_257 = 1;
		}
	}
...
void func_56()//Position - 0x3634
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_218, 0))
	{
		vLocal_245 = { unk_0x8000C77B5F336760(iLocal_218, true) };
	}
	else if (!ENTITY::IS_ENTITY_DEAD(iLocal_219, 0))
	{
		vLocal_245 = { unk_0x8000C77B5F336760(iLocal_219, true) };
	}
...
int func_57(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x375A
{
...
void func_58()//Position - 0x37AE
{
	if (!bLocal_256)
	{
		...
		if (iLocal_239 == 1)
		{
			if (!PED::IS_PED_INJURED(iLocal_218) && !ENTITY::IS_ENTITY_DEAD(iLocal_226, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(iLocal_218, iLocal_226, 0))
				{
					...
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_243);
					BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_226, AUDIO::_0x0626A247D2405330(), 8, 100f, 786469, 1000f, 10f, 1);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_243);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_218, iLocal_243);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_243);
					PED::SET_PED_KEEP_TASK(iLocal_218, true);
					bLocal_256 = true;
				}
		...
		if (iLocal_239 == 2)
		{
			if (!PED::IS_PED_INJURED(iLocal_219) && !ENTITY::IS_ENTITY_DEAD(iLocal_226, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(iLocal_219, iLocal_226, 0))
				{
					...
					BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_226, AUDIO::_0x0626A247D2405330(), 8, 100f, 786469, 1000f, 10f, 1);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_243);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_219, iLocal_243);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_243);
					PED::SET_PED_KEEP_TASK(iLocal_219, true);
					bLocal_256 = true;
				}
		...
		if (iLocal_239 == 3)
		{
			...
			{
				func_53(&uLocal_52, 5);
				BRAIN::TASK_ENTER_VEHICLE(iLocal_219, iLocal_226, 4294967295, 4294967295, 2f, 8, 0);
				iLocal_239 = 2;
			}
			if (PED::IS_PED_INJURED(iLocal_219) && !PED::IS_PED_INJURED(iLocal_218))
			{
				func_53(&uLocal_52, 6);
				BRAIN::TASK_ENTER_VEHICLE(iLocal_218, iLocal_226, 4294967295, 4294967295, 2f, 8, 0);
				iLocal_239 = 1;
			}
		}
		if (iLocal_239 == 4)
		{
			if (!PED::IS_PED_INJURED(iLocal_218))
			{
				NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_218);
				BRAIN::TASK_SMART_FLEE_COORD(iLocal_218, vLocal_217, 1000f, 4294967295, 0, 0);
				PED::SET_PED_KEEP_TASK(iLocal_218, true);
			}
			if (!PED::IS_PED_INJURED(iLocal_219))
			{
				NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_219);
				BRAIN::TASK_SMART_FLEE_COORD(iLocal_219, vLocal_217, 1000f, 4294967295, 0, 0);
				PED::SET_PED_KEEP_TASK(iLocal_219, true);
			}
			bLocal_256 = true;
...
void func_59()//Position - 0x3ABA
{
	if ((ENTITY::IS_ENTITY_DEAD(iLocal_222[0], 0) && ENTITY::IS_ENTITY_DEAD(iLocal_222[1], 0)) && ENTITY::IS_ENTITY_DEAD(iLocal_222[2], 0))
	{
		...
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_226, 0))
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_218) && !PED::IS_PED_HURT(iLocal_218))
			{
				...
				iLocal_239 = 1;
				NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_218);
				BRAIN::TASK_SWAP_WEAPON(iLocal_218, 1);
				ENTITY::SET_ENTITY_HEALTH(iLocal_218, true);
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_218);
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_226);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_243);
				BRAIN::TASK_ENTER_VEHICLE(0, iLocal_226, 4294967295, 4294967295, 2f, 9, 0);
				CUTSCENE::_0x8D9DF6ECA8768583(iLocal_243);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_218, iLocal_243);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_243);
				...
				{
					NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_219);
					ENTITY::SET_ENTITY_HEALTH(iLocal_219, true);
					ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_219);
					ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_226);
					BRAIN::TASK_SWAP_WEAPON(iLocal_219, 1);
					BRAIN::TASK_ENTER_VEHICLE(iLocal_219, iLocal_226, 4294967295, 0, 2f, 1, 0);
					iLocal_239 = 3;
				}
			}
			else if (!PED::IS_PED_INJURED(iLocal_219))
			{
				...
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_226);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_243);
				BRAIN::TASK_ENTER_VEHICLE(0, iLocal_226, 4294967295, 4294967295, 2f, 1, 0);
				CUTSCENE::_0x8D9DF6ECA8768583(iLocal_243);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_219, iLocal_243);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_243);
				iLocal_239 = 2;
...
int func_60(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x3CB4
{
	func_49(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_61(int iParam0, var uParam1, int iParam2, float fParam3)//Position - 0x3D08
{
	vector3 vVar0;
	vector3 vVar1;
	int iVar2;
		...
		if (*uParam1 < 5)
		{
			...
			if (MISC::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, vVar0), fParam3, 1, 1) || MISC::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, vVar0), fParam3, 0, 1))
			{
				switch (*uParam1)
				{
					...
					case 1:
						ENTITY::_0xDC6F8601FAF2E893(iParam0, iVar2);
						*uParam1++;
						break;
...
void func_62(int iParam0)//Position - 0x3E86
{
	if ((!PED::IS_PED_INJURED(iParam0) && !func_36()) && SYSTEM::TIMERA() > 12000)
	{
		func_50(&uLocal_52, 4, iParam0, "RECSBCop1", 0, 1);
		if (ENTITY::IS_ENTITY_AT_ENTITY(iParam0, AUDIO::_0x0626A247D2405330(), 20f, 20f, 20f, 0, 1, 0))
		{
...
void func_63()//Position - 0x3EF3
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_218, 0))
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_218))
		{
			if (!func_66() && WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 4))
			{
				if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_218) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_218))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_218, 20f, 20f, 20f, 0, 1, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_218, AUDIO::_0x0626A247D2405330()))
					{
						iLocal_230++;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_219, 0))
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_219))
		{
			if (!func_66() && WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 4))
			{
				if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_219) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_219))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_219, 20f, 20f, 20f, 0, 1, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_219, AUDIO::_0x0626A247D2405330()))
					{
	...
	if (!iLocal_261 && bLocal_234)
	{
		if (OBJECT::HAS_PICKUP_BEEN_COLLECTED(iLocal_264[0]))
		{
			if (!PED::IS_PED_INJURED(iLocal_218))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_218, AUDIO::_0x0626A247D2405330()) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_218, AUDIO::_0x0626A247D2405330(), 20f, 20f, 20f, 0, 1, 0))
				{
					bLocal_48 = true;
					func_3();
					SYSTEM::WAIT(0);
			...
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_219, AUDIO::_0x0626A247D2405330()) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_219, AUDIO::_0x0626A247D2405330(), 20f, 20f, 20f, 0, 1, 0))
				{
					bLocal_48 = true;
					func_53(&uLocal_52, 5);
					func_50(&uLocal_52, 5, iLocal_219, "RECSBRobber1", 0, 1);
	...
	{
		if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_226, AUDIO::_0x0626A247D2405330(), 1) || PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_226, 0)) || WEAPON::HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(AUDIO::_0x0626A247D2405330(), iLocal_226, joaat("weapon_stickybomb"), 4294967295))
		{
			bLocal_48 = true;
			SYSTEM::SETTIMERA(0);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_241, 1862763509);
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_226, 0))
			{
				if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_226, 0))
				{
					if (!PED::IS_PED_INJURED(iLocal_218))
					{
						func_60(&uLocal_52, "recsbau", "recsb_deadcr", "recsb_deadcr_1", 4, 0, 0);
						BRAIN::TASK_ENTER_VEHICLE(iLocal_218, iLocal_226, 4294967295, 4294967295, 2f, 524296, 0);
					}
					else if (!PED::IS_PED_INJURED(iLocal_219))
					{
						func_53(&uLocal_52, 5);
						func_50(&uLocal_52, 5, iLocal_219, "RECSBRobber1", 0, 1);
						func_60(&uLocal_52, "recsbau", "recsb_deadcr", "recsb_deadcr_1", 4, 0, 0);
						BRAIN::TASK_ENTER_VEHICLE(iLocal_219, iLocal_226, 4294967295, 4294967295, 2f, 524296, 0);
					}
				}
				else if (!bLocal_47)
				{
...
int func_64(char* sParam0)//Position - 0x493E
{
	var uVar0;
...
struct<6> func_65()//Position - 0x4966
{
	struct<6> Var0;
...
int func_66()//Position - 0x498A
{
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 0))
		{
			if (PED::IS_PED_IN_MODEL(AUDIO::_0x0626A247D2405330(), joaat("LAZER")) || PED::IS_PED_IN_MODEL(AUDIO::_0x0626A247D2405330(), joaat("BUZZARD")))
			{
				return 1;
			}
		}
...
void func_67()//Position - 0x49D7
{
	...
	if (!bLocal_258)
	{
		PLAYER::GET_ENTITY_PLAYER_IS_FREE_AIMING_AT(CAM::_0xDC9DA9E8789F5246(), &iLocal_244);
		...
		if ((iLocal_224 == iLocal_222[0] || iLocal_224 == iLocal_222[1]) || iLocal_224 == iLocal_222[2])
		{
			if (!PED::IS_PED_INJURED(iLocal_224))
			{
				if (!func_66() && WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 4))
				{
					if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_224) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_224))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_224, 20f, 20f, 20f, 0, 1, 0))
						{
							if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_224, AUDIO::_0x0626A247D2405330()) || ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_224, 8f, 8f, 8f, 0, 1, 0))
							{
								if (!bLocal_259)
								{
								...
								if (iLocal_228 > 40)
								{
									...
									if (!ENTITY::IS_ENTITY_DEAD(iLocal_244, 0))
									{
										...
										while (iVar0 < iLocal_222)
										{
											...
											{
												BRAIN::TASK_COMBAT_PED(iLocal_222[iVar0], AUDIO::_0x0626A247D2405330(), 0, 16);
												PED::SET_PED_KEEP_TASK(iLocal_222[iVar0], true);
												PED::REGISTER_TARGET(iLocal_222[iVar0], AUDIO::_0x0626A247D2405330());
	...
	while (iVar1 < iLocal_222)
	{
		...
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_222[iVar1], AUDIO::_0x0626A247D2405330(), 1))
			{
				bLocal_47 = true;
			}
	...
	if (iLocal_240)
	{
		if (SYSTEM::TIMERB() > 6000)
		{
			...
			if (PED::IS_PED_SHOOTING_IN_AREA(AUDIO::_0x0626A247D2405330(), Vector(43.5005f, 2626.29f, 326.6079f) - Vector(50f, 50f, 50f), Vector(43.5005f, 2626.29f, 326.6079f) + Vector(50f, 50f, 50f), 0, 1))
			{
				bLocal_47 = true;
			}
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_226, 0))
		...
		while (iVar1 < iLocal_222)
		{
			if (!PED::IS_PED_INJURED(iLocal_222[iVar1]))
			{
				...
				{
					if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_222[iVar1], AUDIO::_0x0626A247D2405330()) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_222[iVar1], AUDIO::_0x0626A247D2405330(), 20f, 20f, 20f, 0, 1, 0))
					{
						bLocal_47 = true;
						func_3();
						SYSTEM::WAIT(0);
				...
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_222[iVar1]))
				{
		...
		{
			if (!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_222[1], AUDIO::_0x0626A247D2405330(), 100f, 100f, 100f, 0, 1, 0))
			{
	...
	while (iVar1 < iLocal_225)
	{
		...
		{
			if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_225[iVar1], AUDIO::_0x0626A247D2405330(), 1) || PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_225[iVar1], 0)) || WEAPON::HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(AUDIO::_0x0626A247D2405330(), iLocal_225[iVar1], joaat("weapon_stickybomb"), 4294967295))
			{
				bLocal_47 = true;
			}
			if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
	...
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_227, AUDIO::_0x0626A247D2405330(), 1) || PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_227, 0))
		{
			bLocal_47 = true;
		}
	}
	...
	if (bLocal_47 || bLocal_258)
	{
		...
		bLocal_47 = true;
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_226, 0) && PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_226, 0))
		{
		}
		else
		{
		...
		if (iLocal_240)
		{
			...
			while (iVar1 < iLocal_222)
			{
				if (!PED::IS_PED_INJURED(iLocal_222[iVar1]))
				{
					BRAIN::TASK_COMBAT_PED(iLocal_222[iVar1], AUDIO::_0x0626A247D2405330(), 0, 16);
					PED::SET_PED_KEEP_TASK(iLocal_222[iVar1], true);
					PED::REGISTER_TARGET(iLocal_222[iVar1], AUDIO::_0x0626A247D2405330());
	...
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_220, AUDIO::_0x0626A247D2405330(), 1))
		{
			PLAYER::SET_POLICE_IGNORE_PLAYER(CAM::_0xDC9DA9E8789F5246(), 0);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_242, 1862763509);
			bLocal_47 = true;
	...
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_221, AUDIO::_0x0626A247D2405330(), 1))
		{
			PLAYER::SET_POLICE_IGNORE_PLAYER(CAM::_0xDC9DA9E8789F5246(), 0);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_242, 1862763509);
			bLocal_47 = true;
...
int func_68(int iParam0)//Position - 0x56D1
{
	if (func_72())
	{
		Global_19E4C = 1;
...
void func_69(int iParam0)//Position - 0x5724
{
	switch (iParam0)
	{
		case 0:
			if (Global_19E56.f_6187.f_2 < 3)
			{
				...
				{
					func_70(func_71(iParam0), 4294967295);
...
void func_70(char* sParam0, int iParam1)//Position - 0x5805
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_71(int iParam0)//Position - 0x581C
{
	char* sVar0;
...
int func_72()//Position - 0x5860
{
	switch (func_73(&Global_63AE, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_73(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x5896
{
	int iVar0;
...
void func_74(var uParam0, int iParam1)//Position - 0x59CD
{
	int iVar0;
...
bool func_75(int iParam0)//Position - 0x5A1C
{
	return func_76(iParam0, Global_8D15);
}

int func_76(int iParam0, int iParam1)//Position - 0x5A2D
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_77(int iParam0)//Position - 0x5C0E
{
	if (Global_8D15 == 15)
	{
		return 0;
...
void func_78()//Position - 0x5C30
{
	int iVar0;
	
	if ((!PED::IS_PED_INJURED(iLocal_222[0]) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330())) && !PED::IS_PED_INJURED(iLocal_218))
	{
	}
	if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 220.6075f, 2615.145f, 35.8465f, 440.8339f, 2684.23f, 72.6324f, 183.125f, 0, true, 0) && CAM::IS_SPHERE_VISIBLE(vLocal_217, 1f)) || ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), 325.6556f, 2647.021f, 43.6289f, 30f, 30f, 30f, false, true, 0))
	{
		iVar0 = 0;
		while (iVar0 < iLocal_222)
		{
			if (!PED::IS_PED_INJURED(iLocal_222[iVar0]))
			{
				...
				if (!HUD::DOES_BLIP_EXIST(iLocal_267[iVar0]))
				{
					...
					HUD::_0x75A16C3DA34F1245(iLocal_267[iVar0], false);
				}
			}
			iVar0++;
		}
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_218, 0) || (!PED::IS_PED_INJURED(iLocal_218) && !iLocal_249))
		{
			...
			HUD::_0x75A16C3DA34F1245(iLocal_265, false);
			iLocal_248 = 0;
			iLocal_249 = 1;
		}
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_219, 0) || (!PED::IS_PED_INJURED(iLocal_219) && !iLocal_250))
		{
			...
			HUD::_0x75A16C3DA34F1245(iLocal_266, false);
			iLocal_247 = 0;
			iLocal_250 = 1;
		}
		SYSTEM::SETTIMERA(0);
...
int func_79(int iParam0, bool bParam1, int iParam2)//Position - 0x5DCC
{
	int iVar0;
...
int func_80(int iParam0, bool bParam1, bool bParam2)//Position - 0x5E1E
{
	int iVar0;
...
void func_82()//Position - 0x5EED
{
	...
	if (!iLocal_252)
	{
		...
		{
			if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), 325.6556f, 2647.021f, 43.6289f, 30f, 30f, 30f, false, true, 0))
			{
				iVar0 = 0;
				while (iVar0 < iLocal_222)
				{
					if (HUD::DOES_BLIP_EXIST(iLocal_267[iVar0]))
					{
						HUD::_0x75A16C3DA34F1245(iLocal_267[iVar0], true);
					}
					iVar0++;
				}
				if (HUD::DOES_BLIP_EXIST(iLocal_265))
				{
					HUD::_0x75A16C3DA34F1245(iLocal_265, true);
				}
				if (HUD::DOES_BLIP_EXIST(iLocal_266))
				{
					HUD::_0x75A16C3DA34F1245(iLocal_266, true);
				}
				if (!PED::IS_PED_INJURED(iLocal_222[0]))
				{
					func_50(&uLocal_52, 4, iLocal_222[0], "RECSBCop1", 0, 1);
...
void func_83(var uParam0, char* sParam1)//Position - 0x6304
{
	if (!PED::IS_PED_INJURED(*uParam0))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), *uParam0, 4f, 4f, 4f, 0, 1, 0))
		{
			if (!bLocal_47)
			{
				func_50(&uLocal_52, 4, *uParam0, "RECSBCop1", 0, 1);
				func_38(&uLocal_52, "recsbau", sParam1, 4, 0, 0, 0);
				BRAIN::TASK_LOOK_AT_ENTITY(*uParam0, AUDIO::_0x0626A247D2405330(), 10000, 48, 4);
			}
			SYSTEM::SETTIMERA(0);
			iLocal_255++;
		}
...
void func_84()//Position - 0x636E
{
	...
	while (iVar0 < iLocal_225)
	{
		...
		{
			if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_225[iVar0], 0))
			{
...
void func_85()//Position - 0x66AD
{
	...
	if ((((STREAMING::HAS_MODEL_LOADED(joaat("s_m_y_ranger_01")) && STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_genstreet_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("s_m_m_paramedic_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("SHERIFF"))) && STREAMING::HAS_MODEL_LOADED(joaat("PHOENIX")))
	{
		...
		PED::SET_PED_USING_ACTION_MODE(iLocal_222[0], true, 4294967295, 0);
		PED::SET_PED_USING_ACTION_MODE(iLocal_222[1], true, 4294967295, 0);
		PED::SET_PED_USING_ACTION_MODE(iLocal_222[2], true, 4294967295, 0);
		...
		BRAIN::TASK_STAY_IN_COVER(iLocal_222[0]);
		BRAIN::TASK_STAY_IN_COVER(iLocal_222[1]);
		BRAIN::TASK_STAY_IN_COVER(iLocal_222[2]);
		...
		BRAIN::TASK_GUARD_CURRENT_POSITION(iLocal_219, 35f, 35f, 1);
		...
		BRAIN::TASK_GUARD_CURRENT_POSITION(iLocal_218, 35f, 35f, 1);
		...
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_242, 2761840924);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, 2761840924, iLocal_242);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_242, 1862763509);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_241, 1862763509);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_242, iLocal_241);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 2761840924, iLocal_241);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_241, iLocal_242);
		BRAIN::TASK_SEEK_COVER_FROM_PED(iLocal_222[0], iLocal_218, 3000, 0);
		BRAIN::TASK_SEEK_COVER_FROM_PED(iLocal_222[1], iLocal_218, 3000, 0);
		BRAIN::TASK_SEEK_COVER_FROM_PED(iLocal_222[2], iLocal_218, 3000, 0);
		if (func_45() == 0)
		{
			func_50(&uLocal_52, 0, AUDIO::_0x0626A247D2405330(), "MICHAEL", 0, 1);
		}
		else if (func_45() == 1)
		{
			func_50(&uLocal_52, 0, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
		}
		else if (func_45() == 2)
		{
			func_50(&uLocal_52, 0, AUDIO::_0x0626A247D2405330(), "TREVOR", 0, 1);
		}
		func_50(&uLocal_52, 4, iLocal_222[0], "RECSBCop1", 0, 1);
...
void func_86(int iParam0)//Position - 0x6EA2
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_33();
...
void func_88(int iParam0)//Position - 0x6F15
{
	Global_19E4B = iParam0;
}

int func_89(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x6F23
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(AUDIO::_0x0626A247D2405330())) > 1369f && !func_140())
			{
				return 0;
			}
		}
		...
		if (!func_125(Global_19E56.f_6187.f_2B[iParam1]))
		{
			return 0;
		}
...
bool func_90(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x72BD
{
	if (bParam2)
	{
...
bool func_91(int iParam0)//Position - 0x7304
{
	int iVar0;
...
int func_92(int iParam0)//Position - 0x7325
{
	return func_93(iParam0, 1);
}

int func_93(int iParam0, int iParam1)//Position - 0x7334
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_94(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x7387
{
	func_95(func_106(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_95(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x73A5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_96(float fParam0, float fParam1, float fParam2)//Position - 0x75A6
{
	float fVar0;
...
int func_97(int iParam0, int iParam1)//Position - 0x75E8
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_98(int iParam0)//Position - 0x768A
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_99(int iParam0)//Position - 0x769D
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_100(int iParam0)//Position - 0x76B0
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_101(int iParam0)//Position - 0x76C3
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_102(int iParam0)//Position - 0x76D5
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_103(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}

int func_103(bool bParam0, int iParam1, int iParam2)//Position - 0x76FA
{
	if (bParam0)
	{
		return iParam1;
...
int func_104(int iParam0)//Position - 0x7711
{
	return iParam0 & 15;
}

int func_105(int iParam0, int iParam1)//Position - 0x771E
{
	int iVar0;
	int iVar1;
...
void func_107(var uParam0, int iParam1)//Position - 0x7870
{
	if (iParam1 <= 0)
	{
		return;
...
void func_108(var uParam0, int iParam1)//Position - 0x78F6
{
...
void func_109(var uParam0, int iParam1)//Position - 0x7929
{
	int iVar0;
	int iVar1;
...
void func_110(var uParam0, int iParam1)//Position - 0x797A
{
...
void func_111(var uParam0, int iParam1)//Position - 0x79B4
{
...
void func_112(var uParam0, int iParam1)//Position - 0x79EF
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_113(int iParam0)//Position - 0x7A2B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_114(int iParam0, int iParam1)//Position - 0x7B07
{
...
int func_115(int iParam0)//Position - 0x7B2A
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_123()) || Global_19A9D) || Global_6375) || func_122()) || func_47(8, 4294967295)) || func_121()) || func_120()) || func_119()) || func_118()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_123()) || Global_6375) || func_122()) || func_47(8, 4294967295)) || func_119()) || func_121()) || func_120()) || func_118()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_123()) || Global_19A9D) || Global_6375) || func_122()) || func_47(8, 4294967295)) || func_119()) || func_121()) || func_120()) || func_118()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_123()) || Global_19A9D) || Global_6375) || func_122()) || func_47(8, 4294967295)) || func_121()) || func_120()) || func_118()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_123() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_47(8, 4294967295)) || func_118()) || func_117()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_47(8, 4294967295) || func_121()) || func_120()) || func_117()) || func_116())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_123()) || Global_6375) || func_122()) || func_47(8, 4294967295)) || func_120()) || func_119()) || func_118()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_116()//Position - 0x8248
{
	return Global_16C57.f_1;
}

int func_117()//Position - 0x8256
{
...
bool func_120()//Position - 0x82C0
{
	return Global_16C64.f_148 > 0;
}

bool func_121()//Position - 0x82D1
{
	return Global_16C64.f_147 > 0;
}

var func_122()//Position - 0x82E2
{
	return Global_140859;
}

int func_123()//Position - 0x82EE
{
...
bool func_125(int iParam0)//Position - 0x8332
{
	return func_105(func_106(), iParam0);
}

int func_126(int iParam0, int iParam1, int iParam2)//Position - 0x8344
{
	int iVar0;
	int iVar1;
...
int func_127(int iParam0)//Position - 0x8428
{
	if (!func_27(iParam0))
	{
		return 7;
...
bool func_128(int iParam0)//Position - 0x844C
{
	int iVar0;
	bool bVar1;
...
int func_129(float fParam0, bool bParam1)//Position - 0x84AA
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_130(int iParam0, var uParam1)//Position - 0x8561
{
	switch (iParam0)
	{
		case 0:
		...
		case 1:
			func_131(uParam1, "Abigail2", func_133(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, 4294967295, 4, 1, 0, 2359, func_132(iParam0), 1, 0);
			break;
		
		case 2:
			func_131(uParam1, "Barry1", func_133(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 0, 2359, func_132(iParam0), 1, 0);
			break;
		
		case 3:
			func_131(uParam1, "Barry2", func_133(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_132(iParam0), 1, 1);
			break;
		
		case 4:
			func_131(uParam1, "Barry3", func_133(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", 4294967295, 0, "", 164, 1, 4294967295, 0, 2, 0, 2359, func_132(iParam0), 0, 0);
			break;
		...
		case 7:
			func_131(uParam1, "Barry4", func_133(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, 4294967295, 4, 2, 800, 2000, func_132(iParam0), 0, 0);
			break;
		
		case 8:
			func_131(uParam1, "Dreyfuss1", func_133(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_132(iParam0), 0, 0);
			break;
		...
		case 15:
			func_131(uParam1, "Epsilon7", func_133(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", 4294967295, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_132(iParam0), 0, 0);
			break;
		
		case 16:
			func_131(uParam1, "Epsilon8", func_133(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, 4294967295, 4, 1, 0, 2359, func_132(iParam0), 1, 0);
			break;
		
		case 17:
			func_131(uParam1, "Extreme1", func_133(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", 4294967295, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_132(iParam0), 0, 1);
			break;
		...
		case 20:
			func_131(uParam1, "Extreme4", func_133(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_132(iParam0), 0, 0);
			break;
		
		case 21:
			func_131(uParam1, "Fanatic1", func_133(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 700, 2000, func_132(iParam0), 1, 0);
			break;
		
		case 22:
			func_131(uParam1, "Fanatic2", func_133(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 700, 2000, func_132(iParam0), 1, 0);
			break;
		
		case 23:
			func_131(uParam1, "Fanatic3", func_133(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 2, 700, 2000, func_132(iParam0), 0, 1);
			break;
		
		case 24:
			func_131(uParam1, "Hao1", func_133(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", 4294967295, 0, "controller_Races", 13, 1, 4294967295, 4, 2, 2000, 500, func_132(iParam0), 0, 1);
			break;
		
		case 25:
			func_131(uParam1, "Hunting1", func_133(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", 4294967295, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_132(iParam0), 0, 1);
			break;
		
		case 26:
			func_131(uParam1, "Hunting2", func_133(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, 4294967295, 4, 4, 0, 2359, func_132(iParam0), 0, 1);
			break;
		
		case 27:
			func_131(uParam1, "Josh1", func_133(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", 4294967295, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_132(iParam0), 1, 0);
			break;
		...
		case 29:
			func_131(uParam1, "Josh3", func_133(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 4294967295, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_132(iParam0), 1, 1);
			break;
		
		case 30:
			func_131(uParam1, "Josh4", func_133(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", 4294967295, 36, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_132(iParam0), 1, 0);
			break;
		
		case 31:
			func_131(uParam1, "Maude1", func_133(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", 4294967295, 0, "BailBond_Launcher", 0, 1, 4294967295, 4, 4, 0, 2359, func_132(iParam0), 0, 1);
			break;
		
		case 32:
			func_131(uParam1, "Minute1", func_133(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", 4294967295, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_132(iParam0), 0, 1);
			break;
		
		case 33:
			func_131(uParam1, "Minute2", func_133(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", 4294967295, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_132(iParam0), 0, 1);
			break;
		
		case 34:
			func_131(uParam1, "Minute3", func_133(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", 4294967295, 10, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_132(iParam0), 0, 1);
			break;
		
		case 35:
			func_131(uParam1, "MrsPhilips1", func_133(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", 4294967295, 0, "ambient_MrsPhilips", 0, 1, 4294967295, 4, 4, 0, 2359, func_132(iParam0), 0, 0);
			break;
		
		case 36:
			func_131(uParam1, "MrsPhilips2", func_133(iParam0), 0, 11, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_132(iParam0), 0, 0);
			break;
		
		case 37:
			func_131(uParam1, "Nigel1", func_133(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", 4294967295, 0, "", 177, 1, 4294967295, 1, 4, 0, 2359, func_132(iParam0), 1, 0);
			break;
		...
		case 42:
			func_131(uParam1, "Nigel2", func_133(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", 4294967295, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_132(iParam0), 1, 1);
			break;
		
		case 43:
			func_131(uParam1, "Nigel3", func_133(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", 4294967295, 16, "postRC_Nigel3", 0, 0, 4294967295, 4, 4, 0, 2359, func_132(iParam0), 1, 1);
			break;
		
		case 44:
			func_131(uParam1, "Omega1", func_133(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", 4294967295, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_132(iParam0), 0, 0);
			break;
		
		case 45:
			func_131(uParam1, "Omega2", func_133(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_132(iParam0), 0, 0);
			break;
		
		case 46:
			func_131(uParam1, "Paparazzo1", func_133(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", 4294967295, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_132(iParam0), 0, 1);
			break;
		
		case 47:
			func_131(uParam1, "Paparazzo2", func_133(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", 4294967295, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_132(iParam0), 0, 1);
			break;
		
		case 48:
			func_131(uParam1, "Paparazzo3", func_133(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", 4294967295, 8, "", 183, 1, 4294967295, 2, 2, 0, 2359, func_132(iParam0), 0, 0);
			break;
		...
		case 51:
			func_131(uParam1, "Paparazzo4", func_133(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", 4294967295, 8, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_132(iParam0), 0, 0);
			break;
		
		case 52:
			func_131(uParam1, "Rampage1", func_133(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", 4294967295, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_132(iParam0), 0, 0);
			break;
		
		case 54:
			func_131(uParam1, "Rampage3", func_133(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", 4294967295, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_132(iParam0), 1, 0);
			break;
		
		case 55:
			func_131(uParam1, "Rampage4", func_133(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", 4294967295, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_132(iParam0), 1, 0);
			break;
		
		case 56:
			func_131(uParam1, "Rampage5", func_133(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", 4294967295, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_132(iParam0), 0, 0);
			break;
		
		case 53:
			func_131(uParam1, "Rampage2", func_133(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", 4294967295, 0, "rampage_controller", 0, 0, 4294967295, 4, 4, 0, 2359, func_132(iParam0), 1, 0);
			break;
		
		case 57:
			func_131(uParam1, "TheLastOne", func_133(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_132(iParam0), 0, 1);
			break;
		
		case 58:
			func_131(uParam1, "Tonya1", func_133(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", 4294967295, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_132(iParam0), 0, 1);
			break;
		
		case 59:
			func_131(uParam1, "Tonya2", func_133(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_132(iParam0), 0, 1);
			break;
		
		case 60:
			func_131(uParam1, "Tonya3", func_133(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_132(iParam0), 0, 1);
			break;
		
		case 61:
			func_131(uParam1, "Tonya4", func_133(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_132(iParam0), 0, 1);
			break;
		
		case 62:
			func_131(uParam1, "Tonya5", func_133(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_132(iParam0), 0, 1);
			break;
...
int func_132(int iParam0)//Position - 0x9839
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_133(int iParam0)//Position - 0x9B7F
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_134(int iParam0)//Position - 0x9BB7
{
	struct<2> Var0;
...
bool func_137()//Position - 0xA07A
{
	return Global_19D3C > 0;
}

int func_138()//Position - 0xA088
{
	if (Global_16089 != 4294967295)
	{
		return 1;
...
void func_142()//Position - 0xA19B
{
	...
	if (iLocal_46)
	{
		...
		while (iVar0 < iLocal_222)
		{
			if (!PED::IS_PED_INJURED(iLocal_222[iVar0]))
			{
				ENTITY::SET_ENTITY_HEALTH(iLocal_222[iVar0], false);
				if (PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
				{
					BRAIN::TASK_STAY_IN_COVER(iLocal_222[iVar0]);
					PED::SET_PED_KEEP_TASK(iLocal_222[iVar0], true);
				}
			}
			if (!PED::IS_PED_INJURED(iLocal_218))
...
void func_143(int iParam0)//Position - 0xA307
{
	char cVar0[64];
	...
	if (func_81())
	{
		...
		func_146(30000);
		StringCopy(&cVar0, func_145(Global_19E4B, 1), 64);
	...
	func_144(&Global_63AE);
	Global_19E4C = 0;
	func_88(4294967295);
}

void func_144(var uParam0)//Position - 0xA3BC
{
	if (*uParam0 == 4294967295)
	{
		return;
...
char* func_145(int iParam0, bool bParam1)//Position - 0xA3F9
{
	switch (iParam0)
	{
		case 0:
...
void func_146(int iParam0)//Position - 0xA642
{
	Global_8F3C = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_147(int iParam0)//Position - 0xA654
{
	func_148(iParam0, 0, func_153(iParam0));
}

void func_148(int iParam0, int iParam1, int iParam2)//Position - 0xA669
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_149(var uParam0)//Position - 0xA698
{
	struct<16> Var0;
	int iVar1;
...
void func_150(int iParam0, var uParam1)//Position - 0xA769
{
	Global_19E56.f_6187.f_2B[iParam0] = *uParam1;
}

void func_151(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xA781
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_152(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xA903
{
...
int func_153(int iParam0)//Position - 0xA93B
{
	int iVar0;
