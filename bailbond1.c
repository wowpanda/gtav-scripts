...
void __EntryFunction__()
{
	...
	if (func_504())
	{
		...
		{
			case 0:
				if (VEHICLE::IS_THIS_MODEL_A_HELI(Global_98783.f_2875.f_12.f_66) || VEHICLE::IS_THIS_MODEL_A_PLANE(Global_98783.f_2875.f_12.f_66))
				{
					func_434(&iLocal_339, 2898.294f, 2796.305f, 53.849f, 162.6353f, 0, 0, 1, 0, 0, joaat("asterope"), 0, 145, 1);
				}
				else
				{
					func_434(&iLocal_339, 2891.459f, 2798.125f, 53.7482f, 206.3925f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				}
				func_433(vLocal_334, fLocal_115, 1, 0);
				iLocal_61 = 2;
				func_422(1, 0);
				break;
			
			case 1:
				func_434(&iLocal_339, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				func_433(vLocal_328, 254.9762f, 0, 0);
				func_422(4, 0);
				break;
	...
	else if (func_421(0))
	{
		...
		{
			func_419(PLAYER::PLAYER_PED_ID(), vLocal_334, fLocal_115, 0, 0);
		...
		switch (iLocal_58)
		{
			case 0:
				if (iLocal_60 == 1)
				{
					if (!func_70())
					{
						func_19(PLAYER::PLAYER_PED_ID(), vLocal_335, fLocal_116, 0, 1);
			...
			case 1:
				...
				if (iLocal_60 == 1)
				{
					if (!func_70())
					{
						func_19(PLAYER::PLAYER_PED_ID(), vLocal_336, fLocal_117, 0, 1);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_103 == 0)
						{
			...
			case 3:
				...
				if (iLocal_60 == 1)
				{
					func_419(Local_68.f_9, vLocal_328, 0f, 0, 0);
					if (!func_70())
					{
						func_419(PLAYER::PLAYER_PED_ID(), vLocal_328, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_103 == 0)
						{
				...
				if (iLocal_62 == 4)
				{
					...
					else if (func_22(Local_75))
					{
						if (!func_63(Local_75, 1805844857))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_75, func_101(), func_73(), 3))
								{
									func_72(&Local_75);
...
void func_82()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_85(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (!PED::IS_PED_RAGDOLL(*iParam0) || BRAIN::IS_PED_GETTING_UP(*iParam0))
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(func_101()))
				{
					*iParam2 = PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
					...
					BRAIN::TASK_SYNCHRONIZED_SCENE(*iParam0, *iParam2, func_101(), func_73(), 1000f, -4f, 4626, 0, 1148846080, 0);
...
void func_113(int iParam0)
{
	if (func_22(Local_70[iParam0 /*19*/]))
	{
		...
		BRAIN::CLEAR_PED_TASKS(Local_70[iParam0 /*19*/]);
		...
		else if (PED::GET_PED_RELATIONSHIP_GROUP_HASH(Local_70[iParam0 /*19*/]) == iLocal_319)
		{
			...
			BRAIN::TASK_LOOK_AT_ENTITY(Local_70[iParam0 /*19*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(Local_70[iParam0 /*19*/], PLAYER::PLAYER_PED_ID(), -1);
...
void func_117()
{
	...
	{
		func_120(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
...
void func_125(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_95814.f_4))
	{
		...
		{
			if (func_177(24) != Global_95814.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_174(ENTITY::GET_ENTITY_COORDS(Global_95814.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_126(Global_95814.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_127(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_157(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
...
void func_128(int iParam0, int iParam1)
{
	...
	func_168(iParam0, &(Global_105220.f_32546.f_5510));
}
...
int func_157(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_167(Global_105220.f_32546.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_167(Global_105220.f_2354.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_167(Global_105220.f_2354.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_160(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_157(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_165(iParam0);
			func_164(uParam1, &(Global_105220.f_32546.f_69[Global_69800.f_555[0 /*21*/].f_14 /*78*/]));
...
{
	return func_186(Global_95814.f_2875.f_12.f_66, vParam0, iParam1);
}
...
int func_192(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_70793[1 /*14*/] = { func_242(iVar10, iParam1, iParam2) };
		if (!func_241(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_70793[1 /*14*/] = { func_242(iVar10, iVar0, uVar11[iVar0]) };
				if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_70793[1 /*14*/] = { func_242(iVar10, 14, uVar12[iVar1]) };
							func_212(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
							func_234(14);
							if (Global_70791 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_202(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_202(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_202(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
						}
						func_234(iVar0);
						if (Global_70791 == 1)
						{
			...
			{
				Global_70793[1 /*14*/] = { func_242(iVar10, iVar0, func_201(iParam0, iVar0, -1)) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_70793[1 /*14*/] = { func_242(iVar10, 14, uVar15[iVar1]) };
			func_212(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
			func_234(14);
			if (Global_70791 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_202(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_202(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_202(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
		}
		if (Global_70791 == 1)
		{
			iVar2 = 0;
...
int func_193(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_306(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_64, Global_105220.f_2354.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_70793[1 /*14*/] = { func_242(iParam0, iParam1, iParam2) };
...
int func_200(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_306(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_61, Global_105220.f_2354.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_214(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_202(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_219(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_202(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_227(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[0], Global_105220.f_2354.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_227(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[1], Global_105220.f_2354.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_227(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[2], Global_105220.f_2354.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_214(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_214(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_214(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_214(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_234(int iParam0)
{
	...
	{
		func_240(iParam0, Global_70793[1 /*14*/].f_5, Global_70793[1 /*14*/].f_2, 2, Global_70793[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_236(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_237(iParam2)];
	if (iVar0 != 0)
	{
...
int func_238(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_237(iParam1)];
...
struct<14> func_242(int iParam0, int iParam1, int iParam2)
{
	func_305();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_244(int iParam0)
{
	...
	func_245(&(Global_70793[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_238(func_248(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_238(func_247(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_238(iVar1, Global_70790, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_251(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_245(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_245(&(Global_70793[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_245(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_202(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_245(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_306(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_70793[1 /*14*/] = { func_242(iVar0, iParam1, iParam2) };
	if (!MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_306(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_306(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_70793[2 /*14*/] = { func_242(iVar0, 14, iVar4) };
									if (Global_70793[2 /*14*/].f_12 == iVar3)
									{
										if (func_306(iParam0, 14, iVar4))
										{
											if (!func_198(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_70793[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_70793[2 /*14*/] = { func_242(iVar0, iVar2, iVar1) };
						if (!func_198(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_70793[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_70793[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_202(iParam1)) && Global_70793[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_202(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_308()
{
	...
	if (func_22(Local_68.f_9))
	{
		...
		func_376(Local_68.f_9, &iLocal_131, 1126825984, 7);
		...
		switch (iLocal_60)
		{
			case 0:
				...
				func_355(&vLocal_338, vLocal_337);
				...
				func_352(&(Local_68.f_8), "", "", &iLocal_123, iLocal_124, 0);
				iLocal_60 = 1;
				break;
			...
			case 1:
				if (!iLocal_107)
				{
					...
					if (Local_68.f_10 == 13 || Local_68.f_10 == 14)
					{
						...
						else
						{
							...
							{
								if (func_112(iLocal_120, MISC::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_104(Local_68.f_9, vLocal_329, 30f))
									{
				...
				else
				{
					...
					if (!func_104(Local_68.f_9, vLocal_329, 10f))
					{
						...
						{
							func_352(&(Local_68.f_8), "BBS_APPSUS", "BBS_APPSUS2", &iLocal_123, iLocal_124, 1);
						}
					}
					else
					{
...
int func_332(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_340() || func_339(Global_4456448.f_148478)) || func_338())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
			iVar1 = func_337(PLAYER::PLAYER_PED_ID(), 0);
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("riot2") && iVar1 == 0) && func_336(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_333(int iParam0)
{
	if (iParam0 != func_335())
	{
		...
		else if ((Global_1312854 && iParam0 == PLAYER::PLAYER_ID()) && func_334(iParam0, 1, 0))
		{
			return Global_2423644[iParam0 /*406*/].f_305.f_1 != -1;
		}
	}
...
void func_356()
{
	...
	if (func_22(Local_68.f_9))
	{
		if (iLocal_69 == 0)
		{
			func_367(&(Local_68.f_9), &bLocal_113);
			if (func_366())
			{
			...
			switch (Local_68.f_10)
			{
				...
				case 30:
					if (!func_63(Local_68.f_9, 242628503))
					{
						...
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_142);
						BRAIN::TASK_GOTO_ENTITY_AIMING(0, PLAYER::PLAYER_PED_ID(), fVar3, 30f);
						BRAIN::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 2000, 0);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_142);
						BRAIN::TASK_PERFORM_SEQUENCE(Local_68.f_9, iLocal_142);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_142);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, true);
					}
					break;
				...
				case 15:
					...
					{
						if (((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_71[0 /*6*/], 0) && func_104(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f)) && func_363(ENTITY::GET_ENTITY_HEADING(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f)) && !func_362(Local_71[0 /*6*/], 2))
						{
							...
							else if (func_112(Local_68.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 350)))
							{
								...
								BRAIN::TASK_ENTER_VEHICLE(Local_68.f_9, Local_71[0 /*6*/], 25000, -1, 3f, 8388608, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, true);
								Local_68.f_10 = 16;
							}
						}
				...
				case 16:
					...
					else if ((((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_71[0 /*6*/], 1) || PED::IS_PED_BEING_JACKED(Local_68.f_9)) || !func_104(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f)) || !func_363(ENTITY::GET_ENTITY_HEADING(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f)) || func_362(Local_71[0 /*6*/], 2))
					{
						Local_68.f_18 = (MISC::GET_GAME_TIMER() - 5000);
						Local_68.f_10 = 13;
					}
				...
				case 23:
					if (func_361(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_360())
					{
						...
						{
							BRAIN::TASK_LOOK_AT_ENTITY(Local_68.f_9, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							if ((!func_357(Local_68.f_19, 10) && func_104(Local_68.f_9, vLocal_329, 50f)) || !func_112(iLocal_139, 2000))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 0))
								{
									BRAIN::TASK_LEAVE_ANY_VEHICLE(Local_68.f_9, 0, 0);
					...
					if (func_361(Local_68.f_9, Local_68.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_360())
					{
						if (!func_63(Local_68.f_9, -1519143300))
						{
							if (!func_63(Local_68.f_9, -875674219))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 0))
								{
									if (!func_357(Local_68.f_19, 10) && func_104(Local_68.f_9, vLocal_329, 50f))
									{
										BRAIN::TASK_LEAVE_ANY_VEHICLE(Local_68.f_9, 0, 0);
										Local_68.f_10 = 23;
									}
							...
							else if (!func_357(Local_68.f_19, 10) && func_104(Local_68.f_9, vLocal_329, 50f))
							{
...
bool func_369(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (!func_420(iParam0) || !func_420(iParam1))
	{
		if (iVar2 != -1)
		{
...
void func_377()
{
	if (func_58(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_328, 100f))
	{
		if (!func_378())
		{
	...
	{
		if (!func_58(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), vLocal_328, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
			...
			else
			{
				...
				else if (Local_68.f_10 == 24 && func_63(Local_68.f_9, -1519143300))
				{
					if (func_104(Local_68.f_9, vLocal_329, 25f))
					{
						...
						{
							if (func_112(iLocal_121, MISC::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_61())
								{
									func_3();
				...
				else
				{
					...
					if (!func_61())
					{
						if (func_112(iLocal_120, MISC::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_104(Local_68.f_9, vLocal_329, 20f))
							{
	...
	if (func_22(Local_68.f_9))
	{
		...
		switch (iLocal_60)
		{
			...
			case 1:
				if (!iLocal_108)
				{
					...
					else
					{
						if (!HUD::DOES_BLIP_EXIST(iLocal_114))
						{
							if (iLocal_96)
							{
								iLocal_114 = func_389(vLocal_328, 5, 1);
							}
						}
						if (!iLocal_83)
						{
						...
						{
							func_380();
							func_387(&Local_75, vLocal_329, &iLocal_122, 5000, 1101004800);
						}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (func_104(PLAYER::PLAYER_PED_ID(), vLocal_328, 6.5f))
							{
								iLocal_60 = 2;
							}
						}
						else if (func_104(PLAYER::PLAYER_PED_ID(), vLocal_328, 2.5f))
						{
							iLocal_60 = 2;
						}
					}
				...
				if (!bLocal_105)
				{
					bLocal_105 = func_385(vLocal_329, Local_63, 180f);
				}
				if (func_309(&(Local_68.f_9)))
				{
					iLocal_112 = 1;
			...
			case 2:
				...
				else
				{
					...
					if (!bLocal_105)
					{
						bLocal_105 = func_385(vLocal_329, Local_63, 0f);
					}
					func_124(4);
				}
				break;
				...
				if (!iLocal_107)
				{
					...
					else
					{
						...
						if (func_7(Local_71[0 /*6*/]))
						{
							...
							{
								if (func_395(Local_68.f_9, Local_71[0 /*6*/], &iLocal_134, 2))
								{
									if (!func_61())
									{
										func_319();
								...
								{
									if (func_394(Local_68.f_9, Local_71[0 /*6*/], Local_71[0 /*6*/].f_5, &vLocal_330, &iLocal_118, iLocal_129))
									{
										if (Local_68.f_10 == 34)
										{
											Local_68.f_10 = 17;
									...
									func_393(Local_68.f_8, Local_68.f_9, 150f, 0.65f, 0);
									func_392(Local_68.f_9, Local_71[0 /*6*/], vLocal_329);
								}
							}
						}
						else
...
void func_392(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_393(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_394(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
...
void func_396()
{
	if (func_22(Local_68.f_9))
	{
		func_376(Local_68.f_9, &iLocal_131, 1126825984, 1);
		func_368(Local_68.f_9, &(Local_68.f_19), 1126825984, 7);
		func_356();
		switch (iLocal_60)
		{
			...
			case 1:
				switch (iLocal_61)
				{
					case 2:
						...
						{
							func_352(&(Local_68.f_8), "BBS_APHEND", "BBS_APHEND2", &iLocal_123, iLocal_124, 1);
							if (func_104(Local_68.f_9, vLocal_329, 25f) && func_399(Local_68.f_9, vLocal_329, 10f))
							{
								if (PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), 0))
								{
									if (func_398(&(Local_68.f_19)))
									{
										iLocal_61 = 1;
										iLocal_91 = 0;
								...
								else if (func_397(Local_68.f_9, iLocal_131, 0, 1103626240, 1086324736))
								{
									iLocal_61 = 0;
								}
								...
								else if (func_398(&(Local_68.f_19)))
								{
...
int func_397(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)
{
	if (func_420(iParam0))
	{
		if (!func_357(iParam1, 10))
		{
			if (bParam2)
			{
				...
				if (!func_399(iParam0, vLocal_329, fParam4))
				{
					return 0;
				}
			}
...
int func_399(int iParam0, vector3 vParam1, float fParam2)
{
	vector3 vVar0;
	float fVar1;
...
void func_401(var uParam0, var uParam1)
{
	if (!uParam0->f_7)
	{
		if (func_404(26, func_406(uParam0->f_4), 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if ((!func_61() && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID())) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
					...
					if (func_75(uParam1, func_403(uParam0->f_4), func_402(uParam0->f_4), 4, 0, 0, 0))
					{
						uParam0->f_7 = 1;
					}
				}
...
int func_410(bool bParam0)
{
	if (func_22(Local_75))
	{
		...
		if (func_416(Local_75, 1126825984))
		{
			return 1;
		}
		if (func_411(Local_75, 1, 0, 0, 0))
		{
			return 1;
		}
...
int func_411(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_420(PLAYER::PLAYER_PED_ID()) && func_420(iParam0))
	{
		...
		if (!bParam2)
		{
			if (func_415(iParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_412(iParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_412(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_413(int iParam0, float fParam1)
{
	var uVar0;
	vector3 vVar1;
	...
	{
		if (func_414(iParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_414(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
int func_415(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_416(int iParam0, float fParam1)
{
	...
	if (func_420(PLAYER::PLAYER_PED_ID()) && func_420(iParam0))
	{
		if (func_418(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
void func_419(int iParam0, vector3 vParam1, float fParam2, bool bParam3, bool bParam4)
{
...
void func_433(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_504())
	{
...
void func_434(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
	
	iVar0 = 1;
	if (!func_504() || !func_502())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	{
		if (!func_499(iParam4, iParam5, iParam6, iParam11))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_477(vParam1, fParam2);
	}
	else if (iParam7 == 1)
	{
		if (func_167(vParam1, 0f, 0f, 0f, 0))
		...
		func_473(vParam1, 5f, 0);
		if (func_83(iParam10))
		{
			func_472(iParam10, 0);
			while (!func_435(iParam0, iParam10, vParam1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_435(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2, vParam2, fParam3, true, true, false);
				...
				func_467(iParam0, &(Var2.f_31), &(Var2.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
				if (iParam1 == 1)
				{
...
void func_436(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_83(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_440(*iParam1, 0, &uVar0))
		{
			func_170(iParam1, &(Global_105220.f_2354.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_105220.f_2354.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_105220.f_20089[iParam0 /*43*/].f_31 = func_439(*iParam1);
				...
				func_437(Global_105220.f_2354.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_105220.f_2354.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_105220.f_20089[iParam0 /*43*/].f_1));
				...
				func_437(Global_105220.f_2354.f_539.f_2387[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_105220.f_20089[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_437(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_438(iVar0, &sVar2, &iVar1, &iVar3, &iVar4))
	{
...
bool func_438(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
int func_440(int iParam0, bool bParam1, var uParam2)
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_462(iVar0, bParam1, uParam2) && !func_461(PLAYER::PLAYER_ID())) && !func_446(iParam0))
	{
		return 0;
	}
	...
	if (((((((VEHICLE::IS_BIG_VEHICLE(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("halftrack")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("phantom3")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("hauler2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("trailerlarge")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("trailersmall2")) && !bVar1) && !(func_443(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_441(PLAYER::PLAYER_ID())))
	{
		*uParam2 = 2;
		return 0;
	}
...
int func_441(int iParam0)
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			...
			{
				return func_442(Global_2423644[iParam0 /*406*/].f_305.f_1) == 11;
			}
		}
	}
	return 0;
...
int func_444(int iParam0)
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			if (Global_2423644[iParam0 /*406*/].f_305.f_1 != -1)
			{
				return func_442(Global_2423644[iParam0 /*406*/].f_305.f_1) == 7;
			}
		}
	}
	return 0;
...
int func_448(int iParam0)
{
	...
	if (func_449(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
	...
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_452(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				...
				else if (func_451(iParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_459(int iParam0)
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			if (Global_2423644[iParam0 /*406*/].f_305.f_1 != -1 && Global_2423644[iParam0 /*406*/].f_305.f_4 != func_335())
			{
				return func_442(Global_2423644[iParam0 /*406*/].f_305.f_1) == 5;
			}
		}
	}
	return 0;
...
int func_460(int iParam0)
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			if (Global_2423644[iParam0 /*406*/].f_305.f_1 != -1 && Global_2423644[iParam0 /*406*/].f_305.f_4 != func_335())
			{
				return func_442(Global_2423644[iParam0 /*406*/].f_305.f_1) == 8;
			}
		}
	}
	return 0;
...
int func_461(int iParam0)
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			if (Global_2423644[iParam0 /*406*/].f_305.f_1 != -1)
			{
				return func_442(Global_2423644[iParam0 /*406*/].f_305.f_1) == 9;
			}
		}
	}
	return 0;
...
int func_467(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_458(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_470(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_470(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_469(iParam0);
	if (func_468(*iParam0))
	{
...
void func_472(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90431[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90431[iVar0]) == func_158(iParam0, iParam1))
				{
...
void func_473(vector3 vParam0, float fParam1, bool bParam2)
{
	...
	while (iVar0 < 68)
	{
		if (func_157(&(Global_69800.f_555[0 /*21*/]), iVar0))
		{
...
void func_474(int iParam0)
{
	...
	if (func_157(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		...
		if (MISC::IS_BIT_SET(Global_69800.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_163(iParam0, 0)) && Global_70709.f_66 == 0) && Global_105220.f_32546.f_1958[Global_69800.f_555[0 /*21*/].f_14] != 0) && Global_105220.f_32546.f_1958[Global_69800.f_555[0 /*21*/].f_14] > 3) && (!func_475(0, Global_69800.f_555[0 /*21*/].f_12) || !func_475(1, Global_69800.f_555[0 /*21*/].f_12)))
			{
				func_164(&(Global_105220.f_32546.f_69[Global_69800.f_555[0 /*21*/].f_14 /*78*/]), &Global_70709);
...
int func_475(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_476(&(Global_105220.f_32546.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_131(Global_105220.f_32546.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_477(vector3 vParam0, float fParam1)
{
	return func_478(&(Global_98783.f_2875), vParam0, fParam1, 0);
}

int func_478(var uParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
...
int func_480(int iParam0, vector3 vParam1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_482(iParam0, uVar1[iVar3], 1) && func_481(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
int func_481(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_483(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_486(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_485())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
...
int func_487(int iParam0)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!func_493(PLAYER::PLAYER_ID(), -1))
		{
	...
	if (func_489(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
...
bool func_496()
{
	return func_494(&(Global_98783.f_2875));
}

void func_497()
{
	func_498(&(Global_98783.f_2875));
}
...
int func_499(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_501(Global_98783.f_2875.f_12.f_66))
	{
		return 0;
	}
...
bool func_502()
{
	return func_495(&(Global_98783.f_2875));
}
...
void func_505()
{
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_319);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_319, 1862763509);
	vVar0 = { func_512(Local_63) };
	vVar1 = { func_511(Local_63) };
	PED::SET_PED_NON_CREATION_AREA(vVar0, vVar1);
	...
	if (func_22(PLAYER::PLAYER_PED_ID()))
	{
		func_90(&uLocal_154, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
void func_506()
{
	...
	if (func_22(Local_68.f_9))
	{
		...
		func_354(Local_68.f_9);
		func_507(Local_68.f_9, "TARGET_", 0);
		Local_68.f_10 = 0;
		PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_68.f_9);
		BRAIN::TASK_PLAY_ANIM(Local_68.f_9, "ODDJOBS@BAILBOND_QUARRY", "prem_producer_argue_a", 8f, -2f, -1, 1, 0, 0, 0, 0);
		if (!ENTITY::DOES_ENTITY_EXIST(Local_72))
		{
			Local_72 = OBJECT::CREATE_OBJECT(joaat("prop_phone_ing"), ENTITY::GET_ENTITY_COORDS(Local_68.f_9, 0), true, true, false);
		}
		if (func_420(Local_72))
		{
	...
	while (iVar0 <= 5)
	{
		if (func_22(Local_70[iVar0 /*19*/]))
		{
			...
			func_507(Local_70[iVar0 /*19*/], "BACKUP_", iVar0);
		}
		iVar0++;
	}
	iVar0 = 0;
...
int func_508()
{
	...
	if (iLocal_126 > 0)
	{
		...
		{
			if (func_510(&(Local_71[iVar2 /*6*/]), Local_71[iVar2 /*6*/].f_5, Local_71[iVar2 /*6*/].f_1, Local_71[iVar2 /*6*/].f_4, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	if (iLocal_128 > 0)
	{
		...
		{
			if (func_509(&(Local_74[iVar2 /*7*/]), Local_74[iVar2 /*7*/].f_5, Local_74[iVar2 /*7*/].f_2, Local_74[iVar2 /*7*/].f_6, Local_74[iVar2 /*7*/].f_1, 1))
			{
				iVar0++;
			}
			iVar2++;
...
int func_509(var uParam0, int iParam1, vector3 vParam2, int iParam3, int iParam4, bool bParam5)
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_55(iParam4))
...
int func_510(var uParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_55(iParam1))
...
Vector3 func_511(struct<5> Param0, var uParam1, var uParam2, var uParam3)
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_512(struct<5> Param0, var uParam1, var uParam2, var uParam3)
{
	switch (Param0.f_4)
	{
		case 0:
...
void func_513()
{
	...
	StringCopy(&vLocal_320, "", 24);
	Local_75.f_6 = func_524(62);
	Local_75.f_1 = { func_523() };
	Local_75.f_4 = func_522();
	Local_77.f_5 = func_521();
	Local_77.f_1 = { func_520() };
	Local_77.f_4 = func_519();
	Local_78.f_5 = func_518();
	Local_78.f_1 = { func_517() };
	Local_78.f_4 = func_516();
	Local_79.f_5 = func_47();
	Local_79.f_1 = { func_46() };
	Local_79.f_4 = func_45();
	Local_80.f_5 = func_44();
	Local_80.f_1 = { func_515() };
	Local_80.f_4 = func_514();
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_528()) || Global_104267) || Global_25279) || func_534()) || func_88(8, -1)) || func_533()) || func_532()) || func_526()) || func_527()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_528()) || Global_25279) || func_534()) || func_88(8, -1)) || func_526()) || func_533()) || func_532()) || func_527()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_528()) || Global_104267) || Global_25279) || func_534()) || func_88(8, -1)) || func_526()) || func_533()) || func_532()) || func_527()) || Global_105220.f_7659.f_919[iVar0] == 5) || Global_36452 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_528()) || Global_104267) || Global_25279) || func_534()) || func_88(8, -1)) || func_533()) || func_532()) || func_527()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_528() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_88(8, -1)) || func_527()) || func_531()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_88(8, -1) || func_533()) || func_532()) || func_531()) || func_530())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_528()) || Global_25279) || func_534()) || func_88(8, -1)) || func_532()) || func_526()) || func_527()) || Global_105220.f_7659.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_528()) || func_532()) || Global_104267) || Global_25279) || func_534()) || Global_37057) || func_88(8, -1)) || func_526()) || func_531()) || func_527()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_528()) || Global_104267) || Global_25279) || func_534()) || func_88(8, -1)) || func_526()) || func_531()) || func_533()) || func_532()) || func_527())
						{
							return 0;
						}
						break;
...
void func_537(int iParam0)
{
	...
	if (!func_561())
	{
		...
		func_538(SCRIPT::GET_THIS_SCRIPT_NAME());
	}
}
...
int func_539(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_550())
	{
		...
		{
			iVar2 = func_540(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
void func_541(int iParam0, var uParam1)
{
	...
	{
		case 0:
			func_542(uParam1, "Abigail1", func_544(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0, "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_543(iParam0), 1, 0);
			break;
		
		case 1:
			func_542(uParam1, "Abigail2", func_544(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, -1, 4, 1, 0, 2359, func_543(iParam0), 1, 0);
			break;
		
		case 2:
			func_542(uParam1, "Barry1", func_544(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, -1, 4, 1, 0, 2359, func_543(iParam0), 1, 0);
			break;
		
		case 3:
			func_542(uParam1, "Barry2", func_544(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_543(iParam0), 1, 1);
			break;
		
		case 4:
			func_542(uParam1, "Barry3", func_544(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", -1, 0, "", 164, 1, -1, 0, 2, 0, 2359, func_543(iParam0), 0, 0);
			break;
		
		case 5:
			func_542(uParam1, "Barry3A", func_544(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 6:
			func_542(uParam1, "Barry3C", func_544(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, 381, "", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 7:
			func_542(uParam1, "Barry4", func_544(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_543(iParam0), 0, 0);
			break;
		
		case 8:
			func_542(uParam1, "Dreyfuss1", func_544(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_543(iParam0), 0, 0);
			break;
		
		case 9:
			func_542(uParam1, "Epsilon1", func_544(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1, 10, 4, 1, 0, 2359, func_543(iParam0), 0, 0);
			break;
		
		case 10:
			func_542(uParam1, "Epsilon2", func_544(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0, 11, 4, 1, 0, 2359, func_543(iParam0), 1, 0);
			break;
		
		case 11:
			func_542(uParam1, "Epsilon3", func_544(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars", 0, 0, 12, 4, 1, 0, 2359, func_543(iParam0), 0, 0);
			break;
		
		case 12:
			func_542(uParam1, "Epsilon4", func_544(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16, "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_543(iParam0), 0, 0);
			break;
		
		case 13:
			func_542(uParam1, "Epsilon5", func_544(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16, "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_543(iParam0), 1, 0);
			break;
		
		case 14:
			func_542(uParam1, "Epsilon6", func_544(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0, 15, 4, 1, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 15:
			func_542(uParam1, "Epsilon7", func_544(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_543(iParam0), 0, 0);
			break;
		
		case 16:
			func_542(uParam1, "Epsilon8", func_544(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_543(iParam0), 1, 0);
			break;
		
		case 17:
			func_542(uParam1, "Extreme1", func_544(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 18:
			func_542(uParam1, "Extreme2", func_544(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171, 0, 19, 4, 2, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 19:
			func_542(uParam1, "Extreme3", func_544(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20, 4, 2, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 20:
			func_542(uParam1, "Extreme4", func_544(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, -1, 4, 2, 0, 2359, func_543(iParam0), 0, 0);
			break;
		
		case 21:
			func_542(uParam1, "Fanatic1", func_544(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, -1, 4, 1, 700, 2000, func_543(iParam0), 1, 0);
			break;
		
		case 22:
			func_542(uParam1, "Fanatic2", func_544(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1, -1, 4, 4, 700, 2000, func_543(iParam0), 1, 0);
			break;
		
		case 23:
			func_542(uParam1, "Fanatic3", func_544(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1, 4, 2, 700, 2000, func_543(iParam0), 0, 1);
			break;
		
		case 24:
			func_542(uParam1, "Hao1", func_544(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0, "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_543(iParam0), 0, 1);
			break;
		
		case 25:
			func_542(uParam1, "Hunting1", func_544(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 26:
			func_542(uParam1, "Hunting2", func_544(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, -1, 4, 4, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 27:
			func_542(uParam1, "Josh1", func_544(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_543(iParam0), 1, 0);
			break;
		
		case 28:
			func_542(uParam1, "Josh2", func_544(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0, 29, 4, 4, 0, 2359, func_543(iParam0), 1, 1);
			break;
		
		case 29:
			func_542(uParam1, "Josh3", func_544(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_543(iParam0), 1, 1);
			break;
		
		case 30:
			func_542(uParam1, "Josh4", func_544(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1, 4, 4, 0, 2359, func_543(iParam0), 1, 0);
			break;
		
		case 31:
			func_542(uParam1, "Maude1", func_544(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0, "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 32:
			func_542(uParam1, "Minute1", func_544(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 33:
			func_542(uParam1, "Minute2", func_544(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 34:
			func_542(uParam1, "Minute3", func_544(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0, -1, 4, 4, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 35:
			func_542(uParam1, "MrsPhilips1", func_544(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0, "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_543(iParam0), 0, 0);
			break;
		
		case 36:
			func_542(uParam1, "MrsPhilips2", func_544(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_543(iParam0), 0, 0);
			break;
		
		case 37:
			func_542(uParam1, "Nigel1", func_544(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1, -1, 1, 4, 0, 2359, func_543(iParam0), 1, 0);
			break;
		
		case 38:
			func_542(uParam1, "Nigel1A", func_544(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_543(iParam0), 1, 1);
			break;
		
		case 39:
			func_542(uParam1, "Nigel1B", func_544(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_543(iParam0), 1, 1);
			break;
		
		case 40:
			func_542(uParam1, "Nigel1C", func_544(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_543(iParam0), 1, 1);
			break;
		
		case 41:
			func_542(uParam1, "Nigel1D", func_544(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_543(iParam0), 1, 1);
			break;
		
		case 42:
			func_542(uParam1, "Nigel2", func_544(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_543(iParam0), 1, 1);
			break;
		
		case 43:
			func_542(uParam1, "Nigel3", func_544(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16, "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_543(iParam0), 1, 1);
			break;
		
		case 44:
			func_542(uParam1, "Omega1", func_544(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_543(iParam0), 0, 0);
			break;
		
		case 45:
			func_542(uParam1, "Omega2", func_544(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_543(iParam0), 0, 0);
			break;
		
		case 46:
			func_542(uParam1, "Paparazzo1", func_544(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 47:
			func_542(uParam1, "Paparazzo2", func_544(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 48:
			func_542(uParam1, "Paparazzo3", func_544(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183, 1, -1, 2, 2, 0, 2359, func_543(iParam0), 0, 0);
			break;
		
		case 49:
			func_542(uParam1, "Paparazzo3A", func_544(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 50:
			func_542(uParam1, "Paparazzo3B", func_544(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 51:
			func_542(uParam1, "Paparazzo4", func_544(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1, -1, 4, 2, 0, 2359, func_543(iParam0), 0, 0);
			break;
		
		case 52:
			func_542(uParam1, "Rampage1", func_544(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_543(iParam0), 0, 0);
			break;
		
		case 54:
			func_542(uParam1, "Rampage3", func_544(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_543(iParam0), 1, 0);
			break;
		
		case 55:
			func_542(uParam1, "Rampage4", func_544(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_543(iParam0), 1, 0);
			break;
		
		case 56:
			func_542(uParam1, "Rampage5", func_544(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_543(iParam0), 0, 0);
			break;
		
		case 53:
			func_542(uParam1, "Rampage2", func_544(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0, "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_543(iParam0), 1, 0);
			break;
		
		case 57:
			func_542(uParam1, "TheLastOne", func_544(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, -1, 4, 2, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 58:
			func_542(uParam1, "Tonya1", func_544(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 59:
			func_542(uParam1, "Tonya2", func_544(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 60:
			func_542(uParam1, "Tonya3", func_544(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 61:
			func_542(uParam1, "Tonya4", func_544(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_543(iParam0), 0, 1);
			break;
		
		case 62:
			func_542(uParam1, "Tonya5", func_544(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0, -1, 4, 2, 0, 2359, func_543(iParam0), 0, 1);
			break;
...
void func_542(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_546()
{
	...
	iVar0 = func_547(&(Global_92955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_550()
{
	...
	{
		if (func_540(&(Global_92955.f_3)) > -1)
		{
			return 1;
		}
	}
