	...
	while (true)
	{
		...
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			switch (iLocal_45)
			{
				...
				case 2:
					iLocal_52 = VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 35f, 0, 101383);
					if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_52, 0))
					{
						if (!bLocal_92)
						{
				...
				case 3:
					...
					else
					{
						...
						iLocal_51 = PED::GET_RANDOM_PED_AT_COORD(vLocal_46, 1.5f, 1.5f, 1.5f, 4294967295);
						...
						if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), vLocal_46) > 5625f && !CAM::IS_SPHERE_VISIBLE(vLocal_46, 10f))
						{
							func_22();
						}
					}
...
void func_3()//Position - 0x662
{
	if (func_4())
	{
		if (!PED::IS_PED_INJURED(iLocal_49))
		{
			ENTITY::SET_ENTITY_HEALTH(iLocal_49, false);
			BRAIN::TASK_SMART_FLEE_COORD(iLocal_49, vLocal_46, 50f, 4294967295, 0, 0);
			PED::SET_PED_KEEP_TASK(iLocal_49, true);
		...
		if (!PED::IS_PED_INJURED(iLocal_50))
		{
			...
			BRAIN::TASK_SMART_FLEE_COORD(iLocal_50, vLocal_46, 50f, 4294967295, 0, 0);
...
bool func_4()//Position - 0x86D
{
	...
	if (!PED::IS_PED_INJURED(iLocal_49))
	{
		...
		if (FIRE::IS_EXPLOSION_IN_ANGLED_AREA(4294967295, -90.68654f, 6411.883f, 36.00729f, -103.86f, 6398.848f, 30.19453f, 23f) || FIRE::IS_EXPLOSION_IN_SPHERE(4294967295, PED::GET_PED_BONE_COORDS(iLocal_49, 31086, 0f, 0f, 0f), 20f))
		{
			bLocal_90 = true;
			bVar0 = true;
		}
...
int func_33()//Position - 0x1F04
{
	return Global_1407E0;
}

int func_34(int iParam0, int iParam1)//Position - 0x1F10
{
	switch (iParam0)
	{
		case 0:
...
void func_36(int iParam0)//Position - 0x22B3
{
	int iVar0;
	int iVar1;
...
void func_37(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x22F5
{
	func_38(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_38(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2317
{
	int iVar0;
...
int func_41(int iParam0)//Position - 0x2651
{
	int iVar0;
	int iVar1;
...
void func_42(int iParam0, int iParam1)//Position - 0x2694
{
	MISC::SET_BIT(&(Global_19E56.f_6187.f_8[iParam0]), iParam1);
}

int func_43(int iParam0)//Position - 0x26AF
{
	int iVar0;
...
int func_45(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x277D
{
...
int func_46()//Position - 0x2957
{
	return 1;
}

int func_47()//Position - 0x2960
{
	if (!iLocal_73)
	{
		SYSTEM::WAIT(0);
		if (!PED::IS_PED_INJURED(iLocal_49))
		{
			if (iLocal_64 == 4294967295)
			{
				...
				BRAIN::TASK_PLAY_ANIM(iLocal_49, sLocal_99, "girl_villian_shot", 8f, -2f, 4294967295, 10, 0, 0, 0, 0);
				iLocal_64 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_66, vLocal_67, 2);
				if (!PED::IS_PED_INJURED(iLocal_50))
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_50, iLocal_55);
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -91.30704f, 6391.854f, 30.6403f, -102.5595f, 6403.103f, 32.45444f, 8.5f, 0, true, 0))
					{
...
void func_48()//Position - 0x2BBC
{
	Global_3960 = 0;
	func_49();
}

void func_49()//Position - 0x2BCC
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_50(var uParam0, int iParam1)//Position - 0x2BED
{
...
void func_51()//Position - 0x2C0A
{
	if (((((((((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -91.30704f, 6391.854f, 30.6403f, -102.5595f, 6403.103f, 32.45444f, 8.5f, 0, true, 0) && PED::_CAN_PED_SEE_PED(iLocal_48, AUDIO::_0x0626A247D2405330())) || (func_61(iLocal_48, &uLocal_58, &iLocal_59, 0, 0, 1077936128, 0) && PED::_CAN_PED_SEE_PED(iLocal_48, AUDIO::_0x0626A247D2405330()))) || (func_60(1) && PED::_CAN_PED_SEE_PED(iLocal_48, AUDIO::_0x0626A247D2405330()))) || func_58()) || func_57()) || func_4()) || func_56()) || PED::IS_PED_RAGDOLL(iLocal_48)) || func_55()) || func_54()) || func_52(iLocal_48))
	{
	...
	{
		if ((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_48) && PED::_CAN_PED_SEE_PED(iLocal_48, AUDIO::_0x0626A247D2405330())) || (PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_48) && PED::_CAN_PED_SEE_PED(iLocal_48, AUDIO::_0x0626A247D2405330())))
		{
			if (HUD::DOES_BLIP_EXIST(iLocal_53))
			{
...
int func_52(int iParam0)//Position - 0x2EE3
{
	int iVar0;
	bool bVar1;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(AUDIO::_0x0626A247D2405330(), iVar0, joaat("component_at_ar_flsh")))
	{
		if (WEAPON::IS_PED_WEAPON_COMPONENT_ACTIVE(AUDIO::_0x0626A247D2405330(), iVar0, joaat("component_at_ar_flsh")))
		{
			bVar1 = true;
		}
	}
	else if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(AUDIO::_0x0626A247D2405330(), iVar0, joaat("component_at_pi_flsh")))
	{
		if (WEAPON::IS_PED_WEAPON_COMPONENT_ACTIVE(AUDIO::_0x0626A247D2405330(), iVar0, joaat("component_at_pi_flsh")))
		{
			bVar1 = true;
		}
	}
	if (bVar1)
	{
		...
		{
			if (SYSTEM::VDIST(unk_0x8000C77B5F336760(iParam0, true), func_53(CAM::_0xDC9DA9E8789F5246())) < 8f)
			{
				return 1;
			}
		}
...
Vector3 func_53(int iParam0)//Position - 0x2FA9
{
	return unk_0x8000C77B5F336760(PLAYER::GET_PLAYER_PED(iParam0), false);
}

int func_54()//Position - 0x2FBC
{
	if (func_95())
	{
...
int func_55()//Position - 0x2FF9
{
	...
	fVar0 = 75f;
	iVar4 = PED::GET_RANDOM_PED_AT_COORD(unk_0x8000C77B5F336760(iLocal_48, false), fVar0, fVar0, fVar0, 4294967295);
	...
	iVar5 = VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(unk_0x8000C77B5F336760(iLocal_48, false), fVar0, 0, 66561);
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iVar5, 0))
	{
		return 1;
	}
	...
	if (iVar3 > 0)
	{
		...
		while (iVar2 < iVar3)
		{
			if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(uVar1[iVar2], 0))
			{
...
int func_56()//Position - 0x30FE
{
	if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_48, AUDIO::_0x0626A247D2405330(), 2f, 2f, 1.5f, 0, 1, 0))
	{
		if (PLAYER::CAN_PED_HEAR_PLAYER(CAM::_0xDC9DA9E8789F5246(), iLocal_48))
		{
			return 1;
		}
	}
...
bool func_57()//Position - 0x312F
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
		if (ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)) == joaat("BULLDOZER"))
		{
			if (!PED::IS_PED_INJURED(iLocal_50))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), iLocal_50))
				{
					bVar0 = true;
				}
			}
			if (!PED::IS_PED_INJURED(iLocal_49))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), iLocal_49))
				{
					bVar0 = true;
				}
			}
			if (!PED::IS_PED_INJURED(iLocal_48))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), iLocal_48))
				{
					bVar0 = true;
				}
			}
...
bool func_58()//Position - 0x31BF
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
		MISC::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)), &uVar3, &Var4);
		fVar6 = Var4.f_1;
		if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TRAILER(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
		{
			if (VEHICLE::GET_VEHICLE_TRAILER_VEHICLE(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), &iVar8))
			{
		...
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_48, (fVar6 + 17f), (fVar6 + 17f), 6f, 0, 1, 0))
			{
				bVar1 = true;
			}
		}
		...
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_48, (fVar6 + 12f), (fVar6 + 12f), 6f, 0, 1, 0))
			{
				bVar1 = true;
			}
		}
		else if (ENTITY::GET_ENTITY_SPEED(AUDIO::_0x0626A247D2405330()) > 5f)
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_48, (fVar6 + 8f), (fVar6 + 8f), 6f, 0, 1, 0))
			{
				bVar1 = true;
			}
		}
	...
	if (bVar1)
	{
		vVar2 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true) - vLocal_46 };
		fVar5 = MISC::GET_HEADING_FROM_VECTOR_2D(vVar2.x, vVar2.y);
		if (func_59(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), fVar5, 15f))
		{
			bVar0 = true;
		}
		vVar2 = { vLocal_46 - unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true) };
		fVar5 = MISC::GET_HEADING_FROM_VECTOR_2D(vVar2.x, vVar2.y);
		if (func_59(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), fVar5, 15f))
		{
			bVar0 = true;
...
int func_59(int iParam0, float fParam1, float fParam2)//Position - 0x3391
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_60(int iParam0)//Position - 0x3418
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
int func_61(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, float fParam5, int iParam6)//Position - 0x3472
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
void func_62(char* sParam0, int iParam1)//Position - 0x36D0
{
	func_64(sParam0);
	func_63(iParam1);
}

void func_63(int iParam0)//Position - 0x36E4
{
	if (iParam0 > 0)
	{
	}
...
void func_64(char* sParam0)//Position - 0x36F2
{
...
void func_65(int iParam0)//Position - 0x3705
{
	AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(iParam0);
}

void func_66(char* sParam0)//Position - 0x3713
{
	func_64(sParam0);
}

int func_67(int iParam0, int iParam1)//Position - 0x3721
{
...
void func_68()//Position - 0x376E
{
	if (((ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -62.6571f, 6447.08f, 40.49928f, -153.6411f, 6354.579f, 23.99063f, 144.25f, 0, true, 0) || CAM::IS_SPHERE_VISIBLE(vLocal_46, 15f)) || bLocal_68) || func_4())
	{
...
int func_69(int iParam0)//Position - 0x37FE
{
	if (func_73())
	{
		Global_19E4C = 1;
		Global_19E49 = MISC::GET_GAME_TIMER();
		if (func_35(Global_19E4B))
		{
			func_70(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_35(Global_19E4B))
		{
...
void func_70(int iParam0)//Position - 0x3851
{
	switch (iParam0)
	{
		case 0:
			if (Global_19E56.f_6187.f_2 < 3)
			{
				...
				{
					func_71(func_72(iParam0), 4294967295);
...
void func_71(char* sParam0, int iParam1)//Position - 0x3932
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_72(int iParam0)//Position - 0x3949
{
	char* sVar0;
...
int func_73()//Position - 0x398D
{
	switch (func_74(&Global_63AE, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_74(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x39C3
{
	int iVar0;
...
void func_75(var uParam0, int iParam1)//Position - 0x3AFA
{
	int iVar0;
...
bool func_76(int iParam0)//Position - 0x3B49
{
	return func_77(iParam0, Global_8D15);
}

int func_77(int iParam0, int iParam1)//Position - 0x3B5A
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_78(int iParam0)//Position - 0x3D3B
{
	if (Global_8D15 == 15)
	{
		return 0;
...
int func_79(int iParam0, bool bParam1, int iParam2)//Position - 0x3D5D
{
	iParam2 = iParam2;
	return func_80(iParam0, bParam1, 145);
}

int func_80(int iParam0, bool bParam1, int iParam2)//Position - 0x3D73
{
	int iVar0;
...
int func_81(int iParam0, bool bParam1, bool bParam2)//Position - 0x3DC5
{
	int iVar0;
...
float func_82(bool bParam0, float fParam1, float fParam2)//Position - 0x3E69
{
	if (bParam0)
	{
		return fParam1;
...
int func_83()//Position - 0x3E80
{
	...
	{
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(AUDIO::_0x0626A247D2405330())) > 1369f && !func_90())
		{
			return 0;
		}
	}
	if (func_84(100f, 1) != 4294967295)
	{
		return 1;
	}
	return 0;
...
int func_84(float fParam0, bool bParam1)//Position - 0x3EE2
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_85(int iParam0, var uParam1)//Position - 0x3F99
{
	switch (iParam0)
	{
		case 0:
		...
		case 1:
			func_86(uParam1, "Abigail2", func_88(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, 4294967295, 4, 1, 0, 2359, func_87(iParam0), 1, 0);
			break;
		
		case 2:
			func_86(uParam1, "Barry1", func_88(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 0, 2359, func_87(iParam0), 1, 0);
			break;
		
		case 3:
			func_86(uParam1, "Barry2", func_88(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_87(iParam0), 1, 1);
			break;
		
		case 4:
			func_86(uParam1, "Barry3", func_88(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", 4294967295, 0, "", 164, 1, 4294967295, 0, 2, 0, 2359, func_87(iParam0), 0, 0);
			break;
		...
		case 7:
			func_86(uParam1, "Barry4", func_88(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, 4294967295, 4, 2, 800, 2000, func_87(iParam0), 0, 0);
			break;
		
		case 8:
			func_86(uParam1, "Dreyfuss1", func_88(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_87(iParam0), 0, 0);
			break;
		...
		case 15:
			func_86(uParam1, "Epsilon7", func_88(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", 4294967295, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_87(iParam0), 0, 0);
			break;
		
		case 16:
			func_86(uParam1, "Epsilon8", func_88(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, 4294967295, 4, 1, 0, 2359, func_87(iParam0), 1, 0);
			break;
		
		case 17:
			func_86(uParam1, "Extreme1", func_88(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", 4294967295, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_87(iParam0), 0, 1);
			break;
		...
		case 20:
			func_86(uParam1, "Extreme4", func_88(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_87(iParam0), 0, 0);
			break;
		
		case 21:
			func_86(uParam1, "Fanatic1", func_88(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 700, 2000, func_87(iParam0), 1, 0);
			break;
		
		case 22:
			func_86(uParam1, "Fanatic2", func_88(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 700, 2000, func_87(iParam0), 1, 0);
			break;
		
		case 23:
			func_86(uParam1, "Fanatic3", func_88(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 2, 700, 2000, func_87(iParam0), 0, 1);
			break;
		
		case 24:
			func_86(uParam1, "Hao1", func_88(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", 4294967295, 0, "controller_Races", 13, 1, 4294967295, 4, 2, 2000, 500, func_87(iParam0), 0, 1);
			break;
		
		case 25:
			func_86(uParam1, "Hunting1", func_88(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", 4294967295, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_87(iParam0), 0, 1);
			break;
		
		case 26:
			func_86(uParam1, "Hunting2", func_88(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, 4294967295, 4, 4, 0, 2359, func_87(iParam0), 0, 1);
			break;
		
		case 27:
			func_86(uParam1, "Josh1", func_88(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", 4294967295, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_87(iParam0), 1, 0);
			break;
		...
		case 29:
			func_86(uParam1, "Josh3", func_88(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 4294967295, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_87(iParam0), 1, 1);
			break;
		
		case 30:
			func_86(uParam1, "Josh4", func_88(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", 4294967295, 36, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_87(iParam0), 1, 0);
			break;
		
		case 31:
			func_86(uParam1, "Maude1", func_88(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", 4294967295, 0, "BailBond_Launcher", 0, 1, 4294967295, 4, 4, 0, 2359, func_87(iParam0), 0, 1);
			break;
		
		case 32:
			func_86(uParam1, "Minute1", func_88(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", 4294967295, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_87(iParam0), 0, 1);
			break;
		
		case 33:
			func_86(uParam1, "Minute2", func_88(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", 4294967295, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_87(iParam0), 0, 1);
			break;
		
		case 34:
			func_86(uParam1, "Minute3", func_88(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", 4294967295, 10, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_87(iParam0), 0, 1);
			break;
		
		case 35:
			func_86(uParam1, "MrsPhilips1", func_88(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", 4294967295, 0, "ambient_MrsPhilips", 0, 1, 4294967295, 4, 4, 0, 2359, func_87(iParam0), 0, 0);
			break;
		
		case 36:
			func_86(uParam1, "MrsPhilips2", func_88(iParam0), 0, 11, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_87(iParam0), 0, 0);
			break;
		
		case 37:
			func_86(uParam1, "Nigel1", func_88(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", 4294967295, 0, "", 177, 1, 4294967295, 1, 4, 0, 2359, func_87(iParam0), 1, 0);
			break;
		...
		case 42:
			func_86(uParam1, "Nigel2", func_88(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", 4294967295, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_87(iParam0), 1, 1);
			break;
		
		case 43:
			func_86(uParam1, "Nigel3", func_88(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", 4294967295, 16, "postRC_Nigel3", 0, 0, 4294967295, 4, 4, 0, 2359, func_87(iParam0), 1, 1);
			break;
		
		case 44:
			func_86(uParam1, "Omega1", func_88(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", 4294967295, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_87(iParam0), 0, 0);
			break;
		
		case 45:
			func_86(uParam1, "Omega2", func_88(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_87(iParam0), 0, 0);
			break;
		
		case 46:
			func_86(uParam1, "Paparazzo1", func_88(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", 4294967295, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_87(iParam0), 0, 1);
			break;
		
		case 47:
			func_86(uParam1, "Paparazzo2", func_88(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", 4294967295, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_87(iParam0), 0, 1);
			break;
		
		case 48:
			func_86(uParam1, "Paparazzo3", func_88(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", 4294967295, 8, "", 183, 1, 4294967295, 2, 2, 0, 2359, func_87(iParam0), 0, 0);
			break;
		...
		case 51:
			func_86(uParam1, "Paparazzo4", func_88(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", 4294967295, 8, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_87(iParam0), 0, 0);
			break;
		
		case 52:
			func_86(uParam1, "Rampage1", func_88(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", 4294967295, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_87(iParam0), 0, 0);
			break;
		
		case 54:
			func_86(uParam1, "Rampage3", func_88(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", 4294967295, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_87(iParam0), 1, 0);
			break;
		
		case 55:
			func_86(uParam1, "Rampage4", func_88(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", 4294967295, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_87(iParam0), 1, 0);
			break;
		
		case 56:
			func_86(uParam1, "Rampage5", func_88(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", 4294967295, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_87(iParam0), 0, 0);
			break;
		
		case 53:
			func_86(uParam1, "Rampage2", func_88(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", 4294967295, 0, "rampage_controller", 0, 0, 4294967295, 4, 4, 0, 2359, func_87(iParam0), 1, 0);
			break;
		
		case 57:
			func_86(uParam1, "TheLastOne", func_88(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_87(iParam0), 0, 1);
			break;
		
		case 58:
			func_86(uParam1, "Tonya1", func_88(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", 4294967295, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_87(iParam0), 0, 1);
			break;
		
		case 59:
			func_86(uParam1, "Tonya2", func_88(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_87(iParam0), 0, 1);
			break;
		
		case 60:
			func_86(uParam1, "Tonya3", func_88(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_87(iParam0), 0, 1);
			break;
		
		case 61:
			func_86(uParam1, "Tonya4", func_88(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_87(iParam0), 0, 1);
			break;
		
		case 62:
			func_86(uParam1, "Tonya5", func_88(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_87(iParam0), 0, 1);
			break;
...
{
	if ((Global_19E4B == func_44() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_19E4C)
	{
		return 1;
	}
	return 0;
...
void func_97()//Position - 0x5C74
{
	if (!iLocal_75)
	{
		if (!PED::IS_PED_INJURED(iLocal_48))
		{
			...
			if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_48, AUDIO::_0x0626A247D2405330(), 50f, 50f, 50f, 0, 1, 0))
			{
				BRAIN::TASK_COMBAT_PED(iLocal_48, AUDIO::_0x0626A247D2405330(), 0, 16);
				ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_48, 1);
			}
			else
			{
				BRAIN::TASK_SMART_FLEE_PED(iLocal_48, AUDIO::_0x0626A247D2405330(), 200f, 4294967295, 0, 0);
			}
...
void func_99()//Position - 0x5D5A
{
	...
	func_102();
	PATHFIND::GET_CLOSEST_VEHICLE_NODE(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), &vLocal_46, 1, 1077936128, 0);
	...
	if (iLocal_72)
	{
		...
		else
		{
			if (!PED::IS_PED_INJURED(iLocal_50))
			{
				if (!PED::IS_PED_INJURED(iLocal_48))
				{
					BRAIN::TASK_SMART_FLEE_PED(iLocal_50, iLocal_48, 100f, 4294967295, 0, 0);
				}
				else
				{
...
void func_102()//Position - 0x5F0A
{
	...
	if (bLocal_90 == 0)
	{
		if (!PED::IS_PED_INJURED(iLocal_50) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			if (iLocal_72)
			{
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_71);
				BRAIN::TASK_GO_TO_ENTITY(0, AUDIO::_0x0626A247D2405330(), 20000, 5f, 2f, 1073741824, 0);
			...
			else
			{
				...
				BRAIN::TASK_LOOK_AT_COORD(0, vLocal_46, 4294967295, 2048, 2);
				BRAIN::TASK_PLAY_ANIM(0, sLocal_99, "bystander_bystander_angry", 8f, -8f, 1500, 0, 0, 0, 0, 0);
				CUTSCENE::_0x8D9DF6ECA8768583(iLocal_71);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_50, iLocal_71);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_71);
...
void func_103()//Position - 0x601C
{
	if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_49, AUDIO::_0x0626A247D2405330(), 1))
	{
		if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(CAM::_0xDC9DA9E8789F5246(), 2))
		{
			PLAYER::SET_PLAYER_WANTED_LEVEL_NO_DROP(CAM::_0xDC9DA9E8789F5246(), 2, 0);
			HUD::_0x84698AB38D0C6636(CAM::_0xDC9DA9E8789F5246(), 0);
		}
...
{
	if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_46, 50f, 50f, 25f, false, true, 0))
	{
		iLocal_98 = 0;
	}
	else
...
int func_106()//Position - 0x613B
{
	...
	if (((STREAMING::HAS_MODEL_LOADED(iVar0) && STREAMING::HAS_MODEL_LOADED(iVar2)) && STREAMING::HAS_MODEL_LOADED(iVar1)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_99))
	{
		...
		WEAPON::GIVE_WEAPON_TO_PED(iLocal_48, joaat("weapon_pistol"), 4294967295, true, true);
		NETWORK::_SET_NETWORK_OBJECT_NON_CONTACT(iLocal_48, 1);
		...
		iLocal_55 = PED::GET_PED_RELATIONSHIP_GROUP_HASH(AUDIO::_0x0626A247D2405330());
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_56, iLocal_55);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_55, iLocal_56);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_50, iLocal_57);
		...
		func_108(&Local_93, 0, AUDIO::_0x0626A247D2405330(), sLocal_82, 0, 1);
...
int func_115(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x6679
{
	...
	if (!bVar0)
	{
		...
		if (!func_151(Global_19E56.f_6187.f_2B[iParam1]))
		{
			return 0;
		}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_129(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_149()) || Global_19A9D) || Global_6375) || func_148()) || func_19(8, 4294967295)) || func_147()) || func_146()) || func_145()) || func_144()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_149()) || Global_6375) || func_148()) || func_19(8, 4294967295)) || func_145()) || func_147()) || func_146()) || func_144()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_149()) || Global_19A9D) || Global_6375) || func_148()) || func_19(8, 4294967295)) || func_145()) || func_147()) || func_146()) || func_144()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_149()) || Global_19A9D) || Global_6375) || func_148()) || func_19(8, 4294967295)) || func_147()) || func_146()) || func_144()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_149() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_19(8, 4294967295)) || func_144()) || func_143()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_19(8, 4294967295) || func_147()) || func_146()) || func_143()) || func_142())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_149()) || Global_6375) || func_148()) || func_19(8, 4294967295)) || func_146()) || func_145()) || func_144()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
void func_157()//Position - 0x7CFE
{
	...
	if (!PED::IS_PED_INJURED(iLocal_48) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		BRAIN::TASK_SMART_FLEE_PED(iLocal_48, AUDIO::_0x0626A247D2405330(), 100f, 4294967295, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_48, true);
		SYSTEM::WAIT(0);
	}
	func_158(4294967295);
...
void func_158(int iParam0)//Position - 0x7D82
{
	...
	if (func_95())
	{
		...
		func_161(30000);
		StringCopy(&cVar0, func_160(Global_19E4B, 1), 64);
		if (func_43(Global_19E4B) > 0)
		{
