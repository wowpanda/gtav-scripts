...
int func_2()
{
	...
	if (!func_3(&uVar0))
	{
		vVar1 = { GET_ENTITY_COORDS(uLocal_72, 0) };
		fVar4 = VDIST2(vLocal_176 + vLocal_181, vVar1);
		if (fVar4 < (4.5f * 4.5f))
		{
			TASK_VEHICLE_DRIVE_WANDER(uLocal_72, uLocal_74, uLocal_179, 786599);
			return 1;
		}
	}
	return 0;
...
int func_3(var uParam0)
{
	...
	if (IS_VEHICLE_DRIVEABLE(uLocal_74, 0))
	{
	}
	else
	{
...
int func_4()
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
		{
			...
			if (!func_5(Global_93403, uLocal_74, 2))
			{
				if (fVar1 >= 0.9f)
				{
					SET_PED_INTO_VEHICLE(Global_93403, uLocal_74, 2);
				}
			}
			if (!iLocal_180)
			{
				FREEZE_ENTITY_POSITION(uLocal_72, 0);
				iLocal_180 = 1;
			}
			TASK_VEHICLE_TEMP_ACTION(uLocal_72, uLocal_74, 6, 50);
		}
		else
		{
			if (!func_5(Global_93403, uLocal_74, 2))
			...
			STOP_SYNCHRONIZED_ENTITY_ANIM(uLocal_74, -8f, 1);
			WAIT(100);
			if (!func_3(&uVar0))
			{
				OPEN_SEQUENCE_TASK(&uVar2);
				TASK_VEHICLE_TEMP_ACTION(0, uLocal_74, 24, 50);
				TASK_PAUSE(0, 2000);
				TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_74, vLocal_176 + vLocal_181, uLocal_179, 0, uLocal_75, 786599, ((4.5f / 2f) - 1f), 10f);
				CLOSE_SEQUENCE_TASK(uVar2);
				TASK_PERFORM_SEQUENCE(uLocal_72, uVar2);
...
void func_21()
{
	...
	SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_73, 1);
	uLocal_74 = GET_RANDOM_VEHICLE_IN_SPHERE(vLocal_181 + vLocal_173, 15f, uLocal_75, 2);
	iVar0 = 0;
	while ((!DOES_ENTITY_EXIST(Global_93403) || !DOES_ENTITY_EXIST(uLocal_74)) || (!HAS_MODEL_LOADED(iLocal_73) && iVar0 < 400))
	{
		if (!DOES_ENTITY_EXIST(uLocal_74))
		{
			uLocal_74 = GET_RANDOM_VEHICLE_IN_SPHERE(vLocal_181 + vLocal_173, 15f, uLocal_75, 2);
		}
		iVar0++;
	...
	{
		SET_PED_RELATIONSHIP_GROUP_HASH(Global_93403, Global_88716);
		SET_AMBIENT_VOICE_NAME(Global_93403, "A_F_Y_BevHills_01_White_FULL_01");
	}
	if (!IS_ENTITY_DEAD(uLocal_74, 0))
	{
		SET_VEHICLE_ENGINE_ON(uLocal_74, 1, 1, 0);
		SET_VEHICLE_DOORS_LOCKED(uLocal_74, 2);
		SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_74, 1084227584);
		uLocal_72 = CREATE_PED_INSIDE_VEHICLE(uLocal_74, 4, iLocal_73, -1, 1, 1);
		SET_PED_RANDOM_COMPONENT_VARIATION(uLocal_72, 0);
...
void func_22()
{
	...
	func_41(iLocal_70, &vLocal_181, &uLocal_184, &cVar0);
	iLocal_73 = joaat("a_m_m_eastsa_02");
	func_28(1, iLocal_70, &uLocal_75, &vLocal_173, &uVar8, &vLocal_176, &uLocal_179);
	Var9.f_1 = -1;
	Var9.f_17 = 4;
	Var9.f_17.f_8 = 4;
	Var9.f_17.f_13 = 4;
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_26(uParam109, 17, 1785177548, 1785177548, GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_26(uParam109, 144, 1785177548, 1785177548, GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_26(uParam109, 43, 1785177548, 1785177548, GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
...
void func_26(var uParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, float fParam7)
{
...
void func_49()
{
	if (!IS_ENTITY_DEAD(uLocal_72, 0) && DOES_ENTITY_BELONG_TO_THIS_SCRIPT(uLocal_72, 1))
	{
		SET_PED_AS_NO_LONGER_NEEDED(&uLocal_72);
	}
	if (!IS_ENTITY_DEAD(uLocal_74, 0) && DOES_ENTITY_BELONG_TO_THIS_SCRIPT(uLocal_74, 1))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_74);
	}
	SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_73, 0);
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_73);
	SET_GAME_PAUSED(0);
