...
void func_3(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_5(Global_105220.f_18504[iVar0], &vVar2, &fVar3))
			{
...
void func_17(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_105220.f_20535.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_19() /*12171*/].f_7688.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_105220.f_20535.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_19() /*12171*/].f_7688.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_23(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_19() /*12171*/].f_7688.f_10, iParam0);
}
...
int func_57(int iParam0, float fParam1)
{
...
float func_60(var uParam0)
{
	if (func_63(uParam0))
	{
		...
		{
			return (func_61(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
void func_66(int iParam0, float fParam1)
{
	iParam0->f_1 = (func_61(MISC::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
void func_83(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, char* sParam10, int iParam11)
{
	...
	func_116(uParam0, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
...
struct<4> func_88(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_89(&(Global_105220.f_19932), iVar1, 1);
	}
...
struct<4> func_99(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	if ((((!func_104(&(Global_105220.f_19932), 8) && iParam1) && iParam0 != 4) && func_102(3) > 0) && MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) < 0.75f)
	{
		iVar1 = 8;
		*uParam3 = 4;
	}
	...
	if (bParam2)
	{
		func_100(&(Global_105220.f_19932), iVar1, 1);
	}
...
void func_106(var uParam0, var uParam1, var uParam2, int iParam3)
{
	if (iParam3 == 0)
	{
		func_85(uParam0, uParam1, uParam2, "DRF_OVG", MISC::GET_RANDOM_INT_IN_RANGE(1, 3), 1, 0);
		func_85(uParam0, uParam1, uParam2, "DRF_TMG", func_108(func_109(), 0, 2), 1, 0);
	}
	else if (iParam3 == 1)
	{
		func_85(uParam0, uParam1, uParam2, "DRF_OVO", MISC::GET_RANDOM_INT_IN_RANGE(1, 3), 1, 0);
...
{
	if (Global_89561 != 0 && (MISC::GET_GAME_TIMER() - Global_89561) < 1800000)
	{
		return 0;
	}
	HUD::REQUEST_ADDITIONAL_TEXT("SHRINK", 0);
	...
	func_116(uParam0, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	func_116(uParam0, 1, 0, "FRIEDLANDER", 0, 1);
	Global_89561 = MISC::GET_GAME_TIMER();
	return 1;
}
