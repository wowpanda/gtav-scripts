...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_57.f_4)
	{
		...
		case 2:
			if (func_48(PLAYER::PLAYER_PED_ID(), uParam0[uParam0->f_57.f_2 /*14*/]))
			{
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				uParam0->f_57.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_37(uParam0), func_36(uParam0), 2, true, false, 1065353216, 0, 1065353216);
...
int func_45(var uParam0)
{
	...
	while (iVar0 < NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if ((iVar1 != PLAYER::PLAYER_ID() && func_46(iVar1, 1, 1)) && func_48(PLAYER::GET_PLAYER_PED(iVar1), uParam0[uParam0->f_57.f_2 /*14*/]))
			{
				return 1;
			}
		}
...
void func_54(var uParam0)
{
	...
	func_55(&(uParam0->f_57), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0));
	func_55(&(uParam0->f_57), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1));
	func_55(&(uParam0->f_57), 0, func_35(0));
	func_55(&(uParam0->f_57), 2, BRAIN::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
...
int func_70()
{
	if (Global_1589140 != func_58())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_entrance_seats", Global_1589140, 1, 0))
		{
			return 0;
		}
...
void func_71()
{
	...
	iVar0[0] = 0;
	iVar0[1] = 1;
	func_72(0, &uLocal_144, &iVar0);
	iVar0[0] = 2;
	iVar0[1] = 3;
	func_72(1, &uLocal_144, &iVar0);
}
...
Vector3 func_75(vector3 vParam0, float fParam1)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
