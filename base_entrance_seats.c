...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_57.f_4)
	{
		...
		case 2:
			if (func_49(PLAYER_PED_ID(), uParam0[uParam0->f_57.f_2 /*14*/]))
			{
		...
		case 5:
			...
			{
				uParam0->f_57.f_1 = NETWORK_CREATE_SYNCHRONISED_SCENE(func_38(uParam0), func_37(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uParam0->f_57.f_1, &sVar0, &sVar16, 2f, -1000f, 13, 16, 1.5f, 0);
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			uVar42 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_57.f_1);
			if (IS_SYNCHRONIZED_SCENE_RUNNING(uVar42))
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(uVar42) >= 1f)
				{
					...
					func_39(uParam0, &sVar16);
					uParam0->f_57.f_1 = NETWORK_CREATE_SYNCHRONISED_SCENE(func_38(uParam0), func_37(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
					NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uParam0->f_57.f_1, &sVar0, &sVar16, 4f, -1.5f, 13, 16, 1000f, 0);
					NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_57.f_1);
					func_25(&(uParam0->f_57), 8);
		...
		case 8:
			uVar43 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_57.f_1);
...
int func_46(var uParam0)
{
	...
	while (iVar0 < _NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK_IS_PARTICIPANT_ACTIVE(INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if ((iVar1 != PLAYER_ID() && func_47(iVar1, 1, 1)) && func_49(GET_PLAYER_PED(iVar1), uParam0[uParam0->f_57.f_2 /*14*/]))
			{
				return 1;
			}
		}
...
void func_55(var uParam0)
{
	...
	func_56(&(uParam0->f_57), 1, IS_ENTITY_DEAD(PLAYER_PED_ID(), 0));
	func_56(&(uParam0->f_57), 3, IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1));
	func_56(&(uParam0->f_57), 0, func_35(0));
	func_56(&(uParam0->f_57), 2, IS_PED_RUNNING(PLAYER_PED_ID()));
}
...
{
	return IS_ENTITY_IN_ANGLED_AREA(uParam0, 451.6327f, 4829.453f, -54.97165f, 499.981f, 4842.034f, -50.67961f, 30.75f, 0, 1, 0);
}
...
int func_72()
{
	if (Global_1589667 != func_59())
	{
		if (NETWORK_IS_SCRIPT_ACTIVE("base_entrance_seats", Global_1589667, 1, 0))
		{
			return 0;
		}
...
void func_74(int iParam0, var uParam1, int iParam2)
{
	...
	func_81(iParam0, &vVar0, &fVar3);
	iVar4 = 0;
	while (iVar4 < 2)
	{
		(*uParam1)[(*iParam2)[iVar4] /*14*/] = 2;
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_8 = { func_77(func_78(iVar4), fVar3) + vVar0 };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_8.f_3 = { 0f, 0f, (fVar3 + 174f) };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_1 = { func_77(func_76(iVar4), fVar3) + vVar0 };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_1.f_3 = { func_77(func_75(iVar4), fVar3) + vVar0 };
