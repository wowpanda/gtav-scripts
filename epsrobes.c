...
void func_1()
{
	...
	if (iLocal_219)
	{
		...
		{
			if ((((!func_171() && !IS_PED_FLEEING(uLocal_53)) && !IS_PED_RAGDOLL(uLocal_53)) && !IS_PED_PRONE(uLocal_53)) && !IS_PED_INJURED(uLocal_53))
			{
				if (func_170(uLocal_53, PLAYER_PED_ID(), 1) <= 3f)
				{
			...
			if (func_170(uLocal_53, PLAYER_PED_ID(), 1) > 150f)
			{
				func_159(&uLocal_53);
			}
		}
	...
	if (IS_PLAYER_PLAYING(PLAYER_ID()) && func_157(0))
	{
		switch (iLocal_222)
		{
			case 0:
				if (func_177(91) && IS_PLAYER_CONTROL_ON(PLAYER_ID()))
				{
					func_154(4, 10, 1);
					...
					iLocal_226 = (Global_106565.f_10043.f_104 + 2 % func_137(GET_CLOCK_MONTH(), GET_CLOCK_YEAR()));
				...
				else if (!func_177(91))
				{
					if (iLocal_50 == 0)
					{
						if (func_134())
						{
							func_133(&uLocal_54, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
			...
			case 1:
				iLocal_223 = func_146();
				iLocal_226 = (Global_106565.f_10043.f_104 + 2 % func_137(GET_CLOCK_MONTH(), GET_CLOCK_YEAR()));
				if ((((func_131(iLocal_223, iLocal_225) || GET_CLOCK_DAY_OF_MONTH() == iLocal_226) && IS_PLAYER_CONTROL_ON(PLAYER_ID())) && GET_ROOM_KEY_FROM_ENTITY(PLAYER_PED_ID()) != GET_HASH_KEY("V_Michael_1_M_Ward")) && GET_ROOM_KEY_FROM_ENTITY(PLAYER_PED_ID()) != GET_HASH_KEY("V_Michael_1_Master"))
				{
			...
			case 2:
				if ((func_37(PLAYER_PED_ID(), 12, iLocal_47) && IS_PLAYER_CONTROL_ON(PLAYER_ID())) && !IS_HELP_MESSAGE_BEING_DISPLAYED())
				{
			...
			case 3:
				if (!func_37(PLAYER_PED_ID(), 12, iLocal_47) && !func_35())
				{
					iLocal_222 = 2;
				}
				...
				if (iLocal_48)
				{
					if ((IS_PLAYER_CONTROL_ON(PLAYER_ID()) && !IS_HELP_MESSAGE_BEING_DISPLAYED()) && !func_34(14))
					{
						...
						if (iVar1 < 10)
						{
							if (iVar1 > 1)
							{
								_SET_NOTIFICATION_TEXT_ENTRY("EPSROBE_01");
								ADD_TEXT_COMPONENT_INTEGER(iVar1);
								_DRAW_NOTIFICATION(0, 1);
							}
							else
							{
								_SET_NOTIFICATION_TEXT_ENTRY("EPSROBE_00");
								_DRAW_NOTIFICATION(0, 1);
							}
						}
						func_135();
			...
			case 4:
				...
				{
					_SET_NOTIFICATION_TEXT_ENTRY("EPSROBE_02");
					_DRAW_NOTIFICATION(0, 1);
					func_135();
					WAIT(8000);
...
int func_10(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_14726)
	{
		if (Global_14553.f_1 == 6)
		{
			...
			func_11(1);
			func_14(Global_14534, "DISPLAY_VIEW", 1f, TO_FLOAT(Global_14533), -1082130432, -1082130432, -1082130432);
		}
	}
	return 1;
}
					...
					if (iVar0 == Global_2430[iVar1 /*15*/].f_4)
					{
						if (Global_2992[iVar0] == 0)
						{
							...
							if (Global_2458608)
							{
								if (iVar1 == 14)
								{
									func_12(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(Global_16929), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_2992[iVar0] = 1;
						}
					...
					if (iVar0 == Global_2430[iVar1 /*15*/].f_4)
					{
						if (Global_2992[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_12(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(Global_16934), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_71590)
								{
									...
									func_12(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(iVar4), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_14553)
									...
									func_12(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(uVar6), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_2430[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_12(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(iVar9), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_12(Global_14534, "SET_DATA_SLOT", TO_FLOAT(1), TO_FLOAT(iVar0), TO_FLOAT(Global_2430[iVar1 /*15*/].f_10), TO_FLOAT(0), -1f, &(Global_2430[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_2992[iVar0] = 1;
						}
					}
...
void func_12(var uParam0, char* sParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
...
void func_21(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = ROUND(func_22(TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
void func_30()
{
	if (((!func_33() && !IS_ENTITY_DEAD(PLAYER_PED_ID(), 0)) && !IS_PED_INJURED(PLAYER_PED_ID())) && !IS_AMBIENT_SPEECH_PLAYING(PLAYER_PED_ID()))
	{
		if (iLocal_49 == 1)
		{
			if (IS_PED_WALKING(PLAYER_PED_ID()) || IS_PED_STILL(PLAYER_PED_ID()))
			{
				func_31(PLAYER_PED_ID(), "CULT_TALK", 4);
				fLocal_51 = GET_RANDOM_FLOAT_IN_RANGE(120000f, 240000f);
				iLocal_52 = GET_GAME_TIMER();
				iLocal_49 = 0;
			}
...
{
	_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_32(iParam2), 1);
}
...
int func_37(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(uParam0, func_38(iParam1)) && Global_71402[1 /*14*/].f_4 == GET_PED_TEXTURE_VARIATION(uParam0, func_38(iParam1)))
	{
		return 1;
	}
	return 0;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || _0x341DE7ED1D2A1BFD(func_43(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || _0x341DE7ED1D2A1BFD(func_43(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || _0x341DE7ED1D2A1BFD(func_43(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || _0x341DE7ED1D2A1BFD(func_43(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_38(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
		...
		if (!_IS_DLC_DATA_EMPTY(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (_0xA9F9C2E0FDE11CBB(Var1.f_1, iVar19, &vVar16) && vVar16.z != -1)
				{
					...
					{
						(*iParam0)[vVar16.z] = func_51(iParam1, vVar16.x, 14, iVar0);
					}
					else if (vVar16.y != -1)
					{
...
int func_51(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_38(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		while (iVar36 < Var1.f_4)
		{
			if (_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar36, &vVar16))
			{
				if ((vVar16.x != 0 && vVar16.x != -1) && vVar16.x != 1849449579)
				{
					...
					{
						(*uParam0)[func_55(vVar16.z)] = vVar16.x;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_55(vVar16.z)] = func_51(iParam1, vVar16.x, func_55(vVar16.z), iVar0);
					}
				}
				else if (vVar16.y != -1)
				{
					(*uParam0)[func_55(vVar16.z)] = vVar16.y;
				}
			}
			iVar36++;
		}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_63(func_62(iParam1, uParam0->f_2), Global_71399, 0);
			if (IS_BIT_SET(uVar0, uParam0->f_1))
			{
				SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_63(iVar1, Global_71399, 0);
				if (!IS_BIT_SET(uVar0, uParam0->f_1))
				{
					SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_63(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2539502[iParam0 /*3*/][func_64(iParam1)];
...
int func_67(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_71(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_60(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_60(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = _GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_38(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_149(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iVar0 == iParam0)
	{
		...
		if (bVar1)
		{
			func_150(_SET_NOTIFICATION_MESSAGE(&cVar2, &cVar2, 0, 2, _GET_LABEL_TEXT(func_151(iParam1)), 0));
		}
		else
		{
			func_150(_SET_NOTIFICATION_MESSAGE("CHAR_DEFAULT", "CHAR_DEFAULT", 0, 2, _GET_LABEL_TEXT(func_151(iParam1)), 0));
		}
		switch (Global_14553)
		{
			case 0:
...
void func_173()
{
	...
	if (Global_106565.f_10043.f_105 < 240)
	{
		...
		else if (!func_37(PLAYER_PED_ID(), 12, iLocal_47))
		{
			Global_106565.f_10043.f_105 = 0;
			iLocal_50 = 1;
			iLocal_222 = 2;
...
int func_175()
{
	...
	while (iVar1 < iVar0)
	{
		...
		{
			if (GET_ENTITY_MODEL(uVar2[iVar1]) == func_176(60))
			{
				uLocal_53 = uVar2[iVar1];
				if (!IS_ENTITY_A_MISSION_ENTITY(uLocal_53))
				{
					SET_ENTITY_AS_MISSION_ENTITY(uLocal_53, 1, 0);
				}
				SET_PED_MONEY(uLocal_53, 0);
				SET_PED_CAN_BE_TARGETTED(uLocal_53, 0);
				SET_PED_NAME_DEBUG(uLocal_53, "POSTMARNIE");
				SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_53, 1862763509);
...
void func_179()
{
	...
	if (Global_106565.f_10043.f_105 >= 240 || func_177(92) == 1)
	{
		...
		if (iVar0 < 16)
		{
			STAT_SET_INT(joaat("num_epsilon_step"), 16, 1);
			func_185(23, 16);
		}
		func_184(8);
		func_180(77, 0, 0);
...
void func_181()
{
	...
	{
		func_185(13, FLOOR(Global_106565.f_10188.f_3853));
	}
	if (!DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_71590)
		{
			if (func_182() == 2 == 0 && !NETWORK_IS_GAME_IN_PROGRESS())
			{
