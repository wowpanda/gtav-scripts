...
void __EntryFunction__()//Position - 0x0
{
	...
	func_18();
	Global_38B1.f_1 = 7;
	func_17(Global_389E, "DISPLAY_VIEW", 14f, 3212836864, 3212836864, 3212836864, 3212836864);
	func_16(Global_389E, "SET_HEADER", "CELL_4", 0, 0, 0, 0);
	while (true)
	{
		SYSTEM::WAIT(0);
		if (Global_38B1.f_1 != 9)
		{
			...
			else if (func_2(2, Global_3891, 0))
			{
				Global_389B = 1;
				Global_41F8 = 0;
				Global_38B1.f_1 = 7;
...
void func_6()//Position - 0x277
{
	...
	func_9();
	func_8(fLocal_25, fLocal_26, &(Global_19E56.f_6D76[Global_42D6[iLocal_21 /*9*/] /*29*/].f_3), 0);
	fLocal_25 = (fLocal_25 + 0.07f);
	func_10(255, 255, 255, 205);
	if (Global_42D6[iLocal_21 /*9*/].f_2.f_1 < 10)
	{
		func_7(fLocal_25, fLocal_26, "CELL_506", Global_42D6[iLocal_21 /*9*/].f_2.f_2, Global_42D6[iLocal_21 /*9*/].f_2.f_1);
	}
	else
	{
		func_7(fLocal_25, fLocal_26, "CELL_503", Global_42D6[iLocal_21 /*9*/].f_2.f_2, Global_42D6[iLocal_21 /*9*/].f_2.f_1);
	}
	fLocal_25 = (fLocal_25 + 0.07f);
	func_10(255, 255, 255, 205);
	func_7(fLocal_25, fLocal_26, "CELL_505", Global_42D6[iLocal_21 /*9*/].f_2.f_3, Global_42D6[iLocal_21 /*9*/].f_2.f_4);
	fLocal_25 = fLocal_23;
	func_10(255, 255, 255, 205);
	fLocal_26 = (fLocal_26 + 0.02f);
	if (Global_422D[Global_42D6[iLocal_21 /*9*/].f_1 /*42*/].f_8 == 0)
	{
		func_9();
	}
	HUD::SET_TEXT_WRAP(0f, 0.93f);
	func_8(fLocal_25, fLocal_26, &(Global_422D[Global_42D6[iLocal_21 /*9*/].f_1 /*42*/].f_4), 0);
	fLocal_26 = (fLocal_26 + 0.07f);
	iVar0 = 1;
	while (iVar0 <= Global_422D[Global_42D6[iLocal_21 /*9*/].f_1 /*42*/].f_9)
	{
		func_10(255, 255, 255, 255);
		fLocal_26 = (fLocal_26 + 0.04f);
		if (Global_422D[Global_42D6[iLocal_21 /*9*/].f_1 /*42*/].f_20[iVar0] == 4294967295)
		{
			func_8(fLocal_25, fLocal_26, &(Global_422D[Global_42D6[iLocal_21 /*9*/].f_1 /*42*/].f_A[iVar0 /*4*/]), 0);
		}
		else
		{
			func_7(fLocal_25, fLocal_26, &(Global_422D[Global_42D6[iLocal_21 /*9*/].f_1 /*42*/].f_A[iVar0 /*4*/]), Global_422D[Global_42D6[iLocal_21 /*9*/].f_1 /*42*/].f_1B[iVar0], Global_422D[Global_42D6[iLocal_21 /*9*/].f_1 /*42*/].f_20[iVar0]);
		}
		iVar0++;
	}
}
...
{
	if (func_2(2, Global_3892, 0))
	{
		iLocal_21 = iLocal_18[iLocal_20];
		Global_41F8 = 1;
		func_12(Global_389E, "SET_DATA_SLOT", 15f, 0f, -1f, -1f, -1f, "CELL_287", "CELL_280", "CELL_285", "CELL_284", 0);
		func_17(Global_389E, "DISPLAY_VIEW", 15f, 3212836864, 3212836864, 3212836864, 3212836864);
		func_16(Global_389E, "SET_HEADER", "CELL_4", 0, 0, 0, 0);
		Global_38B1.f_1 = 8;
		Global_41F8 = 1;
	}
...
void func_15()//Position - 0x6E0
{
	...
	while (iVar0 < iLocal_22)
	{
		...
		func_8(fLocal_25, fLocal_26, &(Global_19E56.f_6D76[Global_42D6[iLocal_18[iVar0] /*9*/] /*29*/].f_3), 0);
		fLocal_25 = (fLocal_25 + 0.07f);
		func_10(255, 255, 255, 205);
		if (Global_42D6[iLocal_18[iVar0] /*9*/].f_2.f_1 < 10)
		{
			func_7(fLocal_25, fLocal_26, "CELL_506", Global_42D6[iLocal_18[iVar0] /*9*/].f_2.f_2, Global_42D6[iLocal_18[iVar0] /*9*/].f_2.f_1);
		}
		else
		{
			func_7(fLocal_25, fLocal_26, "CELL_503", Global_42D6[iLocal_18[iVar0] /*9*/].f_2.f_2, Global_42D6[iLocal_18[iVar0] /*9*/].f_2.f_1);
		}
		fLocal_25 = (fLocal_25 + 0.07f);
		func_10(255, 255, 255, 205);
		func_7(fLocal_25, fLocal_26, "CELL_505", Global_42D6[iLocal_18[iVar0] /*9*/].f_2.f_3, Global_42D6[iLocal_18[iVar0] /*9*/].f_2.f_4);
		fLocal_25 = fLocal_23;
		func_10(255, 255, 255, 205);
		if (iVar0 == iLocal_20)
		{
		...
		fLocal_26 = (fLocal_26 + 0.02f);
		HUD::SET_TEXT_WRAP(0f, 0.93f);
		func_8(fLocal_25, fLocal_26, &(Global_422D[Global_42D6[iLocal_18[iVar0] /*9*/].f_1 /*42*/]), 0);
...
void func_18()//Position - 0x905
{
	...
	while (iVar1 < 4)
	{
		iVar2 = 0;
		iVar3 = 3;
		Global_42D6[iVar3 /*9*/].f_2 = 4294967295;
		Global_42D6[iVar3 /*9*/].f_2.f_1 = 0;
		Global_42D6[iVar3 /*9*/].f_2.f_2 = 0;
		Global_42D6[iVar3 /*9*/].f_2.f_3 = 0;
		Global_42D6[iVar3 /*9*/].f_2.f_5 = 0;
		while (iVar2 < 4)
		{
			if (iVar0[iVar2] == 0)
			{
				if (Global_42D6[iVar2 /*9*/].f_8 != 0)
				{
					if (func_19(Global_42D6[iVar2 /*9*/].f_2, Global_42D6[iVar3 /*9*/].f_2))
					{
						iVar3 = iVar2;
					}
				}
		...
		iVar0[iVar3] = 1;
		if (Global_42D6[iVar1 /*9*/].f_8 != 0)
		{
			iLocal_19++;
		}
		iVar1++;
	}
	func_12(Global_389E, "SET_DATA_SLOT", 14f, 0f, 25f, -1f, -1f, "CELL_287", "CELL_280", 0, 0, 0);
}
