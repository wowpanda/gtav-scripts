...
int func_2()
{
	...
	if (VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_104) > 100f)
	{
		return 1;
	}
	return 0;
		...
		switch (iLocal_82[iParam1])
		{
			case 0:
				...
				if (GET_SCRIPT_TASK_STATUS(iParam0, -1146898486) != 1)
				{
					...
					SET_PED_KEEP_TASK(iLocal_72[iParam1], 1);
				}
				break;
			...
			case 1:
				...
				if (!IS_STRING_NULL_OR_EMPTY(&(Local_87[iParam1 /*4*/])))
				{
					START_NEW_SCRIPT_WITH_ARGS(&(Local_87[iParam1 /*4*/]), &(iLocal_72[iParam1]), 1, 1424);
					iLocal_82[iParam1] = 4;
					return 0;
				}
				if (func_4(iParam0))
				...
				{
					TASK_START_SCENARIO_IN_PLACE(iParam0, sVar0, 0, 1);
					SET_PED_KEEP_TASK(iLocal_72[iParam1], 1);
				}
				break;
			...
			case 3:
				...
				if (VDIST2(GET_ENTITY_COORDS(iParam0, 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) > (50f * 50f))
				{
					iLocal_82[iParam1] = 0;
					return 1;
				}
...
void func_20()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_77)
		{
			...
			if (!IS_STRING_NULL_OR_EMPTY(&(Local_87[iVar0 /*4*/])))
			{
				REQUEST_SCRIPT(&(Local_87[iVar0 /*4*/]));
				if (!HAS_SCRIPT_LOADED(&(Local_87[iVar0 /*4*/])))
				{
					bVar2 = false;
				}
			}
	...
	while (iVar0 < iLocal_72)
	{
		if (iLocal_77[iVar0] != 0)
		{
			iLocal_72[iVar0] = CREATE_PED(4, iLocal_77[iVar0], vLocal_104 + vLocal_108[iVar0 /*3*/], 0, 1, 1);
			SET_ENTITY_HEADING(iLocal_72[iVar0], (fLocal_107 + fLocal_121[iVar0]));
			...
			SET_PED_CAN_RAGDOLL(iLocal_72[iVar0], 0);
		}
		iVar0++;
	}
}
...
void func_21()
{
	...
	func_25(iLocal_70, &vLocal_104, &fLocal_107, &cVar0);
	Var8.f_1 = -1;
	Var8.f_17 = 4;
	Var8.f_17.f_8 = 4;
	Var8.f_17.f_13 = 4;
	...
	switch (iLocal_70)
	{
		case 97:
			...
			vLocal_108[3 /*3*/] = { Vector(45.5004f, GET_RANDOM_FLOAT_IN_RANGE(-205.8167f, -210.4254f), GET_RANDOM_FLOAT_IN_RANGE(-1416.54f, -1428.501f)) - vLocal_104 };
