...
void __EntryFunction__()
{
	...
	uLocal_432 = func_265(func_266(), 0, 1);
	uLocal_433 = func_265(func_266(), 0, 1);
	uLocal_434 = func_265(func_266(), 0, 1);
	if (HAS_FORCE_CLEANUP_OCCURRED(67))
	{
		func_264();
		if (bVar23)
		{
			if (DOES_ENTITY_EXIST(uLocal_400) && IS_PED_INJURED(uLocal_400))
			{
				func_263(80, 1);
				STAT_SET_BOOL(joaat("sp_killed_dr_friedlander"), 1, 1);
			}
			func_261(0, 0);
		}
		else
		...
		func_246(&iLocal_399, &uLocal_402, uLocal_404, iLocal_60);
	}
	iLocal_82 = func_245();
	func_244(&Local_61, iLocal_82);
	STOP_FIRE_IN_RANGE(-1899.756f, -561.3688f, 10.78784f, 100f);
	SET_BIT(&(Global_106565.f_10010.f_25), 6);
	switch (func_245())
	{
		case 0:
			fVar22 = 3.6f;
	...
	while (true)
	{
		...
		switch (iLocal_60)
		{
			case 0:
				...
				DISPLAY_RADAR(0);
				func_237();
				while (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
				{
					WAIT(0);
				}
				TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER_PED_ID(), -1918.944f, -577.8114f, 10.8764f, 1f, -1, 1048576000, 0, 1193033728);
				uVar12 = CREATE_CAMERA_WITH_PARAMS(26379945, -1896.529f, -545.7853f, 18.7228f, 3.1482f, 0.0036f, 170.2056f, 44.9736f, 0, 2);
				uVar13 = CREATE_CAMERA_WITH_PARAMS(26379945, -1896.866f, -547.7337f, 18.8316f, 4.9529f, 0.0036f, 170.2056f, 44.9736f, 0, 2);
				SET_CAM_ACTIVE_WITH_INTERP(uVar13, uVar12, 5000, 1, 1);
			...
			case 1:
				if (!bVar4)
				{
					...
					{
						func_226(&iLocal_399, iLocal_55, vLocal_419, fLocal_425, uLocal_432, uLocal_433, uLocal_434);
				...
				if (bVar4)
				{
					if (!bVar5)
					{
						if (_0xB56BBBCC2955D9CB())
						{
							...
							{
								func_131(&cLocal_407, PLAYER_PED_ID(), 0, 2);
							}
							if (!IS_ENTITY_DEAD(iLocal_399, 0))
							{
								func_131(&cLocal_413, iLocal_399, 0, 2);
							}
							bVar5 = true;
						}
					}
				}
				if (func_129(&uVar6) > 6f && func_128())
				{
					if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_ENTITY_DEAD(iLocal_399, 0))
					{
						REGISTER_ENTITY_FOR_CUTSCENE(PLAYER_PED_ID(), &cLocal_407, 0, 0, 0);
						REGISTER_ENTITY_FOR_CUTSCENE(iLocal_399, &cLocal_413, 0, 0, 0);
					}
					START_CUTSCENE(0);
			...
			case 2:
				...
				{
					DESTROY_CAM(uVar12, 0);
				}
				if (DOES_CAM_EXIST(uVar13))
				{
					DESTROY_CAM(uVar13, 0);
				}
				if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&cLocal_407, 0))
				{
					func_126(iLocal_399, 1, 0);
				}
				if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&cLocal_413, 0))
				{
					func_126(iLocal_399, 0, 1);
				}
				if (CAN_SET_EXIT_STATE_FOR_CAMERA(0))
				{
					func_125(iLocal_399, &uLocal_401, &uLocal_402, &uLocal_404, &uLocal_83, vLocal_422, fLocal_427, iLocal_57);
					func_123(func_245());
					func_236(&uLocal_251);
					func_122(&uLocal_275, 0, 0, 0, 1);
					func_121(&uLocal_275, "SHRINK_ACCEPT", 2, 201, 1, 1, 0);
					func_121(&uLocal_275, "SHRINK_REJECT", 2, 202, 1, 1, 0);
					bVar5 = false;
					SET_PLAYER_CONTROL(PLAYER_ID(), 0, 0);
					iLocal_60 = 3;
			...
			case 3:
				...
				if (IS_SCREEN_FADED_OUT() || bVar24)
				{
					...
					func_114(&uLocal_251);
					while (func_129(&uLocal_251) < 0.4f)
					{
						WAIT(0);
						func_115();
					}
				...
				if (!bVar2)
				{
					if (!bLocal_435 && !IS_CUTSCENE_ACTIVE())
					{
						Local_61.f_20 = 0;
						func_102(&(Local_61.f_12), &Local_61, func_245());
						bLocal_435 = true;
					}
					if (func_92(&uLocal_251, &uLocal_275, &bVar1))
					{
						if (bVar1)
						{
							Local_61.f_20 = 0;
					...
					else if (func_129(&uLocal_251) >= 14f)
					{
						Local_61.f_20 = 2;
						bVar2 = true;
						CLEAR_HELP(1);
					}
					else if (!bVar3 && func_129(&uLocal_251) >= 7f)
					{
						StringCopy(&cVar18, "DRF_PROMPT", 16);
						func_91(&uLocal_83, &cVar14, &cVar18, 9, 0, 0, 0);
						bVar3 = true;
					}
				}
				else if ((func_129(&uLocal_251) > 5f && func_128()) || (HAS_CUTSCENE_LOADED() && ((Local_61.f_20 != 1 || func_129(&uLocal_251) > fVar22) || func_88(iLocal_82, iLocal_399, &uLocal_404))))
				{
					func_85();
					if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
					{
			...
			case 14:
				if (DOES_CAM_EXIST(uLocal_404))
				{
					RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
					DESTROY_CAM(uLocal_404, 0);
				}
				if (((func_84() && IS_CUTSCENE_PLAYING()) && !IS_SCREEN_FADING_OUT()) && !IS_SCREEN_FADED_OUT())
				{
					STOP_CUTSCENE(0);
				}
				if (CAN_SET_EXIT_STATE_FOR_CAMERA(0))
				{
					...
					else
					{
						...
						if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
						{
							...
							SET_ENTITY_COLLISION(PLAYER_PED_ID(), 1, 0);
							FREEZE_ENTITY_POSITION(PLAYER_PED_ID(), 0);
							func_81(PLAYER_PED_ID(), -1902.609f, -559.9267f, 10.7916f);
							SET_ENTITY_HEADING(PLAYER_PED_ID(), fLocal_426);
							SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
							SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
							func_73(0, 1, 1, 0, 0, 0);
							uLocal_402 = GET_PLAYERS_LAST_VEHICLE();
							if (DOES_ENTITY_EXIST(uLocal_402))
							{
								if (!IS_ENTITY_DEAD(uLocal_402, 0))
								{
									SET_ENTITY_COORDS(uLocal_402, func_72(uLocal_402), 1, 0, 0, 1);
									SET_ENTITY_HEADING(uLocal_402, 231f);
								}
							}
							if (IS_SCREEN_FADED_OUT())
							{
								if (!iLocal_436)
								{
									NEW_LOAD_SCENE_START(-1903.87f, -562.9188f, 12.8354f, func_71(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
									iLocal_436 = 1;
									WAIT(0);
								}
								if (!iLocal_437)
				...
				else
				{
					if (!iLocal_436)
					{
						if (GET_CUTSCENE_TIME() > 60000)
						{
							if (iLocal_82 == 4)
							{
								NEW_LOAD_SCENE_START(-1905.5f, -557.8768f, 12.4125f, func_71(Vector(11.9712f, -560.4745f, -1903.855f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
							}
							else
							{
								NEW_LOAD_SCENE_START(-1903.87f, -562.9188f, 12.8354f, func_71(Vector(12.8015f, -560.0015f, -1901.331f) - Vector(12.8354f, -562.9188f, -1903.87f)), 100f, 0);
					...
					if (!iLocal_437)
					{
						if (_0x583DF8E3D4AFBD98() >= 16)
						{
							...
							else if (func_129(&uVar9) > func_69(func_245()))
							{
								if (func_245() == 4)
								{
									uLocal_400 = CREATE_PED(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, 1);
									SET_PED_COMPONENT_VARIATION(uLocal_400, 3, uLocal_432, uLocal_433, 0);
									SET_PED_COMPONENT_VARIATION(uLocal_400, 4, 0, uLocal_434, 0);
									SET_PED_MONEY(uLocal_400, (2000 + GET_RANDOM_INT_IN_RANGE(5, 301)));
									SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_400, 1, 1);
									func_68(&uLocal_83, 1, uLocal_400, "FRIEDLANDER", 0, 1);
								}
								iLocal_437 = 1;
							}
						}
			...
			case 15:
				...
				if (IS_ENTITY_DEAD(uLocal_400, 0))
				{
					func_263(80, 1);
					STAT_SET_BOOL(joaat("sp_killed_dr_friedlander"), 1, 1);
					func_91(&uLocal_83, "DrfAud", "DRF_KILL", 9, 0, 0, 0);
					if (DOES_BLIP_EXIST(uLocal_403))
					{
						SET_BLIP_COLOUR(uLocal_403, 1);
					}
					iLocal_60 = 17;
				}
				else if (!DOES_ENTITY_EXIST(uLocal_400) || func_67(uLocal_400, PLAYER_PED_ID(), 1) > 300f)
				{
					func_91(&uLocal_83, "DrfAud", "DRF_AWAY", 9, 0, 0, 0);
					if (DOES_BLIP_EXIST(uLocal_403))
					{
						SET_BLIP_COLOUR(uLocal_403, 3);
					}
					if (DOES_ENTITY_EXIST(uLocal_400))
					{
						CLEAR_AREA_OF_PROJECTILES(GET_ENTITY_COORDS(uLocal_400, 1), 10f, 0);
					}
					iLocal_60 = 17;
				}
				else
				{
					func_55();
					SET_PED_CONFIG_FLAG(uLocal_400, 26, 1);
					if (func_70(&uLocal_266))
					{
						if (func_129(&uLocal_266) > 2.5f)
						{
							SIMULATE_PLAYER_INPUT_GAIT(PLAYER_ID(), 2f, 1000, 0, 1, 0);
							SET_PLAYER_CONTROL(PLAYER_ID(), 0, 0);
							func_127(&uLocal_266);
						}
					}
					if (!iLocal_439)
					{
						...
						if (func_129(&uLocal_263) > 2f)
						{
							...
							uLocal_404 = CREATE_CAMERA_WITH_PARAMS(26379945, vVar26, vVar29, 50f, 0, 2);
							SET_CAM_ACTIVE_WITH_INTERP(uLocal_404, uLocal_405, 2660, 1, 1);
							if (DOES_ENTITY_EXIST(uLocal_402) && !IS_ENTITY_DEAD(uLocal_402, 0))
							{
								SET_VEHICLE_FIXED(uLocal_402);
								SET_ENTITY_INVINCIBLE(uLocal_402, 0);
								SET_VEHICLE_CAN_BREAK(uLocal_402, 1);
							}
							func_114(&uLocal_263);
							iLocal_439 = 1;
						}
					...
					else if (DOES_CAM_EXIST(uLocal_405))
					{
						if (func_129(&uLocal_263) >= 2.66f)
						{
							SET_GAMEPLAY_CAM_RELATIVE_HEADING(func_54(GET_FOLLOW_PED_CAM_VIEW_MODE() == 2, -16f, 0f));
							RENDER_SCRIPT_CAMS(0, 1, 340, 0, 0, 0);
							DESTROY_CAM(uLocal_405, 0);
						}
						else
						{
							SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					...
					if (iLocal_438 && IS_PLAYER_CONTROL_ON(PLAYER_ID()))
					{
						if (func_52(&uLocal_257, 0.5f))
						{
							...
							if (!DOES_BLIP_EXIST(uLocal_403))
							{
								if (!IS_ENTITY_DEAD(uLocal_400, 0))
								{
									uLocal_403 = ADD_BLIP_FOR_ENTITY(uLocal_400);
									SET_BLIP_COLOUR(uLocal_403, 1);
									func_114(&uLocal_257);
								}
							}
							else if (GET_BLIP_COLOUR(uLocal_403) != 3)
							{
								SET_BLIP_COLOUR(uLocal_403, 3);
								if (func_70(&uLocal_260))
								{
									if (func_129(&uLocal_260) < (7500f / 1000f))
									{
					...
					if (!IS_PED_INJURED(uLocal_400))
					{
						if (DOES_ENTITY_EXIST(uLocal_401))
						{
							if (IS_PED_IN_ANY_VEHICLE(uLocal_400, 0))
							{
								iVar0 = 1;
							}
							if (!IS_PED_FLEEING(uLocal_400))
							{
								if ((((((((!IS_VEHICLE_DRIVEABLE(uLocal_401, 0) || IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_401, 1)) || IS_VEHICLE_STUCK_TIMER_UP(uLocal_401, 0, 2000)) || IS_VEHICLE_STUCK_TIMER_UP(uLocal_401, 1, 2000)) || IS_VEHICLE_STUCK_TIMER_UP(uLocal_401, 2, 2000)) || IS_VEHICLE_STUCK_TIMER_UP(uLocal_401, 3, 2000)) || (iVar0 && !IS_PED_IN_ANY_VEHICLE(uLocal_400, 0))) || func_48(uLocal_401)) || func_44(uLocal_401))
								{
									TASK_SMART_FLEE_PED(uLocal_400, PLAYER_PED_ID(), 3000f, -1, 0, 0);
								}
							}
						}
						else if (!IS_PED_FLEEING(uLocal_400))
						{
							TASK_SMART_FLEE_PED(uLocal_400, PLAYER_PED_ID(), 3000f, -1, 0, 0);
						}
						if (!bVar25 && !IS_ENTITY_IN_ANGLED_AREA(uLocal_400, -1892.139f, -567.194f, 10.5f, -1904.935f, -556.4423f, 13.5f, 4.73f, 0, 1, 0))
						{
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_400, 0);
							bVar25 = true;
						}
					}
				}
			...
			case 16:
				if (!func_70(&uLocal_254))
				{
					NEW_LOAD_SCENE_STOP();
					func_236(&uLocal_254);
				}
				else if (func_129(&uLocal_254) > 2f)
				{
					func_2(func_39(), 24, func_38(iLocal_82));
					func_264();
					func_261(0, 0);
					func_246(&iLocal_399, &uLocal_402, uLocal_404, iLocal_60);
				}
			...
			case 17:
				...
				if (func_129(&uLocal_254) > 4f || IS_SCREEN_FADED_OUT())
				{
					REMOVE_BLIP(&uLocal_403);
					if (DOES_CAM_EXIST(uLocal_404))
					{
						DESTROY_CAM(uLocal_404, 0);
					}
					...
					if (!func_1(80))
					{
						if (DOES_ENTITY_EXIST(uLocal_400))
						{
							if (DOES_ENTITY_EXIST(uLocal_401) && IS_PED_IN_VEHICLE(uLocal_400, uLocal_401, 0))
							{
								DELETE_VEHICLE(&uLocal_401);
							}
						}
						DELETE_PED(&uLocal_400);
					}
...
void func_6(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_8() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_8() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_7(iParam0));
...
int func_14(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_8() /*10778*/].f_6165.f_10, iParam0);
}
...
int func_15(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2539502[iParam0 /*3*/][func_10(iParam1)];
...
int func_44(var uParam0)
{
	...
	if ((func_47(PLAYER_PED_ID()) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0)) && func_45(uParam0))
	{
		...
		if (func_45(uVar0))
		{
			...
			{
				if (DOES_CARGOBOB_HAVE_PICK_UP_ROPE(uVar0))
				{
					if (IS_VEHICLE_ATTACHED_TO_CARGOBOB(uVar0, uParam0))
					{
						return 1;
					}
				}
...
void func_55()
{
	...
	if ((!DOES_ENTITY_EXIST(uLocal_400) || IS_ENTITY_DEAD(uLocal_400, 0)) || IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
	{
		return;
	}
	if (!func_70(&uLocal_269))
	{
		func_236(&uLocal_269);
	}
	if (!func_70(&uLocal_272))
	{
		func_236(&uLocal_272);
	}
	fVar6 = VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(uLocal_400, 1));
	if (iLocal_429 < 7)
	{
		if (iLocal_429 <= 0)
		{
			if (func_129(&uLocal_269) > 0.2f)
			{
				iVar4 = GET_RANDOM_INT_IN_RANGE(0, 7);
				SET_BIT(&uLocal_428, iVar4);
		...
		else if (func_129(&uLocal_269) > 12f)
		{
			if (fVar6 <= 144f && !IS_SCRIPTED_SPEECH_PLAYING(PLAYER_PED_ID()))
			{
				iVar4 = GET_RANDOM_INT_IN_RANGE(0, (7 - iLocal_429));
				while (iVar5 >= 0 && iVar5 < 7)
				{
					if (!IS_BIT_SET(uLocal_428, iVar5))
					{
						if (iVar4 == 0)
						{
							SET_BIT(&uLocal_428, iVar5);
							iVar4 = iVar5;
							iVar5 = -2;
						}
						else
	...
	if (iLocal_431 < 8)
	{
		if (iLocal_431 <= 0)
		{
			if (func_129(&uLocal_272) > 1f && !IS_SCRIPTED_SPEECH_PLAYING(uLocal_400))
			{
				iVar4 = GET_RANDOM_INT_IN_RANGE(0, 8);
				SET_BIT(&uLocal_430, iVar4);
		...
		else if (func_129(&uLocal_272) > 10.3f)
		{
			if (fVar6 <= 2500f && !IS_SCRIPTED_SPEECH_PLAYING(uLocal_400))
			{
				iVar4 = GET_RANDOM_INT_IN_RANGE(0, (8 - iLocal_431));
				iVar5 = 0;
				while (iVar5 >= 0)
				{
					if (!IS_BIT_SET(uLocal_430, iVar5))
					{
						if (iVar4 == 0)
						{
							SET_BIT(&uLocal_430, iVar5);
							iVar4 = iVar5;
							iVar5 = -2;
						}
						else
	...
	if (((!iLocal_438 && iLocal_429 >= 1) && iLocal_431 >= 1) && !IS_MESSAGE_BEING_DISPLAYED())
	{
		iLocal_438 = 1;
	}
}
...
Vector3 func_72(var uParam0)
{
	...
	GET_ENTITY_MATRIX(uParam0, &uVar0, &uVar3, &uVar6, &uVar9);
	GET_MODEL_DIMENSIONS(GET_ENTITY_MODEL(uParam0), &uVar12, &Var15);
...
void func_73(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_77(PLAYER_ID())) && !func_75(PLAYER_ID(), 0)) && !func_74()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_77(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
...
Vector3 func_81(var uParam0, vector3 vParam1)
{
	var uVar0;
...
void func_83()
{
	...
	if (!IS_VEHICLE_DRIVEABLE(uLocal_401, 0))
	{
		DELETE_VEHICLE(&uLocal_401);
		uLocal_401 = CREATE_VEHICLE(iLocal_57, vLocal_422, fLocal_427, 1, 1, 0);
		SET_VEHICLE_COLOUR_COMBINATION(uLocal_401, 6);
	}
	if (DOES_ENTITY_EXIST(iLocal_399))
	{
		DELETE_PED(&iLocal_399);
	}
	if ((!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_ENTITY_DEAD(uLocal_401, 0)) && IS_VEHICLE_DRIVEABLE(uLocal_401, 0))
	{
		SET_ENTITY_COORDS(PLAYER_PED_ID(), -1907.827f, -560.0641f, 10.8064f, 1, 0, 0, 1);
		SET_ENTITY_HEADING(PLAYER_PED_ID(), 260.195f);
		SET_ENTITY_COORDS(uLocal_401, vLocal_422, 1, 0, 0, 1);
		SET_ENTITY_HEADING(uLocal_401, fLocal_427);
		if (DOES_ENTITY_EXIST(uLocal_402))
		{
			if (!IS_ENTITY_DEAD(uLocal_402, 0))
			{
				SET_VEHICLE_FIXED(uLocal_402);
				SET_ENTITY_INVINCIBLE(uLocal_402, 1);
				SET_VEHICLE_CAN_BREAK(uLocal_402, 0);
				SET_ENTITY_COORDS(uLocal_402, func_72(uLocal_402), 1, 0, 0, 1);
				SET_ENTITY_HEADING(uLocal_402, 231f);
			}
		}
		...
		if ((!iLocal_437 || !DOES_ENTITY_EXIST(uLocal_400)) || IS_ENTITY_DEAD(uLocal_400, 0))
		{
			uLocal_400 = CREATE_PED(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, 1);
			SET_PED_COMPONENT_VARIATION(uLocal_400, 3, uLocal_432, uLocal_433, 0);
			SET_PED_COMPONENT_VARIATION(uLocal_400, 4, 0, uLocal_434, 0);
			SET_PED_MONEY(uLocal_400, (2000 + GET_RANDOM_INT_IN_RANGE(5, 301)));
			SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_400, 1, 1);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_400, 1);
			func_68(&uLocal_83, 1, uLocal_400, "FRIEDLANDER", 0, 1);
			iLocal_437 = 1;
		}
		else
		{
			SET_ENTITY_COORDS(uLocal_400, -1899.7f, -562.2f, 10.7945f, 1, 0, 0, 1);
			SET_ENTITY_HEADING(uLocal_400, 217.9453f);
			CLEAR_PED_TASKS_IMMEDIATELY(uLocal_400);
			TASK_STAND_STILL(uLocal_400, -1);
		}
		if (IS_SCREEN_FADED_OUT())
		{
			if (!iLocal_436)
			{
				NEW_LOAD_SCENE_START(-1905.5f, -557.8768f, 12.4125f, func_71(Vector(12.4748f, -560.2881f, -1904.709f) - Vector(12.4125f, -557.8768f, -1905.5f)), 100f, 0);
				iLocal_436 = 1;
				WAIT(0);
			}
			while (!IS_NEW_LOAD_SCENE_LOADED() || (!IS_PED_INJURED(uLocal_400) && !_0x7350823473013C02(uLocal_400)))
			{
				WAIT(0);
			}
			if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
		...
		fVar0 = 2f;
		if (!IS_PED_INJURED(uLocal_400) && !IS_ENTITY_DEAD(uLocal_401, 0))
		{
			OPEN_SEQUENCE_TASK(&uLocal_406);
			TASK_ENTER_VEHICLE(0, uLocal_401, -1, -1, fVar0, 1, 0);
			TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_401, -1783.73f, -629.1945f, 9.89f, 20f, 0, GET_ENTITY_MODEL(uLocal_401), 786484, 10f, 12f);
			TASK_VEHICLE_DRIVE_WANDER(0, uLocal_401, 19f, 786484);
			CLOSE_SEQUENCE_TASK(uLocal_406);
			TASK_PERFORM_SEQUENCE(uLocal_400, uLocal_406);
			FORCE_PED_MOTION_STATE(uLocal_400, -530524, 1, 1, 1);
		}
		uLocal_403 = ADD_BLIP_FOR_ENTITY(uLocal_400);
		SET_BLIP_COLOUR(uLocal_403, 1);
		func_114(&uLocal_257);
		SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
		SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
		uLocal_405 = CREATE_CAMERA_WITH_PARAMS(26379945, -1904.615f, -558.892f, 12.8339f, -9.0794f, 0f, -127.4455f, 50f, 1, 2);
		RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
		DISPLAY_RADAR(0);
		DISPLAY_HUD(0);
	}
	CLEAR_AREA(-1886.884f, -571.1942f, 11.3828f, 2.5f, 1, 1, 0, 0);
	CREATE_VEHICLE(iLocal_58, -1886.884f, -571.1942f, 11.3828f, -40.83f, 1, 1, 0);
}
...
int func_88(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_89())
	{
		...
		{
			if (!IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cVar1, &Var13, 3))
			{
				TASK_PLAY_ANIM(PLAYER_PED_ID(), &cVar1, &Var13, 2f, -1000f, -1, iVar0, 0, 0, 0, 0);
				TASK_PLAY_ANIM(iParam1, &cVar1, &cVar21, 2f, -1000f, -1, iVar0, 0, 0, 0, 0);
				TASK_PLAY_ANIM(PLAYER_PED_ID(), &cVar9, &cVar25, 2f, -1000f, -1, 32 | iVar0, 0, 0, 4, 0);
				TASK_PLAY_ANIM(iParam1, &cVar9, &cVar31, 2f, -1000f, -1, 32 | iVar0, 0, 0, 0, 0);
				_0x2208438012482A1A(PLAYER_PED_ID(), 0, 0);
				_0x2208438012482A1A(iParam1, 0, 0);
				...
				if (!DOES_CAM_EXIST(*uParam2))
				{
					*uParam2 = CREATE_CAMERA(26379945, 0);
				}
				SET_CAM_COORD(*uParam2, -1906.842f, -572.3835f, 19.1046f);
				SET_CAM_ROT(*uParam2, -1.5254f, 0.0003f, 171.4657f, 2);
				SET_CAM_FOV(*uParam2, 17f);
				SET_CAM_ACTIVE(*uParam2, 1);
				RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
			}
			else if (GET_ENTITY_ANIM_CURRENT_TIME(PLAYER_PED_ID(), &cVar1, &Var13) >= 0.99f)
			{
				return 1;
			}
		}
...
int func_92(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_70(uParam0) && func_129(uParam0) > 1.3f)
	{
		bVar0 = IS_CONTROL_JUST_PRESSED(2, 201);
		uVar1 = IS_CONTROL_JUST_PRESSED(2, 202);
		if (bVar0 || uVar1)
		{
			if (bVar0)
			{
	...
	func_93(uParam1, 1128792064, 1, 0, 1, 1065353216);
	return 0;
}

void func_93(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)
{
	var uVar0;
	var uVar1;
	var uVar2;
	...
	if (!func_98(uParam0->f_1, 256) || (func_98(uParam0->f_1, 8192) && _0x6CD79468A1E595C6(2)))
	{
		...
		if (IS_PC_VERSION())
		{
			...
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(func_98(uParam0->f_1, 4096));
			END_SCALEFORM_MOVIE_METHOD();
		}
		iVar5 = 0;
		iVar6 = 0;
		while (iVar6 < uParam0->f_123)
		{
			...
			if (bVar4)
			{
				if (BEGIN_SCALEFORM_MOVIE_METHOD(*uParam0, "SET_DATA_SLOT"))
				{
					...
					{
						func_96(uParam0->f_2[iVar6 /*15*/]);
					}
					if (IS_PC_VERSION())
					{
						if (func_98(uParam0->f_1, 4096))
						{
		...
		fVar8 = func_54(bParam4, func_54(func_98(uParam0->f_1, 32), 1f, 0f), -1f);
...
void func_102(var uParam0, var uParam1, int iParam2)
{
	...
	iVar0 |= 98304;
	_REQUEST_CUTSCENE_EX(uParam0, iVar0, 8);
}
...
struct<4> func_104(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (func_112() <= 0)
	{
		if (!func_111())
		{
			iVar4 = func_108(1, 2, 3, 4, 12);
		}
		else if (func_107() >= 1)
		{
			iVar4 = func_108(5, 6, 7, 0, 0);
		}
		else
		{
			iVar4 = func_108(5, 7, 0, 0, 0);
		}
	}
	else if (func_112() >= 2)
	{
		iVar4 = func_108(10, 11, 0, 0, 0);
	}
	else if (!func_111())
	{
		if (iParam2 != 4)
		{
			iVar4 = func_108(8, 9, 0, 0, 0);
		}
		else
		{
			iVar4 = 9;
	...
	{
		iVar4 = func_108(8, 9, 10, 0, 0);
	}
	else
	{
		iVar4 = func_108(9, 10, 0, 0, 0);
	}
	func_106(uParam0, iVar4);
	if (bParam3)
	{
		func_105(&(Global_106565.f_19955), iVar4, 1);
	}
...
void func_115()
{
	...
	{
		DISABLE_CONTROL_ACTION(2, 200, 0);
	}
}
...
void func_125(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, vector3 vParam5, float fParam8, int iParam9)
{
	var uVar0;
	int iVar1;
	
	*uParam2 = GET_PLAYERS_LAST_VEHICLE();
	if (DOES_ENTITY_EXIST(*uParam2))
	{
		...
		{
			uVar0 = GET_ENTITY_MODEL(*uParam2);
			if (IS_THIS_MODEL_A_BOAT(uVar0) || IS_THIS_MODEL_A_TRAIN(uVar0))
			{
				*uParam2 = 0;
			}
			else
			{
				iVar1 = GET_PED_IN_VEHICLE_SEAT(*uParam2, -1, 0);
	...
	if (DOES_ENTITY_EXIST(Global_90209[0]))
	{
		*uParam1 = Global_90209[0];
		SET_ENTITY_AS_MISSION_ENTITY(*uParam1, 1, 1);
	}
	if (DOES_ENTITY_EXIST(*uParam1))
	{
		...
		else
		{
			...
			FREEZE_ENTITY_POSITION(*uParam1, 0);
		}
	}
	if (!DOES_ENTITY_EXIST(*uParam1))
	{
		*uParam1 = CREATE_VEHICLE(iParam9, vParam5, fParam8, 1, 1, 0);
		SET_VEHICLE_COLOUR_COMBINATION(*uParam1, 6);
	}
	if (DOES_ENTITY_EXIST(*uParam2))
	{
		if (!IS_ENTITY_A_MISSION_ENTITY(*uParam2))
		{
			SET_ENTITY_AS_MISSION_ENTITY(*uParam2, 1, 0);
		}
	}
	func_68(uParam4, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
	func_68(uParam4, 1, iParam0, "FRIEDLANDER", 0, 1);
	if (DOES_CAM_EXIST(*uParam3))
	{
		DESTROY_CAM(*uParam3, 0);
	}
	if (!DOES_CAM_EXIST(*uParam3))
	{
		*uParam3 = CREATE_CAMERA(26379945, 0);
	}
	SET_CAM_COORD(*uParam3, -1906.842f, -572.3835f, 19.1046f);
	SET_CAM_ROT(*uParam3, -1.5254f, 0.0003f, 171.4657f, 2);
	SET_CAM_FOV(*uParam3, 17f);
...
void func_126(int iParam0, int iParam1, int iParam2)
{
	...
	{
		SET_ENTITY_COORDS(PLAYER_PED_ID(), -1907.39f, -577.33f, 17.64f, 1, 0, 0, 1);
		SET_ENTITY_HEADING(PLAYER_PED_ID(), 318.6574f);
		TASK_PLAY_ANIM(PLAYER_PED_ID(), &cVar1, &cVar13, 1000f, -2f, -1, iVar0, 0, 0, 0, 0);
		TASK_PLAY_ANIM(PLAYER_PED_ID(), &cVar9, &cVar21, 1000f, -2f, -1, 32 | iVar0, 0, 0, 4, 0);
		_0x2208438012482A1A(PLAYER_PED_ID(), 0, 0);
	}
	if (iParam2 && !IS_PED_INJURED(iParam0))
	{
		SET_ENTITY_COORDS(iParam0, -1907.69f, -574.77f, 17.67f, 1, 0, 0, 1);
		SET_ENTITY_HEADING(iParam0, 177f);
		TASK_PLAY_ANIM(iParam0, &cVar1, &cVar17, 1000f, -2f, -1, iVar0, 0, 0, 0, 0);
		TASK_PLAY_ANIM(iParam0, &cVar9, &cVar25, 1000f, -2f, -1, 32 | iVar0, 0, 0, 0, 0);
...
void func_131(char[4] cParam0, int iParam1, int iParam2, int iParam3)
{
	struct<50> Var0;
	int iVar65;
	...
	while (iVar65 < 12)
	{
		SET_CUTSCENE_PED_COMPONENT_VARIATION(cParam0, iVar65, Var0.f_13[iVar65], Var0[iVar65], iParam2);
		iVar65++;
	}
	iVar65 = 0;
	while (iVar65 < 9)
	{
		...
		{
			SET_CUTSCENE_PED_PROP_VARIATION(cParam0, iVar65, -1, 0, iParam2);
		}
		else
		{
			SET_CUTSCENE_PED_PROP_VARIATION(cParam0, iVar65, Var0.f_39[iVar65], Var0.f_49[iVar65], iParam2);
		}
		iVar65++;
	}
}
...
void func_132(int iParam0, var uParam1, int iParam2)
{
	...
	while (iVar0 < 12)
	{
		if (uParam1->f_13[iVar0] != Var2.f_13[iVar0] || (*uParam1)[iVar0] != Var2[iVar0])
		{
			...
			{
				Var67 = { func_143(iVar81, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var67.f_3;
				(*uParam1)[2] = Var67.f_4;
				iVar82 = 1;
			}
			if (func_141(iVar81, func_211(iVar0), func_210(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_211(iVar0)), &uVar1))
			{
				Var67 = { func_143(iVar81, 1, uParam1->f_62, -1) };
	...
	while (iVar0 < 9)
	{
		...
		{
			if (func_209(iVar81, 14, func_134(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var67 = { func_143(iVar81, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = Var67.f_3;
				(*uParam1)[2] = Var67.f_4;
			...
			if (func_141(iVar81, 14, func_134(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &uVar1))
			{
				Var67 = { func_143(iVar81, 1, uParam1->f_62, -1) };
				uParam1->f_13[1] = Var67.f_3;
				(*uParam1)[1] = Var67.f_4;
	...
	if (iVar83 || iVar82)
	{
		...
		if (iVar86 != -99)
		{
			Var67 = { func_143(iVar81, 0, iVar86, -1) };
...
int func_136(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_138(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var20))
			{
				...
				{
					return (func_137(iParam0, func_138(iParam2)) + iVar38);
				}
				iVar38++;
			}
			iVar37++;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_15(func_149(iParam1, uParam0->f_2), Global_71399, 0);
			if (IS_BIT_SET(uVar0, uParam0->f_1))
			{
				SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_15(func_148(iParam1, uParam0->f_2), Global_71399, 0);
			if (IS_BIT_SET(uVar0, uParam0->f_1))
			{
				SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_15(iVar1, Global_71399, 0);
				if (!IS_BIT_SET(uVar0, uParam0->f_1))
				{
					SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_150(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_154(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = _GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_138(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_216(char* sParam0, int iParam1)
{
	...
	iVar1 = (iVar1 || SHIFT_LEFT(func_217(iParam1), iVar0));
	_REQUEST_CUTSCENE_EX(sParam0, iVar1, 8);
}
...
struct<4> func_218(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	if ((((!func_223(&(Global_106565.f_19955), 8) && iParam1) && iParam0 != 4) && func_221(3) > 0) && GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.75f)
	{
		iVar4 = 8;
		*uParam3 = 4;
	}
	else
	{
		...
		if (iVar6 <= 0)
		{
			if (iParam0 != 4)
			{
				iVar4 = func_220(7, 9, 10, 11, 0);
			}
			else
			{
				iVar4 = func_220(7, 9, 10, 0, 0);
			}
		}
		else
		{
			iVar7 = GET_RANDOM_INT_IN_RANGE(1, iVar6 + 1);
			iVar8 = 1;
			while (iVar7 > 0)
			{
				if (IS_BIT_SET(uVar5, iVar8))
				{
					iVar7 = (iVar7 - 1);
					if (iVar7 == 0)
					{
	...
	if (bParam2)
	{
		func_219(&(Global_106565.f_19955), iVar4, 1);
	}
...
void func_226(var uParam0, int iParam1, vector3 vParam2, float fParam5, var uParam6, var uParam7, var uParam8)
{
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
	{
	...
	SET_PED_COMPONENT_VARIATION(*uParam0, 3, uParam6, uParam7, 0);
	SET_PED_COMPONENT_VARIATION(*uParam0, 4, 0, uParam8, 0);
	func_227(1, 0);
	func_73(1, 1, 1, 0, 0, 0);
}
...
void func_246(int iParam0, var uParam1, var uParam2, int iParam3)
{
	DISPLAY_HUD(1);
	DISPLAY_RADAR(1);
	func_250();
...
void func_254(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_256(Global_106565.f_18527[iVar0], &vVar2, &fVar5))
			{
