...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_178(vLocal_49, 4294967295, 0, 0, 0))
	{
		func_175(4294967295);
	}
	else
					...
					case 1:
						...
						switch (iLocal_47)
						{
							...
							case 1:
								if (!iLocal_81)
								{
									if ((ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), -467.0595f, 540.1724f, 125.3034f, 91.875f, 90.875f, 30f, false, true, 0) && CAM::IS_SPHERE_VISIBLE(vLocal_86, 1f)) || ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_86, 20f, 20f, 20f, false, true, 0))
									{
										func_144();
										func_135(1);
										iLocal_81 = 1;
								...
								{
									if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_86, 50f, 50f, 50f, false, true, 0))
									{
										func_133();
									}
									if (!PED::IS_PED_INJURED(iLocal_54))
							...
							case 4:
								...
								if (!iLocal_71)
								{
									if (func_51())
									{
										if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_88, 23f, 60f, 20f, false, true, 0))
										{
											func_56(0);
											func_54();
											SYSTEM::WAIT(0);
...
void func_1()//Position - 0x4AA
{
	...
	if (iLocal_109 && !iLocal_108)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_91[8]))
		{
			iLocal_92 = OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_weapon_golfclub"), unk_0x8000C77B5F336760(iLocal_91[8], true), ENTITY::GET_ENTITY_ROTATION(iLocal_91[8], 2) + Vector(2.8157f, -159.5768f, -14.1956f), 0, 4294967295, 2, 1, 0);
	...
	if ((!ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_57, 80f, 80f, 80f, false, true, 0) || OBJECT::HAS_PICKUP_BEEN_COLLECTED(iLocal_92)) || !(ENTITY::DOES_ENTITY_EXIST(iLocal_91[8]) && !OBJECT::DOES_PICKUP_EXIST(iLocal_92)))
	{
		func_221();
	}
}
...
int func_11()//Position - 0xB22
{
	return Global_6373;
}

void func_12(int iParam0, int iParam1, bool bParam2)//Position - 0xB2D
{
	int iVar0;
...
int func_13(int iParam0, int iParam1, bool bParam2)//Position - 0xB9F
{
	if (iParam0 == 4294967295)
	{
		return 0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_11() == 0)
		{
			return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(func_9(func_10(iParam0), 4294967295, 0), iParam1);
		}
	}
	else
	{
...
void func_14()//Position - 0xC09
{
	...
	Global_19E56.f_4872.f_17F = func_41() + 1;
	func_18(4294967295, 0);
	func_15();
	iLocal_46 = 3;
}

void func_15()//Position - 0xC4D
{
	func_16();
}

int func_16()//Position - 0xC5A
{
	if (func_17(0))
	{
		return 0;
...
bool func_17(bool bParam0)//Position - 0xCA5
{
...
void func_18(int iParam0, int iParam1)//Position - 0xCD0
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_39();
...
void func_19(int iParam0)//Position - 0xDD3
{
	Global_19E48 = iParam0;
}

void func_20(int iParam0, var uParam1, var uParam2)//Position - 0xDE1
{
	bool bVar0;
...
int func_22(int iParam0, int iParam1)//Position - 0x138A
{
	int iVar0;
...
int func_23(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x13DB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_24(int iParam0, int iParam1)//Position - 0x193A
{
	switch (iParam0)
	{
		case 0:
...
int func_25(int iParam0)//Position - 0x1CAE
{
	switch (iParam0)
	{
		case 29:
...
void func_26(int iParam0)//Position - 0x1CDD
{
	int iVar0;
	int iVar1;
...
void func_27(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x1D1F
{
	func_28(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_28(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x1D3F
{
	int iVar0;
...
bool func_32(int iParam0)//Position - 0x2174
{
	return Global_8D15 == iParam0;
}

bool func_33(int iParam0)//Position - 0x2182
{
	return iParam0 < 3;
}

int func_34(int iParam0)//Position - 0x218E
{
	int iVar0;
	int iVar1;
...
int func_35(int iParam0)//Position - 0x21CB
{
	if (func_33(iParam0))
	{
...
int func_36(int iParam0)//Position - 0x21F5
{
	int iVar0;
	int iVar1;
...
void func_37(int iParam0, int iParam1)//Position - 0x2238
{
	MISC::SET_BIT(&(Global_19E56.f_6187.f_8[iParam0]), iParam1);
}

int func_38(int iParam0)//Position - 0x2253
{
	int iVar0;
...
int func_40(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x2321
{
...
int func_41()//Position - 0x24FB
{
	return (Global_19E56.f_2704.f_15 + Global_19E56.f_4872.f_17C);
}

int func_42()//Position - 0x2517
{
	return 1;
}

int func_43()//Position - 0x2520
{
	if (Global_645F)
	{
		func_19(4);
...
void func_45(int iParam0)//Position - 0x2559
{
	Global_41C1 = iParam0;
}

int func_46()//Position - 0x2566
{
...
bool func_47()//Position - 0x2582
{
	return Global_645E;
}

void func_48(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x258D
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_49(iParam3), 0);
}

int func_49(int iParam0)//Position - 0x25A6
{
	int iVar0;
...
void func_50()//Position - 0x279B
{
	iLocal_46 = 3;
}

int func_51()//Position - 0x27A6
{
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
		iLocal_110 = PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0);
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_110, 0))
		{
			if (!PED::IS_PED_INJURED(iLocal_54))
			{
...
int func_53()//Position - 0x2864
{
	func_31();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_54()//Position - 0x287D
{
	Global_3960 = 0;
	func_55();
}

void func_55()//Position - 0x288D
{
...
void func_56(bool bParam0)//Position - 0x28AE
{
	if (bParam0)
	{
		if (iLocal_63)
...
void func_57()//Position - 0x290A
{
	Global_3960 = 0;
	func_58();
}

void func_58()//Position - 0x291A
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
struct<6> func_59()//Position - 0x293E
{
	struct<6> Var0;
	int iVar1;
...
struct<6> func_60()//Position - 0x2984
{
	struct<6> Var0;
...
int func_62(char* sParam0)//Position - 0x2A1F
{
	var uVar0;
...
bool func_63(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2A47
{
...
int func_64(char* sParam0, int iParam1, bool bParam2)//Position - 0x2A9B
{
	Global_3DCF = 0;
...
bool func_71(int iParam0, int iParam1)//Position - 0x2FE4
{
	switch (iParam0)
	{
		case 5:
...
void func_73(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x3076
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
int func_74(vector3 vParam0)//Position - 0x30CC
{
	if (func_53() == 2)
	{
		if (func_47() && !Global_6461)
		{
			if (fLocal_45 == -1f)
			{
	...
	switch (iLocal_62)
	{
		case 0:
			...
			else if (!PED::IS_PED_INJURED(iLocal_54))
			{
				...
				if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_54, AUDIO::_0x0626A247D2405330(), 8f, 8f, 8f, 0, 1, 0))
				{
					if (iLocal_60 < 19)
					{
		...
		case 2:
			...
			if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_88, 10f, 10f, 10f, false, true, 0))
			{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_54))
			{
				if (!PED::IS_PED_INJURED(iLocal_54))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(iLocal_54, vLocal_88, Global_13, true, true, 0) && func_110(1, 0, 1))
					{
	...
	switch (iLocal_102)
	{
		...
		case 2:
			...
			if (!PED::IS_PED_INJURED(iLocal_54))
			{
				...
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_89, 1f, 4294967295, 0.25f, 0, 311.3569f);
		...
		case 4:
			if (!func_150())
			{
				func_108("DOM_GOLF", 4294967295);
				func_107(&(Global_19E56.f_4A07), 16);
				if (func_53() == 0)
				{
					func_106(&(Global_19E56.f_4A07.f_18), 1);
				}
				else if (func_53() == 1)
				{
					func_106(&(Global_19E56.f_4A07.f_18), 4);
				}
				else if (func_53() == 2)
				{
					func_106(&(Global_19E56.f_4A07.f_18), 2);
				}
...
void func_77(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x34EA
{
	int iVar0;
	int iVar1;
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x35D1
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_79(bool bParam0)//Position - 0x3BD0
{
	int iVar0;
	int iVar1;
...
void func_80(int iParam0)//Position - 0x3E52
{
	int iVar0;
...
void func_81(int iParam0)//Position - 0x3EAC
{
	bool bVar0;
	char cVar1[64];
...
char* func_82(int iParam0)//Position - 0x3FBD
{
	switch (iParam0)
	{
		case 0:
...
void func_84(int iParam0)//Position - 0x40B3
{
	func_104(93, iParam0);
	func_104(29, iParam0);
	func_104(30, iParam0);
...
bool func_85(int iParam0)//Position - 0x40D3
{
	if (iParam0 == 8)
	{
...
int func_86(int iParam0, int iParam1, int iParam2)//Position - 0x4157
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_87(int iParam0)//Position - 0x4194
{
	int iVar0;
...
int func_88(int iParam0, int iParam1)//Position - 0x44AC
{
	int iVar0;
...
int func_89(bool bParam0)//Position - 0x479B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_90(int iParam0, int iParam1)//Position - 0x4852
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_91(int iParam0, int iParam1)//Position - 0x486D
{
	...
	if (func_101(&Global_412216))
	{
		if (func_99(&Global_412216, iParam0))
		{
			return 0;
		}
...
int func_92(var uParam0, int iParam1)//Position - 0x490A
{
	int iVar0;
	var uVar1[78];
...
int func_93(var uParam0, int iParam1)//Position - 0x49BB
{
	int iVar0;
...
bool func_94(var uParam0, int iParam1)//Position - 0x4A36
{
	return (*uParam0)[iParam1] == 78;
}

void func_95(var uParam0)//Position - 0x4A47
{
	int iVar0;
	...
	func_97(uParam0, (Global_412215 - 0.5f));
}

void func_96(var uParam0, int iParam1)//Position - 0x4A7B
{
	(*uParam0)[iParam1] = 78;
}

void func_97(var uParam0, float fParam1)//Position - 0x4A8B
{
	if (fParam1 == 0f)
	{
		uParam0->f_50 = 0f;
...
float func_98(var uParam0)//Position - 0x4AA8
{
	return uParam0->f_50;
}

bool func_99(var uParam0, int iParam1)//Position - 0x4AB4
{
	return func_100(uParam0, iParam1) != 4294967295;
}

int func_100(var uParam0, int iParam1)//Position - 0x4AC6
{
	int iVar0;
...
bool func_101(var uParam0)//Position - 0x4AF3
{
	return uParam0->f_4F == 1;
}

int func_102(int iParam0)//Position - 0x4B01
{
	switch (iParam0)
	{
		case 60:
...
void func_103(int iParam0, int iParam1)//Position - 0x4B51
{
	int iVar0;
...
void func_104(int iParam0, int iParam1)//Position - 0x4B74
{
	int iVar0;
...
void func_106(var uParam0, int iParam1)//Position - 0x4C46
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_107(var uParam0, int iParam1)//Position - 0x4C57
{
	uParam0->f_17 = (uParam0->f_17 || iParam1);
}

void func_108(char* sParam0, int iParam1)//Position - 0x4C6A
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

void func_109()//Position - 0x4C81
{
	switch (iLocal_102)
	{
		case 0:
...
int func_110(bool bParam0, bool bParam1, bool bParam2)//Position - 0x4ECA
{
	int iVar0;
...
void func_112()//Position - 0x54DA
{
	if (!PED::IS_PED_INJURED(iLocal_54))
	{
		if (!iLocal_66)
		{
			...
			{
				if (!PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1) && PED::IS_PED_IN_VEHICLE(iLocal_54, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
				{
					func_56(0);
					func_54();
					SYSTEM::WAIT(0);
		...
		{
			if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0) && PED::IS_PED_IN_VEHICLE(iLocal_54, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				iLocal_66 = 0;
			}
		}
...
void func_113()//Position - 0x5601
{
	...
	if ((iLocal_96 - iLocal_95) > 60000)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_54))
		{
			...
			{
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_54, vLocal_89, 1f, 4294967295, 1048576000, 0, 1193033728);
			}
			else
			{
...
void func_114()//Position - 0x56B9
{
	if (!PED::IS_PED_INJURED(iLocal_54))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_54, 8f, 8f, 8f, 0, 1, 0) || PED::IS_PED_IN_ANY_TAXI(AUDIO::_0x0626A247D2405330()))
		{
			if ((PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_54, 0)) && !PED::IS_PED_IN_ANY_TAXI(AUDIO::_0x0626A247D2405330()))
			{
				if (!HUD::DOES_BLIP_EXIST(uLocal_84[0]))
				{
...
void func_115()//Position - 0x57D8
{
	if (func_53() == 2)
	{
		if (!Global_6460)
		{
			func_108("CULT_BLIP_HELP", 4294967295);
			Global_6460 = 1;
		}
	}
}

int func_116(vector3 vParam0, bool bParam1)//Position - 0x57FC
{
	int iVar0;
...
float func_117(bool bParam0, float fParam1, float fParam2)//Position - 0x5828
{
	if (bParam0)
	{
		return fParam1;
...
int func_118(int iParam0, bool bParam1, int iParam2)//Position - 0x583F
{
	int iVar0;
...
int func_119(int iParam0, bool bParam1, bool bParam2)//Position - 0x5891
{
	int iVar0;
...
void func_121(var uParam0, int iParam1)//Position - 0x596E
{
	...
	if (!PED::IS_PED_INJURED(iLocal_54))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 1))
		{
			if (!func_125())
			{
				...
				{
					BRAIN::TASK_GO_TO_ENTITY(iLocal_54, AUDIO::_0x0626A247D2405330(), 4294967295, 6f, 2f, 1073741824, 0);
				}
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_54, 0))
				{
			...
			else
			{
				...
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_54, 1227113341) == 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_54, 1227113341) == 0)
				{
					NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_54);
				}
			}
		}
...
int func_123()//Position - 0x5AAC
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

int func_124()//Position - 0x5ABC
{
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 1))
	{
...
void func_126()//Position - 0x5C49
{
	switch (iLocal_61)
	{
		...
		case 2:
			...
			if (!PED::IS_PED_INJURED(iLocal_54))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_54, 12f, 12f, 5f, 0, 1, 2))
				{
					if (func_125())
					{
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, iLocal_111, 1862763509);
				...
				if ((iLocal_99 - iLocal_98) > 60000)
				{
					if (func_149(&uLocal_114, "REDO2AU", "REDO2_TX", 4, 0, 0, 0))
					{
						...
						if (!PED::IS_PED_INJURED(iLocal_54))
						{
							...
							BRAIN::TASK_USE_MOBILE_PHONE_TIMED(0, 4294967295);
		...
		case 3:
			if (!PED::IS_PED_INJURED(iLocal_54) && ENTITY::DOES_ENTITY_EXIST(iLocal_91[8]))
			{
				...
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, unk_0x8000C77B5F336760(iLocal_91[8], true) + Vector(0f, 0.39f, 0.35f), 1f, 4294967295, 0f, 512, func_128(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_91[8], true)));
				BRAIN::TASK_PLAY_ANIM(0, "random@domestic", "pickup_low", 2f, -2f, 4294967295, 0, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(0, "random@security_van", "sec_hand_override", 8f, -4f, 4294967295, 33, 0, 0, 0, 0);
				CUTSCENE::_0x8D9DF6ECA8768583(iLocal_77);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_54, iLocal_77);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
				SYSTEM::SETTIMERB(0);
		...
		case 5:
			if (!PED::IS_PED_INJURED(iLocal_54) && !ENTITY::IS_ENTITY_DEAD(iLocal_91[8], 0))
			{
				...
				else if (SYSTEM::TIMERB() > 10000 || ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), unk_0x8000C77B5F336760(iLocal_91[8], true), 1.5f, 1.5f, 3f, false, true, 0))
				{
		...
		case 7:
			if (!PED::IS_PED_INJURED(iLocal_54))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_54, AUDIO::_0x0626A247D2405330(), 20f, 20f, 20f, 0, 1, 0))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_91[8], iLocal_54, PED::GET_PED_BONE_INDEX(iLocal_54, 57005), 0f, -0.15f, -0.05f, 70f, 110f, 200f, 1, 0, 0, 0, 2, 1);
					PED::SET_PED_AS_GROUP_MEMBER(iLocal_54, PLAYER::GET_PLAYER_GROUP(CAM::_0xDC9DA9E8789F5246()));
					PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_54, 1);
					PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_54, 0);
					func_127();
					iLocal_47 = 4;
...
float func_128(struct<2> Param0, float fParam1, struct<2> Param2, float fParam3)//Position - 0x61D1
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param2 - Param0), (Param2.f_1 - Param0.f_1));
}

int func_129(char* sParam0)//Position - 0x61EB
{
	var uVar0;
...
void func_130()//Position - 0x6213
{
	if (!iLocal_80)
	{
		if (!PED::IS_PED_INJURED(iLocal_54))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_54, AUDIO::_0x0626A247D2405330(), 12f, 12f, 5f, 0, 1, 0))
			{
				NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_54);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
				BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), 0);
				BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 18000, 0, 2);
				CUTSCENE::_0x8D9DF6ECA8768583(iLocal_77);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_54, iLocal_77);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
				BRAIN::TASK_LOOK_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_54, 15000, 0, 2);
				iLocal_80 = 1;
			}
		}
	}
			...
			if (bLocal_97)
			{
				if (bLocal_50)
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_54))
					{
						if (!func_150())
						{
							if (PED::IS_PED_FACING_PED(iLocal_54, AUDIO::_0x0626A247D2405330(), 90f))
							{
...
void func_131()//Position - 0x63B6
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_54))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_54, 15f, 15f, 15f, 0, 1, 0))
		{
			if (func_132())
			{
				func_45(0);
...
void func_133()//Position - 0x6426
{
	switch (iLocal_60)
	{
		case 0:
			...
			{
				if (CAM::IS_SPHERE_VISIBLE(unk_0x8000C77B5F336760(iLocal_53, true), 3f))
				{
					if (!func_150())
					{
						if (func_149(&uLocal_114, "REDO2AU", "REDO2_ARMA", 4, 0, 0, 0))
						{
							BRAIN::TASK_PLAY_ANIM(iLocal_54, "random@domestic", "balcony_fight_male", 2f, -2f, 4294967295, 0, 0.3f, 0, 0, 0);
							BRAIN::TASK_PLAY_ANIM(iLocal_53, "random@domestic", "balcony_fight_female", 2f, -2f, 4294967295, 0, 0.3f, 0, 0, 0);
							iLocal_60++;
						}
					}
				}
		...
		case 3:
			if (!iLocal_70 && ENTITY::DOES_ENTITY_EXIST(iLocal_91[8]))
			{
				...
				{
					AUDIO::PLAY_SOUND_FROM_ENTITY(4294967295, "CLOTHES_THROWN", iLocal_91[8], "RE_DOMESTIC_SOUNDSET", 0, 0);
					iLocal_70 = 1;
				}
			}
		...
		case 7:
			if (!iLocal_70 && ENTITY::DOES_ENTITY_EXIST(iLocal_91[9]))
			{
				...
				{
					AUDIO::PLAY_SOUND_FROM_ENTITY(4294967295, "CLOTHES_THROWN", iLocal_91[9], "RE_DOMESTIC_SOUNDSET", 0, 0);
					iLocal_70 = 1;
				}
			}
			if (!func_150() || func_132())
		...
		case 10:
			if (!iLocal_70 && ENTITY::DOES_ENTITY_EXIST(iLocal_91[10]))
			{
				...
				{
					AUDIO::PLAY_SOUND_FROM_ENTITY(4294967295, "CLOTHES_THROWN", iLocal_91[10], "RE_DOMESTIC_SOUNDSET", 0, 0);
					iLocal_70 = 1;
				}
			}
			if (!func_150() || func_132())
	...
	if (!bLocal_50)
	{
		if (iLocal_60 > 2 && iLocal_60 < 8)
		{
			if (!PED::IS_PED_INJURED(iLocal_54))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_54, 6f, 4f, 5f, 0, 1, 0) || (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_54, 12f, 12f, 5f, 0, 1, 2) && PLAYER::IS_PLAYER_PRESSING_HORN(CAM::_0xDC9DA9E8789F5246())))
				{
					NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_54);
					func_134();
					if (iLocal_60 > 18)
		...
		else if (iLocal_60 > 7)
		{
			if (!PED::IS_PED_INJURED(iLocal_54))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_54, 6f, 8f, 5f, 0, 1, 0))
				{
					if (HUD::DOES_BLIP_EXIST(uLocal_84[0]))
					{
...
void func_134()//Position - 0x6BDF
{
	...
	{
		BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
		BRAIN::TASK_GO_STRAIGHT_TO_COORD(0, vLocal_87, 1f, 4294967295, 1193033728, 1056964608);
		BRAIN::TASK_PLAY_ANIM(0, "random@domestic", "f_attack_end", 2f, -2f, 4294967295, 1, 0, 0, 0, 0);
		CUTSCENE::_0x8D9DF6ECA8768583(iLocal_77);
...
int func_135(int iParam0)//Position - 0x6C6A
{
	if (func_138())
	{
		Global_19E4C = 1;
...
void func_136(int iParam0)//Position - 0x6CBD
{
	switch (iParam0)
	{
		case 0:
			if (Global_19E56.f_6187.f_2 < 3)
			{
				...
				{
					func_108(func_137(iParam0), 4294967295);
...
char* func_137(int iParam0)//Position - 0x6D9E
{
	char* sVar0;
...
int func_138()//Position - 0x6DE0
{
	switch (func_139(&Global_63AE, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_139(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x6E16
{
	int iVar0;
...
void func_140(var uParam0, int iParam1)//Position - 0x6F4D
{
	int iVar0;
...
bool func_141(int iParam0)//Position - 0x6F9C
{
	return func_142(iParam0, Global_8D15);
}

int func_142(int iParam0, int iParam1)//Position - 0x6FAD
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_143(int iParam0)//Position - 0x718E
{
	if (Global_8D15 == 15)
	{
		return 0;
...
void func_145()//Position - 0x71EC
{
	...
	BRAIN::TASK_PLAY_ANIM(iLocal_53, "random@domestic", "balcony_fight_idle_female", 8f, -4f, 4294967295, 1, 0, 0, 0, 0);
	...
	BRAIN::TASK_PLAY_ANIM(iLocal_54, "random@domestic", "balcony_fight_idle_male", 8f, -4f, 4294967295, 1, 0, 0, 0, 0);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_54, iLocal_111);
	func_148(iLocal_54, "GENERIC_WHATEVER", 24);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_79);
	BRAIN::TASK_LOOK_AT_ENTITY(iLocal_54, iLocal_53, 4294967295, 0, 2);
	BRAIN::TASK_LOOK_AT_ENTITY(iLocal_53, iLocal_54, 4294967295, 0, 2);
	...
	if (func_53() == 0)
	{
		func_146(&uLocal_114, 0, AUDIO::_0x0626A247D2405330(), "MICHAEL", 0, 1);
	}
	if (func_53() == 1)
	{
		func_146(&uLocal_114, 1, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
	}
	if (func_53() == 2)
	{
		func_146(&uLocal_114, 2, AUDIO::_0x0626A247D2405330(), "TREVOR", 0, 1);
	}
...
void func_146(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x7547
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_147()//Position - 0x75E2
{
	...
	unk_0x346478B12F69D4E3(iLocal_91[0], true);
	...
	unk_0x346478B12F69D4E3(iLocal_91[1], true);
	...
	unk_0x346478B12F69D4E3(iLocal_91[2], true);
	...
	unk_0x346478B12F69D4E3(iLocal_91[3], true);
	...
	unk_0x346478B12F69D4E3(iLocal_91[4], true);
	...
	unk_0x346478B12F69D4E3(iLocal_91[5], true);
	...
	unk_0x346478B12F69D4E3(iLocal_91[6], true);
	...
	unk_0x346478B12F69D4E3(iLocal_91[7], true);
...
void func_148(int iParam0, char* sParam1, int iParam2)//Position - 0x78C7
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_49(iParam2), 1);
}

bool func_149(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x78DE
{
...
void func_151()//Position - 0x794E
{
	if (!PED::IS_PED_INJURED(iLocal_54) && !PED::IS_PED_INJURED(iLocal_53))
	{
		if (WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6))
		{
			if (PED::_CAN_PED_SEE_PED(iLocal_54, AUDIO::_0x0626A247D2405330()) || PED::_CAN_PED_SEE_PED(iLocal_53, AUDIO::_0x0626A247D2405330()))
			{
				if (((PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_54) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_54)) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_53)) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iLocal_53))
				{
			...
			if ((iLocal_94 != 4294967295 && MISC::GET_GAME_TIMER() > iLocal_94 + 500) || PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
			{
				func_158();
			}
		}
	...
	if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), -471.1757f, 535.356f, 124.8557f, 3f, 2.5f, 1.5f, false, true, 0))
	{
		func_155();
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_53))
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_54))
	{
		if (func_154(iLocal_54) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_54, AUDIO::_0x0626A247D2405330(), 1))
		{
			func_152();
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_53))
	{
		if (func_154(iLocal_53) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_53, AUDIO::_0x0626A247D2405330(), 1))
		{
			func_152();
		}
	}
	if (!PED::IS_PED_INJURED(iLocal_54))
	{
		if (!ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_54, 250f, 250f, 250f, 0, 1, 0) || ENTITY::IS_ENTITY_IN_WATER(iLocal_54))
		{
			iLocal_47 = 11;
		}
	}
...
int func_154(int iParam0)//Position - 0x7BFA
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_156()//Position - 0x7CA0
{
	if (!PED::IS_PED_INJURED(iLocal_54))
	{
		NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_54);
		BRAIN::TASK_SMART_FLEE_COORD(iLocal_54, unk_0x8000C77B5F336760(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), true), 150f, 4294967295, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_54, true);
	}
	iLocal_47 = 11;
}

int func_157(int iParam0)//Position - 0x7CDF
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0) && ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iParam0, 1.5f, 1.5f, 8f, 0, 1, 2))
		{
			if (ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)) > 4f)
			{
				return 1;
			}
		}
...
int func_161()//Position - 0x8022
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(AUDIO::_0x0626A247D2405330())) > 1369f && !func_172())
		{
			return 0;
		}
	}
...
int func_162(float fParam0, bool bParam1)//Position - 0x80A8
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_163(int iParam0, var uParam1)//Position - 0x815F
{
	switch (iParam0)
	{
		case 0:
...
int func_165(int iParam0)//Position - 0x9365
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_166(int iParam0)//Position - 0x96AB
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_167(int iParam0)//Position - 0x96E1
{
	struct<2> Var0;
...
bool func_169()//Position - 0x9B5E
{
	return Global_19D3C > 0;
}

int func_170()//Position - 0x9B6C
{
...
void func_175(int iParam0)//Position - 0x9C51
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_39();
...
void func_177(int iParam0)//Position - 0x9CC4
{
	Global_19E4B = iParam0;
}

int func_178(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x9CD2
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
...
bool func_179(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0xA06C
{
	if (bParam2)
	{
...
bool func_180(int iParam0)//Position - 0xA0B3
{
	int iVar0;
...
int func_181(int iParam0)//Position - 0xA0D4
{
	return func_182(iParam0, 1);
}

int func_182(int iParam0, int iParam1)//Position - 0xA0E3
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_183(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xA136
{
	func_184(func_195(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_184(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xA154
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_185(float fParam0, float fParam1, float fParam2)//Position - 0xA355
{
	float fVar0;
...
int func_186(int iParam0, int iParam1)//Position - 0xA397
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_187(int iParam0)//Position - 0xA439
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_188(int iParam0)//Position - 0xA44C
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_189(int iParam0)//Position - 0xA45F
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_190(int iParam0)//Position - 0xA472
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_191(int iParam0)//Position - 0xA484
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_192(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}

int func_192(bool bParam0, int iParam1, int iParam2)//Position - 0xA4A9
{
	if (bParam0)
	{
		return iParam1;
...
int func_193(int iParam0)//Position - 0xA4C0
{
	return iParam0 & 15;
}

int func_194(int iParam0, int iParam1)//Position - 0xA4CD
{
	int iVar0;
	int iVar1;
...
void func_196(var uParam0, int iParam1)//Position - 0xA61F
{
	if (iParam1 <= 0)
	{
		return;
...
void func_197(var uParam0, int iParam1)//Position - 0xA6A5
{
...
void func_198(var uParam0, int iParam1)//Position - 0xA6D8
{
	int iVar0;
	int iVar1;
...
void func_199(var uParam0, int iParam1)//Position - 0xA729
{
...
void func_200(var uParam0, int iParam1)//Position - 0xA763
{
...
void func_201(var uParam0, int iParam1)//Position - 0xA79E
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_202(int iParam0)//Position - 0xA7DA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_203(int iParam0, int iParam1)//Position - 0xA8B6
{
...
int func_204(int iParam0)//Position - 0xA8D9
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_212()) || Global_19A9D) || Global_6375) || func_211()) || func_71(8, 4294967295)) || func_210()) || func_209()) || func_208()) || func_207()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_212()) || Global_6375) || func_211()) || func_71(8, 4294967295)) || func_208()) || func_210()) || func_209()) || func_207()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_212()) || Global_19A9D) || Global_6375) || func_211()) || func_71(8, 4294967295)) || func_208()) || func_210()) || func_209()) || func_207()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_212() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_71(8, 4294967295)) || func_207()) || func_206()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_71(8, 4294967295) || func_210()) || func_209()) || func_206()) || func_205())
						{
							return 0;
						}
...
var func_205()//Position - 0xAFF6
{
	return Global_16C57.f_1;
}

int func_206()//Position - 0xB004
{
	if (Global_16089 != 4294967295)
	{
...
bool func_209()//Position - 0xB06E
{
	return Global_16C64.f_148 > 0;
}

bool func_210()//Position - 0xB07F
{
	return Global_16C64.f_147 > 0;
}

var func_211()//Position - 0xB090
{
	return Global_140859;
}

int func_212()//Position - 0xB09C
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_214(int iParam0)//Position - 0xB0E0
{
	return func_194(func_195(), iParam0);
}

int func_215(int iParam0, int iParam1, int iParam2)//Position - 0xB0F2
{
	int iVar0;
	int iVar1;
...
int func_216(int iParam0)//Position - 0xB1D6
{
	if (!func_33(iParam0))
	{
		return 7;
...
bool func_217(int iParam0)//Position - 0xB1FA
{
	int iVar0;
	bool bVar1;
...
int func_220(int iParam0, int iParam1)//Position - 0xB357
{
	if (Global_19E56.f_27B6[iParam0 /*12*/].f_5 == 1)
	{
		if (iParam1 == 1)
...
void func_222(int iParam0)//Position - 0xB4E7
{
	char cVar0[64];
	...
	if (func_174())
	{
		...
		func_225(30000);
		StringCopy(&cVar0, func_224(Global_19E4B, 1), 64);
	...
	func_223(&Global_63AE);
	Global_19E4C = 0;
	func_177(4294967295);
}

void func_223(var uParam0)//Position - 0xB59C
{
	if (*uParam0 == 4294967295)
	{
		return;
...
char* func_224(int iParam0, bool bParam1)//Position - 0xB5D9
{
	switch (iParam0)
	{
		case 0:
...
void func_225(int iParam0)//Position - 0xB822
{
	Global_8F3C = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_226(int iParam0)//Position - 0xB834
{
	func_227(iParam0, 0, func_232(iParam0));
}

void func_227(int iParam0, int iParam1, int iParam2)//Position - 0xB849
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_228(var uParam0)//Position - 0xB878
{
	struct<16> Var0;
	int iVar1;
...
void func_229(int iParam0, var uParam1)//Position - 0xB947
{
	Global_19E56.f_6187.f_2B[iParam0] = *uParam1;
}

void func_230(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xB95F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_231(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xBAE1
{
...
int func_232(int iParam0)//Position - 0xBB19
{
	int iVar0;
