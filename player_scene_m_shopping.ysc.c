...
int func_3(int iParam0)//Position - 0x12C
{
	...
	if (!PED::IS_PED_INJURED(*iParam0))
	{
		if (!func_125(1, *iParam0))
		{
			...
			func_121(4294967294, "ped dead baby, ped dead");
			return 0;
		}
		if (iLocal_290 >= 0)
		{
			if (FIRE::IS_ENTITY_ON_FIRE(*iParam0))
			{
				...
				{
					BRAIN::STOP_ANIM_PLAYBACK(*iParam0, 0, 0);
				}
				NETWORK::_0x5E3AA4CA2B6FB0EE(*iParam0);
				func_121(4294967295, "ped on fire");
				return 0;
			}
		}
		switch (iLocal_290)
		{
			...
			case 1:
				...
				else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_16221))
				{
					...
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_300, &cLocal_318, 2))
					{
						...
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vLocal_296 + vLocal_298, 1f, 4294967295, (fLocal_299 * 0.1f), 0, 1193033728);
						PED::FORCE_PED_MOTION_STATE(*iParam0, 3626484699, false, 0, 0);
				...
				else if (iLocal_99 != 151)
				{
					...
					{
						BRAIN::TASK_START_SCENARIO_AT_POSITION(*iParam0, &cLocal_327, vLocal_296 + vLocal_336, (fLocal_297 + fLocal_337), 0, 0, 1);
			...
			case 2:
				...
				else
				{
					...
					{
						vVar3 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(AUDIO::_0x0626A247D2405330(), 5f, 0f, 0f) };
			...
			case 3:
				...
				{
					if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(*iParam0, true), vLocal_296 + vLocal_298) < (fLocal_299 * fLocal_299))
					{
						if (fLocal_299 == 0f)
						{
							fLocal_299 = (SYSTEM::VMAG(vLocal_298) * 0.75f);
						}
						BRAIN::TASK_WANDER_IN_AREA(*iParam0, vLocal_296 + vLocal_298, fLocal_299, 1077936128, 1086324736);
						func_121(4, 0);
						return 1;
					}
				}
			...
			case 4:
				...
				if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(*iParam0, true), vLocal_296 + vLocal_298) < (fLocal_299 * fLocal_299))
				{
					if (BRAIN::DOES_SCENARIO_EXIST_IN_AREA(vLocal_296 + vLocal_298, fLocal_299, 1))
					{
						BRAIN::TASK_USE_NEAREST_SCENARIO_TO_COORD(*iParam0, vLocal_296 + vLocal_298, fLocal_299, 0);
			...
			case 5:
				...
				else
				{
					...
					{
						if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(*iParam0, true), vVar5) > 100f)
						{
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vVar5, 1f, 4294967295, 1048576000, 0, 1193033728);
							vVar6 = { unk_0x8000C77B5F336760(*iParam0, true) - Vector(2f, 2f, 2f) };
							vVar7 = { unk_0x8000C77B5F336760(*iParam0, true) + Vector(2f, 2f, 2f) };
			...
			case 8:
				...
				if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(*iParam0, true), unk_0x8000C77B5F336760(*iParam0, true)) > (50f * 1.25f))
				{
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vLocal_296 + vLocal_298, 1f, 4294967295, (fLocal_299 * 0.1f), 0, 1193033728);
	...
	{
		if (iLocal_290 != 4294967294)
		{
			func_121(4294967294, 0);
		}
...
void func_7(int iParam0)//Position - 0x96A
{
	...
	if (PED::IS_PED_INJURED(iParam0))
	{
		if (!iLocal_342 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, AUDIO::_0x0626A247D2405330(), 1))
		{
			...
			if (iVar2 != 4294967295)
			{
				...
				if (iVar3 != 0)
				{
					...
					{
						func_102(75, unk_0x8000C77B5F336760(iParam0, false), 250f, 4294967295);
						if (func_40(Global_15BE5, iVar0, 2, 0, iVar3, iVar2, 75))
						{
							iLocal_342 = 1;
						}
					}
...
int func_10(int iParam0, int iParam1, var uParam2, char* sParam3, var uParam4, int iParam5, int iParam6)//Position - 0xCCE
{
	...
	if (iVar8 || func_31(sParam3, &Var4, uParam4))
	{
		if (iVar3 == 5)
		{
			if (iVar2 == 0)
			{
				func_30(uParam2, 0, AUDIO::_0x0626A247D2405330(), "MICHAEL", 0, 1);
			}
			else if (iVar2 == 1)
			{
				func_30(uParam2, 0, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
			}
			else if (iVar2 == 2)
			{
				func_30(uParam2, 0, AUDIO::_0x0626A247D2405330(), "TREVOR", 0, 1);
			}
		}
...
int func_14(char* sParam0, char* sParam1, var uParam2, int iParam3, var uParam4, char* sParam5)//Position - 0x1109
{
	...
	if (func_28(sParam0, 7))
	{
		...
		{
			func_30(uParam2, 0, AUDIO::_0x0626A247D2405330(), sVar0, 0, 1);
...
void func_38()//Position - 0x2222
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_34(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_35(iVar0) && (!func_23(14) || Global_19A3D))
			{
				if (Global_19E56.f_933.f_21B.f_10CD != iVar0 && func_35(Global_19E56.f_933.f_21B.f_10CD))
				{
...
int func_40(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x235C
{
	...
	if (iParam3 == 0)
	{
		if (func_99(iVar1, iParam2, 4294967295, &iVar4, &iVar5))
		{
	...
	else if (func_91(iVar1, iParam2, 4294967295, &sVar8))
	{
...
int func_42(int iParam0, int iParam1, int iParam2)//Position - 0x2548
{
	...
	return func_43(Global_19E56.f_6D76[iParam0 /*29*/].f_11, 0, iParam1, iParam2, 0);
}
...
void func_46(int iParam0)//Position - 0x2E6C
{
	...
	else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_5038.f_1D7, iParam0) || INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_48() /*12745*/].f_1FF2.f_A, iParam0))
	{
		bVar0 = true;
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_19E56.f_5038.f_1D7), iParam0);
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_200000[func_48() /*12745*/].f_1FF2.f_A), iParam0);
	}
	if (bVar0)
	{
...
char* func_47(int iParam0)//Position - 0x2F7D
{
	switch (iParam0)
	{
		case 0:
...
int func_49(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3037
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_50()//Position - 0x359F
{
	return Global_1407E0;
}

void func_51(int iParam0)//Position - 0x35AB
{
	func_72(93, iParam0);
	func_72(29, iParam0);
	func_72(30, iParam0);
...
bool func_52(int iParam0)//Position - 0x35CB
{
	if (iParam0 == 8)
	{
		return func_53(129, 4294967295, 4294967295);
	}
	if (iParam0 == 9)
	{
		return func_53(135, 4294967295, 4294967295);
	}
	if (iParam0 == 10)
	{
		return func_53(136, 4294967295, 4294967295);
	}
	if (iParam0 == 11)
	{
		return func_53(137, 4294967295, 4294967295);
	}
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_5038.f_1D7, iParam0);
	}
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_48() /*12745*/].f_1FF2.f_A, iParam0);
}

int func_53(int iParam0, int iParam1, int iParam2)//Position - 0x364F
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_54(int iParam0)//Position - 0x368C
{
	int iVar0;
...
int func_55(int iParam0, int iParam1)//Position - 0x39A4
{
	int iVar0;
...
int func_56(bool bParam0)//Position - 0x3C9C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_57(int iParam0, int iParam1)//Position - 0x3D53
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_58(int iParam0, int iParam1)//Position - 0x3D6E
{
...
int func_59(var uParam0, int iParam1)//Position - 0x3E0B
{
	int iVar0;
	var uVar1[78];
...
int func_60(var uParam0, int iParam1)//Position - 0x3EBC
{
	int iVar0;
...
bool func_61(var uParam0, int iParam1)//Position - 0x3F37
{
	return (*uParam0)[iParam1] == 78;
}

void func_62(var uParam0)//Position - 0x3F48
{
	int iVar0;
...
void func_63(var uParam0, int iParam1)//Position - 0x3F7C
{
	(*uParam0)[iParam1] = 78;
}

void func_64(var uParam0, float fParam1)//Position - 0x3F8C
{
	if (fParam1 == 0f)
	{
		uParam0->f_50 = 0f;
...
float func_65(var uParam0)//Position - 0x3FA9
{
	return uParam0->f_50;
}

bool func_66(var uParam0, int iParam1)//Position - 0x3FB5
{
	return func_67(uParam0, iParam1) != 4294967295;
}

int func_67(var uParam0, int iParam1)//Position - 0x3FC7
{
	int iVar0;
...
bool func_68(var uParam0)//Position - 0x3FF4
{
	return uParam0->f_4F == 1;
}

int func_69(int iParam0)//Position - 0x4003
{
	switch (iParam0)
	{
		case 60:
...
int func_70(int iParam0, int iParam1)//Position - 0x4053
{
	int iVar0;
...
void func_71(int iParam0, int iParam1)//Position - 0x40A4
{
	int iVar0;
...
void func_72(int iParam0, int iParam1)//Position - 0x40C7
{
	int iVar0;
...
int func_74(int iParam0)//Position - 0x4199
{
	var uVar0;
...
int func_79(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)//Position - 0x42F9
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_80(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)//Position - 0x4391
{
	int iVar0;
	...
	if (!Global_395A)
	{
		...
		{
			func_84(Global_389E, "SET_DATA_SLOT_EMPTY", 1f, 3212836864, 3212836864, 3212836864, 3212836864);
			func_81(1);
			func_84(Global_389E, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_389D), 3212836864, 3212836864, 3212836864);
		}
	}
	return 1;
}

void func_81(int iParam0)//Position - 0x4848
{
	int iVar0;
	int iVar1;
	int iVar2;
					...
					if (iVar0 == Global_956[iVar1 /*15*/].f_4)
					{
						if (Global_B88[iVar0] == 0)
						{
							...
							if (Global_25824A)
							{
								if (iVar1 == 14)
								{
									func_82(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(Global_41F5), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_B88[iVar0] = 1;
						}
					...
					if (iVar0 == Global_956[iVar1 /*15*/].f_4)
					{
						if (Global_B88[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_82(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(Global_41FA), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_11625)
								{
									...
									func_82(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_38B1)
									...
									func_82(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_956[iVar1 /*15*/].f_A == 57 && iVar1 == 23)
							{
								...
								func_82(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_82(Global_389E, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_956[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(0), -1f, &(Global_956[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_B88[iVar0] = 1;
						}
					}
...
void func_82(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, char* sParam8, char* sParam9, char* sParam10, char* sParam11)//Position - 0x4DEE
{
...
void func_83(char* sParam0)//Position - 0x4EA1
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	CAM::_DISABLE_VEHICLE_FIRST_PERSON_CAM_THIS_FRAME();
}

void func_84(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)//Position - 0x4EB3
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
...
bool func_85()//Position - 0x4F16
{
	return Global_140859;
}

void func_86(int iParam0)//Position - 0x4F22
{
	var uVar0;
	var uVar1;
...
void func_87(int iParam0)//Position - 0x4F41
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_88()//Position - 0x4FD3
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_89(Global_19E56.f_3721[iVar2 /*104*/].f_12, Global_19E56.f_3721[Global_41F9 /*104*/].f_12))
		{
			Global_41F9 = iVar2;
		}
		iVar2++;
...
int func_89(struct<6> Param0, struct<6> Param1)//Position - 0x509E
{
	struct<4> Var0;
	struct<4> Var1;
	int iVar2;
...
int func_91(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x52F1
{
	struct<4> Var0;
	struct<4> Var1[2];
	int iVar2;
...
int func_92(char* sParam0, int iParam1)//Position - 0x5429
{
	int iVar0;
	int iVar1;
...
int func_93(int iParam0)//Position - 0x549D
{
	switch (iParam0)
	{
		case 0:
...
char* func_94(int iParam0)//Position - 0x54FF
{
	switch (iParam0)
	{
		case 0:
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x5572
{
	struct<14> Var0;
...
void func_96(int iParam0)//Position - 0x56B0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_97(int iParam0)//Position - 0x5774
{
	switch (iParam0)
	{
		case 0:
...
bool func_98(bool bParam0)//Position - 0x57DE
{
...
int func_99(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4)//Position - 0x5809
{
	struct<4> Var0[2];
	int iVar1;
...
int func_100(int iParam0, int iParam1)//Position - 0x590B
{
...
int func_101(int iParam0)//Position - 0x59B9
{
	switch (iParam0)
	{
		case 0:
...
void func_102(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0x59F0
{
	if (iParam0 == iParam3)
	{
		return;
...
int func_103(int iParam0)//Position - 0x5A39
{
	int iVar0;
	int iVar1;
...
int func_104(int iParam0, int iParam1)//Position - 0x5AEF
{
	struct<10> Var0;
	bool bVar1;
	...
	bVar1 = false;
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Var0.f_2, func_105()))
	{
		bVar1 = true;
	}
	if (Var0.f_4 > iParam1)
	...
	if (bVar1)
	{
		if (Var0.f_3 < Global_19E56.f_1DEC.f_397[func_105()])
		{
			return 5;
		}
	}
...
int func_105()//Position - 0x5B87
{
	func_38();
	return Global_19E56.f_933.f_21B.f_10CD;
}

struct<10> func_106(int iParam0)//Position - 0x5BA0
{
	int iVar0;
	struct<10> Var1;
...
int func_107(int iParam0, int iParam1)//Position - 0x5BEF
{
	struct<14> Var0;
	bool bVar1;
...
struct<14> func_108(int iParam0)//Position - 0x5C7E
{
	int iVar0;
	struct<14> Var1;
...
int func_109(int iParam0, int iParam1)//Position - 0x5CCD
{
	struct<15> Var0;
	bool bVar1;
...
struct<15> func_110(int iParam0)//Position - 0x5D78
{
	int iVar0;
	struct<15> Var1;
...
int func_111(int iParam0)//Position - 0x5DC0
{
	int iVar0;
...
int func_113(vector3 vParam0, bool bParam1)//Position - 0x5F4F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_114(int iParam0)//Position - 0x5FCC
{
	if (iParam0 == 0)
	{
		return 2091854273;
...
int func_115(int iParam0)//Position - 0x6038
{
	if (iParam0 == 145)
	{
		return 7;
...
int func_116(int iParam0)//Position - 0x6093
{
	int iVar0;
	int iVar1;
...
int func_117(int iParam0)//Position - 0x60D3
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_118(int iParam0, bool bParam1)//Position - 0x6131
{
...
bool func_119(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x6181
{
	if (bParam2)
	{
...
void func_120(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x61C8
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_9(iParam3), 0);
}

void func_121(int iParam0, char* sParam1)//Position - 0x61E1
{
	sParam1 = sParam1;
	iLocal_290 = iParam0;
}

int func_122()//Position - 0x61F2
{
	if (!func_124())
	{
		func_30(&uLocal_100, 0, AUDIO::_0x0626A247D2405330(), "MICHAEL", 0, 1);
		switch (func_33(Global_16B5A))
		{
			case 0:
				func_30(&uLocal_100, 1, Global_16B5A, func_123(0), 0, 1);
				break;
			
			case 1:
				func_30(&uLocal_100, 2, Global_16B5A, func_123(1), 0, 1);
				break;
			
			case 2:
				func_30(&uLocal_100, 3, Global_16B5A, func_123(2), 0, 1);
				break;
...
char* func_123(int iParam0)//Position - 0x62F2
{
	switch (iParam0)
	{
		case 0:
...
int func_125(int iParam0, int iParam1)//Position - 0x6448
{
	vector3 vVar0;
	float fVar1;
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_126(Global_16B5A) && iParam1 != 0)
		{
			Global_16B5A = 0;
		}
	}
...
int func_126(var uParam0)//Position - 0x652C
{
	return uParam0;
}

bool func_127(var uParam0, var uParam1)//Position - 0x6536
{
	return (uParam0 && uParam1) != 0;
}

int func_128()//Position - 0x6545
{
	func_38();
...
void func_130()//Position - 0x65CB
{
	func_131((Global_16B5C - 1));
}

void func_131(int iParam0)//Position - 0x65DD
{
	Global_16B5C = iParam0;
}

void func_132()//Position - 0x65EB
{
	func_131(0);
}

void func_133()//Position - 0x65F8
{
	int iVar0;
	bool bVar1;
...
int func_136(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)//Position - 0x69FD
{
	*uParam4 = 9;
	*uParam5 = 8;
	switch (iParam0)
...
void func_137(char* sParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)//Position - 0x7117
{
...
int func_138(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x7131
{
	uParam2->f_3 = 1000;
	uParam2->f_1 = 0;
	uParam2->f_54 = 255;
...
void func_139(int iParam0, var uParam1, int iParam2)//Position - 0xA5A6
{
	int iVar0;
...
int func_140(int iParam0, var uParam1, int iParam2)//Position - 0xA802
{
	...
	if (!func_141(Global_16A1D[iParam0 /*98*/], 0))
	{
		func_139(iParam0, uParam1, iParam2);
		uParam1->f_5B = iParam2;
		return 1;
...
int func_141(int iParam0, bool bParam1)//Position - 0xAA39
{
	int iVar0;
	struct<2> Var1;
...
int func_142(int iParam0)//Position - 0xABB9
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_144(int iParam0)//Position - 0xAC9C
{
	int iVar0;
	int iVar1;
...
int func_145()//Position - 0xC999
{
	return 0;
}

int func_146()//Position - 0xC9A2
{
	return 1;
}

int func_147()//Position - 0xC9AB
{
	return 1;
}

int func_148()//Position - 0xC9B4
{
...
int func_150(int iParam0)//Position - 0xCA88
{
...
int func_151(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0xCD08
{
	int iVar0;
...
bool func_152(var uParam0)//Position - 0xCEF3
{
	int iVar0;
	vector3 vVar1;
	float fVar2;
...
int func_153(int iParam0, var uParam1, char* sParam2)//Position - 0xCFAE
{
	vector3 vVar0;
	int iVar1;
	var uVar2;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[0];
			StringCopy(sParam2, func_157(Global_19E56.f_933.f_21B.f_8F6[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[1];
			StringCopy(sParam2, func_157(Global_19E56.f_933.f_21B.f_8F6[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[2];
			StringCopy(sParam2, func_157(Global_19E56.f_933.f_21B.f_8F6[2]), 32);
			return 1;
			break;
...
int func_154(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0xF3BA
{
	switch (iParam1)
	{
		case 0:
...
int func_156(int iParam0, var uParam1, var uParam2)//Position - 0x11328
{
	switch (iParam0)
	{
		case 11:
...
char* func_157(int iParam0)//Position - 0x11C97
{
	switch (iParam0)
	{
		case 2014101067:
...
void func_158()//Position - 0x11D28
{
	if (iLocal_291 != 0)
	{
