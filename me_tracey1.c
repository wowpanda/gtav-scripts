...
void func_11()
{
	...
	{
		if (func_14(Global_104555.f_2353.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_42(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_47(PLAYER::PLAYER_ID())) && !func_44(PLAYER::PLAYER_ID(), 0)) && !func_43())
			{
...
int func_51(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_92619))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_92620))
		{
			return 0;
		}
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_70671[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iVar0), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_72(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iVar0), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, iParam4);
						}
						func_104(iVar0);
						if (Global_70669 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_72(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_72(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, iParam4);
		}
		if (Global_70669 == 1)
		{
			iVar2 = 0;
		...
		while (iVar4 < Var1.f_4)
		{
			if (FILES::_GET_PROP_FROM_OUTFIT(Var1.f_1, iVar4, &vVar2))
			{
				if ((vVar2.x != 0 && vVar2.x != -1) && vVar2.x != 1849449579)
				{
					if (vVar2.z == 10)
					{
						FILES::INIT_SHOP_PED_COMPONENT(&uVar3);
						FILES::GET_SHOP_PED_COMPONENT(vVar2.x, &uVar3);
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_115(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
		...
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_115(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_176(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_70671[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_72(iParam1)) && Global_70671[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_72(iParam1)))
	{
		return 1;
	}
	return 0;
...
{
	func_200(&Global_98118, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_220(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2547365[iParam0 /*3*/][func_107(iParam1)];
...
int func_236(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_257())
		{
			*uParam0 = func_242(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_271(char* sParam0, int iParam1)
{
	int iVar0;
	char* sVar1;
	int iVar2;
		...
		case 0:
			...
			if (func_26(iLocal_240))
			{
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_240, 0))
				{
					...
					BRAIN::TASK_SMART_FLEE_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 2000f, -1, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iVar0);
				...
				{
					BRAIN::TASK_SMART_FLEE_COORD(iLocal_240, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 2000f, -1, 0, 0);
				}
				iLocal_300 = 0;
				bLocal_301 = false;
				iLocal_302 = 0;
...
void func_288(bool bParam0)
{
	...
	if (bParam0)
	{
		vLocal_343[5 /*3*/] = { ENTITY::GET_ENTITY_COORDS(iLocal_240, 1) };
	}
	else
	{
		vLocal_343[5 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Local_237, 1) };
	}
}
...
int func_290()
{
	...
	if (Global_15756 == 4)
	{
		...
		if (iVar0 > -1)
		{
			if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_14624[iVar0 /*6*/])))
			{
				cVar1 = { Global_15375 };
...
void func_293(int iParam0, char* sParam1, char* sParam2, var uParam3, int iParam4, int iParam5)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_294()
{
	...
	else if (bLocal_277)
	{
		...
		else if (func_56(iLocal_239, ENTITY::GET_ENTITY_COORDS(iLocal_240, 0), 10f))
		{
			return 1;
		}
...
int func_299(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_301(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
void func_306(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	func_307(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_307(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)
{
	func_308(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_308(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
	{
...
void func_309(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
	...
	if (func_332(iParam1) && ENTITY::IS_ENTITY_VISIBLE(iParam1))
	{
		iVar1 = 0;
...
int func_314(char* sParam0)
{
	if (!func_315(1, 1, 0))
	{
		if ((!MISC::IS_STRING_NULL_OR_EMPTY(sParam0) && func_284(sParam0)) || func_284("CMN_HINT"))
		{
			HUD::CLEAR_HELP(1);
		}
		return 0;
...
int func_315(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_321() || func_320(Global_4456448.f_143970)) || func_319())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if ((VEHICLE::_0xE33FFA906CE74880(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), func_318(PLAYER::PLAYER_PED_ID(), 0)) || (ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) == joaat("apc") && func_318(PLAYER::PLAYER_PED_ID(), 0) != -1)) || (ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) == joaat("akula") && func_318(PLAYER::PLAYER_PED_ID(), 0) != -1))
			{
				return 0;
			}
		}
...
void func_324(var uParam0, int iParam1, vector3 vParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_325()
{
	return func_326(PLAYER::PLAYER_ID());
}
...
int func_327(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_330(bParam1, bParam2, bParam3) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || func_328(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_334(int iParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, bool bParam5, int iParam6)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if (bParam5)
...
void func_335()
{
	...
	vVar0 = { ENTITY::GET_ENTITY_COORDS(iLocal_240, 1) };
		...
		case 0:
			if (func_26(iLocal_240))
			{
				...
				else
				{
					...
					{
						vLocal_343[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Local_237, 1) };
	...
	switch (iLocal_294)
	{
		...
		case 1:
			if (func_26(iLocal_240))
			{
				...
				else if (func_338() && (MISC::GET_GAME_TIMER() - iLocal_272) > 6000)
				{
					iLocal_294 = 7;
				}
...
void func_340()
{
	if ((MISC::GET_GAME_TIMER() - iLocal_271) > 3000)
	{
		...
		vLocal_270[2 /*3*/] = { ENTITY::GET_ENTITY_COORDS(iLocal_233, 1) };
		iLocal_271 = MISC::GET_GAME_TIMER();
	}
}
...
int func_342()
{
	...
	if (func_26(Local_237))
	{
		fVar0 = func_343(ENTITY::GET_ENTITY_ROLL(Local_237), 0f, 360f);
...
void func_346()
{
	...
	if (iLocal_356 == 1)
	{
		...
		else if ((MISC::GET_GAME_TIMER() - iLocal_352) < iLocal_353 && func_347(1))
		{
	...
	if (iLocal_356 == 2)
	{
		if ((MISC::GET_GAME_TIMER() - iLocal_352) < iLocal_353 && func_347(0))
		{
...
int func_350(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6)
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		vVar1 = { func_301(ENTITY::GET_ENTITY_COORDS(iVar0, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
		...
		case 0:
			if (!func_358())
			{
				...
				if (func_354(Local_237.f_6, Local_237.f_9, 0))
				{
					...
					BRAIN::OPEN_SEQUENCE_TASK(&iVar0);
					BRAIN::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_237, ENTITY::GET_ENTITY_COORDS(iLocal_233, 1), 4, 35f, 2883621, 10f, 12f, 1);
...
void func_360()
{
	...
	{
		if (func_338() && (MISC::GET_GAME_TIMER() - iLocal_272) > 18000)
		{
...
int func_362(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	vector3 vVar0;
	...
	if (func_26(PLAYER::PLAYER_PED_ID()) && func_26(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_366(PLAYER::PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_363(int iParam0, float fParam1)
{
	...
	if (func_26(PLAYER::PLAYER_PED_ID()) && func_26(iParam0))
	{
		if (func_365(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				fVar0 = 40f;
...
bool func_364(int iParam0, float fParam1)
{
...
int func_370(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_301(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
	...
	switch (iLocal_53)
	{
		case 0:
			...
			if (!func_358())
			{
				if (!func_2())
				{
					if (((func_385(&iLocal_239, vLocal_323, fLocal_324, 1) && func_375(&iLocal_233, 15, vLocal_321, fLocal_322, 1, 0)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_246)) && func_26(iLocal_233))
					{
						iLocal_243 = 1;
						...
						func_374();
						BRAIN::TASK_PLAY_ANIM(iLocal_239, sLocal_246, "nervous_loop", 8f, -8f, -1, 1, 0, 0, 0, 0);
					...
					switch (iLocal_254)
					{
						case 0:
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 246.1479f, -39.21085f, 67.89664f, 202.6635f, -23.77725f, 72.90416f, 22f, 0, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 233.7891f, -45.51515f, 67.57388f, 229.9916f, -55.96275f, 72.28979f, 12.5f, 0, true, 0))
							{
								...
								BRAIN::OPEN_SEQUENCE_TASK(&iVar0);
								BRAIN::TASK_PLAY_ANIM(0, sLocal_246, "breakout", 8f, -4f, -1, 0, 0, 0, 0, 0);
...
int func_375(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	struct<98> Var0;
	int iVar1;
	int iVar2;
	...
	if (!func_12(iParam1))
	{
		...
		if ((iParam1 == 17 && Global_104555.f_2353.f_539.f_3598[0 /*197*/][0 /*98*/] == Var0) || (iParam1 == 15 && Global_104555.f_2353.f_539.f_3598[0 /*197*/][1 /*98*/] == Var0))
		{
			...
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/], vParam2, fParam3, false, false, false);
				...
				Var0.f_3 = 1250;
				VEHICLE::SET_VEHICLE_COLOURS(*iParam0, Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_5, Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_6);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(*iParam0, Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_7, Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_8);
				VEHICLE::SET_VEHICLE_DIRT_LEVEL(*iParam0, Var0.f_2);
				iVar2 = 0;
				while (iVar2 < 12)
				{
					VEHICLE::SET_VEHICLE_EXTRA(*iParam0, iVar2 + 1, !Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_11[iVar2]);
					iVar2++;
				}
				...
				VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(*iParam0, &(Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_27));
				...
				{
					VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(*iParam0, Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_26);
				}
				VEHICLE::SET_VEHICLE_TYRE_SMOKE_COLOR(*iParam0, Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_84, Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_85, Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_86);
				VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(*iParam0, Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_88);
				VEHICLE::SET_VEHICLE_WINDOW_TINT(*iParam0, Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_87);
				VEHICLE::_SET_VEHICLE_NEON_LIGHTS_COLOUR(*iParam0, Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_93, Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_94, Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_95);
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 2, MISC::IS_BIT_SET(Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_92, 28));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 3, MISC::IS_BIT_SET(Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_92, 29));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 0, MISC::IS_BIT_SET(Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_92, 30));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 1, MISC::IS_BIT_SET(Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_92, 31));
				if (VEHICLE::GET_VEHICLE_LIVERY_COUNT(*iParam0) > 1 && Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_89 >= 0)
				{
					VEHICLE::SET_VEHICLE_LIVERY(*iParam0, Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_89);
				}
				if (Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_90 > -1)
				{
					if (!VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(*iParam0)))
					{
						if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(*iParam0)))
						{
							...
							{
								VEHICLE::SET_VEHICLE_WHEEL_TYPE(*iParam0, Global_104555.f_2353.f_539.f_3598[0 /*197*/][iVar1 /*98*/].f_90);
							}
						}
						else
						{
...
void func_376(int iParam0, struct<98> Param1)
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_379(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_383(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_382(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_382(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_381(iParam0);
	if (func_380(*iParam0))
	{
...
int func_385(int iParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
...
void func_387(int iParam0, vector3 vParam1, float fParam2)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_388(vector3 vParam0, bool bParam1)
{
	int iVar0;
...
void func_390(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	vector3 vVar0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_95149.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_95149.f_4, 0))
		{
			if (func_420(24) != Global_95149.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_417(ENTITY::GET_ENTITY_COORDS(Global_95149.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_217(iParam0, 0, 0)) || func_217(iParam0, 1, 0)) || func_217(iParam0, 2, 0)) || func_207(iParam0) != 145) || func_408(iParam0)) || func_407(iParam0)) || func_406(iParam0)) || func_405(iParam0)) || !func_395(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_407(iParam0))
		{
		}
...
void func_410(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_409(&(Global_69678.f_555[0 /*21*/]), iParam0))
	{
...
int func_417(vector3 vParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
...
int func_418(vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_435(int iParam0, var uParam1, float fParam2)
{
	switch (iParam0)
	{
		case 11:
...
void func_438(bool bParam0, bool bParam1)
{
	...
	else if ((((iLocal_52 == 3 || iLocal_52 == 4) || iLocal_52 == 5) && func_26(iLocal_233)) && func_26(iLocal_239))
	{
		if (func_26(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_233, 0))
			{
				func_449(PLAYER::PLAYER_PED_ID(), iLocal_233, -1);
				vLocal_357 = { ENTITY::GET_ENTITY_COORDS(iLocal_233, 1) };
			}
		}
	}
	else
...
void func_439(vector3 vParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
void func_450(vector3 vParam0, float fParam1, bool bParam2)
{
	func_451();
...
void func_453(vector3 vParam0, var uParam1, var uParam2)
{
	vector3 vVar0[4];
	float fVar1[4];
	int iVar2;
...
int func_459(vector3 vParam0, float fParam1)
{
	return func_460(&(Global_98118.f_2875), vParam0, fParam1, 0);
}

int func_460(var uParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
	...
	if (func_483(uParam0))
	{
		...
		if (func_482(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_465(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_465(int iParam0, vector3 vParam1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_467(iParam0, uVar1[iVar3], 1) && func_466(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_235(vParam1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_469(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90309[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90309[iVar0]) == func_209(iParam0, iParam1))
				{
...
void func_470(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_474(int iParam0)
{
	...
	if (func_476(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
...
void func_492(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	vector3 vVar0;
	float fVar1;
...
void func_493(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	int iVar0;
...
int func_494(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
...
void func_495(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_12(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_499(*iParam1, 0, &uVar0))
		{
...
int func_496(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_497(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
int func_499(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_518(iVar0, bParam1, uParam2) && !func_517(PLAYER::PLAYER_ID())) && !func_503(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_500(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
...
{
	if (func_516(PLAYER::PLAYER_ID()) || func_515(PLAYER::PLAYER_ID()))
	{
		if (func_504(iParam0))
		{
			return 1;
...
int func_505(int iParam0)
{
	...
	if (func_506(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_518(int iParam0, bool bParam1, var uParam2)
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_500(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_522(int iParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_530(var uParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	*(uParam0[0 /*3*/]) = { vParam1 };
	*(uParam0[1 /*3*/]) = { vParam2 };
	uParam0->f_7 = fParam3;
...
Vector3 func_536(char* sParam0, int iParam1)
{
	vector3 vVar0;
...
void func_542(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
