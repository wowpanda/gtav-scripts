...
void __EntryFunction__()
{
	...
	func_273(&uLocal_393, 3);
	func_272();
	if ((iLocal_90 == 1 && func_271(55)) && !func_270(55))
	{
		TERMINATE_THIS_THREAD();
	}
	if (func_229(vLocal_122, 25, iLocal_90, 0, 0))
	{
		func_226(-1);
	}
	else
	...
	while (true)
	{
		...
		func_222(uLocal_65, &uLocal_392);
		if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || bLocal_149)
		{
			switch (iLocal_46)
			{
				case 0:
					if (func_208())
					{
						...
						CLEAR_AREA_OF_VEHICLES(-127.9025f, -1574.084f, 36.4128f, 10f, 0, 0, 0, 0, 0, 0);
						iLocal_156 = 1;
						iLocal_46 = 1;
					}
					else if (func_207())
				...
				case 1:
						...
						switch (iLocal_48)
						{
							...
							case 2:
								...
								switch (iLocal_49)
								{
									case 0:
										...
										if (IS_PED_INJURED(uLocal_63) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_63, PLAYER_PED_ID(), 0))
										{
											iVar0 = IS_PED_INJURED(uLocal_62);
											if (!DOES_PICKUP_EXIST(uLocal_191))
											{
											}
											if (iVar0 == 0 && iLocal_90 == 1)
											{
												SET_PED_TO_RAGDOLL(uLocal_62, 500, 1000, 0, 0, 0, 0);
												TASK_SMART_FLEE_PED(uLocal_62, PLAYER_PED_ID(), 250f, -1, 0, 0);
												SET_PED_KEEP_TASK(uLocal_62, 1);
												func_198(1);
												func_193();
											}
										}
									...
									case 4:
										...
										if (GET_SCRIPT_TASK_STATUS(uLocal_62, 242628503) == 7)
										{
											OPEN_SEQUENCE_TASK(&uLocal_121);
											TASK_LOOK_AT_ENTITY(0, uLocal_63, 5000, 0, 2);
											TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), 5000);
											TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_a", 4f, -4f, -1, 0, 0, 0, 0, 0);
											TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
											TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
											CLOSE_SEQUENCE_TASK(uLocal_121);
											TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
											CLEAR_SEQUENCE_TASK(&uLocal_121);
										}
										break;
									
									case 5:
										func_156();
										if (!IS_ENTITY_DEAD(uLocal_62, 0))
										{
											if (GET_SCRIPT_TASK_STATUS(uLocal_62, 242628503) == 7)
											{
												OPEN_SEQUENCE_TASK(&uLocal_121);
												TASK_TURN_PED_TO_FACE_ENTITY(0, uLocal_63, 0);
												TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
												TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
												TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
												CLOSE_SEQUENCE_TASK(uLocal_121);
												TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
								...
								if (iLocal_49 == 0)
								{
									if (func_152())
									{
										if (iLocal_143 == 4)
										{
											if (DOES_BLIP_EXIST(uLocal_66))
											{
												REMOVE_BLIP(&uLocal_66);
											}
								...
								if (func_147())
								{
									func_146();
									func_145();
									if (IS_ENTITY_AT_COORD(uLocal_62, vLocal_184, 7f, 7f, 7f, 0, 1, 0))
									{
										iLocal_143 = 2;
										iLocal_48 = 3;
									}
								...
								if (bLocal_149)
								{
									if (!IS_PED_IN_COMBAT(uLocal_63, 0))
									{
										func_143(uLocal_66, &uLocal_142);
									}
									else if (DOES_BLIP_EXIST(uLocal_66))
									{
										if (GET_BLIP_COLOUR(uLocal_66) == 1)
										{
										}
										else
										{
											SET_BLIP_AS_FRIENDLY(uLocal_66, 0);
											SET_BLIP_COLOUR(uLocal_66, 1);
										}
									}
								}
								if (func_142())
							...
							case 5:
								...
								if (!bLocal_152)
								{
									...
									if (func_121(func_122()) < iLocal_192)
									{
										iLocal_48 = 12;
									}
								}
							...
							case 8:
								if (!IS_PED_INJURED(uLocal_62))
								{
									if (IS_ENTITY_AT_ENTITY(uLocal_62, PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0))
									{
										iLocal_48 = 6;
									}
									else
							...
							case 9:
								DRAW_DEBUG_TEXT_2D("ABLE_TO_RETRIEVE_DROPPED_BAG", 0.02f, 0.1f, 0f, 0, 0, 255, 255);
								if (DOES_ENTITY_EXIST(uLocal_63))
								{
									if (IS_PED_INJURED(uLocal_63))
									{
										if (DOES_BLIP_EXIST(uLocal_66))
										{
											REMOVE_BLIP(&uLocal_66);
										}
										if (!DOES_ENTITY_EXIST(uLocal_62))
										{
											if (DOES_ENTITY_EXIST(uLocal_64))
											{
												DELETE_OBJECT(&uLocal_64);
											}
											func_40();
											iLocal_56 = 1;
											func_133();
					...
					if (bLocal_60)
					{
						if (DOES_PICKUP_EXIST(uLocal_191))
						{
							if (DOES_PICKUP_OBJECT_EXIST(uLocal_191))
							{
								if (VDIST(vLocal_184, GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) > 150f)
								{
									func_274();
								}
							}
					...
					else if (bLocal_149)
					{
						if (!IS_PED_INJURED(uLocal_63))
						{
							if (iLocal_48 != 6)
							{
								if (func_38(PLAYER_PED_ID(), uLocal_63, 1) > 150f && (!IS_ENTITY_ON_SCREEN(uLocal_63) || IS_ENTITY_OCCLUDED(uLocal_63)))
								{
					...
					if (DOES_ENTITY_EXIST(uLocal_62))
					{
						if (!IS_PED_INJURED(uLocal_62))
						{
							if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_62, PLAYER_PED_ID(), 1))
							{
								if (DOES_ENTITY_EXIST(uLocal_64))
								{
									if (IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_64, uLocal_62))
									{
										DETACH_ENTITY(uLocal_64, 1, 1);
									}
								}
							}
						}
					...
					if (iLocal_150)
					{
						if (!iLocal_163)
						{
							if (!IS_ENTITY_DEAD(uLocal_63, 0) && !IS_ENTITY_DEAD(uLocal_62, 0))
							{
								if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(uLocal_63, 1), GET_ENTITY_COORDS(uLocal_62, 1), 1) > 100f && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(uLocal_63, 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 1) < 100f)
								{
									TASK_SMART_FLEE_PED(uLocal_63, PLAYER_PED_ID(), 200f, -1, 0, 0);
									iLocal_163 = 1;
								}
							}
						}
					...
					if (bLocal_149 && !iLocal_150)
					{
						if (!IS_PED_INJURED(uLocal_63))
						{
							if (iLocal_90 == 3)
							{
								if (GET_SCRIPT_TASK_STATUS(uLocal_63, 1805844857) != 1)
								{
									CLEAR_PED_SECONDARY_TASK(uLocal_63);
									TASK_SMART_FLEE_PED(uLocal_63, uLocal_62, 200f, -1, 0, 0);
									FORCE_PED_MOTION_STATE(uLocal_63, -530524, 1, 0, 0);
									iLocal_150 = 1;
								}
							}
							else if (GET_SCRIPT_TASK_STATUS(uLocal_63, 1805844857) != 1)
							{
								CLEAR_PED_SECONDARY_TASK(uLocal_63);
								TASK_SMART_FLEE_PED(uLocal_63, PLAYER_PED_ID(), 200f, -1, 0, 0);
								FORCE_PED_MOTION_STATE(uLocal_63, -530524, 1, 0, 0);
							...
							if (HAS_ANIM_EVENT_FIRED(uLocal_63, -2134635134))
							{
								TASK_SMART_FLEE_PED(uLocal_63, uLocal_62, 200f, -1, 0, 0);
								FORCE_PED_MOTION_STATE(uLocal_63, -530524, 1, 0, 0);
								iLocal_150 = 1;
							...
							{
								if (IS_ENTITY_PLAYING_ANIM(uLocal_63, cLocal_359, sLocal_369, 3))
								{
									if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_63, cLocal_359, sLocal_369) >= 0.922f)
									{
										TASK_SMART_FLEE_PED(uLocal_63, PLAYER_PED_ID(), 200f, -1, 0, 0);
										FORCE_PED_MOTION_STATE(uLocal_63, -530524, 1, 0, 0);
										iLocal_150 = 1;
								...
								if (IS_ENTITY_PLAYING_ANIM(uLocal_63, cLocal_359, sLocal_367, 3))
								{
									if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_63, cLocal_359, sLocal_367) >= 0.922f)
									{
										TASK_SMART_FLEE_PED(uLocal_63, PLAYER_PED_ID(), 200f, -1, 0, 0);
										FORCE_PED_MOTION_STATE(uLocal_63, -530524, 1, 0, 0);
										iLocal_150 = 1;
...
void func_4()
{
	if (!IS_PED_INJURED(uLocal_63) || !bLocal_133)
	{
...
void func_8(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_34(uParam1) && IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
...
int func_14(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_22() || func_21(Global_4456448.f_161209)) || func_20())
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			if (((_0xE33FFA906CE74880(uVar0, iVar1) || (GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_18(uVar0, 10)) && GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_15(int iParam0)
{
	if (iParam0 != func_17())
	{
		...
		else if ((Global_1312867 && iParam0 == PLAYER_ID()) && func_16(iParam0, 1, 0))
		{
			return Global_2424047[iParam0 /*416*/].f_309.f_5 != -1;
		}
	}
...
int func_29(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_32(bParam1, bParam2, bParam3) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1) || func_30(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_40()
{
	if (!DOES_PICKUP_EXIST(uLocal_191))
	{
		if (IS_PED_INJURED(uLocal_63))
		{
			vLocal_184 = { GET_DEAD_PED_PICKUP_COORDS(uLocal_63, 1067030938, 1069547520) };
		}
		else
		{
			vLocal_184 = { GET_SAFE_PICKUP_COORDS(GET_ENTITY_COORDS(uLocal_63, 1), 1067030938, 1069547520) };
		}
		uLocal_191 = CREATE_PICKUP(joaat("pickup_money_wallet"), vLocal_184, uLocal_144, iLocal_192, 1, iLocal_85);
		iLocal_67 = func_150(uLocal_191);
		func_37(&uLocal_380, 0, 0);
		bLocal_60 = true;
	}
...
void func_41()
{
	if (!IS_PED_INJURED(uLocal_62))
	{
		if (IS_ENTITY_PLAYING_ANIM(uLocal_62, cLocal_359, "flee_backward_loop_shopkeeper", 3))
		{
			OPEN_SEQUENCE_TASK(&uLocal_121);
			TASK_PLAY_ANIM(0, cLocal_359, "flee_backward_outro_shopkeeper", 8f, -4f, -1, 8, 0, 0, 0, 0);
			TASK_WANDER_STANDARD(0, 1193033728, 0);
			CLOSE_SEQUENCE_TASK(uLocal_121);
			TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
			CLEAR_SEQUENCE_TASK(&uLocal_121);
		}
		else if (IS_ENTITY_PLAYING_ANIM(uLocal_62, cLocal_359, "flee_forward_loop_shopkeeper", 3))
		{
			OPEN_SEQUENCE_TASK(&uLocal_121);
			TASK_PLAY_ANIM(0, cLocal_359, "flee_forward_outro_shopkeeper", 8f, -4f, -1, 8, 0, 0, 0, 0);
			TASK_WANDER_STANDARD(0, 1193033728, 0);
			CLOSE_SEQUENCE_TASK(uLocal_121);
			TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
			CLEAR_SEQUENCE_TASK(&uLocal_121);
...
void func_54()
{
	if (!IS_PED_INJURED(uLocal_62))
	{
		...
		SET_PED_AS_NO_LONGER_NEEDED(&uLocal_62);
	}
	if (IS_PED_INJURED(uLocal_63) || IS_PED_INJURED(uLocal_62))
	{
		if (DOES_BLIP_EXIST(uLocal_66))
		{
			REMOVE_BLIP(&uLocal_66);
...
void func_55()
{
	...
	if (iLocal_143 == 1)
	{
		if (!iLocal_51)
		{
			if (!IS_PED_INJURED(uLocal_63))
			{
				CLEAR_PED_TASKS(uLocal_63);
				TASK_COMBAT_PED(uLocal_63, PLAYER_PED_ID(), 0, 16);
				SET_PED_KEEP_TASK(uLocal_63, 1);
			}
			if (!IS_PED_INJURED(uLocal_62))
			{
				if (DOES_PICKUP_EXIST(uLocal_191))
				{
					if (DOES_PICKUP_OBJECT_EXIST(uLocal_191))
					{
						CLEAR_PED_TASKS(uLocal_62);
						OPEN_SEQUENCE_TASK(&uLocal_121);
						TASK_FOLLOW_NAV_MESH_TO_COORD(0, GET_PICKUP_COORDS(uLocal_191), 1f, 20000, 0.25f, 0, 1193033728);
						CLOSE_SEQUENCE_TASK(uLocal_121);
						TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
						CLEAR_SEQUENCE_TASK(&uLocal_121);
					}
	...
	if (iLocal_143 == 2)
	{
		if (!iLocal_51)
		{
			if (!IS_PED_INJURED(uLocal_63))
			{
				...
				TASK_COMBAT_PED(uLocal_63, PLAYER_PED_ID(), 0, 16);
				SET_PED_KEEP_TASK(uLocal_63, 1);
				SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_63, 0, 1);
				SET_PED_AS_NO_LONGER_NEEDED(&uLocal_63);
			}
			if (!IS_PED_INJURED(uLocal_62))
			{
				if (DOES_PICKUP_EXIST(uLocal_191))
				{
					if (DOES_PICKUP_OBJECT_EXIST(uLocal_191))
					{
						if (IS_ENTITY_AT_COORD(uLocal_62, GET_PICKUP_COORDS(uLocal_191), 10f, 10f, 10f, 0, 1, 0))
						{
							if (iLocal_90 == 3)
							{
								if ((!IS_ENTITY_PLAYING_ANIM(uLocal_62, cLocal_359, "handsup_standing_enter", 3) && !IS_ENTITY_PLAYING_ANIM(uLocal_62, cLocal_359, "handsup_standing_base", 3)) && !IS_ENTITY_PLAYING_ANIM(uLocal_62, cLocal_359, "handsup_standing_exit", 3))
								{
									CLEAR_PED_TASKS(uLocal_62);
									OPEN_SEQUENCE_TASK(&uLocal_121);
									TASK_FOLLOW_NAV_MESH_TO_COORD(0, GET_PICKUP_COORDS(uLocal_191), 1f, 20000, 0.25f, 0, 1193033728);
							...
							else if ((!IS_ENTITY_PLAYING_ANIM(uLocal_62, cLocal_359, sLocal_370, 3) && !IS_ENTITY_PLAYING_ANIM(uLocal_62, cLocal_359, sLocal_366, 3)) && !IS_ENTITY_PLAYING_ANIM(uLocal_62, cLocal_359, sLocal_368, 3))
							{
								CLEAR_PED_TASKS(uLocal_62);
								OPEN_SEQUENCE_TASK(&uLocal_121);
								TASK_FOLLOW_NAV_MESH_TO_COORD(0, GET_PICKUP_COORDS(uLocal_191), 1f, 20000, 0.25f, 0, 1193033728);
	...
	if (iLocal_143 == 3)
	{
		if (!iLocal_51)
		{
			...
			{
				CLEAR_PED_TASKS(uLocal_63);
				TASK_SMART_FLEE_PED(uLocal_63, PLAYER_PED_ID(), 250f, -1, 0, 0);
				SET_PED_KEEP_TASK(uLocal_63, 1);
				SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_63, 0, 1);
				SET_PED_AS_NO_LONGER_NEEDED(&uLocal_63);
			}
		...
		if (!IS_PED_INJURED(uLocal_62))
		{
			if (iLocal_51)
			{
				if (DOES_PICKUP_EXIST(uLocal_191))
				{
					if (DOES_PICKUP_OBJECT_EXIST(uLocal_191))
					{
						if (IS_ENTITY_PLAYING_ANIM(uLocal_62, cLocal_360, "pickup_low", 3))
						{
							if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_62, cLocal_360, "pickup_low") > 0.5f)
							{
								if (DOES_PICKUP_EXIST(uLocal_191))
								{
									if (DOES_PICKUP_OBJECT_EXIST(uLocal_191))
									{
										...
										REMOVE_PICKUP(uLocal_191);
										bLocal_52 = true;
									}
								}
							}
						}
						else if (GET_SCRIPT_TASK_STATUS(uLocal_62, 242628503) == 7)
						{
							CLEAR_PED_TASKS(uLocal_62);
							OPEN_SEQUENCE_TASK(&uLocal_121);
							TASK_PLAY_ANIM(0, cLocal_360, "pickup_low", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
							TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 250f, -1, 0, 0);
							CLOSE_SEQUENCE_TASK(uLocal_121);
							TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
							CLEAR_SEQUENCE_TASK(&uLocal_121);
							SET_PED_KEEP_TASK(uLocal_62, 1);
					...
					{
						SET_PED_MONEY(uLocal_62, iLocal_192);
						SET_PED_AS_NO_LONGER_NEEDED(&uLocal_62);
						func_198(3);
						func_193();
					}
...
void func_57()
{
	...
	if (!IS_PED_INJURED(uLocal_62))
	{
		if (!bLocal_152)
		{
			if (iLocal_153)
			{
				vVar15 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
				iVar18 = 1;
				if (iLocal_90 == 1)
				{
					if (vVar15.z > 33.5f)
				...
				if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_62, 5f, 5f, 5f, 0, 1, 0) && iVar18 == 1)
				{
					if (func_119(2))
					{
						CLEAR_HELP(1);
						...
						if (func_118(1, 0, 1))
						{
							if (!func_117())
							{
								if (!IS_PED_RAGDOLL(PLAYER_PED_ID()))
								{
									...
									if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
									{
										while (!func_107(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), uLocal_77, 1, 1056964608, 0, 1, 0) || func_161())
										{
									...
									if (!IS_PED_INJURED(uLocal_62))
									{
										SET_PED_CAN_RAGDOLL(uLocal_62, 0);
									}
									HIDE_HUD_AND_RADAR_THIS_FRAME();
				...
				{
					func_103(GET_ENTITY_COORDS(uLocal_62, 1), &uLocal_76, &uLocal_77);
				}
			}
			else if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_62, 15f, 15f, 15f, 0, 1, 0))
			{
				OPEN_SEQUENCE_TASK(&uLocal_121);
				...
				if (iLocal_47 == 2)
				{
					TASK_PLAY_ANIM(0, cLocal_377, "RETURNING_FRONT_A", 8f, -1000f, -1, 0, 0, 0, 0, 0);
				}
				CLOSE_SEQUENCE_TASK(uLocal_121);
				TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
				CLEAR_SEQUENCE_TASK(&uLocal_121);
				FORCE_PED_MOTION_STATE(uLocal_62, -668482597, 0, 0, 0);
				iLocal_153 = 1;
			}
		}
		if (bLocal_152)
			...
			switch (iLocal_151)
			{
				case 0:
					...
					if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
					{
						if (!IS_PED_INJURED(uLocal_62))
						{
							func_100(uLocal_62, &vLocal_125, &vLocal_128, cLocal_361, sLocal_363);
							if (iLocal_90 == 1)
							{
							...
							GET_GROUND_Z_FOR_3D_COORD(vLocal_125, &(vLocal_125.f_2), 0, 0);
							vVar1 = { GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_361, sLocal_363, vLocal_125, vLocal_128, 0f, 2) };
							vVar10 = { vVar1 - vLocal_125 };
							vVar10.z = 0f;
							uVar13 = VMAG(vVar10);
							GET_GROUND_Z_FOR_3D_COORD(vVar1, &(vVar1.f_2), 0, 0);
							fVar14 = (vLocal_125.z - vVar1.z);
							vLocal_128.x = ATAN2(fVar14, uVar13);
						...
						if (IS_VEHICLE_DRIVEABLE(GET_PLAYERS_LAST_VEHICLE(), 0))
						{
							if (!IS_VEHICLE_DRIVEABLE(uVar0, 0))
							{
								...
								GET_MODEL_DIMENSIONS(GET_ENTITY_MODEL(uVar0), &uVar4, &Var7);
								if (IS_ENTITY_AT_COORD(uVar0, vLocal_125, (Var7.f_1 + 1.5f), (Var7.f_1 + 1.5f), 3f, 0, 1, 0) || IS_ENTITY_AT_COORD(uVar0, GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_361, sLocal_363, vLocal_125, vLocal_128, 0, 2), (Var7.f_1 + 1f), (Var7.f_1 + 1f), 3f, 0, 1, 0))
								{
									if (iLocal_90 == 1)
									{
									...
									{
										fLocal_79 = GET_ENTITY_HEADING(uVar0);
										vLocal_80 = { func_98(vLocal_125, GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_361, sLocal_363, vLocal_125, vLocal_128, 0, 2)) };
									}
									if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
									{
										SET_ENTITY_COORDS(uVar0, vLocal_80, 1, 0, 0, 1);
										SET_ENTITY_HEADING(uVar0, fLocal_79);
						...
						CLEAR_AREA(vLocal_125, 2f, 1, 1, 0, 0);
						HIDE_PED_WEAPON_FOR_SCRIPTED_CUTSCENE(PLAYER_PED_ID(), 1);
						uLocal_64 = CREATE_OBJECT(iLocal_85, GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 1, 1, 0);
						if (!IS_PED_INJURED(PLAYER_PED_ID()))
						{
							ATTACH_ENTITY_TO_ENTITY(uLocal_64, PLAYER_PED_ID(), GET_PED_BONE_INDEX(PLAYER_PED_ID(), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
						}
						uLocal_131 = CREATE_SYNCHRONIZED_SCENE(vLocal_125, vLocal_128, 2);
						_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_131, 0);
						uLocal_132 = CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
						PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_132, uLocal_131, sLocal_364, cLocal_361);
						CLEAR_PED_TASKS_IMMEDIATELY(PLAYER_PED_ID());
						TASK_SYNCHRONIZED_SCENE(PLAYER_PED_ID(), uLocal_131, cLocal_361, sLocal_362, 1000f, -8f, 0, 0, 1148846080, 0);
						if (!IS_PED_INJURED(uLocal_62))
						{
							CLEAR_PED_TASKS_IMMEDIATELY(uLocal_62);
							TASK_SYNCHRONIZED_SCENE(uLocal_62, uLocal_131, cLocal_361, sLocal_363, 1000f, -8f, 0, 0, 1148846080, 0);
						}
						SET_CAM_ACTIVE(uLocal_132, 1);
				...
				case 1:
					if ((IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_131) && GET_SYNCHRONIZED_SCENE_PHASE(uLocal_131) > 0.9f) || func_96(1000))
					{
						SET_PLAYER_CONTROL(PLAYER_ID(), 1, 0);
						SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						SET_CAM_ACTIVE(uLocal_132, 0);
						DESTROY_CAM(uLocal_132, 0);
						func_95();
						if (!IS_PED_INJURED(uLocal_62))
						{
							CLEAR_PED_TASKS_IMMEDIATELY(uLocal_62);
							SET_PED_MONEY(uLocal_62, (iLocal_192 - (iLocal_192 / 10)));
							vVar1 = { GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_361, sLocal_363, vLocal_125, vLocal_128, 1f, 2) };
							GET_GROUND_Z_FOR_3D_COORD(vVar1, &(vVar1.f_2), 0, 0);
							SET_ENTITY_COORDS(uLocal_62, vVar1, 1, 0, 0, 1);
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_62, 0);
							vVar1 = { GET_ANIM_INITIAL_OFFSET_ROTATION(cLocal_361, sLocal_363, vLocal_125, vLocal_128, 1f, 2) };
							SET_ENTITY_HEADING(uLocal_62, vVar1.z);
							if (iLocal_90 == 4)
							{
								if (func_94(vVar1.z, 0f, 90f))
								{
									OPEN_SEQUENCE_TASK(&uLocal_121);
									TASK_FOLLOW_NAV_MESH_TO_COORD(0, 38.2412f, -992.2134f, 28.4317f, 1f, 20000, 1048576000, 0, 1193033728);
									TASK_WANDER_STANDARD(0, GET_ENTITY_HEADING(uLocal_62), 1);
									CLOSE_SEQUENCE_TASK(uLocal_121);
									TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
									CLEAR_SEQUENCE_TASK(&uLocal_121);
								}
								...
								{
									OPEN_SEQUENCE_TASK(&uLocal_121);
									TASK_FOLLOW_NAV_MESH_TO_COORD(0, 58.803f, -1067.711f, 28.4411f, 1f, 20000, 1048576000, 0, 1193033728);
									TASK_WANDER_STANDARD(0, GET_ENTITY_HEADING(uLocal_62), 1);
									CLOSE_SEQUENCE_TASK(uLocal_121);
									TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
									CLEAR_SEQUENCE_TASK(&uLocal_121);
							...
							{
								OPEN_SEQUENCE_TASK(&uLocal_121);
								TASK_WANDER_STANDARD(0, vVar1.z, 1);
								CLOSE_SEQUENCE_TASK(uLocal_121);
								TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
								CLEAR_SEQUENCE_TASK(&uLocal_121);
							}
							SET_PED_MOVEMENT_CLIPSET(uLocal_62, cLocal_378, 1048576000);
							FORCE_PED_MOTION_STATE(uLocal_62, -668482597, 1, 0, 0);
							SET_PED_KEEP_TASK(uLocal_62, 1);
						}
						if (!IS_PED_INJURED(PLAYER_PED_ID()))
						{
						...
						{
							SET_PED_MONEY(uLocal_62, (iLocal_192 - (iLocal_192 / 10)));
							SET_PED_CAN_RAGDOLL(uLocal_62, 1);
						}
						iVar19 = (iLocal_192 / 100);
						iVar19 *= 90;
						WAIT(0);
						_RENDER_FIRST_PERSON_CAM(0, 0, 3, 0);
						func_60(func_122(), 1, iVar19);
						func_59(joaat("rc_wallets_returned"), 1);
						func_198(3);
						func_193();
					}
					else if (HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), -3856156))
					{
						if (!IS_PED_INJURED(uLocal_62) && !IS_PED_INJURED(PLAYER_PED_ID()))
						{
							if (IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_64, PLAYER_PED_ID()))
							{
								DETACH_ENTITY(uLocal_64, 0, 1);
								if (IS_PED_MALE(uLocal_62))
								{
									ATTACH_ENTITY_TO_ENTITY(uLocal_64, uLocal_62, GET_PED_BONE_INDEX(uLocal_62, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
								}
								else
								{
									ATTACH_ENTITY_TO_ENTITY(uLocal_64, uLocal_62, GET_PED_BONE_INDEX(uLocal_62, 60309), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
								}
								if (!iLocal_61)
								{
...
void func_64(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_66() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_66() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_65(iParam0));
...
int func_72(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_66() /*10778*/].f_6165.f_10, iParam0);
}
		...
		switch (iVar13)
		{
			case 0:
				...
				if (DOES_ENTITY_EXIST(uVar0))
				{
					...
					{
						vVar22 = { func_99(vVar1, 0f, vVar10) };
						vVar25 = { func_99(vVar1, 0f, vVar7) };
...
Vector3 func_99(vector3 vParam0, float fParam3, struct<2> Param4, var uParam6)
{
	vector3 vVar0;
	var uVar3;
	float fVar4;
...
void func_100(var uParam0, var uParam1, var uParam2, char[4] cParam3, char* sParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	*uParam1 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 0) };
	uParam2->f_2 = func_102(uParam0, PLAYER_PED_ID(), 1);
	fVar3 = func_102(uParam0, PLAYER_PED_ID(), 1);
	fVar4 = func_102(uParam0, PLAYER_PED_ID(), 1);
	vVar16 = { GET_ENTITY_COORDS(uParam0, 0) - GET_ENTITY_COORDS(PLAYER_PED_ID(), 0) };
	...
	while (iVar0 < 2)
	{
		switch (iVar0)
		{
			case 0:
				if (iVar1 > 20)
				{
					uParam2->f_2 = func_101(GET_ENTITY_COORDS(uParam0, 0), *uParam1, 1);
					*uParam1 = { _GET_OBJECT_OFFSET_FROM_COORDS(GET_ENTITY_COORDS(uParam0, 0), uParam2->f_2, vVar16) };
					iVar0 = 2;
				}
				else
				{
			...
			case 1:
				if (GET_SHAPE_TEST_RESULT(uVar5, &iVar6, &vVar10, &uVar7, &uVar19) == 2)
				{
					...
					else
					{
						if (iVar1 > 0)
						{
							uParam2->f_2 = func_101(vVar13 + Vector(-0.75f, 0f, 0f), *uParam1, 1);
						}
						iVar0++;
					}
				}
...
float func_101(struct<2> Param0, Vector3 vParam2, struct<2> Param3, var uParam5, int iParam6)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
float func_102(var uParam0, var uParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
	...
	vVar0 = { GET_ENTITY_COORDS(uParam0, 0) };
	vVar3 = { GET_ENTITY_COORDS(uParam1, 0) };
	return func_101(vVar0, vVar3, iParam2);
}

void func_103(vector3 vParam0, var uParam3, var uParam4)
{
	bool bVar0;
	vector3 vVar1;
	float fVar4;
	...
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		...
		if (func_104(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), fVar4, 15f))
		{
			bVar0 = true;
		}
...
int func_104(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_107(var uParam0, var uParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_109(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_113(PLAYER_ID())) && !func_111(PLAYER_ID(), 0)) && !func_110()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_113(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
...
int func_115(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_123()
{
	...
	{
		if (func_126(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
			iVar0 = func_125(PLAYER_PED_ID());
...
void func_127()
{
	if (!IS_PED_INJURED(uLocal_62))
	{
		TASK_SMART_FLEE_PED(uLocal_62, PLAYER_PED_ID(), 150f, -1, 0, 0);
		SET_PED_KEEP_TASK(uLocal_62, 1);
		WAIT(0);
	}
}
...
int func_128()
{
	...
	else
	{
		...
		if (IS_BULLET_IN_AREA(GET_PED_BONE_COORDS(uLocal_62, 31086, 0f, 0f, 0f), 5f, 1))
		{
			return 1;
		}
		vVar0 = { vVar0 + GET_PED_BONE_COORDS(uLocal_62, 31086, 0f, 0f, 0f) };
		vVar3 = { vVar3 + GET_PED_BONE_COORDS(uLocal_62, 31086, 0f, 0f, 0f) };
		...
		if (_0x2F09F7976C512404(GET_PED_BONE_COORDS(uLocal_62, 31086, 0f, 0f, 0f), 3f))
		{
			return 1;
		}
	}
...
void func_129()
{
	if (!IS_ENTITY_DEAD(uLocal_62, 0))
	{
		if (VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(uLocal_62, 1)) > (fLocal_165 + 50f))
		{
			func_193();
		}
		else if (func_121(func_122()) < iLocal_192)
		{
			func_193();
		}
	}
...
void func_130()
{
	if (!IS_PED_INJURED(uLocal_62))
	{
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_62, Global_19, 0, 1, 0))
		{
			TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), uLocal_62, 3000, 0, 2);
			TASK_LOOK_AT_ENTITY(uLocal_62, PLAYER_PED_ID(), 3000, 0, 2);
		}
	}
}
...
void func_131()
{
	...
	if (iLocal_90 == 1 || iLocal_90 == 4)
	{
		if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_166, vLocal_169, fVar0, 0, 1, 0))
		{
			if (!iLocal_157)
			{
				if (!IS_PED_INJURED(uLocal_62))
				{
					TASK_TURN_PED_TO_FACE_ENTITY(uLocal_62, PLAYER_PED_ID(), 0);
					iLocal_157 = 1;
					iLocal_158 = 0;
				}
			}
		}
		if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_172, vLocal_175, fVar0, 0, 1, 0))
		{
			if (!iLocal_158)
			{
				if (!IS_PED_INJURED(uLocal_62))
		...
		if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_178, vLocal_181, fVar0, 0, 1, 0))
		{
			if (!iLocal_159)
			{
				if (!IS_PED_INJURED(uLocal_62))
	...
	if (!iLocal_160)
	{
		if (!IS_PED_INJURED(uLocal_62))
		{
			if (IS_ENTITY_AT_ENTITY(uLocal_62, PLAYER_PED_ID(), 25f, 25f, 5f, 0, 1, 0) && HAS_ENTITY_CLEAR_LOS_TO_ENTITY(uLocal_62, PLAYER_PED_ID(), 17))
			{
				if (func_42(&uLocal_194, cLocal_103, sLocal_108, 4, 0, 0, 0) || func_58())
				{
					if (!IS_ENTITY_PLAYING_ANIM(uLocal_62, cLocal_359, "flee_forward_outro_shopkeeper", 3))
					{
						OPEN_SEQUENCE_TASK(&uLocal_121);
						TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), 0);
						if (iLocal_47 == 2)
						{
							TASK_PLAY_ANIM(0, cLocal_377, "RETURNING_FRONT_A", 8f, -4f, -1, 0, 0, 0, 0, 0);
						}
						CLOSE_SEQUENCE_TASK(uLocal_121);
						TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
						CLEAR_SEQUENCE_TASK(&uLocal_121);
	...
	switch (*uParam1)
	{
		case 0:
			if (!IS_PED_INJURED(uParam0))
			{
				...
				TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), 0);
				CLOSE_SEQUENCE_TASK(uLocal_121);
				TASK_PERFORM_SEQUENCE(uParam0, uLocal_121);
				CLEAR_SEQUENCE_TASK(&uLocal_121);
				SETTIMERA(0);
				*uParam1++;
			}
		...
		case 1:
			if (!IS_PED_INJURED(uParam0))
			{
				if (IS_PED_FACING_PED(uParam0, PLAYER_PED_ID(), fVar0))
				{
					*uParam1++;
				}
			}
...
void func_133()
{
	if (HAS_PICKUP_BEEN_COLLECTED(uLocal_191))
	{
		if (!IS_ENTITY_DEAD(uLocal_62, 0))
		{
			fLocal_165 = VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(uLocal_62, 1));
		}
		...
		if (DOES_ENTITY_EXIST(uLocal_62))
		{
			if (!IS_PED_INJURED(uLocal_62))
			{
				SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(uLocal_62, 0);
			}
		}
		func_141(0);
		REMOVE_PICKUP(uLocal_191);
...
void func_136()
{
	...
	if (!DOES_BLIP_EXIST(uLocal_65))
	{
		if (!IS_ENTITY_DEAD(uLocal_62, 0))
		{
			uLocal_65 = func_137(uLocal_62, 0, 0);
		}
	}
}

var func_137(var uParam0, bool bParam1, int iParam2)
{
	iParam2 = iParam2;
	return func_138(uParam0, bParam1, 145);
}

var func_138(var uParam0, bool bParam1, int iParam2)
{
	var uVar0;
	
	uVar0 = func_139(uParam0, !bParam1, 0);
...
int func_139(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (IS_ENTITY_A_VEHICLE(uParam0))
	{
		SET_BLIP_SCALE(uVar0, func_140(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		SET_BLIP_SCALE(uVar0, func_140(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
	else if (IS_ENTITY_AN_OBJECT(uParam0))
	{
...
{
	if (!IS_PED_INJURED(uLocal_62) && iLocal_90 == 4)
	{
		if (IS_ENTITY_PLAYING_ANIM(uLocal_62, cLocal_359, "flee_forward_loop_shopkeeper", 3))
		{
			OPEN_SEQUENCE_TASK(&uLocal_121);
			TASK_PLAY_ANIM(0, cLocal_359, "flee_forward_outro_shopkeeper", 8f, -4f, -1, 8, 0, 0, 0, 0);
			TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), -1, 0, 2);
			if (bParam0)
			{
				...
				TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
				TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
				TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 1, 0, 0, 0, 0);
			}
			CLOSE_SEQUENCE_TASK(uLocal_121);
			CLEAR_PED_TASKS(uLocal_62);
			TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
...
int func_142()
{
	if (DOES_ENTITY_EXIST(uLocal_64))
	{
		if (IS_ENTITY_ATTACHED(uLocal_64))
		{
			if (!IS_PED_INJURED(uLocal_62))
			{
				if (IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_64, uLocal_62))
				{
					if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_62, 18f, 18f, 18f, 0, 1, 0))
					{
...
void func_143(var uParam0, var uParam1)
{
	if (DOES_BLIP_EXIST(uParam0))
	{
		...
		if (!IS_HELP_MESSAGE_BEING_DISPLAYED() && func_144(0))
		{
			func_134(1);
		}
	}
...
void func_145()
{
	if (!IS_PED_INJURED(uLocal_62))
	{
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_62, 8f, 8f, 18f, 0, 1, 0) || IS_ENTITY_ON_SCREEN(uLocal_62))
		{
			CLEAR_PRINTS();
		}
	}
...
void func_146()
{
	...
	if (!IS_PED_INJURED(uLocal_63))
	{
		if (func_42(&uLocal_194, cLocal_103, sLocal_107, 4, 0, 0, 0) || func_58())
		{
			if (iLocal_47 == 2)
			{
				SET_PED_FLEE_ATTRIBUTES(uLocal_63, 128, 1);
				SET_PED_FLEE_ATTRIBUTES(uLocal_63, 2, 1);
				SET_PED_FLEE_ATTRIBUTES(uLocal_63, 1, 0);
				TASK_SMART_FLEE_PED(uLocal_63, PLAYER_PED_ID(), 250f, -1, 0, 0);
			}
			SET_PED_KEEP_TASK(uLocal_63, 1);
		}
...
int func_147()
{
	if (!IS_ENTITY_DEAD(uLocal_63, 0))
	{
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_63, PLAYER_PED_ID(), 1))
		{
			if (bLocal_149)
			{
				return 1;
...
void func_148()
{
	...
	if (!IS_PED_INJURED(uLocal_63))
	{
		...
		CLOSE_SEQUENCE_TASK(uLocal_121);
		TASK_PERFORM_SEQUENCE(uLocal_63, uLocal_121);
		CLEAR_SEQUENCE_TASK(&uLocal_121);
		SET_PED_KEEP_TASK(uLocal_63, 1);
		WAIT(0);
		SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_63, 0, 1);
		...
		if (DOES_PICKUP_OBJECT_EXIST(uLocal_191))
		{
			if (DOES_ENTITY_EXIST(uLocal_63))
			{
				if (!IS_ENTITY_DEAD(uLocal_63, 0))
				{
					if (IS_PED_SHOOTING(PLAYER_PED_ID()))
					{
						if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_63, 18f, 18f, 18f, 0, 1, 0) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_63, PLAYER_PED_ID(), 1))
						{
							SETTIMERB(0);
							iLocal_143 = 1;
							return 1;
				...
				else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_63, PLAYER_PED_ID(), 1))
				{
					SETTIMERB(0);
					iLocal_143 = 2;
					if (DOES_ENTITY_EXIST(uLocal_62))
			...
			if (DOES_ENTITY_EXIST(uLocal_62))
			{
				if (!IS_ENTITY_DEAD(uLocal_62, 0))
				{
					if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_62, 5.3f, 5.3f, 6f, 0, 1, 0))
					{
						if (IS_PED_ARMED(PLAYER_PED_ID(), 6))
						{
							if (IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uLocal_62) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uLocal_62))
							{
								SETTIMERB(0);
								iLocal_143 = 3;
								return 1;
...
int func_153()
{
	if (!IS_PED_INJURED(uLocal_63))
	{
		if (_CAN_PED_SEE_PED(uLocal_63, PLAYER_PED_ID()) && IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_63, 20f, 20f, 20f, 0, 1, 0))
		{
			if (IS_PED_ARMED(PLAYER_PED_ID(), 6))
			{
				if (IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uLocal_63) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uLocal_63))
				{
					return 1;
				}
			}
...
int func_155()
{
	...
	if (!IS_PED_INJURED(uLocal_62))
	{
		...
		{
			if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_62, 20f, 20f, 20f, 0, 1, 0))
			{
				if (IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uLocal_62) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uLocal_62))
				{
					return 1;
		...
		if (GET_CURRENT_PED_WEAPON(PLAYER_PED_ID(), &iVar0, 1))
		{
			...
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(uLocal_62, joaat("weapon_stungun"), 0))
				{
					return 1;
				}
			}
	...
	if (IS_BULLET_IN_AREA(GET_PED_BONE_COORDS(uLocal_62, 31086, 0f, 0f, 0f), 3f, 1))
	{
		return 1;
	}
	return 0;
...
void func_156()
{
	...
	if (!func_161())
	{
		if (TIMERA() > 10000)
		{
			if (!IS_PED_INJURED(uLocal_62))
			{
				if (!IS_ANY_SPEECH_PLAYING(uLocal_62))
				{
					func_157(uLocal_62, "GENERIC_CURSE_MED", 24);
					SETTIMERA(0);
				}
			}
		}
	...
	if (!bLocal_60)
	{
		if (func_38(PLAYER_PED_ID(), uLocal_63, 1) > 200f)
		{
			if (!IS_ENTITY_ON_SCREEN(uLocal_63) || IS_ENTITY_OCCLUDED(uLocal_63))
			{
				iLocal_48 = 8;
			}
		}
...
{
	_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_158(iParam2), 1);
}
...
void func_159()
{
	if (!IS_PED_INJURED(uLocal_62))
	{
		...
		if (bLocal_53)
		{
			if (!iLocal_136)
			{
				if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_62, 7f, 7f, 7f, 0, 1, 0))
				{
					if (GET_SCRIPT_TASK_STATUS(uLocal_62, 242628503) == 1)
					{
						if (GET_SEQUENCE_PROGRESS(uLocal_62) == iLocal_164)
						{
							TASK_LOOK_AT_ENTITY(uLocal_62, PLAYER_PED_ID(), 9000, 0, 2);
...
int func_160()
{
	if (!IS_PED_INJURED(uLocal_62))
	{
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_62, 12f, 12f, 5f, 0, 1, 0))
		{
			return 1;
		}
	}
...
void func_163()
{
	...
	if (!bLocal_55)
	{
		...
		if (iLocal_90 != 2)
		{
			if (!IS_PED_INJURED(uLocal_62) && !IS_PED_INJURED(uLocal_63))
			{
				if (!func_190())
				{
					if (func_177())
				...
				if (func_176())
				{
					if (!DOES_BLIP_EXIST(uLocal_68))
					{
						if (!IS_ENTITY_DEAD(uLocal_63, 0))
						{
							uLocal_68 = func_137(uLocal_63, 1, 0);
						}
						func_168(1);
					}
				}
				if (func_167())
				{
					...
					if (iLocal_90 == 3)
					{
						...
						{
							OPEN_SEQUENCE_TASK(&uLocal_121);
							TASK_LOOK_AT_ENTITY(0, uLocal_63, 16000, 0, 2);
							TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_87, 1f, 20000, fVar0, 4, 1193033728);
							CLOSE_SEQUENCE_TASK(uLocal_121);
							TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
							CLEAR_SEQUENCE_TASK(&uLocal_121);
							iLocal_57 = 1;
						...
						OPEN_SEQUENCE_TASK(&uLocal_121);
						TASK_LOOK_AT_ENTITY(0, uLocal_62, -1, 0, 2);
						TASK_PLAY_ANIM(0, "AMB@PROP_HUMAN_SEAT_CHAIR@MALE@GENERIC@EXIT", "exit_forward", 1000f, -1000f, -1, 512, 0, 0, 0, 0);
						TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_87, uLocal_62, 1f, 0, 1.5f, 1082130432, 1, 0, 0, -957453492, 20000);
						TASK_AIM_GUN_AT_ENTITY(0, uLocal_62, -1, 1);
						CLOSE_SEQUENCE_TASK(uLocal_121);
						TASK_PERFORM_SEQUENCE(uLocal_63, uLocal_121);
						CLEAR_SEQUENCE_TASK(&uLocal_121);
						SETTIMERA(0);
	...
	if (bLocal_55)
	{
		if (!iLocal_135)
		{
			if (TIMERA() > 1000)
			{
				if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_63, 60f, 60f, 50f, 0, 1, 0))
				{
					if (!IS_ENTITY_DEAD(uLocal_62, 0))
					{
						TASK_TURN_PED_TO_FACE_ENTITY(uLocal_62, uLocal_63, 0);
					}
					iLocal_135 = 1;
				}
				else
		...
		if (iLocal_135 && !bLocal_133)
		{
			if (!IS_PED_INJURED(uLocal_62) && !IS_PED_INJURED(uLocal_63))
			{
				if (func_42(&uLocal_194, cLocal_103, sLocal_104, 4, 0, 0, 0) || func_58())
				{
					CLEAR_PED_TASKS(uLocal_62);
					OPEN_SEQUENCE_TASK(&uLocal_121);
					TASK_PLAY_ANIM(0, cLocal_359, "handsup_standing_enter", 8f, -4f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, cLocal_359, "handsup_standing_base", 8f, -4f, 7000, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, cLocal_359, "handsup_standing_exit", 8f, -4f, -1, 0, 0, 0, 0, 0);
					CLOSE_SEQUENCE_TASK(uLocal_121);
					TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
					CLEAR_SEQUENCE_TASK(&uLocal_121);
					func_166();
					uLocal_191 = CREATE_PICKUP(joaat("pickup_money_purse"), GET_SAFE_PICKUP_COORDS(GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_62, 0f, 2.5f, 0f), 1067030938, 1069547520), uLocal_144, iLocal_192, 1, iLocal_85);
					bLocal_133 = true;
				}
			}
		}
		if (bLocal_133)
		{
			...
			else
			{
				...
				{
					case 0:
						vLocal_670 = { GET_PICKUP_COORDS(uLocal_191) - Vector(0f, 0f, 0.75f) };
						if (DOES_PICKUP_OBJECT_EXIST(uLocal_191))
						{
							CLEAR_PED_TASKS(uLocal_63);
							OPEN_SEQUENCE_TASK(&uLocal_121);
							TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_670, uLocal_62, 2f, 0, 0.1f, 1082130432, 1, 0, 0, -957453492, 20000);
							CLOSE_SEQUENCE_TASK(uLocal_121);
							TASK_PERFORM_SEQUENCE(uLocal_63, uLocal_121);
							CLEAR_SEQUENCE_TASK(&uLocal_121);
					...
					case 1:
						if (GET_SCRIPT_TASK_STATUS(uLocal_63, 242628503) == 7)
						{
							vLocal_670 = { GET_PICKUP_COORDS(uLocal_191) - Vector(0f, 0f, 0.75f) };
							if (DOES_PICKUP_OBJECT_EXIST(uLocal_191))
							{
								if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(uLocal_63, 1), vLocal_670, 1) > 1f)
								{
									iLocal_669 = 1;
									iLocal_667 = 4;
								}
								else
								{
									CLEAR_PED_TASKS(uLocal_63);
									OPEN_SEQUENCE_TASK(&uLocal_121);
									TASK_PLAY_ANIM(0, cLocal_360, "pickup_low", 8f, -4f, -1, 8224, 0, 0, 0, 0);
									CLOSE_SEQUENCE_TASK(uLocal_121);
									TASK_PERFORM_SEQUENCE(uLocal_63, uLocal_121);
									CLEAR_SEQUENCE_TASK(&uLocal_121);
									iLocal_667 = 2;
						...
						if ((GET_GAME_TIMER() - iLocal_668) > 15000)
						{
							iLocal_669 = 1;
							iLocal_667 = 4;
						}
					...
					case 2:
						if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_63, cLocal_360, "pickup_low") > 0.5f)
						{
							if (DOES_PICKUP_OBJECT_EXIST(uLocal_191))
							{
								REMOVE_PICKUP(uLocal_191);
					...
					case 3:
						if ((IS_ENTITY_PLAYING_ANIM(uLocal_63, cLocal_360, "pickup_low", 3) && GET_ENTITY_ANIM_CURRENT_TIME(uLocal_63, cLocal_360, "pickup_low") > 0.58f) || !IS_ENTITY_PLAYING_ANIM(uLocal_63, cLocal_360, "pickup_low", 3))
						{
							iLocal_667 = 4;
						}
						break;
					...
					case 4:
						SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_63, 1, 1);
						TASK_SMART_FLEE_PED(uLocal_63, PLAYER_PED_ID(), 50f, -1, 0, 0);
						_0x2208438012482A1A(uLocal_63, 0, 0);
						bLocal_149 = true;
						break;
					}
				}
...
void func_165()
{
	...
	if (IS_PED_FACING_PED(uLocal_63, PLAYER_PED_ID(), 90f))
	{
		TASK_PLAY_ANIM(uLocal_63, cLocal_359, sLocal_367, 1000f, -1000f, -1, 8, 0, 0, 0, 0);
		if (iLocal_47 == 2)
		{
			OPEN_SEQUENCE_TASK(&uLocal_121);
			TASK_PLAY_ANIM(0, cLocal_359, sLocal_368, 8f, -8f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_A", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_B", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_C", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_A", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_B", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_C", 8f, -4f, -1, 1, 0, 0, 0, 0);
			CLOSE_SEQUENCE_TASK(uLocal_121);
			TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
			CLEAR_SEQUENCE_TASK(&uLocal_121);
		}
		else if (iLocal_90 == 4)
		{
			...
			OPEN_SEQUENCE_TASK(&uLocal_121);
			TASK_PLAY_ANIM(0, cLocal_359, "flee_backward_intro_shopkeeper", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, cLocal_359, "flee_backward_loop_shopkeeper", 8f, -4f, -1, 9, 0, 0, 0, 0);
			CLOSE_SEQUENCE_TASK(uLocal_121);
			TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
			CLEAR_SEQUENCE_TASK(&uLocal_121);
		}
		...
		{
			OPEN_SEQUENCE_TASK(&uLocal_121);
			TASK_PLAY_ANIM(0, cLocal_359, sLocal_368, 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 1, 0, 0, 0, 0);
	...
	{
		TASK_PLAY_ANIM(uLocal_63, cLocal_359, sLocal_369, 1000f, -1000f, -1, 8, 0, 0, 0, 0);
		if (iLocal_47 == 2)
		{
			OPEN_SEQUENCE_TASK(&uLocal_121);
			TASK_PLAY_ANIM(0, cLocal_359, sLocal_370, 8f, -8f, -1, 8, 0.1f, 0, 0, 0);
			...
			TASK_PLAY_ANIM(0, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_B", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_C", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, "RANDOM@BICYCLE_THIEF@IDLE_A", "IDLE_A", 8f, -4f, -1, 1, 0, 0, 0, 0);
			CLOSE_SEQUENCE_TASK(uLocal_121);
			TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
			CLEAR_SEQUENCE_TASK(&uLocal_121);
		}
		...
		{
			OPEN_SEQUENCE_TASK(&uLocal_121);
			TASK_PLAY_ANIM(0, cLocal_359, "flee_forward_intro_shopkeeper", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, cLocal_359, "flee_forward_loop_shopkeeper", 8f, -4f, -1, 9, 0, 0, 0, 0);
			CLOSE_SEQUENCE_TASK(uLocal_121);
			TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
			CLEAR_SEQUENCE_TASK(&uLocal_121);
		}
		...
		{
			OPEN_SEQUENCE_TASK(&uLocal_121);
			TASK_PLAY_ANIM(0, cLocal_359, sLocal_370, 8f, -4f, -1, 8, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
			TASK_PLAY_ANIM(0, cLocal_359, "agitated_loop_c", 8f, -4f, -1, 1, 0, 0, 0, 0);
...
void func_166()
{
	if (DOES_BLIP_EXIST(uLocal_68))
	{
		REMOVE_BLIP(&uLocal_68);
	}
	if (!DOES_BLIP_EXIST(uLocal_66))
	{
		if (!IS_ENTITY_DEAD(uLocal_63, 0))
		{
			uLocal_66 = func_137(uLocal_63, 1, 0);
		}
	}
}
...
int func_167()
{
	...
	if (iLocal_90 == 1)
	{
		if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -170.3051f, -1670.362f, 53.73083f, -91.94043f, -1578.828f, 24.96221f, 18f, 0, 0, 0))
		{
			iVar0 = 1;
		}
	}
	...
	{
		if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(uLocal_63, 1), 1) < 30f)
		{
			iVar0 = 1;
		}
	}
	...
	{
		if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -41.32678f, -959.6443f, 38.4444f, 119.9208f, -1021.231f, 21.85738f, 123.75f, 0, 1, 0))
		{
			iVar0 = 1;
		}
	}
	else if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), -325.7037f, -829.31f, 30.5812f, 1) < 95f)
	{
		iVar0 = 1;
	}
	return iVar0;
...
int func_170()
{
	switch (func_171(&Global_25824, 0, 5, 0, GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_176()
{
	...
	if (iLocal_90 == 1)
	{
		if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -179.103f, -1682.421f, 53.693f, -83.53208f, -1567.584f, 25.18745f, 40.75f, 0, 0, 0))
		{
			iVar0 = 1;
		}
	}
	...
	{
		if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 353.1506f, -296.1962f, 62.76571f, 210.4646f, -243.5106f, 46.13731f, 123.75f, 0, 1, 0))
		{
			iVar0 = 1;
		}
	}
	...
	{
		if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), -325.7037f, -829.31f, 30.5812f, 1) < 105f)
		{
			iVar0 = 1;
		}
	}
...
int func_177()
{
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (VMAG2(GET_ENTITY_VELOCITY(PLAYER_PED_ID())) > 1369f && !func_185())
		{
			return 0;
		}
	}
...
int func_190()
{
	if ((Global_106554 == func_191() && GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
void func_199()
{
	switch (iLocal_140)
	{
		case 0:
			if (!IS_PED_INJURED(uLocal_63))
			{
				TASK_PLAY_ANIM(uLocal_63, cLocal_359, "IG_1_guy_stickup_loop", 8f, -4f, -1, 1, 0, 0, 0, 0);
			}
			if (!IS_PED_INJURED(uLocal_62))
			{
				TASK_PLAY_ANIM(uLocal_62, cLocal_361, "ortega_stand_loop_ort", 8f, -4f, -1, 1, 0, 0, 0, 0);
			}
			iLocal_140++;
			break;
			...
			if (DOES_ENTITY_EXIST(uLocal_63))
			{
				if (!IS_PED_INJURED(uLocal_63))
				{
					...
					if (func_167())
					{
						...
						func_166();
						iLocal_187 = GET_GAME_TIMER();
						SET_WANTED_LEVEL_MULTIPLIER(0f);
						iLocal_190 = 1;
						iLocal_140++;
					}
				}
				else if (!IS_PED_INJURED(uLocal_62))
				{
					TASK_SMART_FLEE_COORD(uLocal_62, vLocal_145, 250f, -1, 0, 0);
					SET_PED_KEEP_TASK(uLocal_62, 1);
					WAIT(0);
					func_205();
				}
		...
		case 2:
			if (DOES_ENTITY_EXIST(uLocal_63))
			{
				if (!IS_PED_INJURED(uLocal_63))
				{
					if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_63, 6f, 6f, 15f, 0, 1, 0))
					{
						if (_CAN_PED_SEE_PED(uLocal_63, PLAYER_PED_ID()) || IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_63, 3f, 3f, 15f, 0, 1, 0))
						{
							if (IS_PED_FACING_PED(PLAYER_PED_ID(), uLocal_63, 65f))
							{
								iLocal_189 = GET_GAME_TIMER();
								TASK_LOOK_AT_ENTITY(uLocal_63, PLAYER_PED_ID(), 7000, 0, 2);
								func_42(&uLocal_194, cLocal_103, sLocal_112, 4, 0, 0, 0);
								SETTIMERB(0);
								iLocal_140++;
							}
		...
		case 10:
			if (DOES_ENTITY_EXIST(uLocal_63))
			{
				if (IS_PED_INJURED(uLocal_63) || func_38(PLAYER_PED_ID(), uLocal_63, 1) > 100f)
				{
					func_200();
					func_205();
				}
			...
			if (DOES_ENTITY_EXIST(uLocal_62))
			{
				if (!IS_PED_INJURED(uLocal_62))
				{
					if (!HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_62, PLAYER_PED_ID(), 1))
					{
						...
						{
							OPEN_SEQUENCE_TASK(&uLocal_121);
							TASK_SMART_FLEE_COORD(0, GET_ENTITY_COORDS(uLocal_63, 0), 150f, -1, 0, 0);
							CLOSE_SEQUENCE_TASK(uLocal_121);
							TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
							CLEAR_SEQUENCE_TASK(&uLocal_121);
							SET_PED_KEEP_TASK(uLocal_62, 1);
		...
		case 5:
			if (TIMERB() > 250)
			{
				if (DOES_ENTITY_EXIST(uLocal_63))
				{
					if (!IS_PED_INJURED(uLocal_63))
					{
						SET_PED_COMBAT_ATTRIBUTES(uLocal_63, 17, 1);
						SET_PED_RESET_FLAG(uLocal_63, 156, 1);
						OPEN_SEQUENCE_TASK(&uLocal_121);
						TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 250f, -1, 0, 0);
						CLOSE_SEQUENCE_TASK(uLocal_121);
						TASK_PERFORM_SEQUENCE(uLocal_63, uLocal_121);
		...
		case 9:
			if (DOES_ENTITY_EXIST(uLocal_63))
			{
				...
				{
					SET_PED_RESET_FLAG(uLocal_63, 156, 1);
					TASK_COMBAT_HATED_TARGETS_AROUND_PED(uLocal_63, 50f, 0);
					if (IS_SCRIPTED_CONVERSATION_ONGOING())
					{
						func_105();
					}
	...
	iLocal_188 = GET_GAME_TIMER();
	if (iLocal_190 && !bLocal_137)
	{
		if (DOES_ENTITY_EXIST(uLocal_63) && DOES_ENTITY_EXIST(uLocal_63))
		{
			if (!IS_PED_INJURED(uLocal_62) && !IS_PED_INJURED(uLocal_63))
			{
				if ((((iLocal_188 - iLocal_187) > 12000 && !IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_63, 3f, 3f, 35f, 0, 1, 0)) && IS_ENTITY_ON_SCREEN(uLocal_63)) && !func_161())
				{
					if ((func_42(&uLocal_194, cLocal_103, "REMG2_FKIT", 4, 0, 0, 0) || func_58()) || func_58())
					{
						SET_PED_RESET_FLAG(uLocal_63, 156, 1);
						SET_PED_SHOOTS_AT_COORD(uLocal_63, GET_PED_BONE_COORDS(uLocal_62, 31086, 0f, 0f, 0f), 0);
						CLEAR_PED_TASKS(uLocal_62);
						SET_ENTITY_HEALTH(uLocal_62, 99, 0);
						TASK_SMART_FLEE_COORD(uLocal_63, vLocal_145, 250f, -1, 0, 0);
						SET_PED_KEEP_TASK(uLocal_63, 1);
						func_274();
					}
				}
...
int func_201()
{
	if (!IS_PED_INJURED(uLocal_62) && !IS_PED_INJURED(uLocal_63))
	{
		if (IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), uLocal_63) || IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), uLocal_62))
		{
			return 1;
		}
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_63, 2f, 2f, 2f, 0, 1, 0))
		{
		}
	}
	return 0;
...
int func_203()
{
	if (!IS_PED_INJURED(uLocal_62))
	{
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_62, 5.3f, 5.3f, 6f, 0, 1, 0))
		{
			if (HAS_ENTITY_CLEAR_LOS_TO_ENTITY(uLocal_62, PLAYER_PED_ID(), 17))
			{
				if (IS_PED_ARMED(PLAYER_PED_ID(), 6) && !IS_PED_SHOOTING(PLAYER_PED_ID()))
				{
					if (!IS_PED_INJURED(uLocal_63))
					{
						if (!IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uLocal_63))
						{
							if (IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uLocal_62) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uLocal_62))
							{
								SETTIMERB(0);
					...
					else if (IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uLocal_62) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uLocal_62))
					{
						SETTIMERB(0);
						return 1;
					}
...
void func_205()
{
	if (!IS_PED_INJURED(uLocal_62))
	{
		if (!IS_PED_RAGDOLL(uLocal_62))
		{
			if (func_190())
			{
				if (GET_SCRIPT_TASK_STATUS(uLocal_62, 242628503) == 7 || GET_SCRIPT_TASK_STATUS(uLocal_62, 474215631) == 7)
				{
					if (IS_SCRIPTED_CONVERSATION_ONGOING())
					{
						func_105();
					...
					if (!IS_PED_INJURED(uLocal_63))
					{
						if (!IS_PED_FLEEING(uLocal_62))
						{
							TASK_SMART_FLEE_PED(uLocal_62, uLocal_63, 150f, -1, 0, 0);
						}
					}
					else if (iLocal_47 == 3)
					{
						if (!IS_PED_FLEEING(uLocal_62))
						{
							TASK_SMART_FLEE_COORD(uLocal_62, vLocal_122, 150f, -1, 0, 0);
						}
					}
					SET_PED_KEEP_TASK(uLocal_62, 1);
					WAIT(0);
					...
					if (iLocal_192 > 0)
					{
						SET_PED_MONEY(PLAYER_PED_ID(), (iLocal_192 / 100) * 90);
						func_60(func_122(), 1, iLocal_192);
						WAIT(0);
						func_206(func_122(), 1, (iLocal_192 / 10), 0, 1);
					}
					func_198(3);
					func_193();
				}
...
{
	func_219();
	func_218(&uLocal_393, "AMB@PROP_HUMAN_SEAT_CHAIR@MALE@GENERIC@BASE");
	func_218(&uLocal_393, "AMB@PROP_HUMAN_SEAT_CHAIR@MALE@GENERIC@EXIT");
	func_218(&uLocal_393, cLocal_377);
	func_218(&uLocal_393, cLocal_361);
	func_216(&uLocal_393, iLocal_83);
	func_216(&uLocal_393, iLocal_84);
	func_216(&uLocal_393, iLocal_85);
	func_218(&uLocal_393, cLocal_360);
	func_218(&uLocal_393, cLocal_359);
	func_218(&uLocal_393, cLocal_378);
	func_218(&uLocal_393, "RANDOM@BICYCLE_THIEF@IDLE_A");
	if (func_212(&uLocal_393))
	{
		func_209();
		return 1;
	}
...
void func_209()
{
	uLocal_62 = CREATE_PED(26, iLocal_83, vLocal_69, fLocal_75, 1, 1);
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_62, 1);
	SET_PED_CAN_BE_TARGETTED(uLocal_62, 0);
	SET_PED_FLEE_ATTRIBUTES(uLocal_62, 8, 1);
	SET_PED_FLEE_ATTRIBUTES(uLocal_62, 128, 1);
	SET_PED_FLEE_ATTRIBUTES(uLocal_62, 512, 1);
	STOP_PED_SPEAKING(uLocal_62, 1);
	_0x570389D1C3DE3C6B(uLocal_62);
	SET_PED_MONEY(uLocal_62, 0);
	SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_62, 1);
	if (iLocal_83 == joaat("a_m_y_genstreet_01"))
	{
		SET_PED_COMPONENT_VARIATION(uLocal_62, 0, 1, 0, 0);
		SET_PED_COMPONENT_VARIATION(uLocal_62, 3, 0, 3, 0);
		SET_PED_COMPONENT_VARIATION(uLocal_62, 4, 0, 2, 0);
	}
	if (iLocal_83 == joaat("a_m_y_business_02"))
	{
		SET_PED_COMPONENT_VARIATION(uLocal_62, 0, 1, 0, 0);
		SET_PED_COMPONENT_VARIATION(uLocal_62, 2, 1, 0, 0);
		SET_PED_COMPONENT_VARIATION(uLocal_62, 3, 1, 0, 0);
		SET_PED_COMPONENT_VARIATION(uLocal_62, 4, 1, 0, 0);
		SET_PED_COMPONENT_VARIATION(uLocal_62, 8, 0, 0, 0);
	}
	ADD_RELATIONSHIP_GROUP("theAssailant", &uLocal_86);
	uLocal_63 = CREATE_PED(26, iLocal_84, vLocal_72, fLocal_78, 1, 1);
	SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_63, 1, 1);
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_63, 1);
	SET_ENTITY_IS_TARGET_PRIORITY(uLocal_63, 1, 0);
	GIVE_WEAPON_TO_PED(uLocal_63, joaat("weapon_pistol"), -1, 1, 1);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_63, 13, 0);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_63, 17, 0);
	SET_PED_DIES_WHEN_INJURED(uLocal_63, 1);
	SET_PED_CONFIG_FLAG(uLocal_63, 42, 1);
	SET_PED_CONFIG_FLAG(uLocal_63, 137, 1);
	SET_PED_FLEE_ATTRIBUTES(uLocal_63, 128, 1);
	SET_PED_FLEE_ATTRIBUTES(uLocal_63, 2, 0);
	SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_63, uLocal_86);
	STOP_PED_SPEAKING(uLocal_63, 1);
	if (!IS_STRING_NULL(sLocal_120))
	{
		SET_AMBIENT_VOICE_NAME(uLocal_62, sLocal_120);
	}
	SET_AMBIENT_VOICE_NAME(uLocal_63, sLocal_119);
	SET_RELATIONSHIP_BETWEEN_GROUPS(2, 45677184, uLocal_86);
	SET_RELATIONSHIP_BETWEEN_GROUPS(2, 1191392768, uLocal_86);
	SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_86, 45677184);
	SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_86, 1191392768);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_86, 1862763509);
	switch (func_122())
	{
		case 0:
			func_211(&uLocal_194, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
			break;
		
		case 1:
			func_211(&uLocal_194, 0, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			break;
		
		case 2:
			func_211(&uLocal_194, 0, PLAYER_PED_ID(), "TREVOR", 0, 1);
			break;
	}
	func_211(&uLocal_194, 1, uLocal_63, sLocal_118, 0, 1);
	func_211(&uLocal_194, 2, uLocal_62, sLocal_117, 0, 1);
	if (iLocal_47 == 2)
	{
		SET_PED_FLEE_ATTRIBUTES(uLocal_63, 1, 0);
	}
	...
	if (iLocal_90 == 3)
	{
		...
		uLocal_131 = CREATE_SYNCHRONIZED_SCENE(vLocal_125, vLocal_128, 2);
		TASK_SYNCHRONIZED_SCENE(uLocal_63, uLocal_131, "AMB@PROP_HUMAN_SEAT_CHAIR@MALE@GENERIC@BASE", "base", 1000f, -1000f, 0, 0, 1148846080, 0);
	}
	if (iLocal_90 == 4)
	{
...
void func_210()
{
	...
	SET_ENTITY_COORDS_NO_OFFSET(uLocal_63, GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_359, sLocal_365, vLocal_371, vLocal_374, 0, 2), 0, 0, 1);
	vVar0 = { GET_ANIM_INITIAL_OFFSET_ROTATION(cLocal_359, sLocal_365, vLocal_371, vLocal_374, 0, 2) };
	if (vVar0.z < 0f)
	{
		vVar0.z = (vVar0.z + 360f);
	}
	SET_ENTITY_HEADING(uLocal_63, vVar0.z);
	SET_ENTITY_COORDS_NO_OFFSET(uLocal_62, GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_359, sLocal_366, vLocal_371, vLocal_374, 0, 2), 0, 0, 1);
	vVar0 = { GET_ANIM_INITIAL_OFFSET_ROTATION(cLocal_359, sLocal_366, vLocal_371, vLocal_374, 0, 2) };
	if (vVar0.z < 0f)
	{
		vVar0.z = (vVar0.z + 360f);
	}
	SET_ENTITY_HEADING(uLocal_62, vVar0.z);
	TASK_PLAY_ANIM(uLocal_63, cLocal_359, sLocal_365, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
	TASK_PLAY_ANIM(uLocal_62, cLocal_359, sLocal_366, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
}

void func_211(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
{
	func_272();
	SET_BIT(&uLocal_144, 3);
	SET_BIT(&uLocal_144, 4);
	SET_BIT(&uLocal_144, 1);
	if (iLocal_90 == 1)
	{
...
{
	func_225(uParam0, &(uParam0->f_2), uParam0->f_1);
}
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_262()) || Global_105612) || Global_25767) || func_261()) || func_51(8, -1)) || func_260()) || func_259()) || func_258()) || func_257()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_262()) || Global_25767) || func_261()) || func_51(8, -1)) || func_258()) || func_260()) || func_259()) || func_257()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_262()) || Global_105612) || Global_25767) || func_261()) || func_51(8, -1)) || func_258()) || func_260()) || func_259()) || func_257()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_262()) || Global_105612) || Global_25767) || func_261()) || func_51(8, -1)) || func_260()) || func_259()) || func_257()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_262() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_51(8, -1)) || func_257()) || func_256()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_262()) || Global_25767) || func_261()) || func_51(8, -1)) || func_259()) || func_258()) || func_257()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_262()) || func_259()) || Global_105612) || Global_25767) || func_261()) || Global_37584) || func_51(8, -1)) || func_258()) || func_256()) || func_257()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_262()) || Global_105612) || Global_25767) || func_261()) || func_51(8, -1)) || func_258()) || func_256()) || func_260()) || func_259()) || func_257())
						{
							return 0;
						}
						break;
...
int func_271(int iParam0)
{
	...
	return IS_BIT_SET(Global_106565.f_18568[iParam0 /*6*/], 0);
}
...
void func_274()
{
	if (iLocal_156)
	{
		...
		if (!IS_PED_INJURED(uLocal_63))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				TASK_SMART_FLEE_PED(uLocal_63, PLAYER_PED_ID(), 150f, -1, 0, 0);
			}
			SET_PED_KEEP_TASK(uLocal_63, 1);
			if (!bLocal_60)
			{
				SET_PED_MONEY(uLocal_63, iLocal_192);
			}
		}
		if (DOES_ENTITY_EXIST(uLocal_62))
		{
			if (!IS_PED_INJURED(uLocal_62))
			{
				SET_PED_CAN_BE_TARGETTED(uLocal_62, 1);
				if (GET_SCRIPT_TASK_STATUS(uLocal_62, -1146898486) == 7 && GET_SCRIPT_TASK_STATUS(uLocal_62, 242628503) == 7)
				{
					OPEN_SEQUENCE_TASK(&uLocal_121);
					if (IS_PED_DUCKING(uLocal_62))
					{
						TASK_TOGGLE_DUCK(0, 0);
					}
					TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), 9000, 0, 2);
					TASK_SMART_FLEE_COORD(0, vLocal_122, 250f, -1, 0, 0);
					CLOSE_SEQUENCE_TASK(uLocal_121);
					TASK_PERFORM_SEQUENCE(uLocal_62, uLocal_121);
					CLEAR_SEQUENCE_TASK(&uLocal_121);
					SET_PED_KEEP_TASK(uLocal_62, 1);
		...
		if (DOES_ENTITY_EXIST(uLocal_64))
		{
			SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_64);
		}
		if (DOES_BLIP_EXIST(iLocal_67))
		{
...
void func_294()
{
	...
	{
		func_91(13, FLOOR(Global_106565.f_10188.f_3853));
	}
	if (!DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_71590)
		{
			if (func_295() == 2 == 0 && !NETWORK_IS_GAME_IN_PROGRESS())
			{
