...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		switch (iVar422)
		{
			...
			case 3:
				if ((HAS_ANIM_DICT_LOADED(func_307()) && func_302(&uVar423)) && HAS_ANIM_SET_LOADED("move_m@golfer@"))
				{
					func_299(&uVar397);
					iVar422 = 4;
				}
			...
			case 4:
				if (func_298(GET_CLOCK_HOURS()))
				{
					if (!IS_SPHERE_VISIBLE(func_296(&Var341, func_297(&(Var0[iVar436 /*170*/]))), 10f) || func_295(4))
					{
						func_299(&uVar397);
						iVar422 = 5;
						iVar436 = 0;
						while (iVar436 < Var0)
						{
							func_282(&Var341, &(Var0[iVar436 /*170*/]), 1, iVar436 * 4, 0);
							iVar435 = 0;
							while (iVar435 < func_281(&(Var0[iVar436 /*170*/])))
							{
								func_280(&(Var0[iVar436 /*170*/]), iVar435, 4194304);
								func_277(&(Var0[iVar436 /*170*/]), func_279(&uVar397, 19));
								iVar435++;
							}
							iVar436++;
						}
...
void func_1(var uParam0, var uParam1, var uParam2)
{
	...
	if (((IS_ENTITY_DEAD(func_275(uParam2), 0) || IS_PED_INJURED(func_275(uParam2))) || !DOES_ENTITY_EXIST(func_275(uParam2))) || IS_PED_FLEEING(func_275(uParam2)))
	{
		if (DOES_ENTITY_EXIST(func_273(uParam2)))
		{
			func_271(uParam2);
		}
		return;
	...
	else
	{
		...
		Var0.f_5 = 1103626240;
		Var0.f_6 = 5;
		if ((func_261(func_275(uParam2), 0, &Var0, &uVar7, 0, 1, 0, 1, 1) || IS_PED_IN_MELEE_COMBAT(func_275(uParam2))) || IS_PED_RESPONDING_TO_EVENT(func_275(uParam2), 60))
		{
			CLEAR_PED_TASKS(func_275(uParam2));
			TASK_SMART_FLEE_PED(func_275(uParam2), PLAYER_PED_ID(), 150f, -1, 0, 0);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(func_275(uParam2), 1);
			func_260(uParam2, 4);
			return;
		}
	}
	func_258(&(uParam2->f_15[func_259(uParam2) /*34*/]), PLAYER_PED_ID(), uParam2, func_259(uParam2), uParam1);
	switch (func_257(uParam2))
	{
		...
		case 2:
			...
			SET_PED_RESET_FLAG(func_275(uParam2), 129, 1);
			...
			if (func_26(uParam2, -1, 0))
			{
				...
				if (DOES_ENTITY_EXIST(func_273(uParam2)))
				{
					func_5(uParam2, GET_ENTITY_COORDS(func_273(uParam2), 1));
				}
			}
...
int func_16(vector3 vParam0)
{
	...
	while (iVar0 < 9)
	{
		if (VDIST2(func_18(iVar0), vParam0) < (func_17(iVar0) * func_17(iVar0)))
		{
			return 1;
		}
		iVar0++;
...
void func_30(var uParam0, var uParam1, var uParam2)
{
	...
	if (IS_ENTITY_DEAD(func_275(uParam2), 0))
	{
		return;
	}
	switch (func_29(uParam2))
	{
		case 0:
			...
			{
				SET_ENTITY_COORDS(func_273(uParam2), vVar0, 1, 0, 0, 1);
			}
			func_5(uParam2, GET_ENTITY_COORDS(func_273(uParam2), 1));
			...
			SET_ENTITY_RECORDS_COLLISIONS(func_273(uParam2), 0);
		...
		case 3:
			if (func_185(uParam2) || func_3(&(uParam2->f_15[func_259(uParam2) /*34*/]), 1048576))
			{
				...
				if (DOES_ENTITY_EXIST(func_275(uParam2)) && !IS_ENTITY_DEAD(func_275(uParam2), 0))
				{
					if (VDIST2(GET_ENTITY_COORDS(func_275(uParam2), 1), func_243(uParam2)) > 9f)
					{
						CLEAR_PED_TASKS(func_275(uParam2));
						func_24(uParam2, 1);
						return;
			...
			else if (GET_ENTITY_SPEED(func_275(uParam2)) == 0f && func_156(&(uParam2->f_162), 15f))
			{
				func_187(&(uParam2->f_162));
				CLEAR_PED_TASKS(func_275(uParam2));
		...
		case 4:
			if (func_153(PLAYER_PED_ID(), uParam2->f_15[func_259(uParam2) /*34*/].f_2, 0) < 1f)
			{
				if (IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), uParam2->f_15[func_259(uParam2) /*34*/].f_2))
				{
					CLEAR_PED_TASKS_IMMEDIATELY(uParam2->f_15[func_259(uParam2) /*34*/].f_2);
					func_197(uParam1, uParam2, uParam0, 0, 0, 0, 1, 0);
					func_260(uParam2, 0);
					func_24(uParam2, 1);
			...
			{
				if (((uParam2->f_1 == 4 || uParam2->f_1 == 6) || func_139(uParam2, 1048576)) && DOES_ENTITY_EXIST(func_273(uParam2)))
				{
					if (((func_137(func_275(uParam2)) || func_156(&(uParam2->f_162), 2.5f)) || func_139(uParam2, 1048576)) && DOES_ENTITY_HAVE_PHYSICS(func_273(uParam2)))
					{
						if (func_139(uParam2, 1048576))
						{
							if (bLocal_0)
				...
				else if (!DOES_ENTITY_EXIST(func_273(uParam2)))
				{
					uParam2->f_1 = 0;
					func_24(uParam2, 0);
				}
		...
		case 6:
			func_100(uParam0, uParam2, 1);
			if ((func_66(uParam2) || func_65(uParam2)) || func_62(GET_ENTITY_COORDS(func_273(uParam2), 1)))
			{
				func_61(uParam2);
			}
			else
		...
		case 8:
			...
			{
				CLEAR_PED_TASKS(func_275(uParam2));
				OPEN_SEQUENCE_TASK(&(uParam2->f_15[func_259(uParam2) /*34*/].f_21));
				TASK_GO_TO_COORD_ANY_MEANS(0, func_44(uParam1, func_297(uParam2), func_259(uParam2)), 1f, 0, 0, 786603, -1082130432);
				TASK_TURN_PED_TO_FACE_COORD(0, func_43(uParam1, func_297(uParam2)), 0);
				CLOSE_SEQUENCE_TASK(uParam2->f_15[func_259(uParam2) /*34*/].f_21);
				TASK_PERFORM_SEQUENCE(func_275(uParam2), uParam2->f_15[func_259(uParam2) /*34*/].f_21);
				CLEAR_SEQUENCE_TASK(&(uParam2->f_15[func_259(uParam2) /*34*/].f_21));
			}
			break;
			...
			if (!func_100(uParam0, uParam2, 0))
			{
				if (func_39(uParam1, uParam2) && !func_154(uParam2, func_259(uParam2)))
				{
					if (!func_139(uParam2, 1048576))
					{
						...
						CLEAR_PED_TASKS(func_275(uParam2));
						OPEN_SEQUENCE_TASK(&(uParam2->f_15[func_259(uParam2) /*34*/].f_21));
						TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_38(uParam1, func_297(uParam2), func_259(uParam2)), 1f, -1, 1048576000, 0, 1193033728);
						TASK_TURN_PED_TO_FACE_COORD(0, func_296(uParam1, func_297(uParam2)), 0);
						CLOSE_SEQUENCE_TASK(uParam2->f_15[func_259(uParam2) /*34*/].f_21);
						TASK_PERFORM_SEQUENCE(func_275(uParam2), uParam2->f_15[func_259(uParam2) /*34*/].f_21);
						CLEAR_SEQUENCE_TASK(&(uParam2->f_15[func_259(uParam2) /*34*/].f_21));
					}
					...
					{
						SET_ENTITY_COORDS(func_275(uParam2), func_38(uParam1, func_297(uParam2), func_259(uParam2)), 1, 0, 0, 1);
					}
				}
				else if (func_186(uParam2) || func_139(uParam2, 67108864))
				{
					if (!func_139(uParam2, 1048576))
					{
						if (!func_26(uParam2, func_259(uParam2), 0))
						{
							...
							CLEAR_PED_TASKS(func_275(uParam2));
							OPEN_SEQUENCE_TASK(&(uParam2->f_15[func_259(uParam2) /*34*/].f_21));
							TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_44(uParam1, func_297(uParam2), func_259(uParam2)), 1f, -1, 1048576000, 0, 1193033728);
							TASK_TURN_PED_TO_FACE_COORD(0, func_43(uParam1, func_297(uParam2)), 0);
							CLOSE_SEQUENCE_TASK(uParam2->f_15[func_259(uParam2) /*34*/].f_21);
							TASK_PERFORM_SEQUENCE(func_275(uParam2), uParam2->f_15[func_259(uParam2) /*34*/].f_21);
							CLEAR_SEQUENCE_TASK(&(uParam2->f_15[func_259(uParam2) /*34*/].f_21));
					...
					{
						SET_ENTITY_COORDS(func_275(uParam2), func_44(uParam1, func_297(uParam2), func_259(uParam2)), 1, 0, 0, 1);
					}
				}
				else if (!func_139(uParam2, 1048576))
				{
					if (!func_26(uParam2, func_259(uParam2), 0) && DOES_ENTITY_EXIST(func_35(uParam2)))
					{
						if (!IS_ENTITY_DEAD(func_35(uParam2), 0))
						{
							CLEAR_PED_TASKS(func_275(uParam2));
							OPEN_SEQUENCE_TASK(&(uParam2->f_15[func_259(uParam2) /*34*/].f_21));
...
void func_52(var uParam0, var uParam1)
{
	if (!bLocal_369)
	{
		...
		func_5(uParam1, GET_ENTITY_COORDS(func_273(uParam1), 1));
		func_59(uParam1, VDIST(func_243(uParam1), func_43(uParam0, func_297(uParam1))));
	}
	else
	{
		SET_ENTITY_COORDS(func_273(uParam1), func_243(uParam1) + Vector(0.05f, 0f, 0f), 1, 0, 0, 1);
		func_57(uParam1);
		func_55(uParam1);
	}
	SET_ENTITY_MAX_SPEED(func_273(uParam1), 150f);
...
{
	func_9(&(uParam0->f_15[uParam0->f_157 /*34*/]), uParam1);
}
...
void func_67(var uParam0, var uParam1, var uParam2)
{
	...
	{
		func_23(uParam2, GET_ENTITY_COORDS(uVar0, 1), func_77(GET_LAST_MATERIAL_HIT_BY_ENTITY(uVar0)));
		func_47(uParam2, 2);
		func_276(uParam0, 268435456);
		if (DOES_ENTITY_EXIST(uVar11))
		{
			if (IS_ENTITY_TOUCHING_ENTITY(uVar0, uVar11) && !func_139(uParam2, 268435456))
			{
				PLAY_SOUND_FROM_ENTITY(-1, "GOLF_BALL_IMPACT_FLAG_MASTER", func_273(uParam2), 0, 0, 0);
	...
	{
		if (!func_138(uParam0, 268435456) && VDIST2(vVar8, vVar5) < (0.3f * 0.3f))
		{
			PLAY_SOUND_FROM_ENTITY(-1, "GOLF_BALL_CUP_MISS_MASTER", func_273(uParam2), 0, 0, 0);
	...
	if (((fVar4 < 0.25f || (fVar4 < 6f && func_76(uParam1, uParam2))) || func_139(uParam2, 256)) || func_75())
	{
		...
		{
			func_23(uParam2, GET_ENTITY_COORDS(uVar0, 1), func_77(GET_LAST_MATERIAL_HIT_BY_ENTITY(uVar0)));
			func_22(uParam2, GET_COLLISION_NORMAL_OF_LAST_HIT_FOR_ENTITY(uVar0));
			if (func_76(uParam1, uParam2))
			{
			}
			func_187(&(uParam2->f_159));
		}
		if ((!func_76(uParam1, uParam2) && (((func_139(uParam2, 256) || VDIST2(vVar8, vVar5) < (0.1601f * 0.1601f)) || func_75()) || func_71(uParam1, uParam2))) && 0)
		{
			func_70(uVar0, vVar8, vVar5);
			func_47(uParam2, 256);
		}
	...
	{
		SET_ENTITY_COORDS(uVar0, func_68(uParam2), 1, 0, 0, 1);
		SET_ENTITY_RECORDS_COLLISIONS(uVar0, 0);
		func_196(uVar0, 1);
		func_24(uParam2, 6);
		func_47(uParam2, 68);
...
void func_70(var uParam0, struct<2> Param1, var uParam3, struct<2> Param4, var uParam6)
{
	vector3 vVar0;
...
int func_71(var uParam0, var uParam1)
{
	...
	if (VDIST(vVar0, func_43(uParam0, func_297(uParam1))) > fVar3)
	{
		return 0;
	}
	return 1;
...
int func_76(var uParam0, var uParam1)
{
	...
	if (!DOES_ENTITY_EXIST(func_273(uParam1)))
	{
		return 0;
	}
	vVar0 = { GET_ENTITY_COORDS(func_273(uParam1), 0) };
	vVar3 = { func_43(uParam0, func_297(uParam1)) };
...
{
	PLAY_SOUND_FROM_ENTITY(-1, "GOLF_BALL_IN_WATER_MASTER", func_273(uParam0), 0, 0, 0);
	return;
	START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_golf_landing_water", GET_ENTITY_COORDS(func_273(uParam0), 1), 0f, 0f, func_242(GET_ENTITY_COORDS(func_273(uParam0), 1), func_243(uParam0)), 1065353216, 0, 0, 0);
}
...
void func_83(var uParam0, var uParam1, var uParam2)
{
	...
	DRAW_DEBUG_LINE(GET_ENTITY_COORDS(uVar0, 1), GET_ENTITY_COORDS(uVar0, 1) + func_64(vVar17), 0, 0, 0, 255);
	if (func_78(uParam0, uParam1, uParam2))
	{
		return;
	}
	if (HAS_ENTITY_COLLIDED_WITH_ANYTHING(uVar0))
	{
		...
		fVar22 = 0f;
		fVar23 = 0f;
		switch (func_77(GET_LAST_MATERIAL_HIT_BY_ENTITY(uVar0)))
		{
			case 1:
				fVar20 = 0.89f;
				fVar21 = 0.75f;
		...
		if (!func_138(uParam0, 64))
		{
			if (fVar21 != 0f && VMAG2(vVar2) > 9.5f)
			{
				...
				vVar30 = { FtoV(func_63(vLocal_379, vVar27)) * vVar27 };
			...
			func_107(uParam0, 64);
			func_94(uParam2, 0, func_95(uVar0));
		}
		else
		{
	...
	if (!func_139(uParam2, 2))
	{
		...
		if (HAS_ENTITY_COLLIDED_WITH_ANYTHING(uVar0) && func_86(&(uParam2->f_159), 0.2f))
		{
			...
			func_53(uParam2, VDIST(GET_ENTITY_COORDS(uVar0, 1), func_243(uParam2)));
			func_47(uParam2, 2);
			func_152(&(uParam2->f_159));
			func_84(uParam2);
		}
	...
	{
		func_70(uVar0, GET_ENTITY_COORDS(uVar0, 1), func_43(uParam1, func_297(uParam2)));
	}
	else if ((fVar5 < 0.5f && (ABSF(uParam2->f_1.f_5) + ABSF(uParam2->f_1.f_6)) < 0.05f) || (fVar5 < 6f && func_76(uParam1, uParam2)))
	{
		if (!func_74(&(uParam2->f_159)))
		{
			func_23(uParam2, GET_ENTITY_COORDS(uVar0, 1), func_77(GET_LAST_MATERIAL_HIT_BY_ENTITY(uVar0)));
...
void func_84(var uParam0)
{
	...
	sVar0 = "";
	switch (GET_LAST_MATERIAL_HIT_BY_ENTITY(func_273(uParam0)))
	{
		case -461750719:
		case 930824497:
	...
	if (!func_85(sVar0))
	{
		START_PARTICLE_FX_NON_LOOPED_AT_COORD(sVar0, GET_ENTITY_COORDS(func_273(uParam0), 1), 0f, 0f, func_242(GET_ENTITY_COORDS(func_273(uParam0), 1), func_243(uParam0)), 1065353216, 0, 0, 0);
	}
}
...
void func_94(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_85(sVar0))
	{
		if (bParam1)
		{
			PLAY_SOUND_FROM_COORD(-1, sVar0, GET_ENTITY_COORDS(func_273(uParam0), 1), 0, 0, 0, 0);
		}
		else
		{
			PLAY_SOUND_FROM_ENTITY(-1, sVar0, func_273(uParam0), 0, 0, 0);
		}
	}
}
...
void func_96(var uParam0)
{
	...
	vVar0 = { func_64(uParam0->f_5, uParam0->f_6, 0f) * Vector(25f, 25f, 25f) * FtoV(GET_FRAME_TIME()) };
	vVar3 = { -vVar0 };
...
int func_100(var uParam0, var uParam1, bool bParam2)
{
	...
	if (IS_ENTITY_PLAYING_ANIM(uVar0, func_101(0), &cVar2, 3))
	{
		if (GET_ENTITY_ANIM_CURRENT_TIME(uVar0, func_101(0), &cVar2) > 0.95f)
		{
			return 0;
		}
	}
	if (bParam2)
	{
		if (!IS_ENTITY_PLAYING_ANIM(uVar0, func_101(0), &cVar2, 3) && (((IS_ENTITY_PLAYING_ANIM(uVar0, func_101(0), "iron_swing_action", 3) || IS_ENTITY_PLAYING_ANIM(uVar0, func_101(0), "putt_action", 3)) || IS_ENTITY_PLAYING_ANIM(uVar0, func_101(0), "wedge_swing_action", 3)) || IS_ENTITY_PLAYING_ANIM(uVar0, func_101(0), "wood_swing_action", 3)))
		{
			TASK_PLAY_ANIM(uVar0, func_101(0), &cVar2, 8f, -2f, -1, 0, 0, 0, 0, 0);
		}
		return 1;
	}
	return 0;
...
int func_106(var uParam0, float fParam1)
{
	...
	if (!IS_PED_INJURED(uParam0))
	{
		...
		if (IS_ENTITY_PLAYING_ANIM(uParam0, func_101(0), &cVar0, 3))
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(uParam0, func_101(0), &cVar0) >= fParam1)
			{
				return 1;
			}
		}
		else if (IS_ENTITY_PLAYING_ANIM(uParam0, func_101(0), &cVar8, 3))
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(uParam0, func_101(0), &cVar8) >= fParam1)
			{
				return 1;
			}
		}
		else if (IS_ENTITY_PLAYING_ANIM(uParam0, func_101(0), &cVar16, 3))
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(uParam0, func_101(0), &cVar16) >= fParam1)
			{
				return 1;
			}
		}
		else if (IS_ENTITY_PLAYING_ANIM(uParam0, func_101(0), &cVar24, 3))
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(uParam0, func_101(0), &cVar24) >= fParam1)
			{
				return 1;
			}
		}
...
int func_108(var uParam0, var uParam1, var uParam2)
{
	...
	SET_ENTITY_RECORDS_COLLISIONS(func_273(uParam2), 1);
	SET_OBJECT_PHYSICS_PARAMS(func_273(uParam2), -1f, -1f, 0f, 0f, 0.01f, -1f, -1f, -1f, -1f, -1f, -1082130432);
	bVar0 = func_60(uParam2) == 4;
	fVar1 = func_124(&(uParam2->f_15[func_259(uParam2) /*34*/]), uParam0, &(uParam2->f_1), bVar0, !bLocal_370, 0);
	fVar2 = 1f;
	...
	else
	{
		...
		vVar12 = { func_64(COS(fVar4), SIN(fVar4), 0f) };
		...
		{
			vVar24 = { func_113(vVar24, (fVar28 * (ACOS(ABSF(fVar27)) - 15f))) };
		}
	...
	SET_ENTITY_VELOCITY(func_273(uParam2), vVar6);
	SET_ENTITY_MAX_SPEED(func_273(uParam2), 150f);
	func_107(uParam0, 32);
...
void func_109(var uParam0, var uParam1, var uParam2)
{
	...
	if (!func_85(sVar0))
	{
		START_PARTICLE_FX_NON_LOOPED_AT_COORD(sVar0, func_243(uParam0), 0f, 0f, func_98(uParam0), 1065353216, 0, 0, 0);
	}
}
...
void func_110(var uParam0, bool bParam1)
{
	...
	return;
	if (!func_186(uParam0) && DOES_ENTITY_EXIST(func_273(uParam0)))
	{
		uVar0 = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_golf_ball_trail", func_273(uParam0), 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
		if (bParam1)
		{
...
void func_111(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!func_85(sVar0))
	{
		if (iParam2 || !DOES_ENTITY_EXIST(func_273(uParam1)))
		{
			PLAY_SOUND_FROM_COORD(-1, sVar0, func_243(uParam1), 0, 0, 0, 0);
		}
		else
		{
			PLAY_SOUND_FROM_ENTITY(-1, sVar0, func_273(uParam1), 0, 0, 0);
		}
	}
}
...
void func_132()
{
	...
	{
		if (func_136(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
...
int func_137(var uParam0)
{
	...
	if (!IS_PED_INJURED(uParam0))
	{
		...
		if (IS_ENTITY_PLAYING_ANIM(uParam0, func_101(0), &cVar0, 3))
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(uParam0, func_101(0), &cVar0) > 0.16f)
			{
				return 1;
			}
		}
		...
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(uParam0, func_101(0), &cVar8) > 0.134f)
			{
				return 1;
			}
		}
		...
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(uParam0, func_101(0), &cVar16) > 0.119f)
			{
				return 1;
			}
		}
		...
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(uParam0, func_101(0), &cVar24) > 0.159f)
			{
				return 1;
			}
		}
...
void func_145(var uParam0, var uParam1, int iParam2, float fParam3)
{
	...
	switch (func_118(uParam0))
	{
		...
		case 3:
		case 2:
			PLAY_SOUND_FROM_ENTITY(-1, "GOLF_FORWARD_SWING_HARD_MASTER", func_146(uParam0), 0, 0, 0);
			break;
...
void func_149(var uParam0)
{
	switch (func_118(uParam0))
	{
		case 0:
		case 1:
			PLAY_SOUND_FROM_ENTITY(-1, "GOLF_BACK_SWING_HARD_MASTER", func_146(uParam0), 0, 0, 0);
			break;
...
float func_153(var uParam0, var uParam1, bool bParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_157(var uParam0, var uParam1)
{
	...
	uVar0 = func_273(uParam1);
	if (DOES_ENTITY_EXIST(func_158(uParam1)) && func_31(uParam1) == 3)
	{
		return 1;
	}
	if (!DOES_ENTITY_EXIST(uVar0))
	...
	vVar1 = { GET_ENTITY_COORDS(func_273(uParam1), 0) };
	if (func_31(uParam1) != 3 && VDIST2(vVar1, func_43(uParam0, func_297(uParam1))) > (0.7f * 0.7f))
	{
		return 0;
	}
	if (VDIST2(vVar1, func_43(uParam0, func_297(uParam1))) > (55f * 55f))
	{
		return 0;
	}
	return 1;
	...
	if (!IS_PED_INJURED(uVar0))
	{
		...
		switch (func_151(uParam1))
		{
			...
			case 1:
				...
				if (!IS_ENTITY_PLAYING_ANIM(uVar0, func_101(0), &cVar17, 3))
				{
					TASK_PLAY_ANIM(uVar0, func_101(0), &cVar17, 8f, -8f, -1, 2, 0, 0, 0, 0);
					if (bLocal_0)
					{
					}
				}
				...
				{
					fVar4 = GET_ENTITY_ANIM_CURRENT_TIME(uVar0, func_101(0), &cVar17);
					if (GET_ENTITY_ANIM_CURRENT_TIME(uVar0, func_101(0), &cVar17) >= 0.975f)
					{
						if (bLocal_0)
						{
						}
						SET_ENTITY_ANIM_SPEED(uVar0, func_101(0), &cVar17, 0f);
						if (uParam2->f_10 == 0)
						{
					...
					{
						SET_ENTITY_ANIM_SPEED(uVar0, func_101(0), &cVar17, 0.6f);
					}
					if (fVar4 < fVar2)
					{
						SET_ENTITY_ANIM_CURRENT_TIME(uVar0, func_101(0), &cVar17, fVar2);
						SET_ENTITY_ANIM_SPEED(uVar0, func_101(0), &cVar17, 0.8f);
					}
				}
				break;
			...
			case 3:
				...
				if (IS_ENTITY_PLAYING_ANIM(uVar0, func_101(0), &cVar17, 3))
				{
					...
					if (fVar4 < fVar2)
					{
						TASK_PLAY_ANIM(uVar0, func_101(0), &cVar9, 4f, -8f, -1, 10, 0, 0, 0, 0);
						func_162(uParam1, 0);
					}
					else
					{
						SET_ENTITY_ANIM_CURRENT_TIME(uVar0, func_101(0), &cVar17, (fVar4 - fVar3));
						if (bLocal_0)
						{
						}
					}
				...
				{
					if (!IS_ENTITY_PLAYING_ANIM(uVar0, func_101(0), &cVar9, 3))
					{
						TASK_PLAY_ANIM(uVar0, func_101(0), &cVar9, 4f, -8f, -1, 10, 0, 0, 0, 0);
						if (bLocal_0)
						{
			...
			case 4:
				...
				if (!IS_ENTITY_PLAYING_ANIM(uVar0, func_101(0), &cVar25, 3))
				{
					if (HAS_ENTITY_ANIM_FINISHED(uVar0, func_101(0), &cVar17, 3))
					{
						TASK_PLAY_ANIM(uVar0, func_101(0), &cVar25, 8f, -8f, -1, 2, 0, 0, 0, 0);
						if (bLocal_0)
						{
						}
					}
					else if (IS_ENTITY_PLAYING_ANIM(uVar0, func_101(0), &cVar17, 3))
					{
						fVar1 = GET_ENTITY_ANIM_CURRENT_TIME(uVar0, func_101(0), &cVar17);
						TASK_PLAY_ANIM(uVar0, func_101(0), &cVar25, 8f, -8f, -1, 2, 0, 0, 0, 0);
						if (bLocal_0)
						{
						}
...
char* func_163(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4, int iParam5, int iParam6)
{
	...
	vVar2 = { GET_ENTITY_COORDS(func_171(uParam0), 1) };
	if (bParam3)
	{
	...
	vVar11 = { GET_ENTITY_FORWARD_VECTOR(func_171(uParam0)) };
	vVar14 = { func_64(vVar5 - vVar2) };
	vVar17 = { func_113(vVar11, 90f) };
	vVar20 = { vVar11 };
	func_164(&vVar20, fVar8, vVar17);
	fVar23 = ACOS(func_63(vVar11, vVar14));
	fVar24 = (fVar23 - fVar8);
...
void func_179(var uParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6, int iParam7)
{
	var uVar0;
	int iVar1;
	vector3 vVar2;
	...
	SET_ENTITY_COORDS(func_183(uParam0, iParam1), vParam2, 0, 0, 0, 1);
	iVar1 = func_37(uParam0, iParam1);
	if (DOES_ENTITY_EXIST(func_36(uParam0, iVar1)) && iParam7)
	{
		vVar2 = { 0f, 0f, 0f };
		vVar5 = { 0f, 0f, 0f };
		fVar8 = 0f;
		...
		if (!IS_ENTITY_DEAD(func_36(uParam0, iVar1), 0))
		{
			if (func_27(uParam0, iParam1, 1048576))
			{
				bVar9 = func_182(vParam2 + vVar5, func_43(uParam5, func_297(uParam0)), &vVar2, &fVar8);
			}
			else
			{
				bVar9 = func_180(vParam2 + vVar5, func_43(uParam5, func_297(uParam0)), &vVar2, &fVar8, 0f, 0f, 0f, 0f, 0f, 0f, 0);
			}
			if (bVar9 && !IS_SPHERE_VISIBLE(vVar2, 5f))
			{
				SET_ENTITY_COORDS(func_36(uParam0, iVar1), vVar2, 1, 0, 0, 1);
				SET_ENTITY_HEADING(func_36(uParam0, iVar1), fVar8);
			}
		}
	}
}

int func_180(vector3 vParam0, struct<2> Param3, var uParam5, var uParam6, float fParam7, vector3 vParam8, struct<2> Param11, float fParam13, bool bParam14)
{
	bool bVar0;
	int iVar1;
	var uVar2;
	...
	while (!bVar0 && iVar1 < 10)
	{
		...
		else if ((VDIST2(vParam0, *uParam6) > 100f && !IS_ANY_VEHICLE_NEAR_POINT(*uParam6, 5f)) && !func_62(*uParam6))
		{
			vVar3 = { func_64(Vector(0f, uParam6->f_1, *uParam6) - Vector(0f, Param11.f_1, Param11)) };
			if (!bParam14 || func_181(vParam8, vVar3) < 0.75f)
			{
				bVar0 = true;
			}
		}
...
int func_182(vector3 vParam0, struct<2> Param3, var uParam5, var uParam6, float fParam7)
{
...
int func_185(var uParam0)
{
	...
	{
		if (GET_SCRIPT_TASK_STATUS(func_275(uParam0), 242628503) == 1)
		{
			if (GET_SEQUENCE_PROGRESS(func_275(uParam0)) == 2)
			{
				return 1;
			}
		}
	}
	else if (GET_SCRIPT_TASK_STATUS(func_275(uParam0), 242628503) != 1 && GET_SCRIPT_TASK_STATUS(func_275(uParam0), 242628503) != 0)
	{
		return 1;
	}
	return 0;
...
Vector3 func_189(var uParam0, var uParam1)
{
	...
	{
		vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(func_243(uParam0), (func_98(uParam0) + fVar3), (((-func_126(uParam1, func_122(uParam0)) * func_190(func_118(uParam0))) * func_125(func_32(&(uParam0->f_15[func_259(uParam0) /*34*/])))) * ((func_148(uParam0, 1) * fVar4) / 100f)), 0f, 0f) };
	}
	else if (func_31(uParam0) != 3)
	{
		vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(func_243(uParam0), func_98(uParam0), (((-func_126(uParam1, func_122(uParam0)) * func_190(func_118(uParam0))) * func_125(func_32(&(uParam0->f_15[func_259(uParam0) /*34*/])))) * (func_148(uParam0, 1) / 100f)), 0f, 0f) };
	}
	else
	{
		vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(func_243(uParam0), func_98(uParam0), Vector(-uParam0->f_1.f_1, -uParam0->f_1.f_1, -uParam0->f_1.f_1) * Vector(0f, 0f, (func_148(uParam0, 1) / 100f))) };
	}
...
void func_197(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	fVar3 = (func_242(vVar0, func_243(uParam1)) + 90f);
	func_198(&(uParam1->f_15[func_259(uParam1) /*34*/]), uParam2, fVar3, 0, iParam3, iParam4, iParam6, bParam7);
}
...
void func_198(var uParam0, var uParam1, float fParam2, bool bParam3, var uParam4, int iParam5, var uParam6, bool bParam7)
{
	...
	{
		TASK_STAND_STILL(func_171(uParam0), -1);
	}
	else
	{
		iParam5 = 1;
	...
	func_224(uParam0, fParam2);
	vVar1 = { _GET_OBJECT_OFFSET_FROM_COORDS(func_170(uParam0), func_99(uParam0), func_223(iVar0)) };
	vVar4 = { GET_ENTITY_COORDS(func_171(uParam0), 1) };
	if (bParam3)
	{
		CLEAR_PED_TASKS_IMMEDIATELY(func_171(uParam0));
	}
	if (iParam5 || func_3(uParam0, 1048576))
	{
		if (func_28(uParam0) != 4)
		{
			func_245(&vVar4, 100f, 0f);
		}
		...
		else
		{
			...
			if (bVar8)
			{
				SET_ENTITY_HEADING(func_171(uParam0), func_99(uParam0));
				SET_ENTITY_COORDS(func_171(uParam0), vVar1, 0, 1, 1, 1);
			}
		}
	}
	else
	{
		CLEAR_PED_TASKS(func_171(uParam0));
		...
		TASK_PERFORM_SEQUENCE(func_171(uParam0), uParam0->f_21);
...
void func_199(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	{
		if (iVar1 == GET_ENTITY_MODEL(func_147(uParam0)))
		{
			bVar2 = false;
		}
	}
	...
	if (!bParam2 || bVar2)
	{
		uVar3 = func_171(uParam0);
		if (!IS_PED_INJURED(uVar3))
		{
			ATTACH_ENTITY_TO_ENTITY(func_147(uParam0), uVar3, GET_PED_BONE_INDEX(uVar3, 28422), func_201(uVar3, iVar0), func_200(uVar3, iVar0), 0, 0, 0, 0, 2, 1);
		}
	}
}

Vector3 func_200(var uParam0, int iParam1)
{
	uParam0 = uParam0;
	iParam1 = iParam1;
	return 0f, 0f, 0f;
...
Vector3 func_201(var uParam0, int iParam1)
{
	return 0f, 0f, 0f;
}
...
int func_203(var uParam0, var uParam1)
{
	...
	func_204(uParam0);
	uVar0 = CREATE_OBJECT_NO_OFFSET(func_206(uParam1, func_105(uParam0)), func_170(uParam0), 0, 1, 0);
	return uVar0;
}
...
int func_205(var uParam0, int iParam1)
{
	...
	{
		return ((IS_ENTITY_PLAYING_ANIM(uParam0, func_101(0), "wood_idle_a", 3) || IS_ENTITY_PLAYING_ANIM(uParam0, func_101(1), "wood_idle_b", 3)) || IS_ENTITY_PLAYING_ANIM(uParam0, func_101(1), "wood_idle_c", 3));
	}
	else if (iParam1 >= 6 && iParam1 <= 13)
	{
		return ((IS_ENTITY_PLAYING_ANIM(uParam0, func_101(0), "iron_idle_a", 3) || IS_ENTITY_PLAYING_ANIM(uParam0, func_101(1), "iron_idle_b", 3)) || IS_ENTITY_PLAYING_ANIM(uParam0, func_101(1), "iron_idle_c", 3));
	}
	else if (iParam1 >= 14 && iParam1 <= 18)
	{
		return ((IS_ENTITY_PLAYING_ANIM(uParam0, func_101(0), "wedge_idle_a", 3) || IS_ENTITY_PLAYING_ANIM(uParam0, func_101(1), "wedge_idle_b", 3)) || IS_ENTITY_PLAYING_ANIM(uParam0, func_101(1), "wedge_idle_c", 3));
	}
	else if (iParam1 == 19)
	{
		return ((IS_ENTITY_PLAYING_ANIM(uParam0, func_101(0), "putt_idle_a", 3) || IS_ENTITY_PLAYING_ANIM(uParam0, func_101(1), "putt_idle_b", 3)) || IS_ENTITY_PLAYING_ANIM(uParam0, func_101(1), "putt_idle_c", 3));
	}
	return 0;
}
...
void func_207(var uParam0, var uParam1)
{
	...
	{
		_0x2208438012482A1A(func_171(uParam0), 1, 0);
		_0xED3C76ADFA6D07C4(func_171(uParam0));
		func_48(uParam0, 32768);
	}
}

void func_208(var uParam0, char[4] cParam1, char[4] cParam2, bool bParam3, float fParam4, float fParam5, int iParam6, float fParam7, float fParam8, float fParam9, bool bParam10)
{
	struct<20> Var0;
	struct<21> Var22;
...
int func_210(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, float fParam12)
{
	var uVar0;
	vector3 vVar1;
	float fVar4;
	...
	if (!func_219())
	{
		if (func_218(PLAYER_ID(), 1, 0) && !(func_217() || func_216()))
		{
			if (((bParam9 && func_215(PLAYER_ID(), 1, 0)) && IS_PLAYER_SWITCH_IN_PROGRESS()) && Global_2424047[PLAYER_ID() /*416*/].f_222 == 1)
			{
			}
			else if (func_214() == 67)
			{
	...
	if (((!vParam0.x == Global_2437364.f_1234 || !vParam0.y == Global_2437364.f_1234.f_1) || !vParam0.z == Global_2437364.f_1234.f_2) || !fParam3 == Global_2437364.f_1237)
	{
		...
		{
			if (GET_TIME_DIFFERENCE(GET_NETWORK_TIME(), Global_2437364.f_1238) < func_213(0))
			{
				return 0;
			}
			STOP_PLAYER_TELEPORT();
	...
	if (Global_2437364.f_1232)
	{
		...
		if (Global_2437364.f_1239 > -1)
		{
			...
			if (func_211(&(Global_2437364.f_1239), vParam0, fParam3, uVar0))
			{
				func_220(bParam6, bParam9);
				return 1;
			}
...
int func_211(var uParam0, vector3 vParam1, float fParam4, var uParam5)
{
...
int func_235(var uParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		if (DOES_ENTITY_EXIST(func_273(uParam1)))
		{
			vVar0 = { GET_ENTITY_COORDS(func_273(uParam1), 1) };
		}
	}
	if (VDIST2(vVar0, func_43(uParam0, func_297(uParam1))) > (0.7f * 0.7f))
	{
		return 0;
	}
	return 1;
...
float func_242(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)
{
...
int func_246(var uParam0)
{
	...
	if (!DOES_ENTITY_EXIST(func_171(uParam0)))
	{
		return 0;
	}
	fVar0 = VDIST2(GET_ENTITY_COORDS(func_171(uParam0), 1), func_170(uParam0));
	if ((fVar0 < (4f * 4f) || func_3(uParam0, 512)) && ((!IS_PED_RAGDOLL(func_171(uParam0)) && !IS_ENTITY_IN_AIR(func_171(uParam0))) && !IS_PED_GETTING_UP(func_171(uParam0))))
	{
		return 1;
	}
	if (IS_PED_IN_ANY_VEHICLE(func_171(uParam0), 0))
	{
		if (fVar0 < (12f * 12f))
		{
			return 1;
...
void func_248(var uParam0, var uParam1, int iParam2)
{
	...
	if (!DOES_ENTITY_EXIST(func_171(&(uParam1->f_15[iParam2 /*34*/]))))
	{
		return;
	}
	if (IS_ENTITY_DEAD(func_171(&(uParam1->f_15[iParam2 /*34*/])), 0))
	{
		return;
	}
	...
	if (func_27(uParam1, iParam2, 1048576))
	{
		...
		{
			SET_ENTITY_COORDS(func_171(&(uParam1->f_15[iParam2 /*34*/])), vVar0, 0, 0, 0, 1);
		}
		vVar4 = { 0f, 0f, 0f };
		fVar7 = 0f;
		if (DOES_ENTITY_EXIST(func_36(uParam1, 0)))
		{
			if (!IS_ENTITY_DEAD(func_36(uParam1, 0), 0))
			{
				if (func_180(func_184(uParam1, 0), func_43(uParam0, func_297(uParam1)), &vVar4, &fVar7, 0f, 0f, 0f, 0f, 0f, 0f, 0))
				{
					if (!IS_SPHERE_VISIBLE(vVar4, 5f))
					{
						SET_ENTITY_COORDS(func_36(uParam1, 0), vVar4, 1, 0, 0, 1);
						SET_ENTITY_HEADING(func_36(uParam1, 0), fVar7);
					}
				}
			}
		}
	}
	else if (GET_SCRIPT_TASK_STATUS(uVar3, 242628503) != 1 && GET_SCRIPT_TASK_STATUS(uVar3, 242628503) != 0)
	{
		if (func_27(uParam1, iParam2, 4194304) && DOES_ENTITY_EXIST(func_273(uParam1)))
		{
			vVar0 = { GET_ENTITY_COORDS(func_273(uParam1), 1) };
		}
		...
		if (VDIST2(vVar0, GET_ENTITY_COORDS(uVar3, 1)) > 1.5f)
		{
			CLEAR_PED_TASKS(uVar3);
			OPEN_SEQUENCE_TASK(&(uParam1->f_15[iParam2 /*34*/].f_21));
			TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar0, 1f, -1, 0.25f, 4, func_251(vVar0, func_43(uParam0, func_297(uParam1))));
			CLOSE_SEQUENCE_TASK(uParam1->f_15[iParam2 /*34*/].f_21);
			TASK_PERFORM_SEQUENCE(uVar3, uParam1->f_15[iParam2 /*34*/].f_21);
...
var func_251(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)
{
	return GET_HEADING_FROM_VECTOR_2D((Param3 - Param0), (Param3.f_1 - Param0.f_1));
}
	...
	while (iVar2 < func_281(uParam0))
	{
		if (func_250(uParam0, iVar2) != 0)
		{
			if (func_155(uParam0, iVar2) != 10 && !func_27(uParam0, iVar2, 16777216))
			{
				...
				vVar7 = { func_43(uParam1, func_297(uParam0)) };
				vVar4.z = 0f;
				vVar7.z = 0f;
...
void func_256(var uParam0, var uParam1)
{
	...
	if (DOES_ENTITY_EXIST(func_146(uParam0)))
	{
		uVar0 = func_104(uParam1, func_122(uParam0));
		ATTACH_ENTITY_TO_ENTITY(func_146(uParam0), func_275(uParam0), GET_PED_BONE_INDEX(func_275(uParam0), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	}
}
...
void func_258(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (IS_ENTITY_DEAD(func_171(uParam0), 0) || IS_PED_INJURED(func_171(uParam0)))
	{
		return;
	}
	...
	if (GET_SCRIPT_TASK_STATUS(func_171(uParam0), -1794415470) == 1)
	{
		return;
	}
	vVar0 = { func_170(uParam0) };
	vVar3 = { GET_ENTITY_COORDS(uParam1, 1) };
	vVar6 = { GET_ENTITY_COORDS(func_171(uParam0), 1) };
	...
	else
	{
		...
		if (func_3(uParam0, 524288) && func_154(uParam2, -1))
		{
			...
			if (GET_SCRIPT_TASK_STATUS(func_171(uParam0), 1435919172) == 1)
			{
				CLEAR_PED_TASKS(func_171(uParam0));
			}
		}
...
int func_261(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)
{
	var uVar0;
	bool bVar1;
	...
	if (!IS_ENTITY_DEAD(uVar0, 0) && !IS_ENTITY_DEAD(uParam0, 0))
	{
		...
		{
			if (func_267(uVar0, uParam0, uParam2, bParam5))
			{
				*uParam3 = 4;
				return 1;
			}
		...
		{
			if (func_266(uVar0, uParam0, uParam2))
			{
				*uParam3 = 8;
				return 1;
			}
		...
		if (bParam4)
		{
			if (func_262(uParam0, iParam1, 1, bParam6, bVar1, 1))
			{
				*uParam3 = 32;
				return 1;
			}
		...
		{
			if (func_262(uParam0, iParam1, 0, bParam6, bVar1, bParam8))
			{
				*uParam3 = 16;
				return 1;
			}
...
int func_262(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	var uVar0;
	var uVar1;
	...
	if (func_265(PLAYER_PED_ID(), uParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (IS_PED_RAGDOLL(uParam0) && func_263(uParam0, 1) < 1.5f)
		{
			return 1;
		}
...
{
	return func_264(GET_PLAYER_PED(GET_PLAYER_INDEX()), uParam0, iParam1);
}
...
int func_266(var uParam0, var uParam1, var uParam2)
{
...
int func_267(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	...
	if (IS_PED_ARMED(uParam0, 2))
	{
		...
		else
		{
			...
			if (IS_PED_PLANTING_BOMB(uParam0) || func_268(iVar3))
			{
				if (IS_ENTITY_AT_COORD(uParam1, GET_ENTITY_COORDS(uParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (IS_PED_FACING_PED(GET_PED_INDEX_FROM_ENTITY_INDEX(uParam1), uParam0, 120f) && HAS_ENTITY_CLEAR_LOS_TO_ENTITY(uParam1, uParam0, 17))
		...
		if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			if (GET_PED_IN_VEHICLE_SEAT(iParam0, -1, 0) != 0)
			{
				if (GET_CURRENT_PED_WEAPON(PLAYER_PED_ID(), &iVar0, 1))
				{
					...
					{
						if (func_264(PLAYER_PED_ID(), iParam0, 1) < 40f)
						{
	...
	if (!IS_ENTITY_DEAD(uParam0, 0))
	{
		if (IS_PED_ARMED(PLAYER_PED_ID(), 6))
		{
			if (IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uParam0) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uParam0))
			{
				...
				{
					if (func_263(uParam0, 1) < uParam1->f_2)
					{
						if (uParam1->f_1 == 0)
						{
...
void func_283(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	{
		if (!DOES_ENTITY_EXIST(func_36(uParam1, iVar4)))
		{
			if (iVar4 == 1)
			{
				vVar5 = { Vector(10f, 10f, 10f) * GET_ENTITY_FORWARD_VECTOR(func_36(uParam1, 0)) };
			}
			if (func_182(func_296(uParam0, iParam2) + vVar5, func_43(uParam0, func_297(uParam1)), &vVar0, &uVar3))
			{
				func_284(uParam1, CREATE_VEHICLE(joaat("caddy"), vVar0, uVar3, 1, 1, 0), iVar4);
				SET_VEHICLE_EXTRA(func_36(uParam1, iVar4), 5, 1);
				_SET_ENTITY_SOMETHING(func_36(uParam1, iVar4), 1);
			}
		}
		iVar4++;
	}
...
void func_285(var uParam0, var uParam1, int iParam2)
{
	...
	{
		uVar3 = func_288(&iVar4, 1065437102);
		func_286(uParam1, iParam2, CREATE_PED(iVar4, uVar3, vVar0, 0, 1, 1));
		SET_ENTITY_HEADING(func_183(uParam1, iParam2), func_242(vVar0, func_296(uParam0, func_297(uParam1))));
		if (HAS_ANIM_SET_LOADED("move_m@golfer@"))
		{
			SET_PED_WEAPON_MOVEMENT_CLIPSET(func_183(uParam1, iParam2), "move_m@golfer@");
		}
		_0x2F3C3D9F50681DE4(func_183(uParam1, iParam2), 1);
	}
}
...
void func_286(var uParam0, int iParam1, var uParam2)
{
	...
	func_287(&(uParam0->f_15[iParam1 /*34*/]), uParam2);
}
...
void func_309(var uParam0)
{
	...
	{
		(*uParam0)[iVar0 /*3*/] = (VDIST(func_296(uParam0, iVar0), func_244(uParam0, iVar0)) + VDIST(func_244(uParam0, iVar0), func_43(uParam0, iVar0)));
