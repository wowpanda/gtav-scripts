	...
	while (true)
	{
		...
		switch (iVar3)
		{
			case 2:
				...
				func_305(&Var1);
				STREAMING::REQUEST_ANIM_DICT(func_304());
			...
			case 3:
				if ((STREAMING::HAS_ANIM_DICT_LOADED(func_304()) && func_299(&uVar4)) && STREAMING::HAS_ANIM_SET_LOADED("move_m@golfer@"))
				{
					func_296(&uVar2);
					iVar3 = 4;
				}
			...
			case 4:
				if (func_295(CLOCK::GET_CLOCK_HOURS()))
				{
					if (!CAM::IS_SPHERE_VISIBLE(func_293(&Var1, func_294(&(Var0[iVar6 /*170*/]))), 10f) || func_292(4))
					{
						func_296(&uVar2);
						iVar3 = 5;
						iVar6 = 0;
						while (iVar6 < Var0)
						{
							func_279(&Var1, &(Var0[iVar6 /*170*/]), 1, iVar6 * 4, 0);
							iVar5 = 0;
							while (iVar5 < func_278(&(Var0[iVar6 /*170*/])))
							{
								func_277(&(Var0[iVar6 /*170*/]), iVar5, 4194304);
								func_274(&(Var0[iVar6 /*170*/]), func_276(&uVar2, 19));
								iVar5++;
							}
							iVar6++;
						}
			...
			case 9:
				func_311(&Var1);
				func_308(&Var0);
				STREAMING::REMOVE_ANIM_DICT(func_304());
				SCRIPT::TERMINATE_THIS_THREAD();
				break;
...
void func_1(var uParam0, var uParam1, var uParam2)
{
	...
	if (((ENTITY::IS_ENTITY_DEAD(func_272(uParam2), 0) || PED::IS_PED_INJURED(func_272(uParam2))) || !ENTITY::DOES_ENTITY_EXIST(func_272(uParam2))) || PED::IS_PED_FLEEING(func_272(uParam2)))
	{
	...
	else
	{
		...
		Var0.f_5 = 1103626240;
		Var0.f_6 = 5;
		if ((func_258(func_272(uParam2), 0, &Var0, &uVar1, 0, 1, 0, 1, 1) || PED::IS_PED_IN_MELEE_COMBAT(func_272(uParam2))) || PED::IS_PED_RESPONDING_TO_EVENT(func_272(uParam2), 60))
		{
			BRAIN::CLEAR_PED_TASKS(func_272(uParam2));
			BRAIN::TASK_SMART_FLEE_PED(func_272(uParam2), PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(func_272(uParam2), true);
			func_257(uParam2, 4);
			return;
		}
	}
	func_255(&(uParam2->f_15[func_256(uParam2) /*34*/]), PLAYER::PLAYER_PED_ID(), uParam2, func_256(uParam2), uParam1);
	switch (func_254(uParam2))
	{
		case 0:
			func_253(uParam2, uParam0);
			func_244(uParam1, uParam2);
			if (func_243(&(uParam2->f_15[0 /*34*/])))
			{
				func_257(uParam2, 2);
			}
			break;
		...
		case 2:
			...
			PED::SET_PED_RESET_FLAG(func_272(uParam2), 129, true);
			...
			if (func_26(uParam2, -1, 0))
			{
				...
				func_253(uParam2, uParam0);
				uParam2->f_157 = 0;
				while (uParam2->f_157 < func_278(uParam2))
				{
					func_24(uParam2, 0);
				...
				if (ENTITY::DOES_ENTITY_EXIST(func_270(uParam2)))
				{
					func_5(uParam2, ENTITY::GET_ENTITY_COORDS(func_270(uParam2), true));
				}
			}
			else if (func_2(&(uParam2->f_15[func_256(uParam2) /*34*/])))
			{
				func_24(uParam2, 1);
				func_244(uParam1, uParam2);
				func_20(uParam2, 0);
...
void func_7(var uParam0, var uParam1)
{
	...
	iVar0 = 0;
	while (iVar0 < func_278(uParam1))
	{
		func_13(&(uParam1->f_15[iVar0 /*34*/]), 0f, 0f, 0f, 5, 1);
		func_12(&(uParam1->f_15[iVar0 /*34*/]), 0f, 0f, -1f);
		func_11(&(uParam1->f_15[iVar0 /*34*/]), 0f, 0f, 0f);
		func_6(&(uParam1->f_15[iVar0 /*34*/]), func_293(uParam0, func_294(uParam1)));
		func_9(&(uParam1->f_15[iVar0 /*34*/]), func_10(uParam0, func_294(uParam1)));
...
void func_30(var uParam0, var uParam1, var uParam2)
{
	...
	if (ENTITY::IS_ENTITY_DEAD(func_272(uParam2), 0))
	{
		return;
	}
	...
	{
		case 0:
			vVar0 = { func_293(uParam1, func_294(uParam2)) };
			func_242(&vVar0, 1073741824, 1065353216);
			if (!ENTITY::DOES_ENTITY_EXIST(func_270(uParam2)))
			{
				func_236(uParam2, func_238(vVar0, func_239(func_241(uParam1, func_294(uParam2)), func_240(uParam2))));
			}
			else if (!func_235())
			{
				ENTITY::SET_ENTITY_COORDS(func_270(uParam2), vVar0, 1, false, 0, 1);
			}
			func_5(uParam2, ENTITY::GET_ENTITY_COORDS(func_270(uParam2), true));
			if (func_234(uParam1, func_294(uParam2)) == 1)
			{
			...
			if (!bLocal_301)
			{
				func_222(uParam0, uParam1, uParam2, 1);
			}
			func_197(uParam1, uParam2, uParam0, 0, 0, 1, 1, 0);
			ENTITY::SET_ENTITY_RECORDS_COLLISIONS(func_270(uParam2), 0);
			func_196(func_270(uParam2), 1);
			func_193(uParam0, uParam1, uParam2);
			func_191(&(uParam2->f_1), &(uParam2->f_15[func_256(uParam2) /*34*/]), uParam0);
		...
		case 1:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(func_270(uParam2)))
			{
				func_236(uParam2, func_238(func_293(uParam1, func_294(uParam2)) + Vector(0.075f, 0f, 0f), func_239(func_241(uParam1, func_294(uParam2)), func_240(uParam2))));
			}
			func_193(uParam0, uParam1, uParam2);
			func_191(&(uParam2->f_1), &(uParam2->f_15[func_256(uParam2) /*34*/]), uParam0);
			if (!func_186(uParam2))
		...
		case 3:
			if (func_185(uParam2) || func_3(&(uParam2->f_15[func_256(uParam2) /*34*/]), 1048576))
			{
				if (func_3(&(uParam2->f_15[func_256(uParam2) /*34*/]), 1048576))
				{
					func_178(uParam2, func_256(uParam2), uParam1, 0, 1);
					func_176(&(uParam2->f_162));
					func_24(uParam2, func_175());
					return;
				}
				if (ENTITY::DOES_ENTITY_EXIST(func_272(uParam2)) && !ENTITY::IS_ENTITY_DEAD(func_272(uParam2), 0))
				{
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(func_272(uParam2), true), func_240(uParam2)) > 9f)
					{
						BRAIN::CLEAR_PED_TASKS(func_272(uParam2));
						func_24(uParam2, 1);
						return;
				...
				func_24(uParam2, func_175());
				func_174(uParam2, 1);
				func_160(uParam0, &(uParam2->f_15[func_256(uParam2) /*34*/]), &(uParam2->f_1));
				if (func_157(uParam1, uParam2))
				{
					func_188(uParam2, func_189(uParam2, uParam0));
				}
			}
			else if (ENTITY::GET_ENTITY_SPEED(func_272(uParam2)) == 0f && func_156(&(uParam2->f_162), 15f))
			{
				func_187(&(uParam2->f_162));
				BRAIN::CLEAR_PED_TASKS(func_272(uParam2));
		...
		case 4:
			if (func_153(PLAYER::PLAYER_PED_ID(), uParam2->f_15[func_256(uParam2) /*34*/].f_2, 0) < 1f)
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam2->f_15[func_256(uParam2) /*34*/].f_2))
				{
					BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(uParam2->f_15[func_256(uParam2) /*34*/].f_2);
					func_197(uParam1, uParam2, uParam0, 0, 0, 0, 1, 0);
					func_257(uParam2, 0);
					func_24(uParam2, 1);
			...
			{
				if (((uParam2->f_1 == 4 || uParam2->f_1 == 6) || func_139(uParam2, 1048576)) && ENTITY::DOES_ENTITY_EXIST(func_270(uParam2)))
				{
					if (((func_137(func_272(uParam2)) || func_156(&(uParam2->f_162), 2.5f)) || func_139(uParam2, 1048576)) && ENTITY::DOES_ENTITY_HAVE_PHYSICS(func_270(uParam2)))
					{
						if (func_139(uParam2, 1048576))
						{
							if (bLocal_0)
				...
				else if (!ENTITY::DOES_ENTITY_EXIST(func_270(uParam2)))
				{
					uParam2->f_1 = 0;
					func_24(uParam2, 0);
				}
		...
		case 5:
			if (func_106(func_272(uParam2), 1f))
			{
				func_100(uParam0, uParam2, 1);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(func_270(uParam2)))
			{
				func_236(uParam2, func_238(func_240(uParam2), func_239(func_241(uParam1, func_294(uParam2)), func_240(uParam2))));
			}
			if (!func_157(uParam1, uParam2))
			{
		...
		case 6:
			func_100(uParam0, uParam2, 1);
			if ((func_66(uParam2) || func_65(uParam2)) || func_62(ENTITY::GET_ENTITY_COORDS(func_270(uParam2), true)))
			{
				func_61(uParam2);
			}
			else
			...
			func_24(uParam2, 7);
			func_51(uParam2, 1);
			if (func_49(uParam2) > func_234(uParam1, func_294(uParam2)) + 3)
			{
				func_24(uParam2, 7);
		...
		case 8:
			...
			if (!func_26(uParam2, func_256(uParam2), 0) && !func_139(uParam2, 1048576))
			{
				BRAIN::CLEAR_PED_TASKS(func_272(uParam2));
				BRAIN::OPEN_SEQUENCE_TASK(&(uParam2->f_15[func_256(uParam2) /*34*/].f_21));
				BRAIN::TASK_GO_TO_COORD_ANY_MEANS(0, func_44(uParam1, func_294(uParam2), func_256(uParam2)), 1f, 0, 0, 786603, -1082130432);
				BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, func_43(uParam1, func_294(uParam2)), 0);
				BRAIN::CLOSE_SEQUENCE_TASK(uParam2->f_15[func_256(uParam2) /*34*/].f_21);
				BRAIN::TASK_PERFORM_SEQUENCE(func_272(uParam2), uParam2->f_15[func_256(uParam2) /*34*/].f_21);
				BRAIN::CLEAR_SEQUENCE_TASK(&(uParam2->f_15[func_256(uParam2) /*34*/].f_21));
			}
			break;
		...
		case 7:
			...
			{
				if (func_39(uParam1, uParam2) && !func_154(uParam2, func_256(uParam2)))
				{
					if (!func_139(uParam2, 1048576))
					{
						if (bLocal_0)
						...
						BRAIN::CLEAR_PED_TASKS(func_272(uParam2));
						BRAIN::OPEN_SEQUENCE_TASK(&(uParam2->f_15[func_256(uParam2) /*34*/].f_21));
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_38(uParam1, func_294(uParam2), func_256(uParam2)), 1f, -1, 0.25f, 0, 1193033728);
						BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, func_293(uParam1, func_294(uParam2)), 0);
						BRAIN::CLOSE_SEQUENCE_TASK(uParam2->f_15[func_256(uParam2) /*34*/].f_21);
						BRAIN::TASK_PERFORM_SEQUENCE(func_272(uParam2), uParam2->f_15[func_256(uParam2) /*34*/].f_21);
						BRAIN::CLEAR_SEQUENCE_TASK(&(uParam2->f_15[func_256(uParam2) /*34*/].f_21));
					}
					...
					{
						ENTITY::SET_ENTITY_COORDS(func_272(uParam2), func_38(uParam1, func_294(uParam2), func_256(uParam2)), 1, false, 0, 1);
					}
				}
				else if (func_186(uParam2) || func_139(uParam2, 67108864))
				{
					if (!func_139(uParam2, 1048576))
					{
						if (!func_26(uParam2, func_256(uParam2), 0))
						{
							if (bLocal_0)
							{
							}
							BRAIN::CLEAR_PED_TASKS(func_272(uParam2));
							BRAIN::OPEN_SEQUENCE_TASK(&(uParam2->f_15[func_256(uParam2) /*34*/].f_21));
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_44(uParam1, func_294(uParam2), func_256(uParam2)), 1f, -1, 0.25f, 0, 1193033728);
							BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, func_43(uParam1, func_294(uParam2)), 0);
							BRAIN::CLOSE_SEQUENCE_TASK(uParam2->f_15[func_256(uParam2) /*34*/].f_21);
							BRAIN::TASK_PERFORM_SEQUENCE(func_272(uParam2), uParam2->f_15[func_256(uParam2) /*34*/].f_21);
							BRAIN::CLEAR_SEQUENCE_TASK(&(uParam2->f_15[func_256(uParam2) /*34*/].f_21));
					...
					{
						ENTITY::SET_ENTITY_COORDS(func_272(uParam2), func_44(uParam1, func_294(uParam2), func_256(uParam2)), 1, false, 0, 1);
					}
				}
				else if (!func_139(uParam2, 1048576))
				{
					if (!func_26(uParam2, func_256(uParam2), 0) && ENTITY::DOES_ENTITY_EXIST(func_35(uParam2)))
					{
						if (!ENTITY::IS_ENTITY_DEAD(func_35(uParam2), 0))
						{
							BRAIN::CLEAR_PED_TASKS(func_272(uParam2));
							BRAIN::OPEN_SEQUENCE_TASK(&(uParam2->f_15[func_256(uParam2) /*34*/].f_21));
							BRAIN::TASK_ENTER_VEHICLE(0, func_35(uParam2), -1, func_33(uParam2), 1f, 1, 0);
							BRAIN::CLOSE_SEQUENCE_TASK(uParam2->f_15[func_256(uParam2) /*34*/].f_21);
							BRAIN::TASK_PERFORM_SEQUENCE(func_272(uParam2), uParam2->f_15[func_256(uParam2) /*34*/].f_21);
							BRAIN::CLEAR_SEQUENCE_TASK(&(uParam2->f_15[func_256(uParam2) /*34*/].f_21));
						}
...
{
	return func_34(func_256(uParam0));
}
...
{
	return func_36(uParam0, func_37(uParam0, func_256(uParam0)));
}
...
{
	if (func_294(uParam1) < 0 || func_294(uParam1) >= func_42(uParam0))
	{
		return 0;
	}
...
void func_52(var uParam0, var uParam1)
{
	if (!bLocal_301)
	{
		...
		func_5(uParam1, ENTITY::GET_ENTITY_COORDS(func_270(uParam1), true));
		func_59(uParam1, SYSTEM::VDIST(func_240(uParam1), func_43(uParam0, func_294(uParam1))));
	}
	else
	{
		ENTITY::SET_ENTITY_COORDS(func_270(uParam1), func_240(uParam1) + Vector(0.05f, 0f, 0f), 1, false, 0, 1);
		func_57(uParam1);
		func_55(uParam1);
	}
	ENTITY::SET_ENTITY_MAX_SPEED(func_270(uParam1), 150f);
	func_196(func_270(uParam1), 1);
	func_45(uParam1, 2);
	func_53(uParam1, 0f);
}
...
void func_67(var uParam0, var uParam1, var uParam2)
{
	...
	if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iVar0))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar5))
		{
			...
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "GOLF_BALL_IMPACT_FLAG_MASTER", func_270(uParam2), 0, 0, 0);
	...
	else if (func_139(uParam2, 2) && func_186(uParam2))
	{
		...
		{
			AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "GOLF_BALL_CUP_MISS_MASTER", func_270(uParam2), 0, 0, 0);
...
int func_71(var uParam0, var uParam1)
{
	...
	if (SYSTEM::VDIST(vVar0, func_43(uParam0, func_294(uParam1))) > fVar1)
	{
		return 0;
	}
	return 1;
...
int func_76(var uParam0, var uParam1)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(func_270(uParam1)))
	{
		return 0;
	}
	vVar0 = { ENTITY::GET_ENTITY_COORDS(func_270(uParam1), false) };
	vVar1 = { func_43(uParam0, func_294(uParam1)) };
...
{
	AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "GOLF_BALL_IN_WATER_MASTER", func_270(uParam0), 0, 0, 0);
	return;
	GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_golf_landing_water", ENTITY::GET_ENTITY_COORDS(func_270(uParam0), true), 0f, 0f, func_239(ENTITY::GET_ENTITY_COORDS(func_270(uParam0), true), func_240(uParam0)), 1f, 0, 0, 0);
}
...
void func_83(var uParam0, var uParam1, var uParam2)
{
	...
	iVar0 = func_270(uParam2);
	iVar1 = func_80(uParam1, func_294(uParam2));
	...
	GRAPHICS::_0x7FDFADE676AA3CB0(ENTITY::GET_ENTITY_COORDS(iVar0, true), ENTITY::GET_ENTITY_COORDS(iVar0, true) + func_64(vVar9), 0, 0, 0, 255);
	if (func_78(uParam0, uParam1, uParam2))
	{
		return;
	}
	if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iVar0))
	{
		...
		if (!func_138(uParam0, 64))
		{
			if (fVar11 != 0f && SYSTEM::VMAG2(vVar2) > 9.5f)
			{
				...
				vVar16 = { FtoV(func_63(vLocal_311, vVar15)) * vVar15 };
	...
	if (!func_139(uParam2, 2))
	{
		...
		if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iVar0) && func_86(&(uParam2->f_159), 0.2f))
		{
			...
			func_53(uParam2, SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iVar0, true), func_240(uParam2)));
			func_47(uParam2, 2);
			func_152(&(uParam2->f_159));
			func_84(uParam2);
		}
	...
	{
		func_70(iVar0, ENTITY::GET_ENTITY_COORDS(iVar0, true), func_43(uParam1, func_294(uParam2)));
	}
...
void func_84(var uParam0)
{
	...
	sVar0 = "";
	switch (ENTITY::GET_LAST_MATERIAL_HIT_BY_ENTITY(func_270(uParam0)))
	{
		case -461750719:
		case 930824497:
	...
	if (!func_85(sVar0))
	{
		GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD(sVar0, ENTITY::GET_ENTITY_COORDS(func_270(uParam0), true), 0f, 0f, func_239(ENTITY::GET_ENTITY_COORDS(func_270(uParam0), true), func_240(uParam0)), 1f, 0, 0, 0);
	}
}
...
void func_94(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_85(sVar0))
	{
		if (bParam1)
		{
			AUDIO::PLAY_SOUND_FROM_COORD(-1, sVar0, ENTITY::GET_ENTITY_COORDS(func_270(uParam0), true), 0, 0, 0, 0);
		}
		else
		{
			AUDIO::PLAY_SOUND_FROM_ENTITY(-1, sVar0, func_270(uParam0), 0, 0, 0);
		}
	}
}
...
int func_100(var uParam0, var uParam1, bool bParam2)
{
	...
	sVar1 = func_103(uParam0, &(uParam1->f_15[func_256(uParam1) /*34*/]), 1, 1);
	...
	if (bParam2)
	{
		...
		{
			BRAIN::TASK_PLAY_ANIM(iVar0, func_101(0), &cVar2, 8f, -2f, -1, 0, 0, 0, 0, 0);
		}
		return 1;
	}
	return 0;
...
int func_108(var uParam0, var uParam1, var uParam2)
{
	...
	func_196(func_270(uParam2), 0);
	ENTITY::SET_ENTITY_RECORDS_COLLISIONS(func_270(uParam2), 1);
	OBJECT::SET_OBJECT_PHYSICS_PARAMS(func_270(uParam2), -1f, -1f, 0f, 0f, 0.01f, -1f, -1f, -1f, -1f, -1f, -1082130432);
	bVar0 = func_60(uParam2) == 4;
	fVar1 = func_124(&(uParam2->f_15[func_256(uParam2) /*34*/]), uParam0, &(uParam2->f_1), bVar0, !bLocal_302, 0);
	fVar2 = 1f;
	...
	switch (uParam2->f_1)
	{
		case 4:
			...
			{
				fVar4 = (func_239(func_68(uParam2), func_240(uParam2)) + 90f);
			}
			if (func_31(uParam2) == 0 && func_122(uParam2) != func_276(uParam0, 16))
			{
	...
	ENTITY::SET_ENTITY_VELOCITY(func_270(uParam2), vVar6);
	ENTITY::SET_ENTITY_MAX_SPEED(func_270(uParam2), 150f);
	func_107(uParam0, 32);
...
void func_109(var uParam0, var uParam1, var uParam2)
{
	...
	switch (func_31(uParam0))
	{
		...
		case 5:
			if (uParam0->f_1 != 6 && func_234(uParam1, func_294(uParam0)) > 3)
			{
	...
	if (!func_85(sVar0))
	{
		GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD(sVar0, func_240(uParam0), 0f, 0f, func_98(uParam0), 1f, 0, 0, 0);
	}
}
...
void func_110(var uParam0, bool bParam1)
{
	...
	return;
	if (!func_186(uParam0) && ENTITY::DOES_ENTITY_EXIST(func_270(uParam0)))
	{
		iVar0 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_golf_ball_trail", func_270(uParam0), 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
		if (bParam1)
		{
...
void func_111(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!func_85(sVar0))
	{
		if (iParam2 || !ENTITY::DOES_ENTITY_EXIST(func_270(uParam1)))
		{
			AUDIO::PLAY_SOUND_FROM_COORD(-1, sVar0, func_240(uParam1), 0, 0, 0, 0);
		}
		else
		{
			AUDIO::PLAY_SOUND_FROM_ENTITY(-1, sVar0, func_270(uParam1), 0, 0, 0);
		}
	}
}
...
void func_132()
{
	...
	{
		if (func_136(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_135(PLAYER::PLAYER_PED_ID());
			if (func_134(iVar0) && (!func_133(14) || Global_104171))
			{
				if (Global_105220.f_2354.f_539.f_4301 != iVar0 && func_134(Global_105220.f_2354.f_539.f_4301))
				{
...
int func_157(var uParam0, var uParam1)
{
	...
	vVar1 = { ENTITY::GET_ENTITY_COORDS(func_270(uParam1), false) };
	if (func_31(uParam1) != 3 && SYSTEM::VDIST2(vVar1, func_43(uParam0, func_294(uParam1))) > (0.7f * 0.7f))
	{
		return 0;
	}
	if (SYSTEM::VDIST2(vVar1, func_43(uParam0, func_294(uParam1))) > (55f * 55f))
	{
		return 0;
	}
	return 1;
	...
	if (!PED::IS_PED_INJURED(iVar0))
	{
		...
		switch (func_151(uParam1))
		{
			...
			case 1:
				...
				{
					BRAIN::TASK_PLAY_ANIM(iVar0, func_101(0), &cVar10, 8f, -8f, -1, 2, 0, 0, 0, 0);
					if (bLocal_0)
					{
					}
				}
			...
			case 3:
				...
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iVar0, func_101(0), &cVar10, 3))
				{
					...
					if (fVar4 < fVar2)
					{
						BRAIN::TASK_PLAY_ANIM(iVar0, func_101(0), &cVar9, 4f, -8f, -1, 10, 0, 0, 0, 0);
						func_162(uParam1, 0);
					}
					else
					{
			...
			case 4:
				...
				if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iVar0, func_101(0), &cVar11, 3))
				{
					...
					{
						BRAIN::TASK_PLAY_ANIM(iVar0, func_101(0), &cVar11, 8f, -8f, -1, 2, 0, 0, 0, 0);
						if (bLocal_0)
						{
						}
					}
...
void func_179(var uParam0, int iParam1, vector3 vParam2, var uParam3, bool bParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(func_36(uParam0, iVar1)) && iParam5)
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(func_36(uParam0, iVar1), 0))
		{
			...
			{
				bVar5 = func_182(vParam2 + vVar3, func_43(uParam3, func_294(uParam0)), &vVar2, &fVar4);
			}
			else
			{
				bVar5 = func_180(vParam2 + vVar3, func_43(uParam3, func_294(uParam0)), &vVar2, &fVar4, 0f, 0f, 0f, 0f, 0f, 0f, 0);
			}
...
{
	if (func_235() || func_186(uParam0))
	{
		if (BRAIN::GET_SCRIPT_TASK_STATUS(func_272(uParam0), 242628503) == 1)
		{
			if (BRAIN::GET_SEQUENCE_PROGRESS(func_272(uParam0)) == 2)
			{
				return 1;
			}
		}
	}
	else if (BRAIN::GET_SCRIPT_TASK_STATUS(func_272(uParam0), 242628503) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(func_272(uParam0), 242628503) != 0)
	{
		return 1;
	}
	return 0;
...
Vector3 func_189(var uParam0, var uParam1)
{
	...
	{
		vVar0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_240(uParam0), (func_98(uParam0) + fVar1), (((-func_126(uParam1, func_122(uParam0)) * func_190(func_118(uParam0))) * func_125(func_32(&(uParam0->f_15[func_256(uParam0) /*34*/])))) * ((func_148(uParam0, 1) * fVar2) / 100f)), 0f, 0f) };
	}
	else if (func_31(uParam0) != 3)
	{
		vVar0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_240(uParam0), func_98(uParam0), (((-func_126(uParam1, func_122(uParam0)) * func_190(func_118(uParam0))) * func_125(func_32(&(uParam0->f_15[func_256(uParam0) /*34*/])))) * (func_148(uParam0, 1) / 100f)), 0f, 0f) };
	}
	else
	{
		vVar0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_240(uParam0), func_98(uParam0), Vector(-uParam0->f_1.f_1, -uParam0->f_1.f_1, -uParam0->f_1.f_1) * Vector(0f, 0f, (func_148(uParam0, 1) / 100f))) };
	}
...
void func_197(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (bParam5)
	{
		vVar0 = { func_241(uParam0, func_294(uParam1)) };
	}
	else
	{
		vVar0 = { func_43(uParam0, func_294(uParam1)) };
	}
	iVar1 = (func_239(vVar0, func_240(uParam1)) + 90f);
	func_198(&(uParam1->f_15[func_256(uParam1) /*34*/]), uParam2, iVar1, 0, iParam3, iParam4, iParam6, bParam7);
}
...
void func_198(var uParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, var uParam6, bool bParam7)
{
	...
	{
		BRAIN::TASK_STAND_STILL(func_171(uParam0), -1);
	}
	else
	{
		iParam5 = 1;
	...
	vVar1 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(func_170(uParam0), func_99(uParam0), func_220(iVar0)) };
	vVar2 = { ENTITY::GET_ENTITY_COORDS(func_171(uParam0), true) };
	if (bParam3)
	{
	...
	{
		BRAIN::CLEAR_PED_TASKS(func_171(uParam0));
		BRAIN::OPEN_SEQUENCE_TASK(&(uParam0->f_21));
		if (func_235() || func_173(uParam0))
		{
		...
		BRAIN::TASK_PERFORM_SEQUENCE(func_171(uParam0), uParam0->f_21);
...
int func_210(vector3 vParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, float fParam10)
{
	...
	if (!func_216())
	{
		if (func_215(PLAYER::PLAYER_ID(), 1, 0))
		{
			if (((bParam7 && func_214(PLAYER::PLAYER_ID(), 1, 0)) && STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) && Global_2423644[PLAYER::PLAYER_ID() /*406*/].f_218 == 1)
			{
			}
			else
			{
	...
	if (((!vParam0.x == Global_2436641.f_1230 || !vParam0.y == Global_2436641.f_1230.f_1) || !vParam0.z == Global_2436641.f_1230.f_2) || !fParam1 == Global_2436641.f_1233)
	{
		...
		{
			if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2436641.f_1234) < func_213(0))
			{
				return 0;
			}
			PLAYER::STOP_PLAYER_TELEPORT();
	...
	if (Global_2436641.f_1228)
	{
		...
		if (Global_2436641.f_1235 > -1)
		{
			...
			if (func_211(&(Global_2436641.f_1235), vParam0, fParam1, iVar0))
			{
				func_217(bParam4, bParam7);
				return 1;
			}
...
void func_222(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	fVar0 = func_233(uParam2);
	fVar3 = -9999f;
	fVar4 = -1f;
	if (func_157(uParam1, uParam2) || func_235())
	{
		if (func_232(uParam1, uParam2, 0))
		{
			func_230(uParam2, 7);
		}
		else if (fVar0 < 5f)
		...
		func_274(uParam2, func_276(uParam0, 19));
	...
	{
		func_230(uParam2, 0);
		func_274(uParam2, func_276(uParam0, 16));
		if (func_122(uParam2) != -1)
		{
			return;
		}
	}
	else if (func_228(uParam1, uParam2, bParam3))
	{
		func_230(uParam2, 3);
	}
	else
	...
	func_225(uParam1, uParam2, &iVar5, &iVar6, 0);
	fVar4 = func_195(uParam0, func_276(uParam0, iVar6));
	if (func_118(uParam2) == 3 || func_118(uParam2) == 2)
	{
		fVar4 = (fVar4 * func_224());
	}
	if (fVar4 > fVar0)
	{
		func_274(uParam2, func_276(uParam0, iVar6));
		return;
	}
	iVar2 = -1;
	iVar1 = 0;
	while (iVar1 < *uParam0)
	{
		...
		if (iVar7 >= iVar5 && iVar7 <= iVar6)
		{
			...
			if (func_223(uParam1, uParam2))
			{
				if (func_294(uParam2) == 2)
				{
					fVar4 = (fVar4 * 1.1f);
				}
				else if (func_294(uParam2) == 3)
				{
					fVar4 = (fVar4 * 2.25f);
				}
			}
	...
	if (iVar2 != -1)
	{
		func_274(uParam2, iVar2);
		return;
	}
	func_274(uParam2, func_276(uParam0, iVar5));
}
...
void func_225(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	if (func_157(uParam0, uParam1))
	{
		*uParam2 = 14;
	...
	else if (func_228(uParam0, uParam1, 1))
	{
		*uParam2 = 7;
		if (bParam4)
		{
	...
	else if (func_223(uParam0, uParam1))
	{
		*uParam2 = 1;
		*uParam3 = 17;
	}
...
int func_228(var uParam0, var uParam1, bool bParam2)
{
	int iVar0;
	vector3 vVar1;
...
{
	func_231(&(uParam0->f_15[uParam0->f_157 /*34*/]), iParam1);
}
...
int func_232(var uParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_270(uParam1)))
		{
			vVar0 = { ENTITY::GET_ENTITY_COORDS(func_270(uParam1), true) };
		}
	}
	if (SYSTEM::VDIST2(vVar0, func_43(uParam0, func_294(uParam1))) > (0.7f * 0.7f))
	{
		return 0;
	}
	return 1;
...
{
	func_237(&(uParam0->f_15[uParam0->f_157 /*34*/]), uParam1);
}
...
int func_238(vector3 vParam0, float fParam1)
{
	int iVar0;
...
float func_239(struct<2> Param0, float fParam1, struct<2> Param2, var uParam3)
{
...
Vector3 func_241(var uParam0, int iParam1)
{
	if (iParam1 < 0 || iParam1 >= uParam0->f_28)
	{
		return 0f, 0f, 0f;
...
int func_242(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
...
void func_244(var uParam0, var uParam1)
{
	...
	while (iVar0 < func_278(uParam1))
	{
		func_245(uParam0, uParam1, iVar0);
		iVar0++;
	}
}
...
void func_245(var uParam0, var uParam1, int iParam2)
{
	...
	if (func_223(uParam0, uParam1))
	{
		vVar0 = { func_38(uParam0, func_294(uParam1), iParam2) };
	}
	...
	if (func_27(uParam1, iParam2, 1048576))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(func_36(uParam1, 0)))
		{
			...
			{
				if (func_180(func_184(uParam1, 0), func_43(uParam0, func_294(uParam1)), &vVar2, &fVar3, 0f, 0f, 0f, 0f, 0f, 0f, 0))
				{
	...
	{
		if (func_27(uParam1, iParam2, 4194304) && ENTITY::DOES_ENTITY_EXIST(func_270(uParam1)))
		{
			vVar0 = { ENTITY::GET_ENTITY_COORDS(func_270(uParam1), true) };
		}
		else if ((func_155(uParam1, iParam2) == 10 || func_155(uParam1, iParam2) == 8) || func_32(&(uParam1->f_15[iParam2 /*34*/])) == 3)
		{
			if (((func_32(&(uParam1->f_15[iParam2 /*34*/])) == 3 || func_155(uParam1, iParam2) == 10) || func_155(uParam1, iParam2) == 8) || (func_32(&(uParam1->f_15[iParam2 /*34*/])) == 8 && func_249(uParam1, uParam0) != iParam2))
			{
				vVar0 = { func_44(uParam0, func_294(uParam1), iParam2) };
				func_277(uParam1, iParam2, 67108864);
			}
			else
			{
				vVar0 = { func_170(&(uParam1->f_15[iParam2 /*34*/])) };
		...
		if (SYSTEM::VDIST2(vVar0, ENTITY::GET_ENTITY_COORDS(iVar1, true)) > 1.5f)
		{
			...
			BRAIN::OPEN_SEQUENCE_TASK(&(uParam1->f_15[iParam2 /*34*/].f_21));
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar0, 1f, -1, 0.25f, 4, func_248(vVar0, func_43(uParam0, func_294(uParam1))));
			BRAIN::CLOSE_SEQUENCE_TASK(uParam1->f_15[iParam2 /*34*/].f_21);
			BRAIN::TASK_PERFORM_SEQUENCE(iVar1, uParam1->f_15[iParam2 /*34*/].f_21);
			BRAIN::CLEAR_SEQUENCE_TASK(&(uParam1->f_15[iParam2 /*34*/].f_21));
		}
		if (func_247(uParam1, iParam2) != 4)
		{
			func_246(uParam1, 32);
		}
	}
...
float func_248(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3)
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param2 - Param0), (Param2.f_1 - Param0.f_1));
}
...
int func_249(var uParam0, var uParam1)
{
	...
	fVar0 = 0f;
	iVar1 = -1;
	if (((func_233(uParam0) < (0.7f * 0.7f) && func_31(uParam0) == 3) && func_29(uParam0) != 10) && func_250(uParam0, uParam1))
	{
		return func_256(uParam0);
	}
	iVar2 = 0;
	while (iVar2 < func_278(uParam0))
	{
		if (func_247(uParam0, iVar2) != 0)
		{
			if (func_155(uParam0, iVar2) != 10 && !func_27(uParam0, iVar2, 16777216))
			{
				vVar4 = { func_184(uParam0, iVar2) };
				vVar5 = { func_43(uParam1, func_294(uParam0)) };
				vVar4.z = 0f;
				vVar5.z = 0f;
...
int func_250(var uParam0, var uParam1)
{
	...
	while (iVar0 < func_278(uParam0))
	{
		if (((((func_32(&(uParam0->f_15[iVar0 /*34*/])) != 3 && func_32(&(uParam0->f_15[iVar0 /*34*/])) != 8) && func_155(uParam0, iVar0) != 10) && !func_27(uParam0, iVar0, 16384)) && !func_251(uParam0, uParam1, iVar0, 0)) && !func_27(uParam0, iVar0, 16777216))
		{
			return 0;
		}
		iVar0++;
...
bool func_251(var uParam0, var uParam1, int iParam2, int iParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = func_256(uParam0);
	}
	return func_252(uParam0, iParam2) >= (func_234(uParam1, func_294(uParam0)) + (5 + iParam3));
}
...
void func_253(var uParam0, var uParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(func_146(uParam0)))
	{
		...
		ENTITY::ATTACH_ENTITY_TO_ENTITY(func_146(uParam0), func_272(uParam0), PED::GET_PED_BONE_INDEX(func_272(uParam0), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	}
}
...
void func_255(var uParam0, int iParam1, var uParam2, int iParam3, var uParam4)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	if (BRAIN::GET_SCRIPT_TASK_STATUS(func_171(uParam0), -1794415470) == 1)
	{
		return;
	}
	...
	if (SYSTEM::VDIST2(vVar2, vVar1) > (150f * 150f))
	{
		...
		if (func_3(uParam0, 262144) && iParam3 == func_256(uParam2))
		{
...
int func_258(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)
{
	int iVar0;
	bool bVar1;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0) && !ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		...
		{
			if (func_264(iVar0, iParam0, uParam2, bParam5))
			{
				*uParam3 = 4;
				return 1;
			}
		...
		{
			if (func_263(iVar0, iParam0, uParam2))
			{
				*uParam3 = 8;
				return 1;
			}
		...
		if (bParam4)
		{
			if (func_259(iParam0, iParam1, 1, bParam6, bVar1, 1))
			{
				*uParam3 = 32;
				return 1;
			}
		...
		{
			if (func_259(iParam0, iParam1, 0, bParam6, bVar1, bParam8))
			{
				*uParam3 = 16;
				return 1;
			}
...
int func_259(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	...
	if (func_262(PLAYER::PLAYER_PED_ID(), iParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (PED::IS_PED_RAGDOLL(iParam0) && func_260(iParam0, 1) < 1.5f)
		{
			return 1;
		}
...
float func_260(int iParam0, bool bParam1)
{
	return func_261(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), iParam0, bParam1);
}
...
int func_264(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar1;
	...
	if (WEAPON::IS_PED_ARMED(iParam0, 2))
	{
		...
		else
		{
			...
			if (PED::IS_PED_PLANTING_BOMB(iParam0) || func_265(iVar1))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(iParam1, ENTITY::GET_ENTITY_COORDS(iParam0, true), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), false, true, 0))
				{
					if (PED::IS_PED_FACING_PED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam1), iParam0, 120f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam1, iParam0, 17))
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iParam0, -1, 0) != 0)
			{
				if (WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iVar0, 1))
				{
					...
					{
						if (func_261(PLAYER::PLAYER_PED_ID(), iParam0, 1) < 40f)
						{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
			{
				...
				{
					if (func_260(iParam0, 1) < uParam1->f_2)
					{
						if (uParam1->f_1 == 0)
						{
...
{
	func_269(&(uParam0->f_15[uParam0->f_157 /*34*/]));
}
...
{
	func_275(&(uParam0->f_15[uParam0->f_157 /*34*/]), iParam1);
}
...
void func_279(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4)
{
	int iVar0;
	
	func_288(uParam0, uParam1, iParam3, iParam2);
	iVar0 = 0;
	while (iVar0 < func_278(uParam1))
	{
	...
	if (bParam4)
	{
		func_280(uParam0, uParam1, iParam3, iParam2);
	}
}
...
void func_280(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	while (iVar2 < (iParam3 + 1 / 2))
	{
		if (!ENTITY::DOES_ENTITY_EXIST(func_36(uParam1, iVar2)))
		{
			...
			if (func_182(func_293(uParam0, iParam2) + vVar3, func_43(uParam0, func_294(uParam1)), &vVar0, &fVar1))
			{
				func_281(uParam1, VEHICLE::CREATE_VEHICLE(joaat("caddy"), vVar0, fVar1, true, true, false), iVar2);
...
void func_282(var uParam0, var uParam1, int iParam2)
{
	...
	iVar2 = 3;
	func_286(uParam1, iParam2, 4);
	if (iParam2 == 0)
	{
		vVar0 = { func_293(uParam0, func_294(uParam1)) };
	}
	else
	{
		vVar0 = { func_38(uParam0, func_294(uParam1), iParam2) };
	...
	{
		iVar1 = func_285(&iVar2, 1065437102);
		func_283(uParam1, iParam2, PED::CREATE_PED(iVar2, iVar1, vVar0, 0f, 1, true));
		ENTITY::SET_ENTITY_HEADING(func_183(uParam1, iParam2), func_239(vVar0, func_293(uParam0, func_294(uParam1))));
...
void func_283(var uParam0, int iParam1, int iParam2)
{
	...
	func_284(&(uParam0->f_15[iParam1 /*34*/]), iParam2);
}
...
void func_288(var uParam0, var uParam1, var uParam2, var uParam3)
{
	func_21(uParam1, uParam2);
	func_291(uParam1, uParam3);
	func_290(uParam1, 0, 0);
	func_290(uParam1, 2, 1);
	func_289(uParam1, 0);
...
int func_297(var uParam0, int iParam1)
{
	...
	while (iVar0 < iVar1)
	{
		if ((*uParam0)[iVar0] == 0)
		{
			func_298(uParam0[iVar0], iParam1);
			uParam0->f_15++;
			return 1;
		}
		iVar0++;
...
{
	func_302(uParam0, joaat("a_m_y_golfer_01"));
	func_302(uParam0, joaat("prop_golf_putter_01"));
	func_302(uParam0, joaat("prop_golf_ball"));
	func_302(uParam0, joaat("prop_golf_pitcher_01"));
	func_301(uParam0);
}
...
void func_306(var uParam0)
{
	...
	{
		(*uParam0)[iVar0 /*3*/] = (SYSTEM::VDIST(func_293(uParam0, iVar0), func_241(uParam0, iVar0)) + SYSTEM::VDIST(func_241(uParam0, iVar0), func_43(uParam0, iVar0)));
...
void func_308(int iParam0)
{
	...
	{
		iVar1 = 0;
		while (iVar1 < func_278(iParam0[iVar0 /*170*/]))
		{
			func_310(iParam0[iVar0 /*170*/], iVar1);
			func_204(&((iParam0[iVar0 /*170*/])->f_15[iVar1 /*34*/]));
			func_309(&((iParam0[iVar0 /*170*/])->f_15[iVar1 /*34*/]));
...
void func_310(var uParam0, int iParam1)
{
	...
	func_269(&(uParam0->f_15[iParam1 /*34*/]));
}
