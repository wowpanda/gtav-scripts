	...
	switch (func_254(uParam2))
	{
		...
		case 2:
			...
			if (func_26(uParam2, -1, 0))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(func_270(uParam2)))
				{
					func_5(uParam2, ENTITY::GET_ENTITY_COORDS(func_270(uParam2), 1));
				}
			}
	...
	switch (func_29(uParam2))
	{
		...
		case 3:
			if (func_185(uParam2) || func_3(&(uParam2->f_15[func_256(uParam2) /*34*/]), 1048576))
			{
				...
				{
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(func_272(uParam2), 1), func_240(uParam2)) > 9f)
					{
						BRAIN::CLEAR_PED_TASKS(func_272(uParam2));
						func_24(uParam2, 1);
						return;
		...
		case 6:
			func_100(uParam0, uParam2, 1);
			if ((func_66(uParam2) || func_65(uParam2)) || func_62(ENTITY::GET_ENTITY_COORDS(func_270(uParam2), 1)))
			{
				func_61(uParam2);
			}
			else
...
void func_52(var uParam0, var uParam1)
{
	if (!bLocal_285)
	{
		...
		func_5(uParam1, ENTITY::GET_ENTITY_COORDS(func_270(uParam1), 1));
...
int func_76(var uParam0, var uParam1)
{
	...
	vVar0 = { ENTITY::GET_ENTITY_COORDS(func_270(uParam1), 0) };
...
void func_79(var uParam0)
{
	...
	return;
	GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_golf_landing_water", ENTITY::GET_ENTITY_COORDS(func_270(uParam0), 1), 0f, 0f, func_239(ENTITY::GET_ENTITY_COORDS(func_270(uParam0), 1), func_240(uParam0)), 1f, 0, 0, 0);
}
...
void func_83(var uParam0, var uParam1, var uParam2)
{
	...
	GRAPHICS::_0x7FDFADE676AA3CB0(ENTITY::GET_ENTITY_COORDS(iVar0, 1), ENTITY::GET_ENTITY_COORDS(iVar0, 1) + func_64(vVar9), 0, 0, 0, 255);
	if (func_78(uParam0, uParam1, uParam2))
	{
		return;
	}
	if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iVar0))
	{
		...
		if (!func_138(uParam0, 64))
		{
			if (fVar11 != 0f && SYSTEM::VMAG2(vVar2) > 9.5f)
			{
				...
				vVar16 = { FtoV(func_63(vLocal_295, vVar15)) * vVar15 };
	...
	if (!func_139(uParam2, 2))
	{
		...
		if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iVar0) && func_86(&(uParam2->f_159), 0.2f))
		{
			...
			func_53(uParam2, SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iVar0, 1), func_240(uParam2)));
			func_47(uParam2, 2);
			func_152(&(uParam2->f_159));
			func_84(uParam2);
		}
	...
	{
		func_70(iVar0, ENTITY::GET_ENTITY_COORDS(iVar0, 1), func_43(uParam1, func_294(uParam2)));
	}
...
void func_84(var uParam0)
{
	...
	if (!func_85(sVar0))
	{
		GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD(sVar0, ENTITY::GET_ENTITY_COORDS(func_270(uParam0), 1), 0f, 0f, func_239(ENTITY::GET_ENTITY_COORDS(func_270(uParam0), 1), func_240(uParam0)), 1f, 0, 0, 0);
	}
}
...
void func_94(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_85(sVar0))
	{
		if (bParam1)
		{
			AUDIO::PLAY_SOUND_FROM_COORD(-1, sVar0, ENTITY::GET_ENTITY_COORDS(func_270(uParam0), 1), 0, 0, 0, 0);
		}
		else
		{
...
int func_108(var uParam0, var uParam1, var uParam2)
{
	...
	fVar1 = func_124(&(uParam2->f_15[func_256(uParam2) /*34*/]), uParam0, &(uParam2->f_1), bVar0, !bLocal_286, 0);
	fVar2 = 1f;
...
void func_132()
{
	...
	{
		if (func_136(Global_104555.f_2353.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_135(PLAYER::PLAYER_PED_ID());
			if (func_134(iVar0) && (!func_133(14) || Global_103506))
			{
				if (Global_104555.f_2353.f_539.f_4301 != iVar0 && func_134(Global_104555.f_2353.f_539.f_4301))
				{
...
int func_157(var uParam0, var uParam1)
{
	...
	vVar1 = { ENTITY::GET_ENTITY_COORDS(func_270(uParam1), 0) };
...
int func_210(vector3 vParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, float fParam10)
{
	...
	if (!func_216())
	{
		...
		{
			if (((bParam7 && func_214(PLAYER::PLAYER_ID(), 1, 0)) && STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) && Global_2422736[PLAYER::PLAYER_ID() /*420*/].f_237 == 1)
			{
			}
			else
			{
	...
	if (((!vParam0.x == Global_2436181.f_1119 || !vParam0.y == Global_2436181.f_1119.f_1) || !vParam0.z == Global_2436181.f_1119.f_2) || !fParam1 == Global_2436181.f_1122)
	{
		...
		{
			if (NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), Global_2436181.f_1123) < func_213(0))
			{
				return 0;
			}
			PLAYER::STOP_PLAYER_TELEPORT();
	...
	if (Global_2436181.f_1117)
	{
		...
		if (Global_2436181.f_1124 > -1)
		{
			...
			if (func_211(&(Global_2436181.f_1124), vParam0, fParam1, iVar0))
			{
				func_217(bParam4, bParam7);
				return 1;
			}
...
int func_232(var uParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_270(uParam1)))
		{
			vVar0 = { ENTITY::GET_ENTITY_COORDS(func_270(uParam1), 1) };
		}
	}
...
void func_245(var uParam0, var uParam1, int iParam2)
{
	...
	else if (BRAIN::GET_SCRIPT_TASK_STATUS(iVar1, 242628503) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iVar1, 242628503) != 0)
	{
		...
		if (SYSTEM::VDIST2(vVar0, ENTITY::GET_ENTITY_COORDS(iVar1, 1)) > 1.5f)
		{
