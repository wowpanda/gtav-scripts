...
void __EntryFunction__()
{
	...
	if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("forsalesigns")) > 1)
	{
...
void func_1()
{
	...
	while (iVar0 < 15)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_210[iVar0 /*11*/]))
		{
			...
			{
				MISC::SET_BIT(&(Global_104555.f_10019.f_108), iVar0);
				func_21(iVar0);
		...
		else if (!MISC::IS_BIT_SET(Global_104555.f_10019.f_108, iVar0))
		{
...
int func_2(int iParam0)
{
	...
	else
	{
		...
		{
			if (!MISC::IS_BIT_SET(Global_104555.f_10019.f_108, func_3(func_4(iParam0), iVar0)))
			{
				return 0;
			}
			iVar0++;
...
int func_5(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (MISC::IS_BIT_SET(Global_104555.f_10019.f_108, func_3(func_4(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
void func_16(int iParam0, var uParam1)
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(*iParam0, 1), true) >= 110f && !ENTITY::IS_ENTITY_ON_SCREEN(*iParam0))
		{
			func_17(iParam0);
			*uParam1 = 0;
		}
...
void func_62()
{
	...
	{
		func_64(13, SYSTEM::FLOOR(Global_104555.f_10164.f_3853));
	}
