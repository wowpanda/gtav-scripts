...
void __EntryFunction__()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("forsalesigns")) > 1)
	{
...
void func_1()
{
	...
	if (iLocal_42)
	{
		...
		{
			if ((((!func_45() && !IS_PED_FLEEING(uLocal_44)) && !IS_PED_RAGDOLL(uLocal_44)) && !IS_PED_PRONE(uLocal_44)) && !IS_PED_INJURED(uLocal_44))
			{
				if (func_44(uLocal_44, PLAYER_PED_ID(), 1) <= 3f)
				{
			...
			if (func_44(uLocal_44, PLAYER_PED_ID(), 1) > 150f)
			{
				func_26(&uLocal_44);
			}
		}
	...
	while (iVar0 < 15)
	{
		if (DOES_ENTITY_EXIST(Local_210[iVar0 /*11*/]))
		{
			if (HAS_OBJECT_BEEN_BROKEN(Local_210[iVar0 /*11*/], 0) || func_24(Local_210[iVar0 /*11*/]))
			{
				SET_BIT(&(Global_106565.f_10043.f_108), iVar0);
				func_21(iVar0);
				SET_OBJECT_AS_NO_LONGER_NEEDED(&(Local_210[iVar0 /*11*/]));
				bLocal_39 = true;
				func_20(1, 0);
				func_18();
			}
		...
		else if (!IS_BIT_SET(Global_106565.f_10043.f_108, iVar0))
		{
...
int func_2(int iParam0)
{
	...
	else
	{
		...
		{
			if (!IS_BIT_SET(Global_106565.f_10043.f_108, func_3(func_4(iParam0), iVar0)))
			{
				return 0;
			}
			iVar0++;
...
int func_5(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (IS_BIT_SET(Global_106565.f_10043.f_108, func_3(func_4(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
	...
	if (bLocal_39)
	{
		switch (iLocal_40)
		{
			case 0:
				...
				{
					uLocal_41 = REQUEST_SCALEFORM_MOVIE("MIDSIZED_MESSAGE");
					if (HAS_SCALEFORM_MOVIE_LOADED(uLocal_41))
					{
						uVar0 = GET_SOUND_ID();
						PLAY_SOUND_FRONTEND(uVar0, "SIGN_DESTROYED", "HUD_AWARDS", 1);
						iLocal_40++;
					}
				}
				break;
			...
			case 1:
				BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_41, "SHOW_SHARD_MIDSIZED_MESSAGE");
			...
			case 2:
				if (TIMERB() > 7000)
				{
					BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_41, "SHARD_ANIM_OUT");
				...
				else if (!func_12())
				{
					if (HAS_SCALEFORM_MOVIE_LOADED(uLocal_41))
					{
						DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_41, 100, 100, 100, 255, 0);
					}
				}
				break;
			...
			case 4:
				if (HAS_SCALEFORM_MOVIE_LOADED(uLocal_41))
				{
					SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_41);
				}
				bLocal_376 = false;
				bLocal_39 = false;
				iLocal_40 = 0;
...
void func_13(var uParam0, int iParam1, bool bParam2, float fParam3)
{
	...
	{
		if (func_15(PLAYER_PED_ID(), uParam0->f_3, fParam3) && !DOES_ENTITY_EXIST(*uParam0))
		{
			...
			*uParam0 = CREATE_OBJECT(iParam1, uParam0->f_3, 1, 1, 0);
			uParam0->f_10 = 1;
...
bool func_15(var uParam0, vector3 vParam1, float fParam4)
{
...
void func_16(var uParam0, var uParam1)
{
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(*uParam0, 1), 1) >= 110f && !IS_ENTITY_ON_SCREEN(*uParam0))
		{
			func_17(uParam0);
			*uParam1 = 0;
		}
...
int func_24(var uParam0)
{
	...
	vVar0 = { GET_ENTITY_ROTATION(uParam0, 0) };
...
void func_35()
{
	...
	{
		if (func_38(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
...
float func_44(var uParam0, var uParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_48()
{
	...
	while (iVar1 < iVar0)
	{
		...
		{
			if (GET_ENTITY_MODEL(uVar2[iVar1]) == func_50(58))
			{
				uLocal_44 = uVar2[iVar1];
				if (!IS_ENTITY_A_MISSION_ENTITY(uLocal_44))
				{
					SET_ENTITY_AS_MISSION_ENTITY(uLocal_44, 1, 0);
				}
				SET_PED_MONEY(uLocal_44, 0);
				SET_PED_CAN_BE_TARGETTED(uLocal_44, 0);
				SET_PED_NAME_DEBUG(uLocal_44, "POSTJOSH");
				SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_44, 1862763509);
				func_49(&uLocal_45, 5, uLocal_44, "JOSH", 1, 1);
				return 1;
			}
		}
		iVar1++;
...
void func_62()
{
	...
	{
		func_64(13, FLOOR(Global_106565.f_10188.f_3853));
	}
	if (!DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_71590)
		{
			if (func_63() == 2 == 0 && !NETWORK_IS_GAME_IN_PROGRESS())
			{
