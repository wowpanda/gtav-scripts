...
void func_1()
{
	...
	while (iVar0 < 15)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_210[iVar0 /*11*/]))
		{
			...
			{
				MISC::SET_BIT(&(Global_105220.f_10020.f_108), iVar0);
				func_21(iVar0);
		...
		else if (!MISC::IS_BIT_SET(Global_105220.f_10020.f_108, iVar0))
		{
...
int func_2(int iParam0)
{
	...
	else
	{
		...
		{
			if (!MISC::IS_BIT_SET(Global_105220.f_10020.f_108, func_3(func_4(iParam0), iVar0)))
			{
				return 0;
			}
			iVar0++;
...
int func_5(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (MISC::IS_BIT_SET(Global_105220.f_10020.f_108, func_3(func_4(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
void func_35()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_38(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_36(iVar0) && (!func_39(14) || Global_104171))
			{
...
void func_62()
{
	...
	{
		func_64(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
