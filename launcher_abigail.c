...
void __EntryFunction__()
{
	...
	iVar231[0] = 0;
	iVar231[1] = 1;
	if (!func_266(&iVar231, &Var0, vVar61, 1f))
	{
		func_265();
	...
	while (true)
	{
		...
		func_207(Var0);
		func_200(&iLocal_100, &(Var0.f_9), vVar61);
		switch (Var0)
		{
			case 0:
			...
			case 1:
				func_186(&Var0, vVar61, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
				break;
		}
		if (func_171(&Var0, 0))
		{
...
int func_186(var uParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_126(PLAYER_PED_ID()) && func_126(uParam0->f_28[0])) && !func_145()) && (GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_190(PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_189(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
...
{
	if (func_126(*uParam1) && func_126(PLAYER_PED_ID()))
	{
		switch (*iParam0)
		{
			case 0:
				...
				TASK_PLAY_ANIM(*uParam1, cLocal_99, "base", 1000f, -8f, -1, 1, 0, 0, 0, 0);
				*iParam0 = 1;
				break;
			...
			case 1:
				...
				{
					if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_92, vLocal_95, 8f, 0, 1, 0))
					{
						TASK_PLAY_ANIM(*uParam1, cLocal_99, "intro", 8f, -8f, -1, 2, 0, 0, 0, 0);
						*iParam0 = 3;
					}
					else if (func_199(PLAYER_PED_ID(), *uParam1, 1) < 15f)
					{
						*iParam0 = 4;
					}
				}
				if (IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_99, "outro", 3) && GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_99, "outro") > 0.99f)
				{
					TASK_PLAY_ANIM(*uParam1, cLocal_99, "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				break;
			
			case 3:
				if (IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_99, "intro", 3) && GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_99, "intro") > 0.99f)
				{
					*iParam0 = 4;
				}
				break;
			...
			case 4:
				if (func_192(&(iParam0->f_1), "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_92, vLocal_95, 8f, 0, 1, 0))
					{
						TASK_PLAY_ANIM(*uParam1, cLocal_99, "loop_talk", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
					*iParam0 = 5;
				}
				break;
			...
			case 5:
				if (!func_145())
				{
					if (IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_99, "loop_talk", 3))
					{
						if (GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_99, "loop_talk") > 0.99f)
						{
							iParam0->f_166 = (GET_GAME_TIMER() + GET_RANDOM_INT_IN_RANGE(7000, 10000));
							if (!IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_92, vLocal_95, 8f, 0, 1, 0))
							{
								TASK_PLAY_ANIM(*uParam1, cLocal_99, "outro", 8f, -8f, -1, 2, 0, 0, 0, 0);
								*iParam0 = 1;
							}
							else
							{
								TASK_PLAY_ANIM(*uParam1, cLocal_99, "loop_look", 8f, -8f, -1, 1, 0, 0, 0, 0);
								*iParam0 = 2;
							}
						}
					}
			...
			case 2:
				if (IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_99, "loop_look", 3) && GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_99, "loop_look") > 0.99f)
				{
					if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_92, vLocal_95, 8f, 0, 1, 0))
					{
						if (GET_GAME_TIMER() > iParam0->f_166)
...
float func_199(var uParam0, var uParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_247(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			REQUEST_ANIM_DICT(cLocal_99);
			func_254(&(uParam0->f_48), cLocal_99, "base", 0);
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_253(&iVar0) || !HAS_ANIM_DICT_LOADED(cLocal_99))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				...
				_0x2B6747FAA9DB9D6B(uParam0->f_35[0], 1);
			}
			if (bVar4)
			{
				iLocal_91 = 3;
...
void func_248(var uParam0, var uParam1, vector3 vParam2, float fParam5)
{
	func_249(uParam0);
...
int func_255(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!HAS_MODEL_LOADED(uVar0) || !HAS_ANIM_DICT_LOADED(cLocal_99))
			{
				return 0;
			}
			iLocal_91 = 2;
...
int func_267(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
