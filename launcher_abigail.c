	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_104307[Var0 /*10*/].f_9 != -1)
			{
				...
				func_283(&(Global_104307[Var0 /*10*/].f_9));
			}
		}
		func_266(&Var0, 1);
	}
...
int func_183(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_124(PLAYER::PLAYER_PED_ID()) && func_124(uParam0->f_28[0])) && !func_143()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam6) && func_187(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
{
	if (func_124(*uParam1) && func_124(PLAYER::PLAYER_PED_ID()))
	{
		switch (*iParam0)
		{
			case 0:
				...
				BRAIN::TASK_PLAY_ANIM(*uParam1, fLocal_55, "base", 1000f, -8f, -1, 1, 0, 0, 0, 0);
				*iParam0 = 1;
				break;
			...
			case 1:
				if (MISC::GET_GAME_TIMER() > iParam0->f_166)
				{
					...
					{
						BRAIN::TASK_PLAY_ANIM(*uParam1, fLocal_55, "intro", 8f, -8f, -1, 2, 0, 0, 0, 0);
						*iParam0 = 3;
					}
					else if (func_196(PLAYER::PLAYER_PED_ID(), *uParam1, 1) < 15f)
					{
						*iParam0 = 4;
					}
				}
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, fLocal_55, "outro", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, fLocal_55, "outro") > 0.99f)
				{
					BRAIN::TASK_PLAY_ANIM(*uParam1, fLocal_55, "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				break;
			
			case 3:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, fLocal_55, "intro", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, fLocal_55, "intro") > 0.99f)
				{
					*iParam0 = 4;
				}
				break;
			...
			case 4:
				if (func_189(&(iParam0->f_1), "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_52, vLocal_53, 8f, 0, true, 0))
					{
						BRAIN::TASK_PLAY_ANIM(*uParam1, fLocal_55, "loop_talk", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
					*iParam0 = 5;
				}
				break;
			...
			case 5:
				if (!func_143())
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, fLocal_55, "loop_talk", 3))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, fLocal_55, "loop_talk") > 0.99f)
						{
							iParam0->f_166 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(7000, 10000));
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_52, vLocal_53, 8f, 0, true, 0))
							{
								BRAIN::TASK_PLAY_ANIM(*uParam1, fLocal_55, "outro", 8f, -8f, -1, 2, 0, 0, 0, 0);
								*iParam0 = 1;
							}
							else
							{
								BRAIN::TASK_PLAY_ANIM(*uParam1, fLocal_55, "loop_look", 8f, -8f, -1, 1, 0, 0, 0, 0);
								*iParam0 = 2;
							}
						}
					}
			...
			case 2:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, fLocal_55, "loop_look", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, fLocal_55, "loop_look") > 0.99f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), vLocal_52, vLocal_53, 8f, 0, true, 0))
					{
						if (MISC::GET_GAME_TIMER() > iParam0->f_166)
...
int func_244(var uParam0)
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			STREAMING::REQUEST_ANIM_DICT(fLocal_55);
			func_251(&(uParam0->f_48), fLocal_55, "base", 0);
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_250(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(fLocal_55))
			{
				return 0;
			}
			iLocal_51 = 2;
...
void func_251(var uParam0, void fParam1, char* sParam2, int iParam3)
{
	*uParam0 = fParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_252(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!STREAMING::HAS_MODEL_LOADED(iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(fLocal_55))
			{
				return 0;
			}
			iLocal_51 = 2;
...
bool func_257(int iParam0, void fParam1)
{
...
int func_263(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	int iVar0;
...
int func_264(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
...
int func_265(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
