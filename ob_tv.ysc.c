...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iScriptParam_69))
		{
			if ((iLocal_41 != 4294967295 && (func_65() && !func_64())) && !func_63(iLocal_41))
			{
				func_67();
			}
				...
				if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
				{
					...
					switch (iLocal_29)
					{
						case 0:
							...
							{
								func_56();
								AUDIO::HINT_AMBIENT_AUDIO_BANK("SAFEHOUSE_MICHAEL_SIT_SOFA", 0, 4294967295);
								AUDIO::REGISTER_SCRIPT_WITH_AUDIO(0);
								Global_63AF[iLocal_41 /*11*/].f_2 = 0;
								Global_63AF[iLocal_41 /*11*/].f_6 = 1;
								Global_63AF[iLocal_41 /*11*/] = MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
								Global_63AF[iLocal_41 /*11*/].f_1 = 0;
								Global_63AF[iLocal_41 /*11*/].f_4 = 0;
								Global_63AF[iLocal_41 /*11*/].f_7 = 0;
								Global_63AF[iLocal_41 /*11*/].f_8 = 0;
								Global_63AF[iLocal_41 /*11*/].f_A = 0;
								fLocal_30 = -4f;
								func_54(&iLocal_26);
								func_52();
								func_51();
						...
						case 1:
							...
							{
								if (func_43() || Global_63AF[iLocal_41 /*11*/].f_5)
								{
									iLocal_29 = 2;
								}
							}
						...
						case 2:
							...
							if (!func_63(iLocal_41))
							{
								if ((Global_63AF[iLocal_41 /*11*/] == 3 || Global_63AF[iLocal_41 /*11*/] == 2) || Global_63AF[iLocal_41 /*11*/] == 4294967295)
								{
									Global_63AF[iLocal_41 /*11*/] = MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
								}
								GRAPHICS::SET_TV_CHANNEL(Global_63AF[iLocal_41 /*11*/]);
								GRAPHICS::SET_TV_VOLUME(fLocal_30);
							}
							else
							{
								iLocal_42 = Global_63AF[iLocal_41 /*11*/];
								iLocal_43 = Global_63AF[iLocal_41 /*11*/].f_1;
								GRAPHICS::_LOAD_TV_CHANNEL_SEQUENCE(iLocal_42, func_40(iLocal_43), Global_63AF[iLocal_41 /*11*/].f_9);
								GRAPHICS::SET_TV_CHANNEL(iLocal_42);
								if (Global_63AF[iLocal_41 /*11*/].f_7)
								{
									Global_63AF[iLocal_41 /*11*/].f_5 = 0;
									Global_63AF[iLocal_41 /*11*/].f_7 = 0;
								}
							}
							Global_63AF[iLocal_41 /*11*/].f_2 = 1;
							func_39(133, 1);
							func_39(131, 1);
							func_39(132, 1);
							iLocal_29 = 3;
						...
						case 3:
							if (Global_63AF[iLocal_41 /*11*/].f_4)
							{
								iLocal_29 = 6;
							}
							if (Global_63AF[iLocal_41 /*11*/].f_7 && func_63(iLocal_41))
							{
								Global_63AF[iLocal_41 /*11*/].f_7 = 0;
								iLocal_29 = 6;
							}
							...
							{
								func_34();
								if (GRAPHICS::GET_TV_CHANNEL() == 4294967295)
								{
									GRAPHICS::SET_TV_CHANNEL(Global_63AF[iLocal_41 /*11*/]);
								}
								if (func_15())
...
void func_1()//Position - 0x4E5
{
	if (iLocal_41 != 4294967295)
	{
		Global_63AF[iLocal_41 /*11*/] = GRAPHICS::GET_TV_CHANNEL();
	}
...
void func_4()//Position - 0x642
{
	if (iLocal_65)
	{
		...
		if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			...
			BRAIN::TASK_LOOK_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_31, 1, 0, 2);
...
void func_5(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x70C
{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_10(CAM::_0xDC9DA9E8789F5246())) && !func_7(CAM::_0xDC9DA9E8789F5246(), 0)) && !func_6()) && !bParam4)
			{
				ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_10(CAM::_0xDC9DA9E8789F5246())) && !bParam4)
		{
			ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), false);
		}
		Global_11623 = 0;
...
int func_15()//Position - 0x9BA
{
	if (!func_63(iLocal_41))
	{
		if (((((((func_30(&iLocal_26) >= 1f && ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_68, 1f, 1f, 1.5f, false, true, 0)) && INTERIOR::GET_INTERIOR_FROM_ENTITY(iLocal_35) == INTERIOR::GET_INTERIOR_FROM_ENTITY(AUDIO::_0x0626A247D2405330())) && !func_29(8, 4294967295)) && !PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0)) && PED::_0xFCF37A457CB96DC0(AUDIO::_0x0626A247D2405330(), vLocal_31, 90f)) && !PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			if (iLocal_40 == 4294967295)
			{
				func_28();
			...
			else if (func_25(iLocal_40, 1))
			{
				...
				{
					unk_0x1190AB7024CBD8CB(4294967295, "MICHAEL_SOFA_TV_ON_MASTER", 0, true);
				}
				return 1;
			}
			func_16();
...
void func_18(int iParam0)//Position - 0xBB3
{
	if (func_21())
	{
		return;
...
void func_19(bool bParam0, bool bParam1)//Position - 0xC2D
{
	if (bParam0)
	{
		if (func_20(0))
...
int func_20(int iParam0)//Position - 0xCA1
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
bool func_21()//Position - 0xCFB
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

void func_22(bool bParam0, bool bParam1)//Position - 0xD0D
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_23(int iParam0)//Position - 0xE54
{
	int iVar0;
	int iVar1;
...
void func_24()//Position - 0xEA0
{
	...
	if (iLocal_65 == 0)
	{
		...
		if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			...
			BRAIN::TASK_LOOK_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_31, 4294967295, 0, 2);
			ENTITY::SET_ENTITY_VISIBLE(AUDIO::_0x0626A247D2405330(), false, 0);
		}
		if (!MISC::ARE_STRINGS_EQUAL(&cLocal_53, "NULL"))
		{
...
int func_25(int iParam0, bool bParam1)//Position - 0xF75
{
	int iVar0;
...
int func_26(int iParam0)//Position - 0x102D
{
	int iVar0;
...
void func_27(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x1068
{
	int iVar0;
...
bool func_29(int iParam0, int iParam1)//Position - 0x11B3
{
	switch (iParam0)
	{
		case 5:
...
float func_30(int iParam0)//Position - 0x11EE
{
	if (func_33(iParam0))
	{
		if (func_32(iParam0))
		...
		{
			return (func_31(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}

float func_31(bool bParam0)//Position - 0x122D
{
	float fVar0;
	float fVar1;
	int iVar2;
...
void func_35(float fParam0)//Position - 0x12E6
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_37(int iParam0)//Position - 0x13A3
{
	vector3 vVar0;
	
	vVar0 = { func_38(CAM::_0xDC9DA9E8789F5246()) };
	switch (iParam0)
	{
		case 0:
		case 1:
...
Vector3 func_38(int iParam0)//Position - 0x1418
{
	return unk_0x8000C77B5F336760(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_39(int iParam0, int iParam1)//Position - 0x142B
{
	int iVar0;
...
char* func_40(int iParam0)//Position - 0x1488
{
	char* sVar0;
...
int func_41(char* sParam0)//Position - 0x1567
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_42(int iParam0)//Position - 0x157A
{
	int iVar0;
...
int func_43()//Position - 0x15D1
{
	...
	if ((!ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_68, 1f, 1f, 1.5f, false, true, 0) || !PED::_0xFCF37A457CB96DC0(AUDIO::_0x0626A247D2405330(), vLocal_31, 90f)) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()))
	{
		func_42(&iLocal_40);
		return 0;
	}
	if (INTERIOR::GET_INTERIOR_FROM_ENTITY(iLocal_35) != INTERIOR::GET_INTERIOR_FROM_ENTITY(AUDIO::_0x0626A247D2405330()))
	{
		func_42(&iLocal_40);
		return 0;
	}
	...
	if (Global_63AF[iLocal_41 /*11*/].f_8)
	{
		func_42(&iLocal_40);
		return 0;
	}
	...
	if (func_25(iLocal_40, 1))
	{
		func_42(&iLocal_40);
		func_54(&iLocal_26);
		Global_63AF[iLocal_41 /*11*/].f_7 = 1;
		if (AUDIO::REQUEST_AMBIENT_AUDIO_BANK("SAFEHOUSE_MICHAEL_SIT_SOFA", 0, 4294967295))
		{
			unk_0x1190AB7024CBD8CB(4294967295, "MICHAEL_SOFA_TV_ON_MASTER", 0, true);
		}
...
void func_44(int iParam0, int iParam1, int iParam2)//Position - 0x1700
{
	bool bVar0;
...
void func_45()//Position - 0x17E8
{
	...
	{
		func_49(13, SYSTEM::FLOOR(Global_19E56.f_27B6.f_F0D));
	}
...
bool func_47(bool bParam0)//Position - 0x1CF4
{
...
int func_48()//Position - 0x1D1F
{
	return Global_6373;
}

int func_49(int iParam0, int iParam1)//Position - 0x1D2A
{
	int iVar0;
...
int func_50(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1D7B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_54(int iParam0)//Position - 0x244A
{
	func_55(iParam0, 0f);
}

void func_55(int iParam0, float fParam1)//Position - 0x2459
{
	iParam0->f_1 = (func_31(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 4)) - fParam1);
	MISC::SET_BIT(iParam0, 1);
	GRAPHICS::_0x35FB78DC42B7BD21(iParam0, 2);
	iParam0->f_2 = 0f;
}

void func_56()//Position - 0x2487
{
}

int func_57(int iParam0)//Position - 0x248F
{
...
void func_58()//Position - 0x24BB
{
	vLocal_31 = { unk_0x8000C77B5F336760(iLocal_35, true) };
	fLocal_32 = ENTITY::GET_ENTITY_HEADING(iLocal_35);
	func_60();
	if (ENTITY::GET_ENTITY_MODEL(iLocal_35) == 3397365739)
	{
...
void func_60()//Position - 0x27DB
{
	GRAPHICS::_LOAD_TV_CHANNEL_SEQUENCE(0, func_40(1), 0);
	if (func_57(22))
	{
		GRAPHICS::_LOAD_TV_CHANNEL_SEQUENCE(1, func_40(12), 0);
	}
	else
	{
		GRAPHICS::_LOAD_TV_CHANNEL_SEQUENCE(1, func_40(2), 0);
	}
}

void func_61()//Position - 0x2811
{
	if (iLocal_41 == 4294967295)
	{
		return;
	}
	if (Global_63AF[iLocal_41 /*11*/].f_A == 0)
	{
		if (iLocal_66 == 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_38))
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_35))
			{
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_35, false);
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_37))
			{
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_37, false);
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_36))
			{
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_36, false);
			}
			iLocal_66 = 0;
		}
	}
...
bool func_62(int iParam0)//Position - 0x28C4
{
	return Global_8D15 == iParam0;
}

int func_63(int iParam0)//Position - 0x28D2
{
	if (iParam0 != 4294967295)
	{
		if (Global_63AF[iParam0 /*11*/].f_5)
		{
			return 1;
		}
	}
...
void func_66()//Position - 0x2934
{
}

void func_67()//Position - 0x293C
{
	if (iLocal_41 == 4294967295)
	{
		HUD::DISPLAY_SNIPER_SCOPE_THIS_FRAME();
	...
	{
		func_1();
		Global_63AF[iLocal_41 /*11*/].f_6 = 0;
		Global_63AF[iLocal_41 /*11*/].f_7 = 0;
		Global_63AF[iLocal_41 /*11*/].f_8 = 0;
		Global_63AF[iLocal_41 /*11*/].f_4 = 0;
		Global_63AF[iLocal_41 /*11*/].f_5 = 0;
		Global_63AF[iLocal_41 /*11*/].f_2 = 0;
		Global_63AF[iLocal_41 /*11*/] = 4294967295;
		Global_63AF[iLocal_41 /*11*/].f_1 = 0;
		Global_63AF[iLocal_41 /*11*/].f_A = 0;
	}
