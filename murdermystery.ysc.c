...
void func_1()//Position - 0x15D
{
	switch (iLocal_71)
	{
		...
		case 6:
			if (!func_28(3))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -580.8914f, 2033.12f, 130.5113f, -578.4783f, 2035.029f, 127.5615f, 0.75f, 0, true, 0))
				{
					func_27(3, 1);
				}
			}
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -580.2305f, 2032.054f, 130.2928f, -577.6669f, 2033.917f, 127.5157f, 0.75f, 0, true, 0))
			{
				if (func_28(3))
				{
			...
			if (!func_28(2))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -580.2305f, 2032.054f, 130.2928f, -577.6669f, 2033.917f, 127.5157f, 0.75f, 0, true, 0) || CAM::IS_SCREEN_FADED_OUT())
				{
					ENTITY::CREATE_MODEL_HIDE(vLocal_58, 200f, 3053754761, 0);
					func_27(2, 1);
				}
			}
			if (func_66() && !func_65())
			...
			if (func_28(1))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -594.9976f, 2089.005f, 130.3449f, -597.1125f, 2088.365f, 133.3035f, 1f, 0, true, 0))
				{
...
{
	switch (Global_19E56.f_2725.f_86)
	{
		case 0:
			Global_19E56.f_2725.f_86 = 1;
			break;
		
		case 1:
			Global_19E56.f_2725.f_86 = 2;
			GRAPHICS::_SET_EXTRA_TIMECYCLE_MODIFIER(func_4());
			unk_0x1190AB7024CBD8CB(4294967295, "ON", "NOIR_FILTER_SOUNDS", true);
			break;
		
		case 2:
			Global_19E56.f_2725.f_86 = 0;
			break;
	}
}
...
{
	return Global_19E56.f_2725.f_85 == 127;
}
...
bool func_16(int iParam0)//Position - 0x9C2
{
	...
	iVar1 = MISC::GET_BITS_IN_RANGE(Global_19E56.f_2725.f_85, 0, (iVar0 - 1));
...
void func_27(int iParam0, bool bParam1)//Position - 0x13F5
{
	...
	{
		GRAPHICS::_0x35FB78DC42B7BD21(&iLocal_78, iParam0);
	}
}

bool func_28(int iParam0)//Position - 0x1415
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_78, iParam0);
}
...
void func_29()//Position - 0x1425
{
	...
	switch (iLocal_60)
	{
		case 0:
			...
			{
				if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_51, vLocal_57, true, true, 0))
				{
					if (func_55())
					{
						iLocal_60 = 2;
		...
		case 1:
			...
			{
				if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_52, vLocal_57, true, true, 0))
				{
					func_48(0);
					iLocal_60 = 3;
					func_54(0, 800);
		...
		case 2:
			...
			{
				func_39(24, 0);
				func_38(AUDIO::_0x0626A247D2405330(), vLocal_55, fLocal_56);
				...
				if (iLocal_72 <= MISC::GET_GAME_TIMER())
				{
					...
					func_38(AUDIO::_0x0626A247D2405330(), vLocal_53, fLocal_54);
					func_54(1, 800);
					iLocal_60 = 0;
				}
				else
...
void func_32()//Position - 0x1765
{
	if (MISC::IS_PC_VERSION())
	{
		if (!func_28(0))
		{
			PAD::_0x3D42B92563939375("MYSTERY LETTER CAM");
			func_27(0, 1);
		}
	}
}
...
struct<6> func_35(int iParam0, bool bParam1)//Position - 0x3AFB
{
	struct<6> Var0;
...
Vector3 func_36()//Position - 0x46B3
{
	return 2.55f, 5.665f, 2.55f;
}

void func_37(bool bParam0)//Position - 0x46CA
{
	func_27(5, bParam0);
	CLOCK::PAUSE_CLOCK(bParam0);
}

void func_38(int iParam0, vector3 vParam1, float fParam2)//Position - 0x46DF
{
	ENTITY::SET_ENTITY_COORDS(iParam0, vParam1, 1, false, 0, 1);
	ENTITY::SET_ENTITY_HEADING(iParam0, fParam2);
}

void func_39(int iParam0, bool bParam1)//Position - 0x46FD
{
	char* sVar0;
	int iVar1;
...
int func_40(int iParam0)//Position - 0x4788
{
	struct<2> Var0;
...
struct<2> func_41(var uParam0)//Position - 0x47BC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_42(int iParam0, bool bParam1)//Position - 0x480E
{
	struct<2> Var0;
...
void func_43()//Position - 0x4851
{
	...
	{
		case 0:
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vVar0, vVar1, fVar2, 0, true, 0) && !func_5(0))
			{
				func_47(sLocal_76);
				iLocal_61++;
			}
		...
		case 1:
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vVar0, vVar1, fVar2, 0, true, 0) && !func_5(0))
			{
				if (!func_46(AUDIO::_0x0626A247D2405330(), 3414437612))
				{
					BRAIN::TASK_LOOK_AT_COORD(AUDIO::_0x0626A247D2405330(), -1007.995f, -476.8016f, 49.9117f, 4294967295, 0, 2);
				}
				if (PAD::IS_CONTROL_JUST_PRESSED(2, 51))
				{
					func_45(0);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(AUDIO::_0x0626A247D2405330(), -1007.351f, -477.5197f, 49.0282f, 1f, 4294967295, 0.5f, 0, 30.4025f);
					func_47(sLocal_77);
		...
		case 2:
			...
			if (PAD::IS_CONTROL_JUST_PRESSED(2, 51))
			{
				if (CAM::_0xEE778F8C7E1142E2(0) == 4)
				{
					...
					unk_0x1190AB7024CBD8CB(4294967295, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", false);
				}
				else
				{
					iLocal_72 = 0;
...
int func_44(char* sParam0)//Position - 0x4A4E
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_45(bool bParam0)//Position - 0x4A61
{
	func_27(6, !bParam0);
	PLAYER::SET_PLAYER_CONTROL(CAM::_0xDC9DA9E8789F5246(), bParam0, 0);
}

bool func_46(int iParam0, int iParam1)//Position - 0x4A7C
{
	int iVar0;
...
void func_47(char* sParam0)//Position - 0x4A9C
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 1, true, 4294967295);
}

void func_48(int iParam0)//Position - 0x4AB2
{
	if (func_52())
	{
		return;
...
void func_49(int iParam0)//Position - 0x4AE5
{
	if (func_52())
	{
		return;
...
void func_51(bool bParam0, bool bParam1)//Position - 0x4B86
{
	if (bParam0)
	{
		if (func_5(0))
...
bool func_52()//Position - 0x4BFA
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

void func_53()//Position - 0x4C0C
{
	Global_434C.f_6 = 1;
}

void func_54(bool bParam0, int iParam1)//Position - 0x4C1A
{
	func_27(4, !bParam0);
	if (bParam0)
	{
...
int func_56()//Position - 0x4C71
{
	...
	if (PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0 && iLocal_60 == 0)
	{
		return 0;
	}
	if (func_63(0))
...
int func_57(int iParam0)//Position - 0x4D10
{
	if (!func_12(iParam0))
	{
		return 7;
...
int func_59(int iParam0)//Position - 0x4D78
{
...
int func_60(int iParam0)//Position - 0x4DA4
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_61(int iParam0, bool bParam1, bool bParam2)//Position - 0x4DC5
{
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_19E56.f_2725.f_85), iParam0);
		if (!bParam2)
		{
			unk_0x1190AB7024CBD8CB(iLocal_69, sLocal_67, sLocal_68, false);
		}
		func_62();
	}
	else
	{
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_19E56.f_2725.f_85), iParam0);
	}
}

int func_62()//Position - 0x4E09
{
	if (func_63(0))
	{
		return 0;
...
bool func_63(bool bParam0)//Position - 0x4E54
{
...
bool func_64()//Position - 0x4E7F
{
	return ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()) == joaat("player_zero");
}

int func_65()//Position - 0x4E95
{
	if (func_60(AUDIO::_0x0626A247D2405330()))
	{
		return PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0);
	}
	return 0;
}

bool func_66()//Position - 0x4EB5
{
	return SYSTEM::VDIST2(func_68(iLocal_71), vLocal_70) < func_67(iLocal_71);
}

float func_67(int iParam0)//Position - 0x4ED2
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_68(int iParam0)//Position - 0x4F43
{
	switch (iParam0)
	{
		case 0:
...
bool func_69(int iParam0)//Position - 0x5012
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_2725.f_85, iParam0);
}

int func_70()//Position - 0x5029
{
	switch (iLocal_71)
	{
		case 0:
...
bool func_71(vector3 vParam0)//Position - 0x50CC
{
	var uVar0;
	var uVar1;
...
bool func_72()//Position - 0x50E0
{
	return SYSTEM::VDIST2(func_74(iLocal_71), vLocal_70) < func_73(iLocal_71);
}

float func_73(int iParam0)//Position - 0x50FD
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_74(int iParam0)//Position - 0x516F
{
	switch (iParam0)
	{
		case 0:
...
void func_75()//Position - 0x523E
{
	if (func_60(AUDIO::_0x0626A247D2405330()))
	{
		vLocal_70 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false) };
	}
}

void func_76(vector3 vParam0)//Position - 0x525E
{
	int iVar0;
	int iVar1;
...
void func_77()//Position - 0x52C1
{
	switch (iLocal_71)
	{
		...
		case 4:
			func_79(3623056905);
			func_78(sLocal_74);
			iLocal_66 = PED::CREATE_PED(26, 3623056905, func_68(4), 184.5548f, 1, true);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(3623056905);
			BRAIN::TASK_PLAY_ANIM(iLocal_66, sLocal_74, sLocal_75, 1000f, -1000f, 4294967295, 9, 0, 0, 0, 0);
			ENTITY::SET_ENTITY_HEALTH(iLocal_66, true);
...
void func_78(char* sParam0)//Position - 0x5479
{
...
void func_79(int iParam0)//Position - 0x5499
{
...
void func_80(int iParam0, vector3 vParam1, float fParam2)//Position - 0x54B9
{
...
bool func_81(vector3 vParam0, vector3 vParam1, float fParam2)//Position - 0x54DF
{
	return SYSTEM::VDIST(vParam0, vParam1) <= fParam2;
}

int func_82()//Position - 0x54F6
{
	int iVar0;
...
void func_84()//Position - 0x55C5
{
	switch (iLocal_71)
	{
		...
		case 6:
			...
			if (func_28(2))
			{
				ENTITY::REMOVE_MODEL_HIDE(vLocal_58, 200f, 3053754761, false);
			}
			break;
	}
}
