...
void __EntryFunction__()
{
	...
	fLocal_249 = "RANDOM@CRASH_RESCUE@WOUNDED@BASE";
	fLocal_250 = "MOVE_INJURED_GENERIC";
	fLocal_251 = "RANDOM@CRASH_RESCUE@HELP_VICTIM_UP";
	fLocal_252 = "random@crash_rescue@dead_ped";
	fLocal_253 = "RANDOM@CRASH_RESCUE@CAR_DEATH@LOW_CAR";
	fLocal_254 = "RANDOM@CRASH_RESCUE@CAR_DEATH@STD_CAR";
	fLocal_255 = "RANDOM@CRASH_RESCUE@CAR_DEATH@VAN";
	fLocal_257 = "random@crash_rescue@get_victim_to_friend";
	...
	switch (iLocal_269)
	{
		...
		case 5:
			if (!PED::IS_PED_INJURED(iLocal_67))
			{
				...
				BRAIN::CLEAR_PED_TASKS(iLocal_67);
				PED::SET_PED_TO_RAGDOLL(iLocal_67, 500, 1000, 0, 0, 0, 0);
				PED::APPLY_DAMAGE_TO_PED(iLocal_67, 200, 0, 0);
				func_316();
			}
...
void func_3()
{
	...
	{
		if (func_7(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_67) && !PED::IS_PED_INJURED(iLocal_68))
			{
				if (func_70(&uLocal_76, "RECRAAU", "RECRA_ARRIV", "RECRA_ARRIV_1", 3, 0, 0))
				{
					...
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_67, iLocal_259, fLocal_257, "helping_friend_inside_victim", 1000f, -1000f, 0, 0, 1148846080, 0);
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_68, iLocal_259, fLocal_257, "helping_friend_inside_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
					iLocal_75 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
					CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_75, iLocal_259, "HELPING_FRIEND_INSIDE_CAM", fLocal_257);
...
void func_28()
{
	...
	{
		func_30(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
...
void func_37(void fParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_70793[1 /*14*/] = { func_124(iVar10, 14, uVar12[iVar1]) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_84(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_84(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_84(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
						}
						func_116(iVar0);
						if (Global_70791 == 1)
						{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_70793[1 /*14*/] = { func_124(iVar10, 14, uVar15[iVar1]) };
			func_94(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
			func_116(14);
			if (Global_70791 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_84(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_84(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_84(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
		}
		if (Global_70791 == 1)
		{
			iVar2 = 0;
...
int func_96(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_84(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_84(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_126(int iParam0)
{
	...
	func_127(&(Global_70793[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_127(var uParam0, int iParam1, int iParam2, void fParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
...
void func_133(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_127(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_84(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_127(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_188(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_70793[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_84(iParam1)) && Global_70793[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_84(iParam1)))
	{
		return 1;
	}
	return 0;
			...
			if (func_215())
			{
				...
				if (bLocal_244)
				{
					...
					else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_68, PLAYER::PLAYER_PED_ID(), 1) || func_208(iLocal_68, PLAYER::PLAYER_PED_ID(), 1.25f, 1))
					{
						...
						BRAIN::TASK_SMART_FLEE_PED(iLocal_68, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
				...
				if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_67) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
				{
					...
					{
						fLocal_256 = fLocal_254;
						if (func_205())
						{
							fLocal_256 = fLocal_253;
						}
						else if (func_204())
						{
							fLocal_256 = fLocal_255;
						}
						if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_67, -2017877118) == 7)
						{
							BRAIN::TASK_PLAY_ANIM(iLocal_67, fLocal_256, "LOOP", 2f, -8f, -1, 1, 0, 0, 0, 0);
						}
					}
				}
			}
...
void func_206()
{
	if (!bLocal_244 && func_214(PLAYER::PLAYER_PED_ID(), vLocal_56, 150f))
	{
		...
		STREAMING::REQUEST_ANIM_DICT(fLocal_257);
		if ((STREAMING::HAS_MODEL_LOADED(iLocal_246) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_257)) && OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(1728.778f, 3851.287f, 33.7826f, 5f, joaat("prop_skid_chair_01"), 0))
		{
			...
			iLocal_259 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_72, vLocal_73, 2);
			BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_68, iLocal_259, fLocal_257, "helping_friend_idle_friend", 1000f, -1000f, 0, 0, 1148846080, 0);
			bLocal_244 = true;
		}
	}
}
...
int func_215()
{
	...
	if (PED::IS_PED_GROUP_MEMBER(iLocal_67, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID())))
	{
		...
		else if (PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_67, -828834893) == 7)
				{
					BRAIN::CLEAR_PED_TASKS(iLocal_67);
...
void func_230()
{
	...
	{
		case 0:
			STREAMING::REQUEST_ANIM_DICT(fLocal_251);
			if (STREAMING::HAS_ANIM_DICT_LOADED(fLocal_251))
			{
				iLocal_63++;
			}
			break;
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_67))
			{
				...
				CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_74, iLocal_258, "HELPING_VICTIM_TO_FEET_CAM", fLocal_251);
				...
				BRAIN::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_258, fLocal_251, "HELPING_VICTIM_TO_FEET_PLAYER", 1000f, -4f, 0, 0, 1148846080, 0);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_67, iLocal_258, fLocal_251, "HELPING_VICTIM_TO_FEET_VICTIM", 1000f, -4f, 0, 0, 1148846080, 0);
		...
		case 4:
			...
			STREAMING::REMOVE_ANIM_DICT(fLocal_251);
			STREAMING::REMOVE_ANIM_DICT(fLocal_249);
			if (func_19(iLocal_67))
			{
			...
			if (iLocal_242)
			{
				...
				PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
				PED::_0x2208438012482A1A(iLocal_67, 0, 0);
				vVar0 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(fLocal_251, "HELPING_VICTIM_TO_FEET_PLAYER", vLocal_72, vLocal_73, 1f, 2) };
				MISC::GET_GROUND_Z_FOR_3D_COORD(vVar0, &(vVar0.f_2), 0, 0);
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vVar0, 1, false, 0, 1);
				vVar0 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(fLocal_251, "HELPING_VICTIM_TO_FEET_PLAYER", vLocal_72, vLocal_73, 1f, 2) };
				ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), vVar0.z);
				vVar0 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(fLocal_251, "HELPING_VICTIM_TO_FEET_VICTIM", vLocal_72, vLocal_73, 1f, 2) };
				MISC::GET_GROUND_Z_FOR_3D_COORD(vVar0, &(vVar0.f_2), 0, 0);
				ENTITY::SET_ENTITY_COORDS(iLocal_67, vVar0, 1, false, 0, 1);
				vVar0 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(fLocal_251, "HELPING_VICTIM_TO_FEET_VICTIM", vLocal_72, vLocal_73, 1f, 2) };
			...
			else
			{
				if (!bLocal_243)
				{
					...
					BRAIN::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), fVar1, "idle_intro", 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
				...
				switch (iLocal_60)
				{
					...
					case 1:
						if (!func_333())
						{
							...
							BRAIN::TASK_LOOK_AT_ENTITY(iLocal_67, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
...
int func_241()
{
	switch (func_242(&Global_25336, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_247()
{
	if ((Global_105209 == func_43() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_105210)
	{
		return 1;
	}
	return 0;
...
void func_255()
{
	...
	STREAMING::REQUEST_ANIM_DICT(fLocal_249);
	STREAMING::REQUEST_CLIP_SET(fLocal_250);
	STREAMING::REQUEST_ANIM_DICT(fLocal_253);
	STREAMING::REQUEST_ANIM_DICT(fLocal_254);
	STREAMING::REQUEST_ANIM_DICT(fLocal_255);
	STREAMING::REQUEST_ANIM_DICT(fLocal_252);
	STREAMING::REQUEST_PTFX_ASSET();
	if (((((((((STREAMING::HAS_MODEL_LOADED(iLocal_246) && STREAMING::HAS_MODEL_LOADED(iLocal_248)) && STREAMING::HAS_MODEL_LOADED(iLocal_247)) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_249)) && STREAMING::HAS_CLIP_SET_LOADED(fLocal_250)) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_253)) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_254)) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_255)) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_252)) && STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		bLocal_262 = false;
		iLocal_273 = 0;
		...
		MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vLocal_57.x, (vLocal_57.y + 0.1f), (vLocal_57.z + 0.1f), vLocal_57.x, (vLocal_57.y - 0.1f), (vLocal_57.z - 0.1f), 1, 1, joaat("weapon_assaultrifle"), 0, 1, 1, -1f);
		BRAIN::TASK_PLAY_ANIM(iLocal_67, fLocal_249, "BASE", 8f, -8f, -1, 9, 0, 0, 0, 0);
		if (func_19(iLocal_67))
		{
		...
		PED::SET_PED_MOVEMENT_CLIPSET(iLocal_67, fLocal_250, 1048576000);
		...
		BRAIN::TASK_PLAY_ANIM_ADVANCED(iLocal_69, fLocal_252, "dead_ped", 1935.53f, 6291.888f, 41.144f, 0f, 0f, -28.44f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
...
int func_273(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_308(Global_105220.f_24966.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_306()) || Global_104267) || Global_25279) || func_305()) || func_16(8, -1)) || func_304()) || func_303()) || func_302()) || func_301()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_306()) || Global_25279) || func_305()) || func_16(8, -1)) || func_302()) || func_304()) || func_303()) || func_301()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_306()) || Global_104267) || Global_25279) || func_305()) || func_16(8, -1)) || func_304()) || func_303()) || func_301()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_306() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_16(8, -1)) || func_301()) || func_300()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_306()) || Global_25279) || func_305()) || func_16(8, -1)) || func_303()) || func_302()) || func_301()) || Global_105220.f_7659.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_306()) || func_303()) || Global_104267) || Global_25279) || func_305()) || Global_37057) || func_16(8, -1)) || func_302()) || func_300()) || func_301()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_306()) || Global_104267) || Global_25279) || func_305()) || func_16(8, -1)) || func_302()) || func_300()) || func_304()) || func_303()) || func_301())
						{
							return 0;
						}
						break;
