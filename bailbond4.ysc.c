...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		if (func_428(AUDIO::_0x0626A247D2405330()))
		{
			func_427(AUDIO::_0x0626A247D2405330(), vLocal_333, fLocal_117, 0, 0);
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			...
			vLocal_331 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 1) };
			func_416();
			func_415();
			switch (iLocal_58)
			{
		...
		switch (iLocal_58)
		{
			case 0:
				if (iLocal_60 == 1)
				{
					if (!func_70())
					{
						func_19(AUDIO::_0x0626A247D2405330(), vLocal_334, fLocal_118, 0, 1);
			...
			case 1:
				...
				if (iLocal_60 == 1)
				{
					if (!func_70())
					{
						func_19(AUDIO::_0x0626A247D2405330(), vLocal_335, fLocal_119, 0, 1);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_104 == 0)
						{
					...
					if (iLocal_132 > 0)
					{
						...
						while (iVar0 <= (iLocal_132 - 1))
						{
							if (func_22(Local_69[iVar0 /*19*/]))
							{
								...
								unk_0x65E471E4A2D56226(Local_69[iVar0 /*19*/], 0, 0);
							}
							iVar0++;
						}
					}
			...
			case 3:
				...
				if (iLocal_60 == 1)
				{
					...
					if (!func_70())
					{
						func_427(AUDIO::_0x0626A247D2405330(), vLocal_330, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_104 == 0)
						{
...
int func_3(int iParam0, float fParam1)//Position - 0x65F
{
	...
	if (func_22(iParam0))
	{
		if (func_4(unk_0x8000C77B5F336760(iParam0, 1), &vVar0, fParam1, 0))
		{
...
void func_15(bool bParam0, bool bParam1)//Position - 0x8F9
{
	if (bParam0)
	{
		if (func_16(0))
...
int func_16(int iParam0)//Position - 0x96D
{
	if (iParam0 == 1)
	{
...
bool func_17()//Position - 0x9C7
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

void func_18(int iParam0, struct<2> Param1, float fParam2)//Position - 0x9D9
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
int func_19(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)//Position - 0xA38
{
	bool bVar0;
	float fVar1;
...
void func_20()//Position - 0xA94
{
	Global_3960 = 0;
	func_21();
}

void func_21()//Position - 0xAA4
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
...
int func_22(int iParam0)//Position - 0xAFB
{
	if (func_428(iParam0))
	{
...
void func_23(int iParam0, bool bParam1)//Position - 0xB1B
{
...
void func_24(int iParam0, int iParam1, int iParam2)//Position - 0xB57
{
...
void func_25(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0xB8B
{
	int iVar0;
...
void func_26(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xC33
{
	if (bParam0)
	{
...
int func_29(int iParam0, bool bParam1)//Position - 0xDC4
{
	int iVar0;
	int iVar1;
...
int func_30()//Position - 0xE05
{
	return Global_1407E0;
}

int func_31(int iParam0)//Position - 0xE11
{
...
bool func_32()//Position - 0xE53
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_240006, 3);
}

int func_33(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xE64
{
	int iVar0;
...
void func_34(int iParam0)//Position - 0xE97
{
	if (iParam0 == 1)
	{
...
void func_35(int iParam0)//Position - 0xEBA
{
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		switch (iParam0)
...
void func_37(int iParam0, bool bParam1)//Position - 0x10CB
{
	if (bParam1)
	{
		func_39(iParam0);
...
void func_38(int iParam0, bool bParam1)//Position - 0x10E8
{
...
void func_39(int iParam0)//Position - 0x1123
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
char* func_40()//Position - 0x114E
{
	return "special_ped@maude@base";
}

void func_41(int iParam0, bool bParam1)//Position - 0x1159
{
	if (bParam1)
	{
		func_43(iParam0);
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1178
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_43(int iParam0)//Position - 0x11C8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_44()//Position - 0x1209
{
	return 2057223314;
}

float func_45()//Position - 0x1216
{
	return -92.17f;
}

Vector3 func_46()//Position - 0x1223
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_47()//Position - 0x123A
{
	return 3914268813;
}
...
char* func_49()//Position - 0x1333
{
	return "base_chair";
}

char* func_50()//Position - 0x133E
{
	return "base";
}

Vector3 func_51()//Position - 0x1349
{
	return 0f, 0f, -92.17f;
}

Vector3 func_52()//Position - 0x1358
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_53(var uParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x136F
{
...
void func_54(int iParam0, bool bParam1)//Position - 0x13F1
{
	if (iParam0 != 0)
	{
		if (bParam1)
...
int func_55(int iParam0)//Position - 0x141C
{
	if (iParam0 == 0)
	{
		return 1;
...
int func_56(var uParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0x1442
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_55(iParam1))
...
int func_57(int iParam0)//Position - 0x14AD
{
	switch (iParam0)
	{
		case 0:
...
bool func_58(vector3 vParam0, vector3 vParam1, float fParam2)//Position - 0x1551
{
	return SYSTEM::VDIST2(vParam0, vParam1) <= (fParam2 * fParam2);
}

int func_59(int iParam0, float fParam1, int iParam2)//Position - 0x156B
{
	int iVar0;
...
int func_63(int iParam0, int iParam1)//Position - 0x16D5
{
	if (func_22(iParam0))
	{
...
int func_64(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x1708
{
...
void func_65(int iParam0)//Position - 0x1897
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_67(char* sParam0)//Position - 0x1905
{
	func_26(1, 1, 0, 0, 0);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_68(int iParam0, int iParam1, int iParam2)//Position - 0x191E
{
	if (func_515() && func_70())
	{
...
void func_69(int iParam0)//Position - 0x19E2
{
	if (iParam0 == 1)
	{
...
void func_72(int iParam0)//Position - 0x1CCA
{
	if (func_22(*iParam0))
	{
...
char* func_73()//Position - 0x1D33
{
	return "female_Flee_Table_Left_Maude";
}

int func_74(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1D3F
{
	if (iParam4 == 0)
	{
...
bool func_75(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1D7C
{
...
int func_76(char* sParam0, int iParam1, bool bParam2)//Position - 0x1DCA
{
	Global_3DCF = 0;
...
int func_81()//Position - 0x2297
{
	func_82();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_82()//Position - 0x22B0
{
	int iVar0;
...
bool func_83(int iParam0)//Position - 0x23AD
{
	return iParam0 < 3;
}

int func_84(int iParam0)//Position - 0x23B9
{
	int iVar0;
	int iVar1;
...
int func_85(int iParam0)//Position - 0x23F6
{
	if (func_83(iParam0))
	{
...
bool func_86(int iParam0)//Position - 0x2420
{
	return Global_8D15 == iParam0;
}

void func_87()//Position - 0x242E
{
	int iVar0;
...
bool func_88(int iParam0, int iParam1)//Position - 0x2485
{
	switch (iParam0)
	{
		case 5:
...
void func_89(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x24C0
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
void func_90(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2516
{
...
void func_91(bool bParam0)//Position - 0x25B1
{
	int iVar0;
	...
	if (iLocal_132 > 0)
	{
		...
		while (iVar0 <= (iLocal_132 - 1))
		{
			if (iLocal_67 == 4)
			{
				if (func_22(Local_69[iVar0 /*19*/]))
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_69[iVar0 /*19*/], 2229074605);
					ENTITY::SET_ENTITY_HEALTH(Local_69[iVar0 /*19*/], 0);
					if (Global_1994B == 0)
					{
...
void func_92(int iParam0, bool bParam1)//Position - 0x2784
{
	if (bParam1)
	{
		func_94(iParam0);
...
void func_94(int iParam0)//Position - 0x27D8
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_95(int iParam0)//Position - 0x2874
{
	if (func_428(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
void func_96(var uParam0)//Position - 0x289E
{
...
void func_98(char* sParam0)//Position - 0x28E4
{
...
void func_99(int iParam0, bool bParam1)//Position - 0x2923
{
	if (func_22(iParam0))
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(iParam0, 5, 0);
		...
		if (!func_63(iParam0, 1805844857))
		{
			...
			BRAIN::TASK_SMART_FLEE_PED(iParam0, AUDIO::_0x0626A247D2405330(), 150f, 4294967295, 0, 0);
		}
		if (bParam1)
		{
...
int func_100(int iParam0, int iParam1, int iParam2)//Position - 0x299E
{
	int iVar0;
...
char* func_101()//Position - 0x2AEA
{
	return "Female_Flee_Table_Left_Maude_Chair";
}

char* func_102()//Position - 0x2AF6
{
	return "special_ped@maude@exit_flee";
}

void func_103(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2B02
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_104(iParam3), 0);
}

int func_104(int iParam0)//Position - 0x2B1B
{
	int iVar0;
...
bool func_105(int iParam0, vector3 vParam1, float fParam2)//Position - 0x2D10
{
	return SYSTEM::VDIST2(unk_0x8000C77B5F336760(iParam0, 1), vParam1) <= (fParam2 * fParam2);
}

void func_106(int iParam0, bool bParam1)//Position - 0x2D2D
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
void func_107(var uParam0, int iParam1)//Position - 0x2D9E
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_109(int iParam0)//Position - 0x2DDF
{
	bool bVar0;
	struct<8> Var1;
...
void func_110(int iParam0)//Position - 0x2E51
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_111(int iParam0)//Position - 0x2E71
{
	int iVar0;
...
bool func_113(int iParam0, int iParam1)//Position - 0x2F5D
{
	return (MISC::GET_GAME_TIMER() - iParam0) > iParam1;
}

void func_114(int iParam0)//Position - 0x2F6F
{
	if (func_22(Local_69[iParam0 /*19*/]))
	{
		if (PED::GET_PED_RELATIONSHIP_GROUP_HASH(Local_69[iParam0 /*19*/]) == iLocal_320)
		{
			...
			BRAIN::TASK_LOOK_AT_ENTITY(Local_69[iParam0 /*19*/], AUDIO::_0x0626A247D2405330(), 4294967295, 0, 2);
			if (!PED::IS_PED_FLEEING(Local_69[iParam0 /*19*/]))
			{
				...
				BRAIN::TASK_CLEAR_LOOK_AT(Local_69[iParam0 /*19*/]);
				BRAIN::CLEAR_PED_SECONDARY_TASK(Local_69[iParam0 /*19*/]);
				NETWORK::_0x5E3AA4CA2B6FB0EE(Local_69[iParam0 /*19*/]);
				BRAIN::TASK_HANDS_UP(Local_69[iParam0 /*19*/], 4294967295, AUDIO::_0x0626A247D2405330(), 4294967295, 0);
			}
			ENTITY::SET_ENTITY_HEALTH(Local_69[iParam0 /*19*/], 1);
		...
		else
		{
			...
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_69[iParam0 /*19*/], 0, 1);
			ENTITY::SET_ENTITY_HEALTH(Local_69[iParam0 /*19*/], 0);
			Local_69[iParam0 /*19*/].f_E = 5;
		}
	}
}

void func_115(int iParam0)//Position - 0x30B2
{
	func_23(500, 1);
...
void func_116(int iParam0, int iParam1, int iParam2)//Position - 0x30E7
{
	bool bVar0;
...
int func_119()//Position - 0x36DB
{
	return Global_6373;
}

int func_120(int iParam0, int iParam1)//Position - 0x36E6
{
	int iVar0;
...
int func_121(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3737
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_122(int iParam0)//Position - 0x3C9F
{
	int iVar0;
	...
	switch (iLocal_60)
	{
		case 0:
			...
			if (func_36())
			{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(AUDIO::_0x0626A247D2405330(), sLocal_150, 0, 0, 0);
					if (func_428(Local_75))
					{
...
void func_124(int iParam0)//Position - 0x3FD9
{
	iLocal_58 = iParam0;
	iLocal_60 = 0;
}

void func_125(vector3 vParam0, float fParam1, int iParam2, int iParam3)//Position - 0x3FE8
{
	vector3 vVar0;
	var uVar1;
...
void func_126(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)//Position - 0x4065
{
	struct<60> Var0;
...
void func_127(int iParam0, int iParam1, int iParam2)//Position - 0x418E
{
	int iVar0;
...
void func_128(int iParam0, int iParam1)//Position - 0x42AB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_129(int iParam0)//Position - 0x44AD
{
...
int func_130(int iParam0)//Position - 0x458A
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_131(int iParam0, bool bParam1)//Position - 0x473B
{
	int iVar0;
	struct<2> Var1;
...
int func_134(int iParam0)//Position - 0x499E
{
	int iVar0;
	int iVar1;
...
int func_135()//Position - 0x6699
{
	return 0;
}

int func_136()//Position - 0x66A2
{
	return 1;
}

int func_137()//Position - 0x66AB
{
	return 1;
}

int func_138()//Position - 0x66B4
{
...
int func_140(int iParam0)//Position - 0x6788
{
	int iVar0;
	char* sVar1;
...
int func_141(int iParam0)//Position - 0x67CE
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0x6809
{
	int iVar0;
...
int func_143(int iParam0)//Position - 0x6885
{
	int iVar0;
...
int func_144(int iParam0, int iParam1, bool bParam2)//Position - 0x696D
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_145(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x69DE
{
...
void func_147(var uParam0, int iParam1)//Position - 0x6AFC
{
	if (iParam1 <= 0)
	{
		return;
...
void func_148(var uParam0, int iParam1)//Position - 0x6B82
{
...
void func_149(var uParam0, int iParam1)//Position - 0x6BB5
{
	int iVar0;
	int iVar1;
...
int func_150(int iParam0, int iParam1)//Position - 0x6C06
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_153(var uParam0)//Position - 0x6CE4
{
	return uParam0 & 15;
}

void func_154(var uParam0, int iParam1)//Position - 0x6CF1
{
...
void func_155(var uParam0, int iParam1)//Position - 0x6D2B
{
...
void func_156(var uParam0, int iParam1)//Position - 0x6D66
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_157(var uParam0, int iParam1)//Position - 0x6DA2
{
	int iVar0;
	int iVar1;
...
int func_158(int iParam0, int iParam1)//Position - 0x849B
{
	struct<82> Var0;
...
void func_159(int iParam0, var uParam1, int iParam2)//Position - 0x84DD
{
	int iVar0;
...
void func_160(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0x8739
{
	if (func_157(&(Global_11188.f_22B[0 /*21*/]), iParam0))
	{
...
void func_161(int iParam0, bool bParam1)//Position - 0x8838
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_162(int iParam0, int iParam1, bool bParam2)//Position - 0x8895
{
	if (iParam0 == 4294967295)
	{
		return;
...
bool func_163(int iParam0, int iParam1)//Position - 0x88D0
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
void func_164(var uParam0, var uParam1)//Position - 0x88F3
{
...
void func_165(int iParam0)//Position - 0x89BF
{
	if (iParam0 == 4294967295)
	{
		return;
...
int func_166(int iParam0)//Position - 0x8A39
{
	int iVar0;
...
bool func_167(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x8A9C
{
	if (bParam2)
	{
...
void func_168(int iParam0, var uParam1)//Position - 0x8AE3
{
	int iVar0;
...
int func_169(int iParam0)//Position - 0x8D8E
{
	switch (iParam0)
	{
		case 1:
...
int func_170(int iParam0, var uParam1, var uParam2)//Position - 0x8E3E
{
	int iVar0;
	int iVar1;
...
int func_171(int iParam0)//Position - 0x9031
{
	switch (iParam0)
	{
		case joaat("GRANGER"):
...
void func_172(var uParam0)//Position - 0x9051
{
	int iVar0;
...
void func_173(int iParam0)//Position - 0x9101
{
...
int func_174(vector3 vParam0, int iParam1, var uParam2, var uParam3)//Position - 0x9128
{
	int iVar0;
...
int func_175(vector3 vParam0, int iParam1, int iParam2)//Position - 0x923E
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_176(int iParam0)//Position - 0x92CD
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_1C21[iParam0], 0);
}

int func_177(int iParam0)//Position - 0x92E5
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
void func_178(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x9301
{
	func_179(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_179(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x932A
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_180(vector3 vParam0)//Position - 0x971E
{
...
int func_181(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)//Position - 0x9748
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_182(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x9A3E
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_183(vector3 vParam0)//Position - 0x9AF2
{
	float fVar0;
	float fVar1;
...
void func_184(int iParam0)//Position - 0x9B31
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
bool func_185(vector3 vParam0, int iParam1)//Position - 0x9B96
{
	return func_186(Global_17998.f_B3B.f_C.f_42, vParam0, iParam1);
}

int func_186(int iParam0, vector3 vParam1, int iParam2)//Position - 0x9BB3
{
	vector3 vVar0;
	vector3 vVar1;
...
Vector3 func_187()//Position - 0x9C1D
{
	return 2.55f, 5.665f, 2.55f;
}

Vector3 func_188()//Position - 0x9C34
{
	return 3.01f, 11.01f, 6.01f;
}

int func_189(var uParam0, var uParam1, var uParam2)//Position - 0x9C4B
{
...
void func_190(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x9C82
{
	int iVar0;
...
Vector3 func_191(int iParam0)//Position - 0x9E40
{
	return unk_0x8000C77B5F336760(PLAYER::GET_PLAYER_PED(iParam0), 0);
}

int func_192(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x9E53
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_193(int iParam0, int iParam1, int iParam2)//Position - 0xA669
{
	int iVar0;
...
int func_194(int iParam0)//Position - 0xA6F5
{
	switch (iParam0)
	{
...
void func_195(int iParam0, int iParam1, int iParam2)//Position - 0xA730
{
	int iVar0;
	int iVar1;
...
int func_196(int iParam0, int iParam1, int iParam2)//Position - 0xA7BA
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_197(int iParam0, int iParam1, int iParam2)//Position - 0xA898
{
...
int func_198(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0xA8C3
{
	var uVar0;
	int iVar1;
...
int func_199(int iParam0, int iParam1, int iParam2)//Position - 0xAEC7
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_200(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAF60
{
	int iVar0;
...
int func_201(int iParam0, int iParam1, int iParam2)//Position - 0xAFF6
{
	int iVar0;
	int iVar1;
...
int func_202(int iParam0)//Position - 0xB097
{
	switch (iParam0)
	{
		case 0:
...
int func_203(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB147
{
	int iVar0;
...
int func_204(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xB44E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_205(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0xC003
{
	int iVar0;
...
int func_206(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC2E7
{
	int iVar0;
...
int func_207(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC5AE
{
	int iVar0;
	int iVar1;
...
int func_208(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC5E5
{
	int iVar0;
...
int func_209(int iParam0, int iParam1, int iParam2)//Position - 0xC60E
{
	*iParam2 = 4294967197;
	switch (iParam0)
	{
...
int func_210(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC8D8
{
	int iVar0;
...
int func_211(int iParam0, int iParam1, int iParam2)//Position - 0xCB62
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_212(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCCB9
{
	int iVar0;
...
int func_213(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCD51
{
	switch (iParam0)
	{
...
int func_214(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCE1F
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_215(int iParam0, int iParam1)//Position - 0xCF7B
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_216(int iParam0)//Position - 0xD322
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_217(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD383
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_218(int iParam0, int iParam1)//Position - 0xD47F
{
	int iVar0;
...
int func_219(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD5BD
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_220(int iParam0)//Position - 0xD69D
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_221(int iParam0, int iParam1)//Position - 0xD723
{
	int iVar0;
	struct<10> Var1;
...
void func_222(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE052
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar2;
...
void func_223(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xE17C
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_224(int iParam0, int iParam1)//Position - 0xE1C4
{
	int iVar0;
	struct<17> Var1;
...
void func_225(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1000E
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar2;
...
int func_226(int iParam0)//Position - 0x101F8
{
	switch (iParam0)
	{
		case 0:
...
void func_227(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x102A8
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_228(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10319
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_229(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10596
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_230(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x109BB
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_231(int iParam0, int iParam1)//Position - 0x10CAE
{
	int iVar0;
	int iVar1;
...
int func_232(int iParam0, int iParam1)//Position - 0x10CF4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_233(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10D54
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_234(int iParam0)//Position - 0x10DD8
{
...
void func_235(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x10E90
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_236(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x10EDA
{
	int iVar0;
...
int func_237(var uParam0)//Position - 0x10F0A
{
	int iVar0;
	int iVar1;
...
int func_238(int iParam0, int iParam1, int iParam2)//Position - 0x10F3E
{
	int iVar0;
	var uVar1;
...
bool func_239(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x10F70
{
	int iVar0;
...
int func_240(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x12A29
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_241(int iParam0)//Position - 0x13947
{
	if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11569[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_242(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x13998
{
	func_305();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_243(int iParam0, int iParam1)//Position - 0x139EA
{
	switch (iParam0)
	{
		case 0:
...
void func_244(int iParam0)//Position - 0x13ADA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_245(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x14D52
{
	int iVar0;
	int iVar1;
...
bool func_246(int iParam0, int iParam1, var uParam2)//Position - 0x150E3
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_247(int iParam0, int iParam1)//Position - 0x154E8
{
	switch (iParam1)
	{
		case 0:
...
int func_248(int iParam0, int iParam1)//Position - 0x158E3
{
	switch (iParam1)
	{
		case 0:
...
int func_249(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x15CDE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_250(int iParam0)//Position - 0x15D20
{
	switch (iParam0)
	{
		case 4294967295:
...
void func_251(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x15DF4
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_252(int iParam0)//Position - 0x160CD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_253(int iParam0)//Position - 0x16224
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_254(int iParam0)//Position - 0x16732
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_255(int iParam0)//Position - 0x167A7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_256(int iParam0)//Position - 0x1681B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_257(int iParam0)//Position - 0x16902
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_258(int iParam0)//Position - 0x16C65
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_259(int iParam0)//Position - 0x16E76
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_260(int iParam0)//Position - 0x170A6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_261(int iParam0)//Position - 0x171B6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_262(int iParam0)//Position - 0x17B55
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_263(int iParam0)//Position - 0x186CA
{
	if (iParam0 < 136)
	{
		func_265(iParam0);
...
void func_264(int iParam0)//Position - 0x186FF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_265(int iParam0)//Position - 0x19303
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_266(int iParam0)//Position - 0x1A211
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_267(int iParam0)//Position - 0x1A33E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_268(int iParam0, int iParam1)//Position - 0x1A43C
{
	switch (iParam0)
	{
		case 0:
...
void func_269(int iParam0)//Position - 0x1A52C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_270(int iParam0)//Position - 0x1BA1D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_271(int iParam0)//Position - 0x1BB6E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_272(int iParam0)//Position - 0x1C07B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_273(int iParam0)//Position - 0x1C6E9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_274(int iParam0)//Position - 0x1C75D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_275(int iParam0)//Position - 0x1C82D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_276(int iParam0)//Position - 0x1CD5D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_277(int iParam0)//Position - 0x1CEF4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_278(int iParam0)//Position - 0x1D6F2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_279(int iParam0)//Position - 0x1D802
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_280(int iParam0)//Position - 0x1E72D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_281(int iParam0)//Position - 0x1F3EA
{
	if (iParam0 < 107)
	{
		func_284(iParam0);
...
void func_282(int iParam0)//Position - 0x1F430
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_283(int iParam0)//Position - 0x1FED5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_284(int iParam0)//Position - 0x20DC8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_285(int iParam0)//Position - 0x21A11
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_286(int iParam0)//Position - 0x21C8A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_287(int iParam0, int iParam1)//Position - 0x21DD0
{
	switch (iParam0)
	{
		case 0:
...
void func_288(int iParam0)//Position - 0x21EC0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_289(int iParam0)//Position - 0x22C4A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_290(int iParam0)//Position - 0x22DC4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_291(int iParam0)//Position - 0x2333B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_293(int iParam0)//Position - 0x238D9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_294(int iParam0)//Position - 0x239A9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_295(int iParam0)//Position - 0x23E81
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_296(int iParam0)//Position - 0x240EB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_297(int iParam0)//Position - 0x243C1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_298(int iParam0)//Position - 0x2458A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_299(int iParam0)//Position - 0x250DE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_300(int iParam0)//Position - 0x25D28
{
	if (iParam0 < 60)
	{
		func_302(iParam0);
...
void func_301(int iParam0)//Position - 0x25D5D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_302(int iParam0)//Position - 0x26AFD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_303(int iParam0)//Position - 0x27189
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_304(int iParam0)//Position - 0x27270
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_305()//Position - 0x2736E
{
...
int func_306(int iParam0, int iParam1, int iParam2)//Position - 0x273E7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_307(bool bParam0)//Position - 0x27642
{
	int iVar0;
...
void func_308()//Position - 0x2767F
{
	bool bVar0;
	vector3 vVar1;
	...
	if (func_22(Local_68.f_9))
	{
		...
		switch (iLocal_60)
		{
			case 0:
				...
				vLocal_336 = { unk_0x8000C77B5F336760(Local_68.f_9, 0) };
...
int func_309(var uParam0)//Position - 0x27B5A
{
	vector3 vVar0;
...
int func_310(var uParam0)//Position - 0x27B9F
{
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
...
bool func_311(char* sParam0, int iParam1, int iParam2)//Position - 0x27BD7
{
...
void func_312(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x27BF5
{
...
void func_313(char* sParam0, int iParam1, int iParam2)//Position - 0x27CA1
{
	iParam2 = iParam2;
...
int func_314(char* sParam0, bool bParam1)//Position - 0x27CBA
{
	struct<6> Var0;
...
struct<6> func_315()//Position - 0x27CF5
{
	struct<6> Var0;
...
void func_316(int iParam0, vector3 vParam1, int iParam2, float fParam3)//Position - 0x27D19
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_317(var uParam0, int iParam1, int iParam2)//Position - 0x27DFE
{
	char* sVar0;
...
int func_318(char* sParam0)//Position - 0x27EDB
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_319()//Position - 0x27EEE
{
	if (func_22(Local_68.f_9))
	{
...
int func_320(int iParam0, vector3 vParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)//Position - 0x27FE9
{
	int iVar0;
...
int func_321(int iParam0, vector3 vParam1, float fParam2, float fParam3)//Position - 0x28161
{
...
int func_322(int iParam0, vector3 vParam1)//Position - 0x28199
{
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
...
void func_323(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x281F7
{
	func_324(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_324(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x28211
{
	func_325(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_325(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x2822E
{
...
void func_326(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x28266
{
	int iVar0;
	int iVar1;
...
void func_327(var uParam0)//Position - 0x285D3
{
...
int func_328(var uParam0)//Position - 0x2863C
{
	int iVar0;
...
int func_329(bool bParam0)//Position - 0x28667
{
	switch (Global_8D15)
	{
		case 0:
...
void func_330(char* sParam0, int iParam1)//Position - 0x28711
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_331(char* sParam0)//Position - 0x28728
{
	if (!func_332(1, 1, 0))
	{
...
int func_332(bool bParam0, bool bParam1, bool bParam2)//Position - 0x287C1
{
	int iVar0;
	int iVar1;
...
int func_333(int iParam0)//Position - 0x28A0F
{
	if (iParam0 != func_335())
	{
...
int func_334(int iParam0, bool bParam1, bool bParam2)//Position - 0x28A75
{
	int iVar0;
...
int func_335()//Position - 0x28ABF
{
	return 4294967295;
}

int func_336(int iParam0, int iParam1)//Position - 0x28AC8
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		if (VEHICLE::GET_NUM_MOD_KITS(iParam0) > 0)
...
int func_337(int iParam0, int iParam1)//Position - 0x28B2A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_338()//Position - 0x28BAF
{
	return Global_255C02.f_10;
}

bool func_339(int iParam0)//Position - 0x28BBD
{
	return iParam0 == 51;
}

var func_340()//Position - 0x28BCA
{
	return Global_255C02.f_F;
}

bool func_341()//Position - 0x28BD8
{
	return MISC::GET_GAME_TIMER() <= Global_43D7.f_16F1 + 100;
}

void func_342(var uParam0, int iParam1, vector3 vParam2, int iParam3)//Position - 0x28BED
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_343()//Position - 0x28CFD
{
	return func_344(CAM::_0xDC9DA9E8789F5246());
}

int func_344(int iParam0)//Position - 0x28D0D
{
...
int func_345(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x28D2C
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_346(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29098
{
...
int func_347(bool bParam0, bool bParam1, bool bParam2)//Position - 0x290EA
{
	if (!func_332(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_348(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29133
{
	if (!func_332(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_349(bool bParam0, bool bParam1, bool bParam2)//Position - 0x29192
{
	if (!func_332(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_350(int iParam0)//Position - 0x291E8
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_351()//Position - 0x29243
{
	MISC::SET_BIT(&Global_950, 4);
}

void func_352(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x29253
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
...
int func_353(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x2934E
{
	int iVar0;
	bool bVar1;
...
void func_354(int iParam0)//Position - 0x293A0
{
...
void func_355(var uParam0, vector3 vParam1)//Position - 0x293E6
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_356()//Position - 0x294C3
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			switch (Local_68.f_A)
			{
				...
				case 30:
					if (!func_63(Local_68.f_9, 242628503))
					{
						...
						BRAIN::OPEN_SEQUENCE_TASK(&uLocal_143);
						...
						CUTSCENE::_0x8D9DF6ECA8768583(uLocal_143);
						BRAIN::TASK_PERFORM_SEQUENCE(Local_68.f_9, uLocal_143);
						BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_143);
						ENTITY::SET_ENTITY_HEALTH(Local_68.f_9, 1);
					}
					break;
				...
				case 31:
					if (func_113(Local_68.f_12, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						BRAIN::OPEN_SEQUENCE_TASK(&uLocal_143);
						BRAIN::TASK_AIM_GUN_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 1500, 0);
						BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_332, AUDIO::_0x0626A247D2405330(), 1f, 1, 1056964608, 1082130432, 1, 0, 0, 3337513804, 20000);
						BRAIN::TASK_SEEK_COVER_FROM_PED(0, AUDIO::_0x0626A247D2405330(), MISC::GET_RANDOM_INT_IN_RANGE(1500, 2500), 1);
						BRAIN::TASK_COMBAT_PED(0, AUDIO::_0x0626A247D2405330(), 0, 16);
						BRAIN::TASK_SET_SPHERE_DEFENSIVE_AREA(0, vLocal_332, 50f);
						CUTSCENE::_0x8D9DF6ECA8768583(uLocal_143);
						BRAIN::TASK_PERFORM_SEQUENCE(Local_68.f_9, uLocal_143);
						BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_143);
						ENTITY::SET_ENTITY_HEALTH(Local_68.f_9, 1);
				...
				case 33:
					if (func_113(Local_68.f_12, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						BRAIN::OPEN_SEQUENCE_TASK(&uLocal_143);
						BRAIN::TASK_AIM_GUN_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 750, 0);
						BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_332, AUDIO::_0x0626A247D2405330(), 2f, 1, 0.5f, 4f, 1, 0, 0, 3607063905, 20000);
						BRAIN::TASK_SEEK_COVER_FROM_PED(0, AUDIO::_0x0626A247D2405330(), MISC::GET_RANDOM_INT_IN_RANGE(1000, 2000), 0);
						BRAIN::TASK_SET_SPHERE_DEFENSIVE_AREA(0, vLocal_332, 50f);
						CUTSCENE::_0x8D9DF6ECA8768583(uLocal_143);
						BRAIN::TASK_PERFORM_SEQUENCE(Local_68.f_9, uLocal_143);
						BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_143);
				...
				case 35:
					if (func_113(Local_68.f_12, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						BRAIN::OPEN_SEQUENCE_TASK(&uLocal_143);
						BRAIN::TASK_AIM_GUN_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 750, 0);
						BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_332, AUDIO::_0x0626A247D2405330(), 2f, 1, 0.75f, 4f, 1, 0, 0, 3607063905, 20000);
						CUTSCENE::_0x8D9DF6ECA8768583(uLocal_143);
						BRAIN::TASK_PERFORM_SEQUENCE(Local_68.f_9, uLocal_143);
						BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_143);
						ENTITY::SET_ENTITY_HEALTH(Local_68.f_9, 1);
				...
				case 13:
					if (func_113(Local_68.f_12, MISC::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						...
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 5, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_68.f_9, 17, 1);
						BRAIN::TASK_SMART_FLEE_PED(Local_68.f_9, AUDIO::_0x0626A247D2405330(), 200f, 4294967295, 0, 0);
						ENTITY::SET_ENTITY_HEALTH(Local_68.f_9, 1);
						PED::SET_PED_KEEP_TASK(Local_68.f_9, 1);
						Local_68.f_A = 14;
					}
				...
				case 23:
					if (func_361(Local_68.f_9, Local_68.f_13, 100f, 1, 1090519040, 1097859072, 0) || func_360())
					{
						...
						{
							BRAIN::TASK_LOOK_AT_ENTITY(Local_68.f_9, AUDIO::_0x0626A247D2405330(), 4294967295, 0, 2);
							if ((!func_357(Local_68.f_13, 10) && func_105(Local_68.f_9, vLocal_331, 50f)) || !func_113(iLocal_140, 2000))
							{
					...
					if (func_361(Local_68.f_9, Local_68.f_13, 100f, 1, 1090519040, 1097859072, 0) || func_360())
					{
						if (!func_63(Local_68.f_9, 2775823996))
						{
							if (!func_63(Local_68.f_9, 3419293077))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 0))
								{
									if (!func_357(Local_68.f_13, 10) && func_105(Local_68.f_9, vLocal_331, 50f))
									{
										BRAIN::TASK_LEAVE_ANY_VEHICLE(Local_68.f_9, 0, 0);
										Local_68.f_A = 23;
									}
							...
							else if (!func_357(Local_68.f_13, 10) && func_105(Local_68.f_9, vLocal_331, 50f))
							{
...
bool func_357(int iParam0, int iParam1)//Position - 0x2A96D
{
	return (MISC::GET_FRAME_COUNT() - iParam0) > iParam1;
}

int func_358()//Position - 0x2A97F
{
	int iVar0;
	int iVar1;
...
var func_359()//Position - 0x2AA05
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

int func_360()//Position - 0x2AA15
{
	if (!iLocal_82)
	{
		return 1;
...
int func_361(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)//Position - 0x2AA82
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_362(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2AC38
{
	int iVar0;
...
int func_363(float fParam0, float fParam1, float fParam2)//Position - 0x2AD2F
{
...
char* func_364()//Position - 0x2AD4B
{
	return "move_m@bail_bond_not_tazered";
}

char* func_365()//Position - 0x2AD57
{
	return "move_m@bail_bond_tazered";
}

int func_366()//Position - 0x2AD63
{
...
void func_367(var uParam0, bool bParam1)//Position - 0x2AD98
{
...
void func_368(int iParam0, var uParam1, float fParam2, int iParam3)//Position - 0x2ADAF
{
	if (func_428(iParam0))
	{
...
bool func_369(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2ADDB
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_370(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2AE9C
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_371(int iParam0, int iParam1)//Position - 0x2AFC8
{
	int iVar0;
...
int func_373(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2B0D7
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
float func_374(vector3 vParam0, vector3 vParam1)//Position - 0x2B168
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

int func_375(int iParam0, int iParam1)//Position - 0x2B189
{
	int iVar0;
...
void func_376(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2B1C8
{
	if (func_428(iParam0))
	{
...
void func_377()//Position - 0x2B1F4
{
	if (func_58(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 1), vLocal_330, 100f))
	{
		if (!func_378())
		{
	...
	{
		if (!func_58(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 1), vLocal_330, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
...
bool func_378()//Position - 0x2B27E
{
	return Global_1620C;
}

void func_379()//Position - 0x2B28A
{
	func_36();
	func_377();
	if (func_22(Local_68.f_9))
...
int func_380(int iParam0, vector3 vParam1, int iParam2, int iParam3, float fParam4)//Position - 0x2B59E
{
	vector3 vVar0;
	var uVar1;
	char[] cVar2[8];
...
void func_381(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2B62B
{
...
void func_382()//Position - 0x2B666
{
	int iVar0;
	int iVar1;
...
int func_383(int iParam0)//Position - 0x2BAC2
{
	int iVar0;
...
void func_384(char* sParam0, int iParam1)//Position - 0x2BAFB
{
	if (func_318(sParam0))
	{
...
void func_385(int iParam0)//Position - 0x2BB12
{
...
void func_386()//Position - 0x2BB4D
{
	func_36();
	func_377();
	if (func_22(Local_68.f_9))
			...
			case 1:
				if (!iLocal_108)
				{
					...
					else
					{
						...
						if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_330, 4f, 4f, 2f, 1, 1, 0))
						{
						}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
						{
							if (func_105(AUDIO::_0x0626A247D2405330(), vLocal_330, 6.5f))
							{
								iLocal_60 = 2;
							}
						}
						else if (func_105(AUDIO::_0x0626A247D2405330(), vLocal_330, 2.5f))
						{
							iLocal_60 = 2;
						}
					}
...
int func_387(vector3 vParam0, vector3 vParam1, float fParam2)//Position - 0x2BF22
{
	int iVar0;
...
bool func_388(vector3 vParam0, vector3 vParam1, float fParam2)//Position - 0x2C016
{
	vector3 vVar0;
...
int func_389(vector3 vParam0, int iParam1, int iParam2)//Position - 0x2C040
{
	int iVar0;
...
void func_390()//Position - 0x2C06E
{
	bool bVar0;
...
void func_391(bool bParam0, var uParam1)//Position - 0x2C48D
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_392(int iParam0)//Position - 0x2C57A
{
	int iVar0;
...
void func_393(int iParam0)//Position - 0x2C5C3
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_22(Local_69[iVar0 /*19*/]))
		{
			func_368(Local_69[iVar0 /*19*/], &(Local_69[iVar0 /*19*/].f_10), 1126825984, 7);
			switch (Local_69[iVar0 /*19*/].f_E)
			{
				...
				case 1:
					...
					if (func_113(Local_69[iVar0 /*19*/].f_F, iVar2))
					{
						func_114(iVar0);
					}
					break;
				...
				case 2:
					if (func_395(Local_69[iVar0 /*19*/], Local_69[iVar0 /*19*/].f_10, 50f, 1, 1, 12f, 15f))
					{
						if (!func_22(Local_68.f_9) || (PED::IS_PED_FLEEING(Local_68.f_9) && BRAIN::GET_PED_DESIRED_MOVE_BLEND_RATIO(Local_68.f_9) > 1f))
						{
							if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_69[iVar0 /*19*/], 2775823996) == 1)
							{
								if (iVar0 == 0)
								{
									iVar2 = 750;
								...
								BRAIN::UPDATE_TASK_HANDS_UP_DURATION(Local_69[iVar0 /*19*/], iVar2);
							}
							else
							{
								NETWORK::_0x5E3AA4CA2B6FB0EE(Local_69[iVar0 /*19*/]);
								BRAIN::CLEAR_PED_SECONDARY_TASK(Local_69[iVar0 /*19*/]);
							}
							Local_69[iVar0 /*19*/].f_E = 4;
							func_109(&(Local_69[iVar0 /*19*/].f_6));
						}
					...
					else if (!func_63(Local_69[iVar0 /*19*/], 780511057))
					{
						...
						{
							if (!func_357(Local_69[iVar0 /*19*/].f_10, 10))
							{
								PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_69[iVar0 /*19*/], unk_0x8000C77B5F336760(Local_69[iVar0 /*19*/], 1), 5f, 0, 0);
								BRAIN::TASK_COMBAT_PED(Local_69[iVar0 /*19*/], AUDIO::_0x0626A247D2405330(), 0, 16);
								ENTITY::SET_ENTITY_HEALTH(Local_69[iVar0 /*19*/], 1);
							}
						}
					}
					else
					{
						...
						{
							NETWORK::_0x5E3AA4CA2B6FB0EE(Local_69[iVar0 /*19*/]);
							BRAIN::TASK_LOOK_AT_ENTITY(Local_69[iVar0 /*19*/], AUDIO::_0x0626A247D2405330(), 4294967295, 0, 2);
							BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(Local_69[iVar0 /*19*/], AUDIO::_0x0626A247D2405330(), 4294967295);
							ENTITY::SET_ENTITY_HEALTH(Local_69[iVar0 /*19*/], 0);
						}
						func_394(Local_69[iVar0 /*19*/], &(Local_69[iVar0 /*19*/].f_6), 4294967295, 0, 0, 0, 3212836864, 0, 4294967295, 4294967295, 1);
					}
					break;
				
				case 3:
					if (!func_63(Local_69[iVar0 /*19*/], 2277090178))
					{
						if (func_395(Local_69[iVar0 /*19*/], Local_69[iVar0 /*19*/].f_10, 50f, 1, 1, 12f, 15f))
						{
							func_99(Local_69[iVar0 /*19*/], 1);
				...
				case 4:
					if (!func_63(Local_69[iVar0 /*19*/], 2775823996))
					{
...
int func_394(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x2C917
{
	if (iParam3 == 0)
	{
...
int func_395(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, float fParam6)//Position - 0x2CAEE
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	if (func_22(iParam0))
	{
		if (func_362(1, 0, 1))
		{
			...
			if (func_105(iParam0, vLocal_331, fParam2))
			{
				...
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(AUDIO::_0x0626A247D2405330(), iParam0) || PED::HAS_PED_RECEIVED_EVENT(iParam0, 56))
				{
					return 1;
				}
			}
			...
			if (FIRE::IS_EXPLOSION_IN_SPHERE(4294967295, vVar0, fParam6))
			{
				return 1;
			}
			vVar1 = { vVar0 };
...
void func_396(int iParam0)//Position - 0x2CC87
{
	int iVar0;
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_22(Local_69[iVar0 /*19*/]))
		{
			Local_69[iVar0 /*19*/].f_F = MISC::GET_GAME_TIMER();
...
void func_397()//Position - 0x2CCC6
{
	if (func_22(Local_68.f_9))
	{
		func_376(Local_68.f_9, &iLocal_133, 1126825984, 1);
		func_368(Local_68.f_9, &(Local_68.f_13), 120f, 7);
		func_356();
		switch (iLocal_60)
		{
			case 0:
					...
					case 2:
						...
						else
						{
							...
							if (func_105(Local_68.f_9, vLocal_331, 25f) && func_407(Local_68.f_9, vLocal_331, 10f))
							{
								...
								else if (func_406(&(Local_68.f_13)))
								{
									iLocal_61 = 1;
									iLocal_91 = 0;
									if (Local_68.f_A != 3 && Local_68.f_A != 4)
						...
						if (func_361(Local_68.f_9, Local_68.f_13, 25f, 0, 1090519040, 1097859072, 0))
						{
							iLocal_60 = 2;
						}
						break;
...
void func_398(bool bParam0)//Position - 0x2D18A
{
...
void func_399()//Position - 0x2D1AE
{
	Global_3960 = 0;
	func_400();
}

void func_400()//Position - 0x2D1BE
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_401()//Position - 0x2D1E2
{
	if (!iLocal_92)
	{
		if (!func_61())
...
struct<6> func_402()//Position - 0x2D307
{
	struct<6> Var0;
	int iVar1;
	int iVar2;
...
int func_403(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2D3B3
{
	if (iParam5 == 0)
	{
		if (HUD::IS_MESSAGE_BEING_DISPLAYED())
...
bool func_404(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2D3F0
{
...
int func_405(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)//Position - 0x2D444
{
	if (func_428(iParam0))
	{
		if (!func_357(iParam1, 10))
...
int func_406(var uParam0)//Position - 0x2D4AA
{
...
int func_407(int iParam0, vector3 vParam1, float fParam2)//Position - 0x2D4C4
{
	vector3 vVar0;
	float fVar1;
...
void func_408()//Position - 0x2D4F3
{
	switch (iLocal_60)
	{
		case 0:
...
void func_409(var uParam0, var uParam1)//Position - 0x2D720
{
	if (!uParam0->f_7)
	{
...
char* func_410(int iParam0)//Position - 0x2D7B1
{
	switch (iParam0)
	{
		case 0:
...
char* func_411(int iParam0)//Position - 0x2D7F6
{
	switch (iParam0)
	{
		case 0:
...
int func_412(int iParam0, int iParam1, int iParam2)//Position - 0x2D839
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_413(int iParam0)//Position - 0x2D923
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_414(int iParam0)//Position - 0x2D987
{
	switch (iParam0)
	{
		case 0:
...
void func_415()//Position - 0x2D9C4
{
	if (bLocal_103)
	{
...
void func_416()//Position - 0x2DA21
{
	if (bLocal_103)
	{
...
void func_417()//Position - 0x2DA6B
{
...
int func_418(bool bParam0)//Position - 0x2DBAA
{
	if (func_22(Local_75))
	{
...
int func_419(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2DD02
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_428(AUDIO::_0x0626A247D2405330()) && func_428(iParam0))
	{
...
int func_420(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2DDFD
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_421(int iParam0, float fParam1)//Position - 0x2DF09
{
	var uVar0;
	vector3 vVar1;
...
int func_422(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0x2DF9E
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
int func_423(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2E02C
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
...
int func_424(int iParam0, float fParam1)//Position - 0x2E074
{
	float fVar0;
	
	if (func_428(AUDIO::_0x0626A247D2405330()) && func_428(iParam0))
	{
		if (func_426(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iParam0))
		{
...
bool func_425(int iParam0, float fParam1)//Position - 0x2E0EA
{
	return func_369(iParam0, AUDIO::_0x0626A247D2405330(), fParam1, 1, 250, 7);
}

int func_426(int iParam0)//Position - 0x2E102
{
...
void func_427(int iParam0, vector3 vParam1, float fParam2, bool bParam3, bool bParam4)//Position - 0x2E12A
{
...
int func_428(int iParam0)//Position - 0x2E158
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
bool func_429(bool bParam0)//Position - 0x2E179
{
...
void func_430(int iParam0, bool bParam1)//Position - 0x2E1A4
{
	func_440(bParam1, 1);
	if (bParam1)
	{
...
void func_431()//Position - 0x2E233
{
	func_432(1, 0);
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
...
void func_432(bool bParam0, bool bParam1)//Position - 0x2E2A5
{
	HUD::CLEAR_PRINTS();
	if (HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
	{
...
void func_433(bool bParam0)//Position - 0x2E3BC
{
	if (bParam0)
	{
...
void func_434()//Position - 0x2E3F7
{
	STREAMING::REMOVE_ANIM_SET(func_364());
	STREAMING::REMOVE_ANIM_SET(func_365());
}

void func_435(bool bParam0, int iParam1, int iParam2)//Position - 0x2E40F
{
	bool bVar0;
...
void func_436(int iParam0)//Position - 0x2E46E
{
	Global_16209 = iParam0;
}

void func_437(bool bParam0)//Position - 0x2E47C
{
	if (bParam0)
	{
...
void func_438(bool bParam0)//Position - 0x2E558
{
	if (bParam0)
	{
		func_439();
...
void func_439()//Position - 0x2E5BB
{
...
void func_440(bool bParam0, bool bParam1)//Position - 0x2E5E4
{
	if (bParam0)
	{
		func_435(0, 1, 1);
...
void func_441(vector3 vParam0, float fParam1, int iParam2, int iParam3)//Position - 0x2E617
{
	if (func_515())
	{
...
void func_442(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x2E6AC
{
	int iVar0;
...
int func_443(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)//Position - 0x2E840
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
		...
		if (Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_478(iParam0, &(Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/].f_1F), &(Global_19E56.f_933.f_21B.f_953[0 /*295*/][iParam1 /*98*/].f_51));
		...
		else if (Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				...
				func_478(iParam0, &(Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/].f_1F), &(Global_19E56.f_933.f_21B.f_953[1 /*295*/][iParam1 /*98*/].f_51));
				GRAPHICS::_ADD_CLAN_DECAL_TO_VEHICLE(*iParam0, Var2.f_60);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("BODHI2"))
...
void func_444(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2F684
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_83(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(*iParam1, 0))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_448(*iParam1, 0, &uVar0))
		{
			...
			if (bParam3)
			{
				...
				Global_19E56.f_4E7A[iParam0 /*43*/].f_1F = func_447(*iParam1);
				...
				func_445(Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_19E56.f_4E7A[iParam0 /*43*/].f_1));
				...
				func_445(Global_19E56.f_933.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_6, 4294967295, iVar3, 0, &(Global_19E56.f_4E7A[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_445(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x3029B
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_446(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x3030E
{
	*uParam2 = 4294967295;
	*uParam3 = 4294967295;
	*uParam4 = 4294967295;
...
float func_447(int iParam0)//Position - 0x31800
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_448(int iParam0, bool bParam1, var uParam2)//Position - 0x318B0
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_473(iVar0, bParam1, uParam2) && !func_472(CAM::_0xDC9DA9E8789F5246())) && !func_456(iParam0))
	{
		return 0;
	}
	if (func_472(CAM::_0xDC9DA9E8789F5246()))
	{
		if (func_455(iVar0))
		{
			return 1;
	...
	bVar1 = false;
	if (func_454(CAM::_0xDC9DA9E8789F5246()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_452(iParam0)) && !bVar1) && !(func_451(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_449(CAM::_0xDC9DA9E8789F5246())))
	{
...
int func_449(int iParam0)//Position - 0x31A1E
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			...
			{
				return func_450(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 11;
			}
		}
	}
	return 0;
...
int func_450(int iParam0)//Position - 0x31A65
{
	switch (iParam0)
	{
		case 0:
...
int func_451(int iParam0)//Position - 0x31DBF
{
...
int func_452(int iParam0)//Position - 0x31E01
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("MONSTER4"):
		case joaat("MONSTER5"):
			if (func_453(CAM::_0xDC9DA9E8789F5246()))
			{
				return 1;
			}
			break;
...
int func_453(int iParam0)//Position - 0x31E94
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			if (Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295)
			{
				return func_450(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 13;
			}
		}
	}
	return 0;
...
int func_454(int iParam0)//Position - 0x31EDB
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			if (Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295)
			{
				return func_450(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 7;
			}
		}
	}
	return 0;
...
int func_455(int iParam0)//Position - 0x31F21
{
	switch (iParam0)
	{
		case joaat("AVENGER"):
...
int func_456(int iParam0)//Position - 0x31F56
{
	if (func_471(CAM::_0xDC9DA9E8789F5246()) || func_470(CAM::_0xDC9DA9E8789F5246()))
	{
		if (func_457(iParam0))
		{
			return 1;
...
int func_457(int iParam0)//Position - 0x31F85
{
...
int func_458(int iParam0)//Position - 0x3203C
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || !OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		return 0;
...
int func_459(int iParam0)//Position - 0x32072
{
	switch (iParam0)
	{
		case joaat("APC"):
...
int func_460(int iParam0, bool bParam1)//Position - 0x320CB
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("INSURGENT"):
			if (func_462(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				...
				else if (func_461(iParam0) != 4294967295 && !bParam1)
				{
					return 1;
				}
			}
...
int func_461(int iParam0)//Position - 0x32126
{
	int iVar0;
...
int func_462(int iParam0, int iParam1)//Position - 0x32160
{
	if (iParam1 == 0)
	{
...
bool func_463()//Position - 0x324D4
{
	return DLC::IS_DLC_PRESENT(1927191088);
}

bool func_464()//Position - 0x324E5
{
	return DLC::IS_DLC_PRESENT(2067165443);
}

bool func_465()//Position - 0x324F6
{
	return DLC::IS_DLC_PRESENT(3337689893);
}

bool func_466()//Position - 0x32507
{
	return DLC::IS_DLC_PRESENT(210122941);
}

bool func_467()//Position - 0x32518
{
	return DLC::IS_DLC_PRESENT(2400444888);
}

bool func_468()//Position - 0x32529
{
	return DLC::IS_DLC_PRESENT(1630677557);
}

int func_469(int iParam0, int iParam1)//Position - 0x3253A
{
	switch (iParam0)
	{
		case joaat("FACTION2"):
...
int func_470(int iParam0)//Position - 0x328B0
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			...
			{
				return func_450(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 5;
			}
		}
	}
	return 0;
...
int func_471(int iParam0)//Position - 0x3290F
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			if (Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295 && Global_24FBF9[iParam0 /*413*/].f_135.f_7 != func_335())
			{
				return func_450(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 8;
			}
		}
	}
	return 0;
...
int func_472(int iParam0)//Position - 0x3296F
{
	if (iParam0 != func_335())
	{
		if (func_334(iParam0, 1, 1))
		{
			if (Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295)
			{
				return func_450(Global_24FBF9[iParam0 /*413*/].f_135.f_4) == 9;
			}
		}
	}
	return 0;
...
int func_473(int iParam0, bool bParam1, var uParam2)//Position - 0x329B6
{
	bool bVar0;
	...
	bVar0 = false;
	if (func_454(CAM::_0xDC9DA9E8789F5246()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_474(int iParam0)//Position - 0x32DCE
{
	switch (iParam0)
	{
		case joaat("TOWTRUCK"):
...
void func_475(int iParam0, int iParam1)//Position - 0x32DF7
{
	int iVar0;
...
void func_476(int iParam0)//Position - 0x32E79
{
	if (!func_477(*iParam0))
	{
...
bool func_477(int iParam0)//Position - 0x32EA4
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_478(int iParam0, var uParam1, var uParam2)//Position - 0x32EB3
{
	int iVar0;
	int iVar1;
...
int func_479(int iParam0)//Position - 0x33076
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_480(var uParam0)//Position - 0x33152
{
...
int func_481(int iParam0, int iParam1)//Position - 0x33192
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_482(var uParam0, int iParam1)//Position - 0x33277
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_483(int iParam0, int iParam1)//Position - 0x332B8
{
	int iVar0;
...
void func_484(vector3 vParam0, float fParam1, bool bParam2)//Position - 0x33356
{
	int iVar0;
...
void func_485(int iParam0)//Position - 0x333A6
{
	bool bVar0;
	...
	if (func_157(&(Global_11188.f_22B[0 /*21*/]), iParam0))
	{
		...
		if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11188.f_22B[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_163(iParam0, 0)) && Global_11515.f_42 == 0) && Global_19E56.f_7F5D.f_7A6[Global_11188.f_22B[0 /*21*/].f_E] != 0) && Global_19E56.f_7F5D.f_7A6[Global_11188.f_22B[0 /*21*/].f_E] > 3) && (!func_486(0, Global_11188.f_22B[0 /*21*/].f_C) || !func_486(1, Global_11188.f_22B[0 /*21*/].f_C)))
			{
...
int func_486(int iParam0, int iParam1)//Position - 0x33518
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_487(&(Global_19E56.f_7F5D.f_13AE[iVar0 /*157*/])))
	{
		return 0;
	}
...
int func_487(var uParam0)//Position - 0x3358A
{
	return *uParam0;
}

int func_488(vector3 vParam0, float fParam1)//Position - 0x33595
{
	return func_489(&(Global_18531.f_B3B), vParam0, fParam1, 0);
}

int func_489(var uParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x335AF
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
	...
	if (func_506(uParam0))
	{
		...
		if (func_505(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_491(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_A) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_490(int iParam0)//Position - 0x33861
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_491(int iParam0, vector3 vParam1, bool bParam2)//Position - 0x33924
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("CARGOBOB"):
			if (func_493(iParam0, Global_11188.f_8B[38], 0))
			{
				func_485(38);
				return 1;
			}
		...
		case joaat("FIRETRUK"):
			if (func_493(iParam0, Global_11188.f_8B[43], 1))
			{
				func_485(43);
				return 1;
			}
		...
		case joaat("CUBAN800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_493(iParam0, uVar1[iVar3], 1) && func_492(unk_0x8000C77B5F336760(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
int func_492(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x33B2C
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_493(int iParam0, int iParam1, bool bParam2)//Position - 0x33BA7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_494(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x33C08
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		...
		if (((INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam1->f_4D, 15) || func_497(iParam0)) || (((uParam1->f_3E == 0 && uParam1->f_3F == 0) && uParam1->f_40 == 0) && uParam1->f_9[20] > 0)) && func_496())
		{
			uParam1->f_3E = 0;
			uParam1->f_3F = 0;
			uParam1->f_40 = 0;
...
void func_495(int iParam0, int iParam1)//Position - 0x34159
{
	int iVar0;
	int iVar1;
...
bool func_496()//Position - 0x341BE
{
	return DLC::IS_DLC_PRESENT(2603778600);
}

int func_497(int iParam0)//Position - 0x341CF
{
	int iVar0;
...
int func_498(int iParam0)//Position - 0x3421A
{
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
		if (!func_504(CAM::_0xDC9DA9E8789F5246(), 4294967295))
		{
	...
	if (func_500(CAM::_0xDC9DA9E8789F5246()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
		{
...
int func_499(int iParam0)//Position - 0x342A1
{
...
int func_500(int iParam0)//Position - 0x342D0
{
...
int func_501(int iParam0)//Position - 0x342ED
{
...
int func_502(int iParam0, int iParam1)//Position - 0x34310
{
...
int func_503(int iParam0)//Position - 0x3434B
{
	if (func_502(iParam0, 0))
	{
...
int func_504(int iParam0, int iParam1)//Position - 0x3436E
{
	int iVar0;
...
int func_505(var uParam0)//Position - 0x343BB
{
	if (func_506(uParam0))
	{
...
int func_506(var uParam0)//Position - 0x343F0
{
...
bool func_507()//Position - 0x3444F
{
	return func_505(&(Global_18531.f_B3B));
}

void func_508()//Position - 0x34462
{
	func_509(&(Global_18531.f_B3B));
}

void func_509(var uParam0)//Position - 0x34475
{
	if (func_506(uParam0))
	{
...
int func_510(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x34493
{
	...
	if (iParam2 == 0 && func_512(Global_18531.f_B3B.f_C.f_42))
	{
		return 0;
	}
...
int func_512(int iParam0)//Position - 0x34596
{
	switch (iParam0)
	{
		case joaat("POLICE"):
...
bool func_513()//Position - 0x345EF
{
	return func_506(&(Global_18531.f_B3B));
}

int func_514()//Position - 0x34602
{
...
void func_516()//Position - 0x34650
{
	vector3 vVar0;
	vector3 vVar1;
	...
	if (func_22(AUDIO::_0x0626A247D2405330()))
	{
		func_90(&uLocal_155, 2, AUDIO::_0x0626A247D2405330(), "TREVOR", 0, 1);
...
void func_517()//Position - 0x34795
{
	int iVar0;
	...
	if (func_22(Local_68.f_9))
	{
		...
		NETWORK::_SET_NETWORK_OBJECT_NON_CONTACT(Local_68.f_9, 1);
		if (Local_68.f_C != 0)
		{
			WEAPON::GIVE_WEAPON_TO_PED(Local_68.f_9, Local_68.f_C, 4294967295, false, true);
		}
		func_354(Local_68.f_9);
		...
		BRAIN::OPEN_SEQUENCE_TASK(&uLocal_143);
		BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "base", 8f, -1.5f, 4294967295, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "base", 8f, -1.5f, 4294967295, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "idle_a", 8f, -1.5f, 4294967295, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "idle_c", 8f, -1.5f, 4294967295, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "idle_a", 8f, -1.5f, 4294967295, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "base", 8f, -1.5f, 4294967295, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_c", "idle_a", 8f, -1.5f, 4294967295, 0, 0, 0, 0, 0);
		BRAIN::SET_SEQUENCE_TO_REPEAT(uLocal_143, 1);
		CUTSCENE::_0x8D9DF6ECA8768583(uLocal_143);
		BRAIN::TASK_PERFORM_SEQUENCE(Local_68.f_9, uLocal_143);
		BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_143);
	}
	...
	while (iVar0 <= 2)
	{
		if (func_22(Local_69[iVar0 /*19*/]))
		{
			...
			switch (iVar0)
			{
				case 0:
					BRAIN::OPEN_SEQUENCE_TASK(&uLocal_143);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "idle_b", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "base", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "base", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "base", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "idle_b", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobohang_out_street_b", "base", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::SET_SEQUENCE_TO_REPEAT(uLocal_143, 1);
					CUTSCENE::_0x8D9DF6ECA8768583(uLocal_143);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_69[iVar0 /*19*/], uLocal_143);
					BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_143);
					break;
				
				case 1:
					BRAIN::OPEN_SEQUENCE_TASK(&uLocal_143);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "base", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "base", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "idle_a", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "base", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "idle_b", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "base", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobotwitchy", "idle_a", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::SET_SEQUENCE_TO_REPEAT(uLocal_143, 1);
					CUTSCENE::_0x8D9DF6ECA8768583(uLocal_143);
				...
				case 2:
					BRAIN::OPEN_SEQUENCE_TASK(&uLocal_143);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "base", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "base", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "idle_c", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "idle_a", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "base", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "oddjobs@bailbond_hobodepressed", "idle_a", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::SET_SEQUENCE_TO_REPEAT(uLocal_143, 1);
					CUTSCENE::_0x8D9DF6ECA8768583(uLocal_143);
...
void func_518(int iParam0, char* sParam1, int iParam2)//Position - 0x34C8C
{
	char cVar0[16];
...
int func_519()//Position - 0x34CA8
{
	...
	if (iLocal_132 > 0)
	{
		...
		{
			if (func_53(&(Local_69[iVar2 /*19*/]), Local_69[iVar2 /*19*/].f_12, Local_69[iVar2 /*19*/].f_1, Local_69[iVar2 /*19*/].f_4, 0, 0, 0))
			{
...
int func_520(var uParam0, int iParam1, vector3 vParam2, int iParam3, int iParam4, bool bParam5)//Position - 0x34EDE
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_55(iParam4))
...
int func_521(var uParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0x34F4F
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_55(iParam1))
...
Vector3 func_522(struct<5> Param0, var uParam1, var uParam2, var uParam3)//Position - 0x34FEE
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_523(struct<5> Param0, var uParam1, var uParam2, var uParam3)//Position - 0x35062
{
	switch (Param0.f_4)
	{
		case 0:
...
void func_524()//Position - 0x350D6
{
	int iVar0;
...
float func_525()//Position - 0x35597
{
	return 75.15f;
}

Vector3 func_526()//Position - 0x355A4
{
	return 2727.29f, 4145.9f, 44.16f;
}

float func_527()//Position - 0x355BB
{
	return 71f;
}

Vector3 func_528()//Position - 0x355C8
{
	return 2727.686f, 4145.715f, 44.08f;
}

int func_529()//Position - 0x355DF
{
	return 1385417869;
}

float func_530()//Position - 0x355EC
{
	return -91.28f;
}

Vector3 func_531()//Position - 0x355F9
{
	return 2728.35f, 4145.59f, 43.3f;
}

int func_532()//Position - 0x35610
{
	return 3553022755;
}

float func_533()//Position - 0x3561D
{
	return 89.19f;
}

Vector3 func_534()//Position - 0x3562A
{
	return 2728.33f, 4145.6f, 43.89f;
}

int func_535(int iParam0)//Position - 0x35641
{
	if (!func_83(iParam0))
	{
		return Global_19E56.f_6D76[iParam0 /*29*/];
...
int func_536(bool bParam0)//Position - 0x3566C
{
...
int func_540(int iParam0)//Position - 0x357A4
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_539()) || Global_19A9D) || Global_6375) || func_545()) || func_88(8, 4294967295)) || func_544()) || func_543()) || func_537()) || func_538()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_539()) || Global_6375) || func_545()) || func_88(8, 4294967295)) || func_537()) || func_544()) || func_543()) || func_538()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_539()) || Global_19A9D) || Global_6375) || func_545()) || func_88(8, 4294967295)) || func_537()) || func_544()) || func_543()) || func_538()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_539()) || Global_19A9D) || Global_6375) || func_545()) || func_88(8, 4294967295)) || func_544()) || func_543()) || func_538()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_539() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_88(8, 4294967295)) || func_538()) || func_542()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_88(8, 4294967295) || func_544()) || func_543()) || func_542()) || func_541())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_539()) || Global_6375) || func_545()) || func_88(8, 4294967295)) || func_543()) || func_537()) || func_538()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_541()//Position - 0x35EC1
{
	return Global_16C57.f_1;
}

int func_542()//Position - 0x35ECF
{
...
bool func_543()//Position - 0x35EF5
{
	return Global_16C64.f_148 > 0;
}

bool func_544()//Position - 0x35F06
{
	return Global_16C64.f_147 > 0;
}

var func_545()//Position - 0x35F17
{
	return Global_140859;
}

bool func_546(int iParam0)//Position - 0x35F23
{
	return func_547(iParam0, Global_8D15);
}

int func_547(int iParam0, int iParam1)//Position - 0x35F34
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_548(int iParam0)//Position - 0x36115
{
	func_573();
	if (!func_572())
	{
...
void func_549(char* sParam0)//Position - 0x36160
{
	if (Global_16C30 != 12)
	{
...
int func_550(char* sParam0, int iParam1, int iParam2)//Position - 0x3617D
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
...
int func_551(char* sParam0)//Position - 0x3630F
{
...
void func_552(int iParam0, var uParam1)//Position - 0x36365
{
	switch (iParam0)
	{
		case 0:
...
void func_553(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, vector3 vParam6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0x3751A
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_554(int iParam0)//Position - 0x375AB
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_555(int iParam0)//Position - 0x378F1
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_556(int iParam0)//Position - 0x37928
{
	struct<2> Var0;
...
int func_557()//Position - 0x37D74
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_558(&(Global_16C30.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_558(char* sParam0, bool bParam1)//Position - 0x37D98
{
	int iVar0;
	int iVar1;
...
int func_559(int iParam0, bool bParam1)//Position - 0x37DC2
{
	int iVar0;
...
int func_561()//Position - 0x37E48
{
	...
	{
		if (func_551(&(Global_16C30.f_3)) > 4294967295)
		{
			return 1;
		}
	}
...
void func_562(int iParam0)//Position - 0x37EB4
{
	if (iParam0 == 1)
	{
		Global_8F3A = 1;
...
void func_563(bool bParam0)//Position - 0x37ECD
{
	unk_0x59B038076F830627(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_564(int iParam0)//Position - 0x37EE1
{
	if (iParam0 == 1)
	{
		HUD::_0xFDB423997FA30340();
...
void func_565(int iParam0)//Position - 0x37F1E
{
	if (iParam0 == 1)
	{
...
void func_566()//Position - 0x37F5B
{
	Global_434C.f_5 = 1;
}

void func_567()//Position - 0x37F69
{
	Global_434C.f_5 = 0;
}

void func_568()//Position - 0x37F77
{
	Global_155CF = 0;
	Global_155D0 = 0;
}

void func_569()//Position - 0x37F89
{
	Global_16C30 = 13;
...
void func_573()//Position - 0x38077
{
	Global_16C53 = 1;
...
void func_574()//Position - 0x38164
{
	if (iLocal_109)
	{
		func_432(0, 1);
