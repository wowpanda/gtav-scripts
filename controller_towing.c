...
void func_1()
{
	...
	{
		if (IS_ENTITY_OCCLUDED(iLocal_274))
		{
			SET_MODEL_AS_NO_LONGER_NEEDED(joaat("a_f_y_soucent_01"));
	...
	if (DOES_ENTITY_EXIST(iLocal_275))
	{
		if (IS_ENTITY_OCCLUDED(iLocal_275))
		{
			SET_MODEL_AS_NO_LONGER_NEEDED(joaat("towtruck"));
			if (IS_ENTITY_A_MISSION_ENTITY(iLocal_275))
			{
				DELETE_VEHICLE(&iLocal_275);
			}
		}
		else
		{
			SET_MODEL_AS_NO_LONGER_NEEDED(joaat("towtruck"));
			SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_275);
		}
	}
}
...
void func_2(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	*iParam3 = 500;
	if (!IS_ENTITY_DEAD(iParam1, 0))
	{
		...
		func_144(Global_106565.f_19967.f_3, &vVar3, &uVar7, &uVar0, &uVar6);
		...
		switch (*iParam0)
		{
			...
			case 17:
				if (!IS_THREAD_ACTIVE(uLocal_249))
				{
					...
					else
					{
						...
						func_139(&(Global_106565.f_19967.f_1), 8192);
						func_139(&(Global_106565.f_19967.f_1), 16384);
						if (DOES_ENTITY_EXIST(iLocal_274) && !IS_ENTITY_DEAD(iLocal_274, 0))
						{
							REMOVE_PED_FROM_GROUP(iLocal_274);
						}
						if (DOES_BLIP_EXIST(uLocal_273))
						{
							REMOVE_BLIP(&uLocal_273);
						}
						...
						if (Global_106565.f_19967.f_3 >= 5)
						{
							if (HAS_MODEL_LOADED(iLocal_271))
							{
								...
								if (!DOES_ENTITY_EXIST(iLocal_275))
								{
									...
									iLocal_275 = CREATE_VEHICLE(iLocal_271, 408.8376f, -1638.952f, 28.2928f, 230.2387f, 1, 1, 0);
									SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_271);
								}
								if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_ENTITY_DEAD(iLocal_275, 0))
								{
									SET_PED_INTO_VEHICLE(PLAYER_PED_ID(), iLocal_275, -1);
									SET_PED_COORDS_KEEP_VEHICLE(PLAYER_PED_ID(), 408.8376f, -1638.952f, 28.2928f);
									SET_ENTITY_HEADING(iLocal_275, 230.2387f);
									*iParam0 = 16;
								}
							}
						}
			...
			case 19:
				if ((GET_GAME_TIMER() - *uParam2) > iLocal_253)
				{
					*uParam2 = 0;
					*iParam0 = 0;
				}
...
int func_106()
{
	...
	if (HAS_SCRIPT_LOADED("Towing"))
	{
		...
		if (iVar0 == 1)
		{
			...
			vLocal_53.z = 1;
			uLocal_249 = START_NEW_SCRIPT_WITH_ARGS("Towing", &vLocal_53, 9, 28000);
			SET_SCRIPT_AS_NO_LONGER_NEEDED("Towing");
			if (!IS_ENTITY_DEAD(iLocal_274, 0))
			{
				SET_PED_KEEP_TASK(iLocal_274, 1);
			}
			SET_PED_AS_NO_LONGER_NEEDED(&iLocal_274);
			REMOVE_ANIM_DICT("amb@world_human_smoking@male@male_a@base");
			REMOVE_ANIM_DICT("oddjobs@towingcome_here");
...
void func_117()
{
	switch (iLocal_74)
	{
		case 1:
			if (!func_137())
			{
				if (!IS_HELP_MESSAGE_BEING_DISPLAYED() && !func_136(&uLocal_62))
				{
					SET_FRONTEND_RADIO_ACTIVE(0);
					func_134(&uLocal_62);
				}
				else if (!IS_HELP_MESSAGE_BEING_DISPLAYED() && func_136(&uLocal_62))
				{
...
float func_131(var uParam0)
{
	if (func_136(uParam0))
	{
		...
		{
			return (func_132(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	uParam0->f_1 = (func_132(IS_BIT_SET(*uParam0, 4)) - fParam1);
	SET_BIT(uParam0, 1);
	CLEAR_BIT(uParam0, 2);
	uParam0->f_2 = 0f;
}
	...
	if (IS_PED_IN_ANY_VEHICLE(iParam0, 0))
	{
		...
		if (!IS_ENTITY_DEAD(iVar0, 0))
		{
			if (GET_PED_IN_VEHICLE_SEAT(iVar0, -1, 0) == iParam0)
			{
				...
				{
					iLocal_275 = iVar0;
					if (DOES_ENTITY_EXIST(iLocal_275) && !IS_ENTITY_DEAD(iLocal_275, 0))
					{
						iLocal_271 = GET_ENTITY_MODEL(iLocal_275);
					}
					return 1;
				}
			}
...
void func_141(var uParam0, int iParam1)
{
	if (!func_145(uParam0, 0, 1))
	{
		if (func_138(iParam1))
		{
			if (IS_CONTROL_JUST_PRESSED(0, 86) || IS_DISABLED_CONTROL_PRESSED(0, 86))
			{
				if ((((((!func_137() && !IS_HELP_MESSAGE_BEING_DISPLAYED()) && !func_113(0)) && !func_57(6)) && !func_57(7)) && !GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) && func_105() == 1)
				{
					func_130(&uLocal_84, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					func_130(&uLocal_84, 4, 0, "TOWDISPATCH", 0, 1);
...
void func_143(var uParam0, vector3 vParam1, var uParam4, var uParam5)
{
	...
	fVar0 = VDIST2(vParam1, GET_ENTITY_COORDS(uParam0, 1));
	switch (iLocal_75)
	{
		case 0:
			...
			{
				uVar1 = GET_VEHICLE_PED_IS_IN(uParam0, 0);
				if (!IS_ENTITY_DEAD(uVar1, 0))
				{
					iVar2 = GET_ENTITY_MODEL(uVar1);
					if ((iVar2 == joaat("towtruck") || iVar2 == joaat("towtruck2")) && GET_ENTITY_HEALTH(uVar1) > 400)
					{
						return;
					}
				}
		...
		case 2:
			...
			{
				if (!IS_SPHERE_VISIBLE(vLocal_258, fLocal_261) || func_22(Global_106565.f_19967.f_1, 1073741824))
				{
					if (!DOES_ENTITY_EXIST(iLocal_275))
					{
						iLocal_275 = CREATE_VEHICLE(joaat("towtruck"), vParam1, uParam4, 1, 1, 0);
						SET_MODEL_AS_NO_LONGER_NEEDED(joaat("towtruck"));
						iLocal_75 = 3;
					}
				}
		...
		case 3:
			if (IS_PED_IN_ANY_VEHICLE(uParam0, 0))
			{
				if (GET_VEHICLE_PED_IS_IN(uParam0, 0) == iLocal_275)
				{
					iLocal_75 = 0;
				}
			}
			if (IS_ENTITY_DEAD(iLocal_275, 0))
			{
				iLocal_75 = 0;
			}
			if (fVar0 > 62500f)
...
int func_145(var uParam0, bool bParam1, bool bParam2)
{
	...
	if ((GET_GAME_TIMER() - iLocal_252) < iLocal_253)
	{
		return 0;
	}
	return 1;
