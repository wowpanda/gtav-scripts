...
void func_2(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	*iParam3 = 500;
	if (!ENTITY::IS_ENTITY_DEAD(iParam1, 0))
	{
		...
		func_142(Global_105220.f_19944.f_3, &vVar1, &fVar3, &uVar0, &uVar2);
		if (Global_105220.f_19944.f_3 >= 5 || uLocal_257)
		{
...
int func_104()
{
	...
	if (SCRIPT::HAS_SCRIPT_LOADED("Towing"))
	{
		...
		if (iVar0 == 1)
		{
			...
			vLocal_51.z = 1;
			iLocal_245 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS("Towing", &vLocal_51, 9, 23500);
			SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("Towing");
...
void func_115()
{
	switch (iLocal_70)
	{
		case 1:
			if (!func_135())
			{
				if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !func_134(&iLocal_58))
				{
					AUDIO::SET_FRONTEND_RADIO_ACTIVE(0);
					func_132(&iLocal_58);
				}
				else if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && func_134(&iLocal_58))
				{
...
float func_129(int iParam0)
{
	if (func_134(iParam0))
	{
		...
		{
			return (func_130(MISC::IS_BIT_SET(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
{
	iParam0->f_1 = (func_130(MISC::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
void func_139(var uParam0, int iParam1)
{
	if (!func_143(uParam0, 0, 1))
	{
		if (func_136(iParam1))
		{
			if (PAD::IS_CONTROL_JUST_PRESSED(0, 86) || PAD::IS_DISABLED_CONTROL_PRESSED(0, 86))
			{
				if ((((((!func_135() && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()) && !func_111(0)) && !func_57(6)) && !func_57(7)) && !PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) && func_103() == 1)
				{
					func_128(&uLocal_80, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					func_128(&uLocal_80, 4, 0, "TOWDISPATCH", 0, 1);
...
void func_141(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	switch (iLocal_71)
	{
		...
		case 2:
			...
			{
				if (!CAM::IS_SPHERE_VISIBLE(vLocal_254, fLocal_255) || func_22(Global_105220.f_19944.f_1, 1073741824))
				{
					if (!ENTITY::DOES_ENTITY_EXIST(iLocal_269))
					{
