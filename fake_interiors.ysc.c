...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_23(CAM::_0xDC9DA9E8789F5246()) && ENTITY::DOES_ENTITY_EXIST(func_22()))
		{
			iLocal_31 = func_22();
		}
		else
		{
			iLocal_31 = AUDIO::_0x0626A247D2405330();
		}
...
void func_1()//Position - 0xB1
{
	...
	{
		vVar0 = { unk_0x8000C77B5F336760(iLocal_31, false) };
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_2())
		{
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_32, 1))
			{
				GRAPHICS::_0x35FB78DC42B7BD21(&iLocal_32, 1);
			}
			if (HUD::IS_PAUSE_MENU_ACTIVE())
			{
				if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_32, 0))
				{
					HUD::SET_MINIMAP_COMPONENT(15, 1, 4294967295);
					MISC::SET_BIT(&iLocal_32, 0);
				}
			}
			else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_32, 0))
			{
				HUD::SET_MINIMAP_COMPONENT(15, 0, 4294967295);
				GRAPHICS::_0x35FB78DC42B7BD21(&iLocal_32, 0);
			}
		}
		else if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_32, 1))
		{
			HUD::SET_MINIMAP_COMPONENT(15, 0, 4294967295);
			GRAPHICS::_0x35FB78DC42B7BD21(&iLocal_32, 0);
...
int func_2()//Position - 0x1F3
{
	...
	if (func_5(CAM::_0xDC9DA9E8789F5246(), 1))
	{
		iVar0 = func_4();
		if (iVar0 != func_3())
		{
...
bool func_5(int iParam0, bool bParam1)//Position - 0x251
{
	...
	return Global_18CD5B[iParam0 /*560*/].f_B != func_3();
}
...
int func_6(int iParam0)//Position - 0x27C
{
	if (iParam0 != func_3())
	{
		if (Global_18CD5B[iParam0 /*560*/].f_B != func_3())
		{
