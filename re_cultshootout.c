...
void __EntryFunction__()
{
	...
	{
		WAIT(0);
		if ((IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_100) || (func_105() && IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_48, 500f, 500f, 500f, 0, 1, 0)))
		{
			if (!func_105())
			{
				if (func_104())
...
void func_1()
{
	if (iLocal_88 && !iLocal_87)
	{
		...
		while (iLocal_125 < 6)
		{
			if (!IS_PED_INJURED(iLocal_103[iLocal_125]))
			{
				if (DOES_BLIP_EXIST(uLocal_116[iLocal_125]))
				{
					REMOVE_BLIP(&(uLocal_116[iLocal_125]));
				}
				SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_103[iLocal_125]));
			}
			iLocal_125++;
		}
	...
	if (VDIST(func_2(PLAYER_ID()), vLocal_48) > 150f)
	{
		func_136();
	}
}
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_6(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_24()
{
	...
	{
		case 0:
			if (DOES_PICKUP_EXIST(uLocal_113))
			{
				if (DOES_BLIP_EXIST(uLocal_114))
				{
					if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_73, vLocal_76, fLocal_79, 0, 1, 0))
					{
						func_66();
						if (!bLocal_101)
						{
			...
			if (bLocal_101)
			{
				if ((GET_GAME_TIMER() - iLocal_130) > 6000)
				{
					if (!iLocal_102)
					{
		...
		case 1:
			if ((((IS_PED_INJURED(iLocal_103[0]) && IS_PED_INJURED(iLocal_103[1])) && IS_PED_INJURED(iLocal_103[2])) && IS_PED_INJURED(iLocal_103[3])) && IS_PED_INJURED(iLocal_103[4]))
			{
				func_25();
			}
			else if (!IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_48, 100f, 100f, 100f, 0, 1, 0))
			{
				func_25();
			}
			break;
...
void func_32()
{
	...
	{
		func_34(13, FLOOR(Global_106565.f_10188.f_3853));
	}
...
int func_60()
{
	switch (func_61(&Global_25824, 0, 5, 0, GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_67(var uParam0)
{
	...
	SET_BLIP_SCALE(uVar0, func_68(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
	return uVar0;
}
...
void func_69()
{
	if (HAS_PICKUP_BEEN_COLLECTED(uLocal_113))
	{
		if (DOES_BLIP_EXIST(uLocal_114))
		{
			REMOVE_BLIP(&uLocal_114);
...
void func_70()
{
	...
	while (iLocal_125 < 6)
	{
		...
		{
			if ((func_89() && iLocal_127 != 2) || (iLocal_127 == 1 && IS_PED_SHOOTING(PLAYER_PED_ID())))
			{
				func_87();
				WAIT(0);
				if (func_86())
			...
			switch (iLocal_127)
			{
				case 0:
					...
					{
						if ((IS_ENTITY_AT_ENTITY(iLocal_103[iLocal_125], PLAYER_PED_ID(), 15f, 15f, 40f, 0, 1, 0) && CAN_PED_HEAR_PLAYER(PLAYER_ID(), iLocal_103[iLocal_125])) || _CAN_PED_SEE_PED(iLocal_103[iLocal_125], PLAYER_PED_ID()))
						{
							if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_73, vLocal_76, fLocal_79, 0, 1, 0) || IS_ENTITY_AT_COORD(PLAYER_PED_ID(), 2205.918f, 5633.455f, 55.7472f, 15f, 15f, 40f, 0, 1, 0))
							{
								if (!func_55())
								{
								...
								{
									_0xF1C03A5352243A30(iLocal_103[iLocal_125]);
									OPEN_SEQUENCE_TASK(&uLocal_124);
									...
									CLOSE_SEQUENCE_TASK(uLocal_124);
									TASK_PERFORM_SEQUENCE(iLocal_103[iVar0], uLocal_124);
									CLEAR_SEQUENCE_TASK(&uLocal_124);
									SET_PED_USING_ACTION_MODE(iLocal_103[iVar0], 1, -1, 0);
									iVar0++;
								}
				...
				case 1:
					...
					while (iVar1 < iLocal_103)
					{
						if (!iLocal_90[iVar1])
						{
							...
							TASK_AIM_GUN_AT_ENTITY(0, PLAYER_PED_ID(), -1, 0);
							CLOSE_SEQUENCE_TASK(uLocal_124);
							TASK_PERFORM_SEQUENCE(iLocal_103[iVar1], uLocal_124);
							CLEAR_SEQUENCE_TASK(&uLocal_124);
							SET_PED_USING_ACTION_MODE(iLocal_103[iVar1], 1, -1, 0);
							iLocal_90[iVar1] = 1;
						}
						iVar1++;
					}
					if (!IS_PED_INJURED(iLocal_103[iLocal_125]))
					{
						if (!IS_PED_FACING_PED(iLocal_103[iLocal_125], PLAYER_PED_ID(), 50f))
						{
							TASK_LOOK_AT_ENTITY(iLocal_103[iLocal_125], PLAYER_PED_ID(), -1, 0, 2);
							SET_PED_KEEP_TASK(iLocal_103[iLocal_125], 1);
						}
					}
					...
					{
						if ((GET_GAME_TIMER() - iLocal_130) > 12000)
						{
							if (!func_55())
							{
								func_85(&uLocal_131, 3, iLocal_103[iLocal_125], "SalvadorGang", 0, 1);
					...
					if (iLocal_90[iLocal_125])
					{
						if (((GET_GAME_TIMER() - iLocal_130) > 18000 || (iLocal_129 - iLocal_128) > 5000) || IS_PED_IN_COMBAT(iLocal_103[iLocal_125], 0))
						{
							if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_73, vLocal_76, fLocal_79, 0, 1, 0) || IS_ENTITY_AT_ENTITY(iLocal_103[iLocal_125], PLAYER_PED_ID(), 15f, 15f, 5f, 0, 1, 0))
							{
								func_87();
								WAIT(0);
								if (func_86())
							...
							{
								if (!IS_PED_IN_COMBAT(iLocal_103[iLocal_125], 0))
								{
									CLEAR_PED_TASKS(iLocal_103[iLocal_125]);
									if (!IS_PED_INJURED(iLocal_103[0]))
									{
										OPEN_SEQUENCE_TASK(&uLocal_124);
										TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2205.769f, 5631.985f, 55.553f, 1f, -1, 1048576000, 0, 1193033728);
										TASK_TURN_PED_TO_FACE_COORD(0, 2214.833f, 5635.627f, 55.0029f, 8000);
										TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2222.259f, 5613.22f, 53.5576f, 1f, -1, 1048576000, 0, 1193033728);
										TASK_TURN_PED_TO_FACE_COORD(0, 2221.951f, 5593.625f, 52.9483f, 10000);
										SET_SEQUENCE_TO_REPEAT(uLocal_124, 1);
										CLOSE_SEQUENCE_TASK(uLocal_124);
										TASK_PERFORM_SEQUENCE(iLocal_103[0], uLocal_124);
										CLEAR_SEQUENCE_TASK(&uLocal_124);
										SET_PED_USING_ACTION_MODE(iLocal_103[0], 0, -1, 0);
									}
									if (!IS_PED_INJURED(iLocal_103[1]))
									{
										OPEN_SEQUENCE_TASK(&uLocal_124);
										TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2210.584f, 5580.684f, 52.8132f, 1f, -1, 1048576000, 0, 1193033728);
										TASK_TURN_PED_TO_FACE_COORD(0, 2205.466f, 5583.631f, 52.8682f, 8000);
										TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2203.039f, 5567.408f, 52.7996f, 1f, -1, 1048576000, 0, 1193033728);
										TASK_TURN_PED_TO_FACE_COORD(0, 2199.498f, 5560.702f, 52.8606f, 10000);
										SET_SEQUENCE_TO_REPEAT(uLocal_124, 1);
										CLOSE_SEQUENCE_TASK(uLocal_124);
										TASK_PERFORM_SEQUENCE(iLocal_103[1], uLocal_124);
										CLEAR_SEQUENCE_TASK(&uLocal_124);
										SET_PED_USING_ACTION_MODE(iLocal_103[1], 0, -1, 0);
									}
									if (!IS_PED_INJURED(iLocal_103[2]))
									{
										OPEN_SEQUENCE_TASK(&uLocal_124);
										TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2199.679f, 5590.673f, 52.7784f, 1f, -1, 1048576000, 0, 1193033728);
										TASK_TURN_PED_TO_FACE_COORD(0, 2210.646f, 5593.576f, 52.8312f, 8000);
										TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2232.761f, 5593.563f, 53.0542f, 1f, -1, 1048576000, 0, 1193033728);
										TASK_TURN_PED_TO_FACE_COORD(0, 2237.916f, 5599.589f, 53.2311f, 12000);
										SET_SEQUENCE_TO_REPEAT(uLocal_124, 1);
										CLOSE_SEQUENCE_TASK(uLocal_124);
										TASK_PERFORM_SEQUENCE(iLocal_103[2], uLocal_124);
										CLEAR_SEQUENCE_TASK(&uLocal_124);
										SET_PED_USING_ACTION_MODE(iLocal_103[2], 0, -1, 0);
									}
									if (!IS_PED_INJURED(iLocal_103[3]) && !IS_PED_INJURED(iLocal_103[4]))
									{
										OPEN_SEQUENCE_TASK(&uLocal_124);
										TASK_GO_TO_ENTITY(0, iLocal_103[4], -1, 2f, 1f, 1073741824, 0);
										TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_103[4], 0);
										TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
										CLOSE_SEQUENCE_TASK(uLocal_124);
										TASK_PERFORM_SEQUENCE(iLocal_103[3], uLocal_124);
										CLEAR_SEQUENCE_TASK(&uLocal_124);
										SET_PED_USING_ACTION_MODE(iLocal_103[3], 0, -1, 0);
									}
									if (!IS_PED_INJURED(iLocal_103[4]))
									{
										OPEN_SEQUENCE_TASK(&uLocal_124);
										TASK_GO_TO_ENTITY(0, iLocal_103[3], -1, 2f, 1f, 1073741824, 0);
										TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_103[3], 0);
										TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
										CLOSE_SEQUENCE_TASK(uLocal_124);
										TASK_PERFORM_SEQUENCE(iLocal_103[4], uLocal_124);
										CLEAR_SEQUENCE_TASK(&uLocal_124);
										SET_PED_USING_ACTION_MODE(iLocal_103[4], 0, -1, 0);
									}
									if (!IS_PED_INJURED(iLocal_103[5]))
									{
										TASK_GUARD_CURRENT_POSITION(iLocal_103[5], 0f, 3f, 1);
										SET_PED_USING_ACTION_MODE(iLocal_103[5], 0, -1, 0);
									}
								}
								iVar1 = 0;
				...
				case 2:
					...
					while (iLocal_125 < 6)
					{
						if (!IS_PED_INJURED(iLocal_103[iLocal_125]))
						{
							...
							{
								_0xF1C03A5352243A30(iLocal_103[iLocal_125]);
								TASK_COMBAT_PED(iLocal_103[iLocal_125], PLAYER_PED_ID(), 0, 16);
								SET_PED_KEEP_TASK(iLocal_103[iLocal_125], 1);
								if (!DOES_BLIP_EXIST(uLocal_116[iLocal_125]))
								{
...
int func_72(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_68(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
...
int func_89()
{
	...
	{
		if (IS_VEHICLE_DRIVEABLE(iLocal_110[iVar0], 0))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_110[iVar0], PLAYER_PED_ID(), 1))
			{
				return 1;
			}
		}
	...
	while (iVar0 < iLocal_103)
	{
		if (!IS_PED_INJURED(iLocal_103[iVar0]))
		{
			if (_CAN_PED_SEE_PED(iLocal_103[iVar0], PLAYER_PED_ID()))
			{
				if (IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), iLocal_103[iVar0]) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), iLocal_103[iVar0]))
				{
					return 1;
				}
			}
			if ((((((IS_BULLET_IN_AREA(GET_ENTITY_COORDS(iLocal_103[iVar0], 1), 5f, 1) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_103[iVar0], PLAYER_PED_ID(), 1)) || IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), iLocal_103[iVar0])) || IS_PROJECTILE_TYPE_IN_AREA(GET_ENTITY_COORDS(iLocal_103[iVar0], 1) - Vector(15f, 15f, 15f), GET_ENTITY_COORDS(iLocal_103[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_smokegrenade"), 1)) || IS_PROJECTILE_TYPE_IN_AREA(GET_ENTITY_COORDS(iLocal_103[iVar0], 1) - Vector(15f, 15f, 15f), GET_ENTITY_COORDS(iLocal_103[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_grenade"), 1)) || IS_PROJECTILE_TYPE_IN_AREA(GET_ENTITY_COORDS(iLocal_103[iVar0], 1) - Vector(15f, 15f, 15f), GET_ENTITY_COORDS(iLocal_103[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_grenadelauncher"), 1)) || IS_PROJECTILE_TYPE_IN_AREA(GET_ENTITY_COORDS(iLocal_103[iVar0], 1) - Vector(15f, 15f, 15f), GET_ENTITY_COORDS(iLocal_103[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_stickybomb"), 1))
			{
				return 1;
			}
		}
	...
	if (IS_EXPLOSION_IN_ANGLED_AREA(-1, vLocal_73, vLocal_76, fLocal_79))
	{
		return 1;
	}
	if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_73, vLocal_76, fLocal_79, 0, 1, 0))
	...
	if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), 2202.498f, 5603.424f, 52.7476f, 20f, 20f, 20f, 0, 1, 0))
	{
...
void func_90()
{
	...
	{
		ADD_SCENARIO_BLOCKING_AREA(vLocal_48 - Vector(20f, 50f, 50f), vLocal_48 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
		SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("bobcatxl"), 1);
		SET_WANTED_LEVEL_MULTIPLIER(0f);
		ENABLE_DISPATCH_SERVICE(3, 0);
		iLocal_110[0] = CREATE_VEHICLE(joaat("bobcatxl"), 2209.17f, 5572.897f, 52.7565f, 255.5161f, 1, 1, 0);
		SET_ENTITY_AS_MISSION_ENTITY(iLocal_110[0], 1, 0);
		SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_110[0], 1084227584);
		SET_VEHICLE_EXTRA(iLocal_110[0], 1, 1);
		iLocal_110[1] = CREATE_VEHICLE(joaat("bobcatxl"), 2195.473f, 5607.506f, 52.5648f, 168.4012f, 1, 1, 0);
		SET_ENTITY_AS_MISSION_ENTITY(iLocal_110[1], 1, 0);
		SET_VEHICLE_EXTRA(iLocal_110[1], 1, 0);
		iVar0 = 0;
		SET_BIT(&iVar0, 1);
		uLocal_113 = CREATE_PICKUP_ROTATE(joaat("pickup_money_case"), vLocal_51, -1.368082f, 0.230633f, 176.8749f, iVar0, GET_RANDOM_INT_IN_RANGE(40000, 100000), 2, 1, joaat("prop_cash_case_01"));
		...
		ADD_RELATIONSHIP_GROUP("DrugCult", &uLocal_123);
		SET_RELATIONSHIP_BETWEEN_GROUPS(3, uLocal_123, -1533126372);
		SET_RELATIONSHIP_BETWEEN_GROUPS(3, -1533126372, uLocal_123);
		SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_123, 1862763509);
		iLocal_125 = 0;
		while (iLocal_125 < 6)
		{
			iLocal_103[iLocal_125] = CREATE_PED(26, joaat("g_m_y_salvagoon_01"), vLocal_54[iLocal_125 /*3*/], fLocal_80[iLocal_125], 1, 1);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_103[iLocal_125], 1);
			SET_PED_COMBAT_MOVEMENT(iLocal_103[iLocal_125], 2);
			SET_PED_COMBAT_ATTRIBUTES(iLocal_103[iLocal_125], 50, 1);
			SET_PED_COMBAT_RANGE(iLocal_103[iLocal_125], 0);
			SET_PED_ACCURACY(iLocal_103[iLocal_125], 13);
			SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_103[iLocal_125], uLocal_123);
			iLocal_126 = GET_RANDOM_INT_IN_RANGE(0, 3);
			if (iLocal_126 == 0)
			{
				GIVE_WEAPON_TO_PED(iLocal_103[iLocal_125], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
			}
			else if (iLocal_126 == 1)
			{
				GIVE_WEAPON_TO_PED(iLocal_103[iLocal_125], joaat("weapon_microsmg"), -1, 1, 1);
			}
			else
			{
				GIVE_WEAPON_TO_PED(iLocal_103[iLocal_125], joaat("weapon_assaultrifle"), -1, 1, 1);
			}
			SET_PED_CONFIG_FLAG(iLocal_103[iLocal_125], 42, 1);
			func_85(&uLocal_131, 3, iLocal_103[iLocal_125], "SalvadorGang", 0, 1);
			iLocal_125++;
		}
		if (!IS_PED_INJURED(iLocal_103[0]))
		{
			...
			TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2205.769f, 5631.985f, 55.553f, 1f, -1, 1048576000, 0, 1193033728);
			TASK_TURN_PED_TO_FACE_COORD(0, 2214.833f, 5635.627f, 55.0029f, 8000);
			TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2215.993f, 5613.299f, 53.6157f, 1f, -1, 1048576000, 0, 1193033728);
			TASK_TURN_PED_TO_FACE_COORD(0, 2221.951f, 5593.625f, 52.9483f, 10000);
			SET_SEQUENCE_TO_REPEAT(uLocal_124, 1);
			CLOSE_SEQUENCE_TASK(uLocal_124);
			TASK_PERFORM_SEQUENCE(iLocal_103[0], uLocal_124);
		...
		SET_PED_NAME_DEBUG(iLocal_103[0], "piDrugCult[0]");
		if (!IS_PED_INJURED(iLocal_103[1]))
		{
			OPEN_SEQUENCE_TASK(&uLocal_124);
			TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2210.584f, 5580.684f, 52.8132f, 1f, -1, 1048576000, 0, 1193033728);
		...
		SET_PED_NAME_DEBUG(iLocal_103[1], "piDrugCult[1]");
		if (!IS_PED_INJURED(iLocal_103[2]))
		{
			OPEN_SEQUENCE_TASK(&uLocal_124);
			TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2201.014f, 5589.357f, 52.9573f, 1f, -1, 1048576000, 0, 1193033728);
			TASK_TURN_PED_TO_FACE_COORD(0, 2210.646f, 5593.576f, 52.8312f, 8000);
			TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2229.667f, 5598.368f, 53.2195f, 1f, -1, 1048576000, 0, 1193033728);
			TASK_TURN_PED_TO_FACE_COORD(0, 2237.916f, 5599.589f, 53.2311f, 12000);
			SET_SEQUENCE_TO_REPEAT(uLocal_124, 1);
			CLOSE_SEQUENCE_TASK(uLocal_124);
			TASK_PERFORM_SEQUENCE(iLocal_103[2], uLocal_124);
		...
		SET_PED_NAME_DEBUG(iLocal_103[2], "piDrugCult[2]");
		if (!IS_PED_INJURED(iLocal_103[3]) && !IS_PED_INJURED(iLocal_103[4]))
		{
			OPEN_SEQUENCE_TASK(&uLocal_124);
			TASK_GO_TO_ENTITY(0, iLocal_103[4], -1, 2f, 1f, 1073741824, 0);
		...
		SET_PED_NAME_DEBUG(iLocal_103[3], "piDrugCult[3]");
		if (!IS_PED_INJURED(iLocal_103[4]))
		{
			OPEN_SEQUENCE_TASK(&uLocal_124);
			TASK_GO_TO_ENTITY(0, iLocal_103[3], -1, 2f, 1f, 1073741824, 0);
		...
		SET_PED_NAME_DEBUG(iLocal_103[4], "piDrugCult[4]");
		TASK_GUARD_CURRENT_POSITION(iLocal_103[5], 0f, 3f, 1);
		SET_PED_NAME_DEBUG(iLocal_103[5], "piDrugCult[5]");
		uLocal_114 = func_91(vLocal_51, 0);
		SET_BLIP_SPRITE(uLocal_114, 140);
...
int func_92()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		if (VMAG2(GET_ENTITY_VELOCITY(PLAYER_PED_ID())) > 1369f && !func_103())
		{
			return 0;
		}
	}
...
void func_115(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = ROUND(func_116(TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_128()) || Global_105612) || Global_25767) || func_127()) || func_82(8, -1)) || func_126()) || func_125()) || func_124()) || func_123()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_128()) || Global_25767) || func_127()) || func_82(8, -1)) || func_124()) || func_126()) || func_125()) || func_123()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_128()) || Global_105612) || Global_25767) || func_127()) || func_82(8, -1)) || func_124()) || func_126()) || func_125()) || func_123()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_128()) || Global_105612) || Global_25767) || func_127()) || func_82(8, -1)) || func_126()) || func_125()) || func_123()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_128() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_82(8, -1)) || func_123()) || func_122()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_128()) || Global_25767) || func_127()) || func_82(8, -1)) || func_125()) || func_124()) || func_123()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_128()) || Global_105612) || Global_25767) || func_127()) || func_82(8, -1)) || func_124()) || func_122()) || func_126()) || func_125()) || func_123())
						{
							return 0;
						}
						break;
