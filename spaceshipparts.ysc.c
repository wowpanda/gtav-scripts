...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_15(&Local_42, &Local_48) || func_14(107) == 1)
		{
			if (!bLocal_51)
			{
				bLocal_51 = func_10(367701416, 1, 2, 69, 5000, 10000, 4294967295, 179, 4294967295, 32, 1);
			}
			if (bLocal_51)
			{
				if (!func_4() == 1)
...
void func_5()//Position - 0x45A
{
	...
	{
		if (func_9(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			iVar0 = func_8(AUDIO::_0x0626A247D2405330());
			if (func_7(iVar0) && (!func_6(14) || Global_19A3D))
			{
...
int func_15(var uParam0, int iParam1)//Position - 0x879
{
	...
	if (!func_6(14) && !CAM::IS_SCREEN_FADED_OUT())
	{
		...
		if (!Global_11729)
		{
			func_16(&(uParam0->f_B), &(uParam0->f_C), &(uParam0->f_9), 0, &iLocal_50, &iLocal_52, "SSHIP_TITLE", "SSHIP_COLLECT");
		}
		if (!bLocal_51)
		{
...
int func_18(int iParam0)//Position - 0xBEF
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_2725.f_6C, func_24(func_25(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
	...
	else
	{
		...
		while (iVar1 < func_25(iParam0))
		{
			...
			if (func_19(iVar2, 4294967295, 4294967295))
			{
				iVar0++;
			}
			iVar1++;
...
int func_21(int iParam0, int iParam1)//Position - 0x100C
{
	int iVar0;
...
int func_22()//Position - 0x12FC
{
	return Global_1407E0;
}

int func_23(int iParam0)//Position - 0x1308
{
	if (iParam0 == 3)
	{
		return 815;
...
int func_24(int iParam0, int iParam1)//Position - 0x134F
{
	if (iParam1 < 32)
	{
		return iParam1;
...
int func_25(int iParam0)//Position - 0x136B
{
	if (iParam0 == 3)
	{
		return 30;
...
void func_26(int iParam0)//Position - 0x13BB
{
...
int func_27(var uParam0, var uParam1, vector3 vParam2)//Position - 0x13D5
{
	int iVar0;
...
void func_28(var uParam0)//Position - 0x1492
{
...
void func_29(var uParam0, var uParam1, int iParam2)//Position - 0x14AB
{
	int iVar0;
...
void func_31(int iParam0, int iParam1)//Position - 0x15A1
{
	Global_16C57.f_7 = iParam0;
	Global_16C57.f_8 = iParam1;
}

void func_32()//Position - 0x15B9
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar3 = 0;
	STATS::STAT_GET_INT(func_34(0), &iVar0, 4294967295);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_33(18, iVar0);
	}
	STATS::STAT_GET_INT(func_34(1), &iVar0, 4294967295);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_33(19, iVar0);
	}
	STATS::STAT_GET_INT(func_34(3), &iVar0, 4294967295);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_33(20, iVar0);
...
int func_33(int iParam0, int iParam1)//Position - 0x165C
{
	int iVar0;
...
int func_34(int iParam0)//Position - 0x16AD
{
	if (iParam0 == 3)
	{
...
void func_35(var uParam0)//Position - 0x16FE
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			iVar1++;
			func_37((uParam0->f_2 + iVar0), 1, 4294967295, 1);
			if (bLocal_40)
			{
			}
		}
...
void func_36(int iParam0, int iParam1)//Position - 0x1781
{
...
int func_37(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x17BE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_38(var uParam0, int iParam1)//Position - 0x1D1E
{
	if (uParam0->f_3 <= 0)
	{
	}
	...
	{
		uParam0->f_4++;
		func_37((uParam0->f_2 + iParam1), 1, 4294967295, 1);
		if (bLocal_40)
		{
		}
	}
...
void func_39(int iParam0, int iParam1, bool bParam2)//Position - 0x1D92
{
...
void func_40(int iParam0, int iParam1, bool bParam2)//Position - 0x1E7E
{
	if (iParam1 < 0 || iParam1 >= 64)
	{
		return;
...
void func_41(int iParam0)//Position - 0x1EDF
{
...
int func_42(int iParam0)//Position - 0x1EFF
{
	int iVar0;
	int iVar1;
	...
	if (func_43(AUDIO::_0x0626A247D2405330()))
	{
...
int func_43(int iParam0)//Position - 0x1F8B
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_44(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)//Position - 0x1FAC
{
	int iVar0;
...
void func_45(vector3 vParam0)//Position - 0x20C5
{
	int iVar0;
...
bool func_46(var uParam0, int iParam1)//Position - 0x2103
{
	if (iParam1 < 0 || iParam1 >= 64)
	{
		return 0;
...
bool func_47(int iParam0)//Position - 0x2141
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
void func_48(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x215F
{
	uParam0->f_6 = iParam1;
	func_49(&(uParam0->f_1), iParam2, iParam3);
}

void func_49(int iParam0, var uParam1, var uParam2)//Position - 0x2179
{
	int iVar0;
	int iVar1;
	...
	*iParam0 = 0;
	...
	{
		if (func_19((iParam0->f_2 + iVar0), 4294967295, 4294967295))
		{
			iVar1++;
...
void func_50(var uParam0, int iParam1, int iParam2, char* sParam3)//Position - 0x21E2
{
	*uParam0 = iParam1;
	uParam0->f_7 = iParam2;
	uParam0->f_8 = sParam3;
...
void func_51()//Position - 0x2200
{
	int iVar0;
	
	iLocal_50 = 0;
	Global_19E56.f_2725.f_7D.f_2 = 1;
	iVar0 = 0;
	while (iVar0 < 50)
	{
...
Vector3 func_52(int iParam0, int iParam1)//Position - 0x250D
{
	switch (iParam0)
	{
		case 0:
...
int func_53(int iParam0)//Position - 0x2D59
{
	int iVar0;
	int iVar1;
...
void func_54()//Position - 0x2DB3
{
	int iVar0;
	
	Global_19E56.f_2725.f_7D.f_2 = 0;
	iVar0 = 0;
...
int func_55(int iParam0)//Position - 0x2E29
{
	int iVar0;
	int iVar1;
...
void func_56()//Position - 0x2E83
{
	...
	iVar0 = func_57(63);
	Global_24D678[iVar0 /*83*/] = 63;
	StringCopy(&(Global_24D678[iVar0 /*83*/].f_12[0 /*16*/]), "", 64);
}

int func_57(int iParam0)//Position - 0x2EAF
{
	int iVar0;
	int iVar1;
...
void func_58(int iParam0, int iParam1)//Position - 0x2EFC
{
	if (iParam0 == 146 || iParam0 == 4294967295)
	{
		return;
...
bool func_59(var uParam0)//Position - 0x2F41
{
	if (uParam0->f_3 <= 0)
	{
	}
