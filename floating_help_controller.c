...
void func_1()
{
	...
	while (iVar0 < Global_103207)
	{
		...
		{
			iVar1 = iVar0;
			if (MISC::GET_GAME_TIMER() > Global_103207[iVar0 /*28*/].f_21 && Global_103207[iVar0 /*28*/].f_21 != -1)
			{
				if (func_3(iVar0))
				{
			...
			else if (func_3(iVar0))
			{
				...
				{
					if (!MISC::IS_BIT_SET(Global_103207[iVar0 /*28*/].f_27, 0))
					{
						Global_103207[iVar0 /*28*/].f_21 = (Global_103207[iVar0 /*28*/].f_21 + SYSTEM::ROUND((MISC::GET_FRAME_TIME() * 1000f)));
						if (HUD::_0x2432784ACA090DA4(iVar1))
						{
							MISC::SET_BIT(&(Global_103207[iVar0 /*28*/].f_27), 0);
						}
					}
				}
				if (Global_103207[iVar0 /*28*/].f_24.f_2 != 9999f)
				{
					...
					{
						if (!ENTITY::IS_ENTITY_DEAD(Global_103207[iVar0 /*28*/].f_23, 0))
						{
							if (!MISC::IS_BIT_SET(Global_103207[iVar0 /*28*/].f_27, 3))
							{
								HUD::_0x784BA7E0ECEB4178(iVar1, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_103207[iVar0 /*28*/].f_23, Global_103207[iVar0 /*28*/].f_24));
							}
							else
							{
								HUD::_0xB094BC1DB4018240(iVar1, Global_103207[iVar0 /*28*/].f_23, Global_103207[iVar0 /*28*/].f_24, Global_103207[iVar0 /*28*/].f_24.f_1);
							}
						}
					}
					else if ((Global_103207[iVar0 /*28*/].f_24 != 0f || Global_103207[iVar0 /*28*/].f_24.f_1 != 0f) || Global_103207[iVar0 /*28*/].f_24.f_2 != 0f)
					{
						HUD::_0x784BA7E0ECEB4178(iVar1, Global_103207[iVar0 /*28*/].f_24);
					}
				}
				else
				{
					HUD::_0x7679CC1BCEBE3D4C(iVar1, Global_103207[iVar0 /*28*/].f_24, Global_103207[iVar0 /*28*/].f_24.f_1);
				}
			}
			else if ((MISC::GET_GAME_TIMER() - Global_103207[iVar0 /*28*/].f_22) > 1000)
			{
				func_2(iVar0);
			}
		}
