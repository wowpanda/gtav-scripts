							...
							if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), vLocal_39[iLocal_31 /*3*/]) < fLocal_250)
							{
								if (IS_PED_IN_ANY_HELI(PLAYER_PED_ID()) || IS_PED_IN_ANY_PLANE(PLAYER_PED_ID()))
								{
									...
									if (IS_VEHICLE_DRIVEABLE(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0))
									{
										if (func_14())
										{
											if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_251, vLocal_254, fLocal_263, 0, 1, 0))
											{
												bLocal_33 = true;
												iLocal_27 = 1;
											}
											if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_257, vLocal_260, fLocal_263, 0, 1, 0))
											{
												bLocal_34 = true;
												iLocal_27 = 1;
											}
						...
						if (!IS_PED_INJURED(PLAYER_PED_ID()))
						{
							...
							if (bLocal_33)
							{
								if (iLocal_37)
								{
									if (iLocal_36)
									{
										if (!IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_251, vLocal_254, fLocal_263, 0, 1, 0) && !IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_257, vLocal_260, fLocal_263, 0, 1, 0))
										{
											func_13();
											func_1();
									...
									else if (!IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_251, vLocal_254, fLocal_263, 0, 1, 0) && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_257, vLocal_260, fLocal_263, 0, 1, 0))
									{
										iLocal_36 = 1;
									}
									else if (!IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_251, vLocal_254, fLocal_263, 0, 1, 0) && !IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_257, vLocal_260, fLocal_263, 0, 1, 0))
...
void func_1()
{
	...
	if (iLocal_31 < 32)
	{
		bVar0 = IS_BIT_SET(Global_106565.f_10043.f_96, iLocal_31);
	}
	else if (iLocal_31 < 64)
	{
		bVar0 = IS_BIT_SET(Global_106565.f_10043.f_97, (iLocal_31 - 32));
	}
	else
	{
		bVar0 = IS_BIT_SET(Global_106565.f_10043.f_98, (iLocal_31 - 64));
	}
	if (bVar0)
	{
	}
	else
	{
		...
		if (iLocal_31 < 32)
		{
			SET_BIT(&(Global_106565.f_10043.f_96), iLocal_31);
		}
		else if (iLocal_31 < 64)
		{
			SET_BIT(&(Global_106565.f_10043.f_97), (iLocal_31 - 32));
		}
		else
		{
			SET_BIT(&(Global_106565.f_10043.f_98), (iLocal_31 - 64));
		}
		Global_90157 = 1;
		func_29();
		iLocal_29 = 1;
...
void func_15()
{
	if ((GET_GAME_TIMER() - iLocal_268) > 500)
	{
		if (iLocal_31 == 29)
		{
			if (IS_BIT_SET(Global_106565.f_10043.f_96, iLocal_31))
			{
				bLocal_267 = true;
			}
		}
	...
	switch (iLocal_28)
	{
		case 0:
			if (iLocal_29 && !bLocal_267)
			{
				if (!func_22())
				{
					uLocal_30 = REQUEST_SCALEFORM_MOVIE("MIDSIZED_MESSAGE");
					while (!HAS_SCALEFORM_MOVIE_LOADED(uLocal_30))
					{
						WAIT(0);
					}
					BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_30, "SHOW_BRIDGES_KNIVES_PROGRESS");
					if (bLocal_38)
					{
						func_21("FU_KNIFE");
					...
					SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(func_29());
		...
		case 1:
			...
			{
				BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_30, "SHARD_ANIM_OUT");
...
void func_17()
{
	if (HAS_SCALEFORM_MOVIE_LOADED(uLocal_30))
	{
		SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_30);
	}
}
...
void func_18()
{
	if (!func_22())
	{
		if (HAS_SCALEFORM_MOVIE_LOADED(uLocal_30))
		{
			DRAW_SCALEFORM_MOVIE(uLocal_30, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
		}
	}
}
...
void func_25()
{
	...
	{
		if (IS_BIT_SET(Global_106565.f_10043.f_97, (iLocal_31 - 32)))
		{
			bLocal_267 = true;
		}
	}
	else if (IS_BIT_SET(Global_106565.f_10043.f_98, (iLocal_31 - 64)))
	{
		bLocal_267 = true;
	}
	if (bLocal_267)
...
int func_48()
{
	...
	while (iVar1 < 32)
	{
		if (IS_BIT_SET(Global_106565.f_10043.f_96, iVar1))
		{
			if (func_49(iVar1))
			{
				iVar0++;
		...
		if (IS_BIT_SET(Global_106565.f_10043.f_97, iVar1))
		{
			if (func_49(iVar1 + 32))
			{
				iVar0++;
		...
		if (IS_BIT_SET(Global_106565.f_10043.f_98, iVar1))
		{
			if (func_49(iVar1 + 64))
			{
				iVar0++;
