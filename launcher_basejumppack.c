...
void __EntryFunction__()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_130(uLocal_94, 4194304))
	{
		if (iLocal_105 != 263)
		{
		...
		if (DOES_ENTITY_EXIST(uLocal_85) && !IS_ENTITY_DEAD(uLocal_85, 0))
		{
			...
			switch (iLocal_95)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_110(3) && !Global_93716)
						{
							...
							{
								if ((!func_130(uLocal_94, 1) || !DOES_ENTITY_EXIST(func_109())) && !Global_93716)
								{
									func_123(10);
									break;
								}
						...
						if (bVar2)
						{
							...
							if (bVar2)
							{
								...
								if (func_89(uLocal_86))
								{
									...
									else if (!func_130(uLocal_94, 2048) || !IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_87(&iLocal_96);
				...
				case 6:
					...
					if (func_130(uLocal_94, 2097152))
					{
						if (!func_110(3) && !IS_THREAD_ACTIVE(uLocal_52))
						{
							func_123(10);
						}
					}
					if (!IS_THREAD_ACTIVE(uLocal_52))
					{
						...
						if (iLocal_99 != -1)
						{
							if (func_130(Global_105216, 0))
							{
								PLAYSTATS_MISSION_CHECKPOINT(func_18(iLocal_99), 0, Global_93719, 0);
...
var func_24()
{
	...
	uVar0 = START_NEW_SCRIPT_WITH_ARGS(&Local_53, &vLocal_123, 170, iLocal_97);
...
void func_25(bool bParam0)
{
	...
	vVar12 = { func_67(COS(vVar12.z), SIN(vVar12.z), TAN(vVar12.x)) };
	NEW_LOAD_SCENE_START(func_66(iLocal_122), vVar12, 5000f, 0);
	...
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
	{
		...
		if (DOES_ENTITY_EXIST(uLocal_297))
		{
			vVar6 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) - GET_ENTITY_COORDS(uLocal_297, 0) };
			vVar6.z = 0f;
			fVar15 = VMAG(vVar6);
			...
			if (fVar15 > 0.8f)
			{
				...
				vVar9 = { GET_ENTITY_COORDS(uLocal_297, 0) + vVar6 };
				if (iLocal_122 == 12)
				{
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar9, 1f, 20000, 1048576000, 0, func_63(vVar9, GET_ENTITY_COORDS(uLocal_297, 0)));
				}
				else
				{
					TASK_GO_STRAIGHT_TO_COORD(0, vVar9, 1f, -1, func_63(vVar9, GET_ENTITY_COORDS(uLocal_297, 0)), 1056964608);
				}
			}
			else if (fVar15 > 0.15f)
			{
				TASK_ACHIEVE_HEADING(0, func_63(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(uLocal_297, 0)), 0);
			}
			TASK_PLAY_ANIM(0, "pickup_object", "pickup_low", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
	...
	func_23(&uLocal_293);
	while ((func_10(&uLocal_293) < 6f && !IS_ENTITY_DEAD(PLAYER_PED_ID(), 0)) && !IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), "pickup_object", "pickup_low", 3))
	{
		SET_PED_RESET_FLAG(PLAYER_PED_ID(), 177, 1);
		WAIT(0);
	}
	...
	while ((func_10(&uLocal_293) < 6f && !IS_ENTITY_DEAD(PLAYER_PED_ID(), 0)) && GET_ENTITY_ANIM_CURRENT_TIME(PLAYER_PED_ID(), "pickup_object", "pickup_low") < 0.22f)
	{
		SET_PED_RESET_FLAG(PLAYER_PED_ID(), 177, 1);
		if (!bVar16 && IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), "pickup_object", "pickup_low", 3))
		{
			SET_ENTITY_ANIM_SPEED(PLAYER_PED_ID(), "pickup_object", "pickup_low", 0.8f);
			bVar16 = true;
		}
	...
	if (bParam0)
	{
		...
		{
			CLEAR_PED_TASKS(PLAYER_PED_ID());
			TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER_PED_ID(), func_34(iLocal_122), 1f, -1, 1048576000, 0, 1193033728);
		}
		if (DOES_ENTITY_EXIST(uLocal_297))
		{
			DELETE_OBJECT(&uLocal_297);
		}
		uVar4 = CREATE_CAMERA_WITH_PARAMS(26379945, func_32(iLocal_122), func_31(iLocal_122), func_30(iLocal_122), 1, 2);
		uVar5 = CREATE_CAMERA_WITH_PARAMS(26379945, func_29(iLocal_122), func_28(iLocal_122), func_27(iLocal_122), 0, 2);
		...
		SET_CAM_ACTIVE_WITH_INTERP(uVar5, uVar4, func_26(iLocal_122), 1, 1);
		func_21(&uVar0);
		while (func_10(&uVar0) < ((TO_FLOAT(func_26(iLocal_122)) / 1000f) + 0.3f))
		{
			if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
			{
				SET_PED_RESET_FLAG(PLAYER_PED_ID(), 177, 1);
...
void func_40()
{
	...
	func_48(0, 0, 1);
	uLocal_297 = CREATE_OBJECT_NO_OFFSET(joaat("p_parachute_s"), func_47(iLocal_122), 1, 1, 0);
	SET_ENTITY_ROTATION(uLocal_297, func_46(iLocal_122), 2, 1);
	func_41(&vVar0, &uVar3);
	vVar4 = { 0f, 0f, uVar3 };
	uVar7 = CREATE_SYNCHRONIZED_SCENE(vVar0, vVar4, 2);
	PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_297, uVar7, "puton_parachute_bag", "oddjobs@basejump@ig_15", 1000f, -1000f, 1, 1148846080);
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
	{
		CLEAR_PED_TASKS(PLAYER_PED_ID());
		TASK_SYNCHRONIZED_SCENE(PLAYER_PED_ID(), uVar7, "oddjobs@basejump@ig_15", "puton_parachute", 1000f, -1000f, 0, 0, 1148846080, 0);
	}
	PLAY_SOUND_FRONTEND(-1, "Grab_Parachute", "BASEJUMPS_SOUNDS", 1);
	uVar8 = CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
	PLAY_SYNCHRONIZED_CAM_ANIM(uVar8, uVar7, "puton_parachute_cam", "oddjobs@basejump@ig_15");
	SET_CAM_ACTIVE(uVar8, 1);
	RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
	while (GET_SYNCHRONIZED_SCENE_PHASE(uVar7) < 0.6f)
	{
		WAIT(0);
	}
...
void func_41(var uParam0, var uParam1)
{
	*uParam0 = { func_45(iLocal_122) };
	switch (iLocal_122)
	{
		...
		case 4:
			*uParam1 = func_44(func_63(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), *uParam0), -180f, 180f);
			if (*uParam1 > 0f)
			{
...
void func_50(bool bParam0, bool bParam1, var uParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_55(PLAYER_ID())) && !func_52(PLAYER_ID(), 0)) && !func_51()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_55(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
...
void func_83()
{
	...
	if (DOES_ENTITY_EXIST(uLocal_297))
	{
		vVar1 = { GET_ENTITY_COORDS(uLocal_297, 1) };
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_107()) || Global_105612) || Global_25767) || func_106()) || func_92(8, -1)) || func_105()) || func_104()) || func_103()) || func_94()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_107()) || Global_25767) || func_106()) || func_92(8, -1)) || func_103()) || func_105()) || func_104()) || func_94()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_107()) || Global_105612) || Global_25767) || func_106()) || func_92(8, -1)) || func_105()) || func_104()) || func_94()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_107() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_92(8, -1)) || func_94()) || func_102()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_107()) || Global_25767) || func_106()) || func_92(8, -1)) || func_104()) || func_103()) || func_94()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_107()) || func_104()) || Global_105612) || Global_25767) || func_106()) || Global_37584) || func_92(8, -1)) || func_103()) || func_102()) || func_94()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
	...
	if (bLocal_296)
	{
		switch (iLocal_122)
		{
			...
			case 8:
				uLocal_297 = CREATE_OBJECT_NO_OFFSET(joaat("p_parachute_s"), func_47(iLocal_122), 1, 1, 0);
				SET_ENTITY_ROTATION(uLocal_297, func_46(iLocal_122), 2, 1);
				FREEZE_ENTITY_POSITION(uLocal_297, 1);
				break;
			...
			case 12:
				uLocal_297 = CREATE_OBJECT_NO_OFFSET(joaat("p_parachute_s"), func_47(iLocal_122), 1, 1, 0);
				SET_ENTITY_ROTATION(uLocal_297, func_46(iLocal_122), 2, 1);
				PLACE_OBJECT_ON_GROUND_PROPERLY(uLocal_297);
				vVar0 = { func_116(iLocal_122) };
				if (!func_33(vVar0))
				{
					uLocal_298 = CREATE_VEHICLE(joaat("bati"), vVar0, func_115(iLocal_122), 1, 1, 0);
...
bool func_117()
{
	switch (iLocal_122)
	{
		...
		case 8:
		case 6:
			return (((HAS_ANIM_DICT_LOADED("pickup_object") && HAS_ANIM_DICT_LOADED("oddjobs@basejump@ig_15")) && func_118(&uLocal_118)) && func_118(&uLocal_120));
			break;
		
		case 12:
			return ((HAS_ANIM_DICT_LOADED("pickup_object") && HAS_ANIM_DICT_LOADED("oddjobs@basejump@ig_15")) && func_118(&uLocal_118));
			break;
...
void func_131()
{
	...
	iLocal_99 = 0;
	fLocal_102 = (TO_FLOAT(func_132(iLocal_105)) + 5f);
	fLocal_117 = 1.1f;
