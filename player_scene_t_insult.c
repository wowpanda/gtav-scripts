...
int func_2()
{
	...
	{
		fVar1 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90308);
	...
	while (iVar0 < iLocal_233)
	{
		...
		{
			vVar3 = { ENTITY::GET_ENTITY_COORDS(iLocal_233[iVar0], 1) };
		...
		switch (iLocal_234[iParam1])
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, &Local_297, &(Local_307[iParam1 /*16*/]), 2))
				{
					...
					{
						fVar2 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90308);
						if (fVar2 > fVar0)
						{
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90308))
		{
			...
			while (iVar0 < iLocal_233)
			{
				if (!PED::IS_PED_INJURED(iLocal_233[iVar0]))
				{
					...
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_233[iVar0], Global_90308, &Local_297, &(Local_307[iVar0 /*16*/]), 1000f, fVar1, iVar2, iVar3, fVar4, iVar5);
					iLocal_234[iVar0] = 0;
				}
				iVar0++;
			}
			...
			while (iVar0 < iLocal_239)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_239[iVar0]))
				{
					...
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_239[iVar0], Global_90308, &(Local_312[iVar0 /*16*/]), &Local_297, 8f, -1000f, 0, 1148846080);
					}
				}
				iVar0++;
			}
...
int func_32()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90307))
	{
		...
		while (iVar0 < iLocal_233)
		{
			if (!PED::IS_PED_INJURED(iLocal_233[iVar0]))
			{
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_233[iVar0], Global_90307, &Local_297, &(Local_306[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_239)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_239[iVar0]))
			{
				...
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_239[iVar0], Global_90307, &(Local_311[iVar0 /*16*/]), &Local_297, 8f, -1000f, 0, 1148846080);
				}
			}
			iVar0++;
		}
