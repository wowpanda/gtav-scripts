...
int func_2()
{
	...
	{
		func_20(iLocal_237[iVar0], iVar0);
		iVar0++;
	}
	if (IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
	{
		fVar1 = GET_SYNCHRONIZED_SCENE_PHASE(Global_91042);
		if (!IS_STRING_NULL_OR_EMPTY(&Local_725))
		{
			if (!iLocal_730)
			{
				if (fVar1 < fLocal_729)
	...
	while (iVar0 < iLocal_237)
	{
		...
		{
			vVar5 = { GET_ENTITY_COORDS(iLocal_237[iVar0], 1) };
...
void func_20(int iParam0, int iParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		{
			case 0:
				if (IS_ENTITY_PLAYING_ANIM(iParam0, &cLocal_345, &(Local_394[iParam1 /*16*/]), 2))
				{
					fVar0 = -1f;
					fVar1 = -1f;
					if (FIND_ANIM_EVENT_PHASE(&cLocal_345, &(Local_394[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1) || func_29(&cLocal_345, &(Local_394[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1))
					{
						fVar2 = GET_SYNCHRONIZED_SCENE_PHASE(Global_91042);
						if (fVar2 > fVar0)
						{
							...
							TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, vLocal_273 + vLocal_284[iParam1 /*3*/], fVar3, -1, (fLocal_294[iParam1] * 0.1f), 0, 1193033728);
							FORCE_PED_MOTION_STATE(iParam0, iVar4, 0, 0, 0);
				...
				{
					CLEAR_PED_TASKS(iParam0);
					if (IS_STRING_NULL_OR_EMPTY(&(Local_427[iParam1 /*16*/])))
					{
						if (func_26(vLocal_284[iParam1 /*3*/], 0f, 0f, 0f, 0))
						{
							vVar5 = { GET_ENTITY_COORDS(iParam0, 1) };
							vLocal_284[iParam1 /*3*/] = { vVar5 - vLocal_273 * Vector(4f, 4f, 4f) };
						}
						if (!IS_STRING_NULL_OR_EMPTY(&(Local_691[iParam1 /*16*/])))
						{
							SET_PED_MOVEMENT_CLIPSET(iParam0, &(Local_691[iParam1 /*16*/]), 1048576000);
						}
						TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, vLocal_273 + vLocal_284[iParam1 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
						iLocal_240[iParam1] = 1;
					}
					else
					{
						if (!IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_724))
						{
							iLocal_724 = CREATE_SYNCHRONIZED_SCENE(vLocal_273, 0f, 0f, fLocal_276, 2);
							SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_724, 1);
						}
						iVar8 = 5;
						iVar9 = 144;
						iVar10 = 0;
						if (iLocal_256[0] == joaat("p_trev_rope_01_s") || iLocal_256[1] == joaat("p_trev_rope_01_s"))
						{
							...
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_237[iParam1], 1);
							SET_PED_CAN_BE_TARGETTED(iLocal_237[iParam1], 0);
							SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_237[iParam1], 0);
							SET_ENTITY_MAX_HEALTH(iLocal_237[iParam1], 1000);
							SET_ENTITY_HEALTH(iLocal_237[iParam1], GET_ENTITY_MAX_HEALTH(iLocal_237[iParam1]), 0);
							SET_PED_SUFFERS_CRITICAL_HITS(iLocal_237[iParam1], 0);
							SET_PED_RESET_FLAG(iLocal_237[iParam1], 64, 1);
							SET_PED_RESET_FLAG(iLocal_237[iParam1], 249, 1);
							SET_PED_RESET_FLAG(iLocal_237[iParam1], 335, 1);
							iVar11 = 0;
							while (iVar11 < iLocal_253)
							{
								SET_ENTITY_CAN_BE_DAMAGED(iLocal_253[iVar11], 0);
								SET_OBJECT_TARGETTABLE(iLocal_253[iVar11], 0);
								iVar11++;
							}
						}
						if (!func_25(iVar9, 16))
						...
						TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_427[iParam1 /*16*/]), 1000f, -1000f, iVar8, iVar9, 1000f, iVar10);
						iVar11 = 0;
						while (iVar11 < iLocal_253)
						{
							if (iLocal_256[iVar11] != 0)
							{
								if (!IS_STRING_NULL_OR_EMPTY(&(Local_592[iVar11 /*16*/])))
								{
									PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar11], iLocal_724, &(Local_592[iVar11 /*16*/]), &cLocal_345, 8f, 1090519040, 0, 1148846080);
								}
							}
							iVar11++;
						}
			...
			case 1:
				if (!IS_PED_GROUP_MEMBER(iLocal_237[iParam1], uLocal_252))
				{
					if (!DOES_GROUP_EXIST(uLocal_252))
					{
						uLocal_252 = CREATE_GROUP(0);
					}
					if (iParam1 == 0)
					{
						SET_PED_AS_GROUP_LEADER(iLocal_237[iParam1], uLocal_252);
					}
					else
					{
						SET_PED_AS_GROUP_MEMBER(iLocal_237[iParam1], uLocal_252);
					}
				}
				if (GET_SCRIPT_TASK_STATUS(iParam0, 713668775) != 1)
				{
					...
					{
						fLocal_294[iParam1] = (VMAG(vLocal_284[iParam1 /*3*/]) * 0.75f);
					}
					TASK_WANDER_IN_AREA(iParam0, vLocal_273 + vLocal_284[iParam1 /*3*/], fLocal_294[iParam1], 1077936128, 1086324736);
			...
			case 10:
				...
				SET_PED_RESET_FLAG(iLocal_237[iParam1], 249, 1);
				SET_PED_RESET_FLAG(iLocal_237[iParam1], 335, 1);
				if (IS_ENTITY_PLAYING_ANIM(iLocal_237[iParam1], &cLocal_345, &(Local_427[iParam1 /*16*/]), 2))
				{
					if (iLocal_70 == 288)
					{
						if (iLocal_731 <= 0)
						{
							iLocal_731 = (GET_GAME_TIMER() + GET_RANDOM_INT_IN_RANGE(10000, 15000));
						}
						...
						if (iLocal_731 > 0)
						{
							if (GET_GAME_TIMER() > iLocal_731)
							{
								func_21(&uLocal_71, 3, iLocal_237[iParam1], "PIERWOMAN", 0, 1);
				...
				else
				{
					...
					TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_427[iParam1 /*16*/]), 1000f, -1000f, iVar13, iVar14, 1000f, iVar15);
					iVar16 = 0;
					while (iVar16 < iLocal_253)
					{
						if (iLocal_256[iVar16] != 0)
						{
							if (!IS_STRING_NULL_OR_EMPTY(&(Local_592[iVar16 /*16*/])))
							{
								PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar16], iLocal_724, &(Local_592[iVar16 /*16*/]), &cLocal_345, 8f, 1090519040, 0, 1148846080);
							}
						}
						iVar16++;
					}
				...
				switch (iLocal_246[iParam1])
				{
					...
					case 0:
						...
						TASK_LOOK_AT_ENTITY(iLocal_237[iParam1], PLAYER_PED_ID(), iVar17, 0, 2);
						iLocal_249[iParam1] = ((GET_GAME_TIMER() + iVar17) + GET_RANDOM_INT_IN_RANGE(500, 2000));
						iLocal_246[iParam1] = 1;
						break;
					
					case 1:
						if (GET_GAME_TIMER() > iLocal_249[iParam1])
						{
				...
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_237[iParam1], PLAYER_PED_ID(), 1))
				{
				}
				bVar18 = false;
				if (GET_ENTITY_HEALTH(iLocal_237[iParam1]) < GET_ENTITY_MAX_HEALTH(iLocal_237[iParam1]))
				{
					bVar18 = true;
				}
				if (IS_ENTITY_ON_FIRE(iLocal_237[iParam1]))
				{
					bVar18 = true;
				}
				if (bVar18)
				{
					SET_SYNCHRONIZED_SCENE_PHASE(iLocal_724, 0f);
					_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_724, 1);
					SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_724, 0);
					iVar19 = 4;
					iVar20 = 4276;
					iVar21 = 0;
					TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_460[iParam1 /*16*/]), 8f, -1000f, iVar19, iVar20, 8f, iVar21);
					SET_ENTITY_CAN_BE_DAMAGED(iLocal_237[iParam1], 0);
					_SET_PED_RAGDOLL_BLOCKING_FLAGS(iLocal_237[iParam1], iVar20);
					SET_PED_CONFIG_FLAG(iLocal_237[iParam1], 208, 1);
					iVar22 = 0;
					while (iVar22 < iLocal_253)
					{
						if (iLocal_256[iVar22] != 0)
						{
							if (!IS_STRING_NULL_OR_EMPTY(&(Local_625[iVar22 /*16*/])))
							{
								PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar22], iLocal_724, &(Local_625[iVar22 /*16*/]), &cLocal_345, 8f, 1090519040, 0, 1148846080);
								SET_ENTITY_CAN_BE_DAMAGED(iLocal_253[iVar22], 0);
							}
						}
						iVar22++;
					}
			...
			case 11:
				...
				else if (GET_SYNCHRONIZED_SCENE_PHASE(iLocal_724) >= 0.99f)
				{
					bVar23 = false;
				}
				if (!bVar23)
				{
					...
					_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(iLocal_724, 0);
					SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_724, 1);
					iVar24 = 0;
					iVar25 = 180;
					iVar26 = 0;
					TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_493[iParam1 /*16*/]), 1000f, -1000f, iVar24, iVar25, 1000f, iVar26);
					iVar27 = 0;
					while (iVar27 < iLocal_253)
					{
						if (iLocal_256[iVar27] != 0)
						{
							if (!IS_STRING_NULL_OR_EMPTY(&(Local_658[iVar27 /*16*/])))
							{
								PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar27], iLocal_724, &(Local_658[iVar27 /*16*/]), &cLocal_345, 8f, 1090519040, 0, 1148846080);
							}
						}
						iVar27++;
					}
			...
			case 12:
				...
				SET_PED_RESET_FLAG(iLocal_237[iParam1], 249, 1);
				SET_PED_RESET_FLAG(iLocal_237[iParam1], 335, 1);
				if (!IS_ENTITY_PLAYING_ANIM(iLocal_237[iParam1], &cLocal_345, &(Local_493[iParam1 /*16*/]), 2))
				{
					if (!IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_724))
					{
						iLocal_724 = CREATE_SYNCHRONIZED_SCENE(vLocal_273, 0f, 0f, fLocal_276, 2);
					}
					TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &cLocal_345, &(Local_493[iParam1 /*16*/]), 1000f, -1000f, 0, 0, 1148846080, 0);
					iVar28 = 0;
					while (iVar28 < iLocal_253)
					{
						if (iLocal_256[iVar28] != 0)
						{
							if (!IS_STRING_NULL_OR_EMPTY(&(Local_658[iVar28 /*16*/])))
							{
								PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar28], iLocal_724, &(Local_658[iVar28 /*16*/]), &cLocal_345, 8f, 1090519040, 0, 1148846080);
							}
						}
						iVar28++;
					}
	...
	else
	{
		...
		if (DOES_ENTITY_EXIST(iParam0))
		{
			...
			{
				if (DOES_ENTITY_EXIST(iLocal_253[iVar29]))
				{
					STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar29], -8f, 1);
					FREEZE_ENTITY_POSITION(iLocal_253[iVar29], 0);
					SET_ENTITY_DYNAMIC(iLocal_253[iVar29], 1);
					SET_OBJECT_AS_NO_LONGER_NEEDED(&(iLocal_253[iVar29]));
				}
				iVar29++;
			}
		}
...
int func_22(int iParam0)
{
	...
	while (iVar0 < iLocal_237)
	{
		...
		{
			if (iLocal_240[iVar0] < 0 && DOES_ENTITY_EXIST(iLocal_237[iVar0]))
			{
				return 1;
			}
		}
...
int func_23(int iParam0)
{
	...
	if (iLocal_70 == 237)
	{
		fVar1 = VDIST2(GET_ENTITY_COORDS(iParam0, 0), GET_ENTITY_COORDS(PLAYER_PED_ID(), 0));
		if (fVar1 < (10f * 10f))
		{
			return 1;
		}
...
bool func_26(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
...
{
	_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_28(iParam3), 0);
}
...
int func_29(char[4] cParam0, var uParam1, char* sParam2, float fParam3, float fParam4)
{
	if (ARE_STRINGS_EQUAL(sParam2, "WalkInterruptible"))
	{
		if (ARE_STRINGS_EQUAL(cParam0, "SWITCH@TREVOR@SCARES_TRAMP"))
		{
			if (ARE_STRINGS_EQUAL(uParam1, "trev_scares_tramp_exit_tramp"))
			{
				*fParam3 = 0.8f;
				*fParam4 = 1f;
				return 1;
		...
		if (ARE_STRINGS_EQUAL(cParam0, "SWITCH@TREVOR@CHASE_STRIPPERS"))
		{
			if (ARE_STRINGS_EQUAL(uParam1, "EXIT_STRIPPER_01") || ARE_STRINGS_EQUAL(uParam1, "EXIT_STRIPPER_02"))
			{
				*fParam3 = 0.4f;
				*fParam4 = 1f;
				return 1;
		...
		if (ARE_STRINGS_EQUAL(cParam0, "SWITCH@TREVOR@THROW_FOOD"))
		{
			if (ARE_STRINGS_EQUAL(uParam1, "EXIT_Ped"))
			{
				*fParam3 = 0.7f;
				*fParam4 = 1f;
				return 1;
		...
		if (IS_SYNCHRONIZED_SCENE_RUNNING(Global_91042))
		{
			...
			while (iVar0 < iLocal_237)
			{
				if (!IS_PED_INJURED(iLocal_237[iVar0]))
				{
					...
					fVar6 = -1f;
					fVar7 = -1f;
					if (FIND_ANIM_EVENT_PHASE(&cLocal_345, &(Local_394[iVar0 /*16*/]), "WalkInterruptible", &fVar6, &fVar7) || func_29(&cLocal_345, &(Local_394[iVar0 /*16*/]), "WalkInterruptible", &fVar6, &fVar7))
					{
						fVar1 = -8f;
						iVar2 = 2;
						iVar3 = 0;
					...
					TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_91042, &cLocal_345, &(Local_394[iVar0 /*16*/]), 1000f, fVar1, iVar2, iVar3, fVar4, iVar5);
					iLocal_240[iVar0] = 0;
				}
				iVar0++;
			}
			...
			{
				if (DOES_ENTITY_EXIST(iLocal_253[iVar0]))
				{
					if (!IS_STRING_NULL_OR_EMPTY(&(Local_559[iVar0 /*16*/])))
					{
						PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_91042, &(Local_559[iVar0 /*16*/]), &cLocal_345, 8f, -1000f, 0, 1148846080);
					}
				}
				iVar0++;
			}
...
int func_32()
{
	...
	if (IS_SYNCHRONIZED_SCENE_RUNNING(Global_91041))
	{
		...
		while (iVar0 < iLocal_237)
		{
			if (!IS_PED_INJURED(iLocal_237[iVar0]))
			{
				TASK_SYNCHRONIZED_SCENE(iLocal_237[iVar0], Global_91041, &cLocal_345, &(Local_361[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_253)
		{
			if (DOES_ENTITY_EXIST(iLocal_253[iVar0]))
			{
				if (!IS_STRING_NULL_OR_EMPTY(&(Local_526[iVar0 /*16*/])))
				{
					PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[iVar0], Global_91041, &(Local_526[iVar0 /*16*/]), &cLocal_345, 8f, -1000f, 0, 1148846080);
				}
			}
			iVar0++;
		}
		if (!IS_STRING_NULL_OR_EMPTY(&Local_725))
		{
			func_21(&uLocal_71, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
			func_21(&uLocal_71, 7, iLocal_237[0], "STRIPPER1", 0, 1);
			func_21(&uLocal_71, 8, iLocal_237[1], "STRIPPER2", 0, 1);
		}
		return 1;
	}
	return 0;
...
void func_41()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_243)
		{
			...
			{
				REQUEST_MODEL(iLocal_243[iVar0]);
				if (!HAS_MODEL_LOADED(iLocal_243[iVar0]))
				{
					bVar2 = false;
					REQUEST_MODEL(iLocal_243[iVar0]);
				}
			}
			if (!IS_STRING_NULL_OR_EMPTY(&(Local_691[iVar0 /*16*/])))
			{
				REQUEST_CLIP_SET(&(Local_691[iVar0 /*16*/]));
				if (!HAS_CLIP_SET_LOADED(&(Local_691[iVar0 /*16*/])))
				{
					bVar2 = false;
				}
			}
		...
		REQUEST_ANIM_DICT(&cLocal_345);
		if (!HAS_ANIM_DICT_LOADED(&cLocal_345))
		{
			bVar2 = false;
			REQUEST_ANIM_DICT(&cLocal_345);
		}
	...
	while (iVar0 < iLocal_237)
	{
		if (iLocal_243[iVar0] != 0)
		{
			iLocal_237[iVar0] = CREATE_PED(26, iLocal_243[iVar0], vLocal_273 + vLocal_277[iVar0 /*3*/], 0, 1, 1);
			SET_ENTITY_HEADING(iLocal_237[iVar0], (fLocal_276 + fLocal_291[iVar0]));
			SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_237[iVar0], 0);
			if (iLocal_243[iVar0] == joaat("a_f_y_beach_01"))
			{
				if (iLocal_70 == 288)
				{
					SET_PED_COMPONENT_VARIATION(iLocal_237[iVar0], 8, 1, 0, 0);
				}
			}
			SET_PED_COMBAT_ATTRIBUTES(iLocal_237[iVar0], 13, 0);
			SET_PED_COMBAT_ATTRIBUTES(iLocal_237[iVar0], 17, 1);
			TASK_PLAY_ANIM(iLocal_237[iVar0], &cLocal_345, &(Local_361[iVar0 /*16*/]), 8f, -8f, -1, 1, 0f, 0, 0, 0);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_253)
	{
		if (iLocal_256[iVar0] != 0)
		{
			iLocal_253[iVar0] = CREATE_OBJECT(iLocal_256[iVar0], vLocal_273 + vLocal_277[iVar0 /*3*/] + vLocal_259[iVar0 /*3*/], 1, 1, 0);
			SET_ENTITY_ROTATION(iLocal_253[iVar0], Vector((fLocal_276 + fLocal_291[iVar0]), 0f, 0f) + vLocal_266[iVar0 /*3*/], 2, 1);
			if (!IS_STRING_NULL_OR_EMPTY(&(Local_526[iVar0 /*16*/])))
			{
				PLAY_ENTITY_ANIM(iLocal_253[iVar0], &(Local_526[iVar0 /*16*/]), &cLocal_345, 8f, 1, 0, 0, 0, 0);
			}
		}
		iVar0++;
	}
...
void func_42()
{
	...
	func_45(iLocal_70, &vLocal_273, &fLocal_276, &cVar0);
	func_43(iLocal_70, &sLocal_297, &cLocal_313, &cLocal_329, &uVar8, &uVar9);
	...
	switch (iLocal_70)
	{
		case 237:
			...
			fLocal_729 = 0.15f;
			vLocal_277[0 /*3*/] = { GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_277[1 /*3*/] = { GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			vLocal_284[0 /*3*/] = { 8.2284f, -35.8652f, -1.0334f };
			vLocal_284[1 /*3*/] = { 28.4066f, -23.8848f, -0.7887f };
			fLocal_291[0] = GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_291[1] = GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_294[0] = 50f;
			fLocal_294[1] = 50f;
		...
		case 244:
			...
			StringCopy(&(Local_427[0 /*16*/]), "", 64);
			vLocal_277[0 /*3*/] = { GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f };
...
void func_52()
{
	...
	while (iVar0 < iLocal_243)
	{
		if (iLocal_243[iVar0] != 0)
		{
			SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_243[iVar0]);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_256)
	{
		if (iLocal_256[iVar0] != 0)
		{
			SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_256[iVar0]);
		}
		iVar0++;
	}
	REMOVE_ANIM_DICT(&cLocal_345);
	if (DOES_GROUP_EXIST(uLocal_252))
	{
		REMOVE_GROUP(uLocal_252);
	}
	SET_GAME_PAUSED(0);
