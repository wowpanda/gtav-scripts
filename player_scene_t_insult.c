...
int func_2()
{
	...
	{
		fVar1 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90430);
		...
		switch (iLocal_234[iParam1])
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, &Local_297, &(Local_307[iParam1 /*16*/]), 2))
				{
					...
					{
						fVar2 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_90430);
						if (fVar2 > fVar0)
						{
							...
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, vLocal_243 + vLocal_246[iParam1 /*3*/], fVar3, -1, (fLocal_248[iParam1] * 0.1f), 0, 1193033728);
				...
				else
				{
					...
					if (MISC::IS_STRING_NULL_OR_EMPTY(&(Local_308[iParam1 /*16*/])))
					{
						...
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, vLocal_243 + vLocal_246[iParam1 /*3*/], 1f, -1, 0.25f, 0, 1193033728);
						iLocal_234[iParam1] = 1;
					}
					else
					{
						...
						BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_233[iParam1], iLocal_317, &Local_297, &(Local_308[iParam1 /*16*/]), 1000f, -1000f, iVar6, iVar7, 1000f, iVar8);
						iVar9 = 0;
						while (iVar9 < iLocal_239)
						{
			...
			case 1:
				...
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iParam0, 713668775) != 1)
				{
					...
					BRAIN::TASK_WANDER_IN_AREA(iParam0, vLocal_243 + vLocal_246[iParam1 /*3*/], fLocal_248[iParam1], 1077936128, 1086324736);
			...
			case 10:
				...
				else
				{
					...
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_233[iParam1], iLocal_317, &Local_297, &(Local_308[iParam1 /*16*/]), 1000f, -1000f, iVar11, iVar12, 1000f, iVar13);
					iVar14 = 0;
				...
				switch (iLocal_236[iParam1])
				{
					...
					case 0:
						...
						BRAIN::TASK_LOOK_AT_ENTITY(iLocal_233[iParam1], PLAYER::PLAYER_PED_ID(), iVar15, 0, 2);
				...
				if (bVar16)
				{
					...
					iVar18 = 4276;
					iVar19 = 0;
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_233[iParam1], iLocal_317, &Local_297, &(Local_309[iParam1 /*16*/]), 8f, -1000f, iVar17, iVar18, 8f, iVar19);
			...
			case 11:
				...
				if (!bVar21)
				{
					...
					iVar23 = 180;
					iVar24 = 0;
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_233[iParam1], iLocal_317, &Local_297, &(Local_310[iParam1 /*16*/]), 1000f, -1000f, iVar22, iVar23, 1000f, iVar24);
					iVar25 = 0;
			...
			case 12:
				...
				if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_233[iParam1], &Local_297, &(Local_310[iParam1 /*16*/]), 2))
				{
					...
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_233[iParam1], iLocal_317, &Local_297, &(Local_310[iParam1 /*16*/]), 1000f, -1000f, 0, 0, 1148846080, 0);
					iVar26 = 0;
...
void func_27(int iParam0, void fParam1, void fParam2, int iParam3)
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, fParam1, fParam2, func_28(iParam3), 0);
}
...
int func_29(void fParam0, void fParam1, void fParam2, float fParam3, float fParam4)
{
	if (MISC::ARE_STRINGS_EQUAL(fParam2, "WalkInterruptible"))
	{
		if (MISC::ARE_STRINGS_EQUAL(fParam0, "SWITCH@TREVOR@SCARES_TRAMP"))
		{
			if (MISC::ARE_STRINGS_EQUAL(fParam1, "trev_scares_tramp_exit_tramp"))
			{
				*fParam3 = 0.8f;
				*fParam4 = 1f;
				return 1;
		...
		if (MISC::ARE_STRINGS_EQUAL(fParam0, "SWITCH@TREVOR@CHASE_STRIPPERS"))
		{
			if (MISC::ARE_STRINGS_EQUAL(fParam1, "EXIT_STRIPPER_01") || MISC::ARE_STRINGS_EQUAL(fParam1, "EXIT_STRIPPER_02"))
			{
				*fParam3 = 0.4f;
				*fParam4 = 1f;
				return 1;
		...
		if (MISC::ARE_STRINGS_EQUAL(fParam0, "SWITCH@TREVOR@THROW_FOOD"))
		{
			if (MISC::ARE_STRINGS_EQUAL(fParam1, "EXIT_Ped"))
			{
				*fParam3 = 0.7f;
				*fParam4 = 1f;
				return 1;
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90430))
		{
			...
			while (iVar0 < iLocal_233)
			{
				if (!PED::IS_PED_INJURED(iLocal_233[iVar0]))
				{
					...
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_233[iVar0], Global_90430, &Local_297, &(Local_307[iVar0 /*16*/]), 1000f, fVar1, iVar2, iVar3, fVar4, iVar5);
					iLocal_234[iVar0] = 0;
				}
				iVar0++;
			}
			...
			while (iVar0 < iLocal_239)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_239[iVar0]))
				{
					...
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_239[iVar0], Global_90430, &(Local_312[iVar0 /*16*/]), &Local_297, 8f, -1000f, 0, 1148846080);
					}
				}
				iVar0++;
			}
...
int func_32()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_90429))
	{
		...
		while (iVar0 < iLocal_233)
		{
			if (!PED::IS_PED_INJURED(iLocal_233[iVar0]))
			{
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_233[iVar0], Global_90429, &Local_297, &(Local_306[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_239)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_239[iVar0]))
			{
				...
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_239[iVar0], Global_90429, &(Local_311[iVar0 /*16*/]), &Local_297, 8f, -1000f, 0, 1148846080);
				}
			}
			iVar0++;
		}
...
int func_33(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_34(Global_92741) && iParam1 != 0)
		{
			Global_92741 = 0;
		}
	}
...
void func_41()
{
	...
	while (iVar0 < iLocal_233)
	{
		if (iLocal_235[iVar0] != 0)
		{
			...
			BRAIN::TASK_PLAY_ANIM(iLocal_233[iVar0], &Local_297, &(Local_306[iVar0 /*16*/]), 8f, -8f, -1, 1, 0f, 0, 0, 0);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_239)
	{
		if (iLocal_240[iVar0] != 0)
		{
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_311[iVar0 /*16*/])))
			{
				ENTITY::PLAY_ENTITY_ANIM(iLocal_239[iVar0], &(Local_311[iVar0 /*16*/]), &Local_297, 8f, true, 0, 0, 0, 0);
			}
		}
		iVar0++;
	}
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_105220.f_2354.f_539.f_2290[0];
			StringCopy(sParam2, func_51(Global_105220.f_2354.f_539.f_2294[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_105220.f_2354.f_539.f_2290[1];
			StringCopy(sParam2, func_51(Global_105220.f_2354.f_539.f_2294[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_105220.f_2354.f_539.f_2290[2];
			StringCopy(sParam2, func_51(Global_105220.f_2354.f_539.f_2294[2]), 32);
			return 1;
			break;
