	...
	switch (iLocal_684)
	{
		...
		case 1:
			if (func_17())
			{
				...
				func_2();
				CLEAR_AREA(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 30f, 1, 0, 0, 0);
				func_369();
			}
			break;
	}
...
void func_3()
{
	...
	REMOVE_RELATIONSHIP_GROUP(uLocal_80);
...
void func_26()
{
	...
	{
		if (func_30(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
		...
		case 0:
			...
			else if (func_143(1, vLocal_824, 0))
			{
				if (func_142())
				{
					...
					SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("s_m_y_garbage"), 1);
					iLocal_683 = 2;
					func_7(&uLocal_821);
					...
					SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_ATTRACTOR", 0);
				...
				else if (((func_143(2, Local_868.f_1, Local_868.f_4) && func_143(3, Local_840.f_1, Local_840.f_4)) && func_143(4, Local_854.f_1, Local_854.f_4)) && func_135(0))
				{
					...
					{
						uVar0 = GET_BLIP_FROM_ENTITY(Local_868);
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	ADD_RELATIONSHIP_GROUP("Enemies", &uLocal_80);
	SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[0 /*11*/], uLocal_80);
	SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[1 /*11*/], uLocal_80);
	SET_ENTITY_IS_TARGET_PRIORITY(Local_111[0 /*11*/], 1, 0);
	SET_ENTITY_IS_TARGET_PRIORITY(Local_111[1 /*11*/], 1, 0);
...
void func_123()
{
	...
	{
		TASK_FOLLOW_NAV_MESH_TO_COORD(Local_111[0 /*11*/], GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, func_131(1)), 1f, -1, 1048576000, 0, 1193033728);
...
{
	if (!IS_VEHICLE_SEAT_FREE(iLocal_109, 0, 0))
	{
		func_125(bParam0);
		if (iLocal_661 != (iLocal_81 - 1))
		{
			...
			{
				TASK_VEHICLE_DRIVE_TO_COORD(Local_111[0 /*11*/], iLocal_109, Local_134[iLocal_661 /*25*/], 15f, 0, 0, 2883755, Local_134[iLocal_661 /*25*/].f_6, Local_134[iLocal_661 /*25*/].f_7);
			}
...
void func_125(bool bParam0)
{
	if (iLocal_661 != -1)
	{
		...
		{
			SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_134[iLocal_661 /*25*/].f_11 - Local_134[iLocal_661 /*25*/].f_14, Local_134[iLocal_661 /*25*/].f_11 + Local_134[iLocal_661 /*25*/].f_14, 1, 1);
		}
	}
	if (!bParam0)
	{
	...
	if (iLocal_661 != -1)
	{
		if (!func_130(Local_134[iLocal_661 /*25*/].f_11) && !func_130(Local_134[iLocal_661 /*25*/].f_14))
		{
			SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_134[iLocal_661 /*25*/].f_11 - Local_134[iLocal_661 /*25*/].f_14, Local_134[iLocal_661 /*25*/].f_11 + Local_134[iLocal_661 /*25*/].f_14, 0, 1);
		}
	}
}
...
int func_129()
{
	...
	iVar0 = GET_RANDOM_INT_IN_RANGE(0, (iLocal_81 - 1));
...
Vector3 func_131(bool bParam0)
{
	...
	if (!bParam0)
	{
		uVar3 = GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_109, "wheel_rf");
	}
	else
	{
		uVar3 = GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_109, "wheel_lf");
	}
	vVar0 = { GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_109, uVar3) };
...
int func_143(int iParam0, vector3 vParam1, float fParam4)
{
	switch (iParam0)
	{
		...
		case 1:
			REQUEST_ADDITIONAL_TEXT(sLocal_819, 0);
		...
		case 2:
			if (func_36(Global_90209[0]))
			{
				...
				{
					func_35(Local_868, 0);
					SET_VEHICLE_HAS_STRONG_AXLES(Local_868, 1);
					_SET_ENTITY_SOMETHING(Local_868, 1);
					return 1;
				}
			}
		...
		case 3:
			if (DOES_ENTITY_EXIST(Global_90209.f_9[0]))
			{
				if (!IS_PED_DEAD_OR_DYING(Global_90209.f_9[0], 1))
				{
					...
					if (func_335(Local_840))
					{
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_840, 1);
						SET_PED_CONFIG_FLAG(Local_840, 170, 0);
						SET_PED_FLEE_ATTRIBUTES(Local_840, 65536, 1);
						SET_PED_COMBAT_ATTRIBUTES(Local_840, 50, 1);
						return 1;
					}
				}
				else
		...
		case 4:
			...
			{
				if (!IS_PED_DEAD_OR_DYING(Global_90209.f_9[1], 1))
				{
					SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_9[1], 1, 1);
					Local_854 = Global_90209.f_9[1];
					if (func_335(Local_854))
					{
						SET_PED_CONFIG_FLAG(Local_854, 170, 0);
						SET_PED_FLEE_ATTRIBUTES(Local_854, 65536, 1);
						SET_PED_COMBAT_ATTRIBUTES(Local_854, 50, 1);
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_854, 1);
						SET_ENTITY_LOAD_COLLISION_FLAG(Local_854, 1, 1);
						return 1;
					}
				}
				else
			...
			else if (func_144(&Local_854, Local_854.f_5, Local_854.f_1, Local_854.f_4, 1, 0, 1, 1))
			{
				if (func_36(Local_868))
				{
					SET_PED_INTO_VEHICLE(Local_854, Local_868, 0);
					SET_PED_CONFIG_FLAG(Local_854, 170, 0);
					SET_PED_FLEE_ATTRIBUTES(Local_854, 65536, 1);
					SET_PED_COMBAT_ATTRIBUTES(Local_854, 50, 1);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_854, 1);
...
void func_150(var uParam0, int iParam1)
{
	if (func_335(*uParam0))
	{
		...
		if (IS_ENTITY_PLAYING_ANIM(*uParam0, "missfbi4prepp1", "_bag_drop_garbage_man", 3))
		{
			if (GET_ENTITY_ANIM_CURRENT_TIME(*uParam0, "missfbi4prepp1", "_bag_drop_garbage_man") >= 0.172f)
			{
				if (func_10(Local_134[iLocal_661 /*25*/].f_17) && IS_ENTITY_ATTACHED(Local_134[iLocal_661 /*25*/].f_17))
				{
					...
					DETACH_ENTITY(Local_134[iLocal_661 /*25*/].f_17, 1, 0);
	...
	else
	{
		...
		if (DOES_ENTITY_EXIST(*uParam0))
		{
			if (!func_151(PLAYER_PED_ID(), *uParam0, 150f, 1) && !bLocal_665)
			{
...
void func_152(var uParam0)
{
	...
	{
		case 5:
			if ((GET_GAME_TIMER() - uParam0->f_1) > uParam0->f_3)
			{
				if (func_178(*uParam0, 780511057))
				{
					CLEAR_PED_TASKS(*uParam0);
				}
				TASK_SMART_FLEE_PED(*uParam0, PLAYER_PED_ID(), 30f, -1, 0, 0);
				uParam0->f_6 = 6;
		...
		case 21:
			...
			{
				if (func_171(*uParam0, PLAYER_PED_ID(), 1126825984, 1, 250, 7))
				{
					func_170(uParam0, 1);
					return;
				}
		...
		case 10:
			if ((GET_GAME_TIMER() - uParam0->f_1) > uParam0->f_3)
			{
				if (IS_PED_IN_ANY_VEHICLE(*uParam0, 0))
				{
					SET_PED_RESET_FLAG(*uParam0, 120, 1);
					uParam0->f_6 = 12;
					uParam0->f_1 = GET_GAME_TIMER();
				}
		...
		case 3:
			if ((GET_GAME_TIMER() - uParam0->f_1) > uParam0->f_3)
			{
				TASK_USE_MOBILE_PHONE(*uParam0, 1, 1);
				TASK_SMART_FLEE_PED(*uParam0, PLAYER_PED_ID(), 500f, -1, 0, 1);
				uParam0->f_1 = GET_GAME_TIMER();
				uParam0->f_6 = 4;
				uParam0->f_5 = 1;
			}
		...
		case 11:
			func_166(uParam0);
			if ((GET_GAME_TIMER() - uParam0->f_1) > 5000)
			{
				if (!func_178(*uParam0, 713668775))
				{
					if (DOES_ENTITY_EXIST(Local_111[func_165(uParam0->f_10) /*11*/]))
					{
						TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, vLocal_667, 1f, -1, 2f, 0, 1193033728);
					}
				}
				uParam0->f_1 = GET_GAME_TIMER();
				uParam0->f_6 = 23;
		...
		case 18:
			if (!func_178(*uParam0, -2017877118))
			{
				...
				if (func_164(GET_ENTITY_COORDS(*uParam0, 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) > 1.5f)
				{
					TASK_TURN_PED_TO_FACE_COORD(0, GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 0);
				}
				TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_MOBILE_FILM_SHOCKING", 6000, 1);
				CLOSE_SEQUENCE_TASK(uVar1);
				TASK_PERFORM_SEQUENCE(*uParam0, uVar1);
		...
		case 19:
			...
			if (!func_178(*uParam0, -2017877118))
			{
				TASK_START_SCENARIO_IN_PLACE(*uParam0, "WORLD_HUMAN_MOBILE_FILM_SHOCKING", 6000, 1);
				uParam0->f_5 = 1;
				uParam0->f_6 = 20;
				uParam0->f_1 = GET_GAME_TIMER();
			}
		...
		case 2:
			if (!IS_PED_SITTING_IN_ANY_VEHICLE(*uParam0) && (GET_GAME_TIMER() - uParam0->f_1) > 3000)
			{
				func_162(uParam0);
			}
			break;
		...
		case 4:
			if ((GET_GAME_TIMER() - uParam0->f_1) > 8000)
			{
				...
				TASK_USE_MOBILE_PHONE(*uParam0, 0, 1);
				uParam0->f_1 = GET_GAME_TIMER();
				uParam0->f_6 = 8;
			}
		...
		case 6:
			if ((GET_GAME_TIMER() - uParam0->f_1) > uParam0->f_2)
			{
				if (!func_151(*uParam0, PLAYER_PED_ID(), 15f, 1))
				{
					func_7(&(uParam0->f_4));
					uParam0->f_6 = 7;
					uParam0->f_1 = GET_GAME_TIMER();
		...
		case 7:
			if (IS_PED_IN_VEHICLE(*uParam0, iLocal_109, 1))
			{
				...
				if (!func_151(*uParam0, PLAYER_PED_ID(), 120f, 1))
				{
					func_5(uParam0, 1, 0, 1);
				}
			}
		...
		case 9:
			...
			if ((GET_GAME_TIMER() - uParam0->f_1) > uParam0->f_2 || !func_178(*uParam0, 2104565373))
			{
				func_157(uParam0);
			}
			break;
		...
		case 16:
			...
			else if ((GET_GAME_TIMER() - iLocal_670) >= 5000 && (GET_GAME_TIMER() - iLocal_670) <= 5500)
			{
				if (IS_PED_IN_ANY_VEHICLE(*uParam0, 0))
				{
					if (IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(*uParam0))
					{
						CLEAR_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(*uParam0);
					}
				}
			}
			break;
		...
		case 20:
			...
			if ((GET_GAME_TIMER() - uParam0->f_1) >= 6000)
			{
				if (!IS_ENTITY_IN_ANGLED_AREA(*uParam0, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, 5f, 0f, -2f), GET_ENTITY_COORDS(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0))
				{
					func_157(uParam0);
				}
				else
...
int func_153(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	vVar0 = { func_154(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_154(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
...
{
	if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, 0f, 10f, -2f), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, 0f, 3f, 2f), 5f, 0, 1, 0) && IS_PED_STOPPED(*uParam0))
	{
		return 1;
	}
	return 0;
...
void func_156(var uParam0)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		...
		if (func_36(iVar0))
		{
			if (!_0x639431E895B9AA57(*uParam0, iVar0, -1, 0, 0))
			{
				uParam0->f_6 = 18;
				uParam0->f_1 = GET_GAME_TIMER();
			}
...
{
	SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_80, 1862763509);
	switch (uParam0->f_8)
	{
		case 4:
			break;
		...
		case 3:
			if (!func_178(*uParam0, 242628503))
			{
				...
				if (!IS_PED_IN_VEHICLE(*uParam0, iLocal_109, 0))
				{
					if (uParam0->f_10 == 0)
					{
						TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, func_131(1)), 1f, -1, 1048576000, 0, 1193033728);
						uParam0->f_7 = 1;
					}
					else
					{
						TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, func_131(0)), 1f, -1, 1048576000, 0, 1193033728);
						uParam0->f_7 = 1;
					}
				}
			}
		...
		case 9:
			...
			else if (!IS_PED_IN_VEHICLE(*uParam0, iLocal_109, 0))
			{
				if (uParam0->f_10 == 0)
				{
					TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, func_131(1)), 1f, -1, 1048576000, 0, 1193033728);
...
int func_160()
{
	if (func_36(iLocal_109) && func_335(PLAYER_PED_ID()))
	{
...
{
	if (func_36(iLocal_109) && (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_109, 0) && !IS_PED_IN_VEHICLE(*uParam0, iLocal_109, 0)))
	{
...
int func_168(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_169(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
{
	func_163(uParam0);
	if ((IS_PED_ARMED(PLAYER_PED_ID(), 6) || iParam1) || uParam0->f_6 == 23)
	{
		if (!func_151(PLAYER_PED_ID(), *uParam0, 10f, 1))
		{
...
void func_179(var uParam0)
{
	...
	switch (uParam0->f_7)
	{
		...
		case 5:
			if (func_36(iLocal_109))
			{
				_SET_VEHICLE_HALT(iLocal_109, 25f, 10, 0);
	...
	switch (uParam0->f_9)
	{
		case 1:
			if (!func_178(*uParam0, -2015108952))
			{
				...
				{
					TASK_TURN_PED_TO_FACE_COORD(0, Local_134[iLocal_661 /*25*/].f_19, 0);
				}
		...
		case 3:
			if (func_36(iLocal_109))
			{
				...
				{
					if (IS_ENTITY_AT_COORD(*uParam0, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, 0f, -5.5f, 0f), 0.9f, 0.9f, 2f, 0, 1, 0))
					{
						if (!func_178(*uParam0, 713668775))
						{
							OPEN_SEQUENCE_TASK(&uVar1);
							...
							{
								TASK_ACHIEVE_HEADING(0, GET_ENTITY_HEADING(iLocal_109), 0);
							}
							TASK_PLAY_ANIM(0, "missfbi4prepp1", "_bag_throw_garbage_man", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
							CLOSE_SEQUENCE_TASK(uVar1);
							TASK_PERFORM_SEQUENCE(*uParam0, uVar1);
							CLEAR_SEQUENCE_TASK(&uVar1);
							uParam0->f_9 = 4;
						...
						if (GET_ENTITY_ANIM_CURRENT_TIME(*uParam0, "missfbi4prepp1", "_bag_throw_garbage_man") >= 0.391f)
						{
							if (func_10(Local_134[iLocal_661 /*25*/].f_17))
							{
								if (IS_ENTITY_ATTACHED(Local_134[iLocal_661 /*25*/].f_17))
								{
									...
									RESET_PED_WEAPON_MOVEMENT_CLIPSET(*uParam0);
									DETACH_ENTITY(Local_134[iLocal_661 /*25*/].f_17, 1, 0);
									SET_OBJECT_PHYSICS_PARAMS(Local_134[iLocal_661 /*25*/].f_17, 2f, -1f, -1f, -1f, -1f, -1f, -1f, -1f, -1082130432, -1082130432, -1082130432);
									APPLY_FORCE_TO_ENTITY_CENTER_OF_MASS(Local_134[iLocal_661 /*25*/].f_17, 1, GET_ENTITY_FORWARD_VECTOR(*uParam0), 0, 1, 1, 0);
								}
...
void func_182(var uParam0)
{
	...
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_80, 1862763509);
	func_163(uParam0);
	if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		if (!IS_PED_IN_ANY_VEHICLE(*uParam0, 0))
...
void func_187(var uParam0, var uParam1)
{
	switch (uParam0->f_1)
	{
		...
		case 1:
			*uParam0 = START_SHAPE_TEST_LOS_PROBE(uParam0->f_2, uParam0->f_5, 511, uParam1, 7);
			break;
		...
		case 4:
			*uParam0 = START_SHAPE_TEST_BOX(uParam0->f_2, uParam0->f_8, uParam0->f_11, uParam0->f_14, 6, uParam1, 4);
			break;
		
		case 5:
			*uParam0 = START_SHAPE_TEST_CAPSULE(uParam0->f_2, uParam0->f_5, uParam0->f_15, 511, uParam1, 4);
			break;
	}
...
void func_188(var uParam0)
{
	...
	{
		OPEN_SEQUENCE_TASK(&uVar0);
		TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_109, Local_134[iLocal_661 /*25*/].f_3, 8f, 0, joaat("trash"), 786469, 10f, 15f);
		TASK_VEHICLE_PARK(0, iLocal_109, Local_134[iLocal_661 /*25*/].f_3, Local_134[iLocal_661 /*25*/].f_8, Local_134[iLocal_661 /*25*/].f_10, 5f, 1);
		CLOSE_SEQUENCE_TASK(uVar0);
		TASK_PERFORM_SEQUENCE(*uParam0, uVar0);
		CLEAR_SEQUENCE_TASK(&uVar0);
		uParam0->f_7 = 6;
...
void func_190(var uParam0, bool bParam1)
{
	...
	if (func_185(GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, func_131(bParam1)), iLocal_109, 1.9f, 1.9f, 8f))
	{
		if (IS_ENTITY_IN_ANGLED_AREA(*uParam0, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, 5f, 0f, -2f), GET_ENTITY_COORDS(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0) && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, 5f, 0f, -2f), GET_ENTITY_COORDS(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0))
		{
			func_191(uParam0);
		}
		else if (!func_178(*uParam0, 1227113341) && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, 5f, 0f, -2f), GET_ENTITY_COORDS(iLocal_109, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0))
		{
			CLEAR_PED_TASKS(*uParam0);
			TASK_GO_TO_ENTITY(*uParam0, PLAYER_PED_ID(), -1, 4f, 1f, 1073741824, 0);
		}
	}
	else if (func_101(*uParam0, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_109, func_131(bParam1)), 5f))
	{
		iVar0 = -1;
		if (!bParam1)
		{
		...
		if (func_36(iLocal_109) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if (!func_178(*uParam0, 2104565373) && IS_PED_IN_VEHICLE(*uParam0, iLocal_109, 0))
			{
				if (func_151(PLAYER_PED_ID(), iLocal_109, 10f, 1))
				{
					...
					{
						TASK_DRIVE_BY(*uParam0, PLAYER_PED_ID(), 0, 0f, 0f, 0f, 10f, 100, 1, -957453492);
						uParam0->f_1 = GET_GAME_TIMER();
						uParam0->f_6 = 9;
					}
				}
...
void func_196(var uParam0, int iParam1, int iParam2)
{
	if (uParam0->f_5 != 1 || iParam2)
	{
		...
		{
			if (func_175(*uParam0, Local_111[func_165(iParam1) /*11*/], 140f, 0) && func_151(Local_111[func_165(iParam1) /*11*/], PLAYER_PED_ID(), 15f, 1))
			{
				uParam0->f_5 = 1;
				uParam0->f_6 = 21;
			}
				...
				if (func_36(iLocal_109))
				{
					if (IS_PED_IN_VEHICLE(*uParam0, iLocal_109, 0))
					{
						if (GET_ENTITY_SPEED(iLocal_109) > 5f)
						{
							if (iParam1 == 0)
							{
								TASK_VEHICLE_MISSION_PED_TARGET(*uParam0, iLocal_109, PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
								uParam0->f_6 = 7;
		...
		else if (IS_PED_BEING_JACKED(*uParam0))
		{
			func_163(uParam0);
			TASK_SMART_FLEE_PED(*uParam0, PLAYER_PED_ID(), 500f, -1, 0, 1);
			uParam0->f_6 = 2;
	...
	if (uParam0->f_5 != 1)
	{
		if (func_335(Local_111[func_165(iParam1) /*11*/]))
		{
			...
			{
				func_163(uParam0);
				TASK_SMART_FLEE_PED(*uParam0, PLAYER_PED_ID(), 120f, -1, 0, 0);
				uParam0->f_1 = GET_GAME_TIMER();
				uParam0->f_6 = 7;
				uParam0->f_5 = 1;
			}
...
{
	if ((IS_ENTITY_AT_COORD(PLAYER_PED_ID(), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(*uParam0, 0f, -2f, 0f), 2f, 3f, 2f, 0, 1, 0) && !IS_PED_ARMED(PLAYER_PED_ID(), 6)) && GET_PED_STEALTH_MOVEMENT(PLAYER_PED_ID()))
	{
		return 1;
	}
	return 0;
...
{
	if (func_151(uParam0, PLAYER_PED_ID(), 6f, 1))
	{
		if (!IS_PED_IN_ANY_VEHICLE(uParam0, 0))
		{
		...
		switch (*iParam2)
		{
			case 0:
				...
				else
				{
					...
					{
						CLEAR_THIS_PRINT(func_109(func_76(), bParam9));
					}
					if (func_76() != 33)
					{
						func_211(iParam0);
...
int func_213(int iParam0)
{
	...
	if ((func_335(PLAYER_PED_ID()) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0)) && func_36(iParam0))
	{
			...
			if (!func_218(iVar2))
			{
				if (func_77(iVar2, 0))
				{
					if (func_225(iVar2) || func_223(iVar2))
					{
						if (func_222(iVar2, 0))
						{
							SET_ENTITY_AS_MISSION_ENTITY(iVar2, 1, 1);
			...
			else if (DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar2, 1))
			{
				if (func_225(iVar2))
				{
					if (GET_SCRIPT_TASK_STATUS(iVar2, -1273030092) != 1 && GET_SCRIPT_TASK_STATUS(iVar2, -1273030092) != 0)
					{
						...
						{
							TASK_VEHICLE_DRIVE_TO_COORD(iVar2, GET_VEHICLE_PED_IS_IN(iVar2, 0), vLocal_827, 20f, 0, 0, 34340901, 2f, 10f);
						}
						else
						{
	...
	if (!func_224())
	{
		if ((!IS_PED_INJURED(PLAYER_PED_ID()) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0)) && GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) == 0)
		{
			...
			if (func_36(iVar0))
			{
				...
				if (IS_PED_IN_VEHICLE(iParam0, iVar0, 0) && GET_PED_IN_VEHICLE_SEAT(iVar0, -1, 0) == iParam0)
				{
					return 1;
				}
			}
...
int func_225(int iParam0)
{
	if (!func_224())
	{
		if ((DOES_ENTITY_EXIST(Local_868) && IS_VEHICLE_DRIVEABLE(Local_868, 0)) && !IS_ENTITY_AT_COORD(Local_868, vLocal_827, 2f, 2f, 2f, 0, 1, 0))
		{
			if ((!IS_PED_INJURED(PLAYER_PED_ID()) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_868, 0)) && GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) == 0)
			{
				if (IS_PED_IN_VEHICLE(iParam0, Local_868, 0) && GET_PED_IN_VEHICLE_SEAT(Local_868, -1, 0) == iParam0)
				{
					return 1;
				}
			}
...
void func_226(int iParam0)
{
	if (iLocal_683 > 1)
	{
		if (iLocal_685 > 0)
		{
			if (!IS_BIT_SET(Local_688[iParam0 /*8*/].f_7, 0) && iLocal_686 == 1)
			{
				if (!IS_MESSAGE_BEING_DISPLAYED())
				{
					if (func_230(&uLocal_879, cLocal_878, Local_688[iParam0 /*8*/][0], 8, 0, 0, 0))
					{
						SET_BIT(&(Local_688[iParam0 /*8*/].f_7), 0);
					}
				}
			}
		}
		...
		{
			if ((IS_BIT_SET(Local_688[iParam0 /*8*/].f_7, 0) && !IS_BIT_SET(Local_688[iParam0 /*8*/].f_7, 1)) && iLocal_686 == 1)
			{
				if (!IS_MESSAGE_BEING_DISPLAYED())
				{
					if (func_230(&uLocal_879, cLocal_878, Local_688[iParam0 /*8*/][1], 7, 0, 0, 0))
					{
						SET_BIT(&(Local_688[iParam0 /*8*/].f_7), 1);
					}
				}
			}
...
void func_233()
{
	...
	switch (iLocal_684)
	{
		...
		case 1:
			...
			if (!bLocal_833)
			{
				if (func_335(Local_840) && IS_PED_BEING_JACKED(Local_840))
				{
					func_235();
				}
				if (func_335(Local_854) && IS_PED_BEING_JACKED(Local_854))
				{
					func_235();
				}
			}
...
void func_239(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_263(uParam1) && IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
...
int func_245(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_253() || func_252(Global_4456448.f_161209)) || func_251())
	{
		...
		{
			uVar0 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
			iVar1 = func_250(PLAYER_PED_ID(), 0);
			if (((_0xE33FFA906CE74880(uVar0, iVar1) || (GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_249(uVar0, 10)) && GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_246(int iParam0)
{
	if (iParam0 != func_248())
	{
		...
		else if ((Global_1312867 && iParam0 == PLAYER_ID()) && func_247(iParam0, 1, 0))
		{
			return Global_2424047[iParam0 /*416*/].f_309.f_5 != -1;
		}
	}
...
int func_258(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_261(bParam1, bParam2, bParam3) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1) || func_259(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_278()
{
	...
	if (DOES_ENTITY_EXIST(iVar0))
	{
		...
		{
			func_279(iVar0, GET_ENTITY_COORDS(iVar0, 1), GET_ENTITY_HEADING(iVar0), 24, 0);
		}
	}
}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_297(iParam0, 0, 0)) || func_297(iParam0, 1, 0)) || func_297(iParam0, 2, 0)) || func_320(iParam0) != 145) || func_296(iParam0)) || func_295(iParam0)) || func_294(iParam0)) || func_293(iParam0)) || !func_283(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_295(iParam0))
		{
		}
...
var func_300()
{
	...
	func_310(&uVar0, GET_CLOCK_SECONDS());
	func_309(&uVar0, GET_CLOCK_MINUTES());
	func_308(&uVar0, GET_CLOCK_HOURS());
	func_303(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_302(&uVar0, GET_CLOCK_MONTH());
	func_301(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SHIFT_RIGHT(uParam0, 26) & 31 * func_306(IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_322(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_332()
{
	...
	else
	{
		...
		{
			if (!func_151(PLAYER_PED_ID(), uLocal_875, fVar0, 1))
			{
				iVar1++;
			}
		}
...
int func_342(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2539502[iParam0 /*3*/][func_341(iParam1)];
...
int func_349(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_344() == 0)
		{
			return IS_BIT_SET(func_342(func_343(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_369()
{
	...
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("s_m_y_garbage"), 0);
	func_62();
	func_379();
	func_378();
	func_370(0);
...
void func_370(bool bParam0)
{
	...
	SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_ATTRACTOR", 1);
	...
	func_139(&uLocal_671, 0, 0);
	if (DOES_CAM_EXIST(uLocal_823))
	{
		RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
		DESTROY_CAM(uLocal_823, 0);
	}
}
