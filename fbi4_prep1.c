...
{
	func_13(&(Global_98783.f_2875), vParam0, fParam1);
}
...
{
	if (func_15(Global_71218, 0f, 0f, 0f, 0))
	{
...
void func_18(int iParam0)
{
	...
	if (Global_105220.f_9056 || func_32(0))
	{
		iVar0 = func_31();
		if (!func_19(iVar0))
		{
...
int func_19(int iParam0)
{
	...
	func_20(&(Global_105220.f_2354.f_539), iVar1);
...
void func_20(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_22(Global_105220.f_18504[iVar0], &vVar2, &fVar3))
			{
...
void func_26()
{
	...
	{
		if (func_30(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_58(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_32(0) && Global_71224.f_1 == 1) && func_59(Global_71224))
		{
		}
		else
		{
...
int func_78(int iParam0)
{
	...
	return Global_90578[func_79(iParam0)];
}
		...
		case 0:
			...
			else if (func_143(1, vLocal_185, 0))
			{
				if (func_142())
				{
					...
					BRAIN::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_ATTRACTOR", false);
...
void func_123()
{
	...
	{
		BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_45[0 /*11*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_131(1)), 1f, -1, 0.25f, 0, 1193033728);
		Local_45[0 /*11*/].f_7 = 1;
	}
	else
	{
...
int func_143(int iParam0, vector3 vParam1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 4:
			...
			{
				if (!PED::IS_PED_DEAD_OR_DYING(Global_89597.f_9[1], 1))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89597.f_9[1], true, 1);
					Local_198 = Global_89597.f_9[1];
					if (func_334(Local_198))
					{
		...
		case 11:
			...
			if ((MISC::GET_GAME_TIMER() - iParam0->f_1) > 5000)
			{
				if (!func_178(*iParam0, 713668775))
				{
					...
					{
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, vLocal_54, 1f, -1, 2f, 0, 1193033728);
					}
				}
				iParam0->f_1 = MISC::GET_GAME_TIMER();
				iParam0->f_6 = 23;
		...
		case 3:
			if (!func_178(*iParam0, 242628503))
			{
				...
				if (!PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_43, 0))
				{
					if (iParam0->f_10 == 0)
					{
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_131(1)), 1f, -1, 0.25f, 0, 1193033728);
						iParam0->f_7 = 1;
					}
					else
					{
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(*iParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_131(0)), 1f, -1, 0.25f, 0, 1193033728);
						iParam0->f_7 = 1;
					}
				}
			}
...
void func_158(var uParam0)
{
	if (!func_178(*uParam0, -71340211))
	{
		if (Local_46[iLocal_48 /*25*/].f_23 != 0)
		{
			if (func_10(Local_46[iLocal_48 /*25*/].f_17))
			{
				BRAIN::TASK_GOTO_ENTITY_OFFSET(*uParam0, Local_46[iLocal_48 /*25*/].f_17, -1, 0f, 180f, 1f, 0);
			}
		}
		else
		{
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_46[iLocal_48 /*25*/].f_19, 1f, 20000, -1f, 0, func_159(Local_46[iLocal_48 /*25*/].f_19, ENTITY::GET_ENTITY_COORDS(*uParam0, true), 1));
		}
		if (func_36(iLocal_43))
		{
...
int func_160()
{
	if (func_36(iLocal_43) && func_334(PLAYER::PLAYER_PED_ID()))
	{
	...
	switch (uParam0->f_9)
	{
		case 1:
			if (!func_178(*uParam0, -2015108952))
			{
				...
				{
					BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, Local_46[iLocal_48 /*25*/].f_19, 0);
				}
		...
		case 2:
			...
			else if (!func_178(*uParam0, 713668775))
			{
				if (func_36(iLocal_43))
				{
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 0f, -4.8f, 0f), 1f, -1, 0.25f, 0, ENTITY::GET_ENTITY_HEADING(iLocal_43));
				}
				uParam0->f_9 = 3;
			}
			PED::SET_PED_CAPSULE(*uParam0, 0.2f);
				...
				if (!func_185(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 0f, -5.5f, 0f), iLocal_43, 1.9f, 1.9f, 8f))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 0f, -5.5f, 0f), 0.9f, 0.9f, 2f, false, true, 0))
					{
						if (!func_178(*uParam0, 713668775))
						{
							...
							BRAIN::CLOSE_SEQUENCE_TASK(iVar1);
							BRAIN::TASK_PERFORM_SEQUENCE(*uParam0, iVar1);
							BRAIN::CLEAR_SEQUENCE_TASK(&iVar1);
							uParam0->f_9 = 4;
						}
					}
...
void func_188(var uParam0)
{
	...
	if (func_36(iLocal_43))
	{
		...
		BRAIN::TASK_VEHICLE_PARK(0, iLocal_43, Local_46[iLocal_48 /*25*/].f_3, Local_46[iLocal_48 /*25*/].f_8, Local_46[iLocal_48 /*25*/].f_10, 5f, 1);
		BRAIN::CLOSE_SEQUENCE_TASK(iVar0);
		BRAIN::TASK_PERFORM_SEQUENCE(*uParam0, iVar0);
		BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
		uParam0->f_7 = 6;
...
void func_190(var uParam0, bool bParam1)
{
	...
	else if (func_101(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_131(bParam1)), 5f))
	{
		...
		BRAIN::TASK_ENTER_VEHICLE(*uParam0, iLocal_43, -1, iVar0, 1f, 8388609, 0);
		uParam0->f_7 = 2;
	}
}
				...
				if (func_36(iLocal_43))
				{
					if (PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_43, 0))
					{
						if (ENTITY::GET_ENTITY_SPEED(iLocal_43) > 5f)
						{
							if (iParam1 == 0)
							{
								BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(*iParam0, iLocal_43, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
								iParam0->f_6 = 7;
								BRAIN::TASK_COWER(Local_45[func_165(iParam1) /*11*/], -1);
							...
							else
							{
								BRAIN::TASK_COWER(*iParam0, -1);
								iParam0->f_6 = 12;
								BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(Local_45[func_165(iParam1) /*11*/], iLocal_43, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
...
int func_213(int iParam0)
{
	...
	if ((func_334(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_36(iParam0))
	{
...
void func_233()
{
	...
	switch (iLocal_69)
	{
		...
		case 1:
			...
			if (!bLocal_190)
			{
				if (func_334(Local_197) && PED::IS_PED_BEING_JACKED(Local_197))
				{
					func_235();
				}
				if (func_334(Local_198) && PED::IS_PED_BEING_JACKED(Local_198))
				{
					func_235();
				}
			}
...
void func_277()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			func_278(iVar0, ENTITY::GET_ENTITY_COORDS(iVar0, true), ENTITY::GET_ENTITY_HEADING(iVar0), 24, 0);
		}
	}
}
...
void func_280(int iParam0, int iParam1)
{
	...
	func_320(iParam0, &(Global_105220.f_32546.f_5510));
}

int func_281(int iParam0)
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_296(iParam0, 0, 0)) || func_296(iParam0, 1, 0)) || func_296(iParam0, 2, 0)) || func_319(iParam0) != 145) || func_295(iParam0)) || func_294(iParam0)) || func_293(iParam0)) || func_292(iParam0)) || !func_282(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_294(iParam0))
		{
		}
...
int func_310(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_15(Global_105220.f_32546.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_15(Global_105220.f_2354.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_15(Global_105220.f_2354.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_313(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_310(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_318(iParam0);
			func_317(uParam1, &(Global_105220.f_32546.f_69[Global_69800.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_339(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	int iVar0;
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_340(iParam2)];
	if (iVar0 != 0)
	{
...
int func_341(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_340(iParam1)];
...
int func_348(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_343() == 0)
		{
			return MISC::IS_BIT_SET(func_341(func_342(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
struct<8> func_353(char* sParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)
{
	struct<8> Var0;
...
void func_355(var uParam0, vector3 vParam1, int iParam2, float fParam3, float fParam4, float fParam5, int iParam6, vector3 vParam7, vector3 vParam8)
{
	uParam0->f_3 = { vParam1 };
	uParam0->f_6 = fParam3;
	uParam0->f_7 = fParam4;
...
struct<25> func_356(vector3 vParam0, vector3 vParam1, float fParam2, int iParam3)
{
	struct<25> Var0;
...
bool func_360(var uParam0, struct<2> Param1, Vector3 vParam2)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
struct<14> func_365(vector3 vParam0, float fParam1, int iParam2)
{
	struct<14> Var0;
...
struct<6> func_367(vector3 vParam0, float fParam1, int iParam2)
{
	struct<6> Var0;
...
void func_369(bool bParam0)
{
	...
	BRAIN::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_ATTRACTOR", true);
