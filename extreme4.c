...
void func_223()
{
	...
	if (func_311(Local_91))
	{
		if (iVar0 < 3)
		{
			...
			vVar4 = { ENTITY::GET_ENTITY_COORDS(Local_91, 1) };
			if (vVar4.z > 155f)
			{
				fVar5 = 155f;
			}
...
void func_226(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_230(PLAYER::PLAYER_ID())) && !func_228(PLAYER::PLAYER_ID(), 0)) && !func_227())
			{
...
void func_292()
{
	...
	if (iLocal_84 == 1)
	{
		...
		{
			fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_91, 1), true);
			if (iLocal_89 == 0)
			{
				if (fVar0 > 160f)
				{
...
{
	if (((!func_307(0) || Global_71125) || Global_71114 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71110)
