	...
	while (true)
	{
		switch (iLocal_45)
		{
			...
			case 2:
				...
				func_12(1);
				func_9(&iLocal_47);
				if (!func_8(Global_105220.f_19068, 4096))
				{
					func_6(&(Global_105220.f_19068), 4096);
				}
				iLocal_45 = 3;
				break;
			
			case 3:
				if (((func_2(&iLocal_47) > ScriptParam_50.f_67 && ScriptParam_50.f_67 != -1f) || CAM::IS_SCREEN_FADED_OUT()) || Global_25421)
				{
					func_17();
				}
				else
