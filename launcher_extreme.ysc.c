...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != 4294967295)
		{
			if (Global_19AC5[Var0 /*10*/].f_9 != 4294967295)
			{
				...
				func_282(&(Global_19AC5[Var0 /*10*/].f_9));
			}
		}
		func_270(&Var0, 1);
	}
	...
	if (Var0 == 17)
	{
		...
		BRAIN::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_SALTON_DIRT_BIKE", 0);
	}
	else if (Var0 == 18)
	{
	...
	while (true)
	{
		...
		else if (Var0 == 19)
		{
			...
			if ((((((!func_188() && func_187(Var0.f_1C[0])) && !AUDIO::IS_ANY_SPEECH_PLAYING(Var0.f_1C[0])) && AUDIO::HAS_SOUND_FINISHED(iLocal_56)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, 4294967295)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, 4294967295)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, 4294967295))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_56, "DOM_BREATHING", Var0.f_1C[0], "EXTREME_03_SOUNDSET", 0, 0);
			}
			if ((iLocal_55 == 0 && func_187(AUDIO::_0x0626A247D2405330())) && ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vVar1, Var0.f_F, Var0.f_F, Var0.f_F, false, false, 0))
			{
				vVar3 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true) };
				if (vVar3.z < 100f)
				{
					iLocal_55 = 1;
					func_186("TOPMAZE_HELP", 4294967295);
...
void func_47(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x38A9
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x3A49
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x3A7B
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x3AAF
{
	return Global_1407E0;
}

int func_51(int iParam0, int iParam1)//Position - 0x3ABB
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3AE7
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x4030
{
	int iVar0;
...
int func_54()//Position - 0x4271
{
	func_55();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_55()//Position - 0x428A
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x4387
{
	return Global_8D15 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x4395
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x4488
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x4712
{
	switch (iParam0)
	{
		case 3036451504:
...
int func_60(int iParam0)//Position - 0x47AD
{
...
int func_61(int iParam0, int iParam1)//Position - 0x4933
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x54A4
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x54DF
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x5753
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x578F
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_66(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x5CEA
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5D2E
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x640D
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x6454
{
...
bool func_70(int iParam0)//Position - 0x64AF
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x64BF
{
...
int func_72(int iParam0)//Position - 0x6529
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x682C
{
	return Global_6373;
}

int func_74(int iParam0)//Position - 0x6837
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6847
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x68E9
{
	switch (iParam0)
	{
		case 4294967295:
...
int func_77(int iParam0)//Position - 0x6EBE
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6F1C
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6FCA
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x705F
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x70A3
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x7227
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x7235
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7CFC
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7D7E
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7DDC
{
	return 4294967295;
}

Vector3 func_87(int iParam0)//Position - 0x7DE5
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x7FF0
{
	return func_89(CAM::_0xDC9DA9E8789F5246());
}

int func_89(int iParam0)//Position - 0x8000
{
	return MISC::GET_BITS_IN_RANGE(Global_24FBF9[iParam0 /*413*/].f_135.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x801D
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x802D
{
	switch (iParam0)
	{
		case 4294967295:
...
bool func_92()//Position - 0x82D4
{
	return Global_16C64.f_147 > 0;
}

var func_93()//Position - 0x82E5
{
	var uVar0;
...
void func_94(var uParam0, int iParam1)//Position - 0x832B
{
	if (iParam1 <= 0)
	{
		return;
...
void func_95(var uParam0, int iParam1)//Position - 0x83B1
{
...
void func_96(var uParam0, int iParam1)//Position - 0x83E4
{
	int iVar0;
	int iVar1;
...
int func_97(int iParam0, int iParam1)//Position - 0x8435
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_100(var uParam0)//Position - 0x8513
{
	return uParam0 & 15;
}

void func_101(var uParam0, int iParam1)//Position - 0x8520
{
...
void func_102(var uParam0, int iParam1)//Position - 0x855A
{
...
void func_103(var uParam0, int iParam1)//Position - 0x8595
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_104()//Position - 0x85D1
{
	func_55();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_105(int iParam0)//Position - 0x85EA
{
	var uVar0;
	vector3 vVar1[24];
...
void func_106(char* sParam0, int iParam1, int iParam2)//Position - 0x8643
{
...
bool func_107(bool bParam0)//Position - 0x8685
{
...
struct<2> func_108(int iParam0)//Position - 0x86B0
{
	struct<2> Var0;
...
void func_109(int iParam0, var uParam1)//Position - 0x8AFD
{
	switch (iParam0)
	{
		case 0:
...
int func_111(int iParam0)//Position - 0x9DD5
{
	switch (iParam0)
	{
		case 0:
...
int func_112(int iParam0)//Position - 0xA11B
{
	int iVar0;
...
void func_113(int iParam0)//Position - 0xA1BF
{
	struct<2> Var0;
...
void func_114(int iParam0)//Position - 0xA25A
{
	if (iParam0 < 63)
	{
		func_115();
...
void func_116(int iParam0)//Position - 0xA2B8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_117(int iParam0)//Position - 0xA311
{
...
int func_118(int iParam0)//Position - 0xA394
{
	int iVar0;
...
void func_119(int iParam0, int iParam1, int iParam2)//Position - 0xA3C5
{
	func_120(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_120(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA3DA
{
	int iVar0;
...
int func_122(int iParam0, int iParam1, int iParam2)//Position - 0xA48D
{
...
int func_123(int iParam0, int iParam1, int iParam2)//Position - 0xA4A8
{
	int iVar0;
...
int func_124(int iParam0)//Position - 0xA4F4
{
	int iVar0;
...
int func_125(int iParam0)//Position - 0xA53D
{
	if (func_187(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_126(int iParam0)//Position - 0xA55D
{
	switch (iParam0)
	{
		case 5:
...
int func_128(int iParam0)//Position - 0xA62D
{
	switch (iParam0)
	{
		case 5:
...
void func_129(var uParam0, bool bParam1, bool bParam2)//Position - 0xA680
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_187(uParam0->f_1C[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_187(uParam0->f_23[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_187(uParam0->f_29[iVar0]))
		{
...
int func_130(int iParam0)//Position - 0xA775
{
	switch (iParam0)
	{
		case 5:
...
void func_131(bool bParam0)//Position - 0xA7E0
{
	int iVar0;
...
void func_132(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA81D
{
	if (bParam0)
	{
...
int func_135(int iParam0, bool bParam1)//Position - 0xA9AE
{
	int iVar0;
	int iVar1;
...
int func_136(int iParam0)//Position - 0xA9EF
{
...
bool func_137()//Position - 0xAA31
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_240006, 3);
}

int func_138(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xAA42
{
	int iVar0;
...
void func_140(int iParam0)//Position - 0xAA9C
{
	if (iParam0 == 1)
	{
...
int func_141(char* sParam0)//Position - 0xAABF
{
...
void func_142()//Position - 0xAAFC
{
	Global_3960 = 0;
	func_143();
}

void func_143()//Position - 0xAB0C
{
...
void func_145()//Position - 0xAB78
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
		{
			if (func_146(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xABD0
{
...
void func_147(int iParam0)//Position - 0xAD5F
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_149(int iParam0)//Position - 0xADDC
{
	if (func_153())
	{
		return;
...
void func_150(int iParam0)//Position - 0xAE0F
{
	if (func_153())
	{
		return;
...
void func_151(bool bParam0, bool bParam1)//Position - 0xAE89
{
	if (bParam0)
	{
		if (func_152(0))
...
int func_152(int iParam0)//Position - 0xAEFD
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
bool func_153()//Position - 0xAF57
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

int func_154(int iParam0)//Position - 0xAF69
{
...
int func_155(int iParam0)//Position - 0xAFAA
{
	int iVar0;
	...
	iVar0 = func_157(&(Global_19AC5[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
void func_156(int iParam0)//Position - 0xAFEF
{
...
int func_157(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB021
{
	int iVar0;
...
void func_158(var uParam0, int iParam1)//Position - 0xB158
{
	int iVar0;
...
bool func_159(int iParam0)//Position - 0xB1A7
{
	return func_160(iParam0, Global_8D15);
}

int func_160(int iParam0, int iParam1)//Position - 0xB1B8
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_161(int iParam0)//Position - 0xB399
{
	if (Global_8D15 == 15)
	{
		return 0;
...
int func_162()//Position - 0xB3BB
{
	return func_163(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_163(char* sParam0, int iParam1)//Position - 0xB3CC
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_165(int iParam0, int iParam1)//Position - 0xB439
{
	switch (iParam0)
	{
		case 0:
...
int func_166(vector3 vParam0, bool bParam1)//Position - 0xB8C0
{
	int iVar0;
...
float func_167(bool bParam0, float fParam1, float fParam2)//Position - 0xB8EC
{
	if (bParam0)
	{
		return fParam1;
...
int func_168(int iParam0)//Position - 0xB903
{
	switch (iParam0)
	{
		case 0:
...
int func_169(var uParam0)//Position - 0xB992
{
	if (*uParam0 == 18)
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -954.5357f, -2760.553f, 11.91636f, -947.6847f, -2749.719f, 15.63161f, 26f, 0, true, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
			{
			...
			else if ((!func_170(AUDIO::_0x0626A247D2405330(), 3466132403) && func_187(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0))) && func_146(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 3f, 1, 1056964608, 0, 1, 0))
			{
				BRAIN::TASK_LEAVE_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0, 0);
			}
		}
...
int func_170(int iParam0, int iParam1)//Position - 0xBA39
{
	if (func_125(iParam0))
	{
...
int func_171(var uParam0, int iParam1)//Position - 0xBA6C
{
	switch (uParam0->f_10)
	{
		case 0:
			if (*uParam0 == 12)
			{
				...
				else if (func_187(uParam0->f_1C[0]))
				{
					if (func_173(uParam0))
					{
						if (func_177(2))
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
				{
					if (func_187(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
					{
...
void func_172()//Position - 0xC250
{
	func_27(&(Global_17998.f_B3B), &Global_17998, 0, 1, 1, 0);
}

int func_173(var uParam0)//Position - 0xC26B
{
	float fVar0;
...
void func_174(int iParam0, int iParam1)//Position - 0xC2F9
{
	if (iParam0 == 1)
	{
		if (!func_128(iParam1))
...
int func_175(bool bParam0)//Position - 0xC35D
{
	int iVar0;
...
int func_176(int iParam0)//Position - 0xC3F4
{
	if (func_187(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
int func_177(int iParam0)//Position - 0xC41E
{
	int iVar0;
...
var func_178()//Position - 0xCB3B
{
	return Global_16C57.f_1;
}

int func_179()//Position - 0xCB49
{
...
bool func_182()//Position - 0xCBB3
{
	return Global_16C64.f_148 > 0;
}

bool func_183(int iParam0, int iParam1)//Position - 0xCBC4
{
	switch (iParam0)
	{
		case 5:
...
var func_184()//Position - 0xCBFF
{
	return Global_140859;
}

int func_185()//Position - 0xCC0B
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_186(char* sParam0, int iParam1)//Position - 0xCC27
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_187(int iParam0)//Position - 0xCC3E
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
int func_189(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xCC81
{
	var uVar0;
	
	if ((((func_187(AUDIO::_0x0626A247D2405330()) && func_187(iParam0->f_1C[0])) && !func_188()) && (MISC::GET_GAME_TIMER() - iParam0->f_3C) > iParam6) && func_193(AUDIO::_0x0626A247D2405330(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_192(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
...
void func_190(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCD09
{
...
void func_191(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCD44
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
void func_192(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCD9A
{
...
float func_193(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xCE35
{
	vector3 vVar0;
...
void func_194(int iParam0)//Position - 0xCE6F
{
	if (CUTSCENE::_0xB56BBBCC2955D9CB())
	{
		if (func_187(iParam0->f_1C[0]))
		{
			CUTSCENE::_0x2A56C06EBEF2B0D9("Dom", iParam0->f_1C[0], 0);
		}
	}
}

void func_195(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xCE9C
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_193(AUDIO::_0x0626A247D2405330(), vParam2, 1) <= 100f)
				{
					func_198(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_193(AUDIO::_0x0626A247D2405330(), vParam2, 1) > 120f)
				{
					func_200(iParam0);
				}
			}
...
void func_196(int iParam0, bool bParam1)//Position - 0xCF8D
{
	if (iParam0 == 4294967295)
	{
		return;
...
int func_197(int iParam0)//Position - 0xCFC9
{
	if (Global_11621 == iParam0)
	{
...
void func_198(int iParam0, int iParam1)//Position - 0xD002
{
	bool bVar0;
	int iVar1;
...
bool func_199()//Position - 0xD0A0
{
	return Global_1620C;
}

void func_200(int iParam0)//Position - 0xD0AC
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_201(iParam0);
...
void func_201(int iParam0)//Position - 0xD0C3
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_202(int iParam0)//Position - 0xD1AB
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_162();
...
int func_203(var uParam0, bool bParam1)//Position - 0xD1D3
{
	struct<27> Var0;
	...
	if ((func_240(*uParam0) || func_238(*uParam0)) || Global_1171A == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_207(&(uParam0->f_30)) && bParam1)
	{
		func_204(uParam0->f_1C[0], &(uParam0->f_30), *uParam0);
	}
	return 1;
}

void func_204(int iParam0, var uParam1, int iParam2)//Position - 0xD446
{
	int iVar0;
	int iVar1;
	...
	if (func_187(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				...
				{
					if (func_205(iParam2) && !PED::IS_PED_FACING_PED(iParam0, AUDIO::_0x0626A247D2405330(), 25f))
					{
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, AUDIO::_0x0626A247D2405330(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_206(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_205(iParam2) || PED::IS_PED_FACING_PED(iParam0, AUDIO::_0x0626A247D2405330(), 10f))
				{
					if (func_68(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						BRAIN::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, 4294967295, 262153, 0, 0, 0, 0);
...
int func_205(int iParam0)//Position - 0xD79E
{
...
int func_206(var uParam0)//Position - 0xD7BE
{
...
int func_207(var uParam0)//Position - 0xD7D6
{
...
void func_208(var uParam0)//Position - 0xD7FB
{
	int iVar0;
	int iVar1;
	...
	if (func_187(AUDIO::_0x0626A247D2405330()))
	{
		iVar0 = 0;
...
void func_209(int iParam0)//Position - 0xDAFF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_210(var uParam0)//Position - 0xDB2A
{
	int iVar0;
...
int func_211(var uParam0, bool bParam1, bool bParam2)//Position - 0xDBAA
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_212(AUDIO::_0x0626A247D2405330(), uParam0->f_23[iVar0]))
							{
...
int func_212(int iParam0, int iParam1)//Position - 0xDD68
{
	int iVar0;
...
int func_213(var uParam0, bool bParam1, int iParam2)//Position - 0xDD98
{
	int iVar0;
	int iVar1;
...
int func_214(int iParam0)//Position - 0xE054
{
...
int func_215(int iParam0, float fParam1)//Position - 0xE088
{
	float fVar0;
	
	if (func_187(AUDIO::_0x0626A247D2405330()) && func_187(iParam0))
	{
		if (func_226(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iParam0))
		{
...
bool func_216(int iParam0, float fParam1)//Position - 0xE0FE
{
	return func_217(iParam0, AUDIO::_0x0626A247D2405330(), fParam1, 1, 250, 7);
}

bool func_217(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE116
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_218(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE1D7
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_219(int iParam0, int iParam1)//Position - 0xE303
{
	int iVar0;
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE412
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_223(unk_0x8000C77B5F336760(iParam1, true) - unk_0x8000C77B5F336760(iParam0, true)) };
...
float func_222(vector3 vParam0, vector3 vParam1)//Position - 0xE4A3
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_223(vector3 vParam0)//Position - 0xE4C4
{
	float fVar0;
	float fVar1;
...
void func_224(var uParam0)//Position - 0xE503
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_225(int iParam0, int iParam1)//Position - 0xE51E
{
	int iVar0;
...
int func_226(int iParam0)//Position - 0xE55D
{
...
int func_227(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE585
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_228(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE680
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_229(int iParam0, float fParam1)//Position - 0xE78C
{
	var uVar0;
	vector3 vVar1;
...
int func_230(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xE821
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_223(vParam1 - unk_0x8000C77B5F336760(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_231(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE8AF
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
...
int func_232(int iParam0)//Position - 0xE8F7
{
...
void func_233(int iParam0)//Position - 0xE941
{
	int iVar0;
...
int func_234(int iParam0)//Position - 0xE9DE
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_162();
...
int func_235(int iParam0)//Position - 0xEA76
{
...
int func_238(int iParam0)//Position - 0xEAF8
{
	if ((func_239() && Global_16C30.f_B == 6) && iParam0 == func_163(&(Global_16C30.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_240(int iParam0)//Position - 0xEB6A
{
	if (func_107(0))
	{
...
int func_241(int iParam0)//Position - 0xEB92
{
	switch (*iParam0)
	{
		case 17:
...
int func_242(var uParam0)//Position - 0xEC07
{
	int iVar0[1];
	int iVar1;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_248(&(uParam0->f_30), "rcmextreme4", "idle_a", "idle_c");
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_247(&iVar0) || !func_246(&(uParam0->f_30)))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			func_243(&(uParam0->f_1C[0]), 1732.27f, 96.36f, 170.29f, -98.56f);
...
void func_243(int iParam0, vector3 vParam1, float fParam2)//Position - 0xED0B
{
...
void func_244(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0xED3D
{
	func_245(iParam0);
	*iParam0 = PED::CREATE_PED(iParam4, iParam1, vParam2, fParam3, 0, false);
}

void func_245(int iParam0)//Position - 0xED5E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_246(var uParam0)//Position - 0xED9F
{
	if (func_207(uParam0))
	{
...
int func_247(int iParam0)//Position - 0xEDC9
{
	int iVar0;
...
void func_248(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xEDFA
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_249(var uParam0)//Position - 0xEE36
{
	int iVar0[1];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_248(&(uParam0->f_30), "rcmextreme3", "idle_calm", "fidget_02");
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			{
				if (func_250(&(uParam0->f_1C[0]), 52, -63.8f, -809.5f, 321.8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
					PED::SET_PED_CONFIG_FLAG(uParam0->f_1C[0], 118, false);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_1C[0], 208, true);
					WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_1C[0], joaat("gadget_parachute"), 1, false, false);
...
int func_250(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xEFC9
{
...
int func_251(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xF025
{
	int iVar0;
...
int func_252(var uParam0, int iParam1)//Position - 0xF0B3
{
	int iVar0;
...
int func_253(var uParam0)//Position - 0xF0F9
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_248(&(uParam0->f_30), "rcmextreme2", "sitting_idle", "loop_punching");
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (func_250(&(uParam0->f_1C[0]), 52, -954.19f, -2760.05f, 14.64f, -31.79f, "EXTREME LAUNCHER RC", 1))
				{
					ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uParam0->f_1C[0], -954.2f, -2760.05f, 14.04f, 1, 0, 1);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_1C[0], 118, false);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_1C[0], 208, true);
					unk_0x346478B12F69D4E3(uParam0->f_1C[0], true);
					ENTITY::SET_ENTITY_COLLISION(uParam0->f_1C[0], false, 0);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[0], 8, 1, 0, 0);
					BRAIN::TASK_PLAY_ANIM(uParam0->f_1C[0], uParam0->f_30, uParam0->f_30.f_1, 8f, -8f, 4294967295, 33281, 0, 0, 0, 0);
					if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
					{
						BRAIN::TASK_LOOK_AT_ENTITY(uParam0->f_1C[0], AUDIO::_0x0626A247D2405330(), 4294967295, 48, 2);
					}
				}
				else
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				func_254(&(uParam0->f_23[0]), iVar0[0], -950.8f, -2751.98f, 13.21f, 199.05f);
			...
			{
				func_254(&(uParam0->f_23[1]), iVar0[0], -950.192f, -2755.96f, 13.3639f, -178.182f);
			...
			{
				func_254(&(uParam0->f_23[2]), iVar0[1], -957.23f, -2764.89f, 14.04f, 147.61f);
				...
				VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(uParam0->f_23[2], false, 0);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
...
void func_254(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF3FD
{
	func_255(iParam0);
...
void func_255(int iParam0)//Position - 0xF43F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_256(var uParam0)//Position - 0xF4DB
{
	int iVar0[1];
	int iVar1;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_248(&(uParam0->f_30), "rcm_extreme1", "idle_a", "idle_c");
			iLocal_51 = 1;
			break;
		...
		case 2:
			func_243(&(uParam0->f_1C[0]), -188.22f, 1296.1f, 302.86f, 43.7f);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iVar0[iVar1]);
...
int func_257(int iParam0)//Position - 0xF5C7
{
	struct<27> Var0;
	int iVar1;
...
int func_258(int iParam0)//Position - 0xF61B
{
	char* sVar0;
...
int func_259(int iParam0)//Position - 0xF6D4
{
	var uVar0;
...
int func_260(int iParam0)//Position - 0xF795
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_261(int iParam0, char* sParam1)//Position - 0xF81A
{
...
bool func_262(int iParam0)//Position - 0xF8FC
{
...
bool func_263(int iParam0)//Position - 0xF92A
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
bool func_264(int iParam0)//Position - 0xF958
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
int func_265(int iParam0)//Position - 0xF986
{
	if (func_235(iParam0))
	{
		return 0;
...
void func_266()//Position - 0xF9BB
{
	func_283("Running end routines.");
	Global_19D3C = (Global_19D3C - 1);
}

int func_267(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF9D5
{
	int iVar0;
...
int func_268(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xFA3A
{
	int iVar0;
	struct<7> Var1;
...
int func_269(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xFAB8
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_270(int iParam0, bool bParam1)//Position - 0xFB33
{
	if (*iParam0 == 18)
	{
		if (func_187(iParam0->f_23[0]))
		{
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(iParam0->f_23[0], 1);
		}
		if (func_187(iParam0->f_23[1]))
		{
	...
	if (*iParam0 == 17)
	{
		...
		BRAIN::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_SALTON_DIRT_BIKE", 1);
	}
	else if (*iParam0 == 18)
	{
		PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_57, 0);
...
int func_271(var uParam0)//Position - 0xFC14
{
	if (func_207(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_272(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFC4A
{
...
void func_273(var uParam0, bool bParam1)//Position - 0xFC6A
{
	func_274(&(uParam0->f_29), bParam1);
}

void func_274(var uParam0, bool bParam1)//Position - 0xFC7C
{
	int iVar0;
...
void func_275(int iParam0, bool bParam1)//Position - 0xFCBA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_276(var uParam0, bool bParam1)//Position - 0xFCF5
{
	func_277(&(uParam0->f_23), bParam1);
}

void func_277(var uParam0, bool bParam1)//Position - 0xFD07
{
	int iVar0;
...
void func_278(int iParam0)//Position - 0xFD44
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_279(var uParam0, int iParam1)//Position - 0xFD7C
{
	func_280(&(uParam0->f_1C), iParam1);
}

void func_280(var uParam0, int iParam1)//Position - 0xFD8E
{
	int iVar0;
...
void func_281(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFDCF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_282(var uParam0)//Position - 0xFE1F
{
	if (*uParam0 == 4294967295)
	{
		return;
...
void func_283(char* sParam0)//Position - 0xFE5C
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_284(var uParam0)//Position - 0xFE6E
{
	*uParam0 = 4294967295;
...
void func_285()//Position - 0xFEA1
{
	func_283("Running start routines.");
	Global_19D3C++;
}

int func_286(int iParam0)//Position - 0xFEBB
{
	if (!func_36(iParam0))
	{
		return Global_19E56.f_6D76[iParam0 /*29*/];
