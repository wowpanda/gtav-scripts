...
void __EntryFunction__()
{
	...
	{
		SYSTEM::WAIT(0);
		if (TASK::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_99)
		{
			if (!func_191())
			{
				if (func_190())
								...
								else
								{
									...
									if (func_163())
									{
										...
										while (iVar0 < iLocal_66)
										{
											...
											{
												BRAIN::TASK_COMBAT_PED(iLocal_66[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
										...
										if (iLocal_47 == 2)
										{
											...
											while (iVar0 < iLocal_67)
											{
												...
												{
													BRAIN::TASK_COWER(iLocal_67[iVar0], -1);
											...
											while (iVar0 < iLocal_68)
											{
												...
												{
													BRAIN::TASK_COWER(iLocal_68[iVar0], -1);
								...
								switch (iLocal_45)
								{
									...
									case 2:
										...
										if (MISC::IS_PROJECTILE_IN_AREA(vLocal_123 - Vector(20f, 20f, 20f), vLocal_123 + Vector(20f, 20f, 20f), 0))
										{
											...
											{
												BRAIN::TASK_SMART_FLEE_COORD(iLocal_67[1], vLocal_59, 150f, -1, 0, 0);
											...
											{
												BRAIN::TASK_SMART_FLEE_COORD(iLocal_67[2], vLocal_59, 150f, -1, 0, 0);
											...
											while (iVar2 <= (iLocal_65 - 1))
											{
												if (!PED::IS_PED_INJURED(iLocal_68[iVar2]))
												{
													...
													{
														BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1201.476f, -790.2733f, 15.5475f, 2f, -1, 0.25f, 0, 1193033728);
													}
													BRAIN::TASK_SMART_FLEE_COORD(0, vLocal_59, 150f, -1, 0, 0);
													BRAIN::CLOSE_SEQUENCE_TASK(iLocal_87);
										...
										if (iLocal_47 == 1)
										{
											...
											if (func_113() && !iLocal_97)
											{
												...
												if (!PED::IS_PED_INJURED(iLocal_115))
												{
													...
													BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_115, iLocal_106, PLAYER::PLAYER_PED_ID(), 8, 16f, 786469, -1f, -1f, 1);
											...
											if (iLocal_97 && !iLocal_143)
											{
												if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_106, 0) && !PED::IS_PED_INJURED(iLocal_115))
												{
													...
													{
														BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_115, iLocal_106, PLAYER::PLAYER_PED_ID(), 8, 19f, 786469, -1f, -1f, 1);
														iLocal_143 = 1;
													}
												}
											}
												...
												if (!PED::IS_PED_INJURED(iLocal_115))
												{
													if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_106, 0))
													{
														if (!iLocal_98)
														{
															...
															PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_115, 6, true);
															PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_115, 1, true);
															BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_115, iLocal_106, PLAYER::PLAYER_PED_ID(), 8, 17f, 786469, -1f, -1f, 1);
															iLocal_98 = 1;
														}
												...
												while (iVar3 <= (iLocal_63 - 1))
												{
													if (!iLocal_80[iVar3])
													{
														if (!PED::IS_PED_INJURED(iLocal_66[iVar3]))
														{
															...
															{
																BRAIN::TASK_DRIVE_BY(iLocal_66[iVar3], PLAYER::PLAYER_PED_ID(), 0, 0.3f, 0.7f, 1.9f, -1f, 15, 0, -753768974);
																iLocal_80[iVar3] = 1;
															}
															else if (!HUD::DOES_BLIP_EXIST(iLocal_121))
															{
																BRAIN::TASK_COMBAT_PED(iLocal_66[iVar3], PLAYER::PLAYER_PED_ID(), 0, 16);
									...
									case 10:
										...
										if (iLocal_47 == 1)
										{
											if (!iLocal_95)
											{
												...
												else if (!PED::IS_PED_INJURED(iLocal_67[0]))
												{
													...
													BRAIN::TASK_PLAY_ANIM(iLocal_67[0], "random@robbery", "stand_worried_female", 8f, -8f, -1, 9, 0, 0, 0, 0);
													if (!PED::IS_PED_INJURED(iLocal_67[1]))
													{
														BRAIN::TASK_SMART_FLEE_COORD(iLocal_67[1], vLocal_59, 150f, -1, 0, 0);
														PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_67[1], false);
											...
											if (!iLocal_95)
											{
												...
												else if (!PED::IS_PED_INJURED(iLocal_67[0]))
												{
													...
													while (iVar5 <= (iLocal_65 - 1))
													{
														...
														{
															BRAIN::TASK_SMART_FLEE_COORD(iLocal_68[iVar5], vLocal_59, 150f, -1, 0, 0);
										...
										if ((func_161() && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
										{
											SYSTEM::SETTIMERA(0);
											iLocal_45 = 11;
										}
										if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_241()) > (fLocal_124 + 150f))
										{
											iLocal_45 = 12;
										}
									...
									case 13:
										if (!iLocal_144)
										{
											if (!PED::IS_PED_INJURED(iLocal_67[0]))
											{
												BRAIN::CLEAR_PED_TASKS(iLocal_67[0]);
												if (iLocal_47 == 1)
												{
	...
	if (bLocal_112)
	{
		if (!iLocal_114)
		{
			...
			if (iLocal_47 == 1)
			{
				...
				fLocal_136 = 0.855f;
				fLocal_130 = "random@robbery";
				fLocal_131 = "return_bag_stand_b";
				fLocal_132 = "return_bag_stand_b_female";
				fLocal_133 = "return_bag_stand_b_bag";
			...
			else if (iLocal_47 == 2)
			{
				...
				fLocal_136 = 0.785f;
				fLocal_130 = "random@robbery";
				fLocal_131 = "return_bag_stand_c_rt";
				fLocal_132 = "return_bag_stand_c_rt_female";
				fLocal_133 = "return_bag_stand_c_rt_bag";
			...
			CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_129, iLocal_135, sLocal_134, fLocal_130);
			BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
			BRAIN::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_135, fLocal_130, fLocal_131, 1000f, -2f, 5, 0, 1148846080, 0);
			PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
			BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_67[0]);
			BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_67[0], iLocal_135, fLocal_130, fLocal_132, 1000f, -2f, 4, 0, 1148846080, 0);
			...
			ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_102, iLocal_135, fLocal_133, fLocal_130, 1000f, 8f, 0, 1148846080);
			if (!PED::IS_PED_INJURED(iLocal_67[0]))
			{
				func_52();
...
void func_16(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_105220.f_20535.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_18() /*12171*/].f_7688.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_105220.f_20535.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_18() /*12171*/].f_7688.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_21(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_18() /*12171*/].f_7688.f_10, iParam0);
}
...
void func_44()
{
	...
	{
		if (func_47(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_59()
{
	...
	{
		func_40(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
...
void func_64(void fParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
...
void func_81(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_82(iParam0) && SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_83888[26 /*34*/].f_6) == 0)
			{
				Global_105220.f_7232[iParam0] = 1;
				OBJECT::_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_105220.f_7232[iParam0], 1, 1);
			}
...
void func_100(void fParam0, int iParam1)
{
...
void func_102()
{
	if (OBJECT::HAS_PICKUP_BEEN_COLLECTED(iLocal_62))
	{
		...
		func_103(&uLocal_148);
		fLocal_124 = SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_241());
		SYSTEM::SETTIMERA(0);
		iLocal_45 = 10;
	}
		...
		if (iLocal_47 == 1)
		{
			...
			while (iVar0 <= (iLocal_63 - 1))
			{
				if (!PED::IS_PED_INJURED(iLocal_66[iVar0]))
				{
					...
					BRAIN::CLEAR_PED_TASKS(iLocal_66[iVar0]);
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_87);
					BRAIN::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
					BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_87);
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_66[iVar0]))
		{
			if (!PED::IS_PED_INJURED(iLocal_66[iVar0]))
			{
				if (PED::IS_PED_BEING_JACKED(iLocal_66[iVar0]))
				{
					...
					{
						ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_66[iVar0], true, 1);
						BRAIN::TASK_SMART_FLEE_PED(iLocal_66[iVar0], PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
						PED::SET_PED_KEEP_TASK(iLocal_66[iVar0], true);
						SYSTEM::WAIT(0);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_115))
	{
		if (!PED::IS_PED_INJURED(iLocal_115))
		{
			if (PED::IS_PED_BEING_JACKED(iLocal_115))
			{
				...
				{
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_115, true, 1);
					BRAIN::TASK_SMART_FLEE_PED(iLocal_115, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
					PED::SET_PED_KEEP_TASK(iLocal_115, true);
					SYSTEM::WAIT(0);
	...
	if (!PED::IS_PED_INJURED(iLocal_66[0]) && !PED::IS_PED_INJURED(iLocal_66[1]))
	{
		...
		else if (iLocal_47 == 2)
		{
			if (!iLocal_100)
			{
				...
				{
					BRAIN::TASK_SMART_FLEE_PED(iLocal_66[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
					iLocal_100 = 1;
				}
			}
			if (!iLocal_101)
			{
				...
				{
					BRAIN::TASK_SMART_FLEE_PED(iLocal_66[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
					iLocal_101 = 1;
				}
			}
		}
	...
	if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
	{
		if (!bLocal_79)
		{
			...
			while (iVar1 <= (iLocal_63 - 1))
			{
				...
				{
					BRAIN::TASK_COMBAT_PED(iLocal_66[iVar1], PLAYER::PLAYER_PED_ID(), 0, 16);
				}
				iVar1++;
			}
			bLocal_79 = true;
			...
			if (iLocal_47 == 1)
			{
				if (SYSTEM::TIMERA() > 14100)
				{
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_106, 0))
					{
						if (!PED::IS_PED_INJURED(iLocal_66[0]))
						{
							BRAIN::CLEAR_PED_TASKS(iLocal_66[0]);
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_87);
							BRAIN::TASK_CLEAR_LOOK_AT(0);
							BRAIN::TASK_ENTER_VEHICLE(0, iLocal_106, -1, 0, 2f, 1, 0);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_87);
						...
						if (!PED::IS_PED_INJURED(iLocal_66[1]))
						{
							...
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_87);
							BRAIN::TASK_CLEAR_LOOK_AT(0);
							BRAIN::TASK_ENTER_VEHICLE(0, iLocal_106, -1, 1, 2f, 1, 0);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_87);
...
void func_147()
{
	switch (iLocal_146)
	{
		case 0:
			func_133(1, 1, 1, 0, 0);
			MISC::CLEAR_AREA_OF_PEDS(func_148(PLAYER::PLAYER_ID()), 10f, 0);
	...
	if (!iLocal_75 && func_152(1, 0, 1))
	{
		...
		if (iLocal_47 == 1)
		{
			if (!iLocal_108)
			{
				...
				BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				BRAIN::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_135, "random@shop_robbery", "robbery_action_p", 8f, -8f, 1, 0, 1148846080, 0);
		...
		else if (iLocal_47 == 2)
		{
			...
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_67[0]);
				BRAIN::TASK_PLAY_ANIM(iLocal_67[0], "random@robbery", "robbery_main_female", 2f, -2f, -1, 0, 0, 0, 0, 0);
			}
			...
			BRAIN::CLOSE_SEQUENCE_TASK(iLocal_87);
			BRAIN::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iLocal_87);
			BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_87);
			PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
		}
		iLocal_75 = 1;
...
int func_155()
{
	switch (func_156(&Global_25336, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_163()
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_161())
	{
		return 1;
	}
	if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) && func_161())
	{
		return 1;
	}
	if (!PED::IS_PED_INJURED(iLocal_66[0]) && !PED::IS_PED_INJURED(iLocal_66[1]))
...
void func_167(int iParam0, void fParam1, void fParam2, int iParam3)
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, fParam1, fParam2, func_168(iParam3), 0);
}
...
void func_169()
{
	...
	if (func_43() == 0)
	{
		func_174(&uLocal_151, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	}
	else if (func_43() == 1)
	{
		func_174(&uLocal_151, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	else if (func_43() == 2)
	{
		func_174(&uLocal_151, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	}
	...
	if (iLocal_47 == 1)
	{
		...
		BRAIN::TASK_COWER(iLocal_67[1], -1);
		...
		BRAIN::TASK_COWER(iLocal_67[2], -1);
		...
		BRAIN::TASK_AIM_GUN_AT_ENTITY(iLocal_66[0], iLocal_67[0], -1, 0);
	...
	else if (iLocal_47 == 2)
	{
		...
		BRAIN::TASK_PLAY_ANIM(iLocal_67[0], "random@shop_robbery", "robbery_intro_loop_f", 4f, -4f, -1, 9, 0, 0, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_67[0], true);
		BRAIN::TASK_PLAY_ANIM(iLocal_67[1], "random@robbery", "f_cower_02", 4f, -4f, -1, 9, 0, 0, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_67[1], true);
		BRAIN::TASK_COWER(iLocal_68[0], -1);
		PED::SET_PED_KEEP_TASK(iLocal_68[0], true);
		BRAIN::TASK_PLAY_ANIM(iLocal_68[1], "random@robbery", "f_cower_01", 4f, -4f, -1, 9, 0, 0, 0, 0);
		PED::SET_PED_KEEP_TASK(iLocal_68[1], true);
		...
		BRAIN::TASK_PLAY_ANIM(iLocal_66[1], "random@shop_robbery", "robbery_intro_loop_a", 16f, -4f, -1, 9, 0, 0, 0, 0);
		func_173(14, 1);
		func_172(14);
		SYSTEM::WAIT(500);
		func_170(14, 0, 0);
...
int func_191()
{
	if ((Global_105209 == func_70() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_105210)
	{
		return 1;
	}
	return 0;
...
int func_195(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_219(Global_105220.f_24966.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_217()) || Global_104267) || Global_25279) || func_216()) || func_124(8, -1)) || func_215()) || func_214()) || func_213()) || func_212()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_217()) || Global_25279) || func_216()) || func_124(8, -1)) || func_213()) || func_215()) || func_214()) || func_212()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_217()) || Global_104267) || Global_25279) || func_216()) || func_124(8, -1)) || func_213()) || func_215()) || func_214()) || func_212()) || Global_105220.f_7659.f_919[iVar0] == 5) || Global_36452 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_217()) || Global_104267) || Global_25279) || func_216()) || func_124(8, -1)) || func_215()) || func_214()) || func_212()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_217() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_124(8, -1)) || func_212()) || func_211()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_217()) || Global_25279) || func_216()) || func_124(8, -1)) || func_214()) || func_213()) || func_212()) || Global_105220.f_7659.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_217()) || func_214()) || Global_104267) || Global_25279) || func_216()) || Global_37057) || func_124(8, -1)) || func_213()) || func_211()) || func_212()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_217()) || Global_104267) || Global_25279) || func_216()) || func_124(8, -1)) || func_213()) || func_211()) || func_215()) || func_214()) || func_212())
						{
							return 0;
						}
						break;
	...
	if (iLocal_142)
	{
		...
		while (iVar0 <= (iLocal_63 - 1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_66[iVar0]))
			{
				...
				{
					BRAIN::TASK_SMART_FLEE_COORD(iLocal_66[iVar0], vLocal_59, 150f, -1, 0, 0);
					PED::SET_PED_KEEP_TASK(iLocal_66[iVar0], true);
				}
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_66[iVar0]));
			}
		...
		while (iVar0 <= (iLocal_65 - 1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_68[iVar0]))
			{
				if (!PED::IS_PED_INJURED(iLocal_68[iVar0]))
				{
					...
					{
						BRAIN::CLEAR_PED_TASKS(iLocal_68[iVar0]);
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1201.476f, -790.2733f, 15.5475f, 2f, -1, 0.25f, 0, 1193033728);
					}
					BRAIN::TASK_SMART_FLEE_COORD(0, vLocal_59, 150f, -1, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_87);
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_67[iVar0]))
			{
				if (!PED::IS_PED_INJURED(iLocal_67[iVar0]))
				{
					...
					if (iVar0 == 0)
					{
						if (!iLocal_114)
						{
							BRAIN::CLEAR_PED_TASKS(iLocal_67[iVar0]);
							BRAIN::TASK_SMART_FLEE_COORD(iLocal_67[iVar0], vLocal_59, 150f, -1, 0, 0);
						}
						else
						{
