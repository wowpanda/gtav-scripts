					...
					case 1:
						switch (iLocal_46)
						{
							case 0:
								...
								{
									func_176();
									if (IS_INTERIOR_READY(uLocal_153))
									{
										func_170();
										iLocal_137 = 1;
									}
								...
								else
								{
									...
									if (func_164())
									{
										...
										{
											if (!IS_PED_INJURED(iLocal_114[iVar0]))
											{
												TASK_COMBAT_PED(iLocal_114[iVar0], PLAYER_PED_ID(), 0, 16);
												SET_PED_KEEP_TASK(iLocal_114[iVar0], 1);
										...
										if (iLocal_49 == 2)
										{
											...
											{
												if (!IS_PED_INJURED(iLocal_117[iVar0]))
												{
													TASK_COWER(iLocal_117[iVar0], -1);
													SET_PED_KEEP_TASK(iLocal_117[iVar0], 1);
												}
												iVar0++;
											}
											iVar0 = 0;
											...
											{
												if (!IS_PED_INJURED(iLocal_121[iVar0]))
												{
													TASK_COWER(iLocal_121[iVar0], -1);
													SET_PED_KEEP_TASK(iLocal_121[iVar0], 1);
												}
												iVar0++;
											}
										}
										DELETE_OBJECT(&uLocal_167);
										bLocal_140 = true;
										iLocal_46 = 1;
										iLocal_47 = 3;
									}
							...
							case 1:
								...
								{
									if (DOES_ENTITY_EXIST(iLocal_117[iVar1]))
									{
										if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_117[iVar1], PLAYER_PED_ID(), 1))
										{
											func_154();
										}
									}
								...
								while (iVar1 < iLocal_121)
								{
									...
									{
										if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_121[iVar1], PLAYER_PED_ID(), 1))
										{
											func_154();
										}
									}
								...
								switch (iLocal_47)
								{
									...
									case 2:
										...
										if (TIMERB() > 500)
										{
											if (DOES_ENTITY_EXIST(uLocal_167))
											{
												if (!IS_ENTITY_ATTACHED(uLocal_167))
												{
													func_143();
													SET_CURRENT_PED_WEAPON(iLocal_114[0], joaat("weapon_unarmed"), 1);
													ATTACH_ENTITY_TO_ENTITY(uLocal_167, iLocal_114[0], GET_PED_BONE_INDEX(iLocal_114[0], 57005), 0.3f, 0f, 0f, 80f, -90f, 0f, 1, 1, 0, 0, 2, 1);
												}
											}
										}
										if (IS_PROJECTILE_IN_AREA(vLocal_194 - Vector(20f, 20f, 20f), vLocal_194 + Vector(20f, 20f, 20f), 0))
										{
											if (!IS_PED_INJURED(iLocal_117[1]))
											{
												TASK_SMART_FLEE_COORD(iLocal_117[1], vLocal_103, 150f, -1, 0, 0);
												SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_117[1], 0);
												SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_117[1]));
											}
											if (!IS_PED_INJURED(iLocal_117[2]))
											{
												TASK_SMART_FLEE_COORD(iLocal_117[2], vLocal_103, 150f, -1, 0, 0);
												SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_117[2], 0);
												SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_117[2]));
											}
											iVar2 = 0;
											while (iVar2 <= (iLocal_113 - 1))
											{
												if (!IS_PED_INJURED(iLocal_121[iVar2]))
												{
													SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_121[iVar2], 1, 1);
													OPEN_SEQUENCE_TASK(&uLocal_152);
													if (iLocal_49 == 1)
													{
														TASK_PLAY_ANIM(0, "random@robbery", "exit_flee", 4f, -4f, -1, 5632, 0f, 0, 1, 0);
													}
													else if (iLocal_49 == 2)
													{
														TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1201.476f, -790.2733f, 15.5475f, 2f, -1, 1048576000, 0, 1193033728);
													}
													TASK_SMART_FLEE_COORD(0, vLocal_103, 150f, -1, 0, 0);
													CLOSE_SEQUENCE_TASK(uLocal_152);
													TASK_PERFORM_SEQUENCE(iLocal_121[iVar2], uLocal_152);
													CLEAR_SEQUENCE_TASK(&uLocal_152);
													SET_PED_KEEP_TASK(iLocal_121[iVar2], 1);
													SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_121[iVar2], 0);
													SET_PED_CAN_BE_TARGETTED(iLocal_121[iVar2], 1);
										...
										if (func_142() || TIMERA() > 20000)
										{
											if (!iLocal_164)
											{
												if (!IS_ENTITY_DEAD(iLocal_114[0], 0))
												{
													...
													TASK_PLAY_ANIM(PLAYER_PED_ID(), "random@shop_robbery", "kneel_getup_p", 2f, -2f, 2700, 0, 0, 0, 0, 0);
													if (iLocal_49 == 1)
													{
														if (DOES_ENTITY_EXIST(uLocal_167))
														{
															SET_ENTITY_VISIBLE(uLocal_167, 0, 0);
															SET_ENTITY_COLLISION(uLocal_167, 0, 0);
														}
													}
													else if (iLocal_49 == 2)
													{
													...
													while (iVar1 < iLocal_117)
													{
														if (!IS_PED_INJURED(iLocal_117[iVar1]))
														{
															SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_117[iVar1], 0);
														}
														iVar1++;
													}
													iVar1 = 0;
													while (iVar1 < iLocal_121)
													{
														if (!IS_PED_INJURED(iLocal_121[iVar1]))
														{
															SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_121[iVar1], 0);
														}
														iVar1++;
													}
													if (!IS_PED_INJURED(iLocal_117[0]))
													{
														SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_117[0], 1);
														OPEN_SEQUENCE_TASK(&uLocal_152);
														TASK_PLAY_ANIM(0, "random@robbery", "f_distressed_loop", 2f, -2f, -1, 9, 0, 0, 0, 0);
														CLOSE_SEQUENCE_TASK(uLocal_152);
														TASK_PERFORM_SEQUENCE(iLocal_117[0], uLocal_152);
														CLEAR_SEQUENCE_TASK(&uLocal_152);
														SET_PED_KEEP_TASK(iLocal_117[0], 1);
													}
													if (!func_127())
													{
										...
										if (iLocal_49 == 1)
										{
											...
											if (!IS_PED_INJURED(iLocal_114[0]) && IS_VEHICLE_DRIVEABLE(uLocal_175, 0))
											{
												if (IS_PED_IN_VEHICLE(iLocal_114[0], uLocal_175, 0))
												{
													if (DOES_ENTITY_EXIST(uLocal_167))
													{
														DELETE_OBJECT(&uLocal_167);
											...
											if (func_113() && !iLocal_162)
											{
												...
												if (!DOES_BLIP_EXIST(uLocal_191))
												{
													uLocal_191 = func_111(uLocal_175, 1, 0);
												}
												bLocal_161 = true;
												if (!IS_PED_INJURED(uLocal_184))
												{
													SET_PED_COMBAT_ATTRIBUTES(uLocal_184, 17, 1);
													SET_PED_COMBAT_ATTRIBUTES(uLocal_184, 6, 1);
													SET_PED_COMBAT_ATTRIBUTES(uLocal_184, 1, 1);
													TASK_VEHICLE_MISSION_PED_TARGET(uLocal_184, uLocal_175, PLAYER_PED_ID(), 8, 16f, 786469, -1f, -1f, 1);
													SET_PED_KEEP_TASK(uLocal_184, 1);
													iLocal_162 = 1;
												}
											}
											if (iLocal_162 && !iLocal_224)
											{
												if (IS_VEHICLE_DRIVEABLE(uLocal_175, 0) && !IS_PED_INJURED(uLocal_184))
												{
													if (!IS_ENTITY_AT_COORD(uLocal_175, vLocal_55[0 /*3*/], 20f, 20f, 10f, 0, 1, 0))
													{
														TASK_VEHICLE_MISSION_PED_TARGET(uLocal_184, uLocal_175, PLAYER_PED_ID(), 8, 19f, 786469, -1f, -1f, 1);
														iLocal_224 = 1;
													}
												}
											}
											if (func_110())
											{
												if (!IS_PED_INJURED(uLocal_184))
												{
													if (IS_VEHICLE_DRIVEABLE(uLocal_175, 0))
													{
														if (!iLocal_163)
														{
															SET_PED_COMBAT_ATTRIBUTES(uLocal_184, 17, 1);
															SET_PED_COMBAT_ATTRIBUTES(uLocal_184, 6, 1);
															SET_PED_COMBAT_ATTRIBUTES(uLocal_184, 1, 1);
															TASK_VEHICLE_MISSION_PED_TARGET(uLocal_184, uLocal_175, PLAYER_PED_ID(), 8, 17f, 786469, -1f, -1f, 1);
															iLocal_163 = 1;
														}
														if (!IS_PED_INJURED(iLocal_114[0]))
														{
															if (IS_PED_IN_VEHICLE(iLocal_114[0], uLocal_175, 0))
															{
																if (DOES_BLIP_EXIST(uLocal_185[0]))
												...
												while (iVar3 <= (iLocal_111 - 1))
												{
													if (!iLocal_141[iVar3])
													{
														if (!IS_PED_INJURED(iLocal_114[iVar3]))
														{
															if (IS_PED_IN_ANY_VEHICLE(iLocal_114[iVar3], 0) && !IS_PED_INJURED(uLocal_184))
															{
																TASK_DRIVE_BY(iLocal_114[iVar3], PLAYER_PED_ID(), 0, 0.3f, 0.7f, 1.9f, -1f, 15, 0, -753768974);
																iLocal_141[iVar3] = 1;
															}
															else if (!DOES_BLIP_EXIST(uLocal_192))
															{
																TASK_COMBAT_PED(iLocal_114[iVar3], PLAYER_PED_ID(), 0, 16);
																SET_PED_KEEP_TASK(iLocal_114[iVar3], 1);
																if (DOES_BLIP_EXIST(uLocal_191))
																{
																	REMOVE_BLIP(&uLocal_191);
																}
													...
													if (!iLocal_144[iVar3])
													{
														if (IS_VEHICLE_DRIVEABLE(uLocal_175, 0))
														{
															if (!IS_PED_INJURED(iLocal_114[iVar3]))
															{
																if ((IS_PED_INJURED(uLocal_184) || IS_VEHICLE_SEAT_FREE(uLocal_175, -1, 0)) || IS_ENTITY_ON_FIRE(iLocal_114[iVar3]))
																{
																	SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_114[iVar3], 1, 1);
																	OPEN_SEQUENCE_TASK(&uLocal_152);
																	TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
																	TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 300f, -1, 0, 0);
																	CLOSE_SEQUENCE_TASK(uLocal_152);
																	TASK_PERFORM_SEQUENCE(iLocal_114[iVar3], uLocal_152);
																	CLEAR_SEQUENCE_TASK(&uLocal_152);
																	SET_PED_KEEP_TASK(iLocal_114[iVar3], 1);
																	if (!IS_PED_INJURED(uLocal_184))
																	{
																		SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_184, 1, 1);
																		OPEN_SEQUENCE_TASK(&uLocal_152);
																		TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
																		TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 300f, -1, 0, 0);
																		CLOSE_SEQUENCE_TASK(uLocal_152);
																		TASK_PERFORM_SEQUENCE(uLocal_184, uLocal_152);
																		CLEAR_SEQUENCE_TASK(&uLocal_152);
																		SET_PED_KEEP_TASK(uLocal_184, 1);
																	}
																	if (!DOES_BLIP_EXIST(uLocal_192))
																	{
																		if (DOES_BLIP_EXIST(uLocal_191))
																		{
																			REMOVE_BLIP(&uLocal_191);
										...
										else if (iLocal_49 == 2)
										{
											...
											if (IS_PED_INJURED(iLocal_114[1]))
											{
												if (DOES_BLIP_EXIST(uLocal_185[1]))
												{
											...
											else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_114[0], PLAYER_PED_ID(), 1))
											{
												if (DOES_ENTITY_EXIST(uLocal_167))
												{
													if (IS_ENTITY_ATTACHED(uLocal_167))
									...
									case 10:
										...
										if (iLocal_49 == 1)
										{
											if (!iLocal_160)
											{
												...
												else if (!IS_PED_INJURED(iLocal_117[0]))
												{
													SET_ENTITY_COORDS(iLocal_117[0], -818.5553f, -185.4815f, 36.5689f, 1, 0, 0, 1);
													SET_ENTITY_HEADING(iLocal_117[0], 47.0582f);
													TASK_PLAY_ANIM(iLocal_117[0], "random@robbery", "stand_worried_female", 8f, -8f, -1, 9, 0, 0, 0, 0);
													if (!IS_PED_INJURED(iLocal_117[1]))
													{
														TASK_SMART_FLEE_COORD(iLocal_117[1], vLocal_103, 150f, -1, 0, 0);
														SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_117[1], 0);
													...
													{
														if (!IS_PED_INJURED(iLocal_121[iVar4]))
														{
															OPEN_SEQUENCE_TASK(&uLocal_152);
															TASK_PLAY_ANIM(0, "random@robbery", "exit_flee", 4f, -4f, -1, 5632, 0f, 0, 1, 0);
															TASK_SMART_FLEE_COORD(0, vLocal_103, 150f, -1, 0, 0);
															CLOSE_SEQUENCE_TASK(uLocal_152);
															TASK_PERFORM_SEQUENCE(iLocal_121[iVar4], uLocal_152);
															CLEAR_SEQUENCE_TASK(&uLocal_152);
															SET_PED_KEEP_TASK(iLocal_121[iVar4], 1);
															SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_121[iVar4], 0);
															SET_PED_CAN_BE_TARGETTED(iLocal_121[iVar4], 1);
										...
										else if (iLocal_49 == 2)
										{
											if (!iLocal_160)
											{
												...
												{
													SET_ENTITY_COORDS(iLocal_117[0], -1197.455f, -776.0289f, 16.3254f, 1, 0, 0, 1);
													...
													{
														if (!IS_PED_INJURED(iLocal_121[iVar5]))
														{
															TASK_SMART_FLEE_COORD(iLocal_121[iVar5], vLocal_103, 150f, -1, 0, 0);
															SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_121[iVar5], 0);
															SET_PED_CAN_BE_TARGETTED(iLocal_121[iVar5], 1);
											...
											{
												SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("v_ilev_clothmiddoor"), -1201.43f, -776.86f, 17.99f, 0, 0f, 0);
											}
										}
										if (func_166())
										{
										}
										if ((func_162() && !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0)) && !IS_PED_RAGDOLL(PLAYER_PED_ID()))
										{
											SETTIMERA(0);
											iLocal_47 = 11;
										}
										if (VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), func_242()) > (fLocal_197 + 150f))
										{
											iLocal_47 = 12;
										}
										if (TIMERA() > 120000)
										...
										else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_117[0], PLAYER_PED_ID(), 1))
										{
											func_73(2);
											func_53();
										}
									...
									case 13:
										if (!iLocal_225)
										{
											if (!IS_PED_INJURED(iLocal_117[0]))
											{
												...
												SET_PED_KEEP_TASK(iLocal_117[0], 1);
												SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_117[0], 0);
												iLocal_225 = 1;
											}
										}
										if (!func_127())
...
void func_1()
{
	if (func_162())
	{
		...
		if (!iLocal_182)
		{
			if (!IS_PED_INJURED(iLocal_117[0]))
			{
				...
				CLEAR_HELP(1);
				CLEAR_AREA_OF_PROJECTILES(GET_ENTITY_COORDS(iLocal_117[0], 1), 20f, 0);
				DISPLAY_HUD(0);
				DISPLAY_RADAR(0);
				if (iLocal_49 == 1)
				{
	...
	if (bLocal_181)
	{
		if (!iLocal_183)
		{
			...
			vLocal_198 = { GET_ENTITY_COORDS(iLocal_117[0], 0) };
			if (iLocal_49 == 1)
			{
			...
			uLocal_216 = CREATE_SYNCHRONIZED_SCENE(vLocal_198, vLocal_204, 2);
			uLocal_210 = CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
			PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_210, uLocal_216, sLocal_215, sLocal_211);
			CLEAR_PED_TASKS_IMMEDIATELY(PLAYER_PED_ID());
			TASK_SYNCHRONIZED_SCENE(PLAYER_PED_ID(), uLocal_216, sLocal_211, sLocal_212, 1000f, -2f, 5, 0, 1148846080, 0);
			_0x2208438012482A1A(PLAYER_PED_ID(), 0, 0);
			CLEAR_PED_TASKS_IMMEDIATELY(iLocal_117[0]);
			TASK_SYNCHRONIZED_SCENE(iLocal_117[0], uLocal_216, sLocal_211, sLocal_213, 1000f, -2f, 4, 0, 1148846080, 0);
			_0x2208438012482A1A(iLocal_117[0], 0, 0);
			uLocal_167 = CREATE_OBJECT(joaat("prop_cs_duffel_01"), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 1, 1, 0);
			PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_167, uLocal_216, sLocal_214, sLocal_211, 1000f, 1090519040, 0, 1148846080);
			if (!IS_PED_INJURED(iLocal_117[0]))
			{
				func_52();
				SET_CAM_ACTIVE(uLocal_210, 1);
	...
	if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_216) > fLocal_217 && iLocal_183)
	{
		if (!IS_PED_INJURED(iLocal_117[0]))
		{
			...
			CLEAR_PED_TASKS(iLocal_117[0]);
			OPEN_SEQUENCE_TASK(&uLocal_152);
			TASK_PLAY_ANIM(0, "random@robbery", "stand_worried_female", 2f, -2f, -1, 1, 0, 0, 0, 0);
			CLOSE_SEQUENCE_TASK(uLocal_152);
			TASK_PERFORM_SEQUENCE(iLocal_117[0], uLocal_152);
			CLEAR_SEQUENCE_TASK(&uLocal_152);
			SET_PED_KEEP_TASK(iLocal_117[0], 1);
...
int func_11(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_9() == 0)
		{
			return IS_BIT_SET(func_7(func_8(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_16(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_18() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_18() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_17(iParam0));
...
int func_21(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_18() /*10778*/].f_6165.f_10, iParam0);
}
...
void func_49()
{
	if (iLocal_49 == 1)
	{
		if (DOES_ENTITY_EXIST(iLocal_117[0]))
		{
			if (!IS_PED_INJURED(iLocal_117[0]))
			{
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_117[0], 0);
		...
		if (DOES_ENTITY_EXIST(iLocal_117[1]))
		{
			if (!IS_PED_INJURED(iLocal_117[1]))
			{
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_117[1], 0);
		...
		if (DOES_ENTITY_EXIST(iLocal_121[0]))
		{
			if (!IS_PED_INJURED(iLocal_121[0]))
			{
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_121[0], 0);
				SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_121[0]));
			}
		}
		if (DOES_ENTITY_EXIST(iLocal_121[1]))
		{
			if (!IS_PED_INJURED(iLocal_121[1]))
			{
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_121[1], 0);
				SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_121[1]));
			}
		}
		if (DOES_ENTITY_EXIST(iLocal_121[2]))
		{
			if (!IS_PED_INJURED(iLocal_121[2]))
			{
				SET_ENTITY_COORDS(iLocal_121[2], -820.424f, -181.9059f, 36.5687f, 1, 0, 0, 1);
				SET_ENTITY_HEADING(iLocal_121[2], 167.7909f);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_121[2], 0);
...
void func_52()
{
	if (iLocal_49 == 1)
	{
		...
		{
			if (IS_ENTITY_AT_COORD(GET_PLAYERS_LAST_VEHICLE(), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 8f, 8f, 8f, 0, 1, 0) || IS_ENTITY_AT_COORD(GET_PLAYERS_LAST_VEHICLE(), -823.1281f, -187.9591f, 36.6189f, 8f, 8f, 8f, 0, 1, 0))
			{
				SET_ENTITY_COORDS(GET_PLAYERS_LAST_VEHICLE(), -831.9709f, -192.0823f, 36.5008f, 0, 0, 0, 1);
				SET_VEHICLE_ON_GROUND_PROPERLY(GET_PLAYERS_LAST_VEHICLE(), 1084227584);
			}
		}
		CLEAR_AREA(-823.1281f, -187.9591f, 36.6189f, 3f, 1, 0, 0, 0);
	}
	else if (iLocal_49 == 2)
	{
		if (IS_VEHICLE_DRIVEABLE(GET_PLAYERS_LAST_VEHICLE(), 0))
		{
			if (IS_ENTITY_AT_COORD(GET_PLAYERS_LAST_VEHICLE(), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 8f, 8f, 8f, 0, 1, 0) || IS_ENTITY_AT_COORD(GET_PLAYERS_LAST_VEHICLE(), -1201.017f, -777.5527f, 16.3398f, 8f, 8f, 8f, 0, 1, 0))
			{
				SET_ENTITY_COORDS(GET_PLAYERS_LAST_VEHICLE(), -1205.936f, -781.2014f, 16.0088f, 0, 0, 0, 1);
				SET_VEHICLE_ON_GROUND_PROPERLY(GET_PLAYERS_LAST_VEHICLE(), 1084227584);
			}
		}
		CLEAR_AREA(-1201.017f, -777.5527f, 16.3398f, 8f, 1, 0, 0, 0);
	}
}
...
void func_59()
{
	...
	{
		func_40(13, FLOOR(Global_106565.f_10188.f_3853));
	}
...
int func_79(int iParam0)
{
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = GET_ENTITY_MODEL(func_80(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 1)));
				switch (iVar0)
				{
...
void func_81(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_82(iParam0) && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_84500[26 /*34*/].f_6) == 0)
			{
				Global_106565.f_7255[iParam0] = 1;
				_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_106565.f_7255[iParam0], 1, 1);
			}
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_90(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_102()
{
	if (HAS_PICKUP_BEEN_COLLECTED(uLocal_110))
	{
		...
		func_103(&uLocal_229);
		fLocal_197 = VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), func_242());
		SETTIMERA(0);
		iLocal_47 = 10;
	}
	if (DOES_PICKUP_EXIST(uLocal_110))
	{
		if (VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_PICKUP_COORDS(uLocal_110)) > 200f)
		{
			func_154();
		}
	}
...
void func_105()
{
	...
	if (!DOES_PICKUP_EXIST(uLocal_110))
	{
		SET_BIT(&uLocal_106, 3);
		SET_BIT(&uLocal_106, 4);
		SET_BIT(&uLocal_106, 1);
		if (!bLocal_161)
		{
			if (IS_ENTITY_DEAD(iLocal_114[0], 0))
			{
				if (DOES_ENTITY_EXIST(iLocal_114[0]))
				{
			...
			{
				vLocal_107 = { GET_SAFE_PICKUP_COORDS(GET_ENTITY_COORDS(iLocal_114[0], 1), 1067030938, 1069547520) };
			}
		}
		else if (DOES_ENTITY_EXIST(uLocal_175))
		{
			vLocal_107 = { GET_SAFE_PICKUP_COORDS(GET_ENTITY_COORDS(uLocal_175, 0), 1067030938, 1069547520) };
		}
		vLocal_107 = { vLocal_107.x, vLocal_107.y, (vLocal_107.z + 0.25f) };
		uLocal_110 = CREATE_PICKUP(joaat("pickup_money_med_bag"), vLocal_107, uLocal_106, iLocal_189, 1, joaat("prop_cs_duffel_01"));
		...
		if (iLocal_49 == 1)
		{
			...
			while (iVar0 <= (iLocal_111 - 1))
			{
				if (!IS_PED_INJURED(iLocal_114[iVar0]))
				{
					SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_114[iVar0], 1, 1);
					CLEAR_PED_TASKS(iLocal_114[iVar0]);
					OPEN_SEQUENCE_TASK(&uLocal_152);
					TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
					TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 300f, -1, 0, 0);
					CLOSE_SEQUENCE_TASK(uLocal_152);
					TASK_PERFORM_SEQUENCE(iLocal_114[iVar0], uLocal_152);
					CLEAR_SEQUENCE_TASK(&uLocal_152);
					SET_PED_KEEP_TASK(iLocal_114[iVar0], 1);
				}
				iVar0++;
...
int func_106(var uParam0)
{
	...
	SET_BLIP_SCALE(uVar0, func_107(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
	return uVar0;
}
...
int func_109()
{
	...
	else if (IS_PED_INJURED(iLocal_114[0]))
	{
		iLocal_149 = 1;
	}
	if (!bLocal_161)
	{
		if (!DOES_ENTITY_EXIST(iLocal_114[1]))
		{
			iLocal_150 = 1;
		}
		else if (IS_PED_INJURED(iLocal_114[1]))
		{
			iLocal_150 = 1;
		}
	}
	...
	if (!DOES_ENTITY_EXIST(uLocal_184))
	{
		iLocal_151 = 1;
	}
	else if (IS_PED_INJURED(uLocal_184) || !IS_PED_IN_ANY_VEHICLE(uLocal_184, 0))
	{
		iLocal_151 = 1;
	}
...
int func_110()
{
	...
	while (iVar0 <= (iLocal_111 - 1))
	{
		if (DOES_ENTITY_EXIST(iLocal_114[iVar0]))
		{
			if (!IS_PED_INJURED(iLocal_114[iVar0]) || IS_ENTITY_DEAD(iLocal_114[iVar0], 0))
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_114[iVar0], PLAYER_PED_ID(), 1))
				{
					return 1;
				}
			}
	...
	while (iVar0 <= (iLocal_111 - 1))
	{
		if (DOES_ENTITY_EXIST(iLocal_114[iVar0]))
		{
			if (!IS_PED_INJURED(iLocal_114[iVar0]))
			{
				...
				{
					if (GET_PEDS_JACKER(iLocal_114[iVar0]) == PLAYER_PED_ID())
					{
						SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_114[iVar0], 1, 1);
						TASK_SMART_FLEE_PED(iLocal_114[iVar0], PLAYER_PED_ID(), 250f, -1, 0, 0);
						SET_PED_KEEP_TASK(iLocal_114[iVar0], 1);
						WAIT(0);
	...
	if (DOES_ENTITY_EXIST(uLocal_184))
	{
		if (!IS_PED_INJURED(uLocal_184) || IS_ENTITY_DEAD(uLocal_184, 0))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_184, PLAYER_PED_ID(), 1))
			{
				return 1;
			}
		}
	...
	if (DOES_ENTITY_EXIST(uLocal_184))
	{
		if (!IS_PED_INJURED(uLocal_184))
		{
			if (IS_PED_BEING_JACKED(uLocal_184))
			{
				if (GET_PEDS_JACKER(uLocal_184) == PLAYER_PED_ID())
				{
					SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_184, 1, 1);
					TASK_SMART_FLEE_PED(uLocal_184, PLAYER_PED_ID(), 250f, -1, 0, 0);
					SET_PED_KEEP_TASK(uLocal_184, 1);
					WAIT(0);
					SET_PED_AS_NO_LONGER_NEEDED(&uLocal_184);
					return 1;
				}
			}
		}
	}
	if (DOES_ENTITY_EXIST(uLocal_175))
	{
		if (!IS_ENTITY_DEAD(uLocal_175, 0) || IS_ENTITY_DEAD(uLocal_175, 0))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_175, PLAYER_PED_ID(), 1))
			{
				return 1;
			}
		}
...
int func_112(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_107(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	if (IS_VEHICLE_DRIVEABLE(uLocal_175, 0))
	{
		if (!IS_PED_INJURED(iLocal_114[0]))
		{
			if (IS_PED_IN_VEHICLE(iLocal_114[0], uLocal_175, 0))
			{
				if (!IS_PED_INJURED(iLocal_114[1]))
				{
					if (IS_PED_IN_VEHICLE(iLocal_114[1], uLocal_175, 0))
					{
						return 1;
					}
				}
...
void func_134(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_138(PLAYER_ID())) && !func_136(PLAYER_ID(), 0)) && !func_135()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_138(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
...
int func_142()
{
	if (!IS_PED_INJURED(iLocal_114[0]) && !IS_PED_INJURED(iLocal_114[1]))
	{
		if (iLocal_49 == 1)
		{
			if (!iLocal_165)
			{
				if (!IS_ENTITY_IN_ANGLED_AREA(iLocal_114[0], -823.5066f, -187.3465f, 40.36355f, -803.6377f, -175.9496f, 36.4337f, 11.9375f, 0, 1, 0))
				{
					iLocal_165 = 1;
				}
			}
			if (!iLocal_166)
			{
				if (!IS_ENTITY_IN_ANGLED_AREA(iLocal_114[1], -823.5066f, -187.3465f, 40.36355f, -803.6377f, -175.9496f, 36.4337f, 11.9375f, 0, 1, 0))
				{
					iLocal_166 = 1;
				}
			}
		...
		else if (iLocal_49 == 2)
		{
			if (!iLocal_165)
			{
				if ((!IS_ENTITY_IN_ANGLED_AREA(iLocal_114[0], -1204.031f, -779.629f, 16.33565f, -1174.799f, -757.0704f, 21.01281f, 12.125f, 0, 1, 0) || IS_ENTITY_IN_ANGLED_AREA(iLocal_114[0], -1206.545f, -777.8941f, 21.20355f, -1204.313f, -778.2245f, 16.08434f, 2.25f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(iLocal_114[0], -1202.928f, -782.6883f, 21.20369f, -1202.583f, -780.5067f, 16.08243f, 2.25f, 0, 1, 0))
				{
					TASK_SMART_FLEE_PED(iLocal_114[0], PLAYER_PED_ID(), 1000f, -1, 0, 0);
					iLocal_165 = 1;
				}
			}
			if (!iLocal_166)
			{
				if ((!IS_ENTITY_IN_ANGLED_AREA(iLocal_114[1], -1204.031f, -779.629f, 16.33565f, -1174.799f, -757.0704f, 21.01281f, 12.125f, 0, 1, 0) || IS_ENTITY_IN_ANGLED_AREA(iLocal_114[1], -1206.545f, -777.8941f, 21.20355f, -1204.313f, -778.2245f, 16.08434f, 2.25f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(iLocal_114[1], -1202.928f, -782.6883f, 21.20369f, -1202.583f, -780.5067f, 16.08243f, 2.25f, 0, 1, 0))
				{
					TASK_SMART_FLEE_PED(iLocal_114[1], PLAYER_PED_ID(), 1000f, -1, 0, 0);
					iLocal_166 = 1;
				}
			}
		}
...
void func_143()
{
	...
	vVar0 = { GET_ENTITY_COORDS(uLocal_167, 1) };
	vVar3 = { GET_ENTITY_ROTATION(uLocal_167, 2) };
	DELETE_OBJECT(&uLocal_167);
	uLocal_167 = CREATE_OBJECT(joaat("prop_cs_duffel_01"), vVar0, 1, 1, 0);
	SET_ENTITY_ROTATION(uLocal_167, vVar3, 2, 1);
}
...
void func_144()
{
	if (DOES_ENTITY_EXIST(iLocal_114[0]))
	{
		if (VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(iLocal_114[0], 0)) > 200f && IS_ENTITY_OCCLUDED(iLocal_114[0]))
		{
			if (DOES_BLIP_EXIST(uLocal_185[0]))
			{
				REMOVE_BLIP(&(uLocal_185[0]));
	...
	if (DOES_ENTITY_EXIST(uLocal_175))
	{
		if (VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(uLocal_175, 0)) > 200f && IS_ENTITY_OCCLUDED(uLocal_175))
		{
			if (DOES_BLIP_EXIST(uLocal_191))
			{
				REMOVE_BLIP(&uLocal_191);
			}
			SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_175);
			bLocal_148 = true;
		}
	}
	else
...
void func_145()
{
	if (!IS_ENTITY_DEAD(uLocal_175, 0))
	{
		if (GET_ENTITY_HEALTH(uLocal_175) < 800)
		{
			SET_ENTITY_HEALTH(uLocal_175, 0, 0);
			SET_VEHICLE_ENGINE_HEALTH(uLocal_175, 10f);
		}
	}
}
...
void func_147()
{
	...
	if (IS_PED_SHOOTING(PLAYER_PED_ID()))
	{
		if (!bLocal_140)
		{
			...
			{
				if (!IS_PED_INJURED(iLocal_114[iVar1]))
				{
					TASK_COMBAT_PED(iLocal_114[iVar1], PLAYER_PED_ID(), 0, 16);
				}
				iVar1++;
			}
			bLocal_140 = true;
	...
	if (!bLocal_140)
	{
		...
		else if (iLocal_49 == 2)
		{
			...
			if (DOES_ENTITY_EXIST(uLocal_167) && !IS_PED_INJURED(iLocal_114[0]))
			{
				if (!iLocal_178)
				{
					iLocal_178 = 1;
		...
		if (!iLocal_138)
		{
			if (iLocal_49 == 1)
			{
				if (TIMERA() > 14100)
				{
					DELETE_OBJECT(&(uLocal_168[0]));
					DELETE_OBJECT(&(uLocal_168[1]));
					if (IS_VEHICLE_DRIVEABLE(uLocal_175, 0))
					{
						if (!IS_PED_INJURED(iLocal_114[0]))
						{
							CLEAR_PED_TASKS(iLocal_114[0]);
							OPEN_SEQUENCE_TASK(&uLocal_152);
							TASK_CLEAR_LOOK_AT(0);
							TASK_ENTER_VEHICLE(0, uLocal_175, -1, 0, 2f, 1, 0);
							CLOSE_SEQUENCE_TASK(uLocal_152);
							TASK_PERFORM_SEQUENCE(iLocal_114[0], uLocal_152);
							CLEAR_SEQUENCE_TASK(&uLocal_152);
						}
						if (!IS_PED_INJURED(iLocal_114[1]))
						{
							FORCE_PED_MOTION_STATE(iLocal_114[1], -530524, 1, 0, 0);
							OPEN_SEQUENCE_TASK(&uLocal_152);
							TASK_CLEAR_LOOK_AT(0);
							TASK_ENTER_VEHICLE(0, uLocal_175, -1, 1, 2f, 1, 0);
							CLOSE_SEQUENCE_TASK(uLocal_152);
							TASK_PERFORM_SEQUENCE(iLocal_114[1], uLocal_152);
							CLEAR_SEQUENCE_TASK(&uLocal_152);
						}
						iLocal_47 = 2;
						iLocal_138 = 1;
					...
					else
					{
						if (!IS_PED_INJURED(iLocal_114[0]))
						{
							SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_114[0], 1, 1);
							CLEAR_PED_TASKS_IMMEDIATELY(iLocal_114[0]);
							OPEN_SEQUENCE_TASK(&uLocal_152);
							TASK_CLEAR_LOOK_AT(0);
						...
						if (!IS_PED_INJURED(iLocal_114[1]))
						{
							SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_114[1], 1, 1);
							CLEAR_PED_TASKS_IMMEDIATELY(iLocal_114[1]);
							OPEN_SEQUENCE_TASK(&uLocal_152);
							TASK_CLEAR_LOOK_AT(0);
							TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 1000f, -1, 0, 0);
							CLOSE_SEQUENCE_TASK(uLocal_152);
			...
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_216) > 0.453f)
				{
					if (!IS_PED_INJURED(iLocal_117[0]))
					{
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_117[0], 1);
					...
					{
						CLEAR_PED_TASKS(iLocal_114[0]);
						SET_PED_FLEE_ATTRIBUTES(iLocal_114[0], 128, 1);
						SET_PED_FLEE_ATTRIBUTES(iLocal_114[0], 1, 1);
						SET_PED_COMBAT_ATTRIBUTES(iLocal_114[0], 17, 1);
						SET_PED_MAX_MOVE_BLEND_RATIO(iLocal_114[0], 1.6f);
						SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_114[0], 1, 1);
						OPEN_SEQUENCE_TASK(&uLocal_152);
						TASK_PLAY_ANIM(0, "random@robbery", "run", 2f, -2f, -1, 49, 0, 0, 0, 0);
						TASK_FOLLOW_WAYPOINT_RECORDING(0, "re_shoprobbery", 0, 0, 16);
						TASK_CLEAR_LOOK_AT(0);
						CLOSE_SEQUENCE_TASK(uLocal_152);
						TASK_PERFORM_SEQUENCE(iLocal_114[0], uLocal_152);
						CLEAR_SEQUENCE_TASK(&uLocal_152);
						SET_PED_KEEP_TASK(iLocal_114[0], 1);
						SETTIMERB(0);
					}
					if (!IS_PED_INJURED(iLocal_114[1]))
					{
						SET_PED_FLEE_ATTRIBUTES(iLocal_114[1], 128, 1);
						SET_PED_FLEE_ATTRIBUTES(iLocal_114[1], 1, 1);
						SET_PED_COMBAT_ATTRIBUTES(iLocal_114[1], 17, 1);
						...
						TASK_PERFORM_SEQUENCE(iLocal_114[1], uLocal_152);
						CLEAR_SEQUENCE_TASK(&uLocal_152);
						SET_PED_KEEP_TASK(iLocal_114[1], 1);
					}
					iLocal_47 = 2;
					iLocal_138 = 1;
				}
...
void func_148()
{
	switch (iLocal_227)
	{
		case 0:
			func_134(1, 1, 1, 0, 0, 0);
			CLEAR_AREA_OF_PEDS(func_149(PLAYER_ID()), 10f, 0);
			uLocal_226 = CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
			SET_CAM_ACTIVE(uLocal_226, 1);
			PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_226, uLocal_216, "robbery_action_cam", "random@shop_robbery");
			if (iLocal_49 == 1)
			{
				_0xAF348AFCB575A441("Hair_room");
			}
			RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
			iLocal_228 = GET_GAME_TIMER() + 3500;
			iLocal_227++;
			break;
		
		case 1:
			if (iLocal_228 < GET_GAME_TIMER())
			{
				if (iLocal_49 == 1)
				{
					SET_GAMEPLAY_CAM_RELATIVE_HEADING(115f);
					SET_GAMEPLAY_CAM_RELATIVE_PITCH(-9.1222f, 1065353216);
				}
				else if (iLocal_49 == 2)
				{
					SET_GAMEPLAY_CAM_RELATIVE_HEADING(44.5236f);
					SET_GAMEPLAY_CAM_RELATIVE_PITCH(-18.1582f, 1065353216);
				}
				NEW_LOAD_SCENE_STOP();
				SET_CAM_ACTIVE(uLocal_226, 0);
...
void func_150()
{
	...
	if (!iLocal_136 && func_153(1, 0, 1))
	{
		...
		if (iLocal_49 == 1)
		{
			if (!iLocal_177)
			{
				uLocal_216 = CREATE_SYNCHRONIZED_SCENE(vLocal_201, vLocal_207, 2);
				CLEAR_PED_TASKS_IMMEDIATELY(PLAYER_PED_ID());
				TASK_SYNCHRONIZED_SCENE(PLAYER_PED_ID(), uLocal_216, "random@shop_robbery", "robbery_action_p", 8f, -8f, 1, 0, 1148846080, 0);
				_0x2208438012482A1A(PLAYER_PED_ID(), 1, 0);
				if (((!IS_PED_INJURED(iLocal_114[0]) && !IS_PED_INJURED(iLocal_114[1])) && !IS_PED_INJURED(iLocal_117[0])) && DOES_ENTITY_EXIST(uLocal_167))
				{
					TASK_SYNCHRONIZED_SCENE(iLocal_114[0], uLocal_216, "random@shop_robbery", "robbery_action_b", 8f, -8f, 1, 0, 1148846080, 0);
					TASK_SYNCHRONIZED_SCENE(iLocal_114[1], uLocal_216, "random@shop_robbery", "robbery_action_a", 8f, -8f, 1, 0, 1148846080, 0);
					TASK_SYNCHRONIZED_SCENE(iLocal_117[0], uLocal_216, "random@shop_robbery", "robbery_action_f", 8f, -4f, 0, 0, 1148846080, 0);
					PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_167, uLocal_216, "robbery_action_bag", "random@shop_robbery", 8f, -8f, 0, 1148846080);
				}
				SET_SYNCHRONIZED_SCENE_PHASE(uLocal_216, 0.06f);
				iLocal_177 = 1;
			}
		}
		else if (iLocal_49 == 2)
		{
			...
			{
				CLEAR_PED_TASKS(iLocal_117[0]);
				TASK_PLAY_ANIM(iLocal_117[0], "random@robbery", "robbery_main_female", 2f, -2f, -1, 0, 0, 0, 0, 0);
			}
			NEW_LOAD_SCENE_START_SPHERE(-1195.062f, -773.2098f, 16.324f, 20f, 4);
			uLocal_216 = CREATE_SYNCHRONIZED_SCENE(vLocal_201, vLocal_207, 2);
			if (((!IS_PED_INJURED(iLocal_114[0]) && !IS_PED_INJURED(iLocal_114[1])) && !IS_PED_INJURED(iLocal_117[0])) && DOES_ENTITY_EXIST(uLocal_167))
			{
				TASK_SYNCHRONIZED_SCENE(iLocal_114[0], uLocal_216, "random@shop_robbery", "robbery_action_b", 2f, -2f, 1, 0, 1148846080, 0);
				TASK_SYNCHRONIZED_SCENE(iLocal_117[0], uLocal_216, "random@shop_robbery", "robbery_action_f", 2f, -2f, 0, 0, 1148846080, 0);
				if (DOES_ENTITY_EXIST(uLocal_168[0]) && DOES_ENTITY_EXIST(uLocal_168[1]))
				{
					ATTACH_ENTITY_TO_ENTITY(uLocal_168[0], iLocal_117[0], GET_PED_BONE_INDEX(iLocal_117[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
					ATTACH_ENTITY_TO_ENTITY(uLocal_168[1], iLocal_117[0], GET_PED_BONE_INDEX(iLocal_117[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
				}
			}
			SET_SYNCHRONIZED_SCENE_PHASE(uLocal_216, 0.05f);
			vLocal_201 = { -1199.369f, -776.1991f, 16.3235f };
			vLocal_207 = { 0f, 0f, -60f };
			uLocal_216 = CREATE_SYNCHRONIZED_SCENE(vLocal_201, vLocal_207, 2);
			if (!IS_PED_INJURED(iLocal_114[1]))
			{
				TASK_SYNCHRONIZED_SCENE(iLocal_114[1], uLocal_216, "random@shop_robbery", "robbery_action_a", 2f, -2f, 1, 0, 1148846080, 0);
			}
			SET_SYNCHRONIZED_SCENE_PHASE(uLocal_216, 0.06f);
			SET_ENTITY_COORDS(PLAYER_PED_ID(), -1200.455f, -777.6201f, 16.3244f, 1, 0, 0, 1);
			SET_ENTITY_HEADING(PLAYER_PED_ID(), 305.3806f);
			CLEAR_PED_TASKS(PLAYER_PED_ID());
			OPEN_SEQUENCE_TASK(&uLocal_152);
			TASK_PLAY_ANIM(0, "random@shop_robbery", "robbery_action_p", 1000f, -2f, -1, 134217736, 0.06f, 0, 0, 0);
			TASK_PLAY_ANIM(0, "random@shop_robbery", "kneel_loop_p", 2f, -4f, -1, 134217737, 0, 0, 0, 0);
			CLOSE_SEQUENCE_TASK(uLocal_152);
			TASK_PERFORM_SEQUENCE(PLAYER_PED_ID(), uLocal_152);
			CLEAR_SEQUENCE_TASK(&uLocal_152);
			_0x2208438012482A1A(PLAYER_PED_ID(), 0, 0);
		}
		iLocal_136 = 1;
	...
	if ((iLocal_49 == 1 && DOES_ENTITY_EXIST(uLocal_175)) || iLocal_49 == 2)
	{
		SETTIMERA(0);
		iLocal_47 = 1;
	}
...
void func_151()
{
	...
	else if (HAS_MODEL_LOADED(iVar0))
	{
		if (func_152())
		{
			if (IS_ENTITY_IN_ANGLED_AREA(uLocal_171, -828.3692f, -194.4669f, 36.41385f, -824.5801f, -201.1353f, 39.39436f, 4.3125f, 0, 1, 0))
			{
		...
		uLocal_175 = CREATE_VEHICLE(iVar0, vLocal_172, 31.9252f, 1, 1, 0);
		SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_175, 1, 1);
		SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_175, 1084227584);
		SET_VEHICLE_ENGINE_ON(uLocal_175, 1, 1, 0);
		uLocal_184 = CREATE_PED_INSIDE_VEHICLE(uLocal_175, 26, joaat("g_m_y_korean_01"), -1, 1, 1);
		SET_PED_CONFIG_FLAG(uLocal_184, 134, 1);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_184, 1);
		SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_184, uLocal_190);
		SET_PED_COMBAT_ATTRIBUTES(uLocal_184, 8, 0);
		SET_PED_COMBAT_ABILITY(uLocal_184, 0);
		SET_PED_ACCURACY(uLocal_184, 13);
		GIVE_WEAPON_TO_PED(uLocal_184, joaat("weapon_pistol"), -1, 1, 1);
		SET_ENTITY_IS_TARGET_PRIORITY(uLocal_184, 1, 0);
		SET_PED_CONFIG_FLAG(uLocal_184, 42, 1);
		iLocal_176 = 1;
	}
}
...
int func_152()
{
	...
	{
		if (IS_ENTITY_AT_COORD(uVar0, -829.3693f, -191.9869f, 36.4616f, 15f, 15f, 5f, 0, 1, 0))
		{
			uLocal_171 = uVar0;
			if (!IS_ENTITY_A_MISSION_ENTITY(uLocal_171))
			{
				SET_ENTITY_AS_MISSION_ENTITY(uLocal_171, 1, 0);
			}
			return 1;
		}
	}
...
int func_156()
{
	switch (func_157(&Global_25824, 0, 5, 0, GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_162()
{
	if (iLocal_49 == 1)
	{
		if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -803.4598f, -175.8135f, 36.28367f, -823.0242f, -187.0462f, 40.53547f, 11.9375f, 0, 1, 0) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -823.3706f, -188.0602f, 36.62162f, -822.8361f, -187.7466f, 39.06914f, 1.5f, 0, 1, 0))
		{
			return 1;
		}
	}
	...
	{
		if (((IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1204.031f, -779.629f, 16.33565f, -1174.799f, -757.0704f, 21.01281f, 12.125f, 0, 1, 0) && !IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1203.899f, -776.9178f, 20.16803f, -1201.289f, -780.4698f, 15.61526f, 3.9375f, 0, 1, 0)) && !IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1206.545f, -777.8941f, 21.20355f, -1204.313f, -778.2245f, 16.08434f, 2.25f, 0, 1, 0)) && !IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1202.928f, -782.6883f, 21.20369f, -1202.583f, -780.5067f, 16.08243f, 2.25f, 0, 1, 0))
		{
			return 1;
		}
	}
...
int func_164()
{
	...
	if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -823.1281f, -187.9591f, 36.6189f, 12f, 12f, 12f, 0, 1, 0) || IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -1201.017f, -777.5527f, 16.3398f, 12f, 12f, 12f, 0, 1, 0))
	{
		if (!IS_PED_INJURED(iLocal_114[0]) && !IS_PED_INJURED(iLocal_114[1]))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_114[0], PLAYER_PED_ID(), 1) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_114[1], PLAYER_PED_ID(), 1))
			{
				return 1;
			}
			if (_CAN_PED_SEE_PED(iLocal_114[0], PLAYER_PED_ID()) || _CAN_PED_SEE_PED(iLocal_114[1], PLAYER_PED_ID()))
			{
				...
				if (iLocal_126 != -1 && GET_GAME_TIMER() > iLocal_126 + 1500)
				{
					return 1;
				}
			}
	...
	if (IS_ENTITY_DEAD(iLocal_114[0], 0) || IS_ENTITY_DEAD(iLocal_114[1], 0))
	{
		return 1;
	}
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && func_162())
	{
		return 1;
	}
	if (IS_PED_RAGDOLL(PLAYER_PED_ID()) && func_162())
	{
		return 1;
	}
	if (!IS_PED_INJURED(iLocal_114[0]) && !IS_PED_INJURED(iLocal_114[1]))
	{
		if (((IS_PED_SHOOTING_IN_AREA(PLAYER_PED_ID(), GET_ENTITY_COORDS(iLocal_114[1], 1) - Vector(12f, 12f, 12f), GET_ENTITY_COORDS(iLocal_114[1], 1) + Vector(12f, 12f, 12f), 0, 1) && !IS_PED_CURRENT_WEAPON_SILENCED(PLAYER_PED_ID())) || IS_BULLET_IN_AREA(GET_ENTITY_COORDS(iLocal_114[0], 1), 3f, 1)) || IS_BULLET_IN_AREA(GET_ENTITY_COORDS(iLocal_114[1], 1), 3f, 1))
		{
			return 1;
		}
	}
	...
	while (iVar0 < iLocal_117)
	{
		if (DOES_ENTITY_EXIST(iLocal_117[iVar0]))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_117[iVar0], PLAYER_PED_ID(), 1))
			{
				return 1;
			}
		}
	...
	while (iVar0 < iLocal_121)
	{
		if (DOES_ENTITY_EXIST(iLocal_121[iVar0]))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_121[iVar0], PLAYER_PED_ID(), 1))
			{
				return 1;
			}
		}
...
int func_166()
{
	if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -823.1281f, -187.9591f, 36.6189f, 4f, 4f, 4f, 0, 1, 0) || IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -1201.017f, -777.5527f, 16.3398f, 4f, 4f, 4f, 0, 1, 0))
	{
...
void func_167()
{
	if (!IS_PED_INJURED(iLocal_117[1]))
	{
		...
		PLAY_PAIN(iLocal_117[1], 26, 0, 0);
	}
	if (!IS_PED_INJURED(iLocal_121[1]))
	{
		func_168(iLocal_121[1], "SCREAM_PANIC", "WAVELOAD_PAIN_FEMALE", 3);
		PLAY_PAIN(iLocal_121[1], 3, 0, 0);
	}
}

void func_168(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_169(iParam3), 0);
}
...
void func_170()
{
	...
	ADD_RELATIONSHIP_GROUP("ROBBERS", &uLocal_190);
	iVar0 = 0;
	while (iVar0 <= (iLocal_111 - 1))
	{
		iLocal_114[iVar0] = CREATE_PED(26, iLocal_222, vLocal_55[iVar0 /*3*/], fLocal_62[iVar0], 1, 1);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_114[iVar0], 1);
		SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_114[iVar0], uLocal_190);
		SET_PED_COMBAT_ATTRIBUTES(iLocal_114[iVar0], 8, 0);
		SET_PED_COMBAT_ABILITY(iLocal_114[iVar0], 0);
		SET_PED_ACCURACY(iLocal_114[iVar0], 13);
		GIVE_WEAPON_TO_PED(iLocal_114[iVar0], joaat("weapon_pistol"), -1, 1, 1);
		SET_ENTITY_IS_TARGET_PRIORITY(iLocal_114[iVar0], 1, 0);
		SET_PED_CONFIG_FLAG(iLocal_114[iVar0], 42, 1);
		SET_PED_CONFIG_FLAG(iLocal_114[iVar0], 269, 1);
		SET_PED_CONFIG_FLAG(iLocal_114[iVar0], 188, 1);
		SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_114[iVar0], 0);
		SET_PED_FLEE_ATTRIBUTES(iLocal_114[iVar0], 128, 1);
		SET_PED_FLEE_ATTRIBUTES(iLocal_114[iVar0], 8, 1);
		iVar0++;
	}
	SET_PED_NAME_DEBUG(iLocal_114[0], "pedRobber[0]");
	SET_PED_NAME_DEBUG(iLocal_114[1], "pedRobber[1]");
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_190, 1862763509);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_190);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_190, -1533126372);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, -1533126372, uLocal_190);
	if (func_43() == 0)
	{
		func_175(&uLocal_232, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
	}
	else if (func_43() == 1)
	{
		func_175(&uLocal_232, 0, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	else if (func_43() == 2)
	{
		func_175(&uLocal_232, 0, PLAYER_PED_ID(), "TREVOR", 0, 1);
	}
	uLocal_167 = CREATE_OBJECT(iLocal_188, vLocal_97, 1, 1, 0);
	if (iLocal_49 == 1)
	{
		ADD_SCENARIO_BLOCKING_AREA(vLocal_128 - Vector(20f, 20f, 20f), vLocal_128 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
		SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("baller"), 1);
		uLocal_168[0] = CREATE_OBJECT(joaat("prop_anim_cash_pile_01"), vLocal_97, 1, 1, 0);
		uLocal_168[1] = CREATE_OBJECT(joaat("prop_anim_cash_pile_01"), vLocal_97 - Vector(0.1f, 0f, 0f), 1, 1, 0);
		...
		uLocal_216 = CREATE_SYNCHRONIZED_SCENE(vLocal_201, vLocal_207, 2);
		SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_216, 1);
		TASK_SYNCHRONIZED_SCENE(iLocal_114[1], uLocal_216, "random@shop_robbery", "robbery_intro_loop_a", 8f, -8f, 0, 0, 1148846080, 0);
		PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_167, uLocal_216, "robbery_intro_loop_bag", "random@shop_robbery", 1000f, 1090519040, 0, 1148846080);
		iVar0 = 0;
		while (iVar0 <= (iLocal_112 - 1))
		{
			iLocal_117[iVar0] = CREATE_PED(26, iLocal_219, vLocal_65[iVar0 /*3*/], fLocal_75[iVar0], 1, 1);
			SET_PED_COMBAT_ATTRIBUTES(iLocal_117[iVar0], 17, 1);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_117[iVar0], 1);
			SET_PED_CAN_BE_TARGETTED(iLocal_117[iVar0], 0);
			SET_PED_CONFIG_FLAG(iLocal_117[iVar0], 269, 1);
			iVar0++;
		}
		...
		iLocal_121[0] = CREATE_PED(26, iLocal_220, vLocal_79[0 /*3*/], fLocal_92[0], 1, 1);
		SET_PED_COMBAT_ATTRIBUTES(iLocal_121[0], 17, 1);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_121[0], 1);
		SET_PED_CAN_BE_TARGETTED(iLocal_121[0], 0);
		SET_PED_CONFIG_FLAG(iLocal_121[0], 269, 1);
		iVar0 = 1;
		while (iVar0 <= 2)
		{
			iLocal_121[iVar0] = CREATE_PED(26, iLocal_221, vLocal_79[iVar0 /*3*/], fLocal_92[iVar0], 1, 1);
			SET_PED_COMBAT_ATTRIBUTES(iLocal_121[iVar0], 17, 1);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_121[iVar0], 1);
			SET_PED_CAN_BE_TARGETTED(iLocal_121[iVar0], 0);
			SET_PED_CONFIG_FLAG(iLocal_121[iVar0], 269, 1);
			iVar0++;
		}
		...
		SET_PED_COMPONENT_VARIATION(iLocal_117[0], 0, 0, 0, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_117[0], 2, 1, 1, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_117[0], 3, 1, 0, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_117[0], 4, 0, 0, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_117[0], 5, 0, 0, 0);
		TASK_SYNCHRONIZED_SCENE(iLocal_117[0], uLocal_216, "random@shop_robbery", "robbery_intro_loop_f", 8f, -8f, 0, 0, 1148846080, 0);
		...
		SET_PED_COMPONENT_VARIATION(iLocal_117[1], 0, 1, 0, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_117[1], 2, 0, 0, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_117[1], 3, 0, 0, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_117[1], 4, 1, 2, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_117[1], 5, 0, 0, 0);
		TASK_COWER(iLocal_117[1], -1);
		SET_PED_KEEP_TASK(iLocal_117[1], 1);
		SET_PED_COMPONENT_VARIATION(iLocal_117[2], 0, 1, 0, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_117[2], 2, 1, 0, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_117[2], 3, 0, 2, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_117[2], 4, 1, 2, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_117[2], 5, 0, 0, 0);
		TASK_COWER(iLocal_117[2], -1);
		SET_PED_KEEP_TASK(iLocal_117[2], 1);
		uLocal_216 = CREATE_SYNCHRONIZED_SCENE(-812.37f, -185.65f, 37.5804f, 0f, 0f, 30f, 2);
		SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_216, 1);
		SET_PED_COMPONENT_VARIATION(iLocal_121[0], 0, 0, 1, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_121[0], 2, 0, 0, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_121[0], 3, 0, 1, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_121[0], 4, 0, 1, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_121[0], 8, 0, 0, 0);
		TASK_SYNCHRONIZED_SCENE(iLocal_121[0], uLocal_216, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		SET_PED_KEEP_TASK(iLocal_121[0], 1);
		uLocal_216 = CREATE_SYNCHRONIZED_SCENE(-817.5606f, -190.8273f, 37.6114f, 0f, 0f, 25.8399f, 2);
		SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_216, 1);
		SET_PED_COMPONENT_VARIATION(iLocal_121[1], 0, 0, 0, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_121[1], 2, 0, 1, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_121[1], 3, 1, 1, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_121[1], 4, 1, 1, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_121[1], 8, 0, 0, 0);
		TASK_SYNCHRONIZED_SCENE(iLocal_121[1], uLocal_216, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		SET_PED_KEEP_TASK(iLocal_121[1], 1);
		uLocal_216 = CREATE_SYNCHRONIZED_SCENE(-816.1862f, -182.897f, 37.68f, 0f, 0f, 30f, 2);
		SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_216, 1);
		SET_PED_COMPONENT_VARIATION(iLocal_121[2], 0, 1, 0, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_121[2], 2, 0, 2, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_121[2], 3, 0, 1, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_121[2], 4, 1, 0, 0);
		SET_PED_COMPONENT_VARIATION(iLocal_121[2], 8, 0, 0, 0);
		TASK_SYNCHRONIZED_SCENE(iLocal_121[2], uLocal_216, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		SET_PED_KEEP_TASK(iLocal_121[2], 1);
		TASK_AIM_GUN_AT_ENTITY(iLocal_114[0], iLocal_117[0], -1, 0);
		SET_ROADS_IN_AREA(-871f, -246f, 0f, -798f, -163f, 50f, 0, 1);
	...
	else if (iLocal_49 == 2)
	{
		...
		SET_ENTITY_ROTATION(uLocal_167, vLocal_100, 2, 1);
		iLocal_117[0] = CREATE_PED(26, iLocal_219, vLocal_65[0 /*3*/], fLocal_75[0], 1, 1);
		SET_PED_NAME_DEBUG(iLocal_117[0], "pedWorker[0]");
		...
		iLocal_117[1] = CREATE_PED(26, iLocal_218, vLocal_65[1 /*3*/], fLocal_75[1], 1, 1);
		SET_PED_NAME_DEBUG(iLocal_117[1], "pedWorker[1]");
		iVar0 = 0;
		while (iVar0 <= (iLocal_112 - 1))
		{
		...
		iLocal_121[0] = CREATE_PED(26, iLocal_220, vLocal_79[0 /*3*/], fLocal_92[0], 1, 1);
		SET_PED_NAME_DEBUG(iLocal_121[0], "pedShopper[0]");
		iLocal_121[1] = CREATE_PED(26, iLocal_221, vLocal_79[1 /*3*/], fLocal_92[1], 1, 1);
		SET_PED_NAME_DEBUG(iLocal_121[1], "pedShopper[1]");
		iVar0 = 0;
		...
		TASK_PLAY_ANIM(iLocal_117[0], "random@shop_robbery", "robbery_intro_loop_f", 4f, -4f, -1, 9, 0, 0, 0, 0);
		SET_PED_KEEP_TASK(iLocal_117[0], 1);
		TASK_PLAY_ANIM(iLocal_117[1], "random@robbery", "f_cower_02", 4f, -4f, -1, 9, 0, 0, 0, 0);
		SET_PED_KEEP_TASK(iLocal_117[1], 1);
		TASK_COWER(iLocal_121[0], -1);
		SET_PED_KEEP_TASK(iLocal_121[0], 1);
		TASK_PLAY_ANIM(iLocal_121[1], "random@robbery", "f_cower_01", 4f, -4f, -1, 9, 0, 0, 0, 0);
		SET_PED_KEEP_TASK(iLocal_121[1], 1);
		vLocal_201 = { -1192.01f, -768.929f, 16.358f };
		vLocal_207 = { 0f, 0f, -59.5f };
		uLocal_216 = CREATE_SYNCHRONIZED_SCENE(vLocal_201, vLocal_207, 2);
		SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_216, 1);
		TASK_SYNCHRONIZED_SCENE(iLocal_114[0], uLocal_216, "random@shop_robbery", "robbery_intro_loop_b", 2f, -2f, 0, 0, 1148846080, 0);
		TASK_SYNCHRONIZED_SCENE(iLocal_117[0], uLocal_216, "random@shop_robbery", "robbery_intro_loop_f", 2f, -2f, 0, 0, 1148846080, 0);
		TASK_PLAY_ANIM(iLocal_114[1], "random@shop_robbery", "robbery_intro_loop_a", 16f, -4f, -1, 9, 0, 0, 0, 0);
		func_174(14, 1);
		func_173(14);
		WAIT(500);
		func_171(14, 0, 0);
...
void func_175(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_176()
{
	if (!iLocal_135)
	{
		uLocal_153 = GET_INTERIOR_AT_COORDS(vLocal_55[0 /*3*/]);
		_LOAD_INTERIOR(uLocal_153);
		iLocal_135 = 1;
	}
}
...
void func_177()
{
	REQUEST_MODEL(iLocal_219);
	REQUEST_MODEL(iLocal_220);
	REQUEST_MODEL(iLocal_221);
	REQUEST_MODEL(iLocal_222);
...
int func_179()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		if (VMAG2(GET_ENTITY_VELOCITY(PLAYER_PED_ID())) > 1369f && !func_190())
		{
			return 0;
		}
	}
...
int func_192()
{
	if ((Global_106554 == func_70() && GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
int func_196(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_197(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_218()) || Global_105612) || Global_25767) || func_217()) || func_124(8, -1)) || func_216()) || func_215()) || func_214()) || func_213()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_218()) || Global_25767) || func_217()) || func_124(8, -1)) || func_214()) || func_216()) || func_215()) || func_213()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_218()) || Global_105612) || Global_25767) || func_217()) || func_124(8, -1)) || func_216()) || func_215()) || func_213()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_218() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_124(8, -1)) || func_213()) || func_212()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_218()) || Global_105612) || Global_25767) || func_217()) || func_124(8, -1)) || func_214()) || func_212()) || func_216()) || func_215()) || func_213())
						{
							return 0;
						}
						break;
...
void func_228()
{
	...
	if (iLocal_223)
	{
		...
		while (iVar0 <= (iLocal_111 - 1))
		{
			if (DOES_ENTITY_EXIST(iLocal_114[iVar0]))
			{
				if (!IS_PED_INJURED(iLocal_114[iVar0]) && !IS_PED_IN_ANY_VEHICLE(iLocal_114[iVar0], 0))
				{
		...
		while (iVar0 <= (iLocal_113 - 1))
		{
			if (DOES_ENTITY_EXIST(iLocal_121[iVar0]))
			{
				if (!IS_PED_INJURED(iLocal_121[iVar0]))
				{
					SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_121[iVar0], 1, 1);
					OPEN_SEQUENCE_TASK(&uLocal_152);
					if (iLocal_49 == 1)
					{
						TASK_PLAY_ANIM(0, "random@robbery", "exit_flee", 4f, -4f, -1, 5632, 0f, 0, 1, 0);
					...
					{
						CLEAR_PED_TASKS(iLocal_121[iVar0]);
						TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1201.476f, -790.2733f, 15.5475f, 2f, -1, 1048576000, 0, 1193033728);
					}
					TASK_SMART_FLEE_COORD(0, vLocal_103, 150f, -1, 0, 0);
					CLOSE_SEQUENCE_TASK(uLocal_152);
					TASK_PERFORM_SEQUENCE(iLocal_121[iVar0], uLocal_152);
					CLEAR_SEQUENCE_TASK(&uLocal_152);
					SET_PED_KEEP_TASK(iLocal_121[iVar0], 1);
				}
			}
		...
		while (iVar0 <= (iLocal_112 - 1))
		{
			if (DOES_ENTITY_EXIST(iLocal_117[iVar0]))
			{
				if (!IS_PED_INJURED(iLocal_117[iVar0]))
				{
					SET_PED_CONFIG_FLAG(iLocal_117[iVar0], 317, 1);
					SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_117[iVar0], 1, 1);
					if (iVar0 == 0)
					{
						if (!iLocal_183)
						{
							CLEAR_PED_TASKS(iLocal_117[iVar0]);
							TASK_SMART_FLEE_COORD(iLocal_117[iVar0], vLocal_103, 150f, -1, 0, 0);
						}
						else
						{
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_117[iVar0], 0);
						}
					}
					else
					{
						...
						TASK_SMART_FLEE_COORD(0, vLocal_103, 150f, -1, 0, 0);
						CLOSE_SEQUENCE_TASK(uLocal_152);
						TASK_PERFORM_SEQUENCE(iLocal_117[iVar0], uLocal_152);
						CLEAR_SEQUENCE_TASK(&uLocal_152);
					}
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_117[iVar0], 0);
					SET_PED_CAN_BE_TARGETTED(iLocal_117[iVar0], 1);
				}
			}
			iVar0++;
		}
		...
		if (DOES_ENTITY_EXIST(uLocal_167))
		{
			...
			SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_167);
		}
		if (DOES_ENTITY_EXIST(uLocal_175))
		{
			SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_175);
...
Vector3 func_242()
{
	...
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		fVar0 = GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_128, 1);
		iLocal_127 = 1;
		if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_131, 1) < fVar0)
		{
			fVar0 = GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_131, 1);
			iLocal_127 = 2;
		}
		if (iLocal_127 == 1)
		{
