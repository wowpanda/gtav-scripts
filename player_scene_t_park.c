...
int func_3(int iParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		...
		case 8:
			vVar8 = { ENTITY::GET_ENTITY_COORDS(*iParam0, 1) };
			...
			*iParam0 = OBJECT::CREATE_OBJECT(iVar14, vVar11, true, true, false);
			...
			if (func_6(iVar0, &sVar15, &cVar16, &iVar17))
			{
				if (func_4(iVar0, &sVar18, &cVar19, &cVar20, &uVar21, &uVar22))
				{
					...
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(*iParam0, Global_90308, &sVar15, &sVar18, 1000f, -8f, iVar17, 1148846080);
					}
				}
			}
...
float func_27()
{
	...
	iVar2 = func_28(PLAYER::PLAYER_PED_ID());
	if (iVar2 == 0)
	{
		if (iVar1 == 0)
		{
