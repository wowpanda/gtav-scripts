...
int func_2()
{
	...
	if (!IS_STRING_NULL_OR_EMPTY(&cLocal_90))
	{
		if (!DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_87))
		{
			vVar0 = { Vector(32.856f, 3819.65f, 1971.62f) - vLocal_83 };
			uLocal_87 = START_PARTICLE_FX_LOOPED_AT_COORD(&cLocal_90, vLocal_83 + vVar0, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
		}
	}
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &sLocal_143, &cLocal_159, 2))
		{
			fVar3 = GET_SYNCHRONIZED_SCENE_PHASE(Global_91042);
			switch (iLocal_224)
			{
				case 0:
					if (fLocal_141 < 0f)
					...
					if (fVar3 > fLocal_141)
					{
						if (!DOES_ENTITY_EXIST(uLocal_72) || iLocal_89 != -1)
						{
							if (START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE(&cLocal_106, PLAYER_PED_ID(), 0f, 0f, 0f, 0f, 0f, 0f, iLocal_89, 1f, 0, 0, 0))
							{
								if (ARE_STRINGS_EQUAL(&cLocal_106, "scr_meth_pipe_smoke"))
								{
									func_16(PLAYER_PED_ID(), 0, 1);
								}
								uLocal_223 = GET_SOUND_ID();
								PLAY_SOUND_FROM_ENTITY(uLocal_223, &cLocal_207, PLAYER_PED_ID(), &cLocal_191, 0, 0);
								iLocal_224++;
							}
						}
						else if (START_PARTICLE_FX_NON_LOOPED_ON_ENTITY(&cLocal_106, uLocal_72, 0f, 0f, -1f, 0f, 0f, 0f, 1065353216, 0, 0, 0))
						{
							if (ARE_STRINGS_EQUAL(&cLocal_106, "scr_meth_pipe_smoke"))
							{
								func_16(PLAYER_PED_ID(), 0, 1);
				...
				case 2:
					if (!IS_STRING_NULL_OR_EMPTY(&cLocal_122))
					{
						if (START_PARTICLE_FX_NON_LOOPED_AT_COORD(&cLocal_122, vLocal_83 + vLocal_138, 0f, 0f, 0f, 1f, 0, 0, 0))
						{
							iLocal_224++;
						}
					}
			...
			if (DOES_ENTITY_EXIST(uLocal_72))
			{
				if (IS_ENTITY_ATTACHED(uLocal_72))
				{
					if (iLocal_82 != -1)
					{
						if (fVar3 > fLocal_81)
		...
		else
		{
			if (iLocal_88 != 0)
			{
				STOP_PARTICLE_FX_LOOPED(iLocal_88, 0);
				iLocal_88 = 0;
				STOP_SOUND(uLocal_223);
				RELEASE_SOUND_ID(uLocal_223);
			}
			if (DOES_ENTITY_EXIST(uLocal_72))
			{
				if (IS_ENTITY_ATTACHED(uLocal_72))
...
int func_3(var uParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			if (GET_ENTITY_MODEL(*uParam0) != joaat("prop_cs_ironing_board") && GET_ENTITY_MODEL(*uParam0) != joaat("prop_iron_01"))
			{
				FREEZE_ENTITY_POSITION(*uParam0, 0);
				SET_ENTITY_DYNAMIC(*uParam0, 1);
			}
			if (GET_ENTITY_MODEL(*uParam0) == joaat("prop_iron_01"))
			{
				vVar1 = { GET_ENTITY_COORDS(*uParam0, 1) };
				vVar4 = { GET_ENTITY_ROTATION(*uParam0, 2) };
				SET_ENTITY_COORDS(*uParam0, vVar1 + Vector(0.1f, 0f, 0f), 1, 0, 0, 1);
				SET_ENTITY_ROTATION(*uParam0, vVar4.x, vVar4.y, vVar4.z, 2, 1);
			}
			if (GET_ENTITY_MODEL(*uParam0) != joaat("p_defilied_ragdoll_01_s"))
			{
		...
		case 3:
			...
			if (((GET_ENTITY_MODEL(*uParam0) != -1593767197 && GET_ENTITY_MODEL(*uParam0) != joaat("v_res_tt_flusher")) && GET_ENTITY_MODEL(*uParam0) != joaat("v_ilev_fh_lampa_on")) && GET_ENTITY_MODEL(*uParam0) != joaat("prop_cs_remote_01"))
			{
				STOP_SYNCHRONIZED_ENTITY_ANIM(*uParam0, -8f, 1);
			}
			if ((GET_ENTITY_MODEL(*uParam0) != joaat("v_ilev_fh_dineeamesa") && GET_ENTITY_MODEL(*uParam0) != joaat("v_res_tt_flusher")) && GET_ENTITY_MODEL(*uParam0) != joaat("v_ilev_fh_lampa_on"))
			{
				FREEZE_ENTITY_POSITION(*uParam0, 0);
			}
			SET_ENTITY_DYNAMIC(*uParam0, 1);
		...
		case 4:
			vVar7 = { GET_ENTITY_COORDS(*uParam0, 1) };
			vVar10 = { GET_ENTITY_ROTATION(*uParam0, 2) };
			iVar13 = 0;
			switch (GET_ENTITY_MODEL(*uParam0))
			{
				...
				case joaat("prop_toiletfoot_static"):
					...
					vVar17 = { 0f, 0f, 53.6f };
					SET_ENTITY_COORDS(*uParam0, vVar14, 1, 0, 0, 1);
					SET_ENTITY_ROTATION(*uParam0, vVar17, 2, 1);
			...
			DELETE_OBJECT(uParam0);
			*uParam0 = CREATE_OBJECT(iVar13, vVar7, 1, 1, 0);
			SET_ENTITY_ROTATION(*uParam0, vVar10, 2, 1);
			SET_MODEL_AS_NO_LONGER_NEEDED(iVar13);
			return 1;
			break;
		
		case 5:
			ADD_EXPLOSION(GET_ENTITY_COORDS(*uParam0, 1), 0, 1056964608, 1, 0, 1065353216, 0);
			DELETE_OBJECT(uParam0);
			return 1;
			break;
		...
		case 7:
			if (GET_ENTITY_MODEL(*uParam0) == GET_WEAPONTYPE_MODEL(joaat("weapon_pistol")))
			{
				if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
				{
					if (!HAS_PED_GOT_WEAPON(PLAYER_PED_ID(), joaat("weapon_pistol"), 0))
					{
						GIVE_WEAPON_TO_PED(PLAYER_PED_ID(), joaat("weapon_pistol"), 30, 0, 1);
					}
					SET_CURRENT_PED_WEAPON(PLAYER_PED_ID(), joaat("weapon_pistol"), 1);
				}
				DELETE_OBJECT(uParam0);
				return 1;
			}
		...
		case 8:
			vVar20 = { GET_ENTITY_COORDS(*uParam0, 1) };
			vVar23 = { GET_ENTITY_ROTATION(*uParam0, 2) };
			sVar26 = "";
			switch (GET_ENTITY_MODEL(*uParam0))
			{
			...
			START_PARTICLE_FX_NON_LOOPED_AT_COORD(sVar26, vVar20, vVar23, 1065353216, 0, 0, 0);
			DELETE_OBJECT(uParam0);
			return 1;
			break;
		
		case 9:
			vVar27 = { GET_ENTITY_COORDS(*uParam0, 1) };
			vVar30 = { GET_ENTITY_ROTATION(*uParam0, 2) };
			sVar33 = "";
			switch (GET_ENTITY_MODEL(*uParam0))
			{
				case joaat("prop_cs_beer_bot_01"):
			...
			REQUEST_MODEL(iVar34);
			while (!HAS_MODEL_LOADED(iVar34))
			{
				HIDE_HUD_AND_RADAR_THIS_FRAME();
				HIDE_HUD_COMPONENT_THIS_FRAME(18);
				CLEAR_REMINDER_MESSAGE();
			...
			DELETE_OBJECT(uParam0);
			*uParam0 = CREATE_OBJECT(iVar34, vVar27, 1, 1, 0);
			SET_ENTITY_ROTATION(*uParam0, vVar30, 2, 1);
			if (func_6(iVar0, &sVar35, &cVar51, &uVar67))
			{
				if (func_4(iVar0, &sVar68, &cVar84, &cVar100, &uVar116, &uVar117))
				{
					if (!IS_ENTITY_PLAYING_ANIM(*uParam0, &sVar68, &sVar35, 2))
					{
						PLAY_SYNCHRONIZED_ENTITY_ANIM(*uParam0, Global_91042, &sVar35, &sVar68, 1000f, -8f, uVar67, 1148846080);
					}
				}
			}
			SET_MODEL_AS_NO_LONGER_NEEDED(iVar34);
			return 1;
			break;
	}
	return 0;
...
void func_27(int iParam0, int iParam1, float fParam2, float fParam3, var uParam4, bool bParam5)
{
	int iVar0;
...
float func_28()
{
	...
	fVar0 = 0.1f;
	iVar1 = func_29(PLAYER_PED_ID());
	iVar2 = func_34(PLAYER_PED_ID());
	if (iVar2 == 0)
	{
		if (iVar1 == 0)
		{
...
int func_35()
{
	if (!iLocal_73 == 0)
	{
		if (!DOES_ENTITY_EXIST(uLocal_72))
		{
			REQUEST_MODEL(iLocal_73);
			if (!HAS_MODEL_LOADED(iLocal_73))
			{
				REQUEST_MODEL(iLocal_73);
			}
			else if (iLocal_80 != -1)
			{
				uLocal_72 = CREATE_OBJECT(iLocal_73, vLocal_83, 1, 1, 0);
				ATTACH_ENTITY_TO_ENTITY(uLocal_72, PLAYER_PED_ID(), GET_PED_BONE_INDEX(PLAYER_PED_ID(), iLocal_80), vLocal_74, vLocal_77, 0, 0, 0, 0, 2, 1);
			}
			else
			{
				uLocal_72 = CREATE_OBJECT(iLocal_73, vLocal_83 + vLocal_74, 1, 1, 0);
				SET_ENTITY_COORDS(uLocal_72, vLocal_83 + vLocal_74, 1, 0, 0, 1);
				SET_ENTITY_ROTATION(uLocal_72, Vector(uLocal_86, 0f, 0f) + vLocal_77, 2, 1);
				FREEZE_ENTITY_POSITION(uLocal_72, 1);
			}
		}
	}
	if (!func_36())
	{
		if (DOES_ENTITY_EXIST(uLocal_72))
		{
			if (iLocal_80 != -1)
			{
				if (!IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_72, PLAYER_PED_ID()))
				{
					ATTACH_ENTITY_TO_ENTITY(uLocal_72, PLAYER_PED_ID(), GET_PED_BONE_INDEX(PLAYER_PED_ID(), iLocal_80), vLocal_74, vLocal_77, 0, 0, 0, 0, 2, 1);
				}
			}
...
void func_41()
{
	...
	{
		if (func_44(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
...
void func_50()
{
	...
	while (!bVar1 && iVar0 < 400)
	{
		...
		if (!IS_STRING_NULL_OR_EMPTY(&cLocal_175))
		{
			if (!REQUEST_AMBIENT_AUDIO_BANK(&cLocal_175, 0, -1))
			{
				bVar1 = false;
			}
		}
...
void func_51()
{
	...
	func_55(iLocal_70, &vLocal_83, &uLocal_86, &cVar0);
	switch (iLocal_70)
	{
		case 273:
		case 274:
...
int func_52(struct<109> Param0, var uParam109)
{
	uParam109->f_119 = 0;
	switch (Param0.f_2)
	{
		...
		case 12:
			*uParam109 = { Param0 };
			...
			func_53(uParam109, 144, -982327190, -982327190, 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
			break;
		...
		case 75:
			*uParam109 = { Param0 };
			...
			func_53(uParam109, 30, -982327190, -982327190, 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
			break;
		...
		case 77:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 17, 1785177548, 1785177548, -0.7035f, -0.0282f, 0f, 0f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 78:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 17, 1785177548, 1785177548, -3.03f, -0.72f, 0.08f, 168f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 80:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 17, -2017877118, -2017877118, Vector(2.6407f, 8.164f, -14.1564f) + Vector(-1f, 0.03f, -2.16f), (-66f + -56f));
			if (Param0.f_2 == 80)
			{
				func_54(uParam109);
			}
		...
		case 94:
			*uParam109 = { Param0 };
			...
			if (Param0.f_2 == 94)
			{
				func_53(uParam109, 17, 1785177548, 1785177548, -1.71f, 1.05f, 0f, -138f);
			}
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 150:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 20, 1785177548, 1785177548, 0.98f, 0.8017f, -0.42f, -180f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 98:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 17, 1785177548, 1785177548, 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
			break;
		...
		case 99:
			*uParam109 = { Param0 };
			uParam109->f_109 = -982327190;
			uParam109->f_110 = -982327190;
			func_53(uParam109, 15, -982327190, 451360105, 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
			break;
		...
		case 101:
			*uParam109 = { Param0 };
			uParam109->f_109 = -982327190;
			uParam109->f_110 = -982327190;
			func_53(uParam109, 14, -982327190, 451360105, 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
			break;
		...
		case 122:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 17, 1785177548, 1785177548, -2.04f, -0.15f, 0f, 14.4f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 152:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 17, 1785177548, 1785177548, 1.1779f, 2.4276f, 0f, 162.1022f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 155:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 17, 1785177548, 1785177548, GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 156:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 14, 1785177548, 1785177548, 0.3427f, 1.1592f, 1.0351f, 139.912f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 144, 1785177548, 1785177548, GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 167:
			*uParam109 = { Param0 };
			uParam109->f_109 = -982327190;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 14, -982327190, 1785177548, -0.8472f, 0.155f, 0f, 152.556f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 169:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 14, 1785177548, 1785177548, -0.3577f, -0.8968f, -0.0003f, 0f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 171:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 14, 1785177548, 1785177548, 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
			break;
		...
		case 172:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 15, 1785177548, 1785177548, 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 192:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 144, 1785177548, 1785177548, 1f, 1f, 0f, 0f);
			uParam109->f_118 = 1;
			if (Global_3)
			{
				uParam109->f_118 = 1;
		...
		case 193:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 144, -982327190, 1785177548, 4.2943f, -6.7858f, 0f, -133.5332f);
			uParam109->f_118 = 1;
			if (Global_3)
			{
				uParam109->f_118 = 1;
		...
		case 196:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 43, 1785177548, 1785177548, GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 205:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 144, 1785177548, 1785177548, 3.4381f, -0.8269f, 0f, -87.6612f);
			if (Param0.f_2 != 205)
			{
		...
		case 221:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 144, 1785177548, 1785177548, -0.7949f, -0.508f, 0f, 0f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 218:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 19, 1785177548, 1785177548, 1.29f, 1.41f, 0f, 57.52f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 220:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 19, 1785177548, 1785177548, 0.5504f, -0.2322f, 0f, -9.9741f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 225:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 19, 1785177548, 1785177548, 1.23f, 0.6f, -1f, 34.56f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 236:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 144, 1785177548, 1785177548, 1.5033f, 1.2118f, 0f, -78.0449f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 270:
			*uParam109 = { Param0 };
			...
			if (Param0.f_2 == 267)
			{
				func_53(uParam109, 144, -982327190, 2106541073, -2.4166f, -0.15f, 0f, -148.7555f);
			}
			if (Param0.f_2 == 266)
			{
				func_53(uParam109, 144, 2106541073, 2106541073, -5.7915f, -11.0439f, 0.67f, -72.589f);
			}
			return 1;
			break;
		...
		case 262:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 144, 1785177548, 1785177548, 0f, 0f, 0f, 0f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 289:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 144, -2017877118, -2017877118, -3.264f, -14.7895f, 14.1815f, -0.6311f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 295:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 32, 1785177548, 1785177548, 0f, 0f, 0f, 0f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 299:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 32, 1785177548, 1785177548, 0.24f, 0.33f, -0.5f, -11.88f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 296:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 32, 1785177548, 1785177548, 1.41f, 1.35f, 0f, 168f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 297:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 32, 1785177548, 1785177548, 1.7491f, 0.6423f, 0f, 166.479f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 298:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_53(uParam109, 32, 1785177548, 1785177548, 0.72f, -0.69f, 0f, 172.44f);
			uParam109->f_118 = 1;
			return 1;
			break;
		...
		case 312:
			*uParam109 = { Param0 };
			...
			func_53(uParam109, 144, 474215631, -1519143300, -9.5443f, -3.191f, -0.3f, 180f);
			uParam109->f_118 = 1;
			return 1;
			break;
...
void func_53(var uParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, float fParam7)
{
...
bool func_57(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
