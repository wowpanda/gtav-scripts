					...
					if (fVar1 > fLocal_108)
					{
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_68) || iLocal_79 != -1)
						{
							if (GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE(&cLocal_89, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 0f, 0f, 0f, iLocal_79, 1f, 0, 0, 0))
							{
								...
								{
									func_15(PLAYER::PLAYER_PED_ID(), 0, 1);
								}
			...
			*iParam0 = OBJECT::CREATE_OBJECT(iVar14, vVar11, true, true, false);
			...
			if (func_6(iVar0, &sVar15, &cVar16, &iVar17))
			{
				if (func_4(iVar0, &sVar18, &cVar19, &cVar20, &uVar21, &uVar22))
				{
					...
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(*iParam0, Global_90430, &sVar15, &sVar18, 1000f, -8f, iVar17, 1148846080);
					}
				}
			}
...
void func_15(int iParam0, int iParam1, int iParam2)
{
	...
	if ((func_33(iParam0) + iParam2) > 10)
	{
		iParam2 = (10 - func_33(iParam0));
	}
	iVar0 = 20000;
	...
	func_16(1, iVar5, 4, iParam0, iParam2);
}

void func_16(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	func_17(iParam0, iParam1, iParam2, iParam3, 0, iParam4);
}

void func_17(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
{
	func_17(iParam0, iParam1, iParam2, 0, iParam3, 1);
}
...
void func_26(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, bool bParam5)
{
	int iVar0;
...
float func_27()
{
	...
	fVar0 = 0.1f;
	iVar1 = func_28(PLAYER::PLAYER_PED_ID());
	iVar2 = func_33(PLAYER::PLAYER_PED_ID());
	if (iVar2 == 0)
	{
		if (iVar1 == 0)
		{
...
int func_36(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_37(Global_92741) && iParam1 != 0)
		{
			Global_92741 = 0;
		}
	}
...
void func_40()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_43(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_41(iVar0) && (!func_44(14) || Global_104171))
			{
...
void func_50()
{
	...
	Var1 = 0;
	Var1.f_2 = iLocal_66;
	Var1.f_3 = Global_90578.f_45;
	func_51(Var1, &Var2);
	func_4(iLocal_66, &sLocal_110, &cVar3, &cLocal_126, &uVar4, &uVar5);
}

int func_51(struct<109> Param0, var uParam1)
{
	uParam1->f_119 = 0;
	switch (Param0.f_2)
	{
		...
		case 2:
			*uParam1 = { Global_91131[0 /*109*/] };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = -982327190;
			func_53(uParam1);
			uParam1->f_118 = Global_92719[0];
			return 1;
			break;
		
		case 3:
			*uParam1 = { Global_91131[1 /*109*/] };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = -982327190;
			func_53(uParam1);
			uParam1->f_118 = Global_92719[1];
			return 1;
			break;
		
		case 4:
			*uParam1 = { Global_91131[2 /*109*/] };
			uParam1->f_109 = -982327190;
			uParam1->f_110 = -982327190;
			func_53(uParam1);
			uParam1->f_118 = Global_92719[2];
			return 1;
			break;
		...
		case 5:
			*uParam1 = { Param0 };
			...
			uParam1->f_110 = -982327190;
			func_53(uParam1);
			uParam1->f_118 = Global_92719[Param0.f_3];
			return 1;
			break;
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_52(uParam1, 17, 1785177548, 1785177548, MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_52(uParam1, 144, 1785177548, 1785177548, MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_52(uParam1, 43, 1785177548, 1785177548, MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
...
void func_52(var uParam0, int iParam1, int iParam2, int iParam3, vector3 vParam4, float fParam5)
{
...
int func_54(int iParam0, var uParam1, var uParam2, char* sParam3)
{
	int iVar0;
