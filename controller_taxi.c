		...
		switch (iVar1)
		{
			...
			case 1:
				...
				if (!func_69() && !Global_90640)
				{
					if (iVar1 != 2)
					{
						if ((!IS_MINIGAME_IN_PROGRESS() && !bVar0) && !func_68(5))
						{
							func_65();
							if (func_64())
							{
								...
								switch (iLocal_106)
								{
									case 0:
										if (func_62() == 0)
										{
											...
											{
												if (!IS_HELP_MESSAGE_BEING_DISPLAYED() && func_52())
												{
													iLocal_107 = 9;
									...
									case 2:
										...
										if (func_53(&uLocal_118) > 15f)
										{
											...
											fLocal_111 = (GET_RANDOM_FLOAT_IN_RANGE(10f, 40f) + func_53(&uLocal_118));
											iLocal_106 = 3;
										}
										else if (iLocal_112)
										{
								...
								if (((IS_CONTROL_PRESSED(0, 86) && !IS_ENTITY_UPSIDEDOWN(PLAYER_PED_ID())) && !Global_25916) && (GET_GAME_TIMER() - iLocal_109) > 3000)
								{
									iVar4 = func_62();
									if (iVar4 == 0)
									{
							...
							else
							{
								...
								if (((GET_GAME_TIMER() - iLocal_110) > 60000 && !func_58("TC_HOWTOSTART")) && iLocal_116)
								{
									iLocal_116 = 0;
								}
								if (bLocal_114)
			...
			case 4:
				...
				if (HAS_SCRIPT_LOADED(&vLocal_99))
				{
			...
			case 8:
				if (func_64())
				{
					if (!func_21())
					{
						...
						iLocal_98 = START_NEW_SCRIPT(&vLocal_99, 28000);
						SET_SCRIPT_AS_NO_LONGER_NEEDED(&vLocal_99);
						if (!func_76(Global_106565.f_19091, 4))
						{
							func_74(&(Global_106565.f_19091), 4);
							SET_VEHICLE_MODEL_IS_SUPPRESSED(func_20(), 1);
						}
...
void func_12()
{
	...
	if (!DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_71590)
		{
			if (func_13() == 2 == 0 && !NETWORK_IS_GAME_IN_PROGRESS())
			{
...
void func_28(char* sParam0, int iParam1)
{
	...
	{
		if (func_58(sParam0) && !IS_HELP_MESSAGE_FADING_OUT())
		{
			CLEAR_HELP(0);
		}
	}
...
float func_53(var uParam0)
{
	if (func_57(uParam0))
	{
		...
		{
			return (func_54(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
int func_62()
{
	...
	else
	{
		...
		iVar1 = ROUND(GET_VEHICLE_ENGINE_HEALTH(uVar0));
		iVar2 = GET_ENTITY_HEALTH(uVar0);
...
{
	uParam0->f_1 = (func_54(IS_BIT_SET(*uParam0, 4)) - fParam1);
	SET_BIT(uParam0, 1);
	CLEAR_BIT(uParam0, 2);
	uParam0->f_2 = 0f;
}
...
void func_73(var uParam0)
{
	...
	if (iVar0 == 0)
	{
		func_51(uParam0, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
	}
	else if (iVar0 == 2)
	{
		func_51(uParam0, 0, PLAYER_PED_ID(), "TREVOR", 0, 1);
	}
	else if (iVar0 == 1)
	{
		func_51(uParam0, 0, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	else
	{
		func_51(uParam0, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
...
void func_83()
{
	...
	if (GET_LENGTH_OF_LITERAL_STRING(&vLocal_99) != 0)
	{
		SET_SCRIPT_AS_NO_LONGER_NEEDED(&vLocal_99);
	}
	if (DOES_BLIP_EXIST(uLocal_105))
