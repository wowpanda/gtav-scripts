...
{
	func_60(&(Global_98783.f_2875), vParam0, fParam1);
}
...
{
	if (func_62(Global_71218, 0f, 0f, 0f, 0))
	{
	...
	if (func_56(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 < Local_250)
		{
			if (func_72(&(Local_250[iVar0 /*19*/])))
			{
				...
				BRAIN::TASK_SMART_FLEE_COORD(Local_250[iVar0 /*19*/].f_3, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 400f, -1, 0, 0);
			}
			iVar0++;
		}
	}
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_302(1, 1093140480, 0) && SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2"))
			{
				...
				GRAPHICS::REMOVE_DECALS_IN_RANGE(vLocal_107, 500f);
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_239, 2, func_638(49), 0);
...
void func_77(int iParam0, bool bParam1)
{
	...
	{
		func_237(&(Global_104307[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
...
void func_80()
{
	...
	{
		func_82(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
...
int func_104(int iParam0, int iParam1, int iParam2)
{
	...
	Global_70793[1 /*14*/] = { func_155(iVar0, iParam1, iParam2) };
	...
	else
	{
		...
		Global_70793[1 /*14*/] = { func_155(iVar0, iParam1, uVar6[iParam1]) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_147(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_147(iParam1), Global_70793[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_147(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, 0);
		}
	}
...
int func_105(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_219(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_64, Global_105220.f_2354.f_539[iVar0 /*65*/].f_63))
		{
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_70793[1 /*14*/] = { func_155(iVar10, iParam1, iParam2) };
		if (!func_145(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_70793[1 /*14*/] = { func_155(iVar10, iVar0, uVar11[iVar0]) };
				if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_70793[1 /*14*/] = { func_155(iVar10, 14, uVar12[iVar1]) };
							func_123(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
							func_138(14);
							if (Global_70791 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_147(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_147(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_147(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
						}
						func_138(iVar0);
						if (Global_70791 == 1)
						{
			...
			{
				Global_70793[1 /*14*/] = { func_155(iVar10, iVar0, func_113(iParam0, iVar0, -1)) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_70793[1 /*14*/] = { func_155(iVar10, 14, uVar15[iVar1]) };
			func_123(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
			func_138(14);
			if (Global_70791 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_147(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_147(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_147(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
		}
		if (Global_70791 == 1)
		{
			iVar2 = 0;
...
{
	Global_70793[1 /*14*/] = { func_155(iParam0, iParam1, iParam2) };
...
int func_125(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_147(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_130(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_147(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_125(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_125(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_125(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_125(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_138(int iParam0)
{
	...
	{
		func_144(iParam0, Global_70793[1 /*14*/].f_5, Global_70793[1 /*14*/].f_2, 2, Global_70793[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
int func_146(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_219(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_61, Global_105220.f_2354.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_154(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[0], Global_105220.f_2354.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_154(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[1], Global_105220.f_2354.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_154(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[2], Global_105220.f_2354.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
struct<14> func_155(int iParam0, int iParam1, int iParam2)
{
	func_218();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_157(int iParam0)
{
	...
	func_158(&(Global_70793[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_142(func_161(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_142(func_160(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_142(iVar1, Global_70790, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_164(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_158(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_158(&(Global_70793[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_158(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_147(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_158(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_219(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_219(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_219(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_70793[2 /*14*/] = { func_155(iVar0, 14, iVar4) };
									if (Global_70793[2 /*14*/].f_12 == iVar3)
									{
										if (func_219(iParam0, 14, iVar4))
										{
											if (!func_111(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_70793[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_70793[2 /*14*/] = { func_155(iVar0, iVar2, iVar1) };
						if (!func_111(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_70793[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_70793[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_147(iParam1)) && Global_70793[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_147(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_226(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_227(&sVar1, Var0.f_3, Global_92992, iParam1, iParam2);
	}
}
...
void func_232()
{
	...
	{
		func_10();
		GRAPHICS::_0xBF59707B3E5ED531(func_233(Global_105220.f_2354.f_539.f_4301));
	}
	else
	{
...
{
	func_242(iParam0, 1);
	Global_105220.f_18545[iParam0 /*6*/].f_3 = func_241();
...
bool func_251(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	else
	{
		...
		if (MISC::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()) != MISC::GET_HASH_KEY("standard_global_reg"))
		{
			if (iParam2 == 0)
			{
				if (Global_32872[iParam0] && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Var3, true) < 200f)
				{
					bVar5 = false;
					Global_1643742 = 1;
				}
...
void func_269(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		func_270(iParam0, &(Global_105220.f_2354.f_539.f_298[iVar0 /*472*/]), bParam1);
		iVar1 = 0;
		while (iVar1 <= (8 - 1))
		{
			HUD::_0x72C1056D678BB7D8(Global_105220.f_2354.f_539.f_1715[iVar1 /*4*/][iVar0]);
			if (bParam2)
			{
				if (iVar1 == Global_105220.f_2354.f_539.f_1748 || (Global_105220.f_2354.f_539.f_1748 == -1 && iVar1 == 4))
				{
					if (Global_105220.f_2354.f_539.f_1715[iVar1 /*4*/][iVar0] != 0 && Global_105220.f_2354.f_539.f_1715[iVar1 /*4*/][iVar0] != joaat("weapon_molotov"))
					{
						if (WEAPON::HAS_PED_GOT_WEAPON(iParam0, Global_105220.f_2354.f_539.f_1715[iVar1 /*4*/][iVar0], 0))
						{
							WEAPON::SET_CURRENT_PED_WEAPON(iParam0, Global_105220.f_2354.f_539.f_1715[iVar1 /*4*/][iVar0], true);
						}
					}
				}
			}
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar7 < 2)
		{
			...
			while (iVar8 < FILES::GET_NUM_DLC_WEAPONS())
			{
				...
				{
					if (!FILES::_IS_DLC_DATA_EMPTY(Var9) && !func_275(Var9.f_1))
					{
						if (iVar7 == 0)
						{
...
bool func_276(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("weapon_hatchet"):
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				if (!func_277() && !Global_262145.f_19122)
				{
					return 0;
				}
			}
	...
	while (iVar0 < FILES::GET_NUM_DLC_WEAPONS())
	{
		if (FILES::GET_DLC_WEAPON_DATA(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (FILES::_IS_DLC_DATA_EMPTY(Var1) || func_275(Var1.f_1))
				{
					return 0;
				}
			}
...
void func_281(var uParam0)
{
	...
	while (iVar0 < 3)
	{
		Global_105220.f_2354.f_539.f_294[iVar0] = uParam0->f_17[iVar0];
		iVar1 = 0;
		while (iVar1 < 44)
		{
			Global_105220.f_2354.f_539.f_298[iVar0 /*472*/][iVar1 /*5*/] = { uParam0->f_812[iVar0 /*472*/][iVar1 /*5*/] };
			iVar1++;
		}
		iVar1 = 0;
		while (iVar1 < 50)
		{
			Global_105220.f_2354.f_539.f_298[iVar0 /*472*/].f_221[iVar1 /*5*/] = { uParam0->f_812[iVar0 /*472*/].f_221[iVar1 /*5*/] };
			iVar1++;
		}
		iVar0++;
	}
...
void func_311(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_374(&(Global_92955.f_3));
				if (iVar6 > -1)
				{
...
{
	func_313(&Global_98783, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_313(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_9();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_335())
		{
			func_331(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
...
void func_331(int iParam0, var uParam1, int iParam2)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && ENTITY::GET_ENTITY_MODEL(iParam0) == ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			if (func_332(161, -1))
			{
				uParam1->f_59 = func_142(2051, Global_70790, 0);
			}
			else
			{
				uParam1->f_59 = func_142(752, Global_70790, 0);
			}
			uParam1->f_60 = func_142(753, Global_70790, 0);
			uParam1->f_61 = func_142(754, Global_70790, 0);
		}
...
void func_336(int iParam0, bool bParam1)
{
	...
	if (func_11(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_337(iParam0, &(Global_105220.f_2354.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
Vector3 func_348(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_359(Global_95018);
			break;
		
		case 46:
			if (Global_1589135 != func_358())
			{
				if (func_357(Global_1589135))
				{
					return func_350(2, 2);
				}
				else if (func_349(Global_1589135))
				{
...
var func_363()
{
	...
	func_373(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_372(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_371(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_366(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_365(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_364(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_369(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_375(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_376(Global_105220.f_9056.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_376(Global_105220.f_9056.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_376(Global_105220.f_9056.f_99.f_205[11]);
			break;
		
		case 90:
			return func_376(Global_105220.f_9056.f_99.f_205[7]);
			break;
		
		case 93:
			return func_376(Global_105220.f_9056.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
{
	iParam0->f_1 = (func_393(MISC::IS_BIT_SET(*iParam0, 4)) - fParam1);
...
int func_400(var uParam0, vector3 vParam1, float fParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	var uVar1;
	...
	*uParam0 = 1;
	...
	BRAIN::TASK_PLAY_ANIM(uParam0->f_3, sLocal_247, &(uParam0->f_7), 8f, -2f, -1, 0, 0, 0, 0, 0);
...
void func_404(int iParam0)
{
	...
	fVar0 = func_405(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
	ENTITY::SET_ENTITY_HEADING(iParam0, fVar0);
}

float func_405(struct<2> Param0, float fParam1, struct<2> Param2, float fParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_413(int iParam0, vector3 vParam1, var uParam2)
{
	if (func_402())
	{
...
float func_414(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3)
{
...
int func_421(var uParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	float fVar0;
...
void func_423(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 2:
			if (iLocal_289 > 1)
			{
				if (func_420(&iLocal_531, MISC::GET_RANDOM_FLOAT_IN_RANGE(9f, 12f)))
				{
					func_410(1, 5, 5, 0);
				}
			}
...
void func_429(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 1:
			HUD::CLEAR_PRINTS();
			func_431(PLAYER::PLAYER_PED_ID(), -1);
			if (!AUDIO::IS_AUDIO_SCENE_ACTIVE(sLocal_248))
			{
	...
	switch (iLocal_523)
	{
		...
		case 1:
			...
			if (CAM::DOES_CAM_EXIST(iLocal_510))
			{
				...
				{
					func_449(PLAYER::PLAYER_PED_ID(), 187.789f, -959.6204f, 29.00801f, 85f, 0, 1);
					func_407(&uLocal_524);
					iLocal_523 = 6;
				}
			}
...
int func_446(var uParam0)
{
	...
	if (BRAIN::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 780511057) > 1)
	{
		if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_3, sLocal_247, &(uParam0->f_7), 3))
		{
			...
			uParam0->f_2 = 12;
			BRAIN::TASK_COMBAT_PED(uParam0->f_3, PLAYER::PLAYER_PED_ID(), 134217728, 16);
			return 1;
		}
	}
	else
...
int func_448(var uParam0)
{
	...
	if (BRAIN::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 1630799643) > 1)
	{
		if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_3, sLocal_247, &(uParam0->f_7), 3))
		{
			uParam0->f_11 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_303, iLocal_304));
			BRAIN::TASK_AIM_GUN_AT_ENTITY(uParam0->f_3, PLAYER::PLAYER_PED_ID(), -1, 1);
			return 1;
		}
	}
	else
...
int func_449(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, sParam1, sParam2, func_451(iParam3), 0);
}
...
int func_452(var uParam0, char* sParam1, int iParam2)
{
	if (uParam0->f_2 == 0)
	{
		if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_3, sLocal_247, sParam1, 3))
		{
			...
			BRAIN::TASK_PLAY_ANIM(uParam0->f_3, sLocal_247, &(uParam0->f_7), 8f, -1f, -1, 0, iParam2, 0, 0, 0);
		}
		else
		{
			return 1;
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_302(1, 1093140480, 0))
			{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_94.f_28[0], sLocal_239, 2, func_638(49), 0);
				}
				if (func_56(Local_94.f_41[0]))
				{
...
void func_467(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)
{
...
int func_471(var uParam0, int iParam1, char* sParam2, int iParam3)
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
int func_473(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4)
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
bool func_476(vector3 vParam0, int iParam1)
{
	return func_477(Global_95814.f_2875.f_12.f_66, vParam0, iParam1);
}

int func_477(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_479(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_95814.f_4))
	{
		...
		{
			if (func_505(24) != Global_95814.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_502(ENTITY::GET_ENTITY_COORDS(Global_95814.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_480(Global_95814.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}

void func_480(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
...
void func_481(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_497(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_105220.f_32546.f_4801 = func_363();
			}
...
void func_482(int iParam0, int iParam1)
{
	...
	func_324(iParam0, &(Global_105220.f_32546.f_5510));
}

int func_483(int iParam0)
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_329(iParam0, 0, 0)) || func_329(iParam0, 1, 0)) || func_329(iParam0, 2, 0)) || func_320(iParam0) != 145) || func_496(iParam0)) || func_495(iParam0)) || func_494(iParam0)) || func_493(iParam0)) || !func_484(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_495(iParam0))
		{
		}
...
void func_498(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_497(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_500(iParam0);
			func_499(uParam1, &(Global_105220.f_32546.f_69[Global_69800.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_502(vector3 vParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
...
int func_503(vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_506(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	func_507(vParam0, vParam1, fParam2, vParam3, fParam4, vParam5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

void func_507(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_509(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_510(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	switch (*iParam0)
	{
		case 0:
			...
			*iParam0 = 1;
			if (func_56(Local_94.f_28[0]))
			{
				...
				if (func_56(PLAYER::PLAYER_PED_ID()))
				{
					BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_94.f_28[0], -1, 0, 2);
				}
			}
			break;
		...
		case 1:
			if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_247) && !func_23())
			{
				...
				{
					BRAIN::TASK_PLAY_ANIM(Local_94.f_28[0], sLocal_247, "lead_in", 8f, -4f, -1, 2, 0, 0, 0, 0);
					BRAIN::TASK_LOOK_AT_ENTITY(Local_94.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
					*iParam0 = 2;
...
int func_517(char* sParam0, int iParam1)
{
	int iVar0;
	...
	if (func_56(PLAYER::PLAYER_PED_ID()))
	{
		if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 189.1399f, -955.8049f, 29.09192f, 187.5274f, -955.0106f, 31.09192f, 2.5f, 0, true, 0))
			{
				...
				if (func_56(Local_94.f_28[0]))
				{
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_94.f_28[0], 0);
				}
			}
		}
	}
...
int func_522(var uParam0)
{
	...
	if (func_524(PLAYER::PLAYER_PED_ID(), vVar0, 1) < fLocal_282)
	{
		return 0;
	}
	if (bLocal_299)
	{
		if (func_523(vVar0, fVar2, PLAYER::PLAYER_PED_ID(), 1))
		{
			return 0;
		}
	}
...
bool func_523(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
...
Vector3 func_525(vector3 vParam0, float fParam1, float fParam2)
{
	vector3 vVar0;
	float fVar1;
	...
	fVar1 = (fParam2 / 2f);
	vVar0 = { func_526(vVar0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1)) };
	vVar0.z = MISC::GET_RANDOM_FLOAT_IN_RANGE(-fVar1, fVar1);
	return vParam0 + vVar0;
}

Vector3 func_526(vector3 vParam0, float fParam1)
{
	float fVar0;
...
int func_528(var uParam0)
{
	...
	if (uParam0->f_9 == 0)
	{
		if (func_538(uParam0->f_3, PLAYER::PLAYER_PED_ID(), 1) < fLocal_288 || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_3, PLAYER::PLAYER_PED_ID(), 1))
		{
	...
	if (bLocal_117)
	{
		if (uParam0->f_9 == 0)
		{
			func_537(ENTITY::GET_ENTITY_COORDS(uParam0->f_3, 1), fLocal_288, 255, 0, 0, 255, 32);
		}
		else
		{
			func_537(ENTITY::GET_ENTITY_COORDS(uParam0->f_3, 1), fLocal_288, 0, 0, 255, 255, 32);
		}
	}
	switch (uParam0->f_2)
	{
		...
		case 10:
			...
			if (func_406(&iVar0))
			{
				...
				if (func_533(&(Local_250[uParam0->f_14 /*19*/]), uParam0->f_3, 1))
				{
					...
					BRAIN::CLEAR_PED_TASKS(Local_250[uParam0->f_14 /*19*/].f_3);
					BRAIN::OPEN_SEQUENCE_TASK(&iVar2);
					BRAIN::TASK_VEHICLE_TEMP_ACTION(0, uParam0->f_3, 32, uParam0->f_11);
					if (uParam0->f_13 == 1)
					{
						BRAIN::TASK_VEHICLE_TEMP_ACTION(0, uParam0->f_3, 5, uParam0->f_12);
					}
					else if (uParam0->f_13 == -1)
					{
						BRAIN::TASK_VEHICLE_TEMP_ACTION(0, uParam0->f_3, 4, uParam0->f_12);
					}
					BRAIN::CLOSE_SEQUENCE_TASK(iVar2);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_250[uParam0->f_14 /*19*/].f_3, iVar2);
		...
		case 11:
			...
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_250[uParam0->f_14 /*19*/].f_3, 242628503) == 7)
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iVar5);
					BRAIN::TASK_LEAVE_VEHICLE(0, uParam0->f_3, 0);
					BRAIN::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
					BRAIN::CLOSE_SEQUENCE_TASK(iVar5);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_250[uParam0->f_14 /*19*/].f_3, iVar5);
			...
			{
				BRAIN::TASK_EVERYONE_LEAVE_VEHICLE(uParam0->f_3);
				uParam0->f_6 = (MISC::GET_GAME_TIMER() + iVar4);
				uParam0->f_2 = 12;
			}
			break;
		...
		case 12:
			if (bLocal_301 == 0 && iLocal_529)
			{
				...
				{
					if (func_538(PLAYER::PLAYER_PED_ID(), uParam0->f_3, 1) < 50f)
					{
						func_531();
					}
				}
			...
			if (func_406(&iVar0))
			{
				if (func_533(&(Local_250[iVar0 /*19*/]), uParam0->f_3, 0))
				{
					...
					BRAIN::TASK_LEAVE_VEHICLE(0, uParam0->f_3, 256);
					BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vVar6, PLAYER::PLAYER_PED_ID(), 1f, true, 1.5f, 2f, true, 0, 0, -957453492, 20000);
					BRAIN::CLOSE_SEQUENCE_TASK(iVar7);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_250[iVar0 /*19*/].f_3, iVar7);
...
int func_530(vector3 vParam0, float fParam1)
{
	int iVar0;
...
int func_532(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
...
int func_535(int iParam0, bool bParam1, int iParam2)
{
	int iVar0;
...
void func_537(vector3 vParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	float fVar1;
	vector3 vVar2;
	...
	while (iVar0 <= iParam6)
	{
		...
		GRAPHICS::_0x7FDFADE676AA3CB0(vVar2, vVar3, iParam2, iParam3, iParam4, iParam5);
		vVar2 = { vVar3 };
		fVar4 = (fVar4 + fVar1);
		iVar0++;
	}
...
void func_543(var uParam0)
{
	...
	if (!func_554(uParam0))
	{
		if ((ENTITY::IS_ENTITY_DEAD(uParam0->f_3, 0) || PED::IS_PED_INJURED(uParam0->f_3)) || PED::IS_PED_DEAD_OR_DYING(uParam0->f_3, 0))
		{
			...
			func_553("CLOWN_DEATH", "CLOWNS", ENTITY::GET_ENTITY_COORDS(uParam0->f_3, 1), 10);
			uParam0->f_2 = 15;
	...
	switch (uParam0->f_2)
	{
		...
		case 12:
			...
			if (func_552(uParam0) == 4 && BRAIN::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 242628503) <= 1)
			{
				return;
			}
...
int func_545(var uParam0, char* sParam1, float fParam2, float fParam3, int iParam4)
{
...
void func_546(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 0)
	{
		...
		BRAIN::TASK_PLAY_ANIM(uParam0->f_3, sLocal_519, &(uParam0->f_7), 8f, -4f, -1, 0, 0.625f, 0, 0, 0);
	}
	else
	{
		StringCopy(&(uParam0->f_7), "clown_idle_", 16);
		StringIntConCat(&(uParam0->f_7), MISC::GET_RANDOM_INT_IN_RANGE(0, 6), 16);
		BRAIN::TASK_PLAY_ANIM(uParam0->f_3, sLocal_247, &(uParam0->f_7), 8f, -1f, -1, 0, 0, 0, 0, 0);
	}
}
...
void func_547(var uParam0)
{
	...
	if (BRAIN::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 242628503) != 1)
	{
		BRAIN::OPEN_SEQUENCE_TASK(&iVar0);
		if (func_538(uParam0->f_3, uParam0->f_15, 0) <= 5f)
		{
			BRAIN::TASK_AIM_GUN_AT_ENTITY(0, uParam0->f_15, MISC::GET_RANDOM_INT_IN_RANGE(250, 500), 0);
			BRAIN::TASK_SHOOT_AT_ENTITY(0, uParam0->f_15, MISC::GET_RANDOM_INT_IN_RANGE(250, 500), -957453492);
		}
		BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, uParam0->f_15, uParam0->f_15, 2f, 1, 3f, 4.5f, 1, 0, -957453492);
		BRAIN::TASK_COMBAT_PED(0, uParam0->f_15, 67108864, 16);
...
int func_550(int iParam0, var uParam1, float fParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_553(char* sParam0, char* sParam1, vector3 vParam2, int iParam3)
{
	AUDIO::_PLAY_AMBIENT_SPEECH_AT_COORDS(sParam0, sParam1, vParam2, func_451(iParam3));
}
		...
		case 2:
			if (func_56(PLAYER::PLAYER_PED_ID()))
			{
				if (func_56(Local_522[iParam0 /*11*/]))
				{
					...
					BRAIN::TASK_SMART_FLEE_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_522[iParam0 /*11*/], vVar0), 200f, -1, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iVar1);
					BRAIN::CLEAR_PED_TASKS(Local_522[iParam0 /*11*/]);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_522[iParam0 /*11*/], iVar1);
...
void func_557(int iParam0)
{
	if (Local_522[iParam0 /*11*/].f_1 == iLocal_511)
	{
		...
		{
			BRAIN::TASK_PLAY_ANIM(Local_522[iParam0 /*11*/], sLocal_517, sLocal_518, 8f, -8f, -1, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.5f), 0, 0, 0);
		}
	}
	else if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_522[iParam0 /*11*/], sLocal_515, sLocal_516, 3))
	{
		BRAIN::TASK_PLAY_ANIM(Local_522[iParam0 /*11*/], sLocal_515, sLocal_516, 8f, -8f, -1, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.5f), 0, 0, 0);
	}
}
	...
	if (Global_71232 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_566(Global_71233, Global_71235, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
int func_575(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (((!func_577(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_562(0)) || func_576(1))
			{
			}
			else
			{
...
{
	return func_579(iParam0, Global_35905);
}
...
void func_582(vector3 vParam0, float fParam1, var uParam2, var uParam3)
{
	vector3 vVar0;
...
void func_590(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_601())
	{
	...
	switch (iLocal_80)
	{
		...
		case 3:
			if (func_56(uParam0->f_28[0]))
			{
				...
				BRAIN::TASK_PLAY_ANIM(uParam0->f_28[0], uParam0->f_48, uParam0->f_48.f_1, 8f, -8f, -1, 9, 0, 0, 0, 0);
...
int func_594(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
...
int func_595(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_600(var uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
struct<8> func_614(struct<8> Param0, float fParam1)
{
	struct<8> Var0;
	vector3 vVar1;
...
void func_615(var uParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	*(uParam0[0 /*3*/]) = { vParam1 };
	*(uParam0[1 /*3*/]) = { vParam2 };
	uParam0->f_7 = fParam3;
...
void func_621(bool bParam0)
{
	...
	if (!func_633())
	{
		...
		{
			func_226(iVar0, 1, 0);
			func_622(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_104307[iVar0 /*10*/].f_9 == -1)
...
int func_624()
{
	...
	iVar0 = func_377(&(Global_92955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_626()
{
	...
	{
		if (func_374(&(Global_92955.f_3)) > -1)
		{
			return 1;
		}
	}
