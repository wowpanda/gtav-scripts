...
int func_2()//Position - 0x12E
{
	...
	while (iVar0 < iLocal_233)
	{
		...
		{
			vVar3 = { unk_0x8000C77B5F336760(iLocal_233[iVar0], true) };
		...
		switch (iLocal_234[iParam1])
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, &Local_297, &(Local_307[iParam1 /*16*/]), 2))
				{
					...
					{
						fVar2 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_16221);
						if (fVar2 > fVar0)
						{
							...
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, vLocal_243 + vLocal_246[iParam1 /*3*/], fVar3, 4294967295, (fLocal_248[iParam1] * 0.1f), 0, 1193033728);
				...
				else
				{
					...
					if (MISC::IS_STRING_NULL_OR_EMPTY(&(Local_308[iParam1 /*16*/])))
					{
						...
						{
							vVar5 = { unk_0x8000C77B5F336760(iParam0, true) };
						...
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, vLocal_243 + vLocal_246[iParam1 /*3*/], 1f, 4294967295, 1048576000, 0, 1193033728);
						iLocal_234[iParam1] = 1;
					}
					else
					{
						...
						if (iLocal_240[0] == joaat("p_trev_rope_01_s") || iLocal_240[1] == joaat("p_trev_rope_01_s"))
						{
							...
							ENTITY::SET_ENTITY_HEALTH(iLocal_233[iParam1], true);
							...
							unk_0x65E471E4A2D56226(iLocal_233[iParam1], ENTITY::GET_ENTITY_MAX_HEALTH(iLocal_233[iParam1]), 0);
			...
			case 10:
				...
				switch (iLocal_236[iParam1])
				{
					...
					case 0:
						...
						BRAIN::TASK_LOOK_AT_ENTITY(iLocal_233[iParam1], AUDIO::_0x0626A247D2405330(), iVar15, 0, 2);
				...
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_233[iParam1], AUDIO::_0x0626A247D2405330(), 1))
				{
				}
				bVar16 = false;
		...
		if (ENTITY::DOES_ENTITY_EXIST(iParam0))
		{
			...
			while (iVar27 < iLocal_239)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_239[iVar27]))
				{
					...
					unk_0x346478B12F69D4E3(iLocal_239[iVar27], false);
...
int func_23(int iParam0)//Position - 0x1650
{
	...
	if (iLocal_66 == 237)
	{
		fVar1 = SYSTEM::VDIST2(unk_0x8000C77B5F336760(iParam0, false), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false));
		if (fVar1 < (10f * 10f))
		{
			return 1;
		}
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_16221))
		{
			...
			while (iVar0 < iLocal_233)
			{
				if (!PED::IS_PED_INJURED(iLocal_233[iVar0]))
				{
					...
					BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_233[iVar0], Global_16221, &Local_297, &(Local_307[iVar0 /*16*/]), 1000f, fVar1, iVar2, iVar3, fVar4, iVar5);
					iLocal_234[iVar0] = 0;
				}
				iVar0++;
			}
			...
			while (iVar0 < iLocal_239)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_239[iVar0]))
				{
					...
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_239[iVar0], Global_16221, &(Local_312[iVar0 /*16*/]), &Local_297, 8f, -1000f, 0, 1148846080);
					}
				}
				iVar0++;
			}
...
int func_32()//Position - 0x1B98
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_16220))
	{
		...
		while (iVar0 < iLocal_233)
		{
			if (!PED::IS_PED_INJURED(iLocal_233[iVar0]))
			{
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_233[iVar0], Global_16220, &Local_297, &(Local_306[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_239)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_239[iVar0]))
			{
				...
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_239[iVar0], Global_16220, &(Local_311[iVar0 /*16*/]), &Local_297, 8f, -1000f, 0, 1148846080);
				}
			}
			iVar0++;
		}
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_318))
		{
			func_21(&uLocal_67, 2, AUDIO::_0x0626A247D2405330(), "TREVOR", 0, 1);
...
int func_33(int iParam0, int iParam1)//Position - 0x1C94
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_34(Global_16B5A) && iParam1 != 0)
		{
			Global_16B5A = 0;
		}
	}
...
void func_41()//Position - 0x1E44
{
	...
	while (iVar0 < iLocal_233)
	{
		if (iLocal_235[iVar0] != 0)
		{
			...
			BRAIN::TASK_PLAY_ANIM(iLocal_233[iVar0], &Local_297, &(Local_306[iVar0 /*16*/]), 8f, -8f, 4294967295, 1, 0f, 0, 0, 0);
		}
		iVar0++;
	}
	iVar0 = 0;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[0];
			StringCopy(sParam2, func_51(Global_19E56.f_933.f_21B.f_8F6[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[1];
			StringCopy(sParam2, func_51(Global_19E56.f_933.f_21B.f_8F6[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[2];
			StringCopy(sParam2, func_51(Global_19E56.f_933.f_21B.f_8F6[2]), 32);
			return 1;
			break;
