...
void func_1()//Position - 0xBF
{
	...
	switch (iLocal_36)
	{
		case 0:
			...
			if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
			{
				...
				while (iVar1 <= 5)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_1994C.f_E1[iVar1]))
					{
						uLocal_221[iVar1] = Global_1994C.f_E1[iVar1];
						Global_1994C.f_E1[iVar1] = 0;
						...
						if (!PED::IS_PED_INJURED(uLocal_221[iVar1]))
						{
							...
							ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_221[iVar1], 1);
				...
				while (iVar1 <= 1)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_1994C.f_DE[iVar1]))
					{
						uLocal_220[iVar1] = Global_1994C.f_DE[iVar1];
						Global_1994C.f_DE[iVar1] = 0;
	...
	while (iVar1 <= 5)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_221[iVar1]))
		{
			...
			else if (func_6(uLocal_221[iVar1], func_7(func_8()), 1) > 100f && func_5(AUDIO::_0x0626A247D2405330(), uLocal_221[iVar1], 1) > 300f)
			{
				func_4();
			}
...
void func_9()//Position - 0x6C1
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_221[iVar0]) && !PED::IS_PED_INJURED(uLocal_221[iVar0]))
		{
			...
			if (uLocal_222[iVar0] > 0)
			{
				...
				if (iVar3 == joaat("weapon_molotov"))
				{
					...
					{
						WEAPON::GIVE_WEAPON_TO_PED(uLocal_221[iVar0], joaat("weapon_microsmg"), 4294967295, true, true);
					}
				}
			}
			switch (uLocal_222[iVar0])
			{
				...
				case 1:
					...
					{
						BRAIN::TASK_COMBAT_PED(uLocal_221[iVar0], AUDIO::_0x0626A247D2405330(), 0, 16);
					}
					break;
				...
				case 2:
					...
					{
						BRAIN::TASK_SMART_FLEE_PED(uLocal_221[iVar0], AUDIO::_0x0626A247D2405330(), 1000f, 4294967295, 1, 0);
					}
					break;
				}
		}
	...
	switch (iLocal_211)
	{
		case 0:
			...
			{
				iVar4 = func_30();
				if (iVar4 != 4294967295 && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(uLocal_221[iVar4]))
				{
		...
		case 3:
			if ((func_31() && (MISC::GET_GAME_TIMER() - iLocal_212) > 3000) && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(AUDIO::_0x0626A247D2405330()))
			{
				func_28(AUDIO::_0x0626A247D2405330(), "BLIND_RAGE", 10);
				iLocal_211++;
			}
			break;
...
int func_30()//Position - 0x1496
{
	...
	while (iVar1 <= 5)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_221[iVar1]) && !PED::IS_PED_INJURED(uLocal_221[iVar1]))
		{
			fVar3 = func_5(uLocal_221[iVar1], AUDIO::_0x0626A247D2405330(), 1);
...
void func_33(int iParam0, vector3 vParam1)//Position - 0x1576
{
	...
	if (!func_36(vParam1))
	{
		...
		else if (BRAIN::GET_SCRIPT_TASK_STATUS(iParam0, 3641635208) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iParam0, 3641635208) != 0)
		{
			BRAIN::TASK_SHOOT_AT_COORD(iParam0, vParam1, 4294967295, 3607063905);
		}
	}
	else if (BRAIN::GET_SCRIPT_TASK_STATUS(iParam0, 3312640106) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(iParam0, 3312640106) != 0)
	{
...
int func_37(int iParam0)//Position - 0x17ED
{
	...
	if (((((((((((func_38(Global_1994C.f_23, 134217728) || PED::_CAN_PED_SEE_PED(uLocal_221[iParam0], AUDIO::_0x0626A247D2405330())) || PLAYER::CAN_PED_HEAR_PLAYER(CAM::_0xDC9DA9E8789F5246(), uLocal_221[iParam0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uLocal_221[iParam0])) || MISC::IS_BULLET_IN_AREA(unk_0x8000C77B5F336760(uLocal_221[iParam0], true), 15f, 1)) || MISC::HAS_BULLET_IMPACTED_IN_AREA(unk_0x8000C77B5F336760(uLocal_221[iParam0], true), 15f, 1, 1)) || FIRE::IS_EXPLOSION_IN_SPHERE(21, unk_0x8000C77B5F336760(uLocal_221[iParam0], true), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(10, unk_0x8000C77B5F336760(uLocal_221[iParam0], true), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(7, unk_0x8000C77B5F336760(uLocal_221[iParam0], true), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(0, unk_0x8000C77B5F336760(uLocal_221[iParam0], true), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(1, unk_0x8000C77B5F336760(uLocal_221[iParam0], true), 15f)) || iLocal_219)
	{
		return 1;
	}
	return 0;
...
void func_39()//Position - 0x1969
{
	...
	while (iVar0 <= 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_220[iVar0]) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(uLocal_220[iVar0], 0))
		{
			iVar2 = 0;
			while (iVar2 <= 5)
			{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_221[iVar0]) && !PED::IS_PED_INJURED(uLocal_221[iVar0]))
		{
			switch (uLocal_222[iVar0])
			{
				...
				case 1:
					...
					else
					{
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_221[iVar0], 0))
						{
							...
							if (bVar5)
							{
								if (iLocal_215 == 4294967295 && func_40(uLocal_221[iVar0], 0) == 4294967295)
								{
									iLocal_215 = iVar0;
								}
								uLocal_222[iVar0]++;
				...
				case 2:
					...
					if ((((((((iLocal_215 == 4294967295 || !ENTITY::DOES_ENTITY_EXIST(uLocal_221[iLocal_215])) || PED::IS_PED_INJURED(uLocal_221[iLocal_215])) || !ENTITY::DOES_ENTITY_EXIST(iVar7)) || !OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iVar7, 0)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iVar7, 0, 1)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iVar7, 1, 1)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iVar7, 4, 1)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iVar7, 5, 1))
					{
						iVar8 = 4294967295;
						bVar9 = false;
						iVar4 = 0;
						while (iVar4 <= 5)
						{
							...
							{
								if (func_40(uLocal_221[iVar4], 0) == 4294967295)
								{
			...
			switch (uLocal_222[iVar0])
			{
				...
				case 1:
					...
					else if (!PED::IS_PED_IN_VEHICLE(uLocal_221[iVar0], uLocal_220[Local_37[iVar0 /*10*/].f_8], 0))
					{
						...
						else if (!func_32(uLocal_221[iVar0], 2500551826, 1))
						{
							BRAIN::TASK_ENTER_VEHICLE(uLocal_221[iVar0], uLocal_220[Local_37[iVar0 /*10*/].f_8], 4294967295, Local_37[iVar0 /*10*/].f_9, 2f, 1, 0);
						}
					}
					else if (!func_32(uLocal_221[iVar0], 538064912, 1))
					{
						BRAIN::TASK_VEHICLE_SHOOT_AT_PED(uLocal_221[iVar0], AUDIO::_0x0626A247D2405330(), 1101004800);
					}
					break;
				...
				case 2:
					if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_221[iVar0], 0))
					{
						if (iLocal_215 == iVar0)
						{
							if (func_40(uLocal_221[iVar0], 0) != 4294967295)
							{
								if (!func_32(uLocal_221[iVar0], 355471868, 1))
								{
									BRAIN::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(uLocal_221[iVar0], PED::GET_VEHICLE_PED_IS_IN(uLocal_221[iVar0], 0), 0);
								}
							}
							else if (!func_32(uLocal_221[iVar0], 3021937204, 1) || iLocal_215 != iLocal_216)
							{
								BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_221[iVar0], PED::GET_VEHICLE_PED_IS_IN(uLocal_221[iVar0], 0), AUDIO::_0x0626A247D2405330(), 8, 40f, 786468, 1000f, 0f, 1);
							}
							else if (BRAIN::GET_SCRIPT_TASK_STATUS(uLocal_221[iVar0], 3021937204) == 1)
							{
								if (!BRAIN::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(uLocal_221[iVar0]))
								{
									BRAIN::TASK_DRIVE_BY(uLocal_221[iVar0], AUDIO::_0x0626A247D2405330(), 0, 0f, 0f, 0f, 1000f, 100, 1, 3541198322);
								}
							}
						}
						else if (func_40(uLocal_221[iVar0], 0) == 4294967295)
						{
							if (!func_32(uLocal_221[iVar0], 3021937204, 1) || iLocal_215 != iLocal_216)
							{
								BRAIN::TASK_VEHICLE_ESCORT(uLocal_221[iVar0], PED::GET_VEHICLE_PED_IS_IN(uLocal_221[iVar0], 0), PED::GET_VEHICLE_PED_IS_IN(uLocal_221[iLocal_215], 0), 4294967295, 40f, 786468, -1f, 20, 20f);
							}
							else if (BRAIN::GET_SCRIPT_TASK_STATUS(uLocal_221[iVar0], 3021937204) == 1)
							{
								if (!BRAIN::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(uLocal_221[iVar0]))
						...
						{
							iVar11 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(PED::GET_VEHICLE_PED_IS_IN(uLocal_221[iVar0], 0), 4294967295, 0);
	...
	switch (iLocal_211)
	{
		case 0:
			...
			{
				iVar12 = func_30();
				if (iVar12 != 4294967295 && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(uLocal_221[iVar12]))
				{
...
void func_48()//Position - 0x24A6
{
	...
	{
		case 0:
			func_54(&uLocal_46, 0, AUDIO::_0x0626A247D2405330(), "MICHAEL", 0, 1);
			break;
		
		case 1:
			func_54(&uLocal_46, 1, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
			break;
		
		case 2:
			func_54(&uLocal_46, 2, AUDIO::_0x0626A247D2405330(), "TREVOR", 0, 1);
			break;
	}
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_224, 2761840924);
	switch (iVar0)
	{
		case 0:
		...
		case 1:
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, 3261945386);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_224, 3261945386);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, 3261945386, iLocal_224);
			break;
...
{
	return func_53(Global_1994C.f_14, Global_1994C.f_1D);
}
...
void func_55()//Position - 0x2F72
{
	...
	while (iVar0 <= 5)
	{
		...
		{
			if (!PED::IS_PED_INJURED(uLocal_221[iVar0]) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				BRAIN::TASK_SMART_FLEE_PED(uLocal_221[iVar0], AUDIO::_0x0626A247D2405330(), 1000f, 4294967295, 0, 1);
			}
