	...
	switch (iLocal_87)
	{
		case 0:
			...
			if (func_297(iLocal_83))
			{
				...
				{
					BRAIN::TASK_PLAY_ANIM(iLocal_83, "rcmabigail", "loop_2_cs", 8f, -8f, -1, 2, 0, 0, 0, 0);
		...
		case 4:
			if (CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				...
				if (func_297(PLAYER::PLAYER_PED_ID()) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
				{
					...
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), -1606.534f, 5253.981f, 2.9994f, 1f, 20000, 0.25f, 0, 1193033728);
					BRAIN::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), -1602.62f, 5260.37f, 1.41f, -1, 0, 2);
				}
				if (func_297(iLocal_83) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Abigail", 0))
				{
					BRAIN::CLEAR_PED_TASKS(iLocal_83);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_83, -1581.559f, 5198.014f, 3.0091f, 1f, 20000, 0.25f, 0, 1193033728);
				}
			}
			else
			{
		...
		case 5:
			...
			if (func_218(1000) || MISC::GET_GAME_TIMER() > iLocal_86)
			{
				...
				{
					BRAIN::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
					BRAIN::TASK_LOOK_AT_COORD(PLAYER::PLAYER_PED_ID(), -1602.62f, 5260.37f, 1.41f, 5000, 0, 2);
				}
				func_3();
			}
...
void func_227(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_95814.f_4))
	{
		...
		{
			if (func_275(24) != Global_95814.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_272(ENTITY::GET_ENTITY_COORDS(Global_95814.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_228(Global_95814.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
void func_229(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_259(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_105220.f_32546.f_4801 = func_248();
			}
...
void func_230(int iParam0, int iParam1)
{
	...
	func_267(iParam0, &(Global_105220.f_32546.f_5510));
}
...
int func_259(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_266(Global_105220.f_32546.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_266(Global_105220.f_2354.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_266(Global_105220.f_2354.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_262(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_259(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_264(iParam0);
			func_263(uParam1, &(Global_105220.f_32546.f_69[Global_69800.f_555[0 /*21*/].f_14 /*78*/]));
	...
	if (Global_71232 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_306(Global_71233, Global_71235, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_317(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_303(0)) || func_316(1))
			{
			}
			else
			{
...
{
	return func_319(iParam0, Global_35905);
}
...
void func_334(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
int func_337(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
...
int func_339()
{
	...
	iVar0 = func_340(&(Global_92955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_343()
{
	...
	{
		if (func_338(&(Global_92955.f_3)) > -1)
		{
			return 1;
		}
	}
