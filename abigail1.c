...
void __EntryFunction__()
{
	...
	func_321(&uLocal_149, &(Local_88.f_28[0]));
	while (true)
	{
		WAIT(0);
		_0x208784099002BC30("SF_DAS", 0);
		func_305(Local_88.f_9, 0, 0, 0, 0, 0);
		func_1();
	}
}
...
void func_1()
{
	switch (iLocal_153)
	{
		case 0:
			func_298();
			if (func_297(uLocal_149))
			{
				if (IS_ENTITY_PLAYING_ANIM(uLocal_149, "rcmabigail", "loop_talk", 3) || IS_ENTITY_PLAYING_ANIM(uLocal_149, "rcmabigail", "loop_look", 3))
				{
					TASK_PLAY_ANIM(uLocal_149, "rcmabigail", "loop_2_cs", 8f, -8f, -1, 2, 0, 0, 0, 0);
					REMOVE_CUTSCENE();
					func_296(1);
					_REQUEST_CUTSCENE_EX("ABIGAIL_MCS_1_CONCAT", 2, 8);
					iLocal_153 = 1;
				}
				else
				{
		...
		case 1:
			func_293();
			if ((func_297(uLocal_149) && IS_ENTITY_PLAYING_ANIM(uLocal_149, "rcmabigail", "loop_2_cs", 3)) && GET_ENTITY_ANIM_CURRENT_TIME(uLocal_149, "rcmabigail", "loop_2_cs") > 0.99f)
			{
				iLocal_153++;
			}
			break;
		...
		case 2:
			...
			if (func_284(1, 1093140480, 0))
			{
				if (func_297(uLocal_149))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(uLocal_149, "ABIGAIL", 0, 0, 0);
				}
				func_283();
				START_CUTSCENE(2048);
		...
		case 4:
			if (IS_CUTSCENE_PLAYING())
			{
				...
				{
					uLocal_150 = CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
					SET_CAM_PARAMS(uLocal_150, -1606.249f, 5273.964f, 5.199186f, -1.633685f, 0f, -175.2748f, 30.16609f, 0, 1, 1, 2);
					SET_CAM_PARAMS(uLocal_150, -1605.681f, 5274.014f, 3.870102f, -2.089875f, 0f, -178.064f, 30.16609f, 10000, 1, 1, 2);
					RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
					SHAKE_CAM(uLocal_150, "HAND_SHAKE", 0.3f);
				}
				if (func_297(PLAYER_PED_ID()) && CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
				{
					_0x81CBAE94390F9F89();
					CLEAR_PED_TASKS(PLAYER_PED_ID());
					TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER_PED_ID(), -1606.534f, 5253.981f, 2.9994f, 1f, 20000, 1048576000, 0, 1193033728);
					TASK_LOOK_AT_COORD(PLAYER_PED_ID(), -1602.62f, 5260.37f, 1.41f, -1, 0, 2);
				}
				if (func_297(uLocal_149) && CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Abigail", 0))
				{
					CLEAR_PED_TASKS(uLocal_149);
					TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_149, -1581.559f, 5198.014f, 3.0091f, 1f, 20000, 1048576000, 0, 1193033728);
				}
			}
			else
			{
		...
		case 5:
			...
			if (func_218(1000) || GET_GAME_TIMER() > iLocal_152)
			{
...
int func_198()
{
	return func_199(GET_THIS_SCRIPT_NAME(), 0);
}
...
void func_208(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_212(PLAYER_ID())) && !func_210(PLAYER_ID(), 0)) && !func_209()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_212(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
...
void func_225(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	var uVar0;
	...
	if (IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_226(GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_227(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	vector3 vVar0;
	var uVar3;
	...
	if (DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_275(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_272(GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_228(Global_97130.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_228(int iParam0, vector3 vParam1, var uParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (DOES_ENTITY_EXIST(iParam0) && IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_262(iParam5, &Var0, vParam1, uParam4, func_265(iParam0));
		func_229(iParam5, iParam0, 0);
	}
}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_246(iParam0, 0, 0)) || func_246(iParam0, 1, 0)) || func_246(iParam0, 2, 0)) || func_265(iParam0) != 145) || func_245(iParam0)) || func_244(iParam0)) || func_243(iParam0)) || func_242(iParam0)) || !func_232(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_244(iParam0))
		{
		}
...
{
	return (SHIFT_RIGHT(uParam0, 26) & 31 * func_254(IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_262(int iParam0, var uParam1, vector3 vParam2, var uParam5, int iParam6)
{
	if (func_259(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
...
bool func_266(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
...
int func_269(var uParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
int func_272(vector3 vParam0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;
	
	iVar0 = func_273(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_273(vector3 vParam0, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_276(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	func_277(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_277(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, var uParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	var uVar0;
	bool bVar1;
	bool bVar2;
	...
	if (DOES_ENTITY_EXIST(uVar0))
	{
		...
		if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_279(uVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_279(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = { func_281(vParam1 - vParam4) };
		vVar3 = { vVar0 };
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
...
int func_284(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_291(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_290(PLAYER_PED_ID(), -828834893))
				{
...
int func_291(var uParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_293()
{
	if (func_297(PLAYER_PED_ID()))
	{
		...
		if (iLocal_154 == 0)
		{
			if (func_297(uLocal_149))
			{
				if (func_294(PLAYER_PED_ID(), uLocal_149, 1) < 4f || (GET_ENTITY_SPEED(PLAYER_PED_ID()) > 2f && func_294(PLAYER_PED_ID(), uLocal_149, 1) < 6f))
				{
...
float func_294(var uParam0, var uParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_299()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if (func_291(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
	...
	if (Global_71844 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_307(Global_71845, Global_71847, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_318(0) || Global_71859) || Global_71848 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_303(0)) || func_317(1))
			{
			}
			else
			{
...
void func_336(bool bParam0)
{
	...
	if (!func_353())
	{
		...
		{
			func_160(iVar0, 1, 0);
			func_337(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_105652[iVar0 /*10*/].f_9 == -1)
...
int func_338(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_344())
	{
		...
		{
			iVar33 = func_339(GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
