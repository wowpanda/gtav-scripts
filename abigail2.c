...
void __EntryFunction__()
{
	...
	if (func_456(Local_100.f_28[0]))
	{
		...
		SET_ENTITY_AS_MISSION_ENTITY(iLocal_169, 1, 1);
	}
	func_455();
	if (func_454())
	{
...
void func_9()
{
	switch (iLocal_168)
	{
		...
		case 1:
			...
			else if (func_226(PLAYER_PED_ID(), iLocal_169) > 250f)
			{
				if (GET_PLAYER_WANTED_LEVEL(GET_PLAYER_INDEX()) == 0)
				{
					iLocal_168 = 2;
			...
			else
			{
				...
				{
					TASK_SMART_FLEE_PED(iLocal_169, PLAYER_PED_ID(), 250f, -1, 0, 0);
				}
				if (iLocal_338 == 0)
				{
					if (((!func_223() && func_222(iLocal_169, PLAYER_PED_ID(), 20f, 1)) && !IS_PED_RAGDOLL(iLocal_169)) && func_210(&uLocal_173, "SONARAU", "SONAR_SHOOTS", 7, 0, 0, 0))
					{
						iLocal_338 = 1;
					}
				}
				else if (((((iLocal_346 < 15 && !func_223()) && (GET_GAME_TIMER() - iLocal_343) > 10000) && func_222(iLocal_169, PLAYER_PED_ID(), 20f, 1)) && !IS_PED_RAGDOLL(iLocal_169)) && func_210(&uLocal_173, "SONARAU", "SONAR_CHASE", 7, 0, 0, 0))
				{
...
bool func_222(int iParam0, var uParam1, float fParam2, int iParam3)
{
...
var func_227(var uParam0, var uParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_229()
{
	if (func_456(iLocal_169))
	{
		if ((GET_GAME_TIMER() - iLocal_352) > 1000)
		{
...
void func_230(var uParam0, var uParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	func_231(uParam0, uParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_231(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	uParam0->f_6 = 2;
	func_232(uParam0, uParam1, vParam2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_232(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
	...
	if (func_258(uParam1) && IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
		...
		if (!IS_GAMEPLAY_HINT_ACTIVE())
		{
			...
			{
				func_249(uParam0, uParam1, vParam2, iParam6);
			}
			if (*uParam0)
			{
				*uParam0 = 0;
...
int func_238(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_246() || func_245(Global_4456448.f_161209)) || func_244())
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			iVar1 = func_243(PLAYER_PED_ID(), 0);
			if (((_0xE33FFA906CE74880(uVar0, iVar1) || (GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_242(uVar0, 10)) && GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_239(int iParam0)
{
	if (iParam0 != func_241())
	{
		...
		else if ((Global_1312867 && iParam0 == PLAYER_ID()) && func_240(iParam0, 1, 0))
		{
			return Global_2424047[iParam0 /*416*/].f_309.f_5 != -1;
		}
	}
...
void func_249(var uParam0, var uParam1, vector3 vParam2, int iParam5)
{
	var uVar0;
	int iVar1;
	int iVar2;
...
bool func_252(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
...
int func_253(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_256(bParam1, bParam2, bParam3) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1) || func_254(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_260()
{
	if (!DOES_BLIP_EXIST(uLocal_170) && func_456(iLocal_169))
	{
		uLocal_170 = func_261(iLocal_169, 1, 0, 5);
	}
	if (DOES_BLIP_EXIST(uLocal_170) && GET_BLIP_COLOUR(uLocal_170) != 1)
	{
		SET_BLIP_AS_FRIENDLY(uLocal_170, 0);
		SET_BLIP_COLOUR(uLocal_170, 1);
	}
}
...
void func_262()
{
	switch (iLocal_168)
	{
		...
		case 1:
			...
			{
				if (((iLocal_340 == 0 && !func_223()) && func_222(iLocal_169, PLAYER_PED_ID(), 20f, 1)) && func_210(&uLocal_173, "SONARAU", "SONAR_ARRIVE", 7, 0, 0, 0))
				{
					iLocal_340 = 1;
					func_260();
				}
				if (func_226(PLAYER_PED_ID(), iLocal_169) > 250f)
				{
					iLocal_168 = 2;
				}
			}
			if ((iLocal_341 == 0 && iLocal_340 == 1) && !func_223())
			{
				if (func_456(iLocal_169))
				{
					...
					SET_PLAYER_WANTED_LEVEL(GET_PLAYER_INDEX(), 3, 0);
					SET_PLAYER_WANTED_LEVEL_NOW(PLAYER_ID(), 0);
				}
...
void func_264()
{
	...
	{
		case 0:
			uLocal_353 = ADD_SCENARIO_BLOCKING_AREA(Vector(2.99f, 5194.44f, -1578.62f) - Vector(10f, 10f, 10f), Vector(2.99f, 5194.44f, -1578.62f) + Vector(10f, 10f, 10f), 0, 1, 1, 1);
			func_292();
			if (func_456(iLocal_169))
			{
				func_290();
				if (func_3(iLocal_162))
				{
					...
					func_289(&uLocal_170, "", "", &iLocal_171, &iLocal_172, 1, 0);
					OPEN_SEQUENCE_TASK(&uLocal_344);
					if (!IS_PED_IN_VEHICLE(iLocal_169, iLocal_162, 0))
					{
						TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 1193033728);
						TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1567.85f, 5178.12f, 14.78f, 1f, 20000, 0.25f, 1, 1193033728);
						TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1571.85f, 5181.21f, 16.88f, 1f, 20000, 0.25f, 1, 1193033728);
						TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1579.01f, 5174.08f, 18.57f, 1f, 20000, 0.25f, 1, 1193033728);
						TASK_ENTER_VEHICLE(0, iLocal_162, 20000, -1, 1f, 1, 0);
					}
					TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(0, iLocal_162, vLocal_347, 20f, 786469, 10f);
					TASK_VEHICLE_PARK(0, iLocal_162, vLocal_347, 49.567f, 3, 1092616192, 0);
					TASK_LEAVE_VEHICLE(0, iLocal_162, 256);
					TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 250f, -1, 0, 0);
					CLOSE_SEQUENCE_TASK(uLocal_344);
					TASK_PERFORM_SEQUENCE(iLocal_169, uLocal_344);
				}
				else
				{
					TASK_WANDER_STANDARD(iLocal_169, 1193033728, 0);
				}
			}
		...
		case 1:
			...
			else if (IS_ENTITY_AT_COORD(iLocal_169, vLocal_347, 5f, 5f, 5f, 0, 1, 0))
			{
				func_228(3);
			}
			else
			{
				func_265(&uLocal_170, "", "", &iLocal_171, iLocal_172, 0);
				if (iLocal_339 == 0)
				{
					if (((func_456(iLocal_162) && IS_PED_IN_VEHICLE(iLocal_169, iLocal_162, 1)) && func_222(iLocal_169, PLAYER_PED_ID(), 20f, 1)) && func_210(&uLocal_173, "SONARAU", "SONAR_INCAR", 7, 0, 0, 0))
					{
						iLocal_339 = 1;
					}
					if (((((iLocal_345 < 7 && !func_223()) && (GET_GAME_TIMER() - iLocal_342) > 10000) && func_222(iLocal_169, PLAYER_PED_ID(), 20f, 1)) && !IS_PED_RAGDOLL(iLocal_169)) && func_210(&uLocal_173, "SONARAU", "SONAR_FOLLOW", 7, 0, 0, 0))
					{
						iLocal_342 = GET_GAME_TIMER();
						iLocal_345++;
					}
	...
	if (DOES_BLIP_EXIST(*uParam0))
	{
		if ((GET_GAME_TIMER() - *iParam3) > 500)
		{
			if (GET_BLIP_COLOUR(*uParam0) == 1)
			{
				...
				{
					if (!IS_MESSAGE_BEING_DISPLAYED() || func_266(sParam1, 0, 0))
					{
			...
			else
			{
				...
				if ((GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!IS_MESSAGE_BEING_DISPLAYED() || func_266(sParam2, 0, 0))
					{
...
int func_269()
{
	...
	if (func_456(iLocal_162))
	{
		...
		if (IS_PED_BEING_JACKED(iLocal_169))
		{
			return 1;
		}
		if (func_456(iLocal_162))
		{
			if (IS_PED_IN_VEHICLE(iLocal_169, iLocal_162, 0) && HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_162, PLAYER_PED_ID(), 1))
			{
				return 1;
			}
			if (((IS_VEHICLE_TYRE_BURST(iLocal_162, 0, 0) || IS_VEHICLE_TYRE_BURST(iLocal_162, 1, 0)) || IS_VEHICLE_TYRE_BURST(iLocal_162, 4, 0)) || IS_VEHICLE_TYRE_BURST(iLocal_162, 5, 0))
			{
				return 1;
			}
		}
...
int func_270(int iParam0, bool bParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	vector3 vVar0;
	
	if (func_456(PLAYER_PED_ID()) && func_456(iParam0))
	{
		...
		if (!IS_PED_ARMED(PLAYER_PED_ID(), 6))
		{
			if (IS_PED_IN_MELEE_COMBAT(PLAYER_PED_ID()))
			{
				...
				{
					return func_283(PLAYER_PED_ID(), iParam0, iParam2);
				}
			}
		}
		if (bParam4)
...
int func_271(int iParam0, float fParam1)
{
	...
	if (func_456(PLAYER_PED_ID()) && func_456(iParam0))
	{
		if (func_282(iParam0) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), iParam0))
		{
			if (IS_PED_ARMED(PLAYER_PED_ID(), 6))
			{
				fVar0 = 40f;
...
{
	return func_273(iParam0, PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
...
bool func_273(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_274(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_274(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_275(iParam4, iParam7) };
...
int func_277(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_279(GET_ENTITY_COORDS(iParam1, 1) - GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		vVar3 = { func_279(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_278(vVar3, vVar0);
...
float func_278(vector3 vParam0, vector3 vParam3)
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}
...
bool func_283(var uParam0, var uParam1, var uParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_284(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_456(PLAYER_PED_ID()) && func_456(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_288(uParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_285(uParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_285(var uParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_286(var uParam0, float fParam1)
{
	...
	{
		if (func_287(uParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_287(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_279(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_279(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_278(vVar3, vVar0);
...
int func_288(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (IS_PED_SHOOTING(PLAYER_PED_ID()))
...
void func_290()
{
	if (func_456(iLocal_169))
	{
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_169, 1);
		func_291(&uLocal_173, 3, iLocal_169, "ABIGAIL", 0, 1);
		SET_PED_FLEE_ATTRIBUTES(iLocal_169, 128, 1);
		SET_PED_FLEE_ATTRIBUTES(iLocal_169, 4, 1);
		SET_PED_FLEE_ATTRIBUTES(iLocal_169, 1024, 1);
		SET_PED_CONFIG_FLAG(iLocal_169, 281, 1);
		SET_PED_CONFIG_FLAG(iLocal_169, 29, 1);
		SET_PED_CONFIG_FLAG(iLocal_169, 116, 1);
		SET_PED_CONFIG_FLAG(iLocal_169, 118, 1);
		SET_PED_CAN_BE_TARGETTED(iLocal_169, 1);
		SET_PED_PATH_CAN_DROP_FROM_HEIGHT(iLocal_169, 0);
		SET_PED_PATH_CAN_USE_CLIMBOVERS(iLocal_169, 0);
	}
}
...
void func_292()
{
	if (!func_456(iLocal_162))
	{
		iLocal_162 = CREATE_VEHICLE(iLocal_161, vLocal_163, fLocal_166, 1, 1, 0);
		SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_161);
	}
	if (func_456(iLocal_162))
	{
		SET_VEHICLE_DOORS_LOCKED(iLocal_162, 3);
		SET_VEHICLE_COLOUR_COMBINATION(iLocal_162, 1);
		SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_161, 1);
		_0x2B6747FAA9DB9D6B(iLocal_162, 1);
	}
}
			...
			switch (iLocal_351)
			{
				case 0:
					if (func_347(1, 1093140480, 0))
					{
						if (func_456(iLocal_169))
						{
							REGISTER_ENTITY_FOR_CUTSCENE(iLocal_169, "ABIGAIL", 0, 0, 0);
						}
						func_346();
						START_CUTSCENE(0);
				...
				case 2:
					if (IS_CUTSCENE_PLAYING())
					{
						if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("ABIGAIL", func_491(16)) && func_456(iLocal_169))
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_169, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 1193033728);
						}
					...
					else
					{
						...
						if (iLocal_350 == 1)
						{
							if (func_456(iLocal_169))
							{
								CLEAR_PED_TASKS_IMMEDIATELY(iLocal_169);
								func_333(iLocal_169, -1587.11f, 5204.18f, 3.02f, 210.9196f, 0, 1);
								TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_169, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 1193033728);
								_0x2208438012482A1A(iLocal_169, 0, 0);
							}
...
void func_298(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_300() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_300() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_299(iParam0));
...
int func_302(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_300() /*10778*/].f_6165.f_10, iParam0);
}
...
void func_325(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_329(PLAYER_ID())) && !func_327(PLAYER_ID(), 0)) && !func_326()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_329(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
...
int func_333(var uParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
void func_335(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_336(GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_338(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	func_339(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_339(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, var uParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_343(iVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_343(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = { func_279(vParam1 - vParam4) };
		vVar3 = { vVar0 };
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_344(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_344(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_344(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_344(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_344(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_344(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_344(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_344(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_344(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_344(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_344(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_344(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_344(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_344(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_344(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_344(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return 1;
		}
	}
...
int func_347(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_351(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_224(PLAYER_PED_ID(), -828834893))
				{
...
int func_351(var uParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_354()
{
	...
	if ((!func_223() && HAS_ADDITIONAL_TEXT_LOADED(0)) && HAS_MODEL_LOADED(iLocal_161))
	{
		...
		if (func_456(Local_100.f_35[0]))
		{
			...
			SET_ENTITY_AS_MISSION_ENTITY(iLocal_162, 1, 1);
			SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_161);
		}
		iLocal_167 = 1;
	}
...
void func_356()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if (func_351(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
{
	if (((!func_374(0) || Global_71859) || Global_71848 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_248(0)) || func_373(1))
			{
			}
			else
			{
...
void func_377(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			func_383(-1595.201f, 5217.495f, 3.0009f, 208.2675f, -1580.236f, 5169.585f, 18.5846f, 189.4926f, -1587.11f, 5204.18f, 3.02f, -143.87f, vLocal_163, fLocal_166);
			func_228(2);
			break;
		
		case 2:
			func_383(0f, 0f, 0f, 0f, -1580.236f, 5169.585f, 18.5846f, 189.4926f, 0f, 0f, 0f, 0f, vLocal_163, fLocal_166);
			func_228(2);
			break;
	...
	if (!func_382())
	{
		func_380(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
	}
	func_379(0, -1, 1);
	func_378(1, 1, 1);
}
...
void func_380(vector3 vParam0, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	var uVar0;
	int iVar1;
...
void func_383(vector3 vParam0, float fParam3, vector3 vParam4, float fParam7, vector3 vParam8, float fParam11, vector3 vParam12, float fParam15)
{
	var uVar0;
	
	if (func_340(vParam0))
	{
		while (!func_388(&uVar0, 0, vParam4, fParam7, 1, 0))
		{
			WAIT(0);
		}
		SET_PED_INTO_VEHICLE(PLAYER_PED_ID(), uVar0, -1);
		func_387(&uVar0);
	}
	else if (!func_454())
	{
		func_333(PLAYER_PED_ID(), vParam0, fParam3, 0, 1);
	}
	REQUEST_MODEL(iLocal_161);
	while (!HAS_MODEL_LOADED(iLocal_161))
	{
		WAIT(0);
	}
	while (!func_384(&iLocal_169, 16, vParam8, fParam11, "RC ABIGAIL 2", 1))
	{
		WAIT(0);
	}
	iLocal_162 = CREATE_VEHICLE(iLocal_161, vParam12, fParam15, 1, 1, 0);
	SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_161, 1);
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_161);
	func_292();
	if (func_340(vParam8))
	{
		SET_PED_INTO_VEHICLE(iLocal_169, iLocal_162, -1);
	}
}

int func_384(var uParam0, int iParam1, vector3 vParam2, var uParam5, char* sParam6, int iParam7)
{
	if (func_385(uParam0, iParam1, vParam2, uParam5, 1))
	{
		if (DOES_ENTITY_EXIST(*uParam0))
		{
			if (!IS_ENTITY_DEAD(*uParam0, 0))
...
int func_385(var uParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	int iVar0;
...
int func_388(var uParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6, int iParam7)
{
	var uVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, uParam5, 0, 0, 0);
				...
				func_444(uParam0, &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, uParam5, 0, 0, 0);
				...
				func_444(uParam0, &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				SET_VEHICLE_ENVEFF_SCALE(*uParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (GET_ENTITY_MODEL(*uParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (HAS_MODEL_LOADED(Var5))
			{
				...
				*uParam0 = CREATE_VEHICLE(Var5, vParam2, uParam5, 1, 1, 0);
				...
				func_444(uParam0, &(Var5.f_31), &(Var5.f_81));
				SET_VEHICLE_ENVEFF_SCALE(*uParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_389(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	if ((func_159(iParam0) && DOES_ENTITY_EXIST(*uParam1)) && IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_394(*uParam1, 0, &uVar0))
		{
			func_393(uParam1, &(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_106565.f_20112[iParam0 /*43*/].f_31 = func_392(*uParam1);
...
int func_394(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_420(iVar0, bParam1, uParam2) && !func_419(PLAYER_ID())) && !func_403(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_401(PLAYER_ID()) && (IS_THIS_MODEL_A_HELI(iVar0) || IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((IS_BIG_VEHICLE(iParam0) && !func_399(iParam0)) && !bVar1) && !(func_398(GET_ENTITY_MODEL(iParam0)) && func_396(PLAYER_ID())))
	{
	...
	if (!NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_395(iParam0) && GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
{
	if (func_418(PLAYER_ID()) || func_417(PLAYER_ID()))
	{
		if (func_404(iParam0))
		{
			return 1;
...
int func_405(int iParam0)
{
	...
	if (func_406(GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_407(int iParam0, bool bParam1)
{
	switch (GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_409(GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_420(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_401(PLAYER_ID()) && (IS_THIS_MODEL_A_HELI(iParam0) || IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_341(iParam0, 0, 0)) || func_341(iParam0, 1, 0)) || func_341(iParam0, 2, 0)) || func_440(iParam0) != 145) || func_439(iParam0)) || func_438(iParam0)) || func_395(iParam0)) || func_437(iParam0)) || !func_427(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_438(iParam0))
		{
		}
...
int func_444(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_416(GET_ENTITY_MODEL(*uParam0), 1) && GET_VEHICLE_MOD(*uParam0, 24) != func_447(*uParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*uParam0, 24, func_447(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_446(uParam0);
	if (func_445(*uParam0))
	{
...
void func_457(int iParam0)
{
	func_7(&uLocal_88, 0, 0);
	SET_WANTED_LEVEL_MULTIPLIER(1f);
	SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_161, 0);
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_161);
	func_6(&uLocal_170);
	...
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_353, 0);
	if (iParam0 == 1)
	{
...
int func_471(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_477())
	{
		...
		{
			iVar33 = func_472(GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
