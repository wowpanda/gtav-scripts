	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != 4294967295)
		{
			if (Global_19AC5[Var0 /*10*/].f_9 != 4294967295)
			{
				...
				func_280(&(Global_19AC5[Var0 /*10*/].f_9));
			}
		}
		func_268(&Var0, 1);
	}
...
void func_47(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3759
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x38F9
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x392B
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x395F
{
	return Global_1407E0;
}

int func_51(int iParam0, int iParam1)//Position - 0x396B
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3997
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EDF
{
	int iVar0;
...
int func_54()//Position - 0x4121
{
	func_55();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_55()//Position - 0x413A
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x4237
{
	return Global_8D15 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x4245
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x4338
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x45C2
{
	switch (iParam0)
	{
		case 3036451504:
...
int func_61(int iParam0, int iParam1)//Position - 0x47E3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x5354
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x538F
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x5603
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x563F
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_66(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x5B9A
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5BDE
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x62BD
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x6304
{
...
bool func_70(int iParam0)//Position - 0x635F
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x636F
{
...
int func_72(int iParam0)//Position - 0x63D9
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x66DC
{
	return Global_6373;
}

int func_74(int iParam0)//Position - 0x66E7
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x66F7
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6799
{
	switch (iParam0)
	{
		case 4294967295:
...
int func_77(int iParam0)//Position - 0x6D6E
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6DCC
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6E7A
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6F0F
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6F53
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x70D7
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x70E5
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7BAC
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7C2E
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7C8C
{
	return 4294967295;
}

Vector3 func_87(int iParam0)//Position - 0x7C95
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x7EA0
{
	return func_89(CAM::_0xDC9DA9E8789F5246());
}

int func_89(int iParam0)//Position - 0x7EB0
{
	return MISC::GET_BITS_IN_RANGE(Global_24FBF9[iParam0 /*413*/].f_135.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x7ECD
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x7EDD
{
	switch (iParam0)
	{
		case 4294967295:
...
int func_139(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xAA2F
{
	int iVar0;
...
void func_141(int iParam0)//Position - 0xAA89
{
	if (iParam0 == 1)
	{
...
int func_142(char* sParam0)//Position - 0xAAAC
{
...
void func_143()//Position - 0xAAE9
{
	Global_3960 = 0;
	func_144();
}

void func_144()//Position - 0xAAF9
{
...
void func_147()//Position - 0xAB87
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
		{
			if (func_148(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_148(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xABDF
{
...
void func_149(int iParam0)//Position - 0xAD6E
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_152(int iParam0)//Position - 0xAE1E
{
	if (func_155())
	{
		return;
...
void func_153(bool bParam0, bool bParam1)//Position - 0xAE98
{
	if (bParam0)
	{
		if (func_154(0))
...
int func_154(int iParam0)//Position - 0xAF0C
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
int func_157(int iParam0)//Position - 0xAFB9
{
	int iVar0;
	...
	iVar0 = func_159(&(Global_19AC5[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
void func_158(int iParam0)//Position - 0xAFFE
{
...
int func_159(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB030
{
	int iVar0;
...
void func_160(var uParam0, int iParam1)//Position - 0xB167
{
	int iVar0;
...
bool func_161(int iParam0)//Position - 0xB1B6
{
	return func_162(iParam0, Global_8D15);
}

int func_162(int iParam0, int iParam1)//Position - 0xB1C7
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_163(int iParam0)//Position - 0xB3A8
{
	if (Global_8D15 == 15)
	{
		return 0;
...
int func_164()//Position - 0xB3CA
{
	return func_165(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_165(char* sParam0, int iParam1)//Position - 0xB3DB
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_167(int iParam0, int iParam1)//Position - 0xB448
{
	switch (iParam0)
	{
		case 0:
...
int func_168(vector3 vParam0, bool bParam1)//Position - 0xB8CF
{
	int iVar0;
...
float func_169(bool bParam0, float fParam1, float fParam2)//Position - 0xB8FB
{
	if (bParam0)
	{
		return fParam1;
...
int func_170(int iParam0)//Position - 0xB912
{
	switch (iParam0)
	{
		case 0:
...
int func_171(var uParam0, int iParam1)//Position - 0xB9A1
{
	switch (uParam0->f_10)
	{
		case 0:
			if (*uParam0 == 12)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, true, 0))
				{
					if (func_126(uParam0->f_1C[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(uParam0->f_1C[0], true), true) < 3f)
						{
							if (func_177(2))
							{
								if (func_175(uParam0->f_1B))
								{
									func_174(uParam0->f_1B, *uParam0);
				...
				else if (func_126(uParam0->f_1C[0]))
				{
					if (func_173(uParam0))
					{
						if (func_177(2))
...
void func_186(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xCB5C
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_190(AUDIO::_0x0626A247D2405330(), vParam2, 1) <= 100f)
				{
					func_189(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_190(AUDIO::_0x0626A247D2405330(), vParam2, 1) > 120f)
				{
					func_192(iParam0);
				}
			}
...
void func_187(int iParam0, bool bParam1)//Position - 0xCC4D
{
	if (iParam0 == 4294967295)
	{
		return;
...
int func_188(int iParam0)//Position - 0xCC89
{
	if (Global_11621 == iParam0)
	{
...
void func_189(int iParam0, int iParam1)//Position - 0xCCC2
{
	bool bVar0;
	int iVar1;
...
float func_190(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xCD60
{
	vector3 vVar0;
...
bool func_191()//Position - 0xCD9A
{
	return Global_1620C;
}

void func_192(int iParam0)//Position - 0xCDA6
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_193(iParam0);
...
void func_193(int iParam0)//Position - 0xCDBD
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_194(int iParam0)//Position - 0xCEA5
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_164();
...
int func_195(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xCECD
{
	var uVar0;
	
	if ((((func_126(AUDIO::_0x0626A247D2405330()) && func_126(iParam0->f_1C[0])) && !func_145()) && (MISC::GET_GAME_TIMER() - iParam0->f_3C) > iParam6) && func_190(AUDIO::_0x0626A247D2405330(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_198(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
...
void func_196(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCF55
{
...
void func_197(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCF90
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
void func_198(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCFE6
{
...
int func_199(var uParam0, bool bParam1)//Position - 0xD081
{
	struct<27> Var0;
	...
	if ((func_236(*uParam0) || func_234(*uParam0)) || Global_1171A == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_200(int iParam0, var uParam1, int iParam2)//Position - 0xD2F4
{
	int iVar0;
	int iVar1;
...
int func_201(int iParam0)//Position - 0xD64C
{
...
int func_202(var uParam0)//Position - 0xD66C
{
...
int func_203(var uParam0)//Position - 0xD684
{
...
void func_204(var uParam0)//Position - 0xD6A9
{
	int iVar0;
	int iVar1;
...
void func_205(int iParam0)//Position - 0xD9AD
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_206(var uParam0)//Position - 0xD9D8
{
	int iVar0;
...
int func_207(var uParam0, bool bParam1, bool bParam2)//Position - 0xDA58
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_208(AUDIO::_0x0626A247D2405330(), uParam0->f_23[iVar0]))
							{
...
int func_208(int iParam0, int iParam1)//Position - 0xDC16
{
	int iVar0;
...
int func_209(var uParam0, bool bParam1, int iParam2)//Position - 0xDC46
{
	int iVar0;
	int iVar1;
...
int func_210(int iParam0)//Position - 0xDF02
{
...
int func_211(int iParam0, float fParam1)//Position - 0xDF36
{
	float fVar0;
	
	if (func_126(AUDIO::_0x0626A247D2405330()) && func_126(iParam0))
	{
		if (func_222(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iParam0))
		{
...
bool func_212(int iParam0, float fParam1)//Position - 0xDFAC
{
	return func_213(iParam0, AUDIO::_0x0626A247D2405330(), fParam1, 1, 250, 7);
}

bool func_213(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDFC4
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_214(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE085
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_215(int iParam0, int iParam1)//Position - 0xE1B1
{
	int iVar0;
...
int func_217(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE2C0
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_219(unk_0x8000C77B5F336760(iParam1, true) - unk_0x8000C77B5F336760(iParam0, true)) };
...
float func_218(vector3 vParam0, vector3 vParam1)//Position - 0xE351
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_219(vector3 vParam0)//Position - 0xE372
{
	float fVar0;
	float fVar1;
...
void func_220(var uParam0)//Position - 0xE3B1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_221(int iParam0, int iParam1)//Position - 0xE3CC
{
	int iVar0;
...
int func_222(int iParam0)//Position - 0xE40B
{
...
int func_223(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE433
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_224(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE52E
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_225(int iParam0, float fParam1)//Position - 0xE63A
{
	var uVar0;
	vector3 vVar1;
...
int func_226(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xE6CF
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_219(vParam1 - unk_0x8000C77B5F336760(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_227(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE75D
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
...
int func_228(int iParam0)//Position - 0xE7A5
{
...
void func_229(int iParam0)//Position - 0xE7EF
{
	int iVar0;
...
int func_230(int iParam0)//Position - 0xE88C
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_164();
...
int func_231(int iParam0)//Position - 0xE924
{
...
int func_234(int iParam0)//Position - 0xE9A6
{
	if ((func_235() && Global_16C30.f_B == 6) && iParam0 == func_165(&(Global_16C30.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_236(int iParam0)//Position - 0xEA18
{
	if (func_107(0))
	{
...
int func_239(var uParam0)//Position - 0xEB11
{
	int iVar0[7];
	char* sVar1;
	int iVar2;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			{
				if (func_245(&(uParam0->f_1C[0]), 50, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
			...
			{
				func_243(&(uParam0->f_1C[1]), iVar0[3], -498.1656f, 228.6284f, 82.09948f, 292.9763f, 26);
			...
			{
				func_243(&(uParam0->f_1C[2]), iVar0[4], -498.309f, 227.9112f, 82.106f, 296.4216f, 26);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				func_241(&(uParam0->f_23[0]), iVar0[1], -497.99f, 224.97f, 82.67f, 266.5f);
				if (func_176(uParam0->f_23[0]))
				{
			...
			{
				func_241(&(uParam0->f_23[1]), iVar0[2], -501.55f, 230.7f, 83.1f, 233.93f);
				if (func_176(uParam0->f_23[1]))
				{
			...
			{
				func_240(&(uParam0->f_29[0]), iVar0[5], -490.11f, 233.15f, 82.1f, 0f);
				if (func_126(uParam0->f_1C[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[0]))
				{
			...
			{
				func_240(&(uParam0->f_29[1]), iVar0[6], -490.11f, 233.15f, 82.1f, 0f);
				if (func_126(uParam0->f_1C[1]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[1]))
				{
...
void func_240(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF0D4
{
	func_205(iParam0);
...
void func_241(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF0FB
{
	func_242(iParam0);
...
void func_242(int iParam0)//Position - 0xF13D
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_243(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0xF1D9
{
	func_244(iParam0);
	*iParam0 = PED::CREATE_PED(iParam4, iParam1, vParam2, fParam3, 0, false);
}

void func_244(int iParam0)//Position - 0xF1FA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_245(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xF23B
{
...
int func_246(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xF297
{
	int iVar0;
...
int func_247(var uParam0, int iParam1)//Position - 0xF325
{
	int iVar0;
...
int func_248(int iParam0)//Position - 0xF36B
{
	int iVar0;
...
int func_249(var uParam0)//Position - 0xF39C
{
	uParam0->f_10 = 3;
...
int func_250(var uParam0)//Position - 0xF3D0
{
	int iVar0[1];
	int iVar1;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			func_241(&(uParam0->f_23[0]), iVar0[0], 307.02f, 143.17f, 103.3f, 250.08f);
...
int func_251(var uParam0)//Position - 0xF4BB
{
	int iVar0[5];
	int iVar1[3];
	vector3 vVar2[3];
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (func_245(&(uParam0->f_1C[0]), 50, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_1C[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[0], 9, 1, 0, 0);
					ENTITY::SET_ENTITY_HEALTH(uParam0->f_1C[0], true);
			...
			if (func_125(uParam0->f_1C[0]))
			{
				...
				{
					func_240(&(uParam0->f_29[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_1C[0], 0f, 0f, 2.5f), 0f);
					if (func_126(uParam0->f_29[3]))
					{
		...
		case 3:
			if (func_126(uParam0->f_29[0]))
			{
				iLocal_54 = PED::CREATE_SYNCHRONIZED_SCENE(unk_0x8000C77B5F336760(uParam0->f_29[0], true), ENTITY::GET_ENTITY_ROTATION(uParam0->f_29[0], 2), 2);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_29[0], iLocal_54, "idle_closed_pap_3_rcm_dumpster", sVar4, 8f, -8f, 0, 1148846080);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_54, true);
				if (func_126(uParam0->f_1C[0]))
				{
					BRAIN::TASK_SYNCHRONIZED_SCENE(uParam0->f_1C[0], iLocal_54, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_126(uParam0->f_29[1]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_29[1], iLocal_54, "idle_closed_pap_3_rcm_lid_l", sVar4, 8f, -8f, 0, 1148846080);
				}
				if (func_126(uParam0->f_29[2]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_29[2], iLocal_54, "idle_closed_pap_3_rcm_lid_r", sVar4, 8f, -8f, 0, 1148846080);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
int func_252(var uParam0)//Position - 0xF9FA
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (func_245(&(uParam0->f_1C[0]), 50, -71.283f, 301.557f, 106.711f, 4.659f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_1C[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[0], 9, 1, 0, 0);
				}
			...
			if (func_125(uParam0->f_1C[0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[0]))
				{
					func_240(&(uParam0->f_29[0]), iVar0[2], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_1C[0], 0f, 0f, 2.5f), 0f);
					if (func_126(uParam0->f_29[0]))
					{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				func_241(&(uParam0->f_23[0]), iVar0[1], -78.0873f, 299.0679f, 105.3972f, 249.8696f);
		...
		case 3:
			if (func_126(uParam0->f_1C[0]) && func_126(AUDIO::_0x0626A247D2405330()))
			{
				...
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_54, true);
				BRAIN::TASK_SYNCHRONIZED_SCENE(uParam0->f_1C[0], iLocal_54, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
			...
			BRAIN::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_PAPARAZZI", 0);
...
int func_253(var uParam0)//Position - 0xFD3B
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (func_245(&(uParam0->f_1C[0]), 50, -149.75f, 285.81f, 93.67f, 135f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_1C[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[0], 9, 1, 0, 0);
				}
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				func_241(&(uParam0->f_23[0]), iVar0[1], -159.56f, 275.41f, 93.14f, 102.75f);
				if (func_176(uParam0->f_23[0]))
				{
		...
		case 3:
			if (func_126(uParam0->f_1C[0]))
			{
				if (STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo1beckon"))
				{
					...
					BRAIN::TASK_PLAY_ANIM(0, sVar4, "pap_idle_01", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, sVar4, "pap_idle_action_01", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, sVar4, "pap_idle_02", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, sVar4, "pap_idle_action_02", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
...
void func_254(int iParam0, bool bParam1)//Position - 0x1005F
{
	switch (iParam0)
	{
		case 46:
...
int func_255(int iParam0)//Position - 0x100EA
{
	struct<27> Var0;
	int iVar1;
...
int func_256(int iParam0)//Position - 0x1013E
{
	char* sVar0;
...
int func_257(int iParam0)//Position - 0x101F7
{
	var uVar0;
...
int func_258(int iParam0)//Position - 0x102B8
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_259(int iParam0, char* sParam1)//Position - 0x1033D
{
...
bool func_260(int iParam0)//Position - 0x1041F
{
...
bool func_261(int iParam0)//Position - 0x1044D
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
int func_263(int iParam0)//Position - 0x104A9
{
	if (func_231(iParam0))
	{
		return 0;
...
void func_264()//Position - 0x104DE
{
	func_281("Running end routines.");
	Global_19D3C = (Global_19D3C - 1);
}

int func_265(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0x104F8
{
	int iVar0;
...
int func_266(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0x1055D
{
	int iVar0;
	struct<7> Var1;
...
int func_267(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x105DB
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_268(int iParam0, bool bParam1)//Position - 0x10656
{
	if (bParam1)
	{
		...
		switch (*iParam0)
		{
			...
			case 47:
				BRAIN::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_PAPARAZZI", 1);
	...
	func_269(&(iParam0->f_30));
	if (!bParam1)
	{
		if (*iParam0 == 48)
		{
			func_281("SCRIPT TERMINATING: Holding on to launcher until Paparazzo 3 cleans up...");
			while (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("paparazzo3")) > 0)
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_269(var uParam0)//Position - 0x107C4
{
	if (func_203(uParam0))
	{
...
void func_270(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x107FA
{
...
void func_271(var uParam0, bool bParam1)//Position - 0x1081A
{
	func_272(&(uParam0->f_29), bParam1);
}

void func_272(var uParam0, bool bParam1)//Position - 0x1082C
{
	int iVar0;
...
void func_273(int iParam0, bool bParam1)//Position - 0x1086A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_274(var uParam0, bool bParam1)//Position - 0x108A5
{
	func_275(&(uParam0->f_23), bParam1);
}

void func_275(var uParam0, bool bParam1)//Position - 0x108B7
{
	int iVar0;
...
void func_276(int iParam0)//Position - 0x108F4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_277(var uParam0, int iParam1)//Position - 0x1092C
{
	func_278(&(uParam0->f_1C), iParam1);
}

void func_278(var uParam0, int iParam1)//Position - 0x1093E
{
	int iVar0;
...
void func_279(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1097F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_280(var uParam0)//Position - 0x109CF
{
	if (*uParam0 == 4294967295)
	{
		return;
...
void func_281(char* sParam0)//Position - 0x10A0C
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_282(var uParam0)//Position - 0x10A1E
{
	*uParam0 = 4294967295;
...
void func_283()//Position - 0x10A51
{
	func_281("Running start routines.");
	Global_19D3C++;
}

int func_284(int iParam0)//Position - 0x10A6B
{
	if (!func_36(iParam0))
	{
		return Global_19E56.f_6D76[iParam0 /*29*/];
