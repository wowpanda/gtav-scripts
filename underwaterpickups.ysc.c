...
void __EntryFunction__()//Position - 0x0
{
	...
	func_24(vVar0);
	bLocal_4 = func_4();
	vLocal_5 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false) };
	func_1();
	while (true)
	{
		SYSTEM::WAIT(0);
		...
		if (func_3(iVar0, &iVar1, &vVar2, &vVar3, &iVar5))
		{
			if (func_2(vVar3, 0f, 0f, 0f, 0))
			{
				...
				else if (SYSTEM::VDIST2(vVar2, vLocal_5) > 400f)
				{
					...
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
						{
							iLocal_3[iVar0] = OBJECT::CREATE_PICKUP(iVar1, vVar2, iVar4, 4294967295, 1, 0);
						}
					}
					else
					{
			...
			else
			{
				...
				else if (SYSTEM::VDIST2(vVar2, vLocal_5) > 400f)
				{
					if (iVar1 == joaat("pickup_armour_standard"))
					{
						iLocal_3[iVar0] = OBJECT::CREATE_PICKUP_ROTATE(iVar1, vVar2, vVar3, iVar4, 4294967295, 2, 1, 0);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
...
{
	if (Global_2587D7 == 4294967281)
	{
		Global_2587D7 = func_23();
		func_15(&Global_2587D7, 0, 0, 0, 1, 0, 0);
		return 1;
	}
	if (func_5(func_23(), Global_2587D7))
	{
		Global_2587D7 = func_23();
		func_15(&Global_2587D7, 0, 0, 0, 1, 0, 0);
		return 1;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_12(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}
