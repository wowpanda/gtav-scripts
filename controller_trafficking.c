...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_172())
		{
			...
			{
				fLocal_31 = VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_32);
			}
			func_170(&iVar1);
			func_30(&iVar2);
			if (iLocal_47 > 3)
			{
				if (fLocal_31 < 600f)
				{
					if (func_27(0) == 0 && (GET_GAME_TIMER() - iLocal_81) > 2000)
					{
...
int func_16(var uParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
void func_30(int iParam0)
{
	...
	switch (iLocal_53)
	{
		...
		case 3:
			...
			{
				CLEAR_AREA_OF_VEHICLES(vLocal_55, 4f, 0, 0, 0, 0, 0, 0);
				if (DOES_ENTITY_EXIST(iLocal_54))
				{
					DELETE_VEHICLE(&iLocal_54);
				}
				iLocal_54 = CREATE_VEHICLE(func_161(), vLocal_55, fLocal_58, 1, 1, 0);
				SET_VEHICLE_RADIO_ENABLED(iLocal_54, 0);
				SET_MODEL_AS_NO_LONGER_NEEDED(func_161());
				if (DOES_ENTITY_EXIST(iLocal_54))
				{
					if (DOES_EXTRA_EXIST(iLocal_54, 1))
					{
						SET_VEHICLE_EXTRA(iLocal_54, 1, 1);
					}
					if (DOES_EXTRA_EXIST(iLocal_54, 2))
					{
						SET_VEHICLE_EXTRA(iLocal_54, 2, 0);
					}
					if (DOES_EXTRA_EXIST(iLocal_54, 3))
					{
						SET_VEHICLE_EXTRA(iLocal_54, 3, 0);
					}
					SET_VEHICLE_COLOURS(iLocal_54, 0, 0);
				}
				iLocal_53 = 4;
			}
			break;
		...
		case 4:
			...
			if (!bVar0 && !*iParam0)
			{
				...
				if (!iLocal_59)
				{
					if (IS_PED_IN_ANY_VEHICLE(uLocal_28, 0))
					{
						iVar1 = GET_VEHICLE_PED_IS_USING(uLocal_28);
						if (iVar1 == iLocal_54)
						{
							iLocal_59 = 1;
			...
			if (*iParam0)
			{
				if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_ENTITY_DEAD(iLocal_54, 0))
				{
					SET_PED_INTO_VEHICLE(PLAYER_PED_ID(), iLocal_54, -1);
				}
			}
			if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_ENTITY_DEAD(iLocal_54, 0))
			{
			...
			if (!IS_ENTITY_DEAD(iLocal_54, 0) && !IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
			{
				if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
					...
					if (iVar2 == iLocal_54)
					{
						if (VDIST2(vLocal_55, GET_ENTITY_COORDS(uLocal_28, 1)) < 100f)
						{
		...
		case 6:
			if (HAS_SCRIPT_LOADED("Traffick_Ground"))
			{
				...
				{
					iVar3 = func_130(&iLocal_35, 6, 9, 0, 0);
					iLocal_45 = 1;
				}
				if (iVar3 == 1)
				{
					...
					Var4.f_85 = 4;
					Var4.f_90 = 6;
					uLocal_30 = START_NEW_SCRIPT_WITH_ARGS("Traffick_Ground", &Var4, 97, 28000);
					func_80(16);
					SET_SCRIPT_AS_NO_LONGER_NEEDED("Traffick_Ground");
					SET_ENTITY_AS_MISSION_ENTITY(iLocal_54, 1, 0);
					SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_54);
		...
		case 7:
			if (!IS_THREAD_ACTIVE(uLocal_30))
			{
				...
				else
				{
					...
					iLocal_36 = 1;
					iVar101 = func_52();
					func_44(&iVar101, 0, 0, 3, 0, 0, 0);
					Global_106565.f_19977.f_12 = iVar101;
					func_1(106, 0, 0);
					Global_106565.f_19977.f_13 = 0;
				}
				*iParam0 = 0;
...
int func_52()
{
	...
	func_51(&uVar0, GET_CLOCK_SECONDS());
	func_50(&uVar0, GET_CLOCK_MINUTES());
	func_49(&uVar0, GET_CLOCK_HOURS());
	func_47(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_48(&uVar0, GET_CLOCK_MONTH());
	func_46(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
void func_84(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_22();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_93())
		{
			func_86(PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
void func_95(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_100(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_97(Var11.f_1)) && iVar72 < 51)
			{
...
int func_103(vector3 vParam0, char* sParam3, vector3 vParam4)
{
	int iVar0;
	int iVar1;
...
int func_106(var uParam0)
{
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (func_129())
		{
			*uParam0 = func_112(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_108(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_110() == 0)
		{
			return IS_BIT_SET(func_87(func_109(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_112(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_128(iVar0))
		{
			if (!bParam5 || func_127(iVar0))
			{
...
int func_116(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	{
		Var12 = { func_118(iParam0) };
	}
	vVar18 = { Var12 - Var0 };
	vVar18 = { func_117(vVar18, -Var0.f_3.f_2) };
	vVar18 = { func_117(vVar18, vVar6.f_3.f_2) };
...
void func_132(int iParam0, vector3 vParam1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (DOES_ENTITY_EXIST(iParam0) && IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_152(iParam5, &Var0, vParam1, fParam4, func_9(iParam0));
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_20(iParam0, 0, 0)) || func_20(iParam0, 1, 0)) || func_20(iParam0, 2, 0)) || func_9(iParam0) != 145) || func_149(iParam0)) || func_148(iParam0)) || func_147(iParam0)) || func_146(iParam0)) || !func_136(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_148(iParam0))
		{
		}
...
void func_152(int iParam0, var uParam1, vector3 vParam2, var uParam5, int iParam6)
{
	if (func_151(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
...
void func_160()
{
	...
	if (!DOES_ENTITY_EXIST(iLocal_29))
	{
		if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
		{
			if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_32) < 2500f)
			{
...
int func_163()
{
	if (func_27(9))
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("trevor2")) == 1)
		{
			if (!iLocal_38[0])
			{
				iLocal_38[0] = 1;
		...
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("finale_heist2b")) == 1)
		{
			if (!iLocal_38[1])
			{
				iLocal_38[1] = 1;
		...
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("traffick_air")) == 1)
		{
			if (!iLocal_38[2])
			{
				iLocal_38[2] = 1;
		...
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("traffick_ground")) == 1)
		{
			if (!iLocal_38[3])
			{
				iLocal_38[3] = 1;
	...
	switch (iLocal_47)
	{
		...
		case 3:
			...
			if (HAS_MODEL_LOADED(joaat("cuban800")))
			{
				...
				{
					CLEAR_AREA_OF_VEHICLES(vLocal_50, 8f, 0, 0, 0, 0, 0, 0);
					iLocal_48 = CREATE_VEHICLE(joaat("cuban800"), vLocal_50, 25.29f, 1, 1, 0);
					SET_MODEL_AS_NO_LONGER_NEEDED(joaat("cuban800"));
					SET_VEHICLE_COLOUR_COMBINATION(iLocal_48, 2);
		...
		case 4:
			if (DOES_ENTITY_EXIST(iLocal_48))
			{
				if (IS_ENTITY_DEAD(iLocal_48, 0) || IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
				{
					iLocal_47 = 9;
					return;
				}
			...
			else if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("traffick_ground")) == 0)
			{
				if (!IS_ENTITY_DEAD(iLocal_48, 0))
				{
					SET_VEHICLE_DOORS_LOCKED(iLocal_48, 1);
				}
			}
			if (!bLocal_37)
			{
			...
			if (*iParam0)
			{
				SET_PED_INTO_VEHICLE(uLocal_28, iLocal_48, -1);
			}
			if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_ENTITY_DEAD(iLocal_48, 0))
			{
				...
				if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
					...
					if (iVar2 == iLocal_48)
					{
						...
						if (DOES_ENTITY_EXIST(iLocal_29) && !IS_ENTITY_DEAD(iLocal_29, 0))
						{
							if (GET_ENTITY_MODEL(iLocal_29) != joaat("dune") && GET_ENTITY_MODEL(iLocal_29) != joaat("cuban800"))
							{
								if (!IS_ENTITY_IN_ANGLED_AREA(iLocal_29, 2137.12f, 4799.97f, 39.67854f, 2116.64f, 4790.417f, 45.45295f, 25f, 0, 1, 0))
								{
									func_132(iLocal_29, 2142.245f, 4823.463f, 40.2769f, 118.4428f, 24, 0);
								}
							}
		...
		case 6:
			if (HAS_SCRIPT_LOADED("Traffick_Air"))
			{
				...
				if (iVar3 == 1)
				{
					...
					if (!*iParam0)
					{
						func_81(GET_THIS_SCRIPT_NAME(), 0);
					}
					uLocal_30 = START_NEW_SCRIPT("Traffick_Air", 28000);
					func_80(15);
				...
				if (Global_93716)
				{
					*iParam0 = 1;
					if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
					{
						if (!IS_PED_INJURED(PLAYER_PED_ID()))
						{
							SET_ENTITY_COORDS(PLAYER_PED_ID(), 2136.446f, 4791.483f, 39.9702f, 1, 0, 0, 1);
						}
					}
					REQUEST_MODEL(joaat("cuban800"));
					REQUEST_SCRIPT("Traffick_Air");
...
int func_172()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("traffick_ground")) == 1 || _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("traffick_air")) == 1)
	{
		return 1;
	}
	uLocal_28 = PLAYER_PED_ID();
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_181()) || Global_105612) || Global_25767) || func_175()) || func_174(8, -1)) || func_129()) || func_180()) || func_173()) || func_179()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_181()) || Global_25767) || func_175()) || func_174(8, -1)) || func_173()) || func_129()) || func_180()) || func_179()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_181()) || Global_105612) || Global_25767) || func_175()) || func_174(8, -1)) || func_173()) || func_129()) || func_180()) || func_179()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_181()) || Global_105612) || Global_25767) || func_175()) || func_174(8, -1)) || func_129()) || func_180()) || func_179()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_181() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_174(8, -1)) || func_179()) || func_178()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_181()) || Global_25767) || func_175()) || func_174(8, -1)) || func_180()) || func_173()) || func_179()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_181()) || func_180()) || Global_105612) || Global_25767) || func_175()) || Global_37584) || func_174(8, -1)) || func_173()) || func_178()) || func_179()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_181()) || Global_105612) || Global_25767) || func_175()) || func_174(8, -1)) || func_173()) || func_178()) || func_129()) || func_180()) || func_179())
						{
							return 0;
						}
						break;
...
void func_186()
{
	if (!iLocal_80)
	{
		iLocal_79 = ADD_SCENARIO_BLOCKING_AREA(Vector(40.073f, 4788.559f, 2157.109f) - Vector(25f, 25f, 25f), Vector(40.073f, 4788.559f, 2157.109f) + Vector(25f, 25f, 25f), 0, 1, 1, 1);
		iLocal_80 = 1;
	}
}
...
void func_188()
{
	if (iLocal_79 != 0)
	{
		REMOVE_SCENARIO_BLOCKING_AREA(iLocal_79, 0);
	}
	func_171(1);
	func_162(1);
	func_191();
...
void func_191()
{
	...
	while (iVar0 < 5)
	{
		if (DOES_PICKUP_EXIST(uLocal_67[iVar0]))
		{
			REMOVE_PICKUP(uLocal_67[iVar0]);
		}
		if (DOES_ENTITY_EXIST(uLocal_61[iVar0]))
		{
			DELETE_OBJECT(&(uLocal_61[iVar0]));
		}
		iVar0++;
	}
}
