...
void __EntryFunction__()
{
	...
	if ((HAS_FORCE_CLEANUP_OCCURRED(18) || func_80()) || Global_2528542.f_1843)
	{
		func_79();
	}
	...
	{
		WAIT(0);
		if ((!IS_PED_INJURED(PLAYER_PED_ID()) && (!IS_PLAYER_SWITCH_IN_PROGRESS() || func_70() == 5)) && !func_58())
		{
			if (GET_DISTANCE_BETWEEN_COORDS(vLocal_338, GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 1) < 3f)
			{
				switch (iLocal_326)
				{
					case 0:
			...
			else if (GET_DISTANCE_BETWEEN_COORDS(vLocal_338, GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 1) > 6f)
			{
				func_79();
			}
		}
...
void func_1()
{
	uLocal_332 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uLocal_331);
	switch (iLocal_327)
	{
		case 0:
			break;
...
void func_2()
{
	...
	switch (iLocal_327)
	{
		case 0:
			...
			if (func_70() == 5)
			{
				CLEAR_BIT(&uLocal_325, 0);
				if (GET_FOLLOW_PED_CAM_VIEW_MODE() == 4)
				{
					iLocal_330 = 1;
				}
				uLocal_331 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_348, vLocal_351, 2, 0, 1, 1065353216, 0, 1065353216);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_331, sLocal_334, sLocal_336, 8f, -2f, 261, 0, 1148846080, 0);
				NETWORK_START_SYNCHRONISED_SCENE(uLocal_331);
				iLocal_327 = 7;
			}
			else if (func_51(9))
			{
				if ((((func_47(vLocal_338, vVar0) && GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()) == GET_INTERIOR_AT_COORDS(vLocal_338)) && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_342, vLocal_345, 2f, 0, 1, 0)) && func_46()) && !func_43(PLAYER_ID()))
				{
					if (iLocal_333 == -1)
					{
		...
		case 1:
			vLocal_354 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 0) };
			if (func_41(1, 0, 1))
			{
				if ((((((func_47(vLocal_338, vVar0) && vLocal_354.z < (vLocal_338.z + 1f)) && func_51(9)) && GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()) == GET_INTERIOR_AT_COORDS(vLocal_338)) && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_342, vLocal_345, 2f, 0, 1, 0)) && func_46()) && !func_43(PLAYER_ID()))
				{
					if (func_39(iLocal_333, 1))
					{
						...
						func_34();
						CLEAR_AREA_OF_PROJECTILES(vLocal_338, 3f, 0);
						Global_1573337 = 9;
						func_27(PLAYER_ID(), 0, 256, 0);
						iLocal_36 = 1;
						SET_CURRENT_PED_WEAPON(PLAYER_PED_ID(), joaat("weapon_unarmed"), 1);
						func_17(1, 1, 1, 0, 0, 0);
						vLocal_338 = { GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_334, sLocal_335, vLocal_348, vLocal_351, 0, 2) };
						vVar3 = { GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_334, sLocal_335, vLocal_348, vLocal_351, 0, 2) };
						fLocal_341 = vVar3.z;
						TASK_GO_STRAIGHT_TO_COORD(PLAYER_PED_ID(), vLocal_338, 1f, 5000, fLocal_341, 0.05f);
						if (GET_FOLLOW_PED_CAM_VIEW_MODE() == 4)
						{
							SET_PED_DESIRED_HEADING(PLAYER_PED_ID(), func_16(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(uLocal_41, 1)));
							FORCE_PED_MOTION_STATE(PLAYER_PED_ID(), 1063765679, 0, 0, 0);
							SET_PED_RESET_FLAG(PLAYER_PED_ID(), 69, 1);
						}
						iLocal_327 = 2;
					}
				}
		...
		case 2:
			...
			{
				CLEAR_BIT(&uLocal_325, 0);
				uLocal_331 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_348, vLocal_351, 2, 0, 0, 1065353216, 0, 1065353216);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_331, sLocal_334, sLocal_335, 4f, -2f, 261, 0, 1148846080, 0);
				NETWORK_START_SYNCHRONISED_SCENE(uLocal_331);
				if (GET_FOLLOW_PED_CAM_VIEW_MODE() == 4)
				{
					iLocal_330 = 1;
		...
		case 4:
			...
			if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_332) > 0.9f)
			{
				CLEAR_BIT(&uLocal_325, 0);
				uLocal_331 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_348, vLocal_351, 2, 0, 1, 1065353216, 0, 1065353216);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_331, sLocal_334, sLocal_336, 8f, -2f, 261, 0, 1148846080, 0);
		...
		case 5:
			...
			{
				SET_BIT(&uLocal_325, 0);
				SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_332, 1);
		...
		case 6:
			...
			if (!func_43(PLAYER_ID()) && IS_CONTROL_JUST_PRESSED(2, 222))
			{
				if (func_35("SA_BED_OUT"))
				{
					CLEAR_HELP(1);
				...
				CLEAR_BIT(&uLocal_325, 0);
				uLocal_331 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_348, vLocal_351, 2, 0, 0, 1065353216, 0, 1065353216);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_331, sLocal_334, sLocal_337, 2f, -2f, 261, 0, 1148846080, 0);
				NETWORK_START_SYNCHRONISED_SCENE(uLocal_331);
				iLocal_327 = 8;
			}
			break;
		...
		case 7:
			if ((!func_8() && IS_INTERIOR_READY(GET_INTERIOR_AT_COORDS(vLocal_338))) && iLocal_330 == 1)
			{
				_DISABLE_FIRST_PERSON_CAM_THIS_FRAME();
			}
			if (((IS_INTERIOR_READY(GET_INTERIOR_AT_COORDS(vLocal_338)) && !func_8()) && !func_6()) && Global_1312467.f_8 == 0)
			{
				bLocal_329 = true;
				CLEAR_BIT(&uLocal_325, 0);
				uLocal_331 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_348, vLocal_351, 2, 0, 0, 1065353216, 0, 1065353216);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_331, sLocal_334, sLocal_337, 1000f, -2f, 261, 0, 1148846080, 0);
				NETWORK_START_SYNCHRONISED_SCENE(uLocal_331);
				iLocal_327 = 8;
			}
			break;
...
void func_3(int iParam0)
{
	...
	if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		Global_2409274.f_3 = GET_NETWORK_TIME();
	}
}
	...
	else
	{
		...
		if (NETWORK_IS_PLAYER_ACTIVE(iParam0) && (IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_19(PLAYER_ID(), 0) && !func_23()))
				{
			...
			if (bParam1)
			{
				if (!func_31(uVar25) && !IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar25))
				{
					if (!bVar21)
					{
...
{
	return IS_BIT_SET(Global_1371947.f_241.f_136[func_45(9) /*33*/][iParam0], func_44(9));
}
...
int func_46()
{
	...
	iVar9 = GET_PED_NEARBY_PEDS(PLAYER_PED_ID(), &uVar0, -1);
	if (iVar9 > 0)
	{
		iVar10 = 0;
		while (iVar10 <= 7)
		{
			if (!IS_PED_INJURED(uVar0[iVar10]))
			{
				if (IS_ENTITY_IN_ANGLED_AREA(uVar0[iVar10], vLocal_342, vLocal_345, 2f, 0, 1, 0))
				{
					return 0;
				}
			}
...
int func_47(vector3 vParam0, float fParam3, var uParam4, var uParam5)
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if ((!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !IS_ENTITY_ON_FIRE(PLAYER_PED_ID())) && IS_PLAYER_CONTROL_ON(PLAYER_ID()))
		{
			...
			{
				if ((((IS_GAMEPLAY_CAM_RENDERING() && !IS_CUTSCENE_PLAYING()) && !IS_CINEMATIC_CAM_RENDERING()) && !func_40(0)) && !func_50())
				{
					if ((Global_90640 && Global_90641) || func_49())
					{
						return 0;
					}
					if (func_48(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vParam0, fParam3, 0))
					{
						return 1;
					}
				}
...
int func_48(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
{
	if ((((((IS_BIT_SET(Global_1573336, iParam0) || Global_1573337 != -1) || func_56()) || IS_PLAYER_FREE_AIMING(PLAYER_ID())) || IS_PLAYER_TARGETTING_ANYTHING(PLAYER_ID())) || func_55()) || func_52(iParam0))
	{
		return 0;
	}
	return 1;
...
int func_57()
{
	REQUEST_ANIM_DICT(sLocal_334);
	if (!HAS_ANIM_DICT_LOADED(sLocal_334))
	{
		return 0;
	}
	iLocal_328 = 1;
...
void func_79()
{
	...
	if (iLocal_328)
	{
		REMOVE_ANIM_DICT(sLocal_334);
	}
	func_4();
	if (!func_22(PLAYER_ID()) && !IS_NEW_LOAD_SCENE_ACTIVE())
	{
		func_27(PLAYER_ID(), 1, 0, 0);
	}
	func_73();
