...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		switch (func_128(NETSHOP::_NETWORK_SHOP_BASKET_START()))
		{
			case 0:
				if (func_127() == 1)
				{
					func_126();
					func_125();
					vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/] = 1;
				}
				else if (func_127() == 4)
				{
					vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/] = 3;
				}
				break;
			...
			case 1:
				...
				{
					if (!ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), unk_0x8000C77B5F336760(NETWORK::NET_TO_VEH(Local_95.f_2), 1), 200f, 200f, 200f, 0, 1, 0))
					{
						vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/] = 4;
					}
				}
				break;
			
			case 3:
				func_69(&(Local_95.f_12));
				if (func_68(&(Local_95.f_12)))
				{
					vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/] = 4;
				}
				break;
		...
		if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		{
			...
			{
				case 0:
					if (func_66(&(Local_95.f_10), 10000, 0))
					{
						if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_95, 12))
						{
							Local_95.f_4 = CAM::_0xDC9DA9E8789F5246();
							Local_95.f_5 = func_65();
							Local_95.f_A = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 0) + Vector(0f, 5f, 0f) };
...
int func_2()//Position - 0x27A
{
	...
	if (Local_95.f_15 >= 0 || Local_95.f_15 <= 3)
	{
		if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_2))
		{
			if (!func_70(Local_95.f_2))
			{
				if (NETWORK::NETWORK_GET_DESTROYER_OF_NETWORK_ID(Local_95.f_2, &uVar0) == CAM::_0xDC9DA9E8789F5246())
				{
					func_5(1, 600000);
				}
				return 1;
		...
		if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_3))
		{
			...
			{
				if (NETWORK::NETWORK_GET_DESTROYER_OF_NETWORK_ID(Local_95.f_3, &uVar1) == CAM::_0xDC9DA9E8789F5246())
				{
					func_5(1, 600000);
				}
				return 1;
		...
		if (!func_3(CAM::_0xDC9DA9E8789F5246(), 1, 1))
		{
			return 1;
		}
	}
...
void func_7(int iParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, bool bParam5)//Position - 0x575
{
	int iVar0;
...
int func_8(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0xAE2
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_9(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xC8D
{
	switch (iParam1)
	{
		case 1704445500:
...
void func_10(int iParam0)//Position - 0xCC5
{
	bool bVar0;
	...
	if (iParam0 != 4294967295)
	{
		...
		func_11(&(Global_410C0F[iParam0 /*80*/]));
	}
}

void func_11(var uParam0)//Position - 0xD19
{
	uParam0->f_3D = 0;
...
void func_12(var uParam0)//Position - 0xE1C
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_13(int iParam0)//Position - 0xE64
{
...
void func_14(int iParam0, int iParam1)//Position - 0xE8E
{
	Global_258B69 = iParam1;
	Global_258B68 = iParam0;
}

int func_15(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, int iParam10)//Position - 0xEA2
{
	int iVar0;
	...
	while (iVar0 < 5)
	{
		if (Global_410C0F[iVar0 /*80*/].f_3D.f_2 == 0)
		{
			...
			{
				func_16(Global_410C0F[iVar0 /*80*/], iVar0);
			}
			return iVar0;
		}
		iVar0++;
...
void func_16(struct<62> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, int iParam19)//Position - 0xFDE
{
	vector3 vVar0;
	int iVar1;
...
void func_17()//Position - 0x1070
{
	SCRIPT::REQUEST_SCRIPT("AM_ARENA_SHP");
}

var func_18(int iParam0)//Position - 0x107E
{
	var uVar0;
...
int func_19()//Position - 0x1090
{
	return Global_1407E0;
}

int func_20()//Position - 0x109C
{
...
char* func_21(int iParam0)//Position - 0x10B3
{
	switch (iParam0)
	{
		case 0:
...
char* func_22(int iParam0)//Position - 0x113D
{
	switch (iParam0)
	{
		case 0:
...
int func_23(int iParam0)//Position - 0x1223
{
	int iVar0;
...
bool func_25()//Position - 0x145F
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(func_26(6424, 4294967295, 0), 19);
}

int func_26(int iParam0, int iParam1, int iParam2)//Position - 0x1476
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Global_26B05F[iParam0 /*3*/][func_27(iParam1)];
...
int func_27(var uParam0)//Position - 0x14A8
{
	int iVar0;
	int iVar1;
...
int func_28(int iParam0)//Position - 0x14DC
{
	switch (iParam0)
	{
		case 1:
...
bool func_29()//Position - 0x17C1
{
	return Global_1841F3[CAM::_0xDC9DA9E8789F5246() /*790*/].f_C4 != 0;
}

void func_30()//Position - 0x17D8
{
	if (!NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		return;
	...
	if (!func_4(Local_95.f_3) && func_70(Local_95.f_2))
	{
		...
		switch (Local_95.f_14)
		{
			case 2:
				...
				else if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_95, 7) && ENTITY::IS_ENTITY_AT_ENTITY(NETWORK::NET_TO_PED(Local_95.f_3), AUDIO::_0x0626A247D2405330(), 10f, 10f, 10f, 0, 1, 0))
				{
					Local_95.f_14 = 3;
				}
				break;
			...
			case 4:
				...
				{
					Local_95.f_14 = 3;
					GRAPHICS::_0x35FB78DC42B7BD21(&iLocal_97, 8);
				}
				else if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_95, 7) && ENTITY::IS_ENTITY_AT_COORD(NETWORK::NET_TO_PED(Local_95.f_3), Local_95.f_7, 10f, 10f, 10f, 0, 1, 0))
				{
					Local_95.f_14 = 5;
				}
				break;
			...
			case 5:
				if ((VEHICLE::GET_VEHICLE_NUMBER_OF_PASSENGERS(NETWORK::NET_TO_VEH(Local_95.f_2)) <= 0 && !PED::IS_PED_ON_SPECIFIC_VEHICLE(AUDIO::_0x0626A247D2405330(), NETWORK::NET_TO_VEH(Local_95.f_2))) && func_31(AUDIO::_0x0626A247D2405330(), NETWORK::NET_TO_VEH(Local_95.f_2), 1) >= 10f)
				{
					Local_95.f_14 = 6;
				}
				break;
			...
			case 1:
				if (BRAIN::GET_SCRIPT_TASK_STATUS(NETWORK::NET_TO_PED(Local_95.f_3), 242628503) == 1 && func_31(AUDIO::_0x0626A247D2405330(), NETWORK::NET_TO_PED(Local_95.f_3), 1) >= 10f)
				{
					Local_95.f_14 = 7;
				}
				break;
...
float func_31(int iParam0, int iParam1, int iParam2)//Position - 0x1A72
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_32()//Position - 0x1AD0
{
	switch (Local_95.f_15)
	{
		case 0:
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_95, 8) || VEHICLE::GET_VEHICLE_NUMBER_OF_PASSENGERS(NETWORK::NET_TO_VEH(Local_95.f_2)) > 0)
			{
				Local_95.f_15 = 1;
			}
			break;
		...
		case 2:
			...
			else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_95, 10))
			{
				Local_95.f_15 = 4;
			}
			break;
...
void func_33()//Position - 0x1C09
{
	int iVar0;
	int iVar1;
	
	GRAPHICS::_0x35FB78DC42B7BD21(&Local_95, 9);
	iVar0 = 0;
	while (iVar0 < NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if (func_3(iVar1, 1, 1))
			{
				if (func_70(Local_95.f_2))
				{
					if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_95, 8))
					{
						if (ENTITY::IS_ENTITY_AT_COORD(NETWORK::NET_TO_VEH(Local_95.f_2), Local_95.f_A, (10f * 1.5f), (10f * 1.5f), (10f * 1.5f), 0, 1, 0))
						{
							MISC::SET_BIT(&Local_95, 8);
						}
					}
					if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_95, 7) || INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_95, 11))
					{
						if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_95, 10))
						{
					...
					if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_95, 9))
					{
						if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(vLocal_96[iVar0 /*3*/].f_1, 6))
						{
							MISC::SET_BIT(&Local_95, 9);
							GRAPHICS::_0x35FB78DC42B7BD21(&(vLocal_96[iVar0 /*3*/].f_1), 6);
						}
					}
					if (Local_95.f_14 != 3)
					{
						if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(vLocal_96[iVar0 /*3*/].f_1, 5))
						{
							Local_95.f_14 = 3;
							GRAPHICS::_0x35FB78DC42B7BD21(&(vLocal_96[iVar0 /*3*/].f_1), 5);
						}
					}
				}
			}
...
int func_35()//Position - 0x1DC8
{
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 2631.833f, 4526.624f, -10f, -380.1435f, 3906.702f, 78.484f, 1200f, 0, 1, 0))
	{
		return 1;
	}
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1731.902f, -123.8468f, 137.2596f, 2079.203f, 798.3421f, 249.3267f, 600f, 0, 1, 0))
	{
		return 1;
	}
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 252.5025f, 855.094f, 148.1213f, -393.3539f, 695.785f, 272.1867f, 500f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
int func_36()//Position - 0x1E70
{
	...
	while (iVar0 < 21)
	{
		if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), func_37(iVar0), 50f, 50f, 50f, 0, 1, 0))
		{
			return 1;
		}
		iVar0++;
...
Vector3 func_37(int iParam0)//Position - 0x1EB3
{
	switch (iParam0)
	{
		case 0:
...
int func_39()//Position - 0x20B3
{
	if ((!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_3) && func_62(joaat("s_m_y_blackops_01"))) && NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_2))
	{
		if (func_70(Local_95.f_2))
		{
			if (func_40(&(Local_95.f_3), Local_95.f_2, 22, joaat("s_m_y_blackops_01"), 4294967295, 1, 1, 1))
			{
				...
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(NETWORK::NET_TO_PED(Local_95.f_3), Global_180845);
				}
				else
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(NETWORK::NET_TO_PED(Local_95.f_3), Global_180708[2 /*94*/][2 /*31*/][2 /*10*/][2 /*3*/][0]);
				}
				PED::SET_PED_KEEP_TASK(NETWORK::NET_TO_PED(Local_95.f_3), 1);
				ENTITY::SET_ENTITY_HEALTH(NETWORK::NET_TO_PED(Local_95.f_3), 1);
				unk_0x65E471E4A2D56226(NETWORK::NET_TO_PED(Local_95.f_3), SYSTEM::ROUND((200f * Global_40001.f_99)), 0);
...
int func_40(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x2217
{
...
int func_41()//Position - 0x229F
{
	...
	if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_95.f_2))
	{
		...
		{
			if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_97, 10))
			{
				...
				{
					if (func_43(vLocal_793, 6f, 1f, 1f, 5f, 1, 1, 1, 1123024896, 0, 4294967295, 1, 0, 0, 0, 0, 0))
					{
			...
			else if (SHAPETEST::GET_SHAPE_TEST_RESULT(iLocal_791, &iLocal_792, &uVar0, &uVar0, &uVar1) == 2)
			{
				...
				{
					iLocal_792 = 0;
					GRAPHICS::_0x35FB78DC42B7BD21(&iLocal_97, 10);
				}
			}
...
int func_42(var uParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, bool bParam13)//Position - 0x2434
{
	float fVar0;
	int iVar1;
...
int func_43(vector3 vParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, bool bParam6, int iParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, float fParam12, bool bParam13, float fParam14, bool bParam15, int iParam16)//Position - 0x252E
{
	Global_24B2CE.f_2 = 0;
	if (fParam1 > 0f)
	{
...
int func_44(vector3 vParam0, float fParam1, int iParam2, int iParam3, float fParam4, bool bParam5, int iParam6, float fParam7, bool bParam8)//Position - 0x263F
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (iParam2 && !bParam5)
	{
		if (func_3(CAM::_0xDC9DA9E8789F5246(), 1, 1))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_48(CAM::_0xDC9DA9E8789F5246()), vParam0, 1) <= (fVar2 + fParam1))
				{
	...
	while (iVar0 < 32)
	{
		...
		if (func_3(iVar1, 1, 1))
		{
			if (!func_46(iVar1, 0) && NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(CAM::_0xDC9DA9E8789F5246(), iVar1))
			{
				if (iParam2 == 1 || (iParam2 == 0 && iVar1 != CAM::_0xDC9DA9E8789F5246()))
				{
					if ((func_45(iVar1) || !bParam8) && !Global_24FBF9[iVar1 /*413*/].f_103)
					{
						fVar2 = fParam4;
						if (fParam7 > 0f)
						{
						...
						if (!bParam5)
						{
							...
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_48(iVar1), vParam0, 1) <= (fVar2 + fParam1))
								{
...
int func_45(int iParam0)//Position - 0x27F7
{
...
bool func_46(int iParam0, int iParam1)//Position - 0x2822
{
	bool bVar0;
...
int func_47(int iParam0, bool bParam1)//Position - 0x286D
{
	int iVar0;
	int iVar1;
...
Vector3 func_48(int iParam0)//Position - 0x28AE
{
	int iVar0;
	
	iVar0 = iParam0;
	if ((func_51() && Global_1841F3[iVar0 /*790*/].f_2F9) && !func_50(Global_1841F3[iVar0 /*790*/].f_2FA))
	{
...
Vector3 func_49(int iParam0)//Position - 0x2901
{
	return unk_0x8000C77B5F336760(PLAYER::GET_PLAYER_PED(iParam0), 0);
}

int func_50(vector3 vParam0)//Position - 0x2914
{
...
var func_51()//Position - 0x293E
{
	return Global_255C02.f_10;
}

int func_52(vector3 vParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, var uParam7)//Position - 0x294C
{
	int iVar0;
	int iVar1;
			...
			if (func_3(iVar1, bParam2, bParam3))
			{
				if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(CAM::_0xDC9DA9E8789F5246(), iVar1))
				{
					if (!bParam5 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_45(iVar1)))
					{
						...
						{
							if (((PLAYER::GET_PLAYER_TEAM(CAM::_0xDC9DA9E8789F5246()) == 4294967295 && uParam7) && bParam4) && func_53(iVar1))
							{
							}
							else if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(iVar1)))
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_49(iVar1), vParam0, 1) < fParam1)
								{
									return 1;
								}
							}
...
int func_53(int iParam0)//Position - 0x2A48
{
	if (func_58(CAM::_0xDC9DA9E8789F5246(), iParam0))
	{
		return 1;
	}
	Global_2633E1 = { func_57(iParam0) };
	if (NETWORK::NETWORK_IS_FRIEND(&Global_2633E1))
	{
		return 1;
	}
	if (func_54(CAM::_0xDC9DA9E8789F5246(), iParam0))
	{
		return 1;
	}
	return 0;
...
int func_54(int iParam0, int iParam1)//Position - 0x2A8F
{
	int iVar0;
...
int func_55()//Position - 0x2ABA
{
	return 4294967295;
}

int func_56(int iParam0)//Position - 0x2AC3
{
	if (iParam0 != func_55())
	{
...
struct<13> func_57(int iParam0)//Position - 0x2AE6
{
	struct<13> Var0;
...
int func_58(int iParam0, int iParam1)//Position - 0x2AFD
{
	if (GRAPHICS::_DRAW_SHOWROOM())
	{
		Global_2633E1 = { func_57(iParam0) };
		Global_2633EE = { func_57(iParam1) };
...
void func_59(var uParam0, var uParam1)//Position - 0x2B6A
{
	*uParam0 = { func_60(Local_95.f_A, (100f / 2f), 100f, 10f) };
	*uParam1 = MISC::GET_HEADING_FROM_VECTOR_2D((Local_95.f_A - *uParam0), (Local_95.f_A.f_1 - uParam0->f_1));
}

Vector3 func_60(vector3 vParam0, float fParam1, float fParam2, float fParam3)//Position - 0x2BAB
{
	vector3 vVar0;
	float fVar1;
	...
	fVar1 = (fParam3 / 2f);
	vVar0 = { func_61(vVar0, MISC::GET_RANDOM_FLOAT_IN_RANGE(fParam1, fParam2)) };
	vVar0.z = MISC::GET_RANDOM_FLOAT_IN_RANGE(-fVar1, fVar1);
	return vParam0 + vVar0;
}

Vector3 func_61(vector3 vParam0, float fParam1)//Position - 0x2BF4
{
	float fVar0;
...
bool func_62(int iParam0)//Position - 0x2C2B
{
	if (iParam0 == 0)
	{
		return 1;
...
Vector3 func_63(int iParam0)//Position - 0x2C49
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
	...
	switch (iParam0)
	{
		case 0:
			...
			while (iVar0 <= 4)
			{
				fVar3 = MISC::GET_DISTANCE_BETWEEN_COORDS(Local_95.f_A, func_37(iVar0), 1);
				if (fVar3 < fVar4)
				{
					iVar1 = iVar0;
					fVar4 = fVar3;
...
float func_64(int iParam0)//Position - 0x2E42
{
	switch (iParam0)
	{
		case 0:
...
int func_65()//Position - 0x2F7C
{
	vector3 vVar0;
	
	vVar0 = { func_49(CAM::_0xDC9DA9E8789F5246()) };
...
int func_66(var uParam0, int iParam1, bool bParam2)//Position - 0x2FF2
{
...
void func_67(var uParam0, bool bParam1, bool bParam2)//Position - 0x3050
{
	if (uParam0->f_1 == 0)
	{
...
int func_68(var uParam0)//Position - 0x3095
{
	if (uParam0->f_1)
	{
...
void func_69(var uParam0)//Position - 0x30BE
{
	if (!uParam0->f_1)
	{
		if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
...
int func_70(var uParam0)//Position - 0x30DD
{
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(uParam0))
	{
...
int func_71(int iParam0)//Position - 0x30FD
{
...
void func_72()//Position - 0x3136
{
	if (func_3(CAM::_0xDC9DA9E8789F5246(), 1, 1))
	{
		if (Local_95.f_15 == 5)
		{
			vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/].f_2 = 5;
		}
		switch (vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/].f_2)
		{
			case 0:
				func_95();
				if (Local_95.f_15 > 0)
				{
					vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/].f_2 = 1;
				}
				break;
			...
			case 1:
				...
				{
					func_125();
					if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), NETWORK::NET_TO_VEH(Local_95.f_2), 0))
					{
						func_94();
						vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/].f_2 = 3;
						NETWORK::_0x5E3AA4CA2B6FB0EE(AUDIO::_0x0626A247D2405330());
						GRAPHICS::_0x35FB78DC42B7BD21(&(vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/].f_1), 0);
					}
				}
				break;
			...
			case 2:
				if (func_70(Local_95.f_2))
				{
					...
					{
						vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/].f_2 = 3;
						GRAPHICS::_0x35FB78DC42B7BD21(&(vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/].f_1), 5);
						MISC::SET_BIT(&(vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/].f_1), 6);
						if (Local_95.f_15 >= 4)
						{
							vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/].f_2 = 4;
						}
					}
					else
					{
			...
			case 4:
				if (func_70(Local_95.f_2))
				{
					if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_97, 3))
					{
					...
					if ((!PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), NETWORK::NET_TO_VEH(Local_95.f_2), 0) && !PED::IS_PED_ON_SPECIFIC_VEHICLE(AUDIO::_0x0626A247D2405330(), NETWORK::NET_TO_VEH(Local_95.f_2))) && func_31(AUDIO::_0x0626A247D2405330(), NETWORK::NET_TO_VEH(Local_95.f_2), 1) >= 10f)
					{
						vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/].f_2 = 5;
					}
				}
...
void func_73()//Position - 0x3342
{
	...
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_103))
	{
		if (func_88(1, 1))
		{
			if (((vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/].f_2 == 1 || vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/].f_2 == 2) || vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/].f_2 == 3) || vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/].f_2 == 4)
			{
				iVar0 = 1;
				Var1 = { func_87() };
				func_85(&uLocal_104);
				if (vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/].f_2 == 1)
				{
					if (func_70(Local_95.f_2))
					{
						if ((ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), NETWORK::NET_TO_VEH(Local_95.f_2), 10f, 10f, 3f, 0, 1, 0) && !PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0)) && !func_84(NETWORK::NET_TO_VEH(Local_95.f_2), 0))
						{
							func_83(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 23, true), "BTX_ENTER", &uLocal_104, 0);
						}
					}
				}
				else
	...
	{
		uLocal_103 = unk_0x9934FEFB3B8C6DB8("instructional_buttons");
	}
}

void func_74(var uParam0, var uParam1, var uParam2, int iParam3)//Position - 0x3454
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			while (iVar0 < uParam2->f_2A8)
			{
				if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam2->f_2A4, iVar0))
				{
					...
					if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam2->f_2A5, iVar0))
					{
						...
						func_78(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(iVar1, iVar2, true));
						if (iVar3 < 358)
						{
							func_78(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTON(iVar1, iVar3, true));
						}
					}
					else
					{
						...
						func_78(PAD::_0x80C2FD58D720C801(iVar4, iVar5, true));
					}
					...
					{
						func_77(&(uParam2->f_1[iVar0 /*56*/].f_20));
					}
					if (MISC::IS_PC_VERSION())
					{
				...
				else
				{
					...
					{
						func_78(&(uParam2->f_1[iVar0 /*56*/].f_10));
					}
					if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uParam2->f_2A2, iVar0))
					{
						GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&(uParam2->f_1[iVar0 /*56*/].f_20));
...
void func_76(var uParam0, var uParam1)//Position - 0x37F0
{
	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(uParam0, uParam1->f_4, uParam1->f_5, uParam1->f_6, uParam1->f_7, 0);
}

void func_77(char* sParam0)//Position - 0x380F
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	CAM::_DISABLE_VEHICLE_FIRST_PERSON_CAM_THIS_FRAME();
}

void func_78(char* sParam0)//Position - 0x3821
{
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_BUTTON_NAME(sParam0);
}

void func_79(int iParam0)//Position - 0x382F
{
	Global_141370 = iParam0;
}

void func_80(var uParam0)//Position - 0x383D
{
	uParam0->f_2A7 = 0;
}

int func_81(var uParam0)//Position - 0x384B
{
	return uParam0->f_2A7;
}

void func_82(int iParam0)//Position - 0x3858
{
	Global_14E696.f_437 = iParam0;
}

void func_83(char* sParam0, char* sParam1, var uParam2, char* sParam3)//Position - 0x3869
{
	int iVar0;
...
int func_84(int iParam0, bool bParam1)//Position - 0x38B9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_85(var uParam0)//Position - 0x391F
{
	func_86(uParam0);
	uParam0->f_2A7 = 1;
}

void func_86(var uParam0)//Position - 0x3933
{
	int iVar0;
...
struct<9> func_87()//Position - 0x3A03
{
	struct<9> Var0;
...
int func_88(int iParam0, int iParam1)//Position - 0x3A47
{
...
bool func_89()//Position - 0x3AE3
{
	return Global_140859;
}

bool func_90(int iParam0, int iParam1)//Position - 0x3AEF
{
	switch (iParam0)
	{
		case 5:
...
int func_91(int iParam0)//Position - 0x3B2A
{
	if (iParam0 == 1)
	{
...
bool func_92()//Position - 0x3B84
{
	return MISC::GET_GAME_TIMER() <= Global_43D7.f_16F1 + 100;
}

void func_93()//Position - 0x3B99
{
	Global_26AF40.f_102 = 1;
}

void func_94()//Position - 0x3BA9
{
...
void func_95()//Position - 0x3BC0
{
	...
	if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
	{
		...
		if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iVar0, 15))
		{
			func_97("BTX_HELP1", 4294967295);
			MISC::SET_BIT(&iVar0, 15);
			func_96(1190, iVar0, 4294967295, 1, 0);
		}
	}
}

void func_96(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x3C04
{
	int iVar0;
	...
	iVar0 = Global_26B05F[iParam0 /*3*/][func_27(iParam2)];
	if (iVar0 != 0)
	{
...
void func_97(char* sParam0, int iParam1)//Position - 0x3C34
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, 1, iParam1);
}

void func_98()//Position - 0x3C4B
{
	if (!func_4(Local_95.f_3) && func_70(Local_95.f_2))
	{
		if (NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_95.f_3) || (!unk_0xDD5EE7D9FC37FA16(Local_95.f_3) && NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT()))
		{
			func_123();
			func_102();
			...
			switch (Local_95.f_14)
			{
				...
				case 2:
					if (BRAIN::GET_SCRIPT_TASK_STATUS(NETWORK::NET_TO_PED(Local_95.f_3), 3021937204) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(NETWORK::NET_TO_PED(Local_95.f_3), 3021937204) != 0)
					{
						BRAIN::TASK_BOAT_MISSION(NETWORK::NET_TO_PED(Local_95.f_3), NETWORK::NET_TO_VEH(Local_95.f_2), 0, AUDIO::_0x0626A247D2405330(), 0f, 0f, 0f, 4, 12f, 786469, 10f, 1071);
					}
					break;
				
				case 4:
					func_100(unk_0x8000C77B5F336760(NETWORK::NET_TO_VEH(Local_95.f_2), 0), Local_95.f_7);
					...
					if (PATHFIND::_0xF7B79A50B905A30D(fLocal_966, fLocal_968, fLocal_967, fLocal_969))
					{
						...
						{
							BRAIN::TASK_PERFORM_SEQUENCE(NETWORK::NET_TO_PED(Local_95.f_3), uLocal_102);
						}
					}
					break;
				...
				case 5:
					if (BRAIN::GET_SCRIPT_TASK_STATUS(NETWORK::NET_TO_PED(Local_95.f_3), 3021937204) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(NETWORK::NET_TO_PED(Local_95.f_3), 3021937204) != 0)
					{
						BRAIN::TASK_VEHICLE_MISSION_COORS_TARGET(NETWORK::NET_TO_PED(Local_95.f_3), NETWORK::NET_TO_VEH(Local_95.f_2), unk_0x8000C77B5F336760(NETWORK::NET_TO_VEH(Local_95.f_2), 1), 5, 5f, 1076625579, 2f, 1f, 1);
					}
					break;
				...
				case 1:
					if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/].f_1, 7))
					{
						if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), NETWORK::NET_TO_VEH(Local_95.f_2), 0) || PED::IS_PED_ON_SPECIFIC_VEHICLE(AUDIO::_0x0626A247D2405330(), NETWORK::NET_TO_VEH(Local_95.f_2)))
						{
							...
							BRAIN::TASK_PERFORM_SEQUENCE(NETWORK::NET_TO_PED(Local_95.f_3), uLocal_100);
						}
						else
						{
							PED::SET_PED_DIES_IN_WATER(NETWORK::NET_TO_PED(Local_95.f_3), 0);
							...
							BRAIN::TASK_PERFORM_SEQUENCE(NETWORK::NET_TO_PED(Local_95.f_3), uLocal_101);
						}
						MISC::SET_BIT(&(vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/].f_1), 7);
					}
					break;
...
void func_99(var uParam0)//Position - 0x3FB2
{
	var uVar0;
...
void func_100(struct<2> Param0, float fParam1, struct<2> Param2, var uParam3)//Position - 0x3FD6
{
	if (Param0 < Param2)
	{
...
int func_101(var uParam0)//Position - 0x406E
{
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(uParam0))
	{
...
void func_102()//Position - 0x4090
{
	int iVar0;
	struct<2> Var1;
	
	if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_97, 4))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), NETWORK::NET_TO_PED(Local_95.f_3), 15f, 15f, 15f, 0, 1, 0))
		{
			func_122(&uLocal_795, 8, NETWORK::NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
			if (func_106(&uLocal_795, "FMAMBAU", "FMA_BPDA", 12, 0, 0, 1))
			{
				BRAIN::TASK_LOOK_AT_ENTITY(NETWORK::NET_TO_PED(Local_95.f_3), AUDIO::_0x0626A247D2405330(), 5000, 0, 2);
				MISC::SET_BIT(&iLocal_97, 4);
			}
		}
	}
	if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_97, 6))
	{
		if (Local_95.f_14 == 4)
		{
			func_122(&uLocal_795, 8, NETWORK::NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
	...
	if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_97, 5))
	{
		if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), Local_95.f_7, (10f * 2f), (10f * 2f), (10f * 2f), 0, 1, 0))
		{
			func_122(&uLocal_795, 8, NETWORK::NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
	...
	if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_97, 7))
	{
		if (Local_95.f_14 == 5)
		{
			func_122(&uLocal_795, 8, NETWORK::NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
	...
	if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_97, 8))
	{
		func_122(&uLocal_795, 8, NETWORK::NET_TO_PED(Local_95.f_3), "FM_DRIVER_BOAT", 0, 1);
	...
	if (Local_95.f_14 == 4)
	{
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) <= 0)
		{
			if (func_66(&uLocal_964, iLocal_963, 0))
			{
				...
				StringCopy(&Var1, "", 16);
				if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_98, iVar0))
				{
					switch (iVar0)
					{
						case 0:
	...
	if (!func_4(Local_95.f_3))
	{
		if (func_70(Local_95.f_2))
		{
			...
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(NETWORK::NET_TO_VEH(Local_95.f_2), AUDIO::_0x0626A247D2405330(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(NETWORK::NET_TO_PED(Local_95.f_3), AUDIO::_0x0626A247D2405330(), 1))
				{
...
void func_103(int iParam0, char* sParam1, int iParam2)//Position - 0x4615
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_104(iParam2), 1);
}

int func_104(int iParam0)//Position - 0x462C
{
	int iVar0;
...
void func_105(var uParam0, bool bParam1, bool bParam2)//Position - 0x4821
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
	{
		if (!bParam2)
...
bool func_106(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x485E
{
...
int func_107(char* sParam0, int iParam1, bool bParam2)//Position - 0x48AC
{
	Global_3DCF = 0;
...
var func_113()//Position - 0x4D9F
{
	func_114();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_114()//Position - 0x4DB8
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_117(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			iVar0 = func_116(AUDIO::_0x0626A247D2405330());
			if (func_115(iVar0) && (!func_118(14) || Global_19A3D))
			{
				if (Global_19E56.f_933.f_21B.f_10CD != iVar0 && func_115(Global_19E56.f_933.f_21B.f_10CD))
				{
...
bool func_115(int iParam0)//Position - 0x4EB5
{
	return iParam0 < 3;
}

int func_116(int iParam0)//Position - 0x4EC1
{
	int iVar0;
	int iVar1;
...
int func_117(int iParam0)//Position - 0x4EFE
{
	if (func_115(iParam0))
	{
...
bool func_118(int iParam0)//Position - 0x4F28
{
	return Global_8D15 == iParam0;
}

void func_119()//Position - 0x4F36
{
	int iVar0;
...
void func_121(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x4FE3
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
void func_122(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x5039
{
...
void func_123()//Position - 0x50D4
{
	AUDIO::SET_AUDIO_FLAG("MobileRadioInGame", 0);
	if (func_3(CAM::_0xDC9DA9E8789F5246(), 1, 1))
	{
		if (PED::IS_PED_SITTING_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), NETWORK::NET_TO_VEH(Local_95.f_2)) && !func_124(AUDIO::_0x0626A247D2405330(), NETWORK::NET_TO_VEH(Local_95.f_2), 4294967295))
		{
...
int func_124(int iParam0, int iParam1, int iParam2)//Position - 0x5125
{
...
void func_126()//Position - 0x51AF
{
	if (func_70(Local_95.f_2))
	{
		BRAIN::OPEN_SEQUENCE_TASK(&uLocal_102);
		BRAIN::TASK_BOAT_MISSION(0, NETWORK::NET_TO_VEH(Local_95.f_2), 0, 0, Local_95.f_7, 4, 12f, 786469, 10f, 1071);
		CUTSCENE::_0x8D9DF6ECA8768583(uLocal_102);
		BRAIN::OPEN_SEQUENCE_TASK(&uLocal_101);
		BRAIN::TASK_VEHICLE_MISSION_COORS_TARGET(0, NETWORK::NET_TO_VEH(Local_95.f_2), Local_95.f_D, 4, 12f, 786469, 0f, 0f, 1);
		BRAIN::TASK_VEHICLE_DRIVE_WANDER(0, NETWORK::NET_TO_VEH(Local_95.f_2), 12f, 786469);
		CUTSCENE::_0x8D9DF6ECA8768583(uLocal_101);
		BRAIN::OPEN_SEQUENCE_TASK(&uLocal_100);
		...
		CUTSCENE::_0x8D9DF6ECA8768583(uLocal_100);
	}
}

int func_127()//Position - 0x5276
{
	return Local_95.f_1;
}

int func_128(int iParam0)//Position - 0x5282
{
	return vLocal_96[iParam0 /*3*/];
}

int func_129()//Position - 0x5290
{
	var uVar0;
...
int func_131()//Position - 0x534E
{
	return Global_6373;
}

bool func_132()//Position - 0x5359
{
	return Global_255C02.f_24B;
}

int func_133(int iParam0)//Position - 0x5368
{
...
bool func_134()//Position - 0x537F
{
	return Global_25824F;
}

bool func_135()//Position - 0x538B
{
	return Global_255C02.f_246;
}

void func_136(var uParam0)//Position - 0x539A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_137(int iParam0)//Position - 0x540D
{
	vector3 vVar0;
	int iVar1;
	int iVar2;
...
int func_138(int iParam0, var uParam1)//Position - 0x548E
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_139()//Position - 0x54ED
{
	SYSTEM::WAIT(0);
}

void func_140()//Position - 0x54FA
{
	func_94();
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_141()//Position - 0x5596
{
	HUD::DISPLAY_SNIPER_SCOPE_THIS_FRAME();
}

void func_142()//Position - 0x55A2
{
	BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_100);
	BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_101);
	BRAIN::CLEAR_SEQUENCE_TASK(&uLocal_102);
}

void func_143(int iParam0, int iParam1, var uParam2)//Position - 0x55BC
{
	struct<4> Var0;
...
int func_144(int iParam0, bool bParam1)//Position - 0x55F4
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_145(struct<21> Param0)//Position - 0x5659
{
	func_149(32, Param0);
	NETWORK::RESERVE_NETWORK_MISSION_PEDS(1);
	NETWORK::RESERVE_NETWORK_MISSION_VEHICLES(1);
	func_147(0, 4294967295, 0);
	...
	vLocal_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*3*/] = 0;
	return 1;
}

int func_146()//Position - 0x56EF
{
	int iVar0;
...
int func_147(int iParam0, int iParam1, bool bParam2)//Position - 0x5748
{
	int iVar0;
...
bool func_148()//Position - 0x585D
{
	return Global_140842;
}

void func_149(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x5869
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_141();
