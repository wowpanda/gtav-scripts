...
void __EntryFunction__()//Position - 0x0
{
	...
	if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_117(uLocal_58, 4194304))
	{
		if (iLocal_69 != 263)
		{
			...
			switch (iLocal_59)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_99(3) && !Global_16C52)
						{
							if (func_117(uLocal_58, 2097152))
							{
								if ((!func_117(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_98())) && !Global_16C52)
								{
									func_110(10);
									break;
								}
						...
						if ((!func_89(6) || Global_19A9D) || func_88())
						{
							bVar3 = false;
						}
						if (func_117(uLocal_58, 1))
						...
						if (bVar3)
						{
							...
							if (fLocal_57 < ((fLocal_77 * fLocal_77) + 4f))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
								{
									...
									{
										func_78("MG_GET_ON_FOOT", 4294967295);
				...
				case 5:
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&Local_52))
					{
						...
						if (iVar4 == 1)
						{
							...
							if (Global_9197)
							{
								func_47(AUDIO::_0x0626A247D2405330());
							}
				...
				case 6:
					...
					if (func_117(Global_19911, 262144))
					{
						func_121(&Global_19911, 262144);
						func_36();
					}
					if (func_117(uLocal_58, 2097152))
					{
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						if (iLocal_63 != 4294967295)
						{
							if (func_117(Global_19911, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_39(iLocal_63), 0, Global_16C55, 0);
								func_28(func_39(iLocal_63), 0, Global_16C55, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_39(iLocal_63), 0, Global_16C55, 0);
								func_28(func_39(iLocal_63), 0, Global_16C55, 0, 0);
							}
						}
						func_4();
						func_121(&Global_19911, 0);
...
{
	if (func_117(Global_19E56.f_4E0F.f_9, 1))
	{
		func_121(&(Global_19E56.f_4E0F.f_9), 1);
		if (iLocal_91 == Global_19E56.f_4E0F.f_8)
		{
			if (Global_19E56.f_4E0F.f_8 != 2)
			{
				Global_19E56.f_4E0F.f_8++;
				if (Global_19E56.f_4E0F.f_8 == 1)
				{
					func_111(108, 1, 0);
					func_20(114, 1, 0, 1, 0);
				}
				else if (Global_19E56.f_4E0F.f_8 == 2)
				{
					func_111(109, 1, 0);
					func_20(115, 1, 0, 1, 0);
				}
				if (iLocal_88 && Global_19E56.f_4E0F.f_8 == 2)
				{
					func_19(62);
				}
				else
...
void func_19(int iParam0)//Position - 0x1387
{
	...
	if (iVar1 < 3)
	{
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_19E56.f_4F9E.f_96[iVar1]), iVar0);
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_19E56.f_4F9E.f_96[iVar1]), iVar0);
	}
}
...
float func_32(int iParam0)//Position - 0x574C
{
	if (func_35(iParam0))
	{
		...
		{
			return (func_33(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
{
	iParam0->f_1 = (func_33(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 4)) - fParam1);
...
void func_60()//Position - 0x5FA9
{
	...
	else if ((PED::IS_PED_INJURED(iLocal_85) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(89, unk_0x8000C77B5F336760(iLocal_85, true), 40f)) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(116, unk_0x8000C77B5F336760(iLocal_85, true), 40f))
	{
		func_78("TRI_DEATH", 4294967295);
		iVar0 = iLocal_69;
		func_72(iLocal_69);
		iLocal_69 = iVar0;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_85))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_85, 0) && !ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
		{
			if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(iLocal_85, true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) <= 144f)
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_85, 150319005) != 1)
				{
					BRAIN::TASK_LOOK_AT_ENTITY(iLocal_85, AUDIO::_0x0626A247D2405330(), 4294967295, 0, 2);
				}
			}
			else if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_85, 150319005) == 1)
			{
...
void func_61()//Position - 0x60B5
{
	...
	if (MISC::GET_GAME_TIMER() > iLocal_90 && fLocal_57 < (30f * 30f))
	{
		...
		if (MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f) <= 0.5f)
		{
			...
			iVar3 = PED::GET_PED_NEARBY_PEDS(AUDIO::_0x0626A247D2405330(), &uVar2, iVar0);
			iVar5 = 0;
			while (iVar5 < iVar3)
			{
...
void func_65()//Position - 0x63D8
{
	...
	{
		if (func_68(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			iVar0 = func_67(AUDIO::_0x0626A247D2405330());
			if (func_66(iVar0) && (!func_101(14) || Global_19A3D))
			{
				if (Global_19E56.f_933.f_21B.f_10CD != iVar0 && func_66(Global_19E56.f_933.f_21B.f_10CD))
				{
...
int func_70(int iParam0)//Position - 0x655E
{
...
void func_72(int iParam0)//Position - 0x65A2
{
	if (iLocal_59 < 5)
	{
		if (iParam0 != 263)
...
int func_73(int iParam0, bool bParam1)//Position - 0x65E5
{
	int iVar0;
...
int func_74(int iParam0)//Position - 0x669D
{
	int iVar0;
...
void func_75(int iParam0)//Position - 0x66D8
{
	int iVar0;
...
void func_76(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x672F
{
	int iVar0;
...
int func_77(var uParam0)//Position - 0x685A
{
	return 1;
}

void func_78(char* sParam0, int iParam1)//Position - 0x6863
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

var func_79()//Position - 0x687A
{
	return Global_10B8E;
}

int func_80(int iParam0)//Position - 0x6886
{
	if (iParam0 == 1)
	{
...
bool func_81(int iParam0, int iParam1)//Position - 0x68E0
{
	switch (iParam0)
	{
		case 5:
...
bool func_82()//Position - 0x691B
{
	return MISC::GET_GAME_TIMER() <= Global_43D7.f_16F1 + 100;
}

int func_83()//Position - 0x6930
{
...
bool func_84(bool bParam0)//Position - 0x694A
{
	if (bParam0)
	{
...
void func_85(var uParam0, int iParam1)//Position - 0x6973
{
	func_86(uParam0, iParam1);
}

void func_86(var uParam0, var uParam1)//Position - 0x6983
{
	*uParam0 = (*uParam0 || uParam1);
}

int func_87()//Position - 0x6994
{
	return 1;
}

bool func_88()//Position - 0x699D
{
	int iVar0;
	bool bVar1;
...
int func_89(int iParam0)//Position - 0x6AA7
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_96()) || Global_19A9D) || Global_6375) || func_95()) || func_81(8, 4294967295)) || func_94()) || func_93()) || func_92()) || func_83()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_96()) || Global_6375) || func_95()) || func_81(8, 4294967295)) || func_92()) || func_94()) || func_93()) || func_83()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_96()) || Global_19A9D) || Global_6375) || func_95()) || func_81(8, 4294967295)) || func_92()) || func_94()) || func_93()) || func_83()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_96()) || Global_19A9D) || Global_6375) || func_95()) || func_81(8, 4294967295)) || func_94()) || func_93()) || func_83()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_96() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_81(8, 4294967295)) || func_83()) || func_91()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_96()) || Global_6375) || func_95()) || func_81(8, 4294967295)) || func_93()) || func_92()) || func_83()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_90()//Position - 0x71C4
{
	return Global_16C57.f_1;
}

int func_91()//Position - 0x71D2
{
...
bool func_93()//Position - 0x7222
{
	return Global_16C64.f_148 > 0;
}

bool func_94()//Position - 0x7233
{
	return Global_16C64.f_147 > 0;
}

var func_95()//Position - 0x7244
{
	return Global_140859;
}

int func_96()//Position - 0x7250
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_98()//Position - 0x7286
{
	return Global_15C47;
}

int func_99(int iParam0)//Position - 0x7292
{
	switch (iParam0)
	{
		case 0:
...
bool func_100(int iParam0)//Position - 0x7304
{
	int iVar0;
...
bool func_101(int iParam0)//Position - 0x7340
{
	return Global_8D15 == iParam0;
}

void func_102()//Position - 0x734E
{
	float fVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	if (bLocal_87)
	{
		...
		if (BRAIN::DOES_SCENARIO_GROUP_EXIST("Triathlon_1_Start") && iLocal_91 == 1)
		{
			BRAIN::SET_SCENARIO_GROUP_ENABLED("Triathlon_1_Start", true);
		}
		if (BRAIN::DOES_SCENARIO_GROUP_EXIST("Triathlon_2_Start") && iLocal_91 == 0)
		{
			BRAIN::SET_SCENARIO_GROUP_ENABLED("Triathlon_2_Start", true);
		}
		if (BRAIN::DOES_SCENARIO_GROUP_EXIST("Triathlon_3_Start") && iLocal_91 == 2)
		{
			BRAIN::SET_SCENARIO_GROUP_ENABLED("Triathlon_3_Start", true);
		}
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_81))
		{
			...
			unk_0x346478B12F69D4E3(iLocal_81, true);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_82))
		{
			...
			unk_0x346478B12F69D4E3(iLocal_82, true);
		...
		{
			if (BRAIN::DOES_SCENARIO_EXIST_IN_AREA(vLocal_79, 3f, 1))
			{
				BRAIN::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_85, vLocal_79, 2f, 0);
			}
			else
			{
				switch (iLocal_91)
				...
				BRAIN::TASK_START_SCENARIO_AT_POSITION(iLocal_85, "PROP_HUMAN_SEAT_CHAIR", vVar3, fVar4, 4294967295, 0, 1);
			}
		}
		iVar8 = 0;
...
int func_103(vector3 vParam0)//Position - 0x773D
{
...
void func_104(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4)//Position - 0x7767
{
	switch (iParam0)
	{
		case 0:
...
float func_105(bool bParam0, float fParam1, float fParam2)//Position - 0x7A9F
{
	if (bParam0)
	{
		return fParam1;
...
Vector3 func_106(bool bParam0, vector3 vParam1, vector3 vParam2)//Position - 0x7AB6
{
	if (bParam0)
	{
		return vParam1;
	...
	if (bLocal_87)
	{
		...
		switch (iLocal_91)
		{
			case 0:
				...
				{
					PED::IS_PED_VAULTING("AP1_04_TriAf01");
				}
				break;
			...
			case 1:
				...
				{
					PED::IS_PED_VAULTING("CS2_06_TriAf02");
				}
				break;
			...
			case 2:
				...
				{
					PED::IS_PED_VAULTING("CS4_04_TriAf03");
				}
				break;
			}
	}
...
void func_109(var uParam0, int iParam1)//Position - 0x7BE4
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_110(int iParam0)//Position - 0x7BF5
{
	iLocal_59 = iParam0;
}

void func_111(int iParam0, bool bParam1, bool bParam2)//Position - 0x7C01
{
	int iVar0;
	bool bVar1;
...
bool func_114(int iParam0, int iParam1)//Position - 0x7D4D
{
	bool bVar0;
...
bool func_115(int iParam0)//Position - 0x7D9A
{
	return func_116(iParam0, Global_8D15);
}

int func_116(int iParam0, int iParam1)//Position - 0x7DAB
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_117(var uParam0, int iParam1)//Position - 0x7F8C
{
	return (uParam0 && iParam1) != 0;
}

void func_118()//Position - 0x7F9B
{
	...
	if (Global_19E56.f_4E0F.f_8 == 4294967295)
	{
		Global_19E56.f_4E0F.f_8 = 0;
	}
	if (Global_19E56.f_4E0F.f_8 < iLocal_91)
	{
		func_85(&uLocal_58, 8388608);
	}
}
...
void func_126(bool bParam0, int iParam1)//Position - 0x8285
{
	...
	if (bParam0)
	{
		func_127(&(Global_43D7.f_161A[iVar0 /*10*/]));
