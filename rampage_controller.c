...
void __EntryFunction__()
{
	...
	iLocal_30 = 52;
	iLocal_28 = 77;
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("rampage_controller")) > 1)
	{
	...
	while (iVar0 < 5)
	{
		...
		SET_BIT(&(Global_106565.f_18568[(iLocal_30 + iVar0) /*6*/]), 3);
		iVar0++;
	}
	func_18(1);
	while (true)
...
void func_18(bool bParam0)
{
	...
	while (iVar0 < 5)
	{
		...
		func_22(iVar1, 1);
		func_21(iVar1, 44);
		if (((Global_106565.f_2346[iVar0 /*2*/] >= 1 || func_35(108) == 1) || func_20((iLocal_29 + iVar0), 0)) || IS_BIT_SET(Global_106565.f_18568[(iLocal_30 + iVar0) /*6*/], 3))
		{
			func_19(iVar1, 1);
		}
		iVar0++;
