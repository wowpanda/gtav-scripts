...
void __EntryFunction__()
{
	...
	{
		func_47();
		if ((!NETWORK_IS_GAME_IN_PROGRESS() || func_35()) || Global_1316809 == 0)
		{
			func_32();
		}
		func_3();
...
void func_1()
{
	...
	if (iLocal_21 == 1)
	{
		...
		if (iVar0 > -1)
		{
			if (DOES_ENTITY_EXIST(Local_25[iVar0 /*13*/]) && !IS_ENTITY_DEAD(Local_25[iVar0 /*13*/], 0))
			{
				PLAY_STREAM_FROM_PED(Local_25[iVar0 /*13*/]);
				iLocal_21++;
			}
		}
	}
...
int func_2()
{
	...
	while (iVar3 < 50)
	{
		...
		{
			fVar1 = VDIST(Local_25[iVar3 /*13*/].f_6, 945f, 15f, 117f);
			if (fVar1 < fVar0)
			{
				fVar0 = fVar1;
				iVar2 = iVar3;
...
void func_3()
{
	...
	while (iVar0 < 50)
	{
		...
		{
			if (!DOES_ENTITY_EXIST(Local_25[iVar0 /*13*/]))
			{
				func_11(&(Local_25[iVar0 /*13*/]));
			}
			else if (IS_ENTITY_DEAD(Local_25[iVar0 /*13*/], 0))
			{
...
void func_5(var uParam0)
{
	...
	uVar2 = GET_RANDOM_FLOAT_IN_RANGE(0f, 0.7f);
	...
	if (iVar3 != 0 && iVar3 != 1)
	{
		if (HAS_ANIM_DICT_LOADED(uVar0))
		{
			...
			if (!func_7(uParam0))
			{
				if (func_6(uParam0))
				{
					TASK_PLAY_ANIM_ADVANCED(0, uVar0, uVar1, uParam0->f_6, 0f, 0f, uParam0->f_9, 1090519040, -1056964608, -1, 790529, uVar2, 2, 3);
				}
				else
				{
					TASK_PLAY_ANIM(0, uVar0, uVar1, 1090519040, -1056964608, -1, 1, uVar2, 0, 0, 0);
				}
			}
			else
			{
				...
				while (iVar12 < 4)
				{
					...
					{
						case 0:
							TASK_PLAY_ANIM(0, uVar0, "IDLE_A", 1090519040, -1056964608, -1, 0, 0f, 0, 0, 0);
							break;
						
						case 1:
							TASK_PLAY_ANIM(0, uVar0, "IDLE_B", 1090519040, -1056964608, -1, 0, 0f, 0, 0, 0);
							break;
						
						case 2:
							TASK_PLAY_ANIM(0, uVar0, "IDLE_C", 1090519040, -1056964608, -1, 0, 0f, 0, 0, 0);
							break;
						
						case 3:
							TASK_PLAY_ANIM(0, uVar0, "IDLE_D", 1090519040, -1056964608, -1, 0, 0f, 0, 0, 0);
							break;
					}
					iVar12++;
				}
...
void func_11(var uParam0)
{
	if (iLocal_20 < 2)
	{
		...
		if (func_28(uParam0))
		{
			*uParam0 = CREATE_PED(26, func_26(uParam0), uParam0->f_6, uParam0->f_9, 0, 0);
			if (DOES_ENTITY_EXIST(*uParam0))
			{
				...
				if (func_16(uParam0))
				{
					if (!DOES_ENTITY_EXIST(uParam0->f_1))
					{
						uParam0->f_1 = CREATE_OBJECT(func_15(uParam0), GET_PED_BONE_COORDS(*uParam0, func_14(uParam0), 0f, 0f, 0f), 0, 0, 0);
						ATTACH_ENTITY_TO_ENTITY(uParam0->f_1, *uParam0, GET_PED_BONE_INDEX(*uParam0, func_14(uParam0)), func_13(uParam0), 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
					}
				}
				if (func_7(uParam0))
				{
					SET_PED_ALTERNATE_MOVEMENT_ANIM(*uParam0, 0, func_12(uParam0), "BASE", 1090519040, 1);
				}
				iLocal_20++;
			}
		}
...
void func_17(var uParam0)
{
	...
	SET_PED_CONFIG_FLAG(*uParam0, 108, 1);
	SET_PED_CONFIG_FLAG(*uParam0, 106, 1);
...
void func_18(var uParam0, var uParam1, var uParam2)
{
	...
	while (iVar0 < 12)
	{
		uVar22 = GET_PED_DRAWABLE_VARIATION(uParam0, iVar0);
		uVar23 = GET_PED_TEXTURE_VARIATION(uParam0, iVar0);
		if (iVar0 < 10)
		{
			Var1[iVar0 /*2*/] = uVar22;
...
void func_20(var uParam0, int iParam1, int iParam2)
{
	switch (iParam1)
	{
		case 0:
			...
			CLEAR_BIT(uParam0, iParam2 + 1);
			CLEAR_BIT(uParam0, iParam2 + 2);
			break;
...
void func_22(var uParam0, struct<2>[] Param1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21)
{
	...
	while (iVar0 < 10)
	{
		SET_PED_COMPONENT_VARIATION(uParam0, iVar0, Param1[iVar0 /*2*/], Param1[iVar0 /*2*/].f_1, 0);
		iVar0++;
	}
}
...
int func_28(var uParam0)
{
	if (func_30(uParam0))
	{
		if (HAS_MODEL_LOADED(func_26(uParam0)) && HAS_ANIM_DICT_LOADED(func_9(uParam0)))
		{
			if (func_7(uParam0))
			{
				if (!HAS_ANIM_DICT_LOADED(func_12(uParam0)))
				{
					return 0;
				}
			}
			if (func_16(uParam0))
			{
				if (HAS_MODEL_LOADED(func_15(uParam0)))
				{
					return 1;
				}
				else
...
void func_29(var uParam0)
{
	if (func_30(uParam0))
	{
		REQUEST_MODEL(func_26(uParam0));
		REQUEST_ANIM_DICT(func_9(uParam0));
		if (func_7(uParam0))
		{
			REQUEST_ANIM_DICT(func_12(uParam0));
		}
		if (func_16(uParam0))
		{
			REQUEST_MODEL(func_15(uParam0));
		}
	}
}
...
int func_35()
{
	...
	if (func_36() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_36()) == 0)
		{
			return 1;
		}
	}
...
void func_54()
{
	while (!_NETWORK_IS_THIS_SCRIPT_MARKED(32, 0, Global_1316818))
	{
		WAIT(0);
	}
	Global_1316818++;
	func_55(0, -1, 0);
	NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&vLocal_22, 3);
}
