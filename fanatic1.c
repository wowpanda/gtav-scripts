	...
	switch (iLocal_55)
	{
		case 0:
			...
			if ((iLocal_58 == 1 || iLocal_58 == 0) || iLocal_58 == 2)
			{
				if (func_427(iLocal_244))
				{
					BRAIN::TASK_SMART_FLEE_PED(iLocal_244, PLAYER::PLAYER_PED_ID(), 80f, -1, 0, 0);
				}
			}
			switch (iLocal_58)
			{
...
void func_2(int iParam0, var uParam1)
{
	...
	Global_105220.f_2354.f_539.f_2312[iParam0] = uParam1;
}
...
void func_25()
{
	...
	{
		if (func_27(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_26(PLAYER::PLAYER_PED_ID());
			if (func_3(iVar0) && (!func_28(14) || Global_104171))
			{
...
void func_35()
{
	...
	switch (iLocal_55)
	{
		case 0:
			...
			BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1celebrate", "celebrate", 4f, -16f, -1, 286720, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, "move_f@runner", "idle", 16f, -4f, -1, 270337, 0, 0, 0, 0);
			BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
			BRAIN::TASK_PERFORM_SEQUENCE(iLocal_244, iLocal_77);
...
void func_37()
{
	...
	switch (iLocal_55)
	{
		case 0:
			...
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_344);
				BRAIN::TASK_SMART_FLEE_PED(iLocal_344, PLAYER::PLAYER_PED_ID(), 40f, -1, 0, 0);
			}
			if (func_34())
			{
			...
			if (bLocal_68)
			{
				...
				func_286();
				if (func_285(PLAYER::PLAYER_PED_ID(), iLocal_244) > 32f)
				{
					ENTITY::SET_ENTITY_COORDS(iLocal_244, -1986.2f, -526.22f, 11f, 1, false, 0, 1);
					ENTITY::SET_ENTITY_HEADING(iLocal_244, 58.26f);
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
					BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(0, sLocal_348, func_282(), 1040, -1);
					BRAIN::TASK_PLAY_ANIM(0, "move_f@runner", "idle", 4f, -4f, -1, 1, 0, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_244, iLocal_77);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
					PED::FORCE_PED_MOTION_STATE(iLocal_244, -530524, true, 1, 0);
				}
				BRAIN::TASK_LOOK_AT_ENTITY(iLocal_244, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_356, 1f, 20000, 0.5f, 0, 1193033728);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
				BRAIN::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iLocal_77);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
			...
			while (iVar5 <= 3)
			{
				if (func_300(Local_325[iVar5 /*12*/]))
				{
					...
					{
						BRAIN::CLEAR_PED_TASKS(Local_325[iVar5 /*12*/]);
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
						...
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
						BRAIN::TASK_PERFORM_SEQUENCE(Local_325[iVar5 /*12*/], iLocal_77);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
			...
			switch (iLocal_308)
			{
				case 1:
					if (bLocal_68)
					{
						if (BRAIN::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), 242628503) == 7)
						{
							...
							{
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
								BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1out_of_breath", "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
								BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
								BRAIN::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iLocal_77);
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
								iLocal_310 = 1;
					...
					else
					{
						...
						if (func_427(iLocal_244))
						{
							BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_348, ENTITY::GET_ENTITY_COORDS(iLocal_244, true), &iVar6);
							if (iVar6 >= 125)
							{
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
								BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "jogging_up", 8f, -16f, -1, 262144, 0, 0, 0, 0);
								BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "jogging_on_spot", 16f, -4f, -1, 262145, 0, 0, 0, 0);
								BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
								BRAIN::TASK_PERFORM_SEQUENCE(iLocal_244, iLocal_77);
								BRAIN::TASK_LOOK_AT_ENTITY(iLocal_244, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
								if (iLocal_59 == 0)
								...
								if (func_272(&uLocal_78, "FAN1AU", "FAN1_DONE", "FAN1_DONE_1", "FAN1_DONE", sLocal_311, "FAN1_DONE", "FAN1_DONE_4", "FAN1_DONE", "FAN1_DONE_5", 7, 0, 0))
								{
									...
									iLocal_308 = 2;
									BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_244, 4000, 0, 2);
									iLocal_308 = 2;
								}
							}
						}
					...
					if (bLocal_68)
					{
						switch (iLocal_309)
						{
							...
							case 1:
								...
								{
									BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
									BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_304, -1, 0, 2);
									BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -2003.36f, -503.77f, 10.48f, 2f, 20000, 1f, 10241, 1193033728);
									BRAIN::TASK_ENTER_VEHICLE(0, iLocal_304, 20000, -1, 1f, 1, 0);
									BRAIN::TASK_CLEAR_LOOK_AT(0);
									BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 2000, 0, 2);
									...
									BRAIN::SET_ANIM_LOOPED(PLAYER::PLAYER_PED_ID(), 0, 0, 0);
									BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
									BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1out_of_breath", "base", 8f, -8f, -1, 0, 0, 0, 0, 0);
									BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_244, -1, 0, 2);
						...
						if (AUDIO::GET_CURRENT_SCRIPTED_CONVERSATION_LINE() > 2)
						{
							if (!bLocal_69)
							{
								if (func_7(iLocal_304))
								{
									...
									BRAIN::TASK_ENTER_VEHICLE(0, iLocal_304, 20000, -1, 2f, 1, 0);
									BRAIN::TASK_CLEAR_LOOK_AT(0);
									BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 2000, 0, 2);
							...
							else
							{
								...
								BRAIN::TASK_CLEAR_LOOK_AT(0);
								BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 2000, 0, 2);
								BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1954.1f, -450.9f, 16.77f, 2f, 20000, 0.25f, 0, 1193033728);
								BRAIN::TASK_WANDER_STANDARD(0, 1193033728, 0);
								BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
								BRAIN::TASK_PERFORM_SEQUENCE(iLocal_244, iLocal_77);
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
							...
							BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_244, 6000, 0, 2);
							iLocal_308 = 3;
						}
					}
					break;
					...
					else
					{
						...
						if (bLocal_69)
						{
							if (!iLocal_70)
							{
								if (func_427(iLocal_244))
								{
									BRAIN::CLEAR_PED_TASKS(iLocal_244);
									BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
									BRAIN::TASK_CLEAR_LOOK_AT(0);
									BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1954.1f, -450.9f, 16.77f, 2f, 20000, 0.25f, 0, 1193033728);
									BRAIN::TASK_WANDER_STANDARD(0, 1193033728, 0);
				...
				case 4:
					...
					else if (!func_34())
					{
						...
						{
							BRAIN::TASK_CLEAR_LOOK_AT(PLAYER::PLAYER_PED_ID());
							BRAIN::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "rcmfanatic1out_of_breath", "p_zero_tired_exit", 1000f, -2f, -1, 48, 0, 0, 0, 0);
...
void func_39()
{
	if ((((iLocal_56 != 7 && iLocal_56 != 10) && iLocal_56 != 8) && iLocal_56 != 10) && iLocal_56 != 9)
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (func_40(iLocal_244, 1126825984) || func_285(PLAYER::PLAYER_PED_ID(), iLocal_244) < 7f)
			{
				iLocal_57 = iLocal_56;
				iLocal_55 = 0;
				iLocal_56 = 7;
...
void func_64(int iParam0, bool bParam1)
{
	...
	{
		func_225(&(Global_104307[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
...
void func_67()
{
	...
	{
		func_69(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
...
int func_92(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_70793[1 /*14*/] = { func_143(iVar0, iParam1, uVar6[iParam1]) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_135(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_135(iParam1), Global_70793[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_135(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, 0);
		}
	}
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_70793[1 /*14*/] = { func_143(iVar10, 14, uVar12[iVar1]) };
							func_111(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
							func_126(14);
							if (Global_70791 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_135(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_135(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_135(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
						}
						func_126(iVar0);
						if (Global_70791 == 1)
						{
			...
			{
				Global_70793[1 /*14*/] = { func_143(iVar10, iVar0, func_101(iParam0, iVar0, -1)) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_70793[1 /*14*/] = { func_143(iVar10, 14, uVar15[iVar1]) };
			func_111(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
			func_126(14);
			if (Global_70791 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_135(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_135(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_135(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
		}
		if (Global_70791 == 1)
		{
			iVar2 = 0;
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_135(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_118(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_135(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_113(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_113(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_113(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_113(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_126(int iParam0)
{
	...
	{
		func_132(iParam0, Global_70793[1 /*14*/].f_5, Global_70793[1 /*14*/].f_2, 2, Global_70793[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_128(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_129(iParam2)];
	if (iVar0 != 0)
	{
...
int func_130(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_129(iParam1)];
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_142(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[0], Global_105220.f_2354.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_142(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[1], Global_105220.f_2354.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_142(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[2], Global_105220.f_2354.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_145(int iParam0)
{
	...
	func_146(&(Global_70793[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_130(func_149(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_130(func_148(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_130(iVar1, Global_70790, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_146(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
		...
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_146(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_207(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_70793[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_135(iParam1)) && Global_70793[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_135(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_214(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_215(&sVar1, Var0.f_3, Global_92992, iParam1, iParam2);
	}
}
...
void func_220()
{
	...
	{
		func_25();
		GRAPHICS::_0xBF59707B3E5ED531(func_221(Global_105220.f_2354.f_539.f_4301));
	}
	else
	{
...
{
	func_230(iParam0, 1);
	Global_105220.f_18545[iParam0 /*6*/].f_3 = func_229();
...
void func_271()
{
	...
	if (iLocal_63 == 0)
	{
		if (BRAIN::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), 242628503) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), 242628503) != 0)
		{
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_379);
			...
			BRAIN::CLOSE_SEQUENCE_TASK(iLocal_379);
			BRAIN::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iLocal_379);
			func_33("Starting out of breath anim loop");
			iLocal_63 = 1;
			BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_379);
		}
	}
...
void func_280()
{
	...
	while (iVar0 <= 1)
	{
		if (func_300(Local_325[iVar0 /*12*/]) && PED::IS_PED_RAGDOLL(Local_325[iVar0 /*12*/]))
		{
			BRAIN::CLEAR_PED_TASKS(Local_325[iVar0 /*12*/]);
			BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
			...
			BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
			BRAIN::TASK_PERFORM_SEQUENCE(Local_325[iVar0 /*12*/], iLocal_77);
			BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
		}
		if (func_427(Local_325[iVar0 /*12*/]))
		{
			...
			{
				BRAIN::CLEAR_PED_TASKS(Local_325[iVar0 /*12*/]);
				BRAIN::TASK_SMART_FLEE_PED(Local_325[iVar0 /*12*/], PLAYER::PLAYER_PED_ID(), 200f, -1, 1, 0);
		...
		if (iLocal_351 > 114)
		{
			if (func_300(Local_325[2 /*12*/]) && func_300(Local_325[3 /*12*/]))
			{
				...
				while (iVar1 <= 3)
				{
					...
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_325[iVar1 /*12*/], iLocal_77);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
					iVar1++;
				}
				BRAIN::TASK_LOOK_AT_ENTITY(Local_325[2 /*12*/], Local_325[3 /*12*/], -1, 0, 2);
				BRAIN::TASK_LOOK_AT_ENTITY(Local_325[3 /*12*/], Local_325[2 /*12*/], -1, 0, 2);
			}
			if (func_300(iLocal_344))
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_344);
	...
	else
	{
		...
		while (iVar2 <= 3)
		{
			if (func_300(Local_325[iVar2 /*12*/]) && PED::IS_PED_RAGDOLL(Local_325[iVar2 /*12*/]))
			{
				BRAIN::CLEAR_PED_TASKS(Local_325[iVar2 /*12*/]);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
				...
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
				BRAIN::TASK_PERFORM_SEQUENCE(Local_325[iVar2 /*12*/], iLocal_77);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
			}
			if (func_427(Local_325[iVar2 /*12*/]))
			{
				...
				{
					BRAIN::CLEAR_PED_TASKS(Local_325[iVar2 /*12*/]);
					BRAIN::TASK_SMART_FLEE_PED(Local_325[iVar2 /*12*/], PLAYER::PLAYER_PED_ID(), 200f, -1, 1, 0);
...
var func_282()
{
	...
	BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_348, func_283(), &uVar0);
	return uVar0;
}
...
void func_284()
{
	...
	{
		BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_348, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), &iLocal_351);
		BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_348, ENTITY::GET_ENTITY_COORDS(iLocal_244, true), &iLocal_352);
...
void func_287(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
void func_291(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
...
int func_296(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_297(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_301()
{
	switch (iLocal_55)
	{
		case 0:
			...
			BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(iLocal_244, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 3f, -1, 3f, 1);
		...
		case 1:
			if (iLocal_257)
			{
				if (func_285(PLAYER::PLAYER_PED_ID(), iLocal_244) < 4f)
				{
					BRAIN::CLEAR_PED_TASKS(iLocal_244);
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_244, PLAYER::PLAYER_PED_ID(), -1);
					iLocal_257 = 0;
				}
			}
			else if (func_285(PLAYER::PLAYER_PED_ID(), iLocal_244) > 5f)
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_244);
				BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(iLocal_244, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 3f, -1, 3f, 1);
				iLocal_257 = 1;
			...
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				if (!MISC::IS_STRING_NULL(sLocal_348))
				{
					if (BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_348))
					{
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
						BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_283(), 3f, 20000, 0.25f, 0, 1193033728);
						BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(0, sLocal_348, func_282(), 1040, -1);
						BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						BRAIN::TASK_PLAY_ANIM(0, "move_f@runner", "idle", 4f, -4f, -1, 1, 0, 0, 0, 0);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
...
void func_305()
{
	...
	switch (iLocal_55)
	{
		...
		case 1:
			...
			{
				if (func_318() && func_285(PLAYER::PLAYER_PED_ID(), iLocal_244) < 25f)
				{
					if (func_17(&uLocal_78, "FAN1AU", vLocal_292.x, 7, 0, 0, 0))
					{
						vLocal_292.z = 1;
						BRAIN::TASK_PLAY_ANIM(iLocal_244, "rcmfanatic1yell", "yell_c", 8f, -8f, -1, 48, 0, 0, 0, 0);
					}
				}
			}
			if (func_316(vLocal_292.x))
			{
				if (func_285(PLAYER::PLAYER_PED_ID(), iLocal_244) > 30f)
				{
					func_15();
				}
			}
...
int func_306(char* sParam0, char* sParam1, bool bParam2, var uParam3)
{
...
bool func_307(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_308()
{
	switch (iLocal_378)
	{
		...
		case 1:
			if (iLocal_364 >= 7)
			{
				if (func_7(iLocal_332))
				{
					...
					{
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
						BRAIN::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(0, iLocal_332, "Fanatic1Quad", 16, 14, 0, -1, -1f, 0, 1073741824);
						BRAIN::TASK_LEAVE_VEHICLE(0, iLocal_332, 0);
						BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_329, -1, 0, 2);
						BRAIN::TASK_GO_STRAIGHT_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_329, true), 1.8f, 20000, 1193033728, 1056964608);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_328, iLocal_77);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
			...
			if (func_300(iLocal_328) && func_300(iLocal_329))
			{
				...
				if (func_309())
				{
					...
					else
					{
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
						BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
						BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 80f, -1, 0, 0);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_328, iLocal_77);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
						if (func_300(iLocal_330))
						{
							...
							BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 80f, -1, 0, 0);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_330, iLocal_77);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
						}
						if (func_300(iLocal_331))
						{
							...
							BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 80f, -1, 0, 0);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_331, iLocal_77);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
						}
						iLocal_378 = 8;
					}
		...
		case 5:
			if (func_300(iLocal_328) && !PED::IS_PED_FLEEING(iLocal_328))
			{
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
				BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
				BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "KNEEL_EXIT", 4f, -8f, -1, 8192, 0, 0, 0, 0);
				BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 80f, -1, 0, 0);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_328, iLocal_77);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
			}
			if (func_300(iLocal_330) && !PED::IS_PED_FLEEING(iLocal_330))
			{
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
				BRAIN::TASK_PAUSE(0, 200);
				BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 80f, -1, 0, 0);
			...
			if (func_300(iLocal_331) && !PED::IS_PED_FLEEING(iLocal_331))
			{
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
				BRAIN::TASK_PAUSE(0, 500);
				BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 80f, -1, 0, 0);
		...
		case 6:
			if (func_300(iLocal_328))
			{
				...
				{
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_329, true), 1f, 20000, 1.5f, 0, 1193033728);
				}
		...
		case 7:
			...
			if (func_309())
			{
				if (func_300(iLocal_328) && !PED::IS_PED_FLEEING(iLocal_328))
				{
					BRAIN::TASK_SMART_FLEE_PED(iLocal_328, PLAYER::PLAYER_PED_ID(), 80f, -1, 0, 0);
				}
				if (func_300(iLocal_330) && !PED::IS_PED_FLEEING(iLocal_330))
				{
					BRAIN::TASK_SMART_FLEE_PED(iLocal_330, PLAYER::PLAYER_PED_ID(), 80f, -1, 0, 0);
				}
				if (func_300(iLocal_331) && !PED::IS_PED_FLEEING(iLocal_331))
				{
					BRAIN::TASK_SMART_FLEE_PED(iLocal_331, PLAYER::PLAYER_PED_ID(), 80f, -1, 0, 0);
				}
				iLocal_378 = 8;
			}
			break;
	...
	if (func_300(iLocal_330) && !PED::IS_PED_FLEEING(iLocal_330))
	{
		...
		{
			BRAIN::CLEAR_PED_TASKS(iLocal_330);
			func_281(&iLocal_330, 1, 0, 1);
		}
	}
	if (func_300(iLocal_331) && !PED::IS_PED_FLEEING(iLocal_331))
	{
		...
		{
			BRAIN::CLEAR_PED_TASKS(iLocal_331);
			func_281(&iLocal_331, 1, 0, 1);
		}
	}
	if (func_300(iLocal_329))
...
void func_310(bool bParam0)
{
	if (!func_7(iLocal_332))
	{
		...
		BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
		BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_329, 0);
		BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "idle_a", 4f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "base", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "base", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "idle_C", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "base", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "idle_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "base", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "base", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "base", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "idle_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::SET_SEQUENCE_TO_REPEAT(iLocal_77, 1);
		BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
		BRAIN::TASK_PERFORM_SEQUENCE(iLocal_330, iLocal_77);
		BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
		...
		BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
		BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_329, 0);
		BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "base", 4f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "idle_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "idle_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "base", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "base", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "idle_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, "rcmfanatic1", "idle_b", 8f, -4f, -1, 0, 0, 0, 0, 0);
		...
		else
		{
			...
			BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_329, -1, 0, 2);
			BRAIN::TASK_LEAVE_VEHICLE(0, iLocal_332, 0);
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_329, true), 1.8f, 20000, 0.25f, 0, 1193033728);
			BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
			BRAIN::TASK_PERFORM_SEQUENCE(iLocal_328, iLocal_77);
			BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
			iLocal_378 = 2;
		...
		switch (iLocal_347)
		{
			...
			case 1:
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (iLocal_351 == 109)
					{
						BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(iLocal_344, PLAYER::PLAYER_PED_ID(), -2f, 2f, 0f, 2.5f, -1, 0.2f, 1);
						iLocal_347 = 2;
					}
				}
				break;
	...
	if (!func_427(Local_325[0 /*12*/]))
	{
		...
		if ((STREAMING::HAS_MODEL_LOADED(iLocal_326) && STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_beach_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("a_f_y_beach_01")))
		{
			if (!ENTITY::DOES_ENTITY_EXIST(Local_325[0 /*12*/]))
			{
				...
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_325[0 /*12*/].f_5, 2f, 20000, 0.25f, 0, 1193033728);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_325[0 /*12*/].f_8, 2f, 20000, 0.25f, 0, 1193033728);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_325[0 /*12*/], iLocal_77);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(Local_325[1 /*12*/]))
			{
				...
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_325[1 /*12*/].f_5, 2.05f, 20000, 0.25f, 0, 1193033728);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_325[1 /*12*/].f_8, 2.05f, 20000, 0.25f, 0, 1193033728);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_325[1 /*12*/], iLocal_77);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
				}
			}
...
void func_319()
{
	switch (iLocal_55)
	{
		case 0:
			...
			{
				BRAIN::CLEAR_PED_TASKS(Local_322);
	...
	switch (iLocal_55)
	{
		case 0:
			...
			if (func_7(Local_324.f_2) && func_300(Local_324))
			{
				...
				BRAIN::TASK_VEHICLE_MISSION_COORS_TARGET(Local_324, Local_324.f_2, Local_324.f_8, 4, Local_324.f_12, 786599, 3f, 3f, 1);
		...
		case 1:
			...
			if (func_318())
			{
				if (vLocal_286.z == 0)
				{
					if (func_427(iLocal_244))
					{
						BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_348, ENTITY::GET_ENTITY_COORDS(iLocal_244, true), &iVar0);
					}
					if (iVar0 <= 52)
					{
	...
	if ((func_300(Local_322.f_1) && func_7(Local_322.f_2)) && func_300(Local_322))
	{
		switch (iLocal_323)
		{
			...
			case 2:
				...
				BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(0, Local_322.f_2, Local_322.f_8, Local_322.f_12, 0, Local_322.f_4, 16, 10f, 10f);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
				BRAIN::TASK_PERFORM_SEQUENCE(Local_322, iLocal_77);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
				iLocal_71 = 0;
				iLocal_323 = 3;
				break;
						...
						if (iLocal_243 == 0)
						{
							if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
							{
								if (func_17(&uLocal_78, "FAN1AU", vLocal_289.x, 9, 0, 0, 0))
								{
									...
									BRAIN::TASK_PLAY_ANIM(iLocal_244, "rcmfanatic1yell", "yell_d", 8f, -8f, -1, 48, 0, 0, 0, 0);
									iLocal_323 = 4;
									iLocal_243 = 0;
									if (iLocal_246 == 1)
									{
			...
			case 4:
				...
				BRAIN::TASK_PERFORM_SEQUENCE(Local_322, iLocal_77);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_77);
				BRAIN::TASK_DRIVE_BY(Local_322.f_1, iLocal_244, 0, 0f, 0f, 0f, 25f, 100, 0, -957453492);
			...
			case 6:
				if ((MISC::GET_GAME_TIMER() - iLocal_369) > 3000)
				{
					...
					if (func_300(Local_324.f_1))
					{
						...
						BRAIN::CLEAR_PED_TASKS(Local_324.f_1);
...
void func_332()
{
	...
	switch (iLocal_55)
	{
		...
		case 1:
			if (!Global_105220.f_18545.f_384)
			{
				if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
				{
					func_50("FAN_HELP", -1);
					Global_105220.f_18545.f_384 = 1;
				}
			}
			if (iLocal_67 == 1)
			{
			...
			if (func_427(iLocal_244))
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_244, 242628503) != 1)
				{
					...
					BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(0, sLocal_348, 1, 1052, -1);
					BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					BRAIN::TASK_PLAY_ANIM(0, "move_f@runner", "idle", 4f, -4f, -1, 1, 0, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_244, iLocal_77);
			...
			if (vLocal_295.z == 0)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1772.762f, -532.9971f, 35.58929f, -1797.246f, -492.1292f, 39.2704f, 26f, 0, true, 0) || func_333(PLAYER::PLAYER_PED_ID(), -1812.91f, -468.5253f, 41.32029f, 1) < 10f)
				{
					if (func_34())
					{
						func_15();
			...
			if (iLocal_64 == 1)
			{
				if (vLocal_301.z == 0)
				{
					if (func_285(PLAYER::PLAYER_PED_ID(), iLocal_244) < 10f)
					{
...
float func_333(int iParam0, vector3 vParam1, bool bParam2)
{
	vector3 vVar0;
...
int func_338(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
int func_341(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_344(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_343(PLAYER::PLAYER_PED_ID(), -828834893))
				{
					...
					if (func_427(iLocal_244))
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_244, "rcmfanatic1", "ef_1_rcm_mary_ann_streching_base", 3))
						{
							if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_244, "rcmfanatic1", "ef_1_rcm_mary_ann_streching_base") < 0.1f)
							{
								...
								func_335(&uLocal_78, 3, iLocal_244, "MARYANN", 0, 1);
								func_335(&uLocal_78, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
								BRAIN::TASK_PLAY_ANIM_ADVANCED(iLocal_244, "rcmfanatic1", "ef_1_rcm_mary_ann_leadin", -1878.223f, -440.5181f, 46.03983f, 0f, 0f, 159.97f, 8f, -8f, -1, 262154, 0, 2, 0);
		...
		case 1:
			if (func_300(iLocal_244))
			{
				...
				if (func_38(PLAYER::PLAYER_PED_ID(), iLocal_244, 1) <= 4f)
				{
					...
					if (!func_343(PLAYER::PLAYER_PED_ID(), -875674219))
					{
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_244, 0);
						BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_244, -1, 0, 2);
					}
				}
			}
			break;
...
void func_349()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_344(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_352()
{
	if (func_300(iLocal_244))
	{
		...
		func_363();
		if (func_285(PLAYER::PLAYER_PED_ID(), iLocal_244) > 80f)
		{
			if (iLocal_256 == 0)
			{
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_244, true, 1);
		...
		if ((iLocal_56 != 8 && iLocal_56 != 7) && iLocal_56 != 9)
		{
			if (iLocal_243 != 1)
			{
				if (func_285(PLAYER::PLAYER_PED_ID(), iLocal_244) > 25f)
				{
					func_362(1);
				}
			}
		...
		if (iLocal_243 != 0)
		{
			if (func_285(PLAYER::PLAYER_PED_ID(), iLocal_244) < 24f)
			{
				func_362(0);
			}
		}
	...
	if (func_300(iLocal_244))
	{
		if (!MISC::IS_STRING_NULL(sLocal_348))
		{
			if (BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_348))
			{
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_77);
				BRAIN::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
				BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(0, sLocal_348, func_282(), 1052, -1);
				BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
				BRAIN::TASK_PLAY_ANIM(0, "move_f@runner", "idle", 4f, -4f, -1, 1, 0, 0, 0, 0);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_77);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_244, iLocal_77);
			...
			if (func_427(iLocal_244))
			{
				if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_244, -1809.173f, -549.0106f, 14.03168f, -1841.729f, -529.4575f, 33.6412f, 21.75f, 0, true, 0))
				{
					if (fLocal_253 >= 2.5f)
					{
						if (func_427(iLocal_244))
						{
							BRAIN::TASK_LOOK_AT_ENTITY(iLocal_244, PLAYER::PLAYER_PED_ID(), 1500, 3120, 4);
						}
...
void func_358()
{
	...
	{
		BRAIN::WAYPOINT_RECORDING_GET_COORD(sLocal_348, iLocal_352 + 1, &vVar0);
		if (func_333(PLAYER::PLAYER_PED_ID(), vVar0, 1) < func_333(iLocal_244, vVar0, 1))
		{
			func_360();
		}
		else
...
void func_359()
{
	...
	fVar0 = (4.5f - (func_285(PLAYER::PLAYER_PED_ID(), iLocal_244) / 2f));
	if (fVar0 < 1.8f)
	{
		fVar0 = 1.8f;
	}
...
void func_366()
{
	if (!Global_105220.f_18545.f_385)
	{
		...
		if (iLocal_56 < 8 && iLocal_56 > 1)
		{
			...
			if (iLocal_351 > iLocal_352)
			{
				if (iLocal_349 != 1)
				{
					...
					{
						func_334("Can't do overtake line, overtake timer is = ", (MISC::GET_GAME_TIMER() - iLocal_276));
					}
				}
			}
			else if (iLocal_351 < iLocal_352)
			...
			else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_244, true), vLocal_363[func_380() /*3*/], true) < MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_363[func_380() /*3*/], true))
			{
				if (iLocal_349 != 2)
				{
					iLocal_349 = 2;
			...
			func_379();
			func_368((MISC::GET_GAME_TIMER() - iLocal_366), "", -1, -1, "", iLocal_349, 2, "", 0, 1, -1, -1, 0, 12, -1, -1, 0, 6, -1, 0, 0, 1, -1, 0, -1082130432, 1, 1);
		}
	}
}
...
void func_369(var uParam0, char* sParam1, var uParam2, int iParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16)
{
	int iVar0;
	int iVar1;
	...
	if (iVar0 > -1)
	{
		...
		Global_1364578.f_4388.f_172[iVar0] = uParam2;
...
void func_372(int iParam0, int iParam1, char* sParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15)
{
	int iVar0;
	int iVar1;
	...
	if (iVar0 > -1)
	{
		...
		Global_1364578.f_3098.f_183[iVar0] = uParam3;
...
void func_373(int iParam0, var uParam1, char* sParam2, var uParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	int iVar0;
	int iVar1;
...
void func_382()
{
	...
	if (iLocal_364 < iLocal_362)
	{
		if (iLocal_364 < (iLocal_362 - 1))
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_363[iLocal_364 /*3*/], 4f, 4f, 3f, false, true, 0) || !HUD::DOES_BLIP_EXIST(iLocal_357))
			{
				...
				if (iLocal_359 != 0)
				{
					...
					iLocal_360 = GRAPHICS::CREATE_CHECKPOINT(func_384(iLocal_364), vLocal_363[iLocal_364 /*3*/] + Vector(2f, 0f, 0f), vLocal_363[iLocal_364 + 1 /*3*/], 3.2f, iVar5, iVar6, iVar7, iLocal_361, 0);
				...
				if (iLocal_364 < (iLocal_362 - 1))
				{
					iLocal_359 = GRAPHICS::CREATE_CHECKPOINT(func_384(iLocal_364), vLocal_363[iLocal_364 /*3*/] + Vector(2f, 0f, 0f), vLocal_363[iLocal_364 + 1 /*3*/], 3.2f, iVar1, iVar2, iVar3, iVar4, 0);
					...
					HUD::_0x75A16C3DA34F1245(iLocal_357, false);
					...
					if (iLocal_364 + 1 == (iLocal_362 - 1))
					{
						...
						HUD::_0x75A16C3DA34F1245(iLocal_358, false);
					}
					else
					{
				...
				else if (iLocal_364 == (iLocal_362 - 1))
				{
					...
					HUD::GET_HUD_COLOUR(iVar0, &iVar1, &iVar2, &iVar3, &iVar4);
					iLocal_359 = GRAPHICS::CREATE_CHECKPOINT(func_384(iLocal_364), vLocal_363[iLocal_364 /*3*/] + Vector(2f, 0f, 0f), vLocal_363[iLocal_364 /*3*/], 3.2f, iVar1, iVar2, iVar3, iVar4, 0);
					GRAPHICS::SET_CHECKPOINT_CYLINDER_HEIGHT(iLocal_359, 1.6f, 1.6f, 100f);
					iLocal_357 = HUD::ADD_BLIP_FOR_COORD(vLocal_363[iLocal_364 /*3*/]);
					HUD::SET_BLIP_SCALE(iLocal_357, 1.2f);
		...
		{
			if (func_333(PLAYER::PLAYER_PED_ID(), vLocal_356, 1) < 4f)
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (iLocal_359 != 0)
...
void func_387()
{
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_353, true) > 60f || func_391(60f))
	{
		AUDIO::TRIGGER_MUSIC_EVENT("RC6A_FAIL");
		iLocal_58 = 6;
		iLocal_55 = 0;
	...
	else if (Local_74.f_1 == 0)
	{
		...
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_353, true) > 40f || func_391(40f))
			{
				if (func_34())
				{
...
bool func_390(char* sParam0, int iParam1, char* sParam2)
{
...
void func_392(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71232 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_394(Global_71233, Global_71235, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
struct<2> func_394(int iParam0, int iParam1, int iParam2)
{
	struct<2> Var0;
	int iVar1;
...
int func_403(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (((!func_405(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_278(0)) || func_404(1))
			{
			}
			else
			{
...
{
	return func_407(iParam0, Global_35905);
}
...
int func_429(int iParam0)
{
	...
	return Global_105220.f_2354.f_539.f_2312[iParam0];
}
...
int func_432(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
...
int func_433(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_453(bool bParam0)
{
	...
	if (!func_470())
	{
		...
		{
			func_214(iVar0, 1, 0);
			func_454(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_104307[iVar0 /*10*/].f_9 == -1)
...
int func_455(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
	...
	if (func_461())
	{
		...
		{
			iVar2 = func_456(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_457()
{
	...
	iVar0 = func_458(&(Global_92955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_461()
{
	...
	{
		if (func_456(&(Global_92955.f_3)) > -1)
		{
			return 1;
		}
	}
