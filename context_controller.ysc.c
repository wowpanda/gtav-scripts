...
void __EntryFunction__()//Position - 0x0
{
	...
	Global_909D = 0;
	func_39();
	StringCopy(&Global_909E, "CC_SUBSTR", 16);
	iVar2 = 4294967295;
	iVar3 = 4294967295;
	bVar4 = false;
	bVar5 = false;
	...
	while (true)
	{
		...
		if (Global_90A3)
		{
			if (Global_90A5 > 4294967295)
			{
				if (!Global_8FDB[Global_90A5 /*32*/].f_6)
				{
					if (!func_23(Global_90A5, 1))
					{
		...
		if (iVar2 > 4294967295)
		{
			if (!Global_90A3)
			{
				if (Global_90A5 != iVar2)
				{
					if (func_18(Global_90A5))
					{
						func_25();
						if (!Global_8FDB[iVar2 /*32*/].f_5 && Global_8FDB[iVar2 /*32*/])
						{
							if (!func_19())
							{
								if (!Global_8FDB[iVar2 /*32*/].f_7)
								{
									if (!Global_8FDB[iVar2 /*32*/].f_6)
									{
										if (!Global_8FDB[iVar2 /*32*/].f_C)
										{
											func_17(Global_8FDB[iVar2 /*32*/].f_8, Global_8FDB[iVar2 /*32*/].f_3);
										}
										else
										{
											func_16(Global_8FDB[iVar2 /*32*/].f_8, Global_8FDB[iVar2 /*32*/].f_D, Global_8FDB[iVar2 /*32*/].f_3, Global_8FDB[iVar2 /*32*/].f_1E);
										}
										Global_90A5 = iVar2;
									}
								}
		...
		switch (iVar0)
		{
			case 0:
				...
				if (!func_19())
				{
					if (iVar2 > 4294967295 && iVar6)
					{
						...
						{
							Global_8FDB[iVar2 /*32*/].f_4 = 1;
							Global_8FDB[iVar2 /*32*/].f_1D = 0;
							iVar7 = Global_8FDB[iVar2 /*32*/].f_1;
							iVar0 = 1;
							Global_909C = 0;
						}
					}
			...
			case 1:
				...
				else
				{
					...
					if (!iVar7 == Global_8FDB[iVar2 /*32*/].f_1)
					{
						iVar0 = 0;
					}
					if (Global_8FDB[iVar2 /*32*/].f_7 || Global_8FDB[iVar2 /*32*/] == 0)
					{
						iVar0 = 0;
					}
				}
			...
			case 2:
				...
				{
					if (!(Global_8FDB[iVar2 /*32*/].f_4 || Global_8FDB[iVar2 /*32*/].f_7))
					{
						Global_909D = 0;
						iVar2 = 4294967295;
					}
...
void func_1()//Position - 0x457
{
	...
	if (bLocal_111)
	{
		...
		HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(&Local_113);
		if (bLocal_112)
		{
			HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&Local_114);
		}
		else
		{
			HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Global_909E);
			HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Local_114);
		}
...
{
	return func_5(CAM::_0xDC9DA9E8789F5246(), bParam0);
}
...
int func_6(int iParam0, bool bParam1, int iParam2)//Position - 0x561
{
	...
	if (iVar0 != func_8() && Global_18CD5B[iVar0 /*560*/].f_B.f_199 == iParam2)
	{
		return 1;
	}
	return 0;
...
int func_7(int iParam0, int iParam1)//Position - 0x5BD
{
	if (iParam0 != func_8())
	{
		if (Global_18CD5B[iParam0 /*560*/].f_B != func_8())
		{
...
void func_10(int iParam0)//Position - 0x642
{
	...
	while (iVar0 < 6)
	{
		if (Global_8FDB[iVar0 /*32*/] && Global_8FDB[iVar0 /*32*/].f_4)
		{
			if (Global_8FDB[iVar0 /*32*/].f_1F != 0)
			{
				if (!SCRIPT::IS_THREAD_ACTIVE(Global_8FDB[iVar0 /*32*/].f_1F))
				{
					if (*iParam0 > 4294967295)
					{
						func_11();
					}
					Global_8FDB[iVar0 /*32*/] = 0;
					Global_8FDB[iVar0 /*32*/].f_1F = 0;
					Global_8FDB[iVar0 /*32*/] = 0;
					Global_8FDB[iVar0 /*32*/].f_4 = 0;
					Global_8FDB[iVar0 /*32*/].f_5 = 0;
					Global_8FDB[iVar0 /*32*/].f_2 = 0;
					Global_8FDB[iVar0 /*32*/].f_7 = 0;
					Global_8FDB[iVar0 /*32*/].f_6 = 0;
					Global_8FDB[iVar0 /*32*/].f_3 = 0;
					*iParam0 = 4294967295;
				}
			}
		}
...
{
	if (Global_90A5 != 4294967295 || bLocal_110)
	{
		bLocal_110 = false;
		Global_90A5 = 4294967295;
	}
...
void func_12()//Position - 0x719
{
	...
	while (iVar0 < 6)
	{
		if (Global_8FDB[iVar0 /*32*/].f_7)
		{
			...
			Global_8FDB[iVar0 /*32*/].f_7 = 0;
			Global_8FDB[iVar0 /*32*/].f_6 = 0;
			Global_8FDB[iVar0 /*32*/].f_1 = 4294967295;
			Global_8FDB[iVar0 /*32*/].f_3 = 0;
		}
		iVar0++;
	}
...
int func_14()//Position - 0x7C9
{
	...
	while (iVar0 < 6)
	{
		if (Global_8FDB[iVar0 /*32*/] == 1)
		{
			if (Global_8FDB[iVar0 /*32*/].f_4 == 0)
			{
				iVar1++;
			}
		}
...
int func_15()//Position - 0x813
{
	...
	while (iVar0 < 6)
	{
		...
		{
			if (Global_8FDB[iVar0 /*32*/].f_2 > iVar1)
			{
				iVar2 = iVar0;
				iVar1 = Global_8FDB[iVar0 /*32*/].f_2;
			}
		}
		iVar0++;
	}
...
bool func_21(bool bParam0)//Position - 0x9C1
{
	if (bParam0)
	{
...
int func_22(int iParam0)//Position - 0x9EA
{
	if (iParam0 == 1)
	{
...
int func_23(int iParam0, int iParam1)//Position - 0xA44
{
	int iVar0;
	int iVar1;
...
int func_24(int iParam0)//Position - 0xAF9
{
	int iVar0;
...
void func_25()//Position - 0xB34
{
	func_11();
	Global_90A5 = 4294967295;
}

void func_26()//Position - 0xB44
{
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !func_32())
	{
		if (func_31(0))
		{
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_255C02.f_2A1.f_C)))
			{
				func_30();
				func_27(6, 0, 0);
			}
...
int func_27(int iParam0, bool bParam1, int iParam2)//Position - 0xB83
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (Global_11625 && func_29())
	{
		return 0;
	}
	if (!Global_11625 && func_28())
	{
		return 0;
	}
	if (bVar0)
...
var func_28()//Position - 0xD8A
{
	return Global_10B8F;
}

var func_29()//Position - 0xD96
{
	return Global_1940E3;
}

void func_30()//Position - 0xDA2
{
	Global_255C02.f_2A1.f_1C = 0;
}

bool func_31(bool bParam0)//Position - 0xDB4
{
	if (bParam0)
	{
...
bool func_32()//Position - 0xDF0
{
	return Global_10B8E;
}

void func_33()//Position - 0xDFC
{
	bool bVar0;
	int iVar1;
...
void func_34(int iParam0)//Position - 0xE46
{
	int iVar0;
...
void func_35()//Position - 0xEA0
{
	...
	if (Global_1801BA != 4294967295)
	{
		...
		if (MISC::IS_XBOX360_VERSION() || MISC::IS_DURANGO_VERSION())
		{
			...
			if (iLocal_116)
			{
				...
				else
				{
					...
					{
						StringCopy(&(Global_200000[func_38() /*12745*/].f_3118.f_12[Global_1801BA /*6*/]), NETWORK::NETWORK_GET_GAMERTAG_FROM_HANDLE(&(Var0[0 /*13*/])), 24);
					}
					func_37();
				}
			}
				...
				switch (iLocal_117)
				{
					...
					case 1:
						...
						switch (iVar2)
						{
							...
							case 0:
								MemCopy(&(Global_200000[func_38() /*12745*/].f_3118.f_12[Global_1801BA /*6*/]), {Var1[0 /*16*/]}, 6);
								func_37();
								break;
		...
		else
		{
			if (func_36(Var0[0 /*13*/]))
			{
				StringCopy(&(Global_200000[func_38() /*12745*/].f_3118.f_12[Global_1801BA /*6*/]), NETWORK::NETWORK_MEMBER_ID_FROM_GAMER_HANDLE(&(Var0[0 /*13*/])), 24);
			}
			func_37();
		}
	}
...
bool func_36(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)//Position - 0x10BA
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0, 13);
}

void func_37()//Position - 0x10CA
{
