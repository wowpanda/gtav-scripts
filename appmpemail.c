...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if ((Global_14493.f_1 != 9 && Global_16834 == 0) && Global_16833 == 0)
		{
			...
			{
				if (MISC::ARE_STRINGS_EQUAL(&(Global_4266201[iLocal_24 /*104*/]), "CELL_FINV"))
				{
				}
				else
				{
					...
					func_48();
					func_46();
					if (Global_4266201[iLocal_24 /*104*/].f_29 > 0)
					{
						if (Global_4266201[iLocal_24 /*104*/].f_31 == 1)
						{
							Global_4266201[iLocal_24 /*104*/].f_29 = 4;
							Global_4266201[iLocal_24 /*104*/].f_24 = 1;
						}
						else
						{
							Global_4266201[iLocal_24 /*104*/].f_24 = 1;
...
void func_6()
{
	func_53(Global_14474, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_9()
{
	func_53(Global_14474, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(1), -1082130432, -1082130432, -1082130432, -1082130432);
	AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_14482, true);
	func_10();
}
...
void func_12()
{
	if (Global_4266201[iLocal_24 /*104*/].f_24 == 1)
	{
		if (Global_14471 == 0)
		{
			if (PAD::IS_CONTROL_PRESSED(2, Global_14464))
			{
				func_2();
				Global_14471 = 1;
				func_26();
				if (Global_4266201[iLocal_24 /*104*/].f_27 == 1)
				{
					Global_4266201[iLocal_24 /*104*/].f_99[0] = 0;
					Global_4266201[iLocal_24 /*104*/].f_99[1] = 0;
					Global_4266201[iLocal_24 /*104*/].f_99[2] = 0;
				}
				else
				{
					Global_4266201[iLocal_24 /*104*/].f_99[Global_14493] = 0;
				}
				...
				{
					Global_4266201[iLocal_24 /*104*/].f_24 = 0;
					Global_4266201[iLocal_24 /*104*/].f_28 = 0;
				}
				HUD::_REMOVE_NOTIFICATION(Global_4266201[iLocal_24 /*104*/].f_16);
				func_53(Global_14474, "SET_DATA_SLOT_EMPTY", 8f, -1082130432, -1082130432, -1082130432, -1082130432);
				func_48();
				if (iLocal_22 > 0)
				{
		...
		if (PAD::IS_CONTROL_PRESSED(2, Global_14465))
		{
			if (iLocal_26 == 1)
			{
				if (Global_14493.f_1 > 3)
				{
					...
					if (MISC::ARE_STRINGS_EQUAL(&Global_68264, "HARDCODED_4207156"))
					{
						Global_14493.f_1 = 3;
						Global_1683364 = 1;
					}
	...
	if (Global_4266201[iLocal_24 /*104*/].f_31 == 1)
	{
		if (Global_14471 == 0)
		{
			if (func_3(2, Global_14465, 0))
			{
				func_23();
				Global_14471 = 1;
				Global_4266201[iLocal_24 /*104*/].f_29 = 2;
				Global_4266201[iLocal_24 /*104*/].f_24 = 1;
				Global_4266201[iLocal_24 /*104*/].f_31 = 0;
	...
	if (Global_14471 == 0 && iLocal_30 == 1)
	{
		if (func_3(2, Global_14462, 0))
		{
			...
			{
				func_23();
				Global_4266201[iLocal_24 /*104*/].f_29 = 3;
				Global_4266201[iLocal_24 /*104*/].f_24 = 1;
				Global_16866 = 0;
				if (Global_14493.f_1 > 3)
				{
			...
			else if (Global_4266201[iLocal_24 /*104*/].f_30 == 1)
			{
				func_23();
				Global_1678 = 144;
				if (Global_14493.f_1 > 3)
				...
				Global_1678 = Global_4266201[iLocal_24 /*104*/].f_17;
				if (Global_105220.f_28021[Global_1678 /*29*/].f_24[Global_14493] == 0)
				{
					func_19(Global_14474, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_1678 /*10*/].f_4), "CELL_300", "CELL_211", "CELL_195", 0);
				}
				else
				{
					func_19(Global_14474, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_105220.f_28021[Global_1678 /*29*/].f_3), &(Global_105220.f_28021[Global_1678 /*29*/].f_7), "CELL_211", &(Global_105220.f_28021[Global_1678 /*29*/].f_3), 0);
				}
				func_13();
				func_56();
			}
...
void func_13()
{
	...
	switch (Global_14493.f_1)
	{
		case 6:
			...
			if (Global_2968 == 1)
			{
				func_53(Global_14474, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_14497), -1082130432, -1082130432, -1082130432);
				Global_14473 = Global_14497;
			}
			else
			{
				func_53(Global_14474, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_14498), -1082130432, -1082130432, -1082130432);
		...
		case 9:
			...
			{
				func_16();
				func_53(Global_14474, "SET_THEME", SYSTEM::TO_FLOAT(Global_105220.f_14022[Global_14493 /*20*/].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
				if (Global_15813)
				{
				...
				{
					func_19(Global_14474, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_117[Global_1678 /*10*/].f_4), "CELL_300", "CELL_217", "CELL_195", 0);
				}
				else
				{
					func_19(Global_14474, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_105220.f_28021[Global_1678 /*29*/].f_3), &(Global_105220.f_28021[Global_1678 /*29*/].f_7), "CELL_217", &(Global_105220.f_28021[Global_1678 /*29*/].f_3), 0);
				}
				func_53(Global_14474, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
			else if (Global_15800 == 4 || Global_15800 == 3)
			{
				...
				else
				{
					...
					if (Global_105220.f_28021[Global_1678 /*29*/].f_24[Global_14493] == 0)
					{
						...
						func_19(Global_14474, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_1678 /*10*/].f_4), "CELL_300", &cVar0, "CELL_195", 0);
					}
					else
					{
						func_53(Global_14474, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_19(Global_14474, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_105220.f_28021[Global_1678 /*29*/].f_3), &(Global_105220.f_28021[Global_1678 /*29*/].f_7), &cVar0, &(Global_105220.f_28021[Global_1678 /*29*/].f_3), 0);
					}
				}
				func_53(Global_14474, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			}
...
void func_28()
{
	...
	{
		if (func_31(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
	...
	if (Global_14471 == 0)
	{
		if ((func_3(2, Global_14462, 0) || Global_4267451 == 1) || Global_16860 == 1)
		{
			...
			if (iLocal_22 == iLocal_21 || iLocal_22 > iLocal_21)
			{
				...
				{
					if (MISC::IS_BIT_SET(Global_4267466, 25))
					{
						MISC::CLEAR_BIT(&Global_4267466, 25);
					}
					if (Global_4266200 > 0)
					{
			...
			if (Global_4266201[iLocal_24 /*104*/].f_24 != 0)
			{
				if (Global_14493.f_1 > 3)
				{
					Global_14493.f_1 = 8;
				...
				Global_4266201[iLocal_24 /*104*/].f_28 = 1;
				iLocal_26 = 0;
				StringCopy(&Global_16841, "NO_HYPERLINK", 64);
				Var0 = { Global_4266201[iLocal_24 /*104*/] };
				...
				if (HUD::DOES_TEXT_LABEL_EXIST(&Var0))
				{
					...
					MISC::SET_BIT(&Global_2363, 17);
					Global_4266201[iLocal_24 /*104*/].f_26 = 1;
					Global_4266201[iLocal_24 /*104*/].f_24 = 2;
				}
				if (Global_4266201[iLocal_24 /*104*/].f_26 == 0)
				{
					Global_4266201[iLocal_24 /*104*/].f_24 = 1;
				}
				func_37();
				...
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(PLAYER::GET_PLAYER_NAME(PLAYER::PLAYER_ID()));
				GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
				if (Global_4266201[iLocal_24 /*104*/].f_17 == 145)
				{
					GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("CELL_FROM_FIELD");
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4266201[iLocal_24 /*104*/].f_50));
					GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
				}
				else
				{
					GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("CELL_FROM_FIELD");
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_105220.f_28021[Global_4266201[iLocal_24 /*104*/].f_17 /*29*/].f_3));
					GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
				}
				switch (Global_4266201[iLocal_24 /*104*/].f_32)
				{
					case 0:
						func_15(&(Global_4266201[iLocal_24 /*104*/]));
						break;
					
					case 1:
						GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&(Global_4266201[iLocal_24 /*104*/]));
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4266201[iLocal_24 /*104*/].f_33));
						if (Global_4266201[iLocal_24 /*104*/].f_66 == 1 && !MISC::ARE_STRINGS_EQUAL(&(Global_4266201[iLocal_24 /*104*/].f_67), "NULL"))
						{
							HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4266201[iLocal_24 /*104*/].f_67));
						}
						if ((Global_4266201[iLocal_24 /*104*/].f_66 == 2 && !MISC::ARE_STRINGS_EQUAL(&(Global_4266201[iLocal_24 /*104*/].f_67), "NULL")) && !MISC::ARE_STRINGS_EQUAL(&(Global_4266201[iLocal_24 /*104*/].f_83), "NULL"))
						{
							if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_4266201[iLocal_24 /*104*/].f_67)))
							{
								HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_4266201[iLocal_24 /*104*/].f_67));
							}
							else
							{
								HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4266201[iLocal_24 /*104*/].f_67));
							}
							if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_4266201[iLocal_24 /*104*/].f_83)))
							{
								HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_4266201[iLocal_24 /*104*/].f_83));
							}
							else
							{
								HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4266201[iLocal_24 /*104*/].f_83));
							}
						}
						GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
						break;
					...
					case 2:
						GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(&(Global_4266201[iLocal_24 /*104*/]));
						HUD::ADD_TEXT_COMPONENT_INTEGER(Global_4266201[iLocal_24 /*104*/].f_49);
						GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
						break;
				...
				{
					func_15(&(Global_105220.f_28021[Global_4266201[iLocal_24 /*104*/].f_17 /*29*/].f_3));
				}
				if (Global_4266201[iLocal_24 /*104*/].f_17 == 149)
				{
					GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_STRING("emailads_maze_bank");
					GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_BOOL(true);
				}
				if (Global_4266201[iLocal_24 /*104*/].f_17 == 140)
				{
					GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_STRING("EmailAds_Warstock");
					GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_BOOL(true);
				}
				...
				if (Global_4266201[iLocal_24 /*104*/].f_24 == 2)
				{
					if (Global_4266201[iLocal_24 /*104*/].f_31 == 1)
					{
						iLocal_26 = 0;
...
void func_37()
{
	...
	if (Global_4266201[iLocal_24 /*104*/].f_24 != 0)
	{
		...
		while (iVar0 < 59)
		{
			if (MISC::ARE_STRINGS_EQUAL(&(Global_4266201[iLocal_24 /*104*/]), &(Local_35[iVar0 /*6*/])))
			{
				if (func_38(&(Local_35[iVar0 /*6*/])))
				{
					StringCopy(&Local_34, "BAT_CASE_", 64);
					StringIntConCat(&Local_34, Global_1683358, 64);
				}
				else
				{
...
void func_40()
{
	...
	fVar0 = func_41(vLocal_39, vLocal_38, Global_14453, -90f, 0f, 90f, 350f, 0);
...
float func_41(vector3 vParam0, vector3 vParam1, vector3 vParam2, vector3 vParam3, float fParam4, bool bParam5)
{
	...
	if (fVar1 < 1f)
	{
		...
		Global_14421 = { func_42(vParam0, vParam1, fVar2) };
		Global_14424 = { func_42(vParam2, vParam3, fVar2) };
	}
	else
	{
...
void func_45()
{
	...
	fVar0 = func_41(vLocal_38, vLocal_39, -90f, 0f, 90f, Global_14453, 350f, 0);
...
void func_46()
{
	if (Global_4267451 == 0)
	{
		...
		func_53(Global_14474, "DISPLAY_VIEW", 8f, SYSTEM::TO_FLOAT(iLocal_23), -1082130432, -1082130432, -1082130432);
		if (Global_14481)
		{
			if (iLocal_20 > 0)
			{
...
void func_48()
{
	...
	while (iVar1 < 11)
	{
		...
		iVar3 = 0;
		iVar4 = 11;
		Global_4266201[iVar4 /*104*/].f_18 = -1;
		Global_4266201[iVar4 /*104*/].f_18.f_1 = 0;
		Global_4266201[iVar4 /*104*/].f_18.f_2 = 0;
		Global_4266201[iVar4 /*104*/].f_18.f_3 = 0;
		Global_4266201[iVar4 /*104*/].f_18.f_5 = 0;
		while (iVar3 < 12)
		{
			if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("cellphone_flashhand")) == 0)
			{
			...
			if (iVar0[iVar3] == 0)
			{
				if (Global_4266201[iVar3 /*104*/].f_24 != 0)
				{
					if (Global_4266201[iVar3 /*104*/].f_99[Global_14493] == 1)
					{
						if (func_52(Global_4266201[iVar3 /*104*/].f_18, Global_4266201[iVar4 /*104*/].f_18))
						{
							iVar4 = iVar3;
							if (Global_4266201[iVar4 /*104*/].f_28 == 0)
							{
								iLocal_25 = 0;
							}
							else
		...
		iVar0[iVar4] = 1;
		if (Global_4266201[iVar4 /*104*/].f_24 != 0)
		{
			if (Global_4266201[iVar4 /*104*/].f_99[Global_14493] == 1)
			{
				GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(Global_14474, "SET_DATA_SLOT");
				...
				if (Global_4266201[iVar4 /*104*/].f_17 == 145)
				{
					GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("CELL_2000");
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4266201[iVar4 /*104*/].f_50));
					GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
				}
				else
				{
					func_15(&(Global_105220.f_28021[Global_4266201[iVar4 /*104*/].f_17 /*29*/].f_3));
				}
				Var5 = { Global_4266201[iVar4 /*104*/] };
				if (func_38(&(Global_4266201[iVar4 /*104*/])))
				{
...
void func_54()
{
	...
	iLocal_41 = 1;
	bLocal_42 = false;
	while (iLocal_41 && Global_14493.f_1 > 3)
	{
		SYSTEM::WAIT(0);
...
void func_56()
{
	if (func_44() == 0)
	{
		MOBILE::SET_MOBILE_PHONE_POSITION(Global_14446[Global_14438 /*3*/]);
	}
	if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("cellphone_flashhand")) == 0)
	{
		func_57(0);
