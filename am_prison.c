...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			{
				if ((((((((!Global_1573970 && !func_23(3)) && !func_20(PLAYER_ID(), 0)) && !IS_PLAYER_SWITCH_IN_PROGRESS()) && IS_PLAYER_CONTROL_ON(PLAYER_ID())) && !func_18(PLAYER_ID())) && !func_16(func_17(PLAYER_ID()))) && !func_14(PLAYER_ID(), 146)) && !func_10(PLAYER_ID()))
				{
...
int func_28()
{
	switch (Local_149)
	{
		case 0:
			...
			{
				Local_149.f_4 = ADD_SCENARIO_BLOCKING_AREA(1413.703f, 2341.517f, -232.3945f, 2016.209f, 2998.893f, 161.0299f, 0, 1, 1, 1);
			}
			func_29(&(uLocal_116[PARTICIPANT_ID_TO_INT()]), 1);
			Local_149 = 1;
			break;
		...
		case 2:
			if (Global_1573970 || func_23(3))
			{
				REMOVE_SCENARIO_BLOCKING_AREA(Local_149.f_4, 0);
			}
			return 1;
			break;
	}
...
int func_33()
{
	...
	if (func_34() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_34()) == 0)
		{
			return 1;
		}
	}
...
void func_48(struct<21> Param0)
{
	...
	func_50(0, -1, 0);
	NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&iLocal_114, 2);
	NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&uLocal_116, 33);
