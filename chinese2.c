	...
	else if (iLocal_86)
	{
		...
		while (iVar0 < Local_109)
		{
			...
			else
			{
				...
				HUD::_0x75A16C3DA34F1245(Local_109[iVar0 /*5*/].f_3, false);
			}
			iVar0++;
		}
		iLocal_86 = 0;
...
void func_44()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_47(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_45(iVar0) && (!func_48(14) || Global_104171))
			{
						...
						switch (Local_113[iVar0 /*33*/].f_3)
						{
							...
							case 5:
								switch (Local_113[iVar0 /*33*/].f_5)
								{
									case 0:
										func_93();
										BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2459.646f, 4977.735f, 50.5678f, 1f, 20000, 0.25f, 0, 1193033728);
										BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2456.221f, 4974.685f, 50.5678f, 1f, 20000, 0.25f, 0, 1193033728);
									...
									case 2:
										func_93();
										BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2450.491f, 4986.83f, 50.5677f, 1f, 20000, 0.25f, 0, 1193033728);
									...
									switch (Local_113[iVar0 /*33*/].f_5)
									{
										...
										case 12:
											if (PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), Local_113[iVar0 /*33*/]) && func_67(Local_113[iVar0 /*33*/], 2448.003f, 4982.305f, 45.8519f, 1) < 10f)
											{
												...
												{
													BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_113[iVar0 /*33*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1f, 20000, 0.25f, 0, 1193033728);
										...
										case 13:
											func_93();
											BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2449.114f, 4981.984f, 45.8102f, 1f, 20000, 0.25f, 0, 1193033728);
							...
							case 18:
								switch (Local_113[iVar0 /*33*/].f_5)
								{
									case 0:
										func_93();
										BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2434.891f, 4973.864f, 50.5679f, 1f, 20000, 0.25f, 0, 1193033728);
...
void func_92(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		BRAIN::SET_SEQUENCE_TO_REPEAT(iLocal_81, 1);
	}
	BRAIN::CLOSE_SEQUENCE_TASK(iLocal_81);
	if (!PED::IS_PED_DEAD_OR_DYING(*iParam0, 1))
	{
		BRAIN::TASK_PERFORM_SEQUENCE(*iParam0, iLocal_81);
	}
	BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_81);
}

void func_93()
{
	BRAIN::OPEN_SEQUENCE_TASK(&iLocal_81);
}
...
void func_133(int iParam0)
{
	...
	if (Global_105220.f_9056 || func_141(0))
	{
		iVar0 = func_140();
		if (!func_134(iVar0))
		{
...
int func_134(int iParam0)
{
	...
	func_135(&(Global_105220.f_2354.f_539), iVar1);
...
void func_135(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_137(Global_105220.f_18504[iVar0], &vVar2, &fVar3))
			{
...
void func_145(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_141(0) && Global_71224.f_1 == 1) && func_146(Global_71224))
		{
		}
		else
		{
...
void func_210(int iParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(iParam0->f_17[iVar0]))
		{
			...
			if (bParam1)
			{
				if (PED::IS_PED_GROUP_MEMBER(iParam0->f_17[iVar0], func_211()) && iParam0->f_17[iVar0] != PLAYER::PLAYER_PED_ID())
				{
...
bool func_220(int iParam0, vector3 vParam1, vector3 vParam2, bool bParam3, char* sParam4, bool bParam5, bool bParam6, int iParam7)
{
	return func_221(iParam0, vParam1, vParam2, func_259(), func_259(), bParam3, 1, 0, 0, 0, 0, sParam4, func_167(), func_167(), func_167(), func_167(), func_167(), 0, bParam5, func_167(), 0, 0, bParam6, iParam7, 0, 0, 0, 1, 1065353216);
}

int func_221(int iParam0, vector3 vParam1, vector3 vParam2, vector3 vParam3, vector3 vParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, char* sParam11, char* sParam12, char* sParam13, char* sParam14, char* sParam15, char* sParam16, bool bParam17, bool bParam18, char* sParam19, bool bParam20, int iParam21, bool bParam22, int iParam23, int iParam24, int iParam25, int iParam26, bool bParam27, float fParam28)
{
	int iVar0;
	bool bVar1;
	int iVar2;
		...
		if (CAM::IS_SCREEN_FADED_IN())
		{
			...
			if (bVar1)
			{
				...
				if (bParam18 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					if ((!func_234(iParam0, 1) && !func_233(iParam0)) && !MISC::IS_BIT_SET(iParam0->f_13, 0))
					{
						if (bParam22)
						{
				...
				else
				{
					...
					else if (!func_228(vVar3, HUD::GET_BLIP_COORDS(iParam0->f_5), 0.1f, 0))
					{
					...
					if (bVar1)
					{
						...
						while (iVar2 < 3)
						{
							if (!PED::IS_PED_INJURED(iParam0->f_17[iVar2]))
							{
								...
								else if (!PED::IS_PED_GROUP_MEMBER(iParam0->f_17[iVar2], func_211()) || !func_226(iParam0->f_17[iVar2], 1))
								{
									bVar1 = false;
								}
							}
...
int func_223(int iParam0)
{
	if (MISC::IS_BIT_SET(iParam0->f_13, 12))
	{
		...
		{
			if (func_224(1, 0, 1) || MISC::IS_BIT_SET(iParam0->f_13, 7))
			{
				return 1;
			}
		}
	}
	else if (func_224(1, 0, 1) || MISC::IS_BIT_SET(iParam0->f_13, 7))
	{
		return 1;
	}
	return 0;
...
int func_226(int iParam0, int iParam1)
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()) && iParam1)
		{
			...
			{
				PED::SET_GROUP_SEPARATION_RANGE(func_211(), 50f);
				return 1;
			}
		}
		else if (PED::IS_PED_GROUP_MEMBER(iParam0, func_211()))
		{
			PED::SET_GROUP_SEPARATION_RANGE(func_211(), 50f);
			return 1;
		}
...
int func_228(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_231(iParam2), 1);
}
...
int func_240(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, float fParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17)
{
	int iVar0;
	int iVar1;
	int iVar2;
						...
						if (func_238(uParam0->f_21, uParam0, iVar3))
						{
							...
							while (iVar0 < 3)
							{
								if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
								{
									...
									if (PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_211()))
									{
										PED::REMOVE_PED_FROM_GROUP(uParam0->f_17[iVar0]);
									}
									if (BRAIN::GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], -1794415470) == 7 && !func_255(uParam0->f_17[iVar0], uParam0->f_21))
									{
			...
			while (iVar0 < 3)
			{
				if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
				{
					...
					if (!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_211()))
					{
						...
						{
							PED::SET_PED_AS_GROUP_MEMBER(uParam0->f_17[iVar0], func_211());
						}
					}
				}
				iVar0++;
	...
	if (!MISC::IS_BIT_SET(uParam0->f_13, 26))
	{
		if ((!func_252(uParam0) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID())) && !ENTITY::DOES_ENTITY_EXIST(iParam10))
		{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iParam10))
		{
			if ((!PED::IS_PED_INJURED(uParam0->f_17[0]) || !PED::IS_PED_INJURED(uParam0->f_17[1])) || !PED::IS_PED_INJURED(uParam0->f_17[2]))
			{
				...
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()) && !func_234(uParam0, 2))
					{
						iVar10 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
				...
				if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
				{
					...
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						...
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar10, 0))
						{
							if (PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_211()))
							{
								if (!func_252(uParam0) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
								{
					...
					if (PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_211()))
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(iVar21))
						{
							...
							{
								if (func_249(iVar0, uParam0) || !MISC::IS_BIT_SET(uParam0->f_13, 27))
								{
									PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uParam0->f_17[iVar0], iVar0);
					...
					if ((!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_211()) && !func_247(uParam0->f_17[iVar0], iParam10)) && !func_246(uParam0->f_17[iVar0], iParam10))
					{
					...
					{
						if (((func_226(uParam0->f_17[iVar0], 1) || func_247(uParam0->f_17[iVar0], iParam10)) || iParam12) || (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam10, 0) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam10, 0)))
						{
							if (HUD::DOES_BLIP_EXIST(uParam0->f_1[iVar0]))
							{
					...
					else if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam10, 0))
					{
						if (!PED::IS_PED_SITTING_IN_VEHICLE(uParam0->f_17[iVar0], iParam10))
						{
							if ((ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], iParam10, 20f, 20f, 5f, 0, 1, 0) && !MISC::IS_BIT_SET(uParam0->f_13, 11)) && !((bParam17 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam10, 0)))
							{
								...
								else
								{
									...
									{
										if (((((!PED::IS_PED_JUMPING_OUT_OF_VEHICLE(uParam0->f_17[iVar0]) && !PED::IS_PED_JUMPING_OUT_OF_VEHICLE(PLAYER::PLAYER_PED_ID())) && !func_245(uParam0->f_17[iVar0], 2f)) && !PED::IS_PED_RAGDOLL(uParam0->f_17[iVar0])) && !BRAIN::IS_PED_GETTING_UP(uParam0->f_17[iVar0])) && !FIRE::IS_ENTITY_ON_FIRE(iParam10))
										{
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_17[iVar0], true);
							...
							else if (!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_211()))
							{
								if (func_253(uParam0, uParam0->f_17[iVar0], fParam8, bParam11))
								{
									if (!PED::IS_PED_RAGDOLL(uParam0->f_17[iVar0]) && !BRAIN::IS_PED_GETTING_UP(uParam0->f_17[iVar0]))
						...
						else if (PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_211()) && !FIRE::IS_ENTITY_ON_FIRE(iParam10))
						{
							PED::REMOVE_PED_FROM_GROUP(uParam0->f_17[iVar0]);
						}
					}
			...
			if (iVar1 > 0)
			{
				...
				while (iVar0 < 3)
				{
					if (iVar7[iVar0])
					{
						if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
						{
							if (func_250(uParam0->f_17[iVar0]) || ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], PLAYER::PLAYER_PED_ID(), uParam0->f_8, uParam0->f_8, uParam0->f_8, 0, 1, 0))
							{
								iVar1 = (iVar1 - 1);
								iVar7[iVar0] = 0;
							}
					...
					{
						if (!ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], PLAYER::PLAYER_PED_ID(), (uParam0->f_8 * 0.85f), (uParam0->f_8 * 0.85f), uParam0->f_8, 0, 1, 0) && !func_250(uParam0->f_17[iVar0]))
						{
						}
					}
					iVar0++;
...
void func_242(var uParam0, char* sParam1, char* sParam2, bool bParam3)
{
	if (!bParam3)
	{
		if (!MISC::IS_STRING_NULL(sParam1))
...
void func_243(char* sParam0, char* sParam1, int iParam2, int iParam3)
{
	iParam3 = iParam3;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
int func_246(int iParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (!PED::IS_PED_GROUP_MEMBER(iParam0, func_211()))
		{
	...
	switch (iLocal_150)
	{
		case 0:
			...
			if (func_204())
			{
				...
				{
					Local_113[14 /*33*/] = Global_89597.f_9[2];
					Local_113[13 /*33*/] = Global_89597.f_9[1];
					Local_113[11 /*33*/] = Global_89597.f_9[4];
					Local_113[10 /*33*/] = Global_89597.f_9[3];
					Local_113[12 /*33*/] = Global_89597.f_9[0];
...
void func_264()
{
	...
	switch (iLocal_150)
	{
		case 0:
			...
			func_17(0, -1);
			BRAIN::SET_SCENARIO_GROUP_ENABLED("Chinese2_Lunch", false);
			BRAIN::SET_SCENARIO_GROUP_ENABLED("CHINESE2_HILLBILLIES", false);
			if (func_358())
			{
				iVar0 = func_357();
				if (Global_87277 == 1)
...
void func_265(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		...
		case 4:
			...
			if (bParam1)
			{
				if ((ENTITY::DOES_ENTITY_EXIST(iLocal_144) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_144, 0)) && func_270())
				{
					func_274(iLocal_144, -1, 1);
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_144, 0))
					{
			...
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_273(), 2570.538f, 4982.031f, 50.6239f, true) < 10f)
			{
			...
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				func_268(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
			}
			break;
...
bool func_270()
{
	return Global_98783.f_2875.f_8;
}
...
float func_272()
{
	return Global_98783.f_2869.f_3;
}
...
int func_278(vector3 vParam0, float fParam1)
{
	return func_279(&(Global_98783.f_2875), vParam0, fParam1, 0);
}

int func_279(var uParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
	...
	if (func_336(uParam0))
	{
		...
		if (func_335(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_313(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
void func_280(int iParam0, int iParam1)
{
	...
	func_281(iParam0, &(Global_105220.f_32546.f_5510));
}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_72(iParam0, 0, 0)) || func_72(iParam0, 1, 0)) || func_72(iParam0, 2, 0)) || func_301(iParam0) != 145) || func_300(iParam0)) || func_299(iParam0)) || func_298(iParam0)) || func_297(iParam0)) || !func_287(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_299(iParam0))
		{
		}
...
void func_305(int iParam0)
{
	...
	if (func_309(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_304(iParam0, 0)) && Global_70709.f_66 == 0) && Global_105220.f_32546.f_1958[Global_69800.f_555[0 /*21*/].f_14] != 0) && Global_105220.f_32546.f_1958[Global_69800.f_555[0 /*21*/].f_14] > 3) && (!func_307(0, Global_69800.f_555[0 /*21*/].f_12) || !func_307(1, Global_69800.f_555[0 /*21*/].f_12)))
			{
				func_306(&(Global_105220.f_32546.f_69[Global_69800.f_555[0 /*21*/].f_14 /*78*/]), &Global_70709);
...
int func_307(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_308(&(Global_105220.f_32546.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_288(Global_105220.f_32546.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
int func_309(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_162(Global_105220.f_32546.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_162(Global_105220.f_2354.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_162(Global_105220.f_2354.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_313(int iParam0, vector3 vParam1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("cargobob"):
			if (func_314(iParam0, Global_69800.f_139[38], 0))
			{
				func_305(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_314(iParam0, Global_69800.f_139[43], 1))
			{
				func_305(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_314(iParam0, uVar1[iVar3], 1) && func_228(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
...
void func_316(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_90431[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_90431[iVar0]) == func_310(iParam0, iParam1))
				{
...
void func_317(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_282(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_282(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_282(iVar1 + 1));
			}
		}
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_325(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_324())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_282(iVar2 + 1)))
				{
...
int func_318(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_322(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_321(*iParam0, ((*uParam1)[38] - 1)))
	{
...
int func_326(int iParam0)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		if (!func_332(PLAYER::PLAYER_ID(), -1))
		{
	...
	if (func_328(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
...
void func_334(vector3 vParam0, float fParam1, bool bParam2)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_309(&(Global_69800.f_555[0 /*21*/]), iVar0))
		{
...
bool func_337()
{
	return func_335(&(Global_98783.f_2875));
}

void func_338()
{
	func_339(&(Global_98783.f_2875));
}
...
bool func_340()
{
	return func_336(&(Global_98783.f_2875));
}

int func_341(vector3 vParam0, float fParam1)
{
	return func_279(&(Global_95814.f_2875), vParam0, fParam1, 0);
}

bool func_342()
{
	return func_335(&(Global_95814.f_2875));
}

void func_343()
{
	func_339(&(Global_95814.f_2875));
}

int func_344(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_346()
{
	return Global_95814.f_2875.f_12.f_66;
}

bool func_347()
{
	return func_336(&(Global_95814.f_2875));
}

void func_348(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_358())
	{
...
int func_349(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_352(int iParam0)
{
	...
	if (iParam0 != 3)
	{
		BRAIN::SET_SCENARIO_GROUP_ENABLED("Chinese2_Lunch", true);
		BRAIN::SET_SCENARIO_GROUP_ENABLED("CHINESE2_HILLBILLIES", false);
	}
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
	if (iLocal_379 != -1)
	...
	{
		func_354(PLAYER::PLAYER_PED_ID(), 2);
	}
	iVar0 = 0;
	while (iVar0 < Local_113)
	{
...
void func_362(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_422(&(Global_92955.f_3));
				if (iVar6 > -1)
				{
...
{
	func_364(&Global_98783, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_364(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_43();
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		func_387(PLAYER::PLAYER_PED_ID());
		func_380(PLAYER::PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_379())
		{
			func_373(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
...
void func_373(int iParam0, var uParam1, int iParam2)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && ENTITY::GET_ENTITY_MODEL(iParam0) == ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			if (func_376(161, -1))
			{
				uParam1->f_59 = func_374(2051, Global_70790, 0);
			}
			else
			{
				uParam1->f_59 = func_374(752, Global_70790, 0);
			}
			uParam1->f_60 = func_374(753, Global_70790, 0);
			uParam1->f_61 = func_374(754, Global_70790, 0);
		}
...
int func_374(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_375(iParam1)];
...
int func_376(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2557346[iParam0 /*3*/][func_375(iParam1)];
...
void func_380(int iParam0, bool bParam1)
{
	...
	if (func_45(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_381(iParam0, &(Global_105220.f_2354.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_381(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_383(Var7.f_1)) && iVar9 < 50)
			{
...
int func_389(vector3 vParam0, char* sParam1, vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
int func_393(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_25() == 0)
		{
			return MISC::IS_BIT_SET(func_374(func_394(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_396(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 48)
	{
		if (iParam1 == 6 || iParam1 == func_410(iVar0))
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_397(iVar0, 0), true);
...
Vector3 func_397(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_408(Global_95018);
			break;
		
		case 46:
			if (Global_1589135 != func_407())
			{
				if (func_406(Global_1589135))
				{
					return func_399(2, 2);
				}
				else if (func_398(Global_1589135))
				{
...
Vector3 func_401(vector3 vParam0, float fParam1)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_417(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_429(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_430(Global_105220.f_9056.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_430(Global_105220.f_9056.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_430(Global_105220.f_9056.f_99.f_205[11]);
			break;
		
		case 90:
			return func_430(Global_105220.f_9056.f_99.f_205[7]);
			break;
		
		case 93:
			return func_430(Global_105220.f_9056.f_99.f_205[9]);
			break;
	}
	return 0;
}
