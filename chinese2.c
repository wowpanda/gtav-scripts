...
void __EntryFunction__()
{
	...
	iLocal_44 = 49;
	iLocal_45 = 64;
	uLocal_49 = _0x4A9923385BDB9DAD();
	uLocal_50 = _GET_BLIP_INFO_ID_ITERATOR();
	iLocal_61 = -1;
	iLocal_62 = -1;
	bLocal_77 = true;
	iLocal_266 = -1;
...
void func_1()
{
	if (iLocal_3505)
	{
		if (IS_INTERIOR_READY(uLocal_3504))
		{
			_LOAD_INTERIOR(uLocal_3504);
			iLocal_3505 = 0;
		}
	}
}
		...
		if (Local_2515[iVar0 /*6*/].f_1 == 1)
		{
			switch (Local_2515[iVar0 /*6*/])
			{
					...
					switch (Local_2515[iVar0 /*6*/].f_2)
					{
						...
						case -15:
							if (HAS_MODEL_LOADED(joaat("dubsta")))
							{
								func_32(22, 0);
								func_32(8, 0);
								SET_ROADS_IN_AREA(Vector(44.8113f, 4961.045f, 2469.985f) - Vector(100f, 100f, 100f), Vector(44.8113f, 4961.045f, 2469.985f) + Vector(100f, 100f, 100f), 0, 1);
								Local_2515[iVar0 /*6*/].f_2 = 1;
							}
							break;
						...
						case 1:
							...
							if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 2460.073f, 4964.176f, 46.2405f, 1) > 300f)
							{
								...
								SET_ROADS_IN_AREA(Vector(44.8113f, 4961.045f, 2469.985f) - Vector(100f, 100f, 100f), Vector(44.8113f, 4961.045f, 2469.985f) + Vector(100f, 100f, 100f), 1, 1);
								func_31(22, 1);
								func_31(8, 1);
								if (iLocal_2678 != 0)
								{
				...
				case 9:
					switch (Local_2515[iVar0 /*6*/].f_2)
					{
						case -1:
							...
							ENABLE_DISPATCH_SERVICE(1, 1);
							ENABLE_DISPATCH_SERVICE(7, 1);
							break;
						...
						case 0:
							if (func_67(PLAYER_PED_ID(), 2578.523f, 4982.284f, 51.4416f, 1) < 500f)
							{
								...
								ENABLE_DISPATCH_SERVICE(1, 0);
								ENABLE_DISPATCH_SERVICE(7, 0);
								Local_2515[iVar0 /*6*/].f_2++;
							}
							break;
				...
				case 14:
					switch (Local_2515[iVar0 /*6*/].f_2)
					{
						...
						case 1:
							if (GET_GAME_TIMER() > Local_2515[iVar0 /*6*/].f_5)
							{
								SET_ENTITY_COORDS(PLAYER_PED_ID(), 2466.385f, 4953.096f, 44.1228f, 1, 0, 0, 1);
								SET_ENTITY_HEADING(PLAYER_PED_ID(), 221f);
								TASK_GO_STRAIGHT_TO_COORD(PLAYER_PED_ID(), 2475.075f, 4945.965f, 44.0228f, 1f, 20000, 1193033728, 1056964608);
				...
				case 12:
					...
					{
						case 0:
							uLocal_2672 = _GET_DES_OBJECT(2457.15f, 4968.79f, 48.677f, 45f, "DES_FarmHs");
							if (_DOES_DES_OBJECT_EXIST(uLocal_2672))
							{
								_SET_DES_OBJECT_STATE(uLocal_2672, 2);
								Local_2515[iVar0 /*6*/].f_2++;
							}
							break;
						
						case 1:
							if (_GET_DES_OBJECT_STATE(uLocal_2672) == 3)
							{
								_SET_DES_OBJECT_STATE(uLocal_2672, 4);
								Local_2515[iVar0 /*6*/].f_2++;
							}
							break;
						...
						case 2:
							if (iLocal_2673 == 1)
							{
								if (_GET_DES_OBJECT_STATE(uLocal_2672) == 5)
								{
									_SET_DES_OBJECT_STATE(uLocal_2672, 6);
				...
				case 16:
					if (Local_2515[iVar0 /*6*/].f_2 != -1)
					{
						if (!HAS_PED_GOT_WEAPON(PLAYER_PED_ID(), joaat("weapon_petrolcan"), 0) || !DOES_PICKUP_EXIST(uLocal_2675))
						{
							...
							if (iLocal_2679 != 0)
							{
								if (DOES_BLIP_EXIST(uLocal_2677))
								{
									REMOVE_BLIP(&uLocal_2677);
								}
				...
				case 17:
					if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2447.671f, 4951.438f, 43.25576f, 2454.664f, 4957.856f, 47.89117f, 6.8125f, 0, 1, 0) && GET_GAME_TIMER() > Local_2515[iVar0 /*6*/].f_5)
					{
						if (DOES_BLIP_EXIST(uLocal_2677))
						{
							REMOVE_BLIP(&uLocal_2677);
				...
				case 20:
					if (!IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 0))
					{
						iLocal_2885 = func_18(4);
						if (iLocal_2885 != -1)
						{
							SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 0);
						}
					}
					else if (!IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 1))
					{
						if (!IS_PED_INJURED(Local_755[iLocal_2885 /*33*/]) && DOES_ENTITY_EXIST(Local_755[iLocal_2885 /*33*/].f_20))
						{
							...
							{
								SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 1);
							}
						}
					}
					...
					{
						DETACH_ENTITY(Local_755[iLocal_2885 /*33*/].f_20, 0, 0);
					}
					...
					{
						DETACH_ENTITY(Local_755[iLocal_2886 /*33*/].f_20, 0, 0);
					}
					break;
					...
					switch (Local_2515[iVar0 /*6*/].f_2)
					{
						case 1:
							...
							while (iVar4 < iLocal_2657)
							{
								...
								FREEZE_ENTITY_POSITION(iLocal_2657[iVar4], 1);
								iVar4++;
							}
							Local_2515[iVar0 /*6*/].f_2++;
							break;
						...
						case 0:
							if (!DOES_ENTITY_EXIST(uLocal_2680) && !DOES_ENTITY_EXIST(uLocal_2681))
							{
								...
								{
									uLocal_2680 = GET_CLOSEST_OBJECT_OF_TYPE(2493.5f, 4969.2f, 43.9f, 1f, -921781850, 1, 0, 1);
									FREEZE_ENTITY_POSITION(uLocal_2680, 1);
									CREATE_MODEL_HIDE(2493.4f, 4971.8f, 43.6f, 1f, -1853453107, 0);
									uLocal_2681 = CREATE_OBJECT(-1853453107, 2493.427f, 4971.729f, 43.54362f, 1, 1, 0);
									SET_ENTITY_ROTATION(uLocal_2681, -1.436373f, 0.176147f, -36.6601f, 2, 1);
									FREEZE_ENTITY_POSITION(uLocal_2681, 1);
									func_32(24, 0);
									Local_2515[iVar0 /*6*/].f_2++;
								}
							}
						...
						case 2:
							...
							while (iVar4 < iLocal_2657)
							{
								...
								{
									FREEZE_ENTITY_POSITION(iLocal_2657[iVar4], 0);
								}
								iVar4++;
							}
							Local_2515[iVar0 /*6*/].f_1 = 0;
				...
				case 24:
					if (!IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 0))
					{
						if (DOES_ENTITY_EXIST(uLocal_2680))
						{
							if (!IS_PED_INJURED(PLAYER_PED_ID()))
							{
								if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_2680, PLAYER_PED_ID(), 1) || func_4(PLAYER_PED_ID(), uLocal_2680, 1) < 30f)
								{
									FREEZE_ENTITY_POSITION(uLocal_2680, 0);
									SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 0);
								}
							}
						}
					}
					if (!IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 1))
					{
						if (DOES_ENTITY_EXIST(uLocal_2681))
						{
							if (!IS_PED_INJURED(PLAYER_PED_ID()))
							{
								if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_2681, PLAYER_PED_ID(), 1) || func_4(PLAYER_PED_ID(), uLocal_2681, 1) < 30f)
								{
									FREEZE_ENTITY_POSITION(uLocal_2681, 0);
									SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 1);
								}
							}
						}
					}
					if ((IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 0) && IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 1)) || iLocal_2511 == 6)
					{
						if (DOES_ENTITY_EXIST(uLocal_2680))
						{
							FREEZE_ENTITY_POSITION(uLocal_2680, 0);
					...
					switch (Local_2515[iVar0 /*6*/].f_2)
					{
						...
						case 1:
							if (HAS_ANIM_DICT_LOADED("MISSChinese2_crystalMazeMCS1_IG"))
							{
								if (HAS_CUTSCENE_FINISHED() || !IS_CUTSCENE_PLAYING())
								{
									...
									{
										SET_ENTITY_COORDS(Local_755[13 /*33*/], 1986.06f, 3051.708f, 46.2151f, 1, 0, 0, 1);
									}
									if (DOES_ENTITY_EXIST(Local_755[14 /*33*/]) && !IS_PED_INJURED(Local_755[14 /*33*/]))
									{
										SET_ENTITY_COORDS(Local_755[14 /*33*/], 1986.105f, 3051.659f, 46.2151f, 1, 0, 0, 1);
									}
									Local_2515[iVar0 /*6*/].f_2++;
								}
							}
						...
						case 2:
							if (DOES_SCENARIO_EXIST_IN_AREA(1984.89f, 3052.46f, 46.98f, 0.3f, 1) && DOES_SCENARIO_EXIST_IN_AREA(1985.322f, 3053.087f, 46.98f, 0.3f, 1))
							{
								if (!DOES_ENTITY_EXIST(Local_755[13 /*33*/]))
								{
									Local_755[13 /*33*/] = CREATE_PED(26, joaat("ig_old_man1a"), 1987.231f, 3052.741f, 46.214f, 0, 1, 1);
								}
								if (!DOES_ENTITY_EXIST(Local_755[14 /*33*/]))
								{
									Local_755[14 /*33*/] = CREATE_PED(26, joaat("ig_old_man2"), 1987.231f, 3052.741f, 46.214f, 0, 1, 1);
								}
								if (!DOES_ENTITY_EXIST(Local_755[12 /*33*/]))
								{
									Local_755[12 /*33*/] = CREATE_PED(26, joaat("ig_janet"), 1987.231f, 3052.741f, 46.214f, 0, 1, 1);
								}
								SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 1);
								...
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_755[14 /*33*/], 0);
								SET_BIT(&(Local_2515[iVar0 /*6*/].f_5), 0);
								...
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_755[13 /*33*/], 0);
								if (!IS_SYNCHRONIZED_SCENE_RUNNING(Local_2515[iVar0 /*6*/].f_5))
								{
									...
									SET_SYNCHRONIZED_SCENE_LOOPED(Local_2515[iVar0 /*6*/].f_5, 1);
								}
								TASK_SYNCHRONIZED_SCENE(Local_755[12 /*33*/], Local_2515[iVar0 /*6*/].f_5, "MISSChinese2_crystalMazeMCS1_IG", "bar_peds_action_janet", 1000f, -1000f, 1, 0, 1148846080, 0);
								_0x2208438012482A1A(Local_755[12 /*33*/], 1, 1);
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_755[12 /*33*/], 0);
								Local_2515[iVar0 /*6*/].f_5 = 0;
								Local_2515[iVar0 /*6*/].f_2++;
							}
							break;
						...
						case 3:
							...
							{
								SET_PED_CONFIG_FLAG(Local_755[13 /*33*/], 152, 1);
								SET_PED_CONFIG_FLAG(Local_755[14 /*33*/], 152, 1);
								if (IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 0) && IS_BIT_SET(Local_2515[iVar0 /*6*/].f_5, 1))
								{
									Local_2515[iVar0 /*6*/].f_2++;
								}
								else
						...
						case 6:
							if (!IS_PED_INJURED(Local_755[12 /*33*/]))
							{
								...
								SET_PED_KEEP_TASK(Local_755[12 /*33*/], 1);
							...
							if (!IS_PED_INJURED(Local_755[13 /*33*/]))
							{
								...
								SET_PED_KEEP_TASK(Local_755[13 /*33*/], 1);
							...
							if (!IS_PED_INJURED(Local_755[14 /*33*/]))
							{
								...
								SET_PED_KEEP_TASK(Local_755[14 /*33*/], 1);
...
float func_4(var uParam0, var uParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
	...
	else if (iLocal_262)
	{
		...
		while (iVar0 < Local_444)
		{
			...
			else
			{
				...
				_0x75A16C3DA34F1245(Local_444[iVar0 /*5*/].f_3, 0);
			}
			iVar0++;
		}
		iLocal_262 = 0;
...
int func_14(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_6(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
void func_27()
{
	...
	func_32(27, 0);
	CLEAR_AREA(2479.875f, 4980.868f, 44.82052f, 60f, 1, 0, 0, 0);
	iLocal_2507 = CREATE_VEHICLE(joaat("burrito"), 2479.579f, 4980.503f, 44.8051f, 341.8158f, 1, 1, 0);
	SET_VEHICLE_COLOUR_COMBINATION(iLocal_2507, 1);
	SET_VEHICLE_LIVERY(iLocal_2507, 2);
	SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_2507, 1084227584);
	if (iLocal_2511 < 5)
	{
		func_29(1, 1, 4);
		func_29(1, 1, 5);
	...
	if (iLocal_2511 == 7)
	{
		...
		Local_755[15 /*33*/] = CREATE_PED(26, joaat("a_m_y_methhead_01"), 2436.901f, 4959.1f, 45.8106f, 209.7559f, 1, 1);
		...
		Local_755[16 /*33*/] = CREATE_PED(26, joaat("a_m_m_hillbilly_01"), 2440.266f, 4970.705f, 45.8306f, 15.7982f, 1, 1);
		...
		Local_755[17 /*33*/] = CREATE_PED(26, joaat("a_m_m_hillbilly_02"), 2443.42f, 4974.523f, 45.8106f, 121.834f, 1, 1);
		...
		Local_755[18 /*33*/] = CREATE_PED(26, joaat("a_m_y_methhead_01"), 2448.888f, 4971.561f, 45.8106f, 194.7676f, 1, 1);
		...
		SET_ENTITY_HEALTH(Local_755[15 /*33*/], 0, 0);
		SET_ENTITY_HEALTH(Local_755[16 /*33*/], 0, 0);
		SET_ENTITY_HEALTH(Local_755[17 /*33*/], 0, 0);
		SET_ENTITY_HEALTH(Local_755[18 /*33*/], 0, 0);
	...
	SET_BIT(&iVar0, 2);
	SET_BIT(&iVar0, 4);
	uLocal_2650 = CREATE_PICKUP(joaat("pickup_health_standard"), 2446.896f, 4990.972f, 45.5477f, iVar0, -1, 1, 0);
	if (!DOES_NAVMESH_BLOCKING_OBJECT_EXIST(uLocal_2510))
	{
		uLocal_2510 = ADD_NAVMESH_BLOCKING_OBJECT(2464.956f, 4990.051f, 44.48415f, 2.5f, 3.125f, 2.0625f, 0f, 0, 7);
	}
	iLocal_2651[0] = CREATE_PICKUP_ROTATE(joaat("pickup_health_standard"), 2444.497f, 4975.956f, 50.565f, 0f, 0f, 100f, iVar0, -1, 2, 1, 0);
	ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(iLocal_2651[0], "V_8_Bed1Rm");
	iLocal_2651[1] = CREATE_PICKUP_ROTATE(joaat("pickup_health_standard"), 2443.4f, 4978.52f, 46.8107f, 0f, 0f, 100f, iVar0, -1, 2, 1, 0);
	ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(iLocal_2651[1], "V_8_KitchnRm");
	iLocal_2651[3] = CREATE_PICKUP_ROTATE(joaat("pickup_health_standard"), 2441.028f, 4963.851f, 46.5605f, 0f, 0f, -80.6f, iVar0, -1, 2, 1, 0);
	ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(iLocal_2651[3], "V_8_StudyRm");
	iLocal_2651[4] = CREATE_PICKUP_ROTATE(joaat("pickup_health_standard"), 2435.165f, 4971.467f, 45.91f, 0f, 0f, -50.4f, iVar0, -1, 2, 1, 0);
	ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(iLocal_2651[4], "V_8_Hall2Rm");
	iVar0 = 0;
	SET_BIT(&iVar0, 2);
	SET_BIT(&iVar0, 1);
	SET_BIT(&iVar0, 3);
	iLocal_2651[2] = CREATE_PICKUP_ROTATE(joaat("pickup_weapon_sawnoffshotgun"), 2438.788f, 4970.79f, 50.565f, 0f, 0f, 0f, iVar0, -1, 2, 1, 0);
...
int func_33(float fParam0, int iParam1)
{
	...
	if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
	{
		if (GET_PED_IN_VEHICLE_SEAT(uVar0, -1, 0) == PLAYER_PED_ID())
		{
			...
			{
				_SET_VEHICLE_HALT(uVar0, fParam0, iParam1, 0);
				return 0;
			}
		}
		else
...
void func_44()
{
	...
	{
		if (func_47(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
...
void func_58(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	
	if (IS_STRING_NULL_OR_EMPTY(uLocal_51) || !ARE_STRINGS_EQUAL(uLocal_51, uParam0))
	{
		uLocal_51 = uParam0;
		iVar0 = 0;
		while (iVar0 <= 15)
...
float func_67(int iParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
void func_69(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	func_70(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_70(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, var uParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	var uVar0;
	bool bVar1;
	bool bVar2;
	...
	if (DOES_ENTITY_EXIST(uVar0))
	{
		...
		if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_74(uVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_74(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
				...
				case 1:
					switch (Local_755[iVar0 /*33*/].f_1)
					{
						case 1:
							switch (Local_755[iVar0 /*33*/].f_2)
							{
								...
								case 4:
									if (iLocal_2511 == 3)
									{
										...
										{
											Local_755[iVar0 /*33*/].f_20 = CREATE_OBJECT(joaat("prop_cs_fertilizer"), 2460.098f, 4957.283f, 44.1304f, 1, 1, 0);
									...
									{
										func_100(&Local_1619, iVar0, Local_755[iVar0 /*33*/], 0, 0, 0);
										Local_755[iVar0 /*33*/].f_20 = CREATE_OBJECT(joaat("prop_cs_fertilizer"), 2478.444f, 4976.921f, 44.5614f, 1, 1, 0);
										Local_755[iVar0 /*33*/].f_5 = 1;
										func_99(iVar0, 2, 0, 0);
									}
									break;
								...
								case 5:
									if (iLocal_2511 == 3)
									{
										...
										{
											Local_755[iVar0 /*33*/].f_20 = CREATE_OBJECT(joaat("prop_cs_fertilizer"), 2455.753f, 4952.719f, 44.1445f, 1, 1, 0);
											Local_755[iVar0 /*33*/].f_5 = 1;
											func_99(iVar0, 3, 0, 0);
										}
									}
									...
									{
										func_100(&Local_1619, iVar0, Local_755[iVar0 /*33*/], 0, 0, 0);
										Local_755[iVar0 /*33*/].f_20 = CREATE_OBJECT(joaat("prop_cs_fertilizer"), 2476.582f, 4978.492f, 44.5734f, 1, 1, 0);
								...
								case 8:
									if (func_101(iVar0, joaat("a_m_m_hillbilly_02"), 2505.451f, 4970.663f, 43.548f, 49.5021f, joaat("weapon_pistol"), 1, 0))
									{
										...
										TASK_SYNCHRONIZED_SCENE(Local_755[iVar0 /*33*/], Local_755[iVar0 /*33*/].f_14, "misschinese2_bank5", "peds_shootcans_a", 1000f, -4f, 1, 0, 1148846080, 0);
										SET_SYNCHRONIZED_SCENE_LOOPED(Local_755[iVar0 /*33*/].f_14, 1);
								...
								case 9:
									if (func_101(iVar0, joaat("a_m_m_hillbilly_01"), 2505.451f, 4970.663f, 43.548f, 49.5021f, joaat("weapon_pistol"), 1, 0))
									{
										...
										SET_SYNCHRONIZED_SCENE_LOOPED(Local_755[iVar0 /*33*/].f_14, 1);
										func_100(&Local_1619, iVar0, Local_755[iVar0 /*33*/], 0, 0, 0);
										TASK_SYNCHRONIZED_SCENE(Local_755[iVar0 /*33*/], Local_755[iVar0 /*33*/].f_14, "misschinese2_bank5", "peds_shootcans_b", 1000f, -4f, 1, 0, 1148846080, 0);
										_0x2208438012482A1A(Local_755[iVar0 /*33*/], 0, 0);
										func_99(iVar0, 4, 0, Local_755[iVar0 /*33*/].f_14);
									}
									break;
							...
							{
								SET_ENTITY_LOAD_COLLISION_FLAG(Local_755[iVar0 /*33*/], 1, 1);
					...
					if (!IS_PED_INJURED(Local_755[iVar0 /*33*/]))
					{
						_SET_ENTITY_SOMETHING(Local_755[iVar0 /*33*/], 1);
						...
						switch (Local_755[iVar0 /*33*/].f_3)
						{
							...
							case 2:
								...
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									...
									case 3:
										if (IS_ENTITY_AT_COORD(Local_755[iVar0 /*33*/], Local_755[iVar0 /*33*/].f_6, 1.5f, 1.5f, 2f, 0, 1, 0))
										{
									...
									case 6:
										if (IS_ENTITY_AT_COORD(Local_755[iVar0 /*33*/], Local_755[iVar0 /*33*/].f_6, 1.5f, 1.5f, 2f, 0, 1, 0))
										{
											...
											if (DOES_ENTITY_EXIST(Local_755[iVar0 /*33*/].f_20))
											{
												DETACH_ENTITY(Local_755[iVar0 /*33*/].f_20, 0, 1);
											}
											if (func_68(iLocal_2507))
											{
												if (Local_755[iVar0 /*33*/].f_2 == 4)
												{
													SET_PED_MOVEMENT_CLIPSET(Local_755[iVar0 /*33*/], "move_m@gangster@var_e", 1048576000);
												...
												{
													SET_PED_MOVEMENT_CLIPSET(Local_755[iVar0 /*33*/], "move_m@gangster@var_f", 1048576000);
													TASK_ENTER_VEHICLE(Local_755[iVar0 /*33*/], iLocal_2507, -1, 0, 1f, 1, 0);
												}
											}
											Local_755[iVar0 /*33*/].f_5++;
									...
									case 7:
										...
										{
											SET_ENTITY_LOAD_COLLISION_FLAG(Local_755[iVar0 /*33*/], 0, 1);
											Local_755[iVar0 /*33*/].f_5++;
										}
										break;
									...
									case 8:
										if (func_68(iLocal_2507))
										{
											if (!IS_VEHICLE_SEAT_FREE(iLocal_2507, -1, 0))
											{
												if (Local_755[iVar0 /*33*/].f_2 == 4)
												{
													if (!IS_VEHICLE_SEAT_FREE(iLocal_2507, 0, 0))
													{
														iVar1 = func_18(5);
														if (iVar1 >= 0)
														{
															if (!IS_PED_INJURED(Local_755[iVar1 /*33*/]))
															{
																...
																{
																	func_93();
																	TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_2507, 2367.668f, 5098.645f, 46.8185f, 12f, 0, joaat("burrito"), 786599, 5f, 5f);
																	TASK_VEHICLE_DRIVE_WANDER(0, iLocal_2507, 19f, 786599);
							...
							case 6:
								...
								{
									case 0:
										SET_CURRENT_PED_WEAPON(Local_755[iVar0 /*33*/], joaat("weapon_unarmed"), 1);
									...
									switch (Local_755[iVar0 /*33*/].f_5)
									{
										...
										case 12:
											if (CAN_PED_HEAR_PLAYER(PLAYER_ID(), Local_755[iVar0 /*33*/]) && func_67(Local_755[iVar0 /*33*/], 2448.003f, 4982.305f, 45.8519f, 1) < 10f)
											{
												...
												{
													TASK_FOLLOW_NAV_MESH_TO_COORD(Local_755[iVar0 /*33*/], GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 1f, 20000, 1048576000, 0, 1193033728);
								...
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									...
									case 1:
										if (GET_GAME_TIMER() > Local_755[iVar0 /*33*/].f_14)
										{
											if (func_68(iLocal_2507))
											{
												TASK_ENTER_VEHICLE(Local_755[iVar0 /*33*/], iLocal_2507, 20000, 1, 1f, 1, 0);
												Local_755[iVar0 /*33*/].f_5++;
												Local_755[iVar0 /*33*/].f_14 = 0;
												Local_755[iVar0 /*33*/].f_15 = 0;
											}
									...
									case 1:
										if (!GET_CURRENT_PED_WEAPON(Local_755[iVar0 /*33*/], &iVar4, 1))
										{
											...
											if (iVar0 == 1)
											{
												...
												{
													TASK_TURN_PED_TO_FACE_ENTITY(0, Local_755[2 /*33*/], 2000);
												}
											}
											else if (iVar0 == 2)
											{
												...
												{
													TASK_TURN_PED_TO_FACE_ENTITY(0, Local_755[1 /*33*/], 2000);
												}
											}
											else if (iVar0 == 6)
											{
												...
												{
													TASK_TURN_PED_TO_FACE_ENTITY(0, Local_755[7 /*33*/], 2000);
												}
											}
											else if (iVar0 == 7)
											{
												...
												{
													TASK_TURN_PED_TO_FACE_ENTITY(0, Local_755[6 /*33*/], 2000);
												}
											}
											if (Local_755[iVar0 /*33*/].f_14 != 0)
											{
												TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", Local_755[iVar0 /*33*/].f_14, 0);
											}
											else
											{
							...
							case 28:
								...
								{
									case 0:
										if (IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), Local_755[iVar0 /*33*/]) || (func_90(GET_ENTITY_COORDS(Local_755[iVar0 /*33*/], 1), 1f, 1120403456) && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2448.583f, 4969.292f, 45.1856f, 2439.538f, 4978.061f, 46.82762f, 5.75f, 0, 1, 0)))
										{
											TASK_HANDS_UP(Local_755[iVar0 /*33*/], 20000, 0, -1, 0);
									...
									case 4:
										if (GET_GAME_TIMER() > Local_755[iVar0 /*33*/].f_14)
										{
											...
											SET_PED_KEEP_TASK(Local_755[iVar0 /*33*/], 1);
							...
							case 30:
								if (!IS_PED_INJURED(Local_755[iVar0 /*33*/]))
								{
									...
									{
										if (HAS_PED_BEEN_DAMAGED_BY_WEAPON(Local_755[iVar0 /*33*/], 0, 2))
										{
											if (!HAS_PED_GOT_WEAPON(Local_755[iVar0 /*33*/], 0, 2))
											{
												GIVE_WEAPON_TO_PED(Local_755[iVar0 /*33*/], joaat("weapon_pistol"), -1, 0, 1);
												TASK_COMBAT_PED(Local_755[iVar0 /*33*/], PLAYER_PED_ID(), 0, 16);
												func_88();
												SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_755[iVar0 /*33*/], 0);
												TASK_COMBAT_PED(Local_755[iVar0 /*33*/], PLAYER_PED_ID(), 0, 16);
												SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[iVar0 /*33*/], iLocal_1616);
								...
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									case 0:
										...
										SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_755[iVar0 /*33*/], 1);
										SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[iVar0 /*33*/], iLocal_1616);
										Local_755[iVar0 /*33*/].f_5++;
										break;
									...
									case 1:
										if (HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze") && HAS_WEAPON_ASSET_LOADED(joaat("weapon_sawnoffshotgun")))
										{
											if (!IS_PED_INJURED(Local_755[iVar0 /*33*/]))
											{
												uLocal_2875 = CREATE_SYNCHRONIZED_SCENE(2435.312f, 4967.087f, 41.35f, 0f, 0f, 11.4f, 2);
												SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_2875, 1);
												TASK_SYNCHRONIZED_SCENE(Local_755[iVar0 /*33*/], uLocal_2875, "misschinese2_crystalmaze", "_cower_loop", 1000f, -8f, 0, 0, 1148846080, 0);
												if (!DOES_ENTITY_EXIST(uLocal_2878))
												{
													uLocal_2878 = CREATE_WEAPON_OBJECT(joaat("weapon_sawnoffshotgun"), 40, 2433.59f, 4969.7f, 42.1854f, 1, 1065353216, 0, 0, 1);
													SET_ENTITY_ROTATION(uLocal_2878, 90f, 0f, 0f, 2, 1);
												}
									...
									case 3:
										uLocal_2874 = CREATE_SYNCHRONIZED_SCENE(2435.312f, 4967.087f, 41.35f, 0f, 0f, 11.4f, 2);
										TASK_SYNCHRONIZED_SCENE(Local_755[iVar0 /*33*/], uLocal_2874, "misschinese2_crystalmaze", "_cower_to_stand", 4f, -8f, 0, 0, 1148846080, 0);
										TASK_LOOK_AT_ENTITY(Local_755[iVar0 /*33*/], PLAYER_PED_ID(), -1, 0, 2);
										Local_755[iVar0 /*33*/].f_5++;
										break;
									...
									case 4:
										...
										if ((IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_2874) && GET_SYNCHRONIZED_SCENE_PHASE(uLocal_2874) > 0.98f) || !IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_2874))
										{
									...
									case 5:
										if ((IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_2874) && GET_SYNCHRONIZED_SCENE_PHASE(uLocal_2874) > 0.98f) || !IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_2874))
										{
											...
											SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_2873, 1);
											TASK_SYNCHRONIZED_SCENE(Local_755[iVar0 /*33*/], iLocal_2873, "misschinese2_crystalmaze", "_stand_loop", 4f, -8f, 0, 0, 1148846080, 0);
											Local_755[iVar0 /*33*/].f_5++;
									...
									case 6:
										if (!IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_2876) || iLocal_2876 == 0)
										{
											if (GET_GAME_TIMER() > Local_755[iVar0 /*33*/].f_14)
											{
												...
												{
													TASK_SYNCHRONIZED_SCENE(Local_755[iVar0 /*33*/], iLocal_2876, "misschinese2_crystalmaze", "_stand_loop_a", 4f, -8f, 0, 0, 1148846080, 0);
												}
												else
												{
													TASK_SYNCHRONIZED_SCENE(Local_755[iVar0 /*33*/], iLocal_2876, "misschinese2_crystalmaze", "_stand_loop_b", 4f, -8f, 0, 0, 1148846080, 0);
												}
											}
										}
										...
										if (!func_59() || (func_67(PLAYER_PED_ID(), 2430.09f, 4965.93f, 41.55f, 1) > 3.438f && !IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2427.079f, 4964.971f, 41.81169f, 2432.589f, 4959.331f, 48.7548f, 3.3125f, 0, 1, 0)))
										{
											func_85();
											Local_755[iVar0 /*33*/].f_5++;
										}
									...
									case 8:
										uLocal_2877 = CREATE_SYNCHRONIZED_SCENE(2435.312f, 4967.087f, 41.35f, 0f, 0f, 11.4f, 2);
										TASK_SYNCHRONIZED_SCENE(Local_755[iVar0 /*33*/], uLocal_2877, "misschinese2_crystalmaze", "_stand_to_aim", 4f, -8f, 0, 0, 1148846080, 0);
										GIVE_WEAPON_OBJECT_TO_PED(uLocal_2878, Local_755[iVar0 /*33*/]);
										Local_755[iVar0 /*33*/].f_5++;
										break;
									
									case 9:
										if ((IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_2877) && GET_SYNCHRONIZED_SCENE_PHASE(uLocal_2877) > 0.98f) || !IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_2877))
										{
							...
							case 27:
								switch (Local_755[iVar0 /*33*/].f_5)
								{
									case 0:
										...
										TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 200f, 999999, 0, 0);
										TASK_COWER(0, -1);
										func_92(&(Local_755[iVar0 /*33*/]), 0);
										SET_PED_KEEP_TASK(Local_755[iVar0 /*33*/], 1);
										SET_PED_AS_NO_LONGER_NEEDED(&(Local_755[iVar0 /*33*/]));
							...
							case 14:
								switch (Local_1619[iVar0 /*24*/].f_4)
								{
									case 1:
										...
										TASK_COMBAT_PED(Local_755[iVar0 /*33*/], PLAYER_PED_ID(), 0, 16);
										SET_PED_TARGET_LOSS_RESPONSE(Local_755[iVar0 /*33*/], 1);
										SET_PED_COMBAT_ATTRIBUTES(Local_755[iVar0 /*33*/], 50, 1);
...
int func_80(int iParam0)
{
	...
	*iParam0 = GET_RANDOM_INT_IN_RANGE(0, 10);
	...
	while (!bVar1)
	{
		if (DOES_ENTITY_EXIST(iLocal_2657[*iParam0]) && IS_ENTITY_IN_ANGLED_AREA(iLocal_2657[*iParam0], 2495.017f, 4970.17f, 44.21808f, 2493.501f, 4971.556f, 45.40248f, 1.375f, 0, 1, 0))
		{
			return 1;
		}
		else
...
int func_90(vector3 vParam0, float fParam3, float fParam4)
{
	if (IS_SPHERE_VISIBLE(vParam0, fParam3))
	{
		if (!IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vParam0, fParam4, fParam4, fParam4, 0, 0, 0))
		{
			return 0;
		}
...
void func_92(var uParam0, bool bParam1)
{
	if (bParam1)
	{
		SET_SEQUENCE_TO_REPEAT(uLocal_257, 1);
	}
	CLOSE_SEQUENCE_TASK(uLocal_257);
	if (!IS_PED_DEAD_OR_DYING(*uParam0, 1))
	{
		TASK_PERFORM_SEQUENCE(*uParam0, uLocal_257);
	}
	CLEAR_SEQUENCE_TASK(&uLocal_257);
}

void func_93()
{
	OPEN_SEQUENCE_TASK(&uLocal_257);
}

void func_94(int iParam0)
{
	Local_755[iParam0 /*33*/].f_15 = (Local_755[iParam0 /*33*/].f_15 + FLOOR((TIMESTEP() * 1000f)));
	switch (Local_755[iParam0 /*33*/].f_2)
	{
		case 7:
			if (Local_755[iParam0 /*33*/].f_15 > 2000 && !IS_BIT_SET(Local_755[iParam0 /*33*/].f_14, 0))
			{
				TASK_LOOK_AT_COORD(Local_755[iParam0 /*33*/], 2505.634f, 4996.994f, 46.6624f, 4000, 0, 2);
				SET_BIT(&(Local_755[iParam0 /*33*/].f_14), 0);
			}
			else if (Local_755[iParam0 /*33*/].f_15 > 8000 && !IS_BIT_SET(Local_755[iParam0 /*33*/].f_14, 1))
			{
				TASK_LOOK_AT_COORD(Local_755[iParam0 /*33*/], 2472.297f, 4962.687f, 47.2297f, 6000, 0, 2);
				SET_BIT(&(Local_755[iParam0 /*33*/].f_14), 1);
			}
			break;
		
		case 5:
			if (Local_755[iParam0 /*33*/].f_15 > 3000 && !IS_BIT_SET(Local_755[iParam0 /*33*/].f_14, 0))
			{
				if (!IS_PED_INJURED(Local_755[6 /*33*/]))
				{
			...
			else if (Local_755[iParam0 /*33*/].f_15 > 11000 && !IS_BIT_SET(Local_755[iParam0 /*33*/].f_14, 1))
			{
		...
		case 4:
			...
			else if (Local_755[iParam0 /*33*/].f_15 > 10000 && !IS_BIT_SET(Local_755[iParam0 /*33*/].f_14, 1))
			{
...
int func_97(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
void func_98(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5)
{
	if (!IS_PED_INJURED(uParam0))
	{
		...
		SET_PED_VISUAL_FIELD_PERIPHERAL_RANGE(uParam0, fParam2);
		SET_PED_VISUAL_FIELD_CENTER_ANGLE(uParam0, (fParam3 / 2f));
		SET_PED_VISUAL_FIELD_MIN_ANGLE(uParam0, fParam4);
		SET_PED_VISUAL_FIELD_MAX_ANGLE(uParam0, fParam5);
	}
}
...
int func_101(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	...
	{
		case 0:
			Local_755[iParam0 /*33*/] = CREATE_PED(26, joaat("a_m_m_hillbilly_01"), vParam2, fParam5, 1, 1);
			SET_PED_DEFAULT_COMPONENT_VARIATION(Local_755[iParam0 /*33*/]);
			SET_PED_COMPONENT_VARIATION(Local_755[iParam0 /*33*/], 0, 0, 1, 0);
		...
		case 1:
			Local_755[iParam0 /*33*/] = CREATE_PED(26, joaat("a_m_m_hillbilly_02"), vParam2, fParam5, 1, 1);
			SET_PED_DEFAULT_COMPONENT_VARIATION(Local_755[iParam0 /*33*/]);
		...
		case 2:
			Local_755[iParam0 /*33*/] = CREATE_PED(26, joaat("a_m_y_methhead_01"), vParam2, fParam5, 1, 1);
			SET_PED_DEFAULT_COMPONENT_VARIATION(Local_755[iParam0 /*33*/]);
			SET_PED_COMPONENT_VARIATION(Local_755[iParam0 /*33*/], 0, 0, 1, 0);
		...
		case 3:
			Local_755[iParam0 /*33*/] = CREATE_PED(26, joaat("a_m_m_hillbilly_01"), vParam2, fParam5, 1, 1);
			SET_PED_DEFAULT_COMPONENT_VARIATION(Local_755[iParam0 /*33*/]);
			SET_PED_COMPONENT_VARIATION(Local_755[iParam0 /*33*/], 0, 0, 2, 0);
	...
	{
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_755[iParam0 /*33*/], 1);
		SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[iParam0 /*33*/], uLocal_1617);
	}
	else
	{
		GIVE_WEAPON_TO_PED(Local_755[iParam0 /*33*/], iParam6, 3000, iParam7, 1);
		SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[iParam0 /*33*/], iLocal_1616);
		SET_PED_AS_ENEMY(Local_755[iParam0 /*33*/], 1);
		SET_PED_COMBAT_ATTRIBUTES(Local_755[iParam0 /*33*/], 9, 1);
		...
		SET_PED_CONFIG_FLAG(Local_755[iParam0 /*33*/], 118, 0);
		SET_COMBAT_FLOAT(Local_755[iParam0 /*33*/], 14, 3f);
		...
		SET_PED_DIES_WHEN_INJURED(Local_755[iParam0 /*33*/], 1);
		SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_755[iParam0 /*33*/], 1);
		SET_PED_COMBAT_ATTRIBUTES(Local_755[iParam0 /*33*/], 15, 0);
		SET_PED_COMBAT_ATTRIBUTES(Local_755[iParam0 /*33*/], 17, 0);
		func_102(Local_755[iParam0 /*33*/], 1);
	}
	STOP_PED_WEAPON_FIRING_WHEN_DROPPED(Local_755[iParam0 /*33*/]);
	_SET_ENTITY_SOMETHING(Local_755[iParam0 /*33*/], 1);
	...
	SET_ENTITY_HEALTH(Local_755[iParam0 /*33*/], 150, 0);
	return 1;
}
...
void func_103(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, vector3 vParam8, vector3 vParam11, vector3 vParam14, vector3 vParam17, vector3 vParam20, vector3 vParam23, vector3 vParam26, vector3 vParam29)
{
	if (iLocal_52 > 0)
	{
...
void func_104(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10, vector3 vParam13, vector3 vParam16, vector3 vParam19)
{
...
void func_107(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, vector3 vParam8)
{
	int iVar0;
	float fVar1;
	var uVar2;
							...
							switch ((uParam0[iVar0 /*24*/])->f_4)
							{
								case 0:
									...
									if (!IS_PED_USING_SCENARIO((*uParam0)[iVar0 /*24*/], "PROP_HUMAN_SEAT_CHAIR") && !IS_PED_USING_SCENARIO((*uParam0)[iVar0 /*24*/], "PROP_HUMAN_SEAT_ARMCHAIR"))
									{
										...
										{
											uVar2 = GET_VEHICLE_PED_IS_USING((*uParam0)[iVar0 /*24*/]);
											if (IS_VEHICLE_DRIVEABLE(uVar2, 0))
											{
												if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uVar2))
												{
													vVar3 = { GET_ENTITY_VELOCITY(uVar2) };
													STOP_PLAYBACK_RECORDED_VEHICLE(uVar2);
													SET_ENTITY_VELOCITY(uVar2, vVar3);
										...
										if (!IS_PED_IN_ANY_VEHICLE((*uParam0)[iVar0 /*24*/], 0))
										{
											switch ((uParam0[iVar0 /*24*/])->f_1)
											{
												...
												case 7:
													...
													{
														case 0:
															SET_CURRENT_PED_WEAPON((*uParam0)[iVar0 /*24*/], GET_BEST_PED_WEAPON((*uParam0)[iVar0 /*24*/], 0), 1);
															func_93();
												...
												case 5:
													...
													if (!IS_PED_IN_ANY_VEHICLE((*uParam0)[iVar0 /*24*/], 1))
													{
														...
														{
															case 0:
																SET_BLOCKING_OF_NON_TEMPORARY_EVENTS((*uParam0)[iVar0 /*24*/], 1);
								...
								case 1:
									if (!(uParam0[iVar0 /*24*/])->f_21)
									{
										...
										if (!bVar14)
										{
											...
											SET_ENTITY_LOAD_COLLISION_FLAG((*uParam0)[iVar0 /*24*/], 1, 1);
						...
						else
						{
							switch ((uParam0[iVar0 /*24*/])->f_4)
							{
								case 0:
									...
									SET_CURRENT_PED_WEAPON((*uParam0)[iVar0 /*24*/], GET_BEST_PED_WEAPON((*uParam0)[iVar0 /*24*/], 0), 1);
									SET_BLOCKING_OF_NON_TEMPORARY_EVENTS((*uParam0)[iVar0 /*24*/], 0);
									_0xA3A9299C4F2ADB98((*uParam0)[iVar0 /*24*/]);
									SET_PED_COMBAT_ATTRIBUTES((*uParam0)[iVar0 /*24*/], 50, 1);
									SET_PED_FLEE_ATTRIBUTES((*uParam0)[iVar0 /*24*/], 512, 1);
									(uParam0[iVar0 /*24*/])->f_4++;
									break;
...
int func_109(int iParam0, var uParam1, char* sParam2, vector3 vParam3, vector3 vParam6, vector3 vParam9, bool bParam12)
{
		...
		case 2:
			if (!ARE_STRINGS_EQUAL("chi2_hear", vParam3.y))
			{
				if ((CAN_PED_HEAR_PLAYER(PLAYER_ID(), (*uParam1)[iParam0 /*24*/]) || iLocal_75 == 1) && func_67((*uParam1)[iParam0 /*24*/], (uParam1[iParam0 /*24*/])->f_12, 1) < (uParam1[iParam0 /*24*/])->f_19)
				{
					...
					{
						TASK_FOLLOW_NAV_MESH_TO_COORD((*uParam1)[iParam0 /*24*/], GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 1f, 20000, 0.1f, 0, 1193033728);
...
float func_111(var uParam0, var uParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
float func_113(var uParam0, var uParam1)
{
	if (DOES_ENTITY_EXIST(uParam0) && DOES_ENTITY_EXIST(uParam1))
	{
		return func_114(uParam0, GET_ENTITY_COORDS(uParam1, 0));
	}
	return 0f;
}

float func_114(var uParam0, vector3 vParam1)
{
	float fVar0;
	...
	if (DOES_ENTITY_EXIST(uParam0))
	{
		if (!IS_ENTITY_DEAD(uParam0, 0))
		{
			fVar0 = func_96(GET_ENTITY_COORDS(uParam0, 0), vParam1, 1);
			return (fVar0 - GET_ENTITY_HEADING(uParam0));
		}
	}
	return 0f;
}
...
void func_115(var uParam0, struct<2> Param1, var uParam3, struct<2> Param4, var uParam6, struct<2> Param7, var uParam9, struct<2> Param10, var uParam12)
{
	...
	{
		uVar13 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
		if (IS_VEHICLE_DRIVEABLE(uVar13, 0))
		{
			if (GET_IS_VEHICLE_ENGINE_RUNNING(uVar13))
			{
				iVar14 = 1;
			}
		}
	}
	if (IS_EXPLOSION_IN_SPHERE(-1, vLocal_71, uLocal_74))
	{
		bLocal_54 = true;
	}
	if (!iLocal_55)
	...
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		uVar17 = GET_VEHICLE_PED_IS_USING(PLAYER_PED_ID());
	}
	if (iLocal_62 == -1)
	{
		iLocal_75 = 0;
		...
		if (!IS_PED_DEAD_OR_DYING((*uParam0)[iVar0 /*24*/], 1))
		{
			if ((uParam0[iVar0 /*24*/])->f_3 != 7)
			{
				...
				if ((uParam0[iVar0 /*24*/])->f_3 <= 4)
				{
					if (iLocal_62 == -1)
					{
						if (IS_VEHICLE_DRIVEABLE(uVar17, 0))
						{
							if (GET_IS_VEHICLE_ENGINE_RUNNING(uVar17))
							{
								iLocal_75 = 1;
								fVar16 = 20f;
							}
							if (IS_VEHICLE_SIREN_ON(uVar17))
							{
								iLocal_75 = 1;
								fVar16 = 50f;
							}
						}
						if (CAN_PED_HEAR_PLAYER(PLAYER_ID(), (*uParam0)[iVar0 /*24*/]) || (IS_VEHICLE_DRIVEABLE(uVar17, 0) && GET_IS_VEHICLE_ENGINE_RUNNING(uVar17)))
						{
					...
					if (!bLocal_258 && !IS_PED_RAGDOLL((*uParam0)[iVar0 /*24*/]))
					{
				...
				if ((uParam0[iVar0 /*24*/])->f_3 <= 5)
				{
					...
					if (((IS_PED_RESPONDING_TO_EVENT((*uParam0)[iVar0 /*24*/], 1) || HAS_PED_RECEIVED_EVENT((*uParam0)[iVar0 /*24*/], 1)) || (IS_PED_IN_COMBAT((*uParam0)[iVar0 /*24*/], 0) && CAN_PED_IN_COMBAT_SEE_TARGET((*uParam0)[iVar0 /*24*/], PLAYER_PED_ID()))) || (func_116((*uParam0)[iVar0 /*24*/]) && HAS_PED_RECEIVED_EVENT((*uParam0)[iVar0 /*24*/], 1)))
					{
						if ((uParam0[iVar0 /*24*/])->f_3 > 4)
						{
...
{
	if (IS_ENTITY_PLAYING_ANIM(uParam0, "misschinese2_bank1", "alert_gunshot", 3))
	{
		return 1;
	}
	if (IS_ENTITY_PLAYING_ANIM(uParam0, "misschinese2_bank1", "buddy_shot_b", 3))
	{
		return 1;
	}
	if (IS_ENTITY_PLAYING_ANIM(uParam0, "misschinese2_bank1", "reaction_forward_big_intro_a", 3))
	{
		return 1;
	}
	if (IS_ENTITY_PLAYING_ANIM(uParam0, "misschinese2_bank1", "alert_body", 3))
	{
		return 1;
	}
	if (IS_ENTITY_PLAYING_ANIM(uParam0, "misschinese2_bank1", "react_forward_small_intro_a", 3))
	{
		return 1;
	}
	if (IS_ENTITY_PLAYING_ANIM(uParam0, "misschinese2_bank1", "react_backward_small_intro_a", 3))
	{
		return 1;
	}
	if (IS_ENTITY_PLAYING_ANIM(uParam0, "misschinese2_bank1", "react_left_small_intro_a", 3))
	{
		return 1;
	}
	if (IS_ENTITY_PLAYING_ANIM(uParam0, "misschinese2_bank1", "react_right_small_intro_a", 3))
	{
		return 1;
	}
	return 0;
...
void func_117()
{
	if (iLocal_3491)
	{
		if (IS_STRING_NULL_OR_EMPTY(&vLocal_3498))
		{
			if (func_59())
			{
				if (IS_SCRIPTED_CONVERSATION_ONGOING())
	...
	if (iLocal_437 == 0)
	{
		if (GET_CLOSEST_FIRE_POS(&vVar1, Local_444[0 /*5*/]))
		{
			...
			while (iVar0 < Local_444)
			{
				if (iVar0 > 0)
				{
					fVar4 = (fVar4 + GET_DISTANCE_BETWEEN_COORDS(Local_444[(iVar0 - 1) /*5*/], Local_444[iVar0 /*5*/], 1));
				}
...
void func_122(vector3 vParam0, int iParam3)
{
	if (iLocal_438 == 0)
	{
		iParam3 = 0;
	...
	Local_281[iLocal_441 /*5*/] = START_SCRIPT_FIRE(vParam0, uLocal_270, iParam3);
	iLocal_441++;
	if (iLocal_441 >= 31)
	{
		iLocal_441 = 0;
...
void func_148()
{
	...
	if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2432.476f, 4953.242f, 43.05545f, 2466.34f, 4986.15f, 57.25303f, 14.4375f, 0, 1, 0))
	{
		if (vVar0.z < 50f)
		{
			if ((((IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2436.762f, 4956.011f, 44.49009f, 2443.38f, 4962.625f, 48.2233f, 1.5f, 0, 1, 0) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2447.669f, 4966.554f, 44.95141f, 2452.497f, 4969.825f, 48.89074f, 2.3125f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2454.863f, 4968.686f, 44.95141f, 2460.505f, 4974.409f, 48.82641f, 1.6875f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2459.058f, 4977.546f, 44.95141f, 2460.411f, 4979.302f, 48.82641f, 1.6875f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2457.602f, 4984.746f, 44.73669f, 2461.977f, 4989.49f, 48.47844f, 1.6875f, 0, 1, 0))
			{
		...
		else if ((((((IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2454.179f, 4995.281f, 44.54151f, 2453.096f, 4993.905f, 48.32043f, 1.6875f, 0, 1, 0) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2449.401f, 4990.354f, 44.92924f, 2447.717f, 4988.865f, 48.82129f, 1.6875f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2443.906f, 4990.104f, 44.4446f, 2439.007f, 4985.271f, 48.30458f, 1.6875f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2439.602f, 4982.387f, 44.95141f, 2440.797f, 4981.365f, 48.82642f, 1.6875f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2440.259f, 4980.671f, 44.95142f, 2434.769f, 4975.055f, 48.82642f, 1.6875f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2432.165f, 4972.586f, 44.29909f, 2430.114f, 4970.545f, 48.21086f, 1.6875f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2428.46f, 4968.569f, 44.81597f, 2426.632f, 4966.603f, 48.29342f, 1.6875f, 0, 1, 0))
		{
			if (!IS_ENTITY_ON_FIRE(PLAYER_PED_ID()))
			{
				START_ENTITY_FIRE(PLAYER_PED_ID());
	...
	else if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2455.487f, 4997.566f, 43.1101f, 2423.653f, 4962.837f, 57.34888f, 14.4375f, 0, 1, 0))
	{
		if (vVar0.z < 50f)
		{
			if ((IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2442.913f, 4965.273f, 50.15687f, 2444.49f, 4967.41f, 53.81783f, 1.6875f, 0, 1, 0) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2445.239f, 4969.07f, 49.94284f, 2450.365f, 4972.188f, 54.03251f, 2.375f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2452.332f, 4971.817f, 49.94283f, 2457.977f, 4977.583f, 53.88097f, 2.375f, 0, 1, 0))
			{
				if (!IS_ENTITY_ON_FIRE(PLAYER_PED_ID()))
				{
					START_ENTITY_FIRE(PLAYER_PED_ID());
		...
		else if ((IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2457.621f, 4978.462f, 49.94283f, 2453.932f, 4982.161f, 53.81783f, 2.375f, 0, 1, 0) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2452.054f, 4984.156f, 49.94283f, 2448.12f, 4987.809f, 53.81316f, 2.375f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2442.014f, 4980.539f, 49.94283f, 2435.796f, 4971.945f, 53.90388f, 2.375f, 0, 1, 0))
		{
			if (!IS_ENTITY_ON_FIRE(PLAYER_PED_ID()))
			{
				START_ENTITY_FIRE(PLAYER_PED_ID());
		...
		if (func_152(iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1, 0))
		{
			switch (Local_3337[iParam0 /*4*/])
			{
				...
				case 7:
					...
					SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_2677, "FRMBLIPB");
					Local_3337[iParam0 /*4*/].f_1 = 1;
					break;
			...
			switch (Local_3358[iParam0 /*7*/])
			{
				...
				case 9:
					switch (Local_3358[iParam0 /*7*/].f_3)
					{
						case 0:
							if (!IS_PED_INJURED(Local_755[Local_3358[iParam0 /*7*/].f_4 /*33*/]))
							{
								Local_3358[iParam0 /*7*/].f_3 = GET_RANDOM_INT_IN_RANGE(1, 3);
							}
							break;
						...
						case 0:
							...
							while (iVar2 < Local_755)
							{
								if (Local_755[iVar2 /*33*/].f_1 == 2)
								{
									if (!IS_PED_INJURED(Local_755[iVar2 /*33*/]))
									{
										if (IS_PED_IN_COMBAT(Local_755[iVar2 /*33*/], 0))
										{
				...
				case 22:
					switch (Local_3358[iParam0 /*7*/].f_3)
					{
						...
						case 1:
							Local_3358[iParam0 /*7*/].f_4 = (Local_3358[iParam0 /*7*/].f_4 - FLOOR((TIMESTEP() * 1000f)));
			...
			switch (Local_2917[iParam0 /*10*/])
			{
				...
				case 3:
					if (func_67(PLAYER_PED_ID(), 1991.05f, 3054.262f, 46.2147f, 1) > 250f)
					{
						...
						if (iLocal_2884 != -1)
						{
							if (DOES_NAVMESH_BLOCKING_OBJECT_EXIST(iLocal_2884))
							{
				...
				case 7:
					if ((!IS_PED_INJURED(Local_755[12 /*33*/]) && !IS_PED_INJURED(Local_755[13 /*33*/])) && !IS_PED_INJURED(Local_755[14 /*33*/]))
					{
						if (func_169(6, 6) < 2)
						{
							if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1981.257f, 3050.721f, 41.08995f, 1984.257f, 3055.543f, 49.47314f, 3.0625f, 0, 1, 0))
							{
				...
				case 8:
					...
					if (fVar1 < 900f)
					{
						if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
						{
							...
							if (IS_VEHICLE_DRIVEABLE(uVar4, 0))
							{
								if (IS_THIS_MODEL_A_HELI(GET_ENTITY_MODEL(uVar4)) || IS_THIS_MODEL_A_PLANE(GET_ENTITY_MODEL(uVar4)))
								{
									fVar2 = (900f - fVar1);
									if (fVar2 < 0f)
									{
									...
									fVar2 = (fVar2 / 900f);
									fVar2 = (fVar2 * 10000f);
									fVar3 = GET_ENTITY_SPEED(uVar4);
									fVar2 = (fVar2 * (fVar3 / 35f));
									if (fVar3 > 35f)
									{
										APPLY_FORCE_TO_ENTITY_CENTER_OF_MASS(uVar4, 1, 0f, -fVar2, 0f, 0, 1, 0, 0);
									}
								}
							}
						}
				...
				case 9:
					if (IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), "missrampageintrooutro", "trvram_6_1h_run_outro", 3))
					{
						...
						SET_PED_RESET_FLAG(PLAYER_PED_ID(), 321, 1);
						if (HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), GET_HASH_KEY("walkinterruptible")))
						{
							FORCE_PED_MOTION_STATE(PLAYER_PED_ID(), -1871534317, 0, 0, 0);
							if (func_168())
							{
				...
				case 6:
					switch (Local_2917[iParam0 /*10*/].f_6)
					{
						case 0:
							if ((!IS_PED_INJURED(Local_755[12 /*33*/]) && !IS_PED_INJURED(Local_755[13 /*33*/])) && !IS_PED_INJURED(Local_755[14 /*33*/]))
							{
								SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[12 /*33*/], uLocal_2636);
								SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[13 /*33*/], uLocal_2636);
								SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[14 /*33*/], uLocal_2636);
								SET_PED_COMBAT_ATTRIBUTES(Local_755[12 /*33*/], 17, 1);
								SET_PED_COMBAT_ATTRIBUTES(Local_755[13 /*33*/], 17, 1);
								SET_PED_COMBAT_ATTRIBUTES(Local_755[14 /*33*/], 17, 1);
					...
					switch (Local_2917[iParam0 /*10*/].f_6)
					{
						case 1:
							if (GET_GAME_TIMER() > Local_2917[iParam0 /*10*/].f_7)
							{
								...
								{
									ADD_EXPLOSION(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) + Vector(0f, GET_RANDOM_FLOAT_IN_RANGE(0f, 4f), GET_RANDOM_FLOAT_IN_RANGE(0f, 4f)), 16, 1.5f, 1, 0, 1065353216, 0);
						...
						default:
							...
							if (GET_GAME_TIMER() > Local_2917[iParam0 /*10*/].f_8)
							{
								...
								while (iVar5 < vLocal_2889.x)
								{
									...
									{
										ADD_EXPLOSION(vLocal_2889[iVar5 /*3*/], 16, 1.5f, 1, 0, 1065353216, 0);
						...
						case 1:
							if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
							{
								if (_0x109697E2FFBAC8A1())
								{
									...
									{
										if (!GET_IS_VEHICLE_ENGINE_RUNNING(iLocal_2506))
										{
											Local_2917[iParam0 /*10*/].f_6++;
										}
									}
						...
						case 4:
							if (func_68(iLocal_2506))
							{
								if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_2506, 0))
								{
									if (GET_IS_VEHICLE_ENGINE_RUNNING(iLocal_2506))
									{
										Local_2917[iParam0 /*10*/].f_7 = (Local_2917[iParam0 /*10*/].f_7 + GET_GAME_TIMER() + 7000);
										Local_2917[iParam0 /*10*/].f_6++;
									}
								}
							}
							...
							if (GET_CURRENT_PED_WEAPON(PLAYER_PED_ID(), &iVar10, 1))
							{
								if (iVar10 == joaat("weapon_petrolcan"))
								{
									if (IS_CONTROL_PRESSED(0, 24))
									{
										...
										if (iLocal_269 == 0)
										{
											Local_2917[iParam0 /*10*/].f_9 = (Local_2917[iParam0 /*10*/].f_9 + (TIMESTEP() * 2f));
										}
										else if (iLocal_269 < 30 && Local_2917[iParam0 /*10*/].f_9 < 70f)
										{
											Local_2917[iParam0 /*10*/].f_9 = (Local_2917[iParam0 /*10*/].f_9 + (TIMESTEP() * 1.5f));
										}
										else
										{
											Local_2917[iParam0 /*10*/].f_9 = (Local_2917[iParam0 /*10*/].f_9 + TIMESTEP());
										}
										iVar11 = FLOOR((IntToFloat(Local_2917[iParam0 /*10*/].f_7) * (1f - (Local_2917[iParam0 /*10*/].f_9 / 90f))));
										if (iVar11 > 0)
										{
											SET_PED_AMMO(PLAYER_PED_ID(), iVar10, iVar11, 0);
										}
										else
										{
											SET_PED_AMMO(PLAYER_PED_ID(), iVar10, 0, 0);
										}
									}
								}
							}
					...
					switch (Local_2917[iParam0 /*10*/].f_6)
					{
						...
						case 1:
							if (IS_PED_INJURED(Local_755[23 /*33*/]))
							{
								if (DOES_ENTITY_EXIST(uLocal_2878))
								{
									SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_2878);
				...
				case 41:
					switch (Local_2917[iParam0 /*10*/].f_6)
					{
						case 0:
							...
							REQUEST_ANIM_DICT("misschinese2_crystalmaze");
							if (iLocal_2884 == -1 || (iLocal_2884 != -1 && !DOES_NAVMESH_BLOCKING_OBJECT_EXIST(iLocal_2884)))
							{
						...
						case 1:
							if ((HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze") && HAS_MODEL_LOADED(joaat("ig_taocheng"))) && HAS_MODEL_LOADED(joaat("ig_taostranslator")))
							{
								if (!DOES_ENTITY_EXIST(Local_755[11 /*33*/]))
								{
									Local_755[11 /*33*/] = CREATE_PED(26, joaat("ig_taocheng"), 1991.988f, 3054.51f, 46.215f, 0, 1, 1);
									SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[11 /*33*/], uLocal_1618);
									SET_PED_CAN_BE_TARGETTED(Local_755[11 /*33*/], 0);
								}
								...
								if (!DOES_ENTITY_EXIST(Local_755[10 /*33*/]))
								{
									Local_755[10 /*33*/] = CREATE_PED(26, joaat("ig_taostranslator"), 1991.988f, 3054.51f, 46.215f, 0, 1, 1);
									SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[10 /*33*/], uLocal_1618);
									SET_PED_CAN_BE_TARGETTED(Local_755[10 /*33*/], 0);
									SET_PED_PROP_INDEX(Local_755[10 /*33*/], 1, 0, 1, 0);
								}
								...
								if (!IS_PED_INJURED(Local_755[11 /*33*/]))
								{
									if (!IS_SYNCHRONIZED_SCENE_RUNNING(Local_2917[iParam0 /*10*/].f_7))
									{
										...
										_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(Local_2917[iParam0 /*10*/].f_7, 1);
									}
									TASK_SYNCHRONIZED_SCENE(Local_755[11 /*33*/], Local_2917[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_A_TaoCheng", 1000f, -4f, 257, 16, 1148846080, 0);
								}
								if (!IS_PED_INJURED(Local_755[10 /*33*/]))
								{
									...
									TASK_SYNCHRONIZED_SCENE(Local_755[10 /*33*/], Local_2917[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_A_taotranslator", 1000f, -4f, 257, 16, 1148846080, 0);
								}
								Local_2917[iParam0 /*10*/].f_6++;
							}
							break;
						...
						case 2:
							...
							{
								SET_PED_COMPONENT_VARIATION(Local_755[10 /*33*/], 0, 0, 0, 0);
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_755[11 /*33*/], 1);
								SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_755[10 /*33*/], 1);
								if (!IS_SYNCHRONIZED_SCENE_RUNNING(Local_2917[iParam0 /*10*/].f_7))
								{
									Local_2917[iParam0 /*10*/].f_7 = CREATE_SYNCHRONIZED_SCENE(1991.988f, 3054.51f, 46.215f, 0f, 0f, 50.76f, 2);
									TASK_SYNCHRONIZED_SCENE(Local_755[11 /*33*/], Local_2917[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_A_TaoCheng", 1000f, -4f, 257, 16, 1148846080, 0);
								...
								SET_PED_CONFIG_FLAG(Local_755[11 /*33*/], 118, 0);
								SET_PED_CONFIG_FLAG(Local_755[11 /*33*/], 208, 1);
								SET_PED_CONFIG_FLAG(Local_755[10 /*33*/], 118, 0);
								SET_PED_CONFIG_FLAG(Local_755[10 /*33*/], 208, 1);
								...
								if (!IS_PED_RAGDOLL(Local_755[11 /*33*/]))
								{
									if (IS_SYNCHRONIZED_SCENE_RUNNING(Local_2917[iParam0 /*10*/].f_7))
									{
										if (GET_SYNCHRONIZED_SCENE_PHASE(Local_2917[iParam0 /*10*/].f_7) == 1f)
										{
											...
											{
												TASK_SYNCHRONIZED_SCENE(Local_755[11 /*33*/], Local_2917[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_Base_TaoCheng", 1000f, -4f, 257, 16, 1148846080, 0);
												if (!IS_PED_INJURED(Local_755[10 /*33*/]))
												{
													if (!IS_PED_RAGDOLL(Local_755[10 /*33*/]))
													{
														if (!IS_BIT_SET(Local_2917[iParam0 /*10*/].f_8, 0))
														{
															TASK_SYNCHRONIZED_SCENE(Local_755[10 /*33*/], Local_2917[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_Base_taotranslator", 1000f, -4f, 257, 16, 1148846080, 0);
														}
													}
												}
											}
							...
							if (!IS_PED_INJURED(Local_755[10 /*33*/]))
							{
								if (((HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_755[10 /*33*/], PLAYER_PED_ID(), 1) || IS_PED_RAGDOLL(Local_755[10 /*33*/])) || IS_PED_INJURED(Local_755[11 /*33*/])) || (!IS_PED_INJURED(Local_755[10 /*33*/]) && GET_SCRIPT_TASK_STATUS(Local_755[10 /*33*/], 1785177548) == 2))
								{
									if (!IS_BIT_SET(Local_2917[iParam0 /*10*/].f_8, 0))
									{
										...
										func_93();
										TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 30f, 20000, 0, 0);
										TASK_COWER(0, -1);
										func_92(&(Local_755[10 /*33*/]), 0);
										SET_BIT(&(Local_2917[iParam0 /*10*/].f_8), 0);
									}
								}
							}
							if (!IS_PED_INJURED(Local_755[11 /*33*/]))
							{
								if (((HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_755[11 /*33*/], PLAYER_PED_ID(), 1) || IS_PED_RAGDOLL(Local_755[11 /*33*/])) || IS_BIT_SET(Local_2917[iParam0 /*10*/].f_8, 1)) || (!IS_PED_INJURED(Local_755[11 /*33*/]) && GET_SCRIPT_TASK_STATUS(Local_755[11 /*33*/], 1785177548) == 2))
								{
									SET_ENTITY_HEALTH(Local_755[11 /*33*/], 0, 0);
									if (!IS_PED_RAGDOLL(Local_755[11 /*33*/]))
									{
									}
								}
				...
				case 16:
					...
					if (!DOES_PICKUP_EXIST(uLocal_2675))
					{
						uLocal_2675 = CREATE_PICKUP(joaat("pickup_weapon_petrolcan"), 2436.775f, 4967.487f, 41.4f, iVar14, -1, 1, 0);
						ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(uLocal_2675, "V_8_BasementRm");
						uLocal_2677 = func_164(uLocal_2675);
						SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_2677, "FRMBLIP");
					}
					Local_2917[iParam0 /*10*/].f_3 = 1;
					break;
								...
								while (Local_2917[iParam0 /*10*/].f_7 < Local_755)
								{
									if (!IS_PED_INJURED(Local_755[Local_2917[iParam0 /*10*/].f_7 /*33*/]))
									{
										if (GET_INTERIOR_FROM_ENTITY(Local_755[Local_2917[iParam0 /*10*/].f_7 /*33*/]) == 0)
										{
											...
											SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[Local_2917[iParam0 /*10*/].f_7 /*33*/], uLocal_1617);
				...
				case 21:
					...
					while (Local_2917[iParam0 /*10*/].f_7 < Local_755)
					{
						if (!IS_PED_INJURED(Local_755[Local_2917[iParam0 /*10*/].f_7 /*33*/]))
						{
							if (IS_ENTITY_IN_ANGLED_AREA(Local_755[Local_2917[iParam0 /*10*/].f_7 /*33*/], 2457.885f, 4981.169f, 50.00518f, 2441.58f, 4965.088f, 56.24006f, 34.3125f, 0, 1, 0))
							{
				...
				case 45:
					if ((func_87(9) || (!IS_PED_INJURED(Local_755[8 /*33*/]) && IS_PED_IN_COMBAT(Local_755[8 /*33*/], 0))) || (!IS_PED_INJURED(Local_755[9 /*33*/]) && IS_PED_IN_COMBAT(Local_755[9 /*33*/], 0)))
					{
						...
						case 1:
							if (HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze"))
							{
								if (!IS_PED_INJURED(Local_755[23 /*33*/]))
								{
									...
									SET_SYNCHRONIZED_SCENE_LOOPED(Local_2917[iParam0 /*10*/].f_7, 1);
									TASK_SYNCHRONIZED_SCENE(Local_755[Local_2917[iParam0 /*10*/].f_7 /*33*/], Local_2917[iParam0 /*10*/].f_8, "misschinese2_crystalmaze", "_stand_to_aim", 1000f, -8f, 0, 0, 1148846080, 0);
									Local_2917[iParam0 /*10*/].f_6++;
								}
							}
							break;
				...
				case 30:
					switch (Local_2917[iParam0 /*10*/].f_6)
					{
						...
						case 1:
							...
							{
								uLocal_2508 = CREATE_VEHICLE(joaat("blazer"), 2478.587f, 4941.803f, 43.6736f, 227.2903f, 1, 1, 0);
								SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_2508, 1084227584);
								Local_2917[iParam0 /*10*/].f_3 = 1;
							}
							break;
					}
					...
					switch (Local_2917[iParam0 /*10*/].f_6)
					{
						...
						case 1:
							if (GET_IS_WAYPOINT_RECORDING_LOADED("arm2_30"))
							{
								if (func_87(29))
								{
									USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE("arm2_30", 1, 1065353216, 1056964608);
						...
						case 2:
							if (!func_87(29))
							{
								USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE("arm2_30", 0, 1065353216, 1056964608);
								Local_2917[iParam0 /*10*/].f_6 = 1;
							}
							break;
					}
				...
				case 34:
					if (!IS_PED_INJURED(PLAYER_PED_ID()))
					{
						if (GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()) == 0)
						{
							...
							{
								SET_RADAR_AS_INTERIOR_THIS_FRAME(0, 0, 0, 0, 0);
							}
						}
					}
					break;
				...
				case 36:
					...
					PLAY_SOUND_FROM_COORD(uLocal_2668, "FarmhouseFire_Ignite", vLocal_2669, "CHINESE2_SOUNDS", 0, 0, 0);
					Local_2917[iParam0 /*10*/].f_3 = 1;
					break;
				...
				case 38:
					...
					{
						case 0:
							REQUEST_SCRIPT_AUDIO_BANK("FARMHOUSE_FIRE", 0, -1);
							REQUEST_SCRIPT_AUDIO_BANK("FARMHOUSE_FIRE_BG", 0, -1);
							break;
					}
					break;
					...
					switch (Local_2917[iParam0 /*10*/].f_6)
					{
						...
						case 1:
							if (func_67(Local_755[Local_2917[iParam0 /*10*/].f_7 /*33*/], 2454.895f, 4950.895f, 44.1488f, 1) > 100f && func_4(Local_755[Local_2917[iParam0 /*10*/].f_7 /*33*/], PLAYER_PED_ID(), 1) > 100f)
							{
								...
								if (!IS_PED_INJURED(Local_755[iVar16 /*33*/]))
								{
									SET_PED_KEEP_TASK(Local_755[iVar16 /*33*/], 1);
									SET_PED_AS_NO_LONGER_NEEDED(&(Local_755[iVar16 /*33*/]));
								}
				...
				case 40:
					if (func_101(24, joaat("a_m_m_hillbilly_01"), 2433.123f, 4960.47f, 45.8218f, 301f, joaat("weapon_smg"), 1, 1))
					{
						...
						SET_ENTITY_HEALTH(Local_755[24 /*33*/], 200, 0);
						Local_2917[iParam0 /*10*/].f_3 = 1;
					}
					break;
			}
...
void func_161()
{
	...
	while (iVar0 < Local_444)
	{
		if (!func_162(Local_444[iVar0 /*5*/], 0f, 0f, 0f, 0))
		{
			...
			CLEAR_AREA(Local_444[iVar0 /*5*/], 2f, 1, 0, 0, 0);
			iVar1 = 0;
...
void func_170(int iParam0, int iParam1)
{
	...
	while (iVar3 < Local_3120)
	{
		switch (Local_3120[iVar3 /*8*/])
		{
			...
			case 12:
				Local_3120[iVar3 /*8*/].f_2 = 0;
				if (GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()) != 0 && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2421.331f, 4954.833f, 25.32829f, 2466.796f, 4996.822f, 66.07018f, 37.1875f, 0, 1, 0))
				{
					Local_3120[iVar3 /*8*/].f_2 = 1;
				}
				break;
			...
			case 13:
				...
				if (func_87(12))
				{
					if (!IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2457.885f, 4981.169f, 50.00518f, 2441.58f, 4965.088f, 56.24006f, 34.3125f, 0, 1, 0))
					{
						Local_3120[iVar3 /*8*/].f_2 = 1;
					}
				}
			...
			case 24:
				switch (Local_3120[iVar3 /*8*/].f_4)
				{
					...
					case 1:
						if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
						{
							uVar9 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
							if (IS_THIS_MODEL_A_HELI(GET_ENTITY_MODEL(uVar9)) || IS_THIS_MODEL_A_PLANE(GET_ENTITY_MODEL(uVar9)))
							{
				...
				switch (Local_3120[iVar3 /*8*/].f_4)
				{
					...
					case 1:
						if (IS_VEHICLE_DRIVEABLE(iLocal_2507, 0))
						{
							...
							{
								Local_3120[iVar3 /*8*/].f_6 = (Local_3120[iVar3 /*8*/].f_6 + FLOOR((TIMESTEP() * 1000f)));
							}
						}
			...
			case 30:
				switch (Local_3120[iVar3 /*8*/].f_4)
				{
					case 0:
						if (DOES_PICKUP_EXIST(uLocal_2675))
						{
							if (DOES_PICKUP_OBJECT_EXIST(uLocal_2675))
							{
								Local_3120[iVar3 /*8*/].f_4++;
							}
						}
			...
			case 17:
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2442.819f, 4970.283f, 45.2481f, 2439.625f, 4966.862f, 48.14596f, 3.4375f, 0, 1, 0))
				{
					Local_3120[iVar3 /*8*/].f_2 = 1;
				}
				break;
			...
			case 18:
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2434.671f, 4959.104f, 44.85109f, 2440.5f, 4965.189f, 48.1231f, 3.625f, 0, 1, 0))
				{
					Local_3120[iVar3 /*8*/].f_2 = 1;
				}
				break;
			...
			case 19:
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2432.467f, 4959.473f, 44.94133f, 2430.797f, 4961.173f, 48.30901f, 1.5625f, 0, 1, 0))
				{
					Local_3120[iVar3 /*8*/].f_2 = 1;
				}
				break;
			...
			case 32:
				Local_3120[iVar3 /*8*/].f_2 = 0;
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2447.671f, 4951.438f, 43.25576f, 2454.664f, 4957.856f, 47.89117f, 6.8125f, 0, 1, 0))
				{
					Local_3120[iVar3 /*8*/].f_2 = 1;
				}
				break;
...
void func_175()
{
	...
	if ((func_195() && iLocal_2512 > 0) && GET_GAME_TIMER() > iLocal_2641)
	{
		...
		SET_ENTITY_COORDS(PLAYER_PED_ID(), 2474.97f, 4946.047f, 44.0297f, 1, 0, 0, 1);
	...
	switch (iLocal_2512)
	{
		case 0:
			...
			CLEAR_AREA(2570.53f, 4982.057f, 50.6819f, 100f, 1, 0, 0, 0);
			...
			if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
				SET_ENTITY_COORDS(PLAYER_PED_ID(), 2455.941f, 4952.801f, 44.112f, 1, 0, 0, 1);
			}
			SET_TIME_SCALE(1f);
			REMOVE_ANIM_DICT("misschinese2_barrelRoll");
			REMOVE_ANIM_SET("move_m@gangster@var_e");
	...
	if (iLocal_2340)
	{
		...
		bLocal_2341 = false;
		iLocal_2673 = 0;
		CLEAR_AREA(2431.097f, 4967.043f, 41.3476f, 20f, 1, 0, 0, 0);
		func_184();
	}
	if (!bLocal_2341)
	{
	...
	if (bLocal_2341)
	{
		...
		if (iLocal_2454 == -1 || ((iLocal_2454 != -1 && iLocal_2454 < 4) && fLocal_2453 > (Local_2380[iLocal_2454 /*18*/].f_13 / 1000f)))
		{
			...
			if (iLocal_2454 == 3)
			{
				if (HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze"))
				{
					uLocal_2637 = CREATE_CAMERA(964613260, 1);
					uLocal_2638 = CREATE_SYNCHRONIZED_SCENE(2452.914f, 4962.096f, 45.585f, 0f, 0f, 45f, 2);
					PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_2637, uLocal_2638, "trevor_barn_walk_cam", "misschinese2_crystalmaze");
					if (!IS_PED_INJURED(PLAYER_PED_ID()))
					{
						TASK_SYNCHRONIZED_SCENE(PLAYER_PED_ID(), uLocal_2638, "misschinese2_crystalmaze", "trevor_barn_walk", 1000f, -8f, 0, 0, 1148846080, 0);
					}
			...
			{
				DESTROY_ALL_CAMS(0);
				uLocal_2637 = CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", Local_2380[iLocal_2454 /*18*/], Local_2380[iLocal_2454 /*18*/].f_3, Local_2380[iLocal_2454 /*18*/].f_14, 1, 2);
				SET_CAM_PARAMS(uLocal_2637, Local_2380[iLocal_2454 /*18*/].f_6, Local_2380[iLocal_2454 /*18*/].f_9, Local_2380[iLocal_2454 /*18*/].f_15, FLOOR(Local_2380[iLocal_2454 /*18*/].f_12), Local_2380[iLocal_2454 /*18*/].f_16, 1, 2);
				RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
				if (iLocal_2454 < 2)
				{
			...
			else if (!bLocal_2339)
			{
				...
				_SET_DES_OBJECT_STATE(uLocal_2672, 9);
				SET_TIME_SCALE(1f);
				END_SRL();
				if (IS_SCREEN_FADED_OUT())
				{
					while (_GET_DES_OBJECT_STATE(uLocal_2672) != 10)
					{
						func_28(29, 1);
					}
					DO_SCREEN_FADE_IN(1000);
			...
			if (!Local_2343[iVar3 /*6*/])
			{
				if (iLocal_2454 == Local_2343[iVar3 /*6*/].f_1 && fLocal_2453 > (Local_2343[iVar3 /*6*/].f_2 / 1000f))
				{
					switch (iVar3)
					{
						...
						case 1:
							ADD_EXPLOSION(2432.534f, 4968.383f, 42.2389f, 4, 1056964608, 1, 0, 1065353216, 0);
							Local_2343[iVar3 /*6*/] = 1;
							break;
						...
						case 3:
							if (DOES_CAM_EXIST(uLocal_2637))
							{
								SHAKE_CAM(uLocal_2637, "LARGE_EXPLOSION_SHAKE", fLocal_2639);
								SET_CAM_MOTION_BLUR_STRENGTH(uLocal_2637, 0.1f);
								Local_2343[iVar3 /*6*/] = 1;
							}
							break;
						...
						case 4:
							...
							{
								case 0:
									SET_ENTITY_COORDS(PLAYER_PED_ID(), 2473.208f, 4947.625f, 44.0664f, 1, 0, 0, 1);
									SET_ENTITY_HEADING(PLAYER_PED_ID(), 223.493f);
									SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
									SET_GAMEPLAY_CAM_RELATIVE_PITCH(-7f, 1065353216);
									if (func_182())
									{
										FORCE_PED_MOTION_STATE(PLAYER_PED_ID(), 1063765679, 1, 0, 0);
...
void func_185(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
...
void func_186(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_191(PLAYER_ID())) && !func_188(PLAYER_ID(), 0)) && !func_187()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_191(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
	...
	switch (iLocal_2512)
	{
		case 0:
			if (IS_SRL_LOADED())
			{
				...
				if (((IS_VEHICLE_DRIVEABLE(uVar4, 0) && IS_THIS_MODEL_A_HELI(GET_ENTITY_MODEL(uVar4))) && IS_ENTITY_IN_AIR(uVar4)) || ((IS_VEHICLE_DRIVEABLE(uVar4, 0) && IS_THIS_MODEL_A_PLANE(GET_ENTITY_MODEL(uVar4))) && IS_ENTITY_IN_AIR(uVar4)))
				{
				...
				else
				{
					if (DOES_ENTITY_EXIST(uVar4))
					{
						if (IS_VEHICLE_DRIVEABLE(uVar4, 0))
						{
							if (!(IS_THIS_MODEL_A_HELI(GET_ENTITY_MODEL(uVar4)) && IS_ENTITY_IN_AIR(uVar4)) && !(IS_THIS_MODEL_A_PLANE(GET_ENTITY_MODEL(uVar4)) && IS_ENTITY_IN_AIR(uVar4)))
							{
								SET_VEHICLE_ON_GROUND_PROPERLY(uVar4, 1084227584);
							}
						}
					}
				...
				if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
					uLocal_260 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
					vLocal_752 = { GET_ENTITY_VELOCITY(uLocal_260) };
					FREEZE_ENTITY_POSITION(uLocal_260, 1);
					SET_ENTITY_VISIBLE(uLocal_260, 0, 0);
				}
				PLAY_STREAM_FRONTEND();
				if (iLocal_2512 == 1)
				{
					...
					if (DOES_ENTITY_EXIST(uVar4))
					{
						if (IS_VEHICLE_DRIVEABLE(uVar4, 0))
						{
							SET_VEHICLE_ENGINE_ON(uVar4, 0, 1, 0);
						}
					}
					CLEAR_AREA(2445.139f, 4978.642f, 52.1489f, 150f, 1, 1, 0, 0);
					CLEAR_AREA(2578.523f, 4982.284f, 51.4416f, 13f, 1, 0, 0, 0);
					SET_ENTITY_COORDS(PLAYER_PED_ID(), 2578.419f, 4981.901f, 50.587f, 1, 0, 0, 1);
					...
					TASK_PERFORM_SEQUENCE(PLAYER_PED_ID(), uVar5);
					CLEAR_SEQUENCE_TASK(&uVar5);
					uLocal_2637 = CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
					ADD_CAM_SPLINE_NODE(uLocal_2637, 2538.6f, 4976.9f, 50.6f, -1.8f, 0f, 93.2f, 5000, 3, 2);
					ADD_CAM_SPLINE_NODE(uLocal_2637, 2536.153f, 4976.7f, 50.5267f, -1.8f, 0f, 93.2f, 6000, 3, 2);
					SET_CAM_FOV(uLocal_2637, 34.9f);
					_0xD1B0F412F109EA5D(uLocal_2637, 0);
				}
				else
				{
					switch (iLocal_2512)
					{
						case 2:
							uLocal_2637 = CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
							ADD_CAM_SPLINE_NODE(uLocal_2637, 2426.8f, 5088.3f, 51.2f, 0f, 0f, -169f, 5000, 3, 2);
							ADD_CAM_SPLINE_NODE(uLocal_2637, 2427.8f, 5087.2f, 51.2f, 0f, 0f, -169.7f, 6000, 3, 2);
							SET_CAM_FOV(uLocal_2637, 28.5f);
							_0xD1B0F412F109EA5D(uLocal_2637, 0);
							break;
						
						case 3:
							uLocal_2637 = CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
							ADD_CAM_SPLINE_NODE(uLocal_2637, 2326.3f, 4985.6f, 51.5f, 0f, 0f, -89.1f, 5000, 3, 2);
							ADD_CAM_SPLINE_NODE(uLocal_2637, 2328f, 4985.4f, 52.1f, 0f, 0f, -89.1f, 6000, 3, 2);
							SET_CAM_FOV(uLocal_2637, 28.5f);
							_0xD1B0F412F109EA5D(uLocal_2637, 0);
							break;
						...
						case 4:
							uLocal_2637 = CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
							ADD_CAM_SPLINE_NODE(uLocal_2637, 2403.6f, 4889.7f, 47.5f, 3.4f, 0f, -19.5f, 5000, 3, 2);
							ADD_CAM_SPLINE_NODE(uLocal_2637, Vector(47.5f, 4889.7f, 2403.6f) + Vector(0.07f, 2.15f, 0.8f), 3.4f, 0f, -19.5f, 6000, 3, 2);
							SET_CAM_FOV(uLocal_2637, 29.8f);
							_0xD1B0F412F109EA5D(uLocal_2637, 0);
							break;
						
						case 5:
							uLocal_2637 = CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
							ADD_CAM_SPLINE_NODE(uLocal_2637, 2493.4f, 4934.8f, 45.7f, 5.2f, 0f, 48f, 5000, 3, 2);
							ADD_CAM_SPLINE_NODE(uLocal_2637, Vector(45.7f, 4934.8f, 2493.4f) + Vector(0f, 1f, -1f), 5.2f, 0f, 48f, 6000, 3, 2);
							SET_CAM_FOV(uLocal_2637, 28.5f);
							_0xD1B0F412F109EA5D(uLocal_2637, 0);
							break;
						...
						case 6:
							uLocal_2637 = CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
							ADD_CAM_SPLINE_NODE(uLocal_2637, 2570.6f, 4982f, 151.6f, -47.9f, 0f, 88.1f, 5000, 3, 2);
							ADD_CAM_SPLINE_NODE(uLocal_2637, 2487.8f, 4896.9f, 151.9f, -47.2f, 0f, 28.8f, 15000, 3, 2);
							SET_CAM_FOV(uLocal_2637, 28.5f);
							_0xD1B0F412F109EA5D(uLocal_2637, 0);
							break;
						...
						case 7:
							uLocal_2637 = CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
							ADD_CAM_SPLINE_NODE(uLocal_2637, 2487.8f, 4896.9f, 151.9f, -47.2f, 0f, 28.8f, 5000, 3, 2);
							ADD_CAM_SPLINE_NODE(uLocal_2637, 2570.6f, 4982f, 151.6f, -47.9f, 0f, 88.1f, 15000, 3, 2);
							SET_CAM_FOV(uLocal_2637, 28.5f);
							_0xD1B0F412F109EA5D(uLocal_2637, 0);
							break;
						}
				...
				if (iLocal_2512 < 6)
				{
					SHAKE_CAM(uLocal_2637, "Hand_shake", 0.2f);
				}
				else
				{
					SHAKE_CAM(uLocal_2637, "Hand_shake", 0.7f);
				}
				SET_CAM_ACTIVE(uLocal_2637, 1);
				RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
				_0x48621C9FCA3EBD28(4);
				...
				uLocal_2642 = CREATE_PED(26, joaat("a_m_y_methhead_01"), 2460.449f, 4976.938f, 45.5765f, 243.4917f, 1, 1);
				GIVE_WEAPON_TO_PED(uLocal_2642, joaat("weapon_microsmg"), -1, 1, 1);
				if (!IS_PED_INJURED(uLocal_2642))
				{
					func_93();
					TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
					...
					func_92(&uLocal_2642, 1);
				}
				iLocal_2509 = CREATE_VEHICLE(joaat("dubsta"), 2479.961f, 4990f, 45.8f, -5.37f, 1, 1, 0);
		...
		case 3:
			if (TIMERA() > iLocal_2640)
			{
				DESTROY_ALL_CAMS(0);
				uLocal_2637 = CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
				ADD_CAM_SPLINE_NODE(uLocal_2637, 2445.944f, 4962.986f, 51.4782f, 7.9159f, 0f, 34.5909f, 5000, 3, 2);
				ADD_CAM_SPLINE_NODE(uLocal_2637, 2445.684f, 4963.368f, 51.6659f, 3.6033f, 0f, 34.5909f, 3500, 3, 2);
				SET_CAM_FOV(uLocal_2637, 34f);
				_0xD1B0F412F109EA5D(uLocal_2637, 0);
				SHAKE_CAM(uLocal_2637, "Hand_shake", 0.5f);
				iLocal_2640 += 3500;
				iLocal_2512++;
			}
			break;
		...
		case 4:
			if (TIMERA() > iLocal_2640)
			{
				DESTROY_ALL_CAMS(0);
				uLocal_2637 = CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
				ADD_CAM_SPLINE_NODE(uLocal_2637, 2465.07f, 4946.688f, 45.3372f, 7.1461f, 0f, 30.9281f, 5000, 3, 2);
				ADD_CAM_SPLINE_NODE(uLocal_2637, 2466.011f, 4947.377f, 45.3509f, 7.1461f, 0f, 32.3761f, 3000, 3, 2);
				SET_CAM_FOV(uLocal_2637, 34f);
				_0xD1B0F412F109EA5D(uLocal_2637, 0);
				SHAKE_CAM(uLocal_2637, "Hand_shake", 0.5f);
				iLocal_2640 += 3000;
		...
		case 5:
			...
			if (TIMERA() > iLocal_2640)
			{
				...
				DESTROY_ALL_CAMS(0);
				uLocal_2637 = CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
				ADD_CAM_SPLINE_NODE(uLocal_2637, 2509.691f, 4971.024f, 44.1325f, 7.2578f, 0f, 88.5226f, 5000, 3, 2);
				ADD_CAM_SPLINE_NODE(uLocal_2637, 2509.415f, 4971.163f, 44.1674f, 6.6554f, 0f, 89.4229f, 2500, 3, 2);
				SET_CAM_FOV(uLocal_2637, 37.34f);
				_0xD1B0F412F109EA5D(uLocal_2637, 0);
				SHAKE_CAM(uLocal_2637, "Hand_shake", 0.5f);
				iLocal_2640 += 2500;
				iLocal_2512++;
		...
		case 10:
			if (DOES_ENTITY_EXIST(uLocal_260) && IS_VEHICLE_DRIVEABLE(uLocal_260, 0))
			{
				REQUEST_VEHICLE_HIGH_DETAIL_MODEL(uLocal_260);
			}
		...
		case 11:
			...
			if ((IS_SCREEN_FADED_OUT() && !IS_CUTSCENE_PLAYING()) || (IS_CUTSCENE_ACTIVE() && CAN_SET_EXIT_STATE_FOR_CAMERA(1)))
			{
				...
				{
					SET_ENTITY_COORDS(PLAYER_PED_ID(), 2570.543f, 4982.002f, 50.6795f, 1, 0, 0, 1);
				...
				func_186(0, 1, 1, 0, 0, 0);
				if (DOES_ENTITY_EXIST(uLocal_2642))
				{
					DELETE_PED(&uLocal_2642);
				}
				iLocal_2885 = func_18(4);
				if (iLocal_2885 != -1)
				{
				...
				func_31(20, 0);
				if (!IS_PED_INJURED(uLocal_2643))
				{
					DELETE_PED(&uLocal_2643);
				}
				if (!IS_PED_INJURED(uLocal_2644))
				{
					DELETE_PED(&uLocal_2644);
				}
				if (func_68(iLocal_2509))
				{
					DELETE_VEHICLE(&iLocal_2509);
				}
				if (DOES_ENTITY_EXIST(uLocal_2682))
				{
					DELETE_OBJECT(&uLocal_2682);
				}
				func_202();
				iLocal_751 = 0;
				func_27();
				...
				SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
				SET_GAMEPLAY_CAM_RELATIVE_PITCH(-6.3f, 1065353216);
				if (DOES_ENTITY_EXIST(uLocal_260))
				{
					if (IS_VEHICLE_DRIVEABLE(uLocal_260, 0))
					{
						FREEZE_ENTITY_POSITION(uLocal_260, 0);
						if (IS_THIS_MODEL_A_PLANE(GET_ENTITY_MODEL(uLocal_260)))
						{
							SET_ENTITY_VELOCITY(uLocal_260, vLocal_752);
							SET_PED_INTO_VEHICLE(PLAYER_PED_ID(), uLocal_260, -1);
						}
						SET_VEHICLE_ENGINE_ON(uLocal_260, 1, 1, 0);
						if (IS_THIS_MODEL_A_HELI(GET_ENTITY_MODEL(uLocal_260)))
						{
							SET_ENTITY_ROTATION(uLocal_260, 0f, 0f, GET_ENTITY_HEADING(uLocal_260), 2, 1);
							SET_HELI_BLADES_FULL_SPEED(uLocal_260);
							SET_ENTITY_VELOCITY(uLocal_260, 1f, 1f, 1f);
							SET_PED_INTO_VEHICLE(PLAYER_PED_ID(), uLocal_260, -1);
						}
						if (iLocal_2883 == 0)
						{
						...
						SET_ENTITY_VISIBLE(uLocal_260, 1, 0);
					}
				}
...
void func_203(var uParam0, var uParam1, char* sParam2, float fParam3, vector3 vParam4, float fParam7, int iParam8)
{
	int iVar0;
...
void func_211(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 3)
	{
		if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
		{
			...
			if (bParam1)
			{
				if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_212()) && uParam0->f_17[iVar0] != PLAYER_PED_ID())
				{
...
void func_217()
{
	...
	func_197(3, 0, 0, 1, 0);
	if ((func_67(PLAYER_PED_ID(), 2458.223f, 4986.042f, 49.05241f, 0) < 107.9f || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2374.441f, 4930.564f, 34.73784f, 2478.099f, 5077.488f, 60.63246f, 185f, 0, 0, 0)) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 2396.726f, 4887.434f, 33.85329f, 2510.54f, 5003.356f, 58.01184f, 158.25f, 0, 0, 0))
	{
		if (DOES_BLIP_EXIST(Local_2683.f_5))
		{
			SET_BLIP_ROUTE(Local_2683.f_6, 0);
		}
		func_176(11);
	}
	else
		...
		switch (iLocal_2512)
		{
			...
			case 2:
				if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
					...
					if (func_219(uVar0, 10f, 2, 1056964608, 0, 1, 0))
					{
						if (func_218(5) > 2)
						{
							iLocal_2512++;
...
int func_219(var uParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
bool func_221(var uParam0, vector3 vParam1, vector3 vParam4, int iParam7, char* sParam8, bool bParam9, bool bParam10, int iParam11)
{
	return func_222(uParam0, vParam1, vParam4, func_260(), func_260(), iParam7, 1, 0, 0, 0, 0, sParam8, func_167(), func_167(), func_167(), func_167(), func_167(), 0, bParam9, func_167(), 0, 0, bParam10, iParam11, 0, 0, 0, 1, 1065353216);
}

int func_222(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, char* sParam19, char* sParam20, char* sParam21, char* sParam22, char* sParam23, char* sParam24, bool bParam25, bool bParam26, char* sParam27, bool bParam28, int iParam29, bool bParam30, int iParam31, int iParam32, int iParam33, int iParam34, bool bParam35, int iParam36)
{
	var uVar0;
	bool bVar1;
	int iVar2;
	...
	func_258(uParam0);
	func_257();
	if (func_241(uParam0, uParam0->f_17[0], uParam0->f_17[1], uParam0->f_17[2], sParam20, sParam21, sParam22, sParam23, uParam0->f_8, bParam25, iParam18, 0, 0, iParam32, iParam33, iParam34, iParam14, bParam26))
	{
		func_240(sParam20);
		func_240(sParam21);
		func_240(sParam22);
		...
		if (IS_SCREEN_FADED_IN())
		{
			...
			if (bVar1)
			{
				...
				if (bParam26 && IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0))
				{
					...
					if ((!func_235(uParam0, 1) && !func_234(uParam0)) && !IS_BIT_SET(uParam0->f_13, 0))
					{
						if (bParam30)
						{
							func_233(uParam0, "LOSE_WANTED", 0);
							if (!IS_PED_INJURED(uParam0->f_17[0]))
							{
								func_231(uParam0->f_17[0], "VEHICLE_POLICE_PURSUIT", 3);
							}
						}
				...
				else
				{
					...
					if (IS_BIT_SET(uParam0->f_13, 1))
					{
						if (!func_235(uParam0, 1))
						{
							if (!IS_PED_INJURED(uParam0->f_17[0]))
							{
								func_231(uParam0->f_17[0], "LOSE_WANTED_LEVEL", 3);
							}
							CLEAR_BIT(&(uParam0->f_13), 1);
						}
					}
					if (!DOES_BLIP_EXIST(uParam0->f_5))
					{
						...
						if (bParam35)
						{
							func_230(uParam0->f_5, uParam0);
						}
					}
					else if (!func_229(vVar3, GET_BLIP_COORDS(uParam0->f_5), 0.1f, 0))
					{
					...
					if (bVar1)
					{
						...
						while (iVar2 < 3)
						{
							if (!IS_PED_INJURED(uParam0->f_17[iVar2]))
							{
								...
								else if (!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar2], func_212()) || !func_227(uParam0->f_17[iVar2], 1))
								{
									bVar1 = false;
								}
							}
						...
						if (!func_235(uParam0, 2))
						{
							...
							else if (IS_BIT_SET(uParam0->f_13, 9))
							{
								...
								if (!IS_BIT_SET(uParam0->f_13, 23))
								{
									if (!IS_PED_INJURED(uParam0->f_17[0]))
									{
										func_231(uParam0->f_17[0], "GET_IN_CAR", 3);
									}
						...
						if (!func_235(uParam0, 2))
						{
							if (IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()))
							{
								if (!IS_BIT_SET(uParam0->f_13, 13))
								{
									...
									{
										func_231(uParam0->f_17[iVar9], "NEED_A_BIGGER_VEHICLE", 3);
									}
...
int func_224(var uParam0)
{
	...
	{
		if (func_226(PLAYER_PED_ID()))
		{
			if (func_225(1, 0, 1) || IS_BIT_SET(uParam0->f_13, 7))
			{
				return 1;
			}
		}
	}
	else if (func_225(1, 0, 1) || IS_BIT_SET(uParam0->f_13, 7))
	{
		return 1;
	}
	return 0;
...
int func_227(var uParam0, int iParam1)
{
	if (!IS_PED_INJURED(uParam0))
	{
		...
		{
			if (func_228(PLAYER_PED_ID(), uParam0))
			{
				SET_GROUP_SEPARATION_RANGE(func_212(), 50f);
				return 1;
			}
		}
		else if (IS_PED_GROUP_MEMBER(uParam0, func_212()))
		{
			SET_GROUP_SEPARATION_RANGE(func_212(), 50f);
			return 1;
		}
...
{
	_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_232(iParam2), 1);
}
...
void func_233(var uParam0, char* sParam1, bool bParam2)
{
	if (!bParam2)
	{
...
int func_238(var uParam0, int iParam1)
{
	...
	{
		uVar0 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
		if (func_239(uVar0, uParam0, iParam1))
		{
			return 1;
		}
	}
...
int func_241(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, var uParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17)
{
	int iVar0;
	int iVar1;
	int iVar2;
						...
						if (func_239(uParam0->f_21, uParam0, iVar3))
						{
							...
							while (iVar0 < 3)
							{
								if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
								{
									...
									if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_212()))
									{
										REMOVE_PED_FROM_GROUP(uParam0->f_17[iVar0]);
									}
									if (GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], -1794415470) == 7 && !func_256(uParam0->f_17[iVar0], uParam0->f_21))
									{
		...
		if (bVar23)
		{
			...
			while (iVar0 < 3)
			{
				if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
				{
					...
					if (!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_212()))
					{
						if (func_254(uParam0, uParam0->f_17[iVar0], uParam8, 1))
						{
							SET_PED_AS_GROUP_MEMBER(uParam0->f_17[iVar0], func_212());
						}
					}
				}
				iVar0++;
	...
	if (!IS_BIT_SET(uParam0->f_13, 26))
	{
		if ((!func_253(uParam0) && IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID())) && !DOES_ENTITY_EXIST(iParam10))
		{
		...
		if (!DOES_ENTITY_EXIST(iParam10))
		{
			if ((!IS_PED_INJURED(uParam0->f_17[0]) || !IS_PED_INJURED(uParam0->f_17[1])) || !IS_PED_INJURED(uParam0->f_17[2]))
			{
				...
				{
					if (IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()) && !func_235(uParam0, 2))
					{
						iVar13 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
				...
				if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
				{
					...
					if (IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()))
					{
						...
						if (IS_VEHICLE_DRIVEABLE(iVar13, 0))
						{
							if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_212()))
							{
								if (!func_253(uParam0) && IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()))
								{
					...
					if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_212()))
					{
						...
						{
							if (func_239(uVar32, uParam0, 0))
							{
								if (func_250(iVar0, uParam0) || !IS_BIT_SET(uParam0->f_13, 27))
								{
									SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uParam0->f_17[iVar0], iVar0);
									func_213(iVar0, uParam0);
									iVar4++;
					...
					if ((!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_212()) && !func_248(uParam0->f_17[iVar0], iParam10)) && !func_247(uParam0->f_17[iVar0], iParam10))
					{
						if (func_254(uParam0, uParam0->f_17[iVar0], uParam8, bParam11))
						{
							if (!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_212()))
							{
					...
					{
						if (((func_227(uParam0->f_17[iVar0], 1) || func_248(uParam0->f_17[iVar0], iParam10)) || iParam12) || (IS_VEHICLE_DRIVEABLE(iParam10, 0) && !IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iParam10, 0)))
						{
							if (DOES_BLIP_EXIST(uParam0->f_1[iVar0]))
							{
								REMOVE_BLIP(&(uParam0->f_1[iVar0]));
					...
					else if (IS_VEHICLE_DRIVEABLE(iParam10, 0))
					{
						if (!IS_PED_SITTING_IN_VEHICLE(uParam0->f_17[iVar0], iParam10))
						{
							if ((IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], iParam10, 20f, 20f, 5f, 0, 1, 0) && !IS_BIT_SET(uParam0->f_13, 11)) && !((bParam17 && IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) && !IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iParam10, 0)))
							{
								...
								else
								{
									...
									{
										if (((((!IS_PED_JUMPING_OUT_OF_VEHICLE(uParam0->f_17[iVar0]) && !IS_PED_JUMPING_OUT_OF_VEHICLE(PLAYER_PED_ID())) && !func_246(uParam0->f_17[iVar0], 2f)) && !IS_PED_RAGDOLL(uParam0->f_17[iVar0])) && !IS_PED_GETTING_UP(uParam0->f_17[iVar0])) && !IS_ENTITY_ON_FIRE(iParam10))
										{
											SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_17[iVar0], 1);
							...
							else if (!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_212()))
							{
								if (func_254(uParam0, uParam0->f_17[iVar0], uParam8, bParam11))
								{
									if (!IS_PED_RAGDOLL(uParam0->f_17[iVar0]) && !IS_PED_GETTING_UP(uParam0->f_17[iVar0]))
						...
						else if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_212()) && !IS_ENTITY_ON_FIRE(iParam10))
						{
							REMOVE_PED_FROM_GROUP(uParam0->f_17[iVar0]);
						}
					}
			...
			if (iVar1 > 0)
			{
				...
				while (iVar0 < 3)
				{
					if (iVar7[iVar0])
					{
						if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
						{
							if (func_251(uParam0->f_17[iVar0]) || IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], PLAYER_PED_ID(), uParam0->f_8, uParam0->f_8, uParam0->f_8, 0, 1, 0))
							{
								iVar1 = (iVar1 - 1);
								iVar7[iVar0] = 0;
							}
					...
					{
						if (!IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], PLAYER_PED_ID(), (uParam0->f_8 * 0.85f), (uParam0->f_8 * 0.85f), uParam0->f_8, 0, 1, 0) && !func_251(uParam0->f_17[iVar0]))
						{
						}
					}
					iVar0++;
...
void func_243(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	if (!bParam3)
	{
		if (!IS_STRING_NULL(uParam1))
		{
			...
			{
				func_244(uParam1, uParam2, 7500, 1);
			}
		}
	}
	uParam0->f_10 = GET_GAME_TIMER();
...
void func_244(var uParam0, var uParam1, int iParam2, int iParam3)
{
	iParam3 = iParam3;
...
int func_247(var uParam0, int iParam1)
{
	...
	if (!IS_PED_INJURED(uParam0))
	{
		if (!IS_PED_GROUP_MEMBER(uParam0, func_212()))
		{
	...
	switch (iLocal_2512)
	{
		case 0:
			...
			if (func_204())
			{
				...
				if (DOES_ENTITY_EXIST(Global_90209.f_9[0]))
				{
					...
					SET_ENTITY_AS_MISSION_ENTITY(Local_755[14 /*33*/], 1, 1);
					SET_ENTITY_AS_MISSION_ENTITY(Local_755[13 /*33*/], 1, 1);
					SET_ENTITY_AS_MISSION_ENTITY(Local_755[11 /*33*/], 1, 1);
					SET_ENTITY_AS_MISSION_ENTITY(Local_755[10 /*33*/], 1, 1);
					SET_ENTITY_AS_MISSION_ENTITY(Local_755[12 /*33*/], 1, 1);
					if (!IS_PED_INJURED(Local_755[13 /*33*/]))
					{
		...
		case 2:
			...
			if (!DOES_ENTITY_EXIST(Local_755[13 /*33*/]))
			{
				...
				{
					Local_755[13 /*33*/] = GET_PED_INDEX_FROM_ENTITY_INDEX(GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Old_Man1A", 0));
				}
			}
			if (!DOES_ENTITY_EXIST(Local_755[14 /*33*/]))
			{
				...
				{
					Local_755[14 /*33*/] = GET_PED_INDEX_FROM_ENTITY_INDEX(GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Old_Man2", 0));
				}
			}
			if (!DOES_ENTITY_EXIST(Local_755[11 /*33*/]))
			{
				...
				{
					Local_755[11 /*33*/] = GET_PED_INDEX_FROM_ENTITY_INDEX(GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("tao", 0));
				}
			}
			if (!DOES_ENTITY_EXIST(Local_755[10 /*33*/]))
			{
				...
				{
					Local_755[10 /*33*/] = GET_PED_INDEX_FROM_ENTITY_INDEX(GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Taos_Translator", 0));
				}
			}
			if (!DOES_ENTITY_EXIST(Local_755[12 /*33*/]))
			{
				...
				{
					Local_755[12 /*33*/] = GET_PED_INDEX_FROM_ENTITY_INDEX(GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Janet", 0));
				}
			}
			if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("tao", 0))
			{
				if (!IS_PED_INJURED(Local_755[11 /*33*/]))
				{
					SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[11 /*33*/], uLocal_1618);
					SET_PED_CAN_BE_TARGETTED(Local_755[11 /*33*/], 0);
					uVar0 = CREATE_SYNCHRONIZED_SCENE(1991.988f, 3054.51f, 46.215f, 0f, 0f, 50.76f, 2);
					TASK_SYNCHRONIZED_SCENE(Local_755[11 /*33*/], uVar0, "misschinese2_crystalmaze", "2int_Loop_A_TaoCheng", 1000f, -4f, 1, 16, 1148846080, 0);
				}
			}
			if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Taos_Translator", 0))
			{
				if (!IS_PED_INJURED(Local_755[10 /*33*/]))
				{
					SET_PED_RELATIONSHIP_GROUP_HASH(Local_755[10 /*33*/], uLocal_1618);
					SET_PED_CAN_BE_TARGETTED(Local_755[10 /*33*/], 0);
					uVar1 = CREATE_SYNCHRONIZED_SCENE(1991.988f, 3054.51f, 46.215f, 0f, 0f, 50.76f, 2);
					TASK_SYNCHRONIZED_SCENE(Local_755[10 /*33*/], uVar1, "misschinese2_crystalmaze", "2int_Loop_A_taotranslator", 1000f, -4f, 1, 16, 1148846080, 0);
				}
			}
			if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Trevor", 0))
			{
				...
				{
					SET_ENTITY_COORDS(PLAYER_PED_ID(), 1992.135f, 3057.467f, 46.06f, 1, 0, 0, 1);
				...
				{
					SET_ENTITY_COORDS(PLAYER_PED_ID(), 1992.919f, 3057.906f, 46.0567f, 1, 0, 0, 1);
...
void func_264()
{
	...
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
	{
		...
		SET_PED_CONFIG_FLAG(PLAYER_PED_ID(), 157, 1);
		SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
	}
	iVar0 = 0;
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_91081[iVar0]))
		{
			if (!IS_ENTITY_DEAD(Global_91081[iVar0], 0))
			{
				SET_ENTITY_PROOFS(Global_91081[iVar0], 0, 0, 0, 0, 0, 0, 0, 0);
				SET_ENTITY_INVINCIBLE(Global_91081[iVar0], 0);
			}
		}
		iVar0++;
	}
...
void func_265()
{
	...
	switch (iLocal_2512)
	{
		case 0:
			...
			func_32(6, 1);
			func_32(25, 1);
			iLocal_2506 = GET_LAST_DRIVEN_VEHICLE();
			SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("bodhi2"), 1);
			ADD_RELATIONSHIP_GROUP("TAOGROUP", &uLocal_1618);
			SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_1618, 1862763509);
			SET_RELATIONSHIP_BETWEEN_GROUPS(1, 1862763509, uLocal_1618);
			func_17(0, -1);
			SET_SCENARIO_GROUP_ENABLED("Chinese2_Lunch", 0);
			SET_SCENARIO_GROUP_ENABLED("CHINESE2_HILLBILLIES", 0);
			if (func_359())
			{
				iVar0 = func_358();
				if (Global_87889 == 1)
...
void func_266(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			SET_ENTITY_COORDS(PLAYER_PED_ID(), 1992.878f, 3057.846f, 46.0568f, 1, 0, 0, 1);
		...
		case 2:
			...
			else
			{
				if (func_68(iLocal_2506))
				{
					SET_ENTITY_COORDS(iLocal_2506, 1994.387f, 3061.94f, 46.0491f, 1, 0, 0, 1);
			...
			ADD_SCENARIO_BLOCKING_AREA(Vector(50.27741f, 3054.884f, 1991.22f) - Vector(40f, 40f, 40f), Vector(50.27741f, 3054.884f, 1991.22f) + Vector(40f, 40f, 40f), 0, 1, 1, 1);
			SET_PED_NON_CREATION_AREA(Vector(50.27741f, 3054.884f, 1991.22f) - Vector(40f, 40f, 40f), Vector(50.27741f, 3054.884f, 1991.22f) + Vector(0f, 40f, 40f));
			CLEAR_AREA(1984.997f, 3052.905f, 46.8556f, 10f, 1, 0, 0, 0);
		...
		case 3:
			...
			{
				SET_ENTITY_COORDS(PLAYER_PED_ID(), 2570.543f, 4982.002f, 50.6795f, 0, 1, 0, 1);
				SET_ENTITY_HEADING(PLAYER_PED_ID(), 98.21f);
				SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
				SET_GAMEPLAY_CAM_RELATIVE_PITCH(-7f, 1065353216);
		...
		case 4:
			...
			if (iVar0 != 0 && iVar0 != joaat("weapon_unarmed"))
			{
				...
				{
					SET_CURRENT_PED_WEAPON(PLAYER_PED_ID(), iVar0, 1);
				}
			}
			func_15("CHN2_MISSION_START", 1, "CHN2_EXPLODE");
			while (!func_2())
			...
			if (bParam1)
			{
				if ((DOES_ENTITY_EXIST(iLocal_2506) && IS_VEHICLE_DRIVEABLE(iLocal_2506, 0)) && func_271())
				{
					func_275(iLocal_2506, -1, 1);
					if (IS_VEHICLE_DRIVEABLE(iLocal_2506, 0))
					{
						SET_VEHICLE_ENGINE_ON(iLocal_2506, 1, 1, 0);
			...
			if (GET_DISTANCE_BETWEEN_COORDS(func_274(), 2570.538f, 4982.031f, 50.6239f, 1) < 10f)
			{
				SET_ENTITY_COORDS(PLAYER_PED_ID(), 2570.538f, 4982.031f, 50.6239f, 1, 0, 0, 1);
				SET_ENTITY_HEADING(PLAYER_PED_ID(), 98f);
			}
			if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
				func_269(PLAYER_PED_ID(), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1));
			}
			break;
		...
		case 5:
			SET_VEHICLE_POPULATION_BUDGET(1);
			SET_PED_POPULATION_BUDGET(1);
			SET_ENTITY_COORDS(PLAYER_PED_ID(), 2572.01f, 4981.678f, 50.6698f, 1, 0, 0, 1);
		...
		case 6:
			...
			{
				SET_ENTITY_COORDS(PLAYER_PED_ID(), 2450.871f, 4960.999f, 44.3759f, 0, 1, 0, 1);
		...
		case 7:
			...
			{
				SET_ENTITY_COORDS(PLAYER_PED_ID(), 2435.319f, 4966.153f, 41.3476f, 1, 0, 0, 1);
			...
			func_267(0, 7, 1);
			GIVE_WEAPON_TO_PED(PLAYER_PED_ID(), joaat("weapon_petrolcan"), 4500, 1, 1);
			func_163(0);
		...
		case 8:
			...
			{
				SET_ENTITY_COORDS(PLAYER_PED_ID(), 2453.124f, 4952.071f, 45.125f, 1, 0, 0, 1);
		...
		case 9:
			...
			{
				SET_ENTITY_COORDS(PLAYER_PED_ID(), 2472.3f, 4948.181f, 44.0937f, 1, 0, 0, 1);
			...
			SET_PED_POPULATION_BUDGET(3);
			REQUEST_MODEL(joaat("blazer"));
			while ((!HAS_MODEL_LOADED(joaat("blazer")) || !REQUEST_SCRIPT_AUDIO_BANK("FARMHOUSE_FIRE", 0, -1)) || !REQUEST_SCRIPT_AUDIO_BANK("FARMHOUSE_FIRE_BG", 0, -1))
			{
				func_28(25, 1);
			}
			uLocal_2508 = CREATE_VEHICLE(joaat("blazer"), 2478.587f, 4941.803f, 43.6736f, 227.2903f, 1, 1, 0);
			...
			func_19(55, 1, 0, 1, 0);
			uLocal_2672 = _GET_DES_OBJECT(2457.15f, 4968.79f, 48.677f, 45f, "DES_FarmHs");
			while (!_DOES_DES_OBJECT_EXIST(uLocal_2672))
			{
				func_28(161, 1);
			}
			_SET_DES_OBJECT_STATE(uLocal_2672, 9);
			REMOVE_MODEL_HIDE(2457.15f, 4968.79f, 48.677f, 100f, 965837842, 0);
			REMOVE_MODEL_HIDE(2457.15f, 4968.79f, 48.677f, 100f, 247384786, 0);
			REMOVE_MODEL_HIDE(2457.15f, 4968.79f, 48.677f, 100f, -247908770, 0);
			if (bParam1)
			{
				func_275(0, -1, 1);
			}
		...
		case 10:
			...
			{
				SET_ENTITY_COORDS(PLAYER_PED_ID(), 2625.776f, 4802.217f, 32.5747f, 1, 0, 0, 1);
...
Vector3 func_269(var uParam0, vector3 vParam1)
{
	var uVar0;
...
int func_280(var uParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	int iVar0;
	vector3 vVar1;
	bool bVar4;
	...
	if (func_337(uParam0))
	{
		...
		if (func_336(uParam0))
		{
			...
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_314(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && ARE_STRINGS_EQUAL(GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_72(iParam0, 0, 0)) || func_72(iParam0, 1, 0)) || func_72(iParam0, 2, 0)) || func_302(iParam0) != 145) || func_301(iParam0)) || func_300(iParam0)) || func_299(iParam0)) || func_298(iParam0)) || !func_288(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_300(iParam0))
		{
		}
...
int func_314(var uParam0, vector3 vParam1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_315(uParam0, Global_70409.f_139[38], 0))
			{
				func_306(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_315(uParam0, Global_70409.f_139[43], 1))
			{
				func_306(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_315(uParam0, uVar1[iVar6], 1) && func_229(GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_162(vParam1, 0f, 0f, 0f, 0)) || GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(uParam0, 1), GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
void func_317(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_91043[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || GET_ENTITY_MODEL(Global_91043[iVar0]) == func_311(iParam0, iParam1))
				{
...
void func_318(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_283(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (IS_BIT_SET(uParam1->f_77, func_283(iVar1 + 1)))
			{
			}
			else
			{
				SET_BIT(&(uParam1->f_77), func_283(iVar1 + 1));
			}
		}
		...
		if (((IS_BIT_SET(uParam1->f_77, 15) || func_326(uParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_325())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (bParam3)
		{
			func_319(&uParam0, &(uParam1->f_9), &(uParam1->f_59));
		}
		if (!IS_THIS_MODEL_A_HELI(uParam1->f_66) && !IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar2 <= 11)
			{
				if (IS_BIT_SET(uParam1->f_77, func_283(iVar2 + 1)))
				{
...
int func_319(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_323(GET_ENTITY_MODEL(*uParam0), 1) && GET_VEHICLE_MOD(*uParam0, 24) != func_322(*uParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*uParam0, 24, func_322(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_321(uParam0);
	if (func_320(*uParam0))
	{
...
void func_335(vector3 vParam0, float fParam3, int iParam4)
{
	int iVar0;
...
int func_345(int iParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_349(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	if (func_359())
	{
...
int func_350(var uParam0, int iParam1, vector3 vParam2, int iParam5, bool bParam6)
{
	int iVar0;
	...
	if (!func_45(iParam1))
	{
		...
		if (HAS_MODEL_LOADED(iVar0))
		{
			...
			*uParam0 = CREATE_PED(26, iVar0, vParam2, iParam5, 0, 0);
...
void func_353(int iParam0)
{
	...
	if (iParam0 != 3)
	{
		SET_SCENARIO_GROUP_ENABLED("Chinese2_Lunch", 1);
		SET_SCENARIO_GROUP_ENABLED("CHINESE2_HILLBILLIES", 0);
	}
	SET_PLAYER_CONTROL(PLAYER_ID(), 1, 0);
	if (iLocal_2884 != -1)
	...
	if (DOES_ENTITY_EXIST(uLocal_2878))
	{
		DELETE_OBJECT(&uLocal_2878);
	}
	if (iParam0 != 0 && iParam0 != 2)
	{
		CLEAR_AREA(2438.433f, 4970.416f, 53.1778f, 450f, 1, 0, 0, 0);
		STOP_FIRE_IN_RANGE(2442.69f, 4970.348f, 46.33f, 30f);
	}
	iVar0 = 0;
	while (iVar0 < Local_2515)
	...
	if (DOES_ENTITY_EXIST(uLocal_2508))
	{
		if (func_68(uLocal_2508))
		{
			SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_2508);
		}
	}
	if (DOES_PICKUP_EXIST(uLocal_2675))
	{
	...
	if (iParam0 == 0)
	{
		...
		{
			FREEZE_ENTITY_POSITION(uLocal_2680, 0);
			SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_2680);
		}
		if (DOES_ENTITY_EXIST(uLocal_2681))
		{
			FREEZE_ENTITY_POSITION(uLocal_2681, 0);
			SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_2681);
		}
	}
	if (DOES_ENTITY_EXIST(uLocal_2642))
	{
...
void func_361()
{
	ADD_RELATIONSHIP_GROUP("MYFRIEND", &uLocal_1615);
	ADD_RELATIONSHIP_GROUP("FOE", &iLocal_1616);
	ADD_RELATIONSHIP_GROUP("IGNORE", &uLocal_1617);
	ADD_RELATIONSHIP_GROUP("BARpeds", &uLocal_2636);
	SET_RELATIONSHIP_BETWEEN_GROUPS(3, uLocal_2636, 1862763509);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER_PED_ID()), iLocal_1616);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_1616, GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER_PED_ID()));
	SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_1615, uLocal_1617);
	SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_1616, uLocal_1617);
	SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_1617, GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER_PED_ID()));
	SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_1617, iLocal_1616);
}
...
void func_363(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_427(GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
...
{
	func_365(&Global_100114, GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_365(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_43();
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		func_388(PLAYER_PED_ID());
		func_381(PLAYER_PED_ID(), 0);
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_91043[iVar0]))
		{
			if (Global_91043[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || GET_ENTITY_MODEL(iParam0) == func_311(iParam1, iParam2))
					{
						return 1;
					}
				}
...
int func_375(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2539502[iParam0 /*3*/][func_376(iParam1)];
...
void func_382(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_387(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_384(Var11.f_1)) && iVar72 < 51)
			{
...
void func_388(var uParam0)
{
	...
	if (func_45(iVar0) && !IS_PED_INJURED(uParam0))
	{
...
int func_390(vector3 vParam0, char* sParam3, vector3 vParam4)
{
	int iVar0;
	int iVar1;
...
int func_392(var uParam0)
{
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (func_34())
		{
			*uParam0 = func_397(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_394(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_25() == 0)
		{
			return IS_BIT_SET(func_375(func_395(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_397(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_413(iVar0))
		{
			...
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_398(iVar0, 0), 1);
...
Vector3 func_402(vector3 vParam0, float fParam3)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
var func_414()
{
	...
	func_424(&uVar0, GET_CLOCK_SECONDS());
	func_423(&uVar0, GET_CLOCK_MINUTES());
	func_422(&uVar0, GET_CLOCK_HOURS());
	func_417(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_416(&uVar0, GET_CLOCK_MONTH());
	func_415(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SHIFT_RIGHT(uParam0, 26) & 31 * func_420(IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_437(int iParam0)
{
	...
	if (DOES_NAVMESH_BLOCKING_OBJECT_EXIST(uLocal_2510))
	{
		REMOVE_NAVMESH_BLOCKING_OBJECT(uLocal_2510);
	}
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		REMOVE_WEAPON_FROM_PED(PLAYER_PED_ID(), joaat("weapon_petrolcan"));
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()) != 0)
		{
			...
			{
				SET_ENTITY_COORDS(PLAYER_PED_ID(), 2463.811f, 4961.747f, 44.176f, 1, 0, 0, 1);
