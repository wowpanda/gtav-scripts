			...
			switch (iLocal_59)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_108(3) && !Global_16C52)
						{
							if (func_136(uLocal_58, 2097152))
							{
								if ((!func_136(uLocal_58, 1) || !ENTITY::DOES_ENTITY_EXIST(func_107())) && !Global_16C52)
								{
									func_129(10);
									break;
								}
						...
						if ((!func_98(6) || Global_19A9D) || func_97())
						{
							bVar3 = false;
						}
						if (!bLocal_78)
						...
						if (func_91() || func_90(8, 4294967295))
						{
							bVar3 = false;
						}
				...
				case 6:
					if (func_136(Global_19911, 262144))
					{
						func_143(&Global_19911, 262144);
						func_27();
					}
					if (func_136(uLocal_58, 2097152))
					{
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						if (iLocal_63 != 4294967295)
						{
							if (func_136(Global_19911, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_30(iLocal_63), 0, Global_16C55, 0);
								func_19(func_30(iLocal_63), 0, Global_16C55, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_30(iLocal_63), 0, Global_16C55, 0);
								func_19(func_30(iLocal_63), 0, Global_16C55, 0, 0);
							}
						}
						func_5();
						func_143(&Global_19911, 0);
...
{
	if (func_136(Global_19E56.f_4A2C, 1))
	{
		func_143(&(Global_19E56.f_4A2C), 1);
		func_18();
		func_8();
		func_6();
	}
...
{
	if (Global_19E56.f_4A2C.f_12 < Global_19E56.f_4A2C.f_13[iLocal_82] || Global_19E56.f_4A2C.f_13[iLocal_82] == 0)
	{
		Global_19E56.f_4A2C.f_13[iLocal_82] = Global_19E56.f_4A2C.f_12;
		Global_19E56.f_4A2C.f_12 = 999;
	}
	if (iLocal_82 == Global_19E56.f_4A2C.f_1 || Global_19E56.f_4A2C.f_1 == 4294967295)
	{
		if (Global_19E56.f_4A2C.f_1 != 5)
		{
			Global_19E56.f_4A2C.f_1++;
			switch (Global_19E56.f_4A2C.f_1)
			{
				case 1:
					func_130(70, 1, 0);
					func_17(70, 1);
...
float func_23(int iParam0)//Position - 0x1755
{
	if (func_26(iParam0))
	{
		...
		{
			return (func_24(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
{
	iParam0->f_1 = (func_24(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 4)) - fParam1);
...
void func_50()//Position - 0x1FCC
{
	...
	fVar0 = SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), vLocal_81);
	if (fVar0 < 62500f)
	{
		func_74();
		func_71();
...
int func_52()//Position - 0x2042
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_267.f_53) || !ENTITY::DOES_ENTITY_EXIST(Local_267.f_53.f_1))
	{
		return 0;
	}
	return 1;
...
void func_63()//Position - 0x2712
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_66(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_64(iVar0) && (!func_110(14) || Global_19A3D))
			{
...
void func_70()//Position - 0x2987
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()) && !ENTITY::IS_ENTITY_DEAD(Local_267.f_53, 0))
	{
		...
		CAM::SET_GAMEPLAY_ENTITY_HINT(Local_267.f_53, 0f, 0f, 0.75f, 1, 2000, 2000, 2000, 0);
	}
}
...
void func_71()//Position - 0x29E3
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_95, 0) && !ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
	{
		switch (iLocal_266)
		{
			case 0:
				if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(iLocal_95, true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) < 64f && !PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
				{
					iLocal_99 = 0;
					iLocal_100 = 0;
					iLocal_266 = 1;
			...
			case 2:
				if ((BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_95, 242628503) != 1 || PED::IS_PED_FACING_PED(iLocal_95, AUDIO::_0x0626A247D2405330(), 20f)) && !AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
				{
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_95, AUDIO::_0x0626A247D2405330(), 4294967295);
					if (!iLocal_100)
					{
			...
			case 3:
				...
				{
					func_33(&iLocal_87);
					BRAIN::TASK_PLAY_ANIM(iLocal_95, "random@street_race", "_streetracer_wait_loop", 4f, -4f, 4294967295, 9, 0, 0, 0, 0);
					iLocal_266 = 4;
				}
				break;
			
			case 4:
				if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(iLocal_95, true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) > 225f)
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iVar2);
					BRAIN::TASK_ACHIEVE_HEADING(0, Local_267.f_53.f_9, 1000);
					BRAIN::TASK_PLAY_ANIM(0, Local_267.f_53.f_C, Local_267.f_53.f_D, 4f, -8f, 4294967295, 1, 0, 0, 0, 0);
...
void func_74()//Position - 0x2E1C
{
	...
	while (iVar2 < 5)
	{
		...
		{
			if (func_79(Local_267[iVar2 /*14*/], 1, 0, 0, 0) || PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), Local_267[iVar2 /*14*/].f_1, 1))
			{
				func_77();
				func_76(iLocal_69);
			...
			if (!PED::IS_PED_INJURED(Local_267[iVar2 /*14*/]))
			{
				if (func_26(&(vLocal_83[iVar2 /*3*/])))
				{
					...
					{
						if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_267[iVar2 /*14*/].f_1, 0) && PED::IS_PED_IN_VEHICLE(Local_267[iVar2 /*14*/], Local_267[iVar2 /*14*/].f_1, 0))
						{
			...
			{
				if ((ENTITY::IS_ENTITY_TOUCHING_ENTITY(AUDIO::_0x0626A247D2405330(), Local_267[iVar2 /*14*/]) && !PED::IS_PED_RAGDOLL(Local_267[iVar2 /*14*/])) && !BRAIN::IS_PED_GETTING_UP(Local_267[iVar2 /*14*/]))
				{
				...
				else if (Local_267[iVar2 /*14*/].f_B)
				{
					...
					BRAIN::TASK_PLAY_ANIM(0, Local_267[iVar2 /*14*/].f_C, Local_267[iVar2 /*14*/].f_D, 4f, -8f, 4294967295, 1, 0, 0, 0, 0);
					CUTSCENE::_0x8D9DF6ECA8768583(iVar3);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_267[iVar2 /*14*/], iVar3);
					BRAIN::CLEAR_SEQUENCE_TASK(&iVar3);
				...
				{
					if (!Local_267[iVar2 /*14*/].f_A && (PED::IS_PED_RAGDOLL(Local_267[iVar2 /*14*/]) || BRAIN::IS_PED_GETTING_UP(Local_267[iVar2 /*14*/])))
					{
						Local_267.f_65++;
					}
				...
				else if (Local_267[iVar2 /*14*/].f_A)
				{
					...
					BRAIN::TASK_PLAY_ANIM(0, "gestures@m@standing@casual", func_75(), 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_ACHIEVE_HEADING(0, Local_267[iVar2 /*14*/].f_9, 1000);
					BRAIN::TASK_PLAY_ANIM(0, Local_267[iVar2 /*14*/].f_C, Local_267[iVar2 /*14*/].f_D, 4f, -8f, 4294967295, 1, 0, 0, 0, 0);
					CUTSCENE::_0x8D9DF6ECA8768583(iVar3);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_267[iVar2 /*14*/], iVar3);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_267.f_53.f_1) && ENTITY::DOES_ENTITY_EXIST(Local_267.f_53))
	{
		if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), Local_267.f_53.f_1, 0))
		{
		...
		if (!PED::IS_PED_INJURED(Local_267.f_53))
		{
			if (func_26(&iLocal_84))
			{
				if (func_23(&iLocal_84) > fLocal_94)
				{
					if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_267.f_53.f_1, 0) && PED::IS_PED_IN_VEHICLE(Local_267.f_53, Local_267.f_53.f_1, 0))
					{
						iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(250, 500);
						iVar1 = MISC::GET_RANDOM_INT_IN_RANGE(250, 500);
						BRAIN::OPEN_SEQUENCE_TASK(&iVar3);
						BRAIN::TASK_VEHICLE_TEMP_ACTION(0, Local_267.f_53.f_1, 1, iVar0);
						BRAIN::TASK_VEHICLE_TEMP_ACTION(0, Local_267.f_53.f_1, 31, iVar1);
						CUTSCENE::_0x8D9DF6ECA8768583(iVar3);
						if (!PED::IS_PED_INJURED(Local_267.f_53))
						{
							BRAIN::TASK_PERFORM_SEQUENCE(Local_267.f_53, iVar3);
						}
						BRAIN::CLEAR_SEQUENCE_TASK(&iVar3);
					}
					func_33(&iLocal_84);
		...
		if (!ENTITY::IS_ENTITY_DEAD(Local_267.f_53, 0))
		{
			if ((ENTITY::IS_ENTITY_TOUCHING_ENTITY(AUDIO::_0x0626A247D2405330(), Local_267.f_53) && !PED::IS_PED_RAGDOLL(Local_267.f_53)) && !BRAIN::IS_PED_GETTING_UP(Local_267.f_53))
			{
			...
			if (PED::IS_PED_RAGDOLL(Local_267.f_53) || BRAIN::IS_PED_GETTING_UP(Local_267.f_53))
			{
			...
			else if (Local_267.f_53.f_A)
			{
				...
				BRAIN::TASK_PLAY_ANIM(0, "gestures@m@standing@casual", func_75(), 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
				BRAIN::TASK_ACHIEVE_HEADING(0, Local_267.f_53.f_9, 1000);
				BRAIN::TASK_PLAY_ANIM(0, Local_267.f_53.f_C, Local_267.f_53.f_D, 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
				CUTSCENE::_0x8D9DF6ECA8768583(iVar3);
				BRAIN::TASK_PERFORM_SEQUENCE(Local_267.f_53, iVar3);
				BRAIN::CLEAR_SEQUENCE_TASK(&iVar3);
				iLocal_266 = 4;
...
void func_77()//Position - 0x3439
{
	...
	PED::GET_PED_NEARBY_PEDS(AUDIO::_0x0626A247D2405330(), &iVar0, 4294967295);
	iVar2 = 0;
	iVar2 = 0;
	while (iVar2 < iVar0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iVar0[iVar2]) && !PED::IS_PED_INJURED(iVar0[iVar2]))
		{
			...
			{
				BRAIN::TASK_SMART_FLEE_PED(iVar0[iVar2], AUDIO::_0x0626A247D2405330(), 100f, 4294967295, 0, 0);
			}
			else
			{
				BRAIN::OPEN_SEQUENCE_TASK(&iVar1);
				BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), MISC::GET_RANDOM_INT_IN_RANGE(300, 900));
				BRAIN::TASK_COMBAT_PED(0, AUDIO::_0x0626A247D2405330(), 0, 0);
				CUTSCENE::_0x8D9DF6ECA8768583(iVar1);
...
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iParam0, 0))
	{
		return 0;
	}
	else
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_105()) || Global_19A9D) || Global_6375) || func_104()) || func_90(8, 4294967295)) || func_103()) || func_102()) || func_101()) || func_92()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_105()) || Global_6375) || func_104()) || func_90(8, 4294967295)) || func_101()) || func_103()) || func_102()) || func_92()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_105()) || Global_19A9D) || Global_6375) || func_104()) || func_90(8, 4294967295)) || func_101()) || func_103()) || func_102()) || func_92()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_105()) || Global_19A9D) || Global_6375) || func_104()) || func_90(8, 4294967295)) || func_103()) || func_102()) || func_92()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_105() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_90(8, 4294967295)) || func_92()) || func_100()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_90(8, 4294967295) || func_103()) || func_102()) || func_100()) || func_99())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_105()) || Global_6375) || func_104()) || func_90(8, 4294967295)) || func_102()) || func_101()) || func_92()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
void func_111()//Position - 0x4532
{
	...
	iVar0 = CLOCK::GET_CLOCK_HOURS();
	if ((iVar0 <= iLocal_79 && iVar0 >= iLocal_80) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) != 0)
	{
		return;
	}
	if (bLocal_96)
	...
	if (fLocal_74 > 9f)
	{
		...
		while (iVar5 < Local_267)
		{
			if (!func_117(Local_267[iVar5 /*14*/].f_2))
			{
				...
				{
					Local_267[iVar5 /*14*/] = PED::CREATE_PED_INSIDE_VEHICLE(Local_267[iVar5 /*14*/].f_1, 4, func_115(), 4294967295, 1, true);
				...
				else
				{
					...
					BRAIN::TASK_PLAY_ANIM(0, sVar3, sVar4, 8f, -8f, 4294967295, 8193, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 0, 0, 0);
				...
				PED::GIVE_PED_HELMET(Local_267[iVar5 /*14*/], 1, 4096, 4294967295);
			}
			iVar5++;
		}
		Local_267.f_53.f_1 = VEHICLE::CREATE_VEHICLE(func_116(1), Local_267.f_53.f_2, Local_267.f_53.f_5, true, true, false);
		VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_267.f_53.f_1, 1084227584);
		VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_267.f_53.f_1, true);
		if (func_117(Local_267.f_53.f_6))
		{
			Local_267.f_53 = PED::CREATE_PED_INSIDE_VEHICLE(Local_267.f_53.f_1, 4, func_115(), 4294967295, 1, true);
			VEHICLE::SET_VEHICLE_ENGINE_ON(Local_267.f_53.f_1, true, false, 0);
		}
		else
		{
			Local_267.f_53 = PED::CREATE_PED(4, func_115(), Local_267.f_53.f_6, Local_267.f_53.f_9, 1, true);
			...
			BRAIN::TASK_PLAY_ANIM(0, "amb@world_human_aa_smoke@male@idle_a", sVar4, 8f, -8f, 4294967295, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f), 0, 0, 0);
			CUTSCENE::_0x8D9DF6ECA8768583(iVar0);
			BRAIN::TASK_PERFORM_SEQUENCE(Local_267.f_53, iVar0);
			BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
		}
	}
...
int func_116(bool bParam0)//Position - 0x50B3
{
	...
	{
		if (STREAMING::IS_MODEL_A_VEHICLE(Local_267.f_47[iVar1]))
		{
			iVar0++;
		}
		iVar1++;
...
{
	return ((((((((func_123(&(Local_267.f_47)) && func_123(&(Local_267.f_4D))) && func_123(&(Local_267.f_63))) && STREAMING::HAS_ANIM_DICT_LOADED("amb@world_human_hang_out_street@male_a@idle_a")) && STREAMING::HAS_ANIM_DICT_LOADED("amb@world_human_hang_out_street@male_b@idle_a")) && STREAMING::HAS_ANIM_DICT_LOADED("amb@world_human_hang_out_street@male_c@idle_a")) && STREAMING::HAS_ANIM_DICT_LOADED("amb@world_human_aa_smoke@male@idle_a")) && STREAMING::HAS_ANIM_DICT_LOADED("random@street_race")) && STREAMING::HAS_ANIM_DICT_LOADED("gestures@m@standing@casual"));
}
...
void func_124()//Position - 0x55CD
{
	...
	if (iLocal_82 == 0)
	{
		STREAMING::REQUEST_MODEL(4041902820);
...
{
	return func_135(iParam0, Global_8D15);
}
...
void func_137()//Position - 0x5C7D
{
	...
	if (iLocal_82 > Global_19E56.f_4A2C.f_1)
	{
...
bool func_138(int iParam0, bool bParam1)//Position - 0x5D78
{
	...
	if (bParam1)
	{
		return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_64EA[iVar0 /*23*/].f_B, 15);
	}
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_64EA[iVar0 /*23*/].f_B, 0);
}
