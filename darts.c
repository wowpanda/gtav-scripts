...
void __EntryFunction__()
{
	...
	if (!DOES_ENTITY_EXIST(ScriptParam_0.f_4))
	{
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			if (iLocal_334 == 2)
			...
			if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(ScriptParam_0, 5f, joaat("prop_dart_bd_cab_01"), 0))
			{
				ScriptParam_0.f_4 = GET_CLOSEST_OBJECT_OF_TYPE(ScriptParam_0, 5f, joaat("prop_dart_bd_cab_01"), 1, 0, 1);
				_0x163F8B586BC95F2A(ScriptParam_0, 5f, joaat("prop_dart_bd_cab_01"), &ScriptParam_0, &vVar1784, 0);
	...
	{
		vVar1784 = { GET_ENTITY_COORDS(ScriptParam_0.f_4, 1) };
	}
	if (!IS_ENTITY_DEAD(func_494(), 0))
	{
		func_492(iLocal_329, 1);
		if (IS_PED_IN_ANY_VEHICLE(func_494(), 0))
		{
			TASK_LEAVE_ANY_VEHICLE(func_494(), 0, 0);
		}
	...
	fVar1776 = (TO_FLOAT(uLocal_325) / 100f);
	fVar1777 = (fVar1776 * 1200f);
	iLocal_142 = ROUND(fVar1777);
	if (iLocal_142 < 660)
	{
		iLocal_142 = 660;
	}
	...
	while (true)
	{
		...
		if ((IS_PED_INJURED(ScriptParam_0.f_5) && !DOES_ENTITY_EXIST(func_494())) || (DOES_ENTITY_EXIST(func_494()) && IS_PED_INJURED(func_494())))
		{
			func_465(&Var0, &Var508, &Var1191);
		}
		if (!IS_PED_INJURED(uLocal_295[0]))
		{
			SET_PED_RESET_FLAG(uLocal_295[0], 239, 1);
			SET_PED_RESET_FLAG(uLocal_295[0], 124, 1);
			func_458();
			_DISABLE_INPUT_GROUP(0);
			_DISABLE_INPUT_GROUP(2);
			iVar1775 = 0;
			while (iVar1775 < GET_PED_NEARBY_PEDS(PLAYER_PED_ID(), &uVar1803, -1))
			{
				if (uVar1803[iVar1775] != uLocal_295[1])
				{
					if (!IS_PED_INJURED(uVar1803[iVar1775]))
					{
						SET_PED_RESET_FLAG(uVar1803[iVar1775], 240, 1);
					}
				}
				iVar1775++;
			}
			switch (Var0)
			{
				case 0:
					...
					{
						vLocal_366 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Var0.f_243, 0.7792f, -1.138f, 0.1814f) };
						vLocal_369 = { -7.9947f, 0f, (Var0.f_243.f_4 + 36.19176f) };
						uLocal_129 = CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_366, vLocal_369, 1115815936, 0, 2);
						SET_CAM_FOV(uLocal_129, 30f);
					}
					func_455();
					SETTIMERA(0);
					Var0 = 1;
				...
				case 1:
					...
					{
						CLEAR_AREA(ScriptParam_0, 0.5f, 1, 0, 0, 0);
						if (!IS_PED_INJURED(PLAYER_PED_ID()) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
						{
							CLEAR_SEQUENCE_TASK(&uLocal_332);
							OPEN_SEQUENCE_TASK(&uLocal_332);
							TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
							CLOSE_SEQUENCE_TASK(uLocal_332);
							TASK_PERFORM_SEQUENCE(PLAYER_PED_ID(), uLocal_332);
						}
						vLocal_85 = { vLocal_85 };
						Var0 = 2;
					}
				...
				case 2:
					...
					if (DOES_ENTITY_EXIST(Var0.f_243))
					{
						vVar1784 = { GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Var0.f_243, Var477.f_18) };
					}
				...
				case 3:
					if (func_445(&Var477, &Var508))
					{
						...
						if (!IS_ENTITY_DEAD(func_494(), 0))
						{
							...
							switch (iLocal_389)
							{
								...
								case 19:
									...
									SET_PED_COMPONENT_VARIATION(func_494(), 5, 2, 0, 0);
									break;
						...
						{
							iVar1773 = GET_RANDOM_INT_IN_RANGE(0, 200);
							if (iLocal_334 == 2)
							{
								if (iVar1773 < 51)
								{
						...
						uLocal_59 = CREATE_OBJECT(iLocal_60, vVar471, 1, 1, 0);
						Var0.f_446[0] = 0;
						Var0.f_446[1] = 0;
						Var0 = 4;
					}
				...
				case 4:
					...
					{
						uVar1824 = CREATE_OBJECT(joaat("prop_dart_1"), vVar471, 1, 1, 0);
						func_436(Var0.f_243.f_4, Var465, &uVar1803, &ScriptParam_0);
						func_435(&Var477, sLocal_390, sLocal_391);
						CLEAR_PED_TASKS(uLocal_295[1]);
						uLocal_333 = CREATE_CAMERA_WITH_PARAMS(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 1115815936, 0, 2);
						if (!IS_PED_INJURED(PLAYER_PED_ID()))
						{
							FORCE_PED_MOTION_STATE(PLAYER_PED_ID(), -1871534317, 0, 0, 0);
						}
						func_434(&(Var0.f_257), 0, PLAYER_PED_ID(), sLocal_390, 0, 1);
						if (IS_ENTITY_DEAD(func_494(), 0))
						{
							if (iLocal_334 == 2)
							{
				...
				case 5:
					if ((((!IS_PED_INJURED(uLocal_295[1]) && IS_PED_ON_FOOT(uLocal_295[0])) && !IS_PED_IN_ANY_VEHICLE(uLocal_295[0], 1)) && IS_PED_ON_FOOT(uLocal_295[1])) && !IS_PED_IN_ANY_VEHICLE(uLocal_295[1], 1))
					{
						bLocal_305 = func_429(&uLocal_321);
						if ((func_428() && GET_GAME_TIMER() >= iLocal_323 + 1000) && iVar1774 != 9)
						{
						...
						if (IS_SCREEN_FADED_OUT() && iVar1774 != 9)
						{
							func_425(0);
							func_423();
							iVar1774 = 9;
						...
						{
							case -1:
								if (!IS_PED_INJURED(uLocal_295[1]))
								{
									uLocal_327 = CREATE_SYNCHRONIZED_SCENE(GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(ScriptParam_0.f_4, 0.337842f, -0.243051f, -0.329731f), 0f, 0f, (GET_ENTITY_HEADING(ScriptParam_0.f_4) - 3.783146f), 2);
									uLocal_333 = CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
									PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_333, uLocal_327, "darts_ig_intro_cam", "mini@dartsintro");
									SET_CAM_ACTIVE(uLocal_333, 1);
									RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
									TASK_CLEAR_LOOK_AT(uLocal_295[0]);
									TASK_CLEAR_LOOK_AT(uLocal_295[1]);
									CLEAR_PED_TASKS_IMMEDIATELY(uLocal_295[0]);
									CLEAR_PED_TASKS_IMMEDIATELY(uLocal_295[1]);
									TASK_SYNCHRONIZED_SCENE(uLocal_295[1], uLocal_327, "mini@dartsintro", "darts_ig_intro_guy1", 1000f, -1000f, 0, 0, 1148846080, 0);
									TASK_SYNCHRONIZED_SCENE(uLocal_295[0], uLocal_327, "mini@dartsintro", "darts_ig_intro_guy2", 1000f, -1000f, 0, 0, 1148846080, 0);
									TASK_PLAY_ANIM(uLocal_295[1], "mini@dartsintro", "darts_ig_intro_guy1_face", 8f, -8f, -1, 32, 0, 0, 0, 0);
									TASK_PLAY_ANIM(uLocal_295[0], "mini@dartsintro", sVar1793, 8f, -8f, -1, 32, 0, 0, 0, 0);
									PLAY_SYNCHRONIZED_ENTITY_ANIM(uVar1824, uLocal_327, "darts_ig_intro_dart", "mini@dartsintro", 1000f, 1090519040, 0, 1148846080);
									func_422(&uVar1800);
									iVar1774++;
								}
								break;
							...
							case 0:
								if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_327))
								{
									if (!bVar1770)
									{
									...
									else if (!IS_AMBIENT_SPEECH_PLAYING(uLocal_295[0]))
									{
										if (!bVar1771)
										{
									...
									switch (iLocal_31)
									{
										...
										case 1:
											if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_327) > 0.25f)
											{
												func_422(&uVar1800);
										...
										case 2:
											if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_327) > 0.55f)
											{
										...
										case 3:
											if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_327) > 0.85f)
											{
												func_416("DARTS_HOW_3A", -1);
												iLocal_31++;
											}
									...
									if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_327) > 0.95f)
									{
										iLocal_317 = 1;
										iVar1774++;
									}
							...
							case 1:
								if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_327) > 0.99f)
								{
									if (!IS_PED_INJURED(uLocal_295[1]))
									{
										...
										iLocal_31 = 0;
										CLEAR_HELP(1);
										DESTROY_CAM(uLocal_333, 0);
										CLEAR_PED_TASKS(uLocal_295[0]);
										CLEAR_PED_TASKS(uLocal_295[1]);
										STOP_SYNCHRONIZED_ENTITY_ANIM(uVar1824, -1000f, 0);
										DELETE_OBJECT(&uVar1824);
										STOP_AUDIO_SCENE(func_412(0));
										func_419(&uVar1800);
										Var0 = 6;
										iVar1774 = 0;
									}
							...
							case 3:
								if (!IS_PED_INJURED(uLocal_295[1]))
								{
									uLocal_327 = CREATE_SYNCHRONIZED_SCENE(GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(ScriptParam_0.f_4, 0.337842f, -0.243051f, -0.329731f), 0f, 0f, (GET_ENTITY_HEADING(ScriptParam_0.f_4) - 3.783146f), 2);
									uLocal_333 = CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
									PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_333, uLocal_327, "darts_ig_intro_alt1_cam", "mini@dartsintro_alt1");
									SET_CAM_ACTIVE(uLocal_333, 1);
									RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
									TASK_CLEAR_LOOK_AT(uLocal_295[0]);
									TASK_CLEAR_LOOK_AT(uLocal_295[1]);
									CLEAR_PED_TASKS_IMMEDIATELY(uLocal_295[0]);
									CLEAR_PED_TASKS_IMMEDIATELY(uLocal_295[1]);
									TASK_SYNCHRONIZED_SCENE(uLocal_295[1], uLocal_327, "mini@dartsintro_alt1", "darts_ig_intro_alt1_guy1", 1000f, -1000f, 0, 0, 1148846080, 0);
									TASK_SYNCHRONIZED_SCENE(uLocal_295[0], uLocal_327, "mini@dartsintro_alt1", "darts_ig_intro_alt1_guy2", 1000f, -1000f, 0, 0, 1148846080, 0);
									TASK_PLAY_ANIM(uLocal_295[1], "mini@dartsintro_alt1", "darts_ig_intro_alt1_guy1_face", 8f, -8f, -1, 32, 0, 0, 0, 0);
									TASK_PLAY_ANIM(uLocal_295[0], "mini@dartsintro_alt1", sVar1793, 8f, -8f, -1, 32, 0, 0, 0, 0);
									PLAY_SYNCHRONIZED_ENTITY_ANIM(uVar1824, uLocal_327, "darts_ig_intro_alt1_dart", "mini@dartsintro_alt1", 1000f, 1090519040, 0, 1148846080);
									func_422(&uVar1800);
									iVar1774++;
								}
								break;
							...
							case 9:
								if (IS_SCREEN_FADED_OUT())
								{
									...
									if (!IS_PED_INJURED(uLocal_295[1]))
									{
										SET_ENTITY_COORDS(uLocal_295[0], Var465, 1, 0, 0, 1);
										SET_ENTITY_HEADING(uLocal_295[0], Var0.f_243.f_4);
										SET_ENTITY_COORDS(uLocal_295[1], Var465.f_3, 1, 0, 0, 1);
										SET_ENTITY_HEADING(uLocal_295[1], Var0.f_243.f_4);
										CLEAR_PED_TASKS(uLocal_295[0]);
										CLEAR_PED_TASKS(uLocal_295[1]);
									}
									DESTROY_CAM(uLocal_333, 0);
				...
				case 6:
					switch (iVar1774)
					{
						case 0:
							...
							START_AUDIO_SCENE(func_412(1));
							iVar1774 = 0;
							Var0 = 7;
							break;
						
						case 1:
							if ((GET_GAME_TIMER() - iLocal_323) > 1500)
							{
				...
				case 7:
					if (!IS_BIT_SET(Global_106526, 0))
					{
						...
						{
							SET_BIT(&Global_106526, 0);
							Var0 = 8;
						}
					}
					else
					{
						SET_CAM_ACTIVE(uLocal_120, 1);
						Var0 = 8;
					}
					break;
				...
				case 8:
					...
					{
						case 0:
							if (!DOES_ENTITY_EXIST(func_494()))
							{
								if (!IS_BIT_SET(Global_106526, 10))
								{
									SET_BIT(&Global_106526, 10);
								}
								else
								{
									CLEAR_BIT(&Global_106526, 10);
								}
								func_403(&Var508);
								iVar1774++;
							}
						...
						case 1:
							if (IS_PC_VERSION())
							{
								if (fLocal_134 != _GET_ASPECT_RATIO(0))
								{
									fLocal_134 = _GET_ASPECT_RATIO(0);
									SET_CAM_FOV(uLocal_120, func_402(fLocal_134));
									SET_CAM_FOV(uLocal_121, func_402(fLocal_134));
								}
							}
							if (func_342(&Var508, &(Var0.f_452), &(Var0.f_453)))
							{
								STOP_AUDIO_SCENE(func_412(1));
								if (Var0.f_452 > 0)
								{
									iVar1774 = 0;
					...
					switch (iVar1774)
					{
						case 0:
							if (func_421(&(Var0.f_254)) > 0.5f)
							{
								...
								iVar1830 = func_238();
								uLocal_327 = CREATE_SYNCHRONIZED_SCENE(vVar1787, vVar1790, 2);
								uLocal_333 = CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
								PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_333, uLocal_327, sLocal_407[iVar1830], "mini@dartsoutro");
								SET_CAM_ACTIVE(uLocal_333, 1);
								RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
								if (!IS_PED_INJURED(uLocal_295[0]) && !IS_PED_INJURED(uLocal_295[1]))
								{
									if (Var0.f_454)
									{
										...
										TASK_SYNCHRONIZED_SCENE(uLocal_295[0], uLocal_327, "mini@dartsoutro", sLocal_399[iVar1830], 1000f, -1.5f, 0, 0, 1148846080, 0);
										TASK_SYNCHRONIZED_SCENE(uLocal_295[1], uLocal_327, "mini@dartsoutro", sLocal_403[iVar1830], 1000f, -1.5f, 0, 0, 1148846080, 0);
										TASK_PLAY_ANIM(PLAYER_PED_ID(), sLocal_394, sLocal_395[GET_RANDOM_INT_IN_RANGE(0, 3)], 4f, -4f, -1, 32, 0, 0, 0, 0);
									}
									else
									{
										PLAY_SOUND_FRONTEND(-1, "OTHER_TEXT", "HUD_AWARDS", 1);
										func_236(&uLocal_295);
										TASK_SYNCHRONIZED_SCENE(uLocal_295[1], uLocal_327, "mini@dartsoutro", sLocal_399[iVar1830], 1000f, -1.5f, 0, 0, 1148846080, 0);
										TASK_SYNCHRONIZED_SCENE(uLocal_295[0], uLocal_327, "mini@dartsoutro", sLocal_403[iVar1830], 1000f, -1.5f, 0, 0, 1148846080, 0);
										TASK_PLAY_ANIM(uLocal_295[1], sLocal_393, sLocal_395[GET_RANDOM_INT_IN_RANGE(0, 3)], 4f, -4f, -1, 32, 0, 0, 0, 0);
									}
								}
								iVar1774++;
							}
						...
						case 2:
							func_419(&(Var0.f_254));
							iLocal_311 = 0;
							STOP_AUDIO_SCENE(func_412(3));
							func_411();
							if (DOES_CAM_EXIST(uLocal_333))
							{
								DESTROY_CAM(uLocal_333, 0);
							}
							iVar1774 = 0;
				...
				case 13:
					...
					switch (iVar1774)
					{
						case 0:
							...
							if (!bLocal_313)
							{
								RENDER_SCRIPT_CAMS(0, bLocal_313, 3000, 1, 0, 0);
							}
							else
							{
							...
							CLEAR_PRINTS();
							TASK_LOOK_AT_ENTITY(uLocal_295[0], uLocal_295[1], 5000, 2049, 3);
							func_432(&uVar1800);
							iVar1774++;
							break;
				...
				case 14:
					...
					if (IS_CONTROL_JUST_RELEASED(2, 201))
					{
						...
						iLocal_330 = 2;
						bVar1768 = true;
						if (IS_AUDIO_SCENE_ACTIVE(func_412(2)))
						{
							STOP_AUDIO_SCENE(func_412(2));
						}
						Var0 = 13;
					}
...
void func_2(var uParam0)
{
	if (!IS_PAUSE_MENU_ACTIVE())
	{
		...
		CLEAR_SMALL_PRINTS();
		SET_WARNING_MESSAGE_WITH_HEADER("DARTS_QUIT", "DARTS_QUIT_DET", 36, 0, 0, -1, 0, 0, 1, 0);
	}
...
{
	if (!IS_ENTITY_DEAD(func_494(), 0) || iParam2)
	{
...
{
	_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_6(iParam3), 0);
}
...
int func_10(var uParam0, bool bParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (!uParam0->f_563)
	{
		switch (func_496(GET_PLAYER_PED(GET_PLAYER_INDEX())))
		{
			case 1:
...
void func_11(var uParam0, bool bParam1)
{
	...
	func_13(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 215, 1));
	func_12("ES_HELP");
	if (IS_PC_VERSION())
	{
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(1);
	...
	if (bParam1)
	{
		...
		func_13(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 216, 1));
		func_12("ES_XPAND");
		if (IS_PC_VERSION())
		{
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(1);
...
void func_15(var uParam0, float fParam1, var uParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_33();
		DRAW_RECT(0.5f, (fVar1 - (func_37((2f - 0.5f)) - 0.001388889f)), fVar6, func_28(1f), uVar13, uVar14, uVar15, ROUND((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
		...
		if (uParam0->f_556 == 4)
		{
			if (iVar17 == (uParam0->f_576 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_14((fVar11 / (0.6f * func_37(25f))), 0f, 1f);
					func_33();
					DRAW_RECT(0.5f, (fVar1 + func_37((2f * 0.5f))), fVar6, func_28(1f), uVar13, uVar14, uVar15, ROUND((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_37((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_37((25f * 0.2f)));
		...
		if (fVar11 >= 0f)
		{
			...
			switch (uParam0->f_556)
			{
				case 0:
					...
					END_TEXT_COMMAND_DISPLAY_TEXT(fVar20, (fVar1 + func_37((2f * 2f))), 0);
					break;
...
void func_25(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, var uParam5)
{
	...
	switch (uParam0->f_517[iParam1])
	{
		...
		case 1:
			...
			DRAW_SPRITE("CommonMenu", func_21(7, 0), (fParam4 - 0.006f), ((fParam2 + func_37(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, uParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 2:
			func_18(5, 0, 1, &fVar5, &fVar6, 0);
			DRAW_SPRITE("CommonMenu", func_21(5, 0), (fParam4 - 0.006f), ((fParam2 + func_37(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, uParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
		
		case 3:
			func_18(6, 0, 1, &fVar5, &fVar6, 0);
			DRAW_SPRITE("CommonMenu", func_21(6, 0), (fParam4 - 0.006f), ((fParam2 + func_37(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, uParam5, 0);
			fVar4 = (fVar4 - ((fVar5 * 0.38f) + 0.006f));
			break;
	}
...
void func_41(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (iLocal_300)
	{
		...
		if ((IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_327) && GET_SYNCHRONIZED_SCENE_PHASE(uLocal_327) >= 0.995f) || !IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_327))
		{
			bLocal_313 = true;
			if (DOES_CAM_EXIST(uLocal_333))
			{
				...
				if (!IS_PED_INJURED(uLocal_295[0]) && !IS_PED_INJURED(uLocal_295[1]))
				{
					CLEAR_PED_TASKS_IMMEDIATELY(uLocal_295[0]);
					CLEAR_PED_TASKS_IMMEDIATELY(uLocal_295[1]);
					_0x2208438012482A1A(uLocal_295[0], 0, 0);
					_0x2208438012482A1A(uLocal_295[1], 0, 0);
				}
			}
			func_106();
		}
		...
		else if (((IS_CONTROL_JUST_PRESSED(0, 234) || IS_CONTROL_JUST_PRESSED(0, 235)) && uParam0->f_248 == 1) && bVar1)
		{
			...
			if (iLocal_299)
			{
				vVar3 = { GET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iLocal_322 /*26*/], 1) };
		...
		else if (((IS_CONTROL_JUST_PRESSED(0, 211) || IS_DISABLED_CONTROL_JUST_PRESSED(0, 211)) && bVar1) && (iLocal_318 || !IS_PLAYER_ONLINE()))
		{
			uParam1->f_680 = 1;
			func_118(&(uParam1->f_509), 0, 0, 1, 1);
			func_117(&(uParam1->f_509), "DARTS_CONT", 2, 215, 1, 1, 0);
	...
	else if (!uParam0->f_457)
	{
		...
		iVar13 = func_238();
		uLocal_327 = CREATE_SYNCHRONIZED_SCENE(vVar7, vVar10, 2);
		uLocal_333 = CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
		PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_333, uLocal_327, sLocal_407[iVar13], "mini@dartsoutro");
		SET_CAM_ACTIVE(uLocal_333, 1);
		RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
		if (!IS_PED_INJURED(uLocal_295[0]) && !IS_PED_INJURED(uLocal_295[1]))
		{
			if (uParam0->f_454)
			{
				TASK_SYNCHRONIZED_SCENE(uLocal_295[0], uLocal_327, "mini@dartsoutro", sLocal_399[iVar13], 1000f, -1.5f, 0, 0, 1148846080, 0);
				TASK_SYNCHRONIZED_SCENE(uLocal_295[1], uLocal_327, "mini@dartsoutro", sLocal_403[iVar13], 1000f, -1.5f, 0, 0, 1148846080, 0);
				TASK_PLAY_ANIM(PLAYER_PED_ID(), sLocal_394, sLocal_395[GET_RANDOM_INT_IN_RANGE(0, 3)], 4f, -4f, -1, 32, 0, 0, 0, 0);
			}
			else
			{
				TASK_SYNCHRONIZED_SCENE(uLocal_295[1], uLocal_327, "mini@dartsoutro", sLocal_399[iVar13], 1000f, -1.5f, 0, 0, 1148846080, 0);
				TASK_SYNCHRONIZED_SCENE(uLocal_295[0], uLocal_327, "mini@dartsoutro", sLocal_403[iVar13], 1000f, -1.5f, 0, 0, 1148846080, 0);
				TASK_PLAY_ANIM(uLocal_295[1], sLocal_393, sLocal_395[GET_RANDOM_INT_IN_RANGE(0, 3)], 4f, -4f, -1, 32, 0, 0, 0, 0);
			}
		}
		bLocal_313 = false;
	...
	else if ((GET_GAME_TIMER() - uParam1->f_671) > 400 && func_42(uParam3, 0, 0))
	{
		if (!uParam0->f_454)
		{
...
void func_43(var uParam0)
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(2);
	func_13(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 188, 1));
	func_12("ES_HELP_TU");
	END_SCALEFORM_MOVIE_METHOD();
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
	func_13(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 187, 1));
	func_12("ES_HELP_TD");
	END_SCALEFORM_MOVIE_METHOD();
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(0);
	func_13(GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 202, 1));
	func_12("ES_HELP_AB");
	END_SCALEFORM_MOVIE_METHOD();
	BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
	END_SCALEFORM_MOVIE_METHOD();
...
void func_50(vector3 vParam0)
{
	...
	if (bLocal_133)
	{
		SET_CAM_COORD(uLocal_131, vVar0);
		SET_CAM_ACTIVE_WITH_INTERP(uLocal_131, uLocal_130, 500, 1, 1);
		bLocal_133 = false;
	}
	else
	{
		SET_CAM_COORD(uLocal_130, vVar0);
		SET_CAM_ACTIVE_WITH_INTERP(uLocal_130, uLocal_131, 500, 1, 1);
		bLocal_133 = true;
	}
}
...
void func_52(vector3 vParam0, bool bParam3, bool bParam4)
{
	...
	{
		SET_CAM_COORD(uLocal_130, vVar0);
		SET_CAM_ACTIVE_WITH_INTERP(uLocal_130, uLocal_129, 1500, 1, 1);
		SET_CAM_ACTIVE(uLocal_129, 0);
		SET_CAM_COORD(uLocal_131, vVar0);
		bLocal_133 = true;
	}
	else if (bParam4)
	{
		SET_CAM_COORD(uLocal_130, vVar0);
		SET_CAM_ACTIVE_WITH_INTERP(uLocal_130, uLocal_122, 2000, 1, 1);
		bLocal_133 = true;
	}
	else
	{
		if (bLocal_133)
		{
			SET_CAM_ACTIVE_WITH_INTERP(uLocal_129, uLocal_130, 1500, 1, 1);
		}
		else
		{
			SET_CAM_ACTIVE_WITH_INTERP(uLocal_129, uLocal_131, 1500, 1, 1);
		}
		SET_CAM_ACTIVE(uLocal_130, 0);
	}
}
...
void func_90()
{
	...
	{
		if (func_92(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
			iVar0 = func_496(PLAYER_PED_ID());
...
void func_120(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	if (!func_122(uParam0->f_1, 256) || (func_122(uParam0->f_1, 8192) && _0x6CD79468A1E595C6(2)))
	{
		...
		if (IS_PC_VERSION())
		{
			...
			SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(func_122(uParam0->f_1, 4096));
			END_SCALEFORM_MOVIE_METHOD();
		}
		iVar5 = 0;
		iVar6 = 0;
...
int func_127(var uParam0, int iParam1)
{
	...
	if (iParam1 == 188 || iParam1 == 187)
	{
		...
		if (((!IS_CONTROL_PRESSED(2, iParam1) && !IS_DISABLED_CONTROL_PRESSED(2, iParam1)) && (iVar1 < 75 && iVar1 > -75)) || func_148(&(uParam0->f_246.f_3), 250, 0))
		{
			return 1;
		}
	}
	else if ((!IS_CONTROL_PRESSED(2, iParam1) && !IS_DISABLED_CONTROL_PRESSED(2, iParam1)) || func_148(&(uParam0->f_246.f_3), 250, 0))
	{
		return 1;
	}
	return 0;
...
void func_134(struct<30> Param0, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, int iParam43, int iParam44, bool bParam45, bool bParam46)
{
	...
	switch (Param0.f_29[iParam43])
	{
		...
		case 8:
			...
			{
				BEGIN_TEXT_COMMAND_SCALEFORM_STRING(func_136(func_139(iParam44), 0));
				END_TEXT_COMMAND_SCALEFORM_STRING();
			}
			else
			{
		...
		case 16:
			if (bParam45)
			{
				...
				if (!SHOULD_USE_METRIC_MEASUREMENTS())
				{
					...
					{
						iParam44 = FLOOR(func_133(TO_FLOAT(iParam44)));
					}
					else
					{
						iParam44 = FLOOR(func_132(TO_FLOAT(iParam44)));
					}
				}
				BEGIN_TEXT_COMMAND_SCALEFORM_STRING("NUMBER");
				ADD_TEXT_COMPONENT_INTEGER(iParam44);
	...
	else if (*uParam2 == 1)
	{
		...
		else
		{
			if (Global_1835392.f_2775[iParam3] < 0)
			{
				...
				(uParam0[iParam1 /*100*/])->f_32 = { func_23(PLAYER_ID()) };
...
void func_152(var uParam0)
{
	...
	Global_1838577.f_87[iVar2 /*3*/] = { func_153(PLAYER_ID()) };
}
...
int func_171()
{
	if (IS_PAUSE_MENU_ACTIVE() && !func_193())
	{
		return 1;
	}
	return 0;
...
void func_175(var uParam0, char* sParam1, int iParam2)
{
	...
	else
	{
		...
		sParam1->f_32 = { func_23(PLAYER_ID()) };
	}
...
int func_202(var uParam0, bool bParam1)
{
	...
	if ((IS_ORBIS_VERSION() && (((iVar1 == 4 || iVar1 == 2) || iVar1 == 1) || iVar1 == 5)) || (!func_208() && NETWORK_IS_SIGNED_ONLINE()))
	{
	...
	{
		func_205(&(Global_1840924.f_3), func_207(&(Global_1840924.f_3)));
		if ((func_185(&(Global_1840924.f_49)) && !func_148(&(Global_1840924.f_49), 2000, 1)) && !NETWORK_IS_SIGNED_ONLINE())
		{
			SET_BIT(uParam0, 3);
			StringCopy(&(Global_1840924.f_3.f_1), "", 64);
			func_203(&(Global_1840924.f_3), 0);
...
int func_212(var uParam0)
{
	...
	switch (Global_1835013)
	{
		...
		case 4:
			if (NETWORK_IS_GAME_IN_PROGRESS() && func_214())
			{
				if (func_213())
				{
					Global_1835013 = 99;
...
void func_236(var uParam0)
{
	...
	{
		if (!IS_PED_INJURED((*uParam0)[0]))
		{
			func_4((*uParam0)[0], "GAME_LOSE_SELF", 1, 4);
		}
	}
	else if (!IS_PED_INJURED((*uParam0)[1]))
	{
...
void func_239(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(*uParam0, uVar0);
	BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
...
{
	SET_CAM_ACTIVE_WITH_INTERP(uLocal_122, uLocal_120, 1500, 1, 1);
	SET_CAM_ACTIVE(uLocal_123, 1);
	SET_CAM_ACTIVE_WITH_INTERP(uLocal_122, uLocal_123, 8000, 1, 1);
	ATTACH_CAM_TO_ENTITY(uLocal_125, uParam0, -0.0301f, 1.498f, 0.7435f, 1);
	POINT_CAM_AT_ENTITY(uLocal_125, uParam0, 0.0557f, -1.4905f, 0.4958f, 1);
	SET_CAM_FOV(uLocal_125, 35f);
}
...
void func_244(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	if (!IS_CAM_INTERPOLATING(uLocal_120))
	{
		bVar0 = false;
		func_325(uParam0);
		if (!bLocal_306)
		...
		if (uParam0->f_1 == 1)
		{
			if (!IS_CAM_INTERPOLATING(uLocal_129) && uParam0->f_3 == 2)
			{
				func_324(uParam3);
			}
		}
			...
			if (iLocal_30 == 0)
			{
				...
				if (((((!func_301("DARTS_SHT_USE") && !func_301("DARTS_INSTR_W")) && !func_301("DARTS_INSTR_B")) && !func_301("DARTS_AIM_HLP")) && !func_301("DARTS_STD_HLP")) && !func_301("DARTS_FST_HLP"))
				{
					if (func_3(&(uParam3->f_666), 24))
					{
						...
						SET_BIT(&(Global_106565.f_18964.f_6), uLocal_326);
	...
	while (iLocal_31 < 3 && uParam0->f_1 == 6)
	{
		...
		else if (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_24)
		{
			...
			else
			{
				...
				if (DOES_ENTITY_EXIST(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/]))
				{
					SET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/], vVar0, 1, 0, 0, 1);
				}
			}
			func_268(&(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/]), &(uParam0->f_243), 0);
			func_253(uParam0, uParam1);
			if (bLocal_307)
			{
				if (iLocal_309)
				{
					uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/] = CREATE_OBJECT(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_1, vLocal_79, 1, 1, 0);
					vVar0 = { _GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11, (uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11.f_1 + fLocal_55), uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_11.f_2) };
					SET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/], vVar0, 1, 0, 0, 1);
					uVar3 = GET_RANDOM_FLOAT_IN_RANGE(0f, 90f);
					uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_17 = { 90f, uVar3, uParam0->f_243.f_4 };
					SET_ENTITY_ROTATION(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/], uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_17, 0, 1);
					uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_23 = 1;
					uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/].f_24 = 0;
				}
			}
			...
			if (bLocal_307)
			{
				if (iLocal_309)
				{
					...
					while (iVar4 < iLocal_31 + 1)
					{
						...
						{
							uParam0->f_5[iLocal_30 /*79*/][iVar4 /*26*/] = CREATE_OBJECT(uParam0->f_5[iLocal_30 /*79*/][iVar4 /*26*/].f_1, vLocal_79, 1, 1, 0);
							...
							if (DOES_ENTITY_EXIST(uParam0->f_5[iLocal_30 /*79*/][iVar4 /*26*/]))
							{
								SET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iVar4 /*26*/], vVar0, 1, 0, 0, 1);
							}
							uVar5 = GET_RANDOM_FLOAT_IN_RANGE(0f, 90f);
							uParam0->f_5[iLocal_30 /*79*/][iVar4 /*26*/].f_17 = { 90f, uVar5, uParam0->f_243.f_4 };
							SET_ENTITY_ROTATION(uParam0->f_5[iLocal_30 /*79*/][iVar4 /*26*/], uParam0->f_5[iLocal_30 /*79*/][iVar4 /*26*/].f_17, 0, 1);
	...
	switch (uParam0->f_2)
	{
		...
		case 1:
			if (IS_CONTROL_JUST_PRESSED(2, 190))
			{
				...
				vVar0 = { GET_ENTITY_COORDS(uParam0->f_5[iLocal_30 /*79*/][iLocal_322 /*26*/], 1) };
				func_50(vVar0);
			}
		...
		case 2:
			if (IS_CONTROL_JUST_PRESSED(2, 201) || (iLocal_308 && bLocal_307))
			{
				iLocal_298 = 1;
			}
...
int func_249(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (iVar2 < 75)
	{
		...
		else if (IS_BIT_SET(uVar0, 2))
		{
			...
			else if (iVar1 < 68 && !DOES_ENTITY_EXIST(func_494()))
			{
				func_4(*uParam1, "DARTS_PLAYING_POORLY", 0, 4);
			}
			else if (iVar1 < 86)
...
void func_252()
{
	SET_CAM_ACTIVE(uLocal_129, 1);
	SET_CAM_ACTIVE(uLocal_120, 0);
}
...
void func_254(char* sParam0, int iParam1, var uParam2, int iParam3, int iParam4)
{
	...
	END_TEXT_COMMAND_PRINT(iParam3, 1);
}
...
int func_271(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (uParam0->f_2.f_1 > (uParam0->f_8.f_1 - 0.04f))
	{
		...
		SET_ENTITY_COORDS(*uParam0, vVar0, 1, 0, 0, 1);
		return 1;
	}
	...
	SET_ENTITY_ROTATION(*uParam0, uParam0->f_17, 0, 1);
	if (DOES_ENTITY_EXIST(*uParam0))
	{
		if (bParam3)
		{
...
void func_272(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (func_275())
	{
		...
		if (iParam3 == 1)
		{
			DRAW_SPRITE(sParam0, sParam1, func_274(Var0), func_273(Var0.f_1), Var0.f_2, Var0.f_3, Var0.f_8, Var0.f_4, Var0.f_5, Var0.f_6, Var0.f_7, iParam6);
		}
		else
		{
			DRAW_SPRITE(sParam0, sParam1, func_274(Var0), func_273(Var0.f_1), Var0.f_2, Var0.f_3, Var0.f_8, Var0.f_4, Var0.f_5, Var0.f_6, Var0.f_7, iParam6);
...
void func_284(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!bParam4 && uParam3->f_3 < 30)
	{
		...
		iVar6 = GET_RANDOM_INT_IN_RANGE(func_286(uParam3), 150);
		if (uParam3->f_2 > 140)
		{
	...
	else
	{
		...
		uParam0->f_24 = 1;
		func_285(uParam0);
		*uParam0 = CREATE_OBJECT(uParam0->f_1, vLocal_79, 0, 0, 0);
		uVar1 = GET_RANDOM_FLOAT_IN_RANGE(0f, 90f);
...
int func_291(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6)
{
	...
	switch (iParam6)
	{
		case 0:
			...
			{
				if (!(IS_CONTROL_JUST_PRESSED(2, 223) && iLocal_101) && !bParam4)
				{
					iLocal_98 = 1;
					iLocal_99 = 1;
					if (!iLocal_100)
...
int func_292(var uParam0)
{
	...
	uVar1 = GET_CONTROL_NORMAL(2, 220);
	uVar2 = GET_CONTROL_NORMAL(2, 221);
	iLocal_136 = ROUND(uVar2);
	switch (iLocal_135)
	{
		case 0:
			if (iLocal_136 > 120)
		...
		case 1:
			...
			else if ((iLocal_136 < 120 && iLocal_136 > -120) && (GET_GAME_TIMER() - iLocal_137) > 500)
			{
				iLocal_135 = 0;
			}
...
void func_296(var uParam0, var uParam1, bool bParam2, int iParam3)
{
	...
	GET_SCREEN_COORD_FROM_WORLD_COORD(vVar0, &Local_61, &(Local_61.f_1));
...
void func_298()
{
	...
	if (IS_CONTROL_PRESSED(2, 229))
	{
		...
		{
			iLocal_95 = 1;
			if (!IS_BIT_SET(Global_106526, 1))
			{
				func_416("DARTS_SHT_USE", -1);
				SET_BIT(&Global_106526, 1);
			}
		}
	}
	else if (bLocal_94)
...
void func_299(var uParam0, struct<4> Param1, var uParam5, var uParam6)
{
	...
	vVar0 = { 0f, 0f, 0f };
	vVar0.x = (vVar0.x + GET_RANDOM_FLOAT_IN_RANGE(-0.1f, 0.1f));
	vVar0.z = (vVar0.z + GET_RANDOM_FLOAT_IN_RANGE(-0.1f, 0.1f));
...
int func_300(var uParam0, var uParam1, bool bParam2)
{
	...
	if (DOES_ENTITY_EXIST(*uParam0))
	{
		SET_ENTITY_COORDS(*uParam0, vLocal_79, 1, 0, 0, 1);
	}
	else
	{
		*uParam0 = CREATE_OBJECT(uParam0->f_1, vLocal_79, 0, 0, 0);
	...
	uParam0->f_24 = 1;
	func_285(uParam0);
	uVar10 = GET_RANDOM_FLOAT_IN_RANGE(0f, 90f);
	...
	GET_SCREEN_COORD_FROM_WORLD_COORD(vVar0, &Local_70, &(Local_70.f_1));
	return 1;
}
...
void func_302(int iParam0, int iParam1)
{
	...
	else if (iParam0 == 2)
	{
		...
		{
			if (!IS_BIT_SET(Global_106526, 2))
			{
				func_416("DARTS_FST_HLP", -1);
				SET_BIT(&Global_106526, 2);
			}
			iLocal_96 = 1;
		}
	}
...
void func_304()
{
	SET_CAM_ACTIVE_WITH_INTERP(uLocal_120, uLocal_132, 2000, 1, 1);
	DESTROY_CAM(uLocal_132, 0);
}
...
void func_305(vector3 vParam0)
{
	...
	uLocal_132 = CREATE_CAMERA_WITH_PARAMS(26379945, vParam0, vVar0, 1115815936, 0, 2);
	SET_CAM_ACTIVE_WITH_INTERP(uLocal_132, uLocal_120, 2000, 1, 1);
}
...
int func_310(var uParam0)
{
	switch (*uParam0)
	{
		...
		case 1:
			if (IS_CONTROL_PRESSED(2, 228))
			{
				if (!IS_CAM_INTERPOLATING(uLocal_129))
				{
					func_315();
		...
		case 3:
			func_317(0);
			func_495();
			if (DOES_CAM_EXIST(uLocal_335))
			{
				if (IS_CAM_ACTIVE(uLocal_335))
				{
					SET_CAM_ACTIVE(uLocal_335, 0);
				}
				DESTROY_CAM(uLocal_335, 0);
			}
			*uParam0 = 0;
			return 0;
			break;
...
void func_317(bool bParam0)
{
	if (bParam0)
	{
		SET_CAM_ACTIVE_WITH_INTERP(uLocal_129, uLocal_120, 1000, 1, 1);
	}
	else
	{
		SET_CAM_ACTIVE_WITH_INTERP(uLocal_120, uLocal_129, 1000, 1, 1);
	}
}
...
void func_321(var uParam0)
{
	...
	{
		if ((IS_CONTROL_PRESSED(2, 201) || IS_CONTROL_JUST_PRESSED(2, 223)) && iLocal_99)
		{
			*uParam0 = 6;
		}
	}
...
int func_330(int iParam0, var uParam1)
{
	if (iParam0 >= 10)
	{
		if (!IS_BIT_SET(Global_106565.f_18964.f_6, 12))
		{
			*uParam1 = 12;
			return 1;
		}
...
{
	DISPLAY_RADAR(0);
	if (IS_CAM_ACTIVE(uLocal_122))
	{
		SET_CAM_ACTIVE(uLocal_122, 0);
	}
	if (IS_CAM_ACTIVE(uLocal_126))
	{
		SET_CAM_ACTIVE(uLocal_126, 0);
	}
	if (IS_SCREEN_FADED_OUT())
	{
		func_334();
...
int func_342(var uParam0, var uParam1, var uParam2)
{
	...
	if (!func_3(&(uParam0->f_666), 7))
	{
		...
		if (func_397())
		{
			...
			Global_4268041 = GET_GAME_TIMER() + 300;
		}
		else if (func_394() && GET_GAME_TIMER() > Global_4268041)
		{
			if (Global_4268040 == uParam0->f_660)
			{
				iVar2 = func_393(0);
		...
		if (IS_CONTROL_JUST_RELEASED(2, 202) || func_344())
		{
			func_343(0, 0);
			func_329(&(uParam0->f_666), 8, 0);
		...
		if (iVar5 == 1 && Global_17411.f_5728)
		{
			...
			if (GET_HASH_KEY(&(Global_17411.f_4690)) != 0 && Global_17411.f_4766 != -1)
			{
				...
				if (Global_17411.f_4768 != 0)
				{
					...
					DRAW_SPRITE(func_24(Global_17411.f_4768), func_21(Global_17411.f_4768, 1), ((Global_17408 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
				}
			...
			if (GET_HASH_KEY(&(Global_4267964.f_21)) != 0 && Global_4267964.f_65 != -1)
			{
				...
				if (Global_4267964.f_67 != 0)
				{
					...
					DRAW_SPRITE(func_24(Global_4267964.f_67), func_21(Global_4267964.f_67, 1), ((Global_17408 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
				}
				fVar51 = (fVar51 + (((_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
								...
								if (bVar33)
								{
									...
									if (bVar54)
									{
										if (func_18(26, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_18(26, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													DRAW_SPRITE(func_24(26), func_21(26, 1), ((fVar34 + fVar42) + fVar45), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
												}
											}
										}
										if (func_18(27, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											if (func_18(27, 1, 1, &fVar36, &fVar37, bParam7))
											{
												...
												if (iVar5 == 1)
												{
													DRAW_SPRITE(func_24(27), func_21(27, 1), (((fVar34 + fVar42) + fVar45) + (fVar43 + fVar44)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
												}
											}
										}
									}
												...
												if (func_18(Global_17411.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (func_18(Global_17411.f_4433[(iVar22 + iVar28)], bVar32, 1, &fVar36, &fVar37, bParam7))
													{
														...
														if (iVar5 == 1)
														{
															if (Global_17411.f_5083[iVar8] == 2)
															{
																DRAW_SPRITE(func_24(Global_17411.f_4433[(iVar22 + iVar28)]), func_21(Global_17411.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar42) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
															else
															{
																DRAW_SPRITE(func_24(Global_17411.f_4433[(iVar22 + iVar28)]), func_21(Global_17411.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar42) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
														}
									...
									if (GET_HASH_KEY(&(Global_17411.f_73[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										else
										{
											...
											if (func_349() && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (iVar8 == 0)
												{
												...
												if (func_18(Global_17411.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														if (func_18(Global_17411.f_4433[(iVar22 + iVar14)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															...
															{
																DRAW_SPRITE(func_24(Global_17411.f_4433[(iVar22 + iVar14)]), func_21(Global_17411.f_4433[(iVar22 + iVar14)], bVar32), (Global_17408 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
															else if (Global_17411.f_5083[iVar8] == 2)
															{
																DRAW_SPRITE(func_24(Global_17411.f_4433[(iVar22 + iVar14)]), func_21(Global_17411.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar42) + fVar43) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
															else
															{
																DRAW_SPRITE(func_24(Global_17411.f_4433[(iVar22 + iVar14)]), func_21(Global_17411.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar42) + fVar43) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
														}
													}
									...
									if (func_18(Global_17411.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											if (func_18(Global_17411.f_4433[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												...
												DRAW_SPRITE(func_24(Global_17411.f_4433[iVar22]), func_21(Global_17411.f_4433[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), (fVar36 * func_346(Global_17411.f_4433[iVar22])), (fVar37 * func_346(Global_17411.f_4433[iVar22])), 0f, uVar47, uVar48, uVar49, uVar50, 0);
											}
										}
									}
								}
...
int func_368(bool bParam0, bool bParam1)
{
	...
	if ((((((((!IS_SCREEN_FADED_IN() || (func_370(8, -1) && func_369() != 64)) || (GET_PAUSE_MENU_STATE() != 0 && !bParam1)) || (IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0)) || SET_STORE_ENABLED()) || Global_71850) || Global_17411.f_8352) || IS_WARNING_MESSAGE_ACTIVE()) || Global_93734.f_1409)
	{
		return 0;
	}
	return 1;
...
int func_405(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	...
	if ((func_428() && GET_GAME_TIMER() >= iLocal_323 + 1000) && *iParam0 != 8)
	{
		if (!IS_SCREEN_FADED_OUT() && !IS_SCREEN_FADING_OUT())
		{
			DO_SCREEN_FADE_OUT(500);
	...
	switch (*iParam0)
	{
		...
		case 3:
			...
			{
				case 0:
					if (!IS_CAM_INTERPOLATING(uLocal_128))
					{
						if (*uParam3 == 2)
						{
							*uParam2 = 20;
		...
		case 4:
			...
			{
				case 0:
					if (!IS_CAM_INTERPOLATING(uLocal_127))
					{
						if (*uParam3 == 2)
						{
							*uParam2 = 50;
		...
		case 5:
			if (!IS_CAM_INTERPOLATING(uLocal_128) && !func_301("DARTS_DBL_WIN"))
			{
		...
		case 6:
			PLAY_SOUND_FRONTEND(-1, "CAM_PAN_DARTS", "HUD_MINI_GAME_SOUNDSET", 1);
			SET_CAM_ACTIVE_WITH_INTERP(uLocal_120, uLocal_128, 1500, 1, 1);
			*iParam0 = 7;
			break;
...
{
	STOP_CAM_POINTING(uLocal_128);
	SET_CAM_FOV(uLocal_128, 35f);
	SET_CAM_COORD(uLocal_128, _GET_OBJECT_OFFSET_FROM_COORDS(vParam0, uParam3, vParam4));
	SET_CAM_ROT(uLocal_128, Vector(uParam3, 0f, 0f) - vParam7, 2);
	SET_CAM_ACTIVE_WITH_INTERP(uLocal_128, uLocal_127, iParam10, 1, 1);
}
...
void func_409(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	...
	ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(sParam1);
	END_TEXT_COMMAND_SCALEFORM_STRING();
	if (!IS_STRING_NULL_OR_EMPTY(iParam2))
	{
		func_12(iParam2);
	}
	if (bParam6)
	...
	if (bParam6)
	{
		...
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(iParam7);
		END_SCALEFORM_MOVIE_METHOD();
	}
	func_432(&(uParam0->f_2));
	uParam0->f_1 = iParam3;
...
void func_411()
{
	SET_CAM_ACTIVE(uLocal_120, 1);
	RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
	if (IS_CAM_ACTIVE(uLocal_127))
	{
		SET_CAM_ACTIVE(uLocal_127, 0);
	}
	if (IS_CAM_ACTIVE(uLocal_122))
	{
		SET_CAM_ACTIVE(uLocal_122, 0);
	}
	if (IS_CAM_ACTIVE(uLocal_123))
	{
		SET_CAM_ACTIVE(uLocal_123, 0);
	}
	if (IS_CAM_ACTIVE(uLocal_124))
	{
		SET_CAM_ACTIVE(uLocal_124, 0);
	}
	if (IS_CAM_ACTIVE(uLocal_125))
	{
		SET_CAM_ACTIVE(uLocal_125, 0);
	}
	if (IS_CAM_ACTIVE(uLocal_126))
	{
		SET_CAM_ACTIVE(uLocal_126, 0);
...
{
	STOP_CAM_POINTING(uLocal_127);
	SET_CAM_FOV(uLocal_127, 35f);
	SET_CAM_COORD(uLocal_127, _GET_OBJECT_OFFSET_FROM_COORDS(vParam0, uParam3, vParam4));
	SET_CAM_ROT(uLocal_127, Vector(uParam3, 0f, 0f) - vParam7, 2);
	if (bParam11)
	{
		SET_CAM_ACTIVE(uLocal_127, 1);
	}
	else
	{
		SET_CAM_ACTIVE_WITH_INTERP(uLocal_127, uLocal_128, iParam10, 1, 1);
	}
}
...
{
	_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_6(iParam2), 1);
}
...
int func_429(var uParam0)
{
	...
	if (DOES_ENTITY_EXIST(uVar0))
	{
		if (!func_430(uVar0))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()) && IS_ENTITY_AT_ENTITY(uVar0, PLAYER_PED_ID(), vLocal_292, 0, 1, 0))
			{
...
void func_436(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8)
{
	...
	if (DOES_ENTITY_EXIST(func_494()) && !IS_PED_INJURED(func_494()))
	{
		REMOVE_PED_FROM_GROUP(func_494());
	}
	else
	{
		if (DOES_ENTITY_EXIST(uParam8->f_5) && !IS_PED_INJURED(uParam8->f_5))
		{
			SET_ENTITY_AS_MISSION_ENTITY(uParam8->f_5, 1, 1);
		...
		{
			uLocal_295[1] = CREATE_PED(26, iLocal_331, Param1.f_3, uParam0, 1, 1);
		}
		if (DECOR_EXIST_ON(uLocal_295[1], "Darts_name"))
		{
			iVar0 = DECOR_GET_INT(uLocal_295[1], "Darts_name");
			if (954610991 == iVar0)
			{
				sLocal_391 = func_441("RAYMOND");
				iLocal_392 = 954610991;
		...
		DECOR_SET_INT(uLocal_295[1], "Darts_name", iLocal_392);
	}
	iVar1 = GET_ENTITY_MODEL(uLocal_295[1]);
	func_437(iVar1);
	TASK_TURN_PED_TO_FACE_ENTITY(uLocal_295[1], uLocal_295[0], 0);
	TASK_TURN_PED_TO_FACE_ENTITY(uLocal_295[0], uLocal_295[1], 0);
}
...
int func_438(var uParam0)
{
	...
	while (iVar0 < GET_PED_NEARBY_PEDS(PLAYER_PED_ID(), uParam0, -1))
	{
		if (!IS_PED_INJURED((*uParam0)[iVar0]))
		{
			...
			{
				SET_ENTITY_AS_MISSION_ENTITY((*uParam0)[iVar0], 1, 1);
...
{
	if (!REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\DARTS", 0, -1))
	{
		return 0;
	}
	if (!REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\FAMILY1_2", 0, -1))
	{
		return 0;
	}
	if ((((((((((((!HAS_MODEL_LOADED(iLocal_28) || !HAS_MODEL_LOADED(iLocal_29)) || !HAS_MODEL_LOADED(iLocal_60)) || !HAS_MODEL_LOADED(iLocal_331)) || !HAS_SCALEFORM_MOVIE_LOADED(*uParam0)) || !HAS_SCALEFORM_MOVIE_LOADED(uParam1->f_645)) || !HAS_SCALEFORM_MOVIE_LOADED(uParam1->f_57)) || !HAS_SCALEFORM_MOVIE_LOADED(uParam1->f_62)) || !HAS_ADDITIONAL_TEXT_LOADED(3)) || !HAS_STREAMED_TEXTURE_DICT_LOADED("Darts")) || !HAS_ANIM_DICT_LOADED(sLocal_393)) || !HAS_ANIM_DICT_LOADED(sLocal_394)) || !func_446(0, -1, 0))
	{
		return 0;
	}
	return 1;
...
void func_448(var uParam0, var uParam1)
{
	...
	REQUEST_MODEL(iLocal_331);
	REQUEST_STREAMED_TEXTURE_DICT("Darts", 0);
	REQUEST_STREAMED_TEXTURE_DICT("ShopUI_Title_Darts", 0);
	REQUEST_ANIM_DICT(sLocal_393);
	REQUEST_ANIM_DICT(sLocal_394);
...
void func_456(vector3 vParam0, float fParam3)
{
	...
	uLocal_120 = CREATE_CAMERA_WITH_PARAMS(26379945, vVar0, vVar6, fVar21, 0, 2);
	uLocal_121 = CREATE_CAMERA_WITH_PARAMS(26379945, vVar3, vVar9, fVar21, 0, 2);
	uLocal_122 = CREATE_CAMERA_WITH_PARAMS(26379945, vVar12, vVar15, 1115815936, 0, 2);
	uLocal_123 = CREATE_CAMERA_WITH_PARAMS(26379945, vVar35, vVar18, 1115815936, 0, 2);
	uLocal_124 = CREATE_CAMERA_WITH_PARAMS(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 1115815936, 0, 2);
	uLocal_125 = CREATE_CAMERA_WITH_PARAMS(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 1115815936, 0, 2);
	uLocal_127 = CREATE_CAMERA_WITH_PARAMS(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 1115815936, 0, 2);
	uLocal_128 = CREATE_CAMERA_WITH_PARAMS(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 1115815936, 0, 2);
	uLocal_126 = CREATE_CAMERA_WITH_PARAMS(26379945, 1996.235f, 3048.456f, 48.0237f, -3.4831f, 0.0223f, 60.6925f, 38.1f, 0, 2);
	SET_CAM_FOV(uLocal_122, 43.35f);
	SET_CAM_FOV(uLocal_123, 42.35f);
	SHAKE_CAM(uLocal_122, "HAND_SHAKE", 0.1f);
	SHAKE_CAM(uLocal_123, "HAND_SHAKE", 0.1f);
}
...
void func_465(int iParam0, var uParam1, var uParam2)
{
	...
	if (!IS_ENTITY_DEAD(func_494(), 0))
	{
		SET_PED_AS_GROUP_MEMBER(func_494(), func_477());
...
void func_470()
{
	...
	if (!DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_71590)
		{
			if (func_471() == 2 == 0 && !NETWORK_IS_GAME_IN_PROGRESS())
			{
...
void func_473(var uParam0)
{
	...
	if (!Global_71858)
	{
		if (!IS_PLAYER_DEAD(GET_PLAYER_INDEX()))
		{
			if (!Global_71859)
			{
				if (IS_SCREEN_FADED_OUT() && !func_468(0))
				{
...
void func_474(var uParam0)
{
	if (DOES_ENTITY_EXIST(*uParam0) && !IS_PED_INJURED(*uParam0))
	{
		CLEAR_SEQUENCE_TASK(&uLocal_332);
		OPEN_SEQUENCE_TASK(&uLocal_332);
		if (DOES_ENTITY_EXIST(uLocal_295[0]))
		{
			TASK_LOOK_AT_ENTITY(0, uLocal_295[0], 8000, 2049, 3);
		}
		...
		if (bLocal_310)
		{
			if (!IS_BIT_SET(Global_106526, 10))
			{
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_475(iLocal_334 == 2, vLocal_375, vLocal_381), 1f, 20000, 0.25f, 0, func_121(iLocal_334 == 2, fLocal_385, fLocal_387));
			}
			else
			{
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_475(iLocal_334 == 2, vLocal_372, vLocal_378), 1f, 20000, 0.25f, 0, func_121(iLocal_334 == 2, fLocal_384, fLocal_386));
			}
			TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
		}
		else
		{
			TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_475(iLocal_334 == 2, vLocal_372, vLocal_378), 1f, 20000, 0.25f, 0, func_121(iLocal_334 == 2, 172.6813f, 142.6717f));
			TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_STAND_IMPATIENT", 0, 1);
		}
		CLOSE_SEQUENCE_TASK(uLocal_332);
		TASK_PERFORM_SEQUENCE(*uParam0, uLocal_332);
		SET_PED_KEEP_TASK(*uParam0, 1);
	}
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_331);
}
...
void func_481()
{
	if (DOES_ENTITY_EXIST(uLocal_59))
	{
		DELETE_OBJECT(&uLocal_59);
	}
}
...
{
	if (IS_PED_INJURED(func_494()))
	{
		return;
	}
	if (bParam1)
	{
		if (!IS_PED_GROUP_MEMBER(func_494(), func_477()))
		{
			return;
		}
		if (!IS_PED_INJURED(func_493()))
		{
			if (!IS_PED_GROUP_MEMBER(func_493(), func_477()))
			{
				return;
			}
		}
