...
int func_2()
{
	...
	if (iVar1 < 0)
	{
		if (!IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			...
			while (iVar2 < 4)
			{
				if (DOES_ENTITY_EXIST(uLocal_451[iVar2]))
				{
					if (!IS_PED_INJURED(uLocal_451[iVar2]))
					{
	...
	if (!IS_STRING_NULL_OR_EMPTY(&Local_507))
	{
		...
		fVar3 = VDIST2(GET_ENTITY_COORDS(uLocal_451[iVar1], 0), GET_ENTITY_COORDS(PLAYER_PED_ID(), 0));
...
int func_3(char[4] cParam0, var uParam1, int iParam2)
{
	...
	if (!DOES_ENTITY_EXIST(uLocal_451[*iParam2]))
	{
		*iParam2 = -1;
		return 0;
	}
	fVar5 = VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(uLocal_451[*iParam2], 0));
	if (fVar5 > (30f * 30f))
	{
		if (fVar5 > (150f * 150f))
		{
	...
	func_24(&uLocal_273, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
...
void func_34(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_60(uParam1) && IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
...
int func_39(char* sParam0)
{
	if (!func_40(1, 1, 0))
	{
		if ((!IS_STRING_NULL_OR_EMPTY(sParam0) && func_62(sParam0)) || func_62("CMN_HINT"))
		{
			CLEAR_HELP(1);
		}
		return 0;
...
int func_40(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_48() || func_47(Global_4456448.f_161209)) || func_46())
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			iVar1 = func_45(PLAYER_PED_ID(), 0);
			if (((_0xE33FFA906CE74880(uVar0, iVar1) || (GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_44(uVar0, 10)) && GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_41(int iParam0)
{
	if (iParam0 != func_43())
	{
		...
		else if ((Global_1312867 && iParam0 == PLAYER_ID()) && func_42(iParam0, 1, 0))
		{
			return Global_2424047[iParam0 /*416*/].f_309.f_5 != -1;
		}
	}
...
int func_55(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_58(bParam1, bParam2, bParam3) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1) || func_56(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
int func_64(int iParam0, int iParam1)
{
	...
	switch (iLocal_529[iParam0])
	{
		case 0:
			...
			if (fLocal_506 >= 0f)
			{
				if (IS_VEHICLE_DRIVEABLE(uLocal_462[iParam0], 0))
				{
					if (!IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_462[iParam0]))
					{
						START_PLAYBACK_RECORDED_VEHICLE(uLocal_462[iParam0], iLocal_500[iParam0], &Local_496, 1);
					}
					else if (IS_PLAYER_SWITCH_IN_PROGRESS())
					{
						if (GET_PLAYER_SWITCH_STATE() == 8 && _0x78C0D93253149435() == 0)
						{
							SKIP_TIME_IN_PLAYBACK_RECORDED_VEHICLE(uLocal_462[iParam0], (fLocal_506 - GET_TIME_POSITION_IN_RECORDING(uLocal_462[iParam0])));
		...
		case 1:
			...
			if (!IS_PED_SITTING_IN_VEHICLE(uLocal_451[iParam0], uLocal_462[iParam0]))
			{
			...
			if (IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_462[iParam0]))
			{
				...
				if (!IS_ENTITY_DEAD(uVar0, 0) && IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uVar0))
				{
				...
				{
					bVar1 = false;
					if (!GET_PED_TYPE(uLocal_451[iParam0]) == 6)
					{
						func_65(uLocal_462[iParam0], PLAYER_PED_ID(), &(fLocal_534[iParam0]), 17.5f, 7.5f, 30f, 0.7f, 1.2f, 1f, bVar1);
					}
					else
					{
						fLocal_534[iParam0] = 1f;
						fVar2 = GET_ENTITY_SPEED(PLAYER_PED_ID());
						fVar3 = GET_ENTITY_SPEED(uLocal_462[iParam0]);
						fLocal_534[iParam0] = 1f;
						if (fVar3 > fVar2)
						{
				...
				{
					STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_462[iParam0]);
					return 0;
				}
				SET_PLAYBACK_SPEED(uLocal_462[iParam0], fLocal_534[iParam0]);
				fVar4 = (GET_TIME_POSITION_IN_RECORDING(uLocal_462[iParam0]) / GET_TOTAL_DURATION_OF_VEHICLE_RECORDING(iLocal_500[iParam0], &Local_496));
				if (!IS_PLAYBACK_USING_AI_GOING_ON_FOR_VEHICLE(uLocal_462[iParam0]))
				{
					if (!GET_PED_TYPE(uLocal_451[iParam0]) == 6)
					{
						if (IS_AREA_OCCUPIED(GET_ENTITY_COORDS(uLocal_462[iParam0], 1) - Vector(1f, 1f, 1f), GET_ENTITY_COORDS(uLocal_462[iParam0], 1) + Vector(1f, 1f, 1f), 0, 1, 0, 0, 0, 0, 0))
						{
							SET_PLAYBACK_TO_USE_AI(uLocal_462[iParam0], iLocal_270);
						}
					}
					else
					{
				...
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_451[iParam0], PLAYER_PED_ID(), 1) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_462[iParam0], PLAYER_PED_ID(), 1))
				{
					STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_462[iParam0]);
					return 0;
				}
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uLocal_462[iParam0]))
				{
					STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_462[iParam0]);
					return 0;
				}
			...
			{
				CLEAR_PED_TASKS(uLocal_451[iParam0]);
				if (!GET_PED_TYPE(uLocal_451[iParam0]) == 6)
				{
					TASK_VEHICLE_DRIVE_WANDER(uLocal_451[iParam0], uLocal_462[iParam0], fLocal_269, iLocal_270);
					SET_PED_KEEP_TASK(uLocal_451[iParam0], 1);
					if (iLocal_272 == 281)
					{
						SET_VEHICLE_ENGINE_HEALTH(uLocal_462[iParam0], 0f);
					}
					iLocal_529[iParam0] = 2;
				}
				else
				{
					TASK_COMBAT_PED(uLocal_451[iParam0], PLAYER_PED_ID(), 0, 16);
					SET_PED_COMBAT_ATTRIBUTES(uLocal_451[iParam0], 1, 1);
					SET_PED_KEEP_TASK(uLocal_451[iParam0], 1);
					_0xDC64D2C53493ED12(PLAYER_ID());
					_0xBC9490CA15AEA8FB(PLAYER_ID());
		...
		case 2:
			...
			if (IS_PED_SITTING_IN_VEHICLE(uLocal_451[iParam0], uLocal_462[iParam0]))
			{
				if (GET_SCRIPT_TASK_STATUS(uLocal_451[iParam0], -258271821) != 1)
				{
					TASK_VEHICLE_DRIVE_WANDER(uLocal_451[iParam0], uLocal_462[iParam0], fLocal_269, iLocal_270);
				}
				else
				{
					SET_DRIVE_TASK_CRUISE_SPEED(uLocal_451[iParam0], fLocal_269);
				}
			}
			else
			{
		...
		case 3:
			...
			if (GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) <= 0)
			{
				...
				{
					CLEAR_PED_TASKS(uLocal_451[iParam0]);
					SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_451[iParam0]));
					return 0;
				}
			}
			break;
		...
		case 4:
			if (IS_PED_INJURED(uLocal_451[iParam0]))
			{
				iLocal_529[iParam0] = -1;
				return 0;
			}
			...
			if (!IS_PED_SITTING_IN_VEHICLE(uLocal_451[iParam0], uLocal_462[iParam0]))
			{
				if (!IS_PED_GETTING_INTO_A_VEHICLE(uLocal_451[iParam0]))
				{
					TASK_ENTER_VEHICLE(uLocal_451[iParam0], uLocal_462[iParam0], 20000, -1, 1073741824, 1, 0);
				}
			}
			else
			{
		...
		case -2:
			if (!IS_PED_INJURED(uLocal_451[iParam0]))
			{
				if (GET_SCRIPT_TASK_STATUS(uLocal_451[iParam0], 1805844857) != 1)
				{
					SET_PED_CONFIG_FLAG(uLocal_451[iParam0], 29, 1);
					TASK_SMART_FLEE_PED(uLocal_451[iParam0], PLAYER_PED_ID(), 150f, -1, 0, 0);
				}
			}
			else
			{
				...
				if (!IS_ENTITY_DEAD(uVar9, 0))
				{
					...
					if (IS_THIS_MODEL_A_CAR(uVar10) || IS_THIS_MODEL_A_BIKE(uVar10))
					{
						if (IS_VEHICLE_DRIVEABLE(uVar9, 0))
						{
							...
							SET_AIR_DRAG_MULTIPLIER_FOR_PLAYERS_VEHICLE(PLAYER_ID(), fLocal_145);
						}
					}
				}
			}
...
int func_75()
{
	...
	if (!IS_ENTITY_DEAD(uVar0, 0))
	{
		...
		else
		{
			...
			while (iVar1 < 4)
			{
				if (IS_VEHICLE_DRIVEABLE(uLocal_462[iVar1], 0) && !IS_PED_INJURED(uLocal_451[iVar1]))
				{
					if (!IS_STRING_NULL_OR_EMPTY(&Local_496) && iLocal_500[iVar1] > 0)
					{
						START_PLAYBACK_RECORDED_VEHICLE(uLocal_462[iVar1], iLocal_500[iVar1], &Local_496, 1);
						SKIP_TIME_IN_PLAYBACK_RECORDED_VEHICLE(uLocal_462[iVar1], uLocal_505);
						TASK_VEHICLE_MISSION(uLocal_451[iVar1], uLocal_462[iVar1], 0, 15, 20f, iLocal_270, 0.5f, 2f, 1);
						if (GET_PED_TYPE(uLocal_451[iVar1]) == 6)
						{
							SET_VEHICLE_SIREN(uLocal_462[iVar1], 1);
						}
					}
				}
				iVar1++;
...
void func_84()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < 4)
		{
			...
			{
				REQUEST_MODEL(iLocal_456[iVar0]);
				if (!HAS_MODEL_LOADED(iLocal_456[iVar0]))
				{
					REQUEST_MODEL(iLocal_456[iVar0]);
					bVar2 = false;
				}
			...
			{
				REQUEST_MODEL(iLocal_467[iVar0]);
				if (!HAS_MODEL_LOADED(iLocal_467[iVar0]))
				{
					REQUEST_MODEL(iLocal_467[iVar0]);
					bVar2 = false;
				}
			}
			if (!IS_STRING_NULL_OR_EMPTY(&Local_496) && iLocal_500[iVar0] > 0)
			{
				REQUEST_VEHICLE_RECORDING(iLocal_500[iVar0], &Local_496);
				if (!HAS_VEHICLE_RECORDING_BEEN_LOADED(iLocal_500[iVar0], &Local_496))
				{
					REQUEST_VEHICLE_RECORDING(iLocal_500[iVar0], &Local_496);
					bVar2 = false;
				}
	...
	ADD_RELATIONSHIP_GROUP("chasecar", &uLocal_491);
	SET_RELATIONSHIP_BETWEEN_GROUPS(3, uLocal_491, 1862763509);
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (iLocal_467[iVar0] != 0)
		{
			CLEAR_AREA(vLocal_492 + vLocal_472[iVar0 /*3*/], 20f, 1, 0, 0, 0);
			uLocal_462[iVar0] = CREATE_VEHICLE(iLocal_467[iVar0], vLocal_492 + vLocal_472[iVar0 /*3*/], (fLocal_495 + fLocal_485[iVar0]), 1, 1, 0);
			SET_VEHICLE_COLOUR_COMBINATION(uLocal_462[iVar0], iLocal_490);
			SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_467[iVar0]);
			_SET_ENTITY_SOMETHING(uLocal_462[iVar0], 1);
		}
		if (iLocal_456[iVar0] != 0)
		{
			uLocal_451[iVar0] = CREATE_PED_INSIDE_VEHICLE(uLocal_462[iVar0], iLocal_461, iLocal_456[iVar0], -1, 1, 1);
			SET_PED_RANDOM_COMPONENT_VARIATION(uLocal_451[iVar0], 0);
			SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_456[iVar0]);
			SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_451[iVar0], uLocal_491);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_451[iVar0], 1);
			if (iLocal_456[iVar0] == joaat("a_m_y_roadcyc_01"))
			{
				SET_PED_HELMET(uLocal_451[iVar0], 1);
			}
			if (iLocal_461 != 6)
			{
				SET_PED_COMBAT_MOVEMENT(uLocal_451[iVar0], 3);
				SET_PED_COMBAT_ATTRIBUTES(uLocal_451[iVar0], 17, 1);
				SET_PED_FLEE_ATTRIBUTES(uLocal_451[iVar0], 1, 1);
				SET_PED_FLEE_ATTRIBUTES(uLocal_451[iVar0], 2, 1);
			}
		}
		iVar0++;
	}
...
void func_85()
{
	...
	switch (iLocal_272)
	{
		...
		case 275:
			...
			fLocal_485[1] = GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
			fLocal_485[2] = GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
			fLocal_485[3] = GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
		...
		case 277:
			...
			fLocal_485[0] = GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
			fLocal_485[1] = GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
			fLocal_485[2] = GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
			fLocal_485[3] = GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
			iLocal_456[0] = joaat("s_m_y_ranger_01");
		...
		default:
			fVar12 = ((fLocal_495 + 90f) + GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f));
			vLocal_472[0 /*3*/] = { Vector(0f, COS(fVar12), SIN(fVar12)) * FtoV(GET_RANDOM_FLOAT_IN_RANGE(15f, 25f)) };
			fLocal_485[0] = GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
			iLocal_490 = 0;
			iLocal_456[0] = joaat("a_m_y_genstreet_01");
			iLocal_456[1] = 0;
...
void func_94()
{
	...
	while (iVar0 < 4)
	{
		SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_451[iVar0]));
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uLocal_462[iVar0]));
		if (iLocal_456[iVar0] != 0)
		{
			SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_456[iVar0]);
		}
		...
		if (!IS_STRING_NULL_OR_EMPTY(&Local_496) && iLocal_500[iVar0] > 0)
		{
			REMOVE_VEHICLE_RECORDING(iLocal_500[iVar0], &Local_496);
		}
		iVar0++;
	}
	func_63(&uLocal_438, 0, 0);
