...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_24(AUDIO::_0x0626A247D2405330()))
	{
	...
	while (true)
	{
		...
		if (func_2(AUDIO::_0x0626A247D2405330(), vLocal_50, 1) > 70f)
		{
			func_1(&iLocal_40, 0);
			func_1(&iLocal_41, 0);
			func_1(&iLocal_42, 0);
...
int func_3()//Position - 0x24E
{
	...
	if (((((func_10(AUDIO::_0x0626A247D2405330()) && func_10(iLocal_43)) && !func_9()) && MISC::GET_GAME_TIMER() > iLocal_46) && func_8(AUDIO::_0x0626A247D2405330(), iLocal_43, 1) < 20f) && !MISC::GET_MISSION_FLAG())
	{
		uVar0 = 16;
...
{
	if (FIRE::IS_EXPLOSION_IN_SPHERE(4294967295, vLocal_50, 5f))
	{
...
void func_12()//Position - 0x561
{
	if (func_10(iLocal_43))
	{
		...
		ENTITY::SET_ENTITY_HEALTH(iLocal_43, true);
		...
		unk_0x346478B12F69D4E3(iLocal_43, true);
		BRAIN::TASK_PLAY_ANIM(iLocal_43, sLocal_44, sLocal_45, 8f, -8f, 4294967295, 9, 0, 0, 0, 0);
		BRAIN::TASK_LOOK_AT_ENTITY(iLocal_43, AUDIO::_0x0626A247D2405330(), 4294967295, 0, 2);
	}
}
