...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_113(vLocal_221, 4294967295, 0, 0, 0))
	{
		func_110(4294967295);
	}
	else
	...
	while (iVar0 != 7)
	{
		...
		switch (iVar0)
		{
			...
			case 4:
				...
				ENTITY::SET_ENTITY_HEALTH(iVar12, true);
				...
				if (func_82() == 0)
				{
					func_81(&uLocal_53, 0, AUDIO::_0x0626A247D2405330(), "MICHAEL", 0, 1);
				}
				else if (func_82() == 1)
				{
					func_81(&uLocal_53, 0, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
				}
				else if (func_82() == 2)
				{
					func_81(&uLocal_53, 0, AUDIO::_0x0626A247D2405330(), "TREVOR", 0, 1);
				}
				func_81(&uLocal_53, 3, iVar12, "REGIFemale", 0, 1);
				func_81(&uLocal_53, 4, iVar11[2], "REGIMale", 0, 1);
				BRAIN::TASK_PLAY_ANIM(iVar12, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 2f, -2f, 4294967295, 49, 0, 0, 0, 0);
				...
				while (iVar14 <= (iLocal_49 - 1))
				{
					if (!ENTITY::DOES_ENTITY_EXIST(iVar11[iVar14]))
					{
						...
						ENTITY::SET_ENTITY_HEALTH(iVar11[iVar14], true);
						...
						WEAPON::GIVE_WEAPON_TO_PED(iVar11[iVar14], func_80(), 4294967295, true, true);
				...
				{
					BRAIN::TASK_SYNCHRONIZED_SCENE(iVar11[0], iLocal_50, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
				}
				if (!PED::IS_PED_INJURED(iVar11[1]))
				{
					BRAIN::TASK_SYNCHRONIZED_SCENE(iVar11[1], iLocal_50, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_c", 4f, -4f, 17, 0, 1148846080, 0);
				}
				if (!PED::IS_PED_INJURED(iVar11[2]))
				{
					BRAIN::TASK_SYNCHRONIZED_SCENE(iVar11[2], iLocal_50, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
				}
			...
			case 5:
					...
					if ((((((((func_73(&iVar11, &uVar6, &uVar5, &uVar4, iVar3, bVar7, 1075838976, 0) || func_72(iVar11[0], 0)) || func_72(iVar11[1], 0)) || func_72(iVar11[2], 0)) || MISC::IS_BULLET_IN_AREA(vLocal_222[0 /*3*/], 40f, 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(vLocal_222[0 /*3*/] - Vector(25f, 25f, 25f), vLocal_222[0 /*3*/] + Vector(25f, 25f, 25f), joaat("weapon_smokegrenade"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(vLocal_222[0 /*3*/] - Vector(25f, 25f, 25f), vLocal_222[0 /*3*/] + Vector(25f, 25f, 25f), joaat("weapon_grenade"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(vLocal_222[0 /*3*/] - Vector(25f, 25f, 25f), vLocal_222[0 /*3*/] + Vector(25f, 25f, 25f), joaat("weapon_grenadelauncher"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(vLocal_222[0 /*3*/] - Vector(25f, 25f, 25f), vLocal_222[0 /*3*/] + Vector(25f, 25f, 25f), joaat("weapon_stickybomb"), 1))
					{
						...
						while (iVar15 < iVar11)
						{
							if (!PED::IS_PED_INJURED(iVar11[iVar15]))
							{
								...
								if (!PED::IS_PED_INJURED(iVar11[iVar15]))
								{
									NETWORK::_0x5E3AA4CA2B6FB0EE(iVar11[iVar15]);
									BRAIN::OPEN_SEQUENCE_TASK(&iLocal_48);
									BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 1000, 2048, 2);
									BRAIN::TASK_SMART_FLEE_PED(0, AUDIO::_0x0626A247D2405330(), 200f, 4294967295, 0, 0);
									CUTSCENE::_0x8D9DF6ECA8768583(iLocal_48);
									BRAIN::TASK_PERFORM_SEQUENCE(iVar11[iVar15], iLocal_48);
						...
						if (!PED::IS_PED_INJURED(iVar12))
						{
							if (!PED::IS_PED_INJURED(iVar12))
							{
								NETWORK::_0x5E3AA4CA2B6FB0EE(iVar12);
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_48);
								BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 1000, 2048, 2);
								BRAIN::TASK_SMART_FLEE_PED(0, AUDIO::_0x0626A247D2405330(), 200f, 4294967295, 0, 0);
								CUTSCENE::_0x8D9DF6ECA8768583(iLocal_48);
								BRAIN::TASK_PERFORM_SEQUENCE(iVar12, iLocal_48);
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_48);
				...
				else
				{
					...
					while (iVar16 < iVar11)
					{
						...
						{
							if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iVar11[iVar16], AUDIO::_0x0626A247D2405330(), 1))
							{
								func_70();
								iVar2 = 6;
							}
...
int func_1(int iParam0, struct<6> Param1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x8FD
{
	...
	if (*iParam0 >= 3)
	{
		...
		{
			if ((!ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_236, 9f, 9f, 9f, false, true, 0) && !ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), 1276.21f, -1613.05f, 53f, 9f, 9f, 9f, false, true, 0)) || BRAIN::IS_PED_RUNNING(AUDIO::_0x0626A247D2405330()))
			{
				*iParam0 = 6;
			}
		}
	...
	switch (*iParam0)
	{
		case 0:
			if (func_54(iParam2, iParam3))
			{
				...
				if (!PED::IS_PED_INJURED(iParam2))
				{
					...
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iParam2, 15f, 15f, 15f, 0, 1, 0))
						{
							if ((WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6) && PED::_CAN_PED_SEE_PED(iParam2, AUDIO::_0x0626A247D2405330())) && !PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
							{
								if ((WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), iParam2)) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iParam2))
								{
									BRAIN::CLEAR_PED_SECONDARY_TASK(iParam2);
									BRAIN::TASK_LOOK_AT_ENTITY(iParam2, AUDIO::_0x0626A247D2405330(), 5000, 1024, 2);
									func_70();
									SYSTEM::WAIT(1000);
									...
									while (iVar0 < *iParam3)
									{
										...
										{
											BRAIN::CLEAR_PED_SECONDARY_TASK((*iParam3)[iVar0]);
											BRAIN::TASK_SMART_FLEE_PED((*iParam3)[iVar0], AUDIO::_0x0626A247D2405330(), 200f, 4294967295, 0, 0);
									...
									if (!PED::IS_PED_INJURED(iParam2))
									{
										BRAIN::TASK_SMART_FLEE_PED(iParam2, AUDIO::_0x0626A247D2405330(), 200f, 4294967295, 0, 0);
					...
					else
					{
						...
						if (!PED::IS_PED_INJURED(iParam2))
						{
							NETWORK::_0x5E3AA4CA2B6FB0EE(iParam2);
							BRAIN::TASK_SMART_FLEE_PED(iParam2, AUDIO::_0x0626A247D2405330(), 200f, 4294967295, 0, 0);
							PED::SET_PED_KEEP_TASK(iParam2, true);
						}
						iLocal_227 = 1;
				...
				else if (PED::IS_PED_RAGDOLL(iParam2))
				{
					...
					{
						BRAIN::STOP_ANIM_TASK(iParam2, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_wave_loop", 3238002688);
					}
				}
			}
			else
		...
		case 2:
			GRAPHICS::DRAW_DEBUG_LINE(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), vLocal_224, 0, 0, 255, 255);
			BRAIN::TASK_PAUSE(AUDIO::_0x0626A247D2405330(), 1000);
			vLocal_236 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true) };
			if (!PED::IS_PED_INJURED((*iParam3)[1]))
			{
				...
				{
					BRAIN::TASK_SYNCHRONIZED_SCENE((*iParam3)[0], iLocal_51, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
				}
				if (!PED::IS_PED_INJURED((*iParam3)[1]))
				{
					BRAIN::TASK_SYNCHRONIZED_SCENE((*iParam3)[1], iLocal_51, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_c", 4f, -4f, 16, 0, 1148846080, 0);
				}
				if (!PED::IS_PED_INJURED((*iParam3)[2]))
				{
					BRAIN::TASK_SYNCHRONIZED_SCENE((*iParam3)[2], iLocal_51, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
				}
				*iParam0 = 3;
			}
			break;
		...
		case 3:
			*iParam4 = 0;
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_51))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_51) > 0.3f)
				{
					if (!PED::IS_PED_INJURED((*iParam3)[0]))
					{
						...
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_48);
						BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true) - Vector(0f, 0f, 1f), AUDIO::_0x0626A247D2405330(), 2f, false, 3.5f, 5f, true, 0, 0, 3337513804, 20000);
						BRAIN::TASK_AIM_GUN_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 25000, 0);
						CUTSCENE::_0x8D9DF6ECA8768583(iLocal_48);
						BRAIN::TASK_PERFORM_SEQUENCE((*iParam3)[0], iLocal_48);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_48);
						iLocal_48 = 0;
					}
				}
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_51) > 0.35f)
				{
					if (!PED::IS_PED_INJURED((*iParam3)[1]))
					{
						...
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_48);
						BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), AUDIO::_0x0626A247D2405330(), 2f, 0, 5f, 1082130432, 1, 0, 3337513804);
						BRAIN::TASK_AIM_GUN_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 25000, 0);
						CUTSCENE::_0x8D9DF6ECA8768583(iLocal_48);
						BRAIN::TASK_PERFORM_SEQUENCE((*iParam3)[1], iLocal_48);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_48);
						iLocal_48 = 0;
					}
				}
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_51) > 0.275f)
				{
					if (!PED::IS_PED_INJURED((*iParam3)[2]))
					{
						...
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_48);
						BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), AUDIO::_0x0626A247D2405330(), 2f, 0, 3.5f, 1082130432, 1, 0, 3337513804);
						BRAIN::TASK_AIM_GUN_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 25000, 0);
						CUTSCENE::_0x8D9DF6ECA8768583(iLocal_48);
						BRAIN::TASK_PERFORM_SEQUENCE((*iParam3)[2], iLocal_48);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_48);
						iLocal_48 = 0;
					}
				}
			...
			if (!PED::IS_PED_INJURED((*iParam3)[2]))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY((*iParam3)[2], AUDIO::_0x0626A247D2405330(), 4f, 4f, 2f, 0, 1, 0))
				{
					func_40(iLocal_219);
					func_40(iLocal_220);
					func_36(iParam3);
		...
		case 4:
			...
			else if (WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6))
			{
				*iParam0 = 6;
			}
			break;
		...
		case 6:
			...
			if (func_31(iParam3))
			{
				*iParam5 = 1;
				if (!PED::IS_PED_INJURED(iParam2))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iParam2, 8f, 8f, 8f, 0, 1, 0))
					{
...
int func_12()//Position - 0x1D9A
{
	return Global_1407E0;
}

int func_13(int iParam0, int iParam1)//Position - 0x1DA6
{
	switch (iParam0)
	{
		case 0:
...
int func_14(int iParam0)//Position - 0x211A
{
	switch (iParam0)
	{
		case 29:
...
void func_15(int iParam0)//Position - 0x2149
{
	int iVar0;
	int iVar1;
...
void func_16(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x218B
{
	func_17(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_17(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x21AD
{
	int iVar0;
...
bool func_21(int iParam0)//Position - 0x25E4
{
	return Global_8D15 == iParam0;
}

bool func_22(int iParam0)//Position - 0x25F2
{
	return iParam0 < 3;
}

int func_23(int iParam0)//Position - 0x25FE
{
	int iVar0;
	int iVar1;
...
int func_24(int iParam0)//Position - 0x263B
{
	if (func_22(iParam0))
	{
...
int func_25(int iParam0)//Position - 0x2665
{
	int iVar0;
	int iVar1;
...
void func_26(int iParam0, int iParam1)//Position - 0x26A8
{
	MISC::SET_BIT(&(Global_19E56.f_6187.f_8[iParam0]), iParam1);
}

int func_27(int iParam0)//Position - 0x26C3
{
	int iVar0;
...
int func_29(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x2791
{
...
int func_30()//Position - 0x296B
{
	return 1;
}

int func_31(var uParam0)//Position - 0x2974
{
	int iVar0;
...
void func_32(var uParam0)//Position - 0x29B2
{
	int iVar0;
...
void func_33(var uParam0)//Position - 0x29E7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_34(struct<6> Param0, int iParam1, var uParam2)//Position - 0x2A53
{
	switch (iLocal_231)
	{
		case 0:
		...
		case 1:
			...
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iParam1, 242628503) == 7 || ENTITY::IS_ENTITY_AT_ENTITY(iParam1, AUDIO::_0x0626A247D2405330(), 8f, 8f, 8f, 0, 1, 0))
				{
					if (!func_69())
					{
		...
		case 2:
			if (!PED::IS_PED_INJURED((*uParam2)[2]))
			{
				if (!PED::IS_PED_INJURED((*uParam2)[0]))
				{
					...
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_222[0 /*3*/], 1f, 4294967295, 1048576000, 0, 1193033728);
					BRAIN::TASK_ACHIEVE_HEADING(0, fLocal_223[0], 0);
					BRAIN::TASK_PLAY_ANIM_ADVANCED(0, Param0.f_5, "sit_down_idle_01", vLocal_222[0 /*3*/], 0f, 0f, fLocal_223[0], 1000f, -4f, 4294967295, 1, 0, 2, 0);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_48);
					BRAIN::TASK_PERFORM_SEQUENCE((*uParam2)[0], iLocal_48);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_48);
					iLocal_48 = 0;
				}
				if (!PED::IS_PED_INJURED((*uParam2)[1]))
				{
					...
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_222[1 /*3*/], 1f, 4294967295, 1048576000, 0, 1193033728);
					BRAIN::TASK_WANDER_STANDARD(0, 1193033728, 0);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_48);
					BRAIN::TASK_PERFORM_SEQUENCE((*uParam2)[1], iLocal_48);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_48);
					iLocal_48 = 0;
				}
				if (!PED::IS_PED_INJURED((*uParam2)[2]))
				{
					...
					BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, (*uParam2)[0], 0f, -0.5f, 0f, 1f, 10000, 1036831949, 1);
					BRAIN::TASK_WANDER_STANDARD(0, 1193033728, 0);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_48);
					BRAIN::TASK_PERFORM_SEQUENCE((*uParam2)[2], iLocal_48);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_48);
					iLocal_48 = 0;
				}
			}
...
int func_35(int iParam0, int iParam1)//Position - 0x2D13
{
	int iVar0;
	int iVar1;
...
void func_36(var uParam0)//Position - 0x2D34
{
	int iVar0;
...
int func_37(int iParam0, bool bParam1, int iParam2)//Position - 0x2D8D
{
	int iVar0;
...
int func_38(int iParam0, bool bParam1, bool bParam2)//Position - 0x2DDF
{
	int iVar0;
...
float func_39(bool bParam0, float fParam1, float fParam2)//Position - 0x2E83
{
	if (bParam0)
	{
		return fParam1;
...
void func_40(int iParam0)//Position - 0x2E9A
{
...
void func_41(var uParam0, int iParam1)//Position - 0x2EB1
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		if (!PED::IS_PED_INJURED((*uParam0)[iVar0]))
		{
			BRAIN::TASK_COMBAT_PED((*uParam0)[iVar0], AUDIO::_0x0626A247D2405330(), 0, 16);
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam1, 0))
	{
		...
		BRAIN::TASK_COWER(iParam1, 4294967295);
		PED::SET_PED_KEEP_TASK(iParam1, true);
	}
}

void func_42()//Position - 0x2F24
{
	Global_3960 = 0;
	func_43();
}

void func_43()//Position - 0x2F34
{
...
bool func_44(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2F8B
{
...
int func_45(char* sParam0, int iParam1, bool bParam2)//Position - 0x2FD9
{
	Global_3DCF = 0;
...
bool func_52(int iParam0, int iParam1)//Position - 0x3526
{
	switch (iParam0)
	{
		case 5:
...
void func_53(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x3561
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
int func_54(int iParam0, var uParam1)//Position - 0x35B7
{
	switch (iLocal_234)
	{
		case 0:
			...
			{
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1272.878f, -1532.84f, 36.4104f, 1339.482f, -1623.636f, 71.4792f, 105.1875f, 0, true, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iParam0)) || ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iParam0, 15f, 15f, 15f, 0, 1, 0))
				{
					if (!func_108())
					{
						func_58(1);
					...
					if (!HUD::DOES_BLIP_EXIST(iLocal_220))
					{
						...
						HUD::_0x75A16C3DA34F1245(iLocal_220, false);
					}
					if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
					{
						if (!PED::IS_PED_IN_ANY_POLICE_VEHICLE(AUDIO::_0x0626A247D2405330()))
						{
							...
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iParam0, 10f, 10f, 10f, 0, 1, 0))
								{
									BRAIN::CLEAR_PED_SECONDARY_TASK(iParam0);
									BRAIN::OPEN_SEQUENCE_TASK(&iLocal_48);
									BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295);
									BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 20000, 1024, 2);
									CUTSCENE::_0x8D9DF6ECA8768583(iLocal_48);
									BRAIN::TASK_PERFORM_SEQUENCE(iParam0, iLocal_48);
									BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_48);
									if (HUD::DOES_BLIP_EXIST(iLocal_220))
									{
										HUD::_0x75A16C3DA34F1245(iLocal_220, true);
									}
							...
							else if (iLocal_225 == 0)
							{
								...
								if (!PED::IS_PED_INJURED(iParam0))
								{
									BRAIN::OPEN_SEQUENCE_TASK(&iLocal_48);
									BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 20000, 1024, 2);
									BRAIN::TASK_PLAY_ANIM(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_wave_loop", 2f, -2f, 4294967295, 49, 0, 0, 0, 0);
									BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295);
									CUTSCENE::_0x8D9DF6ECA8768583(iLocal_48);
									BRAIN::TASK_PERFORM_SEQUENCE(iParam0, iLocal_48);
									BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_48);
					...
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iParam0, 8f, 8f, 8f, 0, 1, 0))
						{
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_48);
							BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295);
							BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 20000, 1024, 2);
			...
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1273.098f, -1604.172f, 53.1535f, 1276.568f, -1615.127f, 56.7879f, 10f, 0, true, 0) && !func_57())
				{
					iLocal_234 = 3;
				}
				else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1298.546f, -1617.742f, 53.2254f, 1262.868f, -1629.36f, 64.2894f, 30.4375f, 0, true, 0))
				{
		...
		case 1:
			...
			if (!PED::IS_PED_INJURED(iParam0) && !PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
			{
				...
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_48);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_224, 2f, 20000, 0.25f, 0, 32.2195f);
					BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295, 1024, 2);
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_48);
					BRAIN::TASK_PERFORM_SEQUENCE(iParam0, iLocal_48);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_48);
					iLocal_48 = 0;
					if ((WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6) && ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iParam0, 6f, 6f, 6f, 0, 1, 0)) && !PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
					{
					}
				}
				iLocal_234 = 2;
		...
		case 3:
			...
			else if (!PED::IS_PED_INJURED(iParam0))
			{
				...
				{
					if (PED::IS_PED_FACING_PED(iParam0, AUDIO::_0x0626A247D2405330(), 60f))
					{
						if (func_158())
						{
							BRAIN::TASK_PLAY_ANIM(iParam0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_a", 2f, -2f, 4294967295, 48, 0, 0, 0, 0);
						}
						else
						{
							BRAIN::TASK_PLAY_ANIM(iParam0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 2f, -2f, 4294967295, 0, 0, 0, 0, 0);
						}
						func_44(&uLocal_53, "REGIAU", "REGIN_HERE", 4, 0, 0, 0);
						SYSTEM::SETTIMERA(0);
					}
				}
				if ((WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 6) && PED::_CAN_PED_SEE_PED(iParam0, AUDIO::_0x0626A247D2405330())) && !PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
				{
		...
		case 4:
			if (!PED::IS_PED_INJURED(iParam0))
			{
				...
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_224, 2f, 20000, 1048576000, 0, 1193033728);
				CUTSCENE::_0x8D9DF6ECA8768583(iLocal_48);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_48);
				iLocal_48 = 0;
			}
...
void func_55(int iParam0)//Position - 0x3C9A
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
		NETWORK::_0x5E3AA4CA2B6FB0EE(iParam0);
		BRAIN::OPEN_SEQUENCE_TASK(&iLocal_48);
		BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1286.037f, -1623.207f, 53.2297f, 2f, 4294967295, 1048576000, 0, 1193033728);
...
void func_56(int iParam0, var uParam1)//Position - 0x3D03
{
	int iVar0;
	...
	while (iVar0 < *uParam1)
	{
		...
		{
			if ((PED::_CAN_PED_SEE_PED((*uParam1)[iVar0], AUDIO::_0x0626A247D2405330()) || PLAYER::CAN_PED_HEAR_PLAYER(CAM::_0xDC9DA9E8789F5246(), (*uParam1)[iVar0])) || PED::_CAN_PED_SEE_PED(iParam0, AUDIO::_0x0626A247D2405330()))
			{
				func_70();
				if (!PED::IS_PED_INJURED((*uParam1)[iVar0]))
				{
					NETWORK::_0x5E3AA4CA2B6FB0EE((*uParam1)[iVar0]);
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_48);
					BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 1000, 2048, 2);
					BRAIN::TASK_SMART_FLEE_PED(0, AUDIO::_0x0626A247D2405330(), 200f, 4294967295, 0, 0);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_48);
					BRAIN::TASK_PERFORM_SEQUENCE((*uParam1)[iVar0], iLocal_48);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_48);
...
int func_57()//Position - 0x3EE7
{
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 0))
		{
			if (PED::IS_PED_IN_MODEL(AUDIO::_0x0626A247D2405330(), joaat("RHINO")))
			{
				return 1;
			}
		}
	}
	if (PED::IS_PED_IN_FLYING_VEHICLE(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(AUDIO::_0x0626A247D2405330()))
	{
		return 1;
	}
	return 0;
...
int func_58(int iParam0)//Position - 0x3F3E
{
	if (func_62())
	{
		Global_19E4C = 1;
...
void func_59(int iParam0)//Position - 0x3F91
{
	switch (iParam0)
	{
		case 0:
...
void func_60(char* sParam0, int iParam1)//Position - 0x4076
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_61(int iParam0)//Position - 0x408D
{
	char* sVar0;
...
int func_62()//Position - 0x40D1
{
	switch (func_63(&Global_63AE, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_63(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x4107
{
	int iVar0;
...
void func_64(var uParam0, int iParam1)//Position - 0x423E
{
	int iVar0;
...
bool func_65(int iParam0)//Position - 0x428D
{
	return func_66(iParam0, Global_8D15);
}

int func_66(int iParam0, int iParam1)//Position - 0x429E
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_67(int iParam0)//Position - 0x447F
{
	if (Global_8D15 == 15)
	{
		return 0;
...
int func_68(vector3 vParam0, int iParam1)//Position - 0x44A1
{
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		if (SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), vParam0) > IntToFloat(iParam1))
		{
			return 1;
		}
	}
...
void func_70()//Position - 0x44F4
{
	Global_3960 = 0;
	func_71();
}

void func_71()//Position - 0x4504
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_72(int iParam0, int iParam1)//Position - 0x4525
{
...
int func_73(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4, bool bParam5, float fParam6, int iParam7)//Position - 0x4572
{
	int iVar0;
...
int func_74(int iParam0, var uParam1, var uParam2, int iParam3, bool bParam4, float fParam5, int iParam6)//Position - 0x45BB
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
void func_75(char* sParam0, int iParam1)//Position - 0x4819
{
	func_77(sParam0);
	func_76(iParam1);
}

void func_76(int iParam0)//Position - 0x482D
{
	if (iParam0 > 0)
	{
	}
...
void func_77(char* sParam0)//Position - 0x483B
{
...
void func_78(int iParam0)//Position - 0x484E
{
	AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(iParam0);
}

void func_79(char* sParam0)//Position - 0x485C
{
	func_77(sParam0);
}

int func_80()//Position - 0x486A
{
	int iVar0;
...
void func_81(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x48CB
{
...
int func_82()//Position - 0x4966
{
	func_20();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_83(bool bParam0)//Position - 0x497F
{
	if (bParam0)
	{
	}
...
int func_84(int iParam0)//Position - 0x498C
{
	if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		if (func_85(iParam0))
...
int func_85(int iParam0)//Position - 0x49A9
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x4A1B
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_94()) || Global_19A9D) || Global_6375) || func_93()) || func_52(8, 4294967295)) || func_92()) || func_91()) || func_90()) || func_89()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_94()) || Global_6375) || func_93()) || func_52(8, 4294967295)) || func_90()) || func_92()) || func_91()) || func_89()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_94()) || Global_19A9D) || Global_6375) || func_93()) || func_52(8, 4294967295)) || func_90()) || func_92()) || func_91()) || func_89()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_94()) || Global_19A9D) || Global_6375) || func_93()) || func_52(8, 4294967295)) || func_92()) || func_91()) || func_89()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_94() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_52(8, 4294967295)) || func_89()) || func_88()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_52(8, 4294967295) || func_92()) || func_91()) || func_88()) || func_87())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_94()) || Global_6375) || func_93()) || func_52(8, 4294967295)) || func_91()) || func_90()) || func_89()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_87()//Position - 0x5138
{
	return Global_16C57.f_1;
}

int func_88()//Position - 0x5146
{
...
bool func_91()//Position - 0x51B0
{
	return Global_16C64.f_148 > 0;
}

bool func_92()//Position - 0x51C1
{
	return Global_16C64.f_147 > 0;
}

var func_93()//Position - 0x51D2
{
	return Global_140859;
}

int func_94()//Position - 0x51DE
{
...
int func_95()//Position - 0x51FA
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(AUDIO::_0x0626A247D2405330())) > 1369f && !func_106())
		{
			return 0;
		}
	}
...
int func_96(float fParam0, bool bParam1)//Position - 0x5280
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_97(int iParam0, var uParam1)//Position - 0x5337
{
	switch (iParam0)
	{
		case 0:
		...
		case 1:
			func_98(uParam1, "Abigail2", func_100(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, 4294967295, 4, 1, 0, 2359, func_99(iParam0), 1, 0);
			break;
		
		case 2:
			func_98(uParam1, "Barry1", func_100(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 0, 2359, func_99(iParam0), 1, 0);
			break;
		
		case 3:
			func_98(uParam1, "Barry2", func_100(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_99(iParam0), 1, 1);
			break;
		
		case 4:
			func_98(uParam1, "Barry3", func_100(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", 4294967295, 0, "", 164, 1, 4294967295, 0, 2, 0, 2359, func_99(iParam0), 0, 0);
			break;
		...
		case 7:
			func_98(uParam1, "Barry4", func_100(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, 4294967295, 4, 2, 800, 2000, func_99(iParam0), 0, 0);
			break;
		
		case 8:
			func_98(uParam1, "Dreyfuss1", func_100(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_99(iParam0), 0, 0);
			break;
		...
		case 15:
			func_98(uParam1, "Epsilon7", func_100(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", 4294967295, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_99(iParam0), 0, 0);
			break;
		
		case 16:
			func_98(uParam1, "Epsilon8", func_100(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, 4294967295, 4, 1, 0, 2359, func_99(iParam0), 1, 0);
			break;
		
		case 17:
			func_98(uParam1, "Extreme1", func_100(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", 4294967295, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_99(iParam0), 0, 1);
			break;
		...
		case 20:
			func_98(uParam1, "Extreme4", func_100(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_99(iParam0), 0, 0);
			break;
		
		case 21:
			func_98(uParam1, "Fanatic1", func_100(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 700, 2000, func_99(iParam0), 1, 0);
			break;
		
		case 22:
			func_98(uParam1, "Fanatic2", func_100(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 700, 2000, func_99(iParam0), 1, 0);
			break;
		
		case 23:
			func_98(uParam1, "Fanatic3", func_100(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 2, 700, 2000, func_99(iParam0), 0, 1);
			break;
		
		case 24:
			func_98(uParam1, "Hao1", func_100(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", 4294967295, 0, "controller_Races", 13, 1, 4294967295, 4, 2, 2000, 500, func_99(iParam0), 0, 1);
			break;
		
		case 25:
			func_98(uParam1, "Hunting1", func_100(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", 4294967295, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_99(iParam0), 0, 1);
			break;
		
		case 26:
			func_98(uParam1, "Hunting2", func_100(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, 4294967295, 4, 4, 0, 2359, func_99(iParam0), 0, 1);
			break;
		
		case 27:
			func_98(uParam1, "Josh1", func_100(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", 4294967295, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_99(iParam0), 1, 0);
			break;
		...
		case 29:
			func_98(uParam1, "Josh3", func_100(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 4294967295, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_99(iParam0), 1, 1);
			break;
		
		case 30:
			func_98(uParam1, "Josh4", func_100(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", 4294967295, 36, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_99(iParam0), 1, 0);
			break;
		
		case 31:
			func_98(uParam1, "Maude1", func_100(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", 4294967295, 0, "BailBond_Launcher", 0, 1, 4294967295, 4, 4, 0, 2359, func_99(iParam0), 0, 1);
			break;
		
		case 32:
			func_98(uParam1, "Minute1", func_100(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", 4294967295, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_99(iParam0), 0, 1);
			break;
		
		case 33:
			func_98(uParam1, "Minute2", func_100(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", 4294967295, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_99(iParam0), 0, 1);
			break;
		
		case 34:
			func_98(uParam1, "Minute3", func_100(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", 4294967295, 10, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_99(iParam0), 0, 1);
			break;
		
		case 35:
			func_98(uParam1, "MrsPhilips1", func_100(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", 4294967295, 0, "ambient_MrsPhilips", 0, 1, 4294967295, 4, 4, 0, 2359, func_99(iParam0), 0, 0);
			break;
		
		case 36:
			func_98(uParam1, "MrsPhilips2", func_100(iParam0), 0, 11, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_99(iParam0), 0, 0);
			break;
		
		case 37:
			func_98(uParam1, "Nigel1", func_100(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", 4294967295, 0, "", 177, 1, 4294967295, 1, 4, 0, 2359, func_99(iParam0), 1, 0);
			break;
		...
		case 42:
			func_98(uParam1, "Nigel2", func_100(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", 4294967295, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_99(iParam0), 1, 1);
			break;
		
		case 43:
			func_98(uParam1, "Nigel3", func_100(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", 4294967295, 16, "postRC_Nigel3", 0, 0, 4294967295, 4, 4, 0, 2359, func_99(iParam0), 1, 1);
			break;
		
		case 44:
			func_98(uParam1, "Omega1", func_100(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", 4294967295, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_99(iParam0), 0, 0);
			break;
		
		case 45:
			func_98(uParam1, "Omega2", func_100(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_99(iParam0), 0, 0);
			break;
		
		case 46:
			func_98(uParam1, "Paparazzo1", func_100(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", 4294967295, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_99(iParam0), 0, 1);
			break;
		
		case 47:
			func_98(uParam1, "Paparazzo2", func_100(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", 4294967295, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_99(iParam0), 0, 1);
			break;
		
		case 48:
			func_98(uParam1, "Paparazzo3", func_100(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", 4294967295, 8, "", 183, 1, 4294967295, 2, 2, 0, 2359, func_99(iParam0), 0, 0);
			break;
		...
		case 51:
			func_98(uParam1, "Paparazzo4", func_100(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", 4294967295, 8, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_99(iParam0), 0, 0);
			break;
		
		case 52:
			func_98(uParam1, "Rampage1", func_100(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", 4294967295, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_99(iParam0), 0, 0);
			break;
		
		case 54:
			func_98(uParam1, "Rampage3", func_100(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", 4294967295, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_99(iParam0), 1, 0);
			break;
		
		case 55:
			func_98(uParam1, "Rampage4", func_100(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", 4294967295, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_99(iParam0), 1, 0);
			break;
		
		case 56:
			func_98(uParam1, "Rampage5", func_100(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", 4294967295, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_99(iParam0), 0, 0);
			break;
		
		case 53:
			func_98(uParam1, "Rampage2", func_100(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", 4294967295, 0, "rampage_controller", 0, 0, 4294967295, 4, 4, 0, 2359, func_99(iParam0), 1, 0);
			break;
		
		case 57:
			func_98(uParam1, "TheLastOne", func_100(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_99(iParam0), 0, 1);
			break;
		
		case 58:
			func_98(uParam1, "Tonya1", func_100(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", 4294967295, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_99(iParam0), 0, 1);
			break;
		
		case 59:
			func_98(uParam1, "Tonya2", func_100(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_99(iParam0), 0, 1);
			break;
		
		case 60:
			func_98(uParam1, "Tonya3", func_100(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_99(iParam0), 0, 1);
			break;
		
		case 61:
			func_98(uParam1, "Tonya4", func_100(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_99(iParam0), 0, 1);
			break;
		
		case 62:
			func_98(uParam1, "Tonya5", func_100(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_99(iParam0), 0, 1);
			break;
...
int func_99(int iParam0)//Position - 0x660F
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_100(int iParam0)//Position - 0x6955
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_101(int iParam0)//Position - 0x698D
{
	struct<2> Var0;
...
bool func_103()//Position - 0x6E0C
{
	return Global_19D3C > 0;
}

int func_104()//Position - 0x6E1A
{
	if (Global_16089 != 4294967295)
	{
		return 1;
...
int func_109(int iParam0, struct<5> Param1, var uParam2)//Position - 0x6EFF
{
	int iVar0;
...
void func_110(int iParam0)//Position - 0x6FB4
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_28();
...
void func_112(int iParam0)//Position - 0x7027
{
	Global_19E4B = iParam0;
}

int func_113(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x7035
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_140(Global_19E56.f_6187.f_2B[iParam1]))
		{
			return 0;
		}
...
bool func_114(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x73CF
{
	if (bParam2)
	{
...
bool func_115(int iParam0)//Position - 0x7416
{
	int iVar0;
...
int func_116(int iParam0)//Position - 0x7437
{
	return func_117(iParam0, 1);
}

int func_117(int iParam0, int iParam1)//Position - 0x7446
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_118(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x7499
{
	func_119(func_130(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_119(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x74B7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_120(float fParam0, float fParam1, float fParam2)//Position - 0x76B8
{
	float fVar0;
...
int func_121(int iParam0, int iParam1)//Position - 0x76FA
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_122(int iParam0)//Position - 0x779C
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_123(int iParam0)//Position - 0x77AF
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_124(int iParam0)//Position - 0x77C2
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_125(int iParam0)//Position - 0x77D5
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_126(int iParam0)//Position - 0x77E7
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_127(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}

int func_127(bool bParam0, int iParam1, int iParam2)//Position - 0x780C
{
	if (bParam0)
	{
		return iParam1;
...
int func_128(int iParam0)//Position - 0x7823
{
	return iParam0 & 15;
}

int func_129(int iParam0, int iParam1)//Position - 0x7830
{
	int iVar0;
	int iVar1;
...
void func_131(var uParam0, int iParam1)//Position - 0x7982
{
	if (iParam1 <= 0)
	{
		return;
...
void func_132(var uParam0, int iParam1)//Position - 0x7A08
{
...
void func_133(var uParam0, int iParam1)//Position - 0x7A3B
{
	int iVar0;
	int iVar1;
...
void func_134(var uParam0, int iParam1)//Position - 0x7A8C
{
...
void func_135(var uParam0, int iParam1)//Position - 0x7AC6
{
...
void func_136(var uParam0, int iParam1)//Position - 0x7B01
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_137(int iParam0)//Position - 0x7B3D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_138(int iParam0, int iParam1)//Position - 0x7C19
{
...
bool func_140(int iParam0)//Position - 0x7C64
{
	return func_129(func_130(), iParam0);
}

int func_141(int iParam0, int iParam1, int iParam2)//Position - 0x7C76
{
	int iVar0;
	int iVar1;
...
int func_142(int iParam0)//Position - 0x7D5A
{
	if (!func_22(iParam0))
	{
		return 7;
...
bool func_143(int iParam0)//Position - 0x7D7E
{
	int iVar0;
	bool bVar1;
...
void func_146(struct<6> Param0, int iParam1, int iParam2, int iParam3)//Position - 0x7EDB
{
	int iVar0;
	...
	if (iLocal_228)
	{
		...
		{
			ENTITY::SET_ENTITY_HEALTH(iParam3, false);
		}
		func_83(0);
		func_109(0, Param0);
	}
...
void func_147(int iParam0)//Position - 0x7F8C
{
	char cVar0[64];
	...
	if (func_108())
	{
		...
		func_150(30000);
		StringCopy(&cVar0, func_149(Global_19E4B, 1), 64);
	...
	func_148(&Global_63AE);
	Global_19E4C = 0;
	func_112(4294967295);
}

void func_148(var uParam0)//Position - 0x8042
{
	if (*uParam0 == 4294967295)
	{
		return;
...
char* func_149(int iParam0, bool bParam1)//Position - 0x807F
{
	switch (iParam0)
	{
		case 0:
...
void func_150(int iParam0)//Position - 0x82C8
{
	Global_8F3C = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_151(int iParam0)//Position - 0x82DA
{
	func_152(iParam0, 0, func_157(iParam0));
}

void func_152(int iParam0, int iParam1, int iParam2)//Position - 0x82EF
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_153(var uParam0)//Position - 0x831E
{
	struct<16> Var0;
	int iVar1;
...
void func_154(int iParam0, var uParam1)//Position - 0x83EF
{
	Global_19E56.f_6187.f_2B[iParam0] = *uParam1;
}

void func_155(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8407
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_156(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8589
{
...
int func_157(int iParam0)//Position - 0x85C1
{
	int iVar0;
