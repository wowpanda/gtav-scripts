...
void __EntryFunction__()
{
	...
	uLocal_365 = ADD_SCENARIO_BLOCKING_AREA(Vector(93.3633f, 82.5239f, 276.3459f) + Vector(10f, 10f, 10f), Vector(93.3633f, 82.5239f, 276.3459f) - Vector(10f, 10f, 10f), 0, 1, 1, 1);
	uLocal_366 = ADD_SCENARIO_BLOCKING_AREA(Vector(188.5935f, 675.8706f, 227.8598f) + Vector(4f, 4f, 4f), Vector(188.5935f, 675.8706f, 227.8598f) - Vector(4f, 4f, 4f), 0, 1, 1, 1);
	uLocal_367 = ADD_SCENARIO_BLOCKING_AREA(Vector(93.8361f, 92.1704f, 246.1673f) + Vector(6f, 6f, 6f), Vector(93.8361f, 92.1704f, 246.1673f) - Vector(6f, 6f, 6f), 0, 1, 1, 1);
	if (Global_3)
	{
		CLEAR_AREA(246.1673f, 92.1704f, 93.8361f, 6f, 1, 0, 0, 0);
	}
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Vector(93.8361f, 92.1704f, 246.1673f) + Vector(6f, 6f, 6f), Vector(93.8361f, 92.1704f, 246.1673f) - Vector(6f, 6f, 6f), 0, 1);
	...
	while (true)
	{
		...
		{
			if (DOES_ENTITY_EXIST(Local_131[iVar0 /*18*/]) && !IS_ENTITY_DEAD(Local_131[iVar0 /*18*/], 0))
			{
		...
		{
			if (DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/]) && !IS_ENTITY_DEAD(Local_204[iVar0 /*18*/], 0))
			{
		...
		{
			vLocal_60 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
		}
		if (!IS_PED_INJURED(uLocal_86))
		{
			vLocal_63 = { GET_ENTITY_COORDS(uLocal_86, 1) };
		}
		if (DOES_ENTITY_EXIST(iLocal_91) && !IS_ENTITY_DEAD(iLocal_91, 0))
		{
		...
		if (!func_224())
		{
			if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			{
				switch (iLocal_369)
				{
					...
					case 1:
						if ((func_194() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || !IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
						{
						...
						else if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 281.0074f, 192.4805f, 58.08817f, 228.8291f, 50.88667f, 111.6104f, 82.75f, 0, 1, 0))
						{
							func_184(1);
							uLocal_360 = func_183(uLocal_86, 0, 145);
		...
		else
		{
			...
			if (!IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_63, 210f, 210f, 210f, 0, 1, 0))
			{
				func_193();
				func_274();
			}
			if (((iLocal_47 != 5 && iLocal_47 != 6) && iLocal_47 != 10) && iLocal_47 != 7)
			{
				if (!Global_3 && !bLocal_70)
				{
					if (func_68(uLocal_86, 1, 1) || func_67())
					{
						if (iLocal_47 > 0)
						{
							func_181(5);
		...
		if (iLocal_47 <= 0)
		{
			...
			{
				if ((!IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 243.6443f, 123.7193f, 97.59898f, 262.4353f, 116.8746f, 107.4762f, 32.25f, 0, 1, 0) && (GET_GAME_TIMER() - iLocal_564) > 5000) && !IS_PED_INJURED(Local_204[iVar1 /*18*/]))
				{
					if (VDIST2(GET_ENTITY_COORDS(Local_204[iVar1 /*18*/], 1), vLocal_60) < (30.5f * 30.5f) && VDIST2(vLocal_63, vLocal_60) > (22.5f * 22.5f))
					{
						...
						else
						{
							...
							StringIntConCat(&cVar2, GET_RANDOM_INT_IN_RANGE(1, 13), 24);
...
void func_2()
{
	...
	while (iVar0 < Local_204)
	{
		if (DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/]))
		{
			if (GET_ENTITY_HEALTH(Local_204[iVar0 /*18*/]) < Local_204[iVar0 /*18*/].f_17)
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_204[iVar0 /*18*/], PLAYER_PED_ID(), 1))
				{
					iLocal_386[iVar0] = (iLocal_386[iVar0] + (Local_204[iVar0 /*18*/].f_17 - GET_ENTITY_HEALTH(Local_204[iVar0 /*18*/])));
					iLocal_82 = (iLocal_82 + (Local_204[iVar0 /*18*/].f_17 - GET_ENTITY_HEALTH(Local_204[iVar0 /*18*/])));
...
{
	_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, cParam1, sParam2, func_4(iParam3), 0);
}
...
void func_17(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
...
int func_24()
{
	...
	while (iVar0 < Local_204)
	{
		if ((DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/]) && !IS_PED_INJURED(Local_204[iVar0 /*18*/])) && !IS_PED_INJURED(uLocal_86))
		{
...
void func_25()
{
	...
	switch (iLocal_49)
	{
		case 0:
			...
			if (((((HAS_MODEL_LOADED(joaat("a_m_y_genstreet_02")) && HAS_MODEL_LOADED(joaat("prop_pap_camera_01"))) && HAS_MODEL_LOADED(joaat("cavalcade2"))) && HAS_MODEL_LOADED(joaat("vader"))) && HAS_ANIM_DICT_LOADED(sLocal_373)) && HAS_ANIM_DICT_LOADED("random@paparazzi@pap_anims"))
			{
				...
				SET_ENTITY_COORDS(func_56(0, 1), 265.408f, 151.2875f, 103.5673f, 1, 0, 0, 1);
				SET_ENTITY_HEADING(func_56(0, 1), 217.1033f);
				SET_ENTITY_COORDS(func_56(2, 1), 245.9477f, 72.661f, 89.1067f, 1, 0, 0, 1);
				SET_ENTITY_HEADING(func_56(2, 1), 38.6283f);
				SET_ENTITY_COORDS(func_56(3, 1), 244.1872f, 73.3336f, 89.0917f, 1, 0, 0, 1);
				SET_ENTITY_HEADING(func_56(3, 1), 272.9875f);
				TASK_PLAY_ANIM(func_56(0, 1), "random@paparazzi@pap_anims", "base_pap", 8f, -8f, -1, 1, 0, 0, 0, 0);
				TASK_PLAY_ANIM(func_56(1, 0), "random@paparazzi@pap_anims", "pap_idle_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
				TASK_PLAY_ANIM(func_56(1, 1), "random@paparazzi@pap_anims", "pap_idle_b", 8f, -8f, -1, 1, 0, 0, 0, 0);
				TASK_PLAY_ANIM(func_56(2, 1), "random@paparazzi@pap_anims", "pap_idle_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
				TASK_PLAY_ANIM(func_56(3, 1), "random@paparazzi@pap_anims", "pap_idle_b", 8f, -8f, -1, 1, 0, 0, 0, 0);
				iLocal_49 = 1;
			}
			break;
		...
		case 2:
			if (DOES_ENTITY_EXIST(Local_204[2 /*18*/].f_2))
			{
				if (!IS_ENTITY_VISIBLE(Local_204[2 /*18*/].f_2))
				{
					SET_ENTITY_VISIBLE(Local_204[2 /*18*/].f_2, 1, 0);
				}
			}
			switch (iLocal_616)
			{
				case 0:
					if (!IS_PED_INJURED(func_56(1, 0)))
					{
						CLEAR_PED_TASKS(func_56(1, 0));
					}
					if (!IS_PED_INJURED(func_56(1, 1)))
					{
						CLEAR_PED_TASKS(func_56(1, 1));
					}
					if (!DOES_ENTITY_EXIST(Local_131[2 /*18*/]))
					{
						func_57(2, vLocal_596[2 /*3*/], fLocal_609[2], 0);
						if (IS_VEHICLE_DRIVEABLE(Local_131[2 /*18*/], 0))
						{
							func_58(func_61(2), GET_ENTITY_COORDS(Local_131[2 /*18*/], 1), 0f);
							SET_PED_INTO_VEHICLE(func_56(2, 0), Local_131[2 /*18*/], -1);
						}
					}
					if (!DOES_ENTITY_EXIST(Local_131[3 /*18*/]))
					{
						func_57(3, vLocal_596[3 /*3*/], fLocal_609[3], 0);
					}
					if (!IS_PED_INJURED(func_56(2, 1)))
					{
						TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(2, 1), vLocal_581, 2f, -1, 1048576000, 0, 1193033728);
					}
					if (!IS_PED_INJURED(func_56(3, 1)))
					{
						TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(3, 1), vLocal_584, 2f, -1, 1048576000, 0, 1193033728);
					}
					if (!DOES_ENTITY_EXIST(func_56(3, 0)))
					{
					...
					if (Global_3 || bLocal_70)
					{
						if (!IS_PED_INJURED(func_56(1, 0)))
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(1, 0), vLocal_587, 2f, 20000, 1048576000, 0, 1193033728);
						}
						if (!IS_PED_INJURED(func_56(1, 1)))
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(1, 1), vLocal_590, 2f, 20000, 1048576000, 0, 1193033728);
						}
						if (!IS_PED_INJURED(func_56(0, 1)))
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(func_56(0, 1), vLocal_593, 2f, 20000, 1048576000, 0, 1193033728);
						}
					}
					SETTIMERB(0);
					iVar1 = 0;
					...
					{
						if (DOES_ENTITY_EXIST(Local_204[iVar1 /*18*/]))
						{
							_DYNAMIC_MIXER_RELATED_FN(Local_204[iVar1 /*18*/], "MAG_2_PAPARAZZI_GROUP", 0);
						}
						iVar1++;
					}
					iVar1 = 0;
					...
					{
						if (DOES_ENTITY_EXIST(Local_131[iVar1 /*18*/]))
						{
							_DYNAMIC_MIXER_RELATED_FN(Local_131[iVar1 /*18*/], "MAG_2_PAPARAZZI_GROUP", 0);
						}
						iVar1++;
					}
					iLocal_616++;
				...
				case 1:
					func_49();
					if ((IS_VEHICLE_DRIVEABLE(Local_131[0 /*18*/], 0) && !IS_PED_INJURED(func_56(0, 0))) && !IS_PED_INJURED(func_56(0, 1)))
					{
						if (!iLocal_571[1])
						{
							iLocal_571[1] = 1;
							TASK_VEHICLE_DRIVE_TO_COORD(func_56(0, 0), Local_131[0 /*18*/], vLocal_575, 10f, 0, joaat("cavalcade2"), 786469, 2f, 10f);
						}
					}
					if ((IS_VEHICLE_DRIVEABLE(Local_131[2 /*18*/], 0) && !IS_PED_INJURED(func_56(2, 0))) && !IS_PED_INJURED(func_56(2, 1)))
					{
						if (!iLocal_571[0])
						{
							TASK_VEHICLE_DRIVE_TO_COORD(func_56(2, 0), Local_131[2 /*18*/], vLocal_578, 10f, 0, joaat("cavalcade2"), 786469, 2f, 10f);
							iLocal_571[0] = 1;
						}
					}
					if (DOES_ENTITY_EXIST(uLocal_86) && !IS_PED_INJURED(uLocal_86))
					{
						func_46(uLocal_86, 6);
						if (Global_3 || bLocal_70)
						{
							if (!IS_PED_INJURED(func_56(1, 0)))
							{
								if (IS_ENTITY_AT_COORD(func_56(1, 0), vLocal_587, Global_22, 0, 1, 0))
								{
									func_45(uLocal_86, func_61(1));
								}
							}
							if (!IS_PED_INJURED(func_56(1, 1)))
							{
								if (IS_ENTITY_AT_COORD(func_56(1, 1), vLocal_590, Global_22, 0, 1, 0))
								{
									func_45(uLocal_86, func_59(1));
								}
							}
							if (!IS_PED_INJURED(func_56(0, 1)))
							{
								if (IS_ENTITY_AT_COORD(func_56(0, 1), vLocal_590, Global_22, 0, 1, 0))
								{
									func_45(uLocal_86, func_59(0));
								}
							}
						}
						else
						{
							func_46(uLocal_86, func_61(1));
							func_46(uLocal_86, func_59(1));
							if (TIMERB() > 1000)
							{
								func_46(uLocal_86, func_61(1));
							}
					...
					{
						if (IS_ENTITY_AT_COORD(func_56(2, 1), vLocal_581, Global_22, 0, 1, 0))
						{
							func_45(uLocal_86, func_59(2));
						}
						if (IS_ENTITY_AT_COORD(func_56(3, 1), vLocal_584, Global_22, 0, 1, 0))
						{
							func_45(uLocal_86, func_59(3));
						}
						if (IS_ENTITY_AT_COORD(func_56(0, 1), vLocal_584, Global_22, 0, 1, 0))
						{
							func_45(uLocal_86, func_59(0));
						}
					}
					...
					{
						if (!IS_BIT_SET(uLocal_619, 3))
						{
							CLEAR_PED_TASKS(Local_204[func_59(3) /*18*/]);
							SET_BIT(&uLocal_619, 3);
						}
						if (!IS_BIT_SET(uLocal_619, 2))
						{
							CLEAR_PED_TASKS(Local_204[func_59(2) /*18*/]);
							SET_BIT(&uLocal_619, 2);
						}
						if (!IS_BIT_SET(uLocal_619, 0))
						{
							CLEAR_PED_TASKS(Local_204[func_59(0) /*18*/]);
							SET_BIT(&uLocal_619, 0);
						}
						if (Global_3 || bLocal_70)
						{
							func_45(uLocal_86, func_59(3));
						...
						{
							func_46(uLocal_86, func_59(3));
						}
						func_46(uLocal_86, func_59(2));
						func_46(uLocal_86, func_59(0));
					}
					break;
			}
			func_44();
		...
		case 3:
			...
			if (IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
			{
				...
				{
					fLocal_574 = (fLocal_574 + GET_FRAME_TIME());
				}
			...
			while (iVar0 < Local_131)
			{
				if (DOES_ENTITY_EXIST(Local_131[iVar0 /*18*/]) && iLocal_47 != 6)
				{
					if ((iVar0 < 2 && ((iVar0 != iLocal_614 || !DOES_ENTITY_EXIST(Local_131[0 /*18*/])) || !DOES_ENTITY_EXIST(Local_131[1 /*18*/]))) && (GET_GAME_TIMER() - iLocal_615) > 500)
					{
						if (VDIST2(vLocal_60, vLocal_87) > 400f)
						{
							if (VDIST2(vLocal_60, vLocal_87) < 62500f || (GET_GAME_TIMER() - iLocal_370) < 30000)
							{
								...
								iLocal_614 = iVar0;
								iLocal_615 = GET_GAME_TIMER();
							}
						}
					}
					iVar2 = func_61(iVar0);
					if (!IS_PED_INJURED(Local_204[iVar2 /*18*/]))
					{
						iVar3 = func_59(iVar0);
					}
					else
					...
					switch (Local_131[iVar0 /*18*/].f_17)
					{
						case 0:
							...
							{
								if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_131[iVar0 /*18*/], 0))
								{
									if (!IS_PED_INJURED(Local_204[iVar2 /*18*/]))
									{
										if (!IS_PED_IN_VEHICLE(Local_204[iVar2 /*18*/], Local_131[iVar0 /*18*/], 0))
										{
											if (GET_SCRIPT_TASK_STATUS(Local_204[iVar2 /*18*/], -1794415470) != 1 && IS_VEHICLE_SEAT_FREE(Local_131[iVar0 /*18*/], -1, 0))
											{
												TASK_ENTER_VEHICLE(Local_204[iVar2 /*18*/], Local_131[iVar0 /*18*/], -1, -1, 1073741824, 1, 0);
											}
										}
									}
									if (iVar3 != -1)
									{
										if (!IS_PED_INJURED(Local_204[iVar3 /*18*/]))
										{
											if (!IS_PED_IN_VEHICLE(Local_204[iVar3 /*18*/], Local_131[iVar0 /*18*/], 0))
											{
												if (GET_SCRIPT_TASK_STATUS(Local_204[iVar3 /*18*/], -1794415470) != 1 && IS_VEHICLE_SEAT_FREE(Local_131[iVar0 /*18*/], 0, 0))
												{
													TASK_ENTER_VEHICLE(Local_204[iVar3 /*18*/], Local_131[iVar0 /*18*/], -1, 0, 1073741824, 1, 0);
												}
											}
										}
										if (!IS_PED_INJURED(Local_204[iVar2 /*18*/]) && (iVar3 != -1 && !IS_PED_INJURED(Local_204[iVar3 /*18*/])))
										{
											if ((IS_PED_IN_VEHICLE(Local_204[iVar2 /*18*/], Local_131[iVar0 /*18*/], 0) && (iVar3 != -1 && IS_PED_IN_VEHICLE(Local_204[iVar3 /*18*/], Local_131[iVar0 /*18*/], 0))) && IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
											{
												...
												{
													SET_PED_COMBAT_ATTRIBUTES(Local_204[iVar2 /*18*/], 3, 0);
													SET_PED_COMBAT_ATTRIBUTES(Local_204[iVar2 /*18*/], 1, 1);
													SET_PED_COMBAT_ATTRIBUTES(Local_204[iVar2 /*18*/], 2, 0);
													if (iVar0 == 0)
													{
							...
							else
							{
								if (!IS_PED_INJURED(Local_204[iVar2 /*18*/]))
								{
									...
									{
										SET_PED_FLEE_ATTRIBUTES(Local_204[iVar2 /*18*/], 2, 0);
										TASK_SMART_FLEE_PED(Local_204[iVar2 /*18*/], PLAYER_PED_ID(), 300f, 100000, 0, 0);
									}
								}
								if (iVar3 != -1)
								{
									if (!IS_PED_INJURED(Local_204[iVar3 /*18*/]))
									{
										...
										{
											SET_PED_FLEE_ATTRIBUTES(Local_204[iVar3 /*18*/], 2, 0);
											TASK_SMART_FLEE_PED(Local_204[iVar3 /*18*/], PLAYER_PED_ID(), 300f, 100000, 0, 0);
										}
									}
								}
							}
						...
						case 1:
							...
							{
								TASK_LEAVE_ANY_VEHICLE(Local_204[iVar2 /*18*/], 1, 256);
							}
							else
							{
								func_46(uLocal_86, iVar2);
							}
							if (iVar3 != -1)
							{
								if (!IS_PED_INJURED(Local_204[iVar3 /*18*/]))
								{
									...
									{
										TASK_LEAVE_ANY_VEHICLE(Local_204[iVar3 /*18*/], 0, 256);
									}
									else
									{
										func_46(uLocal_86, iVar3);
									}
								}
							}
							if (IS_VEHICLE_DRIVEABLE(Local_131[iVar0 /*18*/], 0))
					...
					if ((!IS_PED_INJURED(Local_204[iVar2 /*18*/]) && (iVar3 == -1 || !IS_PED_INJURED(Local_204[iVar3 /*18*/]))) && IS_VEHICLE_DRIVEABLE(Local_131[iVar0 /*18*/], 0))
					{
						iVar4 = 1;
						...
						if ((iVar4 && VDIST(vLocal_60, Local_131[iVar0 /*18*/].f_8) > 25f) && VDIST(vLocal_60, Local_204[iVar0 /*18*/].f_6) > 25f)
						{
							...
							if (iVar3 != -1)
							{
								if (!IS_PED_IN_VEHICLE(Local_204[iVar3 /*18*/], Local_131[iVar0 /*18*/], 0))
								{
									SET_PED_INTO_VEHICLE(Local_204[iVar3 /*18*/], Local_131[iVar0 /*18*/], 0);
								}
							}
						}
					}
		...
		case 4:
			...
			if (!iLocal_618)
			{
				...
				{
					iVar5 = func_61(iVar0);
					if (!IS_PED_INJURED(Local_204[iVar5 /*18*/]))
					{
						iVar6 = func_59(iVar0);
					}
					else
					...
					if (IS_VEHICLE_DRIVEABLE(Local_131[iVar0 /*18*/], 0))
					{
						if (!IS_PED_INJURED(Local_204[iVar5 /*18*/]))
						{
							if (!IS_PED_IN_VEHICLE(Local_204[iVar5 /*18*/], Local_131[iVar0 /*18*/], 0))
							{
								if (GET_SCRIPT_TASK_STATUS(Local_204[iVar5 /*18*/], -1794415470) != 1)
								{
									TASK_ENTER_VEHICLE(Local_204[iVar5 /*18*/], Local_131[iVar0 /*18*/], -1, -1, 1073741824, 1, 0);
								}
							}
						}
						if (iVar6 != -1)
						{
							if (!IS_PED_INJURED(Local_204[iVar6 /*18*/]))
							{
								if (!IS_PED_IN_VEHICLE(Local_204[iVar6 /*18*/], Local_131[iVar0 /*18*/], 0))
								{
									if (GET_SCRIPT_TASK_STATUS(Local_204[iVar6 /*18*/], -1794415470) != 1)
									{
										TASK_ENTER_VEHICLE(Local_204[iVar6 /*18*/], Local_131[iVar0 /*18*/], -1, 0, 1073741824, 1, 0);
									}
								}
							}
							if (!IS_PED_INJURED(Local_204[iVar5 /*18*/]) && (iVar6 != -1 && !IS_PED_INJURED(Local_204[iVar6 /*18*/])))
							{
								if ((IS_PED_IN_VEHICLE(Local_204[iVar5 /*18*/], Local_131[iVar0 /*18*/], 0) && (iVar6 != -1 && IS_PED_IN_VEHICLE(Local_204[iVar6 /*18*/], Local_131[iVar0 /*18*/], 0))) && IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
								{
									fVar7 = func_39((70f - (TO_FLOAT((GET_GAME_TIMER() - iLocal_85)) / 50f)), 0f, 70f);
									if (fVar7 <= 1f || (GET_GAME_TIMER() - iLocal_85) > 4000)
									{
										SET_DRIVE_TASK_MAX_CRUISE_SPEED(Local_204[iVar5 /*18*/], fVar7);
										iVar8 = 0;
										while (iVar8 < Local_131)
										{
											if ((IS_VEHICLE_DRIVEABLE(Local_131[iVar8 /*18*/], 0) && !IS_PED_INJURED(func_56(iVar8, 0))) && IS_PED_IN_VEHICLE(func_56(iVar8, 0), Local_131[iVar8 /*18*/], 0))
											{
												CLEAR_PED_TASKS(func_56(iVar8, 0));
												TASK_VEHICLE_MISSION(func_56(iVar8, 0), Local_131[iVar8 /*18*/], 0, 5, 10f, 786468, 10f, 10f, 1);
											}
											iVar8++;
										}
										iLocal_618 = 1;
									}
									else if (GET_SCRIPT_TASK_STATUS(Local_204[iVar5 /*18*/], -1273030092) != 1 && GET_SCRIPT_TASK_STATUS(Local_204[iVar5 /*18*/], -1817882002) != 1)
									{
										SET_PED_COMBAT_ATTRIBUTES(Local_204[iVar5 /*18*/], 3, 0);
										SET_PED_COMBAT_ATTRIBUTES(Local_204[iVar5 /*18*/], 1, 1);
										SET_PED_COMBAT_ATTRIBUTES(Local_204[iVar5 /*18*/], 2, 0);
										if (iVar0 == 0)
										{
											TASK_VEHICLE_MISSION(Local_204[iVar5 /*18*/], Local_131[iVar0 /*18*/], iLocal_91, 10, fVar7, 786471, 4f, 10f, 1);
										}
										else if (iVar0 == 1)
										{
											TASK_VEHICLE_MISSION(Local_204[iVar5 /*18*/], Local_131[iVar0 /*18*/], iLocal_91, 11, fVar7, 786470, 4f, 10f, 1);
										}
										else if (iVar0 == 2)
										{
											TASK_VEHICLE_MISSION(Local_204[iVar5 /*18*/], Local_131[iVar0 /*18*/], iLocal_91, 10, fVar7, 786471, 4f, 10f, 1);
					...
					else
					{
						if (!IS_PED_INJURED(Local_204[iVar5 /*18*/]))
						{
							if (!IS_PED_FLEEING(Local_204[iVar5 /*18*/]))
							{
								SET_PED_FLEE_ATTRIBUTES(Local_204[iVar5 /*18*/], 2, 0);
								TASK_SMART_FLEE_PED(Local_204[iVar5 /*18*/], PLAYER_PED_ID(), 300f, 100000, 0, 0);
							}
						}
						if (iVar6 != -1)
						{
							if (!IS_PED_INJURED(Local_204[iVar6 /*18*/]))
							{
								...
								{
									SET_PED_FLEE_ATTRIBUTES(Local_204[iVar6 /*18*/], 2, 0);
									TASK_SMART_FLEE_PED(Local_204[iVar6 /*18*/], PLAYER_PED_ID(), 300f, 100000, 0, 0);
								}
							}
						}
					}
	...
	while (iVar0 < Local_204)
	{
		if (DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/]) && !IS_PED_INJURED(Local_204[iVar0 /*18*/]))
		{
			if (iLocal_49 > 1)
			{
				...
				{
					func_28(iVar0);
					if (DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/].f_2) && IS_ENTITY_ATTACHED(Local_204[iVar0 /*18*/].f_2))
					{
						if (!IS_PED_IN_ANY_VEHICLE(Local_204[iVar0 /*18*/], 0))
						{
							if (IS_ENTITY_VISIBLE(Local_204[iVar0 /*18*/].f_2))
							{
								...
								{
									SET_ENTITY_VISIBLE(Local_204[iVar0 /*18*/].f_2, 0, 0);
								}
							}
							else if (!IS_PED_GETTING_UP(Local_204[iVar0 /*18*/]))
							{
								SET_ENTITY_VISIBLE(Local_204[iVar0 /*18*/].f_2, 1, 0);
							}
			...
			if (iLocal_47 != 7)
			{
				if (IS_PED_BEING_JACKED(Local_204[iVar0 /*18*/]) && IS_PED_JACKING(PLAYER_PED_ID()))
				{
					func_181(7);
				}
			}
	...
	if (iLocal_47 != 7)
	{
		...
		while (iVar0 < Local_131)
		{
			if (DOES_ENTITY_EXIST(Local_131[iVar0 /*18*/]))
			{
				if (IS_VEHICLE_DRIVEABLE(Local_131[iVar0 /*18*/], 0))
				{
					if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_131[iVar0 /*18*/], 0))
...
void func_29()
{
	...
	if (!IS_PED_INJURED(uLocal_86))
	{
		...
		if (((DOES_ENTITY_EXIST(Local_131[iLocal_568 /*18*/]) && IS_VEHICLE_DRIVEABLE(Local_131[iLocal_568 /*18*/], 0)) && DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/])) && !IS_PED_INJURED(Local_204[iVar0 /*18*/]))
		{
			if (IS_VEHICLE_MODEL(Local_131[iLocal_568 /*18*/], joaat("cavalcade2")))
			{
				if (VDIST2(Local_204[iVar0 /*18*/].f_6, vLocal_63) < POW(30f, 2f) && GET_PED_IN_VEHICLE_SEAT(Local_131[iLocal_568 /*18*/], 0, 0) == Local_204[iVar0 /*18*/])
				{
					...
					else if (!func_36(iVar0) && (GET_GAME_TIMER() - Local_204[iVar0 /*18*/].f_13) > 1000)
					{
			...
			else if (!Local_204[iVar0 /*18*/].f_9)
			{
				if (VDIST2(Local_204[iVar0 /*18*/].f_6, vLocal_63) < POW(30f, 2f) && GET_PED_IN_VEHICLE_SEAT(Local_131[iLocal_568 /*18*/], 0, 0) == Local_204[iVar0 /*18*/])
				{
					TASK_SWEEP_AIM_ENTITY(Local_204[iVar0 /*18*/], "random@paparazzi@pap_anims", "sweep_low", "sweep_med", "sweep_high", -1, uLocal_86, 1070134723, 1048576000);
					Local_204[iVar0 /*18*/].f_9 = 1;
					Local_204[iVar0 /*18*/].f_13 = GET_GAME_TIMER();
				}
			}
			else if (Local_204[iVar0 /*18*/].f_9)
			{
				if ((GET_GAME_TIMER() - Local_204[iVar0 /*18*/].f_13) > 2000)
				{
...
void func_30(int iParam0)
{
	...
	if (!IS_PED_INJURED(Local_204[iParam0 /*18*/]) && !IS_PED_INJURED(uLocal_86))
	{
		iVar0 = 15;
...
void func_31(int iParam0, int iParam1)
{
	if (iParam1 < 15)
	{
		if (!IS_BIT_SET(Local_204[iParam0 /*18*/].f_15, iParam1))
		{
			...
			{
				TASK_PLAY_ANIM(Local_204[iParam0 /*18*/], sLocal_373, func_27(iParam0), 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
			}
			else
			{
			...
			SET_BIT(&(Local_204[iParam0 /*18*/].f_15), iParam1);
		}
	}
}
...
void func_37(int iParam0)
{
	...
	if (DOES_ENTITY_EXIST(Local_131[iParam0 /*18*/]) && IS_ENTITY_OCCLUDED(Local_131[iParam0 /*18*/]))
	{
	...
	while (iVar0 <= 1)
	{
		...
		if (DOES_ENTITY_EXIST(Local_204[iVar1 /*18*/]) && IS_ENTITY_OCCLUDED(Local_204[iVar1 /*18*/]))
		{
			if (DOES_ENTITY_EXIST(Local_204[iVar1 /*18*/]))
			{
				DELETE_OBJECT(&(Local_204[iVar1 /*18*/].f_2));
			}
			if (DOES_BLIP_EXIST(Local_204[iVar1 /*18*/].f_1))
			{
				REMOVE_BLIP(&(Local_204[iVar1 /*18*/].f_1));
			}
			DELETE_PED(&(Local_204[iVar1 /*18*/]));
		}
		iVar0++;
	}
}
...
int func_38(int iParam0, float fParam1)
{
	...
	iVar0 = 1;
	if (DOES_ENTITY_EXIST(Local_131[iParam0 /*18*/]))
	{
	...
	if (DOES_ENTITY_EXIST(func_56(iParam0, 0)))
	{
		if (!IS_PED_INJURED(func_56(iParam0, 0)))
		{
			if (VDIST2(vLocal_60, Local_204[func_61(iParam0) /*18*/].f_6) < (fParam1 * fParam1) || !IS_ENTITY_OCCLUDED(func_56(iParam0, 0)))
			{
				iVar0 = 0;
			}
		}
	}
	if (DOES_ENTITY_EXIST(func_56(iParam0, 1)))
	{
		if (!IS_PED_INJURED(func_56(iParam0, 1)))
		{
			if (VDIST2(vLocal_60, Local_204[func_59(iParam0) /*18*/].f_6) < (fParam1 * fParam1) || !IS_ENTITY_OCCLUDED(func_56(iParam0, 1)))
			{
				iVar0 = 0;
			}
		}
...
void func_40(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, vector3 vParam7, int iParam10, float fParam11)
{
	if (DOES_ENTITY_EXIST(iParam0) && IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		if (((((DOES_ENTITY_EXIST(iParam1) && iParam0 != iParam1) && !IS_THIS_MODEL_A_BOAT(GET_ENTITY_MODEL(iParam1))) && !IS_THIS_MODEL_A_PLANE(GET_ENTITY_MODEL(iParam1))) && !IS_THIS_MODEL_A_HELI(GET_ENTITY_MODEL(iParam1))) && !IS_THIS_MODEL_A_TRAIN(GET_ENTITY_MODEL(iParam1)))
		{
			if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(iParam1, 1), *uParam4, 1) > 20f)
			{
				if (func_43(iParam0, iParam1, uLocal_358, GET_ENTITY_COORDS(iParam1, 1), GET_ENTITY_ROTATION(iParam1, 2)))
				{
					*uParam2 = { *uParam4 };
					*uParam3 = *uParam5;
			...
			{
				if ((func_42(iParam0, iParam1, 1) > fParam11 && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(iParam1, 1), *uParam2, 1) > 20f) && VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), *uParam2) > 100f)
				{
					if (!func_41(*uParam2))
					{
						if (!IS_SPHERE_VISIBLE(*uParam2, 6f))
						{
							...
							CLEAR_AREA_OF_VEHICLES(*uParam2, 6f, 0, 0, 0, 0, 0, 0);
...
int func_43(int iParam0, int iParam1, var uParam2, vector3 vParam3, vector3 vParam6)
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	if (DOES_ENTITY_EXIST(uParam2))
	{
		...
		GET_MODEL_DIMENSIONS(GET_ENTITY_MODEL(iParam1), &vVar13, &uVar16);
		...
		SET_ENTITY_COORDS(uParam2, vParam3, 1, 0, 0, 1);
		SET_ENTITY_ROTATION(uParam2, vParam6, 2, 1);
		vVar1 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam2, Vector((fVar23 * 1.25f), ((fVar21 / 2f) - (fVar22 * 0.75f)), 0f) + vVar24) };
		vVar4 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam2, Vector((fVar23 * 1.25f), ((-fVar21 / 2f) + (fVar22 * 0.75f)), 0f) + vVar24) };
		uVar35 = START_SHAPE_TEST_CAPSULE(vVar4, vVar1, fVar22, 19, PLAYER_PED_ID(), 4);
		if (GET_SHAPE_TEST_RESULT(uVar35, &iVar27, &uVar28, &uVar31, &uVar34) != 2)
		{
		}
		if (iVar27 != 0)
		{
...
void func_44()
{
	...
	if ((GET_GAME_TIMER() - iLocal_567) > 100)
	{
		if ((GET_GAME_TIMER() - Local_204[iLocal_566 /*18*/].f_12) > 500)
		{
			if (DOES_ENTITY_EXIST(Local_204[iLocal_566 /*18*/]) && !IS_PED_INJURED(Local_204[iLocal_566 /*18*/]))
			{
				bVar0 = true;
				...
				if (bVar0)
				{
					...
					{
						START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_rcpap1_camera", Local_204[iLocal_566 /*18*/].f_2, 0.019f, -0.01f, 0.046f, 0f, 0f, -180f, 1065353216, 0, 0, 0);
						if ((iLocal_566 % 3) == 0)
						{
						...
						Local_204[iLocal_566 /*18*/].f_12 = GET_GAME_TIMER();
					}
					iLocal_567 = GET_GAME_TIMER();
				}
			}
			iLocal_566++;
...
{
	if (!IS_PED_INJURED(Local_204[iParam1 /*18*/]) && !IS_PED_INJURED(uParam0))
	{
		if (!IS_PED_FACING_PED(Local_204[iParam1 /*18*/], uParam0, 20f))
		{
			if (GET_SCRIPT_TASK_STATUS(Local_204[iParam1 /*18*/], -875674219) != 1)
			{
				TASK_TURN_PED_TO_FACE_ENTITY(Local_204[iParam1 /*18*/], uParam0, 0);
			}
		}
		else if ((GET_GAME_TIMER() - Local_204[iParam1 /*18*/].f_13) > 2000)
		{
			if (!IS_ENTITY_PLAYING_ANIM(Local_204[iParam1 /*18*/], sLocal_373, func_27(iParam1), 3))
			{
				...
				Local_204[iParam1 /*18*/].f_13 = GET_GAME_TIMER();
			}
		}
	}
}
...
void func_46(var uParam0, int iParam1)
{
	...
	if (!IS_PED_INJURED(Local_204[iParam1 /*18*/]) && !IS_PED_INJURED(uParam0))
	{
		vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, func_48(iParam1)) };
		switch (Local_204[iParam1 /*18*/].f_16)
		{
			case 0:
				func_47(vVar0, iParam1, uParam0);
...
void func_47(vector3 vParam0, int iParam3, var uParam4)
{
	vector3 vVar0;
	var uVar3;
	
	vVar0 = { func_35(GET_ENTITY_COORDS(uParam4, 1) - vParam0) };
	uVar3 = GET_HEADING_FROM_VECTOR_2D(vVar0.x, vVar0.y);
	Local_204[iParam3 /*18*/].f_3 = { vParam0 };
	CLEAR_PED_TASKS(Local_204[iParam3 /*18*/]);
	if (VDIST(vParam0, Local_204[iParam3 /*18*/].f_6) < 2f)
	{
		TASK_FOLLOW_NAV_MESH_TO_COORD(Local_204[iParam3 /*18*/], Local_204[iParam3 /*18*/].f_3, 1f, -1, 0.5f, 512, uVar3);
	}
	else
	{
		TASK_FOLLOW_NAV_MESH_TO_COORD(Local_204[iParam3 /*18*/], Local_204[iParam3 /*18*/].f_3, 2f, -1, 0.5f, 512, uVar3);
	}
}
...
void func_49()
{
	...
	while (iVar0 < Local_204)
	{
		...
		{
			if (IS_PED_INJURED(Local_204[iVar0 /*18*/]))
			{
		...
		else if (!IS_PED_INJURED(Local_204[iVar0 /*18*/]) && !IS_PED_IN_ANY_VEHICLE(Local_204[iVar0 /*18*/], 0))
		{
...
var func_50(vector3 vParam0, int iParam3)
{
	var uVar0;
	
	uVar0 = ADD_BLIP_FOR_COORD(vParam0);
	SET_BLIP_SCALE(uVar0, func_51(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
int func_52(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam4 || !IS_ENTITY_DEAD(uParam0, 0))
	{
		...
		while (iVar0 < iVar1)
		{
			iVar2 = func_53(uParam0, (iVar0 - 1), bParam6, iParam7);
...
int func_53(var uParam0, int iParam1, bool bParam2, var uParam3)
{
	int iVar0;
...
void func_54(int iParam0, vector3 vParam1, float fParam4, char* sParam5, char* sParam6, int iParam7)
{
	if (!IS_PED_INJURED(Local_204[iParam0 /*18*/]))
	{
		if (VDIST(GET_ENTITY_COORDS(Local_204[iParam0 /*18*/], 1), vParam1) > 1.5f)
		{
			if (GET_SCRIPT_TASK_STATUS(Local_204[iParam0 /*18*/], 713668775) != 1)
			{
				TASK_FOLLOW_NAV_MESH_TO_COORD(Local_204[iParam0 /*18*/], vParam1, 2f, -1, 0.25f, 0, fParam4);
			}
		}
		else if (ABSF((func_55(GET_ENTITY_HEADING(Local_204[iParam0 /*18*/])) - func_55(fParam4))) > 10f)
		{
			if (GET_SCRIPT_TASK_STATUS(Local_204[iParam0 /*18*/], 1920390111) != 1)
			{
				TASK_ACHIEVE_HEADING(Local_204[iParam0 /*18*/], fParam4, 0);
			}
		}
		else
		{
			switch (Local_204[iParam0 /*18*/].f_16)
			{
				case 0:
					...
					{
						if (!IS_ENTITY_PLAYING_ANIM(Local_204[iParam0 /*18*/], sParam5, sParam6, 3))
						{
							TASK_PLAY_ANIM(Local_204[iParam0 /*18*/], sParam5, sParam6, 4f, -4f, -1, 1, 0, 0, 0, 0);
						}
					}
					else if (!IS_ENTITY_PLAYING_ANIM(Local_204[iParam0 /*18*/], sParam5, sParam6, 3))
					{
						TASK_PLAY_ANIM(Local_204[iParam0 /*18*/], sParam5, sParam6, 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else if (GET_ENTITY_ANIM_CURRENT_TIME(Local_204[iParam0 /*18*/], sParam5, sParam6) > 0.99f)
					{
						TASK_PLAY_ANIM(Local_204[iParam0 /*18*/], sParam5, iParam7, 4f, -4f, -1, 0, 0, 0, 0, 0);
						Local_204[iParam0 /*18*/].f_16++;
					}
					break;
				
				case 1:
					if (!IS_ENTITY_PLAYING_ANIM(Local_204[iParam0 /*18*/], sParam5, iParam7, 3))
					{
						TASK_PLAY_ANIM(Local_204[iParam0 /*18*/], sParam5, iParam7, 4f, -4f, -1, 0, 0, 0, 0, 0);
					}
					else if (GET_ENTITY_ANIM_CURRENT_TIME(Local_204[iParam0 /*18*/], sParam5, iParam7) > 0.99f)
					{
						TASK_PLAY_ANIM(Local_204[iParam0 /*18*/], sParam5, sParam6, 4f, -4f, -1, 0, 0, 0, 0, 0);
...
void func_57(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	if ((iParam0 % 2) == 1)
	{
		Local_131[iParam0 /*18*/] = CREATE_VEHICLE(joaat("vader"), vParam1, fParam4, 1, 1, 0);
	}
	else
	{
		Local_131[iParam0 /*18*/] = CREATE_VEHICLE(joaat("cavalcade2"), vParam1, fParam4, 1, 1, 0);
		SET_VEHICLE_COLOUR_COMBINATION(Local_131[iParam0 /*18*/], 0);
	}
	SET_VEHICLE_ON_GROUND_PROPERLY(Local_131[iParam0 /*18*/], 1084227584);
	SET_VEHICLE_STRONG(Local_131[iParam0 /*18*/], 1);
	if (bParam5)
	{
		if (!DOES_ENTITY_EXIST(func_56(iParam0, 0)))
		{
		...
		if (!IS_PED_INJURED(func_56(iParam0, 0)) && IS_VEHICLE_DRIVEABLE(Local_131[iParam0 /*18*/], 0))
		{
			SET_PED_INTO_VEHICLE(func_56(iParam0, 0), Local_131[iParam0 /*18*/], -1);
		}
		if (!IS_PED_INJURED(func_56(iParam0, 1)) && IS_VEHICLE_DRIVEABLE(Local_131[iParam0 /*18*/], 0))
		{
			SET_PED_INTO_VEHICLE(func_56(iParam0, 1), Local_131[iParam0 /*18*/], 0);
		}
		SET_VEHICLE_ENGINE_ON(Local_131[iParam0 /*18*/], 1, 1, 0);
	}
}

void func_58(int iParam0, vector3 vParam1, float fParam4)
{
	Local_204[iParam0 /*18*/] = CREATE_PED(26, joaat("a_m_y_genstreet_02"), vParam1, fParam4, 1, 1);
	SET_PED_COMBAT_ATTRIBUTES(Local_204[iParam0 /*18*/], 1, 0);
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_204[iParam0 /*18*/], 1);
	SET_PED_COMBAT_ATTRIBUTES(Local_204[iParam0 /*18*/], 0, 1);
	SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(Local_204[iParam0 /*18*/], 3);
	SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_204[iParam0 /*18*/], 1);
	SET_PED_COMBAT_ATTRIBUTES(Local_204[iParam0 /*18*/], 17, 1);
	SET_PED_FLEE_ATTRIBUTES(Local_204[iParam0 /*18*/], 2, 0);
	_SET_ENTITY_SOMETHING(Local_204[iParam0 /*18*/], 0);
	SET_PED_KEEP_TASK(Local_204[iParam0 /*18*/], 1);
	SET_PED_SHOOT_RATE(Local_204[iParam0 /*18*/], 100);
	SET_PED_FIRING_PATTERN(Local_204[iParam0 /*18*/], -957453492);
	SET_PED_CONFIG_FLAG(Local_204[iParam0 /*18*/], 101, 1);
	SET_PED_CONFIG_FLAG(Local_204[iParam0 /*18*/], 185, 0);
	SET_ENTITY_HEALTH(Local_204[iParam0 /*18*/], 300, 0);
	SET_PED_COMPONENT_VARIATION(Local_204[iParam0 /*18*/], 3, (iParam0 % 2), FLOOR((TO_FLOAT(iParam0) / 2f)), 0);
	if (Global_3 || bLocal_70)
	{
		SET_ENTITY_INVINCIBLE(Local_204[iParam0 /*18*/], 1);
		SET_ENTITY_HEALTH(Local_204[iParam0 /*18*/], 500, 0);
	}
	SET_PED_TARGET_LOSS_RESPONSE(Local_204[iParam0 /*18*/], 1);
	SET_PED_COMBAT_ATTRIBUTES(Local_204[iParam0 /*18*/], 2, 1);
	SET_PED_MAX_MOVE_BLEND_RATIO(Local_204[iParam0 /*18*/], 2f);
	_SET_ENTITY_SOMETHING(Local_204[iParam0 /*18*/], 0);
	SET_PED_HELMET(Local_204[iParam0 /*18*/], 0);
	Local_204[iParam0 /*18*/].f_2 = CREATE_OBJECT(joaat("prop_pap_camera_01"), GET_PED_BONE_COORDS(Local_204[iParam0 /*18*/], 28422, 0f, 0f, 0f), 1, 1, 0);
	...
	if (DOES_ENTITY_EXIST(Local_204[0 /*18*/].f_2))
	{
		SET_ENTITY_VISIBLE(Local_204[0 /*18*/].f_2, 0, 0);
	}
...
int func_63()
{
	...
	if (!IS_PED_INJURED(uLocal_86))
	{
		...
		if (func_66())
		{
			if (DOES_ENTITY_EXIST(func_65()))
			{
				if (VDIST(GET_ENTITY_COORDS(func_65(), 1), vLocal_63) < 5f && GET_ENTITY_SPEED(iLocal_91) < 1f)
				{
					bVar0 = true;
				}
			}
		...
		{
			if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_91, 0) && IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 0))
			{
				fLocal_570 = (fLocal_570 + GET_FRAME_TIME());
			}
		...
		if (bVar0)
		{
			fLocal_569 = (fLocal_569 + GET_FRAME_TIME());
		}
		...
		if (iLocal_71)
		{
			if (!IS_PED_SITTING_IN_VEHICLE(uLocal_86, iLocal_91))
			{
				if (IS_PED_RAGDOLL(uLocal_86))
				{
					bVar1 = true;
				}
				iLocal_71 = 0;
		...
		if (!IS_VEHICLE_DRIVEABLE(iLocal_91, 0) && (!bLocal_368 || iLocal_47 == 1))
		{
			bVar1 = true;
		}
		...
		if (((IS_VEHICLE_DRIVEABLE(iLocal_91, 0) && func_64(iLocal_91)) && (!bLocal_368 || iLocal_47 == 1)) && VDIST(GET_ENTITY_COORDS(uLocal_86, 1), vLocal_56) > 15f)
		{
			bVar1 = true;
		}
...
int func_66()
{
	if (IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
	{
		if (!IS_PED_INJURED(uLocal_86))
		{
			if (IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 0) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_91, 0))
			{
				return 1;
			}
		}
...
int func_67()
{
	...
	while (iVar0 < Local_204)
	{
		...
		if (DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/]))
		{
			if (IS_PED_INJURED(Local_204[iVar0 /*18*/]) || IS_ENTITY_DEAD(Local_204[iVar0 /*18*/], 0))
			{
...
int func_68(var uParam0, int iParam1, bool bParam2)
{
	...
	if (!IS_PED_INJURED(uParam0))
	{
		...
		if (VDIST2(vVar0, vLocal_60) < 400f)
		{
			if (!bParam2)
			{
				if ((IS_PED_ARMED(PLAYER_PED_ID(), 6) && !IS_PED_CURRENT_WEAPON_SILENCED(PLAYER_PED_ID())) && IS_PED_SHOOTING(PLAYER_PED_ID()))
				{
					return 1;
				}
			}
			if ((iVar3 == joaat("weapon_petrolcan") && IS_PED_SHOOTING(PLAYER_PED_ID())) && VDIST2(vLocal_60, vVar0) < 9f)
			{
				return 1;
			}
			if (((IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uParam0) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uParam0)) && (func_69(vLocal_60, uParam0) && VDIST2(vLocal_60, GET_ENTITY_COORDS(uParam0, 1)) < 100f)) && IS_PED_ARMED(PLAYER_PED_ID(), 6))
			{
				return 1;
			}
			if (iLocal_385 > 150)
		...
		if (_0x2F09F7976C512404(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f), 6f))
		{
			return 1;
		}
	}
	else if (DOES_ENTITY_EXIST(uParam0) && iParam1)
	{
		return 1;
	}
	return 0;
...
int func_69(vector3 vParam0, var uParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	vVar0 = { GET_ENTITY_COORDS(uParam3, 1) };
	vVar3 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam3, 0f, 1f, 0f) - vVar0 };
	vVar6 = { vParam0 - vVar0 };
...
void func_71()
{
	if (iLocal_47 != 11)
	{
		if (DOES_BLIP_EXIST(uLocal_362))
		{
			REMOVE_BLIP(&uLocal_362);
		}
		if (DOES_BLIP_EXIST(uLocal_363))
		{
			REMOVE_BLIP(&uLocal_363);
		}
		if (DOES_BLIP_EXIST(uLocal_360))
		{
...
{
	if ((GET_GAME_TIMER() - iLocal_667) > 5000)
	{
		if (!func_73())
		{
			if (func_5(&Local_395, cLocal_372, sParam0, 4, 0, 0, 0))
			{
				iLocal_667 = GET_GAME_TIMER();
			}
		}
	}
}
...
bool func_74()
{
	if (!IS_PED_INJURED(uLocal_86) && VDIST2(vLocal_60, vLocal_63) < 400f)
	{
		if (!iLocal_350 && (GET_GAME_TIMER() - iLocal_352) > 5000)
		{
			if (iLocal_82 > 10)
			{
				iLocal_350 = 1;
		...
		if ((!iLocal_355 && !iLocal_350) && (GET_GAME_TIMER() - iLocal_356) > 4000)
		{
		...
		if (((!iLocal_353 && !iLocal_350) && !iLocal_355) && (GET_GAME_TIMER() - iLocal_354) > 15000)
		{
...
void func_75()
{
	if (!IS_PED_INJURED(uLocal_86))
	{
		...
		SET_RELATIONSHIP_BETWEEN_GROUPS(255, uLocal_69, 1862763509);
		if (!Global_3 && !bLocal_70)
		{
			SET_PED_CONFIG_FLAG(uLocal_86, 317, 1);
...
void func_82()
{
	...
	if (!DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_71590)
		{
			if (func_83() == 2 == 0 && !NETWORK_IS_GAME_IN_PROGRESS())
			{
...
void func_100()
{
	...
	switch (iLocal_369)
	{
		case 0:
			if (!IS_PED_INJURED(uLocal_86))
			{
				TASK_SMART_FLEE_PED(uLocal_86, PLAYER_PED_ID(), 300f, -1, 0, 0);
			}
			iVar0 = 0;
			while (iVar0 < Local_204)
			{
				if (DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/]))
				{
					if (IS_ENTITY_OCCLUDED(Local_204[iVar0 /*18*/]) && VDIST2(GET_ENTITY_COORDS(Local_204[iVar0 /*18*/], 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) > 900f)
					{
						if (DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/].f_2))
						{
			...
			while (iVar0 < Local_131)
			{
				if (DOES_ENTITY_EXIST(Local_131[iVar0 /*18*/]))
				{
					if (IS_ENTITY_OCCLUDED(Local_131[iVar0 /*18*/]) && VDIST2(GET_ENTITY_COORDS(Local_131[iVar0 /*18*/], 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) > 900f)
					{
		...
		case 1:
			...
			while (iVar0 < Local_204)
			{
				if ((DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/]) && !IS_PED_INJURED(Local_204[iVar0 /*18*/])) && !IS_ENTITY_DEAD(Local_204[iVar0 /*18*/], 0))
				{
					iVar1++;
					func_46(PLAYER_PED_ID(), iVar0);
					if (IS_ENTITY_OCCLUDED(Local_204[iVar0 /*18*/]) && VDIST2(GET_ENTITY_COORDS(Local_204[iVar0 /*18*/], 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) > 2500f)
					{
						if (DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/].f_2))
						{
							DELETE_OBJECT(&(Local_204[iVar0 /*18*/].f_2));
			...
			if (!iLocal_673)
			{
				if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(func_65(), 1)) < 100f)
				{
					...
					if (func_19() == 1)
					{
						...
						switch (iVar2)
						{
							case 0:
								...
								if (DOES_ENTITY_EXIST(Local_395[6 /*10*/]) && !IS_PED_INJURED(Local_395[6 /*10*/]))
								{
							...
							case 1:
								...
								if (DOES_ENTITY_EXIST(Local_395[7 /*10*/]) && !IS_PED_INJURED(Local_395[7 /*10*/]))
								{
							...
							case 2:
								...
								if (DOES_ENTITY_EXIST(Local_395[8 /*10*/]) && !IS_PED_INJURED(Local_395[8 /*10*/]))
								{
					...
					else if (func_19() == 2)
					{
						...
						switch (iVar2)
						{
							case 0:
								func_17(&Local_395, 6, func_65(), "PAP1ESCAPE", 0, 1);
								if (DOES_ENTITY_EXIST(Local_395[iVar2 /*10*/]) && !IS_PED_INJURED(Local_395[iVar2 /*10*/]))
								{
...
void func_101(char* sParam0)
{
		...
		if (DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/]))
		{
			if (!IS_PED_INJURED(Local_204[iVar0 /*18*/]))
			{
				...
				if (!IS_PED_INJURED(uLocal_86))
				{
					if (IS_PED_IN_ANY_VEHICLE(Local_204[iVar0 /*18*/], 0))
					{
						TASK_LEAVE_ANY_VEHICLE(Local_204[iVar0 /*18*/], 0, 0);
					}
					else
					{
						func_46(uLocal_86, iVar0);
					}
				}
			...
			if ((IS_ENTITY_OCCLUDED(Local_204[iVar0 /*18*/]) && VDIST2(GET_ENTITY_COORDS(Local_204[iVar0 /*18*/], 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) > 400f) && VDIST2(GET_ENTITY_COORDS(Local_204[iVar0 /*18*/], 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) > 400f)
			{
				DELETE_PED(&(Local_204[iVar0 /*18*/]));
				if (DOES_ENTITY_EXIST(Local_204[iVar0 /*18*/].f_2))
				{
	...
	while (iVar0 < Local_131)
	{
		if (DOES_ENTITY_EXIST(Local_131[iVar0 /*18*/]))
		{
			if ((IS_ENTITY_OCCLUDED(Local_131[iVar0 /*18*/]) && VDIST2(GET_ENTITY_COORDS(Local_131[iVar0 /*18*/], 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) > 2500f) && func_52(Local_131[iVar0 /*18*/], 0, 0, 0, 0, 0, 1, 0, 1))
			{
	...
	if (DOES_ENTITY_EXIST(uLocal_86))
	{
		if (IS_ENTITY_OCCLUDED(uLocal_86) && VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_63) > 2500f)
		{
			SET_PED_AS_NO_LONGER_NEEDED(&uLocal_86);
			func_274();
		}
	}
	if (func_67() || func_68(uLocal_86, 1, 1))
	{
		func_181(5);
	}
	iVar0 = 0;
	...
	switch (iLocal_369)
	{
		case 0:
			...
			if (DOES_BLIP_EXIST(uLocal_361))
			{
				REMOVE_BLIP(&uLocal_361);
			}
			if (!IS_PED_INJURED(uLocal_86))
			{
				CLEAR_PED_TASKS(uLocal_86);
				SET_PED_MAX_MOVE_BLEND_RATIO(uLocal_86, 3f);
			}
			func_102();
		...
		case 1:
			if (((IS_VEHICLE_DRIVEABLE(iLocal_91, 0) && IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 0)) && !bLocal_368) && IS_VEHICLE_SEAT_FREE(iLocal_91, -1, 0))
			{
				if (VDIST(vLocal_63, vLocal_53) < 100f)
				{
					OPEN_SEQUENCE_TASK(&uVar2);
					TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(0, iLocal_91, 0);
					TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_91, vLocal_53, 20f, 0, joaat("serrano"), 786599, 10f, 10f);
					TASK_VEHICLE_PARK(0, iLocal_91, vLocal_53, 288.7089f, 1, 50f, 0);
					TASK_VEHICLE_MISSION_COORS_TARGET(0, iLocal_91, GET_ENTITY_COORDS(iLocal_91, 1), 5, 10f, 262144, 2f, 2f, 1);
					TASK_LEAVE_VEHICLE(0, iLocal_91, 0);
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_56, 1f, -1, 0.25f, 512, fLocal_59);
					TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_SMOKING", 0, 1);
					CLOSE_SEQUENCE_TASK(uVar2);
					TASK_PERFORM_SEQUENCE(uLocal_86, uVar2);
				...
				else
				{
					...
					TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(0, iLocal_91, 0);
					TASK_VEHICLE_DRIVE_WANDER(0, iLocal_91, 15f, 786468);
					CLOSE_SEQUENCE_TASK(uVar3);
					TASK_PERFORM_SEQUENCE(uLocal_86, uVar3);
			...
			{
				if (IS_PED_IN_ANY_VEHICLE(uLocal_86, 0))
				{
					TASK_LEAVE_ANY_VEHICLE(uLocal_86, 0, 0);
				}
				iLocal_369++;
			}
			break;
		...
		case 2:
			if (iVar1 > 0)
			{
				TASK_SMART_FLEE_PED(uLocal_86, PLAYER_PED_ID(), 3000f, -1, 1, 0);
				iLocal_369 = 1000;
			}
			else
			{
				if (VDIST(vLocal_63, vLocal_53) < 100f)
				{
					...
					TASK_PERFORM_SEQUENCE(uLocal_86, uVar4);
					CLEAR_SEQUENCE_TASK(&uVar4);
				}
				else
				{
					TASK_WANDER_STANDARD(uLocal_86, 1193033728, 0);
				}
				iLocal_369 = 1000;
			}
			break;
...
{
	func_102();
	if (!IS_PED_INJURED(uLocal_86) && VDIST2(vLocal_60, vLocal_63) < 900f)
	{
		CLEAR_PED_TASKS(uLocal_86);
		...
		SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_86, -2065892691);
	}
	else
	{
		func_193();
	...
	switch (iLocal_369)
	{
		case 0:
			...
			if (!IS_PED_INJURED(uLocal_86))
			{
				...
				TASK_LEAVE_VEHICLE(0, iLocal_91, 0);
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_56, 1f, 30000, 0.25f, 512, fLocal_59);
				TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_SMOKING", 0, 1);
				CLOSE_SEQUENCE_TASK(uVar0);
				TASK_PERFORM_SEQUENCE(uLocal_86, uVar0);
				CLEAR_SEQUENCE_TASK(&uVar0);
				if (IS_PED_IN_GROUP(uLocal_86))
				{
					REMOVE_PED_FROM_GROUP(uLocal_86);
				}
				func_102();
				iLocal_369++;
			}
		...
		case 1:
			if (!func_73() && !IS_PED_INJURED(uLocal_86))
			{
				if (IS_ENTITY_AT_COORD(uLocal_86, vLocal_56, 3f, 3f, 3f, 0, 1, 0) && IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_56, 5f, 5f, 5f, 0, 1, 0))
				{
					iLocal_369++;
				}
			}
...
void func_111(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_113() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_113() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_112(iParam0));
...
int func_117(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_113() /*10778*/].f_6165.f_10, iParam0);
}
...
int func_118(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2539502[iParam0 /*3*/][func_115(iParam1)];
...
void func_139(bool bParam0)
{
	if (!IS_PED_INJURED(uLocal_86))
	{
		if (iLocal_621 > 1)
		{
			if (!IS_PED_FACING_PED(uLocal_86, PLAYER_PED_ID(), 60f))
			{
				iLocal_621 = 0;
				iLocal_622 = 0;
			}
		...
		switch (iLocal_621)
		{
			case 0:
				CLEAR_PED_TASKS(uLocal_86);
				TASK_LOOK_AT_ENTITY(uLocal_86, PLAYER_PED_ID(), -1, 16, 2);
				OPEN_SEQUENCE_TASK(&uLocal_620);
				TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), 0);
				TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), -1, 16, 2);
				CLOSE_SEQUENCE_TASK(uLocal_620);
				TASK_PERFORM_SEQUENCE(uLocal_86, uLocal_620);
				CLEAR_SEQUENCE_TASK(&uLocal_620);
				iLocal_621++;
				break;
			
			case 1:
				if (GET_SCRIPT_TASK_STATUS(uLocal_86, 242628503) != 1)
				{
					iLocal_621++;
				}
				break;
			...
			case 2:
				if (bParam0)
				{
					...
					{
						case 0:
							if (!IS_ENTITY_PLAYING_ANIM(uLocal_86, "random@paparazzi@wait", "wait_a", 3))
							{
								TASK_PLAY_ANIM(uLocal_86, "random@paparazzi@wait", "wait_a", 4f, -4f, -1, 0, 0, 0, 0, 0);
							}
							else if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_86, "random@paparazzi@wait", "wait_a") > 0.95f)
							{
								TASK_PLAY_ANIM(uLocal_86, "random@paparazzi@wait", "wait_b", 4f, -4f, -1, 0, 0, 0, 0, 0);
								iLocal_622++;
							}
							break;
						
						case 1:
							if (!IS_ENTITY_PLAYING_ANIM(uLocal_86, "random@paparazzi@wait", "wait_b", 3))
							{
								TASK_PLAY_ANIM(uLocal_86, "random@paparazzi@wait", "wait_b", 4f, -4f, -1, 0, 0, 0, 0, 0);
							}
							else if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_86, "random@paparazzi@wait", "wait_b") > 0.95f)
							{
								TASK_PLAY_ANIM(uLocal_86, "random@paparazzi@wait", "wait_c", 4f, -4f, -1, 0, 0, 0, 0, 0);
								iLocal_622++;
							}
							break;
						
						case 2:
							if (!IS_ENTITY_PLAYING_ANIM(uLocal_86, "random@paparazzi@wait", "wait_c", 3))
							{
								TASK_PLAY_ANIM(uLocal_86, "random@paparazzi@wait", "wait_c", 4f, -4f, -1, 0, 0, 0, 0, 0);
							}
							else if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_86, "random@paparazzi@wait", "wait_c") > 0.95f)
							{
								TASK_PLAY_ANIM(uLocal_86, "random@paparazzi@wait", "wait_a", 4f, -4f, -1, 0, 0, 0, 0, 0);
								iLocal_622 = 0;
							}
...
void func_140()
{
	if (DOES_BLIP_EXIST(uLocal_364))
	{
		REMOVE_BLIP(&uLocal_364);
	}
}
...
void func_141()
{
	...
	if (IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
	{
		...
		{
			case 0:
				if (!IS_PED_INJURED(uLocal_86) && IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
				{
					func_140();
					...
					if (!IS_PED_INJURED(uLocal_86))
					{
						TASK_LOOK_AT_COORD(uLocal_86, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_91, -10f, 5f, 0f), -1, 16, 4);
					}
					TASK_LOOK_AT_COORD(PLAYER_PED_ID(), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_91, 10f, 5f, 0f), 15000, 16, 4);
					SET_PLAYER_CONTROL(PLAYER_ID(), 0, 1280);
					...
					{
						TASK_LOOK_AT_COORD(uLocal_86, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_91, -10f, 5f, 0f), -1, 16, 4);
						_0x2208438012482A1A(uLocal_86, 0, 0);
					}
					TASK_LOOK_AT_COORD(PLAYER_PED_ID(), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_91, 10f, 5f, 0f), 15000, 16, 4);
					iLocal_369++;
				}
			...
			case 2:
				if (!IS_PED_INJURED(uLocal_86) && IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
				{
					if (!IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 0))
					{
						SETTIMERA(0);
						if (bLocal_368)
						{
			...
			case 3:
				if ((!IS_PED_INJURED(uLocal_86) && IS_VEHICLE_DRIVEABLE(iLocal_91, 0)) && TIMERA() > 1000)
				{
					TASK_LEAVE_VEHICLE(PLAYER_PED_ID(), iLocal_91, 0);
					TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), iLocal_91, 10000, 0, 3);
					iLocal_369++;
				}
				break;
			
			case 4:
				if (IS_VEHICLE_DRIVEABLE(iLocal_91, 0) && !IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_91, 0))
				{
					SET_PLAYER_CONTROL(PLAYER_ID(), 1, 0);
					func_145(0, 1, 0, 0, 0, 0);
...
void func_145(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_149(PLAYER_ID())) && !func_147(PLAYER_ID(), 0)) && !func_146()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_149(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
...
void func_153()
{
	...
	if (bLocal_368 && !IS_PED_INJURED(uLocal_86))
	{
		if (!func_174(uLocal_86))
		{
			if (!DOES_BLIP_EXIST(uLocal_360))
			{
				uLocal_360 = func_183(uLocal_86, 0, 145);
		...
		else
		{
			if (func_66())
			{
				if (!DOES_BLIP_EXIST(uLocal_362))
				{
					uLocal_362 = func_50(vLocal_53, 1);
				}
				if (DOES_BLIP_EXIST(uLocal_363))
				{
					REMOVE_BLIP(&uLocal_363);
			...
			else
			{
				if (!DOES_BLIP_EXIST(uLocal_363))
				{
					uLocal_363 = func_50(vLocal_56, 1);
				}
				if (DOES_BLIP_EXIST(uLocal_362))
				{
					REMOVE_BLIP(&uLocal_362);
		...
		if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_91, 0))
		{
			if ((IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && IS_VEHICLE_DRIVEABLE(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0)) && func_173(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)))
			{
				iLocal_91 = 0;
				iLocal_91 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
				SET_ENTITY_AS_MISSION_ENTITY(iLocal_91, 1, 1);
				SET_VEHICLE_DOORS_LOCKED(iLocal_91, 1);
				SET_VEHICLE_AUTOMATICALLY_ATTACHES(iLocal_91, 0, 0);
			}
		}
		if (DOES_BLIP_EXIST(uLocal_363) && !IS_PED_IN_ANY_VEHICLE(uLocal_86, 0))
		{
			if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_56, 15f, 15f, 15f, 0, 1, 0) || IS_ENTITY_AT_COORD(PLAYER_PED_ID(), 231.7982f, 672.7683f, 189.2f, 1f, 1f, 2.5f, 1, 1, 0))
			{
				func_181(4);
			}
		}
		else if (iLocal_369 != 100)
		{
			...
			{
				if (IS_ENTITY_IN_ANGLED_AREA(iLocal_91, 225.5938f, 681.1489f, 188.4262f, 232.02f, 681.3113f, 191.9843f, 8.75f, 0, 1, 0) || IS_ENTITY_AT_COORD(PLAYER_PED_ID(), 226.6788f, 681.0637f, 189f, 1f, 1f, 2.5f, 1, 1, 0))
				{
					SETTIMERA(0);
					iLocal_369 = 100;
				}
			}
			else if (!IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 0))
			{
				if (GET_SCRIPT_TASK_STATUS(uLocal_86, -1794415470) != 1)
				{
					TASK_ENTER_VEHICLE(uLocal_86, iLocal_91, -1, func_171(iLocal_91), 2f, 8388608, 0);
				}
			}
		}
	}
	...
	switch (iLocal_369)
	{
		case 0:
			if (func_66())
			{
				if (IS_ENTITY_PLAYING_ANIM(uLocal_86, "VEH@STD@PS@IDLE_PANIC", "sit", 3) || IS_ENTITY_PLAYING_ANIM(uLocal_86, "VEH@LOW@FRONT_PS@IDLE_PANIC", "sit", 3))
				{
					CLEAR_PED_TASKS(uLocal_86);
				}
	...
	if (func_19() == 2)
	{
		if ((func_154() && !func_167()) && iLocal_47 != 8)
		{
			if (!IS_PED_INJURED(uLocal_86))
			{
				if (IS_ENTITY_AT_COORD(uLocal_86, -1034.6f, 4918.6f, 205.9f, 5f, 5f, 5f, 0, 1, 0))
				{
					if (!IS_PED_GROUP_MEMBER(uLocal_86, GET_PLAYER_GROUP(PLAYER_ID())))
					{
						SET_PED_AS_GROUP_MEMBER(uLocal_86, GET_PLAYER_GROUP(PLAYER_ID()));
					}
					func_102();
					iLocal_47 = 8;
				}
...
int func_155(int iParam0, int iParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	{
		_SET_VEHICLE_HALT(iParam0, iParam1, iParam2, iParam4);
	}
...
int func_158(char* sParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		if ((iLocal_72 && !iLocal_73) && bParam1)
		{
			...
			else if ((GET_GAME_TIMER() - iLocal_81) > 500)
			{
				iLocal_81 = -1;
				iLocal_72 = 0;
				iLocal_73 = 0;
...
int func_161()
{
	if (bLocal_368)
	{
		...
		if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !IS_PED_IN_ANY_VEHICLE(uLocal_86, 0))
		{
...
void func_162()
{
	if (func_19() == 2)
	{
		...
		{
			func_165();
			uLocal_364 = func_164(-1034.6f, 4918.6f, 205.9f, 0);
			SET_BLIP_SPRITE(uLocal_364, 269);
			func_163();
		}
	}
}
...
var func_164(vector3 vParam0, int iParam3)
{
...
{
	if (IS_VEHICLE_DRIVEABLE(iLocal_91, 0) && !IS_PED_INJURED(uLocal_86))
	{
		if (func_66())
		{
			if (bParam0)
		...
		else
		{
			...
			if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_91, 0))
			{
				if (!DOES_BLIP_EXIST(uLocal_361))
				{
					uLocal_361 = func_169(iLocal_91, 0, 0);
				}
			}
			if (!IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 0))
			{
			...
			else if (DOES_BLIP_EXIST(uLocal_360))
			{
				REMOVE_BLIP(&uLocal_360);
			}
		}
...
int func_170(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_51(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
int func_171(int iParam0)
{
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		while (iVar1 <= (GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(iParam0) - 1))
		{
			...
			{
				iVar2 = iVar1;
				if (IS_VEHICLE_SEAT_FREE(iParam0, iVar2, 0))
				{
					iVar0 = iVar2;
				}
			}
...
{
	if (IS_PED_GROUP_MEMBER(uParam0, GET_PLAYER_GROUP(PLAYER_ID())))
	{
		if (!IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uParam0, 25f, 25f, 25f, 0, 1, 0))
		{
			REMOVE_PED_FROM_GROUP(uParam0);
		}
		return 1;
	}
	else if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uParam0, Global_19, 0, 1, 0))
	{
		SET_PED_AS_GROUP_MEMBER(uParam0, GET_PLAYER_GROUP(PLAYER_ID()));
	}
	return 0;
}
...
void func_175()
{
	if (!IS_PED_INJURED(uLocal_86) && IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
	{
		if (!IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 1))
		{
			if (GET_SCRIPT_TASK_STATUS(uLocal_86, -1794415470) != 1)
			{
				TASK_ENTER_VEHICLE(uLocal_86, iLocal_91, -1, func_171(iLocal_91), 2f, 8388608, 0);
		...
		if ((DOES_ENTITY_EXIST(func_65()) && VDIST2(GET_ENTITY_COORDS(uLocal_86, 1), GET_ENTITY_COORDS(func_65(), 1)) < 100f) && (GET_ENTITY_SPEED(iLocal_91) < 5f || !IS_THIS_MODEL_A_BIKE(GET_ENTITY_MODEL(iLocal_91))))
		{
			if (bLocal_368)
			{
				if (!IS_ENTITY_PLAYING_ANIM(uLocal_86, "VEH@STD@PS@IDLE_PANIC", "sit", 3) && IS_PED_SITTING_IN_VEHICLE(uLocal_86, iLocal_91))
				{
					TASK_PLAY_ANIM(uLocal_86, "VEH@STD@PS@IDLE_PANIC", "sit", 4f, -4f, -1, 48, 0, 0, 0, 0);
				}
			}
			else if (!IS_ENTITY_PLAYING_ANIM(uLocal_86, "VEH@LOW@FRONT_PS@IDLE_PANIC", "sit", 3) && IS_PED_SITTING_IN_VEHICLE(uLocal_86, iLocal_91))
			{
				TASK_PLAY_ANIM(uLocal_86, "VEH@LOW@FRONT_PS@IDLE_PANIC", "sit", 4f, -4f, -1, 48, 0, 0, 0, 0);
			}
		}
		else if ((IS_ENTITY_PLAYING_ANIM(uLocal_86, "VEH@STD@PS@IDLE_PANIC", "sit", 3) || IS_ENTITY_PLAYING_ANIM(uLocal_86, "VEH@LOW@FRONT_PS@IDLE_PANIC", "sit", 3)) && IS_PED_SITTING_IN_VEHICLE(uLocal_86, iLocal_91))
		{
			CLEAR_PED_TASKS(uLocal_86);
		}
		switch (iLocal_369)
		{
			case 0:
				if (TIMERA() > 2000)
				{
					if (DOES_ENTITY_EXIST(func_65()) && !IS_PED_INJURED(func_65()))
					{
						func_18(&Local_395, 4);
					...
					if (func_5(&Local_395, cLocal_372, "REPAP_GO", 4, 0, 0, 0))
					{
						...
						SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_69, 1862763509);
						uLocal_358 = CREATE_OBJECT(joaat("prop_ld_test_01"), vLocal_87, 1, 1, 0);
						SET_ENTITY_COLLISION(uLocal_358, 0, 0);
						SET_ENTITY_VISIBLE(uLocal_358, 0, 0);
						FREEZE_ENTITY_POSITION(uLocal_358, 1);
						iLocal_369++;
					}
				}
				break;
			...
			case 1:
				func_177();
				if (!IS_ENTITY_IN_ANGLED_AREA(uLocal_86, 243.5571f, 77.51265f, 90.08002f, 268.2083f, 144.2189f, 109.853f, 23.25f, 0, 1, 0))
				{
					iLocal_369++;
			...
			case 2:
				if (!bLocal_668)
				{
					...
					{
						bLocal_669 = false;
						if (DOES_ENTITY_EXIST(func_65()) && IS_ENTITY_AT_ENTITY(func_65(), iLocal_91, 5f, 5f, 3f, 0, 1, 0))
						{
							bLocal_668 = true;
						}
					}
				...
				else
				{
					...
					if (DOES_ENTITY_EXIST(func_65()))
					{
						if (!IS_ENTITY_AT_ENTITY(func_65(), iLocal_91, 5f, 5f, 3f, 0, 1, 0))
						{
							bLocal_668 = false;
						}
					}
				...
				else
				{
					switch (iLocal_670)
					{
						...
						case 2:
							if ((GET_GAME_TIMER() - iLocal_671) > 8000)
							{
								if (((!bLocal_668 && func_161()) && !func_74()) && !func_73())
								{
						...
						case 4:
							if ((GET_GAME_TIMER() - iLocal_671) > 6000)
							{
								if (func_19() == 0)
								{
				...
				if (Global_3 || bLocal_70)
				{
					if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), 244.2175f, 441.0128f, 126.2767f, 33.5f, 40f, 14.75f, 0, 1, 0) && func_66())
					{
						iLocal_49 = 4;
...
int func_176()
{
	...
	iVar0 = func_24();
	if ((GET_GAME_TIMER() - iLocal_666) > 5000)
	{
		if (DOES_ENTITY_EXIST(iLocal_91) && IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 0))
		{
			if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_91, 1))
			{
				if (iVar0 != -1 && (GET_GAME_TIMER() - Local_204[iVar0 /*18*/].f_12) < 3000)
				{
					if (func_5(&Local_395, cLocal_372, "REPAP_WHINE", 4, 0, 0, 0))
					{
						iLocal_666 = GET_GAME_TIMER();
						return 1;
					}
				}
			}
...
void func_177()
{
	...
	if ((GET_GAME_TIMER() - iLocal_564) > iLocal_565)
	{
		if ((!IS_PED_INJURED(uLocal_86) && DOES_ENTITY_EXIST(func_65())) && !IS_PED_INJURED(func_65()))
		{
			if (GET_DISTANCE_BETWEEN_COORDS(vLocal_63, GET_ENTITY_COORDS(func_65(), 1), 1) < 8f)
			{
				...
				switch (iVar0)
				{
					case 0:
						func_17(&Local_395, 4, func_65(), "PAPARAZZO", 0, 1);
						if (DOES_ENTITY_EXIST(Local_395[4 /*10*/]) && !IS_PED_INJURED(Local_395[4 /*10*/]))
						{
					...
					case 2:
						...
						if (DOES_ENTITY_EXIST(Local_395[5 /*10*/]) && !IS_PED_INJURED(Local_395[5 /*10*/]))
						{
...
void func_178()
{
	...
	if (!IS_PED_INJURED(uLocal_86))
	{
		if (DOES_BLIP_EXIST(uLocal_360))
		{
			_0x75A16C3DA34F1245(uLocal_360, iLocal_664);
		}
		switch (iLocal_369)
		{
			case 0:
				...
				{
					uLocal_625 = CREATE_SYNCHRONIZED_SCENE(vLocal_653, vLocal_656, 2);
					TASK_SYNCHRONIZED_SCENE(uLocal_86, uLocal_625, "random@paparazzi@peek", "left_peek_a", 1000f, -8f, 1, 0, 1148846080, 0);
					TASK_LOOK_AT_ENTITY(uLocal_86, PLAYER_PED_ID(), -1, 4, 4);
					sLocal_626[0] = "peek_a";
					sLocal_626[1] = "peek_b";
					sLocal_626[2] = "peek_c";
					SET_WANTED_LEVEL_MULTIPLIER(0.2f);
			...
			case 1:
				...
				iVar2 = 0;
				bVar0 = IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_639, vLocal_642, fLocal_645, 0, 1, 0);
				bVar1 = IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_632, vLocal_635, fLocal_638, 0, 1, 0);
				...
				if ((IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_625) && GET_SYNCHRONIZED_SCENE_PHASE(uLocal_625) > 0.9f) || iVar2)
				{
					if (iLocal_660 == 0)
					{
						CLEAR_PED_TASKS(uLocal_86);
						...
						uLocal_625 = CREATE_SYNCHRONIZED_SCENE(vLocal_653, vLocal_656, 2);
						TASK_SYNCHRONIZED_SCENE(uLocal_86, uLocal_625, "random@paparazzi@peek", &cVar3, 4f, -4f, 1, 0, 1148846080, 0);
						SET_BIT(&iLocal_660, 0);
					}
				}
				if (bVar0 || bVar1)
				{
					if (fLocal_661 <= 20f)
					{
						fLocal_661 = (fLocal_661 + GET_FRAME_TIME());
					}
					if ((GET_GAME_TIMER() - iLocal_624) > 5000 && iLocal_660 == 0)
					{
						if (VDIST2(vLocal_60, vLocal_63) < (22.2f * 22.2f))
						{
							...
							if (func_19() == 1)
							{
								func_17(&Local_395, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
							}
							else if (func_19() == 0)
							{
								func_17(&Local_395, 1, PLAYER_PED_ID(), "MICHAEL", 0, 1);
							}
							else
							{
								func_17(&Local_395, 1, PLAYER_PED_ID(), "TREVOR", 0, 1);
							}
							if (func_5(&Local_395, cLocal_372, sVar9, 4, 0, 0, 0))
							{
								iLocal_662 = 1;
								if (!IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_86, 7f, 7f, 7f, 0, 1, 0))
								{
									CLEAR_PED_TASKS(uLocal_86);
									StringCopy(&cVar10, sLocal_631, 24);
									StringConCat(&cVar10, "come_here", 24);
									uLocal_625 = CREATE_SYNCHRONIZED_SCENE(vLocal_653, vLocal_656, 2);
									TASK_SYNCHRONIZED_SCENE(uLocal_86, uLocal_625, "random@paparazzi@peek", &cVar10, 4f, -4f, 1, 0, 1148846080, 0);
									SET_BIT(&iLocal_660, 0);
								}
				...
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_646, vLocal_649, fLocal_652, 0, 1, 0) && iLocal_660 == 0)
				{
					if (DOES_BLIP_EXIST(uLocal_359))
					{
						REMOVE_BLIP(&uLocal_359);
						if (!DOES_BLIP_EXIST(uLocal_360))
						{
							uLocal_360 = func_183(uLocal_86, 0, 145);
						}
					...
					if (bVar1)
					{
						TASK_SYNCHRONIZED_SCENE(uLocal_86, uLocal_625, "random@paparazzi@trans", "trans_left_to_wait", 8f, -4f, 1, 0, 1148846080, 0);
					}
					else
					{
						TASK_SYNCHRONIZED_SCENE(uLocal_86, uLocal_625, "random@paparazzi@trans", "trans_right_to_wait", 8f, -4f, 1, 0, 1148846080, 0);
					}
					SET_BIT(&iLocal_660, 0);
					iLocal_369++;
				}
			...
			case 2:
				if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_625) && GET_SYNCHRONIZED_SCENE_PHASE(uLocal_625) > 0.9f)
				{
					if (GET_SCRIPT_TASK_STATUS(uLocal_86, 242628503) != 1)
					{
						CLEAR_PED_TASKS(uLocal_86);
						TASK_PLAY_ANIM(uLocal_86, "random@paparazzi@wait", "wait_c", 8f, -4f, -1, 0, 0, 0, 0, 0);
						iLocal_621 = 2;
						SETTIMERA(0);
					}
					iLocal_369++;
			...
			case 4:
				...
				if (IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
				{
					if (IS_ENTITY_AT_ENTITY(iLocal_91, uLocal_86, Global_19 + Vector(2f, 12f, 12f), 0, 1, 0) && !bLocal_368)
					{
						if (GET_SCRIPT_TASK_STATUS(uLocal_86, 242628503) != 1 && !iLocal_659)
						{
							OPEN_SEQUENCE_TASK(&uVar16);
							TASK_FOLLOW_NAV_MESH_TO_COORD(0, 259.2552f, 122.2986f, 100.441f, 1f, 20000, 1048576000, 0, 1193033728);
							TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), 0);
							CLOSE_SEQUENCE_TASK(uVar16);
							TASK_PERFORM_SEQUENCE(uLocal_86, uVar16);
							_0x2208438012482A1A(uLocal_86, 0, 0);
						...
						{
							SET_PED_MAX_MOVE_BLEND_RATIO(uLocal_86, 1f);
					...
					if ((IS_ENTITY_AT_ENTITY(iLocal_91, uLocal_86, Global_19, 0, 1, 0) && func_173(iLocal_91)) && (TIMERA() > 6000 || !bLocal_368))
					{
						if (!iLocal_623)
						{
							func_102();
						...
						else
						{
							...
							CLEAR_PED_TASKS(uLocal_86);
							TASK_ENTER_VEHICLE(uLocal_86, iLocal_91, -1, func_171(iLocal_91), 1f, 8388608, 0);
						}
					}
				}
				break;
			...
			case 5:
				if (IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
				{
					if (!IS_PED_INJURED(uLocal_86) && IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 0))
					{
						if (DOES_BLIP_EXIST(uLocal_360))
						{
							REMOVE_BLIP(&uLocal_360);
					...
					else
					{
						if (!Global_3 && !bLocal_70)
						{
							if ((IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_91, 0) && !IS_PED_IN_VEHICLE(uLocal_86, iLocal_91, 1)) && !IS_ENTITY_IN_ANGLED_AREA(iLocal_91, 225.1779f, 125.6632f, 113.6647f, 262.3032f, 111.8771f, 97.16339f, 37f, 0, 1, 0))
							{
								if (bLocal_368)
								{
									SET_PED_FLEE_ATTRIBUTES(uLocal_86, 2, 1);
									sLocal_371 = "REPAP_GUP";
									func_181(6);
								}
								else
			...
			case 101:
				if (VDIST2(vLocal_60, vLocal_63) < 49f && !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
					if (GET_ENTITY_SPEED(PLAYER_PED_ID()) < 3f)
					{
						fLocal_665 = (fLocal_665 + GET_FRAME_TIME());
					}
					else
					{
						fLocal_665 = (fLocal_665 - (GET_FRAME_TIME() * 2f));
					}
					if (fLocal_665 > 10f)
					{
				...
				if (IS_VEHICLE_DRIVEABLE(iLocal_91, 0))
				{
					if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_91, 0) && func_180())
					{
						bLocal_368 = true;
						iLocal_74 = 1;
						iLocal_91 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
					...
					if (IS_PED_SITTING_IN_VEHICLE(PLAYER_PED_ID(), iLocal_91))
					{
						if (DOES_BLIP_EXIST(uLocal_361))
						{
							REMOVE_BLIP(&uLocal_361);
				...
				if (!bLocal_368)
				{
					if (!Global_3 && !bLocal_70)
					{
						if (GET_ENTITY_HEALTH(iLocal_91) < iLocal_83)
						{
							...
							{
								iLocal_84 = (iLocal_84 + (iLocal_83 - GET_ENTITY_HEALTH(iLocal_91)));
							}
							CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_91);
						}
						if (iLocal_84 > 250)
						{
							if (HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(uLocal_86, iLocal_91) && VDIST(vLocal_63, vLocal_66) < 25f)
							{
								func_181(5);
							}
						}
...
void func_179(vector3 vParam0, bool bParam3)
{
	if (VDIST(vLocal_63, vParam0) > 2.5f)
	{
		if (GET_SCRIPT_TASK_STATUS(uLocal_86, 713668775) != 1)
		{
			TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_86, vParam0, 1f, -1, 0.25f, 0, 1193033728);
		}
	}
	else if (GET_SCRIPT_TASK_STATUS(uLocal_86, 713668775) != 1)
	{
		func_139(bParam3);
		TASK_LOOK_AT_ENTITY(uLocal_86, PLAYER_PED_ID(), -1, 16, 2);
	}
...
bool func_180()
{
	return (((((IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && IS_VEHICLE_DRIVEABLE(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0)) && (IS_THIS_MODEL_A_CAR(GET_ENTITY_MODEL(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0))) || IS_THIS_MODEL_A_BIKE(GET_ENTITY_MODEL(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0))))) && GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)) > 0) && func_173(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0))) && !Global_105612);
}
...
var func_183(var uParam0, bool bParam1, int iParam2)
{
	var uVar0;
	
	uVar0 = func_170(uParam0, !bParam1, 0);
...
int func_187()
{
	switch (func_188(&Global_25824, 0, 5, 0, GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
void func_193()
{
	...
	if (!IS_PED_INJURED(uLocal_86))
	{
		SET_PED_FLEE_ATTRIBUTES(uLocal_86, 2, 0);
		TASK_SMART_FLEE_PED(uLocal_86, PLAYER_PED_ID(), 300f, -1, 0, 0);
	}
	iVar0 = 0;
	while (iVar0 < Local_204)
	{
		if (!IS_PED_INJURED(Local_204[iVar0 /*18*/]))
		{
			TASK_SMART_FLEE_PED(Local_204[iVar0 /*18*/], PLAYER_PED_ID(), 300f, -1, 0, 0);
			SET_PED_RELATIONSHIP_GROUP_HASH(Local_204[iVar0 /*18*/], -2065892691);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_204[iVar0 /*18*/], 0);
		}
		iVar0++;
	}
}
...
int func_194()
{
	...
	while (iVar1 < Local_204)
	{
		if (DOES_ENTITY_EXIST(Local_204[iVar1 /*18*/]) && !IS_PED_INJURED(Local_204[iVar1 /*18*/]))
		{
...
int func_195()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		if (VMAG2(GET_ENTITY_VELOCITY(PLAYER_PED_ID())) > 1369f && !func_206())
		{
			return 0;
		}
	}
...
void func_207()
{
	...
	func_209(43, 1);
	func_209(44, 1);
	uLocal_359 = func_208(vLocal_87);
	uLocal_86 = CREATE_PED(26, joaat("a_f_y_bevhills_03"), vLocal_87, fLocal_90, 1, 1);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_86, 1, 1);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_86, 17, 1);
	SET_PED_FLEE_ATTRIBUTES(uLocal_86, 128, 1);
	SET_PED_KEEP_TASK(uLocal_86, 1);
	SET_PED_CAN_BE_DRAGGED_OUT(uLocal_86, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_86, 0, 0, 1, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_86, 2, 0, 0, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_86, 3, 0, 0, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_86, 4, 0, 0, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_86, 7, 1, 0, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_86, 8, 0, 0, 0);
	SET_PED_DIES_INSTANTLY_IN_WATER(uLocal_86, 1);
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_86, 1);
	SET_PED_CAN_BE_TARGETTED(uLocal_86, 0);
	SET_AMBIENT_VOICE_NAME(uLocal_86, "LACEY");
	if (Global_3 || bLocal_70)
	{
		SET_ENTITY_INVINCIBLE(uLocal_86, 1);
	}
	if (ADD_RELATIONSHIP_GROUP("CELEBRITY", &uLocal_69))
	{
		SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_86, uLocal_69);
	}
	iLocal_91 = CREATE_VEHICLE(joaat("surano"), vLocal_92, fLocal_95, 1, 1, 0);
	...
	SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_91, 1084227584);
	...
	func_17(&Local_395, 3, uLocal_86, "LACEY", 0, 1);
	iLocal_375[0] = "idle_a";
	iLocal_375[1] = "idle_b";
	iLocal_375[2] = "idle_c";
	iLocal_375[3] = "idle_d";
	...
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("vader"), 1);
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("surano"), 1);
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("cavalcade2"), 1);
}

var func_208(vector3 vParam0)
{
	var uVar0;
	
	uVar0 = ADD_BLIP_FOR_COORD(vParam0);
	SET_BLIP_ALPHA(uVar0, 0);
	SET_BLIP_DISPLAY(uVar0, 0);
	return uVar0;
}
...
void func_210(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_83() == 0)
		{
			uVar0 = func_118(func_211(iParam0), -1, 0);
			CLEAR_BIT(&uVar0, iParam1);
			func_114(func_211(iParam0), uVar0, -1, 1, 0);
		}
	}
	else
	{
...
int func_213(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_83() == 0)
		{
			return IS_BIT_SET(func_118(func_211(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_217(var uParam0, char* sParam1, var uParam2)
{
...
int func_224()
{
	if ((Global_106554 == func_97() && GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
void func_227(var uParam0, char* sParam1, var uParam2)
{
	if (IS_BIT_SET(*uParam0, 30))
	{
		switch (func_218(*uParam0))
...
int func_231(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	vector3 vVar1;
	int iVar4;
...
bool func_232(vector3 vParam0, vector3 vParam3, bool bParam6)
{
	if (bParam6)
	{
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_245(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_248()
{
	...
	func_254(&uVar0, GET_CLOCK_SECONDS());
	func_253(&uVar0, GET_CLOCK_MINUTES());
	func_252(&uVar0, GET_CLOCK_HOURS());
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_265()) || Global_105612) || Global_25767) || func_264()) || func_14(8, -1)) || func_263()) || func_262()) || func_261()) || func_260()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_265()) || Global_25767) || func_264()) || func_14(8, -1)) || func_261()) || func_263()) || func_262()) || func_260()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_265()) || Global_105612) || Global_25767) || func_264()) || func_14(8, -1)) || func_261()) || func_263()) || func_262()) || func_260()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_265()) || Global_105612) || Global_25767) || func_264()) || func_14(8, -1)) || func_263()) || func_262()) || func_260()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_265() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_14(8, -1)) || func_260()) || func_259()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_265()) || Global_25767) || func_264()) || func_14(8, -1)) || func_262()) || func_261()) || func_260()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_265()) || func_262()) || Global_105612) || Global_25767) || func_264()) || Global_37584) || func_14(8, -1)) || func_261()) || func_259()) || func_260()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_265()) || Global_105612) || Global_25767) || func_264()) || func_14(8, -1)) || func_261()) || func_259()) || func_263()) || func_262()) || func_260())
						{
							return 0;
						}
						break;
...
void func_274()
{
	...
	if (DOES_ENTITY_EXIST(uLocal_86) && !IS_PED_INJURED(uLocal_86))
	{
		...
		if (IS_PED_IN_ANY_VEHICLE(uLocal_86, 1))
		{
			if (!IS_PED_FLEEING(uLocal_86))
			{
				TASK_LEAVE_ANY_VEHICLE(uLocal_86, 0, 0);
	...
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("vader"), 0);
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("surano"), 0);
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("cavalcade2"), 0);
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_365, 0);
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_366, 0);
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_367, 0);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Vector(93.8361f, 92.1704f, 246.1673f) + Vector(6f, 6f, 6f), Vector(93.8361f, 92.1704f, 246.1673f) - Vector(6f, 6f, 6f), 1, 1);
	if (Global_26004)
	{
...
void func_291(var uParam0, char* sParam1, var uParam2)
{
	if (IS_BIT_SET(uParam0, 30))
	{
		switch (func_218(uParam0))
