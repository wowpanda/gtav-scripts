...
void __EntryFunction__()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_86(uLocal_94, 4194304))
	{
		if (iLocal_105 != 263)
		{
		...
		if (DOES_ENTITY_EXIST(uLocal_85) && !IS_ENTITY_DEAD(uLocal_85, 0))
		{
			...
			switch (iLocal_95)
			{
				...
				case 3:
					...
					{
						Local_69 = { Local_53 };
						bVar2 = !func_86(uLocal_94, 64);
						func_90(&uLocal_94, 128);
						if (!func_72(3) && !Global_93716)
						{
							if (func_86(uLocal_94, 2097152))
							{
								if ((!func_86(uLocal_94, 1) || !DOES_ENTITY_EXIST(func_71())) && !Global_93716)
								{
									func_79(10);
									break;
								}
				...
				case 6:
					...
					if (func_86(uLocal_94, 2097152))
					{
						if (!func_72(3) && !IS_THREAD_ACTIVE(uLocal_52))
						{
							func_79(10);
						}
					}
...
void func_23()
{
	if (bLocal_125)
	{
		if (bLocal_126)
		{
			if (DOES_ENTITY_EXIST(uLocal_123))
			{
				SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_123);
			}
			if (DOES_ENTITY_EXIST(uLocal_124))
			{
				SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_124);
			}
		}
	}
}
...
var func_24()
{
	...
	vVar0.y = uLocal_124;
	vVar0.z = uLocal_123;
	uVar3 = START_NEW_SCRIPT_WITH_ARGS(&Local_53, &vVar0, 3, iLocal_97);
...
void func_38()
{
	...
	if ((DOES_ENTITY_EXIST(uLocal_124) && !IS_ENTITY_DEAD(uLocal_124, 0)) && !IS_ENTITY_ON_FIRE(uLocal_124))
	{
		SET_VEHICLE_DOORS_LOCKED(uLocal_124, 2);
		SET_VEHICLE_UNDRIVEABLE(uLocal_124, 1);
		SET_VEHICLE_AUTOMATICALLY_ATTACHES(uLocal_124, 0, 0);
		_0x2B6747FAA9DB9D6B(uLocal_124, 1);
		uLocal_122 = uLocal_124;
		if (DOES_ENTITY_EXIST(uLocal_123) && !IS_ENTITY_DEAD(uLocal_123, 0))
		{
			SET_VEHICLE_UNDRIVEABLE(uLocal_123, 1);
			_0x2B6747FAA9DB9D6B(uLocal_123, 1);
			SET_VEHICLE_AUTOMATICALLY_ATTACHES(uLocal_123, 0, 0);
			SET_VEHICLE_LIGHTS(uLocal_123, 1);
		}
	}
	else
	{
		if ((DOES_ENTITY_EXIST(uLocal_124) && IS_ENTITY_DEAD(uLocal_124, 0)) || !DOES_ENTITY_EXIST(uLocal_124))
		{
			func_39(0);
		}
		if ((DOES_ENTITY_EXIST(uLocal_123) && IS_ENTITY_DEAD(uLocal_123, 0)) || !DOES_ENTITY_EXIST(uLocal_123))
		{
			func_39(0);
		}
...
void func_47()
{
	...
	{
		if (func_50(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_68()) || Global_105612) || Global_25767) || func_67()) || func_53(8, -1)) || func_66()) || func_65()) || func_64()) || func_55()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_68()) || Global_25767) || func_67()) || func_53(8, -1)) || func_64()) || func_66()) || func_65()) || func_55()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_68()) || Global_105612) || Global_25767) || func_67()) || func_53(8, -1)) || func_64()) || func_66()) || func_65()) || func_55()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_68()) || Global_105612) || Global_25767) || func_67()) || func_53(8, -1)) || func_66()) || func_65()) || func_55()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_68() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_53(8, -1)) || func_55()) || func_63()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_68()) || Global_25767) || func_67()) || func_53(8, -1)) || func_65()) || func_64()) || func_55()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_68()) || func_65()) || Global_105612) || Global_25767) || func_67()) || Global_37584) || func_53(8, -1)) || func_64()) || func_63()) || func_55()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_68()) || Global_105612) || Global_25767) || func_67()) || func_53(8, -1)) || func_64()) || func_63()) || func_66()) || func_65()) || func_55())
						{
							return 0;
						}
						break;
...
void func_76()
{
	if (bLocal_125)
	{
		...
		if (!iLocal_127)
		{
			CLEAR_AREA_OF_VEHICLES(-1702.46f, 4666.36f, 22.1255f, 10f, 0, 0, 0, 0, 0, 0);
			if (!DOES_ENTITY_EXIST(uLocal_123))
			{
				uLocal_123 = CREATE_VEHICLE(joaat("blazer"), -1707.434f, 4666.563f, 22.1095f, 323.2491f, 1, 1, 0);
			}
			if (!DOES_ENTITY_EXIST(uLocal_124))
			{
				uLocal_124 = CREATE_VEHICLE(joaat("journey"), -1702.695f, 4666.941f, 22.7091f, 80.03f, 1, 1, 0);
				SET_VEHICLE_HAS_STRONG_AXLES(uLocal_124, 1);
			}
			iLocal_127 = 1;
		}
	}
