...
void __EntryFunction__()
{
	...
	iVar64[0] = 31;
	if (!func_248(&iVar64, &Var0, vVar61, 1f))
	{
		func_247();
	...
	while (true)
	{
		...
		func_190(Var0);
		func_182(&iLocal_93, &(Var0.f_9), vVar61);
		if (func_167(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
void func_182(int iParam0, var uParam1, vector3 vParam2)
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
...
int func_206(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
float func_210(vector3 vParam0, vector3 vParam3)
{
	return (((vParam0.x * vParam3.x) + (vParam0.y * vParam3.y)) + (vParam0.z * vParam3.z));
}
...
int func_216(var uParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_217(var uParam0, float fParam1)
{
	...
	{
		if (func_218(uParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_218(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_211(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_211(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_210(vVar3, vVar0);
...
int func_219(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (IS_PED_SHOOTING(PLAYER_PED_ID()))
...
int func_230(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_235(&iVar0) || !HAS_ANIM_DICT_LOADED("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_91 = 2;
...
int func_231(var uParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_232(uParam0, iParam1, vParam2, fParam5, 1))
	{
		if (DOES_ENTITY_EXIST(*uParam0))
		{
			if (!IS_ENTITY_DEAD(*uParam0, 0))
...
int func_232(var uParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	int iVar0;
...
void func_234(var uParam0, var uParam1, vector3 vParam2, float fParam5)
{
	func_197(uParam0);
...
void func_236(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_92 = ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar3, 0, 1, 1, 1);
			...
			{
				REMOVE_SCENARIO_BLOCKING_AREA(uLocal_92, 0);
...
int func_248(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_249((*iParam0)[0], vParam2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_249((*iParam0)[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_249(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_250(Var1.f_6, vParam1, fParam4, 0))
	{
...
int func_250(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_265(var uParam0)
{
	if (IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		...
		if (func_126(uParam0->f_41[0]))
		{
			STOP_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[0], -1000f, 1);
		}
	}
}
