...
void __EntryFunction__()
{
	...
	{
		WAIT(0);
		if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || bLocal_243)
		{
			if (!func_127())
			{
				if (func_126())
			...
			switch (iLocal_46)
			{
				...
				case 1:
					if (!bLocal_243)
					{
						...
						func_86();
						if (!IS_PED_INJURED(uLocal_69))
						{
							SET_PED_RESET_FLAG(uLocal_69, 247, 1);
						}
					}
					else
					{
					...
					if (!IS_PED_INJURED(uLocal_70))
					{
						SET_PED_RESET_FLAG(uLocal_70, 156, 1);
					}
					func_35();
					func_34();
					func_1();
...
void func_1()
{
	if (bLocal_243)
	{
		...
		{
			if (!IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_70, 100f, 100f, 100f, 0, 1, 0))
			{
				func_2();
			}
		}
		else if (!IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_70, 100f, 100f, 100f, 0, 1, 0))
		{
			func_3();
		}
	}
	else
	{
		if (!IS_PED_INJURED(uLocal_69))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_69, PLAYER_PED_ID(), 1) || HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uLocal_69))
			{
				func_2();
			}
		}
		if (IS_PED_INJURED(uLocal_69))
		{
			if (!IS_PED_INJURED(uLocal_70))
			{
				OPEN_SEQUENCE_TASK(&uLocal_75);
				TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), -1, 2052, 2);
				TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 1000f, -1, 0, 0);
				CLOSE_SEQUENCE_TASK(uLocal_75);
				TASK_PERFORM_SEQUENCE(uLocal_70, uLocal_75);
				SET_PED_KEEP_TASK(uLocal_70, 1);
			}
			func_2();
		}
		if (IS_PED_INJURED(uLocal_70))
		{
			if (!IS_PED_INJURED(uLocal_69))
			{
				CLEAR_PED_TASKS(uLocal_69);
				OPEN_SEQUENCE_TASK(&uLocal_75);
				TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), -1, 2052, 2);
				TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 1000f, -1, 0, 0);
				CLOSE_SEQUENCE_TASK(uLocal_75);
				TASK_PERFORM_SEQUENCE(uLocal_69, uLocal_75);
				SET_PED_KEEP_TASK(uLocal_69, 1);
			}
			func_2();
		}
	}
	...
	if (IS_PED_INJURED(uLocal_70))
	{
		if (DOES_BLIP_EXIST(uLocal_72))
		{
			REMOVE_BLIP(&uLocal_72);
		}
	}
}
...
void func_35()
{
	...
	{
		if ((func_50() || IS_PED_ARMED(PLAYER_PED_ID(), 6)) || !IS_ENTITY_AT_COORD(PLAYER_PED_ID(), GET_ENTITY_COORDS(uLocal_70, 0), 12f, 12f, 5f, 0, 1, 0))
		{
			SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_68, 1862763509);
			if (!IS_PED_INJURED(uLocal_70))
			{
				CLEAR_PED_TASKS(uLocal_70);
				TASK_COMBAT_PED(uLocal_70, PLAYER_PED_ID(), 0, 16);
				if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_70, 15f, 15f, 15f, 0, 1, 0))
				{
					func_48();
					WAIT(0);
			...
			{
				CLEAR_PED_TASKS(uLocal_69);
				TASK_COMBAT_PED(uLocal_69, PLAYER_PED_ID(), 0, 16);
			}
			iLocal_246 = 1;
		}
	}
...
int func_50()
{
	...
	vVar0 = { 30f, 30f, 30f };
	vVar3 = { -30f, -30f, -30f };
	if (!IS_PED_INJURED(uLocal_69) && !IS_PED_INJURED(uLocal_70))
	{
		if (IS_BULLET_IN_AREA(GET_PED_BONE_COORDS(uLocal_69, 31086, 0f, 0f, 0f), 30f, 1))
		{
			return 1;
		}
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_69, 30f, 30f, 30f, 0, 1, 0) && IS_PED_ARMED(PLAYER_PED_ID(), 6))
		{
			if (((IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uLocal_69) || IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uLocal_70)) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uLocal_69)) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uLocal_70))
			{
				if (_CAN_PED_SEE_PED(uLocal_69, PLAYER_PED_ID()) || _CAN_PED_SEE_PED(uLocal_70, PLAYER_PED_ID()))
				{
					func_48();
					WAIT(0);
		...
		vVar0 = { vVar0 + GET_PED_BONE_COORDS(uLocal_69, 31086, 0f, 0f, 0f) };
		vVar3 = { vVar3 + GET_PED_BONE_COORDS(uLocal_69, 31086, 0f, 0f, 0f) };
		...
		if (_0x2F09F7976C512404(GET_PED_BONE_COORDS(uLocal_69, 31086, 0f, 0f, 0f), 3f))
		{
			return 1;
		}
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			{
				if (IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), uLocal_69) || IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), uLocal_70))
				{
					return 1;
				}
			}
		...
		if (IS_COP_PED_IN_AREA_3D(GET_ENTITY_COORDS(uLocal_69, 0) - vLocal_55, GET_ENTITY_COORDS(uLocal_69, 0) + vLocal_55) || IS_COP_VEHICLE_IN_AREA_3D(GET_ENTITY_COORDS(uLocal_69, 0) - vLocal_55, GET_ENTITY_COORDS(uLocal_69, 0) + vLocal_55))
		{
			return 1;
		}
	}
	if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), 894.1762f, -1048.294f, 41.828f, 15f, 21.5625f, 10f, 0, 1, 0))
	{
		func_48();
		WAIT(0);
	...
	if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_49, 15f, 15f, 15f, 0, 1, 0))
	{
	...
	if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_49, 40f, 40f, 40f, 0, 1, 0))
	{
	...
	if (DOES_ENTITY_EXIST(uLocal_69))
	{
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_69, PLAYER_PED_ID(), 1))
		{
			func_48();
			return 1;
		}
	}
	if (DOES_ENTITY_EXIST(uLocal_70))
	{
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_70, PLAYER_PED_ID(), 1))
		{
			func_48();
			return 1;
		}
...
void func_51()
{
	if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -734.9749f, -728.4423f, 29.4985f, 2f, 6f, 2f, 0, 1, 0) || IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -663.9312f, -725.6195f, 28.2592f, 2f, 6f, 2f, 0, 1, 0))
	{
		if (!IS_PED_INJURED(uLocal_70))
		{
			OPEN_SEQUENCE_TASK(&uLocal_75);
...
void func_52()
{
	if (!bLocal_244)
	{
		if (!IS_PED_INJURED(uLocal_70))
		{
			if (GET_SCRIPT_TASK_STATUS(uLocal_70, 242628503) == 7 && IS_ENTITY_AT_ENTITY(uLocal_70, PLAYER_PED_ID(), 2.8f, 2.8f, 2.8f, 0, 1, 0))
			{
				if (!iLocal_245)
				{
					iLocal_250 = 500;
					...
					{
						iLocal_251 = func_85(func_43());
						func_53(func_43(), 1, func_85(func_43()));
						func_36(&uLocal_76, "lurinau", "lurin_mugtha", 4, 0, 0, 0);
					}
					if (!IS_PED_INJURED(uLocal_70))
					{
						SET_PED_MONEY(uLocal_70, iLocal_251);
					}
					iLocal_245 = 1;
				}
				if (!IS_PED_INJURED(uLocal_70))
...
void func_86()
{
	if (!IS_PED_INJURED(uLocal_70))
	{
		if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), 873.9561f, -1050.806f, 33.0066f, 4.75f, 1.9f, 1f, 0, 1, 0))
		{
			if (!IS_PED_ARMED(PLAYER_PED_ID(), 6))
			{
				TASK_LOOK_AT_ENTITY(uLocal_70, PLAYER_PED_ID(), -1, 2048, 2);
				SET_PED_DUCKING(uLocal_70, 0);
				GIVE_WEAPON_TO_PED(uLocal_70, joaat("weapon_pistol"), 200, 1, 1);
				if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
					func_48();
					WAIT(0);
				...
				else
				{
					...
					TASK_PLAY_ANIM(0, "random@mugging5", "ig_1_guy_enter_stickup", 2f, -2f, -1, 0, 0, 0, 0, 0);
					TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER_PED_ID(), PLAYER_PED_ID(), 2f, 0, 2.3f, 4f, 1, 1, -957453492);
					TASK_AIM_GUN_AT_ENTITY(0, PLAYER_PED_ID(), 500, 0);
					CLOSE_SEQUENCE_TASK(uLocal_75);
				}
				TASK_PERFORM_SEQUENCE(uLocal_70, uLocal_75);
				CLEAR_SEQUENCE_TASK(&uLocal_75);
				SET_BLIP_AS_FRIENDLY(uLocal_71, 0);
				uLocal_72 = func_93(uLocal_70, 1, 145);
				TRIGGER_MUSIC_EVENT("RE35_OS");
				WAIT(500);
				if (!IS_PED_INJURED(uLocal_69))
				{
					TASK_LOOK_AT_ENTITY(uLocal_69, PLAYER_PED_ID(), -1, 2048, 2);
					GIVE_WEAPON_TO_PED(uLocal_69, joaat("weapon_pistol"), 200, 1, 1);
					OPEN_SEQUENCE_TASK(&uLocal_75);
					TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_64, PLAYER_PED_ID(), 2f, 0, 0f, 4f, 1, 512, 0, -957453492, 20000);
					TASK_AIM_GUN_AT_ENTITY(0, PLAYER_PED_ID(), 5000, 0);
					CLOSE_SEQUENCE_TASK(uLocal_75);
					TASK_PERFORM_SEQUENCE(uLocal_69, uLocal_75);
					CLEAR_SEQUENCE_TASK(&uLocal_75);
				}
				...
				{
					OPEN_SEQUENCE_TASK(&uLocal_75);
					TASK_LOOK_AT_ENTITY(0, uLocal_70, -1, 2048, 2);
					TASK_PAUSE(0, 1000);
					CLOSE_SEQUENCE_TASK(uLocal_75);
					TASK_PERFORM_SEQUENCE(PLAYER_PED_ID(), uLocal_75);
					CLEAR_SEQUENCE_TASK(&uLocal_75);
					func_87(1);
				}
				func_48();
...
var func_93(var uParam0, bool bParam1, int iParam2)
{
	var uVar0;
...
int func_94(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_95(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		SET_BLIP_SCALE(uVar0, func_95(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
void func_96()
{
	if (!IS_ENTITY_DEAD(uLocal_69, 0))
	{
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_69, 15f, 15f, 15f, 0, 1, 0))
		{
			if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
				if (!func_33())
				{
					if (iLocal_249 == 0)
					{
						...
						TASK_LOOK_AT_ENTITY(uLocal_69, PLAYER_PED_ID(), -1, 2052, 2);
						iLocal_249++;
						SETTIMERB(0);
					}
...
void func_97()
{
	if (!IS_PED_INJURED(uLocal_69))
	{
		if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if (IS_PED_ARMED(PLAYER_PED_ID(), 6) && _CAN_PED_SEE_PED(uLocal_69, PLAYER_PED_ID()))
			{
				CLEAR_PED_TASKS(uLocal_69);
				OPEN_SEQUENCE_TASK(&uLocal_75);
				TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), -1, 2052, 2);
...
void func_98()
{
	if (!func_127())
	{
		if (!IS_ENTITY_DEAD(uLocal_69, 0))
		{
			if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_49, 65f, 60f, 60f, 0, 1, 0) || Global_106560)
			{
				if (DOES_BLIP_EXIST(uLocal_73))
				{
					REMOVE_BLIP(&uLocal_73);
				}
				uLocal_71 = func_93(uLocal_69, 0, 145);
				_0x75A16C3DA34F1245(uLocal_71, 0);
	...
	if (!iLocal_241)
	{
		if (!IS_PED_INJURED(uLocal_69))
		{
			if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_69, 25f, 25f, 25f, 0, 1, 0) && func_127())
			{
				if (func_36(&uLocal_76, "lurinau", "lurin_help2", 4, 0, 0, 0))
				{
					OPEN_SEQUENCE_TASK(&uLocal_75);
					TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), -1, 2064, 2);
					TASK_PLAY_ANIM(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 4f, -4f, -1, 49, 0, 0, 0, 0);
	...
	if (!IS_ENTITY_DEAD(uLocal_69, 0))
	{
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_69, 15f, 15f, 15f, 0, 1, 0) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			SET_CURRENT_PED_WEAPON(PLAYER_PED_ID(), joaat("weapon_unarmed"), 1);
		}
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_69, 8f, 8f, 8f, 0, 1, 0))
		{
			if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
				iLocal_242 = 1;
				if (DOES_BLIP_EXIST(uLocal_71))
				{
					_0x75A16C3DA34F1245(uLocal_71, 1);
				}
				CLEAR_PED_TASKS(uLocal_69);
				...
				{
					SETTIMERB(0);
					CLEAR_PED_SECONDARY_TASK(uLocal_69);
					OPEN_SEQUENCE_TASK(&uLocal_75);
					TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), -1, 2064, 2);
					TASK_STAND_STILL(0, 1000);
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_61, 2f, -1, 0.25f, 512, 80.1325f);
					TASK_PLAY_ANIM(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 4f, -4f, -1, 1, 0, 0, 0, 0);
					CLOSE_SEQUENCE_TASK(uLocal_75);
					TASK_PERFORM_SEQUENCE(uLocal_69, uLocal_75);
					CLEAR_SEQUENCE_TASK(&uLocal_75);
...
int func_105()
{
	switch (func_106(&Global_25824, 0, 5, 0, GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
void func_111()
{
	...
	ADD_RELATIONSHIP_GROUP("mugger", &uLocal_68);
	uLocal_69 = CREATE_PED(19, joaat("a_f_m_skidrow_01"), vLocal_58, 79.765f, 1, 1);
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_69, 1);
	SET_PED_CONFIG_FLAG(uLocal_69, 185, 1);
	SET_PED_FLEE_ATTRIBUTES(uLocal_69, 128, 1);
	STOP_PED_SPEAKING(uLocal_69, 1);
	SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_69, uLocal_68);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_68, 1862763509);
	OPEN_SEQUENCE_TASK(&uLocal_75);
	TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), -1, 3076, 2);
	TASK_PLAY_ANIM(0, "random@mugging5", "ig_1_girl_agitated_loop", 2f, -2f, -1, 1, 0, 0, 0, 0);
	TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), -1);
	CLOSE_SEQUENCE_TASK(uLocal_75);
	TASK_PERFORM_SEQUENCE(uLocal_69, uLocal_75);
	CLEAR_SEQUENCE_TASK(&uLocal_75);
	uLocal_70 = CREATE_PED(7, joaat("a_m_m_tramp_01"), vLocal_52, fLocal_67, 1, 1);
	SET_AMBIENT_VOICE_NAME(uLocal_70, "A_M_M_TRAMP_01_BLACK_MINI_01");
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_70, 1);
	SET_PED_FLEE_ATTRIBUTES(uLocal_70, 128, 1);
	SET_ENTITY_IS_TARGET_PRIORITY(uLocal_70, 1, 0);
	STOP_PED_SPEAKING(uLocal_70, 1);
	SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_70, uLocal_68);
	TASK_LOOK_AT_ENTITY(uLocal_70, PLAYER_PED_ID(), -1, 2052, 2);
	func_112(&uLocal_76, 0, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_112(&uLocal_76, 4, uLocal_69, "HOBOFEMALE", 0, 1);
	func_112(&uLocal_76, 5, uLocal_70, "HOBOMALE", 0, 1);
	iLocal_47 = 1;
}

void func_112(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_165()) || Global_105612) || Global_25767) || func_164()) || func_45(8, -1)) || func_163()) || func_162()) || func_161()) || func_160()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_165()) || Global_25767) || func_164()) || func_45(8, -1)) || func_161()) || func_163()) || func_162()) || func_160()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_165()) || Global_105612) || Global_25767) || func_164()) || func_45(8, -1)) || func_163()) || func_162()) || func_160()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_165() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_45(8, -1)) || func_160()) || func_159()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_165()) || Global_25767) || func_164()) || func_45(8, -1)) || func_162()) || func_161()) || func_160()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_165()) || func_162()) || Global_105612) || Global_25767) || func_164()) || Global_37584) || func_45(8, -1)) || func_161()) || func_159()) || func_160()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_165()) || Global_105612) || Global_25767) || func_164()) || func_45(8, -1)) || func_161()) || func_159()) || func_163()) || func_162()) || func_160())
						{
							return 0;
						}
						break;
