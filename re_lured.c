...
void __EntryFunction__()
{
	...
	{
		SYSTEM::WAIT(0);
		if (TASK::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || bLocal_229)
		{
			if (!func_123())
			{
				if (func_122())
...
void func_19(void fParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
...
void func_22()
{
	...
	{
		if (func_26(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_25(PLAYER::PLAYER_PED_ID());
			if (func_24(iVar0) && (!func_23(14) || Global_104171))
			{
...
void func_35()
{
	...
	else if (!iLocal_232 && !bLocal_230)
	{
		if ((func_50() || WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)) || !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_56, false), 12f, 12f, 5f, false, true, 0))
		{
			...
			{
				BRAIN::CLEAR_PED_TASKS(iLocal_56);
				BRAIN::TASK_COMBAT_PED(iLocal_56, PLAYER::PLAYER_PED_ID(), 0, 16);
...
void func_52()
{
	if (!bLocal_230)
	{
		if (!PED::IS_PED_INJURED(iLocal_56))
		{
			if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_56, 242628503) == 7 && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_56, PLAYER::PLAYER_PED_ID(), 2.8f, 2.8f, 2.8f, 0, 1, 0))
			{
				if (!iLocal_231)
				{
					iLocal_236 = 500;
...
int func_53(int iParam0, int iParam1, int iParam2)
{
	...
	return func_54(Global_105220.f_28021[iParam0 /*29*/].f_17, 0, iParam1, iParam2, 0);
}
...
void func_83()
{
	if (!PED::IS_PED_INJURED(iLocal_56))
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 873.9561f, -1050.806f, 33.0066f, 4.75f, 1.9f, 1f, false, true, 0))
		{
			...
			{
				BRAIN::TASK_LOOK_AT_ENTITY(iLocal_56, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
				...
				else
				{
					...
					BRAIN::TASK_PLAY_ANIM(0, "random@mugging5", "ig_1_guy_enter_stickup", 2f, -2f, -1, 0, 0, 0, 0, 0);
					BRAIN::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 2f, 0, 2.3f, 4f, 1, 1, -957453492);
					BRAIN::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 500, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_61);
				}
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_56, iLocal_61);
				...
				if (!PED::IS_PED_INJURED(iLocal_55))
				{
					BRAIN::TASK_LOOK_AT_ENTITY(iLocal_55, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					WEAPON::GIVE_WEAPON_TO_PED(iLocal_55, joaat("weapon_pistol"), 200, true, true);
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
					BRAIN::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vLocal_52, PLAYER::PLAYER_PED_ID(), 2f, false, 0f, 4f, true, 512, 0, -957453492, 20000);
					BRAIN::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 5000, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_61);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_55, iLocal_61);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_61);
				}
				...
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
					BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_56, -1, 2048, 2);
					BRAIN::TASK_PAUSE(0, 1000);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_61);
					BRAIN::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iLocal_61);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_61);
					func_84(1);
				}
				func_48();
...
int func_90(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		HUD::SET_BLIP_SCALE(iVar0, func_91(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		HUD::SET_BLIP_SCALE(iVar0, func_91(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
			...
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (!func_33())
				{
					if (iLocal_235 == 0)
					{
						...
						BRAIN::TASK_LOOK_AT_ENTITY(iLocal_55, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
						iLocal_235++;
						SYSTEM::SETTIMERB(0);
					}
...
void func_94()
{
	if (!func_123())
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_55, 0))
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_47, 65f, 60f, 60f, false, true, 0) || Global_105215)
			{
	...
	if (!iLocal_227)
	{
		if (!PED::IS_PED_INJURED(iLocal_55))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 25f, 25f, 25f, 0, 1, 0) && func_123())
			{
				if (func_36(&uLocal_62, "lurinau", "lurin_help2", 4, 0, 0, 0))
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
					BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2064, 2);
					BRAIN::TASK_PLAY_ANIM(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 4f, -4f, -1, 49, 0, 0, 0, 0);
		...
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 8f, 8f, 8f, 0, 1, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_55, 0))
				{
					...
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_51, 2f, -1, 0.25f, 512, 80.1325f);
					BRAIN::TASK_PLAY_ANIM(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 4f, -4f, -1, 1, 0, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_61);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_55, iLocal_61);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_61);
			...
			else if (!iLocal_234)
			{
				...
				if (!func_33())
				{
					if (!PED::IS_PED_INJURED(iLocal_55))
					{
						...
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
						BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 3076, 2);
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_61);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_55, iLocal_61);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_61);
...
int func_97(int iParam0)
{
	if (func_101())
	{
		...
		if (func_16(Global_105209))
		{
			func_98(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_16(Global_105209))
		{
...
void func_107()
{
	...
	BRAIN::OPEN_SEQUENCE_TASK(&iLocal_61);
	BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 3076, 2);
	BRAIN::TASK_PLAY_ANIM(0, "random@mugging5", "ig_1_girl_agitated_loop", 2f, -2f, -1, 1, 0, 0, 0, 0);
	BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
	BRAIN::CLOSE_SEQUENCE_TASK(iLocal_61);
	BRAIN::TASK_PERFORM_SEQUENCE(iLocal_55, iLocal_61);
	BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_61);
	...
	BRAIN::TASK_LOOK_AT_ENTITY(iLocal_56, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
	func_108(&uLocal_62, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
int func_110()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_121())
		{
			return 0;
		}
	}
...
int func_123()
{
	if ((Global_105209 == func_30() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_105210)
	{
		return 1;
	}
	return 0;
...
int func_127(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_163(Global_105220.f_24966.f_43[iParam1]))
		{
			return 0;
		}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_141(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_144()
{
	...
	func_147(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_146(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_145(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_161()) || Global_104267) || Global_25279) || func_160()) || func_45(8, -1)) || func_159()) || func_158()) || func_157()) || func_156()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_161()) || Global_25279) || func_160()) || func_45(8, -1)) || func_157()) || func_159()) || func_158()) || func_156()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_161()) || Global_104267) || Global_25279) || func_160()) || func_45(8, -1)) || func_157()) || func_159()) || func_158()) || func_156()) || Global_105220.f_7659.f_919[iVar0] == 5) || Global_36452 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_161()) || Global_104267) || Global_25279) || func_160()) || func_45(8, -1)) || func_159()) || func_158()) || func_156()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_161() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_45(8, -1)) || func_156()) || func_155()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_161()) || Global_25279) || func_160()) || func_45(8, -1)) || func_158()) || func_157()) || func_156()) || Global_105220.f_7659.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_161()) || func_158()) || Global_104267) || Global_25279) || func_160()) || Global_37057) || func_45(8, -1)) || func_157()) || func_155()) || func_156()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_161()) || Global_104267) || Global_25279) || func_160()) || func_45(8, -1)) || func_157()) || func_155()) || func_159()) || func_158()) || func_156())
						{
							return 0;
						}
						break;
...
void func_170(int iParam0)
{
	...
	if (func_123())
	{
		...
		func_173(30000);
		StringCopy(&cVar0, func_172(Global_105209, 1), 64);
		if (func_29(Global_105209) > 0)
		{
