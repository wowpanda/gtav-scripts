...
void func_1()
{
	...
	{
		if (!IS_VEHICLE_DRIVEABLE(iLocal_241, 0))
		{
			func_135();
		}
		else if (iLocal_47 == 2)
		{
			if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_241, 0))
			{
				if (!DOES_BLIP_EXIST(uLocal_50))
				{
					func_134("BK_PLANE", 7500, 1);
					uLocal_50 = func_133(iLocal_241, 0, 0);
				}
				if (func_132(PLAYER_PED_ID(), iLocal_241, 1) > 300f)
				{
					func_135();
				}
			}
			else if (DOES_BLIP_EXIST(uLocal_50))
			{
				CLEAR_PRINTS();
	...
	if ((((DOES_ENTITY_EXIST(iLocal_241) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_241, 0)) && IS_ENTITY_IN_AIR(iLocal_241)) && iLocal_325) && REQUEST_SCRIPT_AUDIO_BANK("PLANES", 0, -1))
	{
		if (!bLocal_326)
		{
			if (IS_CONTROL_JUST_PRESSED(0, 114))
			{
				if (iLocal_324 == -1 || (GET_GAME_TIMER() - iLocal_324) > 2000)
				{
					if (!DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_332))
					{
						uLocal_332 = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_property_leaflet_drop", iLocal_241, 0f, -2f, -0.65f, 0f, 0f, 0f, 1f, 0, 0, 0);
						fLocal_330 = 0f;
					}
					if (func_131("LEAFLET"))
					{
					...
					PLAY_SOUND_FROM_ENTITY(-1, "PROPERTIES_PLANE_PROMO_MASTER", iLocal_241, 0, 0, 0);
					iLocal_324 = GET_GAME_TIMER();
					bLocal_326 = true;
				}
			}
		}
		else if ((GET_GAME_TIMER() - iLocal_324) > 3000)
		{
			bLocal_326 = false;
		}
	}
	else if (DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_332))
	{
		STOP_PARTICLE_FX_LOOPED(uLocal_332, 0);
		fLocal_330 = 0f;
	}
	if (DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_332))
	{
		...
		fLocal_330 = (fLocal_330 + ((fVar7 * TIMESTEP()) * 100f));
		fLocal_330 = func_130(fLocal_330, 0f, 1f);
		SET_PARTICLE_FX_LOOPED_EVOLUTION(uLocal_332, "spawn", fLocal_330, 0);
	}
	switch (iLocal_47)
	{
		case 0:
			REQUEST_MODEL(joaat("stunt"));
			if (HAS_MODEL_LOADED(joaat("stunt")))
			{
				iLocal_241 = Global_105275.f_222[0];
				if (!DOES_ENTITY_EXIST(iLocal_241))
				{
					iLocal_241 = CREATE_VEHICLE(joaat("stunt"), vVar0, 121.2244f, 1, 1, 0);
					SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_241, 1084227584);
				}
				else
				{
					SET_ENTITY_AS_MISSION_ENTITY(iLocal_241, 1, 1);
				}
				SET_MODEL_AS_NO_LONGER_NEEDED(joaat("stunt"));
				CLEAR_PRINTS();
				func_134("GET_PLANE", 7500, 1);
				uLocal_50 = func_133(iLocal_241, 0, 0);
				REQUEST_PTFX_ASSET();
				func_127(&uLocal_51, 1, 0);
				iLocal_47++;
			}
			break;
		
		case 1:
			if (DOES_ENTITY_EXIST(iLocal_241) && IS_VEHICLE_DRIVEABLE(iLocal_241, 0))
			{
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_241, 0))
				{
					CLEAR_PRINTS();
		...
		case 3:
			if (func_24(&uLocal_51, vLocal_36, -1067.083f, -2922.601f, 12.82418f, -1091.854f, -2965.403f, 23.94564f, 31.5625f, 1, iLocal_241, "LAND", "", "BK_PLANE", 1, 0, 1, -1) && !IS_ENTITY_IN_AIR(iLocal_241))
			{
				func_127(&uLocal_51, 1, 0);
				iLocal_47++;
			}
		...
		case 4:
			if (func_22(iLocal_241, 1093140480, 1, 0f, 0, 1, 0))
			{
				iLocal_47++;
			}
			break;
		...
		case 5:
			...
			SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_241, 0);
			func_21();
			break;
	}
	switch (iLocal_48)
	{
		case 0:
			...
			else if ((func_20() && (GET_GAME_TIMER() - iLocal_49) > 5000) && iLocal_329)
			{
				StringCopy(&cVar3, "RAND_", 16);
				StringConCat(&cVar3, &cLocal_43, 16);
				if (func_19(49) && GET_RANDOM_INT_IN_RANGE(0, 3) == 0)
				{
		...
		case 1:
			if (func_20() && (GET_GAME_TIMER() - iLocal_49) > 1000)
			{
...
int func_22(int iParam0, int iParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
int func_24(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, float fParam10, int iParam11, int iParam12, char* sParam13, char* sParam14, char* sParam15, bool bParam16, int iParam17, bool bParam18, int iParam19)
{
	return func_25(uParam0, vParam1, func_69(), vParam4, vParam7, iParam11, 5, 0, 0, 0, iParam12, sParam13, func_68(), func_68(), func_68(), func_68(), sParam14, 0, bParam16, sParam15, 1, iParam17, bParam18, iParam19, func_68(), func_68(), func_68(), 1, fParam10);
}

int func_25(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, vector3 vParam10, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, char* sParam19, char* sParam20, char* sParam21, char* sParam22, char* sParam23, char* sParam24, bool bParam25, bool bParam26, char* sParam27, bool bParam28, int iParam29, bool bParam30, int iParam31, var uParam32, var uParam33, var uParam34, bool bParam35, var uParam36)
{
	var uVar0;
	bool bVar1;
	int iVar2;
	...
	func_66(uParam0);
	func_65();
	if (func_48(uParam0, uParam0->f_17[0], uParam0->f_17[1], uParam0->f_17[2], sParam20, sParam21, sParam22, sParam23, uParam0->f_8, bParam25, iParam18, 0, 0, uParam32, uParam33, uParam34, iParam14, bParam26))
	{
		func_47(sParam20);
		func_47(sParam21);
		func_47(sParam22);
		...
		if (IS_SCREEN_FADED_IN())
		{
			...
			if (bVar1)
			{
				...
				if (bParam26 && IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0))
				{
					...
					if ((!func_42(uParam0, 1) && !func_41(uParam0)) && !IS_BIT_SET(uParam0->f_13, 0))
					{
						if (bParam30)
						{
							func_40(uParam0, "LOSE_WANTED", 0);
							if (!IS_PED_INJURED(uParam0->f_17[0]))
							{
								func_38(uParam0->f_17[0], "VEHICLE_POLICE_PURSUIT", 3);
							}
						}
				...
				else
				{
					...
					if (IS_BIT_SET(uParam0->f_13, 1))
					{
						if (!func_42(uParam0, 1))
						{
							if (!IS_PED_INJURED(uParam0->f_17[0]))
							{
								func_38(uParam0->f_17[0], "LOSE_WANTED_LEVEL", 3);
							}
							CLEAR_BIT(&(uParam0->f_13), 1);
						}
					}
					if (!DOES_BLIP_EXIST(uParam0->f_5))
					{
						...
						if (bParam35)
						{
							func_36(uParam0->f_5, uParam0);
						}
					}
					else if (!func_35(vVar3, GET_BLIP_COORDS(uParam0->f_5), 0.1f, 0))
					{
					...
					if (bParam28)
					{
						...
						if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vParam7, vParam10, uParam36, 0, iVar6, iVar7))
						{
							bVar1 = true;
						}
					}
					...
					if (bVar1)
					{
						...
						while (iVar2 < 3)
						{
							if (!IS_PED_INJURED(uParam0->f_17[iVar2]))
							{
								...
								else if (!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar2], func_34()) || !func_32(uParam0->f_17[iVar2], 1))
								{
									bVar1 = false;
								}
							}
						...
						if (!func_42(uParam0, 2))
						{
							...
							else if (IS_BIT_SET(uParam0->f_13, 9))
							{
								...
								if (!IS_BIT_SET(uParam0->f_13, 23))
								{
									if (!IS_PED_INJURED(uParam0->f_17[0]))
									{
										func_38(uParam0->f_17[0], "GET_IN_CAR", 3);
									}
						...
						if (!func_42(uParam0, 2))
						{
							if (IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()))
							{
								if (!IS_BIT_SET(uParam0->f_13, 13))
								{
									...
									{
										func_38(uParam0->f_17[iVar9], "NEED_A_BIGGER_VEHICLE", 3);
									}
...
int func_27(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_28(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		SET_BLIP_SCALE(uVar0, func_28(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
int func_29(var uParam0)
{
	if (IS_BIT_SET(uParam0->f_13, 12))
	{
		...
		{
			if (func_30(1, 0, 1) || IS_BIT_SET(uParam0->f_13, 7))
			{
				return 1;
			}
		}
	}
	else if (func_30(1, 0, 1) || IS_BIT_SET(uParam0->f_13, 7))
	{
		return 1;
	}
	return 0;
...
int func_32(var uParam0, int iParam1)
{
	if (!IS_PED_INJURED(uParam0))
	{
		...
		{
			if (func_33(PLAYER_PED_ID(), uParam0))
			{
...
int func_35(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
var func_37(vector3 vParam0, int iParam3)
{
	var uVar0;
...
void func_38(var uParam0, char* sParam1, int iParam2)
{
	_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_39(iParam2), 1);
}
...
void func_40(var uParam0, char* sParam1, bool bParam2)
{
	if (!bParam2)
	{
...
int func_45(var uParam0, int iParam1)
{
	...
	{
		uVar0 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
		if (func_46(uVar0, uParam0, iParam1))
		{
			return 1;
		}
	}
...
int func_46(var uParam0, var uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_48(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, var uParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17)
{
	int iVar0;
	int iVar1;
	int iVar2;
						...
						if (func_46(uParam0->f_21, uParam0, iVar3))
						{
							...
							while (iVar0 < 3)
							{
								if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
								{
									...
									if (GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], -1794415470) == 7 && !func_64(uParam0->f_17[iVar0], uParam0->f_21))
									{
		...
		if (bVar23)
		{
			...
			while (iVar0 < 3)
			{
				if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
				{
					...
					if (!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_34()))
					{
						if (func_62(uParam0, uParam0->f_17[iVar0], uParam8, 1))
						{
	...
	if (!IS_BIT_SET(uParam0->f_13, 26))
	{
		if ((!func_61(uParam0) && IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID())) && !DOES_ENTITY_EXIST(iParam10))
		{
			...
			if (IS_VEHICLE_DRIVEABLE(iVar13, 0))
			{
				if (!IS_BIT_SET(uParam0->f_13, 13))
				{
					...
					if (!func_42(uParam0, 2))
					{
						...
						{
							func_38(uParam0->f_17[iVar27], "NEED_A_BIGGER_VEHICLE", 3);
						}
						func_40(uParam0, "MORE_SEATS", 0);
						SET_BIT(&(uParam0->f_13), 13);
					}
		...
		if (!DOES_ENTITY_EXIST(iParam10))
		{
			if ((!IS_PED_INJURED(uParam0->f_17[0]) || !IS_PED_INJURED(uParam0->f_17[1])) || !IS_PED_INJURED(uParam0->f_17[2]))
			{
				...
				{
					if (IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()) && !func_42(uParam0, 2))
					{
						iVar13 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
						if (func_60(iVar13, uParam0))
						{
				...
				if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
				{
					...
					if (IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()))
					{
						...
						if (IS_VEHICLE_DRIVEABLE(iVar13, 0))
						{
							if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_34()))
							{
								if (!func_61(uParam0) && IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()))
								{
					...
					if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_34()))
					{
						...
						{
							if (func_46(uVar32, uParam0, 0))
							{
								if (func_58(iVar0, uParam0) || !IS_BIT_SET(uParam0->f_13, 27))
								{
									SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uParam0->f_17[iVar0], iVar0);
					...
					if ((!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_34()) && !func_55(uParam0->f_17[iVar0], iParam10)) && !func_54(uParam0->f_17[iVar0], iParam10))
					{
						if (func_62(uParam0, uParam0->f_17[iVar0], uParam8, bParam11))
						{
							if (!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_34()))
							{
					...
					{
						if (((func_32(uParam0->f_17[iVar0], 1) || func_55(uParam0->f_17[iVar0], iParam10)) || iParam12) || (IS_VEHICLE_DRIVEABLE(iParam10, 0) && !IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iParam10, 0)))
						{
							if (DOES_BLIP_EXIST(uParam0->f_1[iVar0]))
							{
								REMOVE_BLIP(&(uParam0->f_1[iVar0]));
								func_47(uVar15[iVar0]);
							}
						}
						else
						{
						...
						if (!IS_PED_SITTING_IN_VEHICLE(uParam0->f_17[iVar0], iParam10))
						{
							if ((IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], iParam10, 20f, 20f, 5f, 0, 1, 0) && !IS_BIT_SET(uParam0->f_13, 11)) && !((bParam17 && IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) && !IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iParam10, 0)))
							{
								...
								else
								{
									...
									iVar14 = GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], -1794415470);
									if (iVar14 == 7 && !func_64(uParam0->f_17[iVar0], iParam10))
									{
										if (((((!IS_PED_JUMPING_OUT_OF_VEHICLE(uParam0->f_17[iVar0]) && !IS_PED_JUMPING_OUT_OF_VEHICLE(PLAYER_PED_ID())) && !func_53(uParam0->f_17[iVar0], 2f)) && !IS_PED_RAGDOLL(uParam0->f_17[iVar0])) && !IS_PED_GETTING_UP(uParam0->f_17[iVar0])) && !IS_ENTITY_ON_FIRE(iParam10))
										{
											SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_17[iVar0], 1);
			...
			if (iVar1 > 0)
			{
				...
				while (iVar0 < 3)
				{
					if (iVar7[iVar0])
					{
						if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
						{
							if (func_59(uParam0->f_17[iVar0]) || IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], PLAYER_PED_ID(), uParam0->f_8, uParam0->f_8, uParam0->f_8, 0, 1, 0))
							{
								iVar1 = (iVar1 - 1);
								iVar7[iVar0] = 0;
							}
					...
					{
						if (!IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], PLAYER_PED_ID(), (uParam0->f_8 * 0.85f), (uParam0->f_8 * 0.85f), uParam0->f_8, 0, 1, 0) && !func_59(uParam0->f_17[iVar0]))
						{
						}
					}
					iVar0++;
								...
								if (iVar7[iVar0])
								{
									if (!func_52(iVar0, uParam0))
									{
										if (!IS_STRING_NULL(uVar19[iVar0]))
										{
											...
											{
												func_50(uParam0, uVar15[iVar0], uVar19[iVar0], 0);
										...
										if (!func_52(iVar0, uParam0))
										{
											func_40(uParam0, uVar15[iVar0], 0);
											func_49(iVar0, uParam0);
											uParam0->f_12 = iVar1;
										}
									}
...
void func_50(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	if (!bParam3)
	{
		if (!IS_STRING_NULL(uParam1))
		{
			...
			{
				func_51(uParam1, uParam2, 7500, 1);
			}
		}
	}
	uParam0->f_10 = GET_GAME_TIMER();
...
void func_51(var uParam0, var uParam1, int iParam2, int iParam3)
{
	iParam3 = iParam3;
...
int func_70(var uParam0)
{
	...
	if (!uParam0->f_6)
	{
		fVar0 = func_73(PLAYER_PED_ID(), *uParam0, 0);
		if (!iLocal_327)
		{
			if (fVar0 < 400f)
			{
				...
				REQUEST_SCRIPT_AUDIO_BANK("PLANES", 0, -1);
				iLocal_327 = 1;
			}
		}
		if (!iLocal_328)
		...
		if (fVar0 < uParam0->f_3)
		{
			...
			if (bLocal_326)
			{
				...
				else if ((GET_GAME_TIMER() - uParam0->f_7) > 1000)
				{
					uParam0->f_6 = 1;
		...
		if (!uParam0->f_6)
		{
			if (!DOES_BLIP_EXIST(uParam0->f_4))
			{
				...
				SET_BLIP_SCALE(uParam0->f_4, 0.75f);
				_0x75A16C3DA34F1245(uParam0->f_4, 0);
			}
			if (!DOES_BLIP_EXIST(uParam0->f_5))
			{
...
var func_71(vector3 vParam0, var uParam3, bool bParam4)
{
	var uVar0;
	
	uVar0 = ADD_BLIP_FOR_RADIUS(vParam0, uParam3);
	SET_BLIP_COLOUR(uVar0, 5);
	SET_BLIP_ALPHA(uVar0, 64);
	SET_BLIP_AS_SHORT_RANGE(uVar0, bParam4);
	if (!bParam4)
	{
		SET_BLIP_DISPLAY(uVar0, 4);
	}
	return uVar0;
}
...
var func_73(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
	...
	if (DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_126(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_123(GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_75(Global_97130.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}

void func_75(int iParam0, vector3 vParam1, var uParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (DOES_ENTITY_EXIST(iParam0) && IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_109(iParam5, &Var0, vParam1, uParam4, func_115(iParam0));
		func_76(iParam5, iParam0, 0);
	}
}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_93(iParam0, 0, 0)) || func_93(iParam0, 1, 0)) || func_93(iParam0, 2, 0)) || func_115(iParam0) != 145) || func_92(iParam0)) || func_91(iParam0)) || func_90(iParam0)) || func_89(iParam0)) || !func_79(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_91(iParam0))
		{
		}
...
{
	return (SHIFT_RIGHT(uParam0, 26) & 31 * func_101(IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_109(int iParam0, var uParam1, vector3 vParam2, var uParam5, int iParam6)
{
	if (func_106(&(Global_70409.f_555[0 /*21*/]), iParam0))
	{
...
int func_123(vector3 vParam0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;
	
	iVar0 = func_124(vParam0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
float func_132(var uParam0, var uParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
{
	return func_27(uParam0, !bParam1, bParam2);
}
...
void func_137()
{
	...
	REQUEST_ADDITIONAL_TEXT("PPROM", 0);
	func_141(2, 1);
	func_140(&uLocal_76, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
	...
	while (iVar0 <= 9)
	{
		if (!func_139(Local_242[iVar0 /*8*/]))
		{
			fVar1 = 0f;
			GET_GROUND_Z_FOR_3D_COORD(Local_242[iVar0 /*8*/], &fVar1, 0, 0);
...
void func_142()
{
	if (DOES_ENTITY_EXIST(iLocal_241))
	{
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_241);
	}
	if (DOES_BLIP_EXIST(Local_242[0 /*8*/].f_4))
	{
		REMOVE_BLIP(&(Local_242[0 /*8*/].f_4));
	}
	if (DOES_BLIP_EXIST(Local_242[0 /*8*/].f_5))
	{
		REMOVE_BLIP(&(Local_242[0 /*8*/].f_5));
	}
	if (DOES_BLIP_EXIST(Local_242[1 /*8*/].f_4))
	{
		REMOVE_BLIP(&(Local_242[1 /*8*/].f_4));
	}
	if (DOES_BLIP_EXIST(Local_242[1 /*8*/].f_5))
	{
		REMOVE_BLIP(&(Local_242[1 /*8*/].f_5));
	}
