...
void __EntryFunction__()
{
	...
	if (Global_2621550)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(-43879923) == 0)
		{
			...
			START_NEW_SCRIPT_WITH_NAME_HASH_AND_ARGS(-43879923, &ScriptParam_0, 4, 1424);
		}
		TERMINATE_THIS_THREAD();
	}
	else if (Global_2621549)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(1179280373) == 0)
		{
			...
			START_NEW_SCRIPT_WITH_NAME_HASH_AND_ARGS(1179280373, &ScriptParam_0, 4, 1424);
		}
		TERMINATE_THIS_THREAD();
	}
		...
		case 1:
			switch (ScriptParam_0.f_1)
			{
				...
				case 52:
					...
					{
						_0x0CF54F20DE43879C(ScriptParam_0.f_3);
					}
					break;
				...
				case 76:
					if (Global_71856 != -1)
					{
						...
						if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
						{
							...
							{
								Global_71841 = { GET_ENTITY_VELOCITY(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)) };
							}
						}
...
void func_54(int iParam0, var uParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	if (iParam5 != 0)
	{
...
void func_56(int iParam0, var uParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	if (iParam5 != 0)
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(iParam5, "SET_DATA_SLOT");
...
void func_57(int iParam0, int iParam1, var uParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_58(int iParam0, int iParam1, var uParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	float fVar0;
...
void func_59(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4)
{
	if (iParam4 != 0)
	{
...
void func_60(int iParam0, var uParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
void func_61(int iParam0, var uParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	if (iParam5 != 0)
	{
		BEGIN_SCALEFORM_MOVIE_METHOD(iParam5, "SET_DATA_SLOT");
...
void func_66()
{
	...
	if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
	{
		if (func_69(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
...
void func_83(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, char* sParam5, var uParam6)
{
