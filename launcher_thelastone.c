	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_104307[Var0 /*10*/].f_9 != -1)
			{
				...
				func_263(&(Global_104307[Var0 /*10*/].f_9));
			}
		}
		func_250(&Var0, 1);
	}
...
int func_179(var uParam0, vector3 vParam1, char[4] cParam2, void fParam3, int iParam4, char* sParam5, int iParam6)
{
	var uVar0;
	...
	if (func_170(2))
	{
		if (!func_143())
		{
			if (((func_124(PLAYER::PLAYER_PED_ID()) && func_124(uParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam6) && func_185(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_184(&uVar0, iParam4, uParam0->f_28[0], sParam5, 0, 1);
				func_182(&uVar0, cParam2, fParam3, 7, 0, 0);
				uParam0->f_60 = MISC::GET_GAME_TIMER();
				return 1;
			}
		}
		else if (func_180(fParam3))
		{
			if (func_124(PLAYER::PLAYER_PED_ID()))
			{
				if (func_185(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
				{
					func_141();
				}
			}
...
void func_186(int iParam0, var uParam1, void fParam2, vector3 vParam3, vector3 vParam4, vector3 vParam5)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(fParam2))
		{
			...
			{
				if (func_185(PLAYER::PLAYER_PED_ID(), vParam3, 1) <= 100f)
				{
					func_189(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_185(PLAYER::PLAYER_PED_ID(), vParam4, 1);
					fVar1 = func_185(PLAYER::PLAYER_PED_ID(), vParam5, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								CUTSCENE::REMOVE_CUTSCENE();
								CUTSCENE::_REQUEST_CUTSCENE_EX(fParam2, 5, 8);
								func_187(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							CUTSCENE::REMOVE_CUTSCENE();
							CUTSCENE::_REQUEST_CUTSCENE_EX(fParam2, 6, 8);
							func_187(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_185(PLAYER::PLAYER_PED_ID(), vParam3, 1) > 120f)
				{
					func_190(iParam0);
				}
			}
...
int func_233(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (((!func_236(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmlastone1")) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("weapon_pumpshotgun"))) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_51 = 2;
...
bool func_241(int iParam0, void fParam1)
{
...
int func_247(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	int iVar0;
...
int func_248(int iParam0, vector3 vParam1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
...
int func_249(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_261(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
