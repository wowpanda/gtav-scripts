...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_196(Var0);
		func_189(&iLocal_93, &uLocal_94, &(Var0.f_9), vVar61, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_182(&Var0, vVar61, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
		if (func_167(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_182(var uParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
	...
	if (func_173(2))
	{
		if (!func_145())
		{
			if (((func_126(PLAYER_PED_ID()) && func_126(uParam0->f_28[0])) && (GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_188(PLAYER_PED_ID(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_187(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
				func_185(&uVar0, cParam4, sParam5, 7, 0, 0);
				uParam0->f_60 = GET_GAME_TIMER();
				return 1;
			}
		}
		else if (func_183(sParam5))
		{
			if (func_126(PLAYER_PED_ID()))
			{
				if (func_188(PLAYER_PED_ID(), vParam1, 1) >= 20f)
				{
					func_143();
				}
			}
...
void func_187(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
...
float func_188(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
void func_189(int iParam0, var uParam1, var uParam2, vector3 vParam3, vector3 vParam6, vector3 vParam9)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (!IS_STRING_NULL_OR_EMPTY(uParam2))
		{
			...
			{
				if (func_188(PLAYER_PED_ID(), vParam3, 1) <= 100f)
				{
					func_192(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_188(PLAYER_PED_ID(), vParam6, 1);
					fVar1 = func_188(PLAYER_PED_ID(), vParam9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								REMOVE_CUTSCENE();
								_REQUEST_CUTSCENE_EX(uParam2, 5, 8);
								func_190(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							REMOVE_CUTSCENE();
							_REQUEST_CUTSCENE_EX(uParam2, 6, 8);
							func_190(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_188(PLAYER_PED_ID(), vParam3, 1) > 120f)
				{
					func_193(iParam0);
				}
			}
...
void func_198(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_126(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_200(uParam1) || !IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_199(iParam2) && !IS_PED_FACING_PED(iParam0, PLAYER_PED_ID(), 25f))
					{
						TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_200(uParam1) && uParam1->f_4 == 0) && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_199(iParam2) || IS_PED_FACING_PED(iParam0, PLAYER_PED_ID(), 10f))
				{
					if (func_68(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_236(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (((!func_239(&iVar0) || !HAS_ANIM_DICT_LOADED("rcmlastone1")) || !HAS_WEAPON_ASSET_LOADED(joaat("weapon_pumpshotgun"))) || !HAS_WEAPON_ASSET_LOADED(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			bVar5 = true;
			uParam0->f_28[0] = CREATE_PED(25, iLocal_92, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
...
int func_251(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
