...
void __EntryFunction__()//Position - 0x0
{
	...
	func_34(1);
	if (func_33(AUDIO::_0x0626A247D2405330()))
	{
	...
	while (true)
	{
		...
		func_33(AUDIO::_0x0626A247D2405330());
		if (func_1())
		{
			func_40();
		}
...
void func_2(char* sParam0)//Position - 0x1EE
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	CAM::_DISABLE_VEHICLE_FIRST_PERSON_CAM_THIS_FRAME();
}

void func_3()//Position - 0x200
{
	int iVar0;
	int iVar1;
...
void func_5()//Position - 0x26B
{
}

void func_6(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x273
{
	if (bParam0)
	{
...
int func_9(int iParam0, bool bParam1)//Position - 0x404
{
	int iVar0;
	int iVar1;
...
int func_10()//Position - 0x445
{
	return Global_1407E0;
}

int func_11(int iParam0)//Position - 0x451
{
	if (func_8(iParam0, 0))
	{
		return 1;
...
bool func_12()//Position - 0x493
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_240006, 3);
}

int func_13(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x4A4
{
	int iVar0;
...
void func_15(int iParam0)//Position - 0x4FE
{
	if (iParam0 == 1)
	{
...
void func_16(bool bParam0)//Position - 0x521
{
	int iVar0;
...
void func_17(int iParam0)//Position - 0x855
{
	switch (iParam0)
	{
		case 0:
...
void func_18(int iParam0, int iParam1, int iParam2)//Position - 0x9C5
{
	Local_22[iParam0] = iParam1;
	Local_22.f_11[iParam0] = iParam2;
}

void func_19(var uParam0, int iParam1)//Position - 0x9DF
{
	uParam0->f_16 = 0;
...
void func_20(var uParam0, int iParam1)//Position - 0xA07
{
	uParam0->f_16 = 0;
...
void func_21(var uParam0, int iParam1)//Position - 0xA2F
{
	vector3 vVar0;
...
void func_22(var uParam0, vector3 vParam1, vector3 vParam2, int iParam3, float fParam4, float fParam5)//Position - 0x23D4
{
	uParam0->f_1 = { vParam1 };
	uParam0->f_4 = { vParam2 };
	uParam0->f_7 = iParam3;
...
void func_23(var uParam0, int iParam1, vector3 vParam2, vector3 vParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2406
{
...
void func_24(var uParam0, var uParam1, vector3 vParam2, vector3 vParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2441
{
	*uParam0 = { vParam2 };
	uParam0->f_3 = { vParam3 };
	uParam0->f_6 = uParam4;
...
float func_25(float fParam0)//Position - 0x2473
{
	return (fParam0 * 57.29578f);
}

void func_26(var uParam0)//Position - 0x2483
{
	uParam0->f_9A = 0;
	uParam0->f_9B[0 /*11*/] = 0;
	uParam0->f_9B[1 /*11*/] = 0;
...
int func_27(char* sParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x24A0
{
	int iVar0;
...
int func_28(char* sParam0, var uParam1, int iParam2)//Position - 0x2505
{
	int iVar0;
...
int func_29(char* sParam0, int iParam1)//Position - 0x256D
{
	int iVar0;
...
char* func_30(int iParam0)//Position - 0x25C8
{
	char* sVar0;
...
void func_31(int iParam0, int iParam1)//Position - 0x2698
{
	...
	*iParam0 = PED::ADD_SCENARIO_BLOCKING_AREA(-7000f, -7000f, -100f, 7000f, 7000f, 315f, 0, 1, 1, 1);
	...
	if (func_33(AUDIO::_0x0626A247D2405330()) && iParam1 == 1)
	{
		MISC::CLEAR_AREA_OF_PEDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 500f, 0);
	}
}

void func_32(bool bParam0)//Position - 0x2767
{
...
bool func_33(int iParam0)//Position - 0x27C1
{
...
void func_34(bool bParam0)//Position - 0x27DF
{
	if (bParam0)
	{
		func_39();
...
void func_35(int iParam0)//Position - 0x2842
{
	if (func_37())
	{
		return;
...
void func_36(bool bParam0, bool bParam1)//Position - 0x28BC
{
	if (bParam0)
	{
		if (func_38(0))
...
bool func_37()//Position - 0x2930
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

int func_38(int iParam0)//Position - 0x2942
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
void func_42(int iParam0)//Position - 0x2AD2
{
...
void func_43(char* sParam0)//Position - 0x2B35
{
	STREAMING::REMOVE_ANIM_DICT(sParam0);
}

void func_44(int iParam0)//Position - 0x2B43
{
	if (iParam0 != 0)
	{
...
void func_45(var uParam0)//Position - 0x2B57
{
	int iVar0;
	char* sVar1;
	char* sVar2;
...
char* func_46(int iParam0)//Position - 0x2BCC
{
	char* sVar0;
...
char* func_47(int iParam0)//Position - 0x2BE2
{
	char* sVar0;
...
void func_48(var uParam0)//Position - 0x2BF7
{
	int iVar0;
...
void func_49(int iParam0)//Position - 0x2C43
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_50(var uParam0)//Position - 0x2C84
{
	int iVar0;
...
void func_51(int iParam0)//Position - 0x2CAD
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
