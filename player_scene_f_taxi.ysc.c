...
int func_2()//Position - 0x11B
{
	...
	if (!func_3(&uVar0))
	{
		vVar1 = { unk_0x8000C77B5F336760(iLocal_68, false) };
		fVar2 = SYSTEM::VDIST2(vLocal_170 + vLocal_173, vVar1);
		if (fVar2 < (4.5f * 4.5f))
		{
			BRAIN::TASK_VEHICLE_DRIVE_WANDER(iLocal_68, iLocal_70, fLocal_171, 786599);
			return 1;
		}
	}
	return 0;
...
int func_4()//Position - 0x1B6
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_16221))
		{
			...
			if (!func_5(Global_16B5A, iLocal_70, 2))
			{
				if (fVar1 >= 0.9f)
				{
					PED::SET_PED_INTO_VEHICLE(Global_16B5A, iLocal_70, 2);
				}
			}
			if (!iLocal_172)
			{
				unk_0x346478B12F69D4E3(iLocal_68, false);
				iLocal_172 = 1;
			}
			BRAIN::TASK_VEHICLE_TEMP_ACTION(iLocal_68, iLocal_70, 6, 50);
		}
		else
		{
			if (!func_5(Global_16B5A, iLocal_70, 2))
			...
			if (!func_3(&uVar0))
			{
				...
				BRAIN::TASK_VEHICLE_TEMP_ACTION(0, iLocal_70, 24, 50);
				BRAIN::TASK_PAUSE(0, 2000);
				BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_70, vLocal_170 + vLocal_173, fLocal_171, 0, iLocal_71, 786599, ((4.5f / 2f) - 1f), 10f);
				CUTSCENE::_0x8D9DF6ECA8768583(iVar2);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_68, iVar2);
...
int func_8(int iParam0, int iParam1)//Position - 0x36D
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_9(Global_16B5A) && iParam1 != 0)
		{
			Global_16B5A = 0;
		}
	}
...
void func_21()//Position - 0x69B
{
	...
	iVar0 = 0;
	while ((!ENTITY::DOES_ENTITY_EXIST(Global_16B5A) || !ENTITY::DOES_ENTITY_EXIST(iLocal_70)) || (!STREAMING::HAS_MODEL_LOADED(iLocal_69) && iVar0 < 400))
	{
	...
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_16B5A, Global_1590B);
		AUDIO::SET_AMBIENT_VOICE_NAME(Global_16B5A, "A_F_Y_BevHills_01_White_FULL_01");
	}
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_70, 0))
	{
		...
		iLocal_68 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_70, 4, iLocal_69, 4294967295, 1, true);
	...
	switch (Param0.f_2)
	{
		...
		case 12:
			*uParam1 = { Param0 };
			...
			func_26(uParam1, 144, 3312640106, 3312640106, 0f, 0f, 0f, 0f);
			uParam1->f_76 = 2;
			return 1;
			break;
		...
		case 75:
			*uParam1 = { Param0 };
			...
			func_26(uParam1, 30, 3312640106, 3312640106, 0f, 0f, 0f, 0f);
			uParam1->f_76 = 2;
			return 1;
			break;
		...
		case 80:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_26(uParam1, 17, 2277090178, 2277090178, Vector(2.6407f, 8.164f, -14.1564f) + Vector(-1f, 0.03f, -2.16f), (-66f + -56f));
			if (Param0.f_2 == 80)
			{
				func_27(uParam1);
			}
		...
		case 99:
			*uParam1 = { Param0 };
			uParam1->f_6D = 3312640106;
			uParam1->f_6E = 3312640106;
			func_26(uParam1, 15, 3312640106, 451360105, 0f, 0f, 0f, 0f);
			uParam1->f_76 = 2;
			return 1;
			break;
		...
		case 101:
			*uParam1 = { Param0 };
			uParam1->f_6D = 3312640106;
			uParam1->f_6E = 3312640106;
			func_26(uParam1, 14, 3312640106, 451360105, 0f, 0f, 0f, 0f);
			uParam1->f_76 = 2;
			return 1;
			break;
		...
		case 167:
			*uParam1 = { Param0 };
			uParam1->f_6D = 3312640106;
			uParam1->f_6E = 1785177548;
			func_26(uParam1, 14, 3312640106, 1785177548, -0.8472f, 0.155f, 0f, 152.556f);
			uParam1->f_76 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 193:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_26(uParam1, 144, 3312640106, 1785177548, 4.2943f, -6.7858f, 0f, -133.5332f);
			uParam1->f_76 = 1;
			if (Global_3)
			{
				uParam1->f_76 = 1;
		...
		case 270:
			*uParam1 = { Param0 };
			...
			if (Param0.f_2 == 267)
			{
				func_26(uParam1, 144, 3312640106, 2106541073, -2.4166f, -0.15f, 0f, -148.7555f);
			}
			if (Param0.f_2 == 266)
			{
		...
		case 289:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_26(uParam1, 144, 2277090178, 2277090178, -3.264f, -14.7895f, 14.1815f, -0.6311f);
			uParam1->f_76 = 1;
			return 1;
			break;
		...
		case 312:
			*uParam1 = { Param0 };
			...
			func_26(uParam1, 144, 474215631, 2775823996, -9.5443f, -3.191f, -0.3f, 180f);
			uParam1->f_76 = 1;
			return 1;
			break;
...
int func_30(int iParam0, var uParam1, int iParam2)//Position - 0x7A59
{
	...
	if (!func_31(Global_16A1D[iParam0 /*98*/], 0))
	{
		func_29(iParam0, uParam1, iParam2);
		uParam1->f_5B = iParam2;
		return 1;
...
int func_32(int iParam0)//Position - 0x7E10
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_34(int iParam0)//Position - 0x7EF3
{
	int iVar0;
	int iVar1;
...
int func_35()//Position - 0x9BF1
{
	return 0;
}

int func_36()//Position - 0x9BFA
{
	return 1;
}

int func_37()//Position - 0x9C03
{
	return 1;
}

int func_38()//Position - 0x9C0C
{
...
int func_40(int iParam0)//Position - 0x9CE0
{
...
int func_41(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0x9F60
{
	int iVar0;
...
bool func_42(var uParam0)//Position - 0xA15B
{
	int iVar0;
	vector3 vVar1;
	float fVar2;
...
bool func_43(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0xA216
{
	if (bParam2)
	{
...
int func_44(int iParam0, var uParam1, char* sParam2)//Position - 0xA25D
{
	vector3 vVar0;
	int iVar1;
	var uVar2;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[0];
			StringCopy(sParam2, func_48(Global_19E56.f_933.f_21B.f_8F6[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[1];
			StringCopy(sParam2, func_48(Global_19E56.f_933.f_21B.f_8F6[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[2];
			StringCopy(sParam2, func_48(Global_19E56.f_933.f_21B.f_8F6[2]), 32);
			return 1;
			break;
...
int func_45(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0xC85F
{
	switch (iParam1)
	{
		case 0:
...
int func_47(int iParam0, var uParam1, var uParam2)//Position - 0xE7CD
{
	switch (iParam0)
	{
		case 11:
...
char* func_48(int iParam0)//Position - 0xF13C
{
	switch (iParam0)
	{
		case 2014101067:
