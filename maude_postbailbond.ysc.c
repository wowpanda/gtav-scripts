...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			...
			vVar1 = { unk_0x8000C77B5F336760(iLocal_42, true) };
...
void func_1()//Position - 0x1B3
{
	...
	{
		func_2(&iLocal_42);
		BRAIN::TASK_SMART_FLEE_PED(iLocal_42, AUDIO::_0x0626A247D2405330(), 10000f, 4294967295, 0, 0);
...
{
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_617E, 3))
	{
		return "BB4_loiter";
	}
	else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_617E, 2))
	{
		return "BB3_loiter";
	}
	else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_617E, 1))
	{
		return "BB2_loiter";
	}
	else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_617E, 0))
	{
		return "BB1_loiter";
	}
	return "MAUDE_loiter";
...
int func_25(int iParam0, bool bParam1)//Position - 0x836
{
	if (func_51(*iParam0))
	{
		...
		if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330()))
		{
			...
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_39))
				{
					return 1;
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_40))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_40))
				{
					return 1;
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_41))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_41))
				{
					return 1;
				}
			}
		...
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(*iParam0, AUDIO::_0x0626A247D2405330(), 3f, 3f, 3f, 0, 1, 0))
			{
				return 1;
			}
		}
...
int func_26(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x988
{
	...
	if (func_8(AUDIO::_0x0626A247D2405330()) && func_8(iParam0))
	{
...
int func_29(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xC24
{
	...
	vVar0 = { func_31(vParam1 - unk_0x8000C77B5F336760(iParam0, true)) };
...
int func_33(int iParam0, float fParam1)//Position - 0xD5A
{
	...
	if (func_8(AUDIO::_0x0626A247D2405330()) && func_8(iParam0))
	{
		if (func_42(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iParam0))
		{
...
{
	return func_35(iParam0, AUDIO::_0x0626A247D2405330(), fParam1, 1, 250, 7);
}
...
int func_39(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x10E4
{
	...
	vVar0 = { func_31(unk_0x8000C77B5F336760(iParam1, true) - unk_0x8000C77B5F336760(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_50()//Position - 0x1565
{
	...
	if (func_51(iLocal_42))
	{
		...
		ENTITY::SET_ENTITY_HEALTH(iLocal_42, true);
		...
		if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vVar0, 10f, 3914268813, 0))
		{
			iLocal_40 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vVar0, 10f, 3914268813, 1, 0, 1);
			if (func_8(iLocal_40))
			{
		...
		if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vVar0, 10f, 3553022755, 0))
		{
			iLocal_39 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(vVar0, 10f, 3553022755, 0, 0, 1);
			if (func_8(iLocal_39))
			{
