...
void __EntryFunction__()
{
	...
	{
		SYSTEM::WAIT(0);
		if (TASK::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_89)
		{
			if (!func_212())
			{
				if (func_211())
						...
						switch (iLocal_56)
						{
								...
								switch (iLocal_57)
								{
									...
									case 9:
										if (!PED::IS_PED_INJURED(iLocal_71))
										{
											...
											{
												BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_71, vLocal_77, 1f, -1, 0.25f, 0, 1193033728);
											}
											else
											{
							...
							case 1:
								...
								if (!PED::IS_PED_INJURED(iLocal_71))
								{
									...
									BRAIN::TASK_SMART_FLEE_PED(iLocal_71, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
									PED::SET_PED_KEEP_TASK(iLocal_71, true);
									func_53();
								}
								break;
		...
		if (iLocal_57 > 0 && iLocal_57 < 8)
		{
			if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				...
				else if (!PED::IS_PED_RAGDOLL(iLocal_71))
				{
					...
					{
						BRAIN::CLEAR_PED_TASKS(iLocal_71);
						BRAIN::TASK_SMART_FLEE_PED(iLocal_71, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
						func_53();
					}
				}
			}
...
void func_9()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_12(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_10(iVar0) && (!func_13(14) || Global_104171))
			{
...
void func_25()
{
	...
	{
		func_27(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
...
void func_57()
{
	...
	if (!PED::IS_PED_INJURED(iLocal_72) && !PED::IS_PED_INJURED(iLocal_71))
	{
		...
		{
			BRAIN::CLEAR_PED_TASKS(iLocal_72);
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_72, vLocal_77, 1f, -1, 0.25f, 0, 1193033728);
			func_18();
		}
	}
	if (!PED::IS_PED_INJURED(iLocal_72))
				...
				if (!PED::IS_PED_INJURED(iLocal_71) && !PED::IS_PED_INJURED(iLocal_72))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_71, 0) && PED::IS_PED_IN_MELEE_COMBAT(iLocal_72))
					{
						if (!iLocal_137)
						{
							...
							BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_72, -1, 2052, 2);
							...
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_75);
		...
		case 3:
			if (!PED::IS_PED_INJURED(iLocal_71))
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_71) && ENTITY::DOES_ENTITY_EXIST(iLocal_72))
				{
					...
					BRAIN::TASK_PLAY_ANIM(0, "random@hitch_lift", "f_distressed_loop", 2f, -2f, -1, 49, 0, 0, 0, 0);
					BRAIN::TASK_LOOK_AT_ENTITY(0, iLocal_72, -1, 2052, 4);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_72, false), 1f, -1, 3f, 0, 1193033728);
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_72, -1);
...
void func_62()
{
	...
	if (iLocal_58 == 1)
	{
		...
		if (!iLocal_102)
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_71))
			{
				...
				func_81(198, 0);
				BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_71, 8000, 2052, 4);
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_75);
	...
	else if (iLocal_58 == 2)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_71))
		{
			if (!PED::IS_PED_RAGDOLL(iLocal_71))
			{
				...
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 3323.43f, 5166.832f, 17.406f, 1f, -1, 0.25f, 0, 1193033728);
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 3320.684f, 5186.017f, 17.4016f, 1f, -1, 0.25f, 0, 1193033728);
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 3303.612f, 5185.269f, 18.7155f, 1f, -1, 0.25f, 0, 1193033728);
				BRAIN::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_75);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_75);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_75);
				PED::SET_PED_KEEP_TASK(iLocal_71, true);
				BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_71, 5000, 2052, 2);
				PED::REMOVE_PED_FROM_GROUP(iLocal_71);
				SYSTEM::WAIT(1000);
				PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
				if (func_8() == 0)
	...
	else if (iLocal_58 == 5)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_71))
		{
			...
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -346.029f, 632.2272f, 171.2525f, 1f, -1, 0.25f, 0, 1193033728);
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -346.6342f, 627.3992f, 170.3573f, 1f, -1, 0.25f, 0, 1193033728);
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -355.2473f, 622.1964f, 170.3572f, 1f, -1, 0.25f, 0, 1193033728);
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -355.6499f, 615.3431f, 170.3572f, 1f, -1, 0.25f, 0, 1193033728);
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -350.163f, 605.0463f, 170.7292f, 1f, -1, 0.25f, 0, 1193033728);
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -333.177f, 594.991f, 170.7553f, 1f, -1, 0.25f, 0, 1193033728);
	...
	if (bParam1)
	{
		if (!bVar0)
		{
			...
			switch (iParam2)
			{
				...
				case 6:
				case 7:
					MISC::SET_BIT(&(Global_2097152[func_73() /*12171*/].f_7688.f_1272), iParam0);
					func_70(15, 0);
					break;
			}
			func_69(iVar1);
			func_68(iParam0, iVar1);
			Global_104214.f_15[iParam0] = MISC::GET_GAME_TIMER();
		}
	}
	else if (bVar0)
	{
...
void func_68(int iParam0, int iParam1)
{
	if (iParam1 > -1)
	{
		Global_104214.f_4[iParam0] = (MISC::GET_GAME_TIMER() + iParam1);
	}
	else
	{
		Global_104214.f_4[iParam0] = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(1200000, 2100000));
	}
}
...
void func_69(int iParam0)
{
	if (iParam0 != -1)
	{
		Global_104214.f_3 = (MISC::GET_GAME_TIMER() + iParam0);
	}
	else
	{
		Global_104214.f_3 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(21600000, 25200000));
	}
}
...
{
	Global_105220.f_243[func_80() /*53*/].f_2[iParam0 /*5*/].f_1 = iParam1;
}
...
void func_86(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_105220.f_20535.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_73() /*12171*/].f_7688.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_105220.f_20535.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_73() /*12171*/].f_7688.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_89(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_73() /*12171*/].f_7688.f_10, iParam0);
}
...
int func_95(int iParam0, int iParam1)
{
	...
	if (func_105(&Global_4267702))
	{
		if (func_103(&Global_4267702, iParam0))
		{
			return 0;
		}
		if (func_96(&Global_4267702, iParam0))
		{
			return 1;
		}
	}
...
void func_99(var uParam0)
{
	...
	func_101(uParam0, (Global_4267701 - 0.5f));
}
	...
	if (!PED::IS_PED_INJURED(iLocal_71))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
		{
			if (!func_117())
			{
				...
				{
					BRAIN::TASK_GO_TO_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), -1, 6f, 2f, 1073741824, 0);
				}
	...
	if (!func_54())
	{
		switch (iLocal_86)
		{
			...
			case 22:
				if (!PED::IS_PED_INJURED(iLocal_71))
				{
					BRAIN::TASK_PLAY_ANIM(iLocal_71, "facials@gen_female@base", "mood_sleeping_1", 2f, -2f, -1, 33, 0, 0, 0, 0);
				}
				iLocal_86++;
				break;
			}
		...
		if (iLocal_58 == 3)
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vLocal_84, 200f, 200f, 200f, false, true, 0))
			{
				...
				if (STREAMING::HAS_MODEL_LOADED(iLocal_81) && STREAMING::HAS_CLIP_SET_LOADED("move_m@brave"))
				{
					...
					BRAIN::TASK_PLAY_ANIM(iLocal_72, "random@hitch_lift", "idle_a", 2f, -2f, -1, 1, 0, 0, 0, 0);
					BRAIN::TASK_LOOK_AT_ENTITY(iLocal_72, PLAYER::PLAYER_PED_ID(), -1, 2052, 4);
...
void func_169(void fParam0, int iParam1)
{
	...
	switch (iLocal_108)
	{
			...
			if (!PED::IS_PED_INJURED(iLocal_71))
			{
				...
				if (PED::IS_PED_FACING_PED(iLocal_71, PLAYER::PLAYER_PED_ID(), 90f))
				{
					if (func_172(iLocal_71, PLAYER::PLAYER_PED_ID()) < 24f || (PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID()) && func_172(PLAYER::PLAYER_PED_ID(), iLocal_71) < 30f))
					{
						...
						BRAIN::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, fLocal_152, 2f, 1073741824, 0);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_75);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_75);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_75);
						iLocal_108++;
		...
		case 1:
			...
			if (!PED::IS_PED_INJURED(iLocal_71))
			{
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_73, 0))
					{
						if (func_172(iLocal_71, PLAYER::PLAYER_PED_ID()) < 25f || (PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID()) && func_172(PLAYER::PLAYER_PED_ID(), iLocal_71) < 30f))
						{
							if (PED::IS_PED_FACING_PED(iLocal_71, PLAYER::PLAYER_PED_ID(), 150f))
							{
								...
								{
									BRAIN::TASK_OPEN_VEHICLE_DOOR(0, iLocal_73, -1, 0, 2f);
								}
				...
				{
					BRAIN::TASK_LOOK_AT_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), 7000, 2052, 2);
					...
					if (func_117())
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0))
						{
							if (VEHICLE::IS_VEHICLE_SEAT_FREE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0, 0))
							{
								...
								PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_71, 1);
								PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_71, 0);
								BRAIN::TASK_LOOK_AT_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), 10000, 2052, 2);
								BRAIN::TASK_ENTER_VEHICLE(iLocal_71, PLAYER::GET_PLAYERS_LAST_VEHICLE(), -1, 0, 2f, 1, 0);
								func_171();
								iLocal_108++;
							}
							else
		...
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_71))
			{
				...
				else if (func_172(iLocal_71, PLAYER::PLAYER_PED_ID()) < 8f || (PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID()) && func_172(PLAYER::PLAYER_PED_ID(), iLocal_71) < 30f))
				{
					...
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_75);
					BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
					BRAIN::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, fLocal_152, 1f, 1073741824, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_75);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_75);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_75);
					iLocal_108++;
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_73, 0))
					{
						if (func_172(iLocal_71, PLAYER::PLAYER_PED_ID()) < 10f || (PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID()) && func_172(PLAYER::PLAYER_PED_ID(), iLocal_71) < 30f))
						{
							if (PED::IS_PED_FACING_PED(iLocal_71, PLAYER::PLAYER_PED_ID(), 150f))
							{
								...
								if (VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_73, 0, 0))
								{
									BRAIN::TASK_OPEN_VEHICLE_DOOR(0, iLocal_73, -1, 0, 1f);
								}
								BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
								BRAIN::CLOSE_SEQUENCE_TASK(iLocal_75);
								BRAIN::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_75);
					...
					if (func_117())
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0))
						{
							if (VEHICLE::IS_VEHICLE_SEAT_FREE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0, 0))
							{
								...
								PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_71, 0);
								BRAIN::TASK_LOOK_AT_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), 10000, 2052, 2);
								BRAIN::TASK_ENTER_VEHICLE(iLocal_71, PLAYER::GET_PLAYERS_LAST_VEHICLE(), -1, 0, 1f, 1, 0);
								func_171();
								iLocal_108++;
							}
							else
				...
				if (func_172(PLAYER::PLAYER_PED_ID(), iLocal_71) < 12f || (PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID()) && func_172(PLAYER::PLAYER_PED_ID(), iLocal_71) < 30f))
				{
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_73, 0))
						{
							...
							BRAIN::TASK_PLAY_ANIM(iLocal_71, "random@hitch_lift", "idle_f", 2f, -2f, -1, 49, 0, 0, 0, 0);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_75);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_75);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_75);
						}
...
int func_187(int iParam0)
{
	if (func_190())
	{
		...
		if (func_31(Global_105209))
		{
			func_188(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_31(Global_105209))
		{
...
int func_190()
{
	switch (func_191(&Global_25336, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_194(iParam0, Global_35905);
}
...
int func_212()
{
	if ((Global_105209 == func_40() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_105210)
	{
		return 1;
	}
	return 0;
...
int func_216(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_239(Global_105220.f_24966.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_237()) || Global_104267) || Global_25279) || func_236()) || func_15(8, -1)) || func_235()) || func_234()) || func_233()) || func_232()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_237()) || Global_25279) || func_236()) || func_15(8, -1)) || func_233()) || func_235()) || func_234()) || func_232()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_237()) || Global_104267) || Global_25279) || func_236()) || func_15(8, -1)) || func_233()) || func_235()) || func_234()) || func_232()) || Global_105220.f_7659.f_919[iVar0] == 5) || Global_36452 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_237()) || Global_104267) || Global_25279) || func_236()) || func_15(8, -1)) || func_235()) || func_234()) || func_232()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_237() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_15(8, -1)) || func_232()) || func_231()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_237()) || Global_25279) || func_236()) || func_15(8, -1)) || func_234()) || func_233()) || func_232()) || Global_105220.f_7659.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_237()) || func_234()) || Global_104267) || Global_25279) || func_236()) || Global_37057) || func_15(8, -1)) || func_233()) || func_231()) || func_232()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_237()) || Global_104267) || Global_25279) || func_236()) || func_15(8, -1)) || func_233()) || func_231()) || func_235()) || func_234()) || func_232())
						{
							return 0;
						}
						break;
...
void func_246(int iParam0)
{
	...
	if (func_212())
	{
		...
		func_249(30000);
		StringCopy(&cVar0, func_248(Global_105209, 1), 64);
		if (func_39(Global_105209) > 0)
		{
