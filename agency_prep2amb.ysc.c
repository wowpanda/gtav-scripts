...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		func_261("AM_H_PREP8", 2, 0, 4294967295, 10000, 3, 0, 0, 0);
	...
	while (true)
	{
		...
		if (!func_238(1))
		{
			if (func_237(AUDIO::_0x0626A247D2405330()))
			{
				func_230();
				func_223();
				func_222();
	...
	else if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_389E) == 1)
	{
		if (func_10())
		{
			if (func_9())
			{
				...
				while ((!GRAPHICS::_GET_SCALEFORM_MOVIE_FUNCTION_RETURN_BOOL(uVar0) && iVar6 == 0) && GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_389E) == 1)
				{
					SYSTEM::WAIT(0);
...
void func_15(int iParam0)//Position - 0x590
{
	...
	if (iLocal_40 == 0)
	{
		switch (iLocal_41)
		{
			case 0:
				func_106(1);
				uLocal_74 = unk_0x9934FEFB3B8C6DB8("MP_BIG_MESSAGE_FREEMODE");
				func_1(46, 1);
...
void func_17()//Position - 0x8D8
{
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 2) && INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 0))
	{
		if (func_83(iLocal_51))
		{
			...
			{
				if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(iLocal_51, 1), vLocal_52) >= 100f)
				{
					func_67(0);
				}
			}
...
int func_26(int iParam0)//Position - 0x1208
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_28(int iParam0)//Position - 0x12E5
{
	int iVar0;
	int iVar1;
...
int func_29()//Position - 0x2FE0
{
	return 0;
}

int func_30()//Position - 0x2FE9
{
	return 1;
}

int func_31()//Position - 0x2FF2
{
	return 1;
}

int func_32()//Position - 0x2FFB
{
...
int func_34(int iParam0)//Position - 0x30CF
{
	int iVar0;
	char* sVar1;
...
int func_35(int iParam0)//Position - 0x3115
{
	int iVar0;
...
int func_36(int iParam0)//Position - 0x3150
{
	int iVar0;
...
int func_37(int iParam0)//Position - 0x31CC
{
	int iVar0;
...
int func_38(int iParam0, int iParam1, bool bParam2)//Position - 0x32B4
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_39(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3325
{
...
void func_41(var uParam0, int iParam1)//Position - 0x3442
{
	if (iParam1 <= 0)
	{
		return;
...
void func_42(var uParam0, int iParam1)//Position - 0x34C8
{
...
void func_43(var uParam0, int iParam1)//Position - 0x34FB
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0, int iParam1)//Position - 0x354C
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_47(var uParam0)//Position - 0x362A
{
	return uParam0 & 15;
}

void func_48(var uParam0, int iParam1)//Position - 0x3637
{
...
void func_49(var uParam0, int iParam1)//Position - 0x3671
{
...
void func_50(var uParam0, int iParam1)//Position - 0x36AC
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_51(var uParam0, int iParam1)//Position - 0x36E8
{
	int iVar0;
	int iVar1;
...
int func_52(int iParam0, int iParam1)//Position - 0x4DE0
{
	struct<82> Var0;
...
void func_53(int iParam0, var uParam1, int iParam2)//Position - 0x4E22
{
	int iVar0;
...
bool func_54(int iParam0)//Position - 0x507E
{
	return iParam0 < 3;
}

void func_55(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0x508A
{
	if (func_51(&(Global_11188.f_22B[0 /*21*/]), iParam0))
	{
...
void func_56(int iParam0, bool bParam1)//Position - 0x5189
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_57(int iParam0, int iParam1, bool bParam2)//Position - 0x51E6
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_58(var uParam0, var uParam1)//Position - 0x5221
{
...
void func_59(int iParam0)//Position - 0x52ED
{
	if (iParam0 == 4294967295)
	{
		return;
...
int func_60(int iParam0)//Position - 0x5367
{
	int iVar0;
...
void func_61(int iParam0, var uParam1)//Position - 0x53CA
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x5675
{
	switch (iParam0)
	{
		case 1:
...
int func_63(int iParam0, var uParam1, var uParam2)//Position - 0x5725
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x5918
{
	switch (iParam0)
	{
		case joaat("GRANGER"):
...
void func_65(var uParam0)//Position - 0x5938
{
	int iVar0;
...
void func_66(int iParam0)//Position - 0x59E7
{
...
void func_67(bool bParam0)//Position - 0x5A0E
{
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 14))
	{
...
void func_68(int iParam0)//Position - 0x5AF5
{
	int iVar0;
...
int func_69(int iParam0)//Position - 0x5B15
{
	int iVar0;
	int iVar1;
...
int func_70(int iParam0)//Position - 0x5B52
{
	if (func_54(iParam0))
	{
...
bool func_71(int iParam0, int iParam1)//Position - 0x5B7C
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
int func_72(int iParam0)//Position - 0x5B9F
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
bool func_74(int iParam0, vector3 vParam1, float fParam2)//Position - 0x5BD7
{
	return SYSTEM::VDIST2(unk_0x8000C77B5F336760(iParam0, 1), vParam1) <= (fParam2 * fParam2);
}

bool func_75(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x5BF4
{
	if (bParam2)
	{
...
void func_76(int iParam0, bool bParam1)//Position - 0x5C3B
{
...
bool func_78(bool bParam0)//Position - 0x5CAA
{
...
void func_79(char* sParam0, int iParam1)//Position - 0x5CD5
{
...
bool func_82(int iParam0)//Position - 0x5E72
{
	return Global_8D15 == iParam0;
}

int func_83(int iParam0)//Position - 0x5E80
{
	if (func_84(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
int func_84(int iParam0)//Position - 0x5EAA
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_85(int iParam0, int iParam1)//Position - 0x5ECB
{
...
void func_86(bool bParam0)//Position - 0x5F08
{
	char* sVar0;
...
int func_87()//Position - 0x5F7B
{
	func_81();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_88(char* sParam0)//Position - 0x5F94
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	CAM::_DISABLE_VEHICLE_FIRST_PERSON_CAM_THIS_FRAME();
}

void func_89(int iParam0, int iParam1)//Position - 0x5FA6
{
...
void func_92(int iParam0, int iParam1, int iParam2)//Position - 0x6081
{
	bool bVar0;
...
int func_94()//Position - 0x662A
{
	return Global_6373;
}

int func_95(int iParam0, int iParam1)//Position - 0x6635
{
	int iVar0;
...
int func_96(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6686
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_97()//Position - 0x6BEE
{
	return Global_1407E0;
}

int func_98()//Position - 0x6BFA
{
...
int func_101(int iParam0)//Position - 0x6C89
{
	if (iParam0 == 146 || iParam0 == 4294967295)
	{
		return 0;
...
int func_105(int iParam0, int iParam1)//Position - 0x6D14
{
	int iVar0;
	int iVar1;
...
void func_106(int iParam0)//Position - 0x6D55
{
	Global_11729 = iParam0;
	Global_1172A = iParam0;
}

void func_107()//Position - 0x6D69
{
	struct<6> Var0;
...
void func_108(bool bParam0)//Position - 0x6EE2
{
	if (bParam0)
	{
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x6F53
{
	struct<15> Var0;
	int iVar1;
...
void func_110(int iParam0)//Position - 0x70A4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_111(int iParam0)//Position - 0x7168
{
	switch (iParam0)
	{
		case 0:
...
void func_112(int iParam0)//Position - 0x71D2
{
...
void func_114(struct<6> Param0)//Position - 0x7273
{
	if (iLocal_42 == 0)
	{
		func_119(Param0);
...
void func_115(struct<6> Param0)//Position - 0x729A
{
	if (func_99())
	{
		func_116(Param0, 1);
...
void func_116(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)//Position - 0x72BE
{
	struct<4> Var0;
...
struct<4> func_117(bool bParam0)//Position - 0x732E
{
	struct<4> Var0;
...
struct<4> func_118(bool bParam0)//Position - 0x7398
{
	struct<4> Var0;
...
void func_119(struct<6> Param0)//Position - 0x7402
{
	if (func_99())
	{
		if (func_120())
...
void func_122(bool bParam0)//Position - 0x74B9
{
...
void func_123(char* sParam0, char* sParam1)//Position - 0x74CD
{
	if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
	{
		Global_3E07 = 1;
...
struct<6> func_124()//Position - 0x74EE
{
	struct<6> Var0;
...
void func_125()//Position - 0x7512
{
	func_126();
}

void func_126()//Position - 0x751E
{
	func_132();
	func_127();
}

void func_127()//Position - 0x752E
{
	if (func_131() == 69)
	{
	...
	else if (func_131() == 4294967295)
	{
		if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 1))
		{
			if (!func_74(AUDIO::_0x0626A247D2405330(), vLocal_50, 5f))
			{
				if (func_129())
				{
...
bool func_128()//Position - 0x75CA
{
	return SCRIPT::IS_THREAD_ACTIVE(Global_19E56.f_469B.f_18B);
}

int func_129()//Position - 0x75E0
{
	if (func_12())
	{
		if (func_87() == 0)
...
int func_131()//Position - 0x764B
{
	return Global_1172B;
}

void func_132()//Position - 0x7657
{
	if (!func_75(vLocal_52, 0f, 0f, 0f, 0) && func_131() != func_133())
	{
		if (func_74(AUDIO::_0x0626A247D2405330(), vLocal_52, 60f))
		{
			if (func_83(func_72(25)))
			{
				if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(func_72(25), 1), vLocal_52) >= 100f)
				{
					func_67(0);
				}
			}
...
void func_134()//Position - 0x7702
{
	func_16();
	func_107();
}

void func_135()//Position - 0x7712
{
	int iVar0;
...
int func_136(var uParam0)//Position - 0x777D
{
	char* sVar0;
...
int func_137()//Position - 0x77C0
{
	if (func_139(&uLocal_80, Local_44.f_8, sLocal_79, Local_44.f_4, 9, 1, 0, 0, 0))
	{
		iLocal_40 = 1;
		func_138(192, unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 1));
		return 1;
	}
	return 0;
}

void func_138(int iParam0, vector3 vParam1)//Position - 0x77FA
{
	int iVar0;
...
bool func_139(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x7849
{
...
int func_140(char* sParam0, int iParam1, bool bParam2)//Position - 0x78A8
{
	Global_3DCF = 0;
...
bool func_147(int iParam0, int iParam1)//Position - 0x7DF1
{
	switch (iParam0)
	{
		case 5:
...
void func_149(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x7E83
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = uParam1;
...
void func_151(int iParam0, var uParam1)//Position - 0x7EF3
{
	int iVar0;
	...
	func_152(&uLocal_80, Local_44, AUDIO::_0x0626A247D2405330(), Local_44.f_1, 0, 1);
	func_152(&uLocal_80, Local_44.f_2, 0, Local_44.f_3, 0, 1);
	Local_44.f_4 = uParam1;
}

void func_152(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x806A
{
...
void func_153(int iParam0, int iParam1, bool bParam2)//Position - 0x8105
{
	Global_BFD = iParam0;
	if (Global_75[iParam0 /*10*/].f_8 != 145)
	{
...
void func_155(int iParam0)//Position - 0x832C
{
	Local_44.f_6 = ZONE::GET_NAME_OF_ZONE(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 1));
	func_156(iParam0);
}

void func_156(int iParam0)//Position - 0x834B
{
...
char* func_157(int iParam0)//Position - 0x9BDA
{
	char* sVar0;
...
void func_159()//Position - 0x9D3B
{
	if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 6))
	{
		if (func_83(iLocal_51))
		{
			vLocal_52 = { unk_0x8000C77B5F336760(iLocal_51, 1) };
...
int func_160(int iParam0)//Position - 0x9D9E
{
...
int func_161(int iParam0)//Position - 0x9DCE
{
	if (Global_4229 == 0)
	{
		return 0;
...
void func_162()//Position - 0x9E17
{
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 0) && INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 1))
	{
...
void func_163()//Position - 0x9E59
{
	if ((INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 0) && Global_8D15 == 15) && !func_195())
	{
		if (iLocal_38 == 0)
		{
			if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 1) && INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 0))
			{
				if (!func_74(AUDIO::_0x0626A247D2405330(), vLocal_50, 5f))
				{
					if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 20) || func_129())
					{
						if ((func_237(AUDIO::_0x0626A247D2405330()) && !INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uLocal_47[0], 17)) && !INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uLocal_47[1], 18))
						{
							if (PED::IS_PED_STOPPED(AUDIO::_0x0626A247D2405330()))
							{
								...
								if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 0))
								{
									if (!func_192() && func_172(unk_0x8000C77B5F336760(iLocal_51, 1)))
									{
										if (func_169(iLocal_51))
										{
											if (func_168(iLocal_51))
											{
												...
												vLocal_50 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 1) };
												return;
											}
										}
									}
									if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 20))
									{
										func_1(46, 0);
										GRAPHICS::_0x35FB78DC42B7BD21(&iLocal_49, 20);
										iLocal_245 = 4294967295;
									}
									vLocal_50 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 1) };
								}
					...
					{
						if ((PED::IS_PED_STOPPED(AUDIO::_0x0626A247D2405330()) && PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0)) && !INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 20))
						{
			...
			{
				if (!func_74(AUDIO::_0x0626A247D2405330(), vLocal_50, 10f))
				{
					GRAPHICS::_0x35FB78DC42B7BD21(&iLocal_49, 1);
				}
				else if (!PED::IS_PED_STOPPED(AUDIO::_0x0626A247D2405330()))
				{
...
void func_165(int iParam0)//Position - 0xA107
{
	if (func_167())
	{
		return;
...
void func_166(bool bParam0, bool bParam1)//Position - 0xA181
{
	if (bParam0)
	{
		if (func_14(0))
...
bool func_167()//Position - 0xA1F5
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

int func_168(int iParam0)//Position - 0xA207
{
	vector3 vVar0;
...
int func_169(int iParam0)//Position - 0xA2BC
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	if (iParam0 != 0)
	{
		if (func_83(iParam0))
		{
			...
			if (iVar0 == 2)
			{
				if (func_170(unk_0x8000C77B5F336760(iParam0, 1)))
				{
					return 1;
				}
			}
...
int func_170(vector3 vParam0)//Position - 0xA371
{
	float fVar0;
	float fVar1;
	vector3 vVar2;
...
int func_171()//Position - 0xA3CD
{
	var uVar0[5];
	int iVar1;
	
	PED::GET_PED_NEARBY_PEDS(AUDIO::_0x0626A247D2405330(), &uVar0, 4294967295);
	iVar1 = 0;
	while (iVar1 <= 4)
	{
		if (func_237(uVar0[iVar1]) && uVar0[iVar1] != AUDIO::_0x0626A247D2405330())
		{
			if (SYSTEM::VDIST2(vLocal_50, unk_0x8000C77B5F336760(uVar0[iVar1], 1)) <= 16f)
			{
				return 1;
			}
		}
...
int func_172(vector3 vParam0)//Position - 0xA436
{
...
int func_173(vector3 vParam0)//Position - 0xA48F
{
...
int func_174(vector3 vParam0)//Position - 0xA4C2
{
	float fVar0;
	
	fVar0 = SYSTEM::VDIST2(vParam0, Global_15992[func_175(vParam0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_175(vector3 vParam0, bool bParam1)//Position - 0xA4F7
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= (7 - 1))
	{
		if (Global_15992[iVar0 /*9*/].f_7 != 263)
		{
			if (!bParam1 || INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_1C21.f_11[iVar0], 0))
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_15992[iVar0 /*9*/].f_3, 1);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
int func_176(vector3 vParam0)//Position - 0xA574
{
	float fVar0;
	
	fVar0 = SYSTEM::VDIST2(vParam0, Global_159D2[func_177(vParam0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_177(vector3 vParam0, bool bParam1)//Position - 0xA5A9
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= (5 - 1))
	{
		if (Global_159D2[iVar0 /*9*/].f_7 != 263)
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_159D2[iVar0 /*9*/].f_3, 1);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
int func_178(vector3 vParam0)//Position - 0xA626
{
	vector3 vVar0;
	float fVar1;
...
int func_179(vector3 vParam0, vector3 vParam1)//Position - 0xA6AF
{
	float fVar0;
...
int func_180(vector3 vParam0)//Position - 0xA6D2
{
	if (!func_183(1))
	{
		if (!func_183(0))
...
int func_181(vector3 vParam0, int iParam1)//Position - 0xAD45
{
	float fVar0;
...
Vector3 func_182(int iParam0)//Position - 0xAD6D
{
	vector3 vVar0;
...
bool func_183(int iParam0)//Position - 0xB44A
{
...
int func_184()//Position - 0xB478
{
	...
	while (iVar0 <= (4 - 1))
	{
		...
		{
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_68[iVar0 /*261*/].f_102, iVar1))
			{
...
int func_185(var uParam0)//Position - 0xB5D3
{
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), uParam0->f_1, uParam0->f_4, uParam0->f_7, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
int func_186(char* sParam0)//Position - 0xB5FE
{
	int iVar0;
...
int func_187(vector3 vParam0)//Position - 0xB64A
{
	if (vParam0.z < -90f)
	{
		return 1;
...
int func_188()//Position - 0xB6D4
{
	int iVar0;
	float fVar1;
	
	iVar0 = func_190(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 1), 145, 1);
	fVar1 = SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 1), Global_1592D[iVar0 /*10*/].f_3);
	if (fVar1 <= 10000f)
	{
		if (func_12())
		{
...
void func_189(int iParam0)//Position - 0xB726
{
...
int func_190(vector3 vParam0, int iParam1, int iParam2)//Position - 0xB783
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_191(int iParam0)//Position - 0xB812
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_1C21[iParam0], 0);
}

int func_192()//Position - 0xB82A
{
	if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 1), 1276.123f, -1723.665f, 53.6551f) <= 52900f)
	{
		if (func_12())
		{
			func_68(30);
	...
	else if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 1), 111.8564f, -751.7169f, 44.757f) <= 160000f)
	{
		if (func_12())
		{
			func_68(31);
...
int func_193(float fParam0)//Position - 0xB8C2
{
	if (iLocal_42 == 1)
	{
...
void func_194(int iParam0, int iParam1)//Position - 0xB931
{
	func_4(iParam0);
...
void func_196()//Position - 0xB9A6
{
	int iVar0;
	int iVar1;
	
	if ((Global_8D15 == 15 && iLocal_38 == 0) && !func_195())
	{
		if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 0))
...
int func_197(int iParam0)//Position - 0xBC8C
{
...
int func_198(int iParam0)//Position - 0xBCBD
{
...
int func_200(int iParam0)//Position - 0xBD45
{
...
int func_201(int iParam0)//Position - 0xBD6F
{
	int iVar0;
...
int func_202(int iParam0)//Position - 0xBD90
{
...
int func_203(int iParam0)//Position - 0xBDBD
{
	int iVar0;
...
int func_204(int iParam0)//Position - 0xBE11
{
	int iVar0;
...
int func_205(int iParam0)//Position - 0xBE56
{
	int iVar0;
...
int func_207(int iParam0)//Position - 0xBF18
{
	if (DECORATOR::DECOR_EXIST_ON(iParam0, "GetawayVehicleValid"))
	{
		return 1;
...
int func_209(var uParam0)//Position - 0xBF7B
{
	int iVar0;
	int iVar1;
	int iVar2;
	
	if (func_237(AUDIO::_0x0626A247D2405330()) && PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
		iVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
		if (func_83(iVar0))
		{
	...
	switch (iLocal_67)
	{
		case 0:
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 0))
			{
				...
				{
					sLocal_70 = ZONE::GET_NAME_OF_ZONE(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 1));
					iLocal_67 = 1;
				}
		...
		case 1:
			if ((MISC::GET_GAME_TIMER() - Local_68[iLocal_72 /*261*/].f_103) > 500)
			{
				if (!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_70) && !MISC::IS_STRING_NULL_OR_EMPTY(Local_68[iLocal_72 /*261*/][iLocal_71 /*8*/]))
				{
					...
					{
						MISC::SET_BIT(&(Local_68[iLocal_72 /*261*/].f_102), iLocal_71);
					}
					else
					{
						GRAPHICS::_0x35FB78DC42B7BD21(&(Local_68[iLocal_72 /*261*/].f_102), iLocal_71);
					}
				}
				else
				{
				...
				{
					iLocal_71 = 0;
					Local_68[iLocal_72 /*261*/].f_103 = MISC::GET_GAME_TIMER();
					iLocal_72++;
					if (iLocal_72 >= 4)
					{
						iLocal_72 = 0;
...
void func_211()//Position - 0xC140
{
	int iVar0;
	int iVar1;
	
	if (((((((Global_8D15 == 15 && iLocal_37 != 3) && INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 5)) && !func_195()) && Global_11622 == 4294967295) && !func_221()) && !func_82(9)) || func_101(35))
	{
		func_220();
		func_218();
		switch (iLocal_39)
	...
	else if (((((((Global_8D15 != 15 || Global_8D15 != 0) || Global_8D15 != 2) || Global_8D15 != 4) || Global_8D15 != 17) || func_195()) || Global_11622 == 4294967295) || Global_19AA5)
	{
		iVar1 = 0;
		if (func_128())
		{
...
void func_212(int iParam0, bool bParam1)//Position - 0xC2D1
{
	switch (iLocal_39)
	{
		case 1:
...
void func_213(char* sParam0, int iParam1)//Position - 0xC3E1
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, 1, iParam1);
}

int func_214()//Position - 0xC3F8
{
...
int func_215(int iParam0)//Position - 0xC412
{
	int iVar0;
...
int func_216(int iParam0)//Position - 0xC45C
{
	int iVar0;
...
void func_217(int iParam0, int iParam1)//Position - 0xC513
{
	int iVar0;
	...
	if (iLocal_37 == 0 || iLocal_37 == 1)
	{
		switch (iLocal_38)
		{
			case 0:
				...
				{
					if (((((((!func_2(func_3(7)) && !func_2(func_3(8))) && !func_2(func_3(10))) && !func_2(func_3(11))) && !func_2(func_3(12))) && !func_2(func_3(13))) && !func_128()) && !Global_19906)
					{
						MISC::SET_BIT(&iLocal_49, 15);
						GRAPHICS::SET_SCRIPT_GFX_DRAW_BEHIND_PAUSEMENU(1);
					}
...
bool func_219(char* sParam0, int iParam1, int iParam2)//Position - 0xC6DD
{
...
int func_229()//Position - 0xCA7B
{
	if (((((Global_8D15 == 15 && !func_195()) && Global_11622 == 4294967295) && !func_128()) && !func_193(1112014848)) && !Global_19AA5)
	{
		return 1;
	}
	return 0;
...
int func_232(int iParam0)//Position - 0xCB66
{
	return func_233(iParam0, 6, 1);
}

int func_233(int iParam0, int iParam1, bool bParam2)//Position - 0xCB76
{
	if (iParam0 == 4294967295)
	{
		return 0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_94() == 0)
		{
			return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(func_234(func_236(iParam0), 4294967295, 0), iParam1);
		}
	}
	else
	{
...
int func_234(int iParam0, int iParam1, int iParam2)//Position - 0xCBE0
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Global_26B05F[iParam0 /*3*/][func_235(iParam1)];
...
int func_235(var uParam0)//Position - 0xCC12
{
	int iVar0;
	int iVar1;
...
int func_236(int iParam0)//Position - 0xCC46
{
	switch (iParam0)
	{
		case 0:
...
int func_237(int iParam0)//Position - 0xCF49
{
	if (func_84(iParam0))
	{
...
int func_238(bool bParam0)//Position - 0xCF69
{
	if (bParam0)
	{
		if (func_239())
...
void func_240(char* sParam0, int iParam1)//Position - 0xCFC1
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < Global_19E56.f_4F9E.f_91)
	{
		if (MISC::ARE_STRINGS_EQUAL(sParam0, &(Global_19E56.f_4F9E[iVar0 /*16*/])))
		{
			...
			func_242((Global_19E56.f_4F9E.f_91 - 1));
...
void func_242(int iParam0)//Position - 0xD18E
{
...
void func_243(int iParam0, int iParam1)//Position - 0xD226
{
...
int func_244(int iParam0)//Position - 0xD336
{
...
void func_245(int iParam0)//Position - 0xD362
{
	iLocal_42 = iParam0;
	if (iLocal_42 == 0)
	{
...
char* func_247(int iParam0)//Position - 0xD605
{
	char* sVar0;
...
struct<8> func_249(char* sParam0, vector3 vParam1, vector3 vParam2, float fParam3)//Position - 0xEB05
{
	struct<8> Var0;
...
void func_250(int iParam0, bool bParam1)//Position - 0xEB30
{
	if (func_83(iLocal_51))
	{
		func_19(&iLocal_51);
...
int func_251(int iParam0)//Position - 0xEB58
{
	int iVar0;
	int iVar1;
...
void func_252(bool bParam0)//Position - 0xEBB2
{
	char* sVar0;
...
void func_253()//Position - 0xEC7F
{
	StringCopy(&(Global_8AD[3 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_254()//Position - 0xEC95
{
	StringCopy(&(Global_8AD[2 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_255()//Position - 0xECAB
{
	StringCopy(&(Global_8AD[1 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_256()//Position - 0xECC1
{
	StringCopy(&(Global_8AD[0 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_257(char* sParam0)//Position - 0xECD7
{
	StringCopy(&(Global_8AD[0 /*16*/].f_8), sParam0, 32);
}

void func_258(char* sParam0)//Position - 0xECEB
{
	StringCopy(&(Global_8AD[2 /*16*/].f_8), sParam0, 32);
}

void func_259(char* sParam0)//Position - 0xECFF
{
	StringCopy(&(Global_8AD[1 /*16*/].f_8), sParam0, 32);
}

void func_260(char* sParam0)//Position - 0xED13
{
	StringCopy(&(Global_8AD[3 /*16*/].f_8), sParam0, 32);
}

void func_261(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0xED27
{
	func_262(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_262(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0xED47
{
	int iVar0;
...
int func_263(var uParam0, int iParam1)//Position - 0xEF19
{
	if (iParam1 == 4294967295)
	{
		return 0;
...
float func_264(int iParam0)//Position - 0xEF64
{
	if (iParam0 == 4294967295)
	{
		return 0f;
...
Vector3 func_265(int iParam0)//Position - 0xEF9A
{
	if (iParam0 == 4294967295)
	{
		return 0f, 0f, 0f;
...
int func_266(int iParam0)//Position - 0xEFD4
{
	int iVar0;
	int iVar1;
