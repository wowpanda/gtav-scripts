...
void __EntryFunction__()
{
	...
	if (func_384())
	{
		Global_71835 = 1;
		iLocal_94 = 0;
		while (!func_374(&Local_98))
		{
			WAIT(0);
		}
		func_373(&Local_98, 0, 1);
		Global_71835 = 0;
	}
	func_371(50, 1, 0);
	while (true)
	{
		...
		WAIT(0);
		func_355(Local_98.f_9, 0, 0, 0, 0, 0);
...
void func_1()
{
	switch (iLocal_327)
	{
		case 0:
			...
			iLocal_338 = GET_GAME_TIMER() + 500;
			iLocal_327 = 1;
			break;
		
		case 1:
			func_207();
			if (func_205(Local_98.f_28[1]) && !IS_ENTITY_ON_FIRE(Local_98.f_28[1]))
			{
				if (func_205(PLAYER_PED_ID()))
				{
					if (!IS_PED_FLEEING(Local_98.f_28[1]) && !IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], 1))
					{
						SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[1], 128, 1);
						TASK_SMART_FLEE_PED(Local_98.f_28[1], PLAYER_PED_ID(), 500f, -1, 0, 0);
					}
				}
				else
				{
					TASK_WANDER_STANDARD(Local_98.f_28[1], 1193033728, 0);
				}
			}
			if (GET_GAME_TIMER() > iLocal_338)
			{
				iLocal_327 = 2;
			}
			break;
...
int func_33(var uParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_71402[1 /*14*/] = { func_84(iVar0, iParam1, uVar31[iParam1], -1) };
		if (GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(uParam0, func_76(iParam1)) > 0 && GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(uParam0, func_76(iParam1), Global_71402[1 /*14*/].f_3) > 0)
		{
			SET_PED_COMPONENT_VARIATION(uParam0, func_76(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, 0);
		}
	}
...
int func_34(var uParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_149(uParam0, Global_106565.f_2357.f_539[iVar0 /*65*/].f_64, Global_106565.f_2357.f_539[iVar0 /*65*/].f_63))
		{
...
int func_36(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				...
				if (IS_BIT_SET(Global_71402[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_71402[1 /*14*/] = { func_84(iVar10, 14, uVar28[iVar1], -1) };
							func_52(uParam0, Global_71402[1 /*14*/].f_12, Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4);
							func_67(14);
							if (Global_71400 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							SET_PED_COMPONENT_VARIATION(uParam0, func_76(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, GET_PED_PALETTE_VARIATION(uParam0, func_76(iVar0)));
						}
						else
						{
							SET_PED_COMPONENT_VARIATION(uParam0, func_76(iVar0), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
						}
						func_67(iVar0);
						if (Global_71400 == 1)
						{
			...
			{
				Global_71402[1 /*14*/] = { func_84(iVar10, iVar0, func_42(uParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_71402[1 /*14*/] = { func_84(iVar10, 14, uVar69[iVar1], -1) };
			func_52(uParam0, Global_71402[1 /*14*/].f_12, Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4);
			func_67(14);
			if (Global_71400 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			SET_PED_COMPONENT_VARIATION(uParam0, func_76(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, GET_PED_PALETTE_VARIATION(uParam0, func_76(iParam1)));
		}
		else
		{
			SET_PED_COMPONENT_VARIATION(uParam0, func_76(iParam1), Global_71402[1 /*14*/].f_3, Global_71402[1 /*14*/].f_4, iParam4);
		}
		if (Global_71400 == 1)
		{
			iVar2 = 0;
...
void func_52(var uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_53(GET_ENTITY_MODEL(uParam0), 14, iVar0, GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3)))
			{
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar41 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_76(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_57(var uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_59(GET_ENTITY_MODEL(uParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_59(GET_ENTITY_MODEL(uParam0), iVar1, 14, 4);
		}
	}
...
int func_59(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_76(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || _0x341DE7ED1D2A1BFD(func_54(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || _0x341DE7ED1D2A1BFD(func_54(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || _0x341DE7ED1D2A1BFD(func_54(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || _0x341DE7ED1D2A1BFD(func_54(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_64(var uParam0, int iParam1)
{
	...
	return func_57(uParam0, iVar0, iVar1, iParam1);
}
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_75(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_149(uParam0, Global_106565.f_2357.f_539[iVar0 /*65*/].f_61, Global_106565.f_2357.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_86(int iParam0)
{
	...
	func_87(&(Global_71402[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_87(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_87(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = _GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_76(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
int func_149(var uParam0, int iParam1, int iParam2)
{
	...
	else if (Global_71402[1 /*14*/].f_3 == GET_PED_DRAWABLE_VARIATION(uParam0, func_76(iParam1)) && Global_71402[1 /*14*/].f_4 == GET_PED_TEXTURE_VARIATION(uParam0, func_76(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_155()
{
	...
	{
		if (func_151(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
...
void func_160(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_161(&uVar32, Var0.f_3, Global_93719, iParam1, iParam2);
	}
}
...
void func_166()
{
	...
	{
		func_155();
		_0xBF59707B3E5ED531(func_167(Global_106565.f_2357.f_539.f_4321));
	}
	else
	{
		_0xBF59707B3E5ED531("");
...
void func_207()
{
	if (!bLocal_491)
	{
		if (iLocal_492 == -1)
		{
			...
			{
				iLocal_492 = GET_GAME_TIMER() + 500;
			}
		}
		else if (iLocal_492 > GET_GAME_TIMER())
		{
			if ((!func_205(Local_98.f_28[0]) && !func_205(Local_98.f_28[1])) && !func_205(Local_98.f_28[2]))
			{
				bLocal_491 = true;
...
void func_208()
{
	switch (iLocal_327)
	{
		...
		case 1:
			...
			func_243();
			func_230();
			func_227(&uLocal_159, "", "", &uLocal_335, iLocal_336, 0);
			func_224();
			func_221();
			func_218();
			func_215();
...
void func_213()
{
	if ((func_205(Local_98.f_28[0]) && func_214(Local_98.f_35[0])) && GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_480))
	{
		if (IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_98.f_35[0]))
		{
			if (GET_VEHICLE_WAYPOINT_PROGRESS(Local_98.f_35[0]) >= iLocal_482)
			{
				if (bLocal_407)
				{
					TASK_VEHICLE_MISSION_PED_TARGET(Local_98.f_28[0], Local_98.f_35[0], PLAYER_PED_ID(), 8, 15f, 786468, 100f, 1f, 1);
				}
				else
				{
					TASK_VEHICLE_MISSION_PED_TARGET(Local_98.f_28[0], Local_98.f_35[0], PLAYER_PED_ID(), 8, 40f, 786468, 100f, 1f, 1);
				}
			}
		}
	}
	if ((func_205(Local_98.f_28[1]) && func_214(Local_98.f_35[1])) && GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_481))
	{
		if (IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_98.f_35[1]))
		{
			if (GET_VEHICLE_WAYPOINT_PROGRESS(Local_98.f_35[1]) >= iLocal_483)
			{
				if (func_205(Local_98.f_28[0]))
				{
					if (bLocal_407)
					{
						TASK_VEHICLE_MISSION_PED_TARGET(Local_98.f_28[1], Local_98.f_35[1], Local_98.f_28[0], 7, 15f, 786468, 100f, 1f, 1);
					}
					else
					{
						TASK_VEHICLE_MISSION_PED_TARGET(Local_98.f_28[1], Local_98.f_35[1], Local_98.f_28[0], 7, 40f, 786468, 100f, 1f, 1);
					}
				}
				else
				{
					TASK_VEHICLE_DRIVE_WANDER(Local_98.f_28[1], Local_98.f_35[1], 15f, 786597);
				}
			}
		}
	}
...
void func_215()
{
	if ((iLocal_465 && func_205(Local_98.f_28[2])) && !IS_ENTITY_ON_FIRE(Local_98.f_28[2]))
	{
		if (((((!IS_PED_FLEEING(Local_98.f_28[2]) && !IS_PED_GETTING_UP(Local_98.f_28[2])) && !IS_PED_PRONE(Local_98.f_28[2])) && !IS_PED_RAGDOLL(Local_98.f_28[2])) && !func_217(Local_98.f_28[2], 63541484)) && !func_217(Local_98.f_28[2], 242628503))
		{
			if ((!IS_PED_IN_ANY_VEHICLE(Local_98.f_28[2], 1) || (func_214(Local_98.f_35[1]) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_98.f_35[1], 1))) || (func_214(Local_98.f_35[0]) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_98.f_35[0], 1)))
			{
				func_216(1);
				if (IS_PED_IN_GROUP(Local_98.f_28[2]))
				{
					REMOVE_PED_FROM_GROUP(Local_98.f_28[2]);
				}
				SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[2], 128, 1);
				TASK_SMART_FLEE_PED(Local_98.f_28[2], PLAYER_PED_ID(), 100f, -1, 0, 0);
			}
		}
	}
}
...
void func_216(bool bParam0)
{
	if (bParam0)
	{
		SET_PED_PATHS_IN_AREA(vLocal_467, vLocal_470, 1, 0);
	}
	else
	{
		SET_PED_PATHS_IN_AREA(vLocal_467, vLocal_470, 0, 0);
	}
}
...
void func_218()
{
	if ((bLocal_464 && func_205(Local_98.f_28[1])) && !IS_ENTITY_ON_FIRE(Local_98.f_28[1]))
	{
		if ((((((!IS_PED_FLEEING(Local_98.f_28[1]) && !IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], 1)) && !IS_PED_GETTING_UP(Local_98.f_28[1])) && !IS_PED_PRONE(Local_98.f_28[1])) && !IS_PED_RAGDOLL(Local_98.f_28[1])) && !func_217(Local_98.f_28[1], 63541484)) && !func_217(Local_98.f_28[1], 242628503))
		{
			func_216(1);
			SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[1], 128, 1);
			TASK_SMART_FLEE_PED(Local_98.f_28[1], PLAYER_PED_ID(), 500f, -1, 0, 0);
...
void func_221()
{
	if (func_205(Local_98.f_28[1]) && DOES_ENTITY_EXIST(Local_98.f_41[1]))
	{
		if (IS_ENTITY_PLAYING_ANIM(Local_98.f_28[1], sLocal_377, sLocal_393, 3))
		{
			if (IS_PED_BEING_STEALTH_KILLED(Local_98.f_28[1]))
			{
				if (DOES_ENTITY_EXIST(Local_98.f_41[1]))
				{
					STOP_SOUND(uLocal_488);
					func_223(&(Local_98.f_41[1]), 0);
				}
				if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_390))
				{
					STOP_SYNCHRONIZED_ENTITY_ANIM(Local_98.f_28[1], -4f, 1);
					SET_SYNCHRONIZED_SCENE_PHASE(uLocal_390, 1f);
				}
				else
				{
					STOP_ANIM_TASK(Local_98.f_28[1], sLocal_377, sLocal_393, -1056964608);
				}
			}
			else if (IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], 1))
			{
				STOP_SOUND(uLocal_488);
		...
		else if ((((((((!bLocal_464 && !func_217(Local_98.f_28[1], 1785177548)) && !IS_PED_IN_COMBAT(Local_98.f_28[1], 0)) && !IS_PED_IN_MELEE_COMBAT(Local_98.f_28[1])) && !IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], 1)) && DOES_ENTITY_EXIST(Local_98.f_41[1])) && !IS_PED_FLEEING(Local_98.f_28[1])) && !func_217(Local_98.f_28[1], 1805844857)) && DOES_ENTITY_EXIST(Local_98.f_41[1]))
		{
			TASK_PLAY_ANIM(Local_98.f_28[1], sLocal_377, sLocal_393, 1000f, -8f, -1, 57, 0, 0, 0, 0);
		}
	}
}
...
void func_224()
{
	if (!func_205(Local_98.f_28[0]) || (func_225(PLAYER_PED_ID(), Local_98.f_28[0]) > 150f && (!IS_ENTITY_ON_SCREEN(Local_98.f_28[0]) || !HAS_ENTITY_CLEAR_LOS_TO_ENTITY(PLAYER_PED_ID(), Local_98.f_28[0], 17))))
	{
		if (!func_205(Local_98.f_28[0]))
		{
...
float func_225(var uParam0, var uParam1)
{
	return func_226(uParam0, uParam1, 1);
}
...
void func_227(var uParam0, char* sParam1, char* sParam2, var uParam3, int iParam4, int iParam5)
{
	if (DOES_BLIP_EXIST(*uParam0))
	{
		if ((GET_GAME_TIMER() - *uParam3) > 500)
		{
			if (GET_BLIP_COLOUR(*uParam0) == 1)
			{
				...
				{
					if (!IS_MESSAGE_BEING_DISPLAYED() || func_229(sParam1, 0, 0))
					{
			...
			else
			{
				...
				if ((GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!IS_MESSAGE_BEING_DISPLAYED() || func_229(sParam2, 0, 0))
					{
...
void func_230()
{
	if ((!bLocal_408 && func_205(Local_98.f_28[1])) && func_205(PLAYER_PED_ID()))
	{
		if (((((((iLocal_344 < 4 && !IS_PED_FLEEING(Local_98.f_28[1])) && !func_242()) && GET_GAME_TIMER() > iLocal_345) && func_225(Local_98.f_28[1], PLAYER_PED_ID()) < 10f) && !IS_PED_IN_COMBAT(Local_98.f_28[1], 0)) && !IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], 1)) && !IS_PED_FLEEING(Local_98.f_28[1]))
		{
			if (func_231(&uLocal_160, "PAP4AUD", "PAP4_CAMERA", sLocal_339[iLocal_344], 7, 0, 0))
			{
				iLocal_344++;
				iLocal_345 = GET_GAME_TIMER() + 15000;
			}
		}
	}
}
...
int func_243()
{
	...
	iVar1 = 0;
	iVar0 = GET_RANDOM_VEHICLE_IN_SPHERE(GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_98.f_35[0], 0f, 2f, 0f), 2f, 0, 94);
	if (DOES_ENTITY_EXIST(iVar0))
	{
		if (!iVar0 == Local_98.f_35[0])
		{
			if (iVar0 == GET_PLAYERS_LAST_VEHICLE() || (IS_VEHICLE_DRIVEABLE(iVar0, 0) && IS_VEHICLE_STOPPED(iVar0)))
			{
				bLocal_391 = false;
				iVar1 = 1;
			}
	...
	{
		if (IS_PED_IN_VEHICLE(Local_98.f_28[0], Local_98.f_35[0], 0))
		{
			if (IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_98.f_35[0]))
			{
				if (func_244(&uLocal_160, "PAP4AUD", "PAP4_BLOCKED", 7, 0, 0, 0))
				{
					if (((func_205(Local_98.f_28[0]) && !IS_PED_IN_COMBAT(Local_98.f_28[0], 0)) && !IS_PED_IN_MELEE_COMBAT(Local_98.f_28[0])) && !IS_PED_FLEEING(Local_98.f_28[0]))
					{
						TASK_COMBAT_PED(Local_98.f_28[0], PLAYER_PED_ID(), 0, 16);
						func_223(&(Local_98.f_41[0]), 0);
					}
					if (DOES_BLIP_EXIST(uLocal_159))
					{
						SET_BLIP_SCALE(uLocal_159, 0.7f);
					}
				}
			}
		}
		else if (!IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], 0))
		{
			if (!func_242())
			{
				iLocal_461 = 0;
...
void func_246()
{
	if (((!bLocal_408 && func_205(PLAYER_PED_ID())) && func_205(Local_98.f_28[0])) && func_266(PLAYER_PED_ID(), Local_98.f_28[0], 5f, 1))
	{
		if ((IS_PED_SHOOTING(PLAYER_PED_ID()) || func_247(Local_98.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0)) || func_247(Local_98.f_28[1], 1, 1116471296, 1126825984, 0, 0, 0, 0))
		{
			if (GET_GAME_TIMER() > iLocal_373)
			{
				if (!func_242())
				{
					if (iLocal_372 < 3)
					{
						...
						{
							CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_98.f_28[0]);
							iLocal_372++;
							iLocal_373 = GET_GAME_TIMER() + 15000;
						}
					}
...
int func_247(int iParam0, bool bParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	vector3 vVar0;
	
	if (func_206(PLAYER_PED_ID()) && func_206(iParam0))
	{
		...
		if (!IS_PED_ARMED(PLAYER_PED_ID(), 6))
		{
			if (IS_PED_IN_MELEE_COMBAT(PLAYER_PED_ID()))
			{
				...
				{
					return func_260(PLAYER_PED_ID(), iParam0, iParam2);
				}
			}
		}
		if (bParam4)
...
bool func_250(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_251(&(Local_52[iVar4 /*4*/]), vVar1, iParam1, &(Local_52[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (GET_GAME_TIMER() - Local_52[iVar4 /*4*/].f_3) < iParam4);
}

int func_251(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_252(iParam4, iParam7) };
...
int func_254(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_256(GET_ENTITY_COORDS(iParam1, 1) - GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		vVar3 = { func_256(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_263(var uParam0, float fParam1)
{
	...
	{
		if (func_264(uParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_264(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_256(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_256(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_255(vVar3, vVar0);
...
bool func_266(var uParam0, var uParam1, float fParam2, int iParam3)
{
...
void func_267()
{
	...
	{
		if (IS_PED_IN_VEHICLE(Local_98.f_28[1], Local_98.f_35[1], 0))
		{
			TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_98.f_28[1], Local_98.f_35[1], sLocal_481, 786597, 0, 8, -1, -1082130432, 0, 1073741824);
		}
	}
}
...
void func_268()
{
	if ((func_214(Local_98.f_35[1]) && (IS_PED_SITTING_IN_VEHICLE(PLAYER_PED_ID(), Local_98.f_35[1]) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[1], PLAYER_PED_ID(), 1))) && !bLocal_388)
	{
		if ((func_205(Local_98.f_28[1]) && !IS_PED_FLEEING(Local_98.f_28[1])) && !IS_PED_IN_COMBAT(Local_98.f_28[1], 0))
		{
			if (func_242())
			{
				func_219();
			...
			TASK_COMBAT_PED(Local_98.f_28[1], PLAYER_PED_ID(), 0, 16);
			bLocal_388 = true;
		}
		CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_98.f_35[1]);
		bLocal_391 = false;
		iLocal_460 = 3;
		func_219();
		if (func_205(Local_98.f_28[0]))
		{
			if ((!IS_PED_IN_COMBAT(Local_98.f_28[0], 0) && !IS_PED_IN_MELEE_COMBAT(Local_98.f_28[0])) && !IS_PED_FLEEING(Local_98.f_28[0]))
			{
				if (IS_ENTITY_PLAYING_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 3))
				{
					STOP_ANIM_TASK(Local_98.f_28[0], sLocal_377, sLocal_378, -1056964608);
					TASK_SMART_FLEE_PED(Local_98.f_28[0], PLAYER_PED_ID(), 500f, -1, 0, 0);
					func_223(&(Local_98.f_41[0]), 0);
				}
				else
				{
...
void func_269()
{
	if (((func_205(Local_98.f_28[0]) && func_205(PLAYER_PED_ID())) && !IS_ENTITY_ON_FIRE(Local_98.f_28[0])) && !IS_PED_FLEEING(Local_98.f_28[0]))
	{
		if (func_214(Local_98.f_35[0]))
		{
			if (iLocal_326 == 2)
			{
				if (iLocal_436 == 0)
				{
					if (((IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_98.f_35[0], 0) || IS_PED_BEING_JACKED(Local_98.f_28[0])) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[0], PLAYER_PED_ID(), 1)) || func_276(Local_98.f_35[0]))
					{
						iLocal_436 = 1;
						iLocal_326 = 2;
					}
			...
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[0], PLAYER_PED_ID(), 1))
				{
					func_270();
				}
			}
		}
		else if (!IS_PED_FLEEING(Local_98.f_28[0]))
		{
			func_216(1);
			if (IS_ENTITY_PLAYING_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 3))
			{
			...
			SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[0], 2, 0);
			iLocal_389 = 1;
			TASK_SMART_FLEE_PED(Local_98.f_28[0], PLAYER_PED_ID(), 500f, -1, 0, 0);
			func_223(&(Local_98.f_41[0]), 0);
			func_219();
...
void func_270()
{
	if (func_205(Local_98.f_28[0]))
	{
		if (!IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], 1))
		{
			if ((((!bLocal_386 && iLocal_385) && !func_271(Local_98.f_28[0])) && !IS_ENTITY_ON_FIRE(Local_98.f_28[0])) && !IS_PED_PERFORMING_STEALTH_KILL(PLAYER_PED_ID()))
			{
				if (IS_PED_IN_COMBAT(Local_98.f_28[0], 0) || IS_PED_IN_MELEE_COMBAT(Local_98.f_28[0]))
				{
					CLEAR_PED_TASKS(Local_98.f_28[0]);
				}
				SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[0], 2, 0);
				func_223(&(Local_98.f_41[0]), 0);
				iLocal_389 = 1;
				TASK_SMART_FLEE_PED(Local_98.f_28[0], PLAYER_PED_ID(), 400f, -1, 1, 0);
				func_219();
				iLocal_460 = 3;
				iLocal_385 = 0;
				bLocal_386 = true;
		...
		else if ((((!bLocal_386 && iLocal_385) && !func_271(Local_98.f_28[0])) && !IS_ENTITY_ON_FIRE(Local_98.f_28[0])) && !IS_PED_PERFORMING_STEALTH_KILL(PLAYER_PED_ID()))
		{
			if (IS_PED_IN_COMBAT(Local_98.f_28[0], 0) || IS_PED_IN_MELEE_COMBAT(Local_98.f_28[0]))
			{
				CLEAR_PED_TASKS(Local_98.f_28[0]);
			}
			SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[0], 2, 1);
			TASK_SMART_FLEE_PED(Local_98.f_28[0], PLAYER_PED_ID(), 400f, -1, 1, 0);
			func_223(&(Local_98.f_41[0]), 0);
			func_219();
			iLocal_460 = 3;
...
{
	if (func_205(PLAYER_PED_ID()) && func_205(uParam0))
	{
		if (IS_PED_PERFORMING_STEALTH_KILL(PLAYER_PED_ID()) && IS_PED_BEING_STEALTH_KILLED(uParam0))
		{
			return 1;
		}
	}
...
void func_272()
{
	...
	switch (iLocal_436)
	{
		case 1:
			...
			bVar0 = false;
			func_219();
			if ((func_214(Local_98.f_35[0]) && HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[0], PLAYER_PED_ID(), 1)) && func_266(PLAYER_PED_ID(), Local_98.f_28[0], 5f, 1))
			{
				bVar0 = func_244(&uLocal_160, "PAP4AUD", "PAP4_CARSHOT", 7, 0, 0, 0);
			}
			else if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_98.f_35[0], 0) || func_276(Local_98.f_35[0]))
			{
			...
			if (bVar0)
			{
				...
				{
					CLEAR_PED_TASKS(Local_98.f_28[0]);
					CLEAR_PED_SECONDARY_TASK(Local_98.f_28[0]);
					RESET_PED_WEAPON_MOVEMENT_CLIPSET(Local_98.f_28[0]);
				}
				OPEN_SEQUENCE_TASK(&uVar1);
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_98.f_35[0], 0))
				{
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_438, 2f, 20000, 1048576000, 0, 1193033728);
				}
				TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), -1);
				CLOSE_SEQUENCE_TASK(uVar1);
				TASK_PERFORM_SEQUENCE(Local_98.f_28[0], uVar1);
				CLEAR_SEQUENCE_TASK(&uVar1);
				func_223(&(Local_98.f_41[0]), 0);
				if (func_205(Local_98.f_28[1]) && !IS_PED_FLEEING(Local_98.f_28[1]))
				{
					if (IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], 0))
					{
						TASK_LEAVE_ANY_VEHICLE(Local_98.f_28[1], 0, 0);
					}
					else
					{
						TASK_TURN_PED_TO_FACE_ENTITY(Local_98.f_28[1], Local_98.f_28[0], -1);
					}
				}
				if ((((func_205(Local_98.f_28[2]) && !IS_PED_FLEEING(Local_98.f_28[2])) && !iLocal_387) && !iLocal_465) && !IS_PED_RAGDOLL(Local_98.f_28[2]))
				{
					if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[0], PLAYER_PED_ID(), 1))
					{
						TASK_SMART_FLEE_PED(Local_98.f_28[2], PLAYER_PED_ID(), 500f, -1, 0, 0);
					}
					else if (IS_PED_IN_ANY_VEHICLE(Local_98.f_28[2], 0))
					{
						TASK_LEAVE_ANY_VEHICLE(Local_98.f_28[2], 0, 4416);
					}
					else
					{
						TASK_TURN_PED_TO_FACE_ENTITY(Local_98.f_28[2], PLAYER_PED_ID(), -1);
					}
				}
				iLocal_437 = GET_GAME_TIMER() + 3000;
				if (DOES_BLIP_EXIST(uLocal_159))
				{
					SET_BLIP_SCALE(uLocal_159, 0.7f);
				}
		...
		case 2:
			if (func_225(PLAYER_PED_ID(), Local_98.f_28[0]) > 20f)
			{
				iLocal_436 = 4;
			}
			else if (GET_GAME_TIMER() > iLocal_437)
			{
				if ((func_205(Local_98.f_28[0]) && !IS_PED_IN_COMBAT(Local_98.f_28[0], 0)) && iLocal_385)
				{
					if (iLocal_444)
					{
						TASK_COMBAT_PED(Local_98.f_28[0], PLAYER_PED_ID(), 0, 16);
					...
					if ((((func_205(Local_98.f_28[2]) && !IS_PED_FLEEING(Local_98.f_28[2])) && !iLocal_387) && !iLocal_465) && !IS_PED_RAGDOLL(Local_98.f_28[2]))
					{
						...
						TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_441, 2f, 20000, 1048576000, 0, 1193033728);
						TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), -1);
						CLOSE_SEQUENCE_TASK(uVar2);
						TASK_PERFORM_SEQUENCE(Local_98.f_28[2], uVar2);
				...
				else if (iLocal_385 == 0 && !IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], 1))
				{
					if (!IS_PED_FLEEING(Local_98.f_28[0]))
					{
						SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[0], 2, 0);
						iLocal_389 = 1;
						TASK_SMART_FLEE_PED(Local_98.f_28[0], PLAYER_PED_ID(), 500f, -1, 0, 0);
		...
		case 3:
			if (func_225(PLAYER_PED_ID(), Local_98.f_28[0]) > 20f)
			{
				...
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_438, 1f, 20000, 1048576000, 0, 1193033728);
				if (func_205(Local_98.f_28[1]))
				{
					TASK_TURN_PED_TO_FACE_ENTITY(0, Local_98.f_28[1], -1);
				}
				else
				{
					TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), -1);
				...
				TASK_PERFORM_SEQUENCE(Local_98.f_28[0], uVar3);
...
void func_273()
{
	if (func_225(PLAYER_PED_ID(), Local_98.f_28[0]) < 10f)
	{
		if (iLocal_445 || !IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_98.f_35[0], 0))
		{
			func_274();
		}
...
void func_274()
{
	TASK_TURN_PED_TO_FACE_ENTITY(Local_98.f_28[0], PLAYER_PED_ID(), -1);
	iLocal_437 = GET_GAME_TIMER() + 3000;
	if (DOES_BLIP_EXIST(uLocal_159))
	{
		SET_BLIP_SCALE(uLocal_159, 0.7f);
...
void func_275()
{
	...
	if (((func_205(Local_98.f_28[1]) && func_205(Local_98.f_28[0])) && !IS_PED_FLEEING(Local_98.f_28[1])) && !IS_PED_IN_COMBAT(Local_98.f_28[1], 0))
	{
		...
		if (fVar0 > 20f)
		{
			...
			{
				TASK_GOTO_ENTITY_OFFSET(Local_98.f_28[1], Local_98.f_28[0], 20000, 0.5f, 0f, 2f, 2);
			}
		}
		else if (fVar0 < 10f)
		{
...
int func_276(var uParam0)
{
	...
	if ((func_205(PLAYER_PED_ID()) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0)) && func_214(uParam0))
	{
	...
	switch (iLocal_327)
	{
		case 0:
			if (func_205(Local_98.f_28[0]) && func_205(Local_98.f_28[1]))
			{
				...
				{
					uLocal_159 = func_302(Local_98.f_28[0], 1, 0, 5);
					func_301(&uLocal_159, "", "", &uLocal_335, &iLocal_336, 1, 0);
					SET_PED_DIES_WHEN_INJURED(Local_98.f_28[0], 1);
					iLocal_372 = 0;
					iLocal_344 = 0;
					bLocal_407 = true;
					bLocal_408 = true;
...
void func_278()
{
	if ((((func_205(Local_98.f_28[0]) && func_205(Local_98.f_28[1])) && func_205(PLAYER_PED_ID())) && !bLocal_388) && DOES_ENTITY_EXIST(Local_98.f_41[1]))
	{
		if (IS_PED_IN_COMBAT(Local_98.f_28[0], 0))
		{
			if (GET_GAME_TIMER() > iLocal_409)
			{
				func_279();
				iLocal_409 = GET_GAME_TIMER() + 10000;
			}
		}
		else if (IS_ENTITY_PLAYING_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 3))
		{
			if (GET_GAME_TIMER() > iLocal_410)
			{
				if (iLocal_411)
				{
					TASK_TURN_PED_TO_FACE_ENTITY(Local_98.f_28[1], Local_98.f_28[0], -1);
				...
				{
					TASK_TURN_PED_TO_FACE_ENTITY(Local_98.f_28[1], PLAYER_PED_ID(), -1);
					iLocal_411 = 1;
				}
				iLocal_410 = (GET_GAME_TIMER() + 4000 + GET_RANDOM_INT_IN_RANGE(0, 20) * 100);
			}
		}
	}
}
...
void func_279()
{
	...
	if ((((!bLocal_464 && func_205(PLAYER_PED_ID())) && func_205(Local_98.f_28[1])) && func_205(Local_98.f_28[0])) && !IS_PED_IN_COMBAT(Local_98.f_28[1], 0))
	{
		vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_98.f_28[0], 3f, 0f, 0f) };
		vVar3 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_98.f_28[0], -3f, 0f, 0f) };
		fVar6 = func_280(PLAYER_PED_ID(), vVar0, 1);
		fVar7 = func_280(PLAYER_PED_ID(), vVar3, 1);
		if (fVar6 < fVar7)
		{
			vVar8 = { vVar3 };
		}
		...
		TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar8, 3f, 20000, 1048576000, 0, 1193033728);
		TASK_TURN_PED_TO_FACE_ENTITY(0, Local_98.f_28[0], 0);
		CLOSE_SEQUENCE_TASK(uVar11);
		TASK_PERFORM_SEQUENCE(Local_98.f_28[1], uVar11);
		CLEAR_SEQUENCE_TASK(&uVar11);
	}
}

var func_280(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
void func_281()
{
	...
	{
		if ((((((!IS_PED_GETTING_UP(Local_98.f_28[0]) && !IS_PED_PRONE(Local_98.f_28[0])) && !IS_PED_RAGDOLL(Local_98.f_28[0])) && !IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], 1)) && !func_217(Local_98.f_28[0], -1794415470)) && !IS_PED_FLEEING(Local_98.f_28[0])) || IS_PED_BEING_STEALTH_KILLED(Local_98.f_28[0]))
		{
			if (!IS_ENTITY_PLAYING_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 3) && HAS_ANIM_DICT_LOADED(sLocal_377))
			{
				TASK_PLAY_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 4f, -8f, -1, 57, 0, 0, 0, 0);
			}
		}
		else if (IS_ENTITY_PLAYING_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 3))
		{
...
void func_282()
{
	...
	if (((iLocal_460 != 3 && func_205(PLAYER_PED_ID())) && func_205(Local_98.f_28[0])) && func_205(Local_98.f_28[1]))
	{
		switch (iLocal_460)
		{
			case 0:
...
int func_283()
{
	if (func_242() && GET_CURRENT_SCRIPTED_CONVERSATION_LINE() < iLocal_455[iLocal_462])
	{
		return 1;
	}
	return 0;
...
int func_284()
{
	...
	vVar0 = { GET_ENTITY_COORDS(Local_98.f_28[0], 1) + Vector(1f, 0f, 0f) };
	vVar3 = { GET_ENTITY_COORDS(Local_98.f_28[1], 1) - Vector(1f, 0f, 0f) };
	if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vVar0, vVar3, 0.5f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
void func_285(bool bParam0)
{
	...
	if (bLocal_391)
	{
		if (!IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_390))
		{
			uLocal_390 = CREATE_SYNCHRONIZED_SCENE(vLocal_401, vLocal_404, 2);
			SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_390, 0);
			_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_390, 0);
			...
			if (func_205(Local_98.f_28[0]))
			{
				TASK_SYNCHRONIZED_SCENE(Local_98.f_28[0], uLocal_390, sLocal_377, sVar1, fVar4, -4f, 1, 16, 1148846080, 0);
			}
			if (func_205(Local_98.f_28[1]))
			{
				TASK_SYNCHRONIZED_SCENE(Local_98.f_28[1], uLocal_390, sLocal_377, sVar2, 1000f, -2f, 1, 16, 1148846080, 0);
			}
			if (func_205(Local_98.f_28[2]))
			{
				TASK_SYNCHRONIZED_SCENE(Local_98.f_28[2], uLocal_390, sLocal_377, sVar3, fVar4, -4f, 1, 16, 1148846080, 0);
			}
		}
	}
	else if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_390))
	{
		STOP_SYNCHRONIZED_ENTITY_ANIM(Local_98.f_28[0], -4f, 1);
		STOP_SYNCHRONIZED_ENTITY_ANIM(Local_98.f_28[1], -2f, 1);
		if ((((((!IS_ENTITY_PLAYING_ANIM(Local_98.f_28[1], sLocal_377, sLocal_393, 3) && !IS_PED_FLEEING(Local_98.f_28[1])) && !func_217(Local_98.f_28[1], 1805844857)) && !bLocal_464) && !IS_PED_IN_COMBAT(Local_98.f_28[1], 0)) && !IS_PED_IN_MELEE_COMBAT(Local_98.f_28[1])) && DOES_ENTITY_EXIST(Local_98.f_41[1]))
		{
			TASK_PLAY_ANIM(Local_98.f_28[1], sLocal_377, sLocal_393, 1000f, -8f, -1, 57, 0, 0, 0, 0);
			_0x2208438012482A1A(Local_98.f_28[1], 0, 0);
		}
		STOP_SYNCHRONIZED_ENTITY_ANIM(Local_98.f_28[2], -4f, 1);
		SET_SYNCHRONIZED_SCENE_PHASE(uLocal_390, 1f);
	}
}
...
void func_286()
{
	if (func_205(Local_98.f_28[0]) && func_205(PLAYER_PED_ID()))
	{
		if (IS_PED_IN_COMBAT(Local_98.f_28[0], 0))
		{
			if (GET_GAME_TIMER() > iLocal_374)
			{
				if (func_244(&uLocal_160, "PAP4AUD", "PAP4_FIST", 7, 0, 0, 0))
				{
					iLocal_374 = GET_GAME_TIMER() + 5000;
				}
			}
		}
	}
...
void func_287()
{
	...
	if (func_205(PLAYER_PED_ID()))
	{
		if (bLocal_407)
		{
			if ((((IS_PED_SHOOTING(PLAYER_PED_ID()) && func_295()) || IS_EXPLOSION_IN_SPHERE(-1, vLocal_484, fLocal_487)) || !func_205(Local_98.f_28[1])) || !func_205(Local_98.f_28[2]))
			{
				iLocal_461 = 1;
				iLocal_460 = 3;
				iLocal_436 = 5;
				...
				if (func_242())
				{
					Var0 = { func_294() };
					uVar6 = func_293(&Var0);
					if (!ARE_STRINGS_EQUAL(uVar6, "PAP4_THREAT"))
					{
						func_219();
					}
				}
			...
			else if ((((HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[1], PLAYER_PED_ID(), 1) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[2], PLAYER_PED_ID(), 1)) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[0], PLAYER_PED_ID(), 1)) && func_292(PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_292(PLAYER_PED_ID()) != joaat("object"))
			{
				func_270();
				iLocal_461 = 1;
				iLocal_460 = 3;
				...
				{
					Var7 = { func_294() };
					uVar13 = func_293(&Var7);
					if (!ARE_STRINGS_EQUAL(uVar13, "PAP4_THREAT"))
					{
						func_219();
					}
				}
			}
			else if ((((func_248(Local_98.f_28[0], 1126825984) && func_295()) && func_292(PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_292(PLAYER_PED_ID()) != joaat("object")) || IS_PED_PERFORMING_STEALTH_KILL(PLAYER_PED_ID()))
			{
				if (func_217(Local_98.f_28[0], 780511057))
				{
					...
					{
						Var14 = { func_294() };
						uVar20 = func_293(&Var14);
						if (!ARE_STRINGS_EQUAL(uVar20, "PAP4_THREAT"))
						{
							func_219();
						}
					}
				...
				else
				{
					...
					{
						Var21 = { func_294() };
						uVar27 = func_293(&Var21);
						if (!ARE_STRINGS_EQUAL(uVar27, "PAP4_THREAT"))
						{
							func_219();
						}
					}
			...
			else if (((((func_248(Local_98.f_28[0], 1126825984) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[1], PLAYER_PED_ID(), 1)) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[2], PLAYER_PED_ID(), 1)) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[0], PLAYER_PED_ID(), 1)) || iLocal_387) && (func_292(PLAYER_PED_ID()) == joaat("weapon_unarmed") || func_292(PLAYER_PED_ID()) == joaat("object")))
			{
				if (func_205(Local_98.f_28[0]) && !IS_PED_IN_COMBAT(Local_98.f_28[0], 0))
				{
					TASK_COMBAT_PED(Local_98.f_28[0], PLAYER_PED_ID(), 0, 16);
					func_223(&(Local_98.f_41[0]), 0);
					bLocal_391 = false;
					iLocal_374 = GET_GAME_TIMER();
					func_219();
					func_223(&(Local_98.f_41[0]), 0);
				}
			}
		...
		else
		{
			...
			else if ((func_205(Local_98.f_28[0]) && !IS_ENTITY_ON_FIRE(Local_98.f_28[0])) && (((((((GET_ENTITY_HEALTH(Local_98.f_28[0]) < 150 || (func_261(Local_98.f_28[0], 0, 0, 0, 0) && func_295())) || (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[0], PLAYER_PED_ID(), 1) && func_292(PLAYER_PED_ID()) == joaat("weapon_stungun"))) || !func_266(PLAYER_PED_ID(), Local_98.f_28[0], 20f, 1)) || (func_205(Local_98.f_28[1]) && IS_PED_IN_COMBAT(Local_98.f_28[1], 0))) || (func_205(Local_98.f_28[1]) && HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[1], PLAYER_PED_ID(), 1))) || (func_205(Local_98.f_28[2]) && HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[2], PLAYER_PED_ID(), 1))) || iLocal_384))
			{
				if (IS_ENTITY_PLAYING_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 3))
				{
					iLocal_384 = 1;
				...
				switch (iLocal_383)
				{
					case 0:
						...
						if (!IS_ENTITY_PLAYING_ANIM(Local_98.f_28[0], sLocal_379, "flinch_additive_a", 3))
						{
							TASK_PLAY_ANIM(Local_98.f_28[0], sLocal_379, "flinch_additive_a", 4f, -8f, -1, 272, 0, 0, 0, 0);
						}
						else if (GET_ENTITY_ANIM_CURRENT_TIME(Local_98.f_28[0], sLocal_379, "flinch_additive_a") > 0.7f)
						{
							STOP_ANIM_TASK(Local_98.f_28[0], sLocal_379, "flinch_additive_a", -1056964608);
							iLocal_383++;
						}
						break;
					
					case 1:
						if (!IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], 0))
						{
							func_223(&(Local_98.f_41[0]), 0);
							iLocal_385 = 0;
							if (!IS_PED_FLEEING(Local_98.f_28[0]))
		...
		if (func_205(Local_98.f_28[1]))
		{
			if (((((((((func_261(Local_98.f_28[1], 0, 0, 0, 0) && func_295()) || ((HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[1], PLAYER_PED_ID(), 1) && func_292(PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_292(PLAYER_PED_ID()) != joaat("object"))) || ((func_248(Local_98.f_28[1], 1126825984) && func_292(PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_292(PLAYER_PED_ID()) != joaat("object"))) || !func_214(Local_98.f_35[1])) || IS_PED_RAGDOLL(Local_98.f_28[1])) || func_289(Local_98.f_28[1])) || func_271(Local_98.f_28[0])) || func_271(Local_98.f_28[2])) || IS_EXPLOSION_IN_SPHERE(-1, vLocal_484, fLocal_487))
			{
				if (!IS_PED_FLEEING(Local_98.f_28[1]) && !IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], 0))
				{
					if (func_242())
					{
						Var28 = { func_294() };
						uVar34 = func_293(&Var28);
						if (!ARE_STRINGS_EQUAL(uVar34, "PAP4_THREAT") && !ARE_STRINGS_EQUAL(uVar34, "PAP4_ATTACK"))
						{
							func_219();
						}
					}
		...
		{
			if (((((((((((func_247(Local_98.f_28[2], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_295()) || (func_247(Local_98.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_295())) || (func_247(Local_98.f_28[1], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_295())) || func_289(Local_98.f_28[2])) || func_289(Local_98.f_28[0])) || func_289(Local_98.f_28[1])) || IS_PED_RAGDOLL(Local_98.f_28[2])) || !func_214(Local_98.f_35[1])) || IS_EXPLOSION_IN_SPHERE(-1, vLocal_484, fLocal_487)) || func_271(Local_98.f_28[0])) || func_271(Local_98.f_28[1]))
			{
				if (!IS_PED_FLEEING(Local_98.f_28[2]) && !IS_PED_IN_ANY_VEHICLE(Local_98.f_28[2], 0))
				{
					if (func_242())
					{
						Var35 = { func_294() };
						uVar41 = func_293(&Var35);
						if (!ARE_STRINGS_EQUAL(uVar41, "PAP4_THREAT") && !ARE_STRINGS_EQUAL(uVar41, "PAP4_ATTACK"))
						{
							func_219();
						}
					}
					...
					bLocal_391 = false;
					iLocal_387 = 1;
					if (func_292(PLAYER_PED_ID()) != joaat("weapon_unarmed"))
					{
						func_270();
					}
					iLocal_460 = 3;
...
void func_288()
{
	if (func_205(Local_98.f_28[1]))
	{
		if (IS_PED_IN_GROUP(Local_98.f_28[1]))
		{
			REMOVE_PED_FROM_GROUP(Local_98.f_28[1]);
		}
		if (IS_ENTITY_PLAYING_ANIM(Local_98.f_28[1], sLocal_377, sLocal_393, 3))
		{
			if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_390))
...
int func_289(var uParam0)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		...
		if (func_214(uVar0))
		{
			if (IS_ENTITY_TOUCHING_ENTITY(uParam0, uVar0) && !func_290(uVar0))
			{
...
void func_291()
{
	if (func_205(Local_98.f_28[0]))
	{
		if ((((((!IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], 1) && iLocal_385) && !bLocal_386) && !func_271(Local_98.f_28[0])) && !IS_ENTITY_ON_FIRE(Local_98.f_28[0])) && !IS_PED_PERFORMING_STEALTH_KILL(PLAYER_PED_ID())) && iLocal_436 == 0)
		{
			if (IS_PED_IN_COMBAT(Local_98.f_28[0], 0) || IS_PED_IN_MELEE_COMBAT(Local_98.f_28[0]))
			{
				CLEAR_PED_TASKS(Local_98.f_28[0]);
			}
			if (HAS_ANIM_DICT_LOADED(sLocal_377))
			{
				TASK_PLAY_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 4f, -8f, -1, 57, 0, 0, 0, 0);
			}
			TASK_TURN_PED_TO_FACE_ENTITY(Local_98.f_28[0], PLAYER_PED_ID(), -1);
...
int func_295()
{
	if (func_292(PLAYER_PED_ID()) == joaat("weapon_stickybomb"))
	{
...
void func_296()
{
	...
	{
		if (GET_GAME_TIMER() > iLocal_337)
		{
			func_297();
			iLocal_337 = GET_GAME_TIMER() + 1000;
		}
	}
}
...
int func_297()
{
	...
	bVar0 = _0x639431E895B9AA57(Local_98.f_28[0], Local_98.f_35[0], -1, 0, 0);
	bVar1 = _0x639431E895B9AA57(Local_98.f_28[0], Local_98.f_35[0], 0, 0, 0);
	if (!bVar0 && !bVar1)
	{
		iLocal_461 = 0;
		iLocal_460 = 3;
		...
		if (((func_205(Local_98.f_28[1]) && !IS_PED_IN_COMBAT(Local_98.f_28[1], 0)) && !IS_PED_IN_MELEE_COMBAT(Local_98.f_28[1])) && !IS_PED_FLEEING(Local_98.f_28[1]))
		{
			TASK_COMBAT_PED(Local_98.f_28[1], PLAYER_PED_ID(), 0, 16);
			func_223(&(Local_98.f_41[1]), 0);
		}
		if (((func_205(Local_98.f_28[2]) && !IS_PED_IN_COMBAT(Local_98.f_28[2], 0)) && !IS_PED_IN_MELEE_COMBAT(Local_98.f_28[2])) && !IS_PED_FLEEING(Local_98.f_28[2]))
		{
			TASK_SMART_FLEE_PED(Local_98.f_28[2], PLAYER_PED_ID(), 200f, -1, 0, 0);
		}
		return 1;
	}
	return 0;
...
void func_298()
{
	if (func_205(Local_98.f_28[0]))
	{
		if (func_214(Local_98.f_35[0]) && GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_480))
		{
			if (IS_PED_SITTING_IN_VEHICLE(Local_98.f_28[0], Local_98.f_35[0]) && !func_217(Local_98.f_28[0], -1273030092))
			{
				SET_ROADS_IN_ANGLED_AREA(vLocal_473, vLocal_476, fLocal_479, 0, 1, 1);
				TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_98.f_28[0], Local_98.f_35[0], sLocal_480, 786597, 0, 8, -1, -1082130432, 0, 1073741824);
				if (DOES_BLIP_EXIST(uLocal_159))
				{
					SET_BLIP_SCALE(uLocal_159, 1f);
				}
				func_212(0);
			}
			else if (IS_PED_IN_VEHICLE(Local_98.f_28[0], Local_98.f_35[0], 1))
			{
		...
		{
			if (IS_PED_SITTING_IN_VEHICLE(Local_98.f_28[0], Local_98.f_35[1]))
			{
				if (DOES_BLIP_EXIST(uLocal_159))
				{
					SET_BLIP_SCALE(uLocal_159, 1f);
...
void func_299(bool bParam0, bool bParam1)
{
	...
	if ((((((func_214(Local_98.f_35[0]) && func_205(Local_98.f_28[0])) && bLocal_407) && iLocal_385) && !IS_PED_IN_COMBAT(Local_98.f_28[0], 0)) && !IS_PED_FLEEING(Local_98.f_28[0])) && !iLocal_389)
	{
		if (iLocal_376 && GET_GAME_TIMER() > iLocal_375)
		{
			if (iLocal_436 == 0)
			{
				func_300();
		...
		else if ((bParam0 || !func_242()) || !func_266(PLAYER_PED_ID(), Local_98.f_28[0], 30f, 1))
		{
			if (((((iLocal_461 && !func_217(Local_98.f_28[0], -1794415470)) && !func_217(Local_98.f_28[0], 355471868)) && IS_VEHICLE_SEAT_FREE(Local_98.f_35[0], -1, 0)) && !IS_PED_FLEEING(Local_98.f_28[0])) && !iLocal_389)
			{
				if (!func_297() && !func_243())
				{
					...
					if (!bParam0)
					{
						...
						iVar1 = 0;
						if (!func_266(PLAYER_PED_ID(), Local_98.f_28[0], 30f, 1))
						{
							iVar1 = 1;
						}
						if (iLocal_463 > 1)
					...
					{
						func_216(1);
						SET_PED_WEAPON_MOVEMENT_CLIPSET(Local_98.f_28[0], sLocal_381);
						_0x2208438012482A1A(Local_98.f_28[0], 0, 0);
						if (bParam1)
						{
							TASK_ENTER_VEHICLE(Local_98.f_28[0], Local_98.f_35[0], 20000, -1, 2f, 1, 0);
						}
						else
						{
							TASK_ENTER_VEHICLE(Local_98.f_28[0], Local_98.f_35[0], 20000, -1, 1f, 1, 0);
						}
						if (func_205(Local_98.f_28[1]))
						{
							TASK_TURN_PED_TO_FACE_ENTITY(Local_98.f_28[1], Local_98.f_28[0], -1);
						...
						if ((((func_205(Local_98.f_28[2]) && !IS_PED_FLEEING(Local_98.f_28[2])) && !iLocal_387) && !iLocal_465) && !IS_PED_RAGDOLL(Local_98.f_28[2]))
						{
							if (bParam0 || (func_214(Local_98.f_35[1]) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_98.f_35[1], 1)))
							{
								if (DOES_ENTITY_EXIST(Local_98.f_35[0]) && HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[0], PLAYER_PED_ID(), 1))
								{
									TASK_SMART_FLEE_PED(Local_98.f_28[2], PLAYER_PED_ID(), 500f, -1, 0, 0);
								}
								else if (func_214(Local_98.f_35[0]))
								{
									...
									TASK_ENTER_VEHICLE(0, Local_98.f_35[0], 20000, 0, 1073741824, 1, 0);
									CLOSE_SEQUENCE_TASK(uVar2);
									TASK_PERFORM_SEQUENCE(Local_98.f_28[2], uVar2);
									CLEAR_SEQUENCE_TASK(&uVar2);
								}
							...
							else if (func_214(Local_98.f_35[1]) && IS_VEHICLE_SEAT_FREE(Local_98.f_35[1], 0, 0))
							{
								TASK_ENTER_VEHICLE(Local_98.f_28[2], Local_98.f_35[1], 20000, 0, 1f, 1, 0);
							}
						}
						iLocal_375 = GET_GAME_TIMER() + 1500;
						iLocal_376 = 1;
						iLocal_460 = 3;
						bLocal_391 = false;
					}
...
void func_300()
{
	...
	if (func_205(Local_98.f_28[1]))
	{
		if ((((!func_217(Local_98.f_28[1], 242628503) && !IS_PED_FLEEING(Local_98.f_28[1])) && !IS_PED_IN_COMBAT(Local_98.f_28[1], 0)) && GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_481)) && !IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], 0))
		{
			OPEN_SEQUENCE_TASK(&uVar0);
			if (func_205(Local_98.f_28[0]))
			{
				TASK_TURN_PED_TO_FACE_ENTITY(0, Local_98.f_28[0], 6000);
			}
			if (func_214(Local_98.f_35[1]) && IS_VEHICLE_SEAT_FREE(Local_98.f_35[1], -1, 0))
			{
				SET_ROADS_IN_ANGLED_AREA(vLocal_473, vLocal_476, fLocal_479, 0, 1, 1);
				TASK_ENTER_VEHICLE(0, Local_98.f_35[1], 20000, -1, 2f, 1, 0);
			}
			CLOSE_SEQUENCE_TASK(uVar0);
			TASK_PERFORM_SEQUENCE(Local_98.f_28[1], uVar0);
...
void func_303()
{
	switch (iLocal_327)
	{
		case 0:
			...
			if (GET_GAME_TIMER() > iLocal_358)
			{
				...
				if (func_338(1, 1093140480, 0))
				{
					if (func_205(PLAYER_PED_ID()))
					{
						if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_359, vLocal_362, fLocal_365, 0, 1, 0))
						{
							iLocal_366 = 1;
						}
					...
					if (func_205(Local_98.f_28[0]))
					{
						REGISTER_ENTITY_FOR_CUTSCENE(Local_98.f_28[0], "Beverley", 0, 0, 0);
					}
					if (func_205(Local_98.f_28[1]))
					{
						REGISTER_ENTITY_FOR_CUTSCENE(Local_98.f_28[1], "film_guy", 0, 0, 0);
					}
					if (func_205(Local_98.f_28[2]))
					{
						REGISTER_ENTITY_FOR_CUTSCENE(Local_98.f_28[2], "makeup_artist", 0, 0, 0);
					}
					if (DOES_ENTITY_EXIST(Local_98.f_41[0]))
					{
						DETACH_ENTITY(Local_98.f_41[0], 0, 1);
						REGISTER_ENTITY_FOR_CUTSCENE(Local_98.f_41[0], "Beverlys_camera", 0, 0, 0);
					}
					if (DOES_ENTITY_EXIST(Local_98.f_41[1]))
					{
						DETACH_ENTITY(Local_98.f_41[1], 0, 1);
						REGISTER_ENTITY_FOR_CUTSCENE(Local_98.f_41[1], "Video_camera_forMan", 0, 0, 0);
					}
					func_337();
					...
					if (func_214(Local_98.f_35[0]))
					{
						func_335(Local_98.f_35[0], vLocal_421, fLocal_430, 0, 1);
						SET_VEHICLE_ON_GROUND_PROPERLY(Local_98.f_35[0], 1084227584);
						SET_VEHICLE_DOORS_LOCKED(Local_98.f_35[0], 1);
					}
					if (func_214(Local_98.f_35[1]))
					{
						func_335(Local_98.f_35[1], vLocal_424, fLocal_431, 0, 1);
						SET_VEHICLE_ON_GROUND_PROPERLY(Local_98.f_35[1], 1084227584);
						SET_VEHICLE_DOORS_LOCKED(Local_98.f_35[1], 1);
					}
					func_327(vLocal_328, vLocal_331, fLocal_334, -500.71f, 241.83f, 82.46f, 262.59f, 1, 1, 1, 0, 0);
		...
		case 1:
			...
			if ((((func_205(Local_98.f_28[0]) && func_205(Local_98.f_28[1])) && func_205(Local_98.f_28[2])) && DOES_ENTITY_EXIST(Local_98.f_41[0])) && DOES_ENTITY_EXIST(Local_98.f_41[1]))
			{
				...
				{
					ATTACH_ENTITY_TO_ENTITY(Local_98.f_41[0], Local_98.f_28[0], GET_PED_BONE_INDEX(Local_98.f_28[0], 28422), vLocal_346, vLocal_349, 0, 0, 0, 0, 2, 1);
					ATTACH_ENTITY_TO_ENTITY(Local_98.f_41[1], Local_98.f_28[1], GET_PED_BONE_INDEX(Local_98.f_28[1], 57005), vLocal_352, vLocal_355, 0, 0, 0, 0, 2, 1);
					func_313();
				}
			}
			...
			if (IS_CUTSCENE_PLAYING())
			{
				...
				if (iLocal_366 && GET_GAME_TIMER() > iLocal_367)
				{
					if (iLocal_367 < 0)
					{
						iLocal_367 = GET_GAME_TIMER() + 4000;
					}
					else
					{
						SET_ENTITY_VISIBLE(PLAYER_PED_ID(), 1, 0);
		...
		case 2:
			...
			if ((func_205(Local_98.f_28[0]) && func_205(Local_98.f_28[1])) && func_205(Local_98.f_28[2]))
			{
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_98.f_28[0], 1);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_98.f_28[1], 1);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_98.f_28[2], 1);
				SET_PED_CONFIG_FLAG(Local_98.f_28[0], 177, 1);
				SET_PED_CONFIG_FLAG(Local_98.f_28[0], 214, 1);
				SET_ENTITY_LOAD_COLLISION_FLAG(Local_98.f_28[0], 1, 1);
				SET_PED_LOD_MULTIPLIER(Local_98.f_28[0], 1.5f);
				SET_PED_LOD_MULTIPLIER(Local_98.f_28[1], 1.5f);
				SET_PED_LOD_MULTIPLIER(Local_98.f_28[2], 1.5f);
				if (func_205(PLAYER_PED_ID()))
				{
...
void func_304(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam1 == 1)
	{
		if ((iLocal_51 != 0 && iLocal_51 != joaat("object")) && iLocal_51 != joaat("gadget_parachute"))
		{
			...
			{
				if (HAS_PED_GOT_WEAPON(PLAYER_PED_ID(), iLocal_51, 0))
				{
					SET_CURRENT_PED_WEAPON(PLAYER_PED_ID(), iLocal_51, 0);
				}
			}
		}
	}
...
void func_305(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_309(PLAYER_ID())) && !func_307(PLAYER_ID(), 0)) && !func_306()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_309(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
...
void func_313()
{
	...
	if (func_205(Local_98.f_28[0]))
	{
		TASK_SYNCHRONIZED_SCENE(Local_98.f_28[0], uLocal_390, sLocal_377, sLocal_392, 1000f, -4f, 1, 16, 1148846080, 0);
	}
	if (func_205(Local_98.f_28[1]))
	{
		TASK_SYNCHRONIZED_SCENE(Local_98.f_28[1], uLocal_390, sLocal_377, sLocal_393, 1000f, -4f, 1, 16, 1148846080, 0);
	}
	if (func_205(Local_98.f_28[2]))
	{
		TASK_SYNCHRONIZED_SCENE(Local_98.f_28[2], uLocal_390, sLocal_377, sLocal_394, 1000f, -4f, 1, 16, 1148846080, 0);
	}
	bLocal_391 = true;
}
...
void func_315()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if (func_316(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_316(var uParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_324(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	var uVar0;
	...
	if (IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_325(GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
		...
		if (iParam4 == 1)
		{
			...
			if (func_206(PLAYER_PED_ID()))
			{
				iLocal_51 = GET_SELECTED_PED_WEAPON(PLAYER_PED_ID());
...
void func_327(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	func_328(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_328(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, var uParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	var uVar0;
	bool bVar1;
	bool bVar2;
	...
	if (DOES_ENTITY_EXIST(uVar0))
	{
		...
		if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_332(uVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_332(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((((((((((((((func_333(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_333(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_333(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_333(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_333(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_333(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_333(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_333(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_333(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_333(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_333(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_333(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_333(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_333(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_333(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_333(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return 1;
		}
	}
...
int func_335(var uParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
int func_338(int iParam0, int iParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_316(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_341()
{
	switch (iLocal_327)
	{
		case 0:
			...
			REQUEST_ANIM_DICT(sLocal_377);
			REQUEST_ANIM_DICT(sLocal_380);
			REQUEST_ANIM_DICT(sLocal_379);
			REQUEST_CLIP_SET(sLocal_381);
			REQUEST_WAYPOINT_RECORDING(sLocal_480);
			REQUEST_WAYPOINT_RECORDING(sLocal_481);
			SET_WANTED_LEVEL_MULTIPLIER(0.1f);
			if (HAS_ADDITIONAL_TEXT_LOADED(0))
			{
				if (func_205(PLAYER_PED_ID()))
				{
					func_354(&uLocal_160, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
				}
				func_353();
				SET_ROADS_IN_ANGLED_AREA(vLocal_473, vLocal_476, fLocal_479, 0, 0, 1);
				_REMOVE_STEALTH_KILL(GET_HASH_KEY("ACT_takedown_a"), 0);
				_REMOVE_STEALTH_KILL(GET_HASH_KEY("ACT_takedown_heavy"), 0);
				_REMOVE_STEALTH_KILL(GET_HASH_KEY("ACT_armed_takedown"), 0);
				...
				iLocal_455[3] = 2;
				func_216(0);
				uLocal_488 = GET_SOUND_ID();
				if (DOES_ENTITY_EXIST(Local_98.f_41[1]))
				{
					PLAY_SOUND_FROM_ENTITY(uLocal_488, sLocal_490, Local_98.f_41[1], sLocal_489, 0, 0);
				}
				iLocal_327 = 2;
			}
			break;
		...
		case 2:
			if (func_384())
			{
				func_352(vLocal_432, fLocal_435, 1, 0);
				func_342();
			}
			else
			{
				...
				if ((IS_SCREEN_FADED_IN() && func_206(Local_98.f_28[0])) && func_226(PLAYER_PED_ID(), Local_98.f_28[0], 1) > 6f)
				{
					SET_GAMEPLAY_ENTITY_HINT(Local_98.f_28[0], 0f, 0f, 0f, 1, -1, 3000, 2000, 0);
					_0xF8BDBF3D573049A1(0.45f);
					_0x5D7B620DAE436138(-0.01f);
					SET_GAMEPLAY_HINT_FOV(30f);
					GET_IS_MULTIPLAYER_BRIEF(1);
					TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), Local_98.f_28[0], -1, 0, 2);
					iLocal_358 = GET_GAME_TIMER() + 3000;
				}
				else
				{
					iLocal_358 = -1;
...
void func_342()
{
	...
	if (func_205(Local_98.f_28[1]))
	{
		SET_ENTITY_COORDS_NO_OFFSET(Local_98.f_28[1], vLocal_415, 0, 0, 1);
		SET_ENTITY_HEADING(Local_98.f_28[1], fLocal_428);
	}
	if (func_205(PLAYER_PED_ID()) && !func_349())
	{
		func_347(PLAYER_PED_ID(), vLocal_432);
		SET_ENTITY_HEADING(PLAYER_PED_ID(), fLocal_435);
		SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
		SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
	}
	if (func_214(Local_98.f_35[0]))
	...
	CLEAR_AREA_OF_VEHICLES(vLocal_412, 50f, 0, 0, 0, 0, 0, 0);
	func_313();
	if (func_349())
	{
		func_346(0, -1, 1);
	...
	{
		func_344(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
	}
	func_343(1, 1, 1);
}
...
void func_344(vector3 vParam0, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	var uVar0;
	int iVar1;
...
Vector3 func_347(var uParam0, vector3 vParam1)
{
	var uVar0;
...
void func_352(vector3 vParam0, float fParam3, int iParam4, int iParam5)
{
	if (func_384())
	{
...
void func_353()
{
	if (func_205(Local_98.f_28[0]))
	{
		SET_PED_MONEY(Local_98.f_28[0], 2000);
		SET_PED_DIES_WHEN_INJURED(Local_98.f_28[0], 1);
		func_354(&uLocal_160, 3, Local_98.f_28[0], "BEVERLY", 0, 1);
	}
	if (func_205(Local_98.f_28[1]))
	{
		func_354(&uLocal_160, 4, Local_98.f_28[1], "Pap4Cameraman", 0, 1);
	}
}

void func_354(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	if (Global_71844 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_357(Global_71845, Global_71847, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_368(0) || Global_71859) || Global_71848 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_322(0)) || func_367(1))
			{
			}
			else
			{
...
int func_374(var uParam0)
{
	...
	switch (iLocal_94)
	{
		...
		case 1:
			if (!func_383(&iVar0) || !HAS_ANIM_DICT_LOADED(sVar8))
			{
				return 0;
			}
			iLocal_94 = 2;
		...
		case 2:
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_380(&(uParam0->f_28[0]), 50, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
					...
					uVar10 = CREATE_SYNCHRONIZED_SCENE(-490.809f, 232.39f, 82.018f, 0f, 0f, 33.84f, 2);
					SET_SYNCHRONIZED_SCENE_LOOPED(uVar10, 1);
					_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uVar10, 0);
					TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uVar10, "rcmpaparazzo_4", "pap_4_rcm_leadin", 8f, -8f, 1, 16, 1148846080, 0);
				}
				else
				{
					bVar11 = false;
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_28[1]))
			{
				...
				if (func_205(uParam0->f_28[1]))
				{
					...
					TASK_PLAY_ANIM(uParam0->f_28[1], "rcmpaparazzo_4", "Idle_Camman", 8f, -8f, -1, 57, 0, 0, 0, 0);
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_28[2]))
			{
				...
				if (func_205(uParam0->f_28[2]))
				{
					...
					TASK_PLAY_ANIM(uParam0->f_28[2], "rcmpaparazzo_4", "Idle_Prod", 8f, -8f, -1, 57, 0, 0, 0, 0);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_28[2], 1);
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				...
				{
					LOWER_CONVERTIBLE_ROOF(uParam0->f_35[0], 1);
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				...
				if (func_206(uParam0->f_28[0]) && DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
					ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[0], uParam0->f_28[0], GET_PED_BONE_INDEX(uParam0->f_28[0], 57005), 0.1561f, -0.003f, -0.0344f, 202.8703f, -124.43f, -121.5398f, 0, 0, 0, 0, 2, 1);
				}
				else
				{
					bVar11 = false;
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				...
				if (func_206(uParam0->f_28[1]) && DOES_ENTITY_EXIST(uParam0->f_41[1]))
				{
					ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[1], uParam0->f_28[1], GET_PED_BONE_INDEX(uParam0->f_28[1], 57005), 0.1181f, 0.2229f, -0.1535f, 259.2501f, 24.08f, -51.2899f, 0, 0, 0, 0, 2, 1);
				}
				else
				{
					bVar11 = false;
...
void func_375(var uParam0, var uParam1, vector3 vParam2, float fParam5)
{
	func_222(uParam0);
...
void func_376(var uParam0, var uParam1, vector3 vParam2, float fParam5)
{
	func_377(uParam0);
...
void func_378(var uParam0, var uParam1, vector3 vParam2, float fParam5, int iParam6)
{
	func_379(uParam0);
...
int func_380(var uParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_381(uParam0, iParam1, vParam2, fParam5, 1))
	{
		if (DOES_ENTITY_EXIST(*uParam0))
		{
			if (!IS_ENTITY_DEAD(*uParam0, 0))
...
int func_381(var uParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	int iVar0;
...
void func_395()
{
	...
	if (func_205(Local_98.f_28[0]))
	{
		SET_ENTITY_LOAD_COLLISION_FLAG(Local_98.f_28[0], 0, 1);
		if (IS_ENTITY_PLAYING_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 3))
		{
			STOP_ANIM_TASK(Local_98.f_28[0], sLocal_377, sLocal_378, -1056964608);
		}
		if (!IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], 0))
		{
			TASK_WANDER_STANDARD(Local_98.f_28[0], 1193033728, 0);
		}
	}
	if (func_205(Local_98.f_28[1]) && !IS_ENTITY_ON_FIRE(Local_98.f_28[1]))
	{
		if (func_205(PLAYER_PED_ID()))
		{
			...
			{
				TASK_VEHICLE_DRIVE_WANDER(Local_98.f_28[1], Local_98.f_35[1], 20f, 786597);
			}
			else if (!IS_PED_FLEEING(Local_98.f_28[1]) && !IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], 1))
			{
				func_288();
				SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[1], 128, 1);
				func_396(&(Local_98.f_28[1]), 500, 0);
			}
		}
		else
		{
	...
	if (func_205(Local_98.f_28[2]) && !IS_ENTITY_ON_FIRE(Local_98.f_28[2]))
	{
		if (IS_PED_IN_GROUP(Local_98.f_28[2]))
		{
			REMOVE_PED_FROM_GROUP(Local_98.f_28[2]);
		...
		if (func_205(PLAYER_PED_ID()))
		{
			if (IS_PED_IN_ANY_VEHICLE(Local_98.f_28[2], 1))
			{
				uVar0 = GET_VEHICLE_PED_IS_IN(Local_98.f_28[2], 1);
				if (func_214(uVar0) && (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uVar0, 1) || !func_205(Local_98.f_28[0])))
				{
					OPEN_SEQUENCE_TASK(&uVar1);
					TASK_LEAVE_ANY_VEHICLE(0, 0, 320);
					TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 500f, -1, 0, 0);
					CLOSE_SEQUENCE_TASK(uVar1);
					TASK_PERFORM_SEQUENCE(Local_98.f_28[2], uVar1);
					CLEAR_SEQUENCE_TASK(&uVar1);
				}
			}
			else if (!IS_PED_FLEEING(Local_98.f_28[2]))
			{
				SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[2], 128, 1);
				func_396(&(Local_98.f_28[2]), 350, 1);
			}
		}
		else
		{
			TASK_WANDER_STANDARD(Local_98.f_28[2], 1193033728, 0);
		}
	}
	SET_WANTED_LEVEL_MULTIPLIER(1f);
	_REMOVE_STEALTH_KILL(GET_HASH_KEY("ACT_takedown_a"), 1);
	_REMOVE_STEALTH_KILL(GET_HASH_KEY("ACT_takedown_heavy"), 1);
	_REMOVE_STEALTH_KILL(GET_HASH_KEY("ACT_armed_takedown"), 1);
	REMOVE_ANIM_DICT(sLocal_377);
	REMOVE_ANIM_DICT(sLocal_380);
	if (GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_480))
	{
		REMOVE_WAYPOINT_RECORDING(sLocal_480);
	}
	if (GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_481))
	{
		REMOVE_WAYPOINT_RECORDING(sLocal_481);
	}
	STOP_SOUND(uLocal_488);
	func_211(&uLocal_159);
	func_223(&(Local_98.f_41[0]), 0);
	if (DOES_ENTITY_EXIST(Local_98.f_41[1]))
	{
		SET_OBJECT_AS_NO_LONGER_NEEDED(&(Local_98.f_41[1]));
	}
	func_394(&(Local_98.f_28[0]), 1, 0, 1);
	func_394(&(Local_98.f_28[1]), 1, 0, 1);
	func_394(&(Local_98.f_28[2]), 1, 0, 1);
	func_391(&(Local_98.f_35[0]));
	func_391(&(Local_98.f_35[1]));
	SET_ROADS_BACK_TO_ORIGINAL_IN_ANGLED_AREA(vLocal_473, vLocal_476, fLocal_479, 1);
	func_209();
}
...
void func_396(var uParam0, int iParam1, int iParam2)
{
	...
	if ((iParam2 && HAS_ANIM_DICT_LOADED(sLocal_380)) && iLocal_466)
	{
		TASK_PLAY_ANIM(0, sLocal_380, sLocal_382, 8f, -8f, -1, 8192, 0, 0, 0, 0);
		iLocal_466 = 0;
	}
	TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 500f, -1, 0, 0);
	CLOSE_SEQUENCE_TASK(uVar0);
...
void func_398(bool bParam0)
{
	...
	if (!func_415())
	{
		...
		{
			func_160(iVar0, 1, 0);
			func_399(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_105652[iVar0 /*10*/].f_9 == -1)
...
int func_400(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_406())
	{
		...
		{
			iVar33 = func_401(GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
