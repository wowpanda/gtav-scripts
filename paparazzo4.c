...
int func_33(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_76(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_76(iParam1), Global_70671[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, 0);
		}
	}
...
int func_36(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_70671[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iVar0), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_76(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iVar0), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, iParam4);
						}
						func_67(iVar0);
						if (Global_70669 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_76(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_70671[1 /*14*/].f_3, Global_70671[1 /*14*/].f_4, iParam4);
		}
		if (Global_70669 == 1)
		{
			iVar2 = 0;
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_87(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
		...
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_87(&(Global_70671[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_149(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_70671[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_76(iParam1)) && Global_70671[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_76(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_155()
{
	...
	{
		if (func_151(Global_104555.f_2353.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_166()
{
	...
	{
		func_155();
		GRAPHICS::_0xBF59707B3E5ED531(func_167(Global_104555.f_2353.f_539.f_4301));
	}
	else
	{
...
void func_213()
{
	if ((func_205(Local_56.f_28[0]) && func_214(Local_56.f_35[0])) && BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_316))
	{
	...
	if ((func_205(Local_56.f_28[1]) && func_214(Local_56.f_35[1])) && BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_317))
	{
	...
	if (func_205(Local_56.f_28[1]) && ENTITY::DOES_ENTITY_EXIST(Local_56.f_41[1]))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_56.f_28[1], sLocal_252, sLocal_268, 3))
		{
			if (PED::IS_PED_BEING_STEALTH_KILLED(Local_56.f_28[1]))
			{
				...
				{
					BRAIN::STOP_ANIM_TASK(Local_56.f_28[1], sLocal_252, sLocal_268, -1056964608);
				}
			}
		...
		{
			BRAIN::TASK_PLAY_ANIM(Local_56.f_28[1], sLocal_252, sLocal_268, 1000f, -8f, -1, 57, 0, 0, 0, 0);
		}
	}
}
...
int func_254(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_256(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_264(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_256(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_267()
{
	if (func_205(Local_56.f_28[1]) && func_214(Local_56.f_35[1]))
	{
		...
		{
			BRAIN::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_56.f_28[1], Local_56.f_35[1], sLocal_317, 786597, 0, 8, -1, -1f, 0, 1073741824);
		}
	}
}
	...
	if ((func_214(Local_56.f_35[1]) && (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_56.f_35[1]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_35[1], PLAYER::PLAYER_PED_ID(), 1))) && !bLocal_263)
	{
		...
		if (func_205(Local_56.f_28[0]))
		{
			if ((!PED::IS_PED_IN_COMBAT(Local_56.f_28[0], 0) && !PED::IS_PED_IN_MELEE_COMBAT(Local_56.f_28[0])) && !PED::IS_PED_FLEEING(Local_56.f_28[0]))
			{
				...
				{
					BRAIN::STOP_ANIM_TASK(Local_56.f_28[0], sLocal_252, sLocal_253, -1056964608);
...
void func_281()
{
	if ((iLocal_260 == 0 && func_205(Local_56.f_28[0])) && iLocal_295 == 0)
	{
		if ((((((!BRAIN::IS_PED_GETTING_UP(Local_56.f_28[0]) && !PED::IS_PED_PRONE(Local_56.f_28[0])) && !PED::IS_PED_RAGDOLL(Local_56.f_28[0])) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[0], 1)) && !func_217(Local_56.f_28[0], -1794415470)) && !PED::IS_PED_FLEEING(Local_56.f_28[0])) || PED::IS_PED_BEING_STEALTH_KILLED(Local_56.f_28[0]))
		{
			...
			{
				BRAIN::TASK_PLAY_ANIM(Local_56.f_28[0], sLocal_252, sLocal_253, 4f, -8f, -1, 57, 0, 0, 0, 0);
			}
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_56.f_28[0], sLocal_252, sLocal_253, 3))
		{
...
int func_284()
{
	...
	vVar0 = { ENTITY::GET_ENTITY_COORDS(Local_56.f_28[0], 1) + Vector(1f, 0f, 0f) };
	vVar1 = { ENTITY::GET_ENTITY_COORDS(Local_56.f_28[1], 1) - Vector(1f, 0f, 0f) };
...
void func_285(bool bParam0)
{
	...
	if (bLocal_266)
	{
		if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_265))
		{
			...
			if (func_205(Local_56.f_28[0]))
			{
				BRAIN::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[0], iLocal_265, sLocal_252, sVar1, fVar4, -4f, 1, 16, 1148846080, 0);
			}
			if (func_205(Local_56.f_28[1]))
			{
				BRAIN::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[1], iLocal_265, sLocal_252, sVar2, 1000f, -2f, 1, 16, 1148846080, 0);
			}
			if (func_205(Local_56.f_28[2]))
			{
				BRAIN::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[2], iLocal_265, sLocal_252, sVar3, fVar4, -4f, 1, 16, 1148846080, 0);
			}
		}
	}
			...
			else if ((func_205(Local_56.f_28[0]) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[0])) && (((((((ENTITY::GET_ENTITY_HEALTH(Local_56.f_28[0]) < 150 || (func_261(Local_56.f_28[0], 0, 0, 0, 0) && func_295())) || (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), 1) && func_292(PLAYER::PLAYER_PED_ID()) == joaat("weapon_stungun"))) || !func_266(PLAYER::PLAYER_PED_ID(), Local_56.f_28[0], 20f, 1)) || (func_205(Local_56.f_28[1]) && PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0))) || (func_205(Local_56.f_28[1]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), 1))) || (func_205(Local_56.f_28[2]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[2], PLAYER::PLAYER_PED_ID(), 1))) || iLocal_259))
			{
				...
				switch (iLocal_258)
				{
					case 0:
						...
						{
							BRAIN::TASK_PLAY_ANIM(Local_56.f_28[0], sLocal_254, "flinch_additive_a", 4f, -8f, -1, 272, 0, 0, 0, 0);
						}
						else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_56.f_28[0], sLocal_254, "flinch_additive_a") > 0.7f)
						{
							BRAIN::STOP_ANIM_TASK(Local_56.f_28[0], sLocal_254, "flinch_additive_a", -1056964608);
							iLocal_258++;
						}
						break;
...
void func_298()
{
	if (func_205(Local_56.f_28[0]))
	{
		if (func_214(Local_56.f_35[0]) && BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_316))
		{
			if (PED::IS_PED_SITTING_IN_VEHICLE(Local_56.f_28[0], Local_56.f_35[0]) && !func_217(Local_56.f_28[0], -1273030092))
			{
				...
				BRAIN::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_56.f_28[0], Local_56.f_35[0], sLocal_316, 786597, 0, 8, -1, -1f, 0, 1073741824);
				if (HUD::DOES_BLIP_EXIST(iLocal_57))
				{
...
void func_300()
{
	...
	if (func_205(Local_56.f_28[1]))
	{
		if ((((!func_217(Local_56.f_28[1], 242628503) && !PED::IS_PED_FLEEING(Local_56.f_28[1])) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0)) && BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_317)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[1], 0))
		{
...
void func_305(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_309(PLAYER::PLAYER_ID())) && !func_307(PLAYER::PLAYER_ID(), 0)) && !func_306())
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_309(PLAYER::PLAYER_ID()))
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_70854 = 0;
...
void func_313()
{
	...
	if (func_205(Local_56.f_28[0]))
	{
		BRAIN::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[0], iLocal_265, sLocal_252, sLocal_267, 1000f, -4f, 1, 16, 1148846080, 0);
	}
	if (func_205(Local_56.f_28[1]))
	{
		BRAIN::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[1], iLocal_265, sLocal_252, sLocal_268, 1000f, -4f, 1, 16, 1148846080, 0);
	}
	if (func_205(Local_56.f_28[2]))
	{
		BRAIN::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[2], iLocal_265, sLocal_252, sLocal_269, 1000f, -4f, 1, 16, 1148846080, 0);
	}
	bLocal_266 = true;
}
...
void func_341()
{
	...
	{
		func_343(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
	}
	func_342(1, 1, 1);
}
...
{
	if (((!func_367(0) || Global_71125) || Global_71114 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71110)
...
int func_373(var uParam0)
{
	...
	switch (iLocal_52)
	{
		...
		case 1:
			if (!func_382(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar1))
			{
				return 0;
			}
			iLocal_52 = 2;
...
int func_379(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
...
void func_395(var uParam0, int iParam1, int iParam2)
{
	...
	{
		BRAIN::TASK_PLAY_ANIM(0, sLocal_255, sLocal_257, 8f, -8f, -1, 8192, 0, 0, 0, 0);
		iLocal_310 = 0;
	}
	BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
	BRAIN::CLOSE_SEQUENCE_TASK(iVar0);
...
int func_402(char* sParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
