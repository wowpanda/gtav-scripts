...
void __EntryFunction__()
{
	...
	fLocal_243 = 18.5f;
	iLocal_245 = -1;
	fLocal_252 = "rcmpaparazzo_4";
	fLocal_253 = "lift_hands_in_air_loop";
	fLocal_254 = "MISSCOMMON@HANDS_UP_FLINCH";
	fLocal_255 = "reaction@back_away@f";
	fLocal_256 = "random@escape_paparazzi@standing@";
	fLocal_257 = "0";
	iLocal_260 = 1;
	bLocal_266 = true;
	fLocal_267 = "base_pap";
	fLocal_268 = "base_camman";
	fLocal_269 = "base_prod";
	...
	fLocal_315 = 6f;
	fLocal_316 = "pap4_BevRoute";
	fLocal_317 = "pap4_CamRoute";
	iLocal_318 = 20;
	iLocal_319 = 15;
			...
			if (func_205(Local_56.f_28[1]) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[1]))
			{
				if (func_205(PLAYER::PLAYER_PED_ID()))
				{
					if (!PED::IS_PED_FLEEING(Local_56.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[1], 1))
					{
						...
						BRAIN::TASK_SMART_FLEE_PED(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
					}
				}
				else
				{
					BRAIN::TASK_WANDER_STANDARD(Local_56.f_28[1], 1193033728, 0);
				}
			}
...
void func_4(int iParam0, bool bParam1)
{
	...
	{
		func_171(&(Global_104307[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_8()
{
	...
	{
		func_10(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
...
int func_33(int iParam0, int iParam1, int iParam2)
{
	...
	Global_70793[1 /*14*/] = { func_84(iVar0, iParam1, iParam2) };
	...
	else
	{
		...
		Global_70793[1 /*14*/] = { func_84(iVar0, iParam1, uVar6[iParam1]) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_76(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_76(iParam1), Global_70793[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, 0);
		}
	}
...
int func_34(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_149(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_64, Global_105220.f_2354.f_539[iVar0 /*65*/].f_63))
		{
...
int func_36(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_70793[1 /*14*/] = { func_84(iVar10, iParam1, iParam2) };
		if (!func_74(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_70793[1 /*14*/] = { func_84(iVar10, iVar0, uVar11[iVar0]) };
				if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_70793[1 /*14*/] = { func_84(iVar10, 14, uVar12[iVar1]) };
							func_52(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
							func_67(14);
							if (Global_70791 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_76(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
						}
						func_67(iVar0);
						if (Global_70791 == 1)
						{
			...
			{
				Global_70793[1 /*14*/] = { func_84(iVar10, iVar0, func_42(iParam0, iVar0, -1)) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_70793[1 /*14*/] = { func_84(iVar10, 14, uVar15[iVar1]) };
			func_52(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
			func_67(14);
			if (Global_70791 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_76(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
		}
		if (Global_70791 == 1)
		{
			iVar2 = 0;
...
{
	Global_70793[1 /*14*/] = { func_84(iParam0, iParam1, iParam2) };
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_76(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_59(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_76(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_54(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_54(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_54(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_54(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_149(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_61, Global_105220.f_2354.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_83(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[0], Global_105220.f_2354.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_83(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[1], Global_105220.f_2354.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_83(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[2], Global_105220.f_2354.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_86(int iParam0)
{
	...
	func_87(&(Global_70793[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_87(var uParam0, int iParam1, int iParam2, void fParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_71(func_90(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_71(func_89(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_71(iVar1, Global_70790, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_94(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_87(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_87(&(Global_70793[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_87(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_76(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_87(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_149(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_149(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_149(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_70793[2 /*14*/] = { func_84(iVar0, 14, iVar4) };
									if (Global_70793[2 /*14*/].f_12 == iVar3)
									{
										if (func_149(iParam0, 14, iVar4))
										{
											if (!func_40(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_70793[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_70793[2 /*14*/] = { func_84(iVar0, iVar2, iVar1) };
						if (!func_40(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_70793[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_70793[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_76(iParam1)) && Global_70793[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_76(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_155()
{
	...
	{
		if (func_151(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_150(PLAYER::PLAYER_PED_ID());
			if (func_152(iVar0) && (!func_92(14) || Global_104171))
			{
				if (Global_105220.f_2354.f_539.f_4301 != iVar0 && func_152(Global_105220.f_2354.f_539.f_4301))
				{
...
void func_160(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_161(&sVar1, Var0.f_3, Global_92992, iParam1, iParam2);
	}
}
...
void func_166()
{
	...
	{
		func_155();
		GRAPHICS::_0xBF59707B3E5ED531(func_167(Global_105220.f_2354.f_539.f_4301));
	}
	else
	{
...
{
	func_176(iParam0, 1);
	Global_105220.f_18545[iParam0 /*6*/].f_3 = func_175();
...
void func_193(void fParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
...
int func_202(void fParam0, int iParam1)
{
	int iVar0;
	void fVar1;
	int iVar2;
...
void func_213()
{
	if ((func_205(Local_56.f_28[0]) && func_214(Local_56.f_35[0])) && BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(fLocal_316))
	{
		if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_56.f_35[0]))
		{
			if (BRAIN::GET_VEHICLE_WAYPOINT_PROGRESS(Local_56.f_35[0]) >= iLocal_318)
			{
				if (bLocal_278)
				{
					BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(Local_56.f_28[0], Local_56.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 15f, 786468, 100f, 1f, 1);
				}
				else
				{
					BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(Local_56.f_28[0], Local_56.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 40f, 786468, 100f, 1f, 1);
				}
			}
		}
	}
	if ((func_205(Local_56.f_28[1]) && func_214(Local_56.f_35[1])) && BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(fLocal_317))
	{
		if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_56.f_35[1]))
		{
			if (BRAIN::GET_VEHICLE_WAYPOINT_PROGRESS(Local_56.f_35[1]) >= iLocal_319)
			{
				if (func_205(Local_56.f_28[0]))
				{
					if (bLocal_278)
					{
						BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(Local_56.f_28[1], Local_56.f_35[1], Local_56.f_28[0], 7, 15f, 786468, 100f, 1f, 1);
					}
					else
					{
						BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(Local_56.f_28[1], Local_56.f_35[1], Local_56.f_28[0], 7, 40f, 786468, 100f, 1f, 1);
					}
				}
				else
				{
					BRAIN::TASK_VEHICLE_DRIVE_WANDER(Local_56.f_28[1], Local_56.f_35[1], 15f, 786597);
				}
			}
		}
	}
...
void func_215()
{
	...
	{
		if (((((!PED::IS_PED_FLEEING(Local_56.f_28[2]) && !BRAIN::IS_PED_GETTING_UP(Local_56.f_28[2])) && !PED::IS_PED_PRONE(Local_56.f_28[2])) && !PED::IS_PED_RAGDOLL(Local_56.f_28[2])) && !func_217(Local_56.f_28[2], 63541484)) && !func_217(Local_56.f_28[2], 242628503))
		{
			if ((!PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[2], 1) || (func_214(Local_56.f_35[1]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_56.f_35[1], 1))) || (func_214(Local_56.f_35[0]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_56.f_35[0], 1)))
			{
				...
				BRAIN::TASK_SMART_FLEE_PED(Local_56.f_28[2], PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
			}
		}
	}
}
...
void func_218()
{
	...
	{
		if ((((((!PED::IS_PED_FLEEING(Local_56.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[1], 1)) && !BRAIN::IS_PED_GETTING_UP(Local_56.f_28[1])) && !PED::IS_PED_PRONE(Local_56.f_28[1])) && !PED::IS_PED_RAGDOLL(Local_56.f_28[1])) && !func_217(Local_56.f_28[1], 63541484)) && !func_217(Local_56.f_28[1], 242628503))
		{
			func_216(1);
			PED::SET_PED_FLEE_ATTRIBUTES(Local_56.f_28[1], 128, true);
			BRAIN::TASK_SMART_FLEE_PED(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
...
void func_221()
{
	...
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_56.f_28[1], fLocal_252, fLocal_268, 3))
		{
			if (PED::IS_PED_BEING_STEALTH_KILLED(Local_56.f_28[1]))
			{
				...
				{
					BRAIN::STOP_ANIM_TASK(Local_56.f_28[1], fLocal_252, fLocal_268, -1056964608);
				}
			}
		...
		{
			BRAIN::TASK_PLAY_ANIM(Local_56.f_28[1], fLocal_252, fLocal_268, 1000f, -8f, -1, 57, 0, 0, 0, 0);
		}
	}
}
...
void func_227(int iParam0, void fParam1, void fParam2, var uParam3, int iParam4, int iParam5)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if ((MISC::GET_GAME_TIMER() - *uParam3) > 500)
		{
			if (HUD::GET_BLIP_COLOUR(*iParam0) == 1)
			{
				...
				{
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_229(fParam1, 0, 0))
					{
						func_228(fParam2, 7500, 0);
					}
				}
			...
			else
			{
				...
				if ((MISC::GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_229(fParam2, 0, 0))
					{
						func_228(fParam1, 7500, 0);
					}
				}
				*uParam3 = MISC::GET_GAME_TIMER();
			}
	...
	{
		if (func_229(fParam1, 0, 0))
		{
			HUD::CLEAR_THIS_PRINT(fParam1);
		}
		if (func_229(fParam2, 0, 0))
		{
...
void func_228(void fParam0, int iParam1, int iParam2)
{
	iParam2 = iParam2;
...
bool func_229(void fParam0, int iParam1, void fParam2)
{
		...
		if (PED::IS_PED_IN_VEHICLE(Local_56.f_28[0], Local_56.f_35[0], 0))
		{
			if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_56.f_35[0]))
			{
				if (func_244(&uLocal_58, "PAP4AUD", "PAP4_BLOCKED", 7, 0, 0, 0))
				{
					...
					{
						BRAIN::TASK_COMBAT_PED(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), 0, 16);
...
void func_267()
{
	if (func_205(Local_56.f_28[1]) && func_214(Local_56.f_35[1]))
	{
		...
		{
			BRAIN::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_56.f_28[1], Local_56.f_35[1], fLocal_317, 786597, 0, 8, -1, -1f, 0, 1073741824);
		}
	}
}
...
void func_268()
{
	if ((func_214(Local_56.f_35[1]) && (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_56.f_35[1]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_35[1], PLAYER::PLAYER_PED_ID(), 1))) && !bLocal_263)
	{
		if ((func_205(Local_56.f_28[1]) && !PED::IS_PED_FLEEING(Local_56.f_28[1])) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0))
		{
			...
			BRAIN::TASK_COMBAT_PED(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), 0, 16);
			bLocal_263 = true;
		}
		...
		if (func_205(Local_56.f_28[0]))
		{
			...
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_56.f_28[0], fLocal_252, fLocal_253, 3))
				{
					BRAIN::STOP_ANIM_TASK(Local_56.f_28[0], fLocal_252, fLocal_253, -1056964608);
					BRAIN::TASK_SMART_FLEE_PED(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
					func_223(&(Local_56.f_41[0]), 0);
				}
				else
				{
	...
	if (func_205(Local_56.f_28[0]))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[0], 1))
		{
			if ((((!bLocal_261 && iLocal_260) && !func_271(Local_56.f_28[0])) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[0])) && !PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					BRAIN::CLEAR_PED_TASKS(Local_56.f_28[0]);
				}
				PED::SET_PED_FLEE_ATTRIBUTES(Local_56.f_28[0], 2, false);
				func_223(&(Local_56.f_41[0]), 0);
				iLocal_264 = 1;
				BRAIN::TASK_SMART_FLEE_PED(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), 400f, -1, 1, 0);
				func_219();
				iLocal_304 = 3;
				iLocal_260 = 0;
				bLocal_261 = true;
	...
	switch (iLocal_295)
	{
		case 1:
			...
			if (bVar0)
			{
				...
				{
					BRAIN::CLEAR_PED_TASKS(Local_56.f_28[0]);
					BRAIN::CLEAR_PED_SECONDARY_TASK(Local_56.f_28[0]);
				...
				{
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_297, 2f, 20000, 0.25f, 0, 1193033728);
				}
				BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
				BRAIN::CLOSE_SEQUENCE_TASK(iVar1);
				BRAIN::TASK_PERFORM_SEQUENCE(Local_56.f_28[0], iVar1);
				...
				if (func_205(Local_56.f_28[1]) && !PED::IS_PED_FLEEING(Local_56.f_28[1]))
				{
					...
					{
						BRAIN::TASK_LEAVE_ANY_VEHICLE(Local_56.f_28[1], 0, 0);
					}
					else
					{
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(Local_56.f_28[1], Local_56.f_28[0], -1);
					}
				}
				if ((((func_205(Local_56.f_28[2]) && !PED::IS_PED_FLEEING(Local_56.f_28[2])) && !iLocal_262) && !iLocal_309) && !PED::IS_PED_RAGDOLL(Local_56.f_28[2]))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_35[0], PLAYER::PLAYER_PED_ID(), 1))
					{
						BRAIN::TASK_SMART_FLEE_PED(Local_56.f_28[2], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
					}
					else if (PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[2], 0))
					{
						BRAIN::TASK_LEAVE_ANY_VEHICLE(Local_56.f_28[2], 0, 4416);
					}
					else
					{
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(Local_56.f_28[2], PLAYER::PLAYER_PED_ID(), -1);
					}
				}
			...
			else if (MISC::GET_GAME_TIMER() > iLocal_296)
			{
				if ((func_205(Local_56.f_28[0]) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[0], 0)) && iLocal_260)
				{
					...
					if ((((func_205(Local_56.f_28[2]) && !PED::IS_PED_FLEEING(Local_56.f_28[2])) && !iLocal_262) && !iLocal_309) && !PED::IS_PED_RAGDOLL(Local_56.f_28[2]))
					{
						...
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_298, 2f, 20000, 0.25f, 0, 1193033728);
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
						BRAIN::CLOSE_SEQUENCE_TASK(iVar2);
						BRAIN::TASK_PERFORM_SEQUENCE(Local_56.f_28[2], iVar2);
		...
		case 3:
			if (func_225(PLAYER::PLAYER_PED_ID(), Local_56.f_28[0]) > 20f)
			{
				...
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_297, 1f, 20000, 0.25f, 0, 1193033728);
				if (func_205(Local_56.f_28[1]))
				{
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_56.f_28[1], -1);
				}
				else
				{
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
				...
				BRAIN::TASK_PERFORM_SEQUENCE(Local_56.f_28[0], iVar3);
...
void func_274()
{
	BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), -1);
	iLocal_296 = MISC::GET_GAME_TIMER() + 3000;
	if (HUD::DOES_BLIP_EXIST(iLocal_57))
	{
		HUD::SET_BLIP_SCALE(iLocal_57, 0.7f);
...
void func_275()
{
	...
	if (((func_205(Local_56.f_28[1]) && func_205(Local_56.f_28[0])) && !PED::IS_PED_FLEEING(Local_56.f_28[1])) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0))
	{
		...
		if (fVar0 > 20f)
		{
			...
			{
				BRAIN::TASK_GOTO_ENTITY_OFFSET(Local_56.f_28[1], Local_56.f_28[0], 20000, 0.5f, 0f, 2f, 2);
			}
		}
		else if (fVar0 < 10f)
		{
...
void func_278()
{
	if ((((func_205(Local_56.f_28[0]) && func_205(Local_56.f_28[1])) && func_205(PLAYER::PLAYER_PED_ID())) && !bLocal_263) && ENTITY::DOES_ENTITY_EXIST(Local_56.f_41[1]))
	{
		...
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_56.f_28[0], fLocal_252, fLocal_253, 3))
		{
			if (MISC::GET_GAME_TIMER() > iLocal_281)
			{
				...
				{
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), -1);
					iLocal_282 = 1;
				}
...
void func_279()
{
	...
	if ((((!bLocal_308 && func_205(PLAYER::PLAYER_PED_ID())) && func_205(Local_56.f_28[1])) && func_205(Local_56.f_28[0])) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0))
	{
		...
		BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar4, 3f, 20000, 0.25f, 0, 1193033728);
		BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_56.f_28[0], 0);
		BRAIN::CLOSE_SEQUENCE_TASK(iVar5);
		BRAIN::TASK_PERFORM_SEQUENCE(Local_56.f_28[1], iVar5);
...
void func_281()
{
	...
	{
		if ((((((!BRAIN::IS_PED_GETTING_UP(Local_56.f_28[0]) && !PED::IS_PED_PRONE(Local_56.f_28[0])) && !PED::IS_PED_RAGDOLL(Local_56.f_28[0])) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[0], 1)) && !func_217(Local_56.f_28[0], -1794415470)) && !PED::IS_PED_FLEEING(Local_56.f_28[0])) || PED::IS_PED_BEING_STEALTH_KILLED(Local_56.f_28[0]))
		{
			if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_56.f_28[0], fLocal_252, fLocal_253, 3) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_252))
			{
				BRAIN::TASK_PLAY_ANIM(Local_56.f_28[0], fLocal_252, fLocal_253, 4f, -8f, -1, 57, 0, 0, 0, 0);
			}
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_56.f_28[0], fLocal_252, fLocal_253, 3))
		{
...
void func_285(bool bParam0)
{
	...
	if (bLocal_266)
	{
		if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_265))
		{
			...
			if (func_205(Local_56.f_28[0]))
			{
				BRAIN::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[0], iLocal_265, fLocal_252, fVar1, fVar4, -4f, 1, 16, 1148846080, 0);
			}
			if (func_205(Local_56.f_28[1]))
			{
				BRAIN::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[1], iLocal_265, fLocal_252, fVar2, 1000f, -2f, 1, 16, 1148846080, 0);
			}
			if (func_205(Local_56.f_28[2]))
			{
				BRAIN::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[2], iLocal_265, fLocal_252, fVar3, fVar4, -4f, 1, 16, 1148846080, 0);
			}
		}
	}
	else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_265))
	{
		...
		if ((((((!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_56.f_28[1], fLocal_252, fLocal_268, 3) && !PED::IS_PED_FLEEING(Local_56.f_28[1])) && !func_217(Local_56.f_28[1], 1805844857)) && !bLocal_308) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0)) && !PED::IS_PED_IN_MELEE_COMBAT(Local_56.f_28[1])) && ENTITY::DOES_ENTITY_EXIST(Local_56.f_41[1]))
		{
			BRAIN::TASK_PLAY_ANIM(Local_56.f_28[1], fLocal_252, fLocal_268, 1000f, -8f, -1, 57, 0, 0, 0, 0);
		...
		if (bLocal_278)
		{
			if ((((PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()) && func_295()) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vLocal_320, fLocal_321)) || !func_205(Local_56.f_28[1])) || !func_205(Local_56.f_28[2]))
			{
				...
				if (func_242())
				{
					Var0 = { func_294() };
					fVar1 = func_293(&Var0);
					if (!MISC::ARE_STRINGS_EQUAL(fVar1, "PAP4_THREAT"))
					{
						func_219();
					}
				}
			...
			else if ((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[2], PLAYER::PLAYER_PED_ID(), 1)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), 1)) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("object"))
			{
				...
				if (func_242())
				{
					Var2 = { func_294() };
					fVar3 = func_293(&Var2);
					if (!MISC::ARE_STRINGS_EQUAL(fVar3, "PAP4_THREAT"))
					{
						func_219();
					}
				}
			...
			else if ((((func_248(Local_56.f_28[0], 1126825984) && func_295()) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("object")) || PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
			{
				if (func_217(Local_56.f_28[0], 780511057))
				{
					...
					if (func_242())
					{
						Var4 = { func_294() };
						fVar5 = func_293(&Var4);
						if (!MISC::ARE_STRINGS_EQUAL(fVar5, "PAP4_THREAT"))
						{
							func_219();
						}
					}
				...
				else
				{
					...
					if (func_242())
					{
						Var6 = { func_294() };
						fVar7 = func_293(&Var6);
						if (!MISC::ARE_STRINGS_EQUAL(fVar7, "PAP4_THREAT"))
						{
							func_219();
						}
					}
			...
			else if ((func_205(Local_56.f_28[0]) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[0])) && (((((((ENTITY::GET_ENTITY_HEALTH(Local_56.f_28[0]) < 150 || (func_261(Local_56.f_28[0], 0, 0, 0, 0) && func_295())) || (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), 1) && func_292(PLAYER::PLAYER_PED_ID()) == joaat("weapon_stungun"))) || !func_266(PLAYER::PLAYER_PED_ID(), Local_56.f_28[0], 20f, 1)) || (func_205(Local_56.f_28[1]) && PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0))) || (func_205(Local_56.f_28[1]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), 1))) || (func_205(Local_56.f_28[2]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[2], PLAYER::PLAYER_PED_ID(), 1))) || iLocal_259))
			{
				...
				switch (iLocal_258)
				{
					case 0:
						...
						if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_56.f_28[0], fLocal_254, "flinch_additive_a", 3))
						{
							BRAIN::TASK_PLAY_ANIM(Local_56.f_28[0], fLocal_254, "flinch_additive_a", 4f, -8f, -1, 272, 0, 0, 0, 0);
						}
						else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_56.f_28[0], fLocal_254, "flinch_additive_a") > 0.7f)
						{
							BRAIN::STOP_ANIM_TASK(Local_56.f_28[0], fLocal_254, "flinch_additive_a", -1056964608);
							iLocal_258++;
						}
						break;
			...
			if (((((((((func_261(Local_56.f_28[1], 0, 0, 0, 0) && func_295()) || ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_28[1], PLAYER::PLAYER_PED_ID(), 1) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("object"))) || ((func_248(Local_56.f_28[1], 1126825984) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_292(PLAYER::PLAYER_PED_ID()) != joaat("object"))) || !func_214(Local_56.f_35[1])) || PED::IS_PED_RAGDOLL(Local_56.f_28[1])) || func_289(Local_56.f_28[1])) || func_271(Local_56.f_28[0])) || func_271(Local_56.f_28[2])) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vLocal_320, fLocal_321))
			{
				if (!PED::IS_PED_FLEEING(Local_56.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[1], 0))
				{
					if (func_242())
					{
						Var8 = { func_294() };
						fVar9 = func_293(&Var8);
						if (!MISC::ARE_STRINGS_EQUAL(fVar9, "PAP4_THREAT") && !MISC::ARE_STRINGS_EQUAL(fVar9, "PAP4_ATTACK"))
						{
							func_219();
						}
					}
		...
		if (func_205(Local_56.f_28[2]) && !iLocal_309)
		{
			if (((((((((((func_247(Local_56.f_28[2], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_295()) || (func_247(Local_56.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_295())) || (func_247(Local_56.f_28[1], 1, 1116471296, 1126825984, 0, 0, 0, 0) && func_295())) || func_289(Local_56.f_28[2])) || func_289(Local_56.f_28[0])) || func_289(Local_56.f_28[1])) || PED::IS_PED_RAGDOLL(Local_56.f_28[2])) || !func_214(Local_56.f_35[1])) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, vLocal_320, fLocal_321)) || func_271(Local_56.f_28[0])) || func_271(Local_56.f_28[1]))
			{
				if (!PED::IS_PED_FLEEING(Local_56.f_28[2]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[2], 0))
				{
					...
					{
						Var10 = { func_294() };
						fVar11 = func_293(&Var10);
						if (!MISC::ARE_STRINGS_EQUAL(fVar11, "PAP4_THREAT") && !MISC::ARE_STRINGS_EQUAL(fVar11, "PAP4_ATTACK"))
						{
							func_219();
						}
					}
...
int func_289(int iParam0)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (func_214(iVar0))
		{
			...
			{
				BRAIN::TASK_SMART_FLEE_PED(iParam0, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
				return 1;
			}
		}
	}
...
void func_291()
{
	if (func_205(Local_56.f_28[0]))
	{
		if ((((((!PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[0], 1) && iLocal_260) && !bLocal_261) && !func_271(Local_56.f_28[0])) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[0])) && !PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID())) && iLocal_295 == 0)
		{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(fLocal_252))
			{
				BRAIN::TASK_PLAY_ANIM(Local_56.f_28[0], fLocal_252, fLocal_253, 4f, -8f, -1, 57, 0, 0, 0, 0);
			}
			BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(Local_56.f_28[0], PLAYER::PLAYER_PED_ID(), -1);
...
int func_297()
{
	...
	if (!bVar0 && !bVar1)
	{
		...
		{
			BRAIN::TASK_SMART_FLEE_PED(Local_56.f_28[2], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
		}
		return 1;
	}
	return 0;
...
void func_298()
{
	if (func_205(Local_56.f_28[0]))
	{
		if (func_214(Local_56.f_35[0]) && BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(fLocal_316))
		{
			if (PED::IS_PED_SITTING_IN_VEHICLE(Local_56.f_28[0], Local_56.f_35[0]) && !func_217(Local_56.f_28[0], -1273030092))
			{
				...
				BRAIN::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_56.f_28[0], Local_56.f_35[0], fLocal_316, 786597, 0, 8, -1, -1f, 0, 1073741824);
				if (HUD::DOES_BLIP_EXIST(iLocal_57))
				{
		...
		else if ((bParam0 || !func_242()) || !func_266(PLAYER::PLAYER_PED_ID(), Local_56.f_28[0], 30f, 1))
		{
			if (((((iLocal_305 && !func_217(Local_56.f_28[0], -1794415470)) && !func_217(Local_56.f_28[0], 355471868)) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_56.f_35[0], -1, 0)) && !PED::IS_PED_FLEEING(Local_56.f_28[0])) && !iLocal_264)
			{
				if (!func_297() && !func_243())
				{
					...
					{
						func_216(1);
						PED::SET_PED_WEAPON_MOVEMENT_CLIPSET(Local_56.f_28[0], fLocal_256);
						PED::_0x2208438012482A1A(Local_56.f_28[0], 0, 0);
						if (bParam1)
						{
							BRAIN::TASK_ENTER_VEHICLE(Local_56.f_28[0], Local_56.f_35[0], 20000, -1, 2f, 1, 0);
						}
						else
						{
							BRAIN::TASK_ENTER_VEHICLE(Local_56.f_28[0], Local_56.f_35[0], 20000, -1, 1f, 1, 0);
						}
						if (func_205(Local_56.f_28[1]))
						{
							BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(Local_56.f_28[1], Local_56.f_28[0], -1);
						...
						if ((((func_205(Local_56.f_28[2]) && !PED::IS_PED_FLEEING(Local_56.f_28[2])) && !iLocal_262) && !iLocal_309) && !PED::IS_PED_RAGDOLL(Local_56.f_28[2]))
						{
							if (bParam0 || (func_214(Local_56.f_35[1]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_56.f_35[1], 1)))
							{
								...
								else if (func_214(Local_56.f_35[0]))
								{
									...
									BRAIN::TASK_ENTER_VEHICLE(0, Local_56.f_35[0], 20000, 0, 2f, 1, 0);
									BRAIN::CLOSE_SEQUENCE_TASK(iVar2);
									BRAIN::TASK_PERFORM_SEQUENCE(Local_56.f_28[2], iVar2);
									BRAIN::CLEAR_SEQUENCE_TASK(&iVar2);
								}
							...
							{
								BRAIN::TASK_ENTER_VEHICLE(Local_56.f_28[2], Local_56.f_35[1], 20000, 0, 1f, 1, 0);
							}
						}
...
void func_300()
{
	...
	if (func_205(Local_56.f_28[1]))
	{
		if ((((!func_217(Local_56.f_28[1], 242628503) && !PED::IS_PED_FLEEING(Local_56.f_28[1])) && !PED::IS_PED_IN_COMBAT(Local_56.f_28[1], 0)) && BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(fLocal_317)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[1], 0))
		{
			BRAIN::OPEN_SEQUENCE_TASK(&iVar0);
			if (func_205(Local_56.f_28[0]))
			{
				BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_56.f_28[0], 6000);
			}
			if (func_214(Local_56.f_35[1]) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_56.f_35[1], -1, 0))
			{
				PATHFIND::SET_ROADS_IN_ANGLED_AREA(vLocal_313, vLocal_314, fLocal_315, 0, true, 1);
				BRAIN::TASK_ENTER_VEHICLE(0, Local_56.f_35[1], 20000, -1, 2f, 1, 0);
			}
			BRAIN::CLOSE_SEQUENCE_TASK(iVar0);
			BRAIN::TASK_PERFORM_SEQUENCE(Local_56.f_28[1], iVar0);
			BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
		}
	}
}

void func_301(int iParam0, void fParam1, void fParam2, var uParam3, var uParam4, bool bParam5, int iParam6)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if (bParam5)
...
void func_313()
{
	...
	if (func_205(Local_56.f_28[0]))
	{
		BRAIN::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[0], iLocal_265, fLocal_252, fLocal_267, 1000f, -4f, 1, 16, 1148846080, 0);
	}
	if (func_205(Local_56.f_28[1]))
	{
		BRAIN::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[1], iLocal_265, fLocal_252, fLocal_268, 1000f, -4f, 1, 16, 1148846080, 0);
	}
	if (func_205(Local_56.f_28[2]))
	{
		BRAIN::TASK_SYNCHRONIZED_SCENE(Local_56.f_28[2], iLocal_265, fLocal_252, fLocal_269, 1000f, -4f, 1, 16, 1148846080, 0);
	}
	bLocal_266 = true;
}
...
void func_323(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
int func_331(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_332(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_334(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
int func_337(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
...
void func_339(void fParam0, bool bParam1)
{
	func_325(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(fParam0, 8);
}
...
void func_340()
{
	switch (iLocal_225)
	{
		case 0:
			...
			STREAMING::REQUEST_ANIM_DICT(fLocal_252);
			STREAMING::REQUEST_ANIM_DICT(fLocal_255);
			STREAMING::REQUEST_ANIM_DICT(fLocal_254);
			STREAMING::REQUEST_CLIP_SET(fLocal_256);
			BRAIN::REQUEST_WAYPOINT_RECORDING(fLocal_316);
			BRAIN::REQUEST_WAYPOINT_RECORDING(fLocal_317);
			PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.1f);
			if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
			{
				if (func_205(PLAYER::PLAYER_PED_ID()))
				{
					func_353(&uLocal_58, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
				}
				func_352();
				PATHFIND::SET_ROADS_IN_ANGLED_AREA(vLocal_313, vLocal_314, fLocal_315, 0, false, 1);
				MISC::_0xA6A12939F16D85BE(MISC::GET_HASH_KEY("ACT_takedown_a"), 0);
				MISC::_0xA6A12939F16D85BE(MISC::GET_HASH_KEY("ACT_takedown_heavy"), 0);
				MISC::_0xA6A12939F16D85BE(MISC::GET_HASH_KEY("ACT_armed_takedown"), 0);
		...
		case 2:
			...
			else
			{
				...
				if ((CAM::IS_SCREEN_FADED_IN() && func_206(Local_56.f_28[0])) && func_226(PLAYER::PLAYER_PED_ID(), Local_56.f_28[0], 1) > 6f)
				{
					...
					BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_56.f_28[0], -1, 0, 2);
...
void func_341()
{
	...
	if (func_205(PLAYER::PLAYER_PED_ID()) && !func_348())
	{
		func_346(PLAYER::PLAYER_PED_ID(), vLocal_293);
	...
	{
		func_343(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1112014848, 12, 5000, 0, 0);
	}
	func_342(1, 1, 1);
}
...
void func_343(vector3 vParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
Vector3 func_346(int iParam0, vector3 vParam1)
{
	var uVar0;
...
void func_351(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_383())
	{
...
void func_354(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71232 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_356(Global_71233, Global_71235, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
float func_355(void fParam0)
{
	HUD::_BEGIN_TEXT_COMMAND_WIDTH(fParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_356(int iParam0, int iParam1, int iParam2)
{
	struct<2> Var0;
	int iVar1;
...
int func_365(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (((!func_367(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_322(0)) || func_366(1))
			{
			}
			else
			{
...
{
	return func_369(iParam0, Global_35905);
}
...
int func_373(var uParam0)
{
	...
	switch (iLocal_52)
	{
		...
		case 1:
			if (!func_382(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(fVar1))
			{
				return 0;
			}
			iLocal_52 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_379(&(uParam0->f_28[0]), 50, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
					...
					BRAIN::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iVar3, "rcmpaparazzo_4", "pap_4_rcm_leadin", 8f, -8f, 1, 16, 1148846080, 0);
				}
				else
				{
					bVar4 = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
			{
				...
				if (func_205(uParam0->f_28[1]))
				{
					...
					BRAIN::TASK_PLAY_ANIM(uParam0->f_28[1], "rcmpaparazzo_4", "Idle_Camman", 8f, -8f, -1, 57, 0, 0, 0, 0);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[2]))
			{
				...
				if (func_205(uParam0->f_28[2]))
				{
					...
					BRAIN::TASK_PLAY_ANIM(uParam0->f_28[2], "rcmpaparazzo_4", "Idle_Prod", 8f, -8f, -1, 57, 0, 0, 0, 0);
...
void func_374(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_222(iParam0);
...
void func_377(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)
{
	func_378(iParam0);
...
int func_379(int iParam0, int iParam1, vector3 vParam2, float fParam3, void fParam4, int iParam5)
{
	if (func_380(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			...
			PED::SET_PED_NAME_DEBUG(*iParam0, fParam4);
		}
		return 1;
	}
	return 0;
...
void func_393(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_394()
{
	...
	if (func_205(Local_56.f_28[0]))
	{
		...
		if (!PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[0], 0))
		{
			BRAIN::TASK_WANDER_STANDARD(Local_56.f_28[0], 1193033728, 0);
		}
	}
	if (func_205(Local_56.f_28[1]) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[1]))
	{
		if (func_205(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				BRAIN::TASK_VEHICLE_DRIVE_WANDER(Local_56.f_28[1], Local_56.f_35[1], 20f, 786597);
			}
	...
	if (func_205(Local_56.f_28[2]) && !FIRE::IS_ENTITY_ON_FIRE(Local_56.f_28[2]))
	{
		...
		if (func_205(PLAYER::PLAYER_PED_ID()))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_28[2], 1))
			{
				...
				if (func_214(iVar0) && (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iVar0, 1) || !func_205(Local_56.f_28[0])))
				{
					...
					BRAIN::CLOSE_SEQUENCE_TASK(iVar1);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_56.f_28[2], iVar1);
					BRAIN::CLEAR_SEQUENCE_TASK(&iVar1);
				}
			}
		...
		{
			BRAIN::TASK_WANDER_STANDARD(Local_56.f_28[2], 1193033728, 0);
		}
	}
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
	MISC::_0xA6A12939F16D85BE(MISC::GET_HASH_KEY("ACT_takedown_a"), 1);
	MISC::_0xA6A12939F16D85BE(MISC::GET_HASH_KEY("ACT_takedown_heavy"), 1);
	MISC::_0xA6A12939F16D85BE(MISC::GET_HASH_KEY("ACT_armed_takedown"), 1);
	STREAMING::REMOVE_ANIM_DICT(fLocal_252);
	STREAMING::REMOVE_ANIM_DICT(fLocal_255);
	if (BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(fLocal_316))
	{
		BRAIN::REMOVE_WAYPOINT_RECORDING(fLocal_316);
	}
	if (BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(fLocal_317))
	{
		BRAIN::REMOVE_WAYPOINT_RECORDING(fLocal_317);
	}
	AUDIO::STOP_SOUND(iLocal_322);
	func_211(&iLocal_57);
	func_223(&(Local_56.f_41[0]), 0);
...
void func_395(var uParam0, int iParam1, int iParam2)
{
	...
	if ((iParam2 && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_255)) && iLocal_310)
	{
		BRAIN::TASK_PLAY_ANIM(0, fLocal_255, fLocal_257, 8f, -8f, -1, 8192, 0, 0, 0, 0);
		iLocal_310 = 0;
	}
	BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
	BRAIN::CLOSE_SEQUENCE_TASK(iVar0);
...
void func_398(void fParam0, int iParam1)
{
	if (Global_92955 != 12)
	{
		if (func_399(fParam0, 6, iParam1))
		{
...
int func_399(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
...
int func_401()
{
	...
	iVar0 = func_402(&(Global_92955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_402(void fParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
...
int func_405()
{
	...
	{
		if (func_400(&(Global_92955.f_3)) > -1)
		{
			return 1;
		}
	}
