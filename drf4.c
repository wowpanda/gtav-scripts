...
void func_3(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_5(Global_106565.f_18527[iVar0], &vVar2, &fVar5))
			{
...
void func_17(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_19() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_19() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_18(iParam0));
...
int func_25(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_19() /*10778*/].f_6165.f_10, iParam0);
}
...
float func_64(var uParam0)
{
	if (func_67(uParam0))
	{
		...
		{
			return (func_65(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	uParam0->f_1 = (func_65(IS_BIT_SET(*uParam0, 4)) - fParam1);
	SET_BIT(uParam0, 1);
	CLEAR_BIT(uParam0, 2);
	uParam0->f_2 = 0f;
}
...
void func_87(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, char* sParam10, int iParam11)
{
	...
	func_120(uParam0, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
	...
	while (iVar7 < 47)
	{
		if (IS_STRING_NULL_OR_EMPTY(uParam1[iVar7 /*4*/]))
		{
			iVar7 = 47;
		}
		iVar7 = (iVar7 + 1);
	...
	while (iVar7 < 27)
	{
		if (IS_STRING_NULL_OR_EMPTY(uParam4[iVar7 /*4*/]))
		{
			iVar7 = 27;
		}
		iVar7++;
	...
	while (iVar7 < 27)
	{
		if (IS_STRING_NULL_OR_EMPTY(uParam7[iVar7 /*4*/]))
		{
			iVar7 = 27;
		}
		iVar7++;
...
struct<4> func_103(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	if ((((!func_108(&(Global_106565.f_19955), 8) && iParam1) && iParam0 != 4) && func_106(3) > 0) && GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.75f)
	{
		iVar4 = 8;
		*uParam3 = 4;
	}
...
void func_110(var uParam0, var uParam1, var uParam2, int iParam3)
{
	if (iParam3 == 0)
	{
		func_89(uParam0, uParam1, uParam2, "DRF_OVG", GET_RANDOM_INT_IN_RANGE(1, 3), 1, 0);
		func_89(uParam0, uParam1, uParam2, "DRF_TMG", func_112(func_113(), 0, 2), 1, 0);
	}
	else if (iParam3 == 1)
	{
		func_89(uParam0, uParam1, uParam2, "DRF_OVO", GET_RANDOM_INT_IN_RANGE(1, 3), 1, 0);
...
int func_114(var uParam0)
{
	...
	if (ARE_STRINGS_EQUAL(uParam0, "DRF_SOL1"))
	{
		iVar0 = 1;
	}
	else if (ARE_STRINGS_EQUAL(uParam0, "DRF_EXILE"))
	{
		iVar0 = 2;
	}
	else if (ARE_STRINGS_EQUAL(uParam0, "DRF_SOL2"))
	{
		iVar0 = 1;
	}
	else if (ARE_STRINGS_EQUAL(uParam0, "DRF_MIC2"))
	{
		iVar0 = 1;
	}
	return iVar0;
...
{
	if (Global_90173 != 0 && (GET_GAME_TIMER() - Global_90173) < 1800000)
	{
		return 0;
	}
	REQUEST_ADDITIONAL_TEXT("SHRINK", 0);
