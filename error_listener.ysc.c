...
{
	if (Global_6485.f_3D < 20)
	{
		Global_6485[Global_6485.f_3D /*3*/] = { *iParam0 };
		Global_6485.f_3D++;
		return 1;
	}
	return 0;
...
int func_7(int iParam0, var uParam1)//Position - 0x1C7
{
	*uParam1 = 0;
	*uParam1 = 0;
	while (*uParam1 < Global_6485.f_3D)
	{
		if (Global_6485[*uParam1 /*3*/] == *iParam0 && Global_6485[*uParam1 /*3*/].f_2 == iParam0->f_2)
		{
			return 1;
		}
		*uParam1++;
