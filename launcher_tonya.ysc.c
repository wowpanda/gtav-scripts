	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != 4294967295)
		{
			if (Global_19AC5[Var0 /*10*/].f_9 != 4294967295)
			{
				...
				func_277(&(Global_19AC5[Var0 /*10*/].f_9));
			}
		}
		func_262(&Var0, 1);
	}
...
void func_47(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3781
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x3921
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x3953
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x3987
{
	return Global_1407E0;
}

int func_51(int iParam0, int iParam1)//Position - 0x3993
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x39BF
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F07
{
	int iVar0;
...
int func_54()//Position - 0x4149
{
	func_55();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_55()//Position - 0x4162
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x425F
{
	return Global_8D15 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x426D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x4360
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x45EA
{
	switch (iParam0)
	{
		case 3036451504:
...
int func_60(int iParam0)//Position - 0x4685
{
...
int func_61(int iParam0, int iParam1)//Position - 0x480B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x537C
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x53B7
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x562B
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x5667
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_66(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x5BC2
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5C06
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x62E5
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x632C
{
...
bool func_70(int iParam0)//Position - 0x6387
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6397
{
...
int func_72(int iParam0)//Position - 0x6401
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x6704
{
	return Global_6373;
}

int func_74(int iParam0)//Position - 0x670F
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x671F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x67C1
{
	switch (iParam0)
	{
		case 4294967295:
...
int func_77(int iParam0)//Position - 0x6D96
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6DF4
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6EA2
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6F37
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6F7B
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x70FF
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x710D
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7BD4
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7C56
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7CB4
{
	return 4294967295;
}

Vector3 func_87(int iParam0)//Position - 0x7CBD
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x7EC8
{
	return func_89(CAM::_0xDC9DA9E8789F5246());
}

int func_89(int iParam0)//Position - 0x7ED8
{
	return MISC::GET_BITS_IN_RANGE(Global_24FBF9[iParam0 /*413*/].f_135.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x7EF5
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x7F05
{
	switch (iParam0)
	{
		case 4294967295:
...
int func_167(var uParam0, int iParam1)//Position - 0xB448
{
	switch (uParam0->f_10)
	{
		case 0:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, true, 0))
				{
					if (func_126(uParam0->f_1C[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(uParam0->f_1C[0], true), true) < 3f)
						{
							if (func_173(2))
							{
								if (func_171(uParam0->f_1B))
								{
									func_170(uParam0->f_1B, *uParam0);
...
void func_168()//Position - 0xBC2B
{
	func_27(&(Global_17998.f_B3B), &Global_17998, 0, 1, 1, 0);
}

int func_169(var uParam0)//Position - 0xBC46
{
	float fVar0;
...
void func_170(int iParam0, int iParam1)//Position - 0xBCD4
{
	if (iParam0 == 1)
	{
		if (!func_129(iParam1))
...
int func_171(bool bParam0)//Position - 0xBD38
{
	int iVar0;
...
int func_172(int iParam0)//Position - 0xBDCF
{
	if (func_126(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
int func_173(int iParam0)//Position - 0xBDF9
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_181()) || Global_19A9D) || Global_6375) || func_180()) || func_179(8, 4294967295)) || func_92()) || func_178()) || func_177()) || func_176()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_181()) || Global_6375) || func_180()) || func_179(8, 4294967295)) || func_177()) || func_92()) || func_178()) || func_176()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_181()) || Global_19A9D) || Global_6375) || func_180()) || func_179(8, 4294967295)) || func_177()) || func_92()) || func_178()) || func_176()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_181()) || Global_19A9D) || Global_6375) || func_180()) || func_179(8, 4294967295)) || func_92()) || func_178()) || func_176()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_181() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_179(8, 4294967295)) || func_176()) || func_175()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_179(8, 4294967295) || func_92()) || func_178()) || func_175()) || func_174())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_181()) || Global_6375) || func_180()) || func_179(8, 4294967295)) || func_178()) || func_177()) || func_176()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_174()//Position - 0xC517
{
	return Global_16C57.f_1;
}

int func_175()//Position - 0xC525
{
...
bool func_178()//Position - 0xC58F
{
	return Global_16C64.f_148 > 0;
}

bool func_179(int iParam0, int iParam1)//Position - 0xC5A0
{
	switch (iParam0)
	{
		case 5:
...
var func_180()//Position - 0xC5DB
{
	return Global_140859;
}

int func_181()//Position - 0xC5E7
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_182(var uParam0)//Position - 0xC603
{
	float fVar0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
		fVar0 = SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), vLocal_52);
		if (fVar0 < (20f * 20f) && iLocal_56)
		{
			switch (iLocal_57)
			{
				case 0:
					if (!func_145())
					{
						func_199(&uLocal_58, 3, uParam0->f_1C[0], "TONYA", 0, 1);
						if (*uParam0 == 58)
						{
							func_198(&uLocal_58, "TOWAUD", "TONYA_BECK_1", 4, 0, 0, 0);
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_1C[0], 0))
							{
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_54);
								BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_5@franklin_5a", "hey_franklin_0", 2f, -4f, 4294967295, 262144, 0, 0, 0, 0);
								BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_5@franklin_5b", "hey_franklin_1", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
								BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_5@franklin_5c", "hey_franklin_2", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
								BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@base", "base", 2f, -2f, 4294967295, 262145, 0, 0, 0, 0);
								CUTSCENE::_0x8D9DF6ECA8768583(iLocal_54);
								BRAIN::TASK_PERFORM_SEQUENCE(uParam0->f_1C[0], iLocal_54);
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
							}
						}
						else if (*uParam0 == 59)
						{
							...
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_1C[0], 0))
							{
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_54);
								BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_5@franklin_5a", "hey_franklin_0", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
								BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_5@franklin_5b", "hey_franklin_1", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
								BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_5@franklin_5c", "hey_franklin_2", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
								BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@base", "base", 4f, -4f, 4294967295, 262145, 0, 0, 0, 0);
								CUTSCENE::_0x8D9DF6ECA8768583(iLocal_54);
								BRAIN::TASK_PERFORM_SEQUENCE(uParam0->f_1C[0], iLocal_54);
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
							}
				...
				case 1:
					if (!func_145())
					{
						if (func_189(&iLocal_223))
						{
							if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_1C[0], 0))
							{
								BRAIN::TASK_LOOK_AT_ENTITY(uParam0->f_1C[0], AUDIO::_0x0626A247D2405330(), 4294967295, 0, 4);
							}
							func_186(&iLocal_223);
							iLocal_57 = 2;
						}
								...
								case 1:
									if (*uParam0 == 58)
									{
										...
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_1C[0], 0))
										{
											BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
											BRAIN::OPEN_SEQUENCE_TASK(&iLocal_54);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_4@franklin_4a", "whats_wrong_with_you_0", 2f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_4@franklin_4b", "whats_wrong_with_you_1", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_4@franklin_4c", "whats_wrong_with_you_2", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@base", "base", 2f, -2f, 4294967295, 262145, 0, 0, 0, 0);
											CUTSCENE::_0x8D9DF6ECA8768583(iLocal_54);
											BRAIN::TASK_PERFORM_SEQUENCE(uParam0->f_1C[0], iLocal_54);
											BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
									...
									else if (*uParam0 == 59)
									{
										...
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_1C[0], 0))
										{
											BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
											BRAIN::OPEN_SEQUENCE_TASK(&iLocal_54);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_4@franklin_4a", "whats_wrong_with_you_0", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_4@franklin_4b", "whats_wrong_with_you_1", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_4@franklin_4c", "whats_wrong_with_you_2", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@base", "base", 4f, -4f, 4294967295, 262145, 0, 0, 0, 0);
											CUTSCENE::_0x8D9DF6ECA8768583(iLocal_54);
								...
								case 2:
									if (*uParam0 == 58)
									{
										...
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_1C[0], 0))
										{
											BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
											BRAIN::OPEN_SEQUENCE_TASK(&iLocal_54);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_1@franklin_1a", "seriously_franklin_get_your_fat_0", 2f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_1@franklin_1b", "seriously_franklin_get_your_fat_1", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_1@franklin_1c", "seriously_franklin_get_your_fat_2", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@base", "base", 2f, -2f, 4294967295, 262145, 0, 0, 0, 0);
											CUTSCENE::_0x8D9DF6ECA8768583(iLocal_54);
											BRAIN::TASK_PERFORM_SEQUENCE(uParam0->f_1C[0], iLocal_54);
											BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
									...
									else if (*uParam0 == 59)
									{
										...
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_1C[0], 0))
										{
											BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
											BRAIN::OPEN_SEQUENCE_TASK(&iLocal_54);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_1@franklin_1a", "seriously_franklin_get_your_fat_0", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_1@franklin_1b", "seriously_franklin_get_your_fat_1", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_1@franklin_1c", "seriously_franklin_get_your_fat_2", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@base", "base", 4f, -4f, 4294967295, 262145, 0, 0, 0, 0);
											CUTSCENE::_0x8D9DF6ECA8768583(iLocal_54);
								...
								case 3:
									if (*uParam0 == 58)
									{
										...
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_1C[0], 0))
										{
											BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
											BRAIN::OPEN_SEQUENCE_TASK(&iLocal_54);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_3@franklin_3a", "dont_be_actin_like_you_dont_know_me_0", 2f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_3@franklin_3b", "dont_be_actin_like_you_dont_know_me_1", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@base", "base", 2f, -2f, 4294967295, 262145, 0, 0, 0, 0);
											CUTSCENE::_0x8D9DF6ECA8768583(iLocal_54);
											BRAIN::TASK_PERFORM_SEQUENCE(uParam0->f_1C[0], iLocal_54);
											BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
									...
									else if (*uParam0 == 59)
									{
										...
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_1C[0], 0))
										{
											BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
											BRAIN::OPEN_SEQUENCE_TASK(&iLocal_54);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_3@franklin_3a", "dont_be_actin_like_you_dont_know_me_0", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_3@franklin_3b", "dont_be_actin_like_you_dont_know_me_1", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@base", "base", 4f, -4f, 4294967295, 262145, 0, 0, 0, 0);
											CUTSCENE::_0x8D9DF6ECA8768583(iLocal_54);
											BRAIN::TASK_PERFORM_SEQUENCE(uParam0->f_1C[0], iLocal_54);
								...
								case 4:
									if (*uParam0 == 58)
									{
										...
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_1C[0], 0))
										{
											BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
											BRAIN::OPEN_SEQUENCE_TASK(&iLocal_54);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_2@franklin_2a", "seriously_franklin_im_tonya_0", 2f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_2@franklin_2b", "seriously_franklin_im_tonya_1", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_2@franklin_2c", "seriously_franklin_im_tonya_2", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@base", "base", 2f, -2f, 4294967295, 262145, 0, 0, 0, 0);
											CUTSCENE::_0x8D9DF6ECA8768583(iLocal_54);
											BRAIN::TASK_PERFORM_SEQUENCE(uParam0->f_1C[0], iLocal_54);
											BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
									...
									else if (*uParam0 == 59)
									{
										...
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_1C[0], 0))
										{
											BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_54);
											BRAIN::OPEN_SEQUENCE_TASK(&iLocal_54);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_2@franklin_2a", "seriously_franklin_im_tonya_0", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_2@franklin_2b", "seriously_franklin_im_tonya_1", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@franklin_2@franklin_2c", "seriously_franklin_im_tonya_2", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
											BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@base", "base", 4f, -4f, 4294967295, 262145, 0, 0, 0, 0);
											CUTSCENE::_0x8D9DF6ECA8768583(iLocal_54);
...
float func_183(int iParam0)//Position - 0xD3B4
{
	if (func_189(iParam0))
	{
		if (func_185(iParam0))
		...
		{
			return (func_184(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}

float func_184(bool bParam0)//Position - 0xD3F3
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_185(int iParam0)//Position - 0xD44B
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 2);
}

void func_186(int iParam0)//Position - 0xD45B
{
	func_187(iParam0, 0f);
}

void func_187(int iParam0, float fParam1)//Position - 0xD46A
{
	iParam0->f_1 = (func_184(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 4)) - fParam1);
	MISC::SET_BIT(iParam0, 1);
	GRAPHICS::_0x35FB78DC42B7BD21(iParam0, 2);
	iParam0->f_2 = 0f;
}

void func_188(int iParam0)//Position - 0xD498
{
	if (!func_189(iParam0))
	{
		func_186(iParam0);
...
bool func_189(int iParam0)//Position - 0xD4B0
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 1);
}

int func_190(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD4C0
{
...
int func_191(char* sParam0, int iParam1, bool bParam2)//Position - 0xD514
{
	Global_3DCF = 0;
...
void func_197(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDA3A
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
int func_198(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xDA90
{
...
void func_199(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xDADE
{
...
void func_200(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xDB79
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_204(AUDIO::_0x0626A247D2405330(), vParam2, 1) <= 100f)
				{
					func_203(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_204(AUDIO::_0x0626A247D2405330(), vParam2, 1) > 120f)
				{
					func_206(iParam0);
				}
			}
...
void func_201(int iParam0, bool bParam1)//Position - 0xDC6A
{
	if (iParam0 == 4294967295)
	{
		return;
...
int func_202(int iParam0)//Position - 0xDCA6
{
	if (Global_11621 == iParam0)
	{
...
void func_203(int iParam0, int iParam1)//Position - 0xDCDF
{
	bool bVar0;
	int iVar1;
...
float func_204(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xDD7D
{
	vector3 vVar0;
...
bool func_205()//Position - 0xDDB7
{
	return Global_1620C;
}

void func_206(int iParam0)//Position - 0xDDC3
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_207(iParam0);
...
void func_207(int iParam0)//Position - 0xDDDA
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_208(int iParam0)//Position - 0xDEC2
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_164();
...
int func_209(int iParam0, bool bParam1)//Position - 0xDEEA
{
	struct<27> Var0;
	...
	func_109(*iParam0, &Var0);
	if ((func_246(*iParam0) || func_244(*iParam0)) || Global_1171A == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_213(&(iParam0->f_30)) && bParam1)
	{
		func_210(iParam0->f_1C[0], &(iParam0->f_30), *iParam0);
	}
	return 1;
}

void func_210(int iParam0, var uParam1, int iParam2)//Position - 0xE15D
{
	int iVar0;
	int iVar1;
	...
	if (func_126(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				...
				{
					if (func_211(iParam2) && !PED::IS_PED_FACING_PED(iParam0, AUDIO::_0x0626A247D2405330(), 25f))
					{
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, AUDIO::_0x0626A247D2405330(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_212(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_211(iParam2) || PED::IS_PED_FACING_PED(iParam0, AUDIO::_0x0626A247D2405330(), 10f))
				{
					if (func_68(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						BRAIN::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, 4294967295, 262153, 0, 0, 0, 0);
...
int func_211(int iParam0)//Position - 0xE4B5
{
...
int func_212(var uParam0)//Position - 0xE4D5
{
...
int func_213(var uParam0)//Position - 0xE4ED
{
...
void func_214(var uParam0)//Position - 0xE512
{
	int iVar0;
	int iVar1;
	...
	if (*uParam0 == 52)
	{
		func_215(&(uParam0->f_29[1]));
		func_215(&(uParam0->f_29[2]));
	}
...
void func_215(int iParam0)//Position - 0xE816
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_216(var uParam0)//Position - 0xE841
{
	int iVar0;
...
int func_217(var uParam0, bool bParam1, bool bParam2)//Position - 0xE8C1
{
	int iVar0;
	int iVar1;
	int iVar2;
				...
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
					{
						...
						if (func_172(iVar2))
						{
							...
							{
								if (func_172(uParam0->f_23[iVar0]))
								{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_218(AUDIO::_0x0626A247D2405330(), uParam0->f_23[iVar0]))
							{
...
int func_218(int iParam0, int iParam1)//Position - 0xEA7F
{
	int iVar0;
...
int func_219(var uParam0, bool bParam1, int iParam2)//Position - 0xEAAF
{
	int iVar0;
	int iVar1;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_1C[iVar0]))
				{
					...
					if (func_238(*uParam0))
					{
						if (!func_156(*uParam0))
						{
							if (func_233(uParam0->f_1C[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_214(uParam0);
						...
						if (func_221(uParam0->f_1C[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_214(uParam0);
...
int func_220(int iParam0)//Position - 0xED6B
{
...
int func_221(int iParam0, float fParam1)//Position - 0xED9F
{
	float fVar0;
...
bool func_222(int iParam0, float fParam1)//Position - 0xEE15
{
	return func_223(iParam0, AUDIO::_0x0626A247D2405330(), fParam1, 1, 250, 7);
}

bool func_223(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEE2D
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_224(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xEEEE
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_225(int iParam0, int iParam1)//Position - 0xF01A
{
	int iVar0;
...
int func_227(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xF129
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
float func_228(vector3 vParam0, vector3 vParam1)//Position - 0xF1BA
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_229(vector3 vParam0)//Position - 0xF1DB
{
	float fVar0;
	float fVar1;
...
void func_230(var uParam0)//Position - 0xF21A
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_231(int iParam0, int iParam1)//Position - 0xF235
{
	int iVar0;
...
int func_232(int iParam0)//Position - 0xF274
{
...
int func_233(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xF29C
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_234(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF397
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_235(int iParam0, float fParam1)//Position - 0xF4A3
{
	var uVar0;
	vector3 vVar1;
...
int func_236(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xF538
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
int func_237(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF5C6
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
...
int func_238(int iParam0)//Position - 0xF60E
{
...
void func_239(int iParam0)//Position - 0xF658
{
	int iVar0;
...
int func_240(int iParam0)//Position - 0xF6F5
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_164();
...
int func_241(int iParam0)//Position - 0xF78D
{
...
int func_244(int iParam0)//Position - 0xF80F
{
	if ((func_245() && Global_16C30.f_B == 6) && iParam0 == func_165(&(Global_16C30.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_246(int iParam0)//Position - 0xF881
{
	if (func_107(0))
	{
...
int func_247(int iParam0)//Position - 0xF8A9
{
	if (!func_248(iParam0))
	{
		return 0;
...
int func_248(var uParam0)//Position - 0xF8FD
{
	bool bVar0;
	int iVar1;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			{
				uParam0->f_1C[0] = PED::CREATE_PED(5, joaat("ig_tonya"), -16.53f, -1473.12f, 29.61f, 319.56f, 1, true);
				if (func_126(uParam0->f_1C[0]))
				{
		...
		case 3:
			if (func_126(uParam0->f_1C[0]) && PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
			{
				BRAIN::CLEAR_SEQUENCE_TASK(&iVar1);
				BRAIN::OPEN_SEQUENCE_TASK(&iVar1);
				BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@intro", "idle_intro", 4f, -4f, 4294967295, 262144, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(0, "special_ped@tonya@base", "base", 4f, -4f, 4294967295, 262145, 0, 0, 0, 0);
				BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295);
				CUTSCENE::_0x8D9DF6ECA8768583(iVar1);
				BRAIN::TASK_PERFORM_SEQUENCE(uParam0->f_1C[0], iVar1);
				BRAIN::CLEAR_SEQUENCE_TASK(&iVar1);
				BRAIN::TASK_LOOK_AT_ENTITY(uParam0->f_1C[0], AUDIO::_0x0626A247D2405330(), 4294967295, 0, 4);
			}
...
int func_249(int iParam0)//Position - 0xFBB3
{
	int iVar0;
...
int func_250(int iParam0)//Position - 0xFC1B
{
	struct<27> Var0;
	int iVar1;
...
int func_251(int iParam0)//Position - 0xFC6F
{
	char* sVar0;
...
int func_252(int iParam0)//Position - 0xFD28
{
	var uVar0;
...
int func_253(int iParam0)//Position - 0xFDE9
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_254(int iParam0, char* sParam1)//Position - 0xFE6E
{
...
bool func_255(int iParam0)//Position - 0xFF50
{
...
bool func_256(int iParam0)//Position - 0xFF7E
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
bool func_257(int iParam0)//Position - 0xFFAC
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
int func_258(int iParam0)//Position - 0xFFDA
{
	if (func_241(iParam0))
	{
		return 0;
...
int func_259(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0x10010
{
	int iVar0;
...
int func_260(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0x10075
{
	int iVar0;
	struct<7> Var1;
...
int func_261(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x100F3
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_262(int iParam0, bool bParam1)//Position - 0x1016E
{
	func_275();
	if (bParam1)
	{
...
void func_263(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10242
{
...
void func_264(var uParam0, bool bParam1)//Position - 0x10262
{
	func_265(&(uParam0->f_29), bParam1);
}

void func_265(var uParam0, bool bParam1)//Position - 0x10274
{
	int iVar0;
...
void func_266(int iParam0, bool bParam1)//Position - 0x102B2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_267(var uParam0, bool bParam1)//Position - 0x102ED
{
	func_268(&(uParam0->f_23), bParam1);
}

void func_268(var uParam0, bool bParam1)//Position - 0x102FF
{
	int iVar0;
...
void func_269(int iParam0)//Position - 0x1033C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_270(int iParam0)//Position - 0x10374
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_271(var uParam0, int iParam1)//Position - 0x10410
{
	func_272(&(uParam0->f_1C), iParam1);
}

void func_272(var uParam0, int iParam1)//Position - 0x10422
{
	int iVar0;
...
void func_273(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10463
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_274(int iParam0)//Position - 0x104B3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_275()//Position - 0x104F4
{
	Global_3960 = 0;
	func_276();
}

void func_276()//Position - 0x10504
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_277(var uParam0)//Position - 0x10525
{
	if (*uParam0 == 4294967295)
	{
		return;
...
void func_278(char* sParam0)//Position - 0x10562
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_279(var uParam0)//Position - 0x10574
{
	*uParam0 = 4294967295;
