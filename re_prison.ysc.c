...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_247 = AUDIO::_0x0626A247D2405330();
	...
	while (true)
	{
		...
		func_82();
		vLocal_248 = { unk_0x8000C77B5F336760(iLocal_247, true) };
		switch (iLocal_246)
		{
			case 0:
				func_80();
...
void func_4()//Position - 0x22C
{
	...
	if (iLocal_51 == 1)
	{
		...
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1766.972f, 2409.596f, 43.55469f, 1826.647f, 2471.633f, 56.30863f, 12f, 0, true, 0))
			{
				if (!bLocal_55)
				{
	...
	else if (iLocal_51 == 2)
	{
		if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1662.31f, 2391.06f, 43.51377f, 1761.362f, 2405.143f, 56.65472f, 12f, 0, true, 0))
			{
				if (!bLocal_55)
				{
					AUDIO::SET_AMBIENT_ZONE_STATE("AZ_COUNTRYSIDE_PRISON_01_ANNOUNCER_GENERAL", 0, 1);
	...
	else if (iLocal_51 == 3)
	{
		if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1537.369f, 2465.132f, 43.5756f, 1655.663f, 2391.822f, 56.54404f, 12f, 0, true, 0))
			{
				if (!bLocal_55)
				{
					AUDIO::SET_AMBIENT_ZONE_STATE("AZ_COUNTRYSIDE_PRISON_01_ANNOUNCER_GENERAL", 0, 1);
	...
	else if (iLocal_51 == 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1529.153f, 2584.264f, 43.6168f, 1535.014f, 2469.253f, 56.5985f, 12f, 0, true, 0))
			{
				if (!bLocal_55)
				{
					AUDIO::SET_AMBIENT_ZONE_STATE("AZ_COUNTRYSIDE_PRISON_01_ANNOUNCER_GENERAL", 0, 1);
	...
	else if (iLocal_51 == 5)
	{
		if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1565.045f, 2681.205f, 43.50552f, 1529.915f, 2586.427f, 56.52686f, 12f, 0, true, 0))
			{
				if (!bLocal_55)
				{
					AUDIO::SET_AMBIENT_ZONE_STATE("AZ_COUNTRYSIDE_PRISON_01_ANNOUNCER_GENERAL", 0, 1);
	...
	else if (iLocal_51 == 6)
	{
		if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1645.169f, 2760.33f, 43.6705f, 1567.113f, 2682.905f, 56.39177f, 12f, 0, true, 0))
			{
				if (!bLocal_55)
				{
					AUDIO::SET_AMBIENT_ZONE_STATE("AZ_COUNTRYSIDE_PRISON_01_ANNOUNCER_GENERAL", 0, 1);
	...
	else if (iLocal_51 == 7)
	{
		if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1772.306f, 2766.364f, 43.59126f, 1650.228f, 2761.691f, 56.53028f, 12f, 0, true, 0))
			{
				if (!bLocal_55)
				{
					AUDIO::SET_AMBIENT_ZONE_STATE("AZ_COUNTRYSIDE_PRISON_01_ANNOUNCER_GENERAL", 0, 1);
	...
	else if (iLocal_51 == 8)
	{
		if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1831.435f, 2623.257f, 43.46658f, 1851.659f, 2696.404f, 56.68093f, 12f, 0, true, 0))
			{
				if (!bLocal_55)
				{
					AUDIO::SET_AMBIENT_ZONE_STATE("AZ_COUNTRYSIDE_PRISON_01_ANNOUNCER_GENERAL", 0, 1);
	...
	else if (iLocal_51 == 10)
	{
		if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1829.468f, 2480.96f, 43.52237f, 1836.998f, 2566.856f, 60.35412f, 20.5f, 0, true, 0))
			{
				if (!bLocal_55)
				{
					AUDIO::SET_AMBIENT_ZONE_STATE("AZ_COUNTRYSIDE_PRISON_01_ANNOUNCER_GENERAL", 0, 1);
...
void func_5()//Position - 0x6CC
{
	...
	switch (iLocal_50)
	{
		...
		case 1:
			...
			iLocal_68 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_66, 6, joaat("s_m_y_cop_01"), 4294967295, 1, true);
			func_26(&iLocal_68);
			iLocal_50++;
			break;
		...
		case 2:
			...
			if ((func_16(iLocal_68, iLocal_66, &Local_70, &uLocal_71, 0, 1, 0, 1, 1) || func_16(iLocal_69, iLocal_67, &Local_70, &uLocal_71, 0, 1, 0, 1, 1)) || (func_15(vVar0, 4, 20, 0) && !PED::IS_PED_IN_FLYING_VEHICLE(AUDIO::_0x0626A247D2405330())))
			{
				...
				{
					BRAIN::TASK_COMBAT_PED(iLocal_68, AUDIO::_0x0626A247D2405330(), 0, 16);
				}
		...
		case 3:
			if (func_14(&iLocal_72))
			{
				if (func_8(&iLocal_72) > 15f)
				{
					...
					iLocal_69 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_67, 6, joaat("s_m_y_cop_01"), 4294967295, 1, true);
					func_26(&iLocal_69);
					BRAIN::TASK_COMBAT_PED(iLocal_69, AUDIO::_0x0626A247D2405330(), 0, 16);
					iLocal_50++;
				}
...
int func_17(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)//Position - 0x19DC
{
	...
	if (func_20(AUDIO::_0x0626A247D2405330(), iParam0))
	{
		return 1;
	}
	if (bParam2)
		...
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
		{
			if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iParam0, 4294967295, 0) != 0)
			{
				if (WEAPON::GET_CURRENT_PED_WEAPON(AUDIO::_0x0626A247D2405330(), &iVar0, 1))
				{
					...
					{
						if (func_19(AUDIO::_0x0626A247D2405330(), iParam0, 1) < 40f)
						{
...
{
	WEAPON::GIVE_WEAPON_TO_PED(*iParam0, joaat("weapon_assaultshotgun"), 4294967295, false, true);
...
void func_27()//Position - 0x201A
{
	...
	if (bLocal_294)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_289, 0))
		{
			...
			if (bLocal_292)
			{
				vVar1 = { unk_0x8000C77B5F336760(iLocal_289, true) };
...
void func_29()//Position - 0x2110
{
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(Local_307.f_1B[iVar0]))
		{
			if (!Local_307.f_12[iVar0])
			{
				if (func_16(Local_307.f_1B[iVar0], 0, &Local_70, &uLocal_71, 1, 1, 0, 1, 1) || iLocal_306)
				{
					BRAIN::TASK_COMBAT_PED(Local_307.f_1B[iVar0], AUDIO::_0x0626A247D2405330(), 0, 16);
					Local_307.f_12[iVar0] = 1;
				}
			}
			if (!Local_307.f_12[iVar0])
			{
				if (!BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(Local_307.f_1B[iVar0]))
				{
					BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(Local_307.f_1B[iVar0], Local_307.f_E[iVar0], 0, 0, 4294967295);
				}
			}
		}
		else if (HUD::DOES_BLIP_EXIST(Local_307.f_24[iVar0]))
		{
			HUD::REMOVE_BLIP(&(Local_307.f_24[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_307.f_1F[iVar0]))
		{
			if (PED::IS_PED_INJURED(Local_307.f_1F[iVar0]))
			{
				if (HUD::DOES_BLIP_EXIST(Local_307.f_28[iVar0]))
				{
					HUD::REMOVE_BLIP(&(Local_307.f_28[iVar0]));
				}
			}
		}
		iVar0++;
	...
	if (!Local_307.f_16[0])
	{
		if (!PED::IS_PED_INJURED(Local_307.f_1F[0]))
		{
			if ((func_16(Local_307.f_1F[0], 0, &Local_70, &uLocal_71, 1, 1, 0, 1, 1) || Local_307.f_12[1] == 1) || iLocal_306)
			{
				NETWORK::_0x5E3AA4CA2B6FB0EE(Local_307.f_1F[0]);
				BRAIN::TASK_COMBAT_PED(Local_307.f_1F[0], AUDIO::_0x0626A247D2405330(), 0, 16);
				Local_307.f_16[0] = 1;
			}
		}
	}
	if (!Local_307.f_16[1])
	{
		if (!PED::IS_PED_INJURED(Local_307.f_1F[1]))
		{
			if ((func_16(Local_307.f_1F[1], 0, &Local_70, &uLocal_71, 0, 1, 0, 1, 1) || Local_307.f_12[1] == 1) || iLocal_306)
			{
				NETWORK::_0x5E3AA4CA2B6FB0EE(Local_307.f_1F[1]);
				BRAIN::TASK_COMBAT_PED(Local_307.f_1F[1], AUDIO::_0x0626A247D2405330(), 0, 16);
				Local_307.f_16[1] = 1;
			}
		}
	}
	if (!Local_307.f_16[2])
	{
		if (!PED::IS_PED_INJURED(Local_307.f_1F[2]))
		{
			if ((func_16(Local_307.f_1F[2], 0, &Local_70, &uLocal_71, 0, 1, 0, 1, 1) || Local_307.f_12[2] == 1) || iLocal_306)
			{
				NETWORK::_0x5E3AA4CA2B6FB0EE(Local_307.f_1F[2]);
				BRAIN::TASK_COMBAT_PED(Local_307.f_1F[2], AUDIO::_0x0626A247D2405330(), 0, 16);
				Local_307.f_16[2] = 1;
			}
		}
	}
	if (!Local_307.f_16[3])
	{
		if (!PED::IS_PED_INJURED(Local_307.f_1F[3]))
		{
			if ((func_16(Local_307.f_1F[3], 0, &Local_70, &uLocal_71, 0, 1, 0, 1, 1) || Local_307.f_12[2] == 1) || iLocal_306)
			{
				NETWORK::_0x5E3AA4CA2B6FB0EE(Local_307.f_1F[3]);
				BRAIN::TASK_COMBAT_PED(Local_307.f_1F[3], AUDIO::_0x0626A247D2405330(), 0, 16);
				Local_307.f_16[3] = 1;
			}
		}
	}
	if (!PED::IS_PED_INJURED(Local_307.f_1B[1]))
	{
		if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(Local_307.f_1B[1]))
		{
			if (!Local_307.f_16[0])
			{
				if (!PED::IS_PED_INJURED(Local_307.f_1F[0]))
				{
					BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_307.f_1F[0], Local_307.f_1B[1], -2f, 0f, 0f, 1f, 4294967295, 1036831949, 1);
				}
			}
			if (!Local_307.f_16[1])
			{
				if (!PED::IS_PED_INJURED(Local_307.f_1F[1]))
				{
					BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_307.f_1F[1], Local_307.f_1B[1], -1f, 0f, 0f, 1f, 4294967295, 1036831949, 1);
				}
			}
		}
	}
	if (!PED::IS_PED_INJURED(Local_307.f_1B[2]))
	{
		if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(Local_307.f_1B[2]))
		{
			if (!Local_307.f_16[2])
			{
				if (!PED::IS_PED_INJURED(Local_307.f_1F[2]))
				{
					BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_307.f_1F[2], Local_307.f_1B[2], 1f, 0f, 0f, 1f, 4294967295, 1036831949, 1);
				}
			}
			if (!Local_307.f_16[3])
			{
				if (!PED::IS_PED_INJURED(Local_307.f_1F[3]))
				{
					BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_307.f_1F[3], Local_307.f_1B[2], -1f, 0f, 0f, 1f, 4294967295, 1036831949, 1);
				}
			}
		}
	}
...
void func_30()//Position - 0x257A
{
	...
	if (iLocal_269 >= 30)
	{
		if (!bLocal_58)
		{
			if (func_15(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 4, 100, 0))
			{
				iVar0 = 0;
				while (iVar0 < 10)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Local_252.f_40[iVar0]) && !PED::IS_PED_INJURED(Local_252.f_40[iVar0]))
					{
						if (PED::GET_PED_PARACHUTE_STATE(AUDIO::_0x0626A247D2405330()) != 4294967295)
						{
							...
							{
								PED::SET_PED_ACCURACY(Local_252.f_40[iVar0], 10);
								iLocal_268 = 1;
							}
						}
						else if (PED::IS_PED_IN_FLYING_VEHICLE(AUDIO::_0x0626A247D2405330()))
						{
							PED::SET_PED_ACCURACY(Local_252.f_40[iVar0], 10);
							iLocal_268 = 1;
						}
						...
						{
							PED::SET_PED_ACCURACY(Local_252.f_40[iVar0], 100);
							iLocal_268 = 1;
						}
					}
					iVar0++;
	...
	while (iVar0 < 10)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_252.f_40[iVar0]) && !PED::IS_PED_INJURED(Local_252.f_40[iVar0]))
		{
			...
			if ((((func_16(Local_252.f_40[iVar0], 0, &Local_70, &uLocal_71, 0, 1, 0, 1, 1) || MISC::IS_BULLET_IN_AREA(Local_252[iVar0 /*3*/], 20f, 1)) || MISC::IS_SNIPER_BULLET_IN_AREA(Local_252[iVar0 /*3*/] - Vector(20f, 20f, 20f), Local_252[iVar0 /*3*/] + Vector(20f, 20f, 20f))) || iLocal_268) || func_32(&(Local_252.f_40[iVar0])))
			{
				if (!func_2(5))
				{
			...
			{
				if (!BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(Local_252.f_40[iVar0]))
				{
					BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(Local_252.f_40[iVar0], Local_252.f_2A[iVar0], 0, 0, 4294967295);
					Local_252.f_35[iVar0] = 0;
				}
			}
		}
		else if (HUD::DOES_BLIP_EXIST(Local_252.f_4B[iVar0]))
		{
			HUD::REMOVE_BLIP(&(Local_252.f_4B[iVar0]));
		}
		iVar0++;
	}
	iVar0 = 0;
...
void func_31(int iParam0)//Position - 0x2955
{
	...
	{
		BRAIN::TASK_SHOOT_AT_ENTITY(Local_252.f_40[iParam0], AUDIO::_0x0626A247D2405330(), 4294967295, 0);
		PED::SET_PED_SEEING_RANGE(Local_252.f_40[iParam0], 1000f);
		PED::_0xF1C03A5352243A30(Local_252.f_40[iParam0]);
...
int func_32(var uParam0)//Position - 0x29C5
{
	...
	{
		vVar1 = { unk_0x8000C77B5F336760(*uParam0, true) };
	}
...
void func_33()//Position - 0x2A19
{
	if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
	{
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) >= 2 || func_15(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 4, 150, 0))
		{
...
void func_34()//Position - 0x2A6F
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1840.23f, 2471.49f, 41.94113f, 1840.553f, 2751.983f, 54.68177f, 84.25f, 0, true, 0))
		{
			func_57(&Local_70, 2);
		}
		else
...
void func_45()//Position - 0x3255
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_48(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_46(iVar0) && (!func_2(14) || Global_19A3D))
			{
...
void func_61()//Position - 0x3636
{
	...
	while (iVar0 < 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_307.f_1B[iVar0]) && !ENTITY::IS_ENTITY_DEAD(Local_307.f_1B[iVar0], 0))
		{
			WEAPON::GIVE_WEAPON_TO_PED(Local_307.f_1B[iVar0], joaat("weapon_assaultrifle"), 4294967295, true, true);
			ENTITY::SET_ENTITY_LOD_DIST(Local_307.f_1B[iVar0], 1000);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_307.f_1B[iVar0], 4111159735);
			PED::_0xA9B61A329BFDCBEA(Local_307.f_1B[iVar0], false);
			ENTITY::SET_ENTITY_HEALTH(Local_307.f_1B[iVar0], true);
			if (!PED::IS_PED_INJURED(Local_307.f_1B[iVar0]))
			{
				BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(Local_307.f_1B[iVar0], Local_307.f_E[iVar0], 0, 0, 4294967295);
			}
...
void func_62()//Position - 0x36F1
{
	...
	while (iVar0 < 3)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(Local_307.f_1B[iVar0]))
		{
			Local_307.f_1B[iVar0] = PED::CREATE_PED(6, joaat("s_m_m_prisguard_01"), Local_307[iVar0 /*3*/], Local_307.f_A[iVar0], 1, true);
			SYSTEM::WAIT(0);
		}
		iVar0++;
	}
	vVar1 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_307[1 /*3*/], Local_307.f_A[1], -2f, 0f, 0f) };
	vVar2 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_307[1 /*3*/], Local_307.f_A[1], -1f, 0f, 0f) };
	vVar3 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_307[2 /*3*/], Local_307.f_A[2], 1f, 0f, 0f) };
	vVar4 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(Local_307[2 /*3*/], Local_307.f_A[2], -1f, 0f, 0f) };
	Local_307.f_1F[0] = PED::CREATE_PED(6, joaat("s_m_m_prisguard_01"), vVar1, Local_307.f_A[1], 1, true);
	Local_307.f_1F[1] = PED::CREATE_PED(6, joaat("s_m_m_prisguard_01"), vVar2, Local_307.f_A[1], 1, true);
	Local_307.f_1F[2] = PED::CREATE_PED(6, joaat("s_m_m_prisguard_01"), vVar3, Local_307.f_A[2], 1, true);
	Local_307.f_1F[3] = PED::CREATE_PED(6, joaat("s_m_m_prisguard_01"), vVar4, Local_307.f_A[2], 1, true);
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_307.f_1F[iVar0]))
		{
			WEAPON::GIVE_WEAPON_TO_PED(Local_307.f_1F[iVar0], joaat("weapon_assaultrifle"), 4294967295, true, true);
			ENTITY::SET_ENTITY_LOD_DIST(Local_307.f_1F[iVar0], 500);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_307.f_1F[iVar0], 4111159735);
			PED::SET_PED_STEERS_AROUND_PEDS(Local_307.f_1F[iVar0], 0);
			ENTITY::SET_ENTITY_HEALTH(Local_307.f_1F[iVar0], true);
		}
		iVar0++;
	}
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("s_m_m_prisguard_01"));
...
void func_63()//Position - 0x38B6
{
	if (bLocal_294)
	{
		...
		PED::SET_PED_INTO_VEHICLE(iLocal_290, iLocal_289, 4294967295);
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_289, 0))
		{
			VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(iLocal_289, 101, "PrisonHeli", 1);
		}
...
void func_66()//Position - 0x44D7
{
	...
	while (iVar0 < 10)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_252.f_40[iVar0]) && !ENTITY::IS_ENTITY_DEAD(Local_252.f_40[iVar0], 0))
		{
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_252.f_40[iVar0], 4111159735);
			PED::SET_PED_CONFIG_FLAG(Local_252.f_40[iVar0], 132, true);
			PED::SET_PED_TO_INFORM_RESPECTED_FRIENDS(Local_252.f_40[iVar0], 300f, 10);
			PED::SET_PED_SEEING_RANGE(Local_252.f_40[iVar0], 1000f);
			PED::SET_PED_ID_RANGE(Local_252.f_40[iVar0], 1000f);
			PED::SET_PED_HEARING_RANGE(Local_252.f_40[iVar0], 1000f);
			PED::SET_PED_COMBAT_ABILITY(Local_252.f_40[iVar0], 2);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_252.f_40[iVar0], 13, true);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_252.f_40[iVar0], 0, false);
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_252.f_40[iVar0], 1);
			PED::SET_PED_COMBAT_MOVEMENT(Local_252.f_40[iVar0], 1);
			BRAIN::SET_PED_DESIRED_MOVE_BLEND_RATIO(Local_252.f_40[iVar0], 0f);
			PED::SET_PED_KEEP_TASK(Local_252.f_40[iVar0], true);
			PED::SET_PED_ACCURACY(Local_252.f_40[iVar0], 20);
			PED::SET_PED_COMBAT_RANGE(Local_252.f_40[iVar0], 2);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_252.f_40[iVar0], 23, false);
			WEAPON::GIVE_WEAPON_TO_PED(Local_252.f_40[iVar0], joaat("weapon_sniperrifle"), 4294967295, true, true);
			ENTITY::SET_ENTITY_LOD_DIST(Local_252.f_40[iVar0], 1000);
			ENTITY::SET_ENTITY_HEALTH(Local_252.f_40[iVar0], true);
			PED::SET_PED_SEEING_RANGE(Local_252.f_40[iVar0], 1000f);
			if (!PED::IS_PED_INJURED(Local_252.f_40[iVar0]))
			{
				if (iVar0 == 0)
				{
					BRAIN::TASK_PATROL(Local_252.f_40[iVar0], "miss_Tower_01", 1, 0, 1);
				}
				else if (iVar0 == 1)
				{
					BRAIN::TASK_PATROL(Local_252.f_40[iVar0], "miss_Tower_02", 1, 0, 1);
				}
				else if (iVar0 == 2)
				{
					BRAIN::TASK_PATROL(Local_252.f_40[iVar0], "miss_Tower_03", 1, 0, 1);
				}
				else if (iVar0 == 3)
				{
					BRAIN::TASK_PATROL(Local_252.f_40[iVar0], "miss_Tower_04", 1, 0, 1);
				}
				else if (iVar0 == 4)
				{
					BRAIN::TASK_PATROL(Local_252.f_40[iVar0], "miss_Tower_05", 1, 0, 1);
				}
				else if (iVar0 == 5)
				{
					BRAIN::TASK_PATROL(Local_252.f_40[iVar0], "miss_Tower_06", 1, 0, 1);
				}
				else if (iVar0 == 6)
				{
					BRAIN::TASK_PATROL(Local_252.f_40[iVar0], "miss_Tower_07", 1, 0, 1);
				}
				else if (iVar0 == 7)
				{
					BRAIN::TASK_PATROL(Local_252.f_40[iVar0], "miss_Tower_08", 1, 0, 1);
				}
				else if (iVar0 == 9)
				{
					BRAIN::TASK_PATROL(Local_252.f_40[iVar0], "miss_Tower_10", 1, 0, 1);
				}
				else
				{
					BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(Local_252.f_40[iVar0], Local_252.f_2A[iVar0], 0, 0, 4294967295);
...
void func_67()//Position - 0x4785
{
	...
	if (!CAM::IS_SPHERE_VISIBLE(1823.845f, 2621.267f, 57f, 0.5f))
	{
		...
		{
			iLocal_264[0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_263[0], 6, joaat("s_m_m_prisguard_01"), 4294967295, 1, true);
	...
	if (!CAM::IS_SPHERE_VISIBLE(1761.418f, 2410.378f, 61f, 0.5f))
	{
		...
		{
			iLocal_264[1] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_263[1], 6, joaat("s_m_m_prisguard_01"), 4294967295, 1, true);
	...
	if (!CAM::IS_SPHERE_VISIBLE(1534.635f, 2585.162f, 61f, 0.5f))
	{
		...
		{
			iLocal_264[2] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_263[2], 6, joaat("s_m_m_prisguard_01"), 4294967295, 1, true);
...
void func_68()//Position - 0x4A39
{
	...
	while (iVar0 < 10)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(Local_252.f_40[iVar0]))
		{
			Local_252.f_40[iVar0] = PED::CREATE_PED(6, joaat("s_m_m_prisguard_01"), Local_252[iVar0 /*3*/], Local_252.f_1F[iVar0], 1, true);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("s_m_m_prisguard_01"));
			SYSTEM::WAIT(0);
		}
		iVar0++;
...
int func_70()//Position - 0x4C0A
{
	...
	while (iVar0 < 3)
	{
		while (!BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(Local_307.f_E[iVar0]))
		{
			SYSTEM::WAIT(0);
		}
		iVar0++;
...
int func_72()//Position - 0x4C5E
{
	...
	while (iVar0 < 10)
	{
		if (!BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED(Local_252.f_2A[iVar0]))
		{
			return 0;
		}
		iVar0++;
...
void func_75()//Position - 0x4D1D
{
	...
	while (iVar0 < 3)
	{
		BRAIN::REQUEST_WAYPOINT_RECORDING(Local_307.f_E[iVar0]);
		iVar0++;
	}
}
...
void func_77()//Position - 0x4DD8
{
	...
	while (iVar0 < 10)
	{
		BRAIN::REQUEST_WAYPOINT_RECORDING(Local_252.f_2A[iVar0]);
		iVar0++;
	}
...
void func_80()//Position - 0x4EF3
{
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_250, 2761840924);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, 2761840924, iLocal_250);
...
void func_82()//Position - 0x50CB
{
	...
	if (!iLocal_56)
	{
		if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1917.889f, 2618.476f, -45.677f, 1822.889f, 2618.476f, 45.677f, 195f, 0, false, 0))
			{
				if (PLAYER::HAS_PLAYER_DAMAGED_AT_LEAST_ONE_NON_ANIMAL_PED(CAM::_0xDC9DA9E8789F5246()))
				{
					PLAYER::SET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246(), 4, 0);
					HUD::_0x84698AB38D0C6636(CAM::_0xDC9DA9E8789F5246(), 0);
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, 4111159735);
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 4111159735, 1862763509);
					iLocal_56 = 1;
				}
				if ((MISC::IS_BULLET_IN_AREA(1874.072f, 2605.423f, 44.6723f, 100f, 1) && !PLAYER::HAS_PLAYER_DAMAGED_AT_LEAST_ONE_PED(CAM::_0xDC9DA9E8789F5246())) || (PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()) && !PLAYER::HAS_PLAYER_DAMAGED_AT_LEAST_ONE_NON_ANIMAL_PED(CAM::_0xDC9DA9E8789F5246())))
				{
					HUD::_0x84698AB38D0C6636(CAM::_0xDC9DA9E8789F5246(), 0);
...
void func_83(bool bParam0)//Position - 0x5294
{
	...
	if (iLocal_56)
	{
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, 1862763509, 4111159735);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, 4111159735, 1862763509);
	}
	iVar0 = 0;
	while (iVar0 < 12)
	{
...
void func_85()//Position - 0x53AE
{
	...
	while (iVar0 < 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_307.f_1B[iVar0]))
		{
			if (HUD::DOES_BLIP_EXIST(Local_307.f_24[iVar0]))
			{
				HUD::REMOVE_BLIP(&(Local_307.f_24[iVar0]));
			}
			if (ENTITY::IS_ENTITY_OCCLUDED(Local_307.f_1B[iVar0]))
			{
				PED::DELETE_PED(&(Local_307.f_1B[iVar0]));
			}
			else
			{
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(Local_307.f_1B[iVar0]));
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < 4)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_307.f_1F[iVar0]))
		{
			...
			if (ENTITY::IS_ENTITY_OCCLUDED(Local_307.f_1F[iVar0]))
			{
				PED::DELETE_PED(&(Local_307.f_1F[iVar0]));
			}
			else
			{
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(Local_307.f_1F[iVar0]));
			}
		}
		iVar0++;
	}
...
void func_88()//Position - 0x5505
{
	...
	while (iVar0 < 10)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_252.f_40[iVar0]))
		{
			if (HUD::DOES_BLIP_EXIST(Local_252.f_4B[iVar0]))
			{
				HUD::REMOVE_BLIP(&(Local_252.f_4B[iVar0]));
			}
			if (ENTITY::IS_ENTITY_OCCLUDED(Local_252.f_40[iVar0]))
			{
				PED::DELETE_PED(&(Local_252.f_40[iVar0]));
			}
			else
			{
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(Local_252.f_40[iVar0]));
			}
		}
		iVar0++;
	}
	...
	if (((ENTITY::DOES_ENTITY_EXIST(*iParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1)) && !ENTITY::IS_ENTITY_DEAD(*iParam0, 0)) && !ENTITY::IS_ENTITY_DEAD(*uParam1, 0))
	{
		if (ENTITY::IS_ENTITY_IN_AIR(*iParam0))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(*iParam0))
			{
				if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
				{
					BRAIN::TASK_PLANE_MISSION(*uParam1, *iParam0, 0, 0, unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 8, 50f, -1f, 30f, 100, 50, 1);
				}
			}
		}
	}
