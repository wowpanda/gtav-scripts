...
void func_8()
{
	...
	if (!Global_90064)
	{
		Global_90248 = CLOCK::GET_CLOCK_MONTH();
		Global_90247 = CLOCK::GET_CLOCK_DAY_OF_MONTH();
		Global_90246 = CLOCK::GET_CLOCK_HOURS();
		Global_90064 = 1;
		Global_90069 = CLOCK::GET_CLOCK_DAY_OF_WEEK();
		Global_90068 = CLOCK::GET_CLOCK_HOURS();
		func_12();
		return;
	}
