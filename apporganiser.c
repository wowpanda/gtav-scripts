...
void func_8()
{
	...
	if (!Global_90186)
	{
		Global_90370 = CLOCK::GET_CLOCK_MONTH();
		Global_90369 = CLOCK::GET_CLOCK_DAY_OF_MONTH();
		Global_90368 = CLOCK::GET_CLOCK_HOURS();
		Global_90186 = 1;
		Global_90191 = CLOCK::GET_CLOCK_DAY_OF_WEEK();
		Global_90190 = CLOCK::GET_CLOCK_HOURS();
		func_12();
		return;
	}
