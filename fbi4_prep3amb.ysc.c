...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_236(AUDIO::_0x0626A247D2405330()))
		{
			func_229();
			func_221();
			func_220();
...
bool func_18(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x937
{
...
int func_26(int iParam0)//Position - 0x11E7
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_28(int iParam0)//Position - 0x12C3
{
	int iVar0;
	int iVar1;
...
int func_29()//Position - 0x2FBE
{
	return 0;
}

int func_30()//Position - 0x2FC7
{
	return 1;
}

int func_31()//Position - 0x2FD0
{
	return 1;
}

int func_32()//Position - 0x2FD9
{
...
int func_34(int iParam0)//Position - 0x30AD
{
	int iVar0;
	char* sVar1;
...
int func_35(int iParam0)//Position - 0x30F3
{
	int iVar0;
...
int func_36(int iParam0)//Position - 0x312E
{
	int iVar0;
...
int func_37(int iParam0)//Position - 0x31AA
{
	int iVar0;
...
int func_38(int iParam0, int iParam1, bool bParam2)//Position - 0x3292
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_39(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3303
{
...
void func_41(var uParam0, int iParam1)//Position - 0x3420
{
	if (iParam1 <= 0)
	{
		return;
...
void func_42(var uParam0, int iParam1)//Position - 0x34A6
{
...
void func_43(var uParam0, int iParam1)//Position - 0x34D9
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0, int iParam1)//Position - 0x352A
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_47(var uParam0)//Position - 0x3608
{
	return uParam0 & 15;
}

void func_48(var uParam0, int iParam1)//Position - 0x3615
{
...
void func_49(var uParam0, int iParam1)//Position - 0x364F
{
...
void func_50(var uParam0, int iParam1)//Position - 0x368A
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_51(var uParam0, int iParam1)//Position - 0x36C6
{
	int iVar0;
	int iVar1;
...
int func_52(int iParam0, int iParam1)//Position - 0x4DBE
{
	struct<82> Var0;
...
void func_53(int iParam0, var uParam1, int iParam2)//Position - 0x4E00
{
	int iVar0;
...
bool func_54(int iParam0)//Position - 0x505C
{
	return iParam0 < 3;
}

void func_55(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0x5068
{
	if (func_51(&(Global_11188.f_22B[0 /*21*/]), iParam0))
	{
...
void func_56(int iParam0, bool bParam1)//Position - 0x5167
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_57(int iParam0, int iParam1, bool bParam2)//Position - 0x51C4
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_58(var uParam0, var uParam1)//Position - 0x51FF
{
...
void func_59(int iParam0)//Position - 0x52CB
{
	if (iParam0 == 4294967295)
	{
		return;
...
int func_60(int iParam0)//Position - 0x5345
{
	int iVar0;
...
void func_61(int iParam0, var uParam1)//Position - 0x53A8
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x5653
{
	switch (iParam0)
	{
		case 1:
...
int func_63(int iParam0, var uParam1, var uParam2)//Position - 0x5703
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x58F6
{
	switch (iParam0)
	{
		case joaat("GRANGER"):
...
void func_65(var uParam0)//Position - 0x5916
{
	int iVar0;
...
void func_66(int iParam0)//Position - 0x59C5
{
...
void func_67(bool bParam0)//Position - 0x59EC
{
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 14))
	{
...
void func_68(int iParam0)//Position - 0x5AD3
{
	int iVar0;
...
int func_69(int iParam0)//Position - 0x5AF3
{
	int iVar0;
	int iVar1;
...
int func_70(int iParam0)//Position - 0x5B30
{
	if (func_54(iParam0))
	{
...
bool func_71(int iParam0, int iParam1)//Position - 0x5B5A
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
int func_72(int iParam0)//Position - 0x5B7D
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
bool func_74(int iParam0, vector3 vParam1, float fParam2)//Position - 0x5BB5
{
	return SYSTEM::VDIST2(unk_0x8000C77B5F336760(iParam0, true), vParam1) <= (fParam2 * fParam2);
}

bool func_75(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x5BD2
{
	if (bParam2)
	{
...
void func_76(int iParam0, bool bParam1)//Position - 0x5C19
{
...
bool func_78(bool bParam0)//Position - 0x5C88
{
...
void func_79(char* sParam0, int iParam1)//Position - 0x5CB3
{
...
bool func_82(int iParam0)//Position - 0x5E50
{
	return Global_8D15 == iParam0;
}

int func_83(int iParam0)//Position - 0x5E5E
{
	if (func_84(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
int func_84(int iParam0)//Position - 0x5E88
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_85(int iParam0, int iParam1)//Position - 0x5EA9
{
...
void func_86(bool bParam0)//Position - 0x5EE6
{
	char* sVar0;
...
int func_87()//Position - 0x5F59
{
	func_81();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_88(char* sParam0)//Position - 0x5F72
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	CAM::_DISABLE_VEHICLE_FIRST_PERSON_CAM_THIS_FRAME();
}

void func_89(int iParam0, int iParam1)//Position - 0x5F84
{
...
void func_92(int iParam0, int iParam1, int iParam2)//Position - 0x605F
{
	bool bVar0;
...
int func_94()//Position - 0x6608
{
	return Global_6373;
}

int func_95(int iParam0, int iParam1)//Position - 0x6613
{
	int iVar0;
...
int func_96(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x6664
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_97()//Position - 0x6BCC
{
	return Global_1407E0;
}

int func_98()//Position - 0x6BD8
{
...
int func_101(int iParam0)//Position - 0x6C67
{
	if (iParam0 == 146 || iParam0 == 4294967295)
	{
		return 0;
...
int func_105(int iParam0, int iParam1)//Position - 0x6CF2
{
	int iVar0;
	int iVar1;
...
void func_106(int iParam0)//Position - 0x6D33
{
	Global_11729 = iParam0;
	Global_1172A = iParam0;
}

void func_107()//Position - 0x6D47
{
	struct<6> Var0;
...
void func_108(bool bParam0)//Position - 0x6EC0
{
	if (bParam0)
	{
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x6F31
{
	struct<15> Var0;
	int iVar1;
...
void func_110(int iParam0)//Position - 0x7082
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_111(int iParam0)//Position - 0x7146
{
	switch (iParam0)
	{
		case 0:
...
void func_112(int iParam0)//Position - 0x71B0
{
...
void func_114(struct<6> Param0)//Position - 0x7251
{
	if (iLocal_42 == 0)
	{
		func_119(Param0);
...
void func_115(struct<6> Param0)//Position - 0x7278
{
	if (func_99())
	{
		func_116(Param0, 1);
...
void func_116(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)//Position - 0x729C
{
	struct<4> Var0;
...
struct<4> func_117(bool bParam0)//Position - 0x730C
{
	struct<4> Var0;
...
struct<4> func_118(bool bParam0)//Position - 0x7376
{
	struct<4> Var0;
...
void func_119(struct<6> Param0)//Position - 0x73E0
{
	if (func_99())
	{
		if (func_120())
...
void func_122(bool bParam0)//Position - 0x7497
{
...
void func_123(char* sParam0, char* sParam1)//Position - 0x74AB
{
	if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
	{
		Global_3E07 = 1;
...
struct<6> func_124()//Position - 0x74CC
{
	struct<6> Var0;
...
void func_125()//Position - 0x74F0
{
	func_126();
}

void func_126()//Position - 0x74FC
{
	func_132();
	func_127();
}

void func_127()//Position - 0x750C
{
	if (func_131() == 38)
	{
...
bool func_128()//Position - 0x75A8
{
	return SCRIPT::IS_THREAD_ACTIVE(Global_19E56.f_469B.f_18B);
}

int func_129()//Position - 0x75BE
{
	if (func_12())
	{
		if (func_87() == 0)
...
int func_131()//Position - 0x761C
{
	return Global_1172B;
}

void func_132()//Position - 0x7628
{
...
void func_134()//Position - 0x76D3
{
	func_16();
	func_107();
}

void func_135()//Position - 0x76E3
{
	int iVar0;
...
int func_136(var uParam0)//Position - 0x774E
{
	char* sVar0;
...
int func_137()//Position - 0x7791
{
	if (func_139(&uLocal_80, Local_44.f_8, sLocal_79, Local_44.f_4, 9, 1, 0, 0, 0))
	{
		iLocal_40 = 1;
		func_138(192, unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true));
		return 1;
	}
	return 0;
}

void func_138(int iParam0, vector3 vParam1)//Position - 0x77CB
{
	int iVar0;
...
bool func_139(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x781A
{
...
int func_140(char* sParam0, int iParam1, bool bParam2)//Position - 0x7879
{
	Global_3DCF = 0;
...
bool func_147(int iParam0, int iParam1)//Position - 0x7DC2
{
	switch (iParam0)
	{
		case 5:
...
void func_149(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x7E54
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = uParam1;
...
void func_151(int iParam0, var uParam1)//Position - 0x7EC4
{
	int iVar0;
...
void func_152(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x803B
{
...
void func_153(int iParam0, int iParam1, bool bParam2)//Position - 0x80D6
{
	Global_BFD = iParam0;
	if (Global_75[iParam0 /*10*/].f_8 != 145)
	{
...
char* func_157(int iParam0)//Position - 0x9BAB
{
	char* sVar0;
...
int func_160(int iParam0)//Position - 0x9D6E
{
...
int func_161(int iParam0)//Position - 0x9D9E
{
	if (Global_4229 == 0)
	{
		return 0;
...
void func_163()//Position - 0x9E29
{
	if ((INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 0) && Global_8D15 == 15) && !func_194())
	{
		if (iLocal_38 == 0)
		{
			if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 1))
			{
				if (!func_74(AUDIO::_0x0626A247D2405330(), vLocal_50, 5f))
				{
					...
					{
						if ((func_236(AUDIO::_0x0626A247D2405330()) && !INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uLocal_47[0], 17)) && !INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(uLocal_47[1], 18))
						{
							if (PED::IS_PED_STOPPED(AUDIO::_0x0626A247D2405330()))
							{
								...
								if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 0))
								{
									if (!func_192() && func_172(unk_0x8000C77B5F336760(iLocal_51, true)))
									{
...
void func_165(int iParam0)//Position - 0xA12D
{
	if (func_167())
	{
		return;
...
void func_166(bool bParam0, bool bParam1)//Position - 0xA1A7
{
	if (bParam0)
	{
		if (func_14(0))
...
bool func_167()//Position - 0xA21B
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

int func_168(int iParam0)//Position - 0xA22D
{
	vector3 vVar0;
...
int func_169(int iParam0)//Position - 0xA2E2
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	if (iParam0 != 0)
	{
		if (func_83(iParam0))
		{
			...
			if (iVar0 == 2)
			{
				if (func_170(unk_0x8000C77B5F336760(iParam0, true)))
				{
					return 1;
				}
			}
...
int func_170(vector3 vParam0)//Position - 0xA397
{
	float fVar0;
	float fVar1;
	vector3 vVar2;
...
int func_171()//Position - 0xA3F3
{
	...
	while (iVar1 <= 4)
	{
		if (func_236(uVar0[iVar1]) && uVar0[iVar1] != AUDIO::_0x0626A247D2405330())
		{
			if (SYSTEM::VDIST2(vLocal_50, unk_0x8000C77B5F336760(uVar0[iVar1], true)) <= 16f)
			{
				return 1;
			}
		}
...
int func_172(vector3 vParam0)//Position - 0xA45C
{
...
int func_173(vector3 vParam0)//Position - 0xA4B5
{
...
int func_174(vector3 vParam0)//Position - 0xA4E8
{
	float fVar0;
...
int func_175(vector3 vParam0, bool bParam1)//Position - 0xA51D
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= (7 - 1))
	{
		if (Global_15992[iVar0 /*9*/].f_7 != 263)
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_15992[iVar0 /*9*/].f_3, true);
				if (fVar1 < fVar2)
				{
					fVar2 = fVar1;
					iVar3 = iVar0;
...
int func_176(vector3 vParam0)//Position - 0xA59A
{
	float fVar0;
...
int func_177(vector3 vParam0, bool bParam1)//Position - 0xA5CF
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_178(vector3 vParam0)//Position - 0xA64C
{
	vector3 vVar0;
	float fVar1;
...
int func_179(vector3 vParam0, vector3 vParam1)//Position - 0xA6D5
{
	float fVar0;
...
int func_180(vector3 vParam0)//Position - 0xA6F8
{
	if (!func_183(1))
	{
		if (!func_183(0))
...
int func_181(vector3 vParam0, int iParam1)//Position - 0xAD6B
{
	float fVar0;
...
Vector3 func_182(int iParam0)//Position - 0xAD93
{
	vector3 vVar0;
...
bool func_183(int iParam0)//Position - 0xB470
{
...
int func_185(var uParam0)//Position - 0xB5F9
{
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), uParam0->f_1, uParam0->f_4, uParam0->f_7, 0, true, 0))
	{
		return 1;
	}
	return 0;
...
int func_186(char* sParam0)//Position - 0xB624
{
	int iVar0;
...
int func_187(vector3 vParam0)//Position - 0xB670
{
	if (vParam0.z < -90f)
	{
		return 1;
...
int func_188()//Position - 0xB6FA
{
	int iVar0;
	float fVar1;
	
	iVar0 = func_190(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 145, 1);
	fVar1 = SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), Global_1592D[iVar0 /*10*/].f_3);
	if (fVar1 <= 10000f)
	{
		if (func_12())
		{
...
void func_189(int iParam0)//Position - 0xB74C
{
...
int func_190(vector3 vParam0, int iParam1, int iParam2)//Position - 0xB7A9
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_191(int iParam0)//Position - 0xB838
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_1C21[iParam0], 0);
}

int func_192()//Position - 0xB850
{
	if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 855.7258f, -2344.491f, 29.33145f) <= 52900f)
	{
		if (func_12())
		{
			func_68(28);
	...
	else if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 1383.21f, -2068.02f, 51.87057f) <= 160000f)
	{
		if (func_12())
		{
			func_68(29);
...
void func_193(int iParam0, int iParam1)//Position - 0xB8C8
{
	func_4(iParam0);
...
void func_195()//Position - 0xB93D
{
	int iVar0;
	int iVar1;
	
	if ((Global_8D15 == 15 && iLocal_38 == 0) && !func_194())
	{
		if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 0))
...
int func_196(int iParam0)//Position - 0xBC23
{
...
int func_197(int iParam0)//Position - 0xBC54
{
...
int func_199(int iParam0)//Position - 0xBCDC
{
...
int func_200(int iParam0)//Position - 0xBCFB
{
...
int func_201(int iParam0)//Position - 0xBD28
{
	int iVar0;
...
int func_202(int iParam0)//Position - 0xBD7C
{
	int iVar0;
...
int func_203(int iParam0)//Position - 0xBDC1
{
	int iVar0;
...
int func_205(int iParam0)//Position - 0xBE83
{
	if (DECORATOR::DECOR_EXIST_ON(iParam0, "GetawayVehicleValid"))
	{
		return 1;
...
int func_207(var uParam0)//Position - 0xBEE6
{
	int iVar0;
	int iVar1;
	int iVar2;
	
	if (func_236(AUDIO::_0x0626A247D2405330()) && PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
		iVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
		if (func_83(iVar0))
		{
...
void func_209()//Position - 0xC0AB
{
	int iVar0;
	int iVar1;
	
	if (((((((Global_8D15 == 15 && iLocal_37 != 3) && INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iLocal_49, 5)) && !func_194()) && Global_11622 == 4294967295) && !func_219()) && !func_82(9)) || func_101(35))
	{
		func_218();
		func_216();
		switch (iLocal_39)
	...
	else if (((((((Global_8D15 != 15 || Global_8D15 != 0) || Global_8D15 != 2) || Global_8D15 != 4) || Global_8D15 != 17) || func_194()) || Global_11622 == 4294967295) || Global_19AA5)
	{
		iVar1 = 0;
		if (func_128())
		{
...
void func_210(int iParam0, bool bParam1)//Position - 0xC23C
{
	switch (iLocal_39)
	{
		case 1:
...
void func_211(char* sParam0, int iParam1)//Position - 0xC34C
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_212()//Position - 0xC363
{
...
int func_213(int iParam0)//Position - 0xC37D
{
	int iVar0;
...
int func_214(int iParam0)//Position - 0xC3C7
{
	int iVar0;
...
void func_215(int iParam0, int iParam1)//Position - 0xC47E
{
	int iVar0;
...
bool func_217(char* sParam0, int iParam1, int iParam2)//Position - 0xC648
{
...
int func_227()//Position - 0xC9E6
{
	if (((((Global_8D15 == 15 && !func_194()) && Global_11622 == 4294967295) && !func_128()) && !func_228(1112014848)) && !Global_19AA5)
	{
		return 1;
	}
	return 0;
...
int func_228(float fParam0)//Position - 0xCA34
{
	if (iLocal_42 == 1)
	{
...
int func_231(int iParam0)//Position - 0xCB40
{
	return func_232(iParam0, 6, 1);
}

int func_232(int iParam0, int iParam1, bool bParam2)//Position - 0xCB50
{
	if (iParam0 == 4294967295)
	{
		return 0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_94() == 0)
		{
			return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(func_233(func_235(iParam0), 4294967295, 0), iParam1);
		}
	}
	else
	{
...
int func_233(int iParam0, int iParam1, int iParam2)//Position - 0xCBBA
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Global_26B05F[iParam0 /*3*/][func_234(iParam1)];
...
int func_234(var uParam0)//Position - 0xCBEC
{
	int iVar0;
	int iVar1;
...
int func_235(int iParam0)//Position - 0xCC20
{
	switch (iParam0)
	{
		case 0:
...
int func_236(int iParam0)//Position - 0xCF23
{
	if (func_84(iParam0))
	{
...
int func_237(int iParam0)//Position - 0xCF43
{
...
void func_238(int iParam0)//Position - 0xCF6F
{
	iLocal_42 = iParam0;
	if (iLocal_42 == 0)
	{
...
char* func_240(int iParam0)//Position - 0xD212
{
	char* sVar0;
...
struct<8> func_242(char* sParam0, vector3 vParam1, vector3 vParam2, float fParam3)//Position - 0xE712
{
	struct<8> Var0;
...
void func_243(int iParam0, bool bParam1)//Position - 0xE73D
{
	if (func_83(iLocal_51))
	{
		func_19(&iLocal_51);
...
int func_244(int iParam0)//Position - 0xE765
{
	int iVar0;
	int iVar1;
...
void func_245(bool bParam0)//Position - 0xE7BF
{
	char* sVar0;
...
float func_255(int iParam0)//Position - 0xE97F
{
	if (iParam0 == 4294967295)
	{
		return 0f;
...
Vector3 func_256(int iParam0)//Position - 0xE9B5
{
	if (iParam0 == 4294967295)
	{
		return 0f, 0f, 0f;
...
int func_257(int iParam0)//Position - 0xE9EF
{
	int iVar0;
	int iVar1;
