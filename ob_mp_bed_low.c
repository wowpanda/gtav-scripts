...
void __EntryFunction__()
{
	...
	if ((HAS_FORCE_CLEANUP_OCCURRED(16) || func_79()) || Global_2528542.f_1843)
	{
		func_78();
	}
	...
	{
		WAIT(0);
		if ((!IS_PED_INJURED(PLAYER_PED_ID()) && (!IS_PLAYER_SWITCH_IN_PROGRESS() || func_69() == 5)) && !func_57())
		{
			if (GET_DISTANCE_BETWEEN_COORDS(vLocal_343, GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 1) < 3f)
			{
				switch (iLocal_325)
				{
					case 0:
			...
			else if (GET_DISTANCE_BETWEEN_COORDS(vLocal_343, GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 1) > (3f + 2f))
			{
				func_78();
			}
		}
...
void func_1()
{
	...
	switch (iLocal_326)
	{
		case 0:
			...
			if (func_69() == 5)
			{
				uLocal_330 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_347, vLocal_350, 2, 0, 1, 1065353216, 0, 1065353216);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_330, sLocal_333, sLocal_335, 8f, -2f, 261, 0, 1148846080, 0);
				NETWORK_START_SYNCHRONISED_SCENE(uLocal_330);
				iLocal_326 = 7;
			}
			else if (func_50(8))
			{
				if ((((func_46(vLocal_343, vVar0) && GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()) == GET_INTERIOR_AT_COORDS(vLocal_343)) && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_337, vLocal_340, 2f, 0, 1, 0)) && func_45()) && !func_42(PLAYER_ID()))
				{
					if (iLocal_332 == -1)
					{
		...
		case 1:
			if (func_40(1, 0, 1))
			{
				if (((((func_46(vLocal_343, vVar0) && func_50(8)) && GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()) == GET_INTERIOR_AT_COORDS(vLocal_343)) && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_337, vLocal_340, 2f, 0, 1, 0)) && func_45()) && !func_42(PLAYER_ID()))
				{
					if (func_38(iLocal_332, 1))
					{
						...
						CLEAR_AREA_OF_PROJECTILES(vLocal_343, 3f, 0);
						func_27(PLAYER_ID(), 0, 256, 0);
						iLocal_36 = 1;
						func_26();
						SET_CURRENT_PED_WEAPON(PLAYER_PED_ID(), joaat("weapon_unarmed"), 1);
						func_16(1, 1, 1, 0, 0, 0);
						vLocal_343 = { GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_333, sLocal_334, vLocal_347, vLocal_350, 0, 2) };
						vVar3 = { GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_333, sLocal_334, vLocal_347, vLocal_350, 0, 2) };
						fLocal_346 = vVar3.z;
						TASK_GO_STRAIGHT_TO_COORD(PLAYER_PED_ID(), vLocal_343, 1f, 5000, fLocal_346, 0.05f);
						if (GET_FOLLOW_PED_CAM_VIEW_MODE() == 4)
						{
							SET_PED_DESIRED_HEADING(PLAYER_PED_ID(), func_15(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(uLocal_41, 1)));
		...
		case 2:
			...
			{
				uLocal_330 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_347, vLocal_350, 2, 0, 0, 1065353216, 0, 1065353216);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_330, sLocal_333, sLocal_334, 4f, -2f, 261, 0, 1148846080, 0);
				NETWORK_START_SYNCHRONISED_SCENE(uLocal_330);
				iLocal_326 = 3;
			}
			break;
		...
		case 3:
			...
			func_11(1);
			HIDE_HUD_AND_RADAR_THIS_FRAME();
			uLocal_331 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uLocal_330);
		...
		case 4:
			...
			func_11(1);
			HIDE_HUD_AND_RADAR_THIS_FRAME();
			if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_331) > 0.9f)
			{
				uLocal_330 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_347, vLocal_350, 2, 0, 1, 1065353216, 0, 1065353216);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_330, sLocal_333, sLocal_335, 8f, -2f, 261, 0, 1148846080, 0);
				NETWORK_START_SYNCHRONISED_SCENE(uLocal_330);
		...
		case 6:
			...
			if (!func_42(PLAYER_ID()) && IS_CONTROL_JUST_PRESSED(2, 222))
			{
				if (func_34("SA_BED_OUT"))
				{
					CLEAR_HELP(1);
				...
				func_8();
				uLocal_330 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_347, vLocal_350, 2, 0, 0, 1065353216, 0, 1065353216);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_330, sLocal_333, sLocal_336, 2f, -2f, 261, 0, 1148846080, 0);
				NETWORK_START_SYNCHRONISED_SCENE(uLocal_330);
				iLocal_326 = 8;
			}
			break;
		...
		case 7:
			if (((IS_INTERIOR_READY(GET_INTERIOR_AT_COORDS(vLocal_343)) && !func_7()) && !func_5()) && Global_1312467.f_8 == 0)
			{
				bLocal_328 = true;
				uLocal_330 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_347, vLocal_350, 2, 0, 0, 1065353216, 0, 1065353216);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_330, sLocal_333, sLocal_336, 1000f, -2f, 261, 0, 1148846080, 0);
				NETWORK_START_SYNCHRONISED_SCENE(uLocal_330);
				iLocal_326 = 8;
			}
			break;
...
var func_15(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)
{
...
void func_16(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_21(PLAYER_ID())) && !func_18(PLAYER_ID(), 0)) && !func_17()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_21(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
	...
	else
	{
		...
		if (NETWORK_IS_PLAYER_ACTIVE(iParam0) && (IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_18(PLAYER_ID(), 0) && !func_22()))
				{
...
{
	return IS_BIT_SET(Global_1371947.f_241.f_136[func_44(9) /*33*/][iParam0], func_43(9));
}
...
int func_45()
{
	...
	if (iVar9 > 0)
	{
		...
		while (iVar10 <= 7)
		{
			...
			{
				if (IS_ENTITY_IN_ANGLED_AREA(uVar0[iVar10], vLocal_337, vLocal_340, 2f, 0, 1, 0))
				{
					return 0;
				}
			}
...
int func_46(vector3 vParam0, float fParam3, var uParam4, var uParam5)
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if ((!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !IS_ENTITY_ON_FIRE(PLAYER_PED_ID())) && IS_PLAYER_CONTROL_ON(PLAYER_ID()))
		{
			...
			{
				if ((((IS_GAMEPLAY_CAM_RENDERING() && !IS_CUTSCENE_PLAYING()) && !IS_CINEMATIC_CAM_RENDERING()) && !func_39(0)) && !func_49())
				{
...
{
	if ((((((IS_BIT_SET(Global_1573336, iParam0) || Global_1573337 != -1) || func_55()) || IS_PLAYER_FREE_AIMING(PLAYER_ID())) || IS_PLAYER_TARGETTING_ANYTHING(PLAYER_ID())) || func_54()) || func_51(iParam0))
	{
		return 0;
	}
	return 1;
...
int func_56()
{
	REQUEST_ANIM_DICT(sLocal_333);
	if (!HAS_ANIM_DICT_LOADED(sLocal_333))
	{
		return 0;
	}
	iLocal_327 = 1;
...
int func_57()
{
	...
	if (func_58() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_58()) == 0)
		{
			return 1;
		}
	}
...
void func_78()
{
	...
	if (iLocal_327)
	{
		REMOVE_ANIM_DICT(sLocal_333);
	}
	if (iLocal_36 && !func_21(PLAYER_ID()))
	{
		func_27(PLAYER_ID(), 1, 0, 0);
	}
	func_8();
