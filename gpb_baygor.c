...
void __EntryFunction__()
{
	...
	if (MISC::GET_GAME_TIMER() < Global_25494 + 10000 && !func_103())
	{
		func_110(0);
	}
	...
	while (iVar0 == 1)
	{
		...
		{
			if (!func_86() && SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("director_mode")) == 0)
			{
				if (func_105())
				{
				}
		...
		switch (iLocal_216)
		{
			...
			case 5:
				...
				{
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_208, vLocal_210, 1f, -1, 1f, 1024, ScriptParam_333.f_17[0]);
					iLocal_216 = 6;
				}
				break;
			...
			case 8:
				...
				else if (iLocal_269 == 1)
				{
					...
					{
						func_50(Global_104500[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_208, &Local_253, &Local_252));
					}
				}
				break;
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_266))
				{
					if (bLocal_330)
					{
						Global_104500[iLocal_217] = uLocal_329;
					}
					else
					{
	...
	while (true)
	{
		...
		if ((ENTITY::IS_ENTITY_OCCLUDED(iLocal_208) && func_81(iLocal_208, PLAYER::PLAYER_PED_ID(), 1) > 50f) && !TASK::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			func_110(1);
		}
		SYSTEM::WAIT(0);
...
void func_52()
{
	...
	func_55(Global_104500[iLocal_217] + 1, &sVar0, &Var1);
	...
	PED::_0x2208438012482A1A(iLocal_208, 0, 0);
	func_53(Global_104500[iLocal_217]);
}
...
int func_82(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_84(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
void func_94(int iParam0)
{
	...
	func_97(&(Global_104555.f_20087), iParam0);
...
void func_101()
{
	iLocal_277 = OBJECT::CREATE_OBJECT(joaat("prop_cs_pamphlet_01"), ENTITY::GET_ENTITY_COORDS(iLocal_208, 1), true, true, false);
...
{
	return func_108(Global_104555.f_20087, uParam0);
}
