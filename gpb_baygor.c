...
void __EntryFunction__()
{
	...
	if (MISC::GET_GAME_TIMER() < Global_25538 + 10000 && !func_103())
	{
		func_110(0);
	}
		...
		switch (iLocal_216)
		{
			...
			case 8:
				...
				else if (iLocal_269 == 1)
				{
					...
					{
						func_50(Global_105165[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_208, &Local_253, &Local_252));
					}
				}
				break;
			...
			case 9:
				...
				if (!bVar37 && (!bVar36 || bLocal_266))
				{
					if (bLocal_330)
					{
						Global_105165[iLocal_217] = uLocal_329;
					}
					else
					{
...
void func_52()
{
	...
	func_55(Global_105165[iLocal_217] + 1, &sVar0, &Var1);
	...
	PED::_0x2208438012482A1A(iLocal_208, 0, 0);
	func_53(Global_105165[iLocal_217]);
}
...
void func_94(int iParam0)
{
	...
	func_97(&(Global_105220.f_20088), iParam0);
...
{
	return func_108(Global_105220.f_20088, uParam0);
}
