...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		{
			if (NETWORK::_0x3B39236746714134(CAM::_0xDC9DA9E8789F5246()) == 32)
			{
				if (ScriptParam_98.f_10 != (50 + CAM::_0xDC9DA9E8789F5246()))
				{
					func_35(2);
				}
			}
			else if (ScriptParam_98.f_10 != NETWORK::_0x3B39236746714134(CAM::_0xDC9DA9E8789F5246()))
			{
				func_35(2);
			}
		}
		...
		switch (func_33(NETSHOP::_NETWORK_SHOP_BASKET_START()))
		{
			case 0:
				if (Global_440000 == 2)
				{
				...
				if ((!Global_7C9F && func_32() != 4294967295) && func_32() != 999)
				{
					if (!iLocal_63)
					{
		...
		if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		{
			switch (func_26())
			{
				...
				case 2:
					if (func_33(NETSHOP::_NETWORK_SHOP_BASKET_START()) == 1)
					{
						func_1();
					}
					break;
...
void func_1()//Position - 0x22D
{
	...
	while (iLocal_71 < 6)
	{
		...
		{
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_96[iLocal_70 /*4*/].f_2, iLocal_71))
			{
				MISC::SET_BIT(&(Local_73.f_2[iLocal_71]), iLocal_70);
			}
			else
			{
				GRAPHICS::_0x35FB78DC42B7BD21(&(Local_73.f_2[iLocal_71]), iLocal_70);
			}
		}
		else
		{
			GRAPHICS::_0x35FB78DC42B7BD21(&(Local_73.f_9[iLocal_71]), iLocal_70);
			GRAPHICS::_0x35FB78DC42B7BD21(&(Local_73.f_9[iLocal_71]), iLocal_70);
		}
...
void func_2(int iParam0, int iParam1, int iParam2)//Position - 0x384
{
	...
	{
		if (OBJECT::_0x4BC2854478F3A749(iParam1) == 4294967295)
		{
...
void func_9()//Position - 0x570
{
	...
	vVar1 = { func_13(CAM::_0xDC9DA9E8789F5246()) };
	fVar0 = SYSTEM::VDIST(vVar1, Local_69[iLocal_72 /*17*/].f_3);
	if ((INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_26A741, iLocal_72) || INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_26A741.f_1, iLocal_72)) || INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_26A741.f_2, iLocal_72))
	{
		if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_26A741, iLocal_72))
		{
			MISC::SET_BIT(&(Local_96[CAM::_0xDC9DA9E8789F5246() /*4*/].f_2), iLocal_72);
		}
		if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_26A741.f_1, iLocal_72))
		{
			GRAPHICS::_0x35FB78DC42B7BD21(&(Local_96[CAM::_0xDC9DA9E8789F5246() /*4*/].f_2), iLocal_72);
		}
		if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_26A741.f_2, iLocal_72))
		{
			MISC::SET_BIT(&(Local_96[CAM::_0xDC9DA9E8789F5246() /*4*/].f_3), iLocal_72);
		}
	}
	else if (fVar0 <= 20f)
	{
		...
		{
			if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_96[CAM::_0xDC9DA9E8789F5246() /*4*/].f_2, iLocal_72))
			{
				MISC::SET_BIT(&(Local_96[CAM::_0xDC9DA9E8789F5246() /*4*/].f_2), iLocal_72);
			}
		}
		if ((iLocal_72 == 0 || iLocal_72 == 1) || iLocal_72 == 5)
		{
			if (Global_2587D8)
			{
				if (OBJECT::IS_POINT_IN_ANGLED_AREA(vVar1, Local_69[iLocal_72 /*17*/].f_A, Local_69[iLocal_72 /*17*/].f_D, Local_69[iLocal_72 /*17*/].f_10, 0, 1))
				{
					if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_96[CAM::_0xDC9DA9E8789F5246() /*4*/].f_2, iLocal_72))
					{
						MISC::SET_BIT(&(Local_96[CAM::_0xDC9DA9E8789F5246() /*4*/].f_2), iLocal_72);
		...
		if ((iLocal_72 == 2 || iLocal_72 == 3) || iLocal_72 == 4)
		{
			if (func_11() >= 0)
			{
				...
				else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_96[CAM::_0xDC9DA9E8789F5246() /*4*/].f_2, iLocal_72) && !OBJECT::IS_POINT_IN_ANGLED_AREA(vVar1, Local_69[iLocal_72 /*17*/].f_3, Local_69[iLocal_72 /*17*/].f_6, Local_69[iLocal_72 /*17*/].f_9, 0, 1))
				{
					GRAPHICS::_0x35FB78DC42B7BD21(&(Local_96[CAM::_0xDC9DA9E8789F5246() /*4*/].f_2), iLocal_72);
				}
			}
	...
	else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Local_96[CAM::_0xDC9DA9E8789F5246() /*4*/].f_2, iLocal_72))
	{
		GRAPHICS::_0x35FB78DC42B7BD21(&(Local_96[CAM::_0xDC9DA9E8789F5246() /*4*/].f_2), iLocal_72);
	}
	iLocal_72++;
...
{
	if (Global_200000[func_12() /*12745*/].f_1FF2.f_2 >= 261)
	{
		Global_200000[func_12() /*12745*/].f_1FF2.f_2 = 4294967295;
		return 4294967295;
	}
	return Global_200000[func_12() /*12745*/].f_1FF2.f_2;
}

int func_12()//Position - 0x83E
{
	int iVar0;
...
Vector3 func_13(int iParam0)//Position - 0x84B
{
...
void func_14()//Position - 0x85E
{
	...
	{
		func_22(iVar0, &Var3);
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_13(CAM::_0xDC9DA9E8789F5246()), Var3.f_1, 1) < 150f)
		{
			bVar2 = false;
			iVar1 = 0;
			while (iVar1 < 32)
			{
				...
				if (func_7(iVar4, 1, 1))
				{
					if (func_15(iVar4) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::GET_PLAYER_PED(iVar4), Var3.f_4[0 /*3*/], Var3.f_4[1 /*3*/], Var3.f_B, 0, 1, 0))
					{
						bVar2 = true;
						iVar1 = 32;
					}
...
int func_15(int iParam0)//Position - 0x9BC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_16()//Position - 0xA40
{
	return 4294967295;
}

int func_17(int iParam0)//Position - 0xA49
{
	if (iParam0 != func_16())
	{
...
bool func_18(int iParam0, bool bParam1)//Position - 0xA6C
{
	if (!bParam1)
	{
		if (func_19(iParam0))
	...
	return Global_18CD5B[iParam0 /*560*/].f_B != func_16();
}

int func_19(int iParam0)//Position - 0xA97
{
	if (iParam0 != func_16())
	{
		if (Global_18CD5B[iParam0 /*560*/].f_B != func_16())
		{
...
int func_20(int iParam0)//Position - 0xACC
{
	if (iParam0 != func_16())
	{
...
int func_21(int iParam0)//Position - 0xAEF
{
	if (iParam0 != func_16())
	{
...
void func_22(int iParam0, var uParam1)//Position - 0xB14
{
	switch (iParam0)
	{
		case 0:
...
int func_26()//Position - 0xD37
{
	return Local_73;
}

int func_27(int iParam0, int iParam1)//Position - 0xD41
{
	struct<15> Var0;
	int iVar1;
...
struct<15> func_28(int iParam0, int iParam1)//Position - 0xDAE
{
	struct<15> Var0;
...
int func_29(int iParam0, int iParam1)//Position - 0x5596
{
	struct<15> Var0;
	int iVar1;
...
void func_30(struct<15> Param0, int iParam1)//Position - 0x5602
{
	if (Param0 != 0)
	{
		...
		if (Param0.f_C != 0f)
		{
			OBJECT::_SET_DOOR_AJAR_ANGLE(Param0, Param0.f_C, 0, iParam1);
		}
		if (!Param0.f_6)
		{
			if (Param0.f_7)
		...
		if (Param0.f_E != 0f)
		{
			OBJECT::_0x03C27E13B42A0E82(Param0, Param0.f_E, iParam1, 0);
		}
		if (Param0.f_D != 0f)
		{
			OBJECT::_0x9BA001CB45CBF627(Param0, Param0.f_D, iParam1, 0);
		}
	}
}

int func_31(int iParam0, int iParam1)//Position - 0x56A1
{
	struct<15> Var0;
	int iVar1;
...
int func_32()//Position - 0x5713
{
	return Global_6373;
}

int func_33(int iParam0)//Position - 0x571E
{
	return Local_96[iParam0 /*4*/];
}

void func_34(var uParam0, bool bParam1, bool bParam2)//Position - 0x572C
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
	{
		if (!bParam2)
...
void func_35(int iParam0)//Position - 0x5769
{
	Local_96[NETSHOP::_NETWORK_SHOP_BASKET_START() /*4*/] = iParam0;
}

int func_36()//Position - 0x577B
{
	var uVar0;
...
bool func_38()//Position - 0x5839
{
	return Global_255C02.f_24B;
}

int func_39(int iParam0)//Position - 0x5848
{
...
bool func_40()//Position - 0x585F
{
	return Global_25824F;
}

bool func_41()//Position - 0x586B
{
	return Global_255C02.f_246;
}

void func_42(var uParam0)//Position - 0x587A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_43(int iParam0)//Position - 0x58ED
{
	vector3 vVar0;
	int iVar1;
	int iVar2;
...
int func_44(int iParam0, var uParam1)//Position - 0x596E
{
...
void func_45()//Position - 0x59CD
{
	SYSTEM::WAIT(0);
}

void func_46()//Position - 0x59DA
{
	int iVar0;
...
void func_47(int iParam0, var uParam1)//Position - 0x5A00
{
	switch (iParam0)
	{
		case 0:
...
void func_48()//Position - 0x5C6A
{
	func_50(iLocal_67);
	Global_26862F.f_65E = 0;
	Global_26862F.f_118A = 0;
	func_49();
}

void func_49()//Position - 0x5C8C
{
	HUD::DISPLAY_SNIPER_SCOPE_THIS_FRAME();
}

void func_50(int iParam0)//Position - 0x5C98
{
	struct<15> Var0;
	int iVar1;
...
int func_51(struct<21> Param0)//Position - 0x5CEE
{
	func_55(func_56(Param0), Param0);
	func_53(0, 4294967295, 0);
...
int func_53(int iParam0, int iParam1, bool bParam2)//Position - 0x5D8B
{
	int iVar0;
...
bool func_54()//Position - 0x5EA0
{
	return Global_140842;
}

void func_55(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x5EAC
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_49();
...
int func_56(int iParam0)//Position - 0x5ECB
{
	switch (iParam0)
	{
		case 3:
