...
void __EntryFunction__()//Position - 0x0
{
	...
	if (!func_324())
	{
		if ((func_311(Local_80.f_1C[0]) && func_311(AUDIO::_0x0626A247D2405330())) && !func_310(AUDIO::_0x0626A247D2405330(), Local_80.f_1C[0], 4f, 1))
		{
			iLocal_305 = 1;
		}
	}
	while (true)
	{
		...
		{
			if (func_311(AUDIO::_0x0626A247D2405330()) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, 0, true, 0))
			{
				if (func_311(Local_91))
				{
					if (func_310(AUDIO::_0x0626A247D2405330(), Local_91, 10f, 1))
					{
						func_291();
					}
				}
	...
	switch (iLocal_85)
	{
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_102))
			{
				...
				{
					if (func_310(AUDIO::_0x0626A247D2405330(), iLocal_102, 1f, 1))
					{
			...
			if (func_311(AUDIO::_0x0626A247D2405330()))
			{
				if (iLocal_297 == 0)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1624.015f, -5.45107f, 102.0677f, 1639.007f, -52.9875f, 181.3352f, 58.75f, 0, true, 0) && PED::GET_PED_PARACHUTE_STATE(AUDIO::_0x0626A247D2405330()) == 2)
					{
						iLocal_297 = 1;
					}
				}
		...
		case 2:
			if (((!PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330()) && !PED::IS_PED_IN_PARACHUTE_FREE_FALL(AUDIO::_0x0626A247D2405330())) && ENTITY::GET_ENTITY_HEIGHT_ABOVE_GROUND(AUDIO::_0x0626A247D2405330()) < 2f) && !PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()))
			{
...
int func_18()//Position - 0x12E9
{
	return Global_1407E0;
}

void func_19()//Position - 0x12F5
{
	func_36();
	func_28();
	func_24();
...
void func_20(int iParam0)//Position - 0x134E
{
	if (iParam0 == 1)
	{
...
void func_22()//Position - 0x1395
{
	StringCopy(&Global_1170D, "", 16);
	StringCopy(&Global_11711, "", 16);
}

void func_23()//Position - 0x13AF
{
	int iVar0;
...
void func_27(int iParam0)//Position - 0x1481
{
	if (iParam0 == 1)
	{
		Global_8F3A = 1;
...
void func_28()//Position - 0x149A
{
	func_29(&Global_18531);
}

void func_29(var uParam0)//Position - 0x14AA
{
	int iVar0;
	int iVar1;
...
void func_30(var uParam0)//Position - 0x1A3A
{
	*uParam0 = 4294967295;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_31(var uParam0)//Position - 0x1A55
{
	func_32(&(uParam0->f_C));
	*uParam0 = { 0f, 0f, 0f };
...
void func_32(var uParam0)//Position - 0x1A84
{
	int iVar0;
...
void func_33(var uParam0)//Position - 0x1B34
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_34(var uParam0)//Position - 0x1B52
{
	int iVar0;
...
void func_35(var uParam0)//Position - 0x1C32
{
	*uParam0 = 4294967281;
}

void func_36()//Position - 0x1C40
{
	StringCopy(&Global_17990, "", 32);
	func_29(&Global_17998);
}

void func_37()//Position - 0x1C59
{
...
int func_39(int iParam0, int iParam1, int iParam2)//Position - 0x1D97
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_40(int iParam0, int iParam1, int iParam2)//Position - 0x1F56
{
	int iVar0;
...
int func_41(int iParam0)//Position - 0x1FE2
{
	switch (iParam0)
	{
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x201D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_43(int iParam0, int iParam1, int iParam2)//Position - 0x2833
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0, int iParam1, int iParam2)//Position - 0x28BD
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_45(int iParam0, int iParam1, int iParam2)//Position - 0x299B
{
...
int func_46(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x29C6
{
	var uVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1, int iParam2)//Position - 0x2FCA
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x3063
{
	int iVar0;
	int iVar1;
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3104
{
	int iVar0;
...
int func_50(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x340B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_51(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x3FBE
{
	int iVar0;
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x42A3
{
	int iVar0;
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x456A
{
	int iVar0;
	int iVar1;
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x45A1
{
	int iVar0;
...
int func_55(int iParam0, int iParam1, int iParam2)//Position - 0x45CA
{
	*iParam2 = 4294967197;
	switch (iParam0)
	{
...
int func_56(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4894
{
	int iVar0;
...
int func_57(int iParam0, int iParam1, int iParam2)//Position - 0x4B1E
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4C75
{
	int iVar0;
...
int func_59(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4D0D
{
	switch (iParam0)
	{
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4DDB
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_61(int iParam0, int iParam1)//Position - 0x4F37
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_62(int iParam0)//Position - 0x52DE
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_63(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x533F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_64(int iParam0, int iParam1)//Position - 0x543B
{
	int iVar0;
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5579
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_66(int iParam0)//Position - 0x5659
{
	switch (iParam0)
	{
		case 0:
...
int func_67(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x56DF
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_68(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x595C
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_69(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5D81
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_70(int iParam0, int iParam1)//Position - 0x6074
{
	int iVar0;
	int iVar1;
...
int func_71(int iParam0, int iParam1)//Position - 0x60BA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_72(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x611A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_73(int iParam0)//Position - 0x619E
{
...
void func_74(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x6256
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_75(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x62A0
{
	int iVar0;
...
int func_76(var uParam0)//Position - 0x62D0
{
	int iVar0;
	int iVar1;
...
int func_77(int iParam0, int iParam1, int iParam2)//Position - 0x6304
{
	int iVar0;
	var uVar1;
...
bool func_78(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x6336
{
	int iVar0;
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x7DEF
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_80(int iParam0)//Position - 0x8D0E
{
	if (!INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_11569[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8D5F
{
	int iVar0;
...
int func_82(int iParam0)//Position - 0x8DF5
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_83(int iParam0, int iParam1)//Position - 0x8EA5
{
	int iVar0;
	struct<10> Var1;
...
void func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x97D4
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar2;
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x98FE
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_86(int iParam0, int iParam1)//Position - 0x9946
{
	int iVar0;
	struct<17> Var1;
...
void func_87(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB78E
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar2;
...
int func_88(int iParam0)//Position - 0xB978
{
	switch (iParam0)
	{
		case 0:
...
void func_89(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xBA28
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_90(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBA99
{
	func_154();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_91(int iParam0, int iParam1)//Position - 0xBAEB
{
	switch (iParam0)
	{
		case 0:
...
void func_92(int iParam0)//Position - 0xBBDB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_93(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xCE17
{
	int iVar0;
	int iVar1;
...
bool func_94(int iParam0, int iParam1, var uParam2)//Position - 0xD1A7
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_95(int iParam0, int iParam1)//Position - 0xD5AC
{
	switch (iParam1)
	{
		case 0:
...
int func_96(int iParam0, int iParam1)//Position - 0xD9A7
{
	switch (iParam1)
	{
		case 0:
...
int func_97(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xDDA2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_98(int iParam0)//Position - 0xDDE4
{
	return Global_8D15 == iParam0;
}

int func_99(int iParam0)//Position - 0xDDF2
{
	switch (iParam0)
	{
		case 4294967295:
...
void func_100(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDEC6
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
void func_101(int iParam0)//Position - 0xE19E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_102(int iParam0)//Position - 0xE2EB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_103(int iParam0)//Position - 0xE7F8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_104(int iParam0)//Position - 0xE86C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_105(int iParam0)//Position - 0xE8DF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_106(int iParam0)//Position - 0xE9C6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_107(int iParam0)//Position - 0xED08
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0xEF10
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0)//Position - 0xF130
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0)//Position - 0xF239
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0)//Position - 0xFBCB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0x10724
{
	if (iParam0 < 136)
	{
		func_114(iParam0);
...
void func_113(int iParam0)//Position - 0x10759
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x1135D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0x1225D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x1238A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0, int iParam1)//Position - 0x12481
{
	switch (iParam0)
	{
		case 0:
...
void func_118(int iParam0)//Position - 0x12571
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0x13A3E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0x13B85
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0x14090
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0x146F9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0x1476C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0x1483C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0x14D37
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x14EC8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0x156B7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x157C0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0x166E3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x17390
{
	if (iParam0 < 107)
	{
		func_133(iParam0);
...
void func_131(int iParam0)//Position - 0x173D6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x17E7A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x18DC7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x19A06
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x19C7E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0, int iParam1)//Position - 0x19DBA
{
	switch (iParam0)
	{
		case 0:
...
void func_137(int iParam0)//Position - 0x19EAA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x1AC08
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x1AD77
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x1B2E8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x1B810
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x1B883
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x1B953
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x1BE03
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x1C05F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x1C31F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x1C4DA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x1D020
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x1DC52
{
	if (iParam0 < 60)
	{
		func_151(iParam0);
...
void func_150(int iParam0)//Position - 0x1DC87
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1EA1A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x1F09C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x1F182
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154()//Position - 0x1F279
{
...
int func_155(int iParam0, int iParam1, int iParam2)//Position - 0x1F2F1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_156(int iParam0)//Position - 0x1F54C
{
	int iVar0;
	int iVar1;
...
int func_157(int iParam0)//Position - 0x1F589
{
	if (func_158(iParam0))
	{
...
bool func_158(int iParam0)//Position - 0x1F5B3
{
	return iParam0 < 3;
}

void func_159(char* sParam0, int iParam1)//Position - 0x1F5BF
{
...
void func_161()//Position - 0x1F65F
{
	int iVar0;
...
struct<2> func_162(int iParam0)//Position - 0x1F75C
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_163(int iParam0)//Position - 0x1F793
{
	struct<2> Var0;
...
void func_164(int iParam0, int iParam1)//Position - 0x1FBDF
{
...
void func_165(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1FC29
{
...
void func_166(int iParam0, int iParam1, int iParam2)//Position - 0x1FCC6
{
	struct<4> Var0;
	char* sVar1;
...
void func_167(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x1FD05
{
...
void func_168(int iParam0, var uParam1)//Position - 0x1FD49
{
	switch (iParam0)
	{
		case 0:
...
int func_170(int iParam0)//Position - 0x20F91
{
	switch (iParam0)
	{
		case 0:
...
void func_171(int iParam0)//Position - 0x212D7
{
	Global_8F3C = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_172()//Position - 0x212E9
{
	if (Global_1620F)
	{
		func_161();
...
char* func_173(var uParam0)//Position - 0x2131B
{
	uParam0 = uParam0;
	return "";
}

void func_174()//Position - 0x2132A
{
	vector3 vVar0[24];
...
void func_175(int iParam0, int iParam1)//Position - 0x2136D
{
	Global_1620A = iParam0;
	Global_1620B = iParam1;
}

void func_176()//Position - 0x21381
{
	if (Global_11723 != 6)
	{
	}
...
void func_177(var uParam0)//Position - 0x213B9
{
...
void func_178(int iParam0, bool bParam1)//Position - 0x213F6
{
	struct<26> Var0;
	int iVar1;
	bool bVar2;
...
int func_179(int iParam0)//Position - 0x2157C
{
	switch (iParam0)
	{
		case 0:
...
void func_180(int iParam0)//Position - 0x21903
{
	func_182(iParam0, 1);
...
int func_181()//Position - 0x21939
{
	return (Global_19E56.f_2704.f_15 + Global_19E56.f_4872.f_17C);
}

void func_182(var uParam0, bool bParam1)//Position - 0x21955
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_183(int iParam0)//Position - 0x21C79
{
...
void func_184(int iParam0)//Position - 0x21CAC
{
	switch (iParam0)
	{
		case 30:
...
void func_185(int iParam0, bool bParam1)//Position - 0x21CE1
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_186(int iParam0, int iParam1, bool bParam2)//Position - 0x21D3E
{
	if (iParam0 == 4294967295)
	{
		return;
...
bool func_187(int iParam0, int iParam1)//Position - 0x21D79
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
void func_188(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x21D9C
{
	if (iParam0 != 198)
	{
		if (Global_11625)
...
void func_189(int iParam0, int iParam1)//Position - 0x21DF7
{
	switch (iParam0)
	{
		case 12:
...
void func_190(int iParam0, bool bParam1)//Position - 0x21EE0
{
	if (bParam1)
	{
...
bool func_191(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x21F09
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_193()//Position - 0x2288B
{
	return Global_6374;
}

int func_194(var uParam0, int iParam1)//Position - 0x22896
{
	int iVar0;
...
int func_195(int iParam0)//Position - 0x26033
{
	switch (iParam0)
	{
		case 46:
...
void func_196(int iParam0, bool bParam1)//Position - 0x26125
{
	switch (iParam0)
	{
		case 46:
...
void func_197(int iParam0, bool bParam1)//Position - 0x26176
{
	int iVar0;
...
void func_198(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x261DC
{
	func_199(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_199(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x261FD
{
	int iVar0;
...
void func_200()//Position - 0x263D0
{
	int iVar0;
...
int func_201(int iParam0)//Position - 0x264F0
{
	int iVar0;
	int iVar1;
...
int func_204(int iParam0)//Position - 0x2672A
{
...
void func_205(int iParam0, int iParam1)//Position - 0x26757
{
...
int func_206(char* sParam0)//Position - 0x26794
{
	int iVar0;
...
int func_207()//Position - 0x267F4
{
	return func_208(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_208(char* sParam0, int iParam1)//Position - 0x26805
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_209(int iParam0)//Position - 0x2684E
{
	bool bVar0;
	int iVar1;
...
bool func_210(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x268BF
{
...
int func_211(char* sParam0, int iParam1, bool bParam2)//Position - 0x2690D
{
	Global_3DCF = 0;
...
void func_212()//Position - 0x26BD9
{
	int iVar0;
...
void func_213()//Position - 0x26C0A
{
...
void func_216()//Position - 0x26D5F
{
	if (func_98(14))
	{
...
int func_217()//Position - 0x26E01
{
	func_161();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_218()//Position - 0x26E1A
{
	int iVar0;
...
bool func_219(int iParam0, int iParam1)//Position - 0x26E71
{
	switch (iParam0)
	{
		case 5:
...
void func_220()//Position - 0x26EAC
{
...
void func_221(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x26F03
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
int func_222(int iParam0)//Position - 0x26F59
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_223()//Position - 0x26F7A
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (MISC::GET_GAME_TIMER() < iLocal_296 + 11000 && !CAM::IS_SCREEN_FADED_OUT())
	{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_293))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_293) == 1f)
				{
					if (func_311(Local_91))
					{
						...
						iLocal_286 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
						BRAIN::TASK_SYNCHRONIZED_SCENE(Local_91, iLocal_294, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
						...
						MISC::_0x1327E2FE9746BAEE(Local_91, 0, 0);
		...
		else if (!iLocal_302)
		{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_294) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_294) == 1f)
			{
				if (func_311(Local_91))
				{
					...
					iLocal_287 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
					BRAIN::TASK_SYNCHRONIZED_SCENE(Local_91, iLocal_295, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
		...
		if (MISC::GET_GAME_TIMER() > iLocal_296 + 10000)
		{
			if (iVar0 != 7)
			{
				...
				iLocal_284 = CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
	...
	if (func_311(Local_91))
	{
		if (iVar0 < 3)
		{
			unk_0x65E471E4A2D56226(Local_91, 101, 0);
			vVar4 = { unk_0x8000C77B5F336760(Local_91, true) };
			if (vVar4.z > 155f)
			{
				fVar5 = 155f;
			}
	...
	unk_0x59B038076F830627(true);
	HUD::DISPLAY_RADAR(true);
	PLAYER::SET_PLAYER_CONTROL(CAM::_0xDC9DA9E8789F5246(), true, 128);
	MISC::SET_TIME_SCALE(1f);
	if (func_222(Local_91))
	{
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_295))
		...
		BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(Local_91);
		MISC::_0x1327E2FE9746BAEE(Local_91, 0, 0);
		ENTITY::SET_ENTITY_COORDS(Local_91, 1655.77f, -20.04f, 135.8f, 1, false, 0, 1);
		unk_0x65E471E4A2D56226(Local_91, 0, 0);
	}
	func_224(&uLocal_106, 1, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
	func_210(&uLocal_106, "EXT4AUD", "EXT4_DUMB", 7, 0, 0, 0);
}

void func_224(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2762E
{
...
void func_225(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x276C9
{
	int iVar0;
...
void func_226(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x27771
{
	if (bParam0)
	{
...
int func_229(int iParam0, bool bParam1)//Position - 0x27902
{
	int iVar0;
	int iVar1;
...
int func_230(int iParam0)//Position - 0x27943
{
...
bool func_231()//Position - 0x27985
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_240006, 3);
}

int func_232(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x27996
{
	int iVar0;
...
void func_233(int iParam0)//Position - 0x279C9
{
	if (iParam0 == 1)
	{
...
void func_234()//Position - 0x279EC
{
	Global_3960 = 0;
	func_235();
}

void func_235()//Position - 0x279FC
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_236(int iParam0)//Position - 0x27A1D
{
...
void func_238(int iParam0, bool bParam1)//Position - 0x27A99
{
...
void func_239()//Position - 0x27AD5
{
	if (iLocal_85 < 2)
	{
	...
	switch (iLocal_85)
	{
		case 0:
			iLocal_87 = 0;
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1655.139f, 5.342447f, 172.6748f, 1662.085f, -6.198325f, 175.0248f, 8.25f, 0, true, 0))
			{
			...
			if (!func_260())
			{
				if (func_254(1, 20f, 1))
				{
					if ((!iLocal_305 || MISC::GET_GAME_TIMER() > iLocal_306 + 3000) || ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, 0, true, 0))
					{
						...
						if (func_311(Local_91))
						{
							unk_0x346478B12F69D4E3(Local_91, false);
						}
						...
						{
							iLocal_96 = PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0);
					...
					if (!iLocal_90)
					{
						if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_293))
						{
							if (func_311(Local_91))
							{
								...
								{
									iLocal_285 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
								}
								CAM::SET_CAM_ACTIVE(iLocal_285, true);
								CAM::RENDER_SCRIPT_CAMS(true, false, 3000, 1, 0, 0);
								iLocal_293 = PED::CREATE_SYNCHRONIZED_SCENE(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
								BRAIN::TASK_SYNCHRONIZED_SCENE(Local_91, iLocal_293, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
...
void func_240(int iParam0)//Position - 0x27E98
{
	iLocal_84 = iParam0;
	iLocal_85 = 0;
	iLocal_86 = 0;
...
void func_241(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x27EAA
{
	int iVar0;
...
Vector3 func_242(int iParam0)//Position - 0x2806B
{
	return unk_0x8000C77B5F336760(PLAYER::GET_PLAYER_PED(iParam0), false);
}

void func_243(bool bParam0)//Position - 0x2807E
{
	int iVar0;
...
void func_244(vector3 vParam0, float fParam1)//Position - 0x280BB
{
	int iVar0;
...
void func_245(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x2810A
{
	func_246(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_246(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x28133
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_247(vector3 vParam0)//Position - 0x28527
{
...
int func_248(int iParam0, int iParam1, bool bParam2)//Position - 0x28551
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_249(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x285C2
{
...
int func_250(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)//Position - 0x2869A
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_251(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x28990
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_252(vector3 vParam0)//Position - 0x28A44
{
	float fVar0;
	float fVar1;
...
void func_253(int iParam0)//Position - 0x28A83
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
int func_254(int iParam0, float fParam1, int iParam2)//Position - 0x28AE8
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	{
		...
		{
			if (!func_258(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_257(AUDIO::_0x0626A247D2405330(), 3466132403))
				{
...
bool func_255()//Position - 0x28BAB
{
	bool bVar0;
...
void func_256()//Position - 0x28BCE
{
...
int func_257(int iParam0, int iParam1)//Position - 0x28C1F
{
	if (func_311(iParam0))
	{
...
int func_258(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x28C52
{
...
void func_259(int iParam0)//Position - 0x28DE1
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_261()//Position - 0x28E2F
{
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
	...
	{
		case 0:
			if (func_311(Local_80.f_1C[0]))
			{
				PED::SET_PED_COMBAT_ATTRIBUTES(Local_80.f_1C[0], 17, true);
			}
			iLocal_290 = 0;
			iLocal_305 = 1;
		...
		case 1:
			...
			if (func_311(AUDIO::_0x0626A247D2405330()))
			{
				if (func_311(Local_91))
				{
					if (func_310(AUDIO::_0x0626A247D2405330(), Local_91, 100f, 1))
					{
						CUTSCENE::_REQUEST_CUTSCENE_EX("es_4_rcm_p2_concat", 6, 8);
						if (CUTSCENE::_0xB56BBBCC2955D9CB())
						{
					...
					if (func_310(AUDIO::_0x0626A247D2405330(), Local_91, 32f, 1))
					{
						...
						else
						{
							if (!iLocal_300)
							{
								if (func_310(AUDIO::_0x0626A247D2405330(), Local_91, 30f, 1) && !func_260())
								{
							...
							func_263();
							if (!PED::IS_PED_HEADTRACKING_PED(AUDIO::_0x0626A247D2405330(), Local_91))
							{
								BRAIN::TASK_LOOK_AT_ENTITY(AUDIO::_0x0626A247D2405330(), Local_91, 4294967295, 0, 2);
							}
						}
					}
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1663.587f, -11.71415f, 172.6748f, 1658.387f, -1.735749f, 175.7748f, 5.5f, 0, true, 0))
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
						{
							iLocal_85 = 2;
		...
		case 2:
			...
			if (func_311(AUDIO::_0x0626A247D2405330()))
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
				{
					VEHICLE::_SET_VEHICLE_HALT(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 5f, 1, 0);
					SYSTEM::WAIT(600);
					BRAIN::TASK_LEAVE_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0, 0);
				}
			}
...
void func_262()//Position - 0x2916D
{
	if (func_311(Local_91))
	{
		if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_91, 242628503) != 1)
		{
			BRAIN::TASK_PERFORM_SEQUENCE(Local_91, uLocal_95);
		}
	}
}

void func_263()//Position - 0x29195
{
	if (!func_260())
	{
		if (iLocal_290 < 5)
	...
	if (!func_260())
	{
		if ((AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, 4294967295) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, 4294967295)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, 4294967295))
		{
			if (AUDIO::HAS_SOUND_FINISHED(iLocal_289))
			{
...
int func_264(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x29243
{
...
int func_265(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x29297
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_266(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x29392
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_267(int iParam0, float fParam1)//Position - 0x2949E
{
	var uVar0;
	vector3 vVar1;
...
int func_268(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0x29533
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_252(vParam1 - unk_0x8000C77B5F336760(iParam0, true)) };
...
float func_269(vector3 vParam0, vector3 vParam1)//Position - 0x295C1
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

int func_270(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x295E2
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
...
int func_271(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x2962A
{
	int iVar0;
	bool bVar1;
...
void func_272(char* sParam0, int iParam1, int iParam2)//Position - 0x2967C
{
	iParam2 = iParam2;
...
void func_274()//Position - 0x296AE
{
	if (func_324() == 0)
	{
		func_285();
	...
	else
	{
		...
		BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(AUDIO::_0x0626A247D2405330(), 1723.452f, 80.729f, 169.6701f, 1f, 4294967295, 1f, 2113, 1193033728);
		func_238(800, 0);
		iLocal_88 = 1;
		func_281(1, 1, 1);
	}
...
void func_275()//Position - 0x29767
{
	if (func_222(Local_80.f_1C[0]))
	{
		func_279(Local_80.f_1C[0], 1737.453f, 101.7498f, 170.0243f, 288.5211f, 0, 1);
	}
	else
	{
		func_276(&(Local_80.f_1C[0]), 1737.453f, 101.7498f, 170.0243f, 288.5211f);
	}
	BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_80.f_1C[0], 1826.662f, 146.9161f, 170.4472f, 1f, 4294967295, 1048576000, 0, 1193033728);
	...
	if (func_311(Local_91))
	{
		if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_91, 242628503) != 1)
		{
			BRAIN::OPEN_SEQUENCE_TASK(&uLocal_95);
			BRAIN::TASK_PLAY_ANIM(0, "rcmextreme4", "idle", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, "rcmextreme4", "idle", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, "rcmextreme4", "fidget_01", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, "rcmextreme4", "idle", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, "rcmextreme4", "idle", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, "rcmextreme4", "idle", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, "rcmextreme4", "fidget_02", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			BRAIN::SET_SEQUENCE_TO_REPEAT(uLocal_95, 1);
			CUTSCENE::_0x8D9DF6ECA8768583(uLocal_95);
			BRAIN::TASK_PERFORM_SEQUENCE(Local_91, uLocal_95);
		}
	}
	if (func_311(Local_91))
	{
		...
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_91, PED::GET_PED_RELATIONSHIP_GROUP_HASH(AUDIO::_0x0626A247D2405330()));
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_103))
	{
		iLocal_103 = OBJECT::CREATE_AMBIENT_PICKUP(joaat("pickup_parachute"), 1665.264f, -11.4427f, 172.7747f, 7, 4294967295, joaat("p_parachute_s"), 1, 1);
	}
...
void func_276(int iParam0, vector3 vParam1, float fParam2)//Position - 0x29A67
{
...
void func_277(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0x29A99
{
	func_278(iParam0);
	*iParam0 = PED::CREATE_PED(iParam4, iParam1, vParam2, fParam3, 0, false);
}

void func_278(int iParam0)//Position - 0x29ABA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_279(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)//Position - 0x29AFB
{
	bool bVar0;
	float fVar1;
...
void func_280(var uParam0, bool bParam1, bool bParam2)//Position - 0x29B57
{
	int iVar0;
...
void func_281(int iParam0, int iParam1, int iParam2)//Position - 0x29C4C
{
...
void func_282(int iParam0, int iParam1, int iParam2)//Position - 0x29C80
{
...
bool func_283()//Position - 0x29D44
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_16C30.f_14, 13);
}

void func_284(vector3 vParam0, float fParam1, int iParam2, int iParam3)//Position - 0x29D58
{
	if (func_324())
	{
...
void func_285()//Position - 0x29DED
{
	switch (iLocal_86)
	{
		case 0:
			...
			if (func_287(1, 1093140480, 0))
			{
				if (!iLocal_305 || MISC::GET_GAME_TIMER() > iLocal_306 + 3500)
				{
					...
					if (func_222(Local_80.f_1C[0]))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_80.f_1C[0], "Hudson", 0, joaat("a_c_retriever"), 0);
					}
					SYSTEM::WAIT(0);
					CAM::STOP_GAMEPLAY_HINT(0);
		...
		case 2:
			func_279(AUDIO::_0x0626A247D2405330(), 1732.222f, 92.0087f, 169.7867f, 138.1854f, 0, 1);
			PED::FORCE_PED_MOTION_STATE(AUDIO::_0x0626A247D2405330(), 3626484699, 0, 1, 0);
			PED::SET_PED_MIN_MOVE_BLEND_RATIO(AUDIO::_0x0626A247D2405330(), 1f);
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(AUDIO::_0x0626A247D2405330(), 1723.452f, 80.729f, 169.6701f, 1f, 4294967295, 1f, 2113, 1193033728);
			CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
...
void func_286()//Position - 0x29FB6
{
	int iVar0;
...
int func_287(int iParam0, float fParam1, int iParam2)//Position - 0x29FD6
{
	int iVar0;
...
void func_288()//Position - 0x2A0AA
{
	Global_3960 = 0;
	func_220();
}

void func_289(char* sParam0, bool bParam1)//Position - 0x2A0BA
{
	func_243(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_290()//Position - 0x2A0D0
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	fVar3 = -0.85f;
	fVar4 = 0f;
	if (((!func_324() && func_311(Local_80.f_1C[0])) && func_311(AUDIO::_0x0626A247D2405330())) && iLocal_305 == 1)
	{
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			PLAYER::SET_PLAYER_CONTROL(CAM::_0xDC9DA9E8789F5246(), false, 0);
			BRAIN::TASK_LOOK_AT_ENTITY(AUDIO::_0x0626A247D2405330(), Local_80.f_1C[0], 4294967295, 0, 2);
			BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(AUDIO::_0x0626A247D2405330(), Local_80.f_1C[0], 0f, 0f, 0f, 1f, 4294967295, 0.5f, 1);
			CAM::GET_IS_MULTIPLAYER_BRIEF(1);
			CAM::SET_GAMEPLAY_ENTITY_HINT(Local_80.f_1C[0], -0.5f, 0f, -0.2f, 1, 30000, 2000, 2000, 0);
		...
		{
			if (func_310(AUDIO::_0x0626A247D2405330(), Local_80.f_1C[0], 4f, 1))
			{
...
void func_291()//Position - 0x2A1DA
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (iLocal_305)
	{
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			PLAYER::SET_PLAYER_CONTROL(CAM::_0xDC9DA9E8789F5246(), false, 0);
			BRAIN::TASK_LOOK_AT_ENTITY(AUDIO::_0x0626A247D2405330(), Local_91, 4294967295, 0, 2);
			BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(AUDIO::_0x0626A247D2405330(), 1658.95f, -5.45f, 173.78f, 1f, 4294967295, 0.25f, 0, -161.08f);
			CAM::GET_IS_MULTIPLAYER_BRIEF(1);
...
void func_292()//Position - 0x2A295
{
	float fVar0;
	...
	if (iLocal_84 == 1)
	{
		...
		{
			fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(Local_91, true), true);
			if (iLocal_89 == 0)
			{
				if (fVar0 > 160f)
				{
		...
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1660.332f, -20.45607f, 136.7029f, 1584.419f, -30.29117f, 120.6038f, 32f, 0, true, 0))
		{
			sLocal_92 = "EXT4_F2";
			iLocal_84 = 4;
		}
...
void func_293(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2A363
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_11723 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_295(Global_11724, Global_11726, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
float func_294(char* sParam0)//Position - 0x2A648
{
	HUD::_BEGIN_TEXT_COMMAND_WIDTH(sParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_295(int iParam0, int iParam1, int iParam2)//Position - 0x2A65B
{
	struct<2> Var0;
	int iVar1;
...
char* func_296(int iParam0)//Position - 0x2A731
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_297(int iParam0)//Position - 0x2A884
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_298(int iParam0)//Position - 0x2A8B7
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_299(int iParam0)//Position - 0x2A8EA
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_300(int iParam0)//Position - 0x2A91D
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_301(int iParam0)//Position - 0x2A950
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_302(int iParam0)//Position - 0x2A98D
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_303(int iParam0)//Position - 0x2A9C0
{
	struct<2> Var0;
...
int func_304(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2AA29
{
	if (((!func_307(0) || Global_11732) || Global_11727 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_11723)
...
bool func_305(bool bParam0)//Position - 0x2AB41
{
	if (bParam0)
	{
...
int func_306(int iParam0)//Position - 0x2AB6A
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
int func_307(int iParam0)//Position - 0x2ABC4
{
	if (Global_8D15 == 15)
	{
		return 0;
...
bool func_308(int iParam0)//Position - 0x2ABE6
{
	return func_309(iParam0, Global_8D15);
}

int func_309(int iParam0, int iParam1)//Position - 0x2ABF7
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_310(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x2ADD8
{
	return SYSTEM::VDIST2(unk_0x8000C77B5F336760(iParam0, bParam3), unk_0x8000C77B5F336760(iParam1, bParam3)) <= (fParam2 * fParam2);
}

int func_311(int iParam0)//Position - 0x2ADFA
{
	if (func_222(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
void func_312()//Position - 0x2AE1A
{
	func_317(52, 1, 0);
	iLocal_89 = 0;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_99))
	{
		...
		unk_0x346478B12F69D4E3(iLocal_99, true);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_91))
	{
		...
		unk_0x346478B12F69D4E3(Local_91, true);
		ENTITY::SET_ENTITY_HEALTH(Local_91, 1);
...
int func_313(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0x2AFF7
{
...
int func_314(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0x2B053
{
	int iVar0;
...
int func_315(var uParam0, int iParam1)//Position - 0x2B0E1
{
	int iVar0;
...
void func_316(int iParam0)//Position - 0x2B127
{
...
void func_317(int iParam0, int iParam1, bool bParam2)//Position - 0x2B1A7
{
	Global_BFD = iParam0;
...
void func_318()//Position - 0x2B351
{
	char cVar0[64];
	char cVar1[64];
	char* sVar2;
...
int func_319(var uParam0)//Position - 0x2B3D0
{
	int iVar0[1];
	int iVar1;
	...
	switch (iLocal_77)
	{
		case 0:
			...
			func_323(&(uParam0->f_30), "rcmextreme4", "idle_a", "idle_c");
			iLocal_77 = 1;
			break;
		...
		case 2:
			func_276(&(uParam0->f_1C[0]), 1732.27f, 96.36f, 170.29f, -98.56f);
...
int func_320(var uParam0)//Position - 0x2B4D4
{
	if (func_321(uParam0))
	{
...
int func_321(var uParam0)//Position - 0x2B4FE
{
...
int func_322(int iParam0)//Position - 0x2B523
{
	int iVar0;
...
void func_323(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0x2B554
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
void func_325(int iParam0)//Position - 0x2B5B4
{
	func_286();
	if (func_339())
	{
	...
	BRAIN::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 1);
	func_326(&Local_80, 1, 0, 0);
	HUD::DISPLAY_SNIPER_SCOPE_THIS_FRAME();
}

void func_326(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x2B608
{
...
void func_327(var uParam0, bool bParam1)//Position - 0x2B628
{
	func_328(&(uParam0->f_29), bParam1);
}

void func_328(var uParam0, bool bParam1)//Position - 0x2B63A
{
	int iVar0;
...
void func_329(var uParam0, bool bParam1)//Position - 0x2B678
{
	func_330(&(uParam0->f_23), bParam1);
}

void func_330(var uParam0, bool bParam1)//Position - 0x2B68A
{
	int iVar0;
...
void func_331(int iParam0)//Position - 0x2B6C7
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_332(int iParam0)//Position - 0x2B6FF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*iParam0))
...
int func_333(int iParam0)//Position - 0x2B79B
{
	if (func_222(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
void func_334(var uParam0, int iParam1)//Position - 0x2B7C5
{
	func_335(&(uParam0->f_1C), iParam1);
}

void func_335(var uParam0, int iParam1)//Position - 0x2B7D7
{
	int iVar0;
...
void func_336(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2B818
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_337(int iParam0, bool bParam1)//Position - 0x2B868
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_338()//Position - 0x2B8A3
{
	func_326(&Local_80, 1, 0, 0);
	func_336(&(Local_80.f_1C[0]), 1, 0, 1);
	STREAMING::REMOVE_ANIM_DICT("rcmextreme4");
}

int func_339()//Position - 0x2B8CA
{
	int iVar0;
...
void func_340(bool bParam0)//Position - 0x2B96B
{
	int iVar0;
...
void func_341(char* sParam0, int iParam1)//Position - 0x2BA3B
{
	if (Global_16C30 != 12)
	{
...
int func_342(char* sParam0, int iParam1, int iParam2)//Position - 0x2BA63
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
...
int func_343(char* sParam0)//Position - 0x2BBF5
{
...
int func_344()//Position - 0x2BC4B
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_345(&(Global_16C30.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_345(char* sParam0, bool bParam1)//Position - 0x2BC6F
{
	int iVar0;
	int iVar1;
...
int func_346(int iParam0, bool bParam1)//Position - 0x2BC99
{
	int iVar0;
...
int func_348()//Position - 0x2BD1F
{
	...
	{
		if (func_343(&(Global_16C30.f_3)) > 4294967295)
		{
			return 1;
		}
	}
...
void func_349(bool bParam0)//Position - 0x2BD8B
{
	unk_0x59B038076F830627(bParam0);
	HUD::DISPLAY_RADAR(bParam0);
}

void func_350(int iParam0)//Position - 0x2BD9F
{
	if (iParam0 == 1)
	{
		HUD::_0xFDB423997FA30340();
...
void func_351(int iParam0)//Position - 0x2BDDC
{
	if (iParam0 == 1)
	{
...
void func_352()//Position - 0x2BE19
{
	Global_434C.f_5 = 1;
}

void func_353()//Position - 0x2BE27
{
	Global_434C.f_5 = 0;
}

void func_354(bool bParam0)//Position - 0x2BE35
{
	if (bParam0)
	{
		func_355();
...
void func_355()//Position - 0x2BE98
{
...
void func_356(int iParam0)//Position - 0x2BEC1
{
	if (func_358())
	{
		return;
...
void func_357(bool bParam0, bool bParam1)//Position - 0x2BF3B
{
	if (bParam0)
	{
		if (func_306(0))
...
bool func_358()//Position - 0x2BFAF
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

void func_359()//Position - 0x2BFC1
{
	Global_155CF = 0;
	Global_155D0 = 0;
}

int func_360()//Position - 0x2BFD3
{
...
void func_361()//Position - 0x2C013
{
	Global_16C53 = 1;
...
void func_362(char* sParam0)//Position - 0x2C100
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_363(var uParam0)//Position - 0x2C112
{
...
void func_364(var uParam0)//Position - 0x2C132
{
	int iVar0;
...
int func_365(int iParam0)//Position - 0x2C16C
{
	if (!func_158(iParam0))
	{
		return Global_19E56.f_6D76[iParam0 /*29*/];
