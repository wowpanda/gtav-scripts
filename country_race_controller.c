...
void __EntryFunction__()
{
	...
	{
		if (VDIST2(func_60(), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) < 40000f)
		{
...
void func_7(int iParam0)
{
	...
	if (iVar0 < iParam0 + 1)
	{
		STAT_SET_INT(joaat("num_stock_races_completed"), iParam0 + 1, 1);
	}
}
...
void func_8()
{
	...
	StringIntConCat(&cVar0, Global_106565.f_25067 + 1, 16);
	func_9(&cVar0, -1);
}
...
void func_11()
{
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("country_race")) == 0)
	{
...
void func_13()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("country_race")) == 0)
	{
		if (HAS_SCRIPT_LOADED("Country_Race"))
		{
			if (iLocal_155 == 2)
			{
				iLocal_155 = func_17(&Global_106563, 2, 9, 0, 0);
			}
...
void func_15(var uParam0, bool bParam1)
{
	if (DOES_ENTITY_EXIST(*uParam0))
	{
		if (!IS_PED_INJURED(*uParam0))
		{
			...
			if (IS_PED_GROUP_MEMBER(*uParam0, func_16()))
			{
...
void func_23()
{
	if (func_43())
	{
		if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), func_60(), 5f, 5f, 5f, 1, 1, 0))
		{
			DISABLE_CONTROL_ACTION(0, 74, 1);
			SET_IK_TARGET(uLocal_157, 1, PLAYER_PED_ID(), 0, 0f, 0f, 0f, 0, 150, 400);
			if (func_41())
			{
				if (func_38())
				{
					...
					func_33();
					func_32();
					if (((!IS_PLAYER_SWITCH_IN_PROGRESS() && !func_31(1)) && !func_30(0)) && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appinternet")) == 0)
					{
						if (IS_CONTROL_JUST_PRESSED(2, 51))
						{
							...
							SET_ENTITY_INVINCIBLE(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 1);
							HIDE_HELP_TEXT_THIS_FRAME();
							iLocal_154 = 1;
						}
					}
...
void func_28()
{
	...
	{
		if (!func_25("CRACECAR") && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appinternet")) == 0)
		{
			CLEAR_HELP(1);
...
void func_29(char* sParam0, int iParam1, int iParam2, int iParam3)
{
	...
	END_TEXT_COMMAND_DISPLAY_HELP(0, iParam1, iParam2, iParam3);
}
...
void func_32()
{
	...
	{
		Var0 = { func_26() };
		if (!func_25(&Var0) && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appinternet")) == 0)
		{
			CLEAR_HELP(1);
			func_29(&Var0, 1, 1, -1);
		}
...
void func_33()
{
	if (((((GET_FOLLOW_VEHICLE_CAM_VIEW_MODE() != 3 && GET_FOLLOW_VEHICLE_CAM_VIEW_MODE() != 4) && !IS_GAMEPLAY_CAM_LOOKING_BEHIND()) && IS_PLAYER_PLAYING(PLAYER_ID())) && func_34(uLocal_157)) && GET_ENTITY_SPEED(PLAYER_PED_ID()) < 20f)
	{
		if (iLocal_159)
		{
			if (!IS_GAMEPLAY_HINT_ACTIVE())
			{
				SET_GAMEPLAY_ENTITY_HINT(uLocal_157, 0f, 0f, 0f, 1, 2000, 2000, 2000, 0);
				iLocal_159 = 0;
			}
		}
	}
...
void func_35()
{
	if (GET_GAME_TIMER() > iLocal_158 + 5000)
	{
...
int func_43()
{
	if ((!Global_106565.f_25067.f_9 && !Global_106565.f_25067.f_8) && VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), func_60()) < 84100f)
	{
		...
		if (!Global_106565.f_25067.f_9)
		{
			...
			{
				if (!HAS_THIS_ADDITIONAL_TEXT_LOADED("C_RACE", 3) && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("mission_stat_watcher")) <= 0)
				{
	...
	{
		if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), func_60()) > 90000f)
		{
		...
		if (Global_106565.f_25067.f_9)
		{
			...
			if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), func_60(), 5f, 5f, 5f, 1, 1, 0))
			{
				if (HAS_THIS_ADDITIONAL_TEXT_LOADED("C_RACE", 3))
				{
					if (!func_25("CRACEDISRUPT") && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("appinternet")) == 0)
					{
						CLEAR_HELP(1);
...
{
	if (!DOES_ENTITY_EXIST(uLocal_156) && !DOES_ENTITY_EXIST(uLocal_157))
	{
		...
		{
			uLocal_156 = CREATE_VEHICLE(func_50(), func_49(), func_48(), 1, 1, 0);
			SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_156, 1084227584);
			if (Global_106565.f_25067 == 4)
			{
				SET_VEHICLE_LIVERY(uLocal_156, 0);
				SET_VEHICLE_COLOURS(uLocal_156, 44, 83);
				SET_VEHICLE_EXTRA_COLOURS(uLocal_156, 111, 111);
			}
			SET_VEHICLE_DOORS_LOCKED(uLocal_156, 3);
			SET_VEHICLE_AUTOMATICALLY_ATTACHES(uLocal_156, 0, 0);
			_0x2B6747FAA9DB9D6B(uLocal_156, 1);
			SET_MODEL_AS_NO_LONGER_NEEDED(func_50());
			uLocal_157 = CREATE_PED(26, joaat("a_m_y_motox_02"), func_47(), func_46(), 1, 1);
			func_45(uLocal_157);
			SET_AMBIENT_VOICE_NAME(uLocal_157, "A_M_Y_RACER_01_WHITE_MINI_01");
			TASK_START_SCENARIO_IN_PLACE(uLocal_157, "WORLD_HUMAN_STAND_IMPATIENT", -1, 1);
...
void func_51()
{
	...
	{
		if ((!IS_PED_FLEEING(uLocal_157) && !IS_PED_IN_COMBAT(uLocal_157, 0)) && !IS_PED_RAGDOLL(uLocal_157))
		{
			if (!func_53(uLocal_157, 993674639, 1))
			{
				TASK_START_SCENARIO_IN_PLACE(uLocal_157, "WORLD_HUMAN_STAND_IMPATIENT", -1, 1);
			}
			if (func_52(uLocal_156) || Global_106565.f_25067.f_9)
			{
				_0xF1C03A5352243A30(uLocal_157);
				TASK_COMBAT_PED(uLocal_157, PLAYER_PED_ID(), 0, 16);
			}
			fLocal_160 = GET_ENTITY_SPEED(PLAYER_PED_ID());
		}
		else if (IS_PED_RAGDOLL(uLocal_157))
		{
...
int func_52(var uParam0)
{
	...
	if (func_61(uParam0))
	{
		if ((func_61(uVar0) && fLocal_160 != 0f) && fLocal_160 >= 9f)
		{
			...
			if (IS_ENTITY_TOUCHING_ENTITY(uParam0, uVar0) && fVar1 <= (fLocal_160 * 0.5f))
			{
				return 1;
			}
		}
		if (GET_ENTITY_HEALTH(uParam0) + 100 < GET_ENTITY_MAX_HEALTH(uParam0))
		{
			return 1;
		}
	}
...
int func_54()
{
	...
	{
		if (IS_ENTITY_DEAD(uLocal_157, 0))
		{
			return 1;
		}
		else if (IS_PED_FLEEING(uLocal_157))
		{
			return 1;
		}
		else if (IS_PED_IN_COMBAT(uLocal_157, 0))
		{
			return 1;
		}
		else if (IS_PED_RAGDOLL(uLocal_157))
	...
	if (DOES_ENTITY_EXIST(uLocal_156))
	{
		...
		else
		{
			...
			if (HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(PLAYER_PED_ID(), uLocal_156, 0, -1))
			{
				return 1;
			}
		}
...
float func_55(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
void func_56()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("country_race")) == 0)
	{
		if (VDIST2(func_60(), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) > 160000f)
		{
			func_62(0);
		}
	}
...
void func_62(bool bParam0)
{
	...
	if (func_61(uLocal_157))
	{
		...
		{
			TASK_WANDER_STANDARD(uLocal_157, 1193033728, 0);
		}
	}
	...
	if (bParam0)
	{
		CLEAR_AREA(func_60(), 100f, 1, 0, 0, 0);
	}
	if (IS_GAMEPLAY_HINT_ACTIVE())
	{
		STOP_GAMEPLAY_HINT(0);
