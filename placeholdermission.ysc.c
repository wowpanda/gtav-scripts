...
void func_3()//Position - 0xFC
{
	...
	if (Global_19E56.f_2361 || func_18(0))
	{
		if (!func_17())
		{
			iVar0 = func_16();
...
void func_6()//Position - 0x26B
{
	...
	{
		if (func_10(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			iVar0 = func_9(AUDIO::_0x0626A247D2405330());
			if (func_8(iVar0) && (!func_7(14) || Global_19A3D))
			{
				if (Global_19E56.f_933.f_21B.f_10CD != iVar0 && func_8(Global_19E56.f_933.f_21B.f_10CD))
				{
...
int func_11(int iParam0)//Position - 0x3E9
{
	...
	func_12(&(Global_19E56.f_933.f_21B), iVar1);
...
void func_12(var uParam0, int iParam1)//Position - 0x500
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_14(Global_19E56.f_4849[iVar0], &vVar2, &fVar3))
			{
				Global_19E56.f_4849[iVar0] = 318;
				func_13(&(uParam0->f_8E4[iVar0]));
