...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Global_1656129)
		{
			if (!Global_1656131)
			{
				Global_1656128 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("OPENING_CREDITS");
				Global_1656131 = 1;
			}
			else if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_1656128))
			{
				if (!Global_1656130)
				{
					GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(Global_1656128, 255, 255, 255, 255, 0);
				}
			}
		}
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		switch (iParam0->f_6)
		{
			case 0:
				...
				{
					func_181(&(iParam0->f_15), 0, 0);
				}
				GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&Global_1656128);
				Global_1656129 = 0;
				Global_1656131 = 0;
				Global_1656130 = 0;
				Global_1656132 = 0;
				...
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					*iParam0 = 0;
					...
					func_163(1, 0);
					func_153(1, 1);
					if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("fm_intro")) < 1 || !func_152())
					{
						if (iParam0->f_292)
						{
							if (func_151() == 0)
			...
			case 2:
				if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
				{
					...
					{
						if (func_129() == 64 || func_129() == 65)
						{
							STREAMING::CLEAR_FOCUS();
							STREAMING::NEW_LOAD_SCENE_START(754.2219f, 1226.831f, 356.5081f, func_128(-14.367f, 0f, 157.3524f), 100f, 0);
							func_127(&(iParam0->f_17));
							func_181(&(iParam0->f_17), 0, 0);
							MISC::SET_BIT(iParam0, 4);
						}
					}
					else if (AUDIO::PREPARE_MUSIC_EVENT("FM_INTRO_START") && (STREAMING::IS_NEW_LOAD_SCENE_LOADED() || func_126(&(iParam0->f_17), 5000, 0)))
					{
			...
			case 14:
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					...
					func_116(iParam0);
					func_115(iParam0, "race_camera_1", "mp_intro_seq@", -2237.39f, -333.52f, 12.47f, 0f, 0f, 0f, 0.1982f, 1065353216);
				...
				{
					func_121("FMIC_RACE1", -1);
					MISC::SET_BIT(iParam0, 5);
				}
				func_124(iParam0, 14);
				if (func_122(iParam0, 14, 0))
				{
					func_112(iParam0, 23539f, 0);
					NETWORK::NETWORK_OVERRIDE_CLOCK_TIME(16, 0, 0);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 15;
				}
			...
			case 15:
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					func_115(iParam0, "race_camera_2", "mp_intro_seq@", -2237.39f, -333.52f, 12.47f, 0f, 0f, 0f, 0.39f, 1065353216);
					func_113(iParam0, 15);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				...
				else if (func_100(iParam0) && func_93(iParam0))
				{
					func_91(iParam0);
				}
				func_124(iParam0, 15);
				if (func_122(iParam0, 15, 0))
				{
					func_112(iParam0, 28833.33f, 75f);
					NETWORK::NETWORK_OVERRIDE_CLOCK_TIME(16, 0, 0);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 16;
				}
			...
			case 16:
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					func_90(iParam0, "race_camera_3a", "mp_intro_seq@", iParam0->f_92[4], 0f, 0f, -0.1f, 0f, 0f, 0f);
					func_113(iParam0, 16);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				if (!MISC::IS_BIT_SET(iParam0->f_3, 0))
				...
				func_124(iParam0, 16);
				if (func_122(iParam0, 16, 0))
				{
					func_112(iParam0, 29700f, 0);
					NETWORK::NETWORK_OVERRIDE_CLOCK_TIME(16, 0, 0);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 17;
				}
			...
			case 17:
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					func_115(iParam0, "race_camera_3b", "mp_intro_seq@", -2237.39f, -333.52f, 12.47f, 0f, 0f, 0f, 0, 1065353216);
				...
				func_124(iParam0, 17);
				if (func_122(iParam0, 17, 0))
				{
					func_112(iParam0, 36450f, 0);
					NETWORK::NETWORK_OVERRIDE_CLOCK_TIME(16, 0, 0);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 18;
				}
			...
			case 18:
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					func_115(iParam0, "race_camera_4", "mp_intro_seq@", -2237.39f, -333.52f, 12.47f, 0f, 0f, 0f, 0, 1065353216);
					func_113(iParam0, 18);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				if (!MISC::IS_BIT_SET(iParam0->f_3, 0))
				...
				func_124(iParam0, 18);
				if (func_89() && func_122(iParam0, 18, 0))
				{
					func_112(iParam0, 43650f, 0);
					NETWORK::NETWORK_OVERRIDE_CLOCK_TIME(16, 0, 0);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 19;
				}
			...
			case 19:
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					...
					func_115(iParam0, "race_camera_5", "mp_intro_seq@", -2237.39f, -333.52f, 12.47f, 0f, 0f, 0f, 0, 1065353216);
					func_113(iParam0, 19);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				if (!MISC::IS_BIT_SET(iParam0->f_3, 0))
				...
				else
				{
					...
					if (func_100(iParam0) && func_93(iParam0))
					{
						func_91(iParam0);
					}
				}
				...
				func_87(iParam0);
				func_124(iParam0, 19);
				if (func_122(iParam0, 19, 0) && MISC::IS_BIT_SET(iParam0->f_3, 0))
				{
				...
				else if (func_122(iParam0, 19, -4968))
				{
					if (!MISC::IS_BIT_SET(*iParam0, 12))
					{
						HUD::CLEAR_HELP(1);
				...
				else if (func_122(iParam0, 19, -5618))
				{
			...
			case 27:
				...
				func_83(iParam0, 2);
				func_83(iParam0, 7);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_82());
			...
			case 28:
				...
				func_124(iParam0, 28);
				if ((AUDIO::PREPARE_MUSIC_EVENT("FM_INTRO_DRIVE_START") && MISC::IS_BIT_SET(iParam0->f_3, 3)) && func_122(iParam0, 28, 0))
				{
					iParam0->f_6 = 29;
				}
				break;
			...
			case 31:
				...
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(0))
				{
					...
					func_113(iParam0, 33);
					func_115(iParam0, "LAMAR_CAR_DRIVE_01", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
				}
				...
				if ((func_65(iParam0) && func_64(iParam0)) && !CUTSCENE::IS_CUTSCENE_PLAYING())
				{
					if (iParam0->f_293)
					{
			...
			case 33:
				if (func_79(iParam0))
				{
					...
					{
						if (func_122(iParam0, 33, -5450))
						{
							if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM2", "FM_LAM2_1", 9, 0, 0))
							{
					...
					if (!MISC::IS_BIT_SET(iParam0->f_1, 2))
					{
						if (func_122(iParam0, 33, -5450))
						{
							if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM2", "FM_LAM2_3", 9, 0, 0))
							{
				...
				if (!func_79(iParam0))
				{
					if (!MISC::IS_BIT_SET(iParam0->f_1, 1))
					{
						if (func_122(iParam0, 33, -5450))
						{
							if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM1", "FM_LAM1_1", 9, 0, 0))
							{
								MISC::SET_BIT(&(iParam0->f_1), 1);
							}
						}
			...
			case 34:
				if (!func_79(iParam0))
				{
					if (!MISC::IS_BIT_SET(iParam0->f_1, 2))
					{
						if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM1", "FM_LAM1_3", 9, 0, 0))
						{
							MISC::SET_BIT(&(iParam0->f_1), 2);
						}
					}
				...
				func_124(iParam0, 34);
				func_42(iParam0);
				if (func_122(iParam0, 34, 0))
				{
					func_67(iParam0, 18966.65f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 35;
				}
				break;
			...
			case 35:
				if (func_79(iParam0))
				{
					...
					{
						if (func_122(iParam0, 34, 1100))
						{
							if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM2", "FM_LAM2_5", 9, 0, 0))
							{
					...
					if (!MISC::IS_BIT_SET(iParam0->f_1, 4))
					{
						if (func_122(iParam0, 34, 1100))
						{
							if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM2", "FM_LAM2_7", 9, 0, 0))
							{
				...
				if (!func_79(iParam0))
				{
					if (!MISC::IS_BIT_SET(iParam0->f_1, 3))
					{
						if (func_122(iParam0, 34, 1000))
						{
							if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM1", "FM_LAM1_5", 9, 0, 0))
							{
								MISC::SET_BIT(&(iParam0->f_1), 3);
							}
						}
				...
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					func_115(iParam0, "LAMAR_CAR_DRIVE_03", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					if (!ENTITY::IS_ENTITY_DEAD(iParam0->f_35, 0))
					{
			...
			case 36:
				if (func_79(iParam0))
				{
					...
					{
						if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM2", "FM_LAM2_9", 9, 0, 0))
						{
				...
				if (!func_79(iParam0))
				{
					if (!MISC::IS_BIT_SET(iParam0->f_1, 4))
					{
						if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM1", "FM_LAM1_7", 9, 0, 0))
						{
							MISC::SET_BIT(&(iParam0->f_1), 4);
						}
					}
					if (!MISC::IS_BIT_SET(iParam0->f_1, 5))
					{
						if (func_122(iParam0, 36, -3750))
						{
							if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM1", "FM_LAM1_9", 9, 0, 0))
							{
								MISC::SET_BIT(&(iParam0->f_1), 5);
							}
						}
				...
				func_124(iParam0, 36);
				func_42(iParam0);
				if (func_122(iParam0, 36, 0))
				{
					func_67(iParam0, 42700.96f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 37;
				}
				break;
			...
			case 37:
				if (func_79(iParam0))
				{
					...
					{
						if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM2", "FM_LAM2_11", 9, 0, 0))
						{
				...
				if (!func_79(iParam0))
				{
					if (!MISC::IS_BIT_SET(iParam0->f_1, 6))
					{
						if (func_122(iParam0, 36, 1000))
						{
							if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM1", "FM_LAM1_11", 9, 0, 0))
							{
								MISC::SET_BIT(&(iParam0->f_1), 6);
							}
						}
				...
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					func_115(iParam0, "LAMAR_CAR_DRIVE_05", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					if (!ENTITY::IS_ENTITY_DEAD(iParam0->f_35, 0))
					{
						ENTITY::SET_ENTITY_VISIBLE(iParam0->f_35, true, 0);
					}
				...
				func_124(iParam0, 37);
				func_42(iParam0);
				if (func_122(iParam0, 37, 0))
				{
					func_67(iParam0, 51033.28f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 38;
				}
				break;
			...
			case 38:
				if (func_79(iParam0))
				{
					...
					{
						if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM2", "FM_LAM2_13", 9, 0, 0))
						{
					...
					{
						if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM2", "FM_LAM2_15", 9, 0, 0))
						{
					...
					{
						if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM2", "FM_LAM2_17", 9, 0, 0))
						{
				...
				if (!func_79(iParam0))
				{
					if (!MISC::IS_BIT_SET(iParam0->f_1, 7))
					{
						if (func_122(iParam0, 37, 2500))
						{
							if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM1", "FM_LAM1_13", 9, 0, 0))
							{
								MISC::SET_BIT(&(iParam0->f_1), 7);
							}
						}
				...
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					func_115(iParam0, "LAMAR_CAR_DRIVE_07", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					func_113(iParam0, 38);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				func_124(iParam0, 38);
				func_42(iParam0);
				if (func_122(iParam0, 38, 0))
				{
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 39;
				}
			...
			case 39:
				if (!func_79(iParam0))
				{
					if (!MISC::IS_BIT_SET(iParam0->f_1, 8))
					{
						if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM1", "FM_LAM1_15", 9, 0, 0))
						{
							MISC::SET_BIT(&(iParam0->f_1), 8);
						}
					}
					if (!MISC::IS_BIT_SET(iParam0->f_1, 9))
					{
						if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAM1", "FM_LAM1_17", 9, 0, 0))
						{
							MISC::SET_BIT(&(iParam0->f_1), 9);
						}
					}
					...
					{
						if (func_43(&(iParam0->f_123), "FM_1AU", "FM_LAMRAD", "FM_LAMRAD_1", 9, 0, 0))
						{
				...
				func_124(iParam0, 39);
				func_42(iParam0);
				if (func_122(iParam0, 39, 0))
				{
					func_67(iParam0, 85050f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 40;
				}
				break;
			...
			case 40:
				...
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					func_115(iParam0, "LAMAR_CAR_DRIVE_10", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					STREAMING::_0xBEB2D9A1D9A8F55A(9, 12, 9, 12);
					if (!ENTITY::IS_ENTITY_DEAD(iParam0->f_35, 0))
					{
						ENTITY::SET_ENTITY_VISIBLE(iParam0->f_35, true, 0);
				...
				func_124(iParam0, 40);
				if (func_42(iParam0) && func_122(iParam0, 40, 0))
				{
					func_67(iParam0, 116366.5f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 41;
				}
				break;
			...
			case 41:
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					...
					func_115(iParam0, "LAMAR_CAR_DRIVE_12", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0.235f, 0.75f);
					func_113(iParam0, 41);
					MISC::_0xA74802FB8D0B7814("CONTRAILS", 0);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				func_124(iParam0, 41);
				if (func_122(iParam0, 41, 0))
				{
					GRAPHICS::_0x03300B57FCAC6DDB(1);
					func_67(iParam0, 127166.5f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 42;
				}
				break;
			...
			case 42:
				...
				{
					func_41(iParam0);
					func_115(iParam0, "LAMAR_CAR_DRIVE_14", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					func_113(iParam0, 42);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				func_124(iParam0, 42);
				if (func_122(iParam0, 42, 0))
				{
					GRAPHICS::_0x03300B57FCAC6DDB(0);
					func_67(iParam0, 170800f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 43;
				}
				break;
			...
			case 43:
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					func_115(iParam0, "LAMAR_CAR_DRIVE_17", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					func_113(iParam0, 43);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				func_124(iParam0, 43);
				if (func_122(iParam0, 43, 0))
				{
					STREAMING::_0xBEB2D9A1D9A8F55A(9, 12, 9, 12);
					func_67(iParam0, 191799.8f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 44;
				}
				break;
			...
			case 44:
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					func_115(iParam0, "LAMAR_CAR_DRIVE_19", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					func_113(iParam0, 44);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				func_124(iParam0, 44);
			...
			case 45:
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					func_115(iParam0, "LAMAR_CAR_DRIVE_20", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					func_113(iParam0, 45);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				func_124(iParam0, 45);
				if (func_122(iParam0, 45, 0))
				{
					func_67(iParam0, 201466.5f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 46;
				}
				break;
			...
			case 46:
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					func_115(iParam0, "LAMAR_CAR_DRIVE_21", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					func_113(iParam0, 46);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				func_124(iParam0, 46);
				if (func_122(iParam0, 46, 0))
				{
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 47;
				}
			...
			case 47:
				...
				func_124(iParam0, 47);
				if (func_122(iParam0, 47, 0))
				{
					func_67(iParam0, 213066.4f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 48;
				}
				break;
			...
			case 48:
				...
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					func_115(iParam0, "LAMAR_CAR_DRIVE_24", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					if (!ENTITY::IS_ENTITY_DEAD(iParam0->f_35, 0))
					{
						ENTITY::SET_ENTITY_VISIBLE(iParam0->f_35, true, 0);
					}
				...
				func_124(iParam0, 48);
				if (func_122(iParam0, 48, 0))
				{
					MISC::SET_BIT(&(Global_1595693[PLAYER::PLAYER_ID() /*680*/].f_142), 3);
					func_38(iParam0, 10177.75f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 49;
				}
				break;
			...
			case 49:
				...
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					func_115(iParam0, "LAMAR_CAR_DRIVE_25", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					func_113(iParam0, 49);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				func_124(iParam0, 49);
				if (AUDIO::PREPARE_MUSIC_EVENT("FM_INTRO_DRIVE_END") && func_122(iParam0, 49, 0))
				{
					func_36(iParam0, 4500f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 50;
				}
				break;
			...
			case 50:
				...
				if (MISC::IS_BIT_SET(*iParam0, 15))
				{
					func_115(iParam0, "LAMAR_CAR_DRIVE_26", "mp_intro_seq@", -197.9f, 301f, 96.4f, 0f, 0f, 180f, 0, 1065353216);
					if (iParam0->f_292)
					{
						STREAMING::END_SRL();
				...
				if (func_122(iParam0, 50, 0) && MISC::IS_BIT_SET(*iParam0, 20))
				{
			...
			case 55:
				...
				else if (func_126(&(iParam0->f_17), 10000, 0))
				{
					if (func_30(iParam0))
					{
						func_116(iParam0);
			...
			case 56:
				...
				else if (func_126(&(iParam0->f_17), 10000, 0))
				{
					if (func_100(iParam0))
					{
						...
						NETWORK::NETWORK_OVERRIDE_CLOCK_TIME(0, 0, 0);
						MISC::SET_BIT(&(Global_1595693[PLAYER::PLAYER_ID() /*680*/].f_142), 3);
						iParam0->f_13 = (MISC::GET_GAME_TIMER() - func_27(iParam0, 48, 0));
						iParam0->f_293 = 1;
						func_38(iParam0, 10177.75f);
						MISC::SET_BIT(iParam0, 15);
						iParam0->f_6 = 49;
		...
		if (!iParam0->f_291)
		{
			...
			{
				iParam0->f_289 = SYSTEM::TO_FLOAT(func_35(iParam0));
			}
...
void func_3(bool bParam0)
{
	if (bParam0)
	{
		if (!MISC::IS_BIT_SET(Global_1595693[PLAYER::PLAYER_ID() /*680*/].f_142, 18))
		{
			MISC::SET_BIT(&(Global_1595693[PLAYER::PLAYER_ID() /*680*/].f_142), 18);
		}
	}
	else if (MISC::IS_BIT_SET(Global_1595693[PLAYER::PLAYER_ID() /*680*/].f_142, 18))
	{
		MISC::CLEAR_BIT(&(Global_1595693[PLAYER::PLAYER_ID() /*680*/].f_142), 18);
	}
}
...
void func_5(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_58[iParam0->f_90]))
	{
		...
		vVar0 = { ENTITY::GET_ENTITY_COORDS(iParam0->f_58[iParam0->f_90], 1) };
		if (vVar0.z < -50f)
		{
...
void func_10(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	if (func_13())
	{
		iVar0 = Global_2547365[iParam0 /*3*/][func_11(iParam2)];
		if (iVar0 != 0)
		{
...
void func_14(int iParam0, bool bParam1, bool bParam2)
{
	if (!MISC::IS_BIT_SET(*iParam0, 0))
	{
		...
		func_15(0);
		func_131(1);
		Global_2512808.f_1821 = 0;
		Global_2512808.f_1820 = 0;
		if (AUDIO::IS_AUDIO_SCENE_ACTIVE("MP_INTRO_RACE_SCENE"))
		{
			AUDIO::STOP_AUDIO_SCENE("MP_INTRO_RACE_SCENE");
		}
...
void func_32(bool bParam0)
{
	if (bParam0)
	{
		MISC::SET_BIT(&(Global_1595693[PLAYER::PLAYER_ID() /*680*/].f_146), 22);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_1595693[PLAYER::PLAYER_ID() /*680*/].f_146), 22);
	}
}

bool func_33(int iParam0)
{
	return MISC::IS_BIT_SET(Global_1595693[iParam0 /*680*/].f_146, 22);
}
...
void func_34(bool bParam0)
{
	if (bParam0)
	{
		MISC::SET_BIT(&(Global_1595693[PLAYER::PLAYER_ID() /*680*/].f_142), 4);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_1595693[PLAYER::PLAYER_ID() /*680*/].f_142), 4);
	}
}
...
{
	func_37(iParam0->f_34, 7, "FMINTRO", fParam1, 1);
}

void func_37(int iParam0, int iParam1, char* sParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
{
	func_37(iParam0->f_34, 6, "FMINTRO", fParam1, 1);
}
...
bool func_43(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_50()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_53(Global_104555.f_2353.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_51(iVar0) && (!func_54(14) || Global_103506))
			{
...
void func_66(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
{
	func_37(iParam0->f_34, 5, "FMINTRO", fParam1, 0);
}
...
void func_69(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_73(PLAYER::PLAYER_ID())) && !func_71(PLAYER::PLAYER_ID(), 0)) && !func_70())
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_73(PLAYER::PLAYER_ID()))
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_70854 = 0;
...
void func_77(int iParam0)
{
	...
	while (iVar0 < 7)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0->f_104[iVar0], 0))
		{
			...
			CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iParam0->f_104[iVar0], func_78(iVar0), 0, 0, 64);
		}
		iVar0++;
	}
}
...
{
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_84(iParam1));
...
void func_90(int iParam0, char* sParam1, char* sParam2, int iParam3, vector3 vParam4, vector3 vParam5)
{
...
void func_92()
{
	...
	while (iVar0 < 7)
	{
		CUTSCENE::_0x4C61C75BEE8184C2(func_78(iVar0), 0, 1);
		iVar0++;
	}
}
...
{
	if ((uParam0->f_295 && uParam0->f_112[iParam1] != -1) && func_96(PLAYER::INT_TO_PLAYERINDEX(uParam0->f_112[iParam1]), 0, 1))
	{
		return 1;
	}
	return 0;
...
int func_97(var uParam0, int iParam1)
{
	...
	{
		return func_81(PLAYER::INT_TO_PLAYERINDEX(uParam0->f_112[iParam1]));
	}
...
void func_98(var uParam0)
{
	...
	while (iVar1 < 32)
	{
		...
		if (func_96(iVar2, 0, 1))
		{
			if (PLAYER::PLAYER_ID() != iVar2)
			{
				if (iVar0 < 4)
				{
					uParam0->f_112[func_99(iVar0)] = iVar1;
					iVar0++;
				}
			}
		}
	...
	if (!MISC::IS_BIT_SET(iParam0->f_3, 0))
	{
		...
		if (func_103(iParam0))
		{
			if (func_102(iParam0))
			{
				...
				while (iVar0 < 8)
				{
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_84(iVar0));
					iVar0++;
				}
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_82());
...
int func_103(var uParam0)
{
	...
	if (!MISC::IS_BIT_SET(uParam0->f_2, 31))
	{
		...
		while (iVar3 < 8)
		{
			func_108(iVar3, &vVar1, &fVar2);
			if (!func_107(vVar1, 0f, 0f, 0f, 0))
			{
...
void func_109()
{
	STREAMING::REQUEST_MODEL(func_82());
...
void func_111()
{
	...
	while (iVar0 < 8)
	{
		STREAMING::REQUEST_MODEL(func_84(iVar0));
		iVar0++;
	}
}

void func_112(int iParam0, float fParam1, float fParam2)
{
	func_37(iParam0->f_92[0], 100, "FM_Intro_uber", fParam1, 0);
	func_37(iParam0->f_92[1], 101, "FM_Intro_uber", fParam1, 0);
	func_37(iParam0->f_92[2], 102, "FM_Intro_uber", (fParam1 + fParam2), 0);
	func_37(iParam0->f_92[3], 103, "FM_Intro_uber", fParam1, 0);
	func_37(iParam0->f_92[4], 104, "FM_Intro_uber", fParam1, 0);
}
...
void func_113(int iParam0, int iParam1)
{
	...
	{
		case 14:
			func_114(iParam0, 0, -2997.174f, 330.9234f, 14.2341f, -15.97f, &iVar1, 1);
			func_114(iParam0, 2, -2983.9f, 423.7414f, 14.4122f, -5.25f, &iVar1, 1);
			break;
		
		case 15:
			func_114(iParam0, 1, -2622.208f, -109.3386f, 19.2643f, 39.34f, &iVar1, 1);
			func_114(iParam0, 3, -2583.95f, -143.6469f, 20.6224f, 48.89f, &iVar1, 1);
			func_114(iParam0, 7, -2552.145f, -169.0495f, 19.8664f, 60.04f, &iVar1, 1);
			func_114(iParam0, 8, -2531.474f, -174.4581f, 19.2269f, 58.09f, &iVar1, 1);
			break;
		...
		case 17:
			func_114(iParam0, 0, -2420.618f, -232.2668f, 15.3525f, 57.71f, &iVar1, 1);
			func_114(iParam0, 2, -2399.709f, -249.2471f, 14.9551f, 58.19f, &iVar1, 1);
			func_114(iParam0, 4, -2568.499f, -153.4655f, 20.4075f, 54.1f, &iVar1, 1);
			func_114(iParam0, 5, -2485.392f, -198.0737f, 17.5783f, 63.83f, &iVar1, 1);
			func_114(iParam0, 6, -2469.139f, -206.5518f, 17.0201f, 60.64f, &iVar1, 1);
			func_114(iParam0, 9, -2408.733f, -238.8328f, 15.2055f, 59.84f, &iVar1, 1);
			break;
		
		case 18:
			func_114(iParam0, 1, -2146.384f, -323.4933f, 12.0429f, 14.8813f, &iVar1, 1);
			func_114(iParam0, 3, -2075.444f, -374.131f, 11.556f, 56.66f, &iVar1, 1);
			func_114(iParam0, 7, -2160.252f, -294.0829f, 12.5163f, 163.95f, &iVar1, 1);
			func_114(iParam0, 8, -2191.429f, -335.8769f, 12.7225f, 84.71f, &iVar1, 1);
			break;
		
		case 19:
			func_114(iParam0, 0, -1833.87f, -561.7711f, 11.0989f, 48.11f, &iVar1, 1);
			func_114(iParam0, 1, -1630.587f, -685.6821f, 16.5351f, 58.23f, &iVar1, 1);
			func_114(iParam0, 2, -1668.738f, -662.7587f, 14.7925f, 60.52f, &iVar1, 1);
			func_114(iParam0, 3, -1564.946f, -738.6324f, 10.7672f, 68.32f, &iVar1, 1);
			func_114(iParam0, 4, -1706.507f, -720.8959f, 9.6281f, -132.94f, &iVar1, 1);
			func_114(iParam0, 5, -1626.756f, -769.9745f, 10.2367f, -128.8f, &iVar1, 1);
			func_114(iParam0, 6, -1782.764f, -610.5726f, 10.3008f, 52.34f, &iVar1, 1);
			func_114(iParam0, 7, -1595.258f, -733.587f, 10.8576f, 68.39f, &iVar1, 1);
			func_114(iParam0, 8, -1751.892f, -682.1017f, 9.6795f, -134.89f, &iVar1, 1);
			func_114(iParam0, 9, -1742.098f, -642.5658f, 9.8169f, 48.19f, &iVar1, 1);
			break;
		
		case 33:
			func_114(iParam0, 0, -934.4687f, -2716.038f, 12.7365f, 309.2312f, &iVar1, 0);
			func_114(iParam0, 5, -975.6617f, -2733.517f, 12.8172f, 267.4944f, &iVar1, 0);
			break;
		...
		case 36:
			func_114(iParam0, 6, -850.1183f, -2615.271f, 14.1979f, 327.7461f, &iVar1, 0);
			break;
		...
		case 38:
			func_114(iParam0, 0, -712.0925f, -1983.516f, 25.688f, -167.99f, &iVar1, 0);
			func_114(iParam0, 1, -533.9934f, -2004.727f, 26.9085f, 58.71f, &iVar1, 0);
			func_114(iParam0, 2, -653.3551f, -2047.782f, 27.3566f, -112.14f, &iVar1, 0);
			func_114(iParam0, 3, -663.821f, -1934.85f, 27.1417f, -121.65f, &iVar1, 0);
			func_114(iParam0, 4, -656.6017f, -2009.078f, 30.0188f, -106.53f, &iVar1, 0);
			func_114(iParam0, 5, -502.696f, -2023.068f, 26.2376f, 60.2827f, &iVar1, 0);
			func_114(iParam0, 6, -460.1447f, -2044.032f, 26.2371f, 63.9022f, &iVar1, 0);
			func_114(iParam0, 7, -624.7944f, -1960.975f, 26.29f, 237.3848f, &iVar1, 0);
			func_114(iParam0, 8, -463.0545f, -1998.255f, 36.6533f, 27.85f, &iVar1, 0);
			func_114(iParam0, 9, -473.4099f, -1950.213f, 24.7576f, 37.16f, &iVar1, 0);
			func_114(iParam0, 10, -574.5834f, -1994.9f, 26.2871f, 236.0571f, &iVar1, 0);
			func_114(iParam0, 11, -546.7894f, -2012.781f, 26.3137f, 235.9205f, &iVar1, 0);
			func_114(iParam0, 12, -584.929f, -1970.332f, 26.2437f, 55.8826f, &iVar1, 0);
			func_114(iParam0, 13, -633.4936f, -1937.682f, 26.2413f, 54.9911f, &iVar1, 0);
			func_114(iParam0, 14, -601.2188f, -1941.419f, 17.4986f, 148.6622f, &iVar1, 0);
			break;
		
		case 39:
			func_114(iParam0, 4, -499.2335f, -1906.532f, 16.3534f, 133.5751f, &iVar1, 0);
			func_114(iParam0, 9, -518.8654f, -1918.144f, 16.3355f, 134.6305f, &iVar1, 0);
			break;
		
		case 40:
			func_114(iParam0, 3, -270.2197f, -1499.752f, 29.4309f, -13.07f, &iVar1, 0);
			func_114(iParam0, 7, -313.1461f, -1559.589f, 24.2966f, 145.66f, &iVar1, 0);
			func_114(iParam0, 8, -301.9485f, -1550.052f, 25.5595f, 146.95f, &iVar1, 0);
			break;
		...
		case 43:
			func_114(iParam0, 1, 246.1231f, -238.5137f, 52.9482f, 251.5966f, &iVar1, 0);
			func_114(iParam0, 2, 214.2755f, -202.6486f, 53.5033f, 70.72f, &iVar1, 0);
			func_114(iParam0, 6, 263.1977f, -115.1292f, 69.0366f, 155.02f, &iVar1, 0);
			break;
		
		case 44:
			func_114(iParam0, 0, 392.6941f, 239.868f, 102.5932f, 159.15f, &iVar1, 0);
			func_114(iParam0, 7, 375.2224f, 192.316f, 102.0397f, 160.4247f, &iVar1, 0);
			func_114(iParam0, 12, 377.4185f, 166.3668f, 102.0407f, 337.9135f, &iVar1, 0);
			break;
		
		case 45:
			func_114(iParam0, 1, 267.8363f, 181.3352f, 103.7037f, 71.7724f, &iVar1, 0);
			func_114(iParam0, 3, 216.3894f, 211.8832f, 105.2308f, -19.82f, &iVar1, 0);
			func_114(iParam0, 4, 290.3365f, 172.6194f, 103.7313f, 67.09f, &iVar1, 0);
			func_114(iParam0, 5, 283.6507f, 155.574f, 103.264f, 252.0678f, &iVar1, 0);
			func_114(iParam0, 8, 309.5128f, 156.7439f, 103.3183f, -112.52f, &iVar1, 0);
			func_114(iParam0, 9, 249.0189f, 168.3015f, 104.5421f, -112.05f, &iVar1, 0);
			func_114(iParam0, 11, 313.7221f, 144.8591f, 102.6542f, 249.0527f, &iVar1, 0);
			func_114(iParam0, 13, 171.2032f, 216.4137f, 105.2411f, 69.1778f, &iVar1, 0);
			break;
		...
		case 47:
			func_114(iParam0, 2, 226.2312f, 176.6035f, 104.3217f, 252.5577f, &iVar1, 0);
			func_114(iParam0, 6, 247.4283f, 168.6965f, 103.9378f, 250.2977f, &iVar1, 0);
			func_114(iParam0, 7, 211.375f, 181.7446f, 104.561f, 250.2252f, &iVar1, 0);
			break;
		...
		case 49:
			func_114(iParam0, 2, -192.4192f, 249.71f, 91.7534f, -99.42f, &iVar1, 0);
			func_114(iParam0, 3, -45.3246f, 256.5581f, 105.0516f, 272.9104f, &iVar1, 0);
			func_114(iParam0, 4, -24.1551f, 272.3286f, 106.4563f, 96.6005f, &iVar1, 0);
			func_114(iParam0, 5, 6.5526f, 270.3987f, 108.268f, 84.5591f, &iVar1, 0);
			func_114(iParam0, 6, -124.1576f, 245.0871f, 96.1105f, -89.91f, &iVar1, 0);
			func_114(iParam0, 7, -140.9613f, 262.532f, 94.5308f, 87.51f, &iVar1, 0);
			func_114(iParam0, 9, -83.4766f, 247.5941f, 99.488f, 275.7796f, &iVar1, 0);
			func_114(iParam0, 10, -215.5077f, 252.4543f, 91.0469f, 264.726f, &iVar1, 0);
			break;
...
void func_114(var uParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4, bool bParam5)
{
...
void func_115(int iParam0, char* sParam1, char* sParam2, vector3 vParam3, vector3 vParam4, float fParam5, float fParam6)
{
	if (!CAM::DOES_CAM_EXIST(iParam0->f_8))
	{
		iParam0->f_8 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
...
int func_122(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_27(iParam0, iParam1, 0);
	if (iParam0->f_293)
	{
	...
	else if (iVar0 + iParam2) <= func_35(iParam0)
	{
		return 1;
	}
	return 0;
...
{
	if (func_122(iParam0, iParam1, 0))
	{
		if (iParam0->f_293)
		{
			iParam0->f_13 = (MISC::GET_GAME_TIMER() - func_27(iParam0, iParam1, 0));
		}
		else
		{
			iParam0->f_291 = 1;
...
int func_126(var uParam0, int iParam1, bool bParam2)
{
	if (iParam1 == -1)
	{
		return 1;
	}
	func_181(uParam0, bParam2, 0);
...
Vector3 func_128(vector3 vParam0)
{
...
void func_136(int iParam0, bool bParam1, int iParam2)
{
	switch (iParam0)
	{
		case 5:
...
struct<6> func_150(int iParam0, bool bParam1)
{
	struct<6> Var0;
...
int func_151()
{
	return Global_2457987;
}

bool func_152()
{
	return Global_2456828;
}
...
{
	if ((func_166() == 1 || HUD::IS_PAUSE_MENU_ACTIVE()) || iParam0)
	{
		func_165(0);
...
void func_172(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6)
{
	int iVar0;
	...
	func_173(PLAYER::PLAYER_ID(), 0, iVar0);
	if (bParam5)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && PLAYER::IS_PLAYER_PLAYING(iParam0))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_71(PLAYER::PLAYER_ID(), 0) && !func_74()))
				{
			...
			if (bParam1)
			{
				if (!func_177(iVar25) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar25))
				{
					if (!bVar21)
					{
			...
			else
			{
				if (!func_177(iVar25) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar25))
				{
					...
					if (func_174(Global_4456448.f_143970))
					{
...
void func_183(bool bParam0)
{
	if (bParam0)
	{
		if (!MISC::IS_BIT_SET(Global_1595693[PLAYER::PLAYER_ID() /*680*/].f_142, 8))
		{
			MISC::SET_BIT(&(Global_1595693[PLAYER::PLAYER_ID() /*680*/].f_142), 8);
		}
	}
	else if (MISC::IS_BIT_SET(Global_1595693[PLAYER::PLAYER_ID() /*680*/].f_142, 8))
	{
		MISC::CLEAR_BIT(&(Global_1595693[PLAYER::PLAYER_ID() /*680*/].f_142), 8);
	}
}

bool func_184()
{
	return MISC::IS_BIT_SET(Global_1595693[PLAYER::PLAYER_ID() /*680*/].f_142, 8);
}
...
void func_186(int iParam0)
{
	...
	else
	{
		...
		if (iParam0->f_6 > 31)
		{
			if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_1656128))
			{
				if (iParam0->f_5 < 23)
				{
					switch (iParam0->f_5)
					{
						case 0:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 33)
								{
									if (((LOCALE::_GET_CURRENT_LANGUAGE_ID() == 9 || LOCALE::_GET_CURRENT_LANGUAGE_ID() == 10) || LOCALE::_GET_CURRENT_LANGUAGE_ID() == 8) || LOCALE::_GET_CURRENT_LANGUAGE_ID() == 12)
									{
										func_191("artdir", 0f, 420f, "left", 0.3f, 0.3f);
									}
									else
									{
										func_191("artdir", 0f, 450f, "left", 0.3f, 0.3f);
									}
									func_190("artdir", "Art Director", 175f, "HUD_COLOUR_FRIENDLY", 1);
									func_189("artdir", "AARON GARBUT", 210f, "|", 1);
									func_188("artdir", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_122(iParam0, 33, -3390))
							{
								func_187("artdir", 0.16f);
								iParam0->f_5++;
							}
							break;
						...
						case 1:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (func_122(iParam0, 33, -2940))
								{
									func_191("techdir", 0f, 30f, "left", 0.3f, 0.3f);
									func_190("techdir", "Technical Director", 100f, "HUD_COLOUR_NET_PLAYER1", 1);
									func_189("techdir", "ADAM FOWLER", 185f, "|", 1);
									func_188("techdir", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_122(iParam0, 33, -450))
							{
								func_187("techdir", 0.16f);
								iParam0->f_5++;
							}
							break;
						...
						case 2:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 35)
								{
									func_191("assartdir", 0f, 100f, "left", 0.3f, 0f);
									func_190("assartdir", "Associate Art Directors", 20f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_189("assartdir", "ADAM COCHRANE|MICHAEL KANE", 100f, "|", 1);
									func_188("assartdir", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (iParam0->f_6 > 35)
							{
								func_187("assartdir", 0f);
								iParam0->f_5++;
							}
							break;
						...
						case 3:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 36)
								{
									if (((LOCALE::_GET_CURRENT_LANGUAGE_ID() == 9 || LOCALE::_GET_CURRENT_LANGUAGE_ID() == 10) || LOCALE::_GET_CURRENT_LANGUAGE_ID() == 8) || LOCALE::_GET_CURRENT_LANGUAGE_ID() == 12)
									{
										func_191("asstecdir", 0f, 370f, "right", 0.3f, 0.3f);
									}
									else
									{
										func_191("asstecdir", 0f, 400f, "right", 0.3f, 0.3f);
									}
									func_190("asstecdir", "Associate Technical Directors", 0f, "HUD_COLOUR_NET_PLAYER3", 1);
									func_189("asstecdir", "KLAAS SCHILSTRA|PHIL HOOKER", 150f, "|", 1);
									func_188("asstecdir", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_122(iParam0, 36, -4740))
							{
								func_187("asstecdir", 0.16f);
								iParam0->f_5++;
							}
							break;
						...
						case 4:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (func_122(iParam0, 36, -3810))
								{
									func_191("leadprog", 30f, 20f, "right", 0.3f, 0.3f);
									func_190("leadprog", "Lead Programmers", 0f, "HUD_COLOUR_FRIENDLY", 1);
									func_189("leadprog", "DANIEL YELLAND|ROBERT TRICKEY", 145f, "|", 1);
									func_188("leadprog", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_122(iParam0, 36, -600))
							{
								func_187("leadprog", 0.16f);
								iParam0->f_5++;
							}
							break;
						...
						case 5:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 37)
								{
									if (((LOCALE::_GET_CURRENT_LANGUAGE_ID() == 9 || LOCALE::_GET_CURRENT_LANGUAGE_ID() == 10) || LOCALE::_GET_CURRENT_LANGUAGE_ID() == 8) || LOCALE::_GET_CURRENT_LANGUAGE_ID() == 12)
									{
										func_191("senprog", 0f, 200f, "left", 0.3f, 0.3f);
									}
									else
									{
										func_191("senprog", 0f, 225f, "left", 0.3f, 0.3f);
									}
									func_190("senprog", "Senior Programmers", 20f, "HUD_COLOUR_NET_PLAYER1", 1);
									func_189("senprog", "JOHN HYND|JOHN GURNEY|DAN CONTI|ROSS CHILDS|STEPHEN LaVALLEY", 75f, "|", 1);
									func_188("senprog", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_122(iParam0, 37, -1350))
							{
								func_187("senprog", 0.16f);
								iParam0->f_5++;
							}
							break;
						...
						case 6:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 38)
								{
									func_191("prog", 0f, 100f, "left", 0.3f, 0.3f);
									func_190("prog", "Programmers", 35f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_189("prog", "MIGUEL FREITAS|STUART ROSKELL|ALLAN WALTON|PAU AGUILAR FRUTO", 100f, "|", 1);
									func_188("prog", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_122(iParam0, 38, -4320))
							{
								func_187("prog", 0.16f);
								iParam0->f_5++;
							}
						...
						case 7:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (func_122(iParam0, 38, -3240))
								{
									if (((LOCALE::_GET_CURRENT_LANGUAGE_ID() == 9 || LOCALE::_GET_CURRENT_LANGUAGE_ID() == 10) || LOCALE::_GET_CURRENT_LANGUAGE_ID() == 8) || LOCALE::_GET_CURRENT_LANGUAGE_ID() == 12)
									{
										func_191("socclub", 40f, 305f, "right", 0.3f, 0.3f);
									}
									else
									{
										func_191("socclub", 40f, 325f, "right", 0.3f, 0.3f);
									}
									func_190("socclub", "Social Club", 0f, "HUD_COLOUR_NET_PLAYER3", 1);
									func_189("socclub", "IAN McFARLAND|KEVIN BACA", 40f, "|", 1);
									func_188("socclub", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_122(iParam0, 38, -870))
							{
								func_187("socclub", 0.16f);
								iParam0->f_5++;
							}
							break;
						...
						case 8:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 39)
								{
									func_191("audio", 0f, 10f, "right", 0.3f, 0.3f);
									func_190("audio", "Audio", 0f, "HUD_COLOUR_FRIENDLY", 1);
									func_189("audio", "MATTHEW SMITH|CRAIG CONNER|ALASTAIR MacGREGOR|JEFFREY WHITCHER", 35f, "|", 1);
									func_188("audio", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_122(iParam0, 39, -1620))
							{
								func_187("audio", 0.16f);
								iParam0->f_5++;
							}
							break;
						...
						case 9:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 40)
								{
									func_191("scrlead", 50f, 85f, "right", 0.3f, 0.3f);
									func_190("scrlead", "Script Leads", 0f, "HUD_COLOUR_NET_PLAYER1", 1);
									func_189("scrlead", "BOBBY WRIGHT|KEITH McLEMAN|BRENDA CAREY|ROWAN COCKCROFT|NEIL FERGUSON|RYAN BAKER", 60f, "|", 1);
									func_188("scrlead", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_122(iParam0, 40, -1470))
							{
								func_187("scrlead", 0.16f);
								iParam0->f_5++;
							}
							break;
						...
						case 10:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 41)
								{
									func_191("script1", 0f, 10f, "left", 0.3f, 0.3f);
									func_190("script1", "Scripters", 20f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_189("script1", "CONOR McGUIRE|JAMES ADWICK|DAVID WATSON|NEIL BEGGS|WILLIAM KENNEDY", 80f, "|", 1);
									func_188("script1", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_122(iParam0, 41, -1200))
							{
								func_187("script1", 0.16f);
								iParam0->f_5++;
							}
							break;
						...
						case 11:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 42)
								{
									func_191("script2", 0f, 10f, "left", 0.3f, 0.3f);
									func_190("script2", "Scripters", 20f, "HUD_COLOUR_NET_PLAYER3", 1);
									func_189("script2", "DAVID GENTLES|BEN HINCHLIFFE|KEVIN WONG|CHRISTOPHER SPEIRS|CHRIS McMAHON", 80f, "|", 1);
									func_188("script2", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_122(iParam0, 42, -1320))
							{
								func_187("script2", 0.16f);
								iParam0->f_5++;
							}
							break;
						...
						case 12:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 43)
								{
									func_191("visdes", 0f, 45f, "left", 0.2f, 0.2f);
									func_190("visdes", "Visual Design", 30f, "HUD_COLOUR_FRIENDLY", 1);
									func_189("visdes", "THOMAS DIAKOMICHALIS|KARMEN COKER|LUKE HOWARD| | |", 67f, "|", 1);
									func_190("visdes", "Character Creator", 100f, "HUD_COLOUR_FRIENDLY", 1);
									func_189("visdes", "STUART HANSELL|STEWART WRIGHT|FLAVIUS ALECU", 147f, "|", 1);
									func_188("visdes", 0.05f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_122(iParam0, 43, -1320))
							{
								func_187("visdes", 0.05f);
								iParam0->f_5++;
							}
							break;
						...
						case 13:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 44)
								{
									func_191("uides", 40f, 20f, "right", 0f, 0.3f);
									func_190("uides", "UI Design & Development", 0f, "HUD_COLOUR_NET_PLAYER1", 1);
									func_189("uides", "STUART PETRI|STEVE WALSH|GARETH EVANS|JEFFREY KHAN|CHRIS EDWARDS", 110f, "|", 1);
									func_188("uides", 0f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_122(iParam0, 45, -1650))
							{
								func_187("uides", 0.16f);
								iParam0->f_5++;
							}
							break;
						...
						case 14:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 46)
								{
									func_191("concre", 0f, 20f, "left", 0f, 0.3f);
									func_190("concre", "Content Creation", 40f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_189("concre", "CALLUM MUNGALL|CHRIS McCALLUM|JESSE HOLCROFT|JOE STAFFORD", 80f, "|", 1);
									func_189("concre", "JOSHUA MATTYASOVSZKY|MARTIN LOGAN|STEFAN WEBSTER", 80f, "|", 1);
									func_188("concre", 0f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_122(iParam0, 46, -1950))
							{
								func_187("concre", 0.16f);
								iParam0->f_5++;
							}
							break;
						...
						case 15:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 47)
								{
									func_191("devass", 0f, 400f, "right", 0f, 0f);
									func_190("devass", "Development Assistants", 0f, "HUD_COLOUR_NET_PLAYER3", 1);
									func_189("devass", "FIONN WRIGHT|KATIE PICA", 100f, "|", 1);
									func_188("devass", 0f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 16:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 48)
								{
									func_191("qasup", 20f, 0f, "right", 0.3f, 0.3f);
									func_190("qasup", "QA Supervisor", 0f, "HUD_COLOUR_FRIENDLY", 1);
									func_189("qasup", "ADAM WHITING| ", 50f, "|", 1);
									func_190("qasup", "Lead Test Analyst", 50f, "HUD_COLOUR_FRIENDLY", 1);
									func_189("qasup", "CHRIS THOMSON", 160f, "|", 1);
									func_188("qasup", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_122(iParam0, 48, -1320))
							{
								func_187("qasup", 0.16f);
								iParam0->f_5++;
							}
							break;
						...
						case 17:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 49)
								{
									func_191("senta", 0f, 25f, "left", 0.3f, 0.3f);
									func_190("senta", "Senior Test Analysts", 30f, "HUD_COLOUR_NET_PLAYER1", 1);
									func_189("senta", "MICHAEL BURTON|ROSS PARKER|SEAN CASEY", 120f, "|", 1);
									func_188("senta", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_122(iParam0, 49, -5070))
							{
								func_187("senta", 0.16f);
								iParam0->f_5++;
							}
							break;
						...
						case 18:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (func_122(iParam0, 49, -3750))
								{
									func_191("asspro", 20f, 350f, "right", 0.3f, 0.3f);
									func_190("asspro", "Assistant Producer", 0f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_189("asspro", "JOSH NEEDLEMAN", 75f, "|", 1);
									func_188("asspro", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_122(iParam0, 49, -720))
							{
								func_187("asspro", 0.16f);
								iParam0->f_5++;
							}
							break;
						...
						case 19:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (func_79(iParam0))
								{
									...
									{
										func_191("animdir", 0f, 95f, "left", 0.3f, 0.3f);
										func_190("animdir", "Animation Director", 110f, "HUD_COLOUR_NET_PLAYER3", 1);
										func_189("animdir", "ROB NELSON", 200f, "|", 1);
										func_188("animdir", 0.16f);
										MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
									}
								}
								else if (iParam0->f_6 >= 50)
								{
									func_191("animdir", 50f, 90f, "right", 0.3f, 0.3f);
									func_190("animdir", "Animation Director", 0f, "HUD_COLOUR_NET_PLAYER3", 1);
									func_189("animdir", "ROB NELSON", 90f, "|", 1);
									func_188("animdir", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 20:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (func_79(iParam0))
								{
									...
									{
										func_191("producer", 65f, 55f, "right", 0f, 0f);
										func_190("producer", "Producer", 0f, "HUD_COLOUR_FRIENDLY", 1);
										func_189("producer", "ANDY DUTHIE", 20f, "|", 1);
										func_188("producer", 0f);
										MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
									}
								}
								else if (CUTSCENE::IS_CUTSCENE_PLAYING() && CUTSCENE::GET_CUTSCENE_TIME() > 2452)
								{
									func_191("producer", 0f, 100f, "left", 0.3f, 0f);
									func_190("producer", "Producer", 80f, "HUD_COLOUR_FRIENDLY", 1);
									func_189("producer", "ANDY DUTHIE", 110f, "|", 1);
									func_188("producer", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_79(iParam0))
						...
						case 21:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (func_79(iParam0))
								{
									...
									{
										func_191("vpcre", 65f, 55f, "right", 0.3f, 0.3f);
										func_190("vpcre", "VP of Creative", 0f, "HUD_COLOUR_NET_PLAYER1", 1);
										func_189("vpcre", "DAN HOUSER", 80f, "|", 1);
										func_188("vpcre", 0.16f);
										MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
									}
								}
								else if (CUTSCENE::IS_CUTSCENE_PLAYING() && CUTSCENE::GET_CUTSCENE_TIME() > 6921)
								{
									func_191("vpcre", 65f, 80f, "right", 0.3f, 0.3f);
									func_190("vpcre", "VP of Creative", 0f, "HUD_COLOUR_NET_PLAYER1", 1);
									func_189("vpcre", "DAN HOUSER", 80f, "|", 1);
									func_188("vpcre", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
						...
						case 22:
							if (!MISC::IS_BIT_SET(iParam0->f_4, iParam0->f_5))
							{
								if (func_79(iParam0))
								{
									...
									{
										Global_1656130 = 0;
										func_191("execpro", 0f, 375f, "left", 0.3f, 0.3f);
										func_190("execpro", "Executive Producer", 70f, "HUD_COLOUR_NET_PLAYER2", 1);
										func_189("execpro", "SAM HOUSER", 165f, "|", 1);
										func_188("execpro", 0.16f);
										MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
									}
								}
								...
								{
									Global_1656130 = 0;
									func_191("execpro", 0f, 340f, "left", 0.3f, 0.3f);
									func_190("execpro", "Executive Producer", 100f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_189("execpro", "SAM HOUSER", 190f, "|", 1);
									func_188("execpro", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
...
{
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(Global_1656128, "HIDE");
...
void func_188(char* sParam0, float fParam1)
{
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(Global_1656128, "SHOW_CREDIT_BLOCK");
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
	HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_FLOAT(fParam1);
...
void func_189(char* sParam0, char* sParam1, float fParam2, char* sParam3, bool bParam4)
{
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(Global_1656128, "ADD_NAMES_TO_CREDIT_BLOCK");
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
	HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
...
void func_190(char* sParam0, char* sParam1, float fParam2, char* sParam3, bool bParam4)
{
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(Global_1656128, "ADD_ROLE_TO_CREDIT_BLOCK");
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
	HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
...
void func_191(char* sParam0, float fParam1, float fParam2, char* sParam3, float fParam4, float fParam5)
{
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION(Global_1656128, "SETUP_CREDIT_BLOCK");
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
	HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_FLOAT(fParam1);
