...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != 4294967295)
		{
			if (Global_19AC5[Var0 /*10*/].f_9 != 4294967295)
			{
				...
				func_304(&(Global_19AC5[Var0 /*10*/].f_9));
			}
		}
		func_287(&Var0, 1);
	}
	...
	if (Var0 == 4)
	{
		func_250(&uLocal_59, 3, Var0.f_1C[0], "BARRY", 0, 1);
	...
	while (true)
	{
		...
		if (func_199(Var0.f_1C[0]))
		{
			if (Var0 == 2)
			{
				if (func_197(&Var0, unk_0x8000C77B5F336760(Var0.f_1C[0], true), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
				{
			...
			{
				if (func_197(&Var0, unk_0x8000C77B5F336760(Var0.f_1C[0], true), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f))
				{
				}
			}
			else if (Var0 == 4)
			{
				func_186(&uLocal_58, unk_0x8000C77B5F336760(Var0.f_1C[0], true), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar2 = 0;
		if (func_185(Var0))
...
void func_47(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x37EB
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x398B
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x39BD
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x39F1
{
	return Global_1407E0;
}

int func_51(int iParam0, int iParam1)//Position - 0x39FD
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3A29
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F71
{
	int iVar0;
...
int func_54()//Position - 0x41B3
{
	func_55();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_55()//Position - 0x41CC
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x42C9
{
	return Global_8D15 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x42D7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x43CA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x4654
{
	switch (iParam0)
	{
		case 3036451504:
...
int func_60(int iParam0)//Position - 0x46EF
{
...
int func_61(int iParam0, int iParam1)//Position - 0x4875
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x53E6
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x5421
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x5695
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x56D1
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_66(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x5C2C
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5C70
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x634F
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x6396
{
...
bool func_70(int iParam0)//Position - 0x63F1
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6401
{
...
int func_72(int iParam0)//Position - 0x646B
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x676E
{
	return Global_6373;
}

int func_74(int iParam0)//Position - 0x6779
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6789
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x682B
{
	switch (iParam0)
	{
		case 4294967295:
...
int func_77(int iParam0)//Position - 0x6E00
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6E5E
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6F0C
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6FA1
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6FE5
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x7177
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7C3E
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7CC0
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7D1E
{
	return 4294967295;
}

Vector3 func_87(int iParam0)//Position - 0x7D27
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x7F32
{
	return func_89(CAM::_0xDC9DA9E8789F5246());
}

int func_89(int iParam0)//Position - 0x7F42
{
	return MISC::GET_BITS_IN_RANGE(Global_24FBF9[iParam0 /*413*/].f_135.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x7F5F
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x7F6F
{
	switch (iParam0)
	{
		case 4294967295:
...
int func_128(int iParam0)//Position - 0xA5F9
{
	switch (iParam0)
	{
		case 5:
...
void func_129(var uParam0, bool bParam1, bool bParam2)//Position - 0xA64C
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_199(uParam0->f_1C[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_199(uParam0->f_23[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_199(uParam0->f_29[iVar0]))
		{
...
int func_130(int iParam0)//Position - 0xA741
{
	switch (iParam0)
	{
		case 5:
...
void func_131(bool bParam0)//Position - 0xA7AC
{
	int iVar0;
...
void func_132(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA7E9
{
	if (bParam0)
	{
...
int func_135(int iParam0, bool bParam1)//Position - 0xA97A
{
	int iVar0;
	int iVar1;
...
int func_136(int iParam0)//Position - 0xA9BB
{
...
bool func_137()//Position - 0xA9FD
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_240006, 3);
}

int func_138(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xAA0E
{
	int iVar0;
...
int func_141(char* sParam0)//Position - 0xAA8B
{
...
void func_142()//Position - 0xAAC8
{
	Global_3960 = 0;
	func_143();
}

void func_143()//Position - 0xAAD8
{
...
int func_147(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xABBE
{
...
void func_148(int iParam0)//Position - 0xAD4D
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
...
void func_150(int iParam0)//Position - 0xADCA
{
	if (func_154())
	{
		return;
...
void func_151(int iParam0)//Position - 0xADFD
{
	if (func_154())
	{
		return;
...
void func_152(bool bParam0, bool bParam1)//Position - 0xAE77
{
	if (bParam0)
	{
		if (func_153(0))
...
int func_153(int iParam0)//Position - 0xAEEB
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
bool func_154()//Position - 0xAF45
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

int func_155(int iParam0)//Position - 0xAF57
{
...
int func_156(int iParam0)//Position - 0xAF98
{
	int iVar0;
...
void func_157(int iParam0)//Position - 0xAFDD
{
...
int func_158(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xB00F
{
	int iVar0;
...
void func_159(var uParam0, int iParam1)//Position - 0xB146
{
	int iVar0;
...
bool func_160(int iParam0)//Position - 0xB195
{
	return func_161(iParam0, Global_8D15);
}

int func_161(int iParam0, int iParam1)//Position - 0xB1A6
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_162(int iParam0)//Position - 0xB387
{
	if (Global_8D15 == 15)
	{
		return 0;
...
int func_163()//Position - 0xB3A9
{
	return func_164(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_164(char* sParam0, int iParam1)//Position - 0xB3BA
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_166(int iParam0, int iParam1)//Position - 0xB427
{
	switch (iParam0)
	{
		case 0:
...
int func_167(vector3 vParam0, bool bParam1)//Position - 0xB8AE
{
	int iVar0;
...
float func_168(bool bParam0, float fParam1, float fParam2)//Position - 0xB8DA
{
	if (bParam0)
	{
		return fParam1;
...
int func_169(int iParam0)//Position - 0xB8F1
{
	switch (iParam0)
	{
		case 0:
...
int func_170(int iParam0, int iParam1)//Position - 0xB980
{
	switch (iParam0->f_10)
	{
		case 0:
			if (*iParam0 == 12)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, true, 0))
				{
					if (func_199(iParam0->f_1C[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iParam0->f_1C[0], true), true) < 3f)
						{
							if (func_176(2))
							{
								if (func_174(iParam0->f_1B))
								{
									func_173(iParam0->f_1B, *iParam0);
				...
				else if (func_199(iParam0->f_1C[0]))
				{
					if (func_172(iParam0))
					{
						if (func_176(2))
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
				{
					if (func_199(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
					{
...
void func_171()//Position - 0xC166
{
	func_27(&(Global_17998.f_B3B), &Global_17998, 0, 1, 1, 0);
}

int func_172(var uParam0)//Position - 0xC181
{
	float fVar0;
...
void func_173(int iParam0, int iParam1)//Position - 0xC20F
{
	if (iParam0 == 1)
	{
		if (!func_128(iParam1))
...
int func_174(bool bParam0)//Position - 0xC273
{
	int iVar0;
...
int func_175(int iParam0)//Position - 0xC30A
{
	if (func_199(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
int func_176(int iParam0)//Position - 0xC334
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_184()) || Global_19A9D) || Global_6375) || func_183()) || func_182(8, 4294967295)) || func_92()) || func_181()) || func_180()) || func_179()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_184()) || Global_6375) || func_183()) || func_182(8, 4294967295)) || func_180()) || func_92()) || func_181()) || func_179()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_184()) || Global_19A9D) || Global_6375) || func_183()) || func_182(8, 4294967295)) || func_180()) || func_92()) || func_181()) || func_179()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_184()) || Global_19A9D) || Global_6375) || func_183()) || func_182(8, 4294967295)) || func_92()) || func_181()) || func_179()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_184() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_182(8, 4294967295)) || func_179()) || func_178()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_182(8, 4294967295) || func_92()) || func_181()) || func_178()) || func_177())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_184()) || Global_6375) || func_183()) || func_182(8, 4294967295)) || func_181()) || func_180()) || func_179()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_177()//Position - 0xCA51
{
	return Global_16C57.f_1;
}

int func_178()//Position - 0xCA5F
{
...
bool func_181()//Position - 0xCAC9
{
	return Global_16C64.f_148 > 0;
}

bool func_182(int iParam0, int iParam1)//Position - 0xCADA
{
	switch (iParam0)
	{
		case 5:
...
var func_183()//Position - 0xCB15
{
	return Global_140859;
}

int func_184()//Position - 0xCB21
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_185(int iParam0)//Position - 0xCB3D
{
	switch (iParam0)
	{
		case 5:
...
void func_186(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3)//Position - 0xCB60
{
	switch (*uParam0)
	{
		case 0:
		...
		case 1:
			if (func_195(AUDIO::_0x0626A247D2405330(), vParam1, 1) <= 20f)
			{
		...
		case 2:
			...
			else if (func_195(AUDIO::_0x0626A247D2405330(), vParam1, 1) >= 25f)
			{
				func_142();
				*uParam0 = 0;
			}
...
bool func_187(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xCBFD
{
...
int func_188(char* sParam0, int iParam1, bool bParam2)//Position - 0xCC4B
{
	Global_3DCF = 0;
...
void func_194(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD171
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
float func_195(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xD1C7
{
	vector3 vVar0;
...
void func_196(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, int iParam10)//Position - 0xD201
{
	int iVar0;
	int iVar1;
	
	iVar1 = 32768;
	if (!func_199(iParam0->f_1C[iParam10]))
	{
		return;
	}
	if (bParam9)
	...
	BRAIN::TASK_PLAY_ANIM(0, iParam0->f_30, uParam1[uParam1.f_7], 4f, -4f, 4294967295, 0 | iVar1, 0, 0, 0, 0);
	BRAIN::TASK_PLAY_ANIM(0, iParam0->f_30, iParam0->f_30.f_1, 8f, -8f, 4294967295, 1 | iVar1, 0, 0, 0, 0);
	CUTSCENE::_0x8D9DF6ECA8768583(iVar0);
	BRAIN::TASK_PERFORM_SEQUENCE(iParam0->f_1C[iParam10], iVar0);
	BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
}

int func_197(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xD29E
{
	var uVar0;
	
	if ((((func_199(AUDIO::_0x0626A247D2405330()) && func_199(iParam0->f_1C[0])) && !func_144()) && (MISC::GET_GAME_TIMER() - iParam0->f_3C) > iParam6) && func_195(AUDIO::_0x0626A247D2405330(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_250(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
...
void func_198(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD326
{
...
int func_199(int iParam0)//Position - 0xD361
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
...
void func_200(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xD382
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
...
void func_201(int iParam0, bool bParam1)//Position - 0xD473
{
	if (iParam0 == 4294967295)
	{
		return;
...
int func_202(int iParam0)//Position - 0xD4AF
{
	if (Global_11621 == iParam0)
	{
...
void func_203(int iParam0, int iParam1)//Position - 0xD4E8
{
	bool bVar0;
	int iVar1;
...
bool func_204()//Position - 0xD586
{
	return Global_1620C;
}

void func_205(int iParam0)//Position - 0xD592
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_206(iParam0);
...
void func_206(int iParam0)//Position - 0xD5A9
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_207(int iParam0)//Position - 0xD691
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_163();
...
int func_208(int iParam0, bool bParam1)//Position - 0xD6B9
{
	struct<27> Var0;
	...
	func_109(*iParam0, &Var0);
	if ((func_245(*iParam0) || func_243(*iParam0)) || Global_1171A == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (iParam0->f_10 == 2 || iParam0->f_10 == 1)
	{
		if (func_199(iParam0->f_23[0]))
		{
			if (!ENTITY::IS_ENTITY_AT_COORD(iParam0->f_23[0], Var0.f_6, 8f, 8f, 8f, false, true, 0))
			{
				return 0;
			}
		}
	...
	if (*iParam0 == 10)
	{
		if (FIRE::IS_EXPLOSION_IN_SPHERE(4294967295, iParam0->f_11[0 /*3*/], 8f))
		{
	...
	if (func_212(&(iParam0->f_30)) && bParam1)
	{
		func_209(iParam0->f_1C[0], &(iParam0->f_30), *iParam0);
	}
	return 1;
}

void func_209(int iParam0, var uParam1, int iParam2)//Position - 0xD92C
{
	int iVar0;
	int iVar1;
	...
	if (func_199(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				...
				{
					if (func_210(iParam2) && !PED::IS_PED_FACING_PED(iParam0, AUDIO::_0x0626A247D2405330(), 25f))
					{
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, AUDIO::_0x0626A247D2405330(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_211(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_210(iParam2) || PED::IS_PED_FACING_PED(iParam0, AUDIO::_0x0626A247D2405330(), 10f))
				{
					if (func_68(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						BRAIN::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, 4294967295, 262153, 0, 0, 0, 0);
...
int func_210(int iParam0)//Position - 0xDC84
{
...
int func_211(var uParam0)//Position - 0xDCA4
{
...
int func_212(var uParam0)//Position - 0xDCBC
{
...
void func_213(var uParam0)//Position - 0xDCE1
{
	int iVar0;
	int iVar1;
	...
	if (*uParam0 == 52)
	{
		func_214(&(uParam0->f_29[1]));
		func_214(&(uParam0->f_29[2]));
	}
	if (func_199(AUDIO::_0x0626A247D2405330()))
	{
		iVar0 = 0;
...
void func_214(int iParam0)//Position - 0xDFE5
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_215(var uParam0)//Position - 0xE010
{
	int iVar0;
...
int func_216(var uParam0, bool bParam1, bool bParam2)//Position - 0xE090
{
	int iVar0;
	int iVar1;
	int iVar2;
				...
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
					{
						...
						if (func_175(iVar2))
						{
							...
							{
								if (func_175(uParam0->f_23[iVar0]))
								{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_217(AUDIO::_0x0626A247D2405330(), uParam0->f_23[iVar0]))
							{
...
int func_217(int iParam0, int iParam1)//Position - 0xE24E
{
	int iVar0;
...
int func_218(var uParam0, bool bParam1, int iParam2)//Position - 0xE27E
{
	int iVar0;
	int iVar1;
...
int func_219(int iParam0)//Position - 0xE53A
{
...
int func_220(int iParam0, float fParam1)//Position - 0xE56E
{
	float fVar0;
	
	if (func_199(AUDIO::_0x0626A247D2405330()) && func_199(iParam0))
	{
		if (func_231(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iParam0))
		{
...
bool func_221(int iParam0, float fParam1)//Position - 0xE5E4
{
	return func_222(iParam0, AUDIO::_0x0626A247D2405330(), fParam1, 1, 250, 7);
}

bool func_222(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE5FC
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_223(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE6BD
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_224(int iParam0, int iParam1)//Position - 0xE7E9
{
	int iVar0;
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE8F8
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_228(unk_0x8000C77B5F336760(iParam1, true) - unk_0x8000C77B5F336760(iParam0, true)) };
...
float func_227(vector3 vParam0, vector3 vParam1)//Position - 0xE989
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_228(vector3 vParam0)//Position - 0xE9AA
{
	float fVar0;
	float fVar1;
...
void func_229(var uParam0)//Position - 0xE9E9
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_230(int iParam0, int iParam1)//Position - 0xEA04
{
	int iVar0;
...
int func_231(int iParam0)//Position - 0xEA43
{
...
int func_232(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEA6B
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_233(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEB66
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_234(int iParam0, float fParam1)//Position - 0xEC72
{
	var uVar0;
	vector3 vVar1;
...
int func_235(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xED07
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_228(vParam1 - unk_0x8000C77B5F336760(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_236(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xED95
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
...
int func_237(int iParam0)//Position - 0xEDDD
{
...
void func_238(int iParam0)//Position - 0xEE27
{
	int iVar0;
...
int func_239(int iParam0)//Position - 0xEEC4
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_163();
...
int func_240(int iParam0)//Position - 0xEF5C
{
...
int func_243(int iParam0)//Position - 0xEFDE
{
	if ((func_244() && Global_16C30.f_B == 6) && iParam0 == func_164(&(Global_16C30.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_245(int iParam0)//Position - 0xF050
{
	if (func_107(0))
	{
...
void func_246()//Position - 0xF078
{
	...
	if (func_199(AUDIO::_0x0626A247D2405330()))
	{
		if (func_247(AUDIO::_0x0626A247D2405330(), vVar0, fVar1))
		{
			func_149();
		}
	}
...
bool func_247(int iParam0, vector3 vParam1, float fParam2)//Position - 0xF0BA
{
	return SYSTEM::VDIST2(unk_0x8000C77B5F336760(iParam0, true), vParam1) <= (fParam2 * fParam2);
}

void func_248(int iParam0)//Position - 0xF0D7
{
	if (func_199(iParam0->f_1C[0]))
	{
		PED::SET_PED_RESET_FLAG(iParam0->f_1C[0], 64, true);
		PED::SET_PED_RESET_FLAG(iParam0->f_1C[0], 249, true);
...
void func_249(var uParam0)//Position - 0xF146
{
	int iVar0;
	...
	if (*uParam0 == 2 || *uParam0 == 3)
	{
		...
		while (iVar0 <= 5)
		{
			if (func_199(uParam0->f_29[iVar0]))
			{
				unk_0x346478B12F69D4E3(uParam0->f_29[iVar0], false);
			}
			iVar0++;
		}
		if (func_199(uParam0->f_1C[0]))
		{
			unk_0x346478B12F69D4E3(uParam0->f_1C[0], false);
			PED::SET_PED_TO_RAGDOLL(uParam0->f_1C[0], 100, 500, 0, 1, 1, 0);
			BRAIN::TASK_SMART_FLEE_PED(uParam0->f_1C[0], AUDIO::_0x0626A247D2405330(), 10000f, 4294967295, 0, 0);
		}
		func_214(&(uParam0->f_29[2]));
	}
}

void func_250(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xF1E0
{
...
void func_253(var uParam0, char* sParam1)//Position - 0xF38B
{
...
void func_254(var uParam0)//Position - 0xF3B4
{
	int iVar0;
...
int func_255(var uParam0)//Position - 0xF3E1
{
	uParam0->f_10 = 3;
...
int func_256(var uParam0)//Position - 0xF40C
{
	int iVar0[3];
	vector3 vVar1;
	vector3 vVar2;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			{
				func_258(&(uParam0->f_23[0]), iVar0[0], vVar1, fVar5);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
				{
			...
			{
				func_257(&(uParam0->f_29[0]), iVar0[1], vVar1 + vVar3, 0f);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_29[0], uParam0->f_23[0], 0, vVar3, vVar4, 0, 0, 0, 0, 2, 1);
				}
				else
				{
					bVar8 = false;
			...
			{
				func_258(&(uParam0->f_23[1]), iVar0[2], vVar2, fVar6);
...
void func_257(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF691
{
	func_214(iParam0);
...
void func_258(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF6B8
{
	func_259(iParam0);
...
void func_259(int iParam0)//Position - 0xF6FA
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_260(int iParam0)//Position - 0xF796
{
	int iVar0;
...
int func_261(var uParam0)//Position - 0xF7C7
{
	int iVar0[4];
	vector3 vVar1;
	vector3 vVar2;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			bVar7 = true;
			func_258(&(uParam0->f_23[0]), iVar0[0], vVar1, fVar4);
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_23[0], 1);
				VEHICLE::SET_VEHICLE_ALARM(uParam0->f_23[0], 0);
				...
				VEHICLE::SET_VEHICLE_EXTRA(uParam0->f_23[0], 2, true);
				VEHICLE::SET_VEHICLE_EXTRA(uParam0->f_23[0], 3, true);
			}
			else
			{
				bVar7 = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[0]))
			{
				func_257(&(uParam0->f_29[0]), iVar0[1], vVar1 + vVar2, 0f);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_29[0], uParam0->f_23[0], 0, vVar2, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
				}
				else
				{
					bVar7 = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[1]))
			{
				func_258(&(uParam0->f_23[1]), iVar0[2], vVar3, fVar5);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				func_262(&(uParam0->f_1C[0]), iVar0[3], vVar3, fVar5, 6);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[1]))
			{
				func_262(&(uParam0->f_1C[1]), iVar0[3], vVar3, fVar5, 6);
			}
			if (bVar7)
			{
				iLocal_51 = 3;
		...
		case 3:
			if (func_199(uParam0->f_23[1]))
			{
				if (func_199(uParam0->f_1C[0]))
				{
					PED::SET_PED_AS_COP(uParam0->f_1C[0], 1);
					PED::SET_PED_INTO_VEHICLE(uParam0->f_1C[0], uParam0->f_23[1], 4294967295);
					WEAPON::GIVE_DELAYED_WEAPON_TO_PED(uParam0->f_1C[0], joaat("weapon_pistol"), 100, true);
				}
				if (func_199(uParam0->f_1C[1]))
				{
					PED::SET_PED_AS_COP(uParam0->f_1C[1], 1);
					PED::SET_PED_INTO_VEHICLE(uParam0->f_1C[1], uParam0->f_23[1], 0);
					WEAPON::GIVE_DELAYED_WEAPON_TO_PED(uParam0->f_1C[1], joaat("weapon_pistol"), 100, true);
				}
			}
			iVar6 = 0;
			while (iVar6 <= (iVar0 - 1))
...
void func_262(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0xFB16
{
	func_263(iParam0);
	*iParam0 = PED::CREATE_PED(iParam4, iParam1, vParam2, fParam3, 0, false);
}

void func_263(int iParam0)//Position - 0xFB37
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_264(var uParam0)//Position - 0xFB78
{
	int iVar0[2];
	vector3 vVar1;
	float fVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_269(&(uParam0->f_30), "rcm_barry3", "bar_3_rcm_barry_standing_on_street_base", "bar_3_rcm_barry_standing_on_street_fidget");
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_260(&iVar0) || !func_268(&(uParam0->f_30)))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (func_265(&(uParam0->f_1C[0]), 49, vVar1, fVar2, "RC LAUNCHER: BARRY 3", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[0]))
			{
				func_257(&(uParam0->f_29[0]), iVar0[1], vVar1 + Vector(0f, 0f, 5f), -115.18f);
				if (func_199(uParam0->f_29[0]) && func_199(uParam0->f_1C[0]))
				{
...
int func_265(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xFD6E
{
...
int func_266(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xFDCA
{
	int iVar0;
...
int func_267(var uParam0, int iParam1)//Position - 0xFE58
{
	int iVar0;
...
int func_268(var uParam0)//Position - 0xFE9E
{
	if (func_212(uParam0))
	{
...
void func_269(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xFEC8
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_270(var uParam0)//Position - 0xFF04
{
	int iVar0[5];
	vector3 vVar1;
	float fVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_269(&(uParam0->f_30), "rcm_barry2", "lead_in_loop", "lead_in_loop");
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (func_265(&(uParam0->f_1C[0]), 49, vVar1, fVar2, "RC LAUNCHER: BARRY 2", 1))
				{
					PED::SET_PED_PROP_INDEX(uParam0->f_1C[0], 1, 0, 0, false);
				}
				else
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[0]))
			{
				...
				func_257(&(uParam0->f_29[0]), iVar0[1], 189.5964f, -956.0344f, 29.09179f, func_272(-2.01f));
				if (func_199(uParam0->f_29[0]))
				{
					unk_0x346478B12F69D4E3(uParam0->f_29[0], true);
					func_257(&(uParam0->f_29[2]), iVar0[3], 189.7901f, -956.1675f, 29.8229f, func_272(-2.01f));
					if (func_199(uParam0->f_29[2]))
					{
			...
			{
				func_257(&(uParam0->f_29[1]), iVar0[2], 190.417f, -956.511f, 29.09179f, -99.157f);
				if (func_199(uParam0->f_29[1]))
				{
					unk_0x346478B12F69D4E3(uParam0->f_29[1], true);
					ENTITY::SET_ENTITY_COLLISION(uParam0->f_29[1], false, 0);
				}
				else
				{
					bVar4 = false;
		...
		case 3:
			if (func_199(uParam0->f_1C[0]))
			{
				...
				ENTITY::SET_ENTITY_COORDS(uParam0->f_1C[0], vVar1, 1, false, 0, 1);
				ENTITY::SET_ENTITY_HEADING(uParam0->f_1C[0], fVar2);
				unk_0x346478B12F69D4E3(uParam0->f_1C[0], true);
				BRAIN::TASK_PLAY_ANIM(uParam0->f_1C[0], uParam0->f_30, uParam0->f_30.f_1, 8f, -8f, 4294967295, 9, 0, 0, 0, 0);
			...
			{
				unk_0x346478B12F69D4E3(uParam0->f_29[1], true);
				ENTITY::SET_ENTITY_COLLISION(uParam0->f_29[1], true, 0);
			}
			func_271(&(uParam0->f_29[3]), iVar0[4]);
			iVar3 = 0;
			while (iVar3 <= (iVar0 - 1))
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iVar0[iVar3]);
...
void func_271(int iParam0, int iParam1)//Position - 0x102A4
{
	vector3 vVar0;
	float fVar1;
...
float func_272(float fParam0)//Position - 0x102D4
{
	return (fParam0 * 57.29578f);
}

int func_273(var uParam0)//Position - 0x102E4
{
	int iVar0[7];
	vector3 vVar1;
	float fVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_269(&(uParam0->f_30), "RCMBarryLeadInOut", "idle", "fidget");
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (func_265(&(uParam0->f_1C[0]), 49, vVar1, fVar2, "RC LAUNCHER: BARRY 1", 1))
				{
					PED::SET_PED_PROP_INDEX(uParam0->f_1C[0], 1, 0, 0, false);
				}
				else
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[1]))
			{
				func_257(&(uParam0->f_29[1]), iVar0[2], 190.2574f, -956.3513f, 29.09179f, func_272(-1.68f));
				if (func_199(uParam0->f_29[1]))
				{
					unk_0x346478B12F69D4E3(uParam0->f_29[1], true);
					ENTITY::SET_ENTITY_COLLISION(uParam0->f_29[1], false, 0);
		...
		case 3:
			...
			func_257(&(uParam0->f_29[4]), iVar0[5], 189.895f, -955.945f, 29.818f, 0f);
			if (func_199(uParam0->f_29[4]))
			{
				ENTITY::SET_ENTITY_ROTATION(uParam0->f_29[4], -90f, 0f, -30.8f, 2, 1);
				unk_0x346478B12F69D4E3(uParam0->f_29[4], true);
			}
			func_257(&(uParam0->f_29[3]), iVar0[4], 189.783f, -956.015f, 29.79f, 0f);
			if (func_199(uParam0->f_29[3]))
			{
				ENTITY::SET_ENTITY_ROTATION(uParam0->f_29[3], -90f, 0f, 75f, 2, 1);
				unk_0x346478B12F69D4E3(uParam0->f_29[3], true);
			}
			func_271(&(uParam0->f_29[5]), iVar0[6]);
			iVar3 = 0;
			while (iVar3 <= (iVar0 - 1))
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iVar0[iVar3]);
...
int func_274(int iParam0)//Position - 0x10742
{
	struct<27> Var0;
	int iVar1;
...
int func_275(int iParam0)//Position - 0x10796
{
	char* sVar0;
...
int func_276(int iParam0)//Position - 0x1084F
{
	var uVar0;
...
int func_277(int iParam0)//Position - 0x10910
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_278(int iParam0, char* sParam1)//Position - 0x10995
{
...
bool func_279(int iParam0)//Position - 0x10A77
{
...
bool func_280(int iParam0)//Position - 0x10AA5
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
bool func_281(int iParam0)//Position - 0x10AD3
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
int func_282(int iParam0)//Position - 0x10B01
{
	if (func_240(iParam0))
	{
		return 0;
...
void func_283()//Position - 0x10B36
{
	func_305("Running end routines.");
	Global_19D3C = (Global_19D3C - 1);
}

int func_284(int iParam0, vector3 vParam1, float fParam2)//Position - 0x10B50
{
	int iVar0[4];
	int iVar1;
...
int func_285(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0x10BE1
{
	int iVar0;
	struct<7> Var1;
...
int func_286(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x10C5F
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_287(int iParam0, bool bParam1)//Position - 0x10CDA
{
	char* sVar0;
...
void func_288(char* sParam0)//Position - 0x10D6F
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_291(sParam0))
...
void func_289()//Position - 0x10D8E
{
	Global_3960 = 0;
	func_290();
}

void func_290()//Position - 0x10D9E
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_291(char* sParam0)//Position - 0x10DBF
{
	struct<6> Var0;
...
struct<6> func_292()//Position - 0x10DDF
{
	struct<6> Var0;
...
int func_293(var uParam0)//Position - 0x10E03
{
	if (func_212(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_294(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10E39
{
...
void func_295(var uParam0, bool bParam1)//Position - 0x10E59
{
	func_296(&(uParam0->f_29), bParam1);
}

void func_296(var uParam0, bool bParam1)//Position - 0x10E6B
{
	int iVar0;
...
void func_297(int iParam0, bool bParam1)//Position - 0x10EA9
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_298(var uParam0, bool bParam1)//Position - 0x10EE4
{
	func_299(&(uParam0->f_23), bParam1);
}

void func_299(var uParam0, bool bParam1)//Position - 0x10EF6
{
	int iVar0;
...
void func_300(int iParam0)//Position - 0x10F33
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_301(var uParam0, int iParam1)//Position - 0x10F6B
{
	func_302(&(uParam0->f_1C), iParam1);
}

void func_302(var uParam0, int iParam1)//Position - 0x10F7D
{
	int iVar0;
...
void func_303(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10FBE
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_304(var uParam0)//Position - 0x1100E
{
	if (*uParam0 == 4294967295)
	{
		return;
...
void func_305(char* sParam0)//Position - 0x1104B
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_306(var uParam0)//Position - 0x1105D
{
	*uParam0 = 4294967295;
...
void func_307()//Position - 0x11090
{
	func_305("Running start routines.");
	Global_19D3C++;
}

int func_308(int iParam0)//Position - 0x110AA
{
	if (!func_36(iParam0))
	{
		return Global_19E56.f_6D76[iParam0 /*29*/];
