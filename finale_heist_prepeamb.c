...
int func_166()
{
	...
	{
		iLocal_40 = 1;
		func_167(192, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
		return 1;
	}
	return 0;
}
...
void func_195()
{
	...
	if (((((((Global_35861 == 15 && iLocal_37 != 3) && MISC::IS_BIT_SET(iLocal_49, 5)) && !func_163()) && Global_70853 == -1) && !func_205()) && !func_82(9)) || func_101(35))
	{
		func_204();
		func_203();
		switch (iLocal_39)
