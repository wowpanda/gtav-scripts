	...
	while (iVar0 != 7)
	{
		...
		switch (iVar0)
		{
			...
			case 4:
				...
				SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_243 - Vector(15f, 15f, 15f), vLocal_243 + Vector(15f, 15f, 15f), 0, 1);
				SET_BIT(&uVar8, 4);
				SET_BIT(&uVar8, 1);
				SET_BIT(&uVar8, 5);
				ADD_RELATIONSHIP_GROUP("GangOne", &uLocal_49);
				SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_49, 1862763509);
				uVar22 = CREATE_PED(12, Var1.f_4, vVar14, fVar17, 1, 1);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uVar22, 1);
				SET_MODEL_AS_NO_LONGER_NEEDED(Var1.f_4);
				SET_PED_RELATIONSHIP_GROUP_HASH(uVar22, uLocal_49);
				SET_PED_CAN_BE_TARGETTED(uVar22, 0);
				SET_PED_COMPONENT_VARIATION(uVar22, 2, 0, 0, 0);
				SET_PED_COMPONENT_VARIATION(uVar22, 0, 0, 0, 0);
				SET_PED_COMPONENT_VARIATION(uVar22, 3, 2, 0, 0);
				SET_PED_COMPONENT_VARIATION(uVar22, 4, 0, 0, 0);
				SET_PED_COMPONENT_VARIATION(uVar22, 8, 1, 1, 0);
				SET_AMBIENT_VOICE_NAME(uVar22, "G_F_Y_Vagos_01_LATINO_MINI_02");
				if (func_82() == 0)
				{
				...
				TASK_PLAY_ANIM(uVar22, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 2f, -2f, -1, 49, 0, 0, 0, 0);
				if (!DOES_BLIP_EXIST(uLocal_224))
				{
				}
				iVar24 = 0;
				while (iVar24 <= (iLocal_51 - 1))
				{
					...
					{
						iVar18[iVar24] = CREATE_PED(12, Var1[iVar24], vLocal_229[iVar24 /*3*/], fLocal_239[iVar24], 1, 1);
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iVar18[iVar24], 1);
						SET_MODEL_AS_NO_LONGER_NEEDED(Var1[iVar24]);
						SET_PED_RELATIONSHIP_GROUP_HASH(iVar18[iVar24], uLocal_49);
						SET_PED_CONFIG_FLAG(iVar18[iVar24], 42, 1);
						GIVE_WEAPON_TO_PED(iVar18[iVar24], func_80(), -1, 1, 1);
				...
				GIVE_WEAPON_TO_PED(iVar18[0], joaat("weapon_sawnoffshotgun"), 40, 1, 1);
				uLocal_52 = CREATE_SYNCHRONIZED_SCENE(1283.205f, -1622.71f, 54.299f, 0f, 0f, 103.68f, 2);
				if (!IS_PED_INJURED(iVar18[0]))
				{
					TASK_SYNCHRONIZED_SCENE(iVar18[0], uLocal_52, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
				}
				if (!IS_PED_INJURED(iVar18[1]))
				{
					TASK_SYNCHRONIZED_SCENE(iVar18[1], uLocal_52, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_c", 4f, -4f, 17, 0, 1148846080, 0);
				}
				if (!IS_PED_INJURED(iVar18[2]))
				{
					TASK_SYNCHRONIZED_SCENE(iVar18[2], uLocal_52, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
				}
				SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_52, 1);
				iLocal_249 = 1;
				iVar0 = 5;
				break;
						...
						while (iVar25 < iVar18)
						{
							if (!IS_PED_INJURED(iVar18[iVar25]))
							{
								...
								if (!IS_PED_INJURED(iVar18[iVar25]))
								{
									...
									SET_PED_KEEP_TASK(iVar18[iVar25], 1);
								}
							}
							iVar25++;
						}
						if (!IS_PED_INJURED(uVar22))
						{
							if (!IS_PED_INJURED(uVar22))
							{
								CLEAR_PED_TASKS(uVar22);
								OPEN_SEQUENCE_TASK(&iLocal_50);
								TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), 1000, 2048, 2);
								TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 200f, -1, 0, 0);
								CLOSE_SEQUENCE_TASK(iLocal_50);
								TASK_PERFORM_SEQUENCE(uVar22, iLocal_50);
								CLEAR_SEQUENCE_TASK(&iLocal_50);
								SET_PED_KEEP_TASK(uVar22, 1);
							}
						}
						iLocal_248 = 1;
					}
...
int func_1(int iParam0, struct<6> Param1, var uParam7, int iParam8, int iParam9, int iParam10)
{
	...
	if (*iParam0 >= 3)
	{
		if (!IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_53))
		{
			if ((!IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_257, 9f, 9f, 9f, 0, 1, 0) && !IS_ENTITY_AT_COORD(PLAYER_PED_ID(), 1276.21f, -1613.05f, 53f, 9f, 9f, 9f, 0, 1, 0)) || IS_PED_RUNNING(PLAYER_PED_ID()))
			{
				*iParam0 = 6;
			}
		}
	...
	switch (*iParam0)
	{
		case 0:
			if (func_54(uParam7, iParam8))
			{
				...
				{
					SET_PED_RESET_FLAG(uParam7, 247, 1);
					if (!func_72(uParam7, 0))
					{
						if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uParam7, 15f, 15f, 15f, 0, 1, 0))
						{
							if ((IS_PED_ARMED(PLAYER_PED_ID(), 6) && _CAN_PED_SEE_PED(uParam7, PLAYER_PED_ID())) && !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
							{
								if ((IS_PED_ARMED(PLAYER_PED_ID(), 6) || IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uParam7)) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uParam7))
								{
									CLEAR_PED_SECONDARY_TASK(uParam7);
									TASK_LOOK_AT_ENTITY(uParam7, PLAYER_PED_ID(), 5000, 1024, 2);
									func_70();
									WAIT(1000);
									...
									while (iVar0 < *iParam8)
									{
										if (!IS_PED_INJURED((*iParam8)[iVar0]))
										{
											...
											SET_PED_KEEP_TASK((*iParam8)[iVar0], 1);
										}
										iVar0++;
									}
									if (!IS_PED_INJURED(uParam7))
									{
										TASK_SMART_FLEE_PED(uParam7, PLAYER_PED_ID(), 200f, -1, 0, 0);
										SET_PED_KEEP_TASK(uParam7, 1);
									}
									iLocal_248 = 1;
								}
							}
				...
				else if (IS_PED_RAGDOLL(uParam7))
				{
					if (IS_ENTITY_PLAYING_ANIM(uParam7, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_wave_loop", 3))
					{
						STOP_ANIM_TASK(uParam7, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_wave_loop", -1056964608);
					}
				}
			}
			else
		...
		case 2:
			DRAW_DEBUG_LINE(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_243, 0, 0, 255, 255);
			...
			if (!IS_PED_INJURED((*iParam8)[1]))
			{
				...
				uLocal_53 = CREATE_SYNCHRONIZED_SCENE(1283.205f, -1622.71f, 54.299f, 0f, 0f, 103.68f, 2);
				if (!IS_PED_INJURED((*iParam8)[0]))
				{
					TASK_SYNCHRONIZED_SCENE((*iParam8)[0], uLocal_53, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
				}
				if (!IS_PED_INJURED((*iParam8)[1]))
				{
					TASK_SYNCHRONIZED_SCENE((*iParam8)[1], uLocal_53, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_c", 4f, -4f, 16, 0, 1148846080, 0);
				}
				if (!IS_PED_INJURED((*iParam8)[2]))
				{
					TASK_SYNCHRONIZED_SCENE((*iParam8)[2], uLocal_53, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
				}
				*iParam0 = 3;
			}
			break;
		...
		case 3:
			*iParam9 = 0;
			if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_53))
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_53) > 0.3f)
				{
					if (!IS_PED_INJURED((*iParam8)[0]))
					{
						SET_PED_RESET_FLAG((*iParam8)[0], 156, 1);
						OPEN_SEQUENCE_TASK(&iLocal_50);
						TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) - Vector(0f, 0f, 1f), PLAYER_PED_ID(), 2f, 0, 3.5f, 5f, 1, 0, 0, -957453492, 20000);
						TASK_AIM_GUN_AT_ENTITY(0, PLAYER_PED_ID(), 25000, 0);
						CLOSE_SEQUENCE_TASK(iLocal_50);
				...
				if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_53) > 0.35f)
				{
					if (!IS_PED_INJURED((*iParam8)[1]))
					{
						SET_PED_RESET_FLAG((*iParam8)[1], 156, 1);
						OPEN_SEQUENCE_TASK(&iLocal_50);
						TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER_PED_ID(), PLAYER_PED_ID(), 2f, 0, 5f, 1082130432, 1, 0, -957453492);
						TASK_AIM_GUN_AT_ENTITY(0, PLAYER_PED_ID(), 25000, 0);
						CLOSE_SEQUENCE_TASK(iLocal_50);
				...
				if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_53) > 0.275f)
				{
					if (!IS_PED_INJURED((*iParam8)[2]))
					{
						SET_PED_RESET_FLAG((*iParam8)[2], 156, 1);
						OPEN_SEQUENCE_TASK(&iLocal_50);
						TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER_PED_ID(), PLAYER_PED_ID(), 2f, 0, 3.5f, 1082130432, 1, 0, -957453492);
						TASK_AIM_GUN_AT_ENTITY(0, PLAYER_PED_ID(), 25000, 0);
						CLOSE_SEQUENCE_TASK(iLocal_50);
		...
		case 6:
			...
			if (func_31(iParam8))
			{
				*iParam10 = 1;
				if (!IS_PED_INJURED(uParam7))
				{
					if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uParam7, 8f, 8f, 8f, 0, 1, 0))
					{
						func_44(&uLocal_55, "REGIAU", "REGIN_SORRY", 4, 0, 0, 0);
					}
				}
				if (!DOES_BLIP_EXIST(uLocal_225))
				{
				}
				while (func_69())
				{
...
void func_20()
{
	...
	{
		if (func_24(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
...
void func_33(var uParam0)
{
	...
	if (iLocal_254 == 0)
	{
		...
		if (iVar0 == 1)
		{
			...
			{
				SET_PED_COMBAT_ATTRIBUTES((*uParam0)[iVar1], 0, 1);
...
int func_34(struct<6> Param0, var uParam6, var uParam7)
{
	switch (iLocal_252)
	{
		...
		case 1:
			if (!IS_PED_INJURED(uParam6))
			{
				if (GET_SCRIPT_TASK_STATUS(uParam6, 242628503) == 7 || IS_ENTITY_AT_ENTITY(uParam6, PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0))
				{
					if (!func_69())
					{
		...
		case 2:
			if (!IS_PED_INJURED((*uParam7)[2]))
			{
				if (!IS_PED_INJURED((*uParam7)[0]))
				{
					...
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_229[0 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
					TASK_ACHIEVE_HEADING(0, fLocal_239[0], 0);
					TASK_PLAY_ANIM_ADVANCED(0, Param0.f_5, "sit_down_idle_01", vLocal_229[0 /*3*/], 0f, 0f, fLocal_239[0], 1000f, -4f, -1, 1, 0, 2, 0);
					CLOSE_SEQUENCE_TASK(iLocal_50);
				...
				if (!IS_PED_INJURED((*uParam7)[1]))
				{
					...
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_229[1 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
				...
				if (!IS_PED_INJURED((*uParam7)[2]))
				{
					...
					TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, (*uParam7)[0], 0f, -0.5f, 0f, 1f, 10000, 1036831949, 1);
					TASK_WANDER_STANDARD(0, 1193033728, 0);
					CLOSE_SEQUENCE_TASK(iLocal_50);
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		if (!DOES_BLIP_EXIST(uLocal_220[iVar0]))
		{
			if (!IS_PED_INJURED((*uParam0)[iVar0]))
			{
				...
				SET_ENTITY_IS_TARGET_PRIORITY((*uParam0)[iVar0], 1, 0);
			}
		}
		iVar0++;
	}
...
void func_41(var uParam0, var uParam1)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		if (!IS_PED_INJURED((*uParam0)[iVar0]))
		{
			...
			SET_PED_COMBAT_ATTRIBUTES((*uParam0)[iVar0], 0, 1);
...
int func_54(var uParam0, var uParam1)
{
	switch (iLocal_255)
	{
		case 0:
			...
			{
				if ((IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1272.878f, -1532.84f, 36.4104f, 1339.482f, -1623.636f, 71.4792f, 105.1875f, 0, 1, 0) && !IS_ENTITY_OCCLUDED(uParam0)) || IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uParam0, 15f, 15f, 15f, 0, 1, 0))
				{
					if (!func_108())
					{
						func_58(1);
					...
					if (!DOES_BLIP_EXIST(uLocal_225))
					{
						...
						_0x75A16C3DA34F1245(uLocal_225, 0);
					}
					if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
					{
						if (!IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER_PED_ID()))
						{
							...
							{
								if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uParam0, 10f, 10f, 10f, 0, 1, 0))
								{
									...
									CLOSE_SEQUENCE_TASK(iLocal_50);
									TASK_PERFORM_SEQUENCE(uParam0, iLocal_50);
									CLEAR_SEQUENCE_TASK(&iLocal_50);
									if (DOES_BLIP_EXIST(uLocal_225))
									{
										_0x75A16C3DA34F1245(uLocal_225, 1);
									}
							...
							else if (iLocal_246 == 0)
							{
								...
								if (!IS_PED_INJURED(uParam0))
								{
									OPEN_SEQUENCE_TASK(&iLocal_50);
									TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), 20000, 1024, 2);
									TASK_PLAY_ANIM(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_wave_loop", 2f, -2f, -1, 49, 0, 0, 0, 0);
									TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), -1);
									CLOSE_SEQUENCE_TASK(iLocal_50);
									TASK_PERFORM_SEQUENCE(uParam0, iLocal_50);
									CLEAR_SEQUENCE_TASK(&iLocal_50);
						...
						else
						{
							...
							if (!IS_PED_INJURED(uParam0))
							{
								...
								TASK_SMART_FLEE_PED(uParam0, PLAYER_PED_ID(), 200f, -1, 0, 0);
					...
					{
						if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uParam0, 8f, 8f, 8f, 0, 1, 0))
						{
							OPEN_SEQUENCE_TASK(&iLocal_50);
							TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), -1);
							TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), 20000, 1024, 2);
			...
			{
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1273.098f, -1604.172f, 53.1535f, 1276.568f, -1615.127f, 56.7879f, 10f, 0, 1, 0) && !func_57())
				{
					iLocal_255 = 3;
				}
				else if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1298.546f, -1617.742f, 53.2254f, 1262.868f, -1629.36f, 64.2894f, 30.4375f, 0, 1, 0))
				{
		...
		case 1:
			...
			if (!IS_PED_INJURED(uParam0) && !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
				CLEAR_AREA_OF_VEHICLES(vLocal_243, 13f, 0, 0, 0, 0, 0, 0);
				CLEAR_PED_SECONDARY_TASK(uParam0);
				if (!IS_PED_INJURED(uParam0))
				{
					OPEN_SEQUENCE_TASK(&iLocal_50);
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_243, 2f, 20000, 0.25f, 0, 32.2195f);
					...
					CLEAR_SEQUENCE_TASK(&iLocal_50);
					iLocal_50 = 0;
					if ((IS_PED_ARMED(PLAYER_PED_ID(), 6) && IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uParam0, 6f, 6f, 6f, 0, 1, 0)) && !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
					{
					}
				}
				iLocal_255 = 2;
		...
		case 2:
			if (!IS_PED_INJURED(uParam0) && !func_69())
			{
		...
		case 3:
			...
			{
				if (TIMERA() > 8000 && IS_ENTITY_AT_COORD(uParam0, vLocal_243, 3f, 3f, 3f, 0, 1, 0))
				{
					if (IS_PED_FACING_PED(uParam0, PLAYER_PED_ID(), 60f))
					{
						if (func_158())
						{
							TASK_PLAY_ANIM(uParam0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_a", 2f, -2f, -1, 48, 0, 0, 0, 0);
						}
						else
						{
							TASK_PLAY_ANIM(uParam0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 2f, -2f, -1, 0, 0, 0, 0, 0);
						}
						func_44(&uLocal_55, "REGIAU", "REGIN_HERE", 4, 0, 0, 0);
						SETTIMERA(0);
					}
				}
				if ((IS_PED_ARMED(PLAYER_PED_ID(), 6) && _CAN_PED_SEE_PED(uParam0, PLAYER_PED_ID())) && !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
		...
		case 4:
			if (!IS_PED_INJURED(uParam0))
			{
				...
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_243, 2f, 20000, 1048576000, 0, 1193033728);
				CLOSE_SEQUENCE_TASK(iLocal_50);
				CLEAR_SEQUENCE_TASK(&iLocal_50);
				iLocal_50 = 0;
			}
...
void func_55(var uParam0)
{
	if (!IS_PED_INJURED(uParam0))
	{
		CLEAR_PED_TASKS(uParam0);
		OPEN_SEQUENCE_TASK(&iLocal_50);
		TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1286.037f, -1623.207f, 53.2297f, 2f, -1, 1048576000, 0, 1193033728);
		TASK_COWER(0, -1);
		CLOSE_SEQUENCE_TASK(iLocal_50);
		TASK_PERFORM_SEQUENCE(uParam0, iLocal_50);
		CLEAR_SEQUENCE_TASK(&iLocal_50);
...
void func_56(var uParam0, var uParam1)
{
	...
	while (iVar0 < *uParam1)
	{
		if (!IS_PED_INJURED((*uParam1)[iVar0]) && !IS_PED_INJURED(uParam0))
		{
			if ((_CAN_PED_SEE_PED((*uParam1)[iVar0], PLAYER_PED_ID()) || CAN_PED_HEAR_PLAYER(PLAYER_ID(), (*uParam1)[iVar0])) || _CAN_PED_SEE_PED(uParam0, PLAYER_PED_ID()))
			{
				func_70();
...
int func_62()
{
	switch (func_63(&Global_25824, 0, 5, 0, GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_94()) || Global_105612) || Global_25767) || func_93()) || func_52(8, -1)) || func_92()) || func_91()) || func_90()) || func_89()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_94()) || Global_25767) || func_93()) || func_52(8, -1)) || func_90()) || func_92()) || func_91()) || func_89()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_94()) || Global_105612) || Global_25767) || func_93()) || func_52(8, -1)) || func_90()) || func_92()) || func_91()) || func_89()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_94()) || Global_105612) || Global_25767) || func_93()) || func_52(8, -1)) || func_92()) || func_91()) || func_89()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_94() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_52(8, -1)) || func_89()) || func_88()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_94()) || Global_25767) || func_93()) || func_52(8, -1)) || func_91()) || func_90()) || func_89()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_94()) || Global_105612) || Global_25767) || func_93()) || func_52(8, -1)) || func_90()) || func_88()) || func_92()) || func_91()) || func_89())
						{
							return 0;
						}
						break;
...
int func_108()
{
	if ((Global_106554 == func_28() && GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
void func_146(struct<6> Param0, int iParam6, int iParam7, var uParam8)
{
	...
	if (iLocal_249)
	{
		...
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_243 - Vector(10f, 10f, 10f), vLocal_243 + Vector(10f, 10f, 10f), 1, 1);
		...
		{
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam8, 0);
		}
		func_83(0);
		func_109(0, Param0);
	}
