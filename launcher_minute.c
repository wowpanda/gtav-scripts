...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Var0 == 32)
		{
			...
			{
				if (!func_202(329.513f, 3402.691f, 36.258f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[1], 1), 1056964608))
				{
...
int func_187(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_173(2))
		{
			...
			else if (((func_189(sParam3) && !*uParam8 == 1) && func_124(PLAYER::PLAYER_PED_ID())) && func_186(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
			{
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_223(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_230(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_223(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
