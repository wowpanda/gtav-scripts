...
void __EntryFunction__()
{
	...
	iLocal_92 = func_291(56);
	iLocal_93 = func_291(57);
	iLocal_94 = func_291(59);
	...
	if (!func_268(&iVar64, &Var0, vVar61, 1f))
	{
		func_267();
	...
	if (Var0 == 32)
	{
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0, 1);
	...
	while (true)
	{
		...
		if (Var0 == 32)
		{
			...
			{
				if (!func_205(329.513f, 3402.691f, 36.258f, GET_ENTITY_COORDS(Var0.f_35[1], 1), 1056964608))
				{
		...
		func_201(Var0);
		func_194(&iLocal_96, &(Var0.f_9), vVar61);
		if (Var0 == 32)
		{
			func_190(&Var0, vVar61, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_99);
		}
		else if (Var0 == 34)
		{
			func_185(&Var0, vVar61, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
		}
		if (func_171(&Var0, 0))
		{
			if (func_170(Var0))
...
int func_185(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_126(PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && !func_145()) && (GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_189(PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
float func_189(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
int func_190(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	var uVar0;
	...
	if (!*uParam10 == 3)
	{
		if (func_176(2))
		{
			if (!func_145())
			{
				if (((func_126(PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && func_126(iParam0->f_28[1])) && func_189(PLAYER_PED_ID(), vParam1, 1) < 20f)
				{
					...
					{
						func_188(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
						func_188(&uVar0, iParam8, iParam0->f_28[1], sParam9, 0, 1);
						func_186(&uVar0, cParam4, sParam5, 7, 0, 0);
						*uParam10 = 2;
					}
					else if (*uParam10 == 2)
			...
			else if (((func_192(sParam5) && !*uParam10 == 1) && func_126(PLAYER_PED_ID())) && func_189(PLAYER_PED_ID(), vParam1, 1) >= 20f)
			{
				func_288("pause conversation");
				func_191(1);
				*uParam10 = 1;
			}
			if (func_189(PLAYER_PED_ID(), vParam1, 1) < 20f && *uParam10 == 1)
			{
...
void func_194(int iParam0, var uParam1, vector3 vParam2)
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (!IS_STRING_NULL_OR_EMPTY(uParam1))
		{
			...
			{
				if (func_189(PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_197(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_189(PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_199(iParam0);
				}
			}
...
int func_205(struct<2> Param0, float fParam2, struct<2> Param3, var uParam5, float fParam6)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
			...
			if (DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_215(PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_218(int iParam0, float fParam1)
{
	...
	{
		if (func_229(iParam0) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), iParam0))
		{
...
{
	return func_220(iParam0, PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
...
bool func_220(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_221(&(Local_37[iVar4 /*4*/]), vVar1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_221(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
	...
	if (*uParam0 == 0)
	{
		vVar1 = { func_222(iParam4, iParam7) };
...
int func_224(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_226(GET_ENTITY_COORDS(iParam1, 1) - GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		vVar3 = { func_226(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_225(vVar3, vVar0);
...
int func_231(var uParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_232(var uParam0, float fParam1)
{
	...
	{
		if (func_233(uParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_233(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_226(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_226(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_225(vVar3, vVar0);
...
int func_234(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (IS_PED_SHOOTING(PLAYER_PED_ID()))
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				...
				SET_VEHICLE_MODEL_IS_SUPPRESSED(iVar0[1], 1);
			}
...
void func_246(var uParam0, var uParam1, vector3 vParam2, float fParam5)
{
	func_247(uParam0);
...
int func_248(var uParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_249(uParam0, iParam1, vParam2, fParam5, 1))
	{
		if (DOES_ENTITY_EXIST(*uParam0))
		{
			if (!IS_ENTITY_DEAD(*uParam0, 0))
...
int func_249(var uParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	int iVar0;
...
void func_251(var uParam0, var uParam1, vector3 vParam2, float fParam5)
{
	func_204(uParam0);
...
int func_256(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			REQUEST_ANIM_DICT("rcmminute1");
			CLEAR_AREA(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			iLocal_91 = 1;
			break;
		
		case 1:
			CLEAR_AREA(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, 0);
			if (!func_253(&iVar0) || !HAS_ANIM_DICT_LOADED("rcmminute1"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 3:
			if (HAS_ANIM_DICT_LOADED("rcmminute1"))
			{
				...
				if (func_126(uParam0->f_28[1]))
				{
					...
					SET_PED_CONFIG_FLAG(uParam0->f_28[1], 185, 1);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
int func_268(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_269((*iParam0)[0], vParam2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_269((*iParam0)[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_269(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_270(Var1.f_6, vParam1, fParam4, 0))
	{
...
void func_271(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 32)
	{
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 1, 1);
	}
	else if (*iParam0 == 34)
	{
