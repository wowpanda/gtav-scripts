...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Var0 == 32)
		{
			...
			{
				if (!func_202(329.513f, 3402.691f, 36.258f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[1], true), 1056964608))
				{
...
int func_182(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_124(PLAYER::PLAYER_PED_ID()) && func_124(iParam0->f_28[0])) && !func_143()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_186(PLAYER::PLAYER_PED_ID(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_187(int iParam0, vector3 vParam1, char[4] cParam2, void fParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_173(2))
		{
			if (!func_143())
			{
				if (((func_124(PLAYER::PLAYER_PED_ID()) && func_124(iParam0->f_28[0])) && func_124(iParam0->f_28[1])) && func_186(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
				{
					...
					if (*uParam8 == 0)
					{
						...
						func_183(&uVar0, cParam2, fParam3, 7, 0, 0);
						*uParam8 = 2;
					}
					else if (*uParam8 == 2)
					{
			...
			else if (((func_189(fParam3) && !*uParam8 == 1) && func_124(PLAYER::PLAYER_PED_ID())) && func_186(PLAYER::PLAYER_PED_ID(), vParam1, 1) >= 20f)
			{
				func_285("pause conversation");
				func_188(1);
				*uParam8 = 1;
			}
			if (func_186(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f && *uParam8 == 1)
			{
...
void func_191(int iParam0, void fParam1, vector3 vParam2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
int func_202(struct<2> Param0, float fParam1, struct<2> Param2, float fParam3, float fParam4)
{
	if (fParam4 < 0f)
	{
		fParam4 = 0f;
...
{
	if ((func_238() && Global_92955.f_11 == 6) && iParam0 == func_162(&(Global_92955.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_253(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			MISC::CLEAR_AREA(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, false);
			if (!func_250(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1"))
			{
				return 0;
			}
			iLocal_51 = 2;
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1"))
			{
				if (func_124(uParam0->f_28[0]))
				{
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
						...
						BRAIN::TASK_PLAY_ANIM(uParam0->f_28[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, 0, 0, 0, 0);
				...
				if (func_124(uParam0->f_28[1]))
				{
					...
					BRAIN::TASK_PLAY_ANIM(uParam0->f_28[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, 0, 0, 0, 0);
...
bool func_259(int iParam0, void fParam1)
{
