...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(19))
	{
		...
		if (func_566(PLAYER::PLAYER_PED_ID()))
		{
			func_557(PLAYER::PLAYER_PED_ID(), 1);
	...
	switch (iLocal_99)
	{
		...
		case 1:
			if (iParam0 == 0)
			{
				...
				BRAIN::TASK_PLAY_ANIM(0, sLocal_256, sLocal_270, 8f, -8f, -1, 0, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(0, sLocal_256, sLocal_271, 8f, -8f, -1, 1, 0, 0, 0, 0);
				BRAIN::CLOSE_SEQUENCE_TASK(iVar2);
				BRAIN::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iVar2);
...
void func_25()
{
	...
	{
		if (func_28(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_27(PLAYER::PLAYER_PED_ID());
			if (func_26(iVar0) && (!func_29(14) || Global_104171))
			{
				if (Global_105220.f_2354.f_539.f_4301 != iVar0 && func_26(Global_105220.f_2354.f_539.f_4301))
				{
...
{
	func_50(&(Global_98783.f_2875), vParam0, fParam1);
}
...
{
	if (func_52(Global_71218, 0f, 0f, 0f, 0))
	{
...
void func_62()
{
	...
	while (iVar0 < Local_502)
	{
		if (func_4(&(Local_502[iVar0 /*33*/])))
		{
			...
			BRAIN::TASK_SMART_FLEE_COORD(Local_502[iVar0 /*33*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 400f, -1, 0, 0);
		}
		iVar0++;
	}
}
...
void func_64(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			BRAIN::TASK_PLAY_ANIM(0, sLocal_256, sLocal_266, 8f, -8f, -1, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, sLocal_256, sLocal_269, 8f, -2f, -1, 0, 0, 0, 0, 0);
...
int func_69(var uParam0, float fParam1)
{
	...
	if (uParam0->f_15 && !uParam0->f_16)
	{
		if (CAM::DOES_CAM_EXIST(uParam0->f_9))
		{
			...
			if (!Global_17206.f_111)
			{
				AUDIO::PLAY_SOUND(-1, "CHARACTER_CHANGE_UP_MASTER", 0, 0, 0, 1);
				if (Global_17206.f_109 == -1)
				{
					Global_17206.f_109 = AUDIO::GET_SOUND_ID();
					Global_17206.f_110 = MISC::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME());
				}
				AUDIO::PLAY_SOUND(Global_17206.f_109, "CHARACTER_CHANGE_SKY_MASTER", 0, 0, 0, 1);
	...
	if (uParam0->f_17)
	{
		...
		uParam0->f_24 = 0;
		uParam0->f_27 = 0;
		if (Global_17206.f_109 != -1 && Global_17206.f_110 == MISC::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME()))
		{
			AUDIO::STOP_SOUND(Global_17206.f_109);
			AUDIO::RELEASE_SOUND_ID(Global_17206.f_109);
			Global_17206.f_109 = -1;
			Global_17206.f_110 = 0;
		}
	...
	switch (*iParam0)
	{
		...
		case 1:
			if (func_327(1, 1093140480, 0) && SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2"))
			{
				...
				func_277();
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_246, 2, func_569(49), 0);
...
void func_279(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_310(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_105220.f_32546.f_4801 = func_299();
			}
...
void func_280(int iParam0, int iParam1)
{
	...
	func_317(iParam0, &(Global_105220.f_32546.f_5510));
}
...
int func_310(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_52(Global_105220.f_32546.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_52(Global_105220.f_2354.f_539.f_3568[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_52(Global_105220.f_2354.f_539.f_3568[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_313(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_310(&(Global_69800.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_315(iParam0);
			func_314(uParam1, &(Global_105220.f_32546.f_69[Global_69800.f_555[0 /*21*/].f_14 /*78*/]));
...
{
	return func_323(Global_95814.f_2875.f_12.f_66, vParam0, iParam1);
}
...
int func_353(var uParam0, vector3 vParam1, int iParam2, bool bParam3)
{
	...
	BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(uParam0->f_2);
	...
	*uParam0 = 1;
	...
	BRAIN::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_268, 1000f, -8f, -1, 1, 0, 0, 0, 0);
	iLocal_524++;
	return 1;
}
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_327(1, 1093140480, 0))
			{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_94.f_28[0], sLocal_246, 2, func_569(49), 0);
				}
				if (func_566(Local_94.f_41[0]))
				{
...
void func_429(int iParam0)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		func_430(iParam0, &(Global_105220.f_2354.f_539.f_1749));
		iVar1 = 0;
		while (iVar1 <= (8 - 1))
		{
			Global_105220.f_2354.f_539.f_1715[iVar1 /*4*/][iVar0] = HUD::_0xA13E93403F26C812(iVar1);
			iVar1++;
		}
	}
}
...
void func_430(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_431(Var7.f_1)) && iVar9 < 50)
			{
	...
	switch (*iParam0)
	{
		...
		case 1:
			if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_257) && !func_330())
			{
				...
				{
					BRAIN::TASK_PLAY_ANIM(Local_94.f_28[0], sLocal_257, "leadin", 8f, -4f, -1, 2, 0, 0, 0, 0);
...
void func_440(var uParam0)
{
	...
	if (func_469(uParam0) && bLocal_477 == 1)
	{
		...
		BRAIN::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_267, 8f, -8f, -1, 1, 0, 0, 0, 0);
		func_58(uParam0);
		func_60(&(uParam0->f_17));
		uParam0->f_1 = 13;
		uParam0->f_26 = 0;
	...
	switch (uParam0->f_1)
	{
		...
		case 2:
			...
			PED::SET_PED_CAN_BE_TARGETTED(uParam0->f_2, false);
			func_355(uParam0->f_2);
			BRAIN::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_268, 8f, -8f, -1, 1, 0, 0, 0, 0);
		...
		case 9:
			...
			if (!uParam0->f_32)
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(uParam0->f_2, 1227113341) != 1)
				{
					BRAIN::TASK_GO_TO_ENTITY(uParam0->f_2, PLAYER::PLAYER_PED_ID(), 20000, 0.5f, 2f, 1073741824, 0);
				}
			}
			if (!func_9())
			{
			...
			if (func_466(uParam0))
			{
				BRAIN::SET_PED_DESIRED_MOVE_BLEND_RATIO(uParam0->f_2, 3f);
		...
		case 13:
			...
			if (bLocal_477 == 1)
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(uParam0->f_2, -2017877118) != 1)
				{
					BRAIN::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_267, 4f, -4f, -1, 1, 0, 0, 0, 0);
				}
				return;
			}
			uParam0->f_1 = 14;
		...
		case 17:
			ENTITY::SET_ENTITY_COORDS(uParam0->f_5, ENTITY::GET_ENTITY_COORDS(uParam0->f_4, 1), 1, false, 0, 1);
		...
		case 18:
			if (!PED::IS_PED_RUNNING_RAGDOLL_TASK(uParam0->f_2))
			{
				...
				BRAIN::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, "MIND_CONTROL_B_Loop", 4f, -8f, -1, 1, 0, 0, 0, 0);
				uParam0->f_1 = 19;
			}
			break;
		...
		case 20:
			...
			{
				if (((PED::IS_PED_FALLING(uParam0->f_2) || BRAIN::IS_PED_GETTING_UP(uParam0->f_2)) || PED::IS_PED_RAGDOLL(uParam0->f_2)) || PED::IS_PED_RUNNING_RAGDOLL_TASK(uParam0->f_2))
				{
					return;
				}
			}
			if (BRAIN::GET_SCRIPT_TASK_STATUS(uParam0->f_2, -2017877118) != 1)
			{
				BRAIN::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, "MIND_CONTROL_B_LOOP", 2f, -8f, -1, 1, 0, 0, 0, 0);
			}
			if (BRAIN::GET_SCRIPT_TASK_STATUS(uParam0->f_2, -2017877118) == 1)
			{
...
void func_443(var uParam0)
{
			...
			if (iVar0 > 0)
			{
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(uParam0->f_27, vVar2, true) <= 0.7f)
				{
					...
					if (MISC::ABSF((uParam0->f_27.f_2 - vVar2.z)) < 1f)
					{
						...
						{
							MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(vVar3, vVar4, 0, 1, joaat("weapon_pistol"), 0, 0, 1, -1f);
						}
						if (iLocal_503 == 1)
						{
	...
	{
		ENTITY::SET_ENTITY_COORDS(uParam0->f_5, ENTITY::GET_ENTITY_COORDS(uParam0->f_4, 1) + ENTITY::GET_ENTITY_FORWARD_VECTOR(uParam0->f_4) * Vector(uParam0->f_12, uParam0->f_12, uParam0->f_12), 1, false, 0, 1);
	}
	if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uParam0->f_23))
	{
		GRAPHICS::_SET_PARTICLE_FX_LOOPED_RANGE(uParam0->f_23, uParam0->f_12);
...
void func_455(var uParam0)
{
	...
	else if (BRAIN::GET_SCRIPT_TASK_STATUS(uParam0->f_2, -982327190) != 1)
	{
		BRAIN::TASK_STAND_STILL(uParam0->f_2, -1);
	...
	else
	{
		...
		if (iVar1 == 2)
		{
			if (iVar0 == 0 && func_9())
			{
				...
				BRAIN::TASK_PLAY_ANIM(0, sLocal_256, "MIND_CONTROL_B_Enter", 8f, -8f, -1, 2, 0, 0, 0, 0);
				BRAIN::CLOSE_SEQUENCE_TASK(iVar2);
				BRAIN::TASK_PERFORM_SEQUENCE(uParam0->f_2, iVar2);
				BRAIN::CLEAR_SEQUENCE_TASK(&iVar2);
				if (!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uParam0->f_22))
				{
					uParam0->f_22 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_charging", uParam0->f_4, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_490, 0, 0, 0);
...
void func_458(var uParam0)
{
	...
	if (uParam0->f_18 > iLocal_483 || BRAIN::GET_SCRIPT_TASK_STATUS(uParam0->f_2, 242628503) > 1)
	{
		...
		{
			BRAIN::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_263, 8f, -8f, -1, 0, 0, 0, 0, 0);
		}
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_262, 3))
		{
			BRAIN::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
			BRAIN::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_264, 8f, -4f, -1, 0, 0, 0, 0, 0);
	...
	if (MISC::GET_GAME_TIMER() > uParam0->f_7)
	{
		BRAIN::TASK_PLAY_ANIM(uParam0->f_2, sLocal_256, sLocal_265, 8f, -8f, -1, 0, 0, 0, 0, 0);
		func_60(&(uParam0->f_17));
		func_459();
	}
}
...
void func_462(var uParam0)
{
	...
	func_355(uParam0->f_2);
	BRAIN::OPEN_SEQUENCE_TASK(&iVar0);
	BRAIN::TASK_PLAY_ANIM(0, sLocal_256, sLocal_259, 8f, -8f, -1, 0, 0, 0, 0, 0);
	BRAIN::TASK_PLAY_ANIM(0, sLocal_256, sLocal_261, 8f, -8f, -1, 1, 0, 0, 0, 0);
	BRAIN::CLOSE_SEQUENCE_TASK(iVar0);
	BRAIN::TASK_PERFORM_SEQUENCE(uParam0->f_2, iVar0);
	BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
	PED::_0x2208438012482A1A(uParam0->f_2, 0, 0);
	func_464(PLAYER::PLAYER_PED_ID(), uParam0->f_2);
	BRAIN::OPEN_SEQUENCE_TASK(&iVar0);
	BRAIN::TASK_PLAY_ANIM(0, sLocal_256, sLocal_260, 8f, -8f, -1, 0, 0, 0, 0, 0);
	BRAIN::TASK_PLAY_ANIM(0, sLocal_256, sLocal_262, 8f, -8f, -1, 1, 0, 0, 0, 0);
	BRAIN::CLOSE_SEQUENCE_TASK(iVar0);
	BRAIN::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iVar0);
	BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
	PED::_0x2208438012482A1A(PLAYER::PLAYER_PED_ID(), 0, 0);
	...
	if (Global_71232 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_483(Global_71233, Global_71235, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_494(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_479(0)) || func_493(1))
			{
			}
			else
			{
...
{
	return func_496(iParam0, Global_35905);
}
...
void func_499(vector3 vParam0, float fParam1, var uParam2, var uParam3)
{
	vector3 vVar0;
...
void func_501()
{
	...
	if (func_514() == 1)
	{
		...
		if (func_566(PLAYER::PLAYER_PED_ID()))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_262, 3))
			{
				BRAIN::STOP_ANIM_TASK(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_262, -1056964608);
			}
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_260, 3))
			{
				BRAIN::STOP_ANIM_TASK(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_260, -1056964608);
			}
			ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), true, 0);
			func_429(PLAYER::PLAYER_PED_ID());
			WEAPON::REMOVE_ALL_PED_WEAPONS(PLAYER::PLAYER_PED_ID(), 1);
...
int func_506(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
...
int func_507(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_512(var uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
void func_520(var uParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	*(uParam0[0 /*3*/]) = { vParam1 };
	*(uParam0[1 /*3*/]) = { vParam2 };
	uParam0->f_7 = fParam3;
...
int func_529(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_81() == 0)
		{
			return MISC::IS_BIT_SET(func_142(func_527(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
void func_535(bool bParam0)
{
	...
	if (!func_550())
	{
		...
		{
			func_226(iVar0, 1, 0);
			func_536(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_104307[iVar0 /*10*/].f_9 == -1)
...
int func_537(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
	...
	if (func_543())
	{
		...
		{
			iVar2 = func_538(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_539()
{
	...
	iVar0 = func_540(&(Global_92955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_543()
{
	...
	{
		if (func_538(&(Global_92955.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_555(int iParam0)
{
	if (func_26(iParam0))
	{
		Global_105220.f_2354.f_539.f_298[iParam0 /*472*/] = { Global_105220.f_2354.f_539.f_1749 };
	}
}
...
void func_556(int iParam0, bool bParam1)
{
	...
	if (func_26(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		...
		{
			func_430(iParam0, &(Global_105220.f_2354.f_539.f_298[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_557(int iParam0, bool bParam1)
{
	...
	{
		iVar0 = func_27(iParam0);
		func_558(iParam0, &(Global_105220.f_2354.f_539.f_1749), bParam1);
		iVar1 = 0;
		while (iVar1 <= (8 - 1))
		{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar7 < 2)
		{
			...
			while (iVar8 < FILES::GET_NUM_DLC_WEAPONS())
			{
				...
				{
					if (!FILES::_IS_DLC_DATA_EMPTY(Var9) && !func_431(Var9.f_1))
					{
						if (iVar7 == 0)
						{
...
void func_560(int iParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
...
bool func_563(int iParam0)
{
	...
	if (iParam0 == -61829581)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_565())
		{
			return 1;
		}
		else
	...
	switch (iParam0)
	{
		...
		case joaat("weapon_hatchet"):
			if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				if (!func_291() && !Global_262145.f_19122)
				{
					return 0;
				}
			}
	...
	while (iVar0 < FILES::GET_NUM_DLC_WEAPONS())
	{
		if (FILES::GET_DLC_WEAPON_DATA(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (FILES::_IS_DLC_DATA_EMPTY(Var1) || func_431(Var1.f_1))
				{
					return 0;
				}
			}
