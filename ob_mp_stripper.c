...
void __EntryFunction__()
{
	...
	if (DOES_ENTITY_EXIST(uScriptParam_0))
	{
		...
		iLocal_316 = Global_1589819[PLAYER_ID() /*818*/].f_273.f_25;
		func_71(&Global_1295642, iLocal_316);
		vLocal_378 = { Global_1295642.f_146.f_82[5 /*102*/] };
		fLocal_381 = Global_1295642.f_146.f_82[5 /*102*/].f_3;
		if (fLocal_381 < 0f)
		{
			fLocal_381 = (fLocal_381 + 360f);
		}
		vLocal_388 = { Global_1295642.f_146.f_82[5 /*102*/].f_16 };
		uLocal_391 = Global_1295642.f_146.f_82[5 /*102*/].f_19.f_2;
		vLocal_382 = { Global_1295642.f_146.f_82[5 /*102*/].f_7 };
		vLocal_385 = { Global_1295642.f_146.f_82[5 /*102*/].f_10 };
	}
	...
	while (true)
	{
		...
		{
			if (GET_DISTANCE_BETWEEN_COORDS(vLocal_378, GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 1) < 3f)
			{
				switch (iLocal_311)
				{
					case 0:
					...
					case 1:
						if (!IS_PED_INJURED(PLAYER_PED_ID()) && !func_58())
						{
							func_1();
						}
						else
			...
			else if (GET_DISTANCE_BETWEEN_COORDS(vLocal_378, GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 1) > (3f + 2f))
			{
				func_89();
			}
		}
...
void func_1()
{
	...
	{
		case 0:
			if (((func_53(vLocal_378, vVar0) && !func_52()) && GET_ENTITY_HEADING(PLAYER_PED_ID()) > (fLocal_381 - 45f)) && GET_ENTITY_HEADING(PLAYER_PED_ID()) < (fLocal_381 + 45f))
			{
			...
			if (func_49(1, 0, 1))
			{
				if (((func_53(vLocal_378, vVar0) && !func_52()) && GET_ENTITY_HEADING(PLAYER_PED_ID()) > (fLocal_381 - 45f)) && GET_ENTITY_HEADING(PLAYER_PED_ID()) < (fLocal_381 + 45f))
				{
					if ((!IS_PLAYER_FREE_AIMING(PLAYER_ID()) && !IS_PLAYER_TARGETTING_ANYTHING(PLAYER_ID())) && IS_CONTROL_JUST_PRESSED(2, 51))
					{
						...
						func_32(PLAYER_ID(), 0, 256, 0);
						iLocal_36 = 1;
						SET_CURRENT_PED_WEAPON(PLAYER_PED_ID(), joaat("weapon_unarmed"), 1);
						func_23(1, 1, 1, 0, 0, 0);
						TASK_PED_SLIDE_TO_COORD(PLAYER_PED_ID(), vLocal_378, fLocal_381, 1061158912);
						iLocal_312 = 2;
					}
				}
				else
		...
		case 2:
			...
			{
				func_15(104, 1, -1, 1);
				uLocal_317 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_382, vLocal_385, 2, 0, 0, 1065353216, 0, 1065353216);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_317, sLocal_324, sLocal_325, 4f, -2f, 1, 0, 1148846080, 0);
				if (!func_14(uLocal_322))
				{
					NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NET_TO_PED(uLocal_322), uLocal_317, sLocal_324, sLocal_326, 4f, -2f, 1, 0, 1148846080, 0);
					PLAY_FACIAL_ANIM(NET_TO_PED(uLocal_322), sLocal_328, sLocal_324);
				}
				if (!func_14(uLocal_323))
				{
					NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NET_TO_PED(uLocal_323), uLocal_317, sLocal_324, sLocal_327, 4f, -2f, 1, 0, 1148846080, 0);
					PLAY_FACIAL_ANIM(NET_TO_PED(uLocal_323), sLocal_329, sLocal_324);
				}
				NETWORK_START_SYNCHRONISED_SCENE(uLocal_317);
				iLocal_312 = 3;
			}
			break;
		...
		case 3:
			...
			HIDE_HUD_AND_RADAR_THIS_FRAME();
			func_19(1);
			uLocal_318 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uLocal_317);
			if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_318) > 0.99f)
			{
		...
		case 4:
			...
			func_19(1);
			uLocal_317 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_382, vLocal_385, 2, 0, 0, 1065353216, 0, 1065353216);
			NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_317, sLocal_372, sLocal_373, 4f, -2f, 1, 0, 1148846080, 0);
			if (!func_14(uLocal_322))
			{
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NET_TO_PED(uLocal_322), uLocal_317, sLocal_372, sLocal_374, 4f, -2f, 1, 0, 1148846080, 0);
				PLAY_FACIAL_ANIM(NET_TO_PED(uLocal_322), sLocal_376, sLocal_372);
			}
			if (!func_14(uLocal_323))
			{
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NET_TO_PED(uLocal_323), uLocal_317, sLocal_372, sLocal_375, 4f, -2f, 1, 0, 1148846080, 0);
				PLAY_FACIAL_ANIM(NET_TO_PED(uLocal_323), sLocal_377, sLocal_372);
			}
			NETWORK_START_SYNCHRONISED_SCENE(uLocal_317);
		...
		case 5:
			...
			{
				uLocal_317 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_382, vLocal_385, 2, 0, 0, 1065353216, 0, 1065353216);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_317, sLocal_348, sLocal_349, 4f, -2f, 1, 0, 1148846080, 0);
				if (!func_14(uLocal_322))
				{
					NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NET_TO_PED(uLocal_322), uLocal_317, sLocal_348, sLocal_350, 4f, -2f, 1, 0, 1148846080, 0);
					PLAY_FACIAL_ANIM(NET_TO_PED(uLocal_322), sLocal_352, sLocal_348);
				}
				if (!func_14(uLocal_323))
				{
					NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NET_TO_PED(uLocal_323), uLocal_317, sLocal_348, sLocal_351, 4f, -2f, 1, 0, 1148846080, 0);
					PLAY_FACIAL_ANIM(NET_TO_PED(uLocal_323), sLocal_353, sLocal_348);
				}
				NETWORK_START_SYNCHRONISED_SCENE(uLocal_317);
				if (func_51("SA_STRIP_CAM"))
				{
		...
		case 6:
			...
			HIDE_HUD_AND_RADAR_THIS_FRAME();
			func_19(1);
			if (!IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_317))
			{
				uLocal_317 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_382, vLocal_385, 2, 0, 1, 1065353216, 0, 1065353216);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_317, sLocal_354, sLocal_355, 4f, -2f, 1, 0, 1148846080, 0);
				if (!func_14(uLocal_322))
				{
					NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NET_TO_PED(uLocal_322), uLocal_317, sLocal_354, sLocal_356, 4f, -2f, 1, 0, 1148846080, 0);
					PLAY_FACIAL_ANIM(NET_TO_PED(uLocal_322), sLocal_358, sLocal_354);
				}
				if (!func_14(uLocal_323))
				{
					NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NET_TO_PED(uLocal_323), uLocal_317, sLocal_354, sLocal_357, 4f, -2f, 1, 0, 1148846080, 0);
					PLAY_FACIAL_ANIM(NET_TO_PED(uLocal_323), sLocal_359, sLocal_354);
				}
				NETWORK_START_SYNCHRONISED_SCENE(uLocal_317);
				iLocal_319++;
		...
		case 8:
			...
			func_19(1);
			uLocal_317 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_382, vLocal_385, 2, 0, 0, 1065353216, 0, 1065353216);
			NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_317, sLocal_360, sLocal_361, 4f, -2f, 1, 0, 1148846080, 0);
			if (!func_14(uLocal_322))
			{
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NET_TO_PED(uLocal_322), uLocal_317, sLocal_360, sLocal_362, 4f, -2f, 1, 0, 1148846080, 0);
				PLAY_FACIAL_ANIM(NET_TO_PED(uLocal_322), sLocal_364, sLocal_360);
			}
			if (!func_14(uLocal_323))
			{
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NET_TO_PED(uLocal_323), uLocal_317, sLocal_360, sLocal_363, 4f, -2f, 1, 0, 1148846080, 0);
				PLAY_FACIAL_ANIM(NET_TO_PED(uLocal_323), sLocal_365, sLocal_360);
			}
			NETWORK_START_SYNCHRONISED_SCENE(uLocal_317);
			iLocal_312 = 9;
			break;
		...
		case 10:
			...
			Global_1573338 = 3;
			uLocal_317 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_382, vLocal_385, 2, 0, 0, 1065353216, 0, 1065353216);
			NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_317, sLocal_366, sLocal_367, 4f, -2f, 1, 0, 1148846080, 0);
			if (!func_14(uLocal_322))
			{
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NET_TO_PED(uLocal_322), uLocal_317, sLocal_366, sLocal_368, 4f, -2f, 1, 0, 1148846080, 0);
				PLAY_FACIAL_ANIM(NET_TO_PED(uLocal_322), sLocal_370, sLocal_366);
			}
			if (!func_14(uLocal_323))
			{
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NET_TO_PED(uLocal_323), uLocal_317, sLocal_366, sLocal_369, 4f, -2f, 1, 0, 1148846080, 0);
				PLAY_FACIAL_ANIM(NET_TO_PED(uLocal_323), sLocal_371, sLocal_366);
			}
			NETWORK_START_SYNCHRONISED_SCENE(uLocal_317);
			iLocal_312 = 11;
			break;
		...
		case 11:
			...
			if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_318) > 0.5f)
			{
				if (!func_14(uLocal_322))
				{
					if (NETWORK_HAS_CONTROL_OF_NETWORK_ID(uLocal_322))
					{
						func_9(&uLocal_322);
					}
				}
				if (!func_14(uLocal_323))
				{
					if (NETWORK_HAS_CONTROL_OF_NETWORK_ID(uLocal_323))
					{
						func_9(&uLocal_323);
					}
				}
				...
				_RENDER_FIRST_PERSON_CAM(0, 1f, 3, 0);
...
void func_2()
{
	...
	if (iVar0 > -1 && iVar0 != func_8())
	{
		...
		while (iVar1 < 22)
		{
			if (Global_1589819[PLAYER_ID() /*818*/].f_273.f_25 == Global_1589819[iVar0 /*818*/].f_273[iVar1])
			{
				if (iVar0 == PLAYER_ID())
				{
					func_6(iVar1);
...
{
	return IS_BIT_SET(Global_1371947.f_241.f_136[func_13(9) /*33*/][iParam0], func_12(9));
}
...
void func_23(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_27(PLAYER_ID())) && !func_25(PLAYER_ID(), 0)) && !func_24()) && !bParam4) && !bParam5)
			{
	...
	else
	{
		...
		if (NETWORK_IS_PLAYER_ACTIVE(iParam0) && (IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_25(PLAYER_ID(), 0) && !func_28()))
				{
			...
			if (bParam1)
			{
				if (!func_36(uVar25) && !IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar25))
				{
					if (!bVar21)
					{
...
void func_40()
{
	if (!NETWORK_DOES_NETWORK_ID_EXIST(uLocal_322))
	{
		if (func_42(2, 0, 1))
		{
			if (CAN_REGISTER_MISSION_PEDS(2))
			{
				if (func_41(&uLocal_322, 5, iLocal_320, vLocal_388, uLocal_391, 1, 1, 1) && func_41(&uLocal_323, 5, iLocal_321, vLocal_388, uLocal_391, 1, 1, 1))
				{
					SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_320);
					SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_321);
					iLocal_314 = 0;
				}
			}
		}
...
void func_48()
{
	if (IS_PC_VERSION())
	{
		if (iLocal_392 == 0)
		{
			_0x3D42B92563939375("SAFEHOUSE ACTIVITY");
			iLocal_392 = 1;
		}
	}
}
...
int func_53(vector3 vParam0, float fParam3, var uParam4, var uParam5)
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if ((!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !IS_ENTITY_ON_FIRE(PLAYER_PED_ID())) && IS_PLAYER_CONTROL_ON(PLAYER_ID()))
		{
			...
			{
				if ((((IS_GAMEPLAY_CAM_RENDERING() && !IS_CUTSCENE_PLAYING()) && !IS_CINEMATIC_CAM_RENDERING()) && !func_57(0)) && !func_56())
				{
					if ((Global_90640 && Global_90641) || func_55())
					{
						return 0;
					}
					if (func_54(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vParam0, fParam3, 0))
					{
						return 1;
					}
				}
...
int func_54(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_58()
{
	...
	if (func_59() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_59()) == 0)
		{
			return 1;
		}
	}
...
int func_69()
{
	REQUEST_MODEL(iLocal_320);
	REQUEST_MODEL(iLocal_321);
	if (HAS_MODEL_LOADED(iLocal_320) && HAS_MODEL_LOADED(iLocal_321))
	{
		iLocal_314 = 1;
		return 1;
	}
...
int func_70()
{
	...
	REQUEST_ANIM_DICT(sLocal_336);
	REQUEST_ANIM_DICT(sLocal_342);
	REQUEST_ANIM_DICT(sLocal_348);
	REQUEST_ANIM_DICT(sLocal_354);
	REQUEST_ANIM_DICT(sLocal_360);
	REQUEST_ANIM_DICT(sLocal_366);
	if (((((((!HAS_ANIM_DICT_LOADED(sLocal_324) || !HAS_ANIM_DICT_LOADED(sLocal_330)) || !HAS_ANIM_DICT_LOADED(sLocal_336)) || !HAS_ANIM_DICT_LOADED(sLocal_342)) || !HAS_ANIM_DICT_LOADED(sLocal_348)) || !HAS_ANIM_DICT_LOADED(sLocal_354)) || !HAS_ANIM_DICT_LOADED(sLocal_360)) || !HAS_ANIM_DICT_LOADED(sLocal_366))
	{
		return 0;
	}
	else if (!iLocal_313)
...
void func_73(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	*uParam2 = { func_75(iParam1, 86) };
	...
	vVar13 = { func_74(vVar13, -Var0[0 /*6*/].f_3.f_2) };
	vVar13 = { func_74(vVar13, Var0[1 /*6*/].f_3.f_2) };
...
void func_89()
{
	...
	if (iLocal_313)
	{
		...
		REMOVE_ANIM_DICT(sLocal_336);
		REMOVE_ANIM_DICT(sLocal_342);
		REMOVE_ANIM_DICT(sLocal_348);
		REMOVE_ANIM_DICT(sLocal_354);
		REMOVE_ANIM_DICT(sLocal_360);
		REMOVE_ANIM_DICT(sLocal_366);
	}
	if (DOES_CAM_EXIST(uLocal_315))
	{
		DESTROY_CAM(uLocal_315, 0);
	}
	func_10();
	if (iLocal_36)
	{
