...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (IS_PLAYER_PLAYING(PLAYER_ID()))
		{
			...
			_0x07FB139B592FA687((vVar0.x - 2000f), (vVar0.y - 2000f), (vVar0.x + 2000f), (vVar0.y + 2000f));
...
int func_32()
{
	...
	while (iVar0 < 3)
	{
		if (!IS_PED_INJURED(uLocal_85[iVar0]))
		{
			iVar1 = 0;
		}
		iVar0++;
...
int func_33()
{
	...
	if (!func_49())
	{
		...
		while (iVar0 < 3)
		{
			if (!IS_PED_INJURED(uLocal_85[iVar0]))
			{
				if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(uLocal_85[iVar0], 0)) < 400f)
				{
					if (!iLocal_62)
					{
						if (iLocal_83 == 2)
						{
							if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && GET_ENTITY_SPEED(PLAYER_PED_ID()) < 2f)
							{
								iLocal_62 = 1;
								iLocal_83 = 3;
							}
						...
						if (((HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_85[iVar0], PLAYER_PED_ID(), 1) || IS_PED_SHOOTING(PLAYER_PED_ID())) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uLocal_85[iVar0])) || IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uLocal_85[iVar0]))
						{
							iLocal_62 = 1;
							iLocal_65 = 1;
							iLocal_64 = 1;
					...
					if (!iLocal_62 || iLocal_83 < 3)
					{
						if (TIMERA() > 5000)
						{
							if (!IS_PED_IN_WRITHE(uLocal_85[iVar0]))
							{
								func_48(&uLocal_99, 1);
					...
					{
						if (!func_49() && !IS_PED_IN_WRITHE(uLocal_85[iVar0]))
						{
							SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_97, 1862763509);
							SET_PED_COMBAT_ATTRIBUTES(uLocal_85[iVar0], 2, 1);
							func_48(&uLocal_99, 1);
							func_47(&uLocal_99, 1, uLocal_85[iVar0], "BorderPatrol", 0, 1);
							if (func_34() == 0)
							{
					...
					else if (!func_49())
					{
						...
						if (TIMERA() > 5000 && !IS_PED_IN_WRITHE(uLocal_85[iVar0]))
						{
							func_48(&uLocal_99, 1);
							func_47(&uLocal_99, 1, uLocal_85[iVar0], "BorderPatrol", 0, 1);
							if (func_34() == 0)
...
int func_50()
{
	...
	while (iVar0 < 3)
	{
		if (!IS_PED_INJURED(uLocal_85[iVar0]))
		{
			if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), GET_ENTITY_COORDS(uLocal_85[iVar0], 0)) < 62500f)
			{
				return 1;
			}
			else
...
void func_51()
{
	...
	while (iVar0 < 3)
	{
		if (!IS_PED_INJURED(uLocal_85[iVar0]))
		{
			...
			{
				if (IS_PED_IN_ANY_VEHICLE(uLocal_85[iVar0], 0))
				{
					if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !iLocal_67[iVar0])
					{
						if (!IS_ENTITY_DEAD(uLocal_89[iVar0], 0))
						{
							TASK_VEHICLE_MISSION(uLocal_85[iVar0], uLocal_89[iVar0], GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
						}
						if (!iLocal_65)
						{
						...
						if (!IS_PED_INJURED(uLocal_85[iVar0]))
						{
							if (IS_PED_IN_ANY_VEHICLE(uLocal_85[iVar0], 0))
							{
								TASK_DRIVE_BY(uLocal_85[iVar0], PLAYER_PED_ID(), 0, 0f, 0f, 0f, 1000f, 60, 1, -753768974);
								SET_PED_KEEP_TASK(uLocal_85[iVar0], 1);
							}
						}
						iLocal_71[iVar0] = 0;
						iLocal_67[iVar0] = 1;
					}
					else if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !iLocal_71[iVar0])
					{
						if (!IS_PED_INJURED(uLocal_85[iVar0]) && !IS_ENTITY_DEAD(uLocal_89[iVar0], 0))
						{
							TASK_VEHICLE_MISSION_PED_TARGET(uLocal_85[iVar0], uLocal_89[iVar0], PLAYER_PED_ID(), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
							if (!iLocal_65)
							{
								WAIT(GET_RANDOM_INT_IN_RANGE(400, 800));
							}
				...
				else if (!IS_PED_IN_ANY_VEHICLE(uLocal_85[iVar0], 0))
				{
					TASK_COMBAT_PED(uLocal_85[iVar0], PLAYER_PED_ID(), 0, 16);
					SET_PED_KEEP_TASK(uLocal_85[iVar0], 1);
				}
			}
			else if (IS_PED_IN_ANY_VEHICLE(uLocal_85[iVar0], 0))
			{
				if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !iLocal_75[iVar0])
				{
					if (GET_SCRIPT_TASK_STATUS(uLocal_85[iVar0], 579380604) != 1 && GET_SCRIPT_TASK_STATUS(uLocal_85[iVar0], 579380604) != 0)
					{
						CLEAR_PED_TASKS(uLocal_85[iVar0]);
						if (!IS_ENTITY_DEAD(uLocal_89[iVar0], 0))
						{
							TASK_VEHICLE_MISSION(uLocal_85[iVar0], uLocal_89[iVar0], GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
							TASK_LOOK_AT_ENTITY(uLocal_85[iVar0], PLAYER_PED_ID(), -1, 2096, 4);
						}
						iLocal_79[iVar0] = 0;
						iLocal_75[iVar0] = 1;
					}
				}
				else if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !iLocal_79[iVar0])
				{
					if ((!IS_PED_INJURED(uLocal_85[iVar0]) && !IS_PED_INJURED(PLAYER_PED_ID())) && !IS_ENTITY_DEAD(uLocal_89[iVar0], 0))
					{
						CLEAR_PED_TASKS(uLocal_85[iVar0]);
						TASK_VEHICLE_MISSION_PED_TARGET(uLocal_85[iVar0], uLocal_89[iVar0], PLAYER_PED_ID(), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
						TASK_LOOK_AT_ENTITY(uLocal_85[iVar0], PLAYER_PED_ID(), -1, 2096, 4);
			...
			{
				TASK_FOLLOW_TO_OFFSET_OF_ENTITY(uLocal_85[iVar0], PLAYER_PED_ID(), 1f, 0f, 0f, 2f, -1, 1036831949, 1);
			}
			if (!IS_PED_INJURED(uLocal_85[iVar0]))
			{
				if (IS_ENTITY_IN_WATER(uLocal_85[iVar0]))
				{
					if (IS_PED_IN_ANY_VEHICLE(uLocal_85[iVar0], 0))
					{
						TASK_LEAVE_ANY_VEHICLE(uLocal_85[iVar0], 0, 0);
					}
					if (!IS_PED_IN_COMBAT(uLocal_85[iVar0], 0))
					{
						TASK_COMBAT_PED(uLocal_85[iVar0], PLAYER_PED_ID(), 0, 16);
					}
				}
			}
			if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && IS_PED_IN_ANY_VEHICLE(uLocal_85[iVar0], 0))
			{
				if (GET_ENTITY_SPEED(PLAYER_PED_ID()) > 13f)
				{
					if (IS_ENTITY_TOUCHING_ENTITY(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), GET_VEHICLE_PED_IS_IN(uLocal_85[iVar0], 0)))
					{
						SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(uLocal_85[iVar0], 3);
					}
					else
					{
						SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(uLocal_85[iVar0], 1);
					}
				}
				else
				{
			...
			if (func_127())
			{
				TASK_SMART_FLEE_PED(uLocal_85[iVar0], PLAYER_PED_ID(), 1000f, -1, 0, 0);
			}
		}
		else if (DOES_ENTITY_EXIST(uLocal_85[iVar0]))
		{
			iLocal_65 = 1;
			iLocal_64 = 1;
		}
...
void func_52()
{
	...
	while (iVar0 < 3)
	{
		if (!IS_PED_INJURED(uLocal_85[iVar0]))
		{
			...
			{
				if (!DOES_BLIP_EXIST(uLocal_93[iVar0]))
				{
					uLocal_93[iVar0] = func_53(uLocal_85[iVar0], 1, 145);
				}
			}
		}
		else if (DOES_BLIP_EXIST(uLocal_93[iVar0]))
		{
			REMOVE_BLIP(&(uLocal_93[iVar0]));
		}
		iVar0++;
	}
}
...
int func_54(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_55(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		SET_BLIP_SCALE(uVar0, func_55(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
int func_66()
{
	...
	REQUEST_MODEL(iVar6);
	REQUEST_MODEL(iVar7);
	if ((HAS_MODEL_LOADED(iVar8) && HAS_MODEL_LOADED(iVar6)) && HAS_MODEL_LOADED(iVar7))
	{
		if ((IS_VEHICLE_DRIVEABLE(uLocal_89[0], 0) && IS_VEHICLE_DRIVEABLE(uLocal_89[1], 0)) && IS_VEHICLE_DRIVEABLE(uLocal_89[2], 0))
		{
			return 1;
		}
		else
		{
			...
			{
				GET_NTH_CLOSEST_VEHICLE_NODE_FAVOUR_DIRECTION(GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PLAYER_PED_ID(), 0f, -25f, 0f), GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 1, &vVar0, &uVar3, 1, 1077936128, 0);
				if (!IS_SPHERE_VISIBLE(vVar0, 5f))
				{
					ADD_RELATIONSHIP_GROUP("re_border badGuys", &uLocal_97);
					SET_RELATIONSHIP_BETWEEN_GROUPS(3, uLocal_97, 1862763509);
					iVar4 = 0;
					while (iVar4 < 3)
					{
						vVar0.x = (vVar0.x + TO_FLOAT(iVar4));
						vVar0.y = (vVar0.y + TO_FLOAT(iVar4));
						iVar5 = GET_RANDOM_INT_IN_RANGE(0, 5);
						if (iVar5 > 1)
						{
							uLocal_89[iVar4] = CREATE_VEHICLE(iVar6, vVar0, uVar3, 1, 1, 0);
						}
						else
						{
							uLocal_89[iVar4] = CREATE_VEHICLE(iVar7, vVar0, uVar3, 1, 1, 0);
						}
						uLocal_85[iVar4] = CREATE_PED_INSIDE_VEHICLE(uLocal_89[iVar4], 22, iVar8, -1, 1, 1);
						TASK_LOOK_AT_ENTITY(uLocal_85[iVar4], PLAYER_PED_ID(), -1, 2096, 4);
						SET_PED_KEEP_TASK(uLocal_85[iVar4], 1);
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_85[iVar4], 1);
						SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_85[iVar4], uLocal_97);
						GIVE_WEAPON_TO_PED(uLocal_85[iVar4], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
						SET_VEHICLE_FORWARD_SPEED(uLocal_89[iVar4], GET_ENTITY_SPEED(PLAYER_PED_ID()));
						SET_PED_COMBAT_MOVEMENT(uLocal_85[iVar4], 2);
						SET_PED_COMBAT_ATTRIBUTES(uLocal_85[iVar4], 50, 1);
						SET_PED_COMBAT_ATTRIBUTES(uLocal_85[iVar4], 2, 1);
						SET_PED_COMBAT_ATTRIBUTES(uLocal_85[iVar4], 1, 1);
						SET_PED_COMBAT_ATTRIBUTES(uLocal_85[iVar4], 52, 1);
						SET_PED_ACCURACY(uLocal_85[iVar4], 5);
						SET_PED_FIRING_PATTERN(uLocal_85[iVar4], 1566631136);
						SET_PED_SHOOT_RATE(uLocal_85[iVar4], GET_RANDOM_INT_IN_RANGE(50, 100));
						SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(uLocal_85[iVar4], 1);
						SET_PED_CONFIG_FLAG(uLocal_85[iVar4], 42, 1);
						SET_PED_HELMET(uLocal_85[iVar4], 0);
						SET_PED_MONEY(uLocal_85[iVar4], 233);
						SET_AMBIENT_VOICE_NAME(uLocal_85[iVar4], "A_M_M_HILLBILLY_02_WHITE_MINI_04");
						STOP_PED_SPEAKING(uLocal_85[iVar4], 1);
						iVar4++;
					}
					SET_VEHICLE_COLOUR_COMBINATION(uLocal_89[0], 0);
					SET_VEHICLE_COLOUR_COMBINATION(uLocal_89[1], 1);
					SET_VEHICLE_COLOUR_COMBINATION(uLocal_89[2], 2);
				}
			}
			switch (func_34())
			{
			...
			func_47(&uLocal_99, 0, PLAYER_PED_ID(), sLocal_98, 0, 1);
...
int func_67()
{
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (VMAG2(GET_ENTITY_VELOCITY(PLAYER_PED_ID())) > 1369f && !func_74())
		{
			return 0;
		}
	}
...
void func_91(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = ROUND(func_92(TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_99(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_102()
{
	...
	func_105(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_104(&uVar0, GET_CLOCK_MONTH());
	func_103(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_119()) || Global_105612) || Global_25767) || func_118()) || func_43(8, -1)) || func_117()) || func_116()) || func_115()) || func_114()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_119()) || Global_25767) || func_118()) || func_43(8, -1)) || func_115()) || func_117()) || func_116()) || func_114()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_119()) || Global_105612) || Global_25767) || func_118()) || func_43(8, -1)) || func_117()) || func_116()) || func_114()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_119() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_43(8, -1)) || func_114()) || func_113()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_119()) || Global_25767) || func_118()) || func_43(8, -1)) || func_116()) || func_115()) || func_114()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_119()) || func_116()) || Global_105612) || Global_25767) || func_118()) || Global_37584) || func_43(8, -1)) || func_115()) || func_113()) || func_114()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
int func_127()
{
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			{
				if (((((IS_PED_IN_MODEL(PLAYER_PED_ID(), joaat("rhino")) || IS_PED_IN_MODEL(PLAYER_PED_ID(), joaat("ambulance"))) || IS_PED_IN_MODEL(PLAYER_PED_ID(), joaat("firetruk"))) || IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER_PED_ID())) || IS_PED_IN_FLYING_VEHICLE(PLAYER_PED_ID())) || Global_105612 == 1)
				{
					return 1;
				}
			}
...
void func_128()
{
	...
	if (iLocal_61)
	{
		...
		while (iVar0 < 3)
		{
			if (!IS_PED_INJURED(uLocal_85[iVar0]) && !IS_PED_INJURED(PLAYER_PED_ID()))
			{
				TASK_SMART_FLEE_PED(uLocal_85[iVar0], PLAYER_PED_ID(), 1000f, -1, 0, 0);
				SET_PED_KEEP_TASK(uLocal_85[iVar0], 1);
			}
...
Vector3 func_140()
{
	...
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		fVar0 = GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_51, 1);
		iLocal_60 = 1;
		if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_54, 1) < fVar0)
		{
			fVar0 = GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_54, 1);
			iLocal_60 = 2;
		}
		if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_57, 1) < fVar0)
		{
			fVar0 = GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_57, 1);
			iLocal_60 = 3;
		}
		if (iLocal_60 == 1)
		{
