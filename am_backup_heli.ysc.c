		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			...
			switch (func_85(NETSHOP::_NETWORK_SHOP_BASKET_START()))
			{
				case 0:
					if (func_84() > 0)
					{
						iLocal_248[NETSHOP::_NETWORK_SHOP_BASKET_START()] = 2;
					}
					break;
				...
				case 2:
					...
					if (func_84() == 3)
					{
						iLocal_248[NETSHOP::_NETWORK_SHOP_BASKET_START()] = 3;
					}
					break;
	...
	switch (Local_227.f_1.f_2)
	{
		...
		case 2:
			...
			else
			{
				...
				if (func_10(CAM::_0xDC9DA9E8789F5246(), 0))
				{
					func_56(3);
				}
				if (bLocal_52)
				...
				if (func_8(CAM::_0xDC9DA9E8789F5246(), 136))
				{
					func_56(3);
				}
			}
...
{
	if (Global_252F9E.f_F95)
	{
		func_15(1, 600000);
		bLocal_52 = true;
	}
	if (Global_252F9E.f_F94 >= 250f)
	{
		func_15(1, 600000);
		bLocal_52 = true;
	}
		...
		if (func_35(Local_227.f_1.f_3[0 /*2*/].f_1))
		{
			if (!func_12(Local_227.f_1))
			{
				if (func_34(&(Local_227.f_1), Local_227.f_1.f_1, Local_227.f_1.f_A, 0f, 1, 1, 1, 0, 0, 1, 0, 0, 0, 0))
				{
					...
					Global_252F9E.f_F8F = NETWORK::NET_TO_VEH(Local_227.f_1);
					if (func_32(&(Local_227.f_1.f_3[0 /*2*/]), Local_227.f_1, 4, Local_227.f_1.f_3[0 /*2*/].f_1, 4294967295, 1, 1, 1))
					{
						...
						NETWORK::_0x0EDE326D47CD0F3E(NETWORK::NET_TO_PED(Local_227.f_1.f_3[0 /*2*/]), CAM::_0xDC9DA9E8789F5246());
						func_33(NETWORK::NET_TO_PED(Local_227.f_1.f_3[0 /*2*/]), 4);
						Global_252F9E.f_F90[0] = NETWORK::NET_TO_PED(Local_227.f_1.f_3[0 /*2*/]);
						if (func_32(&(Local_227.f_1.f_3[1 /*2*/]), Local_227.f_1, 4, Local_227.f_1.f_3[1 /*2*/].f_1, 1, 1, 1, 1))
						{
							...
							NETWORK::_0x0EDE326D47CD0F3E(NETWORK::NET_TO_PED(Local_227.f_1.f_3[1 /*2*/]), CAM::_0xDC9DA9E8789F5246());
							func_33(NETWORK::NET_TO_PED(Local_227.f_1.f_3[1 /*2*/]), 4);
							Global_252F9E.f_F90[1] = NETWORK::NET_TO_PED(Local_227.f_1.f_3[1 /*2*/]);
							if (func_32(&(Local_227.f_1.f_3[2 /*2*/]), Local_227.f_1, 4, Local_227.f_1.f_3[2 /*2*/].f_1, 2, 1, 1, 1))
							{
								...
								NETWORK::_0x0EDE326D47CD0F3E(NETWORK::NET_TO_PED(Local_227.f_1.f_3[2 /*2*/]), CAM::_0xDC9DA9E8789F5246());
								func_33(NETWORK::NET_TO_PED(Local_227.f_1.f_3[2 /*2*/]), 4);
								Global_252F9E.f_F90[2] = NETWORK::NET_TO_PED(Local_227.f_1.f_3[2 /*2*/]);
								return 1;
							}
						}
					}
...
void func_27(var uParam0)//Position - 0xC14
{
	...
	if (!func_29(CAM::_0xDC9DA9E8789F5246(), 0) && !func_28())
	{
		iVar0 = Global_180854[5];
	}
	else
	{
		iVar0 = PED::GET_PED_RELATIONSHIP_GROUP_HASH(AUDIO::_0x0626A247D2405330());
	}
...
int func_36()//Position - 0xE98
{
	...
	if (func_55(Local_227.f_1.f_A))
	{
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			...
			{
				vVar0 = { func_53(func_54(CAM::_0xDC9DA9E8789F5246()), 0f, (-200f * SYSTEM::SIN((SYSTEM::TO_FLOAT(Local_227.f_1.f_F) * 30f))), (200f * SYSTEM::COS((SYSTEM::TO_FLOAT(Local_227.f_1.f_F) * 30f))), 0f) };
				vVar0.z = PATHFIND::_0x29C24BFBED8AB8FB(vVar0.x, vVar0.y);
				vVar0.z = (vVar0.z + 30f);
				if (func_37(vVar0, 20f, 1f, 1f, 15f, 1, 1, 1, 180f, 0, 4294967295, 1, 0, 0, 0, 0, 0))
				{
...
int func_38(vector3 vParam0, float fParam1, int iParam2, int iParam3, float fParam4, bool bParam5, int iParam6, float fParam7, bool bParam8)//Position - 0x109C
{
	...
	if (iParam2 && !bParam5)
	{
		if (func_45(CAM::_0xDC9DA9E8789F5246(), 1, 1))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_43(CAM::_0xDC9DA9E8789F5246()), vParam0, 1) <= (fVar2 + fParam1))
				{
	...
	while (iVar0 < 32)
	{
		...
		{
			if (!func_40(iVar1, 0) && NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(CAM::_0xDC9DA9E8789F5246(), iVar1))
			{
				if (iParam2 == 1 || (iParam2 == 0 && iVar1 != CAM::_0xDC9DA9E8789F5246()))
				{
					if ((func_39(iVar1) || !bParam8) && !Global_24FBF9[iVar1 /*413*/].f_103)
					{
						fVar2 = fParam4;
						if (fParam7 > 0f)
						{
						...
						if (!bParam5)
						{
							...
							{
								if (MISC::GET_DISTANCE_BETWEEN_COORDS(func_43(iVar1), vParam0, 1) <= (fVar2 + fParam1))
								{
...
bool func_40(int iParam0, int iParam1)//Position - 0x127F
{
	bool bVar0;
	
	if (iParam0 == CAM::_0xDC9DA9E8789F5246())
	{
		bVar0 = func_41(4294967295, 0) == 8;
	}
	else
	{
...
int func_41(int iParam0, bool bParam1)//Position - 0x12CA
{
	int iVar0;
	int iVar1;
...
int func_42()//Position - 0x130B
{
	return Global_1407E0;
}

Vector3 func_43(int iParam0)//Position - 0x1317
{
	int iVar0;
	
	iVar0 = iParam0;
	if ((func_44() && Global_1841F3[iVar0 /*790*/].f_2F9) && !func_55(Global_1841F3[iVar0 /*790*/].f_2FA))
	{
...
var func_44()//Position - 0x136A
{
	return Global_255C02.f_10;
}

int func_45(int iParam0, bool bParam1, bool bParam2)//Position - 0x1378
{
	int iVar0;
...
int func_46(vector3 vParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, var uParam7)//Position - 0x13C2
{
	int iVar0;
	int iVar1;
			...
			if (func_45(iVar1, bParam2, bParam3))
			{
				if (NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(CAM::_0xDC9DA9E8789F5246(), iVar1))
				{
					if (!bParam5 || (!PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(iVar1)) && func_39(iVar1)))
					{
						...
						{
							if (((PLAYER::GET_PLAYER_TEAM(CAM::_0xDC9DA9E8789F5246()) == 4294967295 && uParam7) && bParam4) && func_47(iVar1))
							{
							}
...
int func_47(int iParam0)//Position - 0x14BE
{
	if (func_52(CAM::_0xDC9DA9E8789F5246(), iParam0))
	{
		return 1;
	}
	Global_2633E1 = { func_51(iParam0) };
	if (NETWORK::NETWORK_IS_FRIEND(&Global_2633E1))
	{
		return 1;
	}
	if (func_48(CAM::_0xDC9DA9E8789F5246(), iParam0))
	{
		return 1;
	}
	return 0;
...
int func_48(int iParam0, int iParam1)//Position - 0x1505
{
	int iVar0;
...
int func_49()//Position - 0x1530
{
	return 4294967295;
}

int func_50(int iParam0)//Position - 0x1539
{
	if (iParam0 != func_49())
	{
...
struct<13> func_51(int iParam0)//Position - 0x155C
{
	struct<13> Var0;
...
int func_52(int iParam0, int iParam1)//Position - 0x1573
{
	if (GRAPHICS::_DRAW_SHOWROOM())
	{
		Global_2633E1 = { func_51(iParam0) };
		Global_2633EE = { func_51(iParam1) };
...
Vector3 func_53(vector3 vParam0, float fParam1, struct<2> Param2, float fParam3)//Position - 0x15E0
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_54(int iParam0)//Position - 0x162D
{
	return unk_0x8000C77B5F336760(PLAYER::GET_PLAYER_PED(iParam0), 0);
}

int func_55(vector3 vParam0)//Position - 0x1640
{
...
void func_56(int iParam0)//Position - 0x166A
{
	Local_227.f_1.f_2 = iParam0;
}

void func_57()//Position - 0x167A
{
	func_82();
	func_58();
}

void func_58()//Position - 0x168A
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case 2:
			if (func_12(Local_227.f_1))
			{
				...
				if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_227.f_1.f_3[0 /*2*/]))
				{
					...
					{
						iVar2 = BRAIN::GET_ACTIVE_VEHICLE_MISSION_TYPE(iVar1);
							...
							if (func_78(Local_227.f_1))
							{
								if (NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_227.f_1.f_3[0 /*2*/]))
								{
									...
									if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
									{
										if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
										{
											BRAIN::TASK_HELI_MISSION(iVar0, iVar1, 0, AUDIO::_0x0626A247D2405330(), 0f, 0f, 0f, 23, 20f, 40f, -1f, SYSTEM::CEIL(fLocal_61[0]), 10, -1f, 0);
										}
									}
								}
							}
						...
						if (!iLocal_50)
						{
							if (SYSTEM::VDIST(func_54(CAM::_0xDC9DA9E8789F5246()), unk_0x8000C77B5F336760(NETWORK::NET_TO_VEH(Local_227.f_1), 1)) <= 50f)
							{
					...
					if (iLocal_53 == 0)
					{
						if (func_78(Local_227.f_1))
						{
							if (NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_227.f_1.f_3[0 /*2*/]))
							{
								...
								PED::SET_PED_RELATIONSHIP_GROUP_HASH(iVar0, Global_180845);
								if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
								{
									if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
									{
										BRAIN::TASK_HELI_MISSION(iVar0, iVar1, 0, AUDIO::_0x0626A247D2405330(), 0f, 0f, 0f, 8, 20f, 500f, -1f, 40, 10, -1f, 0);
...
int func_60(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1C4B
{
...
int func_61(char* sParam0, int iParam1, bool bParam2)//Position - 0x1C99
{
	Global_3DCF = 0;
...
var func_67()//Position - 0x218D
{
	func_68();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_68()//Position - 0x21A6
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_71(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			iVar0 = func_70(AUDIO::_0x0626A247D2405330());
			if (func_69(iVar0) && (!func_72(14) || Global_19A3D))
			{
				if (Global_19E56.f_933.f_21B.f_10CD != iVar0 && func_69(Global_19E56.f_933.f_21B.f_10CD))
				{
...
bool func_69(int iParam0)//Position - 0x22A3
{
	return iParam0 < 3;
}

int func_70(int iParam0)//Position - 0x22AF
{
	int iVar0;
	int iVar1;
...
int func_71(int iParam0)//Position - 0x22EC
{
	if (func_69(iParam0))
	{
...
bool func_72(int iParam0)//Position - 0x2316
{
	return Global_8D15 == iParam0;
}

void func_73()//Position - 0x2324
{
	int iVar0;
...
bool func_74(int iParam0, int iParam1)//Position - 0x237B
{
	switch (iParam0)
	{
		case 5:
...
void func_76(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x240D
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
int func_78(var uParam0)//Position - 0x2491
{
...
void func_79(int iParam0, int iParam1)//Position - 0x24B5
{
	int iVar0;
...
int func_80(int iParam0)//Position - 0x24DB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_83(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x2795
{
...
int func_84()//Position - 0x2830
{
	return Local_227;
}

int func_85(int iParam0)//Position - 0x283A
{
	return iLocal_248[iParam0];
}

void func_86()//Position - 0x2848
{
	bool bVar0;
	vector3 vVar1;
	...
	if (bVar0)
	{
		vVar1 = { func_54(CAM::_0xDC9DA9E8789F5246()) };
...
void func_87(var uParam0)//Position - 0x28B7
{
	uParam0->f_1 = 0;
}

void func_88()//Position - 0x28C4
{
}

void func_89()//Position - 0x28CC
{
	var uVar0;
	var uVar1;
	
	Global_252F9E.f_F8F = uVar0;
	Global_252F9E.f_F90[0] = uVar1;
	Global_252F9E.f_F90[1] = uVar1;
	Global_252F9E.f_F90[2] = uVar1;
	Global_252F9E.f_F94 = 0f;
	Global_252F9E.f_F95 = 0;
	func_91(func_92(1, 1), 10, func_49());
	func_90();
}

void func_90()//Position - 0x2925
{
	HUD::DISPLAY_SNIPER_SCOPE_THIS_FRAME();
}

void func_91(int iParam0, int iParam1, var uParam2)//Position - 0x2931
{
	struct<4> Var0;
...
int func_92(int iParam0, bool bParam1)//Position - 0x2969
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_93()//Position - 0x29CE
{
	...
	if (func_94() != 0)
	{
		if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_94()) == 0)
		{
			return 1;
		}
	}
...
int func_95()//Position - 0x2A8C
{
	return Global_6373;
}

bool func_96()//Position - 0x2A97
{
	return Global_255C02.f_24B;
}

int func_97(int iParam0)//Position - 0x2AA6
{
...
bool func_98()//Position - 0x2ABD
{
	return Global_25824F;
}

bool func_99()//Position - 0x2AC9
{
	return Global_255C02.f_246;
}

void func_100(var uParam0)//Position - 0x2AD8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_101(int iParam0)//Position - 0x2B4B
{
	vector3 vVar0;
	int iVar1;
	int iVar2;
...
int func_102(int iParam0, var uParam1)//Position - 0x2BCC
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_103()//Position - 0x2C2B
{
	SYSTEM::WAIT(0);
}

void func_104(struct<21> Param0)//Position - 0x2C38
{
	func_110(func_111(Param0), Param0);
	NETWORK::RESERVE_NETWORK_MISSION_PEDS(3);
	NETWORK::RESERVE_NETWORK_MISSION_VEHICLES(1);
	func_108(0, 4294967295, 0);
	...
	func_105(62, 1);
	iLocal_248[NETSHOP::_NETWORK_SHOP_BASKET_START()] = 0;
}

void func_105(int iParam0, bool bParam1)//Position - 0x2C9B
{
	int iVar0;
	...
	{
		case 59:
			Global_200000[func_106() /*12745*/].f_1FF2.f_13 = iVar0;
			break;
		
		case 19:
			Global_200000[func_106() /*12745*/].f_1FF2.f_12 = iVar0;
			break;
		
		case 74:
			Global_200000[func_106() /*12745*/].f_1FF2.f_C = iVar0;
			break;
		
		case 29:
			Global_200000[func_106() /*12745*/].f_1FF2.f_E = iVar0;
			break;
		
		case 8:
			Global_200000[func_106() /*12745*/].f_1FF2.f_F = iVar0;
			break;
		
		case 31:
			Global_200000[func_106() /*12745*/].f_1FF2.f_10 = iVar0;
			break;
		
		case 3:
			Global_200000[func_106() /*12745*/].f_1FF2.f_14 = iVar0;
			break;
		
		case 6:
			Global_200000[func_106() /*12745*/].f_1FF2.f_11 = iVar0;
			break;
		...
		case 98:
		case 105:
			Global_200000[func_106() /*12745*/].f_1FF2.f_17 = iVar0;
			break;
		
		case 76:
			Global_200000[func_106() /*12745*/].f_1FF2.f_18 = iVar0;
			break;
		
		case 93:
			Global_200000[func_106() /*12745*/].f_1FF2.f_19 = iVar0;
			break;
		...
		case 77:
		case 81:
			Global_200000[func_106() /*12745*/].f_1FF2.f_1A = iVar0;
			break;
		
		case 65:
		case 75:
		case 95:
			Global_200000[func_106() /*12745*/].f_1FF2.f_1B = iVar0;
			break;
			break;
		
		case 97:
			Global_200000[func_106() /*12745*/].f_1FF2.f_1D = iVar0;
			break;
		
		case 88:
			Global_200000[func_106() /*12745*/].f_1FF2.f_1C = iVar0;
			break;
		
		case 100:
			Global_200000[func_106() /*12745*/].f_1FF2.f_1F = iVar0;
			break;
		
		case 106:
			Global_200000[func_106() /*12745*/].f_1FF2.f_20 = iVar0;
			break;
		
		case 99:
			Global_200000[func_106() /*12745*/].f_1FF2.f_1E = iVar0;
			break;
	}
}

int func_106()//Position - 0x2EDA
{
	int iVar0;
...
int func_108(int iParam0, int iParam1, bool bParam2)//Position - 0x2F40
{
	int iVar0;
...
bool func_109()//Position - 0x3055
{
	return Global_140842;
}

void func_110(int iParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5)//Position - 0x3061
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_90();
...
int func_111(int iParam0)//Position - 0x3080
{
	switch (iParam0)
	{
		case 3:
