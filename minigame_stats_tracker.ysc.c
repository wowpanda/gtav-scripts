	...
	while (true)
	{
		switch (iLocal_45)
		{
			...
			case 2:
				...
				GRAPHICS::_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_46, "SET_MISSION_TITLE_COLOUR", ScriptParam_50.f_2, ScriptParam_50.f_2, ScriptParam_50.f_2, 3212836864, 3212836864);
				...
				GRAPHICS::_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_46, "SET_MEDAL", SYSTEM::TO_FLOAT(ScriptParam_50.f_5), 3212836864, 3212836864, 3212836864, 3212836864);
				GRAPHICS::_CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(iLocal_46, "SET_SOCIAL_CLUB_INFO", 0f, 3212836864, 3212836864, 3212836864, 3212836864);
				iVar0 = 0;
				while (iVar0 < ScriptParam_50.f_42 + 1)
				{
					GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_46, "SET_DATA_SLOT");
					GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(ScriptParam_50.f_9[iVar0 /*7*/]);
					GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(ScriptParam_50.f_9[iVar0 /*7*/].f_1);
					...
					{
						GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(ScriptParam_50.f_9[iVar0 /*7*/].f_2);
						if ((ScriptParam_50.f_9[iVar0 /*7*/].f_3 % 1f) == 0f)
						{
							GRAPHICS::_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(ScriptParam_50.f_9[iVar0 /*7*/].f_3);
						}
						else
						{
						...
						{
							GRAPHICS::_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(ScriptParam_50.f_9[iVar0 /*7*/].f_4);
						}
						else
						{
							GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("NUMBER");
				...
				if (ScriptParam_50.f_5 != 0 && !MISC::IS_STRING_NULL(ScriptParam_50.f_5.f_2))
				{
					...
					GRAPHICS::REMOVE_DECALS_FROM_VEHICLE(ScriptParam_50.f_5);
					...
					{
						GRAPHICS::_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(ScriptParam_50.f_5.f_1);
					}
				...
				func_12(1);
				func_9(&iLocal_47);
				if (!func_8(Global_19E56.f_4A7D, 4096))
				{
					func_6(&(Global_19E56.f_4A7D), 4096);
				}
				iLocal_45 = 3;
				break;
			
			case 3:
				if (((func_2(&iLocal_47) > ScriptParam_50.f_43 && ScriptParam_50.f_43 != -1f) || CAM::IS_SCREEN_FADED_OUT()) || Global_6403)
				{
					func_18();
				}
				else
...
float func_2(int iParam0)//Position - 0x45B
{
	if (func_5(iParam0))
	{
		...
		{
			return (func_3(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}
...
{
	iParam0->f_1 = (func_3(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 4)) - fParam1);
