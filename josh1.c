...
void __EntryFunction__()
{
	...
	if (func_296())
	{
		Global_71835 = 1;
		iLocal_79 = 0;
		while (!func_284(&Local_83))
		{
			WAIT(0);
		}
		func_283(&Local_83, 0, 1);
		Global_71835 = 0;
	}
	if (func_282(PLAYER_PED_ID()))
	{
		uLocal_328 = GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER_PED_ID());
	}
	if (func_281(Local_83.f_28[0]))
	{
		SET_PED_RELATIONSHIP_GROUP_HASH(Local_83.f_28[0], uLocal_328);
	...
	while (true)
	{
		...
		WAIT(0);
		func_265(Local_83.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_144)
		{
			case 0:
				func_257();
	...
	switch (iLocal_145)
	{
		case 0:
			...
			if (HAS_ANIM_DICT_LOADED("rcmjosh1leadinout") && HAS_MODEL_LOADED(joaat("p_amb_phone_01")))
			{
				...
				{
					if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0))
					{
						SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, 0, 0f, 0);
					}
					uLocal_147 = GET_CLOSEST_OBJECT_OF_TYPE(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 1, 0, 1);
				}
				iLocal_145 = 1;
			}
			break;
		...
		case 1:
			if (iLocal_158 == 1)
			{
				...
				if ((GET_GAME_TIMER() - iLocal_159) >= 500)
				{
					func_221(1, 1, 1);
					iLocal_158 = 0;
				}
			...
			if (!iLocal_160)
			{
				if (func_282(Local_83.f_28[0]) && DOES_ENTITY_EXIST(uLocal_147))
				{
					uLocal_149 = CREATE_SYNCHRONIZED_SCENE(vLocal_150, vLocal_153, 2);
					TASK_SYNCHRONIZED_SCENE(Local_83.f_28[0], uLocal_149, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
					PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_147, uLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
			...
			else if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_149))
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_149) > 0.29f)
				{
					if (!iLocal_161)
					{
						func_220(&uLocal_163, 2, PLAYER_PED_ID(), "Trevor", 0, 1);
						func_220(&uLocal_163, 5, Local_83.f_28[0], "Josh", 0, 1);
						if (func_210(&uLocal_163, "JOSH1AU", "JOSH1_OUT", 8, 0, 0, 0))
						{
				...
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1107.107f, 290.4275f, 62.9487f, -1102.038f, 291.3421f, 66.27895f, 2f, 0, 1, 0))
				{
					func_232("Too close, stopping scene");
					if (func_281(Local_83.f_28[0]))
					{
						CLEAR_PED_TASKS(Local_83.f_28[0]);
						func_232("Stopping Josh?");
					}
					if (DOES_ENTITY_EXIST(uLocal_147))
					{
						STOP_SYNCHRONIZED_ENTITY_ANIM(uLocal_147, -8f, 1);
					}
					iLocal_162 = 1;
				}
				if (func_209(Local_83.f_28[0], PLAYER_PED_ID(), 1) > 17.5f)
				{
					if (func_281(Local_83.f_28[0]))
					{
						STOP_SYNCHRONIZED_ENTITY_ANIM(Local_83.f_28[0], -8f, 1);
						CLEAR_PED_TASKS(Local_83.f_28[0]);
					}
					if (DOES_ENTITY_EXIST(uLocal_147))
					{
				...
				if ((IS_PED_INJURED(Local_83.f_28[0]) || IS_ENTITY_ON_FIRE(Local_83.f_28[0])) || IS_EXPLOSION_IN_SPHERE(-1, GET_ENTITY_COORDS(Local_83.f_28[0], 1), 5f))
				{
					if (func_281(Local_83.f_28[0]))
					{
						STOP_SYNCHRONIZED_ENTITY_ANIM(Local_83.f_28[0], -8f, 1);
		...
		case 2:
			func_283(&Local_83, 0, 0);
			if (func_281(Local_83.f_28[0]))
			{
				if (iLocal_162 == 1)
				{
					OPEN_SEQUENCE_TASK(&uLocal_146);
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1115.44f, 317.46f, 65.98f, 1f, 30000, 1048576000, 0, 1193033728);
					TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "enter", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "idle_b", 1090519040, -1056964608, -1, 1, 0, 0, 0, 0);
					CLOSE_SEQUENCE_TASK(uLocal_146);
				}
				else
				{
					OPEN_SEQUENCE_TASK(&uLocal_146);
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1115.44f, 317.46f, 65.98f, 1f, 30000, 0.25f, 1, 1193033728);
					TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "enter", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "idle_b", 1090519040, -1056964608, -1, 1, 0, 0, 0, 0);
					CLOSE_SEQUENCE_TASK(uLocal_146);
				}
				TASK_PERFORM_SEQUENCE(Local_83.f_28[0], uLocal_146);
				CLEAR_SEQUENCE_TASK(&uLocal_146);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_83.f_28[0], 0);
				if (iLocal_162 == 0)
				{
					FORCE_PED_MOTION_STATE(Local_83.f_28[0], -668482597, 0, 0, 1);
				}
			}
			if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0))
			{
			...
			if (iLocal_162 == 0)
			{
				_SET_DOOR_AJAR_ANGLE(904342475, 0f, 1, 1);
...
void func_220(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_224(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_228(PLAYER_ID())) && !func_226(PLAYER_ID(), 0)) && !func_225()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_228(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
...
int func_230(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_233()
{
	...
	if (_0xB56BBBCC2955D9CB())
	{
		...
		if (func_281(Local_83.f_28[0]))
		{
			_0x2A56C06EBEF2B0D9("Josh", Local_83.f_28[0], 0);
		}
	}
	switch (iLocal_145)
	{
		case 0:
			if (func_249(1, 1093140480, 0))
			{
				...
				if (func_281(Local_83.f_28[0]))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(Local_83.f_28[0], "Josh", 0, 0, 0);
				}
				if (func_281(PLAYER_PED_ID()))
				{
					REGISTER_ENTITY_FOR_CUTSCENE(PLAYER_PED_ID(), "Trevor", 0, 0, 0);
				}
				SET_ROADS_IN_ANGLED_AREA(-1140.85f, 263.4714f, 63.35776f, -1205.44f, 412.1574f, 78.2589f, 43.75f, 0, 0, 1);
				CLEAR_AREA_OF_VEHICLES(-1146.306f, 295.9831f, 66.13612f, 9f, 0, 0, 0, 0, 0, 0);
				CLEAR_AREA_OF_VEHICLES(-1143.244f, 280.2762f, 65.41892f, 12f, 0, 0, 0, 0, 0, 0);
				CLEAR_AREA_OF_VEHICLES(-1152.426f, 313.6157f, 67.10429f, 12f, 0, 0, 0, 0, 0, 0);
				CLEAR_AREA_OF_VEHICLES(-1165.966f, 332.6786f, 68.81f, 12f, 0, 0, 0, 0, 0, 0);
				CLEAR_AREA_OF_VEHICLES(-1178.729f, 346.4572f, 70.04675f, 12f, 0, 0, 0, 0, 0, 0);
				CLEAR_ANGLED_AREA_OF_VEHICLES(-1140.85f, 263.4714f, 63.35776f, -1205.44f, 412.1574f, 78.2589f, 43.75f, 0, 0, 0, 0, 0, 0);
				uVar0 = GET_PLAYERS_LAST_VEHICLE();
				if (func_248(uVar0))
				{
					if (IS_ENTITY_IN_ANGLED_AREA(uVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, 0, 1, 0))
					{
				...
				if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0))
				{
					...
					SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, 1, 90f, 0);
				}
				func_238(-1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, vVar1, fVar4, 3f, 6f, 3f, 1, 1, 1, 0, 0);
		...
		case 1:
			...
			if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
			{
				...
				if (!iLocal_160)
				{
					...
					func_234(PLAYER_PED_ID(), -1104.65f, 289.02f, 63.25f, 16.6717f, 0, 1);
					SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					if (func_282(Local_83.f_28[0]) && DOES_ENTITY_EXIST(uLocal_147))
					{
						uLocal_149 = CREATE_SYNCHRONIZED_SCENE(vLocal_150, vLocal_153, 2);
						TASK_SYNCHRONIZED_SCENE(Local_83.f_28[0], uLocal_149, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
						PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_147, uLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
						func_232("Done Josh leadout anim on Josh exit state");
						FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(uLocal_147);
						FORCE_PED_MOTION_STATE(Local_83.f_28[0], -1871534317, 0, 1, 1);
						iLocal_160 = 1;
					}
				}
			}
			...
			if (WAS_CUTSCENE_SKIPPED())
			{
				...
				if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0))
				{
					REMOVE_MODEL_HIDE(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0);
					SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, 1, 0f, 0);
				}
				if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1101.62f, 290.36f, 64.76f, 5f, joaat("prop_lrggate_01c_r"), 0))
				{
					REMOVE_MODEL_HIDE(-1101.62f, 290.36f, 64.76f, 5f, joaat("prop_lrggate_01c_r"), 0);
					SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_r"), -1101.62f, 290.36f, 64.76f, 1, 0f, 0);
				}
			}
			if (!IS_CUTSCENE_ACTIVE())
			{
				...
				if (!iLocal_160)
				{
					...
					{
						uLocal_149 = CREATE_SYNCHRONIZED_SCENE(vLocal_150, vLocal_153, 2);
						TASK_SYNCHRONIZED_SCENE(Local_83.f_28[0], uLocal_149, "rcmjosh1leadinout", "leadout_josh", 8f, -8f, 25, 0, 1000f, 16);
						PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_147, uLocal_149, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
						func_232("Done Josh leadout anim on non active cutscene");
						FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(uLocal_147);
						_0x2208438012482A1A(Local_83.f_28[0], 0, 0);
						iLocal_160 = 1;
					}
				}
				iLocal_145 = 2;
...
int func_234(var uParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
void func_235(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	var uVar0;
	...
	if (IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_236(GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_238(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	func_239(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_239(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, var uParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	var uVar0;
	bool bVar1;
	bool bVar2;
	...
	if (DOES_ENTITY_EXIST(uVar0))
	{
		...
		if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_243(uVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_243(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	{
		vParam1.z = vParam4.z;
		vVar0 = { func_245(vParam1 - vParam4) };
		vVar3 = { vVar0 };
		vVar0.x = -vVar3.y;
		vVar0.y = vVar3.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_244(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_244(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_244(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_244(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_244(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_244(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_244(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_244(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_244(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_244(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_244(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_244(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_244(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_244(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_244(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_244(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return 1;
		}
	}
...
int func_249(int iParam0, float fParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_255(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_255(var uParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
void func_257()
{
	...
	{
		case 0:
			if (!func_5(0) && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, 1, 0))
			{
				...
				if (HAS_ANIM_DICT_LOADED("rcmjosh1leadinout"))
				{
					...
					uLocal_147 = GET_CLOSEST_OBJECT_OF_TYPE(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 1, 0, 1);
					func_237(1);
					_REQUEST_CUTSCENE_EX("JOSH_1_INT_CONCAT", 14, 8);
					iLocal_145 = 1;
				}
			}
			else
		...
		case 1:
			if (!func_5(0))
			{
				if (!bLocal_156)
				{
					if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, 1, 0))
					{
						if (func_282(Local_83.f_28[0]) && DOES_ENTITY_EXIST(uLocal_147))
						{
							uLocal_148 = CREATE_SYNCHRONIZED_SCENE(vLocal_150, vLocal_153, 2);
							TASK_SYNCHRONIZED_SCENE(Local_83.f_28[0], uLocal_148, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1148846080, 0);
							PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_147, uLocal_148, "leadin_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
							TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), Local_83.f_28[0], -1, 0, 2);
							TASK_LOOK_AT_ENTITY(Local_83.f_28[0], PLAYER_PED_ID(), 4000, 2060, 2);
					...
					else
					{
						if (!func_5(0) && !bLocal_156)
						{
							...
							REMOVE_CUTSCENE();
							_REQUEST_CUTSCENE_EX("JOSH_1_INT_CONCAT", 13, 8);
						}
						func_232("Replay in progress, skipping leadin");
						iLocal_145 = 2;
					}
				}
				else if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_148))
				{
					if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_148) > 0.15f)
					{
						if (!iLocal_157)
						{
							if (func_210(&uLocal_163, "JOSH1AU", "JOSH1_LEADIN", 8, 0, 0, 0))
							{
					...
					if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_148) > 0.9f)
					{
						func_232("Leadin anim done, launch cutscene");
						iLocal_145 = 2;
					}
					if (func_209(PLAYER_PED_ID(), Local_83.f_28[0], 1) <= 2.5f)
					{
...
void func_259()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if (func_255(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_265(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71844 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_267(Global_71845, Global_71847, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_278(0) || Global_71859) || Global_71848 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_263(0)) || func_277(1))
			{
			}
			else
			{
...
void func_286(var uParam0, bool bParam1)
{
	...
	func_287(uParam0, iLocal_81, vVar0, fVar3);
...
int func_289(var uParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_290(uParam0, iParam1, vParam2, fParam5, 1))
	{
		if (DOES_ENTITY_EXIST(*uParam0))
		{
			if (!IS_ENTITY_DEAD(*uParam0, 0))
...
int func_290(var uParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	int iVar0;
...
void func_297()
{
	...
	func_309(&(Local_83.f_28[0]), 1, 1, 1);
	func_298(&Local_83, 1, 0, 0);
	SET_PED_PATHS_IN_AREA(-1112.67f, 287.38f, 62.85f, -1096.41f, 297.5f, 65.59f, 1, 0);
...
void func_311(bool bParam0)
{
	...
	if (!func_328())
	{
		...
		{
			func_159(iVar0, 1, 0);
			func_312(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_105652[iVar0 /*10*/].f_9 == -1)
...
int func_313(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_319())
	{
		...
		{
			iVar33 = func_314(GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
