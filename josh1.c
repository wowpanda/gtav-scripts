...
void func_1()
{
	switch (iLocal_83)
	{
		...
		case 1:
			...
			if (!iLocal_94)
			{
				if (func_281(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
				{
					iLocal_87 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_88, vLocal_89, 2);
					BRAIN::TASK_SYNCHRONIZED_SCENE(Local_81.f_28[0], iLocal_87, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
			...
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_87))
			{
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.107f, 290.4275f, 62.9487f, -1102.038f, 291.3421f, 66.27895f, 2f, 0, true, 0))
				{
					...
					if (func_280(Local_81.f_28[0]))
					{
						BRAIN::CLEAR_PED_TASKS(Local_81.f_28[0]);
		...
		case 2:
			...
			if (func_280(Local_81.f_28[0]))
			{
				if (iLocal_96 == 1)
				{
					...
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1115.44f, 317.46f, 65.98f, 1f, 30000, 0.25f, 0, 1193033728);
					BRAIN::TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "enter", 8f, -8f, -1, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "idle_b", 8f, -8f, -1, 1, 0, 0, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_84);
				}
				else
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_84);
				...
				BRAIN::TASK_PERFORM_SEQUENCE(Local_81.f_28[0], iLocal_84);
...
void func_223(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (iParam1 == 1)
	{
		...
		{
			if (func_280(PLAYER::PLAYER_PED_ID()))
			{
		...
		case 1:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
			{
				...
				if (!iLocal_94)
				{
					...
					{
						iLocal_87 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_88, vLocal_89, 2);
						BRAIN::TASK_SYNCHRONIZED_SCENE(Local_81.f_28[0], iLocal_87, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, iLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
			...
			if (!CUTSCENE::IS_CUTSCENE_ACTIVE())
			{
				...
				if (!iLocal_94)
				{
					...
					{
						iLocal_87 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_88, vLocal_89, 2);
						BRAIN::TASK_SYNCHRONIZED_SCENE(Local_81.f_28[0], iLocal_87, "rcmjosh1leadinout", "leadout_josh", 8f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, iLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
				...
				if (!bLocal_90)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1115.071f, 279.6581f, 62.42184f, -1092.428f, 284.1398f, 67.31652f, 15.75f, 0, true, 0))
					{
						if (func_281(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85))
						{
							...
							BRAIN::TASK_SYNCHRONIZED_SCENE(Local_81.f_28[0], iLocal_86, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1148846080, 0);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, iLocal_86, "leadin_gate", "rcmjosh1leadinout", 8f, 8f, 0, 1148846080);
							BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], -1, 0, 2);
							BRAIN::TASK_LOOK_AT_ENTITY(Local_81.f_28[0], PLAYER::PLAYER_PED_ID(), 4000, 2060, 2);
	...
	if (Global_71232 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_266(Global_71233, Global_71235, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
float func_265(void fParam0)
{
	HUD::_BEGIN_TEXT_COMMAND_WIDTH(fParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_266(int iParam0, int iParam1, int iParam2)
{
	struct<2> Var0;
	int iVar1;
...
{
	if (((!func_277(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_263(0)) || func_276(1))
			{
			}
			else
			{
...
{
	return func_279(iParam0, Global_35905);
}
...
int func_288(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
...
int func_289(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_310(bool bParam0)
{
	...
	if (!func_327())
	{
		...
		{
			func_159(iVar0, 1, 0);
			func_311(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_104307[iVar0 /*10*/].f_9 == -1)
...
void func_311(void fParam0, int iParam1)
{
	if (Global_92955 != 12)
	{
		if (func_312(fParam0, 6, iParam1))
		{
...
int func_314()
{
	...
	iVar0 = func_315(&(Global_92955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_315(void fParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
