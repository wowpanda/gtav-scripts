...
void __EntryFunction__()
{
	...
	if (HAS_FORCE_CLEANUP_OCCURRED(67))
	{
		if (!func_295())
		{
			...
			func_265(GET_THIS_SCRIPT_NAME());
		}
		func_261();
	}
	if (DOES_ENTITY_EXIST(ScriptParam_0) && DOES_ENTITY_EXIST(ScriptParam_0.f_1))
	{
		if (!IS_ENTITY_DEAD(ScriptParam_0, 0) && !IS_ENTITY_DEAD(ScriptParam_0.f_1, 0))
		{
			SET_ENTITY_AS_MISSION_ENTITY(ScriptParam_0, 1, 1);
			SET_ENTITY_AS_MISSION_ENTITY(ScriptParam_0.f_1, 1, 1);
		}
	}
	...
	if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
	{
		if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			{
				if (GET_ENTITY_MODEL(uVar1) == joaat("towtruck") || GET_ENTITY_MODEL(uVar1) == joaat("towtruck2"))
				{
					uLocal_3109 = uVar1;
				}
			}
	...
	if (DOES_ENTITY_EXIST(uLocal_3109))
	{
		if (!IS_ENTITY_DEAD(uLocal_3109, 0))
		{
			SET_ENTITY_AS_MISSION_ENTITY(uLocal_3109, 1, 1);
			ADD_VEHICLE_UPSIDEDOWN_CHECK(uLocal_3109);
			_0x192547247864DFDD(uLocal_3109, 0);
			SET_VEHICLE_HAS_STRONG_AXLES(uLocal_3109, 1);
		}
	}
	uLocal_3112 = ADD_SCENARIO_BLOCKING_AREA(Vector(27.5001f, -640.002f, 414.1398f) - Vector(50f, 50f, 50f), Vector(27.5001f, -640.002f, 414.1398f) + Vector(50f, 50f, 50f), 0, 1, 1, 1);
	uLocal_3113 = ADD_SCENARIO_BLOCKING_AREA(Vector(21.8557f, -1172f, -229.8159f) - Vector(50f, 50f, 50f), Vector(21.8557f, -1172f, -229.8159f) + Vector(50f, 50f, 50f), 0, 1, 1, 1);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_3060 - Vector(15f, 15f, 15f), vLocal_3060 + Vector(15f, 15f, 15f), 0, 1);
	REMOVE_VEHICLES_FROM_GENERATORS_IN_AREA(vLocal_3060 - Vector(15f, 15f, 15f), vLocal_3060 + Vector(15f, 15f, 15f), 0);
	func_224();
	while (true)
	{
		WAIT(0);
		...
		if (bLocal_2945 && !IS_PED_IN_ANY_TAXI(PLAYER_PED_ID()))
		{
			if (IS_SCREEN_FADED_OUT())
			{
				NEW_LOAD_SCENE_START(408.8376f, -1638.952f, 28.2928f, -3.24f, 0f, -62.6001f, 20f, 0);
				...
				CLEAR_AREA_OF_VEHICLES(408.8376f, -1638.952f, 28.2928f, 8f, 0, 0, 0, 0, 0, 0);
				DO_SCREEN_FADE_IN(500);
			}
		}
		if (iLocal_3115 < 15)
		{
			func_217(&uLocal_3109, &uLocal_2985, &Local_2996, &vLocal_2625, &cLocal_3068, &iLocal_3052, iLocal_3047, bLocal_2958, &iLocal_2967, iLocal_2949, bLocal_2939, bLocal_461, iLocal_3115, 1);
		}
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			switch (iLocal_2992)
			{
				case 0:
					...
					{
						if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_3109, 0))
						{
						}
						if (iLocal_420 != 2 && iLocal_420 != 4)
						{
							if (!func_214(&uLocal_3122, Local_2996[0 /*20*/].f_6, uLocal_3109, &uLocal_3042, &uLocal_3043, bLocal_2945))
							{
								iLocal_3084 = 15;
								func_261();
							}
						...
						{
							func_213(&uLocal_3123, uLocal_3109, &uLocal_3045, &uLocal_3046, bLocal_2945);
						}
					}
					if (bLocal_2959)
					{
						if (iLocal_3115 >= 7)
						{
							func_208(uLocal_3109, Local_2996[0 /*20*/].f_6, Local_3017, &(Local_2996[0 /*20*/].f_8), &vLocal_2625, &cLocal_3068, &vLocal_437, bLocal_2959, &(Local_2996[0 /*20*/]));
						}
					}
					bLocal_2948 = false;
					...
					else if (iLocal_420 == 3)
					{
						...
						{
							if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
							{
								if (IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), Local_2996[0 /*20*/].f_6))
								{
									iLocal_2930 = 1;
									CLEAR_PED_TASKS(Local_2996[0 /*20*/]);
									TASK_TURN_PED_TO_FACE_ENTITY(Local_2996[0 /*20*/], PLAYER_PED_ID(), 0);
								}
							}
						}
					}
					...
					{
						func_179(&(Local_1870[func_250() /*28*/]), &(Local_1870[func_250() /*28*/].f_10), Local_650[iLocal_2604 /*23*/].f_1, &(Local_2996[0 /*20*/]), &(Local_2996[0 /*20*/].f_2), &uLocal_2989, fLocal_3066, cLocal_2619, &sLocal_2620, iLocal_3051);
					}
					if (iLocal_420 == 4)
					{
						func_177(&uLocal_3116, uLocal_3110, uLocal_3111, uLocal_3109, &(Local_2996[0 /*20*/].f_2), iLocal_3051, cLocal_2619, &sLocal_2620, &iLocal_2984, bLocal_2945, &(Local_2996[0 /*20*/].f_6));
					}
					if (!bLocal_2945)
					{
						if (DOES_ENTITY_EXIST(iLocal_2984) && !IS_ENTITY_DEAD(iLocal_2984, 0))
						{
							if (func_169(iLocal_2984, 0, &uLocal_412, &iLocal_419, 0, 1, 0, 1, 0))
							{
								bLocal_2942 = true;
								TASK_SMART_FLEE_PED(iLocal_2984, PLAYER_PED_ID(), 1000f, -1, 0, 0);
							}
							if (func_167())
							{
								bLocal_2943 = true;
					...
					if (bLocal_442 && !bLocal_2964)
					{
						...
						{
							func_166();
							if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
							{
								CLEAR_PED_TASKS(Local_2996[0 /*20*/]);
								SET_PED_KEEP_TASK(Local_2996[0 /*20*/], 1);
								TASK_SMART_FLEE_PED(Local_2996[0 /*20*/], PLAYER_PED_ID(), 1000f, -1, 0, 0);
								iLocal_3084 = 18;
							}
							if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_1, 0))
							{
								CLEAR_PED_TASKS(Local_2996[0 /*20*/].f_1);
								SET_PED_KEEP_TASK(Local_2996[0 /*20*/].f_1, 1);
								CLEAR_SEQUENCE_TASK(&uLocal_421);
								OPEN_SEQUENCE_TASK(&uLocal_421);
								TASK_LEAVE_ANY_VEHICLE(0, 1, 256);
								TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 1000f, -1, 0, 0);
								CLOSE_SEQUENCE_TASK(uLocal_421);
								if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_1, 0))
								{
									TASK_PERFORM_SEQUENCE(Local_2996[0 /*20*/].f_1, uLocal_421);
								}
								CLEAR_SEQUENCE_TASK(&uLocal_421);
								iLocal_3084 = 18;
							}
						...
						if (func_169(Local_2996[0 /*20*/].f_1, Local_2996[0 /*20*/].f_6, &uLocal_412, &iLocal_419, 0, 1, 0, 1, 0))
						{
							...
							if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_1, 0))
							{
								CLEAR_PED_TASKS(Local_2996[0 /*20*/].f_1);
								SET_PED_KEEP_TASK(Local_2996[0 /*20*/].f_1, 1);
								TASK_SMART_FLEE_PED(Local_2996[0 /*20*/].f_1, PLAYER_PED_ID(), 1000f, -1, 0, 0);
								iLocal_3084 = 18;
							}
						}
					}
					...
					{
						if ((!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_ENTITY_DEAD(uLocal_3109, 0)) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_3109, 0))
						{
							if (!iLocal_468)
							{
								if (DOES_ENTITY_EXIST(Local_2996[0 /*20*/].f_6))
								{
									if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
									{
										func_140(&uLocal_399, GET_ENTITY_COORDS(Local_2996[0 /*20*/].f_6, 1), 0, 0, 1, 1, 1);
									}
								}
							}
							else
...
int func_1(vector3 vParam0, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8)
{
	...
	if (DOES_ENTITY_EXIST(Local_2996[0 /*20*/].f_6))
	{
		if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
		{
			if (IS_VEHICLE_STUCK_TIMER_UP(Local_2996[0 /*20*/].f_6, 0, 7000))
			{
				iLocal_3084 = 15;
				return 1;
			}
	...
	if (bLocal_467)
	{
		if ((GET_GAME_TIMER() - iLocal_3052) > 50000)
		{
			if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
			{
				vVar0 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
			}
			if (DOES_ENTITY_EXIST(uLocal_3109) && !IS_ENTITY_DEAD(uLocal_3109, 0))
			{
				vVar3 = { GET_ENTITY_COORDS(uLocal_3109, 1) };
			}
	...
	if (DOES_ENTITY_EXIST(uLocal_3109))
	{
		if (!IS_VEHICLE_DRIVEABLE(uLocal_3109, 0))
		{
			iLocal_3084 = 2;
			return 1;
		}
			...
			switch (iLocal_420)
			{
				...
				case 0:
					if (bLocal_442)
					{
						if (!bLocal_2964)
						{
							if (DOES_ENTITY_EXIST(Local_2996[0 /*20*/]))
							{
								if (IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
								{
									iLocal_3084 = 8;
						...
						if (bLocal_2965)
						{
							if (DOES_ENTITY_EXIST(Local_2996[0 /*20*/].f_1))
							{
								if (IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_1, 0))
								{
									iLocal_3084 = 9;
	...
	if (!DOES_VEHICLE_HAVE_STUCK_VEHICLE_CHECK(uLocal_3109))
	{
		ADD_VEHICLE_UPSIDEDOWN_CHECK(uLocal_3109);
	}
	else if (IS_VEHICLE_STUCK_ON_ROOF(uLocal_3109))
	{
		iLocal_3084 = 4;
		return 1;
	}
...
{
	return func_10(GET_PLAYER_PED(GET_PLAYER_INDEX()), vParam0, iParam3);
}
...
void func_13(struct<165> Param0, var uParam165, var uParam166)
{
	...
	switch (iLocal_2605)
	{
		...
		case 1:
			if ((TIMERA() > 3000 && iLocal_468) && !func_37("TOWT_OBJ_04", 0, 0))
			{
				if (!func_41())
				{
					func_251(&Param0, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya3")) == 1 || _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya4")) == 1)
					{
						if (iLocal_420 == 1)
						{
					...
					else if (iLocal_420 == 1)
					{
						...
						{
							func_251(&Param0, 5, (*uParam165)[0 /*20*/], "TOWTRAINF", 0, 1);
							func_165(&Param0, "TOWAUD", "TOW_MECH", 7, 0, 0, 0);
							sLocal_483 = "TOW_MECH";
						}
						else if (Global_106565.f_19967.f_5 == 2)
						{
							func_251(&Param0, 6, (*uParam165)[0 /*20*/], "TOWILLEGALMAN2", 0, 1);
...
void func_22()
{
	...
	if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
	{
		if (func_25(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
...
int func_31(var uParam0)
{
	...
	{
		case 1:
			if (GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) == 0 && !IS_PED_SHOOTING(PLAYER_PED_ID()))
			{
				iLocal_465 = 0;
				return 1;
			}
		...
		case 6:
			if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_ENTITY_DEAD(*uParam0, 0))
			{
...
void func_32(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, var uParam66, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, var uParam85, var uParam86, var uParam87, var uParam88, var uParam89, var uParam90, var uParam91, var uParam92, var uParam93, var uParam94, var uParam95, var uParam96, var uParam97, var uParam98, var uParam99, var uParam100, var uParam101, var uParam102, var uParam103, var uParam104, var uParam105, var uParam106, var uParam107, var uParam108, var uParam109, var uParam110, var uParam111, var uParam112, var uParam113, var uParam114, var uParam115, var uParam116, var uParam117, var uParam118, var uParam119, var uParam120, var uParam121, var uParam122, var uParam123, var uParam124, var uParam125, var uParam126, var uParam127, var uParam128, var uParam129, var uParam130, var uParam131, var uParam132, var uParam133, var uParam134, var uParam135, var uParam136, var uParam137, var uParam138, var uParam139, var uParam140, var uParam141, var uParam142, var uParam143, var uParam144, var uParam145, var uParam146, var uParam147, var uParam148, var uParam149, var uParam150, var uParam151, var uParam152, var uParam153, var uParam154, var uParam155, var uParam156, var uParam157, var uParam158, var uParam159, var uParam160, var uParam161, var uParam162, var uParam163, var uParam164, var uParam165)
{
	...
	{
		case 1:
			if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("towing")) == 0)
			{
				if (iLocal_420 == 1)
				{
					if (!iLocal_465)
			...
			else if (iLocal_420 == 1)
			{
				if (Global_106565.f_19967.f_5 == 0 || Global_106565.f_19967.f_5 == 1)
				{
					func_251(&Local_2348, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
void func_35(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, var uParam66, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, var uParam85, var uParam86, var uParam87, var uParam88, var uParam89, var uParam90, var uParam91, var uParam92, var uParam93, var uParam94, var uParam95, var uParam96, var uParam97, var uParam98, var uParam99, var uParam100, var uParam101, var uParam102, var uParam103, var uParam104, var uParam105, var uParam106, var uParam107, var uParam108, var uParam109, var uParam110, var uParam111, var uParam112, var uParam113, var uParam114, var uParam115, var uParam116, var uParam117, var uParam118, var uParam119, var uParam120, var uParam121, var uParam122, var uParam123, var uParam124, var uParam125, var uParam126, var uParam127, var uParam128, var uParam129, var uParam130, var uParam131, var uParam132, var uParam133, var uParam134, var uParam135, var uParam136, var uParam137, var uParam138, var uParam139, var uParam140, var uParam141, var uParam142, var uParam143, var uParam144, var uParam145, var uParam146, var uParam147, var uParam148, var uParam149, var uParam150, var uParam151, var uParam152, var uParam153, var uParam154, var uParam155, var uParam156, var uParam157, var uParam158, var uParam159, var uParam160, var uParam161, var uParam162, var uParam163, var uParam164, var uParam165)
{
	...
	iVar0 = (GET_RANDOM_INT_IN_RANGE(0, 65535) % 4);
	if (iVar0 == 0)
	{
...
int func_42(var uParam0, var uParam1)
{
	...
	if ((DOES_ENTITY_EXIST((uParam0[0 /*20*/])->f_6) && !IS_ENTITY_DEAD((uParam0[0 /*20*/])->f_6, 0)) && !IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
	{
		if (!bLocal_427)
		{
			if ((HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY((uParam0[0 /*20*/])->f_6, PLAYER_PED_ID(), 1) || HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT((uParam0[0 /*20*/])->f_6)) || HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED((uParam0[0 /*20*/])->f_6))
			{
				iLocal_2606 = 2;
				return 1;
			}
	...
	if ((DOES_ENTITY_EXIST((*uParam0)[0 /*20*/]) && !IS_ENTITY_DEAD((*uParam0)[0 /*20*/], 0)) && !IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
	{
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(PLAYER_PED_ID(), (*uParam0)[0 /*20*/], 1))
		{
			iLocal_2606 = 4;
			return 1;
		}
	}
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_ENTITY_DEAD(*uParam1, 0))
	{
		if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), *uParam1, 0))
		{
			iLocal_2606 = 6;
			return 1;
		}
...
int func_49()
{
	...
	switch (iLocal_3115)
	{
		...
		case 4:
			switch (iLocal_420)
			{
				case 3:
					if (func_125("TOWT_OBJ_01", "TOWT_HELP_01", &uVar0, 1, 0))
					{
						if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
						{
							SET_VEHICLE_DOORS_LOCKED(Local_2996[0 /*20*/].f_6, 10);
						}
						func_123();
						func_257(&uLocal_3100);
						iLocal_3115 = 6;
					}
					break;
				...
				case 2:
					if (func_125("TOWT_OBJ_AB", "TOWT_HELP_AB", &uVar0, 0, 0))
					{
						...
						SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_2632, vLocal_2635, 0, 1);
						iLocal_2963 = 1;
						SET_VEHICLE_UNDRIVEABLE(Local_2996[0 /*20*/].f_6, 1);
						func_257(&uLocal_3100);
						iLocal_3115 = 6;
					}
					break;
			...
			if (!DOES_BLIP_EXIST(Local_2996[0 /*20*/].f_8))
			{
				if (DOES_ENTITY_EXIST(Local_2996[0 /*20*/].f_6))
				{
					Local_2996[0 /*20*/].f_8 = ADD_BLIP_FOR_ENTITY(Local_2996[0 /*20*/].f_6);
					SET_BLIP_COLOUR(Local_2996[0 /*20*/].f_8, 3);
					SET_BLIP_ROUTE(Local_2996[0 /*20*/].f_8, 1);
				}
			}
			break;
		...
		case 7:
			...
			if (iLocal_420 == 1 && !IS_PED_IN_VEHICLE(Local_2996[0 /*20*/], uLocal_3109, 0))
			{
				bLocal_2957 = true;
			}
			func_106();
			if (func_99(sVar2, vLocal_2629))
			{
				if (iLocal_420 == 1 && !IS_PED_IN_VEHICLE(Local_2996[0 /*20*/], uLocal_3109, 0))
				{
					...
					if (DOES_ENTITY_EXIST(Local_2996[0 /*20*/]))
					{
						Local_2996[0 /*20*/].f_9 = ADD_BLIP_FOR_ENTITY(Local_2996[0 /*20*/]);
						SET_BLIP_COLOUR(Local_2996[0 /*20*/].f_9, 3);
						SET_BLIP_SCALE(Local_2996[0 /*20*/].f_9, 0.7f);
					}
					iLocal_3115 = 5;
				}
				else
		...
		case 9:
			...
			{
				func_139(&uLocal_399, 0, 0);
				SET_VEHICLE_AUTOMATICALLY_ATTACHES(Local_2996[0 /*20*/].f_6, 0, 0);
				if (iLocal_3038 == 0)
				{
					iLocal_2941 = 0;
					iLocal_3115 = 15;
		...
		case 15:
			...
			if (bLocal_2939)
			{
				if (DOES_BLIP_EXIST(uLocal_2985))
				{
					REMOVE_BLIP(&uLocal_2985);
				}
			}
			CLEAR_HELP(1);
			...
			if (iLocal_470 != 0 && !bLocal_2935)
			{
				if (bLocal_2945)
				{
					if ((GET_GAME_TIMER() - iLocal_470) < 12000)
					{
			...
			uVar1 = ROUND(fLocal_3067);
			PLAYSTATS_ODDJOB_DONE(uVar1, 14, 0);
			if (iLocal_420 != 2)
			{
			}
			if (bLocal_2945)
			...
			func_94(&uLocal_2608, "TOW_UI07", 500, ROUND(fLocal_428), ROUND(fLocal_429), "TOW_UI08", 4000, 1);
			if (iLocal_472 > 0)
			{
...
void func_56(int iParam0, int iParam1)
{
	...
	STAT_GET_INT(func_57(iParam0, 1), &iVar0, -1);
	iVar0 = (iVar0 + iParam1);
	STAT_SET_INT(func_57(iParam0, 1), iVar0, 1);
}
...
void func_62(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_64() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_64() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_63(iParam0));
...
int func_70(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_64() /*10778*/].f_6165.f_10, iParam0);
}
...
int func_71(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2539502[iParam0 /*3*/][func_66(iParam1)];
...
void func_94(var uParam0, char* sParam1, int iParam2, var uParam3, var uParam4, char* sParam5, int iParam6, int iParam7)
{
	BEGIN_SCALEFORM_MOVIE_METHOD(*uParam0, "SHOW_SHARD_MIDSIZED_MESSAGE");
	BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
	_SET_NOTIFICATION_COLOR_NEXT(iParam7);
...
int func_96(char* sParam0)
{
	...
	if (Local_2996[iLocal_3037 /*20*/].f_15)
	{
		...
		{
			EXPLODE_VEHICLE(Local_2996[iLocal_3037 /*20*/].f_6, 1, 0);
		}
	}
	if (func_97(&uVar0, &uVar3, &uVar6))
	{
		if (!IS_ENTITY_DEAD(Local_2996[iLocal_3037 /*20*/], 0) && IS_PED_IN_VEHICLE(Local_2996[iLocal_3037 /*20*/], uLocal_3109, 0))
		{
			_SET_VEHICLE_HALT(uLocal_3109, 6f, 2, 0);
			iLocal_466 = 1;
			if (DOES_ENTITY_EXIST(Local_2996[iLocal_3037 /*20*/]) && !IS_ENTITY_DEAD(Local_2996[iLocal_3037 /*20*/], 0))
			{
				OPEN_SEQUENCE_TASK(&uLocal_421);
				TASK_CLEAR_LOOK_AT(0);
				TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
				TASK_GOTO_ENTITY_OFFSET(0, Local_2996[0 /*20*/].f_6, 20000, 2f, 0f, 1f, 0);
				iVar7 = (GET_RANDOM_INT_IN_RANGE(0, 65535) % 3);
				if (iVar7 == 0)
				{
				...
				{
					TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_STAND_IMPATIENT", 0, 1);
				}
				else
				{
					TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
				...
				CLOSE_SEQUENCE_TASK(uLocal_421);
				TASK_PERFORM_SEQUENCE(Local_2996[iLocal_3037 /*20*/], uLocal_421);
				CLEAR_SEQUENCE_TASK(&uLocal_421);
				SET_PED_KEEP_TASK(Local_2996[iLocal_3037 /*20*/], 1);
			}
			if ((Global_106565.f_19967.f_3 == 0 || Global_106565.f_19967.f_3 == 1) || Global_106565.f_19967.f_3 == 4)
			{
				if (DOES_ENTITY_EXIST(iLocal_2984) && !IS_ENTITY_DEAD(iLocal_2984, 0))
				{
					OPEN_SEQUENCE_TASK(&uLocal_421);
					TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
					TASK_WANDER_STANDARD(0, 227.082f, 0);
					CLOSE_SEQUENCE_TASK(uLocal_421);
					if (!IS_ENTITY_DEAD(iLocal_2984, 0))
					{
						TASK_PERFORM_SEQUENCE(iLocal_2984, uLocal_421);
						SET_PED_KEEP_TASK(iLocal_2984, 1);
					}
					CLEAR_SEQUENCE_TASK(&uLocal_421);
				}
			}
		...
		iLocal_468 = 0;
		REMOVE_BLIP(&(Local_2996[iLocal_3037 /*20*/].f_8));
		func_53(&uLocal_3088);
		iLocal_3038 = (iLocal_3038 - 1);
		return 1;
	}
	if (!IS_ENTITY_DEAD(uLocal_3109, 0) && !IS_ENTITY_DEAD(Local_2996[iLocal_3037 /*20*/].f_6, 0))
	{
		if (!IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[iLocal_3037 /*20*/].f_6))
		{
			iLocal_468 = 0;
			func_139(&uLocal_399, 0, 0);
			SET_BLIP_ROUTE(Local_2996[iLocal_3037 /*20*/].f_8, 0);
			REMOVE_BLIP(&(Local_2996[iLocal_3037 /*20*/].f_8));
			if (DOES_ENTITY_EXIST(Local_2996[iLocal_3037 /*20*/].f_6) && !IS_ENTITY_DEAD(Local_2996[iLocal_3037 /*20*/].f_6, 0))
			{
				if (!DOES_BLIP_EXIST(Local_2996[iLocal_3037 /*20*/].f_8))
				{
					Local_2996[iLocal_3037 /*20*/].f_8 = ADD_BLIP_FOR_ENTITY(Local_2996[iLocal_3037 /*20*/].f_6);
					SET_BLIP_COLOUR(Local_2996[iLocal_3037 /*20*/].f_8, 3);
				}
			}
			if (iLocal_420 == 1)
			{
...
int func_97(var uParam0, var uParam1, var uParam2)
{
	if (iLocal_3037 != -1)
	{
		...
		if (!bLocal_2959)
		{
			if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
			{
				if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_2629, 30f, 30f, 2f, 1, 1, 0))
				{
					if (iLocal_420 == 0 || iLocal_420 == 4)
					{
						if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
						{
							SET_VEHICLE_DOORS_LOCKED(Local_2996[0 /*20*/].f_6, 1);
							bLocal_2939 = true;
						}
					}
				}
		...
		if (DOES_ENTITY_EXIST(Local_2996[iLocal_3037 /*20*/].f_6))
		{
			if (IS_ENTITY_IN_ANGLED_AREA(Local_2996[iLocal_3037 /*20*/].f_6, *uParam0, *uParam1, *uParam2, 0, 0, 0))
			{
				if (iLocal_2941)
				{
				...
				if (!IS_ENTITY_DEAD(uLocal_3109, 0) && !IS_ENTITY_DEAD(Local_2996[iLocal_3037 /*20*/].f_6, 0))
				{
					if (!IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[iLocal_3037 /*20*/].f_6) || (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_2996[iLocal_3037 /*20*/].f_6, 0) && !IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[iLocal_3037 /*20*/].f_6)))
					{
						if (func_41())
						{
							func_166();
...
int func_99(char* sParam0, vector3 vParam1)
{
	...
	if (!bLocal_2945 && !bLocal_2956)
	{
		if (DOES_ENTITY_EXIST(uLocal_3109) && !IS_ENTITY_DEAD(uLocal_3109, 0))
		{
			uVar2 = GET_ENTITY_ATTACHED_TO_TOW_TRUCK(uLocal_3109);
			if (DOES_ENTITY_EXIST(uVar2) && !IS_ENTITY_DEAD(uVar2, 0))
			{
				if (IS_ENTITY_A_VEHICLE(uVar2))
				{
					if (GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(uVar2) != Local_2996[0 /*20*/].f_6)
					{
						if (!iLocal_2972)
						{
	...
	while (iVar1 < 1)
	{
		if (DOES_ENTITY_EXIST(Local_2996[iVar1 /*20*/].f_6))
		{
			if (!IS_ENTITY_DEAD(uLocal_3109, 0) && !IS_ENTITY_DEAD(Local_2996[iVar1 /*20*/].f_6, 0))
			{
				if (IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[iVar1 /*20*/].f_6) && func_105())
				{
					SET_VEHICLE_SIREN(uLocal_3109, 1);
					func_102();
					func_139(&uLocal_399, 0, 0);
					iLocal_468 = 1;
					if (iLocal_2961 && !IS_PED_IN_VEHICLE(Local_2996[iVar1 /*20*/], uLocal_3109, 0))
					{
						bVar0 = false;
						if (iLocal_3120 < 4)
						{
					...
					if (bVar0)
					{
						func_101(&uLocal_3094);
						SET_BLIP_ROUTE(Local_2996[iVar1 /*20*/].f_8, 0);
						iLocal_2967 = 0;
						func_100(Local_2996[iVar1 /*20*/].f_8);
						Local_2996[iVar1 /*20*/].f_14 = func_4(&(Local_2996[iVar1 /*20*/].f_11));
						if (iLocal_2992 == 0)
						{
							Local_2996[iVar1 /*20*/].f_8 = ADD_BLIP_FOR_COORD(vParam1);
							fLocal_430 = func_9(vParam1, 0);
							vLocal_2625[0 /*3*/] = { vParam1 };
						}
						if (iLocal_420 == 4)
						{
							SET_VEHICLE_DOOR_SHUT(Local_2996[0 /*20*/].f_6, 0, 0);
						}
						func_53(&uLocal_3100);
						SET_BLIP_COLOUR(Local_2996[iVar1 /*20*/].f_8, 5);
						SET_BLIP_ROUTE(Local_2996[iVar1 /*20*/].f_8, 1);
						...
						StringCopy(&cLocal_3068, sParam0, 64);
						CLEAR_AREA_OF_VEHICLES(vLocal_2625[0 /*3*/], 6f, 0, 0, 0, 0, 0, 0);
						iLocal_3037 = iVar1;
						return 1;
					}
				}
...
void func_106()
{
	...
	if (((!IS_ENTITY_DEAD(uLocal_3109, 0) && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0)) && IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[0 /*20*/].f_6)) || (Global_106565.f_19967.f_3 == 0 || Global_106565.f_19967.f_3 > 2))
	{
		return;
	}
	switch (iLocal_3050)
	{
		...
		case 1:
			if (func_7(&uLocal_3106))
			{
				...
				{
					if (!IS_HELP_MESSAGE_ON_SCREEN() && !func_41())
					{
...
int func_109(int iParam0, int iParam1, char* sParam2)
{
	...
	switch (*iParam0)
	{
		case 0:
			if (!bLocal_2958)
			{
				if ((func_116(Local_2996[iParam1 /*20*/].f_6, uLocal_3109, &iLocal_2603, 10, 150f, 4f, 1) || iLocal_2953) || iLocal_468)
				{
					if (!bLocal_2936)
					{
						iLocal_2603 = 0;
						func_115(&iLocal_2598);
						if (GET_SCRIPT_TASK_STATUS(Local_2996[iParam1 /*20*/], -875674219) != 1)
						{
							TASK_TURN_PED_TO_FACE_ENTITY(Local_2996[iParam1 /*20*/], PLAYER_PED_ID(), -1);
						}
						bLocal_2936 = true;
					}
					if (bLocal_2936)
					{
						if (IS_ENTITY_AT_COORD(uLocal_3109, GET_ENTITY_COORDS(Local_2996[iParam1 /*20*/], 1), 25f, 25f, 25f, 0, 1, 0))
						{
							if (IS_ENTITY_PLAYING_ANIM(Local_2996[iParam1 /*20*/], "oddjobs@towingcome_here", "come_here_idle_a", 3))
							{
								STOP_ANIM_TASK(Local_2996[iParam1 /*20*/], "oddjobs@towingcome_here", "come_here_idle_a", -4f);
							}
							if (!func_114())
							{
								if (iLocal_420 == 1)
								{
									...
									TASK_ENTER_VEHICLE(Local_2996[iParam1 /*20*/], uLocal_3109, 20000, 0, 2f, 1048577, 0);
								}
								else if (iLocal_420 == 3)
								{
									if (Global_106565.f_19967.f_7 == 0 || Global_106565.f_19967.f_7 == 1)
								...
								if (iLocal_2953)
								{
									REMOVE_BLIP(&(Local_2996[iParam1 /*20*/].f_8));
									if (DOES_ENTITY_EXIST(Local_2996[iParam1 /*20*/]))
									{
										Local_2996[iParam1 /*20*/].f_8 = ADD_BLIP_FOR_ENTITY(Local_2996[iParam1 /*20*/]);
										SET_BLIP_COLOUR(Local_2996[iParam1 /*20*/].f_8, 3);
										SET_BLIP_SCALE(Local_2996[iParam1 /*20*/].f_8, 0.7f);
									}
								}
								SETTIMERA(0);
								*iParam0 = 1;
						...
						else if (IS_ENTITY_AT_COORD(uLocal_3109, GET_ENTITY_COORDS(Local_2996[iParam1 /*20*/], 1), 50f, 50f, 50f, 0, 1, 0))
						{
							if (!iLocal_2977)
							{
								if (Global_106565.f_19967.f_7 == 0 || Global_106565.f_19967.f_7 == 1)
		...
		case 1:
			...
			if (!DOES_BLIP_EXIST(Local_2996[0 /*20*/].f_9))
			{
				if (DOES_ENTITY_EXIST(Local_2996[iParam1 /*20*/]))
				{
					Local_2996[0 /*20*/].f_9 = ADD_BLIP_FOR_ENTITY(Local_2996[iParam1 /*20*/]);
					SET_BLIP_COLOUR(Local_2996[0 /*20*/].f_9, 3);
					SET_BLIP_SCALE(Local_2996[0 /*20*/].f_9, 0.7f);
				}
			}
		...
		case 2:
			ADD_RELATIONSHIP_GROUP("TOWBUDDIES", &uLocal_2995);
			SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_2995, 1862763509);
			SET_PED_RELATIONSHIP_GROUP_HASH(Local_2996[iParam1 /*20*/], uLocal_2995);
			func_113(iParam1);
			*iParam0 = 3;
			break;
		
		case 3:
			if (!IS_PED_IN_VEHICLE(Local_2996[iParam1 /*20*/], uLocal_3109, 0))
			{
			...
			if (IS_PED_IN_VEHICLE(Local_2996[iParam1 /*20*/], uLocal_3109, 0))
			{
				if (!IS_ENTITY_DEAD(uLocal_3109, 0))
				{
					SET_VEHICLE_DOORS_LOCKED(uLocal_3109, 9);
					func_100(Local_2996[0 /*20*/].f_9);
				}
			}
			if (IS_PED_IN_VEHICLE(Local_2996[iParam1 /*20*/], uLocal_3109, 0) && !IS_SCRIPTED_CONVERSATION_ONGOING())
			{
				if (iLocal_420 == 1)
				{
					if (Global_106565.f_19967.f_5 == 0 || Global_106565.f_19967.f_5 == 1)
		...
		case 4:
			...
			{
				func_113(iParam1);
				if (!IS_ENTITY_DEAD(uLocal_3109, 0) && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
				{
					if (iLocal_2953 && IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[0 /*20*/].f_6))
					{
						return 1;
					}
				}
				if (!DOES_BLIP_EXIST(Local_2996[0 /*20*/].f_8))
				{
					if (DOES_ENTITY_EXIST(Local_2996[iParam1 /*20*/].f_6) && !IS_ENTITY_DEAD(Local_2996[iParam1 /*20*/].f_6, 0))
					{
						Local_2996[0 /*20*/].f_8 = ADD_BLIP_FOR_ENTITY(Local_2996[iParam1 /*20*/].f_6);
						SET_BLIP_COLOUR(Local_2996[iParam1 /*20*/].f_8, 3);
					}
				}
				if (!IS_ENTITY_DEAD(uLocal_3109, 0) && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
				{
					if (!IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[0 /*20*/].f_6))
					{
...
int func_110(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	switch (*uParam0)
	{
		case 0:
			...
			uParam0->f_2 = func_111(uParam1, 1);
			*uParam0 = 1;
			break;
...
{
	return func_112(GET_PLAYER_PED(GET_PLAYER_INDEX()), uParam0, iParam1);
}

float func_112(var uParam0, var uParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_113(int iParam0)
{
	...
	while (iVar0 < 1)
	{
		if (iVar0 != iParam0)
		{
			if (DOES_BLIP_EXIST(Local_2996[iVar0 /*20*/].f_8))
			{
				REMOVE_BLIP(&(Local_2996[iVar0 /*20*/].f_8));
			}
		}
		iVar0++;
	}
...
int func_114()
{
	...
	if (!IS_ENTITY_DEAD(uLocal_3109, 0) && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
	{
		if (IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[0 /*20*/].f_6))
		{
			fVar0 = GET_ENTITY_SPEED(uLocal_3109);
			if (fVar0 > 1f)
			{
				return 1;
			}
...
int func_116(var uParam0, var uParam1, int iParam2, int iParam3, float fParam4, float fParam5, bool bParam6)
{
	var uVar0;
	...
	if (DOES_ENTITY_EXIST(uParam0))
	{
		if (!IS_ENTITY_DEAD(uVar0, 0) && IS_PED_INJURED(uVar0))
		{
			return 0;
		}
	}
	...
	{
		if (!IS_ENTITY_DEAD(uParam0, 0) && !IS_ENTITY_DEAD(uParam1, 0))
		{
			if (bParam6)
			{
			}
			if (!IS_ENTITY_OCCLUDED(uParam0) && func_111(uParam0, 1) < fParam4)
			{
				*iParam2++;
			}
			else
			...
			if (((*iParam2 > iParam3 || func_111(uParam0, 1) < 8f) && GET_ENTITY_SPEED(uParam1) < fParam5) && !IS_ENTITY_OCCLUDED(uParam0))
			{
				*iParam2 = 0;
				return 1;
			}
...
void func_117()
{
	...
	if (!bLocal_2940)
	{
		iVar0 = ROUND(((300f - func_121(&uLocal_3100)) * 1000f));
		if (iLocal_420 == 3)
		{
			if ((iVar0 / 1000) < 60)
			{
...
int func_124(var uParam0, vector3 vParam1, float fParam4)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_125(char* sParam0, char* sParam1, var uParam2, bool bParam3, bool bParam4)
{
	...
	if (bParam3)
	{
		if (func_131(vLocal_3063, fLocal_3066, uParam2, 0))
		{
			...
			SET_FORCE_HD_VEHICLE(Local_2996[0 /*20*/].f_6, 1);
			SET_VEHICLE_TYRES_CAN_BURST(Local_2996[0 /*20*/].f_6, 0);
			SET_ENTITY_LOAD_COLLISION_FLAG(Local_2996[0 /*20*/].f_6, 1, 1);
			SET_VEHICLE_HAS_STRONG_AXLES(Local_2996[0 /*20*/].f_6, 1);
			return 1;
		}
	}
...
int func_126(bool bParam0, int iParam1)
{
	...
	{
		SET_VEHICLE_DAMAGE(Local_2996[0 /*20*/].f_6, 0f, 1.2f, 0f, 1600f, 1600f, 1);
		SET_VEHICLE_DAMAGE(Local_2996[0 /*20*/].f_6, 0f, 0.75f, 0.05f, 1600f, 1600f, 1);
		SET_VEHICLE_DAMAGE(Local_2996[0 /*20*/].f_6, -0.7f, 0f, 0f, 1600f, 1600f, 1);
		SET_VEHICLE_DAMAGE(Local_2996[0 /*20*/].f_6, 0.7f, 0f, 0f, 1600f, 1600f, 1);
	}
	else if (Local_650[iLocal_2604 /*23*/] == 4)
	{
		fLocal_3066 = -1f;
		iLocal_2950 = 1;
		uLocal_3110 = CREATE_VEHICLE(joaat("ambulance"), Local_1870[func_250() /*28*/].f_23, Local_1870[func_250() /*28*/].f_26, 1, 1, 0);
		if (!IS_ENTITY_DEAD(uLocal_3110, 0))
		{
			SET_VEHICLE_SIREN(uLocal_3110, 1);
			SET_VEHICLE_ENGINE_ON(uLocal_3110, 1, 1, 0);
			uLocal_3111 = CREATE_PED_INSIDE_VEHICLE(uLocal_3110, 4, joaat("s_m_m_paramedic_01"), -1, 1, 1);
		}
		if (!func_11(Local_1870[func_250() /*28*/].f_17))
		{
			uLocal_2347 = func_127(Local_1870[func_250() /*28*/].f_17, Local_1870[func_250() /*28*/].f_20);
		}
		switch (Local_650[iLocal_2604 /*23*/].f_21)
		{
			case 1:
				SET_VEHICLE_DAMAGE(Local_2996[0 /*20*/].f_6, -0.5223f, 2.455f, 0.0784f, 200f, 250f, 1);
				SET_VEHICLE_DAMAGE(Local_2996[0 /*20*/].f_6, -1f, 1.5f, -0.5f, 200f, 250f, 1);
				break;
			
			case 0:
				SET_VEHICLE_DAMAGE(Local_2996[0 /*20*/].f_6, 0.6012f, 2.4222f, 0.0245f, 200f, 250f, 1);
				SET_VEHICLE_DAMAGE(Local_2996[0 /*20*/].f_6, 1f, 1.5f, -0.5f, 200f, 250f, 1);
				break;
			
			case 2:
				SET_VEHICLE_DAMAGE(Local_2996[0 /*20*/].f_6, 0.1414f, 1.8401f, 0.0342f, 200f, 350f, 1);
				break;
		}
		SET_VEHICLE_DOOR_OPEN(Local_2996[0 /*20*/].f_6, 0, 0, 0);
	}
	if (bParam0)
	{
		bLocal_442 = true;
		if (Global_106565.f_19967.f_5 == 0 || Global_106565.f_19967.f_5 == 1)
		{
			Local_2996[0 /*20*/] = CREATE_PED_INSIDE_VEHICLE(Local_2996[0 /*20*/].f_6, 26, joaat("a_f_m_bevhills_01"), -1, 1, 1);
		}
		else if (Global_106565.f_19967.f_5 == 2)
		{
			Local_2996[0 /*20*/] = CREATE_PED_INSIDE_VEHICLE(Local_2996[0 /*20*/].f_6, 26, joaat("a_m_y_genstreet_02"), -1, 1, 1);
		}
		else
		{
			Local_2996[0 /*20*/] = CREATE_PED_INSIDE_VEHICLE(Local_2996[0 /*20*/].f_6, 26, uLocal_2989[0], -1, 1, 1);
		}
	}
	return 1;
}

var func_127(vector3 vParam0, vector3 vParam3)
{
...
int func_128(vector3 vParam0, var uParam3, int iParam4, bool bParam5, var uParam6)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	*iParam4 = func_129(&Local_2996);
	...
	Local_2996[*iParam4 /*20*/].f_6 = CREATE_VEHICLE(iLocal_2987[iLocal_3039], vParam0, uParam3, 1, 1, 0);
	SET_ENTITY_LOAD_COLLISION_FLAG(Local_2996[*iParam4 /*20*/].f_6, 1, 1);
	iLocal_3039++;
	...
	{
		Local_2996[*iParam4 /*20*/].f_17 = _ADD_SPEED_ZONE_FOR_COORD(Local_650[iLocal_2604 /*23*/].f_10, fVar0, 0f, 0);
	}
	else
	{
		Local_2996[*iParam4 /*20*/].f_17 = _ADD_SPEED_ZONE_FOR_COORD(vParam0, fVar0, 0f, 0);
	}
	Local_2996[*iParam4 /*20*/].f_18 = _ADD_SPEED_ZONE_FOR_COORD(vParam0, fVar1, 2.5f, 0);
	Local_2996[*iParam4 /*20*/].f_19 = _ADD_SPEED_ZONE_FOR_COORD(vParam0, fVar2, 4f, 0);
	if (bParam5)
	{
		if (Local_2996[*iParam4 /*20*/].f_15)
		{
			SET_DISABLE_VEHICLE_PETROL_TANK_FIRES(Local_2996[*iParam4 /*20*/].f_6, 1);
			SET_VEHICLE_ENGINE_HEALTH(Local_2996[*iParam4 /*20*/].f_6, 1f);
			_0x91A0BD635321F145(Local_2996[*iParam4 /*20*/].f_6, 1);
		}
		else
		{
			SET_DISABLE_VEHICLE_PETROL_TANK_FIRES(Local_2996[*iParam4 /*20*/].f_6, 1);
	...
	{
		if (DOES_ENTITY_EXIST(Local_2996[*iParam4 /*20*/].f_6))
		{
			Local_2996[*iParam4 /*20*/].f_8 = ADD_BLIP_FOR_ENTITY(Local_2996[*iParam4 /*20*/].f_6);
			SET_BLIP_COLOUR(Local_2996[*iParam4 /*20*/].f_8, 3);
		}
	}
	iLocal_3038++;
...
void func_130(var uParam0, var uParam1, var uParam2)
{
	if (DOES_ENTITY_EXIST(uParam0))
	{
		*uParam1 = GET_ENTITY_HEALTH(uParam0);
		*uParam2 = *uParam1;
	}
}

int func_131(vector3 vParam0, float fParam3, var uParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	SET_VEHICLE_DOOR_OPEN(Local_2996[*uParam4 /*20*/].f_6, 4, 0, 0);
	GET_MODEL_DIMENSIONS(GET_ENTITY_MODEL(Local_2996[*uParam4 /*20*/].f_6), &vVar3, &vVar6);
	vVar9 = { vVar6 - vVar3 };
	vVar9 = { vVar9 / Vector(2f, 2f, 2f) };
	iLocal_2950 = 1;
	vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_2996[*uParam4 /*20*/].f_6, 1.5f, 0f, 0f) };
	vVar12 = { GET_ENTITY_COORDS(Local_2996[*uParam4 /*20*/].f_6, 1) };
	uVar15 = GET_ENTITY_HEADING(Local_2996[*uParam4 /*20*/].f_6);
	uLocal_3048 = _ADD_SPEED_ZONE_FOR_COORD(_GET_OBJECT_OFFSET_FROM_COORDS(vVar12, uVar15, -1.5f, -30f, 0f), 10f, 0f, 0);
	uLocal_3049 = _ADD_SPEED_ZONE_FOR_COORD(_GET_OBJECT_OFFSET_FROM_COORDS(vVar12, uVar15, -1.5f, 30f, 0f), 10f, 0f, 0);
	CLEAR_AREA_OF_VEHICLES(vVar0, 30f, 0, 0, 0, 0, 0, 0);
...
int func_132(var uParam0, float fParam1, var uParam2, var uParam3)
{
	...
	fVar8 = 0f;
	fVar9 = 0f;
	iVar10 = (GET_RANDOM_INT_IN_RANGE(0, 3999) / 1000);
	if (iVar10 == 0)
	{
		fVar8 = -GET_RANDOM_FLOAT_IN_RANGE(450f, 700f);
		fVar9 = GET_RANDOM_FLOAT_IN_RANGE(-100f, 100f);
	}
	else if (iVar10 == 1)
	{
		fVar8 = GET_RANDOM_FLOAT_IN_RANGE(450f, 700f);
	...
	{
		fVar9 = GET_RANDOM_FLOAT_IN_RANGE(450f, 700f);
		fVar8 = GET_RANDOM_FLOAT_IN_RANGE(-100f, 100f);
	}
	else
	{
		fVar9 = -GET_RANDOM_FLOAT_IN_RANGE(450f, 700f);
	...
	vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PLAYER_PED_ID(), fVar8, fVar9, 0f) };
	if (!GET_RANDOM_VEHICLE_NODE(vVar0, 10f, 1, 1, 1, &vVar5, &uVar4))
	{
		return 0;
	}
	GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(vVar5, 2, uParam2, fParam1, &uVar3, 1, 1077936128, 0);
	*uParam0 = { vVar5 };
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya4")) == 1)
	{
...
void func_135()
{
	...
	while (iVar0 < 12)
	{
		if (DOES_BLIP_EXIST(vLocal_280[iVar0 /*3*/].f_1))
		{
			if (IS_ENTITY_DEAD(vLocal_280[iVar0 /*3*/], 0))
			{
				REMOVE_BLIP(&(vLocal_280[iVar0 /*3*/].f_1));
			}
...
void func_136()
{
	if (!ARE_STRINGS_EQUAL(&cLocal_272, ""))
	{
		if (!func_41())
		{
...
void func_140(var uParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, int iParam7, bool bParam8)
{
	int iVar0;
...
int func_146(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_154() || func_153(Global_4456448.f_161209)) || func_152())
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			iVar1 = func_151(PLAYER_PED_ID(), 0);
			if (((_0xE33FFA906CE74880(uVar0, iVar1) || (GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_150(uVar0, 10)) && GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_147(int iParam0)
{
	if (iParam0 != func_149())
	{
		...
		else if ((Global_1312867 && iParam0 == PLAYER_ID()) && func_148(iParam0, 1, 0))
		{
			return Global_2424047[iParam0 /*416*/].f_309.f_5 != -1;
		}
	}
...
void func_157(var uParam0, vector3 vParam1, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_158(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_161(bParam1, bParam2, bParam3) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1) || func_159(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
int func_167()
{
	...
	if (DOES_ENTITY_EXIST(iLocal_2984) && !IS_ENTITY_DEAD(iLocal_2984, 0))
	{
		vVar3 = { GET_ENTITY_COORDS(iLocal_2984, 1) };
	}
	if (VDIST2(vVar0, vVar3) > 2500f)
	{
		if (!bLocal_2968)
		{
			...
			bLocal_2968 = true;
			if (!DOES_BLIP_EXIST(uLocal_425))
			{
				if (!IS_ENTITY_DEAD(iLocal_2984, 0))
				{
					uLocal_425 = ADD_BLIP_FOR_ENTITY(iLocal_2984);
					SET_BLIP_COLOUR(uLocal_425, 3);
					SET_BLIP_SCALE(uLocal_425, 0.5f);
				}
			}
			if (DOES_BLIP_EXIST(Local_2996[0 /*20*/].f_8))
			{
				REMOVE_BLIP(&(Local_2996[0 /*20*/].f_8));
			}
		}
	}
	else if (bLocal_2968)
	{
		...
		if (DOES_BLIP_EXIST(uLocal_425))
		{
			REMOVE_BLIP(&uLocal_425);
		}
		if (!DOES_BLIP_EXIST(Local_2996[0 /*20*/].f_8))
		{
			Local_2996[0 /*20*/].f_8 = ADD_BLIP_FOR_COORD(vLocal_2625[0 /*3*/]);
			if (iLocal_468)
			{
				SET_BLIP_COLOUR(Local_2996[0 /*20*/].f_8, 5);
				SET_BLIP_ROUTE(Local_2996[0 /*20*/].f_8, 1);
				SET_BLIP_ROUTE_COLOUR(Local_2996[0 /*20*/].f_8, 5);
			}
			else
			{
				SET_BLIP_COLOUR(Local_2996[0 /*20*/].f_8, 3);
				SET_BLIP_ROUTE(Local_2996[0 /*20*/].f_8, 1);
				SET_BLIP_ROUTE_COLOUR(Local_2996[0 /*20*/].f_8, 3);
			}
		}
	}
	if (VDIST2(vVar0, vVar3) > 22500f)
...
int func_169(var uParam0, int iParam1, var uParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)
{
	var uVar0;
	bool bVar1;
	...
	if (!IS_ENTITY_DEAD(uVar0, 0) && !IS_ENTITY_DEAD(uParam0, 0))
	{
		...
		{
			if (func_173(uVar0, uParam0, uParam2, bParam5))
			{
				*iParam3 = 4;
				return 1;
			}
		...
		{
			if (func_172(uVar0, uParam0, uParam2))
			{
				*iParam3 = 8;
				return 1;
			}
		...
		if (bParam4)
		{
			if (func_170(uParam0, iParam1, 1, bParam6, bVar1, 1))
			{
				*iParam3 = 32;
				return 1;
			}
		...
		{
			if (func_170(uParam0, iParam1, 0, bParam6, bVar1, bParam8))
			{
				*iParam3 = 16;
				return 1;
			}
...
int func_170(var uParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	var uVar0;
	var uVar1;
	...
	if (bParam3)
	{
		if (!bLocal_395)
		{
			iLocal_396 = GET_ENTITY_HEALTH(uParam0);
			bLocal_395 = true;
		}
		iLocal_397 = GET_ENTITY_HEALTH(uParam0);
	...
	if (func_171(PLAYER_PED_ID(), uParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (IS_PED_RAGDOLL(uParam0) && func_111(uParam0, 1) < 1.5f)
		{
			return 1;
		}
...
int func_173(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	...
	if (IS_PED_ARMED(uParam0, 2))
	{
		...
		else
		{
			...
			if (IS_PED_PLANTING_BOMB(uParam0) || func_174(iVar3))
			{
				if (IS_ENTITY_AT_COORD(uParam1, GET_ENTITY_COORDS(uParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (IS_PED_FACING_PED(GET_PED_INDEX_FROM_ENTITY_INDEX(uParam1), uParam0, 120f) && HAS_ENTITY_CLEAR_LOS_TO_ENTITY(uParam1, uParam0, 17))
		...
		if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
		{
			if (GET_PED_IN_VEHICLE_SEAT(iParam0, -1, 0) != 0)
			{
				if (GET_CURRENT_PED_WEAPON(PLAYER_PED_ID(), &iVar0, 1))
				{
					...
					{
						if (func_112(PLAYER_PED_ID(), iParam0, 1) < 40f)
						{
	...
	if (!IS_ENTITY_DEAD(uParam0, 0))
	{
		if (IS_PED_ARMED(PLAYER_PED_ID(), 6))
		{
			if (IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uParam0) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uParam0))
			{
				...
				{
					if (func_111(uParam0, 1) < uParam1->f_2)
					{
						if (uParam1->f_1 == 0)
						{
...
void func_177(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, char[4] cParam6, char* sParam7, var uParam8, bool bParam9, var uParam10)
{
	int iVar0;
	...
	while (iVar0 < iParam5)
	{
		...
		{
			if (!IS_ENTITY_DEAD((*uParam4)[iVar0], 0) && !IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
			{
				if (func_169((*uParam4)[iVar0], 0, &uLocal_412, &iLocal_419, 0, 1, 0, 1, 1))
				{
					TASK_SMART_FLEE_PED((*uParam4)[iVar0], PLAYER_PED_ID(), 1000f, -1, 0, 0);
				}
			}
		}
		iVar0++;
	...
	{
		case 0:
			if (func_116(uParam1, uParam3, &iLocal_2603, 20, 70f, 65f, 0))
			{
				iLocal_2603 = 0;
				*uParam0 = 1;
			}
		...
		case 1:
			...
			{
				if (!IS_ENTITY_DEAD(uParam1, 0) && !IS_ENTITY_DEAD(uParam2, 0))
				{
					TASK_VEHICLE_DRIVE_WANDER(uParam2, uParam1, 50f, 786469);
					SET_PED_KEEP_TASK(uParam2, 1);
					SET_PED_AS_NO_LONGER_NEEDED(&uParam2);
					SET_VEHICLE_AS_NO_LONGER_NEEDED(&uParam1);
				}
				*uParam0 = 2;
			}
			break;
		...
		case 3:
			if (!func_11(Local_1870[func_250() /*28*/].f_17))
			{
				func_178(uLocal_2347, Local_1870[func_250() /*28*/].f_17, Local_1870[func_250() /*28*/].f_20);
			}
			if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya5")) == 1)
			{
				if (!iLocal_457)
				{
			...
			while (iVar0 < iParam5)
			{
				...
				{
					OPEN_SEQUENCE_TASK(&uLocal_421);
					TASK_PLAY_ANIM(0, cParam6, (*sParam7)[iVar0], 4f, -4f, GET_RANDOM_INT_IN_RANGE(10000, 20000), 0, 0, 0, 0, 0);
					TASK_WANDER_STANDARD(0, 1193033728, 0);
					CLOSE_SEQUENCE_TASK(uLocal_421);
					TASK_PERFORM_SEQUENCE((*uParam4)[iVar0], uLocal_421);
					CLEAR_SEQUENCE_TASK(&uLocal_421);
				}
				iVar0++;
			}
		...
		case 5:
			if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya5")) == 1)
			{
				...
				if (!iLocal_469)
				{
					if (!IS_ENTITY_DEAD(uParam3, 0) && !IS_ENTITY_DEAD(*uParam10, 0))
					{
						if (!IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uParam3, *uParam10))
						{
							if (!func_7(&uLocal_2528))
							{
								func_257(&uLocal_2528);
							}
...
int func_179(var uParam0, var uParam1, vector3 vParam2, var uParam5, var uParam6, var uParam7, float fParam8, char[4] cParam9, char* sParam10, int iParam11)
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	vVar3 = { *(uParam0[0 /*3*/]) };
	vVar3.z = (vVar3.z + 1f);
	if (GET_GROUND_Z_FOR_3D_COORD(vVar3, &uVar0, 0, 0) || func_9(*(uParam0[0 /*3*/]), 0) < 60f)
	{
		func_181(uParam1);
		CLEAR_AREA_OF_PEDS(vParam2, 28f, 0);
		...
		while (iVar2 < iParam11)
		{
			...
			if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya4")) == 1)
			{
				uVar1 = CREATE_PED(4, joaat("a_m_m_tourist_01"), *(uParam0[iVar2 /*3*/]), fParam8, 1, 1);
				SET_PED_COMPONENT_VARIATION(uVar1, 0, 0, 1, 0);
				SET_PED_COMPONENT_VARIATION(uVar1, 2, 0, 0, 0);
				SET_PED_COMPONENT_VARIATION(uVar1, 3, 0, 2, 0);
				SET_PED_COMPONENT_VARIATION(uVar1, 4, 1, 2, 0);
				SET_PED_COMPONENT_VARIATION(uVar1, 8, 0, 0, 0);
				SET_PED_COMPONENT_VARIATION(uVar1, 10, 1, 1, 0);
				SET_MODEL_AS_NO_LONGER_NEEDED(joaat("a_m_m_tourist_01"));
			}
			else if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya5")) == 1)
			{
				if (iVar2 == 0)
				{
					uVar1 = CREATE_PED(4, joaat("a_m_y_genstreet_02"), *(uParam0[iVar2 /*3*/]), fParam8, 1, 1);
					SET_MODEL_AS_NO_LONGER_NEEDED(joaat("a_m_y_genstreet_02"));
				}
				else
				{
					uVar1 = CREATE_PED(4, joaat("a_m_m_bevhills_02"), *(uParam0[iVar2 /*3*/]), fParam8, 1, 1);
					SET_MODEL_AS_NO_LONGER_NEEDED(joaat("a_m_m_bevhills_02"));
				}
			}
			else
			{
				uVar1 = CREATE_PED(4, (*uParam7)[(iVar2 % 2)], *(uParam0[iVar2 /*3*/]), fParam8, 1, 1);
			}
			SET_ENTITY_LOAD_COLLISION_FLAG(uVar1, 1, 1);
			fParam8 = -1f;
			if (iParam11 > 1)
			{
				(*uParam6)[iVar2] = uVar1;
			...
			SET_PED_CONFIG_FLAG(uVar1, 42, 1);
			SET_PED_MOVEMENT_CLIPSET(uVar1, "move_m@JOG@", 1048576000);
			SET_PED_RESET_FLAG(uVar1, 109, 1);
			if (iLocal_420 == 3)
			{
				CLEAR_SEQUENCE_TASK(&uVar6);
				OPEN_SEQUENCE_TASK(&uVar6);
				TASK_PLAY_ANIM(0, "oddjobs@towingcome_here", "come_here_idle_a", 4f, -4f, -1, 49, 0, 0, 0, 0);
				TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), -1);
				CLOSE_SEQUENCE_TASK(uVar6);
				if (!IS_ENTITY_DEAD(uVar1, 0))
				{
					TASK_PERFORM_SEQUENCE(uVar1, uVar6);
				}
				CLEAR_SEQUENCE_TASK(&uVar6);
			}
			iVar2++;
...
float func_180(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)
{
...
void func_181(var uParam0)
{
	...
	while (iVar0 < 1)
	{
		...
		if (iVar0 == 0)
		{
			Local_2556[iVar0 /*18*/].f_8 = { func_182(GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216), 0f) };
		}
		else
		{
		...
		Local_2556[iVar0 /*18*/] = ADD_DECAL(Local_2556[iVar0 /*18*/].f_1, Local_2556[iVar0 /*18*/].f_2, Local_2556[iVar0 /*18*/].f_5, Local_2556[iVar0 /*18*/].f_8, Local_2556[iVar0 /*18*/].f_11, Local_2556[iVar0 /*18*/].f_12, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		iVar0++;
	}
}
...
int func_183()
{
	...
	{
		case 0:
			func_251(&Local_2348, 0, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			func_251(&Local_2348, 3, Local_2996[0 /*20*/], sLocal_2624, 0, 1);
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_2996[0 /*20*/], 1);
			iLocal_3041 = GET_RANDOM_INT_IN_RANGE(35, 80);
			iLocal_3120 = 1;
			break;
		
		case 1:
			OPEN_SEQUENCE_TASK(&uLocal_421);
			TASK_PLAY_ANIM(0, "oddjobs@towing", "Start_Engine_Loop", 8f, -8f, -1, 1, 0, 0, 0, 0);
			CLOSE_SEQUENCE_TASK(uLocal_421);
			TASK_PERFORM_SEQUENCE(Local_2996[0 /*20*/], uLocal_421);
			CLEAR_SEQUENCE_TASK(&uLocal_421);
			...
			{
				TASK_PLAY_ANIM(0, "oddjobs@towing", "Start_Engine_Exit", 8f, -8f, -1, 0, 0, 0, 0, 0);
				iLocal_3120 = 2;
			}
			break;
		...
		case 2:
			if (!func_11(Local_650[iLocal_2604 /*23*/].f_13))
			{
				...
				if (!IS_ENTITY_IN_ANGLED_AREA(Local_2996[0 /*20*/].f_6, Local_650[iLocal_2604 /*23*/].f_13, Local_650[iLocal_2604 /*23*/].f_16, Local_650[iLocal_2604 /*23*/].f_19, 0, 1, 0))
				{
					func_115(&iLocal_2598);
					iLocal_2947 = 1;
					iLocal_2954 = 1;
					bLocal_427 = true;
					if (IS_PED_IN_ANY_VEHICLE(Local_2996[0 /*20*/], 0))
					{
						OPEN_SEQUENCE_TASK(&uLocal_421);
						TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
						TASK_PLAY_ANIM(0, "oddjobs@towingpleadingidle_b", "idle_d", 4f, -4f, 10000, 16, 0, 0, 0, 0);
						CLOSE_SEQUENCE_TASK(uLocal_421);
						TASK_PERFORM_SEQUENCE(Local_2996[0 /*20*/], uLocal_421);
						CLEAR_SEQUENCE_TASK(&uLocal_421);
						iLocal_3120 = 4;
			...
			if (func_10(Local_2996[0 /*20*/].f_7, Local_650[iLocal_2604 /*23*/].f_1, 1) < IntToFloat(iLocal_3041 + 15))
			{
				...
				func_115(&iLocal_2598);
				TASK_LOOK_AT_ENTITY(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_7, -1, 2, 2);
				SETTIMERB(0);
				iLocal_3120 = 3;
			}
			break;
			...
			if (func_10(Local_2996[0 /*20*/].f_7, Local_650[iLocal_2604 /*23*/].f_1, 1) < IntToFloat(iLocal_3041))
			{
				if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
				{
					...
					if (IS_PED_IN_ANY_VEHICLE(Local_2996[0 /*20*/], 0))
					{
						OPEN_SEQUENCE_TASK(&uLocal_421);
						TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
						TASK_GO_TO_COORD_ANY_MEANS(0, _GET_OBJECT_OFFSET_FROM_COORDS(Local_650[iLocal_2604 /*23*/].f_1, Local_650[iLocal_2604 /*23*/].f_4, 0f, 15f, 0f), 3f, 0, 0, 786603, -1082130432);
						TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), -1);
						CLOSE_SEQUENCE_TASK(uLocal_421);
						SET_PED_FLEE_ATTRIBUTES(Local_2996[0 /*20*/], 64, 0);
						TASK_PERFORM_SEQUENCE(Local_2996[0 /*20*/], uLocal_421);
						CLEAR_SEQUENCE_TASK(&uLocal_421);
						iLocal_3120 = 4;
					}
...
int func_184()
{
	if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
	{
		if (bLocal_427)
		{
			...
			{
				case 0:
					if (GET_SEQUENCE_PROGRESS(Local_2996[0 /*20*/]) == 1)
					{
						iLocal_3053 = 1;
					}
					break;
				...
				case 1:
					if (!IS_ENTITY_PLAYING_ANIM(Local_2996[0 /*20*/], "oddjobs@towingpleadingidle_b", "idle_d", 3))
					{
						iLocal_3053 = 2;
					}
					break;
...
void func_186()
{
	...
	if (iLocal_2947 || ((!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0) && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0)) && !IS_PED_IN_VEHICLE(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, 0)))
	{
		if (iLocal_2598 != -1)
		{
			STOP_SOUND(iLocal_2598);
			RELEASE_SOUND_ID(iLocal_2598);
			iLocal_2598 = -1;
			return;
		}
	}
	if (!iLocal_2938)
	{
		iLocal_2598 = GET_SOUND_ID();
		iLocal_2938 = 1;
	}
	if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
	{
		if (IS_ENTITY_PLAYING_ANIM(Local_2996[0 /*20*/], "oddjobs@towing", "Start_Engine_Loop", 3))
		{
			fVar0 = GET_ENTITY_ANIM_CURRENT_TIME(Local_2996[0 /*20*/], "oddjobs@towing", "Start_Engine_Loop");
			if (((fVar0 >= 0.19f && fVar0 <= 0.262f) || (fVar0 >= 0.4f && fVar0 <= 0.6f)) || (fVar0 >= 0.9f && fVar0 <= 1f))
			{
				...
				if (!iLocal_2937)
				{
					PLAY_SOUND_FROM_ENTITY(iLocal_2598, "TOWING_ENGINE_TURNING_MASTER", Local_2996[0 /*20*/].f_6, 0, 0, 0);
					iLocal_2937 = 1;
				}
			}
			else
...
void func_187()
{
	...
	if (HAS_SCALEFORM_MOVIE_LOADED(uLocal_2608))
	{
		SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_2608);
	}
	if (!IS_ENTITY_DEAD(uLocal_3109, 0))
	{
		SET_VEHICLE_DOORS_LOCKED(uLocal_3109, 1);
		SET_VEHICLE_SIREN(uLocal_3109, 0);
	}
	_REMOVE_SPEED_ZONE(uLocal_3048);
	_REMOVE_SPEED_ZONE(uLocal_3049);
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_3112, 0);
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_3113, 0);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_3060 - Vector(15f, 15f, 15f), vLocal_3060 + Vector(15f, 15f, 15f), 1, 1);
	iVar0 = 0;
	while (iVar0 < 1)
	{
		_REMOVE_SPEED_ZONE(Local_2996[iVar0 /*20*/].f_17);
		_REMOVE_SPEED_ZONE(Local_2996[iVar0 /*20*/].f_18);
		_REMOVE_SPEED_ZONE(Local_2996[iVar0 /*20*/].f_19);
		iVar0++;
	}
	if (!func_11(Local_1870[func_250() /*28*/].f_17))
	{
	...
	SET_VEHICLE_AS_NO_LONGER_NEEDED(&(Local_2996[0 /*20*/].f_6));
	if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
	{
		SET_PED_AS_NO_LONGER_NEEDED(&(Local_2996[0 /*20*/]));
		if (DOES_ENTITY_EXIST(Local_2996[0 /*20*/]))
		{
			if (IS_PED_IN_GROUP(Local_2996[0 /*20*/]))
			{
				REMOVE_PED_FROM_GROUP(Local_2996[0 /*20*/]);
			}
		}
	}
	if (DOES_ENTITY_EXIST(uLocal_2983))
	{
		if (!IS_ENTITY_DEAD(uLocal_2983, 0))
		{
			SET_PED_AS_NO_LONGER_NEEDED(&uLocal_2983);
		}
	}
	if (!IS_ENTITY_DEAD(uLocal_3109, 0))
	{
		SET_ENTITY_AS_MISSION_ENTITY(uLocal_3109, 1, 1);
		SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_3109);
	}
	if (iLocal_2963)
	{
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_2632, vLocal_2635, 1, 1);
	}
	if (iLocal_2960 && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_7, 0))
	{
		_SET_VEHICLE_ST(Local_2996[0 /*20*/].f_7, 1);
		SET_MISSION_TRAIN_AS_NO_LONGER_NEEDED(&(Local_2996[0 /*20*/].f_7), 0);
		SET_RANDOM_TRAINS(1);
		func_122(0, 1);
		func_122(1, 0);
		func_122(2, 0);
	...
	func_115(&iLocal_2598);
	func_139(&uLocal_399, 0, 0);
	if (DOES_CAM_EXIST(Local_2993))
	{
		func_185(&Local_2993);
	}
	SET_WANTED_LEVEL_MULTIPLIER(1f);
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("towtruck"), 0);
...
void func_188(var uParam0)
{
	...
	while (iVar0 < 8)
	{
		if ((*uParam0)[iVar0] != 0)
		{
			STOP_PARTICLE_FX_LOOPED((*uParam0)[iVar0], 0);
			(*uParam0)[iVar0] = 0;
		}
		iVar0++;
	}
...
int func_190()
{
	...
	if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0) && !IS_ENTITY_DEAD(uLocal_3109, 0))
	{
		if (IS_PED_IN_VEHICLE(Local_2996[0 /*20*/], uLocal_3109, 0))
		{
			if (DOES_BLIP_EXIST(Local_2996[0 /*20*/].f_10))
			{
				REMOVE_BLIP(&(Local_2996[0 /*20*/].f_10));
				func_115(&iLocal_2598);
			}
		}
		else if (!IS_PED_IN_VEHICLE(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, 0))
		{
			func_115(&iLocal_2598);
		}
	}
	switch (iLocal_3119)
	{
		case 0:
			...
			{
				Local_2996[0 /*20*/].f_7 = CREATE_MISSION_TRAIN(6, Local_650[iLocal_2604 /*23*/].f_6, Local_650[iLocal_2604 /*23*/].f_5);
				if (DOES_ENTITY_EXIST(Local_2996[0 /*20*/].f_7))
				{
					Local_2996[0 /*20*/].f_10 = ADD_BLIP_FOR_ENTITY(Local_2996[0 /*20*/].f_7);
				}
				uLocal_2983 = CREATE_PED_INSIDE_VEHICLE(Local_2996[0 /*20*/].f_7, 4, joaat("s_m_m_lsmetro_01"), -1, 1, 1);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_2983, 1);
				if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_7, 0))
				{
					SET_TRAIN_CRUISE_SPEED(Local_2996[0 /*20*/].f_7, 0f);
				}
		...
		case 1:
			if (func_9(Local_650[iLocal_2604 /*23*/].f_1, 1) < 80f || TIMERA() > 10000)
			{
		...
		case 2:
			if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_7, 0))
			{
				SET_TRAIN_CRUISE_SPEED(Local_2996[0 /*20*/].f_7, 26f);
				SET_TRAIN_SPEED(Local_2996[0 /*20*/].f_7, 22f);
			}
			iLocal_3119 = 3;
			break;
		
		case 3:
			if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_7, 0) && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
			{
		...
		case 4:
			if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_7, 0) && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
			{
				...
				vVar0 = { GET_ENTITY_COORDS(Local_2996[0 /*20*/].f_7, 1) };
				if (func_10(Local_2996[0 /*20*/].f_7, Local_650[iLocal_2604 /*23*/].f_1, 1) < 3f)
				{
					iLocal_2934 = 1;
				}
				if (IS_ENTITY_TOUCHING_ENTITY(Local_2996[0 /*20*/].f_7, Local_2996[0 /*20*/].f_6))
				{
					if (!IS_ENTITY_DEAD(uLocal_3109, 0) && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
					{
						if (IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[0 /*20*/].f_6))
						{
							DETACH_VEHICLE_FROM_TOW_TRUCK(uLocal_3109, Local_2996[0 /*20*/].f_6);
						}
					}
					EXPLODE_VEHICLE(Local_2996[0 /*20*/].f_6, 1, 0);
					iLocal_3119 = 6;
				}
				else if (func_10(Local_2996[0 /*20*/].f_6, vVar0, 1) < 10f && IS_ENTITY_IN_ANGLED_AREA(Local_2996[0 /*20*/].f_6, Local_650[iLocal_2604 /*23*/].f_13, Local_650[iLocal_2604 /*23*/].f_16, Local_650[iLocal_2604 /*23*/].f_19, 0, 1, 0))
				{
					iLocal_2934 = 1;
					if (!IS_ENTITY_DEAD(uLocal_3109, 0) && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
					{
...
{
	(*uParam0)[0] = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_ojtt_train_sparks", uParam1, -0.771f, 6.515f, -1.507f, 0f, 0f, -20f, 1.15f, 1, 0, 0);
	(*uParam0)[1] = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_ojtt_train_sparks", uParam1, 0.771f, 6.515f, -1.507f, 0f, 0f, 20f, 1.15f, 0, 0, 0);
	(*uParam0)[2] = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_ojtt_train_sparks", uParam1, -0.771f, 3.781f, -1.507f, 0f, 0f, -20f, 1.15f, 1, 0, 0);
	(*uParam0)[3] = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_ojtt_train_sparks", uParam1, 0.771f, 3.781f, -1.507f, 0f, 0f, 20f, 1.15f, 0, 0, 0);
	(*uParam0)[4] = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_ojtt_train_sparks", uParam1, -0.771f, -3.743f, -1.507f, 0f, 0f, -20f, 1.15f, 1, 0, 0);
	(*uParam0)[5] = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_ojtt_train_sparks", uParam1, 0.7711f, -3.743f, -1.507f, 0f, 0f, 20f, 1.15f, 0, 0, 0);
	(*uParam0)[6] = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_ojtt_train_sparks", uParam1, -0.771f, -6.537f, -1.507f, 0f, 0f, -20f, 1.15f, 1, 0, 0);
	(*uParam0)[7] = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_ojtt_train_sparks", uParam1, 0.771f, -6.537f, -1.507f, 0f, 0f, 20f, 1.15f, 0, 0, 0);
}
...
int func_192(var uParam0)
{
	...
	if (func_3(&uLocal_2593, 0.15f))
	{
		...
		func_53(&uLocal_2593);
		SET_TRAIN_CRUISE_SPEED(uParam0, fLocal_2600);
		SET_TRAIN_SPEED(uParam0, fLocal_2600);
	}
	return 1;
}

void func_193(char* sParam0, int iParam1, bool bParam2, int iParam3, float fParam4, float fParam5, float fParam6, char* sParam7)
{
	func_115(iParam1);
	if (bParam2)
	{
	...
	if (iParam3 != 0)
	{
		PLAY_SOUND_FROM_ENTITY(*iParam1, sParam0, iParam3, sParam7, 0, 0);
	}
	else if ((fParam4 != 0f || fParam5 != 0f) || fParam6 != 0f)
	{
		PLAY_SOUND_FROM_COORD(*iParam1, sParam0, fParam4, fParam5, fParam6, sParam7, 0, 0, 0);
	}
	else
	{
		PLAY_SOUND_FRONTEND(*iParam1, sParam0, sParam7, 1);
	}
}
	...
	switch (iLocal_3118)
	{
		case 0:
			if (bLocal_2965)
			{
				if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
				{
					...
					Local_2996[0 /*20*/].f_1 = CREATE_PED_INSIDE_VEHICLE(Local_2996[0 /*20*/].f_6, 26, iLocal_74, 2, 1, 1);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_2996[0 /*20*/].f_1, 1);
					SET_PED_CONFIG_FLAG(Local_2996[0 /*20*/].f_1, 42, 1);
					func_251(&Local_2348, 6, Local_2996[0 /*20*/].f_1, "TOWSEXPRISSYGUY", 0, 1);
					TASK_PLAY_ANIM(Local_2996[0 /*20*/], "oddjobs@towing", "m_blow_job_loop", 1000f, -8f, -1, 1, 0, 0, 0, 0);
					TASK_PLAY_ANIM(Local_2996[0 /*20*/].f_1, "oddjobs@towing", "f_blow_job_loop", 1000f, -8f, -1, 1, 0, 0, 0, 0);
					if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
					{
						SET_VEHICLE_DOORS_LOCKED(Local_2996[0 /*20*/].f_6, 10);
					}
			...
			else if (bLocal_2966)
			{
				if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
				{
					Local_2996[0 /*20*/] = CREATE_PED_INSIDE_VEHICLE(Local_2996[0 /*20*/].f_6, 26, uLocal_2989[0], 0, 1, 1);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_2996[0 /*20*/], 1);
					SET_PED_CONFIG_FLAG(Local_2996[0 /*20*/], 42, 1);
					func_251(&Local_2348, 2, Local_2996[0 /*20*/], sLocal_2624, 0, 1);
					TASK_PLAY_ANIM(Local_2996[0 /*20*/], "RANDOM@CAR_SLEEPING", "Sleeping_Idle", 8f, -8f, -1, 1, 0, 0, 0, 0);
					bLocal_442 = true;
				}
			}
			else if (func_203())
		...
		case 1:
			if (bLocal_2965)
			{
				if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
				{
					if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), GET_ENTITY_COORDS(Local_2996[0 /*20*/].f_6, 1), 15f, 15f, 15f, 0, 1, 0))
					{
						if (!iLocal_3136)
						{
			...
			if (!IS_ENTITY_DEAD(uLocal_3109, 0) && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
			{
				if (IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[0 /*20*/].f_6) || func_202(uLocal_3109, Local_2996[0 /*20*/].f_6, !(bLocal_2965 || bLocal_2966)))
				{
					if (func_202(uLocal_3109, Local_2996[0 /*20*/].f_6, !(bLocal_2965 || bLocal_2966)))
					{
						bLocal_2979 = true;
					}
					if (!bLocal_2966)
					{
						func_201(&uLocal_3103, 1f);
					}
					else
					{
						func_257(&uLocal_3103);
					}
				}
			}
			if (func_7(&uLocal_3103) && func_4(&uLocal_3103) > 1f)
			{
				if (bLocal_2965 && func_7(&uLocal_3103))
				{
					...
					{
						OPEN_SEQUENCE_TASK(&uLocal_421);
						TASK_LEAVE_ANY_VEHICLE(0, 750, 0);
						TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), 0);
						TASK_PLAY_ANIM(0, "oddjobs@towingpleadingidle_b", "idle_d", -8f, 0.25f, -1, 1, 0, 0, 0, 0);
						CLOSE_SEQUENCE_TASK(uLocal_421);
						TASK_PERFORM_SEQUENCE(Local_2996[0 /*20*/], uLocal_421);
						CLEAR_SEQUENCE_TASK(&uLocal_421);
						OPEN_SEQUENCE_TASK(&uLocal_421);
						TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
						TASK_TURN_PED_TO_FACE_ENTITY(0, Local_2996[0 /*20*/], 0);
						TASK_PLAY_ANIM(0, "oddjobs@towingpleadingidle_a", "idle_c", 0.25f, 0.25f, 30000, 1, 0, 0, 0, 0);
						TASK_SMART_FLEE_PED(0, Local_2996[0 /*20*/], 1000f, -1, 0, 0);
						TASK_WANDER_STANDARD(0, 1193033728, 0);
						CLOSE_SEQUENCE_TASK(uLocal_421);
						if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_1, 0))
						{
				...
				else if (bLocal_2966)
				{
					if ((Global_106565.f_19967.f_4 % 2) == 0)
					{
						if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
						{
							OPEN_SEQUENCE_TASK(&uLocal_421);
							TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
							TASK_GO_TO_ENTITY(0, uLocal_3109, 20000, 9f, 1f, 1073741824, 0);
							TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), 0);
							TASK_PLAY_ANIM(0, "oddjobs@towingangryidle_a", "idle_b", -8f, 0.25f, 7000, 0, 0, 0, 0, 0);
							TASK_WANDER_STANDARD(0, 1193033728, 0);
							CLOSE_SEQUENCE_TASK(uLocal_421);
							TASK_PERFORM_SEQUENCE(Local_2996[0 /*20*/], uLocal_421);
							CLEAR_SEQUENCE_TASK(&uLocal_421);
					...
					else
					{
						if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
						{
							...
							SET_PED_COMBAT_ATTRIBUTES(Local_2996[0 /*20*/], 0, 0);
							SET_PED_COMBAT_ATTRIBUTES(Local_2996[0 /*20*/], 1, 0);
							OPEN_SEQUENCE_TASK(&uLocal_421);
							TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
							TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), 0);
							...
							if (DOES_ENTITY_EXIST(Local_2996[0 /*20*/]))
							{
								uLocal_2986 = ADD_BLIP_FOR_ENTITY(Local_2996[0 /*20*/]);
								SET_BLIP_COLOUR(uLocal_2986, 1);
								SET_BLIP_SCALE(uLocal_2986, 0.7f);
								func_199(Local_2996[0 /*20*/], uLocal_2986, 1);
							}
							bLocal_2964 = true;
						}
				...
				{
					Local_2996[0 /*20*/] = CREATE_PED(4, uLocal_2989[0], Local_650[iLocal_2604 /*23*/].f_6, Local_650[iLocal_2604 /*23*/].f_9, 1, 1);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_2996[0 /*20*/], 1);
					SET_PED_CONFIG_FLAG(Local_2996[0 /*20*/], 42, 1);
					bLocal_442 = true;
					...
					{
						OPEN_SEQUENCE_TASK(&uLocal_421);
						TASK_GO_TO_ENTITY(0, uLocal_3109, 20000, 15f, 3f, 1073741824, 0);
						TASK_COMBAT_PED(0, PLAYER_PED_ID(), 0, 16);
						CLOSE_SEQUENCE_TASK(uLocal_421);
						TASK_PERFORM_SEQUENCE(Local_2996[0 /*20*/], uLocal_421);
						CLEAR_SEQUENCE_TASK(&uLocal_421);
				...
				else
				{
					...
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_2996[0 /*20*/], 1);
					SET_PED_CONFIG_FLAG(Local_2996[0 /*20*/], 42, 1);
					SET_ENTITY_LOAD_COLLISION_FLAG(Local_2996[0 /*20*/], 1, 1);
					bLocal_442 = true;
					sLocal_2618 = "TOW_ILLEG1";
					if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
					{
						OPEN_SEQUENCE_TASK(&uLocal_421);
						TASK_GOTO_ENTITY_OFFSET(0, PLAYER_PED_ID(), 20000, 12f, 0f, 3f, 0);
						TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), 0);
						CLOSE_SEQUENCE_TASK(uLocal_421);
						TASK_PERFORM_SEQUENCE(Local_2996[0 /*20*/], uLocal_421);
						CLEAR_SEQUENCE_TASK(&uLocal_421);
		...
		case 2:
			if (bLocal_2965)
			{
				if (!bLocal_2973)
				{
					if (IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[0 /*20*/].f_6) || bLocal_2979)
					{
						if (!IS_MESSAGE_BEING_DISPLAYED())
						{
							if (!func_41())
			...
			if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
			{
				if (!IS_PED_IN_ANY_VEHICLE(Local_2996[0 /*20*/], 0))
				{
					if (bLocal_2966)
					{
						if (!func_41())
						{
							if (GET_SCRIPT_TASK_STATUS(Local_2996[0 /*20*/], 242628503) == 1)
							{
								if (GET_SEQUENCE_PROGRESS(Local_2996[0 /*20*/]) == 2)
								{
									if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
									{
										vVar1 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
									}
									if (VDIST2(vVar1, GET_ENTITY_COORDS(Local_2996[0 /*20*/], 1)) < 400f)
									{
										if ((Global_106565.f_19967.f_4 % 2) == 0)
										{
					...
					else if (!IS_ENTITY_DEAD(uLocal_3109, 0) && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
					{
						if (func_198() || (!IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[0 /*20*/].f_6) && !bLocal_2979))
						{
							func_166();
							iLocal_3118 = 5;
						}
						else if (!IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[0 /*20*/].f_6) && bLocal_2979)
						{
							if (bLocal_2973)
							{
								if (!func_41())
		...
		case 3:
			if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
			{
				if (func_112(Local_2996[0 /*20*/], PLAYER_PED_ID(), 1) < 12f)
				{
					CLEAR_PED_TASKS(Local_2996[0 /*20*/]);
					if (bLocal_2964)
					{
						TASK_COMBAT_PED(Local_2996[0 /*20*/], PLAYER_PED_ID(), 0, 16);
					}
					else if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
					{
						OPEN_SEQUENCE_TASK(&uLocal_421);
						TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), 0);
						TASK_PLAY_ANIM(0, "oddjobs@towingpleadingidle_a", "idle_c", -8f, 0.25f, 5000, 0, 0, 0, 0, 0);
						CLOSE_SEQUENCE_TASK(uLocal_421);
						TASK_PERFORM_SEQUENCE(Local_2996[0 /*20*/], uLocal_421);
						CLEAR_SEQUENCE_TASK(&uLocal_421);
					}
		...
		case 4:
			if (DOES_ENTITY_EXIST(Local_2996[0 /*20*/]))
			{
				...
				if (bLocal_2964)
				{
					SET_BLIP_COLOUR(Local_2996[0 /*20*/].f_9, 1);
					SET_BLIP_SCALE(Local_2996[0 /*20*/].f_9, 0.7f);
				}
				else
				{
		...
		case 5:
			if (!func_41())
			{
				...
				func_53(&uLocal_3097);
				if ((!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0) && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0)) && !IS_ENTITY_DEAD(uLocal_3109, 0))
				{
					if (IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[0 /*20*/].f_6))
					{
						TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, 0f, 0f, 0f, 3f, -1, 10f, 1);
					}
					else
					{
						if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
						...
						TASK_ENTER_VEHICLE(0, Local_2996[0 /*20*/].f_6, 20000, -1, 1073741824, 1, 0);
						TASK_VEHICLE_DRIVE_WANDER(0, Local_2996[0 /*20*/].f_6, 5f, 786597);
						CLOSE_SEQUENCE_TASK(uVar0);
						if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
						{
							TASK_PERFORM_SEQUENCE(Local_2996[0 /*20*/], uVar0);
						}
						CLEAR_SEQUENCE_TASK(&uVar0);
						bLocal_3137 = true;
					}
		...
		case 6:
			...
			if (!bLocal_2971)
			{
				if (!IS_ENTITY_DEAD(uLocal_3109, 0) && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
				{
					if (!IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[0 /*20*/].f_6))
					{
						if (bLocal_2965)
						{
							if (TIMERB() > 8000)
							{
								...
								{
									SET_VEHICLE_DOORS_LOCKED(Local_2996[0 /*20*/].f_6, 1);
									TASK_ENTER_VEHICLE(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, 20000, -1, 1073741824, 1, 0);
								}
								iLocal_3118 = 7;
							}
						}
					...
					else if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0) && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
					{
						if (TIMERB() > 7000)
						{
							if (!bLocal_2964)
							{
								if (IS_PED_IN_VEHICLE(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, 0))
								{
									if (!IS_ENTITY_DEAD(uLocal_3109, 0))
									{
										if (GET_ENTITY_SPEED(uLocal_3109) < 2f)
										{
											if (GET_SCRIPT_TASK_STATUS(Local_2996[0 /*20*/], -258271821) != 1)
											{
												TASK_VEHICLE_DRIVE_WANDER(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, 2f, 786597);
											}
										}
										else
										{
											CLEAR_SEQUENCE_TASK(&uVar0);
											OPEN_SEQUENCE_TASK(&uVar0);
											TASK_LEAVE_ANY_VEHICLE(0, 5000, 4096);
											TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 1000f, -1, 0, 0);
											CLOSE_SEQUENCE_TASK(uVar0);
											if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
											{
								...
								else if (!IS_ENTITY_DEAD(uLocal_3109, 0))
								{
									if (GET_ENTITY_SPEED(uLocal_3109) < 5f)
									{
										if (GET_SCRIPT_TASK_STATUS(Local_2996[0 /*20*/], -1794415470) != 1)
										{
											if (IS_VEHICLE_SEAT_FREE(Local_2996[0 /*20*/].f_6, -1, 0))
											{
												TASK_ENTER_VEHICLE(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, -1, -1, 1073741824, 1, 0);
											}
										}
									}
									else if (GET_SCRIPT_TASK_STATUS(Local_2996[0 /*20*/], 1056466932) != 1)
									{
										TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, 0f, 0f, 0f, 3f, -1, 10f, 1);
									}
								}
		...
		case 7:
			func_195(1);
			if (IS_PED_IN_ANY_VEHICLE(Local_2996[0 /*20*/], 0) && !IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[0 /*20*/].f_6))
			{
				if (bLocal_2964)
				{
				...
				bLocal_2957 = false;
				TASK_VEHICLE_DRIVE_WANDER(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, 5f, 786597);
				iLocal_3118 = 8;
				return 1;
			}
			break;
		...
		case 8:
			...
			if (DOES_BLIP_EXIST(Local_2996[0 /*20*/].f_9))
			{
				REMOVE_BLIP(&(Local_2996[0 /*20*/].f_9));
			}
			break;
	}
	return 0;
...
void func_195(bool bParam0)
{
	...
	if (bParam0)
	{
		if (!IS_ENTITY_DEAD(uLocal_3109, 0) && !IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
		{
			if (IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uLocal_3109, Local_2996[0 /*20*/].f_6) && !IS_PED_IN_VEHICLE(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_6, 0))
			{
				iVar0 = 1;
			}
		}
	...
	if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/], 0))
	{
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_2996[0 /*20*/], PLAYER_PED_ID(), 1) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(PLAYER_PED_ID(), Local_2996[0 /*20*/], 1))
		{
			func_53(&uLocal_3097);
			CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_2996[0 /*20*/]);
	...
	else if (((fVar1 > 35f || (func_4(&uLocal_3097) > 30f && fVar1 > 5f)) || iVar0) || (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && IS_PED_ARMED(PLAYER_PED_ID(), 6)))
	{
		if (bLocal_2964)
		{
			func_251(&Local_2348, 5, Local_2996[0 /*20*/], "TOWABDHANDMAN2", 0, 1);
...
void func_197(struct<165> Param0, char* sParam165, char* sParam166, bool bParam167)
{
	if (bParam167)
	{
		STOP_SCRIPTED_CONVERSATION(0);
...
int func_198()
{
	...
	{
		case 0:
			if (GET_SEQUENCE_PROGRESS(Local_2996[0 /*20*/]) >= 1 && !IS_MESSAGE_BEING_DISPLAYED())
			{
				iLocal_3121 = 1;
			}
			break;
		...
		case 1:
			if (bLocal_2973 && !iLocal_2974)
			{
				if (!func_41())
				{
					...
					if (iLocal_2975 && !IS_MESSAGE_BEING_DISPLAYED())
					{
						if (GET_SCRIPT_TASK_STATUS(Local_2996[0 /*20*/], -875674219) != 1)
						{
							TASK_TURN_PED_TO_FACE_ENTITY(Local_2996[0 /*20*/], Local_2996[0 /*20*/].f_1, 0);
						}
						iLocal_2974 = 1;
						iLocal_3121 = 2;
					}
...
int func_199(int iParam0, var uParam1, int iParam2)
{
	...
	while (iVar0 < 12)
	{
		if (vLocal_280[iVar0 /*3*/] == iParam0 && !DOES_BLIP_EXIST(vLocal_280[iVar0 /*3*/].f_1))
		{
		}
		iVar0++;
	}
...
void func_200(var uParam0)
{
	if (DOES_ENTITY_EXIST(uParam0))
	{
		if (!IS_ENTITY_DEAD(uParam0, 0))
		{
			...
			SET_PED_COMBAT_ATTRIBUTES(uParam0, 23, 0);
			SET_PED_COMBAT_MOVEMENT(uParam0, 2);
			GIVE_WEAPON_TO_PED(uParam0, joaat("weapon_microsmg"), 1000, 1, 1);
			SET_PED_SHOOT_RATE(uParam0, 500);
		}
	}
}
...
int func_202(var uParam0, var uParam1, bool bParam2)
{
	int iVar0;
	...
	iVar0 = 0;
	if (IS_PLAYER_PRESSING_HORN(GET_PLAYER_INDEX()) && func_111(uParam1, 1) < 40f)
	{
		iVar0 = 1;
	}
	if (IS_ENTITY_TOUCHING_ENTITY(uParam0, uParam1))
	{
		iVar0 = 1;
	}
	if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam1, PLAYER_PED_ID(), 1))
...
void func_204()
{
	...
	if (!iLocal_2946)
	{
		if (DOES_ENTITY_EXIST(Local_2996[0 /*20*/].f_6))
		{
			if (!IS_ENTITY_DEAD(Local_2996[0 /*20*/].f_6, 0))
			{
				vVar3 = { GET_ENTITY_COORDS(Local_2996[0 /*20*/].f_6, 1) };
			}
		}
		if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
		{
		...
		if (bLocal_2965)
		{
			if (VDIST2(vVar0, vVar3) < 25f)
			{
				...
				if (!func_41())
				{
					TASK_LOOK_AT_ENTITY(Local_2996[0 /*20*/], PLAYER_PED_ID(), 5000, 0, 2);
					func_251(&Local_2348, 5, Local_2996[0 /*20*/], "TOWSEXMANLYGUY", 0, 1);
...
int func_205(var uParam0, var uParam1)
{
	...
	if (func_111(uParam0, 0) < 15f)
	{
		fLocal_431 = 0.3f;
		fLocal_432 = 0.5f;
		fLocal_433 = 0.1f;
	}
	else if (func_111(uParam0, 0) < 40f)
	{
		fLocal_431 = 0.6f;
		fLocal_432 = 1f;
		fLocal_433 = 0.2f;
	}
	if (func_3(&uLocal_434, GET_RANDOM_FLOAT_IN_RANGE(fLocal_431, fLocal_432)))
	{
		func_53(&uLocal_434);
		APPLY_FORCE_TO_ENTITY(uParam0, 1, 0f, 0f, fLocal_433, -0.0067f, -0.8283f, -0.2766f, 0, 1, 1, 1, 1, 1);
	}
	return 1;
}
...
int func_208(var uParam0, var uParam1, struct<7> Param2, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, char* sParam24, var uParam25, bool bParam26, var uParam27)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
	...
	if (iLocal_2601 != 12)
	{
		func_212(Param2, uParam0, uParam1);
	}
	if (!bLocal_467)
	{
		if (iLocal_2601 >= 6 && iLocal_2601 <= 11)
		{
			if (bParam26)
			{
				if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
				{
					if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), 400.2854f, -1632.597f, 28.29278f, 5f, 5f, 2f, 1, 1, 0))
					{
					}
				}
			}
		...
		{
			case 0:
				if (func_116(uParam1, uParam0, &iLocal_2603, 10, 90f, 100f, 0))
				{
					SET_VEHICLE_TYRES_CAN_BURST(uParam1, 0);
			...
			case 2:
				...
				if (TIMERA() > 5000)
				{
					if (((TIMERA() > 12000 || func_112(uParam0, uParam1, 1) < 15f) && func_112(uParam0, uParam1, 1) < 30f) && !func_41())
					{
			...
			case 4:
				...
				{
					if ((TIMERA() > 12000 || func_112(uParam0, uParam1, 1) < 7.5f) || (iLocal_468 && func_112(uParam0, uParam1, 1) < 30f))
					{
						iLocal_443 = 1;
			...
			case 6:
				if ((!func_41() && !IS_MESSAGE_BEING_DISPLAYED()) && TIMERA() > 12000)
				{
					if (!iLocal_460)
					{
				...
				if (IS_ENTITY_IN_ANGLED_AREA(uParam0, Param2, Param2.f_3, Param2.f_6, 0, 0, 0))
				{
					func_165(&Local_2348, "TOWAUD", "TOW_TUT_INS4", 9, 0, 0, 0);
					if (DOES_BLIP_EXIST(*uParam22))
					{
						SET_BLIP_ROUTE(*uParam22, 0);
						REMOVE_BLIP(uParam22);
					}
					StringCopy(sParam24, "TOW_TUT_04A", 64);
					*(uParam23[0 /*3*/]) = { Param2.f_14 };
					fLocal_430 = func_9(Param2.f_14, 0);
					*uParam22 = ADD_BLIP_FOR_COORD(Param2.f_14);
					SETTIMERB(0);
					iLocal_2601 = 7;
				}
				break;
			...
			case 9:
				...
				if (!func_41())
				{
					if (IS_ENTITY_IN_ANGLED_AREA(uParam0, Param2, Param2.f_3, Param2.f_6, 0, 1, 0))
					{
						iLocal_470 = GET_GAME_TIMER();
						if (bLocal_444)
						{
							SET_BLIP_ROUTE(*uParam22, 0);
							REMOVE_BLIP(uParam22);
			...
			case 10:
				...
				if (IS_ENTITY_IN_ANGLED_AREA(uParam1, vVar0, vVar3, uVar6, 0, 1, 0))
				{
					func_98("TOWT_HELP_UH", -1);
					func_210();
					if (!IS_ENTITY_DEAD(uParam0, 0) && !IS_ENTITY_DEAD(uParam1, 0))
					{
						if (IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uParam0, uParam1))
						{
							iLocal_2601 = 11;
						}
					}
		...
		if (bParam26)
		{
			if (((DOES_ENTITY_EXIST(uParam0) && DOES_ENTITY_EXIST(uParam1)) && !IS_ENTITY_DEAD(uParam0, 0)) && !IS_ENTITY_DEAD(uParam1, 0))
			{
				if (IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uParam0, uParam1) && !bLocal_2602)
				{
					if (func_41())
					{
...
void func_212(struct<7> Param0, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
	
	if (!DOES_ENTITY_EXIST(uParam20) || !DOES_ENTITY_EXIST(uParam21))
	{
		return;
	}
	if (IS_ENTITY_DEAD(uParam20, 0) || IS_ENTITY_DEAD(uParam21, 0))
	{
		return;
	}
	...
	if (!iLocal_445)
	{
		if (IS_ENTITY_IN_ANGLED_AREA(uParam21, vVar0, vVar3, uVar6, 0, 1, 0))
		{
			if (!IS_ENTITY_DEAD(uParam20, 0) && !IS_ENTITY_DEAD(uParam21, 0))
			{
				if (!IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uParam20, uParam21))
				{
					CLEAR_HELP(1);
					CLEAR_PRINTS();
					iLocal_2601 = 12;
...
int func_213(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	int iVar0;
	
	if (DOES_ENTITY_EXIST(uParam1))
	{
		iVar0 = (*uParam2 - GET_ENTITY_HEALTH(uParam1));
	}
	if (fLocal_428 == 0f)
	{
	}
	if (iVar0 > 0)
	{
		if (DOES_ENTITY_EXIST(uParam1))
		{
			if (!IS_ENTITY_DEAD(uParam1, 0))
			{
				if ((IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uParam1, 0)) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam1, PLAYER_PED_ID(), 1))
				{
					*uParam3 = (*uParam3 + iVar0);
				}
				else if (DOES_ENTITY_EXIST(uParam1))
				{
					*uParam2 = GET_ENTITY_HEALTH(uParam1);
					iVar0 = 0;
				}
			}
		}
...
int func_214(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5)
{
	int iVar0;
	
	if (DOES_ENTITY_EXIST(uParam1))
	{
		iVar0 = (*uParam3 - GET_ENTITY_HEALTH(uParam1));
	}
	if (bParam5)
	{
		if (iVar0 > 0)
		{
			if (DOES_ENTITY_EXIST(uParam1) && DOES_ENTITY_EXIST(uParam2))
			{
				if (!IS_ENTITY_DEAD(uParam1, 0) && !IS_ENTITY_DEAD(uParam2, 0))
				{
					if ((IS_ENTITY_TOUCHING_ENTITY(uParam1, uParam2) || IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uParam2, uParam1)) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam1, PLAYER_PED_ID(), 1))
					{
						*uParam4 = (*uParam4 + iVar0);
					}
					else if (DOES_ENTITY_EXIST(uParam1))
					{
						*uParam3 = GET_ENTITY_HEALTH(uParam1);
						iVar0 = 0;
					}
				}
			}
...
void func_217(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, var uParam5, int iParam6, bool bParam7, var uParam8, bool bParam9, var uParam10, bool bParam11, int iParam12, bool bParam13)
{
	int iVar0;
	...
	if (bParam11)
	{
		...
		*uParam5 = GET_GAME_TIMER();
		bLocal_467 = !func_218(uParam0);
		return;
	}
	else if (!DOES_BLIP_EXIST(*uParam1) && bLocal_467)
	{
	...
	if (!bParam9)
	{
		if (!bLocal_467)
		{
			if (!func_218(uParam0))
			{
				...
				*uParam5 = GET_GAME_TIMER();
				...
				while (iVar0 < 1)
				{
					if (DOES_BLIP_EXIST((uParam2[iVar0 /*20*/])->f_8))
					{
						SET_BLIP_ROUTE((uParam2[iVar0 /*20*/])->f_8, 0);
						REMOVE_BLIP(&((uParam2[iVar0 /*20*/])->f_8));
						*uParam8 = 0;
					}
					iVar0++;
				}
				if (DOES_BLIP_EXIST((uParam2[0 /*20*/])->f_9))
				{
					REMOVE_BLIP(&((uParam2[0 /*20*/])->f_9));
				}
				bLocal_467 = true;
			}
		}
		else if (func_218(uParam0))
		{
			...
			if (!IS_PED_INJURED((*uParam2)[0 /*20*/]))
			{
				if (!IS_PED_IN_VEHICLE((*uParam2)[0 /*20*/], *uParam0, 0) && !IS_PED_IN_VEHICLE((*uParam2)[0 /*20*/], (uParam2[iParam6 /*20*/])->f_6, 0))
				{
					if (!DOES_BLIP_EXIST((uParam2[0 /*20*/])->f_9))
					{
						(uParam2[0 /*20*/])->f_9 = ADD_BLIP_FOR_ENTITY((*uParam2)[iVar0 /*20*/]);
						SET_BLIP_COLOUR((uParam2[0 /*20*/])->f_9, 3);
						SET_BLIP_SCALE((uParam2[0 /*20*/])->f_9, 0.7f);
					}
				}
			}
			if (iLocal_441)
			...
			{
				if (!DOES_BLIP_EXIST((uParam2[0 /*20*/])->f_8))
				{
					(uParam2[0 /*20*/])->f_8 = ADD_BLIP_FOR_COORD(*(uParam3[0 /*3*/]));
					SET_BLIP_ROUTE((uParam2[0 /*20*/])->f_8, 1);
				}
			}
			else if (bParam7)
			{
				if (!IS_ENTITY_DEAD((uParam2[iParam6 /*20*/])->f_6, 0))
				{
					if (!DOES_BLIP_EXIST((uParam2[iParam6 /*20*/])->f_8))
					{
						(uParam2[iParam6 /*20*/])->f_8 = ADD_BLIP_FOR_ENTITY((uParam2[iParam6 /*20*/])->f_6);
						SET_BLIP_COLOUR((uParam2[iParam6 /*20*/])->f_8, 3);
						SET_BLIP_ROUTE((uParam2[0 /*20*/])->f_8, 1);
					}
				}
				else
				{
					...
					if (!DOES_BLIP_EXIST((uParam2[0 /*20*/])->f_8))
					{
						(uParam2[0 /*20*/])->f_8 = ADD_BLIP_FOR_COORD(Local_650[iLocal_2604 /*23*/].f_1);
						SET_BLIP_COLOUR((uParam2[0 /*20*/])->f_8, 3);
						SET_BLIP_ROUTE((uParam2[0 /*20*/])->f_8, 1);
					}
				}
			}
			else
			{
				...
				while (iVar0 < 1)
				{
					if (!IS_ENTITY_DEAD((uParam2[iVar0 /*20*/])->f_6, 0))
					{
						if (!DOES_BLIP_EXIST((uParam2[iVar0 /*20*/])->f_8))
						{
							(uParam2[iVar0 /*20*/])->f_8 = ADD_BLIP_FOR_ENTITY((uParam2[iVar0 /*20*/])->f_6);
							SET_BLIP_COLOUR((uParam2[iVar0 /*20*/])->f_8, 3);
							SET_BLIP_ROUTE((uParam2[iVar0 /*20*/])->f_8, 1);
						}
					}
					else
					{
...
void func_225(var uParam0)
{
	...
	{
		cLocal_2619 = "REACTION@MALE_STAND@BIG_VARIATIONS@A";
		func_245(&uLocal_2648, cLocal_2619);
	...
	SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("towtruck"), 1);
	if (uParam0->f_3 == 1)
	{
		REQUEST_PTFX_ASSET();
		func_245(&uLocal_2648, "oddjobs@towing");
	...
	while (iVar0 < 1)
	{
		if (iLocal_2987[iVar0] == 0)
		{
			...
			REQUEST_VEHICLE_ASSET(iLocal_2987[iVar0], 3);
		}
		if (bLocal_2965)
		{
	...
	while (!HAS_SCALEFORM_MOVIE_LOADED(uLocal_2608))
	{
		func_220(&uLocal_2656);
		WAIT(0);
	}
	while (!func_230(&uLocal_2638) || !HAS_VEHICLE_ASSET_LOADED(iLocal_2987[0]))
	{
		func_220(&uLocal_2656);
		WAIT(0);
	}
	...
	if (uParam0->f_3 == 1)
	{
		while (!REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\TOWING_TRAIN", 0, -1) || !HAS_PTFX_ASSET_LOADED())
		{
			func_220(&uLocal_2656);
			WAIT(0);
		}
...
var func_239(var uParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	iVar1 = GET_RANDOM_INT_IN_RANGE(0, (iParam2 - 1));
...
int func_256(float fParam0, int iParam1, int iParam2)
{
	...
	if (iVar57 > 1)
	{
		iVar1 = iVar3[GET_RANDOM_INT_IN_RANGE(0, (iVar57 - 1))];
	}
	else if (iVar57 == 1)
	{
		iVar1 = iVar3[0];
...
int func_266(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_277())
	{
		...
		{
			iVar33 = func_267(GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
