...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != 4294967295)
		{
			if (Global_19AC5[Var0 /*10*/].f_9 != 4294967295)
			{
				...
				func_270(&(Global_19AC5[Var0 /*10*/].f_9));
			}
		}
		func_258(&Var0, 1);
	}
	...
	while (true)
	{
		...
		if (Var0 == 25)
		{
			...
			{
				PED::SET_PED_MAX_MOVE_BLEND_RATIO(AUDIO::_0x0626A247D2405330(), 3f);
			}
		}
...
void func_47(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x378D
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x392D
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x395F
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x3993
{
	return Global_1407E0;
}

int func_51(int iParam0, int iParam1)//Position - 0x399F
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x39CB
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F13
{
	int iVar0;
...
int func_54()//Position - 0x4156
{
	func_55();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_55()//Position - 0x416F
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x426C
{
	return Global_8D15 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x427A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x436D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x45F7
{
	switch (iParam0)
	{
		case 3036451504:
...
int func_60(int iParam0)//Position - 0x4692
{
...
int func_61(int iParam0, int iParam1)//Position - 0x4818
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x5389
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x53C4
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x5638
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x5674
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_66(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x5BCF
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5C13
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x62F2
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x6339
{
...
bool func_70(int iParam0)//Position - 0x6394
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x63A4
{
...
int func_72(int iParam0)//Position - 0x640E
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x6711
{
	return Global_6373;
}

int func_74(int iParam0)//Position - 0x671C
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x672C
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x67CE
{
	switch (iParam0)
	{
		case 4294967295:
...
int func_77(int iParam0)//Position - 0x6DA3
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6E01
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6EAF
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6F44
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6F88
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x710C
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x711A
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7BE1
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7C63
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7CC1
{
	return 4294967295;
}

Vector3 func_87(int iParam0)//Position - 0x7CCA
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x7ED5
{
	return func_89(CAM::_0xDC9DA9E8789F5246());
}

int func_89(int iParam0)//Position - 0x7EE5
{
	return MISC::GET_BITS_IN_RANGE(Global_24FBF9[iParam0 /*413*/].f_135.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x7F02
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x7F12
{
	switch (iParam0)
	{
		case 4294967295:
...
int func_167(int iParam0, int iParam1)//Position - 0xB448
{
	switch (iParam0->f_10)
	{
		case 0:
...
int func_182(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xC603
{
	var uVar0;
	
	if ((((func_126(AUDIO::_0x0626A247D2405330()) && func_126(iParam0->f_1C[0])) && !func_145()) && (MISC::GET_GAME_TIMER() - iParam0->f_3C) > iParam6) && func_186(AUDIO::_0x0626A247D2405330(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_185(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
...
void func_183(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC68B
{
...
void func_184(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC6C6
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
void func_185(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC71C
{
...
float func_186(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xC7B7
{
	vector3 vVar0;
...
void func_187(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xC7F1
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_186(AUDIO::_0x0626A247D2405330(), vParam2, 1) <= 100f)
				{
					func_190(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_186(AUDIO::_0x0626A247D2405330(), vParam2, 1) > 120f)
				{
					func_192(iParam0);
				}
			}
...
void func_188(int iParam0, bool bParam1)//Position - 0xC8E2
{
	if (iParam0 == 4294967295)
	{
		return;
...
int func_189(int iParam0)//Position - 0xC91E
{
	if (Global_11621 == iParam0)
	{
...
void func_190(int iParam0, int iParam1)//Position - 0xC957
{
	bool bVar0;
	int iVar1;
...
bool func_191()//Position - 0xC9F5
{
	return Global_1620C;
}

void func_192(int iParam0)//Position - 0xCA01
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_193(iParam0);
...
void func_193(int iParam0)//Position - 0xCA18
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_194(int iParam0)//Position - 0xCB00
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_164();
...
int func_195(int iParam0, bool bParam1)//Position - 0xCB28
{
	struct<27> Var0;
	...
	func_109(*iParam0, &Var0);
	if ((func_232(*iParam0) || func_230(*iParam0)) || Global_1171A == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_199(&(iParam0->f_30)) && bParam1)
	{
		func_196(iParam0->f_1C[0], &(iParam0->f_30), *iParam0);
	}
	return 1;
}

void func_196(int iParam0, var uParam1, int iParam2)//Position - 0xCD9B
{
	int iVar0;
	int iVar1;
	...
	if (func_126(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				...
				{
					if (func_197(iParam2) && !PED::IS_PED_FACING_PED(iParam0, AUDIO::_0x0626A247D2405330(), 25f))
					{
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, AUDIO::_0x0626A247D2405330(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_198(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_197(iParam2) || PED::IS_PED_FACING_PED(iParam0, AUDIO::_0x0626A247D2405330(), 10f))
				{
					if (func_68(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						BRAIN::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, 4294967295, 262153, 0, 0, 0, 0);
...
int func_197(int iParam0)//Position - 0xD0F3
{
...
int func_198(var uParam0)//Position - 0xD113
{
...
int func_199(var uParam0)//Position - 0xD12B
{
...
void func_200(var uParam0)//Position - 0xD150
{
	int iVar0;
	int iVar1;
	...
	if (*uParam0 == 52)
	{
		func_201(&(uParam0->f_29[1]));
		func_201(&(uParam0->f_29[2]));
	}
...
void func_201(int iParam0)//Position - 0xD454
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_202(var uParam0)//Position - 0xD47F
{
	int iVar0;
...
int func_203(var uParam0, bool bParam1, bool bParam2)//Position - 0xD4FF
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_204(AUDIO::_0x0626A247D2405330(), uParam0->f_23[iVar0]))
							{
...
int func_204(int iParam0, int iParam1)//Position - 0xD6BD
{
	int iVar0;
...
int func_205(var uParam0, bool bParam1, int iParam2)//Position - 0xD6ED
{
	int iVar0;
	int iVar1;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_1C[iVar0]))
				{
					...
					if (func_224(*uParam0))
					{
						if (!func_156(*uParam0))
						{
							if (func_219(uParam0->f_1C[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_200(uParam0);
						...
						if (func_207(uParam0->f_1C[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_200(uParam0);
...
int func_206(int iParam0)//Position - 0xD9A9
{
...
int func_207(int iParam0, float fParam1)//Position - 0xD9DD
{
	float fVar0;
	
	if (func_126(AUDIO::_0x0626A247D2405330()) && func_126(iParam0))
	{
		if (func_218(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iParam0))
		{
...
bool func_208(int iParam0, float fParam1)//Position - 0xDA53
{
	return func_209(iParam0, AUDIO::_0x0626A247D2405330(), fParam1, 1, 250, 7);
}

bool func_209(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDA6B
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_210(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xDB2C
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_211(int iParam0, int iParam1)//Position - 0xDC58
{
	int iVar0;
...
int func_213(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xDD67
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_215(unk_0x8000C77B5F336760(iParam1, true) - unk_0x8000C77B5F336760(iParam0, true)) };
...
float func_214(vector3 vParam0, vector3 vParam1)//Position - 0xDDF8
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_215(vector3 vParam0)//Position - 0xDE19
{
	float fVar0;
	float fVar1;
...
void func_216(var uParam0)//Position - 0xDE58
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_217(int iParam0, int iParam1)//Position - 0xDE73
{
	int iVar0;
...
int func_218(int iParam0)//Position - 0xDEB2
{
...
int func_219(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xDEDA
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_220(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xDFD5
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_221(int iParam0, float fParam1)//Position - 0xE0E1
{
	var uVar0;
	vector3 vVar1;
...
int func_222(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xE176
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_215(vParam1 - unk_0x8000C77B5F336760(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_223(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE204
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
...
int func_224(int iParam0)//Position - 0xE24C
{
...
void func_225(int iParam0)//Position - 0xE296
{
	int iVar0;
...
int func_226(int iParam0)//Position - 0xE333
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_164();
...
int func_227(int iParam0)//Position - 0xE3CB
{
...
int func_230(int iParam0)//Position - 0xE44D
{
	if ((func_231() && Global_16C30.f_B == 6) && iParam0 == func_165(&(Global_16C30.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_232(int iParam0)//Position - 0xE4BF
{
	if (func_107(0))
	{
...
int func_233(int iParam0)//Position - 0xE4E7
{
	switch (*iParam0)
	{
		case 25:
...
int func_234(var uParam0)//Position - 0xE52E
{
	int iVar0[5];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			{
				if (func_238(&(uParam0->f_1C[0]), 54, -683.3276f, 5841.042f, 17.217f, 8.33f, "RC HUNTER 2", 1))
				{
			...
			{
				func_235(&(uParam0->f_23[0]), -685.2281f, 5833.982f, 16.331f, 313.2204f, 0);
			}
...
void func_235(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xE763
{
...
void func_236(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE7C9
{
	func_237(iParam0);
...
void func_237(int iParam0)//Position - 0xE80B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_238(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xE8A7
{
...
int func_239(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xE903
{
	int iVar0;
...
int func_240(var uParam0, int iParam1)//Position - 0xE991
{
	int iVar0;
...
int func_241(int iParam0)//Position - 0xE9D7
{
	int iVar0;
...
int func_242(var uParam0)//Position - 0xEA08
{
	int iVar0[2];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_244(&(uParam0->f_30), "special_ped@cletus@base", "cletus_base", 0);
			STREAMING::REQUEST_ANIM_DICT("special_ped@cletus@base");
			iLocal_51 = 1;
			break;
		
		case 1:
			if ((!func_241(&iVar0) || !func_243(&(uParam0->f_30))) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (func_238(&(uParam0->f_1C[0]), 54, 1804.33f, 3931.33f, 33.83f, 91.63f, "RC HUNTER 1", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				func_235(&(uParam0->f_23[0]), 1806.732f, 3934.353f, 33.3275f, 76.1155f, 0);
...
int func_243(var uParam0)//Position - 0xECBD
{
	if (func_199(uParam0))
	{
...
void func_244(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xECE7
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_245(int iParam0)//Position - 0xED23
{
	struct<27> Var0;
	int iVar1;
...
int func_247(int iParam0)//Position - 0xEE30
{
	var uVar0;
...
int func_248(int iParam0)//Position - 0xEEF1
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_249(int iParam0, char* sParam1)//Position - 0xEF76
{
...
bool func_250(int iParam0)//Position - 0xF058
{
...
bool func_251(int iParam0)//Position - 0xF086
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
bool func_252(int iParam0)//Position - 0xF0B4
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
int func_253(int iParam0)//Position - 0xF0E2
{
	if (func_227(iParam0))
	{
		return 0;
...
void func_254()//Position - 0xF117
{
	func_271("Running end routines.");
	Global_19D3C = (Global_19D3C - 1);
}

int func_255(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF131
{
	int iVar0;
...
int func_256(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xF196
{
	int iVar0;
	struct<7> Var1;
...
int func_257(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xF214
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_258(int iParam0, bool bParam1)//Position - 0xF28F
{
	if (bParam1)
	{
...
void func_259(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xF2DC
{
...
void func_260(var uParam0, bool bParam1)//Position - 0xF2FC
{
	func_261(&(uParam0->f_29), bParam1);
}

void func_261(var uParam0, bool bParam1)//Position - 0xF30E
{
	int iVar0;
...
void func_262(int iParam0, bool bParam1)//Position - 0xF34C
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_263(var uParam0, bool bParam1)//Position - 0xF387
{
	func_264(&(uParam0->f_23), bParam1);
}

void func_264(var uParam0, bool bParam1)//Position - 0xF399
{
	int iVar0;
...
void func_265(int iParam0)//Position - 0xF3D6
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_266(var uParam0, int iParam1)//Position - 0xF40E
{
	func_267(&(uParam0->f_1C), iParam1);
}

void func_267(var uParam0, int iParam1)//Position - 0xF420
{
	int iVar0;
...
void func_268(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF461
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_269(int iParam0)//Position - 0xF4B1
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_270(var uParam0)//Position - 0xF4F2
{
	if (*uParam0 == 4294967295)
	{
		return;
...
void func_271(char* sParam0)//Position - 0xF52F
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_272(var uParam0)//Position - 0xF541
{
	*uParam0 = 4294967295;
...
void func_273()//Position - 0xF574
{
	func_271("Running start routines.");
	Global_19D3C++;
}

int func_274(int iParam0)//Position - 0xF58E
{
	if (!func_36(iParam0))
	{
		return Global_19E56.f_6D76[iParam0 /*29*/];
