...
void __EntryFunction__()
{
	...
	if (NETWORK_IS_GAME_IN_PROGRESS() && func_272(PLAYER_ID(), 0, 1))
	{
	...
	while (true)
	{
		...
		switch (func_244(PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (func_243() == 1)
				{
					func_242();
					Local_123[PARTICIPANT_ID_TO_INT() /*4*/] = 1;
				}
				else if (func_243() == 4)
				{
					Local_123[PARTICIPANT_ID_TO_INT() /*4*/] = 3;
				}
				break;
			...
			case 3:
				...
				{
					Local_123[PARTICIPANT_ID_TO_INT() /*4*/] = 4;
				}
				break;
...
void func_11()
{
	...
	if (Local_103 == 1)
	{
		if (NETWORK_IS_PARTICIPANT_ACTIVE(INT_TO_PARTICIPANTINDEX(iLocal_258)))
		{
			iVar0 = NETWORK_GET_PLAYER_INDEX(INT_TO_PARTICIPANTINDEX(iLocal_258));
			if (func_272(iVar0, 1, 1))
			{
				if (!IS_BIT_SET(Local_103.f_1, 0))
				{
					if (IS_BIT_SET(Local_123[iLocal_258 /*4*/].f_1, 0))
					{
						iLocal_259 = 1;
	...
	iLocal_258++;
	if (iLocal_258 == _NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (iLocal_259 == 0)
		{
			if (IS_BIT_SET(Local_103.f_1, 0))
...
void func_14()
{
	...
	if (!IS_BIT_SET(uLocal_252, 1))
	{
		if ((IS_BIT_SET(Local_123[PARTICIPANT_ID_TO_INT() /*4*/].f_1, 0) && GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) >= (Local_103.f_16 - 1)) && Local_123[PARTICIPANT_ID_TO_INT() /*4*/].f_2 < 10)
		{
			Local_123[PARTICIPANT_ID_TO_INT() /*4*/].f_2++;
		}
		if (Local_123[PARTICIPANT_ID_TO_INT() /*4*/].f_2 > 0)
		{
			iVar0 = (Local_123[PARTICIPANT_ID_TO_INT() /*4*/].f_2 * Global_262145.f_7992);
			...
			if (iVar0 > 0)
			{
				...
				{
					_NETWORK_EARN_FROM_AMBIENT_JOB(iVar0, "AM_DISTRACT_COPS", &uVar1);
				}
			}
			if (func_88())
			{
			...
			if (IS_BIT_SET(uLocal_252, 4))
			{
				if (!IS_BIT_SET(uLocal_252, 5))
				{
					func_15(66, 1, -1);
				}
			}
		}
		SET_BIT(&uLocal_252, 1);
	}
}
...
void func_28(var uParam0)
{
	...
	if (!Global_71858)
	{
		if (!IS_PLAYER_DEAD(GET_PLAYER_INDEX()))
		{
			if (!Global_71859)
			{
				if (IS_SCREEN_FADED_OUT() && !func_30(0))
				{
...
int func_39(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((func_69(PLAYER_ID()) || (func_68() && func_67())) && !IS_BIT_SET(Global_2528542.f_4582, 31)) && !bParam4)
	{
		uVar1 = func_66();
		if (DOES_ENTITY_EXIST(uVar1))
		{
			if (IS_PED_A_PLAYER(uVar1))
			{
				...
				{
					if (func_272(NETWORK_GET_PLAYER_INDEX_FROM_PED(uVar1), 0, 1))
					{
						if ((iParam1 > -1 && NETWORK_IS_ACTIVITY_SESSION()) && iParam1 < 4)
						{
							...
							{
								return func_52(iParam0, NETWORK_GET_PLAYER_INDEX_FROM_PED(uVar1), iParam1, bParam2, bParam3);
							}
						}
						else
						{
	...
	if ((iParam1 > -1 && NETWORK_IS_ACTIVITY_SESSION()) && iParam1 < 4)
	{
		...
		{
			return func_52(iParam0, PLAYER_ID(), iParam1, bParam2, bParam3);
		}
	}
	return func_52(iParam0, PLAYER_ID(), iParam1, bParam2, bParam3);
}
...
{
	return func_41(PLAYER_ID(), bParam0, iParam1, bParam2);
}
...
int func_41(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if (bParam1)
	{
		if (iParam2 > -1)
		{
			if (func_46(iVar0, iParam2, 0) && !IS_BIT_SET(Global_4456448.f_15, 18))
			{
				if (iVar0 == iParam2)
				{
					return func_45(1);
...
int func_51()
{
	if (func_49() && NETWORK_IS_ACTIVITY_SESSION())
	{
		return 1;
	}
	return 0;
...
int func_52(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar1)
	{
		if (iVar0 != -1)
		{
			...
			if ((func_54(iParam1, iParam0, iVar0, 0) && !IS_BIT_SET(Global_4456448.f_15, 18)) || ((func_46(GET_PLAYER_TEAM(iParam1), GET_PLAYER_TEAM(iParam0), 0) && IS_BIT_SET(Global_4456448.f_15, 23)) && !IS_BIT_SET(Global_4456448.f_15, 18)))
			{
				return func_45(1);
			}
...
int func_64(int iParam0, int iParam1, bool bParam2)
{
	...
	if (iParam0 > -1 && iParam1 != func_73())
	{
		...
		if (IS_BIT_SET(Global_4456448.f_15, 26) && !func_46(iParam0, GET_PLAYER_TEAM(iParam1), 0))
		{
			iVar0 = func_53(1);
		}
	}
	...
	if (*iParam0 > 0)
	{
		if (!func_126())
		{
			if (func_125(0))
			{
				if (!func_121(0))
				{
					if (NETWORK_IS_PLAYER_ACTIVE(func_120()))
					{
						if (func_119() == 100)
						{
							iVar0 = *iParam0;
...
void func_106(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_272(iParam0, 0, 1))
	{
		...
		_0xA40CC53DF8E50837(1, &Var0, 8, func_100(iParam0));
	}
}
...
int func_110(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	...
	if (_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER_ID(), iParam1) || iParam5)
	{
		...
		_SET_NOTIFICATION_COLOR_NEXT(func_39(iParam1, -2, 1, 0, 0));
		ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(func_115(&Var1));
		if (!iParam3 == 0)
		{
...
void func_111(int iParam0, char* sParam1, int iParam2, char* sParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	...
	if ((!func_114() || !NETWORK_IS_ACTIVITY_SESSION()) || !func_71(PLAYER_ID(), 0))
	{
		return;
	}
...
{
	return func_122(PLAYER_ID(), bParam0);
}
...
{
	return func_59(PLAYER_ID(), bParam0);
}
...
{
	func_240();
	if (DOES_BLIP_EXIST(uLocal_253))
	{
		if (func_238() || func_237())
		{
			SET_BLIP_DISPLAY(uLocal_253, 0);
		}
		else
		{
			SET_BLIP_DISPLAY(uLocal_253, 4);
		}
	}
	switch (Local_123[PARTICIPANT_ID_TO_INT() /*4*/].f_3)
	{
		case 0:
			if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), Local_103.f_2, Local_103.f_5, Local_103.f_5, 1000f, 0, 1, 0))
			{
				func_215();
				SET_BIT(&(Local_123[PARTICIPANT_ID_TO_INT() /*4*/].f_1), 0);
				SET_BIT(&(Global_2528542.f_4583), 0);
				Local_123[PARTICIPANT_ID_TO_INT() /*4*/].f_3 = 1;
			}
			if (Local_103.f_7 > 1)
			{
				Local_123[PARTICIPANT_ID_TO_INT() /*4*/].f_3 = 2;
			}
			break;
...
void func_129()
{
	if (!IS_BIT_SET(uLocal_252, 5))
	{
		if (!IS_BIT_SET(uLocal_252, 4))
		{
			if (Local_103.f_17 == 0)
			{
				SET_BIT(&uLocal_252, 4);
			}
			else
			{
				SET_BIT(&uLocal_252, 5);
			}
		}
		else if (!func_272(PLAYER_ID(), 1, 1))
		{
			SET_BIT(&uLocal_252, 5);
		}
	}
...
void func_137()
{
	if (func_9(&uLocal_254, 30000, 0))
	{
		...
		func_138(0, PLAYER_PED_ID(), "XPT_DSC", -1636175450, 2048546661, (Global_262145.f_7993 * Local_103.f_16), 1, -1, 0, 0, 0);
		Local_123[PARTICIPANT_ID_TO_INT() /*4*/].f_2++;
		func_5(&uLocal_254);
	}
}
	...
	if (iParam4 == -592022605 || iParam4 == -1915191729)
	{
		if (DOES_ENTITY_EXIST(iParam1))
		{
			if (IS_ENTITY_A_PED(iParam1))
			{
				...
				func_144(GET_PED_BONE_COORDS(uVar1, 31086, 0f, 0f, 0f), iVar0, 0, sParam8, iParam10);
			}
		}
	}
	else
...
int func_149(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	if (func_188(PLAYER_ID()) || func_187(PLAYER_ID()))
	{
	...
	else if (func_185() || func_181(PLAYER_ID()))
	{
	...
	if (func_179())
	{
		...
		if (bParam7)
		{
			...
			if (iParam1 == 0)
			{
				func_160((func_169(PLAYER_ID()) + iVar1), iParam9, 0);
				if (iParam8 == 0)
				{
				}
				if (iParam9 == 0)
...
void func_160(int iParam0, int iParam1, int iParam2)
{
	if (func_179())
	{
		...
		if (func_168(PLAYER_ID()))
		{
			...
			Global_1589819[PLAYER_ID() /*818*/].f_211.f_6 = func_166(iParam0, 1);
		}
...
void func_170(int iParam0)
{
	...
	while (iVar0 < _NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		...
		if (NETWORK_IS_PARTICIPANT_ACTIVE(uVar4))
		{
			...
			{
				if (GET_PLAYER_TEAM(iVar5) == iVar1 || func_46(GET_PLAYER_TEAM(iVar5), iVar1, 0))
				{
					iVar2++;
					if (iVar5 != PLAYER_ID())
					{
						if (func_172(PLAYER_ID(), iVar5))
						{
							bVar3 = true;
						}
					}
...
int func_177(int iParam0)
{
	...
	{
		if (func_178(8000, 0, 0) < (iParam0 + func_169(PLAYER_ID())))
		{
			iParam0 = (func_178(8000, 0, 0) - func_169(PLAYER_ID()));
		}
	}
	return iParam0;
}
...
void func_192()
{
	...
	{
		if (GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) < Local_103.f_16)
		{
			SET_PLAYER_WANTED_LEVEL(PLAYER_ID(), Local_103.f_16, 0);
...
void func_193()
{
	...
	{
		func_196();
		Local_123[PARTICIPANT_ID_TO_INT() /*4*/].f_3 = 0;
	}
	else if (!IS_ENTITY_AT_COORD(PLAYER_PED_ID(), Local_103.f_2, Local_103.f_6, Local_103.f_6, 950f, 0, 1, 0))
	{
		if (!IS_BIT_SET(uLocal_252, 0) && IS_BIT_SET(uLocal_252, 3))
		{
			if (!IS_HELP_MESSAGE_BEING_DISPLAYED() && !func_195())
			{
				if (!func_238())
				{
					func_194("DCP_LEAVE", -1);
				}
				SET_BIT(&uLocal_252, 0);
			}
		}
	}
	else
	{
		if (!IS_BIT_SET(uLocal_252, 3))
		{
			SET_BIT(&uLocal_252, 3);
		}
		if (IS_BIT_SET(uLocal_252, 0))
		{
			CLEAR_BIT(&uLocal_252, 0);
		}
	}
}
...
void func_196()
{
	...
	func_5(&uLocal_256);
	func_197();
	CLEAR_BIT(&(Local_123[PARTICIPANT_ID_TO_INT() /*4*/].f_1), 0);
	CLEAR_BIT(&uLocal_252, 3);
	SET_BIT(&(Global_2528542.f_4583), 0);
	if (!IS_BIT_SET(uLocal_252, 5))
	{
		SET_BIT(&uLocal_252, 5);
...
void func_197()
{
	if (IS_BIT_SET(uLocal_252, 2))
	{
		func_198(1, 1, 0);
		CLEAR_BIT(&uLocal_252, 2);
	}
}
...
void func_205(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	{
		if (IS_BIT_SET(Global_2424047[Global_2437364.f_1893.f_690.f_16 /*416*/].f_402, 0) && func_206())
		{
			iParam0 = 23;
		}
	}
...
int func_206()
{
	if (((((func_183(PLAYER_ID()) == 229 || func_183(PLAYER_ID()) == 191) || func_209()) || func_208()) || func_207(PLAYER_ID())) || Global_2506344.f_173 == 1)
	{
		return 0;
	}
	return 1;
...
void func_218(vector3 vParam0, vector3 vParam3, var uParam6, int iParam7, int iParam8, var uParam9)
{
	...
	if (func_227(PLAYER_ID()) || uParam9)
	{
		...
		if (func_221(Var0))
		{
			Global_2405071.f_45.f_64 = func_220(PLAYER_ID());
...
void func_240()
{
	if (!IS_BIT_SET(uLocal_252, 6))
	{
		if (((((((func_241(60000) && func_243() == 1) && Local_103.f_7 <= 1) && !IS_HELP_MESSAGE_BEING_DISPLAYED()) && !IS_PAUSE_MENU_ACTIVE()) && func_272(PLAYER_ID(), 1, 1)) && !func_195()) && Local_103.f_16 != 5)
		{
			if (!func_238())
			{
				func_194("DCP_HELP1", -1);
			}
			SET_BIT(&uLocal_252, 6);
		}
	}
}
...
void func_242()
{
	...
	{
		uLocal_253 = ADD_BLIP_FOR_RADIUS(Local_103.f_2, Local_103.f_5);
		SET_BLIP_COLOUR(uLocal_253, 50);
		SET_BLIP_ALPHA(uLocal_253, 220);
		_0x75A16C3DA34F1245(uLocal_253, 0);
		SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_253, "DCP_BLIPN");
		if (func_238())
		{
			SET_BLIP_DISPLAY(uLocal_253, 0);
		}
...
int func_247(int iParam0)
{
	...
	while (iVar0 < 32)
	{
		if (func_272(INT_TO_PLAYERINDEX(iVar0), 0, 1))
		{
...
int func_249()
{
	...
	if (func_250() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_250()) == 0)
		{
			return 1;
		}
	}
...
void func_264(struct<21> Param0)
{
	...
	func_268(0, -1, 0);
	NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_103, 20);
	NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&Local_123, 129);
	if (!func_267())
	{
		func_261();
	}
	if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		func_263(16, 1);
		Local_123[PARTICIPANT_ID_TO_INT() /*4*/] = 0;
	}
	else
	{
		func_261();
