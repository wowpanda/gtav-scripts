	...
	switch (iLocal_6209)
	{
		...
		case 1:
			if (!HAS_CUTSCENE_FINISHED())
			{
				...
				SET_TEXT_RENDER_ID(uLocal_6203);
				DRAW_SCALEFORM_MOVIE(uLocal_6201, 0.2f, 0.34f, 0.410001f, 0.69f, 100, 100, 100, 255, 0);
				SET_TEXT_RENDER_ID(uLocal_6204);
				if (bLocal_6205)
				{
					BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_6202, "SET_TEXT");
					func_3("KEYNOTE_NAME");
					func_3("KEYNOTE_TITLE");
					END_SCALEFORM_MOVIE_METHOD();
					DRAW_SCALEFORM_MOVIE(uLocal_6202, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
				}
			}
			else
			{
...
void func_4()
{
	...
	while (iVar1 <= (16 - 1))
	{
		if (Local_24[iVar1] != -1)
		{
			if ((!IS_BIT_SET(uLocal_58, iVar1) && iVar0 >= Local_24[iVar1]) && iVar0 < Local_24.f_17[iVar1])
			{
				func_5();
				SET_BIT(&uLocal_58, iVar1);
			}
		}
		iVar1++;
	}
...
void func_18(bool bParam0)
{
	...
	{
		SET_ENTITY_COORDS(PLAYER_PED_ID(), 689.1f, 586.5f, 130.5f, 1, 0, 0, 1);
	...
	uLocal_6203 = GET_NAMED_RENDERTARGET_RENDER_ID("Big_Disp");
	uLocal_6204 = GET_DEFAULT_SCRIPT_RENDERTARGET_RENDER_ID();
...
void func_42()
{
	...
	REMOVE_IPL("LInvader");
	SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_6201);
	SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_6202);
...
void func_46(var uParam0)
{
	...
	{
		if (DOES_ENTITY_EXIST(uParam0->f_17[iVar0]) && !IS_ENTITY_DEAD(uParam0->f_17[iVar0], 0))
		{
			STOP_ENTITY_ANIM(uParam0->f_17[iVar0], uVar2, uVar1, -1000f);
		}
