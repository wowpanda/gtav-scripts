...
void func_9(bool bParam0, bool bParam1)//Position - 0x4A8
{
	if (bParam0)
	{
		if (func_4(0))
...
void func_10(char* sParam0)//Position - 0x51C
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	CAM::_DISABLE_VEHICLE_FIRST_PERSON_CAM_THIS_FRAME();
}

bool func_11()//Position - 0x52E
{
	return Global_141339;
}

int func_12()//Position - 0x53A
{
	int iVar0;
	int iVar1;
...
int func_14(int iParam0)//Position - 0x5A1
{
	int iVar0;
	...
	if (!MISC::ARE_STRINGS_EQUAL(&(Global_19912[iParam0 /*28*/]), "") && !MISC::IS_STRING_NULL(&(Global_19912[iParam0 /*28*/])))
	{
		if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19912[iParam0 /*28*/].f_1B, 1))
		{
			...
			{
				return func_18(iVar0, &(Global_19912[iParam0 /*28*/]), &(Global_19912[iParam0 /*28*/].f_4), Global_19912[iParam0 /*28*/].f_14);
			}
			else
			{
				return func_17(iVar0, &(Global_19912[iParam0 /*28*/]), &(Global_19912[iParam0 /*28*/].f_4));
			}
		}
		else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19912[iParam0 /*28*/].f_1B, 2))
		{
			return func_16(iVar0, &(Global_19912[iParam0 /*28*/]), Global_19912[iParam0 /*28*/].f_14);
		}
		else
		{
			return func_15(iVar0, &(Global_19912[iParam0 /*28*/]));
		}
	}
	return 0;
}

int func_15(int iParam0, char* sParam1)//Position - 0x67E
{
...
int func_16(int iParam0, char* sParam1, int iParam2)//Position - 0x694
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam1);
...
int func_17(int iParam0, char* sParam1, int iParam2)//Position - 0x6B0
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam1);
...
int func_18(int iParam0, char* sParam1, int iParam2, int iParam3)//Position - 0x6CC
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam1);
	HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(iParam2);
...
void func_21(int iParam0)//Position - 0x7BC
{
	iLocal_42 = iParam0;
	iLocal_43 = 0;
}

int func_22(var uParam0, int iParam1)//Position - 0x7CB
{
	int iVar0;
	bool bVar1;
	vector3 vVar2;
	...
	while (iVar0 < 1)
	{
		bVar1 = func_58(&(uParam0->f_1), uParam0->f_A);
		if (!(iParam1[uParam0->f_A /*11*/])->f_A)
		{
			if (!bVar1)
			{
				...
				{
					func_56(iParam1[uParam0->f_A /*11*/], uParam0->f_7, joaat("pickup_custom_script"), 0, 1, 2);
				}
				else if (uParam0->f_A == iLocal_51)
				{
					...
					{
						INTERIOR::ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME((iParam1[uParam0->f_A /*11*/])->f_1, sLocal_52);
					}
				}
				else
				{
					func_56(iParam1[uParam0->f_A /*11*/], uParam0->f_7, joaat("pickup_custom_script"), 0, 0, 2);
				}
			}
		}
		else if (!bVar1)
		{
			if (func_39(uParam0, iParam1, vVar2))
			{
				if (bVar3)
				{
					if (!func_38(33))
					{
						func_35("LETTERS_FIRST", 1, 0, 4294967295, 10000, 7, 0, 0, 0);
						func_34(33);
					}
				}
			}
	...
	if (uParam0->f_B)
	{
		if (!Global_11729)
		{
			func_23(&(uParam0->f_B), &(uParam0->f_C), &(uParam0->f_9), 1, &iLocal_53, &iLocal_54, "LETTERS_TITLE", "LETTERS_COLLECT");
		}
	}
...
void func_23(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, char* sParam6, char* sParam7)//Position - 0x9B3
{
	int iVar0;
			...
			case 0:
				*iParam5 = unk_0x9934FEFB3B8C6DB8("MIDSIZED_MESSAGE");
				if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*iParam5))
				{
					...
					if (iParam3 == 6)
					{
						unk_0x1190AB7024CBD8CB(iVar0, "PEYOTE_COMPLETED", "HUD_AWARDS", true);
					}
					else
					{
						unk_0x1190AB7024CBD8CB(iVar0, "COLLECTED", "HUD_AWARDS", true);
					}
					*iParam4++;
				}
				break;
...
int func_25(int iParam0)//Position - 0xB61
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam0 == 2)
	{
		...
		{
			if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_2725.f_6C, func_31(func_32(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
	...
	else
	{
		...
		while (iVar1 < func_32(iParam0))
		{
			...
			if (func_26(iVar2, 4294967295, 4294967295))
			{
				iVar0++;
			}
			iVar1++;
...
int func_26(int iParam0, int iParam1, int iParam2)//Position - 0xC29
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_27(int iParam0)//Position - 0xC66
{
	int iVar0;
...
int func_28(int iParam0, int iParam1)//Position - 0xF7E
{
	int iVar0;
...
int func_29()//Position - 0x1276
{
	return Global_1407E0;
}

int func_30(int iParam0)//Position - 0x1282
{
	if (iParam0 == 3)
	{
		return 815;
...
int func_31(int iParam0, int iParam1)//Position - 0x12C9
{
	if (iParam1 < 32)
	{
		return iParam1;
...
int func_32(int iParam0)//Position - 0x12E5
{
	if (iParam0 == 3)
	{
		return 30;
...
void func_33(int iParam0)//Position - 0x1335
{
...
void func_34(int iParam0)//Position - 0x134F
{
	int iVar0;
	int iVar1;
...
void func_35(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x1391
{
	func_36(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_36(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x13B2
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x16A5
{
	int iVar0;
	int iVar1;
...
int func_39(var uParam0, var uParam1, vector3 vParam2)//Position - 0x16E8
{
	int iVar0;
...
void func_40(var uParam0)//Position - 0x17A5
{
...
void func_41(var uParam0, var uParam1, int iParam2)//Position - 0x17BE
{
	int iVar0;
...
bool func_43(bool bParam0)//Position - 0x18B4
{
...
void func_44(int iParam0, int iParam1)//Position - 0x18DF
{
	Global_16C57.f_7 = iParam0;
	Global_16C57.f_8 = iParam1;
}

void func_45()//Position - 0x18F7
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar3 = 0;
	STATS::STAT_GET_INT(func_47(0), &iVar0, 4294967295);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_46(18, iVar0);
	}
	STATS::STAT_GET_INT(func_47(1), &iVar0, 4294967295);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_46(19, iVar0);
	}
	STATS::STAT_GET_INT(func_47(3), &iVar0, 4294967295);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_46(20, iVar0);
...
int func_46(int iParam0, int iParam1)//Position - 0x199A
{
	int iVar0;
...
int func_47(int iParam0)//Position - 0x19EB
{
	if (iParam0 == 3)
	{
...
void func_48(var uParam0)//Position - 0x1A3C
{
	int iVar0;
	int iVar1;
...
int func_49(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1ABF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_50(var uParam0, int iParam1)//Position - 0x2027
{
	if (uParam0->f_3 <= 0)
	{
	}
...
void func_51(int iParam0, int iParam1, bool bParam2)//Position - 0x209B
{
...
void func_52(int iParam0, int iParam1, bool bParam2)//Position - 0x2187
{
	if (iParam1 < 0 || iParam1 >= 64)
	{
		return;
	...
	{
		GRAPHICS::_0x35FB78DC42B7BD21(&(iParam0->f_1), (iParam1 - 32));
	}
}

void func_53(int iParam0)//Position - 0x21E8
{
...
int func_54(int iParam0)//Position - 0x2208
{
	int iVar0;
	int iVar1;
	...
	if (func_55(AUDIO::_0x0626A247D2405330()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
		{
			...
			{
				if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), OBJECT::GET_PICKUP_COORDS(iParam0)) < (5f * 5f) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(AUDIO::_0x0626A247D2405330(), OBJECT::GET_PICKUP_OBJECT(iParam0)))
				{
					return 1;
				}
			}
...
int func_55(int iParam0)//Position - 0x2294
{
...
void func_56(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)//Position - 0x22B5
{
	int iVar0;
	...
	if (!uParam0->f_A)
	{
		if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			if (!func_59(13) && !func_59(14))
			{
				...
				{
					if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), uParam0->f_3) <= (50f * 50f))
					{
...
void func_57(vector3 vParam0)//Position - 0x23CE
{
	int iVar0;
...
bool func_58(var uParam0, int iParam1)//Position - 0x240C
{
	if (iParam1 < 0 || iParam1 >= 64)
	{
		return 0;
...
bool func_59(int iParam0)//Position - 0x244A
{
	return Global_8D15 == iParam0;
}

void func_60(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2458
{
	uParam0->f_6 = iParam1;
	func_61(&(uParam0->f_1), iParam2, iParam3);
}

void func_61(int iParam0, var uParam1, var uParam2)//Position - 0x2472
{
	int iVar0;
	int iVar1;
	...
	*iParam0 = 0;
	...
	{
		if (func_26((iParam0->f_2 + iVar0), 4294967295, 4294967295))
		{
			iVar1++;
...
void func_62(var uParam0, int iParam1, int iParam2, char* sParam3)//Position - 0x24DB
{
	*uParam0 = iParam1;
	uParam0->f_7 = iParam2;
	uParam0->f_8 = sParam3;
...
void func_63()//Position - 0x24F9
{
	int iVar0;
	
	Global_19E56.f_2725.f_7A.f_2 = 1;
	iVar0 = 0;
	while (iVar0 < 50)
	{
...
Vector3 func_64(int iParam0, int iParam1)//Position - 0x28EF
{
	switch (iParam0)
	{
		case 0:
...
bool func_65(int iParam0)//Position - 0x30CF
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
void func_66(int iParam0, int iParam1)//Position - 0x30ED
{
...
void func_67(int iParam0, int iParam1)//Position - 0x312A
{
...
void func_68(int iParam0, int iParam1, int iParam2)//Position - 0x316F
{
	bool bVar0;
...
int func_70()//Position - 0x3718
{
	return Global_6373;
}

int func_71(int iParam0)//Position - 0x3723
{
	int iVar0;
	int iVar1;
...
int func_72(int iParam0)//Position - 0x377D
{
	if (iParam0 == 146 || iParam0 == 4294967295)
	{
		return 0;
...
int func_73(int iParam0)//Position - 0x37AA
{
	int iVar0;
	int iVar1;
...
void func_74()//Position - 0x3804
{
	...
	Global_19E56.f_2725.f_7A.f_2 = 0;
	iVar0 = 0;
...
bool func_75(var uParam0)//Position - 0x38B5
{
	if (uParam0->f_3 <= 0)
	{
	}
...
void func_76()//Position - 0x38CE
{
	int iVar0;
	
	iVar0 = func_77(64);
	Global_24D678[iVar0 /*83*/] = 64;
	StringCopy(&(Global_24D678[iVar0 /*83*/].f_12[0 /*16*/]), "", 64);
}

int func_77(int iParam0)//Position - 0x38FA
{
	int iVar0;
	int iVar1;
