...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		PED::IS_PED_VAULTING("ufo");
	}
	vLocal_72[0 /*3*/] = { vLocal_66 };
	vLocal_72[1 /*3*/] = { vLocal_67 };
	while (true)
	{
		func_11(AUDIO::_0x0626A247D2405330());
		if (Global_6377 == 1)
		{
			func_12();
		}
		if (bLocal_73)
		{
			if (!func_10(AUDIO::_0x0626A247D2405330(), vLocal_72[0 /*3*/], (290f + 50f)))
			{
				if (!func_10(AUDIO::_0x0626A247D2405330(), vLocal_72[1 /*3*/], (290f + 50f)))
				{
					func_12();
				}
			}
			if (iLocal_71 != 0)
			{
				if (!func_10(AUDIO::_0x0626A247D2405330(), vLocal_72[0 /*3*/], (fLocal_78 + 50f)))
				{
					if (!func_10(AUDIO::_0x0626A247D2405330(), vLocal_72[1 /*3*/], (fLocal_78 + 50f)))
					{
		...
		switch (iLocal_71)
		{
			case 0:
				...
				{
					if (func_10(AUDIO::_0x0626A247D2405330(), vLocal_72[iVar0 /*3*/], fLocal_78))
					{
						iLocal_70 = iVar0;
						iLocal_71 = 1;
			...
			case 1:
				...
				while (iVar0 < vLocal_72.x)
				{
					if (func_10(AUDIO::_0x0626A247D2405330(), vLocal_72[iVar0 /*3*/], fLocal_75))
					{
						iLocal_70 = iVar0;
						iLocal_71 = 2;
					}
			...
			case 3:
				if (func_10(AUDIO::_0x0626A247D2405330(), vLocal_72[iLocal_70 /*3*/], fLocal_75))
				{
			...
			case 4:
				...
				if (!func_10(AUDIO::_0x0626A247D2405330(), vLocal_72[iLocal_70 /*3*/], fLocal_78))
				{
					func_1();
					iLocal_70 = 4294967295;
					iLocal_71 = 0;
...
void func_8()//Position - 0x51D
{
	...
	if (!func_10(AUDIO::_0x0626A247D2405330(), vLocal_72[iLocal_70 /*3*/], fLocal_76))
	{
		return;
	}
	vVar0 = { func_9(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 1) - vLocal_72[iLocal_70 /*3*/]) * Vector(fLocal_77, fLocal_77, fLocal_77) };
	ENTITY::APPLY_FORCE_TO_ENTITY(AUDIO::_0x0626A247D2405330(), 2, vVar0, 0f, 0f, 0f, 0, 0, 1, 1, 0, 1);
}
