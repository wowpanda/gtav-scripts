...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != 4294967295)
		{
			if (Global_19AC5[Var0 /*10*/].f_9 != 4294967295)
			{
				...
				func_287(&(Global_19AC5[Var0 /*10*/].f_9));
			}
		}
		func_271(&Var0, 1);
	}
	...
	while (true)
	{
		...
		{
			func_207();
			if (func_206(Var0.f_23[1]))
			{
				if (!func_205(329.513f, 3402.691f, 36.258f, unk_0x8000C77B5F336760(Var0.f_23[1], true), 1056964608))
				{
...
void func_47(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3838
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x39D8
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x3A0A
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x3A3E
{
	return Global_1407E0;
}

int func_51(int iParam0, int iParam1)//Position - 0x3A4A
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3A76
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3FBE
{
	int iVar0;
...
int func_54()//Position - 0x4200
{
	func_55();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_55()//Position - 0x4219
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x4316
{
	return Global_8D15 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x4324
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x4417
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x46A1
{
	switch (iParam0)
	{
		case 3036451504:
...
int func_60(int iParam0)//Position - 0x473C
{
...
int func_61(int iParam0, int iParam1)//Position - 0x48C2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x5433
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x546E
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x56E2
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x571E
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_66(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x5C79
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5CBD
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x639C
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x63E3
{
...
bool func_70(int iParam0)//Position - 0x643E
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x644E
{
...
int func_72(int iParam0)//Position - 0x64B8
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x67BB
{
	return Global_6373;
}

int func_74(int iParam0)//Position - 0x67C6
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x67D6
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6878
{
	switch (iParam0)
	{
		case 4294967295:
...
int func_77(int iParam0)//Position - 0x6E4D
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6EAB
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6F59
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6FEE
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x7032
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x71B6
{
...
int func_84(int iParam0, var uParam1)//Position - 0x7C8B
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7D0D
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7D6B
{
	return 4294967295;
}

Vector3 func_87(int iParam0)//Position - 0x7D74
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x7F7F
{
	return func_89(CAM::_0xDC9DA9E8789F5246());
}

int func_89(int iParam0)//Position - 0x7F8F
{
	return MISC::GET_BITS_IN_RANGE(Global_24FBF9[iParam0 /*413*/].f_135.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x7FAC
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x7FBC
{
	switch (iParam0)
	{
		case 4294967295:
...
var func_177()//Position - 0xCA46
{
	return Global_16C57.f_1;
}

int func_178()//Position - 0xCA54
{
...
bool func_181()//Position - 0xCABE
{
	return Global_16C64.f_148 > 0;
}

bool func_182(int iParam0, int iParam1)//Position - 0xCACF
{
	switch (iParam0)
	{
		case 5:
...
var func_183()//Position - 0xCB0A
{
	return Global_140859;
}

int func_184()//Position - 0xCB16
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_185(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xCB32
{
	var uVar0;
	
	if ((((func_126(AUDIO::_0x0626A247D2405330()) && func_126(iParam0->f_1C[0])) && !func_145()) && (MISC::GET_GAME_TIMER() - iParam0->f_3C) > iParam6) && func_189(AUDIO::_0x0626A247D2405330(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_188(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
...
void func_186(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCBBA
{
...
void func_187(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCBF5
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
void func_188(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCC4B
{
...
float func_189(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xCCE6
{
	vector3 vVar0;
...
int func_190(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)//Position - 0xCD20
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_176(2))
		{
			if (!func_145())
			{
				if (((func_126(AUDIO::_0x0626A247D2405330()) && func_126(iParam0->f_1C[0])) && func_126(iParam0->f_1C[1])) && func_189(AUDIO::_0x0626A247D2405330(), vParam1, 1) < 20f)
				{
					...
					{
						func_188(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
						func_188(&uVar0, iParam6, iParam0->f_1C[1], sParam7, 0, 1);
						func_186(&uVar0, cParam2, sParam3, 7, 0, 0);
						*uParam8 = 2;
					}
					else if (*uParam8 == 2)
			...
			else if (((func_192(sParam3) && !*uParam8 == 1) && func_126(AUDIO::_0x0626A247D2405330())) && func_189(AUDIO::_0x0626A247D2405330(), vParam1, 1) >= 20f)
			{
				func_288("pause conversation");
				func_191(1);
				*uParam8 = 1;
			}
			if (func_189(AUDIO::_0x0626A247D2405330(), vParam1, 1) < 20f && *uParam8 == 1)
			{
...
void func_191(int iParam0)//Position - 0xCE6B
{
	Global_41C1 = iParam0;
}

int func_192(char* sParam0)//Position - 0xCE78
{
	struct<6> Var0;
...
struct<6> func_193()//Position - 0xCE98
{
	struct<6> Var0;
...
void func_194(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xCEBC
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_189(AUDIO::_0x0626A247D2405330(), vParam2, 1) <= 100f)
				{
					func_197(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_189(AUDIO::_0x0626A247D2405330(), vParam2, 1) > 120f)
				{
					func_199(iParam0);
				}
			}
...
void func_195(int iParam0, bool bParam1)//Position - 0xCFAD
{
	if (iParam0 == 4294967295)
	{
		return;
...
void func_197(int iParam0, int iParam1)//Position - 0xD022
{
	bool bVar0;
	int iVar1;
...
bool func_198()//Position - 0xD0C0
{
	return Global_1620C;
}

void func_199(int iParam0)//Position - 0xD0CC
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_200(iParam0);
...
void func_200(int iParam0)//Position - 0xD0E3
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_201(int iParam0)//Position - 0xD1CB
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_164();
...
void func_202(var uParam0)//Position - 0xD1F3
{
	int iVar0;
	int iVar1;
	...
	if (*uParam0 == 52)
	{
		func_204(&(uParam0->f_29[1]));
		func_204(&(uParam0->f_29[2]));
	}
...
void func_203(int iParam0)//Position - 0xD4F7
{
	int iVar0;
...
void func_204(int iParam0)//Position - 0xD594
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_205(struct<2> Param0, float fParam1, struct<2> Param2, float fParam3, float fParam4)//Position - 0xD5BF
{
	if (fParam4 < 0f)
	{
		fParam4 = 0f;
...
int func_206(int iParam0)//Position - 0xD5F8
{
	if (func_126(iParam0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
...
int func_208(var uParam0, bool bParam1)//Position - 0xD655
{
	struct<27> Var0;
	...
	if ((func_242(*uParam0) || func_240(*uParam0)) || Global_1171A == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_212(&(uParam0->f_30)) && bParam1)
	{
		func_209(uParam0->f_1C[0], &(uParam0->f_30), *uParam0);
	}
	return 1;
}

void func_209(int iParam0, var uParam1, int iParam2)//Position - 0xD8C8
{
	int iVar0;
	int iVar1;
...
int func_210(int iParam0)//Position - 0xDC20
{
...
int func_211(var uParam0)//Position - 0xDC40
{
...
int func_212(var uParam0)//Position - 0xDC58
{
...
void func_213(var uParam0)//Position - 0xDC7D
{
	int iVar0;
...
int func_214(var uParam0, bool bParam1, bool bParam2)//Position - 0xDCFD
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_215(AUDIO::_0x0626A247D2405330(), uParam0->f_23[iVar0]))
							{
...
int func_215(int iParam0, int iParam1)//Position - 0xDEBB
{
	int iVar0;
...
int func_216(var uParam0, bool bParam1, int iParam2)//Position - 0xDEEB
{
	int iVar0;
	int iVar1;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_1C[iVar0]))
				{
					...
					if (func_235(*uParam0))
					{
						if (!func_156(*uParam0))
						{
							if (func_230(uParam0->f_1C[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_202(uParam0);
						...
						if (func_218(uParam0->f_1C[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_202(uParam0);
...
int func_217(int iParam0)//Position - 0xE1A7
{
...
int func_218(int iParam0, float fParam1)//Position - 0xE1DB
{
	float fVar0;
	
	if (func_126(AUDIO::_0x0626A247D2405330()) && func_126(iParam0))
	{
		if (func_229(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), iParam0))
		{
...
bool func_219(int iParam0, float fParam1)//Position - 0xE251
{
	return func_220(iParam0, AUDIO::_0x0626A247D2405330(), fParam1, 1, 250, 7);
}

bool func_220(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE269
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_221(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE32A
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_222(int iParam0, int iParam1)//Position - 0xE456
{
	int iVar0;
...
int func_224(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE565
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_226(unk_0x8000C77B5F336760(iParam1, true) - unk_0x8000C77B5F336760(iParam0, true)) };
...
float func_225(vector3 vParam0, vector3 vParam1)//Position - 0xE5F6
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_226(vector3 vParam0)//Position - 0xE617
{
	float fVar0;
	float fVar1;
...
void func_227(var uParam0)//Position - 0xE656
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_228(int iParam0, int iParam1)//Position - 0xE671
{
	int iVar0;
...
int func_229(int iParam0)//Position - 0xE6B0
{
...
int func_230(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE6D8
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_231(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE7D3
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_232(int iParam0, float fParam1)//Position - 0xE8DF
{
	var uVar0;
	vector3 vVar1;
...
int func_233(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xE974
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_226(vParam1 - unk_0x8000C77B5F336760(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_234(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEA02
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
...
int func_235(int iParam0)//Position - 0xEA4A
{
...
int func_236(int iParam0)//Position - 0xEA94
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_164();
...
int func_237(int iParam0)//Position - 0xEB2C
{
...
int func_240(int iParam0)//Position - 0xEBAE
{
	if ((func_241() && Global_16C30.f_B == 6) && iParam0 == func_165(&(Global_16C30.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_242(int iParam0)//Position - 0xEC20
{
	if (func_107(0))
	{
...
int func_245(var uParam0)//Position - 0xECD4
{
	int iVar0[5];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_254(&(uParam0->f_30), "rcmminute3base", "base", "beckon");
		...
		case 1:
			if (!func_253(&iVar0) || !func_252(&(uParam0->f_30)))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				func_251(&(uParam0->f_29[0]), iVar0[3], -303.74f, 6211.56f, 30.49f, -176.77f);
			...
			{
				if (func_248(&(uParam0->f_1C[0]), 59, uParam0->f_30.f_5, -2.8f, "RCM MINUTE - MANUEL", 1))
				{
					PED::SET_PED_PROP_INDEX(uParam0->f_1C[0], 0, 0, 0, false);
					PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(uParam0->f_1C[0], 0);
					if (func_125(AUDIO::_0x0626A247D2405330()))
					{
						BRAIN::TASK_LOOK_AT_ENTITY(uParam0->f_1C[0], AUDIO::_0x0626A247D2405330(), 4294967295, 2050, 4);
					}
				}
				else
				{
			...
			{
				func_246(&(uParam0->f_23[0]), iVar0[0], -281.93f, 6198.32f, 30.77f, -135.32f);
			...
			{
				func_246(&(uParam0->f_23[1]), iVar0[1], -291.72f, 6208.33f, 30.87f, -134.5016f);
			...
			{
				func_251(&(uParam0->f_29[1]), iVar0[4], -303.74f, 6211.56f, 30.49f, -176.77f);
...
void func_246(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xEFF5
{
	func_247(iParam0);
...
void func_247(int iParam0)//Position - 0xF037
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_248(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xF0D3
{
...
int func_249(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xF12F
{
	int iVar0;
...
int func_250(var uParam0, int iParam1)//Position - 0xF1BD
{
	int iVar0;
...
void func_251(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF203
{
	func_204(iParam0);
...
int func_252(var uParam0)//Position - 0xF22A
{
	if (func_212(uParam0))
	{
...
int func_253(int iParam0)//Position - 0xF254
{
	int iVar0;
...
void func_254(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xF285
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_255(var uParam0)//Position - 0xF2C1
{
	int iVar0[1];
	int iVar1;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			func_246(&(uParam0->f_23[0]), iVar0[0], 20.8f, 4532.65f, 104.66f, 284.7f);
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
...
int func_256(var uParam0)//Position - 0xF3D4
{
	int iVar0[4];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (func_248(&(uParam0->f_1C[0]), 56, 329.3f, 3404.2f, 35.8f, -174.9f, "RCM MINUTE - JOE", 1))
				{
			...
			{
				if (func_248(&(uParam0->f_1C[1]), 57, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				func_246(&(uParam0->f_23[0]), iVar0[0], 321.69f, 3408.64f, 35.34f, -105.8f);
				func_257(uParam0->f_23[0], iVar0[0]);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[1]))
			{
				func_246(&(uParam0->f_23[1]), iVar0[1], 329.49f, 3402.71f, 36.29f, 284.36f);
				func_257(uParam0->f_23[1], iVar0[1]);
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1"))
			{
				if (func_126(uParam0->f_1C[0]))
				{
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_1C[0], "rcmminute1", "base_joe", 3))
					{
						...
						BRAIN::TASK_PLAY_ANIM(uParam0->f_1C[0], "rcmminute1", "base_joe", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
				...
				if (func_126(uParam0->f_1C[1]))
				{
					...
					BRAIN::TASK_PLAY_ANIM(uParam0->f_1C[1], "rcmminute1", "base_josef", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_1C[1], 185, true);
				}
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
...
void func_257(int iParam0, int iParam1)//Position - 0xF6F5
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_258(int iParam0)//Position - 0xF72B
{
	struct<27> Var0;
	int iVar1;
...
int func_259(int iParam0)//Position - 0xF77F
{
	char* sVar0;
...
int func_260(int iParam0)//Position - 0xF838
{
	var uVar0;
...
int func_261(int iParam0)//Position - 0xF8F9
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_262(int iParam0, char* sParam1)//Position - 0xF97E
{
...
bool func_263(int iParam0)//Position - 0xFA60
{
...
bool func_264(int iParam0)//Position - 0xFA8E
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
bool func_265(int iParam0)//Position - 0xFABC
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
int func_266(int iParam0)//Position - 0xFAEA
{
	if (func_237(iParam0))
	{
		return 0;
...
void func_267()//Position - 0xFB1F
{
	func_288("Running end routines.");
	Global_19D3C = (Global_19D3C - 1);
}

int func_268(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xFB39
{
	int iVar0;
...
int func_269(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xFB9E
{
	int iVar0;
	struct<7> Var1;
...
int func_270(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xFC1C
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_271(int iParam0, bool bParam1)//Position - 0xFC97
{
	char* sVar0;
...
void func_272(char* sParam0)//Position - 0xFD84
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_192(sParam0))
...
void func_273()//Position - 0xFDA3
{
	Global_3960 = 0;
	func_274();
}

void func_274()//Position - 0xFDB3
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_275(var uParam0)//Position - 0xFDD4
{
	if (func_212(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_276(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFE0A
{
...
void func_277(var uParam0, bool bParam1)//Position - 0xFE2A
{
	func_278(&(uParam0->f_29), bParam1);
}

void func_278(var uParam0, bool bParam1)//Position - 0xFE3C
{
	int iVar0;
...
void func_279(int iParam0, bool bParam1)//Position - 0xFE7A
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_280(var uParam0, bool bParam1)//Position - 0xFEB5
{
	func_281(&(uParam0->f_23), bParam1);
}

void func_281(var uParam0, bool bParam1)//Position - 0xFEC7
{
	int iVar0;
...
void func_282(int iParam0)//Position - 0xFF04
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_283(var uParam0, int iParam1)//Position - 0xFF3C
{
	func_284(&(uParam0->f_1C), iParam1);
}

void func_284(var uParam0, int iParam1)//Position - 0xFF4E
{
	int iVar0;
...
void func_285(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFF8F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_286(int iParam0)//Position - 0xFFDF
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_287(var uParam0)//Position - 0x10021
{
	if (*uParam0 == 4294967295)
	{
		return;
...
void func_288(char* sParam0)//Position - 0x1005E
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_289(var uParam0)//Position - 0x10070
{
	*uParam0 = 4294967295;
...
void func_290()//Position - 0x100A3
{
	func_288("Running start routines.");
	Global_19D3C++;
}

int func_291(int iParam0)//Position - 0x100BD
{
	if (!func_36(iParam0))
	{
		return Global_19E56.f_6D76[iParam0 /*29*/];
