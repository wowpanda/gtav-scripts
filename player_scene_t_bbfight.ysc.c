...
int func_2()//Position - 0x151
{
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_357))
			{
				if (!iLocal_361)
				{
					...
					else
					{
						...
						{
							func_15(&uLocal_110, func_16(), AUDIO::_0x0626A247D2405330(), &Local_351, 0, 1);
						}
	...
	if (SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), vLocal_283) > 100f)
	{
		return 1;
	}
	return 0;
...
void func_17()//Position - 0x958
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_19(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_20(iVar0) && (!func_10(14) || Global_19A3D))
			{
		...
		if (!PED::IS_PED_INJURED((*iParam0)[iVar0]))
		{
			switch ((*iParam1)[iVar0])
			{
				case 100:
					...
					{
						BRAIN::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_16220, &cLocal_338, &(Local_347[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
						(*iParam1)[iVar0] = 101;
					}
				...
				case 101:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_16221))
					{
						BRAIN::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_16221, &cLocal_338, &(Local_348[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
				...
				case 102:
					if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_338) && ENTITY::IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_338, &(Local_348[iVar0 /*16*/]), 2))
					{
						...
						{
							if (fVar2 < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_16221))
							{
								if (!PED::IS_PED_RUNNING_RAGDOLL_TASK((*iParam0)[iVar0]))
								{
									NETWORK::_0x5E3AA4CA2B6FB0EE((*iParam0)[iVar0]);
						...
						if (iLocal_109 == 165)
						{
							if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_349[iVar0 /*16*/])))
							{
								...
								if (0.95f < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_16221))
								{
									if (STREAMING::HAS_ANIM_DICT_LOADED(sVar4))
									{
										BRAIN::TASK_START_SCENARIO_IN_PLACE((*iParam0)[iVar0], &(Local_349[iVar0 /*16*/]), 0, 0);
										MISC::_0x1327E2FE9746BAEE((*iParam0)[iVar0], 0, 0);
										SYSTEM::WAIT(0);
						...
						if (iLocal_109 == 259)
						{
							if (0.95f < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_16221))
							{
								BRAIN::TASK_PUT_PED_DIRECTLY_INTO_MELEE((*iParam0)[iVar0], AUDIO::_0x0626A247D2405330(), 0f, -1f, 0f, 0);
								MISC::_0x1327E2FE9746BAEE((*iParam0)[iVar0], 0, 0);
								SYSTEM::WAIT(0);
								(*iParam1)[iVar0] = 10;
								break;
						...
						if (iLocal_109 == 246 && iVar0 == 0)
						{
							if (0.95f < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_16221))
							{
								...
								if (!PED::IS_PED_INJURED((*iParam0)[iVar0]))
								{
									BRAIN::TASK_PUT_PED_DIRECTLY_INTO_MELEE(AUDIO::_0x0626A247D2405330(), (*iParam0)[iVar0], 0f, -1f, 0f, 0);
									SYSTEM::WAIT(0);
								}
								(*iParam1)[iVar0] = 10;
								break;
				...
				case 200:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_16220))
					{
						BRAIN::TASK_PLAY_ANIM((*iParam0)[iVar0], &cLocal_338, &(Local_347[iVar0 /*16*/]), 8f, -1000f, 4294967295, 0, 0, 0, 0, 0);
						(*iParam1)[iVar0] = 201;
					}
					else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_16221))
					{
				...
				case 201:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_16221))
					{
						BRAIN::TASK_PLAY_ANIM((*iParam0)[iVar0], &cLocal_338, &(Local_348[iVar0 /*16*/]), 8f, -1.5f, 4294967295, 32768, 0, 0, 0, 0);
						BRAIN::TASK_LOOK_AT_ENTITY((*iParam0)[iVar0], AUDIO::_0x0626A247D2405330(), 4294967295, 0, 2);
						STREAMING::REQUEST_ANIM_DICT(&cLocal_338);
						(*iParam1)[iVar0] = 202;
					}
					break;
					...
					if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_338) && ENTITY::IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_338, &(Local_348[iVar0 /*16*/]), 1))
					{
						...
						if (iLocal_109 == 108 || iLocal_109 == 109)
						{
							if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME((*iParam0)[iVar0], &cLocal_338, &(Local_348[iVar0 /*16*/])) > 0.954f)
							{
								...
								BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vLocal_283 + vLocal_285[iVar0 /*3*/], 1f, 4294967295, 1048576000, 0, 1193033728);
								PED::FORCE_PED_MOTION_STATE((*iParam0)[iVar0], 3626484699, false, 0, 0);
								BRAIN::TASK_CLEAR_LOOK_AT((*iParam0)[iVar0]);
								SYSTEM::WAIT(0);
								(*iParam1)[iVar0] = 1;
							}
						}
				...
				case 0:
					vVar8 = { unk_0x8000C77B5F336760((*iParam0)[iVar0], true) };
					...
					if (fVar13 > 45f)
					{
						if (!BRAIN::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], 1920390111) == 1)
						{
							BRAIN::TASK_ACHIEVE_HEADING((*iParam0)[iVar0], fVar12, 0);
						}
						break;
					}
					if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_349[iVar0 /*16*/])))
				...
				case 1:
					vVar14 = { unk_0x8000C77B5F336760((*iParam0)[iVar0], true) };
					...
					if (!BRAIN::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], 713668775) == 1 && !BRAIN::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], 713668775) == 0)
					{
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vVar15, 0.5f, 4294967295, 1048576000, 0, 1193033728);
						break;
					}
					break;
				
				case 10:
					if (BRAIN::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], 4223627085) == 7 || BRAIN::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], 4223627085) == 1)
					{
						iVar17 = 0;
						...
						BRAIN::TASK_COMBAT_HATED_TARGETS_AROUND_PED_TIMED((*iParam0)[iVar0], 25f, 4294967295, 0);
				...
				case 11:
					if (SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), vLocal_283) > 50f && SYSTEM::VDIST(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760((*iParam0)[iVar0], true)) > 50f)
					{
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_279, 1862763509);
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, 1862763509, iLocal_279);
						NETWORK::_0x5E3AA4CA2B6FB0EE((*iParam0)[iVar0]);
						BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], vLocal_283 + vLocal_285[iVar0 /*3*/], 0.5f, 4294967295, 1048576000, 0, 1193033728);
						(*iParam1)[iVar0] = 1;
					}
				...
				case 5:
					...
					if (!BRAIN::PED_HAS_USE_SCENARIO_TASK((*iParam0)[iVar0]))
					{
						if (MISC::ARE_STRINGS_EQUAL(&(Local_349[iVar0 /*16*/]), "any"))
						{
							if (BRAIN::DOES_SCENARIO_EXIST_IN_AREA(vLocal_283 + vLocal_285[iVar0 /*3*/], 20f, 1))
							{
								BRAIN::TASK_USE_NEAREST_SCENARIO_TO_COORD((*iParam0)[iVar0], vLocal_283 + vLocal_285[iVar0 /*3*/], 20f, 0);
						...
						else
						{
							...
							BRAIN::TASK_START_SCENARIO_IN_PLACE((*iParam0)[iVar0], &(Local_349[iVar0 /*16*/]), 0, iVar18);
							iLocal_350[iVar0] = MISC::GET_GAME_TIMER();
						}
					}
...
int func_23(int iParam0, float fParam1)//Position - 0x1563
{
	...
	while (iVar0 < 263)
	{
		...
		{
			if (Global_64EA[iVar0 /*23*/].f_10 == 9)
			{
			}
			else
			{
				vVar1 = { func_25(iVar0, 0) };
				if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(iParam0, true), vVar1) < (fParam1 * fParam1))
				{
					return 1;
				}
				if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_64EA[iVar0 /*23*/].f_B, 19))
				{
					iVar3 = 3;
					iVar2 = 0;
					while (iVar2 < iVar3)
					{
						...
						if (!func_24(vVar4))
						{
							if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(iParam0, true), vVar4) < (fParam1 * fParam1))
							{
								return 1;
							}
						}
...
int func_26(int iParam0)//Position - 0x168D
{
	...
	if (FIRE::IS_EXPLOSION_IN_SPHERE(4294967295, unk_0x8000C77B5F336760(iParam0, true), 15f))
	{
		return 1;
	}
	...
	while (iVar1 < 1)
	{
		...
		{
			if (func_27(AUDIO::_0x0626A247D2405330(), vLocal_283 + vLocal_287[iVar1 /*3*/], vLocal_288[iVar1 /*3*/], (fLocal_284 + fLocal_289[iVar1]), 0, 1, 0))
			{
				fVar2 = 50f;
				if (PED::IS_PED_FACING_PED(iParam0, AUDIO::_0x0626A247D2405330(), fVar2))
				{
					return 1;
				}
			}
...
int func_29(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x187E
{
	...
	if (func_36(AUDIO::_0x0626A247D2405330()) && func_36(iParam0))
	{
...
int func_32(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0x1B1A
{
	...
	vVar0 = { func_34(vParam1 - unk_0x8000C77B5F336760(iParam0, true)) };
...
int func_40()//Position - 0x1CF9
{
	...
	if (Global_252F9E.f_4A)
	{
		return 1;
	}
	if (Global_162B5.f_2C == 1)
	{
		if (Global_162B5.f_2E == 0)
		{
			return 1;
		}
	}
...
int func_42(int iParam0, int iParam1)//Position - 0x1DEA
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_43(Global_16B5A) && iParam1 != 0)
		{
			Global_16B5A = 0;
		}
	}
...
void func_50()//Position - 0x1F9A
{
	...
	while (iVar0 < iLocal_276)
	{
		if (iLocal_278[iVar0] != 0)
		{
			...
			BRAIN::TASK_STAND_STILL(iLocal_276[iVar0], 4294967295);
			if (iLocal_109 == 285)
			{
				ENTITY::SET_ENTITY_MAX_HEALTH(iLocal_276[iVar0], 105);
				unk_0x65E471E4A2D56226(iLocal_276[iVar0], 105, 0);
			}
		}
		if (iLocal_281[iVar0] != 0)
		{
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[0];
			StringCopy(sParam2, func_61(Global_19E56.f_933.f_21B.f_8F6[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[1];
			StringCopy(sParam2, func_61(Global_19E56.f_933.f_21B.f_8F6[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[2];
			StringCopy(sParam2, func_61(Global_19E56.f_933.f_21B.f_8F6[2]), 32);
			return 1;
			break;
