...
void __EntryFunction__()
{
	...
	if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			if (func_224(PLAYER_ID()) != 1 && !IS_BIT_SET(Global_2528542.f_850.f_7, 0))
			{
				func_225();
			}
		}
	...
	while (true)
	{
		...
		if (ScriptParam_0.f_16 >= 32)
		{
			if (func_224(PLAYER_ID()) != 1 && Global_1625025 == 0)
			{
				func_225();
			}
		}
		if (NETWORK_IS_IN_TUTORIAL_SESSION() != iLocal_173)
		{
			func_225();
		}
		_0x2302C0264EA58D31();
		switch (func_211(PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (func_210())
				{
					if (func_209() == 1)
					{
						vLocal_71[PARTICIPANT_ID_TO_INT() /*3*/] = 1;
					}
					else if (func_209() == 4)
					{
						vLocal_71[PARTICIPANT_ID_TO_INT() /*3*/] = 3;
					}
				}
				break;
			...
			case 1:
				...
				if (vLocal_71[PARTICIPANT_ID_TO_INT() /*3*/].f_2 == 0)
				{
					if ((!IS_ENTITY_AT_COORD(PLAYER_PED_ID(), Local_60.f_3, 500f, 500f, 500f, 0, 1, 0) && func_224(PLAYER_ID()) != 1) && !IS_BIT_SET(Global_2528542.f_850.f_7, 0))
					{
						vLocal_71[PARTICIPANT_ID_TO_INT() /*3*/] = 4;
					}
				}
				break;
...
int func_2()
{
	if (Local_60.f_7 >= 32 && func_224(PLAYER_ID()) == 1)
	{
...
void func_6()
{
	...
	while (iVar0 < _NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK_IS_PARTICIPANT_ACTIVE(INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			if (Local_60.f_6 == -1)
			{
				if (IS_BIT_SET(vLocal_71[iVar0 /*3*/].f_1, 0))
				{
					Local_60.f_6 = iVar0;
				}
			}
			...
			{
				if (IS_BIT_SET(vLocal_71[iVar0 /*3*/].f_1, 1))
				{
	...
	if (!NETWORK_DOES_NETWORK_ID_EXIST(Local_60.f_2))
	{
		if (func_210())
		{
			if (CAN_REGISTER_MISSION_OBJECTS(1))
			{
				...
				if (iVar4 == 0)
				{
					if (IS_BIT_SET(Local_60.f_1, 8) || func_180(vVar6, fVar5, &vVar0, &uVar3, &Var13))
					{
						if (Local_60.f_7 >= 32 || func_224(PLAYER_ID()) == 1)
						{
							Local_60.f_2 = OBJ_TO_NET(CREATE_PORTABLE_PICKUP(joaat("pickup_portable_package"), vVar0, 1, joaat("prop_drug_package_02")));
						}
						else
						{
							Local_60.f_2 = OBJ_TO_NET(_CREATE_PORTABLE_PICKUP_2(joaat("pickup_portable_package"), vVar0, 1, joaat("prop_drug_package_02")));
						}
						SET_ENTITY_HEADING(NET_TO_OBJ(Local_60.f_2), uVar3);
					}
				}
				else if (IS_BIT_SET(Local_60.f_1, 8) || func_8(vVar6, vVar9, fVar5, &vVar0, &uVar3, Var13))
				{
					if (Local_60.f_7 >= 32 || func_224(PLAYER_ID()) == 1)
					{
						Local_60.f_2 = OBJ_TO_NET(CREATE_PORTABLE_PICKUP(joaat("pickup_portable_package"), vVar0, 1, joaat("prop_drug_package_02")));
...
int func_9(var uParam0, var uParam1, var uParam2)
{
	...
	if (bVar25)
	{
		if (Global_2405071.f_2452 == 1)
		{
			if (IS_THREAD_ACTIVE(Global_2405071.f_2461))
			{
				...
				{
					if (GET_TIME_DIFFERENCE(GET_NETWORK_TIME(), Global_2405071.f_2458) < func_179(0))
					{
						return 0;
					}
				}
				else if (GET_TIME_DIFFERENCE(GET_NETWORK_TIME(), Global_2405071.f_2458) < func_179(0))
				{
					return 0;
				}
			}
	...
	if (Global_2405071.f_2452)
	{
		...
		{
			if (func_138() || GET_TIME_DIFFERENCE(GET_NETWORK_TIME(), Global_2405071.f_2459) > 10000)
			{
				Global_2405071.f_2459 = GET_NETWORK_TIME();
				Global_2405071.f_2453 = 4;
			}
		...
		if (uParam5->f_5)
		{
			...
			else
			{
				switch (uParam5->f_7)
				{
					case 0:
						vVar67 = { *uParam5 };
						if (func_62(uParam5->f_4) || !IS_VALID_INTERIOR(GET_INTERIOR_AT_COORDS(vVar67)))
						{
							iVar66 += 4;
						}
						break;
					...
					case 1:
						...
						if (func_61(uParam5->f_8, uParam5->f_11, 0f) || !IS_VALID_INTERIOR(GET_INTERIOR_AT_COORDS(vVar67)))
						{
							iVar66 += 4;
						}
						break;
					...
					case 2:
						vVar67 = { uParam5->f_8 + uParam5->f_11 * Vector(0.5f, 0.5f, 0.5f) };
						if (func_61(uParam5->f_8, uParam5->f_11, uParam5->f_14) || !IS_VALID_INTERIOR(GET_INTERIOR_AT_COORDS(vVar67)))
						{
							iVar66 += 4;
						}
						break;
	...
	if (func_42(PLAYER_ID(), 1))
	{
		...
		if (Global_969025.f_255 > 0)
		{
			...
			while (iVar0 < Global_969025.f_255)
			{
				...
				{
					if (func_34(vParam0, GET_ENTITY_COORDS(Global_969025.f_220[iVar0], 1), GET_ENTITY_HEADING(Global_969025.f_220[iVar0]), GET_ENTITY_MODEL(Global_969025.f_220[iVar0]), 0.5f))
					{
						return 1;
					}
				}
		...
		if (Global_969025.f_253 > 0)
		{
			...
			while (iVar0 < Global_969025.f_253)
			{
				...
				{
					if (func_34(vParam0, GET_ENTITY_COORDS(Global_969025.f_118[iVar0], 1), GET_ENTITY_HEADING(Global_969025.f_118[iVar0]), GET_ENTITY_MODEL(Global_969025.f_118[iVar0]), 0.5f))
					{
						return 1;
					}
				}
...
float func_73(vector3 vParam0, float fParam3, int iParam4, int iParam5, bool bParam6, int iParam7, bool bParam8)
{
	...
	while (iVar0 < 32)
	{
		...
		{
			if (!func_140(iVar1, 0) && _NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER_ID(), iVar1))
			{
		...
		if (func_26(iVar11, 1, 1) || (iParam7 == 1 && func_26(iVar11, 0, 0)))
		{
			if (!iVar11 == PLAYER_ID() || iParam5 == 1)
			{
				...
				if (bParam4)
				{
					...
					{
						if (!GET_PLAYER_TEAM(iVar11) == -1 || !func_56(PLAYER_ID(), 1))
						{
							bVar4 = true;
						}
					}
		...
		if (!func_86(iParam0))
		{
			if (_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER_ID(), iParam0))
			{
				if (!GET_PLAYER_TEAM(iParam0) == GET_PLAYER_TEAM(PLAYER_ID()))
				{
					if (func_42(PLAYER_ID(), 1))
					{
						if (!func_85(GET_PLAYER_TEAM(iParam0), GET_PLAYER_TEAM(PLAYER_ID()), 0))
						{
							return 1;
						}
					}
...
float func_90(vector3 vParam0, vector3 vParam3, bool bParam6, bool bParam7, bool bParam8, int iParam9, var uParam10)
{
	...
	if (bParam6)
	{
		fVar0 = func_72(VDIST(vParam0, vParam3), 0f, 0f, 200f, 1f, 0.1f);
	...
	if (iParam4 && !bParam7)
	{
		if (func_26(PLAYER_ID(), 1, 1))
		{
			if (!IS_SCREEN_FADED_OUT())
			{
				...
				if (GET_DISTANCE_BETWEEN_COORDS(func_115(PLAYER_ID()), vParam0, 1) <= (fVar2 + fParam3))
				{
					if (IS_SPHERE_VISIBLE(vParam0, fParam3))
					{
						return 1;
				...
				if (iParam4 == 1 || (iParam4 == 0 && iVar1 != PLAYER_ID()))
				{
					if ((func_74(iVar1) || !bParam10) && !Global_2424047[iVar1 /*416*/].f_259)
					{
						...
						if (!bParam7)
						{
							if ((iParam5 || (iParam5 == 0 && GET_PLAYER_TEAM(iVar1) != GET_PLAYER_TEAM(PLAYER_ID()))) || GET_PLAYER_TEAM(iVar1) == -1)
							{
								if (GET_DISTANCE_BETWEEN_COORDS(func_115(iVar1), vParam0, 1) <= (fVar2 + fParam3))
								{
									if (IS_SPHERE_VISIBLE_TO_PLAYER(iVar1, vParam0, fParam3))
									{
										return 1;
...
int func_121(vector3 vParam0, float fParam3, float fParam4, var uParam5, float fParam6)
{
	...
	while (iVar0 < 32)
	{
		...
		if (!PLAYER_ID() == iVar1)
		{
			if ((func_26(iVar1, 1, 1) && func_74(iVar1)) && _NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER_ID(), iVar1))
			{
...
int func_124(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 32)
	{
		...
		if ((func_26(iVar1, 1, 1) && func_74(iVar1)) && _NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER_ID(), iVar1))
		{
			...
			else if ((GET_PLAYER_TEAM(PLAYER_ID()) == -1 && !PLAYER_ID() == iVar1) || !func_123(PLAYER_ID(), iVar1, -2, 0))
			{
				if (VDIST(vParam0, func_78(iVar1)) < fParam3)
				{
					return 1;
				}
			}
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam8 == 1 && PLAYER_ID() != iVar1) || iParam8 == 0)
		{
			if (func_26(iVar1, bParam4, bParam5))
			{
				...
				{
					if (!bParam7 || (!IS_PED_INJURED(GET_PLAYER_PED(iVar1)) && func_74(iVar1)))
					{
						if ((!bParam6 || (bParam6 == 1 && GET_PLAYER_TEAM(PLAYER_ID()) != GET_PLAYER_TEAM(iVar1))) || GET_PLAYER_TEAM(PLAYER_ID()) == -1)
						{
							if (((GET_PLAYER_TEAM(PLAYER_ID()) == -1 && iParam9) && bParam6) && func_80(iVar1))
							{
							}
							else if (DOES_ENTITY_EXIST(GET_PLAYER_PED(iVar1)))
							{
								if (GET_DISTANCE_BETWEEN_COORDS(func_78(iVar1), vParam0, 1) < fParam3)
								{
									return 1;
								}
							}
...
int func_127(vector3 vParam0, float fParam3, int iParam4, float fParam5)
{
	...
	if (!iVar3 == -1)
	{
		...
		while (iVar0 < 32)
		{
			...
			if (func_26(iVar1, 1, 1))
			{
				if ((!func_140(iVar1, 0) && _NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER_ID(), iVar1)) && iVar1 != PLAYER_ID())
				{
					fVar2 = iParam4;
					if (fParam5 > 0f)
					{
					...
					{
						if (GET_DISTANCE_BETWEEN_COORDS(func_78(iVar1), vParam0, 1) <= (fVar2 + fParam3))
						{
							if (IS_SPHERE_VISIBLE_TO_PLAYER(iVar1, vParam0, fParam3))
							{
								return 1;
														...
														if (func_159(vVar1, uParam2))
														{
															if ((uParam2->f_48 && !func_165(&vVar1, 0)) || uParam2->f_48 == 0)
															{
																...
																if (VMAG(vVar1) > 0f)
																{
																	...
																	{
																		if ((uParam2->f_12 && !func_155(vVar1, fVar4, uParam2->f_34, PLAYER_ID(), 0, uParam2->f_56)) || !uParam2->f_12)
																		{
	...
	while (iVar0 < 32)
	{
		...
		if ((iParam9 == 1 && PLAYER_ID() != iVar1) || iParam9 == 0)
		{
			if (func_26(iVar1, bParam5, bParam6))
			{
				if (_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(PLAYER_ID(), iVar1))
				{
					if (!bParam8 || (!IS_PED_INJURED(GET_PLAYER_PED(iVar1)) && func_74(iVar1)))
					{
						if ((!bParam7 || (bParam7 == 1 && GET_PLAYER_TEAM(PLAYER_ID()) != GET_PLAYER_TEAM(iVar1))) || GET_PLAYER_TEAM(PLAYER_ID()) == -1)
						{
							if (((GET_PLAYER_TEAM(PLAYER_ID()) == -1 && iParam10) && bParam7) && func_80(iVar1))
							{
							}
							else if (DOES_ENTITY_EXIST(GET_PLAYER_PED(iVar1)))
							{
...
Vector3 func_160(vector3 vParam0, var uParam3, int iParam4, bool bParam5, vector3 vParam6, int iParam9, bool bParam10, int iParam11, var uParam12, int iParam13, bool bParam14, bool bParam15)
{
	...
	if (uVar4 & 1024 == 0 && !bParam10)
	{
		...
		if (bParam14)
		{
			...
			if (IS_THIS_MODEL_A_HELI(iParam11) && func_162(vParam0))
			{
				return 0f, 0f, 0f;
			}
		}
			...
			if (iVar1 > -1 && iVar1 < 101)
			{
				...
				if (VMAG(vVar2) > 0f)
				{
					if ((uParam2->f_57 && VDIST(vVar2, uParam2->f_35) > uParam2->f_4) || uParam2->f_57 == 0)
					{
						...
						{
							if ((uParam2->f_12 && !func_155(vVar2, fVar5, uParam2->f_34, PLAYER_ID(), 0, uParam2->f_56)) || !uParam2->f_12)
							{
...
void func_184()
{
	switch (vLocal_71[PARTICIPANT_ID_TO_INT() /*3*/].f_2)
	{
		case 0:
			func_208();
			func_206();
			if (func_195())
			{
				...
				func_186();
				func_185(35);
				vLocal_71[PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 1;
			}
		...
		case 1:
			if (Local_60.f_8 >= 2)
			{
				vLocal_71[PARTICIPANT_ID_TO_INT() /*3*/].f_2 = 2;
			}
			break;
...
void func_186()
{
	...
	{
		REMOVE_BLIP(&uLocal_170);
	}
}

void func_187()
{
	if (!IS_BIT_SET(Global_2437364.f_3880, 0))
	{
		SET_BIT(&(Global_2437364.f_3880), 0);
		func_188();
	}
	else
	{
		SET_BIT(&(Global_2437364.f_3880), 1);
	}
}
...
int func_195()
{
	...
	if (NETWORK_DOES_NETWORK_ID_EXIST(Local_60.f_2))
	{
		...
		{
			if (IS_ENTITY_ATTACHED_TO_ENTITY(NET_TO_OBJ(Local_60.f_2), PLAYER_PED_ID()) && func_205(Local_60.f_2))
			{
				...
				SET_BIT(&(vLocal_71[PARTICIPANT_ID_TO_INT() /*3*/].f_1), 0);
				return 1;
			}
		}
	}
...
void func_199(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	...
	if ((!func_202() || !NETWORK_IS_ACTIVITY_SESSION()) || !func_140(PLAYER_ID(), 0))
	{
		return;
	}
...
void func_206()
{
	if (!DOES_BLIP_EXIST(uLocal_170))
	{
		if (NETWORK_DOES_NETWORK_ID_EXIST(Local_60.f_2))
		{
			uLocal_170 = ADD_BLIP_FOR_ENTITY(NET_TO_OBJ(Local_60.f_2));
			if (func_207())
			{
				SET_BLIP_SCALE(uLocal_170, 0.85f);
			}
			else
			{
				SET_BLIP_SCALE(uLocal_170, 1.2f);
			}
			SET_BLIP_SPRITE(uLocal_170, 403);
			SET_BLIP_COLOUR(uLocal_170, 2);
			SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_170, "ABB_BLIPN");
		}
	}
}
...
int func_212()
{
	...
	if (func_213() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_213()) == 0)
		{
			return 1;
		}
	}
...
void func_227()
{
	...
	CLEAR_BIT(&(Global_2528542.f_850.f_7), 0);
}

void func_228()
{
	if (IS_BIT_SET(uLocal_168, 4))
	{
		...
		func_229(1);
		CLEAR_BIT(&uLocal_168, 5);
		CLEAR_BIT(&uLocal_168, 7);
		CLEAR_BIT(&uLocal_168, 4);
	}
}
...
int func_231(struct<21> Param0)
{
	...
	NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&vLocal_71, 97);
	if (!func_232())
	{
		return 0;
	}
	...
	if (NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		Local_60.f_3 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 0) };
		if (!func_4(Global_2528542.f_850.f_1))
		{
			SET_BIT(&(Local_60.f_1), 8);
		}
	}
	iLocal_173 = NETWORK_IS_IN_TUTORIAL_SESSION();
	vLocal_71[PARTICIPANT_ID_TO_INT() /*3*/] = 0;
	return 1;
}
