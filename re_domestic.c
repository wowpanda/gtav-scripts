...
void __EntryFunction__()
{
	...
	if (HAS_FORCE_CLEANUP_OCCURRED(11))
	{
		...
		{
			if (IS_PED_IN_GROUP(uLocal_58))
			{
				REMOVE_PED_FROM_GROUP(uLocal_58);
			}
		}
		func_221();
	}
					...
					case 1:
						...
						switch (iLocal_49)
						{
							...
							case 1:
								if (!iLocal_99)
								{
									if ((IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -467.0595f, 540.1724f, 125.3034f, 91.875f, 90.875f, 30f, 0, 1, 0) && IS_SPHERE_VISIBLE(vLocal_106, 1f)) || IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_106, 20f, 20f, 20f, 0, 1, 0))
									{
										func_144();
										func_135(1);
										iLocal_99 = 1;
								...
								{
									if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_106, 50f, 50f, 50f, 0, 1, 0))
									{
										func_133();
									}
									if (!IS_PED_INJURED(uLocal_58))
									{
										if (!IS_ENTITY_AT_COORD(uLocal_58, vLocal_63, 30f, 30f, 30f, 0, 1, 0))
										{
											iLocal_49 = 11;
										}
									}
							...
							case 4:
								...
								if (!iLocal_89)
								{
									if (func_51())
									{
										if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_112, 23f, 60f, 20f, 0, 1, 0))
										{
											func_56(0);
											func_54();
											WAIT(0);
						...
						{
							if (IS_ENTITY_PLAYING_ANIM(uLocal_57, "random@domestic", "f_attack_end", 3))
							{
						...
						if ((func_47() && !func_46()) && iLocal_48 != 2)
						{
							if (!IS_PED_INJURED(uLocal_58))
							{
								if (IS_ENTITY_AT_COORD(uLocal_58, vLocal_118, 5f, 5f, 5f, 0, 1, 0))
								{
									if (!DOES_ENTITY_EXIST(iLocal_121[8]))
									{
										iLocal_121[8] = CREATE_OBJECT(joaat("prop_golf_iron_01"), -473.4f, 536.8035f, 123.2482f, 1, 1, 0);
										ATTACH_ENTITY_TO_ENTITY(iLocal_121[8], uLocal_58, GET_PED_BONE_INDEX(uLocal_58, 57005), 0f, -0.15f, -0.05f, 70f, 110f, 200f, 1, 0, 0, 0, 2, 1);
									}
									func_45(0);
									WAIT(0);
									func_54();
...
void func_1()
{
	...
	if (iLocal_150 && !iLocal_149)
	{
		...
		if (DOES_ENTITY_EXIST(iLocal_121[8]))
		{
			uLocal_133 = CREATE_PICKUP_ROTATE(joaat("pickup_weapon_golfclub"), GET_ENTITY_COORDS(iLocal_121[8], 1), GET_ENTITY_ROTATION(iLocal_121[8], 2) + Vector(2.8157f, -159.5768f, -14.1956f), 0, -1, 2, 1, 0);
			DELETE_OBJECT(&(iLocal_121[8]));
		}
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_63 - Vector(10f, 10f, 10f), vLocal_63 + Vector(10f, 10f, 10f), 1, 1);
		SET_RELATIONSHIP_BETWEEN_GROUPS(255, uLocal_152, 1862763509);
		if (bLocal_59)
		{
		...
		if (DOES_ENTITY_EXIST(uLocal_58))
		{
			if (!IS_PED_INJURED(uLocal_58))
			{
				if (!IS_PED_IN_ANY_VEHICLE(uLocal_58, 0))
				{
					RESET_PED_LAST_VEHICLE(uLocal_58);
				}
				REMOVE_PED_FROM_GROUP(uLocal_58);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_58, 0);
				SET_PED_CAN_BE_TARGETTED(uLocal_58, 1);
			}
		}
		iVar0 = 0;
		while (iVar0 < iLocal_121)
		{
			...
			{
				DETACH_ENTITY(iLocal_121[iVar0], 1, 1);
			}
			iVar0++;
		}
	...
	if ((!IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_63, 80f, 80f, 80f, 0, 1, 0) || HAS_PICKUP_BEEN_COLLECTED(uLocal_133)) || !(DOES_ENTITY_EXIST(iLocal_121[8]) && !DOES_PICKUP_EXIST(uLocal_133)))
	{
		func_221();
	}
}
...
int func_44()
{
	if (IS_PED_INJURED(uLocal_57) && IS_PED_INJURED(uLocal_58))
	{
		return 1;
	}
	return 0;
...
{
	_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_49(iParam3), 0);
}
...
int func_51()
{
	...
	{
		uLocal_151 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
		if (IS_VEHICLE_DRIVEABLE(uLocal_151, 0))
		{
			if (!IS_PED_INJURED(uLocal_58))
			{
				if (IS_PED_SITTING_IN_VEHICLE(uLocal_58, uLocal_151))
				{
					return 1;
				}
			}
...
void func_75()
{
	switch (iLocal_70)
	{
		case 0:
			...
			else if (!IS_PED_INJURED(uLocal_58))
			{
				SET_PED_MAX_MOVE_BLEND_RATIO(uLocal_58, 1f);
				if (IS_ENTITY_AT_ENTITY(uLocal_58, PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0))
				{
					if (iLocal_68 < 19)
					{
		...
		case 1:
			...
			if (DOES_ENTITY_EXIST(uLocal_58))
			{
				if (!IS_PED_INJURED(uLocal_58))
				{
					...
					{
						if (IS_PED_GETTING_INTO_A_VEHICLE(uLocal_58))
						{
							DELETE_OBJECT(&(iLocal_121[8]));
						}
					}
					if (IS_PED_SITTING_IN_ANY_VEHICLE(uLocal_58))
					{
						func_120();
						func_114();
		...
		case 2:
			...
			if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_112, 10f, 10f, 10f, 0, 1, 0))
			{
			...
			if (DOES_ENTITY_EXIST(uLocal_58))
			{
				if (!IS_PED_INJURED(uLocal_58))
				{
					if (IS_ENTITY_AT_COORD(uLocal_58, vLocal_112, Global_19, 1, 1, 0) && func_110(1, 0, 1))
					{
						if (DOES_BLIP_EXIST(uLocal_100))
						{
							REMOVE_BLIP(&uLocal_100);
						}
						if (DOES_BLIP_EXIST(uLocal_101))
						{
							REMOVE_BLIP(&uLocal_101);
						}
						if (IS_PED_IN_ANY_VEHICLE(uLocal_58, 0))
						{
							_SET_VEHICLE_HALT(GET_VEHICLE_PED_IS_IN(uLocal_58, 0), 10.5f, 3, 0);
							iLocal_70++;
						}
						else
						{
	...
	switch (iLocal_143)
	{
		...
		case 2:
			...
			if (!IS_PED_INJURED(uLocal_58))
			{
				...
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_115, 1f, -1, 0.25f, 0, 311.3569f);
				TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_SMOKING", 0, 1);
				CLOSE_SEQUENCE_TASK(uLocal_95);
				TASK_PERFORM_SEQUENCE(uLocal_58, uLocal_95);
				CLEAR_SEQUENCE_TASK(&uLocal_95);
				SET_PED_KEEP_TASK(uLocal_58, 1);
				iLocal_144 = GET_GAME_TIMER() + 4000;
				iLocal_143++;
			}
			break;
		
		case 3:
			if (iLocal_144 < GET_GAME_TIMER())
			{
				CLEAR_ALL_HELP_MESSAGES();
				iLocal_143++;
			}
	...
	switch (iLocal_143)
	{
		...
		case 3:
			...
			if (!IS_PED_INJURED(uLocal_58))
			{
				...
				iLocal_144 = GET_GAME_TIMER() + 1000;
				iLocal_143++;
			}
			break;
		...
		case 4:
			...
			if (iLocal_144 < GET_GAME_TIMER())
			{
				...
				{
					SET_PLAYER_CONTROL(PLAYER_ID(), 1, 0);
					iLocal_144 = GET_GAME_TIMER() + 3000;
					iLocal_143++;
				}
			}
			break;
...
void func_111()
{
	...
	if (!func_150())
	{
		switch (iLocal_141)
		{
			...
			case 6:
				iLocal_142 = GET_GAME_TIMER() + 1000;
				iLocal_141++;
				break;
			
			case 7:
				if (iLocal_142 < GET_GAME_TIMER())
				{
					if (func_53() == 0)
					{
...
void func_112()
{
	if (!IS_PED_INJURED(uLocal_58))
	{
		if (!iLocal_84)
		{
			...
			{
				if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), GET_PLAYERS_LAST_VEHICLE(), 1) && IS_PED_IN_VEHICLE(uLocal_58, GET_PLAYERS_LAST_VEHICLE(), 0))
				{
					func_56(0);
					func_54();
					WAIT(0);
		...
		{
			if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), GET_PLAYERS_LAST_VEHICLE(), 0) && IS_PED_IN_VEHICLE(uLocal_58, GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				iLocal_84 = 0;
			}
		}
...
void func_113()
{
	...
	if ((iLocal_137 - iLocal_136) > 60000)
	{
		...
		if (!IS_PED_INJURED(uLocal_58))
		{
			if (IS_ENTITY_AT_COORD(uLocal_58, vLocal_115, 200f, 200f, 200f, 0, 1, 0))
			{
				TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_58, vLocal_115, 1f, -1, 1048576000, 0, 1193033728);
			}
			else
			{
				TASK_WANDER_STANDARD(uLocal_58, 1193033728, 0);
			}
			SET_PED_KEEP_TASK(uLocal_58, 1);
			REMOVE_PED_FROM_GROUP(uLocal_58);
		}
...
void func_114()
{
	if (!IS_PED_INJURED(uLocal_58))
	{
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_58, 8f, 8f, 8f, 0, 1, 0) || IS_PED_IN_ANY_TAXI(PLAYER_PED_ID()))
		{
			if ((IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !IS_PED_IN_ANY_VEHICLE(uLocal_58, 0)) && !IS_PED_IN_ANY_TAXI(PLAYER_PED_ID()))
			{
				if (!DOES_BLIP_EXIST(uLocal_102[0]))
				{
			...
			else
			{
				...
				if (func_53() == 2 && !func_46())
				{
					if (!DOES_BLIP_EXIST(uLocal_101))
					{
						...
						SET_BLIP_SPRITE(uLocal_101, 269);
						func_115();
					}
				}
			}
...
var func_116(vector3 vParam0, int iParam3)
{
	...
	SET_BLIP_SCALE(uVar0, func_117(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
int func_119(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_117(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
	...
	if (!IS_PED_INJURED(uLocal_58))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
		{
			if (!func_125())
			{
				...
				if (GET_SCRIPT_TASK_STATUS(uLocal_58, 1227113341) != 1 && GET_SCRIPT_TASK_STATUS(uLocal_58, 1227113341) != 0)
				{
					TASK_GO_TO_ENTITY(uLocal_58, PLAYER_PED_ID(), -1, 6f, 1073741824, 1073741824, 0);
				}
				if (IS_PED_IN_ANY_VEHICLE(uLocal_58, 0))
				{
					TASK_LEAVE_ANY_VEHICLE(uLocal_58, 0, 0);
				}
				if (!iLocal_91)
				{
					func_56(0);
			...
			else
			{
				...
				if (GET_SCRIPT_TASK_STATUS(uLocal_58, 1227113341) == 1 && GET_SCRIPT_TASK_STATUS(uLocal_58, 1227113341) == 0)
				{
					CLEAR_PED_TASKS(uLocal_58);
				}
			}
		}
		else if (!IS_PED_IN_GROUP(uLocal_58))
		{
			SET_PED_AS_GROUP_MEMBER(uLocal_58, func_123());
			SET_PED_NEVER_LEAVES_GROUP(uLocal_58, 1);
			SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uLocal_58, 0);
		}
	}
}
...
void func_126()
{
	switch (iLocal_69)
	{
		...
		case 2:
			...
			if (!IS_PED_INJURED(uLocal_58))
			{
				if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_58, 12f, 12f, 5f, 0, 1, 2))
				{
					if (func_125())
					{
						SET_RELATIONSHIP_BETWEEN_GROUPS(255, uLocal_152, 1862763509);
		...
		case 3:
			if (!IS_PED_INJURED(uLocal_58) && DOES_ENTITY_EXIST(iLocal_121[8]))
			{
				OPEN_SEQUENCE_TASK(&uLocal_95);
				if (iLocal_68 > 18)
				{
				}
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, GET_ENTITY_COORDS(iLocal_121[8], 1) + Vector(0f, 0.39f, 0.35f), 1f, -1, 0f, 512, func_128(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(iLocal_121[8], 1)));
				TASK_PLAY_ANIM(0, "random@domestic", "pickup_low", 2f, -2f, -1, 0, 0, 0, 0, 0);
				TASK_PLAY_ANIM(0, "random@security_van", "sec_hand_override", 8f, -4f, -1, 33, 0, 0, 0, 0);
				CLOSE_SEQUENCE_TASK(uLocal_95);
				TASK_PERFORM_SEQUENCE(uLocal_58, uLocal_95);
				CLEAR_SEQUENCE_TASK(&uLocal_95);
				SETTIMERB(0);
		...
		case 4:
		case 5:
			if (!IS_PED_INJURED(uLocal_58) && !IS_ENTITY_DEAD(iLocal_121[8], 0))
			{
				if (IS_ENTITY_PLAYING_ANIM(uLocal_58, "random@domestic", "pickup_low", 3))
				{
					SET_ENTITY_NO_COLLISION_ENTITY(uLocal_58, iLocal_121[8], 0);
					if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_58, "random@domestic", "pickup_low") > 0.388f)
					{
						iLocal_69 = 7;
					}
				}
				else if (TIMERB() > 10000 || IS_ENTITY_AT_COORD(PLAYER_PED_ID(), GET_ENTITY_COORDS(iLocal_121[8], 1), 1.5f, 1.5f, 3f, 0, 1, 0))
				{
		...
		case 7:
			if (!IS_PED_INJURED(uLocal_58))
			{
				if (IS_ENTITY_AT_ENTITY(uLocal_58, PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0))
				{
					ATTACH_ENTITY_TO_ENTITY(iLocal_121[8], uLocal_58, GET_PED_BONE_INDEX(uLocal_58, 57005), 0f, -0.15f, -0.05f, 70f, 110f, 200f, 1, 0, 0, 0, 2, 1);
					SET_PED_AS_GROUP_MEMBER(uLocal_58, GET_PLAYER_GROUP(PLAYER_ID()));
					SET_PED_NEVER_LEAVES_GROUP(uLocal_58, 1);
					SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uLocal_58, 0);
					func_127();
					iLocal_49 = 4;
...
void func_130()
{
	if (!iLocal_98)
	{
		if (!IS_PED_INJURED(uLocal_58))
		{
			if (IS_ENTITY_AT_ENTITY(uLocal_58, PLAYER_PED_ID(), 12f, 12f, 5f, 0, 1, 0))
			{
				CLEAR_PED_TASKS(uLocal_58);
				OPEN_SEQUENCE_TASK(&uLocal_95);
				...
				TASK_PERFORM_SEQUENCE(uLocal_58, uLocal_95);
				CLEAR_SEQUENCE_TASK(&uLocal_95);
				TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), uLocal_58, 15000, 0, 2);
				iLocal_98 = 1;
			}
		}
	}
			...
			if (bLocal_138)
			{
				if (bLocal_54)
				{
					...
					if (!IS_PED_INJURED(uLocal_58))
					{
						if (!func_150())
						{
							if (IS_PED_FACING_PED(uLocal_58, PLAYER_PED_ID(), 90f))
							{
...
void func_131()
{
	if (DOES_ENTITY_EXIST(uLocal_58))
	{
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_58, 15f, 15f, 15f, 0, 1, 0))
		{
			if (func_132())
			{
				func_45(0);
...
void func_133()
{
	...
	{
		case 0:
			if (!IS_PED_INJURED(uLocal_58) && !IS_PED_INJURED(uLocal_57))
			{
				if (IS_SPHERE_VISIBLE(GET_ENTITY_COORDS(uLocal_57, 1), 3f))
				{
					if (!func_150())
					{
						if (func_149(&uLocal_155, "REDO2AU", "REDO2_ARMA", 4, 0, 0, 0))
						{
							TASK_PLAY_ANIM(uLocal_58, "random@domestic", "balcony_fight_male", 2f, -2f, -1, 0, 0.3f, 0, 0, 0);
							TASK_PLAY_ANIM(uLocal_57, "random@domestic", "balcony_fight_female", 2f, -2f, -1, 0, 0.3f, 0, 0, 0);
							iLocal_68++;
						}
					}
				}
		...
		case 1:
			if (!IS_PED_INJURED(uLocal_57) && DOES_ENTITY_EXIST(iLocal_121[8]))
			{
				ATTACH_ENTITY_TO_ENTITY(iLocal_121[8], uLocal_57, GET_PED_BONE_INDEX(uLocal_57, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
				iLocal_68++;
			}
			break;
		...
		case 2:
			if (!IS_PED_INJURED(uLocal_57) && DOES_ENTITY_EXIST(iLocal_121[8]))
			{
				if (IS_ENTITY_PLAYING_ANIM(uLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_57, "random@domestic", "balcony_fight_female") > 0.335f)
					{
						DETACH_ENTITY(iLocal_121[8], 0, 1);
						APPLY_FORCE_TO_ENTITY(iLocal_121[8], 1, 0f, 6f, 4f, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
						iLocal_68++;
					}
				}
			}
		...
		case 3:
			if (!iLocal_88 && DOES_ENTITY_EXIST(iLocal_121[8]))
			{
		...
		case 4:
			if (!IS_PED_INJURED(uLocal_57) && DOES_ENTITY_EXIST(iLocal_121[9]))
			{
				if (IS_ENTITY_PLAYING_ANIM(uLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_57, "random@domestic", "balcony_fight_female") > 0.473f)
					{
						ATTACH_ENTITY_TO_ENTITY(iLocal_121[9], uLocal_57, GET_PED_BONE_INDEX(uLocal_57, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
						iLocal_68++;
					}
				}
			}
		...
		case 6:
			if (!IS_PED_INJURED(uLocal_57) && DOES_ENTITY_EXIST(iLocal_121[9]))
			{
				if (IS_ENTITY_PLAYING_ANIM(uLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_57, "random@domestic", "balcony_fight_female") > 0.55f)
					{
						DETACH_ENTITY(iLocal_121[9], 0, 1);
						APPLY_FORCE_TO_ENTITY(iLocal_121[9], 1, 1f, 2f, 3f, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
						iLocal_68++;
					}
				}
			}
		...
		case 7:
			if (!iLocal_88 && DOES_ENTITY_EXIST(iLocal_121[9]))
			{
		...
		case 8:
			if (!IS_PED_INJURED(uLocal_57) && DOES_ENTITY_EXIST(iLocal_121[10]))
			{
				if (IS_ENTITY_PLAYING_ANIM(uLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_57, "random@domestic", "balcony_fight_female") > 0.705f)
					{
						ATTACH_ENTITY_TO_ENTITY(iLocal_121[10], uLocal_57, GET_PED_BONE_INDEX(uLocal_57, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
						iLocal_68++;
					}
				}
			}
		...
		case 9:
			if (!IS_PED_INJURED(uLocal_57) && DOES_ENTITY_EXIST(iLocal_121[10]))
			{
				if (IS_ENTITY_PLAYING_ANIM(uLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_57, "random@domestic", "balcony_fight_female") > 0.838f)
					{
						DETACH_ENTITY(iLocal_121[10], 0, 1);
						APPLY_FORCE_TO_ENTITY(iLocal_121[10], 1, 1f, 3f, 3f, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
						iLocal_68++;
					}
				}
			}
		...
		case 10:
			if (!iLocal_88 && DOES_ENTITY_EXIST(iLocal_121[10]))
			{
		...
		case 11:
			if (!IS_PED_INJURED(uLocal_57) && !IS_PED_INJURED(uLocal_58))
			{
				if (IS_ENTITY_PLAYING_ANIM(uLocal_57, "random@domestic", "balcony_fight_female", 3))
				{
					if (GET_ENTITY_ANIM_CURRENT_TIME(uLocal_57, "random@domestic", "balcony_fight_female") > 0.94f)
					{
						TASK_TURN_PED_TO_FACE_ENTITY(uLocal_57, uLocal_58, 0);
					}
				}
			}
			if (!func_150() || func_132())
		...
		case 16:
			if (!IS_PED_INJURED(uLocal_58))
			{
				...
				TASK_TURN_PED_TO_FACE_COORD(0, vLocal_109, 0);
				CLOSE_SEQUENCE_TASK(uLocal_95);
				TASK_PERFORM_SEQUENCE(uLocal_58, uLocal_95);
				CLEAR_SEQUENCE_TASK(&uLocal_95);
				iLocal_68++;
		...
		case 17:
			if (DOES_ENTITY_EXIST(uLocal_57))
			{
				...
				{
					if (IS_ENTITY_AT_COORD(uLocal_57, vLocal_109, 1f, 1f, 5f, 0, 1, 0) && IS_ENTITY_OCCLUDED(uLocal_57))
					{
						DELETE_PED(&uLocal_57);
					}
				}
			}
			if (iLocal_93 < GET_GAME_TIMER())
			{
				if (!func_150())
				{
					if (func_149(&uLocal_155, "REDO2AU", "REDO2_INS1", 4, 0, 0, 0))
					{
						iLocal_93 = GET_GAME_TIMER() + 5000;
						iLocal_94++;
					}
				}
			}
	...
	if (!bLocal_54)
	{
		if (iLocal_68 > 2 && iLocal_68 < 8)
		{
			if (!IS_PED_INJURED(uLocal_58))
			{
				if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_58, 6f, 4f, 5f, 0, 1, 0) || (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_58, 12f, 12f, 5f, 0, 1, 2) && IS_PLAYER_PRESSING_HORN(PLAYER_ID())))
				{
					CLEAR_PED_TASKS(uLocal_58);
					func_134();
					if (iLocal_68 > 18)
		...
		else if (iLocal_68 > 7)
		{
			if (!IS_PED_INJURED(uLocal_58))
			{
				if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_58, 6f, 8f, 5f, 0, 1, 0))
				{
					if (DOES_BLIP_EXIST(uLocal_102[0]))
					{
						_0x75A16C3DA34F1245(uLocal_102[0], 1);
					}
					CLEAR_PED_TASKS(uLocal_58);
					func_134();
					if (iLocal_68 > 18)
...
void func_134()
{
	...
	{
		OPEN_SEQUENCE_TASK(&uLocal_95);
		TASK_GO_STRAIGHT_TO_COORD(0, vLocal_109, 1f, -1, 1193033728, 1056964608);
		TASK_PLAY_ANIM(0, "random@domestic", "f_attack_end", 2f, -2f, -1, 1, 0, 0, 0, 0);
		CLOSE_SEQUENCE_TASK(uLocal_95);
		TASK_PERFORM_SEQUENCE(uLocal_57, uLocal_95);
		CLEAR_SEQUENCE_TASK(&uLocal_95);
...
int func_138()
{
	switch (func_139(&Global_25824, 0, 5, 0, GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
void func_144()
{
	...
	{
		uLocal_102[0] = func_118(uLocal_58, 0, 145);
		_0x75A16C3DA34F1245(uLocal_102[0], 0);
	}
}
...
void func_145()
{
	...
	func_4(43, 1);
	func_4(44, 1);
	CLEAR_AREA(vLocal_63, 2f, 1, 0, 0, 0);
	CLEAR_AREA(vLocal_60, 2f, 1, 0, 0, 0);
	SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(vLocal_63 - Vector(10f, 10f, 10f), vLocal_63 + Vector(10f, 10f, 10f), 0, 1);
	SET_ROADS_IN_ANGLED_AREA(-499.9164f, 575.6557f, 124.5584f, -346.8641f, 483.3948f, 111.7201f, 74.0625f, 0, 0, 1);
	...
	ADD_RELATIONSHIP_GROUP("rghDomestic", &uLocal_152);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_152, 1862763509);
	uLocal_57 = CREATE_PED(26, iLocal_96, vLocal_60, fLocal_66, 1, 1);
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_57, 1);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_57, 17, 1);
	SET_PED_COMBAT_ATTRIBUTES(uLocal_57, 8, 0);
	SET_PED_FLEE_ATTRIBUTES(uLocal_57, 1, 0);
	SET_PED_FLEE_ATTRIBUTES(uLocal_57, 2, 0);
	SET_PED_FLEE_ATTRIBUTES(uLocal_57, 128, 1);
	SET_PED_FLEE_ATTRIBUTES(uLocal_57, 8, 0);
	TASK_PLAY_ANIM(uLocal_57, "random@domestic", "balcony_fight_idle_female", 8f, -4f, -1, 1, 0, 0, 0, 0);
	SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_57, uLocal_152);
	func_148(uLocal_57, "GENERIC_WHATEVER", 24);
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_96);
	SET_PED_CONFIG_FLAG(uLocal_57, 185, 1);
	uLocal_58 = CREATE_PED(26, iLocal_97, vLocal_63, fLocal_67, 1, 1);
	SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_58, 1);
	SET_PED_FLEE_ATTRIBUTES(uLocal_58, 1, 1);
	SET_PED_FLEE_ATTRIBUTES(uLocal_58, 2, 0);
	SET_PED_FLEE_ATTRIBUTES(uLocal_58, 128, 1);
	SET_PED_FLEE_ATTRIBUTES(uLocal_58, 8, 0);
	SET_PED_FLEE_ATTRIBUTES(uLocal_58, 65536, 1);
	SET_PED_CONFIG_FLAG(uLocal_58, 185, 1);
	SET_PED_CONFIG_FLAG(uLocal_58, 206, 1);
	SET_PED_HELMET(uLocal_58, 0);
	SET_PED_CAN_BE_TARGETTED(uLocal_58, 0);
	TASK_PLAY_ANIM(uLocal_58, "random@domestic", "balcony_fight_idle_male", 8f, -4f, -1, 1, 0, 0, 0, 0);
	SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_58, uLocal_152);
	func_148(uLocal_58, "GENERIC_WHATEVER", 24);
	SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_97);
	TASK_LOOK_AT_ENTITY(uLocal_58, uLocal_57, -1, 0, 2);
	TASK_LOOK_AT_ENTITY(uLocal_57, uLocal_58, -1, 0, 2);
	SET_PED_COMPONENT_VARIATION(uLocal_57, 0, 1, 0, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_57, 2, 1, 1, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_57, 3, 1, 1, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_57, 4, 1, 2, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_58, 0, 0, 0, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_58, 2, 1, 0, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_58, 3, 1, 2, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_58, 4, 1, 1, 0);
	SET_PED_COMPONENT_VARIATION(uLocal_58, 8, 0, 0, 0);
	func_147();
	SET_BIT(&uLocal_134, 5);
	if (func_53() == 0)
	{
		func_146(&uLocal_155, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
	}
	if (func_53() == 1)
	{
		func_146(&uLocal_155, 1, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	if (func_53() == 2)
	{
		func_146(&uLocal_155, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
	}
	func_146(&uLocal_155, 3, uLocal_58, "REDOCastro", 0, 1);
	SET_AMBIENT_VOICE_NAME(uLocal_58, sLocal_153);
	func_146(&uLocal_155, 4, uLocal_57, "NATHALIA", 0, 1);
	SET_AMBIENT_VOICE_NAME(uLocal_57, sLocal_154);
	SETTIMERA(0);
	iLocal_150 = 1;
}
...
void func_147()
{
	iLocal_121[0] = CREATE_OBJECT(joaat("prop_ld_tshirt_02"), -470.3661f, 541.385f, 120.0205f, 1, 1, 0);
	SET_ENTITY_ROTATION(iLocal_121[0], -13.7262f, 0.5001f, -0.5886f, 2, 1);
	FREEZE_ENTITY_POSITION(iLocal_121[0], 1);
	SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_ld_tshirt_02"));
	iLocal_121[1] = CREATE_OBJECT(joaat("prop_ld_jeans_02"), -470.8998f, 540.7595f, 120.169f, 1, 1, 0);
	SET_ENTITY_ROTATION(iLocal_121[1], -7.3906f, -12.8136f, -63.733f, 2, 1);
	FREEZE_ENTITY_POSITION(iLocal_121[1], 1);
	SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_ld_jeans_02"));
	iLocal_121[2] = CREATE_OBJECT(joaat("prop_ld_shoe_01"), -468.3266f, 540.7725f, 120.1762f, 1, 1, 0);
	SET_ENTITY_ROTATION(iLocal_121[2], -7.041683f, 10.17298f, 45.7617f, 2, 1);
	FREEZE_ENTITY_POSITION(iLocal_121[2], 1);
	SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_ld_shoe_01"));
	iLocal_121[3] = CREATE_OBJECT(joaat("prop_ld_jeans_01"), -468.7787f, 541.864f, 119.9098f, 1, 1, 0);
	SET_ENTITY_ROTATION(iLocal_121[3], -8.5884f, 12.6893f, 57.1792f, 2, 1);
	FREEZE_ENTITY_POSITION(iLocal_121[3], 1);
	SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_ld_jeans_01"));
	iLocal_121[4] = CREATE_OBJECT(joaat("prop_ld_shoe_02"), -470.9009f, 541.2538f, 120.0578f, 1, 1, 0);
	SET_ENTITY_ROTATION(iLocal_121[4], -16.4886f, 2.4979f, -3.8769f, 2, 1);
	FREEZE_ENTITY_POSITION(iLocal_121[4], 1);
	SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_ld_shoe_02"));
	iLocal_121[5] = CREATE_OBJECT(joaat("prop_ld_shirt_01"), -472.0366f, 542.0591f, 119.8243f, 1, 1, 0);
	SET_ENTITY_ROTATION(iLocal_121[5], -3.5946f, -15.0978f, -75.5026f, 2, 1);
	FREEZE_ENTITY_POSITION(iLocal_121[5], 1);
	SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_ld_shirt_01"));
	iLocal_121[6] = CREATE_OBJECT(joaat("prop_porn_mag_03"), -472.7543f, 542.3022f, 119.7628f, 1, 1, 0);
	SET_ENTITY_ROTATION(iLocal_121[6], 6.402527f, -15.68665f, -104.1308f, 2, 1);
	FREEZE_ENTITY_POSITION(iLocal_121[6], 1);
	SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_porn_mag_03"));
	iLocal_121[7] = CREATE_OBJECT(joaat("prop_porn_mag_01"), -471.8675f, 543.6655f, 119.4991f, 1, 1, 0);
	SET_ENTITY_ROTATION(iLocal_121[7], -8.3642f, 1.9344f, 2.6889f, 2, 1);
	FREEZE_ENTITY_POSITION(iLocal_121[7], 1);
	SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_porn_mag_01"));
	iLocal_121[8] = CREATE_OBJECT(joaat("prop_golf_iron_01"), -473.4f, 536.8035f, 123.2482f, 1, 1, 0);
	iLocal_121[9] = CREATE_OBJECT(joaat("prop_cs_rub_binbag_01"), -473.195f, 537.2585f, 123.3303f, 1, 1, 0);
	SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_cs_rub_binbag_01"));
	iLocal_121[10] = CREATE_OBJECT(joaat("prop_golf_bag_01"), -473.4f, 536.8035f, 123.2482f, 1, 1, 0);
...
void func_151()
{
	if (!IS_PED_INJURED(uLocal_58) && !IS_PED_INJURED(uLocal_57))
	{
		...
		{
			if (_CAN_PED_SEE_PED(uLocal_58, PLAYER_PED_ID()) || _CAN_PED_SEE_PED(uLocal_57, PLAYER_PED_ID()))
			{
				if (((IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uLocal_58) || IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uLocal_58)) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uLocal_57)) || IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uLocal_57))
				{
					if (iLocal_135 == -1)
					{
			...
			if ((iLocal_135 != -1 && GET_GAME_TIMER() > iLocal_135 + 500) || IS_PED_SHOOTING(PLAYER_PED_ID()))
			{
				func_158();
			}
		}
	...
	if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), -471.1757f, 535.356f, 124.8557f, 3f, 2.5f, 1.5f, 0, 1, 0))
	{
		func_155();
	}
	if (DOES_ENTITY_EXIST(uLocal_57))
	...
	if (DOES_ENTITY_EXIST(uLocal_58))
	{
		if (func_154(uLocal_58) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_58, PLAYER_PED_ID(), 1))
		{
			func_152();
		}
	}
	if (DOES_ENTITY_EXIST(uLocal_57))
	{
		if (func_154(uLocal_57) || HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_57, PLAYER_PED_ID(), 1))
		{
			func_152();
		}
	}
	if (!IS_PED_INJURED(uLocal_58))
	{
		if (!IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_58, 250f, 250f, 250f, 0, 1, 0) || IS_ENTITY_IN_WATER(uLocal_58))
		{
			iLocal_49 = 11;
		}
	}
...
void func_156()
{
	...
	{
		CLEAR_PED_TASKS(uLocal_58);
		TASK_SMART_FLEE_COORD(uLocal_58, GET_ENTITY_COORDS(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 1), 150f, -1, 0, 0);
		SET_PED_KEEP_TASK(uLocal_58, 1);
	}
	iLocal_49 = 11;
}
...
int func_157(var uParam0)
{
	...
	{
		if (!IS_PED_IN_ANY_VEHICLE(uParam0, 0) && IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uParam0, 1.5f, 1.5f, 8f, 0, 1, 2))
		{
			if (GET_ENTITY_SPEED(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)) > 4f)
			{
				return 1;
			}
		}
...
int func_161()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		if (VMAG2(GET_ENTITY_VELOCITY(PLAYER_PED_ID())) > 1369f && !func_172())
		{
			return 0;
		}
	}
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_192(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_195()
{
	...
	func_201(&uVar0, GET_CLOCK_SECONDS());
	func_200(&uVar0, GET_CLOCK_MINUTES());
	func_199(&uVar0, GET_CLOCK_HOURS());
	func_198(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_197(&uVar0, GET_CLOCK_MONTH());
	func_196(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_212()) || Global_105612) || Global_25767) || func_211()) || func_71(8, -1)) || func_210()) || func_209()) || func_208()) || func_207()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_212()) || Global_25767) || func_211()) || func_71(8, -1)) || func_208()) || func_210()) || func_209()) || func_207()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_212()) || Global_105612) || Global_25767) || func_211()) || func_71(8, -1)) || func_208()) || func_210()) || func_209()) || func_207()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_212()) || Global_105612) || Global_25767) || func_211()) || func_71(8, -1)) || func_210()) || func_209()) || func_207()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_212() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_71(8, -1)) || func_207()) || func_206()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_212()) || Global_25767) || func_211()) || func_71(8, -1)) || func_209()) || func_208()) || func_207()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_212()) || func_209()) || Global_105612) || Global_25767) || func_211()) || Global_37584) || func_71(8, -1)) || func_208()) || func_206()) || func_207()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_212()) || Global_105612) || Global_25767) || func_211()) || func_71(8, -1)) || func_208()) || func_206()) || func_210()) || func_209()) || func_207())
						{
							return 0;
						}
						break;
...
void func_221()
{
	...
	if (iLocal_150 && !iLocal_149)
	{
		...
		if (DOES_ENTITY_EXIST(uLocal_58))
		{
			if (!IS_PED_INJURED(uLocal_58))
			{
				SET_PED_CONFIG_FLAG(uLocal_58, 317, 1);
				if (!IS_PED_IN_ANY_VEHICLE(uLocal_58, 0))
				{
					RESET_PED_LAST_VEHICLE(uLocal_58);
				}
