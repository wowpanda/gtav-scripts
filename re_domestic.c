...
void func_14()
{
	...
	Global_105220.f_18545.f_383 = func_41() + 1;
	func_18(-1, 0);
	func_15();
	iLocal_46 = 3;
}
...
void func_48(int iParam0, void fParam1, void fParam2, int iParam3)
{
	AUDIO::_PLAY_AMBIENT_SPEECH_WITH_VOICE(iParam0, fParam1, fParam2, func_49(iParam3), 0);
}
...
void func_76()
{
	switch (iLocal_102)
	{
		...
		case 4:
			...
			{
				func_108("DOM_GOLF", -1);
				func_107(&(Global_105220.f_18950), 16);
				if (func_53() == 0)
				{
					func_106(&(Global_105220.f_18950.f_24), 1);
				}
				else if (func_53() == 1)
				{
					func_106(&(Global_105220.f_18950.f_24), 4);
				}
				else if (func_53() == 2)
				{
					func_106(&(Global_105220.f_18950.f_24), 2);
				}
...
void func_77(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	func_78(Global_105220.f_28021[iParam0 /*29*/].f_17, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
void func_81(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_105220.f_20535.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_83() /*12171*/].f_7688.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_105220.f_20535.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_83() /*12171*/].f_7688.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_85(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_83() /*12171*/].f_7688.f_10, iParam0);
}
...
int func_91(int iParam0, int iParam1)
{
	...
	if (func_101(&Global_4267702))
	{
		if (func_99(&Global_4267702, iParam0))
		{
			return 0;
		}
...
void func_95(var uParam0)
{
	...
	func_97(uParam0, (Global_4267701 - 0.5f));
}
...
void func_113()
{
	...
	if ((iLocal_96 - iLocal_95) > 60000)
	{
		...
		if (!PED::IS_PED_INJURED(iLocal_54))
		{
			...
			{
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_54, vLocal_89, 1f, -1, 0.25f, 0, 1193033728);
			}
			else
			{
...
int func_138()
{
	switch (func_139(&Global_25336, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_142(iParam0, Global_35905);
}
...
void func_148(int iParam0, void fParam1, int iParam2)
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, fParam1, func_49(iParam2), 1);
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_212()) || Global_25279) || func_211()) || func_71(8, -1)) || func_208()) || func_210()) || func_209()) || func_207()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_212()) || Global_104267) || Global_25279) || func_211()) || func_71(8, -1)) || func_208()) || func_210()) || func_209()) || func_207()) || Global_105220.f_7659.f_919[iVar0] == 5) || Global_36452 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_212()) || Global_104267) || Global_25279) || func_211()) || func_71(8, -1)) || func_210()) || func_209()) || func_207()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_212() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_71(8, -1)) || func_207()) || func_206()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_212()) || Global_25279) || func_211()) || func_71(8, -1)) || func_209()) || func_208()) || func_207()) || Global_105220.f_7659.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
...
void func_222(int iParam0)
{
	...
	if (func_174())
	{
		...
		func_225(30000);
		StringCopy(&cVar0, func_224(Global_105209, 1), 64);
