...
void __EntryFunction__()
{
	...
	if (!func_262(&iVar64, &Var0, vVar61, 1f))
	{
		func_261();
	...
	while (true)
	{
		...
		func_200(Var0);
		func_193(&iLocal_93, &(Var0.f_9), vVar61);
		if (Var0 == 44)
		{
			func_185(&Var0, vVar61, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_94);
			func_184();
		}
		else if (Var0 == 45)
		{
			func_185(&Var0, vVar61, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_95);
			func_182(&Var0);
		}
		if (func_167(&Var0, 0))
		{
...
void func_182(int iParam0)
{
	...
	if ((GET_GAME_TIMER() - iLocal_98) > 1250)
	{
		if (func_126(iParam0->f_28[0]) && !IS_ENTITY_ON_SCREEN(iParam0->f_28[0]))
		{
			if (func_126(PLAYER_PED_ID()) && !func_183(PLAYER_PED_ID(), iParam0->f_28[0], 50f, 1))
			{
				vVar0 = { GET_ENTITY_COORDS(iParam0->f_28[0], 1) };
				vVar3 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
				fVar7 = (vVar3.x - vVar0.x);
				fVar8 = (vVar3.y - vVar0.y);
				if (fVar8 != 0f)
				{
					fVar6 = ATAN2(fVar7, fVar8);
				}
				else if (fVar7 < 0f)
				{
					fVar6 = -90f;
				...
				SET_ENTITY_HEADING(iParam0->f_28[0], fVar6);
			}
		}
...
bool func_183(var uParam0, var uParam1, float fParam2, int iParam3)
{
...
void func_184()
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_96, "SET_COLOUR");
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_96, "SET_DISTANCE");
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(10f);
	END_SCALEFORM_MOVIE_METHOD();
	SET_TEXT_RENDER_ID(uLocal_97);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	DRAW_SCALEFORM_MOVIE(uLocal_96, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((GET_GAME_TIMER() - iLocal_98) > 1250)
	{
		PLAY_SOUND_FROM_COORD(uLocal_99, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_98 = GET_GAME_TIMER();
	}
}

int func_185(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_173(2))
		{
			if (!func_145())
			{
				if ((func_126(PLAYER_PED_ID()) && func_126(iParam0->f_28[0])) && func_192(PLAYER_PED_ID(), vParam1, 1) < 20f)
				{
			...
			if (func_192(PLAYER_PED_ID(), vParam1, 1) < 20f && *uParam8 == 1)
			{
...
void func_193(int iParam0, var uParam1, vector3 vParam2)
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_204(uParam1) || !IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_204(uParam1) && uParam1->f_4 == 0) && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_216(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
int func_219(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_221(GET_ENTITY_COORDS(iParam1, 1) - GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		vVar3 = { func_221(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_226(var uParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_227(var uParam0, float fParam1)
{
	...
	{
		if (func_228(uParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_228(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_221(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_221(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_220(vVar3, vVar0);
...
int func_229(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (IS_PED_SHOOTING(PLAYER_PED_ID()))
...
void func_240()
{
	uLocal_96 = REQUEST_SCALEFORM_MOVIE("digiscanner");
	while (!HAS_SCALEFORM_MOVIE_LOADED(uLocal_96))
	{
		WAIT(0);
	}
	...
	if (IS_NAMED_RENDERTARGET_REGISTERED("digiscanner"))
	{
		uLocal_97 = GET_NAMED_RENDERTARGET_RENDER_ID("digiscanner");
	}
	uLocal_99 = GET_SOUND_ID();
	iLocal_98 = GET_GAME_TIMER();
}
...
int func_242(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 3:
			SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(2314.546f, 2576.33f, 44.7f, 2326.446f, 2579.608f, 47.6645f, 0, 1);
			CLEAR_AREA_OF_VEHICLES(2321.252f, 2578.851f, 46.7f, 10f, 0, 0, 0, 0, 0, 0);
			iVar3 = 0;
			while (iVar3 <= (iVar0 - 1))
			{
...
void func_243(var uParam0, var uParam1, vector3 vParam2, float fParam5)
{
	func_244(uParam0);
...
int func_251(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if ((func_126(uParam0->f_28[0]) && DOES_ENTITY_EXIST(uParam0->f_41[0])) && DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
...
int func_262(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_263((*iParam0)[0], vParam2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_263((*iParam0)[iVar0], vParam2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_263(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_264(Var1.f_6, vParam1, fParam4, 0))
	{
...
int func_264(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_265(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 45)
	{
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(2314.546f, 2576.33f, 44.7f, 2326.446f, 2579.608f, 47.6645f, 1, 1);
	}
	if (bParam1)
	{
