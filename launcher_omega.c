...
void func_179(int iParam0)
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_58) > 1250)
	{
		if (func_124(iParam0->f_28[0]) && !ENTITY::IS_ENTITY_ON_SCREEN(iParam0->f_28[0]))
		{
			...
			{
				vVar0 = { ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], 1) };
...
bool func_180(int iParam0, int iParam1, float fParam2, int iParam3)
{
...
int func_182(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6)
{
	var uVar0;
...
void func_190(int iParam0, char* sParam1, vector3 vParam2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_201(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_201(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_216(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_218(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
int func_225(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_218(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
