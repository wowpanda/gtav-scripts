	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_104307[Var0 /*10*/].f_9 != -1)
			{
				...
				func_278(&(Global_104307[Var0 /*10*/].f_9));
			}
		}
		func_262(&Var0, 1);
	}
...
void func_179(int iParam0)
{
	...
	{
		if (func_124(iParam0->f_28[0]) && !ENTITY::IS_ENTITY_ON_SCREEN(iParam0->f_28[0]))
		{
			if (func_124(PLAYER::PLAYER_PED_ID()) && !func_180(PLAYER::PLAYER_PED_ID(), iParam0->f_28[0], 50f, 1))
			{
...
bool func_180(int iParam0, int iParam1, float fParam2, bool bParam3)
{
...
int func_182(int iParam0, vector3 vParam1, char[4] cParam2, void fParam3, int iParam4, char* sParam5, var uParam6)
{
	var uVar0;
	...
	if (!*uParam6 == 3)
	{
		if (func_170(2))
		{
			if (!func_143())
			{
				if ((func_124(PLAYER::PLAYER_PED_ID()) && func_124(iParam0->f_28[0])) && func_189(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f)
				{
			...
			if (func_189(PLAYER::PLAYER_PED_ID(), vParam1, 1) < 20f && *uParam6 == 1)
			{
...
void func_190(int iParam0, void fParam1, vector3 vParam2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
int func_198(int iParam0, bool bParam1)
{
	...
	func_107(*iParam0, &Var0);
	if ((func_235(*iParam0) || func_233(*iParam0)) || Global_71223 == 1)
	{
		return 1;
	}
	if (!TASK::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
int func_213(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
int func_216(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_218(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		vVar1 = { func_218(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_217(vector3 vParam0, vector3 vParam1)
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}
...
int func_225(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_218(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
{
	if ((func_234() && Global_92955.f_11 == 6) && iParam0 == func_162(&(Global_92955.f_3), 0))
	{
		return 1;
	}
	return 0;
...
void func_247(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_248(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if ((func_124(uParam0->f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0])) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
...
bool func_253(int iParam0, void fParam1)
{
