...
void func_6()
{
	...
	while (IS_CUTSCENE_PLAYING() || !bVar1)
	{
		...
		if (!DOES_ENTITY_EXIST(uLocal_30))
		{
			iVar0 = GET_PLAYERS_LAST_VEHICLE();
			if (DOES_ENTITY_EXIST(iVar0))
			{
				...
				{
					func_8(&uLocal_30, 1, -1.3389f, 544.1759f, 172.7673f, 124.3018f, 1, 1);
				}
			}
...
int func_8(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7)
{
	var uVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/], vParam2, fParam5, 0, 0, 0);
				...
				func_69(uParam0, &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5)
		{
			...
			if (HAS_MODEL_LOADED(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*uParam0 = CREATE_VEHICLE(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/], vParam2, fParam5, 0, 0, 0);
				...
				func_69(uParam0, &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				SET_VEHICLE_ENVEFF_SCALE(*uParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (GET_ENTITY_MODEL(*uParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (HAS_MODEL_LOADED(Var5))
			{
				...
				*uParam0 = CREATE_VEHICLE(Var5, vParam2, fParam5, 1, 1, 0);
				...
				func_69(uParam0, &(Var5.f_31), &(Var5.f_81));
				SET_VEHICLE_ENVEFF_SCALE(*uParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_9(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	var uVar0;
	var uVar1;
	int iVar2;
	...
	if ((func_75(iParam0) && DOES_ENTITY_EXIST(*uParam1)) && IS_VEHICLE_DRIVEABLE(*uParam1, 0))
	{
		...
		if (GET_VEHICLE_MOD_KIT(*uParam1) >= 0 && func_14(*uParam1, 0, &uVar0))
		{
			func_13(uParam1, &(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_106565.f_2357.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_106565.f_20112[iParam0 /*43*/].f_31 = func_12(*uParam1);
...
int func_14(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if ((!func_42(iVar0, bParam1, uParam2) && !func_41(PLAYER_ID())) && !func_25(iParam0))
	{
		return 0;
	}
...
{
	if (func_40(PLAYER_ID()) || func_39(PLAYER_ID()))
	{
		if (func_26(iParam0))
		{
			return 1;
...
int func_27(int iParam0)
{
	...
	if (func_28(GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
	return 0;
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_46(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_64(iParam0, 0, 0)) || func_64(iParam0, 1, 0)) || func_64(iParam0, 2, 0)) || func_63(iParam0) != 145) || func_62(iParam0)) || func_61(iParam0)) || func_15(iParam0)) || func_60(iParam0)) || !func_50(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_61(iParam0))
		{
		}
...
int func_69(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_38(GET_ENTITY_MODEL(*uParam0), 1) && GET_VEHICLE_MOD(*uParam0, 24) != func_72(*uParam0, ((*uParam1)[38] - 1)))
	{
		SET_VEHICLE_MOD(*uParam0, 24, func_72(*uParam0, ((*uParam1)[38] - 1)), 0);
	}
	func_71(uParam0);
	if (func_70(*uParam0))
	{
...
int func_76(int iParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;
	struct<82> Var1;
	int iVar99;
...
void func_77(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	func_78(vParam0, vParam3, fParam6, vParam7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_78(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, var uParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	var uVar0;
	bool bVar1;
	bool bVar2;
	...
	if (DOES_ENTITY_EXIST(uVar0))
	{
		...
		if (IS_VEHICLE_DRIVEABLE(uVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_85(uVar0, vParam0, vParam3, fParam6))
					{
						bVar1 = true;
					}
				}
...
void func_81()
{
	...
	{
		if (func_84(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
			iVar0 = func_83(PLAYER_PED_ID());
...
int func_85(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((((((((((((((func_86(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar9) || func_86(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar9, vVar15)) || func_86(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar12, vVar15)) || func_86(vVar18[0 /*3*/], vVar18[1 /*3*/], vVar6, vVar12)) || func_86(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar9)) || func_86(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar9, vVar15)) || func_86(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar12, vVar15)) || func_86(vVar18[1 /*3*/], vVar18[3 /*3*/], vVar6, vVar12)) || func_86(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar9)) || func_86(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar9, vVar15)) || func_86(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar12, vVar15)) || func_86(vVar18[3 /*3*/], vVar18[2 /*3*/], vVar6, vVar12)) || func_86(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar9)) || func_86(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar9, vVar15)) || func_86(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar12, vVar15)) || func_86(vVar18[2 /*3*/], vVar18[0 /*3*/], vVar6, vVar12))
		{
			return 1;
		}
	}
...
void func_89(vector3 vParam0, vector3 vParam3, float fParam6, vector3 vParam7, float fParam10, vector3 vParam11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	func_78(vParam0, vParam3, fParam6, vParam7, fParam10, vParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

bool func_90(vector3 vParam0, int iParam3)
{
	return func_91(Global_97130.f_2890.f_12.f_66, vParam0, iParam3);
}

int func_91(int iParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
	vector3 vVar3;
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_91043[iVar0]))
		{
			if (Global_91043[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || GET_ENTITY_MODEL(iParam0) == func_103(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_105()
{
	...
	while (!HAS_CUTSCENE_LOADED())
	{
		...
		{
			func_106("FRANKLIN", PLAYER_PED_ID(), 0, 2);
		}
		WAIT(0);
	}
}
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_111(GET_ENTITY_MODEL(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_111(GET_ENTITY_MODEL(iParam0), iVar1, 14, 4);
		}
	}
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_113(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
int func_128(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_132(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_121(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_121(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = _GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_113(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_195()
{
	SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_30);
...
void func_199(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_201(Global_106565.f_18527[iVar0], &vVar2, &fVar5))
			{
