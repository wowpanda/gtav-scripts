...
void __EntryFunction__()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("ambient_tonyacall")) > 1)
	{
	...
	while (true)
	{
		...
		{
			vLocal_46 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
		}
...
int func_1()
{
	...
	if (!IS_ENTITY_DEAD(uLocal_38, 0))
	{
		vVar3 = { GET_ENTITY_COORDS(uLocal_38, 1) };
	}
	else
	{
		vVar3 = { 408.5002f, -1624.583f, 29.2928f };
	}
	if ((VDIST2(vVar0, vVar3) > 10000f || IS_ENTITY_DEAD(uLocal_38, 0)) || func_4())
	{
		if (VDIST2(vVar0, vVar3) > 10000f)
		{
		}
		if (IS_ENTITY_DEAD(uLocal_38, 0))
		{
	...
	{
		case 0:
			if (DOES_ENTITY_EXIST(uLocal_38) && !IS_ENTITY_DEAD(uLocal_38, 0))
			{
				if (IS_ENTITY_AT_COORD(uLocal_38, vLocal_57, 1f, 1f, 1f, 0, 1, 0))
				{
					CLEAR_SEQUENCE_TASK(&uVar6);
					OPEN_SEQUENCE_TASK(&uVar6);
					TASK_ACHIEVE_HEADING(0, fLocal_60, 0);
					...
					TASK_PERFORM_SEQUENCE(uLocal_38, uVar6);
					CLEAR_SEQUENCE_TASK(&uVar6);
					iLocal_40 = 1;
				}
			}
		...
		case 1:
			if (DOES_ENTITY_EXIST(uLocal_38) && !IS_ENTITY_DEAD(uLocal_38, 0))
			{
				if (GET_SEQUENCE_PROGRESS(uLocal_38) == 1)
				{
					if (!DOES_ENTITY_EXIST(uLocal_39))
					{
						if (IS_ENTITY_PLAYING_ANIM(uLocal_38, "amb@world_human_stand_mobile@female@standing@call@enter", "enter", 3))
						{
							fVar7 = GET_ENTITY_ANIM_CURRENT_TIME(uLocal_38, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
							if (fVar7 >= 0.157f)
							{
								uLocal_39 = CREATE_OBJECT(joaat("prop_phone_ing"), 1f, 1f, 1f, 1, 1, 0);
								ATTACH_ENTITY_TO_ENTITY(uLocal_39, uLocal_38, GET_PED_BONE_INDEX(uLocal_38, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
							}
						}
					}
				}
				else if (GET_SEQUENCE_PROGRESS(uLocal_38) == 2)
				{
...
void func_2()
{
	if (DOES_ENTITY_EXIST(uLocal_38) && !IS_ENTITY_DEAD(uLocal_38, 0))
	{
		if (GET_SEQUENCE_PROGRESS(uLocal_38) == 1)
		{
			if (DOES_ENTITY_EXIST(uLocal_39))
			{
				DELETE_OBJECT(&uLocal_39);
				TASK_LOOK_AT_ENTITY(uLocal_38, PLAYER_PED_ID(), -1, 0, 2);
			}
		}
	}
	if (DOES_ENTITY_EXIST(uLocal_38) && !IS_ENTITY_DEAD(uLocal_38, 0))
	{
		if (DOES_ENTITY_EXIST(uLocal_39))
		{
			if (GET_SCRIPT_TASK_STATUS(uLocal_38, 993674639) == 1)
			{
				DELETE_OBJECT(&uLocal_39);
			}
		}
...
int func_4()
{
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_ENTITY_DEAD(uLocal_38, 0))
	{
		if (IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), uLocal_38) || IS_PED_SHOOTING(PLAYER_PED_ID()))
		{
			if (DOES_ENTITY_EXIST(uLocal_39))
			{
				DETACH_ENTITY(uLocal_39, 1, 1);
			}
			STOP_SCRIPTED_CONVERSATION(0);
			if (GET_SCRIPT_TASK_STATUS(uLocal_38, 1805844857) != 1)
			{
				SET_PED_KEEP_TASK(uLocal_38, 1);
				TASK_SMART_FLEE_PED(uLocal_38, PLAYER_PED_ID(), 1000f, -1, 0, 0);
				return 1;
			}
		}
	}
...
int func_22()
{
	...
	GET_CLOSEST_PED(vVar0, fLocal_41, 1, 1, &uVar3, 0, 1, -1);
	if (DOES_ENTITY_EXIST(uVar3) && !IS_ENTITY_DEAD(uVar3, 0))
	{
		...
		if (iVar4 == joaat("ig_tonya"))
		{
			...
			SET_PED_NAME_DEBUG(uLocal_38, "TONYA");
			SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_38, 1862763509);
			func_25(&uLocal_63, 3, uLocal_38, "TONYA", 1, 1);
			func_24();
			if (!func_23(vLocal_57))
			{
				if (GET_SCRIPT_TASK_STATUS(uLocal_38, 713668775) != 1)
				{
					TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_38, vLocal_57, 1f, -1, 0.25f, 0, fLocal_60);
					SET_PED_KEEP_TASK(uLocal_38, 1);
				}
				return 1;
			}
...
void func_24()
{
	...
	if (DOES_ENTITY_EXIST(uLocal_38) && !IS_ENTITY_DEAD(uLocal_38, 0))
	{
		vVar0 = { GET_ENTITY_COORDS(uLocal_38, 1) };
		if (func_23(vLocal_57))
		{
			...
			if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
			{
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 407.4285f, -1626.572f, 27.29278f, 412.8245f, -1620.167f, 33.29278f, 6f, 0, 1, 0))
				{
					vLocal_57 = { vLocal_53 };
					fLocal_60 = fLocal_56;
				}
...
void func_27()
{
	...
	{
		if (IS_ENTITY_OCCLUDED(uLocal_38))
		{
			DELETE_PED(&uLocal_38);
		}
		else
		{
			SET_PED_AS_NO_LONGER_NEEDED(&uLocal_38);
		}
	}
	TERMINATE_THIS_THREAD();
}
