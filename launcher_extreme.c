...
void __EntryFunction__()
{
	...
	if (!func_267(&iVar64, &Var0, vVar61, 1f))
	{
		func_266();
	...
	if (Var0 == 17)
	{
		uLocal_97 = ADD_SCENARIO_BLOCKING_AREA(vVar61 - Vector(40f, 40f, 40f), vVar61 + Vector(40f, 40f, 40f), 0, 1, 1, 1);
		SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_SALTON_DIRT_BIKE", 0);
	}
	else if (Var0 == 18)
	{
		uLocal_97 = ADD_SCENARIO_BLOCKING_AREA(-1040f, -2870f, 0f, -910f, -2740f, 50f, 0, 0, 1, 1);
	}
	...
	while (true)
	{
		...
		func_202(Var0);
		func_195(&iLocal_94, &(Var0.f_9), vVar61);
		if (Var0 == 18)
		{
			func_194(&Var0);
			func_189(&Var0, vVar61, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (Var0 == 19)
		{
			func_194(&Var0);
			if (HAS_SOUND_FINISHED(uLocal_96))
			{
				func_189(&Var0, vVar61, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_188() && func_187(Var0.f_28[0])) && !IS_ANY_SPEECH_PLAYING(Var0.f_28[0])) && HAS_SOUND_FINISHED(uLocal_96)) && REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", 0, -1)) && REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", 0, -1)) && REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", 0, -1))
			{
				PLAY_SOUND_FROM_ENTITY(uLocal_96, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
			}
			if ((iLocal_95 == 0 && func_187(PLAYER_PED_ID())) && IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vVar61, Var0.f_15, Var0.f_15, Var0.f_15, 0, 0, 0))
			{
				vVar69 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
				if (vVar69.z < 100f)
				{
					iLocal_95 = 1;
...
void func_145()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if (func_146(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_146(var uParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
int func_162()
{
	return func_163(GET_THIS_SCRIPT_NAME(), 0);
}
...
var func_166(vector3 vParam0, int iParam3)
{
	var uVar0;
	
	uVar0 = ADD_BLIP_FOR_COORD(vParam0);
	SET_BLIP_SCALE(uVar0, func_167(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
int func_169(var uParam0)
{
	if (*uParam0 == 18)
	{
		if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -954.5357f, -2760.553f, 11.91636f, -947.6847f, -2749.719f, 15.63161f, 26f, 0, 1, 0))
		{
			if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
			...
			else if ((!func_170(PLAYER_PED_ID(), -828834893) && func_187(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0))) && func_146(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 3f, 1, 1056964608, 0, 1, 0))
			{
				TASK_LEAVE_ANY_VEHICLE(PLAYER_PED_ID(), 0, 0);
			}
		}
	...
	switch (uParam0->f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
				{
					if (func_187(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)))
					{
...
int func_189(int iParam0, vector3 vParam1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_187(PLAYER_PED_ID()) && func_187(iParam0->f_28[0])) && !func_188()) && (GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_193(PLAYER_PED_ID(), vParam1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_192(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)
{
...
float func_193(var uParam0, vector3 vParam1, int iParam4)
{
	vector3 vVar0;
...
void func_194(int iParam0)
{
	if (_0xB56BBBCC2955D9CB())
	{
		...
		{
			_0x2A56C06EBEF2B0D9("Dom", iParam0->f_28[0], 0);
		}
	}
}

void func_195(int iParam0, var uParam1, vector3 vParam2)
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (!IS_STRING_NULL_OR_EMPTY(uParam1))
		{
			...
			{
				if (func_193(PLAYER_PED_ID(), vParam2, 1) <= 100f)
				{
					func_198(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_193(PLAYER_PED_ID(), vParam2, 1) > 120f)
				{
					func_200(iParam0);
				}
			}
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_206(uParam1) || !IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_206(uParam1) && uParam1->f_4 == 0) && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_215(int iParam0, float fParam1)
{
	...
	if (func_187(PLAYER_PED_ID()) && func_187(iParam0))
	{
...
int func_218(var uParam0, vector3 vParam1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	vector3 vVar1;
	var uVar4;
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_223(GET_ENTITY_COORDS(iParam1, 1) - GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		vVar3 = { func_223(GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_227(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_187(PLAYER_PED_ID()) && func_187(uParam0))
	{
...
int func_228(var uParam0, float fParam1, bool bParam2, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_229(var uParam0, float fParam1)
{
	...
	{
		if (func_230(uParam0, vVar1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_230(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	vector3 vVar0;
	vector3 vVar3;
	float fVar6;
	
	vVar0 = { func_223(vParam1 - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_223(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_222(vVar3, vVar0);
...
int func_231(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (IS_PED_SHOOTING(PLAYER_PED_ID()))
...
void func_243(var uParam0, vector3 vParam1, float fParam4)
{
	func_244(uParam0, iLocal_93, vParam1, fParam4, 26);
...
void func_244(var uParam0, int iParam1, vector3 vParam2, var uParam5, int iParam6)
{
	func_245(uParam0);
		...
		case 2:
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_250(&(uParam0->f_28[0]), 52, -63.8f, -809.5f, 321.8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
					...
					GIVE_WEAPON_TO_PED(uParam0->f_28[0], joaat("gadget_parachute"), 1, 0, 0);
...
int func_250(var uParam0, int iParam1, vector3 vParam2, float fParam5, char* sParam6, int iParam7)
{
	if (func_251(uParam0, iParam1, vParam2, fParam5, 1))
	{
		if (DOES_ENTITY_EXIST(*uParam0))
		{
			if (!IS_ENTITY_DEAD(*uParam0, 0))
...
int func_251(var uParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	int iVar0;
		...
		case 2:
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_250(&(uParam0->f_28[0]), 52, -954.19f, -2760.05f, 14.64f, -31.79f, "EXTREME LAUNCHER RC", 1))
				{
					...
					SET_ENTITY_COLLISION(uParam0->f_28[0], 0, 0);
					SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 8, 1, 0, 0);
					TASK_PLAY_ANIM(uParam0->f_28[0], uParam0->f_48, uParam0->f_48.f_1, 8f, -8f, -1, 33281, 0, 0, 0, 0);
					if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
					{
			...
			if (!DOES_ENTITY_EXIST(uParam0->f_35[2]))
			{
				...
				SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uParam0->f_35[2], 0);
				SET_VEHICLE_AUTOMATICALLY_ATTACHES(uParam0->f_35[2], 0, 0);
			}
			if (bVar5)
			{
				iLocal_91 = 3;
...
void func_254(var uParam0, var uParam1, vector3 vParam2, float fParam5)
{
	func_255(uParam0);
...
int func_268(int iParam0, vector3 vParam1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
...
void func_270(int iParam0, bool bParam1)
{
	...
	if (DOES_BLIP_EXIST(uLocal_98))
	{
		REMOVE_BLIP(&uLocal_98);
	}
	func_271(&(iParam0->f_48));
	if (*iParam0 == 17)
	{
		REMOVE_SCENARIO_BLOCKING_AREA(uLocal_97, 0);
		SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_SALTON_DIRT_BIKE", 1);
	}
	else if (*iParam0 == 18)
	{
		REMOVE_SCENARIO_BLOCKING_AREA(uLocal_97, 0);
