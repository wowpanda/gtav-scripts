...
void __EntryFunction__()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("stock_controller")) > 1)
	{
		func_97();
	}
	Global_56478 = 1;
	...
	while (iVar0 < 204)
	{
		if (!Global_52236[iVar0 /*7*/])
		{
			if (Global_52236[iVar0 /*7*/].f_2)
			{
				...
				{
					STAT_GET_INT(Global_52236[iVar0 /*7*/].f_3, &(Global_52236[iVar0 /*7*/].f_5), -1);
				}
				else
				{
					fVar1 = 0f;
					STAT_GET_FLOAT(Global_52236[iVar0 /*7*/].f_3, &fVar1, -1);
					Global_52236[iVar0 /*7*/].f_5 = FLOOR(fVar1);
				}
			}
		}
		iVar0++;
	...
	while (true)
	{
		...
		func_79();
		if (!NETWORK_IS_GAME_IN_PROGRESS() && !func_78(14))
		{
			func_67();
			iVar3 = 16;
...
void func_1()
{
	...
	uVar0 = GET_PLAYER_PED(GET_PLAYER_INDEX());
	...
	while (iVar0 < 80)
	{
		if (Global_48793[iVar0 /*36*/].f_8)
		{
			if (Global_48793[iVar0 /*36*/].f_35 > -1)
			{
				...
				STAT_GET_FLOAT(uVar2, &(Global_48793[iVar0 /*36*/].f_9), -1);
				if (Global_48793[iVar0 /*36*/].f_9 > 0f)
				{
					fVar3 = 0f;
					_0xBED9F5693F34ED17(uVar2, 0, &(Global_48793[iVar0 /*36*/].f_33));
					...
					{
						fVar5 = 0f;
						_0xBED9F5693F34ED17(uVar2, iVar4 + 1, &fVar5);
	...
	if (fVar0 > 1f)
	{
		...
		if (((iVar5 + iVar6) + iVar7) > 0)
		{
			...
			while (iVar2 < 10)
			{
				...
				{
					iVar8 = (iVar8 + FLOOR(Global_106565.f_20558.f_11[iVar2]));
				}
				if (Global_106565.f_20558.f_55[iVar2] > 0)
				{
					iVar8 = (iVar8 + FLOOR(Global_106565.f_20558.f_44[iVar2]));
				}
				if (Global_106565.f_20558.f_88[iVar2] > 0)
				{
					iVar8 = (iVar8 + FLOOR(Global_106565.f_20558.f_77[iVar2]));
				}
				iVar2++;
			}
			iVar9 = 700000000;
...
float func_9(int iParam0, var uParam1)
{
	...
	if (IS_BIT_SET(uParam1, 16))
	{
		fVar0 = (fVar0 - 0.5f);
	}
	if (IS_BIT_SET(uParam1, 17))
	{
		fVar0 = (fVar0 - 0.25f);
	}
	if (IS_BIT_SET(uParam1, 18))
	{
		fVar0 = (fVar0 - 0.1f);
	}
	if (IS_BIT_SET(uParam1, 19))
	{
		fVar0 = (fVar0 - 0.33f);
	}
	if (bVar1)
	...
	if (!IS_BIT_SET(uParam1, 1))
	{
		if (IS_BIT_SET(uParam1, 6))
		{
			fVar6 = 0f;
			if (IS_BIT_SET(uParam1, 8))
			{
				fVar6 = (fVar6 + 0.5f);
			}
			if (IS_BIT_SET(uParam1, 9))
			{
				fVar6 = (fVar6 + 0.25f);
			}
			if (IS_BIT_SET(uParam1, 10))
			{
				fVar6 = (fVar6 + 0.125f);
			}
			if (fVar5 < fVar6)
		...
		if (IS_BIT_SET(uParam1, 11))
		{
			fVar8 = 0f;
			if (IS_BIT_SET(uParam1, 13))
			{
				fVar8 = (fVar8 + 0.5f);
			}
			if (IS_BIT_SET(uParam1, 14))
			{
				fVar8 = (fVar8 + 0.25f);
			}
			if (IS_BIT_SET(uParam1, 15))
			{
				fVar8 = (fVar8 + 0.125f);
			}
			fVar9 = (1f - fVar8);
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_26(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_27()
{
	...
	while (iVar0 < 8)
	{
		if (!IS_BIT_SET(Global_106565.f_20558.f_461[iVar0], 1))
		{
...
void func_41()
{
	...
	while (iVar0 < 204)
	{
		if (!Global_52236[iVar0 /*7*/])
		{
			if (Global_52236[iVar0 /*7*/].f_2)
			{
				...
				if (!Global_52236[iVar0 /*7*/].f_4)
				{
					STAT_GET_INT(Global_52236[iVar0 /*7*/].f_3, &iVar1, -1);
				}
				else
				{
					fVar2 = 0f;
					STAT_GET_FLOAT(Global_52236[iVar0 /*7*/].f_3, &fVar2, -1);
					iVar3 = FLOOR(fVar2);
	...
	while (iVar0 < 80)
	{
		if (!Global_48793[iVar0 /*36*/].f_8)
		{
			...
			fVar5 = (fVar5 + ((GET_RANDOM_FLOAT_IN_RANGE(-Global_51948[iVar4 /*7*/].f_6, Global_51948[iVar4 /*7*/].f_6) * 0.1f) * Global_48793[iVar0 /*36*/].f_9));
...
void func_47()
{
	...
	if (!IS_PLAYER_DEAD(GET_PLAYER_INDEX()))
	{
		...
		uVar1 = GET_PLAYER_PED(GET_PLAYER_INDEX());
		if (IS_PED_IN_ANY_VEHICLE(uVar1, 0))
		{
			iVar2 = GET_VEHICLE_PED_IS_IN(uVar1, 0);
			if (iVar2 != 0)
			{
				if (func_57(iVar2))
				{
		...
		{
			iVar4 = GET_SELECTED_PED_WEAPON(uVar1);
			func_53(iVar4);
			switch (iVar4)
			{
...
void func_49()
{
	...
	{
		if (func_52(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
...
int func_60(int iParam0, var uParam1)
{
	...
	while (iVar0 < 68)
	{
		if (Global_70409.f_484[iVar0] == iParam0)
		{
			...
			{
				if (IS_BIT_SET(Global_70409.f_555[0 /*21*/].f_9, 10) && Global_70409.f_555[0 /*21*/].f_4 == GET_ENTITY_MODEL(iParam0))
				{
					*uParam1 = iVar0;
					return 1;
				}
...
void func_67()
{
	...
	while (iVar0 < GET_NUMBER_OF_EVENTS(0))
	{
		...
		{
			case 140:
				GET_EVENT_DATA(0, iVar0, &uVar1, 1);
				func_77(uVar1);
				bVar4 = true;
				if (NETWORK_IS_GAME_IN_PROGRESS())
				{
				...
				if (bVar4)
				{
					if (DOES_ENTITY_EXIST(uVar1))
					{
						...
						else if (IS_ENTITY_A_VEHICLE(uVar1))
						{
							if (func_72(GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(uVar1)))
							{
								func_2(3, 1);
							}
							func_71(GET_ENTITY_MODEL(uVar1));
						}
						else if (IS_ENTITY_AN_OBJECT(uVar1))
						{
							switch (GET_ENTITY_MODEL(uVar1))
							{
								case -1186769817:
								case 1211559620:
			...
			case 139:
				...
				if (bVar4)
				{
					if (DOES_ENTITY_EXIST(uVar1))
					{
						if (IS_ENTITY_A_PED(uVar1))
						{
							iVar3 = GET_PED_INDEX_FROM_ENTITY_INDEX(uVar1);
							if (func_48() == 0 && iVar3 != PLAYER_PED_ID())
							{
								if (IS_ENTITY_DEAD(uVar1, 0) || IntToFloat(GET_ENTITY_HEALTH(uVar1)) < (0.5f * IntToFloat(GET_PED_MAX_HEALTH(iVar3))))
								{
									if (IS_ENTITY_A_PED(uVar1) && IS_PED_HUMAN(GET_PED_INDEX_FROM_ENTITY_INDEX(uVar1)))
									{
						...
						{
							func_68(GET_ENTITY_MODEL(uVar1));
							func_2(111, 1);
						}
						else if (IS_ENTITY_AN_OBJECT(uVar1))
						{
...
{
	if (GET_VEHICLE_MOD_KIT(uParam0) >= 0)
	{
		if (GET_VEHICLE_MOD(uParam0, 0) != -1)
		{
			return 1;
		}
		if (GET_VEHICLE_MOD(uParam0, 3) != -1)
		{
			return 1;
		}
		if (GET_VEHICLE_MOD(uParam0, 4) != -1)
		{
			return 1;
		}
		...
		if (GET_VEHICLE_MOD(uParam0, 6) != -1)
		{
			return 1;
		}
		...
		if (GET_VEHICLE_MOD(uParam0, 11) != -1)
		{
			return 1;
		}
		if (GET_VEHICLE_MOD(uParam0, 12) != -1)
		{
			return 1;
		}
		if (GET_VEHICLE_MOD(uParam0, 13) != -1)
		{
			return 1;
		}
		if (GET_VEHICLE_MOD(uParam0, 14) != -1)
		{
			return 1;
		}
		if (GET_VEHICLE_MOD(uParam0, 15) != -1)
		{
			return 1;
		}
		if (GET_VEHICLE_MOD(uParam0, 16) != -1)
		{
			return 1;
		}
		if (GET_VEHICLE_MOD(uParam0, 23) != -1)
		{
			return 1;
		}
		if (GET_VEHICLE_MOD(uParam0, 24) != -1)
		{
			return 1;
		}
		if (GET_VEHICLE_MOD(uParam0, 1) != -1)
		{
			return 1;
		}
		if (GET_VEHICLE_MOD(uParam0, 2) != -1)
		{
			return 1;
		}
		if (GET_VEHICLE_MOD(uParam0, 8) != -1)
		{
			return 1;
		}
		if (GET_VEHICLE_MOD(uParam0, 9) != -1)
		{
			return 1;
		}
		if (IS_TOGGLE_MOD_ON(uParam0, 18))
		{
			return 1;
		}
		if (IS_TOGGLE_MOD_ON(uParam0, 22))
		{
			return 1;
		}
...
void func_73(var uParam0)
{
	...
	{
		uVar1 = GET_PED_SOURCE_OF_DEATH(uVar0);
		if (IS_ENTITY_A_VEHICLE(uVar1))
		{
			iVar2 = GET_ENTITY_MODEL(uVar1);
			func_76(iVar2, GET_PED_TYPE(uVar0));
		}
		else
		{
			iVar3 = GET_PED_CAUSE_OF_DEATH(uVar0);
			iVar4 = GET_ENTITY_MODEL(uParam0);
			func_75(iVar3, GET_PED_TYPE(uVar0), iVar4);
		}
	}
...
int func_74(var uParam0)
{
	...
	iVar0 = GET_PED_SOURCE_OF_DEATH(GET_PED_INDEX_FROM_ENTITY_INDEX(uParam0));
	...
	while (iVar0 < 80)
	{
		if (Global_48793[iVar0 /*36*/].f_8)
		{
			...
			if (iVar1 > -1)
			{
				...
				STAT_SET_INT(Global_51674[iVar1 /*7*/].f_3[iParam0], iVar2, 1);
			}
		}
		iVar0++;
	}
			...
			if ((Global_48793[iVar1 /*36*/].f_32 > 0f && Global_48793[iVar1 /*36*/].f_31 > 0f) && Global_48793[iVar1 /*36*/].f_9 > 0f)
			{
				...
				if (fVar16 != 1f)
				{
					...
					while (iVar3 <= 15)
					{
						...
						Global_48793[iVar1 /*36*/].f_14[iVar3] = (Global_48793[iVar1 /*36*/].f_14[iVar3] * (GET_RANDOM_FLOAT_IN_RANGE(0.95f, 1.05f) + (fVar18 * fVar17)));
						if (iVar3 == 15)
						{
...
void func_93()
{
	...
	if (!Global_106565.f_20558.f_101)
	{
		...
		while (iVar0 < 80)
		{
			if (!Global_48793[iVar0 /*36*/].f_8)
			{
				Global_48793[iVar0 /*36*/].f_9 = GET_RANDOM_FLOAT_IN_RANGE(15f, 290f);
			}
			iVar0++;
		}
		iVar0 = 0;
		...
		while (iVar1 <= 15)
		{
			...
			while (iVar0 < 80)
			{
				...
				Global_48793[iVar0 /*36*/].f_9 = (Global_48793[iVar0 /*36*/].f_9 * GET_RANDOM_FLOAT_IN_RANGE(fVar2, fVar3));
				Global_48793[iVar0 /*36*/].f_9 = func_92(func_91(ABSF(Global_48793[iVar0 /*36*/].f_9), 3.5f), 290f);
				iVar0++;
			}
			iVar1++;
		}
...
void func_94()
{
	...
	iVar2 = GET_RANDOM_INT_IN_RANGE(0, (Global_53955 - 1));
	iVar0 = 0;
	while (iVar0 < 4)
	{
		iVar1 = 0;
