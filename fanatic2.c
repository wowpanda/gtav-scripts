...
void func_43()
{
	...
	{
		func_45(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
...
int func_68(int iParam0, int iParam1, int iParam2)
{
	...
	Global_70793[1 /*14*/] = { func_119(iVar0, iParam1, iParam2) };
	...
	else
	{
		...
		Global_70793[1 /*14*/] = { func_119(iVar0, iParam1, uVar6[iParam1]) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_111(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_111(iParam1), Global_70793[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_111(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, 0);
		}
	}
...
int func_69(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_183(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_64, Global_105220.f_2354.f_539[iVar0 /*65*/].f_63))
		{
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_70793[1 /*14*/] = { func_119(iVar10, iParam1, iParam2) };
		if (!func_109(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_70793[1 /*14*/] = { func_119(iVar10, iVar0, uVar11[iVar0]) };
				if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_70793[1 /*14*/] = { func_119(iVar10, 14, uVar12[iVar1]) };
							func_87(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
							func_102(14);
							if (Global_70791 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_111(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_111(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_111(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
						}
						func_102(iVar0);
						if (Global_70791 == 1)
						{
			...
			{
				Global_70793[1 /*14*/] = { func_119(iVar10, iVar0, func_77(iParam0, iVar0, -1)) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_70793[1 /*14*/] = { func_119(iVar10, 14, uVar15[iVar1]) };
			func_87(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
			func_102(14);
			if (Global_70791 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_111(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_111(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_111(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
		}
		if (Global_70791 == 1)
		{
			iVar2 = 0;
...
{
	Global_70793[1 /*14*/] = { func_119(iParam0, iParam1, iParam2) };
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_111(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_94(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_111(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_89(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_89(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 1) || FILES::_0x341DE7ED1D2A1BFD(func_89(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (FILES::_0x341DE7ED1D2A1BFD(iParam3, -1757550583, 0) || FILES::_0x341DE7ED1D2A1BFD(func_89(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_104(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_105(iParam2)];
	if (iVar0 != 0)
	{
...
int func_106(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_105(iParam1)];
...
int func_110(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_183(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_61, Global_105220.f_2354.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_118(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[0], Global_105220.f_2354.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_118(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[1], Global_105220.f_2354.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_118(&Var1, -99, -99, Global_105220.f_2354.f_539.f_196[2], Global_105220.f_2354.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_121(int iParam0)
{
	...
	func_122(&(Global_70793[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_106(func_125(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_106(func_124(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_106(iVar1, Global_70790, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_128(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_122(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_122(&(Global_70793[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_122(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_111(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_122(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_183(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_183(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_183(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_70793[2 /*14*/] = { func_119(iVar0, 14, iVar4) };
									if (Global_70793[2 /*14*/].f_12 == iVar3)
									{
										if (func_183(iParam0, 14, iVar4))
										{
											if (!func_75(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_70793[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_70793[2 /*14*/] = { func_119(iVar0, iVar2, iVar1) };
						if (!func_75(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_70793[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_70793[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_111(iParam1)) && Global_70793[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_111(iParam1)))
	{
		return 1;
	}
	return 0;
			...
			case 0:
				if (func_22(Local_664.f_28[0]))
				{
					...
					else if (func_3(&uLocal_463, "FAN2AU", "FAN2_WIN", 8, 0, 0, 0))
					{
						...
						{
							BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_664.f_28[0], -1, 2096, 4);
							BRAIN::TASK_LOOK_AT_ENTITY(Local_664.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
							BRAIN::CLEAR_PED_TASKS(Local_664.f_28[0]);
						}
						iLocal_86++;
					}
				}
						...
						else if (func_26())
						{
							if (!iLocal_83)
							{
								if (func_23(uLocal_94[0]))
								{
									...
									{
										BRAIN::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "rcmfanatic2", "celebrate_a", 8f, -8f, -1, 16, 0, 0, 0, 0);
										iLocal_83 = 1;
									}
								}
							}
							if (AUDIO::GET_CURRENT_SCRIPTED_CONVERSATION_LINE() > 3)
							{
								...
								{
									BRAIN::OPEN_SEQUENCE_TASK(&iLocal_657);
									...
									BRAIN::CLOSE_SEQUENCE_TASK(iLocal_657);
									BRAIN::TASK_PERFORM_SEQUENCE(Local_664.f_28[0], iLocal_657);
									BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_657);
									iLocal_86++;
								}
								else
								{
			...
			case 1:
				if (func_242(PLAYER::PLAYER_PED_ID(), Local_664.f_28[0], 1) < 25f)
				{
					if (func_430(Local_664.f_28[0]) && func_23(uLocal_94[1]))
					{
						...
						{
							BRAIN::TASK_PLAY_ANIM(Local_664.f_28[0], "rcmfanatic2", "celebrate_b", 8f, -8f, -1, 16, 0, 0, 0, 0);
							BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_664.f_28[0], -1, 2048, 4);
							BRAIN::TASK_LOOK_AT_ENTITY(Local_664.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
							iLocal_86++;
							SYSTEM::WAIT(0);
						}
...
void func_257()
{
	...
	if (func_260())
	{
		if (func_23(uLocal_94[1]))
		{
			...
			if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_94[1]))
			{
				BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT("Fan2_BikeRoute", ENTITY::GET_ENTITY_COORDS(uLocal_94[1], true), &iVar2);
				fVar3 = BRAIN::WAYPOINT_RECORDING_GET_SPEED_AT_POINT("Fan2_BikeRoute", iVar2);
				fVar4 = 4.8f;
				fVar3 = (fVar3 + fVar4);
				if (iLocal_636 == 2)
				{
			...
			else if (iLocal_642 == 1)
			{
				if (iLocal_636 == 2)
				{
					if (func_22(Local_664.f_28[0]))
					{
						...
						BRAIN::TASK_DRIVE_BY(Local_664.f_28[0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 50f, 100, 1, -957453492);
						iLocal_642 = 0;
					}
				}
			}
...
void func_267()
{
	...
	if (func_23(uLocal_94[1]))
	{
		if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_94[1]))
		{
			BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT("Fan2_BikeRoute", ENTITY::GET_ENTITY_COORDS(uLocal_94[1], true), &iLocal_91);
		}
	}
	if (func_23(uLocal_94[1]) && iLocal_75 != 1)
	{
		if (((((((((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_94[1], 797.1988f, 1150.205f, 297.7592f, 636.3047f, 1194.311f, 323.5919f, 33.75f, 0, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_94[1], 529.2574f, 1137.587f, 244.0458f, 636.8788f, 1189.194f, 321.8586f, 33.75f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_94[1], 595.2324f, 1124.2f, 260.2946f, 497.3239f, 1209.941f, 306.2784f, 30.75f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_94[1], 510.0784f, 1209.081f, 266.6116f, 446.2863f, 1214.47f, 295.9254f, 30.75f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_94[1], 433.5023f, 1264.279f, 259.0397f, 440.9848f, 1213.487f, 275.7219f, 18f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_94[1], 436.5225f, 1281.199f, 263.655f, 435.0948f, 1271.009f, 277.8855f, 11.5f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_94[1], 441.8611f, 1238.9f, 260.4148f, 458.7801f, 1220.361f, 283.4165f, 11.5f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_94[1], 451.619f, 1060.921f, 212.0014f, 434.7438f, 1015.888f, 251.3387f, 14f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_94[1], 442.6712f, 1022.329f, 210.5374f, 387.1651f, 1018.87f, 244.8419f, 14f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_94[1], 374.6094f, 1002.934f, 187.2442f, 353.4876f, 1095.726f, 253.1393f, 14f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_94[1], 362.5221f, 1059.685f, 209.3328f, 302.6266f, 1158.893f, 250.1798f, 14f, 0, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_94[1], 279.92f, 1234.31f, 209.727f, 305.6058f, 1150.027f, 246.7506f, 15f, 0, true, 0))
		{
			...
			if (BRAIN::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_94[1]))
			{
				BRAIN::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT("Fan2_BikeRoute", ENTITY::GET_ENTITY_COORDS(uLocal_94[1], true), &iLocal_92);
			}
	...
	switch (iLocal_75)
	{
		...
		case 2:
			...
			if (func_23(uLocal_94[1]) && func_22(Local_664.f_28[0]))
			{
				...
				BRAIN::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_664.f_28[0], uLocal_94[1], "Fan2_BikeRoute", 786468, 0, 8, -1, -1f, 0, 1073741824);
...
int func_289(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_297() || func_296(Global_4456448.f_148478)) || func_295())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
			iVar1 = func_294(PLAYER::PLAYER_PED_ID(), 0);
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("riot2") && iVar1 == 0) && func_293(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_290(int iParam0)
{
	if (iParam0 != func_292())
	{
		...
		else if ((Global_1312854 && iParam0 == PLAYER::PLAYER_ID()) && func_291(iParam0, 1, 0))
		{
			return Global_2423644[iParam0 /*406*/].f_305.f_1 != -1;
		}
	}
...
void func_311()
{
	if (func_22(Local_664.f_28[0]))
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_664.f_28[0], 591.0933f, 1192.419f, 305.529f, 585.4529f, 1205.725f, 311.526f, 2f, 0, true, 0))
		{
			...
			BRAIN::SET_DRIVE_TASK_DRIVING_STYLE(Local_664.f_28[0], 786468);
		}
	}
}
...
void func_313()
{
	if (iLocal_68 == 1 || iLocal_68 == 2)
	{
		...
		if (func_22(iLocal_655))
		{
			...
			{
				BRAIN::TASK_SMART_FLEE_PED(iLocal_655, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
				func_241(&iLocal_655, 1, 0, 1);
			}
		}
	}
...
void func_335()
{
	if (iLocal_68 == 1 || iLocal_68 == 2)
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 838.8253f, 1255.185f, 352.5532f, 871.4733f, 1263.308f, 364.4244f, 30.25f, 0, true, 0))
		{
			...
			{
				BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(iLocal_653, "Fan2_Jogger1", 0, 0, -1);
			}
			...
			{
				BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(iLocal_654, "Fan2_Jogger2", 0, 0, -1);
			}
		...
		else
		{
			...
			if (func_314(iLocal_653, 1, 1116471296, 1126825984, 0, 0, 0, 0) || func_314(iLocal_654, 1, 1116471296, 1126825984, 0, 0, 0, 0))
			{
				...
				{
					BRAIN::TASK_SMART_FLEE_PED(iLocal_653, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
					BRAIN::TASK_SMART_FLEE_PED(iLocal_654, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
				}
				func_241(&iLocal_653, 1, 0, 1);
				func_241(&iLocal_654, 1, 0, 1);
				...
				if ((MISC::GET_GAME_TIMER() - iLocal_89) > 4000)
				{
					...
					if (iVar1 != 0)
					{
						...
						if ((!VEHICLE::IS_VEHICLE_MODEL(iVar1, joaat("scorcher")) && !VEHICLE::IS_VEHICLE_MODEL(iVar1, joaat("tribike"))) && !VEHICLE::IS_VEHICLE_SEAT_FREE(iVar1, -1, 0))
						{
							...
							if (func_430(PLAYER::PLAYER_PED_ID()))
							{
								BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iVar1, 3000, 0, 2);
							}
							iLocal_89 = MISC::GET_GAME_TIMER();
						}
					}
...
void func_347(var uParam0, var uParam1)
{
	...
	if (!HUD::DOES_BLIP_EXIST(uParam0->f_2))
	{
		...
		HUD::_0x75A16C3DA34F1245(uParam0->f_2, false);
	...
	if (bVar3)
	{
		if (!HUD::DOES_BLIP_EXIST(uParam0->f_3))
		{
			if (uParam0->f_10 < (uParam1->f_126 - 1))
			{
				...
				HUD::_0x75A16C3DA34F1245(uParam0->f_3, false);
...
void func_371()
{
	...
	if (func_237())
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
		{
			BRAIN::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 80);
		}
		iLocal_628 = 0;
		iLocal_629 = 0;
		iLocal_630 = 0;
...
void func_385()
{
	...
	if (func_22(Local_664.f_28[1]))
	{
		...
		BRAIN::TASK_PLAY_ANIM(Local_664.f_28[1], "rcm_fanatic2", "ef_2_rcm_cyclist_punched_out", 8f, -8f, -1, 9, 0, 0, 0, 0);
	...
	if (func_237())
	{
		...
		else if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			if (func_22(Local_664.f_28[0]))
			{
				...
				if (func_22(PLAYER::PLAYER_PED_ID()))
				{
					BRAIN::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(PLAYER::PLAYER_PED_ID(), Local_664.f_28[0], 0f, 0f, 0f, 1f, -1, 1036831949, 1);
				}
			}
		}
		else
...
void func_413()
{
	...
	if (func_328(Local_664.f_28[0], 1, 0, 0, 0))
	{
		...
		BRAIN::TASK_SMART_FLEE_PED(Local_664.f_28[0], PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
		if (func_314(iLocal_653, 1, 1116471296, 1126825984, 0, 0, 0, 0) || func_314(iLocal_654, 1, 1116471296, 1126825984, 0, 0, 0, 0))
		{
			if (func_430(iLocal_653) && func_430(iLocal_654))
			{
	...
	if (Global_71232 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_416(Global_71233, Global_71235, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_427(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
...
{
	return func_429(iParam0, Global_35905);
}
	...
	switch (iLocal_63)
	{
		...
		case 3:
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcm_fanatic2"))
			{
				if (func_22(uParam0->f_28[1]))
				{
					BRAIN::TASK_PLAY_ANIM(uParam0->f_28[1], "rcm_fanatic2", "ef_2_rcm__maryann_biking_cyclist", 8f, -8f, -1, 1, 0, 0, 0, 0);
...
void func_446()
{
	...
	if (func_22(Local_664.f_28[0]))
	{
		BRAIN::TASK_CLEAR_LOOK_AT(Local_664.f_28[0]);
	}
	GRAPHICS::_0xDC459CFA0CCE245B(0);
...
int func_456()
{
	...
	iVar0 = func_457(&(Global_92955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_460()
{
	...
	{
		if (func_455(&(Global_92955.f_3)) > -1)
		{
			return 1;
		}
	}
