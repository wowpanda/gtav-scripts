...
void __EntryFunction__()
{
	...
	fLocal_53 = 7f;
	iLocal_54 = 1;
	fLocal_80 = "random@car_thief@waving_ig_1";
	fLocal_99 = 1f;
	iLocal_119 = 786603;
	iLocal_120 = 786469;
	fLocal_127 = "car_returned_peyote";
	fLocal_128 = "girl_car_returned";
	fLocal_129 = "player_car_returned";
			...
			if (TASK::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			{
				switch (iLocal_46)
				{
					...
					case 1:
						...
						{
							if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_INJURED(iLocal_71)) && func_161(iLocal_73)) && !func_160(0))
							{
								if (func_159())
								{
						...
						{
							if (!PED::IS_PED_INJURED(iLocal_71) && func_161(iLocal_73))
							{
		...
		else
		{
			...
			if (func_161(iLocal_73) && !func_103())
			{
								...
								if (func_161(iLocal_73))
								{
									if (iLocal_121 == 1)
									{
										if (SYSTEM::TIMERA() < 5000)
										{
											...
											{
												if (func_161(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)))
												{
							...
							case 2:
								...
								else if (HUD::DOES_BLIP_EXIST(iLocal_59))
								{
									if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_73, 0))
									{
										if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_71, fLocal_52, fLocal_52, fLocal_52, 0, 1, 0))
										{
											if (func_43(1, 0, 1))
											{
												...
												if (iLocal_121 == 1)
												{
													...
													{
														fLocal_126 = "RANDOM@CAR_THEFT_1@MCS_2";
													}
													else
													{
														fLocal_126 = "RANDOM@CAR_THEFT_1@MCS_2";
												...
												{
													fLocal_126 = "RANDOM@CAR_THEFT_1@MCS_3";
												}
												STREAMING::REQUEST_ANIM_DICT(fLocal_126);
												iLocal_48 = 4;
												iLocal_47 = 3;
											}
										}
										...
										{
											func_40(ENTITY::GET_ENTITY_COORDS(iLocal_71, true), &fLocal_52, &fLocal_53);
										}
									}
									else
									{
				...
				else
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_71))
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_71, fLocal_79, "agitated_idle_a", 3))
						{
							ENTITY::STOP_ENTITY_ANIM(iLocal_71, "waiting", fLocal_79, -2f);
						}
...
void func_1(int iParam0, void fParam1, int iParam2)
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, fParam1, func_2(iParam2), 1);
}
...
int func_4()
{
	...
	fVar1 = "chassis";
	func_55();
	if (((!PED::IS_PED_INJURED(iLocal_71) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && func_161(iLocal_73)) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_126))
	{
		switch (iLocal_49)
		{
			case 0:
			...
			case 1:
				...
				PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(iLocal_122, iLocal_73, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_73, fVar1));
				PED::SET_SYNCHRONIZED_SCENE_ORIGIN(iLocal_122, vLocal_130, vLocal_131, 2);
				BRAIN::TASK_SYNCHRONIZED_SCENE(iLocal_71, iLocal_122, fLocal_126, fLocal_128, 1000f, -2f, 0, 0, 1148846080, 0);
				BRAIN::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_122, fLocal_126, fLocal_129, 1000f, -2f, 1024, 0, 1148846080, 0);
				iLocal_75 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_ANIMATED_CAMERA", vLocal_97, vLocal_98, fLocal_96, 0, 2);
				CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_75, iLocal_122, "car_returned_cam", fLocal_126);
				ENTITY::PLAY_ENTITY_ANIM(iLocal_73, fLocal_127, fLocal_126, 1000f, false, 0, 0, 0, 262144);
			...
			case 4:
					...
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_122))
					{
						if (iLocal_132 == 0)
						{
							if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_122) >= 0.83f)
							{
								...
								BRAIN::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), fLocal_126, fLocal_129, 1000f, -2f, -1, 1048576, PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_122), 0, 0, 0);
						...
						if (!PED::IS_PED_INJURED(iLocal_71))
						{
							if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_122) >= 0.83f)
							{
								if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_71, fLocal_126, fLocal_128, 2))
								{
				...
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_73, 0) && ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_73, fLocal_126, fLocal_127, 3))
					{
						ENTITY::SET_ENTITY_ANIM_CURRENT_TIME(iLocal_73, fLocal_126, fLocal_127, 1f);
					}
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_122))
					{
					...
					if (bLocal_150)
					{
						vVar0 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(fLocal_126, fLocal_129, vLocal_130, vLocal_131, 1f, 2) };
						MISC::GET_GROUND_Z_FOR_3D_COORD(vVar0, &(vVar0.f_2), 0, 0);
						ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), vVar0, 1, false, 0, 1);
						vVar0 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(fLocal_126, fLocal_129, vLocal_130, vLocal_131, 1f, 2) };
...
void func_6(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_7(iParam2)];
	if (iVar0 != 0)
	{
...
int func_9(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_7(iParam1)];
...
void func_32(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_36(PLAYER::PLAYER_ID())) && !func_34(PLAYER::PLAYER_ID(), 0)) && !func_33()) && !bParam4)
			{
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, float fParam6, void fParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
void func_63(var uParam0, void fParam1, int iParam2)
{
	void fVar0;
...
void func_68()
{
	if (func_161(iLocal_73) && HUD::DOES_BLIP_EXIST(iLocal_60))
	{
		func_69(&uLocal_138, iLocal_73, 0, 0, 1, 1, 1);
	}
}

void func_69(var uParam0, int iParam1, void fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	func_70(uParam0, iParam1, 0f, 0f, 0f, fParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_70(var uParam0, int iParam1, vector3 vParam2, void fParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	func_71(uParam0, iParam1, vParam2, fParam3, iParam4, bParam5, uParam6, bParam7);
}

void func_71(var uParam0, int iParam1, vector3 vParam2, void fParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	...
	uParam0->f_6 = 2;
	func_72(uParam0, iParam1, vParam2, fParam3, iParam4, bParam5, uParam6, bParam7);
}

void func_72(var uParam0, int iParam1, vector3 vParam2, void fParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)
{
	void fVar0;
	int iVar1;
...
void func_76(void fParam0, int iParam1)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(fParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

int func_77(void fParam0)
{
	if (!func_78(1, 1, 0))
	{
		if ((!MISC::IS_STRING_NULL_OR_EMPTY(fParam0) && func_64(fParam0)) || func_64("CMN_HINT"))
		{
			HUD::CLEAR_HELP(1);
		}
		return 0;
...
int func_78(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_86() || func_85(Global_4456448.f_148478)) || func_84())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
			iVar1 = func_83(PLAYER::PLAYER_PED_ID(), 0);
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("apc") && iVar1 != -1)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("akula") && iVar1 != -1)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("riot2") && iVar1 == 0) && func_82(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != -1))
			{
				return 0;
			}
		}
		...
		switch (iLocal_48)
		{
			case 0:
				...
				if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_71, 0))
				{
					...
					else if (!PED::IS_PED_RAGDOLL(iLocal_71) && !BRAIN::IS_PED_GETTING_UP(iLocal_71))
					{
						...
						{
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_74);
							BRAIN::TASK_PLAY_ANIM(0, fLocal_80, "arms_waving", 2f, -8f, -1, 0, 0, 0, 0, 0);
							BRAIN::TASK_PLAY_ANIM(0, fLocal_80, "arms_waving", 8f, -8f, -1, 0, 0, 0, 0, 0);
							BRAIN::TASK_PLAY_ANIM(0, fLocal_80, "arms_waving", 8f, -2f, -1, 0, 0, 0, 0, 0);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_74);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_74);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_74);
							iLocal_124 = MISC::GET_GAME_TIMER();
			...
			case 1:
				if (iLocal_121 == 1)
				{
					...
					{
						BRAIN::OPEN_SEQUENCE_TASK(&iLocal_74);
						BRAIN::TASK_PLAY_ANIM(0, fLocal_80, fLocal_82, 4f, -2f, -1, 0, 0, 0, 0, 0);
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_74);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_74);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_74);
						iLocal_48 = 2;
				...
				else if (PED::IS_PED_FACING_PED(iLocal_71, PLAYER::PLAYER_PED_ID(), 60f))
				{
					if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_71, 242628503) != 1)
					{
						...
						if (bLocal_57 == 0)
						{
							BRAIN::TASK_PLAY_ANIM(0, fLocal_80, "pointing", 8f, -4f, -1, 0, 0, 0, 0, 0);
						}
						BRAIN::CLOSE_SEQUENCE_TASK(iLocal_74);
						BRAIN::TASK_PERFORM_SEQUENCE(iLocal_71, iLocal_74);
						BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_74);
			...
			case 2:
				...
				if (iLocal_121 == 2)
				{
					if (!PED::IS_PED_FACING_PED(iLocal_71, PLAYER::PLAYER_PED_ID(), 60f) && !func_108(iLocal_71, -875674219))
					{
						BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), 0);
					}
					if (func_107(iLocal_71, PLAYER::PLAYER_PED_ID(), 1) < 25f)
					{
						if (!func_18())
						{
				...
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_71, 242628503) != 1 && !func_108(iLocal_71, -875674219))
				{
					if (iLocal_121 == 1)
					{
						...
						else if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_71, fLocal_79, "waiting", 3))
						{
							BRAIN::TASK_PLAY_ANIM(iLocal_71, fLocal_79, "waiting", 4f, -4f, -1, 0, 0, 0, 0, 0);
							if (func_107(iLocal_71, PLAYER::PLAYER_PED_ID(), 1) < 25f)
							{
								func_106();
							}
...
void func_119()
{
	...
	{
		func_121(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
...
void func_126(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	func_127(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_127(void fParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
...
int func_136(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	struct<10> Var0;
	struct<10> Var1;
	int iVar2;
	...
	else
	{
		...
		iVar2 = 0;
		func_142(&iVar2);
		iVar3 = func_141(Var1, Global_105220.f_7659.f_765[iVar2 /*10*/]);
		if (iVar3 == 2)
		{
			func_139(Global_105220.f_7659.f_765[iVar2 /*10*/]);
		...
		else if (iVar3 == 1)
		{
			...
			{
				if (!func_137(Global_105220.f_7659.f_765[iVar2 /*10*/]))
				{
					Global_105220.f_7659.f_765[iVar2 /*10*/] = { Var1 };
					func_138(&Var1);
					return 1;
...
int func_137(struct<9> Param0, var uParam1)
{
	if (Param0.f_8 == 0)
	{
		return 0;
...
int func_141(struct<4> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, struct<4> Param7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13)
{
	int iVar0;
	int iVar1;
...
void func_142(int iParam0)
{
	...
	*iParam0 = 0;
	...
	{
		if (func_141(Global_105220.f_7659.f_765[iVar0 /*10*/], Global_105220.f_7659.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
struct<10> func_143(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, var uParam8, var uParam9)
{
	struct<10> Var0;
...
int func_149(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_120() == 0)
		{
			return MISC::IS_BIT_SET(func_9(func_147(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_150(int iParam0)
{
	if (func_153())
	{
		...
		if (func_124(Global_105209))
		{
			func_151(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_124(Global_105209))
		{
...
int func_153()
{
	switch (func_154(&Global_25336, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_162()
{
	...
	switch (iLocal_121)
	{
		case 1:
			...
			cLocal_114 = "RECT1AU";
			fLocal_79 = "RANDOM@CAR_THIEF@waiting_ig_4";
			fLocal_81 = "random@car_thief@waving_ig_1";
			...
			if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_86) < SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_87))
			{
				...
				fVar2 = fLocal_94;
				bLocal_57 = true;
				fLocal_80 = "random@car_thief@waving_ig_2";
				fLocal_82 = "waving_l";
			}
			else
			{
		...
		case 2:
			...
			cLocal_114 = "RECT2AU";
			fLocal_79 = "RANDOM@CAR_THIEF@waiting_ig_4";
			fLocal_80 = "RANDOM@CAR_THIEF@VICTIMPOINTS_IG_3";
			fLocal_81 = "RANDOM@CAR_THIEF@VICTIMPOINTS_IG_3";
	...
	STREAMING::REQUEST_ANIM_DICT(fLocal_79);
	STREAMING::REQUEST_ANIM_DICT(fLocal_80);
	STREAMING::REQUEST_ANIM_DICT(fLocal_81);
	STREAMING::REQUEST_ANIM_DICT("RANDOM@CAR_THIEF@WAITING_IG_4");
	STREAMING::REQUEST_PTFX_ASSET();
	if (((((((STREAMING::HAS_MODEL_LOADED(iVar3) && STREAMING::HAS_MODEL_LOADED(iVar4)) && STREAMING::HAS_MODEL_LOADED(iVar5)) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_79)) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_80)) && STREAMING::HAS_ANIM_DICT_LOADED(fLocal_81)) && STREAMING::HAS_ANIM_DICT_LOADED("RANDOM@CAR_THIEF@WAITING_IG_4")) && STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		if (iLocal_121 == 1)
		{
			func_176("re_cartheft - Distance to vTop = ", SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_86));
			func_176("re_cartheft - Distance to vBottom = ", SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vLocal_87));
		...
		func_175(&Local_102, 0, PLAYER::PLAYER_PED_ID(), sLocal_100, 0, 1);
...
void func_176(void fParam0, float fParam1)
{
	func_178(fParam0);
	func_177(fParam1);
}
...
int func_180()
{
	if ((Global_105209 == func_133() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_105210)
	{
		return 1;
	}
	return 0;
...
int func_187(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_222(Global_105220.f_24966.f_43[iParam1]))
		{
			return 0;
		}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_200(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_220()) || Global_104267) || Global_25279) || func_219()) || func_51(8, -1)) || func_218()) || func_217()) || func_216()) || func_215()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_220()) || Global_25279) || func_219()) || func_51(8, -1)) || func_216()) || func_218()) || func_217()) || func_215()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_220()) || Global_104267) || Global_25279) || func_219()) || func_51(8, -1)) || func_216()) || func_218()) || func_217()) || func_215()) || Global_105220.f_7659.f_919[iVar0] == 5) || Global_36452 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_220()) || Global_104267) || Global_25279) || func_219()) || func_51(8, -1)) || func_218()) || func_217()) || func_215()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_220() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_51(8, -1)) || func_215()) || func_214()) || Global_105220.f_7659.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_220()) || Global_25279) || func_219()) || func_51(8, -1)) || func_217()) || func_216()) || func_215()) || Global_105220.f_7659.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_220()) || Global_104267) || Global_25279) || func_219()) || func_51(8, -1)) || func_216()) || func_214()) || func_218()) || func_217()) || func_215())
						{
							return 0;
						}
						break;
...
void func_242(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
