...
{
	func_17(1, *iParam0, uLocal_114, *iParam0, cParam1, bParam2, 1);
	*iParam0++;
}

void func_17(int iParam0, var uParam1, var uParam2, var uParam3, char[4] cParam4, int iParam5, int iParam6)
{
...
int func_19()
{
	...
	uVar0 = Global_1382690[func_14(-1)];
...
void func_27(int iParam0, int iParam1)
{
	...
	func_17(1, *iParam0, uLocal_114, *iParam0, &cVar0, iParam1, 0);
	*iParam0++;
}
...
int func_32(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2572886[iParam0 /*3*/][func_14(iParam1)];
	if (STAT_GET_INT(uVar0, &uVar1, -1))
	{
		return uVar1;
	}
...
void func_37(int iParam0, int iParam1, int iParam2)
{
	...
	StringIntConCat(&cVar0, *iParam0, 16);
	func_38(1, *iParam0, uLocal_114, *iParam0, &cVar0, "PM_UGEN_NUM", iParam1, iParam2);
	*iParam0++;
}

void func_38(int iParam0, var uParam1, var uParam2, var uParam3, char[4] cParam4, char* sParam5, var uParam6, var uParam7)
{
	if (BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_DATA_SLOT"))
	{
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
		...
		ADD_TEXT_COMPONENT_INTEGER(uParam6);
		ADD_TEXT_COMPONENT_INTEGER(uParam7);
		END_TEXT_COMMAND_SCALEFORM_STRING();
		END_SCALEFORM_MOVIE_METHOD();
	}
}
...
void func_44(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_COLUMN_HIGHLIGHT"))
	{
		...
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(iParam3);
		END_SCALEFORM_MOVIE_METHOD();
	}
}
...
void func_45()
{
	...
	func_43(0);
	iLocal_119 = 0;
	func_47(0, 0, uLocal_113, 0, 1, "PM_UL_D0", 0, 0, 0);
	func_47(0, 1, uLocal_113, 1, 1, "PM_UL_D1", 0, 0, 0);
	func_47(0, 2, uLocal_113, 2, 1, "PM_UL_D2", 0, 0, 0);
	func_2(0);
	func_46(2);
	func_46(3);
	func_46(4);
...
void func_47(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4, char* sParam5, bool bParam6, int iParam7, bool bParam8)
{
	if (BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_DATA_SLOT"))
	{
		SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
...
int func_48()
{
	...
	while (iVar0 < 1200)
	{
		if (IS_BIT_SET(Global_794709.f_4[iVar0 /*88*/].f_76, 14))
		{
...
int func_49(int iParam0)
{
	...
	iVar1 = func_52(iVar0);
	uVar2 = func_51(iVar0);
	if ((IS_CONTROL_JUST_RELEASED(2, iParam0) || IS_DISABLED_CONTROL_JUST_RELEASED(2, iParam0)) || func_50(iParam0, &(Global_1371947.f_1060), 1))
	{
