...
void __EntryFunction__()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("letterscraps")) > 1)
	{
	...
	switch (iLocal_43)
	{
		case 0:
			...
			else if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				if (IS_SCREEN_FADED_IN())
				{
					if (!func_19())
					{
						if (((!IS_MOBILE_PHONE_CALL_ONGOING() && !func_13()) && !func_12()) && !func_11())
						{
							iLocal_619 = 0;
							iLocal_613 = 0;
							...
							uLocal_612 = REQUEST_SCALEFORM_MOVIE("LETTER_SCRAPS");
							while (!HAS_SCALEFORM_MOVIE_LOADED(uLocal_612))
							{
								WAIT(0);
							}
							BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_612, "SET_LETTER_TEXT");
							func_10(sLocal_614[0]);
		...
		case 1:
			...
			if (iLocal_613 < 4)
			{
				...
				DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_612, 255, 255, 255, 255, 0);
			}
			else
			{
				iLocal_43 = 2;
...
var func_15(int iParam0, var uParam1)
{
...
var func_18(int iParam0, var uParam1, var uParam2, var uParam3)
{
	BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(uParam1);
	ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(uParam2);
...
void func_20()
{
	switch (iLocal_43)
	{
		...
		case 1:
			if (!func_59(14) && !IS_SCREEN_FADED_OUT())
			{
				if (func_22(&Local_44, &Local_57) || uLocal_620)
				{
					iLocal_43 = 2;
				}
...
int func_22(var uParam0, int iParam1)
{
	...
	if (uParam0->f_11)
	{
		if (!Global_71850)
		{
			func_23(&(uParam0->f_11), &(uParam0->f_12), &(uParam0->f_9), 1, &iLocal_610, &uLocal_611, "LETTERS_TITLE", "LETTERS_COLLECT");
		}
	}
...
void func_23(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, var uParam5, char* sParam6, char* sParam7)
{
	var uVar0;
	...
	if (*uParam0)
	{
		switch (*iParam4)
		{
			...
			case 1:
				...
				ADD_TEXT_COMPONENT_INTEGER(func_25(iParam3));
				END_TEXT_COMMAND_SCALEFORM_STRING();
				END_SCALEFORM_MOVIE_METHOD();
...
int func_25(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (IS_BIT_SET(Global_106565.f_10043.f_108, func_31(func_32(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
int func_39(var uParam0, var uParam1, vector3 vParam2)
{
	...
	if ((uParam1[iVar0 /*11*/])->f_10)
	{
		...
		{
			if (HAS_PICKUP_BEEN_COLLECTED((uParam1[iVar0 /*11*/])->f_1) || func_54((uParam1[iVar0 /*11*/])->f_1))
			{
	...
	{
		if ((VDIST2(vParam2, GET_PICKUP_COORDS((uParam1[iVar0 /*11*/])->f_1)) > (60f * 60f) || func_59(13)) || func_59(14))
		{
...
void func_45()
{
	...
	iVar3 = 0;
	STAT_GET_INT(func_47(0), &iVar0, -1);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_46(18, iVar0);
	}
	STAT_GET_INT(func_47(1), &iVar0, -1);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_46(19, iVar0);
	}
	STAT_GET_INT(func_47(3), &iVar0, -1);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_46(20, iVar0);
...
void func_56(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)
{
	var uVar0;
...
void func_61(var uParam0, var uParam1, var uParam2)
{
	...
	*uParam0 = 0;
	...
	while (iVar0 < uParam0->f_3)
	{
		if (func_26((uParam0->f_2 + iVar0), -1, -1))
		{
			iVar1++;
			func_52(uParam0, iVar0, 1);
			if (bLocal_40)
			{
			}
		}
...
void func_63()
{
	...
	while (iVar0 < 50)
	{
		Local_57[iVar0 /*11*/].f_3 = { func_64(iVar0, 0) };
...
void func_69()
{
	...
	if (!DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_71590)
		{
			if (func_70() == 2 == 0 && !NETWORK_IS_GAME_IN_PROGRESS())
			{
...
void func_74()
{
	...
	SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_612);
	SET_GAME_PAUSED(0);
	Global_106565.f_10043.f_122.f_2 = 0;
	iVar0 = 0;
	while (iVar0 < Local_57)
	{
		func_53(&(Local_57[iVar0 /*11*/].f_2));
		func_40(&(Local_57[iVar0 /*11*/].f_1));
