...
void func_8()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_11(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_9(iVar0) && (!func_12(14) || Global_104171))
			{
...
void func_16(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_17(iParam0) && SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_83888[26 /*34*/].f_6) == 0)
			{
				Global_105220.f_7232[iParam0] = 1;
				OBJECT::_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_105220.f_7232[iParam0], 1, 1);
			}
...
int func_34(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar2 = 0;
		func_40(&iVar2);
		iVar3 = func_39(Var1, Global_105220.f_7659.f_765[iVar2 /*10*/]);
		if (iVar3 == 2)
		{
			func_37(Global_105220.f_7659.f_765[iVar2 /*10*/]);
		...
		else if (iVar3 == 1)
		{
			...
			{
				if (!func_35(Global_105220.f_7659.f_765[iVar2 /*10*/]))
				{
					Global_105220.f_7659.f_765[iVar2 /*10*/] = { Var1 };
					func_36(&Var1);
					return 1;
...
void func_40(int iParam0)
{
	...
	*iParam0 = 0;
	...
	{
		if (func_39(Global_105220.f_7659.f_765[iVar0 /*10*/], Global_105220.f_7659.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_70793[1 /*14*/] = { func_111(iVar10, iParam1, iParam2) };
		if (!func_110(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_70793[1 /*14*/] = { func_111(iVar10, iVar0, uVar11[iVar0]) };
				if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_70793[1 /*14*/] = { func_111(iVar10, 14, uVar12[iVar1]) };
							func_81(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
							func_103(14);
							if (Global_70791 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_71(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iVar0), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
						}
						func_103(iVar0);
						if (Global_70791 == 1)
						{
			...
			{
				Global_70793[1 /*14*/] = { func_111(iVar10, iVar0, func_70(iParam0, iVar0, -1)) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_70793[1 /*14*/] = { func_111(iVar10, 14, uVar15[iVar1]) };
			func_81(iParam0, Global_70793[1 /*14*/].f_12, Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4);
			func_103(14);
			if (Global_70791 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_71(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, iParam4);
		}
		if (Global_70791 == 1)
		{
			iVar2 = 0;
...
int func_62(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_175(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_64, Global_105220.f_2354.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_70793[1 /*14*/] = { func_111(iParam0, iParam1, iParam2) };
...
int func_69(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_175(iParam0, Global_105220.f_2354.f_539[iVar0 /*65*/].f_61, Global_105220.f_2354.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_71(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_71(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_103(int iParam0)
{
	...
	{
		func_109(iParam0, Global_70793[1 /*14*/].f_5, Global_70793[1 /*14*/].f_2, 2, Global_70793[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_106(iParam2)];
	if (iVar0 != 0)
	{
...
int func_107(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_106(iParam1)];
...
void func_113(int iParam0)
{
	...
	func_114(&(Global_70793[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_107(func_117(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_107(func_116(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_107(iVar1, Global_70790, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_120(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_114(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_114(&(Global_70793[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_114(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_71(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_114(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_175(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_70793[1 /*14*/] = { func_111(iVar0, iParam1, iParam2) };
	if (!MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_175(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_175(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_70793[2 /*14*/] = { func_111(iVar0, 14, iVar4) };
									if (Global_70793[2 /*14*/].f_12 == iVar3)
									{
										if (func_175(iParam0, 14, iVar4))
										{
											if (!func_67(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_70793[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_70793[2 /*14*/] = { func_111(iVar0, iVar2, iVar1) };
						if (!func_67(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_70793[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_70793[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_71(iParam1)) && Global_70793[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_71(iParam1)))
	{
		return 1;
	}
	return 0;
	...
	if (Global_71232 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_221(Global_71233, Global_71235, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_233(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
...
{
	return func_235(iParam0, Global_35905);
}
...
int func_250(int iParam0, int iParam1, int iParam2, char* sParam3)
{
	...
	while (iVar1 < 8)
	{
		...
		{
			if (Global_47793[iVar0 /*53*/] == iParam1 && Global_47793[iVar0 /*53*/].f_1 == iParam2)
			{
				if (iParam0 == Global_47793[iVar0 /*53*/].f_3)
				{
					Global_47793[iVar0 /*53*/].f_5 = 1;
					StringCopy(&(Global_47793[iVar0 /*53*/].f_6), sParam3, 16);
				}
				return 1;
			}
		}
...
void func_255(int iParam0, bool bParam1)
{
	...
	{
		func_292(&(Global_104307[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_258()
{
	...
	{
		func_319(13, SYSTEM::FLOOR(Global_105220.f_10165.f_3853));
	}
...
int func_280(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_70793[1 /*14*/] = { func_111(iVar0, iParam1, uVar6[iParam1]) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_71(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_71(iParam1), Global_70793[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iParam1), Global_70793[1 /*14*/].f_3, Global_70793[1 /*14*/].f_4, 0);
		}
	}
...
void func_285(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_286(&sVar1, Var0.f_3, Global_92992, iParam1, iParam2);
	}
}
...
void func_288()
{
	...
	{
		func_8();
		GRAPHICS::_0xBF59707B3E5ED531(func_289(Global_105220.f_2354.f_539.f_4301));
	}
	else
	{
...
{
	func_297(iParam0, 1);
	Global_105220.f_18545[iParam0 /*6*/].f_3 = func_296();
...
int func_327()
{
	...
	iVar0 = func_328(&(Global_92955.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_331()
{
	...
	{
		if (func_326(&(Global_92955.f_3)) > -1)
		{
			return 1;
		}
	}
