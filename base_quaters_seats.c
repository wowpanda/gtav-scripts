...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_29.f_4)
	{
		...
		case 2:
			if (func_48(PLAYER::PLAYER_PED_ID(), uParam0[uParam0->f_29.f_2 /*14*/]))
			{
				...
				else if (uParam0->f_29.f_5 == -1)
				{
					...
					{
						func_43(&(uParam0->f_29.f_5), 4, "MPJAC_SIT", 0, 0, 0, 0);
					}
				}
		...
		case 4:
			...
			if (Var2 != 3)
			{
				vVar3 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_37(uParam0), func_36(uParam0), 0, 2) };
				vVar4 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_37(uParam0), func_36(uParam0), 0, 2) };
				iVar5 = vVar4.z;
		...
		case 5:
			...
			if (iVar6 != 1 && iVar6 != 0)
			{
				uParam0->f_29.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_37(uParam0), func_36(uParam0), 2, true, false, 1065353216, 0, 1065353216);
	...
	if (uParam0->f_29.f_4 == 6)
	{
		...
		else
		{
			...
			if (((((!HUD::IS_PAUSE_MENU_ACTIVE() && !func_8(&(uParam0->f_29), 0)) && !func_8(&(uParam0->f_29), 4)) && !func_21()) && !func_19(1)) && uParam0->f_29.f_8.f_2 != 3)
			{
				...
				{
					func_43(&(uParam0->f_29.f_5), 4, "MPJAC_EXIT", 0, 0, 0, 0);
				}
				if (uParam0->f_29.f_4 == 6)
				{
...
{
	uParam0->f_29.f_8 = func_42((*uParam0)[uParam0->f_29.f_2 /*14*/]);
	uParam0->f_29.f_8.f_1 = func_41(uParam0);
...
int func_45(var uParam0)
{
	...
	while (iVar0 < NETWORK::_NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if ((iVar1 != PLAYER::PLAYER_ID() && func_46(iVar1, 1, 1)) && func_48(PLAYER::GET_PLAYER_PED(iVar1), uParam0[uParam0->f_29.f_2 /*14*/]))
			{
				return 1;
			}
		}
...
bool func_48(int iParam0, var uParam1)
{
...
void func_52(var uParam0)
{
	...
	else if (uParam0->f_29.f_4 > 4)
	{
		...
		PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_53(uParam0));
...
{
	func_55(&(uParam0->f_29), 4, func_56());
	func_55(&(uParam0->f_29), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0));
	func_55(&(uParam0->f_29), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1));
	func_55(&(uParam0->f_29), 0, func_35(0));
	func_55(&(uParam0->f_29), 2, BRAIN::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
...
int func_59()
{
	...
	if (func_60() != 0)
	{
		if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_60()) == 0)
		{
			return 1;
		}
	}
...
int func_70()
{
	if (Global_1589140 != func_58())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_quaters_seats", Global_1589140, 1, 0))
		{
			return 0;
		}
		NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, 0, Global_1589140);
		func_90(0, -1, 0);
		MISC::SET_THIS_SCRIPT_CAN_BE_PAUSED(0);
		func_89();
		if (func_88(Global_1589140))
		{
			func_81();
		}
		else
...
void func_71()
{
	func_74(2, &uLocal_144, 0);
	func_74(3, &uLocal_144, 1);
	func_72(&uLocal_144, 6526);
}
...
void func_74(int iParam0, var uParam1, int iParam2)
{
	...
	(uParam1[iParam2 /*14*/])->f_8 = { func_77(func_78(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, (fVar1 + 0f) };
	(uParam1[iParam2 /*14*/])->f_1 = { func_77(func_76(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_77(func_75(), fVar1) + vVar0 };
...
void func_81()
{
	func_82(2, &uLocal_144, 0);
	func_82(3, &uLocal_144, 1);
}
...
void func_82(int iParam0, var uParam1, int iParam2)
{
	...
	func_87(iParam0, &vVar0, &fVar1);
	(*uParam1)[iParam2 /*14*/] = 5;
	(uParam1[iParam2 /*14*/])->f_8 = { func_77(func_85(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, (fVar1 + 3f) };
	(uParam1[iParam2 /*14*/])->f_1 = { func_77(func_84(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_77(func_83(), fVar1) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_6 = 0.73f;
}
...
{
	return MISC::IS_BIT_SET(Global_1589291[iParam0 /*770*/].f_273.f_256.f_1, 0);
}
