...
void func_11(var uParam0)
{
	...
	switch (uParam0->f_29.f_4)
	{
		...
		case 1:
			if (func_50(uParam0))
			{
				uParam0->f_29.f_6 = GET_GAME_TIMER();
				func_51(uParam0, 2);
			}
			break;
		
		case 2:
			if (func_49(PLAYER_PED_ID(), uParam0[uParam0->f_29.f_2 /*14*/]))
			{
				...
				{
					if ((GET_GAME_TIMER() - uParam0->f_29.f_6) > 150)
					{
		...
		case 4:
			...
			if (Var20 != 3)
			{
				vVar34 = { GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar16, func_38(uParam0), func_37(uParam0), 0, 2) };
				vVar37 = { GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_38(uParam0), func_37(uParam0), 0, 2) };
				uVar40 = vVar37.z;
		...
		case 5:
			...
			{
				uParam0->f_29.f_1 = NETWORK_CREATE_SYNCHRONISED_SCENE(func_38(uParam0), func_37(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
				NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uParam0->f_29.f_1, &sVar0, &sVar16, 2f, -1000f, 13, 16, 1.5f, 0);
				NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_29.f_1);
				uParam0->f_29.f_8.f_4 = GET_GAME_TIMER();
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			uVar42 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_29.f_1);
			if (IS_SYNCHRONIZED_SCENE_RUNNING(uVar42))
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(uVar42) >= 1f)
				{
					...
					func_39(uParam0, &sVar16);
					uParam0->f_29.f_1 = NETWORK_CREATE_SYNCHRONISED_SCENE(func_38(uParam0), func_37(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
					NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uParam0->f_29.f_1, &sVar0, &sVar16, 4f, -1.5f, 13, 16, 1000f, 0);
					NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_29.f_1);
					func_25(&(uParam0->f_29), 8);
		...
		case 7:
			NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_29.f_1);
			func_51(uParam0, 8);
			break;
		
		case 8:
			uVar43 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uParam0->f_29.f_1);
...
void func_12(var uParam0, bool bParam1)
{
	...
	else
	{
		...
		if ((GET_GAME_TIMER() - uParam0->f_29.f_8.f_4) >= 90000)
		{
			iVar1 = func_13(uParam0);
			if (iVar1 != uParam0->f_29.f_8.f_1)
			{
...
void func_18(var uParam0)
{
	...
	if (uParam0->f_29.f_4 == 6)
	{
		...
		fVar3 = VMAG(vVar0);
		if ((uParam0->f_29.f_4 == 6 && !HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), -1322051853)) && !func_8(&(uParam0->f_29), 12))
		{
			if (fVar3 >= 0.35f)
			{
				func_23(uParam0);
		...
		else
		{
			...
			if (((((!IS_PAUSE_MENU_ACTIVE() && !func_8(&(uParam0->f_29), 0)) && !func_8(&(uParam0->f_29), 4)) && !func_21()) && !func_19(1)) && uParam0->f_29.f_8.f_2 != 3)
			{
...
void func_24(var uParam0)
{
	...
	uParam0->f_29.f_1 = NETWORK_CREATE_SYNCHRONISED_SCENE(func_38(uParam0), func_37(uParam0), 2, 1, 0, 1065353216, 0, 1065353216);
	func_40(uParam0, &sVar0);
	NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uParam0->f_29.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_29.f_1);
	func_9(&(uParam0->f_29.f_5));
	func_51(uParam0, 8);
}
...
int func_42(var uParam0)
{
	...
	switch (uParam0->f_29.f_8)
	{
		...
		default:
			iVar0 = GET_RANDOM_INT_IN_RANGE(0, func_14(uParam0->f_29.f_8));
	}
	return iVar0;
}
...
int func_46(var uParam0)
{
	...
	while (iVar0 < _NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		if (NETWORK_IS_PARTICIPANT_ACTIVE(INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if ((iVar1 != PLAYER_ID() && func_47(iVar1, 1, 1)) && func_49(GET_PLAYER_PED(iVar1), uParam0[uParam0->f_29.f_2 /*14*/]))
			{
				return 1;
			}
		}
...
void func_53(var uParam0)
{
	...
	else if (uParam0->f_29.f_4 > 4)
	{
		...
		SET_PED_CAPSULE(PLAYER_PED_ID(), func_54(uParam0));
		uParam0->f_29.f_7 = GET_FRAME_COUNT();
	}
	...
	else if ((GET_FRAME_COUNT() - uParam0->f_29.f_7) < 5)
	{
		SET_PED_CAPSULE(PLAYER_PED_ID(), func_54(uParam0));
	}
}
...
void func_55(var uParam0)
{
	...
	func_56(&(uParam0->f_29), 1, IS_ENTITY_DEAD(PLAYER_PED_ID(), 0));
	func_56(&(uParam0->f_29), 3, IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1));
	func_56(&(uParam0->f_29), 0, func_35(0));
	func_56(&(uParam0->f_29), 2, IS_PED_RUNNING(PLAYER_PED_ID()));
}
...
int func_60()
{
	...
	if (func_61() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_61()) == 0)
		{
			return 1;
		}
	}
...
{
	return IS_ENTITY_IN_ANGLED_AREA(uParam0, 362.0188f, 4823.182f, -59.98693f, 374.756f, 4823.096f, -56.23059f, 9f, 0, 1, 0);
}
...
int func_72()
{
	if (Global_1589667 != func_59())
	{
		if (NETWORK_IS_SCRIPT_ACTIVE("base_quaters_seats", Global_1589667, 1, 0))
		{
			return 0;
		}
...
void func_76(int iParam0, var uParam1, int iParam2)
{
	...
	(uParam1[iParam2 /*14*/])->f_8 = { func_79(func_80(), fVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, (fVar3 + 0f) };
	(uParam1[iParam2 /*14*/])->f_1 = { func_79(func_78(), fVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_79(func_77(), fVar3) + vVar0 };
...
Vector3 func_79(vector3 vParam0, float fParam3)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
void func_84(int iParam0, var uParam1, int iParam2)
{
	...
	func_89(iParam0, &vVar0, &fVar3);
	(*uParam1)[iParam2 /*14*/] = 5;
	(uParam1[iParam2 /*14*/])->f_8 = { func_79(func_87(), fVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, (fVar3 + 3f) };
	(uParam1[iParam2 /*14*/])->f_1 = { func_79(func_86(), fVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_79(func_85(), fVar3) + vVar0 };
	(uParam1[iParam2 /*14*/])->f_1.f_6 = 0.73f;
}
...
{
	return IS_BIT_SET(Global_1589819[iParam0 /*818*/].f_273.f_265.f_1, 0);
}
