...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (BRAIN::DOES_SCENARIO_GROUP_EXIST("DEALERSHIP"))
		{
			if (BRAIN::IS_SCENARIO_GROUP_ENABLED("DEALERSHIP"))
			{
				BRAIN::SET_SCENARIO_GROUP_ENABLED("DEALERSHIP", false);
			}
		}
		fVar0 = (CAM::_0x8BFCEB5EA1B161B6() + 20f);
		if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), vLocal_57) < (fVar0 * fVar0))
		{
			RECORDING::_0xAF66DCEE6609B148();
		}
		if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), vLocal_59) < (fVar0 * fVar0))
		{
			RECORDING::_0xAF66DCEE6609B148();
		}
		...
		else if (bLocal_72)
		{
			...
			if (func_2(iLocal_48))
			{
				if (func_1(iLocal_48, AUDIO::_0x0626A247D2405330(), 1) > 120f)
				{
					func_94();
				}
			}
			...
			if (func_2(iLocal_48))
			{
				if (func_52())
				{
					if (!iLocal_66)
					{
						iLocal_67 = 1;
						iLocal_62 = 1;
						NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_48);
						...
						if (!bLocal_64)
						{
							...
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_48, iLocal_87);
						...
						else
						{
							if (!bLocal_65)
							{
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_87);
								BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295, 0, 2);
								if (func_1(iLocal_48, AUDIO::_0x0626A247D2405330(), 1) <= 4f)
								{
									BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), 1500);
								}
								BRAIN::TASK_SMART_FLEE_PED(0, AUDIO::_0x0626A247D2405330(), 150f, 4294967295, 1, 0);
								CUTSCENE::_0x8D9DF6ECA8768583(iLocal_87);
							}
							else
							{
					...
					else
					{
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), unk_0x8000C77B5F336760(iLocal_48, false), true) >= 100f && !CAM::IS_SPHERE_VISIBLE(unk_0x8000C77B5F336760(iLocal_48, false), 3f))
						{
				...
				else
				{
					...
					if (Local_45[0 /*20*/].f_12 >= 5 && Local_45[1 /*20*/].f_12 >= 5)
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -69.62395f, -1087.37f, 24.59833f, -11.27861f, -1108.28f, 34.17205f, 47.5f, 0, true, 0))
						{
							func_4();
						}
					}
...
int func_15()//Position - 0x12F9
{
	return Global_1407E0;
}

int func_16(int iParam0, int iParam1)//Position - 0x1305
{
	switch (iParam0)
	{
		case 0:
...
int func_17(int iParam0)//Position - 0x1679
{
	switch (iParam0)
	{
		case 29:
...
void func_18(int iParam0)//Position - 0x16A8
{
	int iVar0;
	int iVar1;
...
void func_19(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x16EA
{
	func_20(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_20(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x170C
{
	int iVar0;
...
void func_23()//Position - 0x1A46
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_27(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_25(iVar0) && (!func_24(14) || Global_19A3D))
			{
...
bool func_24(int iParam0)//Position - 0x1B43
{
	return Global_8D15 == iParam0;
}

bool func_25(int iParam0)//Position - 0x1B51
{
	return iParam0 < 3;
}

int func_26(int iParam0)//Position - 0x1B5D
{
	int iVar0;
	int iVar1;
...
int func_27(int iParam0)//Position - 0x1B9A
{
	if (func_25(iParam0))
	{
...
int func_28(int iParam0)//Position - 0x1BC4
{
	int iVar0;
	int iVar1;
...
void func_29(int iParam0, int iParam1)//Position - 0x1C07
{
	MISC::SET_BIT(&(Global_19E56.f_6187.f_8[iParam0]), iParam1);
}

int func_30(int iParam0)//Position - 0x1C22
{
	int iVar0;
...
int func_32(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x1CF0
{
...
int func_33()//Position - 0x1ECA
{
	return 1;
}

void func_34(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1ED3
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_36(int iParam0, char* sParam1, int iParam2)//Position - 0x2024
{
	AUDIO::_PLAY_AMBIENT_SPEECH1(iParam0, sParam1, func_37(iParam2), 1);
}

int func_37(int iParam0)//Position - 0x203B
{
	int iVar0;
...
bool func_38(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2230
{
...
int func_39(char* sParam0, int iParam1, bool bParam2)//Position - 0x227E
{
	Global_3DCF = 0;
...
bool func_46(int iParam0, int iParam1)//Position - 0x27CB
{
	switch (iParam0)
	{
		case 5:
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x285D
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
int func_49()//Position - 0x28B3
{
	func_23();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_50(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x28CC
{
...
int func_52()//Position - 0x2989
{
	if (func_2(iLocal_48))
	{
		if (!bLocal_64)
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), unk_0x8000C77B5F336760(iLocal_48, false), true) <= 7f || BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_48, 242628503) == 7)
			{
				if (!iLocal_66)
				{
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), unk_0x8000C77B5F336760(iLocal_48, false), true) <= 7f)
					{
					}
					if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_48, 242628503) == 7)
					{
					}
				}
				return 1;
		...
		else if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), unk_0x8000C77B5F336760(iLocal_48, false), true) <= 4.5f || BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_48, 242628503) == 7)
		{
			if (!iLocal_66)
			{
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), unk_0x8000C77B5F336760(iLocal_48, false), true) <= 4.5f)
				{
				}
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_48, 242628503) == 7)
				{
...
int func_54()//Position - 0x2ABC
{
	int iVar0;
	
	iVar0 = INTERIOR::GET_INTERIOR_AT_COORDS(Local_45[0 /*20*/].f_A);
	if (iVar0 != 0)
	{
...
void func_55()//Position - 0x2AED
{
	switch (iLocal_47)
	{
		...
		case 1:
			if (func_54())
			{
				if (!OBJECT::_DOES_DOOR_EXIST(2463679010))
				{
					OBJECT::ADD_DOOR_TO_SYSTEM(2463679010, joaat("v_ilev_fib_door1"), -31.72f, -1101.85f, 26.57f, 1, 1, 0);
				}
				else if (OBJECT::_0x65499865FCA6E5EC(2463679010) < 1f)
				{
					OBJECT::_SET_DOOR_AJAR_ANGLE(2463679010, 1f, 0, 0);
					OBJECT::_SET_DOOR_ACCELERATION_LIMIT(2463679010, 1, 0, 1);
				}
			}
			func_53();
			if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
					...
					if (func_59())
					{
						if (iLocal_71 == 0)
						{
							if (bLocal_63)
							{
								NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_48);
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_87);
								BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295, 12, 2);
								BRAIN::TASK_PLAY_ANIM(0, "cellphone@", "cellphone_call_out", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
								CUTSCENE::_0x8D9DF6ECA8768583(iLocal_87);
								BRAIN::TASK_PERFORM_SEQUENCE(iLocal_48, iLocal_87);
								BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_87);
							}
...
void func_56()//Position - 0x2D45
{
	if (func_49() == 1)
	{
		func_50(&uLocal_92, 1, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
	}
	else
	{
		func_50(&uLocal_92, 0, AUDIO::_0x0626A247D2405330(), "MICHAEL", 0, 1);
	}
...
int func_57()//Position - 0x2E0B
{
	if ((((((((func_58(AUDIO::_0x0626A247D2405330()) != joaat("weapon_unarmed") && func_58(AUDIO::_0x0626A247D2405330()) != joaat("object")) && func_58(AUDIO::_0x0626A247D2405330()) != joaat("weapon_knife")) && func_58(AUDIO::_0x0626A247D2405330()) != joaat("weapon_nightstick")) && func_58(AUDIO::_0x0626A247D2405330()) != joaat("weapon_hammer")) && func_58(AUDIO::_0x0626A247D2405330()) != joaat("weapon_bat")) && func_58(AUDIO::_0x0626A247D2405330()) != joaat("weapon_crowbar")) && func_58(AUDIO::_0x0626A247D2405330()) != joaat("weapon_golfclub")) && func_58(AUDIO::_0x0626A247D2405330()) != joaat("weapon_bottle"))
	{
...
int func_58(int iParam0)//Position - 0x2EE0
{
	var uVar0;
...
int func_59()//Position - 0x2EF4
{
	...
	{
		if (INTERIOR::GET_ROOM_KEY_FROM_ENTITY(AUDIO::_0x0626A247D2405330()) == MISC::GET_HASH_KEY("rm_showroom"))
		{
			if (!func_123())
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -41.19015f, -1104.137f, 24.42232f, -33.7943f, -1107.183f, 28.67232f, 8.5f, 0, true, 0))
				{
					bLocal_64 = true;
					func_71(0);
				}
...
void func_60(int iParam0)//Position - 0x3049
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
int func_61(int iParam0)//Position - 0x308A
{
	if (func_65())
	{
		Global_19E4C = 1;
		Global_19E49 = MISC::GET_GAME_TIMER();
		if (func_17(Global_19E4B))
		{
			func_62(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_17(Global_19E4B))
		{
...
void func_62(int iParam0)//Position - 0x30DD
{
	switch (iParam0)
	{
		case 0:
			if (Global_19E56.f_6187.f_2 < 3)
			{
				...
				{
					func_63(func_64(iParam0), 4294967295);
...
void func_63(char* sParam0, int iParam1)//Position - 0x31BE
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_64(int iParam0)//Position - 0x31D5
{
	char* sVar0;
...
int func_65()//Position - 0x3219
{
	switch (func_66(&Global_63AE, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_66(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x324F
{
	int iVar0;
...
void func_67(var uParam0, int iParam1)//Position - 0x3386
{
	int iVar0;
...
bool func_68(int iParam0)//Position - 0x33D5
{
	return func_69(iParam0, Global_8D15);
}

int func_69(int iParam0, int iParam1)//Position - 0x33E6
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_70(int iParam0)//Position - 0x35C7
{
	if (Global_8D15 == 15)
	{
		return 0;
...
void func_71(bool bParam0)//Position - 0x35E9
{
	if (bParam0)
	{
		if (func_2(iLocal_50))
		{
			...
			unk_0x346478B12F69D4E3(iLocal_50, false);
	...
	else if (func_2(iLocal_49))
	{
		...
		unk_0x346478B12F69D4E3(iLocal_49, false);
...
void func_72(int iParam0)//Position - 0x365F
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		...
		case 1:
			if (!func_2(iLocal_49) || !func_2(iLocal_50))
			{
				...
				if (func_2(iLocal_49))
				{
					...
					iLocal_53 = OBJECT::CREATE_OBJECT(iLocal_74, unk_0x8000C77B5F336760(iLocal_49, true), true, true, false);
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_53, iLocal_49, PED::GET_PED_BONE_INDEX(iLocal_49, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1);
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_87);
					BRAIN::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_b", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_f", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_no_a", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_d", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::SET_SEQUENCE_TO_REPEAT(iLocal_87, 1);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_87);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_49, iLocal_87);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_87);
					unk_0x346478B12F69D4E3(iLocal_49, true);
				}
				...
				if (func_2(iLocal_50))
				{
					...
					iLocal_54 = OBJECT::CREATE_OBJECT(iLocal_74, unk_0x8000C77B5F336760(iLocal_50, true), true, true, false);
					...
					BRAIN::SET_SEQUENCE_TO_REPEAT(iLocal_87, 1);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_87);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_50, iLocal_87);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_87);
					unk_0x346478B12F69D4E3(iLocal_49, true);
				}
			}
...
int func_75(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0x3AAA
{
	int iVar0;
...
int func_76(var uParam0, int iParam1)//Position - 0x3B38
{
	int iVar0;
...
int func_77(int iParam0)//Position - 0x3B7E
{
	if (!func_25(iParam0))
	{
		return Global_19E56.f_6D76[iParam0 /*29*/];
...
int func_78()//Position - 0x3BA9
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(AUDIO::_0x0626A247D2405330())) > 1369f && !func_89())
		{
			return 0;
		}
	}
...
int func_79(float fParam0, bool bParam1)//Position - 0x3C2F
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_80(int iParam0, var uParam1)//Position - 0x3CE6
{
	switch (iParam0)
	{
		case 0:
		...
		case 1:
			func_81(uParam1, "Abigail2", func_83(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, 4294967295, 4, 1, 0, 2359, func_82(iParam0), 1, 0);
			break;
		
		case 2:
			func_81(uParam1, "Barry1", func_83(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 0, 2359, func_82(iParam0), 1, 0);
			break;
		
		case 3:
			func_81(uParam1, "Barry2", func_83(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_82(iParam0), 1, 1);
			break;
		
		case 4:
			func_81(uParam1, "Barry3", func_83(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", 4294967295, 0, "", 164, 1, 4294967295, 0, 2, 0, 2359, func_82(iParam0), 0, 0);
			break;
		...
		case 7:
			func_81(uParam1, "Barry4", func_83(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, 4294967295, 4, 2, 800, 2000, func_82(iParam0), 0, 0);
			break;
		
		case 8:
			func_81(uParam1, "Dreyfuss1", func_83(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_82(iParam0), 0, 0);
			break;
		...
		case 15:
			func_81(uParam1, "Epsilon7", func_83(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", 4294967295, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_82(iParam0), 0, 0);
			break;
		
		case 16:
			func_81(uParam1, "Epsilon8", func_83(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, 4294967295, 4, 1, 0, 2359, func_82(iParam0), 1, 0);
			break;
		
		case 17:
			func_81(uParam1, "Extreme1", func_83(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", 4294967295, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
			break;
		...
		case 20:
			func_81(uParam1, "Extreme4", func_83(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_82(iParam0), 0, 0);
			break;
		
		case 21:
			func_81(uParam1, "Fanatic1", func_83(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 700, 2000, func_82(iParam0), 1, 0);
			break;
		
		case 22:
			func_81(uParam1, "Fanatic2", func_83(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 700, 2000, func_82(iParam0), 1, 0);
			break;
		
		case 23:
			func_81(uParam1, "Fanatic3", func_83(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 2, 700, 2000, func_82(iParam0), 0, 1);
			break;
		
		case 24:
			func_81(uParam1, "Hao1", func_83(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", 4294967295, 0, "controller_Races", 13, 1, 4294967295, 4, 2, 2000, 500, func_82(iParam0), 0, 1);
			break;
		
		case 25:
			func_81(uParam1, "Hunting1", func_83(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", 4294967295, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_82(iParam0), 0, 1);
			break;
		
		case 26:
			func_81(uParam1, "Hunting2", func_83(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, 4294967295, 4, 4, 0, 2359, func_82(iParam0), 0, 1);
			break;
		
		case 27:
			func_81(uParam1, "Josh1", func_83(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", 4294967295, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_82(iParam0), 1, 0);
			break;
		...
		case 29:
			func_81(uParam1, "Josh3", func_83(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 4294967295, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_82(iParam0), 1, 1);
			break;
		
		case 30:
			func_81(uParam1, "Josh4", func_83(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", 4294967295, 36, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_82(iParam0), 1, 0);
			break;
		
		case 31:
			func_81(uParam1, "Maude1", func_83(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", 4294967295, 0, "BailBond_Launcher", 0, 1, 4294967295, 4, 4, 0, 2359, func_82(iParam0), 0, 1);
			break;
		
		case 32:
			func_81(uParam1, "Minute1", func_83(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", 4294967295, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_82(iParam0), 0, 1);
			break;
		
		case 33:
			func_81(uParam1, "Minute2", func_83(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", 4294967295, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_82(iParam0), 0, 1);
			break;
		
		case 34:
			func_81(uParam1, "Minute3", func_83(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", 4294967295, 10, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_82(iParam0), 0, 1);
			break;
		
		case 35:
			func_81(uParam1, "MrsPhilips1", func_83(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", 4294967295, 0, "ambient_MrsPhilips", 0, 1, 4294967295, 4, 4, 0, 2359, func_82(iParam0), 0, 0);
			break;
		
		case 36:
			func_81(uParam1, "MrsPhilips2", func_83(iParam0), 0, 11, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_82(iParam0), 0, 0);
			break;
		
		case 37:
			func_81(uParam1, "Nigel1", func_83(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", 4294967295, 0, "", 177, 1, 4294967295, 1, 4, 0, 2359, func_82(iParam0), 1, 0);
			break;
		...
		case 42:
			func_81(uParam1, "Nigel2", func_83(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", 4294967295, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_82(iParam0), 1, 1);
			break;
		
		case 43:
			func_81(uParam1, "Nigel3", func_83(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", 4294967295, 16, "postRC_Nigel3", 0, 0, 4294967295, 4, 4, 0, 2359, func_82(iParam0), 1, 1);
			break;
		
		case 44:
			func_81(uParam1, "Omega1", func_83(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", 4294967295, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_82(iParam0), 0, 0);
			break;
		
		case 45:
			func_81(uParam1, "Omega2", func_83(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_82(iParam0), 0, 0);
			break;
		
		case 46:
			func_81(uParam1, "Paparazzo1", func_83(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", 4294967295, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
			break;
		
		case 47:
			func_81(uParam1, "Paparazzo2", func_83(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", 4294967295, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
			break;
		
		case 48:
			func_81(uParam1, "Paparazzo3", func_83(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", 4294967295, 8, "", 183, 1, 4294967295, 2, 2, 0, 2359, func_82(iParam0), 0, 0);
			break;
		...
		case 51:
			func_81(uParam1, "Paparazzo4", func_83(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", 4294967295, 8, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_82(iParam0), 0, 0);
			break;
		
		case 52:
			func_81(uParam1, "Rampage1", func_83(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", 4294967295, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_82(iParam0), 0, 0);
			break;
		
		case 54:
			func_81(uParam1, "Rampage3", func_83(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", 4294967295, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_82(iParam0), 1, 0);
			break;
		
		case 55:
			func_81(uParam1, "Rampage4", func_83(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", 4294967295, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_82(iParam0), 1, 0);
			break;
		
		case 56:
			func_81(uParam1, "Rampage5", func_83(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", 4294967295, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_82(iParam0), 0, 0);
			break;
		
		case 53:
			func_81(uParam1, "Rampage2", func_83(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", 4294967295, 0, "rampage_controller", 0, 0, 4294967295, 4, 4, 0, 2359, func_82(iParam0), 1, 0);
			break;
		
		case 57:
			func_81(uParam1, "TheLastOne", func_83(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
			break;
		
		case 58:
			func_81(uParam1, "Tonya1", func_83(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", 4294967295, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
			break;
		
		case 59:
			func_81(uParam1, "Tonya2", func_83(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
			break;
		
		case 60:
			func_81(uParam1, "Tonya3", func_83(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
			break;
		
		case 61:
			func_81(uParam1, "Tonya4", func_83(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
			break;
		
		case 62:
			func_81(uParam1, "Tonya5", func_83(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_82(iParam0), 0, 1);
			break;
...
int func_82(int iParam0)//Position - 0x4FBE
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_83(int iParam0)//Position - 0x5304
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_84(int iParam0)//Position - 0x533C
{
	struct<2> Var0;
...
bool func_86()//Position - 0x57BB
{
	return Global_19D3C > 0;
}

int func_87()//Position - 0x57C9
{
...
int func_90()//Position - 0x5821
{
	if (((((((((((STREAMING::HAS_MODEL_LOADED(Local_45[0 /*20*/]) && STREAMING::HAS_MODEL_LOADED(Local_45[1 /*20*/])) && WEAPON::HAS_WEAPON_ASSET_LOADED(Local_45[0 /*20*/].f_11)) && WEAPON::HAS_WEAPON_ASSET_LOADED(Local_45[1 /*20*/].f_11)) && func_54()) && STREAMING::HAS_ANIM_DICT_LOADED("cellphone@")) && STREAMING::HAS_ANIM_DICT_LOADED("cellphone@str")) && BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED("reyetarian_simeonoffice")) && STREAMING::HAS_MODEL_LOADED(iLocal_74)) && STREAMING::HAS_MODEL_LOADED(joaat("BJXL"))) && STREAMING::HAS_MODEL_LOADED(joaat("TAILGATER"))) && STREAMING::HAS_MODEL_LOADED(joaat("BALLER2")))
	{
		return 1;
	}
	return 0;
...
void func_91(int iParam0)//Position - 0x58CD
{
	switch (Local_45[iParam0 /*20*/].f_12)
	{
		...
		case 1:
			if (!Local_45[iParam0 /*20*/].f_13)
			{
				...
				{
					Local_45[iParam0 /*20*/].f_1 = PED::CREATE_PED(22, Local_45[iParam0 /*20*/], Local_45[iParam0 /*20*/].f_A, Local_45[iParam0 /*20*/].f_D, 1, true);
					if (func_2(Local_45[iParam0 /*20*/].f_1))
					{
						if (iParam0 == 0)
						{
							BRAIN::TASK_START_SCENARIO_AT_POSITION(Local_45[iParam0 /*20*/].f_1, "PROP_HUMAN_SEAT_CHAIR", vLocal_80[iParam0 /*3*/], fLocal_81[iParam0], 0, 0, 1);
						...
						ENTITY::SET_ENTITY_HEALTH(Local_45[iParam0 /*20*/].f_1, true);
						...
						if (func_49() == 0)
						{
							WEAPON::GIVE_WEAPON_TO_PED(Local_45[iParam0 /*20*/].f_1, Local_45[iParam0 /*20*/].f_11, 4294967295, true, true);
						}
		...
		case 2:
			if (func_2(Local_45[iParam0 /*20*/].f_1))
			{
				if (iLocal_67)
				{
					func_93(Local_45[iParam0 /*20*/].f_1, &(Local_45[iParam0 /*20*/].f_2), 4294967295, 0, 0, 0, 3212836864, 0, 4294967295, 4294967295, 1);
					NETWORK::_0x5E3AA4CA2B6FB0EE(Local_45[iParam0 /*20*/].f_1);
					PED::SET_PED_USING_ACTION_MODE(Local_45[iParam0 /*20*/].f_1, true, 4294967295, "DEFAULT_ACTION");
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_87);
					BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 4294967295, 12, 2);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_45[iParam0 /*20*/].f_E, 1f, 4294967295, 3f, 0, 1193033728);
					BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, AUDIO::_0x0626A247D2405330(), 0);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_87);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_45[iParam0 /*20*/].f_1, iLocal_87);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_87);
					Local_45[iParam0 /*20*/].f_12 = 3;
				}
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), unk_0x8000C77B5F336760(Local_45[iParam0 /*20*/].f_1, false), true) >= 250f)
				{
		...
		case 3:
			...
			{
				func_93(Local_45[iParam0 /*20*/].f_1, &(Local_45[iParam0 /*20*/].f_2), 4294967295, 0, 0, 0, 3212836864, 0, 4294967295, 4294967295, 1);
				if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_45[iParam0 /*20*/].f_1, 242628503) == 7 || MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), unk_0x8000C77B5F336760(Local_45[iParam0 /*20*/].f_1, false), true) <= 5f)
				{
					BRAIN::TASK_LOOK_AT_ENTITY(Local_45[iParam0 /*20*/].f_1, AUDIO::_0x0626A247D2405330(), 4294967295, 0, 2);
					BRAIN::TASK_COMBAT_PED(Local_45[iParam0 /*20*/].f_1, AUDIO::_0x0626A247D2405330(), 0, 16);
		...
		case 4:
			...
			else
			{
				if (iLocal_70[iParam0] == 0)
				{
					...
					{
						WEAPON::GIVE_WEAPON_TO_PED(Local_45[iParam0 /*20*/].f_1, Local_45[iParam0 /*20*/].f_11, 4294967295, false, true);
						iLocal_70[iParam0] = 1;
					}
				}
				if (BRAIN::GET_SCRIPT_TASK_STATUS(Local_45[iParam0 /*20*/].f_1, 780511057) == 7)
				{
					BRAIN::TASK_COMBAT_PED(Local_45[iParam0 /*20*/].f_1, AUDIO::_0x0626A247D2405330(), 0, 16);
				}
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), unk_0x8000C77B5F336760(Local_45[iParam0 /*20*/].f_1, false), true) >= 75f)
				{
					Local_45[iParam0 /*20*/].f_12 = 5;
				}
			}
...
void func_92(int iParam0)//Position - 0x5D5F
{
	bool bVar0;
	struct<8> Var1;
...
int func_93(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x5DD1
{
	if (iParam3 == 0)
	{
...
void func_94()//Position - 0x5FA8
{
	int iVar0;
	
	if (func_123())
	{
		func_121(&Global_63AE);
	}
	else
	{
		func_121(&Global_63AE);
	...
	if (BRAIN::DOES_SCENARIO_GROUP_EXIST("DEALERSHIP"))
	{
		if (!BRAIN::IS_SCENARIO_GROUP_ENABLED("DEALERSHIP"))
		{
			BRAIN::SET_SCENARIO_GROUP_ENABLED("DEALERSHIP", true);
		}
	}
...
void func_95(int iParam0)//Position - 0x60AA
{
	char cVar0[64];
	...
	if (func_123())
	{
		...
		func_98(30000);
		StringCopy(&cVar0, func_97(Global_19E4B, 1), 64);
		if (func_30(Global_19E4B) > 0)
		{
...
void func_96(int iParam0)//Position - 0x615F
{
	Global_19E4B = iParam0;
}

char* func_97(int iParam0, bool bParam1)//Position - 0x616D
{
	switch (iParam0)
	{
		case 0:
...
void func_98(int iParam0)//Position - 0x63B6
{
	Global_8F3C = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_99(int iParam0)//Position - 0x63C8
{
	func_100(iParam0, 0, func_120(iParam0));
}

void func_100(int iParam0, int iParam1, int iParam2)//Position - 0x63DD
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_101(var uParam0)//Position - 0x640C
{
	struct<16> Var0;
	int iVar1;
...
int func_104(int iParam0)//Position - 0x6519
{
	return iParam0 & 15;
}

int func_105(int iParam0)//Position - 0x6526
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_106(int iParam0)//Position - 0x6538
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_107(int iParam0)//Position - 0x654B
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_108(int iParam0)//Position - 0x655E
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

void func_109(int iParam0, var uParam1)//Position - 0x6571
{
	Global_19E56.f_6187.f_2B[iParam0] = *uParam1;
}

void func_110(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x6589
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_111(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x670B
{
...
void func_112(var uParam0, int iParam1)//Position - 0x6743
{
	if (iParam1 <= 0)
	{
		return;
...
void func_113(var uParam0, int iParam1)//Position - 0x67C9
{
	int iVar0;
	int iVar1;
...
void func_114(var uParam0, int iParam1)//Position - 0x681A
{
...
void func_115(var uParam0, int iParam1)//Position - 0x684D
{
...
void func_116(var uParam0, int iParam1)//Position - 0x6887
{
...
void func_117(var uParam0, int iParam1)//Position - 0x68C2
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_118(int iParam0, int iParam1)//Position - 0x68FE
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_120(int iParam0)//Position - 0x69E6
{
	int iVar0;
...
void func_121(var uParam0)//Position - 0x6B89
{
	if (*uParam0 == 4294967295)
	{
		return;
...
int func_123()//Position - 0x6C28
{
	if ((Global_19E4B == func_31() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_19E4C)
	{
		return 1;
	}
	return 0;
...
void func_124()//Position - 0x6C53
{
	...
	BRAIN::ADD_COVER_BLOCKING_AREA(-34.2476f, -1107.283f, 24.9621f, -24.7924f, -1102.557f, 29.8287f, 1, 1, 1, 0);
	if (iLocal_86 == 4294967295)
	{
	...
	WEAPON::REQUEST_WEAPON_ASSET(Local_45[0 /*20*/].f_11, 31, 0);
	WEAPON::REQUEST_WEAPON_ASSET(Local_45[1 /*20*/].f_11, 31, 0);
	STREAMING::REQUEST_ANIM_DICT("cellphone@");
	STREAMING::REQUEST_ANIM_DICT("cellphone@str");
	BRAIN::REQUEST_WAYPOINT_RECORDING("reyetarian_simeonoffice");
	AUDIO::PREPARE_MUSIC_EVENT("RE9_SPOTTED");
}

void func_125(int iParam0, int iParam1)//Position - 0x6EEB
{
	int iVar0;
...
void func_126(int iParam0)//Position - 0x6FE4
{
...
void func_127(int iParam0)//Position - 0x7032
{
	struct<7> Var0;
	bool bVar1;
	bool bVar2;
...
int func_129(int iParam0)//Position - 0x7594
{
	int iVar0;
...
int func_130(int iParam0)//Position - 0x77E9
{
	int iVar0;
	...
	if ((iParam0 == 40 || iParam0 == 49) || iParam0 == 52)
	{
		if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
		{
			...
			{
				iVar0 = ENTITY::GET_ENTITY_MODEL(func_131(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 1)));
				switch (iVar0)
				{
...
int func_131(int iParam0)//Position - 0x7855
{
	return iParam0;
}

void func_132(int iParam0, var uParam1)//Position - 0x785F
{
	int iVar0;
	int iVar1;
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_133(iParam0) && SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(Global_14893[26 /*34*/].f_6) == 0)
			{
				Global_19E56.f_1C41[iParam0] = 1;
				OBJECT::_SET_DOOR_ACCELERATION_LIMIT(uParam1->f_5, Global_19E56.f_1C41[iParam0], 1, 1);
			}
...
bool func_133(int iParam0)//Position - 0x81FC
{
	struct<7> Var0;
	int iVar1;
...
struct<7> func_134(int iParam0)//Position - 0x8230
{
	struct<7> Var0;
...
int func_135()//Position - 0xAE39
{
	if ((func_12() == 4294967295 || func_12() == 999) && !func_136() == 0)
	{
		return 1;
	}
	return 0;
...
int func_136()//Position - 0xAE69
{
	return Global_6374;
}

void func_137(int iParam0)//Position - 0xAE74
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_31();
...
int func_139(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xAEE7
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_160(Global_19E56.f_6187.f_2B[iParam1]))
		{
			return 0;
		}
...
bool func_140(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0xB281
{
	if (bParam2)
	{
...
bool func_141(int iParam0)//Position - 0xB2C8
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0xB2E9
{
	return func_143(iParam0, 1);
}

int func_143(int iParam0, int iParam1)//Position - 0xB2F8
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_144(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xB34B
{
	func_145(func_119(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_145(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xB369
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_146(float fParam0, float fParam1, float fParam2)//Position - 0xB56A
{
	float fVar0;
...
int func_147(int iParam0, int iParam1)//Position - 0xB5AC
{
	int iVar0;
	int iVar1;
...
int func_148(int iParam0)//Position - 0xB6B8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_149(int iParam0, int iParam1)//Position - 0xB794
{
...
int func_150(int iParam0)//Position - 0xB7B7
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_158()) || Global_6375) || func_157()) || func_46(8, 4294967295)) || func_154()) || func_156()) || func_155()) || func_153()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_158()) || Global_19A9D) || Global_6375) || func_157()) || func_46(8, 4294967295)) || func_154()) || func_156()) || func_155()) || func_153()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_158() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_46(8, 4294967295)) || func_153()) || func_152()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_46(8, 4294967295) || func_156()) || func_155()) || func_152()) || func_151())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_158()) || Global_6375) || func_157()) || func_46(8, 4294967295)) || func_155()) || func_154()) || func_153()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_151()//Position - 0xBED4
{
	return Global_16C57.f_1;
}

int func_152()//Position - 0xBEE2
{
	if (Global_16089 != 4294967295)
	{
...
bool func_155()//Position - 0xBF4C
{
	return Global_16C64.f_148 > 0;
}

bool func_156()//Position - 0xBF5D
{
	return Global_16C64.f_147 > 0;
}

var func_157()//Position - 0xBF6E
{
	return Global_140859;
}

int func_158()//Position - 0xBF7A
{
...
bool func_160(int iParam0)//Position - 0xBFBE
{
	return func_147(func_119(), iParam0);
}

int func_161(int iParam0, int iParam1, int iParam2)//Position - 0xBFD0
{
	int iVar0;
	int iVar1;
...
int func_162(int iParam0)//Position - 0xC0B5
{
	if (!func_25(iParam0))
	{
		return 7;
...
bool func_163(int iParam0)//Position - 0xC0D9
{
	int iVar0;
	bool bVar1;
...
void func_166()//Position - 0xC236
{
	func_94();
}

void func_167(vector3 vParam0)//Position - 0xC242
{
