			...
			switch (iLocal_142)
			{
				case 0:
					if (func_222(1, 1093140480, 0))
					{
						...
						if (_DOES_DOOR_EXIST(1736361794))
						{
							...
							_SET_DOOR_ACCELERATION_LIMIT(1736361794, 0, 1, 0);
						}
						START_CUTSCENE(0);
				...
				case 2:
					if (IS_CUTSCENE_PLAYING())
					{
						...
						{
							func_215(PLAYER_PED_ID(), 1974.513f, 3814.579f, 32.4266f, 270f, 0, 1);
							FORCE_PED_MOTION_STATE(PLAYER_PED_ID(), -668482597, 0, 1, 0);
							SIMULATE_PLAYER_INPUT_GAIT(PLAYER_ID(), 1f, 4000, 0, 1, 0);
...
void func_206(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_210(PLAYER_ID())) && !func_208(PLAYER_ID(), 0)) && !func_207()) && !bParam4) && !bParam5)
			{
				SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
			}
		}
		else if (((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_210(PLAYER_ID())) && !bParam4) && !bParam5)
		{
			SET_ENTITY_INVINCIBLE(PLAYER_PED_ID(), 0);
		}
		Global_71588 = 0;
...
int func_215(var uParam0, vector3 vParam1, float fParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	float fVar1;
...
void func_216(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	var uVar0;
	...
	if (IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			CLEAR_AREA_OF_PEDS(func_217(GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_222(int iParam0, int iParam1, int iParam2)
{
	...
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_229(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_228(PLAYER_PED_ID(), -828834893))
				{
...
{
	if (((!func_246(0) || Global_71859) || Global_71848 == 1) || !IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71844)
	{
		...
		case 5:
			if ((IS_CUTSCENE_PLAYING() || func_245(0)) || func_244(1))
			{
			}
			else
			{
...
void func_265(bool bParam0)
{
	...
	if (!func_285())
	{
		...
		{
			func_159(iVar0, 1, 0);
			func_266(GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_105652[iVar0 /*10*/].f_9 == -1)
...
int func_267(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_273())
	{
		...
		{
			iVar33 = func_268(GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
