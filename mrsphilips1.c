...
void func_231(void fParam0, bool bParam1)
{
	func_219(bParam1);
	...
	if (Global_71232 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_234(Global_71233, Global_71235, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_246(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
...
void func_266(void fParam0, int iParam1)
{
	if (Global_92955 != 12)
	{
		if (func_267(fParam0, 6, iParam1))
		{
...
int func_270(void fParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
