	...
	while (true)
	{
		switch (iLocal_51)
		{
			...
			case 1:
				if (func_141())
				{
					vLocal_243 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false) };
					func_110();
					if (func_109())
					{
...
void func_1()//Position - 0x16C
{
	if (!func_3())
	{
		if (MISC::ARE_STRINGS_EQUAL("NULL", &Global_19AA6))
		{
			func_2(0);
		}
		else if (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(MISC::GET_HASH_KEY(&Global_19AA6)) == 0)
		{
			func_2(0);
		}
	}
...
void func_5()//Position - 0x22D
{
	...
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "HAIL_TAXI", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(AUDIO::_0x0626A247D2405330(), "HAIL_TAXI", &cLocal_240, -2f);
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "FP_HAIL_TAXI", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(AUDIO::_0x0626A247D2405330(), "FP_HAIL_TAXI", &cLocal_240, -2f);
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "FUCK_U", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(AUDIO::_0x0626A247D2405330(), "FUCK_U", &cLocal_240, -2f);
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "FORGET_IT", 3))
		{
			ENTITY::STOP_ENTITY_ANIM(AUDIO::_0x0626A247D2405330(), "FORGET_IT", &cLocal_240, -2f);
		}
		if (iLocal_65 != 4294967295)
		{
			PED::SET_PED_CONFIG_FLAG(AUDIO::_0x0626A247D2405330(), 113, false);
		}
		if (iLocal_62 == 1)
		{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_19A8E))
	{
		...
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_19A8E, &cLocal_240, "Aknowledge_R", 3))
			{
				ENTITY::STOP_ENTITY_ANIM(Global_19A8E, "Aknowledge_R", &cLocal_240, -4f);
			}
			else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_19A8E, &cLocal_240, "Aknowledge_L", 3))
			{
				ENTITY::STOP_ENTITY_ANIM(Global_19A8E, "Aknowledge_L", &cLocal_240, -4f);
			}
		}
	}
	if (iLocal_54 == 0)
				...
				if (!PED::IS_PED_INJURED(Local_56.f_1))
				{
					...
					if (!PED::IS_PED_FLEEING(Local_56.f_1) && !PED::IS_PED_IN_COMBAT(Local_56.f_1, 0))
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(Local_56.f_1, 0))
						{
							...
							{
								if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Local_56, 0))
								{
									...
									{
										BRAIN::TASK_SMART_FLEE_PED(Local_56.f_1, AUDIO::_0x0626A247D2405330(), 500f, 4294967295, 0, 0);
									}
								}
								else
								{
...
{
	if (func_21(&Global_19A8D, iLocal_70, iLocal_69))
	{
		if (PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), Global_19A8D, 0))
		{
			if (PED::IS_PED_SITTING_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), Global_19A8D))
			{
				func_20();
				if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(Global_19A8D, 1, 0) == AUDIO::_0x0626A247D2405330())
				{
					iLocal_246 = 1;
				}
				else
...
void func_16()//Position - 0xB47
{
	...
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		iVar0 = PED::GET_RANDOM_PED_AT_COORD(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), 1.5f, 1.5f, 1.5f, 4294967295);
		if (!PED::IS_PED_INJURED(iVar0))
		{
			if (PED::IS_PED_ON_FOOT(iVar0))
			{
				BRAIN::TASK_SMART_FLEE_PED(iVar0, AUDIO::_0x0626A247D2405330(), 150f, 4294967295, 0, 0);
			}
		}
	}
}
...
int func_24(int iParam0)//Position - 0xF3D
{
	...
	if (!ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), *iParam0, 5f, 5f, 2f, 0, 1, 0))
	{
		return 0;
	}
	...
	if (INTERIOR::GET_INTERIOR_FROM_ENTITY(*iParam0) != INTERIOR::GET_INTERIOR_FROM_ENTITY(AUDIO::_0x0626A247D2405330()))
	{
		return 0;
	}
	if (!func_25(*iParam0))
...
void func_26()//Position - 0xFCD
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_244))
	{
		if (func_21(&iLocal_244, iLocal_70, iLocal_69))
		{
			...
			{
				if (PED::IS_PED_SITTING_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_244))
				{
					iVar0 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_244, 4294967295, 0);
					if (!VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_244, 1, 0))
					{
						if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_244, 1, 0) == AUDIO::_0x0626A247D2405330())
						{
							iLocal_246 = 1;
						}
					}
					...
					{
						if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_244, 2, 0) == AUDIO::_0x0626A247D2405330())
						{
							iLocal_246 = 2;
						}
					}
...
void func_28()//Position - 0x11E8
{
	...
	if (func_24(&iLocal_244))
	{
		if (!iLocal_59)
		{
			if (iLocal_244 == Global_19A8D && iLocal_55 == 4)
			{
				if (!HUD::IS_HELP_MESSAGE_ON_SCREEN())
				{
					if (!func_7("TX_H02"))
					{
						if (Global_19E56.f_2725.f_79 < 5)
						{
							func_29("TX_H02", 4294967295);
							Global_19E56.f_2725.f_79++;
						}
						iLocal_59 = 1;
					}
				}
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			if (iVar0 == iLocal_244)
			{
				iVar1 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_244, 4294967295, 0);
				if (iLocal_55 == 4 || iLocal_55 == 2)
				{
					if (iLocal_244 != Global_19A8D)
					{
				...
				if (func_27(&iLocal_244, &iVar1, 0))
				{
					...
					if (!PED::IS_PED_INJURED(Global_19A8E) && OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Global_19A8D, 0))
					{
						if (PED::IS_PED_SITTING_IN_VEHICLE(Global_19A8E, Global_19A8D))
						{
							if (!func_18(Global_19A8E, 2176111930))
							{
								BRAIN::TASK_VEHICLE_TEMP_ACTION(Global_19A8E, Global_19A8D, 1, 10000);
							}
						}
					}
					iLocal_59 = 0;
...
{
	if (func_41(&Global_19A8D, &Global_19A8E, iLocal_70, iLocal_69))
	{
		if (!func_35())
		{
			if (!func_18(Global_19A8E, 2176111930))
...
int func_35()//Position - 0x1533
{
	...
	if (iLocal_55 == 4)
	{
		if (Global_19AB2 == 4294967295 || Global_19AB2 == 0)
		{
			Global_19AB2 = MISC::GET_GAME_TIMER();
		}
		else if (func_40(Global_19AB2, 30000))
		{
	...
	if (func_38(Global_19A8D))
	{
		...
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Global_19A8D, AUDIO::_0x0626A247D2405330(), 1))
		{
			return 1;
		}
		...
		{
			if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), Global_19A8D) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), Global_19A8D))
			{
				return 1;
			}
	...
	if (func_36(Global_19A8E))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Global_19A8E, AUDIO::_0x0626A247D2405330(), 1))
		{
			return 1;
		}
	}
...
{
	if (ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "HAIL_TAXI", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "FP_HAIL_TAXI", 3))
	{
		return;
	}
	else if (func_40(iLocal_67, 3000))
	{
		...
		if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_240))
		{
			if (func_43())
			{
				...
				PED::SET_PED_CONFIG_FLAG(AUDIO::_0x0626A247D2405330(), 113, true);
				if (MISC::GET_RANDOM_INT_IN_RANGE(0, 3) < 2)
				{
					BRAIN::TASK_PLAY_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "FORGET_IT", 4f, -2f, 4294967295, 48, 0, 0, 0, 0);
				}
				else
				{
					BRAIN::TASK_PLAY_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "FUCK_U", 4f, -2f, 4294967295, 48, 0, 0, 0, 0);
				}
			}
...
int func_43()//Position - 0x18D3
{
	...
	if (!Global_9196 && PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()))
	{
		return 0;
	}
...
void func_48()//Position - 0x1A0E
{
	...
	if (func_41(&Global_19A8D, &Global_19A8E, iLocal_70, iLocal_69))
	{
		...
		{
			if (BRAIN::GET_SCRIPT_TASK_STATUS(AUDIO::_0x0626A247D2405330(), 2277090178) == 7)
			{
				if (((!ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "HAIL_TAXI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "FP_HAIL_TAXI", 3)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "FUCK_U", 3)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "FORGET_IT", 3))
				{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_240))
			{
				if (MISC::GET_RANDOM_INT_IN_RANGE(0, 10) < 8)
				{
					if (!func_53(0, 0))
					{
						...
						func_51(AUDIO::_0x0626A247D2405330(), "TAXI_HAIL", 34);
						if (bVar1)
						{
				...
				if (func_50(Global_19A8D))
				{
					BRAIN::TASK_PLAY_ANIM(0, &cLocal_240, "Aknowledge_R", 8f, -4f, 4294967295, 16785456, 0, 0, 0, 0);
				}
				else
				{
					BRAIN::TASK_PLAY_ANIM(0, &cLocal_240, "Aknowledge_L", 8f, -4f, 4294967295, 16785456, 0, 0, 0, 0);
				}
				BRAIN::TASK_VEHICLE_MISSION(0, Global_19A8D, Global_19A8D, 22, 12f, 262275, 3f, 3f, 1);
				BRAIN::TASK_VEHICLE_MISSION(0, Global_19A8D, Global_19A8D, 5, 12f, 262275, 3f, 3f, 1);
				CUTSCENE::_0x8D9DF6ECA8768583(iVar2);
				BRAIN::TASK_PERFORM_SEQUENCE(Global_19A8E, iVar2);
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_240))
				{
					if (((!ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "HAIL_TAXI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "FP_HAIL_TAXI", 3)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "FUCK_U", 3)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "FORGET_IT", 3))
					{
						...
						if (func_60(iLocal_65, 1))
						{
							...
							BRAIN::TASK_LOOK_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_245, 5000, 0, 2);
							func_59();
							func_58();
							iLocal_67 = MISC::GET_GAME_TIMER();
							func_8(&iLocal_65);
							if (func_62(&iLocal_245))
							{
								if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_245, 0))
								{
							...
							{
								iVar0 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_245, 4294967295, 0);
								if (func_27(&iLocal_245, &iVar0, 0))
								{
									iLocal_245 = 0;
									BRAIN::TASK_LOOK_AT_ENTITY(AUDIO::_0x0626A247D2405330(), Global_19A8D, 5000, 0, 2);
									Global_19AB2 = MISC::GET_GAME_TIMER();
									if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(Global_19A8D, 0))
									{
										if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
										{
											CAM::SET_GAMEPLAY_VEHICLE_HINT(Global_19A8D, 0f, 0f, 0f, 1, 4000, 2000, 2000);
											iLocal_58 = 1;
										}
									}
									Global_19E56.f_2725.f_78 = 1;
...
void func_59()//Position - 0x21E8
{
	...
	if (!Global_9196)
	{
		...
		WEAPON::GET_CURRENT_PED_WEAPON(AUDIO::_0x0626A247D2405330(), &iVar5, 1);
		if (WEAPON::IS_PED_ARMED(AUDIO::_0x0626A247D2405330(), 7) || (MISC::ARE_STRINGS_EQUAL(Var3.f_2, "FP_HAIL_TAXI") && iVar5 == joaat("weapon_petrolcan")))
		{
			...
			CUTSCENE::_0x8D9DF6ECA8768583(iVar0);
			BRAIN::TASK_PERFORM_SEQUENCE(AUDIO::_0x0626A247D2405330(), iVar0);
			BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
		}
		else
		{
			BRAIN::TASK_SCRIPTED_ANIMATION(AUDIO::_0x0626A247D2405330(), &Var3, &Var2, &Var2, 0.25f, 0.25f);
		}
	}
	else
	{
		...
		func_51(AUDIO::_0x0626A247D2405330(), "TAXI_HAIL_DRUNK", 7);
		if (bVar1)
		{
			AUDIO::STOP_PED_SPEAKING(AUDIO::_0x0626A247D2405330(), true);
		}
				...
				if (BRAIN::GET_SCRIPT_TASK_STATUS(AUDIO::_0x0626A247D2405330(), 242628503) == 7)
				{
					if (((!ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "HAIL_TAXI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "FP_HAIL_TAXI", 3)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "FUCK_U", 3)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), &cLocal_240, "FORGET_IT", 3))
					{
						if (!Global_9196)
						{
							...
							func_51(AUDIO::_0x0626A247D2405330(), "TAXI_DRIVES_PAST", 24);
							if (!bVar0)
							{
								AUDIO::STOP_PED_SPEAKING(AUDIO::_0x0626A247D2405330(), false);
							}
	...
	if (func_66())
	{
		if (iLocal_54 == 0 && iLocal_55 != 4)
		{
			...
			if (func_27(&Local_56, &(Local_56.f_1), 0))
			{
				...
				if (func_38(Global_19A8D))
				{
					VEHICLE::START_VEHICLE_HORN(Global_19A8D, 2500, MISC::GET_HASH_KEY("NORMAL"), 0);
				}
				if (ENTITY::DOES_ENTITY_EXIST(Global_19A8E))
				{
					if (!PED::IS_PED_INJURED(Global_19A8E))
					{
						BRAIN::TASK_LOOK_AT_ENTITY(Global_19A8E, AUDIO::_0x0626A247D2405330(), 3000, 0, 2);
						BRAIN::TASK_LOOK_AT_ENTITY(AUDIO::_0x0626A247D2405330(), Global_19A8E, 3000, 0, 2);
					}
				}
				func_49();
				iLocal_55 = 4;
...
int func_66()//Position - 0x2872
{
	...
	vVar0 = { unk_0x8000C77B5F336760(Local_56, false) };
	if (!Local_56.f_2)
	{
		if (!Local_56.f_3)
		{
			if (func_67(vVar0, Local_56.f_E, Local_56.f_6, &(Local_56.f_11), &(Local_56.f_6)))
			{
				if (!ENTITY::IS_ENTITY_DEAD(Local_56.f_1, 0))
				{
					...
					if (Local_56.f_4)
					{
						BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(Local_56.f_1, Local_56, Local_56.f_11, 10f, 0, ENTITY::GET_ENTITY_MODEL(Local_56), Local_56.f_1D, 5f, MISC::GET_DISTANCE_BETWEEN_COORDS(vVar0, Local_56.f_11, true));
						Local_56.f_4 = 0;
					}
					else
					{
						BRAIN::TASK_VEHICLE_PARK(Local_56.f_1, Local_56, Local_56.f_11, Local_56.f_6, 3, 90f, 1);
					}
				}
				Local_56.f_2 = 1;
			}
	...
	else if (!func_18(Local_56.f_1, 4022883198))
	{
...
int func_67(vector3 vParam0, vector3 vParam1, var uParam2, var uParam3, var uParam4)//Position - 0x2A0A
{
	...
	if (PATHFIND::IS_VEHICLE_NODE_ID_VALID(iVar3))
	{
		...
		else if (PATHFIND::_0x16F46FB18C8009E4(vVar0, 4294967295, &vVar1))
		{
			*uParam3 = { vVar1 };
			*uParam4 = uParam2;
			return 1;
...
int func_74()//Position - 0x2F69
{
	...
	if (!Local_56.f_2)
	{
		...
		{
			BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(Local_56.f_1, Local_56, Local_56.f_E, 12f, 0, ENTITY::GET_ENTITY_MODEL(Local_56), Local_56.f_1D, (Local_56.f_7 - 20f), 20f);
			Local_56.f_2 = 1;
		}
	}
	else
	{
		vVar0 = { unk_0x8000C77B5F336760(Local_56, true) };
		...
		else if (!func_18(Local_56.f_1, 2477085294))
		{
			Local_56.f_2 = 0;
			Local_56.f_8 = 0;
		}
...
void func_83()//Position - 0x53F5
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_87(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_85(iVar0) && (!func_84(14) || Global_19A3D))
			{
				if (Global_19E56.f_933.f_21B.f_10CD != iVar0 && func_85(Global_19E56.f_933.f_21B.f_10CD))
				{
	...
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
		if (func_40(Local_56.f_9, 10000))
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(iLocal_70))
			{
				...
				{
					if (func_72(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false)))
					{
						if (Local_56.f_A < 2)
						{
							iVar2 = 0;
					...
					if (func_99(&vVar0, &fVar1, &(Local_56.f_8), iVar2, 1103626240))
					{
						...
						{
							Local_56.f_5 = func_76(unk_0x8000C77B5F336760(Local_56, true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true));
							Local_56.f_2 = 0;
							Local_56.f_8 = 0;
							iLocal_53 = 2;
						}
			...
			*uParam0 = VEHICLE::CREATE_VEHICLE(func_143(), vParam2, fParam3, true, true, false);
			if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
			{
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(*uParam0, 0))
				{
					...
					*uParam1 = PED::CREATE_PED_INSIDE_VEHICLE(*uParam0, 25, func_144(), 4294967295, 1, true);
					if (ENTITY::DOES_ENTITY_EXIST(*uParam1))
					{
						if (!PED::IS_PED_INJURED(*uParam1))
						{
							...
							ENTITY::SET_ENTITY_HEALTH(*uParam1, true);
...
int func_99(var uParam0, var uParam1, var uParam2, int iParam3, float fParam4)//Position - 0x689B
{
	...
	if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		vVar14 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true) };
...
int func_105()//Position - 0x78B8
{
	...
	if (func_86(AUDIO::_0x0626A247D2405330()) != Local_56.f_1E)
	{
		return 1;
	}
	if (iLocal_55 == 4)
	...
	if (iLocal_53 == 2 || iLocal_53 == 3)
	{
		...
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56, AUDIO::_0x0626A247D2405330(), 1))
		{
			return 1;
		}
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_1, AUDIO::_0x0626A247D2405330(), 1))
		{
			return 1;
		}
		vVar0 = { unk_0x8000C77B5F336760(Local_56, false) };
		...
		if (func_37(vLocal_243, vVar0, 20f))
		{
			if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(CAM::_0xDC9DA9E8789F5246(), Local_56) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(CAM::_0xDC9DA9E8789F5246(), Local_56))
			{
				return 1;
			}
			if (PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
...
int func_106()//Position - 0x7A46
{
	...
	if (iLocal_54 == 0)
	{
		if (func_40(iLocal_66, 500))
		{
			...
			iVar3 = PED::GET_PED_NEARBY_VEHICLES(AUDIO::_0x0626A247D2405330(), &uVar13);
			if (iVar3 > 0)
			{
				iVar4 = 0;
				while (iVar4 <= (iVar3 - 1))
				{
					if (iVar5 < iVar0)
					{
						if (ENTITY::DOES_ENTITY_EXIST(uVar13[iVar4]))
						{
							...
							{
								vVar9 = { unk_0x8000C77B5F336760(uVar13[iVar4], false) };
								...
								if (fVar10 <= (fVar8 * fVar8))
								{
									if (func_21(&(uVar13[iVar4]), iLocal_70, iLocal_69))
									{
										...
										if (iLocal_60)
										{
											if (uVar13[iVar4] != Global_19A8D)
											{
												if (INTERIOR::GET_INTERIOR_FROM_ENTITY(uVar13[iVar4]) == INTERIOR::GET_INTERIOR_FROM_ENTITY(AUDIO::_0x0626A247D2405330()))
												{
													fVar6 = 1f;
													...
													if (fVar10 < 4f)
													{
														vVar11 = { ENTITY::GET_ENTITY_FORWARD_VECTOR(AUDIO::_0x0626A247D2405330()) };
...
void func_110()//Position - 0x7DAD
{
	if (iLocal_52 == 0)
	{
		if (func_140(131))
		{
			...
			{
				func_138();
				func_137(&uLocal_71, 0, AUDIO::_0x0626A247D2405330(), sLocal_236, 0, 1);
	...
	else if (iLocal_52 == 2)
	{
		if (func_115())
		{
			...
			if (iLocal_52 != 0)
			{
				...
				Local_56.f_1E = func_86(AUDIO::_0x0626A247D2405330());
				Local_56.f_8 = 0;
				Local_56.f_A = 0;
				iLocal_53 = 1;
				iLocal_52 = 0;
...
int func_131()//Position - 0x882A
{
	...
	if (!ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vVar0, fVar1, fVar1, 20f, false, true, 0))
	{
		return 0;
	}
...
int func_135(vector3 vParam0, int iParam1)//Position - 0x8A3F
{
	if (iParam1 != 4294967295)
	{
		...
		{
			return func_135(vParam0, Global_8D16[iParam1 /*5*/].f_4);
		}
	}
	return 0;
}
...
int func_139(int iParam0)//Position - 0x8BBF
{
	...
	{
		if (Global_19E56.f_6D76[131 /*29*/].f_C[iParam0] == 1)
		{
			return 1;
		}
	}
	...
	{
		if ((Global_19E56.f_6D76[131 /*29*/].f_C[0] == 1 || Global_19E56.f_6D76[131 /*29*/].f_C[1] == 1) || Global_19E56.f_6D76[131 /*29*/].f_C[2] == 1)
		{
			return 1;
		}
	}
