...
void __EntryFunction__()
{
	...
	if (!func_152(uLocal_94, 8))
	{
		if (!func_150(iLocal_100))
		{
			if (func_149(0, iLocal_99))
			{
				func_161(0);
			}
			else
	...
	if (func_152(uLocal_94, 8388608))
	{
		func_161(1);
	}
	if (func_152(uLocal_94, 524288) && (func_148() && !func_147()))
	{
		func_161(1);
	}
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_152(uLocal_94, 4194304))
	{
		if (iLocal_105 != 263)
		{
			func_146(iLocal_105, 1, 0);
			iLocal_105 = 263;
		}
		func_145(10);
	}
	...
	while (true)
	{
		...
		if (DOES_ENTITY_EXIST(uLocal_85) && !IS_ENTITY_DEAD(uLocal_85, 0))
		{
			...
			{
				case 0:
					if (func_150(iLocal_100) || (func_152(uLocal_94, 16) && !func_152(uLocal_94, 524288)))
					{
						iLocal_98 = -1;
						func_138();
						func_145(1);
				...
				case 3:
					...
					if (!func_152(uLocal_94, 4))
					{
						func_134();
						func_133(&uLocal_94, 4);
					}
					if (fLocal_110 > (fLocal_102 * fLocal_102) && !Global_93716)
					{
						if (iLocal_105 != 263)
						{
							if (func_132(6) && !func_131(iLocal_105))
							{
							}
							else
							{
					...
					{
						Local_69 = { Local_53 };
						bVar2 = !func_152(uLocal_94, 64);
						func_159(&uLocal_94, 128);
						if (!func_130(3) && !Global_93716)
						{
							if (func_152(uLocal_94, 2097152))
							{
								if ((!func_152(uLocal_94, 1) || !DOES_ENTITY_EXIST(func_129())) && !Global_93716)
								{
									func_145(10);
									break;
								}
						...
						if (bVar2)
						{
							...
							{
								iVar3 = GET_VEHICLE_PED_IS_USING(PLAYER_PED_ID());
								if (bVar2)
								{
									if (iLocal_86 == iVar3)
									{
							...
							if (bVar2)
							{
								...
								if (func_109(iLocal_86))
								{
									if (iLocal_96 == -1)
									{
										func_108(&iLocal_96, 4, sLocal_101, 0, 0, 0, 0);
										func_117(&uLocal_94, 2048);
									}
									else if (!func_152(uLocal_94, 2048) || !IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_107(&iLocal_96);
										func_159(&uLocal_94, 2048);
									}
									if (func_105(iLocal_96, 1))
									{
				...
				case 6:
					...
					if (func_152(uLocal_94, 2097152))
					{
						if (!func_130(3) && !IS_THREAD_ACTIVE(uLocal_52))
						{
							func_145(10);
						}
					}
					...
					{
						PLAYSTATS_ODDJOB_DONE(ROUND((func_10(&uLocal_107) * 1000f)), iLocal_99, 0);
						func_9(&uLocal_107);
						func_159(&uLocal_94, 256);
						func_8();
						if (bVar0)
						{
							func_159(&uLocal_94, 2);
						}
						else if (func_152(uLocal_94, 2))
						{
						...
						if (iLocal_99 != -1)
						{
							if (func_152(Global_105216, 0))
							{
								PLAYSTATS_MISSION_CHECKPOINT(func_20(iLocal_99), 0, Global_93719, 0);
								func_6(func_20(iLocal_99), 0, Global_93719, 1, 0);
							}
							else
							{
								PLAYSTATS_MISSION_CHECKPOINT(func_20(iLocal_99), 0, Global_93719, 0);
								func_6(func_20(iLocal_99), 0, Global_93719, 0, 0);
							}
						}
						func_5();
						func_159(&Global_105216, 0);
						if (func_152(uLocal_94, 16777216))
						{
							func_161(1);
						}
						if (iLocal_99 != -1)
					...
					if ((iLocal_104 % 150) == 0)
					{
						if (!IS_PED_INJURED(PLAYER_PED_ID()))
						{
							if (iLocal_106 == 2)
							{
								if (iLocal_106 == 2)
								{
									if (func_150(iLocal_100) && func_149(0, iLocal_99))
									{
										func_153();
										if (iLocal_105 != 263)
										{
...
void func_16(var uParam0, var uParam1)
{
	...
	if (DOES_CAM_EXIST(*uParam0) && IS_CAM_ACTIVE(*uParam0))
	{
		vVar6 = { GET_CAM_COORD(*uParam0) };
		vVar0 = { GET_CAM_ROT(*uParam0, 2) };
		if (IS_VEHICLE_DRIVEABLE(uParam1, 0))
		{
			vVar3 = { GET_ENTITY_COORDS(uParam1, 1) };
		}
		fVar9 = ATAN2((vVar3.z - vVar6.z), GET_DISTANCE_BETWEEN_COORDS(vVar3, vVar6, 0));
		if (fVar9 > vVar0.x)
		{
			vVar0.x = func_17(vVar0.x, fVar9, 0.07f);
		}
		SET_CAM_ROT(*uParam0, vVar0, 2);
	}
}
...
void func_26()
{
	if (DOES_ENTITY_EXIST(Local_287) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
	}
	if (IS_CAM_ACTIVE(uLocal_461))
	{
...
var func_27()
{
	...
	Global_106565.f_18961 = iLocal_121;
	switch (iLocal_121)
	{
		case 0:
		case 1:
	...
	uVar0 = START_NEW_SCRIPT_WITH_ARGS(&Local_53, &Local_287, 170, iLocal_97);
...
void func_51()
{
	...
	uVar11 = func_103(func_104(iLocal_121) == joaat("maverick"), 0.45f, 0.3f);
	iVar4 = GET_PLAYERS_LAST_VEHICLE();
	if (DOES_ENTITY_EXIST(iVar4) && iVar4 != iLocal_86)
	{
		Local_287.f_1 = iVar4;
	}
	if (!iLocal_458)
	...
	if (func_100(Local_287.f_3, Local_287, 1, 1, 1, 1, 0) || IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		func_143(0);
		iLocal_458 = 0;
		if (DOES_ENTITY_EXIST(Local_287.f_3) && !IS_PED_INJURED(Local_287.f_3))
		{
			if (IS_VEHICLE_DRIVEABLE(Local_287, 0) && IS_PED_IN_VEHICLE(Local_287.f_3, Local_287, 0))
			{
				TASK_VEHICLE_MISSION_COORS_TARGET(Local_287.f_3, Local_287, GET_ENTITY_COORDS(Local_287, 1) + Vector(100f, 100f, 100f) * GET_ENTITY_FORWARD_VECTOR(Local_287) + Vector(500f, 0f, 0f), 4, _GET_VEHICLE_MAX_SPEED(Local_287), 262144, 50f, 50f, 1);
			}
			else
			{
				TASK_SMART_FLEE_PED(Local_287.f_3, PLAYER_PED_ID(), 1000f, -1, 0, 0);
			}
			SET_PED_KEEP_TASK(Local_287.f_3, 1);
			SET_PED_CONFIG_FLAG(Local_287.f_3, 251, 0);
			SET_PED_CONFIG_FLAG(Local_287.f_3, 255, 0);
			Local_287.f_3 = 0;
		}
	...
	fVar10 = VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), func_99(iLocal_121));
	if (fVar10 < 11664f)
	{
		if (!iLocal_460)
		{
			REQUEST_MODEL(func_98(iLocal_121));
			iLocal_460 = 1;
		}
	}
	else if (fVar10 > 13924f)
	{
		if (iLocal_460)
		{
			SET_MODEL_AS_NO_LONGER_NEEDED(func_98(iLocal_121));
			iLocal_460 = 0;
		}
	}
	if (fVar10 < 10000f)
	{
		if (!DOES_ENTITY_EXIST(Local_287.f_3))
		{
			if ((HAS_MODEL_LOADED(func_98(iLocal_121)) && DOES_ENTITY_EXIST(Local_287)) && IS_VEHICLE_DRIVEABLE(Local_287, 0))
			{
				Local_287.f_3 = CREATE_PED_INSIDE_VEHICLE(Local_287, 4, func_98(iLocal_121), -1, 1, 1);
				if (!IS_PED_INJURED(Local_287.f_3))
				{
					SET_PED_HELMET(Local_287.f_3, 0);
					func_97(Local_287.f_3, iLocal_121);
					func_96();
					SET_AMBIENT_VOICE_NAME(Local_287.f_3, func_95(iLocal_121));
					func_93(&uLocal_122, 0, Local_287.f_3, func_94(iLocal_121), 1, 1);
					TASK_STAND_STILL(Local_287.f_3, -1);
					SET_PED_CONFIG_FLAG(Local_287.f_3, 251, 1);
					SET_PED_CONFIG_FLAG(Local_287.f_3, 255, 1);
				}
				SET_VEHICLE_ENGINE_ON(Local_287, 1, 1, 0);
				SET_HELI_BLADES_SPEED(Local_287, uVar11);
			}
		}
		else
		{
			SET_ENTITY_AS_MISSION_ENTITY(Local_287.f_3, 1, 0);
			if (!DOES_CAM_EXIST(uLocal_461) || !IS_CAM_RENDERING(uLocal_461))
			{
				SET_HELI_BLADES_SPEED(Local_287, uVar11);
			}
			if (!IS_BIT_SET(Local_287.f_169, 0))
			{
				if (IS_SCREEN_FADED_IN())
				{
					if (!IS_PED_INJURED(Local_287.f_3) && !IS_PED_INJURED(PLAYER_PED_ID()))
					{
						if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(Local_287.f_3, 1)) < 400f)
						{
							func_77(&uLocal_122, "OJBJAUD", func_91(iLocal_121), 8, 0, 0, 0);
							TASK_LOOK_AT_ENTITY(Local_287.f_3, PLAYER_PED_ID(), 6000, 0, 2);
							SET_BIT(&(Local_287.f_169), 0);
						}
					}
				}
			}
	...
	else if (fVar10 > 12100f)
	{
		...
		{
			uVar5 = Local_287.f_3;
			SET_PED_KEEP_TASK(uVar5, 1);
			if (!IS_ENTITY_ON_SCREEN(uVar5))
			{
				SET_ENTITY_AS_MISSION_ENTITY(uVar5, 1, 0);
				DELETE_PED(&uVar5);
			}
			else
			{
				SET_PED_AS_NO_LONGER_NEEDED(&uVar5);
			}
		}
	}
	func_16(&uLocal_461, Local_287);
	if ((IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_287, 1) && !IS_PED_JACKING(PLAYER_PED_ID())) && func_75(Local_287.f_3, Local_287))
	{
		vVar7 = { GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_287, GET_PED_BONE_COORDS(PLAYER_PED_ID(), 0, 0f, 0f, 0f)) };
		if (vVar7.x < 0f || vVar7.y < 1f)
		{
			SET_AUDIO_FLAG("DisableFlightMusic", 1);
			SET_VEH_RADIO_STATION(Local_287, "OFF");
			func_159(&uLocal_94, 64);
			bVar12 = true;
			if (iLocal_459)
			{
			...
			if (!DOES_CAM_EXIST(uLocal_461))
			{
				func_64(0, 0, 1);
				func_58(1);
				uLocal_461 = CREATE_CAMERA_WITH_PARAMS(26379945, func_57(iLocal_121), func_56(iLocal_121), func_55(iLocal_121), 0, 2);
				SET_CAM_ACTIVE(uLocal_461, 1);
				RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
				SHAKE_CAM(uLocal_461, "HAND_SHAKE", 0.07f);
			}
			if (IS_VEHICLE_DRIVEABLE(Local_287, 0))
			{
				...
				if (iVar0 != 0 && iVar0 != 1)
				{
					SET_PED_CONFIG_FLAG(Local_287.f_3, 134, 1);
					func_23(&uVar1);
					while (func_10(&uVar1) < 1f)
					{
						WAIT(0);
						if (IS_PED_INJURED(PLAYER_PED_ID()) || IS_PED_JACKING(PLAYER_PED_ID()))
						{
							func_54(iLocal_105);
							if (DOES_ENTITY_EXIST(Local_287.f_3) && !IS_PED_INJURED(Local_287.f_3))
							{
					...
					func_22(&uLocal_462);
					while (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_287, 0) && func_53(&uLocal_462) < 2f)
					{
						WAIT(0);
					}
					func_9(&uLocal_462);
					if (!IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_287, 0))
					{
						bVar12 = false;
						RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
						if (DOES_CAM_EXIST(uLocal_461))
					...
					if (!IS_ENTITY_DEAD(Local_287.f_3, 0) && !IS_ENTITY_DEAD(Local_287, 0))
					{
						OPEN_SEQUENCE_TASK(&uVar6);
						TASK_STAND_STILL(0, 500);
						TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_287, GET_ENTITY_COORDS(Local_287, 1) + Vector(100f, 100f, 100f) * GET_ENTITY_FORWARD_VECTOR(Local_287) + Vector(500f, 0f, 0f), 4, _GET_VEHICLE_MAX_SPEED(Local_287), 262144, 50f, 50f, 1);
						CLOSE_SEQUENCE_TASK(uVar6);
						TASK_PERFORM_SEQUENCE(Local_287.f_3, uVar6);
	...
	if (!bVar12)
	{
		if ((IS_VEHICLE_DRIVEABLE(Local_287, 0) && VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(Local_287, 1)) < 225f) && !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
		{
		...
		if ((!IS_PED_INJURED(Local_287.f_3) && GET_SCRIPT_TASK_STATUS(Local_287.f_3, -982327190) != 0) && GET_SCRIPT_TASK_STATUS(Local_287.f_3, -982327190) != 1)
		{
			TASK_STAND_STILL(Local_287.f_3, -1);
		}
	}
...
void func_66(bool bParam0, bool bParam1, var uParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		if (NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!IS_PED_INJURED(PLAYER_PED_ID()) && !func_71(PLAYER_ID())) && !func_68(PLAYER_ID(), 0)) && !func_67()) && !bParam4) && !bParam5)
			{
...
int func_75(int iParam0, var uParam1)
{
	...
	if (IS_PED_IN_VEHICLE(iParam0, uParam1, 0) && func_76(iParam0, uParam1) == -1)
	{
		return 1;
	}
	return 0;
...
char* func_91(int iParam0)
{
	...
	bVar0 = func_86(PLAYER_PED_ID()) == true;
	switch (iParam0)
	{
		case 0:
...
int func_100(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	var uVar0;
	vector3 vVar1;
	
	uVar0 = PLAYER_PED_ID();
	if (((!DOES_ENTITY_EXIST(uParam1) || IS_ENTITY_DEAD(uParam1, 0)) || !IS_VEHICLE_DRIVEABLE(uParam1, 0)) || IS_ENTITY_ON_FIRE(uParam1))
	{
		return 1;
	}
	if (DOES_ENTITY_EXIST(iParam0))
	{
		if (!IS_PED_INJURED(iParam0) && !IS_PED_INJURED(PLAYER_PED_ID()))
		{
			vVar1 = { GET_ENTITY_COORDS(iParam0, 1) };
			if (bParam3)
			{
				if (IS_PED_IN_COMBAT(iParam0, uVar0))
				{
					return 1;
				}
			}
			...
			if (bParam4)
			{
				...
				{
					if (IS_PED_FACING_PED(iParam0, uVar0, 90f))
					{
			...
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(GET_VEHICLE_PED_IS_IN(iParam0, 0), uVar0, 1))
				{
					return 1;
				}
			}
			if (IS_PED_ARMED(uVar0, 4))
			{
				if (IS_PED_SHOOTING(uVar0))
				{
					if (IS_ENTITY_AT_COORD(iParam0, GET_ENTITY_COORDS(uVar0, 1), 45f, 45f, 45f, 0, 1, 0))
					{
						return 1;
					}
				}
			...
			if (IS_PED_BEING_JACKED(iParam0) || !func_75(iParam0, uParam1))
			{
				return 1;
			}
...
float func_101(var uParam0, int iParam1)
{
	return func_102(GET_PLAYER_PED(GET_PLAYER_INDEX()), uParam0, iParam1);
}

var func_102(var uParam0, var uParam1, var uParam2)
{
	vector3 vVar0;
	vector3 vVar3;
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_127()) || Global_105612) || Global_25767) || func_126()) || func_112(8, -1)) || func_125()) || func_124()) || func_123()) || func_114()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_127()) || Global_25767) || func_126()) || func_112(8, -1)) || func_123()) || func_125()) || func_124()) || func_114()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_127()) || Global_105612) || Global_25767) || func_126()) || func_112(8, -1)) || func_125()) || func_124()) || func_114()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_127() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_112(8, -1)) || func_114()) || func_122()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_127()) || Global_25767) || func_126()) || func_112(8, -1)) || func_124()) || func_123()) || func_114()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_127()) || Global_105612) || Global_25767) || func_126()) || func_112(8, -1)) || func_123()) || func_122()) || func_125()) || func_124()) || func_114())
						{
							return 0;
						}
						break;
...
void func_135(vector3 vParam0, float fParam3)
{
	var uVar0;
	bool bVar1;
	
	fLocal_93 = VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vParam0);
	if (!IS_PED_INJURED(PLAYER_PED_ID()) && (fLocal_93 > 25f || IS_SCREEN_FADED_OUT()))
	{
		if (fLocal_93 < 25600f)
		{
			if (!IS_SPHERE_VISIBLE(vParam0, 6f) || IS_SCREEN_FADED_OUT())
			{
				bVar1 = true;
			}
		}
	...
	if (bVar1)
	{
		...
		CLEAR_AREA(vParam0, 4f, 1, 0, 0, 0);
		if (iLocal_121 == 0)
		{
			SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-835.7629f, -1298.777f, 0f, -815.1855f, -1283.906f, 10f, 0, 1);
		}
		if (iLocal_121 == 3)
		{
			Local_287 = CREATE_VEHICLE(joaat("frogger"), vParam0, fParam3, 1, 1, 0);
			SET_VEHICLE_COLOUR_COMBINATION(Local_287, 5);
		}
		else
		{
			Local_287 = CREATE_VEHICLE(joaat("maverick"), vParam0, fParam3, 1, 1, 0);
			SET_VEHICLE_COLOUR_COMBINATION(Local_287, 6);
		}
		iLocal_86 = Local_287;
		_SET_ENTITY_SOMETHING(iLocal_86, 1);
		if (GET_GROUND_Z_FOR_3D_COORD(vParam0, &uVar0, 0, 0))
		{
			SET_VEHICLE_ON_GROUND_PROPERLY(Local_287, 1084227584);
		}
		SET_VEHICLE_HAS_STRONG_AXLES(Local_287, 1);
		iLocal_458 = 1;
	}
	else
	{
...
void func_140()
{
	if (iLocal_121 == 3)
	{
		func_141(&uLocal_119, joaat("frogger"));
	}
	else
	{
		func_141(&uLocal_119, joaat("maverick"));
	}
}
...
void func_153()
{
	...
	if (IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
	{
		func_117(&uLocal_94, 8388608);
		return;
	}
	StringCopy(&Local_53, "bj", 64);
	iLocal_121 = func_157(vLocal_90, 1);
	func_117(&uLocal_94, 64);
	switch (iLocal_121)
	{
		case 0:
			iLocal_105 = 125;
	...
	func_117(&uLocal_94, 4194304);
	func_117(&uLocal_94, 16);
	fLocal_102 = (TO_FLOAT(func_154(iLocal_105)) + 5f);
	if (iLocal_105 != 263)
	{
		if (!func_149(0, iLocal_99))
		{
	...
	{
		func_159(&uLocal_94, 8);
	}
	if (func_132(12))
	{
		func_117(&uLocal_94, 8);
	}
	iLocal_97 = 28000;
}
