...
void __EntryFunction__()
{
	...
	{
		WAIT(0);
		if (DOES_ENTITY_EXIST(uLocal_95))
		{
			if (IS_ENTITY_DEAD(uLocal_95, 0) && !iLocal_99 == 7)
			{
		...
		switch (iLocal_99)
		{
			case 0:
				if ((IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() && !func_33()) && !func_12())
				{
					if (func_11())
					{
						uLocal_95 = CREATE_PED(26, iLocal_90, vLocal_91, uLocal_94, 1, 1);
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_95, 1);
						uLocal_96 = CREATE_OBJECT(joaat("prop_tapeplayer_01"), 704.7615f, 4179.574f, 39.7093f, 1, 1, 0);
						SET_ENTITY_HEADING(uLocal_96, (233.8288f + 180f));
						SET_PED_PROP_INDEX(uLocal_95, 0, 0, 0, 0);
						iLocal_99 = 1;
					}
				}
				else
			...
			case 1:
				iLocal_101 = CREATE_SYNCHRONIZED_SCENE(vLocal_91 + Vector(1f, 0f, 0f), 0f, 0f, uLocal_94, 2);
				TASK_SYNCHRONIZED_SCENE(uLocal_95, iLocal_101, sLocal_98, "MTN_DNC_if_you_want_to_get_to_heaven", 2f, -2f, 1, 0, 1148846080, 0);
				_SET_SYNCHRONIZED_AUDIO_EVENT_POSITION_THIS_FRAME("MNT_DNC", uLocal_95);
				iLocal_99 = 2;
				break;
			...
			case 3:
				vVar0 = { GET_ENTITY_COORDS(uLocal_95, 1) };
				SET_PED_LOD_MULTIPLIER(uLocal_95, 3f);
				if (func_10(PLAYER_PED_ID(), uLocal_95) < 10f)
				{
					SET_IK_TARGET(PLAYER_PED_ID(), 1, uLocal_95, 31086, 0f, 0f, 0f, 0, -1, -1);
					SET_IK_TARGET(uLocal_95, 1, PLAYER_PED_ID(), 31086, 0f, 0f, 0f, 0, -1, -1);
				}
				if (func_9(uLocal_95, PLAYER_PED_ID(), 1) < 25f)
				{
					if (!DOES_BLIP_EXIST(uLocal_100))
					{
						func_5(&uLocal_100, &uLocal_95, 0);
						SET_BLIP_COLOUR(uLocal_100, 3);
					}
				}
				else if (DOES_BLIP_EXIST(uLocal_100))
				{
					func_4(&uLocal_100);
				}
				...
				if (IS_PED_RAGDOLL(uLocal_95))
				{
					STOP_SYNCHRONIZED_AUDIO_EVENT(iLocal_101);
					iLocal_99 = 4;
				}
				if (((((IS_PED_INJURED(uLocal_95) || IS_BULLET_IN_AREA(vVar0, 50f, 1)) || IS_BULLET_IN_AREA(vVar0, 50f, 0)) || IS_PROJECTILE_IN_AREA(vVar0, 20f, 20f, 20f, 0)) || IS_EXPLOSION_IN_SPHERE(-1, vVar0, 50f)) || (((IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uLocal_95) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uLocal_95)) && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vVar0, 1) < 25f) && func_1(uLocal_95, PLAYER_PED_ID(), 1126825984, 0)))
				{
					STOP_SYNCHRONIZED_AUDIO_EVENT(iLocal_101);
					iLocal_99 = 4;
					iLocal_97 = 1;
			...
			case 4:
				...
				if (!IS_PED_RAGDOLL(uLocal_95))
				{
					if (iLocal_97 == 1)
					{
						TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_95, 723.1315f, 4171.957f, 39.7091f, 2f, -1, 1f, 1024, 1193033728);
					}
					else
					{
						TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_95, 723.1315f, 4171.957f, 39.7091f, 1f, -1, 1f, 1024, 1193033728);
					}
					SET_PED_KEEP_TASK(uLocal_95, 1);
					iLocal_99 = 6;
				}
				break;
			
			case 6:
				if (GET_SCRIPT_TASK_STATUS(uLocal_95, 713668775) != 1 && GET_SCRIPT_TASK_STATUS(uLocal_95, 713668775) != 0)
				{
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_95, 0);
					if (iLocal_97 == 1)
					{
						TASK_SMART_FLEE_PED(uLocal_95, PLAYER_PED_ID(), 100f, -1, 0, 0);
					}
					else
					{
						TASK_WANDER_STANDARD(uLocal_95, 1193033728, 0);
					}
					SET_PED_KEEP_TASK(uLocal_95, 1);
					iLocal_99 = 5;
				}
			...
			case 5:
				if ((IS_ENTITY_OCCLUDED(uLocal_95) && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(uLocal_95, 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 1) > 50f) && !IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
				{
					func_36(1);
				}
				break;
...
int func_1(var uParam0, var uParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_3(GET_ENTITY_COORDS(uParam1, 1) - GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		vVar3 = { func_3(GET_PED_BONE_COORDS(uParam0, 31086, 0f, 5f, 0f) - GET_PED_BONE_COORDS(uParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_7(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_8(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		SET_BLIP_SCALE(uVar0, func_8(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
{
	if (DOES_ENTITY_EXIST(uLocal_96))
	{
		DELETE_OBJECT(&uLocal_96);
	}
	if (DOES_BLIP_EXIST(uLocal_100))
	{
		func_4(&uLocal_100);
	...
	if (DOES_ENTITY_EXIST(uLocal_95))
	{
		if (bParam0)
		{
			DELETE_PED(&uLocal_95);
		}
		else
		{
			SET_PED_AS_NO_LONGER_NEEDED(&uLocal_95);
		}
	}
