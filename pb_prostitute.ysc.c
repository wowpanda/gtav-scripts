...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		if (func_538(CAM::_0xDC9DA9E8789F5246(), 1))
		{
			HUD::DISPLAY_SNIPER_SCOPE_THIS_FRAME();
		}
		if (func_537(CAM::_0xDC9DA9E8789F5246(), 1))
		{
			HUD::DISPLAY_SNIPER_SCOPE_THIS_FRAME();
		}
	}
	...
	{
		func_520();
		NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(2, 0, CAM::_0xDC9DA9E8789F5246());
		func_515(0, 4294967295, 0);
	...
	while (iLocal_60)
	{
		...
		if (func_535())
		{
			if (func_509(1024))
			{
				...
				{
					if (PED::HAS_PED_HEAD_BLEND_FINISHED(AUDIO::_0x0626A247D2405330()) && PED::_0x7350823473013C02(AUDIO::_0x0626A247D2405330()))
					{
						func_513(1024);
						PED::_0x4668D80430D6C299(AUDIO::_0x0626A247D2405330());
					}
				}
			}
...
void func_3()//Position - 0x37F
{
	...
	switch (iLocal_286)
	{
		...
		case 7:
			...
			{
				BRAIN::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_91, iLocal_92, vLocal_88, (VEHICLE::_GET_VEHICLE_MAX_SPEED(iLocal_92) * 0.65f), 0, 0, 786859, 4f, -1f);
				iLocal_286 = 8;
			}
			break;
		
		case 8:
			if (SYSTEM::VDIST2(vLocal_88, unk_0x8000C77B5F336760(iLocal_90, true)) < 25f && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_91, 2477085294) != 1)
			{
		...
		case 15:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_90) && ENTITY::DOES_ENTITY_EXIST(iLocal_92))
			{
				if (PED::IS_PED_IN_VEHICLE(iLocal_90, iLocal_92, 0))
				{
					...
					{
						if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_91, 3466132403) != 1)
						{
...
void func_4()//Position - 0x5BF
{
	switch (iLocal_293)
	{
		...
		case 1:
			if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), unk_0x8000C77B5F336760(iLocal_90, false)) < 22500f)
			{
				func_32();
			}
			func_29(iLocal_92);
...
void func_19()//Position - 0xCC5
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		...
		{
			iVar0 = func_21(AUDIO::_0x0626A247D2405330());
			if (func_20(iVar0) && (!func_536(14) || Global_19A3D))
			{
				if (Global_19E56.f_933.f_21B.f_10CD != iVar0 && func_20(Global_19E56.f_933.f_21B.f_10CD))
				{
...
int func_27(int iParam0)//Position - 0xF75
{
	if (func_28())
	{
		if (!ENTITY::WOULD_ENTITY_BE_OCCLUDED(ENTITY::GET_ENTITY_MODEL(iParam0), unk_0x8000C77B5F336760(iParam0, true), 1))
		{
			return 1;
		}
	}
...
void func_37(int iParam0, bool bParam1, bool bParam2, int iParam3, bool bParam4)//Position - 0x1117
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 1) && func_42(0, 1))
	{
		if (iLocal_48 != 4)
		{
	...
	else
	{
		...
		BRAIN::TASK_PLAY_ANIM(0, sVar2, func_38(0, bParam2, bParam1, bVar1), 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, sVar2, func_38(1, bParam2, bParam1, bVar1), 8f, -4f, 4294967295, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, sVar2, func_38(2, bParam2, bParam1, bVar1), 8f, -4f, iParam3, 1, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, sVar2, func_38(3, bParam2, bParam1, bVar1), 8f, -4f, 4294967295, 0, 0, 0, 0, 0);
		BRAIN::TASK_PLAY_ANIM(0, sVar2, func_38(4, bParam2, bParam1, bVar1), 4f, -2f, 4294967295, 0, 0, 0, 0, 0);
...
bool func_42(bool bParam0, bool bParam1)//Position - 0x196F
{
	bool bVar0;
...
bool func_43()//Position - 0x199E
{
	return iLocal_288 == 0;
}

char* func_44(int iParam0, bool bParam1, int iParam2)//Position - 0x19AB
{
	int iVar0;
...
char* func_45()//Position - 0x1A2D
{
	return "mini@prostitutes@sexnorm_veh_first_person";
}

char* func_46()//Position - 0x1A39
{
	return "mini@prostitutes@sexnorm_veh";
}

char* func_47()//Position - 0x1A45
{
	return "mini@prostitutes@sexlow_veh_first_person";
}

char* func_48()//Position - 0x1A51
{
	return "mini@prostitutes@sexlow_veh";
}

int func_49(int iParam0)//Position - 0x1A5D
{
	vector3 vVar0;
	
	if (!ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		if (PED::IS_PED_BEING_JACKED(iParam0) || !func_51(iParam0, iLocal_92, 4294967295))
		{
			vVar0 = { unk_0x8000C77B5F336760(iParam0, true) };
			PED::SET_PED_FLEE_ATTRIBUTES(iParam0, 196624, true);
			if (func_50())
			{
				BRAIN::TASK_SMART_FLEE_COORD(iParam0, vVar0, 300f, 4294967295, 1, 1);
			}
...
int func_51(int iParam0, int iParam1, int iParam2)//Position - 0x1B10
{
...
float func_52(int iParam0)//Position - 0x1B4E
{
	vector3 vVar0;
	vector3 vVar1;
	
	vVar0 = { unk_0x8000C77B5F336760(iLocal_90, true) };
	vVar1 = { vLocal_88 };
	if (iParam0 == 0)
	{
		if (vVar0.x < vVar1.x)
				...
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_90, 242628503) == 1)
				{
					if (BRAIN::GET_SEQUENCE_PROGRESS(iLocal_90) > 0)
					{
						if (PED::IS_PED_IN_VEHICLE(iLocal_90, iLocal_92, 0))
						{
							...
							CUTSCENE::_0x8D9DF6ECA8768583(iLocal_95);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_91, iLocal_95);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_95);
							vLocal_88 = { func_54(unk_0x8000C77B5F336760(iLocal_90, true)) };
...
Vector3 func_54(vector3 vParam0)//Position - 0x1CE6
{
	int iVar0;
	int iVar1;
...
Vector3 func_55(int iParam0)//Position - 0x1D2E
{
	vector3 vVar0;
			...
			if (PED::IS_PED_IN_VEHICLE(iLocal_91, iLocal_92, 0))
			{
				...
				if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_91, iLocal_90, 15f, 15f, 5f, 0, 1, 0) && fVar0 <= 1f)
				{
					...
					if (iLocal_64 >= iLocal_66)
					{
						...
						if (iLocal_66 > 2500)
						{
							NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_90);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_95);
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_95);
							BRAIN::TASK_ENTER_VEHICLE(0, iLocal_92, 4294967295, 0, 1f, 8388609, 0);
							BRAIN::TASK_STAND_STILL(0, 4294967295);
							CUTSCENE::_0x8D9DF6ECA8768583(iLocal_95);
...
int func_57()//Position - 0x22B3
{
	...
	if (!func_535())
	{
		...
		else if (func_476(iLocal_49, 4194304))
		{
			...
			{
				BRAIN::TASK_PLAY_ANIM(0, func_61(iLocal_284), func_60(7), 8f, -1.5f, 4294967295, 0, 0, 0, 0, 0);
			}
			func_58(1);
	...
	switch (iLocal_54)
	{
		...
		case 1:
			if (func_476(iLocal_73, 524288))
			{
				if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_90))
				{
					BRAIN::TASK_PLAY_ANIM(iLocal_90, func_61(iLocal_284), func_60(7), 8f, -1.5f, 4294967295, 0, 0, 0, 0, 0);
				}
				else
				{
					NETWORK::NETWORK_REQUEST_CONTROL_OF_ENTITY(iLocal_90);
		...
		case 2:
			if (func_476(iLocal_73, 524288))
			{
				if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_90))
				{
					if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_90, 2277090178) == 7)
					{
						func_58(0);
						iLocal_54 = 3;
					}
...
void func_58(bool bParam0)//Position - 0x2483
{
	vector3 vVar0;
...
char* func_59(int iParam0)//Position - 0x254A
{
	if (iParam0 == 0)
	{
...
char* func_60(int iParam0)//Position - 0x2564
{
	switch (iParam0)
	{
		case 0:
...
char* func_61(int iParam0)//Position - 0x2637
{
	char* sVar0;
...
void func_63(int iParam0)//Position - 0x26D1
{
...
int func_64(int iParam0)//Position - 0x26F5
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
int func_66(bool bParam0)//Position - 0x2821
{
	int iVar0;
	int iVar1;
	...
	if (!func_535())
	{
		if (bParam0)
		{
			AUDIO::_DYNAMIC_MIXER_RELATED_FN(iLocal_90, "PROSTITUTE_GROUP", 0f);
		...
		if (func_476(iLocal_49, 4194304))
		{
			...
			BRAIN::TASK_PLAY_ANIM(0, func_61(iLocal_284), func_60(0), 2f, -2f, 4294967295, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, func_61(iLocal_284), func_60(iVar0), 2f, -2f, 4294967295, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, func_61(iLocal_284), func_60(4), 2f, -2f, 4294967295, 1, 0, 0, 0, 0);
	...
	switch (iLocal_53)
	{
		...
		case 1:
			if (func_476(iLocal_49, 4194304))
			{
				if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_90))
				{
					BRAIN::TASK_PLAY_ANIM(iLocal_90, func_61(iLocal_284), func_60(0), 2f, -2f, 4294967295, 0, 0, 0, 0, 0);
					iLocal_53 = 2;
				}
				else
				{
		...
		case 2:
			if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_90))
			{
				...
				{
					iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(1, 4);
					BRAIN::TASK_PLAY_ANIM(iLocal_90, func_61(iLocal_284), func_60(iVar0), 2f, -2f, 4294967295, 0, 0, 0, 0, 0);
					iLocal_53 = 3;
				}
			}
			else
		...
		case 3:
			if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_90))
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_90, 2277090178) == 7)
				{
					BRAIN::TASK_PLAY_ANIM(iLocal_90, func_61(iLocal_284), func_60(4), 2f, -2f, 4294967295, 1, 0, 0, 0, 0);
					iLocal_53 = 4;
				}
			}
			else
...
bool func_68(int iParam0)//Position - 0x2AC6
{
	int iVar0;
...
int func_69(int iParam0)//Position - 0x2ADC
{
...
int func_70(int iParam0)//Position - 0x2AF3
{
	int iVar0;
	...
	if (func_18() == 0)
	{
		iVar0 = Global_19E56.f_2725.f_1[iParam0 /*11*/][0];
	}
	else if (func_18() == 1)
	{
		iVar0 = Global_19E56.f_2725.f_1[iParam0 /*11*/][1];
	}
	else if (func_18() == 2)
	{
		iVar0 = Global_19E56.f_2725.f_1[iParam0 /*11*/][2];
	}
	return iVar0;
}

int func_71(int iParam0)//Position - 0x2B5E
{
	int iVar0;
...
int func_72(int iParam0, int iParam1)//Position - 0x2BB9
{
	if (PED::IS_PED_MODEL(iParam0, Global_19E56.f_2725.f_1[iParam1 /*11*/].f_A))
	{
		return 1;
	}
	return 0;
...
int func_73(int iParam0, int iParam1)//Position - 0x2BDE
{
	int iVar0;
...
bool func_74(int iParam0, int iParam1, int iParam2)//Position - 0x2C0B
{
	int iVar0;
...
int func_75(int iParam0, int iParam1)//Position - 0x2C2C
{
	if (func_69(iParam0))
	{
		return Global_19E56.f_2725.f_1[iParam0 /*11*/].f_7[iParam1];
	}
	return 4294967295;
}

int func_76(int iParam0)//Position - 0x2C54
{
	int iVar0;
...
int func_77(int iParam0, int iParam1)//Position - 0x2C7D
{
	int iVar0;
...
bool func_78(int iParam0, int iParam1, int iParam2)//Position - 0x2CAA
{
	int iVar0;
...
int func_79(int iParam0, int iParam1)//Position - 0x2CCB
{
	if (func_69(iParam0))
	{
		return Global_19E56.f_2725.f_1[iParam0 /*11*/].f_4[iParam1];
	}
	return 4294967295;
}

int func_80(int iParam0)//Position - 0x2CF3
{
	int iVar0;
...
void func_81(char* sParam0)//Position - 0x2D1C
{
...
void func_82()//Position - 0x2D35
{
	...
	if (!PED::IS_PED_INJURED(iLocal_91))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_92, 0))
		{
			...
			{
				fVar0 = ENTITY::GET_ENTITY_SPEED(iLocal_92);
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_91, 4022883198) == 7 || fVar0 <= 1f)
				{
					...
					vVar6 = { unk_0x8000C77B5F336760(iLocal_90, true) };
					if (SYSTEM::VDIST(vVar6, vVar5) < SYSTEM::VDIST(vVar6, vVar4))
					{
						vVar4 = { vVar5 };
					}
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_95);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar4.x, vVar4.y, vVar4.z, 1f, 4294967295, 0.5f, 8192, 1193033728);
	...
	if (!PED::IS_PED_INJURED(iLocal_91))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_92, 0))
		{
			if (PED::IS_PED_IN_VEHICLE(iLocal_91, iLocal_92, 0))
			{
				...
				{
					if (func_84(unk_0x8000C77B5F336760(iLocal_91, true), 1106247680))
					{
						return;
					}
					vVar0 = { unk_0x8000C77B5F336760(iLocal_90, true) };
					if (PATHFIND::GET_CLOSEST_VEHICLE_NODE(vVar0, &vVar0, 8, 1077936128, 0))
					{
						...
						BRAIN::TASK_LOOK_AT_ENTITY(iLocal_91, iLocal_90, 4294967295, 2048, 4);
...
bool func_84(vector3 vParam0, int iParam1)//Position - 0x2F7D
{
	if (func_535())
	{
...
int func_85(int iParam0)//Position - 0x2FE3
{
	int iVar0;
	int iVar1;
...
char* func_86()//Position - 0x30F2
{
	return "clipset@veh@low@ps@female@base";
}

int func_87(int iParam0)//Position - 0x30FE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_88(int iParam0, bool bParam1)//Position - 0x3331
{
...
void func_89(int iParam0)//Position - 0x34B3
{
	iLocal_286 = iParam0;
}
...
void func_90()//Position - 0x34C0
{
	...
	iLocal_91 = 0;
	iLocal_92 = 0;
	BRAIN::TASK_PLAY_ANIM(iLocal_90, func_61(iLocal_284), func_60(4), 2f, -2f, 4294967295, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.9f), 0, 0, 0);
	func_89(0);
	iLocal_287 = 0;
	iLocal_285 = 1;
}

void func_91(var uParam0)//Position - 0x352D
{
	...
	switch (iLocal_286)
	{
		case 0:
			...
			else if (iLocal_287 != 0 && !func_456("PROS_NO_MONEY"))
			{
				...
				{
					case 0:
						func_455(&uLocal_116, 0, AUDIO::_0x0626A247D2405330(), "MICHAEL", 0, 1);
						break;
					
					case 1:
						func_455(&uLocal_116, 0, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
						break;
					
					case 2:
						func_455(&uLocal_116, 0, AUDIO::_0x0626A247D2405330(), "TREVOR", 0, 1);
						break;
				}
				iLocal_286 = 1;
			}
		...
		case 11:
			...
			if (func_535())
			{
				PED::SET_PED_RESET_FLAG(AUDIO::_0x0626A247D2405330(), 433, true);
				func_218(uParam0);
			}
			break;
...
void func_92(var uParam0)//Position - 0x381A
{
	if (!func_535())
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_94(1), 3))
		{
			return;
		}
	}
...
void func_93(int iParam0)//Position - 0x3897
{
}

var func_94(bool bParam0)//Position - 0x389F
{
	if (!func_476(iLocal_49, 32768))
	{
		if (bParam0)
...
bool func_98(bool bParam0)//Position - 0x3A7E
{
...
void func_99(bool bParam0)//Position - 0x3AA9
{
	if (!PED::IS_PED_INJURED(iLocal_90))
	{
...
void func_100(int iParam0, bool bParam1)//Position - 0x3AD3
{
	int iVar0;
	float fVar1;
	
	if (ENTITY::IS_ENTITY_PLAYING_ANIM(AUDIO::_0x0626A247D2405330(), func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_103(1), 3))
	{
		BRAIN::TASK_PLAY_ANIM(AUDIO::_0x0626A247D2405330(), func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_94(1), 4f, -8f, 4294967295, 0, 0, 0, 0, 0);
	}
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (func_535())
		...
		if (func_476(iLocal_49, 134217728))
		{
			...
			BRAIN::TASK_SMART_FLEE_PED(iParam0, AUDIO::_0x0626A247D2405330(), 300f, 4294967295, 1, 0);
		}
		else
		{
			PED::SET_PED_FLEE_ATTRIBUTES(iParam0, 196624, true);
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0))
			{
				...
				else
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, func_44(iParam0, 0, 0), func_103(0), 3))
					{
						if (iLocal_70 > 0)
						{
							BRAIN::TASK_PLAY_ANIM(0, func_44(iParam0, 0, 0), func_94(0), 4f, -4f, 4294967295, 0, 0, 0, 0, 0);
						}
						else
						{
							BRAIN::TASK_PLAY_ANIM(0, func_44(iParam0, 0, 0), func_101(0), 4f, -4f, 4294967295, 0, 0, 0, 0, 0);
						}
					}
					func_102(iParam0, 1);
				}
		...
		if (func_535())
		{
			...
			{
				if (unk_0xDD5EE7D9FC37FA16(NETWORK::NETWORK_GET_NETWORK_ID_FROM_ENTITY(iLocal_90)))
				{
...
var func_101(bool bParam0)//Position - 0x3CA1
{
	if (!func_476(iLocal_49, 32768))
	{
		if (bParam0)
...
void func_102(int iParam0, int iParam1)//Position - 0x3CE7
{
...
var func_103(bool bParam0)//Position - 0x3D19
{
	if (!func_476(iLocal_49, 32768))
	{
		if (bParam0)
...
void func_104()//Position - 0x3D5F
{
	...
	{
		AUDIO::_PLAY_AMBIENT_SPEECH1(AUDIO::_0x0626A247D2405330(), "HOOKER_STORY_REVULSION_RESP", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
	else if (((iVar0 > 333 && iVar0 <= 666) && iLocal_297 == 0) || iLocal_297 == 1)
	{
		AUDIO::_PLAY_AMBIENT_SPEECH1(AUDIO::_0x0626A247D2405330(), "HOOKER_STORY_SARCASTIC_RESP", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
	else if (iLocal_297 == 0 || iLocal_297 == 2)
	{
		AUDIO::_PLAY_AMBIENT_SPEECH1(AUDIO::_0x0626A247D2405330(), "HOOKER_STORY_SYMPATHETIC_RESP", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
	}
}

int func_105()//Position - 0x3E04
{
...
void func_107(char* sParam0)//Position - 0x3ED0
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 1, true, 4294967295);
}

void func_108(int iParam0)//Position - 0x3EE6
{
	iParam0->f_1 = 0f;
	iParam0->f_2 = 0f;
	*iParam0 = 0;
...
void func_109(int iParam0)//Position - 0x3EFC
{
	int iVar0;
...
void func_110(int iParam0)//Position - 0x3F37
{
	int iVar0;
	vector3 vVar1;
...
void func_111(int iParam0)//Position - 0x3F7F
{
	int iVar0;
...
char* func_112(int iParam0)//Position - 0x3FAD
{
	char* sVar0;
...
void func_113(var uParam0, int iParam1)//Position - 0x403D
{
...
float func_114(int iParam0)//Position - 0x405A
{
	if (func_10(iParam0))
	{
		if (func_9(iParam0))
...
void func_115(var uParam0)//Position - 0x4096
{
	bool bVar0;
	int iVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
		{
			...
			{
				if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iVar1, 4294967295, 0) != AUDIO::_0x0626A247D2405330())
				{
					bVar0 = true;
				}
...
void func_116(bool bParam0)//Position - 0x4122
{
	vector3 vVar0;
...
void func_117(var uParam0)//Position - 0x41A6
{
...
void func_118()//Position - 0x41DE
{
	...
	if (iLocal_293 != 5)
	{
		...
		{
			if (!PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_90) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(AUDIO::_0x0626A247D2405330()))
			{
				iLocal_293 = 5;
			}
			if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
...
void func_119()//Position - 0x448B
{
	...
	if (!AUDIO::IS_ANY_SPEECH_PLAYING(AUDIO::_0x0626A247D2405330()))
	{
		if (iLocal_70 == 0)
		{
			AUDIO::_PLAY_AMBIENT_SPEECH1(AUDIO::_0x0626A247D2405330(), "HOOKER_DECLINE_SERVICE", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		}
		else if (func_120(iLocal_90))
		{
			func_34(&iLocal_101);
			PLAYER::SET_PLAYER_CONTROL(CAM::_0xDC9DA9E8789F5246(), false, 768);
			func_468(&iLocal_49, 2048);
			iLocal_286 = 13;
		}
	}
...
bool func_120(int iParam0)//Position - 0x44EE
{
	int iVar0;
...
void func_121()//Position - 0x4510
{
	Global_252F9E.f_47F.f_A = 1;
}

void func_122()//Position - 0x4522
{
	if (PED::IS_PED_INJURED(iLocal_90))
	{
		return;
...
void func_124(char* sParam0)//Position - 0x457C
{
	if (AUDIO::IS_AUDIO_SCENE_ACTIVE(sParam0))
	{
...
void func_126()//Position - 0x45A7
{
	unk_0x82BD2E9769751DCD();
	CAM::_0x62ECFCFDEE7885D6();
}

void func_127()//Position - 0x45B7
{
	float fVar0;
	bool bVar1;
	bool bVar2;
	
	if (MISC::IS_STRING_NULL_OR_EMPTY(func_44(AUDIO::_0x0626A247D2405330(), 0, 0)))
	{
		return;
	}
	if (!STREAMING::HAS_ANIM_DICT_LOADED(func_44(AUDIO::_0x0626A247D2405330(), 0, 0)))
	{
		return;
	}
	if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
	...
	switch (iLocal_296)
	{
		...
		case 5:
			...
			{
				func_175(iLocal_90, 0);
				BRAIN::TASK_PLAY_ANIM(iLocal_90, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(iLocal_296, 1, bVar1, bVar2), 4f, -4f, 4294967295, 1, 0, 0, 0, 0);
				func_175(AUDIO::_0x0626A247D2405330(), 4294967295);
				BRAIN::TASK_PLAY_ANIM(AUDIO::_0x0626A247D2405330(), func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(iLocal_296, 0, bVar1, bVar2), 4f, -4f, 4294967295, 1, 0, 0, 0, 0);
				func_116(1);
				iLocal_50 = 0;
				iLocal_71 = 0;
				iLocal_59 = 0;
...
void func_128()//Position - 0x4AB1
{
	int iVar0;
	
	if (iLocal_70 == 0 && !func_535())
	{
		if (func_21(AUDIO::_0x0626A247D2405330()) == 0)
		{
			func_149();
		}
		func_144(296, 0, 0);
...
void func_129()//Position - 0x4B0A
{
	switch (func_21(AUDIO::_0x0626A247D2405330()))
	{
		case 0:
			Global_19E56.f_2725.f_5A[0]++;
			func_130(0, 1, 1);
			break;
		
		case 1:
			Global_19E56.f_2725.f_5A[1]++;
			func_130(1, 1, 1);
			break;
		
		case 2:
			Global_19E56.f_2725.f_5A[2]++;
			func_130(2, 1, 1);
			break;
...
void func_130(int iParam0, int iParam1, int iParam2)//Position - 0x4BAD
{
	int iVar0;
	int iVar1;
	...
	switch (iParam0)
	{
		...
		case 3:
			...
			if (iVar1 != 9954)
			{
				iVar0 = func_134(iVar1, 4294967295, 0);
				iVar0 = (iVar0 + iParam2);
				if (iVar0 > 100)
				{
					iVar0 = 100;
				}
				func_131(iVar1, iVar0, 4294967295, 1, 0);
			}
			break;
	}
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x4C9D
{
	int iVar0;
	...
	iVar0 = Global_26B05F[iParam0 /*3*/][func_132(iParam2)];
	if (iVar0 != 0)
	{
...
int func_132(var uParam0)//Position - 0x4CCD
{
	int iVar0;
	int iVar1;
...
int func_133()//Position - 0x4D01
{
	return Global_1407E0;
}

int func_134(int iParam0, int iParam1, int iParam2)//Position - 0x4D0D
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Global_26B05F[iParam0 /*3*/][func_132(iParam1)];
...
void func_135(int iParam0)//Position - 0x4D3F
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Global_19E56.f_2725.f_1[iVar0 /*11*/].f_A = ENTITY::GET_ENTITY_MODEL(iParam0);
	iVar2 = 0;
	while (iVar2 < 2)
	{
		iVar1 = iVar2;
...
void func_136(int iParam0, int iParam1, var uParam2)//Position - 0x4DDE
{
	if (iParam0 > 4294967295)
	{
		Global_19E56.f_2725.f_1[iParam0 /*11*/].f_7[iParam1] = uParam2;
	}
}

int func_137(int iParam0, int iParam1)//Position - 0x4E01
{
	return PED::GET_PED_TEXTURE_VARIATION(iParam0, func_76(iParam1));
}

void func_138(int iParam0, int iParam1, var uParam2)//Position - 0x4E15
{
	if (iParam0 > 4294967295)
	{
		Global_19E56.f_2725.f_1[iParam0 /*11*/].f_4[iParam1] = uParam2;
	}
}

int func_139(int iParam0, int iParam1)//Position - 0x4E38
{
	return PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_80(iParam1));
}

var func_140(int iParam0)//Position - 0x4E4C
{
	return func_141(iParam0);
}

char* func_141(int iParam0)//Position - 0x4E5A
{
	char* sVar0;
...
void func_143(int iParam0)//Position - 0x4F14
{
	if (iParam0 > 4294967295)
	{
		if (func_18() == 0)
		{
			Global_19E56.f_2725.f_1[iParam0 /*11*/][0]++;
		}
		else if (func_18() == 1)
		{
			Global_19E56.f_2725.f_1[iParam0 /*11*/][1]++;
		}
		else if (func_18() == 2)
		{
			Global_19E56.f_2725.f_1[iParam0 /*11*/][2]++;
		}
	}
}

void func_144(int iParam0, int iParam1, int iParam2)//Position - 0x4FA6
{
	bool bVar0;
	...
	{
		func_148((891 + iParam0), 1, 4294967295, 1);
	}
	bVar0 = true;
...
void func_145()//Position - 0x508E
{
	...
	{
		func_147(13, SYSTEM::FLOOR(Global_19E56.f_27B6.f_F0D));
	}
...
int func_146()//Position - 0x554F
{
	return Global_6373;
}

int func_147(int iParam0, int iParam1)//Position - 0x555A
{
	int iVar0;
...
int func_148(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x55AB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_150(bool bParam0, bool bParam1)//Position - 0x5B54
{
	int iVar0;
	...
	func_151(iLocal_90, iLocal_79, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(4, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_151(AUDIO::_0x0626A247D2405330(), iLocal_80, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(4, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}

void func_151(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x5BCD
{
	if (func_535())
	{
...
void func_152(bool bParam0, bool bParam1)//Position - 0x5BFD
{
	int iVar0;
	...
	func_153(iLocal_90, iLocal_79, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(4, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
	func_154(&iLocal_80, 0, 0, 0);
	func_153(AUDIO::_0x0626A247D2405330(), iLocal_80, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(4, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}

void func_153(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, float fParam5, int iParam6, int iParam7, int iParam8)//Position - 0x5C86
{
	if (func_535())
	{
...
void func_154(int iParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x5CAC
{
	vector3 vVar0;
...
void func_155(int iParam0, vector3 vParam1, vector3 vParam2, int iParam3)//Position - 0x5D12
{
	if (!func_535())
	{
...
void func_156(int iParam0, int iParam1, int iParam2)//Position - 0x5D32
{
...
int func_157(vector3 vParam0, vector3 vParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x5D65
{
	int iVar0;
...
void func_158(bool bParam0, bool bParam1)//Position - 0x5DC0
{
	int iVar0;
	...
	func_151(iLocal_90, iLocal_78, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(3, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_151(AUDIO::_0x0626A247D2405330(), iLocal_78, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(3, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}

void func_159(bool bParam0, bool bParam1)//Position - 0x5E39
{
	int iVar0;
	...
	func_153(iLocal_90, iLocal_78, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(3, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
	func_153(AUDIO::_0x0626A247D2405330(), iLocal_78, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(3, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}

int func_160(bool bParam0, int iParam1, int iParam2)//Position - 0x5EB9
{
	if (bParam0)
	{
		return iParam1;
...
int func_162()//Position - 0x5F08
{
	if (func_535())
	{
		return func_134(65, 4294967295, 0);
	}
	return func_163(func_21(AUDIO::_0x0626A247D2405330()), 1);
}

var func_163(int iParam0, int iParam1)//Position - 0x5F32
{
	var uVar0;
	int iVar1;
...
var func_164(int iParam0, int iParam1)//Position - 0x5F50
{
	var uVar0;
	var uVar1;
...
void func_165(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x5F66
{
	switch (iParam0)
	{
		case 0:
...
void func_167(bool bParam0, bool bParam1)//Position - 0x6207
{
	int iVar0;
	...
	func_151(iLocal_90, iLocal_77, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(2, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_151(AUDIO::_0x0626A247D2405330(), iLocal_77, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(2, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}

void func_168(bool bParam0, bool bParam1)//Position - 0x6280
{
	int iVar0;
	...
	func_153(iLocal_90, iLocal_77, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(2, 1, bParam0, bParam1), 1000f, -1000f, iVar0, 0, 1148846080);
	func_153(AUDIO::_0x0626A247D2405330(), iLocal_77, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(2, 0, bParam0, bParam1), 1000f, -1000f, iVar0, 0, 1148846080);
}

void func_169(bool bParam0, bool bParam1)//Position - 0x6300
{
	int iVar0;
	...
	func_151(iLocal_90, iLocal_76, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(1, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
	func_151(AUDIO::_0x0626A247D2405330(), iLocal_76, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(1, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}

void func_170(bool bParam0, bool bParam1)//Position - 0x6379
{
	int iVar0;
	...
	func_153(iLocal_90, iLocal_76, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(1, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
	func_153(AUDIO::_0x0626A247D2405330(), iLocal_76, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(1, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}

float func_171(int iParam0)//Position - 0x63F9
{
	float fVar0;
...
void func_172(int iParam0)//Position - 0x6421
{
	if (!func_211(iParam0))
	{
		return;
...
void func_173(bool bParam0, bool bParam1)//Position - 0x6436
{
	int iVar0;
	...
	func_151(iLocal_90, iLocal_74, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(0, 1, bParam0, bParam1), 8f, -0.7f, iVar0, 0, 1000f, 0);
	func_151(AUDIO::_0x0626A247D2405330(), iLocal_75, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(0, 0, bParam0, bParam1), 8f, -0.7f, iVar0, 0, 1000f, 0);
}

void func_174(bool bParam0, bool bParam1)//Position - 0x64AF
{
	int iVar0;
	...
	func_153(iLocal_90, iLocal_74, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(0, 1, bParam0, bParam1), 4f, -1000f, iVar0, 0, 1148846080);
	func_154(&iLocal_75, 0, 0, 1);
	func_153(AUDIO::_0x0626A247D2405330(), iLocal_75, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_38(0, 0, bParam0, bParam1), 4f, -1000f, iVar0, 0, 1148846080);
}

void func_175(int iParam0, int iParam1)//Position - 0x6530
{
	if (!PED::IS_PED_IN_VEHICLE(iParam0, iLocal_93, 0))
	{
		...
		{
			BRAIN::TASK_ENTER_VEHICLE(iParam0, iLocal_93, 4294967295, iParam1, 2f, 16, 0);
		}
	}
}

void func_176(int iParam0)//Position - 0x6576
{
	var uVar0;
	var uVar1;
	vector3 vVar2;
...
void func_177(var uParam0, vector3 vParam1, vector3 vParam2, float fParam3)//Position - 0x66E1
{
	uParam0->f_1 = { vParam2 };
...
float func_178(struct<2> Param0, var uParam1, struct<2> Param2, float fParam3)//Position - 0x6733
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param2 - Param0), (Param2.f_1 - Param0.f_1));
}

Vector3 func_179(int iParam0)//Position - 0x674D
{
	vector3 vVar0;
	var uVar1;
	struct<2> Var2;
...
Vector3 func_180()//Position - 0x6826
{
	vector3 vVar0;
	vector3 vVar1;
	struct<2> Var2;
...
void func_181(int iParam0, bool bParam1)//Position - 0x688A
{
	if (bParam1)
	{
...
void func_182(int iParam0)//Position - 0x68AC
{
	...
	else
	{
		...
		if ((NETWORK::_0x5C497525F803486B(2, 0) && !HUD::IS_PAUSE_MENU_ACTIVE()) && !func_42(0, 1))
		{
			func_183(iParam0);
			CAM::SET_CAM_ACTIVE(Local_300[*iParam0 /*7*/], true);
		}
...
void func_183(var uParam0)//Position - 0x6977
{
	if (*uParam0 < 3)
	{
		*uParam0++;
...
void func_185(var uParam0)//Position - 0x6A1C
{
	var uVar0[4];
	vector3 vVar1;
	float fVar2;
...
float func_186(float fParam0, float fParam1, float fParam2)//Position - 0x6BB6
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_187(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x6BDD
{
		...
		if (func_192(iLocal_90))
		{
			if (!func_476(iLocal_49, 256))
			{
				...
				if (iLocal_70 == 1)
				{
					if (!func_535())
					{
						PLAYER::SPECIAL_ABILITY_CHARGE_ABSOLUTE(CAM::_0xDC9DA9E8789F5246(), 15, 1);
					}
				...
				else if (iLocal_70 == 2)
				{
					if (!func_535())
					{
						PLAYER::SPECIAL_ABILITY_CHARGE_ABSOLUTE(CAM::_0xDC9DA9E8789F5246(), 10, 1);
					}
				...
				else
				{
					if (!func_535())
					{
						PLAYER::SPECIAL_ABILITY_CHARGE_ABSOLUTE(CAM::_0xDC9DA9E8789F5246(), 5, 1);
					}
...
void func_189(int iParam0)//Position - 0x7003
{
...
void func_190()//Position - 0x701F
{
	int iVar0;
	
	iVar0 = ENTITY::GET_ENTITY_HEALTH(AUDIO::_0x0626A247D2405330());
	iVar0 = (iVar0 + (1 + iLocal_288));
	if (iVar0 > ENTITY::GET_ENTITY_MAX_HEALTH(AUDIO::_0x0626A247D2405330()))
	{
		iVar0 = ENTITY::GET_ENTITY_MAX_HEALTH(AUDIO::_0x0626A247D2405330());
	}
	unk_0x65E471E4A2D56226(AUDIO::_0x0626A247D2405330(), iVar0, 0);
	func_191();
}

void func_191()//Position - 0x7061
{
	if (!func_535())
	{
		return;
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		iLocal_57 = ENTITY::GET_ENTITY_HEALTH(AUDIO::_0x0626A247D2405330());
	}
}

bool func_192(int iParam0)//Position - 0x7089
{
...
bool func_193()//Position - 0x70E7
{
	return ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_90, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_194(iLocal_90, func_43(), 1), 3);
}

char* func_194(int iParam0, bool bParam1, bool bParam2)//Position - 0x710B
{
	char* sVar0;
	int iVar1;
...
void func_195()//Position - 0x71B5
{
	...
	if (AUDIO::IS_ANY_SPEECH_PLAYING(iLocal_90) || AUDIO::IS_ANY_SPEECH_PLAYING(AUDIO::_0x0626A247D2405330()))
	{
		return;
	}
	...
	if (!AUDIO::IS_ANY_SPEECH_PLAYING(iLocal_90) && !AUDIO::IS_ANY_SPEECH_PLAYING(AUDIO::_0x0626A247D2405330()))
	{
		...
		else if (func_7(&iLocal_101) > MISC::GET_RANDOM_FLOAT_IN_RANGE(2f, 5f))
		{
			if (!func_476(iLocal_49, 65536))
			{
				...
				AUDIO::_PLAY_AMBIENT_SPEECH1(AUDIO::_0x0626A247D2405330(), "SEX_GENERIC", "SPEECH_PARAMS_FORCE_NORMAL_CLEAR", 1);
				func_197(iLocal_289);
			}
			else
			{
...
void func_197(int iParam0)//Position - 0x72A0
{
	switch (iParam0)
	{
		case 0:
			func_81("PROSTITUTES_BJ_SPEECH_SCENE");
			if (func_198(CAM::_0xDC9DA9E8789F5246()))
			{
...
int func_198(int iParam0)//Position - 0x7327
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return 1;
...
int func_200(float fParam0)//Position - 0x73E0
{
	float fVar0;
	
	if (func_201(CAM::_0xDC9DA9E8789F5246(), 1, 1))
	{
		fVar0 = NETWORK::NETWORK_GET_PLAYER_LOUDNESS(CAM::_0xDC9DA9E8789F5246());
		if (fVar0 > fParam0)
		{
			return 1;
		}
...
int func_201(int iParam0, bool bParam1, bool bParam2)//Position - 0x740C
{
	int iVar0;
...
void func_202(bool bParam0, bool bParam1)//Position - 0x7456
{
	if (!func_535())
	{
		return;
...
void func_203(int iParam0, int iParam1)//Position - 0x7491
{
	int iVar0;
...
void func_204(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x74D2
{
	int iVar0;
	...
	{
		case 787:
			Global_150A45[func_132(iParam2)] = iParam1;
			break;
		
		case 788:
			Global_150A4B[func_132(iParam2)] = iParam1;
			break;
		
		case 789:
			Global_150A51[func_132(iParam2)] = iParam1;
			break;
		
		case 790:
			Global_150A57[func_132(iParam2)] = iParam1;
			break;
		
		case 777:
			Global_150A2D[func_132(iParam2)] = iParam1;
			break;
		
		case 778:
			Global_150A33[func_132(iParam2)] = iParam1;
			break;
		
		case 779:
			Global_150A39[func_132(iParam2)] = iParam1;
			break;
		
		case 780:
			Global_150A3F[func_132(iParam2)] = iParam1;
			break;
		
		case 767:
			Global_150A15[func_132(iParam2)] = iParam1;
			break;
		
		case 768:
			Global_150A1B[func_132(iParam2)] = iParam1;
			break;
		
		case 769:
			Global_150A21[func_132(iParam2)] = iParam1;
			break;
		
		case 770:
			Global_150A27[func_132(iParam2)] = iParam1;
			break;
		
		case 757:
			Global_150A5D[func_132(iParam2)] = iParam1;
			break;
		
		case 758:
			Global_150A63[func_132(iParam2)] = iParam1;
			break;
		
		case 759:
			Global_150A69[func_132(iParam2)] = iParam1;
			break;
		
		case 760:
			Global_150A6F[func_132(iParam2)] = iParam1;
			break;
		
		case 1303:
			Global_150A75[func_132(iParam2)] = iParam1;
			break;
		
		case 7233:
			Global_150A7B[func_132(iParam2)] = iParam1;
			break;
		
		case 639:
			Global_150A81[func_132(iParam2)] = iParam1;
			break;
		
		case 1278:
			Global_150A87[func_132(iParam2)] = iParam1;
			break;
		
		case 1876:
			Global_272FA8[0 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 2267:
			Global_272FA8[1 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 2929:
			Global_272FA8[2 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3058:
			Global_272FA8[3 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 8527:
			Global_273025[func_132(iParam2)] = iParam1;
			break;
		
		case 764:
			Global_150A8D[func_132(iParam2)] = iParam1;
			break;
		
		case 765:
			Global_150A93[func_132(iParam2)] = iParam1;
			break;
		
		case 766:
			Global_150A99[func_132(iParam2)] = iParam1;
			break;
		
		case 1236:
			Global_150A9F[func_132(iParam2)] = iParam1;
			break;
		
		case 3053:
			Global_272FE5[0 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3054:
			Global_272FE5[1 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3055:
			Global_272FE5[2 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3056:
			Global_272FE5[3 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3057:
			Global_272FE5[4 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3636:
			Global_273028[0 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3637:
			Global_273028[1 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3638:
			Global_273028[2 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3639:
			Global_273028[3 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3640:
			Global_273028[4 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3641:
			Global_273038[0 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3642:
			Global_273038[1 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3643:
			Global_273038[2 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3644:
			Global_273038[3 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3645:
			Global_273038[4 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3221:
			Global_272FE5[5 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3227:
			Global_272FA8[4 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3663:
			Global_273048[func_132(iParam2)] = iParam1;
			break;
		
		case 3664:
			Global_273051[func_132(iParam2)] = iParam1;
			break;
		
		case 3665:
			Global_27304B[func_132(iParam2)] = iParam1;
			break;
		
		case 3666:
			Global_273054[func_132(iParam2)] = iParam1;
			break;
		
		case 3667:
			Global_27304E[func_132(iParam2)] = iParam1;
			break;
		
		case 3668:
			Global_273057[func_132(iParam2)] = iParam1;
			break;
		
		case 3689:
			Global_27305A[func_132(iParam2)] = iParam1;
			break;
		
		case 3229:
			Global_272FE5[6 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3230:
			Global_272FA8[5 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3234:
			Global_272FE5[7 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 3232:
			Global_272FA8[6 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 4019:
			Global_272FE5[8 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 4020:
			Global_272FA8[7 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 4022:
			Global_272FE5[9 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 4023:
			Global_272FA8[8 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 4025:
			Global_272FE5[10 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 4026:
			Global_272FA8[9 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 4028:
			Global_272FE5[11 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 4029:
			Global_272FA8[10 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 6109:
			Global_272FE5[12 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 6110:
			Global_272FA8[11 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 6167:
			Global_272FE5[13 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 6168:
			Global_272FA8[12 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 6545:
			Global_272FE5[14 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 6546:
			Global_272FA8[13 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 6558:
			Global_272FE5[15 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 6559:
			Global_272FA8[14 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 6561:
			Global_272FE5[16 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 6562:
			Global_272FA8[15 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 6564:
			Global_272FE5[17 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 6565:
			Global_272FA8[16 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 7283:
			Global_272FA8[17 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 7285:
			Global_272FA8[18 /*3*/][func_132(iParam2)] = iParam1;
			break;
		
		case 7287:
			Global_272FA8[19 /*3*/][func_132(iParam2)] = iParam1;
			break;
...
int func_205(int iParam0)//Position - 0x7CDD
{
	if (Global_150A02)
	{
		switch (iParam0)
...
void func_206(int iParam0)//Position - 0x7EE7
{
	if (func_210())
	{
		return;
...
void func_207(int iParam0)//Position - 0x7F1A
{
	if (func_210())
	{
		return;
...
void func_208(bool bParam0, bool bParam1)//Position - 0x7F94
{
	if (bParam0)
	{
		if (func_209(0))
...
int func_209(int iParam0)//Position - 0x800B
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
bool func_210()//Position - 0x8065
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_199D01, 19);
}

bool func_211(int iParam0)//Position - 0x8077
{
	bool bVar0;
...
void func_212()//Position - 0x809F
{
	if (CAM::IS_SCREEN_FADED_OUT())
	{
		CAM::DO_SCREEN_FADE_IN(1000);
		ENTITY::SET_ENTITY_COORDS(AUDIO::_0x0626A247D2405330(), func_214(), 1, false, 0, 1);
		ENTITY::SET_ENTITY_HEADING(AUDIO::_0x0626A247D2405330(), func_213());
		func_526();
		CAM::RENDER_SCRIPT_CAMS(false, false, 3000, 1, 0, 0);
		PED::DELETE_PED(&iLocal_90);
	}
...
float func_213()//Position - 0x80E7
{
	switch (func_18())
	{
		case 0:
...
Vector3 func_214()//Position - 0x812C
{
	switch (func_18())
	{
		case 0:
...
float func_216()//Position - 0x81ED
{
	switch (func_18())
	{
		case 0:
...
int func_217(int iParam0, float fParam1)//Position - 0x8232
{
	if (func_10(iParam0))
	{
...
void func_218(var uParam0)//Position - 0x8254
{
	int iVar0;
	int iVar1;
...
void func_219(int iParam0, var uParam1)//Position - 0x8293
{
	var uVar0;
...
void func_220(var uParam0, var uParam1)//Position - 0x82B1
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_A_VEHICLE(*uParam0))
		{
			if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
			{
				if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
				{
					if (PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0) == ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(*uParam0))
					{
						func_116(0);
						NETWORK::_0x5E3AA4CA2B6FB0EE(AUDIO::_0x0626A247D2405330());
						func_526();
...
void func_221(var uParam0)//Position - 0x830F
{
	int iVar0;
...
void func_222(var uParam0)//Position - 0x835E
{
	int iVar0;
...
void func_223(var uParam0)//Position - 0x83B1
{
	int iVar0;
	vector3 vVar1;
...
void func_224()//Position - 0x8422
{
	...
	func_206(0);
	if ((!VEHICLE::IS_VEHICLE_STOPPED(iLocal_93) && PLAYER::IS_PLAYER_CONTROL_ON(CAM::_0xDC9DA9E8789F5246())) && !func_476(iLocal_49, 1024))
	{
		iLocal_286 = 7;
		func_367(1, 4294967295);
		AUDIO::REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\HUD_321_GO", true, 4294967295);
		iLocal_292 = 0;
	...
	switch (iLocal_292)
	{
		...
		case 1:
			if (func_535())
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
				{
					...
					{
						if (NETWORK::NETWORK_GET_ENTITY_IS_NETWORKED(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
						{
							...
							{
								if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
								{
									if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
									{
										ENTITY::SET_ENTITY_AS_MISSION_ENTITY(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), false, 0);
									}
								}
								else
								{
									NETWORK::NETWORK_REQUEST_CONTROL_OF_ENTITY(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0));
									return;
								}
							}
						}
						...
						{
							NETWORK::NETWORK_REGISTER_ENTITY_AS_NETWORKED(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0));
							return;
						}
					}
				}
					...
					if (func_535())
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
						{
							if (NETWORK::NETWORK_GET_ENTITY_IS_NETWORKED(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
							{
								if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
								{
									VEHICLE::SET_VEHICLE_DOORS_LOCKED_FOR_ALL_PLAYERS(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 1);
									VEHICLE::SET_VEHICLE_DOORS_LOCKED(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 4);
									AUDIO::SET_VEHICLE_RADIO_ENABLED(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 1);
								}
							}
						}
					}
		...
		case 2:
			...
			if (func_357(AUDIO::_0x0626A247D2405330(), 1))
			{
				if (func_355(&sVar1, 0))
				{
		...
		case 3:
			...
			func_319();
			func_288(1, 4294967295, 1, 0, 1, 3212836864, 0, 0, 4294967295);
			...
			if (((PAD::IS_CONTROL_JUST_PRESSED(2, 187) || (PAD::_IS_INPUT_DISABLED(2) && PAD::IS_CONTROL_JUST_PRESSED(2, 242))) || (PAD::_IS_INPUT_DISABLED(2) && NETWORK::_0x5C497525F803486B(0, 33))) || (((MISC::IS_PC_VERSION() && !PAD::_IS_INPUT_DISABLED(2)) && iVar4 > 100) && (MISC::GET_GAME_TIMER() - iLocal_87) > 300))
			{
				unk_0x1190AB7024CBD8CB(4294967295, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
			...
			else if (((PAD::IS_CONTROL_JUST_PRESSED(2, 188) || (PAD::_IS_INPUT_DISABLED(2) && PAD::IS_CONTROL_JUST_PRESSED(2, 241))) || (PAD::_IS_INPUT_DISABLED(2) && NETWORK::_0x5C497525F803486B(0, 32))) || (((MISC::IS_PC_VERSION() && !PAD::_IS_INPUT_DISABLED(2)) && iVar4 < 4294967196) && (MISC::GET_GAME_TIMER() - iLocal_87) > 300))
			{
				unk_0x1190AB7024CBD8CB(4294967295, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
				func_477("UP pressed!");
				if (iLocal_68 > 0)
...
int func_225(int iParam0)//Position - 0x8A99
{
	if (MISC::IS_AUSSIE_VERSION())
	{
		if (iParam0 == 0)
...
void func_226(int iParam0)//Position - 0x8B04
{
	var uVar0;
	...
	{
		func_227(2935592169, iParam0, &uVar0, 0, 0, 0);
	}
}

void func_227(int iParam0, int iParam1, var uParam2, bool bParam3, bool bParam4, bool bParam5)//Position - 0x8B46
{
	int iVar0;
	...
	switch (iParam0)
	{
		...
		case 1815541181:
			if (iParam1 > 0)
			{
				func_228(uParam2, 3159588365, 537254313, 1474183246, iParam0, iParam1, iVar0, 7);
			}
			break;
		...
		case 1138089938:
		case 3733955243:
			func_228(uParam2, 3159588365, 1445302971, 1474183246, iParam0, iParam1, iVar0, 7);
			break;
	}
	switch (iParam0)
	{
...
int func_228(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x90B3
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	*uParam0 = 5;
	...
	else
	{
		...
		if (iParam7 & 4 != 0)
		{
			func_229(4294967295, iParam4, iParam6, iParam5, 4294967295);
		}
	}
	return 0;
}

void func_229(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x925E
{
	switch (iParam1)
	{
		case 1704445500:
...
void func_230(int iParam0)//Position - 0x9296
{
	bool bVar0;
	...
	if (iParam0 != 4294967295)
	{
		...
		func_231(&(Global_410C0F[iParam0 /*80*/]));
	}
}

void func_231(var uParam0)//Position - 0x92EA
{
	uParam0->f_3D = 0;
	...
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
	func_232(&(uParam0->f_D));
	func_232(&(uParam0->f_D.f_D));
...
void func_232(var uParam0)//Position - 0x93F5
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_233(int iParam0)//Position - 0x943D
{
...
void func_234(int iParam0, int iParam1)//Position - 0x9467
{
	Global_258B69 = iParam1;
	Global_258B68 = iParam0;
}

int func_235(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, int iParam10)//Position - 0x947B
{
	int iVar0;
	...
	while (iVar0 < 5)
	{
		if (Global_410C0F[iVar0 /*80*/].f_3D.f_2 == 0)
		{
			...
			{
				func_236(Global_410C0F[iVar0 /*80*/], iVar0);
			}
			return iVar0;
		}
		iVar0++;
...
void func_236(struct<62> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, int iParam19)//Position - 0x95B7
{
	vector3 vVar0;
	int iVar1;
...
void func_237()//Position - 0x9649
{
	SCRIPT::REQUEST_SCRIPT("AM_ARENA_SHP");
}

var func_238(int iParam0)//Position - 0x9659
{
	var uVar0;
...
int func_240(int iParam0, int iParam1, int iParam2)//Position - 0x9682
{
	...
	return func_241(Global_19E56.f_6D76[iParam0 /*29*/].f_11, 0, iParam1, iParam2, 0);
}

int func_241(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x96CB
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_242(bool bParam0)//Position - 0x9CCA
{
	int iVar0;
	int iVar1;
...
void func_243(int iParam0)//Position - 0x9F4C
{
	int iVar0;
...
void func_244(int iParam0)//Position - 0x9FA6
{
	bool bVar0;
	char cVar1[64];
	...
	if (iParam0 == 8)
	{
		func_148(129, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 9)
	{
		func_148(135, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 10)
	{
		func_148(136, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 11)
	{
		func_148(137, 0, 4294967295, 1);
		return;
	}
	bVar0 = false;
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_5038.f_1D7, iParam0) || INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_246() /*12745*/].f_1FF2.f_A, iParam0))
	{
		bVar0 = true;
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_19E56.f_5038.f_1D7), iParam0);
		GRAPHICS::_0x35FB78DC42B7BD21(&(Global_200000[func_246() /*12745*/].f_1FF2.f_A), iParam0);
	}
	if (bVar0)
	{
...
char* func_245(int iParam0)//Position - 0xA0B9
{
	switch (iParam0)
	{
		case 0:
...
void func_247(int iParam0)//Position - 0xA175
{
	func_267(93, iParam0);
	func_267(29, iParam0);
	func_267(30, iParam0);
...
bool func_248(int iParam0)//Position - 0xA195
{
	if (iParam0 == 8)
	{
		return func_249(129, 4294967295, 4294967295);
	}
	if (iParam0 == 9)
	{
		return func_249(135, 4294967295, 4294967295);
	}
	if (iParam0 == 10)
	{
		return func_249(136, 4294967295, 4294967295);
	}
	if (iParam0 == 11)
	{
		return func_249(137, 4294967295, 4294967295);
	}
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_19E56.f_5038.f_1D7, iParam0);
	}
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_200000[func_246() /*12745*/].f_1FF2.f_A, iParam0);
}

int func_249(int iParam0, int iParam1, int iParam2)//Position - 0xA219
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_250(int iParam0)//Position - 0xA256
{
	int iVar0;
...
int func_251(int iParam0, int iParam1)//Position - 0xA56E
{
	int iVar0;
...
int func_252(bool bParam0)//Position - 0xA866
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_253(int iParam0, int iParam1)//Position - 0xA91D
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_254(int iParam0, int iParam1)//Position - 0xA938
{
	...
	if (func_264(&Global_412216))
	{
		if (func_262(&Global_412216, iParam0))
		{
			return 0;
		}
		if (func_255(&Global_412216, iParam0))
		{
			return 1;
		}
	}
...
int func_255(var uParam0, int iParam1)//Position - 0xA9D5
{
	int iVar0;
	var uVar1[78];
...
int func_256(var uParam0, int iParam1)//Position - 0xAA86
{
	int iVar0;
...
bool func_257(var uParam0, int iParam1)//Position - 0xAB01
{
	return (*uParam0)[iParam1] == 78;
}

void func_258(var uParam0)//Position - 0xAB12
{
	int iVar0;
	...
	func_260(uParam0, (Global_412215 - 0.5f));
}

void func_259(var uParam0, int iParam1)//Position - 0xAB46
{
	(*uParam0)[iParam1] = 78;
}

void func_260(var uParam0, float fParam1)//Position - 0xAB56
{
	if (fParam1 == 0f)
	{
		uParam0->f_50 = 0f;
...
float func_261(var uParam0)//Position - 0xAB73
{
	return uParam0->f_50;
}

bool func_262(var uParam0, int iParam1)//Position - 0xAB7F
{
	return func_263(uParam0, iParam1) != 4294967295;
}

int func_263(var uParam0, int iParam1)//Position - 0xAB91
{
	int iVar0;
...
bool func_264(var uParam0)//Position - 0xABBE
{
	return uParam0->f_4F == 1;
}

int func_265(int iParam0)//Position - 0xABCC
{
	switch (iParam0)
	{
		case 60:
...
void func_266(int iParam0, int iParam1)//Position - 0xAC1C
{
	int iVar0;
...
void func_267(int iParam0, int iParam1)//Position - 0xAC3F
{
	int iVar0;
...
int func_269()//Position - 0xAD11
{
	if (func_535())
	{
		return func_271(CAM::_0xDC9DA9E8789F5246());
	}
	return func_270(func_18());
}

int func_270(int iParam0)//Position - 0xAD36
{
	var uVar0;
...
var func_271(int iParam0)//Position - 0xAD8E
{
	var uVar0;
...
int func_272(int iParam0)//Position - 0xADA0
{
	if (iParam0 > 4294967295)
	{
...
int func_273(int iParam0)//Position - 0xADE3
{
	if (iParam0 == 4294967295)
	{
		return 0;
...
void func_274(int iParam0)//Position - 0xAE08
{
...
void func_275()//Position - 0xAE25
{
	Global_434C.f_5 = 0;
}

void func_276(int iParam0, bool bParam1, int iParam2)//Position - 0xAE33
{
	int iVar0;
	int iVar1;
...
void func_277()//Position - 0xAF85
{
	...
	else
	{
		...
		if (iLocal_289 == 0)
		{
			...
			AUDIO::REQUEST_SCRIPT_AUDIO_BANK("PROSTITUTE_BLOWJOB", false, 4294967295);
			iLocal_288 = 0;
		}
...
void func_279()//Position - 0xB023
{
	iLocal_46++;
	iLocal_47 = 1;
}

void func_280()//Position - 0xB034
{
	iLocal_45++;
	iLocal_47 = 1;
}

int func_281()//Position - 0xB045
{
	if (PAD::_IS_INPUT_DISABLED(2))
	{
...
int func_282(int iParam0, int iParam1, bool bParam2)//Position - 0xB06C
{
	if (!PAD::_IS_INPUT_DISABLED(2))
	{
		return 0;
...
void func_283(bool bParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0xB14C
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (((fVar7 >= fVar0 && fVar7 <= fVar2) && fVar8 >= fVar1) && fVar8 <= fVar3)
	{
		...
		if (bParam3)
		{
			if (!bParam1 || iVar13 != 0)
			{
				GRAPHICS::SET_SCRIPT_GFX_ALIGN(76, 84);
				GRAPHICS::SET_SCRIPT_GFX_ALIGN_PARAMS(-0.05f, -0.05f, 0f, 0f);
				func_284(fVar4, (fVar5 + (IntToFloat(iVar13) * 0.034722f)), Global_43D6, (0.034722f - 0.0015f), 255, 255, 255, iVar10);
				GRAPHICS::RESET_SCRIPT_GFX_ALIGN();
			}
		}
...
void func_284(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0xB3F8
{
	GRAPHICS::DRAW_RECT((fParam0 + (fParam2 * 0.5f)), (fParam1 + (fParam3 * 0.5f)), fParam2, fParam3, iParam4, iParam5, iParam6, iParam7, 0);
}

void func_285(bool bParam0)//Position - 0xB427
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	{
		func_284(fVar0, fVar1, Global_43D6, fVar2, 255, 255, 255, iVar3);
	}
	else if (Global_411C36 == 4294967293)
	{
		func_284(fVar0, (fVar1 + fVar2), Global_43D6, fVar2, 255, 255, 255, iVar3);
	}
	GRAPHICS::RESET_SCRIPT_GFX_ALIGN();
}

void func_286()//Position - 0xB4B0
{
...
void func_287(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)//Position - 0xB4F8
{
...
void func_288(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7, int iParam8)//Position - 0xB5CD
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (iVar5 == 1 && Global_43D7.f_165E)
		{
			...
			else
			{
				if (Global_43D7)
				{
					...
					{
						func_284(Global_43D4, Global_43D5, fParam5, (fVar56 - 0f), 0, 0, 0, 255);
				...
				func_284(Global_43D4, (Global_43D5 + fVar56), fParam5, 0.034722f, iVar1, iVar2, iVar3, iVar4);
				...
				if (Global_43D7.f_1661 > Global_43D7.f_1467)
				{
					...
					{
						func_308();
						func_306((((Global_43D4 + fParam5) - 0.00390625f) - func_307("CM_ITEM_COUNT", Global_43D7.f_1664, Global_43D7.f_1663)), ((Global_43D5 + fVar56) + 0.00416664f), "CM_ITEM_COUNT", Global_43D7.f_1664, Global_43D7.f_1663);
					}
				}
			}
			...
			if (Global_43D7.f_1661 > Global_43D7.f_1467)
			{
				...
				func_284(Global_43D4, (fVar49 + 0f), fParam5, 0.034722f, iVar1, iVar2, iVar3, iVar4);
			...
			if (MISC::GET_HASH_KEY(&(Global_43D7.f_1252)) != 0 && Global_43D7.f_129C != 4294967295)
			{
				...
				{
					func_314(Global_43D7.f_129E, 1, 1, &fVar36, &fVar37, bParam7);
				...
				func_284(Global_43D4, (fVar49 - 0.00277776f), fParam5, 0.00277776f, iVar1, iVar2, iVar3, iVar4);
				...
				{
					func_314(Global_43D7.f_129E, 1, 1, &fVar36, &fVar37, bParam7);
					func_304(Global_43D7.f_129E, 1, &iVar45, &iVar46, &iVar47, &iVar48);
					GRAPHICS::DRAW_SPRITE(func_312(Global_43D7.f_129E), func_309(Global_43D7.f_129E, 1), ((Global_43D4 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
				}
			...
			if (MISC::GET_HASH_KEY(&(Global_411BEA.f_15)) != 0 && Global_411BEA.f_41 != 4294967295)
			{
				...
				{
					func_314(Global_411BEA.f_43, 1, 1, &fVar36, &fVar37, bParam7);
					fVar40 = (((Global_43D4 + fVar36) + (0.00078125f * 4f)) - (0.00078125f * 1f));
				}
				func_305(fVar40);
				...
				{
					func_314(Global_411BEA.f_43, 1, 1, &fVar36, &fVar37, bParam7);
					func_304(Global_411BEA.f_43, 1, &iVar45, &iVar46, &iVar47, &iVar48);
					GRAPHICS::DRAW_SPRITE(func_312(Global_411BEA.f_43), func_309(Global_411BEA.f_43, 1), ((Global_43D4 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
				}
				fVar49 = (fVar49 + (((HUD::_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
							...
							switch (Global_43D7.f_13BE[iVar8])
							{
									...
									if (iVar5 == 1 && bVar33)
									{
										if (!Global_43D7.f_165F)
										{
											...
											if (MISC::GET_HASH_KEY(&(Global_43D7.f_49[iVar24 /*6*/])) != 0)
											{
												...
												func_295(bVar32, Global_43D7.f_64A[iVar24], Global_43D7.f_74B[iVar24], bVar54, iVar74, bVar51, bVar50);
											...
											if (iVar28 > 0)
											{
												...
												while (iVar14 < iVar28)
												{
													if (func_314(Global_43D7.f_1151[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
													{
										...
										if (MISC::GET_HASH_KEY(&(Global_43D7.f_49[iVar24 /*6*/])) != 0)
										{
											...
											func_295(bVar32, Global_43D7.f_64A[iVar24], Global_43D7.f_74B[iVar24], bVar54, 0, bVar51, bVar50);
										...
										while (iVar14 < 4)
										{
											...
											else if (Global_43D7.f_84C[iVar24 /*5*/][iVar14] == 4)
											{
												...
												{
													if (func_314(Global_43D7.f_1151[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
													{
														fVar40 = (fVar40 + (fVar36 * 0.5f));
														if (func_314(Global_43D7.f_1151[(iVar22 + iVar28)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															func_304(Global_43D7.f_1151[(iVar22 + iVar28)], bVar32, &iVar45, &iVar46, &iVar47, &iVar48);
															if (Global_43D7.f_13D9[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_312(Global_43D7.f_1151[(iVar22 + iVar28)]), func_309(Global_43D7.f_1151[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar40) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar55 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_312(Global_43D7.f_1151[(iVar22 + iVar28)]), func_309(Global_43D7.f_1151[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar40) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar55 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
										...
										if (MISC::GET_HASH_KEY(&(Global_43D7.f_49[iVar24 /*6*/])) != 0)
										{
											...
											else
											{
												...
												if (func_293() && SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("fm_mission_creator")) > 0)
												{
													if (iVar8 == 0)
													{
														func_295(0, Global_43D7.f_64A[iVar24], Global_43D7.f_74B[iVar24], bVar54, 0, bVar51, bVar50);
										...
										if (iVar28 > 0)
										{
											...
											while (iVar14 < iVar28)
											{
												if (Global_43D7.f_1151[(iVar22 + iVar14)] != 2 && Global_43D7.f_1151[(iVar22 + iVar14)] != 48)
												{
													...
													{
														fVar40 = (fVar40 + (fVar36 * 0.5f));
														if (func_314(Global_43D7.f_1151[(iVar22 + iVar14)], bVar32, 1, &fVar36, &fVar37, bParam7))
														{
															func_304(Global_43D7.f_1151[(iVar22 + iVar14)], bVar32, &iVar45, &iVar46, &iVar47, &iVar48);
															if (Global_43D7.f_1151[(iVar22 + iVar14)] == 30)
															{
																GRAPHICS::DRAW_SPRITE(func_312(Global_43D7.f_1151[(iVar22 + iVar14)]), func_309(Global_43D7.f_1151[(iVar22 + iVar14)], bVar32), (Global_43D4 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else if (Global_43D7.f_13D9[iVar8] == 2)
															{
																GRAPHICS::DRAW_SPRITE(func_312(Global_43D7.f_1151[(iVar22 + iVar14)]), func_309(Global_43D7.f_1151[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar40) + fVar41) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar55 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
															else
															{
																GRAPHICS::DRAW_SPRITE(func_312(Global_43D7.f_1151[(iVar22 + iVar14)]), func_309(Global_43D7.f_1151[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar40) + fVar41) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar55 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0);
															}
														}
								...
								case 2:
									if (iVar5 == 1 && bVar33)
									{
										if (!Global_43D7.f_165F)
										{
											func_295(bVar32, Global_43D7.f_64A[iVar24], Global_43D7.f_74B[iVar24], bVar54, 0, 0, 0);
											if (Global_43D7.f_1F97 && Global_43D7.f_1F98 == iVar6)
											{
												func_294(bVar32);
											}
										...
										func_295(bVar32, Global_43D7.f_64A[iVar24], Global_43D7.f_74B[iVar24], bVar54, 0, 0, 0);
										func_292((fVar34 + fVar40), fVar35, "NUMBER", Global_43D7.f_F4E[iVar20], 0);
									}
									bVar39 = true;
									iVar20++;
									break;
								...
								case 3:
									if (iVar5 == 1 && bVar33)
									{
										...
										func_295(bVar32, Global_43D7.f_64A[iVar24], Global_43D7.f_74B[iVar24], bVar54, 0, 0, 0);
										func_291((fVar34 + fVar40), fVar35, "NUMBER", Global_43D7.f_104F[iVar21], Global_43D7.f_10D0[iVar21]);
									}
									bVar39 = true;
									iVar21++;
									break;
								...
								case 4:
									if (iVar5 == 1 && bVar33)
									{
										if (func_314(Global_43D7.f_1151[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
										{
											if (!Global_43D7.f_165F)
											{
												fVar42 = fVar36;
											...
											if (func_314(Global_43D7.f_1151[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												func_304(Global_43D7.f_1151[iVar22], bVar32, &iVar45, &iVar46, &iVar47, &iVar48);
												GRAPHICS::DRAW_SPRITE(func_312(Global_43D7.f_1151[iVar22]), func_309(Global_43D7.f_1151[iVar22], bVar32), ((fVar34 + fVar40) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar55 * 0.5f)), (fVar36 * func_290(Global_43D7.f_1151[iVar22])), (fVar37 * func_290(Global_43D7.f_1151[iVar22])), 0f, iVar45, iVar46, iVar47, iVar48, 0);
											}
										}
									}
									bVar39 = true;
...
void func_289(int iParam0)//Position - 0xE233
{
	Global_14E696.f_437 = iParam0;
}

float func_290(int iParam0)//Position - 0xE244
{
	switch (iParam0)
	{
		case 35:
...
void func_291(float fParam0, float fParam1, char* sParam2, float fParam3, int iParam4)//Position - 0xE2B3
{
...
void func_292(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0xE2D2
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
bool func_293()//Position - 0xE2F0
{
	return DLC::IS_DLC_PRESENT(2532323046);
}

void func_294(bool bParam0)//Position - 0xE301
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_295(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xE347
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam2)
	{
		if (bParam3)
		{
			func_296(Global_43D7.f_1776[iParam4], &iVar0, &iVar1, &iVar2);
...
void func_296(int iParam0, var uParam1, var uParam2, var uParam3)//Position - 0xE4F5
{
	switch (iParam0)
	{
		case 0:
...
void func_297(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)//Position - 0xE77F
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam7 == 0)
	{
		if (func_300(CAM::_0xDC9DA9E8789F5246(), 0))
		{
			return;
		}
	}
	...
	if (Global_43D7.f_129F != 0)
	{
		...
		if (!Global_43D7.f_12A0)
		{
			...
			if (MISC::GET_HASH_KEY(&(Global_411BEA.f_10)) != MISC::GET_HASH_KEY(""))
			{
				...
				func_299(&Global_411BEA);
				if (Global_411BEA.f_14 == 4294967295)
				{
					func_298(&(Global_411BEA.f_10));
				}
				else
				{
...
void func_298(char* sParam0)//Position - 0xEC87
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	CAM::_DISABLE_VEHICLE_FIRST_PERSON_CAM_THIS_FRAME();
}

void func_299(char* sParam0)//Position - 0xEC99
{
	GRAPHICS::_PUSH_SCALEFORM_MOVIE_METHOD_PARAMETER_BUTTON_NAME(sParam0);
}

bool func_300(int iParam0, int iParam1)//Position - 0xECA7
{
	bool bVar0;
	
	if (iParam0 == CAM::_0xDC9DA9E8789F5246())
	{
		bVar0 = func_301(4294967295, 0) == 8;
	}
	else
	{
...
int func_301(int iParam0, bool bParam1)//Position - 0xECF2
{
	int iVar0;
	int iVar1;
...
void func_304(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEDBB
{
...
void func_305(float fParam0)//Position - 0xEEAA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_306(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0xEF09
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::ADD_TEXT_COMPONENT_INTEGER(iParam3);
...
float func_307(char* sParam0, int iParam1, int iParam2)//Position - 0xEF2C
{
...
var func_309(int iParam0, bool bParam1)//Position - 0xEFF8
{
	char* sVar0[2];
	var uVar1;
	struct<13> Var2;
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_43D7.f_1ACF[iParam0 /*16*/])))
	{
		...
		{
			Var2 = { func_311(CAM::_0xDC9DA9E8789F5246()) };
		...
		{
			return func_310(&(Global_43D7.f_1ACF[iParam0 /*16*/]));
		}
	}
	switch (iParam0)
	{
...
var func_310(var uParam0)//Position - 0xF465
{
	return uParam0;
}

struct<13> func_311(int iParam0)//Position - 0xF46F
{
	struct<13> Var0;
...
char* func_312(int iParam0)//Position - 0xF486
{
	var uVar0;
	struct<13> Var1;
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_43D7.f_177E[iParam0 /*16*/])))
	{
		...
		{
			Var1 = { func_311(CAM::_0xDC9DA9E8789F5246()) };
			NETWORK::_NETWORK_GET_PLAYER_CREW_EMBLEM_TXD_NAME(&Var1, &uVar0);
			return func_310(&uVar0);
		}
		else
		{
			return func_310(&(Global_43D7.f_177E[iParam0 /*16*/]));
		}
	}
	if (iParam0 == 48)
	{
...
int func_314(int iParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)//Position - 0xF52D
{
	char cVar0[64];
	char cVar1[64];
	int iVar2;
...
float func_315(int iParam0)//Position - 0xF6DE
{
	switch (iParam0)
	{
		case 33:
...
int func_316(bool bParam0, bool bParam1)//Position - 0xF77D
{
	if (Global_252F9E.f_761.f_2B0 != 0)
	{
		return 1;
	}
	if ((((((((!CAM::IS_SCREEN_FADED_IN() || (func_24(8, 4294967295) && func_317() != 64)) || (HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1)) || (STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0)) || NETWORK::_0x2EAC52B4019E2782()) || Global_11729) || Global_43D7.f_1F9A) || HUD::IS_WARNING_MESSAGE_ACTIVE()) || Global_16C64.f_571)
	{
		return 0;
	}
	return 1;
...
int func_317()//Position - 0xF81A
{
	return Global_140818;
}

int func_318(var uParam0, bool bParam1, int iParam2)//Position - 0xF826
{
	char cVar0[64];
	int iVar1;
	int iVar2;
...
void func_319()//Position - 0xF8C3
{
	if (!func_360(iLocal_295))
	{
		iLocal_295 = func_337();
		func_328(&iLocal_295, 0, 0, MISC::GET_RANDOM_INT_IN_RANGE(1, 2), 0, 0, 0);
	}
...
bool func_320(int iParam0)//Position - 0xF93D
{
	return func_321(func_337(), iParam0);
}

int func_321(int iParam0, int iParam1)//Position - 0xF94F
{
	int iVar0;
	int iVar1;
...
int func_322(int iParam0)//Position - 0xFA5B
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_323(int iParam0)//Position - 0xFA6E
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_324(int iParam0)//Position - 0xFA81
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_325(int iParam0)//Position - 0xFA94
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_326(int iParam0)//Position - 0xFAA6
{
	return iParam0 & 15;
}

var func_327(int iParam0)//Position - 0xFAB3
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_160(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}

void func_328(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xFAD8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_329(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xFC5A
{
...
void func_330(var uParam0, int iParam1)//Position - 0xFC92
{
	if (iParam1 <= 0)
	{
		return;
...
void func_331(var uParam0, int iParam1)//Position - 0xFD18
{
	int iVar0;
	int iVar1;
...
void func_332(var uParam0, int iParam1)//Position - 0xFD69
{
...
void func_333(var uParam0, int iParam1)//Position - 0xFD9C
{
...
void func_334(var uParam0, int iParam1)//Position - 0xFDD6
{
...
void func_335(var uParam0, int iParam1)//Position - 0xFE11
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_336(int iParam0, int iParam1)//Position - 0xFE4D
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_337()//Position - 0xFEEF
{
	var uVar0;
	
	func_335(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_334(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_333(&uVar0, CLOCK::GET_CLOCK_HOURS());
...
void func_338(char* sParam0, int iParam1)//Position - 0xFF35
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

void func_339()//Position - 0xFF4C
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_351(1, 2, 1, 1, 1);
	func_350("PROS_OPTS");
	func_349(201, "PROS_SELECT", 4294967295, 0);
	iLocal_69 = 0;
	iVar0 = func_225(0);
	iVar1 = func_225(1);
	iVar2 = func_225(2);
...
void func_340()//Position - 0x1006D
{
	Global_434C.f_5 = 1;
}

int func_341(int iParam0)//Position - 0x1007B
{
	int iVar0;
...
void func_342(int iParam0, bool bParam1)//Position - 0x10169
{
	float fVar0;
	float fVar1;
	var uVar2;
...
float func_343()//Position - 0x102A4
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar0 < iVar1)
	{
		...
		{
			if (func_314(Global_43D7.f_1151[((Global_43D7.f_1466 - iVar1) + iVar0)], 1, 0, &uVar3, &fVar4, 0))
			{
				if (fVar4 > fVar2)
				{
					fVar2 = fVar4;
...
float func_344()//Position - 0x10357
{
	float fVar0;
	float fVar1;
	var uVar2;
	...
	while (iVar7 < iVar5)
	{
		...
		{
			func_314(Global_43D7.f_1151[((Global_43D7.f_1466 - iVar5) + iVar7)], 1, 0, &fVar1, &uVar2, 0);
			fVar0 = (fVar0 + fVar1);
		}
		iVar7++;
	}
...
void func_345(int iParam0, char* sParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)//Position - 0x1079E
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	if (!bParam3)
	{
		func_348(Global_43D7.f_1460, 1);
	}
	else
	{
		func_348(Global_43D7.f_1460, 0);
	}
	if (iParam2 == 0)
	{
		fVar1 = func_347(&(Global_43D7.f_49[Global_43D7.f_1462 /*6*/]));
	...
	if (bParam5)
	{
		if (iParam2 == 0)
		{
			fVar4 = func_346(&(Global_43D7.f_49[Global_43D7.f_1462 /*6*/]));
...
float func_346(char* sParam0)//Position - 0x109AA
{
...
float func_347(char* sParam0)//Position - 0x109C6
{
	if (!MISC::IS_STRING_NULL(sParam0))
	{
		if (MISC::GET_HASH_KEY(sParam0) == 0)
...
void func_348(int iParam0, bool bParam1)//Position - 0x10A03
{
	int iVar0;
...
void func_349(int iParam0, char* sParam1, int iParam2, bool bParam3)//Position - 0x10A4F
{
	char* sVar0;
...
void func_350(char* sParam0)//Position - 0x10B04
{
	int iVar0;
...
void func_351(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x10B4F
{
...
void func_352(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x10B8E
{
...
void func_353(bool bParam0, bool bParam1)//Position - 0x10C38
{
	int iVar0;
	int iVar1;
	float fVar2;
...
void func_354(bool bParam0)//Position - 0x1111B
{
	if (!bParam0)
	{
...
int func_355(char* sParam0, int iParam1)//Position - 0x11139
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_356(CAM::_0xDC9DA9E8789F5246()))
	{
...
int func_356(int iParam0)//Position - 0x11183
{
	int iVar0;
...
int func_357(int iParam0, bool bParam1)//Position - 0x111A9
{
	int iVar0;
	...
	else if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_103(bParam1), 3) && BRAIN::GET_SCRIPT_TASK_STATUS(iParam0, 2277090178) != 1)
	{
		if (func_535())
		{
			if (iParam0 == AUDIO::_0x0626A247D2405330())
			{
				if (!func_198(CAM::_0xDC9DA9E8789F5246()))
				{
					iVar0 = PED::GET_PED_DRAWABLE_VARIATION(AUDIO::_0x0626A247D2405330(), 6);
					if (!func_509(256))
					{
						func_189(256);
						iLocal_84 = iVar0;
						iLocal_85 = PED::GET_PED_TEXTURE_VARIATION(AUDIO::_0x0626A247D2405330(), 6);
						PED::SET_PED_COMPONENT_VARIATION(AUDIO::_0x0626A247D2405330(), 6, 1, 0, 0);
						func_189(1024);
					}
				}
				BRAIN::TASK_PLAY_ANIM(iParam0, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_358(bParam1), 2f, -8f, 4294967295, 0, 0, 0, 0, 0);
			}
			else
			{
				BRAIN::TASK_PLAY_ANIM(iParam0, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_358(bParam1), 2f, -8f, 4294967295, 0, 0, 0, 0, 0);
	...
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_358(bParam1), 3))
		{
			if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iParam0, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_358(bParam1)) >= 0.95f)
			{
				BRAIN::TASK_PLAY_ANIM(iParam0, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_103(bParam1), 8f, -2f, 4294967295, 1, 0, 0, 0, 0);
			}
		}
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, func_44(AUDIO::_0x0626A247D2405330(), 0, 0), func_103(bParam1), 3))
		{
			return 1;
		}
	}
...
var func_358(bool bParam0)//Position - 0x1133B
{
	if (!func_476(iLocal_49, 32768))
	{
		if (bParam0)
...
void func_359(int iParam0)//Position - 0x11381
{
	*iParam0 = 4294967281;
}

int func_360(int iParam0)//Position - 0x1138F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_361()//Position - 0x1146B
{
	if (PED::IS_PED_INJURED(iLocal_90))
	{
		return;
...
int func_362()//Position - 0x114B6
{
	if (func_363(0, 4294967295, 0) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("SCRIPT\HUD_321_GO", true, 4294967295))
	{
		return 1;
	}
	return 0;
...
bool func_363(char* sParam0, int iParam1, bool bParam2)//Position - 0x114DC
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	bVar2 = func_364(&(Global_43D7.f_161A[iVar0 /*10*/]));
	if (!bVar1 || !bVar2)
	{
	}
	return (bVar1 && bVar2);
...
bool func_364(var uParam0)//Position - 0x115D2
{
	switch (uParam0->f_9)
	{
		case 0:
...
void func_365()//Position - 0x11674
{
	if (!func_535())
	{
		return;
...
void func_366()//Position - 0x11698
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				vLocal_56 = { unk_0x8000C77B5F336760(iVar0, true) };
			}
		}
	}
}

void func_367(bool bParam0, int iParam1)//Position - 0x116E1
{
	int iVar0;
	...
	if (bParam0)
	{
		func_368(&(Global_43D7.f_161A[iVar0 /*10*/]));
...
void func_368(int iParam0)//Position - 0x1179F
{
	if (iParam0->f_9 != 0)
	{
	...
	if (PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) == 0)
	{
		if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
			{
				...
				if (!iLocal_93 == 0)
				{
					if ((OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_93, 0) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_93)) && !ENTITY::IS_ENTITY_UPSIDEDOWN(iLocal_93))
					{
...
void func_370()//Position - 0x1183D
{
	if (iLocal_70 == 0)
	{
...
int func_371(int iParam0)//Position - 0x118C5
{
	vector3 vVar0;
	vector3 vVar1;
	int iVar2;
	...
	vVar1 = { unk_0x8000C77B5F336760(iLocal_93, true) };
	if (iLocal_299[iParam0] == 0)
	{
		if (ENTITY::GET_ENTITY_MODEL(iLocal_93) == joaat("TYRANT"))
		{
			iLocal_299[iParam0] = SHAPETEST::_START_SHAPE_TEST_CAPSULE_2(vVar0, vVar1, 0.1f, 511, iLocal_93, 3);
		}
		...
		{
			iLocal_299[iParam0] = SHAPETEST::_START_SHAPE_TEST_CAPSULE_2(vVar0, vVar1, 0.15f, 511, iLocal_93, 3);
		}
		else
		{
			iLocal_299[iParam0] = SHAPETEST::_START_SHAPE_TEST_CAPSULE_2(vVar0, vVar1, 0.25f, 511, iLocal_93, 3);
		}
	}
	else
	{
...
void func_372(int iParam0)//Position - 0x119EC
{
	switch (iParam0)
	{
		case 0:
...
void func_373()//Position - 0x11A8C
{
	if (func_378() && !PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 1))
	{
		iLocal_286 = 9;
		func_376(iLocal_90);
		func_376(AUDIO::_0x0626A247D2405330());
		func_374();
		func_34(&iLocal_98);
	}
}

void func_374()//Position - 0x11AC7
{
	struct<7> Var0;
	struct<7> Var1;
...
void func_375(var uParam0, var uParam1)//Position - 0x11B5D
{
	switch (func_18())
	{
		case 0:
...
void func_376(int iParam0)//Position - 0x11C97
{
	int iVar0;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_377(), 1f, 4294967295, 0.5f, 8192, 1193033728);
		CUTSCENE::_0x8D9DF6ECA8768583(iVar0);
		BRAIN::TASK_PERFORM_SEQUENCE(iParam0, iVar0);
		BRAIN::CLEAR_SEQUENCE_TASK(&iVar0);
	}
...
Vector3 func_377()//Position - 0x11CF6
{
	switch (func_18())
	{
		case 0:
...
bool func_378()//Position - 0x11D5B
{
	return SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), func_380()) < (func_379() * func_379());
}

float func_379()//Position - 0x11D7E
{
	switch (func_18())
	{
		case 0:
...
Vector3 func_380()//Position - 0x11DC3
{
	switch (func_18())
	{
		case 0:
...
void func_381()//Position - 0x11E28
{
	func_319();
	func_396();
	if (!func_10(&iLocal_101))
	...
	if (func_369() && PED::IS_PED_IN_VEHICLE(iLocal_90, iLocal_93, 0))
	{
		if (VEHICLE::IS_VEHICLE_STOPPED(iLocal_93) && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(iLocal_93))
		{
			if ((func_388() && !func_378()) && !func_387())
			{
				...
				{
					iLocal_83 = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(unk_0x8000C77B5F336760(iLocal_93, false), 40f, 40f, 40f, ENTITY::GET_ENTITY_HEADING(iLocal_93), 0, 7);
					PLAYER::SET_PLAYER_CONTROL(CAM::_0xDC9DA9E8789F5246(), false, 896);
					func_468(&iLocal_49, 2048);
					iLocal_94 = 0;
			...
			{
				if ((!AUDIO::IS_ANY_SPEECH_PLAYING(AUDIO::_0x0626A247D2405330()) && func_7(&iLocal_101) > 15f) && func_384())
				{
					if (!func_476(iLocal_50, 4096))
					{
						func_338("PROS_SPOT", 4294967295);
...
void func_382()//Position - 0x11FDA
{
	iLocal_51 = 0;
	iLocal_299[0] = 0;
	iLocal_299[1] = 0;
...
void func_383()//Position - 0x12001
{
	if (PED::IS_PED_INJURED(iLocal_90))
	{
		return;
...
void func_385()//Position - 0x1204F
{
	if (func_535())
	{
		...
		ENTITY::SET_ENTITY_HEALTH(iLocal_90, true);
	}
}

void func_386()//Position - 0x12080
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	...
	if (!func_476(iLocal_49, 2097152))
	{
		if (MISC::GET_GAME_TIMER() > iLocal_82)
		{
			if (iLocal_94 == 0)
			{
				vVar0 = { unk_0x8000C77B5F336760(iLocal_93, true) };
...
int func_387()//Position - 0x1214B
{
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iVar0, 0))
	{
		...
		{
			if (ENTITY::IS_ENTITY_IN_WATER(AUDIO::_0x0626A247D2405330()) || ENTITY::IS_ENTITY_IN_WATER(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
			{
				return 1;
			}
		}
...
int func_388()//Position - 0x12197
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
	{
		...
		if (func_84(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), (30f * 0.5f)))
		{
			return 0;
		}
		...
		if (PED::GET_CLOSEST_PED(vVar1, 20f, 1, 1, &iVar0, 0, 1, 4294967295))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
		...
		iVar3 = INTERIOR::GET_INTERIOR_FROM_ENTITY(AUDIO::_0x0626A247D2405330());
		if (!iVar3 == 0)
		{
...
int func_390(vector3 vParam0)//Position - 0x1232A
{
...
int func_391(vector3 vParam0)//Position - 0x12492
{
...
int func_392(vector3 vParam0)//Position - 0x125A5
{
	int iVar0;
	
	iVar0 = PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_ID(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), 1, 1, 1077936128, 0);
	...
	if (PATHFIND::_GET_SUPPORTS_GPS_ROUTE_FLAG(iVar0))
	{
		...
		{
			if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), vParam0) > 400f)
			{
				return 1;
			}
		}
		else if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), vParam0) > 56.25f)
		{
			return 1;
		}
	}
	...
	{
		iVar0 = PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_ID(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), 1, 8, 1077936128, 0);
		PATHFIND::GET_VEHICLE_NODE_POSITION(iVar0, &vParam0);
		if (SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), vParam0) > 400f)
		{
			return 1;
...
int func_393(int iParam0, var uParam1)//Position - 0x1268B
{
	vector3 vVar0[4];
...
bool func_394()//Position - 0x12752
{
	return Global_10B8E;
}

int func_395()//Position - 0x1275E
{
...
void func_396()//Position - 0x1278A
{
...
void func_397(int iParam0, bool bParam1)//Position - 0x127D0
{
	if (bParam1)
	{
...
void func_398(int iParam0, int iParam1, bool bParam2)//Position - 0x12807
{
	int iVar0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_146() == 0)
		{
			iVar0 = func_134(func_399(iParam0), 4294967295, 0);
			GRAPHICS::_0x35FB78DC42B7BD21(&iVar0, iParam1);
			func_131(func_399(iParam0), iVar0, 4294967295, 1, 0);
		}
	}
	else
	{
...
int func_399(int iParam0)//Position - 0x12879
{
	switch (iParam0)
	{
		case 0:
...
void func_400(int iParam0, int iParam1, bool bParam2)//Position - 0x12B7C
{
	int iVar0;
...
int func_401(int iParam0, int iParam1, bool bParam2)//Position - 0x12BEE
{
	if (iParam0 == 4294967295)
	{
		return 0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_146() == 0)
		{
			return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(func_134(func_399(iParam0), 4294967295, 0), iParam1);
		}
	}
	else
	{
...
void func_402(var uParam0)//Position - 0x12C58
{
	if (func_476(iLocal_49, 2))
	{
		if (!func_57())
...
void func_403()//Position - 0x12C8F
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_90, 0))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_90, AUDIO::_0x0626A247D2405330(), 5f, 5f, 5f, 0, 1, 0) || func_476(iLocal_49, 8192))
		{
			PAD::DISABLE_CONTROL_ACTION(0, 101, 1);
			PAD::DISABLE_CONTROL_ACTION(0, 74, 1);
			PAD::SET_INPUT_EXCLUSIVE(0, 51);
			if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_90, 0))
			{
				...
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_93, 0))
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(iLocal_90, iLocal_93) && PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_93, 0))
					{
			...
			{
				if ((func_405(iLocal_90, AUDIO::_0x0626A247D2405330(), 1) > 11f || func_404(20f)) || !PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_93, 0))
				{
					func_108(&iLocal_107);
...
bool func_404(float fParam0)//Position - 0x12FA9
{
	if (!func_10(&iLocal_107))
	{
		func_34(&iLocal_107);
...
float func_405(int iParam0, int iParam1, bool bParam2)//Position - 0x12FCA
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_406(int iParam0)//Position - 0x13028
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_407(int iParam0)//Position - 0x13053
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_408(int iParam0)//Position - 0x1307E
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_409(int iParam0)//Position - 0x130AF
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_410(int iParam0)//Position - 0x130DA
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_411(int iParam0)//Position - 0x13105
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_412(int iParam0)//Position - 0x13136
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_413(int iParam0)//Position - 0x13167
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
int func_414(int iParam0)//Position - 0x1319E
{
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		switch (VEHICLE::GET_VEHICLE_LAYOUT_HASH(iParam0))
...
void func_415(var uParam0)//Position - 0x131F9
{
	int iVar0;
	...
	if (func_114(&iLocal_107) >= 20f || !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_90, AUDIO::_0x0626A247D2405330(), 3f, 3f, 3f, 0, 1, 0))
	{
		if (func_476(iLocal_73, 524288))
		{
			func_108(&iLocal_107);
	...
	func_63(iLocal_90);
	if (((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_90, AUDIO::_0x0626A247D2405330(), 3f, 3f, 3f, 0, 1, 0) || func_476(iLocal_73, 1)) && !func_209(0)) && !func_394())
	{
		if (!VEHICLE::_0x639431E895B9AA57(iLocal_90, iLocal_93, 0, 0, false))
		{
			if (!func_105())
	...
	else if (func_456("PROS_ACCEPT"))
	{
		...
		if (func_535())
		{
			iVar0 = BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_90, 2277090178);
			if (iVar0 != 1 && iVar0 != 0)
			{
				func_526();
				func_521(uParam0);
...
void func_416()//Position - 0x13374
{
	char* sVar0;
	...
	{
		func_419();
		if (func_417(iLocal_72, 1) || PLAYER::IS_PLAYER_PRESSING_HORN(CAM::_0xDC9DA9E8789F5246()))
		{
			AUDIO::_PLAY_AMBIENT_SPEECH1(AUDIO::_0x0626A247D2405330(), "HOOKER_REQUEST", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
		...
		if (func_476(iLocal_49, 8192))
		{
			func_454();
			Global_6409 = 1;
			Global_24FBF9[CAM::_0xDC9DA9E8789F5246() /*413*/].f_195 = 1;
			func_124("PROSTITUTES_SOLICIT_SCENE");
			func_81("PROSTITUTES_DRIVE_SCENE");
			if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_90, 2500551826) != 1 && !PED::IS_PED_IN_VEHICLE(iLocal_90, PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 1))
				{
					BRAIN::TASK_ENTER_VEHICLE(iLocal_90, iLocal_93, 4294967295, 0, 1f, 8388609, 0);
				}
			}
			sLocal_61 = func_44(AUDIO::_0x0626A247D2405330(), 1, 0);
			STREAMING::REQUEST_ANIM_DICT(sLocal_61);
			sLocal_61 = func_44(AUDIO::_0x0626A247D2405330(), 0, 1);
			STREAMING::REQUEST_ANIM_DICT(sLocal_61);
			func_34(&iLocal_101);
			iLocal_286 = 5;
		}
...
int func_417(int iParam0, bool bParam1)//Position - 0x1346F
{
	int iVar0;
...
int func_418(int iParam0)//Position - 0x13527
{
	int iVar0;
...
void func_419()//Position - 0x13562
{
	if (Global_6409)
	{
		if (HUD::IS_PAUSE_MENU_ACTIVE())
...
int func_420(int iParam0, int iParam1)//Position - 0x135C4
{
	int iVar0;
	int iVar1;
...
void func_421(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x13679
{
	int iVar0;
...
void func_422(int iParam0)//Position - 0x137A4
{
	int iVar0;
...
int func_423()//Position - 0x137FB
{
	...
	if (!func_535())
	{
		...
		else if (func_476(iLocal_49, 4194304))
		{
			...
			BRAIN::OPEN_SEQUENCE_TASK(&iVar1);
			BRAIN::TASK_PLAY_ANIM(0, func_61(iLocal_284), func_60(5), 2f, -2f, 4294967295, 0, 0, 0, 0, 0);
			BRAIN::TASK_PLAY_ANIM(0, func_61(iLocal_284), func_60(iVar0), 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
			CUTSCENE::_0x8D9DF6ECA8768583(iVar1);
			BRAIN::TASK_PERFORM_SEQUENCE(iLocal_90, iVar1);
			BRAIN::CLEAR_SEQUENCE_TASK(&iVar1);
		}
	...
	switch (iLocal_55)
	{
		...
		case 1:
			if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_90))
			{
				BRAIN::TASK_PLAY_ANIM(iLocal_90, func_61(iLocal_284), func_60(5), 2f, -2f, 4294967295, 0, 0, 0, 0, 0);
				iLocal_55 = 2;
			}
			else
			{
		...
		case 2:
			if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_90))
			{
				...
				{
					iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(8, 11);
					BRAIN::TASK_PLAY_ANIM(iLocal_90, func_61(iLocal_284), func_60(iVar0), 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
					iLocal_55 = 3;
				}
			}
			else
...
int func_424(bool bParam0)//Position - 0x139B2
{
	if (ENTITY::IS_ENTITY_DEAD(iLocal_90, 0))
	{
		return 0;
	...
	if (func_405(iLocal_90, AUDIO::_0x0626A247D2405330(), 1) > 11f)
	{
		return 0;
	}
	if (!PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
	...
	if (func_535())
	{
		if (VEHICLE::GET_VEHICLE_NUMBER_OF_PASSENGERS(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)) > 1)
		{
			return 0;
		}
	}
	if (bParam0)
	{
		if (ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)) > 2f)
		{
			return 0;
		}
	}
	if (func_84(unk_0x8000C77B5F336760(iLocal_90, true), 1106247680))
	{
		if (!func_476(iLocal_50, 8192) && !PED::IS_PED_IN_ANY_POLICE_VEHICLE(AUDIO::_0x0626A247D2405330()))
		{
			func_338("PROS_COPS", 4294967295);
	...
	if (!func_369())
	{
		if (!func_535())
		{
			if ((!iLocal_86 && !Global_19A9D) && func_426(AUDIO::_0x0626A247D2405330(), 0) == 4294967295)
			{
				func_338("PROS_CAR", 4294967295);
				iLocal_86 = 1;
			}
			func_425();
		}
...
void func_425()//Position - 0x13ADB
{
	...
	{
		if (!AUDIO::IS_ANY_SPEECH_PLAYING(AUDIO::_0x0626A247D2405330()) && !AUDIO::IS_ANY_SPEECH_PLAYING(iLocal_90))
		{
			AUDIO::_PLAY_AMBIENT_SPEECH1(AUDIO::_0x0626A247D2405330(), "HOOKER_CAR_INCORRECT", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
			func_468(&iLocal_49, 1);
		}
	}
}

int func_426(int iParam0, int iParam1)//Position - 0x13B2C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_427()//Position - 0x13BB1
{
	if (func_424(0))
	{
		func_416();
		if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_90, 242628503) == 7 && !func_476(iLocal_49, 8192))
		{
			if (func_66(1))
			{
				func_108(&iLocal_107);
...
void func_428(var uParam0)//Position - 0x13C13
{
	if (func_424(0))
	{
		func_416();
...
void func_429(var uParam0)//Position - 0x13C7C
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	vVar5 = { unk_0x8000C77B5F336760(iLocal_90, true) };
	if (SYSTEM::VDIST(vVar5, vVar4) < SYSTEM::VDIST(vVar5, vVar3))
	{
		vVar3 = { vVar4 };
	}
	if ((BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_90, 2500551826) != 1 || !func_476(iLocal_49, 8192)) && SYSTEM::VDIST2(vLocal_89, vVar3) > 0f)
	{
		if (func_535())
		{
		...
		BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar3.x, vVar3.y, vVar3.z, 1f, 4294967295, 1f, 8192, 1193033728);
		BRAIN::TASK_TURN_PED_TO_FACE_COORD(0, PED::GET_PED_BONE_COORDS(AUDIO::_0x0626A247D2405330(), 31086, 0f, 0f, 0f), 0);
...
void func_430(var uParam0, var uParam1)//Position - 0x13DCA
{
	int iVar0;
...
void func_431(var uParam0, char* sParam1)//Position - 0x13E00
{
	func_432(uParam0, 1, 4294967295, sParam1, 0);
}

void func_432(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4)//Position - 0x13E13
{
	int iVar0;
...
void func_433(var uParam0, bool bParam1)//Position - 0x13EFD
{
	int iVar0;
...
void func_434(var uParam0)//Position - 0x13F40
{
	*uParam0 = 0;
...
void func_435(var uParam0)//Position - 0x13F59
{
	int iVar0;
...
void func_436(var uParam0)//Position - 0x13F93
{
	func_437(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

void func_437(int iParam0, char* sParam1, int iParam2)//Position - 0x13FAA
{
...
int func_438(int iParam0)//Position - 0x1406C
{
	int iVar0;
...
int func_439(var uParam0, char* sParam1)//Position - 0x14098
{
	int iVar0;
	int iVar1;
...
int func_440(var uParam0)//Position - 0x140FD
{
	int iVar0;
...
void func_441(var uParam0)//Position - 0x1412C
{
	char* sVar0;
	...
	if (func_424(1))
	{
		...
		if (func_457(&iLocal_107, 2f) || func_476(iLocal_49, 8192))
		{
			...
			if (func_355(&sVar0, 0))
			{
				...
				BRAIN::TASK_LOOK_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_90, 4294967295, 2048, 4);
				func_429(uParam0);
				func_468(&iLocal_49, 4);
				Global_6409 = 1;
				Global_24FBF9[CAM::_0xDC9DA9E8789F5246() /*413*/].f_195 = 1;
			...
			{
				if (MISC::ARE_STRINGS_EQUAL(func_453(&sVar0), "PIM_HHIDCR"))
				{
				...
				func_5(&iLocal_49, 4);
				Global_6409 = 0;
				Global_24FBF9[CAM::_0xDC9DA9E8789F5246() /*413*/].f_195 = 0;
			}
		}
	}
	else
...
void func_442()//Position - 0x1424E
{
	if (!func_509(64))
	{
		func_443(0, 31, 5);
...
void func_443(int iParam0, int iParam1, int iParam2)//Position - 0x1426E
{
	int iVar0;
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_447(CAM::_0xDC9DA9E8789F5246(), 1))
	{
		return;
	}
...
bool func_445()//Position - 0x14368
{
	return Global_258443;
}

bool func_446()//Position - 0x14374
{
	return Global_2586D5;
}

int func_447(int iParam0, bool bParam1)//Position - 0x14380
{
	if (bParam1)
	{
		if (func_448(iParam0))
...
bool func_448(int iParam0)//Position - 0x143AC
{
	return func_449(iParam0);
}

bool func_449(int iParam0)//Position - 0x143BA
{
	return INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_1841F3[iParam0 /*790*/].f_D.f_1, 0);
}

void func_450(int iParam0)//Position - 0x143D4
{
	unk_0x652B3075D0E58C13(3, 21, 200, 0, 0);
	if (iParam0 && !func_451())
	{
		unk_0x1190AB7024CBD8CB(4294967295, "Event_Message_Purple", "GTAO_FM_Events_Soundset", false);
	}
}

bool func_451()//Position - 0x14403
{
	return Global_252F9E.f_A90[0 /*80*/].f_1 != 0;
}

void func_452(char* sParam0, int iParam1)//Position - 0x14419
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, false, iParam1);
}

char* func_453(char* sParam0)//Position - 0x14430
{
	return sParam0;
}

void func_454()//Position - 0x1443A
{
	if (iLocal_72 != 4294967295)
	{
		func_422(&iLocal_72);
...
void func_455(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1444E
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
int func_456(char* sParam0)//Position - 0x144E9
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

int func_457(int iParam0, float fParam1)//Position - 0x144FC
{
...
void func_458(int iParam0)//Position - 0x1451A
{
	if (!func_10(iParam0))
	{
		func_34(iParam0);
...
void func_459(int iParam0)//Position - 0x14532
{
	bool bVar0;
...
int func_460()//Position - 0x14574
{
	if ((((((func_467() || func_466()) || func_465()) || func_464()) || func_461()) || Global_248A6D) || Global_248A6D.f_1 != 0)
	{
		return 1;
	}
	return 0;
...
int func_471()//Position - 0x146B5
{
	int iVar0;
	
	iLocal_92 = VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(unk_0x8000C77B5F336760(iLocal_90, true), 15f, 0, 6);
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_92) && !ENTITY::IS_ENTITY_DEAD(iLocal_92, 0))
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_92, 0))
		{
			if (func_85(&iLocal_92))
			{
				iLocal_91 = VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_92, 4294967295, 0);
				if (!iLocal_91 == 0)
				{
					if (func_472(&iLocal_91))
					{
						...
						if (!iVar0 == joaat("TAXI") && !iVar0 == joaat("TAXI"))
						{
							...
							ENTITY::SET_ENTITY_HEALTH(iLocal_91, true);
...
int func_472(int iParam0)//Position - 0x1477D
{
	if (!PED::IS_PED_INJURED(*iParam0))
	{
...
int func_473()//Position - 0x1479F
{
	if (ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0) || ENTITY::IS_ENTITY_DEAD(iLocal_90, 0))
	{
		return 0;
	}
	return 1;
...
int func_474()//Position - 0x147C5
{
	if ((!func_473() || !PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0)) || func_476(iLocal_49, 4096))
	{
		return 0;
	}
	if (func_476(iLocal_49, 32))
...
void func_475()//Position - 0x14819
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_90, 0))
	{
		if (!PED::IS_PED_FLEEING(iLocal_90))
		{
			...
			{
				ENTITY::SET_ENTITY_HEALTH(iLocal_90, false);
				PED::SET_PED_FLEE_ATTRIBUTES(iLocal_90, 196628, true);
				PED::_0xF1C03A5352243A30(iLocal_90);
				BRAIN::TASK_SMART_FLEE_PED(iLocal_90, AUDIO::_0x0626A247D2405330(), 300f, 4294967295, 1, 0);
...
bool func_476(int iParam0, int iParam1)//Position - 0x1487C
{
	return (iParam0 && iParam1) != 0;
}

void func_477(char* sParam0)//Position - 0x1488B
{
}

int func_478()//Position - 0x14893
{
	if (PED::IS_PED_INJURED(iLocal_90))
	{
		return 0;
...
bool func_480(var uParam0)//Position - 0x14A2D
{
	return func_481(uParam0);
}

int func_481(var uParam0)//Position - 0x14A3B
{
	int iVar0;
...
bool func_482(var uParam0)//Position - 0x14A9F
{
	return func_483(*uParam0, &(uParam0->f_2), uParam0->f_1);
}

int func_483(int iParam0, char* sParam1, int iParam2)//Position - 0x14AB6
{
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 30))
	{
...
float func_485(int iParam0, vector3 vParam1, bool bParam2)//Position - 0x14C0A
{
	vector3 vVar0;
...
void func_487()//Position - 0x14CBD
{
	if (ENTITY::IS_ENTITY_DEAD(iLocal_90, 0))
	{
		return;
	...
	{
		func_488(AUDIO::_0x0626A247D2405330());
	}
...
void func_488(int iParam0)//Position - 0x14CFC
{
	if (ENTITY::IS_ENTITY_DEAD(iParam0, 0))
	{
		return;
	...
	if (func_405(iParam0, iLocal_90, 1) < 30f)
	{
		if (!PED::IS_PED_HEADTRACKING_PED(iLocal_90, iParam0))
		{
			if (func_535())
			{
				...
				{
					BRAIN::TASK_CLEAR_LOOK_AT(iLocal_90);
					BRAIN::TASK_LOOK_AT_ENTITY(iLocal_90, iParam0, 4294967295, 2048, 4);
				}
			}
			else
			{
...
void func_489()//Position - 0x14DB0
{
	if (Global_6409)
	{
		if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_93, 0))
	...
	{
		if (Global_640D != SCRIPT::GET_ID_OF_THIS_THREAD() && func_476(iLocal_49, 32))
		{
			func_5(&iLocal_49, 32);
		}
		return;
	}
	if ((SYSTEM::VDIST2(unk_0x8000C77B5F336760(iLocal_90, true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) < Global_640C || Global_640C == 0f) && iLocal_287 != 4)
	{
		Global_640C = SYSTEM::VDIST2(unk_0x8000C77B5F336760(iLocal_90, true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true));
		Global_640D = SCRIPT::GET_ID_OF_THIS_THREAD();
		func_468(&iLocal_49, 32);
	}
	else if (Global_640D == SCRIPT::GET_ID_OF_THIS_THREAD())
	{
		Global_640C = SYSTEM::VDIST2(unk_0x8000C77B5F336760(iLocal_90, true), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true));
	}
	else
...
void func_490()//Position - 0x14EA9
{
	if (func_535())
	{
		if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_90))
...
void func_491(var uParam0)//Position - 0x14ED8
{
	if (!iLocal_286 == 12)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_90, 0) && !ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
		{
			if (func_495())
			{
				if (func_535())
				{
					...
					BRAIN::TASK_SMART_FLEE_PED(iLocal_90, AUDIO::_0x0626A247D2405330(), 300f, 4294967295, 0, 0);
					PED::SET_PED_KEEP_TASK(iLocal_90, true);
					NETWORK::_0x5E3AA4CA2B6FB0EE(AUDIO::_0x0626A247D2405330());
					func_526();
					func_521(uParam0);
			...
			else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_90, AUDIO::_0x0626A247D2405330(), 1))
			{
				iLocal_65++;
				if (iLocal_65 >= 2)
				{
...
void func_492()//Position - 0x14FB6
{
	if (PED::IS_PED_INJURED(iLocal_90))
	{
		return;
...
int func_493()//Position - 0x14FDF
{
	...
	if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(AUDIO::_0x0626A247D2405330()))
	{
...
int func_494()//Position - 0x15033
{
	if (!func_535())
	{
		return 1;
	}
	else if (ENTITY::DOES_ENTITY_EXIST(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
	{
		if (NETWORK::NETWORK_GET_ENTITY_IS_NETWORKED(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
		{
			if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 4294967295, 0) == AUDIO::_0x0626A247D2405330())
...
int func_495()//Position - 0x150D9
{
	vector3 vVar0;
	
	if (!func_476(iLocal_49, 4096))
	{
		if (func_405(iLocal_90, AUDIO::_0x0626A247D2405330(), 1) < 30f)
		{
			vVar0 = { unk_0x8000C77B5F336760(iLocal_90, true) };
			if ((((((EVENT::IS_SHOCKING_EVENT_IN_SPHERE(86, vVar0, 30f) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(89, vVar0, 30f)) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(88, vVar0, 30f)) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(102, vVar0, 30f)) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(114, vVar0, 30f)) || (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(112, vVar0, 30f) && !func_535())) || PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
			{
				if (!func_535())
				{
					ENTITY::SET_ENTITY_HEALTH(iLocal_90, false);
...
int func_496()//Position - 0x151BD
{
	if ((ENTITY::DOES_ENTITY_EXIST(iLocal_90) && !ENTITY::IS_ENTITY_DEAD(iLocal_90, 0)) && !ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
	{
		if (func_535())
		{
			if (func_537(CAM::_0xDC9DA9E8789F5246(), 0))
			{
		...
		if (!PED::IS_PED_INJURED(iLocal_90))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_90, 0))
			{
				if (!func_498(9))
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_90, 0) && !ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_90, AUDIO::_0x0626A247D2405330(), 100f, 100f, 50f, 0, 1, 0))
						{
							return 1;
						}
						else
...
int func_498(int iParam0)//Position - 0x1537A
{
	if (Global_8D15 == 15)
	{
		return 0;
...
bool func_499(int iParam0)//Position - 0x1539C
{
	return func_500(iParam0, Global_8D15);
}

int func_500(int iParam0, int iParam1)//Position - 0x153AD
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_501()//Position - 0x1558E
{
	int iVar0;
	int iVar1;
	struct<2> Var2;
	...
	while (iVar0 < SCRIPT::GET_NUMBER_OF_EVENTS(1))
	{
		...
		if (iVar1 == 171)
		{
			...
			if (Var2 == 3891977556)
			{
				if (Var2.f_1 == CAM::_0xDC9DA9E8789F5246())
				{
					func_189(128);
				}
			}
...
void func_502()//Position - 0x155E2
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return;
...
bool func_503(int iParam0, bool bParam1, bool bParam2)//Position - 0x15622
{
	return func_504(0, iParam0, 1, bParam1, bParam2);
}

int func_504(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x15636
{
	int iVar0;
	int iVar1;
...
int func_505(int iParam0)//Position - 0x156FF
{
	switch (iParam0)
	{
		case 0:
...
int func_506(int iParam0)//Position - 0x15739
{
	switch (iParam0)
	{
		case 0:
...
int func_507(int iParam0, bool bParam1)//Position - 0x1577F
{
	int iVar0;
...
int func_508(int iParam0)//Position - 0x1581C
{
	switch (iParam0)
	{
		case 0:
...
bool func_509(int iParam0)//Position - 0x1585C
{
	return func_476(iLocal_52, iParam0);
}

void func_510(var uParam0)//Position - 0x1586C
{
	int iVar0;
...
void func_511(int iParam0)//Position - 0x158FA
{
	func_512(iParam0, &(iParam0->f_2), iParam0->f_1);
}

void func_512(int iParam0, char* sParam1, int iParam2)//Position - 0x15910
{
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 30))
	{
		switch (func_438(*iParam0))
...
void func_513(int iParam0)//Position - 0x159EA
{
	if (func_476(iLocal_52, iParam0))
	{
...
void func_514()//Position - 0x15A05
{
	func_2(0);
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_90))
	{
	...
	if (!PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
	{
		func_2(0);
...
int func_515(int iParam0, int iParam1, bool bParam2)//Position - 0x15A69
{
	int iVar0;
...
int func_516(int iParam0)//Position - 0x15B7E
{
...
bool func_517()//Position - 0x15B95
{
	return Global_255C02.f_246;
}

bool func_518()//Position - 0x15BA4
{
	return Global_140842;
}

void func_519()//Position - 0x15BB0
{
	HUD::DISPLAY_SNIPER_SCOPE_THIS_FRAME();
}

void func_520()//Position - 0x15BBC
{
	func_189(1);
}

void func_521(var uParam0)//Position - 0x15BC9
{
	func_524();
	if (func_42(0, 1))
	{
	...
	if (!PED::IS_PED_INJURED(iLocal_90))
	{
		if (ENTITY::IS_ENTITY_A_MISSION_ENTITY(iLocal_90))
		{
			if ((func_535() && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_90, 1805844857) != 1) && BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_90, 4043842218) != 1)
			{
				BRAIN::TASK_WANDER_STANDARD(iLocal_90, 1193033728, 0);
				if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_90))
				{
	...
	if (!PED::IS_PED_INJURED(iLocal_91))
	{
		NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_91);
	}
	iLocal_91 = 0;
	iLocal_287 = 0;
	...
	func_522();
	Global_640C = 0f;
	if (!Global_1987EA.f_1089 && !Global_1987EA.f_108D)
	{
	...
	if (!ENTITY::IS_ENTITY_DEAD(AUDIO::_0x0626A247D2405330(), 0))
	{
		if (func_509(256))
		{
			PED::SET_PED_COMPONENT_VARIATION(AUDIO::_0x0626A247D2405330(), 6, iLocal_84, iLocal_85, 0);
			func_189(1024);
		}
	}
	if (func_456("PROS_ACCEPT") && !Global_6409)
	{
		GRAPHICS::SET_SCRIPT_GFX_DRAW_BEHIND_PAUSEMENU(1);
	}
	if (Global_640D == SCRIPT::GET_ID_OF_THIS_THREAD())
	{
		Global_6409 = 0;
		Global_24FBF9[CAM::_0xDC9DA9E8789F5246() /*413*/].f_195 = 0;
	}
...
void func_522()//Position - 0x15D8C
{
}

void func_523()//Position - 0x15D94
{
	Global_252F9E.f_47F.f_A = 0;
}

void func_524()//Position - 0x15DA6
{
}

void func_525(bool bParam0)//Position - 0x15DAE
{
	if (!PED::IS_PED_INJURED(iLocal_90))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_90, 0))
		{
			if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_90, 3466132403) != 1)
			{
...
void func_526()//Position - 0x15E20
{
	if (!func_535())
	{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_90, 0))
	{
		...
		AUDIO::_0x18EB48CFC41F2EA0(iLocal_90, 0f);
	}
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_93, 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_93, 0))
	{
		if (func_535())
		{
			if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_93))
			{
				if (Global_1841F3[CAM::_0xDC9DA9E8789F5246() /*790*/].f_111.f_18 <= 0 && !INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(Global_1841F3[CAM::_0xDC9DA9E8789F5246() /*790*/].f_111.f_16, 11))
				{
		...
		if (func_509(2))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
			{
				if (NETWORK::NETWORK_GET_ENTITY_IS_NETWORKED(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
				{
					if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0)))
					{
						VEHICLE::SET_VEHICLE_DOORS_LOCKED_FOR_ALL_PLAYERS(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0), 0);
			...
			else if (NETWORK::NETWORK_GET_ENTITY_IS_NETWORKED(iLocal_93))
			{
				if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_93))
				{
					...
					AUDIO::SET_VEHICLE_RADIO_ENABLED(iLocal_93, 0);
				}
				else
				{
...
void func_527()//Position - 0x16151
{
	struct<8> Var0[2];
	struct<6> Var1[2];
	...
	if (func_531(275, &Var1, &Var0, 2, 4294967295, 0, 0))
	{
...
int func_528()//Position - 0x161D6
{
	return iLocal_46;
}

int func_529()//Position - 0x161E0
{
	return iLocal_45;
}

int func_530()//Position - 0x161EA
{
	return 0;
}

int func_531(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x161F3
{
	struct<68> Var0;
	int iVar1;
	struct<13> Var2;
...
void func_533()//Position - 0x1634D
{
	if (func_476(iLocal_49, 128))
	{
		func_397(39, 0);
...
void func_534(int iParam0)//Position - 0x16392
{
	if (func_535())
	{
		if (func_211(iParam0))
...
bool func_535()//Position - 0x163B0
{
	return func_509(1);
}

bool func_536(int iParam0)//Position - 0x163BD
{
	return Global_8D15 == iParam0;
}

int func_537(int iParam0, int iParam1)//Position - 0x163CB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_538(int iParam0, bool bParam1)//Position - 0x16441
{
	if (bParam1)
	{
		if (func_448(iParam0))
	...
	if ((((Global_1841F3[iParam0 /*790*/] == 2 || Global_1841F3[iParam0 /*790*/] == 1) || Global_1841F3[iParam0 /*790*/] == 0) || Global_1841F3[iParam0 /*790*/] == 3) || Global_1841F3[iParam0 /*790*/] == 8)
	{
		return 1;
	}
	return 0;
