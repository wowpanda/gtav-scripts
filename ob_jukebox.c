...
void __EntryFunction__()
{
	...
	if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_KEY("ob_jukebox")) > 1)
	{
		func_176(0);
	}
	iLocal_194 = Global_1589819[PLAYER_ID() /*818*/].f_273.f_25;
	func_174();
	func_167();
	...
	func_166(PLAYER_ID(), &Var0);
	if (func_165(Var0))
	{
		if (NETWORK_IS_GAMER_IN_MY_SESSION(&Var0))
		{
			iLocal_190 = NETWORK_GET_PLAYER_FROM_GAMER_HANDLE(&Var0);
		}
	}
	...
	{
		func_174();
		if (iLocal_189 != 0 && !func_157(vLocal_218, 0f, 0f, 0f, 0))
		{
			if (NETWORK_IS_HOST_OF_THIS_SCRIPT())
			{
				func_156();
		...
		else if (iLocal_194 != -1 && iLocal_194 <= 125)
		{
			...
			iLocal_189 = GET_CLOSEST_OBJECT_OF_TYPE(vLocal_212, 2f, 598033448, 1, 0, 0);
			if (DOES_ENTITY_EXIST(iLocal_189))
			{
				vLocal_215 = { GET_ENTITY_COORDS(iLocal_189, 1) - GET_ENTITY_FORWARD_VECTOR(iLocal_189) * Vector(0.6f, 0.6f, 0.6f) };
				vLocal_215.z = (vLocal_215.z + 0.5f);
				vLocal_218 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_189, 0f, -0.12f, -0.0315f) };
			}
		}
		else
		{
...
void func_5()
{
	if (iLocal_190 == PLAYER_ID() && func_158())
	{
...
void func_7(int iParam0)
{
	...
	iVar1 = (GET_CLOUD_TIME_AS_INT() - iLocal_200);
	func_10(func_14(iParam0), (iVar0 + iVar1), -1, 1, 0);
	if (iLocal_201 < (iVar0 + iVar1))
	{
		func_8(func_9());
	}
	iLocal_200 = GET_CLOUD_TIME_AS_INT();
}

void func_8(var uParam0)
{
	Global_1589819[PLAYER_ID() /*818*/].f_273.f_343 = uParam0;
}
...
void func_18()
{
	...
	{
		func_162(Local_221.f_2);
		if (iLocal_190 == PLAYER_ID() && Local_221.f_3)
		{
			func_19(9355, iLocal_191, -1, 1);
			Global_1589819[iLocal_190 /*818*/].f_273.f_342 = iLocal_191;
		}
	}
	if (IS_BIT_SET(uLocal_199, 6) != bVar0)
	{
		func_160(bVar0);
		if ((iLocal_190 == PLAYER_ID() && Local_221.f_3) && !bVar0)
		{
			func_19(9355, 4, -1, 1);
	...
	switch (iLocal_205)
	{
		case 0:
			if (func_150() && func_149())
			{
				...
				else if ((iLocal_196 != -1 && func_145(iLocal_196, 1)) && !IS_PED_RUNNING(PLAYER_PED_ID()))
				{
					func_144(2);
					func_142(&iLocal_196);
					SET_BIT(&(Local_225[PLAYER_ID() /*2*/]), 0);
					SET_BIT(&Global_2505876, 4);
				}
				SET_BIT(&Global_2505876, 3);
			}
			else if (iLocal_196 != -1)
			{
				func_142(&iLocal_196);
				CLEAR_BIT(&Global_2505876, 3);
			}
		...
		case 2:
			if (Local_221.f_1 == PLAYER_ID() && func_139())
			{
				iLocal_197 = 0;
				func_144(1);
				CLEAR_BIT(&(Local_225[PLAYER_ID() /*2*/]), 0);
				SET_BIT(&(Local_225[PLAYER_ID() /*2*/]), 1);
				func_132(PLAYER_ID(), 0, 256, 0);
				func_131(&uLocal_208);
			}
		...
		case 3:
			if (IS_BIT_SET(uLocal_199, 4))
			{
				if (func_124())
				{
					CLEAR_BIT(&uLocal_199, 4);
				}
			}
			func_38();
			break;
		...
		case 4:
			if (IS_BIT_SET(uLocal_199, 3))
			{
				CLEAR_BIT(&uLocal_199, 3);
				func_35(1, -1);
			}
			uVar0 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(iLocal_198);
			if (!IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), sLocal_203, "EXIT", 3))
			{
				func_27(IS_BIT_SET(uLocal_199, 5));
				if (iLocal_192 != -1)
				{
					if ((IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), sLocal_203, "INSERT_COINS", 3) && GET_SYNCHRONIZED_SCENE_PHASE(uVar0) >= 0.82f) || !IS_BIT_SET(uLocal_199, 5))
					{
						func_26(iLocal_192);
					}
				}
			}
			else if (GET_SYNCHRONIZED_SCENE_PHASE(uVar0) >= 0.96f)
			{
				CLEAR_BIT(&uLocal_199, 5);
				CLEAR_BIT(&uLocal_199, 4);
				CLEAR_BIT(&(Local_225[PLAYER_ID() /*2*/]), 1);
				CLEAR_BIT(&(Local_225[PLAYER_ID() /*2*/]), 2);
				func_132(PLAYER_ID(), 1, 0, 0);
				CLEAR_BIT(&Global_2505876, 4);
				iLocal_204 = 0;
				uLocal_202 = Global_1589819[iLocal_190 /*818*/].f_273.f_342;
				_0x8989CBD7B4E82534(func_24(func_25()), func_23(func_25()), func_22(), func_21(), 4, uLocal_202, 0);
				func_144(0);
			}
			break;
	}
...
{
	Local_225[PLAYER_ID() /*2*/].f_1 = iParam0;
	SET_BIT(&(Local_225[PLAYER_ID() /*2*/]), 2);
}
...
int func_34(char* sParam0, bool bParam1, int iParam2)
{
	...
	{
		if ((!IS_SYNCHRONIZED_SCENE_RUNNING(uVar0) || GET_SYNCHRONIZED_SCENE_PHASE(uVar0) >= 0.96f) || bParam1)
		{
			if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_198))
			{
				DETACH_SYNCHRONIZED_SCENE(iLocal_198);
				iLocal_198 = -1;
			}
			iLocal_198 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_218, GET_ENTITY_ROTATION(iLocal_189, 2), 2, 0, iParam2, 1065353216, 0, 1065353216);
			NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), iLocal_198, sLocal_203, sParam0, 4f, -2f, 5, 0, 1148846080, 0);
			NETWORK_START_SYNCHRONISED_SCENE(iLocal_198);
			return 1;
		}
	}
	return 0;
...
void func_38()
{
	if (!func_123())
	{
		...
		{
			if (IS_BIT_SET(uLocal_199, 1))
			{
				func_82();
				CLEAR_BIT(&uLocal_199, 1);
			}
			else
			{
	...
	while (iVar5 < 2)
	{
		if (iVar5 == 1 && Global_17411.f_5728)
		{
			...
			if (GET_HASH_KEY(&(Global_17411.f_4690)) != 0 && Global_17411.f_4766 != -1)
			{
				...
				{
					func_71(Global_17411.f_4768, 1, 1, &fVar36, &fVar37, bParam7);
					func_56(Global_17411.f_4768, 1, &uVar47, &uVar48, &uVar49, &uVar50);
					DRAW_SPRITE(func_65(Global_17411.f_4768), func_62(Global_17411.f_4768, 1), ((Global_17408 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
				}
			...
			if (GET_HASH_KEY(&(Global_4267964.f_21)) != 0 && Global_4267964.f_65 != -1)
			{
				...
				{
					func_71(Global_4267964.f_67, 1, 1, &fVar36, &fVar37, bParam7);
					func_56(Global_4267964.f_67, 1, &uVar47, &uVar48, &uVar49, &uVar50);
					DRAW_SPRITE(func_65(Global_4267964.f_67), func_62(Global_4267964.f_67, 1), ((Global_17408 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar51 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
				}
				fVar51 = (fVar51 + (((_GET_TEXT_SCALE_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
			...
			func_49(uVar60, iParam1, iParam8, 0, 0, 0, bParam4, 1, 0);
			SET_SCRIPT_GFX_ALIGN(76, 84);
			SET_SCRIPT_GFX_ALIGN_PARAMS(-0.05f, -0.05f, 0f, 0f);
		}
		if (iVar5 == 1 || !Global_17411.f_5728)
								...
								if (bVar33)
								{
									...
									if (bVar54)
									{
										if (func_71(26, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											{
												func_56(26, 1, &uVar47, &uVar48, &uVar49, &uVar50);
												if (iVar5 == 1)
												{
													DRAW_SPRITE(func_65(26), func_62(26, 1), ((fVar34 + fVar42) + fVar45), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
												}
											}
										}
										if (func_71(27, 1, 0, &fVar36, &fVar37, bParam7))
										{
											...
											{
												func_56(27, 1, &uVar47, &uVar48, &uVar49, &uVar50);
												if (iVar5 == 1)
												{
													DRAW_SPRITE(func_65(27), func_62(27, 1), (((fVar34 + fVar42) + fVar45) + (fVar43 + fVar44)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
												}
											}
										}
									}
										...
										else if (Global_17411.f_2124[iVar24 /*5*/][iVar14] == 4)
										{
											if ((Global_17411.f_4433[(iVar22 + iVar28)] == 2 || Global_17411.f_4433[(iVar22 + iVar28)] == 50) || Global_17411.f_4433[(iVar22 + iVar28)] == 60)
											{
												if (func_71(Global_17411.f_4433[(iVar22 + iVar28)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													{
														func_56(Global_17411.f_4433[(iVar22 + iVar28)], bVar32, &uVar47, &uVar48, &uVar49, &uVar50);
														if (iVar5 == 1)
														{
															if (Global_17411.f_5083[iVar8] == 2)
															{
																DRAW_SPRITE(func_65(Global_17411.f_4433[(iVar22 + iVar28)]), func_62(Global_17411.f_4433[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar42) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
															else
															{
																DRAW_SPRITE(func_65(Global_17411.f_4433[(iVar22 + iVar28)]), func_62(Global_17411.f_4433[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar42) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
														}
									...
									if (GET_HASH_KEY(&(Global_17411.f_73[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										else
										{
											...
											if (func_45() && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (iVar8 == 0)
												{
											...
											if ((Global_17411.f_4433[(iVar22 + iVar14)] != 2 && Global_17411.f_4433[(iVar22 + iVar14)] != 50) && Global_17411.f_4433[(iVar22 + iVar14)] != 60)
											{
												if (func_71(Global_17411.f_4433[(iVar22 + iVar14)], bVar32, 0, &fVar36, &fVar37, bParam7))
												{
													...
													if (iVar5 == 1)
													{
														...
														{
															func_56(Global_17411.f_4433[(iVar22 + iVar14)], bVar32, &uVar47, &uVar48, &uVar49, &uVar50);
															if (Global_17411.f_4433[(iVar22 + iVar14)] == 30)
															{
																DRAW_SPRITE(func_65(Global_17411.f_4433[(iVar22 + iVar14)]), func_62(Global_17411.f_4433[(iVar22 + iVar14)], bVar32), (Global_17408 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
															else if (Global_17411.f_5083[iVar8] == 2)
															{
																DRAW_SPRITE(func_65(Global_17411.f_4433[(iVar22 + iVar14)]), func_62(Global_17411.f_4433[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar42) + fVar43) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
															else
															{
																DRAW_SPRITE(func_65(Global_17411.f_4433[(iVar22 + iVar14)]), func_62(Global_17411.f_4433[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar42) + fVar43) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), fVar36, fVar37, 0f, uVar47, uVar48, uVar49, uVar50, 0);
															}
														}
													}
								...
								if (bVar33)
								{
									if (func_71(Global_17411.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											...
											{
												func_56(Global_17411.f_4433[iVar22], bVar32, &uVar47, &uVar48, &uVar49, &uVar50);
												DRAW_SPRITE(func_65(Global_17411.f_4433[iVar22]), func_62(Global_17411.f_4433[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), (fVar36 * func_42(Global_17411.f_4433[iVar22])), (fVar37 * func_42(Global_17411.f_4433[iVar22])), 0f, uVar47, uVar48, uVar49, uVar50, 0);
											}
										}
									}
								}
...
void func_44(float fParam0, float fParam1, char* sParam2, var uParam3, int iParam4)
{
	BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
void func_49(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_56(int iParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
...
void func_58(float fParam0, float fParam1, char* sParam2, var uParam3, var uParam4)
{
	BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	ADD_TEXT_COMPONENT_INTEGER(uParam3);
...
float func_59(char* sParam0, var uParam1, var uParam2)
{
...
int func_71(int iParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)
{
	...
	if (GET_HASH_KEY(&cVar16) != 0)
	{
		...
		vVar37.x = (vVar37.x * (func_72(iParam0) / fVar34));
		vVar37.y = (vVar37.y * (func_72(iParam0) / fVar34));
		if (!bParam2)
		{
...
int func_73(bool bParam0, bool bParam1)
{
	...
	if ((((((((!IS_SCREEN_FADED_IN() || (func_75(8, -1) && func_74() != 64)) || (GET_PAUSE_MENU_STATE() != 0 && !bParam1)) || (IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0)) || SET_STORE_ENABLED()) || Global_71850) || Global_17411.f_8352) || IS_WARNING_MESSAGE_ACTIVE()) || Global_93734.f_1409)
	{
		return 0;
	}
	return 1;
...
void func_94()
{
	...
	bVar4 = IS_CONTROL_JUST_PRESSED(2, 201);
	bVar5 = (IS_CONTROL_JUST_PRESSED(2, 202) || IS_DISABLED_CONTROL_JUST_PRESSED(2, 202));
	iVar0 = GET_CONTROL_VALUE(2, 196);
	if (!IS_BIT_SET(uLocal_199, 0))
	{
		if (_IS_INPUT_JUST_DISABLED(2))
		{
		...
		if (bVar2 || bVar3)
		{
			...
			SET_BIT(&uLocal_199, 0);
		}
	}
	else if (func_15(&uLocal_206, iVar1, 0))
	{
		func_131(&uLocal_206);
		CLEAR_BIT(&uLocal_199, 0);
	}
	if (bVar3)
	{
		iLocal_193++;
...
void func_95(int iParam0)
{
	...
	if (func_4(iLocal_194, -1))
	{
		uVar0 = GET_HASH_KEY(func_109(iParam0));
	}
	if (NETWORK_CAN_SPEND_MONEY(1, 0, 0, 1, -1, 0))
	{
		if (func_108())
		{
		...
		{
			_0x5BCDE0F640C773D2(1, uVar0, 0, 0);
		}
	}
}
...
void func_111(var uParam0, var uParam1, var uParam2, var uParam3)
{
	if (IS_PC_VERSION() && !_NETWORK_IS_TEXT_CHAT_ACTIVE())
	{
		...
		if (func_113(0, 0, 0) || IS_CONTROL_PRESSED(2, 188))
		{
			*uParam0 = 1;
		}
		if (func_112(0, 0, 0) || IS_CONTROL_PRESSED(2, 187))
		{
			*uParam1 = 1;
		}
	}
...
int func_125()
{
	...
	switch (iLocal_197)
	{
		case 0:
			func_28(0);
			vVar0 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_189, 0.06f, -0.8958f, 0.2f) };
			...
			if (!func_130(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vVar0, 0.55f, 0) || !func_129(GET_ENTITY_HEADING(PLAYER_PED_ID()), GET_ENTITY_HEADING(iLocal_189), 15f))
			{
				if (!func_126(PLAYER_PED_ID(), 2106541073))
				{
					TASK_GO_STRAIGHT_TO_COORD(PLAYER_PED_ID(), vVar0, 1f, 4000, GET_ENTITY_HEADING(iLocal_189), 0.125f);
				}
			}
			else
			{
	...
	else
	{
		...
		if (NETWORK_IS_PLAYER_ACTIVE(iParam0) && (IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_52(PLAYER_ID(), 0) && !func_137()))
				{
			...
			if (bParam1)
			{
				if (!func_136(uVar25) && !IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar25))
				{
					if (!bVar21)
					{
...
void func_147()
{
	if (IS_HELP_MESSAGE_BEING_DISPLAYED() && func_148("JBOX_NO_MONEY"))
	{
		CLEAR_HELP(1);
	}
}
...
int func_149()
{
	if (func_158() || unk_0xCCADB536D2A7894D(-1) > 0)
	{
		return 1;
	}
	return 0;
...
int func_150()
{
	if (((((((((!IS_BIT_SET(Global_2505876, 5) && !func_154()) && !func_32(0)) && !func_153()) && !IS_PED_IN_COVER(PLAYER_PED_ID(), 0)) && GET_ROOM_KEY_FROM_ENTITY(PLAYER_PED_ID()) == GET_ROOM_KEY_FROM_ENTITY(iLocal_189)) && IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_215, 0.55f, 0.8f, 1.5f, 0, 1, 1)) && !IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), sLocal_203, "EXIT", 3)) && !func_152(PLAYER_ID())) && !func_151())
	{
		return 1;
	}
	return 0;
...
void func_156()
{
	if (func_151())
	{
		if (IS_BIT_SET(Local_225[Local_221.f_1 /*2*/], 2))
		{
		...
		if (!IS_BIT_SET(Local_225[Local_221.f_1 /*2*/], 1) && !IS_BIT_SET(Local_225[Local_221.f_1 /*2*/], 0))
		{
			Local_221.f_1 = -1;
		}
	}
	else if (IS_BIT_SET(Local_225[iLocal_195 /*2*/], 0))
	{
		if (!func_151())
		{
...
void func_160(bool bParam0)
{
	if (bParam0)
	{
		SET_BIT(&uLocal_199, 6);
	}
	else
	{
		CLEAR_BIT(&uLocal_199, 6);
	}
	if (func_4(iLocal_194, -1))
	{
...
void func_162(int iParam0)
{
	if (func_4(iLocal_194, -1))
	{
		...
		{
			if (iLocal_190 == PLAYER_ID() && iLocal_200 != 0)
			{
				func_7(iLocal_191);
			}
...
void func_163(int iParam0, int iParam1)
{
	...
	if (func_3(iParam0) == 97)
	{
		SET_EMITTER_RADIO_STATION("SE_bkr_biker_dlc_int_02_REC", uVar0);
		SET_EMITTER_RADIO_STATION("SE_bkr_biker_dlc_int_02_GRG", uVar0);
		return;
	}
	else if (func_3(iParam0) == 91)
	{
		SET_EMITTER_RADIO_STATION("SE_bkr_biker_dlc_int_01_BAR", uVar0);
		SET_EMITTER_RADIO_STATION("SE_bkr_biker_dlc_int_01_GRG", uVar0);
		SET_EMITTER_RADIO_STATION("SE_bkr_biker_dlc_int_01_REC", uVar0);
		return;
	}
}
...
void func_167()
{
	...
	if (NETWORK_IS_GAME_IN_PROGRESS() && !IS_BIT_SET(uLocal_199, 2))
	{
		uVar0 = Global_1048576.f_1199;
		NETWORK_SET_SCRIPT_IS_SAFE_FOR_NETWORK_GAME();
		NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, 0, uVar0);
		func_171(0, -1, 0);
		SET_THIS_SCRIPT_CAN_BE_PAUSED(0);
		NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_221, 4);
		NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&Local_225, 65);
		if (!func_168())
		{
			func_176(0);
		}
		SET_BIT(&uLocal_199, 2);
	}
}
...
void func_174()
{
	...
	else if (IS_BIT_SET(Global_2505876, 1))
	{
		CLEAR_BIT(&Global_2505876, 1);
		func_176(0);
	}
	else if (func_175())
	{
	...
	else if (iLocal_194 != Global_1589819[PLAYER_ID() /*818*/].f_273.f_25)
	{
		func_176(0);
	}
}
...
void func_176(bool bParam0)
{
	...
	SET_BIT(&Global_2505876, 2);
	if (iLocal_196 != -1)
	{
		func_142(&iLocal_196);
	}
	if (iLocal_190 == PLAYER_ID())
	{
		func_7(iLocal_191);
	}
	if (IS_HELP_MESSAGE_BEING_DISPLAYED() && func_148("JBOX_NO_MONEY"))
...
void func_177()
{
	...
	{
		if (((IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), sLocal_203, "IDLE", 3) || IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), sLocal_203, "EXIT", 3)) || IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), sLocal_203, "INSERT_COINS", 3)) || IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), sLocal_203, "SELECT_TRACK", 3))
		{
