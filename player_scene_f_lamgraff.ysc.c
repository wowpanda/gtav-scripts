...
int func_2()//Position - 0x12E
{
	...
	if (!PED::IS_PED_INJURED(Global_16B5A))
	{
		...
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_16B5A, &sLocal_271, &cLocal_303, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_16B5A))
				{
					BRAIN::STOP_ANIM_PLAYBACK(Global_16B5A, 0, 0);
					NETWORK::_0x5E3AA4CA2B6FB0EE(Global_16B5A);
					return 0;
				}
...
int func_20()//Position - 0xAB6
{
	...
	if (!PED::IS_PED_INJURED(Global_16B5A))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_267))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_16B5A, &sLocal_271, &cLocal_287, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_16B5A))
				{
					BRAIN::STOP_ANIM_PLAYBACK(Global_16B5A, 0, 0);
				...
				else
				{
					...
					BRAIN::TASK_SYNCHRONIZED_SCENE(Global_16B5A, iLocal_312, &sLocal_271, &cLocal_303, 8f, -8f, 257, 0, 8f, 0);
					return 1;
				}
			}
			else
			{
				...
				{
					NETWORK::_0x5E3AA4CA2B6FB0EE(Global_16B5A);
					PED::_RESET_PED_RAGDOLL_BLOCKING_FLAGS(Global_16B5A, 16);
					if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_312))
					{
						iLocal_312 = PED::CREATE_SYNCHRONIZED_SCENE(vLocal_269, 0f, 0f, fLocal_270, 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_312, true);
...
int func_23(int iParam0, int iParam1)//Position - 0xD46
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_24(Global_16B5A) && iParam1 != 0)
		{
			Global_16B5A = 0;
		}
	}
...
void func_31()//Position - 0xEF6
{
	...
	while (!ENTITY::DOES_ENTITY_EXIST(Global_16B5A) || !STREAMING::HAS_MODEL_LOADED(iLocal_268))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_16B5A))
	{
		if (!PED::IS_PED_INJURED(Global_16B5A))
		{
			BRAIN::TASK_STAND_STILL(Global_16B5A, 4294967295);
		}
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_16B5A, 1862763509);
	}
	ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_16B5A, true, 1);
	PED::SET_PED_CONFIG_FLAG(Global_16B5A, 132, true);
	PED::_SET_PED_RAGDOLL_BLOCKING_FLAGS(Global_16B5A, 16);
	func_33(&Global_16B5A, Global_1590B);
	func_32(&uLocal_100, 1, AUDIO::_0x0626A247D2405330(), "FRANKLIN", 0, 1);
	iLocal_267 = OBJECT::CREATE_OBJECT(iLocal_268, unk_0x8000C77B5F336760(Global_16B5A, true), true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_267, Global_16B5A, PED::GET_PED_BONE_INDEX(Global_16B5A, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
}
	...
	switch (Param0.f_2)
	{
		...
		case 12:
			*uParam1 = { Param0 };
			...
			func_38(uParam1, 144, 3312640106, 3312640106, 0f, 0f, 0f, 0f);
			uParam1->f_76 = 2;
			return 1;
			break;
		...
		case 75:
			*uParam1 = { Param0 };
			...
			func_38(uParam1, 30, 3312640106, 3312640106, 0f, 0f, 0f, 0f);
			uParam1->f_76 = 2;
			return 1;
			break;
		...
		case 80:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_38(uParam1, 17, 2277090178, 2277090178, Vector(2.6407f, 8.164f, -14.1564f) + Vector(-1f, 0.03f, -2.16f), (-66f + -56f));
			if (Param0.f_2 == 80)
			{
				func_39(uParam1);
			}
		...
		case 99:
			*uParam1 = { Param0 };
			uParam1->f_6D = 3312640106;
			uParam1->f_6E = 3312640106;
			func_38(uParam1, 15, 3312640106, 451360105, 0f, 0f, 0f, 0f);
			uParam1->f_76 = 2;
			return 1;
			break;
		...
		case 101:
			*uParam1 = { Param0 };
			uParam1->f_6D = 3312640106;
			uParam1->f_6E = 3312640106;
			func_38(uParam1, 14, 3312640106, 451360105, 0f, 0f, 0f, 0f);
			uParam1->f_76 = 2;
			return 1;
			break;
		...
		case 167:
			*uParam1 = { Param0 };
			uParam1->f_6D = 3312640106;
			uParam1->f_6E = 1785177548;
			func_38(uParam1, 14, 3312640106, 1785177548, -0.8472f, 0.155f, 0f, 152.556f);
			uParam1->f_76 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 193:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_38(uParam1, 144, 3312640106, 1785177548, 4.2943f, -6.7858f, 0f, -133.5332f);
			uParam1->f_76 = 1;
			if (Global_3)
			{
				uParam1->f_76 = 1;
		...
		case 270:
			*uParam1 = { Param0 };
			...
			if (Param0.f_2 == 267)
			{
				func_38(uParam1, 144, 3312640106, 2106541073, -2.4166f, -0.15f, 0f, -148.7555f);
			}
			if (Param0.f_2 == 266)
			{
		...
		case 289:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_38(uParam1, 144, 2277090178, 2277090178, -3.264f, -14.7895f, 14.1815f, -0.6311f);
			uParam1->f_76 = 1;
			return 1;
			break;
		...
		case 312:
			*uParam1 = { Param0 };
			...
			func_38(uParam1, 144, 474215631, 2775823996, -9.5443f, -3.191f, -0.3f, 180f);
			uParam1->f_76 = 1;
			return 1;
			break;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[0];
			StringCopy(sParam2, func_47(Global_19E56.f_933.f_21B.f_8F6[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[1];
			StringCopy(sParam2, func_47(Global_19E56.f_933.f_21B.f_8F6[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[2];
			StringCopy(sParam2, func_47(Global_19E56.f_933.f_21B.f_8F6[2]), 32);
			return 1;
			break;
