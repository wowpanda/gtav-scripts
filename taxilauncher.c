	...
	while (true)
	{
		switch (iLocal_51)
		{
			...
			case 1:
				if (func_141())
				{
					vLocal_274 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 0) };
					func_110();
					if (func_109())
					{
						SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("taxi"), 0);
						func_108();
						if (!func_106())
						{
							func_64();
			...
			case 2:
				if (!IS_THREAD_ACTIVE(uLocal_269))
				{
					func_4(1);
					iLocal_54 = 3;
					iLocal_51 = 0;
...
void func_1()
{
	if (!func_3())
	{
		if (ARE_STRINGS_EQUAL("NULL", &Global_105621))
		{
			func_2(0);
		}
		else if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(GET_HASH_KEY(&Global_105621)) == 0)
		{
			func_2(0);
		}
	}
...
void func_5()
{
	...
	{
		if (IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "HAIL_TAXI", 3))
		{
			STOP_ENTITY_ANIM(PLAYER_PED_ID(), "HAIL_TAXI", &cLocal_270, -2f);
		}
		else if (IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "FP_HAIL_TAXI", 3))
		{
			STOP_ENTITY_ANIM(PLAYER_PED_ID(), "FP_HAIL_TAXI", &cLocal_270, -2f);
		}
		else if (IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "FUCK_U", 3))
		{
			STOP_ENTITY_ANIM(PLAYER_PED_ID(), "FUCK_U", &cLocal_270, -2f);
		}
		else if (IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "FORGET_IT", 3))
		{
			STOP_ENTITY_ANIM(PLAYER_PED_ID(), "FORGET_IT", &cLocal_270, -2f);
		}
		if (iLocal_95 != -1)
		{
			SET_PED_CONFIG_FLAG(PLAYER_PED_ID(), 113, 0);
		}
		if (iLocal_92 == 1)
		{
	...
	if (DOES_BLIP_EXIST(uLocal_93))
	{
		SET_BLIP_ROUTE(uLocal_93, 0);
	...
	if (DOES_ENTITY_EXIST(Global_105597))
	{
		...
		{
			if (IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_270, "Aknowledge_R", 3))
			{
				STOP_ENTITY_ANIM(Global_105597, "Aknowledge_R", &cLocal_270, -4f);
			}
			else if (IS_ENTITY_PLAYING_ANIM(Global_105597, &cLocal_270, "Aknowledge_L", 3))
			{
				STOP_ENTITY_ANIM(Global_105597, "Aknowledge_L", &cLocal_270, -4f);
			}
		}
	}
	if (iLocal_54 == 0)
...
void func_11()
{
	...
	if (DOES_GROUP_EXIST(func_12()))
	{
		...
		if (iVar0 > 0)
		{
			uVar2 = GET_PED_AS_GROUP_MEMBER(func_12(), 0);
			...
			if (iVar0 > 1)
			{
				uVar2 = GET_PED_AS_GROUP_MEMBER(func_12(), 1);
				if (!IS_PED_INJURED(uVar2))
				{
					CLEAR_PED_TASKS(uVar2);
					if (!IS_ENTITY_DEAD(Global_105596, 0))
...
void func_13()
{
	...
	{
		if (DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Local_56.f_1, 0))
		{
			if (Local_56.f_1 != Global_105597)
			{
				if (!IS_PED_INJURED(Local_56.f_1))
				{
					SET_PED_CONFIG_FLAG(Local_56.f_1, 251, 0);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_56.f_1, 0);
					if (!IS_PED_FLEEING(Local_56.f_1) && !IS_PED_IN_COMBAT(Local_56.f_1, 0))
					{
						if (IS_PED_IN_ANY_VEHICLE(Local_56.f_1, 0))
						{
							if (DOES_ENTITY_EXIST(Local_56))
							{
								if (IS_VEHICLE_DRIVEABLE(Local_56, 0))
								{
									if (IS_PED_SITTING_IN_VEHICLE(Local_56.f_1, Local_56))
									{
										OPEN_SEQUENCE_TASK(&uVar0);
										if ((!IS_VEHICLE_SEAT_FREE(Local_56, 1, 0) || !IS_VEHICLE_SEAT_FREE(Local_56, 2, 0)) || !IS_VEHICLE_SEAT_FREE(Local_56, 0, 0))
										{
											TASK_PAUSE(0, 2000);
										}
										else
										...
										TASK_VEHICLE_DRIVE_WANDER(0, Local_56, 12f, 790699);
										CLOSE_SEQUENCE_TASK(uVar0);
										TASK_PERFORM_SEQUENCE(Local_56.f_1, uVar0);
										CLEAR_SEQUENCE_TASK(&uVar0);
									}
									else
									{
										TASK_SMART_FLEE_PED(Local_56.f_1, PLAYER_PED_ID(), 500f, -1, 0, 0);
									}
								}
								else
								{
						...
						{
							TASK_WANDER_STANDARD(Local_56.f_1, 1193033728, 0);
						}
					}
				}
	...
	if (DOES_ENTITY_EXIST(Local_56))
	{
		if (DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Local_56, 0))
		{
	...
	if (iLocal_53 == 1)
	{
		...
		SET_MODEL_AS_NO_LONGER_NEEDED(uLocal_99);
	}
	Local_56 = 0;
	Local_56.f_1 = 0;
	Local_56.f_2 = 0;
...
void func_15()
{
	if (func_21(&Global_105596, iLocal_100, uLocal_99))
	{
		if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Global_105596, 0))
		{
			if (IS_PED_SITTING_IN_VEHICLE(PLAYER_PED_ID(), Global_105596))
			{
				func_20();
				...
				func_19(&Global_105596, iLocal_279);
				...
				if (HAS_SCRIPT_LOADED("taxiService"))
				{
					uLocal_269 = START_NEW_SCRIPT("taxiService", 1828);
					SET_SCRIPT_AS_NO_LONGER_NEEDED("taxiService");
					iLocal_51 = 2;
				}
			}
...
void func_16()
{
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		uVar0 = GET_RANDOM_PED_AT_COORD(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 1.5f, 1.5f, 1.5f, -1);
		if (!IS_PED_INJURED(uVar0))
		{
			if (IS_PED_ON_FOOT(uVar0))
			{
				TASK_SMART_FLEE_PED(uVar0, PLAYER_PED_ID(), 150f, -1, 0, 0);
			}
		}
	}
}
					...
					if (!IS_PED_INJURED(uVar0))
					{
						if (!IS_PED_FLEEING(uVar0))
						{
							if (!IS_PED_IN_COMBAT(uVar0, 0))
							{
								...
								{
									if (IS_ENTITY_UPRIGHT(*iParam0, 1119092736))
									{
...
int func_24(int iParam0)
{
	...
	if (!IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), *iParam0, 5f, 5f, 2f, 0, 1, 0))
	{
		return 0;
	}
...
void func_26()
{
	...
	if (DOES_ENTITY_EXIST(iLocal_277))
	{
		if (func_21(&iLocal_277, iLocal_100, uLocal_99))
		{
			...
			{
				if (IS_PED_SITTING_IN_VEHICLE(PLAYER_PED_ID(), iLocal_277))
				{
					uVar0 = GET_PED_IN_VEHICLE_SEAT(iLocal_277, -1, 0);
					if (!IS_VEHICLE_SEAT_FREE(iLocal_277, 1, 0))
					{
						if (GET_PED_IN_VEHICLE_SEAT(iLocal_277, 1, 0) == PLAYER_PED_ID())
						{
							iLocal_279 = 1;
						}
					}
					if (!IS_VEHICLE_SEAT_FREE(iLocal_277, 2, 0))
					{
						if (GET_PED_IN_VEHICLE_SEAT(iLocal_277, 2, 0) == PLAYER_PED_ID())
						{
							iLocal_279 = 2;
						}
					}
...
int func_27(int iParam0, var uParam1, bool bParam2)
{
	...
	if (DOES_ENTITY_EXIST(*iParam0) && DOES_ENTITY_EXIST(*uParam1))
	{
		if (IS_VEHICLE_DRIVEABLE(*iParam0, 0))
		{
			if (!IS_PED_INJURED(*uParam1))
			{
				if (IS_PED_SITTING_IN_VEHICLE(*uParam1, *iParam0))
				{
...
void func_28()
{
	...
	if (func_24(&iLocal_277))
	{
		if (!iLocal_89)
		{
			if (iLocal_277 == Global_105596 && iLocal_55 == 4)
			{
		...
		if (DOES_ENTITY_EXIST(iVar0))
		{
			if (iVar0 == iLocal_277)
			{
				uVar1 = GET_PED_IN_VEHICLE_SEAT(iLocal_277, -1, 0);
				if (iLocal_55 == 4 || iLocal_55 == 2)
				{
					if (iLocal_277 != Global_105596)
					{
				...
				if (func_27(&iLocal_277, &uVar1, 0))
				{
					...
					if (!IS_PED_INJURED(Global_105597) && IS_VEHICLE_DRIVEABLE(Global_105596, 0))
					{
						if (IS_PED_SITTING_IN_VEHICLE(Global_105597, Global_105596))
						{
							if (!func_18(Global_105597, -2118855366))
							{
								TASK_VEHICLE_TEMP_ACTION(Global_105597, Global_105596, 1, 10000);
							}
						}
					}
					iLocal_89 = 0;
...
void func_31()
{
	if (func_41(&Global_105596, &Global_105597, iLocal_100, uLocal_99))
	{
		if (!func_35())
		{
			if (!func_18(Global_105597, -2118855366))
			...
			if (DOES_BLIP_EXIST(uLocal_93))
			{
				SET_BLIP_FLASH_TIMER(uLocal_93, 10000);
			}
		}
		else
		{
...
int func_35()
{
	...
	if (func_38(Global_105596))
	{
		...
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Global_105596, PLAYER_PED_ID(), 1))
		{
			return 1;
		}
		...
		{
			if (IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), Global_105596) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), Global_105596))
			{
				return 1;
			}
	...
	{
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Global_105597, PLAYER_PED_ID(), 1))
		{
			return 1;
		}
	}
					...
					if (!IS_PED_FLEEING(*uParam1))
					{
						if (!IS_PED_IN_COMBAT(*uParam1, 0))
						{
							if (IS_PED_SITTING_IN_VEHICLE(*uParam1, *uParam0))
							{
								...
								{
									if (IS_PED_MODEL(*uParam1, uParam3))
									{
										return 1;
									}
								}
...
void func_42()
{
	if (IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "HAIL_TAXI", 3) || IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "FP_HAIL_TAXI", 3))
	{
		return;
	}
	else if (func_40(iLocal_97, 3000))
	{
		REQUEST_ANIM_DICT(&cLocal_270);
		if (HAS_ANIM_DICT_LOADED(&cLocal_270))
		{
			if (func_43())
			{
				CLEAR_PED_TASKS(PLAYER_PED_ID());
				SET_PED_CONFIG_FLAG(PLAYER_PED_ID(), 113, 1);
				...
				{
					TASK_PLAY_ANIM(PLAYER_PED_ID(), &cLocal_270, "FUCK_U", 4f, -2f, -1, 48, 0, 0, 0, 0);
				}
			}
...
int func_43()
{
	...
	if (!Global_37583 && IS_PED_RAGDOLL(PLAYER_PED_ID()))
	{
		return 0;
	}
...
void func_48()
{
	...
	if (func_41(&Global_105596, &Global_105597, iLocal_100, uLocal_99))
	{
		...
		if (func_40(iLocal_97, 1000))
		{
			...
			{
				if (((!IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "HAIL_TAXI", 3) && !IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "FP_HAIL_TAXI", 3)) && !IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "FUCK_U", 3)) && !IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "FORGET_IT", 3))
				{
			...
			if (HAS_ANIM_DICT_LOADED(&cLocal_270))
			{
				if (GET_RANDOM_INT_IN_RANGE(0, 10) < 8)
				{
					if (!func_53(0, 0))
					{
						...
						func_51(PLAYER_PED_ID(), "TAXI_HAIL", 34);
						if (bVar1)
						{
				...
				{
					TASK_PLAY_ANIM(0, &cLocal_270, "Aknowledge_R", 8f, -4f, -1, 16785456, 0, 0, 0, 0);
				}
				else
				{
					TASK_PLAY_ANIM(0, &cLocal_270, "Aknowledge_L", 8f, -4f, -1, 16785456, 0, 0, 0, 0);
				}
				TASK_VEHICLE_MISSION(0, Global_105596, Global_105596, 22, 12f, 262275, 3f, 3f, 1);
				TASK_VEHICLE_MISSION(0, Global_105596, Global_105596, 5, 12f, 262275, 3f, 3f, 1);
				CLOSE_SEQUENCE_TASK(uVar2);
				TASK_PERFORM_SEQUENCE(Global_105597, uVar2);
...
void func_49()
{
	...
	if (func_38(Global_105596))
	{
		if (!DOES_BLIP_EXIST(uLocal_93))
		{
			uLocal_93 = ADD_BLIP_FOR_ENTITY(Global_105596);
			SET_BLIP_SPRITE(uLocal_93, 198);
			SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_93, "TXM_BLIP");
			SET_BLIP_FLASHES(uLocal_93, 1);
			SET_BLIP_FLASH_TIMER(uLocal_93, 10000);
		}
	}
}
...
int func_50(var uParam0)
{
	...
	if (!IS_ENTITY_DEAD(uParam0, 0))
	{
		...
		vVar3 = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, 1f, 0f, 0f) };
		if (IS_PLAYER_PLAYING(PLAYER_ID()))
		{
		...
		vVar9 = { vVar3 - vVar0 };
		vVar12 = { vVar6 - vVar0 };
		if (GET_ANGLE_BETWEEN_2D_VECTORS(vVar9.x, vVar9.y, vVar12.x, vVar12.y) < 90f)
		{
			return 1;
		}
	}
...
{
	_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_52(iParam2), 1);
}
	...
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (DOES_GROUP_EXIST(func_12()))
		{
			...
			if (iVar1 > 0)
			{
				...
				while (iVar2 < iVar1)
				{
					uVar0 = GET_PED_AS_GROUP_MEMBER(func_12(), iVar2);
					if (!IS_PED_INJURED(uVar0))
					{
			...
			if (func_43())
			{
				...
				if (HAS_ANIM_DICT_LOADED(&cLocal_270))
				{
					if (((!IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "HAIL_TAXI", 3) && !IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "FP_HAIL_TAXI", 3)) && !IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "FUCK_U", 3)) && !IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "FORGET_IT", 3))
					{
						...
						{
							if (!IS_TAXI_LIGHT_ON(iLocal_278))
							{
								SET_TAXI_LIGHTS(iLocal_278, 1);
							}
						}
						if (iLocal_95 == -1)
						{
						...
						if (func_60(iLocal_95, 1))
						{
							...
							TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), iLocal_278, 5000, 0, 2);
							func_59();
							func_58();
							iLocal_97 = GET_GAME_TIMER();
							func_8(&iLocal_95);
							if (func_62(&iLocal_278))
							{
								if (IS_VEHICLE_DRIVEABLE(iLocal_278, 0))
								{
									SET_TAXI_LIGHTS(iLocal_278, 0);
								}
								iLocal_88 = 0;
								iLocal_55 = 3;
							}
							...
							{
								uVar0 = GET_PED_IN_VEHICLE_SEAT(iLocal_278, -1, 0);
								if (func_27(&iLocal_278, &uVar0, 0))
								{
									iLocal_278 = 0;
									TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), Global_105596, 5000, 0, 2);
									Global_105633 = GET_GAME_TIMER();
									if (IS_VEHICLE_DRIVEABLE(Global_105596, 0))
									{
										if (!IS_GAMEPLAY_HINT_ACTIVE())
										{
											SET_GAMEPLAY_VEHICLE_HINT(Global_105596, 0f, 0f, 0f, 1, 4000, 2000, 2000);
											iLocal_88 = 1;
										}
									}
									Global_106565.f_10043.f_120 = 1;
...
void func_59()
{
	...
	if (!Global_37583)
	{
		...
		GET_CURRENT_PED_WEAPON(PLAYER_PED_ID(), &iVar47, 1);
		if (IS_PED_ARMED(PLAYER_PED_ID(), 7) || (ARE_STRINGS_EQUAL(Var24.f_2, "FP_HAIL_TAXI") && iVar47 == joaat("weapon_petrolcan")))
		{
			...
			TASK_SCRIPTED_ANIMATION(0, &Var24, &Var2, &Var2, 0.25f, 0.25f);
			CLOSE_SEQUENCE_TASK(uVar0);
		...
		{
			TASK_SCRIPTED_ANIMATION(PLAYER_PED_ID(), &Var24, &Var2, &Var2, 0.25f, 0.25f);
		}
	}
	else
	{
		...
		func_51(PLAYER_PED_ID(), "TAXI_HAIL_DRUNK", 7);
		if (bVar1)
		{
			STOP_PED_SPEAKING(PLAYER_PED_ID(), 1);
		}
...
int func_62(int iParam0)
{
	...
	{
		iVar0 = GET_PED_IN_VEHICLE_SEAT(*iParam0, 2, 0);
		if (!iVar0 == PLAYER_PED_ID())
		{
			if (!IS_PED_GROUP_MEMBER(iVar0, func_12()))
			{
				...
				if (GET_SCRIPT_TASK_STATUS(PLAYER_PED_ID(), 242628503) == 7)
				{
					if (((!IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "HAIL_TAXI", 3) && !IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "FP_HAIL_TAXI", 3)) && !IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "FUCK_U", 3)) && !IS_ENTITY_PLAYING_ANIM(PLAYER_PED_ID(), &cLocal_270, "FORGET_IT", 3))
					{
						if (!Global_37583)
						{
							...
							func_51(PLAYER_PED_ID(), "TAXI_DRIVES_PAST", 24);
							if (!bVar0)
							{
								STOP_PED_SPEAKING(PLAYER_PED_ID(), 0);
							}
	...
	if (func_66())
	{
		if (iLocal_54 == 0 && iLocal_55 != 4)
		{
			...
			if (func_27(&Local_56, &(Local_56.f_1), 0))
			{
				...
				if (func_38(Global_105596))
				{
					START_VEHICLE_HORN(Global_105596, 2500, GET_HASH_KEY("NORMAL"), 0);
				}
				if (DOES_ENTITY_EXIST(Global_105597))
				{
					if (!IS_PED_INJURED(Global_105597))
					{
						TASK_LOOK_AT_ENTITY(Global_105597, PLAYER_PED_ID(), 3000, 0, 2);
						TASK_LOOK_AT_ENTITY(PLAYER_PED_ID(), Global_105597, 3000, 0, 2);
					}
				}
				func_49();
				iLocal_55 = 4;
...
int func_66()
{
	...
	vVar0 = { GET_ENTITY_COORDS(Local_56, 0) };
	if (!Local_56.f_2)
	{
		if (!Local_56.f_3)
		{
			...
			{
				if (!IS_ENTITY_DEAD(Local_56.f_1, 0))
				{
					SET_DRIVER_ABILITY(Local_56.f_1, 0.5f);
					if (Local_56.f_4)
					{
						TASK_VEHICLE_DRIVE_TO_COORD(Local_56.f_1, Local_56, Local_56.f_17, 10f, 0, GET_ENTITY_MODEL(Local_56), Local_56.f_29, 5f, GET_DISTANCE_BETWEEN_COORDS(vVar0, Local_56.f_17, 1));
						Local_56.f_4 = 0;
					}
					else
					{
						TASK_VEHICLE_PARK(Local_56.f_1, Local_56, Local_56.f_17, Local_56.f_6, 3, 90f, 1);
					}
				}
				Local_56.f_2 = 1;
			}
		...
		else
		{
			SET_DRIVER_ABILITY(Local_56.f_1, 0.5f);
			Local_56.f_17 = { vVar0 };
			TASK_VEHICLE_TEMP_ACTION(Local_56.f_1, Local_56, 6, 15000);
			Local_56.f_2 = 1;
		}
	}
	else if (!func_18(Local_56.f_1, -272084098))
	{
		if (IS_VEHICLE_STOPPED(Local_56))
		{
			TASK_VEHICLE_TEMP_ACTION(Local_56.f_1, Local_56, 1, 1000000);
			return 1;
		}
	}
	else
	{
		...
		{
			if (IS_VEHICLE_STOPPED(Local_56) || IS_VEHICLE_STOPPED_AT_TRAFFIC_LIGHTS(Local_56))
			{
				TASK_VEHICLE_TEMP_ACTION(Local_56.f_1, Local_56, 1, 1000000);
				return 1;
			}
...
int func_69(var uParam0, vector3 vParam1)
{
	...
	if (!GET_GROUND_Z_FOR_3D_COORD(*uParam0, uParam0->f_1, 1000f, &uVar0, 0, 0))
	{
		*uParam0 = { vParam1 };
		return 0;
	}
...
int func_74()
{
	...
	if (!Local_56.f_2)
	{
		...
		{
			TASK_VEHICLE_DRIVE_TO_COORD(Local_56.f_1, Local_56, Local_56.f_14, 12f, 0, GET_ENTITY_MODEL(Local_56), Local_56.f_29, (Local_56.f_7 - 20f), 20f);
			Local_56.f_2 = 1;
		}
	}
	else
	{
		vVar0 = { GET_ENTITY_COORDS(Local_56, 1) };
	...
	if (func_94(Local_56.f_23, Local_56.f_26))
	{
		if (!func_78(vParam0, uParam3, uParam4, 1))
		{
			while (!bVar8 && *uParam5 < iVar6)
			{
				...
				if (GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(vParam0, *uParam5, uParam3, uParam4, &uVar4, iVar9, fVar0, fVar1))
				{
					uVar5 = GET_NTH_CLOSEST_VEHICLE_NODE_ID(*uParam3, 1, iVar9, 1077936128, 0);
					if (IS_VEHICLE_NODE_ID_VALID(uVar5))
					{
						...
						if (func_77(vParam0, *uParam3) || fVar2 < 0.5f)
						{
							...
							if (!IS_POINT_OBSCURED_BY_A_MISSION_ENTITY(*uParam3, 3f, 3f, 3f, iVar3))
							{
								bVar8 = true;
							}
						}
...
void func_83()
{
	...
	{
		if (func_87(Global_106565.f_2357.f_539.f_4321) != GET_ENTITY_MODEL(PLAYER_PED_ID()))
		{
...
void func_97()
{
	...
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		if (func_40(Local_56.f_9, 10000))
		{
			...
			REQUEST_MODEL(uLocal_99);
			if (HAS_MODEL_LOADED(iLocal_100))
			{
				if (HAS_MODEL_LOADED(uLocal_99))
				{
					if (func_72(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0)))
					{
						if (Local_56.f_10 < 2)
						{
							iVar4 = 0;
					...
					{
						CLEAR_AREA(vVar0, 5f, 1, 0, 0, 0);
						if (func_98(&Local_56, &(Local_56.f_1), vVar0, uVar3))
						{
							Local_56.f_5 = func_76(GET_ENTITY_COORDS(Local_56, 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1));
							Local_56.f_2 = 0;
							Local_56.f_8 = 0;
							iLocal_53 = 2;
						}
...
int func_98(var uParam0, var uParam1, vector3 vParam2, var uParam5)
{
	...
	if (HAS_MODEL_LOADED(func_143()))
	{
		...
		{
			*uParam0 = CREATE_VEHICLE(func_143(), vParam2, uParam5, 1, 1, 0);
			if (DOES_ENTITY_EXIST(*uParam0))
			{
				if (IS_VEHICLE_DRIVEABLE(*uParam0, 0))
				{
					SET_VEHICLE_ON_GROUND_PROPERLY(*uParam0, 1084227584);
					SET_TAXI_LIGHTS(*uParam0, 1);
					...
					*uParam1 = CREATE_PED_INSIDE_VEHICLE(*uParam0, 25, func_144(), -1, 1, 1);
					if (DOES_ENTITY_EXIST(*uParam1))
					{
						if (!IS_PED_INJURED(*uParam1))
						{
							...
							{
								SET_ENTITY_AS_MISSION_ENTITY(*uParam1, 1, 0);
							}
							...
							SET_PED_CONFIG_FLAG(*uParam1, 251, 1);
							SET_PED_COMBAT_ATTRIBUTES(*uParam1, 5, 0);
							SET_PED_COMBAT_ATTRIBUTES(*uParam1, 17, 1);
							SET_PED_FLEE_ATTRIBUTES(*uParam1, 512, 0);
							SET_AMBIENT_VOICE_NAME(*uParam1, "A_M_M_EASTSA_02_LATINO_FULL_01");
							SET_MODEL_AS_NO_LONGER_NEEDED(func_143());
							SET_MODEL_AS_NO_LONGER_NEEDED(func_144());
							return 1;
						}
					}
				}
...
int func_99(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4)
{
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		vVar26 = { GET_ENTITY_COORDS(PLAYER_PED_ID(), 1) };
		...
		else if (GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(vVar26, *uParam2, &vVar0, &fVar9, &uVar10, iParam3, fVar14, fVar15))
		{
			while (!bVar12 && iVar13 < 5)
			{
				if (_0xA4822F1CF23F4810(&vVar0, &vVar3, &vVar6, 0f, 180f, iParam4, iVar11, 1, 0))
				{
...
int func_104(vector3 vParam0)
{
	...
	{
		if (IS_POINT_IN_ANGLED_AREA(vParam0, -1538.981f, -941.1323f, 10.56623f, -1715.57f, -1139.766f, 52.20361f, 110f, 0, 1))
		{
			return 1;
		}
		if (IS_POINT_IN_ANGLED_AREA(vParam0, -1739.989f, -1115.973f, 10.08726f, -1800.515f, -1187.18f, 52.0172f, 25f, 0, 1))
		{
			return 1;
		}
		if (IS_POINT_IN_ANGLED_AREA(vParam0, -1801.766f, -1180.252f, 4.017236f, -1857.718f, -1244.628f, 38.49653f, 85f, 0, 1))
		{
			return 1;
		}
	}
	if (IS_POINT_IN_ANGLED_AREA(vParam0, -1140.89f, -1573.135f, -6.566939f, -1067.084f, -1675.976f, 23.53153f, 52f, 0, 1))
	{
		return 2;
	}
	if (func_90(3, vParam0))
	...
	if (IS_POINT_IN_ANGLED_AREA(vParam0, 1324.172f, 1110.748f, 99.65493f, 1523.097f, 1110.473f, 132.8859f, 170f, 0, 1))
	{
		return 4;
	}
	if (IS_POINT_IN_ANGLED_AREA(vParam0, -1171.709f, -1524.66f, 23.37969f, -1139.721f, -1573.589f, -1.585432f, 55f, 0, 1))
...
int func_105()
{
	...
	if (func_86(PLAYER_PED_ID()) != Local_56.f_30)
	{
		return 1;
	}
	if (iLocal_55 == 4)
	...
	if (iLocal_53 == 2 || iLocal_53 == 3)
	{
		...
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56, PLAYER_PED_ID(), 1))
		{
			return 1;
		}
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_56.f_1, PLAYER_PED_ID(), 1))
		{
			return 1;
		}
		vVar0 = { GET_ENTITY_COORDS(Local_56, 0) };
		...
		if (func_37(vLocal_274, vVar0, 20f))
		{
			if (IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), Local_56) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), Local_56))
			{
				return 1;
			}
			if (IS_PED_SHOOTING(PLAYER_PED_ID()))
...
int func_106()
{
	...
	if (iLocal_54 == 0)
	{
		if (func_40(iLocal_96, 500))
		{
			...
			iVar3 = GET_PED_NEARBY_VEHICLES(PLAYER_PED_ID(), &uVar19);
			if (iVar3 > 0)
			{
				iVar4 = 0;
				while (iVar4 <= (iVar3 - 1))
				{
					if (iVar5 < iVar0)
					{
						if (DOES_ENTITY_EXIST(uVar19[iVar4]))
						{
							if (GET_ENTITY_MODEL(uVar19[iVar4]) == iLocal_100)
							{
								vVar9 = { GET_ENTITY_COORDS(uVar19[iVar4], 0) };
								...
								if (fVar12 <= (fVar8 * fVar8))
								{
									if (func_21(&(uVar19[iVar4]), iLocal_100, uLocal_99))
									{
										...
										if (iLocal_90)
										{
											if (uVar19[iVar4] != Global_105596)
											{
												if (GET_INTERIOR_FROM_ENTITY(uVar19[iVar4]) == GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()))
												{
													fVar6 = 1f;
													...
													if (fVar12 < 4f)
													{
														vVar13 = { GET_ENTITY_FORWARD_VECTOR(PLAYER_PED_ID()) };
														...
														if (((vVar13.x * vVar16.x) + (vVar13.y * vVar16.y)) / VDIST(vVar16, 0f, 0f, 0f)) > COS(120f)
														{
															...
															if (!IS_ENTITY_UPRIGHT(uVar19[iVar4], 1119092736) || IS_ENTITY_IN_WATER(uVar19[iVar4]))
															{
																fVar6 = 0f;
															}
															if (fVar6 > fVar7)
...
void func_107(int iParam0, int iParam1)
{
	...
	if (DOES_ENTITY_EXIST(*iParam0))
	{
		if (IS_VEHICLE_DRIVEABLE(*iParam0, 0))
		{
			...
			if (DOES_ENTITY_EXIST(uVar0))
			{
				if (IS_PED_MODEL(uVar0, func_144()))
				{
					if (!IS_PED_INJURED(uVar0))
					{
						SET_PED_CONFIG_FLAG(uVar0, 251, iParam1);
					}
				}
			}
		}
...
void func_110()
{
	if (iLocal_52 == 0)
	{
		if (func_140(131))
		{
			...
			{
				func_138();
				func_137(&uLocal_101, 0, PLAYER_PED_ID(), sLocal_266, 0, 1);
	...
	else if (iLocal_52 == 2)
	{
		if (func_115())
		{
			...
			if (iLocal_52 != 0)
			{
				...
				Local_56.f_30 = func_86(PLAYER_PED_ID());
				Local_56.f_8 = 0;
				Local_56.f_10 = 0;
				iLocal_53 = 1;
				iLocal_52 = 0;
...
int func_131()
{
	...
	if (!GET_CLOSEST_VEHICLE_NODE(vLocal_274, &vVar0, iVar4, 100f, 2.5f))
	{
		return 0;
	}
	if (!IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vVar0, fVar3, fVar3, 20f, 0, 1, 0))
	{
		return 0;
	}
...
int func_135(vector3 vParam0, int iParam3)
{
	if (iParam3 != -1)
	{
		...
		{
			return func_135(vParam0, Global_36426[iParam3 /*5*/].f_4);
		}
	}
	return 0;
}
