...
void func_1()
{
	if (!IS_BIT_SET(Local_2575.f_659, 0))
	{
		func_13();
		SET_BIT(&(Local_2575.f_659), 0);
	}
	func_2();
}
...
void func_2()
{
	...
	while (iVar0 < 32)
	{
		...
		if (NETWORK_IS_PLAYER_A_PARTICIPANT(iVar4))
		{
			if (func_12(iVar4, 1, 1))
			{
				...
				{
					SET_BIT(&(uVar1[func_11(Local_3235[iVar0 /*11*/])]), func_10(Local_3235[iVar0 /*11*/]));
					func_3(iVar0);
				}
			}
		}
	...
	while (iVar0 < 54)
	{
		if (!IS_BIT_SET(uVar1[func_11(iVar0)], func_10(iVar0)))
		{
...
void func_3(int iParam0)
{
	...
	{
		if (!IS_BIT_SET(Local_2575.f_653[func_11(iVar0)], func_10(iVar0)))
		{
			if (IS_BIT_SET(Local_3235[iParam0 /*11*/].f_10, 0) && !IS_BIT_SET(Local_3235[iParam0 /*11*/].f_10, 2))
			{
				SET_BIT(&(Local_2575.f_653[func_11(iVar0)]), func_10(iVar0));
				func_9(&(Local_2575.f_489[iVar0 /*2*/]), 0, 0);
			}
		}
		else
		{
			if (IS_BIT_SET(Local_3235[iParam0 /*11*/].f_10, 1))
			{
				iVar1 = 0;
				while (iVar1 < 3)
				{
					...
					SET_BIT(&(Local_2575.f_656[func_11(iVar0)]), func_10(iVar0));
					iVar1++;
				}
			}
			if (IS_BIT_SET(Local_3235[iParam0 /*11*/].f_10, 1) && (IS_BIT_SET(Local_3235[iParam0 /*11*/].f_10, 2) || func_5(&(Local_2575.f_489[iVar0 /*2*/]), func_7(iVar0) + 10000, 0)))
			{
				CLEAR_BIT(&(Local_2575.f_653[func_11(iVar0)]), func_10(iVar0));
				CLEAR_BIT(&(Local_2575.f_656[func_11(iVar0)]), func_10(iVar0));
...
void func_15()
{
	...
	{
		case 0:
			if (IS_BIT_SET(uLocal_1472, 18))
			{
				REMOVE_ANIM_DICT(func_310());
				CLEAR_BIT(&uLocal_1472, 18);
			}
			if (func_293())
			{
				iLocal_1474 = 0;
				CLEAR_BIT(&uLocal_1472, 21);
				CLEAR_BIT(&uLocal_1472, 22);
				CLEAR_BIT(&uLocal_1472, 30);
				CLEAR_BIT(&uLocal_1472, 31);
				CLEAR_BIT(&uLocal_1472, 21);
				CLEAR_BIT(&uLocal_1472, 22);
				func_292(1);
			}
		...
		case 1:
			...
			Local_1938 = REQUEST_SCALEFORM_MOVIE("SLOT_MACHINE");
			break;
		...
		case 4:
			...
			SET_BIT(&(Global_2424047[PLAYER_ID() /*416*/].f_309.f_4), 7);
			if (func_274())
			{
				func_267(0);
				func_292(5);
		...
		case 6:
			...
			func_282(0);
			HIDE_SCRIPTED_HUD_COMPONENT_THIS_FRAME(19);
			if (IS_BIT_SET(Global_2424047[PLAYER_ID() /*416*/].f_309.f_4, 7))
			{
				CLEAR_BIT(&(Global_2424047[PLAYER_ID() /*416*/].f_309.f_4), 7);
				func_31();
			}
			if (IS_AUDIO_SCENE_ACTIVE("dlc_vw_casino_slot_machines_playing"))
			{
			...
			vVar0 = { GET_CONTROL_NORMAL(2, 218), GET_CONTROL_NORMAL(2, 219), 0f };
			vVar3 = { GET_CONTROL_NORMAL(2, 220), GET_CONTROL_NORMAL(2, 221), 0f };
			if ((func_30() > 0.99f || func_30() < 0f) || ((VMAG(vVar0) >= 0.24f || VMAG(vVar3) >= 0.24f) && HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), 2115798116)))
			{
				...
				if (IS_BIT_SET(uLocal_1472, 2))
				{
					func_16(0);
					CLEAR_BIT(&uLocal_1472, 2);
				}
			}
			break;
	}
	...
	else
	{
		...
		if (NETWORK_IS_PLAYER_ACTIVE(iParam0) && (IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar19)
			{
				...
				else if (bVar13 || (!func_23(PLAYER_ID(), 0) && !func_22()))
				{
			...
			if (bParam1)
			{
				if (!func_21(uVar25) && !IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar25))
				{
					if (!bVar21)
					{
...
void func_29()
{
	...
	if (HAS_SCALEFORM_MOVIE_LOADED(Local_1938))
	{
		SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&Local_1938);
	}
	Local_1938.f_1 = -1;
	if (iLocal_1960 >= 0)
	{
...
float func_30()
{
	...
	uVar0 = _NETWORK_CONVERT_SYNCHRONISED_SCENE_TO_SYNCHRONIZED_SCENE(uLocal_1475);
	if (IS_SYNCHRONIZED_SCENE_RUNNING(uVar0))
	{
		return GET_SYNCHRONIZED_SCENE_PHASE(uVar0);
	}
	return -1f;
}
...
void func_32()
{
	func_33(1599929969, GET_CLOUD_TIME_AS_INT());
}
...
void func_34()
{
	func_33(575353331, GET_CLOUD_TIME_AS_INT());
}
...
void func_42()
{
	...
	func_221();
	func_220();
	if ((((((func_219() || func_218()) || SET_STORE_ENABLED()) || _0x2F057596F2BD0061()) || IS_PLAYER_SWITCH_IN_PROGRESS()) || func_217(1)) || IS_WARNING_MESSAGE_ACTIVE())
	{
		bVar0 = false;
	}
	if (IS_BIT_SET(Local_2575.f_653[func_11(iLocal_1959)], func_10(iLocal_1959)) && !IS_BIT_SET(Local_3235[PLAYER_ID() /*11*/].f_10, 2))
	{
		if (!func_216())
		{
			func_215(1);
			SET_BIT(&uLocal_1472, 13);
		}
	}
	else if (IS_BIT_SET(uLocal_1472, 13))
	{
		if (func_216())
		{
			func_215(0);
		}
		CLEAR_BIT(&uLocal_1472, 13);
	}
	if (bVar0)
	{
		if (IS_CONTROL_JUST_RELEASED(0, 0) || IS_DISABLED_CONTROL_JUST_RELEASED(0, 0))
		{
			...
			CLEAR_BIT(&uLocal_1472, 0);
		}
		if (IS_BIT_SET(uLocal_1472, 21) || IS_BIT_SET(uLocal_1472, 22))
		{
			...
			{
				if (IS_BIT_SET(uLocal_1472, 21))
				{
					SET_BIT(&uLocal_1472, 22);
					CLEAR_BIT(&uLocal_1472, 21);
				}
				else if (IS_BIT_SET(uLocal_1472, 22))
				{
					SET_BIT(&uLocal_1472, 21);
					CLEAR_BIT(&uLocal_1472, 22);
				}
				CLEAR_BIT(&uLocal_1472, 0);
			}
	...
	if (IS_BIT_SET(uLocal_1473, 2))
	{
		if ((((iLocal_1476 == 4 || iLocal_1476 == 10) || iLocal_1476 == 11) || iLocal_1476 == 12) || HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), -278874898))
		{
			CLEAR_BIT(&uLocal_1472, 0);
			CLEAR_BIT(&uLocal_1473, 2);
		}
	}
	...
	if (!iLocal_1935)
	{
		uLocal_1937 = GET_NETWORK_TIME();
		iLocal_1935 = 1;
	}
	if (!iLocal_1934)
	{
		uLocal_1936 = GET_NETWORK_TIME();
		iLocal_1934 = 1;
	}
	if (!IS_BIT_SET(uLocal_1472, 3))
	{
		...
		if ((((bVar0 && (!IS_BIT_SET(Local_2575.f_653[func_11(iLocal_1959)], func_10(iLocal_1959)) || IS_BIT_SET(Local_3235[PLAYER_ID() /*11*/].f_10, 2))) && !IS_BIT_SET(Local_3235[PLAYER_ID() /*11*/].f_10, 0)) && IS_BIT_SET(uLocal_1472, 0)) && !(IS_BIT_SET(uLocal_1472, 21) || IS_BIT_SET(uLocal_1472, 22)))
		{
			if (IS_CONTROL_JUST_PRESSED(2, 201) || IS_CONTROL_JUST_PRESSED(2, 208))
			{
				...
				else if (func_185() >= (Local_47[iLocal_1959 /*21*/].f_16 * iLocal_1962))
				{
					if ((((iLocal_1476 == 4 || iLocal_1476 == 10) || iLocal_1476 == 11) || iLocal_1476 == 12) || HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), -278874898))
					{
						SET_BIT(&uLocal_1472, 30);
						CLEAR_BIT(&uLocal_1472, 5);
						...
						func_182();
						CLEAR_BIT(&(Local_3235[PLAYER_ID() /*11*/].f_10), 1);
						CLEAR_BIT(&(Local_3235[PLAYER_ID() /*11*/].f_10), 2);
						CLEAR_BIT(&(Local_3235[PLAYER_ID() /*11*/].f_10), 0);
						CLEAR_BIT(&uLocal_1472, 24);
						SET_BIT(&uLocal_1472, 3);
						CLEAR_BIT(&uLocal_1472, 0);
					}
				}
			...
			if (!IS_BIT_SET(uLocal_1472, 3))
			{
				if ((((iLocal_1476 == 4 || iLocal_1476 == 10) || iLocal_1476 == 11) || iLocal_1476 == 12) || HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), -278874898))
				{
					if (IS_CONTROL_JUST_PRESSED(2, 203) && !IS_BIT_SET(uLocal_1472, 27))
					{
						SET_BIT(&uLocal_1472, 30);
						func_174(1, -1, -1, -1);
						iLocal_1962++;
						...
						if ((iLocal_1476 == 4 || iLocal_1476 == 10) || HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), -278874898))
						{
							func_172(0);
						}
						func_170(PLAYER_ID(), Local_47[iLocal_1959 /*21*/].f_17, 5);
						func_174(1, -1, -1, -1);
						CLEAR_BIT(&uLocal_1472, 0);
					}
					else if (!IS_CONTROL_JUST_PRESSED(2, 203))
					{
						CLEAR_BIT(&uLocal_1472, 27);
					}
					if (IS_CONTROL_JUST_RELEASED(2, 204) && !IS_BIT_SET(uLocal_1472, 28))
					{
						SET_BIT(&uLocal_1472, 30);
						func_174(1, -1, -1, -1);
						iLocal_1962 = 5;
						...
						{
							iLocal_1962 = FLOOR(TO_FLOAT((iVar8 / Local_47[iLocal_1959 /*21*/].f_16)));
						}
						if ((iLocal_1476 == 4 || iLocal_1476 == 10) || HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), -278874898))
						{
							func_172(1);
						}
						func_170(PLAYER_ID(), Local_47[iLocal_1959 /*21*/].f_17, 6);
						func_173((Local_47[iLocal_1959 /*21*/].f_16 * iLocal_1962));
						CLEAR_BIT(&uLocal_1472, 0);
					}
					else if (!IS_CONTROL_JUST_PRESSED(2, 204))
					{
						CLEAR_BIT(&uLocal_1472, 28);
					}
				}
				if (iLocal_1476 == 4 || iLocal_1476 == 10)
				{
	...
	else if (!IS_BIT_SET(uLocal_1472, 5))
	{
		if (((iLocal_1476 == 8 || iLocal_1476 == 14) || iLocal_1476 == 9) || iLocal_1476 == 15)
		{
			if (func_30() > 0.99f || HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), 2044168827))
			{
				if (IS_BIT_SET(uLocal_1472, 0))
				{
					CLEAR_BIT(&uLocal_1472, 0);
				}
				SET_BIT(&uLocal_1472, 5);
				SET_BIT(&(Local_3235[PLAYER_ID() /*11*/].f_10), 0);
			}
		}
		else
		{
	...
	else if (!IS_BIT_SET(uLocal_1472, 24))
	{
		if (IS_BIT_SET(Local_2575.f_653[func_11(iLocal_1959)], func_10(iLocal_1959)))
		{
			func_14(iLocal_1959, &uLocal_1925, &Local_1182, &Local_47);
			SET_BIT(&uLocal_1472, 24);
		}
	}
	else
	{
		if (!IS_BIT_SET(Local_3235[PLAYER_ID() /*11*/].f_10, 1))
		{
			...
			if (Local_47[iLocal_1959 /*21*/] > 0)
			{
				if (func_118(Local_47[iLocal_1959 /*21*/], &iLocal_2574, 0))
				{
					...
					while (iVar7 < 3)
					{
						Local_3235[PLAYER_ID() /*11*/].f_5[iVar7] = uLocal_1925.f_4[iVar7];
						Local_3235[PLAYER_ID() /*11*/].f_1[iVar7] = uLocal_1925[iVar7];
						iVar7++;
					}
					Local_3235[PLAYER_ID() /*11*/].f_9 = uLocal_1925.f_8;
					func_55();
					SET_BIT(&(Local_3235[PLAYER_ID() /*11*/].f_10), 1);
					iLocal_2574 = 0;
				}
			}
			else
		...
		if (!IS_BIT_SET(Local_2575.f_653[func_11(iLocal_1959)], func_10(iLocal_1959)) || IS_BIT_SET(Local_3235[PLAYER_ID() /*11*/].f_10, 2))
		{
			if (Local_47[iLocal_1959 /*21*/] > 0)
			{
				if (IS_BIT_SET(uLocal_1472, 16))
				{
					func_164(22);
				}
				else if (IS_BIT_SET(uLocal_1472, 14))
				{
					if (IS_BIT_SET(uLocal_1472, 29))
					{
						func_170(PLAYER_ID(), Local_47[iLocal_1959 /*21*/].f_17, 4);
					}
					else
					{
						func_170(PLAYER_ID(), Local_47[iLocal_1959 /*21*/].f_17, 3);
					}
					func_164(19);
				}
				else
				{
					func_170(PLAYER_ID(), Local_47[iLocal_1959 /*21*/].f_17, 2);
					func_164(18);
				}
			...
			else
			{
				...
				func_170(PLAYER_ID(), Local_47[iLocal_1959 /*21*/].f_17, 1);
...
{
	BEGIN_SCALEFORM_MOVIE_METHOD(Local_1938, "SET_LAST_WIN");
...
void func_44(int iParam0, int iParam1)
{
	...
	{
		case 1:
			SET_BIT(&(Global_1589819[PLAYER_ID() /*818*/].f_782), 4);
			break;
		
		case 2:
			SET_BIT(&(Global_1589819[PLAYER_ID() /*818*/].f_782), 5);
			break;
		
		case 3:
			SET_BIT(&(Global_1589819[PLAYER_ID() /*818*/].f_782), 6);
			break;
		
		case 4:
			SET_BIT(&(Global_1589819[PLAYER_ID() /*818*/].f_782), 7);
			break;
		
		case 5:
			if (iParam1 >= 1000000)
			{
				SET_BIT(&(Global_1589819[PLAYER_ID() /*818*/].f_782), 3);
			}
			else
			{
				SET_BIT(&(Global_1589819[PLAYER_ID() /*818*/].f_782), 10);
			}
			break;
		
		case 6:
			SET_BIT(&(Global_1589819[PLAYER_ID() /*818*/].f_782), 8);
			break;
		
		case 7:
			SET_BIT(&(Global_1589819[PLAYER_ID() /*818*/].f_782), 2);
			break;
		
		case 8:
			SET_BIT(&(Global_1589819[PLAYER_ID() /*818*/].f_782), 9);
			break;
	}
}
...
{
	BEGIN_SCALEFORM_MOVIE_METHOD(Local_1938, "SET_MESSAGE");
	func_48(uParam0);
	END_SCALEFORM_MOVIE_METHOD();
}
...
struct<6> func_49(int iParam0, bool bParam1)
{
	...
	iVar6 = GET_RANDOM_INT_IN_RANGE(1, 17);
	if (bParam1)
	{
...
void func_52()
{
	func_33(2026157635, GET_CLOUD_TIME_AS_INT());
}
...
void func_55()
{
	...
	if (Global_262145.f_25799)
	{
		...
		Var0.f_7 = func_185();
		Var0.f_10 = (IS_BIT_SET(uLocal_1472, 20) || IS_BIT_SET(uLocal_1473, 1));
		Var0.f_11 = func_63(PLAYER_ID());
		...
		Var0.f_17 = ABSI(GET_TIME_DIFFERENCE(uLocal_1936, GET_NETWORK_TIME()));
		Var0.f_18 = NETWORK_IS_HOST_OF_THIS_SCRIPT();
		Var0.f_19 = unk_0xDB663CC9FF3407A9(NETWORK_GET_PLAYER_INDEX(NETWORK_GET_HOST_OF_THIS_SCRIPT()));
...
int func_64(int iParam0)
{
	...
	if (Local_47[iLocal_1959 /*21*/].f_17 == 8)
	{
		if (iParam0 == 12)
		{
			GIVE_WEAPON_TO_PED(PLAYER_PED_ID(), joaat("weapon_grenade"), 25, 0, 0);
		}
		else
		{
			func_117(iParam0, &uVar0, &uVar1);
			_0x2472622CE1F2D45F(PLAYER_PED_ID(), uVar0, uVar1);
		}
	}
	else if (Local_47[iLocal_1959 /*21*/].f_17 == 4)
	{
		...
		if (iVar183 > 0)
		{
			iVar185 = GET_RANDOM_INT_IN_RANGE(0, iVar183);
...
int func_66(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	if (func_109(PLAYER_ID()) || func_108(PLAYER_ID()))
	{
	...
	else if (func_105() || func_101(PLAYER_ID()))
	{
	...
	if (func_99())
	{
		...
		if (bParam7)
		{
			...
			if (iParam1 == 0)
			{
				func_75((func_85(PLAYER_ID()) + iVar1), iParam9, 0);
				if (iParam8 == 0)
				{
				}
				if (iParam9 == 0)
		...
		if (bParam7)
		{
			if (iParam6 == -1)
			{
				func_67((func_68(PLAYER_ID()) + iVar1));
			}
			else
			{
				func_67((func_68(PLAYER_ID()) + iParam6));
			}
		}
		if (bParam7)
		{
...
void func_75(int iParam0, int iParam1, int iParam2)
{
	if (func_99())
	{
		...
		if (func_83(PLAYER_ID()))
		{
			...
			Global_1589819[PLAYER_ID() /*818*/].f_211.f_6 = func_81(iParam0, 1);
		}
...
void func_89(int iParam0)
{
	...
	while (iVar0 < _NETWORK_GET_NUM_PARTICIPANTS_HOST())
	{
		...
		if (NETWORK_IS_PARTICIPANT_ACTIVE(uVar4))
		{
			...
			{
				if (GET_PLAYER_TEAM(iVar5) == iVar1 || func_92(GET_PLAYER_TEAM(iVar5), iVar1, 0))
				{
					iVar2++;
					if (iVar5 != PLAYER_ID())
					{
						if (func_91(PLAYER_ID(), iVar5))
						{
							bVar3 = true;
						}
					}
	...
	if (bVar3)
	{
		iVar6 = ROUND((func_90(*iParam0, 100) * (10f * Global_262145.f_4217)));
	}
	if (iVar2 > 4)
	{
		iVar2 = 4;
	...
	if (iVar2 >= 2)
	{
		iVar7 = ROUND((func_90(*iParam0, 100) * (20f * Global_262145.f_4210)));
	}
...
void func_93(bool bParam0, int iParam1)
{
	...
	else
	{
		...
		while (iVar0 < 32)
		{
			...
			if (func_12(iVar4, 1, 1))
			{
				if (iVar4 != PLAYER_ID())
				{
					if (func_94(PLAYER_ID(), iVar4) <= 20f)
					{
						iVar1++;
						if (func_91(PLAYER_ID(), iVar4))
						{
	...
	if (bVar2)
	{
		iVar5 = ROUND((func_90(*iParam1, 100) * (10f * Global_262145.f_4217)));
	}
	if (iVar1 > 4)
	{
		iVar1 = 4;
	...
	if (iVar1 >= 1)
	{
		iVar6 = ROUND((func_90(*iParam1, 100) * (20f * Global_262145.f_4210)));
	}
...
{
	return VDIST(func_95(uParam0), func_95(iParam1));
	return 0f;
}
...
int func_96(int iParam0)
{
	...
	iVar0 = ROUND((func_90(*iParam0, 100) * 25f));
...
int func_97(int iParam0)
{
	if (iParam0 < 0)
	{
		if (ABSI(iParam0) > func_85(PLAYER_ID()))
		{
			iParam0 = -func_85(PLAYER_ID());
		}
	}
	if (func_98(8000, 0, 0) > 0)
	{
		if (func_98(8000, 0, 0) < (iParam0 + func_85(PLAYER_ID())))
		{
			iParam0 = (func_98(8000, 0, 0) - func_85(PLAYER_ID()));
		}
	}
	return iParam0;
}
...
void func_127()
{
	func_33(67083818, GET_CLOUD_TIME_AS_INT());
}
	...
	if (func_152())
	{
		...
		else if (*uParam0 == 1)
		{
			if (func_141(func_151()))
			{
				...
				{
					unk_0x7D3EC9370CE8AE07(func_139(func_151()));
					if (func_155(iParam1))
					{
...
int func_142()
{
	...
	if (!bVar0)
	{
		if (!unk_0xE46667979780116E(func_25()) || unk_0x64BE694244417BDA())
		{
...
int func_158(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	CLEAR_BIT(&uLocal_1472, 14);
	CLEAR_BIT(&uLocal_1472, 15);
	CLEAR_BIT(&uLocal_1472, 16);
	CLEAR_BIT(&uLocal_1472, 29);
	CLEAR_BIT(&uLocal_1473, 0);
	if (iParam1 == iParam2 && iParam2 == iParam3)
	{
		...
		if (iParam1 >= 5)
		{
			SET_BIT(&uLocal_1472, 14);
			if (iParam1 == 6)
			{
				SET_BIT(&uLocal_1472, 29);
			}
		}
		else if (iParam1 >= 2)
		{
			SET_BIT(&uLocal_1473, 0);
		}
		return iVar1;
	}
	else
...
void func_164(int iParam0)
{
	...
	uLocal_1475 = NETWORK_CREATE_SYNCHRONISED_SCENE(vLocal_1477, vLocal_1480, 2, Local_1940.f_17, Local_1940.f_16, 1065353216, 0, 1065353216);
	if (iParam0 == 5 || iParam0 == 6)
	{
		NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_1475, func_310(), &Local_1940, 4f, -8f, 13, 16, 1148846080, 0);
	}
	else if (iParam0 == 11 || iParam0 == 12)
	{
		NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_1475, func_310(), &Local_1940, 8f, -8f, 13, 16, 1148846080, 0);
	}
	else if (iParam0 == 8 || iParam0 == 14)
	{
		NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_1475, func_310(), &Local_1940, 8f, -4f, 13, 16, 1148846080, 0);
	}
	else if (((iParam0 == 0 || iParam0 == 1) || iParam0 == 2) || iParam0 == 3)
	{
		NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_1475, func_310(), &Local_1940, 2f, -1.5f, 13, 16, 2f, 0);
	}
	else
	{
		NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER_PED_ID(), uLocal_1475, func_310(), &Local_1940, 2f, -1.5f, 13, 16, 1148846080, 0);
		if (iParam0 == 15 || iParam0 == 9)
		{
			StringCopy(&cVar0, "vw_prop_casino_slot_0", 24);
			StringIntConCat(&cVar0, Local_47[iLocal_1959 /*21*/].f_17, 24);
			StringConCat(&cVar0, "a", 24);
			uVar6 = GET_HASH_KEY(&cVar0);
	...
	NETWORK_START_SYNCHRONISED_SCENE(uLocal_1475);
	iLocal_1476 = iParam0;
}
...
void func_170(var uParam0, int iParam1, int iParam2)
{
	...
	{
		case 1:
			PLAY_SOUND_FROM_ENTITY(-1, "no_win", GET_PLAYER_PED(uParam0), uVar0, 1, 20);
			break;
		
		case 2:
			PLAY_SOUND_FROM_ENTITY(-1, "small_win", GET_PLAYER_PED(uParam0), uVar0, 1, 20);
			break;
		
		case 3:
			PLAY_SOUND_FROM_ENTITY(-1, "big_win", GET_PLAYER_PED(uParam0), uVar0, 1, 20);
			break;
		
		case 4:
			PLAY_SOUND_FROM_ENTITY(-1, "jackpot", GET_PLAYER_PED(uParam0), uVar0, 1, 20);
			break;
		
		case 5:
			PLAY_SOUND_FROM_ENTITY(-1, "place_bet", GET_PLAYER_PED(uParam0), uVar0, 1, 20);
			break;
		
		case 6:
			PLAY_SOUND_FROM_ENTITY(-1, "place_max_bet", GET_PLAYER_PED(uParam0), uVar0, 1, 20);
			break;
		
		case 7:
			PLAY_SOUND_FROM_ENTITY(-1, "spinning", GET_PLAYER_PED(uParam0), uVar0, 1, 20);
			break;
		
		case 8:
			PLAY_SOUND_FROM_ENTITY(-1, "start_spin", GET_PLAYER_PED(uParam0), uVar0, 1, 20);
			break;
		
		case 9:
			PLAY_SOUND_FROM_ENTITY(-1, "wheel_stop_clunk", GET_PLAYER_PED(uParam0), uVar0, 1, 20);
			break;
		
		case 10:
			PLAY_SOUND_FROM_ENTITY(-1, "wheel_stop_on_prize", GET_PLAYER_PED(uParam0), uVar0, 1, 20);
			break;
		
		case 11:
			PLAY_SOUND_FROM_ENTITY(-1, "welcome_stinger", GET_PLAYER_PED(uParam0), uVar0, 1, 20);
			break;
		
		case 12:
			PLAY_SOUND_FROM_ENTITY(-1, "spin_wheel", GET_PLAYER_PED(uParam0), uVar0, 1, 20);
			break;
		
		case 13:
			PLAY_SOUND_FROM_ENTITY(-1, "spin_wheel_win", GET_PLAYER_PED(uParam0), uVar0, 1, 20);
			break;
	}
}
...
void func_172(int iParam0)
{
	if (iParam0 == 0)
	{
		if (iLocal_1476 == 4 || (iLocal_1476 == 16 && HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), -278874898)))
		{
			func_164(5);
		}
		else if (iLocal_1476 == 10 || HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), -278874898))
		{
			func_164(11);
		}
	}
...
{
	BEGIN_SCALEFORM_MOVIE_METHOD(Local_1938, "SET_BET");
	SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
	END_SCALEFORM_MOVIE_METHOD();
}
					...
					if (iParam1 == 7 && iParam3 > 0)
					{
						if (Local_47[iLocal_1959 /*21*/].f_17 == 8)
						{
							if (iParam3 != 12)
							{
								...
								_0x585847C5E4E11709(PLAYER_PED_ID(), iVar16, &iVar18);
								if (iVar18 < iVar17)
								{
...
void func_176(int iParam0, char* sParam1, int iParam2, char* sParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11)
{
	...
	if ((!func_179() || !NETWORK_IS_ACTIVITY_SESSION()) || !func_23(PLAYER_ID(), 0))
	{
		return;
	}
...
void func_183()
{
	...
	else if (((iLocal_1476 == 10 || iLocal_1476 == 11) || iLocal_1476 == 12) || HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), -278874898))
	{
		func_164(14);
	}
}
...
void func_193(int iParam0)
{
	...
	iLocal_1959 = iParam0;
	Local_3235[PLAYER_ID() /*11*/] = iParam0;
	iLocal_1961 = -1;
}
...
int func_195(int iParam0)
{
	...
	if ((((func_210() || func_209()) || func_208()) || IS_SCREEN_FADED_OUT()) || IS_SCREEN_FADING_OUT())
	{
		bVar6 = true;
		SET_BIT(&uLocal_1472, 6);
	}
	...
	if (bVar6)
	{
		if (ARE_STRINGS_EQUAL(&vVar0, "CAS_MG_MEMB2"))
		{
		...
		else if (!IS_BIT_SET(uLocal_1472, 6))
		{
			func_182();
			if (!IS_HELP_MESSAGE_BEING_DISPLAYED())
			{
...
void func_198()
{
	if (!NETWORK_CAN_SPEND_MONEY(func_201(0), 0, 1, 0, -1, 0))
	{
		func_186("MAITRD_M_D0E", -1);
	}
	else if (func_57(PLAYER_ID()))
	{
	}
...
int func_202()
{
	...
	if (func_60(PLAYER_ID(), 1))
	{
		iVar0 = func_59();
		if (func_12(iVar0, 1, 1) && IS_BIT_SET(Global_1589819[iVar0 /*818*/].f_273.f_362.f_3, 6))
		{
			return 1;
		}
		if ((func_104(PLAYER_ID(), 0) && func_206(PLAYER_ID())) || func_203(PLAYER_ID()))
		{
			return 1;
		}
	}
...
void func_212(bool bParam0)
{
	...
	if (Global_262145.f_25805)
	{
		...
		{
			Var0.f_5 = ABSI(GET_TIME_DIFFERENCE(uLocal_1937, GET_NETWORK_TIME()));
		}
		Var0.f_6 = (IS_BIT_SET(uLocal_1472, 20) || IS_BIT_SET(uLocal_1473, 1));
		Var0.f_7 = Local_1919.f_5;
		Var0.f_10 = NETWORK_IS_HOST_OF_THIS_SCRIPT();
		Var0.f_11 = unk_0xDB663CC9FF3407A9(NETWORK_GET_PLAYER_INDEX(NETWORK_GET_HOST_OF_THIS_SCRIPT()));
...
void func_215(bool bParam0)
{
	if (bParam0)
	{
		SET_BIT(&Global_1689926, 2);
	}
	else
	{
		CLEAR_BIT(&Global_1689926, 2);
	}
}

bool func_216()
{
	return IS_BIT_SET(Global_1689926, 2);
}
...
void func_220()
{
	if (iLocal_1530 == 0 && _0xEE778F8C7E1142E2(0) == 4)
	{
	}
}
...
void func_221()
{
	...
	if (IS_SYNCHRONIZED_SCENE_RUNNING(uVar0))
	{
		if (GET_SYNCHRONIZED_SCENE_PHASE(uVar0) >= 0.99f || HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), -1424880317))
		{
			bVar1 = true;
		}
	}
...
void func_222()
{
	...
	if (!IS_BIT_SET(Local_3235[PLAYER_ID() /*11*/].f_10, 0))
	{
		if (((iLocal_1476 == 4 || iLocal_1476 == 10) || iLocal_1476 == 11) || iLocal_1476 == 12)
		{
			if (IS_BIT_SET(uLocal_1472, 25))
			{
				CLEAR_BIT(&uLocal_1472, 0);
			}
		}
	...
	{
		SET_BIT(&uLocal_1472, 25);
	}
	if (iLocal_1959 >= 0 && (iLocal_1471 == 5 || IS_BIT_SET(uLocal_1472, 31)))
	{
		func_266();
		if ((!IS_BIT_SET(Local_3235[PLAYER_ID() /*11*/].f_10, 0) && !IS_BIT_SET(uLocal_1472, 3)) && (((iLocal_1476 == 4 || iLocal_1476 == 10) || iLocal_1476 == 11) || iLocal_1476 == 12))
		{
		...
		if (!IS_BIT_SET(uLocal_1472, 0))
		{
			if (IS_BIT_SET(uLocal_1472, 21) || IS_BIT_SET(uLocal_1472, 22))
			{
				...
				REQUEST_STREAMED_TEXTURE_DICT(&vVar0, 0);
				SET_BIT(&uLocal_1472, 23);
				if (func_264(0, -1, 0) && HAS_STREAMED_TEXTURE_DICT_LOADED(&vVar0))
				{
					func_163(0, 0);
			...
			{
				func_163(0, 0);
				if (!IS_BIT_SET(Local_3235[PLAYER_ID() /*11*/].f_10, 0) && (((((iLocal_1476 == 4 || iLocal_1476 == 10) || iLocal_1476 == 11) || iLocal_1476 == 12) || IS_BIT_SET(uLocal_1472, 31)) || HAS_ANIM_EVENT_FIRED(PLAYER_PED_ID(), -278874898)))
				{
					func_256(202, "SLOTS_EXIT", -1);
					func_230("SLOTS_SPIN", GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 208, 1), GET_CONTROL_INSTRUCTIONAL_BUTTON(2, 201, 1), 0, 0);
	...
	else if (IS_BIT_SET(uLocal_1472, 0))
	{
		func_163(0, 0);
		func_160(1, -1);
		CLEAR_BIT(&uLocal_1472, 0);
...
int func_227(bool bParam0, bool bParam1)
{
	...
	if ((((((((!IS_SCREEN_FADED_IN() || (func_229(8, -1) && func_228() != 64)) || (GET_PAUSE_MENU_STATE() != 0 && !bParam1)) || (IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0)) || SET_STORE_ENABLED()) || Global_71850) || Global_17411.f_8352) || IS_WARNING_MESSAGE_ACTIVE()) || Global_93734.f_1409)
	{
		return 0;
	}
	return 1;
								...
								if (bVar33)
								{
									...
									if (GET_HASH_KEY(&(Global_17411.f_73[iVar24 /*6*/])) != 0 && iVar5 == 1)
									{
										...
										else
										{
											...
											if (func_179() && _GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (iVar8 == 0)
												{
									...
									if (func_253(Global_17411.f_4433[iVar22], bVar32, 0, &fVar36, &fVar37, bParam7))
									{
										...
										if (iVar5 == 1)
										{
											if (func_253(Global_17411.f_4433[iVar22], bVar32, 1, &fVar36, &fVar37, bParam7))
											{
												...
												DRAW_SPRITE(func_247(Global_17411.f_4433[iVar22]), func_245(Global_17411.f_4433[iVar22], bVar32), ((fVar34 + fVar42) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar56 * 0.5f)), (fVar36 * func_233(Global_17411.f_4433[iVar22])), (fVar37 * func_233(Global_17411.f_4433[iVar22])), 0f, uVar47, uVar48, uVar49, uVar50, 0);
											}
										}
									}
								}
...
void func_266()
{
	if (HAS_SCALEFORM_MOVIE_LOADED(Local_1938))
	{
		_0x32F34FF7F617643B(Local_1938, 1);
		SET_TEXT_RENDER_ID(Local_1938.f_1);
		SET_SCRIPT_GFX_DRAW_ORDER(4);
		SET_SCRIPT_GFX_DRAW_BEHIND_PAUSEMENU(1);
		DRAW_SCALEFORM_MOVIE(Local_1938, 0.401f, 0.09f, 0.805f, 0.195f, 255, 255, 255, 255, 0);
...
void func_268()
{
	func_33(-1040706016, GET_CLOUD_TIME_AS_INT());
	func_269();
	func_32();
	Global_1689915 = 1;
	Global_1689910 = 0;
...
void func_271()
{
	func_33(937560627, GET_CLOUD_TIME_AS_INT());
	func_34();
	func_272((GET_CLOUD_TIME_AS_INT() + 86400));
	Global_1689914 = 1;
}
...
int func_274()
{
	...
	switch (iLocal_1474)
	{
		case 0:
			if (func_281())
			{
				if (func_280())
				{
					...
					CLEAR_BIT(&uLocal_1472, 26);
					SET_BIT(&uLocal_1472, 26);
					TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER_PED_ID(), func_276(iLocal_1485), 1f, 7000, 0.05f, 0, func_275(iLocal_1485));
					CLEAR_BIT(&uLocal_1472, 30);
					CLEAR_BIT(&uLocal_1472, 31);
					iLocal_1474++;
				}
		...
		case 1:
			if (GET_DISTANCE_BETWEEN_COORDS(func_95(PLAYER_ID()), func_276(iLocal_1485), 0) <= 0.25f)
			{
				SET_BIT(&uLocal_1472, 26);
			}
			if ((((!IS_PED_INJURED(PLAYER_PED_ID()) && GET_SCRIPT_TASK_STATUS(PLAYER_PED_ID(), 713668775) != 1) && GET_SCRIPT_TASK_STATUS(PLAYER_PED_ID(), 713668775) != 0) && !IS_PED_WALKING(PLAYER_PED_ID())) || (IS_BIT_SET(uLocal_1472, 26) && GET_SCRIPT_TASK_STATUS(PLAYER_PED_ID(), 713668775) != 0))
			{
		...
		case 2:
			...
			if (IS_SYNCHRONIZED_SCENE_RUNNING(uVar0))
			{
				...
				{
					SET_BIT(&uLocal_1472, 31);
					func_42();
					if (IS_BIT_SET(uLocal_1472, 30))
					{
						CLEAR_BIT(&uLocal_1472, 30);
						CLEAR_BIT(&uLocal_1472, 31);
						return 1;
				...
				if (GET_SYNCHRONIZED_SCENE_PHASE(uVar0) >= 0.99f)
				{
					func_170(PLAYER_ID(), Local_47[iLocal_1959 /*21*/].f_17, 11);
					func_164(4);
					iLocal_1474++;
				}
			}
...
var func_275(int iParam0)
{
	...
	func_165(iParam0, &Local_1940);
	vVar0 = { GET_ANIM_INITIAL_OFFSET_ROTATION(func_310(), &Local_1940, vLocal_1477, vLocal_1480, 0.01f, 2) };
	return vVar0.z;
}
...
{
	func_165(iParam0, &Local_1940);
	return GET_ANIM_INITIAL_OFFSET_POSITION(func_310(), &Local_1940, vLocal_1477, vLocal_1480, 0.01f, 2);
}
...
int func_277()
{
	...
	while (iVar2 < 4)
	{
		if (GET_DISTANCE_BETWEEN_COORDS(func_95(PLAYER_ID()), func_276((0 + iVar2)), 1) < fVar0)
		{
			fVar0 = GET_DISTANCE_BETWEEN_COORDS(func_95(PLAYER_ID()), func_276((0 + iVar2)), 1);
			iVar1 = (0 + iVar2);
		}
		iVar2++;
	}
...
void func_279(int iParam0)
{
	...
	BEGIN_SCALEFORM_MOVIE_METHOD(Local_1938, "SET_THEME");
...
int func_280()
{
	...
	if (HAS_SCALEFORM_MOVIE_LOADED(Local_1938))
	{
		if (!IS_NAMED_RENDERTARGET_REGISTERED(&cVar0))
		{
			REGISTER_NAMED_RENDERTARGET(&cVar0, 0);
			if (!IS_NAMED_RENDERTARGET_LINKED(uVar6))
			{
				LINK_NAMED_RENDERTARGET(uVar6);
				if (Local_1938.f_1 == -1)
				{
					Local_1938.f_1 = GET_NAMED_RENDERTARGET_RENDER_ID(&cVar0);
				}
				return 1;
			}
			else
		...
		else if (!IS_NAMED_RENDERTARGET_LINKED(uVar6))
		{
			LINK_NAMED_RENDERTARGET(uVar6);
			if (Local_1938.f_1 == -1)
			{
...
int func_281()
{
	SET_BIT(&uLocal_1472, 18);
	REQUEST_ANIM_DICT(func_310());
	if (HAS_ANIM_DICT_LOADED(func_310()))
	{
		return 1;
	}
	return 0;
...
void func_289()
{
	...
	REQUEST_STREAMED_TEXTURE_DICT(&cVar0, 0);
	SET_BIT(&uLocal_1472, 23);
	if (func_264(0, -1, 0) && HAS_STREAMED_TEXTURE_DICT_LOADED(&cVar0))
	{
		if (!IS_BIT_SET(uLocal_1472, 19))
		{
			func_163(0, 0);
		...
		if (IS_CONTROL_JUST_RELEASED(2, 202) || IS_DISABLED_CONTROL_JUST_RELEASED(2, 202))
		{
			...
			if (IS_BIT_SET(uLocal_1472, 2))
			{
				if ((func_12(PLAYER_ID(), 1, 1) && !IS_PLAYER_SWITCH_IN_PROGRESS()) && func_26())
				{
					func_17(PLAYER_ID(), 1, 0, 0);
				}
				if (IS_RADAR_HIDDEN())
		...
		if (IS_CONTROL_JUST_RELEASED(2, 201) || IS_DISABLED_CONTROL_JUST_RELEASED(2, 201))
		{
			...
			if (func_8(iLocal_1959, &Local_47))
			{
				SET_BIT(&uLocal_1473, 1);
			}
			else
			{
				SET_BIT(&uLocal_1472, 20);
			}
			PLAY_SOUND_FRONTEND(-1, "DLC_VW_CONTINUE", "dlc_vw_table_games_frontend_sounds", 1);
			func_292(4);
		}
...
void func_291(int iParam0)
{
	...
	{
		if (Local_2575.f_598[iParam0] == PLAYER_ID())
		{
			func_193(iParam0);
			if (func_8(iParam0, &Local_47) && IS_BIT_SET(uLocal_1473, 1))
			{
				func_292(4);
			}
			else if (!func_8(iParam0, &Local_47) && IS_BIT_SET(uLocal_1472, 20))
			{
				func_292(4);
			}
			else
		...
		{
			if (!IS_BIT_SET(uLocal_1472, 1))
			{
				if (!IS_HELP_MESSAGE_BEING_DISPLAYED())
				{
					func_186("SLOTS_USED", -1);
					SET_BIT(&uLocal_1472, 1);
				}
			}
			iLocal_1961 = -1;
			func_193(-1);
...
int func_293()
{
	...
	if ((((((((((((((((func_12(PLAYER_ID(), 1, 1) && func_307(PLAYER_PED_ID()) <= 9) && !Global_2405071.f_2668) && !IS_PED_RAGDOLL(PLAYER_PED_ID())) && !IS_BIT_SET(Global_1671295.f_4, 2)) && !func_218()) && !SET_STORE_ENABLED()) && !_0x2F057596F2BD0061()) && !IS_PLAYER_SWITCH_IN_PROGRESS()) && !func_217(1)) && !func_219()) && !func_210()) && !func_208()) && !IS_SCREEN_FADED_OUT()) && !IS_SCREEN_FADING_OUT()) && !Global_2458648.f_12) && Global_1671289 != 31)
	{
		if (iLocal_1964 < 0)
		{
			iVar13 = 0;
			while (iVar13 < 8)
			{
				...
				vVar0[0 /*3*/] = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar20, fVar23, 0.0579063f, -0.256112f, -0.197113f) };
				vVar0[1 /*3*/] = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar20, fVar23, 0.0289372f, -1.85613f, 2.75002f) };
				vVar7 = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar20, fVar23, 0f, -0.4f, 1f) };
				vVar10 = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar20, fVar23, 0f, -0.6f, 1f) };
				fVar23 = func_306(func_95(PLAYER_ID()), vVar20, 1);
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vVar0[0 /*3*/], vVar0[1 /*3*/], 1.25f, 0, 1, 0))
				{
					if ((func_305(GET_ENTITY_HEADING(PLAYER_PED_ID()), fVar23, 45f) || func_301(PLAYER_PED_ID(), vVar7, 45f)) || func_301(PLAYER_PED_ID(), vVar10, 45f))
					{
		...
		else
		{
			...
			vVar10 = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar20, fVar23, 0f, -0.6f, 1f) };
			fVar23 = func_306(func_95(PLAYER_ID()), vVar20, 1);
			if (!IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vVar0[0 /*3*/], vVar0[1 /*3*/], 1.25f, 0, 1, 0) || ((!func_305(GET_ENTITY_HEADING(PLAYER_PED_ID()), fVar23, 45f) && !func_301(PLAYER_PED_ID(), vVar7, 45f)) && !func_301(PLAYER_PED_ID(), vVar10, 45f)))
			{
				iLocal_1964 = -1;
			}
		}
		...
		{
			func_214(iLocal_1964, &vVar20, &fVar23);
			vVar0[0 /*3*/] = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar20, fVar23, 0f, -0.5f, 0.77f) };
			if (Local_2575.f_598[iLocal_1964] == -1 && !func_300(iLocal_1964))
			{
				if (IS_BIT_SET(uLocal_1472, 1))
				{
					CLEAR_BIT(&uLocal_1472, 1);
				}
			...
			{
				if (Local_2575.f_598[iLocal_1964] != PLAYER_ID())
				{
					if (!IS_BIT_SET(uLocal_1472, 1))
					{
						func_186("SLOTS_USED", -1);
		...
		else
		{
			...
			if (IS_BIT_SET(uLocal_1472, 6))
			{
				CLEAR_BIT(&uLocal_1472, 6);
			}
			if (iLocal_1958 != -1)
			{
				func_196(&iLocal_1958);
...
int func_300(int iParam0)
{
	if (iParam0 < 32)
	{
		return IS_BIT_SET(Global_2506781, iParam0);
	}
	else
	{
		iParam0 = (iParam0 - 32);
		return IS_BIT_SET(Global_2506782, iParam0);
	}
	return 0;
}
...
{
	return func_302(GET_ENTITY_COORDS(uParam0, 1), GET_ENTITY_HEADING(uParam0), vParam1, fParam4);
}
...
void func_314()
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (!IS_BIT_SET(Local_2242[func_11(Global_1689853[iVar0 /*3*/].f_1)], func_10(Global_1689853[iVar0 /*3*/].f_1)))
			{
				SET_BIT(&(Local_2242[func_11(Global_1689853[iVar0 /*3*/].f_1)]), func_10(Global_1689853[iVar0 /*3*/].f_1));
			}
			if (Global_1689853[iVar0 /*3*/])
			{
				if (!IS_BIT_SET(Local_2242.f_3[func_11(Global_1689853[iVar0 /*3*/].f_1)], func_10(Global_1689853[iVar0 /*3*/].f_1)))
				{
					...
					SET_BIT(&(Local_2242.f_3[func_11(Global_1689853[iVar0 /*3*/].f_1)]), func_10(Global_1689853[iVar0 /*3*/].f_1));
				}
			}
		}
		iVar0++;
	...
	while (iVar1 < 54)
	{
		if (IS_BIT_SET(Local_2242.f_3[func_11(iVar1)], func_10(iVar1)))
		{
			...
			while (iVar0 < 3)
			{
							...
							if (iVar11[(iVar0 - 1)])
							{
								if (func_311(&(Local_1536[iVar1 /*5*/][(iVar0 - 1) /*2*/])))
								{
									if (func_5(&(Local_1536[iVar1 /*5*/][(iVar0 - 1) /*2*/]), 150, 0))
									{
										...
										{
											Local_47[iVar1 /*21*/].f_10[iVar0] = ((Local_2242.f_115[iVar1 /*4*/][iVar0] * 22.5f) + IntToFloat(FLOOR((Local_47[iVar1 /*21*/].f_2[iVar0] / 360f)) * 360));
										}
									}
								}
								else
				...
				if (DOES_ENTITY_EXIST(Local_1965[iVar1 /*4*/][iVar0]))
				{
					if (Local_47[iVar1 /*21*/].f_6[iVar0] != Local_47[iVar1 /*21*/].f_2[iVar0])
					{
						...
						SET_ENTITY_ROTATION(Local_1965[iVar1 /*4*/][iVar0], Local_47[iVar1 /*21*/].f_2[iVar0], 0f, uVar6, 2, 1);
				...
				if (iVar7[iVar0])
				{
					...
					if (ABSF(fVar24) <= 20f || (Local_47[iVar1 /*21*/].f_10[iVar0] != -1f && Local_47[iVar1 /*21*/].f_2[iVar0] >= Local_47[iVar1 /*21*/].f_10[iVar0]))
					{
					...
					{
						Local_47[iVar1 /*21*/].f_2[iVar0] = (Local_47[iVar1 /*21*/].f_2[iVar0] + (600f * TIMESTEP()));
					}
				}
				else
				{
			...
			if (!IS_BIT_SET(uLocal_1486[func_11(iVar1)], func_10(iVar1)))
			{
				func_315(iVar1, 7);
				func_315(iVar1, 8);
				SET_BIT(&(uLocal_1486[func_11(iVar1)]), func_10(iVar1));
			}
			if (iVar11[2])
			{
				iVar2 = 0;
				while (iVar2 < 10)
				{
					...
					{
						CLEAR_BIT(&(uLocal_1486[func_11(iVar1)]), func_10(iVar1));
						...
						if (DOES_ENTITY_EXIST(uLocal_2182[iVar1]))
						{
							Local_47[iVar1 /*21*/].f_14 = 0f;
							SET_ENTITY_ROTATION(uLocal_2182[iVar1], 0f, 0f, uVar6, 2, 1);
						}
						...
						CLEAR_BIT(&(Local_2242.f_3[func_11(Global_1689853[iVar2 /*3*/].f_1)]), func_10(Global_1689853[iVar2 /*3*/].f_1));
					}
					iVar2++;
				}
			}
...
void func_315(int iParam0, int iParam1)
{
	...
	vVar1 = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar1, uVar4, 0f, -0.4f, 1f) };
	switch (iParam1)
	{
		case 1:
			PLAY_SOUND_FROM_COORD(-1, "no_win", vVar1, uVar0, 0, 20, 0);
			break;
		
		case 2:
			PLAY_SOUND_FROM_COORD(-1, "small_win", vVar1, uVar0, 0, 20, 0);
			break;
		
		case 3:
			PLAY_SOUND_FROM_COORD(-1, "big_win", vVar1, uVar0, 0, 20, 0);
			break;
		
		case 4:
			PLAY_SOUND_FROM_COORD(-1, "jackpot", vVar1, uVar0, 0, 20, 0);
			break;
		
		case 5:
			PLAY_SOUND_FROM_COORD(-1, "place_bet", vVar1, uVar0, 0, 20, 0);
			break;
		
		case 6:
			PLAY_SOUND_FROM_COORD(-1, "place_max_bet", vVar1, uVar0, 0, 20, 0);
			break;
		
		case 7:
			PLAY_SOUND_FROM_COORD(-1, "spinning", vVar1, uVar0, 0, 20, 0);
			break;
		
		case 8:
			PLAY_SOUND_FROM_COORD(-1, "start_spin", vVar1, uVar0, 0, 20, 0);
			break;
		
		case 9:
			PLAY_SOUND_FROM_COORD(-1, "wheel_stop_clunk", vVar1, uVar0, 0, 20, 0);
			break;
		
		case 10:
			PLAY_SOUND_FROM_COORD(-1, "wheel_stop_on_prize", vVar1, uVar0, 0, 20, 0);
			break;
		
		case 11:
			PLAY_SOUND_FROM_COORD(-1, "welcome_stinger", vVar1, uVar0, 0, 20, 0);
			break;
		
		case 12:
			PLAY_SOUND_FROM_COORD(-1, "spin_wheel", vVar1, uVar0, 0, 20, 0);
			break;
		
		case 13:
			PLAY_SOUND_FROM_COORD(-1, "spin_wheel_win", vVar1, uVar0, 0, 20, 0);
			break;
	}
}
...
void func_317(int iParam0, int iParam1)
{
	...
	if (Local_47[iParam0 /*21*/].f_6[iParam1] != 0f)
	{
		...
		if (ABSF(fVar1) <= 2.5f)
		{
			if (fVar1 < 0f)
			{
				Local_47[iParam0 /*21*/].f_2[iParam1] = (Local_47[iParam0 /*21*/].f_2[iParam1] - IntToFloat(GET_RANDOM_INT_IN_RANGE(3, 8)));
			}
			else
			{
				Local_47[iParam0 /*21*/].f_2[iParam1] = (Local_47[iParam0 /*21*/].f_2[iParam1] + IntToFloat(GET_RANDOM_INT_IN_RANGE(3, 8)));
...
void func_318(var uParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		...
		case 2:
			...
			iVar2 = GET_RANDOM_INT_IN_RANGE(0, iVar13);
	...
	while (iVar0 < 3)
	{
		...
		if (iVar14[iVar0] == 0)
		{
			iVar2 = GET_RANDOM_INT_IN_RANGE(0, Local_1182.f_225);
...
void func_319()
{
	...
	while (iVar1 < 54)
	{
		if (IS_BIT_SET(Local_2242[func_11(iVar1)], func_10(iVar1)))
		{
		}
		else if (IS_BIT_SET(Local_2575.f_653[func_11(iVar1)], func_10(iVar1)) || ((iVar1 == iLocal_1959 && IS_BIT_SET(Local_3235[PLAYER_ID() /*11*/].f_10, 0)) && !IS_BIT_SET(Local_3235[PLAYER_ID() /*11*/].f_10, 2)))
		{
			if (iVar1 == iLocal_1959 && IS_BIT_SET(Local_3235[PLAYER_ID() /*11*/].f_10, 2))
			{
			}
			else
			{
				...
				while (iVar0 < 3)
				{
					...
					if (func_311(&(Local_2575.f_489[iVar1 /*2*/])))
					{
						...
						{
							if (IS_BIT_SET(Local_2575.f_656[func_11(iVar1)], func_10(iVar1)))
							{
								if (iVar0 > 0)
								{
									if (iVar11[(iVar0 - 1)])
									{
										if (func_311(&(Local_1536[iVar1 /*5*/][(iVar0 - 1) /*2*/])))
										{
											if (func_5(&(Local_1536[iVar1 /*5*/][(iVar0 - 1) /*2*/]), 150, 0))
											{
												...
												if (Local_47[iVar1 /*21*/].f_10[iVar0] == -1f)
												{
													Local_47[iVar1 /*21*/].f_10[iVar0] = ((Local_2575.f_217[iVar1 /*4*/][iVar0] * 22.5f) + IntToFloat(FLOOR((Local_47[iVar1 /*21*/].f_2[iVar0] / 360f)) * 360));
												}
											}
										}
										else
					...
					if (DOES_ENTITY_EXIST(Local_1965[iVar1 /*4*/][iVar0]))
					{
						...
						if (iLocal_1959 == iVar1)
						{
							if (!iVar7[iVar0])
							{
								if (!IS_BIT_SET(uLocal_1472, (8 + iVar0)))
								{
									vVar3 = { GET_ENTITY_COORDS(Local_1965[iVar1 /*4*/][iVar0], 1) };
									vVar3.z = (vVar3.z - 10f);
									SET_ENTITY_COORDS(Local_1965[iVar1 /*4*/][iVar0], vVar3, 1, 0, 0, 1);
									if (DOES_ENTITY_EXIST(uLocal_2237[iVar0]))
									{
										vVar3 = { GET_ENTITY_COORDS(uLocal_2237[iVar0], 1) };
										vVar3.z = (vVar3.z + 10f);
										SET_ENTITY_COORDS(uLocal_2237[iVar0], vVar3, 1, 0, 0, 1);
										FORCE_ROOM_FOR_ENTITY(uLocal_2237[iVar0], GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()), GET_ROOM_KEY_FROM_ENTITY(PLAYER_PED_ID()));
										SET_BIT(&uLocal_1472, (8 + iVar0));
									}
								}
							}
						}
						...
						SET_ENTITY_ROTATION(Local_1965[iVar1 /*4*/][iVar0], Local_47[iVar1 /*21*/].f_2[iVar0], 0f, uVar6, 2, 1);
						if (iLocal_1959 == iVar1 && DOES_ENTITY_EXIST(uLocal_2237[iVar0]))
						{
							SET_ENTITY_ROTATION(uLocal_2237[iVar0], Local_47[iVar1 /*21*/].f_2[iVar0], 0f, uVar6, 2, 1);
						}
						Local_47[iVar1 /*21*/].f_6[iVar0] = Local_47[iVar1 /*21*/].f_2[iVar0];
					}
					if (iVar7[iVar0])
					{
						...
						if (ABSF(fVar16) <= 20f || (Local_47[iVar1 /*21*/].f_10[iVar0] != -1f && Local_47[iVar1 /*21*/].f_2[iVar0] >= Local_47[iVar1 /*21*/].f_10[iVar0]))
						{
							...
							if (iLocal_1959 == iVar1)
							{
								if (IS_BIT_SET(uLocal_1472, (8 + iVar0)))
								{
									if (DOES_ENTITY_EXIST(Local_1965[iVar1 /*4*/][iVar0]) && DOES_ENTITY_EXIST(uLocal_2237[iVar0]))
									{
										vVar3 = { GET_ENTITY_COORDS(Local_1965[iVar1 /*4*/][iVar0], 1) };
										vVar3.z = (vVar3.z + 10f);
										SET_ENTITY_COORDS(Local_1965[iVar1 /*4*/][iVar0], vVar3, 1, 0, 0, 1);
										FORCE_ROOM_FOR_ENTITY(Local_1965[iVar1 /*4*/][iVar0], GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()), GET_ROOM_KEY_FROM_ENTITY(PLAYER_PED_ID()));
										vVar3 = { GET_ENTITY_COORDS(uLocal_2237[iVar0], 1) };
										vVar3.z = (vVar3.z - 10f);
										SET_ENTITY_COORDS(uLocal_2237[iVar0], vVar3, 1, 0, 0, 1);
										CLEAR_BIT(&uLocal_1472, (8 + iVar0));
									}
									func_170(PLAYER_ID(), Local_47[iLocal_1959 /*21*/].f_17, 9);
									if (Local_1182.f_1[0 /*65*/][uLocal_1925[0]] == 6)
									{
										func_170(PLAYER_ID(), Local_47[iLocal_1959 /*21*/].f_17, 10);
									}
								}
							}
							if (DOES_ENTITY_EXIST(Local_1965[iVar1 /*4*/][iVar0]))
				...
				if (iVar1 == iLocal_1959)
				{
					if (!IS_BIT_SET(uLocal_1486[func_11(iVar1)], func_10(iVar1)))
					{
						func_170(PLAYER_ID(), Local_47[iLocal_1959 /*21*/].f_17, 7);
						func_170(PLAYER_ID(), Local_47[iLocal_1959 /*21*/].f_17, 8);
						SET_BIT(&(uLocal_1486[func_11(iVar1)]), func_10(iVar1));
					}
				}
				if (func_320(iVar1, iVar11[2]))
				{
					...
					else if (func_5(&(Local_1807[iVar1 /*2*/]), 1000, 1) && !IS_BIT_SET(uLocal_1472, 12))
					{
						if (iLocal_1959 == iVar1)
						{
							if (iLocal_1476 == 17)
							...
							if (!IS_BIT_SET(uLocal_1472, 12))
							{
								SET_BIT(&uLocal_1472, 12);
							}
						}
					}
					else if (func_5(&(Local_1807[iVar1 /*2*/]), 1250, 1))
					{
						if (!func_5(&(Local_2575.f_489[iVar1 /*2*/]), func_7(iVar1), 0))
						{
							if (func_5(&(Local_2575.f_489[iVar1 /*2*/]), (func_7(iVar1) - 2000), 0))
							{
								...
								{
									Local_47[iVar1 /*21*/].f_15 = (TO_FLOAT(Local_2575.f_434[iVar1] * 30) + IntToFloat(FLOOR((Local_47[iVar1 /*21*/].f_14 / 360f)) * 360));
								}
							}
							if (DOES_ENTITY_EXIST(uLocal_2182[iVar1]))
							{
								if (iLocal_1959 == iVar1)
								{
									if (!bVar15)
									{
										if (!IS_BIT_SET(uLocal_1472, 11))
										{
											vVar3 = { GET_ENTITY_COORDS(uLocal_2182[iVar1], 1) };
											vVar3.z = (vVar3.z - 10f);
											SET_ENTITY_COORDS(uLocal_2182[iVar1], vVar3, 1, 0, 0, 1);
											if (DOES_ENTITY_EXIST(uLocal_2241))
											{
												vVar3 = { GET_ENTITY_COORDS(uLocal_2241, 1) };
												vVar3.z = (vVar3.z + 10f);
												SET_ENTITY_COORDS(uLocal_2241, vVar3, 1, 0, 0, 1);
												FORCE_ROOM_FOR_ENTITY(uLocal_2241, GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()), GET_ROOM_KEY_FROM_ENTITY(PLAYER_PED_ID()));
												SET_BIT(&uLocal_1472, 11);
											}
											func_170(PLAYER_ID(), Local_47[iLocal_1959 /*21*/].f_17, 12);
										}
									}
								}
								func_214(iVar1, &vVar3, &uVar6);
								SET_ENTITY_ROTATION(uLocal_2182[iVar1], 0f, Local_47[iVar1 /*21*/].f_14, uVar6, 2, 1);
								if (iLocal_1959 == iVar1 && DOES_ENTITY_EXIST(uLocal_2241))
								{
									SET_ENTITY_ROTATION(uLocal_2241, 0f, Local_47[iVar1 /*21*/].f_14, uVar6, 2, 1);
								}
							}
							if (bVar15)
							{
								fVar17 = (TO_FLOAT(Local_2575.f_434[iVar1] * 30) - (Local_47[iVar1 /*21*/].f_14 % 360f));
								if (ABSF(fVar17) <= 20f || (Local_47[iVar1 /*21*/].f_15 != -1f && Local_47[iVar1 /*21*/].f_14 >= Local_47[iVar1 /*21*/].f_15))
								{
									Local_47[iVar1 /*21*/].f_14 = TO_FLOAT(Local_2575.f_434[iVar1] * 30);
									if (iLocal_1959 == iVar1)
									{
										if (IS_BIT_SET(uLocal_1472, 11))
										{
											if (DOES_ENTITY_EXIST(uLocal_2182[iVar1]) && DOES_ENTITY_EXIST(uLocal_2241))
											{
												vVar3 = { GET_ENTITY_COORDS(uLocal_2182[iVar1], 1) };
												vVar3.z = (vVar3.z + 10f);
												SET_ENTITY_COORDS(uLocal_2182[iVar1], vVar3, 1, 0, 0, 1);
												FORCE_ROOM_FOR_ENTITY(uLocal_2182[iVar1], GET_INTERIOR_FROM_ENTITY(PLAYER_PED_ID()), GET_ROOM_KEY_FROM_ENTITY(PLAYER_PED_ID()));
												vVar3 = { GET_ENTITY_COORDS(uLocal_2241, 1) };
												vVar3.z = (vVar3.z - 10f);
												SET_ENTITY_COORDS(uLocal_2241, vVar3, 1, 0, 0, 1);
												CLEAR_BIT(&uLocal_1472, 11);
											}
										}
										if (DOES_ENTITY_EXIST(uLocal_2182[iVar1]))
										{
										...
										func_170(PLAYER_ID(), Local_47[iLocal_1959 /*21*/].f_17, 13);
										SET_BIT(&(Local_3235[PLAYER_ID() /*11*/].f_10), 2);
									}
								}
								else
								{
									Local_47[iVar1 /*21*/].f_14 = (Local_47[iVar1 /*21*/].f_14 + (300f * TIMESTEP()));
								}
							}
							else
							{
		...
		else
		{
			...
			if (DOES_ENTITY_EXIST(uLocal_2182[iVar1]))
			{
				if (Local_47[iVar1 /*21*/].f_14 != TO_FLOAT(Local_2575.f_434[iVar1] * 30))
				{
					func_214(iVar1, &vVar3, &uVar6);
					Local_47[iVar1 /*21*/].f_14 = TO_FLOAT(Local_2575.f_434[iVar1] * 30);
					SET_ENTITY_ROTATION(uLocal_2182[iVar1], 0f, Local_47[iVar1 /*21*/].f_14, uVar6, 2, 1);
			...
			if (iLocal_1959 == iVar1)
			{
				if (IS_BIT_SET(uLocal_1472, 12))
				{
					CLEAR_BIT(&uLocal_1472, 12);
				}
				if (IS_BIT_SET(Local_3235[PLAYER_ID() /*11*/].f_10, 2) && !IS_BIT_SET(uLocal_1472, 3))
				{
					func_4(&(Local_1536[iVar1 /*5*/][0 /*2*/]));
					func_4(&(Local_1536[iVar1 /*5*/][1 /*2*/]));
					func_4(&(Local_1807[iVar1 /*2*/]));
...
void func_321()
{
	...
	while (iVar2 < 54)
	{
		if (func_322(iVar2))
		{
			...
			{
				if (!DOES_ENTITY_EXIST(uLocal_2182[iVar2]))
				{
					if (CAN_REGISTER_MISSION_ENTITIES(0, 0, 1, 0))
					{
						...
						uVar0 = GET_HASH_KEY(&cVar7);
						REQUEST_MODEL(uVar0);
						if (HAS_MODEL_LOADED(uVar0))
						{
							func_214(iVar2, &vVar3, &uVar6);
							vVar3 = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar3, uVar6, 0f, -0.12f, 1.6f) };
							uLocal_2182[iVar2] = CREATE_OBJECT(uVar0, vVar3, 0, 0, 1);
							FREEZE_ENTITY_POSITION(uLocal_2182[iVar2], 1);
							SET_ENTITY_ROTATION(uLocal_2182[iVar2], 0f, 0f, uVar6, 2, 1);
			...
			while (iVar1 < 3)
			{
				if (!DOES_ENTITY_EXIST(Local_1965[iVar2 /*4*/][iVar1]))
				{
					if (CAN_REGISTER_MISSION_ENTITIES(0, 0, 1, 0))
					{
						...
						if (HAS_MODEL_LOADED(uVar0))
						{
							...
							if (iVar1 == 0)
							{
								vVar3 = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar3, uVar6, -0.115f, 0.047f, 0.906f) };
							}
							else if (iVar1 == 1)
							{
								vVar3 = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar3, uVar6, 0.005f, 0.047f, 0.906f) };
							}
							else if (iVar1 == 2)
							{
								vVar3 = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar3, uVar6, 0.125f, 0.047f, 0.906f) };
							}
							Local_1965[iVar2 /*4*/][iVar1] = CREATE_OBJECT(uVar0, vVar3, 0, 0, 1);
							FREEZE_ENTITY_POSITION(Local_1965[iVar2 /*4*/][iVar1], 1);
							SET_ENTITY_COLLISION(Local_1965[iVar2 /*4*/][iVar1], 0, 0);
							SET_ENTITY_ROTATION(Local_1965[iVar2 /*4*/][iVar1], 0f, 0f, uVar6, 2, 1);
							SET_MODEL_AS_NO_LONGER_NEEDED(uVar0);
						}
					}
				}
		...
		else
		{
			...
			while (iVar1 < 3)
			{
				if (DOES_ENTITY_EXIST(Local_1965[iVar2 /*4*/][iVar1]))
				{
					DELETE_OBJECT(&(Local_1965[iVar2 /*4*/][iVar1]));
				}
				iVar1++;
			}
			if (DOES_ENTITY_EXIST(uLocal_2182[iVar2]))
			{
				DELETE_OBJECT(&(uLocal_2182[iVar2]));
			}
		}
		iVar2++;
	}
	if (iLocal_1959 >= 0)
	{
		...
		while (iVar1 < 3)
		{
			if (!DOES_ENTITY_EXIST(uLocal_2237[iVar1]))
			{
				if (CAN_REGISTER_MISSION_ENTITIES(0, 0, 1, 0))
				{
					StringCopy(&cVar7, "Vw_prop_casino_slot_0", 64);
					...
					if (HAS_MODEL_LOADED(uVar0))
					{
						...
						vVar3.z = (vVar3.z - 10f);
						uLocal_2237[iVar1] = CREATE_OBJECT(uVar0, vVar3, 0, 0, 1);
						FREEZE_ENTITY_POSITION(uLocal_2237[iVar1], 1);
						SET_ENTITY_ROTATION(uLocal_2237[iVar1], 0f, 0f, uVar6, 2, 1);
						SET_MODEL_AS_NO_LONGER_NEEDED(uVar0);
					}
				}
			}
			...
			if (!DOES_ENTITY_EXIST(uLocal_2241))
			{
				if (CAN_REGISTER_MISSION_ENTITIES(0, 0, 1, 0))
				{
					...
					if (HAS_MODEL_LOADED(uVar0))
					{
						...
						vVar3 = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar3, uVar6, 0f, -0.12f, 1.6f) };
						vVar3.z = (vVar3.z - 10f);
						uLocal_2241 = CREATE_OBJECT(uVar0, vVar3, 0, 0, 1);
						FREEZE_ENTITY_POSITION(uLocal_2241, 1);
						SET_ENTITY_ROTATION(uLocal_2241, 0f, 0f, uVar6, 2, 1);
						SET_MODEL_AS_NO_LONGER_NEEDED(uVar0);
					}
				}
			}
	...
	else
	{
		...
		while (iVar1 < 3)
		{
			if (DOES_ENTITY_EXIST(uLocal_2237[iVar1]))
			{
				DELETE_OBJECT(&(uLocal_2237[iVar1]));
			}
			iVar1++;
		}
		if (DOES_ENTITY_EXIST(uLocal_2241))
		{
			DELETE_OBJECT(&uLocal_2241);
		}
	}
}
...
int func_322(int iParam0)
{
	...
	if (GET_DISTANCE_BETWEEN_COORDS(func_95(PLAYER_ID()), vVar0, 1) <= 10f)
	{
		return 1;
	}
	return 0;
	...
	while (iVar0 < 4)
	{
		if (Local_1489[iVar0 /*2*/].f_1 == -1)
		{
			...
			if (iVar1 != -1)
			{
				...
				Local_1489[iVar0 /*2*/].f_1 = GET_SOUND_ID();
				func_214(iVar1, &vVar2, &uVar5);
				vVar2 = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar2, uVar5, 0f, -0.2f, 1f) };
				uVar6 = func_171(Local_47[iVar1 /*21*/].f_17);
				PLAY_SOUND_FROM_COORD(Local_1489[iVar0 /*2*/].f_1, "attract_loop", vVar2, uVar6, 0, 0, 0);
			}
		}
		else if (Local_2575.f_598[Local_1489[iVar0 /*2*/]] != -1 || func_300(Local_1489[iVar0 /*2*/]))
		{
			STOP_SOUND(Local_1489[iVar0 /*2*/].f_1);
			RELEASE_SOUND_ID(Local_1489[iVar0 /*2*/].f_1);
			Local_1489[iVar0 /*2*/].f_1 = -1;
		}
		else if (HAS_SOUND_FINISHED(Local_1489[iVar0 /*2*/].f_1))
		{
			RELEASE_SOUND_ID(Local_1489[iVar0 /*2*/].f_1);
			Local_1489[iVar0 /*2*/].f_1 = -1;
		}
...
int func_324(int iParam0, int iParam1)
{
	...
	iVar43 = GET_RANDOM_INT_IN_RANGE(0, iVar37);
	iVar38 = 0;
	while (iVar38 < iVar37)
	{
...
void func_325()
{
	...
	if ((func_326() && Global_1671295.f_2688 != 123) && IS_SCREEN_FADED_OUT())
	{
		func_342();
	}
	if (NETWORK_IS_ACTIVITY_SESSION() && !IS_BIT_SET(Global_4456448.f_34, 9))
	{
		func_342();
	}
}
...
int func_329()
{
	...
	if (func_330() != 0)
	{
		if (_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(func_330()) == 0)
		{
			return 1;
		}
	}
...
void func_342()
{
	...
	while (iVar9 < 54)
	{
		...
		while (iVar8 < 3)
		{
			if (DOES_ENTITY_EXIST(Local_1965[iVar9 /*4*/][iVar8]))
			{
				DELETE_OBJECT(&(Local_1965[iVar9 /*4*/][iVar8]));
			}
			iVar8++;
		}
		if (DOES_ENTITY_EXIST(uLocal_2182[iVar9]))
		{
			DELETE_OBJECT(&(uLocal_2182[iVar9]));
		}
		iVar9++;
	}
	iVar8 = 0;
	while (iVar8 < 3)
	{
		if (DOES_ENTITY_EXIST(uLocal_2237[iVar8]))
		{
			DELETE_OBJECT(&(uLocal_2237[iVar8]));
		}
		iVar8++;
	}
	if (DOES_ENTITY_EXIST(uLocal_2241))
...
void func_344()
{
	...
	func_346(0, -1, 0);
	NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_2575, 660);
	NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&Local_3235, 353);
	if (!func_345())
	{
		func_342();
	}
