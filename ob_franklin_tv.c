...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (GET_DISTANCE_BETWEEN_COORDS(vLocal_309, GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 1) < 3f)
			{
				switch (iLocal_307)
				{
					case 0:
...
void func_1()
{
	...
	switch (iLocal_308)
	{
		case 0:
			...
			{
				if (_0xFCF37A457CB96DC0(PLAYER_PED_ID(), vLocal_312, 90f) || iLocal_317)
				{
					func_32("TV_HLP0");
		...
		case 1:
			if (func_31(1, 0, 1))
			{
				if (func_35(vLocal_309, vVar0) && DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vLocal_309, 3f, joaat("prop_cs_remote_01"), 0))
				{
					if (IS_PLAYER_PLAYING(PLAYER_ID()))
					{
						if ((!IS_PLAYER_FREE_AIMING(PLAYER_ID()) && !IS_PLAYER_TARGETTING_ANYTHING(PLAYER_ID())) && IS_CONTROL_PRESSED(0, 51))
						{
							...
							CLEAR_AREA_OF_PROJECTILES(vLocal_312, 3f, 0);
		...
		case 2:
			...
			uLocal_319 = CREATE_SYNCHRONIZED_SCENE(vLocal_323, vLocal_326, 2);
			if (Global_25825[1 /*11*/].f_2)
			{
				TASK_SYNCHRONIZED_SCENE(PLAYER_PED_ID(), uLocal_319, sLocal_322, "enter_no_remote", 8f, -4f, 0, 0, 1148846080, 0);
				PLAY_SYNCHRONIZED_ENTITY_ANIM(func_18(), uLocal_319, "enter_no_remote_remote", sLocal_322, 8f, -4f, 0, 1148846080);
			}
			else
			{
				TASK_SYNCHRONIZED_SCENE(PLAYER_PED_ID(), uLocal_319, sLocal_322, "enter", 8f, -4f, 0, 0, 1148846080, 0);
				PLAY_SYNCHRONIZED_ENTITY_ANIM(func_18(), uLocal_319, "enter_remote", sLocal_322, 8f, -4f, 0, 1148846080);
			}
			if (_0x7F2F4F13AC5257EF(uLocal_319))
			{
				_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_319, 0);
			}
			if (GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
			{
				uLocal_321 = CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
				if (Global_25825[1 /*11*/].f_2)
				{
					PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_321, uLocal_319, "enter_no_remote_cam", sLocal_322);
				}
				else
				{
					PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_321, uLocal_319, "enter_cam", sLocal_322);
				}
				SHAKE_CAM(uLocal_321, "HAND_SHAKE", 0.2f);
		...
		case 3:
			...
			if (!Global_25825[1 /*11*/].f_2)
			{
				if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_319) > 0.691f)
				{
					func_16();
					func_12(1, 0, 1, 0, 0);
				}
			}
			if (GET_SYNCHRONIZED_SCENE_PHASE(uLocal_319) > 0.9f)
			{
				uLocal_319 = CREATE_SYNCHRONIZED_SCENE(vLocal_323, vLocal_326, 2);
				TASK_SYNCHRONIZED_SCENE(PLAYER_PED_ID(), uLocal_319, sLocal_322, "base", 8f, -8f, 64, 0, 1148846080, 0);
				PLAY_SYNCHRONIZED_ENTITY_ANIM(func_18(), uLocal_319, "base_remote", sLocal_322, 8f, -8f, 64, 1148846080);
				SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_319, 1);
				func_32("TV_HLP7");
		...
		case 5:
			...
			if (!func_8())
			{
				...
				{
					uLocal_319 = CREATE_SYNCHRONIZED_SCENE(vLocal_323, vLocal_326, 2);
					TASK_SYNCHRONIZED_SCENE(PLAYER_PED_ID(), uLocal_319, sLocal_322, "exit", 8f, -8f, 0, 0, 1148846080, 0);
					PLAY_SYNCHRONIZED_ENTITY_ANIM(func_18(), uLocal_319, "exit_remote", sLocal_322, 8f, -8f, 0, 1148846080);
					if (func_6(uLocal_321))
					{
						PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_321, uLocal_319, "exit_cam", sLocal_322);
					}
					if (_0x7F2F4F13AC5257EF(uLocal_319))
					{
						_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_319, 0);
				...
				{
					uLocal_319 = CREATE_SYNCHRONIZED_SCENE(vLocal_323, vLocal_326, 2);
					TASK_SYNCHRONIZED_SCENE(PLAYER_PED_ID(), uLocal_319, sLocal_322, "idle_a", 8f, -8f, 0, 0, 1148846080, 0);
					PLAY_SYNCHRONIZED_ENTITY_ANIM(func_18(), uLocal_319, "idle_a_remote", sLocal_322, 8f, -8f, 0, 1148846080);
					if (_0x7F2F4F13AC5257EF(uLocal_319))
					{
						_SET_SYNCHRONIZED_SCENE_OCCLUSION_PORTAL(uLocal_319, 0);
					}
		...
		case 6:
			...
			HIDE_HUD_AND_RADAR_THIS_FRAME();
			DISABLE_CONTROL_ACTION(0, 0, 1);
			if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_319))
			{
				if (iLocal_316)
				{
					fVar3 = GET_SYNCHRONIZED_SCENE_PHASE(uLocal_319);
					if (fVar3 > 0.3f)
					{
						if (GET_TV_CHANNEL() == 0)
						{
		...
		case 7:
			...
			else
			{
				...
				{
					fVar3 = GET_SYNCHRONIZED_SCENE_PHASE(uLocal_319);
					if (FIND_ANIM_EVENT_PHASE(sLocal_322, "exit", "WalkInterruptible", &fVar4, &fVar5))
					{
...
void func_12(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	if (iParam0 != -1)
	{
		...
		{
			SET_TV_CHANNEL(-1);
			_LOAD_TV_CHANNEL_SEQUENCE(iParam1, func_13(iParam2), iParam4);
...
void func_16()
{
	_LOAD_TV_CHANNEL_SEQUENCE(0, func_13(1), 0);
	if (func_17(22))
	{
		_LOAD_TV_CHANNEL_SEQUENCE(1, func_13(12), 0);
	}
	else
	{
		_LOAD_TV_CHANNEL_SEQUENCE(1, func_13(2), 0);
	}
}
...
var func_18()
{
	...
	uVar0 = GET_CLOSEST_OBJECT_OF_TYPE(vLocal_309, 3f, joaat("prop_cs_remote_01"), 0, 0, 1);
	return uVar0;
}
		...
		if ((!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && !IS_ENTITY_ON_FIRE(PLAYER_PED_ID())) && IS_PLAYER_CONTROL_ON(PLAYER_ID()))
		{
			if (!IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				if ((((IS_GAMEPLAY_CAM_RENDERING() && !IS_CUTSCENE_PLAYING()) && !IS_CINEMATIC_CAM_RENDERING()) && !func_39(0)) && !func_38())
				{
					...
					if (func_36(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vParam0, fParam3, 0))
					{
						return 1;
					}
				}
...
int func_41()
{
	...
	uVar0 = GET_CLOSEST_OBJECT_OF_TYPE(vLocal_309, 10f, joaat("prop_cs_remote_01"), 0, 0, 1);
...
int func_42()
{
	...
	if (HAS_ANIM_DICT_LOADED(sLocal_322))
	{
		iLocal_318 = 1;
		return 1;
	}
...
void func_55()
{
	...
	if (DOES_CAM_EXIST(uLocal_321))
	{
		SET_CAM_ACTIVE(uLocal_321, 0);
		DESTROY_CAM(uLocal_321, 0);
	}
	func_10();
	if (iLocal_51)
	{
