...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_274)
		{
			...
			{
				case 0:
					if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_219, 100f, 100f, 100f, 0, 1, 0))
					{
						func_142();
					}
					if (iLocal_47)
...
void func_2()
{
	...
	if (!iLocal_279)
	{
		if (IS_ENTITY_DEAD(iLocal_226[0], 0) || IS_PED_INJURED(iLocal_226[0]))
		{
			func_53(&uLocal_54, 4);
			iLocal_279 = 1;
		}
	...
	if (!bLocal_260)
	{
		if ((IS_ENTITY_DEAD(uLocal_222, 0) || IS_PED_INJURED(uLocal_222)) || IS_PED_HURT(uLocal_222))
		{
			REQUEST_MODEL(joaat("prop_security_case_01"));
			if (HAS_MODEL_LOADED(joaat("prop_security_case_01")))
			{
				vLocal_271 = { GET_DEAD_PED_PICKUP_COORDS(uLocal_222, 1067030938, 1069547520) };
				vLocal_271.z = (vLocal_271.z + 0.3f);
				uLocal_292[0] = CREATE_PICKUP_ROTATE(joaat("pickup_money_case"), vLocal_271 + Vector(-0.49f, 0f, 0f), -90f, 0f, 0f, 0, 5000, 2, 1, joaat("prop_security_case_01"));
	...
	if (!bLocal_261)
	{
		if ((IS_ENTITY_DEAD(uLocal_223, 0) || IS_PED_INJURED(uLocal_223)) || IS_PED_HURT(uLocal_223))
		{
			REQUEST_MODEL(joaat("prop_security_case_01"));
			if (HAS_MODEL_LOADED(joaat("prop_security_case_01")))
			{
				vLocal_271 = { GET_DEAD_PED_PICKUP_COORDS(uLocal_223, 1067030938, 1069547520) };
				vLocal_271.z = (vLocal_271.z + 0.3f);
				uLocal_292[1] = CREATE_PICKUP_ROTATE(joaat("pickup_money_case"), vLocal_271 + Vector(-0.49f, 0f, 0f), -90f, 0f, 0f, 0, 5000, 2, 1, joaat("prop_security_case_01"));
	...
	if (!bLocal_284)
	{
		if (!iLocal_276)
		{
			if (DOES_ENTITY_EXIST(uLocal_222))
			{
				if (IS_ENTITY_DEAD(uLocal_222, 0) || IS_PED_INJURED(uLocal_222))
				{
					if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_222, PLAYER_PED_ID(), 1))
					{
						REMOVE_BLIP(&uLocal_295);
						iLocal_276 = 1;
						bLocal_50 = true;
						SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_267, 1862763509);
						if (!IS_PED_INJURED(uLocal_223))
						{
							TASK_COMBAT_PED(uLocal_223, PLAYER_PED_ID(), 0, 16);
							SET_PED_KEEP_TASK(uLocal_223, 1);
							REGISTER_TARGET(uLocal_223, PLAYER_PED_ID());
							_0x52D59AB61DDC05DD(uLocal_223, 1);
							func_53(&uLocal_54, 5);
		...
		if (!iLocal_275)
		{
			if (DOES_ENTITY_EXIST(uLocal_223))
			{
				if (IS_ENTITY_DEAD(uLocal_223, 0) || IS_PED_INJURED(uLocal_223))
				{
					if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_223, PLAYER_PED_ID(), 1))
					{
						REMOVE_BLIP(&uLocal_296);
						iLocal_275 = 1;
						bLocal_50 = true;
						SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_267, 1862763509);
						if (!IS_PED_INJURED(uLocal_222))
						{
							TASK_COMBAT_PED(uLocal_222, PLAYER_PED_ID(), 0, 16);
							SET_PED_KEEP_TASK(uLocal_222, 1);
							REGISTER_TARGET(uLocal_222, PLAYER_PED_ID());
							_0x52D59AB61DDC05DD(uLocal_222, 1);
							func_38(&uLocal_54, "recsbau", "recsb_deadcr", 3, 0, 0, 0);
						}
					}
				}
		...
		if (func_37() || !IS_ENTITY_AT_COORD(PLAYER_PED_ID(), 310.6203f, 2642.854f, 43.5173f, 150f, 150f, 180f, 0, 1, 0))
		{
			if (IS_PED_INJURED(uLocal_222) && IS_PED_INJURED(uLocal_223))
			{
				if (func_37() && !IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_219, 50f, 50f, 50f, 0, 1, 0))
				{
					func_7();
				}
				if (bLocal_50 && !bLocal_49)
				{
					if (!IS_ENTITY_AT_COORD(PLAYER_PED_ID(), 310.6203f, 2642.854f, 43.5173f, 150f, 150f, 180f, 0, 1, 0))
					{
						func_6(5);
						func_7();
					}
			...
			else if (!IS_ENTITY_AT_COORD(PLAYER_PED_ID(), 310.6203f, 2642.854f, 43.5173f, 200f, 200f, 180f, 0, 1, 0))
			{
				func_5();
			}
		}
	...
	if (bLocal_284)
	{
		if (func_37())
		{
			if (IS_ENTITY_DEAD(uLocal_222, 0) && IS_ENTITY_DEAD(uLocal_223, 0))
			{
				func_7();
			}
			if (bLocal_284)
			{
				if (DOES_ENTITY_EXIST(uLocal_222))
				{
					if (!IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_222, 150f, 150f, 150f, 0, 0, 0))
					{
						if (!bLocal_50)
						{
							func_6(6);
				...
				if (!DOES_ENTITY_EXIST(uLocal_223))
				{
					if (!IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_223, 150f, 150f, 150f, 0, 0, 0))
					{
						if (!bLocal_50)
						{
							func_6(6);
	...
	else if (!iLocal_266 && !bLocal_49)
	{
		...
		if (((IS_ENTITY_DEAD(uLocal_222, 0) && IS_ENTITY_DEAD(uLocal_223, 0)) && HAS_MODEL_LOADED(joaat("ambulance"))) && HAS_ANIM_DICT_LOADED("random@countrysiderobbery"))
		{
			REMOVE_BLIP(&uLocal_295);
			REMOVE_BLIP(&uLocal_296);
			func_53(&uLocal_54, 5);
			...
			SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_268, 1862763509);
			ENABLE_DISPATCH_SERVICE(5, 1);
			ENABLE_DISPATCH_SERVICE(3, 1);
			if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), 267.94f, 2700.48f, 43.6f, 15f, 15f, 15f, 0, 1, 0))
			{
				uLocal_237 = CREATE_VEHICLE(joaat("ambulance"), 267.94f, 2700.48f, 43.1f, 180f, 1, 1, 0);
			}
			else
			{
				uLocal_237 = CREATE_VEHICLE(joaat("ambulance"), 185.94f, 2603.48f, 46.9f, 0f, 1, 1, 0);
			}
			SET_VEHICLE_SIREN(uLocal_237, 1);
			uLocal_224 = CREATE_PED_INSIDE_VEHICLE(uLocal_237, 20, joaat("s_m_m_paramedic_01"), -1, 1, 1);
			uLocal_225 = CREATE_PED_INSIDE_VEHICLE(uLocal_237, 20, joaat("s_m_m_paramedic_01"), 0, 1, 1);
			SET_PED_COMBAT_ATTRIBUTES(uLocal_224, 17, 1);
			SET_PED_COMBAT_ATTRIBUTES(uLocal_225, 17, 1);
			SET_PED_CONFIG_FLAG(uLocal_224, 185, 1);
			SET_PED_CONFIG_FLAG(uLocal_225, 185, 1);
			if (DOES_ENTITY_EXIST(uLocal_222))
			{
				OPEN_SEQUENCE_TASK(&uLocal_269);
				TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_237, 307.1379f, 2640.042f, 43.4639f, 18f, 0, joaat("ambulance"), 786475, 5f, 5f);
				TASK_GO_TO_ENTITY(0, uLocal_222, -1, 2f, 1f, 10f, 0);
				TASK_LOOK_AT_ENTITY(0, uLocal_222, -1, 2052, 2);
				TASK_TURN_PED_TO_FACE_ENTITY(0, uLocal_222, 0);
				TASK_PLAY_ANIM(0, "random@countrysiderobbery", "enter", 2f, -2f, -1, 0, 0, 0, 0, 0);
				TASK_PLAY_ANIM(0, "random@countrysiderobbery", "base", 2f, -2f, -1, 1, 0, 0, 0, 0);
				CLOSE_SEQUENCE_TASK(uLocal_269);
				TASK_PERFORM_SEQUENCE(uLocal_224, uLocal_269);
				CLEAR_SEQUENCE_TASK(&uLocal_269);
				SET_PED_KEEP_TASK(uLocal_224, 1);
			}
			if (DOES_ENTITY_EXIST(uLocal_223))
			{
				OPEN_SEQUENCE_TASK(&uLocal_269);
				TASK_PAUSE(0, 15000);
				TASK_GO_TO_ENTITY(0, uLocal_223, -1, 2f, 1f, 10f, 0);
				TASK_LOOK_AT_ENTITY(0, uLocal_223, -1, 2052, 2);
				TASK_TURN_PED_TO_FACE_ENTITY(0, uLocal_223, 0);
				TASK_PLAY_ANIM(0, "random@countrysiderobbery", "enter", 2f, -2f, -1, 0, 0, 0, 0, 0);
				TASK_PLAY_ANIM(0, "random@countrysiderobbery", "base", 2f, -2f, -1, 1, 0, 0, 0, 0);
				CLOSE_SEQUENCE_TASK(uLocal_269);
				TASK_PERFORM_SEQUENCE(uLocal_225, uLocal_269);
				CLEAR_SEQUENCE_TASK(&uLocal_269);
				SET_PED_KEEP_TASK(uLocal_225, 1);
			}
			if (!IS_PED_INJURED(iLocal_226[0]) && DOES_ENTITY_EXIST(uLocal_236))
			{
				SET_PED_CONFIG_FLAG(iLocal_226[0], 185, 1);
				OPEN_SEQUENCE_TASK(&uLocal_269);
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, GET_ENTITY_COORDS(uLocal_236, 0) + Vector(0f, 5f, 0f), 1f, -1, 1048576000, 0, 1193033728);
				TASK_SWAP_WEAPON(0, 0);
				TASK_PLAY_ANIM(0, "random@countrysiderobbery", "idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
				TASK_PLAY_ANIM(0, "random@countrysiderobbery", "idle_d", 2f, -2f, -1, 1, 0, 0, 0, 0);
				CLOSE_SEQUENCE_TASK(uLocal_269);
				TASK_PERFORM_SEQUENCE(iLocal_226[0], uLocal_269);
				CLEAR_SEQUENCE_TASK(&uLocal_269);
				SET_PED_KEEP_TASK(iLocal_226[0], 1);
			}
			if (!IS_ENTITY_DEAD(iLocal_226[1], 0) && DOES_ENTITY_EXIST(uLocal_230))
			{
				SET_PED_CONFIG_FLAG(iLocal_226[1], 185, 1);
				SET_CURRENT_PED_WEAPON(iLocal_226[1], joaat("weapon_unarmed"), 1);
				OPEN_SEQUENCE_TASK(&uLocal_269);
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, GET_ENTITY_COORDS(uLocal_230, 0) + Vector(0f, 1f, 0f), 2f, -1, 1048576000, 0, 1193033728);
				TASK_LOOK_AT_COORD(0, GET_ENTITY_COORDS(uLocal_230, 0), -1, 2052, 2);
				TASK_TURN_PED_TO_FACE_COORD(0, GET_ENTITY_COORDS(uLocal_230, 0), 0);
				TASK_PLAY_ANIM(0, "random@countrysiderobbery", "enter", 2f, -2f, -1, 0, 0, 0, 0, 0);
				TASK_PLAY_ANIM(0, "random@countrysiderobbery", "base", 2f, -2f, -1, 1, 0, 0, 0, 0);
				CLOSE_SEQUENCE_TASK(uLocal_269);
				TASK_PERFORM_SEQUENCE(iLocal_226[1], uLocal_269);
				CLEAR_SEQUENCE_TASK(&uLocal_269);
				SET_PED_KEEP_TASK(iLocal_226[1], 1);
			}
			if (!IS_PED_INJURED(iLocal_226[2]) && DOES_ENTITY_EXIST(uLocal_223))
			{
				SET_PED_CONFIG_FLAG(iLocal_226[2], 185, 1);
				if (DOES_ENTITY_EXIST(uLocal_223))
				{
					OPEN_SEQUENCE_TASK(&uLocal_269);
					TASK_FOLLOW_NAV_MESH_TO_COORD(0, GET_ENTITY_COORDS(uLocal_223, 0) + Vector(0f, 1f, 0f), 1f, -1, 1048576000, 0, 1193033728);
					TASK_SWAP_WEAPON(0, 0);
					TASK_PLAY_ANIM(0, "random@countrysiderobbery", "idle_d", 2f, -2f, -1, 0, 0, 0, 0, 0);
					TASK_PLAY_ANIM(0, "random@countrysiderobbery", "idle_a", 2f, -2f, -1, 1, 0, 0, 0, 0);
					CLOSE_SEQUENCE_TASK(uLocal_269);
					TASK_PERFORM_SEQUENCE(iLocal_226[2], uLocal_269);
					CLEAR_SEQUENCE_TASK(&uLocal_269);
				}
				SET_PED_KEEP_TASK(iLocal_226[2], 1);
			}
			func_3();
			WAIT(0);
			if (!IS_PED_INJURED(iLocal_226[0]))
			{
				func_50(&uLocal_54, 4, iLocal_226[0], "RECSBCop1", 0, 1);
				func_38(&uLocal_54, "recsbau", "recsb_ntouch", 4, 0, 0, 0);
			}
			else if (!IS_PED_INJURED(iLocal_226[1]))
			{
			...
			else if (!IS_PED_INJURED(iLocal_226[2]))
			{
	...
	if (((((IS_ENTITY_DEAD(uLocal_222, 0) && IS_ENTITY_DEAD(uLocal_223, 0)) && IS_ENTITY_DEAD(iLocal_226[0], 0)) && IS_ENTITY_DEAD(iLocal_226[1], 0)) && IS_ENTITY_DEAD(iLocal_226[2], 0)) && (func_37() || !IS_ENTITY_AT_COORD(PLAYER_PED_ID(), 310.6203f, 2642.854f, 43.5173f, 200f, 200f, 180f, 0, 1, 0)))
	{
...
void func_13()
{
	...
	{
		func_15(13, FLOOR(Global_106565.f_10188.f_3853));
	}
...
int func_51(var uParam0)
{
	...
	SET_BLIP_SCALE(uVar0, func_52(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
	return uVar0;
}
...
void func_54()
{
	if (!iLocal_282)
	{
		if (!IS_PED_INJURED(uLocal_222))
		{
			if (IS_PED_IN_ANY_VEHICLE(uLocal_222, 0))
			{
				uLocal_291 = GET_VEHICLE_PED_IS_IN(uLocal_222, 0);
				if (((((HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_291, PLAYER_PED_ID(), 1) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0)) && IS_ENTITY_AT_ENTITY(uLocal_291, PLAYER_PED_ID(), 10f, 10f, 10f, 0, 1, 0)) || IS_PED_BEING_JACKED(uLocal_222)) || IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_291, 0)) || HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(PLAYER_PED_ID(), uLocal_291, joaat("weapon_stickybomb"), -1))
				{
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_222, 0);
					SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_267, 1862763509);
					if (IS_PED_IN_ANY_VEHICLE(uLocal_222, 0))
					{
						GIVE_WEAPON_TO_PED(uLocal_222, joaat("weapon_microsmg"), 200, 1, 1);
						SET_CURRENT_PED_WEAPON(uLocal_222, joaat("weapon_microsmg"), 1);
						TASK_DRIVE_BY(uLocal_222, PLAYER_PED_ID(), 0, 0f, 0f, 0f, 200f, 50, 0, -753768974);
					}
					if (!IS_PED_INJURED(uLocal_223))
					{
						if (IS_PED_IN_ANY_VEHICLE(uLocal_223, 0))
						{
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_223, 0);
							GIVE_WEAPON_TO_PED(uLocal_223, joaat("weapon_microsmg"), 200, 1, 1);
							SET_CURRENT_PED_WEAPON(uLocal_223, joaat("weapon_microsmg"), 1);
							TASK_DRIVE_BY(uLocal_223, PLAYER_PED_ID(), 0, 0f, 0f, 0f, 200f, 50, 0, -753768974);
						}
					}
					bLocal_50 = true;
					iLocal_282 = 1;
			...
			{
				SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_267, 1862763509);
				if ((IS_PED_IN_ANY_VEHICLE(uLocal_222, 0) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0)) && !IS_ENTITY_DEAD(uLocal_291, 0))
				{
					if (IS_ENTITY_AT_ENTITY(uLocal_291, PLAYER_PED_ID(), 10f, 10f, 10f, 0, 1, 0))
					{
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_222, 0);
						GIVE_WEAPON_TO_PED(uLocal_222, joaat("weapon_microsmg"), 200, 1, 1);
						SET_CURRENT_PED_WEAPON(uLocal_222, joaat("weapon_microsmg"), 1);
				...
				if (!IS_PED_INJURED(uLocal_223))
				{
					if ((IS_PED_IN_ANY_VEHICLE(uLocal_223, 0) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0)) && !IS_ENTITY_DEAD(uLocal_291, 0))
					{
						if (IS_ENTITY_AT_ENTITY(uLocal_291, PLAYER_PED_ID(), 10f, 10f, 10f, 0, 1, 0))
						{
							SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_223, 0);
		...
		if (!IS_PED_INJURED(uLocal_223))
		{
			if (IS_PED_IN_ANY_VEHICLE(uLocal_223, 0))
			{
				uLocal_291 = GET_VEHICLE_PED_IS_IN(uLocal_223, 0);
				if (((HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_291, PLAYER_PED_ID(), 1) || IS_PED_BEING_JACKED(uLocal_223)) || IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_291, 0)) || HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(PLAYER_PED_ID(), uLocal_291, joaat("weapon_stickybomb"), -1))
				{
					SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_267, 1862763509);
					if (!IS_PED_INJURED(uLocal_222))
					{
...
void func_55()
{
	if (!IS_PED_INJURED(uLocal_222) && !IS_ENTITY_DEAD(uLocal_236, 0))
	{
		if (!_0x639431E895B9AA57(uLocal_222, uLocal_236, -1, 0, 0) && !_0x639431E895B9AA57(uLocal_222, uLocal_236, 0, 0, 0))
		{
			TASK_SMART_FLEE_COORD(uLocal_222, vLocal_219, 1000f, -1, 0, 0);
			SET_PED_KEEP_TASK(uLocal_222, 1);
			iLocal_285 = 1;
		}
	}
	if (!IS_PED_INJURED(uLocal_223) && !IS_ENTITY_DEAD(uLocal_236, 0))
	{
		if (!_0x639431E895B9AA57(uLocal_223, uLocal_236, -1, 0, 0) && !_0x639431E895B9AA57(uLocal_223, uLocal_236, 0, 0, 0))
		{
			TASK_SMART_FLEE_COORD(uLocal_223, vLocal_219, 1000f, -1, 0, 0);
			SET_PED_KEEP_TASK(uLocal_223, 1);
			iLocal_285 = 1;
		}
	}
...
void func_56()
{
	if (!IS_ENTITY_DEAD(uLocal_222, 0))
	{
		vLocal_271 = { GET_ENTITY_COORDS(uLocal_222, 1) };
	}
	else if (!IS_ENTITY_DEAD(uLocal_223, 0))
	{
		vLocal_271 = { GET_ENTITY_COORDS(uLocal_223, 1) };
	}
	...
	if (!IS_ENTITY_DEAD(uLocal_222, 0))
	{
		...
		if (!bLocal_50)
		{
			...
			CREATE_MONEY_PICKUPS(GET_SAFE_PICKUP_COORDS(vLocal_271, 1067030938, 1069547520), 1000, 5, 0);
			iLocal_281 = 1;
		}
	}
	if (!IS_ENTITY_DEAD(uLocal_223, 0) && !IS_ENTITY_DEAD(uLocal_236, 0))
	{
		if (IS_PED_IN_VEHICLE(uLocal_223, uLocal_236, 0))
		{
			SETTIMERA(0);
			if (!IS_ENTITY_DEAD(uLocal_222, 0))
			{
...
void func_58()
{
	if (!bLocal_284)
	{
		...
		if (iLocal_265 == 1)
		{
			if (!IS_PED_INJURED(uLocal_222) && !IS_ENTITY_DEAD(uLocal_236, 0))
			{
				if (IS_PED_IN_VEHICLE(uLocal_222, uLocal_236, 0))
				{
					SET_PED_FLEE_ATTRIBUTES(uLocal_222, 2, 1);
					OPEN_SEQUENCE_TASK(&uLocal_269);
					TASK_VEHICLE_MISSION_PED_TARGET(0, uLocal_236, PLAYER_PED_ID(), 8, 100f, 786469, 1000f, 10f, 1);
					CLOSE_SEQUENCE_TASK(uLocal_269);
					TASK_PERFORM_SEQUENCE(uLocal_222, uLocal_269);
					CLEAR_SEQUENCE_TASK(&uLocal_269);
					SET_PED_KEEP_TASK(uLocal_222, 1);
					bLocal_284 = true;
				}
		...
		if (iLocal_265 == 2)
		{
			if (!IS_PED_INJURED(uLocal_223) && !IS_ENTITY_DEAD(uLocal_236, 0))
			{
				if (IS_PED_IN_VEHICLE(uLocal_223, uLocal_236, 0))
				{
					SET_PED_FLEE_ATTRIBUTES(uLocal_223, 2, 1);
					OPEN_SEQUENCE_TASK(&uLocal_269);
					TASK_VEHICLE_MISSION_PED_TARGET(0, uLocal_236, PLAYER_PED_ID(), 8, 100f, 786469, 1000f, 10f, 1);
					CLOSE_SEQUENCE_TASK(uLocal_269);
					TASK_PERFORM_SEQUENCE(uLocal_223, uLocal_269);
					CLEAR_SEQUENCE_TASK(&uLocal_269);
					SET_PED_KEEP_TASK(uLocal_223, 1);
					bLocal_284 = true;
				}
		...
		if (iLocal_265 == 3)
		{
			if ((!IS_PED_INJURED(uLocal_223) && !IS_PED_INJURED(uLocal_222)) && !IS_ENTITY_DEAD(uLocal_236, 0))
			{
				if (IS_PED_IN_VEHICLE(uLocal_222, uLocal_236, 0) && IS_PED_IN_VEHICLE(uLocal_223, uLocal_236, 0))
				{
					SET_PED_FLEE_ATTRIBUTES(uLocal_222, 2, 1);
					SET_PED_FLEE_ATTRIBUTES(uLocal_223, 2, 1);
					OPEN_SEQUENCE_TASK(&uLocal_269);
			...
			{
				func_53(&uLocal_54, 5);
				TASK_ENTER_VEHICLE(uLocal_223, uLocal_236, -1, -1, 2f, 8, 0);
				iLocal_265 = 2;
			}
			if (IS_PED_INJURED(uLocal_223) && !IS_PED_INJURED(uLocal_222))
			{
				func_53(&uLocal_54, 6);
				TASK_ENTER_VEHICLE(uLocal_222, uLocal_236, -1, -1, 2f, 8, 0);
				iLocal_265 = 1;
			}
		}
		if (iLocal_265 == 4)
		{
			if (!IS_PED_INJURED(uLocal_222))
			{
				CLEAR_PED_TASKS(uLocal_222);
				TASK_SMART_FLEE_COORD(uLocal_222, vLocal_219, 1000f, -1, 0, 0);
				SET_PED_KEEP_TASK(uLocal_222, 1);
			}
			if (!IS_PED_INJURED(uLocal_223))
			{
				CLEAR_PED_TASKS(uLocal_223);
				TASK_SMART_FLEE_COORD(uLocal_223, vLocal_219, 1000f, -1, 0, 0);
				SET_PED_KEEP_TASK(uLocal_223, 1);
			}
			bLocal_284 = true;
...
void func_59()
{
	if ((IS_ENTITY_DEAD(iLocal_226[0], 0) && IS_ENTITY_DEAD(iLocal_226[1], 0)) && IS_ENTITY_DEAD(iLocal_226[2], 0))
	{
		func_53(&uLocal_54, 4);
		iLocal_274 = 1;
		iLocal_264 = 1;
		SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_267, 1862763509);
		if (!bLocal_50 && bLocal_49)
		{
			REMOVE_BLIP(&uLocal_295);
			REMOVE_BLIP(&uLocal_296);
		...
		if (IS_VEHICLE_DRIVEABLE(uLocal_236, 0))
		{
			CLEAR_ENTITY_LAST_DAMAGE_ENTITY(uLocal_236);
			if (!IS_PED_INJURED(uLocal_222) && !IS_PED_HURT(uLocal_222))
			{
				SET_PED_CURRENT_WEAPON_VISIBLE(uLocal_222, 1, 1, 1, 0);
				iLocal_265 = 1;
				CLEAR_PED_TASKS(uLocal_222);
				TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_222, 1);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_222, 1);
				CLEAR_ENTITY_LAST_DAMAGE_ENTITY(uLocal_222);
				CLEAR_ENTITY_LAST_DAMAGE_ENTITY(uLocal_236);
				OPEN_SEQUENCE_TASK(&uLocal_269);
				TASK_ENTER_VEHICLE(0, uLocal_236, -1, -1, 2f, 9, 0);
				CLOSE_SEQUENCE_TASK(uLocal_269);
				TASK_PERFORM_SEQUENCE(uLocal_222, uLocal_269);
				CLEAR_SEQUENCE_TASK(&uLocal_269);
				if (!IS_PED_INJURED(uLocal_223) && !IS_PED_HURT(uLocal_223))
				{
					CLEAR_PED_TASKS(uLocal_223);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_223, 1);
					CLEAR_ENTITY_LAST_DAMAGE_ENTITY(uLocal_223);
					CLEAR_ENTITY_LAST_DAMAGE_ENTITY(uLocal_236);
					TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_223, 1);
					TASK_ENTER_VEHICLE(uLocal_223, uLocal_236, -1, 0, 2f, 1, 0);
					iLocal_265 = 3;
				}
			}
			else if (!IS_PED_INJURED(uLocal_223))
			{
				TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_223, 1);
				SET_PED_CURRENT_WEAPON_VISIBLE(uLocal_223, 1, 1, 1, 0);
				CLEAR_PED_TASKS(uLocal_223);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_223, 1);
				CLEAR_ENTITY_LAST_DAMAGE_ENTITY(uLocal_223);
				CLEAR_ENTITY_LAST_DAMAGE_ENTITY(uLocal_236);
				OPEN_SEQUENCE_TASK(&uLocal_269);
				TASK_ENTER_VEHICLE(0, uLocal_236, -1, -1, 2f, 1, 0);
				CLOSE_SEQUENCE_TASK(uLocal_269);
				TASK_PERFORM_SEQUENCE(uLocal_223, uLocal_269);
				CLEAR_SEQUENCE_TASK(&uLocal_269);
				iLocal_265 = 2;
...
void func_61(var uParam0, var uParam1, int iParam2, float fParam3)
{
	...
	if (!IS_ENTITY_DEAD(uParam0, 0))
	{
		if (*uParam1 < 5)
		{
			...
			if (HAS_BULLET_IMPACTED_IN_AREA(GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, vVar0), fParam3, 1, 1) || HAS_BULLET_IMPACTED_IN_AREA(GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, vVar0), fParam3, 0, 1))
			{
				switch (*uParam1)
				{
					case 0:
						SET_VEHICLE_TYRE_BURST(uParam0, iParam2, 0, 1148846080);
						*uParam1++;
						break;
					
					case 1:
						SMASH_VEHICLE_WINDOW(uParam0, iVar6);
						*uParam1++;
						break;
					...
					case 4:
						SET_VEHICLE_DAMAGE(uParam0, vVar3, 150f, 50f, 1);
						*uParam1++;
						break;
					}
				}
...
{
	if ((!IS_PED_INJURED(uParam0) && !func_36()) && TIMERA() > 12000)
	{
		func_50(&uLocal_54, 4, uParam0, "RECSBCop1", 0, 1);
		if (IS_ENTITY_AT_ENTITY(uParam0, PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0))
		{
...
void func_63()
{
	if (!IS_ENTITY_DEAD(uLocal_222, 0))
	{
		...
		if (!IS_PED_INJURED(uLocal_222))
		{
			if (!func_66() && IS_PED_ARMED(PLAYER_PED_ID(), 4))
			{
				if (IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uLocal_222) || IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uLocal_222))
				{
					if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_222, 20f, 20f, 20f, 0, 1, 0) && HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(uLocal_222, PLAYER_PED_ID()))
					{
						iLocal_240++;
	...
	if (!IS_ENTITY_DEAD(uLocal_223, 0))
	{
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_223, PLAYER_PED_ID(), 1))
		{
			bLocal_50 = true;
		...
		if (!IS_PED_INJURED(uLocal_223))
		{
			if (!func_66() && IS_PED_ARMED(PLAYER_PED_ID(), 4))
			{
				if (IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), uLocal_223) || IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), uLocal_223))
				{
					if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), uLocal_223, 20f, 20f, 20f, 0, 1, 0) && HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(uLocal_223, PLAYER_PED_ID()))
					{
						if ((!iLocal_242 && !IS_PED_INJURED(uLocal_222)) && !func_64("recsb_theaim"))
						{
							func_3();
							WAIT(0);
							if (!IS_PED_INJURED(uLocal_222))
	...
	{
		if (HAS_PICKUP_BEEN_COLLECTED(uLocal_292[0]))
		{
			if (!IS_PED_INJURED(uLocal_222))
			{
				if (HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(uLocal_222, PLAYER_PED_ID()) && IS_ENTITY_AT_ENTITY(uLocal_222, PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0))
				{
					bLocal_50 = true;
					func_3();
					WAIT(0);
			...
			{
				if (HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(uLocal_223, PLAYER_PED_ID()) && IS_ENTITY_AT_ENTITY(uLocal_223, PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0))
				{
					bLocal_50 = true;
					func_53(&uLocal_54, 5);
					func_50(&uLocal_54, 5, uLocal_223, "RECSBRobber1", 0, 1);
	...
	{
		if (HAS_PICKUP_BEEN_COLLECTED(uLocal_292[1]))
		{
			if (!IS_PED_INJURED(uLocal_222))
			{
				if (HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(uLocal_222, PLAYER_PED_ID()) && IS_ENTITY_AT_ENTITY(uLocal_222, PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0))
	...
	if (!IS_ENTITY_DEAD(uLocal_236, 0))
	{
		if ((HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_236, PLAYER_PED_ID(), 1) || IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_236, 0)) || HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(PLAYER_PED_ID(), uLocal_236, joaat("weapon_stickybomb"), -1))
		{
			bLocal_50 = true;
			SETTIMERA(0);
			SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_267, 1862763509);
			...
			if (!IS_ENTITY_DEAD(uLocal_236, 0))
			{
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_236, 0))
				{
					if (!IS_PED_INJURED(uLocal_222))
					{
						func_60(&uLocal_54, "recsbau", "recsb_deadcr", "recsb_deadcr_1", 4, 0, 0);
						TASK_ENTER_VEHICLE(uLocal_222, uLocal_236, -1, -1, 2f, 524296, 0);
					}
					else if (!IS_PED_INJURED(uLocal_223))
					{
						func_53(&uLocal_54, 5);
						func_50(&uLocal_54, 5, uLocal_223, "RECSBRobber1", 0, 1);
						func_60(&uLocal_54, "recsbau", "recsb_deadcr", "recsb_deadcr_1", 4, 0, 0);
						TASK_ENTER_VEHICLE(uLocal_223, uLocal_236, -1, -1, 2f, 524296, 0);
					}
				}
				else if (!bLocal_49)
				{
...
void func_67()
{
	...
	if (!bLocal_286)
	{
		GET_ENTITY_PLAYER_IS_FREE_AIMING_AT(PLAYER_ID(), &uLocal_270);
		if (IS_ENTITY_A_PED(uLocal_270))
		{
			iLocal_231 = GET_PED_INDEX_FROM_ENTITY_INDEX(uLocal_270);
		}
		if ((iLocal_231 == iLocal_226[0] || iLocal_231 == iLocal_226[1]) || iLocal_231 == iLocal_226[2])
		{
			if (!IS_PED_INJURED(iLocal_231))
			{
				if (!func_66() && IS_PED_ARMED(PLAYER_PED_ID(), 4))
				{
					if (IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), iLocal_231) || IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), iLocal_231))
					{
						if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_231, 20f, 20f, 20f, 0, 1, 0))
						{
							if (HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_231, PLAYER_PED_ID()) || IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), iLocal_231, 8f, 8f, 8f, 0, 1, 0))
							{
								if (!bLocal_287)
								{
								...
								if (iLocal_238 > 40)
								{
									bLocal_286 = true;
									bLocal_49 = true;
									if (!IS_ENTITY_DEAD(uLocal_270, 0))
									{
										SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_268, 1862763509);
										iVar0 = 0;
										while (iVar0 < iLocal_226)
										{
											if (!IS_PED_INJURED(iLocal_226[iVar0]))
											{
												TASK_COMBAT_PED(iLocal_226[iVar0], PLAYER_PED_ID(), 0, 16);
												SET_PED_KEEP_TASK(iLocal_226[iVar0], 1);
												REGISTER_TARGET(iLocal_226[iVar0], PLAYER_PED_ID());
	...
	{
		if (DOES_ENTITY_EXIST(iLocal_226[iVar1]))
		{
			if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_226[iVar1], PLAYER_PED_ID(), 1))
			{
				bLocal_49 = true;
			}
			if (IS_VEHICLE_DRIVEABLE(GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_226[iVar1], GET_PLAYERS_LAST_VEHICLE(), 1))
				{
					bLocal_49 = true;
				}
			}
	...
	if (iLocal_266)
	{
		if (TIMERB() > 6000)
		{
			...
			if (IS_PED_SHOOTING_IN_AREA(PLAYER_PED_ID(), Vector(43.5005f, 2626.29f, 326.6079f) - Vector(50f, 50f, 50f), Vector(43.5005f, 2626.29f, 326.6079f) + Vector(50f, 50f, 50f), 0, 1))
			{
				bLocal_49 = true;
			}
			if (!IS_ENTITY_DEAD(uLocal_236, 0))
		...
		while (iVar1 < iLocal_226)
		{
			if (!IS_PED_INJURED(iLocal_226[iVar1]))
			{
				if (HAS_PICKUP_BEEN_COLLECTED(uLocal_292[0]) || HAS_PICKUP_BEEN_COLLECTED(uLocal_292[1]))
				{
					if (HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_226[iVar1], PLAYER_PED_ID()) && IS_ENTITY_AT_ENTITY(iLocal_226[iVar1], PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0))
					{
						bLocal_49 = true;
						func_3();
						WAIT(0);
				...
				if (IS_ENTITY_TOUCHING_ENTITY(PLAYER_PED_ID(), iLocal_226[iVar1]))
				{
		...
		if (!IS_PED_INJURED(iLocal_226[1]) && !IS_ENTITY_DEAD(iLocal_232[2], 0))
		{
			if (!IS_ENTITY_AT_ENTITY(iLocal_226[1], PLAYER_PED_ID(), 100f, 100f, 100f, 0, 1, 0))
			{
	...
	{
		if (!IS_ENTITY_DEAD(iLocal_232[iVar1], 0))
		{
			if ((HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_232[iVar1], PLAYER_PED_ID(), 1) || IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_232[iVar1], 0)) || HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(PLAYER_PED_ID(), iLocal_232[iVar1], joaat("weapon_stickybomb"), -1))
			{
				bLocal_49 = true;
			}
			if (IS_VEHICLE_DRIVEABLE(GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_232[iVar1], GET_PLAYERS_LAST_VEHICLE(), 1))
				{
					bLocal_49 = true;
				}
			}
	...
	if (!IS_ENTITY_DEAD(uLocal_237, 0))
	{
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_237, PLAYER_PED_ID(), 1) || IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_237, 0))
		{
			bLocal_49 = true;
		}
	}
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
		if (IS_PED_IN_MODEL(PLAYER_PED_ID(), joaat("towtruck")) || IS_PED_IN_MODEL(PLAYER_PED_ID(), joaat("towtruck2")))
		{
			...
			if (iLocal_266)
			{
				if (!IS_ENTITY_DEAD(uLocal_236, 0))
				{
					if (IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uVar2, uLocal_236))
					{
						bLocal_49 = true;
						func_3();
						WAIT(0);
			...
			while (iVar1 < iLocal_232)
			{
				if (!IS_ENTITY_DEAD(iLocal_232[iVar1], 0))
				{
					if (IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uVar2, iLocal_232[iVar1]))
					{
						bLocal_49 = true;
					}
				}
			...
			if (!IS_ENTITY_DEAD(uLocal_237, 0))
			{
				if (IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uVar2, uLocal_237))
				{
					bLocal_49 = true;
				}
			}
	...
	if (bLocal_49 || bLocal_286)
	{
		...
		bLocal_49 = true;
		if (!IS_ENTITY_DEAD(uLocal_236, 0) && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_236, 0))
		{
		}
		else
		{
			...
			else if (!IS_PED_INJURED(iLocal_226[0]))
			{
				func_50(&uLocal_54, 4, iLocal_226[0], "RECSBCop1", 0, 1);
		...
		if (iLocal_266)
		{
			...
			while (iVar1 < iLocal_226)
			{
				if (!IS_PED_INJURED(iLocal_226[iVar1]))
				{
					TASK_COMBAT_PED(iLocal_226[iVar1], PLAYER_PED_ID(), 0, 16);
					SET_PED_KEEP_TASK(iLocal_226[iVar1], 1);
					REGISTER_TARGET(iLocal_226[iVar1], PLAYER_PED_ID());
					...
					SET_PED_COMBAT_ATTRIBUTES(iLocal_226[iVar1], 50, 1);
				}
				iVar1++;
			}
		}
	}
	if (DOES_ENTITY_EXIST(uLocal_224))
	{
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_224, PLAYER_PED_ID(), 1))
		{
			SET_POLICE_IGNORE_PLAYER(PLAYER_ID(), 0);
			SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_268, 1862763509);
			bLocal_49 = true;
	...
	if (DOES_ENTITY_EXIST(uLocal_225))
	{
		if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_225, PLAYER_PED_ID(), 1))
		{
			SET_POLICE_IGNORE_PLAYER(PLAYER_ID(), 0);
			SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_268, 1862763509);
			bLocal_49 = true;
...
int func_72()
{
	switch (func_73(&Global_25824, 0, 5, 0, GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
void func_78()
{
	...
	if ((!IS_PED_INJURED(iLocal_226[0]) && !IS_PED_INJURED(PLAYER_PED_ID())) && !IS_PED_INJURED(uLocal_222))
	{
	}
	if ((IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 220.6075f, 2615.145f, 35.8465f, 440.8339f, 2684.23f, 72.6324f, 183.125f, 0, 1, 0) && IS_SPHERE_VISIBLE(vLocal_219, 1f)) || IS_ENTITY_AT_COORD(PLAYER_PED_ID(), 325.6556f, 2647.021f, 43.6289f, 30f, 30f, 30f, 0, 1, 0))
	{
		iVar0 = 0;
		while (iVar0 < iLocal_226)
		{
			if (!IS_PED_INJURED(iLocal_226[iVar0]))
			{
				SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(iLocal_226[iVar0], 1, uLocal_267);
				if (!DOES_BLIP_EXIST(uLocal_297[iVar0]))
				{
					uLocal_297[iVar0] = func_79(iLocal_226[iVar0], 0, 145);
					_0x75A16C3DA34F1245(uLocal_297[iVar0], 0);
				}
			}
			iVar0++;
		}
		if (!IS_ENTITY_DEAD(uLocal_222, 0) || (!IS_PED_INJURED(uLocal_222) && !iLocal_277))
		{
			SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(uLocal_222, 1, uLocal_268);
			uLocal_295 = func_79(uLocal_222, 0, 145);
			_0x75A16C3DA34F1245(uLocal_295, 0);
			iLocal_276 = 0;
			iLocal_277 = 1;
		}
		if (!IS_ENTITY_DEAD(uLocal_223, 0) || (!IS_PED_INJURED(uLocal_223) && !iLocal_278))
		{
			SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(uLocal_223, 1, uLocal_268);
			uLocal_296 = func_79(uLocal_223, 0, 145);
			_0x75A16C3DA34F1245(uLocal_296, 0);
			iLocal_275 = 0;
			iLocal_278 = 1;
		}
		SETTIMERA(0);
...
int func_80(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_52(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
...
void func_82()
{
	...
	if (!iLocal_280)
	{
		...
		{
			if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), 325.6556f, 2647.021f, 43.6289f, 30f, 30f, 30f, 0, 1, 0))
			{
				iVar0 = 0;
				while (iVar0 < iLocal_226)
				{
					if (DOES_BLIP_EXIST(uLocal_297[iVar0]))
					{
						_0x75A16C3DA34F1245(uLocal_297[iVar0], 1);
					}
					iVar0++;
				}
				if (DOES_BLIP_EXIST(uLocal_295))
				{
					_0x75A16C3DA34F1245(uLocal_295, 1);
				}
				if (DOES_BLIP_EXIST(uLocal_296))
				{
					_0x75A16C3DA34F1245(uLocal_296, 1);
				}
				if (!IS_PED_INJURED(iLocal_226[0]))
				{
					func_50(&uLocal_54, 4, iLocal_226[0], "RECSBCop1", 0, 1);
...
void func_83(var uParam0, char* sParam1)
{
	...
	{
		if (IS_ENTITY_AT_ENTITY(PLAYER_PED_ID(), *uParam0, 4f, 4f, 4f, 0, 1, 0))
		{
			if (!bLocal_49)
			{
				func_50(&uLocal_54, 4, *uParam0, "RECSBCop1", 0, 1);
...
void func_84()
{
	...
	{
		if (!IS_ENTITY_DEAD(iLocal_232[iVar0], 0))
		{
			if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_232[iVar0], 0))
			{
	...
	if (bLocal_50)
	{
		if (!iLocal_52)
		{
			...
			if (!IS_PED_INJURED(uLocal_222))
			{
				...
				if (!DOES_BLIP_EXIST(uLocal_295))
				{
					...
					SET_PED_CAN_BE_TARGETTED(uLocal_222, 1);
				}
				TASK_COMBAT_PED(uLocal_222, PLAYER_PED_ID(), 0, 16);
				SET_PED_KEEP_TASK(uLocal_222, 1);
				REGISTER_TARGET(uLocal_222, PLAYER_PED_ID());
			...
			if (!IS_PED_INJURED(uLocal_223))
			{
				...
				if (!DOES_BLIP_EXIST(uLocal_296))
				{
					...
					SET_PED_CAN_BE_TARGETTED(uLocal_223, 1);
				}
				TASK_COMBAT_PED(uLocal_223, PLAYER_PED_ID(), 0, 16);
				SET_PED_KEEP_TASK(uLocal_223, 1);
				REGISTER_TARGET(uLocal_223, PLAYER_PED_ID());
		...
		if (bLocal_49)
		{
			if (!iLocal_53)
			{
				...
				while (iVar0 < iLocal_226)
				{
					if (!IS_PED_INJURED(iLocal_226[iVar0]))
					{
						SET_PED_CAN_BE_TARGETTED(iLocal_226[iVar0], 1);
						if (DOES_BLIP_EXIST(uLocal_297[iVar0]))
						{
							REMOVE_BLIP(&(uLocal_297[iVar0]));
						}
		...
		else
		{
			...
			while (iVar0 < iLocal_226)
			{
				if (!IS_PED_INJURED(iLocal_226[iVar0]))
				{
					SET_PED_CAN_BE_TARGETTED(iLocal_226[iVar0], 0);
				}
				iVar0++;
			}
		}
	...
	else if (bLocal_49)
	{
		if (!iLocal_51)
		{
			if (!IS_PED_INJURED(uLocal_222))
			{
				SET_PED_CAN_BE_TARGETTED(uLocal_222, 0);
			}
			if (!IS_PED_INJURED(uLocal_223))
			{
				SET_PED_CAN_BE_TARGETTED(uLocal_223, 0);
			}
			iLocal_51 = 1;
		}
		if (!iLocal_53)
...
void func_85()
{
	...
	{
		SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("phoenix"), 1);
		...
		SET_ROADS_IN_ANGLED_AREA(418.2996f, 2650.597f, 42.84723f, 297.8981f, 2617.968f, 53.6412f, 49.6875f, 0, 0, 1);
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Vector(43.4932f, 2612.694f, 328.0555f) - Vector(10f, 10f, 10f), Vector(43.4932f, 2612.694f, 328.0555f) + Vector(10f, 10f, 10f), 0, 1);
		CLEAR_AREA_OF_VEHICLES(328.0555f, 2612.694f, 43.4932f, 5f, 0, 0, 0, 0, 0, 0);
		uLocal_236 = CREATE_VEHICLE(joaat("phoenix"), 326.78f, 2626.56f, 43.5081f, 45.21f, 1, 1, 0);
		iLocal_232[0] = CREATE_VEHICLE(joaat("sheriff"), 314.1008f, 2641.67f, 43.5055f, 258.9436f, 1, 1, 0);
		iLocal_232[1] = CREATE_VEHICLE(joaat("sheriff"), 330.7097f, 2646.913f, 43.685f, 120.9436f, 1, 1, 0);
		iLocal_232[2] = CREATE_VEHICLE(joaat("sheriff"), 321.4496f, 2649.388f, 43.5706f, 105.9436f, 1, 1, 0);
		SET_SIREN_WITH_NO_DRIVER(iLocal_232[2], 1);
		SET_SIREN_WITH_NO_DRIVER(iLocal_232[1], 1);
		SET_SIREN_WITH_NO_DRIVER(iLocal_232[0], 1);
		SET_VEHICLE_SIREN(iLocal_232[2], 1);
		SET_VEHICLE_SIREN(iLocal_232[1], 1);
		SET_VEHICLE_SIREN(iLocal_232[0], 1);
		...
		SET_VEHICLE_PROVIDES_COVER(uLocal_236, 1);
		...
		uLocal_222 = CREATE_PED(19, joaat("a_m_y_genstreet_01"), 321.31f, 2615.66f, 43.4963f, 346f, 1, 1);
		uLocal_223 = CREATE_PED(19, joaat("a_m_y_genstreet_01"), 326.25f, 2624.51f, 43.4846f, 341f, 1, 1);
		uLocal_230 = CREATE_PED(6, joaat("s_m_y_ranger_01"), 325.3731f, 2631.16f, 43.5248f, 87f, 1, 1);
		iLocal_226[0] = CREATE_PED(6, joaat("s_m_y_ranger_01"), 310.6203f, 2642.854f, 43.5173f, 226f, 1, 1);
		iLocal_226[1] = CREATE_PED(6, joaat("s_m_y_ranger_01"), 319.5652f, 2650.067f, 43.5411f, 189f, 1, 1);
		iLocal_226[2] = CREATE_PED(6, joaat("s_m_y_ranger_01"), 324.0396f, 2650.964f, 43.5983f, 214f, 1, 1);
		...
		SET_PED_USING_ACTION_MODE(iLocal_226[0], 1, -1, 0);
		SET_PED_USING_ACTION_MODE(iLocal_226[1], 1, -1, 0);
		SET_PED_USING_ACTION_MODE(iLocal_226[2], 1, -1, 0);
		SET_PED_SPHERE_DEFENSIVE_AREA(uLocal_223, 326.25f, 2624.51f, 43.4846f, 3.5f, 0, 0);
		SET_PED_SPHERE_DEFENSIVE_AREA(uLocal_222, 321.31f, 2615.66f, 43.4963f, 3.5f, 0, 0);
		...
		SET_PED_COMBAT_ATTRIBUTES(iLocal_226[0], 0, 1);
		SET_PED_COMBAT_ATTRIBUTES(iLocal_226[1], 0, 1);
		SET_PED_COMBAT_ATTRIBUTES(iLocal_226[2], 0, 1);
		SET_PED_COMBAT_ATTRIBUTES(iLocal_226[0], 1, 1);
		SET_PED_COMBAT_ATTRIBUTES(iLocal_226[1], 1, 1);
		SET_PED_COMBAT_ATTRIBUTES(iLocal_226[2], 1, 1);
		SET_PED_ACCURACY(iLocal_226[0], 13);
		SET_PED_ACCURACY(iLocal_226[1], 13);
		SET_PED_ACCURACY(iLocal_226[2], 13);
		SET_PED_COMBAT_ATTRIBUTES(uLocal_223, 0, 1);
		SET_PED_COMBAT_ATTRIBUTES(uLocal_222, 0, 1);
		SET_PED_COMBAT_ATTRIBUTES(uLocal_223, 1, 1);
		SET_PED_COMBAT_ATTRIBUTES(uLocal_222, 1, 1);
		SET_VEHICLE_DOOR_OPEN(iLocal_232[0], 0, 0, 0);
		SET_VEHICLE_DOOR_OPEN(iLocal_232[0], 1, 0, 0);
		SET_VEHICLE_DOOR_OPEN(iLocal_232[1], 1, 0, 0);
		SET_VEHICLE_DOOR_OPEN(iLocal_232[1], 0, 0, 0);
		SET_VEHICLE_DOOR_OPEN(iLocal_232[2], 1, 0, 0);
		SET_VEHICLE_DOOR_OPEN(iLocal_232[2], 0, 0, 0);
		SET_VEHICLE_DOOR_OPEN(uLocal_236, 1, 0, 0);
		SET_VEHICLE_DOOR_OPEN(uLocal_236, 0, 0, 0);
		SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_236, 1, 1);
		ADD_RELATIONSHIP_GROUP("robbers", &uLocal_267);
		ADD_RELATIONSHIP_GROUP("cops", &uLocal_268);
		SET_ENTITY_HEALTH(uLocal_230, 0, 0);
		SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_223, uLocal_267);
		SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(uLocal_223, 0, uLocal_268);
		SET_ENTITY_HEALTH(uLocal_223, 300, 0);
		GIVE_WEAPON_TO_PED(uLocal_223, joaat("weapon_pistol"), 200, 1, 1);
		SET_PED_SEEING_RANGE(uLocal_223, 100f);
		SET_PED_HEARING_RANGE(uLocal_223, 100f);
		TASK_GUARD_CURRENT_POSITION(uLocal_223, 35f, 35f, 1);
		SET_PED_ACCURACY(uLocal_223, 13);
		SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_222, uLocal_267);
		SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(uLocal_222, 0, uLocal_268);
		SET_ENTITY_HEALTH(uLocal_222, 300, 0);
		GIVE_WEAPON_TO_PED(uLocal_222, joaat("weapon_pistol"), 200, 1, 1);
		SET_PED_SEEING_RANGE(uLocal_222, 100f);
		SET_PED_HEARING_RANGE(uLocal_222, 100f);
		TASK_GUARD_CURRENT_POSITION(uLocal_222, 35f, 35f, 1);
		SET_PED_ACCURACY(uLocal_222, 13);
		SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(iLocal_226[0], 0, uLocal_267);
		SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(iLocal_226[1], 0, uLocal_267);
		SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(iLocal_226[2], 0, uLocal_267);
		GIVE_WEAPON_TO_PED(iLocal_226[0], joaat("weapon_pumpshotgun"), 200, 1, 1);
		GIVE_WEAPON_TO_PED(iLocal_226[1], joaat("weapon_pistol"), 200, 1, 1);
		GIVE_WEAPON_TO_PED(iLocal_226[2], joaat("weapon_pumpshotgun"), 200, 1, 1);
		...
		SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_226[0], uLocal_268);
		SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_226[1], uLocal_268);
		SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_226[2], uLocal_268);
		ENABLE_DISPATCH_SERVICE(5, 0);
		ENABLE_DISPATCH_SERVICE(3, 0);
		SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_268, -1533126372);
		SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, uLocal_268);
		SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_268, 1862763509);
		SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_267, 1862763509);
		SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_268, uLocal_267);
		SET_RELATIONSHIP_BETWEEN_GROUPS(5, -1533126372, uLocal_267);
		SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_267, uLocal_268);
		TASK_SEEK_COVER_FROM_PED(iLocal_226[0], uLocal_222, 3000, 0);
		TASK_SEEK_COVER_FROM_PED(iLocal_226[1], uLocal_222, 3000, 0);
		TASK_SEEK_COVER_FROM_PED(iLocal_226[2], uLocal_222, 3000, 0);
		if (func_45() == 0)
		{
			func_50(&uLocal_54, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
		}
		else if (func_45() == 1)
		{
			func_50(&uLocal_54, 0, PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		}
		else if (func_45() == 2)
		{
			func_50(&uLocal_54, 0, PLAYER_PED_ID(), "TREVOR", 0, 1);
		}
		func_50(&uLocal_54, 4, iLocal_226[0], "RECSBCop1", 0, 1);
		func_50(&uLocal_54, 5, uLocal_222, "RECSBRobber1", 0, 1);
		SET_AMBIENT_VOICE_NAME(iLocal_226[0], "S_M_Y_RANGER_01_WHITE_FULL_01");
		SET_AMBIENT_VOICE_NAME(uLocal_222, "G_M_Y_ArmGoon_02_White_Armenian_MINI_01");
		SET_AMBIENT_VOICE_NAME(uLocal_222, "G_M_Y_ArmGoon_02_White_Armenian_MINI_01");
		iLocal_47 = 1;
	}
}
...
int func_89(vector3 vParam0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!bVar0)
	{
		if (IS_PLAYER_PLAYING(PLAYER_ID()) && !IS_PED_INJURED(PLAYER_PED_ID()))
		{
			...
			if (VMAG2(GET_ENTITY_VELOCITY(PLAYER_PED_ID())) > 1369f && !func_140())
			{
				return 0;
			}
		}
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_123()) || Global_105612) || Global_25767) || func_122()) || func_47(8, -1)) || func_121()) || func_120()) || func_119()) || func_118()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_123()) || Global_25767) || func_122()) || func_47(8, -1)) || func_119()) || func_121()) || func_120()) || func_118()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_123()) || Global_105612) || Global_25767) || func_122()) || func_47(8, -1)) || func_119()) || func_121()) || func_120()) || func_118()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_123()) || Global_105612) || Global_25767) || func_122()) || func_47(8, -1)) || func_121()) || func_120()) || func_118()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_123() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_47(8, -1)) || func_118()) || func_117()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_123()) || Global_25767) || func_122()) || func_47(8, -1)) || func_120()) || func_119()) || func_118()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_123()) || func_120()) || Global_105612) || Global_25767) || func_122()) || Global_37584) || func_47(8, -1)) || func_119()) || func_117()) || func_118()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_123()) || Global_105612) || Global_25767) || func_122()) || func_47(8, -1)) || func_119()) || func_117()) || func_121()) || func_120()) || func_118())
						{
							return 0;
						}
						break;
...
void func_142()
{
	...
	if (iLocal_48)
	{
		...
		SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Vector(43.4932f, 2612.694f, 328.0555f) - Vector(10f, 10f, 10f), Vector(43.4932f, 2612.694f, 328.0555f) + Vector(10f, 10f, 10f), 1, 1);
		iVar0 = 0;
		while (iVar0 < iLocal_226)
		{
			if (!IS_PED_INJURED(iLocal_226[iVar0]))
			{
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_226[iVar0], 0);
				if (IS_PED_INJURED(PLAYER_PED_ID()))
				{
			...
			if (!IS_PED_INJURED(uLocal_222))
			{
				SET_PED_CONFIG_FLAG(uLocal_222, 317, 1);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_222, 0);
				if (!IS_VEHICLE_DRIVEABLE(uLocal_236, 0))
				{
					if (IS_PED_IN_VEHICLE(uLocal_222, uLocal_236, 0))
					{
						_0x25367DE49D64CF16(uLocal_236, 1);
					}
				}
			}
			if (!IS_PED_INJURED(uLocal_223))
			{
				SET_PED_CONFIG_FLAG(uLocal_223, 317, 1);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_223, 0);
				if (!IS_VEHICLE_DRIVEABLE(uLocal_236, 0))
				{
					if (IS_PED_IN_VEHICLE(uLocal_223, uLocal_236, 0))
