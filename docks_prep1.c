...
void func_8()
{
	switch (iLocal_2104)
	{
		case 0:
			...
			{
				SET_ENTITY_PROOFS(Local_55[0 /*2*/], 0, 0, 0, 1, 0, 0, 0, 0);
			}
			SET_VEHICLE_CAN_BE_VISIBLY_DAMAGED(Local_55[0 /*2*/], 0);
			SET_VEHICLE_CAN_BE_VISIBLY_DAMAGED(Local_55[1 /*2*/], 0);
			SET_IGNORE_NO_GPS_FLAG(1);
			SET_GPS_DISABLED_ZONE(288.0967f, -3133.249f, 0f, 301.0605f, -2969.622f, 11.47017f);
			_0xA80AE305E0A3044F(Local_55[0 /*2*/], 0);
			SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_55[0 /*2*/], 0);
		...
		case 1:
			if (func_101(PLAYER_PED_ID()) && func_101(Local_55[0 /*2*/]))
			{
				if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), 1) > 400f && !IS_ENTITY_ON_SCREEN(Local_55[0 /*2*/]))
				{
					func_87(9);
				}
			}
			if (func_86(PLAYER_PED_ID(), 324.7653f, -2974.495f, -1.5f, 1) > 150f)
			{
			...
			if (!iLocal_453 && func_86(PLAYER_PED_ID(), vLocal_52, 1) < 200f)
			{
			...
			{
				if (func_86(PLAYER_PED_ID(), vLocal_52, 1) > 220f)
				{
					func_83(&uLocal_460, joaat("bison"));
					iLocal_454 = 0;
					iLocal_453 = 0;
					if (DOES_ENTITY_EXIST(Local_55[3 /*2*/]))
					{
						DELETE_VEHICLE(&(Local_55[3 /*2*/]));
					}
				}
				else if (func_86(PLAYER_PED_ID(), vLocal_52, 1) < 200f)
				{
					if (iLocal_454 && HAS_MODEL_LOADED(joaat("bison")))
					{
						if (!DOES_ENTITY_EXIST(Local_55[3 /*2*/]))
						{
							Local_55[3 /*2*/] = CREATE_VEHICLE(joaat("bison"), -317.0741f, -2594.14f, 5.0004f, 316.2352f, 1, 1, 0);
							SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_55[3 /*2*/], 0);
						}
						iLocal_454 = 0;
					}
				}
			}
			if (IS_ENTITY_ATTACHED_TO_ENTITY(Local_55[1 /*2*/], GET_PLAYERS_LAST_VEHICLE()) || ((IS_ENTITY_IN_ANGLED_AREA(Local_55[2 /*2*/], -333.6057f, -2623.681f, 5.00103f, -350.1272f, -2640.339f, 12.65742f, 15f, 0, 1, 0) && IS_ENTITY_IN_ANGLED_AREA(Local_64[3 /*10*/], -333.6057f, -2623.681f, 5.00103f, -350.1272f, -2640.339f, 12.65742f, 15f, 0, 1, 0)) && IS_ENTITY_IN_ANGLED_AREA(Local_55[0 /*2*/], -333.6057f, -2623.681f, 5.00103f, -350.1272f, -2640.339f, 12.65742f, 15f, 0, 1, 0)))
			{
				if (func_101(Local_55[1 /*2*/]))
				{
					_0x2A8F319B392E7B3F(Local_55[1 /*2*/], 0.5f);
				}
				if (DOES_BLIP_EXIST(Local_188.f_5))
				{
					_0xC4278F70131BAA6D(Local_188.f_5, 1);
				}
				if (DOES_BLIP_EXIST(uLocal_378))
				{
				...
				if (func_42(&Local_188, vLocal_52, 0.1f, 0.1f, 2f, 1, Local_64[3 /*10*/], 0, 0, GET_PLAYERS_LAST_VEHICLE(), "dkp1_tk2", "DKP1_ABFLD", "", "", "", "DKP1_TRUCK", "DKP1_TRUCKBK", 0, 1, 1, -1) || (DOES_BLIP_EXIST(Local_188.f_5) && IS_ENTITY_IN_ANGLED_AREA(GET_PLAYERS_LAST_VEHICLE(), -340.1324f, -2630.243f, 5.001461f, -346.5508f, -2636.808f, 12.68896f, 14.9375f, 0, 1, 0)))
				{
					REMOVE_SCENARIO_BLOCKING_AREAS();
					func_40(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 7f, -1, 1056964608, 0, 1, 0);
					SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0);
					SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_55[0 /*2*/], 0);
					SET_VEHICLE_DOORS_LOCKED(Local_55[0 /*2*/], 10);
					func_36(&Local_188, 1, 0);
					SET_IGNORE_NO_GPS_FLAG(0);
					SET_GPS_DISABLED_ZONE(0f, 0f, 0f, 0f, 0f, 0f);
					iLocal_452 = GET_GAME_TIMER();
					iLocal_392 = 0;
					iLocal_2104++;
				}
			}
			else if (!IS_ENTITY_ATTACHED_TO_ENTITY(Local_55[1 /*2*/], GET_PLAYERS_LAST_VEHICLE()))
			{
				func_35(&Local_188);
				if (!DOES_BLIP_EXIST(uLocal_378))
				{
		...
		case 2:
			if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
				...
				{
					SET_PED_KEEP_TASK(Local_64[3 /*10*/], 1);
					TASK_LOOK_AT_ENTITY(Local_64[3 /*10*/], PLAYER_PED_ID(), -1, 2048, 2);
					CLEAR_SEQUENCE_TASK(&uLocal_379);
					OPEN_SEQUENCE_TASK(&uLocal_379);
					TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
					TASK_GO_TO_ENTITY(0, PLAYER_PED_ID(), -1, 3f, 1f, 1073741824, 0);
					TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), -1);
					CLOSE_SEQUENCE_TASK(uLocal_379);
					TASK_PERFORM_SEQUENCE(Local_64[3 /*10*/], uLocal_379);
					CLEAR_SEQUENCE_TASK(&uLocal_379);
					iLocal_2104++;
				}
			}
			else if ((!iLocal_387 && func_30()) && (GET_GAME_TIMER() - iLocal_452) > 3000)
			{
		...
		case 3:
			if (!func_11())
			{
				...
				{
					CLEAR_PED_TASKS(Local_64[3 /*10*/]);
					CLEAR_SEQUENCE_TASK(&uLocal_379);
					OPEN_SEQUENCE_TASK(&uLocal_379);
					TASK_ENTER_VEHICLE(0, Local_55[3 /*2*/], -1, -1, 2f, 1, 0);
					TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_55[3 /*2*/], -189.8985f, -2622.707f, 5.0001f, 14, 30f, 786468, 5f, 1f, 1);
					TASK_VEHICLE_MISSION_PED_TARGET(0, Local_55[3 /*2*/], PLAYER_PED_ID(), 8, 30f, 786468, 1000f, 10f, 1);
					CLOSE_SEQUENCE_TASK(uLocal_379);
					TASK_PERFORM_SEQUENCE(Local_64[3 /*10*/], uLocal_379);
					CLEAR_SEQUENCE_TASK(&uLocal_379);
				}
				...
				{
					CLEAR_PED_TASKS(Local_64[3 /*10*/]);
					TASK_SMART_FLEE_COORD(Local_64[3 /*10*/], vLocal_52, 300f, -1, 0, 0);
				}
				iLocal_452 = GET_GAME_TIMER();
				iLocal_2104++;
			}
		...
		case 4:
			if (func_10(Local_64[3 /*10*/], PLAYER_PED_ID(), 1) > 70f || (GET_GAME_TIMER() - iLocal_452) > 20000)
			{
...
int func_33(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_34(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		SET_BLIP_SCALE(uVar0, func_34(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
void func_36(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 3)
	{
		if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
		{
			...
			if (bParam1)
			{
				if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_37()) && uParam0->f_17[iVar0] != PLAYER_PED_ID())
				{
		...
		if (IS_SCREEN_FADED_IN())
		{
			...
			if (bVar1)
			{
				...
				if (bParam26 && IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0))
				{
					...
					if ((!func_57(uParam0, 1) && !func_56(uParam0)) && !IS_BIT_SET(uParam0->f_13, 0))
					{
						if (bParam30)
						{
				...
				else
				{
					...
					else if (!func_50(vVar3, GET_BLIP_COORDS(uParam0->f_5), 0.1f, 0))
					{
					...
					if (bVar1)
					{
						...
						while (iVar2 < 3)
						{
							if (!IS_PED_INJURED(uParam0->f_17[iVar2]))
							{
								...
								else if (!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar2], func_37()) || !func_48(uParam0->f_17[iVar2], 1))
								{
									bVar1 = false;
								}
							}
...
int func_45(var uParam0)
{
	if (IS_BIT_SET(uParam0->f_13, 12))
	{
		...
		{
			if (func_46(1, 0, 1) || IS_BIT_SET(uParam0->f_13, 7))
			{
				return 1;
			}
		}
	}
	else if (func_46(1, 0, 1) || IS_BIT_SET(uParam0->f_13, 7))
	{
		return 1;
	}
	return 0;
...
int func_48(var uParam0, int iParam1)
{
	if (!IS_PED_INJURED(uParam0))
	{
		...
		{
			if (func_49(PLAYER_PED_ID(), uParam0))
			{
				SET_GROUP_SEPARATION_RANGE(func_37(), 50f);
				return 1;
			}
		}
		else if (IS_PED_GROUP_MEMBER(uParam0, func_37()))
		{
			SET_GROUP_SEPARATION_RANGE(func_37(), 50f);
			return 1;
		}
...
{
	_PLAY_AMBIENT_SPEECH1(uParam0, sParam1, func_54(iParam2), 1);
}
...
int func_62(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, var uParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17)
{
						...
						if (func_60(uParam0->f_21, uParam0, iVar3))
						{
							...
							while (iVar0 < 3)
							{
								if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
								{
									...
									if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_37()))
									{
										REMOVE_PED_FROM_GROUP(uParam0->f_17[iVar0]);
									}
									if (GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], -1794415470) == 7 && !func_77(uParam0->f_17[iVar0], uParam0->f_21))
									{
			...
			while (iVar0 < 3)
			{
				if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
				{
					...
					if (!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_37()))
					{
						...
						{
							SET_PED_AS_GROUP_MEMBER(uParam0->f_17[iVar0], func_37());
						}
					}
				}
				iVar0++;
	...
	if (!IS_BIT_SET(uParam0->f_13, 26))
	{
		if ((!func_74(uParam0) && IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID())) && !DOES_ENTITY_EXIST(iParam10))
		{
		...
		if (!DOES_ENTITY_EXIST(iParam10))
		{
			if ((!IS_PED_INJURED(uParam0->f_17[0]) || !IS_PED_INJURED(uParam0->f_17[1])) || !IS_PED_INJURED(uParam0->f_17[2]))
			{
				...
				{
					if (IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()) && !func_57(uParam0, 2))
					{
						iVar13 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
				...
				if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
				{
					...
					if (IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()))
					{
						...
						if (IS_VEHICLE_DRIVEABLE(iVar13, 0))
						{
							if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_37()))
							{
								if (!func_74(uParam0) && IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER_PED_ID()))
								{
					...
					if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_37()))
					{
						...
						if (DOES_ENTITY_EXIST(uVar32))
						{
							...
							{
								if (func_71(iVar0, uParam0) || !IS_BIT_SET(uParam0->f_13, 27))
								{
									SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uParam0->f_17[iVar0], iVar0);
									func_38(iVar0, uParam0);
									iVar4++;
					...
					if ((!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_37()) && !func_69(uParam0->f_17[iVar0], iParam10)) && !func_68(uParam0->f_17[iVar0], iParam10))
					{
					...
					{
						if (((func_48(uParam0->f_17[iVar0], 1) || func_69(uParam0->f_17[iVar0], iParam10)) || iParam12) || (IS_VEHICLE_DRIVEABLE(iParam10, 0) && !IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iParam10, 0)))
						{
							if (DOES_BLIP_EXIST(uParam0->f_1[iVar0]))
							{
								REMOVE_BLIP(&(uParam0->f_1[iVar0]));
					...
					else if (IS_VEHICLE_DRIVEABLE(iParam10, 0))
					{
						if (!IS_PED_SITTING_IN_VEHICLE(uParam0->f_17[iVar0], iParam10))
						{
							if ((IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], iParam10, 20f, 20f, 5f, 0, 1, 0) && !IS_BIT_SET(uParam0->f_13, 11)) && !((bParam17 && IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) && !IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iParam10, 0)))
							{
								...
								else
								{
									...
									{
										if (((((!IS_PED_JUMPING_OUT_OF_VEHICLE(uParam0->f_17[iVar0]) && !IS_PED_JUMPING_OUT_OF_VEHICLE(PLAYER_PED_ID())) && !func_67(uParam0->f_17[iVar0], 2f)) && !IS_PED_RAGDOLL(uParam0->f_17[iVar0])) && !IS_PED_GETTING_UP(uParam0->f_17[iVar0])) && !IS_ENTITY_ON_FIRE(iParam10))
										{
											SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_17[iVar0], 1);
							...
							else if (!IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_37()))
							{
								if (func_75(uParam0, uParam0->f_17[iVar0], uParam8, bParam11))
								{
									if (!IS_PED_RAGDOLL(uParam0->f_17[iVar0]) && !IS_PED_GETTING_UP(uParam0->f_17[iVar0]))
						...
						else if (IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_37()) && !IS_ENTITY_ON_FIRE(iParam10))
						{
							REMOVE_PED_FROM_GROUP(uParam0->f_17[iVar0]);
						}
					}
			...
			if (iVar1 > 0)
			{
				...
				while (iVar0 < 3)
				{
					if (iVar7[iVar0])
					{
						if (!IS_PED_INJURED(uParam0->f_17[iVar0]))
						{
							if (func_72(uParam0->f_17[iVar0]) || IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], PLAYER_PED_ID(), uParam0->f_8, uParam0->f_8, uParam0->f_8, 0, 1, 0))
							{
								iVar1 = (iVar1 - 1);
								iVar7[iVar0] = 0;
							}
					...
					{
						if (!IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], PLAYER_PED_ID(), (uParam0->f_8 * 0.85f), (uParam0->f_8 * 0.85f), uParam0->f_8, 0, 1, 0) && !func_72(uParam0->f_17[iVar0]))
						{
						}
					}
					iVar0++;
...
int func_68(var uParam0, int iParam1)
{
	...
	if (!IS_PED_INJURED(uParam0))
	{
		if (!IS_PED_GROUP_MEMBER(uParam0, func_37()))
		{
...
void func_87(int iParam0)
{
	...
	else if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1298.369f, -3062.1f, -71.22691f, 790.9125f, -3068.998f, 63.91419f, 250f, 0, 0, 0))
	{
...
void func_95(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_97(Global_106565.f_18527[iVar0], &vVar2, &fVar5))
			{
...
void func_102(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_186(GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar5 = func_179(GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
...
{
	func_104(&Global_100114, GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_104(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_19();
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		func_138(PLAYER_PED_ID());
		func_131(PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_130())
		{
			func_123(PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (DOES_ENTITY_EXIST(Global_91043[iVar0]))
		{
			if (Global_91043[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || GET_ENTITY_MODEL(iParam0) == func_113(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				SET_BIT(&(uParam1->f_77), func_116(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_132(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_137(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_134(Var11.f_1)) && iVar72 < 51)
			{
...
void func_138(var uParam0)
{
	...
	if (func_21(iVar0) && !IS_PED_INJURED(uParam0))
	{
...
int func_142(var uParam0)
{
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (func_165())
		{
			*uParam0 = func_148(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_144(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_146() == 0)
		{
			return IS_BIT_SET(func_124(func_145(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_148(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_164(iVar0))
		{
			...
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_149(iVar0, 0), 1);
...
var func_166()
{
	...
	func_176(&uVar0, GET_CLOCK_SECONDS());
	func_175(&uVar0, GET_CLOCK_MINUTES());
	func_174(&uVar0, GET_CLOCK_HOURS());
	func_169(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_168(&uVar0, GET_CLOCK_MONTH());
	func_167(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SHIFT_RIGHT(uParam0, 26) & 31 * func_172(IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}
...
void func_189()
{
	...
	switch (iLocal_2104)
	{
		case 0:
			...
			if (HAS_MODEL_LOADED(joaat("packer")) && HAS_MODEL_LOADED(joaat("armytrailer")))
			{
				...
				func_217(6, 0);
				Local_55[2 /*2*/] = CREATE_VEHICLE(joaat("packer"), 298.2343f, -2942.77f, 5.0003f, 0f, 1, 1, 0);
				SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_55[2 /*2*/], 0);
				SET_VEHICLE_HAS_STRONG_AXLES(Local_55[2 /*2*/], 1);
				SET_VEHICLE_COLOUR_COMBINATION(Local_55[2 /*2*/], 0);
				SET_VEHICLE_TYRES_CAN_BURST(Local_55[2 /*2*/], 0);
				Local_55[1 /*2*/] = CREATE_VEHICLE(joaat("armytrailer"), 298.27f, -2951.27f, 7.86f, 0f, 1, 1, 0);
				ATTACH_VEHICLE_TO_TRAILER(Local_55[2 /*2*/], Local_55[1 /*2*/], 0.5f);
				_0x95CF53B3D687F9FA(Local_55[1 /*2*/]);
				SET_VEHICLE_TYRES_CAN_BURST(Local_55[1 /*2*/], 0);
				SET_VEHICLE_HAS_STRONG_AXLES(Local_55[1 /*2*/], 1);
				iLocal_383 = 0;
		...
		case 2:
			if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_55[0 /*2*/], 0))
			{
				switch (iLocal_397)
				{
					case 0:
						if (!IS_HELP_MESSAGE_BEING_DISPLAYED())
						{
							if (iLocal_396 == -1)
							{
								iLocal_396 = GET_GAME_TIMER() + 5000;
							}
							if (GET_GAME_TIMER() > iLocal_396)
							{
			...
			if (IS_VEHICLE_STUCK_TIMER_UP(Local_55[0 /*2*/], 3, 10000))
			{
				func_87(1);
			}
			if (func_86(PLAYER_PED_ID(), 324.7653f, -2974.495f, -1.5f, 1) < 150f)
			...
			{
				if ((IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, 1, 0) || IS_PED_FLEEING(Local_64[6 /*10*/])) || func_10(PLAYER_PED_ID(), Local_64[6 /*10*/], 1) > 100f)
				{
					CLEAR_PED_TASKS(Local_64[6 /*10*/]);
					func_9(&(Local_64[6 /*10*/]), 1, 0, 1);
				}
			}
			if (func_101(Local_64[7 /*10*/]))
			{
				if ((IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, 1, 0) || IS_PED_FLEEING(Local_64[7 /*10*/])) || func_10(PLAYER_PED_ID(), Local_64[7 /*10*/], 1) > 100f)
				{
					CLEAR_PED_TASKS(Local_64[7 /*10*/]);
					func_9(&(Local_64[7 /*10*/]), 1, 0, 1);
				}
			}
			if (func_101(Local_64[4 /*10*/]))
			{
				if ((IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, 1, 0) || IS_PED_FLEEING(Local_64[4 /*10*/])) || func_10(PLAYER_PED_ID(), Local_64[4 /*10*/], 1) > 100f)
				{
					CLEAR_PED_TASKS(Local_64[4 /*10*/]);
					func_9(&(Local_64[4 /*10*/]), 1, 0, 1);
				}
			}
			if (func_101(Local_64[5 /*10*/]))
			{
				if ((IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, 1, 0) || IS_PED_FLEEING(Local_64[5 /*10*/])) || func_10(PLAYER_PED_ID(), Local_64[5 /*10*/], 1) > 100f)
				{
					CLEAR_PED_TASKS(Local_64[5 /*10*/]);
					func_9(&(Local_64[5 /*10*/]), 1, 0, 1);
				}
			}
			if (func_220(&Local_188, 324.7653f, -2974.495f, -1.5f, 0.1f, 0.1f, 2f, 0, Local_55[0 /*2*/], "dkp1_tk1", "", "DKP1_SUBBK", 1, 0, 1, -1) || ((DOES_BLIP_EXIST(Local_188.f_5) && IS_ENTITY_IN_ANGLED_AREA(Local_55[0 /*2*/], 312.8557f, -2974.003f, 1.19166f, 339.1654f, -2974.348f, -6.70078f, 15f, 0, 1, 0)) && func_212(PLAYER_PED_ID(), Local_55[0 /*2*/])))
			{
			...
			else if (GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) == 0 && DOES_BLIP_EXIST(Local_188.f_5))
			{
				DRAW_MARKER(6, 324.7653f, -2974.495f, -3.5f, 0f, 0f, 0f, 0f, 0f, 0f, 5f, 5f, 5f, 255, 255, 0, 65, 0, 0, 2, 0, 0, 0, 0);
			}
			break;
		
		case 3:
			if (func_76(Local_55[0 /*2*/]) || (GET_GAME_TIMER() - iLocal_452) > 3500)
			{
				uLocal_444 = CREATE_CAMERA_WITH_PARAMS(26379945, 341.6419f, -2965.525f, 4.037704f, 17.06695f, 0.473599f, 112.4448f, 34f, 0, 2);
				SET_CAM_ACTIVE(uLocal_444, 1);
				SHAKE_CAM(uLocal_444, "HAND_SHAKE", 0.4f);
				SET_CAM_PARAMS(uLocal_444, 341.6419f, -2965.525f, 4.037704f, -4.346406f, 0.473595f, 112.4448f, 34f, 6000, 1, 1, 2);
				func_204(0, 340.6675f, -2964.01f, 1.4937f, 1, 0, 1, 3000, 0, 1);
				func_82(&uLocal_460, joaat("prop_tarp_strap"));
				SET_ENTITY_COORDS(Local_55[0 /*2*/], vLocal_411, 1, 0, 0, 1);
				SET_ENTITY_HEADING(Local_55[0 /*2*/], fLocal_414);
				iLocal_452 = GET_GAME_TIMER();
				iLocal_410 = 0;
		...
		case 5:
			...
			{
				REGISTER_ENTITY_FOR_CUTSCENE(Local_55[2 /*2*/], "DockHeist_truck", 0, 0, 0);
				REGISTER_ENTITY_FOR_CUTSCENE(Local_55[0 /*2*/], "submarine", 0, joaat("submersible"), 0);
				REGISTER_ENTITY_FOR_CUTSCENE(Local_55[1 /*2*/], "dockheist_trailer", 0, joaat("armytrailer"), 0);
				...
				_0x2A56C06EBEF2B0D9("Trevor", PLAYER_PED_ID(), 0);
				SET_VEHICLE_LIGHTS(Local_55[2 /*2*/], 1);
				SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_55[2 /*2*/], 1);
				func_193(0);
		...
		case 6:
			...
			if (!DOES_ENTITY_EXIST(Local_64[3 /*10*/]))
			{
				if (DOES_ENTITY_EXIST(GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Floyd", 0)))
				{
					Local_64[3 /*10*/] = GET_PED_INDEX_FROM_ENTITY_INDEX(GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Floyd", 0));
					func_218(&uLocal_213, 1, Local_64[3 /*10*/], "FLOYD", 0, 1);
					SET_PED_RELATIONSHIP_GROUP_HASH(Local_64[3 /*10*/], uLocal_394);
				}
			}
			...
			{
				SET_ALL_VEHICLES_SPAWN(Local_55[2 /*2*/], 1, 0, 0);
				SET_VEHICLE_DOORS_SHUT(Local_55[2 /*2*/], 1);
				iLocal_448 = 1;
			}
			if (CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("DockHeist_trailer", 0))
			{
				SET_ALL_VEHICLES_SPAWN(Local_55[1 /*2*/], 1, 0, 0);
				iLocal_451 = 1;
			}
			...
			else if (!DOES_ENTITY_EXIST(Local_169[4 /*2*/]))
			{
				if (DOES_ENTITY_EXIST(GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("sub_cover", joaat("prop_sub_cover_01"))))
				{
					Local_169[4 /*2*/] = GET_OBJECT_INDEX_FROM_ENTITY_INDEX(GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("sub_cover", joaat("prop_sub_cover_01")));
				}
			}
			if (GET_VEHICLE_LIGHTS_STATE(Local_55[2 /*2*/], &iVar0, &uVar1))
			{
				if (iVar0 == 0)
				{
					if (GET_CUTSCENE_TIME() >= 14200)
					{
						SET_VEHICLE_LIGHTS(Local_55[2 /*2*/], 3);
					}
				}
			}
			if (((((iLocal_446 && iLocal_447) && iLocal_448) && iLocal_449) && iLocal_450) && iLocal_451)
			{
				if (IS_SCREEN_FADED_IN() || _0x7350823473013C02(Local_64[3 /*10*/]))
				{
					SET_PED_INTO_VEHICLE(Local_64[3 /*10*/], Local_55[2 /*2*/], 0);
					SET_PED_INTO_VEHICLE(PLAYER_PED_ID(), Local_55[2 /*2*/], -1);
					_0x16B5E274BDE402F8(Local_55[0 /*2*/], Local_55[1 /*2*/], 0f, -4f, -0.7f, 0f, 0f, 0f, 0f, 0f, 0f, -1f);
					SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_55[0 /*2*/], 0);
					SET_VEHICLE_DOORS_SHUT(Local_55[0 /*2*/], 1);
					SET_VEHICLE_DOORS_LOCKED(Local_55[0 /*2*/], 10);
					SET_VEHICLE_ENGINE_ON(Local_55[0 /*2*/], 0, 1, 0);
					SET_VEHICLE_LIGHTS(Local_55[0 /*2*/], 1);
					SET_VEHICLE_RADIO_ENABLED(Local_55[0 /*2*/], 0);
					ATTACH_ENTITY_TO_ENTITY(Local_169[4 /*2*/], Local_55[1 /*2*/], -1, vLocal_440, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					Local_169[5 /*2*/] = CREATE_OBJECT(joaat("prop_tarp_strap"), -332.8449f, -2622.157f, 8.7838f, 1, 1, 0);
					ATTACH_ENTITY_TO_ENTITY(Local_169[5 /*2*/], Local_55[1 /*2*/], -1, vLocal_440, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	...
	if (DOES_BLIP_EXIST(Local_188.f_5))
	{
		SET_BLIP_ROUTE(Local_188.f_5, 0);
	}
	if (func_101(PLAYER_PED_ID()) && func_101(Local_55[0 /*2*/]))
	{
		if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 324.7653f, -2974.495f, -1f, 1) > 2500f)
		{
			func_87(9);
		}
	}
...
void func_192(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4)
{
	DISPLAY_RADAR(1);
	DISPLAY_HUD(1);
	SET_PLAYER_CONTROL(PLAYER_ID(), iParam0, iParam4);
...
int func_194()
{
	...
	switch (iLocal_410)
	{
		case 0:
			...
			SET_ENTITY_COORDS(Local_55[0 /*2*/], vLocal_411, 1, 0, 0, 1);
			SET_ENTITY_HEADING(Local_55[0 /*2*/], fLocal_414);
			FREEZE_ENTITY_POSITION(Local_55[0 /*2*/], 1);
			uLocal_380 = START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_pls_sub_water_drips", Local_55[0 /*2*/], 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
			SET_PARTICLE_FX_LOOPED_EVOLUTION(uLocal_380, "flow", 1f, 0);
		...
		case 1:
			vLocal_430 = { GET_ENTITY_COORDS(Local_169[8 /*2*/], 1) };
			if (vLocal_430.z <= 1f)
			{
				FREEZE_ENTITY_POSITION(Local_55[0 /*2*/], 0);
				SET_CAM_PARAMS(uLocal_444, 310.0923f, -2949.529f, 10.9528f, -20.2654f, 2.7992f, -141.6393f, 25.6f, 0, 1, 1, 2);
				SET_CAM_PARAMS(uLocal_444, 308.3542f, -2950.972f, 10.8434f, 0.0544f, 2.7992f, -137.3849f, 25.6f, 12500, 1, 1, 2);
				ATTACH_ENTITY_TO_ENTITY(Local_55[0 /*2*/], Local_169[8 /*2*/], -1, 2.47f, 0f, -1.96f, 0f, 0f, -90f, 0, 0, 0, 0, 2, 1);
				iLocal_410++;
			}
			else
			{
		...
		case 2:
			...
			{
				SET_CAM_PARAMS(uLocal_444, 356.9992f, -2984.961f, 117.2741f, -68.2497f, -0.1106f, 66.9743f, 20f, 0, 1, 1, 2);
				SET_CAM_PARAMS(uLocal_444, 361.4758f, -2966.824f, 117.2872f, -66.6976f, -0.1106f, 84.372f, 20f, 10000, 1, 1, 2);
				uLocal_443 = GET_CAM_NEAR_CLIP(uLocal_444);
				SET_CAM_NEAR_CLIP(uLocal_444, 1.8f);
				iLocal_410++;
			}
			else
			{
		...
		case 3:
			if (fLocal_424 >= 40f)
			{
				SET_CAM_PARAMS(uLocal_444, 289.8129f, -2944.046f, 5.5715f, 17.075f, 0.1698f, -109.4507f, 38.3f, 0, 1, 1, 2);
				SET_CAM_PARAMS(uLocal_444, 290.8941f, -2941.987f, 5.5781f, 22.5176f, 0.1698f, -128.6537f, 38.3f, 7000, 1, 1, 2);
				SET_CAM_NEAR_CLIP(uLocal_444, uLocal_443);
				fLocal_424 = 80f;
				DETACH_ENTITY(Local_169[7 /*2*/], 1, 1);
				ATTACH_ENTITY_TO_ENTITY(Local_169[7 /*2*/], Local_169[6 /*2*/], -1, vLocal_421, 0f, 0f, fLocal_424, 0, 0, 0, 0, 2, 1);
				SET_ENTITY_COORDS_NO_OFFSET(Local_169[8 /*2*/], GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[7 /*2*/], vLocal_426), 0, 0, 1);
				iLocal_2110 = GET_GAME_TIMER();
				iLocal_410++;
			}
			else
			{
		...
		case 4:
			if (fLocal_424 >= 108f)
			{
				...
				SET_CAM_PARAMS(uLocal_444, 300.0253f, -2973.253f, 5.7369f, 10.5662f, 0.1117f, 4.0913f, 22.7929f, 0, 1, 1, 2);
				SET_CAM_PARAMS(uLocal_444, 300.0292f, -2973.294f, 6.1746f, 5.2629f, 0.1117f, 4.0913f, 22.7929f, 8000, 1, 1, 2);
				SET_CAM_SHAKE_AMPLITUDE(uLocal_444, 0.25f);
				DETACH_ENTITY(Local_169[7 /*2*/], 1, 1);
				ATTACH_ENTITY_TO_ENTITY(Local_169[7 /*2*/], Local_169[6 /*2*/], -1, vLocal_421, 0f, 0f, fLocal_424, 0, 0, 0, 0, 2, 1);
				SET_ENTITY_COORDS_NO_OFFSET(Local_169[8 /*2*/], GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[7 /*2*/], vLocal_426), 0, 0, 1);
				if (DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_380))
				{
					STOP_PARTICLE_FX_LOOPED(uLocal_380, 0);
				}
				iLocal_410++;
			}
			else
			{
				fVar0 = (1f - func_198((TO_FLOAT((GET_GAME_TIMER() - iLocal_2110 + 1500)) / 3000f), 0f, 1f));
				SET_PARTICLE_FX_LOOPED_EVOLUTION(uLocal_380, "flow", fVar0, 0);
				func_199(1, 5.5f);
			}
			break;
		...
		case 5:
			...
			if (vLocal_430.z <= 11f)
			{
				DETACH_ENTITY(Local_55[0 /*2*/], 1, 1);
				iLocal_410++;
			}
			else
			{
		...
		case 6:
			if (HAS_ENTITY_COLLIDED_WITH_ANYTHING(Local_55[0 /*2*/]))
			{
				iLocal_2110 = GET_GAME_TIMER() + 1000;
				iLocal_410++;
			}
			break;
		
		case 7:
			if (GET_GAME_TIMER() > iLocal_2110)
			{
				FREEZE_ENTITY_POSITION(Local_169[8 /*2*/], 1);
				iLocal_410++;
			}
			else
			{
	...
	else if (IS_SCREEN_FADED_OUT())
	{
		...
		REMOVE_PARTICLE_FX_IN_RANGE(GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), 30f);
		iLocal_2108 = 2;
		iLocal_2107 = 1;
	}
	return 0;
...
int func_201(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7, int iParam8)
{
	...
	{
		NEW_LOAD_SCENE_START(vParam1, vParam4, fParam7, iParam8);
		uParam0->f_868 = 1;
...
void func_203()
{
	if (iLocal_383)
	{
		DELETE_ROPE(&(Local_145[0 /*5*/]));
		DELETE_ROPE(&(Local_145[1 /*5*/]));
		DELETE_ROPE(&(Local_145[2 /*5*/]));
		DELETE_ROPE(&(Local_145[3 /*5*/]));
		iLocal_383 = 0;
	}
}
...
void func_204(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, int iParam7, int iParam8, bool bParam9)
{
	DISPLAY_RADAR(0);
	DISPLAY_HUD(0);
	SET_PLAYER_CONTROL(PLAYER_ID(), iParam0, iParam8);
	CLEAR_PRINTS();
	CLEAR_HELP(1);
	RENDER_SCRIPT_CAMS(iParam4, iParam5, iParam7, 1, 0, 0);
	if (bParam6)
	{
...
int func_212(var uParam0, var uParam1)
{
	if (DOES_ENTITY_EXIST(uParam0) && !IS_ENTITY_DEAD(uParam0, 0))
	{
		...
		{
			if (IS_PED_SITTING_IN_VEHICLE(uParam0, uParam1))
			{
				return 1;
			}
		}
...
int func_216()
{
	if (!DOES_ENTITY_EXIST(Local_169[6 /*2*/]))
	{
		Local_169[6 /*2*/] = CREATE_OBJECT(iLocal_415, vLocal_416, 1, 1, 0);
		SET_ENTITY_COORDS(Local_169[6 /*2*/], vLocal_416, 1, 0, 0, 1);
		SET_ENTITY_HEADING(Local_169[6 /*2*/], fLocal_419);
		FREEZE_ENTITY_POSITION(Local_169[6 /*2*/], 1);
	}
	if (!DOES_ENTITY_EXIST(Local_169[7 /*2*/]))
	{
		Local_169[7 /*2*/] = CREATE_OBJECT(iLocal_420, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[6 /*2*/], vLocal_421), 1, 1, 0);
	}
	if (!IS_ENTITY_ATTACHED_TO_ENTITY(Local_169[7 /*2*/], Local_169[6 /*2*/]))
	{
		ATTACH_ENTITY_TO_ENTITY(Local_169[7 /*2*/], Local_169[6 /*2*/], -1, vLocal_421, 0f, 0f, fLocal_424, 0, 0, 0, 0, 2, 1);
	}
	if (!DOES_ENTITY_EXIST(Local_169[8 /*2*/]))
	{
		Local_169[8 /*2*/] = CREATE_OBJECT(iLocal_425, GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[7 /*2*/], vLocal_426), 1, 1, 0);
		_SET_ENTITY_SOMETHING(Local_169[8 /*2*/], 0);
		ATTACH_ENTITY_TO_ENTITY(Local_169[8 /*2*/], Local_169[7 /*2*/], -1, vLocal_426, 0f, 0f, fLocal_429, 0, 0, 0, 0, 2, 1);
		DETACH_ENTITY(Local_169[8 /*2*/], 1, 0);
		FREEZE_ENTITY_POSITION(Local_169[8 /*2*/], 1);
	}
	if (!iLocal_384)
	{
		if (DOES_ENTITY_HAVE_PHYSICS(Local_169[7 /*2*/]) && DOES_ENTITY_HAVE_PHYSICS(Local_169[8 /*2*/]))
		{
			uLocal_439 = ADD_ROPE(GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[7 /*2*/], vLocal_433), 0f, 0f, 0f, 70f, 0, -1f, 4f, 1.4f, 0, 0, 1, 1065353216, 0, 0);
			_0x36CCB9BE67B970FD(uLocal_439, 1);
			_0xDC57A637A20006ED(uLocal_439, 2);
			ROPE_DRAW_SHADOW_ENABLED(&uLocal_439, 0);
			ATTACH_ENTITIES_TO_ROPE(uLocal_439, Local_169[7 /*2*/], Local_169[8 /*2*/], GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[7 /*2*/], vLocal_433), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[8 /*2*/], vLocal_436), 70f, 0, 0, 0, 0);
			iLocal_384 = 1;
			return 1;
		}
		if (!DOES_ENTITY_HAVE_PHYSICS(Local_169[7 /*2*/]))
		{
		}
		if (!DOES_ENTITY_HAVE_PHYSICS(Local_169[8 /*2*/]))
		{
		}
	}
	return 0;
...
void func_223()
{
	...
	switch (iLocal_2104)
	{
		case 0:
			...
			if (func_101(Local_55[0 /*2*/]))
			{
				if (!DOES_BLIP_EXIST(Local_55[0 /*2*/].f_1))
				{
					Local_55[0 /*2*/].f_1 = func_32(Local_55[0 /*2*/], 0, 0);
				}
				vLocal_166 = { GET_CGOFFSET(Local_55[0 /*2*/]) };
			}
			if (DOES_ENTITY_EXIST(Local_169[2 /*2*/]) && !DOES_BLIP_EXIST(uLocal_378))
			{
				uLocal_378 = func_271(Local_169[2 /*2*/]);
			}
			SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_378, "SUBBTN_LABEL");
			if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
			...
			if (func_101(Local_64[4 /*10*/]))
			{
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_64[4 /*10*/], 1);
				SET_PED_PATH_CAN_USE_CLIMBOVERS(Local_64[4 /*10*/], 0);
			}
			...
			iLocal_400 = 0;
			iLocal_401 = 0;
			iLocal_403 = GET_GAME_TIMER();
			iLocal_404 = 0;
			iLocal_388 = 0;
			iLocal_398 = 0;
			if (uLocal_2113[0] == -1)
			{
				uLocal_2113[0] = GET_SOUND_ID();
			}
			if (uLocal_2113[1] == -1)
			{
				uLocal_2113[1] = GET_SOUND_ID();
			}
			iLocal_2104++;
			break;
		...
		case 1:
			if (iLocal_383)
			{
				if (((!_0x84DE3B5FB3E666F0(&(Local_145[0 /*5*/])) && !_0x84DE3B5FB3E666F0(&(Local_145[1 /*5*/]))) && !_0x84DE3B5FB3E666F0(&(Local_145[2 /*5*/]))) && !_0x84DE3B5FB3E666F0(&(Local_145[3 /*5*/])))
				{
					ROPE_CONVERT_TO_SIMPLE(Local_169[0 /*2*/]);
					ROPE_CONVERT_TO_SIMPLE(Local_169[1 /*2*/]);
					if (func_101(Local_55[0 /*2*/]))
					{
						SET_CGOFFSET(Local_55[0 /*2*/], vLocal_166);
					}
					if (DOES_BLIP_EXIST(uLocal_378))
					{
						REMOVE_BLIP(&uLocal_378);
				...
				func_264();
				if ((IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1249.106f, -3007.908f, 10.84327f, 1249.962f, -3007.837f, 8.31909f, 1.68f, 0, 1, 0) && !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) && !func_207(0))
				{
					if (IS_CONTROL_JUST_PRESSED(2, 51))
					{
						uLocal_444 = CREATE_CAMERA_WITH_PARAMS(26379945, 1249.929f, -3010.267f, 9.590105f, 5.351202f, -1.57369f, 8.12499f, 21.33357f, 1, 2);
						SET_CAM_PARAMS(uLocal_444, 1249.929f, -3010.267f, 9.590105f, 4.448765f, -1.5737f, 12.68005f, 21.33357f, 3500, 0, 1, 2);
						SHAKE_CAM(uLocal_444, "hand_shake", 0.3f);
						...
						uLocal_381 = CREATE_SYNCHRONIZED_SCENE(1250.01f, -3007.9f, 9.32f, 0f, 0f, 90f, 2);
						if (GET_PED_STEALTH_MOVEMENT(PLAYER_PED_ID()))
						{
							TASK_SYNCHRONIZED_SCENE(PLAYER_PED_ID(), uLocal_381, cLocal_51, "ig_1_stealth_button", 1000f, -1.5f, 4, 0, 1000f, 2);
						}
						else
						{
							TASK_SYNCHRONIZED_SCENE(PLAYER_PED_ID(), uLocal_381, cLocal_51, "ig_1_button", 1000f, -1.5f, 4, 0, 1000f, 2);
						}
						_0x2208438012482A1A(PLAYER_PED_ID(), 0, 0);
						CLEAR_HELP(1);
						uVar0 = GET_CLOSEST_VEHICLE(1249.787f, -3008.016f, 8.52751f, 5f, 0, 4);
						if (func_101(uVar0))
						{
							SET_ENTITY_COORDS(uVar0, 1250.333f, -3010.219f, 8.3191f, 1, 0, 0, 1);
							SET_ENTITY_HEADING(uVar0, 85.8086f);
		...
		case 2:
			if (!IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_381) || GET_SYNCHRONIZED_SCENE_PHASE(uLocal_381) == 1f)
			{
				_0x81CBAE94390F9F89();
				PLAY_SOUND_FROM_COORD(-1, "SUB_RELEASE", 1260.896f, -3006.556f, 23.4213f, "DOCKS_HEIST_PREP_1_SOUNDSET", 0, 0, 0);
				SET_CAM_PARAMS(uLocal_444, 1249f, -3010.3f, 10.7f, 37.7f, 0f, -61.5f, 43.4f, 0, 1, 1, 2);
				SET_CAM_PARAMS(uLocal_444, 1249f, -3010.3f, 10.7f, -20.1f, 0f, -48.2f, 43.4f, 1700, 2, 2, 2);
				SET_CAM_SHAKE_AMPLITUDE(uLocal_444, 0.1f);
				DETACH_ROPE_FROM_ENTITY(Local_145[0 /*5*/], Local_55[0 /*2*/]);
				DETACH_ROPE_FROM_ENTITY(Local_145[1 /*5*/], Local_55[0 /*2*/]);
				DETACH_ROPE_FROM_ENTITY(Local_145[2 /*5*/], Local_55[0 /*2*/]);
				DETACH_ROPE_FROM_ENTITY(Local_145[3 /*5*/], Local_55[0 /*2*/]);
				ROPE_CONVERT_TO_SIMPLE(Local_169[0 /*2*/]);
				ROPE_CONVERT_TO_SIMPLE(Local_169[1 /*2*/]);
				if (func_101(Local_55[0 /*2*/]))
				{
					SET_CGOFFSET(Local_55[0 /*2*/], vLocal_166);
					ACTIVATE_PHYSICS(Local_55[0 /*2*/]);
				}
				iLocal_452 = GET_GAME_TIMER();
				TRIGGER_MUSIC_EVENT("DHP1_RELEASED");
				CLEAR_HELP(1);
			...
			else if (IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_381) && GET_SYNCHRONIZED_SCENE_PHASE(uLocal_381) >= 0.7f)
			{
				if (GET_SCRIPT_TASK_STATUS(PLAYER_PED_ID(), 713668775) != 1)
				{
					TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER_PED_ID(), 1252.594f, -3008.883f, 8.3191f, 1f, -1, 1048576000, 0, 1193033728);
				}
			}
			break;
		
		case 3:
			if ((GET_GAME_TIMER() - iLocal_452) > 1500)
			{
				if (iLocal_445)
				{
					SET_CAM_PARAMS(uLocal_444, 1261.7f, -3013.3f, 21.7f, -62.7f, 0f, 29.5f, 40.4f, 0, 3, 3, 2);
					SET_CAM_PARAMS(uLocal_444, 1259.9f, -3014.1f, 21.7f, -67.7f, 0f, 16.5f, 40.4f, 4000, 3, 3, 2);
					iLocal_445 = 0;
				}
				if ((GET_GAME_TIMER() - iLocal_452) > 5000 || IS_CONTROL_JUST_PRESSED(2, 201))
				{
					if (DOES_BLIP_EXIST(uLocal_378))
					{
						REMOVE_BLIP(&uLocal_378);
		...
		case 4:
			if (!func_262())
			{
				if (func_19() == 2)
				{
					...
					{
						func_218(&uLocal_213, 0, PLAYER_PED_ID(), "TREVOR", 0, 1);
		...
		case 5:
			vVar1 = { GET_ENTITY_COORDS(Local_55[0 /*2*/], 1) };
			if (GET_ENTITY_SUBMERGED_LEVEL(Local_55[0 /*2*/]) > 0f || vVar1.z < -0.5f)
			{
				DELETE_CHILD_ROPE(Local_145[0 /*5*/]);
				DELETE_CHILD_ROPE(Local_145[1 /*5*/]);
				DELETE_CHILD_ROPE(Local_145[2 /*5*/]);
				DELETE_CHILD_ROPE(Local_145[3 /*5*/]);
				if (uLocal_2113[0] != -1)
				{
					STOP_SOUND(uLocal_2113[0]);
				}
				if (uLocal_2113[1] != -1)
				{
					STOP_SOUND(uLocal_2113[1]);
				}
			}
			if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_55[0 /*2*/], 0))
			{
				...
				{
					Local_64[6 /*10*/] = CREATE_PED(26, joaat("s_m_m_security_01"), 1229.557f, -3002.882f, 8.31909f, -30.33f, 1, 1);
					GIVE_WEAPON_TO_PED(Local_64[6 /*10*/], joaat("weapon_pistol"), -1, 0, 1);
					SET_PED_CONFIG_FLAG(Local_64[6 /*10*/], 330, 1);
					SET_PED_AS_COP(Local_64[6 /*10*/], 1);
					CLEAR_SEQUENCE_TASK(&uLocal_379);
					OPEN_SEQUENCE_TASK(&uLocal_379);
					...
					CLOSE_SEQUENCE_TASK(uLocal_379);
					TASK_PERFORM_SEQUENCE(Local_64[6 /*10*/], uLocal_379);
					CLEAR_SEQUENCE_TASK(&uLocal_379);
					Local_64[7 /*10*/] = CREATE_PED(26, joaat("s_m_m_security_01"), 1229.557f, -3002.882f, 8.31909f, -30.33f, 1, 1);
					SET_PED_CONFIG_FLAG(Local_64[7 /*10*/], 330, 1);
					GIVE_WEAPON_TO_PED(Local_64[7 /*10*/], joaat("weapon_pistol"), -1, 0, 1);
					SET_PED_AS_COP(Local_64[7 /*10*/], 1);
					CLEAR_SEQUENCE_TASK(&uLocal_379);
					OPEN_SEQUENCE_TASK(&uLocal_379);
					...
					TASK_COMBAT_PED(0, PLAYER_PED_ID(), 0, 16);
					CLOSE_SEQUENCE_TASK(uLocal_379);
					TASK_PERFORM_SEQUENCE(Local_64[7 /*10*/], uLocal_379);
					CLEAR_SEQUENCE_TASK(&uLocal_379);
					func_83(&uLocal_460, joaat("s_m_m_security_01"));
				}
				else
				{
					Local_64[5 /*10*/] = CREATE_PED(26, joaat("s_m_m_dockwork_01"), 1228.929f, -3015.008f, 8.31909f, 0, 1, 1);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_64[5 /*10*/], 1);
					CLEAR_SEQUENCE_TASK(&uLocal_379);
					OPEN_SEQUENCE_TASK(&uLocal_379);
					...
					CLOSE_SEQUENCE_TASK(uLocal_379);
					TASK_PERFORM_SEQUENCE(Local_64[5 /*10*/], uLocal_379);
					CLEAR_SEQUENCE_TASK(&uLocal_379);
					func_83(&uLocal_460, joaat("s_m_m_security_01"));
				}
				if (func_101(Local_64[4 /*10*/]))
				{
					CLEAR_PED_TASKS(Local_64[4 /*10*/]);
					SET_ENTITY_COORDS(Local_64[4 /*10*/], 1229.557f, -3002.882f, 8.31909f, 1, 0, 0, 1);
				}
				else
				{
					Local_64[4 /*10*/] = CREATE_PED(26, joaat("s_m_m_dockwork_01"), 1229.557f, -3002.882f, 8.31909f, -99f, 1, 1);
				}
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_64[4 /*10*/], 1);
				STOP_PED_SPEAKING(Local_64[4 /*10*/], 1);
				CLEAR_SEQUENCE_TASK(&uLocal_379);
				OPEN_SEQUENCE_TASK(&uLocal_379);
				TASK_LOOK_AT_ENTITY(0, PLAYER_PED_ID(), -1, 2096, 2);
				...
				CLOSE_SEQUENCE_TASK(uLocal_379);
				TASK_PERFORM_SEQUENCE(Local_64[4 /*10*/], uLocal_379);
				CLEAR_SEQUENCE_TASK(&uLocal_379);
				iLocal_456 = GET_GAME_TIMER();
				iLocal_459 = 0;
				iLocal_458 = 0;
				CLEAR_HELP(1);
				...
				if (DOES_BLIP_EXIST(Local_55[0 /*2*/].f_1))
				{
					REMOVE_BLIP(&(Local_55[0 /*2*/].f_1));
				}
				SET_OBJECT_AS_NO_LONGER_NEEDED(&(Local_169[3 /*2*/]));
				SET_OBJECT_AS_NO_LONGER_NEEDED(&(Local_169[0 /*2*/]));
				SET_OBJECT_AS_NO_LONGER_NEEDED(&(Local_169[1 /*2*/]));
			...
			else if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), 1) < 5f && !iLocal_388)
			{
	...
	if ((!iLocal_398 && func_101(Local_55[0 /*2*/])) && IS_ENTITY_IN_WATER(Local_55[0 /*2*/]))
	{
		PLAY_SOUND_FROM_ENTITY(-1, "SUB_SPLASH", Local_55[0 /*2*/], "DOCKS_HEIST_PREP_1_SOUNDSET", 0, 0);
		iLocal_398 = 1;
	}
	if (((!iLocal_383 && DOES_ENTITY_EXIST(Local_169[0 /*2*/])) && DOES_ENTITY_EXIST(Local_169[1 /*2*/])) && func_101(Local_55[0 /*2*/]))
	{
		if (DOES_ENTITY_HAVE_PHYSICS(Local_169[0 /*2*/]) && DOES_ENTITY_HAVE_PHYSICS(Local_169[1 /*2*/]))
		{
			SET_CG_AT_BOUNDCENTER(Local_55[0 /*2*/]);
			Local_145[0 /*5*/] = ADD_ROPE(1260.692f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_2109, 1, fLocal_2109, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
			ATTACH_ENTITIES_TO_ROPE(Local_145[0 /*5*/], Local_169[0 /*2*/], Local_55[0 /*2*/], GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[0 /*2*/], 0f, 0f, 0f), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_55[0 /*2*/], 1.8f, 1.02f, 1.11f), fLocal_2109, 0, 0, 0, 0);
			Local_145[1 /*5*/] = ADD_ROPE(1260.692f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_2109, 1, fLocal_2109, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
			ATTACH_ENTITIES_TO_ROPE(Local_145[1 /*5*/], Local_169[0 /*2*/], Local_55[0 /*2*/], GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[0 /*2*/], 0f, 0f, 0f), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_55[0 /*2*/], -1.8f, 1.02f, 1.11f), fLocal_2109, 0, 0, 0, 0);
			Local_145[2 /*5*/] = ADD_ROPE(1260.692f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_2109, 1, fLocal_2109, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
			ATTACH_ENTITIES_TO_ROPE(Local_145[2 /*5*/], Local_169[1 /*2*/], Local_55[0 /*2*/], GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[1 /*2*/], 0f, 0f, 0f), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_55[0 /*2*/], 1.8f, -3.07f, 1.11f), fLocal_2109, 0, 0, 0, 0);
			Local_145[3 /*5*/] = ADD_ROPE(1260.752f, -3004.994f, 22.68315f, 0f, 0f, 0f, fLocal_2109, 1, fLocal_2109, 0.5f, 0.5f, 0, 0, 0, 10f, 1, 0);
			ATTACH_ENTITIES_TO_ROPE(Local_145[3 /*5*/], Local_169[1 /*2*/], Local_55[0 /*2*/], GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_169[1 /*2*/], 0f, 0f, 0f), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_55[0 /*2*/], -1.8f, -3.07f, 1.11f), fLocal_2109, 0, 0, 0, 0);
			iLocal_383 = 1;
			iLocal_385 = 0;
			ACTIVATE_PHYSICS(Local_55[0 /*2*/]);
			APPLY_FORCE_TO_ENTITY_CENTER_OF_MASS(Local_55[0 /*2*/], 1, 0f, 0f, 0.01f, 0, 0, 1, 0);
		}
	}
	...
	if (!iLocal_386)
	{
		if (DOES_ENTITY_EXIST(Local_169[3 /*2*/]))
		{
			if (DOES_ENTITY_HAVE_PHYSICS(Local_169[3 /*2*/]))
			{
				ATTACH_ENTITY_TO_ENTITY(Local_169[3 /*2*/], Local_64[4 /*10*/], GET_PED_BONE_INDEX(Local_64[4 /*10*/], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
				iLocal_386 = 1;
			}
		}
	}
	if (DOES_ENTITY_EXIST(Local_169[3 /*2*/]) && ((func_101(Local_64[4 /*10*/]) && IS_PED_FLEEING(Local_64[4 /*10*/])) || !func_101(Local_64[4 /*10*/])))
	{
		if (func_101(Local_64[4 /*10*/]) && IS_ENTITY_PLAYING_ANIM(Local_64[4 /*10*/], cLocal_50, "cellphone_call_listen_c", 3))
		{
			STOP_ANIM_TASK(Local_64[4 /*10*/], cLocal_50, "cellphone_call_listen_c", -1056964608);
		}
		if (IS_ENTITY_ATTACHED_TO_ANY_PED(Local_169[3 /*2*/]))
		{
			DETACH_ENTITY(Local_169[3 /*2*/], 1, 1);
		}
	}
	if (func_19() == 2)
	{
		if (func_101(Local_55[0 /*2*/]))
		{
			SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_55[0 /*2*/], 1);
		}
	}
	else if (func_101(Local_55[0 /*2*/]))
	{
	...
	if (DOES_ENTITY_EXIST(Global_97130.f_4))
	{
		if (IS_VEHICLE_DRIVEABLE(Global_97130.f_4, 0))
		{
			if (func_254(24) != Global_97130.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_251(GET_ENTITY_COORDS(Global_97130.f_4, 1), iParam5, &vVar0, &uVar3))
					{
						vParam0 = { vVar0 };
						fParam3 = uVar3;
					}
				}
				func_225(Global_97130.f_4, vParam0, fParam3, 24, 0);
			}
		}
	}
}
...
{
	if ((((((((((!DOES_ENTITY_EXIST(iParam0) || !IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_121(iParam0, 0, 0)) || func_121(iParam0, 1, 0)) || func_121(iParam0, 2, 0)) || func_111(iParam0) != 145) || func_242(iParam0)) || func_241(iParam0)) || func_240(iParam0)) || func_239(iParam0)) || !func_229(GET_ENTITY_MODEL(iParam0)))
	{
		if (func_241(iParam0))
		{
		}
...
void func_264()
{
	...
	{
		if (!_0x84DE3B5FB3E666F0(&(Local_145[iLocal_382 /*5*/])))
		{
	...
	if (bVar1)
	{
		if (((((!_0x84DE3B5FB3E666F0(&(Local_145[0 /*5*/])) && !_0x84DE3B5FB3E666F0(&(Local_145[1 /*5*/]))) && (!Local_145[0 /*5*/].f_4 || !Local_145[1 /*5*/].f_4)) || ((!_0x84DE3B5FB3E666F0(&(Local_145[2 /*5*/])) && !_0x84DE3B5FB3E666F0(&(Local_145[3 /*5*/]))) && (!Local_145[2 /*5*/].f_4 || !Local_145[3 /*5*/].f_4))) || iVar0 == 3) && iVar0 < 4)
		{
			if (iLocal_2116 > 0)
			{
				if (uLocal_2113[(iLocal_2116 - 1)] != -1)
				{
					STOP_SOUND(uLocal_2113[(iLocal_2116 - 1)]);
				}
			}
			if (uLocal_2113[iLocal_2116] != -1)
			{
				PLAY_SOUND_FROM_COORD(uLocal_2113[iLocal_2116], "DOCKS_HEIST_PREP_1_SUB_SWING", 1260.896f, -3006.556f, 23.4213f, 0, 0, 0, 0);
				iLocal_2116++;
			}
		}
		else if (iVar0 <= 2)
		{
			PLAY_SOUND_FROM_COORD(-1, "DOCKS_HEIST_PREP_1_SUB_TILT", 1260.896f, -3006.556f, 23.4213f, 0, 0, 0, 0);
		}
		iLocal_382 = 0;
		while (iLocal_382 < Local_145)
		{
			if (!_0x84DE3B5FB3E666F0(&(Local_145[iLocal_382 /*5*/])))
			{
				if (!Local_145[iLocal_382 /*5*/].f_4)
				{
					PLAY_SOUND_FROM_COORD(-1, "DOCKS_HEIST_PREP_1_CABLE_SNAP", 1260.896f, -3006.556f, 23.4213f, 0, 0, 0, 0);
				}
...
void func_272()
{
	...
	{
		if (DOES_ENTITY_EXIST(Local_64[iLocal_382 /*10*/]))
		{
			if (Local_64[iLocal_382 /*10*/] != Local_64[3 /*10*/])
			{
				...
				else if (DOES_BLIP_EXIST(Local_64[iLocal_382 /*10*/].f_2))
				{
					REMOVE_BLIP(&(Local_64[iLocal_382 /*10*/].f_2));
				}
			}
			if (IS_PED_INJURED(Local_64[iLocal_382 /*10*/]))
			{
				if (Local_64[iLocal_382 /*10*/] == Local_64[3 /*10*/])
				{
					func_87(7);
			...
			{
				if (func_10(Local_64[3 /*10*/], PLAYER_PED_ID(), 1) > 300f)
				{
					func_87(11);
				}
			}
	...
	{
		if (DOES_ENTITY_EXIST(Local_55[iLocal_382 /*2*/]))
		{
			if (!IS_VEHICLE_DRIVEABLE(Local_55[iLocal_382 /*2*/], 0))
			{
			...
			else if (iLocal_392)
			{
				if (Local_55[iLocal_382 /*2*/] == Local_55[0 /*2*/] || Local_55[iLocal_382 /*2*/] == Local_55[1 /*2*/])
				{
					if (iLocal_2103 == 2)
					{
						if (GET_ENTITY_SUBMERGED_LEVEL(Local_55[iLocal_382 /*2*/]) > 0.5f)
						{
							func_87(5);
						}
					}
	...
	if (func_101(Local_55[0 /*2*/]) && func_101(PLAYER_PED_ID()))
	{
		if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), 1) > 750f)
		{
			func_87(10);
		}
		else if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), 1) > 700f)
		{
	...
	if ((((IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1240.402f, -2880.396f, 8.25003f, 1240.384f, -2924.513f, 40.81909f, 28.875f, 0, 1, 0) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1240.222f, -3035.469f, 16.02625f, 1240.409f, -2924.159f, 8.06909f, 28.875f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1240.464f, -3035.127f, 13.00698f, 1240.617f, -3057.122f, 16.97133f, 27.6875f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1240.537f, -2967.822f, 32.94558f, 1240.792f, -2943.657f, 10.00659f, 12.1875f, 0, 1, 0)) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1261.525f, -3006.275f, 29.21641f, 1237.788f, -3006.826f, 12.87723f, 8.1875f, 0, 1, 0))
	{
		...
		if ((!IS_ENTITY_IN_AIR(uVar0) && !IS_ENTITY_IN_WATER(uVar0)) && (!DOES_ENTITY_EXIST(Local_55[0 /*2*/]) || !IS_ENTITY_TOUCHING_ENTITY(uVar0, Local_55[0 /*2*/])))
		{
			if (!iLocal_391)
			{
				func_273(593);
	...
	{
		_0xFD3151CD37EA2245(Local_55[0 /*2*/]);
	}
}
	...
	switch (iLocal_399)
	{
		case 0:
			if (func_101(Local_64[4 /*10*/]))
			{
				if (iLocal_404)
				{
					TASK_PLAY_ANIM(Local_64[4 /*10*/], cLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0, 0, 0, 0);
					if (GET_IS_WAYPOINT_RECORDING_LOADED("docksprep1"))
					{
						TASK_FOLLOW_WAYPOINT_RECORDING(Local_64[4 /*10*/], "docksprep1", 0, 8, -1);
					}
					else
					{
		...
		case 1:
			if (!iLocal_404)
			{
				if ((GET_GAME_TIMER() - iLocal_403) > 2000 || GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(Local_64[4 /*10*/], 1), 1) < 10f)
				{
					iLocal_404 = 1;
					iLocal_399 = 0;
				}
			}
			if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, 1, 0))
			{
				if (func_101(Local_64[4 /*10*/]))
				{
					if (_CAN_PED_SEE_PED(Local_64[4 /*10*/], PLAYER_PED_ID()))
					{
						CLEAR_PED_TASKS(Local_64[4 /*10*/]);
						STOP_CURRENT_PLAYING_AMBIENT_SPEECH(Local_64[4 /*10*/]);
						func_218(&uLocal_213, 3, Local_64[4 /*10*/], "CONSTRUCTION2", 0, 1);
						iLocal_399 = 2;
					}
					else if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(Local_64[4 /*10*/], 1), 1) < 12f && GET_PLAYER_CURRENT_STEALTH_NOISE(PLAYER_ID()) > 8.5f)
					{
						STOP_CURRENT_PLAYING_AMBIENT_SPEECH(Local_64[4 /*10*/]);
						if (!func_277(Local_64[4 /*10*/], 1464580341, 1))
						{
							TASK_TURN_PED_TO_FACE_COORD(Local_64[4 /*10*/], GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 4000);
							TASK_PLAY_ANIM(Local_64[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 4f, -8f, -1, 49, 0, 0, 0, 0);
						}
					}
					else if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(Local_64[4 /*10*/], 1), 1) < 12f && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
					{
						if (!func_277(Local_64[4 /*10*/], 1464580341, 1))
						{
							TASK_TURN_PED_TO_FACE_COORD(Local_64[4 /*10*/], GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 4000);
					...
					else if (((SET_WEAPON_SMOKEGRENADE_ASSIGNED(PLAYER_PED_ID()) && (GET_CLOCK_HOURS() >= 19 || GET_CLOCK_HOURS() < 6)) && func_10(PLAYER_PED_ID(), Local_64[4 /*10*/], 1) < 25f) && (IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), Local_64[4 /*10*/]) || IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), Local_64[4 /*10*/])))
					{
						if (!func_277(Local_64[4 /*10*/], 1464580341, 1))
						{
							TASK_TURN_PED_TO_FACE_COORD(Local_64[4 /*10*/], GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 4000);
				...
				if (iLocal_2104 > 1)
				{
					if (func_101(Local_64[4 /*10*/]))
					{
						if (HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(Local_64[4 /*10*/], Local_55[0 /*2*/]))
						{
							STOP_CURRENT_PLAYING_AMBIENT_SPEECH(Local_64[4 /*10*/]);
							func_218(&uLocal_213, 3, Local_64[4 /*10*/], "CONSTRUCTION2", 0, 1);
							iLocal_399 = 3;
							iLocal_401 = 3;
							CLEAR_PED_TASKS_IMMEDIATELY(Local_64[4 /*10*/]);
							TASK_FOLLOW_NAV_MESH_TO_COORD(Local_64[4 /*10*/], 1252.558f, -3004.846f, 8.31909f, 2f, -1, 0.25f, 0, -122.93f);
							iLocal_403 = GET_GAME_TIMER();
							iLocal_404 = 0;
						}
					}
			...
			if (func_101(Local_64[4 /*10*/]))
			{
				if (!IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(Local_64[4 /*10*/]))
				{
					if (iLocal_404)
					{
						if ((GET_SCRIPT_TASK_STATUS(Local_64[4 /*10*/], 242628503) != 1 && GET_SCRIPT_TASK_STATUS(Local_64[4 /*10*/], 713668775) != 1) && GET_SCRIPT_TASK_STATUS(Local_64[4 /*10*/], 1464580341) != 1)
						{
							if (!IS_ENTITY_PLAYING_ANIM(Local_64[4 /*10*/], cLocal_50, "cellphone_call_listen_c", 3))
							{
								TASK_PLAY_ANIM(Local_64[4 /*10*/], cLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0, 0, 0, 0);
							}
							if (IS_ENTITY_AT_COORD(Local_64[4 /*10*/], 1228.056f, -3000.427f, 8.4424f, 2f, 2f, 2f, 0, 1, 0))
							{
								if (GET_IS_WAYPOINT_RECORDING_LOADED("docksprep1"))
								{
									TASK_FOLLOW_WAYPOINT_RECORDING(Local_64[4 /*10*/], "docksprep1", 0, 0, -1);
								}
							}
				...
				{
					if ((GET_GAME_TIMER() - iLocal_407) > 10000)
					{
						if (!WAYPOINT_PLAYBACK_GET_IS_PAUSED(Local_64[4 /*10*/]))
						{
							if (IS_ENTITY_AT_COORD(Local_64[4 /*10*/], 1251.625f, -3003.338f, 8.31909f, 2f, 2f, 2f, 0, 1, 0))
							{
								WAYPOINT_PLAYBACK_PAUSE(Local_64[4 /*10*/], 0, 0);
							}
							else if (IS_ENTITY_AT_COORD(Local_64[4 /*10*/], 1228.849f, -2986.284f, 8.31909f, 2f, 2f, 2f, 0, 1, 0))
							{
								WAYPOINT_PLAYBACK_PAUSE(Local_64[4 /*10*/], 0, 0);
							}
						}
						...
						{
							iLocal_407 = GET_GAME_TIMER();
							WAYPOINT_PLAYBACK_RESUME(Local_64[4 /*10*/], 1, -1, 3000);
						}
					}
					if (!IS_AMBIENT_SPEECH_PLAYING(Local_64[4 /*10*/]) && (GET_GAME_TIMER() - iLocal_408) > 4000)
					{
						func_276(Local_64[4 /*10*/], "Sol1_EFAA", "CONSTRUCTION2", 3);
						iLocal_408 = GET_GAME_TIMER();
					}
				}
				if (((HAS_PED_RECEIVED_EVENT(Local_64[4 /*10*/], 122) || HAS_PED_RECEIVED_EVENT(Local_64[4 /*10*/], 123)) || HAS_PED_RECEIVED_EVENT(Local_64[4 /*10*/], 124)) || HAS_PED_RECEIVED_EVENT(Local_64[4 /*10*/], 116))
				{
					STOP_CURRENT_PLAYING_AMBIENT_SPEECH(Local_64[4 /*10*/]);
					func_218(&uLocal_213, 3, Local_64[4 /*10*/], "CONSTRUCTION2", 0, 1);
					iLocal_399 = 3;
					iLocal_401 = 1;
					TASK_PLAY_ANIM(Local_64[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 1000f, -8f, -1, 49, 0, 0, 0, 0);
					TASK_HANDS_UP(Local_64[4 /*10*/], -1, PLAYER_PED_ID(), -1, 1);
				}
				else if (HAS_PED_RECEIVED_EVENT(Local_64[4 /*10*/], 23))
				{
					STOP_CURRENT_PLAYING_AMBIENT_SPEECH(Local_64[4 /*10*/]);
					func_218(&uLocal_213, 3, Local_64[4 /*10*/], "CONSTRUCTION2", 0, 1);
					iLocal_399 = 3;
					...
					CLEAR_PED_TASKS(Local_64[4 /*10*/]);
					TASK_PLAY_ANIM(Local_64[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 1000f, -8f, -1, 49, 0, 0, 0, 0);
					TASK_COWER(Local_64[4 /*10*/], -1);
				}
				else if (HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_64[4 /*10*/], PLAYER_PED_ID(), 1))
				{
					STOP_CURRENT_PLAYING_AMBIENT_SPEECH(Local_64[4 /*10*/]);
					TASK_PLAY_ANIM(Local_64[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 1000f, -8f, -1, 49, 0, 0, 0, 0);
					func_218(&uLocal_213, 3, Local_64[4 /*10*/], "CONSTRUCTION2", 0, 1);
		...
		case 2:
			if (func_101(Local_64[4 /*10*/]))
			{
				if (!IS_PED_HEADTRACKING_PED(Local_64[4 /*10*/], PLAYER_PED_ID()))
				{
					TASK_LOOK_AT_ENTITY(Local_64[4 /*10*/], PLAYER_PED_ID(), -1, 3104, 2);
				}
			}
			switch (iLocal_400)
			{
				case 0:
					if (func_101(Local_64[4 /*10*/]))
					{
						...
						{
							OPEN_SEQUENCE_TASK(&uLocal_379);
							TASK_GO_TO_ENTITY(0, PLAYER_PED_ID(), -1, 4f, 1073741824, 1073741824, 0);
							TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER_PED_ID(), -1);
							CLOSE_SEQUENCE_TASK(uLocal_379);
							TASK_PERFORM_SEQUENCE(Local_64[4 /*10*/], uLocal_379);
							CLEAR_SEQUENCE_TASK(&uLocal_379);
							TASK_PLAY_ANIM(Local_64[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 1000f, -8f, -1, 49, 0, 0, 0, 0);
							iLocal_402 = GET_GAME_TIMER();
							iLocal_400 = 1;
						}
					}
					break;
				...
				case 1:
					if ((GET_GAME_TIMER() - iLocal_402) > 4000)
					{
						if (func_101(Local_64[4 /*10*/]))
						{
				...
				case 2:
					if ((GET_GAME_TIMER() - iLocal_402) > 8000)
					{
						if (func_101(Local_64[4 /*10*/]))
						{
			...
			if (!IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, 1, 0) || !func_101(Local_64[4 /*10*/]))
			{
				iLocal_399 = 0;
			}
			GET_CURRENT_PED_WEAPON(PLAYER_PED_ID(), &iLocal_406, 1);
			if (func_101(Local_64[4 /*10*/]))
			{
				if ((HAS_PED_RECEIVED_EVENT(Local_64[4 /*10*/], 122) || HAS_PED_RECEIVED_EVENT(Local_64[4 /*10*/], 123)) || HAS_PED_RECEIVED_EVENT(Local_64[4 /*10*/], 124))
				{
					func_218(&uLocal_213, 3, Local_64[4 /*10*/], "CONSTRUCTION2", 0, 1);
					iLocal_399 = 3;
					iLocal_401 = 1;
				...
				else if (IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), Local_64[4 /*10*/]) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), Local_64[4 /*10*/]))
				{
					if (GET_WEAPONTYPE_GROUP(iLocal_406) != -728555052 && iLocal_406 != joaat("weapon_unarmed"))
					{
						func_218(&uLocal_213, 3, Local_64[4 /*10*/], "CONSTRUCTION2", 0, 1);
						iLocal_399 = 3;
						iLocal_401 = 1;
						CLEAR_PED_TASKS_IMMEDIATELY(Local_64[4 /*10*/]);
						TASK_HANDS_UP(Local_64[4 /*10*/], -1, PLAYER_PED_ID(), -1, 0);
					}
				}
				else if (HAS_PED_RECEIVED_EVENT(Local_64[4 /*10*/], 23))
				{
		...
		case 3:
			switch (iLocal_401)
			{
				...
				case 3:
					if (func_101(Local_64[4 /*10*/]))
					{
						if (IS_ENTITY_AT_COORD(Local_64[4 /*10*/], 1252.558f, -3004.846f, 8.31909f, 2f, 2f, 2f, 0, 1, 0))
						{
						...
						if (!IS_PED_HEADTRACKING_ENTITY(Local_64[4 /*10*/], Local_55[0 /*2*/]))
						{
							TASK_LOOK_AT_ENTITY(Local_64[4 /*10*/], Local_55[0 /*2*/], -1, 2096, 2);
						}
					}
					else
					{
				...
				case 4:
					if (func_101(Local_64[4 /*10*/]))
					{
						if (!IS_PED_RAGDOLL(Local_64[4 /*10*/]) && !IS_PED_GETTING_UP(Local_64[4 /*10*/]))
						{
				...
				case 5:
					if ((GET_GAME_TIMER() - iLocal_402) > 8000)
					{
						...
						if (func_101(Local_64[4 /*10*/]))
						{
							if (iLocal_405)
							{
								if (!IS_PED_FLEEING(Local_64[4 /*10*/]))
								{
									TASK_SMART_FLEE_PED(Local_64[4 /*10*/], PLAYER_PED_ID(), 200f, -1, 0, 0);
								}
							}
							else if (GET_SCRIPT_TASK_STATUS(Local_64[4 /*10*/], 923520851) != 1)
							{
								TASK_WANDER_IN_AREA(Local_64[4 /*10*/], 1183.287f, -2947.87f, 4.8986f, 100f, 1077936128, 1086324736);
							}
						}
					}
					if (!iLocal_405)
						...
						if (func_101(Local_64[4 /*10*/]))
						{
							if ((HAS_PED_RECEIVED_EVENT(Local_64[4 /*10*/], 122) || HAS_PED_RECEIVED_EVENT(Local_64[4 /*10*/], 123)) || HAS_PED_RECEIVED_EVENT(Local_64[4 /*10*/], 124))
							{
								...
								if (func_12(&uLocal_213, "SOL1AUD", "SOL1_ARM2", 7, 0, 0, 0))
								{
									CLEAR_PED_TASKS(Local_64[4 /*10*/]);
									OPEN_SEQUENCE_TASK(&uLocal_379);
									TASK_HANDS_UP(0, 3000, PLAYER_PED_ID(), -1, 0);
									TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1228.775f, -2923.852f, 8.31909f, 2f, 20000, 1048576000, 0, 1193033728);
									TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 200f, -1, 0, 0);
									CLOSE_SEQUENCE_TASK(uLocal_379);
									TASK_PERFORM_SEQUENCE(Local_64[4 /*10*/], uLocal_379);
							...
							else if ((IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER_ID(), Local_64[4 /*10*/]) || IS_PLAYER_TARGETTING_ENTITY(PLAYER_ID(), Local_64[4 /*10*/])) && IS_PED_FACING_PED(Local_64[4 /*10*/], PLAYER_PED_ID(), 160f))
							{
								if (GET_WEAPONTYPE_GROUP(iLocal_406) != -728555052 && iLocal_406 != joaat("weapon_unarmed"))
								{
...
{
	_PLAY_AMBIENT_SPEECH_WITH_VOICE(uParam0, sParam1, sParam2, func_54(iParam3), 0);
}
...
void func_278()
{
	switch (iLocal_459)
	{
		case 0:
			switch (iLocal_458)
			{
				case 0:
					if (func_101(Local_55[0 /*2*/]))
					{
						if ((!IS_MESSAGE_BEING_DISPLAYED() && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_55[0 /*2*/], 0)) && GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) == 0)
						{
							func_283();
							iLocal_456 = GET_GAME_TIMER();
							iLocal_458 = 1;
				...
				case 1:
					if ((GET_GAME_TIMER() - iLocal_456) > 6000 && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_55[0 /*2*/], 0))
					{
						func_218(&uLocal_213, 1, 0, "FLOYD", 0, 1);
		...
		case 2:
			...
			{
				case 0:
					if ((!IS_MESSAGE_BEING_DISPLAYED() && IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_55[0 /*2*/], 0)) && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 324.7653f, -2974.495f, -1f, 1) < 110f)
					{
						func_283();
						iLocal_458 = 1;
					}
		...
		case 3:
			if (func_101(Local_55[2 /*2*/]) && func_101(Local_64[3 /*10*/]))
			{
				...
				{
					case 0:
						if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_55[2 /*2*/], 0) && IS_PED_IN_VEHICLE(Local_64[3 /*10*/], Local_55[2 /*2*/], 0))
						{
							if (func_11())
							{
								func_283();
					...
					case 2:
						if (!IS_AMBIENT_SPEECH_PLAYING(Local_64[3 /*10*/]))
						{
							iLocal_458 = 3;
						}
						break;
		...
		case 4:
			if (func_101(Local_55[2 /*2*/]) && func_101(Local_64[3 /*10*/]))
			{
				...
				{
					case 0:
						if (((IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && IS_PED_IN_VEHICLE(Local_64[3 /*10*/], GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0)) && IS_ENTITY_ATTACHED_TO_ENTITY(Local_55[1 /*2*/], GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0))) && !IS_MESSAGE_BEING_DISPLAYED())
						{
							func_283();
							iLocal_456 = GET_GAME_TIMER();
							iLocal_458 = 1;
					...
					case 1:
						if ((GET_GAME_TIMER() - iLocal_456) > 2000)
						{
							func_218(&uLocal_213, 1, Local_64[3 /*10*/], "FLOYD", 0, 1);
					...
					case 2:
						if (func_11())
						{
							if ((IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && IS_PED_IN_VEHICLE(Local_64[3 /*10*/], GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0)) && IS_ENTITY_ATTACHED_TO_ENTITY(Local_55[1 /*2*/], GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0)))
							{
								if (func_31())
								{
									func_282(0);
				...
				if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), -323.73f, -2613.702f, 5f, 1) < 60f)
				{
					func_281();
					iLocal_458 = 3;
				}
		...
		case 5:
			...
			{
				case 0:
					if ((((IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && IS_PED_IN_VEHICLE(Local_64[3 /*10*/], GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0)) && IS_ENTITY_ATTACHED_TO_ENTITY(Local_55[1 /*2*/], GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0))) && !IS_MESSAGE_BEING_DISPLAYED()) && IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), -273.635f, -2558.818f, 4.751376f, -405.7218f, -2695.898f, 14.37495f, 51f, 0, 1, 0))
					{
						func_283();
						iLocal_458 = 1;
					}
		...
		case 6:
			...
			{
				case 0:
					if ((((IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0) && IS_PED_IN_VEHICLE(Local_64[3 /*10*/], GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0)) && IS_ENTITY_ATTACHED_TO_ENTITY(Local_55[1 /*2*/], GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0))) && !IS_MESSAGE_BEING_DISPLAYED()) && GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(Local_55[0 /*2*/], 1), -323.73f, -2613.702f, 5f, 1) < 40f)
					{
						func_283();
						iLocal_458 = 1;
					}
...
void func_289()
{
	if (!func_101(Local_55[0 /*2*/]))
	{
		Local_55[0 /*2*/] = CREATE_VEHICLE(joaat("submersible"), -337.7228f, -2623.835f, 8.6595f, 135.24f, 1, 1, 0);
		SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_55[0 /*2*/], 0);
		SET_VEHICLE_ENGINE_ON(Local_55[0 /*2*/], 0, 1, 0);
		SET_VEHICLE_LIGHTS(Local_55[0 /*2*/], 1);
		SET_VEHICLE_RADIO_ENABLED(Local_55[0 /*2*/], 1);
		_0xA80AE305E0A3044F(Local_55[0 /*2*/], 0);
	}
	if (!func_101(Local_55[2 /*2*/]))
	{
		Local_55[2 /*2*/] = CREATE_VEHICLE(joaat("packer"), -337.7228f, -2627.038f, 5.001f, 134.9894f, 1, 1, 0);
		SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(Local_55[2 /*2*/], 0);
		SET_VEHICLE_COLOUR_COMBINATION(Local_55[2 /*2*/], 0);
		SET_VEHICLE_TYRES_CAN_BURST(Local_55[2 /*2*/], 0);
		SET_VEHICLE_HAS_STRONG_AXLES(Local_55[2 /*2*/], 1);
	...
	if (!func_101(Local_55[1 /*2*/]))
	{
		Local_55[1 /*2*/] = CREATE_VEHICLE(joaat("armytrailer"), -331.728f, -2621.006f, 7.8828f, 135.24f, 1, 1, 0);
		SET_VEHICLE_HAS_STRONG_AXLES(Local_55[1 /*2*/], 1);
	}
	ATTACH_VEHICLE_TO_TRAILER(Local_55[2 /*2*/], Local_55[1 /*2*/], 0.5f);
	_0x95CF53B3D687F9FA(Local_55[1 /*2*/]);
	_0x16B5E274BDE402F8(Local_55[0 /*2*/], Local_55[1 /*2*/], 0f, -4f, -0.7f, 0f, 0f, 0f, 0f, 0f, 0f, -1f);
	if (!DOES_ENTITY_EXIST(Local_169[4 /*2*/]))
	{
		Local_169[4 /*2*/] = CREATE_OBJECT(joaat("prop_sub_cover_01"), 297.5948f, -2950.354f, 5.0008f, 1, 1, 0);
		ATTACH_ENTITY_TO_ENTITY(Local_169[4 /*2*/], Local_55[1 /*2*/], -1, vLocal_440, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	}
	if (!DOES_ENTITY_EXIST(Local_169[5 /*2*/]))
	{
		Local_169[5 /*2*/] = CREATE_OBJECT(joaat("prop_tarp_strap"), -332.8449f, -2622.157f, 8.7838f, 1, 1, 0);
		ATTACH_ENTITY_TO_ENTITY(Local_169[5 /*2*/], Local_55[1 /*2*/], -1, vLocal_440, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	}
...
void func_293()
{
	if (!func_101(Local_55[0 /*2*/]))
	{
		Local_55[0 /*2*/] = CREATE_VEHICLE(joaat("submersible"), 320.4211f, -2975.993f, -11.1896f, 2.5159f, 1, 1, 0);
		SET_VEHICLE_CAN_BE_VISIBLY_DAMAGED(Local_55[0 /*2*/], 0);
		SET_VEHICLE_ENGINE_ON(Local_55[0 /*2*/], 0, 1, 0);
		SET_VEHICLE_LIGHTS(Local_55[0 /*2*/], 1);
		SET_VEHICLE_RADIO_ENABLED(Local_55[0 /*2*/], 1);
	...
	if (!func_101(Local_55[2 /*2*/]))
	{
		Local_55[2 /*2*/] = CREATE_VEHICLE(joaat("packer"), 297.5948f, -2950.354f, 5.0008f, 359.1976f, 1, 1, 0);
		SET_VEHICLE_COLOUR_COMBINATION(Local_55[2 /*2*/], 0);
		SET_VEHICLE_TYRES_CAN_BURST(Local_55[2 /*2*/], 0);
		SET_VEHICLE_HAS_STRONG_AXLES(Local_55[2 /*2*/], 1);
	}
	if (!func_101(Local_55[1 /*2*/]))
	{
		Local_55[1 /*2*/] = CREATE_VEHICLE(joaat("armytrailer"), 297.2917f, -2970.246f, 4.8884f, 359.0483f, 1, 1, 0);
		SET_VEHICLE_CAN_BE_VISIBLY_DAMAGED(Local_55[1 /*2*/], 0);
		SET_VEHICLE_HAS_STRONG_AXLES(Local_55[1 /*2*/], 1);
	}
	ATTACH_VEHICLE_TO_TRAILER(Local_55[2 /*2*/], Local_55[1 /*2*/], 0.5f);
...
int func_294(var uParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	if (!func_21(iParam1))
	{
		...
		if (HAS_MODEL_LOADED(uVar0))
		{
			...
			{
				*uParam0 = CREATE_PED_INSIDE_VEHICLE(uParam2, 26, uVar0, iParam3, 0, 0);
...
void func_297()
{
	if (!DOES_ENTITY_EXIST(Local_55[0 /*2*/]))
	{
		Local_55[0 /*2*/] = CREATE_VEHICLE(joaat("submersible"), 1272.398f, -2982.072f, -3.2414f, 201.5542f, 1, 1, 0);
		SET_VEHICLE_RADIO_ENABLED(Local_55[0 /*2*/], 1);
	}
	if (func_304())
	{
	...
	{
		FREEZE_ENTITY_POSITION(PLAYER_PED_ID(), 0);
		SET_PED_INTO_VEHICLE(PLAYER_PED_ID(), Local_55[0 /*2*/], -1);
	}
	CLEAR_AREA(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 100f, 1, 0, 0, 0);
	iLocal_459 = 0;
	iLocal_458 = 0;
...
void func_298()
{
	if (!DOES_ENTITY_EXIST(Local_55[0 /*2*/]))
	{
		Local_55[0 /*2*/] = CREATE_VEHICLE(joaat("submersible"), 1260.802f, -3006.417f, 18.3289f, 178.9076f, 1, 1, 0);
		func_299(Local_55[0 /*2*/], 0);
		FREEZE_ENTITY_POSITION(Local_55[0 /*2*/], 1);
		SET_ENTITY_LOAD_COLLISION_FLAG(Local_55[0 /*2*/], 1, 1);
		_SET_ENTITY_SOMETHING(Local_55[0 /*2*/], 0);
		SET_VEHICLE_RADIO_ENABLED(Local_55[0 /*2*/], 1);
	}
	if (!DOES_ENTITY_EXIST(Local_64[4 /*10*/]))
	{
		Local_64[4 /*10*/] = CREATE_PED(26, joaat("s_m_m_dockwork_01"), 1229.322f, -3002.879f, 8.31861f, 270f, 1, 1);
		TASK_PLAY_ANIM(Local_64[4 /*10*/], cLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0, 0, 0, 0);
		SET_PED_FLEE_ATTRIBUTES(Local_64[4 /*10*/], 512, 0);
		SET_PED_COMBAT_ATTRIBUTES(Local_64[4 /*10*/], 17, 1);
		SET_PED_RELATIONSHIP_GROUP_HASH(Local_64[4 /*10*/], uLocal_395);
		SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_64[4 /*10*/], 1);
		SET_PED_VISUAL_FIELD_CENTER_ANGLE(Local_64[4 /*10*/], 45f);
		SET_PED_VISUAL_FIELD_MAX_ANGLE(Local_64[4 /*10*/], 50f);
		SET_PED_VISUAL_FIELD_MIN_ANGLE(Local_64[4 /*10*/], -50f);
		STOP_PED_SPEAKING(Local_64[4 /*10*/], 1);
	}
	if (!DOES_ENTITY_EXIST(Local_169[0 /*2*/]))
	{
		Local_169[0 /*2*/] = CREATE_OBJECT(joaat("prop_ld_test_01"), 1260.692f, -3008.286f, 23.73365f, 1, 1, 0);
		FREEZE_ENTITY_POSITION(Local_169[0 /*2*/], 1);
	}
	if (!DOES_ENTITY_EXIST(Local_169[1 /*2*/]))
	{
		Local_169[1 /*2*/] = CREATE_OBJECT(joaat("prop_ld_test_01"), 1260.752f, -3004.994f, 22.68315f, 1, 1, 0);
		FREEZE_ENTITY_POSITION(Local_169[1 /*2*/], 1);
	}
	if (!DOES_ENTITY_EXIST(Local_169[2 /*2*/]))
	{
		Local_169[2 /*2*/] = CREATE_OBJECT(joaat("prop_sub_release"), 1249.105f, -3007.968f, 9.68718f, 1, 1, 0);
		SET_ENTITY_ROTATION(Local_169[2 /*2*/], 0f, 0f, 90f, 2, 1);
		FREEZE_ENTITY_POSITION(Local_169[2 /*2*/], 1);
	}
	if (!DOES_ENTITY_EXIST(Local_169[3 /*2*/]))
	{
		Local_169[3 /*2*/] = CREATE_OBJECT(joaat("p_amb_phone_01"), 1229.322f, -3002.879f, 8.31861f, 1, 1, 0);
	}
	iLocal_383 = 0;
	REQUEST_WAYPOINT_RECORDING("docksprep1");
	...
	if (uParam0->f_982)
	{
		...
		while (iVar1 < 5)
		{
			if (uParam0->f_737[iVar1 /*5*/])
			{
				...
				{
					if (REQUEST_SCRIPT_AUDIO_BANK(uParam0->f_737[iVar1 /*5*/].f_4, 0, -1))
					{
...
int func_302(var uParam0, vector3 vParam1, float fParam4, int iParam5)
{
	...
	NEW_LOAD_SCENE_START_SPHERE(vParam1, fParam4, iParam5);
	uParam0->f_868 = 1;
	uParam0->f_868.f_3 = GET_GAME_TIMER();
	uParam0->f_868.f_4 = { vParam1 };
...
void func_306()
{
	...
	while (iLocal_382 <= (8 - 1))
	{
		...
		if (DOES_ENTITY_EXIST(Local_64[iLocal_382 /*10*/]) && !IS_PED_INJURED(Local_64[iLocal_382 /*10*/]))
		{
			if (IS_PED_IN_ANY_VEHICLE(Local_64[iLocal_382 /*10*/], 0))
			{
				SET_PED_COORDS_NO_GANG(Local_64[iLocal_382 /*10*/], GET_ENTITY_COORDS(GET_VEHICLE_PED_IS_IN(Local_64[iLocal_382 /*10*/], 0), 1) + Vector(0f, -2f, 0f));
			}
	...
	{
		if (DOES_ENTITY_EXIST(Local_169[iLocal_382 /*2*/]))
		{
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		CLEAR_PED_TASKS(PLAYER_PED_ID());
		CLEAR_AREA(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 300f, 1, 0, 0, 0);
	}
	CLEAR_AREA(1219.186f, -2977.9f, 4.8653f, 300f, 1, 0, 0, 0);
	iLocal_403 = GET_GAME_TIMER();
	iLocal_386 = 0;
	iLocal_404 = 0;
	iLocal_399 = 0;
	...
	if (DOES_ENTITY_EXIST(uParam0))
	{
		if (IS_VEHICLE_DRIVEABLE(uParam0, 0))
		{
			...
			if (DOES_ENTITY_EXIST(uVar0))
			{
				...
				{
					CLEAR_PED_TASKS_IMMEDIATELY(uVar0);
				}
				else
				{
					DELETE_PED(&uVar0);
			...
			iVar2 = GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(uParam0);
			iVar1 = 0;
			while (iVar1 < iVar2)
			{
				if (!IS_VEHICLE_SEAT_FREE(uParam0, iVar1, 0))
				{
					uVar0 = GET_PED_IN_VEHICLE_SEAT(uParam0, iVar1, 0);
					if (DOES_ENTITY_EXIST(uVar0))
					{
						if (!IS_PED_INJURED(uVar0))
						{
...
void func_315()
{
	switch (iLocal_2102)
	{
		...
		case 0:
			if ((GET_GAME_TIMER() - iLocal_2106) > 2500)
			{
				iLocal_2106 = GET_GAME_TIMER();
			}
			break;
	}
}
...
void func_319()
{
	...
	_0xD2B315B6689D537D(PLAYER_ID(), 0);
	REMOVE_RELATIONSHIP_GROUP(uLocal_394);
	REMOVE_RELATIONSHIP_GROUP(uLocal_395);
	ADD_RELATIONSHIP_GROUP("REL_BUDDY", &uLocal_394);
	ADD_RELATIONSHIP_GROUP("rel_dock", &uLocal_395);
	SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_395, 1862763509);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, 1862763509, uLocal_394);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_394, 1862763509);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_395, uLocal_395);
	if (!DOES_ENTITY_EXIST(Local_55[0 /*2*/]))
	{
	...
	if (!DOES_ENTITY_EXIST(Local_64[4 /*10*/]))
	{
		if (DOES_ENTITY_EXIST(Global_90209.f_9[0]))
		{
			...
			SET_PED_RELATIONSHIP_GROUP_HASH(Local_64[4 /*10*/], uLocal_395);
			SET_PED_CONFIG_FLAG(Local_64[4 /*10*/], 208, 1);
			SET_PED_VISUAL_FIELD_CENTER_ANGLE(Local_64[4 /*10*/], 45f);
			SET_PED_VISUAL_FIELD_MAX_ANGLE(Local_64[4 /*10*/], 50f);
			SET_PED_VISUAL_FIELD_MIN_ANGLE(Local_64[4 /*10*/], -50f);
		}
	...
	if (!DOES_ENTITY_EXIST(Local_169[1 /*2*/]))
	{
		if (DOES_ENTITY_EXIST(Global_90209.f_28[1]))
		{
			SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_28[1], 1, 1);
			Local_169[1 /*2*/] = Global_90209.f_28[1];
		}
	}
	if (!DOES_ENTITY_EXIST(Local_169[2 /*2*/]))
	{
		if (DOES_ENTITY_EXIST(Global_90209.f_28[2]))
		{
			SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_28[2], 1, 1);
			Local_169[2 /*2*/] = Global_90209.f_28[2];
		}
	}
	if (!DOES_ENTITY_EXIST(Local_169[3 /*2*/]))
	{
		if (DOES_ENTITY_EXIST(Global_90209.f_28[3]))
		{
			SET_ENTITY_AS_MISSION_ENTITY(Global_90209.f_28[3], 1, 1);
			Local_169[3 /*2*/] = Global_90209.f_28[3];
		}
	}
	if (Global_90209.f_357)
	{
		if (DOES_ROPE_EXIST(&(Global_90209.f_37[0])))
		{
			_0xB1B6216CA2E7B55E(Global_90209.f_37[0], 1, 1);
			Local_145[0 /*5*/] = Global_90209.f_37[0];
			Global_90209.f_37[0] = 0;
		}
		if (DOES_ROPE_EXIST(&(Global_90209.f_37[1])))
		{
			_0xB1B6216CA2E7B55E(Global_90209.f_37[1], 1, 1);
			Local_145[1 /*5*/] = Global_90209.f_37[1];
			Global_90209.f_37[1] = 0;
		}
		if (DOES_ROPE_EXIST(&(Global_90209.f_37[2])))
		{
			_0xB1B6216CA2E7B55E(Global_90209.f_37[2], 1, 1);
			Local_145[2 /*5*/] = Global_90209.f_37[2];
			Global_90209.f_37[2] = 0;
		}
		if (DOES_ROPE_EXIST(&(Global_90209.f_37[3])))
		{
			_0xB1B6216CA2E7B55E(Global_90209.f_37[3], 1, 1);
...
void func_324()
{
	...
	if (func_101(PLAYER_PED_ID()))
	{
		if (func_101(Local_55[0 /*2*/]))
		{
			if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), Local_55[0 /*2*/], 0))
			{
				SET_PED_COORDS_NO_GANG(PLAYER_PED_ID(), GET_ENTITY_COORDS(Local_55[0 /*2*/], 1) + Vector(2f, 0f, 0f));
			}
		}
	}
	func_203();
	...
	while (iLocal_382 <= (8 - 1))
	{
		...
		{
			func_314(&(Local_64[iLocal_382 /*10*/].f_2));
			if (DOES_BLIP_EXIST(Local_64[iLocal_382 /*10*/].f_1))
			{
				REMOVE_BLIP(&(Local_64[iLocal_382 /*10*/].f_1));
			}
			if (IS_PED_IN_GROUP(Local_64[iLocal_382 /*10*/]))
			{
				REMOVE_PED_FROM_GROUP(Local_64[iLocal_382 /*10*/]);
			}
			if (Local_64[iLocal_382 /*10*/] != PLAYER_PED_ID())
			{
				func_9(&(Local_64[iLocal_382 /*10*/]), 1, 0, 1);
			}
		}
	...
	while (iLocal_382 <= (4 - 1))
	{
		if (DOES_BLIP_EXIST(Local_55[iLocal_382 /*2*/].f_1))
		{
			REMOVE_BLIP(&(Local_55[iLocal_382 /*2*/].f_1));
		}
	...
	_0xD2B315B6689D537D(PLAYER_ID(), 1);
