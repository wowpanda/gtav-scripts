...
void func_8()
{
	switch (iLocal_1953)
	{
		...
		case 1:
			...
			{
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_53[0 /*2*/], 1), true) > 400f && !ENTITY::IS_ENTITY_ON_SCREEN(Local_53[0 /*2*/]))
				{
					func_87(9);
				}
			}
		...
		case 3:
			if (!func_11())
			{
				...
				{
					BRAIN::CLEAR_PED_TASKS(Local_54[3 /*10*/]);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_244);
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_244);
					BRAIN::TASK_ENTER_VEHICLE(0, Local_53[3 /*2*/], -1, -1, 2f, 1, 0);
					BRAIN::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_53[3 /*2*/], -189.8985f, -2622.707f, 5.0001f, 14, 30f, 786468, 5f, 1f, 1);
					BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(0, Local_53[3 /*2*/], PLAYER::PLAYER_PED_ID(), 8, 30f, 786468, 1000f, 10f, 1);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_244);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_54[3 /*10*/], iLocal_244);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_244);
				}
				...
				{
					BRAIN::CLEAR_PED_TASKS(Local_54[3 /*10*/]);
					BRAIN::TASK_SMART_FLEE_COORD(Local_54[3 /*10*/], vLocal_52, 300f, -1, 0, 0);
				}
				iLocal_301 = MISC::GET_GAME_TIMER();
				iLocal_1953++;
			}
						...
						if (func_60(uParam0->f_21, uParam0, iVar3))
						{
							...
							while (iVar0 < 3)
							{
								if (!PED::IS_PED_INJURED(uParam0->f_17[iVar0]))
								{
									...
									if (BRAIN::GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], -1794415470) == 7 && !func_77(uParam0->f_17[iVar0], uParam0->f_21))
									{
					...
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						...
						if (iVar10 != iParam10 && !ENTITY::IS_ENTITY_DEAD(iVar10, 0))
						{
							if (PED::IS_PED_SITTING_IN_VEHICLE(uParam0->f_17[iVar0], iVar10))
							{
								...
								{
									vVar19 = { ENTITY::GET_ENTITY_COORDS(iVar10, 1) };
									if (vVar19.z < -1f)
									{
						...
						if (!PED::IS_PED_SITTING_IN_VEHICLE(uParam0->f_17[iVar0], iParam10))
						{
							if ((ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], iParam10, 20f, 20f, 5f, 0, 1, 0) && !MISC::IS_BIT_SET(uParam0->f_13, 11)) && !((bParam17 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam10, 0)))
							{
								...
								else
								{
									...
									{
										if (((((!PED::IS_PED_JUMPING_OUT_OF_VEHICLE(uParam0->f_17[iVar0]) && !PED::IS_PED_JUMPING_OUT_OF_VEHICLE(PLAYER::PLAYER_PED_ID())) && !func_67(uParam0->f_17[iVar0], 2f)) && !PED::IS_PED_RAGDOLL(uParam0->f_17[iVar0])) && !BRAIN::IS_PED_GETTING_UP(uParam0->f_17[iVar0])) && !FIRE::IS_ENTITY_ON_FIRE(iParam10))
										{
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_17[iVar0], true);
...
void func_102(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_184(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_177(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar4 != -1)
			{
...
{
	func_104(&Global_98118, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_104(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_19();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_130())
		{
			func_123(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
...
int func_127(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2547365[iParam0 /*3*/][func_125(iParam1)];
...
void func_132(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < iVar6)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar5, &Var7) && !func_134(Var7.f_1)) && iVar9 < 50)
			{
...
void func_187()
{
	...
	switch (iLocal_1953)
	{
		...
		case 2:
			...
			if (func_101(Local_54[6 /*10*/]))
			{
				...
				{
					BRAIN::CLEAR_PED_TASKS(Local_54[6 /*10*/]);
			...
			if (func_101(Local_54[7 /*10*/]))
			{
				...
				{
					BRAIN::CLEAR_PED_TASKS(Local_54[7 /*10*/]);
			...
			if (func_101(Local_54[4 /*10*/]))
			{
				...
				{
					BRAIN::CLEAR_PED_TASKS(Local_54[4 /*10*/]);
			...
			if (func_101(Local_54[5 /*10*/]))
			{
				...
				{
					BRAIN::CLEAR_PED_TASKS(Local_54[5 /*10*/]);
					func_9(&(Local_54[5 /*10*/]), 1, 0, 1);
				}
			}
			if (func_217(&Local_58, 324.7653f, -2974.495f, -1.5f, 0.1f, 0.1f, 2f, 0, Local_53[0 /*2*/], "dkp1_tk1", "", "DKP1_SUBBK", 1, 0, 1, -1) || ((HUD::DOES_BLIP_EXIST(Local_58.f_5) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_53[0 /*2*/], 312.8557f, -2974.003f, 1.19166f, 339.1654f, -2974.348f, -6.70078f, 15f, 0, true, 0)) && func_209(PLAYER::PLAYER_PED_ID(), Local_53[0 /*2*/])))
			{
	...
	if (func_101(PLAYER::PLAYER_PED_ID()) && func_101(Local_53[0 /*2*/]))
	{
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 324.7653f, -2974.495f, -1f, true) > 2500f)
		{
			func_87(9);
		}
	}
...
void func_190(bool bParam0, bool bParam1, bool bParam2, int iParam3, int iParam4)
{
	HUD::DISPLAY_RADAR(true);
	HUD::DISPLAY_HUD(true);
...
int func_192()
{
	...
	switch (iLocal_275)
	{
		...
		case 1:
			vLocal_287 = { ENTITY::GET_ENTITY_COORDS(Local_57[8 /*2*/], 1) };
			if (vLocal_287.z <= 1f)
			{
		...
		case 4:
			...
			{
				fVar0 = (1f - func_196((SYSTEM::TO_FLOAT((MISC::GET_GAME_TIMER() - iLocal_1959 + 1500)) / 3000f), 0f, 1f));
...
int func_199(var uParam0, vector3 vParam1, vector3 vParam2, float fParam3, int iParam4)
{
...
void func_202(bool bParam0, vector3 vParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, int iParam6, bool bParam7)
{
...
int func_217(int iParam0, vector3 vParam1, vector3 vParam2, bool bParam3, int iParam4, char* sParam5, char* sParam6, char* sParam7, bool bParam8, int iParam9, bool bParam10, int iParam11)
{
	return func_43(iParam0, vParam1, vParam2, func_81(), func_81(), bParam3, 5, 0, 0, 0, iParam4, sParam5, func_218(), func_218(), func_218(), func_218(), sParam6, 0, bParam8, sParam7, 0, iParam9, bParam10, iParam11, 0, 0, 0, 1, 1065353216);
}
...
void func_220()
{
	...
	switch (iLocal_1953)
	{
		...
		case 1:
			if (iLocal_248)
			{
				...
				func_261();
				if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1249.106f, -3007.908f, 10.84327f, 1249.962f, -3007.837f, 8.31909f, 1.68f, 0, true, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && !func_205(0))
				{
					if (PAD::IS_CONTROL_JUST_PRESSED(2, 51))
					{
						...
						{
							BRAIN::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_246, cLocal_51, "ig_1_stealth_button", 1000f, -1.5f, 4, 0, 1000f, 2);
						}
						else
						{
							BRAIN::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_246, cLocal_51, "ig_1_button", 1000f, -1.5f, 4, 0, 1000f, 2);
						}
		...
		case 2:
			...
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_246) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_246) >= 0.7f)
			{
				...
				{
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), 1252.594f, -3008.883f, 8.3191f, 1f, -1, 0.25f, 0, 1193033728);
				}
			}
			break;
		...
		case 4:
			if (!func_259())
			{
				if (func_19() == 2)
				{
					...
					{
						func_215(&uLocal_78, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		...
		case 5:
			vVar1 = { ENTITY::GET_ENTITY_COORDS(Local_53[0 /*2*/], 1) };
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_53[0 /*2*/], 0))
			{
				...
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
				{
					...
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_244);
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_244);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1252.876f, -3014.035f, 8.31909f, 2f, 20000, 0.25f, 0, 1193033728);
					BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					BRAIN::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_244);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_54[6 /*10*/], iLocal_244);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_244);
					...
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_244);
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_244);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1252.056f, -3006.94f, 8.31909f, 2f, 20000, 0.25f, 0, 1193033728);
					BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					BRAIN::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_244);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_54[7 /*10*/], iLocal_244);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_244);
				...
				else
				{
					...
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_244);
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_244);
					BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2096, 2);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1252.876f, -3014.035f, 8.31909f, 2f, 20000, 0.25f, 0, 1193033728);
					BRAIN::TASK_PLAY_ANIM(0, cLocal_49, "react_big_variations_g", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
					BRAIN::TASK_PLAY_ANIM(0, cLocal_49, "react_big_variations_i", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
					BRAIN::TASK_SMART_FLEE_COORD(0, 1252.876f, -3014.035f, 8.31909f, 300f, -1, 0, 0);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_244);
					BRAIN::TASK_PERFORM_SEQUENCE(Local_54[5 /*10*/], iLocal_244);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_244);
					func_83(&uLocal_309, joaat("s_m_m_security_01"));
				}
				if (func_101(Local_54[4 /*10*/]))
				...
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_244);
				BRAIN::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2096, 2);
				BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1252.994f, -3004.134f, 9.319f, 2f, 20000, 0.25f, 0, 1193033728);
				BRAIN::TASK_PLAY_ANIM(0, cLocal_49, "react_big_variations_f", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(0, cLocal_49, "react_big_variations_g", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(0, cLocal_49, "react_big_variations_h", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(0, cLocal_49, "react_big_variations_i", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
				BRAIN::TASK_PLAY_ANIM(0, cLocal_49, "react_big_variations_f", 1.5f, -1.5f, -1, 0, 0, 0, 0, 0);
				BRAIN::TASK_SMART_FLEE_COORD(0, 1252.994f, -3004.134f, 9.319f, 300f, -1, 0, 0);
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_244);
				BRAIN::TASK_PERFORM_SEQUENCE(Local_54[4 /*10*/], iLocal_244);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_244);
			...
			else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_53[0 /*2*/], 1), true) < 5f && !iLocal_253)
			{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_57[3 /*2*/]) && ((func_101(Local_54[4 /*10*/]) && PED::IS_PED_FLEEING(Local_54[4 /*10*/])) || !func_101(Local_54[4 /*10*/])))
	{
		...
		{
			BRAIN::STOP_ANIM_TASK(Local_54[4 /*10*/], cLocal_50, "cellphone_call_listen_c", -1056964608);
		}
...
void func_221(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	vector3 vVar0;
	var uVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_95149.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_95149.f_4, 0))
		{
			if (func_251(24) != Global_95149.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_248(ENTITY::GET_ENTITY_COORDS(Global_95149.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
void func_222(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_121(iParam0, 0, 0)) || func_121(iParam0, 1, 0)) || func_121(iParam0, 2, 0)) || func_111(iParam0) != 145) || func_239(iParam0)) || func_238(iParam0)) || func_237(iParam0)) || func_236(iParam0)) || !func_226(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_238(iParam0))
		{
		}
...
void func_241(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_240(&(Global_69678.f_555[0 /*21*/]), iParam0))
	{
...
int func_248(vector3 vParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
...
int func_249(vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_269()
{
	...
	{
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_53[0 /*2*/], 1), true) > 750f)
		{
			func_87(10);
		}
		else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_53[0 /*2*/], 1), true) > 700f)
		{
	...
	switch (iLocal_264)
	{
		case 0:
			if (func_101(Local_54[4 /*10*/]))
			{
				if (iLocal_269)
				{
					BRAIN::TASK_PLAY_ANIM(Local_54[4 /*10*/], cLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0, 0, 0, 0);
					if (BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED("docksprep1"))
					{
						BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(Local_54[4 /*10*/], "docksprep1", 0, 8, -1);
					}
					else
					{
		...
		case 1:
			if (!iLocal_269)
			{
				if ((MISC::GET_GAME_TIMER() - iLocal_268) > 2000 || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_54[4 /*10*/], 1), true) < 10f)
				{
					iLocal_269 = 1;
					iLocal_264 = 0;
				}
			...
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, true, 0))
			{
				if (func_101(Local_54[4 /*10*/]))
				{
					...
					else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_54[4 /*10*/], 1), true) < 12f && PLAYER::GET_PLAYER_CURRENT_STEALTH_NOISE(PLAYER::PLAYER_ID()) > 8.5f)
					{
						AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(Local_54[4 /*10*/]);
						if (!func_274(Local_54[4 /*10*/], 1464580341, 1))
						{
							BRAIN::TASK_TURN_PED_TO_FACE_COORD(Local_54[4 /*10*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 4000);
							BRAIN::TASK_PLAY_ANIM(Local_54[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 4f, -8f, -1, 49, 0, 0, 0, 0);
						}
					}
					else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_54[4 /*10*/], 1), true) < 12f && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						if (!func_274(Local_54[4 /*10*/], 1464580341, 1))
						{
							BRAIN::TASK_TURN_PED_TO_FACE_COORD(Local_54[4 /*10*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 4000);
				...
				if (iLocal_1953 > 1)
				{
					if (func_101(Local_54[4 /*10*/]))
					{
						if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(Local_54[4 /*10*/], Local_53[0 /*2*/]))
						{
							...
							BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_54[4 /*10*/], 1252.558f, -3004.846f, 8.31909f, 2f, -1, 0.25f, 0, -122.93f);
							iLocal_268 = MISC::GET_GAME_TIMER();
							iLocal_269 = 0;
						}
					}
			...
			if (func_101(Local_54[4 /*10*/]))
			{
					...
					if (iLocal_269)
					{
						if ((BRAIN::GET_SCRIPT_TASK_STATUS(Local_54[4 /*10*/], 242628503) != 1 && BRAIN::GET_SCRIPT_TASK_STATUS(Local_54[4 /*10*/], 713668775) != 1) && BRAIN::GET_SCRIPT_TASK_STATUS(Local_54[4 /*10*/], 1464580341) != 1)
						{
							...
							if (ENTITY::IS_ENTITY_AT_COORD(Local_54[4 /*10*/], 1228.056f, -3000.427f, 8.4424f, 2f, 2f, 2f, false, true, 0))
							{
								if (BRAIN::GET_IS_WAYPOINT_RECORDING_LOADED("docksprep1"))
								{
									BRAIN::TASK_FOLLOW_WAYPOINT_RECORDING(Local_54[4 /*10*/], "docksprep1", 0, 0, -1);
								}
							}
				...
				else
				{
					...
					{
						if (!BRAIN::WAYPOINT_PLAYBACK_GET_IS_PAUSED(Local_54[4 /*10*/]))
						{
						...
						else
						{
							...
							BRAIN::WAYPOINT_PLAYBACK_RESUME(Local_54[4 /*10*/], 1, -1, 3000);
						}
					}
				...
				if (((PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 122) || PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 123)) || PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 124)) || PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 116))
				{
					...
					iLocal_264 = 3;
					iLocal_266 = 1;
					BRAIN::TASK_PLAY_ANIM(Local_54[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 1000f, -8f, -1, 49, 0, 0, 0, 0);
					BRAIN::TASK_HANDS_UP(Local_54[4 /*10*/], -1, PLAYER::PLAYER_PED_ID(), -1, 1);
				}
				else if (PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 23))
				{
					...
					BRAIN::CLEAR_PED_TASKS(Local_54[4 /*10*/]);
					BRAIN::TASK_PLAY_ANIM(Local_54[4 /*10*/], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 1000f, -8f, -1, 49, 0, 0, 0, 0);
					BRAIN::TASK_COWER(Local_54[4 /*10*/], -1);
				}
		...
		case 2:
			if (func_101(Local_54[4 /*10*/]))
			{
				...
				{
					BRAIN::TASK_LOOK_AT_ENTITY(Local_54[4 /*10*/], PLAYER::PLAYER_PED_ID(), -1, 3104, 2);
				}
			}
			switch (iLocal_265)
			{
				case 0:
					if (func_101(Local_54[4 /*10*/]))
					{
						...
						{
							BRAIN::OPEN_SEQUENCE_TASK(&iLocal_244);
							BRAIN::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 4f, 2f, 1073741824, 0);
							BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
							BRAIN::CLOSE_SEQUENCE_TASK(iLocal_244);
							BRAIN::TASK_PERFORM_SEQUENCE(Local_54[4 /*10*/], iLocal_244);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_244);
			...
			if (func_101(Local_54[4 /*10*/]))
			{
				...
				else if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_54[4 /*10*/]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_54[4 /*10*/]))
				{
					if (WEAPON::GET_WEAPONTYPE_GROUP(iLocal_271) != -728555052 && iLocal_271 != joaat("weapon_unarmed"))
					{
						...
						iLocal_266 = 1;
						BRAIN::CLEAR_PED_TASKS_IMMEDIATELY(Local_54[4 /*10*/]);
						BRAIN::TASK_HANDS_UP(Local_54[4 /*10*/], -1, PLAYER::PLAYER_PED_ID(), -1, 0);
					}
				}
				else if (PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 23))
				{
			...
			switch (iLocal_266)
			{
				...
				case 3:
					if (func_101(Local_54[4 /*10*/]))
					{
						...
						{
							BRAIN::TASK_LOOK_AT_ENTITY(Local_54[4 /*10*/], Local_53[0 /*2*/], -1, 2096, 2);
						}
					}
					else
					{
					...
					if (func_101(Local_54[4 /*10*/]))
					{
						if (!PED::IS_PED_RAGDOLL(Local_54[4 /*10*/]) && !BRAIN::IS_PED_GETTING_UP(Local_54[4 /*10*/]))
						{
							if (func_12(&uLocal_78, "SOL1AUD", "SOL1_COPSIN2", 7, 0, 0, 0))
							{
								BRAIN::CLEAR_PED_TASKS(Local_54[4 /*10*/]);
								BRAIN::OPEN_SEQUENCE_TASK(&iLocal_244);
								BRAIN::TASK_PLAY_ANIM(0, cLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0, 0, 0, 0);
								if (iLocal_270)
								{
									BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1228.775f, -2923.852f, 8.31909f, 2f, 20000, 0.25f, 0, 1193033728);
									BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
								}
								else
								{
									BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1228.775f, -2923.852f, 8.31909f, 1f, 20000, 0.25f, 0, 1193033728);
					...
					if ((MISC::GET_GAME_TIMER() - iLocal_267) > 8000)
					{
						...
						if (func_101(Local_54[4 /*10*/]))
						{
							if (iLocal_270)
							{
								...
								{
									BRAIN::TASK_SMART_FLEE_PED(Local_54[4 /*10*/], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
								}
							}
						...
						if (func_101(Local_54[4 /*10*/]))
						{
							if ((PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 122) || PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 123)) || PED::HAS_PED_RECEIVED_EVENT(Local_54[4 /*10*/], 124))
							{
								...
								if (func_12(&uLocal_78, "SOL1AUD", "SOL1_ARM2", 7, 0, 0, 0))
								{
									BRAIN::CLEAR_PED_TASKS(Local_54[4 /*10*/]);
									BRAIN::OPEN_SEQUENCE_TASK(&iLocal_244);
									BRAIN::TASK_HANDS_UP(0, 3000, PLAYER::PLAYER_PED_ID(), -1, 0);
									BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1228.775f, -2923.852f, 8.31909f, 2f, 20000, 0.25f, 0, 1193033728);
									BRAIN::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
									BRAIN::CLOSE_SEQUENCE_TASK(iLocal_244);
									BRAIN::TASK_PERFORM_SEQUENCE(Local_54[4 /*10*/], iLocal_244);
...
void func_275()
{
	switch (iLocal_308)
	{
		...
		case 2:
			...
			{
				case 0:
					if ((!HUD::IS_MESSAGE_BEING_DISPLAYED() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_53[0 /*2*/], 0)) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 324.7653f, -2974.495f, -1f, true) < 110f)
					{
						func_280();
						iLocal_307 = 1;
					}
		...
		case 4:
			if (func_101(Local_53[2 /*2*/]) && func_101(Local_54[3 /*10*/]))
			{
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_53[0 /*2*/], 1), -323.73f, -2613.702f, 5f, true) < 60f)
				{
					func_278();
					iLocal_307 = 3;
				}
		...
		case 6:
			...
			{
				case 0:
					if ((((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && PED::IS_PED_IN_VEHICLE(Local_54[3 /*10*/], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_53[1 /*2*/], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))) && !HUD::IS_MESSAGE_BEING_DISPLAYED()) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_53[0 /*2*/], 1), -323.73f, -2613.702f, 5f, true) < 40f)
					{
						func_280();
						iLocal_307 = 1;
					}
...
int func_284(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10)
{
	if (iParam3 == 0)
	{
...
int func_299(var uParam0, vector3 vParam1, float fParam2, int iParam3)
{
...
void func_303()
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		BRAIN::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
		MISC::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 300f, 1, 0, 0, false);
	}
...
void func_316()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_53[0 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89475[0]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89475[0], true, 1);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_57[1 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89475.f_28[1]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89475.f_28[1], true, 1);
			Local_57[1 /*2*/] = Global_89475.f_28[1];
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_57[2 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89475.f_28[2]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89475.f_28[2], true, 1);
			Local_57[2 /*2*/] = Global_89475.f_28[2];
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_57[3 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89475.f_28[3]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89475.f_28[3], true, 1);
			Local_57[3 /*2*/] = Global_89475.f_28[3];
		}
	}
	if (Global_89475.f_357)
	{
		if (PHYSICS::DOES_ROPE_EXIST(&(Global_89475.f_37[0])))
		{
			PHYSICS::_0xB1B6216CA2E7B55E(Global_89475.f_37[0], 1, 1);
			Local_55[0 /*5*/] = Global_89475.f_37[0];
			Global_89475.f_37[0] = 0;
		}
		if (PHYSICS::DOES_ROPE_EXIST(&(Global_89475.f_37[1])))
		{
			PHYSICS::_0xB1B6216CA2E7B55E(Global_89475.f_37[1], 1, 1);
			Local_55[1 /*5*/] = Global_89475.f_37[1];
			Global_89475.f_37[1] = 0;
		}
		if (PHYSICS::DOES_ROPE_EXIST(&(Global_89475.f_37[2])))
		{
			PHYSICS::_0xB1B6216CA2E7B55E(Global_89475.f_37[2], 1, 1);
			Local_55[2 /*5*/] = Global_89475.f_37[2];
			Global_89475.f_37[2] = 0;
		}
		if (PHYSICS::DOES_ROPE_EXIST(&(Global_89475.f_37[3])))
		{
			PHYSICS::_0xB1B6216CA2E7B55E(Global_89475.f_37[3], 1, 1);
...
void func_319(vector3 vParam0, var uParam1, int iParam2, int iParam3)
{
	if (func_289())
	{
