...
void func_95(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_97(Global_105220.f_18504[iVar0], &vVar2, &fVar3))
			{
...
void func_102(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar6 = func_175(&(Global_92955.f_3));
				if (iVar6 > -1)
				{
...
{
	func_104(&Global_98783, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
int func_124(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_125(iParam1)];
...
int func_127(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2557346[iParam0 /*3*/][func_125(iParam1)];
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_95814.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_95814.f_4, 0))
		{
			if (func_251(24) != Global_95814.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_248(ENTITY::GET_ENTITY_COORDS(Global_95814.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_222(Global_95814.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
			...
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.513f, -2880.356f, 2.10339f, 1240.559f, -3057.271f, 17.4f, 29.45f, 0, true, 0))
			{
				if (func_101(Local_54[4 /*10*/]))
				{
					...
					else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_54[4 /*10*/], true), true) < 12f && PLAYER::GET_PLAYER_CURRENT_STEALTH_NOISE(PLAYER::PLAYER_ID()) > 8.5f)
					{
						...
						{
							BRAIN::TASK_TURN_PED_TO_FACE_COORD(Local_54[4 /*10*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 4000);
...
void func_316()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_54[4 /*10*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89597.f_9[0]))
		{
			...
			Local_54[4 /*10*/] = Global_89597.f_9[0];
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_54[4 /*10*/], iLocal_260);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_57[0 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89597.f_28[0]))
		{
			...
			Local_57[0 /*2*/] = Global_89597.f_28[0];
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_57[1 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89597.f_28[1]))
		{
			...
			Local_57[1 /*2*/] = Global_89597.f_28[1];
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_57[2 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89597.f_28[2]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89597.f_28[2], true, 1);
			Local_57[2 /*2*/] = Global_89597.f_28[2];
		}
	}
	if (!ENTITY::DOES_ENTITY_EXIST(Local_57[3 /*2*/]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_89597.f_28[3]))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_89597.f_28[3], true, 1);
			Local_57[3 /*2*/] = Global_89597.f_28[3];
		}
	}
	if (Global_89597.f_357)
	{
		if (PHYSICS::DOES_ROPE_EXIST(&(Global_89597.f_37[0])))
		{
			PHYSICS::_0xB1B6216CA2E7B55E(Global_89597.f_37[0], 1, 1);
			Local_55[0 /*5*/] = Global_89597.f_37[0];
			Global_89597.f_37[0] = 0;
		}
		if (PHYSICS::DOES_ROPE_EXIST(&(Global_89597.f_37[1])))
		{
			PHYSICS::_0xB1B6216CA2E7B55E(Global_89597.f_37[1], 1, 1);
			Local_55[1 /*5*/] = Global_89597.f_37[1];
			Global_89597.f_37[1] = 0;
		}
		if (PHYSICS::DOES_ROPE_EXIST(&(Global_89597.f_37[2])))
		{
			PHYSICS::_0xB1B6216CA2E7B55E(Global_89597.f_37[2], 1, 1);
			Local_55[2 /*5*/] = Global_89597.f_37[2];
			Global_89597.f_37[2] = 0;
		}
		if (PHYSICS::DOES_ROPE_EXIST(&(Global_89597.f_37[3])))
		{
			PHYSICS::_0xB1B6216CA2E7B55E(Global_89597.f_37[3], 1, 1);
			Local_55[3 /*5*/] = Global_89597.f_37[3];
