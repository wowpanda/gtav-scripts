		...
		if (!func_104(0) && !func_103(14))
		{
			if (iLocal_47 == 0)
			{
				if (func_113())
				{
					...
					iLocal_461 = IS_BIT_SET(Global_2424, 28);
					if (iLocal_48 != -1)
					{
						if (fVar0 < fLocal_46)
						{
							...
							if (((((fVar15 >= 0.35f && func_97(vVar1, 0f, 1f)) && func_97(vVar4, 0f, 1f)) && func_97(vVar7, 0f, 1f)) && func_97(vVar10, 0f, 1f)) || ((((fVar15 < 0.35f && func_97(vVar1, 0.05f, 0.95f)) && func_97(vVar4, 0.05f, 0.95f)) && func_97(vVar7, 0.05f, 0.95f)) && func_97(vVar10, 0.05f, 0.95f)))
							{
								if (fVar13 >= 0.08f && fVar14 >= 0.101f)
								{
									...
									{
										bVar16 = ((((IS_TRACKED_POINT_VISIBLE(iLocal_49) && IS_TRACKED_POINT_VISIBLE(iLocal_50)) && IS_TRACKED_POINT_VISIBLE(iLocal_51)) && IS_TRACKED_POINT_VISIBLE(iLocal_52)) && IS_TRACKED_POINT_VISIBLE(iLocal_53));
										iVar17++;
										WAIT(0);
									}
									if (bVar16)
									{
										func_95(iLocal_48, 1);
										STAT_SET_INT(joaat("num_hidden_packages_6"), func_92(), 1);
										bLocal_460 = true;
										if (func_105())
										{
											func_6();
...
int func_9(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_12(int iParam0)
{
	...
	func_13(&(Global_71402[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_16(func_19(iParam1, uParam0->f_2), Global_71399, 0);
			if (IS_BIT_SET(uVar0, uParam0->f_1))
			{
				SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_16(func_15(iParam1, uParam0->f_2), Global_71399, 0);
			if (IS_BIT_SET(uVar0, uParam0->f_1))
			{
				SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_16(iVar1, Global_71399, 0);
				if (!IS_BIT_SET(uVar0, uParam0->f_1))
				{
					SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_23(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!_IS_DLC_DATA_EMPTY(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_13(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, _0x341DE7ED1D2A1BFD(Var20.f_1, -2050632586, 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_71571)
		{
			...
			func_13(&(Global_71402[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, _0x341DE7ED1D2A1BFD(Var41.f_1, -2050632586, 0), -1, 2, Var41.f_1 != 0);
			return;
		}
		iVar59 = 0;
		iVar60 = _GET_NUM_PROPS_FROM_OUTFIT(uVar1, 7, -1, 0, -1, func_24(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_79(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			if (!bParam3 || IS_BIT_SET(Global_106565.f_7223[1], 0))
			{
				SET_BIT(&(Global_106565.f_2357.f_539.f_3816[0 /*166*/][iParam1 /*11*/][(iParam2 / 32)]), (iParam2 % 32));
			}
			break;
		
		case joaat("player_two"):
			if (!bParam3 || IS_BIT_SET(Global_106565.f_7223[3], 0))
			{
				SET_BIT(&(Global_106565.f_2357.f_539.f_3816[1 /*166*/][iParam1 /*11*/][(iParam2 / 32)]), (iParam2 % 32));
			}
			if (!bParam3 || IS_BIT_SET(Global_106565.f_7223[4], 0))
			{
				SET_BIT(&(Global_106565.f_2357.f_539.f_3816[2 /*166*/][iParam1 /*11*/][(iParam2 / 32)]), (iParam2 % 32));
			}
			break;
	}
}
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = _GET_NUM_PROPS_FROM_OUTFIT(iParam3, 7, -1, 0, -1, func_24(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
bool func_93(int iParam0)
{
	...
	return IS_BIT_SET(Global_106565.f_10043.f_135[iVar0], uVar1);
}
...
void func_95(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		SET_BIT(&(Global_106565.f_10043.f_135[iVar0]), uVar1);
	}
	else
	{
		CLEAR_BIT(&(Global_106565.f_10043.f_135[iVar0]), uVar1);
	}
}
...
int func_97(vector3 vParam0, float fParam3, float fParam4)
{
	...
	if (GET_SCREEN_COORD_FROM_WORLD_COORD(vParam0, &fVar0, &fVar1))
	{
...
void func_98(vector3 vParam0, vector3 vParam3, vector3 vParam6, float fParam9, float fParam10)
{
	...
	GET_SCREEN_COORD_FROM_WORLD_COORD(vParam0, &vVar0, &(vVar0.f_1));
	GET_SCREEN_COORD_FROM_WORLD_COORD(vParam3, &vVar3, &(vVar3.f_1));
	GET_SCREEN_COORD_FROM_WORLD_COORD(vParam6, &vVar6, &(vVar6.f_1));
	*fParam9 = VDIST(vVar0, vVar3);
	*fParam10 = VDIST(vVar0, vVar6);
}
...
int func_102(float fParam0)
{
	...
	while (iVar0 < 50)
	{
		if (!func_93(iVar0))
		{
			fVar5 = VDIST2(vVar2, Local_54[iVar0 /*8*/]);
...
bool func_105()
{
	...
	return Global_106565.f_10043.f_135[iVar0] == (ROUND(POW(2f, TO_FLOAT(iVar1 + 1))) - 1);
}
...
void func_106()
{
	if (bLocal_460)
	{
		if (HAS_SCALEFORM_MOVIE_LOADED(uLocal_459))
		{
			DRAW_SCALEFORM_MOVIE(uLocal_459, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
		}
		switch (iLocal_458)
		{
			case 0:
				iLocal_462 = GET_GAME_TIMER() + 2000;
				iLocal_458++;
				break;
			
			case 1:
				if (iLocal_462 < GET_GAME_TIMER())
				{
					if (!func_112())
					{
						uLocal_459 = REQUEST_SCALEFORM_MOVIE("MIDSIZED_MESSAGE");
						iLocal_462 = GET_GAME_TIMER() + 5000;
						iLocal_458++;
					}
				}
				break;
			...
			case 2:
				if (HAS_SCALEFORM_MOVIE_LOADED(uLocal_459) || iLocal_462 < GET_GAME_TIMER())
				{
					if (iLocal_462 < GET_GAME_TIMER())
					{
						bLocal_460 = false;
			...
			case 3:
				BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_459, "SHOW_BRIDGES_KNIVES_PROGRESS");
				func_111("PM_TITLE");
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(50);
				func_111("PM_PASS");
				func_111("PM_CHALLENGE");
				SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(func_92());
				END_SCALEFORM_MOVIE_METHOD();
				iLocal_462 = GET_GAME_TIMER() + 7500;
				PLAY_SOUND_FRONTEND(-1, "UNDER_THE_BRIDGE", "HUD_AWARDS", 1);
				iLocal_458++;
				break;
			
			case 4:
				if ((((((iLocal_462 < GET_GAME_TIMER() || IS_SCREEN_FADED_OUT()) || !IS_PLAYER_PLAYING(PLAYER_ID())) || func_112()) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || func_110()) || func_109())
				{
					BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_459, "SHARD_ANIM_OUT");
					SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
					SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(0.33f);
					END_SCALEFORM_MOVIE_METHOD();
					iLocal_462 = GET_GAME_TIMER() + 500;
					iLocal_458++;
				}
				break;
			...
			case 6:
				SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_459);
				if (func_105())
				{
					iLocal_462 = GET_GAME_TIMER() + 1000;
					iLocal_458++;
				}
				else
				{
