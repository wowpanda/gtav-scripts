		...
		if (!func_104(0) && !func_103(14))
		{
			if (iLocal_47 == 0)
			{
				if (func_113())
				{
					...
					bLocal_59 = MISC::IS_BIT_SET(Global_2364, 28);
					if (iLocal_48 != -1)
					{
						if (fVar0 < fLocal_46)
						{
...
void func_1()
{
	Global_105220.f_10020.f_135[1] = -1;
}
...
{
	Global_70793[1 /*14*/] = { func_10(iParam0, iParam1, iParam2) };
	if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_9(iParam1, Global_70793[1 /*14*/].f_5, Global_70793[1 /*14*/].f_2, 2, Global_70793[1 /*14*/].f_1, 0, 1);
		}
		else
		{
			func_9(iParam1, Global_70793[1 /*14*/].f_5, Global_70793[1 /*14*/].f_2, 2, Global_70793[1 /*14*/].f_1, 1, 0);
		}
		return 1;
	}
	return 0;
...
void func_12(int iParam0)
{
	...
	func_13(&(Global_70793[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_13(var uParam0, int iParam1, int iParam2, void fParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_16(func_19(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_16(func_15(iParam1, uParam0->f_2), Global_70790, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_16(iVar1, Global_70790, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
int func_16(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = Global_2530245[iParam0 /*3*/][func_17(iParam1)];
...
void func_23(int iParam0, int iParam1, int iParam2)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_13(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_13(&(Global_70793[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_13(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::_0x341DE7ED1D2A1BFD(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iVar1, 6, -1, 0, -1, func_24(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::_IS_DLC_DATA_EMPTY(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					func_13(&(Global_70793[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::_0x341DE7ED1D2A1BFD(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
void func_79(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			if (!bParam3 || MISC::IS_BIT_SET(Global_105220.f_7200[1], 0))
			{
				MISC::SET_BIT(&(Global_105220.f_2354.f_539.f_3796[0 /*166*/][iParam1 /*11*/][(iParam2 / 32)]), (iParam2 % 32));
			}
			break;
		
		case joaat("player_two"):
			if (!bParam3 || MISC::IS_BIT_SET(Global_105220.f_7200[3], 0))
			{
				MISC::SET_BIT(&(Global_105220.f_2354.f_539.f_3796[1 /*166*/][iParam1 /*11*/][(iParam2 / 32)]), (iParam2 % 32));
			}
			if (!bParam3 || MISC::IS_BIT_SET(Global_105220.f_7200[4], 0))
			{
				MISC::SET_BIT(&(Global_105220.f_2354.f_539.f_3796[2 /*166*/][iParam1 /*11*/][(iParam2 / 32)]), (iParam2 % 32));
			}
			break;
	}
}
...
int func_80(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_9(iParam1, Global_70793[1 /*14*/].f_5, Global_70793[1 /*14*/].f_2, 1, Global_70793[1 /*14*/].f_1, 1, 0);
			if (iParam1 == 12)
			{
				iVar0 = 1;
				if (iParam0 == joaat("player_zero"))
		...
		{
			func_9(iParam1, Global_70793[1 /*14*/].f_5, Global_70793[1 /*14*/].f_2, 1, Global_70793[1 /*14*/].f_1, 0, 1);
		}
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = FILES::_GET_NUM_PROPS_FROM_OUTFIT(iParam3, 6, -1, 0, -1, func_24(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
int func_91(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_70793[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_9(iParam1, Global_70793[1 /*14*/].f_5, Global_70793[1 /*14*/].f_2, 0, Global_70793[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_9(iParam1, Global_70793[1 /*14*/].f_5, Global_70793[1 /*14*/].f_2, 0, Global_70793[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
bool func_93(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_105220.f_10020.f_135[iVar0], iVar1);
}
...
void func_95(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_105220.f_10020.f_135[iVar0]), iVar1);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_105220.f_10020.f_135[iVar0]), iVar1);
	}
}
...
bool func_105()
{
	...
	if (Global_105220.f_10020.f_135[1] == -1)
	{
		return 1;
	}
	...
	if (iVar0 > 0)
	{
		...
		while (iVar2 <= (iVar0 - 1))
		{
			if (Global_105220.f_10020.f_135[iVar2] != -1)
			{
				return 0;
			}
			iVar2++;
	...
	if (iVar1 == 31)
	{
		return Global_105220.f_10020.f_135[iVar0] == -1;
	}
	return Global_105220.f_10020.f_135[iVar0] == (SYSTEM::ROUND(SYSTEM::POW(2f, SYSTEM::TO_FLOAT(iVar1 + 1))) - 1);
}
...
void func_107(void fParam0, int iParam1)
{
