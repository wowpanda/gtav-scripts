...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_69(AUDIO::_0x0626A247D2405330()))
	{
		while (bVar0 == 0)
		{
			bVar0 = ((MISC::GET_MISSION_FLAG() == 0 && func_65() == 0) && func_64(AUDIO::_0x0626A247D2405330(), vLocal_64, fLocal_65));
			func_62();
		}
	}
	func_61(65, 0);
	...
	while (true)
	{
		...
		vLocal_244 = { ENTITY::GET_ENTITY_FORWARD_VECTOR(AUDIO::_0x0626A247D2405330()) };
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) == 0)
		{
			func_58(&uLocal_233);
			func_3(&uLocal_234);
			if (func_2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), 1), 7, 0, 0))
			{
				func_61(65, 1);
				func_1(30);
				func_71();
...
void func_3(var uParam0)//Position - 0xF3D
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			if (func_52(AUDIO::_0x0626A247D2405330(), -1210.236f, -579.875f, 26.33215f, -1204.725f, -586.3573f, 29.56773f, 6f))
			{
				fLocal_235 = 0.25f;
				*uParam0++;
				return;
		...
		case 2:
			...
			{
				func_46(&uLocal_68, 0, AUDIO::_0x0626A247D2405330(), "MICHAEL", 0, 1);
				if (func_45())
				{
		...
		case 4:
			if (!AUDIO::IS_SCRIPTED_SPEECH_PLAYING(AUDIO::_0x0626A247D2405330()) && !AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
			{
...
void func_4(int iParam0, vector3 vParam1, float fParam2)//Position - 0x11E9
{
	...
	{
		unk_0x346478B12F69D4E3(iParam0->f_1, true);
		...
		*iParam0 = PED::CREATE_PED_INSIDE_VEHICLE(iParam0->f_1, 26, ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()), 4294967295, 1, 1);
		if (func_69(*iParam0))
		{
...
void func_58(var uParam0)//Position - 0x6211
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			if (func_52(AUDIO::_0x0626A247D2405330(), -1055.046f, -469.3347f, 35.43333f, -1057.44f, -474.9772f, 39.8187f, 12.5f))
			{
				fLocal_235 = 0.25f;
				*uParam0++;
				return;
		...
		case 7:
			if (!func_52(AUDIO::_0x0626A247D2405330(), -1055.514f, -474.6371f, 35.6278f, -1051.23f, -464.4126f, 39.91479f, 9.5f))
			{
				func_54(&iLocal_237);
				*uParam0++;
			}
...
void func_62()//Position - 0x65F2
{
	...
	if (!func_64(AUDIO::_0x0626A247D2405330(), vLocal_64, (fLocal_65 + 30f)))
	{
		func_71();
	}
	SYSTEM::WAIT(0);
...
void func_66()//Position - 0x66E1
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
	{
		if (func_68(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			...
			if (func_13(iVar0) && (!func_11(14) || Global_19A3D))
			{
...
void func_72(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6900
{
