...
{
	if (MISC::IS_BIT_SET(Global_92833.f_20, 17))
	{
		return 0;
	}
	...
	switch (iLocal_88)
	{
		...
		case 1:
			...
			if (!func_429(iLocal_89))
			{
				...
				if (!MISC::IS_BIT_SET(Global_104555.f_18544.f_382, 0))
				{
					MISC::SET_BIT(&(Global_104555.f_18544.f_382), 0);
				}
				func_289(4);
			}
			else if (func_287(PLAYER::PLAYER_PED_ID(), iLocal_89) > 250f)
			{
...
int func_248(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_250(vParam1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	...
	switch (iLocal_88)
	{
		case 0:
			...
			if (func_429(Local_82.f_35[0]))
			{
				...
				while (iVar0 < 3)
				{
					vLocal_295[iVar0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Local_82.f_35[0], 1) };
					iVar0++;
				}
			}
...
bool func_295(vector3 vParam0, vector3 vParam1, float fParam2)
{
...
void func_296()
{
	...
	vLocal_295[2 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Local_82.f_35[0], 1) };
}
	...
	switch (iLocal_88)
	{
		case 0:
			...
			if (func_429(iLocal_89))
			{
				...
				if (func_3(Local_82.f_35[0]))
				{
					...
					iLocal_263 = VEHICLE::_0x2CE544C68FB812A0(ENTITY::GET_ENTITY_COORDS(Local_82.f_35[0], 1), 100f, 10f, 0);
				}
				else
				{
		...
		case 1:
			...
			else
			{
				...
				if ((func_301(242628503) && BRAIN::GET_SEQUENCE_PROGRESS(iLocal_89) > 0) && func_297())
				{
					func_289(3);
				}
			}
...
int func_303(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_250(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_306(int iParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, bool bParam5, int iParam6)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if (bParam5)
...
void func_310()
{
	switch (iLocal_88)
	{
		case 0:
			...
			if (((CAM::IS_SCREEN_FADED_IN() && !func_439()) && func_429(iLocal_89)) && func_288(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], 1) > 4f)
			{
			...
			switch (iLocal_318)
			{
				...
				case 3:
					...
					else
					{
						...
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Dreyfuss", 0) && func_429(iLocal_89))
						{
...
void func_312(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_316(PLAYER::PLAYER_ID())) && !func_314(PLAYER::PLAYER_ID(), 0)) && !func_313())
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_316(PLAYER::PLAYER_ID()))
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_70854 = 0;
...
int func_318(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_320(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_95149.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_95149.f_4, 0))
		{
			if (func_370(24) != Global_95149.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_367(ENTITY::GET_ENTITY_COORDS(Global_95149.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
...
void func_324(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_342(iParam0, 0, 0)) || func_342(iParam0, 1, 0)) || func_342(iParam0, 2, 0)) || func_361(iParam0) != 145) || func_341(iParam0)) || func_340(iParam0)) || func_339(iParam0)) || func_338(iParam0)) || !func_328(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_340(iParam0))
		{
		}
...
void func_358(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_355(&(Global_69678.f_555[0 /*21*/]), iParam0))
	{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_363(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_367(vector3 vParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
...
int func_368(vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_371(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	func_372(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_372(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_374(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_375(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_377(vector3 vParam0, int iParam1)
{
	return func_378(Global_95149.f_2875.f_12.f_66, vParam0, iParam1);
}

int func_378(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_381(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_385(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_384(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
void func_387()
{
	...
	if (iLocal_320 == 0)
	{
		if (func_429(iLocal_89))
		{
			if (func_288(PLAYER::PLAYER_PED_ID(), iLocal_89, 1) < 3f)
			{
				iLocal_320 = 1;
...
void func_389()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_385(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_395(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
{
	if (((!func_408(0) || Global_71125) || Global_71114 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71110)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_275(0)) || func_407(1))
			{
			}
			else
			{
...
void func_411(int iParam0)
{
	...
	if (!func_422())
	{
		...
		func_421(PLAYER::PLAYER_PED_ID(), -1462.177f, 485.6856f, 115.2016f, 97.1913f, 0, 1);
	}
	func_2(&iLocal_94);
	func_4(&iLocal_89);
	func_2(&(Local_82.f_35[0]));
	...
	if (!func_422())
	{
		func_414(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 100f, 12, 5000, 0, 0);
	}
	func_413(0, -1, 1);
	if (iParam0 == 1)
	{
...
void func_414(vector3 vParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
int func_419(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_421(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_428()
{
	...
	func_424();
	MISC::CLEAR_BIT(&(Global_104555.f_18544.f_382), 0);
	HUD::REQUEST_ADDITIONAL_TEXT("DREY1", 0);
	func_418(&uLocal_98, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_417();
	func_416();
}
...
void func_450(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_456(bool bParam0)
{
	...
	if (!func_473())
	{
		...
		{
			func_167(iVar0, 1, 0);
			func_457(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_103642[iVar0 /*10*/].f_9 == -1)
...
int func_458(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_464())
	{
		...
		{
			iVar2 = func_459(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
