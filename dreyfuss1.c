...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_396(Local_82.f_9, 0, 0, 0, 0, 0);
...
{
	if (MISC::IS_BIT_SET(Global_92955.f_20, 17))
	{
		return 0;
	}
...
void func_240()
{
	switch (iLocal_88)
	{
		case 0:
			...
			if (func_430(iLocal_89))
			{
				BRAIN::OPEN_SEQUENCE_TASK(&iLocal_93);
				...
				BRAIN::CLOSE_SEQUENCE_TASK(iLocal_93);
				BRAIN::TASK_PERFORM_SEQUENCE(iLocal_89, iLocal_93);
				BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_93);
			}
			func_237();
			iLocal_297 = 0;
			iLocal_88 = 1;
		...
		case 1:
			...
			if (!func_430(iLocal_89))
			{
				...
				if (!MISC::IS_BIT_SET(Global_105220.f_18545.f_382, 0))
				{
					MISC::SET_BIT(&(Global_105220.f_18545.f_382), 0);
				}
				func_290(4);
			}
		...
		case 1:
			...
			else
			{
				if (func_430(Local_82.f_35[0]))
				{
					...
					{
						BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_89, Local_82.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 90f, 786469, 100f, 1f, 1);
						iLocal_266 = 1;
					}
				}
				func_244(0);
				...
				{
					BRAIN::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_89, Local_82.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 90f, 786468, 100f, 1f, 1);
					iLocal_265 = 1;
				}
				if (!func_299())
				{
	...
	switch (iLocal_88)
	{
		case 0:
			...
			if (func_430(iLocal_89))
			{
				...
				if (func_3(Local_82.f_35[0]))
				{
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_92);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1472.27f, 513.9628f, 116.898f, 3f, 20000, 0.25f, 1, 1193033728);
					BRAIN::TASK_ENTER_VEHICLE(0, Local_82.f_35[0], 20000, -1, 3f, 1, 0);
					BRAIN::TASK_VEHICLE_DRIVE_WANDER(0, Local_82.f_35[0], 15f, 262144);
					BRAIN::CLOSE_SEQUENCE_TASK(iLocal_92);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_89, iLocal_92);
					iLocal_263 = VEHICLE::_0x2CE544C68FB812A0(ENTITY::GET_ENTITY_COORDS(Local_82.f_35[0], true), 100f, 10f, 0);
				}
				else
				{
					BRAIN::TASK_SMART_FLEE_PED(iLocal_89, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
				}
			}
...
void func_311()
{
	switch (iLocal_88)
	{
		case 0:
			...
			if (((CAM::IS_SCREEN_FADED_IN() && !func_440()) && func_430(iLocal_89)) && func_289(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], 1) > 4f)
			{
		...
		case 1:
			switch (iLocal_318)
			{
				case 0:
					...
					{
						func_388();
						if ((!func_236() && func_430(iLocal_89)) && func_252(&uLocal_98, "DREY1AU", "DREY1_RCM_LI", 8, 0, 0, 0))
						{
							BRAIN::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_89, -1, 0, 2);
							iLocal_318++;
						}
					}
					break;
				...
				case 3:
					...
					else
					{
						...
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Dreyfuss", 0) && func_430(iLocal_89))
						{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_95814.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_95814.f_4, 0))
		{
			if (func_371(24) != Global_95814.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_368(ENTITY::GET_ENTITY_COORDS(Global_95814.f_4, true), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_325(Global_95814.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}
...
{
	return func_379(Global_95814.f_2875.f_12.f_66, vParam0, iParam1);
}
	...
	if (iLocal_320 == 0)
	{
		if (func_430(iLocal_89))
		{
			if (func_289(PLAYER::PLAYER_PED_ID(), iLocal_89, 1) < 3f)
			{
				...
				BRAIN::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_89, 0);
			}
		}
	}
}
...
void func_396(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_71232 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_398(Global_71233, Global_71235, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_399(iVar1), 8);
					break;
			}
			break;
...
{
	if (((!func_409(0) || Global_71247) || Global_71236 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_71232)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_276(0)) || func_408(1))
			{
			}
			else
			{
...
void func_412(int iParam0)
{
	...
	if (!func_423())
	{
		...
		func_422(PLAYER::PLAYER_PED_ID(), -1462.177f, 485.6856f, 115.2016f, 97.1913f, 0, 1);
	}
	func_2(&iLocal_94);
	func_4(&iLocal_89);
	func_2(&(Local_82.f_35[0]));
	...
	if (!func_423())
	{
		func_415(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 100f, 12, 5000, 0, 0);
	}
	func_414(0, -1, 1);
	if (iParam0 == 1)
	{
...
void func_415(vector3 vParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
void func_418()
{
	if (!func_430(iLocal_89))
	{
		while (!func_420(&iLocal_89, 68, -1472.9f, 483.3f, 115.2f, 75f, 1))
		{
			SYSTEM::WAIT(0);
		}
	}
	if (func_430(iLocal_89))
	{
		func_419(&uLocal_98, 3, iLocal_89, "DREYFUSS", 0, 1);
		...
		BRAIN::SET_PED_PATH_MAY_ENTER_WATER(iLocal_89, 0);
...
int func_420(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_422(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
void func_429()
{
	...
	func_425();
	MISC::CLEAR_BIT(&(Global_105220.f_18545.f_382), 0);
	HUD::REQUEST_ADDITIONAL_TEXT("DREY1", 0);
	func_419(&uLocal_98, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_418();
	func_417();
}
...
int func_433(var uParam0)
{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			{
				BRAIN::TASK_LOOK_AT_ENTITY(uParam0->f_28[0], PLAYER::PLAYER_PED_ID(), -1, 2096, 2);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_434(&(uParam0->f_35[0]), iVar0[1], vLocal_80, fLocal_81);
...
void func_434(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_2(iParam0);
...
int func_435(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_420(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_452()
{
	...
	func_7(&uLocal_305, 0, 0);
	func_431(1);
	func_455(&uLocal_98, 1);
	func_455(&uLocal_98, 3);
	func_6(&iLocal_90);
	...
	func_451(&iLocal_89, 1, 0, 1);
	func_448(&iLocal_94);
	func_453();
	PATHFIND::SET_ROADS_IN_AREA(Local_83, Local_83.f_3, true, 1);
	VEHICLE::_0x1033371FC8E842A7(iLocal_263);
}
