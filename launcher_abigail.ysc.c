...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != 4294967295)
		{
			if (Global_19AC5[Var0 /*10*/].f_9 != 4294967295)
			{
				...
				func_286(&(Global_19AC5[Var0 /*10*/].f_9));
			}
		}
		func_269(&Var0, 1);
	}
	...
	while (true)
	{
		...
		{
			case 0:
				func_191(&Var2, &(Var0.f_1C[0]), "SONAR_PRE");
				break;
...
void func_47(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x375A
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x38FA
{
	int iVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x392C
{
	int iVar0;
	int iVar1;
...
int func_50()//Position - 0x3960
{
	return Global_1407E0;
}

int func_51(int iParam0, int iParam1)//Position - 0x396C
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3998
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EE0
{
	int iVar0;
...
int func_54()//Position - 0x4124
{
	func_55();
	return Global_19E56.f_933.f_21B.f_10CD;
}

void func_55()//Position - 0x413D
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x423A
{
	return Global_8D15 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x4248
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x433B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x45C5
{
	switch (iParam0)
	{
		case 3036451504:
...
int func_60(int iParam0)//Position - 0x4660
{
...
int func_61(int iParam0, int iParam1)//Position - 0x47E6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_62(int iParam0, var uParam1)//Position - 0x5357
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0)//Position - 0x5392
{
	int iVar0;
...
void func_64(int iParam0)//Position - 0x5606
{
	int iVar0;
...
void func_65(var uParam0, int iParam1)//Position - 0x5642
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_66(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x5B9D
{
	int iVar0;
	int iVar1;
...
bool func_67(int iParam0, var uParam1, var uParam2)//Position - 0x5BE1
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x62C0
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x6307
{
...
bool func_70(int iParam0)//Position - 0x6362
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6372
{
...
int func_72(int iParam0)//Position - 0x63DC
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x66DF
{
	return Global_6373;
}

int func_74(int iParam0)//Position - 0x66EA
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x66FA
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x679C
{
	switch (iParam0)
	{
		case 4294967295:
...
int func_77(int iParam0)//Position - 0x6D71
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6DCF
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6E7D
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6F12
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6F56
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x70DA
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x70E8
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7BAF
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7C31
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7C8F
{
	return 4294967295;
}

Vector3 func_87(int iParam0)//Position - 0x7C98
{
	switch (iParam0)
	{
		case 1:
...
int func_88()//Position - 0x7EA3
{
	return func_89(CAM::_0xDC9DA9E8789F5246());
}

int func_89(int iParam0)//Position - 0x7EB3
{
	return MISC::GET_BITS_IN_RANGE(Global_24FBF9[iParam0 /*413*/].f_135.f_3, 28, 31);
}

int func_90(int iParam0)//Position - 0x7ED0
{
	return func_71(iParam0, 0, 0);
}

int func_91(int iParam0)//Position - 0x7EE0
{
	switch (iParam0)
	{
		case 4294967295:
...
int func_186(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xCB5C
{
	var uVar0;
	
	if ((((func_126(AUDIO::_0x0626A247D2405330()) && func_126(uParam0->f_1C[0])) && !func_145()) && (MISC::GET_GAME_TIMER() - uParam0->f_3C) > iParam6) && func_190(AUDIO::_0x0626A247D2405330(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_187(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCBE4
{
...
void func_188(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCC1F
{
	Global_3BAC = { *uParam0 };
	Global_6A3 = iParam1;
...
void func_189(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCC75
{
...
float func_190(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xCD10
{
	vector3 vVar0;
...
void func_191(int iParam0, var uParam1, char* sParam2)//Position - 0xCD4A
{
	if (func_126(*uParam1) && func_126(AUDIO::_0x0626A247D2405330()))
	{
		switch (*iParam0)
		{
			case 0:
				...
				BRAIN::TASK_PLAY_ANIM(*uParam1, cLocal_55, "base", 1000f, -8f, 4294967295, 1, 0, 0, 0, 0);
				*iParam0 = 1;
				break;
			...
			case 1:
				...
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_52, vLocal_53, 8f, 0, true, 0))
					{
						BRAIN::TASK_PLAY_ANIM(*uParam1, cLocal_55, "intro", 8f, -8f, 4294967295, 2, 0, 0, 0, 0);
						*iParam0 = 3;
					}
					else if (func_199(AUDIO::_0x0626A247D2405330(), *uParam1, 1) < 15f)
					{
						*iParam0 = 4;
					}
				}
				...
				{
					BRAIN::TASK_PLAY_ANIM(*uParam1, cLocal_55, "base", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
				}
				break;
			...
			case 4:
				if (func_192(&(iParam0->f_1), "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_52, vLocal_53, 8f, 0, true, 0))
					{
						BRAIN::TASK_PLAY_ANIM(*uParam1, cLocal_55, "loop_talk", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
					}
					*iParam0 = 5;
				}
				break;
				...
				if (!func_145())
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_55, "loop_talk", 3))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_55, "loop_talk") > 0.99f)
						{
							...
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), vLocal_52, vLocal_53, 8f, 0, true, 0))
							{
								BRAIN::TASK_PLAY_ANIM(*uParam1, cLocal_55, "outro", 8f, -8f, 4294967295, 2, 0, 0, 0, 0);
								*iParam0 = 1;
							}
							else
							{
								BRAIN::TASK_PLAY_ANIM(*uParam1, cLocal_55, "loop_look", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
								*iParam0 = 2;
							}
						}
					}
...
bool func_192(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD046
{
...
int func_193(char* sParam0, int iParam1, bool bParam2)//Position - 0xD094
{
	Global_3DCF = 0;
...
float func_199(int iParam0, int iParam1, bool bParam2)//Position - 0xD5BA
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_200(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xD618
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
	{
...
void func_201(int iParam0, bool bParam1)//Position - 0xD709
{
	if (iParam0 == 4294967295)
	{
		return;
...
int func_202(int iParam0)//Position - 0xD745
{
	if (Global_11621 == iParam0)
	{
...
void func_203(int iParam0, int iParam1)//Position - 0xD77E
{
	bool bVar0;
	int iVar1;
...
bool func_204()//Position - 0xD81C
{
	return Global_1620C;
}

void func_205(int iParam0)//Position - 0xD828
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_206(iParam0);
...
void func_206(int iParam0)//Position - 0xD83F
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_207(int iParam0)//Position - 0xD927
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_164();
...
int func_208(int iParam0, bool bParam1)//Position - 0xD94F
{
	struct<27> Var0;
...
void func_209(int iParam0, var uParam1, int iParam2)//Position - 0xDBC2
{
	int iVar0;
	int iVar1;
...
int func_210(int iParam0)//Position - 0xDF1A
{
...
int func_211(var uParam0)//Position - 0xDF3A
{
...
int func_212(var uParam0)//Position - 0xDF52
{
...
void func_213(var uParam0)//Position - 0xDF77
{
	int iVar0;
	int iVar1;
...
void func_214(int iParam0)//Position - 0xE275
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_215(var uParam0)//Position - 0xE2A0
{
	int iVar0;
...
int func_216(var uParam0, bool bParam1, bool bParam2)//Position - 0xE320
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_217(int iParam0, int iParam1)//Position - 0xE4DE
{
	int iVar0;
...
int func_218(var uParam0, bool bParam1, int iParam2)//Position - 0xE50E
{
	int iVar0;
	int iVar1;
...
int func_219(int iParam0)//Position - 0xE7CA
{
...
int func_220(int iParam0, float fParam1)//Position - 0xE7FE
{
	float fVar0;
...
bool func_221(int iParam0, float fParam1)//Position - 0xE874
{
	return func_222(iParam0, AUDIO::_0x0626A247D2405330(), fParam1, 1, 250, 7);
}

bool func_222(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE88C
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_223(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE94D
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_224(int iParam0, int iParam1)//Position - 0xEA79
{
	int iVar0;
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEB88
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
float func_227(vector3 vParam0, vector3 vParam1)//Position - 0xEC19
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_228(vector3 vParam0)//Position - 0xEC3A
{
	float fVar0;
	float fVar1;
...
void func_229(var uParam0)//Position - 0xEC79
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_230(int iParam0, int iParam1)//Position - 0xEC94
{
	int iVar0;
...
int func_231(int iParam0)//Position - 0xECD3
{
...
int func_232(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xECFB
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_233(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEDF6
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_234(int iParam0, float fParam1)//Position - 0xEF02
{
	var uVar0;
	vector3 vVar1;
...
int func_235(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xEF97
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
int func_236(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF025
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(AUDIO::_0x0626A247D2405330()))
...
int func_237(int iParam0)//Position - 0xF06D
{
...
void func_238(int iParam0)//Position - 0xF0B7
{
	int iVar0;
...
int func_239(int iParam0)//Position - 0xF154
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_164();
...
int func_240(int iParam0)//Position - 0xF1EC
{
...
int func_243(int iParam0)//Position - 0xF26E
{
	if ((func_244() && Global_16C30.f_B == 6) && iParam0 == func_165(&(Global_16C30.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_245(int iParam0)//Position - 0xF2E0
{
	if (func_107(0))
	{
...
int func_246(int iParam0)//Position - 0xF308
{
	switch (*iParam0)
	{
		case 0:
...
int func_247(var uParam0)//Position - 0xF34F
{
	int iVar0[2];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_254(&(uParam0->f_30), cLocal_55, "base", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			{
				if (!func_250(&(uParam0->f_1C[0]), 16, -1596.09f, 5218.102f, 3.045f, 125.5f, "RC ABIGAIL 2", 1))
				{
					bVar2 = false;
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				func_248(&(uParam0->f_23[0]), iVar0[1], -1584.013f, 5158.539f, 18.6057f, 210.5309f);
				VEHICLE::SET_VEHICLE_DOORS_LOCKED(uParam0->f_23[0], 3);
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_23[0], 1);
				VEHICLE::_0x2B6747FAA9DB9D6B(uParam0->f_23[0], 1);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
...
void func_248(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF501
{
	func_249(iParam0);
...
void func_249(int iParam0)//Position - 0xF543
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_250(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xF5DF
{
...
int func_251(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xF63B
{
	int iVar0;
...
int func_252(var uParam0, int iParam1)//Position - 0xF6C9
{
	int iVar0;
...
int func_253(int iParam0)//Position - 0xF70F
{
	int iVar0;
...
void func_254(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xF740
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_255(var uParam0)//Position - 0xF77C
{
	int iVar0;
	bool bVar1;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (!func_250(&(uParam0->f_1C[0]), 16, -1607.918f, 5243.162f, 3.045f, 125.5f, "RC ABIGAIL 1", 1))
				{
					bVar1 = false;
				}
			}
...
int func_256(int iParam0)//Position - 0xF887
{
	struct<27> Var0;
	int iVar1;
...
int func_257(int iParam0)//Position - 0xF8DB
{
	char* sVar0;
...
int func_258(int iParam0)//Position - 0xF994
{
	var uVar0;
...
int func_259(int iParam0)//Position - 0xFA55
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_260(int iParam0, char* sParam1)//Position - 0xFADA
{
...
bool func_262(int iParam0)//Position - 0xFBEA
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
bool func_263(int iParam0)//Position - 0xFC18
{
	if (iParam0 == 63 || iParam0 == 4294967295)
	{
		return 0;
...
int func_264(int iParam0)//Position - 0xFC46
{
	if (func_240(iParam0))
	{
		return 0;
...
void func_265()//Position - 0xFC7B
{
	func_287("Running end routines.");
	Global_19D3C = (Global_19D3C - 1);
}

int func_266(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xFC95
{
	int iVar0;
...
int func_267(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xFCFA
{
	int iVar0;
	struct<7> Var1;
...
int func_268(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xFD78
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_269(int iParam0, bool bParam1)//Position - 0xFDF3
{
	char* sVar0;
...
void func_270(char* sParam0)//Position - 0xFE7A
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (func_273(sParam0))
...
void func_271()//Position - 0xFE99
{
	Global_3960 = 0;
	func_272();
}

void func_272()//Position - 0xFEA9
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_41C1 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_273(char* sParam0)//Position - 0xFECA
{
	struct<6> Var0;
...
struct<6> func_274()//Position - 0xFEEA
{
	struct<6> Var0;
...
void func_275(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFF0E
{
...
void func_276(var uParam0, bool bParam1)//Position - 0xFF2E
{
	func_277(&(uParam0->f_29), bParam1);
}

void func_277(var uParam0, bool bParam1)//Position - 0xFF40
{
	int iVar0;
...
void func_278(int iParam0, bool bParam1)//Position - 0xFF7E
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*iParam0))
...
void func_279(var uParam0, bool bParam1)//Position - 0xFFB9
{
	func_280(&(uParam0->f_23), bParam1);
}

void func_280(var uParam0, bool bParam1)//Position - 0xFFCB
{
	int iVar0;
...
void func_281(int iParam0)//Position - 0x10009
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_282(var uParam0, int iParam1)//Position - 0x10041
{
	func_283(&(uParam0->f_1C), iParam1);
}

void func_283(var uParam0, int iParam1)//Position - 0x10053
{
	int iVar0;
...
void func_284(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10094
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_285(int iParam0)//Position - 0x100E4
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*iParam0, 0))
...
void func_286(var uParam0)//Position - 0x10125
{
	if (*uParam0 == 4294967295)
	{
		return;
...
void func_287(char* sParam0)//Position - 0x10162
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_288(var uParam0)//Position - 0x10174
{
	*uParam0 = 4294967295;
...
void func_289()//Position - 0x101A7
{
	func_287("Running start routines.");
	Global_19D3C++;
}

int func_290(int iParam0)//Position - 0x101C1
{
	if (!func_36(iParam0))
	{
		return Global_19E56.f_6D76[iParam0 /*29*/];
