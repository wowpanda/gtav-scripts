...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_132(vLocal_74, 4294967295, 0, 0, 0))
	{
		func_129(4294967295);
	}
	else
...
void func_1()//Position - 0x1CF
{
	...
	{
		if (!CAM::IS_SPHERE_VISIBLE(vLocal_75 + Vector(20f, 0f, 0f), 30f) && !ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), vLocal_75, 80f, 80f, 80f, false, true, 0))
		{
			func_174();
		}
	}
...
void func_2(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x370
{
	...
	else
	{
		...
		{
			if ((((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_7(CAM::_0xDC9DA9E8789F5246())) && !func_4(CAM::_0xDC9DA9E8789F5246(), 0)) && !func_3()) && !bParam4)
			{
				ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), false);
			}
		}
		else if ((!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()) && !func_7(CAM::_0xDC9DA9E8789F5246())) && !bParam4)
		{
			ENTITY::FREEZE_ENTITY_POSITION(AUDIO::_0x0626A247D2405330(), false);
		}
		Global_11623 = 0;
...
void func_22()//Position - 0xDB4
{
	...
	{
		case 0:
			AUDIO::REQUEST_SCRIPT_AUDIO_BANK("CONSTRUCTION_ACCIDENT_1", false, 4294967295);
			STREAMING::REQUEST_ANIM_DICT("re@construction");
			if (Local_283.f_20 <= 0)
			{
				Local_283.f_20 = MISC::GET_FRAME_COUNT();
			}
			func_105(&Local_283, joaat("s_m_m_dockwork_01"));
			func_105(&Local_283, 3879457979);
			func_105(&Local_283, joaat("p_amb_phone_01"));
			func_102(&Local_283);
			if ((AUDIO::REQUEST_SCRIPT_AUDIO_BANK("CONSTRUCTION_ACCIDENT_1", false, 4294967295) && STREAMING::HAS_ANIM_DICT_LOADED("re@construction")) && func_98(&Local_283))
			{
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_80, 0))
				{
					iLocal_78 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_80, 26, joaat("s_m_m_dockwork_01"), 4294967295, 1, true);
					...
					BRAIN::TASK_PLAY_ANIM(iLocal_78, "re@construction", "idle_c", 1000f, -1000f, 4294967295, 49, 0.4f, 0, 0, 0);
					...
					ENTITY::SET_ENTITY_HEALTH(iLocal_78, true);
					...
					ENTITY::SET_ENTITY_HEALTH(iLocal_79, true);
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_79, true, 1);
					unk_0x346478B12F69D4E3(iLocal_79, true);
					EVENT::SET_DECISION_MAKER(iLocal_78, 3151330285);
					EVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(3151330285, 24);
					EVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(3151330285, 46);
					EVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(3151330285, 61);
					EVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(3151330285, 136);
					EVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(3151330285, 55);
					iLocal_89 = OBJECT::CREATE_OBJECT(3879457979, vLocal_274.x, (vLocal_274.y + 0.5f), (vLocal_274.z - 0.25f), true, true, false);
		...
		case 1:
			...
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				if (!iLocal_92)
				{
					...
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(AUDIO::_0x0626A247D2405330(), -532.2208f, -849.2668f, 19.7038f, -531.6973f, -1065.341f, 60.7893f, 190.8125f, 0, true, 0))
						{
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_80, 0))
							{
								if (!HUD::DOES_BLIP_EXIST(iLocal_85))
						...
						if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_78, AUDIO::_0x0626A247D2405330(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_80, AUDIO::_0x0626A247D2405330(), 1))
						{
							unk_0x346478B12F69D4E3(iLocal_80, false);
							NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_78);
							...
							CUTSCENE::_0x8D9DF6ECA8768583(iLocal_107);
							BRAIN::TASK_PERFORM_SEQUENCE(iLocal_78, iLocal_107);
							BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_107);
							func_89();
						}
						STREAMING::REQUEST_MODEL(joaat("prop_ld_pipe_single_01"));
						if ((((ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), -473.1686f, -984.6405f, 22.487f, 40f, 40f, 5f, false, true, 0) && !PED::IS_PED_IN_ANY_HELI(AUDIO::_0x0626A247D2405330())) && !PED::IS_PED_IN_ANY_PLANE(AUDIO::_0x0626A247D2405330())) && func_88(1, 0, 1)) && STREAMING::HAS_MODEL_LOADED(joaat("prop_ld_pipe_single_01")))
						{
							if (!func_128())
							{
				...
				else
				{
					...
					if (!PED::IS_PED_INJURED(iLocal_78))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_78, vLocal_76, 0, 1, 0))
						{
							if (!bLocal_93)
							{
								func_42();
					...
					if (!OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_81, 0))
					{
						if (HUD::DOES_BLIP_EXIST(iLocal_86))
						{
							HUD::REMOVE_BLIP(&iLocal_86);
				...
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_81, 0))
				{
					if (iLocal_103 >= 3)
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0) && PED::IS_PED_IN_MODEL(AUDIO::_0x0626A247D2405330(), joaat("BULLDOZER")))
						{
							if (HUD::DOES_BLIP_EXIST(iLocal_86))
							{
								HUD::REMOVE_BLIP(&iLocal_86);
				...
				if (!PED::IS_PED_INJURED(iLocal_78))
				{
					...
					{
						if (PED::IS_PED_IN_MODEL(AUDIO::_0x0626A247D2405330(), joaat("BULLDOZER")))
						{
							iLocal_97 = 0;
							while (iLocal_97 < 11)
							{
...
void func_31()//Position - 0x1A73
{
	...
	{
		if (func_34(Global_19E56.f_933.f_21B.f_10CD) != ENTITY::GET_ENTITY_MODEL(AUDIO::_0x0626A247D2405330()))
		{
			iVar0 = func_33(AUDIO::_0x0626A247D2405330());
			if (func_32(iVar0) && (!func_35(14) || Global_19A3D))
			{
				if (Global_19E56.f_933.f_21B.f_10CD != iVar0 && func_32(Global_19E56.f_933.f_21B.f_10CD))
				{
		...
		case 2:
			if (!PED::IS_PED_INJURED(iLocal_78))
			{
				if ((MISC::GET_GAME_TIMER() - iLocal_101) > 5000 && !func_23())
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
					{
						iLocal_106 = ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0));
					}
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_78, 0))
					{
						if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_81, 0))
		...
		case 2:
			if ((MISC::GET_GAME_TIMER() - iLocal_105) > iLocal_73 || func_45())
			{
				...
				if (!bLocal_95)
				{
					if (!PED::IS_PED_INJURED(iLocal_78) && !ENTITY::IS_ENTITY_DEAD(iLocal_80, 0))
					{
						if (!VEHICLE::_0x639431E895B9AA57(iLocal_78, iLocal_80, 4294967295, 0, false) && !VEHICLE::_0x639431E895B9AA57(iLocal_78, iLocal_80, 0, 0, false))
						{
							func_40();
							SYSTEM::WAIT(0);
							func_24(&uLocal_108, "CONACAU", "CONAC_DIE", 4, 0, 0, 0);
	...
	switch (iLocal_98)
	{
		case 0:
			if (iLocal_103 >= 2)
			{
				if (!PED::IS_PED_INJURED(iLocal_78) && !ENTITY::IS_ENTITY_DEAD(iLocal_80, 0))
				{
					...
					if (VEHICLE::_0x639431E895B9AA57(iLocal_78, iLocal_80, 4294967295, 0, false) || VEHICLE::_0x639431E895B9AA57(iLocal_78, iLocal_80, 0, 0, false))
					{
						if (VEHICLE::_0x639431E895B9AA57(iLocal_78, iLocal_80, 4294967295, 0, false))
						{
							bLocal_94 = true;
							vLocal_77 = { unk_0x8000C77B5F336760(iLocal_80, false) + Vector(0f, -1f, -3f) };
						}
						else
						{
							vLocal_77 = { unk_0x8000C77B5F336760(iLocal_80, false) + Vector(0f, 1.5f, -3f) };
						}
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_78) && !ENTITY::IS_ENTITY_DEAD(iLocal_80, 0))
			{
				...
				if (bLocal_94)
				{
					BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 3000, 0, 2);
					BRAIN::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
					BRAIN::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -476.3904f, -986.836f, 22.5569f, 3f, 4294967295, 1048576000, 0, 1193033728);
				}
				else
				{
					BRAIN::TASK_LOOK_AT_ENTITY(0, AUDIO::_0x0626A247D2405330(), 3000, 0, 2);
		...
		case 5:
			if ((MISC::GET_GAME_TIMER() - iLocal_101) > 3000)
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_78))
				{
					...
					ENTITY::SET_ENTITY_HEALTH(iLocal_78, false);
					EVENT::SET_DECISION_MAKER(iLocal_78, 3839837909);
					NETWORK::_0x5E3AA4CA2B6FB0EE(AUDIO::_0x0626A247D2405330());
					BRAIN::OPEN_SEQUENCE_TASK(&iLocal_107);
					BRAIN::TASK_PLAY_ANIM(0, "re@construction", "Out_Of_Breath", 2f, -2f, 4294967295, 0, 0, 0, 0, 0);
					BRAIN::SET_SEQUENCE_TO_REPEAT(iLocal_107, 1);
					CUTSCENE::_0x8D9DF6ECA8768583(iLocal_107);
					BRAIN::TASK_PERFORM_SEQUENCE(iLocal_78, iLocal_107);
					BRAIN::CLEAR_SEQUENCE_TASK(&iLocal_107);
				}
...
int func_58(int iParam0, int iParam1)//Position - 0x3472
{
	switch (iParam0)
	{
		case 0:
...
int func_59(int iParam0)//Position - 0x37E6
{
	switch (iParam0)
	{
		case 29:
...
void func_60(int iParam0)//Position - 0x3815
{
	int iVar0;
	int iVar1;
...
void func_61(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x3857
{
	func_62(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_62(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x3878
{
	int iVar0;
...
int func_65(int iParam0)//Position - 0x3BB1
{
	int iVar0;
	int iVar1;
...
void func_66(int iParam0, int iParam1)//Position - 0x3BF4
{
	MISC::SET_BIT(&(Global_19E56.f_6187.f_8[iParam0]), iParam1);
}

int func_67(int iParam0)//Position - 0x3C0F
{
	int iVar0;
...
int func_69(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x3CDD
{
...
void func_70(int iParam0, int iParam1, int iParam2)//Position - 0x3EB7
{
	int iVar0;
	int iVar1;
	...
	switch (iParam0)
	{
		...
		case 3:
			...
			if (iVar1 != 9954)
			{
				iVar0 = func_73(iVar1, 4294967295, 0);
				iVar0 = (iVar0 + iParam2);
				if (iVar0 > 100)
				{
					iVar0 = 100;
				}
				func_71(iVar1, iVar0, 4294967295, 1, 0);
			}
			break;
	}
}

void func_71(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x3FA7
{
	int iVar0;
	...
	iVar0 = Global_26B05F[iParam0 /*3*/][func_72(iParam2)];
	if (iVar0 != 0)
	{
...
int func_72(var uParam0)//Position - 0x3FD7
{
	int iVar0;
	int iVar1;
...
int func_73(int iParam0, int iParam1, int iParam2)//Position - 0x400C
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Global_26B05F[iParam0 /*3*/][func_72(iParam1)];
...
int func_74()//Position - 0x403E
{
	return 1;
}

int func_75(int iParam0, bool bParam1, int iParam2)//Position - 0x4047
{
	int iVar0;
...
int func_76(int iParam0, bool bParam1, bool bParam2)//Position - 0x4099
{
	int iVar0;
...
float func_77(bool bParam0, float fParam1, float fParam2)//Position - 0x413D
{
	if (bParam0)
	{
		return fParam1;
...
int func_78(int iParam0)//Position - 0x4154
{
	if (func_82())
	{
		Global_19E4C = 1;
		Global_19E49 = MISC::GET_GAME_TIMER();
		if (func_59(Global_19E4B))
		{
			func_79(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_59(Global_19E4B))
		{
...
void func_79(int iParam0)//Position - 0x41A7
{
	switch (iParam0)
	{
		case 0:
			if (Global_19E56.f_6187.f_2 < 3)
			{
				...
				{
					func_80(func_81(iParam0), 4294967295);
...
void func_80(char* sParam0, int iParam1)//Position - 0x4288
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, true, iParam1);
}

char* func_81(int iParam0)//Position - 0x429F
{
	char* sVar0;
...
int func_82()//Position - 0x42E2
{
	switch (func_83(&Global_63AE, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_83(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x4318
{
	int iVar0;
...
void func_84(var uParam0, int iParam1)//Position - 0x444F
{
	int iVar0;
...
bool func_85(int iParam0)//Position - 0x449E
{
	return func_86(iParam0, Global_8D15);
}

int func_86(int iParam0, int iParam1)//Position - 0x44AF
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_87(int iParam0)//Position - 0x4690
{
	if (Global_8D15 == 15)
	{
		return 0;
...
int func_88(bool bParam0, bool bParam1, bool bParam2)//Position - 0x46B2
{
	int iVar0;
...
void func_89()//Position - 0x4797
{
	AUDIO::TRIGGER_MUSIC_EVENT("RE14A_FAIL");
	iLocal_70 = 2;
}

int func_90(int iParam0, bool bParam1, bool bParam2)//Position - 0x47AB
{
	return func_76(iParam0, !bParam1, bParam2);
}

void func_91()//Position - 0x47BE
{
	if (func_94(1000))
	{
		func_40();
	...
	switch (iLocal_72)
	{
		case 0:
			...
			if (ENTITY::IS_ENTITY_AT_COORD(AUDIO::_0x0626A247D2405330(), -473.1686f, -984.6405f, 22.487f, 15f, 15f, 5f, false, true, 0))
			{
				ENTITY::SET_ENTITY_COORDS(AUDIO::_0x0626A247D2405330(), -477.3538f, -972.67f, 22.5494f, 1, false, 0, 1);
				ENTITY::SET_ENTITY_HEADING(AUDIO::_0x0626A247D2405330(), 237.4839f);
			}
		...
		case 1:
			...
			{
				unk_0x1190AB7024CBD8CB(4294967295, "WEAKEN", "CONSTRUCTION_ACCIDENT_1_SOUNDS", true);
				unk_0x1190AB7024CBD8CB(iLocal_100, "WIND", "CONSTRUCTION_ACCIDENT_1_SOUNDS", true);
				...
				{
					NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_78);
					BRAIN::TASK_LOOK_AT_COORD(iLocal_78, -461.4785f, -984.8583f, 28.0809f, 30000, 2080, 2);
				}
		...
		case 2:
			...
			{
				unk_0x1190AB7024CBD8CB(4294967295, "CABLE_SNAPS", "CONSTRUCTION_ACCIDENT_1_SOUNDS", true);
				iLocal_104 = MISC::GET_GAME_TIMER();
				iLocal_72 = 3;
			}
			break;
		...
		case 5:
			if ((MISC::GET_GAME_TIMER() - iLocal_104) > 500)
			{
				...
				{
					unk_0x346478B12F69D4E3(iLocal_80, false);
					unk_0x1190AB7024CBD8CB(4294967295, "PIPES_LAND", "CONSTRUCTION_ACCIDENT_1_SOUNDS", true);
					VEHICLE::SET_VEHICLE_DAMAGE(iLocal_80, 0f, 1f, 1f, 200f, 800f, 1);
					if (!PED::IS_PED_INJURED(iLocal_78))
					{
						BRAIN::TASK_CLEAR_LOOK_AT(iLocal_78);
					}
					BRAIN::TASK_PLAY_ANIM(iLocal_78, "re@construction", "idle_panic", 8f, -8f, 4294967295, 16, 0, 0, 0, 0);
		...
		case 6:
			if ((MISC::GET_GAME_TIMER() - iLocal_104) > 500)
			{
				...
				if (!PED::IS_PED_INJURED(iLocal_78))
				{
					BRAIN::TASK_LOOK_AT_COORD(iLocal_78, unk_0x8000C77B5F336760(iLocal_78, true) - Vector(10f, 0f, 2f), 30000, 2080, 2);
				}
				iLocal_104 = MISC::GET_GAME_TIMER();
				iLocal_72 = 7;
			}
		...
		case 8:
			...
			if (!PED::IS_PED_INJURED(iLocal_78))
			{
				NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_78);
				BRAIN::TASK_CLEAR_LOOK_AT(iLocal_78);
				BRAIN::TASK_PLAY_ANIM(iLocal_78, "re@construction", "idle_panic", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
			}
...
void func_92(int iParam0)//Position - 0x5305
{
...
void func_93()//Position - 0x531D
{
	AUDIO::START_PRELOADED_CONVERSATION();
	Global_41AE = 0;
}

int func_94(int iParam0)//Position - 0x532D
{
...
int func_96(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x53A9
{
	func_39(uParam0, 145, sParam1, iParam4, iParam5, iParam6);
	if (iParam3 > 7)
	{
...
void func_97(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x53FC
{
...
int func_98(var uParam0)//Position - 0x5497
{
	int iVar0;
...
bool func_99(var uParam0)//Position - 0x54F9
{
	return func_100(*uParam0, "NULL", uParam0->f_1);
}

int func_100(int iParam0, char* sParam1, int iParam2)//Position - 0x550E
{
...
int func_101(int iParam0)//Position - 0x5602
{
	int iVar0;
...
void func_102(var uParam0)//Position - 0x562E
{
	func_103(uParam0, 9, 4294967295, 0);
}

void func_103(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5640
{
	int iVar0;
...
int func_104(int iParam0)//Position - 0x5703
{
	switch (iParam0)
	{
		case 4294967295:
...
void func_105(var uParam0, int iParam1)//Position - 0x57A2
{
	func_103(uParam0, 0, iParam1, 0);
}

void func_106(var uParam0)//Position - 0x57B4
{
	int iVar0;
...
void func_107(int iParam0)//Position - 0x583E
{
	func_108(iParam0, "NULL", iParam0->f_1);
}

void func_108(int iParam0, char* sParam1, int iParam2)//Position - 0x5852
{
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*iParam0, 30))
	{
		switch (func_101(*iParam0))
...
void func_110(var uParam0, bool bParam1)//Position - 0x5C12
{
	int iVar0;
...
void func_111(var uParam0)//Position - 0x5C52
{
	*uParam0 = 0;
	uParam0->f_1 = 4294967295;
}

void func_112(var uParam0)//Position - 0x5C63
{
	int iVar0;
...
void func_113(var uParam0)//Position - 0x5C9C
{
	func_114(*uParam0, "NULL", uParam0->f_1);
}

void func_114(int iParam0, char* sParam1, int iParam2)//Position - 0x5CB1
{
	if (INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 30))
	{
		switch (func_101(iParam0))
...
int func_115()//Position - 0x5D71
{
	if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()) && !PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(AUDIO::_0x0626A247D2405330())) > 1369f && !func_126())
		{
			return 0;
		}
	}
...
int func_116(float fParam0, bool bParam1)//Position - 0x5DF7
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_117(int iParam0, var uParam1)//Position - 0x5EAE
{
	switch (iParam0)
	{
		case 0:
		...
		case 1:
			func_118(uParam1, "Abigail2", func_120(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, 4294967295, 4, 1, 0, 2359, func_119(iParam0), 1, 0);
			break;
		
		case 2:
			func_118(uParam1, "Barry1", func_120(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 0, 2359, func_119(iParam0), 1, 0);
			break;
		
		case 3:
			func_118(uParam1, "Barry2", func_120(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_119(iParam0), 1, 1);
			break;
		
		case 4:
			func_118(uParam1, "Barry3", func_120(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", 4294967295, 0, "", 164, 1, 4294967295, 0, 2, 0, 2359, func_119(iParam0), 0, 0);
			break;
		...
		case 7:
			func_118(uParam1, "Barry4", func_120(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, 4294967295, 4, 2, 800, 2000, func_119(iParam0), 0, 0);
			break;
		
		case 8:
			func_118(uParam1, "Dreyfuss1", func_120(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_119(iParam0), 0, 0);
			break;
		...
		case 15:
			func_118(uParam1, "Epsilon7", func_120(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", 4294967295, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_119(iParam0), 0, 0);
			break;
		
		case 16:
			func_118(uParam1, "Epsilon8", func_120(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, 4294967295, 4, 1, 0, 2359, func_119(iParam0), 1, 0);
			break;
		
		case 17:
			func_118(uParam1, "Extreme1", func_120(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", 4294967295, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_119(iParam0), 0, 1);
			break;
		...
		case 20:
			func_118(uParam1, "Extreme4", func_120(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_119(iParam0), 0, 0);
			break;
		
		case 21:
			func_118(uParam1, "Fanatic1", func_120(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 700, 2000, func_119(iParam0), 1, 0);
			break;
		
		case 22:
			func_118(uParam1, "Fanatic2", func_120(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 700, 2000, func_119(iParam0), 1, 0);
			break;
		
		case 23:
			func_118(uParam1, "Fanatic3", func_120(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 2, 700, 2000, func_119(iParam0), 0, 1);
			break;
		
		case 24:
			func_118(uParam1, "Hao1", func_120(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", 4294967295, 0, "controller_Races", 13, 1, 4294967295, 4, 2, 2000, 500, func_119(iParam0), 0, 1);
			break;
		
		case 25:
			func_118(uParam1, "Hunting1", func_120(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", 4294967295, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_119(iParam0), 0, 1);
			break;
		
		case 26:
			func_118(uParam1, "Hunting2", func_120(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, 4294967295, 4, 4, 0, 2359, func_119(iParam0), 0, 1);
			break;
		
		case 27:
			func_118(uParam1, "Josh1", func_120(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", 4294967295, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_119(iParam0), 1, 0);
			break;
		...
		case 29:
			func_118(uParam1, "Josh3", func_120(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 4294967295, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_119(iParam0), 1, 1);
			break;
		
		case 30:
			func_118(uParam1, "Josh4", func_120(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", 4294967295, 36, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_119(iParam0), 1, 0);
			break;
		
		case 31:
			func_118(uParam1, "Maude1", func_120(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", 4294967295, 0, "BailBond_Launcher", 0, 1, 4294967295, 4, 4, 0, 2359, func_119(iParam0), 0, 1);
			break;
		
		case 32:
			func_118(uParam1, "Minute1", func_120(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", 4294967295, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_119(iParam0), 0, 1);
			break;
		
		case 33:
			func_118(uParam1, "Minute2", func_120(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", 4294967295, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_119(iParam0), 0, 1);
			break;
		
		case 34:
			func_118(uParam1, "Minute3", func_120(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", 4294967295, 10, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_119(iParam0), 0, 1);
			break;
		
		case 35:
			func_118(uParam1, "MrsPhilips1", func_120(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", 4294967295, 0, "ambient_MrsPhilips", 0, 1, 4294967295, 4, 4, 0, 2359, func_119(iParam0), 0, 0);
			break;
		
		case 36:
			func_118(uParam1, "MrsPhilips2", func_120(iParam0), 0, 11, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_119(iParam0), 0, 0);
			break;
		
		case 37:
			func_118(uParam1, "Nigel1", func_120(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", 4294967295, 0, "", 177, 1, 4294967295, 1, 4, 0, 2359, func_119(iParam0), 1, 0);
			break;
		...
		case 42:
			func_118(uParam1, "Nigel2", func_120(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", 4294967295, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_119(iParam0), 1, 1);
			break;
		
		case 43:
			func_118(uParam1, "Nigel3", func_120(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", 4294967295, 16, "postRC_Nigel3", 0, 0, 4294967295, 4, 4, 0, 2359, func_119(iParam0), 1, 1);
			break;
		
		case 44:
			func_118(uParam1, "Omega1", func_120(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", 4294967295, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_119(iParam0), 0, 0);
			break;
		
		case 45:
			func_118(uParam1, "Omega2", func_120(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_119(iParam0), 0, 0);
			break;
		
		case 46:
			func_118(uParam1, "Paparazzo1", func_120(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", 4294967295, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_119(iParam0), 0, 1);
			break;
		
		case 47:
			func_118(uParam1, "Paparazzo2", func_120(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", 4294967295, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_119(iParam0), 0, 1);
			break;
		
		case 48:
			func_118(uParam1, "Paparazzo3", func_120(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", 4294967295, 8, "", 183, 1, 4294967295, 2, 2, 0, 2359, func_119(iParam0), 0, 0);
			break;
		...
		case 51:
			func_118(uParam1, "Paparazzo4", func_120(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", 4294967295, 8, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_119(iParam0), 0, 0);
			break;
		
		case 52:
			func_118(uParam1, "Rampage1", func_120(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", 4294967295, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_119(iParam0), 0, 0);
			break;
		
		case 54:
			func_118(uParam1, "Rampage3", func_120(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", 4294967295, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_119(iParam0), 1, 0);
			break;
		
		case 55:
			func_118(uParam1, "Rampage4", func_120(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", 4294967295, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_119(iParam0), 1, 0);
			break;
		
		case 56:
			func_118(uParam1, "Rampage5", func_120(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", 4294967295, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_119(iParam0), 0, 0);
			break;
		
		case 53:
			func_118(uParam1, "Rampage2", func_120(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", 4294967295, 0, "rampage_controller", 0, 0, 4294967295, 4, 4, 0, 2359, func_119(iParam0), 1, 0);
			break;
		
		case 57:
			func_118(uParam1, "TheLastOne", func_120(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_119(iParam0), 0, 1);
			break;
		
		case 58:
			func_118(uParam1, "Tonya1", func_120(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", 4294967295, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_119(iParam0), 0, 1);
			break;
		
		case 59:
			func_118(uParam1, "Tonya2", func_120(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_119(iParam0), 0, 1);
			break;
		
		case 60:
			func_118(uParam1, "Tonya3", func_120(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_119(iParam0), 0, 1);
			break;
		
		case 61:
			func_118(uParam1, "Tonya4", func_120(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_119(iParam0), 0, 1);
			break;
		
		case 62:
			func_118(uParam1, "Tonya5", func_120(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_119(iParam0), 0, 1);
			break;
...
int func_119(int iParam0)//Position - 0x70F4
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_120(int iParam0)//Position - 0x743A
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_121(int iParam0)//Position - 0x7471
{
	struct<2> Var0;
...
bool func_123()//Position - 0x78EF
{
	return Global_19D3C > 0;
}

int func_124()//Position - 0x78FD
{
...
int func_128()//Position - 0x79B7
{
	if ((Global_19E4B == func_68() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_19E4C)
	{
		return 1;
	}
	return 0;
...
void func_129(int iParam0)//Position - 0x79E2
{
	if (iParam0 == 4294967295)
	{
		iParam0 = func_68();
...
void func_131(int iParam0)//Position - 0x7A55
{
	Global_19E4B = iParam0;
}

int func_132(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x7A63
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_168(Global_19E56.f_6187.f_2B[iParam1]))
		{
			return 0;
		}
...
bool func_133(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x7DFD
{
	if (bParam2)
	{
...
bool func_134(int iParam0)//Position - 0x7E44
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0x7E65
{
	return func_136(iParam0, 1);
}

int func_136(int iParam0, int iParam1)//Position - 0x7E74
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_137(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x7EC7
{
	func_138(func_149(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_138(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x7EE5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_139(float fParam0, float fParam1, float fParam2)//Position - 0x80E8
{
	float fVar0;
...
int func_140(int iParam0, int iParam1)//Position - 0x812A
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_141(int iParam0)//Position - 0x81CC
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_142(int iParam0)//Position - 0x81DF
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_143(int iParam0)//Position - 0x81F2
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_144(int iParam0)//Position - 0x8205
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_145(int iParam0)//Position - 0x8217
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_146(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(iParam0, 31), 4294967295, 1)) + 2011;
}

int func_146(bool bParam0, int iParam1, int iParam2)//Position - 0x823C
{
	if (bParam0)
	{
		return iParam1;
...
int func_147(int iParam0)//Position - 0x8253
{
	return iParam0 & 15;
}

int func_148(int iParam0, int iParam1)//Position - 0x8260
{
	int iVar0;
	int iVar1;
...
void func_150(var uParam0, int iParam1)//Position - 0x83B2
{
	if (iParam1 <= 0)
	{
		return;
...
void func_151(var uParam0, int iParam1)//Position - 0x8438
{
...
void func_152(var uParam0, int iParam1)//Position - 0x846B
{
	int iVar0;
	int iVar1;
...
void func_153(var uParam0, int iParam1)//Position - 0x84BC
{
...
void func_154(var uParam0, int iParam1)//Position - 0x84F6
{
...
void func_155(var uParam0, int iParam1)//Position - 0x8531
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_157(int iParam0, int iParam1)//Position - 0x8649
{
...
int func_158(int iParam0)//Position - 0x866C
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_166()) || Global_19A9D) || Global_6375) || func_165()) || func_37(8, 4294967295)) || func_164()) || func_163()) || func_162()) || func_161()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1) || func_166()) || Global_6375) || func_165()) || func_37(8, 4294967295)) || func_162()) || func_164()) || func_163()) || func_161()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(CAM::_0xDC9DA9E8789F5246()) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_166()) || Global_19A9D) || Global_6375) || func_165()) || func_37(8, 4294967295)) || func_162()) || func_164()) || func_163()) || func_161()) || Global_19E56.f_1DEC.f_397[iVar0] == 5) || Global_8F38 != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330()) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0)) || func_166()) || Global_19A9D) || Global_6375) || func_165()) || func_37(8, 4294967295)) || func_164()) || func_163()) || func_161()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_166() || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || func_37(8, 4294967295)) || func_161()) || func_160()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_37(8, 4294967295) || func_164()) || func_163()) || func_160()) || func_159())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(AUDIO::_0x0626A247D2405330()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(AUDIO::_0x0626A247D2405330(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(CAM::_0xDC9DA9E8789F5246()) > 0) || ENTITY::IS_ENTITY_IN_AIR(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_RAGDOLL(AUDIO::_0x0626A247D2405330())) || PED::IS_PED_FALLING(AUDIO::_0x0626A247D2405330())) || PLAYER::IS_PLAYER_BEING_ARRESTED(CAM::_0xDC9DA9E8789F5246(), 1)) || PLAYER::IS_PLAYER_CLIMBING(CAM::_0xDC9DA9E8789F5246())) || func_166()) || Global_6375) || func_165()) || func_37(8, 4294967295)) || func_163()) || func_162()) || func_161()) || Global_19E56.f_1DEC.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_159()//Position - 0x8D89
{
	return Global_16C57.f_1;
}

int func_160()//Position - 0x8D97
{
	if (Global_16089 != 4294967295)
	{
...
bool func_163()//Position - 0x8E01
{
	return Global_16C64.f_148 > 0;
}

bool func_164()//Position - 0x8E12
{
	return Global_16C64.f_147 > 0;
}

var func_165()//Position - 0x8E23
{
	return Global_140859;
}

int func_166()//Position - 0x8E2F
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_168(int iParam0)//Position - 0x8E73
{
	return func_148(func_149(), iParam0);
}

int func_169(int iParam0, int iParam1, int iParam2)//Position - 0x8E85
{
	int iVar0;
	int iVar1;
...
int func_170(int iParam0)//Position - 0x8F69
{
	if (!func_32(iParam0))
	{
		return 7;
...
bool func_171(int iParam0)//Position - 0x8F8D
{
	int iVar0;
	bool bVar1;
...
void func_174()//Position - 0x90EA
{
	if (iLocal_280)
	{
		if (!iLocal_281)
		{
			...
			{
				if (!PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_83, 0) && !ENTITY::IS_ENTITY_AT_ENTITY(AUDIO::_0x0626A247D2405330(), iLocal_83, 50f, 50f, 50f, 0, 1, 0))
				{
...
void func_175(int iParam0)//Position - 0x92D5
{
	char cVar0[64];
	...
	if (func_128())
	{
		...
		func_178(30000);
		StringCopy(&cVar0, func_177(Global_19E4B, 1), 64);
		if (func_67(Global_19E4B) > 0)
		{
	...
	func_176(&Global_63AE);
	Global_19E4C = 0;
	func_131(4294967295);
}

void func_176(var uParam0)//Position - 0x938A
{
	if (*uParam0 == 4294967295)
	{
		return;
...
char* func_177(int iParam0, bool bParam1)//Position - 0x93C7
{
	switch (iParam0)
	{
		case 0:
...
void func_178(int iParam0)//Position - 0x9610
{
	Global_8F3C = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_179(int iParam0)//Position - 0x9622
{
	func_180(iParam0, 0, func_185(iParam0));
}

void func_180(int iParam0, int iParam1, int iParam2)//Position - 0x9637
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_181(var uParam0)//Position - 0x9666
{
	struct<16> Var0;
	int iVar1;
...
void func_182(int iParam0, var uParam1)//Position - 0x9736
{
	Global_19E56.f_6187.f_2B[iParam0] = *uParam1;
}

void func_183(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x974E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_184(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x98D0
{
...
int func_185(int iParam0)//Position - 0x9908
{
	int iVar0;
...
int func_186(int iParam0, int iParam1, int iParam2)//Position - 0x9AAB
{
	var uVar0;
	char* sVar1;
...
void func_187(int iParam0, int iParam1)//Position - 0x9AEB
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_188(iParam0, &(Global_19E56.f_7F5D.f_1586));
}

void func_188(int iParam0, var uParam1)//Position - 0x9CED
{
	int iVar0;
	...
	if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		if (uParam1->f_41 == 4294967295 && !func_191(uParam1->f_42))
		{
			uParam1->f_41 = 0;
		}
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_4D), func_189(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_189(int iParam0)//Position - 0x9F98
{
	switch (iParam0)
	{
		case 1:
...
int func_190(int iParam0, var uParam1, var uParam2)//Position - 0xA048
{
	int iVar0;
	int iVar1;
...
int func_191(int iParam0)//Position - 0xA23B
{
	switch (iParam0)
	{
		case joaat("GRANGER"):
...
void func_192(var uParam0)//Position - 0xA25B
{
	int iVar0;
...
int func_193(int iParam0)//Position - 0xA30B
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iParam0, 0)) || func_208(iParam0, 0, 0)) || func_208(iParam0, 1, 0)) || func_208(iParam0, 2, 0)) || func_207(iParam0) != 145) || func_206(iParam0)) || func_205(iParam0)) || func_204(iParam0)) || func_203(iParam0)) || !func_194(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_205(iParam0))
		{
		}
...
int func_194(int iParam0)//Position - 0xA3E8
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_195(int iParam0, bool bParam1)//Position - 0xA599
{
	int iVar0;
	struct<2> Var1;
...
int func_196(int iParam0)//Position - 0xA719
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_198(int iParam0)//Position - 0xA7FC
{
	int iVar0;
	int iVar1;
...
int func_199()//Position - 0xC4F8
{
	return 0;
}

int func_200()//Position - 0xC501
{
	return 1;
}

int func_201()//Position - 0xC50A
{
	return 1;
}

int func_202()//Position - 0xC513
{
...
int func_203(int iParam0)//Position - 0xC52C
{
	int iVar0;
	char* sVar1;
...
int func_204(int iParam0)//Position - 0xC572
{
	int iVar0;
...
int func_205(int iParam0)//Position - 0xC5AD
{
	int iVar0;
...
int func_206(int iParam0)//Position - 0xC629
{
	int iVar0;
...
int func_207(int iParam0)//Position - 0xC711
{
	int iVar0;
...
int func_208(int iParam0, int iParam1, bool bParam2)//Position - 0xC774
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_209(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0xC7E5
{
...
void func_210()//Position - 0xC8BD
{
	Global_3960 = 0;
	func_211();
}

void func_211()//Position - 0xC8CD
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
