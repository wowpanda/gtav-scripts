	...
	while (true)
	{
		...
		if ((MISC::GET_GAME_TIMER() - iVar4) > 100)
		{
			if (!PED::IS_PED_INJURED(AUDIO::_0x0626A247D2405330()))
			{
				...
				{
					if (SYSTEM::VDIST2(vVar0, unk_0x8000C77B5F336760(iLocal_79[iVar1], false)) >= IntToFloat((iVar3 * iVar3)) && ENTITY::IS_ENTITY_OCCLUDED(iLocal_79[iVar1]))
					{
				...
				if (func_3(iLocal_79.f_5[iVar2]))
				{
					...
					{
						if (ENTITY::IS_ENTITY_OCCLUDED(iLocal_79.f_5[iVar2]) || PED::IS_PED_IN_VEHICLE(AUDIO::_0x0626A247D2405330(), iLocal_79.f_5[iVar2], 0))
						{
...
{
	return func_17(iParam0, Global_8D15);
}
...
void func_18()//Position - 0x97A
{
	...
	while (iVar0 <= (iLocal_79.f_5 - 1))
	{
		if (func_3(iLocal_79.f_5[iVar0]))
		{
			...
			vLocal_88[iVar0 /*3*/] = { unk_0x8000C77B5F336760(iLocal_79.f_5[iVar0], false) };
		}
		iVar0++;
	}
	iVar0 = 0;
