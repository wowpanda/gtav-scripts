	...
	while (true)
	{
		...
		switch (Global_106565.f_24980.f_2)
		{
					...
					if (!func_239())
					{
						if (func_219(4, 62, 2, -1, 0))
						{
							if (func_216(Local_43.f_4, Local_43.f_5))
							{
								...
								iLocal_218 = func_196();
								func_188(&iLocal_218, 0, 0, 0, 10, 0, 0);
								Global_106565.f_24980.f_3 = iLocal_218;
								CLEAR_BIT(&(Global_106565.f_24980), 9);
			...
			case 1:
				if (func_187() == 2)
				{
					func_172(&Local_43, &uLocal_53);
					func_164(Local_43.f_4);
					if (!IS_BIT_SET(Global_106565.f_24980, 8))
					{
						if (!func_239())
						{
							SET_BIT(&(Global_106565.f_24980), 8);
						}
						else
						{
							WAIT(2000);
					...
					else if (func_239())
					{
						...
						else
						{
							if (IS_BIT_SET(Global_106565.f_24980, 8))
							{
								CLEAR_BIT(&(Global_106565.f_24980), 8);
							}
							WAIT(2000);
						}
					}
			...
			case 2:
				if (!IS_THREAD_ACTIVE(iLocal_219))
				{
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_25(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_28(int iParam0)
{
	...
	switch (iParam0)
	{
		case 1:
		case 2:
			SET_BIT(&(Global_106565.f_24980), func_73(Local_43.f_4));
			if (iParam0 == 1)
			{
				func_72(0);
				iVar0 = 8;
				SET_BIT(&(Global_106565.f_24980), func_71(Local_43.f_4));
			}
			else
			{
				func_72(1);
				iVar0 = 4;
				CLEAR_BIT(&(Global_106565.f_24980), func_71(Local_43.f_4));
			...
			if (func_36())
			{
				if (IS_BIT_SET(Global_106565.f_24980, func_71(Local_43.f_4)))
				{
					iLocal_218 = func_196();
					func_188(&iLocal_218, 0, 0, iVar0, 0, 0, 0);
					Global_106565.f_24980.f_3 = iLocal_218;
...
void func_30()
{
	...
	iVar0 = (iVar0 - 1);
	if (iVar0 >= 0 && IS_BIT_SET(Global_106565.f_24980, func_71(iVar0)))
	{
		Local_43.f_5 = 1;
	}
	else
...
int func_35()
{
	...
	while (iVar0 <= (4 - 1))
	{
		if (!IS_BIT_SET(Global_106565.f_24980, iVar0))
		{
			return iVar0;
		}
		iVar0++;
...
void func_74(int iParam0)
{
	...
	if (!IS_BIT_SET(Global_106565.f_24980, 9))
	{
		if (func_17(Global_106565.f_24980.f_3))
		{
			if (func_241())
			{
				if (func_219(4, 62, 2, -1, 0))
				{
					...
					{
						SET_BIT(&(Global_106565.f_24980), 9);
					}
				}
			}
		}
...
void func_79(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_187();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_107())
		{
			func_100(PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
...
int func_93(var uParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
int func_101(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = Global_2539502[iParam0 /*3*/][func_102(iParam1)];
...
void func_110(int iParam0, var uParam1)
{
	...
	if (!IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_115(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((GET_DLC_WEAPON_DATA(iVar9, &Var11) && !func_112(Var11.f_1)) && iVar72 < 51)
			{
...
void func_116(var uParam0)
{
	...
	if (func_90(iVar0) && !IS_PED_INJURED(uParam0))
	{
...
int func_118(vector3 vParam0, char* sParam3, vector3 vParam4)
{
	int iVar0;
	int iVar1;
...
int func_121(var uParam0)
{
	if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (func_144())
		{
			*uParam0 = func_127(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
int func_123(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_125() == 0)
		{
			return IS_BIT_SET(func_101(func_124(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_127(vector3 vParam0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 51)
	{
		if (iParam3 == 6 || iParam3 == func_143(iVar0))
		{
			if (!bParam5 || func_142(iVar0))
			{
				fVar1 = GET_DISTANCE_BETWEEN_COORDS(vParam0, func_128(iVar0, 0), 1);
...
int func_131(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	vVar18 = { Var12 - Var0 };
	vVar18 = { func_132(vVar18, -Var0.f_3.f_2) };
	vVar18 = { func_132(vVar18, vVar6.f_3.f_2) };
	*uParam2 = { _GET_OBJECT_OFFSET_FROM_COORDS(vVar6, 0f, vVar18) };
	uParam2->f_3 = { Var12.f_3 };
	return 1;
}

Vector3 func_132(vector3 vParam0, float fParam3)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
void func_146(int iParam0)
{
	...
	iLocal_219 = START_NEW_SCRIPT_WITH_ARGS(&Var0, &Local_43, 8, 28000);
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_157()) || Global_105612) || Global_25767) || func_163()) || func_162(8, -1)) || func_144()) || func_161()) || func_155()) || func_156()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_157()) || Global_25767) || func_163()) || func_162(8, -1)) || func_155()) || func_144()) || func_161()) || func_156()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_157()) || Global_105612) || Global_25767) || func_163()) || func_162(8, -1)) || func_155()) || func_144()) || func_161()) || func_156()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_157()) || Global_105612) || Global_25767) || func_163()) || func_162(8, -1)) || func_144()) || func_161()) || func_156()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_157() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_162(8, -1)) || func_156()) || func_160()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_157()) || func_161()) || Global_105612) || Global_25767) || func_163()) || Global_37584) || func_162(8, -1)) || func_155()) || func_160()) || func_156()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_172(var uParam0, var uParam1)
{
	if (!uParam0->f_7)
	{
		if (func_31(26, func_32(uParam0->f_4), 0))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				if ((!func_186() && !IS_AMBIENT_SPEECH_PLAYING(PLAYER_PED_ID())) && !IS_MESSAGE_BEING_DISPLAYED())
				{
					func_185(uParam1, 2, PLAYER_PED_ID(), "TREVOR", 0, 1);
...
int func_196()
{
	...
	func_195(&uVar0, GET_CLOCK_SECONDS());
	func_194(&uVar0, GET_CLOCK_MINUTES());
	func_193(&uVar0, GET_CLOCK_HOURS());
	func_191(&uVar0, GET_CLOCK_DAY_OF_MONTH());
	func_192(&uVar0, GET_CLOCK_MONTH());
	func_190(&uVar0, GET_CLOCK_YEAR());
	return uVar0;
}
...
void func_201(int iParam0)
{
	...
	else if (IS_BIT_SET(Global_106565.f_20558.f_471, iParam0) || IS_BIT_SET(Global_2097152[func_203() /*10778*/].f_6165.f_10, iParam0))
	{
		bVar0 = true;
		CLEAR_BIT(&(Global_106565.f_20558.f_471), iParam0);
		CLEAR_BIT(&(Global_2097152[func_203() /*10778*/].f_6165.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		_SET_NOTIFICATION_TEXT_ENTRY("COUP_RED");
		ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_202(iParam0));
...
int func_207(int iParam0)
{
	...
	return IS_BIT_SET(Global_2097152[func_203() /*10778*/].f_6165.f_10, iParam0);
}
...
int func_219(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (IS_PLAYER_PLAYING(PLAYER_ID()))
	{
		...
		{
			if (IS_BIT_SET(iParam0, func_107()) && !IS_BIT_SET(iParam4, 19))
			{
				return 0;
			}
		}
	...
	{
		if (!IS_BIT_SET(iParam0, func_107()))
		{
			return 0;
		}
	}
	...
	if (iParam3 != -1)
	{
		if (func_221(PLAYER_PED_ID(), iParam3, 0))
		{
			return 0;
		}
	}
	...
	if (func_90(iVar4))
	{
		...
		while (iVar25 < 2)
		{
			if (iVar22[iVar25] != 0)
			{
				...
				while (iVar26 < 16)
				{
					if (DOES_ENTITY_EXIST(uVar5[iVar26]))
					{
						if (GET_ENTITY_MODEL(uVar5[iVar26]) == iVar22[iVar25])
						{
							if (!IS_ENTITY_DEAD(uVar5[iVar26], 0))
							{
								if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
								{
									if (VDIST2(GET_ENTITY_COORDS(uVar5[iVar26], 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) < 6400f)
									{
										return 0;
									}
								}
				...
				if (DOES_ENTITY_EXIST(iVar27))
				{
					if (!IS_ENTITY_DEAD(PLAYER_PED_ID(), 0))
					{
						if (VDIST2(GET_ENTITY_COORDS(iVar27, 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) < 6400f)
						{
							return 0;
						}
					}
...
int func_221(var uParam0, int iParam1, float fParam2)
{
	...
	if (!IS_ENTITY_DEAD(uParam0, 0))
	{
		...
		if (GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(uParam0, 1), Var0, 1) < fVar5)
		{
			return 1;
		}
		else if (Var0.f_4 != -1)
		{
			return func_221(uParam0, Var0.f_4, fParam2);
		}
	}
	return 0;
}
...
float func_222(var uParam0)
{
	if (func_225(uParam0))
	{
		...
		{
			return (func_223(IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
void func_230(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, vector3 vParam7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_239()
{
	...
	vVar0 = { func_240(GET_PLAYER_INDEX()) };
	fVar3 = Local_43.f_3;
	if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
	{
...
void func_242()
{
	...
	if (iLocal_225 != 0)
	{
		...
		{
			case 1:
				uLocal_220 = REQUEST_SCALEFORM_MOVIE("MIDSIZED_MESSAGE");
				iLocal_225 = 2;
				break;
			...
			case 2:
				...
				{
					BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_220, "SHOW_SHARD_MIDSIZED_MESSAGE");
					BEGIN_TEXT_COMMAND_SCALEFORM_STRING("BBS_MP");
					END_TEXT_COMMAND_SCALEFORM_STRING();
					BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sVar0);
					ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(sLocal_224);
					END_TEXT_COMMAND_SCALEFORM_STRING();
			...
			case 3:
				if (HAS_SCALEFORM_MOVIE_LOADED(uLocal_220))
				{
					DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_220, 255, 255, 255, 255, 0);
				...
				if ((GET_GAME_TIMER() - iLocal_223) > 7000)
				{
					if (!iLocal_52)
					{
						BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_220, "SHARD_ANIM_OUT");
				...
				if ((GET_GAME_TIMER() - iLocal_223) > 7500)
				{
					iLocal_225 = 4;
				}
				break;
...
void func_245()
{
	if (Global_106565.f_24980.f_1 == 0)
	{
		...
		{
			CLEAR_BIT(&(Global_106565.f_24980), 0);
			CLEAR_BIT(&(Global_106565.f_24980), 1);
			CLEAR_BIT(&(Global_106565.f_24980), 2);
			CLEAR_BIT(&(Global_106565.f_24980), 3);
			CLEAR_BIT(&(Global_106565.f_24980), 4);
			CLEAR_BIT(&(Global_106565.f_24980), 5);
			CLEAR_BIT(&(Global_106565.f_24980), 6);
			CLEAR_BIT(&(Global_106565.f_24980), 7);
			CLEAR_BIT(&(Global_106565.f_24980), 8);
			CLEAR_BIT(&(Global_106565.f_24980), 9);
			iLocal_218 = func_196();
			func_188(&iLocal_218, 0, 0, 1, 0, 0, 0);
			Global_106565.f_24980.f_3 = iLocal_218;
			Global_106565.f_24980.f_2 = 4;
		}
	}
