...
void __EntryFunction__()
{
			...
			while (iVar0 < iLocal_51)
			{
				if (!IS_PED_INJURED(iLocal_51[iVar0]))
				{
					if (IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
					{
						...
						{
							TASK_ENTER_VEHICLE(iLocal_51[iVar0], iLocal_54, -1, func_243(iLocal_54), 1073741824, 1, 0);
						}
					}
					else
					{
	...
	func_182();
	uLocal_65 = ADD_SCENARIO_BLOCKING_AREA(vLocal_77 + Vector(30f, 30f, 30f), vLocal_77 - Vector(30f, 30f, 30f), 0, 1, 1, 1);
	while (true)
	{
		WAIT(0);
		func_179(&uLocal_317);
		if (!func_178())
		{
			...
			{
				case 0:
					if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() && !func_165())
					{
						if (func_156())
						{
							if ((iLocal_46 == 3 && !(IS_SPHERE_VISIBLE(vLocal_77, 3f) && func_155(PLAYER_PED_ID(), vLocal_77, 1) < 150f)) || iLocal_46 != 3)
							{
								if (iLocal_46 == 3)
								{
									if (!IS_SPHERE_VISIBLE(vLocal_77, 8f))
									{
										CLEAR_AREA(vLocal_77, 4f, 1, 0, 0, 0);
									}
									iLocal_48 = 4;
									bLocal_109 = true;
								}
				...
				case 2:
					...
					if (DOES_ENTITY_EXIST(iLocal_54) && !IS_PED_INJURED(PLAYER_PED_ID()))
					{
						...
						{
							func_143();
							if (!IS_ENTITY_OCCLUDED(iLocal_54) && (VDIST(GET_ENTITY_COORDS(iLocal_54, 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) < 100f || func_153()))
							{
								func_134(1);
							}
						}
						else if (((!IS_ENTITY_OCCLUDED(iLocal_54) && iLocal_48 == 4) || IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), vLocal_96, vLocal_99, fLocal_102, 0, 1, 0)) || func_153())
						{
							func_134(1);
						}
		...
		else
		{
			...
			if (!DOES_BLIP_EXIST(uLocal_63))
			{
				...
				if (DOES_ENTITY_EXIST(uLocal_56))
				{
					if (iLocal_511 != 0)
					{
						if (VDIST2(GET_ENTITY_COORDS(uLocal_56, 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) < POW(50f, 2f))
						{
							iLocal_511 = 0;
				...
				else if (((bLocal_109 && !DOES_PICKUP_EXIST(uLocal_137)) && IS_VEHICLE_DRIVEABLE(iLocal_54, 0)) && !bLocal_121)
				{
					if (iLocal_511 != 1)
					{
				...
				else if (DOES_PICKUP_EXIST(uLocal_137))
				{
					if (iLocal_511 != 2)
					{
						if (VDIST2(GET_PICKUP_COORDS(uLocal_137), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) < POW(50f, 2f))
						{
							iLocal_511 = 2;
							func_130(&uLocal_305, 0, 0);
						}
				...
				{
					if (DOES_PICKUP_EXIST(uLocal_137))
					{
						func_98(&uLocal_305, GET_PICKUP_COORDS(uLocal_137), 0, 0, 1, 1, 1);
						if (VDIST2(GET_PICKUP_COORDS(uLocal_137), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) > POW(50f, 2f))
						{
							iLocal_511 = -1;
							func_130(&uLocal_305, 0, 0);
				...
				if (((!IS_ENTITY_DEAD(iLocal_54, 0) && bLocal_109) && !bLocal_111) && (!func_133(0) || (HAS_PED_GOT_WEAPON(PLAYER_PED_ID(), joaat("weapon_stickybomb"), 0) && !func_133(1))))
				{
					switch (iLocal_134)
					{
						case 0:
			...
			if ((((IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && !IS_PED_INJURED(PLAYER_PED_ID())) && GET_PED_IN_VEHICLE_SEAT(iLocal_54, -1, 0) == PLAYER_PED_ID()) && !bLocal_113) && iLocal_48 != 8)
			{
				if (bLocal_109)
				{
					func_62(8);
			...
			if (bLocal_110)
			{
				if (GET_RELATIONSHIP_BETWEEN_GROUPS(uLocal_66, 1862763509) != 5)
				{
					SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_66, 1862763509);
					SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, uLocal_66);
				}
			}
			if (bLocal_111)
			{
				if ((DOES_PICKUP_EXIST(uLocal_137) && !IS_PED_INJURED(PLAYER_PED_ID())) && VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_PICKUP_COORDS(uLocal_137)) > 250f)
				{
					func_62(9);
				}
			}
		...
		{
			if (GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_54, 0) > 0f || GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_54, 1) > 0f)
			{
		...
		if (DOES_ENTITY_EXIST(uLocal_56))
		{
			...
			while (iVar5 < iLocal_51)
			{
				...
				{
					if (IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_56, iLocal_51[iVar5]))
					{
						if (iLocal_48 == 1)
						{
							if (!iLocal_512[iVar5])
							{
								SET_PED_ALTERNATE_MOVEMENT_ANIM(iLocal_51[iVar5], 0, "random@security_van", "sec_idle", 1090519040, 1);
								SET_PED_ALTERNATE_MOVEMENT_ANIM(iLocal_51[iVar5], 1, "random@security_van", "sec_walk_calm", 1090519040, 1);
								iLocal_512[iVar5] = 1;
							}
						}
						if (iLocal_48 == 7)
						{
							...
							{
								SET_PED_ALTERNATE_MOVEMENT_ANIM(iLocal_51[iVar5], 0, "random@security_van", "sec_idle", 1090519040, 1);
								SET_PED_ALTERNATE_MOVEMENT_ANIM(iLocal_51[iVar5], 1, "random@security_van", "sec_walk_panic", 1090519040, 1);
								iLocal_515[iVar5] = 1;
							}
						}
						if (IS_PED_ARMED(iLocal_51[iVar5], 4) && !iLocal_115)
						{
							HIDE_PED_WEAPON_FOR_SCRIPTED_CUTSCENE(iLocal_51[iVar5], 1);
							iLocal_115 = 1;
						}
					}
					else
					{
						if (iLocal_512[iVar5])
						{
							CLEAR_PED_ALTERNATE_MOVEMENT_ANIM(iLocal_51[iVar5], 0, -1056964608);
							CLEAR_PED_ALTERNATE_MOVEMENT_ANIM(iLocal_51[iVar5], 1, -1056964608);
							iLocal_512[iVar5] = 0;
						}
						if (iLocal_515[iVar5])
						{
...
int func_2()
{
	...
	fVar0 = 50f;
	if (((!IS_PED_INJURED(PLAYER_PED_ID()) && (((IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && bLocal_114) && DOES_PICKUP_EXIST(uLocal_137)) || (!IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && DOES_PICKUP_EXIST(uLocal_137)))) && VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(iLocal_54, 1)) < 20f) && VDIST(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_PICKUP_COORDS(uLocal_137)) < 20f)
	{
		uVar1 = GET_RANDOM_PED_AT_COORD(GET_ENTITY_COORDS(PLAYER_PED_ID(), 0), fVar0, fVar0, fVar0, -1);
		if (!IS_PED_INJURED(uVar1))
		{
			if (GET_ENTITY_MODEL(uVar1) == joaat("s_m_y_cop_01") || GET_ENTITY_MODEL(uVar1) == joaat("s_f_y_cop_01"))
			{
				return 1;
			}
		}
...
void func_23()
{
	if (!bLocal_121)
	{
		if (!bLocal_109)
		{
			if (DOES_ENTITY_EXIST(uLocal_56))
			{
				if (!IS_ENTITY_ATTACHED(uLocal_56))
				{
					DELETE_OBJECT(&uLocal_56);
					if (!DOES_PICKUP_EXIST(uLocal_137) && !bLocal_111)
					{
						func_24(0f, 0f, 0f, 0);
					}
				}
			...
			{
				if (IS_PED_INJURED(iLocal_51[iLocal_130]) || ((!IS_PED_INJURED(iLocal_51[iLocal_130]) && IS_PED_RAGDOLL(iLocal_51[iLocal_130])) && !bLocal_111))
				{
					func_24(0f, 0f, 0f, 0);
				}
			}
...
void func_24(vector3 vParam0, bool bParam3)
{
	if (!bLocal_121 && !bLocal_111)
	{
		if (!bParam3)
		{
			if (bLocal_109)
			{
				vParam0 = { GET_SAFE_PICKUP_COORDS(GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, 0f, -3.3f, 0f), 1067030938, 1069547520) };
			}
			else
			{
				vParam0 = { GET_SAFE_PICKUP_COORDS(GET_ENTITY_COORDS(iLocal_51[iLocal_130], 0), 1067030938, 1069547520) };
			}
		}
		SET_BIT(&uLocal_138, 3);
		SET_BIT(&uLocal_138, 4);
		SET_BIT(&uLocal_138, 1);
		if (bParam3)
		{
			uLocal_137 = CREATE_PICKUP_ROTATE(joaat("pickup_money_security_case"), vParam0, GET_ENTITY_ROTATION(uLocal_56, 2), 0, uLocal_128, 2, 1, 0);
		}
		else
		{
			uLocal_137 = CREATE_PICKUP(joaat("pickup_money_security_case"), vParam0, uLocal_138, uLocal_128, 1, 0);
		}
...
int func_26(var uParam0)
{
	...
	SET_BLIP_SCALE(uVar0, func_27(NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
	return uVar0;
}
...
void func_28()
{
	...
	switch (iLocal_49)
	{
		...
		case 1:
			if (GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_54, 2) == 0f && GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_54, 3) == 0f)
			{
				if (DOES_ENTITY_EXIST(uLocal_56))
				{
					...
					ATTACH_ENTITY_TO_ENTITY(uLocal_56, iLocal_54, 0, vLocal_81, vLocal_84, 0, 0, 0, 0, 2, 1);
					iLocal_49 = 2;
				}
			}
			break;
					...
					if (((IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_54, 2) > 0.25f) && GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_54, 3) > 0.25f) || !IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
					{
						if (DOES_ENTITY_EXIST(uLocal_56))
						{
							if (IS_ENTITY_ATTACHED(uLocal_56))
							{
								...
								DETACH_ENTITY(uLocal_56, 1, 0);
								SET_ENTITY_COLLISION(uLocal_56, 1, 0);
								ACTIVATE_PHYSICS(uLocal_56);
								SET_ACTIVATE_OBJECT_PHYSICS_AS_SOON_AS_IT_IS_UNFROZEN(uLocal_56, 1);
								vLocal_477 = { GET_ENTITY_COORDS(uLocal_56, 1) - GET_ENTITY_COORDS(iLocal_54, 1) * Vector(1.5f, 1.5f, 1.5f) };
								...
								APPLY_FORCE_TO_ENTITY(uLocal_56, 1, 0f, 1f, 5f, 0f, 0f, 0f, 0, 1, 1, 1, 0, 1);
								iLocal_476 = GET_GAME_TIMER();
							}
							else if (_0x7F8F6405F4777AF6(GET_ENTITY_COORDS(uLocal_56, 1), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, vLocal_470), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, vLocal_473), 0) >= 1f)
							{
								iLocal_49 = 3;
								iLocal_123[0] = 0;
								iLocal_123[1] = 0;
		...
		case 3:
			...
			if (DOES_ENTITY_EXIST(uLocal_56) && !DOES_PICKUP_EXIST(uLocal_137))
			{
				if (GET_ENTITY_SPEED(uLocal_56) == 0f && (GET_GAME_TIMER() - iLocal_476) > 1000)
				{
					func_24(GET_ENTITY_COORDS(uLocal_56, 1), 1);
					DELETE_OBJECT(&uLocal_56);
				}
				else if ((GET_GAME_TIMER() - iLocal_476) > 5000)
				{
...
int func_30()
{
	...
	if (DOES_ENTITY_EXIST(uLocal_57) && IS_ENTITY_ATTACHED(uLocal_57))
	{
		if (!iLocal_466)
		{
			if (_IS_PROJECTILE_TYPE_IN_RADIUS(GET_ENTITY_COORDS(uLocal_57, 1), joaat("weapon_stickybomb"), 0.25f, 0) || DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(GET_ENTITY_COORDS(uLocal_57, 1), 0.3f, GET_WEAPONTYPE_MODEL(joaat("weapon_stickybomb")), 0))
			{
				iLocal_466 = 1;
			}
		}
		iVar0 = 0;
		DRAW_DEBUG_SPHERE(GET_ENTITY_COORDS(uLocal_57, 1), 0.1f, 255, 0, 0, 255);
		if (func_31(0f, 0f, 0f, 0f, 0f, 0f, GET_ENTITY_COORDS(uLocal_57, 1), 1f, 1) || (IS_EXPLOSION_IN_SPHERE(2, GET_ENTITY_COORDS(uLocal_57, 1), 0.3f) && iLocal_466))
		{
			iLocal_117 = 1;
			iVar0 = 1;
		}
		if (GET_ENTITY_HEALTH(uLocal_57) < iLocal_132 && HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_57, PLAYER_PED_ID(), 0))
		{
			iLocal_133 = (iLocal_133 + (iLocal_132 - GET_ENTITY_HEALTH(uLocal_57)));
			CLEAR_ENTITY_LAST_DAMAGE_ENTITY(uLocal_57);
		}
		...
		iLocal_132 = GET_ENTITY_HEALTH(uLocal_57);
	}
	return 0;
}
...
int func_31(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, bool bParam10)
{
	...
	{
		if ((((((((((((((((((((((IS_EXPLOSION_IN_AREA(5, vParam3, vParam0) || (IS_EXPLOSION_IN_AREA(2, vParam3, vParam0) && !bParam10)) || (IS_EXPLOSION_IN_AREA(20, vParam3, vParam0) && !bParam10)) || IS_EXPLOSION_IN_AREA(4, vParam3, vParam0)) || (IS_EXPLOSION_IN_AREA(28, vParam3, vParam0) && !bParam10)) || IS_EXPLOSION_IN_AREA(32, vParam3, vParam0)) || IS_EXPLOSION_IN_AREA(25, vParam3, vParam0)) || IS_EXPLOSION_IN_AREA(9, vParam3, vParam0)) || (IS_EXPLOSION_IN_AREA(3, vParam3, vParam0) && !bParam10)) || (IS_EXPLOSION_IN_AREA(6, vParam3, vParam0) && !bParam10)) || IS_EXPLOSION_IN_AREA(0, vParam3, vParam0)) || IS_EXPLOSION_IN_AREA(1, vParam3, vParam0)) || IS_EXPLOSION_IN_AREA(23, vParam3, vParam0)) || IS_EXPLOSION_IN_AREA(34, vParam3, vParam0)) || IS_EXPLOSION_IN_AREA(14, vParam3, vParam0)) || (IS_EXPLOSION_IN_AREA(30, vParam3, vParam0) && !bParam10)) || (IS_EXPLOSION_IN_AREA(12, vParam3, vParam0) && !bParam10)) || IS_EXPLOSION_IN_AREA(7, vParam3, vParam0)) || (IS_EXPLOSION_IN_AREA(21, vParam3, vParam0) && !bParam10)) || (IS_EXPLOSION_IN_AREA(18, vParam3, vParam0) && !bParam10)) || IS_EXPLOSION_IN_AREA(15, vParam3, vParam0)) || IS_EXPLOSION_IN_AREA(10, vParam3, vParam0)) || IS_EXPLOSION_IN_AREA(27, vParam3, vParam0))
		{
			iVar0 = 1;
		}
	}
	else if ((((((((((((((((((((((IS_EXPLOSION_IN_SPHERE(5, vParam6, iParam9) || (IS_EXPLOSION_IN_SPHERE(2, vParam6, iParam9) && !bParam10)) || (IS_EXPLOSION_IN_SPHERE(20, vParam6, iParam9) && !bParam10)) || IS_EXPLOSION_IN_SPHERE(4, vParam6, iParam9)) || (IS_EXPLOSION_IN_SPHERE(28, vParam6, iParam9) && !bParam10)) || IS_EXPLOSION_IN_SPHERE(32, vParam6, iParam9)) || IS_EXPLOSION_IN_SPHERE(25, vParam6, iParam9)) || IS_EXPLOSION_IN_SPHERE(9, vParam6, iParam9)) || (IS_EXPLOSION_IN_SPHERE(3, vParam6, iParam9) && !bParam10)) || (IS_EXPLOSION_IN_SPHERE(6, vParam6, iParam9) && !bParam10)) || IS_EXPLOSION_IN_SPHERE(0, vParam6, iParam9)) || IS_EXPLOSION_IN_SPHERE(1, vParam6, iParam9)) || IS_EXPLOSION_IN_SPHERE(23, vParam6, iParam9)) || IS_EXPLOSION_IN_SPHERE(34, vParam6, iParam9)) || IS_EXPLOSION_IN_SPHERE(14, vParam6, iParam9)) || (IS_EXPLOSION_IN_SPHERE(30, vParam6, iParam9) && !bParam10)) || (IS_EXPLOSION_IN_SPHERE(12, vParam6, iParam9) && !bParam10)) || IS_EXPLOSION_IN_SPHERE(7, vParam6, iParam9)) || (IS_EXPLOSION_IN_SPHERE(21, vParam6, iParam9) && !bParam10)) || (IS_EXPLOSION_IN_SPHERE(18, vParam6, iParam9) && !bParam10)) || IS_EXPLOSION_IN_SPHERE(15, vParam6, iParam9)) || IS_EXPLOSION_IN_SPHERE(10, vParam6, iParam9)) || IS_EXPLOSION_IN_SPHERE(27, vParam6, iParam9))
	{
		iVar0 = 1;
	}
	return iVar0;
...
void func_33()
{
	...
	if (!DOES_BLIP_EXIST(uLocal_63))
	{
		if (!bLocal_110)
		{
			if ((!IS_PED_INJURED(iLocal_51[1]) && IS_VEHICLE_DRIVEABLE(iLocal_54, 0)) && !bLocal_121)
			{
				if (!bLocal_109)
				{
		...
		else
		{
			...
			if (DOES_BLIP_EXIST(uLocal_59) && GET_BLIP_HUD_COLOUR(uLocal_59) != 119)
			{
				REMOVE_BLIP(&uLocal_59);
			}
			if (IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
			...
			else if (DOES_BLIP_EXIST(uLocal_59))
			{
				REMOVE_BLIP(&uLocal_59);
			}
			if ((IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && DOES_BLIP_EXIST(uLocal_59)) && !IS_PED_INJURED(PLAYER_PED_ID()))
			{
				if (IS_PED_IN_VEHICLE(PLAYER_PED_ID(), iLocal_54, 0))
				{
					if (GET_BLIP_ALPHA(uLocal_59) != 0)
					{
						SET_BLIP_ALPHA(uLocal_59, 0);
					}
				}
				else if (GET_BLIP_ALPHA(uLocal_59) != 255)
				{
					SET_BLIP_ALPHA(uLocal_59, 255);
				}
			}
			iVar0 = 0;
			while (iVar0 < iLocal_51)
			{
				...
				{
					if (!DOES_PICKUP_EXIST(uLocal_137) && !IS_PED_IN_ANY_VEHICLE(iLocal_51[iVar0], 0))
					{
			...
			if (DOES_PICKUP_EXIST(uLocal_137) && !bLocal_121)
			{
				if (!DOES_BLIP_EXIST(uLocal_64))
				{
			...
			else if (DOES_BLIP_EXIST(uLocal_64))
			{
	...
	if (DOES_BLIP_EXIST(uLocal_59))
	{
		_0x75A16C3DA34F1245(uLocal_59, iLocal_122);
	}
	if (DOES_BLIP_EXIST(uLocal_64))
	{
		_0x75A16C3DA34F1245(uLocal_64, iLocal_122);
	}
	if (!iLocal_122)
	{
...
int func_35(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		SET_BLIP_SCALE(uVar0, func_27(NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
...
int func_61()
{
	if (bLocal_111)
	{
		if (HAS_PICKUP_BEEN_COLLECTED(uLocal_137))
		{
			return 1;
		}
	}
...
int func_63()
{
	if (!DOES_PICKUP_EXIST(uLocal_137))
	{
		...
		if (iLocal_465 != -1)
		{
			if ((GET_GAME_TIMER() - iLocal_465) > 3000)
			{
				...
				SET_ENTITY_COLLISION(iLocal_54, 1, 0);
	...
	else
	{
		...
		if (!IS_PED_INJURED(PLAYER_PED_ID()) && VDIST(GET_PICKUP_COORDS(uLocal_137), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) > 300f)
		{
			return 1;
		}
	}
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		switch (iLocal_50)
		{
			case 0:
				...
				while (iVar0 < iLocal_51)
				{
					if (!IS_PED_INJURED(iLocal_51[iVar0]) && DOES_ENTITY_EXIST(uLocal_56))
					{
						if ((iVar0 != iLocal_130 || bLocal_109) || !IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_56, iLocal_51[iVar0]))
						{
							CLEAR_PED_TASKS(iLocal_51[iVar0]);
							OPEN_SEQUENCE_TASK(&uLocal_58);
							if (IS_PED_IN_ANY_VEHICLE(iLocal_51[iVar0], 0))
							{
								if (iLocal_117)
								{
									...
									{
										SET_PED_MOVEMENT_CLIPSET(iLocal_51[iVar0], "move_injured_generic", 1048576000);
										iLocal_118[iVar0] = 1;
									}
								}
							...
							CLOSE_SEQUENCE_TASK(uLocal_58);
							TASK_PERFORM_SEQUENCE(iLocal_51[iVar0], uLocal_58);
							CLEAR_SEQUENCE_TASK(&uLocal_58);
						}
						SET_PED_COMBAT_ATTRIBUTES(iLocal_51[iVar0], 6, 0);
						SET_PED_COMBAT_ATTRIBUTES(iLocal_51[iVar0], 0, 1);
						SET_PED_COMBAT_ATTRIBUTES(iLocal_51[iVar0], 1, 0);
						SET_PED_COMBAT_MOVEMENT(iLocal_51[iVar0], 1);
						SET_PED_TARGET_LOSS_RESPONSE(iLocal_51[iVar0], 1);
						SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_51[iVar0], 1);
					}
					iVar0++;
				}
				if ((DOES_ENTITY_EXIST(uLocal_56) && IS_ENTITY_ATTACHED(uLocal_56)) && !IS_PED_INJURED(iLocal_51[iLocal_130]))
				{
			...
			case 1:
				if (func_70(iLocal_130))
				{
					if (!IS_PED_INJURED(iLocal_51[iLocal_130]))
					{
						...
						TASK_COMBAT_PED(0, PLAYER_PED_ID(), 0, 16);
						CLOSE_SEQUENCE_TASK(uLocal_58);
						TASK_PERFORM_SEQUENCE(iLocal_51[iLocal_130], uLocal_58);
						CLEAR_SEQUENCE_TASK(&uLocal_58);
					}
					iLocal_50++;
				}
				...
				if (!IS_PED_INJURED(iLocal_51[0]) || !IS_PED_INJURED(iLocal_51[1]))
				{
					...
					while (iVar0 < iLocal_51)
					{
						if (!IS_PED_INJURED(iLocal_51[iVar0]))
						{
							...
							if (((DOES_PICKUP_EXIST(uLocal_137) && !iLocal_123[iVar0]) && iLocal_49 == 3) && !bLocal_121)
							{
								_0xE4723DB6E736CCFF(iLocal_51[iVar0], iLocal_54, GET_PICKUP_COORDS(uLocal_137), 5f, 0);
								iLocal_123[iVar0] = 1;
							}
							if (bLocal_121)
							{
		...
		while (iVar0 < iLocal_51)
		{
			if (!IS_PED_INJURED(iLocal_51[iVar0]))
			{
				...
				{
					RESET_PED_MOVEMENT_CLIPSET(iLocal_51[iVar0], 1048576000);
					iLocal_118[iVar0] = 0;
				}
			}
			iVar0++;
...
bool func_70(int iParam0)
{
	...
	if (DOES_ENTITY_EXIST(uLocal_56))
	{
		...
		{
			if (IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_56, iLocal_51[iParam0]))
			{
				...
				{
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_51[iParam0], 1);
					TASK_PLAY_ANIM(iLocal_51[iParam0], "weapons@holster_1h", "holster", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
				}
			}
		}
	}
	bVar0 = (!DOES_ENTITY_EXIST(uLocal_56) || (DOES_ENTITY_EXIST(uLocal_56) && !IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_56, iLocal_51[iParam0])));
	if (bVar0)
	{
		if (!IS_PED_INJURED(iLocal_51[iParam0]))
		{
			SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_51[iParam0], 0);
		}
	}
	return bVar0;
}
...
void func_71(int iParam0, bool bParam1)
{
	...
	if (IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		if (bVar13)
		{
			...
			while (iVar12 < iLocal_51)
			{
				if ((((((!IS_PED_INJURED(iLocal_51[iVar12]) && !IS_PED_INJURED(PLAYER_PED_ID())) && VDIST(GET_ENTITY_COORDS(iLocal_51[iVar12], 1), vVar5[iVar12 /*3*/]) > 2f) && (GET_GAME_TIMER() - uLocal_504[iVar12]) > 1000) && !IS_PED_IN_ANY_VEHICLE(iLocal_51[iVar12], 0)) && !iLocal_481[iVar12]) && (iParam0 == -1 || iParam0 == iVar12))
				{
					if (bParam1)
					{
						if (func_66())
						...
						OPEN_SEQUENCE_TASK(&uVar14);
						if (func_66() || func_32(vLocal_501))
						{
							TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vVar5[iVar12 /*3*/], PLAYER_PED_ID(), 2f, 0, 1056964608, 1082130432, 1, 0, 0, -957453492, 20000);
							TASK_AIM_GUN_AT_ENTITY(0, PLAYER_PED_ID(), -1, 1);
						}
						else
						{
							TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, vVar5[iVar12 /*3*/], vLocal_501, 2f, 0, 1056964608, 1082130432, 1, 0, 0, -957453492);
							TASK_AIM_GUN_AT_COORD(0, vLocal_501, -1, 1, 0);
						}
						CLOSE_SEQUENCE_TASK(uVar14);
						TASK_PERFORM_SEQUENCE(iLocal_51[iVar12], uVar14);
						CLEAR_SEQUENCE_TASK(&uVar14);
					}
					uLocal_504[iVar12] = GET_GAME_TIMER();
				}
				iVar12++;
			}
		}
...
void func_73(var uParam0)
{
	...
	if (IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
	{
		switch (iLocal_50)
		{
				...
				if (!bLocal_109)
				{
					...
					if (((!IS_PED_INJURED(iLocal_51[1]) && !IS_ENTITY_DEAD(iLocal_51[1], 0)) && !IS_PED_INJURED(iLocal_51[0])) && !IS_ENTITY_DEAD(iLocal_51[0], 0))
					{
						...
						if (DOES_PICKUP_EXIST(uLocal_137))
						{
							if (bLocal_110)
							{
								TASK_FOLLOW_NAV_MESH_TO_COORD(uParam0, GET_PICKUP_COORDS(uLocal_137), 2f, -1, 1048576000, 0, 1193033728);
							}
							else
							{
								TASK_FOLLOW_NAV_MESH_TO_COORD(uParam0, GET_PICKUP_COORDS(uLocal_137), 1f, -1, 1048576000, 0, 1193033728);
							}
							iLocal_50++;
						}
						else
			...
			case 1:
				if (!IS_PED_INJURED(uParam0) && DOES_PICKUP_EXIST(uLocal_137))
				{
					if ((GET_DISTANCE_BETWEEN_COORDS(GET_ENTITY_COORDS(uParam0, 1), GET_PICKUP_COORDS(uLocal_137), 1) < 2f && !IS_PED_RAGDOLL(uParam0)) && (GET_GAME_TIMER() - iLocal_136) > 3000)
					{
						if (IS_PED_ARMED(uParam0, 4))
						{
							SET_CURRENT_PED_WEAPON(uParam0, joaat("weapon_unarmed"), 1);
						}
						REMOVE_PICKUP(uLocal_137);
						func_79(uParam0);
						SET_CURRENT_PED_WEAPON(uParam0, joaat("weapon_unarmed"), 1);
			...
			case 2:
				if (!IS_PED_INJURED(uParam0) && IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
				{
					if (GET_SCRIPT_TASK_STATUS(uParam0, 713668775) != 1)
					{
						if (bLocal_110)
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(uParam0, vLocal_491, 2f, -1, 0.1f, 512, vLocal_488.z);
						}
						else
						{
							TASK_FOLLOW_NAV_MESH_TO_COORD(uParam0, vLocal_491, 1f, -1, 0.1f, 512, vLocal_488.z);
						}
						iLocal_50++;
					}
				}
			...
			case 3:
				if (!IS_PED_INJURED(uParam0))
				{
					...
					else
					{
						...
						if (VDIST(vLocal_491, GET_ENTITY_COORDS(uParam0, 1)) < 0.3f)
						{
							if (ABSF((fVar0 - vLocal_488.z)) < 15f)
							{
								CLEAR_PED_ALTERNATE_WALK_ANIM(uParam0, -1056964608);
								CLEAR_PED_TASKS(uParam0);
								bLocal_496 = true;
								iLocal_494 = CREATE_SYNCHRONIZED_SCENE(vLocal_485, vLocal_488, 2);
								if (bLocal_110)
								{
									TASK_SYNCHRONIZED_SCENE(uParam0, iLocal_494, "random@security_van", "sec_case_into_van_panic", 4f, 4f, 3, 0, 4f, 0);
									PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_54, iLocal_494, "van_case_into_van_panic", "random@security_van", 4f, -1000f, 0, -1000f);
								}
								else
								{
									TASK_SYNCHRONIZED_SCENE(uParam0, iLocal_494, "random@security_van", "sec_case_into_van_calm", 4f, -4f, 3, 0, 4f, 0);
						...
						else if (IS_ENTITY_OCCLUDED(uParam0) && !IS_SPHERE_VISIBLE(vLocal_485, 2f))
						{
							SET_ENTITY_COORDS(uParam0, vLocal_485, 1, 0, 0, 1);
						}
					}
				}
				break;
			...
			case 4:
				if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_494))
				{
					...
					if (!bLocal_109)
					{
						if ((DOES_ENTITY_EXIST(uLocal_56) && IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_56, uParam0)) && GET_SYNCHRONIZED_SCENE_PHASE(iLocal_494) > fLocal_508)
						{
							if (!IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_56, iLocal_54))
							{
								DETACH_ENTITY(uLocal_56, 1, 1);
								SET_ENTITY_COLLISION(uLocal_56, 0, 0);
								ATTACH_ENTITY_TO_ENTITY(uLocal_56, iLocal_54, 0, GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_54, GET_ENTITY_COORDS(uLocal_56, 1)), 90f, 0f, 0f, 0, 0, 0, 0, 2, 1);
							}
							bLocal_109 = true;
						}
					}
...
int func_74(var uParam0)
{
	...
	iVar0 = 0;
	if (DOES_ENTITY_EXIST(uParam0) && DOES_ENTITY_EXIST(iLocal_54))
	{
		uVar59 = 4;
		GET_MODEL_DIMENSIONS(GET_ENTITY_MODEL(uParam0), &Var1, &Var4);
		vVar7[0 /*3*/] = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, Var1, Var4.f_1, 0f) };
		vVar7[1 /*3*/] = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, Var4, Var4.f_1, 0f) };
		vVar7[2 /*3*/] = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, Var4, Var1.f_1, 0f) };
		vVar7[3 /*3*/] = { GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, Var1, Var1.f_1, 0f) };
		fVar72 = -3.7f;
		fVar73 = 1.35f;
...
void func_79(var uParam0)
{
	if (!IS_PED_INJURED(uParam0))
	{
		if (!DOES_ENTITY_EXIST(uLocal_56))
		{
			uLocal_56 = CREATE_OBJECT(iLocal_105, vLocal_77, 1, 1, 0);
			SET_ENTITY_CAN_BE_DAMAGED(uLocal_56, 0);
		}
		if (DOES_ENTITY_EXIST(uLocal_56))
		{
			ATTACH_ENTITY_TO_ENTITY(uLocal_56, uParam0, GET_PED_BONE_INDEX(uParam0, 28422), vLocal_90, vLocal_93, 1, 0, 0, 0, 2, 1);
		}
	}
}
...
void func_80()
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			if (IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
			{
				if (DOES_ENTITY_EXIST(func_83()))
				{
					...
					{
						if (GET_PED_IN_VEHICLE_SEAT(iLocal_54, -1, 0) != func_83() && IS_VEHICLE_SEAT_FREE(iLocal_54, -1, 0))
						{
				...
				{
					if (GET_PED_IN_VEHICLE_SEAT(iLocal_54, 0, 0) != iLocal_51[1] && IS_VEHICLE_SEAT_FREE(iLocal_54, 0, 0))
					{
						TASK_ENTER_VEHICLE(iLocal_51[1], iLocal_54, -1, 0, 1073741824, 1, 0);
					}
				}
				iLocal_50++;
			}
		...
		case 2:
			if (func_81())
			{
				if (DOES_ENTITY_EXIST(func_83()))
				{
					TASK_VEHICLE_MISSION(func_83(), iLocal_54, 0, 5, 0f, 786484, 100f, 100f, 1);
					iLocal_50++;
				}
			}
			break;
	...
	if ((DOES_ENTITY_EXIST(iLocal_54) && DOES_ENTITY_EXIST(GET_PED_IN_VEHICLE_SEAT(iLocal_54, -1, 0))) && (IS_ENTITY_DEAD(GET_PED_IN_VEHICLE_SEAT(iLocal_54, -1, 0), 0) || IS_PED_INJURED(GET_PED_IN_VEHICLE_SEAT(iLocal_54, -1, 0))))
	{
		iVar1 = 0;
		if (GET_PED_IN_VEHICLE_SEAT(iLocal_54, -1, 0) == iLocal_51[0])
		{
			iVar1 = 1;
		}
		if (VDIST2(GET_ENTITY_COORDS(iLocal_54, 1), GET_ENTITY_COORDS(PLAYER_PED_ID(), 1)) > 100f)
		{
			...
			{
				SET_PED_FLEE_ATTRIBUTES(iLocal_51[iVar1], 2, 1);
				OPEN_SEQUENCE_TASK(&uVar2);
				TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(0, iLocal_54, 0);
				TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_54, PLAYER_PED_ID(), 8, 50f, 786484, 100f, 5f, 1);
				CLOSE_SEQUENCE_TASK(uVar2);
				TASK_PERFORM_SEQUENCE(iLocal_51[iVar1], uVar2);
	...
	if (((((((!IS_VEHICLE_DRIVEABLE(iLocal_54, 0) || DOES_PICKUP_EXIST(uLocal_137)) || iLocal_49 == 3) || IS_VEHICLE_STUCK_TIMER_UP(iLocal_54, 0, 7000)) || IS_VEHICLE_STUCK_TIMER_UP(iLocal_54, 3, 30000)) || IS_VEHICLE_STUCK_TIMER_UP(iLocal_54, 2, 30000)) || IS_VEHICLE_STUCK_TIMER_UP(iLocal_54, 1, 40000)) || (iLocal_50 > 1 && !func_82()))
	{
		if (!func_82())
		{
		}
...
int func_81()
{
	if (DOES_ENTITY_EXIST(iLocal_54))
	{
		if (!IS_ENTITY_DEAD(iLocal_54, 0))
		{
			if (((((GET_ENTITY_HEALTH(iLocal_54) < 300 || GET_VEHICLE_ENGINE_HEALTH(iLocal_54) < 200f) || (IS_VEHICLE_TYRE_BURST(iLocal_54, 0, 0) && IS_VEHICLE_TYRE_BURST(iLocal_54, 1, 0))) || (IS_VEHICLE_TYRE_BURST(iLocal_54, 4, 0) && IS_VEHICLE_TYRE_BURST(iLocal_54, 5, 0))) || (IS_VEHICLE_TYRE_BURST(iLocal_54, 0, 0) && IS_VEHICLE_TYRE_BURST(iLocal_54, 4, 0))) || (IS_VEHICLE_TYRE_BURST(iLocal_54, 1, 0) && IS_VEHICLE_TYRE_BURST(iLocal_54, 5, 0)))
			{
				return 1;
			}
		}
...
void func_84()
{
	...
	switch (iLocal_50)
	{
		case 0:
			if (!bLocal_109)
			{
				if (DOES_ENTITY_EXIST(uLocal_56) && IS_ENTITY_ATTACHED(uLocal_56))
				{
					DETACH_ENTITY(uLocal_56, 1, 1);
				}
			}
			if ((!IS_PED_INJURED(iLocal_51[0]) || !IS_PED_INJURED(iLocal_51[1])) && !IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				while (iVar0 < iLocal_51)
				{
					if (!IS_PED_INJURED(iLocal_51[iVar0]))
					{
						SET_PED_COMBAT_ATTRIBUTES(iLocal_51[iVar0], 17, 1);
						SET_PED_FLEE_ATTRIBUTES(iLocal_51[iVar0], 128, 1);
						SET_PED_FLEE_ATTRIBUTES(iLocal_51[iVar0], 16, 1);
						SET_PED_COMBAT_ATTRIBUTES(iLocal_51[iVar0], 1, 0);
						OPEN_SEQUENCE_TASK(&uVar1);
						if (IS_PED_IN_ANY_VEHICLE(iLocal_51[iVar0], 1))
						{
							TASK_LEAVE_ANY_VEHICLE(iLocal_51[iVar0], 0, 256);
						}
						TASK_SMART_FLEE_PED(0, PLAYER_PED_ID(), 300f, -1, 0, 0);
						CLOSE_SEQUENCE_TASK(uVar1);
						TASK_PERFORM_SEQUENCE(iLocal_51[iVar0], uVar1);
...
void func_87()
{
		...
		switch (iLocal_50)
		{
			case 0:
				if (func_4(&Local_140, cLocal_139, "RESEC_CAR1", 8, 0, 0, 0))
				{
					if (DOES_ENTITY_EXIST(uLocal_56) && IS_ENTITY_ATTACHED(uLocal_56))
					{
						if (!IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_56, iLocal_51[0]))
						{
							func_88(0);
						}
						else
						...
						if (!IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_56, iLocal_51[1]))
						{
							func_88(1);
						}
						else
			...
			case 3:
				if ((TIMERA() > 12000 && !func_67()) && func_4(&Local_140, cLocal_139, "RESEC_CAR3", 8, 0, 0, 0))
				{
					SETTIMERA(0);
					iLocal_50++;
				}
			...
			case 4:
				if ((TIMERA() > 7000 && !func_67()) && func_4(&Local_140, cLocal_139, "RESEC_CAR4", 8, 0, 0, 0))
				{
					SETTIMERA(0);
					func_62(8);
				}
	...
	{
		if (!IS_ENTITY_DEAD(uLocal_55, 0) && IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
		{
			if (VDIST(GET_ENTITY_COORDS(uLocal_55, 1), GET_ENTITY_COORDS(iLocal_54, 1)) > 10f)
			{
				func_62(7);
			}
		}
		if ((IS_ENTITY_DEAD(uLocal_55, 0) || !IS_VEHICLE_DRIVEABLE(uLocal_55, 0)) || (!IS_ENTITY_UPRIGHT(uLocal_55, 1119092736) && !IS_PED_IN_VEHICLE(PLAYER_PED_ID(), uLocal_55, 1)))
		{
...
void func_88(int iParam0)
{
	if (!IS_PED_INJURED(iLocal_51[iParam0]) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		CLOSE_SEQUENCE_TASK(uLocal_58);
		TASK_PERFORM_SEQUENCE(iLocal_51[iParam0], uLocal_58);
		CLEAR_SEQUENCE_TASK(&uLocal_58);
		if (iLocal_131 == 0)
		{
			iLocal_131 = ADD_SHOCKING_EVENT_AT_POSITION(116, GET_ENTITY_COORDS(iLocal_51[iParam0], 1), -1082130432);
		}
	}
}
...
void func_89()
{
	...
	switch (iLocal_50)
	{
		case 0:
			if (!IS_PED_INJURED(iLocal_51[0]))
			{
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_51[0], 1);
			}
			if (!IS_PED_INJURED(iLocal_51[1]))
			{
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_51[1], 1);
			}
			if (func_96())
			{
		...
		case 2:
			if (!func_93())
			{
				if (!func_92(iLocal_54, 1000) && TIMERA() > 10000)
				{
					bVar0 = true;
				}
				else if (TIMERA() > 7000)
				...
				while (iVar1 < iLocal_51)
				{
					if (!func_92(iLocal_51[iVar1], 1000) && (func_21() < 2f && IS_PED_ARMED(PLAYER_PED_ID(), 6)))
					{
						bVar0 = true;
					}
	...
	if ((IS_PED_INJURED(iLocal_51[0]) || IS_PED_INJURED(iLocal_51[1])) || bLocal_121)
	{
		func_62(8);
	}
...
int func_94()
{
	...
	if (IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, 0f, 1.7532f, 0.5984f), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, 0f, 3.3477f, 3.5984f), 2.8f, 0, 1, 0))
		{
			return 1;
		}
		iVar0 = 0;
...
void func_99(var uParam0, vector3 vParam1, var uParam4, int iParam5, bool bParam6, var uParam7, bool bParam8)
{
	...
	else
	{
		if (!IS_STRING_NULL(iVar0))
		{
			if (func_97(iVar0) && IS_HELP_MESSAGE_BEING_DISPLAYED())
			{
				CLEAR_HELP(1);
			}
		}
...
int func_104(char* sParam0)
{
	if (!func_105(1, 1, 0))
	{
		if ((!IS_STRING_NULL_OR_EMPTY(sParam0) && func_97(sParam0)) || func_97("CMN_HINT"))
		{
			CLEAR_HELP(1);
		}
		return 0;
...
int func_105(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_113() || func_112(Global_4456448.f_161209)) || func_111())
	{
		if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			...
			iVar1 = func_110(PLAYER_PED_ID(), 0);
			if (((_0xE33FFA906CE74880(uVar0, iVar1) || (GET_ENTITY_MODEL(uVar0) == joaat("apc") && iVar1 != -1)) || (GET_ENTITY_MODEL(uVar0) == joaat("akula") && iVar1 != -1)) || (((GET_ENTITY_MODEL(uVar0) == joaat("riot2") && iVar1 == 0) && func_109(uVar0, 10)) && GET_VEHICLE_MOD(uVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_106(int iParam0)
{
	if (iParam0 != func_108())
	{
		...
		else if ((Global_1312867 && iParam0 == PLAYER_ID()) && func_107(iParam0, 1, 0))
		{
			return Global_2424047[iParam0 /*416*/].f_309.f_5 != -1;
		}
	}
...
int func_117(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_120(bParam1, bParam2, bParam3) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1) || func_118(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_125(var uParam0, var uParam1, vector3 vParam2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)
{
	...
	if (func_101(uParam1) && IS_ENTITY_VISIBLE(uParam1))
	{
		iVar1 = 0;
...
{
	SET_BIT(&(Global_106565.f_24989.f_6), iParam0);
}
...
{
	return IS_BIT_SET(Global_106565.f_24989.f_6, iParam0);
}
...
int func_137()
{
	switch (func_138(&Global_25824, 0, 5, 0, GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
	...
	switch (iLocal_50)
	{
		case 0:
			if (IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
			{
				if (!IS_PED_INJURED(iLocal_51[0]) && !IS_PED_INJURED(iLocal_51[1]))
				{
					SET_PED_COMBAT_ATTRIBUTES(iLocal_51[0], 6, 1);
					SET_PED_COMBAT_ATTRIBUTES(iLocal_51[1], 6, 1);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_51[0], 1);
					SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_51[1], 1);
					if (IS_PED_IN_VEHICLE(iLocal_51[0], iLocal_54, 0) && IS_PED_IN_VEHICLE(iLocal_51[1], iLocal_54, 0))
					{
						if (iLocal_47 == 2)
						{
							...
							TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_54, -574.6195f, -847.232f, 25.2925f, 10f, 0, joaat("stockade"), 786603, 2f, 4f);
							TASK_VEHICLE_DRIVE_WANDER(0, iLocal_54, 10f, 786603);
							CLOSE_SEQUENCE_TASK(uVar0);
							TASK_PERFORM_SEQUENCE(iLocal_51[0], uVar0);
						...
						{
							OPEN_SEQUENCE_TASK(&uVar1);
							TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_54, -551.2968f, -1119.418f, 20.4011f, 10f, 0, joaat("stockade"), 786603, 2f, 4f);
							TASK_VEHICLE_DRIVE_WANDER(0, iLocal_54, 10f, 786603);
							CLOSE_SEQUENCE_TASK(uVar1);
							TASK_PERFORM_SEQUENCE(iLocal_51[0], uVar1);
							CLEAR_SEQUENCE_TASK(&uVar1);
							iLocal_50++;
						}
						else if (iLocal_47 == 7)
						{
							OPEN_SEQUENCE_TASK(&uVar2);
							TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_54, 2786.752f, 4358.032f, 48.6794f, 10f, 0, joaat("stockade"), 786603, 2f, 4f);
							TASK_VEHICLE_DRIVE_WANDER(0, iLocal_54, 10f, 786603);
							CLOSE_SEQUENCE_TASK(uVar2);
							TASK_PERFORM_SEQUENCE(iLocal_51[0], uVar2);
							CLEAR_SEQUENCE_TASK(&uVar2);
							iLocal_50++;
						}
						else
					...
					else
					{
						...
						{
							TASK_ENTER_VEHICLE(iLocal_51[1], iLocal_54, -1, 0, 1f, 8388608, 0);
						}
					}
				}
			}
	...
	if (iLocal_48 == 4)
	{
		if (!IS_PED_INJURED(PLAYER_PED_ID()))
		{
			...
			if ((iVar4 == joaat("weapon_stickybomb") || iVar4 == joaat("weapon_molotov")) || iVar4 == joaat("weapon_grenade"))
			{
				...
				if ((IS_PED_SHOOTING(PLAYER_PED_ID()) && !IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, 0f, -3.44f, -3f), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, 0f, -13.44f, 3f), 2.3f, 0, 1, 0)) && VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), GET_ENTITY_COORDS(iLocal_54, 1)) < 225f)
				{
					func_62(6);
				}
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, 0f, -3.44f, -3f), GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_54, 0f, -13.44f, 3f), 2.3f, 0, 1, 0))
				{
		...
		if (iLocal_48 != 4)
		{
			if (!IS_PED_INJURED(iLocal_51[0]))
			{
				SET_PED_COMBAT_ATTRIBUTES(iLocal_51[0], 6, 0);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_51[0], 0);
			}
			if (!IS_PED_INJURED(iLocal_51[1]))
			{
				SET_PED_COMBAT_ATTRIBUTES(iLocal_51[1], 6, 0);
				SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_51[1], 0);
			}
		}
	}
}
...
int func_146()
{
	...
	if (IS_VEHICLE_DRIVEABLE(iLocal_54, 0) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		if (DOES_ENTITY_EXIST(uVar0) && DOES_ENTITY_EXIST(iLocal_54))
		{
			return ((IS_VEHICLE_DRIVEABLE(uVar0, 0) && IS_ENTITY_TOUCHING_ENTITY(uVar0, iLocal_54)) && GET_ENTITY_SPEED(uVar0) > 10f);
		}
	}
	return 0;
}
...
void func_148()
{
	...
	if ((!IS_PED_INJURED(iLocal_51[0]) && !IS_PED_INJURED(iLocal_51[1])) && IS_VEHICLE_DRIVEABLE(iLocal_54, 0))
	{
		switch (iLocal_50)
		{
			case 0:
				...
				bLocal_496 = false;
				iLocal_497 = 0;
				SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_54, 1084227584);
				OPEN_SEQUENCE_TASK(&uLocal_58);
				TASK_STAND_STILL(0, 5000);
				TASK_FOLLOW_NAV_MESH_TO_COORD(0, vLocal_491, 1f, -1, 0.1f, 512, vLocal_488.z);
				TASK_ACHIEVE_HEADING(0, vLocal_488.z, 0);
				CLOSE_SEQUENCE_TASK(uLocal_58);
				TASK_PERFORM_SEQUENCE(iLocal_51[1], uLocal_58);
				CLEAR_SEQUENCE_TASK(&uLocal_58);
				iLocal_50++;
				break;
			...
			case 1:
				...
				if (!IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_495))
				{
					if (VDIST2(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), vLocal_77) < 22500f && HAS_COLLISION_LOADED_AROUND_ENTITY(iLocal_54))
					{
						...
						TASK_SYNCHRONIZED_SCENE(iLocal_51[0], iLocal_495, "random@security_van", "driver_idle", 2f, -8f, 13, 0, 1148846080, 0);
						SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_495, 1);
					}
				}
				...
				{
					CLEAR_PED_ALTERNATE_WALK_ANIM(iLocal_51[1], -1056964608);
					CLEAR_PED_TASKS(iLocal_51[1]);
					bLocal_496 = true;
					iLocal_494 = CREATE_SYNCHRONIZED_SCENE(vLocal_485, vLocal_488, 2);
			...
			case 2:
				...
				if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_494))
				{
					if (!bLocal_109)
					{
						if ((DOES_ENTITY_EXIST(uLocal_56) && IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_56, iLocal_51[1])) && GET_SYNCHRONIZED_SCENE_PHASE(iLocal_494) > 0.3793f)
						{
							if (!IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_56, iLocal_54))
							{
								DETACH_ENTITY(uLocal_56, 1, 1);
			...
			case 3:
				...
				if (!iLocal_497)
				{
					if ((IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_494) && GET_SYNCHRONIZED_SCENE_PHASE(iLocal_494) > 0.6f) || !IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_494))
					{
						if (IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_495))
						{
							CLEAR_PED_TASKS(iLocal_51[0]);
							iLocal_495 = CREATE_SYNCHRONIZED_SCENE(vLocal_485, vLocal_488, 2);
							TASK_SYNCHRONIZED_SCENE(iLocal_51[0], iLocal_495, "random@security_van", "driver_exit_calm", 4f, -4f, 9, 0, 1148846080, 0);
						}
						iLocal_497 = 1;
					}
				}
				...
				{
					CLEAR_PED_TASKS(iLocal_51[1]);
					TASK_ENTER_VEHICLE(iLocal_51[1], iLocal_54, -1, 0, 1f, 1, 0);
					SETTIMERA(0);
				}
				if ((func_82() && GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_54, 0) == 0f) && GET_VEHICLE_DOOR_ANGLE_RATIO(iLocal_54, 1) == 0f)
				{
					func_62(4);
				}
				break;
			...
			case 4:
				if (TIMERA() > 15000)
				{
					SET_VEHICLE_DOOR_SHUT(iLocal_54, 0, 1);
					SET_VEHICLE_DOOR_SHUT(iLocal_54, 1, 1);
				}
				break;
		}
	...
	if (iLocal_48 != 1)
	{
		...
		if (bLocal_109 && !DOES_PICKUP_EXIST(uLocal_137))
		{
			SET_VEHICLE_DOOR_SHUT(iLocal_54, 2, 1);
			SET_VEHICLE_DOOR_SHUT(iLocal_54, 3, 1);
		}
	...
	if (!IS_PED_INJURED(PLAYER_PED_ID()))
	{
		if (!IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
		{
			if (!IS_ENTITY_DEAD(GET_PLAYERS_LAST_VEHICLE(), 0))
			{
				...
				{
					uLocal_55 = GET_PLAYERS_LAST_VEHICLE();
					return 1;
				}
			}
		}
		else if (!IS_ENTITY_DEAD(GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0), 0))
		{
			...
			{
				fLocal_480 = (fLocal_480 + GET_FRAME_TIME());
			}
			else if (fLocal_480 > 0f)
			{
				fLocal_480 = (fLocal_480 - (GET_FRAME_TIME() * 10f));
			}
			else if (fLocal_480 < 0f)
			{
				fLocal_480 = 0f;
			...
			if (fLocal_480 > 3f)
			{
				uLocal_55 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 0);
				return 1;
			}
		}
	}
...
int func_152()
{
	...
	{
		if (IS_ENTITY_AT_COORD(PLAYER_PED_ID(), vLocal_77, 25f, 25f, 20f, 0, 1, 0))
		{
			return 1;
		}
	}
...
void func_154()
{
	...
	iLocal_54 = CREATE_VEHICLE(iLocal_104, vLocal_77, fLocal_80, 1, 1, 0);
	uLocal_57 = CREATE_OBJECT(joaat("prop_security_case_01"), vLocal_77, 1, 1, 0);
	ATTACH_ENTITY_TO_ENTITY(uLocal_57, iLocal_54, 0, 0f, -2.4589f, 1.2195f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
	SET_ENTITY_VISIBLE(uLocal_57, 0, 0);
	SET_ENTITY_NO_COLLISION_ENTITY(uLocal_57, iLocal_54, 0);
	SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_54, 1084227584);
	SET_VEHICLE_DOORS_LOCKED(iLocal_54, 3);
	SET_ENTITY_PROOFS(uLocal_57, 0, 1, 1, 1, 1, 1, 0, 0);
	SET_ENTITY_IS_TARGET_PRIORITY(iLocal_54, 1, 0);
	SET_ENTITY_HEALTH(iLocal_54, 700, 0);
	SET_VEHICLE_AUTOMATICALLY_ATTACHES(iLocal_54, 0, 0);
	SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_54, 1, 1);
	SET_VEHICLE_DROPS_MONEY_WHEN_BLOWN_UP(iLocal_54, 0);
	...
	if (iLocal_46 == 3)
	{
		iLocal_51[0] = CREATE_PED_INSIDE_VEHICLE(iLocal_54, 26, iLocal_103, -1, 1, 1);
		iLocal_51[1] = CREATE_PED_INSIDE_VEHICLE(iLocal_54, 26, iLocal_103, 0, 1, 1);
		SET_VEHICLE_ENGINE_ON(iLocal_54, 1, 1, 0);
		SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_54, 1, 1);
	}
	else
	{
		iLocal_51[1] = CREATE_PED(26, iLocal_103, vLocal_67[1 /*3*/], fLocal_74[1], 1, 1);
		iLocal_51[0] = CREATE_PED(26, iLocal_103, vLocal_67[0 /*3*/], fLocal_74[0], 1, 1);
		TASK_LOOK_AT_ENTITY(iLocal_51[1], iLocal_51[0], -1, 0, 2);
	}
	func_79(iLocal_51[1]);
	ADD_RELATIONSHIP_GROUP("Security_guards", &uLocal_66);
	iVar0 = 0;
	while (iVar0 < iLocal_51)
	{
		SET_PED_MONEY(iLocal_51[iVar0], 0);
		SET_PED_COMBAT_ATTRIBUTES(iLocal_51[iVar0], 1, 0);
		SET_PED_COMBAT_ATTRIBUTES(iLocal_51[iVar0], 13, 0);
		SET_PED_COMBAT_ATTRIBUTES(iLocal_51[iVar0], 6, 1);
		SET_PED_COMBAT_ATTRIBUTES(iLocal_51[iVar0], 8, 0);
		SET_PED_COMBAT_ATTRIBUTES(iLocal_51[iVar0], 10, 1);
		SET_PED_FLEE_ATTRIBUTES(iLocal_51[iVar0], 512, 1);
		SET_PED_CONFIG_FLAG(iLocal_51[iVar0], 118, 0);
		SET_PED_FLEE_ATTRIBUTES(iLocal_51[iVar0], 128, 1);
		SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_51[iVar0], 0);
		SET_ENTITY_IS_TARGET_PRIORITY(iLocal_51[iVar0], 1, 0);
		...
		GIVE_WEAPON_TO_PED(iLocal_51[iVar0], joaat("weapon_pistol"), -1, 0, 1);
		SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_51[iVar0], uLocal_66);
		SET_PED_KEEP_TASK(iLocal_51[iVar0], 1);
		SET_ENTITY_LOD_DIST(iLocal_51[iVar0], 250);
		iVar0++;
	}
	SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_51[1], 1, 1);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1533126372, uLocal_66);
	SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_66, -1533126372);
	SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_66, 1862763509);
	SET_RELATIONSHIP_BETWEEN_GROUPS(2, 1862763509, uLocal_66);
	if (iLocal_46 == 1)
	{
		SET_PED_PROP_INDEX(iLocal_51[0], 0, 1, 0, 0);
		SET_PED_SUFFERS_CRITICAL_HITS(iLocal_51[0], 0);
		SET_PED_PROP_INDEX(iLocal_51[1], 0, 1, 0, 0);
	...
	SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_104, 1);
	SET_PED_MODEL_IS_SUPPRESSED(iLocal_103, 1);
	if (iLocal_46 != 3)
	{
	}
}
...
int func_165()
{
	if (IS_PLAYER_PLAYING(PLAYER_ID()) && !IS_PED_INJURED(PLAYER_PED_ID()))
	{
		...
		if (VMAG2(GET_ENTITY_VELOCITY(PLAYER_PED_ID())) > 1369f && !func_176())
		{
			return 0;
		}
	}
...
int func_178()
{
	if ((Global_106554 == func_59() && GET_RANDOM_EVENT_FLAG()) && Global_106555)
	{
		return 1;
	}
	return 0;
...
void func_182()
{
	...
	uLocal_128 = GET_RANDOM_INT_IN_RANGE(3000, 8000);
	switch (iLocal_47)
	{
		case 1:
...
{
	return (SHIFT_RIGHT(iParam0, 26) & 31 * func_199(IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_202()
{
	...
	func_208(&uVar0, GET_CLOCK_SECONDS());
	func_207(&uVar0, GET_CLOCK_MINUTES());
	func_206(&uVar0, GET_CLOCK_HOURS());
		...
		if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
		{
			if (!IS_PED_INJURED(PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_1()) || Global_105612) || Global_25767) || func_218()) || func_18(8, -1)) || func_217()) || func_216()) || func_215()) || func_214()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1) || func_1()) || Global_25767) || func_218()) || func_18(8, -1)) || func_215()) || func_217()) || func_216()) || func_214()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_GETTING_INTO_A_VEHICLE(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_1()) || Global_105612) || Global_25767) || func_218()) || func_18(8, -1)) || func_215()) || func_217()) || func_216()) || func_214()) || Global_106565.f_7682.f_919[iVar0] == 5) || Global_36972 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((IS_PED_RAGDOLL(PLAYER_PED_ID()) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0)) || func_1()) || Global_105612) || Global_25767) || func_218()) || func_18(8, -1)) || func_217()) || func_216()) || func_214()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_1() || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || func_18(8, -1)) || func_214()) || func_213()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (DOES_ENTITY_EXIST(PLAYER_PED_ID()))
						{
							if ((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || GET_PLAYER_WANTED_LEVEL(PLAYER_ID()) > 0) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_1()) || Global_25767) || func_218()) || func_18(8, -1)) || func_216()) || func_215()) || func_214()) || Global_106565.f_7682.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || func_1()) || func_216()) || Global_105612) || Global_25767) || func_218()) || Global_37584) || func_18(8, -1)) || func_215()) || func_213()) || func_214()) || Global_106565.f_7682.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((IS_PED_IN_COMBAT(PLAYER_PED_ID(), 0) || !IS_PLAYER_CONTROL_ON(PLAYER_ID())) || !IS_PLAYER_READY_FOR_CUTSCENE(PLAYER_ID())) || !IS_SCREEN_FADED_IN()) || IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER_ID(), 0)) || IS_ENTITY_IN_AIR(PLAYER_PED_ID())) || IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1)) || IS_PED_RAGDOLL(PLAYER_PED_ID())) || IS_PED_FALLING(PLAYER_PED_ID())) || IS_PED_SWIMMING(PLAYER_PED_ID())) || IS_PLAYER_BEING_ARRESTED(PLAYER_ID(), 1)) || IS_PLAYER_CLIMBING(PLAYER_ID())) || func_1()) || Global_105612) || Global_25767) || func_218()) || func_18(8, -1)) || func_215()) || func_213()) || func_217()) || func_216()) || func_214())
						{
							return 0;
						}
						break;
...
void func_226()
{
	if (func_178())
	{
		...
		if (DOES_ENTITY_EXIST(uLocal_56))
		{
			if (IS_ENTITY_OCCLUDED(uLocal_56))
			{
				DELETE_OBJECT(&uLocal_56);
			}
			else
			{
				SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_56);
			}
		}
		...
		SET_PED_MODEL_IS_SUPPRESSED(iLocal_103, 0);
		SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_104, 0);
	}
	if (iLocal_131 != 0)
	{
		REMOVE_SHOCKING_EVENT(iLocal_131);
	}
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_65, 0);
	func_130(&uLocal_305, 0, 0);
	func_232(-1);
...
int func_243(var uParam0)
{
	if (!IS_ENTITY_DEAD(uParam0, 0))
	{
		...
		if (IS_VEHICLE_SEAT_FREE(uParam0, 3, 0))
		{
			return 3;
		}
		if (IS_VEHICLE_SEAT_FREE(uParam0, 4, 0))
		{
			return 4;
		}
		if (IS_VEHICLE_SEAT_FREE(uParam0, 5, 0))
		{
			return 5;
		}
		if (IS_VEHICLE_SEAT_FREE(uParam0, 6, 0))
		{
			return 6;
		}
		if (IS_VEHICLE_SEAT_FREE(uParam0, 7, 0))
		{
			return 7;
		}
		if (IS_VEHICLE_SEAT_FREE(uParam0, 8, 0))
		{
			return 8;
		}
	}
