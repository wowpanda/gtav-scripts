...
int func_2()//Position - 0x1D4
{
	...
	{
		if (iLocal_483 != iVar1 || iVar1 < 4294967295)
		{
			func_63(&uLocal_434, 0, 0);
			iLocal_483 = iVar1;
			return 0;
		}
		fVar3 = SYSTEM::VDIST2(unk_0x8000C77B5F336760(iLocal_447[iVar1], false), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false));
...
int func_3(char* sParam0, int iParam1, int iParam2)//Position - 0x317
{
	...
	fVar2 = SYSTEM::VDIST2(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), unk_0x8000C77B5F336760(iLocal_447[*iParam2], false));
	if (fVar2 > (30f * 30f))
	{
		if (fVar2 > (150f * 150f))
		{
	...
	func_24(&uLocal_269, 2, AUDIO::_0x0626A247D2405330(), "TREVOR", 0, 1);
...
float func_26(var uParam0)//Position - 0xDB9
{
	if (func_29(uParam0))
	{
		...
		{
			return (func_6(INTERIOR::_GET_ROOM_KEY_FROM_GAMEPLAY_CAM(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
int func_40(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1445
{
	...
	if ((func_48() || func_47(Global_440000.f_2559E)) || func_46())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 0))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(AUDIO::_0x0626A247D2405330(), 0);
			iVar1 = func_45(AUDIO::_0x0626A247D2405330(), 0);
			if (((VEHICLE::_0xE33FFA906CE74880(iVar0, iVar1) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("APC") && iVar1 != 4294967295)) || (ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("AKULA") && iVar1 != 4294967295)) || (((ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("RIOT2") && iVar1 == 0) && func_44(iVar0, 10)) && VEHICLE::GET_VEHICLE_MOD(iVar0, 10) != 4294967295))
			{
				return 0;
			}
		}
...
int func_41(int iParam0)//Position - 0x1693
{
	if (iParam0 != func_43())
	{
		...
		else if ((Global_140859 && iParam0 == CAM::_0xDC9DA9E8789F5246()) && func_42(iParam0, 1, 0))
		{
			return Global_24FBF9[iParam0 /*413*/].f_135.f_4 != 4294967295;
		}
	}
...
int func_42(int iParam0, bool bParam1, bool bParam2)//Position - 0x16F9
{
	int iVar0;
...
int func_43()//Position - 0x1743
{
	return 4294967295;
}

int func_44(int iParam0, int iParam1)//Position - 0x174C
{
...
int func_45(int iParam0, int iParam1)//Position - 0x17AE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_46()//Position - 0x1833
{
	return Global_255C02.f_10;
}

bool func_47(int iParam0)//Position - 0x1841
{
	return iParam0 == 51;
}

var func_48()//Position - 0x184E
{
	return Global_255C02.f_F;
}

bool func_49()//Position - 0x185C
{
	return MISC::GET_GAME_TIMER() <= Global_43D7.f_16F1 + 100;
}

int func_50(int iParam0)//Position - 0x1871
{
	if (iParam0 == 1)
	{
		if (Global_38B1.f_1 > 3)
...
void func_51(var uParam0, int iParam1, vector3 vParam2, int iParam3)//Position - 0x18CB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_52()//Position - 0x19D7
{
	return func_53(CAM::_0xDC9DA9E8789F5246());
}

int func_53(int iParam0)//Position - 0x19E7
{
...
bool func_54(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x1A06
{
	if (bParam2)
	{
...
int func_55(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x1A4D
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_58(bParam1, bParam2, bParam3) || PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 1))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(AUDIO::_0x0626A247D2405330(), 1) || func_56(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
int func_56(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1DB9
{
...
int func_57(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1E0B
{
	if (!func_40(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_58(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1E54
{
	if (!func_40(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_59(bool bParam0, bool bParam1, bool bParam2)//Position - 0x1EB3
{
	if (!func_40(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_60(int iParam0)//Position - 0x1F09
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_61()//Position - 0x1F64
{
	MISC::SET_BIT(&Global_950, 4);
}

int func_62(char* sParam0)//Position - 0x1F74
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_63(var uParam0, int iParam1, int iParam2)//Position - 0x1F87
{
	char* sVar0;
...
int func_64(int iParam0, int iParam1)//Position - 0x205D
{
	int iVar0;
	bool bVar1;
	float fVar2;
	...
	{
		case 0:
			if (!func_73(iLocal_447[iParam0], iLocal_450[iParam0], &(iLocal_480[iParam0]), 4294967295, 4294967294))
			{
				return 0;
			}
			...
			if (fLocal_463 >= 0f)
			{
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_450[iParam0], 0))
				{
		...
		case 1:
			...
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_450[iParam0]))
			{
				...
				else
				{
					...
					{
						func_65(iLocal_450[iParam0], AUDIO::_0x0626A247D2405330(), &(fLocal_481[iParam0]), 17.5f, 7.5f, 30f, 0.7f, 1.2f, 1f, bVar1);
					}
					else
					{
						fLocal_481[iParam0] = 1f;
						fVar2 = ENTITY::GET_ENTITY_SPEED(AUDIO::_0x0626A247D2405330());
				...
				if (!VEHICLE::IS_PLAYBACK_USING_AI_GOING_ON_FOR_VEHICLE(iLocal_450[iParam0]))
				{
					if (!PED::GET_PED_TYPE(iLocal_447[iParam0]) == 6)
					{
						if (MISC::IS_AREA_OCCUPIED(unk_0x8000C77B5F336760(iLocal_450[iParam0], true) - Vector(1f, 1f, 1f), unk_0x8000C77B5F336760(iLocal_450[iParam0], true) + Vector(1f, 1f, 1f), 0, 1, 0, 0, 0, 0, 0))
						{
				...
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_447[iParam0], AUDIO::_0x0626A247D2405330(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_450[iParam0], AUDIO::_0x0626A247D2405330(), 1))
				{
					VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_450[iParam0]);
					return 0;
				}
				...
				if (PED::GET_PED_TYPE(iLocal_447[iParam0]) == 6)
				{
					...
					{
						if (ENTITY::DOES_ENTITY_EXIST(PED::GET_VEHICLE_PED_IS_USING(AUDIO::_0x0626A247D2405330())) && !VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(PED::GET_VEHICLE_PED_IS_USING(AUDIO::_0x0626A247D2405330())))
						{
							VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_450[iParam0]);
							return 0;
						}
			...
			{
				NETWORK::_0x5E3AA4CA2B6FB0EE(iLocal_447[iParam0]);
				if (!PED::GET_PED_TYPE(iLocal_447[iParam0]) == 6)
				{
					BRAIN::TASK_VEHICLE_DRIVE_WANDER(iLocal_447[iParam0], iLocal_450[iParam0], fLocal_265, iLocal_266);
				...
				{
					BRAIN::TASK_COMBAT_PED(iLocal_447[iParam0], AUDIO::_0x0626A247D2405330(), 0, 16);
		...
		case 2:
			...
			if (PED::IS_PED_SITTING_IN_VEHICLE(iLocal_447[iParam0], iLocal_450[iParam0]))
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_447[iParam0], 4036695475) != 1)
				{
					BRAIN::TASK_VEHICLE_DRIVE_WANDER(iLocal_447[iParam0], iLocal_450[iParam0], fLocal_265, iLocal_266);
				}
				else
				{
					BRAIN::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_447[iParam0], fLocal_265);
				}
			}
			else
			{
		...
		case 4:
			...
			{
				iLocal_480[iParam0] = 4294967295;
				return 0;
			}
			if (!OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_450[iParam0], 0))
			{
				iLocal_480[iParam0] = 4294967294;
				return 0;
			}
			if (!PED::IS_PED_SITTING_IN_VEHICLE(iLocal_447[iParam0], iLocal_450[iParam0]))
			{
				...
				{
					BRAIN::TASK_ENTER_VEHICLE(iLocal_447[iParam0], iLocal_450[iParam0], 20000, 4294967295, 2f, 1, 0);
				}
			}
			else
			{
		...
		case 4294967294:
			if (!PED::IS_PED_INJURED(iLocal_447[iParam0]))
			{
				if (BRAIN::GET_SCRIPT_TASK_STATUS(iLocal_447[iParam0], 1805844857) != 1)
				{
					PED::SET_PED_CONFIG_FLAG(iLocal_447[iParam0], 29, true);
					BRAIN::TASK_SMART_FLEE_PED(iLocal_447[iParam0], AUDIO::_0x0626A247D2405330(), 150f, 4294967295, 0, 0);
				}
			}
			else
			{
...
void func_65(int iParam0, int iParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, bool bParam9)//Position - 0x2693
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_66(int iParam0, int iParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, bool bParam10)//Position - 0x26F3
{
	float fVar0;
	float fVar1;
	float fVar2;
				...
				if (!ENTITY::IS_ENTITY_DEAD(iVar9, 0))
				{
					...
					if (VEHICLE::IS_THIS_MODEL_A_CAR(iVar10) || VEHICLE::IS_THIS_MODEL_A_BIKE(iVar10))
					{
						if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iVar9, 0))
						{
							...
							PLAYER::SET_AIR_DRAG_MULTIPLIER_FOR_PLAYERS_VEHICLE(CAM::_0xDC9DA9E8789F5246(), fLocal_141);
						}
					}
				}
			}
...
float func_67(int iParam0, int iParam1)//Position - 0x299A
{
	struct<2> Var0;
	vector3 vVar1;
	vector3 vVar2;
...
float func_68(int iParam0, int iParam1)//Position - 0x2A2B
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_69(int iParam0, int iParam1)//Position - 0x2A7D
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
float func_70(vector3 vParam0, vector3 vParam1)//Position - 0x2B20
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

float func_71(int iParam0, int iParam1)//Position - 0x2B41
{
	struct<2> Var0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_72(int iParam0, var uParam1)//Position - 0x2BD0
{
	if (*uParam1 < 0)
	{
		*uParam1 = iParam0;
...
int func_73(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4)//Position - 0x2BE9
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		*uParam2 = iParam3;
...
int func_75()//Position - 0x2C9A
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iVar0, 0))
	{
		...
		else
		{
			...
			while (iVar1 < 4)
			{
				if (OBJECT::_GET_DES_OBJECT_ANIM_PROGRESS(iLocal_450[iVar1], 0) && !PED::IS_PED_INJURED(iLocal_447[iVar1]))
				{
					if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_458) && iLocal_461[iVar1] > 0)
					{
						...
						BRAIN::TASK_VEHICLE_MISSION(iLocal_447[iVar1], iLocal_450[iVar1], 0, 15, 20f, iLocal_266, 0.5f, 2f, 1);
...
int func_76(int iParam0, int iParam1)//Position - 0x2D77
{
	vector3 vVar0;
	float fVar1;
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_77(Global_16B5A) && iParam1 != 0)
		{
			Global_16B5A = 0;
		}
	}
...
int func_77(var uParam0)//Position - 0x2E5B
{
	return uParam0;
}

bool func_78(var uParam0, var uParam1)//Position - 0x2E65
{
	return (uParam0 && uParam1) != 0;
}

int func_79()//Position - 0x2E74
{
	func_15();
...
void func_81()//Position - 0x2EFA
{
	func_82((Global_16B5C - 1));
}

void func_82(int iParam0)//Position - 0x2F0C
{
	Global_16B5C = iParam0;
}

void func_83()//Position - 0x2F1A
{
	func_82(0);
}

void func_84()//Position - 0x2F27
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	while (iVar0 < 4)
	{
		...
		if (iLocal_448[iVar0] != 0)
		{
			iLocal_447[iVar0] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_450[iVar0], iLocal_449, iLocal_448[iVar0], 4294967295, 1, true);
			...
			ENTITY::SET_ENTITY_HEALTH(iLocal_447[iVar0], true);
...
void func_85()//Position - 0x3175
{
	...
	switch (iLocal_268)
	{
		case 281:
			...
			iLocal_266 = 794660;
			iLocal_461[0] = 2;
			iLocal_461[1] = 4294967295;
			iLocal_461[2] = 4294967295;
			iLocal_461[3] = 4294967295;
...
int func_86(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x398D
{
	switch (iParam0)
	{
		case 231:
...
int func_87(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0x3C64
{
	int iVar0;
...
bool func_88(var uParam0)//Position - 0x3E57
{
	int iVar0;
	vector3 vVar1;
	float fVar2;
...
int func_89(int iParam0, var uParam1, char* sParam2)//Position - 0x3F12
{
	vector3 vVar0;
	int iVar1;
	var uVar2;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[0];
			StringCopy(sParam2, func_93(Global_19E56.f_933.f_21B.f_8F6[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[1];
			StringCopy(sParam2, func_93(Global_19E56.f_933.f_21B.f_8F6[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_19E56.f_933.f_21B.f_8F2[2];
			StringCopy(sParam2, func_93(Global_19E56.f_933.f_21B.f_8F6[2]), 32);
			return 1;
			break;
...
int func_90(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x6500
{
	switch (iParam1)
	{
		case 0:
...
int func_92(int iParam0, var uParam1, var uParam2)//Position - 0x8470
{
	switch (iParam0)
	{
		case 11:
...
char* func_93(int iParam0)//Position - 0x8DDF
{
	switch (iParam0)
	{
		case 2014101067:
