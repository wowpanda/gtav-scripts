...
void __EntryFunction__()
{
	...
	func_83(&Local_43, 2);
	Local_43.f_4 = 3;
	CLEAR_AREA_OF_VEHICLES(vLocal_40, 5f, 0, 0, 0, 0, 0, 0);
	func_82(&vLocal_109, -691.9059f, 515.8249f, 108.6139f, -684.0605f, 493.0171f, 110.8504f, 8.25f);
	SET_ROADS_IN_ANGLED_AREA(vLocal_109[0 /*3*/], vLocal_109[1 /*3*/], 8.25f, 0, 0, 1);
	SET_ROADS_IN_ANGLED_AREA(-683.4503f, 492.9922f, 108.8737f, -688.8357f, 506.9997f, 112.1928f, 11.25f, 0, 0, 1);
	func_81(-688.5f, 503.7f, 110.2f, 30f, &vVar0, &vVar3);
	uLocal_118 = ADD_SCENARIO_BLOCKING_AREA(vVar0, vVar3, 0, 1, 1, 1);
	if (func_89(90) == 1)
	{
		func_88();
		func_90();
	...
	while (true)
	{
		...
		if (func_43(&Local_43))
		{
			if (func_37(&Local_43))
			{
				if (GET_LAST_DRIVEN_VEHICLE() == Global_71314)
				{
					Global_71314 = 0;
					Global_106565.f_32743.f_5588 = 0;
				}
				CLEAR_AREA_OF_VEHICLES(Local_43.f_14, 8.5f, 0, 0, 0, 0, 0, 0);
				Global_106565.f_10043.f_103 = iLocal_99;
				func_35();
				func_34(&uLocal_119, 0, PLAYER_PED_ID(), "MICHAEL", 0, 1);
		...
		if (Global_106565.f_10043.f_104 != 0)
		{
			iLocal_97 = (Global_106565.f_10043.f_104 + 14 % func_18(GET_CLOCK_MONTH(), GET_CLOCK_YEAR()));
		...
		if ((iLocal_107 > 0 && GET_GAME_TIMER() > iLocal_107) && iLocal_285 == 99)
		{
			iLocal_107 = 0;
			if (func_86())
			{
	...
	switch (*iParam2)
	{
		case 0:
			*iParam0 = REQUEST_SCALEFORM_MOVIE("MIDSIZED_MESSAGE");
			...
			{
				uVar0 = GET_SOUND_ID();
				PLAY_SOUND_FRONTEND(uVar0, "CHECKPOINT_UNDER_THE_BRIDGE", "HUD_MINI_GAME_SOUNDSET", 1);
				*iParam2++;
			}
			break;
...
int func_37(var uParam0)
{
	...
	while (iVar0 < iVar1)
	{
		...
		{
			if (IS_ENTITY_IN_ANGLED_AREA(uVar3[iVar0], uParam0->f_6[0 /*3*/], uParam0->f_6[1 /*3*/], uParam0->f_6.f_7, 0, 1, 0) && !uParam0->f_26)
			{
	...
	{
		Global_106565.f_10043.f_104 = GET_CLOCK_DAY_OF_MONTH();
		iLocal_107 = (GET_GAME_TIMER() + iLocal_108);
	}
	return iVar2;
}
...
int func_38(var uParam0)
{
	...
	while (iVar0 < 5)
	{
		if (func_41(iVar1, iVar0))
		{
			if (!func_14(iVar0))
			{
				func_40(iVar0, GET_ENTITY_HEALTH(uParam0) < 875);
				func_39(iVar0, 1);
				return 1;
			}
		}
...
bool func_42(var uParam0)
{
	...
	if (GET_ENTITY_HEALTH(uParam0) < 750)
	{
		return 1;
	}
	if (IS_VEHICLE_BUMPER_BROKEN_OFF(uParam0, 1) || IS_VEHICLE_BUMPER_BROKEN_OFF(uParam0, 0))
	{
		return 1;
	}
	return _0x42A4BEB35D372407(uParam0) > 0;
}
...
void func_44(var uParam0)
{
	...
	uParam0->f_26 = 0;
	if (IS_POSITION_OCCUPIED(uParam0->f_19[0 /*3*/], 1.2f, 0, 1, 1, 0, 0, PLAYER_PED_ID(), 0))
	{
		uParam0->f_26 = 1;
	}
	else if (IS_POSITION_OCCUPIED(uParam0->f_19[1 /*3*/], 1.2f, 0, 1, 1, 0, 0, PLAYER_PED_ID(), 0))
	{
		uParam0->f_26 = 1;
	}
	else
	{
		...
		uParam0->f_26 = IS_POSITION_OCCUPIED(vVar0, 1.2f, 0, 1, 1, 0, 0, PLAYER_PED_ID(), 0);
		if (uParam0->f_26)
		{
		}
	}
	if (uParam0->f_5 == 2 && (uParam0->f_4 != 2 || uParam0->f_4 == 3))
	{
		...
		if (uParam0->f_17 <= 0f)
		{
			uParam0->f_17 = 0f;
			uParam0->f_4 = 2;
			STOP_SOUND(uLocal_95);
			iLocal_96 = 0;
			PLAY_SOUND_FROM_COORD(-1, "CLOSED", *uParam0, "DOOR_GARAGE", 0, 0, 1);
		}
		else if (!iLocal_96)
		{
			PLAY_SOUND_FROM_COORD(uLocal_95, "CLOSING", *uParam0, "DOOR_GARAGE", 0, 0, 1);
			iLocal_96 = 1;
		}
	}
	if (uParam0->f_5 == 1 && (uParam0->f_4 != 1 || uParam0->f_4 == 4))
	{
		...
		{
			PLAY_SOUND_FROM_COORD(uLocal_95, "OPENING", *uParam0, "DOOR_GARAGE", 0, 0, 1);
			iLocal_96 = 1;
		}
	}
	if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(*uParam0, 20f, uParam0->f_3, 0))
	{
		SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(uParam0->f_3, *uParam0, 1, uParam0->f_17, 0);
	}
}
	...
	switch (*iParam0)
	{
		...
		case 2:
			...
			if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
			{
				...
				if (func_75(uVar0))
				{
					if (GET_VEHICLE_NUMBER_OF_PASSENGERS(uVar0) == 0)
					{
						*iParam0 = 4;
					}
				}
...
int func_53()
{
	...
	while (iVar0 < 5)
	{
		if (!func_14(iVar0))
		{
			if (func_41(GET_ENTITY_MODEL(uVar1), iVar0))
			{
				if (func_42(uVar1))
				{
					if (!iLocal_102)
...
void func_56(int iParam0)
{
	...
	switch (*iParam0)
	{
		case 1:
			...
			if (IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
			{
				STOP_FIRE_IN_RANGE(GET_ENTITY_COORDS(PLAYER_PED_ID(), 1), 1.5f);
			}
			*iParam0 = 2;
			iLocal_98 = 0;
			iLocal_106 = 0;
		...
		case 2:
			switch (iLocal_98)
			{
				case 0:
					...
					if (func_61(PLAYER_PED_ID()) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
					{
						uVar0 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 1);
					}
					if (func_75(uVar0) && GET_VEHICLE_NUMBER_OF_PASSENGERS(uVar0) > 0)
					{
						if (GET_PED_IN_VEHICLE_SEAT(uVar0, 0, 0) != PLAYER_PED_ID())
						{
							func_76(3);
							return;
						}
					...
					if (!Local_43.f_26)
					{
						if (iLocal_104 == 0)
						{
							if (func_60(uVar0))
							{
								if (IS_ENTITY_IN_ANGLED_AREA(uVar0, Local_43.f_6[0 /*3*/], Local_43.f_6[1 /*3*/], Local_43.f_6.f_7, 0, 1, 0))
								{
						...
						if (func_58(PLAYER_PED_ID(), Local_43.f_14, 0) < 3f)
						{
							func_55(&iLocal_92);
						}
						if (func_58(PLAYER_PED_ID(), Local_43, 0) > (15f + 5f))
						{
							func_83(&Local_43, 2);
							Local_43.f_4 = 3;
							iLocal_104 = 0;
						...
						if (func_57(&Local_43) && !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0))
						{
							func_83(&Local_43, 2);
							Local_43.f_4 = 3;
							iLocal_106 = 0;
					...
					if ((Local_43.f_26 && !IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 0)) && IS_PED_ON_FOOT(PLAYER_PED_ID()))
					{
						if (iLocal_106 == 0)
						{
							iLocal_106 = GET_GAME_TIMER();
						}
						else if ((GET_GAME_TIMER() - iLocal_106) > 500)
						{
							if (iLocal_103 == 0)
							{
								CLEAR_PRINTS();
...
void func_62(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 2:
			...
			if (func_61(PLAYER_PED_ID()) && IS_PED_IN_ANY_VEHICLE(PLAYER_PED_ID(), 1))
			{
				uVar0 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 1);
			}
			if (func_75(uVar0) && GET_VEHICLE_NUMBER_OF_PASSENGERS(uVar0) > 0)
			...
			if (func_58(PLAYER_PED_ID(), Local_43, 0) < 15f)
			{
				*iParam0 = 4;
				return;
			}
...
void func_64(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 2:
			...
			{
				if (IS_ENTITY_IN_ANGLED_AREA(PLAYER_PED_ID(), Local_43.f_6[0 /*3*/], Local_43.f_6[1 /*3*/], Local_43.f_6.f_7, 0, 1, 0) && func_43(&Local_43))
				{
					SET_ENTITY_COORDS(PLAYER_PED_ID(), -687.6668f, 500.598f, 109.0364f, 1, 0, 0, 1);
		...
		case 4:
			if (iLocal_101 == 0 && func_61(PLAYER_PED_ID()))
			{
				if (iLocal_117 != GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 1))
				{
					iLocal_117 = GET_VEHICLE_PED_IS_IN(PLAYER_PED_ID(), 1);
...
void func_67()
{
	...
	func_69();
	func_68(&Local_43);
	REMOVE_SCENARIO_BLOCKING_AREA(uLocal_118, 0);
...
void func_68(var uParam0)
{
	if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(*uParam0, 20f, uParam0->f_3, 0))
	{
		SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(uParam0->f_3, *uParam0, 1, 0f, 0);
	}
}
