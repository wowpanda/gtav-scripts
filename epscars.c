...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (func_43(&Local_41))
		{
			if (func_37(&Local_41))
			{
				if (VEHICLE::GET_LAST_DRIVEN_VEHICLE() == Global_70583)
				{
					Global_70583 = 0;
		...
		if (Global_104555.f_10019.f_104 != 0)
		{
			iLocal_49 = (Global_104555.f_10019.f_104 + 14 % func_18(CLOCK::GET_CLOCK_MONTH(), CLOCK::GET_CLOCK_YEAR()));
...
void func_71()
{
	...
	{
		if (func_74(Global_104555.f_2353.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
