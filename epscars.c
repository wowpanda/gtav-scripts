...
void __EntryFunction__()
{
	...
	iLocal_51 = Global_105220.f_10020.f_103;
	func_87();
	if (func_86())
	{
		func_90();
	...
	while (true)
	{
		...
		if (Global_105220.f_10020.f_104 != 0)
		{
			iLocal_49 = (Global_105220.f_10020.f_104 + 14 % func_18(CLOCK::GET_CLOCK_MONTH(), CLOCK::GET_CLOCK_YEAR()));
...
int func_49(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar1 < Global_46370[iVar0 /*203*/].f_3)
	{
		...
		if (iVar3 < 3)
		{
			func_50(Global_46370[iVar0 /*203*/].f_4[iVar1], Global_46370[iVar0 /*203*/].f_1, 1, bParam2, 0);
		}
		iVar1++;
	}
	return 1;
...
void func_71()
{
	...
	{
		if (func_74(Global_105220.f_2354.f_539.f_4301) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_73(PLAYER::PLAYER_PED_ID());
			if (func_72(iVar0) && (!func_29(14) || Global_104171))
			{
