		...
		if (PLAYER::IS_PLAYER_PLAYING(CAM::_0xDC9DA9E8789F5246()))
		{
			switch (iLocal_43)
			{
				...
				case 2:
					...
					{
						if (MISC::CREATE_INCIDENT_WITH_ENTITY(7, AUDIO::_0x0626A247D2405330(), 2, 3f, &uLocal_47, 0, 0))
						{
				...
				case 3:
					...
					if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
					{
						if ((func_7(CAM::_0xDC9DA9E8789F5246(), 0) && func_4(CAM::_0xDC9DA9E8789F5246()) == 5) && Global_19B5CC)
						{
							if (Global_19B5CD == 0)
							{
								Global_19B5CD = 1;
						...
						else if (MISC::CREATE_INCIDENT_WITH_ENTITY(5, AUDIO::_0x0626A247D2405330(), 2, 3f, &uLocal_47, 0, 0))
						{
							iLocal_46 = MISC::GET_GAME_TIMER();
							iLocal_43 = 5;
						}
				...
				case 4:
					...
					if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
					{
						if (MISC::CREATE_INCIDENT_WITH_ENTITY(3, AUDIO::_0x0626A247D2405330(), 4, 3f, &uLocal_47, 0, 0))
						{
							iLocal_46 = MISC::GET_GAME_TIMER();
							iLocal_43 = 5;
						}
					...
					{
						if (Global_15EE0.f_166 == MISC::GET_HASH_KEY("AGENCY_PREP_1") || (SCRIPT::_GET_NUMBER_OF_INSTANCES_OF_SCRIPT_WITH_NAME_HASH(MISC::GET_HASH_KEY("agency_prep1")) > 0 && func_3(0)))
						{
							Global_15EE0.f_166 = MISC::GET_HASH_KEY("AHP1_TRUCKCALLED");
						}
...
void func_9()//Position - 0x398
{
	...
	switch (iLocal_44)
	{
		...
		case 1:
			...
			{
				func_10(AUDIO::_0x0626A247D2405330(), &vLocal_45, &uVar0);
			}
			iLocal_46 = MISC::GET_GAME_TIMER();
			break;
	}
...
void func_10(int iParam0, var uParam1, var uParam2)//Position - 0x431
{
	...
	while (iVar13 < 2)
	{
		...
		{
			case 0:
				PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true), iVar0, uParam1, &fVar10, &iVar1, 5, 3f, 0f);
				PATHFIND::GET_CLOSEST_ROAD(*uParam1, 1f, 1, &uVar4, &uVar5, &uVar2, &uVar3, &fVar7, 0);
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), -3044.66f, 596.43f, 6.58f, true) < 25f)
				{
					*uParam1 = { -3031.38f, 605.32f, 6.86f };
				}
				vVar6 = { unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true) - unk_0x8000C77B5F336760(iParam0, true) };
				...
				else
				{
					...
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), 294f, -895f, 28f, true) < 25f || MISC::GET_DISTANCE_BETWEEN_COORDS(unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), false), -713.01f, -819.64f, 22.63f, true) < 25f)
					{
						fVar11 = (fVar11 + 5f);
					}
					else
				...
				if (SYSTEM::VDIST(OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(*uParam1, *uParam2, fVar11, 0f, 0f), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)) > SYSTEM::VDIST(OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(*uParam1, *uParam2, -fVar11, 0f, 0f), unk_0x8000C77B5F336760(AUDIO::_0x0626A247D2405330(), true)))
				{
					fVar11 = -fVar11;
				}
